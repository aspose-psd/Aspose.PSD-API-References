---
title: "ArtboardLayer-klass"
type: docs
weight: 90
url: /sv/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Hämtar eller anger bakgrundsfärgen för artboarden. |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | Hämtar eller anger ett värde som indikerar om [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) har bakgrundsfärgen. |
...
| is_cached | bool | r |  |
| is_open | bool | r/w | Hämtar eller anger om mappen är öppen<br/>            om den sätts till <c>true</c> blir gruppen i öppet läge vid start, annars i minimerat läge. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Hämtar lagren i lagergruppen. |
| vänster | int | r/w | <inheritdoc /> |
| längd | int | r |  |
...
| **Name** | **Beskrivning** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Lägger till lagret i lagergruppen. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Lägger till lagergruppen. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Laddar 32‑bitars ARGB‑pixlar delvis (i block). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Laddar rådata. |
