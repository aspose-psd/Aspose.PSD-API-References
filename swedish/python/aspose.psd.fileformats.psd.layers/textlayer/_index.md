---
title: "TextLayer-klass"
type: docs
weight: 1750
url: /sv/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Hämtar teckensnittet. |
| has_alpha | bool | r |  |
...
| inner_text | string | r | Hämtar lagrets text. |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Hämtar eller anger textens avgränsningsruta. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Hämtar textens färg. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Hämtar textens delar. |
| övre | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Hämtar teckensnittssamlingen för textlagret. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Ändrar bildens storlek. Standardvärdet [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) används. |
...
| [update_text(text)](#update_text_text_38) | Uppdaterar texten. |
| [update_text(text, color)](#update_text_text_color_39) | Uppdaterar texten. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Uppdaterar texten. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Uppdaterar texten. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Uppdaterar texten. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Uppdaterar texten. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Uppdaterar texten. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Uppdaterar texten. |
...
| Typ | Beskrivning |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | Teckensnittssamlingen för textlagret. |
...
Ändrar bildens storlek. Standardvärdet [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) används.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Typen av storleksändringstransformation [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | Textvärdet. |
| color | [Color](/psd/python-net/aspose.psd/color) | Färgvärdet. |
...
| :- | :- | :- |
| text | string | Textvärdet. |
| font_size | float | Storlek på teckensnittet. |
...
| :- | :- | :- |
| text | string | Textvärdet. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | Den övre vänstra koordinaten. |
