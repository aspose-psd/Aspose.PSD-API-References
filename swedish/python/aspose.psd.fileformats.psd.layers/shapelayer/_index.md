---
title: "ShapeLayer-klass"
type: docs
weight: 1600
url: /sv/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Initierar en ny instans av klassen [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Alla resurser skapas i sitt standardtillstånd. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Hämtar eller anger fyllinställningar för den interna ytan av former i Shape-lagret. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Hämtar mängden vägar som finns i ett Shape-lager. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Hämtar eller anger streckinställningar för former. |
| övre | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Skapar en ny instans av klassen [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Uppdaterar resurser från Shape-lageregenskaper. |
...
Initierar en ny instans av klassen [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Alla resurser skapas i sitt standardtillstånd.
...
Skapar en ny instans av klassen [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Returnerar den nya instansen av klassen [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
