---
title: "FillLayer-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Hämtar eller anger fyllningsinställningarna. |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | Hämtar fyllningstypen. |
| filler | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | Skapa en ny instans av klassen [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) baserat på fyllningstyp. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | Ersätter alla icke‑transparenta färger med en ny färg och bevarar original‑alfavärdet för att spara mjuka kanter.<br/>            Obs: om du använder den på bilder utan transparens kommer alla färger att ersättas med en enda. |
...
| update() | Uppdaterar pixeldata för fyllningslagret baserat på de aktuella [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
...
Skapa en ny instans av klassen [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) baserat på fyllningstyp.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | Typen av fyllningslager. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | Returnerar en ny instans av klassen [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) baserat på fyllningstyp. |
