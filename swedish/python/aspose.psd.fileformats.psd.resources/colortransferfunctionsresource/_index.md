---
title: "ColorTransferFunctionsResource klass"
type: docs
weight: 60
url: /sv/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | Initierar en ny instans av ColorTransferFunctionsResource-klassen |
## **Properties**
...
| color_transfer_data | byte | r/w | Hämtar eller anger färgöverföringsdata. |
...
Initierar en ny instans av ColorTransferFunctionsResource-klassen
