---
title: "WatermarkResource-klass"
type: docs
weight: 310
url: /sv/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | Initierar en ny instans av WatermarkResource-klassen |
## **Properties**
...
| is_watermark | bool | r/w | Hämtar eller anger ett värde som indikerar om denna instans är en vattenstämpel. |
...
Initierar en ny instans av WatermarkResource-klassen
