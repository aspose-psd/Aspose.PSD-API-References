---
title: "QuickMaskInformationResource-klass"
type: docs
weight: 220
url: /sv/python-net/aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource__1) | Initierar en ny instans av klassen QuickMaskInformationResource |
## **Properties**
...
| channel_id | short | r/w | Hämtar eller anger kanalidentifieraren. |
| data_size | int | r | Hämtar resursens datastorlek i byte. |
| id | short | r/w | Hämtar eller anger den unika identifieraren för resursen. |
| is_mask_empty | bool | r/w | Hämtar eller anger ett värde som indikerar om masken är tom för denna instans. |
...
Initierar en ny instans av klassen QuickMaskInformationResource
