---
title: "PrintFlagsResource-klass"
type: docs
weight: 200
url: /sv/python-net/aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [PrintFlagsResource()](#PrintFlagsResource__1) | Initierar en ny instans av PrintFlagsResource-klassen |
## **Properties**
...
| bleed_scale | short | r/w | Hämtar eller anger blödningsskalan. |
| bleed_width | int | r/w | Hämtar eller anger blödningsbredden. |
| center_crop_mark | byte | r/w | Hämtar eller anger centrumbeskärningsmarkören. |
...
Initierar en ny instans av PrintFlagsResource-klassen
