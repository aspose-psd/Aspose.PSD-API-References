...
type: docs
weight: 20
url: /sv/python-net/aspose.psd.exif/jpegexifdata/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [JpegExifData()](#JpegExifData__1) | Initierar en ny instans av klassen [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) . |
| [JpegExifData(common_tags, exif_tags, gps_tags)](#JpegExifData_common_tags_exif_tags_gps_tags_2) | Initierar en ny instans av klassen [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) med data från en array. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_3) | Initierar en ny instans av klassen [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) med data från en array. |
## **Properties**
| **Name** | **Type** | **Access** | **Beskrivning** |
| :- | :- | :- | :- |
| MAX_EXIF_SEGMENT_SIZE [static] | int | r | Den maximala EXIF-segmentstorleken i byte som tillåts. |
...
| compression | ushort | r/w | Hämtar eller anger komprimeringen. |
...
| make | string | r/w | Hämtar eller anger tillverkaren av inspelningsutrustningen. |
...
| model | string | r/w | Hämtar eller anger modellen. |
| oecf | byte | r/w | Hämtar eller anger den optoelektriska konverteringsfunktionen (OECF) som specificeras i ISO 14524. |
| orientation | [ExifOrientation](/psd/python-net/aspose.psd.exif.enums/exiforientation/) | r/w | Hämtar eller anger orienteringen. |
| photographic_sensitivity | uint | r/w | Hämtar eller anger den fotografiska känsligheten. |
| photometric_interpretation | ushort | r/w | Hämtar eller anger den fotometriska tolkningen. |
...
| planar_configuration | ushort | r/w | Hämtar eller anger planär konfiguration. |
| primary_chromaticities | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Hämtar eller anger kromaticiteten för bildens tre primära färger. |
...
| reference_black_white | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Hämtar eller anger referenssvart och vit. |
| related_sound_file | string | r/w | Hämtar eller anger den relaterade ljudfilen. |
| resolution_unit | [ExifUnit](/psd/python-net/aspose.psd.exif.enums/exifunit/) | r/w | Hämtar eller anger upplösningsenheten. |
| samples_per_pixel | ushort | r/w | Hämtar eller anger antalet prover per pixel. |
...
| software | string | r/w | Hämtar eller anger programvaran. |
...
| thumbnail | [RasterImage](/psd/python-net/aspose.psd/rasterimage) | r/w | Hämtar eller anger miniatyrbilden. |
| transfer_function | ushort | r/w | Hämtar eller anger överföringsfunktionen. |
...
| x_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Hämtar eller ställer in x-upplösningen. |
| y_cb_cr_coefficients | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Hämtar eller anger matriskoefficienterna för transformation från RGB till YCbCr-bilddata. |
| y_cb_cr_positioning | [ExifYCbCrPositioning](/psd/python-net/aspose.psd.exif.enums/exifycbcrpositioning/) | r/w | Hämtar eller anger positionen för krominanskomponenterna i förhållande till luminanskomponenten. |
| y_cb_cr_sub_sampling | ushort | r/w | Hämtar eller anger samplingsförhållandet för krominanskomponenterna i förhållande till luminanskomponenten. |
| y_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Hämtar eller anger y-upplösningen. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
| [serialize_exif_data()](#serialize_exif_data__3) | Serialiserar EXIF-data. Skriver taggvärdena och innehållet. Den mest påverkande storlekstaggen är miniatyrbildstaggens innehåll. |
...
Initierar en ny instans av klassen [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) .
...
Initierar en ny instans av klassen [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) med data från en array.
...
Serialiserar EXIF-data. Skriver taggvärdena och innehållet. Den mest påverkande storlekstaggen är miniatyrbildstaggens innehåll.
