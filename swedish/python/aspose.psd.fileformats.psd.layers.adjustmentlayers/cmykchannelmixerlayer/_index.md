---
title: "CmykChannelMixerLayer-klass"
type: docs
weight: 50
url: /sv/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Hämtar den svarta kanalen. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Hämtar cyan-kanalen. |
...
| vänster | int | r/w |  |
| längd | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Hämtar magenta-kanalen. |
| monochrome | bool | r/w | Hämtar eller anger ett värde som indikerar om denna [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) är monokrom. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Hämtar den gula kanalen. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Hämtar index för kanalen med. Returnerar CmykMixerChannel |
...
Hämtar index för kanalen med. Returnerar CmykMixerChannel
