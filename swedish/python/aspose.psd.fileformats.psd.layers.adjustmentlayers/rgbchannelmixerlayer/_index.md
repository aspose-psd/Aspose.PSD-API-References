---
title: "RgbChannelMixerLayer-klass"
type: docs
weight: 180
url: /sv/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Hämtar den blå kanalen. |
| nedre | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Hämtar den gröna kanalen. |
| has_alpha | bool | r |  |
...
| raw_line_size | int | r |  |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Hämtar den röda kanalen. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Hämtar indexet för kanalen med. Returnerar RgbMixerChannel |
...
Hämtar indexet för kanalen med. Returnerar RgbMixerChannel
