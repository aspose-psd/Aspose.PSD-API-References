---
title: "BrightnessContrastLayer-klass"
type: docs
weight: 30
url: /sv/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| ljusstyrka | int | r/w | Hämtar eller anger ljusstyrkan. För PS är intervallet för ljusstyrka från -150 till +150. Men vi ignorerar detta. |
...
| kontrast | int | r/w | Hämtar eller anger kontrasten. För PS är intervallet för kontrast från -50 till +100. Men vi ignorerar detta. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | Laddar 32‑bitars ARGB‑pixlar delvis (i block). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | Laddar rådata. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | Slår samman lagret med angivet lager. |
| normalize_angle() |  |
