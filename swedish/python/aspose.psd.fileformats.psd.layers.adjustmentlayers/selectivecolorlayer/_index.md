---
title: "SelectiveColorLayer klass"
type: docs
weight: 200
url: /sv/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | Hämtar eller anger korrigeringsmetod. |
...
| version | short | r | Hämtar versionen. |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | Hämtar CMYK-korrigering med selektiv färg. |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | Anger CMYK-korrigering med selektiv färg. |
...
Hämtar CMYK-korrigering med selektiv färg.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Selektiva färger. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | CMYK-korrigering. |
...
Anger CMYK-korrigering med selektiv färg.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Typ av selektiva färger. |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | CMYK-korrigering. |
