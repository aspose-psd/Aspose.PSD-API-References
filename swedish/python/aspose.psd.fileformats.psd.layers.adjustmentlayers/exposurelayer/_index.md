---
title: "ExposureLayer-klass"
type: docs
weight: 100
url: /sv/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| borttagen | bool | r |  |
| exponering | float | r/w | Hämtar eller anger exponeringen. För PS är intervallet för exponering från -20 till +20. |
| extra_length | int | r |  |
...
| gamma_correction | float | r/w | Hämtar eller anger GammaCorrection. För PS är intervallet för GammaCorrection från 9.99 till +0.01 |
| has_alpha | bool | r |  |
...
| offset | float | r/w | Hämtar eller anger Offset. För PS är intervallet för Offset från -0.5 till +0.5 |
| opacity | byte | r/w |  |
