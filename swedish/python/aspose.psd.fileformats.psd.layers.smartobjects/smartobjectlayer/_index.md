---
title: "SmartObjectLayer-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [SmartObjectLayer(stream)](#SmartObjectLayer_stream_1) | Initierar en ny instans av [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) klassen. |
## **Properties**
...
| content_type | [SmartObjectType](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype) | r | Hämtar typen av smartobjektlagrets innehåll.<br/>            Det inbäddade smartobjektets innehåll är den inbäddade råa bildfilen: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/).<br/>            Det länkade smartobjektets innehåll är de råa innehållen i den länkade bildfilen om den är tillgänglig: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/).<br/>            Vi stödjer inte inläsning från Adobe� Photoshop� �� Graphics Library när [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) är sant.<br/>            För vanliga länkar, först använder vi [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) för att söka efter filen relativt<br/>            till källbildens sökväg [None](/psd/python-net/aspose.psd/datastreamsupporter/),<br/>            om den inte är tillgänglig tittar vi på [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/),<br/>            om inte, så söker vi efter länken i samma katalog där vår bild finns: [None](/psd/python-net/aspose.psd/datastreamsupporter/). |
| contents | byte | r/w | Hämtar eller anger smartobjektlagrets innehåll.<br/>            Det inbäddade smartobjektets innehåll är den inbäddade råa bildfilen: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) och dess egenskaper.<br/>            Det länkade smartobjektets innehåll är det råa innehållet i den länkade bildfilen om den är tillgänglig och dess egenskaper: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/).<br/>            Vi stödjer inte inläsning från Adobe� Photoshop� �� Graphics Library när [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) är sant.<br/>            För vanliga länkar, först använder vi [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) för att söka efter filen relativt<br/>            till källbildens sökväg [None](/psd/python-net/aspose.psd/datastreamsupporter/),<br/>            om den inte är tillgänglig tittar vi på [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/),<br/>            om inte, så söker vi efter länken i samma katalog där vår bild finns: [None](/psd/python-net/aspose.psd/datastreamsupporter/). |
| contents_bounds | [Rectangle](/psd/python-net/aspose.psd/rectangle) | r/w | Hämtar eller anger smartobjektets innehållsgränser. |
| contents_source | [LinkDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) | r/w | Hämtar eller anger smartobjektets innehållskälla. |
...
| smart_filters | [SmartFilters](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/smartfilters/) | r | Hämtar de smarta filtren. |
...
| warp_settings | [WarpSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.warp/warpsettings/) | r/w | Den hämtar eller anger Warp-parametrar som sattes eller hämtades från resurs (standard) |
...
| [convert_to_linked(linked_path)](#convert_to_linked_linked_path_6) | Konverterar detta inbäddade smarta objekt till ett länkat smart objekt. |
...
| [duplicate_layer()](#duplicate_layer__8) | Skapar ett nytt smart objekt‑lager genom att kopiera detta.<br/>            Observera att för inbäddade smarta objekt delas den inbäddade bilden.<br/>            Om du vill kopiera den inbäddade bilden, använd metoden [SmartObjectLayer.new_smart_object_via_copy()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) . |
| embed_linked() | Bäddar in det länkade smarta objektet i detta lager. |
| [export_contents(file_path)](#export_contents_file_path_9) | Exporterar det inbäddade eller länkade innehållet till en fil. |
...
| [load_contents(options)](#load_contents_options_32) | Hämtar det inbäddade eller länkade bildinnehållet i smarta objekt‑lagret. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_33) | Laddar 32‑bitars ARGB‑pixlar delvis (i block). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_34) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_35) | Laddar rådata. |
| merge_layer_to(layer_to_merge_into) |  |
| [new_smart_object_via_copy()](#new_smart_object_via_copy__36) | Skapar ett nytt smart objekt‑lager genom att kopiera detta.<br/>            Reproducerar funktionaliteten `Layer -&gt; Smart Objects -&gt; New Smart Object via Copy` i Adobe Photoshop.<br/>            Observera att den endast är aktiverad för inbäddade smarta objekt eftersom den inbäddade bilden också kopieras.<br/>            Om du vill dela den inbäddade bilden, använd metoden [SmartObjectLayer.duplicate_layer()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) . |
| normalize_angle() |  |
...
| [relink_to_file(linked_path)](#relink_to_file_linked_path_39) | Länkar om den länkade smartobjektet till en ny fil.<br/>            Det behövs inte att anropa UpdateModifiedContent-metoden efteråt. |
| replace_color(old_color, old_color_diff, new_color) |  |
| replace_color(old_color_argb, old_color_diff, new_color_argb) |  |
| [replace_contents(image)](#replace_contents_image_40) | Ersätter smartobjektets innehåll som är inbäddat i smartobjektlagret. |
| [replace_contents(image, resolution)](#replace_contents_image_resolution_41) | Ersätter smartobjektets innehåll som är inbäddat i smartobjektlagret. |
| [replace_contents(linked_path)](#replace_contents_linked_path_42) | Ersätter innehållet med en fil.<br/>            Det behövs inte att anropa UpdateModifiedContent-metoden efteråt. |
| [replace_contents(linked_path, resolution)](#replace_contents_linked_path_resolution_43) | Ersätter innehållet med en fil.<br/>            Det behövs inte att anropa UpdateModifiedContent-metoden efteråt. |
...
| update_modified_content() | Uppdaterar smartobjektlagrets bildcache med det modifierade innehållet. |
...
Initierar en ny instans av [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) klassen.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| stream | _io.BufferedRandom | Strömmen av objekt |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| linked_path | string | Den länkade sökvägen. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| file_path | string | Exportfilens sökväg. |
...
Hämtar det inbäddade eller länkade bildinnehållet i smarta objekt‑lagret.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| options | [LoadOptions](/psd/python-net/aspose.psd/loadoptions) | Alternativen. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [Image](/psd/python-net/aspose.psd/image) | Den laddade [Image](/psd/python-net/aspose.psd/image/) smartobjektinstansen. |
...
Länkar om den länkade smartobjektet till en ny fil.<br/>            Det behövs inte att anropa UpdateModifiedContent-metoden efteråt.
...
Ersätter smartobjektets innehåll som är inbäddat i smartobjektlagret.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | Bilden. |
...
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | Bilden. |
| resolution | [ResolutionSetting](/psd/python-net/aspose.psd/resolutionsetting) | Upplösningsinställningarna. Om null kommer bildens upplösning att användas. |
...
Ersätter innehållet med en fil.<br/>            Det behövs inte att anropa UpdateModifiedContent-metoden efteråt.
