---
title: "AliasStructure klass"
type: docs
weight: 10
url: /sv/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Initierar en ny instans av klassen [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Beskrivning** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifierar structure key. |
| data_length | int | r | Hämtar den exakta datalängden i byte. |
| full_path | string | r/w | Hämtar eller anger den fullständiga sökvägen. |
...
Initierar en ny instans av klassen [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/).
