---
title: "IntegerStructure klass"
type: docs
weight: 80
url: /sv/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **Beskrivning** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | Initierar en ny instans av klassen [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Beskrivning** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Den heltalsstrukturens nyckel. |
...
| värde | int | r/w | Hämtar eller anger ett heltalsvärde. |
## **Methods**
| **Name** | **Beskrivning** |
| :- | :- |
...
Initierar en ny instans av klassen [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/).
