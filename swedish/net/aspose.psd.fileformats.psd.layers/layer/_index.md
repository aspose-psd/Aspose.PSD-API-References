...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer klass. PSDlagret.
type: docs
weight: 2080
...
| namn | Beskrivning |
| --- | --- |
| [Layer](layer/#constructor)() | Initierar en ny instans av`Layer` klass. Konstruktör för lat initialisering. |
| [Layer](layer/#constructor_3)(Stream) | Initierar en ny instans av`Layer` class. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Initierar en ny instans av`Layer` class. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Initierar en ny instans av`Layer` klass från byte arrays. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Sparar objektets data till den angivna filplatsen i det angivna filformatet enligt sparalternativ. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Sparar bildens data till den angivna strömmen i det angivna filformatet enligt sparalternativ. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Sparar objektets data till den angivna filplatsen i det angivna filformatet enligt sparalternativ. |
...
| namn | Beskrivning |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Representerar blandningslägessignatur. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | Lagerhuvudets storlek. |
