...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer klass. Sektionsavdelarlagret för att markera gränserna för mappen lagergrupp.
type: docs
weight: 3410
...
Sektionsavdelarlagret för att markera gränserna för mappen (lagergrupp).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Får ett värde som indikerar om denna instans är synlig i gruppen (om lagret inte är i gruppen betyder det rotgrupp). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Får[`LayerGroup`](../layergroup/) det är relaterat till detta`SectionDividerLayer` instans. |
