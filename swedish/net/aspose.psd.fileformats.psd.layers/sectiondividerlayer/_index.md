---
title: "Klass SectionDividerLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer-klass. Sektiondelarlagret för att markera gränserna för mappens lagergrupp"
type: docs
weight: 3810
url: /sv/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
{{< psd/tize >}}
## SectionDividerLayer class

Avsnittsskiljelager för att markera gränserna för mappen (lagergupp).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Hämtar ett värde som indikerar om detta objekt är synligt i grupp(Om lagret inte är i en grupp betyder det rotgrupp). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Hämtar [`LayerGroup`](../layergroup/) som är relaterad till detta `SectionDividerLayer`-instans. |
