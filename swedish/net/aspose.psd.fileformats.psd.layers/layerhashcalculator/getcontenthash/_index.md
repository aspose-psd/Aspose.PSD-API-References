...
description: LayerHashCalculator metod. Hämtar innehållshash.
type: docs
weight: 40
...
Hash för de betydande parametrarna för lager. Denna hash är olika för alla typer av lager
