...
description: "LayerHashCalculator metod. Hämtar innehållshashen"
type: docs
weight: 40
url: /sv/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/getcontenthash/
---
{{< psd/tize >}}
## LayerHashCalculator.GetContentHash method

Hämtar innehålls‑hashen.
...
Hash för de betydande parametrarna för lager. Denna hash är olika för alla lagertyper
