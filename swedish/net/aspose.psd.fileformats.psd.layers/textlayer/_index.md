...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer klass. Textlagret class
type: docs
weight: 3560
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | Hämtar typsnittet. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Hämtar texten för lagret |
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Hämtar eller ställer in den textbundna rutan. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Får färgen på texten. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Hämtar textdelarna. |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Hämtar eller ställer in det översta lagrets position. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Hämtar eller ställer in transformationsmatrisen |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Hämtar teckensnittsuppsättningen för textlagret. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Ändrar storleken på bilden. StandardenLeftTopToLeftTopanvänds. |
