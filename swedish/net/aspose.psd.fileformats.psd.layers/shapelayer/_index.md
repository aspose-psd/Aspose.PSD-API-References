---
title: "Klass ShapeLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer-klass. Shape-lager. Inkapslar logiken för arbete med Shape-lager och relaterade resurser."
type: docs
weight: 3820
url: /sv/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class
...
| Namn | Beskrivning |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Initierar en ny instans av klassen `ShapeLayer`. Alla resurser skapas i sitt standardtillstånd. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Hämtar eller anger fyllningsinställningar för den interna ytan av former i Shape-lagret. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Hämtar mängden Paths som finns i ett Shape-lager. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Hämtar eller anger linjestilsinställningar för former. |
...
| Namn | Beskrivning |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Skapar en ny instans av klassen `ShapeLayer`. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Uppdaterar resurser från Shape-lagrets egenskaper. |
