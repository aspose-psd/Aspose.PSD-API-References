---
title: "Klass ArtboardLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer-klass. Artboard‑lagerklassen"
type: docs
weight: 1990
url: /sv/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class

Artboard-lagerklassen.
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Hämtar eller anger artboardens bakgrundsfärg. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Hämtar eller anger nyckeln för blandningsläget. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | Hämtar eller anger ett värde som indikerar om `ArtboardLayer` har bakgrundsfärgen. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Hämtar eller anger om mappen är öppen; om den sätts till `true` blir gruppen öppen vid start, annars minimerad. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Hämtar lagren i lagergruppen |
...
| Namn | Beskrivning |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Lägger till lagret i lagergruppen. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Lägger till lagergruppen. |
