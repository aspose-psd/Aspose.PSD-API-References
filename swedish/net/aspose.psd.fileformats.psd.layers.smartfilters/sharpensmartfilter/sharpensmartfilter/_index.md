...
description: "SharpenSmartFilter-konstruktorn. Initierar en ny instans av SharpenSmartFilter-klassen"
type: docs
weight: 10
url: /sv/net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/sharpensmartfilter/
---
{{< psd/tize >}}
## SharpenSmartFilter() {#constructor}

Initierar en ny instans av [`SharpenSmartFilter`](../)-klassen.
...
| --- | --- | --- |
| sourceDescriptor | DescriptorStructure | Deskriptörstrukturen med smartfilterinformation. |
