...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | Hämtar eller ställer in ljusstyrkan. För PS är ljusstyrkan från -150 till +150. Men vi ignorerar detta. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | Hämtar eller ställer in kontrasten. För PS är kontrastområdet från -50 till +100. Men vi ignorerar detta. |
