...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer klass. Kurvorjusteringslager
type: docs
weight: 1730
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Hämtar eller ställer in ett värde som indikerar om denna instans är kontinuerlig hanterare som används. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Hämtar eller ställer in ett värde som indikerar om denna instans är diskret hanterare som används. |
