---
title: "Klass CurvesLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer-klass. Curves justeringslager"
type: docs
weight: 1790
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
{{< psd/tize >}}
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Hämtar eller anger ett värde som indikerar om den här instansen använder en kontinuerlig manager. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Hämtar eller anger ett värde som indikerar om den här instansen använder en diskret manager. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | Hämtar kurvhanteraren. |
