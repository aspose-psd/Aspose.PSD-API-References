...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer klass. HueSaturation justeringslager.
type: docs
weight: 1750
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
## HueSaturationLayer class

HueSaturation justeringslager.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Hämtar eller ställer in ett värde som indikerar om detta`HueSaturationLayer` är colorize. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Hämtar eller ställer in nyansen. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | Får eller ställer in ljusheten. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | Hämtar eller ställer in mättnaden. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | Hämtar intervallet. |
