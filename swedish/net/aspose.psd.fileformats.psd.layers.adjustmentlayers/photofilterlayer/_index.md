---
title: "Klass PhotoFilterLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer-klass. PhotoFilter-justeringslager"
type: docs
weight: 1860
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
{{< psd/tize >}}
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Hämtar eller anger RGB-färgen för filtret. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Hämtar eller anger densiteten för filtret. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Hämtar eller anger ett värde som indikerar om [preserve luminosity]. |
