...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer klass. PhotoFilterjusteringslager.
type: docs
weight: 1790
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Hämtar eller ställer in RGB-färgen för filtret. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Hämtar eller ställer in tätheten för filter |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Hämtar eller ställer in ett värde som anger om [bevara ljusstyrkan]. |
