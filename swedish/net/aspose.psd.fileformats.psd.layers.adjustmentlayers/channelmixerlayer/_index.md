...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer klass. Justeringslager för kanalmixer.
type: docs
weight: 1690
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
## ChannelMixerLayer class

Justeringslager för kanalmixer.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Hämtar eller ställer in ett värde som indikerar om detta`ChannelMixerLayer` är monokrom. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Hämtar index för kanalen genom. Kan returnera RgbMixerChannel eller CmykMixerChannel |
