---
title: "Klass ChannelMixerLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer-klass. Channel Mixer justeringslager"
type: docs
weight: 1730
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Hämtar eller anger ett värde som indikerar om detta `ChannelMixerLayer` är monokrom. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Hämtar kanalens index. Kan returnera RgbMixerChannel eller CmykMixerChannel. |
