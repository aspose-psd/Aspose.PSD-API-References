...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes enum. Korrigeringsmetod i selektiv färgjusteringslager"
type: docs
weight: 1780
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
## CorrectionMethodTypes enumeration

Korrigeringsmetod i selektiv färg justeringslager.
...
| --- | --- | --- |
| Relative | `0` | Tillämpa färgkorrigering i relativt läge. |
| Absolute | `1` | Tillämpa färgkorrigering i absolut läge. |
