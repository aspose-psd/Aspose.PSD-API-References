...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Hämtar eller anger Exposure. För PS är intervallet för Exposure från -20 till +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Hämtar eller anger GammaCorrection. För PS är intervallet för GammaCorrection från 9,99 till +0,01. |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Hämtar eller anger Offset. För PS är intervallet för Offset från -0,5 till +0,5. |
