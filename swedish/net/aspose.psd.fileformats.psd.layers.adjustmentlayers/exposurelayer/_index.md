...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer klass. Exponeringsjusteringslager.
type: docs
weight: 1740
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
## ExposureLayer class
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Hämtar eller ställer in exponeringen. För PS är exponeringsintervallet från -20 till +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Hämtar eller ställer in GammaCorrection. För PS är intervallet för GammaCorrection från 9,99 till +0,01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Hämtar eller ställer in offset. För PS är intervallet för offset från -0,5 till +0,5 |
