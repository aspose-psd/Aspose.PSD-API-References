...
description: "SelectiveColorLayer-metod. Hämtar cmyk-korrigeringen via selektiv färg"
type: docs
weight: 30
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | Selektiva färger. |
