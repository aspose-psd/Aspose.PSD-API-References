...
description: "SelectiveColorLayer-metod. Anger cmyk-korrigeringen via selektiv färg"
type: docs
weight: 40
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | Typ av selektiva färger. |
| korrektion | CmykCorrection | Cmyk-korrigering. |
