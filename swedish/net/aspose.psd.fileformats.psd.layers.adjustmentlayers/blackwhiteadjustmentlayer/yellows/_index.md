...
description: BlackWhiteAdjustmentLayer fast egendom. Hämtar eller ställer in det gula värdet.
type: docs
weight: 130
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/
---
## BlackWhiteAdjustmentLayer.Yellows property

Hämtar eller ställer in det gula värdet.
