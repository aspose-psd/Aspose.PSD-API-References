...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorsTypes enum. Färgt typer i selektiv färgjusteringslager"
type: docs
weight: 1910
url: /sv/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes/
---
{{< psd/tize >}}
## SelectiveColorsTypes enumeration

Färgtyper i selektiv färg justeringslager.
...
| --- | --- | --- |
| Reds | `0` | De röda färgerna. |
| Yellows | `1` | De gula färgerna. |
| Greens | `2` | De gröna färgerna. |
| Cyans | `3` | De cyanfärgerna. |
| Blues | `4` | De blå färgerna. |
| Magentas | `5` | De magentafärgerna. |
| Whites | `6` | De vita färgerna. |
| Neutrals | `7` | De neutrala färgerna. |
| Blacks | `8` | De svarta färgerna. |
