...
| Namn | Beskrivning |
| --- | --- |
| [StreamSource](streamsource/#constructor)(Stream) | Initierar en ny instans av klassen `StreamSource`. |
| [StreamSource](streamsource/#constructor_1)(Stream, bool) | Initierar en ny instans av klassen `StreamSource`. |

## Egenskaper

| Namn | Beskrivning |
| --- | --- |
| [DisposeStream](../../aspose.psd.sources/streamsource/disposestream/) { get; } | Hämtar ett värde som indikerar om strömmen ska avyttras när behållaren avyttras. |
