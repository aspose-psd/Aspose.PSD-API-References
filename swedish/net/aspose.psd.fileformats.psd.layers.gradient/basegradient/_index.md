---
title: "Klass BaseGradient"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient klass. Basgradient definitionsklass. Den innehåller gemensamma egenskaper för båda gradienttyperna Solid och Noise"
type: docs
weight: 2190
url: /sv/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| Namn | Beskrivning |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | Hämtar läget för denna gradient. Bestämmer 'Gradient Type' = 'Solid/Noise' (0/1). |
