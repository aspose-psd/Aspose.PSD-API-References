...
description: ISmartFilterRenderer metod. Återger det aktuella smarta filtret på pixeldata.
type: docs
weight: 10
url: /sv/net/aspose.psd.fileformats.psd.layers.smartfilters.rendering/ismartfilterrenderer/render/
---
## ISmartFilterRenderer.Render method

Återger det aktuella smarta filtret på pixeldata.
...
| --- | --- | --- |
| pixelsData | PixelsData | Pixeldata. |

### Returvärde

Returnerar bearbetade pixeldata.
...
* namnutrymme [Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.Rendering](../../ismartfilterrenderer/)
