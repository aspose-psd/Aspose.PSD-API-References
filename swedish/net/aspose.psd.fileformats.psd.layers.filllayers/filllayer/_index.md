---
title: "Klass FillLayer"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer-klass. Fyllningslager. Färgfyll, gradientfyll eller mönsterfyll lager som skiljer sig med FillSettings"
type: docs
weight: 2020
...
Fyllningslager. Färgfyll, gradientfyll eller mönsterfyll lager som skiljer sig med [`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | Hämtar eller anger fyllningsinställningarna. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Hämtar fyllningens typ. |
...
| Namn | Beskrivning |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Skapa en ny instans av `FillLayer`-klassen efter fyllningstyp. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Uppdaterar pixeldata för fyllningslagret baserat på den aktuella [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
