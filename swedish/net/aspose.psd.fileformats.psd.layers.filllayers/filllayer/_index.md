...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer klass. Fyll lager. Färgfyllning Gradientfyllning eller Mönsterfyllningslager som skiljer sig åtFillSettings
type: docs
weight: 1910
url: /sv/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

Fyll lager. Färgfyllning, Gradientfyllning eller Mönsterfyllningslager som skiljer sig åt[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Hämtar fyllningsinställningarna. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Hämtar typen av fyllning. |
...
| namn | Beskrivning |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Bygg en ny instans av`FillLayer` klass efter typ av fyllning. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Ersätter alla icke-transparenta färger med ny färg och bevarar det ursprungliga alfavärdet för att spara jämna kanter. Obs: om du använder det på bilder utan genomskinlighet kommer alla färger att ersättas med en enda. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Uppdaterar data för fylllagerpixlar enligt faktiska[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* namnutrymme [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
