...
description: RasterImage fast egendom. Hämtar eller ställer in den vertikala upplösningen i pixlar per tum för dettaRasterImage .
type: docs
weight: 160
url: /sv/net/aspose.psd/rasterimage/verticalresolution/
---
## RasterImage.VerticalResolution property

Hämtar eller ställer in den vertikala upplösningen, i pixlar per tum, för detta[`RasterImage`](../) .
