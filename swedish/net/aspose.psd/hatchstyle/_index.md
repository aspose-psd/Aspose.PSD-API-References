...
description: Aspose.PSD.HatchStyle uppräkning. Anger de olika mönster som är tillgängliga förHatchBrush objekt.
type: docs
weight: 4340
url: /sv/net/aspose.psd/hatchstyle/
---
## HatchStyle enumeration

Anger de olika mönster som är tillgängliga för[`HatchBrush`](../../aspose.psd.brushes/hatchbrush/) objekt.
...
| WideUpwardDiagonal | `23` | Anger diagonala linjer som lutar åt vänster från topppunkter till bottenpunkter, har samma avstånd som luckastil BackwardDiagonal och är tredubbla med dess bredd, men är inte kantutjämnade. |
