...
description: "VectorShapeOriginSettings egenskap. Hämtar ett värde som indikerar om detta objekt har transformegenskapen"
type: docs
weight: 100
...
Hämtar ett värde som indikerar om den här instansen har transform‑egenskapen.
...
`true` om detta objekt har transformegenskapen; annars `false`.
