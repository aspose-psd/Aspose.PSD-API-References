...
description: "VectorShapeOriginSettings konstruktor. Initierar en ny instans av klassen VectorShapeOriginSettings."
type: docs
weight: 10
url: /sv/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

Initierar en ny instans av klassen [`VectorShapeOriginSettings`](../).
...
| --- | --- | --- |
| isShapeInvalidated | Boolean | Den shape is invalidated värdet. |
| originIndex | Int32 | Den shape origin index. |
