...
description: VectorShapeOriginSettings fast egendom. Hämtar eller ställer in ursprungsboxens hörn.
type: docs
weight: 110
...
Hämtar eller ställer in ursprungsboxens hörn.
