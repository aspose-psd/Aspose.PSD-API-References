...
description: "InitialFillRuleRecord-konstruktor. Initierar en ny instans av klassen InitialFillRuleRecord"
type: docs
weight: 10
url: /sv/net/aspose.psd.fileformats.core.vectorpaths/initialfillrulerecord/initialfillrulerecord/
---
{{< psd/tize >}}
## InitialFillRuleRecord() {#constructor}

Initierar en ny instans av klassen [`InitialFillRuleRecord`](../).
...
| --- | --- | --- |
| isFillStartsWithAllPixels | Boolean | Fyllning startar med alla pixlar. |
