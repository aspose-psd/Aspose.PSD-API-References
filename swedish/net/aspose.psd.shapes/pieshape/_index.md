...
| Namn | Beskrivning |
| --- | --- |
| [PieShape](pieshape/#constructor)() | Initierar en ny instans av `PieShape`-klassen. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | Initierar en ny instans av `PieShape`-klassen. |
...
| override [Segments](../../aspose.psd.shapes/pieshape/segments/) { get; } | Hämtar formens segment. |
