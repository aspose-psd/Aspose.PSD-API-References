...
| namn | Beskrivning |
| --- | --- |
| [ArcShape](arcshape/#constructor)() | Initierar en ny instans av`ArcShape` class. |
| [ArcShape](arcshape/#constructor_1)(RectangleF, float, float) | Initierar en ny instans av`ArcShape` class. |
| [ArcShape](arcshape/#constructor_2)(RectangleF, float, float, bool) | Initierar en ny instans av`ArcShape` class. |
...
| [EndPoint](../../aspose.psd.shapes/arcshape/endpoint/) { get; } | Får slutformpunkten. |
...
| [IsClosed](../../aspose.psd.shapes/arcshape/isclosed/) { get; set; } | Hämtar eller ställer in ett värde som anger om ordnad form är stängd. Vid bearbetning av sluten ordnad form har start- och slutpunkterna ingen betydelse. |
...
| override [Segments](../../aspose.psd.shapes/arcshape/segments/) { get; } | Hämtar formsegmenten. |
| [StartAngle](../../aspose.psd.shapes/pieshape/startangle/) { get; set; } | Hämtar eller ställer in startvinkeln. |
| [StartPoint](../../aspose.psd.shapes/arcshape/startpoint/) { get; } | Får startpunkten för formen. |
...
| [Reverse](../../aspose.psd.shapes/arcshape/reverse/)() | Vänder om ordningen på punkterna för denna form. |
