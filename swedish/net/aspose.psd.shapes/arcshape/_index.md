---
title: "Klass ArcShape"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.Shapes.ArcShape klass. Representerar en bågform"
type: docs
weight: 5960
url: /sv/net/aspose.psd.shapes/arcshape/
---
{{< psd/tize >}}
## ArcShape class
...
| Namn | Beskrivning |
| --- | --- |
| [ArcShape](arcshape/#constructor)() | Initierar en ny instans av klassen `ArcShape`. |
| [ArcShape](arcshape/#constructor_1)(RectangleF, float, float) | Initierar en ny instans av klassen `ArcShape`. |
| [ArcShape](arcshape/#constructor_2)(RectangleF, float, float, bool) | Initierar en ny instans av klassen `ArcShape`. |
...
| [EndPoint](../../aspose.psd.shapes/arcshape/endpoint/) { get; } | Hämtar den avslutande formpunkten. |
...
| [IsClosed](../../aspose.psd.shapes/arcshape/isclosed/) { get; set; } | Hämtar eller anger ett värde som indikerar om den ordnade formen är sluten. Vid bearbetning av en sluten ordnad form har start- och slutpunkterna ingen betydelse. |
...
| override [Segments](../../aspose.psd.shapes/arcshape/segments/) { get; } | Hämtar formens segment. |
| [StartAngle](../../aspose.psd.shapes/pieshape/startangle/) { get; set; } | Hämtar eller anger startvinkeln. |
| [StartPoint](../../aspose.psd.shapes/arcshape/startpoint/) { get; } | Hämtar den startande formpunkten. |
| [SweepAngle](../../aspose.psd.shapes/pieshape/sweepangle/) { get; set; } | Hämtar eller anger svepvinkeln. |

## Metoder

| Namn | Beskrivning |
| --- | --- |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds)(Matrix) | Hämtar objektets gränser. |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds_1)(Matrix, Pen) | Hämtar objektets gränser. |
| [Reverse](../../aspose.psd.shapes/arcshape/reverse/)() | Vänder ordningen på punkterna för denna form. |
