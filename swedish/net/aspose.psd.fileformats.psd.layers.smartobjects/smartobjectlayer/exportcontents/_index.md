...
description: SmartObjectLayer metod. Exporterar det inbäddade eller länkade innehållet till en fil.
type: docs
weight: 100
url: /sv/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/exportcontents/
---
...
| --- | --- | --- |
| filePath | String | Exportfilens sökväg. |
