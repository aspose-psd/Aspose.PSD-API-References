...
description: "SmartObjectLayer egenskap. Den hämtar eller anger Warp‑parametrar som sattes eller hämtades från resursens standard."
type: docs
weight: 80
url: /sv/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

Den hämtar eller anger Warp-parametrar som sattes eller hämtades från resurs (standard)
