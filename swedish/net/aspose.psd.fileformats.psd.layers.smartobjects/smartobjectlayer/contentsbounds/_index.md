...
description: SmartObjectLayer fast egendom. Hämtar eller ställer in gränserna för innehållet i smarta objekt.
type: docs
weight: 20
...
Hämtar eller ställer in gränserna för innehållet i smarta objekt.
