...
description: "IGradientFillSettings egenskap. Hämtar eller anger ett värde som indikerar om detta IGradientFillSettings är omvänt"
type: docs
weight: 80
...
Hämtar eller anger ett värde som indikerar om detta [`IGradientFillSettings`](../) är omvänt.
