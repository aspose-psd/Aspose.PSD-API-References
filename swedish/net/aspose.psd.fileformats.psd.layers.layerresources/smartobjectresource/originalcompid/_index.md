...
description: "SmartObjectResource‑egenskap. Hämtar det ursprungliga ID‑t för den för närvarande valda Comp‑en för underdokumentet, som blir 1 om ingen är vald. Denna egenskap hämtar det ursprungliga lager‑Comp‑valets identifierare för smartobjektlagret i PSD‑filen. Lager‑comps i Smart Objects"
type: docs
weight: 140
...
Hämtar det ursprungliga ID:t för den för närvarande valda kompositionen för underdokumentet, vilket blir -1 om ingen är vald. Denna egenskap hämtar den ursprungliga lagerkompositionsvalets identifierare för smartobjektlagret i PSD‑filen. [Layer comps in Smart Objects](https://helpx.adobe.com/photoshop/using/layer-comps.html)
...
Det ursprungliga ID:t för den för närvarande valda kompositionen för underdokumentet i PSD-bilden, vilket blir -1 om ingen är vald.
