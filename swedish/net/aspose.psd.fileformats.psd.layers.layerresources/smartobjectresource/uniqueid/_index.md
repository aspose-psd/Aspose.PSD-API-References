...
description: "SmartObjectResource-egenskap. Hämtar eller anger det globalt unika identifieraren för smartobjektlagrets data SmartObjectResource i PSD-bilden"
type: docs
weight: 220
...
Hämtar eller anger det globalt unika identifieraren för smartobjektlagrets data [`SmartObjectResource`](../) i PSD-bilden.
...
Det globala unika identifieraren för smartobjektlagrets data [`SmartObjectResource`](../).
