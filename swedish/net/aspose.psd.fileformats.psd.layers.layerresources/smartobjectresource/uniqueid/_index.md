...
description: SmartObjectResource fast egendom. Hämtar eller ställer in den globala unika identifieraren för data för smarta objektlagerSmartObjectResource i PSDbilden.
type: docs
weight: 240
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

Hämtar eller ställer in den globala unika identifieraren för data för smarta objektlager[`SmartObjectResource`](../) i PSD-bilden.
...
Den globala unika identifieraren för data för smarta objektlager[`SmartObjectResource`](../) .
