...
description: BlwhResource fast egendom. Hämtar eller ställer in Tint Color ARGBvärdet.
type: docs
weight: 120
...
Hämtar eller ställer in Tint Color ARGB-värdet.
