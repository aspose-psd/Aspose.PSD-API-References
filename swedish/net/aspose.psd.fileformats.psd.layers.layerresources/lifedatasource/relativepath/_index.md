...
description: "LiFeDataSource egenskap. Hämtar eller anger den relativa sökvägen för den externa filen i LiFE-datakällan för PSD LnkE-resursen."
type: docs
weight: 100
...
| undantag | villkor |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt RelativePath-egenskapen, den är endast tillgänglig för liFE-datakällan. |
