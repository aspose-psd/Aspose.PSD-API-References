...
description: LiFeDataSource fast egendom. Hämtar eller ställer in den relativa sökvägen för den externa filen i LiFEdatakällan för PSD LnkEresursen.
type: docs
weight: 100
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
## LiFeDataSource.RelativePath property

Hämtar eller ställer in den relativa sökvägen för den externa filen i LiFE-datakällan för PSD LnkE-resursen.
...
Den relativa filsökvägen.

### Undantag

| undantag | skick |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt RelativePath-egenskapen, den är endast tillgänglig för liFE data source |
