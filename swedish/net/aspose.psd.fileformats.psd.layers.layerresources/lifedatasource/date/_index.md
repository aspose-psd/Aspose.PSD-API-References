...
description: "LiFeDataSource egenskap. Hämtar eller anger det senaste skrivdatumet och -tiden för den externa filen i LiFE-datakällan för PSD LnkE-resursen"
type: docs
weight: 40
...
Hämtar eller anger sista skrivdatum och -tid för den externa filen i LiFE-datakällan för PSD LnkE‑resursen.
...
Det senaste skrivdatumet och -tiden för den externa filen.

### Undantag

| undantag | villkor |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt Date-egenskapen, den är endast tillgänglig för liFE-datakällan med version 3 eller högre |
