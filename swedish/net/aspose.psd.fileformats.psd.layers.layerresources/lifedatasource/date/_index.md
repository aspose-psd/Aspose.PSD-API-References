...
description: LiFeDataSource fast egendom. Hämtar eller ställer in sista skrivdatum och tidpunkt för den externa filen i LiFEdatakällan för PSD LnkEresursen.
type: docs
weight: 40
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
## LiFeDataSource.Date property

Hämtar eller ställer in sista skrivdatum och tidpunkt för den externa filen i LiFE-datakällan för PSD LnkE-resursen.
...
Senaste skrivdatum och tidpunkt för den externa filen.

### Undantag

| undantag | skick |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt Date-egenskapen, den är endast tillgänglig för livsdatakällan med version 3 eller senare |
