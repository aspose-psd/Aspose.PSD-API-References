...
description: LiFeDataSource fast egendom. Hämtar eller ställer in referensen för grafikbibliotekselementet för Adobe Photoshop CC Libraries.
type: docs
weight: 60
...
| undantag | skick |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt ElementRef-egenskapen, den är endast tillgänglig för livsdatakällan när IsLibrary är true |
