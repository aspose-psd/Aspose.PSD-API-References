...
description: "LiFeDataSource-egenskap. Hämtar eller anger referensen till grafikbibliotekets element för Adobe Photoshop CC Libraries"
type: docs
weight: 60
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
{{< psd/tize >}}
...
Referensen till grafikbibliotekets element.

### Undantag

| undantag | villkor |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt ElementRef-egenskapen, den är endast tillgänglig för liFE-datakälla när IsLibrary är sant. |
