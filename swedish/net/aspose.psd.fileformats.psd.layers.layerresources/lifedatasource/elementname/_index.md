...
description: "LiFeDataSource egenskap. Hämtar eller anger grafikbibliotekets elementnamn för Adobe Photoshop CC Libraries"
type: docs
weight: 50
...
| undantag | villkor |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt ElementName-egenskapen, den är endast tillgänglig för liFE-datakällan när IsLibrary är sant |
