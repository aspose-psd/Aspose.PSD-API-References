...
description: LiFeDataSource fast egendom. Hämtar eller ställer in namnet på grafikbibliotekselementet för Adobe Photoshop CC Libraries.
type: docs
weight: 50
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

Hämtar eller ställer in namnet på grafikbibliotekselementet för Adobe® Photoshop® CC Libraries.
...
Grafikbibliotekets elementnamn.

### Undantag

| undantag | skick |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt egenskapen ElementName, den är endast tillgänglig för livsdatakällan när IsLibrary är true |
