...
description: "LiFeDataSource-egenskap. Hämtar eller anger storleken på den externa filen i LiFE-datakällan för PSD LnkE-resursen."
type: docs
weight: 80
...
| undantag | villkor |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt FileSize-egenskapen, den är endast tillgänglig för liFE-datakälla. |
