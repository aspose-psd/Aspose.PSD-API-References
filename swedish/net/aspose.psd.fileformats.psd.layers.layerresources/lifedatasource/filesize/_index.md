...
description: LiFeDataSource fast egendom. Hämtar eller ställer in storleken på den externa filen i LiFEdatakällan för PSD LnkEresursen.
type: docs
weight: 80
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
## LiFeDataSource.FileSize property

Hämtar eller ställer in storleken på den externa filen i LiFE-datakällan för PSD LnkE-resursen.
...
| undantag | skick |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt FileSize-egenskapen, den är endast tillgänglig för liFE data source |
