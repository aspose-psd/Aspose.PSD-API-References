...
description: "LiFeDataSource-egenskap. Hämtar eller anger grafikbibliotekets AdobeStockId för Adobe Photoshop CC Libraries."
type: docs
weight: 20
...
Grafikbibliotekets Adobe Stock-identifierare.

### Undantag

| undantag | villkor |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt AdobeStockId-egenskapen, den är endast tillgänglig för liFE-datakälla när IsLibrary är sant. |
