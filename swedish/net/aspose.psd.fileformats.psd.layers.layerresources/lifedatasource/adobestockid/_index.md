...
description: LiFeDataSource fast egendom. Hämtar eller ställer in grafikbiblioteket AdobeStockId för Adobe Photoshop CC Libraries.
type: docs
weight: 20
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

Hämtar eller ställer in grafikbiblioteket AdobeStockId, för Adobe® Photoshop® CC Libraries.
...
Grafikbiblioteket Adobe Stock Identifier.

### Undantag

| undantag | skick |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Du kan inte komma åt AdobeStockId-egenskapen, den är endast tillgänglig för livsdatakällan när IsLibrary är true |
