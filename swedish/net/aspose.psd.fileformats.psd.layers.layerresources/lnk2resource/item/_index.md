...
description: "Lnk2Resource egenskap. Hämtar `LiFdDataSource` på angivet index"
type: docs
weight: 20
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
{{< psd/tize >}}
## Lnk2Resource indexer

Hämtar [`LiFdDataSource`](../../lifddatasource/) på angivet index.
...
Instansen av [`LiFdDataSource`](../../lifddatasource/).

### Property Value

Den [`LiFdDataSource`](../../lifddatasource/).
