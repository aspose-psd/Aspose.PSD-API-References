...
description: "PtFlResource egenskap. Hämtar eller anger ett värde som indikerar om detta objekt är länkat till lager"
type: docs
weight: 40
...
`true` om detta objekt är länkat till lager; annars, `false`.
