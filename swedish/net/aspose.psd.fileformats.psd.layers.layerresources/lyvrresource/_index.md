---
title: "Klass LyvrResource"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource klass. Resursen som representerar Photoshop-versionen av Layer"
type: docs
weight: 3150
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

Resursen som representerar Photoshop‑versionen av lager.
...
| Namn | Beskrivning |
| --- | --- |
| [LyvrResource](lyvrresource/)() | Standardkonstruktorn. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | Hämtar eller anger Photoshop-versionen av Layer. |

## Metoder

| Namn | Beskrivning |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | Sparar resursen till den angivna strömbehållaren. |
...
| Namn | Beskrivning |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | Typverktygsinformationsnyckeln. |
