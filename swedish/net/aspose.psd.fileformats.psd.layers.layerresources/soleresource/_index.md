...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource klass. Definierar klassen SoLeResource som innehåller information om ett smart objektlager i en PSDfil. Is används för att stödja smarta objektlager med externa fillänkar i Adobe Photoshopbilderna.
type: docs
weight: 3030
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
## SoLeResource class

Definierar klassen SoLeResource som innehåller information om ett smart objektlager i en PSD-fil. Is används för att stödja smarta objektlager med externa fillänkar i Adobe® Photoshop®-bilderna.
...
| namn | Beskrivning |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Initierar en ny instans av`SoLeResource` class. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Initierar en ny instans av`SoLeResource` class. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/key/) { get; } | Hämtar resursnyckeln för Sole smart objektlager. |
...
| namn | Beskrivning |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | Typverktygets infonyckel: 'SoLE'. |
