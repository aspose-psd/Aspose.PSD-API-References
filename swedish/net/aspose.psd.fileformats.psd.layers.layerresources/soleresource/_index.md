---
title: "Klass SoLeResource"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource-klass. Definierar SoLeResource-klassen som innehåller information om ett smart objekt‑lager i en PSD‑fil. Den används för att stödja smarta objekt‑lager med externa fillänkar i Adobe Photoshop‑bilder."
type: docs
weight: 3380
...
Definierar klassen SoLeResource som innehåller information om ett smart objektlager i en PSD-fil. Används för att stödja smarta objektlager med externa fillänkar i Adobe® Photoshop®-bilderna.
...
| Namn | Beskrivning |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Initierar en ny instans av `SoLeResource`-klassen. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Initierar en ny instans av `SoLeResource`-klassen. |
...
| Namn | Beskrivning |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | Typverktygets informationsnyckel: 'SoLE'. |
