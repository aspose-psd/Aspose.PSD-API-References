---
title: "Klass ArtBResource"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtBResource-klass. Artboard‑informationsdata för Resources"
type: docs
weight: 2520
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/
---
{{< psd/tize >}}
## ArtBResource class

Artboard‑informationsdata för [`Resources`](../../aspose.psd.fileformats.psd.layers/layer/resources/).
...
| Namn | Beskrivning |
| --- | --- |
| [ArtBResource](artbresource/)() | Standardkonstruktorn. |

## Egenskaper

| Namn | Beskrivning |
| --- | --- |
| [ArtboardBackgroundType](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/artboardbackgroundtype/) { get; set; } | Hämtar eller anger [`ArtboardBackgroundType`](./artboardbackgroundtype/) |
| [Color](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/color/) { get; set; } | Hämtar eller anger [`Color`](./color/) |
| [Items](../../aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/) { get; set; } | Hämtar eller anger [`OSTypeStructure`](../ostypestructure/)‑objekten. |
...
| Namn | Beskrivning |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/save/)(StreamContainer, int) | Sparar resursen till den angivna strömbehållaren. |
...
| Namn | Beskrivning |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/typetoolkey/) | Typverktygsinformationsnyckeln. |

## Exempel

Följande kod demonstrerar stöd för Artboard‑resurser.
