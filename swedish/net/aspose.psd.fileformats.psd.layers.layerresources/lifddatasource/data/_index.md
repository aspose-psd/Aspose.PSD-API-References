...
description: LiFdDataSource fast egendom. Hämtar eller ställer in data för inbäddade smarta objekt i PSDfil.
type: docs
weight: 20
...
Hämtar eller ställer in data för inbäddade smarta objekt i PSD-fil.
...
De inbäddade smarta objektdata.
...
* namnutrymme [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lifddatasource/)
