...
description: "PlacedResource egenskap. Hämtar eller anger den globala unika identifieraren för det placerade lagret i PSD-bilden"
type: docs
weight: 170
...
Hämtar eller anger den globala unika identifieraren för det placerade lagret i PSD‑bilden.
