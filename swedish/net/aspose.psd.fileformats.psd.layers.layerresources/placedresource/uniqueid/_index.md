...
description: PlacedResource fast egendom. Hämtar eller ställer in den globala unika identifieraren för det placerade lagret i PSDbilden.
type: docs
weight: 180
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/uniqueid/
---
## PlacedResource.UniqueId property

Hämtar eller ställer in den globala unika identifieraren för det placerade lagret i PSD-bilden.
...
Den unika identifieraren för det placerade lagret.
