...
description: PlacedResource fast egendom. Hämtar eller ställer in det totala antalet sidor för det placerade lagret i PSDfilen.
type: docs
weight: 160
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/totalpages/
---
## PlacedResource.TotalPages property

Hämtar eller ställer in det totala antalet sidor för det placerade lagret i PSD-filen.
...
Det totala antalet sidor i det placerade lagret.
