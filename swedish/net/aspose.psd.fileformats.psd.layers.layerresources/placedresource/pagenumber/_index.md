...
description: PlacedResource fast egendom. Hämtar eller ställer in sidnumret för det placerade lagret i PSDfilen.
type: docs
weight: 90
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/pagenumber/
---
## PlacedResource.PageNumber property

Hämtar eller ställer in sidnumret för det placerade lagret i PSD-filen.
...
Sidnumret för det placerade lagret.
