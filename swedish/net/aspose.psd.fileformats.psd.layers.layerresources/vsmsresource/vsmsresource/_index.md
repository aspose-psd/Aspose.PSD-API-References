...
description: VsmsResource byggare. Initierar en ny instans avVsmsResource class.
type: docs
weight: 10
url: /sv/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/vsmsresource/
---
## VsmsResource(byte[]) {#constructor_1}

Initierar en ny instans av[`VsmsResource`](../) class.
...
| undantag | skick |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Ogiltigt Vsms-resursvärde |

### Se även

* class [VsmsResource](../)
* namnutrymme [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../vsmsresource/)
