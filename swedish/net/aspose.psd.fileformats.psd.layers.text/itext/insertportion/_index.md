...
description: IText metod. InfogarITextPortion till angiven position
type: docs
weight: 50
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itext/insertportion/
---
## IText.InsertPortion method

Infogar[`ITextPortion`](../../itextportion/) till angiven position
...
| --- | --- | --- |
| portion | ITextPortion | Portionen. |
| index | Int32 | Indexet. |
