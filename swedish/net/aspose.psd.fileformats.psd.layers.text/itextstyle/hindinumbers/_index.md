...
description: "ITextStyle egenskap. Hämtar eller anger ett värde som visar om hindi-nummer är aktiverade"
type: docs
weight: 150
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
{{< psd/tize >}}
## ITextStyle.HindiNumbers property

Hämtar eller anger ett värde som indikerar om [hindi-nummer].
...
`true` om [hindi-nummer]; annars `false`.
