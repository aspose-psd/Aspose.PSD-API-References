...
description: ITextStyle fast egendom. Hämtar eller ställer in ett värde som anger om hindi tal.
type: docs
weight: 150
...
Hämtar eller ställer in ett värde som anger om [hindi tal].
...
`Sann` if [hindi siffror]; annat,`falsk` .
