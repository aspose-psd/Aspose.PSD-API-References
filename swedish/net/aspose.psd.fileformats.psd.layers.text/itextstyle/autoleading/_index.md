...
description: "ITextStyle egenskap. Hämtar eller anger ett värde som visar om automatisk radavstånd är aktiverat"
type: docs
weight: 20
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
{{< psd/tize >}}
## ITextStyle.AutoLeading property

Hämtar eller anger ett värde som indikerar om [automatisk radavstånd].
...
`true` om [automatisk radavstånd]; annars `false`.
