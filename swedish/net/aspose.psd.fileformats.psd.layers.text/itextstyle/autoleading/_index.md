...
description: ITextStyle fast egendom. Hämtar eller ställer in ett värde som anger om automatisk inledande.
type: docs
weight: 20
...
Hämtar eller ställer in ett värde som anger om [automatisk inledande].
...
`Sann` if [automatisk ledande]; annat,`falsk` .
