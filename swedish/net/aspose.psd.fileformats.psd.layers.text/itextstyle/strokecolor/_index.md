...
description: ITextStyle fast egendom. Hämtar eller ställer in färgen på strecket.
type: docs
weight: 240
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextstyle/strokecolor/
---
## ITextStyle.StrokeColor property

Hämtar eller ställer in färgen på strecket.
