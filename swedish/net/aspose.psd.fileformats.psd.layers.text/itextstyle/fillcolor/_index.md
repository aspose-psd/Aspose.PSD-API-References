...
description: ITextStyle fast egendom. Hämtar eller ställer in färgen på fyllningen.
type: docs
weight: 80
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextstyle/fillcolor/
---
## ITextStyle.FillColor property

Hämtar eller ställer in färgen på fyllningen.
