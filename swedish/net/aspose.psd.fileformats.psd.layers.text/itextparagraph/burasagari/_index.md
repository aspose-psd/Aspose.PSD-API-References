...
description: "ITextParagraph-egenskap. Hämtar eller anger ett värde som indikerar om detta ITextParagraph är burasagiri"
type: docs
weight: 30
...
Hämtar eller anger ett värde som indikerar om detta [`ITextParagraph`](../) är burasagiri.
...
`true` om burasagiri; annars `false`.
