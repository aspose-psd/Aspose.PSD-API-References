...
description: ITextParagraph fast egendom. Hämtar eller ställer in ett värde som indikerar om dettaITextParagraphär burasagiri.
type: docs
weight: 30
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Hämtar eller ställer in ett värde som indikerar om detta[`ITextParagraph`](../)är burasagiri.
...
`Sann` om burasagiri; annat,`falsk` .
