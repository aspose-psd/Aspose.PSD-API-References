...
description: ITextParagraph fast egendom. Hämtar eller ställer in ett värde som anger om automatisk avstavning.
type: docs
weight: 10
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Hämtar eller ställer in ett värde som anger om [automatisk avstavning].
...
`Sann` om [automatiskt avstavning]; annat,`falsk` .
