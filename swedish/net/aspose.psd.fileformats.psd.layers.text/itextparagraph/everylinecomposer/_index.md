...
description: ITextParagraph fast egendom. Hämtar eller ställer in ett värde som indikerar om varje radkomponist.
type: docs
weight: 60
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Hämtar eller ställer in ett värde som indikerar om [varje radkomponist].
...
`Sann` om [varje rad kompositör]; annat,`falsk` .
