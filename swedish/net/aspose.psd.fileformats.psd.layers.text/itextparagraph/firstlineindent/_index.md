...
description: ITextParagraph fast egendom. Hämtar eller ställer in första radens indrag.
type: docs
weight: 70
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/firstlineindent/
---
## ITextParagraph.FirstLineIndent property

Hämtar eller ställer in första radens indrag.
