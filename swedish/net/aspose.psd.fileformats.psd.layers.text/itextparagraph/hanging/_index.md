...
description: "ITextParagraph-egenskap. Hämtar eller anger ett värde som indikerar om detta ITextParagraph är hängande"
type: docs
weight: 90
...
Hämtar eller anger ett värde som indikerar om detta [`ITextParagraph`](../) är hängande.
