...
description: ITextParagraph fast egendom. Hämtar eller ställer in ett värde som indikerar om dettaITextParagraph hänger.
type: docs
weight: 90
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Hämtar eller ställer in ett värde som indikerar om detta[`ITextParagraph`](../) hänger.
