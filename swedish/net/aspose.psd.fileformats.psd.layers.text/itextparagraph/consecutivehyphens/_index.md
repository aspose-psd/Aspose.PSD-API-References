...
description: ITextParagraph fast egendom. Hämtar eller ställer in på varandra följande bindestreck.
type: docs
weight: 40
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/consecutivehyphens/
---
## ITextParagraph.ConsecutiveHyphens property

Hämtar eller ställer in på varandra följande bindestreck.
...
De på varandra följande bindestreck.
