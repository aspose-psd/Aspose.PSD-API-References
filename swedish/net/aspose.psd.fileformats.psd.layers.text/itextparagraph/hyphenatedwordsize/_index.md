...
description: ITextParagraph fast egendom. Hämtar eller ställer in storleken på avstavningsordet.
type: docs
weight: 100
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hyphenatedwordsize/
---
## ITextParagraph.HyphenatedWordSize property

Hämtar eller ställer in storleken på avstavningsordet.
...
Storleken på det avstavade ordet.
