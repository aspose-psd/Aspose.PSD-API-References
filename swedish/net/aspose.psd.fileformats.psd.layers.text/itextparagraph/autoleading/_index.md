...
description: ITextParagraph fast egendom. Hämtar eller ställer in den automatiska ledningen.
type: docs
weight: 20
url: /sv/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autoleading/
---
## ITextParagraph.AutoLeading property

Hämtar eller ställer in den automatiska ledningen.
