...
description: Aspose.PSD.FileFormats.Psd.Resources.GlobalAngleResource klass. Global vinkelresurs
type: docs
weight: 3720
url: /sv/net/aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| namn | Beskrivning |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalangleresource/datasize/) { get; } | Hämtar resursdatastorleken i byte. |
| [GlobalAngle](../../aspose.psd.fileformats.psd.resources/globalangleresource/globalangle/) { get; set; } | Hämtar eller ställer in den globala vinkeln. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Hämtar eller ställer in den unika identifieraren för resursen. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/globalangleresource/minimalversion/) { get; } | Får den minsta nödvändiga PSD-versionen. |
