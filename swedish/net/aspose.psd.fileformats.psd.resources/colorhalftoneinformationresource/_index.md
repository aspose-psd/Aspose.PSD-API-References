---
title: "Klass ColorHalftoneInformationResource"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.Resources.ColorHalftoneInformationResource klass. Halvtoningsresurs"
type: docs
weight: 4130
url: /sv/net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
{{< psd/tize >}}
...
| Namn | Beskrivning |
| --- | --- |
| [ColorHalftoneInformationResource](colorhalftoneinformationresource/)() | Standardkonstruktorn. |

## Egenskaper

| Namn | Beskrivning |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/datasize/) { get; } | Hämtar resursens datastorlek i byte. |
| [HalftoneData](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/halftonedata/) { get; set; } | Hämtar eller anger halvtoningsdata. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Hämtar eller anger den unika identifieraren för resursen. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/minimalversion/) { get; } | Hämtar den minsta erforderliga PSD-versionen. |
