...
description: Aspose.PSD.FileFormats.Psd.Resources.IccProfileResource klass. Representerar ICCprofilresursen.
type: docs
weight: 3760
...
| namn | Beskrivning |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/iccprofileresource/datasize/) { get; } | Hämtar resursdatastorleken i byte. |
| [IccProfile](../../aspose.psd.fileformats.psd.resources/iccprofileresource/iccprofile/) { get; set; } | Hämtar eller ställer in ICC-profilen. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Hämtar eller ställer in den unika identifieraren för resursen. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/iccprofileresource/minimalversion/) { get; } | Får den minsta nödvändiga PSD-versionen. |
