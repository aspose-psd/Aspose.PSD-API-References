---
title: "Klassen SmartObjectProvider"
second_title: "Aspose.PSD för .NET API‑referens"
description: "Aspose.PSD.FileFormats.Psd.SmartObjectProvider class. Definierar smartobjekt‑leverantören som möjliggör hämtning / inställning av datakällor från globala länkresurser i PSD‑filen och deras innehåll"
type: docs
weight: 4470
url: /sv/net/aspose.psd.fileformats.psd/smartobjectprovider/
---
{{< psd/tize >}}
## SmartObjectProvider class

Definierar smartobjektleverantören som möjliggör hämtning / inställning av datakällor från globala länkreferenser i PSD-filen och deras innehåll.
...
| Namn | Beskrivning |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Konverterar lager till ett inbäddat smartobjekt. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Konverterar lager till ett inbäddat smartobjekt. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Bäddar in alla länkade smartobjekt i bilden. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Skapar ett nytt smartobjekt‑lager genom att kopiera källan. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Uppdaterar innehållet i alla modifierade smartobjekt i bilden. |
