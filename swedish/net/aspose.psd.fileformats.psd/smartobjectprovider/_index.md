...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider klass. Definierar leverantören av smarta objekt som tillhandahåller att hämta/ställa in datakällor från globala länkresurser för PSDfilen och deras innehåll.
type: docs
weight: 4000
...
Definierar leverantören av smarta objekt som tillhandahåller att hämta/ställa in datakällor från globala länkresurser för PSD-filen och deras innehåll.
...
| namn | Beskrivning |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Konverterar lager till ett inbäddat smart objekt. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Konverterar lager till ett inbäddat smart objekt. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Bäddar in alla länkade smarta objekt i bilden. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Skapar ett nytt smart objektlager genom att kopiera källan. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Uppdaterar innehållet i alla modifierade smarta objekt i bilden. |
