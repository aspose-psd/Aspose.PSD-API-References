...
description: "Packade fourCC-värden för Photoshop gradientinterpolationsmetod."
type: docs
weight: 18
url: /sv/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
| Fält | Beskrivning |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Klassisk (standardvärde för äldre när nyckeln saknas). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Linjär (observera efterföljande mellanslag). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Perceptuell. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Mjuk. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Ränder. |
## Metoder
...
'Gcls' \\u2014 Klassisk (standardvärde för äldre när nyckeln saknas).
...
'Lnr ' \\u2014 Linjär (observera efterföljande mellanslag).
