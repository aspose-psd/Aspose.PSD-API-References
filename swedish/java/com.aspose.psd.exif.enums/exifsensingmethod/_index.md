...
description: "exif avkänningsmetodenum."
type: docs
weight: 24
url: /sv/java/com.aspose.psd.exif.enums/exifsensingmethod/
---
...
exif avkänningsmetodenum.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Colorsequentialarea](#Colorsequentialarea) | Färgrekventiellt område. |
| [Colorsequentiallinear](#Colorsequentiallinear) | Färgrekventiell linjär sensor. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Notdefined](#Notdefined) | Ej definierad. |
| [OneChipColorArea](#OneChipColorArea) | En-chip färgområde. |
| [ThreeChipColorArea](#ThreeChipColorArea) | Tre-chip färgområde. |
| [Trilinearsensor](#Trilinearsensor) | Trilinjär sensor. |
| [TwoChipColorArea](#TwoChipColorArea) | Två-chip färgområde. |
## Metoder
