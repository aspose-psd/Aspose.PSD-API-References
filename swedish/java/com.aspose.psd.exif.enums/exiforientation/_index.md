...
type: docs
weight: 21
url: /sv/java/com.aspose.psd.exif.enums/exiforientation/
---
...
| Fält | Beskrivning |
| --- | --- |
| [BottomLeft](#BottomLeft) | Nedre vänster. |
| [BottomRight](#BottomRight) | Nedre höger. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LeftBottom](#LeftBottom) | Vänster nederst. |
| [LeftTop](#LeftTop) | Vänster övre. |
| [RightBottom](#RightBottom) | Höger nederst. |
| [RightTop](#RightTop) | Höger övre. |
| [TopLeft](#TopLeft) | Övre vänster. |
| [TopRight](#TopRight) | Övre höger. |
## Metoder
...
Nedre vänster. Roterad 180 grader och sedan horisontellt omvänd.
...
Nedre höger. Roterad 180 grader.
...
Vänster nederst. Roterad 90 grader moturs.
...
Vänster övre. Roterad 90 grader moturs och sedan horisontellt omvänd.
...
Höger nederst. Roterad 90 grader medurs och sedan horisontellt omvänd.
...
Höger övre. Roterad 90 grader medurs.
...
Övre höger. Horisontellt omvänd.
