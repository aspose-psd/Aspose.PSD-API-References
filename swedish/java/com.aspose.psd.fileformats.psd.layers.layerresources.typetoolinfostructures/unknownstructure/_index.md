...
description: "Den okända strukturen."
type: docs
weight: 30
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
Den okända strukturen.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Initierar en ny instans av klassen [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure). |
## Metoder
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Hämtar det läsbara typnamnet för strukturen. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Initierar en ny instans av klassen [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Nyckelnamnet. |
| nyckel | int | Strukturnyckeln. |
...
Hämtar det läsbara typnamnet för strukturen.
