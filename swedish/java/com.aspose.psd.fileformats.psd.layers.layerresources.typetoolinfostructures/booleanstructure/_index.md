...
description: "Den booleska strukturen."
type: docs
weight: 11
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
Den booleska strukturen.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [BooleanStructure(ClassID keyName)](#BooleanStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initierar en ny instans av klassen [BooleanStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure) class. |
## Fält
...
| [getValue()](#getValue--) | Hämtar eller anger ett booleskt värde. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(boolean value)](#setValue-boolean-) | Hämtar eller anger ett booleskt värde. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [BooleanStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure) class.
...
Hämtar eller anger ett booleskt värde.

Värde: Ett booleskt värde.
