...
description: "Offsetstrukturen."
type: docs
weight: 21
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initierar en ny instans av klassen [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) class. |
## Fält
...
| [getValue()](#getValue--) | Hämtar eller anger det heltalsvärdet. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Hämtar eller anger det heltalsvärdet. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) class.
...
Hämtar eller anger det heltalsvärdet.

Värde: Det heltalsvärdet.
