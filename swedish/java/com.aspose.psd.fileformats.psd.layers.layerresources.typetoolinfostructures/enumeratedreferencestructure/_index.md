...
description: "Uppräknad referensstruktur."
type: docs
weight: 16
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
Uppräknad referensstruktur.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initierar en ny instans av klassen [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) klass. |
## Fält

| Fält | Beskrivning |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | Identifierar strukturnyckeln. |
| [StructureKey](#StructureKey) | Den enumererade deskriptornyckeln. |
## Metoder
...
| [getEnumName()](#getEnumName--) | Hämtar eller anger enum-namnet. |
...
| [getTypeID()](#getTypeID--) | Hämtar eller anger typ-ID. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Hämtar eller anger enum-namnet. |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Hämtar eller anger typ-ID. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) klass.
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Typ-ID. |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Enum-namnet. |
...
Den enumererade deskriptornyckeln.
