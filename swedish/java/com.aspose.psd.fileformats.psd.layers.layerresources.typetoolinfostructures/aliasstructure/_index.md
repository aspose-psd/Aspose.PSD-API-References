...
description: "Alias‑strukturen."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initierar en ny instans av klassen [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure). |
## Fält
...
| [getDataLength()](#getDataLength--) | Hämtar den exakta datalängden i byte. |
| [getFullPath()](#getFullPath--) | Hämtar eller anger den fullständiga sökvägen. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Hämtar eller anger den fullständiga sökvägen. |
...
Initierar en ny instans av klassen [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure).
...
Hämtar den exakta datalängden i byte.

Värde: Datalängden i byte.
...
Hämtar eller anger den fullständiga sökvägen.

Värde: Den fullständiga sökvägen.
