...
description: "Den heltalsstrukturen."
type: docs
weight: 17
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
Den heltalsstrukturen.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [IntegerStructure(ClassID keyName)](#IntegerStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initierar en ny instans av klassen [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure). |
## Fält

| Fält | Beskrivning |
| --- | --- |
| [StructureKey](#StructureKey) | Det heltaliga strukturnyckeln. |
## Metoder
...
| [getValue()](#getValue--) | Hämtar eller anger ett heltalsvärde. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Hämtar eller anger ett heltalsvärde. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure).
...
Hämtar eller anger ett heltalsvärde.

Värde: Ett heltalsvärde.
