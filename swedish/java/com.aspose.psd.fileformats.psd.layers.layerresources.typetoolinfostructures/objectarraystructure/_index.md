...
description: "Definierar klassen ObjectArrayStructure som vanligtvis innehåller en array."
type: docs
weight: 20
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Definierar klassen ObjectArrayStructure som vanligtvis innehåller [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) array. Den används i PSD-filresurser, såsom PlLd Resource och SoLd Resource.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initierar en ny instans av klassen [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class. |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initierar en ny instans av klassen [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class. |
## Fält

| Fält | Beskrivning |
| --- | --- |
| [StructureKey](#StructureKey) | Identifierar nyckeln 'ObAr' för strukturen. |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Hämtar eller anger klass-ID för objektarrayen. |
| [getClassName()](#getClassName--) | Hämtar eller anger klassnamnet för objektarrayen. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Hämtar listan över strukturer. |
| [getKey()](#getKey--) | Hämtar nyckeln för objektarrayens struktur. |
| [getKeyName()](#getKeyName--) | Hämtar eller anger nyckelnamn. |
| [getLength()](#getLength--) | Hämtar OSTypeStructure‑längden i byte. |
...
| [getStructureCount()](#getStructureCount--) | Hämtar antalet delstrukturer i objektarrayen. |
| [getStructures()](#getStructures--) | Hämtar eller anger delstrukturerna i objektarrayens struktur. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Hämtar eller anger klass-ID för objektarrayen. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Hämtar eller anger klassnamnet för objektarrayen. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Hämtar eller anger delstrukturerna i objektarrayens struktur. |
...
Initierar en ny instans av klassen [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| keyName | java.lang.String | Nyckelns namn. |
| classIdName | java.lang.String | Namn på klassidentifieraren. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| nyckel | int | Det heltaliga nyckeln. |
...
Identifierar nyckeln 'ObAr' för strukturen.
...
Hämtar eller anger klass-ID för objektarrayen.

Värde: Objektarrayens klass-ID.
...
Hämtar eller anger klassnamnet för objektarrayen.

Värde: Objektarrayens klassnamn.
...
Hämtar nyckeln för objektarrayens struktur.
...
Hämtar antalet delstrukturer i objektarrayen.

Värde: Antalet delstrukturer i objektarrayens struktur.
...
Hämtar eller anger delstrukturerna i objektarrayens struktur.

Värde: Delstrukturerna i objektarrayens struktur.
