...
description: "Delegaten för lång operation för den asynkrona uppgiften med generisk typresultat."
type: docs
weight: 12
url: /sv/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
Delegaten för lång operation för den asynkrona uppgiften med generisk typresultat.
## Konstruktörer
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | Delegaten för lång operation för den asynkrona uppgiften med generisk typresultat. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| återuppringning | com.aspose.ms.System.AsyncCallback |  |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | Tillstånd för den asynkrona uppgiften. |

**Returns:**
java.lang.Object - Resultat av den långa operationen.
### notify() {#notify--}
```
