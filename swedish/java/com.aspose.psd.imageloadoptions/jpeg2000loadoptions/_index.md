...
description: "JPEG2000 inläsningsalternativ"
type: docs
weight: 10
url: /sv/java/com.aspose.psd.imageloadoptions/jpeg2000loadoptions/
---
...
JPEG2000 inläsningsalternativ
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [Jpeg2000LoadOptions()](#Jpeg2000LoadOptions--) | Initierar en ny instans av klassen Jpeg2000LoadOptions. |
## Fält
...
| [getDefaultMaximumDecodingTime_internalized()](#getDefaultMaximumDecodingTime-internalized--) | Hämtar standard maximala avkodningstiden. |
| [getIgnoreAfterLoad_internalized()](#getIgnoreAfterLoad-internalized--) | Hämtar ett värde som indikerar om [ignore after load]. |
| [getMaximumDecodingTime()](#getMaximumDecodingTime--) | Hämtar den maximala avkodningstiden i sekunder (detta alternativ kan användas på mycket långsamma eller minnesbegränsade maskiner för att förhindra att processen hänger på mycket stora bilder - upplösning mer än 5500x6500 pixlar). |
| [getMaximumDecodingTimeForTile()](#getMaximumDecodingTimeForTile--) | Hämtar den maximala avkodningstiden för tile. |
...
| [setDefaultMaximumDecodingTime_internalized(int value)](#setDefaultMaximumDecodingTime-internalized-int-) | Ställer in standard maximal avkodningstid. |
...
| [setMaximumDecodingTime(int value)](#setMaximumDecodingTime-int-) | Ställer in maximal avkodningstid i sekunder (detta alternativ kan användas på mycket långsamma maskiner med lite minne för att förhindra att processen hänger på mycket stora bilder – upplösning mer än 5500x6500 pixlar). |
| [setMaximumDecodingTimeForTile(int value)](#setMaximumDecodingTimeForTile-int-) | Ställer in maximal avkodningstid för tile. |
...
Hämtar standard maximala avkodningstiden.

**Returns:**
int – standard maximal avkodningstid.
...
Hämtar den maximala avkodningstiden i sekunder (detta alternativ kan användas på mycket långsamma eller minnesbegränsade maskiner för att förhindra att processen hänger på mycket stora bilder - upplösning mer än 5500x6500 pixlar).

**Returns:**
int – maximal avkodningstid.
...
Hämtar den maximala avkodningstiden för tile.

Värde: maximal avkodningstid för tile.

**Returns:**
int – maximal avkodningstid för tile.
...
Ställer in standard maximal avkodningstid.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| värde | int | Standard maximal avkodningstid. |
...
Ställer in maximal avkodningstid i sekunder (detta alternativ kan användas på mycket långsamma maskiner med lite minne för att förhindra att processen hänger på mycket stora bilder – upplösning mer än 5500x6500 pixlar).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| värde | int | Maximal avkodningstid. |
...
Ställer in maximal avkodningstid för tile.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| värde | int | den maximala avkodningstiden för kakel. |
