...
description: "Anger de skrivskyddade lägen som är tillgängliga när en PSD‑bild läses in."
type: docs
weight: 13
url: /sv/java/com.aspose.psd.imageloadoptions/readonlymode/
---
...
| Fält | Beskrivning |
| --- | --- |
| [Default](#Default) | Standardläge. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MetadataEdit](#MetadataEdit) | Tillåter redigering av bildmetadata samtidigt som bildinnehållet förblir skrivskyddat. |
| [None](#None) | Inga skrivskyddsrestriktioner tillämpas. |
## Metoder
...
Standardläge. Bilden är helt skrivskyddad och kan inte ändras.
...
Tillåter redigering av bildmetadata samtidigt som bildinnehållet förblir skrivskyddat.
...
Inga skrivskyddsrestriktioner tillämpas. Bilden kan ändras helt.
