...
description: "Färgöverföringsresurs"
type: docs
weight: 15
url: /sv/java/com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| --- | --- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource--) | Initierar en ny instans av klassen [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource). |
## Fält
...
| [getClass()](#getClass--) |  |
| [getColorTransferData()](#getColorTransferData--) | Hämtar eller anger färgöverföringsdata. |
...
| [setColorTransferData(byte[] value)](#setColorTransferData-byte---) | Hämtar eller anger färgöverföringsdata. |
...
Initierar en ny instans av klassen [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource).
...
Hämtar eller anger färgöverföringsdata.

Värde: Färgöverföringsdata.
