...
description: "CaptionDigest-resurs"
type: docs
weight: 13
url: /sv/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
CaptionDigest-resurs
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Initierar en ny instans av klassen [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Fält
...
| [getDigest()](#getDigest--) | Hämtar eller anger digest. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Hämtar eller anger digest. |
