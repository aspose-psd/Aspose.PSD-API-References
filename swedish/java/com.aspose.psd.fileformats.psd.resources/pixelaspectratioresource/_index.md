...
description: "Resurs för pixelaspektförhållande"
type: docs
weight: 29
url: /sv/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
Resurs för pixelaspektförhållande
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | Initierar en ny instans av klassen [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Fält
...
| [getAspectRatio()](#getAspectRatio--) | Hämtar eller anger bildförhållandet. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | Hämtar eller anger bildförhållandet. |
...
Hämtar eller anger bildförhållandet.

Värde: Bildförhållandet.
