...
description: "Resurs för utskriftsskala"
type: docs
weight: 31
url: /sv/java/com.aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
Resurs för utskriftsskala
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [PrintScaleResource()](#PrintScaleResource--) | Initierar en ny instans av klassen [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource). |
## Fält
...
| [getXLocation()](#getXLocation--) | Hämtar eller anger x‑positionen. |
| [getYLocation()](#getYLocation--) | Hämtar eller anger y‑positionen. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setScale(float value)](#setScale-float-) | Hämtar eller anger skalan. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Hämtar eller anger resursblockets tillstånd. |
| [setStyle(short value)](#setStyle-short-) | Hämtar eller anger stilen. |
| [setXLocation(float value)](#setXLocation-float-) | Hämtar eller anger x‑positionen. |
| [setYLocation(float value)](#setYLocation-float-) | Hämtar eller anger y‑positionen. |
| [toString()](#toString--) |  |
...
Initierar en ny instans av klassen [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource).
