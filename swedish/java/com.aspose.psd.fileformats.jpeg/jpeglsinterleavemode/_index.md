...
description: "Definierar interleavläget för flerkomponent färgpixeldata."
type: docs
weight: 14
url: /sv/java/com.aspose.psd.fileformats.jpeg/jpeglsinterleavemode/
---
...
Definierar interleaveläget för flerkomponent (färg) pixeldata.
## Fält
...
| [None](#None) | Data kodas och lagras komponent för komponent: RRRGGGBBB. |
| [Sample](#Sample) | Data kodas och lagras per prov. |
## Metoder
...
Interleavläget är per rad. En hel rad av varje komponent kodas innan nästa rad bearbetas.
...
Data kodas och lagras komponent för komponent: RRRGGGBBB.
...
Data kodas och lagras per prov. För färgbilder är detta formatet som RGBRGBRGB.
