...
description: "Filter Effects-resursen innehåller kanaler en användarmask och ett bladmask för det smarta filtret."
type: docs
weight: 29
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
Filter Effects-resursen innehåller kanaler, en användarmask och ett bladmask för det smarta filtret.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Initierar en ny instans av klassen [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource). |
## Fält

| Fält | Beskrivning |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | Typverktygsinfo-nyckeln FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | Typverktygsinfo-nyckeln FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Hämtar filtereffektmaskerna. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Hämtar filtereffektmaskerna. |
...
Initierar en ny instans av klassen [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource).
...
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Filtereffektmaskerna. |
