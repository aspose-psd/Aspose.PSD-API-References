...
description: "Den okända resursen."
type: docs
weight: 82
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Initierar en ny instans av klassen [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource). |
## Fält
...
Initierar en ny instans av klassen [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource).
