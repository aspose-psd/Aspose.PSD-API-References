...
description: "Klass LevlResource."
type: docs
weight: 48
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/levlresource/
---
...
Klassen LevlResource. Resurs för exponeringjusteringslager.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LevlResource(byte[] bytes)](#LevlResource-byte---) | Initierar en ny instans av klassen [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) class. |
| [LevlResource()](#LevlResource--) | Initierar en ny instans av klassen [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) class. |
## Fält
...
| [getChannel(int channelIndex)](#getChannel-int-) | Hämtar kanalen. |
| [getClass()](#getClass--) |  |
...
Initierar en ny instans av klassen [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) class. Stöds i GrayScale, Duotone, RGB, CMYK, Lab-färglägen 2 bytes - Version (=2) 29 \* 10 bytes - Uppsättningar av nivåposter med 5 short integers 4 bytes - Lvls header (Starts at 292 index) 2 bytes - Version (=3) 2 bytes - Count of total level record 10 \* (Total Count - 29) Zero ending of Lvls resource should be fold for four too
...
Initierar en ny instans av klassen [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) class.
