...
description: "VibA-resurs."
type: docs
weight: 83
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| --- | --- |
| [VibAResource()](#VibAResource--) | Initierar en ny instans av klassen [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource). |
## Fält
...
| [getSaturation()](#getSaturation--) | Hämtar eller anger mättnadsvärde |
| [getSignature()](#getSignature--) | Hämtar lagrets resurs‑signatur. |
| [getVibrance()](#getVibrance--) | Hämtar eller anger vibransvärde |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | Hämtar eller anger mättnadsvärde |
| [setVibrance(int value)](#setVibrance-int-) | Hämtar eller anger vibransvärde |
...
Initierar en ny instans av klassen [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource).
...
Hämtar eller anger mättnadsvärde
...
Hämtar eller anger vibransvärde
