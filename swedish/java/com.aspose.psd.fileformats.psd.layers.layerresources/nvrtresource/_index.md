...
description: "Klass NvrtResource."
type: docs
weight: 63
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
Klass NvrtResource. Resurs för Invert‑justeringslager.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | Initierar en ny instans av klassen [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | Initierar en ny instans av klassen [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
## Fält

| Fält | Beskrivning |
| --- | --- |
| [DataLength_internalized](#DataLength-internalized) | Förväntad datalängd. |
...
Initierar en ny instans av klassen [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource).
