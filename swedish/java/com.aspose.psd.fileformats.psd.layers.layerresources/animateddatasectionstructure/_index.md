...
description: "Avsnittet med animerade data."
type: docs
weight: 11
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Fält | Beskrivning |
| --- | --- |
| [StructureKey](#StructureKey) | Identifierar strukturnyckeln för AnDs. |
## Metoder
...
| [getClass()](#getClass--) |  |
| [getClassName_internalized()](#getClassName-internalized--) | Hämtar eller anger klassnamnet. |
...
| [getItems()](#getItems--) | Hämtar eller anger de animerade datasektionsstrukturerna. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Hämtar eller anger ClassID. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Hämtar eller anger klassnamnet. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Hämtar eller anger beskrivarversionen. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Hämtar eller anger de animerade datasektionsstrukturerna. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Hämtar eller anger de okända 3 byte som finns när antalet ramar är udda. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Kontrollerar att antalet ramar i 'FrIn'-liststrukturen är udda.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| objekt | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Hämtar eller anger de okända 3 byte som finns när antalet ramar är udda.
