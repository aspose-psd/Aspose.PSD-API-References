...
description: "Lagersektionens resurs."
type: docs
weight: 43
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
Lagersektionens resurs.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Initierar en ny instans av klassen [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Initierar en ny instans av klassen [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Fält
...
Initierar en ny instans av klassen [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
