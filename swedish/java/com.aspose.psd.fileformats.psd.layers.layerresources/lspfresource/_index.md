...
description: "Lager skyddade inställningar"
type: docs
weight: 57
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
Lager skyddade inställningar
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | Initierar en ny instans av klassen [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | Initierar en ny instans av klassen [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource()](#LspfResource--) | Initierar en ny instans av klassen [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
## Fält
...
| [TypeToolKey](#TypeToolKey) | Typverktygsinfo-nyckeln 1819504742 |
...
| [getLockType()](#getLockType--) | Hämtar eller anger låsets typ. |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | Hämtar eller anger ett värde som indikerar om den här instansen är skyddad mot sammansättning. |
| [isPositionProtected()](#isPositionProtected--) | Hämtar eller anger ett värde som indikerar om den här instansen är positionsskyddad. |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | Hämtar eller anger ett värde som indikerar om den här instansen är transparensskyddad. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | Hämtar eller anger ett värde som indikerar om den här instansen är skyddad mot sammansättning. |
...
| [setLockType(int value)](#setLockType-int-) | Hämtar eller anger låsets typ. |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | Hämtar eller anger ett värde som indikerar om den här instansen är positionsskyddad. |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | Hämtar eller anger ett värde som indikerar om den här instansen är transparensskyddad. |
...
Initierar en ny instans av klassen [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). Med anpassat eller okänt värde
...
Initierar en ny instans av klassen [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| isTransparencyProtected | boolean | om satt till  true  [är transparensskyddad]. |
| isCompositeProtected | boolean | om satt till  true  [är sammansättningsskyddad]. |
...
Hämtar eller anger ett värde som indikerar om den här instansen är skyddad mot sammansättning.

Värde:  true  om den här instansen är sammansättningsskyddad; annars  false .
...
Hämtar eller anger ett värde som indikerar om den här instansen är positionsskyddad.

Värde:  true  om den här instansen är positionsskyddad; annars  false .
...
Hämtar eller anger ett värde som indikerar om den här instansen är transparensskyddad.

Värde:  true  om den här instansen är transparensskyddad; annars  false .
