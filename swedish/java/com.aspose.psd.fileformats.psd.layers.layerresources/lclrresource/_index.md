...
description: "Klass LclrResource."
type: docs
weight: 46
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
Klassen LclrResource. Denna resurs innehåller information om färgen på lager i lagerlistan i PS. Det är bara.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LclrResource()](#LclrResource--) | Initierar en ny instans av klassen [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(short color)](#LclrResource-short-) | Initierar en ny instans av klassen [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(byte[] data)](#LclrResource-byte---) | Initierar en ny instans av klassen [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
## Fält
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Hämtar eller anger färgen på lagret. |
...
| [setColor(short value)](#setColor-short-) | Hämtar eller anger färgen på lagret. |
...
Initierar en ny instans av klassen [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource).
...
Hämtar eller anger färgen på lagret.
