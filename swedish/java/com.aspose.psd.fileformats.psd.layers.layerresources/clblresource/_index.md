...
description: "Klassen ClblResource."
type: docs
weight: 20
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Klassen ClblResource. Denna resurs innehåller information om blandning av beskurna element.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [ClblResource()](#ClblResource--) | Initierar en ny instans av klassen [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Initierar en ny instans av klassen [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Initierar en ny instans av klassen [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Fält
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Hämtar eller anger ett värde som indikerar om [blend clipped elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Hämtar eller anger ett värde som indikerar om [blend clipped elements]. |
...
Initierar en ny instans av klassen [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
| --- | --- | --- |
| blendClippedElements | boolean | om satt till  true  [blend clipped elements]. |
...
Initierar en ny instans av klassen [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). Med anpassat eller okänt värde
...
Hämtar eller anger ett värde som indikerar om [blend clipped elements].

Värde:  true  om [blend clipped elements]; annars,  false .
