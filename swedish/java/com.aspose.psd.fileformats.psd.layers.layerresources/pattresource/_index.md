...
description: "Klass PattResource."
type: docs
weight: 66
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
Klassen PattResource. Resurs med mönsterdata
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [PattResource()](#PattResource--) | Initierar en ny instans av klassen [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Initierar en ny instans av klassen [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
## Fält
...
| [TypeToolKey](#TypeToolKey) | Den 'Patt'-typens verktygsinformationsnyckel för 8-bit. |
| [TypeToolKey2](#TypeToolKey2) | Den 'Pat2'-typens verktygsinformationsnyckel för 16-bit. |
| [TypeToolKey3](#TypeToolKey3) | Den 'Pat3'-typens verktygsinformationsnyckel för 32-bitars. |
| [ventureLicense_internalized](#ventureLicense-internalized) | Venture‑licensen. |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Uppdaterar Patt-resursen med standarddata. |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | Skapar standardresursen som inte är tom. |
...
| [getPatterns()](#getPatterns--) | Hämtar eller anger mönsterdata; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Hämtar eller anger mönsterdata; |
| [toString()](#toString--) | Returnerar en String som representerar detta objekt. |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | Söker efter mönsterdataobjektet och uppdaterar det med nytt, annars läggs nytt till i slutet av arrayen. |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource).
...
| --- | --- | --- |
| nyckel | int | Resurstypnyckeln. |
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | Mönsterdata. |
...
Den 'Patt'-typens verktygsinformationsnyckel för 8-bit.
...
Den 'Pat2'-typens verktygsinformationsnyckel för 16-bit.
...
Den 'Pat3'-typens verktygsinformationsnyckel för 32-bitars.
...
Uppdaterar Patt-resursen med standarddata.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | Resursen. |
...
Skapar standardresursen som inte är tom.
...
Söker efter mönsterdataobjektet och uppdaterar det med nytt, annars läggs nytt till i slutet av arrayen.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | Mönsterinställningsobjektet för att uppdatera mönsterelementet. |
