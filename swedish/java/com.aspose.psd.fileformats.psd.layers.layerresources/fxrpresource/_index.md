...
description: "Klassen FxrpResource."
type: docs
weight: 32
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
Klassen **FxrpResource**. Referenspunkten för lagret
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Initierar en ny instans av klassen [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Initierar en ny instans av klassen [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Initierar en ny instans av klassen [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Fält
...
| [getX()](#getX--) | Hämtar eller anger x för referenspunkten |
| [getY()](#getY--) | Hämtar eller anger y för referenspunkten |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Sparar till den angivna strömbehållaren. |
...
| [setX(double value)](#setX-double-) | Hämtar eller anger x för referenspunkten |
| [setY(double value)](#setY-double-) | Hämtar eller anger y för referenspunkten |
...
Initierar en ny instans av klassen [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).
...
Initierar en ny instans av klassen [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Med anpassat eller okänt värde
...
Hämtar eller anger x för referenspunkten

Värde: X för referenspunkten
...
Hämtar eller anger y för referenspunkten

Värde: Y för referenspunkten
