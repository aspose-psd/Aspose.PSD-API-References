...
description: "Basresurs för effekter"
type: docs
weight: 12
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
Basresurs för effekter
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Initierar en ny instans av klassen [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) |
## Fält
...
Initierar en ny instans av klassen [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource)

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| resourceKey | int | Resursnyckeln. |
