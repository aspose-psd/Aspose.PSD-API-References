...
description: "Txt2-resursklass"
type: docs
weight: 76
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource/
---
...
| --- | --- |
| [Txt2Resource()](#Txt2Resource--) | Initierar en ny instans av klassen [Txt2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource). |
## Fält
...
| Metod | Beskrivning |
| --- | --- |
| [addTextRecord(String text, RectangleF bounds)](#addTextRecord-java.lang.String-com.aspose.psd.RectangleF-) | Lägger till textposten i Resource och returnerar id för textposten. |
...
| [getKeys_internalized(System.Collections.Generic.Dictionary<String,Object> tree)](#getKeys-internalized-com.aspose.ms.System.Collections.Generic.Dictionary-java.lang.String-java.lang.Object--) | Hämtar om resursen är komprimerad. |
| [getLength()](#getLength--) | Hämtar lagrets resurslängd i byte. |
| [getParsedTxt2Model_internalized()](#getParsedTxt2Model-internalized--) | Analyserar txt2-data till en Txt2DataRoot-klassinstans. |
...
| [getTextData()](#getTextData--) | Hämtar textposten från resursdata. |
| [getText_internalized()](#getText-internalized--) | Hämtar eller anger namnet. |
| [getTxt2FromParsedTree_internalized(System.Collections.Generic.Dictionary<String,Object> tree)](#getTxt2FromParsedTree-internalized-com.aspose.ms.System.Collections.Generic.Dictionary-java.lang.String-java.lang.Object--) | Hämtar TXT2 från det analyserade trädet. |
| [getTxt2ParsedTree_internalized()](#getTxt2ParsedTree-internalized--) | Hämtar det analyserade TXT2-trädet. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [removeTextRecord_internalized(int textIndex)](#removeTextRecord-internalized-int-) | Ta bort textposten från Resource. |
...
| [setText_internalized(String value)](#setText-internalized-java.lang.String-) | Hämtar eller anger namnet. |
| [toString()](#toString--) | Returnerar en String som representerar detta objekt. |
| [updateTextData_internalized(int textIndex, String newText, double fontSize, Color color)](#updateTextData-internalized-int-java.lang.String-double-com.aspose.psd.Color-) | Uppdaterar textposten via textindex med ny standardtextdata samt ny text, teckenstorlek och färg. |
| [updateTxt2DataFromModel_internalized(Txt2DataRoot txt2DataRoot)](#updateTxt2DataFromModel-internalized-com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot-) | Uppdaterar txt2-data från Txt2DataRoot-modellen. |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [Txt2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource).
...
| --- | --- | --- |
| text | java.lang.String | Texten i posten. |
| bounds | [RectangleF](../../com.aspose.psd/rectanglef) | Gränserna. |

**Returns:**
int - Returnerar Id för textpost i resursen.
...
Hämtar om resursen är komprimerad.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| träd | com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> | Trädet. |

**Returns:**
com.aspose.internal.fileformats.psd.layers.layerresources.ITextEngineKeys - Returnerar objekt med nycklar.
### getLength() {#getLength--}
```
...
Analyserar txt2-data till en Txt2DataRoot-klassinstans.

**Returns:**
com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot - txt2-data som en Txt2DataRoot-klassinstans.
...
**Returns:**
java.lang.String[] - Array av textposter
...
Hämtar TXT2 från det analyserade trädet.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| träd | com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> | Dataträdet. |

**Returns:**
java.lang.String - Txt2-data.
...
Hämtar det analyserade TXT2-trädet.

**Returns:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> - Analyserat träd
### hashCode() {#hashCode--}
```
...
Ta bort textposten från Resource.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| textIndex | int | Index för textpost som ska tas bort. |
...
Uppdaterar textposten via textindex med ny standardtextdata samt ny text, teckenstorlek och färg.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| textIndex | int | Index för textpost i txt2-resursdata. |
| newText | java.lang.String | Den nya texten. |
| fontSize | double | den nya teckenstorleken. |
| color | [Color](../../com.aspose.psd/color) | Den nya textfärgen. |
...
Uppdaterar txt2-data från Txt2DataRoot-modellen.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| txt2DataRoot | com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot | Den txt2-datamodellen. |
