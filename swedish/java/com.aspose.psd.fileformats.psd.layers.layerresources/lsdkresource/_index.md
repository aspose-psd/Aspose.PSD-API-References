...
description: "Den lsdk-lagerresursen för inbäddad lagersektion."
type: docs
weight: 56
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
lsdk-lagerresurs (nästlad lagersektionresurs).
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Initierar en ny instans av klassen [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) class. |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Initierar en ny instans av klassen [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) class. |
## Fält
...
| [getSectionType()](#getSectionType--) | Hämtar eller anger sektionstypen. |
| [getSignature()](#getSignature--) | Hämtar lagrets resurs‑signatur. |
| [getSubtype()](#getSubtype--) | Hämtar eller anger undertypen. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Hämtar eller anger sektionstypen. |
| [setSubtype(int value)](#setSubtype-int-) | Hämtar eller anger undertypen. |
...
Initierar en ny instans av klassen [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) class.
...
| --- | --- | --- |
| sectionType | int | Sektionstypen. |
| subType | int | Undertypen. |
...
Hämtar eller anger sektionstypen.
