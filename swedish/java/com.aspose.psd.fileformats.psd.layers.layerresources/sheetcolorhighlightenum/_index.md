...
description: "Möjliga färger för bladfärgsinställning."
type: docs
weight: 73
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Möjliga färger för Sheet‑färginställning. Det är en UI‑dekorativ färg för lager i lagerlistan i PS.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Blue](#Blue) | Den blå färgen. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gray](#Gray) | Den grå färgen. |
| [Green](#Green) | Den gröna färgen. |
| [NoColor](#NoColor) | Färgen är inte specificerad. |
| [Orange](#Orange) | Den orangea färgen. |
| [Red](#Red) | Den röda färgen. |
| [Violet](#Violet) | Den violetta färgen. |
| [Yellow](#Yellow) | Den gula färgen. |
## Metoder
