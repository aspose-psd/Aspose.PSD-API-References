...
description: "Klass KnkoResource."
type: docs
weight: 41
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Klass KnkoResource. Denna resurs innehåller information om blandning av klippt element.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | Initierar en ny instans av klassen [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource()](#KnkoResource--) | Initierar en ny instans av klassen [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | Initierar en ny instans av klassen [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
## Fält
...
| [getKnockout()](#getKnockout--) | Hämtar eller anger ett värde som indikerar om [blend interior elements]. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | Hämtar eller anger ett värde som indikerar om [blend interior elements]. |
...
Initierar en ny instans av klassen [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| knockout | boolean | om den är satt till  true  [blend interior elements]. |
...
Initierar en ny instans av klassen [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). Med anpassat eller okänt värde
