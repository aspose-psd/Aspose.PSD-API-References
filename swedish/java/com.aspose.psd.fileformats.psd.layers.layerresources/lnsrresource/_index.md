...
description: "Klass lnsrResource."
type: docs
weight: 51
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Initierar en ny instans av klassen [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Initierar en ny instans av klassen [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Fält
...
| [getValue()](#getValue--) | Hämtar värdet som LnsrResourceType om motsvarande enum är beskriven. |
| [hashCode()](#hashCode--) |  |
...
Initierar en ny instans av klassen [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| lnsrResourceType | int | Typ av LNSR. |
...
Initierar en ny instans av klassen [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). Med anpassat eller okänt värde
...
Hämtar värdet som LnsrResourceType om motsvarande enum är beskriven. Annars returneras Unknown

Värde: Värdet som LnsrResourceType
