...
description: "lr32-resursen."
type: docs
weight: 53
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource/
---
...
| --- | --- |
| [Lr16Resource()](#Lr16Resource--) | Initierar en ny instans av klassen [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource) |
## Fält
...
| [getLayers()](#getLayers--) | Hämtar eller anger lagren. |
| [getLength()](#getLength--) | Hämtar resurslängden för PSD‑huvudversionen av bilden. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | Hämtar resurslängden. |
...
| [getRawData_internalized()](#getRawData-internalized--) | Hämtar eller anger rådata för resursen. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Sparar lagerposten. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Hämtar eller anger lagren. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | Hämtar eller anger rådata för resursen. |
...
Initierar en ny instans av klassen [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource)
...
Hämtar resurslängden för PSD‑huvudversionen av bilden.
...
Hämtar resurslängden. Det kan bero på PSD‑versionen.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| psdHeaderVersion | int | PSD‑huvudversionen. |
...
Hämtar eller anger rådata för resursen.
