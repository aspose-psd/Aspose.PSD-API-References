...
description: "Representerar färglägen för psd-filformatet."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd/colormodes/
---
...
Representerar färglägen för psd-filformatet.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Bitmap](#Bitmap) | Bitmap-färgläget. |
| [Cmyk](#Cmyk) | CMYK-färgläge. |
| [Duotone](#Duotone) | Duoton-färgläge. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | Gråskala-läget. |
| [Indexed](#Indexed) | Indexerad färgläge. |
| [Lab](#Lab) | Lab-färgläge. |
| [Multichannel](#Multichannel) | Flerkanaligt färgläge. |
| [Rgb](#Rgb) | RGB-färgläge. |
## Metoder
