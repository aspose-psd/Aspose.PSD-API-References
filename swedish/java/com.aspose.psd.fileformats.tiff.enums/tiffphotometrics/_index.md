...
description: "Fotometrisk interpolering enum"
type: docs
weight: 20
url: /sv/java/com.aspose.psd.fileformats.tiff.enums/tiffphotometrics/
---
...
Fotometrisk interpolering enum
## Fält
...
| [Mask](#Mask) | [föråldrad av TIFF rev. |
| [MinIsBlack](#MinIsBlack) | Minsta värdet är svart. |
| [MinIsWhite](#MinIsWhite) | Minsta värdet är vitt. |
| [Palette](#Palette) | Färgkarta indexerad. |
| [Rgb](#Rgb) | RGB-färgsmodell. |
| [Separated](#Separated) | Färgseparationer. |
...
ICC L\*a\*b\*. Introducerad efter TIFF rev 6.0 av Adobe TIFF Technote 4.
