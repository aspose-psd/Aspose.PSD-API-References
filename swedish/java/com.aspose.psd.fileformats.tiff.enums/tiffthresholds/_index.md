...
description: "Tröskelvärdesbehandling som används på data."
type: docs
weight: 26
url: /sv/java/com.aspose.psd.fileformats.tiff.enums/tiffthresholds/
---
...
Tröskelvärdesbehandling som används på data.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ErrorDiffuse](#ErrorDiffuse) | Vanligtvis Floyd‑Steinberg. |
| [HalfTone](#HalfTone) | Dithrad skanning. |
| [NoDithering](#NoDithering) | Ingen dithring utförs. |
## Metoder
