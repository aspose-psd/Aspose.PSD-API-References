...
description: "Prediktionsschema för LZW"
type: docs
weight: 22
url: /sv/java/com.aspose.psd.fileformats.tiff.enums/tiffpredictor/
---
...
Prediktionsschema för LZW
## Fält

| Fält | Beskrivning |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Horizontal](#Horizontal) | Horisontell differens. |
| [None](#None) | Inget förutsägelseschema används. |
## Metoder
...
Inget förutsägelseschema används.
