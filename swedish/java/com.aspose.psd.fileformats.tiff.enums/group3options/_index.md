...
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
Alternativ för CCITT Group 3/4 faxkodning.

Möjliga värden för GROUP3OPTIONS / TiffTag.T4OPTIONS och TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS-taggar.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Encoding1D](#Encoding1D) | 1-dimensionell kodning. |
| [Encoding2D](#Encoding2D) | 2-dimensionell kodning. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | Fyll till bytegräns. |
| [Uncompressed](#Uncompressed) | Data ej komprimerad. |
## Metoder
...
1-dimensionell kodning. (standard)
