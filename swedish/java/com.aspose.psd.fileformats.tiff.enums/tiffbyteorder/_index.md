...
type: docs
weight: 12
url: /sv/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
| Fält | Beskrivning |
| --- | --- |
| [BigEndian](#BigEndian) | Den stora endian-byteordningen (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | Den lilla endian-byteordningen (Intel). |
## Metoder
...
Den stora endian-byteordningen (Motorola).
...
Den lilla endian-byteordningen (Intel).
