...
description: "Definierar PlLdResource-klassen som innehåller information om ett placerat lager i PSD-filen."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
Definierar PlLdResource-klassen som innehåller information om ett placerat lager i PSD-filen. Den används för att stödja smarta objektlager i Adobe® Photoshop®-bilder. Den ersattes av SoLdResource i Adobe® Photoshop® CS3.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [PlLdResource()](#PlLdResource--) | Initierar en ny instans av klassen [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
## Fält
...
| [getLength()](#getLength--) | Hämtar längden på PlLd-resursen i byte. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Sparar PlLD-resursen till den angivna strömbehållaren. |
...
Initierar en ny instans av klassen [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). Denna standardkonstruktör är avsedd för användning av PlLdResourceLoader. Använd [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) för att skapa PlLdResource-klasser.
...
Hämtar längden på PlLd-resursen i byte.
