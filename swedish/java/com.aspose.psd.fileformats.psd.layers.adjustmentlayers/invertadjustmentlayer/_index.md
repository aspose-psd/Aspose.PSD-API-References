...
description: "Klassen för inverteringsjusteringslager."
type: docs
weight: 21
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
Klassen för inverteringsjusteringslager.
## Fält
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Bearbetar inverteringsjusteringslagret. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Applicera inverteringskorrektionerna på den angivna int ARGB-arrayen. |
...
Bearbetar inverteringsjusteringslagret.
...
Applicera inverteringskorrektionerna på den angivna int ARGB-arrayen.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| pixlar | int[] | int ARGB-arrayen. |
