...
description: "Kurvor justeringslager."
type: docs
weight: 17
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | Hämtar kurvhanteraren. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | Hämtar eller anger ett värde som indikerar om detta objekt använder en kontinuerlig hanterare. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | Hämtar eller anger ett värde som indikerar om detta objekt använder en diskret hanterare. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | Hämtar eller anger ett värde som indikerar om detta objekt använder en kontinuerlig hanterare. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | Hämtar eller anger ett värde som indikerar om detta objekt använder en diskret hanterare. |
...
Hämtar eller anger ett värde som indikerar om detta objekt använder en kontinuerlig hanterare.

Värde:  true  om detta objekt använder en kontinuerlig hanterare; annars,  false .
...
Hämtar eller anger ett värde som indikerar om detta objekt använder en diskret hanterare.

Värde:  true  om detta objekt använder en diskret hanterare; annars,  false .
...
| pixlar | int[] | Pixlarna. |
| start | [Point](../../com.aspose.psd/point) | Starten. |
| end | [Point](../../com.aspose.psd/point) | Slutet. |
