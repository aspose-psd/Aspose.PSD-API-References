...
description: "Selektiv färgjusteringslager."
type: docs
weight: 28
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | Hämtar typen av justeringslagret. |
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Hämtar cmyk-korrigeringen med selektiv färg. |
| [getContainer()](#getContainer--) | Hämtar  Image  behållaren. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Hämtar eller anger korrigeringsmetoden. |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | Hämtar processorn. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Bearbetar Selective Color-lagret. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Slår ihop data i. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Anger cmyk-korrigeringen med selektiv färg. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Ställer in Image-behållaren. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Hämtar eller anger korrigeringsmetoden. |
...
Hämtar typen av justeringslagret.

Värde: Typen av justeringslagret.
...
Hämtar cmyk-korrigeringen med selektiv färg.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| selectiveColorsType | int | Selektiva färger. |
...
Hämtar eller anger korrigeringsmetoden.

Värde: Korrigeringsmetoden.
...
Bearbetar Selective Color-lagret.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | Pixelrektangeln. |
| pixlar | int[] | Arrayen av pixlar. |
| start | [Point](../../com.aspose.psd/point) | Pixelernas övre vänstra position. |
| end | [Point](../../com.aspose.psd/point) | Pixelernas nedre högra position. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - Pixlarrektangeln och de bearbetade pixlarna.
...
Anger cmyk-korrigeringen med selektiv färg.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| selectiveColorsType | int | Typ av de selektiva färgerna. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Cmyk-korrigering. |
