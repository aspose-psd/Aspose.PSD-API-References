...
description: "Klassen för färgbalans justeringslager."
type: docs
weight: 16
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Hämtar eller anger balansen för Shadow YellowBlue. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Applicera korrigeringarna för de aktuella skuggorna, mellantonerna och highlightsen på den angivna int RGB‑arrayen. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Hämtar eller anger balansen för Shadow YellowBlue. |
...
Hämtar eller anger balansen för Shadow YellowBlue.
...
Applicera korrigeringarna för de aktuella skuggorna, mellantonerna och highlightsen på den angivna int RGB‑arrayen.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| pixlar | int[] | Den int‑färgen RGB‑arrayen. |
