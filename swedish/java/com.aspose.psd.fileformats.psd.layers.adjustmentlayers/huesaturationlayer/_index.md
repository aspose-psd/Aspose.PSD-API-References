...
description: "NyansMättnad justeringslager."
type: docs
weight: 20
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| [getColorize()](#getColorize--) | Hämtar eller anger ett värde som indikerar om denna [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) är färglagd. |
...
| [getRange(int index)](#getRange-int-) | Hämtar intervallet. |
...
| [setColorize(boolean value)](#setColorize-boolean-) | Hämtar eller anger ett värde som indikerar om denna [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) är färglagd. |
...
Hämtar eller anger ett värde som indikerar om denna [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) är färglagd.

Värde:  true  om färgläggning; annars,  false .
