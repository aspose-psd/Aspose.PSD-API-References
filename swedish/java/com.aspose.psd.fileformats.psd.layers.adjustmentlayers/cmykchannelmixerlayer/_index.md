...
description: "CMYK-kanalblandare justeringslager."
type: docs
weight: 14
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
CMYK-kanalblandare justeringslager.
## Fält
...
| [getBlackChannel()](#getBlackChannel--) | Hämtar den svarta kanalen. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Hämtar kanalens index med. |
...
| [getCyanChannel()](#getCyanChannel--) | Hämtar cyan-kanalen. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Hämtar magentakanalen. |
...
| [getMonochrome()](#getMonochrome--) | Hämtar eller anger ett värde som indikerar om detta [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) är monokrom. |
...
| [getYellowChannel()](#getYellowChannel--) | Hämtar gul-kanalen. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Bearbetar justeringslagret. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Hämtar eller anger ett värde som indikerar om detta [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) är monokrom. |
...
Hämtar den svarta kanalen.

Värde: Den svarta kanalen.
...
Hämtar kanalens index med. Returnerar CmykMixerChannel
...
Hämtar magentakanalen.

Värde: Magentakanalen.
...
Hämtar eller anger ett värde som indikerar om detta [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) är monokrom.
