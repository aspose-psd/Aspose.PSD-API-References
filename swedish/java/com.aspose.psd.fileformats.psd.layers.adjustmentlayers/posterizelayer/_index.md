...
description: "Posteriseringslager."
type: docs
weight: 25
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Posterize-lager. Hanterar Posterize-rendering med data från PostResource.
## Fält
...
| [getLevels()](#getLevels--) | Nivåer för Posterize-lager. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Bearbetar Posterize-lagret. |
...
| [setLevels(short value)](#setLevels-short-) | Nivåer för Posterize-lager. |
