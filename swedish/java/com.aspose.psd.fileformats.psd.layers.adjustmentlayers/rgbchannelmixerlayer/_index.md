...
description: "RGB-kanalblandare justeringslager."
type: docs
weight: 26
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
RGB-kanalblandare justeringslager.
## Fält
...
| [getBlueChannel()](#getBlueChannel--) | Hämtar den blå kanalen. |
...
| [getGreenChannel()](#getGreenChannel--) | Hämtar den gröna kanalen. |
...
| [getRedChannel()](#getRedChannel--) | Hämtar den röda kanalen. |
...
Hämtar den blå kanalen.

Värde: Den blå kanalen.
...
Hämtar kanalens index med. Returnerar RgbMixerChannel
