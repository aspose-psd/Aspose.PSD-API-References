...
description: "Exponeringsjusteringslager."
type: docs
weight: 18
url: /sv/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | Hämtar eller anger exponeringen. |
...
| [getGammaCorrection()](#getGammaCorrection--) | Hämtar eller anger gamma-korrektionen. |
...
| [setExposure(float value)](#setExposure-float-) | Hämtar eller anger exponeringen. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Hämtar eller anger gamma-korrektionen. |
...
| [setOffset(float value)](#setOffset-float-) | Hämtar eller anger förskjutningen. |
...
Hämtar eller anger exponeringen. För PS är intervallet för exponering från -20 till +20.
...
Hämtar eller anger GammaCorrection. För PS är intervallet för GammaCorrection från 9,99 till +0,01.

Värde: GammaCorrection.
...
Hämtar eller anger Offset. För PS är intervallet för Offset från -0,5 till +0,5.
