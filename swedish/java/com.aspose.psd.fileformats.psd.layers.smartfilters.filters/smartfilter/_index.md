...
description: "Klassen för att bearbeta grundlogiken för smarta filter."
type: docs
weight: 13
url: /sv/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter/
---
...
Klassen för att bearbeta grundlogiken för smarta filter.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [SmartFilter()](#SmartFilter--) | Initierar en ny instans av klassen [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter). |
## Metoder
...
Initierar en ny instans av klassen [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter).
