...
description: "Det smarta filtret GaussianBlur."
type: docs
weight: 11
url: /sv/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter/
---
...
Det smarta filtret GaussianBlur.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [GaussianBlurSmartFilter()](#GaussianBlurSmartFilter--) | Initierar en ny instans av klassen [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats/psd.layers.smartfilters.filters/gaussianblursmartfilter). |
## Fält
...
| [getRadius()](#getRadius--) | Hämtar eller anger radien för gaussian smartfilter. |
...
| [setRadius(double value)](#setRadius-double-) | Hämtar eller anger radien för gaussian smartfilter. |
...
Initierar en ny instans av klassen [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats/psd.layers.smartfilters.filters/gaussianblursmartfilter).
...
Hämtar eller anger radien för gaussian smartfilter.
