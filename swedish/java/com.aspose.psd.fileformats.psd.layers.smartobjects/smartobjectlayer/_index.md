...
description: "Definierar klassen SmartObjectLayer som innehåller inbäddade smartobjekt i PSD-filen eller länkade smartobjekt i den externa filen."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Definierar klassen SmartObjectLayer som innehåller inbäddade i PSD-filen eller länkade smarta objekt i den externa filen. Med Smart Objects kan du: Utföra icke-förstörande transformationer. Du kan skala, rotera, skeva, förvränga, perspektivtransformera eller vrida ett lager utan att förlora originalbilddata eller kvalitet eftersom transformationerna don\\ufffdt påverkar originaldata. Arbeta med vektordata, såsom vektorillustrationer från Illustrator, som annars skulle rasteriseras. Utföra icke-förstörande filtrering. Du kan redigera filter som tillämpas på Smart Objects när som helst. Redigera ett Smart Object och uppdatera automatiskt alla dess länkade instanser. Applicera en lagermask som antingen är länkad eller olänkad till Smart Object‑lagret. Prova olika designer med lågupplösta platshållarbilder som du senare ersätter med slutversioner. I Adobe\\ufffd Photoshop\\ufffd kan du bädda in innehållet i en bild i ett PSD‑dokument. Mer information finns här:   Ett lager med ett inbäddat smart objekt innehåller placerade (PlLd) och SoLd‑resurser med smarta objekt‑egenskaper. PlLd‑resursen kan finnas ensam för PSD‑versioner äldre än 10. Dessa resurser innehåller UniqueId för LiFdDataSource i den globala Lnk2Resource med det inbäddade filnamnet och andra parametrar, inklusive det inbäddade filinnehållet i originalformat som en byte‑array.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Initierar en ny instans av klassen [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Fält

| Fält | Beskrivning |
| --- | --- |
| [BlendSignature](#BlendSignature) | Representerar signatur för blandningsläge. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Meddelandet för både placerade och smarta objektresurser som hittats |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Meddelandet Du kan bara kopiera ett inbäddat smart objekt |
| [LayerHeaderSize](#LayerHeaderSize) | Storleken på lagerhuvudet. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Meddelandet Ingen placerad eller smart objektresurs hittades |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Meddelandet Fel placerade resursindex |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Konverterar detta inbäddade smarta objekt till ett länkat smart objekt. |
...
| [duplicateLayer()](#duplicateLayer--) | Skapar ett nytt smart objekt‑lager genom att kopiera detta. |
| [embedLinked()](#embedLinked--) | Bäddar in det länkade smarta objektet i detta lager. |
| [equals(Object obj)](#equals-java.lang.Object-) | Bestämmer om det angivna objektet är lika med denna instans. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Exporterar det inbäddade eller länkade innehållet till en fil. |
...
| [getContentType()](#getContentType--) | Hämtar typen av smartobjektlagrets innehåll. |
| [getContents()](#getContents--) | Hämtar eller anger innehållet i smart objekt‑lagret. |
| [getContentsBounds()](#getContentsBounds--) | Hämtar eller anger gränserna för smart objekt‑innehållet. |
| [getContentsSource()](#getContentsSource--) | Hämtar eller anger källan för smart objekt‑innehållet. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Den hämtar eller anger den sista storleken på bilden som ska vridas |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Hämtar eller anger den ursprungliga fyrhörningen. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Hämtar de placerade och smarta lagerresursindexen samt den korrekta placerade resursen. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Hämtar den placerade lagerresursen |
...
| [getSmartFilters()](#getSmartFilters--) | Hämtar de smarta filtren. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Hämtar eller anger transformeringsfyrhörningen. |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Hämtar det inbäddade eller länkade bildinnehållet i smart objekt‑lagret. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Skapar ett nytt smart objekt‑lager genom att kopiera detta. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Anropas när behållaren för detta [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) har satts. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Länkar om det länkade smarta objektet till en ny fil. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Ersätter det smarta objektets inbäddade innehåll i smart objekt‑lagret. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Ersätter det smarta objektets inbäddade innehåll i smart objekt‑lagret. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Ersätter innehållet med en fil. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Ersätter innehållet med en fil. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Ersätter innehållet med en fil. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Ersätter innehållet med en fil. |
...
| [setContents(byte[] value)](#setContents-byte---) | Hämtar eller anger innehållet i smart objekt‑lagret. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Hämtar eller anger gränserna för smart objekt‑innehållet. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Hämtar eller anger källan för smart objekt‑innehållet. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Den hämtar eller anger den sista storleken på bilden som ska vridas |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Hämtar eller anger den ursprungliga fyrhörningen. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Hämtar leverantören för smarta objekt. |
| [setTop(int value)](#setTop-int-) | Hämtar eller anger den övre lagerpositionen. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Hämtar eller anger transformeringsfyrhörningen. |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Uppdaterar identifieraren för datakällan. |
| [updateModifiedContent()](#updateModifiedContent--) | Uppdaterar smartobjektlagrets bildcache med det modifierade innehållet. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Uppdaterar smartobjektlagrets bildcache med modifierat innehåll. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Uppdaterar de placerade / smarta resurserna när placedResource ändras eller när konvertering behövs. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Det är ett omslag för "IWarpSupport" för att uppdatera lagerförhandsgranskning. |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Strömmen av objekt |
...
Meddelandet för både placerade och smarta objektresurser som hittats
...
Meddelandet Du kan bara kopiera ett inbäddat smart objekt
...
Meddelandet Ingen placerad eller smart objektresurs hittades
...
Meddelandet Fel placerade resursindex
...
Konverterar detta inbäddade smarta objekt till ett länkat smart objekt.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| linkedPath | java.lang.String | Den länkade sökvägen. |
...
Skapar ett nytt smartobjektlager genom att kopiera detta. Observera att för inbäddade smarta objekt delas den inbäddade bilden. Om du vill kopiera den inbäddade bilden, använd [.newSmartObjectViaCopy](../../null/\\#newSmartObjectViaCopy) metoden.
...
Bäddar in det länkade smarta objektet i detta lager.
...
Exporterar det inbäddade eller länkade innehållet till en fil.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| filePath | java.lang.String | Exportfilens sökväg. |
...
Typen av smartobjektlagrets innehåll. Det inbäddade smartobjektets innehåll är den inbäddade råa bildfilen:  LiFdDataSource.Data . Det länkade smartobjektets innehåll är det råa innehållet i den länkade bildfilen om den är tillgänglig: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Vi stödjer inte inläsning från Adobe\\\\ufffd Photoshop\\\\ufffd \\\\ufffd\\\\ufffd Graphics Library när  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)) är true. För vanliga länkar filer använder vi först  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)) för att söka efter filen relativt till källbildens sökväg  DataStreamSupporter.SourceImagePath , om den inte är tillgänglig söker vi i  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)), och om den fortfarande saknas letar vi efter länken i samma katalog som vår bild finns:  DataStreamSupporter.SourceImagePath .

Värde: Typen av smartobjektlagrets innehåll.
...
Hämtar eller anger innehållet i smartobjektslagret. Det inbäddade smartobjektets innehåll är den inbäddade råa bildfilen: LiFdDataSource.Data och dess egenskaper. Det länkade smartobjektets innehåll är det råa innehållet i den länkade bildfilen om den är tillgänglig och dess egenskaper: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Vi stödjer inte inläsning från Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library när LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) är sant. För vanliga länkar använder vi först LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) för att söka efter filen relativt till källbildens sökväg DataStreamSupporter.SourceImagePath, om den inte finns söker vi på LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), och om den inte finns letar vi efter länken i samma katalog som vår bild är i: DataStreamSupporter.SourceImagePath.
...
Hämtar eller anger gränserna för smart objekt‑innehållet.

Värde: Smartobjektets gränser.
...
Hämtar eller anger källan för smart objekt‑innehållet.

Värde: Smartobjektets datakälla.
...
Den hämtar eller anger den sista storleken på bilden som ska vridas
...
Hämtar eller anger den ursprungliga fyrhörningen.

Värde: Den ursprungliga fyrhörningen.
...
Hämtar de placerade och smarta lagerresursindexen samt den korrekta placerade resursen.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Resurserna. |
| placedResourceIndex | int[] | Index för den placerade resursen. |
| smartResourceIndex | int[] | Index för den smarta resursen. |
...
Hämtar den placerade lagerresursen
...
Hämtar eller anger transformeringsfyrhörningen.

Värde: Transformationsfyrhörningen.
...
Hämtar det inbäddade eller länkade bildinnehållet i smart objekt‑lagret.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Alternativen. |
...
Skapar ett nytt smartobjektlager genom att kopiera detta. Reproducerar Lager -> Smartobjekt -> Nytt smartobjekt via Kopiera-funktionen i Adobe\ufffd Photoshop\ufffd. Observera att den endast är aktiverad för inbäddade smartobjekt eftersom den inbäddade bilden också kopieras. Om du vill dela den inbäddade bilden, använd [.duplicateLayer](../../null/\#duplicateLayer)-metoden.
...
Anropas när behållaren för detta [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) har satts.
...
Länkar om det länkade smartobjektet till en ny fil. Det är inte nödvändigt att anropa UpdateModifiedContent-metoden efteråt.
...
Ersätter det smarta objektets inbäddade innehåll i smart objekt‑lagret.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Bilden. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Bilden. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Upplösningsinställningarna. Om null används bildens upplösning. |
...
Ersätter innehållet med en fil. Det är inte nödvändigt att anropa UpdateModifiedContent-metoden efteråt.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Den länkade sökvägen. |
| isReplaceOnlyThis | boolean | Flaggan visar att ersätta innehåll från detta smarta lager eller till alla smarta lager med detta innehåll |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| värde | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Uppdaterar identifieraren för datakällan.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | Datakällans identifierare. |
...
Uppdaterar smartobjektlagrets bildcache med det modifierade innehållet.
...
Uppdaterar smartobjektlagrets bildcache med modifierat innehåll.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Bilden. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Upplösningen. |
| skipBoundsUpdate | boolean | om satt till true [hoppa över gränsuppdatering]. |
...
Uppdaterar de placerade / smarta resurserna när placedResource ändras eller när konvertering behövs.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| toEmbedded | boolean | om satt till true konvertera till en inbäddad resurs om behövs, annars till en länkad. |
...
Det är ett omslag för "IWarpSupport" för att uppdatera lagerförhandsgranskning.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Pixlar och storlek på ny förhandsgranskningsbild |
