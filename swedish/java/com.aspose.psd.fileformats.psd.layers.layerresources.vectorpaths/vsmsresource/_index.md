...
description: "Klassen VsmsResource."
type: docs
weight: 29
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
Klassen VsmsResource. Denna resurs innehåller information om vektorlagermask.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | Initierar en ny instans av klassen [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
| [VsmsResource()](#VsmsResource--) | Initierar en ny instans av klassen [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
## Fält
...
| [hashCode()](#hashCode--) |  |
| [isChanged_internalized()](#isChanged-internalized--) | Bestämmer om detta objekt har ändrats. |
...
| [updateDataToCurrent_internalized()](#updateDataToCurrent-internalized--) | Uppdatera cachad originaldata till det aktuella tillståndet |
| [wait()](#wait--) |  |
...
Initierar en ny instans av klassen [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource).
...
Bestämmer om detta objekt har ändrats.

**Returns:**
boolean -  true  om detta objekt har ändrats; annars  false .
...
Uppdatera cachad originaldata till det aktuella tillståndet
