...
description: "Klassen för artboardlagret."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Lägger till lagret i lagergruppen. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Lägger till lagret i lagergruppen. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Lägger till lagergruppen. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Hämtar eller anger artboard‑bakgrundsfärgen. |
...
| [getLayers()](#getLayers--) | Hämtar lagren i lagergruppen |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Hämtar de sanna gränserna för ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Hämtar  LayerSectionResource  från resurser. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Hämtar eller anger ett värde som indikerar om [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) har bakgrundsfärgen. |
...
| [isOpen()](#isOpen--) | Hämtar eller anger om mappen är öppen; om den sätts till  true  blir gruppen öppen vid start, annars minimerad. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Hämtar eller anger artboard‑bakgrundsfärgen. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Hämtar eller anger om mappen är öppen; om den sätts till  true  blir gruppen öppen vid start, annars minimerad. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Lagret. |
| index | int | Indexet där lagret kommer att infogas. Ogiltiga värden betyder slutet på lagerlistan. |
...
| --- | --- | --- |
| groupName | java.lang.String | Namn på gruppen. |
| psdHeader | com.aspose.internal.fileformats.psd.sections.PsdHeader | PSD‑rubriken. |
| colorPalette | [IColorPalette](../../com.aspose.psd/icolorpalette) | Färgpaletten. |
| layerNestingLevel | int |  |

**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Returnerar en array av två LayerGroup‑objekt, där den första [0] är startgruppmarkören och den andra [1] är slutgruppmarkören.
### cacheData() {#cacheData--}
```
...
Hämtar eller anger artboard‑bakgrundsfärgen.
...
Hämtar de sanna gränserna för ArtboardLayer.
...
Hämtar  LayerSectionResource  från resurser.
...
Hämtar eller anger ett värde som indikerar om [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) har bakgrundsfärgen.
