...
description: "Formlager."
type: docs
weight: 29
url: /sv/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Formlager. Inkapslar logiken för arbete med Formlager och relaterade resurser.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Initierar en ny instans av klassen [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Fält
...
| [createInstance()](#createInstance--) | Skapar en ny instans av klassen [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Fyllinställningar för det interna området av former i Formlagret. |
...
| [getPath()](#getPath--) | Hämtar uppsättningen av vägar som finns i ett Formlager. |
...
| [getStroke()](#getStroke--) | Hämtar eller anger streckinställningar för former. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Kallas när [global resources changed]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Kallas när [resources change]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Fyllinställningar för det interna området av former i Formlagret. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Hämtar eller anger streckinställningar för former. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Uppdaterar resurser från Shape‑lagrets egenskaper. |
...
Initierar en ny instans av klassen [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). Alla resurser skapas i sitt standardläge.
...
Skapar en ny instans av klassen [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
Fyllinställningar för det interna området av former i Formlagret.
...
Hämtar uppsättningen av vägar som finns i ett Formlager.
...
Hämtar eller anger streckinställningar för former.
...
**Returns:**
boolean - Booleskt värde som indikerar att lagret är giltigt.
...
Kallas när [global resources changed].

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| avsändare | java.lang.Object | Avsändaren. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | EventArgs‑instansen som innehåller händelsedata. |
