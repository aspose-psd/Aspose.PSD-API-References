...
description: "Grupplagerklass"
type: docs
weight: 19
url: /sv/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Hämtar höjden på lagergruppen. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Hämtar den förenade gränsen för alla lager i LayerGroup. |
...
| [getWidth()](#getWidth--) | Hämtar bredden på lagergruppen. |
...
Hämtar den förenade gränsen för alla lager i LayerGroup.
...
Hämtar bredden på lagergruppen.
