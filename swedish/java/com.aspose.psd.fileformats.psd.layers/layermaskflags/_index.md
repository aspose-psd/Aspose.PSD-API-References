...
description: "Lagermaskflaggor"
type: docs
weight: 24
url: /sv/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| Fält | Beskrivning |
| --- | --- |
| [Disabled](#Disabled) | Lagermasken är inaktiverad. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | Invertera lagermasken vid blandning. |
| [None](#None) | Inga flaggor definierade. |
| [RelativeToLayer](#RelativeToLayer) | Positionen är relativ till lagret. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | Indikerar att användarmasken faktiskt kom från rendering av annan data. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | Indikerar att användar- och/eller vektormaskerna har parametrar tillämpade på dem. |
## Metoder
...
Invertera lagermasken vid blandning.
...
Positionen är relativ till lagret.
...
Indikerar att användarmasken faktiskt kom från rendering av annan data.
...
Indikerar att användar- och/eller vektormaskerna har parametrar tillämpade på dem.
