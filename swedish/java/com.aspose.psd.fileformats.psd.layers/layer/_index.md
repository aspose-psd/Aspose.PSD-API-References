...
description: "PSD-lagret."
type: docs
weight: 16
url: /sv/java/com.aspose.psd.fileformats.psd.layers/layer/
---
...
| --- | --- |
| [Layer()](#Layer--) | Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer). |
| [Layer(RasterImage image)](#Layer-com.aspose.psd.RasterImage-) |  |
| [Layer(RasterImage image, boolean disposeImage)](#Layer-com.aspose.psd.RasterImage-boolean-) | Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer). |
| [Layer(InputStream stream)](#Layer-java.io.InputStream-) | Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer). |
| [Layer(Rectangle bounds, byte[] redBytes, byte[] greenBytes, byte[] blueBytes, String name)](#Layer-com.aspose.psd.Rectangle-byte---byte---byte---java.lang.String-) | Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) från byte-arrayer. |
## Fält
...
Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer). Konstruktor för lat initiering.
...
Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| image | [RasterImage](../../com.aspose.psd/rasterimage) | Bilden. |
| disposeImage | boolean | om inställd på  true  [dispose image]. |
...
Initierar en ny instans av klassen [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) från byte-arrayer.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Lagrets gränser. |
| redBytes | byte[] | De röda bytena. |
| greenBytes | byte[] | De gröna bytena. |
| blueBytes | byte[] | De blåa bytena. |
