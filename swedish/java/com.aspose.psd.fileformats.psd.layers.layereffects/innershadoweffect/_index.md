...
description: "Innerskuggelager‑effekt"
type: docs
weight: 14
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | Hämtar eller anger spridningen (choke) i procent. |
...
| [setSpread(int value)](#setSpread-int-) | Hämtar eller anger spridningen (choke) i procent. |
