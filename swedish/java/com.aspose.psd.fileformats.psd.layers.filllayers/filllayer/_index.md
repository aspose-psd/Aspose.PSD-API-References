...
description: "Fyllningslager."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| [createInstance(int fillType)](#createInstance-int-) | Skapa en ny instans av klassen [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) baserat på fyllningstyp. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Hämtar renderingsprocessorn för [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Hämtar eller anger fyllningsopaciteten. |
| [getFillSettings()](#getFillSettings--) | Hämtar fyllningsinställningarna. |
| [getFillType()](#getFillType--) | Hämtar fyllningens typ. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Hämtar fyllningsinställningarna. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Uppdaterar Fill Layer Pixels Data enligt faktiska [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Skapa en ny instans av klassen [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) baserat på fyllningstyp.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| fillType | int | Typen av fyllningslager. |
...
Hämtar renderingsprocessorn för [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | Bilden att rendera till. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Gränserna att bearbeta. |

**Returns:**
com.aspose.internal.IPartialProcessor - Returnerar renderingsprocessorn för [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Hämtar fyllningens typ.

Värde: Typ av fyllning.
...
Uppdaterar Fill Layer Pixels Data enligt faktiska [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
