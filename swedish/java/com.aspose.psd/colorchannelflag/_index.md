...
description: "Anger enskilda kanaler i CMYK-färgrymden cyan magenta gul svart."
type: docs
weight: 22
url: /sv/java/com.aspose.psd/colorchannelflag/
---
...
Anger enskilda kanaler i CMYK (cyan, magenta, gul, svart) färgrymden. Denna uppräkning används av SetOutputChannel-metoderna.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [ColorChannelC](#ColorChannelC) | Den cyan-färgkanalen. |
| [ColorChannelK](#ColorChannelK) | Den svarta färgkanalen. |
| [ColorChannelLast](#ColorChannelLast) | Den sista valda kanalen bör användas. |
| [ColorChannelM](#ColorChannelM) | Den magenta färgkanalen. |
| [ColorChannelY](#ColorChannelY) | Den gula färgkanalen. |
...
Den sista valda kanalen bör användas.
