...
description: "Anger måttenheten för de givna data."
type: docs
weight: 51
url: /sv/java/com.aspose.psd/graphicsunit/
---
...
Anger måttenheten för de givna data.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Display](#Display) | Anger måttenheten för displayenheten. |
...
| [Point](#Point) | Anger en skrivarpunkt (1/72 tum) som måttenhet. |
| [World](#World) | Anger världens koordinatsystemsenhet som måttenhet. |
## Metoder
...
Anger måttenheten för displayenheten. Vanligtvis pixlar för videodisplayer och 1/100 tum för skrivare.
...
Anger världens koordinatsystemsenhet som måttenhet.
