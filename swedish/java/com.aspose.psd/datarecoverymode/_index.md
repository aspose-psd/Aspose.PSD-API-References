...
description: "Datåterställningsläget."
type: docs
weight: 37
url: /sv/java/com.aspose.psd/datarecoverymode/
---
...
| Fält | Beskrivning |
| --- | --- |
| [ConsistentRecover](#ConsistentRecover) | Det konsekventa återställningsläget försöker återställa all data så länge korruption inte bryter filformatet och möjliggör korrekt vidare bearbetning. |
...
Det konsekventa återställningsläget försöker återställa all data så länge korruption inte bryter filformatet och möjliggör korrekt vidare bearbetning.
