...
type: docs
weight: 109
url: /sv/java/com.aspose.psd/textrenderinghint/
---
...
| [SystemDefault](#SystemDefault) | Varje tecken ritas med sin glyf-bitmap, med systemets standardrenderingshint. |
## Metoder
...
Varje tecken ritas med sin antialiasade glyf-bitmap med hintning. Mycket bättre kvalitet på grund av antialiasing, men till en högre prestandakostnad.
...
Varje tecken ritas med sin glyf-bitmap. Hintning används för att förbättra tecknens utseende på stammar och kurvatur.
...
Varje tecken ritas med sin glyf-bitmap, med systemets standardrenderingshint. Texten kommer att ritas med de fontutjämningsinställningar som användaren har valt för systemet.
