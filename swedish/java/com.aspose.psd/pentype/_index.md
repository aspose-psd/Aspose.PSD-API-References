...
description: "Anger vilken fyllningstyp ett Pen-objekt använder för att fylla linjer."
type: docs
weight: 79
url: /sv/java/com.aspose.psd/pentype/
---
...
Specificerar fyllningstypen som ett  Pen  objekt använder för att fylla linjer.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HatchFill](#HatchFill) | Anger en korsningsfyllning. |
| [LinearGradient](#LinearGradient) | Anger en linjär gradientfyllning. |
| [PathGradient](#PathGradient) | Anger en sökvägsgradientfyllning. |
| [SolidColor](#SolidColor) | Anger en solid fyllning. |
| [TextureFill](#TextureFill) | Anger en bitmap-texturfyllning. |
## Metoder
...
Anger en linjär gradientfyllning.
...
Anger en sökvägsgradientfyllning.
...
Anger en bitmap-texturfyllning.
