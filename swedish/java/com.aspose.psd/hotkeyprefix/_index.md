...
description: "Anger vilken typ av visning som används för snabbtangentsprefix som relaterar till text."
type: docs
weight: 53
url: /sv/java/com.aspose.psd/hotkeyprefix/
---
...
Anger vilken typ av visning som används för snabbtangentsprefix som relaterar till text.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Hide](#Hide) | Visa inte hotkey-prefixet. |
| [None](#None) | Inget hotkey-prefix. |
| [Show](#Show) | Visa hotkey-prefixet. |
## Metoder
