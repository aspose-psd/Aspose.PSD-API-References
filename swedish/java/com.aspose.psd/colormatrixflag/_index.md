...
description: "Anger vilka typer av bilder och färger som kommer att påverkas av färg- och gråskalejusteringsinställningarna för en ImageAttributes."
type: docs
weight: 26
url: /sv/java/com.aspose.psd/colormatrixflag/
---
...
Anger typerna av bilder och färger som kommer att påverkas av färg- och gråskalajusteringsinställningarna för ett ImageAttributes.
## Fält
...
Alla färger justeras, men grå nyanser justeras inte. En grå nyans är någon färg som har samma värde för sina röda, gröna och blå komponenter.
