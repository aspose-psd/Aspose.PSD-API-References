...
description: "Dithermetoderna som används för att kontrollera färgkonvertering."
type: docs
weight: 41
url: /sv/java/com.aspose.psd/ditheringmethods/
---
...
| Fält | Beskrivning |
| --- | --- |
| [CustomConverter](#CustomConverter) | Den anpassade konverteraren. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | Paletten ignoreras inte och smart färgkonvertering bör tillämpas. |
| [PaletteIgnore](#PaletteIgnore) | Paletten ignoreras |
## Metoder
...
Paletten ignoreras inte och smart färgkonvertering bör tillämpas.
