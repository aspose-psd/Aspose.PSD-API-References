...
description: "Enumeration com.aspose.psd.InterpolationMode specificerar den algoritm som används när bilder skalas eller roteras."
type: docs
weight: 63
url: /sv/java/com.aspose.psd/interpolationmode/
---
...
Den  com.aspose.psd.InterpolationMode  enumeration specificerar algoritmen som används när bilder skalas eller roteras.
## Fält
...
Anger bikubisk interpolation. Ingen förfiltrering utförs. Detta läge är inte lämpligt för att krympa en bild till under 25 procent av dess originalstorlek.
...
Anger bilinjär interpolation. Ingen förfiltrering utförs. Detta läge är inte lämpligt för att krympa en bild till under 50 procent av dess originalstorlek.
...
Anger högkvalitativ, bikubisk interpolation. Förfiltrering utförs för att säkerställa högkvalitativ krympning. Detta läge producerar de högsta kvalitetsförändrade bilderna.
