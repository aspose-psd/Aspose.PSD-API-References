...
description: "Anger vilken cachetyp som ska användas."
type: docs
weight: 15
url: /sv/java/com.aspose.psd/cachetype/
---
...
Anger vilken cachetyp som ska användas.
## Fält

| Fält | Beskrivning |
| --- | --- |
| [Auto](#Auto) | Anger automatisk cache-typ. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Endast cache i minnet. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Endast diskcache. |
...
Anger automatisk cache-typ. Det automatiska cacheschemat kommer först att försöka cachea i minnet och sedan på disk.
