...
description: "Definierar LnkeResource‑klassen som innehåller information om externa länkade filer eller tillgångar i PSD‑formatbilden."
type: docs
weight: 17
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Definierar klassen LnkeResource som innehåller information om externa länkade filer eller resurser i PSD-formatets bild. Länkresursen kan innehålla flera [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) instanser som kan nås via indexeraren. Detta är en del av PSD File Format Manipulation API som hjälper till att programatiskt modifiera Adobe® Photoshop®-filer.
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Initierar en ny instans av klassen [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) . |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Initierar en ny instans av klassen [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) . |
## Fält
...
| [get_Item(int index)](#get-Item-int-) | Hämtar [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) på det angivna indexet. |
...
Initierar en ny instans av klassen [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) .
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Datakällorna. |
...
Hämtar [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) på det angivna indexet.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Indexen. Värde: [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource). |
