...
description: "Definierar liFD-datakällklassen i PSD‑filen som innehåller information om en inbäddad fil."
type: docs
weight: 10
url: /sv/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
Definierar liFD-datakällklassen i PSD File som innehåller information om en inbäddad fil. Detta är en del av PSD File Format Manipulation API som hjälper till att modifiera Adobe® Photoshop®‑filer
## Konstruktörer

| Konstruktör | Beskrivning |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | Initierar en ny instans av klassen [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Initierar en ny instans av klassen [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
## Fält
...
| [getData()](#getData--) | Hämtar eller anger den inbäddade smartobjektsdata i PSD‑filen. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | Hämtar längden på den inbäddade datan. |
...
| [setData(byte[] value)](#setData-byte---) | Hämtar eller anger den inbäddade smartobjektsdata i PSD‑filen. |
...
Initierar en ny instans av klassen [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource).
...
Hämtar eller anger den inbäddade smartobjektsdata i PSD‑filen.

Värde: Den inbäddade smartobjektsdatan.
...
Hämtar längden på den inbäddade datan.

Värde: Längden på den inbäddade datan.
