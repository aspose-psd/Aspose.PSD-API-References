---
title: LayerState Class
type: docs
weight: 20
url: /python-net/aspose.psd.fileformats.psd.layers.animation/layerstate/
---
...
| **Name** | **Description** |
| :- | :- |
| [LayerState()](#LayerState__1) | Initializes a new instance of the LayerState class |
## **Properties**
...
| position_offset | [Point](/psd/python-net/aspose.psd/point) | r/w | Gets or sets the layer position offset related to the actual layer position. |
| state_effects | [LayerStateEffects](/psd/python-net/aspose.psd.fileformats.psd.layers.animation/layerstateeffects) | r | Gets the layer state effects. |
| vertical_fx_rf | double | r/w | Gets or sets the VerticalFXRf value. |


### Constructor: LayerState() {#LayerState__1}
