---
title: PathStructure Class
type: docs
weight: 120
url: /python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| **Name** | **Description** |
| :- | :- |
| [PathStructure(key_name)](#PathStructure_key_name_1) | Initializes a new instance of the [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/) class. |
## **Properties**
...
| path | string | r/w | Gets or sets the path. |
| prefix | string | r/w | Gets or sets the path prefix. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Initializes a new instance of the [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/) class.
