...
type: docs
weight: 20
url: /python-net/aspose.psd.xmp.schemas.photoshop/photoshoppackage/
---
...
| **Name** | **Description** |
| :- | :- |
| [PhotoshopPackage()](#PhotoshopPackage__1) | Initializes a new instance of the PhotoshopPackage class |
## **Properties**
...
| [set_authors_position(authors_position)](#set_authors_position_authors_position_5) | Sets the authors position. |
| [set_caption_writer(caption_writer)](#set_caption_writer_caption_writer_6) | Sets the caption writer. |
| [set_category(category)](#set_category_category_7) | Sets the category. |
| [set_city(city)](#set_city_city_8) | Sets the city. |
| [set_color_mode(color_mode)](#set_color_mode_color_mode_9) | Sets the color mode. |
| [set_country(country)](#set_country_country_10) | Sets the country. |
| [set_created_date(created_date)](#set_created_date_created_date_11) | Sets created date. |
| [set_credit(credit)](#set_credit_credit_12) | Sets the credit. |
| [set_document_ancestors(ancestors)](#set_document_ancestors_ancestors_13) | Sets the document ancestors. |
| [set_headline(headline)](#set_headline_headline_14) | Sets the headline. |
| [set_history(history)](#set_history_history_15) | Sets the history. |
| [set_icc_profile(icc_profile)](#set_icc_profile_icc_profile_16) | Sets the icc profile. |
| [set_instructions(instructions)](#set_instructions_instructions_17) | Sets the instructions. |
| [set_source(source)](#set_source_source_18) | Sets the source. |
| [set_state(state)](#set_state_state_19) | Sets the state. |
| [set_supplemental_categories(supplemental_categories)](#set_supplemental_categories_supplemental_categories_20) | Sets supplemental categories. |
| [set_transmission_reference(transmission_reference)](#set_transmission_reference_transmission_reference_21) | Sets the transmission reference. |
| [set_urgency(urgency)](#set_urgency_urgency_22) | Sets the urgency. |
...
| Parameter | Type | Description |
| :- | :- | :- |
| color_mode | [ColorMode](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colormode) | The color mode. |
