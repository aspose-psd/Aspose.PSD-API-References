...
| [Matrix(m11, m12, m21, m22, m31, m32)](#Matrix_m11_m12_m21_m22_m31_m32_2) | Initializes a new instance of the [Matrix](/psd/python-net/aspose.psd/matrix/) class. |
| [Matrix(origin)](#Matrix_origin_3) | Makes a copy of the [Matrix](/psd/python-net/aspose.psd/matrix/) class. |
| [Matrix(rect, plgpts)](#Matrix_rect_plgpts_4) | Initializes a new instance of the [Matrix](/psd/python-net/aspose.psd/matrix/) class to the geometric transform defined by the specified rectangle and array of points. |
| [Matrix(rect, plgpts)](#Matrix_rect_plgpts_5) | Initializes a new instance of the [Matrix](/psd/python-net/aspose.psd/matrix/) class to the geometric transform defined by the specified rectangle and array of points. |
## **Properties**
...
| elements | float | r | Gets an array of floating-point values that represents the elements of this [Matrix](/psd/python-net/aspose.psd/matrix/). |
