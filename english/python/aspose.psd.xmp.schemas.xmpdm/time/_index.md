...
type: docs
weight: 40
url: /python-net/aspose.psd.xmp.schemas.xmpdm/time/
---
...
| **Name** | **Description** |
| :- | :- |
| [Time(scale, value)](#Time_scale_value_1) | Initializes a new instance of the [Time](/psd/python-net/aspose.psd.xmp.schemas.xmpdm/time/) class. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| scale | [Rational](/psd/python-net/aspose.psd.xmp.types.derived/rational/) | r/w | Gets or sets scale for the time value. |
...
Initializes a new instance of the [Time](/psd/python-net/aspose.psd.xmp.schemas.xmpdm/time/) class.

**Parameters:**

| Parameter | Type | Description |
| :- | :- | :- |
| scale | [Rational](/psd/python-net/aspose.psd.xmp.types.derived/rational/) | The scale. |
| value | int | The value. |
