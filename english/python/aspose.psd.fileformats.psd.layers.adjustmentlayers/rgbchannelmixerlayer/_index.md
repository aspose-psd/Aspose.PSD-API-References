---
title: RgbChannelMixerLayer Class
type: docs
weight: 180
url: /python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Gets the blue channel. |
| bottom | int | r/w |    |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Gets the green channel. |
| has_alpha | bool | r |    |
...
| raw_line_size | int | r |    |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Gets the red channel. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Gets the index of the channel by. Returns RgbMixerChannel |
