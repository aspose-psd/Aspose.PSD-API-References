---
title: BrightnessContrastLayer Class
type: docs
weight: 30
url: /python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| brightness | int | r/w | Gets or sets the brightness. For PS range of brightness is from -150 to +150. But we ignore this. |
...
| contrast | int | r/w | Gets or sets the contrast. For PS range of contrast is from -50 to +100. But we ignore this. |
