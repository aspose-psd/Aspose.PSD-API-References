---
title: ThresholdLayer Class
type: docs
weight: 210
url: /python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/thresholdlayer/
---
...
| left | int | r/w |    |
| length | int | r |    |
| level | short | r/w | Gets and sets the threshold level. |
