...
| left | int | r/w |    |
| length | int | r |    |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | Gets the master channel. |
...
| [get_channel(index)](#get_channel_index_8) | Gets the channel. |
...
| Type | Description |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) by index |
