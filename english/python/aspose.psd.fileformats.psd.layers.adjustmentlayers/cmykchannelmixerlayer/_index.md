---
title: CmykChannelMixerLayer Class
type: docs
weight: 50
url: /python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Gets the black channel. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Gets the cyan channel. |
...
| left | int | r/w |    |
| length | int | r |    |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Gets the magenta channel. |
| monochrome | bool | r/w | Gets or sets a value indicating whether this [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) is monochrome. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Gets the yellow channel. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Gets the index of the channel by. Returns CmykMixerChannel |
