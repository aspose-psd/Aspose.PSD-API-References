...
type: docs
weight: 40
url: /python-net/aspose.psd.xmp.types.complex.colorant/colorantrgb/
---
...
**Full Name:** aspose.psd.xmp.types.complex.colorant.ColorantRgb
...
| **Name** | **Description** |
| :- | :- |
| [ColorantRgb()](#ColorantRgb__1) | Initializes a new instance of the [ColorantRgb](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colorantrgb/) class. |
| [ColorantRgb(red, green, blue)](#ColorantRgb_red_green_blue_2) | Initializes a new instance of the [ColorantRgb](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colorantrgb/) class. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| blue | byte | r/w | Gets or sets the blue component value. |
| color_type | [ColorType](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colortype) | r/w | Gets or sets the type of the color. |
| green | byte | r/w | Gets or sets the green component value. |
| mode | [ColorMode](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colormode) | r | Gets [ColorMode](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colormode/). |
...
Initializes a new instance of the [ColorantRgb](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colorantrgb/) class.
