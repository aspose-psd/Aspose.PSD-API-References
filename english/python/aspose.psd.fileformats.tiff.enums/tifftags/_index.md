...
type: docs
weight: 160
url: /python-net/aspose.psd.fileformats.tiff.enums/tifftags/
---
...
| XP_AUTHOR | Image Author, used by Windows Explorer.<br/>            The [TiffTags.XP_AUTHOR](/psd/python-net/aspose.psd.fileformats.tiff.enums/tifftags/) is ignored by Windows Explorer if the [TiffTags.ARTIST](/psd/python-net/aspose.psd.fileformats.tiff.enums/tifftags/) tag exists. |
...
| XP_TITLE | Information about image, used by Windows Explorer.<br/>            The [TiffTags.XP_TITLE](/psd/python-net/aspose.psd.fileformats.tiff.enums/tifftags/) is ignored by Windows Explorer if the [TiffTags.IMAGE_DESCRIPTION](/psd/python-net/aspose.psd.fileformats.tiff.enums/tifftags/) tag exists. |
