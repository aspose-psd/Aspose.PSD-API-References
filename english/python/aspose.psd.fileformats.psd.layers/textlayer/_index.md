---
title: TextLayer Class
type: docs
weight: 1690
url: /python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Gets the font. |
| has_alpha | bool | r |    |
...
| inner_text | string | r | Gets the text of the layer |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Gets or sets the text bound box. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Gets the color of the text. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Gets the texts portions. |
| top | int | r/w |    |
...
| [get_fonts()](#get_fonts__15) | Gets the fonts set of the text layer. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Resizes the image. The default [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) is used. |
...
| [update_text(text)](#update_text_text_38) | Updates the text. |
| [update_text(text, color)](#update_text_text_color_39) | Updates the text. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Updates the text. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Updates the text. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Updates the text. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Updates the text. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Updates the text. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Updates the text. |
...
| Type | Description |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | The fonts set of the text layer. |
...
Resizes the image. The default [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) is used.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | The type of resize transformation [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | The text value. |
| color | [Color](/psd/python-net/aspose.psd/color) | The color value. |
...
| :- | :- | :- |
| text | string | The text value. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | The left top coordinate. |
