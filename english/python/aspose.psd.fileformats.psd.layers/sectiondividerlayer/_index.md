...
| [get_related_layer_group()](#get_related_layer_group__20) | Gets the [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/) that's related to this [SectionDividerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/) instance. |
...
Gets the [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/) that's related to this [SectionDividerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/) instance.

**Returns**

| Type | Description |
| :- | :- |
| [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup) | The [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/) instance. |
