---
title: ArtboardLayer Class
type: docs
weight: 90
url: /python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Gets or sets the artboard background color. |
...
| has_alpha | bool | r |    |
| has_background_color | bool | r/w | Gets or sets a value indicating whether [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) has the background color. |
...
| is_cached | bool | r |    |
| is_open | bool | r/w | Gets or sets is folder opened<br/>            if set to <c>true</c> than group will be in open state on start up, otherwise in minimized state. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Gets the layers in layer group |
...
| **Name** | **Description** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Adds the layer to the layer group. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Adds the layer group. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Loads 32-bit ARGB pixels partially (by blocks). |
| load_partial_pixels(desired_rectangle, pixel_loader) |    |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |    |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Loads raw data. |
