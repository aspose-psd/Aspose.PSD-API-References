...
| **Name** | **Description** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Initializes a new instance of the [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) class.<br/>            All resources are created in their default state. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Gets or sets Fill settings for internal area of Shapes in the Shape layer. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Gets the set of Paths that present ina Shape layer. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Gets or sets Stroke settings of Shapes. |
| top | int | r/w |    |
...
| [create_instance()](#create_instance__7) | Creates a new instance of the [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) class. |
...
| update() | Updates resources from Shape layer properties. |
...
Initializes a new instance of the [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) class.<br/>            All resources are created in their default state.
...
Creates a new instance of the [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) class.

**Returns**

| Type | Description |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Returns the new instance of the [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) class. |
