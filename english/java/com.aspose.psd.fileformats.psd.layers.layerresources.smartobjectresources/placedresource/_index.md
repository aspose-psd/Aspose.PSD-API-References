...
description: Defines the PlacedResource class that contains common information about a placed layer or a smart object layer in the PSD file.
type: docs
weight: 12
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Gets or sets the warp items. |
