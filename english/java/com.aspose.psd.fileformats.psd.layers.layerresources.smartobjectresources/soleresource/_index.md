...
description: Defines the SoLeResource class that contains information about a smart object layer in a PSD file.
type: docs
weight: 16
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource/
---
...
| --- | --- |
| [SoLeResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLeResource-java.util.UUID-boolean-boolean-) | Initializes a new instance of the [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource) class. |
| [SoLeResource()](#SoLeResource--) | Initializes a new instance of the [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource) class. |
## Fields
...
| [TypeToolKey](#TypeToolKey) | The type tool info key: 'SoLE'. |
...
| [getKey()](#getKey--) | Gets the Sole smart object layer resource key. |
...
Initializes a new instance of the [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource) class.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| uniqueId | java.util.UUID | The unique identifier of the placed layer data [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
