...
description: Defines the SoLdResource class that contains information about a smart object layer in a PSD file.
type: docs
weight: 15
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Initializes a new instance of the [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) class. |
| [SoLdResource()](#SoLdResource--) | Initializes a new instance of the [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) class. |
## Fields

| Field | Description |
| --- | --- |
| [AntiAliasPolicyKey_internalized](#AntiAliasPolicyKey-internalized) | The anti alias policy key |
| [BottomKey_internalized](#BottomKey-internalized) | The bottom key |
| [BoundsKey_internalized](#BoundsKey-internalized) | The bounds key |
| [CompIdKey_internalized](#CompIdKey-internalized) | The key name of the CompID |
| [CompInfoKey_internalized](#CompInfoKey-internalized) | The comp information key name |
| [CompKey_internalized](#CompKey-internalized) | The comp key |
| [CompNoneValue_internalized](#CompNoneValue-internalized) | The comp value that means 'none' |
| [CropKey_internalized](#CropKey-internalized) | The crop key |
...
| [DenominatorKey_internalized](#DenominatorKey-internalized) | The denominator key |
| [DurationKey_internalized](#DurationKey-internalized) | The duration key |
...
| [FrameCountKey_internalized](#FrameCountKey-internalized) | The frame count key |
| [FrameStepKey_internalized](#FrameStepKey-internalized) | The frame step key |
| [HeightKey_internalized](#HeightKey-internalized) | The height key |
| [HorizontalIdName_internalized](#HorizontalIdName-internalized) | The horizontal identifier name |
| [IdentKey_internalized](#IdentKey-internalized) | The unique identifier key |
| [ItemsPropertyCannotBeNull_internalized](#ItemsPropertyCannotBeNull-internalized) | The items property cannot be null |
...
| [NonAffineTransformKey_internalized](#NonAffineTransformKey-internalized) | The non affine transform key |
| [NullClassId_internalized](#NullClassId-internalized) | The null class identifier |
| [NumeratorKey_internalized](#NumeratorKey-internalized) | The numerator key |
| [OptionalKeys_internalized](#OptionalKeys-internalized) | The collection of optional keys |
| [OrientationIdName_internalized](#OrientationIdName-internalized) | The orientation identifier name |
| [OriginalCompIdKey_internalized](#OriginalCompIdKey-internalized) | The key name of the original CompID |
| [PageNumberKey_internalized](#PageNumberKey-internalized) | The page number key |
| [PlacedIdKey_internalized](#PlacedIdKey-internalized) | The placed identifier key |
...
| [ResolutionKey_internalized](#ResolutionKey-internalized) | The resolution key |
...
| [SizeKey_internalized](#SizeKey-internalized) | The size key |
...
| [SmartVersionValue_internalized](#SmartVersionValue-internalized) | The expected smart object resource version value. |
| [TopKey_internalized](#TopKey-internalized) | The top key |
| [TotalPagesKey_internalized](#TotalPagesKey-internalized) | The total pages key |
| [TransformKey_internalized](#TransformKey-internalized) | The transform key |
| [TransformValueCount_internalized](#TransformValueCount-internalized) | The transform value count |
| [TypeKey_internalized](#TypeKey-internalized) | The type key |
| [TypeToolKey](#TypeToolKey) | The type tool info key: 'SoLd'. |
...
| [WidthKey_internalized](#WidthKey-internalized) | The width key |
| [YouCannotAccessCropPropertyMessage_internalized](#YouCannotAccessCropPropertyMessage-internalized) | You cannot access Crop property message |
| [YouCannotSetCompIdPropertyMessage_internalized](#YouCannotSetCompIdPropertyMessage-internalized) | You cannot set CompId property message |
...
| [convertListStructureToDoubleArray_internalized(ListStructure list)](#convertListStructureToDoubleArray-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures.ListStructure-) | Converts the list structure to a double array. |
...
| [getAntiAliasPolicy()](#getAntiAliasPolicy--) | Gets or sets the anti alias policy of the smart object layer data in the PSD image. |
...
| [getClass()](#getClass--) |  |
| [getComp()](#getComp--) | Gets or sets the comp value of the smart object layer data in the PSD file. |
...
| [getCrop()](#getCrop--) | Gets or sets the crop of the smart object layer data in the PSD image. |
...
| [getDurationDenominator()](#getDurationDenominator--) | Gets or sets the duration denominator. |
| [getDurationNumerator()](#getDurationNumerator--) | Gets or sets the duration numerator. |
| [getFrameCount()](#getFrameCount--) | Gets or sets the frame count of the smart object layer data in the PSD file. |
| [getFrameStepDenominator()](#getFrameStepDenominator--) | Gets or sets the frame step denominator. |
| [getFrameStepNumerator()](#getFrameStepNumerator--) | Gets or sets the frame step numerator. |
...
| [getItems()](#getItems--) | Gets or sets the descriptor items of the smart object layer data in the PSD file. |
| [getKey()](#getKey--) | Gets the SoLd smart object layer resource key. |
| [getLeft()](#getLeft--) | Gets or sets the left location of the placed layer in the PSD file. |
| [getLength()](#getLength--) | Gets the smart object resource length in bytes. |
| [getNonAffineTransformMatrix()](#getNonAffineTransformMatrix--) | Gets or sets the non affine transform matrix of the smart object layer data in the PSD file. |
...
| [getPageNumber()](#getPageNumber--) | Gets or sets the page number of the smart object layer data in the PSD file. |
...
| [getUniqueId()](#getUniqueId--) | Gets or sets the global unique identifier of the smart object layer data [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) in the PSD image. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Saves the smart object resource to the specified stream container. |
...
| [setAntiAliasPolicy(int value)](#setAntiAliasPolicy-int-) | Gets or sets the anti alias policy of the smart object layer data in the PSD image. |
...
| [setComp(int value)](#setComp-int-) | Gets or sets the comp value of the smart object layer data in the PSD file. |
...
| [setCrop(int value)](#setCrop-int-) | Gets or sets the crop of the smart object layer data in the PSD image. |
...
| [setDurationDenominator(int value)](#setDurationDenominator-int-) | Gets or sets the duration denominator. |
| [setDurationNumerator(int value)](#setDurationNumerator-int-) | Gets or sets the duration numerator. |
| [setFrameCount(int value)](#setFrameCount-int-) | Gets or sets the frame count of the smart object layer data in the PSD file. |
| [setFrameStepDenominator(int value)](#setFrameStepDenominator-int-) | Gets or sets the frame step denominator. |
| [setFrameStepNumerator(int value)](#setFrameStepNumerator-int-) | Gets or sets the frame step numerator. |
...
| [setItems(OSTypeStructure[] value)](#setItems-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Gets or sets the descriptor items of the smart object layer data in the PSD file. |
| [setLeft(double value)](#setLeft-double-) | Gets or sets the left location of the placed layer in the PSD file. |
| [setNonAffineTransformMatrix(double[] value)](#setNonAffineTransformMatrix-double---) | Gets or sets the non affine transform matrix of the smart object layer data in the PSD file. |
| [setOriginalCompId_internalized(int value)](#setOriginalCompId-internalized-int-) | Gets the original ID of the currently selected Comp for the child document, which will be -1 if none are selected. |
| [setPageNumber(int value)](#setPageNumber-int-) | Gets or sets the page number of the smart object layer data in the PSD file. |
...
| [setPlacedLayerType(int value)](#setPlacedLayerType-int-) | Gets or sets the type of the smart object layer data in the PSD file. |
| [setResolution(double value)](#setResolution-double-) | Gets or sets the resolution of the smart object layer data in the PSD file. |
| [setResolutionUnit(int value)](#setResolutionUnit-int-) | Gets or sets the resolution measure unit of the smart object layer data in the PSD file. |
...
| [setTotalPages(int value)](#setTotalPages-int-) | Gets or sets the total pages number of the smart object layer data in the PSD file. |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | Gets or sets the transform matrix of the smart object layer data in the PSD file. |
| [setUOrder(int value)](#setUOrder-int-) | Gets or sets the U order value of the placed layer in the PSD file. |
| [setUniqueId(UUID value)](#setUniqueId-java.util.UUID-) | Gets or sets the global unique identifier of the smart object layer data [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) in the PSD image. |
...
Initializes a new instance of the [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) class. It is necessary to set Items property or call InitializeItems() to get a ready instance. This constructor is designed for using by [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) and in unit tests. Use [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) for creating SoLdResource classes.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| uniqueId | java.util.UUID | The unique identifier of the smart object layer data [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Initializes a new instance of the [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) class. This default constructor is designed for using by SoLdResourceLoader. Use [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) for creating SoLdResource classes.
...
| Parameter | Type | Description |
| --- | --- | --- |
| list | [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) | The  ListStructure  instance. |

**Returns:**
double[] - The created  double[]  array.
### create_internalized(System.Guid uniqueId, boolean isCustom, boolean hasCompInfo) {#create-internalized-com.aspose.ms.System.Guid-boolean-boolean-}
```
...
Gets or sets the global unique identifier of the smart object layer data [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) in the PSD image.

Value: The global unique identifier of the smart object layer data [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource).
