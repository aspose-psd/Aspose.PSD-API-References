...
type: docs
weight: 11
url: /java/com.aspose.psd.xmp.schemas.photoshop/layer/
---
...
| [isEquals(Layer other)](#isEquals-com.aspose.psd.xmp.schemas.photoshop.Layer-) | Indicates whether the current object is equal to another object of the same type. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Parameter | Type | Description |
| --- | --- | --- |
| other | [Layer](../../com.aspose.psd.xmp.schemas.photoshop/layer) | An object to compare with this object. |
