...
description: Layer group information resource
type: docs
weight: 25
url: /java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Initializes a new instance of the [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) class. |
## Fields
...
| [getGroups()](#getGroups--) | Gets or sets the groups. |
...
| [setGroups(short[] value)](#setGroups-short---) | Gets or sets the groups. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Updates LinkGroupId in layers from the Groups property. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Updates values in Groups property from the layers. |
...
Updates LinkGroupId in layers from the Groups property.
...
Updates values in Groups property from the layers.
