...
description: The transparency index resource block.
type: docs
weight: 37
url: /java/com.aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| --- | --- |
| [TransparencyIndexResource()](#TransparencyIndexResource--) | Initializes a new instance of the [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) class. |
## Fields

| Field | Description |
| --- | --- |
| [RequiredVersion_internalized](#RequiredVersion-internalized) | The required psd version. |
...
| [getTransparencyIndex()](#getTransparencyIndex--) | Gets or sets the transparency color index. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTransparencyIndex(short value)](#setTransparencyIndex-short-) | Gets or sets the transparency color index. |
| [toString()](#toString--) |  |
...
Initializes a new instance of the [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) class.
