...
description: Url list resource
type: docs
weight: 40
url: /java/com.aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| --- | --- |
| [UrlListResource()](#UrlListResource--) | Initializes a new instance of the [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource) class. |
## Fields
...
| [getIds()](#getIds--) | Gets or sets the ids. |
| [getLongs()](#getLongs--) | Gets or sets the longs. |
...
| [getTexts()](#getTexts--) | Gets or sets the texts. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIds(int[] value)](#setIds-int---) | Gets or sets the ids. |
...
| [setLongs(int[] value)](#setLongs-int---) | Gets or sets the longs. |
...
| [setTexts(String[] value)](#setTexts-java.lang.String---) | Gets or sets the texts. |
| [toString()](#toString--) |  |
...
Initializes a new instance of the [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource) class.
