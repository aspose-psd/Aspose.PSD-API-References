...
description: Print flags resource
type: docs
weight: 30
url: /java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Initializes a new instance of the [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) class. |
## Fields
...
| [getBleedScale()](#getBleedScale--) | Gets or sets the bleed scale. |
| [getBleedWidth()](#getBleedWidth--) | Gets or sets the width of the bleed. |
| [getCenterCropMark()](#getCenterCropMark--) | Gets or sets the center crop mark. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Gets or sets the bleed scale. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Gets or sets the width of the bleed. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Gets or sets the center crop mark. |
...
Initializes a new instance of the [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) class.
