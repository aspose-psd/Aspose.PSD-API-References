...
description: Inner Shadow Layer effect
type: docs
weight: 14
url: /java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | Gets or sets the spread (choke) as percentage. |
...
| [setSpread(int value)](#setSpread-int-) | Gets or sets the spread (choke) as percentage. |
...
### create_internalized(IEffectsResource entity) {#create-internalized-com.aspose.internal.fileformats.psd.layers.layerresources.lfx2resources.IEffectsResource-}
```
public static InnerShadowEffect create_internalized(IEffectsResource entity)
```
