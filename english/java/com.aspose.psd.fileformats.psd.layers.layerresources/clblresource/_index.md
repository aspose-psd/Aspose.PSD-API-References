...
description: Class ClblResource.
type: docs
weight: 18
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Gets or sets a value indicating whether [blend clipped elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Gets or sets a value indicating whether [blend clipped elements]. |
...
Initializes a new instance of the [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) class. With custom or unknown value
...
Value:  true  if [blend clipped elements]; otherwise,  false .
