...
| [LockAll](#LockAll) | Lock all properties of a layer |
| [LockImagePixels](#LockImagePixels) | Partially lock a layer - Prevents modification of the layer\\u2019s pixels using the painting tools. |
| [LockPosition](#LockPosition) | Partially lock a layer - Prevents the layer\\u2019s pixels from being moved. |
| [LockTransparentPixels](#LockTransparentPixels) | Partially lock a layer - Confines editing to the opaque portions of the layer. |
| [None](#None) | No layer lock |
## Methods
