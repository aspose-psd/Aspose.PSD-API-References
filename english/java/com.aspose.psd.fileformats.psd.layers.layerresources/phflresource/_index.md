...
type: docs
weight: 61
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresource/
---
...
| [getRgbColor()](#getRgbColor--) | Gets the color of the RGB. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| color | [Color](../../com.aspose.psd/color) | The RGB color. |
