...
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | Initializes a new instance of the [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) class. |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | Initializes a new instance of the [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) class. |
| [LspfResource()](#LspfResource--) | Initializes a new instance of the [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) class. |
## Fields
...
| [TypeToolKey](#TypeToolKey) | The type tool info key 1819504742 |
...
| [getLockType()](#getLockType--) | Gets or sets the type of the lock. |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | Gets or sets a value indicating whether this instance is composite protected. |
| [isPositionProtected()](#isPositionProtected--) | Gets or sets a value indicating whether this instance is position protected. |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | Gets or sets a value indicating whether this instance is transparency protected. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | Gets or sets a value indicating whether this instance is composite protected. |
...
| [setLockType(int value)](#setLockType-int-) | Gets or sets the type of the lock. |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | Gets or sets a value indicating whether this instance is position protected. |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | Gets or sets a value indicating whether this instance is transparency protected. |
...
Initializes a new instance of the [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) class. With custom or unknown value
...
Initializes a new instance of the [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) class.
