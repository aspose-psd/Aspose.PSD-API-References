...
description: The Vector Origination Data resource.
type: docs
weight: 28
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| Field | Description |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | The descriptor key to save shape origin settings. |
...
| [getItems_internalized()](#getItems-internalized--) | Gets or sets the structure items. |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | Gets or sets the shape origin settings. |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | Gets or sets the shape origin settings. |
...
The descriptor key to save shape origin settings.
