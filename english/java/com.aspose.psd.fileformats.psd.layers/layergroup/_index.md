...
| [getHeight()](#getHeight--) | Gets height of the layers group. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Gets the union bounds of the all layers in LayerGroup. |
...
| [getWidth()](#getWidth--) | Gets width of the layers group. |
...
Gets the union bounds of the all layers in LayerGroup.
