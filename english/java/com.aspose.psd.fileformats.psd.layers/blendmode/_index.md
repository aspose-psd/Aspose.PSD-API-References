...
| Field | Description |
| --- | --- |
| [Absent](#Absent) | Blend mode is absent or not set yet. |
| [Color](#Color) | Color blend mode. |
| [ColorBurn](#ColorBurn) | Color burn blend mode. |
| [ColorDodge](#ColorDodge) | Color dodge blend mode. |
...
| [LighterColor](#LighterColor) | Lighter color blend mode. |
| [LinearBurn](#LinearBurn) | Linear burn blend mode. |
| [LinearDodge](#LinearDodge) | Linear dodge blend mode. |
| [LinearLight](#LinearLight) | Linear light blend mode. |
...
| [PassThrough](#PassThrough) | Pass through blend mode. |
| [PinLight](#PinLight) | Pin light blend mode. |
| [Saturation](#Saturation) | Saturation blend mode. |
| [Screen](#Screen) | Screen blend mode. |
| [SoftLight](#SoftLight) | Soft light blend mode. |
| [Subtract](#Subtract) | Subtract blend mode. |
| [VividLight](#VividLight) | Vivid light blend mode. |
## Methods
