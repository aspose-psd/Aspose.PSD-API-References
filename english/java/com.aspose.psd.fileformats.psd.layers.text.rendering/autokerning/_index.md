...
description: The Photoshop auto kerning mode distance between symbols.
type: docs
weight: 10
url: /java/com.aspose.psd.fileformats.psd.layers.text.rendering/autokerning/
---
...
| [Manual](#Manual) | Manual kerning value. |
| [Metric](#Metric) | Metrics kerning uses kern pairs, which are included with most fonts (from their designers). |
| [Optical](#Optical) | Optical kerning adjusts the spacing between adjacent characters based on their shapes. |
## Methods
