...
description: Enumeration for text orientation mode.
type: docs
weight: 15
url: /java/com.aspose.psd.fileformats.psd.layers.text.rendering/textorientation/
---
...
| [Horizontal](#Horizontal) | The horizontal text orientation. |
| [Vertical](#Vertical) | The vertical text orientation. |
## Methods
