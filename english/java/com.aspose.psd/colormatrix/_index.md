...
type: docs
weight: 25
url: /java/com.aspose.psd/colormatrix/
---
...
| Field | Description |
| --- | --- |
| [MatrixDimensionElementsCount](#MatrixDimensionElementsCount) | The number of elements in matrix dimension. |
| [MatrixDimensionsCount](#MatrixDimensionsCount) | The number of matrix dimensions. |
| [MatrixTotalElementsCount](#MatrixTotalElementsCount) | The total number of elements in the matrix. |
## Methods
