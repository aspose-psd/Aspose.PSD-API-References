...
type: docs
weight: 69
url: /java/com.aspose.psd/matrix/
---
...
| [Matrix(Matrix origin)](#Matrix-com.aspose.psd.Matrix-) | Makes a copy of the  Matrix  class. |
| [Matrix(RectangleF rect, PointF[] plgpts)](#Matrix-com.aspose.psd.RectangleF-com.aspose.psd.PointF---) | Initializes a new instance of the  Aspose.Imaging.Matrix  class to the geometric transform defined by the specified rectangle and array of points. |
| [Matrix(Rectangle rect, Point[] plgpts)](#Matrix-com.aspose.psd.Rectangle-com.aspose.psd.Point---) | Initializes a new instance of the  Aspose.Imaging.Matrix  class to the geometric transform defined by the specified rectangle and array of points. |
## Fields
...
| [isEquals(Matrix a, Matrix b)](#isEquals-com.aspose.psd.Matrix-com.aspose.psd.Matrix-) | Determines whether two matrixes are equal. |
| [isIdentity()](#isIdentity--) | Returns `true` if this `AffineTransform` is an identity transform. |
| [multiply(Matrix Tx)](#multiply-com.aspose.psd.Matrix-) | Multiplies this Matrix by the matrix specified in the matrix parameter using (default) Prepend order. |
| [multiply(Matrix Tx, int order)](#multiply-com.aspose.psd.Matrix-int-) | Multiplies this Matrix by the matrix specified in the matrix parameter, and in the order specified in the order parameter. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [rotateAt(float angle, PointF point)](#rotateAt-float-com.aspose.psd.PointF-) | Applies a clockwise rotation about the specified point to this Matrix in the default (Prepend) order. |
| [rotateAt(float angle, PointF point, int order)](#rotateAt-float-com.aspose.psd.PointF-int-) | Applies a clockwise rotation about the specified point to this Matrix in the specified order. |
...
| [transformPoints(PointF[] points)](#transformPoints-com.aspose.psd.PointF---) | Applies the geometric transform represented by this  Matrix  to a specified array of points. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| origin | [Matrix](../../com.aspose.psd/matrix) | the base matrix for coping |
...
| Parameter | Type | Description |
| --- | --- | --- |
| rect | [RectangleF](../../com.aspose.psd/rectanglef) | A  Aspose.Imaging.RectangleF  structure that represents the rectangle to be transformed. |
| plgpts | [PointF\[\]](../../com.aspose.psd/pointf) | An array of three  Aspose.Imaging.PointF  structures that represents the points of a parallelogram to which the upper-left, upper-right, and lower-left corners of the rectangle is to be transformed. The lower-right corner of the parallelogram is implied by the first three corners. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| rect | [Rectangle](../../com.aspose.psd/rectangle) | A  Aspose.Imaging.Rectangle  structure that represents the rectangle to be transformed. |
| plgpts | [Point\[\]](../../com.aspose.psd/point) | An array of three  Aspose.Imaging.Point  structures that represents the points of a parallelogram to which the upper-left, upper-right, and lower-left corners of the rectangle is to be transformed. The lower-right corner of the parallelogram is implied by the first three corners. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| a | [Matrix](../../com.aspose.psd/matrix) | The first matrix to compare. |
| b | [Matrix](../../com.aspose.psd/matrix) | The second matrix to compare. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| Tx | [Matrix](../../com.aspose.psd/matrix) | The matrix to multiply with. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| Tx | [Matrix](../../com.aspose.psd/matrix) | The tx. The tx. The tx. |
...
| point | [PointF](../../com.aspose.psd/pointf) | The point. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | The points. |
