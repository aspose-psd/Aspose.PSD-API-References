...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setColorPalette(IColorPalette value)](#setColorPalette-com.aspose.psd.IColorPalette-) | Sets the color palette |
| [setCustomColorConverter(IColorConverter value)](#setCustomColorConverter-com.aspose.psd.IColorConverter-) | Sets the custom color converter |
...
| [setIndexedColorConverter(IIndexedColorConverter value)](#setIndexedColorConverter-com.aspose.psd.IIndexedColorConverter-) | Sets the indexed color converter |
| [setLineSize(int value)](#setLineSize-int-) | Sets the pixels line size in bytes for raw data processing |
| [setPixelDataFormat(PixelDataFormat value)](#setPixelDataFormat-com.aspose.psd.PixelDataFormat-) | Sets the pixel data format |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
### setColorPalette(IColorPalette value) {#setColorPalette-com.aspose.psd.IColorPalette-}
```
...
### setCustomColorConverter(IColorConverter value) {#setCustomColorConverter-com.aspose.psd.IColorConverter-}
```
...
### setIndexedColorConverter(IIndexedColorConverter value) {#setIndexedColorConverter-com.aspose.psd.IIndexedColorConverter-}
```
...
### setPixelDataFormat(PixelDataFormat value) {#setPixelDataFormat-com.aspose.psd.PixelDataFormat-}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | [PixelDataFormat](../../com.aspose.psd/pixeldataformat) | The pixel data format |
