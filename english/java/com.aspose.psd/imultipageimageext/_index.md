...
[com.aspose.psd.IMultipageImage](../../com.aspose.psd/imultipageimage)
```
...
| Method | Description |
| --- | --- |
| [addPage(RasterImage page)](#addPage-com.aspose.psd.RasterImage-) | Adds page to the image. |
### addPage(RasterImage page) {#addPage-com.aspose.psd.RasterImage-}
```
...
| --- | --- | --- |
| page | [RasterImage](../../com.aspose.psd/rasterimage) | The page to add. |
