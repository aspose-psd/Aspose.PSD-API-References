...
| --- | --- |
| [SizeF()](#SizeF--) |  |
| [SizeF(SizeF size)](#SizeF-com.aspose.psd.SizeF-) | Initializes a new instance of the  Aspose.Imaging.SizeF  structure from the specified  Aspose.Imaging.SizeF . |
| [SizeF(PointF point)](#SizeF-com.aspose.psd.PointF-) | Initializes a new instance of the  Aspose.Imaging.SizeF  structure from the specified  Aspose.Imaging.PointF . |
...
| [add(SizeF size1, SizeF size2)](#add-com.aspose.psd.SizeF-com.aspose.psd.SizeF-) | Adds the width and height of one  Aspose.Imaging.SizeF  structure to the width and height of another  Aspose.Imaging.SizeF  structure. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [op_Addition(SizeF size1, SizeF size2)](#op-Addition-com.aspose.psd.SizeF-com.aspose.psd.SizeF-) | Adds the width and height of one  Aspose.Imaging.SizeF  structure to the width and height of another  Aspose.Imaging.SizeF  structure. |
| [op_Equality(SizeF size1, SizeF size2)](#op-Equality-com.aspose.psd.SizeF-com.aspose.psd.SizeF-) | Tests whether two  Aspose.Imaging.SizeF  structures are equal. |
| [op_Inequality(SizeF size1, SizeF size2)](#op-Inequality-com.aspose.psd.SizeF-com.aspose.psd.SizeF-) | Tests whether two  Aspose.Imaging.SizeF  structures are different. |
| [op_Subtraction(SizeF size1, SizeF size2)](#op-Subtraction-com.aspose.psd.SizeF-com.aspose.psd.SizeF-) | Subtracts the width and height of one  Aspose.Imaging.SizeF  structure from the width and height of another  Aspose.Imaging.SizeF  structure. |
...
| [subtract(SizeF size1, SizeF size2)](#subtract-com.aspose.psd.SizeF-com.aspose.psd.SizeF-) | Subtracts the width and height of one  Aspose.Imaging.SizeF  structure from the width and height of another  Aspose.Imaging.SizeF  structure. |
...
| [to_PointF(SizeF size)](#to-PointF-com.aspose.psd.SizeF-) | Converts the specified  Aspose.Imaging.SizeF  to a  Aspose.Imaging.PointF . |
| [wait()](#wait--) |  |
...
| --- | --- | --- |
| size | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  from which to create the new  Aspose.Imaging.SizeF . |
...
| Parameter | Type | Description |
| --- | --- | --- |
| point | [PointF](../../com.aspose.psd/pointf) | The  Aspose.Imaging.PointF  from which to initialize this  Aspose.Imaging.SizeF . |
...
| Parameter | Type | Description |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.psd/sizef) | The first  Aspose.Imaging.SizeF  to add. |
| size2 | [SizeF](../../com.aspose.psd/sizef) | The second  Aspose.Imaging.SizeF  to add. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure on the left side of the equality operator. |
| size2 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure on the right of the equality operator. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure on the left of the inequality operator. |
| size2 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure on the right of the inequality operator. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  on the left side of the subtraction operator. |
| size2 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  on the right side of the subtraction operator. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure on the left side of the subtraction operator. |
| size2 | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure on the right side of the subtraction operator. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| size | [SizeF](../../com.aspose.psd/sizef) | The  Aspose.Imaging.SizeF  structure to be converted |
