...
description: The color balance adjustment layer class.
type: docs
weight: 16
url: /java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Gets or sets the Shadows YellowBlue Balance. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Apply the corrections for the current shadows, midtones and highlights to the specified int RGB array. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Gets or sets the Shadows YellowBlue Balance. |
...
Apply the corrections for the current shadows, midtones and highlights to the specified int RGB array.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| pixels | int[] | The int color RGB array. |
