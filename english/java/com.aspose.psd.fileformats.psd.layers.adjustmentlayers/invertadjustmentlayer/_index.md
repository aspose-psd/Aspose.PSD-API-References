...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Processes the invert adjustment layer. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Apply the invert corrections to the specified int ARGB array. |
...
Processes the invert adjustment layer.
...
Apply the invert corrections to the specified int ARGB array.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| pixels | int[] | The int ARGB array. |
