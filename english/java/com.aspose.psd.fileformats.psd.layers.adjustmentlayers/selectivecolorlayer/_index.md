...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Gets the cmyk correction by selective color. |
| [getContainer()](#getContainer--) | Gets the  Image  container. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Gets or sets the correction method. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Processes the Selective Color layer. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Merges the data in. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Sets the cmyk correction by selective color. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Sets the  Image  container. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Gets or sets the correction method. |
...
Gets the cmyk correction by selective color.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| selectiveColorsType | int | Selective colors. |
...
Gets or sets the correction method.

Value: The correction method.
...
Processes the Selective Color layer.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | The pixels rectangle. |
| pixels | int[] | The array of pixels. |
| start | [Point](../../com.aspose.psd/point) | The pixels left top location. |
| end | [Point](../../com.aspose.psd/point) | The pixels right bottom location. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - The pixels rectangle and the processed pixels.
...
| Parameter | Type | Description |
| --- | --- | --- |
| selectiveColorsType | int | Type of the selective colors. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Cmyk Correction. |
