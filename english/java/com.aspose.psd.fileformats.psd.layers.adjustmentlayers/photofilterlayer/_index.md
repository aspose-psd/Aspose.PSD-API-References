...
| [getColor()](#getColor--) | Gets or sets the RGB color of filter. |
...
| [getDensity()](#getDensity--) | Gets or sets the density of filter |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Gets or sets the RGB color of filter. |
...
| [setDensity(int value)](#setDensity-int-) | Gets or sets the density of filter |
