...
description: The class structure.
type: docs
weight: 12
url: /java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Initializes a new instance of the [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) class. |
## Fields

| Field | Description |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Identifies the structure key. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Identifies the structure key. |
| [StructureKeyType](#StructureKeyType) | Identifies the structure key. |
## Methods
...
Initializes a new instance of the [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) class.
...
| structureKey | int | The structure key. |
