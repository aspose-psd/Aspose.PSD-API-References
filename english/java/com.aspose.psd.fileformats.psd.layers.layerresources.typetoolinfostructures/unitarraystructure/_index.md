...
Defines the UnitArrayStructure class that holds  double  values array and their measure unit. It is used in the PSD file resources, usually by [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).
## Constructors

| Constructor | Description |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | Initializes a new instance of the [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) class. |
## Fields

| Field | Description |
| --- | --- |
| [StructureKey](#StructureKey) | Defines the 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) key. |
## Methods
...
| [getKey()](#getKey--) | Gets this unit array structure key. |
...
| [getUnitType()](#getUnitType--) | Gets or sets the measure unit type of the [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) values. |
| [getValueCount()](#getValueCount--) | Gets the value count. |
| [getValues()](#getValues--) | Gets or sets the unit array structure values. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | Gets or sets the measure unit type of the [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) values. |
| [setValues(double[] value)](#setValues-double---) | Gets or sets the unit array structure values. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initializes a new instance of the [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) class.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Name of the key. |
| unitType | int | Type of the unit. |
...
Defines the 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) key.
...
Gets or sets the measure unit type of the [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) values.

Value: The measure unit type.
...
Value: The value count in the unit array structure.
