...
Defines the ObjectArrayStructure class that usually holds [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) array. It is used in the PSD file resources, such as PlLd Resource and SoLd Resource.
## Constructors

| Constructor | Description |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initializes a new instance of the [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class. |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initializes a new instance of the [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class. |
## Fields

| Field | Description |
| --- | --- |
| [StructureKey](#StructureKey) | Identifies the 'ObAr' structure key. |
## Methods
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Gets or sets the object array class ID. |
| [getClassName()](#getClassName--) | Gets or sets the object array class name. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Gets the list of structures. |
| [getKey()](#getKey--) | Gets the object array structure key. |
| [getKeyName()](#getKeyName--) | Gets or sets the key name. |
| [getLength()](#getLength--) | Gets the  OSTypeStructure  length in bytes. |
...
| [getStructureCount()](#getStructureCount--) | Gets the object array substructure count. |
| [getStructures()](#getStructures--) | Gets or sets the substructures in the object array structure. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Gets or sets the substructures in the object array structure. |
...
Initializes a new instance of the [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class.
