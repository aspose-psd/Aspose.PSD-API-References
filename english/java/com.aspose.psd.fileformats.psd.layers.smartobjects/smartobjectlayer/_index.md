...
description: Defines the SmartObjectLayer class that contains embedded in the PSD file or linked smart object in the external file.
type: docs
weight: 10
url: /java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | The both placed and smart object resources found message |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | The message You can only copy an embedded smart object |
| [LayerHeaderSize](#LayerHeaderSize) | The layer header size. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | There is no placed or smart object resource found message |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | The wrong placed resource indices message |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Converts this embedded smart object to a linked smart object. |
...
| [duplicateLayer()](#duplicateLayer--) | Creates a new smart object layer by coping this one. |
...
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Exports the embedded or linked contents to a file. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Gets or sets the original quadrilateral. |
...
| [getSmartFilters()](#getSmartFilters--) | Gets the smart filters. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Gets or sets the transform quadrilateral. |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Gets the embedded or linked image contents of the smart object layer. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Creates a new smart object layer by coping this one. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Invoke when container of this [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) was set. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Re-links the linked smart object to a new file. |
...
| [setContents(byte[] value)](#setContents-byte---) | Gets or sets the smart object layer contents. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Gets or sets the smart object content's bounds. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Gets or sets the smart object content's source. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Gets or sets the original quadrilateral. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Gets the smart object provider. |
| [setTop(int value)](#setTop-int-) | Gets or sets the top layer position. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Gets or sets the transform quadrilateral. |
...
The both placed and smart object resources found message
...
The message You can only copy an embedded smart object
...
There is no placed or smart object resource found message
...
The wrong placed resource indices message
...
Creates a new smart object layer by coping this one. Notice that for embedded smart objects the embedded image is shared. If you want to copy the embedded image use [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy) method.
...
| Parameter | Type | Description |
| --- | --- | --- |
| filePath | java.lang.String | The export file path. |
...
Gets the type of the smart object layer content. The embedded smart object contents is the embedded raw image file:  LiFdDataSource.Data . The linked smart object contents is the raw contents of the linked image file if it is available: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). We do not support loading from the Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library when  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) is true. For regular link files, at first, we use  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) to look for the file relatively to the source image path  DataStreamSupporter.SourceImagePath , if it is not available we look at  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), if not then we look for the link file in the same directory where our image is:  DataStreamSupporter.SourceImagePath .

Value: The type of the smart object layer content.
...
Gets or sets the smart object layer contents. The embedded smart object contents is the embedded raw image file:  LiFdDataSource.Data  and its properties. The linked smart object contents is the raw content of the linked image file if it is available and its properties: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). We do not support loading from the Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library when  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) is true. For regular link files, at first, we use  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) to look for the file relatively to the source image path  DataStreamSupporter.SourceImagePath , if it is not available we look at  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), if not then we look for the link file in the same directory where our image is:  DataStreamSupporter.SourceImagePath .
...
Gets or sets the original quadrilateral.

Value: The original quadrilateral.
...
Gets the placed and smart layer resource indices and the proper placed resource.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | The resources. |
| placedResourceIndex | int[] | Index of the placed resource. |
| smartResourceIndex | int[] | Index of the smart resource. |
...
Gets the placed layer resource
...
Gets or sets the transform quadrilateral.

Value: The transform quadrilateral.
...
| Parameter | Type | Description |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | The options. |
...
Invoke when container of this [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) was set.
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Updates the data source identifier.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | The data source identifier. |
...
Updates the placed / smart resources when the placedResource is changed or when conversion is needed.
