...
description: The AddNoise smart filter.
type: docs
weight: 10
url: /java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/addnoisesmartfilter/
---
...
| --- | --- |
| [AddNoiseSmartFilter()](#AddNoiseSmartFilter--) | Initializes a new instance of the [AddNoiseSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/addnoisesmartfilter) class. |
## Fields
...
| [getAmountNoise()](#getAmountNoise--) | Gets or sets The noise value amount. |
| [getBlendMode()](#getBlendMode--) | Gets or sets the blending mode. |
| [getClass()](#getClass--) |  |
| [getDistribution()](#getDistribution--) | Gets or sets the distribution of noise filter. |
...
| [isMonochromatic()](#isMonochromatic--) | Gets or sets the value of monochromatic. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAmountNoise(double value)](#setAmountNoise-double-) | Gets or sets The noise value amount. |
| [setBlendMode(long value)](#setBlendMode-long-) | Gets or sets the blending mode. |
| [setDistribution(int value)](#setDistribution-int-) | Gets or sets the distribution of noise filter. |
| [setEnabled(boolean value)](#setEnabled-boolean-) | Gets or sets the is enabled status of the smart filter. |
| [setMonochromatic(boolean value)](#setMonochromatic-boolean-) | Gets or sets the value of monochromatic. |
...
Initializes a new instance of the [AddNoiseSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/addnoisesmartfilter) class.
