...
type: docs
weight: 25
url: /java/com.aspose.psd.fileformats.tiff.enums/tifftags/
---
...
| [JpegACtables](#JpegACtables) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 AC coefficient offsets. |
| [JpegDCtables](#JpegDCtables) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 DCT table offsets. |
| [JpegInerchangeFormat](#JpegInerchangeFormat) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 Pointer to SOI marker. |
| [JpegInterchangeFormatLength](#JpegInterchangeFormatLength) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 JFIF stream length |
| [JpegLosslessPredictors](#JpegLosslessPredictors) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 Lossless proc predictor. |
| [JpegPointTransform](#JpegPointTransform) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 Lossless point transform. |
| [JpegProc](#JpegProc) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 JPEG processing algorithm. |
| [JpegQTables](#JpegQTables) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]

 Q matrice offsets. |
| [JpegRestartInterval](#JpegRestartInterval) | [obsoleted by Technical Note \#2 which specifies a revised JPEG-in-TIFF scheme]
...
Image Author, used by Windows Explorer. The  TiffTags.XPAuthor  is ignored by Windows Explorer if the [Artist](../../com.aspose.psd.fileformats.tiff.enums/tifftags\#Artist) tag exists.
...
Information about image, used by Windows Explorer. The  TiffTags.XPTitle  is ignored by Windows Explorer if the [ImageDescription](../../com.aspose.psd.fileformats.tiff.enums/tifftags\#ImageDescription) tag exists.
