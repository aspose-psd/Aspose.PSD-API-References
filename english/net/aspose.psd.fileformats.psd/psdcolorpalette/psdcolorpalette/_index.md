...
| --- | --- | --- |
| colorPalette | IColorPalette | The color palette. |
| transparentIndex | Int16 | The transparent color index. |
...
| --- | --- | --- |
| rawEntriesData | Byte[] | The raw entries data. |
| transparentIndex | Int16 | The transparent color index. Note the index is not the raw entries index instead it is for the converted color array. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| colorPaletteArgb32Entries | Int32[] | The color palette 32-bit ARGB entries. |
| isCompactPalette | Boolean | Indicating whether compact it palette. |
