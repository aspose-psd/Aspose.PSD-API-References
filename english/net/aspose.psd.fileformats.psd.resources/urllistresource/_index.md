...
| Name | Description |
| --- | --- |
| [Count](../../aspose.psd.fileformats.psd.resources/urllistresource/count/) { get; set; } | Gets or sets the count. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/urllistresource/datasize/) { get; } | Gets the resource data size in bytes. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Gets or sets the unique identifier for the resource. |
| [Ids](../../aspose.psd.fileformats.psd.resources/urllistresource/ids/) { get; set; } | Gets or sets the ids. |
| [Longs](../../aspose.psd.fileformats.psd.resources/urllistresource/longs/) { get; set; } | Gets or sets the longs. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/urllistresource/minimalversion/) { get; } | Gets the minimal required PSD version. |
...
| [Texts](../../aspose.psd.fileformats.psd.resources/urllistresource/texts/) { get; set; } | Gets or sets the texts. |
