...
| Name | Description |
| --- | --- |
| [InfxResource](infxresource/#constructor)() | Initializes a new instance of the `InfxResource` class. |
| [InfxResource](infxresource/#constructor_1)(bool) | Initializes a new instance of the `InfxResource` class. |
| [InfxResource](infxresource/#constructor_2)(byte[]) | Initializes a new instance of the `InfxResource` class. With custom or unknown value |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/infxresource/key/) { get; } | Gets the layer resource key. |
...
| Name | Description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/infxresource/typetoolkey/) | The type tool info key. |
