...
| Name | Description |
| --- | --- |
| [Hue2Resource](hue2resource/#constructor)() | Initializes a new instance of the `Hue2Resource` class. |
| [Hue2Resource](hue2resource/#constructor_1)(byte[]) | Initializes a new instance of the `Hue2Resource` class. |
...
| Name | Description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/hue2resource/typetoolkey/) | The type tool info key. |
