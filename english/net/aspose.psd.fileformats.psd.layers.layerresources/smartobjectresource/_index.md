...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | Gets or sets the global unique identifier of the smart object layer data `SmartObjectResource` in the PSD image. |
