...
description: SmartObjectResource property. Gets the original ID of the currently selected Comp for the child document which will be 1 if none are selected. This property gets the original layer Comp selection identifier for he smart object layer in the PSD file. Layer comps in Smart Objects
type: docs
weight: 140
