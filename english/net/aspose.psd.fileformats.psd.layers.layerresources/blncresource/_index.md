...
| Name | Description |
| --- | --- |
| [BlncResource](blncresource/)() | Initializes a new instance of the `BlncResource` class. |
...
| Name | Description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/blncresource/typetoolkey/) | The type tool info key. |
