...
| Name | Description |
| --- | --- |
| [OSTypeStructure](ostypestructure/)(ClassID) | Initializes a new instance of the `OSTypeStructure` class. |
...
| abstract [Length](../../aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/length/) { get; } | Gets the `OSTypeStructure` length in bytes. |
