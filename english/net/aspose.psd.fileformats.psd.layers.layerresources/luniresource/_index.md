...
| Name | Description |
| --- | --- |
| [LuniResource](luniresource/)() | Initializes a new instance of the `LuniResource` class. |
...
| Name | Description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/luniresource/typetoolkey/) | The type tool info key. |
