...
| Name | Description |
| --- | --- |
| [AComponent](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/acomponent/) { get; set; } | Gets or sets a component. |
| [BComponent](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/bcomponent/) { get; set; } | Gets or sets the b component. |
| [CharacterCount](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/charactercount/) { get; set; } | Gets or sets the character count. |
| [ColorSpaceValue](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/colorspacevalue/) { get; set; } | Gets or sets the color space value. |
| [Fonts](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/fonts/) { get; set; } | Gets or sets the fonts. |
| [FontsCount](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/fontscount/) { get; } | Gets the fonts count. |
...
| [TypeValue](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/typevalue/) { get; set; } | Gets or sets the type value. |
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/version/) { get; set; } | Gets or sets the version. |
| [VerticalPlacement](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/verticalplacement/) { get; set; } | Gets or sets the vertical placement. |

## Methods

| Name | Description |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/typetoolinforesource/save/)(StreamContainer, int) | Saves the specified stream container. |
