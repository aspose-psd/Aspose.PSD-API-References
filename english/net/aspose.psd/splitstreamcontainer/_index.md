...
| override [Read](../../aspose.psd/splitstreamcontainer/read)(byte[]) | Reads bytes to fill the specified bytes buffer. |
| override [Read](../../aspose.psd/splitstreamcontainer/read)(byte[], int, int) | Reads a sequence of bytes from the current stream and advances the position within the stream by the number of bytes read. |
...
| override [Save](../../aspose.psd/splitstreamcontainer/save)(Stream, int, long) | Saves (copies) the stream's data to the specified stream. |
...
| override [ToBytes](../../aspose.psd/splitstreamcontainer/tobytes)() | Converts the stream data to the Byte array. |
| override [ToBytes](../../aspose.psd/splitstreamcontainer/tobytes)(long, long) | Converts the stream data to the Byte array. |
| override [Write](../../aspose.psd/splitstreamcontainer/write)(byte[]) | Writes all of the specified bytes to the stream. |
| override [Write](../../aspose.psd/splitstreamcontainer/write)(byte[], int, int) | Writes a sequence of bytes to the current stream and advances the current position within this stream by the number of bytes written. |
