...
description: The namespace is the core for nested namespaces and the most basic objects used for Aspose.PSD processing.
type: docs
weight: 10
url: /net/aspose.psd/
---
...
| static class [CmykColorHelper](./cmykcolorhelper) | Helper methods to work with CMYK color presented as a signed 32-bit integer value. Provides the similar API as the [`CmykColor`](aspose.psd/cmykcolor) struct. It's more lightweight because CMYK color is presented just as Int32 rather than structure with internal fields. Please prefer to use static methods of this class when possible instead of the deprecated [`CmykColor`](aspose.psd/cmykcolor) struct. |
...
| class [ColorMap](./colormap) | Defines a map for converting colors. Several methods of the [`ImageAttributes`](aspose.psd/imageattributes) class adjust image colors by using a color-remap table, which is an array of [`ColorMap`](aspose.psd/colormap) structures. Not inheritable. |
| class [ColorMatrix](./colormatrix) | Defines a 5 x 5 matrix that contains the coordinates for the RGBA space. Several methods of the [`ImageAttributes`](aspose.psd/imageattributes) class adjust image colors by using a color matrix. This class cannot be inherited. |
...
| static class [FontSettings](./fontsettings) | General PSD vector formats renderer font settings. |
...
| class [ImageAttributes](./imageattributes) | An [`ImageAttributes`](aspose.psd/imageattributes) object contains information about how bitmap and metafile colors are manipulated during rendering. An [`ImageAttributes`](aspose.psd/imageattributes) object maintains several color-adjustment settings, including color-adjustment matrices, grayscale-adjustment matrices, gamma-correction values, color-map tables, and color-threshold values. During rendering, colors can be corrected, darkened, lightened, and removed. To apply such manipulations, initialize an [`ImageAttributes`](aspose.psd/imageattributes) object and pass the path of that [`ImageAttributes`](aspose.psd/imageattributes) object (along with the path of an [`Image`](aspose.psd/image)) to the DrawImage method. |
...
| class [PixelsData](./pixelsdata) | The class to store image pixels data and its bounds. |
...
| interface [IImageExporter](./iimageexporter) | The image exporter. Can export data from internal Aspose.PSD format to a specified data format. |
...
| interface [IPsdColorPalette](./ipsdcolorpalette) | The pasd color palette |
...
| enum [ColorMatrixFlag](./colormatrixflag) | Specifies the types of images and colors that will be affected by the color and grayscale adjustment settings of an [`ImageAttributes`](aspose.psd/imageattributes). |
...
| enum [DashStyle](./dashstyle) | Specifies the style of dashed lines drawn with a [`Pen`](aspose.psd/pen) object. |
...
| enum [FileFormat](./fileformat) | One of supported PSD file formats. |
...
| enum [HatchStyle](./hatchstyle) | Specifies the different patterns available for [`HatchBrush`](aspose.psd.brushes/hatchbrush) objects. |
...
| enum [InterpolationMode](./interpolationmode) | The [`InterpolationMode`](aspose.psd/interpolationmode) enumeration specifies the algorithm that is used when images are scaled or rotated. |
| enum [KnownColor](./knowncolor) | Specifies the known system colors. |
| enum [LineCap](./linecap) | Specifies the available cap styles with which a [`Pen`](aspose.psd/pen) object can end a line. |
| enum [LineJoin](./linejoin) | Specifies how to join consecutive line or curve segments in a figure (subpath) contained in a [`GraphicsPath`](aspose.psd/graphicspath) object. |
...
| enum [PenAlignment](./penalignment) | Specifies the alignment of a [`Pen`](aspose.psd/pen) object in relation to the theoretical, zero-width line. |
| enum [PenType](./pentype) | Specifies the type of fill a [`Pen`](aspose.psd/pen) object uses to fill lines. |
...
| enum [SeekOrigin](./seekorigin) | Provides the fields that represent reference points in [`StreamContainer`](aspose.psd/streamcontainer) for seeking. |
