...
| [ColorMap](./colormap/) | Defines a map for converting colors. Several methods of the [`ImageAttributes`](../aspose.psd/imageattributes/) class adjust image colors by using a color-remap table, which is an array of [`ColorMap`](../aspose.psd/colormap/) structures. Not inheritable. |
| [ColorMatrix](./colormatrix/) | Defines a 5 x 5 matrix that contains the coordinates for the RGBA space. Several methods of the [`ImageAttributes`](../aspose.psd/imageattributes/) class adjust image colors by using a color matrix. This class cannot be inherited. |
...
| [FontSettings](./fontsettings/) | General PSD vector formats renderer font settings. |
...
| [IImageExporter](./iimageexporter/) | The image exporter. Can export data from internal Aspose.PSD format to a specified data format. |
...
| [ColorMatrixFlag](./colormatrixflag/) | Specifies the types of images and colors that will be affected by the color and grayscale adjustment settings of an [`ImageAttributes`](../aspose.psd/imageattributes/). |
...
| [DashStyle](./dashstyle/) | Specifies the style of dashed lines drawn with a [`Pen`](../aspose.psd/pen/) object. |
...
| [FileFormat](./fileformat/) | One of supported PSD file formats. |
...
| [HatchStyle](./hatchstyle/) | Specifies the different patterns available for [`HatchBrush`](../aspose.psd.brushes/hatchbrush/) objects. |
...
| [InterpolationMode](./interpolationmode/) | The [`InterpolationMode`](../aspose.psd/interpolationmode/) enumeration specifies the algorithm that is used when images are scaled or rotated. |
| [KnownColor](./knowncolor/) | Specifies the known system colors. |
| [LineCap](./linecap/) | Specifies the available cap styles with which a [`Pen`](../aspose.psd/pen/) object can end a line. |
| [LineJoin](./linejoin/) | Specifies how to join consecutive line or curve segments in a figure (subpath) contained in a [`GraphicsPath`](../aspose.psd/graphicspath/) object. |
...
| [PenAlignment](./penalignment/) | Specifies the alignment of a [`Pen`](../aspose.psd/pen/) object in relation to the theoretical, zero-width line. |
| [PenType](./pentype/) | Specifies the type of fill a [`Pen`](../aspose.psd/pen/) object uses to fill lines. |
...
| [SeekOrigin](./seekorigin/) | Provides the fields that represent reference points in [`StreamContainer`](../aspose.psd/streamcontainer/) for seeking. |
