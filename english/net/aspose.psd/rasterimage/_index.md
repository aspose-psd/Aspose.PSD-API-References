...
| virtual [AdjustGamma](../../aspose.psd/rasterimage/adjustgamma)(float) | Gamma-correction of an image. |
| virtual [AdjustGamma](../../aspose.psd/rasterimage/adjustgamma)(float, float, float) | Gamma-correction of an image. |
| virtual [BinarizeBradley](../../aspose.psd/rasterimage/binarizebradley)(double) | Binarization of an image using Bradley's adaptive thresholding algorithm using the integral image thresholding |
| virtual [BinarizeBradley](../../aspose.psd/rasterimage/binarizebradley)(double, int) | Binarization of an image using Bradley's adaptive thresholding algorithm using the integral image thresholding |
...
| virtual [Crop](../../aspose.psd/rasterimage/crop)(Rectangle) | Crops the specified rectangle. |
...
| abstract [Dither](../../aspose.psd/rasterimage/dither)(DitheringMethod, int, IColorPalette) | Performs dithering on the current image. |
...
| [NormalizeAngle](../../aspose.psd/rasterimage/normalizeangle)() | Normalizes the angle. This method is applicable to scanned text documents to get rid of the skewed scan. This method uses [`GetSkewAngle`](./getskewangle) and [`Rotate`](./rotate) methods. |
| virtual [NormalizeAngle](../../aspose.psd/rasterimage/normalizeangle)(bool, Color) | Normalizes the angle. This method is applicable to scanned text documents to get rid of the skewed scan. This method uses [`GetSkewAngle`](./getskewangle) and [`Rotate`](./rotate) methods. |
...
| override [Resize](../../aspose.psd/rasterimage/resize)(int, int, ImageResizeSettings) | Resizes the image with extended options. |
| override [Resize](../../aspose.psd/rasterimage/resize)(int, int, ResizeType) | Resizes the image. |
...
| virtual [Rotate](../../aspose.psd/rasterimage/rotate)(float, bool, Color) | Rotate image around the center. |
