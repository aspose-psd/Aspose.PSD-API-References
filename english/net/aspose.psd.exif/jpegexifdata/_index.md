...
| [Artist](../../aspose.psd.exif/jpegexifdata/artist) { get; set; } | Gets or sets the artist. |
| [BitsPerSample](../../aspose.psd.exif/jpegexifdata/bitspersample) { get; set; } | Gets or sets the bits per sample. |
...
| [Compression](../../aspose.psd.exif/jpegexifdata/compression) { get; set; } | Gets or sets the compression. |
| [Contrast](../../aspose.psd.exif/exifdata/contrast) { get; set; } | Gets or sets the contrast. |
| [Copyright](../../aspose.psd.exif/jpegexifdata/copyright) { get; set; } | Gets or sets the copyright. |
| [CustomRendered](../../aspose.psd.exif/exifdata/customrendered) { get; set; } | Gets or sets the custom rendered. |
| [DateTime](../../aspose.psd.exif/jpegexifdata/datetime) { get; set; } | Gets or sets the date time. |
...
| [ExposureIndex](../../aspose.psd.exif/exifdata/exposureindex) { get; set; } | Gets or sets the exposure index. |
...
| [GPSMeasureMode](../../aspose.psd.exif/exifdata/gpsmeasuremode) { get; set; } | Gets or sets the GPS measurement mode. |
...
| [ImageDescription](../../aspose.psd.exif/jpegexifdata/imagedescription) { get; set; } | Gets or sets the image description. |
| [ImageLength](../../aspose.psd.exif/jpegexifdata/imagelength) { get; set; } | Gets or sets the image length. |
| [ImageUniqueID](../../aspose.psd.exif/exifdata/imageuniqueid) { get; set; } | Gets or sets the image unique identifier. |
| [ImageWidth](../../aspose.psd.exif/jpegexifdata/imagewidth) { get; set; } | Gets or sets the image width. |
...
| [Make](../../aspose.psd.exif/jpegexifdata/make) { get; set; } | Gets or sets the manufacturer of the recording equipment. |
...
| [Model](../../aspose.psd.exif/jpegexifdata/model) { get; set; } | Gets or sets the model. |
...
| [Orientation](../../aspose.psd.exif/jpegexifdata/orientation) { get; set; } | Gets or sets the orientation. |
...
| [PhotometricInterpretation](../../aspose.psd.exif/jpegexifdata/photometricinterpretation) { get; set; } | Gets or sets the photometric interpretation. |
...
| [PlanarConfiguration](../../aspose.psd.exif/jpegexifdata/planarconfiguration) { get; set; } | Gets or sets the planar configuration. |
| [PrimaryChromaticities](../../aspose.psd.exif/jpegexifdata/primarychromaticities) { get; set; } | Gets or sets the chromaticity of the three primary colors of the image. |
...
| [ReferenceBlackWhite](../../aspose.psd.exif/jpegexifdata/referenceblackwhite) { get; set; } | Gets or sets the reference black white. |
| [RelatedSoundFile](../../aspose.psd.exif/exifdata/relatedsoundfile) { get; set; } | Gets or sets the related sound file. |
| [ResolutionUnit](../../aspose.psd.exif/jpegexifdata/resolutionunit) { get; set; } | Gets or sets the resolution unit. |
| [SamplesPerPixel](../../aspose.psd.exif/jpegexifdata/samplesperpixel) { get; set; } | Gets or sets the samples per pixel. |
...
| [Sharpness](../../aspose.psd.exif/exifdata/sharpness) { get; set; } | Gets or sets the sharpness. |
| [ShutterSpeedValue](../../aspose.psd.exif/exifdata/shutterspeedvalue) { get; set; } | Gets or sets the shutter speed value. |
| [Software](../../aspose.psd.exif/jpegexifdata/software) { get; set; } | Gets or sets the software. |
...
| [Thumbnail](../../aspose.psd.exif/jpegexifdata/thumbnail) { get; set; } | Gets or sets the thumbnail image. |
| [TransferFunction](../../aspose.psd.exif/jpegexifdata/transferfunction) { get; set; } | Gets or sets the transfer function. |
...
| [XResolution](../../aspose.psd.exif/jpegexifdata/xresolution) { get; set; } | Gets or sets the x resolution. |
| [YCbCrCoefficients](../../aspose.psd.exif/jpegexifdata/ycbcrcoefficients) { get; set; } | Gets or sets the matrix coefficients for transformation from RGB to YCbCr image data. |
| [YCbCrPositioning](../../aspose.psd.exif/jpegexifdata/ycbcrpositioning) { get; set; } | Gets or sets the position of chrominance components in relation to the luminance component. |
| [YCbCrSubSampling](../../aspose.psd.exif/jpegexifdata/ycbcrsubsampling) { get; set; } | Gets or sets the sampling ratio of chrominance components in relation to the luminance component. |
| [YResolution](../../aspose.psd.exif/jpegexifdata/yresolution) { get; set; } | Gets or sets the y resolution. |

## Methods

| Name | Description |
| --- | --- |
| [RemoveTag](../../aspose.psd.exif/exifdata/removetag)(ExifProperties) | Remove tag from container |
| [RemoveTag](../../aspose.psd.exif/exifdata/removetag)(ushort) | Remove tag from container |
| [SerializeExifData](../../aspose.psd.exif/jpegexifdata/serializeexifdata)() | Serializes the EXIF data. Writes the tags values and contents. The most influencing size tag is Thumbnail tag contents. |

## Fields

| Name | Description |
| --- | --- |
| const [MaxExifSegmentSize](../../aspose.psd.exif/jpegexifdata/maxexifsegmentsize) | The maximum EXIF segment size in bytes allowed. |
