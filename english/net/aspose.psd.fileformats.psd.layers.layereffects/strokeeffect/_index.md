...
| Name | Description |
| --- | --- |
| [BlendMode](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/blendmode) { get; set; } | Gets or sets the blend mode. |
| [EffectType](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/effecttype) { get; } | Gets a type of effect |
| [FillSettings](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/fillsettings) { get; set; } | Gets or sets the fill settings. |
| [IsVisible](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/isvisible) { get; set; } | Gets or sets a value indicating whether this instance is visible. |
| [Opacity](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/opacity) { get; set; } | Gets or sets the opacity. |
| [Overprint](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/overprint) { get; set; } | Gets or sets a value indicating whether this [`StrokeEffect`](../strokeeffect) will blend stroke against current layer contents. |
...
The following code example shows rendering of Stroke effect with Color Fill.
