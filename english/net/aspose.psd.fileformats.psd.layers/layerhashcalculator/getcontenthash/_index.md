...
description: LayerHashCalculator method. Gets the content hash
type: docs
weight: 40
url: /net/aspose.psd.fileformats.psd.layers/layerhashcalculator/getcontenthash/
---
{{< psd/tize >}}
...
The hash of the significant parameters of layers. This hash is different for all types of layers
