...
description: SectionDividerLayer property. Gets a value indicating whether this instance is visible in groupIf layer is not in group it means root group
type: docs
weight: 10
