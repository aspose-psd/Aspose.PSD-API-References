...
| Name | Description |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Initializes a new instance of the `ShapeLayer` class. All resources are created in their default state. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Gets the set of Paths that present ina Shape layer. |
...
| Name | Description |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Creates a new instance of the `ShapeLayer` class. |
