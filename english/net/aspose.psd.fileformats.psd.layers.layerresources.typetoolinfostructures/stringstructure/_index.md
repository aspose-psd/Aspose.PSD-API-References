...
| Name | Description |
| --- | --- |
| [StringStructure](stringstructure/#constructor)(ClassID) | Initializes a new instance of the `StringStructure` class. |
| [StringStructure](stringstructure/#constructor_1)(ClassID, string) | Initializes a new instance of the `StringStructure` class with value. |
