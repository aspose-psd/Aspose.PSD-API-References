...
| Name | Description |
| --- | --- |
| [UnitStructure](unitstructure/)(ClassID) | Initializes a new instance of the `UnitStructure` class. |
...
| Name | Description |
| --- | --- |
| const [StructureKey](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/structurekey/) | Identifies the structure key. |
