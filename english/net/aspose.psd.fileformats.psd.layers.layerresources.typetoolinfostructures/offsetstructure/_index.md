...
| Name | Description |
| --- | --- |
| [OffsetStructure](offsetstructure/)(ClassID, ClassID) | Initializes a new instance of the `OffsetStructure` class. |
...
| Name | Description |
| --- | --- |
| const [StructureKey](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/structurekey/) | Identifies the structure key. |
