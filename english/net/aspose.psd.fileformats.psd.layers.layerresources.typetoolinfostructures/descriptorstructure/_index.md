...
| Name | Description |
| --- | --- |
| [DescriptorStructure](descriptorstructure/)(ClassID, ClassID, string, OSTypeStructure[]) | Initializes a new instance of the `DescriptorStructure` class. |
...
| [Structures](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure/structures/) { get; set; } | Gets or sets a copy of an array of structures. |
