...
| Name | Description |
| --- | --- |
| [EnumeratedDescriptorStructure](enumerateddescriptorstructure/)(ClassID, ClassID, ClassID) | Initializes a new instance of the `EnumeratedDescriptorStructure` class. |
...
| Name | Description |
| --- | --- |
| const [StructureKey](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumerateddescriptorstructure/structurekey/) | The enumerated descriptor key. |
