...
| [XmpArray](./xmparray/) | Represents Xmp Array in [`XmpPackage`](../aspose.psd.xmp/xmppackage/). TODO: Array may contain complex data. |
...
| [XmpPackage](./xmppackage/) | Defines the XmpPackage class that represents base abstraction for XMP package. |
| [XmpPackageBaseCollection](./xmppackagebasecollection/) | Represents collection of [`XmpPackage`](../aspose.psd.xmp/xmppackage/). |
...
| --- | --- |
| [XmpArrayType](./xmparraytype/) | Represents array type in [`XmpArray`](../aspose.psd.xmp/xmparray/). |
