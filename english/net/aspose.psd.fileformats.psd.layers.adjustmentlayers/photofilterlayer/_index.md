...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color) { get; set; } | Gets or sets the RGB color of filter. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density) { get; set; } | Gets or sets the density of filter |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity) { get; set; } | Gets or sets a value indicating whether [preserve luminosity]. |
