...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness) { get; set; } | Gets or sets the brightness. For PS range of brightness is from -150 to +150. But we ignore this. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast) { get; set; } | Gets or sets the contrast. For PS range of contrast is from -50 to +100. But we ignore this. |
