...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Gets or sets the Exposure. For PS range of Exposure is from -20 to +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Gets or sets the GammaCorrection. For PS range of GammaCorrection is from 9.99 to +0.01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Gets or sets the Offset. For PS range of Offset is from -0.5 to +0.5 |
