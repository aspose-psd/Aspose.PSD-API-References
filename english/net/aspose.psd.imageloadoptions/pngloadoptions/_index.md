...
description: Aspose.PSD.ImageLoadOptions.PngLoadOptions class. The png load options
type: docs
weight: 5150
url: /net/aspose.psd.imageloadoptions/pngloadoptions/
---
{{< psd/tize >}}
...
| Name | Description |
| --- | --- |
| [PngLoadOptions](pngloadoptions/)() | The default constructor. |
...
| [StrictMode](../../aspose.psd.imageloadoptions/pngloadoptions/strictmode/) { get; set; } | Gets or sets a value indicating whether [strict mode]. |
