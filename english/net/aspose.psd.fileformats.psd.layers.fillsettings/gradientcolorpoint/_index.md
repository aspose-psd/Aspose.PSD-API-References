...
| Name | Description |
| --- | --- |
| [GradientColorPoint](gradientcolorpoint/#constructor)() | Initializes a new instance of the `GradientColorPoint` class. |
| [GradientColorPoint](gradientcolorpoint/#constructor_1)(Color, int, int) | Initializes a new instance of the `GradientColorPoint` class. |
...
| [RawColor](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientcolorpoint/rawcolor/) { get; set; } | Gets or sets the color of the raw. |
