...
description: TimeLine method. Apply current time line values to input PsdImage
type: docs
weight: 90
...
Apply current time line values to input [`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
