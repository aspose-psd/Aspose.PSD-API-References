...
description: "WarpSettings свойство. Получает или задает значение поворота"
type: docs
weight: 60
url: /ru/net/aspose.psd.fileformats.psd.layers.warp/warpsettings/rotate/
---
{{< psd/tize >}}
## WarpSettings.Rotate property

Получает или задает значение поворота
