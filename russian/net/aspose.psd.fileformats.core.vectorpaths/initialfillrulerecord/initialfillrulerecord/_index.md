...
description: InitialFillRuleRecord строитель. Инициализирует новый экземплярInitialFillRuleRecord класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`InitialFillRuleRecord`](../) класс.
