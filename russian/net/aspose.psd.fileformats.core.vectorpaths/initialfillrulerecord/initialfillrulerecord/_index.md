...
description: "Конструктор InitialFillRuleRecord. Инициализирует новый экземпляр класса InitialFillRuleRecord"
type: docs
weight: 10
url: /ru/net/aspose.psd.fileformats.core.vectorpaths/initialfillrulerecord/initialfillrulerecord/
---
{{< psd/tize >}}
## InitialFillRuleRecord() {#constructor}

Инициализирует новый экземпляр класса [`InitialFillRuleRecord`](../).
