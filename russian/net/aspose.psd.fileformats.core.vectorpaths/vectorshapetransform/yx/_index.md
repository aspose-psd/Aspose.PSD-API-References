...
description: VectorShapeTransform свойство. Получает или задает значение YX.
type: docs
weight: 60
...
Получает или задает значение YX.
...
* пространство имен [Aspose.PSD.FileFormats.Core.VectorPaths](../../vectorshapetransform/)
* сборка [Aspose.PSD](../../../)
