...
description: VectorShapeTransform строитель. Инициализирует новый экземплярVectorShapeTransform класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`VectorShapeTransform`](../) класс.
