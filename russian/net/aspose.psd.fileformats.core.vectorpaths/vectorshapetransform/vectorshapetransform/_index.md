...
description: "Конструктор VectorShapeTransform. Инициализирует новый экземпляр класса VectorShapeTransform"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`VectorShapeTransform`](../).
