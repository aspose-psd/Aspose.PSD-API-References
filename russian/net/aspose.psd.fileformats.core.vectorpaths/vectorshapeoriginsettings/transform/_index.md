...
description: VectorShapeOriginSettings свойство. Получает или задает матрицу преобразования.
type: docs
weight: 170
...
В этом примере показано, как изменить размер слоев с ресурсом Vogk и векторным путем в изображении PSD.
