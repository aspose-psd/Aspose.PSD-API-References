...
description: "Свойство IVectorPathData. Возвращает или задает значение, указывающее, отключен ли данный экземпляр."
type: docs
weight: 10
...
`true` если данный экземпляр отключен; в противном случае `false`.
