...
description: "Метод LayerStateEffects. Добавляет эффект цветового наложения"
type: docs
weight: 30
...
Новый экземпляр класса [`ColorOverlayEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/coloroverlayeffect/).
