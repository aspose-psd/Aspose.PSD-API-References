...
description: LayerStateEffects метод. Добавляет эффект внутренней тени.
type: docs
weight: 60
...
Новый экземпляр[`InnerShadowEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/) сорт.
