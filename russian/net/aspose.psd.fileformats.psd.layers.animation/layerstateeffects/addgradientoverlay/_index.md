...
description: "Метод LayerStateEffects. Добавляет эффект градиентного наложения"
type: docs
weight: 50
...
Новый экземпляр класса [`GradientOverlayEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/gradientoverlayeffect/).
