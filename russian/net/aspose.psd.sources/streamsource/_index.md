...
description: Aspose.PSD.Sources.StreamSource сорт. Представляет источник потока.
type: docs
weight: 5620
...
| Имя | Описание |
| --- | --- |
| [StreamSource](streamsource/#constructor)(Stream) | Инициализирует новый экземпляр`StreamSource` класс. |
| [StreamSource](streamsource/#constructor_1)(Stream, bool) | Инициализирует новый экземпляр`StreamSource` класс. |
