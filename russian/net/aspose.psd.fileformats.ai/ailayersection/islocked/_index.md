...
description: Получает или задает значение указывающее заблокирован ли этот слой. Предотвращает изменение элемента.
type: docs
weight: 60
...
Получает или задает значение, указывающее, заблокирован ли этот слой. Предотвращает изменение элемента.
...
` true` если этот слой заблокирован; в противном случае` false` .
