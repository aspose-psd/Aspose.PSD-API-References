...
description: Получает или задает значение указывающее является ли этот слой слоем шаблона.
type: docs
weight: 100
...
` true` если этот слой является шаблоном; в противном случае` false` .
