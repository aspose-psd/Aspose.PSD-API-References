...
description: Получает или задает имя слоя. Указывает имя элемента которое отображается на панели Слои.
type: docs
weight: 110
...
Получает или задает имя слоя. Указывает имя элемента, которое отображается на панели «Слои».
