...
description: Получает или задает номер цвета. -1  это пользовательское значение цвета из свойств Красный Зеленый Синий. Задает настройку цвета слоя.
type: docs
weight: 20
...
Получает или задает номер цвета. -1 — это пользовательское значение цвета из свойств «Красный», «Зеленый», «Синий». Задает настройку цвета слоя.
