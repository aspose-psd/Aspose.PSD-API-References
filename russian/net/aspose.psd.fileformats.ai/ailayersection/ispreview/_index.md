...
description: Получает или задает значение указывающее является ли этот слой предварительным. Отображает иллюстрацию содержащуюся в слое в цвете а не в виде контуров.
type: docs
weight: 70
...
` true` если этот слой предварительный; в противном случае` false` .
