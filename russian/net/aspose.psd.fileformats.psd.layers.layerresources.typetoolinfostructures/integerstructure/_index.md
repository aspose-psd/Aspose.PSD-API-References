...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.IntegerStructure сорт. Целочисленная структура.
type: docs
weight: 3180
...
| Имя | Описание |
| --- | --- |
| [IntegerStructure](integerstructure/)(ClassID) | Инициализирует новый экземпляр`IntegerStructure` класс. |
