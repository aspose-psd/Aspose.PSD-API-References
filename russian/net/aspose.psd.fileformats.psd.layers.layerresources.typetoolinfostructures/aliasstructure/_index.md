...
| Имя | Описание |
| --- | --- |
| [DataLength](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/datalength) { get; } | Получает точную длину данных в байтах. |
...
| Имя | Описание |
| --- | --- |
| const [StructureKey](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/structurekey) | Идентифицирует ключ структуры. |
