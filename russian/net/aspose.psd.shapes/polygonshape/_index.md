...
description: Aspose.PSD.Shapes.PolygonShape сорт. Представляет форму многоугольника.
type: docs
weight: 5510
...
| Имя | Описание |
| --- | --- |
| [PolygonShape](polygonshape/#constructor)() | Инициализирует новый экземпляр`PolygonShape` класс. |
| [PolygonShape](polygonshape/#constructor_1)(PointF[]) | Инициализирует новый экземпляр`PolygonShape` класс. |
| [PolygonShape](polygonshape/#constructor_2)(PointF[], bool) | Инициализирует новый экземпляр`PolygonShape` класс. |
