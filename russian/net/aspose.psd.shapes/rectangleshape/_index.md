...
description: Aspose.PSD.Shapes.RectangleShape сорт. Представляет прямоугольную форму.
type: docs
weight: 5530
...
| Имя | Описание |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Инициализирует новый экземпляр`RectangleShape` класс. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Инициализирует новый экземпляр`RectangleShape` класс. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Получает сегменты формы. |
