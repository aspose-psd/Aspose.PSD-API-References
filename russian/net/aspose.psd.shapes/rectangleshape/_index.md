...
description: "Aspose.PSD.Shapes.RectangleShape класс. Представляет прямоугольную форму"
type: docs
weight: 6030
...
| Имя | Описание |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Инициализирует новый экземпляр класса `RectangleShape`. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Инициализирует новый экземпляр класса `RectangleShape`. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Получает сегменты фигуры. |
