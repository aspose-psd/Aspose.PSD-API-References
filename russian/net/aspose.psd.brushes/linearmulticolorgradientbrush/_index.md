...
description: ПредставляетBrush../aspose.psd/brush с линейным градиентом определяемым несколькими цветами и соответствующими позициями. Этот класс не может быть унаследован.
type: docs
weight: 160
