...
description: "Класс Aspose.PSD.Brushes.LinearMulticolorGradientBrush. Представляет кисть с линейным градиентом, определённым несколькими цветами и соответствующими позициями. Этот класс не может быть наследован"
type: docs
weight: 160
...
Представляет [`Brush`](../../aspose.psd/brush/) с линейным градиентом, определённым несколькими цветами и соответствующими позициями. Этот класс не может быть наследован.
...
| Имя | Описание |
| --- | --- |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor)() | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` с параметрами по умолчанию. Начальный цвет — чёрный, конечный цвет — белый, угол — 45 градусов, а прямоугольник расположен в (0,0) размером (1,1). |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_1)(Point, Point) | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` с указанными точками. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_2)(PointF, PointF) | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` с указанными точками. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_3)(Rectangle, float) | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` на основе прямоугольника и угла ориентации. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_5)(RectangleF, float) | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` на основе прямоугольника и угла ориентации. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_4)(Rectangle, float, bool) | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` на основе прямоугольника и угла ориентации. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_6)(RectangleF, float, bool) | Инициализирует новый экземпляр класса `LinearMulticolorGradientBrush` на основе прямоугольника и угла ориентации. |
...
| [InterpolationColors](../../aspose.psd.brushes/linearmulticolorgradientbrush/interpolationcolors/) { get; set; } | Получает или задаёт [`ColorBlend`](../../aspose.psd/colorblend/), определяющий многокрасочный линейный градиент. |
