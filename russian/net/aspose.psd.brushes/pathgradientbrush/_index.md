...
| Имя | Описание |
| --- | --- |
| [Blend](../../aspose.psd.brushes/pathgradientbrush/blend) { get; set; } | Получает или задает[`Blend`](../../aspose.psd/blend), который указывает позиции и факторы, определяющие пользовательский спад для градиента. |
...
| [SurroundColors](../../aspose.psd.brushes/pathgradientbrush/surroundcolors) { get; set; } | Получает или задает массив цветов, соответствующих точкам на пути, который заполняет этот[`PathGradientBrush`](../pathgradientbrush). |
