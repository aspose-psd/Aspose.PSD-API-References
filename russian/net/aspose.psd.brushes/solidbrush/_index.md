...
description: Aspose.PSD.Brushes.SolidBrush сорт. Сплошная кисть предназначена для непрерывного рисования определенным цветом. Этот класс не может быть унаследован.
type: docs
weight: 200
...
| Имя | Описание |
| --- | --- |
| [SolidBrush](solidbrush/#constructor)() | Инициализирует новый экземпляр`SolidBrush` класс. |
| [SolidBrush](solidbrush/#constructor_1)(Color) | Инициализирует новый экземпляр`SolidBrush` класс. |
