...
description: ПредставляетBrush../aspose.psd/brush с возможностями градиента и соответствующими свойствами.
type: docs
weight: 150
...
| [IsAngleScalable](../../aspose.psd.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | Получает или задает значение, указывающее,[`Angle`](./angle) изменяется во время трансформаций с этим[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
