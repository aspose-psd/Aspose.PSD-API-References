...
description: ITextStyle метод. Определяет равен ли указанный стиль.
type: docs
weight: 290
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
...
| --- | --- | --- |
| style | ITextStyle | Стиль. |

### Возвращаемое значение

`истинный` если указанный стиль равен; в противном случае,`ЛОЖЬ` .
