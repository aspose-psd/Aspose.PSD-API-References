...
description: Получает или задает значение указывающее используются ли числа на хинди.
type: docs
weight: 150
...
Получает или задает значение, указывающее, используются ли [числа на хинди].
...
` true` if [числа на хинди]; в противном случае` false` .
