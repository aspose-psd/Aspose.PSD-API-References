...
description: "Свойство ITextStyle. Получает или задает значение, указывающее, включены ли цифры хинди"
type: docs
weight: 150
...
Получает или задает значение, указывающее, включены ли [hindi numbers].
...
`true` если [hindi numbers]; иначе, `false`.
