---
title: ITextStyle.HindiNumbers
second_title: Справочник по Aspose.PSD для .NET API
description: ITextStyle свойство. Получает или задает значение указывающее являются ли числа на хинди.
type: docs
weight: 150
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Получает или задает значение, указывающее, являются ли [числа на хинди].
...
`истинный` если [числа на хинди]; в противном случае,`ЛОЖЬ` .
