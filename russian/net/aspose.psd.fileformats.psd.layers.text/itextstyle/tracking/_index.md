...
description: ITextStyle свойство. Получает или задает отслеживание.
type: docs
weight: 250
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextstyle/tracking/
---
## ITextStyle.Tracking property

Получает или задает отслеживание.
