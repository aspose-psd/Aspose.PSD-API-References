...
description: ITextStyle свойство. Получает или задает значение указывающее используется ли автоматический интерлиньяж.
type: docs
weight: 20
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Получает или задает значение, указывающее, используется ли [автоматический интерлиньяж].
...
`истинный` если [автоматическое опережение]; в противном случае,`ЛОЖЬ` .
