...
description: "Свойство ITextStyle. Получает или задает значение, указывающее, включено ли автоматическое межстрочное расстояние"
type: docs
weight: 20
...
`true` если [automatic leading]; иначе, `false`.
