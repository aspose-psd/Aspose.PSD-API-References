...
description: Создает новую порцию с параметрами по умолчанию
type: docs
weight: 50
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itext/produceportion/
---
## IText.ProducePortion method

Создает новую порцию с параметрами по умолчанию
...
Ссылка на вновь созданный[`ITextPortion`](../../itextportion).
