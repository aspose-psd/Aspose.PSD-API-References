...
description: ITextParagraph свойство. Получает или задает конечный отступ.
type: docs
weight: 50
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/endindent/
---
## ITextParagraph.EndIndent property

Получает или задает конечный отступ.
