...
description: ITextParagraph свойство. Получает или устанавливает пробел после.
type: docs
weight: 170
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/spaceafter/
---
## ITextParagraph.SpaceAfter property

Получает или устанавливает пробел после.
