...
description: "ITextParagraph свойство. Получает или задает значение, указывающее, является ли этот ITextParagraph burasagiri"
type: docs
weight: 30
...
Получает или задает значение, указывающее, является ли этот [`ITextParagraph`](../) burasagiri.
...
`true` если burasagiri; иначе `false`.
