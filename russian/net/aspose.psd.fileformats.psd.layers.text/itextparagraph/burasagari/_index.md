...
description: ITextParagraph свойство. Получает или задает значение указывающее является ли этоITextParagraphэто бурасагири.
type: docs
weight: 30
...
Получает или задает значение, указывающее, является ли это[`ITextParagraph`](../)это бурасагири.
