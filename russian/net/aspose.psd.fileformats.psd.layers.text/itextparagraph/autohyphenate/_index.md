...
description: "Свойство ITextParagraph. Получает или задает значение, указывающее, включено ли автоматическое расставление переносов"
type: docs
weight: 10
...
`true` если [automatic hyphenate]; иначе `false`.
