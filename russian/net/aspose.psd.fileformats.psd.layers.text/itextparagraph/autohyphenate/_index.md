---
title: ITextParagraph.AutoHyphenate
second_title: Справочник по Aspose.PSD для .NET API
description: ITextParagraph свойство. Получает или задает значение указывающее используется ли автоматический перенос.
type: docs
weight: 10
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Получает или задает значение, указывающее, используется ли [автоматический перенос].
...
`истинный` если [автоматический перенос]; в противном случае,`ЛОЖЬ` .
