---
title: ITextParagraph.EveryLineComposer
second_title: Справочник по Aspose.PSD для .NET API
description: ITextParagraph свойство. Получает или задает значение указывающее является ли композитор каждой строки.
type: docs
weight: 60
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Получает или задает значение, указывающее, является ли [композитор каждой строки].
...
`истинный` если [композитор каждой строки]; в противном случае,`ЛОЖЬ` .
...
* пространство имен [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph/)
* сборка [Aspose.PSD](../../../)
