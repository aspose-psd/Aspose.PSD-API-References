...
description: "Свойство ITextParagraph. Получает или задает значение, указывающее, включён ли каждый составитель строки"
type: docs
weight: 60
...
Получает или задает значение, указывающее, включено ли [every line composer].
...
`true` если [every line composer]; иначе, `false`.
