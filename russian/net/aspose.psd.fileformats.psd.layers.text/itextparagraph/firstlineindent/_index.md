...
description: ITextParagraph свойство. Получает или задает отступ первой строки.
type: docs
weight: 70
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/firstlineindent/
---
