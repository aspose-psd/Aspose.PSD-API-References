...
description: Получает или задает размер слова через дефис.
type: docs
weight: 100
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hyphenatedwordsize/
---
## ITextParagraph.HyphenatedWordSize property

Получает или задает размер слова через дефис.
