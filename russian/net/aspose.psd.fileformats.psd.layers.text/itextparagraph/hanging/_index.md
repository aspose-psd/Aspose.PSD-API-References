...
description: ITextParagraph свойство. Получает или задает значение указывающее является ли этоITextParagraph висит.
type: docs
weight: 90
...
Получает или задает значение, указывающее, является ли это[`ITextParagraph`](../) висит.
