...
description: "Свойство ITextParagraph. Получает или задает значение, указывающее, является ли этот ITextParagraph висячим"
type: docs
weight: 90
...
Получает или задает значение, указывающее, является ли этот [`ITextParagraph`](../) висячим.
...
`true` если подвешено; иначе `false`.
