...
description: ITextParagraph свойство. Получает или устанавливает дефис сообщения.
type: docs
weight: 150
url: /ru/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/posthyphen/
---
## ITextParagraph.PostHyphen property

Получает или устанавливает дефис сообщения.
