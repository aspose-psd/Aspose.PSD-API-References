...
description: Получает или задает значение указывающее влияет ли загрузка на ресурс по умолчанию ресурс не загружается. При установке этого параметра только поддерживаемые эффекты будут отображаться в окончательном объединенном изображении.
type: docs
weight: 40
