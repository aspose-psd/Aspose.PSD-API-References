...
description: "Метод PsdImage. Добавляет слой коррекции выборочного цвета"
type: docs
weight: 450
url: /ru/net/aspose.psd.fileformats.psd/psdimage/addselectivecoloradjustmentlayer/
---
{{< psd/tize >}}
## PsdImage.AddSelectiveColorAdjustmentLayer method

Добавляет слой коррекции избирательных цветов.
...
Созданный слой корректировки избирательного цвета.
