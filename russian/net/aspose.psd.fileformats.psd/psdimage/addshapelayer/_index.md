...
description: "Метод PsdImage. Добавляет пустой слой Shape. Без путей. Их следует добавить в слой shape перед сохранением"
type: docs
weight: 460
url: /ru/net/aspose.psd.fileformats.psd/psdimage/addshapelayer/
---
{{< psd/tize >}}
## PsdImage.AddShapeLayer method

Добавить пустой слой Shape. Без путей. Их следует добавить в слой Shape перед сохранением.
...
Экземпляр ShapeLayer.

## Примеры

Следующий код демонстрирует, как добавить ShapeLayer.
