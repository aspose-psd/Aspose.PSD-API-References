...
description: "Класс Aspose.PSD.FileFormats.Psd.SmartObjectProvider. Определяет поставщик смарт‑объектов, который обеспечивает получение/установку источников данных из глобальных связанных ресурсов PSD‑файла и их содержимого."
type: docs
weight: 4470
...
Определяет поставщик смарт-объектов, который обеспечивает получение/установку источников данных из глобальных связанных ресурсов PSD‑файла и их содержимого.
...
| Имя | Описание |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Преобразует слои в встроенный смарт‑объект. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Преобразует слои в встроенный смарт‑объект. |
...
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Создаёт новый слой смарт‑объекта, копируя исходный. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Обновляет содержимое всех изменённых смарт‑объектов в изображении. |
