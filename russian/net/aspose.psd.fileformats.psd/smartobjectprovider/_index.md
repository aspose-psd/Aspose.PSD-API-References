...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider сорт. Определяет провайдера смартобъекта обеспечивающего получение/настройку источников данных из ресурсов глобальных ссылок PSDфайла и их содержимого.
type: docs
weight: 4000
