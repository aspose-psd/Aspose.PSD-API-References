...
description: Получает тип содержимого слоя смартобъекта. Содержимое встроенного смартобъекта представляет собой встроенный файл необработанного изображенияDataaspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data . Содержимое связанного смартобъекта  это необработанное содержимое связанного файла изображения если оно доступноLiFeDataSourceaspose.psd.fileformats.psd.layers.layerresources/lifedatasource . Мы не поддерживаем загрузку из графической библиотеки Adobe Photoshop  приIsLibraryLinkaspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink верно. Для обычных файлов ссылок сначала используетсяRelativePathaspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath искать файл относительно пути к исходному изображениюSourceImagePath  если нет в наличии смотримFullPathaspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath  если нет то ищем файл ссылки в той же директории где наш образSourceImagePath .
type: docs
weight: 40
