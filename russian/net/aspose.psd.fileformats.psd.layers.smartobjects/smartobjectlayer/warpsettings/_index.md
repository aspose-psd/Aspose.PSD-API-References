...
description: "Свойство SmartObjectLayer. Получает или задает параметры Warp, которые были установлены или получены из ресурса по умолчанию."
type: docs
weight: 80
url: /ru/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

Получает или задает параметры Warp, которые были установлены или получены из ресурса (по умолчанию).
