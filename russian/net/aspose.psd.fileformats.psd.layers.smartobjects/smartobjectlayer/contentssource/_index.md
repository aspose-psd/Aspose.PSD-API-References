...
description: "Свойство SmartObjectLayer. Получает или задает источник содержимого умного объекта"
type: docs
weight: 40
...
Получает или задает источник содержимого смарт‑объекта.
...
Источник данных умного объекта.
