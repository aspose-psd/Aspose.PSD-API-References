...
description: SmartObjectLayer метод. Создает новый слой смартобъекта копируя этот слой. Воспроизводит функцию Слой  Смартобъекты  Новый смартобъект через копирование Adobe Photoshop. также копируется. Если вы хотите поделиться встроенным изображением используйтеDuplicateLayer метод.
type: docs
weight: 120
...
Клонированный[`SmartObjectLayer`](../) пример.
