...
description: SmartObjectLayer метод. Повторно связывает связанный смартобъект с новым файлом. После этого нет необходимости вызывать метод UpdateModifiedContent.
type: docs
weight: 130
...
Повторно связывает связанный смарт-объект с новым файлом. После этого нет необходимости вызывать метод UpdateModifiedContent.
