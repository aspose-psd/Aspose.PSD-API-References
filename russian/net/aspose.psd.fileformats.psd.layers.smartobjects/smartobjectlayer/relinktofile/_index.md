...
description: "Метод SmartObjectLayer. Перепривязывает связанный смарт‑объект к новому файлу. Нет необходимости вызывать метод UpdateModifiedContent после этого"
type: docs
weight: 150
...
Переподключает связанный смарт‑объект к новому файлу. Нет необходимости вызывать метод UpdateModifiedContent позже.
