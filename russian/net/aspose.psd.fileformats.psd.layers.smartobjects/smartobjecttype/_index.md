---
title: "Перечисление SmartObjectType"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Перечисление Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType. Определяет перечисление SmartObjectType для типа содержимого смарт‑объекта"
type: docs
weight: 3920
...
| AvailableLinked | `1` | Связанный файл, который доступен |
| UnavailableLinked | `2` | Связанный файл, который недоступен |
| LibraryLink | `3` | Ссылка на библиотеку Adobe® Photoshop® ÑÑ |
