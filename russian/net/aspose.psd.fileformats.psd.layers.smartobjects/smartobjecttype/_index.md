...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType перечисление. Определяет перечисление SmartObjectType для содержимого смартобъекта type
type: docs
weight: 3500
