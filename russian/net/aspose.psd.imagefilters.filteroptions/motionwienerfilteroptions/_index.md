...
description: Aspose.PSD.ImageFilters.FilterOptions.MotionWienerFilterOptions сорт. Параметры фильтра деконволюции deblur motion
type: docs
weight: 4730
...
| Имя | Описание |
| --- | --- |
| [MotionWienerFilterOptions](motionwienerfilteroptions/)(int, double, double) | Инициализирует новый экземпляр`MotionWienerFilterOptions` класс. |
