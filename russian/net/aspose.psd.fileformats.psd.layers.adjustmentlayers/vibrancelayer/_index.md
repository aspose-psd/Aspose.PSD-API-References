...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer сорт. Реализация корректирующего слоя Vibrance
type: docs
weight: 1830
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation/) { get; set; } | Получает или устанавливает насыщенность. |
