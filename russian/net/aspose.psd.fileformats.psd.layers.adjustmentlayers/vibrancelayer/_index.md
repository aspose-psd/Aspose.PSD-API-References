...
description: Реализация корректирующего слоя Vibrance
type: docs
weight: 1820
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
## VibranceLayer class

Реализация корректирующего слоя Vibrance
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation) { get; set; } | Получает или задает насыщенность. |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance) { get; set; } | Получает или устанавливает яркость. |
...
В следующем примере кода демонстрируется поддержка слой VibranceLayer и возможность редактировать эту настройку.
