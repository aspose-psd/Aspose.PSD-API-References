...
description: корректирующий слой PhotoFilter.
type: docs
weight: 1790
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
## PhotoFilterLayer class

корректирующий слой PhotoFilter.
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color) { get; set; } | Получает или задает цвет фильтра RGB. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density) { get; set; } | Получает или устанавливает плотность фильтра |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity) { get; set; } | Получает или задает значение, указывающее, [сохранять яркость]. |
