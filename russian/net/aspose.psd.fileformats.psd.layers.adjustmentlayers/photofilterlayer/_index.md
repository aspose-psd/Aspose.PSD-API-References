...
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer. Слой корректировки PhotoFilter."
type: docs
weight: 1860
...
Слой корректировки PhotoFilter.
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Получает или задает RGB‑цвет фильтра. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Получает или задает плотность фильтра. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Получает или задает значение, указывающее, следует ли [preserve luminosity]. |
