---
title: "Класс BrightnessContrastLayer"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer класс. Слой яркости/контраста."
type: docs
weight: 1720
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | Получает или задает яркость. В диапазоне PS значение яркости от -150 до +150. Но мы игнорируем это. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | Получает или задает контраст. В диапазоне PS значение контраста от -50 до +100. Но мы игнорируем это. |
