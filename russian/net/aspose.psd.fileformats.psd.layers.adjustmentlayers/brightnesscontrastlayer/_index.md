...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer сорт. Слой яркости/контрастности.
type: docs
weight: 1680
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | Получает или задает контрастность. Для PS диапазон контрастности от -50 до +100. Но мы игнорируем это. |
