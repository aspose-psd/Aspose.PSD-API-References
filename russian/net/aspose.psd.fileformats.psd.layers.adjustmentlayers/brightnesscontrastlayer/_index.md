...
description: Слой яркости/контрастности.
type: docs
weight: 1680
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
## BrightnessContrastLayer class

Слой яркости/контрастности.
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness) { get; set; } | Получает или устанавливает яркость. Для PS диапазон яркости от -150 до +150. Но мы игнорируем это. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast) { get; set; } | Получает или устанавливает контрастность. Для PS диапазон контрастности от -50 до +100. Но мы игнорируем это. |
