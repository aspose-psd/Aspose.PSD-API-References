...
description: Корректирующий слой кривых
type: docs
weight: 1730
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused) { get; set; } | Получает или задает значение, указывающее, используется ли этот экземпляр диспетчера непрерывности. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused) { get; set; } | Получает или задает значение, указывающее, используется ли данный экземпляр в качестве дискретного диспетчера. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager)() | Получает менеджер кривых. |
