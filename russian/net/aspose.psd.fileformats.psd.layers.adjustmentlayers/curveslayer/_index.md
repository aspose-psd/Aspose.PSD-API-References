...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer класс. Слой корректировки кривых"
type: docs
weight: 1790
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Получает или задает значение, указывающее, используется ли непрерывный менеджер в этом экземпляре. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Получает или задает значение, указывающее, используется ли дискретный менеджер в этом экземпляре. |
