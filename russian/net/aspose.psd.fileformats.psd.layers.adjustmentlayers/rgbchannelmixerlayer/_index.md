...
description: Регулирующий слой Rgb Channel Mixer.
type: docs
weight: 1800
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
## RgbChannelMixerLayer class

Регулирующий слой Rgb Channel Mixer.
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel) { get; } | Получает синий канал. |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel) { get; } | Получает зеленый канал. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel) { get; } | Получает красный канал. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex)(int) | Получает индекс канала по. Возвращает RgbMixerChannel |
