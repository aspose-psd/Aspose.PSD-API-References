...
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer. Слой градиентной карты. Обрабатывает рендеринг градиентной карты, используя данные из GrdmResource"
type: docs
weight: 1810
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | Получает или задает экземпляр настроек градиента, переданный из экземпляра GrdmResource. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | Обновляет данные слоя в связанном ресурсе слоя [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/). |
