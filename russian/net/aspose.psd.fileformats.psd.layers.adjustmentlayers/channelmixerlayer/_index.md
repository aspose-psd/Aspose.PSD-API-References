...
description: Корректирующий слой Channel Mixer.
type: docs
weight: 1690
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
## ChannelMixerLayer class

Корректирующий слой Channel Mixer.
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex)(int) | Получает индекс канала по. Может возвращать RgbMixerChannel или CmykMixerChannel |
