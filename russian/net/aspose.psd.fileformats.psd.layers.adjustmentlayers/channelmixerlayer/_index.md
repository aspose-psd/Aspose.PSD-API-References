...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer класс. Слой корректировки микшера каналов"
type: docs
weight: 1730
...
Слой корректировки Channel Mixer.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Получает или задает значение, указывающее, является ли этот `ChannelMixerLayer` монохромным. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Получает индекс канала. Может вернуть RgbMixerChannel или CmykMixerChannel |
