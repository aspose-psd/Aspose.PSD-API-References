...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BlackWhiteAdjustmentLayer сорт. Класс корректирующего чернобелого слоя.
type: docs
weight: 1670
...
Класс корректирующего черно-белого слоя.
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind/) { get; set; } | Получает или задает значение предустановленного вида черно-белого изображения. |
