...
description: "Свойство BlackWhiteAdjustmentLayer. Получает или задает двойное значение Green Tint Color."
type: docs
weight: 100
...
Получает или задает двойное значение Green Tint Color.
...
Двойное значение Green Tint Color.
