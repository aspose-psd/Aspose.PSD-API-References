...
description: "Свойство BlackWhiteAdjustmentLayer. Получает или задает двойное значение синего оттенка цвета."
type: docs
weight: 90
...
Получает или задает двойное значение Blue Tint Color.
...
Двойное значение синего оттенка цвета.
