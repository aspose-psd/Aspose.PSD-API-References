...
description: BlackWhiteAdjustmentLayer свойство. Получает или задает двойное значение цвета синего оттенка.
type: docs
weight: 90
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/
---
## BlackWhiteAdjustmentLayer.TintColorBlue property

Получает или задает двойное значение цвета синего оттенка.
...
Двойное значение цвета синего оттенка.
