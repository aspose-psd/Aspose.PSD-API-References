...
description: BlackWhiteAdjustmentLayer свойство. Получает или задает значение зелени.
type: docs
weight: 50
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens/
---
## BlackWhiteAdjustmentLayer.Greens property

Получает или задает значение зелени.
