...
description: "Свойство BlackWhiteAdjustmentLayer. Получает или задает двойное значение Red Tint Color."
type: docs
weight: 110
...
Получает или задает двойное значение Red Tint Color.
...
Двойное значение Red Tint Color.
