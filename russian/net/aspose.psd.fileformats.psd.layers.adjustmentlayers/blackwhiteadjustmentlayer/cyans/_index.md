...
description: BlackWhiteAdjustmentLayer свойство. Получает или задает значение голубого цвета.
type: docs
weight: 40
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans/
---
## BlackWhiteAdjustmentLayer.Cyans property

Получает или задает значение голубого цвета.
