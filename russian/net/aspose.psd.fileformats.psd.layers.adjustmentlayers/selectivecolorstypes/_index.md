---
title: "Перечисление SelectiveColorsTypes"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Перечисление Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorsTypes. Типы цветов в слое корректировки селективного цвета"
type: docs
weight: 1910
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes/
---
{{< psd/tize >}}
## SelectiveColorsTypes enumeration

Типы цветов в слое регулировки выборочного цвета.
...
| --- | --- | --- |
| Reds | `0` | Красные цвета. |
| Yellows | `1` | Желтые цвета. |
| Greens | `2` | Зеленые цвета. |
| Cyans | `3` | Голубые цвета. |
| Blues | `4` | Синие цвета. |
| Magentas | `5` | Пурпурные цвета. |
| Whites | `6` | Белые цвета. |
| Neutrals | `7` | Нейтральные цвета. |
| Blacks | `8` | Черные цвета. |
