---
title: "Класс HueSaturationLayer"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer класс. Слой корректировки HueSaturation"
type: docs
weight: 1820
...
Слой корректировки HueSaturation.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Получает или задает значение, указывающее, является ли этот `HueSaturationLayer` цветовым. |
