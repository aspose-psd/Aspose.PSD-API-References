...
description: корректирующий слой HueSaturation.
type: docs
weight: 1750
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
## HueSaturationLayer class

корректирующий слой HueSaturation.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize) { get; set; } | Получает или задает значение, указывающее, является ли этот[`HueSaturationLayer`](../huesaturationlayer)раскрашиваемым. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue) { get; set; } | Получает или задает оттенок. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness) { get; set; } | Получает или устанавливает яркость. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation) { get; set; } | Получает или задает насыщенность. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange)(int) | Получает диапазон. |
