...
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer. Слой коррекции микшера каналов CMYK"
type: docs
weight: 1740
...
Слой корректировки Cmyk Channel Mixer.
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Получает канал циан. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | Получает канал магента. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Получает или задает значение, указывающее, является ли этот [`ChannelMixerLayer`](../channelmixerlayer/) монохромным. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Получает индекс канала. Возвращает CmykMixerChannel |
