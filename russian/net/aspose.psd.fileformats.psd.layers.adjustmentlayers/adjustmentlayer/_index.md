...
description: Корректирующий слой. Например Яркость/контрастность
type: docs
weight: 1660
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/adjustmentlayer/
---
## AdjustmentLayer class

Корректирующий слой. Например, Яркость/контрастность
