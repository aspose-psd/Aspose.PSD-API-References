...
description: "SelectiveColorLayer метод. Устанавливает cmyk коррекцию по выборочному цвету"
type: docs
weight: 40
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/
---
{{< psd/tize >}}
## SelectiveColorLayer.SetCmykCorrection method

Задает CMYK‑коррекцию по избирательному цвету.
...
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | Тип выборочных цветов. |
| коррекция | CmykCorrection | Cmyk коррекция. |
