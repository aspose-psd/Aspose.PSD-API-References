...
description: "SelectiveColorLayer метод. Получает cmyk коррекцию по выборочному цвету"
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/
---
{{< psd/tize >}}
## SelectiveColorLayer.GetCmykCorrection method

Получает CMYK‑коррекцию по избирательному цвету.
...
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | Выборочные цвета. |
