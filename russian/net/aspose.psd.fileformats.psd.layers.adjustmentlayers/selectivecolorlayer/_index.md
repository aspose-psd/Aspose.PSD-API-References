---
title: "Класс SelectiveColorLayer"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorLayer. Слой корректировки избирательного цвета"
type: docs
weight: 1900
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
{{< psd/tize >}}
## SelectiveColorLayer class

Слой регулировки выборочного цвета.
...
| [CorrectionMethod](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/correctionmethod/) { get; set; } | Получает или задает метод коррекции. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/version/) { get; } | Получает версию. |
...
| [GetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/)(SelectiveColorsTypes) | Получает CMYK‑коррекцию по избирательному цвету. |
...
| [SetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/)(SelectiveColorsTypes, CmykCorrection) | Задает CMYK‑коррекцию по избирательному цвету. |
...
Следующий код демонстрирует поддержку слоя корректировки SelectiveColorLayer.
...
// Получите, проверьте и измените слой корректировки Selective Color из изображения.
using (var image = (PsdImage)Image.Load(sourceFileWithSelectiveColorLayer))
{
    foreach (var layer in image.Layers)
    {
        ...
        {
            // Получить слой корректировки Selective Color.
...
// Добавьте и установите слой корректировки Selective color в изображение.
using (var image = (PsdImage)Image.Load(sourceFileWithoutSelectiveColorLayer))
{
    // Добавить слой корректировки Selective Color.
