---
title: "Класс CmykCorrection"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection. Коррекция цветов в слое корректировки выборочного цвета."
type: docs
weight: 1750
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
## CmykCorrection class

Коррекция цветов в слое корректировки selective color.
...
| Имя | Описание |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | Конструктор по умолчанию. |

## Свойства

| Имя | Описание |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | Получает или задает коррекцию чёрного цвета. |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | Получает или задает коррекцию цвета циан. |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | Получает или задает коррекцию цвета маджента. |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | Получает или задает коррекцию жёлтого цвета. |
