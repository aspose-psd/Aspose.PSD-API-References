...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer сорт. Слой регулировки экспозиции.
type: docs
weight: 1740
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Получает или задает экспозицию. Для PS диапазон экспозиции от -20 до +20. |
