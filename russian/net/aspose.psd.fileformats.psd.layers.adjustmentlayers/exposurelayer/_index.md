...
description: Слой регулировки экспозиции.
type: docs
weight: 1740
url: /ru/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
## ExposureLayer class
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure) { get; set; } | Получает или задает экспозицию. Для PS диапазон экспозиции составляет от -20 до +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection) { get; set; } | Получает или задает гамма-коррекцию. Для PS диапазон GammaCorrection составляет от 9,99 до +0,01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset) { get; set; } | Получает или задает смещение. Для PS диапазон смещения составляет от -0,5 до +0,5 |
