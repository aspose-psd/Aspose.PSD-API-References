...
| override [Equals](../../aspose.psd.fileformats.tiff/tiffsrational/equals)(object) | Определяет, равен ли указанныйObjectэтому экземпляру. |
| override [GetHashCode](../../aspose.psd.fileformats.tiff/tiffsrational/gethashcode)() | Возвращает хэш-код для этого экземпляра. |
| override [ToString](../../aspose.psd.fileformats.tiff/tiffsrational/tostring)() | ВозвращаетString, представляющий этот экземпляр. |

## Поля

| Имя | Описание |
| --- | --- |
| const [Epsilon](../../aspose.psd.fileformats.tiff/tiffsrational/epsilon) | Эпсилон для расчета дроби |
