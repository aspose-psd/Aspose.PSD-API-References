---
title: "Класс ColorTransferFunctionsResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Resources.ColorTransferFunctionsResource. Ресурс передачи цвета"
type: docs
weight: 4140
...
| Имя | Описание |
| --- | --- |
| [ColorTransferFunctionsResource](colortransferfunctionsresource/)() | Конструктор по умолчанию. |

## Свойства

| Имя | Описание |
| --- | --- |
| [ColorTransferData](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/colortransferdata/) { get; set; } | Получает или задает данные передачи цвета. |
