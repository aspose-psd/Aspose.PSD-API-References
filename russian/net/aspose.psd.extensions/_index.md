...
| --- | --- |
| [BrushExtensions](./brushextensions) | Содержит методы расширения для[`Brush`](../aspose.psd/brush) а такжеBrush . |
...
| [ImageAttributesExtensions](./imageattributesextensions) | Содержит методы расширения для[`ImageAttributes`](../aspose.psd/imageattributes) а такжеImageAttributes . |
| [ImageExtensions](./imageextensions) | Содержит методы расширения для преобразования на основеImage а также[`Image`](../aspose.psd/image) . |
| [MatrixExtensions](./matrixextensions) | Содержит[`Matrix`](../aspose.psd/matrix) расширения класса. |
| [PenExtensions](./penextensions) | Содержит методы расширения для[`Pen`](../aspose.psd/pen) а такжеPen . |
| [PointExtensions](./pointextensions) | Содержит методы расширения для[`Point`](../aspose.psd/point) а также[`PointF`](../aspose.psd/pointf) структуры. |
