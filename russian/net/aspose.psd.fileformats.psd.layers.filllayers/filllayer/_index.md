...
description: Залейте слой. Цветная заливка градиентная заливка или слой заливки узором который отличаетсяFillSettings./filllayer/fillsettings
type: docs
weight: 1850
...
Залейте слой. Цветная заливка, градиентная заливка или слой заливки узором, который отличается[`FillSettings`](./fillsettings)
...
| Имя | Описание |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | Создайте новый экземпляр класса[`FillLayer`](../filllayer)по типу заливки. |
