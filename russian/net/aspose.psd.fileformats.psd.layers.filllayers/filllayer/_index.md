...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer сорт. Слой заливки. Слой цветовой заливки градиентной заливки или узорной заливки отличающийсяFillSettings
type: docs
weight: 1910
...
Слой заливки. Слой цветовой заливки, градиентной заливки или узорной заливки, отличающийся[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Получает настройки заливки. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Получает тип заливки. |
...
| Имя | Описание |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Создайте новый экземпляр`FillLayer` класс по типу заливки. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа-канала для сохранения гладких краев. Примечание: если вы используете его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Обновляет данные пикселей слоя заливки в соответствии с фактическими[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* пространство имен [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* сборка [Aspose.PSD](../../)
