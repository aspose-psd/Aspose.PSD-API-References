...
description: Слой заливки. Слой цветовой заливки градиентной заливки или узорной заливки отличающийсяFillSettings./filllayer/fillsettings
type: docs
weight: 1890
...
| Имя | Описание |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | Создайте новый экземпляр[`FillLayer`](../filllayer) класс по типу заливки. |
