...
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer. Слой заполнения. Слой Color Fill, Gradient Fill или Pattern Fill, который отличается параметрами FillSettings"
type: docs
weight: 2020
url: /ru/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
{{< psd/tize >}}
## FillLayer class

Слой заполнения. Слой Color Fill, Gradient Fill или Pattern Fill, который отличается параметрами [`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | Получает или задает параметры заполнения. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Возвращает тип заливки. |
...
| Имя | Описание |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Создайте новый экземпляр класса `FillLayer` по типу заполнения. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края. Примечание: если использовать его для изображений без прозрачности, все цвета будут заменены одним цветом. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Обновляет данные пикселей слоя заливки на основе текущих [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
