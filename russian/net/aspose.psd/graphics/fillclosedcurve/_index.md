...
description: Заполняет внутреннюю часть замкнутой кардинальной сплайновой кривой определяемой массивомPointFaspose.psd/pointf структуры. Этот метод использует натяжение по умолчанию 05 иAlternate режим заполнения.
type: docs
weight: 340
