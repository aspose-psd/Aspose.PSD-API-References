...
description: "Метод Graphics. Рисует дугу, представляющую часть эллипса, заданную парой координат, шириной и высотой."
type: docs
weight: 170
...
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen/) определяет цвет, ширину и стиль дуги. |
...
| startAngle | Single | Угол в градусах, измеряемый по часовой стрелке от оси x до начальной точки дуги. |
| sweepAngle | Single | Угол в градусах, измеряемый по часовой стрелке от параметра *startAngle* до конечной точки дуги. |
...
Рисует дугу, представляющую часть эллипса, заданную структурой [`RectangleF`](../../rectanglef/).
...
| исключение | условие |
| --- | --- |
| ArgumentNullException | *pen* равен null |
...
| startAngle | Int32 | Угол в градусах, измеряемый по часовой стрелке от оси x до начальной точки дуги. |
| sweepAngle | Int32 | Угол в градусах, измеряемый по часовой стрелке от параметра *startAngle* до конечной точки дуги. |
...
Рисует дугу, представляющую часть эллипса, заданную структурой [`Rectangle`](../../rectangle/).
