...
description: Aspose.PSD.StreamContainer сорт. Представляет контейнер потока который содержит поток и предоставляет подпрограммы обработки потока.
type: docs
weight: 5640
...
| Имя | Описание |
| --- | --- |
| [StreamContainer](streamcontainer/#constructor)(Stream) | Инициализирует новый экземпляр`StreamContainer` класс. |
| [StreamContainer](streamcontainer/#constructor_1)(Stream, bool) | Инициализирует новый экземпляр`StreamContainer` класс. |
...
| [explicit operator](../../aspose.psd/streamcontainer/op_explicit/) | Выполняет явное преобразование из`StreamContainer` кStream . |
