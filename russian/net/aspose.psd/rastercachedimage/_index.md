...
description: Aspose.PSD.RasterCachedImage сорт. Представляет растровое изображение поддерживающее операции с растровой графикой. Это изображение кэширует пиксельные данные когда это необходимо.
type: docs
weight: 5310
