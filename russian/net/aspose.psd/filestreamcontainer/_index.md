...
description: Aspose.PSD.FileStreamContainer сорт. Помощник для обработки файлового потока.
type: docs
weight: 4250
...
| virtual [ToBytes](../../aspose.psd/streamcontainer/tobytes/)() | Преобразует потоковые данные вByte массив. |
| virtual [ToBytes](../../aspose.psd/streamcontainer/tobytes/)(long, long) | Преобразует потоковые данные вByte массив. |
...
| [explicit operator](../../aspose.psd/filestreamcontainer/op_explicit/#op_explicit_1) | Выполняет явное преобразование из`FileStreamContainer` кStream . (2 operators) |
