...
description: Aspose.PSD.Image сорт. Изображение является базовым классом для всех типов изображений.
type: docs
weight: 4590
...
| [Container](../../aspose.psd/image/container/) { get; } | Получает`Image` контейнер. |
