...
description: Ограничивает использование шрифта списком шрифтов. Перед ограничением проверьте имена реальных шрифтов. Установите для списка разрешенных шрифтов значение Null чтобы удалить ограничения .
type: docs
weight: 100
