...
description: Получает наиболее подходящий шрифт для замены. Если все замены не разрешены будет возвращен первый разрешенный и доступный шрифт. Если доступных шрифтов нет будет возвращен шрифт из arguments
type: docs
weight: 70
