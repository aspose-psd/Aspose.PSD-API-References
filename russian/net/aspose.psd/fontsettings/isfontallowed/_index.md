...
description: FontSettings метод. Определяет разрешен ли шрифт указанное имя шрифта.
type: docs
weight: 80
...
`истинный` если [разрешен ли шрифт] [указанное имя шрифта]; в противном случае,`ЛОЖЬ` .
