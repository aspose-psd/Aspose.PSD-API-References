...
description: SplitStreamContainer свойство. Получает или задает длину потока в байтах. Это значение меньше чемLengthпо начальной позиции потока переданной в конструкторе StreamContainer.
type: docs
weight: 50
