...
description: Указывает содержится ли указанная точка внутри под контура этогоGraphicsPathaspose.psd/graphicspathпри рисовании с указаннымPenaspose.psd/pen.
type: docs
weight: 110
