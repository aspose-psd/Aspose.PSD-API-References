...
description: Создает новыйRectangleaspose.psd/rectangleиз двух указанных точек. Две вершины созданногоRectangleaspose.psd/rectangleбудут равны переданнымpoint1иpoint2. Обычно это противоположные вершины.
type: docs
weight: 40
