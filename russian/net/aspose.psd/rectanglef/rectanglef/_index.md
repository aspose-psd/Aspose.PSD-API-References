...
description: RectangleF строитель. Инициализирует новый экземплярRectangleF структура с указанным расположением и размером.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`RectangleF`](../) структура с указанным расположением и размером.
