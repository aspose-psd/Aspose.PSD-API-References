...
description: Инициализирует новый экземпляр структурыRectangleFaspose.psd/rectanglefс указанным расположением и размером.
type: docs
weight: 10
...
| size | SizeF | A[`SizeF`](../../sizef)представляет ширину и высоту прямоугольной области. |
