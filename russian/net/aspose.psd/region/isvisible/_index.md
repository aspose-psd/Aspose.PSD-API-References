...
Истинно, когда указанная точка содержится внутри этого[`Region`](../../region); в противном случае ложно.
...
true, когда указанная точка содержится внутри этого[`Region`](../../region); в противном случае ложно.
...
Проверяет, содержится ли какая-либо часть указанной[`Rectangle`](../../rectangle)структуры в этомРегион.
...
Проверяет, содержится ли какая-либо часть указанной[`Rectangle`](../../rectangle)структуры в этом[`Region`](../../region)при рисовании с использованием указанного[`Graphics`](../../graphics).
