...
description: Обновляет этотRegionaspose.psd/region чтобы он содержал только ту часть его внутренней части которая не пересекается с указаннымRectangleFaspose.psd/rectanglefструктура.
type: docs
weight: 50
