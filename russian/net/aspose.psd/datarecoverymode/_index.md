...
| MaximalRecover | `2` | Максимальный режим восстановления восстанавливает все данные, даже если формат файла имеет поврежденную структуру, и дальнейшая обработка может привести к нежелательным эффектам. |
