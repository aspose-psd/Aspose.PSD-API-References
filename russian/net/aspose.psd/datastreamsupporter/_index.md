...
| virtual [Save](../../aspose.psd/datastreamsupporter/save#save)() | Сохраняет данные объекта в текущий[`DataStreamSupporter`](../datastreamsupporter). |
| [Save](../../aspose.psd/datastreamsupporter/save#save_1)(Stream) | Сохраняет данные объекта в указанный поток. |
