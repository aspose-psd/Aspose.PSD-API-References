...
description: ПолучаетPixelDataFormataspose.psd/pixeldataformat определено для 16 бит на пиксель с 5 битами для каждого из красного зеленого и синего альфа не определена.
type: docs
weight: 50
