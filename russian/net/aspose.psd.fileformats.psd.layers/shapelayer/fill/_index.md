...
description: "Свойство ShapeLayer. Получает или задает настройки Fill для внутренней области фигур в слое Shape"
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers/shapelayer/fill/
---
{{< psd/tize >}}
## ShapeLayer.Fill property

Получает или задает настройки заливки для внутренней области фигур в слое Shape.
...
Следующий код демонстрирует свойство Fill класса ShapeLayer.
