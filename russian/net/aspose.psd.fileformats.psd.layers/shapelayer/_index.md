...
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer. Слой Shape. Инкапсулирует логику работы со слоем Shape и связанными ресурсами."
type: docs
weight: 3820
url: /ru/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

Слой Shape. Инкапсулирует логику работы с слоем Shape и связанными ресурсами.
...
| Имя | Описание |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Инициализирует новый экземпляр класса `ShapeLayer`. Все ресурсы создаются в их состоянии по умолчанию. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Получает или задает настройки заливки для внутренней области фигур в слое Shape. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Получает набор путей, присутствующих в слое Shape. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Получает или задает настройки обводки фигур. |
...
| Имя | Описание |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Создает новый экземпляр класса `ShapeLayer`. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Обновляет ресурсы из свойств слоя Shape. |
