...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerHashCalculator сорт. Калькулятор хэшей для слоев PSD. Его можно использовать для поиска одинаковых или разных слоев в разных файлах PSD
type: docs
weight: 2230
...
Калькулятор хэшей для слоев PSD. Его можно использовать для поиска одинаковых или разных слоев в разных файлах PSD
...
| Имя | Описание |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator/)(Layer) | Инициализирует новый экземпляр`LayerHashCalculator` класс. |
