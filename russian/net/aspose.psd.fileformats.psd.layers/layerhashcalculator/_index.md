...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerHashCalculator class. Калькулятор хэшей для слоёв PSD. Может использоваться для поиска одинаковых или разных слоёв в разных PSD‑файлах."
type: docs
weight: 2430
...
Калькулятор хешей для слоёв PSD. Может использоваться для поиска одинаковых или разных слоёв в разных файлах PSD.
...
| Имя | Описание |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator/)(Layer) | Инициализирует новый экземпляр класса `LayerHashCalculator`. |

## Методы

| Имя | Описание |
| --- | --- |
| [GetBlendingHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getblendinghash/)() | Получает хэш смешивания. |
| [GetChannelsHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getchannelshash/)() | Получает хэш каналов. |
| [GetContentHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getcontenthash/)() | Получает хеш содержимого. |
