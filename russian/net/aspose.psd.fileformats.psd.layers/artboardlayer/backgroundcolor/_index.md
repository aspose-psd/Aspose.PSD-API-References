...
description: "Свойство ArtboardLayer. Возвращает или задаёт цвет фона артборда."
type: docs
weight: 10
url: /ru/net/aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/
---
{{< psd/tize >}}
## ArtboardLayer.BackgroundColor property

Получает или задает цвет фона артборда.
