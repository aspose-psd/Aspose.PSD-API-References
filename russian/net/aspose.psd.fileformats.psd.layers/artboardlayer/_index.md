---
title: "Класс ArtboardLayer"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer class. Класс слоя артборда"
type: docs
weight: 1990
url: /ru/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Получает или задает цвет фона артборда. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Получает или задает ключ режима смешивания. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | Получает или задает значение, указывающее, имеет ли `ArtboardLayer` цвет фона. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Получает или задает, открыт ли каталог; если установить `true`, группа будет в открытом состоянии при запуске, иначе — в свернутом. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Получает слои в группе слоёв |
...
| Имя | Описание |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Добавляет слой в группу слоёв. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Добавляет группу слоёв. |
