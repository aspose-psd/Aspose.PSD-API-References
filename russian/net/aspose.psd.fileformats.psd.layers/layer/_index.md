...
| Имя | Описание |
| --- | --- |
| [Layer](layer#constructor)() | Инициализирует новый экземпляр[`Layer`](../layer) учебный класс. Конструктор для ленивой инициализации. |
| [Layer](layer#constructor_3)(Stream) | Инициализирует новый экземпляр[`Layer`](../layer) класс. |
| [Layer](layer#constructor_1)(RasterImage, bool) | Инициализирует новый экземпляр[`Layer`](../layer) класс. |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Инициализирует новый экземпляр[`Layer`](../layer) класс из байтовых массивов. |
