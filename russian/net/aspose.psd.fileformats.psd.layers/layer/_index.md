...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer сорт. PSDслой.
type: docs
weight: 2080
...
| Имя | Описание |
| --- | --- |
| [Layer](layer/#constructor)() | Инициализирует новый экземпляр`Layer` сорт. Конструктор для ленивой инициализации. |
| [Layer](layer/#constructor_3)(Stream) | Инициализирует новый экземпляр`Layer` класс. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Инициализирует новый экземпляр`Layer` класс. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Инициализирует новый экземпляр`Layer` класс из байтовых массивов. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Сохраняет данные объекта в указанном месте файла. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Сохраняет данные объекта в указанном месте файла в указанном формате файла в соответствии с параметрами сохранения. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Сохраняет данные изображения в указанный поток в указанном формате файла в соответствии с параметрами сохранения. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Сохраняет данные объекта в указанном месте файла в указанном формате файла в соответствии с параметрами сохранения. |
...
| Имя | Описание |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Представляет сигнатуру режима наложения. |
