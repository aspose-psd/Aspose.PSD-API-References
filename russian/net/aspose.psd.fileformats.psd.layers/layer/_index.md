...
| Имя | Описание |
| --- | --- |
| [Layer](layer#constructor)() | Инициализирует новый экземпляр класса[`Layer`](../layer). Конструктор для ленивой инициализации. |
| [Layer](layer#constructor_3)(Stream) | Инициализирует новый экземпляр класса[`Layer`](../layer). |
| [Layer](layer#constructor_1)(RasterImage, bool) | Инициализирует новый экземпляр класса[`Layer`](../layer). |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Инициализирует новый экземпляр класса[`Layer`](../layer)из байтовых массивов. |
