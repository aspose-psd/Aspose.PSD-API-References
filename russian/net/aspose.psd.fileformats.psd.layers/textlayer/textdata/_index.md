...
description: Получает части текста.
type: docs
weight: 60
url: /ru/net/aspose.psd.fileformats.psd.layers/textlayer/textdata/
---
...
Следующий код демонстрирует, как Aspose.PSD получает свойства встроенное форматирование текстового слоя.
