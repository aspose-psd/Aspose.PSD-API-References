...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer сорт. Текстовый слой class
type: docs
weight: 3560
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Изменяет размер изображения. По умолчаниюLeftTopToLeftTopиспользуется. |
