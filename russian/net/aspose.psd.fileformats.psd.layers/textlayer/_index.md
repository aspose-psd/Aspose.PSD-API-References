...
description: "Aspose.PSD.FileFormats.Psd.Layers.TextLayer class. Класс текстового слоя"
type: docs
weight: 3980
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Получает или задает ограничивающий прямоугольник текста. |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | Получает или задает параметры Warp, которые были установлены или получены из ресурса (по умолчанию). |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Изменяет размер изображения. Используется значение по умолчанию LeftTopToLeftTop. |
