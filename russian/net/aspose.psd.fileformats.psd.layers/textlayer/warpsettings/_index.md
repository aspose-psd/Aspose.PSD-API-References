...
description: "Свойство TextLayer. Получает или задает параметры Warp, которые были получены или заданы из ресурса по умолчанию"
type: docs
weight: 80
url: /ru/net/aspose.psd.fileformats.psd.layers/textlayer/warpsettings/
---
{{< psd/tize >}}
