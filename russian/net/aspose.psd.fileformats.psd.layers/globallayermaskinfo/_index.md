...
description: Маска глобального слоя.
type: docs
weight: 1990
...
| [Kind](../../aspose.psd.fileformats.psd.layers/globallayermaskinfo/kind) { get; set; } | Получает или задает вид. 0 = выбранный цвет -- т.е. инвертированный; 1 = защищенный цвет; 128 = использовать значение, сохраненное для каждого слоя. Это значение является предпочтительным. Остальные предназначены для обратной совместимости с бета-версиями. |
...
| [Opacity](../../aspose.psd.fileformats.psd.layers/globallayermaskinfo/opacity) { get; set; } | Получает или устанавливает непрозрачность глобальных слоев. 0 = прозрачный, 100 = непрозрачный. |
