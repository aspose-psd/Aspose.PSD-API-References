...
description: Слойразделитель раздела для обозначения границ папки группы слоев.
type: docs
weight: 3350
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup)() | Получает[`LayerGroup`](../layergroup) это связано с этим[`SectionDividerLayer`](../sectiondividerlayer) экземпляр. |
