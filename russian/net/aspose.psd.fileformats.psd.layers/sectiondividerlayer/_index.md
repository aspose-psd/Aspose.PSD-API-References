...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer сорт. Слойразделитель раздела для обозначения границ папки группы слоев.
type: docs
weight: 3410
...
Слой-разделитель раздела для обозначения границ папки (группы слоев).
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Получает[`LayerGroup`](../layergroup/) это связано с этим`SectionDividerLayer` экземпляр. |
