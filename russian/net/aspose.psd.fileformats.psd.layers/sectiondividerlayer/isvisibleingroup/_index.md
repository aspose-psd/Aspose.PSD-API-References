...
description: SectionDividerLayer свойство. Получает значение указывающее виден ли этот экземпляр в группе если слой не входит в группу это означает корневую группу.
type: docs
weight: 10
