...
description: "Свойство SectionDividerLayer. Возвращает значение, указывающее, видим ли этот экземпляр в группе. Если слой не находится в группе, это означает корневую группу"
type: docs
weight: 10
...
`true`, если этот экземпляр видим в группе; иначе `false`.
