...
description: Группа слоев класса
type: docs
weight: 2160
url: /ru/net/aspose.psd.fileformats.psd.layers/layergroup/
---
## LayerGroup class
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey) { get; set; } | Получает или задает ключ режима наложения. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height) { get; } | Получает высоту группы слоев. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen) { get; set; } | Получает или устанавливает открыта ли папка если установлено` true` than group будет в открытом состоянии при запуске, в противном случае в свернутом состоянии. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers) { get; } | Получает слои в группе слоев |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width) { get; } | Получает ширину группы слоев. |
...
| Имя | Описание |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer)(Layer) | Добавляет слой в группу слоев. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup)(string, int) | Добавляет группу слоев. |
...
Следующий пример демонстрирует, как можно изменить LayerGroup видимость в Aspose.PSD
