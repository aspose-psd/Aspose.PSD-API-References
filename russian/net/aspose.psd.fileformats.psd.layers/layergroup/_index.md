...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup сорт. Групповой слой class
type: docs
weight: 2220
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Получает или устанавливает открыта ли папка , если установлено значение`истинный` чем группа будет в открытом состоянии при запуске, иначе в свернутом состоянии. |
