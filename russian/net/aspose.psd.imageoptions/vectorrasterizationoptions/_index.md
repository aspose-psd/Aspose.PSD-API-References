---
title: "Класс VectorRasterizationOptions"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.ImageOptions.VectorRasterizationOptions. Параметры векторной растеризации"
type: docs
weight: 5470
...
Параметры векторного растеризования.
