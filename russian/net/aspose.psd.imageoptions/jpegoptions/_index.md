...
description: Aspose.PSD.ImageOptions.JpegOptions сорт. Параметры создания файла формата jpeg.
type: docs
weight: 4840
...
| Имя | Описание |
| --- | --- |
| [JpegOptions](jpegoptions/#constructor)() | Инициализирует новый экземпляр`JpegOptions` класс. |
| [JpegOptions](jpegoptions/#constructor_1)(JpegOptions) | Инициализирует новый экземпляр`JpegOptions` класс. |
