---
title: "Класс BaseGradient"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient класс. Класс определения базового градиента. Содержит общие свойства для обоих типов градиентов: Solid и Noise."
type: docs
weight: 2190
url: /ru/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| Имя | Описание |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | Получает режим для этого градиента. Определяет 'Gradient Type' = 'Solid/Noise' (0/1). |
