...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VibAResource сорт. Ресурс VibA.
type: docs
weight: 3350
...
| Имя | Описание |
| --- | --- |
| [VibAResource](vibaresource/)() | Инициализирует новый экземпляр`VibAResource` класс. |
