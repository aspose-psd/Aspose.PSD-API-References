...
description: ISmartObjectLayerResource свойство. Получает или задает уникальный идентификатор данных слоя этого смартобъекта в изображении PSD.
type: docs
weight: 10
...
Получает или задает уникальный идентификатор данных слоя этого смарт-объекта в изображении PSD.
...
* пространство имен [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../ismartobjectlayerresource/)
* сборка [Aspose.PSD](../../../)
