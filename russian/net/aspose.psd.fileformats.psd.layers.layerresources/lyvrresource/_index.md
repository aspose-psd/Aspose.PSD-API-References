---
title: "Класс LyvrResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource. Ресурс, представляющий версию Photoshop слоя"
type: docs
weight: 3150
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class
...
| Имя | Описание |
| --- | --- |
| [LyvrResource](lyvrresource/)() | Конструктор по умолчанию. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | Получает или задает версию Photoshop слоя. |

## Методы

| Имя | Описание |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | Сохраняет ресурс в указанный контейнер потока. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | Ключ информации о типе инструмента. |
