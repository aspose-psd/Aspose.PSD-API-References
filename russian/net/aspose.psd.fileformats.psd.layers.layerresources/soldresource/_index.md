...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource сорт. Определяет класс SoLdResource который содержит информацию о слое смартобъектов в файле PSD. Используется для поддержки слоев смартобъектов в изображениях Adobe Photoshop.
type: docs
weight: 3020
