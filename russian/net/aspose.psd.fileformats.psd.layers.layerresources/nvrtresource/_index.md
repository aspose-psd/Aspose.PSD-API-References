...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.NvrtResource сорт. Класс NvrtResource. Ресурс инвертированного корректирующего слоя.
type: docs
weight: 2840
...
| Имя | Описание |
| --- | --- |
| [NvrtResource](nvrtresource/#constructor)() | Инициализирует новый экземпляр`NvrtResource` класс. |
| [NvrtResource](nvrtresource/#constructor_1)(byte[]) | Инициализирует новый экземпляр`NvrtResource` класс. |
