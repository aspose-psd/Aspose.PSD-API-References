...
description: FilterEffectMaskData строитель. Инициализирует новый экземплярFilterEffectMaskData класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`FilterEffectMaskData`](../) класс.
