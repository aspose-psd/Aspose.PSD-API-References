...
description: Класс ЛевлРесаурце. Ресурс корректирующего слоя экспозиции
type: docs
weight: 2620
...
| Имя | Описание |
| --- | --- |
| [LevlResource](levlresource#constructor)() | Инициализирует новый экземпляр[`LevlResource`](../levlresource) класс. |
| [LevlResource](levlresource#constructor_1)(byte[]) | Инициализирует новый экземпляр[`LevlResource`](../levlresource) class. Поддерживается в режимах GrayScale, Duotone, RGB, CMYK, Lab. 2 байта - Версия (=3) 2 байта - Счетчик общего уровня record 10 * (Общий счет - 29) Нулевой конец ресурса Lvls должен быть сложен на четыре too |
