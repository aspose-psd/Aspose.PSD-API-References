...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.CgEdResource сорт. Класс CgEdResource. Дополнительные данные генератора контента Photoshop CS5
type: docs
weight: 2350
...
| Имя | Описание |
| --- | --- |
| [Auto](../../aspose.psd.fileformats.psd.layers.layerresources/cgedresource/auto/) { get; set; } | Получает или задает значение, указывающее, является ли это`CgEdResource` автоматически. |
