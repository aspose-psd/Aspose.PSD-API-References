...
description: "Свойство LmskResource. Возвращает компонент цвета 4"
type: docs
weight: 50
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent4/
---
{{< psd/tize >}}
## LmskResource.ColorComponent4 property

Получает четвертый компонент цвета.
