...
description: "Свойство LmskResource. Возвращает цветовой компонент 2"
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent2/
---
{{< psd/tize >}}
## LmskResource.ColorComponent2 property

Получает второй компонент цвета.
