...
description: "Свойство LmskResource. Возвращает компонент цвета 1"
type: docs
weight: 20
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent1/
---
{{< psd/tize >}}
## LmskResource.ColorComponent1 property

Получает первый компонент цвета.
