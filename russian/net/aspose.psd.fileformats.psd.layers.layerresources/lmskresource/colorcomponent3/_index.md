...
description: "Свойство LmskResource. Возвращает компонент цвета 3"
type: docs
weight: 40
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent3/
---
{{< psd/tize >}}
## LmskResource.ColorComponent3 property

Получает третий компонент цвета.
