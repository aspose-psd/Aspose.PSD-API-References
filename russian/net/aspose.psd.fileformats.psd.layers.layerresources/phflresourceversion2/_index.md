...
| Имя | Описание |
| --- | --- |
| [PhflResourceVersion2](phflresourceversion2#constructor)() | Инициализирует новый экземпляр[`PhflResourceVersion2`](../phflresourceversion2) класс. |
| [PhflResourceVersion2](phflresourceversion2#constructor_1)(byte[]) | Инициализирует новый экземпляр[`PhflResourceVersion2`](../phflresourceversion2) класс. |
