...
description: CmlsResource метод. Сохраняет ресурс в указанный контейнер потока.
type: docs
weight: 60
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/save/
---
