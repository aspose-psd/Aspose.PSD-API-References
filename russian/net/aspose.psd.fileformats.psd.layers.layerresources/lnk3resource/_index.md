...
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.LayerResources.Lnk3Resource. Определяет класс, который содержит информацию о встроенном файле в изображении PSD формата 32 бита на канал. Ресурс ссылки может содержать несколько экземпляров LiFdDataSource, к которым можно получить доступ через индексатор."
type: docs
weight: 3040
...
Определяет класс, который содержит информацию о встроенном файле в изображении PSD формата 32 бита на канал. Ресурс ссылки может содержать несколько экземпляров [`LiFdDataSource`](../lifddatasource/), к которым можно получить доступ через индексатор.
...
| Имя | Описание |
| --- | --- |
| [Lnk3Resource](lnk3resource/)() | Инициализирует новый экземпляр класса `Lnk3Resource`. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lnk3resource/typetoolkey/) | Ключ информации о типе инструмента. |
