...
description: "Свойство LinkResource. Возвращает LinkDataSource по указанному индексу, который является уникальным идентификатором link‑источника данных"
type: docs
weight: 30
...
Возвращает [`LinkDataSource`](../../linkdatasource/) по указанному индексу, который является уникальным идентификатором link‑источника данных..
...
| Параметр | Описание |
| --- | --- |
| index | Индекс как уникальный идентификатор link‑источника данных. |
...
Элемент [`LinkDataSource`](../../linkdatasource/).
