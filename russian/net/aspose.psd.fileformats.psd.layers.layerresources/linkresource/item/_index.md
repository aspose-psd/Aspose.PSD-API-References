...
description: LinkResource свойство. ПолучаетLinkDataSource по указанному индексу который является уникальным идентификатором источника данных ссылки..
type: docs
weight: 30
...
| Параметр | Описание |
| --- | --- |
| index | Индекс как уникальный идентификатор источника данных ссылки. |
