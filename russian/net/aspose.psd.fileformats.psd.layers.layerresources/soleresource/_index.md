...
description: Определяет класс SoLeResource который содержит информацию о слое смартобъектов в файле PSD. Используется для поддержки слоев смартобъектов с внешними ссылками на файлы в изображениях Adobe Photoshop.
type: docs
weight: 3000
...
| Имя | Описание |
| --- | --- |
| [SoLeResource](soleresource#constructor)() | Инициализирует новый экземпляр[`SoLeResource`](../soleresource) класс. |
| [SoLeResource](soleresource#constructor_1)(Guid, bool, bool) | Инициализирует новый экземпляр[`SoLeResource`](../soleresource) класс. |
