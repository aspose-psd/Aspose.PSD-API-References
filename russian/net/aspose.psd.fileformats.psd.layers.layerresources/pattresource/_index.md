...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PattResource сорт. Класс PattResource. Ресурс с шаблоном data
type: docs
weight: 2870
...
| Имя | Описание |
| --- | --- |
| [PattResource](pattresource/#constructor)() | Инициализирует новый экземпляр`PattResource` класс. |
| [PattResource](pattresource/#constructor_1)(int, PattResourceData[]) | Инициализирует новый экземпляр`PattResource` класс. |
