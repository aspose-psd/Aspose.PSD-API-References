...
Следующий пример демонстрирует поддержку обработки векторных масок слоя. Как работает редактирование контуров и как Aspose.PSD рисует финальное изображение.
