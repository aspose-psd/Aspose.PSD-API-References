...
description: Инициализирует новый экземпляр классаVsmsResourceaspose.psd.fileformats.psd.layers.layerresources/vsmsresource.
type: docs
weight: 10
...
Инициализирует новый экземпляр класса[`VsmsResource`](../../vsmsresource).
