...
description: Инициализирует новый экземплярVsmsResourceaspose.psd.fileformats.psd.layers.layerresources/vsmsresource класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`VsmsResource`](../../vsmsresource) класс.
