---
title: "Класс VsmsResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VsmsResource класс. Класс VsmsResource. Этот ресурс содержит информацию о векторной маске слоя"
type: docs
weight: 3780
...
| Имя | Описание |
| --- | --- |
| [VsmsResource](vsmsresource/#constructor)() | Инициализирует новый экземпляр класса `VsmsResource`. |
| [VsmsResource](vsmsresource/#constructor_1)(byte[]) | Инициализирует новый экземпляр класса `VsmsResource`. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/typetoolkey/) | Ключ информации о типе инструмента. |
