...
description: "Свойство LiFdDataSource. Получает или задает встроенные данные смарт-объекта в файле PSD"
type: docs
weight: 20
...
Получает или задаёт данные встроенного смарт-объекта в файле PSD.
...
Встроенные данные смарт-объекта.
