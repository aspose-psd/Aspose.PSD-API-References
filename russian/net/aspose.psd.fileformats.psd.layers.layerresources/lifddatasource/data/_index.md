...
description: LiFdDataSource свойство. Получает или задает встроенные данные смартобъекта в файле PSD.
type: docs
weight: 20
...
Получает или задает встроенные данные смарт-объекта в файле PSD.
...
Данные встроенного смарт-объекта.
