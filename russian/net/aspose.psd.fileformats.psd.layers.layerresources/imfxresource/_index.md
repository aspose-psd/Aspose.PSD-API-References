---
title: "Класс ImfxResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ImfxResource class. Ресурс Imfx, ресурс многократных эффектов."
type: docs
weight: 2850
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/imfxresource/
---
{{< psd/tize >}}
## ImfxResource class

Ресурс Imfx (ресурс мульти-эффектов)
...
| Имя | Описание |
| --- | --- |
| [ImfxResource](imfxresource/)() | Конструктор по умолчанию. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/imfxresource/typetoolkey/) | Ключ информации о типе инструмента. |
