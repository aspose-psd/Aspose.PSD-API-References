---
title: "Класс ArtBResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtBResource. Информация о Artboard для Resources"
type: docs
weight: 2520
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/
---
{{< psd/tize >}}
## ArtBResource class

Информация о Artboard для [`Resources`](../../aspose.psd.fileformats.psd.layers/layer/resources/).
...
| Имя | Описание |
| --- | --- |
| [ArtBResource](artbresource/)() | Конструктор по умолчанию. |

## Свойства

| Имя | Описание |
| --- | --- |
| [ArtboardBackgroundType](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/artboardbackgroundtype/) { get; set; } | Получает или задает [`ArtboardBackgroundType`](./artboardbackgroundtype/) |
| [Color](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/color/) { get; set; } | Получает или задает [`Color`](./color/) |
| [Items](../../aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/) { get; set; } | Получает или задает элементы [`OSTypeStructure`](../ostypestructure/). |
...
| Имя | Описание |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/save/)(StreamContainer, int) | Сохраняет ресурс в указанный контейнер потока. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/typetoolkey/) | Ключ информации о типе инструмента. |

## Примеры

Следующий код демонстрирует поддержку ресурсов Artboard.
