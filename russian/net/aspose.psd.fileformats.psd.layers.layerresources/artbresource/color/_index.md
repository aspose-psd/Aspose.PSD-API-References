...
description: "Свойство ArtBResource. Получает или задаёт цвет"
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/color/
---
{{< psd/tize >}}
## ArtBResource.Color property

Получает или задаёт `Color`
