...
description: BlwhResource свойство. Получает или задает имя файла предустановленных чернобелых изображений.
type: docs
weight: 20
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/blwhresource/blackandwhitepresetfilename/
---
