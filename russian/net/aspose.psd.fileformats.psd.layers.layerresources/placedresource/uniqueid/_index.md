...
description: PlacedResource свойство. Получает или задает глобальный уникальный идентификатор размещенного слоя в изображении PSD.
type: docs
weight: 180
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/uniqueid/
---
## PlacedResource.UniqueId property

Получает или задает глобальный уникальный идентификатор размещенного слоя в изображении PSD.
