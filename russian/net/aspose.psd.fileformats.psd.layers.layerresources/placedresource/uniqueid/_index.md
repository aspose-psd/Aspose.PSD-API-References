...
description: "Свойство PlacedResource. Получает или задаёт глобальный уникальный идентификатор размещённого слоя в изображении PSD"
type: docs
weight: 170
...
Уникальный идентификатор размещённого слоя.
