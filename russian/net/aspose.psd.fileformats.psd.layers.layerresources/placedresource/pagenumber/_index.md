...
description: PlacedResource свойство. Получает или задает номер страницы размещенного слоя в файле PSD.
type: docs
weight: 90
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/pagenumber/
---
