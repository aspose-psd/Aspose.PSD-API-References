...
description: PostResource метод. Сохраняет ресурс в указанный контейнер потока.
type: docs
weight: 70
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/postresource/save/
---
