...
description: LiFeDataSource свойство. Получает или задает AdobeStockId графической библиотеки для библиотек Adobe Photoshop CC Libraries.
type: docs
weight: 20
...
Графическая библиотека Adobe Stock Identifier.

### Исключения

| исключение | условие |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Вы не можете получить доступ к свойству AdobeStockId, оно доступно только для источника данных liFE, когда IsLibrary имеет значение true |
