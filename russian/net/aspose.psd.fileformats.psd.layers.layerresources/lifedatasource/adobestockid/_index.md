...
description: "Свойство LiFeDataSource. Получает или задает идентификатор AdobeStockId графической библиотеки для Adobe Photoshop CC Libraries"
type: docs
weight: 20
...
Получает или задаёт идентификатор библиотеки графики AdobeStockId для библиотек Adobe® Photoshop® CC.
...
Идентификатор Adobe Stock графической библиотеки.

### Исключения

| исключение | условие |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Вы не можете получить доступ к свойству AdobeStockId, оно доступно только для источника данных liFE, когда IsLibrary равно true |
