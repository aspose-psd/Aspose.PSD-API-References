...
description: LiFeDataSource свойство. Получает или задает относительный путь внешнего файла в источнике данных LiFE ресурса PSD LnkE.
type: docs
weight: 100
...
Получает или задает относительный путь внешнего файла в источнике данных LiFE ресурса PSD LnkE.
