...
description: "Свойство LiFeDataSource. Получает или задает полный путь к внешнему файлу в источнике данных LiFE ресурса PSD LnkE"
type: docs
weight: 90
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
{{< psd/tize >}}
...
| исключение | условие |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Вы не можете получить доступ к свойству FullPath, оно доступно только для источника данных liFE |
