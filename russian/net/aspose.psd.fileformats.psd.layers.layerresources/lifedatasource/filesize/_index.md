...
description: "Свойство LiFeDataSource. Получает или задает размер внешнего файла в источнике данных LiFE ресурса PSD LnkE"
type: docs
weight: 80
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
{{< psd/tize >}}
...
| исключение | условие |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Вы не можете получить доступ к свойству FileSize, оно доступно только для источника данных liFE |
