...
description: "Свойство LiFeDataSource. Получает или задает ссылку на элемент графической библиотеки для Adobe Photoshop CC Libraries"
type: docs
weight: 60
...
Ссылка на элемент графической библиотеки.

### Исключения

| исключение | условие |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Вы не можете получить доступ к свойству ElementRef, оно доступно только для источника данных liFE, когда IsLibrary равно true |
