...
description: LiFeDataSource свойство. Получает или задает ссылку на элемент графической библиотеки для библиотек Adobe Photoshop CC Libraries.
type: docs
weight: 60
...
| исключение | условие |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Вы не можете получить доступ к свойству ElementRef, оно доступно только для источника данных liFE, когда IsLibrary имеет значение true |
