...
description: Определяет класс LnkeDataSource который содержит информацию о внешнем связанном файле. Это часть API управления форматом файлов PSD который помогает изменять файлы Adobe Photoshop
type: docs
weight: 2620
...
Определяет класс LnkeDataSource, который содержит информацию о внешнем связанном файле. Это часть API управления форматом файлов PSD, который помогает изменять файлы Adobe® Photoshop®
...
| Имя | Описание |
| --- | --- |
| [LiFeDataSource](lifedatasource#constructor)() | Инициализирует новый экземпляр класса[`LiFeDataSource`](../lifedatasource). |
| [LiFeDataSource](lifedatasource#constructor_1)(int, Guid, string, string, string) | Инициализирует новый экземпляр класса[`LiFeDataSource`](../lifedatasource). |

## Характеристики

| Имя | Описание |
| --- | --- |
| [AdobeStockId](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid) { get; set; } | Получает или задает AdobeStockId графической библиотеки для библиотек Adobe® Photoshop® CC. |
...
| [ElementName](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname) { get; set; } | Получает или задает имя элемента графической библиотеки для библиотек Adobe® Photoshop® CC. |
| [ElementRef](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref) { get; set; } | Получает или задает ссылку на элемент графической библиотеки для библиотек Adobe® Photoshop® CC. |
...
| [FileName](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filename) { get; set; } | Получает или задает имя внешнего или встроенного файла в ресурсе ссылок PSD. |
...
Этот пример демонстрирует, как получить и установить свойства ресурса Psd LnkE.
