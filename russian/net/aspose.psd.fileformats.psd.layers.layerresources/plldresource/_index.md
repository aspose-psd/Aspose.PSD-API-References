---
title: "Класс PlLdResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlLdResource. Определяет класс PlLdResource, который содержит информацию о размещённом слое в файле PSD. Он используется для поддержки слоёв смарт‑объектов в изображениях Adobe Photoshop. Был заменён на SoLdResource в Adobe Photoshop CS3."
type: docs
weight: 3270
...
Определяет класс PlLdResource, который содержит информацию о размещённом слое в файле PSD. Используется для поддержки слоёв смарт‑объектов в изображениях Adobe® Photoshop®. Был заменён классом SoLdResource в Adobe® Photoshop® CS3.
...
| Имя | Описание |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/save/)(StreamContainer, int) | Сохраняет ресурс PlLD в указанный потоковый контейнер. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/typetoolkey/) | Ключ информации о типе инструмента. |
