...
description: "Свойство BaseArtboardInfoResource. Возвращает или задает элементы OSTypeStructure"
type: docs
weight: 10
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/
---
{{< psd/tize >}}
## BaseArtboardInfoResource.Items property

Возвращает или задает элементы [`OSTypeStructure`](../../ostypestructure/).
