---
title: "Класс AbddResource"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.AbddResource класс. Данные информации о рабочей области."
type: docs
weight: 2490
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/abddresource/
---
{{< psd/tize >}}
## AbddResource class

Данные информации о рабочей области.
...
| Имя | Описание |
| --- | --- |
| [AbddResource](abddresource/)() | Конструктор по умолчанию. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/abddresource/typetoolkey/) | Ключ информации о типе инструмента. |
