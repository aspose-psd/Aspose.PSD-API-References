...
description: "Свойство SmartObjectResource. Получает или задает общее количество страниц данных слоя умного объекта в файле PSD"
type: docs
weight: 200
...
Общее количество страниц данных слоя умного объекта.
