...
description: SmartObjectResource свойство. Получает или задает общее количество страниц данных слоя смартобъекта в PSDфайле.
type: docs
weight: 220
...
Получает или задает общее количество страниц данных слоя смарт-объекта в PSD-файле.
...
Общее количество страниц данных слоя смарт-объекта.
