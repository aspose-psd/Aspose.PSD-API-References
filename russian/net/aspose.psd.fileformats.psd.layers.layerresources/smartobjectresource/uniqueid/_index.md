...
description: "Свойство SmartObjectResource. Получает или задает глобальный уникальный идентификатор данных слоя умного объекта SmartObjectResource в изображении PSD"
type: docs
weight: 220
...
Получает или задает глобальный уникальный идентификатор данных слоя умного объекта [`SmartObjectResource`](../) в изображении PSD.
...
Глобальный уникальный идентификатор данных слоя умного объекта [`SmartObjectResource`](../).
