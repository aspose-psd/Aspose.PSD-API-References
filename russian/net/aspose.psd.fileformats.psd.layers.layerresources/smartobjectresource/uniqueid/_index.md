...
description: SmartObjectResource свойство. Получает или задает глобальный уникальный идентификатор данных слоя смартобъекта.SmartObjectResource в изображении PSD.
type: docs
weight: 240
...
Получает или задает глобальный уникальный идентификатор данных слоя смарт-объекта.[`SmartObjectResource`](../) в изображении PSD.
...
Глобальный уникальный идентификатор данных слоя смарт-объекта[`SmartObjectResource`](../) .
