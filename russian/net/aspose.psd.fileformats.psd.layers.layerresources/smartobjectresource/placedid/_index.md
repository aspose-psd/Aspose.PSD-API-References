...
description: "Свойство SmartObjectResource. Получает или задает уникальный идентификатор этих данных слоя умного объекта в изображении PSD"
type: docs
weight: 160
...
Уникальный идентификатор этого ресурса слоя умного объекта.
