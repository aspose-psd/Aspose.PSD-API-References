...
description: SmartObjectResource свойство. Получает или задает уникальный идентификатор данных слоя этого смартобъекта в изображении PSD.
type: docs
weight: 160
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/placedid/
---
