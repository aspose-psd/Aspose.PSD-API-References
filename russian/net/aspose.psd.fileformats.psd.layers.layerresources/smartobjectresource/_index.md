...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SmartObjectResource сорт. Определяет класс SmartObjectResource который содержит информацию о слое смартобъектов в PSDфайле. Является базовым классом для ресурсов Sold и Sole который используется для поддержки слоев смартобъектов в изображениях Adobe Photoshop.
type: docs
weight: 2990
