...
description: Получает или задает значение указывающее связан ли этот экземпляр со слоем.
type: docs
weight: 30
...
` true` если этот экземпляр связан со слоем; в противном случае` false` .
