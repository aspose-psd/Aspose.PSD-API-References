...
description: "Свойство PtFlResource. Получает или задает значение, указывающее, связан ли данный экземпляр со слоем"
type: docs
weight: 40
...
`true`, если данный экземпляр связан со слоем; иначе `false`.
