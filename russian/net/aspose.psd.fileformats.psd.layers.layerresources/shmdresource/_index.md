...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ShmdResource сорт. Класс ShmdResource. Настройки метаданных
type: docs
weight: 2980
...
| Имя | Описание |
| --- | --- |
| [ShmdResource](shmdresource/#constructor)() | Инициализирует новый экземпляр`ShmdResource` класс. |
| [ShmdResource](shmdresource/#constructor_1)(byte[]) | Инициализирует новый экземпляр`ShmdResource` класс. |
