...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtDResource класс. Информация о доске объявлений для GlobalLayerResources"
type: docs
weight: 2530
url: /ru/net/aspose.psd.fileformats.psd.layers.layerresources/artdresource/
---
{{< psd/tize >}}
## ArtDResource class

Информация о доске объявлений для [`GlobalLayerResources`](../../aspose.psd.fileformats.psd/psdimage/globallayerresources/).
...
| Имя | Описание |
| --- | --- |
| [ArtDResource](artdresource/)() | Конструктор по умолчанию. |
...
| Имя | Описание |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artdresource/typetoolkey/) | Ключ информации о типе инструмента. |
