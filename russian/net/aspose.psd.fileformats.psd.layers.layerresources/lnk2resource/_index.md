...
description: Определяет класс который содержит информацию о вложенных файлах в изображение формата PSD. Ресурс ссылки может содержать несколькоLiFdDataSource./lifddatasource экземпляры к которым может обращаться индексатор.
type: docs
weight: 2700
...
| Имя | Описание |
| --- | --- |
| [Lnk2Resource](lnk2resource)() | Инициализирует новый экземпляр[`Lnk2Resource`](../lnk2resource) класс. |
