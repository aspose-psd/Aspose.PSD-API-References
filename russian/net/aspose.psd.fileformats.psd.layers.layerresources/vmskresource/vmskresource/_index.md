...
description: "Конструктор VmskResource. Инициализирует новый экземпляр класса VmskResource"
type: docs
weight: 10
...
Инициализирует новый экземпляр класса [`VmskResource`](../).
...
| исключение | условие |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Недопустимое значение ресурса Vmsk |
