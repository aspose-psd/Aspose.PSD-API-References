...
description: AddNoiseSmartFilter свойство. Получает или задает распределение фильтра шума.
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/distribution/
---
## AddNoiseSmartFilter.Distribution property

Получает или задает распределение фильтра шума.
