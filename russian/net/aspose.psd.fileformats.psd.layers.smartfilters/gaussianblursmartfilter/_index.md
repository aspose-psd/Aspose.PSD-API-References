...
description: Интеллектуальный фильтр GaussianBlur.
type: docs
weight: 3370
...
| Имя | Описание |
| --- | --- |
| [GaussianBlurSmartFilter](gaussianblursmartfilter)() | Инициализирует новый экземпляр[`GaussianBlurSmartFilter`](../gaussianblursmartfilter) класс. |
