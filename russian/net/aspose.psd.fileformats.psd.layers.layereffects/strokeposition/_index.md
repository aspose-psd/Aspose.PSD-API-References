...
description: Параметр положения управляет выравниванием штриха относительно слоя к которому он применяется вStrokeEffect./strokeeffect.
type: docs
weight: 2140
...
Параметр положения управляет выравниванием штриха относительно слоя, к которому он применяется в[`StrokeEffect`](../strokeeffect).
...
| --- | --- | --- |
| Inside | `0` | Обводка будет создаваться от края фигуры и расти внутрь, к центру объекта. |
