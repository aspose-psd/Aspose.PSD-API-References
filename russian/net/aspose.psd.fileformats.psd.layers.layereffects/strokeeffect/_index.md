---
title: "Класс StrokeEffect"
second_title: "Справочник API Aspose.PSD для .NET"
description: "Класс Aspose.PSD.FileFormats.Psd.Layers.LayerEffects.StrokeEffect. Эффект обводки Adobe Photoshop для слоя PSD."
type: docs
weight: 2390
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/fillsettings/) { get; set; } | Получает или задает параметры заполнения. |
| [IsVisible](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/isvisible/) { get; set; } | Получает или задает значение, указывающее, видим ли этот экземпляр. |
| [Opacity](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/opacity/) { get; set; } | Получает или задает непрозрачность. |
| [Overprint](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/overprint/) { get; set; } | Получает или задает значение, указывающее, будет ли этот `StrokeEffect` смешивать штрих с текущим содержимым слоя. |
| [Position](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/position/) { get; set; } | Получает или задает положение эффекта штриха для управления выравниванием вашего штриха относительно содержимого слоя PSD. Значение может быть Inside, чтобы рисовать штрих внутри содержимого слоя PSD, Outside — чтобы рисовать штрих вокруг содержимого слоя PSD, и Center — чтобы рисовать штрих как внутри, так и снаружи. |
| [Size](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/size/) { get; set; } | Получает или задает ширину эффекта штриха. |

## Методы

| Имя | Описание |
| --- | --- |
| [GetEffectBounds](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/geteffectbounds/)(Rectangle, int) | Вычисляет и получает границы пикселей эффекта на основе границ пикселей входного слоя. |

## Примеры

Следующий пример кода демонстрирует рендеринг эффекта Stroke с Color Fill.

```csharp
[C#]

// Реализовать рендеринг эффекта Stroke с Color Fill для экспорта
