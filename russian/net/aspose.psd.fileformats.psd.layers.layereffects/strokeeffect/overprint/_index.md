...
description: "Свойство StrokeEffect. Получает или задает значение, указывающее, будет ли данный StrokeEffect смешивать штрих с текущим содержимым слоя"
type: docs
weight: 60
...
Получает или задает значение, указывающее, будет ли этот [`StrokeEffect`](../) смешивать штрих с текущим содержимым слоя.
...
`true`, если необходимо смешивать штрих с текущим содержимым слоя; иначе — `false`.
