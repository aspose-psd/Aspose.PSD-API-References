...
description: StrokeEffect свойство. Получает или задает значение указывающее является ли этоStrokeEffect смешает обводку с текущим содержимым слоя.
type: docs
weight: 60
...
Получает или задает значение, указывающее, является ли это[`StrokeEffect`](../) смешает обводку с текущим содержимым слоя.
