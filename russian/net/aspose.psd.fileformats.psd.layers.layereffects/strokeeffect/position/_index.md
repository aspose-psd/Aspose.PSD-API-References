...
description: Получает или задает положение эффекта обводки для управления выравниванием обводки по содержимому слоя PSD. Значение может бытьInsideдля рисования штриха внутри содержимого слоя PSD илиOutsideдля рисования обводки вокруг содержимого слоя PSD иCenterдля рисования обводки внутри и снаружи.
type: docs
weight: 70
...
Получает или задает положение эффекта обводки для управления выравниванием обводки по содержимому слоя PSD. Значение может бытьInsideдля рисования штриха внутри содержимого слоя PSD, илиOutsideдля рисования обводки вокруг содержимого слоя PSD, иCenterдля рисования обводки внутри и снаружи.
