...
| Имя | Описание |
| --- | --- |
| [Angle](../../aspose.psd.fileformats.psd.layers.layereffects/ishadoweffect/angle) { get; set; } | Получает или задает угол в градусах. |
| [Color](../../aspose.psd.fileformats.psd.layers.layereffects/ishadoweffect/color) { get; set; } | Получает или задает цвет. |
| [Distance](../../aspose.psd.fileformats.psd.layers.layereffects/ishadoweffect/distance) { get; set; } | Получает или задает расстояние в пикселях. |
