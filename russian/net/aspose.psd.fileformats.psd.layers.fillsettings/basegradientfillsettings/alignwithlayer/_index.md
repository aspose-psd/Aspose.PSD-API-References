...
description: "Свойство BaseGradientFillSettings. Получает или задает значение, указывающее, выравнивается ли с слоем"
type: docs
weight: 20
url: /ru/net/aspose.psd.fileformats.psd.layers.fillsettings/basegradientfillsettings/alignwithlayer/
---
{{< psd/tize >}}
