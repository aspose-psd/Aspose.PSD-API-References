...
description: Инициализирует новый экземпляр классаGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings.
type: docs
weight: 10
...
Инициализирует новый экземпляр класса[`GradientFillSettings`](../../gradientfillsettings).
