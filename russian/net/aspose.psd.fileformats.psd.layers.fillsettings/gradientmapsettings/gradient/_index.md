...
description: "Свойство GradientMapSettings. Получает или задает конкретный экземпляр определения градиента Solid/Noise"
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/
---
{{< psd/tize >}}
