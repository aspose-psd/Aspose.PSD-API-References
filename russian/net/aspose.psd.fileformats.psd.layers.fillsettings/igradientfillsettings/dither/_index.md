...
description: "Свойство IGradientFillSettings. Возвращает или задает значение, указывающее, применяется ли дизеринг к данному IGradientFillSettings"
type: docs
weight: 30
url: /ru/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
{{< psd/tize >}}
## IGradientFillSettings.Dither property

Возвращает или задает значение, указывающее, применяется ли дизеринг к данному [`IGradientFillSettings`](../).
