...
description: "Свойство IGradientFillSettings. Возвращает или задает значение, указывающее, является ли данный IGradientFillSettings обратным"
type: docs
weight: 80
...
Возвращает или задает значение, указывающее, является ли данный [`IGradientFillSettings`](../) обратным.
