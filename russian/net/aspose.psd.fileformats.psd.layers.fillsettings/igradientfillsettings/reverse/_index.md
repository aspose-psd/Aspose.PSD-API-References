...
description: IGradientFillSettings свойство. Получает или задает значение указывающее является ли этоIGradientFillSettings является обратным.
type: docs
weight: 90
url: /ru/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
## IGradientFillSettings.Reverse property

Получает или задает значение, указывающее, является ли это[`IGradientFillSettings`](../) является обратным.
