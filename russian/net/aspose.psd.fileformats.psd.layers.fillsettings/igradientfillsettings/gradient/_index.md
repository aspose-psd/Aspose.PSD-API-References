...
description: "Свойство IGradientFillSettings. Возвращает или задает конкретный экземпляр определения градиента Solid/Noise"
type: docs
weight: 40
url: /ru/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/gradient/
---
{{< psd/tize >}}
## IGradientFillSettings.Gradient property

Получает или задаёт конкретный экземпляр определения градиента (Solid/Noise).
