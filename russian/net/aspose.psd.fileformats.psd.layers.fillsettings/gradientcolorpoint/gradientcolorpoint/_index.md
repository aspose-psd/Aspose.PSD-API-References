...
description: GradientColorPoint строитель. Инициализирует новый экземплярGradientColorPoint класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`GradientColorPoint`](../) класс.
