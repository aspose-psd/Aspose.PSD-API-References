...
description: Aspose.PSD.Xmp.XmpRdfRoot сорт. Представляет элемент rdfRDF. Один пакет XMP должен быть сериализован с использованием одного элемента XML rdfRDF. Содержимое элемента rdfRDF должно состоять только из нуля или более элементов rdfDescription.
type: docs
weight: 6300
