...
description: Aspose.PSD.Xmp.XmpMeta сорт. Представляет xmpmeta. Необязательный. Целью этого элемента является идентификация метаданных XMP в общем тексте XML которые могут содержать другие неXMP варианты использования RDF.
type: docs
weight: 6260
...
| Имя | Описание |
| --- | --- |
| [XmpMeta](xmpmeta/#constructor)() | Инициализирует новый экземпляр`XmpMeta` класс. |
| [XmpMeta](xmpmeta/#constructor_1)(string) | Инициализирует новый экземпляр`XmpMeta` класс. |
