---
title: "Класс FillLayer"
type: docs
weight: 10
url: /ru/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Получает или задает параметры заполнения. |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | Возвращает тип заливки. |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | Создайте новый экземпляр класса [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) по типу заполнения. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа для получения плавных краёв.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
...
| update() | Обновляет пиксельные данные слоя заполнения на основе текущих [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
...
Создайте новый экземпляр класса [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) по типу заполнения.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | Тип слоя заполнения. |

**Returns**

| Тип | Описание |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | Возвращает новый экземпляр класса [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) по типу заполнения. |
