---
title: "Класс CmlsResource"
type: docs
weight: 170
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [CmlsResource(data)](#CmlsResource_data_1) | Инициализирует новый экземпляр класса [CmlsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/). |
## **Properties**
...
Инициализирует новый экземпляр класса [CmlsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/).
