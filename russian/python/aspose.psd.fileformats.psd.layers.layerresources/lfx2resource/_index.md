---
title: "Класс Lfx2Resource"
type: docs
weight: 500
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [Lfx2Resource()](#Lfx2Resource__1) | Инициализирует новый экземпляр класса Lfx2Resource |
## **Properties**
...
| descriptor_version | int | r | Получает версию дескриптора. |
...
Инициализирует новый экземпляр класса Lfx2Resource
