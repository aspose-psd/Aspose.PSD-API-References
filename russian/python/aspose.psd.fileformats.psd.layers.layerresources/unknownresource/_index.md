...
type: docs
weight: 1050
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [UnknownResource(signature, key)](#UnknownResource_signature_key_1) | Инициализирует новый экземпляр класса [UnknownResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/). |
## **Properties**
...
| signature | int | r | Получает подпись ресурса слоя. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса [UnknownResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| signature | int | Подпись. |
