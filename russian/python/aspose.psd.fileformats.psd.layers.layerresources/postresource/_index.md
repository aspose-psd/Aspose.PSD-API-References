---
title: "PostResource Класс"
type: docs
weight: 840
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [PostResource()](#PostResource__1) | Инициализирует новый экземпляр класса PostResource. |
## **Properties**
...
Инициализирует новый экземпляр класса PostResource.
