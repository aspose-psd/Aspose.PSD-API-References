...
type: docs
weight: 940
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [SoLeResource()](#SoLeResource__1) | Инициализирует новый экземпляр класса [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
| [SoLeResource(unique_id, is_custom, has_comp_info)](#SoLeResource_unique_id_is_custom_has_comp_info_2) | Инициализирует новый экземпляр класса [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | Ключ информации инструмента типа: 'SoLE'. |
...
Инициализирует новый экземпляр класса [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/).
...
| :- | :- | :- |
| unique_id | Guid | Уникальный идентификатор размещённых данных слоя [PlLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/). |
