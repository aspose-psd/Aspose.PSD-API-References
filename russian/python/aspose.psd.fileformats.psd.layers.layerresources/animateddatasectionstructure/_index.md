...
type: docs
weight: 40
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Определяет ключ структуры AnDs. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | Получает или задает структуры анимированных секций данных. |
