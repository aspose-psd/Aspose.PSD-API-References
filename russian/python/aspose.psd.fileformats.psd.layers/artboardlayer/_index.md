---
title: "ArtboardLayer Класс"
type: docs
weight: 90
url: /ru/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Получает или задает цвет фона артборда. |
...
| имеет_alpha | bool | r |  |
| has_background_color | bool | r/w | Получает или задает значение, указывающее, имеет ли [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) фоновый цвет. |
...
| закешировано | bool | r |  |
| is_open | bool | r/w | Получает или задает, открыт ли каталог<br/>            если установить в <c>true</c>, то группа будет открыта при запуске, иначе будет свернута. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Получает слои в группе слоёв. |
| слева | int | r/w | <inheritdoc /> |
| длина | int | r |  |
...
| **Name** | **Описание** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Добавляет слой в группу слоёв. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Добавляет группу слоёв. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Частично загружает 32‑битные ARGB‑пиксели (по блокам). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Загружает необработанные данные. |
