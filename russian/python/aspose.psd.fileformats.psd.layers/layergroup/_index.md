---
title: "LayerGroup Класс"
type: docs
weight: 950
url: /ru/python-net/aspose.psd.fileformats.psd.layers/layergroup/
---
...
| height | int | r | Получает высоту группы слоёв. |
...
| width | int | r | Получает ширину группы слоёв. |
