---
title: "Класс ShapeLayer"
type: docs
weight: 1600
url: /ru/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Описание** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Инициализирует новый экземпляр класса [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) .<br/>            Все ресурсы создаются в их состоянии по умолчанию. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Получает или задает настройки заливки для внутренней области фигур в слое Shape. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Получает набор путей, присутствующих в слое Shape. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Получает или задает настройки обводки фигур. |
| верх | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Создает новый экземпляр класса [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) . |
...
| update() | Обновляет ресурсы из свойств слоя Shape. |
...
Инициализирует новый экземпляр класса [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) .<br/>            Все ресурсы создаются в их состоянии по умолчанию.
...
Создает новый экземпляр класса [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) .

**Returns**

| Тип | Описание |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Возвращает новый экземпляр класса [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
