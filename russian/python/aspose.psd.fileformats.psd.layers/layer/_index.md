...
type: docs
weight: 930
url: /ru/python-net/aspose.psd.fileformats.psd.layers/layer/
---
...
| **Name** | **Описание** |
| :- | :- |
| [Layer()](#Layer__1) | Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/). Конструктор для отложенной инициализации. |
| [Layer(bounds, red_bytes, green_bytes, blue_bytes, name)](#Layer_bounds_red_bytes_green_bytes_blue_bytes_name_2) | Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) из массивов байтов. |
| [Layer(image, dispose_image)](#Layer_image_dispose_image_3) | Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/). |
| [Layer(stream)](#Layer_stream_4) | Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/). |
## **Properties**
| **Name** | **Type** | **Access** | **Описание** |
| :- | :- | :- | :- |
| BLEND_SIGNATURE [static] | int | r | Представляет сигнатуру режима смешения. |
| LAYER_HEADER_SIZE [static] | int | r | Размер заголовка слоя. |
...
| blend_clipped_elements | bool | r/w | Получает или задаёт смешивание обрезанного элемента. |
...
| blend_mode_signature | int | r | Получает подпись режима наложения. |
| blending_options | [BlendingOptions](/psd/python-net/aspose.psd.fileformats.psd.layers.layereffects/blendingoptions/) | r | Получает параметры наложения. |
| bottom | int | r/w | Получает или задает позицию нижнего слоя. |
...
| channel_information | [ChannelInformation[]](/psd/python-net/aspose.psd.fileformats.psd.layers/channelinformation) | r/w | Получает или задает информацию о канале. |
| channels_count | ushort | r | Получает количество каналов слоя. |
| clipping | байт | r/w | Получает или задает обрезку слоя. 0 = базовая, 1 = небазовая. |
...
| display_name | string | r/w | Получает или задает отображаемое имя слоя. |
| освобождено | bool | r | Получает значение, указывающее, освобожден ли данный экземпляр. |
| дополнительная_длина | int | r | Получает длину дополнительной информации слоя в байтах. |
| file_format | [FileFormat](/psd/python-net/aspose.psd/fileformat) | r | Получает значение формата файла |
| непрозрачность_заполнения | int | r/w | Получает или задает непрозрачность заливки. |
| заполнитель | байт | r/w | Получает или задает заполнитель слоя. |
| flags | [LayerFlags](/psd/python-net/aspose.psd.fileformats.psd.layers/layerflags) | r/w | Получает или задает флаги слоя.<br/>            бит 0 = защита от прозрачности;<br/>            бит 1 = видимый;<br/>            бит 2 = устаревший;<br/>            бит 3 = 1 для Photoshop 5.0 и новее, указывает, содержит ли бит 4 полезную информацию;<br/>            бит 4 = данные пикселей не влияют на внешний вид документа. |
...
| видим | bool | r/w | Получает или задает значение, указывающее, видим ли слой |
| видим_в_группе | bool | r | Получает значение, указывающее, видим ли этот экземпляр в группе(Если слой не находится в группе, это означает корневую группу). |
| layer_blending_ranges_data | [LayerBlendingRangesData](/psd/python-net/aspose.psd.fileformats.psd.layers/layerblendingrangesdata) | r/w | Получает или задает данные диапазонов наложения слоя. |
| дата_и_время_создания_слоя | datetime | r/w | Получает или задает дату и время создания слоя. |
...
| layer_mask_data | [LayerMaskData](/psd/python-net/aspose.psd.fileformats.psd.layers/layermaskdata) | r/w | Получает или задает данные маски слоя. |
| layer_options | [PsdOptions](/psd/python-net/aspose.psd.imageoptions/psdoptions/) | r | Получает параметры слоя. |
| слева | int | r/w | Получает или задает позицию слоя слева. |
| длина | int | r | Получает общий размер слоя в байтах. |
| name | string | r/w | Получает или задает имя слоя. |
| opacity | байт | r/w | Получает или задает непрозрачность слоя. 0 = прозрачно, 255 = непрозрачный. |
...
| resources | [LayerResource[]](/psd/python-net/aspose.psd.fileformats.psd.layers/layerresource) | r/w | Получает или задает ресурсы слоя. |
| справа | int | r/w | Получает или задает позицию слоя справа. |
| sheet_color_highlight | [SheetColorHighlightEnum](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/) | r/w | Получает или задает выделение цвета декоративного листа в списке слоёв |
| size | [Size](/psd/python-net/aspose.psd/size) | r | Получает размер объекта. |
| верх | int | r/w | Получает или задает позицию верхнего слоя. |
...
| **Name** | **Описание** |
| :- | :- |
| [add_layer_mask(layer_mask)](#add_layer_mask_layer_mask_1) | Добавляет маску к текущему слою. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_2) | Регулировка яркости изображения. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_3) | Контрастирование изображения |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_4) | Гамма‑коррекция изображения. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_5) | Гамма‑коррекция изображения. |
| [binarize_bradley(brightness_difference)](#binarize_bradley_brightness_difference_6) | Бинаризация изображения с использованием адаптивного порогового алгоритма Брэдли, основанного на интегральном изображении |
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_7) | Бинаризация изображения с использованием адаптивного порогового алгоритма Брэдли, основанного на интегральном изображении |
...
| [can_load(file_path)](#can_load_file_path_9) | Определяет, может ли изображение быть загружено из указанного пути к файлу. |
| [can_load(file_path, load_options)](#can_load_file_path_load_options_10) | Определяет, может ли изображение быть загружено из указанного пути к файлу и, при необходимости, с использованием указанных параметров открытия. |
| [can_load(stream)](#can_load_stream_11) | Определяет, может ли изображение быть загружено из указанного потока. |
| [can_load(stream, load_options)](#can_load_stream_load_options_12) | Определяет, может ли изображение быть загружено из указанного потока и, при необходимости, с использованием указанного <paramref name="loadOptions" />. |
| [can_save(options)](#can_save_options_13) | Определяет, может ли изображение быть сохранено в указанный формат файла, представленный переданными параметрами сохранения. |
| [create(image_options, width, height)](#create_image_options_width_height_14) | Создаёт новое изображение с использованием указанных параметров создания. |
| crop(left_shift, right_shift, top_shift, bottom_shift) |  |
| [crop(rectangle)](#crop_rectangle_15) | Обрезка изображения. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_16) | Выполняет дизеринг текущего изображения. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_17) | Выполняет дизеринг текущего изображения. |
| [draw_image(location, image)](#draw_image_location_image_18) | Рисует изображение на слое. |
| filter(rectangle, options) |  |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_19) | Получает 32‑битный ARGB‑пиксель изображения. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_20) | Получает массив пикселей по умолчанию в формате 32‑бит ARGB. |
| [get_default_options(args)](#get_default_options_args_21) | Получает параметры по умолчанию. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_22) | Получает массив пикселей по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_23) | Получает массив необработанных данных по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_24) | Получает массив необработанных данных по умолчанию. |
...
| [load(file_path)](#load_file_path_35) | Загружает новое изображение из указанного файла. |
| [load(file_path, load_options)](#load_file_path_load_options_36) | Загружает новое изображение из указанного файла. |
...
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_39) | Загружает 32‑битные ARGB‑пиксели. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_40) | Загружает 64‑битные ARGB‑пиксели. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_41) | Загружает пиксели в формате CMYK. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_42) | Загружает пиксели в формате CMYK.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.load_cmyk_32_pixels(rectangle)](/psd/python-net/aspose.psd/rasterimage/). |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_43) | Частично загружает 32‑битные ARGB‑пиксели (по блокам). |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_44) | Частично загружает пиксели пакетами. |
| [load_pixels(rectangle)](#load_pixels_rectangle_45) | Загружает пиксели. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_46) | Загружает необработанные данные. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_47) | Загружает необработанные данные. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_48) | Объединяет слой с указанным слоем |
| normalize_angle() |  |
| normalize_angle(resize_proportionally, background_color) |  |
| [read_argb_32_scan_line(scan_line_index)](#read_argb_32_scan_line_scan_line_index_49) | Читает всю строку сканирования по указанному индексу строки сканирования. |
| [read_scan_line(scan_line_index)](#read_scan_line_scan_line_index_50) | Читает всю строку сканирования по указанному индексу строки сканирования. |
| replace_color(old_color, old_color_diff, new_color) |  |
| replace_color(old_color_argb, old_color_diff, new_color_argb) |  |
| replace_non_transparent_colors(new_color) |  |
| replace_non_transparent_colors(new_color_argb) |  |
| [resize(new_width, new_height)](#resize_new_width_new_height_51) | Изменяет размер изображения. Используется значение по умолчанию [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_52) | Изменяет размер изображения. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_53) | Изменяет размер изображения. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_54) | Пропорционально изменяет высоту. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_55) | Пропорционально изменяет высоту. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_56) | Пропорционально изменяет высоту. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_57) | Пропорционально изменяет ширину. Используется значение по умолчанию [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_58) | Пропорционально изменяет ширину. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_59) | Пропорционально изменяет ширину. |
| rotate(angle) |  |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_60) | Поворачивает изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_61) | Поворачивает, отражает или одновременно поворачивает и отражает изображение. |
| save() | Сохраняет данные изображения в базовый поток. |
| [save(file_path)](#save_file_path_62) | Сохраняет данные объекта в указанное расположение файла. |
| [save(file_path, options)](#save_file_path_options_63) | Сохраняет данные объекта в указанное расположение файла в указанном формате файла согласно параметрам сохранения. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_64) | Сохраняет данные объекта в указанное расположение файла в указанном формате файла согласно параметрам сохранения. |
| [save(file_path, over_write)](#save_file_path_over_write_65) | Сохраняет данные объекта в указанное расположение файла. |
| [save(stream)](#save_stream_66) | Сохраняет данные объекта в указанный поток. |
| [save(stream, options_base)](#save_stream_options_base_67) | Сохраняет данные изображения в указанный поток в указанном формате файла согласно параметрам сохранения. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_68) | Сохраняет данные изображения в указанный поток в указанном формате файла согласно параметрам сохранения. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_69) | Сохраняет 32‑битные ARGB‑пиксели. |
| save_cmyk_32_pixels(rectangle, pixels) |  |
| save_cmyk_pixels(rectangle, pixels) |  |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_70) | Сохраняет пиксели (метод, специфичный для формата). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_71) | Сохраняет необработанные данные. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_72) | Устанавливает 32‑битный ARGB‑пиксель изображения для указанной позиции. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_73) | Устанавливает палитру изображения. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_74) | Устанавливает пиксель изображения для указанной позиции. |
| set_resolution(dpi_x, dpi_y) |  |
| [shallow_copy()](#shallow_copy__75) | Создает поверхностную копию текущего слоя.<br/>            Пожалуйста, <see href=\"https://msdn.microsoft.com/ru-ru/library/system.object.memberwiseclone(v=vs.110).aspx\" /> для объяснения. |
| [to_bitmap()](#to_bitmap__76) |    |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_77) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_78) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
...
Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/). Конструктор для отложенной инициализации.
...
Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) из массивов байтов.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| bounds | [Rectangle](/psd/python-net/aspose.psd/rectangle) | Границы слоя. |
| red_bytes | байт | Красные байты. |
| green_bytes | байт | Зеленые байты. |
| blue_bytes | байт | Синие байты. |
...
Инициализирует новый экземпляр класса [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/).
...
| dispose_image | bool | если установлено <c>true</c> [удалить изображение]. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| layer_mask | [LayerMaskData](/psd/python-net/aspose.psd.fileformats.psd.layers/layermaskdata) | Маска слоя. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| location | [Point](/psd/python-net/aspose.psd/point) | Расположение. |
| image | [RasterImage](/psd/python-net/aspose.psd/rasterimage) | Изображение. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| layer_to_merge_into | [Layer](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | Слой, в который выполнять слияние. |
...
Создает поверхностную копию текущего слоя.<br/>            Пожалуйста, <see href=\"https://msdn.microsoft.com/ru-ru/library/system.object.memberwiseclone(v=vs.110).aspx\" /> для объяснения.

**Returns**

| Тип | Описание |
| :- | :- |
| [Layer](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | Поверхностная копия текущего слоя. |
