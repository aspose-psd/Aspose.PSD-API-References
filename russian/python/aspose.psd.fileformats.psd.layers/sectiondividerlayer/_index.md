---
title: "SectionDividerLayer Класс"
type: docs
weight: 1580
url: /ru/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
...
| [get_related_layer_group()](#get_related_layer_group__20) | Получает [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/), связанный с этим экземпляром [SectionDividerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/). |
...
Получает [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/), связанный с этим экземпляром [SectionDividerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/).

**Returns**

| Тип | Описание |
| :- | :- |
| [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup) | Экземпляр [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/). |
