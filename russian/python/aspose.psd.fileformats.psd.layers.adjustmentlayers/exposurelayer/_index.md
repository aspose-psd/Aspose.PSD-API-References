---
title: "ExposureLayer Класс"
type: docs
weight: 100
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| освобождено | bool | r |  |
| экспозиция | float | r/w | Получает или задает экспозицию. Для диапазона PS значение экспозиции от -20 до +20. |
...
| коррекция_гаммы | float | r/w | Получает или задает коррекцию гаммы. Для диапазона PS значение коррекции гаммы от 9.99 до +0.01. |
| имеет_alpha | bool | r |  |
...
| offset | float | r/w | Получает или задает смещение. Для диапазона PS значение смещения от -0.5 до +0.5. |
| opacity | байт | r/w |  |
