---
title: "Класс GradientMapLayer"
type: docs
weight: 110
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---

**Summary:** Gradient map layer. Handles Gradient map rendering using data from GrdmResource.
...
**Full Name:** aspose.psd.fileformats.psd.layers.adjustmentlayers.GradientMapLayer
...
| gradient_settings | [BaseGradientFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/basegradientfillsettings/) | r/w | Экземпляр настроек градиента, переданный из экземпляра GrdmResource. |
| имеет_alpha | bool | r |  |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | Частично загружает 32‑битные ARGB‑пиксели (по блокам). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | Загружает необработанные данные. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | Объединяет слой с указанным слоем |
| normalize_angle() |  |
