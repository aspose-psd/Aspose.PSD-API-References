...
type: docs
weight: 120
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | байт | r/w |  |
| colorize | bool | r/w | Получает или задает значение, указывающее, является ли этот [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) цветовым. |
...
| [get_range(index)](#get_range_index_20) | Получает диапазон. |
...
| Тип | Описание |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | Диапазон цвета Hsl |
