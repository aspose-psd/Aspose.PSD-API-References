---
title: "BrightnessContrastLayer Класс"
type: docs
weight: 30
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---

**Summary:** Brightness/contrast layer.
...
**Full Name:** aspose.psd.fileformats.psd.layers.adjustmentlayers.BrightnessContrastLayer
...
| яркость | int | r/w | Получает или задает яркость. Для диапазона PS значение яркости от -150 до +150. Но мы игнорируем это. |
...
| контраст | int | r/w | Получает или задает контраст. Для диапазона PS значение контраста от -50 до +100. Но мы игнорируем это. |
