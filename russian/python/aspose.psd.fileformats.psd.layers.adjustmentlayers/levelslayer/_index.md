---
title: "Класс LevelsLayer"
type: docs
weight: 140
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| слева | int | r/w |  |
| длина | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | Получает основной канал. |
...
| [get_channel(index)](#get_channel_index_8) | Получает канал. |
...
| Тип | Описание |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) по индексу |
