...
type: docs
weight: 170
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---

**Summary:** Posterize layer. Handles Posterize rendering using data from PostResource.
...
**Full Name:** aspose.psd.fileformats.psd.layers.adjustmentlayers.PosterizeLayer
...
| слева | int | r/w |  |
| длина | int | r |  |
| levels | short | r/w | Уровни слоя Posterize. |
