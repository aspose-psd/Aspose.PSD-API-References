---
title: "BlackWhiteAdjustmentLayer Класс"
type: docs
weight: 20
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Получает или задает значение Tint Color. |
| tint_color_blue | double | r/w | Получает или задает значение double Blue Tint Color. |
| tint_color_green | double | r/w | Получает или задает значение double Green Tint Color. |
| tint_color_red | double | r/w | Получает или задает значение double Red Tint Color. |
| верх | int | r/w |  |
