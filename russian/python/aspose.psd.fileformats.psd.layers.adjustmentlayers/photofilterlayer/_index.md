---
title: "Класс PhotoFilterLayer"
type: docs
weight: 160
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| clipping | байт | r/w |  |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Получает или задает RGB‑цвет фильтра. |
...
| density | int | r/w | Получает или задает плотность фильтра |
