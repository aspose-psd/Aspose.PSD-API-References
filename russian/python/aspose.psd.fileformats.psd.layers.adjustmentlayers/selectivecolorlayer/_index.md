---
title: "SelectiveColorLayer Класс"
type: docs
weight: 200
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | Получает или задает метод коррекции. |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | Получает коррекцию cmyk по выборочному цвету. |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | Устанавливает коррекцию cmyk по выборочному цвету. |
...
Получает коррекцию cmyk по выборочному цвету.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Выборочные цвета. |

**Returns**

| Тип | Описание |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Коррекция cmyk. |
...
Устанавливает коррекцию cmyk по выборочному цвету.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Тип выборочных цветов. |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Коррекция cmyk. |
