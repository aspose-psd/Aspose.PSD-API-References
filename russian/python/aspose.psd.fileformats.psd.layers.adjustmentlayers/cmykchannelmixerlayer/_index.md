---
title: "Класс CmykChannelMixerLayer"
type: docs
weight: 50
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Получает черный канал. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Получает канал циан. |
...
| слева | int | r/w |  |
| длина | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Получает канал маджента. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Получает желтый канал. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Получает индекс канала. Возвращает CmykMixerChannel |
