---
title: "Класс RgbChannelMixerLayer"
type: docs
weight: 180
url: /ru/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Получает синий канал. |
| bottom | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Получает зелёный канал. |
| имеет_alpha | bool | r |  |
...
| слева | int | r/w |  |
| длина | int | r |  |
| monochrome | bool | r/w | Получает или задает значение, указывающее, является ли этот [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) монохромным. |
...
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Получает красный канал. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Получает индекс канала. Возвращает RgbMixerChannel |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Объединяет слой с указанным слоем |
| normalize_angle() |  |
...
Получает индекс канала. Возвращает RgbMixerChannel
