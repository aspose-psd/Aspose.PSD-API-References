...
type: docs
weight: 80
url: /ru/python-net/aspose.psd.shapes/rectangleshape/
---
...
| **Name** | **Описание** |
| :- | :- |
| [RectangleShape()](#RectangleShape__1) | Инициализирует новый экземпляр класса [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/). |
| [RectangleShape(rectangle)](#RectangleShape_rectangle_2) | Инициализирует новый экземпляр класса [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/). |
## **Properties**
...
Инициализирует новый экземпляр класса [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/).
