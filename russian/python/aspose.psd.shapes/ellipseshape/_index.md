...
type: docs
weight: 40
url: /ru/python-net/aspose.psd.shapes/ellipseshape/
---
...
| **Name** | **Описание** |
| :- | :- |
| [EllipseShape()](#EllipseShape__1) | Инициализирует новый экземпляр класса [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/). |
| [EllipseShape(rectangle)](#EllipseShape_rectangle_2) | Инициализирует новый экземпляр класса [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/). |
## **Properties**
...
Инициализирует новый экземпляр класса [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/).
