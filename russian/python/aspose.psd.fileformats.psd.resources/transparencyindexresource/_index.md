---
title: "TransparencyIndexResource Класс"
type: docs
weight: 260
url: /ru/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | Инициализирует новый экземпляр класса TransparencyIndexResource |
## **Properties**
...
| transparency_index | short | r/w | Получает или задает индекс цвета прозрачности. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса TransparencyIndexResource
