...
type: docs
weight: 330
url: /ru/python-net/aspose.psd.fileformats.psd.resources/xmpresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [XmpResource()](#XmpResource__1) | Инициализирует новый экземпляр класса XmpResource |
## **Properties**
...
Инициализирует новый экземпляр класса XmpResource
