...
type: docs
weight: 290
url: /ru/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | Инициализирует новый экземпляр класса UrlListResource |
## **Properties**
...
| количество | int | r/w | Получает или задает количество. |
| data_size | int | r | Получает размер данных ресурса в байтах. |
| id | short | r/w | Получает или задает уникальный идентификатор ресурса. |
| ids | int | r/w | Получает или задает идентификаторы. |
| longs | int | r/w | Получает или задает longs. |
...
| texts | string | r/w | Получает или задает texts. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса UrlListResource
