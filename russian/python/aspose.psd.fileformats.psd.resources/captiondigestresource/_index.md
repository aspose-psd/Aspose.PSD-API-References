...
type: docs
weight: 40
url: /ru/python-net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [CaptionDigestResource()](#CaptionDigestResource__1) | Инициализирует новый экземпляр класса CaptionDigestResource |
## **Properties**
...
| дайджест | байт | r/w | Получает или задает дайджест. |
...
Инициализирует новый экземпляр класса CaptionDigestResource
