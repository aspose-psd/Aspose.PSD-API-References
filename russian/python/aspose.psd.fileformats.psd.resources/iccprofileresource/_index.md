...
type: docs
weight: 130
url: /ru/python-net/aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [IccProfileResource()](#IccProfileResource__1) | Инициализирует новый экземпляр класса IccProfileResource |
## **Properties**
...
Инициализирует новый экземпляр класса IccProfileResource
