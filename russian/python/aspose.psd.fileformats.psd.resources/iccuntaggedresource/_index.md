...
type: docs
weight: 140
url: /ru/python-net/aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [IccUntaggedResource()](#IccUntaggedResource__1) | Инициализирует новый экземпляр класса IccUntaggedResource |
## **Properties**
...
| профиль | байт | r/w | Получает или задает профиль. |
...
Инициализирует новый экземпляр класса IccUntaggedResource
