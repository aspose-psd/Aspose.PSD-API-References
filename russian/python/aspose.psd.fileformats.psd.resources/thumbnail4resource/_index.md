...
type: docs
weight: 240
url: /ru/python-net/aspose.psd.fileformats.psd.resources/thumbnail4resource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [Thumbnail4Resource()](#Thumbnail4Resource__1) | Инициализирует новый экземпляр класса Thumbnail4Resource |
## **Properties**
...
Инициализирует новый экземпляр класса Thumbnail4Resource
