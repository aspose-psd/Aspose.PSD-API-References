---
title: "LayerGroupsEnabledResource Класс"
type: docs
weight: 160
url: /ru/python-net/aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource__1) | Инициализирует новый экземпляр класса LayerGroupsEnabledResource |
## **Properties**
...
| ds | байт | r/w | Получает или задает i ds. |
...
Инициализирует новый экземпляр класса LayerGroupsEnabledResource
