---
title: "ColorHalftoneInformationResource Класс"
type: docs
weight: 50
url: /ru/python-net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource__1) | Инициализирует новый экземпляр класса ColorHalftoneInformationResource |
## **Properties**
...
| halftone_data | байт | r/w | Получает или задает данные полутонов. |
...
Инициализирует новый экземпляр класса ColorHalftoneInformationResource
