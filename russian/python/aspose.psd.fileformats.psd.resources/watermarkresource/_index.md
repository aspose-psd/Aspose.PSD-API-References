---
title: "WatermarkResource Class"
type: docs
weight: 310
url: /ru/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | Инициализирует новый экземпляр класса WatermarkResource |
## **Properties**
...
| is_watermark | bool | r/w | Получает или задает значение, указывающее, является ли данный экземпляр водяным знаком. |
...
Инициализирует новый экземпляр класса WatermarkResource
