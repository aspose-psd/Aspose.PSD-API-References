...
type: docs
weight: 150
url: /ru/python-net/aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource__1) | Инициализирует новый экземпляр класса LayerGroupInformationResource |
## **Properties**
...
| groups | short | r/w | Получает или задает группы. |
...
Инициализирует новый экземпляр класса LayerGroupInformationResource
