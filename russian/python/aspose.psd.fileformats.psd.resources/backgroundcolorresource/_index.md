...
type: docs
weight: 20
url: /ru/python-net/aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [BackgroundColorResource()](#BackgroundColorResource__1) | Инициализирует новый экземпляр класса BackgroundColorResource |
## **Properties**
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Получает или задает цвет фона. |
...
Инициализирует новый экземпляр класса BackgroundColorResource
