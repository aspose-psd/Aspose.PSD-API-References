---
title: "Класс PrintScaleResource"
type: docs
weight: 210
url: /ru/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | Инициализирует новый экземпляр класса PrintScaleResource |
## **Properties**
...
| scale | float | r/w | Получает или задает масштаб. |
...
| style | short | r/w | Получает или задает стиль. |
| x_location | float | r/w | Получает или задает координату x. |
| y_location | float | r/w | Получает или задает координату y. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса PrintScaleResource
