---
title: "Класс PrintFlagsResource"
type: docs
weight: 200
url: /ru/python-net/aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| **Name** | **Описание** |
| :- | :- |
| [PrintFlagsResource()](#PrintFlagsResource__1) | Инициализирует новый экземпляр класса PrintFlagsResource |
## **Properties**
...
| bleed_scale | short | r/w | Получает или задает масштаб отступа. |
| bleed_width | int | r/w | Получает или задает ширину отступа. |
| center_crop_mark | байт | r/w | Получает или задает метку центрального кадрирования. |
...
Инициализирует новый экземпляр класса PrintFlagsResource
