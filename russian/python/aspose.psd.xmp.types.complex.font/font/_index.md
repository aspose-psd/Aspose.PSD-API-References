...
type: docs
weight: 10
url: /ru/python-net/aspose.psd.xmp.types.complex.font/font/
---
...
| **Name** | **Описание** |
| :- | :- |
| [Font()](#Font__1) | Инициализирует новый экземпляр класса [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font/). |
| [Font(font_family)](#Font_font_family_2) | Инициализирует новый экземпляр класса [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font/). |
## **Properties**
...
| font_name | string | r/w | Получает или задает имя шрифта PostScript. |
...
Инициализирует новый экземпляр класса [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font/).
