---
title: "Класс IntegerStructure"
type: docs
weight: 80
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **Описание** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | Инициализирует новый экземпляр класса [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Описание** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Ключ целочисленной структуры. |
...
| значение | int | r/w | Получает или задает целочисленное значение. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/).
