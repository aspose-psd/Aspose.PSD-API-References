---
title: "PathStructure Класс"
type: docs
weight: 120
url: /ru/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| **Name** | **Описание** |
| :- | :- |
| [PathStructure(key_name)](#PathStructure_key_name_1) | Инициализирует новый экземпляр класса [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/). |
## **Properties**
...
| путь | string | r/w | Получает или задает путь. |
| префикс | string | r/w | Получает или задает префикс пути. |
## **Methods**
| **Name** | **Описание** |
| :- | :- |
...
Инициализирует новый экземпляр класса [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/).
