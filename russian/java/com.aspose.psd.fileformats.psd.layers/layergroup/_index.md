...
description: "Класс группового слоя."
type: docs
weight: 19
url: /ru/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Получает высоту группы слоев. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Получает объединяющие границы всех слоев в LayerGroup. |
...
| [getWidth()](#getWidth--) | Получает ширину группы слоев. |
...
Получает объединяющие границы всех слоев в LayerGroup.
