...
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.psd.layers/filllayer/
---
...
Слой заливки. Цветовая заливка, градиентная заливка или узорчатая заливка, которые различаются по FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers/filllayer\#setFillSettings-IFillSettings-))
## Поля
...
| [createInstance(int fillType)](#createInstance-int-) | Создайте новый экземпляр класса [FillLayer](../../com.aspose.psd.fileformats.psd.layers/filllayer) по типу заливки. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Обновляет пиксельные данные слоя заливки на основе текущих [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Создайте новый экземпляр класса [FillLayer](../../com.aspose.psd.fileformats.psd.layers/filllayer) по типу заливки.
...
Обновляет пиксельные данные слоя заливки на основе текущих [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
