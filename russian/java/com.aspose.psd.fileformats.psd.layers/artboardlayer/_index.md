...
description: "Класс слоя артборда."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Добавляет слой в группу слоев. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Добавляет слой в группу слоев. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Добавляет группу слоев. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Получает или задаёт цвет фона артборда. |
...
| [getLayers()](#getLayers--) | Получает слои в группе слоев |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Получает истинные границы ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Получает  LayerSectionResource  из ресурсов. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Получает или задаёт значение, указывающее, имеет ли [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) цвет фона. |
...
| [isOpen()](#isOpen--) | Получает или задает, открыта ли папка; если установить значение true, группа будет в открытом состоянии при запуске, иначе будет свернута. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Получает или задаёт цвет фона артборда. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Получает или задает, открыта ли папка; если установить значение true, группа будет в открытом состоянии при запуске, иначе будет свернута. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Слой. |
| индекс | int | Индекс, по которому будет вставлен слой. Недопустимые значения означают конец списка слоёв. |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Возвращает массив из двух объектов LayerGroup, где первый [0] является маркером начала группы, а второй [1] — маркером её окончания.
### cacheData() {#cacheData--}
```
...
Получает или задаёт цвет фона артборда.
...
Получает истинные границы ArtboardLayer.
...
Получает  LayerSectionResource  из ресурсов.
...
Получает или задаёт значение, указывающее, имеет ли [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) цвет фона.
...
Получает или задает, открыта ли папка; если установить значение true, группа будет в открытом состоянии при запуске, иначе будет свернута.
