...
type: docs
weight: 24
url: /ru/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| Поле | Описание |
| --- | --- |
| [Disabled](#Disabled) | Маска слоя отключена. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | Инвертировать маску слоя при смешивании. |
| [None](#None) | Флаги не определены. |
| [RelativeToLayer](#RelativeToLayer) | Позиция относительна слою. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | Указывает, что пользовательская маска фактически получена из рендеринга других данных. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | Указывает, что к пользовательским и/или векторным маскам применены параметры. |
## Методы
...
Инвертировать маску слоя при смешивании.
...
Указывает, что пользовательская маска фактически получена из рендеринга других данных.
...
Указывает, что к пользовательским и/или векторным маскам применены параметры.
