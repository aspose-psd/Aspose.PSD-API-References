...
description: "Слой формы."
type: docs
weight: 29
url: /ru/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Слой Shape. Инкапсулирует логику работы со слоем Shape и связанными ресурсами.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Инициализирует новый экземпляр класса [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Поля
...
| [createInstance()](#createInstance--) | Создает новый экземпляр класса [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Настройки заполнения внутренней области фигур в слое Shape. |
...
| [getPath()](#getPath--) | Получает набор путей, присутствующих в слое Shape. |
...
| [getStroke()](#getStroke--) | Получает или задает настройки обводки фигур. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Вызывается, когда [global resources changed] изменились. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Вызывается, когда [resources change] изменятся. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Настройки заполнения внутренней области фигур в слое Shape. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Получает или задает настройки обводки фигур. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Обновляет ресурсы из свойств слоя Shape. |
...
Инициализирует новый экземпляр класса [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). Все ресурсы создаются в их состоянии по умолчанию.
...
Создает новый экземпляр класса [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
Настройки заполнения внутренней области фигур в слое Shape.
...
Получает или задает настройки обводки фигур.
...
**Returns:**
boolean — логическое значение, указывающее, что слой допустим.
...
Вызывается, когда [global resources changed] изменились.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| отправитель | java.lang.Object | Отправитель. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | Экземпляр EventArgs, содержащий данные события. |
...
Вызывается, когда [resources change] изменятся.
...
Обновляет ресурсы из свойств слоя Shape.
