...
description: "Слой-разделитель, отмечающий границы группы слоёв папки."
type: docs
weight: 28
url: /ru/java/com.aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
...
Слой-разделитель секции, отмечающий границы папки (группы слоёв).
## Поля
...
| [getRelatedLayerGroup()](#getRelatedLayerGroup--) | Получает [LayerGroup](../../com.aspose.psd.fileformats.psd.layers/layergroup), связанный с этим экземпляром [SectionDividerLayer](../../com.aspose.psd.fileformats.psd.layers/sectiondividerlayer). |
...
Инициализирует новый экземпляр класса [LayerGroup](../../com.aspose.psd.fileformats.psd.layers/layergroup) с ресурсами по умолчанию.
...
| layerNestedLevel | int | Вложенный уровень слоя. |
...
Получает [LayerGroup](../../com.aspose.psd.fileformats.psd.layers/layergroup), связанный с этим экземпляром [SectionDividerLayer](../../com.aspose.psd.fileformats.psd.layers/sectiondividerlayer).
