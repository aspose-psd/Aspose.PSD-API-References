...
description: "Перечисление фотометрической интерполяции"
type: docs
weight: 20
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffphotometrics/
---
...
Перечисление фотометрической интерполяции
## Поля
...
| [Mask](#Mask) | [устарело в TIFF rev. |
| [MinIsBlack](#MinIsBlack) | Минимальное значение — черное. |
| [MinIsWhite](#MinIsWhite) | Минимальное значение — белое. |
| [Palette](#Palette) | Карта цветов индексирована. |
| [Rgb](#Rgb) | Модель цвета RGB. |
| [Separated](#Separated) | Разделения цветов. |
| [Ycbcr](#Ycbcr) | Стандарт CCIR 601. |
## Методы
...
ICC L\*a\*b\*. Введено после TIFF rev 6.0 в Adobe TIFF Technote 4.
