...
description: "Перечисление формата образца"
type: docs
weight: 24
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffsampleformats/
---
...
| Поле | Описание |
| --- | --- |
| [ComplexIeeeFp](#ComplexIeeeFp) | Комплексный ieee с плавающей точкой |
| [ComplexInt](#ComplexInt) | Комплексный знаковый int |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IeeeFp](#IeeeFp) | Данные с плавающей точкой IEEE |
| [Int](#Int) | Данные знакового целого |
| [Uint](#Uint) | Данные беззнакового целого |
| [Void](#Void) | Данные без типа |
## Методы
...
Комплексный ieee с плавающей точкой
...
Данные с плавающей точкой IEEE
