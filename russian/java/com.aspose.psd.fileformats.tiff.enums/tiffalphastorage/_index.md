...
type: docs
weight: 11
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffalphastorage/
---
...
| Поле | Описание |
| --- | --- |
| [Associated](#Associated) | Значение альфа хранится в предварительно умноженной форме. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Unassociated](#Unassociated) | Значение альфа хранится в несвязанной форме. |
| [Unspecified](#Unspecified) | Альфа не указана и хранится в файле tiff. |
## Методы
...
Значение альфа хранится в предварительно умноженной форме. При восстановлении альфа может возникнуть некоторое округление, и восстановленное значение может отличаться от оригинального.
...
Значение альфа хранится в несвязанной форме. Это означает, что восстановленная альфа будет точно такой же, как она была сохранена в tiff.
...
Альфа не указана и хранится в файле tiff.
