...
description: "Порядок байтов для tiff‑изображения."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
Порядок байтов для tiff‑изображения.
## Поля

| Поле | Описание |
| --- | --- |
| [BigEndian](#BigEndian) | Большой порядок байтов (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | Малый порядок байтов (Intel). |
## Методы
...
Большой порядок байтов (Motorola).
