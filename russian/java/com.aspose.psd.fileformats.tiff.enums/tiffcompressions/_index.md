...
type: docs
weight: 13
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffcompressions/
---
...
| Поле | Описание |
| --- | --- |
| [AdobeDeflate](#AdobeDeflate) | Сжатие Deflate, признанное Adobe. |
| [CcittFax3](#CcittFax3) | Кодирование факса CCITT Group 3. |
| [CcittFax4](#CcittFax4) | Кодирование факса CCITT Group 4. |
| [CcittRle](#CcittRle) | Модифицированный Huffman RLE от CCITT. |
| [CcittRleW](#CcittRleW) | CCITT RLE. |
| [Dcs](#Dcs) | Кодирование Kodak DCS. |
| [Deflate](#Deflate) | Сжатие Deflate. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [It8Bl](#It8Bl) | Бинарный линейный рисунок IT8. |
| [It8Ctpad](#It8Ctpad) | IT8 CT с заполнением. |
| [It8Lw](#It8Lw) | IT8 Linework RLE. |
| [It8Mp](#It8Mp) | IT8 монохромное изображение. |
| [Jbig](#Jbig) | ISO Jpeg big. |
| [Jp2000](#Jp2000) | Leadtools JPEG2000. |
| [Jpeg](#Jpeg) | Сжатие JPEG DCT. |
| [Lzw](#Lzw) | Lempel-Ziv & Welch. |
| [Next](#Next) | NeXT 2-битовый RLE. |
| [None](#None) | Режим дампа. |
| [Ojpeg](#Ojpeg) | Оригинальный JPEG / JPEG старого стиля (6.0). |
| [Packbits](#Packbits) | Macintosh RLE. |
| [PixarFilm](#PixarFilm) | Pixar с компрессией 10‑бит LZW. |
| [PixarLog](#PixarLog) | Pixar с компрессией 11‑бит ZIP. |
| [Sgilog](#Sgilog) | SGI Log Luminance RLE. |
| [Sgilog24](#Sgilog24) | SGI Log 24‑бит упакованный. |
...
Сжатие Deflate, признанное Adobe.
...
Кодирование факса CCITT Group 3.
...
Кодирование факса CCITT Group 4.
...
Модифицированный Huffman RLE от CCITT.
...
Кодирование Kodak DCS. Зарезервировано для Oceana Matrix
...
Бинарный линейный рисунок IT8. Зарезервировано для ANSI IT8 TIFF/IT.
...
IT8 CT с заполнением. Зарезервировано для ANSI IT8 TIFF/IT.
...
IT8 Linework RLE. Зарезервировано для ANSI IT8 TIFF/IT.
...
IT8 монохромное изображение. Зарезервировано для ANSI IT8 TIFF/IT.
...
Сжатие JPEG DCT. Введено после версии TIFF 6.0.
...
Оригинальный JPEG / JPEG старого стиля (6.0).
...
Pixar с компрессией 10‑бит LZW. Зарезервировано для Pixar.
...
Pixar с компрессией 11‑бит ZIP. Зарезервировано для Pixar.
