---
title: "Единицы разрешения TIFF"
second_title: "Aspose.PSD for Java API Справочник"
description: "Перечисление единицы разрешения Tiff"
type: docs
weight: 23
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffresolutionunits/
---
...
Перечисление единицы разрешения Tiff
## Поля

| Поле | Описание |
| --- | --- |
| [Centimeter](#Centimeter) | Метрическая система. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inch](#Inch) | Английская система. |
| [None](#None) | Нет значимых единиц. |
## Методы
