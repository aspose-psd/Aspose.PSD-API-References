...
type: docs
weight: 21
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tiffplanarconfigs/
---
...
Возможные значения тега PLANARCONFIG.
## Поля

| Поле | Описание |
| --- | --- |
| [Contiguous](#Contiguous) | Одна плоскость изображения. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Separate](#Separate) | Отдельные плоскости данных. |
## Методы
