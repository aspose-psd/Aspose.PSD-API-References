...
description: "Указывает стандарты формата файла TIFF."
type: docs
weight: 16
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
| Поле | Описание |
| --- | --- |
| [Baseline](#Baseline) | Базовый стандарт файла TIFF 6.0. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extended](#Extended) | Расширенный стандарт файла TIFF 6.0. |
## Методы
...
Базовый стандарт файла TIFF 6.0. Этот стандарт официально известен как TIFF 6.0, часть 1: Baseline TIFF.
...
Расширенный стандарт файла TIFF 6.0. Этот стандарт официально известен как Extended TIFF 6.0, часть 2: TIFF Extensions.
