...
description: "Порядок данных внутри байта. Возможные значения для тега FILLORDER."
type: docs
weight: 17
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/tifffillorders/
---
...
Порядок данных внутри байта.

Возможные значения тега FILLORDER.
## Поля

| Поле | Описание |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Lsb2Msb](#Lsb2Msb) | Наименее значимый -> наиболее значимый. |
| [Msb2Lsb](#Msb2Lsb) | Наиболее значимый -> наименее значимый. |
## Методы
...
Наименее значимый -> наиболее значимый.
