...
description: "Опции кодирования факса CCITT Group 3/4. Возможные значения для тегов GROUP3OPTIONS / TiffTag.T4OPTIONS и TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
Параметры для кодирования факса CCITT Group 3/4.

Возможные значения для тегов GROUP3OPTIONS / TiffTag.T4OPTIONS и TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS.
## Поля

| Поле | Описание |
| --- | --- |
| [Encoding1D](#Encoding1D) | Одномерное кодирование. |
| [Encoding2D](#Encoding2D) | Двумерное кодирование. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | Заполнить до границы байта. |
| [Uncompressed](#Uncompressed) | Данные не сжаты. |
## Методы
...
Одномерное кодирование. (по умолчанию)
