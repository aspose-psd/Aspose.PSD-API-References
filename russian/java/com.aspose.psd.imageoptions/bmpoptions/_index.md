...
description: "Параметры создания формата файла bmp."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.imageoptions/bmpoptions/
---
...
Параметры создания формата файла bmp.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [BmpOptions()](#BmpOptions--) | Инициализирует новый экземпляр класса BmpOptions. |
| [BmpOptions(BmpOptions bmpOptions)](#BmpOptions-com.aspose.psd.imageoptions.BmpOptions-) | Инициализирует новый экземпляр класса BmpOptions. |
## Методы
...
| [setCompression(long value)](#setCompression-long-) | Получает или задаёт сжатие. |
...
| --- | --- | --- |
| bmpOptions | [BmpOptions](../../com.aspose.psd.imageoptions/bmpoptions) | Опции BMP. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Количество бит на пиксель изображения. |
