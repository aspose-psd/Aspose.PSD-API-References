...
type: docs
weight: 11
url: /ru/java/com.aspose.psd.imageoptions/cmxrasterizationoptions/
---
...
| --- | --- |
| [CmxRasterizationOptions()](#CmxRasterizationOptions--) | Инициализирует новый экземпляр класса [CmxRasterizationOptions](../../com.aspose.psd.imageoptions/cmxrasterizationoptions). |
## Методы
...
Инициализирует новый экземпляр класса [CmxRasterizationOptions](../../com.aspose.psd.imageoptions/cmxrasterizationoptions).
