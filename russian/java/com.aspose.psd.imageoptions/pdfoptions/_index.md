...
type: docs
weight: 18
url: /ru/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| --- | --- |
| [PdfOptions()](#PdfOptions--) | Инициализирует новый экземпляр класса [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions). |
## Методы
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | Получает основные параметры PDF. |
...
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | Основные параметры PDF |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | Получает или задает метаданные документа. |
...
Инициализирует новый экземпляр класса [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions).
...
Получает основные параметры PDF.
