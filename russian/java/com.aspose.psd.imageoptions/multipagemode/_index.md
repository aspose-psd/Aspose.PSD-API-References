...
type: docs
weight: 16
url: /ru/java/com.aspose.psd.imageoptions/multipagemode/
---
...
| Поле | Описание |
| --- | --- |
| [AllPages](#AllPages) | Использованы все страницы |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pages](#Pages) | Использованы индексы страниц |
| [Range](#Range) | Использован диапазон страниц |
| [TimeInterval](#TimeInterval) | Использованы страницы во временном интервале |
| [Titles](#Titles) | Использованы заголовки страниц |
## Методы
...
Использованы страницы во временном интервале
...
Использованы заголовки страниц
