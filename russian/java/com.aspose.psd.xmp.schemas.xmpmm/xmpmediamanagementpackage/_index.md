...
description: "Представляет пространство имён XMP Media Management."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.xmp.schemas.xmpmm/xmpmediamanagementpackage/
---
...
Представляет пространство имён XMP Media Management.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [XmpMediaManagementPackage()](#XmpMediaManagementPackage--) | Инициализирует новый экземпляр класса  XmpMediaManagementPackage . |
## Методы
...
| [setDerivedFrom(ResourceRef resourceRef)](#setDerivedFrom-com.aspose.psd.xmp.types.complex.resourceref.ResourceRef-) | Устанавливает значение derived from. |
| [setDocumentId(String guid)](#setDocumentId-java.lang.String-) | Устанавливает идентификатор документа. |
| [setDocumentId(UUID guid)](#setDocumentId-java.util.UUID-) | Устанавливает идентификатор документа. |
| [setDocumentId_internalized(System.Guid guid)](#setDocumentId-internalized-com.aspose.ms.System.Guid-) |  |
| [setInstanceId(String guid)](#setInstanceId-java.lang.String-) | Устанавливает идентификатор экземпляра. |
| [setInstanceId(UUID guid)](#setInstanceId-java.util.UUID-) | Устанавливает идентификатор экземпляра. |
| [setInstanceId_internalized(System.Guid guid)](#setInstanceId-internalized-com.aspose.ms.System.Guid-) |  |
| [setOriginalDocumentId(String guid)](#setOriginalDocumentId-java.lang.String-) | Устанавливает идентификатор оригинального документа. |
| [setOriginalDocumentId(UUID guid)](#setOriginalDocumentId-java.util.UUID-) | Устанавливает идентификатор оригинального документа. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| resourceRef | [ResourceRef](../../com.aspose.psd.xmp.types.complex.resourceref/resourceref) | Ссылка на ресурс. |
