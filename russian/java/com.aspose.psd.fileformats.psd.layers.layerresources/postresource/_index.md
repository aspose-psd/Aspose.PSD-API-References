...
description: "Класс PostResource."
type: docs
weight: 71
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
Класс PostResource. Настройки постеризации слоя.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PostResource()](#PostResource--) | Инициализирует новый экземпляр класса [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource). |
## Поля
...
Инициализирует новый экземпляр класса [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource).
...
**Returns:**
short — значение Levels типа int.
