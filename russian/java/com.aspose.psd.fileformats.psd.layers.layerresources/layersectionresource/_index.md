...
description: "Ресурс секции слоя."
type: docs
weight: 43
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Инициализирует новый экземпляр класса [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Инициализирует новый экземпляр класса [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Поля
...
| [getSectionType()](#getSectionType--) | Получает или задает тип секции. |
| [getSignature()](#getSignature--) | Получает подпись ресурса слоя. |
| [getSubtype()](#getSubtype--) | Получает или задает подтип. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Получает или задает тип секции. |
| [setSubtype(int value)](#setSubtype-int-) | Получает или задает подтип. |
...
Инициализирует новый экземпляр класса [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
Получает или задает тип секции.
