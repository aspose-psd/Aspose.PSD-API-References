...
description: "Базовый класс для ресурсов слоя заполнения"
type: docs
weight: 30
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/filllayerresource/
---
...
Базовый класс для ресурсов слоя заполнения
## Поля
