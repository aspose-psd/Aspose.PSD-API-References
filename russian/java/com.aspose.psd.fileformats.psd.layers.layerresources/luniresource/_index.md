...
type: docs
weight: 58
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| --- | --- |
| [LuniResource()](#LuniResource--) | Инициализирует новый экземпляр класса [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource). |
## Поля
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Получает или задает данные. |
...
Инициализирует новый экземпляр класса [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource).
