...
type: docs
weight: 82
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Инициализирует новый экземпляр класса [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource). |
## Поля
...
Инициализирует новый экземпляр класса [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource).
