...
description: "Ресурс Filter Effects содержит каналы, пользовательскую маску и листовую маску для умного фильтра."
type: docs
weight: 29
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Инициализирует новый экземпляр класса [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource). |
## Поля

| Поле | Описание |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | Ключ информации инструмента типа FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | Ключ информации инструмента типа FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Получает маски эффектов фильтра. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Получает маски эффектов фильтра. |
...
Инициализирует новый экземпляр класса [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource).
...
| version | int | Версия. |
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Маски эффектов фильтра. |
...
Ключ информации инструмента типа FEid.
...
Ключ информации инструмента типа FXid.
