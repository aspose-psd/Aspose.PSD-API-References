...
description: "Класс InfxResource."
type: docs
weight: 39
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Инициализирует новый экземпляр класса [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource()](#InfxResource--) | Инициализирует новый экземпляр класса [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Инициализирует новый экземпляр класса [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
## Поля
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Получает или задает значение, указывающее, [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Получает или задает значение, указывающее, [blend interior elements]. |
...
Инициализирует новый экземпляр класса [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| blendInteriorElements | boolean | если установлено в  true  [blend interior elements]. |
...
Инициализирует новый экземпляр класса [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). С пользовательским или неизвестным значением
