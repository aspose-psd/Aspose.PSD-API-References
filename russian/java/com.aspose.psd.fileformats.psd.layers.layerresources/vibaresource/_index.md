...
type: docs
weight: 83
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| --- | --- |
| [VibAResource()](#VibAResource--) | Инициализирует новый экземпляр класса [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource). |
## Поля
...
| [getSaturation()](#getSaturation--) | Получает или задает значение насыщенности |
| [getSignature()](#getSignature--) | Получает подпись ресурса слоя. |
| [getVibrance()](#getVibrance--) | Получает или задает значение яркости |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | Получает или задает значение насыщенности |
| [setVibrance(int value)](#setVibrance-int-) | Получает или задает значение яркости |
...
Инициализирует новый экземпляр класса [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource).
