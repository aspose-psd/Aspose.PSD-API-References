...
type: docs
weight: 51
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Инициализирует новый экземпляр класса [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Инициализирует новый экземпляр класса [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Поля
...
| [getValue()](#getValue--) | Получает значение как LnsrResourceType, если соответствующий перечислимый тип описан. |
| [hashCode()](#hashCode--) |  |
...
Инициализирует новый экземпляр класса [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| lnsrResourceType | int | Тип LNSR. |
...
Инициализирует новый экземпляр класса [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). С пользовательским или неизвестным значением
...
Получает значение как LnsrResourceType, если соответствующий перечислимый тип описан. В противном случае возвращает Unknown.

Значение: значение как LnsrResourceType
