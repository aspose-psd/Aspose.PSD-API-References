...
description: "Ресурс Imfx Multi-effects"
type: docs
weight: 38
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource/
---
...
| --- | --- |
| [ImfxResource()](#ImfxResource--) | Инициализирует новый экземпляр класса [ImfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource). |
## Поля
...
Инициализирует новый экземпляр класса [ImfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource).
