...
description: "Класс LclrResource."
type: docs
weight: 46
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
Класс LclrResource. Этот ресурс содержит информацию о цвете слоя в списке слоёв PS. Это единственное
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LclrResource()](#LclrResource--) | Инициализирует новый экземпляр класса [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(short color)](#LclrResource-short-) | Инициализирует новый экземпляр класса [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(byte[] data)](#LclrResource-byte---) | Инициализирует новый экземпляр класса [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
## Поля
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Получает или задаёт цвет слоя. |
...
| [setColor(short value)](#setColor-short-) | Получает или задаёт цвет слоя. |
...
Инициализирует новый экземпляр класса [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource).
