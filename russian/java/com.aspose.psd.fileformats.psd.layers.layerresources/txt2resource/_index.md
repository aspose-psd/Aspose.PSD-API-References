...
type: docs
weight: 76
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource/
---
...
| --- | --- |
| [Txt2Resource()](#Txt2Resource--) | Создаёт новый экземпляр класса [Txt2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource). |
## Поля
...
| Метод | Описание |
| --- | --- |
| [addTextRecord(String text, RectangleF bounds)](#addTextRecord-java.lang.String-com.aspose.psd.RectangleF-) | Добавляет запись текста в Resource и возвращает идентификатор записи текста. |
...
| [getKeys_internalized(System.Collections.Generic.Dictionary<String,Object> tree)](#getKeys-internalized-com.aspose.ms.System.Collections.Generic.Dictionary-java.lang.String-java.lang.Object--) | Получает, сжат ли ресурс. |
| [getLength()](#getLength--) | Получает длину ресурса слоя в байтах. |
| [getParsedTxt2Model_internalized()](#getParsedTxt2Model-internalized--) | Разбирает данные txt2 в экземпляр класса Txt2DataRoot. |
...
| [getTextData()](#getTextData--) | Получает запись текста из данных ресурса. |
| [getText_internalized()](#getText-internalized--) | Получает или задает имя. |
| [getTxt2FromParsedTree_internalized(System.Collections.Generic.Dictionary<String,Object> tree)](#getTxt2FromParsedTree-internalized-com.aspose.ms.System.Collections.Generic.Dictionary-java.lang.String-java.lang.Object--) | Получает TXT2 из разобранного дерева. |
| [getTxt2ParsedTree_internalized()](#getTxt2ParsedTree-internalized--) | Получает разобранное дерево TXT2. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [removeTextRecord_internalized(int textIndex)](#removeTextRecord-internalized-int-) | Удаляет запись текста из Resource. |
...
| [setText_internalized(String value)](#setText-internalized-java.lang.String-) | Получает или задает имя. |
| [toString()](#toString--) | Возвращает объект String, представляющий этот экземпляр. |
| [updateTextData_internalized(int textIndex, String newText, double fontSize, Color color)](#updateTextData-internalized-int-java.lang.String-double-com.aspose.psd.Color-) | Обновляет запись текста по индексу текста новыми данными текста по умолчанию, а также новым текстом, размером шрифта и цветом. |
| [updateTxt2DataFromModel_internalized(Txt2DataRoot txt2DataRoot)](#updateTxt2DataFromModel-internalized-com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot-) | Обновляет данные txt2 из модели Txt2DataRoot. |
| [wait()](#wait--) |  |
...
Создаёт новый экземпляр класса [Txt2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource).
...
Добавляет запись текста в Resource и возвращает идентификатор записи текста.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| текст | java.lang.String | Текст записи. |
| bounds | [RectangleF](../../com.aspose.psd/rectanglef) | Границы. |

**Returns:**
int - Возвращает Id записи текста для ресурса
...
Получает, сжат ли ресурс.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| дерево | com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> | Дерево. |

**Returns:**
com.aspose.internal.fileformats.psd.layers.layerresources.ITextEngineKeys - Возвращает объект с ключами.
### getLength() {#getLength--}
```
...
Разбирает данные txt2 в экземпляр класса Txt2DataRoot.

**Returns:**
com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot - Данные txt2 в виде экземпляра класса Txt2DataRoot.
...
Получает запись текста из данных ресурса.

**Returns:**
java.lang.String[] - Массив записей текста.
...
Получает TXT2 из разобранного дерева.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| дерево | com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> | Дерево данных. |

**Returns:**
java.lang.String - Данные Txt2.
...
Получает разобранное дерево TXT2.

**Returns:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> - Разобранное дерево
### hashCode() {#hashCode--}
```
...
Удаляет запись текста из Resource.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| textIndex | int | Индекс текстовой записи для удаления. |
...
Обновляет запись текста по индексу текста новыми данными текста по умолчанию, а также новым текстом, размером шрифта и цветом.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| textIndex | int | Индекс текстовой записи в ресурсных данных txt2. |
| newText | java.lang.String | Новый текст. |
| fontSize | double | новый размер шрифта. |
| color | [Color](../../com.aspose.psd/color) | Новый цвет текста. |
...
Обновляет данные txt2 из модели Txt2DataRoot.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| txt2DataRoot | com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot | Модель данных txt2. |
