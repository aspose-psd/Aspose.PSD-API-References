...
description: "Класс ExpaResource."
type: docs
weight: 28
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
Класс ExpaResource. Ресурс слоя коррекции экспозиции
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | Инициализирует новый экземпляр класса [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | Инициализирует новый экземпляр класса [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | Инициализирует новый экземпляр класса [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
## Поля
...
| [getExposure()](#getExposure--) | Получает или задает экспозицию. |
| [getGammaCorrection()](#getGammaCorrection--) | Получает или задает гамму. |
...
| [setExposure(float value)](#setExposure-float-) | Получает или задает экспозицию. |
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Получает или задает гамму. |
...
| [setOffset(float value)](#setOffset-float-) | Получает или задает смещение. |
...
Инициализирует новый экземпляр класса [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource).
