...
description: "Возможные цвета настройки цвета листа."
type: docs
weight: 73
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Возможные цвета настройки Sheet color. Это декоративный цвет интерфейса слоя в списке слоёв в Photoshop.
## Поля
...
| [Gray](#Gray) | Серый цвет. |
| [Green](#Green) | Зелёный цвет. |
| [NoColor](#NoColor) | Цвет не указан. |
| [Orange](#Orange) | Оранжевый цвет. |
| [Red](#Red) | Красный цвет. |
| [Violet](#Violet) | Фиолетовый цвет. |
| [Yellow](#Yellow) | Жёлтый цвет. |
## Методы
