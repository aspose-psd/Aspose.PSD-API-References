...
description: "Класс KnkoResource."
type: docs
weight: 41
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Класс KnkoResource. Этот ресурс содержит информацию о смешивании обрезанного элемента.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | Инициализирует новый экземпляр класса [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource()](#KnkoResource--) | Инициализирует новый экземпляр класса [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | Инициализирует новый экземпляр класса [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
## Поля
...
| [getKnockout()](#getKnockout--) | Получает или задает значение, указывающее, [blend interior elements]. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | Получает или задает значение, указывающее, [blend interior elements]. |
...
Инициализирует новый экземпляр класса [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| нокаут | boolean | если установлено в  true  [blend interior elements]. |
...
Инициализирует новый экземпляр класса [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). С пользовательским или неизвестным значением
...
Получает или задает значение, указывающее, [blend interior elements].

Значение:  true  если [blend interior elements]; иначе,  false .
