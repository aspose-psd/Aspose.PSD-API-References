...
type: docs
weight: 11
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Поле | Описание |
| --- | --- |
| [StructureKey](#StructureKey) | Определяет ключ структуры AnDs. |
## Методы
...
| [getItems()](#getItems--) | Получает или задает структуры раздела анимированных данных. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Получает или задает структуры раздела анимированных данных. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Получает или задает неизвестные 3 байта, которые существуют, когда количество кадров нечётное. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Определяет ключ структуры AnDs.
...
Проверяет, что количество кадров в структуре списка 'FrIn' нечётное.
...
Получает или задает структуры раздела анимированных данных.
...
Получает или задает неизвестные 3 байта, которые существуют, когда количество кадров нечётное.
