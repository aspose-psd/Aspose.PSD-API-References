...
type: docs
weight: 21
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/
---
...
| --- | --- |
| [CmlsResource(byte[] data)](#CmlsResource-byte---) | Инициализирует новый экземпляр класса [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource). |
## Поля
...
Инициализирует новый экземпляр класса [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource).
