...
description: "Базовый ресурс эффектов"
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Инициализирует новый экземпляр класса [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource). |
## Поля
...
Инициализирует новый экземпляр класса [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| resourceKey | int | Ключ ресурса. |
