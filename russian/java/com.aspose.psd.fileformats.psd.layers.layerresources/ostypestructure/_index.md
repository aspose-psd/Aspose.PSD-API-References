...
type: docs
weight: 64
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
...
| --- | --- |
| [OSTypeStructure(ClassID keyName)](#OSTypeStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Инициализирует новый экземпляр класса [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure). |
## Методы
...
Инициализирует новый экземпляр класса [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure).
