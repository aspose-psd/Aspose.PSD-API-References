...
description: "Ресурс, представляющий версию Photoshop слоя."
type: docs
weight: 60
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
Ресурс, представляющий версию Photoshop слоя.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | Инициализирует новый экземпляр класса [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource). |
## Поля
...
| [getVersion()](#getVersion--) | Получает или задает версию Photoshop слоя. |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | Получает или задает версию Photoshop слоя. |
...
Инициализирует новый экземпляр класса [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource).
...
Получает или задает версию Photoshop слоя.
