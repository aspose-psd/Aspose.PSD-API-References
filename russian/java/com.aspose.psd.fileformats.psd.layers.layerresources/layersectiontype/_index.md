...
description: "Тип секции слоя"
type: docs
weight: 45
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectiontype/
---
...
| Поле | Описание |
| --- | --- |
| [ClosedFolder](#ClosedFolder) | Закрытая папка. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Layer](#Layer) | Слой. |
| [OpenFolder](#OpenFolder) | Открытая папка. |
| [SectionDivider](#SectionDivider) | Разделитель секций. |
## Методы
