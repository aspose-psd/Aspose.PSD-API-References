...
description: "Ресурс слоя lsdk, вложенный ресурс секции слоя."
type: docs
weight: 56
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
Ресурс слоя lsdk (вложенный ресурс секции слоя).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Инициализирует новый экземпляр класса [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Инициализирует новый экземпляр класса [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
## Поля
...
Инициализирует новый экземпляр класса [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource).
