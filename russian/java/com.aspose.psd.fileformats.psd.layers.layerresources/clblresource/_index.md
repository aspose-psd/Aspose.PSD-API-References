...
description: "Класс ClblResource."
type: docs
weight: 20
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
| --- | --- |
| [ClblResource()](#ClblResource--) | Инициализирует новый экземпляр класса [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Инициализирует новый экземпляр класса [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Инициализирует новый экземпляр класса [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Поля
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Получает или задаёт значение, указывающее, следует ли [blend clipped elements]. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | Получает или задает значение, указывающее, является ли значение [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) истинным или ложным |
| [hashCode()](#hashCode--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Получает или задаёт значение, указывающее, следует ли [blend clipped elements]. |
...
| [setValue(boolean value)](#setValue-boolean-) | Получает или задает значение, указывающее, является ли значение [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) истинным или ложным |
...
Инициализирует новый экземпляр класса [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
| --- | --- | --- |
| blendClippedElements | boolean | если установлено в  true  [blend clipped elements]. |
...
Инициализирует новый экземпляр класса [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). С пользовательским или неизвестным значением
...
Получает или задаёт значение, указывающее, следует ли [blend clipped elements].

Значение:  true  если [blend clipped elements]; иначе,  false .
...
Получает или задает значение, указывающее, является ли значение [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) истинным или ложным

Значение:  true  если значение истинно; иначе,  false .
