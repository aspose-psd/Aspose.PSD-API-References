...
description: "Класс FxrpResource."
type: docs
weight: 32
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Инициализирует новый экземпляр класса [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Инициализирует новый экземпляр класса [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Инициализирует новый экземпляр класса [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Поля
...
| [getX()](#getX--) | Получает или задает x точки привязки |
| [getY()](#getY--) | Получает или задает y точки привязки |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Сохраняет в указанный контейнер потока. |
...
| [setX(double value)](#setX-double-) | Получает или задает x точки привязки |
| [setY(double value)](#setY-double-) | Получает или задает y точки привязки |
...
Инициализирует новый экземпляр класса [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| x | double | Координата x точки привязки |
| y | double | Координата y точки привязки |
...
Инициализирует новый экземпляр класса [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). С пользовательским или неизвестным значением
...
Получает или задает x точки привязки

Значение: x точки привязки
...
Получает или задает y точки привязки

Значение: y точки привязки
