...
description: "Защищённые настройки слоя"
type: docs
weight: 57
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
Защищённые настройки слоя
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | Инициализирует новый экземпляр класса [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | Инициализирует новый экземпляр класса [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource()](#LspfResource--) | Инициализирует новый экземпляр класса [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
## Поля
...
| [TypeToolKey](#TypeToolKey) | Ключ типа инструмента 1819504742 |
...
| [getLockType()](#getLockType--) | Получает или задает тип блокировки. |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | Получает или задает значение, указывающее, защищён ли этот экземпляр от составной защиты. |
| [isPositionProtected()](#isPositionProtected--) | Получает или задает значение, указывающее, защищён ли этот экземпляр от защиты позиции. |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | Получает или задает значение, указывающее, защищён ли этот экземпляр от защиты прозрачности. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | Получает или задает значение, указывающее, защищён ли этот экземпляр от составной защиты. |
...
| [setLockType(int value)](#setLockType-int-) | Получает или задает тип блокировки. |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | Получает или задает значение, указывающее, защищён ли этот экземпляр от защиты позиции. |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | Получает или задает значение, указывающее, защищён ли этот экземпляр от защиты прозрачности. |
...
Инициализирует новый экземпляр класса [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). С пользовательским или неизвестным значением.
...
Инициализирует новый экземпляр класса [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| isTransparencyProtected | boolean | если установлено в  true  [is transparency protected]. |
| isCompositeProtected | boolean | если установлено в  true  [is composite protected]. |
| isPositionProtected | boolean | если установлено в  true  [is position protected]. |
...
Ключ типа инструмента 1819504742
...
Получает или задает значение, указывающее, защищён ли этот экземпляр от составной защиты.

Значение:  true  если этот экземпляр защищён композитом; иначе  false .
...
Получает или задает значение, указывающее, защищён ли этот экземпляр от защиты позиции.

Значение:  true  если этот экземпляр защищён позицией; иначе  false .
...
Получает или задает значение, указывающее, защищён ли этот экземпляр от защиты прозрачности.

Значение:  true  если этот экземпляр защищён прозрачностью; иначе  false .
