...
description: "Класс IopaResource."
type: docs
weight: 40
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
| --- | --- |
| [IopaResource()](#IopaResource--) | Инициализирует новый экземпляр класса [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Инициализирует новый экземпляр класса [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
## Поля
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Получает или задает непрозрачность заливки. |
...
Инициализирует новый экземпляр класса [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).
...
| --- | --- | --- |
| данные | byte[] | Сырые байтовые данные. |
...
Значение: непрозрачность заливки.
