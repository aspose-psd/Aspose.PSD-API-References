...
type: docs
weight: 13
url: /ru/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Инициализирует новый экземпляр класса [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Поля
...
| [getDigest()](#getDigest--) | Получает или задает дайджест. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Получает или задает дайджест. |
