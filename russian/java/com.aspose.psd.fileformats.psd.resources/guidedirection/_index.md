...
type: docs
weight: 21
url: /ru/java/com.aspose.psd.fileformats.psd.resources/guidedirection/
---
...
| [Horizontal](#Horizontal) | Горизонтальное направление направляющей. |
| [Vertical](#Vertical) | Вертикальное направление направляющей. |
## Методы
...
Горизонтальное направление направляющей.
...
Вертикальное направление направляющей.
