...
description: "Ресурс цветовой передачи"
type: docs
weight: 15
url: /ru/java/com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
Ресурс цветовой передачи
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource--) | Инициализирует новый экземпляр класса [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource). |
## Поля
...
| [getClass()](#getClass--) |  |
| [getColorTransferData()](#getColorTransferData--) | Получает или задает данные цветовой трансформации. |
...
| [setColorTransferData(byte[] value)](#setColorTransferData-byte---) | Получает или задает данные цветовой трансформации. |
...
Инициализирует новый экземпляр класса [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource).
...
Получает или задает данные цветовой трансформации.

Значение: Данные цветовой трансформации.
