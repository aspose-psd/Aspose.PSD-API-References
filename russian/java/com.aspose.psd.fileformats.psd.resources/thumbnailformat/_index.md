...
description: "Указывает формат данных миниатюры."
type: docs
weight: 35
url: /ru/java/com.aspose.psd.fileformats.psd.resources/thumbnailformat/
---
...
| [KJpegRgb](#KJpegRgb) | Сжатый формат JPEG. |
| [KRawRgb](#KRawRgb) | Необработанный формат RGB. |
## Методы
