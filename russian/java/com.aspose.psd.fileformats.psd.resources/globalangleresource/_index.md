...
description: "Ресурс глобального угла"
type: docs
weight: 19
url: /ru/java/com.aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| --- | --- |
| [GlobalAngleResource()](#GlobalAngleResource--) | Инициализирует новый экземпляр класса [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource). |
## Поля
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | Получает или задает глобальный угол. |
...
Инициализирует новый экземпляр класса [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource).
