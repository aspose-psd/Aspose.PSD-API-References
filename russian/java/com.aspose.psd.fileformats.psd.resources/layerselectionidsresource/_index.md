...
description: "Ресурс идентификаторов выбора слоёв"
type: docs
weight: 27
url: /ru/java/com.aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
Ресурс идентификаторов выбора слоёв
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource--) | Инициализирует новый экземпляр класса [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource). |
## Поля
...
| [getLayerIds()](#getLayerIds--) | Получает или задает идентификаторы слоёв. |
...
| [setCount(short value)](#setCount-short-) | Получает или задает количество. |
...
| [setLayerIds(int[] value)](#setLayerIds-int---) | Получает или задает идентификаторы слоёв. |
...
Инициализирует новый экземпляр класса [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource).
...
Получает или задает идентификаторы слоёв.

Значение: Идентификаторы слоёв.
