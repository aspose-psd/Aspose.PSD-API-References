...
type: docs
weight: 44
url: /ru/java/com.aspose.psd.fileformats.psd.resources/xmpresource/
---
...
| --- | --- |
| [XmpResource()](#XmpResource--) | Инициализирует новый экземпляр класса [XmpResource](../../com.aspose.psd.fileformats.psd.resources/xmpresource). |
## Поля
...
Инициализирует новый экземпляр класса [XmpResource](../../com.aspose.psd.fileformats.psd.resources/xmpresource).
