...
description: "Ресурс глобальной высоты"
type: docs
weight: 18
url: /ru/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
Ресурс глобальной высоты
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | Инициализирует новый экземпляр класса [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource). |
## Поля
...
| [getAltitude()](#getAltitude--) | Получает или задает высоту. |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | Получает или задает высоту. |
...
Инициализирует новый экземпляр класса [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource).
