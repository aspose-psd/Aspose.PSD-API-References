...
description: "Ресурс соотношения сторон пикселя"
type: docs
weight: 29
url: /ru/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
Ресурс соотношения сторон пикселя
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | Инициализирует новый экземпляр класса [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Поля
...
| [getAspectRatio()](#getAspectRatio--) | Получает или задает соотношение сторон. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | Получает или задает соотношение сторон. |
