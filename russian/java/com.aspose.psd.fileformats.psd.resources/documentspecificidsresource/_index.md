...
description: "Ресурс специфических идентификаторов документа"
type: docs
weight: 16
url: /ru/java/com.aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
...
Ресурс специфических идентификаторов документа
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [DocumentSpecificIdsResource()](#DocumentSpecificIdsResource--) | Инициализирует новый экземпляр класса [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource). |
## Поля
...
| [getId()](#getId--) | Получает или задает идентификатор. |
...
| [setId(int value)](#setId-int-) | Получает или задает идентификатор. |
...
Инициализирует новый экземпляр класса [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource).
