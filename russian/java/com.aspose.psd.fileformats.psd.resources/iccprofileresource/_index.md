...
type: docs
weight: 23
url: /ru/java/com.aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| --- | --- |
| [IccProfileResource()](#IccProfileResource--) | Инициализирует новый экземпляр класса [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource). |
## Поля
...
| [getIccProfile()](#getIccProfile--) | Получает или задает ICC‑профиль. |
...
| [setIccProfile(byte[] value)](#setIccProfile-byte---) | Получает или задает ICC‑профиль. |
...
Инициализирует новый экземпляр класса [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource).
...
Получает или задает ICC‑профиль.

Значение: ICC‑профиль.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | com.aspose.ms.System.IO.MemoryStream |  |
