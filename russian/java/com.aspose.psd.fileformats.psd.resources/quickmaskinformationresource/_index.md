...
description: "Ресурс информации о быстрой маске"
type: docs
weight: 32
url: /ru/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Ресурс информации о быстрой маске
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Инициализирует новый экземпляр класса [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource). |
## Поля
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Получает или задает значение, указывающее, является ли данный экземпляр пустой маской. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Получает или задает значение, указывающее, является ли данный экземпляр пустой маской. |
...
Инициализирует новый экземпляр класса [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource).
...
Получает или задает значение, указывающее, является ли данный экземпляр пустой маской.

Значение:  true  если данный экземпляр является пустой маской; иначе,  false .
