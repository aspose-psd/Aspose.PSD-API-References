...
description: "Ресурс информации о состоянии слоёв"
type: docs
weight: 28
url: /ru/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | Инициализирует новый экземпляр класса [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource). |
## Поля
...
| [getLayerIndex()](#getLayerIndex--) | Получает или задает индекс слоя. |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | Получает или задает индекс слоя. |
...
Инициализирует новый экземпляр класса [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource).
