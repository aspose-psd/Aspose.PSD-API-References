...
description: "Ресурс имён Unicode alpha"
type: docs
weight: 38
url: /ru/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
Ресурс имён Unicode alpha
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | Инициализирует новый экземпляр класса [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource). |
## Поля
...
| [getAlphaNames()](#getAlphaNames--) | Получает или задает альфа-имена. |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | Получает или задает альфа-имена. |
...
Инициализирует новый экземпляр класса [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource).
