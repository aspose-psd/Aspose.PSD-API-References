...
description: "Ресурс полутонов"
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | Инициализирует новый экземпляр класса [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource). |
## Поля
...
| [getHalftoneData()](#getHalftoneData--) | Получает или задаёт данные полутонов. |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | Получает или задаёт данные полутонов. |
...
Инициализирует новый экземпляр класса [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource).
...
Получает или задаёт данные полутонов.

Значение: Данные полутонов.
