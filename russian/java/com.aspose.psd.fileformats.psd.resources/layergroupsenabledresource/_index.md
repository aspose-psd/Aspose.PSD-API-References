...
description: "Ресурс включённых групп слоёв"
type: docs
weight: 26
url: /ru/java/com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
| --- | --- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource--) | Инициализирует новый экземпляр класса [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource). |
## Поля
...
| [getIDs()](#getIDs--) | Получает или задает идентификаторы. |
...
| [setIDs(byte[] value)](#setIDs-byte---) | Получает или задает идентификаторы. |
...
Инициализирует новый экземпляр класса [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource).
...
Получает или задает идентификаторы.
