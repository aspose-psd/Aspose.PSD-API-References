...
description: "Блок ресурса миниатюры."
type: docs
weight: 36
url: /ru/java/com.aspose.psd.fileformats.psd.resources/thumbnailresource/
---
...
| --- | --- |
| [ThumbnailResource()](#ThumbnailResource--) | Инициализирует новый экземпляр класса [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource). |
## Поля
...
Инициализирует новый экземпляр класса [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource).
