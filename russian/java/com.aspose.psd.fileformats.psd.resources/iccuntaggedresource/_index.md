...
description: "Ресурс без тегов ICC"
type: docs
weight: 24
url: /ru/java/com.aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
Ресурс без тегов ICC
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [IccUntaggedResource()](#IccUntaggedResource--) | Инициализирует новый экземпляр класса [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource). |
## Поля
...
| [getProfile()](#getProfile--) | Получает или задает профиль. |
...
| [setProfile(byte value)](#setProfile-byte-) | Получает или задает профиль. |
...
Инициализирует новый экземпляр класса [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource).
