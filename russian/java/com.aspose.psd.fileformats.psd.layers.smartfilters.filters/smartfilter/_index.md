...
description: "Класс для обработки базовой логики умных фильтров."
type: docs
weight: 13
url: /ru/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter/
---
...
| --- | --- |
| [SmartFilter()](#SmartFilter--) | Инициализирует новый экземпляр класса [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter). |
## Методы
...
Инициализирует новый экземпляр класса [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter).
