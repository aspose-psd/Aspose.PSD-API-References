...
description: "Фильтр распределения шума."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/noisedistribution/
---
...
Фильтр распределения шума.
## Поля

| Поле | Описание |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gaussian](#Gaussian) | Гауссово распределение шума. |
| [Uniform](#Uniform) | Равномерное распределение шума. |
## Методы
...
Равномерное распределение шума.
