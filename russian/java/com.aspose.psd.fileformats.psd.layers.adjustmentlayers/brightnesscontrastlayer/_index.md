...
description: "Слой яркости/контраста."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
Получает или задает яркость. Для PS диапазон яркости от -150 до +150. Но мы игнорируем это.
...
Получает или задает контраст. Для PS диапазон контраста от -50 до +100. Но мы игнорируем это.
