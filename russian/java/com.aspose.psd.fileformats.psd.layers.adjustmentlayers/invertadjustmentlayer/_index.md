...
description: "Класс слоя коррекции инверсии."
type: docs
weight: 21
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Обрабатывает слой инверсии. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Применить инвертированные коррекции к указанному массиву int ARGB. |
...
Применить инвертированные коррекции к указанному массиву int ARGB.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| пиксели | int[] | Массив int ARGB. |
