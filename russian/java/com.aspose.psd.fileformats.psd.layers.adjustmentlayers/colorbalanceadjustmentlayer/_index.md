...
description: "Класс слоя коррекции цветового баланса."
type: docs
weight: 16
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
Класс слоя коррекции цветового баланса.
## Поля
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Получает или задает баланс YellowBlue для теней. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Примените коррекции для текущих теней, средних тонов и светлых тонов к указанному массиву int RGB. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Получает или задает баланс YellowBlue для теней. |
...
Получает или задает баланс YellowBlue для теней.
...
Примените коррекции для текущих теней, средних тонов и светлых тонов к указанному массиву int RGB.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| пиксели | int[] | Массив int цвета RGB. |
