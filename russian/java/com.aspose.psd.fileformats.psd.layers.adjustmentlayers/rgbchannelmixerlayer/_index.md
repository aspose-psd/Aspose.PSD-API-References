...
description: "Слой коррекции микшера каналов RGB."
type: docs
weight: 26
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
Слой коррекции микшера каналов RGB.
## Поля
...
| [getBlueChannel()](#getBlueChannel--) | Получает синий канал. |
...
| [getGreenChannel()](#getGreenChannel--) | Получает зелёный канал. |
...
| [getRedChannel()](#getRedChannel--) | Получает красный канал. |
...
Получает индекс канала по. Возвращает RgbMixerChannel
...
Получает зелёный канал.

Значение: Зелёный канал.
