...
description: "Реализация слоя коррекции Vibrance"
type: docs
weight: 30
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
Реализация слоя коррекции Vibrance
## Поля
...
| [getVibrance()](#getVibrance--) | Получает или задаёт яркость. |
...
| [setVibrance(int value)](#setVibrance-int-) | Получает или задаёт яркость. |
...
**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - слой корректировки
