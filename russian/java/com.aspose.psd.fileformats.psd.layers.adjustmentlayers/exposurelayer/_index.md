...
description: "Слой коррекции экспозиции."
type: docs
weight: 18
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | Получает или задаёт экспозицию. |
...
| [getGammaCorrection()](#getGammaCorrection--) | Получает или задаёт коррекцию гаммы. |
...
| [getOffset()](#getOffset--) | Получает или задаёт смещение. |
...
| [setExposure(float value)](#setExposure-float-) | Получает или задаёт экспозицию. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Получает или задаёт коррекцию гаммы. |
...
| [setOffset(float value)](#setOffset-float-) | Получает или задаёт смещение. |
...
Получает или задаёт экспозицию. Для PS диапазон экспозиции от -20 до +20.
...
Получает или задает GammaCorrection. Для PS диапазон GammaCorrection от 9,99 до +0,01.

Значение: GammaCorrection.
...
Получает или задает Offset. Для PS диапазон Offset от -0,5 до +0,5.
