...
description: "Слой коррекции фотофильтра."
type: docs
weight: 24
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [getColor()](#getColor--) | Получает или задает цвет RGB фильтра. |
...
| [getDensity()](#getDensity--) | Получает или задает плотность фильтра. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Получает или задает цвет RGB фильтра. |
...
| [setDensity(int value)](#setDensity-int-) | Получает или задает плотность фильтра. |
...
Получает или задает цвет RGB фильтра.
...
Получает или задает плотность фильтра.
