...
description: "Слой градиентной карты."
type: docs
weight: 19
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
Слой градиентной карты. Обрабатывает рендеринг градиентной карты, используя данные из GrdmResource.
## Поля
...
| [getGradientSettings()](#getGradientSettings--) | Получает или задает экземпляр настроек Gradient, переданный из экземпляра GrdmResource. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Обрабатывает слой градиентной карты. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | Получает или задает экземпляр настроек Gradient, переданный из экземпляра GrdmResource. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Обновить данные слоя в связанном ресурсе слоя [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
Получает или задает экземпляр настроек Gradient, переданный из экземпляра GrdmResource.
...
Обрабатывает слой градиентной карты.
...
Обновить данные слоя в связанном ресурсе слоя [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
