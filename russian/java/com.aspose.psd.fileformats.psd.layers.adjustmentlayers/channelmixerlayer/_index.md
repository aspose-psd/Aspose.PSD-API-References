...
description: "Слой коррекции микшера каналов."
type: docs
weight: 13
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
...
Слой коррекции микшера каналов.
## Поля
...
Получает индекс канала по. Может вернуть RgbMixerChannel или CmykMixerChannel
