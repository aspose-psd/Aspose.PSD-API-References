...
description: "Слой коррекции уровней"
type: docs
weight: 22
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| [getChannel(int index)](#getChannel-int-) | Получает канал. |
...
| [getMasterChannel()](#getMasterChannel--) | Получает основной канал. |
...
Получает основной канал.

Значение: главный канал.
