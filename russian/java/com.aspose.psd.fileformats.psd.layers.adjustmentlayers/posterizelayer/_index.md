...
description: "Слой постеризации."
type: docs
weight: 25
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
| [getLevels()](#getLevels--) | Уровни слоя Posterize. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Обрабатывает слой Posterize. |
...
| [setLevels(short value)](#setLevels-short-) | Уровни слоя Posterize. |
