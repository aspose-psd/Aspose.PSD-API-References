...
description: "Слой коррекции выборочного цвета."
type: docs
weight: 28
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
Слой коррекции выборочного цвета.
## Поля
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Получает cmyk‑коррекцию по выборочному цвету. |
| [getContainer()](#getContainer--) | Получает контейнер  Image  . |
| [getCorrectionMethod()](#getCorrectionMethod--) | Получает или задает метод коррекции. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Обрабатывает слой Selective Color. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Задаёт cmyk‑коррекцию по выборочному цвету. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Устанавливает контейнер Image. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Получает или задает метод коррекции. |
...
Получает cmyk‑коррекцию по выборочному цвету.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| selectiveColorsType | int | Выборочные цвета. |
...
Получает или задает метод коррекции.

Значение: Метод коррекции.
...
Обрабатывает слой Selective Color.
...
Задаёт cmyk‑коррекцию по выборочному цвету.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| selectiveColorsType | int | Тип выборочных цветов. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Cmyk‑коррекция. |
