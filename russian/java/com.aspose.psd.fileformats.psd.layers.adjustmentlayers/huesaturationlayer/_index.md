...
description: "Слой коррекции тона/насыщенности."
type: docs
weight: 20
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
Слой коррекции тона/насыщенности.
## Поля
...
| [getColorize()](#getColorize--) | Получает или задает значение, указывающее, окрашивает ли этот [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) объект. |
...
| [getRange(int index)](#getRange-int-) | Получает диапазон. |
...
| [setColorize(boolean value)](#setColorize-boolean-) | Получает или задает значение, указывающее, окрашивает ли этот [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) объект. |
...
Получает или задает значение, указывающее, окрашивает ли этот [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) объект.

Значение:  true  если colorize; иначе,  false .
