...
description: "Слой коррекции кривых"
type: docs
weight: 17
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | Получает менеджер кривых. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | Получает или задает значение, указывающее, используется ли непрерывный менеджер в этом экземпляре. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | Получает или задает значение, указывающее, используется ли дискретный менеджер в этом экземпляре. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | Получает или задает значение, указывающее, используется ли непрерывный менеджер в этом экземпляре. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | Получает или задает значение, указывающее, используется ли дискретный менеджер в этом экземпляре. |
...
Получает или задает значение, указывающее, используется ли непрерывный менеджер в этом экземпляре.

Значение:  true  если в этом экземпляре используется непрерывный менеджер; иначе,  false .
...
Получает или задает значение, указывающее, используется ли дискретный менеджер в этом экземпляре.

Значение:  true  если в этом экземпляре используется дискретный менеджер; иначе,  false .
...
| пиксели | int[] | Пиксели. |
| start | [Point](../../com.aspose.psd/point) | Начало. |
| end | [Point](../../com.aspose.psd/point) | Конец. |
