...
description: "Слой коррекции микшера каналов CMYK."
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
Слой коррекции микшера каналов CMYK.
## Поля
...
| [getBlackChannel()](#getBlackChannel--) | Получает черный канал. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Получает индекс канала по. |
...
| [getCyanChannel()](#getCyanChannel--) | Получает циановый канал. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Получает пурпурный канал. |
...
| [getMonochrome()](#getMonochrome--) | Получает или задаёт значение, указывающее, является ли этот [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) монохромным. |
...
| [getYellowChannel()](#getYellowChannel--) | Получает желтый канал. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Получает или задаёт значение, указывающее, является ли этот [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) монохромным. |
...
Получает циановый канал.

Значение: Циановый канал.
...
Получает или задаёт значение, указывающее, является ли этот [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) монохромным.

Значение:  true  если монохромный; иначе,  false .
