...
description: "Исключение изображения Gif."
type: docs
weight: 11
url: /ru/java/com.aspose.psd.coreexceptions.imageformats/gifimageexception/
---
...
| --- | --- |
| [GifImageException(String message)](#GifImageException-java.lang.String-) | Инициализирует новый экземпляр класса  GifImageException . |
| [GifImageException(String message, Throwable innerException)](#GifImageException-java.lang.String-java.lang.Throwable-) | Инициализирует новый экземпляр класса  GifImageException . |
## Методы
...
Инициализирует новый экземпляр класса  GifImageException .
