...
type: docs
weight: 13
url: /ru/java/com.aspose.psd.coreexceptions.imageformats/jpegexception/
---
...
| --- | --- |
| [JpegException(String message)](#JpegException-java.lang.String-) | Инициализирует новый экземпляр класса  JpegException . |
| [JpegException(String message, Throwable innerException)](#JpegException-java.lang.String-java.lang.Throwable-) | Инициализирует новый экземпляр класса  JpegException . |
## Методы
...
Инициализирует новый экземпляр класса  JpegException .
