...
type: docs
weight: 12
url: /ru/java/com.aspose.psd.coreexceptions.imageformats/jpeg2000exception/
---
...
| --- | --- |
| [Jpeg2000Exception(String message)](#Jpeg2000Exception-java.lang.String-) | Инициализирует новый экземпляр класса  Jpeg2000Exception . |
| [Jpeg2000Exception(String message, Throwable innerException)](#Jpeg2000Exception-java.lang.String-java.lang.Throwable-) | Инициализирует новый экземпляр класса  Jpeg2000Exception . |
## Методы
...
Инициализирует новый экземпляр класса  Jpeg2000Exception .
