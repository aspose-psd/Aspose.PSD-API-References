...
description: "Модель цвета. Когда тип градиента Noise, мы можем назначить модель цвета: RGB/SHB/LAB 3/4/6"
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.gradient/noisecolormodel/
---
...
Модель цвета: когда 'Gradient type' = 'Noise', мы можем назначить 'Color Model' в RGB/SHB/LAB (3/4/6)
## Поля

| Поле | Описание |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HSB](#HSB) | Модель цвета HSB. |
| [LAB](#LAB) | Модель цвета LAB. |
