...
description: "Ресурс данных содержимого Vector Stroke."
type: docs
weight: 13
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
Ресурс данных содержимого Vector Stroke.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [VscgResource()](#VscgResource--) | Инициализирует новый экземпляр класса [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource). |
## Поля
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Получает или задает имя класса. |
| [getClassName_internalized()](#getClassName-internalized--) | Получает или задает идентификатор класса. |
| [getHeader_internalized()](#getHeader-internalized--) | Получает или задает заголовок. |
| [getItems()](#getItems--) | Получает или задаёт элементы структуры. |
| [getKey()](#getKey--) | Получает ключ ресурса слоя. |
| [getKeyForData()](#getKeyForData--) | Целочисленный ключ, определяющий, какой тип настроек заполнения хранится в ресурсе: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Получает или задает имя класса. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Получает или задает идентификатор класса. |
...
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Получает целочисленный ключ, определяющий, какой тип настроек заполнения хранится в ресурсе: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Предупреждение! Значение свойства KeyForData должно соответствовать типу настроек заполнения, хранящихся в структурах Items. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Внутренний метод, позволяющий назначить только для чтения свойство KeyForData. |
...
Инициализирует новый экземпляр класса [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource).
...
Целочисленный ключ, определяющий, какой тип настроек заполнения хранится в ресурсе: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Внутренний метод, позволяющий назначить только для чтения свойство KeyForData. Должен использоваться только в загрузчике ресурсов Vscg при назначении свойств ресурса.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Целочисленное значение свойства KeyForData. |
