...
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.png/pngcolortype/
---
...
| [Grayscale](#Grayscale) | Представляет тип цвета, где каждый пиксель — образец в градациях серого. |
| [GrayscaleWithAlpha](#GrayscaleWithAlpha) | Представляет тип цвета, где каждый пиксель — образец в градациях серого, за которым следует альфа‑образец. |
| [IndexedColor](#IndexedColor) | Представляет тип цвета, где каждый пиксель — индекс палитры; должен присутствовать блок PLTE. |
| [Truecolor](#Truecolor) | Представляет тип цвета, где каждый пиксель — тройка R,G,B. |
...
Представляет тип цвета, где каждый пиксель — образец в градациях серого.
...
Представляет тип цвета, где каждый пиксель — образец в градациях серого, за которым следует альфа‑образец.
...
Представляет тип цвета, где каждый пиксель — индекс палитры; должен присутствовать блок PLTE.
...
Представляет тип цвета, где каждый пиксель — тройка R,G,B.
