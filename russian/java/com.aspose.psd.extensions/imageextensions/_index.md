...
description: "Содержит методы расширения для преобразований, основанных на java.awt.Image и ."
type: docs
weight: 19
url: /ru/java/com.aspose.psd.extensions/imageextensions/
---
...
Содержит методы расширения для преобразований, основанных на java.awt.Image и [Image](../../com.aspose.psd/image).
## Методы
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toGdiImage(Image image)](#toGdiImage-com.aspose.psd.Image-) | Преобразует [Image](../../com.aspose.psd/image) в java.awt.Image. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| изображение | java.awt.image.BufferedImage |  |
...
Преобразует [Image](../../com.aspose.psd/image) в java.awt.Image.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
|  | image | [Image](../../com.aspose.psd/image) | Элемент [Image](../../com.aspose.psd/image) для преобразования. |

--------------------

Предупреждение, GDI‑изображение может иметь меньшие границы, чем у изображения. Чтобы получить все части изображения, используйте более безопасный метод расширения ToGdiImageFull. |
