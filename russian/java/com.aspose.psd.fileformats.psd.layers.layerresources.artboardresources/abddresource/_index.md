...
description: "Данные о информации Artboard."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource/
---
...
Данные о информации Artboard.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [AbddResource()](#AbddResource--) | Инициализирует новый экземпляр класса [AbddResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource). |
## Поля
...
Инициализирует новый экземпляр класса [AbddResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource).
