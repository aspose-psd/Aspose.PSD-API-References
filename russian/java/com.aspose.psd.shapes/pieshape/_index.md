...
type: docs
weight: 14
url: /ru/java/com.aspose.psd.shapes/pieshape/
---
...
| [PieShape(RectangleF rectangle, float startAngle, float sweepAngle)](#PieShape-com.aspose.psd.RectangleF-float-float-) | Инициализирует новый экземпляр класса PieShape. |
## Методы
