...
type: docs
weight: 17
url: /ru/java/com.aspose.psd.shapes/rectangleshape/
---
...
| --- | --- |
| [RectangleShape()](#RectangleShape--) | Создаёт новый экземпляр класса  RectangleShape . |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.psd.RectangleF-) | Создаёт новый экземпляр класса  RectangleShape . |
## Методы
...
Создаёт новый экземпляр класса  RectangleShape .
