...
type: docs
weight: 11
url: /ru/java/com.aspose.psd.shapes/beziershape/
---
...
| [BezierShape(PointF[] points)](#BezierShape-com.aspose.psd.PointF---) | Инициализирует новый экземпляр класса BezierShape. |
| [BezierShape(PointF[] points, boolean isClosed)](#BezierShape-com.aspose.psd.PointF---boolean-) | Инициализирует новый экземпляр класса BezierShape. |
## Методы
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | Массив точек. |
| isClosed | boolean | Если установить значение  true  , кривая Безье будет закрытой. |
