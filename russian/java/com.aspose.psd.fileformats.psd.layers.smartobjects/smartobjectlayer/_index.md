...
description: "Определяет класс SmartObjectLayer, который содержит встроенный в файл PSD или связанный смарт-объект во внешнем файле."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Определяет класс SmartObjectLayer, который содержит встроенный в файл PSD или связанный смарт‑объект во внешнем файле. С помощью Smart Objects вы можете: выполнять недеструктивные преобразования. Вы можете масштабировать, вращать, наклонять, искажать, выполнять перспективные преобразования или деформировать слой, не теряя оригинальные данные изображения или качество, потому что преобразования don\\ufffdt влияют на оригинальные данные. Работать с векторными данными, такими как векторные иллюстрации из Illustrator, которые иначе были бы растеризованы. Выполнять недеструктивную фильтрацию. Вы можете редактировать фильтры, применённые к Smart Objects, в любое время. Отредактировать один Smart Object и автоматически обновить все его связанные экземпляры. Применять маску слоя, которая\\ufffds либо связана, либо не связана с слоем Smart Object. Пробовать различные варианты дизайна с низкокачественными заполнительными изображениями, которые позже заменяются финальными версиями. В Adobe\\ufffd Photoshop\\ufffd вы можете внедрять содержимое изображения в документ PSD. Подробнее здесь:   Слой с встроенным смарт‑объектом содержит ресурсы placed (PlLd) и SoLd со свойствами смарт‑объекта. Ресурс PlLd может быть единственным для версий PSD старше 10. Эти ресурсы содержат UniqueId LiFdDataSource в глобальном Lnk2Resource с внедрённым именем файла и другими параметрами, включая содержимое внедрённого файла в оригинальном формате в виде массива байтов.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Инициализирует новый экземпляр класса [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Поля

| Поле | Описание |
| --- | --- |
| [BlendSignature](#BlendSignature) | Представляет сигнатуру режима наложения. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Сообщение о найденных как размещённых, так и смарт‑объектных ресурсах |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Сообщение: Вы можете копировать только встроенный смарт‑объект |
| [LayerHeaderSize](#LayerHeaderSize) | Размер заголовка слоя. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Сообщение: Не найдено размещённого или смарт‑объектного ресурса |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Сообщение о неверно размещенных индексах ресурсов |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Преобразует этот встроенный смарт‑объект в связанный смарт‑объект. |
...
| [duplicateLayer()](#duplicateLayer--) | Создаёт новый слой смарт‑объекта, копируя этот. |
| [embedLinked()](#embedLinked--) | Встраивает связанный смарт‑объект в этот слой. |
| [equals(Object obj)](#equals-java.lang.Object-) | Определяет, равен ли указанный объект этому экземпляру. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Экспортирует встроенное или связанное содержимое в файл. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Получает или задает искажение рендеринга или использование изображения PS |
...
| [getContentType()](#getContentType--) | Получает тип содержимого слоя смарт‑объекта. |
| [getContents()](#getContents--) | Получает или задаёт содержимое слоя смарт‑объекта. |
| [getContentsBounds()](#getContentsBounds--) | Получает или задаёт границы содержимого смарт‑объекта. |
| [getContentsSource()](#getContentsSource--) | Получает или задаёт источник содержимого смарт‑объекта. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Получает или задаёт последний размер изображения для деформации |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Получает или задаёт оригинальный четырёхугольник. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Получает индексы размещённых и смарт‑слойных ресурсов, а также корректный размещённый ресурс. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Получает ресурс размещённого слоя |
...
| [getSmartFilters()](#getSmartFilters--) | Получает смарт‑фильтры. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Получает или задаёт трансформационный четырёхугольник. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Получает функции, помогающие с искажением. |
| [getWarpSettings()](#getWarpSettings--) | Получает или задает параметры искажения, которые были получены или заданы из ресурса (по умолчанию). |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Получает встроенное или связанное изображение слоя смарт‑объекта. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Создаёт новый слой смарт‑объекта, копируя этот. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Вызывается, когда контейнер этого [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) был установлен. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Переподключает связанный смарт‑объект к новому файлу. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Заменяет содержимое смарт‑объекта, встроенное в слой смарт‑объекта. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Заменяет содержимое смарт‑объекта, встроенное в слой смарт‑объекта. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Заменяет содержимое файлом. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Заменяет содержимое файлом. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Заменяет содержимое файлом. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Заменяет содержимое файлом. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Изменяет размер данных каналов |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Получает или задает искажение рендеринга или использование изображения PS |
...
| [setContents(byte[] value)](#setContents-byte---) | Получает или задаёт содержимое слоя смарт‑объекта. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Получает или задаёт границы содержимого смарт‑объекта. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Получает или задаёт источник содержимого смарт‑объекта. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Получает или задаёт последний размер изображения для деформации |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Получает или задаёт оригинальный четырёхугольник. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Получает поставщик смарт‑объектов. |
| [setTop(int value)](#setTop-int-) | Получает или задает позицию верхнего слоя. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Получает или задаёт трансформационный четырёхугольник. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Получает или задает параметры искажения, которые были получены или заданы из ресурса (по умолчанию). |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Обновляет идентификатор источника данных. |
| [updateModifiedContent()](#updateModifiedContent--) | Обновляет кэш изображений слоя смарт‑объекта изменённым содержимым. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Обновляет кэш изображений слоя смарт‑объекта изменённым содержимым. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Обновляет размещённые/смарт‑ресурсы, когда placedResource изменяется или требуется конверсия. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Это оболочка для "IWarpSupport", обновляющая предварительный просмотр слоя. |
| [wait()](#wait--) |  |
...
Инициализирует новый экземпляр класса [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Поток элементов |
...
Сообщение о найденных как размещённых, так и смарт‑объектных ресурсах
...
Сообщение: Вы можете копировать только встроенный смарт‑объект
...
Сообщение: Не найдено размещённого или смарт‑объектного ресурса
...
Сообщение о неверно размещенных индексах ресурсов
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| linkedPath | java.lang.String | Связанный путь. |
...
Создает новый слой смарт-объекта, копируя этот. Обратите внимание, что для встроенных смарт-объектов встроенное изображение является общим. Если вы хотите скопировать встроенное изображение, используйте метод [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy).
...
Встраивает связанный смарт‑объект в этот слой.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| filePath | java.lang.String | Путь к файлу экспорта. |
...
Получает или задает искажение рендеринга или использование изображения PS
...
Получает тип содержимого слоя смарт-объекта. Содержимое встроенного смарт-объекта представляет собой встроенный необработанный файл изображения: LiFdDataSource.Data. Содержимое связанного смарт-объекта — это необработанное содержимое связанного файла изображения, если оно доступно: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Мы не поддерживаем загрузку из Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library, когда LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) имеет значение true. Для обычных файлов‑ссылок сначала используется LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) для поиска файла относительно пути исходного изображения DataStreamSupporter.SourceImagePath; если он недоступен, ищем по LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)); если и это не удалось, ищем файл ссылки в том же каталоге, где находится наше изображение: DataStreamSupporter.SourceImagePath.

Значение: Тип содержимого слоя смарт-объекта.
...
Получает или задает содержимое слоя смарт-объекта. Содержимое встроенного смарт-объекта представляет собой встроенный необработанный файл изображения: LiFdDataSource.Data и его свойства. Содержимое связанного смарт-объекта — это необработанное содержимое связанного файла изображения, если оно доступно, и его свойства: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Мы не поддерживаем загрузку из Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library, когда LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) имеет значение true. Для обычных файлов‑ссылок сначала используется LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) для поиска файла относительно пути исходного изображения DataStreamSupporter.SourceImagePath; если он недоступен, ищем по LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)); если и это не удалось, ищем файл ссылки в том же каталоге, где находится наше изображение: DataStreamSupporter.SourceImagePath.
...
Получает или задаёт границы содержимого смарт‑объекта.

Значение: Границы смарт-объекта.
...
Получает или задаёт источник содержимого смарт‑объекта.

Значение: Источник данных смарт-объекта.
...
Получает или задаёт последний размер изображения для деформации
...
Получает или задаёт оригинальный четырёхугольник.

Значение: Исходный четырехугольник.
...
Получает индексы размещённых и смарт‑слойных ресурсов, а также корректный размещённый ресурс.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Ресурсы. |
| placedResourceIndex | int[] | Индекс размещённого ресурса. |
| smartResourceIndex | int[] | Индекс умного ресурса. |
...
Получает ресурс размещённого слоя
...
Получает или задаёт трансформационный четырёхугольник.

Значение: Трансформирующий четырёхугольник.
...
Получает функции, помогающие с искажением.
...
Получает или задает параметры искажения, которые были получены или заданы из ресурса (по умолчанию).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Параметры. |
...
Создаёт новый слой смарт‑объекта, копируя этот. Воспроизводит Layer -> Smart Objects -> New Smart Object с помощью функции Copy в Adobe\ufffd Photoshop\ufffd. Обратите внимание, что это доступно только для встроенных смарт‑объектов, поскольку встроенное изображение также копируется. Если вы хотите поделиться встроенным изображением, используйте метод [.duplicateLayer](../../null/\#duplicateLayer).
...
Вызывается, когда контейнер этого [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) был установлен.
...
Перепривязывает связанный смарт‑объект к новому файлу. Нет необходимости вызывать метод UpdateModifiedContent после этого.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Изображение. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Изображение. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Настройки разрешения. Если значение null, будет использовано разрешение изображения. |
...
Заменяет содержимое файлом. Нет необходимости вызывать метод UpdateModifiedContent после этого.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Связанный путь. |
| isReplaceOnlyThis | boolean | Флаг указывает заменять содержимое из этого Smart Layer или во всех Smart Layers этим содержимым. |
...
Изменяет размер данных каналов
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Обновляет идентификатор источника данных.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | Идентификатор источника данных. |
...
Обновляет кэш изображений слоя смарт‑объекта изменённым содержимым.
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Изображение. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Разрешение. |
| skipBoundsUpdate | boolean | если установлено в true  [skip bounds update]. |
...
Обновляет размещённые/смарт‑ресурсы, когда placedResource изменяется или требуется конверсия.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| toEmbedded | boolean | если установлено в true, преобразовать в встроенный ресурс при необходимости, иначе в связанный. |
...
Это оболочка для "IWarpSupport", обновляющая предварительный просмотр слоя.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Пиксели и размер нового изображения предварительного просмотра. |
