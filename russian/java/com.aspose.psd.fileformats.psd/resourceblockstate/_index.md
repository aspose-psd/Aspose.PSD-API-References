...
description: "Представляет состояние блока ресурса."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.psd/resourceblock.resourceblockstate/
---
...
Представляет состояние блока ресурса.
## Поля

| Поле | Описание |
| --- | --- |
| [Cached](#Cached) | Кешированное состояние. |
