...
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.text.rendering/fontcaps/
---
...
| Поле | Описание |
| --- | --- |
| [AllCaps](#AllCaps) | Все заглавные. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | Нет значения заглавных шрифтов. |
| [SmallCaps](#SmallCaps) | Малые заглавные. |
## Методы
...
Нет значения заглавных шрифтов.
