...
description: "Тип межстрочного интервала Photoshop — расстояние между строками."
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
| Поле | Описание |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | Межстрочный интервал снизу к снизу. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | Межстрочный интервал сверху к сверху. |
## Методы
...
Межстрочный интервал снизу к снизу.
...
Межстрочный интервал сверху к сверху.
