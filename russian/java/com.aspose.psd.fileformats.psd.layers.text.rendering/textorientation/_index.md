...
description: "Перечисление для режима ориентации текста."
type: docs
weight: 15
url: /ru/java/com.aspose.psd.fileformats.psd.layers.text.rendering/textorientation/
---
...
| [Horizontal](#Horizontal) | Горизонтальная ориентация текста. |
| [Vertical](#Vertical) | Вертикальная ориентация текста. |
## Методы
