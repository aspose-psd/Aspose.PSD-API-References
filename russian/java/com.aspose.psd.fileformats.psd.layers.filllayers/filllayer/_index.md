...
description: "Слой заполнения."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| [createInstance(int fillType)](#createInstance-int-) | Создаёт новый экземпляр класса [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) по типу заполнения. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Получает процессор рендеринга для [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Получает или задает непрозрачность заливки. |
| [getFillSettings()](#getFillSettings--) | Получает настройки заливки. |
| [getFillType()](#getFillType--) | Получает тип заливки. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Получает настройки заливки. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Обновляет данные пикселей слоя заливки в соответствии с актуальными [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Создаёт новый экземпляр класса [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) по типу заполнения.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| fillType | int | Тип слоя заполнения. |
...
Получает процессор рендеринга для [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | Изображение, в которое производится рендеринг. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Границы для обработки. |

**Returns:**
com.aspose.internal.IPartialProcessor - Вернуть процессор рендеринга для [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Обновляет данные пикселей слоя заливки в соответствии с актуальными [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
