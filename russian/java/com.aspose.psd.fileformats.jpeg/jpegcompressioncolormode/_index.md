...
description: "Режим цвета для jpeg‑изображений."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.jpeg/jpegcompressioncolormode/
---
...
| Поле | Описание |
| --- | --- |
| [Cmyk](#Cmyk) | Изображение CMYK с 4 компонентами. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | Изображение в градациях серого. |
| [Rgb](#Rgb) | RGB‑цветовой режим. |
| [YCbCr](#YCbCr) | Изображение YCbCr, стандартный вариант для jpeg‑изображений. |
| [Ycck](#Ycck) | JPEG‑изображение в цветовом пространстве ycck. |
## Методы
...
Изображение CMYK с 4 компонентами.
...
Изображение YCbCr, стандартный вариант для jpeg‑изображений.
...
JPEG‑изображение в цветовом пространстве ycck. Требуется ICC‑профиль для сохранения.
