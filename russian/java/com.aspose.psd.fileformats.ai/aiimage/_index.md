...
description: "Изображение Adobe Illustrator AI"
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
| --- | --- |
| [AiImage()](#AiImage--) | Инициализирует новый экземпляр класса [AiImage](../../com.aspose.psd.fileformats.ai/aiimage). |
## Поля
...
| Метод | Описание |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | Добавляет раздел слоя AI. |
| [cacheData()](#cacheData--) | Кеширует данные и гарантирует, что дополнительная загрузка данных не будет выполнена из базового P:Aspose.PSD.DataStreamSupporter.DataStreamContainer. |
...
| [getActivePageIndex()](#getActivePageIndex--) | Получает или задает индекс активной страницы. |
...
| [getDataSection()](#getDataSection--) | Получает раздел данных. |
...
| [getFinalizeSection()](#getFinalizeSection--) | Получает раздел завершения. |
...
| [getPageCount()](#getPageCount--) | Количество страниц. |
...
| [getSetupSection()](#getSetupSection--) | Получает раздел настройки. |
...
| [getVersion()](#getVersion--) | Получает версию формата Adobe Illustrator. |
| [getWidth()](#getWidth--) | Получает ширину изображения. |
| [getXmpData()](#getXmpData--) | Получает метаданные XMP. |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | Получает или задает индекс активной страницы. |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | Получает отрендеренное изображение. |
...
Инициализирует новый экземпляр класса [AiImage](../../com.aspose.psd.fileformats.ai/aiimage).
...
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | Раздел слоя AI. |
...
Кеширует данные и гарантирует, что дополнительная загрузка данных не будет выполнена из базового P:Aspose.PSD.DataStreamSupporter.DataStreamContainer.
...
**Returns:**
com.aspose.foundation.rendering.ApsPage — экземпляр ApsPage.
...
Значение: Это свойство актуально только для AI‑изображения в формате PDF. Если изображение не в формате PDF или страниц нет, свойство будет равно -1. Это свойство указывает, какая страница AI‑изображения будет использоваться в качестве основы для рендеринга.
...
Значение:  true  если данные объекта кэшированы; иначе,  false .
...
Получает отрендеренное изображение.

Значение: отрендеренное изображение.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| ventureLicense | java.lang.Object | Объект лицензии Venture. |
