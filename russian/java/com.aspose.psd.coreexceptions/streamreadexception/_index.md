...
type: docs
weight: 22
url: /ru/java/com.aspose.psd.coreexceptions/streamreadexception/
---
...
| [getActualReadCount()](#getActualReadCount--) | Получает фактическое количество прочитанных байтов. |
| [getCause()](#getCause--) |  |
| [getClass()](#getClass--) |  |
| [getExpectedReadCount()](#getExpectedReadCount--) | Получает ожидаемое количество прочитанных байтов. |
...
| message | java.lang.String | Сообщение. |
| innerException | java.lang.Throwable | Внутреннее исключение. |
| expectedReadCount | int | Ожидаемое количество прочитанных байтов. |
| actualReadCount | int | Фактическое количество прочитанных байтов. |
