...
type: docs
weight: 18
url: /ru/java/com.aspose.psd.coreexceptions/limitmemoryexception/
---
...
Исключение ограничения памяти. Происходит, когда использование памяти должно быть уменьшено.
## Конструкторы
...
Значение: Коэффициент уменьшения памяти.
