...
description: "Исключение загрузки изображения."
type: docs
weight: 15
url: /ru/java/com.aspose.psd.coreexceptions/imageloadexception/
---
...
| --- | --- |
| [ImageLoadException(String message)](#ImageLoadException-java.lang.String-) | Инициализирует новый экземпляр класса  ImageLoadException  . |
| [ImageLoadException(String message, Throwable innerException)](#ImageLoadException-java.lang.String-java.lang.Throwable-) | Инициализирует новый экземпляр класса  ImageLoadException  . |
## Методы
...
Инициализирует новый экземпляр класса  ImageLoadException  .
