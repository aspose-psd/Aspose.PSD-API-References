...
description: "перечисления типов захвата сцены exif."
type: docs
weight: 23
url: /ru/java/com.aspose.psd.exif.enums/exifscenecapturetype/
---
...
| [Landscape](#Landscape) | Пейзажная сцена. |
| [NightScene](#NightScene) | Ночная сцена. |
| [Portrait](#Portrait) | Портретная сцена. |
| [Standard](#Standard) | Стандартная сцена. |
## Методы
