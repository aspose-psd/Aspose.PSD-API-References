...
description: "перечисление позиционирования YCbCr exif."
type: docs
weight: 28
url: /ru/java/com.aspose.psd.exif.enums/exifycbcrpositioning/
---
...
перечисление позиционирования YCbCr exif.
## Поля

| Поле | Описание |
| --- | --- |
| [Centered](#Centered) | Центрированный YCbCr |
| [CoSited](#CoSited) | Совместное расположение |
