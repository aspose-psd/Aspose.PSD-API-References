...
description: "перечисления режимов измерения экспозиции exif."
type: docs
weight: 20
url: /ru/java/com.aspose.psd.exif.enums/exifmeteringmode/
---
...
перечисления режимов измерения экспозиции exif.
## Поля

| Поле | Описание |
| --- | --- |
| [Average](#Average) | Среднее измерение |
| [Centerweightedaverage](#Centerweightedaverage) | Центр-взвешенное среднее. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MultiSegment](#MultiSegment) | Многосегментное измерение. |
| [MultiSpot](#MultiSpot) | Многоточечное измерение |
| [Other](#Other) | Для других режимов. |
| [Partial](#Partial) | Частичное измерение. |
| [Spot](#Spot) | Точечное измерение |
