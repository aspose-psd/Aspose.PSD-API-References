...
description: "перечисления режимов экспозиции exif."
type: docs
weight: 13
url: /ru/java/com.aspose.psd.exif.enums/exifexposuremode/
---
...
перечисления режимов экспозиции exif.
## Поля

| Поле | Описание |
| --- | --- |
| [Auto](#Auto) | Автоматическая экспозиция. |
| [AutoBracket](#AutoBracket) | Автоматический брекетинг. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | Ручная экспозиция. |
## Методы
