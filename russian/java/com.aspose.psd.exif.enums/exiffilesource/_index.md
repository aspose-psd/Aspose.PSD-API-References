...
description: "перечисления источников файлов exif."
type: docs
weight: 15
url: /ru/java/com.aspose.psd.exif.enums/exiffilesource/
---
...
перечисления источников файлов exif.
## Поля

| Поле | Описание |
| --- | --- |
| [DigitalStillCamera](#DigitalStillCamera) | Цифровая фотокамера. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FilmScanner](#FilmScanner) | Сканер пленки. |
| [Others](#Others) | Другие. |
| [ReflexionPrintScanner](#ReflexionPrintScanner) | Сканер отражающей печати. |
## Методы
