...
description: "перечисления программ экспозиции exif."
type: docs
weight: 14
url: /ru/java/com.aspose.psd.exif.enums/exifexposureprogram/
---
...
перечисления программ экспозиции exif.
## Поля

| Поле | Описание |
| --- | --- |
| [Actionprogram](#Actionprogram) | Режим действия. |
| [Aperturepriority](#Aperturepriority) | Приоритет диафрагмы. |
| [Auto](#Auto) | Автоматическая экспозиция. |
| [Creativeprogram](#Creativeprogram) | Творческий режим. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Landscapemode](#Landscapemode) | Режим пейзажа. |
| [Manual](#Manual) | Ручной режим. |
| [Notdefined](#Notdefined) | Не определено. |
| [Portraitmode](#Portraitmode) | Режим портрета. |
| [Shutterpriority](#Shutterpriority) | Приоритет выдержки. |
## Методы
