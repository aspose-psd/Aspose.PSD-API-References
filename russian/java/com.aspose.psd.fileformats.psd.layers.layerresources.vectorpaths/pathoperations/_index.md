...
type: docs
weight: 15
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| Поле | Описание |
| --- | --- |
| [CombineShapes](#CombineShapes) | Объединить формы (операция ИЛИ). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | Исключить перекрывающиеся формы (операция XOR). |
| [IntersectShapeAreas](#IntersectShapeAreas) | Пересечь области форм (операция И). |
...
Объединить формы (операция ИЛИ). Это значение по умолчанию в Photoshop.
...
Пересечь области форм (операция И).
