...
description: "Класс VmskResource."
type: docs
weight: 27
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource/
---
...
Класс VmskResource. Этот ресурс содержит информацию о векторной маске слоя
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [VmskResource(byte[] data)](#VmskResource-byte---) | Инициализирует новый экземпляр класса [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource). |
| [VmskResource()](#VmskResource--) | Инициализирует новый экземпляр класса [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource). |
## Поля
...
Инициализирует новый экземпляр класса [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource).
