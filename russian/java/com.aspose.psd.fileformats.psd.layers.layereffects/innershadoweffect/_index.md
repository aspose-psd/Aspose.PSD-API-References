...
description: "Эффект внутренней тени слоя"
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | Получает или задает растушевку (зажим) в процентах. |
...
| [setSpread(int value)](#setSpread-int-) | Получает или задает растушевку (зажим) в процентах. |
...
Получает или задает растушевку (зажим) в процентах.
