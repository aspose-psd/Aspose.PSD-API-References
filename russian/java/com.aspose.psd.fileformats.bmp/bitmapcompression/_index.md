...
description: "Указывает различные методы сжатия растровых изображений."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.bmp/bitmapcompression/
---
...
Указывает различные методы сжатия растровых изображений.
## Поля

| Поле | Описание |
| --- | --- |
| [AlphaBitfields](#AlphaBitfields) | Битовые поля RGBA. |
| [Bitfields](#Bitfields) | RGB-битовые поля. |
...
RGBA-битовые поля. Может использоваться только с 16- и 32-битными/пиксельными битмапами.
...
RGB-битовые поля. Может использоваться только с 16- и 32-битными/пиксельными битмапами.
...
Сжатие RLE 4-бит/пиксель. Может использоваться только с 4-битными/пиксельными битмапами.
...
Сжатие RLE 8-бит/пиксель. Может использоваться только с 8-битными/пиксельными битмапами.
