...
type: docs
weight: 37
url: /ru/java/com.aspose.psd/datarecoverymode/
---
...
| Поле | Описание |
| --- | --- |
| [ConsistentRecover](#ConsistentRecover) | Последовательный режим восстановления пытается восстановить все данные, пока повреждение не нарушает формат файла, и позволяет корректно продолжать обработку. |
...
Последовательный режим восстановления пытается восстановить все данные, пока повреждение не нарушает формат файла, и позволяет корректно продолжать обработку.
...
Восстановление данных не предполагается. При наличии повреждённых данных в формате файла выбрасывается соответствующее исключение.
