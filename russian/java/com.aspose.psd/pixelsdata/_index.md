...
type: docs
weight: 82
url: /ru/java/com.aspose.psd/pixelsdata/
---
...
| --- | --- |
| [PixelsData()](#PixelsData--) | Инициализирует новый экземпляр класса [PixelsData](../../com.aspose.psd/pixelsdata). |
| [PixelsData(int[] pixels, Rectangle bounds)](#PixelsData-int---com.aspose.psd.Rectangle-) | Инициализирует новый экземпляр класса [PixelsData](../../com.aspose.psd/pixelsdata). |
## Методы
...
Инициализирует новый экземпляр класса [PixelsData](../../com.aspose.psd/pixelsdata).
