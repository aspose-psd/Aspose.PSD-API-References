...
type: docs
weight: 84
url: /ru/java/com.aspose.psd/progresseventhandler/
---
...
| [hashCode()](#hashCode--) |  |
| [invoke(ProgressEventHandlerInfo info)](#invoke-com.aspose.psd.progressmanagement.ProgressEventHandlerInfo-) | Ссылка на функцию обработчика события прогресса |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| info | [ProgressEventHandlerInfo](../../com.aspose.psd.progressmanagement/progresseventhandlerinfo) | Данные обработчика события прогресса. |
