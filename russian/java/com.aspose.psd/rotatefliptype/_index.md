...
type: docs
weight: 94
url: /ru/java/com.aspose.psd/rotatefliptype/
---
...
| [Rotate90FlipNone](#Rotate90FlipNone) | Указывает, насколько изображение вращается и ось, используемую для отражения изображения. |
...
Указывает, насколько изображение вращается и ось, используемую для отражения изображения.
