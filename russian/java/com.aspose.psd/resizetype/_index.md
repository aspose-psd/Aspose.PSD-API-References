...
type: docs
weight: 91
url: /ru/java/com.aspose.psd/resizetype/
---
...
| [CenterToCenter](#CenterToCenter) | Центр нового изображения будет совпадать с центром исходного изображения. |
| [CubicBSpline](#CubicBSpline) | Метод кубической интерполяции CubicBSpline |
| [CubicConvolution](#CubicConvolution) | Метод кубической интерполяции Cubic Convolution |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HighQualityResample](#HighQualityResample) | Высококачественное пересэмплирование |
| [LanczosResample](#LanczosResample) | Пересэмплирование с использованием алгоритма lanczos с a=3. |
| [LeftBottomToLeftBottom](#LeftBottomToLeftBottom) | Левая нижняя точка нового изображения будет совпадать с левой нижней точкой исходного изображения. |
| [LeftTopToLeftTop](#LeftTopToLeftTop) | Левая верхняя точка нового изображения будет совпадать с левой верхней точкой исходного изображения. |
...
| [RightBottomToRightBottom](#RightBottomToRightBottom) | Правая нижняя точка нового изображения будет совпадать с правой нижней точкой исходного изображения. |
| [RightTopToRightTop](#RightTopToRightTop) | Правая верхняя точка нового изображения будет совпадать с правой верхней точкой исходного изображения. |
...
Центр нового изображения будет совпадать с центром исходного изображения. При необходимости будет выполнено обрезание.
...
Метод кубической интерполяции Cubic Convolution
...
Пересэмплирование с использованием алгоритма lanczos с a=3.
...
Левая нижняя точка нового изображения будет совпадать с левой нижней точкой исходного изображения. При необходимости будет выполнено обрезание.
...
Левая верхняя точка нового изображения будет совпадать с левой верхней точкой исходного изображения. При необходимости будет выполнено обрезание.
...
Правая нижняя точка нового изображения будет совпадать с правой нижней точкой исходного изображения. При необходимости будет выполнено обрезание.
...
Правая верхняя точка нового изображения будет совпадать с правой верхней точкой исходного изображения. При необходимости будет выполнено обрезание.
