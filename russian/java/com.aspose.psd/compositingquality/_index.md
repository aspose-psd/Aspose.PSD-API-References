...
description: "Указывает уровень качества, используемый при композитинге."
type: docs
weight: 32
url: /ru/java/com.aspose.psd/compositingquality/
---
...
| Поле | Описание |
| --- | --- |
| [AssumeLinear](#AssumeLinear) | Предполагаются линейные значения. |
| [Default](#Default) | Качество по умолчанию. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GammaCorrected](#GammaCorrected) | Используется гамма‑коррекция. |
| [HighQuality](#HighQuality) | Высокое качество, низкая скорость композитинга. |
| [HighSpeed](#HighSpeed) | Высокая скорость, низкое качество. |
| [Invalid](#Invalid) | Недопустимое качество. |
## Методы
...
Высокое качество, низкая скорость композитинга.
