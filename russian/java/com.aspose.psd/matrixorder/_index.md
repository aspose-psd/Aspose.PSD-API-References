...
type: docs
weight: 70
url: /ru/java/com.aspose.psd/matrixorder/
---
...
| Поле | Описание |
| --- | --- |
| [Append](#Append) | Новая операция применяется после старой операции. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Prepend](#Prepend) | Новая операция применяется перед старой операцией. |
## Методы
...
Новая операция применяется после старой операции.
...
Новая операция применяется перед старой операцией.
