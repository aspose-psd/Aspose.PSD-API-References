...
description: "Указывает отдельные каналы в цветовом пространстве CMYK (циан, маджента, желтый, черный)."
type: docs
weight: 22
url: /ru/java/com.aspose.psd/colorchannelflag/
---
...
| Поле | Описание |
| --- | --- |
| [ColorChannelC](#ColorChannelC) | Канал цвета циан. |
| [ColorChannelK](#ColorChannelK) | Канал цвета черный. |
| [ColorChannelLast](#ColorChannelLast) | Следует использовать последний выбранный канал. |
| [ColorChannelM](#ColorChannelM) | Канал цвета маджента. |
| [ColorChannelY](#ColorChannelY) | Канал цвета желтый. |
...
Следует использовать последний выбранный канал.
