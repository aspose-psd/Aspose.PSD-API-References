...
type: docs
weight: 45
url: /ru/java/com.aspose.psd/fillmode/
---
...
| Поле | Описание |
| --- | --- |
| [Alternate](#Alternate) | Указывает альтернативный режим заливки. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Winding](#Winding) | Указывает режим заливки winding. |
## Методы
...
Указывает альтернативный режим заливки.
...
Указывает режим заливки winding.
