...
description: "Один из поддерживаемых форматов файлов PSD."
type: docs
weight: 43
url: /ru/java/com.aspose.psd/fileformat/
---
...
Один из поддерживаемых форматов файлов PSD.
## Поля
...
| [Odg](#Odg) | Формат Open document graphic |
...
| [Undefined](#Undefined) | Неопределённый формат файла. |
