...
description: "Представляет негeneric словарь."
type: docs
weight: 72
url: /ru/java/com.aspose.psd/nongenericdictionary/
---
...
Представляет негeneric словарь.
## Конструкторы
...
| [getKeys()](#getKeys--) |  |
| [getKeysTyped()](#getKeysTyped--) | Получает строго типизированную коллекцию ключей. |
| [getSyncRoot()](#getSyncRoot--) |  |
| [getValues()](#getValues--) |  |
| [getValuesTyped()](#getValuesTyped--) | Получает строго типизированную коллекцию значений. |
...
Получает строго типизированную коллекцию ключей.

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<K> - Строго типизированная коллекция ключей.
### getSyncRoot() {#getSyncRoot--}
```
...
Получает строго типизированную коллекцию значений.

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<V> - Строго типизированная коллекция значений.
### get_Item(TKey arg0) {#get-Item-TKey-}
```
