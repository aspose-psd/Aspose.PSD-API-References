...
description: "Методы дизеринга, используемые для управления преобразованием цветов."
type: docs
weight: 41
url: /ru/java/com.aspose.psd/ditheringmethods/
---
...
Методы дизеринга, используемые для управления преобразованием цветов.
## Поля

| Поле | Описание |
| --- | --- |
| [CustomConverter](#CustomConverter) | Пользовательский конвертер. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | Палитра не игнорируется, и следует применить разумное преобразование цветов. |
| [PaletteIgnore](#PaletteIgnore) | Палитра игнорируется |
## Методы
...
Палитра не игнорируется, и следует применить разумное преобразование цветов.
