...
type: docs
weight: 67
url: /ru/java/com.aspose.psd/linejoin/
---
...
| Поле | Описание |
| --- | --- |
| [Bevel](#Bevel) | Указывает скруглённое соединение. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Miter](#Miter) | Указывает соединение в виде острого угла. |
| [MiterClipped](#MiterClipped) | Указывает соединение в виде острого угла. |
| [Round](#Round) | Указывает круглое соединение. |
## Методы
...
Указывает скруглённое соединение. Это создаёт диагональный угол.
...
Указывает соединение в виде острого угла. Это создаёт острый угол или срезанный угол, в зависимости от того, превышает ли длина фаски предел фаски.
...
Указывает соединение в виде острого угла. Это создаёт острый угол или скруглённый угол, в зависимости от того, превышает ли длина фаски предел фаски.
...
Указывает круглое соединение. Это создаёт плавную круглую дугу между линиями.
