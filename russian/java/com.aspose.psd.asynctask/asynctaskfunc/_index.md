...
description: "Делегат длительной операции для асинхронной задачи с обобщённым типом результата."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
Делегат длительной операции для асинхронной задачи с обобщённым типом результата.
## Конструкторы
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | Делегат длительной операции для асинхронной задачи с обобщённым типом результата. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | Состояние асинхронной задачи. |
