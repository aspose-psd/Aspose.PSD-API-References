...
description: "Структура enumerated descriptor."
type: docs
weight: 15
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumerateddescriptorstructure/
---
...
Структура enumerated descriptor.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [EnumeratedDescriptorStructure(ClassID keyName, ClassID typeID, ClassID enumName)](#EnumeratedDescriptorStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Инициализирует новый экземпляр класса [EnumeratedDescriptorStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/enumerateddescriptorstructure). |
## Поля
...
Инициализирует новый экземпляр класса [EnumeratedDescriptorStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/enumerateddescriptorstructure).
