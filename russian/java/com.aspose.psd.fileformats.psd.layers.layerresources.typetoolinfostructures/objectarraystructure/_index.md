...
description: "Определяет класс ObjectArrayStructure, который обычно содержит массив."
type: docs
weight: 20
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Определяет класс ObjectArrayStructure, который обычно содержит массив [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure). Он используется в ресурсах файлов PSD, таких как ресурс PlLd и ресурс SoLd.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Инициализирует новый экземпляр класса [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Инициализирует новый экземпляр класса [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
## Поля

| Поле | Описание |
| --- | --- |
| [StructureKey](#StructureKey) | Определяет ключ структуры 'ObAr'. |
## Методы
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Получает или задает идентификатор класса объектного массива. |
| [getClassName()](#getClassName--) | Получает или задает имя класса массива объектов. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Получает список структур. |
| [getKey()](#getKey--) | Получает ключ структуры массива объектов. |
| [getKeyName()](#getKeyName--) | Получает или задаёт имя ключа. |
| [getLength()](#getLength--) | Получает длину  OSTypeStructure  в байтах. |
...
| [getStructureCount()](#getStructureCount--) | Получает количество подструктур массива объектов. |
| [getStructures()](#getStructures--) | Получает или задает подструктуры в структуре массива объектов. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Получает или задает идентификатор класса объектного массива. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Получает или задает имя класса массива объектов. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Получает или задает подструктуры в структуре массива объектов. |
...
Инициализирует новый экземпляр класса [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| keyName | java.lang.String | Имя ключа. |
| classIdName | java.lang.String | Имя идентификатора класса. |
...
Получает или задает идентификатор класса объектного массива.

Значение: Идентификатор класса массива объектов.
...
Значение: Имя класса массива объектов.
...
Получает длину  OSTypeStructure  в байтах.
...
Значение: Количество подструктур в структуре массива объектов.
...
Значение: Подструктуры в структуре массива объектов.
