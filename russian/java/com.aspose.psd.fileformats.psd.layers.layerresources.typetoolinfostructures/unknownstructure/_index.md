...
type: docs
weight: 30
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Инициализирует новый экземпляр класса [UnknownStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unknownstructure). |
## Методы
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Получает читаемое название типа структуры. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setData(byte[] value)](#setData-byte---) | Получает или задает данные. |
...
Инициализирует новый экземпляр класса [UnknownStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unknownstructure).

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Имя ключа. |
| key | int | Ключ структуры. |
...
Получает читаемое название типа структуры.
