...
type: docs
weight: 23
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure/
---
...
| --- | --- |
| [PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID)](#PropertyStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Инициализирует новый экземпляр класса [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure). |
## Поля
...
| [getKeyID()](#getKeyID--) | Получает или задаёт идентификатор ключа. |
...
| [setKeyID(ClassID value)](#setKeyID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Получает или задаёт идентификатор ключа. |
...
Инициализирует новый экземпляр класса [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure).
...
| keyID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Идентификатор ключа. |
...
Получает или задаёт идентификатор ключа.

Value: Идентификатор ключа.
