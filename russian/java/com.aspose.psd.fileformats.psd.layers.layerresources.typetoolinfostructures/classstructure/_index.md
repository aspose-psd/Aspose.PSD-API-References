...
description: "Структура class."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Инициализирует новый экземпляр класса [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure). |
## Поля

| Поле | Описание |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Определяет ключ структуры. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Определяет ключ структуры. |
| [StructureKeyType](#StructureKeyType) | Определяет ключ структуры. |
## Методы
...
Инициализирует новый экземпляр класса [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure).
...
| structureKey | int | Ключ структуры. |
