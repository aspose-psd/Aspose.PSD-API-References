...
description: "Ключ структуры Name 0x6E616D65, который в ASCII читается как \"name\", представляет собой простую структуру, используемую для хранения строки Unicode или в стиле Pascal, представляющей имя элемента, такого как путь слоя или коррекция."
type: docs
weight: 19
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
Структура Name (ключ: 0x6E616D65, который в ASCII читается как "name") — простая структура, используемая для хранения Unicode‑ или Pascal‑подобной строки, представляющей имя элемента, например слоя, пути или коррекции.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Инициализирует новый экземпляр класса [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure). |
## Поля

| Поле | Описание |
| --- | --- |
| [StructureKey](#StructureKey) | Ключ структуры Name. |
## Методы
...
| [getValue()](#getValue--) | Получает или задает значение структуры Name. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Получает или задает первое строковое значение структуры Name. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Получает или задает значение структуры Name. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Инициализирует новый экземпляр класса [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure).
...
Получает или задает значение структуры Name.
...
Получает или задает первое строковое значение структуры Name. Обычно оно содержит символ конца строки.
