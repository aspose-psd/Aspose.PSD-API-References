...
description: "Структура строки."
type: docs
weight: 26
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/
---
...
| --- | --- |
| [StringStructure(ClassID keyName)](#StringStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Инициализирует новый экземпляр класса [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure). |
## Поля
...
| [setValue(String value)](#setValue-java.lang.String-) | Получает или задает значение. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Инициализирует новый экземпляр класса [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure).
