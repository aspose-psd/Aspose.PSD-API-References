...
description: "Представляет тип проекта в XmpDynamicMediaPackage."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.xmp.schemas.xmpdm/projecttype/
---
...
Представляет тип проекта в XmpDynamicMediaPackage.
## Поля

| Поле | Описание |
| --- | --- |
| [Audio](#Audio) | Тип аудио проекта |
| [Custom](#Custom) | Тип пользовательского проекта |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Movie](#Movie) | Тип проекта фильма |
| [Still](#Still) | Тип проекта статичного изображения |
## Методы
...
Тип проекта статичного изображения
