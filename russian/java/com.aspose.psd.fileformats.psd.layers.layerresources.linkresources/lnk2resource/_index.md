...
description: "Определяет класс, который содержит информацию о встроенных файлах в изображении формата PSD."
type: docs
weight: 15
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
Определяет класс, содержащий информацию о встроенных файлах в изображении формата PSD. Связанный ресурс может содержать несколько LiFdDataSource экземпляров, к которым можно получить доступ через индексатор.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Инициализирует новый экземпляр класса [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource). |
## Поля
...
Инициализирует новый экземпляр класса [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource).
