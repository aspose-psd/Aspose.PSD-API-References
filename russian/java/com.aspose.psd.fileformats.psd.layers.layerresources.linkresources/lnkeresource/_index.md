...
description: "Определяет класс LnkeResource, который содержит информацию о внешних связанных файлах или ресурсах в изображении формата PSD."
type: docs
weight: 17
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Определяет класс LnkeResource, содержащий информацию о внешних связанных файлах или ресурсах в изображении формата PSD. Связанный ресурс может содержать несколько [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) экземпляров, к которым можно получить доступ через индексатор. Это часть API манипуляции форматом файлов PSD, помогающая программно изменять файлы Adobe® Photoshop®.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Инициализирует новый экземпляр класса [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource). |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Инициализирует новый экземпляр класса [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource). |
## Поля
...
| [get_Item(int index)](#get-Item-int-) | Получает [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) по указанному индексу. |
...
Инициализирует новый экземпляр класса [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource).
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Источники данных. |
...
Получает [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) по указанному индексу.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Индекс. Значение: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). |
