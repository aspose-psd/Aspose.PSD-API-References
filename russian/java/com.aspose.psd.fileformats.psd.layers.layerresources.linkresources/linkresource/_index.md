...
description: "Определяет класс LinkResource, который содержит информацию о связанных или встроенных файлах в изображении формата PSD."
type: docs
weight: 14
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
Определяет класс LinkResource, содержащий информацию о связанных или встроенных файлах в изображении формата PSD. Связанный ресурс может содержать несколько [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) экземпляров, к которым можно получить доступ через индексаторы в любом производном классе.
## Поля
...
| [get_Item(int index)](#get-Item-int-) | Получает [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) по указанному индексу. |
...
Получает [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) по указанному индексу.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Целочисленный индекс. Значение: [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
