...
description: "Определяет класс источника данных liFD в файле PSD, который содержит информацию о встроенном файле."
type: docs
weight: 10
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
Определяет класс источника данных liFD в файле PSD, который содержит информацию о встроенном файле. Это часть API манипуляции форматом файлов PSD, который помогает изменять файлы Adobe® Photoshop®.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | Инициализирует новый экземпляр класса [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
## Поля
...
| [getData()](#getData--) | Получает или задает данные встроенного смарт-объекта в файле PSD. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | Получает длину встроенных данных. |
...
| [setData(byte[] value)](#setData-byte---) | Получает или задает данные встроенного смарт-объекта в файле PSD. |
...
Инициализирует новый экземпляр класса [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource).
...
Получает или задает данные встроенного смарт-объекта в файле PSD.

Значение: Встроенные данные смарт-объекта.
...
Получает длину встроенных данных.

Значение: Длина встроенных данных.
