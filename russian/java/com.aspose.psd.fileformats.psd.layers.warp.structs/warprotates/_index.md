...
description: "Типы вращения искажения"
type: docs
weight: 11
url: /ru/java/com.aspose.psd.fileformats.psd.layers.warp.structs/warprotates/
---
...
Типы вращения искажения
## Поля

| Поле | Описание |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Horizontal](#Horizontal) | Горизонтальное направление искажения |
| [Vertical](#Vertical) | Вертикальное направление искажения |
## Методы
...
Горизонтальное направление искажения
...
Вертикальное направление искажения
