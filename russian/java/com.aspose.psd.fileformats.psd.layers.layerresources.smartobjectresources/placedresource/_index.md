...
description: "Определяет класс PlacedResource, который содержит общую информацию о размещённом слое или слое смарт‑объекта в файле PSD."
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Получает или задает элементы искажения. |
