...
description: "Определяет класс SoLdResource, который содержит информацию о слое смарт‑объекта в файле PSD."
type: docs
weight: 15
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
Определяет класс SoLdResource, который содержит информацию о слое смарт‑объекта в файле PSD. Используется для поддержки слоёв смарт‑объектов в изображениях Adobe® Photoshop®.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Инициализирует новый экземпляр класса [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | Инициализирует новый экземпляр класса [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## Поля
...
| [TypeToolKey](#TypeToolKey) | Ключ информации инструмента типа: 'SoLd'. |
...
Инициализирует новый экземпляр класса [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Необходимо установить свойство Items или вызвать InitializeItems(), чтобы получить готовый экземпляр. Этот конструктор предназначен для использования [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) и в модульных тестах. Используйте [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) для создания классов SoLdResource.

**Parameters:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| uniqueId | java.util.UUID | Уникальный идентификатор данных слоя смарт‑объекта [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Инициализирует новый экземпляр класса [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Этот конструктор по умолчанию предназначен для использования SoLdResourceLoader. Используйте [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) для создания классов SoLdResource.
...
Ключ информации инструмента типа: 'SoLd'.
