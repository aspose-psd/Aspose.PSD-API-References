...
description: "Определяет перечисление PlacedLayerType для размещённого слоя ресурса PlLd."
type: docs
weight: 11
url: /ru/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedlayertype/
---
...
| [ImageStack](#ImageStack) | Тип размещённого слоя стека изображений |
| [Raster](#Raster) | Тип размещённого растрового слоя |
| [Unknown](#Unknown) | Тип неизвестного размещённого слоя |
| [Vector](#Vector) | Тип размещённого векторного слоя |
## Методы
...
Тип размещённого слоя стека изображений
...
Тип размещённого растрового слоя
...
Тип неизвестного размещённого слоя
...
Тип размещённого векторного слоя
