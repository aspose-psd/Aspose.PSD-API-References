...
type: docs
weight: 12
url: /ru/java/com.aspose.psd.fileformats.psd.layers.fillsettings/filltype/
---
...
| Поле | Описание |
| --- | --- |
| [Color](#Color) | Тип цветовой заливки |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gradient](#Gradient) | Тип градиентной заливки |
| [Pattern](#Pattern) | Тип заливки узором |
## Методы
