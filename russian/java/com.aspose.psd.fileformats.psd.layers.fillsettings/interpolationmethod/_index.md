...
description: "Упакованные значения fourCC для метода интерполяции градиента Photoshop."
type: docs
weight: 18
url: /ru/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
| Поле | Описание |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Классический (устаревшее значение по умолчанию, когда ключ отсутствует). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Линейный (обратите внимание на пробел в конце). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Перцептивный. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Плавный. |
| [Stripes](#Stripes) | 'GIMs' — Полосы. |
## Методы
...
'Gcls' \\u2014 Классический (устаревшее значение по умолчанию, когда ключ отсутствует).
...
'Lnr ' \\u2014 Линейный (обратите внимание на пробел в конце).
