...
type: docs
weight: 12
url: /ru/java/com.aspose.psd.exif/jpegexifdata/
---
...
| [JpegExifData(TiffDataType[] exifdata)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | Инициализирует новый экземпляр класса  JpegExifData  с данными из массива. |
| [JpegExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | Инициализирует новый экземпляр класса  JpegExifData  с данными из массива. |
## Поля

| Поле | Описание |
| --- | --- |
| [MaxExifSegmentSize](#MaxExifSegmentSize) | Максимальный разрешённый размер сегмента EXIF в байтах. |
## Методы
...
| [getCopyright()](#getCopyright--) | Получает или задаёт информацию об авторском праве. |
...
| [getThumbnail()](#getThumbnail--) | Получает или задаёт миниатюру изображения. |
...
| [getYCbCrPositioning()](#getYCbCrPositioning--) | Получает или задаёт положение компонентов хроминанс относительно компонента яркости. |
| [getYCbCrSubSampling()](#getYCbCrSubSampling--) | Получает или задаёт коэффициент выборки компонентов хроминанс относительно компонента яркости. |
...
| [setCopyright(String value)](#setCopyright-java.lang.String-) | Получает или задаёт информацию об авторском праве. |
...
| [setPrimaryChromaticities(TiffRational[] value)](#setPrimaryChromaticities-com.aspose.psd.fileformats.tiff.TiffRational---) | Получает или задаёт хроматичность трёх основных цветов изображения. |
...
| [setReferenceBlackWhite(TiffRational[] value)](#setReferenceBlackWhite-com.aspose.psd.fileformats.tiff.TiffRational---) | Получает или задаёт эталонные чёрный и белый. |
...
| [setThumbnail(RasterImage value)](#setThumbnail-com.aspose.psd.RasterImage-) | Получает или задаёт миниатюру изображения. |
...
| [setYCbCrCoefficients(TiffRational[] value)](#setYCbCrCoefficients-com.aspose.psd.fileformats.tiff.TiffRational---) | Получает или задаёт коэффициенты матрицы для преобразования данных изображения из RGB в YCbCr. |
| [setYCbCrPositioning(int value)](#setYCbCrPositioning-int-) | Получает или задаёт положение компонентов хроминанс относительно компонента яркости. |
| [setYCbCrSubSampling(int[] value)](#setYCbCrSubSampling-int---) | Получает или задаёт коэффициент выборки компонентов хроминанс относительно компонента яркости. |
...
Получает или задаёт информацию об авторском праве.
...
Получает или задаёт миниатюру изображения.
...
Получает или задаёт положение компонентов хроминанс относительно компонента яркости.

Значение: Позиция компонентов хроминанс относительно компонента яркости.
...
Получает или задаёт коэффициент выборки компонентов хроминанс относительно компонента яркости.

Значение: Коэффициент дискретизации компонентов хроминанс относительно компонента яркости.
...
Сериализует данные EXIF. Записывает значения тегов и их содержимое. Тег, наиболее влияющий на размер, — содержимое тега Thumbnail.
