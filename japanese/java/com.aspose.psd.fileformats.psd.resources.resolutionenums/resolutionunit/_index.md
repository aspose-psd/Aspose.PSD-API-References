...
description: "resolution info の解像度単位"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.resources.resolutionenums/resolutionunit/
---
...
resolution info の解像度単位
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PxPerCm](#PxPerCm) | センチメートルあたりのピクセル数 |
| [PxPerInch](#PxPerInch) | インチあたりのピクセル数 |
## メソッド
