...
description: "PNG 画像のカラ―タイプを表します。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.png/pngcolortype/
---
...
| [Grayscale](#Grayscale) | 各ピクセルがグレースケールサンプルであるカラータイプを表します。 |
| [GrayscaleWithAlpha](#GrayscaleWithAlpha) | 各ピクセルがグレースケールサンプルに続いてアルファサンプルがあるカラータイプを表します。 |
| [IndexedColor](#IndexedColor) | 各ピクセルがパレットインデックスであるカラータイプを表します。PLTE チャンクが必要です。 |
| [Truecolor](#Truecolor) | 各ピクセルが R,G,B の三要素であるカラータイプを表します。 |
| [TruecolorWithAlpha](#TruecolorWithAlpha) | 各ピクセルがR,G,Bの3つ組に続いてアルファサンプルになるカラータイプを表します。 |
## メソッド
...
各ピクセルがグレースケールサンプルであるカラータイプを表します。
...
各ピクセルがグレースケールサンプルに続いてアルファサンプルがあるカラータイプを表します。
...
各ピクセルがパレットインデックスであるカラータイプを表します。PLTE チャンクが必要です。
...
各ピクセルが R,G,B の三要素であるカラータイプを表します。
...
各ピクセルがR,G,Bの3つ組に続いてアルファサンプルになるカラータイプを表します。
