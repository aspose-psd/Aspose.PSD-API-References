...
description: "この png フィルタタイプ。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.png/pngfiltertype/
---
...
| フィールド | 説明 |
| --- | --- |
| [Adaptive](#Adaptive) | 適応フィルタリングは、保存処理が各データ行に最適なフィルタを選択することを意味します。 |
| [Avg](#Avg) | 平均フィルタは、画像データに適用されることを意味します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | ヌルフィルタは、画像データ行にフィルタリングを行わないことを意味します。 |
| [Paeth](#Paeth) | Paeth 予測フィルタです。 |
| [Sub](#Sub) | サブフィルタは、画像データに減算フィルタリングを適用することを意味します。 |
| [Up](#Up) | アップフィルタは、行ごとの減算フィルタを適用することを意味します。 |
## メソッド
...
適応フィルタリングは、保存処理が各データ行に最適なフィルタを選択することを意味します。最高の圧縮率ですが、実行時間が最も遅くなります。
...
ヌルフィルタは、画像データ行にフィルタリングを行わないことを意味します。
...
サブフィルタは、画像データに減算フィルタリングを適用することを意味します。
...
アップフィルタは、行ごとの減算フィルタを適用することを意味します。
