...
description: "複数の色と適切な位置で定義された線形グラデーションを持つブラシを表します。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.brushes/linearmulticolorgradientbrush/
---
...
複数の色と適切な位置で定義された線形グラデーションを持つ Brush を表します。このクラスは継承できません。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [LinearMulticolorGradientBrush()](#LinearMulticolorGradientBrush--) | デフォルト パラメーターで LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
| [LinearMulticolorGradientBrush(Point point1, Point point2)](#LinearMulticolorGradientBrush-com.aspose.psd.Point-com.aspose.psd.Point-) | 指定されたポイントで LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
| [LinearMulticolorGradientBrush(PointF point1, PointF point2)](#LinearMulticolorGradientBrush-com.aspose.psd.PointF-com.aspose.psd.PointF-) | 指定されたポイントで LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.psd.Rectangle-float-) | 矩形と方向角に基づいて LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.psd.RectangleF-float-) | 矩形と方向角に基づいて LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.psd.Rectangle-float-boolean-) | 矩形と方向角に基づいて LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.psd.RectangleF-float-boolean-) | 矩形と方向角に基づいて LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。 |
## メソッド
...
デフォルトパラメータで LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。開始色は黒、終了色は白、角度は45度で、矩形は (0,0) に位置しサイズは (1,1) です。
...
矩形と方向角に基づいて LinearMulticolorGradientBrush クラスの新しいインスタンスを初期化します。
...
| rect | [Rectangle](../../com.aspose.psd/rectangle) | 線形グラデーションの境界を指定する Aspose.Imaging.RectangleF 構造体です。 |
| 角度 | float | グラデーションの方向線の角度で、x 軸から時計回りに測定した度数です。 |
| isAngleScalable | boolean | true に設定されている場合、この LinearMulticolorGradientBrush での変換中に角度が変更されます。 |
