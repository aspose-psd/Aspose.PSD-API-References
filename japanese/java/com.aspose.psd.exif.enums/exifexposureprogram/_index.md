...
description: "exif 露出プログラム列挙体。"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.exif.enums/exifexposureprogram/
---
...
| フィールド | 説明 |
| --- | --- |
| [Actionprogram](#Actionprogram) | アクションプログラム。 |
| [Aperturepriority](#Aperturepriority) | 絞り優先。 |
| [Auto](#Auto) | 自動露出。 |
| [Creativeprogram](#Creativeprogram) | クリエイティブプログラム。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Landscapemode](#Landscapemode) | 風景モード。 |
| [Manual](#Manual) | マニュアルプログラム。 |
| [Notdefined](#Notdefined) | 未定義。 |
| [Portraitmode](#Portraitmode) | ポートレートモード。 |
| [Shutterpriority](#Shutterpriority) | シャッター優先。 |
## メソッド
