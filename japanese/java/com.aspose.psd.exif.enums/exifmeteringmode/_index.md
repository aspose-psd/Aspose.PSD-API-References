...
description: "exif 測光モード列挙体。"
type: docs
weight: 20
url: /ja/java/com.aspose.psd.exif.enums/exifmeteringmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Average](#Average) | 平均測光 |
| [Centerweightedaverage](#Centerweightedaverage) | 中央重点平均。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MultiSegment](#MultiSegment) | マルチセグメント測光。 |
| [MultiSpot](#MultiSpot) | マルチスポット測光 |
| [Other](#Other) | 他のモード用。 |
| [Partial](#Partial) | 部分測光。 |
| [Spot](#Spot) | スポット測光 |
| [Unknown](#Unknown) | 未定義モード |
## メソッド
