...
type: docs
weight: 16
url: /ja/java/com.aspose.psd.exif.enums/exifflash/
---
...
| [Fired](#Fired) | フラッシュが発光しました。 |
| [FiredReturnLightDetected](#FiredReturnLightDetected) | フラッシュが発光し、帰還光が検出されました。 |
| [FiredReturnLightNotDetected](#FiredReturnLightNotDetected) | フラッシュが発光し、帰還光が検出されませんでした。 |
| [NoAuto](#NoAuto) | フラッシュは発光せず、オートモードです。 |
| [NoCompulsory](#NoCompulsory) | フラッシュは発光せず、強制フラッシュモードです。 |
| [NoDidNotFireReturnLightNotDetected](#NoDidNotFireReturnLightNotDetected) | フラッシュは発光せず、帰還光が検出されませんでした。 |
| [NoFlashFunction](#NoFlashFunction) | フラッシュ機能がありません。 |
| [Noflash](#Noflash) | フラッシュは発光しませんでした。 |
| [YesAuto](#YesAuto) | フラッシュが発光し、オートモードです。 |
| [YesAutoReturnLightDetected](#YesAutoReturnLightDetected) | フラッシュが発光し、オートモード、帰還光が検出されました。 |
| [YesAutoReturnLightNotDetected](#YesAutoReturnLightNotDetected) | フラッシュが発光し、オートモード、帰還光が検出されませんでした。 |
| [YesCompulsory](#YesCompulsory) | フラッシュが発光し、強制フラッシュモードです。 |
| [YesCompulsoryReturnLightDetected](#YesCompulsoryReturnLightDetected) | フラッシュが発光し、強制モード、帰還光が検出されました。 |
| [YesCompulsoryReturnLightNotDetected](#YesCompulsoryReturnLightNotDetected) | フラッシュが発光し、強制モード、帰還光が検出されませんでした。 |
## メソッド
...
フラッシュが発光し、オートモード、帰還光が検出されませんでした。
...
フラッシュが発光し、強制モード、帰還光が検出されませんでした。
