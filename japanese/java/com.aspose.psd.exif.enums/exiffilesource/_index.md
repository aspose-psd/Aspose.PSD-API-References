...
description: "exif ファイルソース列挙体。"
type: docs
weight: 15
url: /ja/java/com.aspose.psd.exif.enums/exiffilesource/
---
...
| フィールド | 説明 |
| --- | --- |
| [DigitalStillCamera](#DigitalStillCamera) | デジタル静止カメラ。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FilmScanner](#FilmScanner) | フィルムスキャナ。 |
| [Others](#Others) | その他。 |
| [ReflexionPrintScanner](#ReflexionPrintScanner) | リフレクションプリントスキャナ。 |
## メソッド
