...
description: "exif センシング方式列挙体。"
type: docs
weight: 24
url: /ja/java/com.aspose.psd.exif.enums/exifsensingmethod/
---
...
| フィールド | 説明 |
| --- | --- |
| [Colorsequentialarea](#Colorsequentialarea) | カラーシーケンシャル領域。 |
| [Colorsequentiallinear](#Colorsequentiallinear) | カラーシーケンシャル線形センサー。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Notdefined](#Notdefined) | 未定義。 |
| [OneChipColorArea](#OneChipColorArea) | ワンチップカラー領域。 |
| [ThreeChipColorArea](#ThreeChipColorArea) | スリーチップカラー領域。 |
| [Trilinearsensor](#Trilinearsensor) | トリリニアセンサー。 |
| [TwoChipColorArea](#TwoChipColorArea) | ツーチップカラー領域。 |
## メソッド
