...
description: "Photoshop のリーディングタイプは、行間の距離のタイプです。"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
Photoshop のリーディングタイプ（行間の距離の種類）です。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | 下から下へのリーディングです。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | 上から上へのリーディングです。 |
## メソッド
