...
description: "Photoshop の自動カーニングモードのシンボル間距離です。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd.layers.text.rendering/autokerning/
---
...
Photoshop の自動カーニングモード（シンボル間の距離）です。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | 手動カーニング値です。 |
| [Metric](#Metric) | メトリックカーニングはカーンペアを使用し、ほとんどのフォント（デザイナー提供）に含まれています。 |
| [Optical](#Optical) | 光学カーニングは隣接する文字間のスペースを文字の形状に基づいて調整します。 |
## メソッド
...
メトリックカーニングはカーンペアを使用し、ほとんどのフォント（デザイナー提供）に含まれています。
...
光学カーニングは隣接する文字間のスペースを文字の形状に基づいて調整します。
