...
description: "これはフォントのベースラインです。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.text.rendering/fontbaseline/
---
...
| [None](#None) | ベースラインの値がありません |
| [Subscript](#Subscript) | 下付き文字のベースラインです。 |
| [Superscript](#Superscript) | 上付き文字のベースラインです。 |
## メソッド
