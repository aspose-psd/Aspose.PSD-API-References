...
description: "テキストの配置モードです。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.fileformats.psd.layers.text.rendering/justificationmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Center](#Center) | 中央揃えのテキストです。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Left](#Left) | 左揃えのテキストです。 |
| [Right](#Right) | 右揃えのテキストです。 |
## メソッド
...
左揃えのテキストです。左から右へのモードでは、左位置は左です。右から左へのモードでは、左位置は右です。
...
右揃えのテキストです。左から右へのモードでは、右位置は右です。右から左へのモードでは、右位置は左です。
