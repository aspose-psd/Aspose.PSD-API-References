...
description: "Tiff 画像例外です"
type: docs
weight: 19
url: /ja/java/com.aspose.psd.coreexceptions.imageformats/tiffimageexception/
---
...
| Constructor | 説明 |
| --- | --- |
| [TiffImageException(String message)](#TiffImageException-java.lang.String-) | TiffImageException クラスの新しいインスタンスを初期化します。 |
| [TiffImageException(String message, Throwable innerException)](#TiffImageException-java.lang.String-java.lang.Throwable-) | TiffImageException クラスの新しいインスタンスを初期化します。 |
| [TiffImageException(String message, int error)](#TiffImageException-java.lang.String-int-) | TiffImageException クラスの新しいインスタンスを初期化します。 |
| [TiffImageException(int error)](#TiffImageException-int-) | TiffImageException クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getOptionsError()](#getOptionsError--) | tiff オプションエラーを取得します。 |
