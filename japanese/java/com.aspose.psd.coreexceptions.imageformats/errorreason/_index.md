...
description: "エラーの原因を表します。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.coreexceptions.imageformats/jpegloadexception.errorreason/
---
...
| フィールド | 説明 |
| --- | --- |
| [BasicError](#BasicError) | 基本的なエラータイプです。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NotEnoughData](#NotEnoughData) | ストリームのデータが不足しています。 |
## メソッド
