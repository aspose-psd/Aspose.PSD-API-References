...
description: "塗りつぶしレイヤーです。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
塗りつぶしレイヤー。カラー塗りつぶし、グラデーション塗りつぶし、またはパターン塗りつぶしレイヤーは、FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#setFillSettings-IFillSettings-)) によって異なります
## フィールド
...
| [createInstance(int fillType)](#createInstance-int-) | 塗りタイプで [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) クラスの新しいインスタンスを構築します。 |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) のレンダリングプロセッサを取得します。 |
| [getFillOpacity()](#getFillOpacity--) | 塗りつぶしの不透明度を取得または設定します。 |
| [getFillSettings()](#getFillSettings--) | 塗りつぶし設定を取得します。 |
| [getFillType()](#getFillType--) | 塗りつぶしのタイプを取得します。 |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | 塗りつぶし設定を取得します。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 実際の [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) に従って Fill Layer ピクセルデータを更新します。 |
...
塗りタイプで [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) クラスの新しいインスタンスを構築します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fillType | int | 塗りレイヤーのタイプ。 |
...
[FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) のレンダリングプロセッサを取得します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | レンダリング先の画像。 |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | 処理対象の境界。 |

**Returns:**
com.aspose.internal.IPartialProcessor - [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) のレンダリングプロセッサを返します。
...
実際の [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) に従って Fill Layer ピクセルデータを更新します。
