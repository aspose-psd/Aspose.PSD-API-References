...
description: "アートボード レイヤークラスです。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | レイヤーをレイヤー グループに追加します。 |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | レイヤーをレイヤー グループに追加します。 |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | レイヤー グループを追加します。 |
...
| [buildGroupLayerMarkers_internalized(String groupName, PsdHeader psdHeader, IColorPalette colorPalette, int layerNestingLevel)](#buildGroupLayerMarkers-internalized-java.lang.String-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-int-) | 開始グループマーカーと終了グループマーカーを作成します。 |
...
| [getBackgroundColor()](#getBackgroundColor--) | アートボードの背景色を取得または設定します。 |
...
| [getLayers()](#getLayers--) | レイヤー グループ内のレイヤーを取得します |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | ArtboardLayer の実際の境界を取得します。 |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | リソースから  LayerSectionResource  を取得します。 |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | ArtboardLayer が背景色を持つかどうかを示す値を取得または設定します。 |
...
| [isOpen()](#isOpen--) | フォルダーが開かれているかを取得または設定します。true に設定すると、起動時にグループは開いた状態になり、そうでなければ最小化された状態になります。 |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | アートボードの背景色を取得または設定します。 |
...
| [setOpen(boolean value)](#setOpen-boolean-) | フォルダーが開かれているかを取得または設定します。true に設定すると、起動時にグループは開いた状態になり、そうでなければ最小化された状態になります。 |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | レイヤーです。 |
| index | int | レイヤーが挿入されるインデックスです。無効な値はレイヤーリストの末尾を意味します。 |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - 2 つの LayerGroup オブジェクトの配列を返します。最初の [0] が開始グループマーカーで、2 番目の [1] が終了グループマーカーです。
### cacheData() {#cacheData--}
```
...
リソースから  LayerSectionResource  を取得します。
...
ArtboardLayer が背景色を持つかどうかを示す値を取得または設定します。
...
フォルダーが開かれているかを取得または設定します。true に設定すると、起動時にグループは開いた状態になり、そうでなければ最小化された状態になります。
