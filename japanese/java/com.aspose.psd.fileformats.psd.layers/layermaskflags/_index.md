...
description: "レイヤーマスクフラグ"
type: docs
weight: 24
url: /ja/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| フィールド | 説明 |
| --- | --- |
| [Disabled](#Disabled) | レイヤーマスクは無効です。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | ブレンド時にレイヤーマスクを反転します。 |
| [None](#None) | フラグは定義されていません。 |
| [RelativeToLayer](#RelativeToLayer) | 位置はレイヤーに対して相対的です。 |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | ユーザーマスクが実際に他のデータのレンダリングから来たことを示します。 |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | ユーザーおよび/またはベクターマスクにパラメータが適用されていることを示します。 |
## メソッド
...
ユーザーマスクが実際に他のデータのレンダリングから来たことを示します。
...
ユーザーおよび/またはベクターマスクにパラメータが適用されていることを示します。
