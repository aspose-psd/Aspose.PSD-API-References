...
description: "レイヤーのブレンドモードです。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers/blendmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Absent](#Absent) | ブレンドモードが存在しないか、まだ設定されていません。 |
| [Color](#Color) | カラー ブレンドモードです。 |
| [ColorBurn](#ColorBurn) | カラー バーン ブレンドモード。 |
| [ColorDodge](#ColorDodge) | カラー ドッジ ブレンドモード。 |
| [Darken](#Darken) | 暗くするブレンドモード。 |
| [DarkerColor](#DarkerColor) | 暗いカラー ブレンドモード。 |
| [Difference](#Difference) | 差分ブレンドモード。 |
| [Dissolve](#Dissolve) | ディゾルブ ブレンドモード。 |
| [Divide](#Divide) | 除算ブレンドモード。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Exclusion](#Exclusion) | 除外ブレンドモード。 |
| [HardLight](#HardLight) | ハードライト ブレンドモード。 |
| [HardMix](#HardMix) | ハードミックス ブレンドモード。 |
| [Hue](#Hue) | 色相ブレンドモード。 |
| [Lighten](#Lighten) | 明るくするブレンドモード。 |
| [LighterColor](#LighterColor) | 明るいカラー ブレンドモード。 |
| [LinearBurn](#LinearBurn) | リニアバーン ブレンドモード。 |
| [LinearDodge](#LinearDodge) | リニアドッジ ブレンドモード。 |
| [LinearLight](#LinearLight) | リニアライト ブレンドモード。 |
| [Luminosity](#Luminosity) | 輝度ブレンドモード。 |
| [Multiply](#Multiply) | 乗算ブレンドモード。 |
| [Normal](#Normal) | 通常ブレンドモード。 |
| [Overlay](#Overlay) | オーバーレイ ブレンドモード。 |
| [PassThrough](#PassThrough) | パススルー ブレンドモード。 |
| [PinLight](#PinLight) | ピンライト ブレンドモード。 |
| [Saturation](#Saturation) | 彩度ブレンドモード。 |
| [Screen](#Screen) | スクリーン ブレンドモード。 |
| [SoftLight](#SoftLight) | ソフトライト ブレンドモード。 |
| [Subtract](#Subtract) | 減算ブレンドモード。 |
| [VividLight](#VividLight) | ビビッドライトブレンドモード。 |
## メソッド
