...
description: "レイヤーフラグです"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.fileformats.psd.layers/layerflags/
---
...
| [HasUsefulInformation](#HasUsefulInformation) | Photoshop 5.0 以降の場合は 1 で、ビット 4 に有用な情報があるかどうかを示します。 |
| [Obsolete](#Obsolete) | 廃止されたフラグ |
| [PixelDataIrrelevantToAppearenceInDocument](#PixelDataIrrelevantToAppearenceInDocument) | ドキュメントの外観に関係のないピクセルデータ |
| [TransparencyProtected](#TransparencyProtected) | 透過が保護されています |
| [Undocumented](#Undocumented) | 文書化されていないフラグ |
| [Visible](#Visible) | 表示フラグ |
## メソッド
...
Photoshop 5.0 以降の場合は 1 で、ビット 4 に有用な情報があるかどうかを示します。
