...
description: "シェイプレイヤー。"
type: docs
weight: 29
url: /ja/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Shape layer. Shapeレイヤーと関連リソースの操作ロジックをカプセル化します。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | 新しいインスタンスの [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) クラスを初期化します。 |
## フィールド
...
| [createInstance()](#createInstance--) | 新しいインスタンスの [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) クラスを作成します。 |
...
| [getFill()](#getFill--) | Shapeレイヤー内のシェイプの内部領域の塗り設定。 |
...
| [getPath()](#getPath--) | Shapeレイヤーに存在するパスの集合を取得します。 |
...
| [getStroke()](#getStroke--) | シェイプのストローク設定を取得または設定します。 |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | [global resources changed] が発生したときに呼び出されます。 |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | [resources change] が発生したときに呼び出されます。 |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Shapeレイヤー内のシェイプの内部領域の塗り設定。 |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | シェイプのストローク設定を取得または設定します。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Shapeレイヤーのプロパティからリソースを更新します。 |
...
新しいインスタンスの [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) クラスを初期化します。すべてのリソースはデフォルト状態で作成されます。
...
新しいインスタンスの [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) クラスを作成します。
...
[global resources changed] が発生したときに呼び出されます。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| 送信者 | java.lang.Object | 送信者です。 |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | イベントデータを含む EventArgs インスタンスです。 |
...
[resources change] が発生したときに呼び出されます。
