...
description: "テキストレイヤークラス"
type: docs
weight: 30
url: /ja/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | フォントのサイズを修正します |
...
| [createInstance_internalized()](#createInstance-internalized--) | 新しい [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) クラスのインスタンスを作成します。 |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | 新しい [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) クラスのインスタンスを作成します。 |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | エンジン データを取得します。 |
...
| [getFont()](#getFont--) | フォントを取得します。 |
| [getFonts()](#getFonts--) | テキストレイヤーのフォントセットを取得します。 |
...
| [getInnerText()](#getInnerText--) | レイヤーのテキストを取得します |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | リソース プロセッサーを取得または設定します。 |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | 文字列形式を取得します。 |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | 同期ルートを取得します。 |
| [getText()](#getText--) | テキストを取得します。 |
| [getTextBoundBox()](#getTextBoundBox--) | テキストのバウンド ボックスを取得または設定します。 |
| [getTextColor()](#getTextColor--) | テキストの色を取得します。 |
| [getTextData()](#getTextData--) | テキストの部分を取得します。 |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) リソースを [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) から検索して取得します。 |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | 変更されたかどうかを示す値を取得または設定します。 |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | 指定されたフォントが利用可能かどうかを判定します。 |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | フォントを前処理します。 |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | フォントをデフォルトに置き換えます。 |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | レイヤーのテキストを取得します |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | リソース プロセッサーを取得または設定します。 |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | テキストのバウンド ボックスを取得または設定します。 |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | 変更されたかどうかを示す値を取得または設定します。 |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | リソース内の [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) の境界を更新します。 |
| [updateText(String text)](#updateText-java.lang.String-) | テキストを更新します。 |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | テキストを更新します。 |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | テキストを更新します。 |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | テキストを更新します。 |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | テキストを更新します。 |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | テキストを更新します。 |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | テキストを更新します。 |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | テキストを更新します。 |
| [wait()](#wait--) |  |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| newSize | float | 新しいフォントサイズ |
| yyTransform | double | 'yy' 変換行列パラメータ |
...
新しい [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) クラスのインスタンスを作成します。
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - テキストレイヤーのフォントセットです。
...
[TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) リソースを [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) から検索して取得します。
...
変更されたかどうかを示す値を取得または設定します。

値: true  [was changed] の場合; それ以外の場合は false。
...
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | フォント。 |
| defaultFontName | java.lang.String | フォントのデフォルト名。 |
...
| newWidth | int | 新しい幅です。 |
| newHeight | int | 新しい高さです。 |
| resizeType | int | リサイズ変換のタイプ  ResizeType |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| 値 | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
リソース内の [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) の境界を更新します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | テキストの絶対位置とサイズ。 |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | テキストボックスに対するテキストの位置とサイズ。 |
...
| --- | --- | --- |
| text | java.lang.String | テキストの値。 |
| color | [Color](../../com.aspose.psd/color) | 色の値。 |
...
| --- | --- | --- |
| text | java.lang.String | テキストの値。 |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | 左上の座標。 |
