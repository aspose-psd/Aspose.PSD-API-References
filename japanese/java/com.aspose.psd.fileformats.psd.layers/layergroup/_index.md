...
description: "グループレイヤークラス"
type: docs
weight: 19
url: /ja/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | レイヤー グループの高さを取得します。 |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | LayerGroup 内のすべてのレイヤーの結合境界を取得します。 |
...
| [getWidth()](#getWidth--) | レイヤー グループの幅を取得します。 |
...
LayerGroup 内のすべてのレイヤーの結合境界を取得します。
