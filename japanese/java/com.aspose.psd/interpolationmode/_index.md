...
description: "com.aspose.psd.InterpolationMode 列挙体は、画像が拡大または回転される際に使用されるアルゴリズムを指定します。"
type: docs
weight: 63
url: /ja/java/com.aspose.psd/interpolationmode/
---
...
com.aspose.psd.InterpolationMode 列挙体は、画像が拡大縮小または回転される際に使用されるアルゴリズムを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Bicubic](#Bicubic) | 双三次補間を指定します。 |
| [Bilinear](#Bilinear) | 双一次補間を指定します。 |
| [Default](#Default) | 既定のモードを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [High](#High) | 高品質の補間を指定します。 |
| [HighQualityBicubic](#HighQualityBicubic) | 高品質の双三次補間を指定します。 |
| [HighQualityBilinear](#HighQualityBilinear) | 高品質の双一次補間を指定します。 |
| [Invalid](#Invalid) | 無効な補間モードです。 |
...
双三次補間を指定します。事前フィルタリングは行われません。このモードは、画像を元のサイズの 25% 未満に縮小する場合には適していません。
...
双一次補間を指定します。事前フィルタリングは行われません。このモードは、画像を元のサイズの 50% 未満に縮小する場合には適していません。
...
高品質の双三次補間を指定します。高品質な縮小を保証するために事前フィルタリングが実行されます。このモードは最高品質の変換画像を生成します。
