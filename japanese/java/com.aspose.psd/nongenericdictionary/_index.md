...
description: "非ジェネリック辞書を表します。"
type: docs
weight: 72
url: /ja/java/com.aspose.psd/nongenericdictionary/
---
...
| [getKeys()](#getKeys--) |  |
| [getKeysTyped()](#getKeysTyped--) | キーの強く型付けされたコレクションを取得します。 |
| [getSyncRoot()](#getSyncRoot--) |  |
| [getValues()](#getValues--) |  |
| [getValuesTyped()](#getValuesTyped--) | 値の強く型付けされたコレクションを取得します。 |
...
キーの強く型付けされたコレクションを取得します。

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<K> - キーの強く型付けされたコレクション。
### getSyncRoot() {#getSyncRoot--}
```
...
値の強く型付けされたコレクションを取得します。

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<V> - 値の強く型付けされたコレクション。
### get_Item(TKey arg0) {#get-Item-TKey-}
```
