...
description: "シーク用に StreamContainer の参照ポイントを表すフィールドを提供します。"
type: docs
weight: 95
url: /ja/java/com.aspose.psd/seekorigin/
---
...
シーク用に StreamContainer 内の参照ポイントを表すフィールドを提供します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Begin](#Begin) | ストリームの開始位置を指定します。 |
| [Current](#Current) | ストリーム内の現在位置を指定します。 |
| [End](#End) | ストリームの終了位置を指定します。 |
