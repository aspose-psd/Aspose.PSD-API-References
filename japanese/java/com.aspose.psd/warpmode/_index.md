...
description: "適用されるワープ変換のタイプを指定します。"
type: docs
weight: 112
url: /ja/java/com.aspose.psd/warpmode/
---
...
適用されるワープ変換のタイプを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Bilinear](#Bilinear) | 双一次ワープを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Perspective](#Perspective) | パースペクティブワープを指定します。 |
## メソッド
