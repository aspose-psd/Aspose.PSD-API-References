...
description: "レイアウト形状に完全に収まらない文字列から文字をトリミングする方法を指定します。"
type: docs
weight: 108
url: /ja/java/com.aspose.psd/stringtrimming/
---
...
| フィールド | 説明 |
| --- | --- |
| [Character](#Character) | テキストが最も近い文字までトリミングされることを指定します。 |
| [EllipsisCharacter](#EllipsisCharacter) | テキストが最も近い文字までトリミングされ、トリミングされた行の末尾に省略記号が挿入されることを指定します。 |
| [EllipsisPath](#EllipsisPath) | トリミングされた行の中央が削除され、省略記号で置き換えられます。 |
| [EllipsisWord](#EllipsisWord) | テキストが最も近い単語までトリミングされ、トリミングされた行の末尾に省略記号が挿入されることを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | トリミングしないことを指定します。 |
| [Word](#Word) | テキストが最も近い単語までトリミングされることを指定します。 |
## メソッド
...
テキストが最も近い文字までトリミングされ、トリミングされた行の末尾に省略記号が挿入されることを指定します。
...
トリミングされた行の中央が削除され、省略記号で置き換えられます。アルゴリズムは、行の最後のスラッシュ区切りセグメントをできるだけ多く保持します。
...
テキストが最も近い単語までトリミングされ、トリミングされた行の末尾に省略記号が挿入されることを指定します。
