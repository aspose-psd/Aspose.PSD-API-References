...
description: "CMYK（シアン、マゼンタ、イエロー、ブラック）カラースペースの個々のチャンネルを指定します。"
type: docs
weight: 22
url: /ja/java/com.aspose.psd/colorchannelflag/
---
...
| フィールド | 説明 |
| --- | --- |
| [ColorChannelC](#ColorChannelC) | シアン カラーチャンネル。 |
| [ColorChannelK](#ColorChannelK) | ブラック カラーチャンネル。 |
| [ColorChannelLast](#ColorChannelLast) | 最後に選択されたチャンネルを使用すべきです。 |
| [ColorChannelM](#ColorChannelM) | マゼンタ色チャンネル。 |
| [ColorChannelY](#ColorChannelY) | 黄色チャンネル。 |
