...
type: docs
weight: 32
url: /ja/java/com.aspose.psd/compositingquality/
---
...
| フィールド | 説明 |
| --- | --- |
| [AssumeLinear](#AssumeLinear) | 線形値とみなします。 |
| [Default](#Default) | デフォルトの品質です。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GammaCorrected](#GammaCorrected) | ガンマ補正が使用されます。 |
| [HighQuality](#HighQuality) | 高品質・低速の合成です。 |
| [HighSpeed](#HighSpeed) | 高速・低品質です。 |
| [Invalid](#Invalid) | 無効な品質です。 |
## メソッド
