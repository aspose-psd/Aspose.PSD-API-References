...
description: "破線の各ダッシュの両端に使用するグラフィック形状のタイプを指定します。"
type: docs
weight: 35
url: /ja/java/com.aspose.psd/dashcap/
---
...
破線の各ダッシュの両端に使用するグラフィック形状のタイプを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Flat](#Flat) | 各ダッシュの両端を四角く整える四角形キャップを指定します。 |
| [Round](#Round) | 各ダッシュの両端を丸く整える円形キャップを指定します。 |
| [Triangle](#Triangle) | 各ダッシュの両端を三角形に尖らせる三角形キャップを指定します。 |
## メソッド
...
各ダッシュの両端を三角形に尖らせる三角形キャップを指定します。
