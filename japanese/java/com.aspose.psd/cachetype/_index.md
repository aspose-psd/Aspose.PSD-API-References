...
description: "使用するキャッシュタイプを指定します。"
type: docs
weight: 15
url: /ja/java/com.aspose.psd/cachetype/
---
...
| フィールド | 説明 |
| --- | --- |
| [Auto](#Auto) | 自動キャッシュタイプを指定します。 |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | メモリ内キャッシュのみ。 |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | ディスクキャッシュのみ。 |
...
自動キャッシュタイプを指定します。自動キャッシュ方式は、まずメモリ内にキャッシュし、次にディスクにキャッシュしようとします。
