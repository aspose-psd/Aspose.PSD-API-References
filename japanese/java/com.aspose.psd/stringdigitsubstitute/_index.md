...
description: "この列挙は、ユーザーのロケールまたは言語に従って文字列内の数字を置換する方法を指定します。"
type: docs
weight: 105
url: /ja/java/com.aspose.psd/stringdigitsubstitute/
---
...
| [National](#National) | ユーザーのロケールの公式な国語に対応する置換数字を指定します。 |
| [None](#None) | 置換を無効にすることを指定します。 |
| [Traditional](#Traditional) | ユーザーのロケールの公式な国語とは異なる場合がある、ユーザーの母語またはスクリプトに対応する置換数字を指定します。 |
| [User](#User) | ユーザー定義の置換スキームを指定します。 |
## メソッド
...
ユーザーのロケールの公式な国語に対応する置換数字を指定します。
...
ユーザーのロケールの公式な国語とは異なる場合がある、ユーザーの母語またはスクリプトに対応する置換数字を指定します。
