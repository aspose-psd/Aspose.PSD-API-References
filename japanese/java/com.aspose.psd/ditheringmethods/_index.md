...
description: "カラー変換を制御するために使用されるディザリング手法です。"
type: docs
weight: 41
url: /ja/java/com.aspose.psd/ditheringmethods/
---
...
| フィールド | 説明 |
| --- | --- |
| [CustomConverter](#CustomConverter) | カスタムコンバータです。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | パレットは無視されず、適切なカラー変換が適用されるべきです。 |
| [PaletteIgnore](#PaletteIgnore) | パレットは無視されます |
## メソッド
