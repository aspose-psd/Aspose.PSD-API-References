...
description: "Pen オブジェクトが線を終端する際に使用できる利用可能なキャップスタイルを指定します。"
type: docs
weight: 66
url: /ja/java/com.aspose.psd/linecap/
---
...
Pen オブジェクトが線の終端に使用できる利用可能なキャップスタイルを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [AnchorMask](#AnchorMask) | カスタムラインキャップを指定します。 |
| [ArrowAnchor](#ArrowAnchor) | 矢印形状のアンカーキャップを指定します。 |
| [Custom](#Custom) | ラインキャップがアンカーキャップかどうかを確認するために使用されるマスクを指定します。 |
| [DiamondAnchor](#DiamondAnchor) | ダイヤモンド形アンカーキャップを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Flat](#Flat) | フラットなラインキャップを指定します。 |
| [NoAnchor](#NoAnchor) | アンカーなしを指定します。 |
| [Round](#Round) | 丸いラインキャップを指定します。 |
| [RoundAnchor](#RoundAnchor) | 丸いアンカーキャップを指定します。 |
| [Square](#Square) | 四角いラインキャップを指定します。 |
| [SquareAnchor](#SquareAnchor) | 四角いアンカーラインキャップを指定します。 |
| [Triangle](#Triangle) | 三角形のラインキャップを指定します。 |
## メソッド
...
ラインキャップがアンカーキャップかどうかを確認するために使用されるマスクを指定します。
