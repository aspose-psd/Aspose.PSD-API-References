...
type: docs
weight: 86
url: /ja/java/com.aspose.psd/rasterimage/
---
...
ラスター グラフィックス操作をサポートするラスター画像を表します。
## フィールド
...
| [crop(Rectangle rectangle)](#crop-com.aspose.psd.Rectangle-) | 指定された矩形を切り取ります。 |
...
| [resize(int newWidth, int newHeight, ImageResizeSettings settings)](#resize-int-int-com.aspose.psd.ImageResizeSettings-) | 拡張オプションで画像のサイズを変更します。 |
