...
description: "テクスチャまたはグラデーションが塗りつぶし領域より小さい場合のタイル配置方法を指定します。"
type: docs
weight: 113
url: /ja/java/com.aspose.psd/wrapmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Clamp](#Clamp) | テクスチャまたはグラデーションはタイル化されません。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Tile](#Tile) | グラデーションまたはテクスチャをタイル化します。 |
| [TileFlipX](#TileFlipX) | テクスチャまたはグラデーションを水平に反転し、次にタイル化します。 |
| [TileFlipXY](#TileFlipXY) | テクスチャまたはグラデーションを水平・垂直に反転し、次にタイル化します。 |
| [TileFlipY](#TileFlipY) | テクスチャまたはグラデーションを垂直に反転し、次にタイル化します。 |
## メソッド
...
テクスチャまたはグラデーションを水平に反転し、次にタイル化します。
...
テクスチャまたはグラデーションを水平・垂直に反転し、次にタイル化します。
...
テクスチャまたはグラデーションを垂直に反転し、次にタイル化します。
