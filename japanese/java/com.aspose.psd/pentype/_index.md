...
description: "Pen オブジェクトが線を塗りつぶす際に使用する塗りタイプを指定します。"
type: docs
weight: 79
url: /ja/java/com.aspose.psd/pentype/
---
...
Pen オブジェクトが線を塗りつぶす際に使用する塗りタイプを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HatchFill](#HatchFill) | ハッチ塗りを指定します。 |
| [LinearGradient](#LinearGradient) | 線形グラデーション塗りを指定します。 |
| [PathGradient](#PathGradient) | パス グラデーション塗りを指定します。 |
| [SolidColor](#SolidColor) | 単色塗りを指定します。 |
| [TextureFill](#TextureFill) | ビットマップテクスチャ塗りを指定します。 |
## メソッド
