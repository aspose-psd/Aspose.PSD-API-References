...
description: "使用する画像フィルター"
type: docs
weight: 58
url: /ja/java/com.aspose.psd/imagefiltertype/
---
...
| フィールド | 説明 |
| --- | --- |
| [BigRectangular](#BigRectangular) | 大きな長方形フィルタ |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | フィルタは使用されません |
| [SmallRectangular](#SmallRectangular) | 小さな長方形フィルタ |
## メソッド
