...
description: "閉じたパスの内部がどのように塗りつぶされるかを指定します。"
type: docs
weight: 45
url: /ja/java/com.aspose.psd/fillmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Alternate](#Alternate) | 代替塗りつぶしモードを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Winding](#Winding) | ワインディング塗りつぶしモードを指定します。 |
## メソッド
