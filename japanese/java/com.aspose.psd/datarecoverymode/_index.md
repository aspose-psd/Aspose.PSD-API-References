...
description: "データ復旧モードです。"
type: docs
weight: 37
url: /ja/java/com.aspose.psd/datarecoverymode/
---
...
| フィールド | 説明 |
| --- | --- |
| [ConsistentRecover](#ConsistentRecover) | 一貫したリカバリーモードは、破損がファイル形式を壊さない限りすべてのデータを復元し、正しい後続処理を可能にします。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MaximalRecover](#MaximalRecover) | 最大リカバリーモードは、ファイル形式が破損した構造であってもすべてのデータを復元し、後続の処理が予期しない結果をもたらす可能性があります。 |
| [None](#None) | データ復元は行われません。 |
## メソッド
...
一貫したリカバリーモードは、破損がファイル形式を壊さない限りすべてのデータを復元し、正しい後続処理を可能にします。
...
最大リカバリーモードは、ファイル形式が破損した構造であってもすべてのデータを復元し、後続の処理が予期しない結果をもたらす可能性があります。
...
データ復元は行われません。ファイル形式に破損したデータがある場合は、適切な例外がスローされます。
