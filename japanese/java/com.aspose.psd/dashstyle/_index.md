...
description: "Pen オブジェクトで描画される破線のスタイルを指定します。"
type: docs
weight: 36
url: /ja/java/com.aspose.psd/dashstyle/
---
...
| フィールド | 説明 |
| --- | --- |
| [Custom](#Custom) | ユーザー定義のカスタム破線スタイルを指定します。 |
| [Dash](#Dash) | 破線で構成された線を指定します。 |
| [DashDot](#DashDot) | 破線と点の繰り返しパターンで構成された線を指定します。 |
| [DashDotDot](#DashDotDot) | 破線・点・点の繰り返しパターンで構成された線を指定します。 |
| [Dot](#Dot) | 点で構成された線を指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Solid](#Solid) | 実線を指定します。 |
## メソッド
