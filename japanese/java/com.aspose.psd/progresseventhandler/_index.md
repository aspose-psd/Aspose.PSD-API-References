...
description: "プログレス イベント ハンドラ 関数の参照"
type: docs
weight: 84
url: /ja/java/com.aspose.psd/progresseventhandler/
---
...
| [hashCode()](#hashCode--) |  |
| [invoke(ProgressEventHandlerInfo info)](#invoke-com.aspose.psd.progressmanagement.ProgressEventHandlerInfo-) | プログレス イベント ハンドラ 関数の参照 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| info | [ProgressEventHandlerInfo](../../com.aspose.psd.progressmanagement/progresseventhandlerinfo) | プログレスイベントハンドラのデータです。 |
