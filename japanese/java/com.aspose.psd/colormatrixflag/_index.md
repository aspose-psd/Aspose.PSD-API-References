...
description: "ImageAttributes のカラーおよびグレースケール調整設定の影響を受ける画像と色のタイプを指定します。"
type: docs
weight: 26
url: /ja/java/com.aspose.psd/colormatrixflag/
---
...
ImageAttributes のカラーおよびグレースケール調整設定の影響を受ける画像とカラーのタイプを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [AltGrays](#AltGrays) | グレーの濃淡のみが調整されます。 |
| [Default](#Default) | グレーの濃淡を含むすべての色値が同じカラー調整マトリックスで調整されます。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [SkipGrays](#SkipGrays) | すべての色が調整されますが、グレーの濃淡は調整されません。 |
## メソッド
...
グレーの濃淡を含むすべての色値が同じカラー調整マトリックスで調整されます。
...
すべての色が調整されますが、グレーの濃淡は調整されません。グレーの濃淡とは、赤、緑、青の各成分の値が同じである任意の色を指します。
