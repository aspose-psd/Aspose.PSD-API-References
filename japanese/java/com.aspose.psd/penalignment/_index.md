...
description: "Pen オブジェクトの理論上のゼロ幅ラインに対する配置を指定します。"
type: docs
weight: 78
url: /ja/java/com.aspose.psd/penalignment/
---
...
Pen オブジェクトの理論的なゼロ幅線に対する配置を指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Center](#Center) | Pen オブジェクトが理論上のラインの中央に配置されていることを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inset](#Inset) | Pen が理論上のラインの内側に配置されていることを指定します。 |
| [Left](#Left) | Pen が理論上のラインの左側に配置されていることを指定します。 |
| [Outset](#Outset) | Pen が理論上のラインの外側に配置されていることを指定します。 |
| [Right](#Right) | Pen が理論上のラインの右側に配置されていることを指定します。 |
## メソッド
...
Pen オブジェクトが理論上のラインの中央に配置されていることを指定します。
...
Pen が理論上のラインの内側に配置されていることを指定します。
...
Pen が理論上のラインの左側に配置されていることを指定します。
...
Pen が理論上のラインの外側に配置されていることを指定します。
...
Pen が理論上のラインの右側に配置されていることを指定します。
