...
description: "回転テスト モードです。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd/rastercachedimage.rotatetestmode/
---
...
| フィールド | 説明 |
| --- | --- |
| [ByteArrayMode](#ByteArrayMode) | バイト配列モード |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [RegularMode](#RegularMode) | 通常モード |
| [StreamMode](#StreamMode) | ストリームモード |
## メソッド
