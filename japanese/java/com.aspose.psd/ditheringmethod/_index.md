...
description: "ディザリング手法です。"
type: docs
weight: 40
url: /ja/java/com.aspose.psd/ditheringmethod/
---
...
| [FloydSteinbergDithering](#FloydSteinbergDithering) | Floyd‑Steinbergディザリングです。 |
| [ThresholdDithering](#ThresholdDithering) | 閾値ディザリングです。 |
## メソッド
...
Floyd‑Steinbergディザリング。より複雑なディザリングアルゴリズムで、最近傍の輝度値を使用します。
...
閾値ディザリング。最もシンプルで高速なディザリングアルゴリズムです。
