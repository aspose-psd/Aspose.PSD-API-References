...
description: "GraphicsPath オブジェクトに含まれる図形サブパス内の連続する直線または曲線セグメントの結合方法を指定します。"
type: docs
weight: 67
url: /ja/java/com.aspose.psd/linejoin/
---
...
GraphicsPath オブジェクトに含まれる図形（サブパス）内の連続する直線または曲線セグメントの結合方法を指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Bevel](#Bevel) | ベベル結合を指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Miter](#Miter) | ミタージョインを指定します。 |
| [MiterClipped](#MiterClipped) | ミタージョインを指定します。 |
| [Round](#Round) | 円形結合を指定します。 |
## メソッド
...
ミタージョインを指定します。ミターの長さがミターリミットを超えるかどうかに応じて、鋭い角または切り取られた角が生成されます。
...
ミタージョインを指定します。ミターの長さがミターリミットを超えるかどうかに応じて、鋭い角またはベベル角が生成されます。
...
円形結合を指定します。これにより、線間に滑らかな円弧が生成されます。
