...
description: "テキストに関連するホットキー接頭辞の表示タイプを指定します。"
type: docs
weight: 53
url: /ja/java/com.aspose.psd/hotkeyprefix/
---
...
テキストに関連するホットキー接頭辞の表示タイプを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Hide](#Hide) | ホットキーのプレフィックスを表示しません。 |
| [None](#None) | ホットキーのプレフィックスなし。 |
| [Show](#Show) | ホットキーのプレフィックスを表示します。 |
## メソッド
