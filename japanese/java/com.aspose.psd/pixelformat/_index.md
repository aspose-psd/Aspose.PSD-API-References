...
description: "ピクセルデータ形式の実際の意味です。"
type: docs
weight: 81
url: /ja/java/com.aspose.psd/pixelformat/
---
...
| フィールド | 説明 |
| --- | --- |
| [Bgr](#Bgr) | BGR カラースペースです。 |
| [CieLab](#CieLab) | CIE Lab カラースペースです。 |
| [Cmyk](#Cmyk) | CMYK カラースペースです。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | グレースケール カラースペース |
| [Rgb](#Rgb) | RGB カラースペースです。 |
| [YCbCr](#YCbCr) | YCbCr カラースペースです。 |
| [Ycck](#Ycck) | YCCK カラースペースです。 |
## メソッド
