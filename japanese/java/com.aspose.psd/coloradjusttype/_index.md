...
description: "どのオブジェクトがカラー調整情報を使用するかを指定します。"
type: docs
weight: 20
url: /ja/java/com.aspose.psd/coloradjusttype/
---
...
| --- | --- |
| [Any](#Any) | 指定されたタイプの数。 |
| [Bitmap](#Bitmap) | Bitmap オブジェクト用のカラー調整情報。 |
| [Brush](#Brush) | Brush オブジェクト用のカラー調整情報。 |
| [Count](#Count) | 指定されたタイプの数。 |
| [Default](#Default) | 独自のカラー調整情報を持たないすべての GDI+ オブジェクトで使用されるカラー調整情報。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pen](#Pen) | Pen オブジェクト用のカラー調整情報。 |
| [Text](#Text) | テキスト用のカラー調整情報。 |
## メソッド
...
独自のカラー調整情報を持たないすべての GDI+ オブジェクトで使用されるカラー調整情報。
