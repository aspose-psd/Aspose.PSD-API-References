...
type: docs
weight: 94
url: /ja/java/com.aspose.psd/rotatefliptype/
---
...
| [Rotate180FlipNone](#Rotate180FlipNone) | 180 度の時計回り回転でフリップしないことを指定します。 |
| [Rotate180FlipX](#Rotate180FlipX) | 180 度の時計回り回転に続いて水平フリップを指定します。 |
| [Rotate180FlipXY](#Rotate180FlipXY) | 180 度の時計回り回転に続いて水平および垂直フリップを指定します。 |
| [Rotate180FlipY](#Rotate180FlipY) | 180 度の時計回り回転に続いて垂直フリップを指定します。 |
| [Rotate270FlipNone](#Rotate270FlipNone) | 270 度の時計回り回転でフリップしないことを指定します。 |
| [Rotate270FlipX](#Rotate270FlipX) | 270 度の時計回り回転に続いて水平フリップを指定します。 |
| [Rotate270FlipXY](#Rotate270FlipXY) | 270 度の時計回り回転に続いて水平および垂直フリップを指定します。 |
| [Rotate270FlipY](#Rotate270FlipY) | 270 度の時計回り回転に続いて垂直フリップを指定します。 |
| [Rotate90FlipNone](#Rotate90FlipNone) | 画像がどれだけ回転するかと、画像をフリップする際に使用する軸を指定します。 |
| [Rotate90FlipX](#Rotate90FlipX) | 90 度の時計回り回転に続いて水平フリップを指定します。 |
| [Rotate90FlipXY](#Rotate90FlipXY) | 90 度の時計回り回転に続いて水平および垂直フリップを指定します。 |
| [Rotate90FlipY](#Rotate90FlipY) | 90 度の時計回り回転に続いて垂直フリップを指定します。 |
| [RotateNoneFlipNone](#RotateNoneFlipNone) | 時計回り回転もフリップもしないことを指定します。 |
| [RotateNoneFlipX](#RotateNoneFlipX) | 時計回り回転なしで水平フリップを指定します。 |
| [RotateNoneFlipXY](#RotateNoneFlipXY) | 時計回り回転なしで水平および垂直フリップを指定します。 |
| [RotateNoneFlipY](#RotateNoneFlipY) | 時計回り回転なしで垂直フリップを指定します。 |
## メソッド
...
180 度の時計回り回転に続いて水平および垂直フリップを指定します。
...
270 度の時計回り回転に続いて水平および垂直フリップを指定します。
...
画像がどれだけ回転するかと、画像をフリップする際に使用する軸を指定します。
...
90 度の時計回り回転に続いて水平および垂直フリップを指定します。
