...
description: "サポートされている PSD ファイル形式の一つです。"
type: docs
weight: 43
url: /ja/java/com.aspose.psd/fileformat/
---
...
サポートされている PSD ファイル形式の一つです。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Ai](#Ai) | Adobe Illustrator 形式 |
| [Bmp](#Bmp) | Bmp (Dib) ファイル形式。 |
| [Cdr](#Cdr) | CDR ファイル形式 |
| [Cmx](#Cmx) | CMX ファイル形式 |
| [Custom](#Custom) | カスタムファイル形式。 |
| [Dicom](#Dicom) | dicom 形式 |
| [Djvu](#Djvu) | Djvu ファイル形式 |
| [Dng](#Dng) | DNG ファイル形式 |
| [Emf](#Emf) | Emf/Emf+ ファイル形式 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Eps](#Eps) | Encapsulated PostScript 形式 |
| [Gif](#Gif) | Gif ファイル形式。 |
| [Jpeg](#Jpeg) | Jpeg ファイル形式。 |
| [Jpeg2000](#Jpeg2000) | Jpeg2000 ファイル形式 |
| [Odg](#Odg) | Open document graphic 形式 |
| [Otg](#Otg) | otg ファイル形式 |
| [Png](#Png) | Png ファイル形式。 |
| [Psd](#Psd) | Psd ファイル形式。 |
| [Svg](#Svg) | SVG ファイル形式 |
| [Tiff](#Tiff) | Tiff ファイル形式。 |
| [Undefined](#Undefined) | 未定義のファイル形式。 |
| [Webp](#Webp) | webp ファイル形式 |
| [Wmf](#Wmf) | Wmf ファイル形式 |
## メソッド
