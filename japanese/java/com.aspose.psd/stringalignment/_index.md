...
description: "テキスト文字列のレイアウト矩形に対する配置を指定します。"
type: docs
weight: 104
url: /ja/java/com.aspose.psd/stringalignment/
---
...
テキスト文字列のレイアウト矩形に対する配置を指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Center](#Center) | テキストがレイアウト矩形の中央に配置されることを指定します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Far](#Far) | テキストがレイアウト矩形の原点位置から遠くに配置されることを指定します。 |
| [Near](#Near) | テキストがレイアウトの近くに配置されることを指定します。 |
## メソッド
...
レイアウト矩形の原点位置から遠くにテキストが配置されることを指定します。左から右へのレイアウトでは、遠い位置は右です。右から左へのレイアウトでは、遠い位置は左です。
...
テキストがレイアウトに近い位置に配置されることを指定します。左から右へのレイアウトでは、近い位置は左です。右から左へのレイアウトでは、近い位置は右です。
