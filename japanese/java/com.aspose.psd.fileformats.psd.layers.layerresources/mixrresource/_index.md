...
description: "クラス MixrResource."
type: docs
weight: 61
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource/
---
...
クラス MixrResource。チャンネルミキサー調整レイヤーのリソース
## Constructors

| Constructor | 説明 |
| --- | --- |
| [MixrResource()](#MixrResource--) | 新しい [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) クラスのインスタンスを初期化します。 |
| [MixrResource(byte[] data)](#MixrResource-byte---) | 新しい [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getChannelInfo(int channelIndex)](#getChannelInfo-int-) | チャンネル情報の生データを取得します |
| [getClass()](#getClass--) |  |
...
| [getMonochrome()](#getMonochrome--) | この [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) がモノクロかどうかを示す値を取得または設定します。 |
...
| [setChannelInfo(int channelIndex, byte[] value)](#setChannelInfo-int-byte---) | チャンネル情報を設定します。 |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | この [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) がモノクロかどうかを示す値を取得または設定します。 |
...
新しい [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) クラスのインスタンスを初期化します。PSD フォーマット仕様には次の記述が含まれます: 2 Version ( = 1) 2 Monochrome 20 RGB または CMYK カラーにミキサー設定用の定数が加わります。4 \\* 2 バイトのカラーと 2 バイトの定数。
...
この [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) がモノクロかどうかを示す値を取得または設定します。
