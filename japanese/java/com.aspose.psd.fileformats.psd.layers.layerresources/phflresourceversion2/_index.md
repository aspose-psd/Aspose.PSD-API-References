...
description: "クラス PhflResource."
type: docs
weight: 69
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/
---
...
クラス PhflResource. Exposure Adjustment Layer 2 のリソース バージョン ( = 3 ) または ( = 2 ) 12 4 バイトずつ XYZ カラー用（バージョン 3 のみ） 10 2 バイト カラースペースの後に 4 \* 2 バイト カラーコンポーネント（バージョン 2 のみ） 4 密度 1 輝度保持
## Constructors

| Constructor | 説明 |
| --- | --- |
| [PhflResourceVersion2()](#PhflResourceVersion2--) | 新しい [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) クラスのインスタンスを初期化します。 |
| [PhflResourceVersion2(byte[] data)](#PhflResourceVersion2-byte---) | 新しい [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getClass()](#getClass--) |  |
| [getColorSpace()](#getColorSpace--) | カラー空間を取得します。 |
| [getComponentA()](#getComponentA--) | 色の A コンポーネントを取得または設定します |
| [getComponentB()](#getComponentB--) | B コンポーネントを取得または設定します |
| [getComponentL()](#getComponentL--) | 色の L コンポーネントを取得または設定します |
| [getData()](#getData--) | データを取得または設定します。 |
| [getDensity()](#getDensity--) | 密度を取得または設定します。 |
...
| [getPreserveLuminosity()](#getPreserveLuminosity--) | 輝度の保持 [preserve luminosity] を示す値を取得または設定します。 |
| [getPsdVersion()](#getPsdVersion--) | レイヤーリソースに必要な最小の psd バージョンを取得します。 |
| [getRgbColor()](#getRgbColor--) | 色を取得します。 |
...
| [setColorSpace(short value)](#setColorSpace-short-) | カラー空間を取得します。 |
| [setComponentA(short value)](#setComponentA-short-) | 色の A コンポーネントを取得または設定します |
| [setComponentB(short value)](#setComponentB-short-) | B コンポーネントを取得または設定します |
| [setComponentL(short value)](#setComponentL-short-) | 色の L コンポーネントを取得または設定します |
| [setDensity(int value)](#setDensity-int-) | 密度を取得または設定します。 |
...
| [setPreserveLuminosity(boolean value)](#setPreserveLuminosity-boolean-) | 輝度の保持 [preserve luminosity] を示す値を取得または設定します。 |
| [setRgbColor(Color color)](#setRgbColor-com.aspose.psd.Color-) | RGB カラーを設定します。 |
...
新しい [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) クラスのインスタンスを初期化します。
...
輝度の保持 [preserve luminosity] を示す値を取得または設定します。

値: [preserve luminosity] の場合は true、そうでなければ false。
