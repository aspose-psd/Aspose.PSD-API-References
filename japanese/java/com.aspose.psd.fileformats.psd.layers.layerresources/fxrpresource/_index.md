...
description: "FxrpResource クラス。"
type: docs
weight: 32
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
FxrpResource クラス。レイヤーの基準点。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | 新しいインスタンスを初期化します [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) クラス。 |
| [FxrpResource()](#FxrpResource--) | 新しいインスタンスを初期化します [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) クラス。 |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | 新しいインスタンスを初期化します [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) クラス。 |
## フィールド
...
| [getX()](#getX--) | 基準点の x を取得または設定します |
| [getY()](#getY--) | 基準点の y を取得または設定します |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 指定されたストリームコンテナに保存します。 |
...
| [setX(double value)](#setX-double-) | 基準点の x を取得または設定します |
| [setY(double value)](#setY-double-) | 基準点の y を取得または設定します |
...
新しいインスタンスを初期化します [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) クラス。
...
新しいインスタンスを初期化します [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) クラス。カスタムまたは不明な値で。
