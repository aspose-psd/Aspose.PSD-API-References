...
description: "シートカラー設定の可能な色。"
type: docs
weight: 73
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
シートカラー設定の可能な色。PS のレイヤー一覧でレイヤーの UI 装飾色です。
## フィールド
...
| [Gray](#Gray) | 灰色です。 |
| [Green](#Green) | 緑色です。 |
| [NoColor](#NoColor) | 色が指定されていません。 |
| [Orange](#Orange) | オレンジ色です。 |
| [Red](#Red) | 赤色です。 |
| [Violet](#Violet) | 紫色です。 |
| [Yellow](#Yellow) | 黄色です。 |
## メソッド
