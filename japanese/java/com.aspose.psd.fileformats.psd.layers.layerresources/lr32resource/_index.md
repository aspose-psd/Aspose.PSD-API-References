...
description: "lr32 リソース."
type: docs
weight: 54
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource/
---
...
| Constructor | 説明 |
| --- | --- |
| [Lr32Resource()](#Lr32Resource--) | 新しいインスタンスを初期化します。[Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) クラス。 |
## フィールド
...
| [getLayers()](#getLayers--) | レイヤーを取得または設定します。 |
| [getLength()](#getLength--) | 画像の PSD ヘッダー バージョンのリソース長さを取得します。 |
| [getLength(int psdHeaderVersion)](#getLength-int-) | リソースの長さを取得します。 |
...
| [getRawData_internalized()](#getRawData-internalized--) | リソースの生データを取得または設定します。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | レイヤーレコードを保存します。 |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | レイヤーを取得または設定します。 |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | リソースの生データを取得または設定します。 |
...
新しいインスタンスを初期化します。[Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) クラス。
...
画像の PSD ヘッダー バージョンのリソース長さを取得します。
...
リソースの長さを取得します。PSD バージョンに依存する場合があります。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| psdHeaderVersion | int | PSD ヘッダー バージョン。 |
