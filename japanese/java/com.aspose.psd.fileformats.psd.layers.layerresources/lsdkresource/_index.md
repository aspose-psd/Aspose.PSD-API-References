...
description: "lsdk レイヤー リソースのネストされたレイヤー セクション リソース。"
type: docs
weight: 56
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | 新しい [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) クラスのインスタンスを初期化します。 |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | 新しい [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) クラスのインスタンスを初期化します。 |
## フィールド
...
新しい [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) クラスのインスタンスを初期化します。
