...
description: "レイヤー保護設定"
type: docs
weight: 57
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | 新しいインスタンスを初期化します。[LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) クラス。 |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | 新しいインスタンスを初期化します。[LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) クラス。 |
| [LspfResource()](#LspfResource--) | 新しいインスタンスを初期化します。[LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) クラス。 |
## フィールド
...
| [TypeToolKey](#TypeToolKey) | このタイプツール情報キー 1819504742 |
...
| [getLockType()](#getLockType--) | ロックのタイプを取得または設定します。 |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | このインスタンスが複合保護されているかどうかを示す値を取得または設定します。 |
| [isPositionProtected()](#isPositionProtected--) | このインスタンスが位置保護されているかどうかを示す値を取得または設定します。 |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | このインスタンスが透過保護されているかどうかを示す値を取得または設定します。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | このインスタンスが複合保護されているかどうかを示す値を取得または設定します。 |
...
| [setLockType(int value)](#setLockType-int-) | ロックのタイプを取得または設定します。 |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | このインスタンスが位置保護されているかどうかを示す値を取得または設定します。 |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | このインスタンスが透過保護されているかどうかを示す値を取得または設定します。 |
...
新しいインスタンスを初期化します。[LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) クラス。カスタムまたは不明な値を使用します。
...
新しいインスタンスを初期化します。[LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) クラス。
...
このインスタンスが複合保護されているかどうかを示す値を取得または設定します。

値: このインスタンスが複合保護されている場合は true、そうでない場合は false。
...
このインスタンスが位置保護されているかどうかを示す値を取得または設定します。

値: このインスタンスが位置保護されている場合は true、そうでない場合は false。
...
このインスタンスが透過保護されているかどうかを示す値を取得または設定します。

値: このインスタンスが透過保護されている場合は true、そうでない場合は false。
