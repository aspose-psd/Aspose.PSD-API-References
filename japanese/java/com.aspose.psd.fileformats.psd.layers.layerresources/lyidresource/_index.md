...
description: "クラス LyidResource."
type: docs
weight: 59
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | 新しいインスタンスを初期化します [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) クラス。 |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | 新しいインスタンスを初期化します [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) クラス。 |
## フィールド
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | 値を取得します。 |
...
新しいインスタンスを初期化します [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) クラス。
...
新しいインスタンスを初期化します [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) クラス。カスタムまたは不明な値で。
