...
description: "Ifxs リソース グループ レイヤー エフェクト リソース"
type: docs
weight: 37
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [IfxsResource()](#IfxsResource--) | 新しいインスタンスを初期化します。 [IfxsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource) クラス。 |
## フィールド
...
| [fillDefaultStructs_internalized(BaseFxResource fxResource, boolean isMultiStructure)](#fillDefaultStructs-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.BaseFxResource-boolean-) | デフォルト構造で構造を埋める |
| [findResourceForTest_internalized(int type)](#findResourceForTest-internalized-int-) | エフェクトエンティティを検索します。 |
| [generateDefaultResource_internalized()](#generateDefaultResource-internalized--) | デフォルトリソースを生成します。 |
| [getClass()](#getClass--) |  |
| [getDefaultListStructure_internalized(int multiType, int type, boolean isMultiStructure)](#getDefaultListStructure-internalized-int-int-boolean-) | デフォルトのエフェクト構造を持つ LayerMultiEffectsTypes に基づいて、[ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) の新しいインスタンスを作成します。 |
| [getDescriptorVersion()](#getDescriptorVersion--) | ディスクリプタのバージョンを取得します。 |
| [getHeader_internalized()](#getHeader-internalized--) | ヘッダーを取得または設定します。 |
| [getKey()](#getKey--) | レイヤーリソースキーを取得します。 |
| [getLayerStyle_internalized()](#getLayerStyle-internalized--) | レイヤースタイルを取得または設定します。 |
...
| [setLayerStyle_internalized(LayerStyleFX value)](#setLayerStyle-internalized-com.aspose.internal.fileformats.psd.layers.layereffects.LayerStyleFX-) | レイヤースタイルを取得または設定します。 |
| [toString()](#toString--) | このインスタンスを表す String を返します。 |
| [update_internalized()](#update-internalized--) | このインスタンスを更新します。 |
| [wait()](#wait--) |  |
...
新しいインスタンスを初期化します。 [IfxsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource) クラス。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fxResource | [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) | 任意のエフェクトリソース |
| isMultiStructure | boolean | マルチ構造クラスの使用フラグ |
...
**Returns:**
com.aspose.internal.fileformats.psd.layers.layereffects.effectentities.IEffectEntity - エフェクトエンティティを返します。
...
デフォルトのエフェクト構造を持つ LayerMultiEffectsTypes に基づいて、[ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) の新しいインスタンスを作成します。isMultiStructure が true の場合、構造はマルチになり、そうでない場合はシンプルになります。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| multiType | int | エフェクトのマルチタイプ。 |
| 型 | int | エフェクトのタイプ。 |
| isMultiStructure | boolean | マルチ構造クラスの使用フラグ |
...
このインスタンスを更新します。TODO: このメソッドを削除してください。更新は自動的に行われるべきです。
