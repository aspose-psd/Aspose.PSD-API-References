...
description: "この mlst リソース。"
type: docs
weight: 62
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
mlst リソースです。このクラスは、他のことも含めて、レイヤーのタイムライン上の位置に関する情報を含んでいます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [MlstResource()](#MlstResource--) | 新しい [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getItems()](#getItems--) | 構造体を取得または設定します。 |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 構造体を取得または設定します。 |
...
新しい [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) クラスのインスタンスを初期化します。
