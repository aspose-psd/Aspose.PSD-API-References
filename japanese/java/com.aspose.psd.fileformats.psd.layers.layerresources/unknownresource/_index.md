...
type: docs
weight: 82
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | 新しい [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) クラスのインスタンスを初期化します。 |
## フィールド
...
新しい [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) クラスのインスタンスを初期化します。
