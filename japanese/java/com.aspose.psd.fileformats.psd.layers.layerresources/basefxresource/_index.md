...
description: "基本エフェクトリソース"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | 新しいインスタンスを初期化します [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) クラス。 |
## フィールド
...
新しいインスタンスを初期化します [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) クラス。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| resourceKey | int | リソースキーです。 |
