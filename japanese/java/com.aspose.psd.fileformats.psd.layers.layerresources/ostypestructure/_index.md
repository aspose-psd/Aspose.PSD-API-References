...
description: "OS タイプ構造を表します。"
type: docs
weight: 64
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [OSTypeStructure(ClassID keyName)](#OSTypeStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスを初期化します [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) クラス。 |
## メソッド
...
新しいインスタンスを初期化します [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) クラス。
