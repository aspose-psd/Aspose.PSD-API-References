...
description: "クラス KnkoResource."
type: docs
weight: 41
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Class KnkoResource. このリソースはクリップされた要素のブレンドに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | 新しい [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) クラスのインスタンスを初期化します。 |
| [KnkoResource()](#KnkoResource--) | 新しい [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) クラスのインスタンスを初期化します。 |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | 新しい [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getKnockout()](#getKnockout--) | [blend interior elements] かどうかを示す値を取得または設定します。 |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | [blend interior elements] かどうかを示す値を取得または設定します。 |
...
新しい [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) クラスのインスタンスを初期化します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| knockout | boolean | true に設定された場合、[blend interior elements]。 |
...
新しい [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) クラスのインスタンスを初期化します。カスタムまたは不明な値を使用します。
