...
description: "クラス SoCoResource."
type: docs
weight: 75
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
クラス SoCoResource。 このリソースはカラー フィル レイヤーに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [SoCoResource()](#SoCoResource--) | 新しいインスタンスを初期化します。 [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource) クラス。 |
## フィールド
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | RGB カラーを取得します。 |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | RGB カラーを取得します。 |
...
新しいインスタンスを初期化します。 [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource) クラス。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | RGB カラー |
