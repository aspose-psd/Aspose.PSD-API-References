...
description: "レイヤーセクションリソース."
type: docs
weight: 43
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | 新しいインスタンスを初期化します [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) クラス。 |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | 新しいインスタンスを初期化します [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) クラス。 |
## フィールド
...
| [getSectionType()](#getSectionType--) | セクションタイプを取得または設定します。 |
| [getSignature()](#getSignature--) | レイヤーリソースのシグネチャを取得します。 |
| [getSubtype()](#getSubtype--) | サブタイプを取得または設定します。 |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | セクションタイプを取得または設定します。 |
| [setSubtype(int value)](#setSubtype-int-) | サブタイプを取得または設定します。 |
...
新しいインスタンスを初期化します [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) クラス。
