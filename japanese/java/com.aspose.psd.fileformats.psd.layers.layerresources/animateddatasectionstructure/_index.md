...
description: "アニメーションデータを含むセクションです。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| フィールド | 説明 |
| --- | --- |
| [StructureKey](#StructureKey) | AnDs の構造キーを識別します。 |
## メソッド
...
| [framesNumberIsOdd_internalized(System.Collections.Generic.IGenericEnumerable<OSTypeStructure> items)](#framesNumberIsOdd-internalized-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure--) | フレーム数が 'FrIn' リスト構造で奇数であることを確認します。 |
...
| [getItems()](#getItems--) | アニメーション データ セクション構造を取得または設定します。 |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ClassID を取得または設定します。 |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | 記述子バージョンを取得または設定します。 |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | アニメーション データ セクション構造を取得または設定します。 |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | フレーム数が奇数の場合に存在する不明なバイト 3 を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
フレーム数が 'FrIn' リスト構造で奇数であることを確認します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| アイテム | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
フレーム数が奇数の場合に存在する不明なバイト 3 を取得または設定します。
