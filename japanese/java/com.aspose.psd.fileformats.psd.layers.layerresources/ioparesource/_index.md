...
description: "クラス IopaResource."
type: docs
weight: 40
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
クラス IopaResource。このリソースはレイヤースタイルフォームからの塗りつぶし不透明度プロパティに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [IopaResource()](#IopaResource--) | クラス [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) の新しいインスタンスを初期化します。 |
| [IopaResource(byte[] data)](#IopaResource-byte---) | クラス [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) の新しいインスタンスを初期化します。 |
## フィールド
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | 塗りつぶしの不透明度を取得または設定します。 |
...
クラス [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) の新しいインスタンスを初期化します。
