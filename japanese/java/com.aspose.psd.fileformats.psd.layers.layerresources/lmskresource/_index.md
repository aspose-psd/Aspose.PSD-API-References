...
description: "LMsk リソース."
type: docs
weight: 50
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lmskresource/
---
...
このリソースにはカラー空間 ID が含まれており、特定のカラー空間タイプを参照し、4 つのカラーコンポーネントがあります。ID に応じて、カラーコンポーネントの意味は異なります。カラー空間タイプが 4 つの値を必要としない場合、余分なコンポーネントは未定義となり、常に 0 として書き込まれます。カラーコンポーネントはカラー空間タイプごとに次の通りです: RGB - 最初の 3 つのコンポーネントは赤、緑、青です。HSB - 最初の 3 つのコンポーネントは色相、彩度、明度です。CMYK- 4 つのコンポーネントはシアン、マゼンタ、イエロー、ブラックです。Lab - 最初の 3 つのコンポーネントは明度、a クロマ、b クロマです。グレースケール - 最初のコンポーネントは 0...10000 の範囲のグレー値です。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [LmskResource()](#LmskResource--) | 新しい [LmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lmskresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getClass()](#getClass--) |  |
| [getColorComponent1()](#getColorComponent1--) | カラーコンポーネント 1 を取得します。 |
| [getColorComponent2()](#getColorComponent2--) | カラーコンポーネント 2 を取得します。 |
| [getColorComponent3()](#getColorComponent3--) | カラーコンポーネント 3 を取得します。 |
| [getColorComponent4()](#getColorComponent4--) | カラーコンポーネント 4 を取得します。 |
| [getColorSpace()](#getColorSpace--) | カラー空間を取得します。 |
| [getFlag()](#getFlag--) | フラグを取得します。 |
...
| [getOpacity()](#getOpacity--) | 不透明度を取得します。 |
...
| [setColorComponent1(int value)](#setColorComponent1-int-) | カラーコンポーネント 1 を取得します。 |
| [setColorComponent2(int value)](#setColorComponent2-int-) | カラーコンポーネント 2 を取得します。 |
| [setColorComponent3(int value)](#setColorComponent3-int-) | カラーコンポーネント 3 を取得します。 |
| [setColorComponent4(int value)](#setColorComponent4-int-) | カラーコンポーネント 4 を取得します。 |
| [setColorSpace(int value)](#setColorSpace-int-) | カラー空間を取得します。 |
...
| [setOpacity(short value)](#setOpacity-short-) | 不透明度を取得します。 |
...
新しい [LmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lmskresource) クラスのインスタンスを初期化します。
