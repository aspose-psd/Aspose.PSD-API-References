...
description: "検出された可能性のある Lnsr リソースタイプ"
type: docs
weight: 52
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresourcetype/
---
...
検出された可能性のある Lnsr リソースタイプ
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Bgnd](#Bgnd) | 背景レイヤーの Bgnd |
| [Cont](#Cont) | 塗りレイヤー用の cont（例） |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Layr](#Layr) | 通常画像レイヤー用の layr |
| [Rend](#Rend) | テキスト用の rend |
| [Unknown](#Unknown) | Unknown は、列挙体が記述されていない状況を表します。 |
## メソッド
