...
description: "CustResource クラス。"
type: docs
weight: 27
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/custresource/
---
...
クラス CustResource。 このリソースはクリップされた要素のブレンドに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [CustResource()](#CustResource--) | 新しい [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) クラスのインスタンスを初期化します。 |
| [CustResource(byte[] data)](#CustResource-byte---) | 新しい [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | レイヤー作成日を取得または設定します。 |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | レイヤー作成日を取得または設定します。 |
...
新しい [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) クラスのインスタンスを初期化します。
