...
description: "クラス LevlResource."
type: docs
weight: 48
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/levlresource/
---
...
クラス LevlResource。 露出調整レイヤーのリソース。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [LevlResource(byte[] bytes)](#LevlResource-byte---) | 新しいインスタンスを初期化します [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) クラス。 |
| [LevlResource()](#LevlResource--) | 新しいインスタンスを初期化します [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) クラス。 |
## フィールド
...
| [getChannel(int channelIndex)](#getChannel-int-) | チャンネルを取得します。 |
| [getClass()](#getClass--) |  |
...
新しいインスタンスを初期化します [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) クラス。GrayScale、Duotone、RGB、CMYK、Lab カラーモードでサポートされます。2 バイト - バージョン (=2) 29 \\* 10 バイト - 5 個のショート整数からなるレベルレコードのセット 4 バイト - Lvls ヘッダー（インデックス 292 から開始） 2 バイト - バージョン (=3) 2 バイト - 総レベルレコード数 10 \\* (総数 - 29) Lvls リソースのゼロ終端は 4 バイトに合わせて折りたたむ必要があります。
...
新しいインスタンスを初期化します [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) クラス。
