...
description: "レイヤー名リソース"
type: docs
weight: 58
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LuniResource()](#LuniResource--) | 新しいインスタンスを初期化します [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) クラス。 |
## フィールド
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | データを取得または設定します。 |
...
新しいインスタンスを初期化します [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) クラス。
