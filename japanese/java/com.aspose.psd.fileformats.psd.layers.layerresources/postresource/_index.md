...
description: "クラス PostResource."
type: docs
weight: 71
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
クラス PostResource。ポスタライズ レイヤー設定。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [PostResource()](#PostResource--) | [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) クラスの新しいインスタンスを初期化します。 |
## フィールド
...
[PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) クラスの新しいインスタンスを初期化します。
