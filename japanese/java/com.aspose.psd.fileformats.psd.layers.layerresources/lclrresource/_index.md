...
description: "クラス LclrResource."
type: docs
weight: 46
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
クラス LclrResource。 このリソースは、PS のレイヤーリスト内のレイヤーの色に関する情報を含みます。 それだけです。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [LclrResource()](#LclrResource--) | 新しい [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) クラスのインスタンスを初期化します。 |
| [LclrResource(short color)](#LclrResource-short-) | 新しい [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) クラスのインスタンスを初期化します。 |
| [LclrResource(byte[] data)](#LclrResource-byte---) | 新しい [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | レイヤーの色を取得または設定します。 |
...
| [setColor(short value)](#setColor-short-) | レイヤーの色を取得または設定します。 |
...
新しい [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) クラスのインスタンスを初期化します。
