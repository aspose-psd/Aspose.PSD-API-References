...
description: "VibA リソース。"
type: docs
weight: 83
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [VibAResource()](#VibAResource--) | 新しい [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getSaturation()](#getSaturation--) | 彩度の値を取得または設定します |
| [getSignature()](#getSignature--) | レイヤーリソースのシグネチャを取得します。 |
| [getVibrance()](#getVibrance--) | ビブランスの値を取得または設定します |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | 彩度の値を取得または設定します |
| [setVibrance(int value)](#setVibrance-int-) | ビブランスの値を取得または設定します |
...
新しい [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource) クラスのインスタンスを初期化します。
