...
description: "ClblResource クラス。"
type: docs
weight: 20
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
クラス ClblResource。 このリソースはクリップされた要素のブレンドに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [ClblResource()](#ClblResource--) | 新しい [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) クラスのインスタンスを初期化します。 |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | 新しい [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) クラスのインスタンスを初期化します。 |
| [ClblResource(byte[] data)](#ClblResource-byte---) | 新しい [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getBlendClippedElements()](#getBlendClippedElements--) | ブレンドされたクリップ要素かどうかを示す値を取得または設定します。[blend clipped elements] |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | ブレンドされたクリップ要素かどうかを示す値を取得または設定します。[blend clipped elements] |
...
新しい [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) クラスのインスタンスを初期化します。
...
新しい [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) クラスのインスタンスを初期化します。カスタムまたは不明な値を使用します。
...
ブレンドされたクリップ要素かどうかを示す値を取得または設定します。[blend clipped elements]

値: true - [blend clipped elements] の場合; それ以外の場合は false。
