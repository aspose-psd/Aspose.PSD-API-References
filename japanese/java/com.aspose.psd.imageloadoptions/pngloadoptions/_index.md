...
description: "PNG のロードオプション。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.imageloadoptions/pngloadoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [PngLoadOptions()](#PngLoadOptions--) | PngLoadOptions クラスの新しいインスタンスを初期化します。 |
## フィールド
...
| [getStrictMode()](#getStrictMode--) | [strict mode] を示す値を取得または設定します。 |
...
| [setStrictMode(boolean value)](#setStrictMode-boolean-) | [strict mode] を示す値を取得または設定します。 |
...
PngLoadOptions クラスの新しいインスタンスを初期化します。
...
[strict mode] を示す値を取得または設定します。

**Returns:**
boolean - [strict mode] を示す値。
