...
description: "PSD 画像をロードする際に利用可能な読み取り専用モードを指定します。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.imageloadoptions/readonlymode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Default](#Default) | デフォルトモード。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MetadataEdit](#MetadataEdit) | 画像コンテンツを読み取り専用に保ちながら、画像メタデータの編集を許可します。 |
| [None](#None) | 読み取り専用の制限は適用されません。 |
## メソッド
...
デフォルトモード。画像は完全に読み取り専用で、変更できません。
...
画像コンテンツを読み取り専用に保ちながら、画像メタデータの編集を許可します。
...
読み取り専用の制限は適用されません。画像は完全に変更可能です。
