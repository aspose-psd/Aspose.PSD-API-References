...
description: "クラス構造体です。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | 新しい [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) クラスのインスタンスを初期化します。 |
## フィールド

| フィールド | 説明 |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | 構造キーを識別します。 |
| [StructureKeyGlbc](#StructureKeyGlbc) | 構造キーを識別します。 |
| [StructureKeyType](#StructureKeyType) | 構造キーを識別します。 |
## メソッド
...
新しい [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) クラスのインスタンスを初期化します。
