...
type: docs
weight: 25
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [ReferenceStructure(ClassID keyName)](#ReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスの [ReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure) クラスを初期化します。 |
## フィールド
...
### ReferenceStructure(ClassID keyName) {#ReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-}
```
public ReferenceStructure(ClassID keyName)
```


新しいインスタンスの [ReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure) クラスを初期化します。
