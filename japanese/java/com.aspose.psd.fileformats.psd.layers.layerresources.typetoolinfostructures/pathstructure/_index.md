...
type: docs
weight: 22
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [PathStructure(ClassID keyName)](#PathStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスの [PathStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure) クラスを初期化します。 |
## フィールド
...
| [getPrefix()](#getPrefix--) | パスプレフィックスを取得または設定します。 |
...
| [setPath(String value)](#setPath-java.lang.String-) | パスを取得または設定します。 |
...
| [setPrefix(String value)](#setPrefix-java.lang.String-) | パスプレフィックスを取得または設定します。 |
...
新しいインスタンスの [PathStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure) クラスを初期化します。
