...
description: "ブール構造体です。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [BooleanStructure(ClassID keyName)](#BooleanStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | [BooleanStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/booleanstructure) クラスの新しいインスタンスを初期化します。 |
## フィールド
...
| [getValue()](#getValue--) | boolean 値を取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(boolean value)](#setValue-boolean-) | boolean 値を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[BooleanStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/booleanstructure) クラスの新しいインスタンスを初期化します。
