...
type: docs
weight: 30
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | 新しいインスタンスの [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) クラスを初期化します。 |
## メソッド
...
| [getTypeName_internalized()](#getTypeName-internalized--) | 構造の読み取り可能な型名を取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setData(byte[] value)](#setData-byte---) | データを取得または設定します。 |
...
### UnknownStructure(ClassID keyName, int key) {#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-}
```
public UnknownStructure(ClassID keyName, int key)
```


新しいインスタンスの [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) クラスを初期化します。
...
### getTypeName_internalized() {#getTypeName-internalized--}
```
public final ClassID getTypeName_internalized()
```
