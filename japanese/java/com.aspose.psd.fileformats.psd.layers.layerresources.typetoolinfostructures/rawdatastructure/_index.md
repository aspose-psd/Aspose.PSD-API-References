...
description: "生データ構造です。"
type: docs
weight: 24
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [RawDataStructure(ClassID keyName)](#RawDataStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスを初期化します。[RawDataStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure) クラス。 |
## フィールド
...
### RawDataStructure(ClassID keyName) {#RawDataStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-}
```
public RawDataStructure(ClassID keyName)
```


新しいインスタンスを初期化します。[RawDataStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure) クラス。
