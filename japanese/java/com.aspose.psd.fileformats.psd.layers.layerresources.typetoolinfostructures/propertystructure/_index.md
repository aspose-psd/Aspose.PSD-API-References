...
description: "プロパティ構造です。"
type: docs
weight: 23
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID)](#PropertyStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しい [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure) クラスのインスタンスを初期化します。 |
## フィールド

| フィールド | 説明 |
| --- | --- |
| [StructureKey](#StructureKey) | 構造キーを識別します。 |
## メソッド
...
| [getKey()](#getKey--) | 構造キーを取得します。 |
| [getKeyID()](#getKeyID--) | キー ID を取得または設定します。 |
...
| [setKeyID(ClassID value)](#setKeyID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | キー ID を取得または設定します。 |
...
新しい [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure) クラスのインスタンスを初期化します。
...
| keyID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | キー ID。 |
