...
description: "リスト構造体です。"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [ListStructure(ClassID keyName)](#ListStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスを初期化します。[ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) クラス。 |
## フィールド
...
| [getItemsCount()](#getItemsCount--) | 項目数を取得します。 |
...
| [getTypes()](#getTypes--) | タイプを取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTypes(OSTypeStructure[] value)](#setTypes-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | タイプを取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しいインスタンスを初期化します。[ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) クラス。
