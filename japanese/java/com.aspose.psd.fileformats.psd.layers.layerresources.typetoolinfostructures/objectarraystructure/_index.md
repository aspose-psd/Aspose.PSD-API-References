...
description: "ObjectArrayStructure クラスは通常、配列を保持します。"
type: docs
weight: 20
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
ObjectArrayStructure クラスは通常、[UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 配列を保持します。PSD ファイルリソース（例：PlLd リソースや SoLd リソース）で使用されます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) クラスの新しいインスタンスを初期化します。 |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) クラスの新しいインスタンスを初期化します。 |
## フィールド

| フィールド | 説明 |
| --- | --- |
| [StructureKey](#StructureKey) | 'ObAr' 構造キーを識別します。 |
## メソッド
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | object array クラス ID を取得または設定します。 |
| [getClassName()](#getClassName--) | object array クラス名を取得または設定します。 |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | 構造のリストを取得します。 |
| [getKey()](#getKey--) | object array 構造キーを取得します。 |
...
| [getStructureCount()](#getStructureCount--) | object array サブ構造の数を取得します。 |
| [getStructures()](#getStructures--) | object array 構造内のサブ構造を取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | object array クラス ID を取得または設定します。 |
| [setClassName(String value)](#setClassName-java.lang.String-) | object array クラス名を取得または設定します。 |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | object array 構造内のサブ構造を取得または設定します。 |
...
[ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) クラスの新しいインスタンスを初期化します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| キー名 | java.lang.String | キーの名前。 |
| classIdName | java.lang.String | クラス識別子の名前。 |
...
| --- | --- | --- |
| キー | int | 整数キー。 |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | キー名。 |
...
object array クラス ID を取得または設定します。

値: object array クラス ID。
...
object array サブ構造の数を取得します。

値: オブジェクト配列構造内のサブ構造のカウントです。
...
object array 構造内のサブ構造を取得または設定します。

値: オブジェクト配列構造内のサブ構造です。
