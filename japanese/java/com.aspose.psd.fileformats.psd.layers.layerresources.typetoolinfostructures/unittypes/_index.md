...
type: docs
weight: 29
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes/
---
...
| --- | --- |
| [Angle](#Angle) | 角度単位。 |
| [Density](#Density) | 密度単位。 |
| [Distance](#Distance) | 距離単位。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Millimeters](#Millimeters) | ミリメートル単位。 |
| [None](#None) | 未定義単位。 |
| [Percent](#Percent) | パーセント単位。 |
| [Pixels](#Pixels) | ピクセル単位。 |
| [Points](#Points) | ポイント単位。 |
## メソッド
