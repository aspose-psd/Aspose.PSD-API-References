...
type: docs
weight: 17
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [IntegerStructure(ClassID keyName)](#IntegerStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しい [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure) クラスのインスタンスを初期化します。 |
## フィールド

| フィールド | 説明 |
| --- | --- |
| [StructureKey](#StructureKey) | 整数構造キーです。 |
## メソッド
...
新しい [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure) クラスのインスタンスを初期化します。
