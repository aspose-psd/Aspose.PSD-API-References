...
type: docs
weight: 26
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [StringStructure(ClassID keyName)](#StringStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しい [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure) クラスのインスタンスを初期化します。 |
## フィールド
...
| [setValue(String value)](#setValue-java.lang.String-) | 値を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しい [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure) クラスのインスタンスを初期化します。
