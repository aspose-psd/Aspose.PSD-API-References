...
description: "列挙参照構造体です。"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスを初期化します。[EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) クラス。 |
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | 構造キーを識別します。 |
| [StructureKey](#StructureKey) | 列挙ディスクリプタキー。 |
## メソッド
...
| [getEnumName()](#getEnumName--) | enum 名を取得または設定します。 |
...
| [getKey()](#getKey--) | キーを取得します。 |
| [getKeyName()](#getKeyName--) | キー名を取得または設定します。 |
| [getLength()](#getLength--) | バイト単位で [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) の長さを取得します。 |
...
| [getTypeID()](#getTypeID--) | type ID を取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | enum 名を取得または設定します。 |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | type ID を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しいインスタンスを初期化します。[EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) クラス。
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | type ID。 |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | enum 名。 |
...
バイト単位で [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) の長さを取得します。
