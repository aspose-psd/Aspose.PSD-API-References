...
description: "エイリアス構造体です。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しい [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getDataLength()](#getDataLength--) | バイト単位の正確なデータ長さを取得します。 |
| [getFullPath()](#getFullPath--) | 完全パスを取得または設定します。 |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | 完全パスを取得または設定します。 |
...
新しい [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) クラスのインスタンスを初期化します。
