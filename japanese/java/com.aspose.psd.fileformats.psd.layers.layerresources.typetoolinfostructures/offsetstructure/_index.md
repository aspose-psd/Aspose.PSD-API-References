...
description: "オフセット構造です。"
type: docs
weight: 21
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しいインスタンスを初期化します。[OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) クラス。 |
## フィールド
...
| [getValue()](#getValue--) | 整数値を取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | 整数値を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しいインスタンスを初期化します。[OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) クラス。
