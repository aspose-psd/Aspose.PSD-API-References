...
type: docs
weight: 28
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| Constructor | 説明 |
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 新しい [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getUnitType()](#getUnitType--) | 単位タイプを取得または設定します。 |
...
| [setUnitType(int value)](#setUnitType-int-) | 単位タイプを取得または設定します。 |
| [setValue(double value)](#setValue-double-) | 値を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しい [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) クラスのインスタンスを初期化します。
