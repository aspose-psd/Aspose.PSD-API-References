...
description: "アートボード情報データです。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [AbddResource()](#AbddResource--) | 新しいインスタンスを初期化します [AbddResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource) クラス。 |
## フィールド
...
新しいインスタンスを初期化します [AbddResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource) クラス。
