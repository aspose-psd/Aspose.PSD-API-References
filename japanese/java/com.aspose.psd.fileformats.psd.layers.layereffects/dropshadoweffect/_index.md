...
description: "ドロップシャドウレイヤーエフェクト"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layereffects/dropshadoweffect/
---
...
| [getKnocksOut()](#getKnocksOut--) | [knocks out] かどうかを示す値を取得または設定します。 |
...
| [setKnocksOut(boolean value)](#setKnocksOut-boolean-) | [knocks out] かどうかを示す値を取得または設定します。 |
