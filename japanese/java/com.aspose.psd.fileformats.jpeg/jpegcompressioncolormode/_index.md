...
description: "u0421olor JPEG 画像のモード。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.jpeg/jpegcompressioncolormode/
---
...
| フィールド | 説明 |
| --- | --- |
| [Cmyk](#Cmyk) | 4 コンポーネント CMYK 画像。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | グレースケール画像。 |
| [Rgb](#Rgb) | RGB カラーモード。 |
| [YCbCr](#YCbCr) | YCbCr 画像、jpeg 画像の標準オプション。 |
| [Ycck](#Ycck) | ycck カラー jpeg 画像。 |
## メソッド
...
ycck カラー jpeg 画像。保存には icc プロファイルが必要です。
