...
description: "n ビット値が 8 ビット値に変換される方法を定義します。"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.fileformats.jpeg/sampleroundingmode/
---
...
n ビット値が 8 ビット値に変換される方法を定義します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extrapolate](#Extrapolate) | 8ビットの値を n ビットに合わせて外挿します（1 < n < 8）。 |
| [Truncate](#Truncate) | 8ビットの値を n ビットに合わせて切り捨てます（1 < n < 8）。 |
## メソッド
...
8ビットの値を n ビットに合わせて外挿します（1 < n < 8）。すべての可能な 8 ビット値の数は 1 << 8 = 256 で、0 から 255 です。すべての可能な n ビット値の数は 1 << n で、0 から (1 << n) - 1 です。ある 8 ビット値 V8 に対応する最も妥当な n ビット値 Vn は Vn = V8 >> (8 - n) と等しくなります。
...
8ビットの値を n ビットに合わせて切り捨てます（1 < n < 8）。すべての可能な n ビット値の数は 1 << n で、0 から (1 << n) - 1 です。ある 8 ビット値 V8 に対応する最も妥当な n ビット値 Vn は Vn = V8 & ((1 << n) - 1) と等しくなります。
