...
description: "マルチコンポーネントカラー画素データのインタリーブモードを定義します。"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.fileformats.jpeg/jpeglsinterleavemode/
---
...
マルチコンポーネント（カラー）ピクセルデータのインタリーブモードを定義します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Line](#Line) | インタリーブモードは行単位です。 |
| [None](#None) | データはコンポーネントごとにエンコードされ、RRRGGGBBB として格納されます。 |
| [Sample](#Sample) | データはサンプル単位でエンコードされ、格納されます。 |
## メソッド
...
インタリーブモードは行単位です。次の行に移る前に、各コンポーネントの全行がエンコードされます。
...
データはコンポーネントごとにエンコードされ、RRRGGGBBB として格納されます。
...
データはサンプル単位でエンコードされ、格納されます。カラー画像の場合、これは RGBRGBRGB のような形式です。
