...
description: "XmpArray の配列型を表します。"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.xmp/xmparraytype/
---
...
| フィールド | 説明 |
| --- | --- |
| [ALTERNATIVE](#ALTERNATIVE) | 代替配列です。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ORDERED](#ORDERED) | 順序付き配列です。 |
| [UNORDERED](#UNORDERED) | 順序なし配列です。 |
## メソッド
