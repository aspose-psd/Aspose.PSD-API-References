...
description: "この畳み込みフィルタ。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.imagefilters.filteroptions/convolutionfilteroptions/
---
...
| [getBias()](#getBias--) | バイアスを取得または設定します。 |
| [getClass()](#getClass--) |  |
| [getFactor()](#getFactor--) | 係数を取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBias(int value)](#setBias-int-) | バイアスを取得または設定します。 |
| [setFactor(double value)](#setFactor-double-) | 係数を取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
