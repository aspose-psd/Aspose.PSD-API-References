...
description: "Gauss Wiener Filter Options デブラー ガウス"
type: docs
weight: 15
url: /ja/java/com.aspose.psd.imagefilters.filteroptions/gausswienerfilteroptions/
---
...
Gauss Wiener Filter Options デブラー ガウス
## Constructors

| Constructor | 説明 |
| --- | --- |
| [GaussWienerFilterOptions(int radius, double smooth)](#GaussWienerFilterOptions-int-double-) | GaussWienerFilterOptions クラスの新しいインスタンスを初期化します。 |
| [GaussWienerFilterOptions()](#GaussWienerFilterOptions--) | GaussWienerFilterOptions クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getRadius()](#getRadius--) | 半径を取得または設定します。 |
...
| [setRadius(int value)](#setRadius-int-) | 半径を取得または設定します。 |
...
GaussWienerFilterOptions クラスの新しいインスタンスを初期化します。デフォルト設定を使用します。
