...
description: "選択的カラー調整レイヤーの補正方法です。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/correctionmethodtypes/
---
...
| フィールド | 説明 |
| --- | --- |
| [Absolute](#Absolute) | 絶対モードで色補正を適用します。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | 相対モードで色補正を適用します。 |
## メソッド
