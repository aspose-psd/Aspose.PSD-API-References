...
description: "グラデーションタイプ"
type: docs
weight: 17
url: /ja/java/com.aspose.psd.fileformats.psd.layers.fillsettings/gradienttype/
---
...
| フィールド | 説明 |
| --- | --- |
| [Angle](#Angle) | 角度グラデーションのタイプ |
| [Diamond](#Diamond) | ダイヤモンドグラデーションのタイプ |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 線形グラデーションのタイプ |
| [Radial](#Radial) | 放射状グラデーションのタイプ |
| [Reflected](#Reflected) | 反射グラデーションのタイプ |
| [ShapeBurst](#ShapeBurst) | 形状バーストグラデーションのタイプ |
## メソッド
