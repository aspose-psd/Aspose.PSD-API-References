...
description: "Photoshop のグラデーション補間方法のためのパックされた fourCC 値。"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Photoshop グラデーション補間方法のためのパックされた fourCC 値。ディスクリプタキー: "gradientsInterpolationMethod"
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 クラシック（キーが存在しない場合のレガシーデフォルト）。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 リニア（末尾のスペースに注意）。 |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 知覚的。 |
| [Smooth](#Smooth) | 'Smoo' \\u2014 スムーズ。 |
| [Stripes](#Stripes) | 'GIMs' \\u2014 ストライプ。 |
## メソッド
...
'Gcls' \\u2014 クラシック（キーが存在しない場合のレガシーデフォルト）。
