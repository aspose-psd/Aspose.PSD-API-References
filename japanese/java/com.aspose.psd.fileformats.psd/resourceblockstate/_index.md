...
description: "リソースブロックの状態を表します。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd/resourceblock.resourceblockstate/
---
...
| フィールド | 説明 |
| --- | --- |
| [Cached](#Cached) | キャッシュされた状態です。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Normal](#Normal) | 標準的な状態です。 |
## メソッド
