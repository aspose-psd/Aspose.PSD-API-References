...
description: "psd ファイル形式のカラーモードを表します。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd/colormodes/
---
...
psd ファイル形式のカラーモードを表します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Bitmap](#Bitmap) | ビットマップのカラーモードです。 |
| [Cmyk](#Cmyk) | CMYK カラーモード。 |
| [Duotone](#Duotone) | デュオトーン カラーモードです。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | グレースケールモードです。 |
| [Indexed](#Indexed) | インデックスカラー モードです。 |
| [Lab](#Lab) | Lab カラーモードです。 |
| [Multichannel](#Multichannel) | マルチチャンネル カラーモードです。 |
| [Rgb](#Rgb) | RGB カラーモード。 |
## メソッド
