...
description: "Photoshop のリーディングモード（行間の距離）"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.psd/leadingmode/
---
...
Photoshop のリーディングモード（行間の距離）
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Auto](#Auto) | 自動リーディングモード |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | 手動リーディングモード |
## メソッド
