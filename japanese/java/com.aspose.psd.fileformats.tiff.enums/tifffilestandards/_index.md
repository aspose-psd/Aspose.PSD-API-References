...
description: "TIFF ファイル形式の標準を指定します。"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
| フィールド | 説明 |
| --- | --- |
| [Baseline](#Baseline) | ベースライン TIFF 6.0 ファイル標準。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extended](#Extended) | 拡張 TIFF 6.0 ファイル標準。 |
## メソッド
...
ベースライン TIFF 6.0 ファイル標準。この標準は正式に TIFF 6.0、パート 1: ベースライン TIFF と呼ばれます。
...
拡張 TIFF 6.0 ファイル標準。この標準は正式に拡張 TIFF 6.0、パート 2: TIFF 拡張 と呼ばれます。
