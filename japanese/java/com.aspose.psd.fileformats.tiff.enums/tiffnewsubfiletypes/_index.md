...
description: "tiff の新しいサブファイルタイプ列挙体。"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffnewsubfiletypes/
---
...
tiff の新しいサブファイルタイプ列挙体。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FileTypeDefault](#FileTypeDefault) | デフォルトのファイルタイプ。 |
| [FileTypeLast](#FileTypeLast) | 最後のファイルタイプ。 |
| [FileTypeMask](#FileTypeMask) | マスクファイルタイプ。 |
| [FileTypePage](#FileTypePage) | ページのファイルタイプ。 |
| [FileTypeReducedImage](#FileTypeReducedImage) | 縮小画像のファイルタイプ。 |
## メソッド
