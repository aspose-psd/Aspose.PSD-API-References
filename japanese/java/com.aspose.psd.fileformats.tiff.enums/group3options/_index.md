...
description: "CCITT Group 3/4 ファックスエンコーディングのオプション。GROUP3OPTIONS / TiffTag.T4OPTIONS および TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS タグの可能な値。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
CCITT Group 3/4 ファックスエンコーディングのオプション。

GROUP3OPTIONS / TiffTag.T4OPTIONS および TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS タグの可能な値。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Encoding1D](#Encoding1D) | 1 次元符号化。 |
| [Encoding2D](#Encoding2D) | 2 次元符号化。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | バイト境界まで埋める。 |
| [Uncompressed](#Uncompressed) | データは圧縮されていません。 |
## メソッド
