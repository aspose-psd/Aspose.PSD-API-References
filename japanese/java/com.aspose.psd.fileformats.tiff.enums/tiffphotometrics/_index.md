...
description: "フォトメトリック補間列挙体"
type: docs
weight: 20
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffphotometrics/
---
...
| [Mask](#Mask) | [TIFF rev. によって廃止 |
| [MinIsBlack](#MinIsBlack) | 最小値は黒です。 |
| [MinIsWhite](#MinIsWhite) | 最小値は白です。 |
| [Palette](#Palette) | カラーマップはインデックス化されています。 |
| [Rgb](#Rgb) | RGB カラーモデル。 |
| [Separated](#Separated) | カラー分離。 |
...
ICC L\*a\*b\*。Adobe TIFF Technote 4 によって TIFF rev 6.0 以降に導入されました。
