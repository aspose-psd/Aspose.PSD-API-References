...
description: "tiff ドキュメントのアルファストレージを指定します。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffalphastorage/
---
...
tiff ドキュメントのアルファストレージを指定します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Associated](#Associated) | アルファ値は事前乗算形式で保存されます。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Unassociated](#Unassociated) | アルファ値は非結合形式で保存されます。 |
| [Unspecified](#Unspecified) | アルファは指定されておらず、tiff ファイルに保存されます。 |
## メソッド
...
アルファ値は事前乗算形式で保存されます。アルファを復元すると、丸め誤差が生じる可能性があり、復元された値が元の値と異なる場合があります。
...
アルファ値は非結合形式で保存されます。これは、復元されたアルファが tiff に保存されたものと完全に同じであることを意味します。
...
アルファは指定されておらず、tiff ファイルに保存されます。
