...
description: "tiff 画像のバイトオーダー"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
| フィールド | 説明 |
| --- | --- |
| [BigEndian](#BigEndian) | ビッグエンディアンのバイト順序（Motorola）。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | リトルエンディアンのバイト順序（Intel）。 |
## メソッド
