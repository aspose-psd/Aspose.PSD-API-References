...
description: "画像の向き。ORIENTATION タグの可能な値。"
type: docs
weight: 19
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tifforientations/
---
...
| フィールド | 説明 |
| --- | --- |
| [BottomLeft](#BottomLeft) | 行 0 が下、列 0 が左側。 |
| [BottomRight](#BottomRight) | 行 0 が下、列 0 が右側。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LeftBottom](#LeftBottom) | 行 0 が左側、列 0 が下。 |
| [LeftTop](#LeftTop) | 行 0 が左側、列 0 が上。 |
| [RightBottom](#RightBottom) | 行 0 が右側、列 0 が下。 |
| [RightTop](#RightTop) | 行 0 が右側、列 0 が上。 |
| [TopLeft](#TopLeft) | 行 0 が上、列 0 が左側。 |
| [TopRight](#TopRight) | 行 0 が上、列 0 が右側。 |
## メソッド
