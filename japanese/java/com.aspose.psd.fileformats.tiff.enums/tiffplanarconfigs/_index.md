...
description: "ストレージの構成。PLANARCONFIG タグの可能な値。"
type: docs
weight: 21
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffplanarconfigs/
---
...
PLANARCONFIG タグの可能な値です。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Contiguous](#Contiguous) | 単一画像平面です。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Separate](#Separate) | データの個別平面です。 |
## メソッド
