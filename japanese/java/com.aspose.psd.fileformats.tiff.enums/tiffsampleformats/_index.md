...
description: "サンプル形式列挙体"
type: docs
weight: 24
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffsampleformats/
---
...
| フィールド | 説明 |
| --- | --- |
| [ComplexIeeeFp](#ComplexIeeeFp) | 複素 ieee 浮動小数点 |
| [ComplexInt](#ComplexInt) | 複素 符号付き int |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IeeeFp](#IeeeFp) | IEEE 浮動小数点データ |
| [Int](#Int) | 符号付き整数データ |
| [Uint](#Uint) | 符号なし整数データ |
| [Void](#Void) | 型なしデータ |
## メソッド
