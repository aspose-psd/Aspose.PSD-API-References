...
description: "tiff データ型列挙型。"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.fileformats.tiff.enums/tiffdatatypes/
---
...
| フィールド | 説明 |
| --- | --- |
| [Ascii](#Ascii) | 8ビットバイト（最後のバイトは null）。 |
| [Byte](#Byte) | 8ビット符号なし整数。 |
| [Double](#Double) | 64ビット IEEE 浮動小数点。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Float](#Float) | 32ビット IEEE 浮動小数点。 |
| [Ifd](#Ifd) | Exif 画像ファイルディレクトリ（IFD）へのポインタ。 |
| [Long](#Long) | 32ビット符号なし整数。 |
| [Rational](#Rational) | 64ビット符号なし分数。 |
| [Sbyte](#Sbyte) | 8ビット符号付き整数。 |
| [Short](#Short) | 16ビット符号なし整数。 |
| [Slong](#Slong) | 32ビット符号付き整数。 |
| [Srational](#Srational) | 64ビット符号付き分数。 |
| [Sshort](#Sshort) | 16ビット符号付き整数。 |
| [Undefined](#Undefined) | 8ビット型なしデータ。 |
## メソッド
