...
description: "XmpDynamicMediaPackage のプロジェクトタイプを表します。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.xmp.schemas.xmpdm/projecttype/
---
...
XmpDynamicMediaPackage のプロジェクトタイプを表します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Audio](#Audio) | オーディオ プロジェクト タイプ |
| [Custom](#Custom) | カスタム プロジェクト タイプ |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Movie](#Movie) | ムービー プロジェクト タイプ |
| [Still](#Still) | スチル プロジェクト タイプ |
## メソッド
