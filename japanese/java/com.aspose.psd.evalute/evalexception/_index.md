...
description: "評価エラー用のカスタム例外です。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.evalute/evalexception/
---
...
| Constructor | 説明 |
| --- | --- |
| [EvalException(String message, int position)](#EvalException-java.lang.String-int-) | EvalException クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getCause()](#getCause--) |  |
| [getClass()](#getClass--) |  |
| [getColumn_internalized()](#getColumn-internalized--) | 列を取得または設定します。 |
| [getInnerException()](#getInnerException--) |  |
| [getLocalizedMessage()](#getLocalizedMessage--) |  |
| [getMessage()](#getMessage--) | この例外に関連付けられたメッセージを取得します |
...
| [setColumn_internalized(int value)](#setColumn-internalized-int-) | 列を取得または設定します。 |
...
EvalException クラスの新しいインスタンスを初期化します。
