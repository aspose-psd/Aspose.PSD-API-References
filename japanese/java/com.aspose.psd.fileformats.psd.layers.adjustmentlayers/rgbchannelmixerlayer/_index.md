...
description: "Rgb チャンネルミキサー調整レイヤー。"
type: docs
weight: 26
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| [getBlueChannel()](#getBlueChannel--) | 青チャンネルを取得します。 |
...
| [getGreenChannel()](#getGreenChannel--) | 緑チャンネルを取得します。 |
...
| [getRedChannel()](#getRedChannel--) | 赤チャンネルを取得します。 |
