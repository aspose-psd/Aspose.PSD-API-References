...
description: "PhotoFilter 調整レイヤー。"
type: docs
weight: 24
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [getColor()](#getColor--) | フィルターの RGB カラーを取得または設定します。 |
...
| [getDensity()](#getDensity--) | フィルターの密度を取得または設定します。 |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | フィルターの RGB カラーを取得または設定します。 |
...
| [setDensity(int value)](#setDensity-int-) | フィルターの密度を取得または設定します。 |
