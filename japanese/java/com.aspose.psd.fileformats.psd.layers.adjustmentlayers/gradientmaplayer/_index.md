...
description: "グラデーションマップレイヤー。"
type: docs
weight: 19
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
グラデーションマップレイヤー。GrdmResource のデータを使用してグラデーションマップのレンダリングを処理します。
## フィールド
...
| [getGradientSettings()](#getGradientSettings--) | GrdmResource インスタンスから渡された Gradient 設定インスタンスを取得または設定します。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | グラデーションマップレイヤーを処理します。 |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | GrdmResource インスタンスから渡された Gradient 設定インスタンスを取得または設定します。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 関連レイヤーリソース [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource) のレイヤーデータを更新します。 |
...
関連レイヤーリソース [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource) のレイヤーデータを更新します。
