...
description: "Vibrance 調整レイヤーの実装"
type: docs
weight: 30
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
| [getVibrance()](#getVibrance--) | 鮮やかさを取得または設定します。 |
...
| [setVibrance(int value)](#setVibrance-int-) | 鮮やかさを取得または設定します。 |
...
**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - 調整レイヤー
