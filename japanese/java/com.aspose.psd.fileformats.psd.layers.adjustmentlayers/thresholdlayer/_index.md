...
description: "Threshold 調整レイヤー。"
type: docs
weight: 29
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/thresholdlayer/
---
...
| [getLevel()](#getLevel--) | しきい値レベルを取得および設定します。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | しきい値レイヤーを処理します。 |
...
| [setLevel(short value)](#setLevel-short-) | しきい値レベルを取得および設定します。 |
