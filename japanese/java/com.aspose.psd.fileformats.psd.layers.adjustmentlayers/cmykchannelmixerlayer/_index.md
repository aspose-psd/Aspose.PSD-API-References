...
description: "Cmyk チャンネルミキサー調整レイヤー。"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| [getBlackChannel()](#getBlackChannel--) | 黒チャンネルを取得します。 |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | チャンネルのインデックスを取得します。 |
...
| [getCyanChannel()](#getCyanChannel--) | シアンチャンネルを取得します。 |
...
| [getMagentaChannel()](#getMagentaChannel--) | マゼンタチャンネルを取得します。 |
...
| [getMonochrome()](#getMonochrome--) | この [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) がモノクロかどうかを示す値を取得または設定します。 |
...
| [getYellowChannel()](#getYellowChannel--) | イエローチャンネルを取得します。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 調整レイヤーを処理します。 |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | この [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) がモノクロかどうかを示す値を取得または設定します。 |
...
この [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) がモノクロかどうかを示す値を取得または設定します。

値: モノクロの場合は true、そうでなければ false。
