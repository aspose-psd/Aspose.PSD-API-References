...
description: "Curves 調整レイヤー"
type: docs
weight: 17
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | カーブマネージャーを取得します。 |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | このインスタンスが連続マネージャーとして使用されているかどうかを示す値を取得または設定します。 |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | このインスタンスが離散マネージャーとして使用されているかどうかを示す値を取得または設定します。 |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | このインスタンスが連続マネージャーとして使用されているかどうかを示す値を取得または設定します。 |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | このインスタンスが離散マネージャーとして使用されているかどうかを示す値を取得または設定します。 |
...
値: このインスタンスが連続マネージャーとして使用されている場合は true、そうでない場合は false。
...
値: このインスタンスが離散マネージャーとして使用されている場合は true、そうでない場合は false。
