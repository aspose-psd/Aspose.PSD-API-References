...
description: "明るさ/コントラストレイヤー。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
brightness を取得または設定します。PS の brightness の範囲は -150 から +150 ですが、これは無視します。
...
contrast を取得または設定します。PS の contrast の範囲は -50 から +100 ですが、これは無視します。
