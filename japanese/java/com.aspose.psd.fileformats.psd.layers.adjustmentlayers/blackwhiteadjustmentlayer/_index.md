...
description: "Black and White 調整レイヤークラス。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| [getTintColor()](#getTintColor--) | ティントカラーの値を取得または設定します。 |
| [getTintColorBlue()](#getTintColorBlue--) | 青のティントカラーの倍精度値を取得または設定します。 |
| [getTintColorGreen()](#getTintColorGreen--) | 緑のティントカラーの倍精度値を取得または設定します。 |
| [getTintColorRed()](#getTintColorRed--) | 赤のティントカラーの倍精度値を取得または設定します。 |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | ピクセルを処理します。 |
...
| [setTintColor(int value)](#setTintColor-int-) | ティントカラーの値を取得または設定します。 |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | 青のティントカラーの倍精度値を取得または設定します。 |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | 緑のティントカラーの倍精度値を取得または設定します。 |
| [setTintColorRed(double value)](#setTintColorRed-double-) | 赤のティントカラーの倍精度値を取得または設定します。 |
