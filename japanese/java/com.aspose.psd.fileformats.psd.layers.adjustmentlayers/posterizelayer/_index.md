...
description: "ポスタライズレイヤー。"
type: docs
weight: 25
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Posterize レイヤー。PostResource のデータを使用して Posterize のレンダリングを処理します。
## フィールド
...
| [getLevels()](#getLevels--) | Posterize レイヤーのレベルです。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Posterize レイヤーを処理します。 |
...
| [setLevels(short value)](#setLevels-short-) | Posterize レイヤーのレベルです。 |
