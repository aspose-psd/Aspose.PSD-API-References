...
description: "color balance 調整レイヤークラス。"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | シャドウの YellowBlue バランスを取得または設定します。 |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | 指定された int RGB 配列に対して、現在のシャドウ、ミッドトーン、ハイライトの補正を適用します。 |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | シャドウの YellowBlue バランスを取得または設定します。 |
...
シャドウの YellowBlue バランスを取得または設定します。
...
指定された int RGB 配列に対して、現在のシャドウ、ミッドトーン、ハイライトの補正を適用します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| ピクセル | int[] | int カラー RGB 配列です。 |
