...
description: "Levels 調整レイヤー"
type: docs
weight: 22
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| [getChannel(int index)](#getChannel-int-) | チャンネルを取得します。 |
...
| [getMasterChannel()](#getMasterChannel--) | マスターチャンネルを取得します。 |
...
| ピクセル | int[] | ピクセル。 |
| start | [Point](../../com.aspose.psd/point) | 開始。 |
| end | [Point](../../com.aspose.psd/point) | 終了。 |
