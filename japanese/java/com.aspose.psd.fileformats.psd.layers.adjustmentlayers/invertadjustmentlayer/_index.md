...
description: "invert 調整レイヤークラス。"
type: docs
weight: 21
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | invert adjustment layer を処理します。 |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | 指定された int ARGB 配列に invert 補正を適用します。 |
...
invert adjustment layer を処理します。
...
指定された int ARGB 配列に invert 補正を適用します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| ピクセル | int[] | int ARGB 配列です。 |
