...
description: "Selective Color 調整レイヤー。"
type: docs
weight: 28
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | 調整レイヤーのタイプを取得します。 |
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | 選択的カラーによる cmyk 補正を取得します。 |
| [getContainer()](#getContainer--) | Image コンテナを取得します。 |
| [getCorrectionMethod()](#getCorrectionMethod--) | 補正方法を取得または設定します。 |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | プロセッサを取得します。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 選択カラー レイヤーを処理します。 |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | データをマージします。 |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | 選択的カラーによる cmyk 補正を設定します。 |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Image コンテナを設定します。 |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | 補正方法を取得または設定します。 |
...
選択的カラーによる cmyk 補正を取得します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| selectiveColorsType | int | 選択的カラー。 |
...
| ピクセル | int[] | ピクセルの配列です。 |
| start | [Point](../../com.aspose.psd/point) | ピクセルの左上位置。 |
| end | [Point](../../com.aspose.psd/point) | ピクセルの右下位置。 |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - ピクセルの矩形と処理されたピクセルです。
...
選択的カラーによる cmyk 補正を設定します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| selectiveColorsType | int | 選択的カラーのタイプ。 |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Cmyk 補正。 |
