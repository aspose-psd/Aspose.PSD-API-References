...
description: "Exposure 調整レイヤー。"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | Exposure を取得または設定します。 |
...
| [getGammaCorrection()](#getGammaCorrection--) | GammaCorrection を取得または設定します。 |
...
| [getOffset()](#getOffset--) | Offset を取得または設定します。 |
...
| [setExposure(float value)](#setExposure-float-) | Exposure を取得または設定します。 |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | GammaCorrection を取得または設定します。 |
...
| [setOffset(float value)](#setOffset-float-) | Offset を取得または設定します。 |
...
Exposure を取得または設定します。PS の Exposure の範囲は -20 から +20 です。
...
GammaCorrection を取得または設定します。PS の GammaCorrection の範囲は 9.99 から +0.01 です。
...
Offset を取得または設定します。PS の Offset の範囲は -0.5 から +0.5 です。
