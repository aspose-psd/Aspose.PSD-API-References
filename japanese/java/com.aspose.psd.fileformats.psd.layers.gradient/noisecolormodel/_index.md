...
description: "グラデーションタイプがノイズの場合、カラー モデルを RGB/SHB/LAB 3/4/6 に割り当てることができます"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.fileformats.psd.layers.gradient/noisecolormodel/
---
...
カラー モデル: 'Gradient type' が 'Noise' の場合、'Color Model' を RGB/SHB/LAB (3/4/6) に割り当てることができます。
## フィールド
