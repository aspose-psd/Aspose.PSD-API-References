...
description: "レンダリング対象のエンティティのタイプを表します"
type: docs
weight: 28
url: /ja/java/com.aspose.psd.imageoptions/typeofentities/
---
...
レンダリング対象のエンティティのタイプを表します
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Entities2D](#Entities2D) | 2D エンティティをレンダリング |
| [Entities3D](#Entities3D) | 3D エンティティをレンダリング |
