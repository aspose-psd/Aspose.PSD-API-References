...
description: "TIFF オプションのエラーコードです。"
type: docs
weight: 26
url: /ja/java/com.aspose.psd.imageoptions/tiffoptionserror/
---
...
| フィールド | 説明 |
| --- | --- |
| [Baseline6OptionsMismatch](#Baseline6OptionsMismatch) | 指定された TIFF オプションパラメータは TIFF Baseline 6.0 標準に準拠していません。 |
| [ColorMapLengthInvalid](#ColorMapLengthInvalid) | カラーマップの長さが無効です。 |
| [CompressionSppMismatch](#CompressionSppMismatch) | 圧縮がピクセルあたりのサンプル数と一致しません。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NoColorMap](#NoColorMap) | カラーマップが定義されていません。 |
| [NoError](#NoError) | エラーコードがありません。 |
| [NotSupportedAlphaStorage](#NotSupportedAlphaStorage) | アルファストレージはサポートされていません。 |
| [PhotometricBitsPerSampleMismatch](#PhotometricBitsPerSampleMismatch) | フォトメトリックのサンプルあたりビット数が無効です |
| [PhotometricCompressionMismatch](#PhotometricCompressionMismatch) | 圧縮がフォトメトリック設定と一致しません。 |
| [PhotometricSppMismatch](#PhotometricSppMismatch) | フォトメトリックがピクセルあたりのサンプル数と一致しません。 |
## メソッド
...
指定された TIFF オプションパラメータは TIFF Baseline 6.0 標準に準拠していません。
