...
description: "PSD ファイル形式の作成オプションです。"
type: docs
weight: 21
url: /ja/java/com.aspose.psd.imageoptions/psdoptions/
---
...
PSD ファイル形式の作成オプションです。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [PsdOptions()](#PsdOptions--) | 新しい [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) クラスのインスタンスを初期化します。 |
| [PsdOptions(PsdOptions options)](#PsdOptions-com.aspose.psd.imageoptions.PsdOptions-) | 新しい [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) クラスのインスタンスを初期化します。 |
| [PsdOptions(PsdImage image)](#PsdOptions-com.aspose.psd.fileformats.psd.PsdImage-) | 新しい [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) クラスのインスタンスを初期化します。 |
## メソッド
...
| [getBackgroundContents()](#getBackgroundContents--) | 背景色を取得または設定します。 |
| [getBufferSizeHint()](#getBufferSizeHint--) | バッファサイズのヒントを取得または設定します。これはすべての内部バッファに対して許容される最大サイズとして定義されています。 |
| [getChannelBitsCount()](#getChannelBitsCount--) | カラー チャンネルあたりのビット数を取得または設定します。 |
| [getChannelsCount()](#getChannelsCount--) | カラー チャンネル数を取得または設定します。 |
| [getClass()](#getClass--) |  |
| [getColorMode()](#getColorMode--) | psd カラーモードを取得または設定します。 |
| [getCompressionMethod()](#getCompressionMethod--) | psd 圧縮方式を取得または設定します。 |
...
| [getPsdVersion()](#getPsdVersion--) | ファイル形式バージョンを取得または設定します。 |
| [getRefreshImagePreviewData()](#getRefreshImagePreviewData--) | 画像プレビュー データの [refresh image preview data] を更新するかどうかを示す値を取得または設定します。- 他の PSD 画像ビューアとの互換性を最大化するために使用されるオプションです。 |
| [getRemoveGlobalTextEngineResource()](#getRemoveGlobalTextEngineResource--) | グローバル テキスト エンジン リソースを削除するかどうかを示す値を取得または設定します。- テキストレイヤー付きの psd ファイルで、処理後に Adobe Photoshop で開けなくなる場合（主にフォントが欠如したテキストレイヤーに関連）に使用されます。 |
| [getResolutionSettings()](#getResolutionSettings--) | 解像度設定を取得または設定します。 |
| [getResources()](#getResources--) | psd リソースを取得または設定します。 |
| [getSource()](#getSource--) | 画像を作成するソースを取得または設定します。 |
| [getUpdateMetadata()](#getUpdateMetadata--) | メタデータを [update metadata] するかどうかを示す値を取得または設定します。 |
| [getVectorRasterizationOptions()](#getVectorRasterizationOptions--) | ベクトルラスタライズオプションを取得または設定します。 |
| [getVersion()](#getVersion--) | psd ファイル バージョンを取得または設定します。 |
| [getXmpData()](#getXmpData--) | XMP データ コンテナを取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [isColorModeSet()](#isColorModeSet--) | ColorMode プロパティが割り当てられているかを示します。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBackgroundContents(RawColor value)](#setBackgroundContents-com.aspose.psd.fileformats.psd.rawcolor.RawColor-) | 背景色を取得または設定します。 |
| [setBufferSizeHint(int value)](#setBufferSizeHint-int-) | バッファサイズのヒントを取得または設定します。これはすべての内部バッファに対して許容される最大サイズとして定義されています。 |
| [setChannelBitsCount(short value)](#setChannelBitsCount-short-) | カラー チャンネルあたりのビット数を取得または設定します。 |
| [setChannelsCount(short value)](#setChannelsCount-short-) | カラー チャンネル数を取得または設定します。 |
| [setColorMode(short value)](#setColorMode-short-) | psd カラーモードを取得または設定します。 |
| [setCompressionMethod(short value)](#setCompressionMethod-short-) | psd 圧縮方式を取得または設定します。 |
...
| [setPsdVersion(byte value)](#setPsdVersion-byte-) | ファイル形式バージョンを取得または設定します。 |
| [setRefreshImagePreviewData(boolean value)](#setRefreshImagePreviewData-boolean-) | 画像プレビュー データの [refresh image preview data] を更新するかどうかを示す値を取得または設定します。- 他の PSD 画像ビューアとの互換性を最大化するために使用されるオプションです。 |
| [setRemoveGlobalTextEngineResource(boolean value)](#setRemoveGlobalTextEngineResource-boolean-) | グローバル テキスト エンジン リソースを削除するかどうかを示す値を取得または設定します。- テキストレイヤー付きの psd ファイルで、処理後に Adobe Photoshop で開けなくなる場合（主にフォントが欠如したテキストレイヤーに関連）に使用されます。 |
| [setResolutionSettings(ResolutionSetting value)](#setResolutionSettings-com.aspose.psd.ResolutionSetting-) | 解像度設定を取得または設定します。 |
| [setResources(ResourceBlock[] value)](#setResources-com.aspose.psd.fileformats.psd.ResourceBlock---) | psd リソースを取得または設定します。 |
| [setSource(Source value)](#setSource-com.aspose.psd.Source-) | 画像を作成するソースを取得または設定します。 |
| [setUpdateMetadata(boolean value)](#setUpdateMetadata-boolean-) | メタデータを [update metadata] するかどうかを示す値を取得または設定します。 |
...
| [setVersion(int value)](#setVersion-int-) | psd ファイル バージョンを取得または設定します。 |
| [setXmpData(XmpPacketWrapper value)](#setXmpData-com.aspose.psd.xmp.XmpPacketWrapper-) | XMP データ コンテナを取得または設定します。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
新しい [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| options | [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) | オプション。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| image | [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) | 画像です。 |
...
ファイル形式バージョンを取得または設定します。PSD または PSB にすることができます。
...
[refresh image preview data] を行うかどうかの値を取得または設定します。- 他の PSD 画像ビューアとの互換性を最大化するためのオプションです。Compact Framework プラットフォームでは、最終レイアウトへのテキストレイヤー描画はサポートされていないことに注意してください。

値: [refresh image preview data] の場合は true、そうでない場合は false。
...
[remove global text engine resource] を削除するかどうかの値を取得または設定します。- グローバルテキストエンジンリソースを削除します。- 処理後に Adobe Photoshop で開けなくなるテキストレイヤーが含まれる PSD ファイルで使用されます（主にフォントが欠如しているテキストレイヤーが原因）。このオプションを使用した後、Photoshop で開いたファイルで次の操作を行う必要があります: メニュー \"Text\" -> \"Process absent fonts\"。その操作後、すべてのテキストが再び表示されます。なお、この操作により最終レイアウトが変更される可能性があることに注意してください。

値: [remove global text engine resource] の場合は true、そうでない場合は false。
...
psd リソースを取得または設定します。値が: NULL の場合は元の ImageResources を保存します（既定の動作）。Not Empty の場合は、このプロパティに渡されたリソースと [required resources] を保存します。Empty の場合は、[required resources] のみが保存されます。必須リソース: ResolutionInfoResource, XmpResource
...
[update metadata] を行うかどうかの値を取得または設定します。値が true の場合、画像を保存する際にメタデータが更新されます。

値: [update metadata] の場合は true、そうでない場合は false。
...
ColorMode プロパティが割り当てられているかを示します。
