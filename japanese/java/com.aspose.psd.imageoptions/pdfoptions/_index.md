...
description: "PDF のオプションです。"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [PdfOptions()](#PdfOptions--) | 新しい [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) クラスのインスタンスを初期化します。 |
## メソッド
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | コア PDF オプションを取得します。 |
...
| [getPageSize()](#getPageSize--) | ページのサイズを取得します。 |
| [getPalette()](#getPalette--) | カラーパレットを取得または設定します。 |
| [getPdfCoreOptions()](#getPdfCoreOptions--) | PDF コアオプション |
| [getPdfDocumentInfo()](#getPdfDocumentInfo--) | ドキュメントのメタデータを取得または設定します。 |
...
| [setPageSize(SizeF value)](#setPageSize-com.aspose.psd.SizeF-) | ページのサイズを設定します。 |
| [setPalette(IColorPalette value)](#setPalette-com.aspose.psd.IColorPalette-) | カラーパレットを取得または設定します。 |
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | PDF コアオプション |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | ドキュメントのメタデータを取得または設定します。 |
...
新しい [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| value | [SizeF](../../com.aspose.psd/sizef) | ページのサイズ。 |
