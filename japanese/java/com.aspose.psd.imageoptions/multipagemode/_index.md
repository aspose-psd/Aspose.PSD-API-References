...
description: "マルチページモードを表します"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.imageoptions/multipagemode/
---
...
| フィールド | 説明 |
| --- | --- |
| [AllPages](#AllPages) | すべてのページを使用 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pages](#Pages) | 使用されたページインデックス |
| [Range](#Range) | 使用されたページ範囲 |
| [TimeInterval](#TimeInterval) | 時間間隔内で使用されたページ |
| [Titles](#Titles) | 使用されたページタイトル |
## メソッド
