...
description: "グラフィックシーンの位置指定とサイズタイプ。"
type: docs
weight: 20
url: /ja/java/com.aspose.psd.imageoptions/positioningtypes/
---
...
グラフィックシーンの位置指定とサイズタイプ。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [DefinedByDocument](#DefinedByDocument) | ドキュメントページ設定で定義されたページ上の絶対位置。 |
| [DefinedByOptions](#DefinedByOptions) | オプションページ設定で定義されたページ上の絶対位置。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | 相対的な位置とサイズ。 |
## メソッド
...
相対的な位置とサイズ。すべてのグラフィックオブジェクトの境界によって決定されます。
