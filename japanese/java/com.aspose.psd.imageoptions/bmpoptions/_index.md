...
description: "BMP ファイル形式の作成オプション。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.imageoptions/bmpoptions/
---
...
| Constructor | 説明 |
| --- | --- |
| [BmpOptions()](#BmpOptions--) | BmpOptions クラスの新しいインスタンスを初期化します。 |
| [BmpOptions(BmpOptions bmpOptions)](#BmpOptions-com.aspose.psd.imageoptions.BmpOptions-) | BmpOptions クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getBitsPerPixel()](#getBitsPerPixel--) | 画像のビット/ピクセル数を取得または設定します。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBitsPerPixel(int value)](#setBitsPerPixel-int-) | 画像のビット/ピクセル数を取得または設定します。 |
| [setBufferSizeHint(int value)](#setBufferSizeHint-int-) | バッファサイズのヒントを取得または設定します。これはすべての内部バッファに対して許容される最大サイズとして定義されています。 |
| [setCompression(long value)](#setCompression-long-) | 圧縮を取得または設定します。 |
...
BmpOptions クラスの新しいインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| bmpOptions | [BmpOptions](../../com.aspose.psd.imageoptions/bmpoptions) | BMP オプションです。 |
