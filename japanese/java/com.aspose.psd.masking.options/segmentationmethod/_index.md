...
description: "セグメンテーション手法のタイプ"
type: docs
weight: 17
url: /ja/java/com.aspose.psd.masking.options/segmentationmethod/
---
...
| [FuzzyCMeans](#FuzzyCMeans) | Fuzzy C-means セグメンテーションアルゴリズムです。 |
| [GraphCut](#GraphCut) | Graph Cut セグメンテーションアルゴリズムです |
| [KMeans](#KMeans) | K-means セグメンテーションアルゴリズムです。 |
| [Manual](#Manual) | 手動セグメンテーションアルゴリズムです |
| [Watershed](#Watershed) | Watershed セグメンテーションアルゴリズムです。 |
## メソッド
...
Fuzzy C-means セグメンテーションアルゴリズムです。
