...
description: "検出されたオブジェクトタイプの列挙体です。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.masking.options/detectedobjecttype/
---
...
検出されたオブジェクトタイプの列挙体です。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Human](#Human) | 人間オブジェクトのタイプ。 |
| [Other](#Other) | その他のオブジェクトタイプ。 |
## メソッド
