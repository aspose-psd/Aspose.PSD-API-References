...
description: "PSD ファイル内のスマートオブジェクトレイヤーに関する情報を含む SmartObjectResource クラスを定義します。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource/
---
...
SmartObjectResource クラスを定義します。このクラスは PSD ファイル内のスマートオブジェクトレイヤーに関する情報を含みます。Sold および Sole リソースの基底クラスであり、Adobe\ufffd Photoshop\ufffd 画像におけるスマートオブジェクトレイヤーをサポートするために使用されます。
## フィールド
