...
description: "PlLdResource クラスを定義し、PSD ファイル内の配置レイヤーに関する情報を含みます。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
PlLdResource クラスは、PSD ファイル内の配置レイヤーに関する情報を含みます。Adobe® Photoshop® 画像のスマートオブジェクトレイヤーをサポートするために使用されます。Adobe® Photoshop® CS3 では SoLdResource に置き換えられました。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [PlLdResource()](#PlLdResource--) | 新しい [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [TypeValue_internalized](#TypeValue-internalized) | 期待される型の値 |
...
| [getLength()](#getLength--) | PlLd リソースの長さ（バイト単位）を取得します。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 指定されたストリームコンテナに PlLD リソースを保存します。 |
...
新しい [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource) クラスのインスタンスを初期化します。このデフォルトコンストラクタは PlLdResourceLoader が使用するように設計されています。PlLdResource クラスを作成するには [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) を使用してください。
