...
description: "PlacedLayerType 列挙体を定義し、配置レイヤー PlLd リソース用です。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedlayertype/
---
...
PlacedLayerType 列挙体を定義し、配置レイヤー PlLd リソース用です。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ImageStack](#ImageStack) | 画像スタックの配置レイヤータイプ |
| [Raster](#Raster) | ラスタ配置レイヤータイプ |
| [Unknown](#Unknown) | 不明な配置レイヤータイプ |
| [Vector](#Vector) | ベクタ配置レイヤータイプ |
## メソッド
