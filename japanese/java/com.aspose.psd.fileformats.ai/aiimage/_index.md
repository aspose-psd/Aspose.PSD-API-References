...
description: "Adobe Illustrator AI 画像"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
Adobe Illustrator (AI) 画像です
## Constructors

| Constructor | 説明 |
| --- | --- |
| [AiImage()](#AiImage--) | 新しい [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) クラスのインスタンスを初期化します。 |
## フィールド
...
| メソッド | 説明 |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | AI レイヤー セクションを追加します。 |
| [cacheData()](#cacheData--) | データをキャッシュし、基になる P:Aspose.PSD.DataStreamSupporter.DataStreamContainer から追加のデータ読み込みが行われないことを保証します。 |
...
| [getActivePageIndex()](#getActivePageIndex--) | アクティブ ページのインデックスを取得または設定します。 |
...
| [getDataSection()](#getDataSection--) | データ セクションを取得します。 |
...
| [getFinalizeSection()](#getFinalizeSection--) | finalize セクションを取得します。 |
...
| [getPageCount()](#getPageCount--) | ページ数。 |
...
| [getSetupSection()](#getSetupSection--) | セットアップ セクションを取得します。 |
...
| [getVersion()](#getVersion--) | Adobe Illustrator 形式のバージョンを取得します。 |
| [getWidth()](#getWidth--) | 画像の幅を取得します。 |
| [getXmpData()](#getXmpData--) | XMP メタデータを取得します。 |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | アクティブ ページのインデックスを取得または設定します。 |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | レンダリングされた画像を取得します。 |
...
新しい [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | AI レイヤー セクション。 |
...
データをキャッシュし、基になる P:Aspose.PSD.DataStreamSupporter.DataStreamContainer から追加のデータ読み込みが行われないことを保証します。
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - ApsPage インスタンス。
...
アクティブ ページのインデックスを取得または設定します。

Value: このプロパティは PDF 形式の AI 画像に対してのみ有効です。画像が PDF 形式でない場合、またはページが存在しない場合、プロパティは -1 になります。このプロパティは、AI 画像のどのページがレンダリングの基礎になるかを示します。
...
Adobe Illustrator 形式のバージョンを取得します。
...
Value: オブジェクトのデータがキャッシュされている場合は true、そうでない場合は false。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| ventureLicense | java.lang.Object | ベンチャー ライセンス オブジェクト。 |
