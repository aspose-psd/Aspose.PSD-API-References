...
description: "Adobe Pdf 名前空間を表します。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.xmp.schemas.pdf/pdfpackage/
---
...
| Constructor | 説明 |
| --- | --- |
| [PdfPackage()](#PdfPackage--) | PdfPackage クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [setKeywords(String keywords)](#setKeywords-java.lang.String-) | キーワードを設定します。 |
| [setPdfVersion(String version)](#setPdfVersion-java.lang.String-) | Pdf バージョンを設定します。 |
| [setProducer(String producer)](#setProducer-java.lang.String-) | Pdf を作成したツールの名前を設定します。 |
| [setTrapped(boolean isTrapped)](#setTrapped-boolean-) | trapped を設定します。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| キーワード | java.lang.String | キーワードです。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| version | java.lang.String | Pdf バージョン、例: 1.0、1.3 など。 |
...
Pdf を作成したツールの名前を設定します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| producer | java.lang.String | producer の名前です。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| isTrapped | boolean | true に設定されている場合、ドキュメントはトラップされています。 |
