...
description: "PhotoshopPackage のカラーモードを表します。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.xmp.schemas.photoshop/colormode/
---
...
PhotoshopPackage のカラーモードを表します。
## フィールド

| フィールド | 説明 |
| --- | --- |
| [Bitmap](#Bitmap) | ビットマップ カラーモード。 |
| [Cmyk](#Cmyk) | CMYK カラーモード。 |
| [Duotone](#Duotone) | デュオトーンカラー。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GrayScale](#GrayScale) | グレースケール カラーモード。 |
| [IndexedColor](#IndexedColor) | インデックスカラー。 |
| [LabColor](#LabColor) | LAB カラー。 |
| [MultiChannel](#MultiChannel) | マルチチャンネルカラー。 |
| [Rgb](#Rgb) | RGB カラー。 |
## メソッド
