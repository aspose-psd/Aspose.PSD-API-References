...
description: "PSD 形式画像内の埋め込みファイルに関する情報を含むクラスを定義します。"
type: docs
weight: 15
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
埋め込みファイルに関する情報を含むクラスを定義します。このクラスは PSD 形式画像における埋め込みファイルに関する情報を提供します。リンクリソースは、インデクサーでアクセス可能な複数の LiFdDataSource インスタンスを含む場合があります。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | 新しい [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [get_Item(int index)](#get-Item-int-) | 指定されたインデックスの LiFdDataSource を取得します。 |
...
新しい [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) クラスのインスタンスを初期化します。
...
指定されたインデックスの LiFdDataSource を取得します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| index | int | インデックス。値: LiFdDataSource。 |
