...
description: "PSD 形式の 1 チャネルあたり 32 ビット画像における埋め込みファイルに関する情報を含むクラスを定義します。"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
32 ビット/チャンネル画像の PSD 形式で埋め込みファイルに関する情報を含むクラスを定義します。リンクリソースは、インデクサでアクセスできる複数の [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) インスタンスを含む場合があります。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | 新しい [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) クラスのインスタンスを初期化します。 |
## フィールド
...
新しい [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) クラスのインスタンスを初期化します。
