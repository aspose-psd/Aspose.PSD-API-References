...
description: "PSD リンクリソース内のデータソース用に LinkDataSourceType 列挙体を定義します。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasourcetype/
---
...
PSD リンクリソース内のデータソース用に LinkDataSourceType 列挙体を定義します。
## フィールド
...
| [None](#None) | 空のリンクリソース。 |
| [liFA](#liFA) | リンクされたファイルエイリアス データ |
| [liFD](#liFD) | 埋め込まれたリンクファイル データ |
| [liFE](#liFE) | 外部リンクされたファイルデータ |
## メソッド
