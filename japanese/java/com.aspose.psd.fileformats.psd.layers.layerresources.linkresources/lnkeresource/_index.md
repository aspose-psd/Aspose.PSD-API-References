...
description: "PSD 形式画像内の外部リンクファイルまたはアセットに関する情報を含む LnkeResource クラスを定義します。"
type: docs
weight: 17
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
LnkeResource クラスを定義します。このクラスは PSD 形式画像における外部リンクファイルまたはアセットに関する情報を含みます。リンクリソースは、インデクサーでアクセス可能な複数の [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) インスタンスを含む場合があります。これは、Adobe® Photoshop® ファイルをプログラムで変更するのに役立つ PSD ファイル形式操作 API の一部です。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | 新しい [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) クラスのインスタンスを初期化します。 |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | 新しい [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [get_Item(int index)](#get-Item-int-) | 指定されたインデックスの [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) を取得します。 |
...
新しい [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | データソース。 |
...
指定されたインデックスの [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) を取得します。

**Parameters:**
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| index | int | インデックス。値: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)。 |
