...
description: "PSD フォーマット仕様に基づくベクトルパスタイプ"
type: docs
weight: 22
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
| フィールド | 説明 |
| --- | --- |
| [ClipboardRecord](#ClipboardRecord) | クリップボード レコード |
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | 閉じたサブパス ベジェ ノード（リンクあり） |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | 閉じたサブパス ベジェ ノード（リンクなし） |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | 閉じたサブパス 長さ レコード |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | 初期塗りルール レコード |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | 開いたサブパス ベジェ ノード（リンクあり） |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | 開いたサブパス ベジェ ノード（リンクなし） |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | 開いたサブパス 長さ レコード |
| [PathFillRuleRecord](#PathFillRuleRecord) | パス塗りルール レコード |
## メソッド
