...
description: "クラス VsmsResource。"
type: docs
weight: 29
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
クラス VsmsResource。 このリソースはベクトルレイヤーマスクに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | 新しい [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) クラスのインスタンスを初期化します。 |
| [VsmsResource()](#VsmsResource--) | 新しい [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) クラスのインスタンスを初期化します。 |
## フィールド
...
新しい [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) クラスのインスタンスを初期化します。
