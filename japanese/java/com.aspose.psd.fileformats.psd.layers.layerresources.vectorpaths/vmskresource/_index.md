...
description: "クラス VmskResource。"
type: docs
weight: 27
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource/
---
...
クラス VmskResource。 このリソースはベクターレイヤーマスクに関する情報を含みます。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [VmskResource(byte[] data)](#VmskResource-byte---) | 新しい [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) クラスのインスタンスを初期化します。 |
| [VmskResource()](#VmskResource--) | 新しい [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) クラスのインスタンスを初期化します。 |
## フィールド
...
新しい [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) クラスのインスタンスを初期化します。
