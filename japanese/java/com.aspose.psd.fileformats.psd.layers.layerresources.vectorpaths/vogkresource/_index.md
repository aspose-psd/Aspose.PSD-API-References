...
description: "ベクトル起点データリソースです。"
type: docs
weight: 28
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [VogkResource()](#VogkResource--) | 新しい [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) クラスのインスタンスを初期化します。 |
## フィールド

| フィールド | 説明 |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | シェイプの原点設定を保存するディスクリプタキー。 |
...
| [getItems_internalized()](#getItems-internalized--) | 構造項目を取得または設定します。 |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | シェイプの原点設定を取得または設定します。 |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | シェイプの原点設定を取得または設定します。 |
...
新しい [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) クラスのインスタンスを初期化します。
