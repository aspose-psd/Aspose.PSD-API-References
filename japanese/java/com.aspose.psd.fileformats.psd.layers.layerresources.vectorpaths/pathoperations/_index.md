...
description: "パス形状を組み合わせるブール演算の操作です。"
type: docs
weight: 15
url: /ja/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| フィールド | 説明 |
| --- | --- |
| [CombineShapes](#CombineShapes) | 形状を結合 (OR 演算)。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | 重複する形状を除外 (XOR 演算)。 |
| [IntersectShapeAreas](#IntersectShapeAreas) | 形状領域を交差 (AND 演算)。 |
| [SubtractFrontShape](#SubtractFrontShape) | 前面形状を減算 (NOT 演算)。 |
## メソッド
...
形状を結合 (OR 演算)。 これは Photoshop のデフォルト値です。
