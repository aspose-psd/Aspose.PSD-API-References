...
description: "GaussianBlur スマートフィルターです。"
type: docs
weight: 11
url: /ja/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter/
---
...
| Constructor | 説明 |
| --- | --- |
| [GaussianBlurSmartFilter()](#GaussianBlurSmartFilter--) | 新しい [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getRadius()](#getRadius--) | ガウススマートフィルターの半径を取得または設定します。 |
...
| [setRadius(double value)](#setRadius-double-) | ガウススマートフィルターの半径を取得または設定します。 |
...
新しい [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter) クラスのインスタンスを初期化します。
