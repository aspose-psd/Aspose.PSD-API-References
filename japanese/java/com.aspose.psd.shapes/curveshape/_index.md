...
description: "曲線スプライン形状を表します。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.shapes/curveshape/
---
...
| Constructor | 説明 |
| --- | --- |
| [CurveShape()](#CurveShape--) | CurveShape クラスの新しいインスタンスを初期化します。 |
| [CurveShape(PointF[] points)](#CurveShape-com.aspose.psd.PointF---) | CurveShape クラスの新しいインスタンスを初期化します。 |
| [CurveShape(PointF[] points, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---boolean-) | CurveShape クラスの新しいインスタンスを初期化します。 |
| [CurveShape(PointF[] points, float tension)](#CurveShape-com.aspose.psd.PointF---float-) | CurveShape クラスの新しいインスタンスを初期化します。 |
| [CurveShape(PointF[] points, float tension, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---float-boolean-) | CurveShape クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getTension()](#getTension--) | 曲線テンションを取得または設定します。 |
...
| [setTension(float value)](#setTension-float-) | 曲線テンションを取得または設定します。 |
| [toString()](#toString--) |  |
