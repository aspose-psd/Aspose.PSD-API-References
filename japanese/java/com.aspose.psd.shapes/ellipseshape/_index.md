...
description: "楕円形状を表します。"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.shapes/ellipseshape/
---
...
| Constructor | 説明 |
| --- | --- |
| [EllipseShape()](#EllipseShape--) | EllipseShape クラスの新しいインスタンスを初期化します。 |
| [EllipseShape(RectangleF rectangle)](#EllipseShape-com.aspose.psd.RectangleF-) | EllipseShape クラスの新しいインスタンスを初期化します。 |
## メソッド
