...
description: "多角形形状を表します。"
type: docs
weight: 15
url: /ja/java/com.aspose.psd.shapes/polygonshape/
---
...
| Constructor | 説明 |
| --- | --- |
| [PolygonShape()](#PolygonShape--) | PolygonShape クラスの新しいインスタンスを初期化します。 |
| [PolygonShape(PointF[] points)](#PolygonShape-com.aspose.psd.PointF---) | PolygonShape クラスの新しいインスタンスを初期化します。 |
| [PolygonShape(PointF[] points, boolean isClosed)](#PolygonShape-com.aspose.psd.PointF---boolean-) | PolygonShape クラスの新しいインスタンスを初期化します。 |
## メソッド
...
PolygonShape クラスの新しいインスタンスを初期化します。
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | ポイント配列です。 |
| isClosed | boolean | true に設定すると、ポリゴンは閉じます。 |
