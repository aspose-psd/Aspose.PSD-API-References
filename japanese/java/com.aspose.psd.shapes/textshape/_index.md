...
description: "テキスト形状を表します。"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.shapes/textshape/
---
...
| Constructor | 説明 |
| --- | --- |
| [TextShape()](#TextShape--) | TextShape クラスの新しいインスタンスを初期化します。 |
| [TextShape(String text, RectangleF rectangle, Font font, StringFormat stringFormat)](#TextShape-java.lang.String-com.aspose.psd.RectangleF-com.aspose.psd.Font-com.aspose.psd.StringFormat-) | TextShape クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getClass()](#getClass--) |  |
| [getFont()](#getFont--) | テキスト描画に使用されるフォントを取得または設定します。 |
...
| [getText()](#getText--) | 描画されたテキストを取得または設定します。 |
| [getTextFormat()](#getTextFormat--) | テキスト形式を取得または設定します。 |
| [hasSegments()](#hasSegments--) | 形状にセグメントがあるかどうかを示す値を取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setFont(Font value)](#setFont-com.aspose.psd.Font-) | テキスト描画に使用されるフォントを取得または設定します。 |
| [setText(String value)](#setText-java.lang.String-) | 描画されたテキストを取得または設定します。 |
| [setTextFormat(StringFormat value)](#setTextFormat-com.aspose.psd.StringFormat-) | テキスト形式を取得または設定します。 |
| [toString()](#toString--) |  |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| text | java.lang.String | 描画するテキスト。 |
| rectangle | [RectangleF](../../com.aspose.psd/rectanglef) | テキスト矩形。 |
| font | [Font](../../com.aspose.psd/font) | 使用するフォント。 |
