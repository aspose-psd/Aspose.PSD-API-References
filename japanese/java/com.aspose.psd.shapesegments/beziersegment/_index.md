...
description: "2 つの制御点を使用して、ある点から次の点へ移動するベジエセグメントです。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.shapesegments/beziersegment/
---
...
2 つの制御点を使用して、ある点から次の点へ移動するベジエセグメントです。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [BezierSegment(PointF startPoint, PointF firstControlPoint, PointF secondControlPoint, PointF endPoint)](#BezierSegment-com.aspose.psd.PointF-com.aspose.psd.PointF-com.aspose.psd.PointF-com.aspose.psd.PointF-) | BezierSegment クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getClass()](#getClass--) |  |
| [getEndPoint()](#getEndPoint--) | 終了点を取得します。 |
| [getFirstControlPoint()](#getFirstControlPoint--) | ベジエスプラインの最初の制御点を取得します。 |
| [getSecondControlPoint()](#getSecondControlPoint--) | ベジエスプラインの2番目の制御点を取得します。 |
| [getStartPoint()](#getStartPoint--) | 開始点を取得します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| startPoint | [PointF](../../com.aspose.psd/pointf) | 開始点。 |
| firstControlPoint | [PointF](../../com.aspose.psd/pointf) | 最初の制御点。 |
| secondControlPoint | [PointF](../../com.aspose.psd/pointf) | 2番目の制御点。 |
| endPoint | [PointF](../../com.aspose.psd/pointf) | 終了点。 |
