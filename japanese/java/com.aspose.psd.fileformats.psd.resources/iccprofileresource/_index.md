...
description: "ICC プロファイルリソースを表します。"
type: docs
weight: 23
url: /ja/java/com.aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [IccProfileResource()](#IccProfileResource--) | 新しい [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getIccProfile()](#getIccProfile--) | ICC プロファイルを取得または設定します。 |
...
| [setIccProfile(byte[] value)](#setIccProfile-byte---) | ICC プロファイルを取得または設定します。 |
...
新しい [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource) クラスのインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| 値 | com.aspose.ms.System.IO.MemoryStream |  |
