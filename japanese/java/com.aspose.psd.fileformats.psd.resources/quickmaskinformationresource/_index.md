...
description: "クイックマスク情報リソース"
type: docs
weight: 32
url: /ja/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | 新しいインスタンスを初期化します [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) クラス。 |
## フィールド
...
| [getChannelId()](#getChannelId--) | チャンネル識別子を取得または設定します。 |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | このインスタンスがマスクが空かどうかを示す値を取得または設定します。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | リソースブロックを指定されたストリームに保存します。 |
| [setChannelId(short value)](#setChannelId-short-) | チャンネル識別子を取得または設定します。 |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | このインスタンスがマスクが空かどうかを示す値を取得または設定します。 |
...
新しいインスタンスを初期化します [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) クラス。
...
このインスタンスがマスクが空かどうかを示す値を取得または設定します。

Value:  true  このインスタンスがマスクが空の場合は true、そうでない場合は false 。
