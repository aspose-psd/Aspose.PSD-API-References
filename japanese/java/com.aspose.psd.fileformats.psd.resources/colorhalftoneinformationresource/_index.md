...
description: "ハーフトーニングリソース"
type: docs
weight: 14
url: /ja/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | 新しいインスタンスを初期化します [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) クラス。 |
## フィールド
...
| [getHalftoneData()](#getHalftoneData--) | 取得または設定しますハーフトーン データ。 |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | 取得または設定しますハーフトーン データ。 |
...
新しいインスタンスを初期化します [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) クラス。
