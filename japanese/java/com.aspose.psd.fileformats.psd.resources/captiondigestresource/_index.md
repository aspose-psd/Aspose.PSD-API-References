...
description: "CaptionDigest リソース"
type: docs
weight: 13
url: /ja/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | 新しい [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getDigest()](#getDigest--) | ダイジェストを取得または設定します。 |
...
| [setDigest(byte[] value)](#setDigest-byte---) | ダイジェストを取得または設定します。 |
