...
description: "Icc タグ付けされていないリソース"
type: docs
weight: 24
url: /ja/java/com.aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [IccUntaggedResource()](#IccUntaggedResource--) | 新しいインスタンスを初期化します [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource) クラス。 |
## フィールド
...
| [getProfile()](#getProfile--) | プロファイルを取得または設定します。 |
...
| [setProfile(byte value)](#setProfile-byte-) | プロファイルを取得または設定します。 |
...
新しいインスタンスを初期化します [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource) クラス。
