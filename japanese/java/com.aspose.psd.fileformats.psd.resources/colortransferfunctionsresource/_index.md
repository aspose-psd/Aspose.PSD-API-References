...
description: "カラートランスファーリソース"
type: docs
weight: 15
url: /ja/java/com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource--) | 新しいインスタンスを初期化します [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource) クラス。 |
## フィールド
...
| [getClass()](#getClass--) |  |
| [getColorTransferData()](#getColorTransferData--) | カラー転送データを取得または設定します。 |
...
| [setColorTransferData(byte[] value)](#setColorTransferData-byte---) | カラー転送データを取得または設定します。 |
...
新しいインスタンスを初期化します [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource) クラス。
