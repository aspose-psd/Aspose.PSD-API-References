...
description: "グローバル角度リソース"
type: docs
weight: 19
url: /ja/java/com.aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [GlobalAngleResource()](#GlobalAngleResource--) | 新しい [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | 全体の角度を取得または設定します。 |
...
新しい [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) クラスのインスタンスを初期化します。
