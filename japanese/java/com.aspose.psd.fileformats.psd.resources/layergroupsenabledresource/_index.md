...
description: "レイヤー グループ有効リソース"
type: docs
weight: 26
url: /ja/java/com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource--) | 新しいインスタンスを初期化します [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) クラス。 |
## フィールド
...
| [setIDs(byte[] value)](#setIDs-byte---) | 取得または設定します i ds。 |
...
新しいインスタンスを初期化します [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) クラス。
