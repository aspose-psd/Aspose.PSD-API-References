...
description: "グローバル高度リソース"
type: docs
weight: 18
url: /ja/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| Constructor | 説明 |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | 新しいインスタンスを初期化します [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) クラス。 |
## フィールド
...
| [getAltitude()](#getAltitude--) | 高度を取得または設定します。 |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | 高度を取得または設定します。 |
...
新しいインスタンスを初期化します [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) クラス。
