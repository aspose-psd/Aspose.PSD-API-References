...
description: "レイヤー 状態情報リソース"
type: docs
weight: 28
url: /ja/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | 新しいインスタンスを初期化します [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) クラス。 |
## フィールド
...
| [getLayerIndex()](#getLayerIndex--) | レイヤーのインデックスを取得または設定します。 |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | レイヤーのインデックスを取得または設定します。 |
...
新しいインスタンスを初期化します [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) クラス。
