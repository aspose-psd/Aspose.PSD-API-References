...
description: "Unicode アルファ名リソース"
type: docs
weight: 38
url: /ja/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | 新しい [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getAlphaNames()](#getAlphaNames--) | アルファ名を取得または設定します。 |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | アルファ名を取得または設定します。 |
...
新しい [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) クラスのインスタンスを初期化します。
