...
type: docs
weight: 42
url: /ja/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | 新しい [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | このインスタンスが透かしかどうかを示す値を取得または設定します。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | このインスタンスが透かしかどうかを示す値を取得または設定します。 |
| [toString()](#toString--) |  |
...
新しい [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) クラスのインスタンスを初期化します。
...
このインスタンスが透かしかどうかを示す値を取得または設定します。

値: このインスタンスが透かしの場合は true、そうでない場合は false。
