...
description: "レイヤー グループ情報リソース"
type: docs
weight: 25
url: /ja/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | 新しい [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getGroups()](#getGroups--) | グループを取得または設定します。 |
...
| [setGroups(short[] value)](#setGroups-short---) | グループを取得または設定します。 |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Layers の LinkGroupId を Groups プロパティから更新します。 |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Layers から Groups プロパティの値を更新します。 |
...
Layers の LinkGroupId を Groups プロパティから更新します。
...
Layers から Groups プロパティの値を更新します。
