...
description: "バージョン情報リソース"
type: docs
weight: 41
url: /ja/java/com.aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
| Constructor | 説明 |
| --- | --- |
| [VersionInfoResource()](#VersionInfoResource--) | 新しいインスタンスを初期化します [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource) クラス。 |
## フィールド
...
| [getFileVersion()](#getFileVersion--) | 取得または設定しますファイル バージョン。 |
...
| [getReaderName()](#getReaderName--) | 取得または設定しますリーダーの名前。 |
...
| [getWriterName()](#getWriterName--) | 取得または設定しますライターの名前。 |
| [hasRealMergedData()](#hasRealMergedData--) | 取得または設定します、このインスタンスが実際の結合データを持つかどうかを示す値。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | リソースブロックを指定されたストリームに保存します。 |
| [setFileVersion(long value)](#setFileVersion-long-) | 取得または設定しますファイル バージョン。 |
...
| [setReaderName(String value)](#setReaderName-java.lang.String-) | 取得または設定しますリーダーの名前。 |
| [setRealMergedData(boolean value)](#setRealMergedData-boolean-) | 取得または設定します、このインスタンスが実際の結合データを持つかどうかを示す値。 |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | リソースブロックの状態を取得または設定します。 |
| [setVersion(long value)](#setVersion-long-) | バージョンを取得または設定します。 |
| [setWriterName(String value)](#setWriterName-java.lang.String-) | 取得または設定しますライターの名前。 |
| [toString()](#toString--) |  |
...
新しいインスタンスを初期化します [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource) クラス。
...
取得または設定します、このインスタンスが実際の結合データを持つかどうかを示す値。

値:  true  このインスタンスが実際の結合データを持つ場合; それ以外の場合は  false .
