...
description: "グリッドとガイドのリソースを表します。"
type: docs
weight: 20
url: /ja/java/com.aspose.psd.fileformats.psd.resources/gridandguidesresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [GridAndGuidesResource()](#GridAndGuidesResource--) | 新しい [GridAndGuidesResource](../../com.aspose.psd.fileformats.psd.resources/gridandguidesresource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getGridCycleX()](#getGridCycleX--) | 水平グリッドサイクルを取得または設定します。 |
| [getGridCycleY()](#getGridCycleY--) | 垂直グリッドサイクルを取得または設定します。 |
| [getGuideCount()](#getGuideCount--) | ガイドリソースブロックの数を取得します。 |
| [getGuides()](#getGuides--) | ガイドを取得または設定します。 |
| [getHeaderVersion()](#getHeaderVersion--) | ヘッダー バージョンを取得または設定します。 |
...
| [setGridCycleX(int value)](#setGridCycleX-int-) | 水平グリッドサイクルを取得または設定します。 |
| [setGridCycleY(int value)](#setGridCycleY-int-) | 垂直グリッドサイクルを取得または設定します。 |
| [setGuides(GuideResource[] value)](#setGuides-com.aspose.psd.fileformats.psd.resources.GuideResource---) | ガイドを取得または設定します。 |
| [setHeaderVersion(int value)](#setHeaderVersion-int-) | ヘッダー バージョンを取得または設定します。 |
...
新しい [GridAndGuidesResource](../../com.aspose.psd.fileformats.psd.resources/gridandguidesresource) クラスのインスタンスを初期化します。
...
水平グリッドサイクルを取得または設定します。デフォルトは 576 です。
...
垂直グリッドサイクルを取得または設定します。デフォルトは 576 です。
...
ヘッダー バージョンを取得または設定します。この値は常に 1 である必要があります。
