...
description: "解像度情報リソース"
type: docs
weight: 33
url: /ja/java/com.aspose.psd.fileformats.psd.resources/resolutioninforesource/
---
...
| Constructor | 説明 |
| --- | --- |
| [ResolutionInfoResource()](#ResolutionInfoResource--) | 新しい [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getHResDisplayUnit()](#getHResDisplayUnit--) | 水平解像度の表示単位。 |
| [getHeightDisplayUnit()](#getHeightDisplayUnit--) | 高さの表示単位を取得または設定します。 |
...
| [getVResDisplayUnit()](#getVResDisplayUnit--) | 垂直解像度の表示単位。 |
| [getWidthDisplayUnit()](#getWidthDisplayUnit--) | 幅の表示単位を取得または設定します。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setHResDisplayUnit(int value)](#setHResDisplayUnit-int-) | 水平解像度の表示単位。 |
| [setHeightDisplayUnit(int value)](#setHeightDisplayUnit-int-) | 高さの表示単位を取得または設定します。 |
...
| [setVResDisplayUnit(int value)](#setVResDisplayUnit-int-) | 垂直解像度の表示単位。 |
| [setWidthDisplayUnit(int value)](#setWidthDisplayUnit-int-) | 幅の表示単位を取得または設定します。 |
| [toString()](#toString--) |  |
...
新しい [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) クラスのインスタンスを初期化します。
...
水平解像度の表示単位。これはユーザーインターフェイスにのみ影響し、解像度は PSD ファイル内にピクセル/インチとして保存されます。
