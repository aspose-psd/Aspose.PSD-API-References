...
description: "サムネイルリソースブロック。"
type: docs
weight: 36
url: /ja/java/com.aspose.psd.fileformats.psd.resources/thumbnailresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [ThumbnailResource()](#ThumbnailResource--) | 新しい [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource) クラスのインスタンスを初期化します。 |
## フィールド
...
新しい [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource) クラスのインスタンスを初期化します。
