...
description: "ドキュメント固有 ID リソース"
type: docs
weight: 16
url: /ja/java/com.aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [DocumentSpecificIdsResource()](#DocumentSpecificIdsResource--) | 新しいインスタンスを初期化します [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) クラス。 |
## フィールド
...
| [setId(int value)](#setId-int-) | 識別子を取得または設定します。 |
...
新しいインスタンスを初期化します [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) クラス。
