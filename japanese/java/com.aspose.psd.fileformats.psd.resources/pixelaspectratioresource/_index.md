...
description: "ピクセル アスペクト比リソース"
type: docs
weight: 29
url: /ja/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | 新しい [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) クラスのインスタンスを初期化します。 |
## フィールド
...
| [getAspectRatio()](#getAspectRatio--) | アスペクト比を取得または設定します。 |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | アスペクト比を取得または設定します。 |
