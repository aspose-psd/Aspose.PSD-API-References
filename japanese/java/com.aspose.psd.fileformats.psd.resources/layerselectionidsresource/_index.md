...
description: "レイヤー 選択 ID リソース"
type: docs
weight: 27
url: /ja/java/com.aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| Constructor | 説明 |
| --- | --- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource--) | 新しいインスタンスを初期化します [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource) クラス。 |
## フィールド
...
| [getLayerIds()](#getLayerIds--) | レイヤー ID を取得または設定します。 |
...
| [setCount(short value)](#setCount-short-) | カウントを取得または設定します。 |
...
| [setLayerIds(int[] value)](#setLayerIds-int---) | レイヤー ID を取得または設定します。 |
...
新しいインスタンスを初期化します [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource) クラス。
