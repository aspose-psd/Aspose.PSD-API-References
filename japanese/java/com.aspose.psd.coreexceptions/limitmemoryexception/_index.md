...
type: docs
weight: 18
url: /ja/java/com.aspose.psd.coreexceptions/limitmemoryexception/
---
...
メモリ制限例外です。メモリ使用量を削減すべき時に発生します。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [LimitMemoryException(String message)](#LimitMemoryException-java.lang.String-) | LimitMemoryException クラスの新しいインスタンスを初期化します。 |
| [LimitMemoryException(String message, Throwable innerException)](#LimitMemoryException-java.lang.String-java.lang.Throwable-) | LimitMemoryException クラスの新しいインスタンスを初期化します。 |
| [LimitMemoryException(String message, long reduceMemoryFactor)](#LimitMemoryException-java.lang.String-long-) | LimitMemoryException クラスの新しいインスタンスを初期化します。 |
| [LimitMemoryException(String message, Throwable innerException, int reduceMemoryFactor)](#LimitMemoryException-java.lang.String-java.lang.Throwable-int-) | LimitMemoryException クラスの新しいインスタンスを初期化します。 |
## メソッド
...
| [getReduceMemoryFactor()](#getReduceMemoryFactor--) | reduce memory factor を取得または設定します。 |
...
| [setReduceMemoryFactor(long value)](#setReduceMemoryFactor-long-) | reduce memory factor を取得または設定します。 |
...
| --- | --- | --- |
| メッセージ | java.lang.String | 例外メッセージです。 |
| reduceMemoryFactor | long | reduce memory factor です。 |
...
| メッセージ | java.lang.String | 例外メッセージです。 |
| innerException | java.lang.Throwable | 内部例外です。 |
| reduceMemoryFactor | int | reduce memory factor です。 |
...
reduce memory factor を取得または設定します。

値: reduce memory factor です。
