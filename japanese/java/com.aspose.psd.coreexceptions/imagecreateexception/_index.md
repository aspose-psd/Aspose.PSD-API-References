...
type: docs
weight: 13
url: /ja/java/com.aspose.psd.coreexceptions/imagecreateexception/
---
...
画像作成例外です。画像の作成中に発生します。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [ImageCreateException(String message)](#ImageCreateException-java.lang.String-) | ImageCreateException クラスの新しいインスタンスを初期化します。 |
| [ImageCreateException(String message, Throwable innerException)](#ImageCreateException-java.lang.String-java.lang.Throwable-) | ImageCreateException クラスの新しいインスタンスを初期化します。 |
## メソッド
...
ImageCreateException クラスの新しいインスタンスを初期化します。
