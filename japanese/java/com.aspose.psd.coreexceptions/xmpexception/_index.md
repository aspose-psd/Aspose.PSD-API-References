...
description: "XMPの構造が無効な場合にスローされる例外。"
type: docs
weight: 23
url: /ja/java/com.aspose.psd.coreexceptions/xmpexception/
---
...
XMPの構造が無効な場合にスローされる例外。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [XmpException()](#XmpException--) | XmpException クラスの新しいインスタンスを初期化します。 |
| [XmpException(String message)](#XmpException-java.lang.String-) | XmpException クラスの新しいインスタンスを初期化します。 |
| [XmpException(String message, Throwable innerException)](#XmpException-java.lang.String-java.lang.Throwable-) | XmpException クラスの新しいインスタンスを初期化します。 |
## フィールド
