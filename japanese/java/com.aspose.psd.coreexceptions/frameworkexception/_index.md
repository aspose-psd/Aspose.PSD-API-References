...
description: "イメージングフレームワーク例外。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.coreexceptions/frameworkexception/
---
...
イメージングフレームワーク例外です。このクラスは Aspose.Imaging のすべての例外のコアクラスです。Aspose.Imaging エンジンがスローする例外とその他の例外タイプを区別するために導入されました。
## Constructors

| Constructor | 説明 |
| --- | --- |
| [FrameworkException(String message)](#FrameworkException-java.lang.String-) | FrameworkException クラスの新しいインスタンスを初期化します。 |
| [FrameworkException(String message, Throwable innerException)](#FrameworkException-java.lang.String-java.lang.Throwable-) | FrameworkException クラスの新しいインスタンスを初期化します。 |
## メソッド
