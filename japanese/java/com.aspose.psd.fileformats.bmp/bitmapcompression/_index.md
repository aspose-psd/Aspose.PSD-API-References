...
type: docs
weight: 10
url: /ja/java/com.aspose.psd.fileformats.bmp/bitmapcompression/
---
...
| フィールド | 説明 |
| --- | --- |
| [AlphaBitfields](#AlphaBitfields) | RGBA ビットフィールド。 |
| [Bitfields](#Bitfields) | RGB ビットフィールド。 |
| [Dxt1](#Dxt1) | DXT1 圧縮。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Jpeg](#Jpeg) | JPEG 圧縮。 |
| [Png](#Png) | PNG 圧縮。 |
| [Rgb](#Rgb) | 圧縮なし。 |
| [Rle4](#Rle4) | RLE 4ビット/ピクセル 圧縮。 |
| [Rle8](#Rle8) | RLE 8ビット/ピクセル 圧縮。 |
## メソッド
...
RGBA ビットフィールド。16 および 32 ビット/ピクセルのビットマップでのみ使用できます。
...
RGB ビットフィールド。16 および 32 ビット/ピクセルのビットマップでのみ使用できます。
...
JPEG 圧縮。ビットマップに JPEG 画像が含まれています。
...
RLE 4ビット/ピクセル 圧縮。4 ビット/ピクセルのビットマップでのみ使用できます。
...
RLE 8ビット/ピクセル 圧縮。8 ビット/ピクセルのビットマップでのみ使用できます。
