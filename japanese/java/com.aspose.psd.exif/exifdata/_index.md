...
description: "EXIF データコンテナです。"
type: docs
weight: 10
url: /ja/java/com.aspose.psd.exif/exifdata/
---
...
| Constructor | 説明 |
| --- | --- |
| [ExifData()](#ExifData--) | ExifDataクラスの新しいインスタンスを初期化します。 |
| [ExifData(TiffDataType[] exifdata)](#ExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | 配列からデータを使用してExifDataクラスの新しいインスタンスを初期化します。 |
| [ExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#ExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | 配列からデータを使用してExifDataクラスの新しいインスタンスを初期化します。 |
## メソッド
...
配列からデータを使用してExifDataクラスの新しいインスタンスを初期化します。
