...
description: "ジェネリック型結果を持つ非同期タスク用の長時間操作デリゲートです。"
type: docs
weight: 12
url: /ja/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
ジェネリック型結果を持つ非同期タスク用の長時間操作デリゲートです。
## Constructors
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | ジェネリック型結果を持つ非同期タスク用の長時間操作デリゲートです。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| コールバック | com.aspose.ms.System.AsyncCallback |  |
| 状態 | java.lang.Object |  |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| 結果 | com.aspose.ms.System.IAsyncResult |  |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | 非同期タスクの状態。 |

**Returns:**
java.lang.Object - 長時間操作の結果。
### notify() {#notify--}
```
