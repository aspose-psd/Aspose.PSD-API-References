---
title: "JpegExifData クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.psd.exif/jpegexifdata/
---
...
| **Name** | **説明** |
| :- | :- |
| [JpegExifData()](#JpegExifData__1) | 新しい [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) クラスのインスタンスを初期化します。 |
| [JpegExifData(common_tags, exif_tags, gps_tags)](#JpegExifData_common_tags_exif_tags_gps_tags_2) | 配列からのデータを使用して、新しい [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) クラスのインスタンスを初期化します。 |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_3) | 配列からのデータを使用して、新しい [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
| MAX_EXIF_SEGMENT_SIZE [static] | int | r | 許容される最大EXIFセグメントサイズ（バイト単位）です。 |
...
| compression | ushort | r/w | 圧縮を取得または設定します。 |
...
| date_time | string | r/w | 日時を取得または設定します。 |
...
| make | string | r/w | 録音機器のメーカーを取得または設定します。 |
...
| model | string | r/w | モデルを取得または設定します。 |
| oecf | byte | r/w | ISO 14524で規定された光電変換関数（OECF）を取得または設定します。 |
| orientation | [ExifOrientation](/psd/python-net/aspose.psd.exif.enums/exiforientation/) | r/w | 向きを取得または設定します。 |
| photographic_sensitivity | uint | r/w | 写真感度を取得または設定します。 |
| photometric_interpretation | ushort | r/w | フォトメトリック解釈を取得または設定します。 |
| pixel_x_dimension | uint | r/w | ピクセルのX寸法を取得または設定します。 |
| pixel_y_dimension | uint | r/w | ピクセルのY寸法を取得または設定します。 |
| planar_configuration | ushort | r/w | 平面構成を取得または設定します。 |
| primary_chromaticities | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | 画像の3つの基本色の色度を取得または設定します。 |
...
| reference_black_white | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | 基準の黒と白を取得または設定します。 |
| related_sound_file | string | r/w | 関連するサウンドファイルを取得または設定します。 |
| resolution_unit | [ExifUnit](/psd/python-net/aspose.psd.exif.enums/exifunit/) | r/w | 解像度単位を取得または設定します。 |
| samples_per_pixel | ushort | r/w | ピクセルあたりのサンプル数を取得または設定します。 |
...
| ソフトウェア | string | r/w | ソフトウェアを取得または設定します。 |
...
| thumbnail | [RasterImage](/psd/python-net/aspose.psd/rasterimage) | r/w | サムネイル画像を取得または設定します。 |
| transfer_function | ushort | r/w | 転送関数を取得または設定します。 |
...
| x_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | x 解像度を取得または設定します。 |
| y_cb_cr_coefficients | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | RGB から YCbCr 画像データへの変換のための行列係数を取得または設定します。 |
| y_cb_cr_positioning | [ExifYCbCrPositioning](/psd/python-net/aspose.psd.exif.enums/exifycbcrpositioning/) | r/w | 輝度成分に対する色差成分の位置を取得または設定します。 |
| y_cb_cr_sub_sampling | ushort | r/w | 輝度成分に対する色差成分のサンプリング比率を取得または設定します。 |
| y_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | y 解像度を取得または設定します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
| [remove_tag(tag)](#remove_tag_tag_1) | コンテナからタグを削除する |
| [remove_tag(tag_id)](#remove_tag_tag_id_2) | コンテナからタグを削除する |
| [serialize_exif_data()](#serialize_exif_data__3) | EXIF データをシリアライズします。タグの値と内容を書き込みます。サイズに最も影響するタグはサムネイルタグの内容です。 |
...
新しい [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) クラスのインスタンスを初期化します。
...
配列からのデータを使用して、新しい [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) クラスのインスタンスを初期化します。
