---
title: "RectangleShape クラス"
type: docs
weight: 80
url: /ja/python-net/aspose.psd.shapes/rectangleshape/
---
...
| **Name** | **説明** |
| :- | :- |
| [RectangleShape()](#RectangleShape__1) | 新しい [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/) クラスのインスタンスを初期化します。 |
| [RectangleShape(rectangle)](#RectangleShape_rectangle_2) | 新しい [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
新しい [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/) クラスのインスタンスを初期化します。
