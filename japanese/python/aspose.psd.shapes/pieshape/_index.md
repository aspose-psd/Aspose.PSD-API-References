...
type: docs
weight: 50
url: /ja/python-net/aspose.psd.shapes/pieshape/
---
...
| **Name** | **説明** |
| :- | :- |
| [PieShape()](#PieShape__1) | 新しい [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/) クラスのインスタンスを初期化します。 |
| [PieShape(rectangle, start_angle, sweep_angle)](#PieShape_rectangle_start_angle_sweep_angle_2) | 新しい [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
新しい [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/) クラスのインスタンスを初期化します。
