---
title: "EllipseShape クラス"
type: docs
weight: 40
url: /ja/python-net/aspose.psd.shapes/ellipseshape/
---
...
| **Name** | **説明** |
| :- | :- |
| [EllipseShape()](#EllipseShape__1) | 新しい [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) クラスのインスタンスを初期化します。 |
| [EllipseShape(rectangle)](#EllipseShape_rectangle_2) | 新しい [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
新しい [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) クラスのインスタンスを初期化します。
