---
title: "ExposureLayer クラス"
type: docs
weight: 100
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| 破棄済み | bool | r |  |
| exposure | float | r/w | Exposure を取得または設定します。PS の Exposure の範囲は -20 から +20 です。 |
| extra_length | int | r |  |
...
| gamma_correction | float | r/w | GammaCorrection を取得または設定します。PS の GammaCorrection の範囲は 9.99 から +0.01 です。 |
| has_alpha | bool | r |  |
...
| offset | float | r/w | Offset を取得または設定します。PS の Offset の範囲は -0.5 から +0.5 です。 |
| opacity | byte | r/w |  |
