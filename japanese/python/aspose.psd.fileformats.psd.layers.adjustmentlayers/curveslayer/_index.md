---
title: "CurvesLayer クラス"
type: docs
weight: 90
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | r/w | このインスタンスが continuous manager として使用されているかどうかを示す値を取得または設定します。 |
| is_discrete_manager_used | bool | r/w | このインスタンスが discrete manager として使用されているかどうかを示す値を取得または設定します。 |
...
| [get_curves_manager()](#get_curves_manager__8) | curves manager を取得します。 |
