---
title: "ChannelMixerLayer クラス"
type: docs
weight: 40
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | チャネルのインデックスを取得します。RgbMixerChannel または CmykMixerChannel を返すことがあります。 |
...
チャネルのインデックスを取得します。RgbMixerChannel または CmykMixerChannel を返すことがあります。
