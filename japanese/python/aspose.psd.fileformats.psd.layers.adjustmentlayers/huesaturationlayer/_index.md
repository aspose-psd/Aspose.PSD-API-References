---
title: "HueSaturationLayer クラス"
type: docs
weight: 120
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | byte | r/w |  |
| colorize | bool | r/w | この [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) がカラー化されているかどうかを示す値を取得または設定します。 |
...
| [get_range(index)](#get_range_index_20) | 範囲を取得します。 |
...
| タイプ | 説明 |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | カラー範囲 Hsl |
