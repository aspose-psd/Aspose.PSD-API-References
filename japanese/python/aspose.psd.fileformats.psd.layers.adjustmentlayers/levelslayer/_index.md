---
title: "LevelsLayer クラス"
type: docs
weight: 140
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| 左 | int | r/w |  |
| 長さを取得または設定します。 | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | マスターチャネルを取得します。 |
...
| [get_channel(index)](#get_channel_index_8) | チャネルを取得します。 |
...
| タイプ | 説明 |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) をインデックスで取得します。 |
