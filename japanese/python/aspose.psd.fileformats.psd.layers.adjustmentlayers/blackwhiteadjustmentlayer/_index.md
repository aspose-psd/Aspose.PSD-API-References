---
title: "BlackWhiteAdjustmentLayer クラス"
type: docs
weight: 20
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Tint Color の値を取得または設定します。 |
| tint_color_blue | double | r/w | Blue Tint Color の double 値を取得または設定します。 |
| tint_color_green | double | r/w | Green Tint Color の double 値を取得または設定します。 |
| tint_color_red | double | r/w | Red Tint Color の double 値を取得または設定します。 |
| top | int | r/w |  |
