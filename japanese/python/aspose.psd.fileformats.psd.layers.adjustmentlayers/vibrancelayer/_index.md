---
title: "VibranceLayer クラス"
type: docs
weight: 220
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
| 右 | int | r/w |  |
| saturation | int | r/w | saturation を取得または設定します。 |
...
| vibrance | int | r/w | vibrance を取得または設定します。 |
