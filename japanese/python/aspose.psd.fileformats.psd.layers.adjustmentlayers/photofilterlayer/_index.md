---
title: "PhotoFilterLayer クラス"
type: docs
weight: 160
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| clipping | byte | r/w |  |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | フィルタの RGB カラーを取得または設定します。 |
...
| density | int | r/w | フィルタの密度を取得または設定します |
