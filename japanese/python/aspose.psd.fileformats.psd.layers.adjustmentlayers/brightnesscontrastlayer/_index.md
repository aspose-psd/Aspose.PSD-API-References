---
title: "BrightnessContrastLayer クラス"
type: docs
weight: 30
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| 明るさを取得または設定します。<br/>            推奨範囲 1 - 1.5<br/>            デフォルト値 = 1.15 | int | r/w | brightness を取得または設定します。PS の brightness の範囲は -150 から +150 です。ただし、これは無視します。 |
...
| コントラスト | int | r/w | contrast を取得または設定します。PS の contrast の範囲は -50 から +100 です。ただし、これは無視します。 |
