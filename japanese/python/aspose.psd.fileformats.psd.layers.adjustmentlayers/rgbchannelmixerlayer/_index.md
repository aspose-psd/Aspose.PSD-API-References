---
title: "RgbChannelMixerLayer クラス"
type: docs
weight: 180
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 青チャンネルを取得します。 |
| bottom | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 緑チャンネルを取得します。 |
| has_alpha | bool | r |  |
...
| raw_line_size | int | r |  |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 赤チャンネルを取得します。 |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | チャンネルのインデックスを取得します。戻り値は RgbMixerChannel です。 |
...
チャンネルのインデックスを取得します。戻り値は RgbMixerChannel です。
