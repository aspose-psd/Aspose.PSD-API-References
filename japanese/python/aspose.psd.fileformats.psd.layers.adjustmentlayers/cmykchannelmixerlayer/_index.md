---
title: "CmykChannelMixerLayer クラス"
type: docs
weight: 50
url: /ja/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 黒チャネルを取得します。 |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | シアンチャネルを取得します。 |
...
| 左 | int | r/w |  |
| 長さを取得または設定します。 | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | マゼンタチャネルを取得します。 |
| monochrome | bool | r/w | この [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) がモノクロかどうかを示す値を取得または設定します。 |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | イエローチャネルを取得します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | チャネルのインデックスを取得します。CmykMixerChannel を返します。 |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | 指定されたレイヤーにレイヤーをマージします |
| normalize_angle() |  |
...
チャネルのインデックスを取得します。CmykMixerChannel を返します。
