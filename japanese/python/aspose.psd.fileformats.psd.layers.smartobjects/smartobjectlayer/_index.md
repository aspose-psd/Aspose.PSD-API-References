---
title: "SmartObjectLayer クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
| **Name** | **説明** |
| :- | :- |
| [SmartObjectLayer(stream)](#SmartObjectLayer_stream_1) | 新しい [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| content_type | [SmartObjectType](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype) | r | スマートオブジェクトレイヤーコンテンツのタイプを取得します。<br/>            埋め込みスマートオブジェクトのコンテンツは埋め込み生画像ファイルです: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/)。<br/>            リンクされたスマートオブジェクトのコンテンツは、利用可能な場合はリンク画像ファイルの生データです: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/)。<br/>            [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) が true の場合、Adobe® Photoshop® の Graphics Library からの読み込みはサポートしていません。<br/>            通常のリンクファイルの場合、まず [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) を使用して、ソース画像パス [None](/psd/python-net/aspose.psd/datastreamsupporter/) から相対的にファイルを検索します。<br/>            利用できない場合は [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) を確認し、<br/>            それでも見つからない場合は、画像と同じディレクトリにあるリンクファイルを探します: [None](/psd/python-net/aspose.psd/datastreamsupporter/)。 |
| contents | byte | r/w | スマートオブジェクトレイヤーのコンテンツを取得または設定します。<br/>            埋め込みスマートオブジェクトのコンテンツは埋め込み生画像ファイルとそのプロパティです: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/)。<br/>            リンクされたスマートオブジェクトのコンテンツは、利用可能な場合はリンク画像ファイルの生データとそのプロパティです: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/)。<br/>            [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) が true の場合、Adobe® Photoshop® の Graphics Library からの読み込みはサポートしていません。<br/>            通常のリンクファイルの場合、まず [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) を使用して、ソース画像パス [None](/psd/python-net/aspose.psd/datastreamsupporter/) から相対的にファイルを検索します。<br/>            利用できない場合は [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) を確認し、<br/>            それでも見つからない場合は、画像と同じディレクトリにあるリンクファイルを探します: [None](/psd/python-net/aspose.psd/datastreamsupporter/)。 |
| contents_bounds | [Rectangle](/psd/python-net/aspose.psd/rectangle) | r/w | スマートオブジェクトコンテンツの境界を取得または設定します。 |
| contents_source | [LinkDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) | r/w | スマートオブジェクトコンテンツのソースを取得または設定します。 |
...
| 左 | int | r/w |  |
| 長さを取得または設定します。 | int | r |  |
| name | string | r/w | テキストレイヤーの名前を取得または設定します。 |
| opacity | byte | r/w |  |
...
| smart_filters | [SmartFilters](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/smartfilters/) | r | スマートフィルターを取得します。 |
...
| warp_settings | [WarpSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.warp/warpsettings/) | r/w | リソースから設定または取得された Warp パラメータを取得または設定します（デフォルト）。 |
...
| [convert_to_linked(linked_path)](#convert_to_linked_linked_path_6) | この埋め込みスマートオブジェクトをリンクされたスマートオブジェクトに変換します。 |
...
| [duplicate_layer()](#duplicate_layer__8) | このレイヤーをコピーして新しいスマートオブジェクトレイヤーを作成します。<br/>            埋め込みスマートオブジェクトの場合、埋め込み画像は共有されていることに注意してください。<br/>            埋め込み画像をコピーしたい場合は、[SmartObjectLayer.new_smart_object_via_copy()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) メソッドを使用してください。 |
| embed_linked() | このレイヤーにリンクされたスマートオブジェクトを埋め込みます。 |
| [export_contents(file_path)](#export_contents_file_path_9) | 埋め込まれたまたはリンクされたコンテンツをファイルにエクスポートします。 |
...
| [load_contents(options)](#load_contents_options_32) | スマートオブジェクトレイヤーの埋め込まれたまたはリンクされた画像コンテンツを取得します。 |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_33) | 32ビット ARGB ピクセルを部分的に（ブロック単位で）ロードします。 |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_34) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_35) | 生データをロードします。 |
| merge_layer_to(layer_to_merge_into) |  |
| [new_smart_object_via_copy()](#new_smart_object_via_copy__36) | このレイヤーをコピーして新しいスマートオブジェクトレイヤーを作成します。<br/>            Adobe Photoshop の `Layer -> Smart Objects -> New Smart Object via Copy` 機能を再現します。<br/>            埋め込みスマートオブジェクトに対してのみ有効です。埋め込み画像もコピーされるためです。<br/>            埋め込み画像を共有したい場合は、[SmartObjectLayer.duplicate_layer()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) メソッドを使用してください。 |
| normalize_angle() |  |
...
| [relink_to_file(linked_path)](#relink_to_file_linked_path_39) | リンクされたスマートオブジェクトを新しいファイルに再リンクします。<br/>            その後、UpdateModifiedContent メソッドを呼び出す必要はありません。 |
| replace_color(old_color, old_color_diff, new_color) |  |
| replace_color(old_color_argb, old_color_diff, new_color_argb) |  |
| [replace_contents(image)](#replace_contents_image_40) | スマートオブジェクトレイヤーに埋め込まれたスマートオブジェクトのコンテンツを置き換えます。 |
| [replace_contents(image, resolution)](#replace_contents_image_resolution_41) | スマートオブジェクトレイヤーに埋め込まれたスマートオブジェクトのコンテンツを置き換えます。 |
| [replace_contents(linked_path)](#replace_contents_linked_path_42) | コンテンツをファイルで置き換えます。<br/>            その後、UpdateModifiedContent メソッドを呼び出す必要はありません。 |
| [replace_contents(linked_path, resolution)](#replace_contents_linked_path_resolution_43) | コンテンツをファイルで置き換えます。<br/>            その後、UpdateModifiedContent メソッドを呼び出す必要はありません。 |
...
| update_modified_content() | 変更されたコンテンツでスマートオブジェクトレイヤーの画像キャッシュを更新します。 |
...
新しい [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) クラスのインスタンスを初期化します。

**Parameters:**

| パラメーター | タイプ | 説明 |
| :- | :- | :- |
| ストリーム | _io.BufferedRandom | アイテムのストリーム |
...
このレイヤーをコピーして新しいスマートオブジェクトレイヤーを作成します。<br/>            埋め込みスマートオブジェクトの場合、埋め込み画像は共有されていることに注意してください。<br/>            埋め込み画像をコピーしたい場合は、[SmartObjectLayer.new_smart_object_via_copy()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) メソッドを使用してください。
...
埋め込まれたまたはリンクされたコンテンツをファイルにエクスポートします。

**Parameters:**

| パラメーター | タイプ | 説明 |
| :- | :- | :- |
| file_path | string | エクスポートファイルのパス。 |
...
スマートオブジェクトレイヤーの埋め込まれたまたはリンクされた画像コンテンツを取得します。

**Parameters:**

| パラメーター | タイプ | 説明 |
| :- | :- | :- |
| options | [LoadOptions](/psd/python-net/aspose.psd/loadoptions) | オプション。 |

**Returns**

| タイプ | 説明 |
| :- | :- |
| [Image](/psd/python-net/aspose.psd/image) | 読み込まれた [Image](/psd/python-net/aspose.psd/image/) スマートオブジェクト インスタンス。 |
...
このレイヤーをコピーして新しいスマートオブジェクトレイヤーを作成します。<br/>            Adobe Photoshop の `Layer -> Smart Objects -> New Smart Object via Copy` 機能を再現します。<br/>            埋め込みスマートオブジェクトに対してのみ有効です。埋め込み画像もコピーされるためです。<br/>            埋め込み画像を共有したい場合は、[SmartObjectLayer.duplicate_layer()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) メソッドを使用してください。
...
リンクされたスマートオブジェクトを新しいファイルに再リンクします。<br/>            その後、UpdateModifiedContent メソッドを呼び出す必要はありません。
...
| パラメーター | タイプ | 説明 |
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | 画像。 |
...
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | 画像。 |
| resolution | [ResolutionSetting](/psd/python-net/aspose.psd/resolutionsetting) | 解像度設定です。null の場合は画像の解像度が使用されます。 |
...
コンテンツをファイルで置き換えます。<br/>            その後、UpdateModifiedContent メソッドを呼び出す必要はありません。
