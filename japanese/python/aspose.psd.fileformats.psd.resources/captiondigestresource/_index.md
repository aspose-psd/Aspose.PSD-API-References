---
title: "CaptionDigestResource クラス"
type: docs
weight: 40
url: /ja/python-net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [CaptionDigestResource()](#CaptionDigestResource__1) | CaptionDigestResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| ダイジェスト | byte | r/w | ダイジェストを取得または設定します。 |
...
CaptionDigestResource クラスの新しいインスタンスを初期化します
