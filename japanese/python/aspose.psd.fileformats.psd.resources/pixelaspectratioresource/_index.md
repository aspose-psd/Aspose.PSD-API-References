...
type: docs
weight: 190
url: /ja/python-net/aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource__1) | PixelAspectRatioResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| aspect_ratio | double | r/w | アスペクト比を取得または設定します。 |
...
PixelAspectRatioResource クラスの新しいインスタンスを初期化します
