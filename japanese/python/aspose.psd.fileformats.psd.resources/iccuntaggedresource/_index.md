---
title: "IccUntaggedResource クラス"
type: docs
weight: 140
url: /ja/python-net/aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [IccUntaggedResource()](#IccUntaggedResource__1) | IccUntaggedResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| profile | byte | r/w | プロファイルを取得または設定します。 |
...
IccUntaggedResource クラスの新しいインスタンスを初期化します
