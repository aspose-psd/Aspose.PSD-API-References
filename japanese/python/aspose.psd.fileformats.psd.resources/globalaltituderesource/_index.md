---
title: "GlobalAltitudeResource クラス"
type: docs
weight: 90
url: /ja/python-net/aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| **Name** | **説明** |
| :- | :- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource__1) | GlobalAltitudeResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| altitude | int | r/w | 高度を取得または設定します。 |
...
GlobalAltitudeResource クラスの新しいインスタンスを初期化します
