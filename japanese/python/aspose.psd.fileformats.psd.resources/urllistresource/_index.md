---
title: "UrlListResource クラス"
type: docs
weight: 290
url: /ja/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | UrlListResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| count | int | r/w | カウントを取得または設定します。 |
| data_size | int | r | リソースデータサイズ（バイト）を取得します。 |
| id | short | r/w | リソースの一意の識別子を取得または設定します。 |
| ids | int | r/w | ID を取得または設定します。 |
| longs | int | r/w | long 値を取得または設定します。 |
...
| texts | string | r/w | テキストを取得または設定します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
UrlListResource クラスの新しいインスタンスを初期化します
