---
title: "UnicodeAlphaNamesResource クラス"
type: docs
weight: 270
url: /ja/python-net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource__1) | UnicodeAlphaNamesResource クラスの新しいインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| alpha_names | string | r/w | アルファ名を取得または設定します。 |
...
UnicodeAlphaNamesResource クラスの新しいインスタンスを初期化します。
