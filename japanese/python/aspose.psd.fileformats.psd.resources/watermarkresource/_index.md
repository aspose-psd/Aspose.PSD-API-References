...
type: docs
weight: 310
url: /ja/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | WatermarkResource クラスの新しいインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| is_watermark | bool | r/w | このインスタンスが透かしかどうかを示す値を取得または設定します。 |
...
WatermarkResource クラスの新しいインスタンスを初期化します。
