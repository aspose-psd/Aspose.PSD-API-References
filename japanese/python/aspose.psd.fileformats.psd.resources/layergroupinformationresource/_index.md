---
title: "LayerGroupInformationResource クラス"
type: docs
weight: 150
url: /ja/python-net/aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource__1) | LayerGroupInformationResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| groups | short | r/w | グループを取得または設定します。 |
...
LayerGroupInformationResource クラスの新しいインスタンスを初期化します
