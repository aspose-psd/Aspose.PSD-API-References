...
type: docs
weight: 230
url: /ja/python-net/aspose.psd.fileformats.psd.resources/resolutioninforesource/
---
...
| **Name** | **説明** |
| :- | :- |
| [ResolutionInfoResource()](#ResolutionInfoResource__1) | ResolutionInfoResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| h_res_display_unit | [ResolutionUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/resolutionunit/) | r/w | 水平解像度の表示単位です。  これは<br/>            ユーザーインターフェイスにのみ影響します。解像度は PSD ファイルに<br/>            ピクセル/インチとして保存されたままです。 |
| height_display_unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | 高さの表示単位を取得または設定します。 |
...
| v_res_display_unit | [ResolutionUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/resolutionunit/) | r/w | 垂直解像度の表示単位です。 |
| width_display_unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | 幅の表示単位を取得または設定します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
ResolutionInfoResource クラスの新しいインスタンスを初期化します
