---
title: "ColorTransferFunctionsResource クラス"
type: docs
weight: 60
url: /ja/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | ColorTransferFunctionsResource クラスの新しいインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| color_transfer_data | byte | r/w | カラー転送データを取得または設定します。 |
...
ColorTransferFunctionsResource クラスの新しいインスタンスを初期化します。
