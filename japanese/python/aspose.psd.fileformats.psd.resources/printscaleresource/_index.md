---
title: "PrintScaleResource クラス"
type: docs
weight: 210
url: /ja/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | PrintScaleResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| scale | float | r/w | スケールを取得または設定します。 |
| signature | int | r | リソース署名を取得します。常に '8BIM' である必要があります。 |
| サイズ | int | r | データを含むリソースブロックのサイズ（バイト）を取得します。 |
| style | short | r/w | スタイルを取得または設定します。 |
| x_location | float | r/w | x 位置を取得または設定します。 |
| y_location | float | r/w | y 位置を取得または設定します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
PrintScaleResource クラスの新しいインスタンスを初期化します
