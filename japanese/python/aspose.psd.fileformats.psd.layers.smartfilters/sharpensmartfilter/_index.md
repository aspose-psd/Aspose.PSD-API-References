---
title: "SharpenSmartFilter クラス"
type: docs
weight: 40
url: /ja/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/
---
...
| **Name** | **説明** |
| :- | :- |
| [SharpenSmartFilter()](#SharpenSmartFilter__1) | 新しい [SharpenSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/) クラスのインスタンスを初期化します。 |
| [SharpenSmartFilter(source_descriptor)](#SharpenSmartFilter_source_descriptor_2) | 新しい [SharpenSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
新しい [SharpenSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/) クラスのインスタンスを初期化します。
...
| パラメーター | タイプ | 説明 |
| :- | :- | :- |
| source_descriptor | [DescriptorStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure/) | スマートフィルタ情報を含む記述子構造体です。 |
