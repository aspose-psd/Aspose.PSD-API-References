...
type: docs
weight: 20
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| **Name** | **説明** |
| :- | :- |
| [BooleanStructure(key_name)](#BooleanStructure_key_name_1) | 新しい [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| 値 | bool | r/w | boolean 値を取得または設定します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
新しい [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/) クラスのインスタンスを初期化します。
