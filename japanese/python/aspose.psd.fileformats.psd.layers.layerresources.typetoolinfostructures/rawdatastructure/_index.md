---
title: "RawDataStructure クラス"
type: docs
weight: 140
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/
---
...
| **Name** | **説明** |
| :- | :- |
| [RawDataStructure(key_name)](#RawDataStructure_key_name_1) | 新しいインスタンスを初期化します [RawDataStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/) クラス。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
新しいインスタンスを初期化します [RawDataStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/) クラス。
