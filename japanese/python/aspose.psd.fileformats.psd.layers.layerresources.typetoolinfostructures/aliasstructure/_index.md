---
title: "AliasStructure クラス"
type: docs
weight: 10
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **説明** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | 新しい [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | 構造キーを識別します。 |
| data_length | int | r | バイト単位で正確なデータ長を取得します。 |
| full_path | string | r/w | 完全パスを取得または設定します。 |
...
新しい [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) クラスのインスタンスを初期化します。
