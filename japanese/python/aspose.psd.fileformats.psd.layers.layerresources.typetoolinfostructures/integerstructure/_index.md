---
title: "IntegerStructure クラス"
type: docs
weight: 80
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **説明** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | 新しい [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | 整数構造のキーです。 |
| key | int | r | キーを取得します。 |
...
新しい [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/) クラスのインスタンスを初期化します。
