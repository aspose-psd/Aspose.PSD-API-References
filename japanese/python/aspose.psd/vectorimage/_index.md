---
title: "VectorImage クラス"
type: docs
weight: 4700
url: /ja/python-net/aspose.psd/vectorimage/
---
...
| height_f | float | r | オブジェクトの高さ（インチ）を取得します。 |
...
| size_f | [SizeF](/psd/python-net/aspose.psd/sizef) | r | オブジェクトのサイズ（インチ）を取得します。 |
| use_palette | bool | r | 画像パレットが使用されているかどうかを示す値を取得します。 |
| width | int | r | 画像の幅を取得します。 |
| width_f | float | r | オブジェクトの幅（インチ）を取得します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
| [get_default_options(args)](#get_default_options_args_7) | デフォルトのオプションを取得します。 |
| [get_file_format(file_path)](#get_file_format_file_path_8) | ファイル形式を取得します。 |
| [get_file_format(stream)](#get_file_format_stream_9) | ファイル形式を取得します。 |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_10) | 現在の画像に適合する矩形を取得します。 |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_11) | 現在の画像に適合する矩形を取得します。 |
...
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_13) | 比例した高さを取得します。 |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_14) | 比例した幅を取得します。 |
| [load(file_path)](#load_file_path_15) | 指定されたファイルから新しい画像をロードします。 |
| [load(file_path, load_options)](#load_file_path_load_options_16) | 指定されたファイルから新しい画像をロードします。 |
| [load(stream)](#load_stream_17) | 指定されたストリームから新しい画像をロードします。 |
| [load(stream, load_options)](#load_stream_load_options_18) | 指定されたストリームから新しい画像をロードします。 |
| [resize(new_width, new_height)](#resize_new_width_new_height_19) | 画像のサイズを変更します。デフォルトの [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/) が使用されます。 |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_20) | 画像のサイズを変更します。 |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_21) | 画像のサイズを変更します。 |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_22) | 高さを比例的にリサイズします。 |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_23) | 高さを比例的にリサイズします。 |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_24) | 高さを比例的にリサイズします。 |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_25) | 幅を比例的にリサイズします。デフォルトの [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/) が使用されます。 |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_26) | 幅を比例的にリサイズします。 |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_27) | 幅を比例的にリサイズします。 |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_28) | 画像を回転、反転、または回転と反転を行います。 |
| save() | 画像データを基になるストリームに保存します。 |
| [save(file_path)](#save_file_path_29) | オブジェクトのデータを指定されたファイル位置に保存します。 |
| [save(file_path, options)](#save_file_path_options_30) | 保存オプションに従って、指定されたファイル形式でオブジェクトのデータを指定されたファイル位置に保存します。 |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_31) | 保存オプションに従って、指定されたファイル形式でオブジェクトのデータを指定されたファイル位置に保存します。 |
| [save(file_path, over_write)](#save_file_path_over_write_32) | オブジェクトのデータを指定されたファイル位置に保存します。 |
| [save(stream)](#save_stream_33) | オブジェクトのデータを指定されたストリームに保存します。 |
| [save(stream, options_base)](#save_stream_options_base_34) | 保存オプションに従って、指定されたファイル形式で画像のデータを指定されたストリームに保存します。 |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_35) | 保存オプションに従って、指定されたファイル形式で画像のデータを指定されたストリームに保存します。 |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_36) | 画像のパレットを設定します。 |
