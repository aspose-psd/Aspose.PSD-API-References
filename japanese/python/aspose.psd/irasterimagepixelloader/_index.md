---
title: "IRasterImagePixelLoader クラス"
type: docs
weight: 2010
url: /ja/python-net/aspose.psd/irasterimagepixelloader/
---
...
| **Name** | **説明** |
| :- | :- |
| [load_partial_pixels(rectangle, partial_pixel_loader)](#load_partial_pixels_rectangle_partial_pixel_loader_1) | ピクセルを部分的に（ブロック単位で）ロードします。 |
...
| partial_pixel_loader | [IPartialPixelLoader](/psd/python-net/aspose.psd/ipartialpixelloader) | 部分的なピクセルローダー。 |
