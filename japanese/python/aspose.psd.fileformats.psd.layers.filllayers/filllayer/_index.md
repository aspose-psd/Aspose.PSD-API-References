...
type: docs
weight: 10
url: /ja/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | 塗り設定を取得または設定します。 |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | 塗りつぶしのタイプを取得します。 |
| filler | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | 塗りタイプに基づいて [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) クラスの新しいインスタンスを作成します。 |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_30) | 32ビット ARGB ピクセルを部分的に（ブロック単位で）ロードします。 |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_31) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_32) | 生データをロードします。 |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | すべての非透過色を新しい色に置き換え、元のアルファ値を保持して滑らかなエッジを保存します。<br/>            注: 透過性のない画像に使用すると、すべての色が単一の色に置き換えられます。 |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_36) | すべての非透過色を新しい色に置き換え、元のアルファ値を保持して滑らかなエッジを保存します。<br/>            注: 透過性のない画像に使用すると、すべての色が単一の色に置き換えられます。 |
...
| update() | 現在の [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) に基づいて、塗りレイヤーのピクセルデータを更新します。 |
...
塗りタイプに基づいて [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) クラスの新しいインスタンスを作成します。

**Parameters:**

| パラメーター | タイプ | 説明 |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | 塗りレイヤーのタイプです。 |

**Returns**

| タイプ | 説明 |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | 塗りタイプに基づいて、[FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) クラスの新しいインスタンスを返します。 |
