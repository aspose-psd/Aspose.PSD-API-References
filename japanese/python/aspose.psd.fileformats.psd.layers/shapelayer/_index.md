---
title: "ShapeLayer クラス"
type: docs
weight: 1600
url: /ja/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **説明** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | 新しい [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) クラスのインスタンスを初期化します。<br/>            すべてのリソースはデフォルト状態で作成されます。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Shape レイヤー内のシェイプの内部領域の Fill 設定を取得または設定します。 |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Shape レイヤーに存在するパスの集合を取得します。 |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | シェイプの Stroke 設定を取得または設定します。 |
| top | int | r/w |  |
...
| [create_instance()](#create_instance__7) | 新しい [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) クラスのインスタンスを作成します。 |
...
| update() | Shapeレイヤーのプロパティからリソースを更新します。 |
...
新しい [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) クラスのインスタンスを初期化します。<br/>            すべてのリソースはデフォルト状態で作成されます。
...
新しい [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) クラスのインスタンスを作成します。

**Returns**

| タイプ | 説明 |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | 新しいインスタンスの [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) クラスを返します。 |
