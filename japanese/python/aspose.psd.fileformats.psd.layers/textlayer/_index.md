...
type: docs
weight: 1750
url: /ja/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | フォントを取得します。 |
| has_alpha | bool | r |  |
...
| inner_text | string | r | レイヤーのテキストを取得します |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | テキストのバウンドボックスを取得または設定します。 |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | テキストの色を取得します。 |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | テキストの部分を取得します。 |
| top | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | テキストレイヤーのフォントセットを取得します。 |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | 画像のサイズを変更します。デフォルトの[ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/)が使用されます。 |
...
| [update_text(text)](#update_text_text_38) | テキストを更新します。 |
| [update_text(text, color)](#update_text_text_color_39) | テキストを更新します。 |
| [update_text(text, font_size)](#update_text_text_font_size_40) | テキストを更新します。 |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | テキストを更新します。 |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | テキストを更新します。 |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | テキストを更新します。 |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | テキストを更新します。 |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | テキストを更新します。 |
...
| タイプ | 説明 |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | テキストレイヤーのフォントセット。 |
...
画像のサイズを変更します。デフォルトの[ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/)が使用されます。
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | リサイズ変換のタイプ [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | テキスト値。 |
| color | [Color](/psd/python-net/aspose.psd/color) | 色の値。 |
...
| :- | :- | :- |
| text | string | テキスト値。 |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | 左上座標。 |
