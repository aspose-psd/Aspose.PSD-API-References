---
title: "ArtboardLayer クラス"
type: docs
weight: 90
url: /ja/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | アートボードの背景色を取得または設定します。 |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | 取得または設定します。背景色があるかどうかを示す値を [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) が持ちます。 |
...
| is_cached | bool | r |  |
| is_open | bool | r/w | フォルダーが開いているかどうかを取得または設定します<br/>            <c>true</c> に設定すると、起動時にグループが開いた状態になり、そうでなければ最小化された状態になります。 |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | レイヤー グループ内のレイヤーを取得します |
| 左 | int | r/w | <inheritdoc /> |
| 長さを取得または設定します。 | int | r |  |
...
| **Name** | **説明** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | レイヤーをレイヤー グループに追加します。 |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | レイヤー グループを追加します。 |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | 32ビット ARGB ピクセルを部分的に（ブロック単位で）ロードします。 |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | 生データをロードします。 |
