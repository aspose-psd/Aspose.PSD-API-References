---
title: "Lfx2Resource クラス"
type: docs
weight: 500
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
| **Name** | **説明** |
| :- | :- |
| [Lfx2Resource()](#Lfx2Resource__1) | Lfx2Resource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| descriptor_version | int | r | ディスクリプタのバージョンを取得します。 |
...
Lfx2Resource クラスの新しいインスタンスを初期化します
