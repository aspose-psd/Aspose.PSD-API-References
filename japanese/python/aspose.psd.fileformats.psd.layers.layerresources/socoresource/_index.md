---
title: "SoCoResource クラス"
type: docs
weight: 920
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [SoCoResource()](#SoCoResource__1) | 新しい [SoCoResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | RGB カラーを取得します。 |
...
新しい [SoCoResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/) クラスのインスタンスを初期化します。
