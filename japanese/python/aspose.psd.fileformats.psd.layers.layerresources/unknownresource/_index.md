---
title: "UnknownResource クラス"
type: docs
weight: 1050
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [UnknownResource(signature, key)](#UnknownResource_signature_key_1) | 新しい [UnknownResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| signature | int | r | レイヤーリソースのシグネチャを取得します。 |
## **Methods**
| **Name** | **説明** |
| :- | :- |
...
新しい [UnknownResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/) クラスのインスタンスを初期化します。
