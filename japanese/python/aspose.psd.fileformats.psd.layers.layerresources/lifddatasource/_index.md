---
title: "LiFdDataSource クラス"
type: docs
weight: 510
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/
---
...
| **Name** | **説明** |
| :- | :- |
| [LiFdDataSource()](#LiFdDataSource__1) | 新しい [LiFdDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) クラスのインスタンスを初期化します。 |
| [LiFdDataSource(version, unique_id, original_file_name, file_type, file_creator)](#LiFdDataSource_version_unique_id_original_file_name_file_type_file_creator_2) | 新しい [LiFdDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| data | byte | r/w | PSD ファイル内の埋め込みスマートオブジェクト データを取得または設定します。 |
...
新しい [LiFdDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) クラスのインスタンスを初期化します。
