---
title: "MlstResource クラス"
type: docs
weight: 690
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [MlstResource()](#MlstResource__1) | MlstResource クラスの新しいインスタンスを初期化します |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| descriptor_version | int | r | ディスクリプタ バージョンを取得または設定します。 |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | 構造体を取得または設定します。 |
...
MlstResource クラスの新しいインスタンスを初期化します
