---
title: "PhflResourceVersion2 クラス"
type: docs
weight: 800
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/
---
...
| **Name** | **説明** |
| :- | :- |
| [PhflResourceVersion2()](#PhflResourceVersion2__1) | 新しい [PhflResourceVersion2](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/) クラスのインスタンスを初期化します。 |
| [PhflResourceVersion2(data)](#PhflResourceVersion2_data_2) | 新しい [PhflResourceVersion2](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/) クラスのインスタンスを初期化します。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
| component_a | short | r/w | 色の A コンポーネントを取得または設定します |
| component_b | short | r/w | B コンポーネントを取得または設定します |
| component_l | short | r/w | 色の L コンポーネントを取得または設定します |
...
新しい [PhflResourceVersion2](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/) クラスのインスタンスを初期化します。
