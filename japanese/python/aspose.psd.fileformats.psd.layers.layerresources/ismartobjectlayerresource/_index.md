---
title: "ISmartObjectLayerResource クラス"
type: docs
weight: 400
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/ismartobjectlayerresource/
---
...
| unique_id | Guid | r/w | PSD 画像内の配置されたレイヤー（またはスマートオブジェクト）のグローバル一意識別子を取得または設定します。 |
