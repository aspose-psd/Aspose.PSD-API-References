---
title: "VsmsResource クラス"
type: docs
weight: 1130
url: /ja/python-net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/
---
...
| **Name** | **説明** |
| :- | :- |
| [VsmsResource()](#VsmsResource__1) | 新しいインスタンスを初期化します [VsmsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/) クラス。 |
| [VsmsResource(data)](#VsmsResource_data_2) | 新しいインスタンスを初期化します [VsmsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/) クラス。 |
## **Properties**
| **Name** | **Type** | **Access** | **説明** |
| :- | :- | :- | :- |
...
新しいインスタンスを初期化します [VsmsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/) クラス。
