...
description: "LengthRecord プロパティ。 ベジエノットレコード数を取得または設定します"
type: docs
weight: 20
url: /ja/net/aspose.psd.fileformats.core.vectorpaths/lengthrecord/bezierknotrecordscount/
---
{{< psd/tize >}}
## LengthRecord.BezierKnotRecordsCount property

bezier knot レコード数を取得または設定します。
