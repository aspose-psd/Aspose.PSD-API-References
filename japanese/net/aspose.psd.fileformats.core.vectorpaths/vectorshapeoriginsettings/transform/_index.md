...
description: VectorShapeOriginSettings 財産. 変換行列を取得または設定します
type: docs
weight: 170
url: /ja/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/transform/
---
...
この例では、PSD イメージ内の Vogk およびベクトル パス リソースを使用してレイヤーのサイズを変更する方法を示します。

```csharp
[C#]

// この例では、PSD 画像の Vogk およびベクター パス リソースを使用してレイヤーのサイズを変更する方法を示します
float scaleX = 0.45f;
float scaleY = 1.60f;
