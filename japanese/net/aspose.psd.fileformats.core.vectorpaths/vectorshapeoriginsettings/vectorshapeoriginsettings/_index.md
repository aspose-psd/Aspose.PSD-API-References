...
description: "VectorShapeOriginSettings コンストラクタ。 VectorShapeOriginSettings クラスの新しいインスタンスを初期化します"
type: docs
weight: 10
url: /ja/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

[`VectorShapeOriginSettings`](../) クラスの新しいインスタンスを初期化します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| isShapeInvalidated | Boolean | シェイプが無効化されたことを示す値です。 |
| originIndex | Int32 | シェイプの原点インデックスです。 |
