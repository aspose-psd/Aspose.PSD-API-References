---
title: "クラス VectorShapeTransform"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform クラス。ベクトル形状変換行列クラスを定義します"
type: docs
weight: 1470
url: /ja/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/
---
{{< psd/tize >}}
## VectorShapeTransform class

ベクトル形状の変換行列クラスを定義します
...
| 名前 | 説明 |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | `VectorShapeTransform` クラスの新しいインスタンスを初期化します。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Tx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/tx/) { get; set; } | TX 値を取得または設定します。 |
| [Ty](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/ty/) { get; set; } | TY 値を取得または設定します。 |
| [Xx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx/) { get; set; } | XX 値を取得または設定します。 |
| [Xy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy/) { get; set; } | XY 値を取得または設定します。 |
| [Yx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yx/) { get; set; } | YX 値を取得または設定します。 |
| [Yy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yy/) { get; set; } | YY 値を取得または設定します。 |
