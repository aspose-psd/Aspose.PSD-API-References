...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform クラス. ベクトル形状変換行列を定義します class
type: docs
weight: 1460
...
| 名前 | 説明 |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | の新しいインスタンスを初期化します`VectorShapeTransform`class. |
