...
description: BezierKnotRecord コンストラクタ. の新しいインスタンスを初期化しますBezierKnotRecordclass.
type: docs
weight: 10
url: /ja/net/aspose.psd.fileformats.core.vectorpaths/bezierknotrecord/bezierknotrecord/
---
## BezierKnotRecord() {#constructor}

の新しいインスタンスを初期化します[`BezierKnotRecord`](../)class.
