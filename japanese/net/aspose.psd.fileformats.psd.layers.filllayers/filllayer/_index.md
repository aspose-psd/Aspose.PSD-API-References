...
description: "Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer クラス。Fill layer。FillSettings によって異なる、カラー フィル、グラデーション フィル、またはパターン フィル レイヤーです"
type: docs
weight: 2020
...
Fill layer。[`FillSettings`](./fillsettings/) によって異なる、カラー フィル、グラデーション フィル、またはパターン フィル レイヤーです
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | フィル設定を取得または設定します。 |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | 塗りのタイプを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | `FillLayer` クラスの新しいインスタンスをフィルのタイプで構築します。 |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | すべての非透明色を新しい色に置き換え、元のアルファ値を保持して滑らかなエッジを保ちます。注意: 透明度のない画像に使用すると、すべての色が単一の色に置き換えられます。 |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | 現在の [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) に基づいて、フィルレイヤーのピクセル データを更新します。 |
