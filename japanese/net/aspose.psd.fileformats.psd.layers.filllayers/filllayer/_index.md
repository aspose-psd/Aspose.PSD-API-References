...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer クラス. 塗りつぶしレイヤーカラー塗りつぶしグラデーション塗りつぶしまたはパターン塗りつぶしレイヤーFillSettings
type: docs
weight: 1910
url: /ja/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

塗りつぶしレイヤー。カラー塗りつぶし、グラデーション塗りつぶし、またはパターン塗りつぶしレイヤー[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | 塗りつぶし設定を取得します。 |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | 塗りつぶしのタイプを取得します。 |
...
| 名前 | 説明 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | の新しいインスタンスを構築します`FillLayer`塗りつぶしの種類によるクラス. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | すべての不透明な色を新しい色に置き換え、元のアルファ値を維持して滑らかなエッジを保存します。 |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | 実際に従って塗りつぶしレイヤー ピクセル データを更新します。[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* 名前空間 [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* 組み立て [Aspose.PSD](../../)
