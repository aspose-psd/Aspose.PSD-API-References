---
title: "クラス SolidBrush"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.Brushes.SolidBrush クラス。Solid brush は特定の色で継続的に描画するために意図されています。このクラスは継承できません"
type: docs
weight: 200
...
ソリッドブラシは特定の色で継続的に描画することを目的としています。このクラスは継承できません。
...
| 名前 | 説明 |
| --- | --- |
| [SolidBrush](solidbrush/#constructor)() | `SolidBrush` クラスの新しいインスタンスを初期化します。 |
