...
description: Aspose.PSD.Brushes.LinearMulticolorGradientBrush クラス. を表しますBrush複数の色と適切な位置で定義された線形グラデーションこのクラスは継承できません.
type: docs
weight: 160
...
を表します[`Brush`](../../aspose.psd/brush/)複数の色と適切な位置で定義された線形グラデーション。このクラスは継承できません.
...
| 名前 | 説明 |
| --- | --- |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor)() | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`クラスのデフォルト パラメータ. 開始色は黒、終了色は白、角度は 45 度、四角形は (0,0) に位置し、サイズは (1,1). |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_1)(Point, Point) | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`指定されたポイントを持つクラス. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_2)(PointF, PointF) | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`指定されたポイントを持つクラス. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_3)(Rectangle, float) | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`長方形と方向角に基づくクラス. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_5)(RectangleF, float) | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`長方形と方向角に基づくクラス. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_4)(Rectangle, float, bool) | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`長方形と方向角に基づくクラス. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_6)(RectangleF, float, bool) | の新しいインスタンスを初期化します`LinearMulticolorGradientBrush`長方形と方向角に基づくクラス. |
...
| [InterpolationColors](../../aspose.psd.brushes/linearmulticolorgradientbrush/interpolationcolors/) { get; set; } | を取得または設定します[`ColorBlend`](../../aspose.psd/colorblend/)マルチカラーの線形グラデーションを定義します. |
