...
| 名前 | 説明 |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | の新しいインスタンスを初期化します`EllipseShape`class. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | の新しいインスタンスを初期化します`EllipseShape`class. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | 形状セグメントを取得します。 |
