---
title: "クラス EllipseShape"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.Shapes.EllipseShape クラス。楕円形を表します"
type: docs
weight: 5990
url: /ja/net/aspose.psd.shapes/ellipseshape/
---
{{< psd/tize >}}
## EllipseShape class
...
| 名前 | 説明 |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | `EllipseShape` クラスの新しいインスタンスを初期化します。 |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | `EllipseShape` クラスの新しいインスタンスを初期化します。 |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | シェイプのセグメントを取得します。 |
