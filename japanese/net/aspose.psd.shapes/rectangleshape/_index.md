...
description: Aspose.PSD.Shapes.RectangleShape クラス. 長方形を表します
type: docs
weight: 5530
...
| 名前 | 説明 |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | の新しいインスタンスを初期化します`RectangleShape`class. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | の新しいインスタンスを初期化します`RectangleShape`class. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | 形状セグメントを取得します。 |
