...
description: "Aspose.PSD.Shapes.PieShape クラス。円形のパイ形を表します"
type: docs
weight: 6000
...
| 名前 | 説明 |
| --- | --- |
| [PieShape](pieshape/#constructor)() | `PieShape` クラスの新しいインスタンスを初期化します。 |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | `PieShape` クラスの新しいインスタンスを初期化します。 |
...
| override [Segments](../../aspose.psd.shapes/pieshape/segments/) { get; } | シェイプのセグメントを取得します。 |
