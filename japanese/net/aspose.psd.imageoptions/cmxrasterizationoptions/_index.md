...
description: Aspose.PSD.ImageOptions.CmxRasterizationOptions クラス. CMX エクスポーター オプション.
type: docs
weight: 4800
...
| 名前 | 説明 |
| --- | --- |
| [CmxRasterizationOptions](cmxrasterizationoptions/)() | デフォルトのコンストラクター。 |
...
| [Positioning](../../aspose.psd.imageoptions/cmxrasterizationoptions/positioning/) { get; set; } | 位置を取得または設定します。 |
