...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType 列挙. スマート オブジェクト コンテンツ type の SmartObjectType 列挙を定義します
type: docs
weight: 3500
url: /ja/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
## SmartObjectType enumeration

スマート オブジェクト コンテンツ type の SmartObjectType 列挙を定義します
...
| 名前 | 価値 | 説明 |
| --- | --- | --- |
| Embedded | `0` | 埋め込みコンテンツ |
| AvailableLinked | `1` | 利用可能なリンクされたファイル |
| UnavailableLinked | `2` | 利用できないリンクされたファイル |
| LibraryLink | `3` | Adobe® Photoshop® ÑÑ ライブラリ link |
