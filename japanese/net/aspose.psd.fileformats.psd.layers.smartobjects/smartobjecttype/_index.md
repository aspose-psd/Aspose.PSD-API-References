---
title: "列挙型 SmartObjectType"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType enum. スマートオブジェクトのコンテンツタイプ用の SmartObjectType 列挙体を定義します"
type: docs
weight: 3920
...
スマートオブジェクトのコンテンツタイプ用の SmartObjectType 列挙体を定義します
...
| AvailableLinked | `1` | 利用可能なリンクファイル |
| UnavailableLinked | `2` | 利用できないリンクファイル |
| LibraryLink | `3` | Adobe® Photoshop® の ÑÑ ライブラリリンク |
