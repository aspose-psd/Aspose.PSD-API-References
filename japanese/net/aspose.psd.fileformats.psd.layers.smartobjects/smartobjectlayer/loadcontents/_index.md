...
description: "SmartObjectLayer メソッド。スマート オブジェクト レイヤーの埋め込みまたはリンクされた画像コンテンツを取得します。"
type: docs
weight: 130
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| オプション | LoadOptions | オプションです。 |

### 戻り値

ロードされた [`Image`](../../../aspose.psd/image/) スマート オブジェクト インスタンスです。
