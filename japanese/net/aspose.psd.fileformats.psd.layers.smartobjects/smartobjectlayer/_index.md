---
title: "クラス SmartObjectLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectLayer クラス。PSD ファイルに埋め込まれた、または外部ファイルにリンクされたスマートオブジェクトを含む SmartObjectLayer クラスを定義します。Smart Objects を使用すると、破壊的でない変換を実行できます。レイヤーをスケール、回転、歪み、遠近変換、ワープさせても、元の画像データや品質が失われません。Illustrator のベクターアートワークなどのベクターデータをラスタライズせずに扱えます。破壊的でないフィルタリングも可能です。Smart Objects に適用されたフィルタはいつでも編集できます。1 つの Smart Object を編集すると、リンクされたすべてのインスタンスが自動的に更新されます。Smart Object レイヤーにリンクまたはアンリンクされたレイヤーマスクを適用できます。低解像度のプレースホルダー画像でさまざまなデザインを試し、後で最終版に差し替えることができます。Adobe Photoshop では、画像の内容を PSD ドキュメントに埋め込むことができます。詳細は https//helpx.adobe.com/photoshop/using/createsmartobjects.html を参照してください。埋め込みスマートオブジェクトを含むレイヤーは、配置された PlLd および SoLd リソースとスマートオブジェクトプロパティを保持します。PlLd リソースは PSD バージョン 10 未満では単独で存在できます。これらのリソースは、グローバル Lnk2Resource 内の LiFdDataSource の UniqueId と、埋め込みファイル名やその他のパラメータ、元の形式のバイト配列としての埋め込みファイル内容を含みます。"
type: docs
weight: 3910
url: /ja/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
{{< psd/tize >}}
## SmartObjectLayer class

SmartObjectLayer クラスを定義します。このクラスは PSD ファイルに埋め込まれたスマートオブジェクトまたは外部ファイルにリンクされたスマートオブジェクトを含みます。Smart Objects を使用すると、次のことが可能です。破壊的でない変形を実行できます。レイヤーをスケール、回転、傾斜、歪み、遠近変換、またはワープさせても、元の画像データや品質が失われません。変形は元のデータに影響しないためです。Illustrator のベクターアートワークなど、ベクターデータをラスタライズせずに扱えます。破壊的でないフィルタリングを実行できます。Smart Objects に適用されたフィルタをいつでも編集できます。1 つの Smart Object を編集すると、リンクされたすべてのインスタンスが自動的に更新されます。Smart Object レイヤーにリンクまたは非リンクのレイヤーマスクを適用できます。低解像度のプレースホルダー画像でさまざまなデザインを試し、後で最終バージョンに差し替えることができます。Adobe Photoshop では、画像の内容を PSD ドキュメントに埋め込むことができます。詳細は以下をご覧ください: [https://helpx.adobe.com/photoshop/using/create-smart-objects.html](https://helpx.adobe.com/photoshop/using/create-smart-objects.html) 埋め込まれたスマートオブジェクトを含むレイヤーは、配置された (PlLd) および SoLd リソースとスマートオブジェクトプロパティを保持します。PlLd リソースは PSD バージョン 10 より古い場合に単独で存在することがあります。これらのリソースは、埋め込みファイル名やその他のパラメータとともに、グローバル Lnk2Resource の LiFdDataSource の UniqueId を含み、元の形式のバイト配列として埋め込みファイルの内容を保持します。
...
| 名前 | 説明 |
| --- | --- |
| [SmartObjectLayer](smartobjectlayer/)(Stream) | `SmartObjectLayer` クラスの新しいインスタンスを初期化します。 |
...
| [Contents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contents/) { get; set; } | スマートオブジェクトレイヤーの内容を取得または設定します。埋め込みスマートオブジェクトの内容は、埋め込み生画像ファイルです：[`Data`](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) とそのプロパティ。リンクされたスマートオブジェクトの内容は、利用可能な場合はリンク画像ファイルの生コンテンツとそのプロパティです：[`LiFeDataSource`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/)。[`IsLibraryLink`](../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) が true の場合、Adobe Photoshop Graphics Library からの読み込みはサポートしていません。通常のリンクファイルの場合、まず [`RelativePath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/) を使用してソース画像パス SourceImagePath に対して相対的にファイルを探し、利用できない場合は [`FullPath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/) を確認し、それでも見つからなければ画像と同じディレクトリにあるリンクファイルを探します。 |
| [ContentsBounds](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentsbounds/) { get; set; } | スマートオブジェクトコンテンツの境界を取得または設定します。 |
| [ContentsSource](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentssource/) { get; set; } | スマートオブジェクトコンテンツのソースを取得または設定します。 |
| [ContentType](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contenttype/) { get; } | スマートオブジェクトレイヤーコンテンツのタイプを取得します。埋め込みスマートオブジェクトの内容は、埋め込み生画像ファイルです：[`Data`](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/)。リンクされたスマートオブジェクトの内容は、利用可能な場合はリンク画像ファイルの生コンテンツです：[`LiFeDataSource`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/)。[`IsLibraryLink`](../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) が true の場合、Adobe Photoshop Graphics Library からの読み込みはサポートしていません。通常のリンクファイルの場合、まず [`RelativePath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/) を使用してソース画像パス SourceImagePath に対して相対的にファイルを探し、利用できない場合は [`FullPath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/) を確認し、それでも見つからなければ画像と同じディレクトリにあるリンクファイルを探します。 |
...
| [SmartFilters](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/smartfilters/) { get; } | スマートフィルタを取得します。 |
| [SmartObjectProvider](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/smartobjectprovider/) { get; } | スマートオブジェクトプロバイダーを取得します。 |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/) { get; set; } | リソースから設定または取得されたワープパラメータを取得または設定します（デフォルト）。 |
...
| [ConvertToLinked](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/converttolinked/)(string) | この埋め込みスマートオブジェクトをリンクされたスマートオブジェクトに変換します。 |
...
| [DuplicateLayer](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/duplicatelayer/)() | このスマートオブジェクトレイヤーをコピーして新しいスマートオブジェクトレイヤーを作成します。埋め込みスマートオブジェクトの場合、埋め込み画像は共有されることに注意してください。埋め込み画像をコピーしたい場合は、[`NewSmartObjectViaCopy`](./newsmartobjectviacopy/) メソッドを使用してください。 |
| [EmbedLinked](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/embedlinked/)() | このレイヤーにリンクされたスマートオブジェクトを埋め込みます。 |
| [ExportContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/exportcontents/)(string) | 埋め込みまたはリンクされたコンテンツをファイルにエクスポートします。 |
...
| [LoadContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/loadcontents/)(LoadOptions) | スマートオブジェクトレイヤーの埋め込みまたはリンクされた画像コンテンツを取得します。 |
...
| virtual [MergeLayerTo](../../aspose.psd.fileformats.psd.layers/layer/mergelayerto/)(Layer) | レイヤーを指定されたレイヤーにマージします。 |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/newsmartobjectviacopy/)() | このレイヤーをコピーして新しいスマートオブジェクトレイヤーを作成します。Adobe Photoshop の `Layer -&gt; Smart Objects -&gt; New Smart Object via Copy` 機能を再現します。埋め込みスマートオブジェクトのみが対象で、埋め込み画像もコピーされることに注意してください。埋め込み画像を共有したい場合は [`DuplicateLayer`](./duplicatelayer/) メソッドを使用してください。 |
...
| [RelinkToFile](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/)(string) | リンクされたスマートオブジェクトを新しいファイルに再リンクします。その後 UpdateModifiedContent メソッドを呼び出す必要はありません。 |
...
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents)(Image) | スマートオブジェクトレイヤーに埋め込まれたスマートオブジェクトのコンテンツを置き換えます。 |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_2)(string) | コンテンツをファイルで置き換えます。その後 UpdateModifiedContent メソッドを呼び出す必要はありません。 |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_1)(Image, ResolutionSetting) | スマートオブジェクトレイヤーに埋め込まれたスマートオブジェクトのコンテンツを置き換えます。 |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_5)(string, bool) | コンテンツをファイルで置き換えます。その後 UpdateModifiedContent メソッドを呼び出す必要はありません。 |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_3)(string, ResolutionSetting) | コンテンツをファイルで置き換えます。その後 UpdateModifiedContent メソッドを呼び出す必要はありません。 |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_4)(string, ResolutionSetting, bool) | コンテンツをファイルで置き換えます。その後 UpdateModifiedContent メソッドを呼び出す必要はありません。 |
...
| [UpdateModifiedContent](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/updatemodifiedcontent/)() | 変更されたコンテンツでスマートオブジェクトレイヤーの画像キャッシュを更新します。 |
