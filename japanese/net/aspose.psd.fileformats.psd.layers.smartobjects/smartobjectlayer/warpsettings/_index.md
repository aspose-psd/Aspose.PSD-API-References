...
description: "SmartObjectLayer プロパティ。リソースのデフォルトから設定または取得された Warp パラメータを取得または設定します。"
type: docs
weight: 80
url: /ja/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

リソースから設定または取得されたワープパラメータを取得または設定します（デフォルト）。
