...
description: SmartObjectLayer 方法. 変更されたコンテンツでスマート オブジェクト レイヤーの画像キャッシュを更新します
type: docs
weight: 150
url: /ja/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/updatemodifiedcontent/
---
## SmartObjectLayer.UpdateModifiedContent method

変更されたコンテンツでスマート オブジェクト レイヤーの画像キャッシュを更新します。
