...
description: SmartObjectLayer 方法. リンクされたスマート オブジェクトを新しいファイルに再リンクします 後で UpdateModifiedContent メソッドを呼び出す必要はありません
type: docs
weight: 130
...
リンクされたスマート オブジェクトを新しいファイルに再リンクします。 後で UpdateModifiedContent メソッドを呼び出す必要はありません。
