...
description: "SmartObjectLayer メソッド。リンクされたスマートオブジェクトを新しいファイルに再リンクします。その後、UpdateModifiedContent メソッドを呼び出す必要はありません。"
type: docs
weight: 150
url: /ja/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/
---
{{< psd/tize >}}
