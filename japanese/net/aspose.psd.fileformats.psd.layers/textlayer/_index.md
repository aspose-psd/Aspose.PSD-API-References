...
description: "Aspose.PSD.FileFormats.Psd.Layers.TextLayer クラス。テキストレイヤークラス"
type: docs
weight: 3980
url: /ja/net/aspose.psd.fileformats.psd.layers/textlayer/
---
{{< psd/tize >}}
## TextLayer class
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | フォントを取得します。 |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | レイヤーのテキストを取得します |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | テキストを取得します。 |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | テキストのバウンドボックスを取得または設定します。 |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | テキストの色を取得します。 |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | テキストの部分を取得します。 |
| virtual [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | 上部レイヤー位置を取得または設定します。 |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | 変換行列を取得または設定します |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | リソースから設定または取得されたワープパラメータを取得または設定します（デフォルト）。 |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | テキストレイヤーのフォントセットを取得します。 |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | 画像のサイズを変更します。デフォルトの LeftTopToLeftTop が使用されます。 |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | テキストを更新します。 |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | テキストを更新します。 |
