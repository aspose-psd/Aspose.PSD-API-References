...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer クラス. テキストレイヤー class
type: docs
weight: 3560
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | テキスト バインド ボックスを取得または設定します。 |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | テキストの色を取得します。 |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | テキスト部分を取得します。 |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | 最上層の位置を取得または設定します。 |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | 変換マトリックスを取得または設定します |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | 画像のサイズを変更します。デフォルトLeftTopToLeftTop使用されています. |
