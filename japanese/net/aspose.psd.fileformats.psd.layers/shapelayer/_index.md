---
title: "クラス ShapeLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer クラス。シェイプレイヤー。シェイプレイヤーと関連リソースの操作ロジックをカプセル化します。"
type: docs
weight: 3820
url: /ja/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

シェイプレイヤー。シェイプレイヤーと関連リソースの処理ロジックをカプセル化します。
...
| 名前 | 説明 |
| --- | --- |
| [ShapeLayer](shapelayer/)() | `ShapeLayer` クラスの新しいインスタンスを初期化します。すべてのリソースはデフォルト状態で作成されます。 |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | シェイプレイヤー内のシェイプの内部領域の塗り設定を取得または設定します。 |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | シェイプレイヤーに存在するパスの集合を取得します。 |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | シェイプのストローク設定を取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | `ShapeLayer` クラスの新しいインスタンスを作成します。 |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | シェイプレイヤーのプロパティからリソースを更新します。 |
