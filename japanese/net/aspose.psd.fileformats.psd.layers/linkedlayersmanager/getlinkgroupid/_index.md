...
description: LinkedLayersManager 方法. レイヤーに関連付けられたリンク グループ ID を取得します
type: docs
weight: 20
url: /ja/net/aspose.psd.fileformats.psd.layers/linkedlayersmanager/getlinkgroupid/
---
## LinkedLayersManager.GetLinkGroupId method

レイヤーに関連付けられたリンク グループ ID を取得します。
