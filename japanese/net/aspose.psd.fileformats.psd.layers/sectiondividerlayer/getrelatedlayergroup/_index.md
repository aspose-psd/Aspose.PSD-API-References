...
description: "SectionDividerLayer メソッド。この SectionDividerLayer インスタンスに関連付けられた LayerGroup を取得します"
type: docs
weight: 20
...
この [`SectionDividerLayer`](../) インスタンスに関連付けられた [`LayerGroup`](../../layergroup/) を取得します
...
[`LayerGroup`](../../layergroup/) インスタンスです。
