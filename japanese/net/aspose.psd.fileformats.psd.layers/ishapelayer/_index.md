---
title: "インターフェイス IShapeLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.IShapeLayer インターフェイス。シェイプレイヤーのプロパティを記述します。"
type: docs
weight: 2260
url: /ja/net/aspose.psd.fileformats.psd.layers/ishapelayer/
---
{{< psd/tize >}}
## IShapeLayer interface

シェイプレイヤーのプロパティを説明します。
...
| 名前 | 説明 |
| --- | --- |
| [Fill](../../aspose.psd.fileformats.psd.layers/ishapelayer/fill/) { get; set; } | シェイプの内部領域を塗りつぶすための塗り設定です。 |
| [Path](../../aspose.psd.fileformats.psd.layers/ishapelayer/path/) { get; } | シェイプレイヤーに存在するパスの集合です。 |
| [Stroke](../../aspose.psd.fileformats.psd.layers/ishapelayer/stroke/) { get; set; } | シェイプのストローク設定です。 |
