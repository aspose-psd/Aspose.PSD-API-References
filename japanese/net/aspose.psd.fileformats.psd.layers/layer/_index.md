...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer クラス. psd レイヤー
type: docs
weight: 2080
url: /ja/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| 名前 | 説明 |
| --- | --- |
| [Layer](layer/#constructor)() | の新しいインスタンスを初期化します`Layer`クラス。遅延初期化のコンストラクター. |
| [Layer](layer/#constructor_3)(Stream) | の新しいインスタンスを初期化します`Layer`class. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | の新しいインスタンスを初期化します`Layer`class. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | の新しいインスタンスを初期化します`Layer`バイト配列からのクラス. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | オブジェクトのデータを指定されたストリームに保存します。 |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | オブジェクトのデータを指定されたファイルの場所に保存します。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | 保存オプションに従って、指定されたファイル形式でオブジェクトのデータを指定されたファイルの場所に保存します。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | 保存オプションに従って、指定されたファイル形式でイメージのデータを指定されたストリームに保存します。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | 保存オプションに従って、指定されたファイル形式でオブジェクトのデータを指定されたファイルの場所に保存します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | ブレンド モード シグネチャを表します。 |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | レイヤ ヘッダー サイズ. |
