...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup クラス. グループ層 class
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | ブレンド モード キーを取得または設定します。 |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | レイヤーグループの高さを取得します. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | フォルダーが開かれていることを取得または設定します に設定されている場合`真実`グループは起動時に開いた状態になり、それ以外の場合は最小化された状態になります. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | 画層 group の画層を取得します |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | レイヤーグループの幅を取得します. |
...
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | 画層グループを追加します。 |
