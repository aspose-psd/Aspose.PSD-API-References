---
title: "クラス ArtboardLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer クラス。 アートボードレイヤークラス"
type: docs
weight: 1990
url: /ja/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | アートボードの背景色を取得または設定します。 |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | ブレンドモードキーを取得または設定します。 |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | `ArtboardLayer` が背景色を持つかどうかを示す値を取得または設定します。 |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | フォルダーが開いているかどうかを取得または設定します。`true` に設定すると、起動時にグループは開いた状態になり、そうでなければ最小化された状態になります。 |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | レイヤー グループ内のレイヤーを取得します |
...
| 名前 | 説明 |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | レイヤーをレイヤー グループに追加します。 |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | レイヤー グループを追加します。 |
