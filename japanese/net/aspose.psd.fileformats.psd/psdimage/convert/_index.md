...
description: "PsdImage メソッド。この画像形式をオプションで指定された形式に変換します。"
type: docs
weight: 560
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| newOptions | PsdOptions | 新しいオプションです。 |

## 例

これらの例は、PSD 画像形式を他のカラーモード/ビット深度に変換する方法を示しています。
...
// PSD に保存し、保存されたファイルを読み込んで PNG に保存します。
