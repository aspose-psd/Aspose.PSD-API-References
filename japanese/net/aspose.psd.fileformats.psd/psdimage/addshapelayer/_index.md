...
description: "PsdImage メソッド。空の Shape レイヤーを追加します。パスはありません。保存前にシェイプレイヤーにパスを追加する必要があります。"
type: docs
weight: 460
url: /ja/net/aspose.psd.fileformats.psd/psdimage/addshapelayer/
---
{{< psd/tize >}}
## PsdImage.AddShapeLayer method

空の Shape レイヤーを追加します。パスはありません。保存前にシェイプレイヤーに追加する必要があります。
...
以下のコードは ShapeLayer の追加方法を示しています。
