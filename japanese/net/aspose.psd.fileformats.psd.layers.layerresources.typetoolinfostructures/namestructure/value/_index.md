...
description: "NameStructure プロパティ。Name 構造体の値を取得または設定します"
type: docs
weight: 40
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/value/
---
{{< psd/tize >}}
## NameStructure.Value property

Name 構造体の値を取得または設定します。
