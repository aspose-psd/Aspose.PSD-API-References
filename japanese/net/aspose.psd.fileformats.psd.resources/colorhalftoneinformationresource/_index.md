...
description: Aspose.PSD.FileFormats.Psd.Resources.ColorHalftoneInformationResource クラス. ハーフトーン リソース
type: docs
weight: 3670
url: /ja/net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| 名前 | 説明 |
| --- | --- |
| [ColorHalftoneInformationResource](colorhalftoneinformationresource/)() | デフォルトのコンストラクター。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/datasize/) { get; } | リソース データ サイズをバイト単位で取得します。 |
| [HalftoneData](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/halftonedata/) { get; set; } | ハーフトーン データを取得または設定します。 |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | リソースの一意の識別子を取得または設定します。 |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/minimalversion/) { get; } | 必要最小限の PSD バージョンを取得します。 |
