...
description: GaussianBlurSmartFilter 財産. ガウス スマート フィルターの半径を取得または設定します
type: docs
weight: 40
url: /ja/net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/radius/
---
## GaussianBlurSmartFilter.Radius property

ガウス スマート フィルターの半径を取得または設定します。
