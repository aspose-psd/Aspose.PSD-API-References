...
description: "IGradientFillSettings プロパティ。この IGradientFillSettings がディザリングかどうかを示す値を取得または設定します"
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
{{< psd/tize >}}
## IGradientFillSettings.Dither property

この [`IGradientFillSettings`](../) がディザリングかどうかを示す値を取得または設定します。
