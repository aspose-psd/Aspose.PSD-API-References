...
description: "IGradientFillSettings プロパティ。この IGradientFillSettings が逆かどうかを示す値を取得または設定します"
type: docs
weight: 80
url: /ja/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
{{< psd/tize >}}
## IGradientFillSettings.Reverse property

この [`IGradientFillSettings`](../) が逆かどうかを示す値を取得または設定します。
