...
description: "IGradientFillSettings プロパティ。特定のグラデーション定義インスタンス（Solid/Noise）を取得または設定します"
type: docs
weight: 40
url: /ja/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/gradient/
---
{{< psd/tize >}}
## IGradientFillSettings.Gradient property

特定のグラデーション定義インスタンス（Solid/Noise）を取得または設定します。
