...
description: "GradientMapSettings プロパティ。特定のグラデーション定義インスタンス（Solid/Noise）を取得または設定します"
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/
---
{{< psd/tize >}}
