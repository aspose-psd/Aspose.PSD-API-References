...
description: "NoiseGradientFillSettings プロパティ。拡張カウントを取得または設定します（Photoshop 6.0 用の 2）"
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.fillsettings/noisegradientfillsettings/expansioncount/
---
{{< psd/tize >}}
## NoiseGradientFillSettings.ExpansionCount property

拡張カウント（= Photoshop 6.0 の場合は 2）を取得または設定します。
