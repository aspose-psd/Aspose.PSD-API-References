...
description: "Aspose.PSD.FileFormats.Psd.Resources.Enums.ColorSpace 列挙型。カラースペースの種類"
type: docs
weight: 4160
url: /ja/net/aspose.psd.fileformats.psd.resources.enums/colorspace/
---
{{< psd/tize >}}
...
| RGB | `0` | RGB カラースペースです。 |
| HSB | `1` | HSB カラースペースです。 |
| CMYK | `2` | CMYK カラースペースです。 |
| Lab | `7` | Lab カラースペースです。 |
| GrayScale | `8` | グレースケール カラースペースです。 |
