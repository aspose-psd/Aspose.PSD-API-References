...
description: "InnerShadowEffect プロパティ。この角度をすべてのレイヤーエフェクトで使用するかどうかを示す値を取得または設定します"
type: docs
weight: 110
url: /ja/net/aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/usegloballight/
---
{{< psd/tize >}}
