...
description: ColorBalanceAdjustmentLayer 財産. ハイライト シアン レッド バランスを取得または設定します
type: docs
weight: 10
...
| 例外 | 調子 |
| --- | --- |
| ArgumentOutOfRangeException | ハイライト シアン レッド バランスは -100 から +100 の範囲内でなければなりません. |
