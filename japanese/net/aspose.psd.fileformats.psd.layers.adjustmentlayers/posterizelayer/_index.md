...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer クラス. ポスタライズ レイヤー PostResource. からのデータを使用してポスタライズ レンダリングを処理します
type: docs
weight: 1800
...
ポスタライズ レイヤー。 PostResource. からのデータを使用してポスタライズ レンダリングを処理します。
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | ポスタライズ レイヤーのレベル. |
