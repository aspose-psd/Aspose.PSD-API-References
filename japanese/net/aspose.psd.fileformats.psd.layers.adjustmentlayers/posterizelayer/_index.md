---
title: "クラス PosterizeLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer クラス。Posterize レイヤー。PostResource のデータを使用して Posterize のレンダリングを処理します。"
type: docs
weight: 1870
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
{{< psd/tize >}}
## PosterizeLayer class

ポスタライズレイヤー。PostResource のデータを使用してポスタライズのレンダリングを処理します。
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Posterize レイヤーのレベル。 |
