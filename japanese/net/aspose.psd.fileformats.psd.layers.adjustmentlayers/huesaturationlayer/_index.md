---
title: "クラス HueSaturationLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer クラス。HueSaturation 調整レイヤー。"
type: docs
weight: 1820
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
{{< psd/tize >}}
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | この `HueSaturationLayer` がカラー化されているかどうかを示す値を取得または設定します。 |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | 色相を取得または設定します。 |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | 明度を取得または設定します。 |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | 彩度を取得または設定します。 |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | 範囲を取得します。 |
