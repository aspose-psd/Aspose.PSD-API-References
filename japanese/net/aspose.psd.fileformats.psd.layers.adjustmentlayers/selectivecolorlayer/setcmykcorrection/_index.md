...
description: "SelectiveColorLayer メソッド。選択色によるCMYK補正を設定します"
type: docs
weight: 40
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/
---
{{< psd/tize >}}
## SelectiveColorLayer.SetCmykCorrection method

選択的カラーによるCMYK補正を設定します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | 選択色のタイプです。 |
| 補正 | CmykCorrection | CMYK 補正です。 |
