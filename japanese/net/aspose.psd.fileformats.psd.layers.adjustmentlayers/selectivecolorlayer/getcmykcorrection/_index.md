...
description: "SelectiveColorLayer メソッド。選択色によるCMYK補正を取得します"
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/
---
{{< psd/tize >}}
## SelectiveColorLayer.GetCmykCorrection method

選択的カラーによるCMYK補正を取得します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | 選択色です。 |
