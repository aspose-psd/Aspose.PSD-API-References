...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer クラス. RGB チャンネル ミキサー調整レイヤー
type: docs
weight: 1810
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
## RgbChannelMixerLayer class

RGB チャンネル ミキサー調整レイヤー。
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel/) { get; } | 青チャンネルを取得します。 |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel/) { get; } | 緑のチャンネルを取得します. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel/) { get; } | 赤チャンネルを取得します。 |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | によってチャネルのインデックスを取得します。 RgbMixerChannel を返します |
