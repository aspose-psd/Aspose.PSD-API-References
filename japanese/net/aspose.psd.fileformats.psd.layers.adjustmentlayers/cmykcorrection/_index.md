---
title: "クラス CmykCorrection"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection クラス。選択的カラー調整レイヤーにおける色補正"
type: docs
weight: 1750
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
...
| 名前 | 説明 |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | デフォルトコンストラクタです。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | 黒色補正を取得または設定します。 |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | シアン色補正を取得または設定します。 |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | マゼンタ色補正を取得または設定します。 |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | イエロー色補正を取得または設定します。 |
