---
title: "クラス BrightnessContrastLayer"
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | 明るさを取得または設定します。PS における明るさの範囲は -150 から +150 です。ただし、これらは無視します。 |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | コントラストを取得または設定します。PS におけるコントラストの範囲は -50 から +100 です。ただし、これらは無視します。 |
