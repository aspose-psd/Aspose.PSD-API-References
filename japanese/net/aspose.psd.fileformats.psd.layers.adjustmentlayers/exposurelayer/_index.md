...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer クラス. 露出調整レイヤー
type: docs
weight: 1740
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | 露出を取得または設定します。 PS の露出範囲は -20 から +20 です。 |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | GammaCorrection を取得または設定します。 GammaCorrection の PS 範囲は 9.99 から +0.01 です。 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | オフセットを取得または設定します。 PS の場合、オフセットの範囲は -0.5 から +0.5 です。 |
