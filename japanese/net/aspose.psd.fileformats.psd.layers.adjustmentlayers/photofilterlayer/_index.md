---
title: "クラス PhotoFilterLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer クラス。PhotoFilter 調整レイヤー"
type: docs
weight: 1860
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
{{< psd/tize >}}
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | フィルタの RGB カラーを取得または設定します。 |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | フィルタの濃度を取得または設定します |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | [preserve luminosity] を示すかどうかの値を取得または設定します。 |
