---
title: "クラス CurvesLayer"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer クラス。カーブ調整レイヤー。"
type: docs
weight: 1790
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
{{< psd/tize >}}
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | このインスタンスが連続マネージャーとして使用されているかどうかを示す値を取得または設定します。 |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | このインスタンスが離散マネージャーとして使用されているかどうかを示す値を取得または設定します。 |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | カーブマネージャーを取得します。 |
