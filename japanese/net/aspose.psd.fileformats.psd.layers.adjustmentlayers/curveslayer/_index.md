...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | このインスタンスが連続マネージャーを使用しているかどうかを示す値を取得または設定します。 |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | このインスタンスがディスクリート マネージャで使用されているかどうかを示す値を取得または設定します。 |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | カーブ マネージャを取得します。 |
