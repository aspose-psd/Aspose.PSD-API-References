...
description: "BlackWhiteAdjustmentLayer プロパティ。黄色の値を取得または設定します"
type: docs
weight: 130
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/
---
{{< psd/tize >}}
## BlackWhiteAdjustmentLayer.Yellows property

yellows の値を取得または設定します。
