...
description: "BlackWhiteAdjustmentLayer プロパティ。Blue Tint Color の double 値を取得または設定します"
type: docs
weight: 90
url: /ja/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/
---
{{< psd/tize >}}
## BlackWhiteAdjustmentLayer.TintColorBlue property

ブルーティントカラーの double 値を取得または設定します。
