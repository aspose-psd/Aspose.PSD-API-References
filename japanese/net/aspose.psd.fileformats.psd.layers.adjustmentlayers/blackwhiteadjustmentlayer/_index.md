...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BlackWhiteAdjustmentLayer クラス. 白黒調整レイヤー クラス.
type: docs
weight: 1670
...
| [BlackAndWhitePresetFileName](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blackandwhitepresetfilename/) { get; set; } | 白黒プリセット ファイル名を取得または設定します。 |
...
| [Blues](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blues/) { get; set; } | ブルース値を取得または設定します。 |
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind/) { get; set; } | 白黒プリセット種別値を取得または設定します。 |
...
| [Cyans](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans/) { get; set; } | シアン値を取得または設定します。 |
...
| [Greens](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens/) { get; set; } | 緑の値を取得または設定します。 |
...
| [Magentas](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/magentas/) { get; set; } | マゼンタ値を取得または設定します。 |
...
| [Reds](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/reds/) { get; set; } | 赤の値を取得または設定します。 |
...
| [TintColor](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolor/) { get; set; } | 色合いの値を取得または設定します。 |
| [TintColorBlue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/) { get; set; } | 青の色合いの double 値を取得または設定します。 |
| [TintColorGreen](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorgreen/) { get; set; } | 緑の色合いの double 値を取得または設定します。 |
| [TintColorRed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorred/) { get; set; } | 赤の色合いの double 値を取得または設定します。 |
...
| [UseTint](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/usetint/) { get; set; } | [色合い] を使用するかどうかを示す値を取得または設定します。 |
...
| [Yellows](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/) { get; set; } | 黄色の値を取得または設定します。 |
