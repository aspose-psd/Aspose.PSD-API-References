...
description: "LiFeDataSource プロパティ。PSD LnkE リソースの LiFE データソースにある外部ファイルの相対パスを取得または設定します。"
type: docs
weight: 100
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
{{< psd/tize >}}
## LiFeDataSource.RelativePath property

取得または設定します PSD LnkE リソースの LiFE データソースにある外部ファイルの相対パスを取得または設定します。
...
| 例外 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | RelativePath プロパティにアクセスできません。これは liFE データソースでのみ利用可能です。 |
