...
description: LiFeDataSource 財産. PSD LnkE リソースの LiFE データ ソース内の外部ファイルの最終書き込み日時を取得または設定します
type: docs
weight: 40
...
PSD LnkE リソースの LiFE データ ソース内の外部ファイルの最終書き込み日時を取得または設定します。
...
| 例外 | 調子 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Date プロパティにはアクセスできません。バージョン 3 以降の liFE データ ソースでのみ使用できます |
