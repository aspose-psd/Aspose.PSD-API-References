...
description: "LiFeDataSource プロパティ。PSD LnkE リソースの LiFE データソース内の外部ファイルの最終書き込み日時を取得または設定します"
type: docs
weight: 40
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
{{< psd/tize >}}
## LiFeDataSource.Date property

取得または設定します PSD LnkE リソースの LiFE データソースにある外部ファイルの最終書き込み日時を取得または設定します。
...
| 例外 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Date プロパティにアクセスできません。バージョン 3 以上の liFE データソースでのみ利用可能です |
