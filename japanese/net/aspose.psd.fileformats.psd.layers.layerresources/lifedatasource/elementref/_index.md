...
description: LiFeDataSource 財産. Adobe Photoshop CC ライブラリのグラフィック ライブラリ要素参照を取得または設定します
type: docs
weight: 60
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
## LiFeDataSource.ElementRef property

Adobe® Photoshop® CC ライブラリのグラフィック ライブラリ要素参照を取得または設定します。
...
グラフィックス ライブラリ要素のリファレンス。

### 例外

| 例外 | 調子 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | ElementRef プロパティにはアクセスできません。IsLibrary が true の場合、liFE データ ソースでのみ使用できます |
