...
description: "LiFeDataSource プロパティ。Adobe Photoshop CC ライブラリ用のグラフィックライブラリ要素参照を取得または設定します"
type: docs
weight: 60
...
取得または設定します Adobe® Photoshop® CC Libraries 用のグラフィックライブラリ要素参照を取得または設定します。
...
| 例外 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | ElementRef プロパティにアクセスできません。IsLibrary が true の場合にのみ liFE データソースで利用可能です |
