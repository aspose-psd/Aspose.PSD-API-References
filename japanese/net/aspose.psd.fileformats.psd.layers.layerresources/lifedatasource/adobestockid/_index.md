...
description: LiFeDataSource 財産. Adobe Photoshop CC ライブラリのグラフィック ライブラリ AdobeStockId を取得または設定します
type: docs
weight: 20
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

Adobe® Photoshop® CC ライブラリのグラフィック ライブラリ AdobeStockId を取得または設定します。
...
グラフィック ライブラリ Adobe Stock Identifier.

### 例外

| 例外 | 調子 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | AdobeStockId プロパティにアクセスできません。IsLibrary が true の場合、liFE データ ソースでのみ使用できます |
