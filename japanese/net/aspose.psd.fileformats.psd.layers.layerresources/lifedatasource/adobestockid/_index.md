...
description: "LiFeDataSource プロパティ。Adobe Photoshop CC ライブラリ用のグラフィックライブラリ AdobeStockId を取得または設定します"
type: docs
weight: 20
...
グラフィックライブラリの Adobe Stock 識別子。

### 例外

| 例外 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | AdobeStockId プロパティにアクセスできません。IsLibrary が true の場合にのみ liFE データソースで利用可能です |
