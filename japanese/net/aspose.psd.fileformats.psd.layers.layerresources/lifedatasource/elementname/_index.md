...
description: LiFeDataSource 財産. Adobe Photoshop CC ライブラリのグラフィック ライブラリ要素名を取得または設定します
type: docs
weight: 50
...
Adobe® Photoshop® CC ライブラリのグラフィック ライブラリ要素名を取得または設定します。
...
| 例外 | 調子 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | ElementName プロパティにアクセスできません。IsLibrary が true の場合、liFE データ ソースでのみ使用できます |
