...
description: "LiFeDataSource プロパティ。PSD LnkE リソースの LiFE データソースにある外部ファイルのフルパスを取得または設定します。"
type: docs
weight: 90
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
{{< psd/tize >}}
## LiFeDataSource.FullPath property

取得または設定します PSD LnkE リソースの LiFE データソースにある外部ファイルのフルパスを取得または設定します。
...
| 例外 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FullPath プロパティにアクセスできません。これは liFE データソースでのみ利用可能です。 |
