...
description: LiFeDataSource 財産. PSD LnkE リソースの LiFE データ ソース内の外部ファイルのフル パスを取得または設定します
type: docs
weight: 90
...
PSD LnkE リソースの LiFE データ ソース内の外部ファイルのフル パスを取得または設定します。
...
| 例外 | 調子 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FullPath プロパティにアクセスできません。これは、liFE データ ソースでのみ使用できます |
