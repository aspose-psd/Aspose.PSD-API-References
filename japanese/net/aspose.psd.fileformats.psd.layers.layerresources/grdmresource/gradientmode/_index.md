...
description: "GrdmResource property. このグラデーションのモード。グラデーションタイプ（ソリッド/ノイズ）を 0 または 1 で決定します"
type: docs
weight: 60
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/grdmresource/gradientmode/
---
{{< psd/tize >}}
## GrdmResource.GradientMode property

このグラデーションのモードは 'Gradient Type' を 'Solid/Noise' (0/1) に決定します。
