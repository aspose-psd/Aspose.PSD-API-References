...
description: VsmsResource コンストラクタ. の新しいインスタンスを初期化しますVsmsResourceclass.
type: docs
weight: 10
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/vsmsresource/
---
## VsmsResource(byte[]) {#constructor_1}

の新しいインスタンスを初期化します[`VsmsResource`](../)class.
...
| 例外 | 調子 |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Vsms リソース値が無効です |

### 関連項目

* class [VsmsResource](../)
* 名前空間 [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../vsmsresource/)
* 組み立て [Aspose.PSD](../../../)
