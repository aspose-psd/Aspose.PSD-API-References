...
description: "VsmsResource コンストラクタ。VsmsResource クラスの新しいインスタンスを初期化します"
type: docs
weight: 10
...
[`VsmsResource`](../) クラスの新しいインスタンスを初期化します。
...
| 例外 | 条件 |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | 無効な Vsms Resource 値 |
