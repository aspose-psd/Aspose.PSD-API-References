...
description: "Lnk2Resource プロパティ。指定されたインデックスの LiFdDataSource を取得します"
type: docs
weight: 20
...
指定されたインデックスの [`LiFdDataSource`](../../lifddatasource/) を取得します。
...
[`LiFdDataSource`](../../lifddatasource/) のインスタンスです。
