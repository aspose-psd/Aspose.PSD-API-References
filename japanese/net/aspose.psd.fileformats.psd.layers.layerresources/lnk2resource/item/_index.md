...
description: Lnk2Resource 財産. を取得しますLiFdDataSource指定されたインデックスで.
type: docs
weight: 20
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
## Lnk2Resource indexer

を取得します[`LiFdDataSource`](../../lifddatasource/)指定されたインデックスで.
...
[`LiFdDataSource`](../../lifddatasource/)インスタンス.
...
* class [Lnk2Resource](../)
* 名前空間 [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lnk2resource/)
* 組み立て [Aspose.PSD](../../../)
