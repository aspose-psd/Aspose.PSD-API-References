---
title: "クラス LiFdDataSource"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LiFdDataSource クラス。埋め込みファイルに関する情報を含む PSD ファイル内の liFD データソースクラスを定義します。これは Adobe Photoshop ファイルの変更を支援する PSD ファイル形式操作 API の一部です。"
type: docs
weight: 2970
...
PSD ファイル内の埋め込みファイルに関する情報を含む liFD データソースクラスを定義します。これは、Adobe® Photoshop® ファイルの変更を支援する PSD ファイル形式操作 API の一部です。
...
| 名前 | 説明 |
| --- | --- |
| [LiFdDataSource](lifddatasource/#constructor)() | `LiFdDataSource` クラスの新しいインスタンスを初期化します。 |
| [LiFdDataSource](lifddatasource/#constructor_1)(int, Guid, string, string, string) | `LiFdDataSource` クラスの新しいインスタンスを初期化します。 |
...
| [Data](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) { get; set; } | PSD ファイル内の埋め込みスマートオブジェクトデータを取得または設定します。 |
