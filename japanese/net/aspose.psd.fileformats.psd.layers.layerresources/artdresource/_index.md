---
title: "クラス ArtDResource"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtDResource クラス。GlobalLayerResources 用のアートボード情報データ"
type: docs
weight: 2530
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/artdresource/
---
{{< psd/tize >}}
## ArtDResource class

[`GlobalLayerResources`](../../aspose.psd.fileformats.psd/psdimage/globallayerresources/) 用のアートボード情報データ。
...
| 名前 | 説明 |
| --- | --- |
| [ArtDResource](artdresource/)() | デフォルトコンストラクタです。 |
...
| 名前 | 説明 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artdresource/typetoolkey/) | タイプツール情報キーです。 |
