...
description: "PlacedResource プロパティ。配置レイヤーの総ページ数を取得または設定します（PSD ファイル内）。"
type: docs
weight: 150
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/totalpages/
---
{{< psd/tize >}}
