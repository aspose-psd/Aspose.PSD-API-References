...
description: "PlacedResource プロパティ。配置レイヤーのグローバル一意識別子を取得または設定します（PSD 画像内）。"
type: docs
weight: 170
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/uniqueid/
---
{{< psd/tize >}}
## PlacedResource.UniqueId property

配置されたレイヤーの PSD 画像におけるグローバル一意識別子を取得または設定します。
