...
description: SmartObjectResource 財産. 子ドキュメントの現在選択されているコンプの ID を取得または設定します何も選択されていない場合は 1 になります コンプはデザイナーが作成できるページ レイアウトのコンポジションですレイヤーカンプを使用すると1 つの Adobe Photoshop ファイルでレイアウトの複数のバージョン を作成管理および表示できますレイヤーカンプはレイヤーパネルの状態のスナップショットですレイヤー構成は 3 種類のレイヤー オプションを保存しますが このプロパティはPSD ファイル内のスマート オブジェクト レイヤーのレイヤー構成選択識別子を取得します. スマートオブジェクトのレイヤーカンプ
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/compid/
---
## SmartObjectResource.CompId property

子ドキュメントの現在選択されているコンプの ID を取得または設定します。何も選択されていない場合は -1 になります。 コンプは、デザイナーが作成できるページ レイアウトのコンポジションです。レイヤーカンプを使用すると、1 つの Adobe® Photoshop® ファイルでレイアウトの複数のバージョン を作成、管理、および表示できます。レイヤーカンプは、レイヤーパネルの状態のスナップショットです。レイヤー構成は 3 種類のレイヤー オプションを保存しますが、 このプロパティは、PSD ファイル内のスマート オブジェクト レイヤーのレイヤー構成選択識別子を取得します. [スマートオブジェクトのレイヤーカンプ](https://helpx.adobe.com/photoshop/using/layer-comps.html)
...
PSD 画像の子ドキュメントで現在選択されているカンプの ID。何も選択されていない場合は -1 になります。
