...
description: "SmartObjectResource プロパティ。このスマートオブジェクトレイヤーデータのユニーク識別子を取得または設定します（PSD 画像内）。"
type: docs
weight: 160
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/placedid/
---
{{< psd/tize >}}
