---
title: "クラス LyvrResource"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource クラス。レイヤーの Photoshop バージョンを表すリソースです。"
type: docs
weight: 3150
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

レイヤーの Photoshop バージョンを表すリソース。
...
| 名前 | 説明 |
| --- | --- |
| [LyvrResource](lyvrresource/)() | デフォルトコンストラクタです。 |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | レイヤーの Photoshop バージョンを取得または設定します。 |

## メソッド

| 名前 | 説明 |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | リソースを指定されたストリームコンテナに保存します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | タイプツール情報キーです。 |
