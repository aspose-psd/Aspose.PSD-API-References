...
description: "LyvrResource プロパティ。レイヤーの Photoshop バージョンを取得または設定します"
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/
---
{{< psd/tize >}}
## LyvrResource.Version property

レイヤーの Photoshop バージョンを取得または設定します。
