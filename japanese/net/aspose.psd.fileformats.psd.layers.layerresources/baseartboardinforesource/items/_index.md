...
description: "BaseArtboardInfoResource プロパティ。OSTypeStructure アイテムを取得または設定します"
type: docs
weight: 10
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/
---
{{< psd/tize >}}
## BaseArtboardInfoResource.Items property

[`OSTypeStructure`](../../ostypestructure/) アイテムを取得または設定します。
