...
description: Lnk3Resource コンストラクタ. の新しいインスタンスを初期化しますLnk3Resourceclass.
type: docs
weight: 10
url: /ja/net/aspose.psd.fileformats.psd.layers.layerresources/lnk3resource/lnk3resource/
---
## Lnk3Resource constructor

の新しいインスタンスを初期化します[`Lnk3Resource`](../)class.
...
* class [Lnk3Resource](../)
* 名前空間 [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lnk3resource/)
* 組み立て [Aspose.PSD](../../../)
