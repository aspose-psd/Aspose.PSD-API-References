...
description: "ITextParagraph プロパティ。取得または設定します。この ITextParagraph がぶらさぎりかどうかを示す値"
type: docs
weight: 30
url: /ja/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
{{< psd/tize >}}
## ITextParagraph.Burasagari property

取得または設定します。この [`ITextParagraph`](../) がぶらさぎりかどうかを示す値。
