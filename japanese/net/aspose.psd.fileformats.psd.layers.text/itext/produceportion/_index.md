...
description: IText 方法. デフォルトのパラメーターで新しい部分を生成します
type: docs
weight: 60
url: /ja/net/aspose.psd.fileformats.psd.layers.text/itext/produceportion/
---
## IText.ProducePortion method

デフォルトのパラメーターで新しい部分を生成します
...
新規作成への参照[`ITextPortion`](../../itextportion/).
