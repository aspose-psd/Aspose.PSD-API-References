...
description: "ITextStyle プロパティ。ヒンディー数字かどうかを示す値を取得または設定します"
type: docs
weight: 150
url: /ja/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
{{< psd/tize >}}
## ITextStyle.HindiNumbers property

[hindi numbers] を示すかどうかの値を取得または設定します。
...
`true` は [hindi numbers] の場合; それ以外は `false`。
