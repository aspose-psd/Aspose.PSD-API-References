...
description: "ITextStyle メソッド。指定されたスタイルが等しいかどうかを判断します"
type: docs
weight: 290
url: /ja/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
{{< psd/tize >}}
## ITextStyle.IsEqual method

指定されたスタイルが等しいかどうかを判断します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| style | ITextStyle | スタイルです。 |

### 戻り値

`true` は指定されたスタイルが等しい場合、そうでなければ `false`。
