...
description: "ITextStyle プロパティ。自動リーディングかどうかを示す値を取得または設定します"
type: docs
weight: 20
url: /ja/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
{{< psd/tize >}}
## ITextStyle.AutoLeading property

自動リーディングかどうかを示す値を取得または設定します。
...
`true` は [automatic leading] の場合; それ以外は `false`。
