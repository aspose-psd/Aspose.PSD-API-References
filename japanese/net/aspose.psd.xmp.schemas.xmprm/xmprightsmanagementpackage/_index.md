---
title: "クラス XmpRightsManagementPackage"
second_title: "Aspose.PSD for .NET API Reference"
description: "Aspose.PSD.Xmp.Schemas.XmpRm.XmpRightsManagementPackage クラス。XMP 権利管理名前空間を表します"
type: docs
weight: 6430
url: /ja/net/aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/
---
{{< psd/tize >}}
...
| 名前 | 説明 |
| --- | --- |
| [XmpRightsManagementPackage](xmprightsmanagementpackage/)() | デフォルトコンストラクタです。 |
...
| 名前 | 説明 |
| --- | --- |
| override [AddValue](../../aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/addvalue/)(string, string) | 文字列プロパティを追加します。 |
...
| [SetCertificate](../../aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/setcertificate/)(string) | 証明書を設定します。 |
| [SetMarkedAsRightManagement](../../aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/setmarkedasrightmanagement/)(bool) | 権利管理コンテンツとしてマークします |
| [SetOwners](../../aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/setowners/)(string[]) | 所有者を設定します。 |
| [SetUsageTerms](../../aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/setusageterms/)(LangAlt) | 使用条件を設定します。 |
| virtual [SetValue](../../aspose.psd.xmp/xmppackage/setvalue/)(string, IXmlValue) | 値を設定します。 |
| [SetWebStatement](../../aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/setwebstatement/)(string) | Web ステートメントを設定します。 |
