---
title: "क्लास FillLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer क्लास। Fill लेयर। रंग भराव, ग्रेडिएंट भराव या पैटर्न भराव लेयर जो FillSettings द्वारा भिन्न होती है"
type: docs
weight: 2020
...
Fill लेयर। रंग भराव, ग्रेडिएंट भराव या पैटर्न भराव लेयर जो [`FillSettings`](./fillsettings/) द्वारा भिन्न होती है
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | Fill सेटिंग्स को प्राप्त करता या सेट करता है। |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | फ़िल का प्रकार प्राप्त करता है। |
...
| नाम | विवरण |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | `FillLayer` क्लास का नया इंस्टेंस बनाता है भराव प्रकार के आधार पर। |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | सभी गैर-ट्रांसपेरेंट रंगों को नए रंग से बदलता है और स्मूद एजेज़ को बचाने के लिए मूल अल्फा वैल्यू को संरक्षित रखता है। नोट: यदि आप इसे बिना ट्रांसपेरेंसी वाली इमेज पर उपयोग करते हैं, तो सभी रंग एक ही रंग से बदल दिए जाएंगे। |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | वर्तमान [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) के आधार पर fill लेयर के पिक्सेल डेटा को अपडेट करता है। |
