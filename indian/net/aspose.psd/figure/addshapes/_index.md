...
description: Figure तरक. आकृत में आकृतयं क एक श्रृंखल जड़त है
type: docs
weight: 70
url: /hi/net/aspose.psd/figure/addshapes/
---
## Figure.AddShapes method

आकृति में आकृतियों की एक श्रृंखला जोड़ता है।
...
| --- | --- | --- |
| shapes | Shape[] | जोड़ने के लिए आकार। |
