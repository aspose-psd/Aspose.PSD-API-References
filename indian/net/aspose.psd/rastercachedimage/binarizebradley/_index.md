...
description: RasterCachedImage तरक. इंटग्रल इमेज थ्रेशल्डंग क उपयग करके ब्रैडल के एडेप्टव थ्रेशल्डंग एल्गरथम क उपयग करके इमेज क बइनेरइज़ेशन
type: docs
weight: 50
url: /hi/net/aspose.psd/rastercachedimage/binarizebradley/
---
