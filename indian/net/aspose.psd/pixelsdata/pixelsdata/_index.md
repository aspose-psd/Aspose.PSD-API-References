...
description: PixelsData नर्मत. क एक नय उदहरण प्ररंभ करत हैPixelsData वर्ग.
type: docs
weight: 10
...
का एक नया उदाहरण प्रारंभ करता है[`PixelsData`](../) वर्ग.
...
| --- | --- | --- |
| pixels | Int32[] | पिक्सेल डेटा। |
| bounds | Rectangle | पिक्सेल आयत को बाउंड करते हैं। |
