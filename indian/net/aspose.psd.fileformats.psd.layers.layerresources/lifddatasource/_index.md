...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LiFdDataSource कक्ष. PSD फ़इल में liFD डेट स्रत वर्ग क परभषत करत है जसमें एक एम्बेडेड फ़इल के बरे में जनकर हत है यह PSD फ़इल प्ररूप हेरफेर एपआई क हस्स है ज Adobe Photoshop files क संशधत करने में मदद करत है
type: docs
weight: 2670
...
PSD फ़ाइल में liFD डेटा स्रोत वर्ग को परिभाषित करता है जिसमें एक एम्बेडेड फ़ाइल के बारे में जानकारी होती है। यह PSD फ़ाइल प्रारूप हेरफेर एपीआई का हिस्सा है जो Adobe® Photoshop® files को संशोधित करने में मदद करता है
...
| नाम | विवरण |
| --- | --- |
| [LiFdDataSource](lifddatasource/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`LiFdDataSource` वर्ग. |
| [LiFdDataSource](lifddatasource/#constructor_1)(int, Guid, string, string, string) | का एक नया उदाहरण प्रारंभ करता है`LiFdDataSource` वर्ग. |
...
| [Data](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) { get; set; } | PSD फ़ाइल में एम्बेडेड स्मार्ट ऑब्जेक्ट डेटा प्राप्त या सेट करता है। |
