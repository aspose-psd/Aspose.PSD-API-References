---
title: "क्लास LyvrResource"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource क्लास। लेयर के फ़ोटोशॉप संस्करण को दर्शाने वाला संसाधन"
type: docs
weight: 3150
url: /hi/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

लेयर के Photoshop संस्करण को दर्शाने वाला रिसोर्स।
...
| नाम | विवरण |
| --- | --- |
| [LyvrResource](lyvrresource/)() | डिफ़ॉल्ट कन्स्ट्रक्टर। |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | लेयर के फ़ोटोशॉप संस्करण को प्राप्त करता है या सेट करता है। |

## मेथड्स

| नाम | विवरण |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | निर्दिष्ट स्ट्रीम कंटेनर में रिसोर्स को सहेजता है। |
...
| नाम | विवरण |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | टाइप टूल जानकारी कुंजी। |
