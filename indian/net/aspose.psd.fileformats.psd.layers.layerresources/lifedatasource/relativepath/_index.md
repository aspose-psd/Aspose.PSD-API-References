...
description: LiFeDataSource संपत्त. PSD LnkE संसधन के LiFE डेट स्रत में बहर फ़इल क सपेक्ष पथ प्रप्त य सेट करत है
type: docs
weight: 100
...
PSD LnkE संसाधन के LiFE डेटा स्रोत में बाहरी फ़ाइल का सापेक्ष पथ प्राप्त या सेट करता है।
...
| अपवाद | स्थिति |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | आप RelativePath गुण तक नहीं पहुंच सकते, यह केवल liFE डेटा स्रोत के लिए उपलब्ध है |
