...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource कक्ष. SoLdResource वर्ग क परभषत करत है जसमें PSD फ़इल में स्मर्ट ऑब्जेक्ट परत के बरे में जनकर हत है क उपयग Adobe Photoshop छवयं में स्मर्ट ऑब्जेक्ट परतं क समर्थन करने के लए कय जत है
type: docs
weight: 3020
...
SoLdResource वर्ग को परिभाषित करता है जिसमें PSD फ़ाइल में स्मार्ट ऑब्जेक्ट परत के बारे में जानकारी होती है। का उपयोग Adobe® Photoshop® छवियों में स्मार्ट ऑब्जेक्ट परतों का समर्थन करने के लिए किया जाता है।
...
| नाम | विवरण |
| --- | --- |
| [SoLdResource](soldresource/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`SoLdResource` class. यह डिफ़ॉल्ट कन्स्ट्रक्टर द्वारा उपयोग करने के लिए डिज़ाइन किया गया हैSoLdResourceLoader . उपयोग करें[`SmartResourceCreator`](../smartresourcecreator/) SoLdResource क्लासेस बनाने के लिए. |
| [SoLdResource](soldresource/#constructor_1)(Guid, bool, bool) | का एक नया उदाहरण प्रारंभ करता है`SoLdResource` class. तैयार उदाहरण प्राप्त करने के लिए आइटम प्रॉपर्टी सेट करना या InitializeItems() को कॉल करना आवश्यक है। यह कन्स्ट्रक्टर उपयोग करने के लिए डिज़ाइन किया गया है[`SmartResourceCreator`](../smartresourcecreator/) और इकाई परीक्षणों में. उपयोग करें[`SmartResourceCreator`](../smartresourcecreator/) SoLdResource क्लासेस बनाने के लिए. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/key/) { get; } | सोल्ड स्मार्ट ऑब्जेक्ट लेयर संसाधन कुंजी प्राप्त करता है। |
...
| नाम | विवरण |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | प्रकार टूल जानकारी कुंजी: 'SoLd'. |
