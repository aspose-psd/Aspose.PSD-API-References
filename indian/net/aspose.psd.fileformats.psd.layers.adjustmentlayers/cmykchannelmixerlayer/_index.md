---
title: "क्लास CmykChannelMixerLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer क्लास। Cmyk Channel Mixer Adjustment layer।"
type: docs
weight: 1740
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | काले चैनल को प्राप्त करता है। |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | सियान चैनल को प्राप्त करता है। |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | मैजेंटा चैनल को प्राप्त करता है। |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | एक मान प्राप्त करता है या सेट करता है जो यह दर्शाता है कि यह [`ChannelMixerLayer`](../channelmixerlayer/) मोनोक्रोम है। |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | पीले चैनल को प्राप्त करता है। |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | चैनल का इंडेक्स प्राप्त करता है। CmykMixerChannel को वापस देता है। |
