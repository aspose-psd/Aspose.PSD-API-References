---
title: "क्लास ChannelMixerLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer क्लास। चैनल मिक्सर समायोजन लेयर"
type: docs
weight: 1730
url: /hi/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
{{< psd/tize >}}
## ChannelMixerLayer class

चैनल मिक्सर समायोजन लेयर।
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | इस `ChannelMixerLayer` मोनोक्रोम है या नहीं, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | चैनल का इंडेक्स प्राप्त करता है। यह RgbMixerChannel या CmykMixerChannel वापस कर सकता है। |
