---
title: "क्लास BrightnessContrastLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer क्लास। Brightness/contrast लेयर"
type: docs
weight: 1720
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | ब्राइटनेस प्राप्त करता है या सेट करता है। PS में ब्राइटनेस की सीमा -150 से +150 तक है। लेकिन हम इसे नजरअंदाज करते हैं। |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | कॉन्ट्रास्ट प्राप्त करता है या सेट करता है। PS में कॉन्ट्रास्ट की सीमा -50 से +100 तक है। लेकिन हम इसे नजरअंदाज करते हैं। |
