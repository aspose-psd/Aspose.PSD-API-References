...
description: ColorBalanceAdjustmentLayer संपत्त. मडटन मैजेंट ग्रन बैलेंस प्रप्त य सेट करत है
type: docs
weight: 50
url: /hi/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesmagentagreenbalance/
---
...
द मिडटोन मैजेंटा ग्रीन बैलेंस।

### अपवाद

| अपवाद | स्थिति |
| --- | --- |
| ArgumentOutOfRangeException | मिडटोन मैजेंटा ग्रीन बैलेंस -100 से +100 की सीमा में होना चाहिए। |
