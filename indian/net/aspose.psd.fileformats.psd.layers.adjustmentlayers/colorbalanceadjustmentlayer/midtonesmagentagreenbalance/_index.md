...
description: "ColorBalanceAdjustmentLayer प्रॉपर्टी। Midtones Magenta Green Balance को प्राप्त करता है या सेट करता है"
type: docs
weight: 50
...
| अपवाद | शर्त |
| --- | --- |
| ArgumentOutOfRangeException | Midtones Magenta Green Balance -100 से +100 की सीमा में होना चाहिए। |
