...
description: ColorBalanceAdjustmentLayer संपत्त. हइलइट सयन रेड बैलेंस प्रप्त य सेट करत है
type: docs
weight: 10
...
| अपवाद | स्थिति |
| --- | --- |
| ArgumentOutOfRangeException | हाइलाइट सियान रेड बैलेंस -100 से +100 की सीमा में होना चाहिए। |
