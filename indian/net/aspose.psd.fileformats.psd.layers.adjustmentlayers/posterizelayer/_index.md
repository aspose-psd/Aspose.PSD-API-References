---
title: "क्लास PosterizeLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer क्लास। पोस्टराइज़ लेयर। PostResource से डेटा का उपयोग करके पोस्टराइज़ रेंडरिंग को संभालता है।"
type: docs
weight: 1870
...
पोस्टराइज़ लेयर। PostResource से डेटा का उपयोग करके पोस्टराइज़ रेंडरिंग को संभालता है।
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | पोस्टराइज़ लेयर के स्तर। |
