...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer कक्ष. पस्टरइज़ परत PostResource. के डेट क उपयग करके रेंडरंग क हैंडल करत है
type: docs
weight: 1800
url: /hi/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
## PosterizeLayer class

पोस्टराइज़ परत। PostResource. के डेटा का उपयोग करके रेंडरिंग को हैंडल करता है
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | पोस्टराइज परत के स्तर। |
