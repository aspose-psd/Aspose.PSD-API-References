---
title: "क्लास GradientMapLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer क्लास। Gradient map layer। GrdmResource से डेटा का उपयोग करके Gradient map रेंडरिंग को संभालता है।"
type: docs
weight: 1810
url: /hi/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | Gradient सेटिंग्स इंस्टेंस को प्राप्त करता है या सेट करता है, जो GrdmResource इंस्टेंस से पास किया गया है। |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | संबंधित लेयर रिसोर्स में लेयर डेटा को अपडेट करें [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/). |
