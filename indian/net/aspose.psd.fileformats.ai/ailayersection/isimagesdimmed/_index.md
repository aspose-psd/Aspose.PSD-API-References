...
description: AiLayerSection संपत्त. यह इंगत करत है क यह परत मंद है य नहं यह इंगत करत है य सेट करत है परत में नहत लंक क गई छवयं और बटमैप छवयं क तव्रत क कम करत है
type: docs
weight: 50
...
यह इंगित करता है कि यह परत मंद है या नहीं, यह इंगित करता है या सेट करता है। परत में निहित लिंक की गई छवियों और बिटमैप छवियों की तीव्रता को कम करता है।
...
`सत्य` अगर यह परत मंद है; अन्यथा,`असत्य` .
