...
description: SmartObjectLayer तरक. स्मर्ट ऑब्जेक्ट लेयर क एम्बेडेड य लंक क गई छव समग्र प्रप्त करत है
type: docs
weight: 110
...
स्मार्ट ऑब्जेक्ट लेयर की एम्बेडेड या लिंक की गई छवि सामग्री प्राप्त करता है।
...
| --- | --- | --- |
| options | LoadOptions | विकल्प। |

### प्रतिलाभ की मात्रा

भरी हुई[`Image`](../../../aspose.psd/image/) स्मार्ट वस्तु उदाहरण।
