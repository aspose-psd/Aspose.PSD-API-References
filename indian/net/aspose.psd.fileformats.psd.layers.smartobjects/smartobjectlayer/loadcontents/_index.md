...
description: "SmartObjectLayer मेथड। स्मार्ट ऑब्जेक्ट लेयर की एम्बेडेड या लिंक्ड इमेज कंटेंट को प्राप्त करता है"
type: docs
weight: 130
url: /hi/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/loadcontents/
---
{{< psd/tize >}}
## SmartObjectLayer.LoadContents method

स्मार्ट ऑब्जेक्ट लेयर की एम्बेडेड या लिंक्ड इमेज कंटेंट प्राप्त करता है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| विकल्प | LoadOptions | विकल्प। |

### रिटर्न वैल्यू

लोड किया गया [`Image`](../../../aspose.psd/image/) स्मार्ट ऑब्जेक्ट इंस्टेंस।
