...
description: "SmartObjectLayer मेथड। लिंक किए गए स्मार्ट ऑब्जेक्ट को नई फ़ाइल से पुनः लिंक करता है। बाद में UpdateModifiedContent मेथड को कॉल करने की आवश्यकता नहीं है।"
type: docs
weight: 150
...
लिंक्ड स्मार्ट ऑब्जेक्ट को नई फ़ाइल से पुनः लिंक करता है। बाद में UpdateModifiedContent मेथड को कॉल करने की आवश्यकता नहीं है।
