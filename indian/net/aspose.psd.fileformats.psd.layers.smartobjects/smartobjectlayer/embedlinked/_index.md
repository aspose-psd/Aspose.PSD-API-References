...
description: SmartObjectLayer तरक. लंक कए गए स्मर्ट ऑब्जेक्ट क इस परत में एम्बेड करत है.
type: docs
weight: 90
url: /hi/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/embedlinked/
---
## SmartObjectLayer.EmbedLinked method

लिंक किए गए स्मार्ट ऑब्जेक्ट को इस परत में एम्बेड करता है.
