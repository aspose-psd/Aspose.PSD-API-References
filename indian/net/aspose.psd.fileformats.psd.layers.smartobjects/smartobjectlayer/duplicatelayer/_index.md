...
description: "SmartObjectLayer मेथड। इस लेयर को कॉपी करके एक नया स्मार्ट ऑब्जेक्ट लेयर बनाता है। ध्यान दें कि एम्बेडेड स्मार्ट ऑब्जेक्ट्स के लिए एम्बेडेड इमेज साझा की जाती है। यदि आप एम्बेडेड इमेज को कॉपी करना चाहते हैं तो NewSmartObjectViaCopy मेथड का उपयोग करें।"
type: docs
weight: 100
...
इसको कॉपी करके एक नया स्मार्ट ऑब्जेक्ट लेयर बनाता है। ध्यान दें कि एम्बेडेड स्मार्ट ऑब्जेक्ट्स के लिए एम्बेडेड इमेज साझा की जाती है। यदि आप एम्बेडेड इमेज को कॉपी करना चाहते हैं तो [`NewSmartObjectViaCopy`](../newsmartobjectviacopy/) मेथड का उपयोग करें।
