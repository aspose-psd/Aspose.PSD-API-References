...
description: IGradientFillSettings संपत्त. एक मन प्रप्त करत है य सेट करत है ज दर्शत है क यहIGradientFillSettings मुश्कल है.
type: docs
weight: 50
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह[`IGradientFillSettings`](../) मुश्किल है.
...
`सत्य` अगर परेशान है; अन्यथा,`असत्य` .
