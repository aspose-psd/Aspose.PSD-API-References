...
description: "IGradientFillSettings प्रॉपर्टी। प्राप्त करता है या सेट करता है विशिष्ट ग्रेडिएंट परिभाषा इंस्टेंस Solid/Noise"
type: docs
weight: 40
url: /hi/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/gradient/
---
{{< psd/tize >}}
## IGradientFillSettings.Gradient property

विशिष्ट ग्रेडिएंट डिफिनिशन इंस्टेंस (सॉलिड/नॉइज़) प्राप्त करता या सेट करता है।
