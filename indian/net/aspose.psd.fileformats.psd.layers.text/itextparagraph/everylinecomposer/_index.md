...
description: ITextParagraph संपत्त. एक मन प्रप्त करत है य सेट करत है ज इंगत करत है क प्रत्येक पंक्त संगतकर.
type: docs
weight: 60
url: /hi/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

एक मान प्राप्त करता है या सेट करता है जो इंगित करता है कि [प्रत्येक पंक्ति संगीतकार].
...
`सत्य` अगर [हर लाइन संगीतकार]; अन्यथा,`असत्य` .
...
* नाम स्थान [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph/)
* सभा [Aspose.PSD](../../../)
