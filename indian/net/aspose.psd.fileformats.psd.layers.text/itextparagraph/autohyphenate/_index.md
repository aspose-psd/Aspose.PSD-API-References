...
description: ITextParagraph संपत्त. एक मन प्रप्त करत है य सेट करत है ज इंगत करत है क क्य स्वचलत हइफ़नेट.
type: docs
weight: 10
url: /hi/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

एक मान प्राप्त करता है या सेट करता है जो इंगित करता है कि क्या [स्वचालित हाइफ़नेट].
...
`सत्य` अगर [स्वचालित हाइफ़नेट]; अन्यथा,`असत्य` .
