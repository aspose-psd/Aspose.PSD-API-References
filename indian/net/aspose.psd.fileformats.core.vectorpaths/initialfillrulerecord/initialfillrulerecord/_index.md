...
description: InitialFillRuleRecord नर्मत. क एक नय उदहरण प्ररंभ करत हैInitialFillRuleRecord वर्ग.
type: docs
weight: 10
...
का एक नया उदाहरण प्रारंभ करता है[`InitialFillRuleRecord`](../) वर्ग.
...
| --- | --- | --- |
| isFillStartsWithAllPixels | Boolean | is भरण सभी पिक्सेल से शुरू होता है। |
