...
description: "InitialFillRuleRecord कंस्ट्रक्टर। InitialFillRuleRecord क्लास का एक नया उदाहरण आरंभ करता है"
type: docs
weight: 10
url: /hi/net/aspose.psd.fileformats.core.vectorpaths/initialfillrulerecord/initialfillrulerecord/
---
{{< psd/tize >}}
## InitialFillRuleRecord() {#constructor}

[`InitialFillRuleRecord`](../) क्लास का एक नया उदाहरण आरंभ करता है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| isFillStartsWithAllPixels | बूलियन | फ़िल सभी पिक्सेल से शुरू होता है। |
