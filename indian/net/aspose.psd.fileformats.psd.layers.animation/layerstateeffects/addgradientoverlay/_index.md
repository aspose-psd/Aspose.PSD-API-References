...
description: LayerStateEffects तरक. ग्रेडएंट ओवरले प्रभव जड़त है.
type: docs
weight: 50
...
ग्रेडिएंट ओवरले प्रभाव जोड़ता है.
...
का नया उदाहरण[`GradientOverlayEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/gradientoverlayeffect/) कक्षा।
