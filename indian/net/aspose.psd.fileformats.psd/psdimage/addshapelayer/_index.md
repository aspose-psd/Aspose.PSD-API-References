...
description: "PsdImage मेथड। खाली Shape लेयर जोड़ें। बिना पाथ्स के। इन्हें सहेजने से पहले Shape लेयर में जोड़ना चाहिए"
type: docs
weight: 460
url: /hi/net/aspose.psd.fileformats.psd/psdimage/addshapelayer/
---
{{< psd/tize >}}
## PsdImage.AddShapeLayer method

खाली शेप लेयर जोड़ें। बिना पाथ्स के। इन्हें सहेजने से पहले शेप लेयर में जोड़ना चाहिए।
...
निम्नलिखित कोड दिखाता है कि कैसे ShapeLayer जोड़ें।
