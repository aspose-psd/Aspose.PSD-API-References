...
description: "LinkedLayersManager मेथड। लेयर को अनलिंक करता है"
type: docs
weight: 40
...
| अपवाद | शर्त |
| --- | --- |
| ArgumentNullException | लेयर null है। |
| ArgumentException | लेयर का कंटेनर वर्तमान PsdImage के समान होना चाहिए। |
