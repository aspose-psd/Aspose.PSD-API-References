...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer कक्ष. पएसड परत.
type: docs
weight: 2080
url: /hi/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| नाम | विवरण |
| --- | --- |
| [Layer](layer/#constructor)() | का एक नया उदाहरण प्रारंभ करता है`Layer` कक्षा। आलसी आरंभीकरण के लिए निर्माता। |
| [Layer](layer/#constructor_3)(Stream) | का एक नया उदाहरण प्रारंभ करता है`Layer` वर्ग. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | का एक नया उदाहरण प्रारंभ करता है`Layer` वर्ग. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | का एक नया उदाहरण प्रारंभ करता है`Layer` बाइट सरणियों से वर्ग. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | ऑब्जेक्ट के डेटा को निर्दिष्ट स्ट्रीम में सहेजता है। |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | ऑब्जेक्ट के डेटा को निर्दिष्ट फ़ाइल स्थान पर सहेजता है। |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | ऑब्जेक्ट के डेटा को निर्दिष्ट फ़ाइल स्थान पर निर्दिष्ट फ़ाइल स्वरूप में सहेजें विकल्पों के अनुसार सहेजता है। |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | इमेज के डेटा को सेव ऑप्शन के अनुसार निर्दिष्ट फ़ाइल प्रारूप में निर्दिष्ट स्ट्रीम में सहेजता है। |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | ऑब्जेक्ट के डेटा को निर्दिष्ट फ़ाइल स्थान पर निर्दिष्ट फ़ाइल स्वरूप में सहेजें विकल्पों के अनुसार सहेजता है। |
...
| नाम | विवरण |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | मिश्रण मोड हस्ताक्षर का प्रतिनिधित्व करता है। |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | लेयर हेडर का आकार. |
