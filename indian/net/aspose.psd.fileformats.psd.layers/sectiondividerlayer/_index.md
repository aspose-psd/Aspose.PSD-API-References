---
title: "क्लास SectionDividerLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer क्लास। फ़ोल्डर लेयर समूह की सीमाओं को चिह्नित करने वाला सेक्शन डिवाइडर लेयर।"
type: docs
weight: 3810
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | एक मान प्राप्त करता है जो दर्शाता है कि यह इंस्टेंस समूह में दृश्यमान है या नहीं (यदि लेयर समूह में नहीं है तो इसका अर्थ रूट समूह है)। |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | `SectionDividerLayer` इंस्टेंस से संबंधित [`LayerGroup`](../layergroup/) को प्राप्त करता है। |
