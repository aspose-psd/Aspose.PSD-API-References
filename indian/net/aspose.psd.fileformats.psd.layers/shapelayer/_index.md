---
title: "क्लास ShapeLayer"
second_title: "Aspose.PSD for .NET API रेफ़रेंस"
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer क्लास। Shape लेयर। Shape लेयर और संबंधित संसाधनों के साथ कार्य करने की लॉजिक को समाहित करता है।"
type: docs
weight: 3820
url: /hi/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

शेप लेयर। शेप लेयर और संबंधित रिसोर्सेज के साथ कार्य की लॉजिक को संलग्न करता है।
...
| नाम | विवरण |
| --- | --- |
| [ShapeLayer](shapelayer/)() | `ShapeLayer` क्लास का नया उदाहरण प्रारंभ करता है। सभी संसाधन उनके डिफ़ॉल्ट स्थिति में बनाए जाते हैं। |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Shape लेयर में Shapes के आंतरिक क्षेत्र के लिए भराव सेटिंग्स को प्राप्त करता है या सेट करता है। |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Shape लेयर में मौजूद Paths के सेट को प्राप्त करता है। |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Shapes के स्ट्रोक सेटिंग्स को प्राप्त करता है या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | `ShapeLayer` क्लास का नया उदाहरण बनाता है। |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Shape लेयर गुणों से संसाधनों को अपडेट करता है। |
