...
description: "एक पाई आकार का प्रतिनिधित्व करता है।"
type: docs
weight: 14
url: /hi/java/com.aspose.psd.shapes/pieshape/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PieShape()](#PieShape--) | PieShape वर्ग की नई इंस्टेंस को प्रारंभ करता है। |
| [PieShape(RectangleF rectangle, float startAngle, float sweepAngle)](#PieShape-com.aspose.psd.RectangleF-float-float-) | PieShape वर्ग की नई इंस्टेंस को प्रारंभ करता है। |
## विधियाँ
...
PieShape वर्ग की नई इंस्टेंस को प्रारंभ करता है।
