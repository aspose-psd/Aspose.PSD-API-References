...
description: "AddNoise स्मार्ट फ़िल्टर।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/addnoisesmartfilter/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [AddNoiseSmartFilter()](#AddNoiseSmartFilter--) | [AddNoiseSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/addnoisesmartfilter) वर्ग का नया उदाहरण प्रारंभ करता है। |
## फ़ील्ड्स
...
| [getAmountNoise()](#getAmountNoise--) | शोर मान की मात्रा प्राप्त करता है या सेट करता है। |
| [getBlendMode()](#getBlendMode--) | ब्लेंडिंग मोड प्राप्त करता है या सेट करता है। |
| [getClass()](#getClass--) |  |
| [getDistribution()](#getDistribution--) | शोर फ़िल्टर के वितरण को प्राप्त करता है या सेट करता है। |
...
| [isMonochromatic()](#isMonochromatic--) | एकरंगी का मान प्राप्त करता है या सेट करता है। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAmountNoise(double value)](#setAmountNoise-double-) | शोर मान की मात्रा प्राप्त करता है या सेट करता है। |
| [setBlendMode(long value)](#setBlendMode-long-) | ब्लेंडिंग मोड प्राप्त करता है या सेट करता है। |
| [setDistribution(int value)](#setDistribution-int-) | शोर फ़िल्टर के वितरण को प्राप्त करता है या सेट करता है। |
| [setEnabled(boolean value)](#setEnabled-boolean-) | स्मार्ट फ़िल्टर की सक्षम स्थिति प्राप्त करता है या सेट करता है। |
| [setMonochromatic(boolean value)](#setMonochromatic-boolean-) | एकरंगी का मान प्राप्त करता है या सेट करता है। |
...
[AddNoiseSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/addnoisesmartfilter) वर्ग का नया उदाहरण प्रारंभ करता है।
...
शोर मान की मात्रा प्राप्त करता है या सेट करता है।
...
शोर फ़िल्टर के वितरण को प्राप्त करता है या सेट करता है।
...
एकरंगी का मान प्राप्त करता है या सेट करता है।
