...
description: "जनरिक टाइप परिणाम के साथ असिंक्रोनस कार्य के लिए लंबी ऑपरेशन डेलीगेट।"
type: docs
weight: 12
url: /hi/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
जनरिक टाइप परिणाम के साथ असिंक्रोनस कार्य के लिए लंबी ऑपरेशन डेलीगेट।
## कन्स्ट्रक्टर्स
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | जनरिक टाइप परिणाम के साथ असिंक्रोनस कार्य के लिए लंबी ऑपरेशन डेलीगेट। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| कॉलबैक | com.aspose.ms.System.AsyncCallback |  |
| स्थिति | java.lang.Object |  |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| परिणाम | com.aspose.ms.System.IAsyncResult |  |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | असिंक्रोनस टास्क की स्थिति। |

**Returns:**
java.lang.Object - लंबी ऑपरेशन का परिणाम।
### notify() {#notify--}
```
