...
description: "फ़ाइल स्ट्रीम प्रोसेसिंग के लिए सहायक।"
type: docs
weight: 44
url: /hi/java/com.aspose.psd/filestreamcontainer/
---
...
| [createFileStream(String fileLocation, boolean isTemporal)](#createFileStream-java.lang.String-boolean-) | एक नया फ़ाइल स्ट्रीम बनाता है। |
...
| [getFilePath()](#getFilePath--) | फ़ाइल पथ प्राप्त करता है। |
...
| [hashCode()](#hashCode--) |  |
| [isCreated()](#isCreated--) | एक मान प्राप्त करता है जो दर्शाता है कि स्ट्रीम स्पष्ट रूप से बनाई गई थी या नहीं। |
...
| [isTemporal()](#isTemporal--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि स्ट्रीम अस्थायी है या नहीं। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [openFileStream(String fileLocation)](#openFileStream-java.lang.String-) | एक मौजूदा फ़ाइल स्ट्रीम खोलता है। |
| [openFileStream_internalized(String fileLocation, boolean disposeDuplicatedStreams)](#openFileStream-internalized-java.lang.String-boolean-) | एक मौजूदा फ़ाइल स्ट्रीम खोलता है। |
...
| [setTemporal(boolean value)](#setTemporal-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि स्ट्रीम अस्थायी है या नहीं। |
...
| [toString()](#toString--) |  |
| [to_FileStream(FileStreamContainer fileStreamContainer)](#to-FileStream-com.aspose.psd.FileStreamContainer-) | एक स्पष्ट रूपांतरण करता है [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) से FileInputStream में। |
...
| [to_Stream(FileStreamContainer fileStreamContainer)](#to-Stream-com.aspose.psd.FileStreamContainer-) | एक स्पष्ट रूपांतरण करता है [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) से java.io.InputStream में। |
...
एक नया फ़ाइल स्ट्रीम बनाता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| fileLocation | java.lang.String | फ़ाइल स्थान। |
| isTemporal | boolean | यदि  true  सेट किया गया है तो फ़ाइल स्ट्रीम कंटेनर अस्थायी है। |
...
एक मान प्राप्त करता है जो दर्शाता है कि स्ट्रीम स्पष्ट रूप से बनाई गई थी या नहीं।

मान:  true  यदि स्ट्रीम स्पष्ट रूप से बनाई गई थी; अन्यथा,  false .
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि स्ट्रीम अस्थायी है या नहीं।

मान:  true  यदि स्ट्रीम अस्थायी है; अन्यथा,  false .

--------------------

एक अस्थायी स्ट्रीम डिस्पोज़ होने पर स्वयं को हटा देगा। यदि स्ट्रीम मेमोरी-आधारित है तो यह प्रॉपर्टी कोई प्रभाव नहीं रखती। स्ट्रीम को स्पष्ट रूप से बनाई गई होने की स्थिति में अस्थायी या स्थायी के रूप में चिह्नित किया जा सकता है, अन्यथा उपयुक्त अपवाद फेंका जाएगा।
...
एक मौजूदा फ़ाइल स्ट्रीम खोलता है। यदि फ़ाइल स्ट्रीम मौजूद नहीं है तो उपयुक्त अपवाद फेंका जाता है।
...
| --- | --- | --- |
| fileLocation | java.lang.String | फ़ाइल स्थान। |
| disposeDuplicatedStreams | boolean | यदि  true  सेट किया गया है तो डुप्लिकेटेड स्ट्रीम्स को डिस्पोज़ करता है। |
...
एक स्पष्ट रूपांतरण करता है [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) से FileInputStream में।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| fileStreamContainer | [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) | फ़ाइल स्ट्रीम कंटेनर। |

**Returns:**
java.io.FileInputStream - रूपांतरण का परिणाम।
### to_FileStream_internalized(FileStreamContainer fileStreamContainer) {#to-FileStream-internalized-com.aspose.psd.FileStreamContainer-}
```
...
एक स्पष्ट रूपांतरण करता है [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) से java.io.InputStream में।
...
**Returns:**
java.io.InputStream - रूपांतरण का परिणाम।
