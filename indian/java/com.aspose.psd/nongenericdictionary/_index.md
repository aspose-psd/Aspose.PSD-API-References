...
description: "एक नॉन-जनरिक डिक्शनरी का प्रतिनिधित्व करता है।"
type: docs
weight: 72
url: /hi/java/com.aspose.psd/nongenericdictionary/
---
...
एक नॉन-जनरिक डिक्शनरी का प्रतिनिधित्व करता है।
## कन्स्ट्रक्टर्स
...
| [getKeys()](#getKeys--) |  |
| [getKeysTyped()](#getKeysTyped--) | कुंजियों का सशक्त टाइप्ड संग्रह प्राप्त करता है। |
| [getSyncRoot()](#getSyncRoot--) |  |
| [getValues()](#getValues--) |  |
| [getValuesTyped()](#getValuesTyped--) | मानों का सशक्त टाइप्ड संग्रह प्राप्त करता है। |
...
कुंजियों का सशक्त टाइप्ड संग्रह प्राप्त करता है।

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<K> - सशक्त टाइप्ड कुंजियों का संग्रह।
### getSyncRoot() {#getSyncRoot--}
```
...
मानों का सशक्त टाइप्ड संग्रह प्राप्त करता है।

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<V> - सशक्त टाइप्ड मानों का संग्रह।
### get_Item(TKey arg0) {#get-Item-TKey-}
```
