...
description: "स्प्लिट स्ट्रीम कंटेनर को दर्शाता है जो स्ट्रीम को रखता है और स्ट्रीम प्रोसेसिंग रूटीन प्रदान करता है।"
type: docs
weight: 102
url: /hi/java/com.aspose.psd/splitstreamcontainer/
---
...
स्प्लिट स्ट्रीम कंटेनर को दर्शाता है जो स्ट्रीम को रखता है और स्ट्रीम प्रोसेसिंग रूटीन प्रदान करता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [SplitStreamContainer(InputStream stream)](#SplitStreamContainer-java.io.InputStream-) | नया उदाहरण प्रारंभ करता है [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) क्लास का। |
| [SplitStreamContainer(InputStream stream, boolean disposeStream)](#SplitStreamContainer-java.io.InputStream-boolean-) | नया उदाहरण प्रारंभ करता है [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) क्लास का। |
| [SplitStreamContainer(StreamContainer stream, boolean disposeStream)](#SplitStreamContainer-com.aspose.psd.StreamContainer-boolean-) | नया उदाहरण प्रारंभ करता है [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) क्लास का। |
## फ़ील्ड्स
...
| [hashCode()](#hashCode--) |  |
| [insert(int position, StreamContainer stream, boolean disposeStream)](#insert-int-com.aspose.psd.StreamContainer-boolean-) | स्ट्रीम कंटेनर को निर्दिष्ट स्थिति में सम्मिलित करता है। |
...
| [save(OutputStream dstStream, int bufferSize, long length)](#save-java.io.OutputStream-int-long-) | स्ट्रीम के डेटा को निर्दिष्ट स्ट्रीम में सहेजता (कॉपी करता) है। |
...
नया उदाहरण प्रारंभ करता है [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) क्लास का।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| stream | [StreamContainer](../../com.aspose.psd/streamcontainer) | स्ट्रीम कंटेनर। |
| disposeStream | boolean | यदि true पर सेट किया जाता है तो स्ट्रीम को बंद कर देता है। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| position | int | इन्सर्ट करने की स्थिति। |
| stream | [StreamContainer](../../com.aspose.psd/streamcontainer) | इन्सर्ट करने के लिए स्ट्रीम कंटेनर। |
| disposeStream | boolean | यदि true पर सेट किया जाता है तो स्ट्रीम को बंद कर देता है। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| dstStream | java.io.OutputStream | डेटा को सहेजने के लिए स्ट्रीम। |
| bufferSize | int | बफ़र आकार। डिफ़ॉल्ट रूप से [StreamContainer.READ\_WRITE\_BYTES\_COUNT](../../com.aspose.psd/streamcontainer\#READ-WRITE-BYTES-COUNT) मान उपयोग किया जाता है। |
| length | long | कॉपी करने के लिए स्ट्रीम डेटा की लंबाई। डिफ़ॉल्ट रूप से लंबाई को Length ([StreamContainer.getLength()](../../com.aspose.psd/streamcontainer\#getLength--)/[StreamContainer.setLength(long)](../../com.aspose.psd/streamcontainer\#setLength-long-)) मान पर सेट किया जाता है। |
...
| origin | int | [SeekOrigin](../../com.aspose.psd/seekorigin) प्रकार का मान जो नई स्थिति प्राप्त करने के लिए उपयोग किए जाने वाले संदर्भ बिंदु को दर्शाता है। |
