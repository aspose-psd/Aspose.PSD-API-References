...
description: "उपयोग करने के लिए कैश प्रकार निर्दिष्ट करता है।"
type: docs
weight: 15
url: /hi/java/com.aspose.psd/cachetype/
---
...
| फ़ील्ड | विवरण |
| --- | --- |
| [Auto](#Auto) | ऑटो कैश प्रकार निर्दिष्ट करता है। |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | केवल इन-मेमोरी कैश। |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | केवल डिस्क कैश। |
...
ऑटो कैश प्रकार निर्दिष्ट करता है। ऑटो कैश योजना पहले इन-मेमोरी और फिर डिस्क पर कैश करने का प्रयास करेगी।
