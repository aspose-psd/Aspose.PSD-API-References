...
description: "Name संरचना कुंजी 0x6E616D65 जो ASCII में 'name' को दर्शाता है, एक सरल संरचना है जिसका उपयोग यूनिकोड या पास्कल-शैली की स्ट्रिंग को संग्रहीत करने के लिए किया जाता है, जो लेयर पाथ या एडजस्टमेंट जैसे तत्व के नाम का प्रतिनिधित्व करती है।"
type: docs
weight: 19
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
Name संरचना (कुंजी: 0x6E616D65, जो ASCII में "name" लिखती है) एक सरल संरचना है जिसका उपयोग यूनिकोड या पास्कल-शैली की स्ट्रिंग को संग्रहीत करने के लिए किया जाता है, जो किसी तत्व का नाम दर्शाती है, जैसे लेयर, पाथ, या एडजस्टमेंट।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | नया उदाहरण प्रारंभ करता है [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) क्लास का। |
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [StructureKey](#StructureKey) | Name संरचना कुंजी। |
## विधियाँ
...
| [getValue()](#getValue--) | Name संरचना के मान को प्राप्त या सेट करता है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Name संरचना के पहले स्ट्रिंग मान को प्राप्त या सेट करता है। |
...
| [setValue(String value)](#setValue-java.lang.String-) | Name संरचना के मान को प्राप्त या सेट करता है। |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
नया उदाहरण प्रारंभ करता है [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) क्लास का।
...
Name संरचना के मान को प्राप्त या सेट करता है।
...
Name संरचना के पहले स्ट्रिंग मान को प्राप्त या सेट करता है। यह आमतौर पर अंत लाइन प्रतीक शामिल करता है।
