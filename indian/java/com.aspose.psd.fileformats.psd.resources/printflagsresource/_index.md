...
description: "प्रिंट फ़्लैग्स संसाधन"
type: docs
weight: 30
url: /hi/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
प्रिंट फ़्लैग्स संसाधन
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | नए [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) क्लास का एक नया उदाहरण आरंभ करता है। |
## फ़ील्ड्स
...
| [getBleedScale()](#getBleedScale--) | ब्लीड स्केल को प्राप्त करता है या सेट करता है। |
| [getBleedWidth()](#getBleedWidth--) | ब्लीड की चौड़ाई को प्राप्त करता है या सेट करता है। |
| [getCenterCropMark()](#getCenterCropMark--) | केंद्र क्रॉप मार्क को प्राप्त करता है या सेट करता है। |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | ब्लीड स्केल को प्राप्त करता है या सेट करता है। |
| [setBleedWidth(int value)](#setBleedWidth-int-) | ब्लीड की चौड़ाई को प्राप्त करता है या सेट करता है। |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | केंद्र क्रॉप मार्क को प्राप्त करता है या सेट करता है। |
...
नए [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) क्लास का एक नया उदाहरण आरंभ करता है।
...
ब्लीड स्केल को प्राप्त करता है या सेट करता है।
...
ब्लीड की चौड़ाई को प्राप्त करता है या सेट करता है।
...
केंद्र क्रॉप मार्क को प्राप्त करता है या सेट करता है।

मान: केंद्र क्रॉप मार्क।
