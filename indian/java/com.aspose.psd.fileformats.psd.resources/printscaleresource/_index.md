...
description: "प्रिंट स्केल संसाधन"
type: docs
weight: 31
url: /hi/java/com.aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PrintScaleResource()](#PrintScaleResource--) | नया उदाहरण प्रारंभ करता है [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource) वर्ग का। |
## फ़ील्ड्स
...
| [getStyle()](#getStyle--) | स्टाइल को प्राप्त करता है या सेट करता है। |
| [getXLocation()](#getXLocation--) | x स्थान को प्राप्त करता है या सेट करता है। |
| [getYLocation()](#getYLocation--) | y स्थान को प्राप्त करता है या सेट करता है। |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setScale(float value)](#setScale-float-) | स्केल को प्राप्त करता है या सेट करता है। |
...
| [setStyle(short value)](#setStyle-short-) | स्टाइल को प्राप्त करता है या सेट करता है। |
| [setXLocation(float value)](#setXLocation-float-) | x स्थान को प्राप्त करता है या सेट करता है। |
| [setYLocation(float value)](#setYLocation-float-) | y स्थान को प्राप्त करता है या सेट करता है। |
| [toString()](#toString--) |  |
...
नया उदाहरण प्रारंभ करता है [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource) वर्ग का।
...
स्टाइल को प्राप्त करता है या सेट करता है।
...
x स्थान को प्राप्त करता है या सेट करता है।
...
y स्थान को प्राप्त करता है या सेट करता है।
