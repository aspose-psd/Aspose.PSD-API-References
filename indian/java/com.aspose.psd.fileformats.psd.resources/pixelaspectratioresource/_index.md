...
description: "Pixel aspect ration संसाधन"
type: docs
weight: 29
url: /hi/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
Pixel aspect ration संसाधन
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | नए उदाहरण को प्रारंभ करता है [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) क्लास का। |
## फ़ील्ड्स
...
| [getAspectRatio()](#getAspectRatio--) | अस्पेक्ट रेशियो को प्राप्त करता है या सेट करता है। |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | अस्पेक्ट रेशियो को प्राप्त करता है या सेट करता है। |
...
अस्पेक्ट रेशियो को प्राप्त करता है या सेट करता है।
