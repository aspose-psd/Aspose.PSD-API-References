...
description: "लेयर स्थिति जानकारी संसाधन"
type: docs
weight: 28
url: /hi/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | एक नया उदाहरण प्रारंभ करता है [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) क्लास का। |
## फ़ील्ड्स
...
| [getLayerIndex()](#getLayerIndex--) | लेयर के इंडेक्स को प्राप्त करता है या सेट करता है। |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | लेयर के इंडेक्स को प्राप्त करता है या सेट करता है। |
...
एक नया उदाहरण प्रारंभ करता है [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) क्लास का।
...
लेयर के इंडेक्स को प्राप्त करता है या सेट करता है।
