...
description: "Adobe Pdf नेमस्पेस का प्रतिनिधित्व करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.xmp.schemas.pdf/pdfpackage/
---
...
Adobe Pdf नेमस्पेस का प्रतिनिधित्व करता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PdfPackage()](#PdfPackage--) | PdfPackage वर्ग की एक नई इंस्टेंस को प्रारंभ करता है। |
## विधियाँ
...
| [setKeywords(String keywords)](#setKeywords-java.lang.String-) | कीवर्ड सेट करता है। |
| [setPdfVersion(String version)](#setPdfVersion-java.lang.String-) | Pdf संस्करण सेट करता है। |
| [setProducer(String producer)](#setProducer-java.lang.String-) | Pdf बनाने वाले टूल का नाम सेट करता है। |
| [setTrapped(boolean isTrapped)](#setTrapped-boolean-) | ट्रैप्ड सेट करता है। |
...
PdfPackage वर्ग की एक नई इंस्टेंस को प्रारंभ करता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| कीवर्ड | java.lang.String | कीवर्ड। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| version | java.lang.String | Pdf संस्करण, उदाहरण के लिए: 1.0, 1.3 आदि। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| उत्पादक | java.lang.String | उत्पादक नाम। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| isTrapped | boolean | यदि true पर सेट किया गया है तो दस्तावेज़ ट्रैप्ड हो गया है। |
