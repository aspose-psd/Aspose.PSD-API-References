...
description: "SmartObjectLayer क्लास को परिभाषित करता है जो PSD फ़ाइल में एम्बेडेड या बाहरी फ़ाइल में लिंक्ड स्मार्ट ऑब्जेक्ट को शामिल करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
SmartObjectLayer क्लास को परिभाषित करता है जो PSD फ़ाइल में एम्बेडेड या बाहरी फ़ाइल में लिंक्ड स्मार्ट ऑब्जेक्ट को सम्मिलित करता है। Smart Objects के साथ, आप कर सकते हैं: नॉन‑डिस्ट्रक्टिव ट्रांसफ़ॉर्म्स करना। आप लेयर को स्केल, रोटेट, स्क्यू, डिस्टॉर्ट, पर्सपेक्टिव ट्रांसफ़ॉर्म या वार्प कर सकते हैं बिना मूल छवि डेटा या गुणवत्ता खोए क्योंकि ट्रांसफ़ॉर्म्स don\\ufffdt मूल डेटा को प्रभावित नहीं करते। वेक्टर डेटा के साथ काम करें, जैसे Illustrator से वेक्टर आर्टवर्क, जिसे अन्यथा रास्टराइज़ किया जाता। नॉन‑डिस्ट्रक्टिव फ़िल्टरिंग करना। आप किसी भी समय Smart Objects पर लागू फ़िल्टर को संपादित कर सकते हैं। एक Smart Object को संपादित करें और उसके सभी लिंक्ड इंस्टेंस स्वचालित रूप से अपडेट हो जाएँ। लेयर मास्क लागू करें जो\\ufffds लिंक्ड या अनलिंक्ड हो Smart Object लेयर के लिए। विभिन्न डिज़ाइनों को कम‑रिज़ॉल्यूशन प्लेसहोल्डर इमेज़ के साथ आज़माएँ जिन्हें आप बाद में अंतिम संस्करणों से बदल सकते हैं। Adobe\\ufffd Photoshop\\ufffd में, आप एक इमेज़ की सामग्री को PSD दस्तावेज़ में एम्बेड कर सकते हैं। अधिक जानकारी यहाँ है: एम्बेडेड स्मार्ट ऑब्जेक्ट वाली लेयर में प्लेस्ड (PlLd) और SoLd रिसोर्सेज़ होते हैं जिनमें स्मार्ट ऑब्जेक्ट प्रॉपर्टीज़ होती हैं। PlLd रिसोर्स PSD संस्करण 10 से पुराने के लिए अकेला हो सकता है। इन रिसोर्सेज़ में ग्लोबल Lnk2Resource में LiFdDataSource का UniqueId, एम्बेडेड फ़ाइलनाम और अन्य पैरामीटर होते हैं, जिसमें मूल फ़ॉर्मेट में एम्बेडेड फ़ाइल कंटेंट बाइट एरे के रूप में शामिल है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | नए [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) क्लास का एक इंस्टेंस इनिशियलाइज़ करता है। |
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [BlendSignature](#BlendSignature) | ब्लेंड मोड हस्ताक्षर का प्रतिनिधित्व करता है। |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | दोनों प्लेस्ड और स्मार्ट ऑब्जेक्ट रिसोर्सेज़ पाए गए संदेश |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | संदेश: आप केवल एम्बेडेड स्मार्ट ऑब्जेक्ट को कॉपी कर सकते हैं |
| [LayerHeaderSize](#LayerHeaderSize) | लेयर हेडर आकार। |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | कोई placed या smart object रिसोर्स नहीं मिला संदेश |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | गलत placed रिसोर्स इंडेक्सेस संदेश |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | इस एम्बेडेड smart object को लिंक्ड smart object में बदलता है। |
...
| [duplicateLayer()](#duplicateLayer--) | इसको कॉपी करके एक नया smart object लेयर बनाता है। |
| [embedLinked()](#embedLinked--) | इस लेयर में लिंक्ड smart object को एम्बेड करता है। |
| [equals(Object obj)](#equals-java.lang.Object-) | निर्धारित करता है कि निर्दिष्ट ऑब्जेक्ट इस उदाहरण के बराबर है या नहीं। |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | एम्बेडेड या लिंक्ड कंटेंट को फ़ाइल में एक्सपोर्ट करता है। |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | यह रेंडर वॉर्प को प्राप्त करता है या सेट करता है या PS चित्र का उपयोग करता है। |
...
| [getContentType()](#getContentType--) | स्मार्ट ऑब्जेक्ट लेयर कंटेंट का प्रकार प्राप्त करता है। |
| [getContents()](#getContents--) | smart object लेयर कंटेंट को प्राप्त या सेट करता है। |
| [getContentsBounds()](#getContentsBounds--) | smart object कंटेंट की सीमाओं को प्राप्त या सेट करता है। |
| [getContentsSource()](#getContentsSource--) | smart object कंटेंट के स्रोत को प्राप्त या सेट करता है। |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | यह इमेज को warp करने के लिए अंतिम आकार को प्राप्त या सेट करता है। |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | मूल क्वाड्रिलेटर को प्राप्त या सेट करता है। |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | placed और smart लेयर रिसोर्स इंडेक्सेस तथा उचित placed रिसोर्स को प्राप्त करता है। |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | placed लेयर रिसोर्स को प्राप्त करता है। |
...
| [getSmartFilters()](#getSmartFilters--) | smart फ़िल्टर को प्राप्त करता है। |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | ट्रांसफ़ॉर्म क्वाड्रिलेटर को प्राप्त या सेट करता है। |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | यह वॉर्प में मदद करने वाले फ़ंक्शन प्राप्त करता है। |
| [getWarpSettings()](#getWarpSettings--) | यह संसाधन से सेट या प्राप्त किए गए वॉर्प पैरामीटर को प्राप्त करता है या सेट करता है (डिफ़ॉल्ट)। |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | smart object लेयर की एम्बेडेड या लिंक्ड इमेज कंटेंट को प्राप्त करता है। |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | इसको कॉपी करके एक नया smart object लेयर बनाता है। |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | जब इस [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) का कंटेनर सेट किया गया था, तब invoke करें। |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | लिंक्ड smart object को नई फ़ाइल से पुनः लिंक करता है। |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | smart object लेयर में एम्बेडेड smart object कंटेंट को बदलता है। |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | smart object लेयर में एम्बेडेड smart object कंटेंट को बदलता है। |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | कंटेंट को फ़ाइल से बदलता है। |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | कंटेंट को फ़ाइल से बदलता है। |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | कंटेंट को फ़ाइल से बदलता है। |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | कंटेंट को फ़ाइल से बदलता है। |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | चैनल डेटा का आकार बदलता है |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | यह रेंडर वॉर्प को प्राप्त करता है या सेट करता है या PS चित्र का उपयोग करता है। |
...
| [setContents(byte[] value)](#setContents-byte---) | smart object लेयर कंटेंट को प्राप्त या सेट करता है। |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | smart object कंटेंट की सीमाओं को प्राप्त या सेट करता है। |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | smart object कंटेंट के स्रोत को प्राप्त या सेट करता है। |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | यह इमेज को warp करने के लिए अंतिम आकार को प्राप्त या सेट करता है। |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | मूल क्वाड्रिलेटर को प्राप्त या सेट करता है। |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | स्मार्ट ऑब्जेक्ट प्रोवाइडर प्राप्त करता है। |
| [setTop(int value)](#setTop-int-) | टॉप लेयर स्थिति प्राप्त करता है या सेट करता है |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | ट्रांसफ़ॉर्म क्वाड्रिलेटर को प्राप्त या सेट करता है। |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | यह संसाधन से सेट या प्राप्त किए गए वॉर्प पैरामीटर को प्राप्त करता है या सेट करता है (डिफ़ॉल्ट)। |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | डेटा स्रोत पहचानकर्ता को अपडेट करता है। |
| [updateModifiedContent()](#updateModifiedContent--) | परिवर्तित कंटेंट के साथ smart object लेयर इमेज कैश को अपडेट करता है। |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | परिवर्तित कंटेंट के साथ smart object लेयर इमेज कैश को अपडेट करता है। |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | जब placedResource बदलता है या रूपांतरण की आवश्यकता होती है, तब placed / smart रिसोर्सेज को अपडेट करता है। |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | यह "IWarpSupport" के लिए लेयर प्रीव्यू को अपडेट करने वाला रैपर है। |
| [wait()](#wait--) |  |
...
नए [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) क्लास का एक इंस्टेंस इनिशियलाइज़ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | आइटम्स की स्ट्रीम |
...
दोनों प्लेस्ड और स्मार्ट ऑब्जेक्ट रिसोर्सेज़ पाए गए संदेश
...
संदेश: आप केवल एम्बेडेड स्मार्ट ऑब्जेक्ट को कॉपी कर सकते हैं
...
कोई placed या smart object रिसोर्स नहीं मिला संदेश
...
गलत placed रिसोर्स इंडेक्सेस संदेश
...
इस एम्बेडेड smart object को लिंक्ड smart object में बदलता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| linkedPath | java.lang.String | लिंक्ड पाथ। |
...
इसको कॉपी करके एक नया स्मार्ट ऑब्जेक्ट लेयर बनाता है। ध्यान दें कि एम्बेडेड स्मार्ट ऑब्जेक्ट्स के लिए एम्बेडेड इमेज साझा की जाती है। यदि आप एम्बेडेड इमेज को कॉपी करना चाहते हैं तो [.newSmartObjectViaCopy](../../null/\\#newSmartObjectViaCopy) मेथड का उपयोग करें।
...
इस लेयर में लिंक्ड smart object को एम्बेड करता है।
...
एम्बेडेड या लिंक्ड कंटेंट को फ़ाइल में एक्सपोर्ट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| filePath | java.lang.String | निर्यात फ़ाइल पथ। |
...
यह रेंडर वॉर्प को प्राप्त करता है या सेट करता है या PS चित्र का उपयोग करता है।
...
स्मार्ट ऑब्जेक्ट लेयर कंटेंट का प्रकार प्राप्त करता है। एम्बेडेड स्मार्ट ऑब्जेक्ट कंटेंट एम्बेडेड रॉ इमेज फ़ाइल है: LiFdDataSource.Data। लिंक्ड स्मार्ट ऑब्जेक्ट कंटेंट लिंक्ड इमेज फ़ाइल की रॉ सामग्री है यदि उपलब्ध हो: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)। हम Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd ग्राफ़िक्स लाइब्रेरी से लोडिंग का समर्थन नहीं करते जब  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)) true हो। नियमित लिंक फ़ाइलों के लिए, पहले हम LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)) का उपयोग करके फ़ाइल को स्रोत इमेज पाथ DataStreamSupporter.SourceImagePath के सापेक्ष खोजते हैं, यदि उपलब्ध नहीं है तो हम LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)) को देखते हैं, यदि फिर भी नहीं मिलता तो हम लिंक फ़ाइल को उसी डायरेक्टरी में देखते हैं जहाँ हमारी इमेज है: DataStreamSupporter.SourceImagePath।

मान: स्मार्ट ऑब्जेक्ट लेयर कंटेंट का प्रकार।
...
स्मार्ट ऑब्जेक्ट लेयर कंटेंट को प्राप्त करता है या सेट करता है। एम्बेडेड स्मार्ट ऑब्जेक्ट कंटेंट एम्बेडेड रॉ इमेज फ़ाइल है: LiFdDataSource.Data और उसकी प्रॉपर्टीज़। लिंक्ड स्मार्ट ऑब्जेक्ट कंटेंट लिंक्ड इमेज फ़ाइल की रॉ सामग्री है यदि उपलब्ध हो और उसकी प्रॉपर्टीज़: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)। हम Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd ग्राफ़िक्स लाइब्रेरी से लोडिंग का समर्थन नहीं करते जब  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)) true हो। नियमित लिंक फ़ाइलों के लिए, पहले हम LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)) का उपयोग करके फ़ाइल को स्रोत इमेज पाथ DataStreamSupporter.SourceImagePath के सापेक्ष खोजते हैं, यदि उपलब्ध नहीं है तो हम LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)) को देखते हैं, यदि फिर भी नहीं मिलता तो हम लिंक फ़ाइल को उसी डायरेक्टरी में देखते हैं जहाँ हमारी इमेज है: DataStreamSupporter.SourceImagePath।
...
smart object कंटेंट की सीमाओं को प्राप्त या सेट करता है।

मान: स्मार्ट ऑब्जेक्ट की सीमाएँ।
...
smart object कंटेंट के स्रोत को प्राप्त या सेट करता है।

मान: स्मार्ट ऑब्जेक्ट डेटा स्रोत।
...
यह इमेज को warp करने के लिए अंतिम आकार को प्राप्त या सेट करता है।
...
मूल क्वाड्रिलेटर को प्राप्त या सेट करता है।
...
placed और smart लेयर रिसोर्स इंडेक्सेस तथा उचित placed रिसोर्स को प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | संसाधन। |
| placedResourceIndex | int[] | प्लेस्ड रिसोर्स का इंडेक्स। |
| smartResourceIndex | int[] | स्मार्ट संसाधन का इंडेक्स। |
...
placed लेयर रिसोर्स को प्राप्त करता है।
...
smart फ़िल्टर को प्राप्त करता है।
...
ट्रांसफ़ॉर्म क्वाड्रिलेटर को प्राप्त या सेट करता है।

मान: ट्रांसफ़ॉर्म क्वाड्रिलेटर।
...
यह वॉर्प में मदद करने वाले फ़ंक्शन प्राप्त करता है।
...
यह संसाधन से सेट या प्राप्त किए गए वॉर्प पैरामीटर को प्राप्त करता है या सेट करता है (डिफ़ॉल्ट)।
...
smart object लेयर की एम्बेडेड या लिंक्ड इमेज कंटेंट को प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | विकल्प। |
...
इसको कॉपी करके एक नया स्मार्ट ऑब्जेक्ट लेयर बनाता है। लेयर -> स्मार्ट ऑब्जेक्ट्स -> नया स्मार्ट ऑब्जेक्ट Adobe\\ufffd Photoshop\\ufffd की कॉपी फ़ंक्शनैलिटी के माध्यम से पुनः उत्पन्न करता है। ध्यान दें कि यह केवल एम्बेडेड स्मार्ट ऑब्जेक्ट्स के लिए सक्षम है क्योंकि एम्बेडेड इमेज भी कॉपी की जाती है। यदि आप एम्बेडेड इमेज को साझा करना चाहते हैं तो [.duplicateLayer](../../null/\\#duplicateLayer) मेथड का उपयोग करें।
...
जब इस [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) का कंटेनर सेट किया गया था, तब invoke करें।
...
लिंक किए गए स्मार्ट ऑब्जेक्ट को नई फ़ाइल से पुनः लिंक करता है। बाद में UpdateModifiedContent मेथड को कॉल करने की आवश्यकता नहीं है।
...
smart object लेयर में एम्बेडेड smart object कंटेंट को बदलता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | छवि। |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | छवि। |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | रिज़ॉल्यूशन सेटिंग्स। यदि null है तो इमेज का रिज़ॉल्यूशन उपयोग किया जाएगा। |
...
सामग्री को फ़ाइल से बदलता है। बाद में UpdateModifiedContent मेथड को कॉल करने की आवश्यकता नहीं है।
...
| --- | --- | --- |
| linkedPath | java.lang.String | लिंक्ड पाथ। |
| isReplaceOnlyThis | boolean | यह फ़्लैग दर्शाता है कि इस स्मार्ट लेयर से या सभी स्मार्ट लेयर्स में इस सामग्री को बदलें। |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
डेटा स्रोत पहचानकर्ता को अपडेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | डेटा स्रोत पहचानकर्ता। |
...
परिवर्तित कंटेंट के साथ smart object लेयर इमेज कैश को अपडेट करता है।
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | छवि। |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | रिज़ॉल्यूशन। |
| skipBoundsUpdate | boolean | यदि true सेट किया गया है तो [बाउंड्स अपडेट छोड़ें]। |
...
जब placedResource बदलता है या रूपांतरण की आवश्यकता होती है, तब placed / smart रिसोर्सेज को अपडेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| toEmbedded | boolean | यदि true सेट किया गया है तो आवश्यक होने पर एम्बेडेड रिसोर्स में बदलें, अन्यथा लिंक्ड रिसोर्स में। |
...
यह "IWarpSupport" के लिए लेयर प्रीव्यू को अपडेट करने वाला रैपर है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | नए प्रीव्यू इमेज के पिक्सेल और आकार |
