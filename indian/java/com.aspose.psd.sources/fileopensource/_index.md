...
description: "खोलने के लिए फ़ाइल स्रोत का प्रतिनिधित्व करता है।"
type: docs
weight: 11
url: /hi/java/com.aspose.psd.sources/fileopensource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [FileOpenSource(String filePath)](#FileOpenSource-java.lang.String-) | FileOpenSource क्लास की एक नई इंस्टेंस को प्रारंभ करता है। |
## विधियाँ
...
| [getClass()](#getClass--) |  |
| [getFilePath()](#getFilePath--) | फ़ाइल खोलने के लिए पथ प्राप्त करता है। |
...
FileOpenSource क्लास की एक नई इंस्टेंस को प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| filePath | java.lang.String | फ़ाइल खोलने का पथ। |
...
फ़ाइल खोलने के लिए पथ प्राप्त करता है।

मान: फ़ाइल खोलने का पथ।
