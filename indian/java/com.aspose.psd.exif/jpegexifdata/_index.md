...
description: "jpeg फ़ाइलों के लिए EXIF डेटा कंटेनर।"
type: docs
weight: 12
url: /hi/java/com.aspose.psd.exif/jpegexifdata/
---
...
jpeg फ़ाइलों के लिए EXIF डेटा कंटेनर।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [JpegExifData()](#JpegExifData--) | JpegExifData क्लास का नया उदाहरण आरंभ करता है। |
| [JpegExifData(TiffDataType[] exifdata)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | एरे से डेटा के साथ JpegExifData क्लास का एक नया इंस्टेंस प्रारंभ करता है। |
| [JpegExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | एरे से डेटा के साथ JpegExifData क्लास का एक नया इंस्टेंस प्रारंभ करता है। |
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [MaxExifSegmentSize](#MaxExifSegmentSize) | अनुमत अधिकतम EXIF सेगमेंट आकार बाइट्स में। |
## विधियाँ
...
| [getBitsPerSample()](#getBitsPerSample--) | प्रति सैंपल बिट्स को प्राप्त करता है या सेट करता है। |
...
| [getCompression()](#getCompression--) | कम्प्रेशन को प्राप्त करता है या सेट करता है। |
| [getContrast()](#getContrast--) | कॉन्ट्रास्ट को प्राप्त या सेट करता है। |
| [getCopyright()](#getCopyright--) | कॉपीराइट को प्राप्त करता है या सेट करता है। |
...
| [getModel()](#getModel--) | मॉडल को प्राप्त करता है या सेट करता है। |
...
| [getPhotometricInterpretation()](#getPhotometricInterpretation--) | फोटोमेट्रिक व्याख्या को प्राप्त करता है या सेट करता है। |
...
| [getPrimaryChromaticities()](#getPrimaryChromaticities--) | छवि के तीन प्राथमिक रंगों की क्रोमैटिसिटी को प्राप्त करता है या सेट करता है। |
...
| [getReferenceBlackWhite()](#getReferenceBlackWhite--) | रेफ़रेंस ब्लैक व्हाइट को प्राप्त करता है या सेट करता है। |
...
| [getSamplesPerPixel()](#getSamplesPerPixel--) | प्रति पिक्सेल सैंपल्स को प्राप्त करता है या सेट करता है। |
...
| [getSoftware()](#getSoftware--) | सॉफ़्टवेयर को प्राप्त करता है या सेट करता है। |
...
| [getThumbnail()](#getThumbnail--) | थंबनेल छवि को प्राप्त करता है या सेट करता है। |
| [getTransferFunction()](#getTransferFunction--) | ट्रांसफ़र फ़ंक्शन को प्राप्त करता है या सेट करता है। |
...
| [getYCbCrCoefficients()](#getYCbCrCoefficients--) | RGB से YCbCr छवि डेटा में परिवर्तन के लिए मैट्रिक्स गुणांक को प्राप्त करता है या सेट करता है। |
| [getYCbCrPositioning()](#getYCbCrPositioning--) | ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों की स्थिति को प्राप्त करता है या सेट करता है। |
| [getYCbCrSubSampling()](#getYCbCrSubSampling--) | ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों के सैंपलिंग अनुपात को प्राप्त करता है या सेट करता है। |
...
| [serializeExifData()](#serializeExifData--) | EXIF डेटा को सीरियलाइज़ करता है। |
...
| [setBitsPerSample(int[] value)](#setBitsPerSample-int---) | प्रति सैंपल बिट्स को प्राप्त करता है या सेट करता है। |
...
| [setCompression(int value)](#setCompression-int-) | कम्प्रेशन को प्राप्त करता है या सेट करता है। |
| [setContrast(int value)](#setContrast-int-) | कॉन्ट्रास्ट को प्राप्त या सेट करता है। |
| [setCopyright(String value)](#setCopyright-java.lang.String-) | कॉपीराइट को प्राप्त करता है या सेट करता है। |
...
| [setModel(String value)](#setModel-java.lang.String-) | मॉडल को प्राप्त करता है या सेट करता है। |
...
| [setPhotometricInterpretation(int value)](#setPhotometricInterpretation-int-) | फोटोमेट्रिक व्याख्या को प्राप्त करता है या सेट करता है। |
...
| [setPrimaryChromaticities(TiffRational[] value)](#setPrimaryChromaticities-com.aspose.psd.fileformats.tiff.TiffRational---) | छवि के तीन प्राथमिक रंगों की क्रोमैटिसिटी को प्राप्त करता है या सेट करता है। |
...
| [setReferenceBlackWhite(TiffRational[] value)](#setReferenceBlackWhite-com.aspose.psd.fileformats.tiff.TiffRational---) | रेफ़रेंस ब्लैक व्हाइट को प्राप्त करता है या सेट करता है। |
...
| [setSamplesPerPixel(int value)](#setSamplesPerPixel-int-) | प्रति पिक्सेल सैंपल्स को प्राप्त करता है या सेट करता है। |
...
| [setSoftware(String value)](#setSoftware-java.lang.String-) | सॉफ़्टवेयर को प्राप्त करता है या सेट करता है। |
...
| [setThumbnail(RasterImage value)](#setThumbnail-com.aspose.psd.RasterImage-) | थंबनेल छवि को प्राप्त करता है या सेट करता है। |
| [setTransferFunction(int[] value)](#setTransferFunction-int---) | ट्रांसफ़र फ़ंक्शन को प्राप्त करता है या सेट करता है। |
...
| [setYCbCrCoefficients(TiffRational[] value)](#setYCbCrCoefficients-com.aspose.psd.fileformats.tiff.TiffRational---) | RGB से YCbCr छवि डेटा में परिवर्तन के लिए मैट्रिक्स गुणांक को प्राप्त करता है या सेट करता है। |
| [setYCbCrPositioning(int value)](#setYCbCrPositioning-int-) | ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों की स्थिति को प्राप्त करता है या सेट करता है। |
| [setYCbCrSubSampling(int[] value)](#setYCbCrSubSampling-int---) | ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों के सैंपलिंग अनुपात को प्राप्त करता है या सेट करता है। |
...
JpegExifData क्लास का नया उदाहरण आरंभ करता है।
...
एरे से डेटा के साथ JpegExifData क्लास का एक नया इंस्टेंस प्रारंभ करता है।
...
प्रति सैंपल बिट्स को प्राप्त करता है या सेट करता है।

मान: प्रति सैंपल बिट्स।
...
कॉपीराइट को प्राप्त करता है या सेट करता है।
...
मॉडल को प्राप्त करता है या सेट करता है।
...
फोटोमेट्रिक व्याख्या को प्राप्त करता है या सेट करता है।

मान: फोटोमेट्रिक व्याख्या।
...
छवि के तीन प्राथमिक रंगों की क्रोमैटिसिटी को प्राप्त करता है या सेट करता है।

मान: छवि के तीन प्राथमिक रंगों की क्रोमैटिसिटी।
...
प्रति पिक्सेल सैंपल्स को प्राप्त करता है या सेट करता है।

मान: प्रति पिक्सेल सैंपल।
...
थंबनेल छवि को प्राप्त करता है या सेट करता है।
...
ट्रांसफ़र फ़ंक्शन को प्राप्त करता है या सेट करता है।

मान: ट्रांसफ़र फ़ंक्शन।
...
RGB से YCbCr छवि डेटा में परिवर्तन के लिए मैट्रिक्स गुणांक को प्राप्त करता है या सेट करता है।

मान: RGB से YCbCr इमेज डेटा में परिवर्तन के लिए मैट्रिक्स गुणांक।
...
ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों की स्थिति को प्राप्त करता है या सेट करता है।

मान: ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों की स्थिति।
...
मान: ल्यूमिनेंस घटक के संबंध में क्रोमिनेंस घटकों का सैंपलिंग अनुपात।
...
EXIF डेटा को सीरियलाइज़ करता है। टैग मान और सामग्री लिखता है। सबसे अधिक प्रभाव डालने वाला आकार टैग थंबनेल टैग सामग्री है।

**Returns:**
byte[] - सीरियलाइज़ किया गया EXIF डेटा।

सही JPEG छवि बनाने के लिए कुल सेगमेंट आकार MaxExifSegmentSize बाइट्स से कम या बराबर होना चाहिए। संकेत: यदि आपका EXIF सेक्शन बहुत बड़ा है तो थंबनेल आकार कम करने या उसके संपीड़न को बदलने का प्रयास करें।
