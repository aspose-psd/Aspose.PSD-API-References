...
description: "एक्सपोज़र समायोजन लेयर।"
type: docs
weight: 18
url: /hi/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | एक्सपोज़र प्राप्त करता है या सेट करता है। |
...
| [getGammaCorrection()](#getGammaCorrection--) | गामा सुधार प्राप्त करता है या सेट करता है। |
...
| [setExposure(float value)](#setExposure-float-) | एक्सपोज़र प्राप्त करता है या सेट करता है। |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | गामा सुधार प्राप्त करता है या सेट करता है। |
...
Exposure को प्राप्त करता है या सेट करता है। PS में Exposure की सीमा -20 से +20 तक है।
...
GammaCorrection को प्राप्त करता है या सेट करता है। PS में GammaCorrection की सीमा 9.99 से +0.01 तक है।
...
Offset को प्राप्त करता है या सेट करता है। PS में Offset की सीमा -0.5 से +0.5 तक है।
