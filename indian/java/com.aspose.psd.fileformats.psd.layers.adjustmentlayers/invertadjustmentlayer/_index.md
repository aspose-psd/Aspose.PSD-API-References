...
description: "इनवर्ट समायोजन लेयर क्लास।"
type: docs
weight: 21
url: /hi/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | invert adjustment layer को प्रोसेस करता है। |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | निर्दिष्ट int ARGB array पर invert सुधार लागू करें। |
...
invert adjustment layer को प्रोसेस करता है।
...
निर्दिष्ट int ARGB array पर invert सुधार लागू करें।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| पिक्सेल | int[] | int ARGB array। |
