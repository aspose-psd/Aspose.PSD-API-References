...
description: "ब्लैक एंड व्हाइट समायोजन लेयर क्लास।"
type: docs
weight: 11
url: /hi/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| [getTintColor()](#getTintColor--) | टिंट रंग मान को प्राप्त करता है या सेट करता है। |
| [getTintColorBlue()](#getTintColorBlue--) | नीला टिंट रंग डबल मान को प्राप्त करता है या सेट करता है। |
| [getTintColorGreen()](#getTintColorGreen--) | हरा टिंट रंग डबल मान को प्राप्त करता है या सेट करता है। |
| [getTintColorRed()](#getTintColorRed--) | लाल टिंट रंग डबल मान को प्राप्त करता है या सेट करता है। |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | पिक्सेल को प्रोसेस करता है। |
...
| [setTintColor(int value)](#setTintColor-int-) | टिंट रंग मान को प्राप्त करता है या सेट करता है। |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | नीला टिंट रंग डबल मान को प्राप्त करता है या सेट करता है। |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | हरा टिंट रंग डबल मान को प्राप्त करता है या सेट करता है। |
| [setTintColorRed(double value)](#setTintColorRed-double-) | लाल टिंट रंग डबल मान को प्राप्त करता है या सेट करता है। |
...
टिंट रंग मान को प्राप्त करता है या सेट करता है।
