...
description: "ग्रेडिएंट मैप लेयर।"
type: docs
weight: 19
url: /hi/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
ग्रेडिएंट मैप लेयर। GrdmResource से डेटा का उपयोग करके ग्रेडिएंट मैप रेंडरिंग को संभालता है।
## फ़ील्ड्स
...
| [getGradientSettings()](#getGradientSettings--) | GrdmResource इंस्टेंस से पास किए गए ग्रेडिएंट सेटिंग्स इंस्टेंस को प्राप्त करता है या सेट करता है। |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | ग्रेडिएंट मैप लेयर को प्रोसेस करता है। |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | GrdmResource इंस्टेंस से पास किए गए ग्रेडिएंट सेटिंग्स इंस्टेंस को प्राप्त करता है या सेट करता है। |
...
| [toString()](#toString--) |  |
| [update()](#update--) | संबंधित लेयर रिसोर्स में लेयर डेटा को अपडेट करें [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
GrdmResource इंस्टेंस से पास किए गए ग्रेडिएंट सेटिंग्स इंस्टेंस को प्राप्त करता है या सेट करता है।
...
ग्रेडिएंट मैप लेयर को प्रोसेस करता है।
...
संबंधित लेयर रिसोर्स में लेयर डेटा को अपडेट करें [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
