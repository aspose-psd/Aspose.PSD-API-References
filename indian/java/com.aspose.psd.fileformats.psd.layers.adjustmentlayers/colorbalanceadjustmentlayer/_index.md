...
description: "कलर बैलेंस समायोजन लेयर क्लास।"
type: docs
weight: 16
url: /hi/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getHighlightsCyanRedBalance()](#getHighlightsCyanRedBalance--) | Highlights Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| [getHighlightsMagentaGreenBalance()](#getHighlightsMagentaGreenBalance--) | Highlights Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| [getHighlightsYellowBlueBalance()](#getHighlightsYellowBlueBalance--) | Highlights Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है। |
...
| [getMidtonesCyanRedBalance()](#getMidtonesCyanRedBalance--) | Midtones Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| [getMidtonesMagentaGreenBalance()](#getMidtonesMagentaGreenBalance--) | Midtones Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| [getMidtonesYellowBlueBalance()](#getMidtonesYellowBlueBalance--) | Midtones Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है। |
...
| [getPreserveLuminosity()](#getPreserveLuminosity--) | इस [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) ल्यूमिनोसिटी को संरक्षित करता है या नहीं, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
| [getShadowsCyanRedBalance()](#getShadowsCyanRedBalance--) | Shadows Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| [getShadowsMagentaGreenBalance()](#getShadowsMagentaGreenBalance--) | Shadows Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Shadows YellowBlue बैलेंस को प्राप्त करता है या सेट करता है। |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | निर्दिष्ट int RGB एरे पर वर्तमान शैडोज़, मिडटोन और हाइलाइट्स के लिए सुधार लागू करें। |
...
| [setHighlightsCyanRedBalance(short value)](#setHighlightsCyanRedBalance-short-) | Highlights Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| [setHighlightsMagentaGreenBalance(short value)](#setHighlightsMagentaGreenBalance-short-) | Highlights Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| [setHighlightsYellowBlueBalance(short value)](#setHighlightsYellowBlueBalance-short-) | Highlights Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है। |
...
| [setMidtonesCyanRedBalance(short value)](#setMidtonesCyanRedBalance-short-) | Midtones Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| [setMidtonesMagentaGreenBalance(short value)](#setMidtonesMagentaGreenBalance-short-) | Midtones Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| [setMidtonesYellowBlueBalance(short value)](#setMidtonesYellowBlueBalance-short-) | Midtones Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है। |
...
| [setPreserveLuminosity(boolean value)](#setPreserveLuminosity-boolean-) | इस [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) ल्यूमिनोसिटी को संरक्षित करता है या नहीं, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
| [setShadowsCyanRedBalance(short value)](#setShadowsCyanRedBalance-short-) | Shadows Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| [setShadowsMagentaGreenBalance(short value)](#setShadowsMagentaGreenBalance-short-) | Shadows Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Shadows YellowBlue बैलेंस को प्राप्त करता है या सेट करता है। |
...
Highlights Cyan Red बैलेंस को प्राप्त करता है या सेट करता है।
...
Highlights Magenta Green बैलेंस को प्राप्त करता है या सेट करता है।
...
Highlights Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है।
...
Midtones Cyan Red बैलेंस को प्राप्त करता है या सेट करता है।
...
Midtones Magenta Green बैलेंस को प्राप्त करता है या सेट करता है।
...
Midtones Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है।
...
इस [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) ल्यूमिनोसिटी को संरक्षित करता है या नहीं, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है।

मान:  true  यदि यह ल्यूमिनोसिटी को संरक्षित करता है; अन्यथा,  false .
...
Shadows Cyan Red बैलेंस को प्राप्त करता है या सेट करता है।
...
Shadows Magenta Green बैलेंस को प्राप्त करता है या सेट करता है।
...
Shadows YellowBlue बैलेंस को प्राप्त करता है या सेट करता है।
...
| पिक्सेल | int[] | पिक्सेल्स की array। |
| start | [Point](../../com.aspose.psd/point) | पिक्सेल का बायाँ शीर्ष स्थान। |
| end | [Point](../../com.aspose.psd/point) | पिक्सेल का दायाँ निचला स्थान। |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - पिक्सेल्स का rectangle और प्रोसेस किए गए पिक्सेल्स।
...
निर्दिष्ट int RGB एरे पर वर्तमान शैडोज़, मिडटोन और हाइलाइट्स के लिए सुधार लागू करें।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| पिक्सेल | int[] | int कलर RGB एरे। |
