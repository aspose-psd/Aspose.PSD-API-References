...
description: "सेलेक्टिव कलर समायोजन लेयर।"
type: docs
weight: 28
url: /hi/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | सेलेक्टिव कलर द्वारा सीएमवाईके सुधार प्राप्त करता है। |
| [getContainer()](#getContainer--) |   Image  कंटेनर प्राप्त करता है। |
| [getCorrectionMethod()](#getCorrectionMethod--) | सुधार विधि प्राप्त करता है या सेट करता है। |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | सेलेक्टिव कलर लेयर को प्रोसेस करता है। |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | सेलेक्टिव कलर द्वारा सीएमवाईके सुधार सेट करता है। |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | छवि कंटेनर सेट करता है। |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | सुधार विधि प्राप्त करता है या सेट करता है। |
...
सेलेक्टिव कलर द्वारा सीएमवाईके सुधार प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| selectiveColorsType | int | सेलेक्टिव रंग। |
...
सुधार विधि प्राप्त करता है या सेट करता है।
...
सेलेक्टिव कलर लेयर को प्रोसेस करता है।
...
सेलेक्टिव कलर द्वारा सीएमवाईके सुधार सेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| selectiveColorsType | int | सेलेक्टिव रंगों का प्रकार। |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | सीएमवाईके सुधार। |
