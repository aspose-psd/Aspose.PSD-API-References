...
description: "BMP फ़ाइल फ़ॉर्मेट निर्माण विकल्प।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.imageoptions/bmpoptions/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [BmpOptions()](#BmpOptions--) | BmpOptions क्लास का नया उदाहरण प्रारंभ करता है। |
| [BmpOptions(BmpOptions bmpOptions)](#BmpOptions-com.aspose.psd.imageoptions.BmpOptions-) | BmpOptions क्लास का नया उदाहरण प्रारंभ करता है। |
## विधियाँ
...
| [getBitsPerPixel()](#getBitsPerPixel--) | छवि बिट्स प्रति पिक्सेल गिनती को प्राप्त करता है या सेट करता है। |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBitsPerPixel(int value)](#setBitsPerPixel-int-) | छवि बिट्स प्रति पिक्सेल गिनती को प्राप्त करता है या सेट करता है। |
...
| [setCompression(long value)](#setCompression-long-) | कम्प्रेशन को प्राप्त करता है या सेट करता है। |
...
BmpOptions क्लास का नया उदाहरण प्रारंभ करता है।
...
| --- | --- | --- |
| bmpOptions | [BmpOptions](../../com.aspose.psd.imageoptions/bmpoptions) | BMP विकल्प। |
...
छवि बिट्स प्रति पिक्सेल गिनती को प्राप्त करता है या सेट करता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | int | छवि बिट्स प्रति पिक्सेल गिनती। |
