...
description: "JPEG2000 फ़ाइल फ़ॉर्मेट विकल्प।"
type: docs
weight: 14
url: /hi/java/com.aspose.psd.imageoptions/jpeg2000options/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [Jpeg2000Options()](#Jpeg2000Options--) | Jpeg2000Options क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
| [Jpeg2000Options(Jpeg2000Options jpeg2000Options)](#Jpeg2000Options-com.aspose.psd.imageoptions.Jpeg2000Options-) | Jpeg2000Options क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
## विधियाँ
...
| [getClass()](#getClass--) |  |
| [getCodec()](#getCodec--) | JPEG2000 कोडेक को प्राप्त करता है या सेट करता है |
| [getComments()](#getComments--) | Jpeg टिप्पणी मार्करों को प्राप्त करता है या सेट करता है। |
| [getCompressionRatios()](#getCompressionRatios--) | कम्प्रेशन अनुपात की एरे को प्राप्त करता है या सेट करता है। |
...
| [getIrreversible()](#getIrreversible--) | एक मान प्राप्त करता है जो दर्शाता है कि अपरिवर्तनीय DWT 9-7 (true) का उपयोग करना है या लॉसलेस DWT 5-3 कम्प्रेशन (डिफ़ॉल्ट) का उपयोग करना है। |
...
| [setCodec(int value)](#setCodec-int-) | JPEG2000 कोडेक को प्राप्त करता है या सेट करता है |
| [setComments(String[] value)](#setComments-java.lang.String---) | Jpeg टिप्पणी मार्करों को प्राप्त करता है या सेट करता है। |
| [setCompressionRatios(int[] value)](#setCompressionRatios-int---) | कम्प्रेशन अनुपात की एरे को प्राप्त करता है या सेट करता है। |
...
| [setIrreversible(boolean value)](#setIrreversible-boolean-) | एक मान सेट करता है जो दर्शाता है कि अपरिवर्तनीय DWT 9-7 (true) का उपयोग करना है या लॉसलेस DWT 5-3 कम्प्रेशन (डिफ़ॉल्ट) का उपयोग करना है। |
...
Jpeg2000Options क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है।
...
| --- | --- | --- |
| jpeg2000Options | [Jpeg2000Options](../../com.aspose.psd.imageoptions/jpeg2000options) | Jpeg2000 फ़ाइल फ़ॉर्मेट विकल्प जिनसे सेटिंग्स कॉपी की जाएँ। |
...
JPEG2000 कोडेक को प्राप्त करता है या सेट करता है
...
**Returns:**
java.lang.String[] - Jpeg टिप्पणी मार्कर।
...
कम्प्रेशन अनुपात की एरे को प्राप्त करता है या सेट करता है। क्रमिक लेयर्स के लिए विभिन्न कम्प्रेशन अनुपात। प्रत्येक गुणवत्ता स्तर के लिए निर्दिष्ट दर वांछित कम्प्रेशन फैक्टर है। घटते अनुपात आवश्यक हैं।

**Returns:**
int[] - कम्प्रेशन अनुपात।
...
एक मान प्राप्त करता है जो दर्शाता है कि अपरिवर्तनीय DWT 9-7 (true) का उपयोग करना है या लॉसलेस DWT 5-3 कम्प्रेशन (डिफ़ॉल्ट) का उपयोग करना है।

**Returns:**
boolean - एक मान जो दर्शाता है कि अपरिवर्तनीय DWT 9-7 (true) का उपयोग करना है या लॉसलेस DWT 5-3 कम्प्रेशन
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | java.lang.String[] | Jpeg टिप्पणी मार्कर। |
...
एक मान सेट करता है जो दर्शाता है कि अपरिवर्तनीय DWT 9-7 (true) का उपयोग करना है या लॉसलेस DWT 5-3 कम्प्रेशन (डिफ़ॉल्ट) का उपयोग करना है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | boolean | एक मान जो दर्शाता है कि अपरिवर्तनीय DWT 9-7 (true) का उपयोग करना है या लॉसलेस DWT 5-3 कम्प्रेशन |
