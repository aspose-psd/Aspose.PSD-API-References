...
description: "PDF विकल्प।"
type: docs
weight: 18
url: /hi/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PdfOptions()](#PdfOptions--) | एक नया उदाहरण प्रारंभ करता है [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) क्लास का. |
## विधियाँ
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | कोर PDF विकल्प प्राप्त करता है. |
...
| [getPageSize()](#getPageSize--) | पृष्ठ का आकार प्राप्त करता है. |
| [getPalette()](#getPalette--) | रंग पैलेट को प्राप्त करता है या सेट करता है। |
| [getPdfCoreOptions()](#getPdfCoreOptions--) | PDF कोर विकल्प |
| [getPdfDocumentInfo()](#getPdfDocumentInfo--) | दस्तावेज़ के लिए मेटाडेटा प्राप्त करता या सेट करता है. |
...
| [setPageSize(SizeF value)](#setPageSize-com.aspose.psd.SizeF-) | पृष्ठ का आकार सेट करता है। |
| [setPalette(IColorPalette value)](#setPalette-com.aspose.psd.IColorPalette-) | रंग पैलेट को प्राप्त करता है या सेट करता है। |
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | PDF कोर विकल्प |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | दस्तावेज़ के लिए मेटाडेटा प्राप्त करता या सेट करता है. |
...
एक नया उदाहरण प्रारंभ करता है [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) क्लास का.
...
कोर PDF विकल्प प्राप्त करता है.
...
दस्तावेज़ के लिए मेटाडेटा प्राप्त करता या सेट करता है.
