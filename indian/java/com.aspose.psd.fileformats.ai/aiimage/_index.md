...
description: "Adobe Illustrator AI छवि"
type: docs
weight: 14
url: /hi/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
एडोब इलस्ट्रेटर (AI) छवि
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [AiImage()](#AiImage--) | एक नया उदाहरण प्रारंभ करता है [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) क्लास का। |
## फ़ील्ड्स
...
| विधि | विवरण |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | AI लेयर सेक्शन जोड़ता है। |
| [cacheData()](#cacheData--) | डेटा को कैश करता है और सुनिश्चित करता है कि अंतर्निहित P:Aspose.PSD.DataStreamSupporter.DataStreamContainer से कोई अतिरिक्त डेटा लोडिंग नहीं होगी। |
...
| [getActivePageIndex()](#getActivePageIndex--) | सक्रिय पृष्ठ का सूचकांक प्राप्त करता है या सेट करता है। |
...
| [getDataSection()](#getDataSection--) | डेटा सेक्शन प्राप्त करता है। |
...
| [getFinalizeSection()](#getFinalizeSection--) | फ़ाइनलाइज़ सेक्शन प्राप्त करता है। |
...
| [getPageCount()](#getPageCount--) | पृष्ठों की संख्या। |
...
| [getSetupSection()](#getSetupSection--) | सेटअप सेक्शन प्राप्त करता है। |
...
| [getVersion()](#getVersion--) | Adobe Illustrator फ़ॉर्मेट का संस्करण प्राप्त करता है। |
| [getWidth()](#getWidth--) | छवि की चौड़ाई प्राप्त करता है। |
| [getXmpData()](#getXmpData--) | XMP मेटाडेटा प्राप्त करता है। |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | सक्रिय पृष्ठ का सूचकांक प्राप्त करता है या सेट करता है। |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | रेंडर की गई छवि प्राप्त करता है। |
...
एक नया उदाहरण प्रारंभ करता है [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) क्लास का।
...
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | AI लेयर सेक्शन। |
...
डेटा को कैश करता है और सुनिश्चित करता है कि अंतर्निहित P:Aspose.PSD.DataStreamSupporter.DataStreamContainer से कोई अतिरिक्त डेटा लोडिंग नहीं होगी।
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - ApsPage इंस्टेंस।
...
सक्रिय पृष्ठ का सूचकांक प्राप्त करता है या सेट करता है।

Value: यह प्रॉपर्टी केवल PDF फ़ॉर्मेट AI इमेज के लिए वास्तविक है। यदि इमेज PDF फ़ॉर्मेट में नहीं है या कोई पृष्ठ नहीं हैं, तो प्रॉपर्टी -1 होगी। यह प्रॉपर्टी दर्शाती है कि AI इमेज का कौन सा पृष्ठ रेंडरिंग के लिए आधार होगा।
...
फ़ाइनलाइज़ सेक्शन प्राप्त करता है।

Value: फ़ाइनलाइज़ सेक्शन।
...
पृष्ठों की संख्या। पुराने AI फ़ॉर्मेट की छवियों के लिए हमेशा 0 के बराबर होती है।

मान: पृष्ठों की संख्या।
...
Adobe Illustrator फ़ॉर्मेट का संस्करण प्राप्त करता है।
...
मान:  true  यदि ऑब्जेक्ट का डेटा कैश किया गया है; अन्यथा,  false .
...
रेंडर की गई छवि प्राप्त करता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| ventureLicense | java.lang.Object | वेंचर लाइसेंस ऑब्जेक्ट। |
