...
description: "PsdImage क्लास को परिभाषित करता है जो PSD फ़ाइलों को लोड, संपादित, सहेजने की क्षमता प्रदान करता है, साथ ही गुणों को अपडेट करना, वॉटरमार्क जोड़ना, ग्राफ़िक्स ऑपरेशन करना या एक फ़ाइल फ़ॉर्मेट को दूसरे में बदलना।"
type: docs
weight: 14
url: /hi/java/com.aspose.psd.fileformats.psd/psdimage/
---
...
PsdImage क्लास को परिभाषित करता है जो PSD फ़ाइलों को लोड, संपादित, सहेजने की क्षमता प्रदान करता है, साथ ही गुणों को अपडेट करना, वॉटरमार्क जोड़ना, ग्राफ़िक्स ऑपरेशन करना या एक फ़ाइल फ़ॉर्मेट को दूसरे में बदलना। Aspose.PSD निम्नलिखित फ़ॉर्मेटों में आयात को लेयर के रूप में और निर्यात को समर्थन देता है: Png, Jpeg, Jpeg2000, Gif, Bmp, Tiff, Psd, Psb के साथ चयन योग्य टेक्स्ट वाले Pdf में निर्यात।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PsdImage(String path)](#PsdImage-java.lang.String-) | निर्दिष्ट पथ से रास्टर इमेज (पथ में PSD इमेज नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [PsdImage(String path, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-java.lang.String-short-short-short-int-short-) | निर्दिष्ट पथ से रास्टर इमेज (पथ में PSD इमेज नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस कंस्ट्रक्टर पैरामीटरों के साथ प्रारंभ करता है। |
| [PsdImage(InputStream stream)](#PsdImage-java.io.InputStream-) | निर्दिष्ट पथ से रास्टर इमेज (स्ट्रीम में PSD इमेज नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [PsdImage(InputStream stream, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-java.io.InputStream-short-short-short-int-short-) | निर्दिष्ट पथ से रास्टर इमेज (स्ट्रीम में PSD इमेज नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस कंस्ट्रक्टर पैरामीटरों के साथ प्रारंभ करता है। |
| [PsdImage(RasterImage rasterImage)](#PsdImage-com.aspose.psd.RasterImage-) | मौजूदा रास्टर इमेज (PSD इमेज नहीं) से RGB कलर मोड, 4 चैनल, 8 बिट/चैनल और बिना संपीड़न के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [PsdImage(RasterImage rasterImage, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-com.aspose.psd.RasterImage-short-short-short-int-short-) | मौजूदा रास्टर इमेज (PSD इमेज नहीं) से कंस्ट्रक्टर पैरामीटरों के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [PsdImage(int width, int height)](#PsdImage-int-int-) | निर्दिष्ट चौड़ाई और ऊँचाई के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है। |
| [PsdImage(int width, int height, IColorPalette colorPalette, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-int-int-com.aspose.psd.IColorPalette-short-short-short-int-short-) | निर्दिष्ट चौड़ाई, ऊँचाई, पैलेट, कलर मोड, चैनल गिनती और चैनल बिट-लेंथ तथा निर्दिष्ट संपीड़न मोड पैरामीटरों के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है। |
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [DefaultStubEncodingName_internalized](#DefaultStubEncodingName-internalized) | डिफ़ॉल्ट एन्कोडिंग नाम |
| [DefaultVersion](#DefaultVersion) | डिफ़ॉल्ट PSD संस्करण। |
...
| [SyncLayersRoot_internalized](#SyncLayersRoot-internalized) | ऑब्जेक्ट जो लेयर्स तक पहुंच को सिंक्रनाइज़ करने के लिए उपयोग किया जा सकता है। |
| [horizontalResolution](#horizontalResolution) |  |
## विधियाँ

| विधि | विवरण |
| --- | --- |
| [addBlackWhiteAdjustmentLayer()](#addBlackWhiteAdjustmentLayer--) | ब्लैक व्हाइट एडजस्टमेंट लेयर जोड़ता है। |
| [addBrightnessContrastAdjustmentLayer(int brightness, int contrast)](#addBrightnessContrastAdjustmentLayer-int-int-) | ब्राइटनेस/कॉन्ट्रास्ट एडजस्टमेंट लेयर जोड़ता है। |
| [addChannelMixerAdjustmentLayer()](#addChannelMixerAdjustmentLayer--) | डिफ़ॉल्ट पैरामीटरों के साथ चैनल मिक्सर एडजस्टमेंट लेयर जोड़ता है |
| [addColorBalanceAdjustmentLayer()](#addColorBalanceAdjustmentLayer--) | कलर बैलेंस एडजस्टमेंट लेयर जोड़ता है। |
| [addCurvesAdjustmentLayer()](#addCurvesAdjustmentLayer--) | Curves Adjustment लेयर जोड़ता है। |
...
| [addExposureAdjustmentLayer(float exposure, float offset, float gammaCorrection)](#addExposureAdjustmentLayer-float-float-float-) | exposure adjustment लेयर जोड़ता है। |
| [addGradientMapAdjustmentLayer()](#addGradientMapAdjustmentLayer--) | GradientMap Adjustment लेयर जोड़ता है। |
| [addHueSaturationAdjustmentLayer()](#addHueSaturationAdjustmentLayer--) | hue/saturation adjustment लेयर जोड़ता है। |
| [addInvertAdjustmentLayer()](#addInvertAdjustmentLayer--) | एक invert adjustment लेयर जोड़ता है। |
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | लेयर जोड़ता है। |
| [addLayerGroup(String groupName, int index, boolean startBehaviour)](#addLayerGroup-java.lang.String-int-boolean-) | लेयर समूह को जोड़ता है। |
| [addLayer_internalized(Layer layer, int index)](#addLayer-internalized-com.aspose.psd.fileformats.psd.layers.Layer-int-) | इंडेक्स पर लेयर जोड़ता है। |
| [addLevelsAdjustmentLayer()](#addLevelsAdjustmentLayer--) | Levels adjustment लेयर जोड़ता है। |
| [addPhotoFilterLayer(Color color)](#addPhotoFilterLayer-com.aspose.psd.Color-) | photofilter लेयर जोड़ता है। |
| [addPosterizeAdjustmentLayer()](#addPosterizeAdjustmentLayer--) | Posterize Adjustment लेयर जोड़ता है। |
| [addRegularLayer()](#addRegularLayer--) | एक नया regular लेयर जोड़ता है। |
| [addSelectiveColorAdjustmentLayer()](#addSelectiveColorAdjustmentLayer--) | selective color adjustment लेयर जोड़ता है। |
| [addShapeLayer()](#addShapeLayer--) | खाली Shape लेयर जोड़ें। |
| [addTextLayer(String text, Rectangle rect)](#addTextLayer-java.lang.String-com.aspose.psd.Rectangle-) | एक नया Text लेयर जोड़ता है। |
| [addThresholdAdjustmentLayer()](#addThresholdAdjustmentLayer--) | Threshold adjustment लेयर जोड़ता है। |
| [addVibranceAdjustmentLayer()](#addVibranceAdjustmentLayer--) | Vibrance adjustment लेयर जोड़ता है। |
...
| [convert(PsdOptions newOptions)](#convert-com.aspose.psd.imageoptions.PsdOptions-) | इस इमेज फ़ॉर्मेट को विकल्पों में निर्दिष्ट फ़ॉर्मेट में बदलता है। |
...
| [flattenImage()](#flattenImage--) | सभी लेयर्स को फ्लैट करता है। |
| [getActiveLayer()](#getActiveLayer--) | सक्रिय लेयर को प्राप्त करता है या सेट करता है। |
...
| [getBackgroundContents_internalized()](#getBackgroundContents-internalized--) | बैकग्राउंड का रंग प्राप्त करता है या सेट करता है। |
| [getBitsPerChannel()](#getBitsPerChannel--) | प्रति चैनल बिट्स प्राप्त करता है। |
...
| [getChannelsCount()](#getChannelsCount--) | PSD चैनल की गिनती प्राप्त करता है। |
| [getClass()](#getClass--) |  |
| [getCmykColorProfile()](#getCmykColorProfile--) | CMYK PSD इमेजेज़ के लिए CMYK कलर प्रोफ़ाइल प्राप्त करता है या सेट करता है। |
| [getColorMode()](#getColorMode--) | कलर मोड प्राप्त करता है या सेट करता है। |
| [getCompression()](#getCompression--) | संपीड़न विधि प्राप्त करता है। |
| [getContainer()](#getContainer--) |   Image  कंटेनर प्राप्त करता है। |
| [getCurrentOptions_internalized()](#getCurrentOptions-internalized--) | वर्तमान छवि विकल्प प्राप्त करता है। |
...
| [getDefaultReplacementFont_internalized()](#getDefaultReplacementFont-internalized--) | डिफ़ॉल्ट प्रतिस्थापन फ़ॉन्ट प्राप्त करता है या सेट करता है। |
...
| [getGlobalAngle()](#getGlobalAngle--) | ग्लोबल एंगल को प्राप्त करता है या सेट करता है। |
| [getGlobalLayerMaskInfo()](#getGlobalLayerMaskInfo--) | वैश्विक लेयर मास्क जानकारी प्राप्त करता है। |
| [getGlobalLayerResources()](#getGlobalLayerResources--) | वैश्विक लेयर संसाधन प्राप्त करता है या सेट करता है। |
| [getGrayColorProfile()](#getGrayColorProfile--) | ग्रेस्केल PSD छवियों के लिए GRAY (मोनोक्रोम) रंग प्रोफ़ाइल प्राप्त करता है या सेट करता है। |
| [getHeight()](#getHeight--) | छवि की ऊँचाई प्राप्त करता है। |
| [getHorizontalResolution()](#getHorizontalResolution--) | इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की क्षैतिज रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है। |
| [getImageLayers_internalized()](#getImageLayers-internalized--) | PSD लेयर्स प्राप्त करता है या सेट करता है। |
| [getImageOpacity()](#getImageOpacity--) | इस छवि की अपारदर्शिता प्राप्त करता है। |
| [getImageResources()](#getImageResources--) | PSD छवि संसाधन प्राप्त करता है या सेट करता है। |
...
| [getLayerAndMask_internalized()](#getLayerAndMask-internalized--) | लेयर और मास्क प्राप्त करता है। |
| [getLayers()](#getLayers--) | PSD लेयर्स प्राप्त करता है या सेट करता है। |
| [getLinkedLayersManager()](#getLinkedLayersManager--) | लिंक्ड लेयर्स मैनेजर प्राप्त करता है। |
...
| [getPsdHeader_internalized()](#getPsdHeader-internalized--) | PSD हेडर प्राप्त करता है या सेट करता है। |
...
| [getRgbColorProfile()](#getRgbColorProfile--) | CMYK PSD छवियों के लिए RGB रंग प्रोफ़ाइल प्राप्त करता है या सेट करता है। |
...
| [getSmartObjectProvider()](#getSmartObjectProvider--) | स्मार्ट ऑब्जेक्ट प्रोवाइडर प्राप्त करता है। |
...
| [getTimeline()](#getTimeline--) | इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की टाइमलाइन ([.getTimeline](../../null/\#getTimeline)/[.setTimeline(Timeline)](../../null/\#setTimeline-Timeline-)) प्राप्त करता है। |
...
| [getUpdatedResourceBlocks_internalized(ResourceBlock[] resources, ResourceBlock resource, boolean removeDuplicates)](#getUpdatedResourceBlocks-internalized-com.aspose.psd.fileformats.psd.ResourceBlock---com.aspose.psd.fileformats.psd.ResourceBlock-boolean-) | ब्रांड न्यू रिसोर्स ब्लॉक के साथ अद्यतन संसाधन प्राप्त करता है। |
...
| [getVerticalResolution()](#getVerticalResolution--) | इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की लंबवत रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है। |
...
| [hasAlpha()](#hasAlpha--) | इस RasterImage की ऊर्ध्वाधर रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है। |
...
| [hasTransparencyData()](#hasTransparencyData--) | लेयर्स डेटा निर्दिष्ट करते समय यह दर्शाने वाला मान प्राप्त करता है या सेट करता है कि पहला अल्फा चैनल मर्ज्ड परिणाम के लिए पारदर्शिता डेटा रखता है या नहीं। |
...
| [insertLayerAfter_internalized(Layer layer, Layer layerToInsert)](#insertLayerAfter-internalized-com.aspose.psd.fileformats.psd.layers.Layer-com.aspose.psd.fileformats.psd.layers.Layer-) | निर्दिष्ट लेयर के बाद सभी तैयारियों के साथ लेयर सम्मिलित करता है। |
| [isCached()](#isCached--) | एक मान प्राप्त करता है जो यह दर्शाता है कि वर्तमान में छवि डेटा कैश किया गया है या नहीं। |
| [isFlatten()](#isFlatten--) | यह दर्शाने वाला मान प्राप्त करता है कि PSD छवि फ्लैटेड है या नहीं। |
...
| [mergeLayers(Layer bottomLayer, Layer topLayer)](#mergeLayers-com.aspose.psd.fileformats.psd.layers.Layer-com.aspose.psd.fileformats.psd.layers.Layer-) | लेयर्स को मर्ज करता है। |
...
| [removeGlobalTextEngineResource_internalized()](#removeGlobalTextEngineResource-internalized--) | वैश्विक टेक्स्ट इंजन रिसोर्स को हटाता है - यह मेथड कुछ टेक्स्ट-लेयर वाले PSD फ़ाइलों के लिए उपयोग किया जाता है, जिन्हें प्रोसेसिंग के बाद Adobe Photoshop में नहीं खोला जा सकता (मुख्यतः अनुपलब्ध फ़ॉन्ट्स वाले टेक्स्ट लेयर से संबंधित)। |
...
| [saveSpecificLayers_internalized(System.IO.Stream stream, ImageOptionsBase optionsBase, Rectangle boundsRectangle, Layer[] layersToExport)](#saveSpecificLayers-internalized-com.aspose.ms.System.IO.Stream-com.aspose.psd.ImageOptionsBase-com.aspose.psd.Rectangle-com.aspose.psd.fileformats.psd.layers.Layer---) | निर्दिष्ट सहेजने विकल्पों और सीमाओं का उपयोग करके छवि डेटा को निर्दिष्ट स्ट्रीम में सहेजता है। |
...
| [setActiveLayer(Layer value)](#setActiveLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | सक्रिय लेयर को प्राप्त करता है या सेट करता है। |
...
| [setBackgroundContents_internalized(RawColor value)](#setBackgroundContents-internalized-com.aspose.psd.fileformats.psd.rawcolor.RawColor-) | बैकग्राउंड का रंग प्राप्त करता है या सेट करता है। |
...
| [setCmykColorProfile(StreamSource value)](#setCmykColorProfile-com.aspose.psd.sources.StreamSource-) | CMYK PSD इमेजेज़ के लिए CMYK कलर प्रोफ़ाइल प्राप्त करता है या सेट करता है। |
| [setColorMode(short value)](#setColorMode-short-) | कलर मोड प्राप्त करता है या सेट करता है। |
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | वैश्विक कोण। |
| [setGlobalLayerResources(LayerResource[] value)](#setGlobalLayerResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | वैश्विक लेयर संसाधन प्राप्त करता है या सेट करता है। |
| [setGrayColorProfile(StreamSource value)](#setGrayColorProfile-com.aspose.psd.sources.StreamSource-) | ग्रे (एकरंगी) रंग प्रोफ़ाइल ग्रेस्केल PSD छवियों के लिए। |
| [setHorizontalResolution(double value)](#setHorizontalResolution-double-) | इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की क्षैतिज रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है। |
...
| [setImageResources(ResourceBlock[] value)](#setImageResources-com.aspose.psd.fileformats.psd.ResourceBlock---) | PSD छवि संसाधन प्राप्त करता है या सेट करता है। |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | PSD लेयर्स प्राप्त करता है या सेट करता है। |
...
| [setResolution(double dpiX, double dpiY)](#setResolution-double-double-) | इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की रिज़ॉल्यूशन सेट करता है। |
| [setRgbColorProfile(StreamSource value)](#setRgbColorProfile-com.aspose.psd.sources.StreamSource-) | CMYK PSD छवियों के लिए RGB रंग प्रोफ़ाइल प्राप्त करता है या सेट करता है। |
| [setRotateMode_internalized(int value)](#setRotateMode-internalized-int-) | रोटेट मोड प्राप्त करता है या सेट करता है |
| [setTransparencyData(boolean value)](#setTransparencyData-boolean-) | लेयर्स डेटा निर्दिष्ट करते समय यह दर्शाने वाला मान प्राप्त करता है या सेट करता है कि पहला अल्फा चैनल मर्ज्ड परिणाम के लिए पारदर्शिता डेटा रखता है या नहीं। |
...
| [setVentureLicense_internalized(Object ventureLicense)](#setVentureLicense-internalized-java.lang.Object-) | वेंचर लाइसेंस सेट करता है। |
| [setVersion(int value)](#setVersion-int-) | संस्करण को प्राप्त करता है या सेट करता है। |
| [setVerticalResolution(double value)](#setVerticalResolution-double-) | इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की लंबवत रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है। |
...
निर्दिष्ट पथ से रास्टर छवि (पथ में psd छवि नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। डिफ़ॉल्ट पैरामीटर के साथ psd छवि को इनिशियलाइज़ करने के लिए उपयोग किया जाता है - Color mode - rgb, 4 channels, 8 bit per channel, Compression - Raw.

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| path | java.lang.String | पिक्सेल और पैलेट डेटा लोड करने और इनिशियलाइज़ करने के लिए पथ। |
...
निर्दिष्ट पथ से रास्टर इमेज (पथ में PSD इमेज नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस कंस्ट्रक्टर पैरामीटरों के साथ प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| path | java.lang.String | पिक्सेल और पैलेट डेटा लोड करने और इनिशियलाइज़ करने के लिए पथ। |
| colorMode | short | रंग मोड। |
| channelBitDepth | short | प्रति चैनल PSD बिट डेप्थ। |
| channels | short | PSD चैनलों की संख्या। |
| psdVersion | int | PSD संस्करण। |
| compression | short | उपयोग करने के लिए संपीड़न। |
...
निर्दिष्ट पथ से रास्टर छवि (स्ट्रीम में psd छवि नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। डिफ़ॉल्ट पैरामीटर के साथ psd छवि को इनिशियलाइज़ करने के लिए उपयोग किया जाता है - Color mode - rgb, 4 channels, 8 bit per channel, Compression - Raw.

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| stream | java.io.InputStream | पिक्सेल और पैलेट डेटा लोड करने और इनिशियलाइज़ करने के लिए स्ट्रीम। |
...
निर्दिष्ट पथ से रास्टर इमेज (स्ट्रीम में PSD इमेज नहीं) के आधार पर [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस कंस्ट्रक्टर पैरामीटरों के साथ प्रारंभ करता है।
...
मौजूदा रास्टर इमेज (PSD इमेज नहीं) से RGB कलर मोड, 4 चैनल, 8 बिट/चैनल और बिना संपीड़न के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| rasterImage | [RasterImage](../../com.aspose.psd/rasterimage) | पिक्सेल और पैलेट डेटा लोड करने और इनिशियलाइज़ करने के लिए छवि। |
...
मौजूदा रास्टर इमेज (PSD इमेज नहीं) से कंस्ट्रक्टर पैरामीटरों के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास का नया इंस्टेंस प्रारंभ करता है।
...
निर्दिष्ट चौड़ाई और ऊँचाई के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। खाली psd छवि को इनिशियलाइज़ करने के लिए उपयोग किया जाता है।
...
निर्दिष्ट चौड़ाई, ऊँचाई, पैलेट, रंग मोड, चैनलों की संख्या और चैनल बिट-लेंथ तथा निर्दिष्ट संपीड़न मोड पैरामीटरों के साथ [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। खाली psd छवि को इनिशियलाइज़ करने के लिए उपयोग किया जाता है।
...
ऑब्जेक्ट जो लेयर्स तक पहुंच को सिंक्रनाइज़ करने के लिए उपयोग किया जा सकता है।
...
Curves Adjustment लेयर जोड़ता है।
...
exposure adjustment लेयर जोड़ता है।
...
GradientMap Adjustment लेयर जोड़ता है।
...
hue/saturation adjustment लेयर जोड़ता है।
...
एक invert adjustment लेयर जोड़ता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| groupName | java.lang.String | समूह का नाम। |
| सूचकांक | int | उस लेयर के बाद सम्मिलित करने के लिए लेयर का सूचकांक। |
| startBehaviour | boolean | यदि इसे  true  [start behaviour] पर सेट किया जाता है तो समूह प्रारंभ पर खुली स्थिति में रहेगा, अन्यथा न्यूनतम स्थिति में रहेगा। |
...
Levels adjustment लेयर जोड़ता है।
...
Posterize Adjustment लेयर जोड़ता है।
...
selective color adjustment लेयर जोड़ता है।
...
खाली Shape लेयर जोड़ें। बिना पाथ के। उन्हें सहेजने से पहले Shape लेयर में जोड़ा जाना चाहिए।
...
एक नया Text लेयर जोड़ता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| पाठ | java.lang.String | लेयर का पाठ। |
| rect | [Rectangle](../../com.aspose.psd/rectangle) | लेयर का आयत। |
...
Threshold adjustment लेयर जोड़ता है।
...
Vibrance adjustment लेयर जोड़ता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| newOptions | [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) | नए विकल्प। |
...
नई [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) क्लास की इंस्टेंस बनाता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| psdHeader | com.aspose.internal.fileformats.psd.sections.PsdHeader | PSD हेडर। |
| colorData | com.aspose.internal.fileformats.psd.sections.ColorData | रंग डेटा। |
| imageResources | com.aspose.internal.fileformats.psd.sections.ImageResources | छवि संसाधन। |
| layerAndMaskInfo | com.aspose.internal.fileformats.psd.sections.LayerAndMaskInfo | लेयर और मास्क जानकारी। |
| imageData | com.aspose.internal.fileformats.psd.sections.ImageData | छवि डेटा। |
| colorPalette | [IColorPalette](../../com.aspose.psd/icolorpalette) | रंग पैलेट। |
| version | int | PSD संस्करण। |
| loadOptions | [LoadOptions](../../com.aspose.psd/loadoptions) | लोड विकल्प। |
| noLayerLoad | boolean | कोई लेयर लोड नहीं |
...
सक्रिय लेयर को प्राप्त करता है या सेट करता है।
...
PSD चैनल की गिनती प्राप्त करता है।

मान: PSD चैनलों की गिनती।
...
CMYK PSD छवियों के लिए CMYK रंग प्रोफ़ाइल को प्राप्त करता है या सेट करता है। सही रंग रूपांतरण के लिए इसे RgbColorProfile के साथ जोड़ा जाना चाहिए।

मान: CMYK रंग प्रोफ़ाइल।
...
कलर मोड प्राप्त करता है या सेट करता है।
...
वर्तमान छवि विकल्प प्राप्त करता है।
...
डिफ़ॉल्ट प्रतिस्थापन फ़ॉन्ट को प्राप्त करता है या सेट करता है। यदि प्रतिस्थापन फ़ॉन्ट सेट किया गया है तो इसे रेंडरिंग के लिए उपयोग किया जाएगा। हमें इस मेथड की आंतरिक समर्थन के लिए आवश्यकता है।

**Returns:**
java.lang.String - प्रतिस्थापन फ़ॉन्ट का नाम
...
वैश्विक लेयर मास्क जानकारी प्राप्त करता है।
...
वैश्विक लेयर संसाधन प्राप्त करता है या सेट करता है।

मान: वैश्विक लेयर संसाधन।
...
ग्रेस्केल PSD छवियों के लिए GRAY (मोनोक्रोम) रंग प्रोफ़ाइल प्राप्त करता है या सेट करता है।

मान: ग्रे (एकरंगी) रंग प्रोफ़ाइल।
...
इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की क्षैतिज रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है।
...
PSD लेयर्स प्राप्त करता है या सेट करता है।

मान: PSD लेयर्स।

--------------------

ध्यान दें कि यदि लेयर्स नहीं हैं तो लेयर और मास्क जानकारी अनुभाग के भीतर अन्य संबंधित जानकारी (लेयर मास्क, संसाधन आदि) संरक्षित नहीं रहेगी।
...
PSD छवि संसाधन प्राप्त करता है या सेट करता है।
...
लिंक्ड लेयर्स मैनेजर प्राप्त करता है।
...
PSD हेडर प्राप्त करता है या सेट करता है।
...
CMYK PSD छवियों के लिए RGB रंग प्रोफ़ाइल को प्राप्त करता है या सेट करता है। सही रंग रूपांतरण के लिए इसे CmykColorProfile के साथ जोड़ा जाना चाहिए।

मान: RGB रंग प्रोफ़ाइल।
...
स्मार्ट ऑब्जेक्ट प्रोवाइडर प्राप्त करता है।

मान: स्मार्ट ऑब्जेक्ट प्रदाता।
...
इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की टाइमलाइन ([.getTimeline](../../null/\#getTimeline)/[.setTimeline(Timeline)](../../null/\#setTimeline-Timeline-)) प्राप्त करता है।
...
ब्रांड न्यू रिसोर्स ब्लॉक के साथ अद्यतन संसाधन प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| resources | [ResourceBlock\[\]](../../com.aspose.psd.fileformats.psd/resourceblock) | संसाधन। |
| resource | [ResourceBlock](../../com.aspose.psd.fileformats.psd/resourceblock) | मौजूदा संसाधनों में जोड़ने के लिए संसाधन। |
| removeDuplicates | boolean | यदि true पर सेट किया गया है तो समान IDs वाले संसाधनों को हटा देता है। |

**Returns:**
com.aspose.psd.fileformats.psd.ResourceBlock[] - अद्यतन संसाधन ब्लॉकों के साथ एक एरे लौटाता है।
...
इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की लंबवत रिज़ॉल्यूशन, पिक्सेल प्रति इंच में, प्राप्त करता है या सेट करता है।
...
मान: यदि इस इंस्टेंस की छवि बदल गई है तो true; अन्यथा false।
...
लेयर्स डेटा निर्दिष्ट करते समय यह दर्शाने वाला मान प्राप्त करता है या सेट करता है कि पहला अल्फा चैनल मर्ज्ड परिणाम के लिए पारदर्शिता डेटा रखता है या नहीं।

मान: यदि लेयर डेटा निर्दिष्ट करने पर पहला अल्फा चैनल मर्ज किए गए परिणाम के लिए पारदर्शिता डेटा रखता है तो true; अन्यथा false।
...
निर्दिष्ट लेयर के बाद सभी तैयारियों के साथ लेयर सम्मिलित करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | लेयर। |
| layerToInsert | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | डालने के लिए लेयर। |
...
यह दर्शाने वाला मान प्राप्त करता है कि PSD छवि फ्लैटेड है या नहीं।

मान:  true  यदि यह उदाहरण फ्लैटन है; अन्यथा,  false .
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| bottomLayer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | निचला लेयर। |
| topLayer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | ऊपरी लेयर। |
...
वैश्विक टेक्स्ट इंजन रिसोर्स को हटाता है - यह मेथड कुछ टेक्स्ट-लेयर वाले PSD फ़ाइलों के लिए उपयोग किया जाता है, जिन्हें प्रोसेसिंग के बाद Adobe Photoshop में नहीं खोला जा सकता (मुख्यतः अनुपस्थित फ़ॉन्ट्स वाले टेक्स्ट लेयर्स के कारण)। इस विकल्प का उपयोग करने के बाद, उपयोगकर्ता को Photoshop में खुले फ़ाइल में निम्न करना होगा: मेन्यू \"Text\" -> \"Process absent fonts\"। इसके बाद सभी टेक्स्ट फिर से दिखाई देंगे। कृपया ध्यान दें, इस ऑपरेशन से अंतिम लेआउट में कुछ परिवर्तन हो सकते हैं।
...
निर्दिष्ट स्ट्रीम में निर्दिष्ट सेव विकल्पों और बाउंड्स का उपयोग करके इमेज डेटा को सहेजता है। वैकल्पिक रूप से केवल निर्दिष्ट लेयर्स को रेंडरिंग प्रीव्यू के लिए निर्यात करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | स्ट्रीम जहाँ इमेज डेटा सहेजा जाएगा। |
| optionsBase | [ImageOptionsBase](../../com.aspose.psd/imageoptionsbase) | उपयोग करने के लिए सहेजने विकल्प। |
| boundsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | गंतव्य इमेज बाउंड्स आयत। स्रोत बाउंड्स उपयोग करने के लिए इसे Rectangle.Empty सेट करें। |
| layersToExport | [Layer\[\]](../../com.aspose.psd.fileformats.psd.layers/layer) | निर्यात करने के लिए विशिष्ट लेयर्स। एक  null  मान सभी लेयर्स के साथ डिफ़ॉल्ट व्यवहार दर्शाता है। |
...
ग्रे (एकरंगी) रंग प्रोफ़ाइल ग्रेस्केल PSD छवियों के लिए।
...
इस [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) की रिज़ॉल्यूशन सेट करता है।
...
वेंचर लाइसेंस सेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| ventureLicense | java.lang.Object | वेंचर लाइसेंस। |
