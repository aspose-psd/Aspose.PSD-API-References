...
description: "छवि डेटा के लिए उपयोग किए जाने वाले संपीड़न विधि को परिभाषित करता है।"
type: docs
weight: 11
url: /hi/java/com.aspose.psd.fileformats.psd/compressionmethod/
---
...
छवि डेटा के लिए उपयोग किए जाने वाले संपीड़न विधि को परिभाषित करता है।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [RLE](#RLE) | RLE संपीड़ित छवि डेटा सभी स्कैन लाइनों (पंक्तियों \* चैनल) के बाइट काउंट से शुरू होता है, जहाँ प्रत्येक काउंट दो-बाइट मान के रूप में संग्रहीत होता है। |
| [Raw](#Raw) | कोई संपीड़न नहीं। |
| [ZipWithPrediction](#ZipWithPrediction) | भविष्यवाणी के साथ ZIP। |
| [ZipWithoutPrediction](#ZipWithoutPrediction) | भविष्यवाणी के बिना ZIP। |
## विधियाँ
...
कोई संपीड़न नहीं। छवि डेटा RGBA प्लेनर क्रम में कच्चे बाइट्स के रूप में संग्रहीत किया जाता है। इसका मतलब है कि पहले सभी R डेटा लिखा जाता है, फिर सभी G, फिर सभी B और अंत में सभी A डेटा लिखा जाता है।
