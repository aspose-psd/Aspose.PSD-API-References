...
description: "क्लास lnsrResource."
type: docs
weight: 51
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | नए [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | नए [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
## फ़ील्ड्स
...
| [getValue()](#getValue--) | यदि संबंधित enum वर्णित है तो मान को LnsrResourceType के रूप में प्राप्त करता है। |
| [hashCode()](#hashCode--) |  |
...
नए [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| lnsrResourceType | int | LNSR का प्रकार। |
...
नए [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। कस्टम या अज्ञात मान के साथ
...
मान: LnsrResourceType के रूप में मान।
