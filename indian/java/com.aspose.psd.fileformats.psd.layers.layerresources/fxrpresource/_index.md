...
description: "क्लास FxrpResource।"
type: docs
weight: 32
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
क्लास **FxrpResource**. लेयर का संदर्भ बिंदु.
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | एक नया उदाहरण प्रारंभ करता है [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) क्लास का। |
| [FxrpResource()](#FxrpResource--) | एक नया उदाहरण प्रारंभ करता है [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) क्लास का। |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | एक नया उदाहरण प्रारंभ करता है [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) क्लास का। |
## फ़ील्ड्स
...
| [getX()](#getX--) | संदर्भ बिंदु के x को प्राप्त करता है या सेट करता है. |
| [getY()](#getY--) | संदर्भ बिंदु के y को प्राप्त करता है या सेट करता है. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | निर्दिष्ट स्ट्रीम कंटेनर में सहेजता है। |
...
| [setX(double value)](#setX-double-) | संदर्भ बिंदु के x को प्राप्त करता है या सेट करता है. |
| [setY(double value)](#setY-double-) | संदर्भ बिंदु के y को प्राप्त करता है या सेट करता है. |
...
एक नया उदाहरण प्रारंभ करता है [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) क्लास का।
...
एक नया उदाहरण प्रारंभ करता है [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) क्लास का। कस्टम या अज्ञात मान के साथ।
...
संदर्भ बिंदु के x को प्राप्त करता है या सेट करता है.

मान: संदर्भ बिंदु का x.
...
संदर्भ बिंदु के y को प्राप्त करता है या सेट करता है.

मान: संदर्भ बिंदु का y
