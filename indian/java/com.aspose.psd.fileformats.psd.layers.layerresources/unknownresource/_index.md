...
type: docs
weight: 82
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | एक नया इंस्टेंस इनिशियलाइज़ करता है [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) क्लास का। |
## फ़ील्ड्स
...
एक नया इंस्टेंस इनिशियलाइज़ करता है [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) क्लास का।
