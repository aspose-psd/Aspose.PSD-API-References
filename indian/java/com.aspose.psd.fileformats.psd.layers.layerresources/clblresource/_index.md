...
description: "क्लास ClblResource।"
type: docs
weight: 20
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
क्लास ClblResource. यह रिसोर्स क्लिप्ड एलिमेंट के ब्लेंडिंग के बारे में जानकारी रखता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [ClblResource()](#ClblResource--) | नया इंस्टेंस प्रारंभ करता है [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) क्लास का। |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | नया इंस्टेंस प्रारंभ करता है [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) क्लास का। |
| [ClblResource(byte[] data)](#ClblResource-byte---) | नया इंस्टेंस प्रारंभ करता है [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) क्लास का। |
## फ़ील्ड्स
...
| [getBlendClippedElements()](#getBlendClippedElements--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि क्या [blend clipped elements]। |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) का मान सत्य या असत्य है, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
| [hashCode()](#hashCode--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि क्या [blend clipped elements]। |
...
| [setValue(boolean value)](#setValue-boolean-) | [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) का मान सत्य या असत्य है, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
नया इंस्टेंस प्रारंभ करता है [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) क्लास का।
...
| --- | --- | --- |
| blendClippedElements | boolean | यदि इसे  true  पर सेट किया गया है तो [blend clipped elements]। |
...
नए [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) क्लास की एक नई इंस्टेंस को इनिशियलाइज़ करता है। कस्टम या अज्ञात मान के साथ
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि क्या [blend clipped elements]।

मान: यदि [blend clipped elements] सत्य है; अन्यथा, असत्य।
...
[BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) का मान सत्य या असत्य है, यह दर्शाने वाला मान प्राप्त करता है या सेट करता है।

मान: true यदि मान सत्य है; अन्यथा, false।
