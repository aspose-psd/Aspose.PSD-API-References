...
type: docs
weight: 70
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PhflResourceVersion3()](#PhflResourceVersion3--) | नया उदाहरण प्रारंभ करता है [PhflResourceVersion3](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3) क्लास का। |
| [PhflResourceVersion3(byte[] data)](#PhflResourceVersion3-byte---) | नया उदाहरण प्रारंभ करता है [PhflResourceVersion3](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3) क्लास का। |
## फ़ील्ड्स
...
| [getColorX()](#getColorX--) | X रंग को प्राप्त करता है या सेट करता है। |
| [getColorY()](#getColorY--) | Y रंग को प्राप्त करता है या सेट करता है। |
| [getColorZ()](#getColorZ--) | Z रंग को प्राप्त करता है या सेट करता है। |
...
| [setColorX(float value)](#setColorX-float-) | X रंग को प्राप्त करता है या सेट करता है। |
| [setColorY(float value)](#setColorY-float-) | Y रंग को प्राप्त करता है या सेट करता है। |
| [setColorZ(float value)](#setColorZ-float-) | Z रंग को प्राप्त करता है या सेट करता है। |
...
नया उदाहरण प्रारंभ करता है [PhflResourceVersion3](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3) क्लास का।
...
X रंग को प्राप्त करता है या सेट करता है।
...
Z रंग को प्राप्त करता है या सेट करता है।
...
संस्करण प्राप्त करता है। डिफ़ॉल्ट 2 या 3 है।
