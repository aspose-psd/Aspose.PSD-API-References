...
description: "वर्ग PattResource।"
type: docs
weight: 66
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
क्लास PattResource. पैटर्न डेटा वाला रिसोर्स
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [PattResource()](#PattResource--) | नया उदाहरण प्रारंभ करता है [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) क्लास का। |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | नया उदाहरण प्रारंभ करता है [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) क्लास का। |
## फ़ील्ड्स
...
| [TypeToolKey](#TypeToolKey) | 8-बिट के लिए 'Patt' प्रकार टूल जानकारी कुंजी। |
| [TypeToolKey2](#TypeToolKey2) | 16-बिट के लिए 'Pat2' प्रकार टूल जानकारी कुंजी। |
| [TypeToolKey3](#TypeToolKey3) | 32-बिट के लिए 'Pat3' प्रकार टूल जानकारी कुंजी। |
| [ventureLicense_internalized](#ventureLicense-internalized) | वेंचर लाइसेंस। |
## विधियाँ

| विधि | विवरण |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | डिफ़ॉल्ट डेटा के साथ Patt रिसोर्स को अपडेट करता है। |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | डिफ़ॉल्ट गैर-खाली रिसोर्स बनाता है। |
...
| [getPatterns()](#getPatterns--) | पैटर्न डेटा को प्राप्त करता या सेट करता है; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | पैटर्न डेटा को प्राप्त करता या सेट करता है; |
| [toString()](#toString--) | इस इंस्टेंस का प्रतिनिधित्व करने वाली एक स्ट्रिंग लौटाता है। |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | पैटर्न डेटा आइटम को खोजता है और उसे नया द्वारा अपडेट करता है, अन्यथा, एरे के अंत में नया जोड़ता है। |
| [wait()](#wait--) |  |
...
नया उदाहरण प्रारंभ करता है [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) क्लास का।
...
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | पैटर्न डेटा। |
...
8-बिट के लिए 'Patt' प्रकार टूल जानकारी कुंजी।
...
16-बिट के लिए 'Pat2' प्रकार टूल जानकारी कुंजी।
...
32-बिट के लिए 'Pat3' प्रकार टूल जानकारी कुंजी।
...
डिफ़ॉल्ट डेटा के साथ Patt रिसोर्स को अपडेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | संसाधन। |
...
डिफ़ॉल्ट गैर-खाली रिसोर्स बनाता है।
...
पैटर्न डेटा को प्राप्त करता या सेट करता है;
...
पैटर्न डेटा आइटम को खोजता है और उसे नया द्वारा अपडेट करता है, अन्यथा, एरे के अंत में नया जोड़ता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | पैटर्न आइटम को अपडेट करने के लिए पैटर्न सेटिंग्स ऑब्जेक्ट। |
