...
description: "क्लास CgEdResource।"
type: docs
weight: 18
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource/
---
...
क्लास CgEdResource. कंटेंट जेनरेटर एक्स्ट्रा डेटा (Photoshop CS5)
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [CgEdResource()](#CgEdResource--) | नया उदाहरण प्रारंभ करता है [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) क्लास का। |
## फ़ील्ड्स
...
| [getAuto()](#getAuto--) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि यह [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) स्वचालित है या नहीं। |
...
| [getLabColor()](#getLabColor--) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि [lab color] उपयोग किया गया है या नहीं। |
...
| [getPropertyValueByTypeStructure_internalized(String structureName)](#getPropertyValueByTypeStructure-internalized-java.lang.String-) | टाइप संरचना द्वारा प्रॉपर्टी मान प्राप्त करता है। |
...
| [getUseLegacy()](#getUseLegacy--) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि [use legacy] उपयोग किया गया है या नहीं। |
...
| [setAuto(boolean value)](#setAuto-boolean-) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि यह [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) स्वचालित है या नहीं। |
| [setBrightness(int value)](#setBrightness-int-) | brightness को प्राप्त करता है या सेट करता है। |
...
| [setLabColor(boolean value)](#setLabColor-boolean-) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि [lab color] उपयोग किया गया है या नहीं। |
| [setMeanValueForBrightnessAndContrast(int value)](#setMeanValueForBrightnessAndContrast-int-) | चमक और कंट्रास्ट के लिए औसत मान को प्राप्त करता या सेट करता है। |
...
| [setUseLegacy(boolean value)](#setUseLegacy-boolean-) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि [use legacy] उपयोग किया गया है या नहीं। |
...
नया उदाहरण प्रारंभ करता है [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) क्लास का। PSD फ़ॉर्मेट विनिर्देश में निम्न विवरण शामिल है: 4 डिस्क्रिप्टर वर्ज़न (= 16) अतिरिक्त डेटा का वैरिएबल लंबाई डिस्क्रिप्टर। सुझाव: यह पुराने PS संस्करणों (CS5 से पहले) में उपयोग नहीं हो सकता है।
...
एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि यह [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) स्वचालित है या नहीं।

मान:  true  यदि स्वचालित है; अन्यथा,  false .
...
एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि [lab color] उपयोग किया गया है या नहीं।

मान:  true  यदि [lab color] का उपयोग किया गया है; अन्यथा,  false .
...
प्रॉपर्टी मान को टाइप स्ट्रक्चर द्वारा प्राप्त करता है। केवल UnitTests के लिए उपयोग किया जाता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| structureName | java.lang.String | स्ट्रक्चर का नाम। |

**Returns:**
java.lang.Object - आसान unit-testing के लिए OSType स्ट्रक्चर
...
एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि [use legacy] उपयोग किया गया है या नहीं।

मान:  true  यदि [use legacy] है; अन्यथा,  false .
