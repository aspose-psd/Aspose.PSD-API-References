...
description: "यह रिसोर्स लेयर के फ़ोटोशॉप संस्करण को दर्शाता है।"
type: docs
weight: 60
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
यह रिसोर्स लेयर के फ़ोटोशॉप संस्करण को दर्शाता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | नए [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है। |
## फ़ील्ड्स
...
| [getVersion()](#getVersion--) | लेयर के फोटोशॉप संस्करण को प्राप्त करता है या सेट करता है। |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | लेयर के फोटोशॉप संस्करण को प्राप्त करता है या सेट करता है। |
| [toString()](#toString--) | इस इंस्टेंस का प्रतिनिधित्व करने वाली एक स्ट्रिंग लौटाता है। |
| [wait()](#wait--) |  |
| [wait(long arg0)](#wait-long-) |  |
| [wait(long arg0, int arg1)](#wait-long-int-) |  |
### LyvrResource() {#LyvrResource--}
```
public LyvrResource()
```


नए [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है।
...
लेयर के फोटोशॉप संस्करण को प्राप्त करता है या सेट करता है।
