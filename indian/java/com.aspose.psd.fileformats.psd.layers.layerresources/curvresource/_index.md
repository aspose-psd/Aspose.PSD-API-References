...
description: "क्लास CurvResource।"
type: docs
weight: 23
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/curvresource/
---
...
Class CurvResource. Curves Adjustment Layer का संसाधन 1 बाइट - यदि कर्व्स उपयोग में हों तो 0, यदि मानचित्र पर पिक्सेल उपयोग में हों तो 1; यदि 0 है तो: 2 बाइट - शॉर्ट। डिफ़ॉल्ट 1 4 बाइट - int। केवल अंतिम बाइट बिट द्वारा उपयोग किया जाता है। पहला बिट 1 चैनल के लिए, चौथा बिट 4 चैनल के लिए उदाहरण के रूप में 2 बाइट - शॉर्ट पॉइंट्स काउंट 4 बाइट \\* पॉइंट की गिनती - कर्व के पॉइंट्स 2 शॉर्ट: पहला स्थान, दूसरा ऊँचाई 4 बाइट - शब्द \"Crv \" 2 बाइट - शॉर्ट डिफ़ॉल्ट 4 कर्व्स के लिए 4 बाइट - int। डिफ़ॉल्ट 1 4 बाइट - पॉइंट काउंट 4 बाइट \\* पॉइंट काउंट - कर्व के पॉइंट्स 2 शॉर्ट: पहला स्थान, दूसरा ऊँचाई 0-4 बाइट - चार के लिए फोल्ड किया जाना चाहिए यदि 1 है तो: 2 बाइट - शॉर्ट। डिफ़ॉल्ट 1 4 बाइट - int। केवल अंतिम बाइट उपयोग किया जाता है। एक चैनल एक बिट में है। पहला बिट 1 चैनल के लिए, चौथा बिट 4 चैनल के लिए उदाहरण के रूप में 256 \\* बदले हुए चैनलों की गिनती - 0-255 रेंज में चैनल के क्रमबद्ध मान 4 बाइट - शब्द \"Crv \" 2 बाइट - शॉर्ट। डिफ़ॉल्ट 3 मानचित्र पर पिक्सेल के लिए 4 बाइट - int चैनल काउंट (2 + 256) बाइट - शॉर्ट 2 चैनल इंडेक्स के लिए, 256 0-255 रेंज में चैनल के क्रमबद्ध मान हैं।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [CurvResource(int maxChannelCount)](#CurvResource-int-) | [CurvResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/curvresource) क्लास का नया उदाहरण प्रारंभ करता है। |
| [CurvResource(byte[] bytes)](#CurvResource-byte---) | [CurvResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/curvresource) क्लास का नया उदाहरण प्रारंभ करता है। |
## फ़ील्ड्स
...
| [getActiveManager()](#getActiveManager--) | सक्रिय प्रबंधक प्राप्त करता है। |
| [getChannelData(int channelIndex)](#getChannelData-int-) | चैनल डेटा प्राप्त करता है। |
| [getClass()](#getClass--) |  |
| [getCurveManager()](#getCurveManager--) | कर्व प्रबंधक प्राप्त करता है। |
...
| [hashCode()](#hashCode--) |  |
| [isDataStoredDiscretely()](#isDataStoredDiscretely--) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि यह उदाहरण डेटा को अलग-अलग संग्रहीत करता है या नहीं। |
...
| [setDataStoredDiscretely(boolean value)](#setDataStoredDiscretely-boolean-) | एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि यह उदाहरण डेटा को अलग-अलग संग्रहीत करता है या नहीं। |
...
[CurvResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/curvresource) क्लास का नया उदाहरण प्रारंभ करता है।
...
एक मान प्राप्त करता या सेट करता है जो दर्शाता है कि यह उदाहरण डेटा को अलग-अलग संग्रहीत करता है या नहीं।

मान: true यदि यह उदाहरण डेटा को अलग-अलग संग्रहीत करता है; अन्यथा, false।
