...
description: "यह लेयर सेक्शन रिसोर्स।"
type: docs
weight: 43
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
यह लेयर सेक्शन रिसोर्स।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | एक नया उदाहरण प्रारंभ करता है [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) क्लास का। |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | एक नया उदाहरण प्रारंभ करता है [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) क्लास का। |
## फ़ील्ड्स
...
| [getSectionType()](#getSectionType--) | सेक्शन प्रकार को प्राप्त करता है या सेट करता है। |
| [getSignature()](#getSignature--) | लेयर रिसोर्स सिग्नेचर प्राप्त करता है। |
| [getSubtype()](#getSubtype--) | सबटाइप को प्राप्त करता है या सेट करता है। |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | सेक्शन प्रकार को प्राप्त करता है या सेट करता है। |
| [setSubtype(int value)](#setSubtype-int-) | सबटाइप को प्राप्त करता है या सेट करता है। |
...
एक नया उदाहरण प्रारंभ करता है [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) क्लास का।
...
सेक्शन प्रकार को प्राप्त करता है या सेट करता है।
...
सबटाइप को प्राप्त करता है या सेट करता है।
