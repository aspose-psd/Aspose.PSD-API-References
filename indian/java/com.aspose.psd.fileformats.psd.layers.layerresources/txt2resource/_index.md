...
description: "Txt2 संसाधन वर्ग"
type: docs
weight: 76
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [Txt2Resource()](#Txt2Resource--) | नए उदाहरण को प्रारंभ करता है [Txt2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource) क्लास का। |
## फ़ील्ड्स
...
| विधि | विवरण |
| --- | --- |
| [addTextRecord(String text, RectangleF bounds)](#addTextRecord-java.lang.String-com.aspose.psd.RectangleF-) | टेक्स्ट रिकॉर्ड को रिसोर्स में जोड़ता है और टेक्स्ट रिकॉर्ड का आईडी लौटाता है। |
...
| [getKeys_internalized(System.Collections.Generic.Dictionary<String,Object> tree)](#getKeys-internalized-com.aspose.ms.System.Collections.Generic.Dictionary-java.lang.String-java.lang.Object--) | जाँचता है कि रिसोर्स संकुचित है। |
| [getLength()](#getLength--) | लेयर रिसोर्स की लंबाई बाइट्स में प्राप्त करता है। |
| [getParsedTxt2Model_internalized()](#getParsedTxt2Model-internalized--) | txt2 डेटा को Txt2DataRoot क्लास के उदाहरण में पार्स करता है। |
...
| [getTextData()](#getTextData--) | रिसोर्स डेटा से टेक्स्ट रिकॉर्ड प्राप्त करता है। |
| [getText_internalized()](#getText-internalized--) | नाम प्राप्त करता है या सेट करता है। |
| [getTxt2FromParsedTree_internalized(System.Collections.Generic.Dictionary<String,Object> tree)](#getTxt2FromParsedTree-internalized-com.aspose.ms.System.Collections.Generic.Dictionary-java.lang.String-java.lang.Object--) | पार्स किए गए ट्री से TXT2 प्राप्त करता है। |
| [getTxt2ParsedTree_internalized()](#getTxt2ParsedTree-internalized--) | TXT2 का पार्स किया गया ट्री प्राप्त करता है। |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [removeTextRecord_internalized(int textIndex)](#removeTextRecord-internalized-int-) | रिसोर्स से टेक्स्ट रिकॉर्ड हटाता है। |
...
| [setData(byte[] value)](#setData-byte---) | डेटा को प्राप्त करता है या सेट करता है। |
...
| [setText_internalized(String value)](#setText-internalized-java.lang.String-) | नाम प्राप्त करता है या सेट करता है। |
| [toString()](#toString--) | इस इंस्टेंस का प्रतिनिधित्व करने वाली एक स्ट्रिंग लौटाता है। |
| [updateTextData_internalized(int textIndex, String newText, double fontSize, Color color)](#updateTextData-internalized-int-java.lang.String-double-com.aspose.psd.Color-) | टेक्स्ट इंडेक्स के द्वारा टेक्स्ट रिकॉर्ड को नए डिफ़ॉल्ट टेक्स्ट डेटा और नए टेक्स्ट, फ़ॉन्ट आकार और रंग के साथ अपडेट करता है। |
| [updateTxt2DataFromModel_internalized(Txt2DataRoot txt2DataRoot)](#updateTxt2DataFromModel-internalized-com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot-) | Txt2DataRoot मॉडल से txt2 डेटा को अपडेट करता है। |
| [wait()](#wait--) |  |
...
नए उदाहरण को प्रारंभ करता है [Txt2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/txt2resource) क्लास का।
...
| --- | --- | --- |
| पाठ | java.lang.String | रिकॉर्ड टेक्स्ट। |
| bounds | [RectangleF](../../com.aspose.psd/rectanglef) | सीमाएँ। |

**Returns:**
int - रिसोर्स के लिए टेक्स्ट रिकॉर्ड का आईडी लौटाता है
...
जाँचता है कि रिसोर्स संकुचित है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| ट्री | com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> | ट्री। |

**Returns:**
com.aspose.internal.fileformats.psd.layers.layerresources.ITextEngineKeys - कुंजियों के साथ ऑब्जेक्ट लौटाता है।
### getLength() {#getLength--}
```
...
txt2 डेटा को Txt2DataRoot क्लास के उदाहरण में पार्स करता है।

**Returns:**
com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot - txt2 डेटा को Txt2DataRoot क्लास के उदाहरण के रूप में।
...
**Returns:**
java.lang.String[] - पाठ रिकॉर्ड की सरणी
...
पार्स किए गए ट्री से TXT2 प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| ट्री | com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> | डेटा वृक्ष. |

**Returns:**
java.lang.String - Txt2 डेटा.
...
TXT2 का पार्स किया गया ट्री प्राप्त करता है।

**Returns:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.Object> - पार्स किया गया वृक्ष
### hashCode() {#hashCode--}
```
...
रिसोर्स से टेक्स्ट रिकॉर्ड हटाता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| textIndex | int | हटाने के लिए पाठ रिकॉर्ड का सूचकांक. |
...
टेक्स्ट इंडेक्स के द्वारा टेक्स्ट रिकॉर्ड को नए डिफ़ॉल्ट टेक्स्ट डेटा और नए टेक्स्ट, फ़ॉन्ट आकार और रंग के साथ अपडेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| textIndex | int | txt2 संसाधन डेटा में पाठ रिकॉर्ड का सूचकांक. |
| newText | java.lang.String | नया पाठ. |
| fontSize | double | नया फ़ॉन्ट आकार. |
| color | [Color](../../com.aspose.psd/color) | नया पाठ रंग. |
...
Txt2DataRoot मॉडल से txt2 डेटा को अपडेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| txt2DataRoot | com.aspose.internal.fileformats.psd.layers.text.txt2data.Txt2DataRoot | txt2 डेटा मॉडल. |
