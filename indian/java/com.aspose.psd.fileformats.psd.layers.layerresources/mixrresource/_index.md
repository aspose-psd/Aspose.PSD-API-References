...
description: "वर्ग MixrResource।"
type: docs
weight: 61
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [MixrResource()](#MixrResource--) | नया उदाहरण प्रारंभ करता है [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) क्लास का। |
| [MixrResource(byte[] data)](#MixrResource-byte---) | नया उदाहरण प्रारंभ करता है [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) क्लास का। |
## फ़ील्ड्स
...
| [getChannelInfo(int channelIndex)](#getChannelInfo-int-) | चैनल जानकारी का कच्चा डेटा प्राप्त करता है |
| [getClass()](#getClass--) |  |
...
| [getMonochrome()](#getMonochrome--) | इस [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) के मोनोक्रोम होने को दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
| [setChannelInfo(int channelIndex, byte[] value)](#setChannelInfo-int-byte---) | चैनल जानकारी सेट करता है। |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | इस [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) के मोनोक्रोम होने को दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
नया उदाहरण प्रारंभ करता है [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) क्लास का। PSD फ़ॉर्मेट विनिर्देश में निम्नलिखित विवरण शामिल है: 2 संस्करण (= 1) 2 मोनोक्रोम 20 RGB या CMYK रंग प्लस मिक्सर सेटिंग्स के लिए स्थिरांक। 4 \* 2 बाइट्स रंग के साथ 2 बाइट्स स्थिरांक।
...
इस [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) के मोनोक्रोम होने को दर्शाने वाला मान प्राप्त करता है या सेट करता है।
