...
description: "क्लास InfxResource."
type: docs
weight: 39
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Class InfxResource. यह संसाधन क्लिप किए गए तत्व के मिश्रण के बारे में जानकारी रखता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | नए [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) वर्ग का एक नया उदाहरण आरंभ करता है। |
| [InfxResource()](#InfxResource--) | नए [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) वर्ग का एक नया उदाहरण आरंभ करता है। |
| [InfxResource(byte[] data)](#InfxResource-byte---) | नए [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) वर्ग का एक नया उदाहरण आरंभ करता है। |
## फ़ील्ड्स
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | [blend interior elements] को दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | [blend interior elements] को दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
नए [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) वर्ग का एक नया उदाहरण आरंभ करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| blendInteriorElements | boolean | यदि सेट किया गया है true [blend interior elements]। |
...
नए [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) वर्ग का एक नया उदाहरण आरंभ करता है। कस्टम या अज्ञात मान के साथ।
...
[blend interior elements] को दर्शाने वाला मान प्राप्त करता है या सेट करता है।

मान: true यदि [blend interior elements]; अन्यथा, false।
