...
description: "ड्रॉप शैडो लेयर इफ़ेक्ट"
type: docs
weight: 12
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layereffects/dropshadoweffect/
---
...
| [getAngle()](#getAngle--) | डिग्री में कोण प्राप्त करता है या सेट करता है। |
...
| [getDistance()](#getDistance--) | पिक्सेल में दूरी प्राप्त करता है या सेट करता है। |
...
| [getKnocksOut()](#getKnocksOut--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [knocks out]। |
| [getNoise()](#getNoise--) | शोर प्राप्त करता है या सेट करता है। |
| [getOpacity()](#getOpacity--) | अपारदर्शिता को प्राप्त करता है या सेट करता है। |
| [getSize()](#getSize--) | पिक्सेल में ब्लर मान प्राप्त करता है या सेट करता है। |
| [getSpread()](#getSpread--) | प्रतिशत के रूप में तीव्रता प्राप्त करता है या सेट करता है। |
| [getUseGlobalLight()](#getUseGlobalLight--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि क्या [use this angle in all of the layer effects]। |
| [hashCode()](#hashCode--) |  |
| [isVisible()](#isVisible--) | यह दर्शाने वाला मान प्राप्त करता है या सेट करता है कि यह इंस्टेंस दृश्यमान है या नहीं। |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAngle(int value)](#setAngle-int-) | डिग्री में कोण प्राप्त करता है या सेट करता है। |
...
| [setDistance(int value)](#setDistance-int-) | पिक्सेल में दूरी प्राप्त करता है या सेट करता है। |
| [setKnocksOut(boolean value)](#setKnocksOut-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [knocks out]। |
...
| [setSize(int value)](#setSize-int-) | पिक्सेल में ब्लर मान प्राप्त करता है या सेट करता है। |
| [setSpread(int value)](#setSpread-int-) | प्रतिशत के रूप में तीव्रता प्राप्त करता है या सेट करता है। |
| [setUseGlobalLight(boolean value)](#setUseGlobalLight-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि क्या [use this angle in all of the layer effects]। |
...
पिक्सेल में दूरी प्राप्त करता है या सेट करता है।
...
पिक्सेल में ब्लर मान प्राप्त करता है या सेट करता है।
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि क्या [use this angle in all of the layer effects]।

मान:  true  यदि [use global light]; अन्यथा,  false .
