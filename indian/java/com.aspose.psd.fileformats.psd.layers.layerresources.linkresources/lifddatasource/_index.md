...
description: "PSD फ़ाइल में liFD डेटा स्रोत क्लास को परिभाषित करता है जो एम्बेडेड फ़ाइल के बारे में जानकारी रखती है।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
PSD फ़ाइल में liFD डेटा स्रोत क्लास को परिभाषित करता है जो एम्बेडेड फ़ाइल की जानकारी रखती है। यह PSD फ़ाइल फ़ॉर्मेट मैनिपुलेशन API का हिस्सा है जो Adobe® Photoshop® फ़ाइलों को संशोधित करने में मदद करता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | नए [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) क्लास का एक नया उदाहरण प्रारंभ करता है। |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | नए [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) क्लास का एक नया उदाहरण प्रारंभ करता है। |
## फ़ील्ड्स
...
| [getData()](#getData--) | PSD फ़ाइल में एम्बेडेड स्मार्ट ऑब्जेक्ट डेटा को प्राप्त करता है या सेट करता है। |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | एम्बेडेड डेटा की लंबाई प्राप्त करता है। |
...
| [setData(byte[] value)](#setData-byte---) | PSD फ़ाइल में एम्बेडेड स्मार्ट ऑब्जेक्ट डेटा को प्राप्त करता है या सेट करता है। |
...
नए [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) क्लास का एक नया उदाहरण प्रारंभ करता है।
...
PSD फ़ाइल में एम्बेडेड स्मार्ट ऑब्जेक्ट डेटा को प्राप्त करता है या सेट करता है।

मान: एम्बेडेड स्मार्ट ऑब्जेक्ट डेटा।
...
एम्बेडेड डेटा की लंबाई प्राप्त करता है।

मान: एम्बेडेड डेटा की लंबाई।
