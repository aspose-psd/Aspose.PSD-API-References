...
description: "PSD फ़ॉर्मेट इमेज में लिंक्ड या एम्बेडेड फ़ाइलों के बारे में जानकारी रखने वाली LinkResource क्लास को परिभाषित करता है।"
type: docs
weight: 14
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
LinkResource क्लास को परिभाषित करता है जो PSD फ़ॉर्मेट छवि में लिंक किए गए या एम्बेडेड फ़ाइलों के बारे में जानकारी रखता है। लिंक संसाधन में कई [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) उदाहरण हो सकते हैं जिन्हें किसी भी व्युत्पन्न क्लास में इंडेक्सर द्वारा एक्सेस किया जा सकता है।
## फ़ील्ड्स
...
| [get_Item(int index)](#get-Item-int-) | निर्दिष्ट सूचकांक पर [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) प्राप्त करता है। |
...
निर्दिष्ट सूचकांक पर [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| index | int | पूर्णांक सूचकांक। मान: [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource)। |
