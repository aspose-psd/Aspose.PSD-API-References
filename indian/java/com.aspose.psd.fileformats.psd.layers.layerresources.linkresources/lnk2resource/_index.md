...
description: "PSD फ़ॉर्मेट इमेज में एम्बेडेड फ़ाइलों के बारे में जानकारी रखने वाली क्लास को परिभाषित करता है।"
type: docs
weight: 15
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
क्लास को परिभाषित करता है जो PSD फ़ॉर्मेट छवि में एम्बेडेड फ़ाइलों के बारे में जानकारी रखता है। लिंक संसाधन में कई LiFdDataSource उदाहरण हो सकते हैं जिन्हें इंडेकसर द्वारा एक्सेस किया जा सकता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | नए [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) क्लास का एक नया उदाहरण प्रारंभ करता है। |
## फ़ील्ड्स
...
| [get_Item(int index)](#get-Item-int-) | निर्दिष्ट इंडेक्स पर LiFdDataSource प्राप्त करता है। |
...
नए [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) क्लास का एक नया उदाहरण प्रारंभ करता है।
...
निर्दिष्ट इंडेक्स पर LiFdDataSource प्राप्त करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| सूचकांक | int | सूचकांक। मान: LiFdDataSource। |
