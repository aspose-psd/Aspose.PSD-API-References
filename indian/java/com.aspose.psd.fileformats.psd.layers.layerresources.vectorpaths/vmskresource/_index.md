...
description: "क्लास VmskResource।"
type: docs
weight: 27
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [VmskResource(byte[] data)](#VmskResource-byte---) | नए [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) क्लास का एक नया उदाहरण प्रारंभ करता है। |
| [VmskResource()](#VmskResource--) | नए [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) क्लास का एक नया उदाहरण प्रारंभ करता है। |
## फ़ील्ड्स
...
| [getPaths()](#getPaths--) | पाथ रिकॉर्ड प्राप्त करता है या सेट करता है। |
...
| [hashCode()](#hashCode--) |  |
| [isChanged_internalized()](#isChanged-internalized--) | निर्धारित करता है कि यह उदाहरण बदला गया है या नहीं। |
| [isDisabled()](#isDisabled--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण निष्क्रिय है या नहीं। |
| [isInverted()](#isInverted--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण उलटा है या नहीं। |
| [isNotLinked()](#isNotLinked--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण लिंक नहीं किया गया है या नहीं। |
...
| [setDisabled(boolean value)](#setDisabled-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण निष्क्रिय है या नहीं। |
...
| [setInverted(boolean value)](#setInverted-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण उलटा है या नहीं। |
| [setNotLinked(boolean value)](#setNotLinked-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण लिंक नहीं किया गया है या नहीं। |
| [setPaths(VectorPathRecord[] value)](#setPaths-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorPathRecord---) | पाथ रिकॉर्ड प्राप्त करता है या सेट करता है। |
...
| [updateDataToCurrent_internalized()](#updateDataToCurrent-internalized--) | कैश किए गए मूल डेटा को वर्तमान स्थिति में अपडेट करें। |
| [wait()](#wait--) |  |
...
नए [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) क्लास का एक नया उदाहरण प्रारंभ करता है।
...
पाथ रिकॉर्ड प्राप्त करता है या सेट करता है।
...
निर्धारित करता है कि यह उदाहरण बदला गया है या नहीं।

**Returns:**
boolean - true यदि यह उदाहरण बदला गया है; अन्यथा false।
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण निष्क्रिय है या नहीं।

मान:  true  यदि यह उदाहरण निष्क्रिय है; अन्यथा,  false .
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण उलटा है या नहीं।

मान:  true  यदि यह उदाहरण उलटा है; अन्यथा,  false .
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि यह उदाहरण लिंक नहीं किया गया है या नहीं।

मान:  true  यदि यह उदाहरण लिंक नहीं किया गया है; अन्यथा,  false .
...
कैश किए गए मूल डेटा को वर्तमान स्थिति में अपडेट करें।
