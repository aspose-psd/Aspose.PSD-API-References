...
description: "पाथ आकारों को बूलियन ऑपरेशन्स के साथ मिलाकर करने वाले ऑपरेशन्स।"
type: docs
weight: 15
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| फ़ील्ड | विवरण |
| --- | --- |
| [CombineShapes](#CombineShapes) | आकारों को संयोजित करें (OR ऑपरेशन)। |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | ओवरलैपिंग आकारों को बाहर करें (XOR ऑपरेशन)। |
| [IntersectShapeAreas](#IntersectShapeAreas) | आकार क्षेत्रों को प्रतिच्छेद करें (AND ऑपरेशन)। |
| [SubtractFrontShape](#SubtractFrontShape) | सामने के आकार को घटाएँ (NOT ऑपरेशन)। |
## विधियाँ
...
आकारों को संयोजित करें (OR ऑपरेशन)। यह Photoshop में डिफ़ॉल्ट मान है।
...
ओवरलैपिंग आकारों को बाहर करें (XOR ऑपरेशन)।
...
आकार क्षेत्रों को प्रतिच्छेद करें (AND ऑपरेशन)।
...
सामने के आकार को घटाएँ (NOT ऑपरेशन)।
