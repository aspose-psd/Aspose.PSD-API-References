...
description: "वेक्टर उत्पत्ति डेटा संसाधन।"
type: docs
weight: 28
url: /hi/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [VogkResource()](#VogkResource--) | एक नया उदाहरण प्रारंभ करता है [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) क्लास का। |
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | आकार मूल सेटिंग्स सहेजने के लिए डिस्क्रिप्टर कुंजी। |
...
| [getItems_internalized()](#getItems-internalized--) | संरचना आइटम प्राप्त करता है या सेट करता है। |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | आकार मूल सेटिंग्स प्राप्त करता है या सेट करता है। |
...
| [setClassNameAndId_internalized(String className, ClassID classId)](#setClassNameAndId-internalized-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | क्लास नाम और पहचानकर्ता सेट करता है। |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | संरचना आइटम प्राप्त करता है या सेट करता है। |
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | आकार मूल सेटिंग्स प्राप्त करता है या सेट करता है। |
...
एक नया उदाहरण प्रारंभ करता है [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) क्लास का।
...
आकार मूल सेटिंग्स सहेजने के लिए डिस्क्रिप्टर कुंजी।
...
संरचना आइटम प्राप्त करता है या सेट करता है।
...
आकार मूल सेटिंग्स प्राप्त करता है या सेट करता है।
...
क्लास नाम और पहचानकर्ता सेट करता है।
