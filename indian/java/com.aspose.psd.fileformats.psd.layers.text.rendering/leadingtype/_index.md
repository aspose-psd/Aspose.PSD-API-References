...
description: "फ़ोटोशॉप लीडिंग टाइप, पंक्तियों के बीच की दूरी का प्रकार।"
type: docs
weight: 14
url: /hi/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
फ़ोटोशॉप लीडिंग प्रकार (पंक्तियों के बीच की दूरी का प्रकार)।
## फ़ील्ड्स

| फ़ील्ड | विवरण |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | निचले‑से‑निचले लीडिंग। |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | ऊपर‑से‑ऊपर लीडिंग। |
## विधियाँ
