...
description: "टेक्स्ट लेयर क्लास"
type: docs
weight: 30
url: /hi/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | फ़ॉन्ट का आकार सुधारता है। |
...
| [createInstance_internalized()](#createInstance-internalized--) | नए [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) क्लास का उदाहरण बनाता है। |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | नए [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) क्लास का उदाहरण बनाता है। |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | इंजन डेटा प्राप्त करता है। |
...
| [getFont()](#getFont--) | फ़ॉन्ट प्राप्त करता है। |
| [getFonts()](#getFonts--) | टेक्स्ट लेयर के फ़ॉन्ट सेट को प्राप्त करता है। |
...
| [getInnerText()](#getInnerText--) | लेयर का टेक्स्ट प्राप्त करता है। |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | संसाधन प्रोसेसर को प्राप्त करता है या सेट करता है। |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | स्ट्रिंग फ़ॉर्मेट प्राप्त करता है। |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | सिंक्रोनाइज़ रूट प्राप्त करता है। |
| [getText()](#getText--) | पाठ प्राप्त करता है। |
| [getTextBoundBox()](#getTextBoundBox--) | टेक्स्ट बाउंड बॉक्स को प्राप्त करता है या सेट करता है। |
| [getTextColor()](#getTextColor--) | टेक्स्ट का रंग प्राप्त करता है। |
| [getTextData()](#getTextData--) | टेक्स्ट के भागों को प्राप्त करता है। |
| [getTop()](#getTop--) | टॉप लेयर स्थिति प्राप्त करता है या सेट करता है |
| [getTransformMatrix()](#getTransformMatrix--) | ट्रांसफ़ॉर्म मैट्रिक्स को प्राप्त करता है या सेट करता है। |
| [getTransparentColor()](#getTransparentColor--) | छवि का ट्रांसपेरेंट रंग प्राप्त करता है। |
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | खोजता है और [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) संसाधन को [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) से प्राप्त करता है। |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [was changed]। |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | निर्धारित करता है कि क्या [is font available] [the specified font]। |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | फ़ॉन्ट को पूर्व-प्रसंस्करण करता है। |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | फ़ॉन्ट को डिफ़ॉल्ट से बदलता है। |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | लेयर का टेक्स्ट प्राप्त करता है। |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | संसाधन प्रोसेसर को प्राप्त करता है या सेट करता है। |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | टेक्स्ट बाउंड बॉक्स को प्राप्त करता है या सेट करता है। |
| [setTop(int value)](#setTop-int-) | टॉप लेयर स्थिति प्राप्त करता है या सेट करता है |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | ट्रांसफ़ॉर्म मैट्रिक्स को प्राप्त करता है या सेट करता है। |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [was changed]। |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | संसाधनों में [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) की सीमाओं को अपडेट करता है। |
| [updateText(String text)](#updateText-java.lang.String-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | टेक्स्ट को अपडेट करता है। |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | टेक्स्ट को अपडेट करता है। |
| [wait()](#wait--) |  |
...
फ़ॉन्ट का आकार सुधारता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| newSize | float | नया फ़ॉन्ट आकार |
| yyTransform | double | 'yy' ट्रांसफ़ॉर्म मैट्रिक्स पैरामीटर |

**Returns:**
float - सुधारा गया आकार
...
नए [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) क्लास का उदाहरण बनाता है।
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - टेक्स्ट लेयर के फ़ॉन्ट सेट।
...
संसाधन प्रोसेसर को प्राप्त करता है या सेट करता है।

Value: रिसोर्स प्रोसेसर।
...
स्ट्रिंग फ़ॉर्मेट प्राप्त करता है।

Value: स्ट्रिंग फ़ॉर्मेट।
...
टेक्स्ट बाउंड बॉक्स को प्राप्त करता है या सेट करता है।

Value: टेक्स्ट बाउंड बॉक्स।
...
खोजता है और [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) संसाधन को [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) से प्राप्त करता है।
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [was changed]।

Value:  true  यदि [बदल गया]; अन्यथा,  false .
...
निर्धारित करता है कि क्या [is font available] [the specified font]।
...
**Returns:**
boolean - True यदि फ़ॉन्ट उपलब्ध है
...
फ़ॉन्ट को पूर्व-प्रसंस्करण करता है।
...
फ़ॉन्ट को डिफ़ॉल्ट से बदलता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | फ़ॉन्ट। |
| defaultFontName | java.lang.String | फ़ॉन्ट का डिफ़ॉल्ट नाम। |
...
| newWidth | int | नई चौड़ाई। |
| newHeight | int | नई ऊँचाई। |
| resizeType | int | ResizeType का रिसाइज़ ट्रांसफ़ॉर्मेशन प्रकार |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| मान | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
संसाधनों में [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) की सीमाओं को अपडेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | टेक्स्ट की पूर्ण स्थिति और आकार। |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | टेक्स्ट बॉक्स के सापेक्ष टेक्स्ट की स्थिति और आकार। |
...
| --- | --- | --- |
| पाठ | java.lang.String | पाठ मान। |
| color | [Color](../../com.aspose.psd/color) | रंग मान। |
...
| --- | --- | --- |
| पाठ | java.lang.String | पाठ मान। |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | बाएँ ऊपर निर्देशांक। |
