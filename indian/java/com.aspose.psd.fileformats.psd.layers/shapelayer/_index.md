...
description: "शेप लेयर।"
type: docs
weight: 29
url: /hi/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
शेप लेयर। शेप लेयर और संबंधित संसाधनों के साथ कार्य की लॉजिक को संलग्न करता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | नया उदाहरण प्रारंभ करता है [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) क्लास का। |
## फ़ील्ड्स
...
| [createInstance()](#createInstance--) | एक नया उदाहरण बनाता है [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) क्लास का। |
...
| [getFill()](#getFill--) | शेप लेयर में शेप्स के आंतरिक क्षेत्र के लिए भराव सेटिंग्स। |
...
| [getPath()](#getPath--) | शेप लेयर में मौजूद पाथ्स का सेट प्राप्त करता है। |
...
| [getStroke()](#getStroke--) | शेप्स की स्ट्रोक सेटिंग्स को प्राप्त करता है या सेट करता है। |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | जब [global resources changed] हो, तब बुलाया जाता है। |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | जब [resources change] हो, तब बुलाया जाता है। |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | शेप लेयर में शेप्स के आंतरिक क्षेत्र के लिए भराव सेटिंग्स। |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | शेप्स की स्ट्रोक सेटिंग्स को प्राप्त करता है या सेट करता है। |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Shape लेयर गुणों से संसाधनों को अपडेट करता है। |
...
नए [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) क्लास का एक नया उदाहरण इनिशियलाइज़ करता है। सभी संसाधन डिफ़ॉल्ट स्थिति में बनाए जाते हैं।
...
एक नया उदाहरण बनाता है [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) क्लास का।
...
शेप लेयर में शेप्स के आंतरिक क्षेत्र के लिए भराव सेटिंग्स।
...
शेप लेयर में मौजूद पाथ्स का सेट प्राप्त करता है।
...
शेप्स की स्ट्रोक सेटिंग्स को प्राप्त करता है या सेट करता है।
...
**Returns:**
boolean - बूलियन मान जो दर्शाता है कि लेयर वैध है।
...
जब [global resources changed] हो, तब बुलाया जाता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| प्रेषक | java.lang.Object | प्रेषक। |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | इवेंट डेटा शामिल करने वाला EventArgs इंस्टेंस। |
...
जब [resources change] हो, तब बुलाया जाता है।
