...
description: "आर्टबोर्ड लेयर क्लास।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | लेयर को लेयर समूह में जोड़ता है। |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | लेयर को लेयर समूह में जोड़ता है। |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | लेयर समूह को जोड़ता है। |
...
| [buildGroupLayerMarkers_internalized(String groupName, PsdHeader psdHeader, IColorPalette colorPalette, int layerNestingLevel)](#buildGroupLayerMarkers-internalized-java.lang.String-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-int-) | शुरू और अंत समूह मार्कर बनाता है। |
...
| [getBackgroundColor()](#getBackgroundColor--) | आर्टबोर्ड पृष्ठभूमि रंग को प्राप्त करता है या सेट करता है। |
...
| [getLayers()](#getLayers--) | लेयर समूह में लेयर्स प्राप्त करता है |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | ArtboardLayer की वास्तविक सीमाओं को प्राप्त करता है। |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | संसाधनों से  LayerSectionResource  प्राप्त करता है। |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) की पृष्ठभूमि रंग है या नहीं। |
...
| [isOpen()](#isOpen--) | यदि true सेट किया जाए तो फ़ोल्डर खुला है या नहीं को प्राप्त करता है या सेट करता है, तब समूह स्टार्टअप पर खुली स्थिति में रहेगा, अन्यथा न्यूनतम स्थिति में। |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | आर्टबोर्ड पृष्ठभूमि रंग को प्राप्त करता है या सेट करता है। |
...
| [setOpen(boolean value)](#setOpen-boolean-) | यदि true सेट किया जाए तो फ़ोल्डर खुला है या नहीं को प्राप्त करता है या सेट करता है, तब समूह स्टार्टअप पर खुली स्थिति में रहेगा, अन्यथा न्यूनतम स्थिति में। |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | लेयर। |
| सूचकांक | int | लेयर को सम्मिलित किए जाने वाला सूचकांक। अमान्य मान लेयर्स सूची के अंत को दर्शाते हैं। |
...
शुरू और अंत समूह मार्कर बनाता है।
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - दो LayerGroup ऑब्जेक्ट्स की एक एरे लौटाता है, जहाँ पहला [0] प्रारंभ समूह संकेतक है और दूसरा [1] अंत समूह संकेतक है।
### cacheData() {#cacheData--}
```
...
लेयर समूह में लेयर्स प्राप्त करता है
...
ArtboardLayer की वास्तविक सीमाओं को प्राप्त करता है।
...
संसाधनों से  LayerSectionResource  प्राप्त करता है।
...
एक मान प्राप्त करता है या सेट करता है जो दर्शाता है कि [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) की पृष्ठभूमि रंग है या नहीं।
...
यदि true सेट किया जाए तो फ़ोल्डर खुला है या नहीं को प्राप्त करता है या सेट करता है, तब समूह स्टार्टअप पर खुली स्थिति में रहेगा, अन्यथा न्यूनतम स्थिति में।
