...
description: "XMP मीडिया मैनेजमेंट नेमस्पेस का प्रतिनिधित्व करता है।"
type: docs
weight: 10
url: /hi/java/com.aspose.psd.xmp.schemas.xmpmm/xmpmediamanagementpackage/
---
...
XMP मीडिया मैनेजमेंट नेमस्पेस का प्रतिनिधित्व करता है।
## कन्स्ट्रक्टर्स

| कन्स्ट्रक्टर | विवरण |
| --- | --- |
| [XmpMediaManagementPackage()](#XmpMediaManagementPackage--) | XmpMediaManagementPackage क्लास का नया उदाहरण प्रारंभ करता है। |
## विधियाँ
...
| [setDerivedFrom(ResourceRef resourceRef)](#setDerivedFrom-com.aspose.psd.xmp.types.complex.resourceref.ResourceRef-) | डेराइव्ड फ्रॉम को सेट करता है। |
| [setDocumentId(String guid)](#setDocumentId-java.lang.String-) | डॉक्यूमेंट आइडेंटिफ़ायर को सेट करता है। |
| [setDocumentId(UUID guid)](#setDocumentId-java.util.UUID-) | डॉक्यूमेंट आइडेंटिफ़ायर को सेट करता है। |
| [setDocumentId_internalized(System.Guid guid)](#setDocumentId-internalized-com.aspose.ms.System.Guid-) |  |
| [setInstanceId(String guid)](#setInstanceId-java.lang.String-) | इंस्टेंस आईडी को सेट करता है। |
| [setInstanceId(UUID guid)](#setInstanceId-java.util.UUID-) | इंस्टेंस आईडी को सेट करता है। |
| [setInstanceId_internalized(System.Guid guid)](#setInstanceId-internalized-com.aspose.ms.System.Guid-) |  |
| [setOriginalDocumentId(String guid)](#setOriginalDocumentId-java.lang.String-) | ऑरिजिनल डॉक्यूमेंट आईडी को सेट करता है। |
| [setOriginalDocumentId(UUID guid)](#setOriginalDocumentId-java.util.UUID-) | ऑरिजिनल डॉक्यूमेंट आईडी को सेट करता है। |
...
XmpMediaManagementPackage क्लास का नया उदाहरण प्रारंभ करता है।
...
डेराइव्ड फ्रॉम को सेट करता है।

**Parameters:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| resourceRef | [ResourceRef](../../com.aspose.psd.xmp.types.complex.resourceref/resourceref) | संसाधन रेफ़रेंस। |
...
डॉक्यूमेंट आइडेंटिफ़ायर को सेट करता है।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| guid | java.util.UUID | अद्वितीय पहचानकर्ता। |
...
ऑरिजिनल डॉक्यूमेंट आईडी को सेट करता है।
