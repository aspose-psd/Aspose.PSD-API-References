---
title: "ArtBResource क्लास"
type: docs
weight: 50
url: /hi/python-net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [ArtBResource()](#ArtBResource__1) | ArtBResource क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है |
## **Properties**
...
| artboard_background_type | int | r/w | प्राप्त करता है या सेट करता है [ArtBResource.artboard_background_type](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/) |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | प्राप्त करता है या सेट करता है [ArtBResource.color](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/) |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | [OSTypeStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/) आइटम को प्राप्त करता है या सेट करता है। |
| key | int | r | लेयर संसाधन कुंजी को प्राप्त करता है। |
| लंबाई | int | r | <inheritdoc /> |
...
ArtBResource क्लास का एक नया इंस्टेंस इनिशियलाइज़ करता है
