---
title: "MlstResource क्लास"
type: docs
weight: 690
url: /hi/python-net/aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [MlstResource()](#MlstResource__1) | MlstResource क्लास का एक नया उदाहरण प्रारंभ करता है |
## **Properties**
...
| descriptor_version | int | r | डिस्क्रिप्टर संस्करण प्राप्त करता है या सेट करता है। |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | संरचनाओं को प्राप्त करता है या सेट करता है। |
...
MlstResource क्लास का एक नया उदाहरण प्रारंभ करता है
