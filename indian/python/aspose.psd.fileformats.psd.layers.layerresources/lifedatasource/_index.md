---
title: "LiFeDataSource क्लास"
type: docs
weight: 520
url: /hi/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [LiFeDataSource()](#LiFeDataSource__1) | नया उदाहरण प्रारंभ करता है [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) क्लास का। |
| [LiFeDataSource(version, unique_id, original_file_name, file_type, file_creator)](#LiFeDataSource_version_unique_id_original_file_name_file_type_file_creator_2) | नया उदाहरण प्रारंभ करता है [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) क्लास का। |
## **Properties**
| **Name** | **Type** | **Access** | **विवरण** |
| :- | :- | :- | :- |
| adobe_stock_id | string | r/w | ग्राफ़िक्स लाइब्रेरी AdobeStockId को प्राप्त करता है या सेट करता है, Adobe® Photoshop® CC लाइब्रेरीज़ के लिए। |
| adobe_stock_license_state | string | r | Adobe स्टॉक लाइसेंस की स्थिति प्राप्त करता है यदि उपलब्ध हो, Adobe® Photoshop® CC लाइब्रेरीज़ के लिए। |
...
| date | datetime | r/w | PSD LnkE संसाधन के LiFE डेटा स्रोत में बाहरी फ़ाइल की अंतिम लिखने की तिथि और समय को प्राप्त करता है या सेट करता है। |
| element_name | string | r/w | Adobe® Photoshop® CC Libraries के लिए ग्राफ़िक्स लाइब्रेरी एलिमेंट नाम को प्राप्त करता है या सेट करता है। |
| element_ref | string | r/w | Adobe® Photoshop® CC Libraries के लिए ग्राफ़िक्स लाइब्रेरी एलिमेंट रेफ़रेंस को प्राप्त करता है या सेट करता है। |
| file_creator | string | r/w | PSD फ़ॉर्मेट LnkE / Lnk2 संसाधन में फ़ाइल निर्माता को प्राप्त करता है या सेट करता है। |
| file_name | string | r/w | PSD लिंक संसाधन में बाहरी या एम्बेडेड फ़ाइल का नाम प्राप्त करता है या सेट करता है। |
| file_size | long | r/w | PSD LnkE संसाधन के LiFE डेटा स्रोत में बाहरी फ़ाइल का आकार प्राप्त करता है या सेट करता है। |
...
| relative_path | string | r/w | PSD LnkE रिसोर्स के LiFE डेटा स्रोत में बाहरी फ़ाइल का रिलेटिव पाथ प्राप्त करता है या सेट करता है। |
...
नया उदाहरण प्रारंभ करता है [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) क्लास का।
