---
title: "LyvrResource क्लास"
type: docs
weight: 670
url: /hi/python-net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [LyvrResource()](#LyvrResource__1) | LyvrResource क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है |
## **Properties**
...
| version | int | r/w | लेयर के फ़ोटोशॉप संस्करण को प्राप्त करता है या सेट करता है। |
## **Methods**
| **Name** | **विवरण** |
| :- | :- |
...
LyvrResource क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है
