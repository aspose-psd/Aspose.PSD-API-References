---
title: "ColorBalanceAdjustmentLayer क्लास"
type: docs
weight: 80
url: /hi/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| highlights_cyan_red_balance | short | r/w | Highlights Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| highlights_magenta_green_balance | short | r/w | Highlights Magenta Green बैलेंस को प्राप्त करता है या सेट करता है। |
| highlights_yellow_blue_balance | short | r/w | Highlights Yellow Blue बैलेंस को प्राप्त करता है या सेट करता है। |
...
| left | int | r/w |  |
| लंबाई | int | r |  |
| midtones_cyan_red_balance | short | r/w | Midtones Cyan Red बैलेंस को प्राप्त करता है या सेट करता है। |
| midtones_magenta_green_balance | short | r/w | Midtones Magenta Green Balance को प्राप्त करता है या सेट करता है। |
| midtones_yellow_blue_balance | short | r/w | Midtones Yellow Blue Balance को प्राप्त करता है या सेट करता है। |
...
| preserve_luminosity | bool | r/w | यह दर्शाने वाला मान प्राप्त करता है या सेट करता है कि यह [BlncResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/blncresource/) चमक को संरक्षित करता है। |
...
| right | int | r/w |  |
| shadows_cyan_red_balance | short | r/w | Shadows Cyan Red Balance को प्राप्त करता है या सेट करता है। |
| shadows_magenta_green_balance | short | r/w | Shadows Magenta Green Balance को प्राप्त करता है या सेट करता है। |
| shadows_yellow_blue_balance | short | r/w | Shadows YellowBlue Balance को प्राप्त करता है या सेट करता है। |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | 32-बिट ARGB पिक्सेल को आंशिक रूप से (ब्लॉकों द्वारा) लोड करता है। |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | कच्चा डेटा लोड करता है। |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | लेयर को निर्दिष्ट लेयर में मिलाता है |
| normalize_angle() |  |
