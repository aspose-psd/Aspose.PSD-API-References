---
title: "ExposureLayer वर्ग"
type: docs
weight: 100
url: /hi/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| disposed | bool | r |  |
| एक्सपोज़र | float | r/w | एक्सपोज़र प्राप्त करता है या सेट करता है। PS में एक्सपोज़र की सीमा -20 से +20 तक है। |
| extra_length | int | r |  |
...
| gamma_correction | float | r/w | GammaCorrection प्राप्त करता है या सेट करता है। PS में GammaCorrection की सीमा 9.99 से +0.01 तक है। |
| has_alpha | bool | r |  |
...
| offset | float | r/w | ऑफ़सेट प्राप्त करता है या सेट करता है। PS में ऑफ़सेट की सीमा -0.5 से +0.5 तक है। |
| opacity | byte | r/w |  |
