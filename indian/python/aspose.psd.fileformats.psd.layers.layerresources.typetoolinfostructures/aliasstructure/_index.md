---
title: "AliasStructure क्लास"
type: docs
weight: 10
url: /hi/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | नया उदाहरण इनिशियलाइज़ करता है [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) क्लास का। |
## **Properties**
| **Name** | **Type** | **Access** | **विवरण** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [स्थिर] | int | r | संरचना कुंजी की पहचान करता है। |
| data_length | int | r | बाइट्स में सटीक डेटा लंबाई को प्राप्त करता है। |
| full_path | string | r/w | पूर्ण पथ को प्राप्त करता है या सेट करता है। |
...
नया उदाहरण इनिशियलाइज़ करता है [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) क्लास का।
