---
title: "FillLayer क्लास"
type: docs
weight: 10
url: /hi/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | फ़िल सेटिंग्स प्राप्त करता या सेट करता है। |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | फ़िल का प्रकार प्राप्त करता है। |
| filler | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | फ़िल प्रकार के आधार पर [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) क्लास का नया उदाहरण बनाता है। |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_30) | 32-बिट ARGB पिक्सेल को आंशिक रूप से (ब्लॉकों द्वारा) लोड करता है। |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_31) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_32) | कच्चा डेटा लोड करता है। |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | सभी गैर-ट्रांसपेरेंट रंगों को नए रंग से बदलता है और स्मूद एजेज़ को बचाने के लिए मूल अल्फा वैल्यू को संरक्षित रखता है।<br/>            नोट: यदि आप इसे बिना ट्रांसपेरेंसी वाली छवियों पर उपयोग करते हैं, तो सभी रंग एक ही रंग से बदल दिए जाएंगे। |
...
| update() | वर्तमान [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) के आधार पर फ़िल लेयर के पिक्सेल डेटा को अपडेट करता है। |
...
फ़िल प्रकार के आधार पर [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) क्लास का नया उदाहरण बनाता है।

**Parameters:**

| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | फ़िल लेयर का प्रकार। |

**Returns**

| प्रकार | विवरण |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) क्लास का नया उदाहरण फ़िल प्रकार के आधार पर लौटाता है। |
