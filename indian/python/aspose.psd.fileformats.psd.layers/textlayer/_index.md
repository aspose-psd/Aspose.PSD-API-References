---
title: "TextLayer क्लास"
type: docs
weight: 1750
url: /hi/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | फ़ॉन्ट को प्राप्त करता है। |
| has_alpha | bool | r |  |
...
| inner_text | string | r | लेयर का टेक्स्ट प्राप्त करता है |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | टेक्स्ट बाउंड बॉक्स को प्राप्त करता है या सेट करता है। |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | टेक्स्ट का रंग प्राप्त करता है। |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | पाठ के भाग प्राप्त करता है। |
| ऊपर | int | r/w |  |
| transform_matrix | डबल | r/w | परिवर्तन मैट्रिक्स को प्राप्त करता है या सेट करता है |
...
| [get_fonts()](#get_fonts__15) | पाठ लेयर के फ़ॉन्ट सेट को प्राप्त करता है। |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | छवि का आकार बदलता है। डिफ़ॉल्ट [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) उपयोग किया जाता है। |
...
| [update_text(text)](#update_text_text_38) | पाठ को अपडेट करता है। |
| [update_text(text, color)](#update_text_text_color_39) | पाठ को अपडेट करता है। |
| [update_text(text, font_size)](#update_text_text_font_size_40) | पाठ को अपडेट करता है। |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | पाठ को अपडेट करता है। |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | पाठ को अपडेट करता है। |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | पाठ को अपडेट करता है। |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | पाठ को अपडेट करता है। |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | पाठ को अपडेट करता है। |
...
पाठ लेयर के फ़ॉन्ट सेट को प्राप्त करता है।

**Returns**

| प्रकार | विवरण |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | पाठ लेयर का फ़ॉन्ट सेट। |
...
छवि का आकार बदलता है। डिफ़ॉल्ट [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) उपयोग किया जाता है।
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | आकार परिवर्तन प्रकार [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | पाठ मान। |
| color | [Color](/psd/python-net/aspose.psd/color) | रंग मान। |
...
| :- | :- | :- |
| text | string | पाठ मान। |
| font_size | float | फ़ॉन्ट का आकार। |
...
| :- | :- | :- |
| text | string | पाठ मान। |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | बाएँ ऊपर का निर्देशांक। |
