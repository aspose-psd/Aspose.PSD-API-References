---
title: "WatermarkResource क्लास"
type: docs
weight: 310
url: /hi/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | WatermarkResource क्लास का नया इंस्टेंस इनिशियलाइज़ करता है |
## **Properties**
...
| is_watermark | bool | r/w | इस इंस्टेंस के वॉटरमार्क होने को दर्शाने वाला मान प्राप्त करता है या सेट करता है। |
...
WatermarkResource क्लास का नया इंस्टेंस इनिशियलाइज़ करता है
