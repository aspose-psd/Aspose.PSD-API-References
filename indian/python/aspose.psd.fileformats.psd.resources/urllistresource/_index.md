---
title: "UrlListResource क्लास"
type: docs
weight: 290
url: /hi/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | UrlListResource क्लास का नया उदाहरण प्रारंभ करता है |
## **Properties**
...
| count | int | r/w | गणना को प्राप्त या सेट करता है। |
...
| ids | int | r/w | ids को प्राप्त करता है या सेट करता है। |
| longs | int | r/w | longs को प्राप्त करता है या सेट करता है। |
...
| texts | string | r/w | texts को प्राप्त करता है या सेट करता है। |
## **Methods**
| **Name** | **विवरण** |
| :- | :- |
...
UrlListResource क्लास का नया उदाहरण प्रारंभ करता है
