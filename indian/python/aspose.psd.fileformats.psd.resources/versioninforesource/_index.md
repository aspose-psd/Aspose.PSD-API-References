---
title: "VersionInfoResource क्लास"
type: docs
weight: 300
url: /hi/python-net/aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [VersionInfoResource()](#VersionInfoResource__1) | VersionInfoResource क्लास का नया उदाहरण प्रारंभ करता है। |
## **Properties**
...
| file_version | uint | r/w | फ़ाइल संस्करण को प्राप्त करता है या सेट करता है। |
| has_real_merged_data | bool | r/w | इस उदाहरण के पास वास्तविक मर्ज्ड डेटा है या नहीं, यह दर्शाने वाले मान को प्राप्त करता है या सेट करता है। |
...
| reader_name | string | r/w | रीडर का नाम प्राप्त करता है या सेट करता है। |
...
| version | uint | r/w | संस्करण प्राप्त करता है या सेट करता है। |
| writer_name | string | r/w | राइटर का नाम प्राप्त करता है या सेट करता है। |
## **Methods**
| **Name** | **विवरण** |
| :- | :- |
...
VersionInfoResource क्लास का नया उदाहरण प्रारंभ करता है।
