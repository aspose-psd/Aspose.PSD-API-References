---
title: "LayerSelectionIdsResource क्लास"
type: docs
weight: 170
url: /hi/python-net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource__1) | LayerSelectionIdsResource क्लास का नया उदाहरण प्रारंभ करता है। |
## **Properties**
...
| count | short | r/w | गणना को प्राप्त या सेट करता है। |
...
| layer_ids | int | r/w | लेयर आईडी को प्राप्त या सेट करता है। |
...
LayerSelectionIdsResource क्लास का नया उदाहरण प्रारंभ करता है।
