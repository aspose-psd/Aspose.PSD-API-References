---
title: "BackgroundColorResource क्लास"
type: docs
weight: 20
url: /hi/python-net/aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [BackgroundColorResource()](#BackgroundColorResource__1) | BackgroundColorResource क्लास का नया इंस्टेंस इनिशियलाइज़ करता है |
## **Properties**
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | पृष्ठभूमि रंग प्राप्त करता है या सेट करता है। |
...
BackgroundColorResource क्लास का नया इंस्टेंस इनिशियलाइज़ करता है
