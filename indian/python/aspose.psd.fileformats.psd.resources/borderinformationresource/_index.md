---
title: "BorderInformationResource क्लास"
type: docs
weight: 30
url: /hi/python-net/aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [BorderInformationResource()](#BorderInformationResource__1) | BorderInformationResource क्लास का नया उदाहरण प्रारंभ करता है |
## **Properties**
...
| unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | बॉर्डर इकाइयों को प्राप्त करता है या सेट करता है। |
| width | डबल | r/w | बॉर्डर चौड़ाई को प्राप्त करता है या सेट करता है। |
## **Methods**
| **Name** | **विवरण** |
| :- | :- |
...
BorderInformationResource क्लास का नया उदाहरण प्रारंभ करता है
