...
type: docs
weight: 210
url: /hi/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | PrintScaleResource class की नई इंस्टेंस को प्रारंभ करता है। |
## **Properties**
...
| scale | float | r/w | scale को प्राप्त करता है या सेट करता है। |
...
| style | short | r/w | style को प्राप्त करता है या सेट करता है। |
| x_location | float | r/w | x location को प्राप्त करता है या सेट करता है। |
| y_location | float | r/w | y स्थान को प्राप्त करता है या सेट करता है। |
## **Methods**
| **Name** | **विवरण** |
| :- | :- |
...
PrintScaleResource class की नई इंस्टेंस को प्रारंभ करता है।
