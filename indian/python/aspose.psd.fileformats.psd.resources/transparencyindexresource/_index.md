---
title: "TransparencyIndexResource क्लास"
type: docs
weight: 260
url: /hi/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | TransparencyIndexResource क्लास का नया उदाहरण प्रारंभ करता है। |
## **Properties**
...
| transparency_index | short | r/w | पारदर्शिता रंग सूचकांक को प्राप्त करता है या सेट करता है। |
## **Methods**
| **Name** | **विवरण** |
| :- | :- |
...
TransparencyIndexResource क्लास का नया उदाहरण प्रारंभ करता है।
