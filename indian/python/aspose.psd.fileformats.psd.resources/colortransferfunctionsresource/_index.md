---
title: "ColorTransferFunctionsResource क्लास"
type: docs
weight: 60
url: /hi/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | ColorTransferFunctionsResource क्लास का नया उदाहरण प्रारंभ करता है। |
## **Properties**
...
| color_transfer_data | byte | r/w | रंग ट्रांसफ़र डेटा को प्राप्त करता है या सेट करता है। |
...
ColorTransferFunctionsResource क्लास का नया उदाहरण प्रारंभ करता है।
