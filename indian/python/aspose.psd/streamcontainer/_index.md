---
title: "StreamContainer क्लास"
type: docs
weight: 4230
url: /hi/python-net/aspose.psd/streamcontainer/
---
...
| **Name** | **विवरण** |
| :- | :- |
| [StreamContainer(stream)](#StreamContainer_stream_1) | नया उदाहरण प्रारंभ करता है [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) क्लास का। |
| [StreamContainer(stream, dispose_stream)](#StreamContainer_stream_dispose_stream_2) | नया उदाहरण प्रारंभ करता है [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) क्लास का। |
## **Properties**
...
| [read(buffer, offset, count)](#read_buffer_offset_count_1) | वर्तमान स्ट्रीम से बाइट्स की एक श्रृंखला पढ़ता है और पढ़े गए बाइट्स की संख्या से स्ट्रीम के भीतर स्थिति को आगे बढ़ाता है। |
| [read(bytes)](#read_bytes_2) | निर्दिष्ट बाइट बफ़र को भरने के लिए बाइट्स पढ़ता है। |
| [read_byte()](#read_byte__3) | स्ट्रीम से एक बाइट पढ़ता है और स्ट्रीम के भीतर स्थिति को एक बाइट से आगे बढ़ाता है, या यदि स्ट्रीम के अंत में हो तो -1 लौटाता है। |
| [save(destination_stream)](#save_destination_stream_4) | स्ट्रीम के डेटा को निर्दिष्ट स्ट्रीम में सहेजता (कॉपी करता) है। डिफ़ॉल्ट बफ़र आकार [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) और स्ट्रीम [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) मान का उपयोग करता है। |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_5) | सभी स्ट्रीम डेटा को निर्दिष्ट स्ट्रीम में सहेजता (कॉपी करता) है। स्ट्रीम [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) मान का उपयोग करता है। |
| [save(destination_stream, buffer_size, length)](#save_destination_stream_buffer_size_length_6) | स्ट्रीम के डेटा को निर्दिष्ट स्ट्रीम में सहेजता (कॉपी करता) है। |
| [save(file_path)](#save_file_path_7) | स्ट्रीम के डेटा को निर्दिष्ट स्ट्रीम में सहेजता (कॉपी करता) है। डिफ़ॉल्ट बफ़र आकार [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) और स्ट्रीम [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) मान का उपयोग करता है। |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_8) | निर्दिष्ट स्ट्रीम में स्ट्रीम का डेटा सहेजता (कॉपी करता) है। स्ट्रीम [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) मान का उपयोग करता है। |
| [save(file_path, buffer_size, length)](#save_file_path_buffer_size_length_9) | स्ट्रीम के डेटा को निर्दिष्ट स्ट्रीम में सहेजता (कॉपी करता) है। |
| [seek(offset, origin)](#seek_offset_origin_10) | वर्तमान स्ट्रीम के भीतर स्थिति सेट करता है। |
...
| [to_bytes()](#to_bytes__11) | स्ट्रीम डेटा को int ऐरे में बदलता है। |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_12) | स्ट्रीम डेटा को int ऐरे में बदलता है। |
| [write(buffer, offset, count)](#write_buffer_offset_count_13) | वर्तमान स्ट्रीम में बाइट्स की एक श्रृंखला लिखता है और इस स्ट्रीम में वर्तमान स्थिति को लिखे गए बाइट्स की संख्या से आगे बढ़ाता है। |
| [write(bytes)](#write_bytes_14) | निर्दिष्ट सभी बाइट्स को स्ट्रीम में लिखता है। |
| [write_byte(value)](#write_byte_value_15) | स्ट्रीम में वर्तमान स्थिति पर एक बाइट लिखता है और स्ट्रीम में स्थिति को एक बाइट से आगे बढ़ाता है। |
| [write_to(stream_container)](#write_to_stream_container_16) | समाहित डेटा को दूसरे [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) में कॉपी करता है। |
| [write_to(stream_container, length)](#write_to_stream_container_length_17) | समाहित डेटा को दूसरे [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) में कॉपी करता है। |
...
नया उदाहरण प्रारंभ करता है [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) क्लास का।
