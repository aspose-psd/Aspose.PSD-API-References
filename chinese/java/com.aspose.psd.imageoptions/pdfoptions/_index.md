...
type: docs
weight: 18
url: /zh/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [PdfOptions()](#PdfOptions--) | 初始化 [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) 类的新实例。 |
## Methods
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | 获取核心 PDF 选项。 |
...
| [setPageSize(SizeF value)](#setPageSize-com.aspose.psd.SizeF-) | 设置页面的大小。 |
| [setPalette(IColorPalette value)](#setPalette-com.aspose.psd.IColorPalette-) | 获取或设置颜色调色板。 |
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | PDF 核心选项 |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | 获取或设置文档的元数据。 |
...
初始化 [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) 类的新实例。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| value | [SizeF](../../com.aspose.psd/sizef) | 页面的大小。 |
