...
type: docs
weight: 14
url: /zh/java/com.aspose.psd.imageoptions/jpeg2000options/
---
...
| [Jpeg2000Options(Jpeg2000Options jpeg2000Options)](#Jpeg2000Options-com.aspose.psd.imageoptions.Jpeg2000Options-) | 初始化 Jpeg2000Options 类的新实例。 |
## Methods
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| jpeg2000Options | [Jpeg2000Options](../../com.aspose.psd.imageoptions/jpeg2000options) | 用于复制设置的 Jpeg2000 文件格式选项。 |
...
获取或设置压缩比数组。不同层的压缩比不同。为每个质量级别指定的比率是期望的压缩因子。需要递减的比率。
