...
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/linejointype/
---
...
| 字段 | 描述 |
| --- | --- |
| [BevelJoin](#BevelJoin) | 斜角连接类型。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MiterJoin](#MiterJoin) | 斜接连接类型。 |
| [RoundJoin](#RoundJoin) | 圆角连接类型。 |
## Methods
