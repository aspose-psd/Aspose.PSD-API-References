...
description: "矢量描边内容数据资源。"
type: docs
weight: 13
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [VscgResource()](#VscgResource--) | 初始化 [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource) 类的新实例。 |
## 字段
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | 获取或设置类名。 |
| [getClassName_internalized()](#getClassName-internalized--) | 获取或设置类标识符。 |
| [getHeader_internalized()](#getHeader-internalized--) | 获取或设置标题。 |
| [getItems()](#getItems--) | 获取或设置结构项。 |
| [getKey()](#getKey--) | 获取图层资源键。 |
| [getKeyForData()](#getKeyForData--) | 整数键，定义资源中存储的填充设置类型：\\* Color - 0x536f436f - SoCoResource.TypeToolKey \\* Gradient - 0x4764466c - GdFlResource.TypeToolKey \\* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 获取或设置类名。 |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | 获取或设置类标识符。 |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 获取或设置结构项。 |
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | 获取整数键，定义资源中存储的填充设置类型：\\* Color - 0x536f436f - SoCoResource.TypeToolKey \\* Gradient - 0x4764466c - GdFlResource.TypeToolKey \\* Pattern - 0x5074466c - PtFlResource.TypeToolKey 警告！属性 KeyForData 的值应与 Items 结构中存储的填充设置类型匹配。 |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | 内部方法，允许分配只读属性 KeyForData。 |
...
初始化 [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource) 类的新实例。
...
整数键，定义资源中存储的填充设置类型：\\* Color - 0x536f436f - SoCoResource.TypeToolKey \\* Gradient - 0x4764466c - GdFlResource.TypeToolKey \\* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
获取整数键，定义资源中存储的填充设置类型：\\* Color - 0x536f436f - SoCoResource.TypeToolKey \\* Gradient - 0x4764466c - GdFlResource.TypeToolKey \\* Pattern - 0x5074466c - PtFlResource.TypeToolKey 警告！属性 KeyForData 的值应与 Items 结构中存储的填充设置类型匹配。
...
内部方法，允许分配只读属性 KeyForData。仅应在 Vscg 资源加载器中分配资源属性时使用。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| 值 | int | KeyForData 属性的整数值。 |
