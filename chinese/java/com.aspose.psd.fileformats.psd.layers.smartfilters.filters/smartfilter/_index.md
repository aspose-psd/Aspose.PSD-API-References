...
description: "用于处理智能过滤器基础逻辑的类。"
type: docs
weight: 13
url: /zh/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [SmartFilter()](#SmartFilter--) | 初始化 [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter) 类的新实例。 |
## Methods
...
初始化 [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter) 类的新实例。
