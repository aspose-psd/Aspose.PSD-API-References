...
description: "GaussianBlur 智能过滤器。"
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [GaussianBlurSmartFilter()](#GaussianBlurSmartFilter--) | 初始化 [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats/psd.layers.smartfilters.filters/gaussianblursmartfilter) 类的新实例。 |
## 字段
...
| [getRadius()](#getRadius--) | 获取或设置高斯智能过滤器的半径。 |
...
| [setRadius(double value)](#setRadius-double-) | 获取或设置高斯智能过滤器的半径。 |
...
初始化 [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats/psd.layers.smartfilters.filters/gaussianblursmartfilter) 类的新实例。
