...
description: "定义包含 PSD 格式图像中嵌入文件信息的类。"
type: docs
weight: 15
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
定义该类，包含有关 PSD 格式图像中嵌入文件的信息。链接资源可能包含多个 LiFdDataSource 实例，可通过索引器访问。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | 初始化 [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) 类的新实例。 |
## 字段
...
| [get_Item(int index)](#get-Item-int-) | 获取指定索引处的 LiFdDataSource。 |
...
初始化 [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) 类的新实例。
...
获取指定索引处的 LiFdDataSource。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| index | int | 索引。值：LiFdDataSource。 |
