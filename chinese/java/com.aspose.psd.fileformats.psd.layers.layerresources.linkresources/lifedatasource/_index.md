...
description: "定义包含外部链接文件信息的 LnkeDataSource 类。"
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource/
---
...
定义 LnkeDataSource 类，该类包含有关外部链接文件的信息。这是 PSD 文件格式操作 API 的一部分，可帮助修改 Adobe® Photoshop® 文件。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LiFeDataSource()](#LiFeDataSource--) | 初始化 [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) 类的新实例。 |
| [LiFeDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFeDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | 初始化 [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) 类的新实例。 |
## 字段
...
| [getAdobeStockId()](#getAdobeStockId--) | 获取或设置图形库 AdobeStockId，适用于 Adobe® Photoshop® CC 库。 |
| [getAdobeStockLicenseState()](#getAdobeStockLicenseState--) | 获取 Adobe® Photoshop® CC 库中（如果可用）Adobe Stock 许可证的状态。 |
...
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | 获取附加数据的长度。 |
| [getDataLength_internalized()](#getDataLength-internalized--) | 获取链接源数据的长度。 |
| [getDate()](#getDate--) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的最后写入日期和时间。 |
| [getDate_internalized()](#getDate-internalized--) |  |
| [getElementName()](#getElementName--) | 获取或设置图形库元素名称，适用于 Adobe® Photoshop® CC 库。 |
| [getElementRef()](#getElementRef--) | 获取或设置图形库元素引用，适用于 Adobe® Photoshop® CC 库。 |
| [getFileCreator()](#getFileCreator--) | 获取或设置 PSD 格式 LnkE / Lnk2 资源中的文件创建者。 |
| [getFileName()](#getFileName--) | 获取或设置 PSD 链接资源中外部或嵌入文件的名称。 |
| [getFileSize()](#getFileSize--) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的大小。 |
| [getFileType()](#getFileType--) | 获取或设置 Adobe® Photoshop® Lnk2 / LnkE 资源所包含或链接的嵌入或外部文件的类型。 |
| [getFullPath()](#getFullPath--) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的完整路径。 |
...
| [getRelativePath()](#getRelativePath--) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的相对路径。 |
...
| [setAdobeStockId(String value)](#setAdobeStockId-java.lang.String-) | 获取或设置图形库 AdobeStockId，适用于 Adobe® Photoshop® CC 库。 |
...
| [setDate(Date value)](#setDate-java.util.Date-) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的最后写入日期和时间。 |
| [setDate_internalized(System.DateTime value)](#setDate-internalized-com.aspose.ms.System.DateTime-) |  |
| [setElementName(String value)](#setElementName-java.lang.String-) | 获取或设置图形库元素名称，适用于 Adobe® Photoshop® CC 库。 |
| [setElementRef(String value)](#setElementRef-java.lang.String-) | 获取或设置图形库元素引用，适用于 Adobe® Photoshop® CC 库。 |
| [setFileCreator(String value)](#setFileCreator-java.lang.String-) | 获取或设置 PSD 格式 LnkE / Lnk2 资源中的文件创建者。 |
| [setFileName(String value)](#setFileName-java.lang.String-) | 获取或设置 PSD 链接资源中外部或嵌入文件的名称。 |
| [setFileOpenDescriptor(boolean value)](#setFileOpenDescriptor-boolean-) | 获取或设置 一个值，指示此链接数据源是否具有文件打开描述符：CompId 和 OriginalCompId。 |
| [setFileSize(long value)](#setFileSize-long-) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的大小。 |
| [setFileType(String value)](#setFileType-java.lang.String-) | 获取或设置 Adobe® Photoshop® Lnk2 / LnkE 资源所包含或链接的嵌入或外部文件的类型。 |
| [setFullPath(String value)](#setFullPath-java.lang.String-) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的完整路径。 |
...
| [setRelativePath(String value)](#setRelativePath-java.lang.String-) | 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的相对路径。 |
...
初始化 [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) 类的新实例。
...
获取或设置图形库 AdobeStockId，适用于 Adobe® Photoshop® CC 库。
...
获取 Adobe® Photoshop® CC 库中（如果可用）Adobe Stock 许可证的状态。

值：Adobe Stock 许可证的状态，如果不可用则为空字符串。
...
获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的最后写入日期和时间。
...
获取或设置图形库元素名称，适用于 Adobe® Photoshop® CC 库。
...
获取或设置图形库元素引用，适用于 Adobe® Photoshop® CC 库。
...
获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的大小。
...
获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的完整路径。
...
获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的相对路径。
