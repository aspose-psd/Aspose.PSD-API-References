...
description: "定义包含 PSD 格式每通道 32 位图像中嵌入文件信息的类。"
type: docs
weight: 16
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
定义了该类，该类包含关于 PSD 格式 32 位每通道图像中嵌入文件的信息。链接资源可能包含多个 [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) 实例，可通过索引器访问。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | 初始化 [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) 类的新实例。 |
## 字段
...
初始化 [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) 类的新实例。
