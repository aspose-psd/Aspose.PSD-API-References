...
description: "定义包含 PSD 文件中链接文件或资产信息的 LinkDataSource 类。"
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource/
---
...
定义包含 PSD 文件中链接文件或资产信息的 LinkDataSource 类。
## 字段
