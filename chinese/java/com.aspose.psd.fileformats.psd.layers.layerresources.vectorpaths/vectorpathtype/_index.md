...
type: docs
weight: 22
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
| 字段 | 描述 |
| --- | --- |
| [ClipboardRecord](#ClipboardRecord) | 剪贴板记录 |
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | 已链接的闭合子路径贝塞尔节点 |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | 未链接的闭合子路径贝塞尔节点 |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | 闭合子路径长度记录 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | 初始填充规则记录 |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | 已链接的开放子路径贝塞尔节点 |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | 未链接的开放子路径贝塞尔节点 |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | 开放子路径长度记录 |
| [PathFillRuleRecord](#PathFillRuleRecord) | 路径填充规则记录 |
## Methods
