...
type: docs
weight: 28
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [VogkResource()](#VogkResource--) | 初始化 [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | 用于保存形状原点设置的描述符键。 |
...
| [getItems_internalized()](#getItems-internalized--) | 获取或设置结构项。 |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | 获取或设置形状原点设置。 |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | 获取或设置形状原点设置。 |
...
初始化 [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) 类的新实例。
