...
type: docs
weight: 21
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathrecordfactory/
---
...
| [producePathRecordSerializer_internalized(VectorPathRecord vectorPathRecord)](#producePathRecordSerializer-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorPathRecord-) | 根据 VectorPathRecord 的类型生成 VectorPathRecordSerializer 派生类。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
根据 VectorPathRecord 的类型生成 VectorPathRecordSerializer 派生类。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| vectorPathRecord | [VectorPathRecord](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathrecord) | 应序列化的 VectorPathRecord 对象。 |

**Returns:**
com.aspose.internal.fileformats.psd.layers.layerresources.vectorpaths.serializer.VectorPathRecordSerializer - VectorPathRecordSerializer 实例。
### toString() {#toString--}
```
