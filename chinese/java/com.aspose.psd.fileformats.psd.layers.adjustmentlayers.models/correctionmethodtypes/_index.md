...
description: "选择性颜色调整图层中的校正方法。"
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/correctionmethodtypes/
---
...
| 字段 | 描述 |
| --- | --- |
| [Absolute](#Absolute) | 在绝对模式下应用颜色校正。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | 在相对模式下应用颜色校正。 |
## Methods
