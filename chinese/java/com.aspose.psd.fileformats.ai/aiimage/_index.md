...
description: "Adobe Illustrator AI 图像"
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [AiImage()](#AiImage--) | 初始化 [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) 类的新实例。 |
## 字段
...
| Method | 描述 |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | 添加 AI 图层部分。 |
| [cacheData()](#cacheData--) | 缓存数据，并确保不会从底层 P:Aspose.PSD.DataStreamSupporter.DataStreamContainer 加载额外数据。 |
...
| [getActivePageIndex()](#getActivePageIndex--) | 获取或设置活动页面的索引。 |
...
| [getDataSection()](#getDataSection--) | 获取数据部分。 |
...
| [getFinalizeSection()](#getFinalizeSection--) | 获取 finalize 部分。 |
...
| [getSetupSection()](#getSetupSection--) | 获取设置部分。 |
...
| [getVersion()](#getVersion--) | 获取 Adobe Illustrator 格式的版本。 |
| [getWidth()](#getWidth--) | 获取图像宽度。 |
| [getXmpData()](#getXmpData--) | 获取 XMP 元数据。 |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | 获取或设置活动页面的索引。 |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | 获取渲染的图像。 |
...
初始化 [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) 类的新实例。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | AI 图层部分。 |
...
缓存数据，并确保不会从底层 P:Aspose.PSD.DataStreamSupporter.DataStreamContainer 加载额外数据。
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - ApsPage 实例。
...
值：此属性仅适用于 PDF 格式的 AI 图像。如果图像不是 PDF 格式或没有页面，属性将为 -1。此属性显示 AI 图像的哪一页将作为渲染的基准。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| ventureLicense | java.lang.Object | Venture 许可证对象。 |
