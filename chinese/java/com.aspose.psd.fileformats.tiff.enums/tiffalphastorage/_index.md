...
description: "指定 tiff 文档的 alpha 存储方式。"
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.tiff.enums/tiffalphastorage/
---
...
| [Unspecified](#Unspecified) | Alpha 未指定，且存储在 TIFF 文件中。 |
## Methods
...
Alpha 值以预乘形式存储。恢复 Alpha 时可能会出现一些四舍五入误差，恢复后的值可能与原始值不同。
