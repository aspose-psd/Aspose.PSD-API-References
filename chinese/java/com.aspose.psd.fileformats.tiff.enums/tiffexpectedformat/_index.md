...
type: docs
weight: 15
url: /zh/java/com.aspose.psd.fileformats.tiff.enums/tiffexpectedformat/
---
...
| 字段 | 描述 |
| --- | --- |
| [Default](#Default) | 默认的 tiff 格式是不压缩，仅限于黑白 1 位每像素的格式。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TiffCcitRle](#TiffCcitRle) | tiff CCITT RLE 编码。 |
| [TiffCcittFax3](#TiffCcittFax3) | tiff CCITT FAX3 编码。 |
| [TiffCcittFax4](#TiffCcittFax4) | tiff CCITT FAX4 编码。 |
| [TiffDeflateBw](#TiffDeflateBw) | 具有 Deflate 压缩且仅限 B/W 1 位每像素格式的 tiff。 |
| [TiffDeflateRgb](#TiffDeflateRgb) | 具有 Deflate 压缩且为 RGB 彩色格式的 tiff。 |
| [TiffDeflateRgba](#TiffDeflateRgba) | 具有 Deflate 压缩且为 RGBA 彩色格式的 tiff。 |
| [TiffJpegRgb](#TiffJpegRgb) | 具有 Jpeg 压缩且为 RGB 彩色格式的 tiff。 |
| [TiffJpegYCbCr](#TiffJpegYCbCr) | 具有 Jpeg 压缩且为 YCBCR 彩色格式的 tiff。 |
| [TiffLzwBw](#TiffLzwBw) | 具有 LZW 压缩且仅限 B/W 1 位每像素格式的 tiff。 |
| [TiffLzwCmyk](#TiffLzwCmyk) | 该 tiff 为 LZW CMYK。 |
| [TiffLzwRgb](#TiffLzwRgb) | 具有 LZW 压缩且为 RGB 彩色格式的 tiff。 |
| [TiffLzwRgba](#TiffLzwRgba) | 具有 LZW 压缩且为带透明度的 RGBA 彩色格式的 tiff。 |
| [TiffNoCompressionBw](#TiffNoCompressionBw) | 未压缩的 tiff 且仅限 B/W 1 位每像素格式。 |
| [TiffNoCompressionRgb](#TiffNoCompressionRgb) | 未压缩的 tiff 且为 RGB 彩色格式。 |
| [TiffNoCompressionRgba](#TiffNoCompressionRgba) | 未压缩的 tiff 且为带透明度的 RGBA 彩色格式。 |
## Methods
...
默认的 tiff 格式是不压缩且仅限 B/W 1 位每像素格式。您也可以使用此设置获取空选项，并使用您的标签或其他设置进行初始化。
...
tiff CCITT RLE 编码。仅支持该方案的 B/W 1 位每像素。
...
tiff CCITT FAX3 编码。仅支持该方案的 B/W 1 位每像素。
...
tiff CCITT FAX4 编码。仅支持该方案的 B/W 1 位每像素。
...
具有 Deflate 压缩且仅限 B/W 1 位每像素格式的 tiff。
...
具有 Deflate 压缩且为 RGB 彩色格式的 tiff。
...
具有 Deflate 压缩且为 RGBA 彩色格式的 tiff。
...
具有 LZW 压缩且仅限 B/W 1 位每像素格式的 tiff。
...
具有 LZW 压缩且为带透明度的 RGBA 彩色格式的 tiff。
