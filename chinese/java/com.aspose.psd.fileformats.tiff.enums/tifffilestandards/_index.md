...
type: docs
weight: 16
url: /zh/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
基线 TIFF 6.0 文件标准。该标准正式名称为 TIFF 6.0，第 1 部分：基线 TIFF。
...
扩展 TIFF 6.0 文件标准。该标准正式名称为扩展 TIFF 6.0，第 2 部分：TIFF 扩展。
