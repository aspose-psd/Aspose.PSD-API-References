...
type: docs
weight: 16
url: /zh/java/com.aspose.psd.exif.enums/exifflash/
---
...
| [NoAuto](#NoAuto) | 闪光未触发，自动模式。 |
| [NoCompulsory](#NoCompulsory) | 闪光未触发，强制闪光模式。 |
| [NoDidNotFireReturnLightNotDetected](#NoDidNotFireReturnLightNotDetected) | 闪光未触发，未检测到返光。 |
| [NoFlashFunction](#NoFlashFunction) | 没有闪光功能。 |
| [Noflash](#Noflash) | 未触发闪光。 |
| [YesAuto](#YesAuto) | 闪光已触发自动模式。 |
| [YesAutoReturnLightDetected](#YesAutoReturnLightDetected) | 闪光已触发，自动模式，检测到返光。 |
| [YesAutoReturnLightNotDetected](#YesAutoReturnLightNotDetected) | 闪光已触发，自动模式，未检测到返光。 |
