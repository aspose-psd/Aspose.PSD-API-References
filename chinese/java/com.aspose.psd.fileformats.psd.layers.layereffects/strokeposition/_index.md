...
description: "位置设置控制笔画相对于其应用的图层的对齐方式。"
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layereffects/strokeposition/
---
...
位置设置控制笔画相对于其应用的图层在 [StrokeEffect](../../com.aspose.psd.fileformats.psd.layers.layereffects/strokeeffect) 中的对齐方式。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Center](#Center) | 笔画将从形状的边缘创建，并向内外两侧扩展。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inside](#Inside) | 笔画将从形状的边缘创建，向内生长至对象的中心。 |
| [Outside](#Outside) | 笔画将从形状的边缘创建，向外生长，远离对象。 |
## Methods
