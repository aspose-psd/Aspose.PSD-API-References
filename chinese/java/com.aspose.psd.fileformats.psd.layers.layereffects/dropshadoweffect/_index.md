...
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layereffects/dropshadoweffect/
---
...
| [getKnocksOut()](#getKnocksOut--) | 获取或设置一个值，指示是否 [knocks out]。 |
...
| [setKnocksOut(boolean value)](#setKnocksOut-boolean-) | 获取或设置一个值，指示是否 [knocks out]。 |
