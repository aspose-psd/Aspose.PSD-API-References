...
description: "定义 SoLdResource 类，包含 PSD 文件中智能对象图层的信息。"
type: docs
weight: 15
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
定义 SoLdResource 类，该类包含 PSD 文件中智能对象图层的信息。用于支持 Adobe® Photoshop® 图像中的智能对象图层。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | 初始化 [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) 类的新实例。 |
| [SoLdResource()](#SoLdResource--) | 初始化 [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) 类的新实例。 |
## 字段
...
| [TypeToolKey](#TypeToolKey) | 类型工具信息键：'SoLd'。 |
...
初始化 [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) 类的新实例。需要设置 Items 属性或调用 InitializeItems() 以获取就绪的实例。此构造函数设计用于由 [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) 在单元测试中使用。使用 [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) 来创建 SoLdResource 类。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| uniqueId | java.util.UUID | 智能对象图层数据的唯一标识符 [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
初始化 [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) 类的新实例。此默认构造函数旨在供 SoLdResourceLoader 使用。使用 [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) 来创建 SoLdResource 类。
