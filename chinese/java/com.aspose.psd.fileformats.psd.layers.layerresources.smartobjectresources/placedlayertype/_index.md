...
description: "定义 PlacedLayerType 枚举，用于已放置图层的 PlLd 资源。"
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedlayertype/
---
...
定义 PlacedLayerType 枚举，用于已放置图层的 PlLd 资源。
## 字段

| 字段 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ImageStack](#ImageStack) | 图像堆栈已放置图层类型 |
| [Raster](#Raster) | 光栅已放置图层类型 |
| [Unknown](#Unknown) | 未知已放置图层类型 |
| [Vector](#Vector) | 矢量已放置图层类型 |
## Methods
