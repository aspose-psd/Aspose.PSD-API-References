...
description: "定义 PlacedResource 类，包含 PSD 文件中已放置图层或智能对象图层的通用信息。"
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
定义 PlacedResource 类，包含 PSD 文件中已放置图层或智能对象图层的通用信息。用于支持 Adobe\ufffd Photoshop\ufffd 图像中的智能对象图层。
## 字段
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | 获取或设置扭曲项。 |
