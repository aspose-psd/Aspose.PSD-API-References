...
description: "定义 SoLeResource 类，包含 PSD 文件中智能对象图层的信息。"
type: docs
weight: 16
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource/
---
...
定义 SoLeResource 类，该类包含 PSD 文件中智能对象图层的信息。它用于在 Adobe\ufffd Photoshop\ufffd 图像中支持带有外部文件链接的智能对象图层。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [SoLeResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLeResource-java.util.UUID-boolean-boolean-) | 初始化 [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource) 类的新实例。 |
| [SoLeResource()](#SoLeResource--) | 初始化 [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource) 类的新实例。 |
## 字段
...
| [TypeToolKey](#TypeToolKey) | 类型工具信息键：'SoLE'。 |
...
初始化 [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| uniqueId | java.util.UUID | 已放置图层数据的唯一标识符 [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource)。 |
