...
description: "HueSaturation 调整图层。"
type: docs
weight: 20
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| [getColorize()](#getColorize--) | 获取或设置一个值，指示此 [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) 是否进行着色。 |
...
| [getRange(int index)](#getRange-int-) | 获取范围。 |
...
| [setColorize(boolean value)](#setColorize-boolean-) | 获取或设置一个值，指示此 [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) 是否进行着色。 |
...
获取或设置一个值，指示此 [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) 是否进行着色。
