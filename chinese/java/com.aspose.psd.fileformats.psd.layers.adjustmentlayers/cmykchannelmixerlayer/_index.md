...
description: "CMYK 通道混合器调整图层。"
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| [getBlackChannel()](#getBlackChannel--) | 获取黑色通道。 |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | 获取通道的索引方式。 |
...
| [getCyanChannel()](#getCyanChannel--) | 获取青色通道。 |
...
| [getMagentaChannel()](#getMagentaChannel--) | 获取品红通道。 |
...
| [getMonochrome()](#getMonochrome--) | 获取或设置一个值，指示此 [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) 是否为单色。 |
...
| [getYellowChannel()](#getYellowChannel--) | 获取黄色通道。 |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | 获取或设置一个值，指示此 [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) 是否为单色。 |
...
获取或设置一个值，指示此 [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) 是否为单色。

值： true 如果为单色；否则， false。
