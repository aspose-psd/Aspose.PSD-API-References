...
description: "选择性颜色调整图层。"
type: docs
weight: 28
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | 获取通过选择性颜色的 cmyk 校正。 |
| [getContainer()](#getContainer--) | 获取 Image 容器。 |
| [getCorrectionMethod()](#getCorrectionMethod--) | 获取或设置校正方法。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 处理选择性颜色层。 |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | 设置通过选择性颜色的 cmyk 校正。 |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | 设置 Image 容器。 |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | 获取或设置校正方法。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| selectiveColorsType | int | 选择性颜色的类型。 |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Cmyk 校正。 |
