...
type: docs
weight: 19
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
梯度映射层。使用来自 GrdmResource 的数据处理梯度映射渲染。
## 字段
...
| [getGradientSettings()](#getGradientSettings--) | 获取或设置从 GrdmResource 实例传递的 Gradient 设置实例。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 处理梯度映射层。 |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | 获取或设置从 GrdmResource 实例传递的 Gradient 设置实例。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 在相关图层资源 [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource) 中更新图层数据。 |
...
获取或设置从 GrdmResource 实例传递的 Gradient 设置实例。
...
在相关图层资源 [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource) 中更新图层数据。
