...
type: docs
weight: 17
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | 获取曲线管理器。 |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | 获取或设置一个值，指示此实例是否使用连续管理器。 |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | 获取或设置一个值，指示此实例是否使用离散管理器。 |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | 获取或设置一个值，指示此实例是否使用连续管理器。 |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | 获取或设置一个值，指示此实例是否使用离散管理器。 |
...
获取或设置一个值，指示此实例是否使用连续管理器。

值：  true  如果此实例使用连续管理器；否则，  false 。
...
获取或设置一个值，指示此实例是否使用离散管理器。

值：  true  如果此实例使用离散管理器；否则，  false 。
