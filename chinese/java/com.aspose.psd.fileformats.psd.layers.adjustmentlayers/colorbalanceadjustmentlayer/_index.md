...
description: "颜色平衡调整图层类。"
type: docs
weight: 16
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | 获取调整图层的类型。 |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | 获取处理器。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 处理调整图层。 |
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | 对指定的 int RGB 数组应用当前阴影、中间调和高光的校正。 |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | 合并其中的数据。 |
...
| 像素 | int[] | 像素数组。 |
| start | [Point](../../com.aspose.psd/point) | 像素左上位置。 |
| end | [Point](../../com.aspose.psd/point) | 像素右下位置。 |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - 像素矩形和已处理的像素。
...
对指定的 int RGB 数组应用当前阴影、中间调和高光的校正。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| 像素 | int[] | int 颜色 RGB 数组。 |
