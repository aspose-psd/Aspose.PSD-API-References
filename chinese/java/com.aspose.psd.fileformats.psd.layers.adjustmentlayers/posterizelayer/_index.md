...
type: docs
weight: 25
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Posterize 层。使用来自 PostResource 的数据处理 Posterize 渲染。
## 字段
...
| [getLevels()](#getLevels--) | Posterize 层的级别。 |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 处理 Posterize 层。 |
...
| [setLevels(short value)](#setLevels-short-) | Posterize 层的级别。 |
