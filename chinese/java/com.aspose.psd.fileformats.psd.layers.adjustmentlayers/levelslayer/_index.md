...
type: docs
weight: 22
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| [getChannel(int index)](#getChannel-int-) | 获取通道。 |
...
| [getMasterChannel()](#getMasterChannel--) | 获取主通道。 |
...
| 像素 | int[] | 像素。 |
| start | [Point](../../com.aspose.psd/point) | 开始。 |
| end | [Point](../../com.aspose.psd/point) | 结束。 |
