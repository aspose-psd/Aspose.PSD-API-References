...
description: "亮度/对比度图层。"
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
获取或设置亮度。对于 PS，亮度范围是 -150 到 +150。但我们忽略此设置。
...
获取或设置对比度。对于 PS，对比度范围是 -50 到 +100。但我们忽略此设置。
