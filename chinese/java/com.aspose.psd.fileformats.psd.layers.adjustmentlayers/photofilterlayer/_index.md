...
type: docs
weight: 24
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [getColor()](#getColor--) | 获取或设置滤镜的 RGB 颜色。 |
...
| [getDensity()](#getDensity--) | 获取或设置滤镜的密度。 |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | 获取或设置滤镜的 RGB 颜色。 |
...
| [setDensity(int value)](#setDensity-int-) | 获取或设置滤镜的密度。 |
