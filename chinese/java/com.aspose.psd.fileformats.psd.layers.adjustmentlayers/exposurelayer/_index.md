...
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | 获取或设置 Exposure。 |
...
| [getGammaCorrection()](#getGammaCorrection--) | 获取或设置 GammaCorrection。 |
...
| [getOffset()](#getOffset--) | 获取或设置 Offset。 |
...
| [setExposure(float value)](#setExposure-float-) | 获取或设置 Exposure。 |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | 获取或设置 GammaCorrection。 |
...
| [setOffset(float value)](#setOffset-float-) | 获取或设置 Offset。 |
...
获取或设置 Exposure。对于 PS，Exposure 的范围是从 -20 到 +20。
...
获取或设置 GammaCorrection。对于 PS，GammaCorrection 的范围是从 9.99 到 +0.01。
...
获取或设置 Offset。对于 PS，Offset 的范围是从 -0.5 到 +0.5。
