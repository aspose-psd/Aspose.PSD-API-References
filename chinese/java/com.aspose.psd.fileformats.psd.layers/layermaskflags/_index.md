...
type: docs
weight: 24
url: /zh/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| 字段 | 描述 |
| --- | --- |
| [Disabled](#Disabled) | 图层蒙版已禁用。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | 混合时反转图层蒙版。 |
| [None](#None) | 未定义标志。 |
| [RelativeToLayer](#RelativeToLayer) | 位置相对于图层。 |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | 指示用户蒙版实际上来自渲染其他数据。 |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | 指示用户和/或矢量蒙版已应用参数。 |
## Methods
