...
type: docs
weight: 16
url: /zh/java/com.aspose.psd.fileformats.psd.layers/layer/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [Layer()](#Layer--) | 初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。 |
| [Layer(RasterImage image)](#Layer-com.aspose.psd.RasterImage-) |  |
| [Layer(RasterImage image, boolean disposeImage)](#Layer-com.aspose.psd.RasterImage-boolean-) | 初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。 |
| [Layer(InputStream stream)](#Layer-java.io.InputStream-) | 初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。 |
| [Layer(Rectangle bounds, byte[] redBytes, byte[] greenBytes, byte[] blueBytes, String name)](#Layer-com.aspose.psd.Rectangle-byte---byte---byte---java.lang.String-) | 从字节数组初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。 |
## 字段
...
初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。用于延迟初始化的构造函数。
...
初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| image | [RasterImage](../../com.aspose.psd/rasterimage) | 图像。 |
| disposeImage | boolean | 如果设置为 true，则 [dispose image]。 |
...
从字节数组初始化 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | 图层边界。 |
| redBytes | byte[] | 红色字节。 |
