...
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.psd.layers/filllayer/
---
...
填充图层。颜色填充、渐变填充或图案填充图层，由 FillSettings 区别（[getFillSettings](../../com.aspose.psd.fileformats.psd.layers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers/filllayer\#setFillSettings-IFillSettings-))）
## 字段
...
| [createInstance(int fillType)](#createInstance-int-) | 通过填充类型构建 [FillLayer](../../com.aspose.psd.fileformats.psd.layers/filllayer) 类的新实例。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 根据当前的 [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) 更新填充图层的像素数据。 |
...
通过填充类型构建 [FillLayer](../../com.aspose.psd.fileformats.psd.layers/filllayer) 类的新实例。
...
根据当前的 [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) 更新填充图层的像素数据。
