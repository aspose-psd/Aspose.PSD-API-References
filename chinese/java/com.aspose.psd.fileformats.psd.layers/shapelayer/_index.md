...
type: docs
weight: 29
url: /zh/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
形状图层。封装了与形状图层及相关资源的工作逻辑。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | 初始化 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 类的新实例。 |
## 字段
...
| [createInstance()](#createInstance--) | 创建 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 类的新实例。 |
...
| [getFill()](#getFill--) | 形状图层中形状内部区域的填充设置。 |
...
| [getPath()](#getPath--) | 获取呈现在形状图层中的路径集合。 |
...
| [getStroke()](#getStroke--) | 获取或设置形状的描边设置。 |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | 当 [global resources changed] 时调用。 |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | 当 [resources change] 时调用。 |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | 形状图层中形状内部区域的填充设置。 |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | 获取或设置形状的描边设置。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 从 Shape 图层属性更新资源。 |
...
初始化 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 类的新实例。所有资源均以默认状态创建。
...
创建 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 类的新实例。
...
当 [global resources changed] 时调用。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| 发送者 | java.lang.Object | 发送者。 |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | 包含事件数据的 EventArgs 实例。 |
