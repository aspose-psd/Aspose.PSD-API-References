...
type: docs
weight: 30
url: /zh/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | 校正字体的大小 |
...
| [createInstance_internalized()](#createInstance-internalized--) | 创建 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 类的新实例。 |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | 创建 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 类的新实例。 |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | 获取引擎数据。 |
...
| [getInnerText()](#getInnerText--) | 获取图层的文本。 |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | 获取或设置资源处理器。 |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | 获取字符串格式。 |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | 获取同步根目录。 |
| [getText()](#getText--) | 获取文本。 |
| [getTextBoundBox()](#getTextBoundBox--) | 获取或设置文本边界框。 |
| [getTextColor()](#getTextColor--) | 获取文本的颜色。 |
| [getTextData()](#getTextData--) | 获取文本的各部分。 |
| [getTop()](#getTop--) | 获取或设置顶部图层位置。 |
| [getTransformMatrix()](#getTransformMatrix--) | 获取或设置变换矩阵。 |
| [getTransparentColor()](#getTransparentColor--) | 获取图像透明颜色。 |
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | 搜索并获取来自 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 的 [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) 资源。 |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | 获取或设置指示 [was changed] 的值。 |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | 确定 [is font available] [the specified font] 是否可用。 |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | 预处理字体。 |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | 将字体替换为默认字体。 |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | 获取图层的文本。 |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | 获取或设置资源处理器。 |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | 获取或设置文本边界框。 |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | 获取或设置指示 [was changed] 的值。 |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | 更新资源中 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 的边界。 |
| [updateText(String text)](#updateText-java.lang.String-) | 更新文本。 |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | 更新文本。 |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | 更新文本。 |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | 更新文本。 |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | 更新文本。 |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | 更新文本。 |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | 更新文本。 |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | 更新文本。 |
| [wait()](#wait--) |  |
...
创建 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 类的新实例。
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - 文本图层的字体集合。
...
搜索并获取来自 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 的 [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) 资源。
...
获取或设置指示 [was changed] 的值。

值： true 如果 [已更改]；否则， false 。
...
确定 [is font available] [the specified font] 是否可用。
...
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | 字体。 |
| defaultFontName | java.lang.String | 字体的默认名称。 |
...
| newWidth | int | 新的宽度。 |
| newHeight | int | 新的高度。 |
| resizeType | int | 调整大小变换的类型  ResizeType |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| 值 | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
更新资源中 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 的边界。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | 文本的绝对位置和大小。 |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | 文本相对于 textBox 的位置和大小。 |
...
| --- | --- | --- |
| 文本 | java.lang.String | 文本值。 |
| color | [Color](../../com.aspose.psd/color) | 颜色值。 |
...
| --- | --- | --- |
| 文本 | java.lang.String | 文本值。 |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | 左上坐标。 |
