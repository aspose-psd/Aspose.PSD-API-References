...
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.layers/layerflags/
---
...
| [HasUsefulInformation](#HasUsefulInformation) | 适用于 Photoshop 5.0 及更高版本，指示第 4 位是否包含有用信息。 |
| [Obsolete](#Obsolete) | 已废弃标志 |
| [PixelDataIrrelevantToAppearenceInDocument](#PixelDataIrrelevantToAppearenceInDocument) | 与文档外观无关的像素数据 |
| [TransparencyProtected](#TransparencyProtected) | 受透明度保护的 |
| [Undocumented](#Undocumented) | 未记录的标志 |
...
适用于 Photoshop 5.0 及更高版本，指示第 4 位是否包含有用信息。
