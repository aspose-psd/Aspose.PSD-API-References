...
description: "用于 Photoshop 渐变插值方法的打包 fourCC 值。"
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
为 Photoshop 渐变插值方法打包的 fourCC 值。描述符键："gradientsInterpolationMethod"
## 字段

| 字段 | 描述 |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 经典（当键缺失时的传统默认值）。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 线性（注意尾随空格）。 |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 感知的。 |
| [Smooth](#Smooth) | 'Smoo' \\u2014 平滑。 |
| [Stripes](#Stripes) | 'GIMs' \\u2014 条纹。 |
## Methods
