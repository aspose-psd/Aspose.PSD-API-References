...
description: "带有泛型结果的异步任务的长操作委托。"
type: docs
weight: 12
url: /zh/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | 带有泛型结果的异步任务的长操作委托。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | 异步任务的状态。 |
