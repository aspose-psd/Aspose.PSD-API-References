...
type: docs
weight: 10
url: /zh/java/com.aspose.psd.xmp.schemas.xmpmm/xmpmediamanagementpackage/
---
...
| [setDerivedFrom(ResourceRef resourceRef)](#setDerivedFrom-com.aspose.psd.xmp.types.complex.resourceref.ResourceRef-) | 设置派生自。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| resourceRef | [ResourceRef](../../com.aspose.psd.xmp.types.complex.resourceref/resourceref) | 资源引用。 |
