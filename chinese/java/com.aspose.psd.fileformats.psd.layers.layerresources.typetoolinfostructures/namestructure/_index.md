...
description: "Name 结构键 0x6E616D65（在 ASCII 中拼写为 name）是一个简单结构，用于存储表示元素名称（如图层路径或调整）的 Unicode 或 Pascal 风格字符串。"
type: docs
weight: 19
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
Name 结构（键：0x6E616D65，对应 ASCII 中的 "name"）是一种简单结构，用于存储表示元素名称（如图层、路径或调整）的 Unicode 或 Pascal 风格字符串。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [StructureKey](#StructureKey) | Name 结构键。 |
## Methods
...
| [getValue()](#getValue--) | 获取或设置 Name 结构的值。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | 获取或设置 Name 结构的第一个字符串值。 |
...
| [setValue(String value)](#setValue-java.lang.String-) | 获取或设置 Name 结构的值。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化 [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) 类的新实例。
...
获取或设置 Name 结构的第一个字符串值。它通常包含换行符。
