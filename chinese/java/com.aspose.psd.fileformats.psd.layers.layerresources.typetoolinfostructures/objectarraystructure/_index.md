...
description: "定义通常保存数组的 ObjectArrayStructure 类。"
type: docs
weight: 20
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
定义通常保存 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 数组的 ObjectArrayStructure 类。它用于 PSD 文件资源，例如 PlLd Resource 和 SoLd Resource。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 初始化 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 类的新实例。 |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 初始化 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [StructureKey](#StructureKey) | 标识 'ObAr' 结构键。 |
## Methods
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | 获取或设置对象数组类 ID。 |
| [getClassName()](#getClassName--) | 获取或设置对象数组类名称。 |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | 获取结构列表。 |
| [getKey()](#getKey--) | 获取对象数组结构键。 |
| [getKeyName()](#getKeyName--) | 获取或设置键名。 |
| [getLength()](#getLength--) | 获取 OSTypeStructure 的字节长度。 |
...
| [getStructureCount()](#getStructureCount--) | 获取对象数组子结构计数。 |
| [getStructures()](#getStructures--) | 获取或设置对象数组结构中的子结构。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 获取或设置对象数组类 ID。 |
| [setClassName(String value)](#setClassName-java.lang.String-) | 获取或设置对象数组类名称。 |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 获取或设置对象数组结构中的子结构。 |
...
初始化 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| keyName | java.lang.String | 键的名称。 |
| classIdName | java.lang.String | 类标识符的名称。 |
| structures | [OSTypeStructure\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | 结构。 |
