...
type: docs
weight: 29
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes/
---
...
| --- | --- |
| [Angle](#Angle) | 角度单位。 |
| [Density](#Density) | 密度单位。 |
| [Distance](#Distance) | 距离单位。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Millimeters](#Millimeters) | 毫米单位。 |
| [None](#None) | 未定义单位。 |
| [Percent](#Percent) | 百分比单位。 |
| [Pixels](#Pixels) | 像素单位。 |
| [Points](#Points) | 点单位。 |
## Methods
