...
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | 初始化 [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | 标识结构键。 |
| [StructureKeyGlbc](#StructureKeyGlbc) | 标识结构键。 |
| [StructureKeyType](#StructureKeyType) | 标识结构键。 |
## Methods
...
初始化 [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) 类的新实例。
