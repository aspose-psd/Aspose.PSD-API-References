...
type: docs
weight: 21
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) 类的新实例。 |
## 字段
...
| [setValue(int value)](#setValue-int-) | 获取或设置整数值。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化 [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) 类的新实例。
