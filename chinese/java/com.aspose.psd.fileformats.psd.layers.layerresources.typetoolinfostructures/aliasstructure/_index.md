...
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) 类的新实例。 |
## 字段
...
| [getDataLength()](#getDataLength--) | 获取精确的数据长度（字节）。 |
| [getFullPath()](#getFullPath--) | 获取或设置完整路径。 |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | 获取或设置完整路径。 |
...
初始化 [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) 类的新实例。
