...
type: docs
weight: 17
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [IntegerStructure(ClassID keyName)](#IntegerStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [StructureKey](#StructureKey) | 整数结构键。 |
## Methods
...
初始化 [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure) 类的新实例。
