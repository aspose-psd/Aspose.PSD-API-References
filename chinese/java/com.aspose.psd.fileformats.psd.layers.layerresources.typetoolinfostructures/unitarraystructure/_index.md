...
description: "定义 UnitArrayStructure 类，该类保存 double 值数组及其计量单位。"
type: docs
weight: 27
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
定义 UnitArrayStructure 类，该类保存 double 值数组及其计量单位。它在 PSD 文件资源中使用，通常由 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 提供。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | 初始化 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [StructureKey](#StructureKey) | 定义 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 键。 |
## Methods
...
| [getUnitType()](#getUnitType--) | 获取或设置 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 值的计量单位类型。 |
| [getValueCount()](#getValueCount--) | 获取值计数。 |
| [getValues()](#getValues--) | 获取或设置单位数组结构的值。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | 获取或设置 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 值的计量单位类型。 |
| [setValues(double[] value)](#setValues-double---) | 获取或设置单位数组结构的值。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | 键的名称。 |
| unitType | int | 单位的类型。 |
| values | double[] | 这些值。 |
...
定义 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 键。
...
获取或设置 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 值的计量单位类型。
