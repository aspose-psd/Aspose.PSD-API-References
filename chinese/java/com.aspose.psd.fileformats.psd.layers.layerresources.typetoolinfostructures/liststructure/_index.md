...
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ListStructure(ClassID keyName)](#ListStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) 类的新实例。 |
## 字段
...
| [getItemsCount()](#getItemsCount--) | 获取项目计数。 |
| [getKey()](#getKey--) | 获取结构键。 |
...
| [setTypes(OSTypeStructure[] value)](#setTypes-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 获取或设置类型。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化 [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) 类的新实例。
