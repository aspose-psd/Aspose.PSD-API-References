...
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [DoubleStructure(ClassID keyName)](#DoubleStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) 类的新实例。 |
## 字段
...
| [setValue(double value)](#setValue-double-) | 获取或设置双精度值。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化 [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) 类的新实例。
