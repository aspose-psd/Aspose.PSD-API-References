...
type: docs
weight: 26
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [StringStructure(ClassID keyName)](#StringStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化一个新的 [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure) 类实例。 |
## 字段
...
| [setValue(String value)](#setValue-java.lang.String-) | 获取或设置该值。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
初始化一个新的 [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure) 类实例。
