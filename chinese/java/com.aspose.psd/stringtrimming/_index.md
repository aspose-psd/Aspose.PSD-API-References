...
description: "指定如何从无法完全适配布局形状的字符串中修剪字符。"
type: docs
weight: 108
url: /zh/java/com.aspose.psd/stringtrimming/
---
...
指定如何从无法完全适配布局形状的字符串中修剪字符。
## 字段

| 字段 | 描述 |
| --- | --- |
| [Character](#Character) | 指定将文本修剪至最近的字符。 |
| [EllipsisCharacter](#EllipsisCharacter) | 指定将文本修剪至最近的字符，并在修剪行的末尾插入省略号。 |
| [EllipsisPath](#EllipsisPath) | 修剪行的中间部分被删除，并替换为省略号。 |
| [EllipsisWord](#EllipsisWord) | 指定将文本修剪至最近的单词，并在修剪行的末尾插入省略号。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | 指定不进行修剪。 |
| [Word](#Word) | 指定将文本修剪至最近的单词。 |
## Methods
...
修剪行的中间部分被删除，并替换为省略号。该算法尽可能保留行中最后一个斜杠分隔段的最大部分。
