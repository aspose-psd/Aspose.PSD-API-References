...
description: "指定在虚线中每个短划线两端使用的图形形状类型。"
type: docs
weight: 35
url: /zh/java/com.aspose.psd/dashcap/
---
...
指定在虚线中每个短划线两端使用的图形形状类型。
## 字段

| 字段 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Flat](#Flat) | 指定方形帽，使每个虚线的两端呈方形。 |
| [Round](#Round) | 指定圆形帽，使每个虚线的两端呈圆形。 |
| [Triangle](#Triangle) | 指定一个三角形帽子，指向每个短划线的两端。 |
## Methods
