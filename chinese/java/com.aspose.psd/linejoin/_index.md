...
description: "指定如何连接包含在 GraphicsPath 对象中的图形子路径中的连续直线或曲线段。"
type: docs
weight: 67
url: /zh/java/com.aspose.psd/linejoin/
---
...
指定如何在 GraphicsPath 对象中包含的图形（子路径）中连接连续的直线或曲线段。
## 字段
...
指定斜接连接。这会产生锐角或斜角拐角，取决于斜接长度是否超过斜接限制。
