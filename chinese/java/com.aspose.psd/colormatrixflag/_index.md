...
description: "指定将受到 ImageAttributes 的颜色和灰度调整设置影响的图像类型和颜色。"
type: docs
weight: 26
url: /zh/java/com.aspose.psd/colormatrixflag/
---
...
指定将受到 ImageAttributes 的颜色和灰度调整设置影响的图像和颜色类型。
## 字段

| 字段 | 描述 |
| --- | --- |
| [AltGrays](#AltGrays) | 仅调整灰色阴影。 |
| [Default](#Default) | 所有颜色值（包括灰色阴影）均通过相同的颜色调整矩阵进行调整。 |
...
所有颜色都会被调整，但灰色阴影不受调整。灰色阴影是指红、绿、蓝分量数值相同的任何颜色。
