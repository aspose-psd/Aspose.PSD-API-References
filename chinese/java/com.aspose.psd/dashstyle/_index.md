...
description: "指定使用 Pen 对象绘制的虚线样式。"
type: docs
weight: 36
url: /zh/java/com.aspose.psd/dashstyle/
---
...
| 字段 | 描述 |
| --- | --- |
| [Custom](#Custom) | 指定用户自定义的虚线样式。 |
| [Dash](#Dash) | 指定由短划线组成的线。 |
| [DashDot](#DashDot) | 指定由短划线-点的重复模式组成的线。 |
| [DashDotDot](#DashDotDot) | 指定由短划线-点-点的重复模式组成的线。 |
| [Dot](#Dot) | 指定由点组成的线。 |
