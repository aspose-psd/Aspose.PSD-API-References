...
description: "com.aspose.psd.InterpolationMode 枚举指定在图像缩放或旋转时使用的算法。"
type: docs
weight: 63
url: /zh/java/com.aspose.psd/interpolationmode/
---
...
com.aspose.psd.InterpolationMode 枚举指定在对图像进行缩放或旋转时使用的算法。
## 字段
...
指定高质量双三次插值。进行预过滤以确保高质量缩小。此模式可生成最高质量的变换图像。
