...
description: "该枚举指定如何根据用户的地区或语言在字符串中替换数字。"
type: docs
weight: 105
url: /zh/java/com.aspose.psd/stringdigitsubstitute/
---
...
| [None](#None) | 指定禁用替换。 |
| [Traditional](#Traditional) | 指定与用户本土文字或语言对应的替换数字，该语言可能与用户地区的官方国家语言不同。 |
| [User](#User) | 指定用户自定义的替换方案。 |
## Methods
...
指定与用户本土文字或语言对应的替换数字，该语言可能与用户地区的官方国家语言不同。
