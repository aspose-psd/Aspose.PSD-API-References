...
type: docs
weight: 30
url: /zh/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | 初始化 [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) 类的新实例。 |
## 字段
...
| [getBleedScale()](#getBleedScale--) | 获取或设置出血比例。 |
| [getBleedWidth()](#getBleedWidth--) | 获取或设置出血宽度。 |
| [getCenterCropMark()](#getCenterCropMark--) | 获取或设置中心裁剪标记。 |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | 获取或设置出血比例。 |
| [setBleedWidth(int value)](#setBleedWidth-int-) | 获取或设置出血宽度。 |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | 获取或设置中心裁剪标记。 |
...
初始化 [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) 类的新实例。
