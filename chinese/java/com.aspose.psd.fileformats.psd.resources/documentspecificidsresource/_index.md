...
description: "文档特定 ID 资源"
type: docs
weight: 16
url: /zh/java/com.aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [DocumentSpecificIdsResource()](#DocumentSpecificIdsResource--) | 初始化 [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) 类的新实例。 |
## 字段
...
| [setId(int value)](#setId-int-) | 获取或设置标识符。 |
...
初始化 [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) 类的新实例。
