...
description: "URL 列表资源"
type: docs
weight: 40
url: /zh/java/com.aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [UrlListResource()](#UrlListResource--) | 初始化一个新的 [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource) 类的实例。 |
## 字段
...
| [getIds()](#getIds--) | 获取或设置 ID。 |
| [getLongs()](#getLongs--) | 获取或设置长整型。 |
...
| [setIds(int[] value)](#setIds-int---) | 获取或设置 ID。 |
...
| [setLongs(int[] value)](#setLongs-int---) | 获取或设置长整型。 |
...
| [setTexts(String[] value)](#setTexts-java.lang.String---) | 获取或设置文本。 |
| [toString()](#toString--) |  |
...
初始化一个新的 [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource) 类的实例。
