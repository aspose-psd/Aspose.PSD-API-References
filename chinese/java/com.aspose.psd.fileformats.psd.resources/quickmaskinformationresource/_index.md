...
description: "快速蒙版信息资源"
type: docs
weight: 32
url: /zh/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | 初始化 [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) 类的新实例。 |
## 字段
...
| [getChannelId()](#getChannelId--) | 获取或设置通道标识符。 |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | 获取或设置一个值，指示此实例是否为 mask empty。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | 将资源块保存到指定的流中。 |
| [setChannelId(short value)](#setChannelId-short-) | 获取或设置通道标识符。 |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | 获取或设置一个值，指示此实例是否为 mask empty。 |
...
初始化 [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) 类的新实例。
...
获取或设置一个值，指示此实例是否为 mask empty。

值：  true  如果此实例是 mask empty；否则，  false 。
