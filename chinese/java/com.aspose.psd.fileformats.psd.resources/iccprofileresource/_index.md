...
description: "表示 ICC 配置文件资源。"
type: docs
weight: 23
url: /zh/java/com.aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [IccProfileResource()](#IccProfileResource--) | 初始化 [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource) 类的新实例。 |
## 字段
...
| [getIccProfile()](#getIccProfile--) | 获取或设置 ICC 配置文件。 |
...
| [setIccProfile(byte[] value)](#setIccProfile-byte---) | 获取或设置 ICC 配置文件。 |
...
初始化 [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource) 类的新实例。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| 值 | com.aspose.ms.System.IO.MemoryStream |  |
