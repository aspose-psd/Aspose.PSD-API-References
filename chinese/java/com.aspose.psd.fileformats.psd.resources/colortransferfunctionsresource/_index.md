...
type: docs
weight: 15
url: /zh/java/com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource--) | 初始化 [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource) 类的新实例。 |
## 字段
...
| [getClass()](#getClass--) |  |
| [getColorTransferData()](#getColorTransferData--) | 获取或设置颜色传输数据。 |
...
| [setColorTransferData(byte[] value)](#setColorTransferData-byte---) | 获取或设置颜色传输数据。 |
...
初始化 [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource) 类的新实例。
