...
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [BackgroundColorResource()](#BackgroundColorResource--) | 初始化 [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource) 类的新实例。 |
## 字段
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | 获取或设置背景颜色。 |
| [setColorSpace(int value)](#setColorSpace-int-) | 获取或设置颜色空间。 |
...
初始化 [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource) 类的新实例。
