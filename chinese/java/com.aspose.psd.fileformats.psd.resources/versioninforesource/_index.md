...
type: docs
weight: 41
url: /zh/java/com.aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [VersionInfoResource()](#VersionInfoResource--) | 初始化 [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource) 类的新实例。 |
## 字段
...
| [setReaderName(String value)](#setReaderName-java.lang.String-) | 获取或设置读取器的名称。 |
| [setRealMergedData(boolean value)](#setRealMergedData-boolean-) | 获取或设置一个值，指示此实例是否具有真实合并数据。 |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | 获取或设置资源块状态。 |
| [setVersion(long value)](#setVersion-long-) | 获取或设置版本。 |
| [setWriterName(String value)](#setWriterName-java.lang.String-) | 获取或设置写入器的名称。 |
| [toString()](#toString--) |  |
...
初始化 [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource) 类的新实例。
...
获取或设置一个值，指示此实例是否具有真实合并数据。

Value:  true  如果此实例具有真实的合并数据；否则，  false 。
