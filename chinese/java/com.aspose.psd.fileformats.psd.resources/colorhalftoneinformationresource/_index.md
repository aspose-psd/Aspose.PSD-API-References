...
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | 初始化一个新的 [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) 类的实例。 |
## 字段
...
| [getHalftoneData()](#getHalftoneData--) | 获取或设置半色调数据。 |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | 获取或设置半色调数据。 |
...
初始化一个新的 [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) 类的实例。
