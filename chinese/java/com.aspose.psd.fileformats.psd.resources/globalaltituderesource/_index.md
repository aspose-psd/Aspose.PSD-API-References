...
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | 初始化 [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) 类的新实例。 |
## 字段
...
| [getAltitude()](#getAltitude--) | 获取或设置海拔。 |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | 获取或设置海拔。 |
...
初始化 [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) 类的新实例。
