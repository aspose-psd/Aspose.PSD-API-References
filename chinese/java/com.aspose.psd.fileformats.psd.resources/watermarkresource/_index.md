...
type: docs
weight: 42
url: /zh/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | 初始化 [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) 类的新实例。 |
## 字段
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | 获取或设置一个值，指示此实例是否为水印。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | 获取或设置一个值，指示此实例是否为水印。 |
| [toString()](#toString--) |  |
...
初始化 [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) 类的新实例。
