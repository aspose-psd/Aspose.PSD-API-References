...
description: "包含图像打印设置边框信息的资源。"
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | 初始化 [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource) 类的新实例。 |
## 字段
...
| [getUnit()](#getUnit--) | 获取或设置边框单位。 |
| [getWidth()](#getWidth--) | 获取或设置边框宽度。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | 获取或设置边框单位。 |
| [setWidth(double value)](#setWidth-double-) | 获取或设置边框宽度。 |
| [toString()](#toString--) |  |
...
初始化 [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource) 类的新实例。
