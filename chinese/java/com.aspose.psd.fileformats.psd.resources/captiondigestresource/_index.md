...
description: "CaptionDigest 资源"
type: docs
weight: 13
url: /zh/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | 初始化 [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) 类的新实例。 |
## 字段
...
| [setDigest(byte[] value)](#setDigest-byte---) | 获取或设置摘要。 |
