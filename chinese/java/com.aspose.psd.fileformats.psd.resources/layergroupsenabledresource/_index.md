...
description: "已启用图层组资源"
type: docs
weight: 26
url: /zh/java/com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource--) | 初始化 [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) 类的新实例。 |
## 字段
...
| [setIDs(byte[] value)](#setIDs-byte---) | 获取或设置 i ds。 |
...
初始化 [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) 类的新实例。
