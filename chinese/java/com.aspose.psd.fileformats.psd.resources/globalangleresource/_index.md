...
type: docs
weight: 19
url: /zh/java/com.aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [GlobalAngleResource()](#GlobalAngleResource--) | 初始化 [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) 类的新实例。 |
## 字段
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | 获取或设置全局角度。 |
...
初始化 [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) 类的新实例。
