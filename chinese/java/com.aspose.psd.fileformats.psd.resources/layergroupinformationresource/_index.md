...
type: docs
weight: 25
url: /zh/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | 初始化 [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) 类的新实例。 |
## 字段
...
| [setGroups(short[] value)](#setGroups-short---) | 获取或设置组。 |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | 从 Groups 属性更新图层中的 LinkGroupId。 |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | 从图层更新 Groups 属性中的值。 |
