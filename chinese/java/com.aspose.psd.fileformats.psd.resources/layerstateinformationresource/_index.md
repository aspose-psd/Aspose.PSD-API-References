...
description: "图层状态信息资源"
type: docs
weight: 28
url: /zh/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | 初始化 [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) 类的新实例。 |
## 字段
...
| [getLayerIndex()](#getLayerIndex--) | 获取或设置图层的索引。 |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | 获取或设置图层的索引。 |
...
初始化 [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) 类的新实例。
