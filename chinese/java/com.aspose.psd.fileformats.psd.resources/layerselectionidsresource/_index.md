...
description: "图层选择 ID 资源"
type: docs
weight: 27
url: /zh/java/com.aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource--) | 初始化 [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource) 类的新实例。 |
## 字段
...
| [getLayerIds()](#getLayerIds--) | 获取或设置图层 ID。 |
...
| [setCount(short value)](#setCount-short-) | 获取或设置计数。 |
...
| [setLayerIds(int[] value)](#setLayerIds-int---) | 获取或设置图层 ID。 |
...
初始化 [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource) 类的新实例。
