...
type: docs
weight: 37
url: /zh/java/com.aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [TransparencyIndexResource()](#TransparencyIndexResource--) | 初始化 [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [RequiredVersion_internalized](#RequiredVersion-internalized) | 所需的 psd 版本。 |
...
| [getTransparencyIndex()](#getTransparencyIndex--) | 获取或设置透明颜色索引。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTransparencyIndex(short value)](#setTransparencyIndex-short-) | 获取或设置透明颜色索引。 |
| [toString()](#toString--) |  |
...
初始化 [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) 类的新实例。
