...
description: "Unicode Alpha 名称资源"
type: docs
weight: 38
url: /zh/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | 初始化一个新的 [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) 类的实例。 |
## 字段
...
| [getAlphaNames()](#getAlphaNames--) | 获取或设置 Alpha 名称。 |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | 获取或设置 Alpha 名称。 |
...
初始化一个新的 [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) 类的实例。
