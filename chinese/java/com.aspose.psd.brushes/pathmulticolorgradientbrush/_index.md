...
type: docs
weight: 16
url: /zh/java/com.aspose.psd.brushes/pathmulticolorgradientbrush/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [PathMulticolorGradientBrush(PointF[] points)](#PathMulticolorGradientBrush-com.aspose.psd.PointF---) | 使用指定的点初始化  PathMulticolorGradientBrush  类的新实例。 |
| [PathMulticolorGradientBrush(PointF[] points, int wrapMode)](#PathMulticolorGradientBrush-com.aspose.psd.PointF---int-) | 使用指定的点和 wrap mode 初始化  PathMulticolorGradientBrush  类的新实例。 |
| [PathMulticolorGradientBrush(Point[] points)](#PathMulticolorGradientBrush-com.aspose.psd.Point---) | 使用指定的点初始化  PathMulticolorGradientBrush  类的新实例。 |
| [PathMulticolorGradientBrush(Point[] points, int wrapMode)](#PathMulticolorGradientBrush-com.aspose.psd.Point---int-) | 使用指定的点和 wrap mode 初始化  PathMulticolorGradientBrush  类的新实例。 |
| [PathMulticolorGradientBrush(GraphicsPath path)](#PathMulticolorGradientBrush-com.aspose.psd.GraphicsPath-) | 使用指定的路径初始化  PathMulticolorGradientBrush  类的新实例。 |
## Methods
...
| [getInterpolationColors()](#getInterpolationColors--) | 获取或设置定义多色线性渐变的  com.aspose.psd.ColorBlend  。 |
...
| [setInterpolationColors(ColorBlend value)](#setInterpolationColors-com.aspose.psd.ColorBlend-) | 获取或设置定义多色线性渐变的  com.aspose.psd.ColorBlend  。 |
...
使用指定的点和 wrap mode 初始化  PathMulticolorGradientBrush  类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | 一个由  Aspose.Imaging.PointF  结构组成的数组，表示构成路径顶点的点。 |
| wrapMode | int | 一个  Aspose.Imaging.WrapMode  ，指定使用此  PathMulticolorGradientBrush  绘制的填充如何平铺。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| path | [GraphicsPath](../../com.aspose.psd/graphicspath) | 定义此  PathMulticolorGradientBrush  填充区域的  GraphicsPath  。 |
...
获取或设置定义多色线性渐变的  com.aspose.psd.ColorBlend  。

值：一个定义多色线性渐变的  com.aspose.psd.ColorBlend  。
