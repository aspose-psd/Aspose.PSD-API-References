...
description: "表示一种 Brush，具有由多种颜色和相应位置定义的线性渐变。"
type: docs
weight: 13
url: /zh/java/com.aspose.psd.brushes/linearmulticolorgradientbrush/
---
...
表示一个  Brush ，具有由多种颜色和相应位置定义的线性渐变。此类不能被继承。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LinearMulticolorGradientBrush()](#LinearMulticolorGradientBrush--) | 使用默认参数初始化  LinearMulticolorGradientBrush  类的新实例。 |
| [LinearMulticolorGradientBrush(Point point1, Point point2)](#LinearMulticolorGradientBrush-com.aspose.psd.Point-com.aspose.psd.Point-) | 使用指定的点初始化  LinearMulticolorGradientBrush  类的新实例。 |
| [LinearMulticolorGradientBrush(PointF point1, PointF point2)](#LinearMulticolorGradientBrush-com.aspose.psd.PointF-com.aspose.psd.PointF-) | 使用指定的点初始化  LinearMulticolorGradientBrush  类的新实例。 |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.psd.Rectangle-float-) | 基于矩形和方向角初始化  LinearMulticolorGradientBrush  类的新实例。 |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.psd.RectangleF-float-) | 基于矩形和方向角初始化  LinearMulticolorGradientBrush  类的新实例。 |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.psd.Rectangle-float-boolean-) | 基于矩形和方向角初始化  LinearMulticolorGradientBrush  类的新实例。 |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.psd.RectangleF-float-boolean-) | 基于矩形和方向角初始化  LinearMulticolorGradientBrush  类的新实例。 |
## Methods
...
| rect | [Rectangle](../../com.aspose.psd/rectangle) | 一个 Aspose.Imaging.RectangleF 结构，指定线性渐变的边界。 |
| angle | float | 角度，以顺时针方向从 x 轴测量的度数，表示渐变方向线的角度。 |
| isAngleScalable | boolean | 如果设置为 true，则在使用此 LinearMulticolorGradientBrush 进行变换时角度会被更改。 |
