...
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
填充图层。颜色填充、渐变填充或图案填充图层，其差异由 FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#setFillSettings-IFillSettings-))
## 字段
...
| [createInstance(int fillType)](#createInstance-int-) | 根据填充类型构建 [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) 类的新实例。 |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | 获取用于 [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) 的渲染处理器。 |
| [getFillOpacity()](#getFillOpacity--) | 获取或设置填充不透明度。 |
| [getFillSettings()](#getFillSettings--) | 获取填充设置。 |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | 获取填充设置。 |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 根据实际的 [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) 更新填充图层像素数据。 |
...
根据填充类型构建 [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) 类的新实例。
...
获取用于 [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) 的渲染处理器。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | 要渲染到的图像。 |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | 要处理的边界。 |

**Returns:**
com.aspose.internal.IPartialProcessor - 返回用于 [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) 的渲染处理器。
...
根据实际的 [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) 更新填充图层像素数据。
