...
description: "定义包含嵌入在 PSD 文件中或链接到外部文件的 SmartObjectLayer 类。"
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
定义 SmartObjectLayer 类，该类包含嵌入在 PSD 文件中的或链接到外部文件的智能对象。使用智能对象，您可以：执行非破坏性变换。您可以缩放、旋转、倾斜、扭曲、透视变换或扭曲图层，而不会丢失原始图像数据或质量，因为这些变换不会影响原始数据。处理向量数据，例如来自 Illustrator 的向量艺术作品，否则会被光栅化。执行非破坏性过滤。您可以随时编辑应用于智能对象的滤镜。编辑一个智能对象后，所有链接的实例会自动更新。对智能对象图层应用链接或未链接的图层蒙版。使用低分辨率占位图尝试各种设计，随后再替换为最终版本。在 Adobe Photoshop 中，您可以将图像内容嵌入 PSD 文档。更多信息请参阅此处：包含嵌入智能对象的图层包含带有智能对象属性的 placed (PlLd) 和 SoLd 资源。对于早于 10 版的 PSD，PlLd 资源可以单独存在。这些资源在全局 Lnk2Resource 中包含 LiFdDataSource 的 UniqueId、嵌入的文件名以及其他参数，包括以字节数组形式的原始格式嵌入文件内容。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | 初始化 [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [BlendSignature](#BlendSignature) | 表示混合模式签名。 |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | 找到 both placed 和 smart object 资源的消息 |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | 消息：只能复制嵌入的智能对象 |
| [LayerHeaderSize](#LayerHeaderSize) | 图层头部大小。 |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | 未找到 placed 或 smart object 资源的消息 |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | 错误的 placed 资源索引消息 |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | 将此嵌入的智能对象转换为链接的智能对象。 |
...
| [duplicateLayer()](#duplicateLayer--) | 通过复制此层创建新的智能对象图层。 |
| [embedLinked()](#embedLinked--) | 在此图层中嵌入链接的智能对象。 |
| [equals(Object obj)](#equals-java.lang.Object-) | 确定指定的 Object 是否等于此实例。 |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | 将嵌入或链接的内容导出到文件。 |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | 获取或设置渲染扭曲或使用 PS 图片 |
...
| [getContentType()](#getContentType--) | 获取智能对象图层内容的类型。 |
| [getContents()](#getContents--) | 获取或设置智能对象图层的内容。 |
| [getContentsBounds()](#getContentsBounds--) | 获取或设置智能对象内容的边界。 |
| [getContentsSource()](#getContentsSource--) | 获取或设置智能对象内容的来源。 |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | 获取或设置用于扭曲的图像的最后尺寸。 |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | 获取或设置原始四边形。 |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | 获取已放置和智能图层资源的索引以及适当的已放置资源。 |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | 获取已放置的图层资源。 |
...
| [getSmartFilters()](#getSmartFilters--) | 获取智能过滤器。 |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | 获取或设置变换四边形。 |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | 获取用于扭曲的函数帮助。 |
| [getWarpSettings()](#getWarpSettings--) | 获取或设置从资源中获取的扭曲参数（默认）。 |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | 获取智能对象图层的嵌入或链接图像内容。 |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | 通过复制此层创建新的智能对象图层。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | 当此 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 的容器被设置时调用。 |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | 将已链接的智能对象重新链接到新文件。 |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | 替换嵌入在智能对象图层中的智能对象内容。 |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | 替换嵌入在智能对象图层中的智能对象内容。 |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | 使用文件替换内容。 |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | 使用文件替换内容。 |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | 使用文件替换内容。 |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | 使用文件替换内容。 |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | 获取或设置渲染扭曲或使用 PS 图片 |
...
| [setContents(byte[] value)](#setContents-byte---) | 获取或设置智能对象图层的内容。 |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | 获取或设置智能对象内容的边界。 |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | 获取或设置智能对象内容的来源。 |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | 获取或设置用于扭曲的图像的最后尺寸。 |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | 获取或设置原始四边形。 |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | 获取智能对象提供程序。 |
| [setTop(int value)](#setTop-int-) | 获取或设置顶部图层位置。 |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | 获取或设置变换四边形。 |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | 获取或设置从资源中获取的扭曲参数（默认）。 |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | 更新数据源标识符。 |
| [updateModifiedContent()](#updateModifiedContent--) | 使用修改后的内容更新智能对象图层的图像缓存。 |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | 使用修改后的内容更新智能对象图层的图像缓存。 |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | 当 placedResource 更改或需要转换时，更新已放置/智能资源。 |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | 它是用于更新图层预览的 \"IWarpSupport\" 包装器。 |
| [wait()](#wait--) |  |
...
初始化 [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | 项目流 |
...
找到 both placed 和 smart object 资源的消息
...
未找到 placed 或 smart object 资源的消息
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| linkedPath | java.lang.String | 链接路径。 |
...
通过复制此图层创建一个新的智能对象图层。请注意，对于嵌入的智能对象，嵌入的图像是共享的。如果您想复制嵌入的图像，请使用 [.newSmartObjectViaCopy](../../null/\\#newSmartObjectViaCopy) 方法。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| filePath | java.lang.String | 导出文件路径。 |
...
获取智能对象图层内容的类型。嵌入的智能对象内容是嵌入的原始图像文件：LiFdDataSource.Data。链接的智能对象内容是已链接图像文件的原始内容（如果可用）：[LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)。当 LinkDataSource.IsLibraryLink 为 true 时，我们不支持从 Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library 加载（[LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)）。对于常规链接文件，首先使用 LiFeDataSource.RelativePath（[LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)）相对于源图像路径 DataStreamSupporter.SourceImagePath 查找文件；如果不可用，则查看 LiFeDataSource.FullPath（[LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)）；如果仍未找到，则在我们的图像所在的同一目录 DataStreamSupporter.SourceImagePath 中查找链接文件。
...
获取或设置智能对象图层内容。嵌入的智能对象内容是嵌入的原始图像文件：LiFdDataSource.Data 及其属性。链接的智能对象内容是已链接图像文件的原始内容（如果可用）及其属性：[LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)。当 LinkDataSource.IsLibraryLink 为 true 时，我们不支持从 Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library 加载（[LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)）。对于常规链接文件，首先使用 LiFeDataSource.RelativePath（[LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)）相对于源图像路径 DataStreamSupporter.SourceImagePath 查找文件；如果不可用，则查看 LiFeDataSource.FullPath（[LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)）；如果仍未找到，则在我们的图像所在的同一目录 DataStreamSupporter.SourceImagePath 中查找链接文件。
...
获取已放置和智能图层资源的索引以及适当的已放置资源。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | 资源。 |
| placedResourceIndex | int[] | 已放置资源的索引。 |
| smartResourceIndex | int[] | 智能资源的索引。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | 选项。 |
...
通过复制此对象创建一个新的智能对象图层。通过 Adobe\\ufffd Photoshop\\ufffd 的复制功能实现 Layer -> Smart Objects -> New Smart Object。请注意，仅对嵌入的智能对象启用此功能，因为嵌入的图像也会被复制。如果要共享嵌入的图像，请使用 [.duplicateLayer](../../null/\\#duplicateLayer) 方法。
...
当此 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 的容器被设置时调用。
...
将已链接的智能对象重新链接到新文件。之后无需调用 UpdateModifiedContent 方法。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | 图像。 |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | 图像。 |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | 分辨率设置。如果为 null，则使用图像分辨率。 |
...
使用文件替换内容。之后无需调用 UpdateModifiedContent 方法。
...
| --- | --- | --- |
| linkedPath | java.lang.String | 链接路径。 |
| isReplaceOnlyThis | boolean | 此标志指示是仅替换此智能图层的内容，还是用该内容替换所有智能图层。 |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| 值 | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | 数据源标识符。 |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | 图像。 |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | 分辨率。 |
| skipBoundsUpdate | boolean | 如果设置为 true，则 [跳过边界更新]。 |
...
当 placedResource 更改或需要转换时，更新已放置/智能资源。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| toEmbedded | boolean | 如果设置为 true，则在需要时转换为嵌入资源，否则转换为链接资源。 |
...
它是用于更新图层预览的 \"IWarpSupport\" 包装器。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | 新预览图像的像素和尺寸 |
