...
type: docs
weight: 13
url: /zh/java/com.aspose.psd.fileformats.psd.layers.text.rendering/justificationmode/
---
...
左对齐文本。在从左到右模式中，左位置是左。在从右到左模式中，左位置是右。
...
右对齐文本。在从左到右模式中，右位置是右。在从右到左模式中，右位置是左。
