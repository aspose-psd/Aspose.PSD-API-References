...
description: "Photoshop 行距类型，即行间距离的类型。"
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
Photoshop 行距类型（行之间距离的类型）。
## 字段

| 字段 | 描述 |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | 底部到底部的行距。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | 顶部到顶部的行距。 |
## Methods
