...
description: "Photoshop 自动字距模式符号之间的距离。"
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.psd.layers.text.rendering/autokerning/
---
...
| [Manual](#Manual) | 手动字距值。 |
| [Metric](#Metric) | 度量字距使用字距对，这些字距对包含在大多数字体中（来自其设计者）。 |
| [Optical](#Optical) | 光学字距根据字符形状调整相邻字符之间的间距。 |
## Methods
...
度量字距使用字距对，这些字距对包含在大多数字体中（来自其设计者）。
