...
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | 初始化 [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) 类的新实例。 |
## 字段
...
初始化 [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) 类的新实例。
