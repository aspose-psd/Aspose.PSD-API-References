...
description: "类 InfxResource。"
type: docs
weight: 39
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
类 InfxResource。此资源包含有关剪裁元素混合的信息。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | 初始化 [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 类的新实例。 |
| [InfxResource()](#InfxResource--) | 初始化 [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 类的新实例。 |
| [InfxResource(byte[] data)](#InfxResource-byte---) | 初始化 [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 类的新实例。 |
## 字段
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | 获取或设置一个值，指示是否 [blend interior elements]。 |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | 获取或设置一个值，指示值 [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) 是否为真或假 |
| [hashCode()](#hashCode--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | 获取或设置一个值，指示是否 [blend interior elements]。 |
...
| [setValue(boolean value)](#setValue-boolean-) | 获取或设置一个值，指示值 [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) 是否为真或假 |
...
初始化 [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| blendInteriorElements | boolean | 如果设置为 true [blend interior elements]。 |
...
初始化 [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 类的新实例。使用自定义或未知值。
...
值： true 如果 [blend interior elements]；否则， false。
...
获取或设置一个值，指示值 [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) 是否为真或假

值： true 如果值为 true；否则， false。
