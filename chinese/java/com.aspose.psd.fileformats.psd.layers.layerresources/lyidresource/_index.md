...
type: docs
weight: 59
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | 初始化 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 类的新实例。 |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | 初始化 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 类的新实例。 |
## 字段
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | 获取值。 |
...
初始化 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 类的新实例。
...
初始化 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 类的新实例。使用自定义或未知值
