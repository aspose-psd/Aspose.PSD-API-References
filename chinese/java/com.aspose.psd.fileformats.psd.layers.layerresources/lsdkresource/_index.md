...
description: "lsdk 图层资源的嵌套图层段资源。"
type: docs
weight: 56
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | 初始化 [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) 类的新实例。 |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | 初始化 [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) 类的新实例。 |
## 字段
...
初始化 [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) 类的新实例。
