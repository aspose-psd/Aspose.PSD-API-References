...
description: "类 ShmdResource。"
type: docs
weight: 74
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
Class ShmdResource. 元数据设置
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ShmdResource()](#ShmdResource--) | 初始化 [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) 类的新实例。 |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | 初始化 [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) 类的新实例。 |
## 字段
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | 子资源头长度 |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | 获取或设置图层创建时间。 |
...
| [getSubResources()](#getSubResources--) | 子资源 |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | 获取或设置图层创建时间。 |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | 获取 shmd 资源的子资源。 |
...
初始化 [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) 类的新实例。
