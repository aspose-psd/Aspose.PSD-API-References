...
description: "ClblResource 类。"
type: docs
weight: 20
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
类 ClblResource。此资源包含有关剪切元素混合的信息。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [ClblResource()](#ClblResource--) | 初始化 [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 类的新实例。 |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | 初始化 [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 类的新实例。 |
| [ClblResource(byte[] data)](#ClblResource-byte---) | 初始化 [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 类的新实例。 |
## 字段
...
| [getBlendClippedElements()](#getBlendClippedElements--) | 获取或设置一个值，指示是否 [blend clipped elements]。 |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | 获取或设置一个值，指示是否 [blend clipped elements]。 |
...
初始化 [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 类的新实例。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| blendClippedElements | boolean | 如果设置为 true，则 [blend clipped elements]。 |
...
初始化 [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 类的新实例。使用自定义或未知值。
...
值： true，如果 [blend clipped elements]；否则， false。
