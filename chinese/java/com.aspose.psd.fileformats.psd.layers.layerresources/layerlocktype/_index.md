...
type: docs
weight: 42
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/layerlocktype/
---
...
| [LockAll](#LockAll) | 锁定图层的所有属性 |
| [LockImagePixels](#LockImagePixels) | 部分锁定图层 - 防止使用绘画工具修改图层\u2019s 像素。 |
| [LockPosition](#LockPosition) | 部分锁定图层 - 防止图层\u2019s 像素被移动。 |
| [LockTransparentPixels](#LockTransparentPixels) | 部分锁定图层 - 将编辑限制在图层的不透明部分。 |
| [None](#None) | 未锁定图层 |
## Methods
...
部分锁定图层 - 将编辑限制在图层的不透明部分。此选项等同于早期 Photoshop 版本中的“保留透明度”选项。
