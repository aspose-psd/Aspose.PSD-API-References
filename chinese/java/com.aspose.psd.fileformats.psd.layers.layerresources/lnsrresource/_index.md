...
type: docs
weight: 51
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | 初始化 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 类的新实例。 |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | 初始化 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 类的新实例。 |
## 字段
...
| [getValue()](#getValue--) | 如果已描述相应的枚举，则获取值为 LnsrResourceType。 |
| [hashCode()](#hashCode--) |  |
...
初始化 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| lnsrResourceType | int | LNSR 的类型。 |
...
初始化 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 类的新实例。使用自定义或未知值
...
如果已描述相应的枚举，则获取值为 LnsrResourceType。否则返回 Unknown

值： 作为 LnsrResourceType 的值
