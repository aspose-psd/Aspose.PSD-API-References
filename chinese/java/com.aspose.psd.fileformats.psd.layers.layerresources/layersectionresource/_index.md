...
type: docs
weight: 43
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | 初始化 [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) 类的新实例。 |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | 初始化 [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) 类的新实例。 |
## 字段
...
| [getSectionType()](#getSectionType--) | 获取或设置节类型。 |
...
| [setSectionType(int value)](#setSectionType-int-) | 获取或设置节类型。 |
...
初始化 [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) 类的新实例。
