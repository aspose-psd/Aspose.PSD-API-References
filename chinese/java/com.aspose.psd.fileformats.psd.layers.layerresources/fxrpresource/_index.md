...
description: "FxrpResource 类。"
type: docs
weight: 32
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
FxrpResource 类。图层的参考点。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | 初始化 [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 类的新实例。 |
| [FxrpResource()](#FxrpResource--) | 初始化 [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 类的新实例。 |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | 初始化 [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 类的新实例。 |
## 字段
...
| [getX()](#getX--) | 获取或设置参考点的 x 坐标 |
| [getY()](#getY--) | 获取或设置参考点的 y |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 保存到指定的流容器。 |
...
| [setX(double value)](#setX-double-) | 获取或设置参考点的 x 坐标 |
| [setY(double value)](#setY-double-) | 获取或设置参考点的 y |
...
初始化 [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 类的新实例。
...
初始化 [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 类的新实例。使用自定义或未知值
