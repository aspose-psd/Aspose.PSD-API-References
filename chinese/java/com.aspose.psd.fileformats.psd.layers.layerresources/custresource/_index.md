...
description: "CustResource 类。"
type: docs
weight: 27
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/custresource/
---
...
Class CustResource. 此资源包含有关剪切元素混合的信息。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [CustResource()](#CustResource--) | 初始化 [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) 类的新实例。 |
| [CustResource(byte[] data)](#CustResource-byte---) | 初始化 [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) 类的新实例。 |
## 字段
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | 获取或设置图层创建日期。 |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | 获取或设置图层创建日期。 |
...
初始化 [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) 类的新实例。
