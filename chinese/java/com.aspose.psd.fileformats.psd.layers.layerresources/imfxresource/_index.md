...
description: "Imfx 资源 多效果资源"
type: docs
weight: 38
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ImfxResource()](#ImfxResource--) | 初始化一个新的 [ImfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource) 类的实例。 |
## 字段
...
初始化一个新的 [ImfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource) 类的实例。
