...
type: docs
weight: 83
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [VibAResource()](#VibAResource--) | 初始化 [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource) 类的新实例。 |
## 字段
...
| [getSaturation()](#getSaturation--) | 获取或设置饱和度值 |
| [getSignature()](#getSignature--) | 获取图层资源签名。 |
| [getVibrance()](#getVibrance--) | 获取或设置活力值 |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | 获取或设置饱和度值 |
| [setVibrance(int value)](#setVibrance-int-) | 获取或设置活力值 |
...
初始化 [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource) 类的新实例。
