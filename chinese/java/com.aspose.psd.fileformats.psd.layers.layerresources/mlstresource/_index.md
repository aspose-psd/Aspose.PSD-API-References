...
description: "该 mlst 资源。"
type: docs
weight: 62
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MlstResource()](#MlstResource--) | 初始化 [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) 类的新实例。 |
## 字段
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 获取或设置结构。 |
...
初始化 [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) 类的新实例。
