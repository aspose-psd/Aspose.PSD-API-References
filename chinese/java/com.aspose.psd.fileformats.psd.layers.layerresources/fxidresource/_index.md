...
description: "Filter Effects 资源包含通道、用户蒙版和智能滤镜的图层蒙版。"
type: docs
weight: 29
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
过滤器效果资源包含通道、用户蒙版和智能过滤器的工作表蒙版。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | 初始化 [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | 类型工具信息键 FEid。 |
| [FXidTypeToolKey](#FXidTypeToolKey) | 类型工具信息键 FXid。 |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | 获取滤镜效果蒙版。 |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | 获取滤镜效果蒙版。 |
...
初始化 [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) 类的新实例。
...
| key | int | 资源键。 |
| version | int | 版本。 |
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | 滤镜效果蒙版。 |
