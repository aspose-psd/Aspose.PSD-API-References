...
description: "类 NvrtResource。"
type: docs
weight: 63
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
NvrtResource 类。反转调整图层的资源。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | 初始化 [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource) 类的新实例。 |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | 初始化 [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource) 类的新实例。 |
## 字段
...
初始化 [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource) 类的新实例。
