...
description: "表示图层 Photoshop 版本的资源。"
type: docs
weight: 60
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
表示图层 Photoshop 版本的资源。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | 初始化 [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) 类的新实例。 |
## 字段
...
| [getVersion()](#getVersion--) | 获取或设置 Layer 的 Photoshop 版本。 |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | 获取或设置 Layer 的 Photoshop 版本。 |
...
初始化 [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) 类的新实例。
