...
description: "CgEdResource 类。"
type: docs
weight: 18
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [CgEdResource()](#CgEdResource--) | 初始化 [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) 类的新实例。 |
## 字段
...
| [getAuto()](#getAuto--) | 获取或设置一个值，指示此 [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) 是否为自动。 |
...
| [getLabColor()](#getLabColor--) | 获取或设置一个值，指示是否使用 [lab color]。 |
| [getLength()](#getLength--) | 获取图层资源长度（字节）。 |
| [getMeanValueForBrightnessAndContrast()](#getMeanValueForBrightnessAndContrast--) | 获取或设置亮度和对比度的平均值。 |
| [getPrefixLength_internalized(int psdVersion)](#getPrefixLength-internalized-int-) | 获取前缀长度。 |
| [getPropertyValueByTypeStructure_internalized(String structureName)](#getPropertyValueByTypeStructure-internalized-java.lang.String-) | 按类型结构获取属性值。 |
| [getPsdVersion()](#getPsdVersion--) | 获取图层资源所需的最小 psd 版本。 |
| [getSignature()](#getSignature--) | 获取图层资源签名。 |
| [getUseLegacy()](#getUseLegacy--) | 获取或设置一个值，指示是否 [use legacy]。 |
...
| [setAuto(boolean value)](#setAuto-boolean-) | 获取或设置一个值，指示此 [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) 是否为自动。 |
| [setBrightness(int value)](#setBrightness-int-) | 获取或设置亮度。 |
...
| [setLabColor(boolean value)](#setLabColor-boolean-) | 获取或设置一个值，指示是否使用 [lab color]。 |
| [setMeanValueForBrightnessAndContrast(int value)](#setMeanValueForBrightnessAndContrast-int-) | 获取或设置亮度和对比度的平均值。 |
...
| [setUseLegacy(boolean value)](#setUseLegacy-boolean-) | 获取或设置一个值，指示是否 [use legacy]。 |
...
初始化 [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) 类的新实例。PSD 格式规范包含以下描述：4 Descriptor Version( = 16) 可变长度的额外数据描述符。建议：在旧版本的 PS（CS5 之前）中可能不会使用它。
...
获取或设置一个值，指示此 [CgEdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cgedresource) 是否为自动。

值： true 如果自动；否则， false 。
...
获取或设置一个值，指示是否使用 [lab color]。

值： true 如果使用 [lab color]；否则， false 。
...
按类型结构获取属性值。仅用于 UnitTests。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| structureName | java.lang.String | 结构的名称。 |

**Returns:**
java.lang.Object - 用于简易单元测试的 OSType 结构
