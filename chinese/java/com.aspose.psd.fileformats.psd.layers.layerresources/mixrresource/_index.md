...
description: "类 MixrResource。"
type: docs
weight: 61
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MixrResource()](#MixrResource--) | 初始化 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 类的新实例。 |
| [MixrResource(byte[] data)](#MixrResource-byte---) | 初始化 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 类的新实例。 |
## 字段
...
| [getChannelInfo(int channelIndex)](#getChannelInfo-int-) | 获取通道信息原始数据 |
| [getClass()](#getClass--) |  |
...
| [getMonochrome()](#getMonochrome--) | 获取或设置一个值，指示此 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 是否为单色。 |
...
| [setChannelInfo(int channelIndex, byte[] value)](#setChannelInfo-int-byte---) | 设置通道信息。 |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | 获取或设置一个值，指示此 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 是否为单色。 |
...
初始化 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 类的新实例。PSD 格式规范包含以下描述：2 Version (= 1) 2 Monochrome 20 RGB 或 CMYK 颜色加混合器设置的常量。4 \* 2 字节的颜色加 2 字节的常量。
...
获取或设置一个值，指示此 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 是否为单色。
