...
description: "类 PhflResource。"
type: docs
weight: 69
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/
---
...
类 PhflResource。Exposure Adjustment Layer 2 的资源，版本 ( = 3 ) 或 ( = 2 ) 12 每个 XYZ 颜色 4 字节（仅在版本 3 中）10 2 字节颜色空间，后跟 4 \* 2 字节颜色分量（仅在版本 2 中）4 密度 1 保持亮度。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PhflResourceVersion2()](#PhflResourceVersion2--) | 初始化 [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) 类的新实例。 |
| [PhflResourceVersion2(byte[] data)](#PhflResourceVersion2-byte---) | 初始化 [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) 类的新实例。 |
## 字段
...
| [getComponentA()](#getComponentA--) | 获取或设置颜色的 A 分量 |
| [getComponentB()](#getComponentB--) | 获取或设置 B 分量 |
| [getComponentL()](#getComponentL--) | 获取或设置颜色的 L 分量 |
| [getData()](#getData--) | 获取或设置数据。 |
| [getDensity()](#getDensity--) | 获取或设置密度。 |
...
| [getPreserveLuminosity()](#getPreserveLuminosity--) | 获取或设置一个值，指示是否 [preserve luminosity]。 |
| [getPsdVersion()](#getPsdVersion--) | 获取图层资源所需的最小 psd 版本。 |
| [getRgbColor()](#getRgbColor--) | 获取颜色。 |
...
| [setColorSpace(short value)](#setColorSpace-short-) | 获取颜色空间。 |
| [setComponentA(short value)](#setComponentA-short-) | 获取或设置颜色的 A 分量 |
| [setComponentB(short value)](#setComponentB-short-) | 获取或设置 B 分量 |
| [setComponentL(short value)](#setComponentL-short-) | 获取或设置颜色的 L 分量 |
| [setDensity(int value)](#setDensity-int-) | 获取或设置密度。 |
...
| [setPreserveLuminosity(boolean value)](#setPreserveLuminosity-boolean-) | 获取或设置一个值，指示是否 [preserve luminosity]。 |
| [setRgbColor(Color color)](#setRgbColor-com.aspose.psd.Color-) | 设置 RGB 颜色。 |
...
初始化 [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) 类的新实例。
...
获取或设置一个值，指示是否 [preserve luminosity]。

值： true 如果 [preserve luminosity]；否则， false。
