...
description: "类 KnkoResource。"
type: docs
weight: 41
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
类 KnkoResource。此资源包含有关剪裁元素混合的信息。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | 初始化 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 类的新实例。 |
| [KnkoResource()](#KnkoResource--) | 初始化 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 类的新实例。 |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | 初始化 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 类的新实例。 |
## 字段
...
| [getKnockout()](#getKnockout--) | 获取或设置一个值，指示是否 [blend interior elements]。 |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | 获取或设置一个值，指示是否 [blend interior elements]。 |
...
初始化 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| knockout | boolean | 如果设置为 true [blend interior elements]。 |
...
初始化 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 类的新实例。使用自定义或未知值
