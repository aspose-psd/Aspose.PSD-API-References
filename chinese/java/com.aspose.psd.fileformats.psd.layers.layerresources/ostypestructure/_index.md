...
description: "表示 OS 类型结构。"
type: docs
weight: 64
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [OSTypeStructure(ClassID keyName)](#OSTypeStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 初始化 [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) 类的新实例。 |
## Methods
...
初始化 [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) 类的新实例。
