...
type: docs
weight: 57
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | 初始化 [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) 类的新实例。 |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | 初始化 [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) 类的新实例。 |
| [LspfResource()](#LspfResource--) | 初始化 [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) 类的新实例。 |
## 字段
...
| [TypeToolKey](#TypeToolKey) | 类型工具信息键 1819504742 |
...
| [getLockType()](#getLockType--) | 获取或设置锁的类型。 |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | 获取或设置一个值，指示此实例是否受复合保护。 |
| [isPositionProtected()](#isPositionProtected--) | 获取或设置一个值，指示此实例是否受位置保护。 |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | 获取或设置一个值，指示此实例是否受透明度保护。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | 获取或设置一个值，指示此实例是否受复合保护。 |
...
| [setLockType(int value)](#setLockType-int-) | 获取或设置锁的类型。 |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | 获取或设置一个值，指示此实例是否受位置保护。 |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | 获取或设置一个值，指示此实例是否受透明度保护。 |
...
初始化 [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) 类的新实例。使用自定义或未知值
...
初始化 [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) 类的新实例。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| isTransparencyProtected | boolean | 如果设置为  true  [is transparency protected]. |
| isCompositeProtected | boolean | 如果设置为  true  [is composite protected]. |
| isPositionProtected | boolean | 如果设置为  true  [is position protected]. |
...
获取或设置一个值，指示此实例是否受复合保护。

Value:  true  如果此实例是复合受保护的; 否则,  false .
...
获取或设置一个值，指示此实例是否受位置保护。

Value:  true  如果此实例是位置受保护的; 否则,  false .
...
Value:  true  如果此实例是透明度受保护的; 否则,  false .
