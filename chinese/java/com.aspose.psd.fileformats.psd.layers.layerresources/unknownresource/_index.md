...
type: docs
weight: 82
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | 初始化 [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) 类的新实例。 |
## 字段
...
初始化 [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) 类的新实例。
