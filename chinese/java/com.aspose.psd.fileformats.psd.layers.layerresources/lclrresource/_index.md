...
description: "类 LclrResource。"
type: docs
weight: 46
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
类 LclrResource。此资源包含关于 PS 中图层列表里图层颜色的信息。仅此。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LclrResource()](#LclrResource--) | 初始化 [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 类的新实例。 |
| [LclrResource(short color)](#LclrResource-short-) | 初始化 [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 类的新实例。 |
| [LclrResource(byte[] data)](#LclrResource-byte---) | 初始化 [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 类的新实例。 |
## 字段
...
| [setColor(short value)](#setColor-short-) | 获取或设置图层的颜色。 |
...
初始化 [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 类的新实例。
