...
description: "工作表颜色设置的可能颜色。"
type: docs
weight: 73
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
工作表颜色设置的可能颜色。它是 PS 中图层列表里图层的 UI 装饰颜色。
## 字段
