...
type: docs
weight: 53
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [Lr16Resource()](#Lr16Resource--) | 初始化 [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource) 类的新实例。 |
## 字段
...
| [getLayers()](#getLayers--) | 获取或设置层。 |
| [getLength()](#getLength--) | 获取图像的 PSD 标头版本的资源长度。 |
| [getLength(int psdHeaderVersion)](#getLength-int-) | 获取资源长度。 |
...
| [getRawData_internalized()](#getRawData-internalized--) | 获取或设置资源的原始数据。 |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 保存图层记录。 |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | 获取或设置层。 |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | 获取或设置资源的原始数据。 |
...
初始化 [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource) 类的新实例。
...
获取资源长度。它可能取决于 PSD 版本。

**Parameters:**
| Parameter | Type | 描述 |
| --- | --- | --- |
| psdHeaderVersion | int | PSD 标头版本。 |
