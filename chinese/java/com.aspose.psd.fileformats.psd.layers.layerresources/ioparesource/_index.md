...
description: "类 IopaResource。"
type: docs
weight: 40
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
类 IopaResource。此资源包含来自图层样式表单的填充不透明度属性信息。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [IopaResource()](#IopaResource--) | 初始化 [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) 类的新实例。 |
| [IopaResource(byte[] data)](#IopaResource-byte---) | 初始化 [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) 类的新实例。 |
## 字段
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | 获取或设置填充不透明度。 |
...
初始化 [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) 类的新实例。
