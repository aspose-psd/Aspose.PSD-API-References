...
description: "类 LevlResource。"
type: docs
weight: 48
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/levlresource/
---
...
LevlResource 类。曝光调整图层的资源。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [LevlResource(byte[] bytes)](#LevlResource-byte---) | 初始化 [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) 类的新实例。 |
| [LevlResource()](#LevlResource--) | 初始化 [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) 类的新实例。 |
## 字段
...
| [getChannel(int channelIndex)](#getChannel-int-) | 获取通道。 |
| [getClass()](#getClass--) |  |
...
初始化 [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) 类的新实例。支持在 GrayScale、Duotone、RGB、CMYK、Lab 颜色模式下。2 字节 - 版本 (=2) 29 \* 10 字节 - 包含 5 个短整数的级别记录集合 4 字节 - Lvls 头部（起始于索引 292） 2 字节 - 版本 (=3) 2 字节 - 总级别记录计数 10 \* (总计数 - 29) Lvls 资源的零结尾应也按四字节对齐。
...
初始化 [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) 类的新实例。
