...
description: "包含动画数据的部分。"
type: docs
weight: 11
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| 字段 | 描述 |
| --- | --- |
| [StructureKey](#StructureKey) | 标识 AnDs 的结构键。 |
## Methods
...
| [framesNumberIsOdd_internalized(System.Collections.Generic.IGenericEnumerable<OSTypeStructure> items)](#framesNumberIsOdd-internalized-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure--) | 检查 'FrIn' 列表结构中的帧计数是否为奇数。 |
...
| [getItems()](#getItems--) | 获取或设置动画数据段结构。 |
| [getKey()](#getKey--) | 获取结构键。 |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 获取或设置 ClassID。 |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | 获取或设置描述符版本。 |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 获取或设置动画数据段结构。 |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | 获取或设置在帧数为奇数时存在的未知字节 3。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
