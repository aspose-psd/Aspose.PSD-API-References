...
description: "BlncResource 类是颜色调整图层的资源。"
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/blncresource/
---
...
BlncResource 类是颜色调整图层的资源。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [BlncResource()](#BlncResource--) | 初始化 [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) 类的新实例。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [DataLength_internalized](#DataLength-internalized) | 预期的数据长度。 |
| [HighlightsCyanRedBalanceExceptionMessage_internalized](#HighlightsCyanRedBalanceExceptionMessage-internalized) | 高光青红平衡超出范围异常消息。 |
| [HighlightsMagentaGreenBalanceExceptionMessage_internalized](#HighlightsMagentaGreenBalanceExceptionMessage-internalized) | 高光品红绿平衡超出范围异常消息。 |
| [HighlightsYellowBlueBalanceExceptionMessage_internalized](#HighlightsYellowBlueBalanceExceptionMessage-internalized) | 高光黄蓝平衡超出范围异常消息。 |
| [MidtonesCyanRedBalanceExceptionMessage_internalized](#MidtonesCyanRedBalanceExceptionMessage-internalized) | 中间调青红平衡超出范围异常消息。 |
| [MidtonesMagentaGreenBalanceExceptionMessage_internalized](#MidtonesMagentaGreenBalanceExceptionMessage-internalized) | 中间调品红绿平衡超出范围异常消息。 |
| [MidtonesYellowBlueBalanceExceptionMessage_internalized](#MidtonesYellowBlueBalanceExceptionMessage-internalized) | 中间调黄蓝平衡超出范围异常消息。 |
...
| [ShadowsCyanRedBalanceExceptionMessage_internalized](#ShadowsCyanRedBalanceExceptionMessage-internalized) | 阴影青红平衡超出范围异常消息。 |
| [ShadowsMagentaGreenBalanceExceptionMessage_internalized](#ShadowsMagentaGreenBalanceExceptionMessage-internalized) | 阴影品红绿平衡超出范围异常消息。 |
| [ShadowsYellowBlueBalanceExceptionMessage_internalized](#ShadowsYellowBlueBalanceExceptionMessage-internalized) | 阴影黄蓝平衡超出范围异常消息。 |
...
| [getHighlightsCyanRedBalance()](#getHighlightsCyanRedBalance--) | 获取或设置高光青红平衡。 |
| [getHighlightsMagentaGreenBalance()](#getHighlightsMagentaGreenBalance--) | 获取或设置高光品红绿平衡。 |
| [getHighlightsYellowBlueBalance()](#getHighlightsYellowBlueBalance--) | 获取或设置高光黄蓝平衡。 |
| [getKey()](#getKey--) | 获取图层资源键。 |
| [getLength()](#getLength--) | 获取图层资源长度（字节）。 |
| [getMidtonesCyanRedBalance()](#getMidtonesCyanRedBalance--) | 获取或设置中间调青红平衡。 |
| [getMidtonesMagentaGreenBalance()](#getMidtonesMagentaGreenBalance--) | 获取或设置中间调品红绿平衡。 |
| [getMidtonesYellowBlueBalance()](#getMidtonesYellowBlueBalance--) | 获取或设置中间调黄蓝平衡。 |
| [getPrefixLength_internalized(int psdVersion)](#getPrefixLength-internalized-int-) | 获取前缀长度。 |
| [getPreserveLuminosity()](#getPreserveLuminosity--) | 获取或设置一个值，指示此 [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) 是否保留亮度。 |
| [getPsdVersion()](#getPsdVersion--) | 获取图层资源所需的最小 psd 版本。 |
| [getShadowsCyanRedBalance()](#getShadowsCyanRedBalance--) | 获取或设置阴影青红平衡。 |
| [getShadowsMagentaGreenBalance()](#getShadowsMagentaGreenBalance--) | 获取或设置阴影品红绿平衡。 |
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | 获取或设置阴影黄蓝平衡。 |
...
| [setHighlightsCyanRedBalance(short value)](#setHighlightsCyanRedBalance-short-) | 获取或设置高光青红平衡。 |
| [setHighlightsMagentaGreenBalance(short value)](#setHighlightsMagentaGreenBalance-short-) | 获取或设置高光品红绿平衡。 |
| [setHighlightsYellowBlueBalance(short value)](#setHighlightsYellowBlueBalance-short-) | 获取或设置高光黄蓝平衡。 |
| [setMidtonesCyanRedBalance(short value)](#setMidtonesCyanRedBalance-short-) | 获取或设置中间调青红平衡。 |
| [setMidtonesMagentaGreenBalance(short value)](#setMidtonesMagentaGreenBalance-short-) | 获取或设置中间调品红绿平衡。 |
| [setMidtonesYellowBlueBalance(short value)](#setMidtonesYellowBlueBalance-short-) | 获取或设置中间调黄蓝平衡。 |
| [setPreserveLuminosity(boolean value)](#setPreserveLuminosity-boolean-) | 获取或设置一个值，指示此 [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) 是否保留亮度。 |
| [setShadowsCyanRedBalance(short value)](#setShadowsCyanRedBalance-short-) | 获取或设置阴影青红平衡。 |
| [setShadowsMagentaGreenBalance(short value)](#setShadowsMagentaGreenBalance-short-) | 获取或设置阴影品红绿平衡。 |
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | 获取或设置阴影黄蓝平衡。 |
...
初始化 [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) 类的新实例。
...
获取或设置一个值，指示此 [BlncResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/blncresource) 是否保留亮度。

值：  true  如果保留亮度；否则，  false 。
