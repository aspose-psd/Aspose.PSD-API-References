...
type: docs
weight: 58
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [LuniResource()](#LuniResource--) | 初始化 [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) 类的新实例。 |
## 字段
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | 获取或设置数据。 |
...
初始化 [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) 类的新实例。
