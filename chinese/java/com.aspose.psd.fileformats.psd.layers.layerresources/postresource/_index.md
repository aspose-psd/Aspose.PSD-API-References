...
description: "类 PostResource。"
type: docs
weight: 71
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
类 PostResource。Posterize 图层设置。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [PostResource()](#PostResource--) | 初始化 [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) 类的新实例。 |
## 字段
...
初始化 [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) 类的新实例。
