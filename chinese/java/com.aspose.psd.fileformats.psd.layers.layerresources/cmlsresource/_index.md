...
description: "CmlsResource 类。"
type: docs
weight: 21
url: /zh/java/com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [CmlsResource(byte[] data)](#CmlsResource-byte---) | 初始化 [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource) 类的新实例。 |
## 字段
...
初始化 [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource) 类的新实例。
