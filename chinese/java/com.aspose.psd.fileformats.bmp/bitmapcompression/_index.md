...
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.bmp/bitmapcompression/
---
...
| [Png](#Png) | PNG 压缩。 |
| [Rgb](#Rgb) | 无压缩。 |
| [Rle4](#Rle4) | RLE 4 位/像素 压缩。 |
| [Rle8](#Rle8) | RLE 8 位/像素 压缩。 |
## Methods
...
RGBA 位字段。只能与 16 位和 32 位/像素 位图一起使用。
...
RGB 位字段。只能与 16 位和 32 位/像素 位图一起使用。
...
RLE 4 位/像素 压缩。只能与 4 位/像素 位图一起使用。
...
RLE 8 位/像素 压缩。只能与 8 位/像素 位图一起使用。
