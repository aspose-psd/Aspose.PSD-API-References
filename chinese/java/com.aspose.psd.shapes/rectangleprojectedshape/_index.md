...
description: "表示一种投射在矩形上并旋转到特定方向的形状。"
type: docs
weight: 16
url: /zh/java/com.aspose.psd.shapes/rectangleprojectedshape/
---
...
表示一种投射在矩形上并旋转至特定方向的形状。由四个点定义，这些点可以在空间中旋转，保持相同的边长且相邻边之间保持 90 度。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [RectangleProjectedShape()](#RectangleProjectedShape--) | 初始化一个新的 RectangleProjectedShape 类实例。 |
| [RectangleProjectedShape(RectangleF rectangle)](#RectangleProjectedShape-com.aspose.psd.RectangleF-) | 初始化一个新的 RectangleProjectedShape 类实例。 |
## Methods
...
初始化一个新的 RectangleProjectedShape 类实例。
...
| Parameter | Type | 描述 |
| --- | --- | --- |
| rectangle | [RectangleF](../../com.aspose.psd/rectanglef) | 用于初始化的矩形。 |
