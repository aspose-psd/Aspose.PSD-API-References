...
type: docs
weight: 12
url: /zh/java/com.aspose.psd.shapes/curveshape/
---
...
| [CurveShape(PointF[] points)](#CurveShape-com.aspose.psd.PointF---) | 初始化 CurveShape 类的新实例。 |
| [CurveShape(PointF[] points, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---boolean-) | 初始化 CurveShape 类的新实例。 |
| [CurveShape(PointF[] points, float tension)](#CurveShape-com.aspose.psd.PointF---float-) | 初始化 CurveShape 类的新实例。 |
| [CurveShape(PointF[] points, float tension, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---float-boolean-) | 初始化 CurveShape 类的新实例。 |
## Methods
...
初始化 CurveShape 类的新实例。默认张力为 0.5。
