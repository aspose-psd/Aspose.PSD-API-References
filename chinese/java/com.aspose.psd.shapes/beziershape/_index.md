...
type: docs
weight: 11
url: /zh/java/com.aspose.psd.shapes/beziershape/
---
...
| [BezierShape(PointF[] points)](#BezierShape-com.aspose.psd.PointF---) | 初始化 BezierShape 类的新实例。 |
| [BezierShape(PointF[] points, boolean isClosed)](#BezierShape-com.aspose.psd.PointF---boolean-) | 初始化 BezierShape 类的新实例。 |
## Methods
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | 点数组。 |
| isClosed | boolean | 如果设置为 true，bezier spline 将闭合。 |
