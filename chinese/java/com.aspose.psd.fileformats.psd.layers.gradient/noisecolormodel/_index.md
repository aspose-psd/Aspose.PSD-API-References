...
description: "当渐变类型为噪声时，我们可以将颜色模型分配为 RGB/SHB/LAB 3/4/6"
type: docs
weight: 12
url: /zh/java/com.aspose.psd.fileformats.psd.layers.gradient/noisecolormodel/
---
...
颜色模型 当 'Gradient type' = 'Noise' 时，我们可以将 'Color Model' 分配为 RGB/SHB/LAB (3/4/6)。
## 字段
