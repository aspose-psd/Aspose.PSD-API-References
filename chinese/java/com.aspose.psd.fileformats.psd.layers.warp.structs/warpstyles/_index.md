...
description: "支持的扭曲样式类型"
type: docs
weight: 13
url: /zh/java/com.aspose.psd.fileformats.psd.layers.warp.structs/warpstyles/
---
...
| --- | --- |
| [Arc](#Arc) | 弧形扭曲样式 |
| [ArcLower](#ArcLower) | 拱形扭曲样式 |
| [ArcUpper](#ArcUpper) | 下弧形扭曲样式 |
| [Arch](#Arch) | 上弧形扭曲样式 |
| [Bulge](#Bulge) | 膨胀扭曲样式 |
| [Custom](#Custom) | 点的任意移动样式 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Fish](#Fish) | 鱼形扭曲样式 |
| [Flag](#Flag) | 旗帜扭曲样式 |
| [Inflate](#Inflate) | 膨胀类型的扭曲 |
| [None](#None) | 当图层未变形时设置此样式 |
| [Rise](#Rise) | 上升扭曲样式 |
| [Squeeze](#Squeeze) | 压缩类型的扭曲 |
| [Twist](#Twist) | 扭转类型的扭曲 |
| [Wave](#Wave) | 波浪扭曲样式 |
## Methods
