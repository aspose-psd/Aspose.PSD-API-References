...
description: "它描述了 Warp 的渲染质量。"
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.psd.layers.warp.structs/renderquality/
---
...
| [Excellent](#Excellent) | 最慢的选项。 |
| [Fast](#Fast) | 允许您在质量略有下降的情况下加快渲染速度。 |
| [Good](#Good) | 质量高于标准，速度较慢。 |
| [Normal](#Normal) | 大多数曲率的推荐值 |
| [Turbo](#Turbo) | 最快的选项，但质量受损。 |
| [VeryFast](#VeryFast) | 如果您需要快速渲染，它可能适用于小曲率。 |
## Methods
