...
description: "指定加载 PSD 图像时可用的只读模式。"
type: docs
weight: 13
url: /zh/java/com.aspose.psd.imageloadoptions/readonlymode/
---
...
| [MetadataEdit](#MetadataEdit) | 允许编辑图像元数据，同时保持图像内容只读。 |
| [None](#None) | 未应用只读限制。 |
## Methods
