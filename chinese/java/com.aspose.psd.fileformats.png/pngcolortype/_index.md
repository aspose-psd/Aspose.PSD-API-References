...
type: docs
weight: 10
url: /zh/java/com.aspose.psd.fileformats.png/pngcolortype/
---
...
| [GrayscaleWithAlpha](#GrayscaleWithAlpha) | 表示每个像素为灰度样本后跟一个 alpha 样本的颜色类型。 |
| [IndexedColor](#IndexedColor) | 表示每个像素为调色板索引的颜色类型；应出现 PLTE 块。 |
| [Truecolor](#Truecolor) | 表示每个像素为 R,G,B 三元组的颜色类型。 |
| [TruecolorWithAlpha](#TruecolorWithAlpha) | 表示每个像素为 R,G,B 三元组后跟一个 alpha 样本的颜色类型。 |
## Methods
...
表示每个像素为 R,G,B 三元组后跟一个 alpha 样本的颜色类型。
