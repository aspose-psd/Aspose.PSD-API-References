...
description: "定义多组件彩色像素数据的交错模式。"
type: docs
weight: 14
url: /zh/java/com.aspose.psd.fileformats.jpeg/jpeglsinterleavemode/
---
...
| [Line](#Line) | 交错模式为按行。 |
| [None](#None) | 数据被编码并按组件存储：RRRGGGBBB。 |
| [Sample](#Sample) | 数据被编码并按样本存储。 |
## Methods
...
数据按样本进行编码和存储。对于彩色图像，这种格式类似于 RGBRGBRGB。
