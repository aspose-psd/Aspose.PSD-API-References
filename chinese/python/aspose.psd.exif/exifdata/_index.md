...
type: docs
weight: 10
url: /zh/python-net/aspose.psd.exif/exifdata/
---
...
| **Name** | **Description** |
| :- | :- |
| [ExifData()](#ExifData__1) | 初始化 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 类的新实例。 |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | 使用数组中的数据初始化 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 类的新实例。 |
| [ExifData(exifdata)](#ExifData_exifdata_3) | 使用数组中的数据初始化 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 类的新实例。 |
## **Properties**
...
初始化 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 类的新实例。
...
使用数组中的数据初始化 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 类的新实例。
