---
title: "SoLdResource 类"
type: docs
weight: 930
url: /zh/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [SoLdResource()](#SoLdResource__1) | 初始化 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 类的新实例。<br/>            此默认构造函数旨在供 [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/) 使用。<br/>            使用 [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) 来创建 SoLdResource 类。 |
| [SoLdResource(unique_id, is_custom, has_comp_info)](#SoLdResource_unique_id_is_custom_has_comp_info_2) | 初始化 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 类的新实例。<br/>            必须设置 Items 属性或调用 InitializeItems() 以获得就绪实例。<br/>            此构造函数旨在供 [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) 使用<br/>            并在单元测试中使用。<br/>            使用 [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) 来创建 SoLdResource 类。 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| PSB_RESOURCE_SIGNATURE [static] | int | r | 该 PSB 特定的资源签名。 |
| RESOURCE_SIGNATURE [static] | int | r | 该通用资源签名。 |
| TYPE_TOOL_KEY [static] | int | r | 类型工具信息键：'SoLd'。 |
...
初始化 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 类的新实例。<br/>            此默认构造函数旨在供 [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/) 使用。<br/>            使用 [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) 来创建 SoLdResource 类。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| unique_id | Guid | 智能对象图层数据 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 的唯一标识符。 |
