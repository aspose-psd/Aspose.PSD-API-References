---
title: "SoCoResource 类"
type: docs
weight: 920
url: /zh/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [SoCoResource()](#SoCoResource__1) | 初始化 [SoCoResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/) 类的新实例。 |
## **Properties**
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | 获取 RGB 颜色。 |
| key | int | r | 获取图层资源键。 |
...
初始化 [SoCoResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/) 类的新实例。
