---
title: "MlstResource 类"
type: docs
weight: 690
url: /zh/python-net/aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [MlstResource()](#MlstResource__1) | 初始化 MlstResource 类的新实例 |
## **Properties**
...
| descriptor_version | int | r | 获取或设置描述符版本。 |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | 获取或设置结构。 |
| key | int | r | 获取图层资源键。 |
