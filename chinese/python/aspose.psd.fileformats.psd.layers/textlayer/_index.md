...
type: docs
weight: 1750
url: /zh/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | 获取字体。 |
| has_alpha | bool | r |  |
...
| text | 字符串 | r | 获取文本。 |
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | 获取或设置文本边界框。 |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | 获取文本的颜色。 |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | 获取文本部分。 |
| top | int | 读/写 |  |
...
| [get_fonts()](#get_fonts__15) | 获取文本层的字体集合。 |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | 调整图像大小。默认使用 [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/)。 |
...
| [update_text(text)](#update_text_text_38) | 更新文本。 |
| [update_text(text, color)](#update_text_text_color_39) | 更新文本。 |
| [update_text(text, font_size)](#update_text_text_font_size_40) | 更新文本。 |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | 更新文本。 |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | 更新文本。 |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | 更新文本。 |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | 更新文本。 |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | 更新文本。 |
...
| 类型 | 描述 |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | 文本层的字体集合。 |
...
调整图像大小。默认使用 [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/)。
...
| new_width | int | 新的宽度。 |
| new_height | int | 新的高度。 |
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | 调整转换的类型 [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | 字符串 | 文本值。 |
| color | [Color](/psd/python-net/aspose.psd/color) | 颜色值。 |
...
| :- | :- | :- |
| text | 字符串 | 文本值。 |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | 左上坐标。 |
