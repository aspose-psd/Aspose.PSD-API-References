---
title: "ArtboardLayer 类"
type: docs
weight: 90
url: /zh/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | 获取或设置画板背景颜色。 |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | 获取或设置一个值，指示 [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) 是否具有背景颜色。 |
...
| is_cached | bool | r |  |
| is_open | bool | 读/写 | 获取或设置文件夹是否打开<br/>            如果设置为 <c>true</c>，则组在启动时处于打开状态，否则为最小化状态。 |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | 获取图层组中的图层 |
| left | int | 读/写 | <inheritdoc /> |
| 长度 | int | r |  |
...
| **Name** | **Description** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | 将图层添加到图层组。 |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | 添加图层组。 |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | 部分加载 32 位 ARGB 像素（按块）。 |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | 加载原始数据。 |
