...
type: docs
weight: 1600
url: /zh/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | 初始化 [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 类的新实例。<br/>            所有资源均以默认状态创建。 |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | 获取或设置形状图层中形状内部区域的填充设置。 |
| 填充不透明度 | int | 读/写 |  |
| 填充器 | byte | 读/写 |  |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | 获取形状图层中存在的路径集合。 |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | 获取或设置形状的描边设置。 |
| top | int | 读/写 |  |
...
| [create_instance()](#create_instance__7) | 创建 [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 类的新实例。 |
...
初始化 [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 类的新实例。<br/>            所有资源均以默认状态创建。
...
创建 [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 类的新实例。

**Returns**

| 类型 | 描述 |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | 返回 [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 类的新实例。 |
