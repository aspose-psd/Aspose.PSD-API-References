...
type: docs
weight: 40
url: /zh/python-net/aspose.psd.shapes/ellipseshape/
---
...
| **Name** | **Description** |
| :- | :- |
| [EllipseShape()](#EllipseShape__1) | 初始化一个新的 [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) 类实例。 |
| [EllipseShape(rectangle)](#EllipseShape_rectangle_2) | 初始化一个新的 [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) 类实例。 |
## **Properties**
...
初始化一个新的 [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) 类实例。
