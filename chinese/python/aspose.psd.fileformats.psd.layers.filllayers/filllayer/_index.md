...
type: docs
weight: 10
url: /zh/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| 填充不透明度 | int | 读/写 |  |
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | 获取或设置填充设置。 |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | 获取填充的类型。 |
| 填充器 | byte | 读/写 |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | 通过填充类型构建 [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) 类的新实例。 |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | 将所有非透明颜色替换为新颜色，并保留原始的 alpha 值以实现平滑边缘。<br/>            注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_36) | 将所有非透明颜色替换为新颜色，并保留原始的 alpha 值以实现平滑边缘。<br/>            注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
...
| update() | 根据当前的 [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) 更新填充图层的像素数据。 |
...
通过填充类型构建 [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) 类的新实例。

**Parameters:**

| 参数 | 类型 | 描述 |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | 填充图层的类型。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | 返回根据填充类型创建的 [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) 类的新实例。 |
