---
title: "IntegerStructure 类"
type: docs
weight: 80
url: /zh/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **Description** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | 初始化 [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | 整数结构键。 |
| key | int | r | 获取键。 |
...
初始化 [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/) 类的新实例。
