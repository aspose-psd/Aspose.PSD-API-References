---
title: "DoubleStructure 类"
type: docs
weight: 50
url: /zh/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| **Name** | **Description** |
| :- | :- |
| [DoubleStructure(key_name)](#DoubleStructure_key_name_1) | 初始化一个新的 [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) 类的实例。 |
## **Properties**
...
| value | double | 读/写 | 获取或设置 double 值。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
初始化一个新的 [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) 类的实例。
