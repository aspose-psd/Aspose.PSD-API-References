...
type: docs
weight: 50
url: /zh/python-net/aspose.psd.xmp.types.basic/xmptext/
---
...
| **Name** | **Description** |
| :- | :- |
| [XmpText(value)](#XmpText_value_1) | 初始化 [XmpText](/psd/python-net/aspose.psd.xmp.types.basic/xmptext/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| value | 字符串 | 读/写 | 获取或设置文本值。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
初始化 [XmpText](/psd/python-net/aspose.psd.xmp.types.basic/xmptext/) 类的新实例。
