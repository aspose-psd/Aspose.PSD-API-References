---
title: "BlackWhiteAdjustmentLayer 类"
type: docs
weight: 20
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | 读/写 | 获取或设置 Tint Color 值。 |
| tint_color_blue | double | 读/写 | 获取或设置 Blue Tint Color double 值。 |
| tint_color_green | double | 读/写 | 获取或设置 Green Tint Color double 值。 |
| tint_color_red | double | 读/写 | 获取或设置 Red Tint Color double 值。 |
| top | int | 读/写 |  |
