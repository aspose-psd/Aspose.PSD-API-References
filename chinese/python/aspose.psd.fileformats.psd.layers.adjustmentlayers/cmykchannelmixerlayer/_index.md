---
title: "CmykChannelMixerLayer 类"
type: docs
weight: 50
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 获取黑色通道。 |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 获取青色通道。 |
...
| left | int | 读/写 |  |
| 长度 | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 获取品红通道。 |
| monochrome | bool | r/w | 获取或设置指示此 [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) 是否为单色的值。 |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 获取黄色通道。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | 获取通道的索引。返回 CmykMixerChannel |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | 将图层合并到指定图层 |
| normalize_angle() |  |
