---
title: "SelectiveColorLayer 类"
type: docs
weight: 200
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | 获取或设置校正方法。 |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | 获取按选择颜色的 CMYK 校正。 |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | 设置按选择颜色的 CMYK 校正。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | 选择颜色。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | CMYK 校正。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | 选择颜色的类型。 |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | CMYK 校正。 |
