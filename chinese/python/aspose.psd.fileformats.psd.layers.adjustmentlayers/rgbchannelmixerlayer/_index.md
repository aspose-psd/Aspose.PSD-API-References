---
title: "RgbChannelMixerLayer 类"
type: docs
weight: 180
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 获取蓝色通道。 |
| 底部 | int | 读/写 |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 获取绿色通道。 |
| has_alpha | bool | r |  |
...
| raw_line_size | int | r |  |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 获取红色通道。 |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | 获取通道的索引。返回 RgbMixerChannel |
