...
type: docs
weight: 90
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | 读/写 | 获取或设置一个值，指示此实例是否使用连续管理器。 |
| is_discrete_manager_used | bool | 读/写 | 获取或设置一个值，指示此实例是否使用离散管理器。 |
...
| [get_curves_manager()](#get_curves_manager__8) | 获取曲线管理器。 |
...
| 类型 | 描述 |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) 或 [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) 取决于 IsDiscreteManagerUsed 和 IsContinuousManagerUsed 属性 |
