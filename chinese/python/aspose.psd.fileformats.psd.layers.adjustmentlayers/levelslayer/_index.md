...
type: docs
weight: 140
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| left | int | 读/写 |  |
| 长度 | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | 获取主通道。 |
...
| [get_channel(index)](#get_channel_index_8) | 获取通道。 |
...
| 类型 | 描述 |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) 按索引 |
