---
title: "ExposureLayer 类"
type: docs
weight: 100
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| 已释放 | bool | r |  |
| 曝光 | float | 读/写 | 获取或设置曝光。对于 Photoshop，曝光的范围是 -20 到 +20。 |
| 额外长度 | int | r |  |
...
| 伽马校正 | float | 读/写 | 获取或设置伽马校正。对于 Photoshop，伽马校正的范围是 9.99 到 +0.01。 |
| has_alpha | bool | r |  |
...
| offset | float | 读/写 | 获取或设置偏移量。对于 Photoshop，偏移量的范围是 -0.5 到 +0.5。 |
| opacity | byte | 读/写 |  |
