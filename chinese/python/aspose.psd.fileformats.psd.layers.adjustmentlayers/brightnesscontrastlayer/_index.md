---
title: "BrightnessContrastLayer 类"
type: docs
weight: 30
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| 亮度 | int | 读/写 | 获取或设置亮度。对于 Photoshop，亮度的范围是 -150 到 +150。但我们忽略此范围。 |
...
| 对比度 | int | 读/写 | 获取或设置对比度。对于 Photoshop，对比度的范围是 -50 到 +100。但我们忽略此范围。 |
