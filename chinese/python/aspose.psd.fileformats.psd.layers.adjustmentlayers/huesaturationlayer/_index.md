---
title: "HueSaturationLayer 类"
type: docs
weight: 120
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | byte | 读/写 |  |
| colorize | bool | r/w | 获取或设置一个值，指示此 [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) 是否进行彩色化。 |
...
| [get_range(index)](#get_range_index_20) | 获取范围。 |
...
| 类型 | 描述 |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | 颜色范围 Hsl |
