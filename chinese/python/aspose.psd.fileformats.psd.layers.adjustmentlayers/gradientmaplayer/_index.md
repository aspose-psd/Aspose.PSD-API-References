---
title: "GradientMapLayer 类"
type: docs
weight: 110
url: /zh/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
| gradient_settings | [BaseGradientFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/basegradientfillsettings/) | r/w | 从 GrdmResource 实例传递的 Gradient 设置实例。 |
| has_alpha | bool | r |  |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | 部分加载 32 位 ARGB 像素（按块）。 |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | 加载原始数据。 |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | 将图层合并到指定图层 |
| normalize_angle() |  |
