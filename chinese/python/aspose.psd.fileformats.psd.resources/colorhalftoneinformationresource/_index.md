---
title: "ColorHalftoneInformationResource 类"
type: docs
weight: 50
url: /zh/python-net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource__1) | 初始化 ColorHalftoneInformationResource 类的新实例 |
## **Properties**
...
| halftone_data | byte | 读/写 | 获取或设置半色调数据。 |
...
初始化 ColorHalftoneInformationResource 类的新实例
