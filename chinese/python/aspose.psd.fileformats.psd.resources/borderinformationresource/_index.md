---
title: "BorderInformationResource 类"
type: docs
weight: 30
url: /zh/python-net/aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [BorderInformationResource()](#BorderInformationResource__1) | 初始化 BorderInformationResource 类的新实例 |
## **Properties**
...
| unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | 获取或设置边框单位。 |
| width | double | 读/写 | 获取或设置边框宽度。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
初始化 BorderInformationResource 类的新实例
