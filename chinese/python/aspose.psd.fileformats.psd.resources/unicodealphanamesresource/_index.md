---
title: "UnicodeAlphaNamesResource 类"
type: docs
weight: 270
url: /zh/python-net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource__1) | 初始化 UnicodeAlphaNamesResource 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| RESOUCE_BLOCK_ME_SA_SIGNATURE [static] | int | r | ImageReady 的资源签名。 |
| RESOUCE_BLOCK_SIGNATURE [static] | int | r | 常规 Photoshop 资源签名。 |
| alpha_names | 字符串 | 读/写 | 获取或设置 alpha 名称。 |
...
初始化 UnicodeAlphaNamesResource 类的新实例
