---
title: "ColorTransferFunctionsResource 类"
type: docs
weight: 60
url: /zh/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | 初始化 ColorTransferFunctionsResource 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| RESOUCE_BLOCK_ME_SA_SIGNATURE [static] | int | r | ImageReady 的资源签名。 |
| RESOUCE_BLOCK_SIGNATURE [static] | int | r | 常规 Photoshop 资源签名。 |
| color_transfer_data | byte | 读/写 | 获取或设置颜色传输数据。 |
...
初始化 ColorTransferFunctionsResource 类的新实例
