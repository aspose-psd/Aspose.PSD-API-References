---
title: "PrintScaleResource 类"
type: docs
weight: 210
url: /zh/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | 初始化 PrintScaleResource 类的新实例 |
## **Properties**
...
| scale | float | 读/写 | 获取或设置比例。 |
| signature | int | r | 获取资源签名。应始终为 '8BIM'。 |
| 大小 | int | r | 获取资源块的大小（字节），包括其数据。 |
| style | short | 读/写 | 获取或设置样式。 |
| x_location | float | 读/写 | 获取或设置 x 位置。 |
| y_location | float | 读/写 | 获取或设置 y 位置。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
