---
title: "WorkingPathResource 类"
type: docs
weight: 320
url: /zh/python-net/aspose.psd.fileformats.psd.resources/workingpathresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [WorkingPathResource(data_bytes)](#WorkingPathResource_data_bytes_1) | 初始化 [WorkingPathResource](/psd/python-net/aspose.psd.fileformats.psd.resources/workingpathresource/) 类的新实例。 |
## **Properties**
...
初始化 [WorkingPathResource](/psd/python-net/aspose.psd.fileformats.psd.resources/workingpathresource/) 类的新实例。

**Parameters:**

| 参数 | 类型 | 描述 |
| :- | :- | :- |
| data_bytes | byte | 向量路径的数据。 |
