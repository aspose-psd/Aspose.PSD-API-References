...
type: docs
weight: 3450
url: /zh/python-net/aspose.psd/pixeldataformat/
---
...
| 标题 | 字符串 | r | 获取像素数据格式的标题。 |
| channel_bits | int | r | 获取每个通道的位数。 |
| channels_count | int | r | 获取通道数量。 |
| cmyk [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 32 位、每种青色、品红、黄色和黑色各 8 位的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| cmyka [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取 acmyk。 |
| grayscale [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 8 位、其中 8 位表示 0-255 区间灰度强度的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| grayscale_alpha [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 16 位、其中 8 位表示 0-255 区间灰度强度且额外包含 8 位 alpha 分量的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| pixel_format | [PixelFormat](/psd/python-net/aspose.psd/pixelformat) | r | 获取像素格式。 |
| rgb_16_bpp_555 [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 16 位、红、绿、蓝各 5 位且未定义 alpha 的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| rgb_16_bpp_565 [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 16 位、红 5 位、绿 6 位、蓝 5 位且未定义 alpha 的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| rgb_24_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 24 位、alpha、红、绿、蓝各 8 位且未定义 alpha 的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| rgb_24_bpp_png [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 24 位、alpha、红、绿、蓝各 8 位且未定义 alpha 的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| rgb_32_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 32 位、alpha、红、绿、蓝各 8 位的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| rgb_indexed_1_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每种颜色 1 位索引的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。<br/>            索引像素数据存储旨在在使用调色板的所有地方实现数据的存储和检索。<br/>            使用时请谨慎，因为可能需要将调色板从一种转换为另一种，或将 RGBA 转换为索引颜色模型。 |
| rgb_indexed_2_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取为每种颜色索引的 2 位定义的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。<br/>            索引像素数据存储旨在在使用调色板的所有地方允许数据的存储和检索。<br/>            使用时请谨慎，因为可能需要将一个调色板转换为另一个，或将 RGBA 转换为索引颜色模型。 |
| rgb_indexed_4_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取为每种颜色索引的 4 位定义的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。<br/>            索引像素数据存储旨在在使用调色板的所有地方允许数据的存储和检索。<br/>            使用时请谨慎，因为可能需要将一个调色板转换为另一个，或将 RGBA 转换为索引颜色模型。 |
| rgb_indexed_8_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取为每种颜色索引的 8 位定义的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。<br/>            索引像素数据存储旨在在使用调色板的所有地方允许数据的存储和检索。<br/>            使用时请谨慎，因为可能需要将一个调色板转换为另一个，或将 RGBA 转换为索引颜色模型。 |
| rgba_32_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取定义为每像素 32 位、alpha、红、绿、蓝各 8 位的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| rgba_64_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取为每像素 64 位、每个 alpha、red、green、blue 各 16 位定义的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| y_cb_cr [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取为每像素 24 位、每个亮度、蓝差和红差色度分量各 8 位定义的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
| ycck [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | 获取为每像素 32 位、每个亮度、蓝差、红差和黑色色度分量各 8 位定义的 [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/)。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_grayscale_alpha(bits_per_sample)](#get_grayscale_alpha_bits_per_sample_8) | 获取具有指定每样本位数的灰度 Alpha 颜色。 |
| [get_grayscale_alpha(bits_per_sample, alpha_channel_bits)](#get_grayscale_alpha_bits_per_sample_alpha_channel_bits_9) | 获取具有指定每样本位数的灰度 Alpha 颜色。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| bits_per_sample | int | 每个样本的位数。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | BGRA 颜色。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| bits_per_l | int | L 通道的位数。 |
| bits_per_a | int | A 通道的位数。 |
| bits_per_b | int | B 通道的位数。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | CIE Lab 颜色。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| bits_per_cyan_channel | int | 每个青色通道的位数。 |
| bits_per_magenta_channel | int | 每个品红通道的位数。 |
| bits_per_yellow_channel | int | 每个黄色通道的位数。 |
| bits_per_key_channel | int | 每个键色通道的位数。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | CMYK 颜色。 |
...
| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | 灰度颜色。 |
...
| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | 灰度 Alpha 颜色。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| bits_per_red_channel | int | 每个红色通道的位数。 |
| bits_per_green_channel | int | 每个绿色通道的位数。 |
| bits_per_blue_channel | int | 每个蓝色通道的位数。 |

**Returns**

| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | RGB 颜色。 |
...
| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | RGBA 颜色。 |
...
| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | YCbCr 颜色。 |
...
| 类型 | 描述 |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | YCCK 颜色。 |
