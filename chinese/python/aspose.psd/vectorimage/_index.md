...
type: docs
weight: 4700
url: /zh/python-net/aspose.psd/vectorimage/
---
...
| size_f | [SizeF](/psd/python-net/aspose.psd/sizef) | r | 获取对象的尺寸（英寸）。 |
| use_palette | bool | r | 获取一个值，指示是否使用图像调色板。 |
| width | int | r | 获取图像宽度。 |
| width_f | float | r | 获取对象的宽度（英寸）。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
