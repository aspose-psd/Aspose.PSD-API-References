...
type: docs
weight: 2180
url: /zh/python-net/aspose.psd/imageattributes/
---
...
| **Name** | **Description** |
| :- | :- |
| [ImageAttributes()](#ImageAttributes__1) | 初始化 ImageAttributes 类的新实例 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| clear_brush_remap_table() | 清除此 [ImageAttributes](/psd/python-net/aspose.psd/imageattributes/) 对象的画笔颜色映射表。 |
...
| clear_output_channel_color_profile() | 清除默认类别的输出通道颜色配置设置。 |
| [clear_output_channel_color_profile(type)](#clear_output_channel_color_profile_type_6) | 清除指定类别的输出通道颜色配置设置。 |
| clear_remap_table() | 清除默认类别的颜色重新映射表。 |
| [clear_remap_table(type)](#clear_remap_table_type_7) | 清除指定类别的颜色重新映射表。 |
| clear_threshold() | 清除默认类别的阈值。 |
| [clear_threshold(type)](#clear_threshold_type_8) | 清除指定类别的阈值。 |
| [set_brush_remap_table(map)](#set_brush_remap_table_map_9) | 设置画笔类别的颜色重新映射表。 |
...
| [set_output_channel_color_profile(color_profile_filename)](#set_output_channel_color_profile_color_profile_filename_23) | 为默认类别设置输出通道色彩配置文件。 |
| [set_output_channel_color_profile(color_profile_filename, type)](#set_output_channel_color_profile_color_profile_filename_type_24) | 为指定类别设置输出通道色彩配置文件。 |
...
| [set_wrap_mode(mode)](#set_wrap_mode_mode_29) | 设置用于决定如何在形状上或形状边界处平铺纹理的包裹模式。当纹理小于要填充的形状时，纹理会在形状上平铺以填充。 |
| [set_wrap_mode(mode, color)](#set_wrap_mode_mode_color_30) | 设置用于决定如何在形状上或形状边界处平铺纹理的包裹模式和颜色。当纹理小于要填充的形状时，纹理会在形状上平铺以填充。 |
| [set_wrap_mode(mode, color, clamp)](#set_wrap_mode_mode_color_clamp_31) | 设置用于决定如何在形状上或形状边界处平铺纹理的包裹模式和颜色。当纹理小于要填充的形状时，纹理会在形状上平铺以填充。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除颜色键的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除颜色调整矩阵的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要禁用伽马校正的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除 NoOp 设置的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除输出通道设置的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除输出通道配置文件设置的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除重新映射表的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要清除阈值的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | 一个由 [ColorMap](/psd/python-net/aspose.psd/colormap/) 对象组成的数组。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| color_low | [Color](/psd/python-net/aspose.psd/color) | 低色键值。 |
| color_high | [Color](/psd/python-net/aspose.psd/color) | 高色键值。 |
...
| color_low | [Color](/psd/python-net/aspose.psd/color) | 低色键值。 |
| color_high | [Color](/psd/python-net/aspose.psd/color) | 高色键值。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要设置色键的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 颜色调整矩阵。 |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 灰度调整矩阵。 |
...
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 颜色调整矩阵。 |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 灰度调整矩阵。 |
| flags | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | 一个 [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) 元素，指定将受到颜色调整和灰度调整矩阵影响的图像和颜色类型。 |
...
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 颜色调整矩阵。 |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 灰度调整矩阵。 |
| mode | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | 一个 [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) 元素，指定将受到颜色调整和灰度调整矩阵影响的图像和颜色类型。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要设置颜色调整和灰度调整矩阵的类别。 |
...
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 颜色调整矩阵。 |
| flags | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | 一个 [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) 元素，指定将受到颜色调整矩阵影响的图像和颜色类型。 |
...
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | 颜色调整矩阵。 |
| mode | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | 一个 [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) 元素，指定将受到颜色调整矩阵影响的图像和颜色类型。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要设置颜色调整矩阵的类别。 |
...
| :- | :- | :- |
| 伽马 | float | 伽马校正值。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 枚举的元素，指定要设置伽马值的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要关闭颜色校正的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| flags | [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag) | 一个 [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag/) 元素，指定输出通道。 |
...
| :- | :- | :- |
| flags | [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag) | 一个 [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag/) 元素，指定输出通道。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要设置输出通道的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| color_profile_filename | 字符串 | 颜色配置文件的路径名。如果颜色配置文件位于 %SystemRoot%\System32\Spool\Drivers\Color 目录中，此参数可以是文件名。否则，此参数必须是完整的路径名。 |
...
| :- | :- | :- |
| color_profile_filename | 字符串 | 颜色配置文件的路径名。如果颜色配置文件位于 %SystemRoot%\System32\Spool\Drivers\Color 目录中，此参数可以是文件名。否则，此参数必须是完整的路径名。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要设置输出通道颜色配置文件的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | 一个由 [ColorMap](/psd/python-net/aspose.psd/colormap/) 类型的颜色对组成的数组。每个颜色对包含一个现有颜色（第一个值）和它将映射到的颜色（第二个值）。 |
...
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | 一个由 [ColorMap](/psd/python-net/aspose.psd/colormap/) 类型的颜色对组成的数组。每个颜色对包含一个现有颜色（第一个值）和它将映射到的颜色（第二个值）。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定要设置颜色重新映射表的类别。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| threshold | float | 阈值范围从 0.0 到 1.0，用作分割点以对颜色进行排序，这些颜色将映射到最大值或最小值。 |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | 一个 [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) 元素，指定设置颜色阈值的类别。 |
...
设置用于决定如何在形状上或形状边界处平铺纹理的包裹模式。当纹理小于要填充的形状时，纹理会在形状上平铺以填充。

**Parameters:**

| 参数 | 类型 | 描述 |
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | 一个 [WrapMode](/psd/python-net/aspose.psd/wrapmode/) 元素，指定图像的重复副本如何用于平铺区域。 |
...
设置用于决定如何在形状上或形状边界处平铺纹理的包裹模式和颜色。当纹理小于要填充的形状时，纹理会在形状上平铺以填充。
...
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | 一个 [WrapMode](/psd/python-net/aspose.psd/wrapmode/) 元素，指定图像的重复副本如何用于平铺区域。 |
| color | [Color](/psd/python-net/aspose.psd/color) | 一个 [ImageAttributes](/psd/python-net/aspose.psd/imageattributes/) 对象，指定渲染图像之外像素的颜色。如果模式参数设置为 [WrapMode.CLAMP](/psd/python-net/aspose.psd/wrapmode/) 且传递给 DrawImage 的源矩形大于图像本身，则可见此颜色。 |
...
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | 一个 [WrapMode](/psd/python-net/aspose.psd/wrapmode/) 元素，指定图像的重复副本如何用于平铺区域。 |
| color | [Color](/psd/python-net/aspose.psd/color) | 一个颜色对象，指定渲染图像之外像素的颜色。如果模式参数设置为 [WrapMode.CLAMP](/psd/python-net/aspose.psd/wrapmode/) 且传递给 DrawImage 的源矩形大于图像本身，则可见此颜色。 |
| 夹紧 | bool | 此参数无效。将其设为 false。 |
