...
type: docs
weight: 40
url: /zh/python-net/aspose.psd.fileformats.ai/aiimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [AiImage()](#AiImage__1) | 初始化 AiImage 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| active_page_index | int | 读/写 | 获取或设置活动页面的索引。 |
...
| data_section | [AiDataSection](/psd/python-net/aspose.psd.fileformats.ai/aidatasection) | r | 获取数据段。 |
...
| finalize_section | [AiFinalizeSection](/psd/python-net/aspose.psd.fileformats.ai/aifinalizesection) | r | 获取 finalize 段。 |
| has_background_color | bool | 读/写 | 获取或设置一个值，指示图像是否具有背景颜色。 |
| header | [AiHeader](/psd/python-net/aspose.psd.fileformats.ai/aiheader) | r | 获取标头。 |
| height | int | r | 获取图像高度。 |
...
| layers | [AiLayerSection[]](/psd/python-net/aspose.psd.fileformats.ai/ailayersection) | r | 获取图层段。 |
| page_count | int | r | 页面的数量。<br/> 对于旧的 AI 格式图像始终等于 0。 |
| palette | [IColorPalette](/psd/python-net/aspose.psd/icolorpalette) | r/w | 获取或设置颜色调色板。当像素直接表示时，不使用颜色调色板。 |
| setup_section | [AiSetupSection](/psd/python-net/aspose.psd.fileformats.ai/aisetupsection) | r | 获取设置段。 |
| size | [Size](/psd/python-net/aspose.psd/size) | r | 获取图像尺寸。 |
| use_palette | bool | r | 获取一个值，指示是否使用图像调色板。 |
| version | [AiFormatVersion](/psd/python-net/aspose.psd.fileformats.ai/aiformatversion) | r | 获取 Adobe Illustrator 格式的版本。 |
| width | int | r | 获取图像宽度。 |
| xmp_data | [XmpPacketWrapper](/psd/python-net/aspose.psd.xmp/xmppacketwrapper/) | r | 获取或设置 XMP 元数据。 |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | 添加 AI 图层段。 |
...
| [can_load(file_path, load_options)](#can_load_file_path_load_options_3) | 确定是否可以从指定的文件路径加载图像，且可选地使用指定的打开选项。 |
| [can_load(stream)](#can_load_stream_4) | 确定是否可以从指定的流加载图像。 |
| [can_load(stream, load_options)](#can_load_stream_load_options_5) | 确定是否可以从指定的流加载图像，且可选地使用指定的 <paramref name="loadOptions" />。 |
| [can_save(options)](#can_save_options_6) | 确定是否可以将图像保存为由传入的保存选项表示的指定文件格式。 |
| [create(image_options, width, height)](#create_image_options_width_height_7) | 使用指定的创建选项创建新图像。 |
| [get_default_options(args)](#get_default_options_args_8) | 获取默认选项。 |
| [get_file_format(file_path)](#get_file_format_file_path_9) | 获取文件格式。 |
| [get_file_format(stream)](#get_file_format_stream_10) | 获取文件格式。 |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_11) | 获取适合当前图像的矩形。 |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_12) | 获取适合当前图像的矩形。 |
| [get_original_options()](#get_original_options__13) | 获取基于原始文件设置的选项。<br/>            这有助于保持原始图像的位深度和其他参数不变。<br/>            例如，如果我们加载一张每像素 1 位的黑白 PNG 图像，然后使用<br/>            [DataStreamSupporter.save(file_path)](/psd/python-net/aspose.psd/datastreamsupporter/) 方法保存，它将生成每像素 8 位的输出 PNG 图像。<br/>            为避免这种情况并以每像素 1 位保存 PNG 图像，请使用此方法获取相应的保存选项并将它们<br/>            作为第二个参数传递给 [Image.save(file_path, options)](/psd/python-net/aspose.psd/image/) 方法。 |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_14) | 获取等比例高度。 |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_15) | 获取等比例宽度。 |
| [load(file_path)](#load_file_path_16) | 从指定文件加载新图像。 |
| [load(file_path, load_options)](#load_file_path_load_options_17) | 从指定文件加载新图像。 |
| [load(stream)](#load_stream_18) | 从指定流加载新图像。 |
| [load(stream, load_options)](#load_stream_load_options_19) | 从指定流加载新图像。 |
| [resize(new_width, new_height)](#resize_new_width_new_height_20) | 调整图像大小。使用默认的 [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/)。 |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_21) | 调整图像大小。 |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_22) | 调整图像大小。 |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_23) | 等比例调整高度。 |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_24) | 等比例调整高度。 |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_25) | 等比例调整高度。 |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_26) | 等比例调整宽度。使用默认的 [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/)。 |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_27) | 等比例调整宽度。 |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_28) | 等比例调整宽度。 |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_29) | 旋转、翻转或同时旋转并翻转图像。 |
| save() | 将图像数据保存到底层流。 |
| [save(file_path)](#save_file_path_30) | 将对象的数据保存到指定的文件位置。 |
| [save(file_path, options)](#save_file_path_options_31) | 根据保存选项，将对象的数据以指定的文件格式保存到指定的文件位置。 |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_32) | 根据保存选项，将对象的数据以指定的文件格式保存到指定的文件位置。 |
| [save(file_path, over_write)](#save_file_path_over_write_33) | 将对象的数据保存到指定的文件位置。 |
| [save(stream)](#save_stream_34) | 将对象的数据保存到指定的流中。 |
| [save(stream, options_base)](#save_stream_options_base_35) | 根据保存选项，将图像的数据以指定的文件格式保存到指定的流中。 |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_36) | 根据保存选项，将图像的数据以指定的文件格式保存到指定的流中。 |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_37) | 设置图像调色板。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| layer | [AiLayerSection](/psd/python-net/aspose.psd.fileformats.ai/ailayersection) | 该 AI 图层段。 |
