...
| 姓名 | 描述 |
| --- | --- |
| [Value](../../aspose.psd.xmp.types.basic/xmpboolean/value) { get; set; } | 获取或设置一个值，该值指示此[`XmpBoolean`](../xmpboolean)是否为值。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.types.basic/xmpboolean/getxmprepresentation)() | 以 XMP 格式返回字符串包含的值。 |
