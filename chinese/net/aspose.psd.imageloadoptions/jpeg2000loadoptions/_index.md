...
description: Aspose.PSD.ImageLoadOptions.Jpeg2000LoadOptions 班级. JPEG2000 加载选项
type: docs
weight: 4760
...
| 姓名 | 描述 |
| --- | --- |
| [Jpeg2000LoadOptions](jpeg2000loadoptions/)() | 初始化一个新的实例`Jpeg2000LoadOptions`类. |
...
| [MaximumDecodingTime](../../aspose.psd.imageloadoptions/jpeg2000loadoptions/maximumdecodingtime/) { get; set; } | 获取或设置以秒为单位的最大解码时间（此选项可用于内存速度非常慢的机器，以防止在非常大的图像上挂起进程 - 分辨率超过 5500x6500 像素）。 |
