...
| [MaximumDecodingTime](../../aspose.psd.imageloadoptions/jpeg2000loadoptions/maximumdecodingtime) { get; set; } | 获取或设置最大解码时间（以秒为单位）（此选项可用于内存机器上非常慢的内存机器，以防止在非常大的图像上挂起进程 - 分辨率超过 5500x6500 像素）。 |
