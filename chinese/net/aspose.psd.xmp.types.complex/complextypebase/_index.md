...
description: Aspose.PSD.Xmp.Types.Complex.ComplexTypeBase 班级. 表示 XMP 复杂值类型的基本抽象
type: docs
weight: 6050
...
| 姓名 | 描述 |
| --- | --- |
| [ComplexTypeBase](complextypebase/)(string, string) | 初始化一个新的实例`ComplexTypeBase`类. |
...
| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.types.complex/complextypebase/getxmprepresentation/)() | 获取包含 XMP 格式的字符串值。 |
