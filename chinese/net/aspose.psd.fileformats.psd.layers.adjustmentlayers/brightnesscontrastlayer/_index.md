---
title: "类 BrightnessContrastLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer 类。亮度/对比度图层"
type: docs
weight: 1720
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | 获取或设置亮度。对于 Photoshop，亮度的范围是 -150 到 +150。但我们忽略此设置。 |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | 获取或设置对比度。对于 Photoshop，对比度的范围是 -50 到 +100。但我们忽略此设置。 |
