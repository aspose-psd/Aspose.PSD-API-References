...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer 班级. 亮度/对比度层
type: docs
weight: 1680
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | 获取或设置亮度。对于 PS，亮度范围是从 -150 到 +150。但是我们忽略了这个。 |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | 获取或设置对比度。对于 PS，对比度范围是从 -50 到 +100。但是我们忽略了这个。 |
