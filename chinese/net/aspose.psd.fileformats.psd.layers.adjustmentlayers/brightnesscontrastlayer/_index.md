...
type: docs
weight: 1680
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness) { get; set; } | 获取或设置亮度。 PS的亮度范围是-150到+150。但是我们忽略了这个。 |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast) { get; set; } | 获取或设置对比度。 PS的对比度范围是-50到+100。但是我们忽略了这个。 |
