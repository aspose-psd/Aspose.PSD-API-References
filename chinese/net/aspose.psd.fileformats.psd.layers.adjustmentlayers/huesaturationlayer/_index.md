...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer 班级. HueSaturation 调整图层.
type: docs
weight: 1750
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | 获取或设置一个值，指示是否这`HueSaturationLayer`是 colorize. |
