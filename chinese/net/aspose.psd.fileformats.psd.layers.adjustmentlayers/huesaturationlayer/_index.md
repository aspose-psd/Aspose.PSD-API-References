...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize) { get; set; } | 获取或设置一个值，该值指示此[`HueSaturationLayer`](../huesaturationlayer)是否为彩色。 |
