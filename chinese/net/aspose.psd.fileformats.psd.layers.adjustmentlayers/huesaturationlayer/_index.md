...
description: 色相饱和度调整图层
type: docs
weight: 1750
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize) { get; set; } | 获取或设置一个值，该值指示是否[`HueSaturationLayer`](../huesaturationlayer)是着色. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue) { get; set; } | 获取或设置色调。 |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness) { get; set; } | 获取或设置亮度。 |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation) { get; set; } | 获取或设置饱和度。 |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange)(int) | 获取范围。 |
