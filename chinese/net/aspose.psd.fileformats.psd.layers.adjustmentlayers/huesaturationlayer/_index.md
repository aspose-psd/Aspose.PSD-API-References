---
title: "类 HueSaturationLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer 类。HueSaturation 调整图层。"
type: docs
weight: 1820
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | 获取或设置一个值，指示此 `HueSaturationLayer` 是否进行着色。 |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | 获取或设置色相。 |
