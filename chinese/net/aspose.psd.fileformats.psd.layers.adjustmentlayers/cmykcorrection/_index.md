---
title: "类 CmykCorrection"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection 类。选择性颜色调整图层中的颜色校正"
type: docs
weight: 1750
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
...
| 名称 | 描述 |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | 默认构造函数。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | 获取或设置黑色校正。 |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | 获取或设置青色校正。 |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | 获取或设置品红色校正。 |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | 获取或设置黄色校正。 |
