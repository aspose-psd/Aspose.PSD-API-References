...
description: "ColorBalanceAdjustmentLayer 属性。获取或设置 Shadows Cyan Red Balance"
type: docs
weight: 80
...
该 Shadows Cyan Red Balance。

### 异常

| 异常 | 条件 |
| --- | --- |
| ArgumentOutOfRangeException | Shadows Cyan Red Balance 必须在 -100 到 +100 的范围内。 |
