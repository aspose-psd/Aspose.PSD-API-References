...
description: "ColorBalanceAdjustmentLayer 属性。获取或设置 Highlights Yellow Blue Balance"
type: docs
weight: 30
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsyellowbluebalance/
---
{{< psd/tize >}}
...
| 异常 | 条件 |
| --- | --- |
| ArgumentOutOfRangeException | Highlights Yellow Blue Balance 必须在 -100 到 +100 的范围内。 |
