...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure) { get; set; } | 获取或设置曝光。 PS 的曝光范围是 -20 到 +20。 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset) { get; set; } | 获取或设置偏移量。对于 PS 的偏移量范围是从 -0.5 到 +0.5 |
