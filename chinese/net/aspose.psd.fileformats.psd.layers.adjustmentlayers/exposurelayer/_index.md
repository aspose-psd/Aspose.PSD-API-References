---
title: "类 ExposureLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer 类。曝光调整图层"
type: docs
weight: 1800
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | 获取或设置曝光。对于 Photoshop，曝光的范围是 -20 到 +20。 |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | 获取或设置伽马校正。对于 Photoshop，伽马校正的范围是 9.99 到 +0.01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | 获取或设置偏移。对于 Photoshop，偏移的范围是 -0.5 到 +0.5 |
