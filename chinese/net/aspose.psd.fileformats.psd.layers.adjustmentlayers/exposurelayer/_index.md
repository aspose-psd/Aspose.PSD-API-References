...
type: docs
weight: 1740
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
## ExposureLayer class
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure) { get; set; } | 获取或设置曝光。 PS的曝光范围是-20到+20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection) { get; set; } | 获取或设置 GammaCorrection。对于 PS 的 GammaCorrection 范围是从 9.99 到 +0.01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset) { get; set; } | 获取或设置偏移量。对于 PS 的 Offset 范围是从 -0.5 到 +0.5 |
