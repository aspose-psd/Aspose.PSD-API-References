...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer 班级. 色调分离层使用来自 PostResource. 的数据处理 Posterize 渲染
type: docs
weight: 1800
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
## PosterizeLayer class

色调分离层。使用来自 PostResource. 的数据处理 Posterize 渲染
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | 色调分离层的级别。 |
