---
title: "类 PosterizeLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer 类。Posterize 图层。使用来自 PostResource 的数据处理 Posterize 渲染。"
type: docs
weight: 1870
...
色调分离图层。使用来自 PostResource 的数据处理色调分离渲染。
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Posterize 图层的级别。 |
