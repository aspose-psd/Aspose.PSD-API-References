---
title: "类 GradientMapLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer 类。渐变映射图层。使用来自 GrdmResource 的数据处理渐变映射渲染"
type: docs
weight: 1810
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
## GradientMapLayer class

渐变映射图层。使用来自 GrdmResource 的数据处理渐变映射渲染。
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | 获取或设置从 GrdmResource 实例传递的 Gradient 设置实例。 |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | 在相关图层资源中更新图层数据 [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/)。 |
