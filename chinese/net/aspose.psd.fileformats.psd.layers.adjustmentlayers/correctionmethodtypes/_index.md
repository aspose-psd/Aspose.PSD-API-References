---
title: "枚举 CorrectionMethodTypes"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes 枚举。选择性颜色调整图层中的校正方法"
type: docs
weight: 1780
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Relative | `0` | 在相对模式下应用颜色校正。 |
| Absolute | `1` | 在绝对模式下应用颜色校正。 |
