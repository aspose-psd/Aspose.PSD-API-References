---
title: "类 ThresholdLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ThresholdLayer 类。阈值调整图层"
type: docs
weight: 1920
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/thresholdlayer/
---
{{< psd/tize >}}
...
| [Level](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/thresholdlayer/level/) { get; set; } | 获取并设置阈值级别。 |
