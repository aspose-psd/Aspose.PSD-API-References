---
title: "类 RgbChannelMixerLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer 类。Rgb 通道混合器调整图层"
type: docs
weight: 1880
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | 获取或设置一个值，指示此 [`ChannelMixerLayer`](../channelmixerlayer/) 是否为单色。 |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | 获取通道的索引。返回 RgbMixerChannel |
