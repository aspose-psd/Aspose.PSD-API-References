...
description: RGB 通道混合器调整层
type: docs
weight: 1800
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel) { get; } | 获取蓝色通道。 |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel) { get; } | 获取绿色通道。 |
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome) { get; set; } | 获取或设置一个值，该值指示是否[`ChannelMixerLayer`](../channelmixerlayer)是单色的。 |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel) { get; } | 获取红色通道。 |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex)(int) | 获取通道索引。返回 RgbMixerChannel |
