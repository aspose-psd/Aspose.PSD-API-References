...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer 班级. Rgb 通道混合器调整层
type: docs
weight: 1810
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | 获取或设置一个值，指示是否这[`ChannelMixerLayer`](../channelmixerlayer/)是单色的. |
