---
title: "类 PhotoFilterLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer 类。PhotoFilter 调整图层"
type: docs
weight: 1860
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | 获取或设置滤镜的密度。 |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | 获取或设置一个值，指示是否 [preserve luminosity]。 |
