...
description: PhotoFilter 调整图层.
type: docs
weight: 1790
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color) { get; set; } | 获取或设置滤镜的 RGB 颜色。 |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density) { get; set; } | 获取或设置过滤器的密度 |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity) { get; set; } | 获取或设置一个值，指示是否[保持亮度]. |
