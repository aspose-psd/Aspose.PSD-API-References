...
description: Vibrance调整层的实现
type: docs
weight: 1820
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
## VibranceLayer class
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation) { get; set; } | 获取或设置饱和度。 |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance) { get; set; } | 获取或设置振动。 |
