---
title: "类 SelectiveColorLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorLayer 类。选择性颜色调整图层。"
type: docs
weight: 1900
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
{{< psd/tize >}}
...
| [CorrectionMethod](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/correctionmethod/) { get; set; } | 获取或设置校正方法。 |
...
| [Version](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/version/) { get; } | 获取版本。 |
...
| [GetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/)(SelectiveColorsTypes) | 获取通过选择性颜色的 CMYK 校正。 |
...
| [SetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/)(SelectiveColorsTypes, CmykCorrection) | 设置通过选择性颜色的 CMYK 校正。 |
...
以下代码演示了对 SelectiveColorLayer 调整图层的支持。
...
// 获取、检查并更改图像中的 Selective Color 调整图层。
