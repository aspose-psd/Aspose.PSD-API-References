...
description: "SelectiveColorLayer 方法。设置通过选择颜色的 cmyk 校正"
type: docs
weight: 40
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/
---
{{< psd/tize >}}
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | 选择颜色的类型。 |
| 校正 | CmykCorrection | CMYK 校正。 |
