...
description: "SelectiveColorLayer 方法。获取通过选择颜色的 cmyk 校正"
type: docs
weight: 30
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/
---
{{< psd/tize >}}
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | 选择颜色。 |
