...
type: docs
weight: 1730
url: /zh/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused) { get; set; } | 获取或设置一个值，指示此实例是否被连续管理器使用。 |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused) { get; set; } | 获取或设置一个值，该值指示此实例是否被离散管理器使用。 |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager)() | 获取曲线管理器。 |
