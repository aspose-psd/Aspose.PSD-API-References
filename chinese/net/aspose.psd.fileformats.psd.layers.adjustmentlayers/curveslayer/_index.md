...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer 班级. 曲线调整图层
type: docs
weight: 1730
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | 获取或设置一个值，该值指示此实例是否被连续管理器使用。 |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | 获取或设置一个值，该值指示此实例是否使用离散管理器。 |
