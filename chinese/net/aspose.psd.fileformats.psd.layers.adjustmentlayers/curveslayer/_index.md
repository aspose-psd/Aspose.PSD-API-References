...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer 类。曲线调整图层"
type: docs
weight: 1790
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | 获取或设置一个值，指示此实例是否使用连续管理器。 |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | 获取或设置一个值，指示此实例是否使用离散管理器。 |
