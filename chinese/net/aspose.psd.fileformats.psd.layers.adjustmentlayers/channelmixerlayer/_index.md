...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer 班级. 通道混合器调整层
type: docs
weight: 1690
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | 获取或设置一个值，指示是否这`ChannelMixerLayer`是单色的. |
