...
description: 命名空间是嵌套命名空间的核心也是用于Aspose.PSD处理的最基本的对象
type: docs
weight: 10
url: /zh/net/aspose.psd/
---
命名空间是嵌套命名空间的核心，也是用于Aspose.PSD处理的最基本的对象。
...
| [Cache](./cache) | 包含缓存设置。 |
| [CmykColorHelper](./cmykcolorhelper) | 使用 CMYK 颜色的辅助方法，以带符号的 32 位整数值表示。 提供与[`CmykColor`](../aspose.psd/cmykcolor)struct. 它更轻量级，因为 CMYK 颜色显示为 Int32，而不是具有内部字段的结构。 请尽可能使用此类的静态方法，而不是弃用的 [`CmykColor`](../aspose.psd/cmykcolor) struct. |
| [ColorBlend](./colorblend) | 定义用于在多色渐变中插值颜色混合的颜色和位置数组。这个类不能被继承。 |
| [ColorMap](./colormap) | 定义用于转换颜色的贴图。的几种方法[`ImageAttributes`](../aspose.psd/imageattributes)类通过使用颜色重映射表来调整图像颜色，该表是一个数组[`ColorMap`](../aspose.psd/colormap)结构。不可继承。 |
| [ColorMatrix](./colormatrix) | 定义一个 5 x 5 矩阵，其中包含 RGBA 空间的坐标。的几种方法[`ImageAttributes`](../aspose.psd/imageattributes)类使用颜色矩阵调整图像颜色。这个类不能被继承。 |
...
| [ImageAttributes](./imageattributes) | 一个[`ImageAttributes`](../aspose.psd/imageattributes)对象包含有关在渲染过程中如何操作位图和元文件颜色的信息。一个[`ImageAttributes`](../aspose.psd/imageattributes)对象维护几个颜色调整设置，包括颜色调整矩阵、灰度调整矩阵、伽马校正值、颜色映射表和颜色阈值。在渲染过程中，颜色可以被校正、变暗、变亮和去除。要应用此类操作，请初始化[`ImageAttributes`](../aspose.psd/imageattributes)对象并通过它的路径[`ImageAttributes`](../aspose.psd/imageattributes)对象（连同一个路径[`Image`](../aspose.psd/image) 到 DrawImage 方法。 |
...
| [ColorMatrixFlag](./colormatrixflag) | 指定将受图像的颜色和灰度调整设置影响的图像类型和颜色[`ImageAttributes`](../aspose.psd/imageattributes) . |
...
| [DashStyle](./dashstyle) | 指定虚线的样式[`Pen`](../aspose.psd/pen)对象. |
...
| [LineCap](./linecap) | 指定可用的帽子样式，[`Pen`](../aspose.psd/pen)对象可以结束一行。 |
| [LineJoin](./linejoin) | 指定如何连接图形（子路径）中的连续直线或曲线段[`GraphicsPath`](../aspose.psd/graphicspath)对象. |
| [MatrixOrder](./matrixorder) | 指定矩阵变换操作的顺序。 |
| [PdfComplianceVersion](./pdfcomplianceversion) | 指定输出文件的 PDF 合规级别。 |
| [PenAlignment](./penalignment) | 指定对齐方式[`Pen`](../aspose.psd/pen)相对于理论的零宽度线的对象。 |
| [PenType](./pentype) | 指定填充类型[`Pen`](../aspose.psd/pen)对象用于填充线条。 |
...
| [SeekOrigin](./seekorigin) | 提供代表参考点的字段[`StreamContainer`](../aspose.psd/streamcontainer)寻求. |
