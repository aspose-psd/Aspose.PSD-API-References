...
description: "Graphics 方法。使用指定图像的原始物理尺寸在指定位置绘制。"
type: docs
weight: 240
...
| rect | Rectangle | [`Rectangle`](../../rectangle/) 指定绘制图像的左上角。矩形的 X 和 Y 属性指定左上角。Width 和 Height 属性被忽略。 |
...
| --- | --- | --- |
| sourceImage | Image | 要绘制的图像。 |
| point | Point | [`Point`](../../point/) 结构，指定绘制图像左上角。 |
