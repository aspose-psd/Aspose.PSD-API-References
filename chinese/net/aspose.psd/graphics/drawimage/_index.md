...
description: "Graphics 方法。使用原始物理尺寸在指定位置绘制指定的 Image。"
type: docs
weight: 230
...
在指定位置绘制指定的 [`Image`](../image/)，使用其原始物理尺寸。
...
| --- | --- | --- |
| sourceImage | Image | 要绘制的图像。 |
| rect | RectangleF | [`RectangleF`](../../rectanglef/) 结构，指定绘制图像的位置和尺寸。 |
...
| --- | --- | --- |
| image | Image | 要绘制的图像。 |
| destPoints | Point[] | 由三个 PointF 结构定义的平行四边形数组。 |
...
| --- | --- | --- |
| image | Image | 要绘制的图像。 |
| destPoints | PointF[] | 由三个 PointF 结构定义的平行四边形数组。 |
...
| --- | --- | --- |
| sourceImage | Image | 要绘制的图像。 |
| point | Point | [`Point`](../../point/) 结构表示绘制图像左上角的位置。 |
...
| --- | --- | --- |
| sourceImage | Image | 要绘制的图像。 |
| rect | Rectangle | [`Rectangle`](../../rectangle/) 结构指定绘制图像的位置和大小。 |
