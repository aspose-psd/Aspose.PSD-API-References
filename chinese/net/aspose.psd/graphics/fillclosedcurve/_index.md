...
使用指定的填充模式，填充由 [`PointF`](../../pointf/) 结构数组定义的闭合基数样条曲线的内部。此方法使用默认张力 0.5。
...
| brush | Brush | [`Brush`](../../brush/) 决定填充的特性。 |
| points | PointF[] | 定义样条的 [`PointF`](../../pointf/) 结构数组。 |
| fillmode | FillMode | [`FillMode`](../../fillmode/) 枚举的成员，决定曲线的填充方式。 |
...
使用指定的填充模式和张力，填充由 [`PointF`](../../pointf/) 结构数组定义的闭合基数样条曲线的内部。
...
使用指定的填充模式，填充由 [`Point`](../../point/) 结构数组定义的闭合基数样条曲线的内部。此方法使用默认张力 0.5。
...
使用指定的填充模式和张力，填充由 [`Point`](../../point/) 结构数组定义的闭合基数样条曲线的内部。
