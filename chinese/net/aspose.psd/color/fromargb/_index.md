...
description: 从 32 位 ARGB 值创建Coloraspose.psd/color结构
type: docs
weight: 1430
...
从指定的[`Color`](../../color)结构创建[`Color`](../../color)结构，但使用新指定的阿尔法值。尽管此方法允许为 alpha 值传递 32 位值，但该值被限制为 8 位。
...
| baseColor | Color | [`Color`](../../color)从中创建新的PSD。颜色。 |
