...
| [IsCreated](../../aspose.psd/filestreamcontainer/iscreated) { get; } | 获取一个值，该值指示是否显式创建了流。 |
...
| [explicit operator](../../aspose.psd/filestreamcontainer/op_explicit#op_explicit_1) | 执行从[`FileStreamContainer`](../filestreamcontainer)到Stream的显式转换。 (2 operators) |
