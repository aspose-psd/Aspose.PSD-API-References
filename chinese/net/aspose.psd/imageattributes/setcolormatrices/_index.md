...
type: docs
weight: 130
url: /zh/net/aspose.psd/imageattributes/setcolormatrices/
---
...
| newColorMatrix | ColorMatrix | 颜色调整矩阵。 |
| grayMatrix | ColorMatrix | 灰度调整矩阵。 |
| flags | ColorMatrixFlag | [`ColorMatrixFlag`](../../colormatrixflag)的一个元素，指定将受颜色调整和灰度影响的图像和颜色的类型-调整矩阵。 |
...
| newColorMatrix | ColorMatrix | 颜色调整矩阵。 |
| grayMatrix | ColorMatrix | 灰度调整矩阵。 |
| mode | ColorMatrixFlag | [`ColorMatrixFlag`](../../colormatrixflag)的一个元素，指定将受颜色调整和灰度影响的图像和颜色的类型-调整矩阵。 |
| type | ColorAdjustType | [`ColorAdjustType`](../../coloradjusttype)的一个元素，指定颜色调整和灰度调整矩阵所设置的类别。 |
