...
初始化一个使用指定的现有 [`Font`](../) 和 [`FontStyle`](../../fontstyle/) 枚举的新 [`Font`](../)。
...
| newStyle | FontStyle | 要应用于新 [`Font`](../) 的 [`FontStyle`](../../fontstyle/)。可以使用 OR 运算符组合多个 [`FontStyle`](../../fontstyle/) 枚举值。 |
