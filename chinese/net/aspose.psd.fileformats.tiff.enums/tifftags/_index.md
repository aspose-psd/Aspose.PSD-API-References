...
| T4Options | `292` | GROUP3OPTIONS 的 TIFF 6.0 专有名称别名。 CCITT Group 3 传真编码选项。 32 个标志位。 |
| T6Options | `293` | CCITT Group 4 传真编码选项。 32 个标志位。 GROUP4OPTIONS 的 TIFF 6.0 专有名称别名。 |
| ResolutionUnit | `296` | 分辨率单位。 |
| PageNumber | `297` | 多页的页码。 |
| ColorResponseUnit | `300` | [已被 TIFF rev.淘汰。 6.0]&lt;br /&gt; 颜色曲线准确度。 |
...
| ConsecutiveBadFaxLines | `328` | 最多连续坏行。 |
| SubIfd | `330` | 子图像描述符。 |
| InkSet | `332` | 分离图像中的墨水。 |
...
| JpegInterchangeFormatLength | `514` | [被技术说明 #2 废弃，它指定了一个修订的 JPEG-in-TIFF 方案]&lt;br /&gt; JFIF 流长度 |
| JpegRestartInterval | `515` | [已被技术说明 #2 废弃，该说明指定了修订的 JPEG-in-TIFF 方案]&lt;br /&gt; 重新启动间隔长度。 |
| JpegLosslessPredictors | `517` | [被技术说明 #2 废弃，它指定了一个修订的 JPEG-in-TIFF 方案]&lt;br /&gt; 无损 proc 预测器。 |
| JpegPointTransform | `518` | [已被技术说明 #2 废弃，该说明指定了修订后的 JPEG-in-TIFF 方案]&lt;br /&gt; 无损点变换。 |
| JpegQTables | `519` | [被技术说明 #2 废弃，它指定了一个修订的 JPEG-in-TIFF 方案]&lt;br /&gt; Q 矩阵偏移。 |
| JpegDCtables | `520` | [已被技术说明 #2 废弃，该说明指定了修订后的 JPEG-in-TIFF 方案]&lt;br /&gt; DCT 表偏移量。 |
| JpegACtables | `521` | [被技术说明 #2 废弃，它指定了一个修订的 JPEG-in-TIFF 方案]&lt;br /&gt; AC 系数偏移。 |
