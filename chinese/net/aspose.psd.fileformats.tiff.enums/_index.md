...
| 枚举 | 描述 |
| --- | --- |
| [Group3Options](./group3options) | CCITT Group 3/4 传真编码选项。&lt;br /&gt; GROUP3OPTIONS / TiffTag.T4OPTIONS 和 TiffTag.GROUP4OPTIONS / TiffTag 的可能值。 T6OPTIONS 标签。 |
...
| [TiffFillOrders](./tifffillorders) | 一个字节内的数据顺序。&lt;br /&gt; FILLORDER 标记的可能值。 |
...
| [TiffPlanarConfigs](./tiffplanarconfigs) | 存储组织。&lt;br /&gt; PLANARCONFIG 标记的可能值。 |
