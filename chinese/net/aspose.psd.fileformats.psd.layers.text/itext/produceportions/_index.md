...
description: IText 方法. 使用输入或默认参数生成新部分
type: docs
weight: 70
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| portionsOfText | String[] | 要新建的文本部分[`ITextPortion`](../../itextportion/). |
| stylePrototype | ITextStyle | 一种样式，如果不为空，将应用于新的，否则将默认。 |
| paragraphPrototype | ITextParagraph | 一个段落，如果不为空，将应用于新的，否则将默认。 |
