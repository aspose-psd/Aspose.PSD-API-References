...
| 命名空间 | 描述 |
| --- | --- |
| [Aspose.PSD](./aspose.psd) | 命名空间是嵌套命名空间的核心，也是用于Aspose.PSD处理的最基本的对象。 |
| [Aspose.PSD.AsyncTask](./aspose.psd.asynctask) | 命名空间处理 AsyncTask 处理。 |
| [Aspose.PSD.Brushes](./aspose.psd.brushes) | 命名空间提供了辅助类和方法来处理不同的画笔类型。 |
| [Aspose.PSD.CoreExceptions](./aspose.psd.coreexceptions) | 命名空间包含任何核心 PSD 组件引发的异常。 |
| [Aspose.PSD.CoreExceptions.Compressors](./aspose.psd.coreexceptions.compressors) | 命名空间包含由支持的压缩算法之一引发的异常。 |
| [Aspose.PSD.CoreExceptions.ImageFormats](./aspose.psd.coreexceptions.imageformats) | 命名空间包含由支持的文件格式之一引发的异常。 |
| [Aspose.PSD.Dithering](./aspose.psd.dithering) | 命名空间为颜色抖动提供了不同的帮助类。 |
...
| [Aspose.PSD.FileFormats.Jpeg](./aspose.psd.fileformats.jpeg) | 命名空间处理Jpeg文件格式处理。 |
...
| [Aspose.PSD.FileFormats.Psd.Layers](./aspose.psd.fileformats.psd.layers) | 命名空间包含 PSD 文件格式层。 |
...
| [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](./aspose.psd.fileformats.psd.layers.filllayers) | 命名空间包含填充层 |
| [Aspose.PSD.FileFormats.Psd.Layers.FillSettings](./aspose.psd.fileformats.psd.layers.fillsettings) | 命名空间包含填充层设置 |
| [Aspose.PSD.FileFormats.Psd.Layers.LayerEffects](./aspose.psd.fileformats.psd.layers.layereffects) | 命名空间包含图层效果包装器 |
...
| [Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures](./aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures) | 命名空间包含PSD文件格式类型的工具资源实体。 |
...
| [Aspose.PSD.FileFormats.Psd.Layers.SmartObjects](./aspose.psd.fileformats.psd.layers.smartobjects) | 命名空间包含用于操作智能对象层数据的 API |
...
| [Aspose.PSD.FileFormats.Psd.Resources.ResolutionEnums](./aspose.psd.fileformats.psd.resources.resolutionenums) | 命名空间处理 Psd 资源解析单位 |
...
| [Aspose.PSD.ImageOptions](./aspose.psd.imageoptions) | 命名空间包含适合导出、保存或创建不同文件格式的类。 |
...
| [Aspose.PSD.Xmp.Schemas.Pdf](./aspose.psd.xmp.schemas.pdf) | 命名空间包含与 Adobe PDF 文档一起使用的相关帮助类、常量和方法。 |
| [Aspose.PSD.Xmp.Schemas.Photoshop](./aspose.psd.xmp.schemas.photoshop) | 命名空间包含 Adobe Photoshop 使用的相关帮助程序类、常量和方法。 |
| [Aspose.PSD.Xmp.Schemas.XmpBaseSchema](./aspose.psd.xmp.schemas.xmpbaseschema) | 命名空间包含与 XMP 基本模式相关的帮助类、常量和提供基本描述信息的方法。 |
| [Aspose.PSD.Xmp.Schemas.XmpDm](./aspose.psd.xmp.schemas.xmpdm) | 命名空间包含 Adobe 动态媒体组使用的 XMP 相关帮助程序类、常量和方法。 |
| [Aspose.PSD.Xmp.Schemas.XmpMm](./aspose.psd.xmp.schemas.xmpmm) | 命名空间包含主要由数字资产管理 (DAM) 系统使用的相关帮助程序类、常量和方法。 |
| [Aspose.PSD.Xmp.Schemas.XmpRm](./aspose.psd.xmp.schemas.xmprm) | 命名空间包含与权限管理帮助程序类、常量和方法相关的内容。 这些属性指定有关与资源相关的法律限制的信息。 |
| [Aspose.PSD.Xmp.Types](./aspose.psd.xmp.types) | 命名空间包含表示 XMP 属性值的类，它们分为三个基本类别：基本类型、 复杂类型和派生类型。 |
...
| [Aspose.PSD.Xmp.Types.Complex.Colorant](./aspose.psd.xmp.types.complex.colorant) | 命名空间包含的类表示包含文档中使用的着色剂（样本）特征的结构。 |
| [Aspose.PSD.Xmp.Types.Complex.Dimensions](./aspose.psd.xmp.types.complex.dimensions) | 命名空间包含的类代表包含绘制对象尺寸的结构。 |
| [Aspose.PSD.Xmp.Types.Complex.Font](./aspose.psd.xmp.types.complex.font) | 命名空间包含的类代表包含文档中使用的字体特征的结构。 |
| [Aspose.PSD.Xmp.Types.Complex.ResourceEvent](./aspose.psd.xmp.types.complex.resourceevent) | 命名空间包含的类是在处理此文档时发生的高级事件。 |
| [Aspose.PSD.Xmp.Types.Complex.ResourceRef](./aspose.psd.xmp.types.complex.resourceref) | 命名空间包含的类是对资源的多部分引用。 用于表示以前的版本、翻译的原件、派生文档的原件等。 |
