...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.ObjectArrayStructure 班级. 定义通常持有的 ObjectArrayStructure 类UnitArrayStructurearray. 用于PSD文件资源如PlLd Resource和SoLd Resource.
type: docs
weight: 3200
...
| 姓名 | 描述 |
| --- | --- |
| [ObjectArrayStructure](objectarraystructure/#constructor_1)(string, string, OSTypeStructure[]) | 初始化一个新的实例`ObjectArrayStructure`类. |
| [ObjectArrayStructure](objectarraystructure/#constructor)(int, ClassID, ClassID, string, OSTypeStructure[]) | 初始化一个新的实例`ObjectArrayStructure`类. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/key/) { get; } | 获取对象数组结构key. |
