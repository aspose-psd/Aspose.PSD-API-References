...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.UnknownStructure 班级. 未知结构
type: docs
weight: 3300
...
| 姓名 | 描述 |
| --- | --- |
| [UnknownStructure](unknownstructure/)(ClassID, int) | 初始化一个新的实例`UnknownStructure`类. |
