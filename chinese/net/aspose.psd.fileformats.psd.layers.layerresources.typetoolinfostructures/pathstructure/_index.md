...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.PathStructure 班级. 路径结构
type: docs
weight: 3220
...
| 姓名 | 描述 |
| --- | --- |
| [PathStructure](pathstructure/)(ClassID) | 初始化一个新的实例`PathStructure`类. |
