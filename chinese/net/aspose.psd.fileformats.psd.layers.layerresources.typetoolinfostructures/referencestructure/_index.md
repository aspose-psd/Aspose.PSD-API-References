...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.ReferenceStructure 班级. 参考结构
type: docs
weight: 3250
...
| 姓名 | 描述 |
| --- | --- |
| [ReferenceStructure](referencestructure/)(ClassID) | 初始化一个新的实例`ReferenceStructure`类. |
