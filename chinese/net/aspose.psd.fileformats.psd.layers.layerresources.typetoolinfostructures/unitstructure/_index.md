...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.UnitStructure 班级. 单元结构
type: docs
weight: 3280
...
| 姓名 | 描述 |
| --- | --- |
| [UnitStructure](unitstructure/)(ClassID) | 初始化一个新的实例`UnitStructure`类. |
