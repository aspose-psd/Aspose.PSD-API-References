...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.IntegerStructure 班级. 整数结构
type: docs
weight: 3180
...
| 姓名 | 描述 |
| --- | --- |
| [IntegerStructure](integerstructure/)(ClassID) | 初始化一个新的实例`IntegerStructure`类. |
