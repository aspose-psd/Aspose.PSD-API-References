...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures.AliasStructure 班级. 别名结构
type: docs
weight: 3110
...
| 姓名 | 描述 |
| --- | --- |
| [AliasStructure](aliasstructure/)(ClassID) | 初始化一个新的实例`AliasStructure`类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [DataLength](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/datalength/) { get; } | 获取以字节为单位的准确数据长度。 |
