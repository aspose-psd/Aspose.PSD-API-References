...
description: 命名空间包含任何核心 PSD 组件引发的异常
type: docs
weight: 40
url: /zh/net/aspose.psd.coreexceptions/
---
命名空间包含任何核心 PSD 组件引发的异常。
...
| [FrameworkException](./frameworkexception) | PSD 框架异常。该类是所有Aspose.PSD异常的核心类。 引入以区分Aspose.PSD引擎抛出的异常和所有其他异常类型。 |
