...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeBoundingBox 班级. 定义矢量形状边界框类
type: docs
weight: 1430
...
| [QuadVersion](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/quadversion/) { get; set; } | 获取或设置单位值 quad version. |
