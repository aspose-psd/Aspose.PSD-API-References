...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerEffects.InnerShadowEffect 班级. 内阴影层效果
type: docs
weight: 2160
...
| 姓名 | 描述 |
| --- | --- |
| [Angle](../../aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/angle/) { get; set; } | 获取或设置角度（以度为单位）。 |
...
| [Distance](../../aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/distance/) { get; set; } | 获取或设置以像素为单位的距离。 |
...
| [Spread](../../aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/spread/) { get; set; } | 获取或设置以百分比表示的传播（阻塞）。 |
