...
description: Aspose.PSD.ImageOptions.TiffOptions 班级. tiff 文件格式选项 请注意宽度和高度标签将在图像创建时被宽度和高度参数覆盖因此无需直接指定它们 请注意许多选项返回默认值但这并不意味着此选项明确设置为标记值要验证标签是否存在请使用 Tags 属性或相应的 IsTagPresent 方法
type: docs
weight: 4940
...
| 姓名 | 描述 |
| --- | --- |
| [TiffOptions](tiffoptions/#constructor_2)(TiffDataType[]) | 初始化一个新的实例`TiffOptions`类. |
| [TiffOptions](tiffoptions/#constructor)(TiffExpectedFormat) | 初始化一个新的实例`TiffOptions`班级。默认情况下使用小端约定。 |
| [TiffOptions](tiffoptions/#constructor_3)(TiffOptions) | 初始化一个新的实例`TiffOptions`类. |
| [TiffOptions](tiffoptions/#constructor_1)(TiffExpectedFormat, TiffByteOrder) | 初始化一个新的实例`TiffOptions`类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AlphaStorage](../../aspose.psd.imageoptions/tiffoptions/alphastorage/) { get; set; } | 获取或设置 alpha 存储选项。以外的选项Unspecified 超过 3 个时使用[`SamplesPerPixel`](./samplesperpixel/)定义. |
| [Artist](../../aspose.psd.imageoptions/tiffoptions/artist/) { get; set; } | 获取或设置艺术家。 |
| [BitsPerPixel](../../aspose.psd.imageoptions/tiffoptions/bitsperpixel/) { get; } | 获取每像素的位数。 |
...
| [ByteOrder](../../aspose.psd.imageoptions/tiffoptions/byteorder/) { get; set; } | 获取或设置一个指示 tiff 字节顺序的值。 |
...
| [IsExtraSamplesPresent](../../aspose.psd.imageoptions/tiffoptions/isextrasamplespresent/) { get; } | 获取指示额外样本是否存在的值。 |
| [IsTiled](../../aspose.psd.imageoptions/tiffoptions/istiled/) { get; } | 获取表示图像是否平铺的值。 |
| [IsValid](../../aspose.psd.imageoptions/tiffoptions/isvalid/) { get; } | 获取一个值，表示是否`TiffOptions`已正确配置。使用 Validate 方法查找失败原因. |
...
| [PageNumber](../../aspose.psd.imageoptions/tiffoptions/pagenumber/) { get; set; } | 获取或设置页码标记。 |
...
| [SmaxSampleValue](../../aspose.psd.imageoptions/tiffoptions/smaxsamplevalue/) { get; set; } | 获取或设置最大样本值。该值具有与样本数据最匹配的字段类型（字节、短型或长型）。 |
| [SminSampleValue](../../aspose.psd.imageoptions/tiffoptions/sminsamplevalue/) { get; set; } | 获取或设置最小样本值。该值具有与样本数据最匹配的字段类型（字节、短型或长型）。 |
...
| [ValidTagCount](../../aspose.psd.imageoptions/tiffoptions/validtagcount/) { get; } | 获取有效标签计数。这不是标签总数，而是可以保留的标签数。 |
...
| [XPAuthor](../../aspose.psd.imageoptions/tiffoptions/xpauthor/) { get; set; } | 获取或设置图像作者，Windows 资源管理器使用。 |
| [XPComment](../../aspose.psd.imageoptions/tiffoptions/xpcomment/) { get; set; } | 获取或设置 Windows 资源管理器使用的图像注释。 |
| [XPKeywords](../../aspose.psd.imageoptions/tiffoptions/xpkeywords/) { get; set; } | 获取或设置 Windows 资源管理器使用的主题图像。 |
| [Xposition](../../aspose.psd.imageoptions/tiffoptions/xposition/) { get; set; } | 获取或设置 x 位置。 |
| [XPSubject](../../aspose.psd.imageoptions/tiffoptions/xpsubject/) { get; set; } | 获取或设置 Windows 资源管理器使用的图像信息。 |
| [XPTitle](../../aspose.psd.imageoptions/tiffoptions/xptitle/) { get; set; } | 获取或设置 Windows 资源管理器使用的图像信息。 |
...
| [YCbCrSubsampling](../../aspose.psd.imageoptions/tiffoptions/ycbcrsubsampling/) { get; set; } | 获取或设置 YCbCr 光度学的子采样因子。 |
...
| 姓名 | 描述 |
| --- | --- |
| [AddTag](../../aspose.psd.imageoptions/tiffoptions/addtag/)(TiffDataType) | 添加新标签。 |
...
| [IsTagPresent](../../aspose.psd.imageoptions/tiffoptions/istagpresent/)(TiffTags) | 确定标签是否出现在选项中。 |
| [RemoveTag](../../aspose.psd.imageoptions/tiffoptions/removetag/)(TiffTags) | 删除标签。 |
| [Validate](../../aspose.psd.imageoptions/tiffoptions/validate/)() | 验证选项是否具有有效的 tags 组合 |
