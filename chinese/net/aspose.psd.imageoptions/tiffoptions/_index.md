...
| 姓名 | 描述 |
| --- | --- |
| [AlphaStorage](../../aspose.psd.imageoptions/tiffoptions/alphastorage) { get; set; } | 获取或设置 alpha 存储选项。Unspecified 以外的选项在SamplesPerPixel已定义。 |
...
| [ByteOrder](../../aspose.psd.imageoptions/tiffoptions/byteorder) { get; set; } | 获取或设置一个表示 tiff 字节顺序的值。 |
...
| [IsTiled](../../aspose.psd.imageoptions/tiffoptions/istiled) { get; } | 获取一个值，该值指示图像是否平铺。 |
| [IsValid](../../aspose.psd.imageoptions/tiffoptions/isvalid) { get; } | 获取一个值，该值指示[`TiffOptions`](../tiffoptions)是否已正确配置。使用 Validate 方法查找失败原因。 |
...
| [StripOffsets](../../aspose.psd.imageoptions/tiffoptions/stripoffsets) { get; set; } | 获取或设置条偏移。 |
...
| [TileByteCounts](../../aspose.psd.imageoptions/tiffoptions/tilebytecounts) { get; set; } | 获取或设置切片字节数。 |
| [TileLength](../../aspose.psd.imageoptions/tiffoptions/tilelength) { get; set; } | 获取 ot 设置图块长度。 |
| [TileOffsets](../../aspose.psd.imageoptions/tiffoptions/tileoffsets) { get; set; } | 获取或设置平铺偏移。 |
| [TileWidth](../../aspose.psd.imageoptions/tiffoptions/tilewidth) { get; set; } | 获取 ot 设置平铺宽度。 |
...
| [XPAuthor](../../aspose.psd.imageoptions/tiffoptions/xpauthor) { get; set; } | 获取或设置图片作者，供 Windows 资源管理器使用。 |
| [XPComment](../../aspose.psd.imageoptions/tiffoptions/xpcomment) { get; set; } | 获取或设置图像的注释，供 Windows 资源管理器使用。 |
| [XPKeywords](../../aspose.psd.imageoptions/tiffoptions/xpkeywords) { get; set; } | 获取或设置主题图像，供 Windows 资源管理器使用。 |
| [Xposition](../../aspose.psd.imageoptions/tiffoptions/xposition) { get; set; } | 获取或设置 x 位置。 |
| [XPSubject](../../aspose.psd.imageoptions/tiffoptions/xpsubject) { get; set; } | 获取或设置图像信息，供 Windows 资源管理器使用。 |
| [XPTitle](../../aspose.psd.imageoptions/tiffoptions/xptitle) { get; set; } | 获取或设置图像信息，供 Windows 资源管理器使用。 |
...
| [RemoveTag](../../aspose.psd.imageoptions/tiffoptions/removetag)(TiffTags) | 删除标记。 |
