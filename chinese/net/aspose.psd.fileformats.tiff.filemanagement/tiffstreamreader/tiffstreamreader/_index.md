...
description: "TiffStreamReader 构造函数。初始化 TiffStreamReader 类的新实例"
type: docs
weight: 10
url: /zh/net/aspose.psd.fileformats.tiff.filemanagement/tiffstreamreader/tiffstreamreader/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| 数据 | Byte[] | 字节数组数据。 |
| startIndex | Int32 | 进入 *data* 的起始索引。 |
