...
description: Aspose.PSD.Xmp.Types.Complex.ResourceEvent.ResourceEvent 班级. 包含绘制对象的尺寸
type: docs
weight: 6080
...
| 姓名 | 描述 |
| --- | --- |
| [Action](../../aspose.psd.xmp.types.complex.resourceevent/resourceevent/action/) { get; set; } | 获取或设置操作。 |
| [ActionDate](../../aspose.psd.xmp.types.complex.resourceevent/resourceevent/actiondate/) { get; set; } | 获取或设置操作日期。 |
| [Changed](../../aspose.psd.xmp.types.complex.resourceevent/resourceevent/changed/) { get; set; } | 获取或设置自上次事件历史以来更改的资源部分的分号分隔列表。 |
...
| [Parameters](../../aspose.psd.xmp.types.complex.resourceevent/resourceevent/parameters/) { get; set; } | 获取或设置动作的附加说明。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.types.complex.resourceevent/resourceevent/getxmprepresentation/)() | 获取包含 XMP 格式的字符串值。 |
