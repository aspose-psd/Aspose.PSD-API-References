...
description: Aspose.PSD.Brushes.HatchBrush 班级. 定义具有填充样式前景色和背景色的矩形画笔此类不能被继承
type: docs
weight: 130
...
| [HatchStyle](../../aspose.psd.brushes/hatchbrush/hatchstyle/) { get; set; } | 获取或设置此笔刷的填充样式。 |
