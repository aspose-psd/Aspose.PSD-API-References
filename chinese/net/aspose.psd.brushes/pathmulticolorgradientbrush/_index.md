...
description: "Aspose.PSD.Brushes.PathMulticolorGradientBrush 类。封装具有渐变的 Brush 对象。此类不可被继承。"
type: docs
weight: 190
...
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor_2)(PointF[], WrapMode) | 使用指定的点和换行模式初始化 `PathMulticolorGradientBrush` 类的新实例。 |
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor_4)(Point[], WrapMode) | 使用指定的点和换行模式初始化 `PathMulticolorGradientBrush` 类的新实例。 |
...
| [InterpolationColors](../../aspose.psd.brushes/pathmulticolorgradientbrush/interpolationcolors/) { get; set; } | 获取或设置一个定义多色线性渐变的 [`ColorBlend`](../../aspose.psd/colorblend/)。 |
