---
title: "类 AddNoiseSmartFilter"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.AddNoiseSmartFilter 类。AddNoise 智能滤镜"
type: docs
weight: 3830
...
| 名称 | 描述 |
| --- | --- |
| [AddNoiseSmartFilter](addnoisesmartfilter/)() | 初始化 `AddNoiseSmartFilter` 类的新实例。 |

## 属性

| 名称 | 描述 |
| --- | --- |
| [AmountNoise](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/amountnoise/) { get; set; } | 获取或设置噪声值的数量。 |
| [BlendMode](../../aspose.psd.fileformats.psd.layers.smartfilters/smartfilter/blendmode/) { get; set; } | 获取或设置混合模式。 |
| [Distribution](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/distribution/) { get; set; } | 获取或设置噪声滤镜的分布。 |
...
| [IsMonochromatic](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/ismonochromatic/) { get; set; } | 获取或设置单色的值。 |
