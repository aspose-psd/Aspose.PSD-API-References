...
| [SetIccProfile](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/seticcprofile)(string) | 设置 icc 配置文件。 |
| [SetInstructions](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/setinstructions)(string) | 设置指令。 |
| [SetSource](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/setsource)(string) | 设置源。 |
| [SetState](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/setstate)(string) | 设置状态。 |
| [SetSupplementalCategories](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/setsupplementalcategories)(string[]) | 设置补充类别。 |
| [SetTransmissionReference](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/settransmissionreference)(string) | 设置传输参考。 |
| [SetUrgency](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/seturgency)(int) | 设置紧急程度。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [UrgencyMax](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/urgencymax) | 紧急最大值。 |
| const [UrgencyMin](../../aspose.psd.xmp.schemas.photoshop/photoshoppackage/urgencymin) | 紧急最小值。 |
