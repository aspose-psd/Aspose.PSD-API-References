---
title: "类 BaseGradient"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient 类。 基础渐变定义类。 它包含两种渐变类型（Solid 和 Noise）的公共属性"
type: docs
weight: 2190
url: /zh/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| 名称 | 描述 |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | 获取此渐变的模式。确定 “Gradient Type” = “Solid/Noise”（0/1）。 |
