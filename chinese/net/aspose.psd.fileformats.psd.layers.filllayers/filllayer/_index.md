...
description: 填充层颜色填充渐变填充或图案填充层其不同之处在于FillSettings./filllayer/fillsettings
type: docs
weight: 1850
...
填充层。颜色填充、渐变填充或图案填充层，其不同之处在于[`FillSettings`](./fillsettings)
...
| 姓名 | 描述 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | 按填充类型构建[`FillLayer`](../filllayer)类的新实例。 |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors#replacenontransparentcolors_1)(int) | 用新颜色替换所有非透明颜色并保留原始 alpha 值以保存平滑边缘。 注意：如果您在没有透明度的图像上使用它，所有颜色都将替换为一种颜色。 |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update)() | 根据实际[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings)更新填充层像素数据。 |
