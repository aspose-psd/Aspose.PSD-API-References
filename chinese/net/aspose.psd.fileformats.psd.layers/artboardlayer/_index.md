---
title: "类 ArtboardLayer"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer 类。画板图层类"
type: docs
weight: 1990
url: /zh/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | 获取或设置画板背景颜色。 |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | 获取或设置一个值，指示 `ArtboardLayer` 是否具有背景颜色。 |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | 获取或设置文件夹是否打开；如果设置为 `true`，则组在启动时为打开状态，否则为最小化状态。 |
...
以下代码演示了将 ArtboardLayer 导出为单独图像以及合并为一张图像的支持。
