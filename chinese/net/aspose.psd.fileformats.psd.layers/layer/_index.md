...
description: "Aspose.PSD.FileFormats.Psd.Layers.Layer 类。psd 图层"
type: docs
weight: 2270
...
| 名称 | 描述 |
| --- | --- |
| [Layer](layer/#constructor)() | 初始化 `Layer` 类的新实例。用于延迟初始化的构造函数。 |
| [Layer](layer/#constructor_3)(Stream) | 初始化 `Layer` 类的新实例。 |
| [Layer](layer/#constructor_1)(RasterImage, bool) | 初始化 `Layer` 类的新实例。 |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | 从字节数组初始化 `Layer` 类的新实例。 |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | 将对象的数据保存到指定的流。 |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | 根据保存选项，将对象的数据以指定的文件格式保存到指定的文件位置。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | 根据保存选项，将图像的数据以指定的文件格式保存到指定的流中。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | 根据保存选项，将对象的数据以指定的文件格式保存到指定的文件位置。 |
...
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | 图层头部大小。 |
