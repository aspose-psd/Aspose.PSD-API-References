...
type: docs
weight: 2060
url: /zh/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| 姓名 | 描述 |
| --- | --- |
| [Layer](layer#constructor)() | 初始化[`Layer`](../layer)班级。延迟初始化的构造函数. |
| [Layer](layer#constructor_3)(Stream) | 初始化[`Layer`](../layer)类. |
| [Layer](layer#constructor_1)(RasterImage, bool) | 初始化[`Layer`](../layer)类. |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | 初始化[`Layer`](../layer)来自字节数组的类。 |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save#save_7)(string, bool) | 将对象的数据保存到指定的文件位置。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save#save_5)(string, ImageOptionsBase) | 根据保存选项将对象的数据以指定的文件格式保存到指定的文件位置。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save#save_3)(Stream, ImageOptionsBase, Rectangle) | 根据保存选项将图像的数据以指定的文件格式保存到指定的流中。 |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save#save_6)(string, ImageOptionsBase, Rectangle) | 根据保存选项将对象的数据以指定的文件格式保存到指定的文件位置。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature) | 表示混合模式签名。 |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize) | 层头大小。 |
