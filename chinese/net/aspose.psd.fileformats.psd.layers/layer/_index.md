...
| 姓名 | 描述 |
| --- | --- |
| [Layer](layer#constructor)() | 初始化[`Layer`](../layer)类的新实例。延迟初始化的构造函数。 |
| [Layer](layer#constructor_3)(Stream) | 初始化[`Layer`](../layer)类的新实例。 |
| [Layer](layer#constructor_1)(RasterImage, bool) | 初始化[`Layer`](../layer)类的新实例。 |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | 从字节数组初始化[`Layer`](../layer)类的新实例。 |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save#save_3)(Stream, ImageOptionsBase, Rectangle) | 根据保存选项，将图像数据以指定的文件格式保存到指定的流中。 |
