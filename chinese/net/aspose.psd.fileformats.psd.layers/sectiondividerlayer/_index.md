...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer 班级. 用于标记文件夹图层组边界的部分分隔层
type: docs
weight: 3410
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | 获取一个值，指示此实例是否在组中可见（如果图层不在组中，则表示根组）。 |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | 获取[`LayerGroup`](../layergroup/)与此有关`SectionDividerLayer`实例. |
