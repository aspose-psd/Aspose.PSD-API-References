...
description: 用于标记文件夹图层组边界的部分分隔层
type: docs
weight: 3350
url: /zh/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
## SectionDividerLayer class

用于标记文件夹（图层组）边界的部分分隔层。
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup) { get; } | 获取一个值，指示此实例在组中是否可见（如果图层不在组中，则表示根组）。 |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup)() | 获取[`LayerGroup`](../layergroup)与此有关[`SectionDividerLayer`](../sectiondividerlayer)实例. |
