...
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer 类。形状图层。封装了对形状图层及相关资源的工作逻辑。"
type: docs
weight: 3820
url: /zh/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

形状图层。封装了对形状图层及相关资源的操作逻辑。
...
| 名称 | 描述 |
| --- | --- |
| [ShapeLayer](shapelayer/)() | 初始化 `ShapeLayer` 类的新实例。所有资源均以默认状态创建。 |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | 获取或设置形状图层中形状内部区域的填充设置。 |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | 获取形状图层中存在的路径集合。 |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | 获取或设置形状的描边设置。 |
...
| 名称 | 描述 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | 创建 `ShapeLayer` 类的新实例。 |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | 根据形状图层属性更新资源。 |
