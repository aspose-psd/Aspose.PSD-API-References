...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen) { get; set; } | 获取或设置文件夹是否打开 如果设置为`真的`比组将在启动时处于打开状态，否则处于最小化状态。 |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers) { get; } | 获取图层组中的图层 |
...
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup)(string, int) | 添加图层组。 |
