...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen) { get; set; } | 获取或设置打开的文件夹 如果设置为` true` 则组将在启动时处于打开状态，否则处于最小化状态。 |
...
下面的例子演示了如何在 Aspose.PSD 中改变 LayerGroup 的可见性
