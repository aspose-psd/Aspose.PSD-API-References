...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer 班级. 文字图层类
type: docs
weight: 3560
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | 获取层的文字 |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | 调整图像大小。默认值LeftTopToLeftTop使用. |
