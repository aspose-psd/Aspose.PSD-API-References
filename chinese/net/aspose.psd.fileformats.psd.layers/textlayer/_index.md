...
description: "Aspose.PSD.FileFormats.Psd.Layers.TextLayer 类。文本图层类"
type: docs
weight: 3980
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | 获取或设置文本边界框。 |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | 获取文本的颜色。 |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | 获取文本的各部分。 |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | 获取或设置从资源中设置或获取的 Warp 参数（默认） |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | 获取文本图层的字体集合。 |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | 调整图像大小。使用默认的 LeftTopToLeftTop。 |
