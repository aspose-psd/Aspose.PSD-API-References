...
type: docs
weight: 5900
url: /zh/net/aspose.psd.xmp.types.complex.colorant/colorantcmyk/
---
## ColorantCmyk class
...
| 姓名 | 描述 |
| --- | --- |
| [Black](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/black) { get; set; } | 获取或设置黑色分量值。 |
| [ColorType](../../aspose.psd.xmp.types.complex.colorant/colorantbase/colortype) { get; set; } | 获取或设置颜色的类型。 |
| [Cyan](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/cyan) { get; set; } | 获取或设置青色分量值。 |
| [Magenta](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/magenta) { get; set; } | 获取或设置洋红色分量值。 |
...
| [Yellow](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/yellow) { get; set; } | 获取或设置黄色分量值。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/getxmprepresentation)() | 获取 XMP 格式的字符串包含的值。 |

## 字段

| 姓名 | 描述 |
| --- | --- |
| const [ColorValueMax](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/colorvaluemax) | CMYK 着色剂中的颜色最大值。 |
| const [ColorValueMin](../../aspose.psd.xmp.types.complex.colorant/colorantcmyk/colorvaluemin) | CMYK 着色剂中的颜色最小值。 |
