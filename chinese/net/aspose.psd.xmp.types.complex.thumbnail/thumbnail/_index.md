...
| [ImageBase64](../../aspose.psd.xmp.types.complex.thumbnail/thumbnail/imagebase64) { get; set; } | 获取或设置 base64 格式的图像。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.types.complex.thumbnail/thumbnail/getxmprepresentation)() | 获取 XMP 格式的字符串包含的值。 |
