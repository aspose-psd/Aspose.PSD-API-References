...
description: Aspose.PSD.FileFormats.Psd.Resources.ResolutionInfoResource 班级. 分辨率信息资源
type: docs
weight: 3880
...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/resolutioninforesource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
...
| [HResDisplayUnit](../../aspose.psd.fileformats.psd.resources/resolutioninforesource/hresdisplayunit/) { get; set; } | 水平分辨率的显示单位。这只会影响 the 用户界面；分辨率仍以像素/英寸的形式存储在 PSD 文件 中。 |
