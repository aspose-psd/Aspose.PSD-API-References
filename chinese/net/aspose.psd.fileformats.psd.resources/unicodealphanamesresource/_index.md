...
description: Aspose.PSD.FileFormats.Psd.Resources.UnicodeAlphaNamesResource 班级. Unicode alpha 名称 resource
type: docs
weight: 3930
url: /zh/net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
## UnicodeAlphaNamesResource class

Unicode alpha 名称 resource
...
| 姓名 | 描述 |
| --- | --- |
| [UnicodeAlphaNamesResource](unicodealphanamesresource/)() | 默认构造函数。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AlphaNames](../../aspose.psd.fileformats.psd.resources/unicodealphanamesresource/alphanames/) { get; set; } | 获取或设置字母名称。 |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/unicodealphanamesresource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | 获取或设置资源的唯一标识符。 |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/unicodealphanamesresource/minimalversion/) { get; } | 获取所需的最低 PSD 版本。 |
