...
description: Aspose.PSD.FileFormats.Psd.Resources.IccUntaggedResource 班级. Icc 未标记资源
type: docs
weight: 3770
...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/iccuntaggedresource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
