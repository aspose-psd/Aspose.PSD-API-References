...
| [BackgroundColorResource](./backgroundcolorresource) | 带有图像打印设置边框信息的资源。 |
| [BorderInformationResource](./borderinformationresource) | 带有图像打印设置边框信息的资源。 |
...
| [GuideResource](./guideresource) | 引导资源块。 |
...
| [LayerGroupsEnabledResource](./layergroupsenabledresource) | 层组启用资源 |
| [LayerSelectionIdsResource](./layerselectionidsresource) | 层选择 ids 资源 |
| [LayerStateInformationResource](./layerstateinformationresource) | 层状态信息资源 |
| [PixelAspectRatioResource](./pixelaspectratioresource) | 像素长宽比资源 |
| [PrintFlagsResource](./printflagsresource) | 打印标志资源 |
| [PrintScaleResource](./printscaleresource) | 打印比例资源 |
| [QuickMaskInformationResource](./quickmaskinformationresource) | 快速口罩信息资源 |
| [ResolutionInfoResource](./resolutioninforesource) | 分辨率信息资源 |
| [Thumbnail4Resource](./thumbnail4resource) | 表示 psd 4.0 的缩略图资源。 |
