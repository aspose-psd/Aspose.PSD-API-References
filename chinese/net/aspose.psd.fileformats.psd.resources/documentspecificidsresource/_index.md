...
description: Aspose.PSD.FileFormats.Psd.Resources.DocumentSpecificIdsResource 班级. 文档特定 IDs resource
type: docs
weight: 3690
...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
