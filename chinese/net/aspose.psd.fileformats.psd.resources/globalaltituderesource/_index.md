...
| 姓名 | 描述 |
| --- | --- |
| [Altitude](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/altitude) { get; set; } | 获取或设置高度。 |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/datasize) { get; } | 获取资源数据大小（以字节为单位）。 |
