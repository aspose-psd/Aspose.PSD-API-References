...
description: Aspose.PSD.FileFormats.Psd.Resources.GlobalAltitudeResource 班级. 全球海拔资源
type: docs
weight: 3710
...
| 姓名 | 描述 |
| --- | --- |
| [Altitude](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/altitude/) { get; set; } | 获取或设置海拔高度。 |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
