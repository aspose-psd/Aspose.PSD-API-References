...
description: 未知资源当资源块未被识别时则创建该资源块
type: docs
weight: 3830
...
| override [DataSize](../../aspose.psd.fileformats.psd.resources/unknownresource/datasize) { get; } | 获取资源数据大小（以字节为单位）。 |
