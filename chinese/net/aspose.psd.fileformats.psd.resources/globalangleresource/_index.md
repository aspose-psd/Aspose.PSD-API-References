...
description: Aspose.PSD.FileFormats.Psd.Resources.GlobalAngleResource 班级. 全局角度资源
type: docs
weight: 3720
...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalangleresource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
