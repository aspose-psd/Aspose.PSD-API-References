...
description: Aspose.PSD.FileFormats.Psd.Resources.LayerGroupInformationResource 班级. 图层组信息资源
type: docs
weight: 3780
...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layergroupinformationresource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
