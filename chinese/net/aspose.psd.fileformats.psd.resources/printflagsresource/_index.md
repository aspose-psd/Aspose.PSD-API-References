...
| [BleedWidth](../../aspose.psd.fileformats.psd.resources/printflagsresource/bleedwidth) { get; set; } | 获取或设置出血的宽度。 |
| [CenterCropMark](../../aspose.psd.fileformats.psd.resources/printflagsresource/centercropmark) { get; set; } | 获取或设置中心裁剪标记。 |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/printflagsresource/datasize) { get; } | 以字节为单位获取资源数据大小。 |
