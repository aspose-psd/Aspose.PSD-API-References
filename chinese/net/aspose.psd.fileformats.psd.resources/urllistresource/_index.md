...
| override [DataSize](../../aspose.psd.fileformats.psd.resources/urllistresource/datasize) { get; } | 以字节为单位获取资源数据大小。 |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id) { get; set; } | 获取或设置资源的唯一标识符。 |
| [Ids](../../aspose.psd.fileformats.psd.resources/urllistresource/ids) { get; set; } | 获取或设置ids. |
