...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/watermarkresource/datasize) { get; } | 以字节为单位获取资源数据大小。 |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id) { get; set; } | 获取或设置资源的唯一标识符。 |
| [IsWatermark](../../aspose.psd.fileformats.psd.resources/watermarkresource/iswatermark) { get; set; } | 获取或设置一个值，该值指示此实例是否为水印。 |
