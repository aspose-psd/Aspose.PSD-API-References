...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/watermarkresource/datasize) { get; } | 获取资源数据大小（以字节为单位）。 |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id) { get; set; } | 获取或设置资源的唯一标识符。 |
| [IsWatermark](../../aspose.psd.fileformats.psd.resources/watermarkresource/iswatermark) { get; set; } | 获取或设置该实例是否为水印的值。 |
