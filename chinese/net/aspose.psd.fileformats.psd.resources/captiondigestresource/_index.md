...
description: Aspose.PSD.FileFormats.Psd.Resources.CaptionDigestResource 班级. CaptionDigest 资源
type: docs
weight: 3660
...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/captiondigestresource/datasize/) { get; } | 获取以字节为单位的资源数据大小。 |
