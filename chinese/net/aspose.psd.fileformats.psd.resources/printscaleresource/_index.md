...
| 姓名 | 描述 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/printscaleresource/datasize) { get; } | 以字节为单位获取资源数据大小。 |
...
| [Scale](../../aspose.psd.fileformats.psd.resources/printscaleresource/scale) { get; set; } | 获取或设置比例尺。 |
