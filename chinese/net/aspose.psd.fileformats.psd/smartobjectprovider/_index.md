---
title: "类 **SmartObjectProvider**"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.SmartObjectProvider 类。定义了智能对象提供程序，该提供程序提供从 PSD 文件的全局链接资源及其内容获取/设置数据源的功能。"
type: docs
weight: 4470
...
定义智能对象提供程序，该提供程序用于从 PSD 文件的全局链接资源及其内容获取/设置数据源。
...
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | 将图像中所有已链接的智能对象嵌入。 |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | 通过复制源图层创建新的智能对象图层。 |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | 更新图像中所有已修改的智能对象的内容。 |
