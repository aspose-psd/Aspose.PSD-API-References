...
description: "PsdImage 方法。添加空的 Shape 图层。没有路径。应在保存前将路径添加到 Shape 图层中"
type: docs
weight: 460
url: /zh/net/aspose.psd.fileformats.psd/psdimage/addshapelayer/
---
{{< psd/tize >}}
## PsdImage.AddShapeLayer method

添加空的形状图层。没有路径。它们应在保存前添加到形状图层。
