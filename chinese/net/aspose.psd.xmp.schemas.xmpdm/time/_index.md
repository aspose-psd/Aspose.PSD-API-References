...
| [Value](../../aspose.psd.xmp.schemas.xmpdm/time/value) { get; set; } | 获取或设置指定刻度的时间值。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.schemas.xmpdm/time/getxmprepresentation)() | 获取 XMP 格式的字符串包含的值。 |
