...
description: Aspose.PSD.Shapes.EllipseShape 班级. 代表椭圆形状
type: docs
weight: 5490
url: /zh/net/aspose.psd.shapes/ellipseshape/
---
## EllipseShape class
...
| 姓名 | 描述 |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | 初始化一个新的实例`EllipseShape`类. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | 初始化一个新的实例`EllipseShape`类. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | 获取形状段。 |
