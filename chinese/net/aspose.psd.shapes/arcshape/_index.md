...
description: Aspose.PSD.Shapes.ArcShape 班级. 代表一个弧形
type: docs
weight: 5460
...
| 姓名 | 描述 |
| --- | --- |
| [ArcShape](arcshape/#constructor)() | 初始化一个新的实例`ArcShape`类. |
| [ArcShape](arcshape/#constructor_1)(RectangleF, float, float) | 初始化一个新的实例`ArcShape`类. |
| [ArcShape](arcshape/#constructor_2)(RectangleF, float, float, bool) | 初始化一个新的实例`ArcShape`类. |
...
| [IsClosed](../../aspose.psd.shapes/arcshape/isclosed/) { get; set; } | 获取或设置一个值，指示有序形状是否闭合。处理闭合有序形状时，起点和终点没有意义。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds)(Matrix) | 获取对象的边界。 |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds_1)(Matrix, Pen) | 获取对象的边界。 |
| [Reverse](../../aspose.psd.shapes/arcshape/reverse/)() | 反转此形状的点顺序。 |
