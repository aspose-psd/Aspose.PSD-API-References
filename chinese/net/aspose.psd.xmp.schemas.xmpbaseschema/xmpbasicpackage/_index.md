...
description: Aspose.PSD.Xmp.Schemas.XmpBaseSchema.XmpBasicPackage 班级. 表示 XMP 基本命名空间
type: docs
weight: 5830
...
| 姓名 | 描述 |
| --- | --- |
| [XmpBasicPackage](xmpbasicpackage/#constructor)() | 初始化一个新的实例`XmpBasicPackage`类. |
| [XmpBasicPackage](xmpbasicpackage/#constructor_1)(string, string) | 初始化一个新的实例`XmpBasicPackage`类. |
...
| [SetCreatorTool](../../aspose.psd.xmp.schemas.xmpbaseschema/xmpbasicpackage/setcreatortool/)(string) | 设置创建者工具。 |
...
| [SetMetadataDate](../../aspose.psd.xmp.schemas.xmpbaseschema/xmpbasicpackage/setmetadatadate/#setmetadatadate)(DateTime) | 添加元数据上次更改日期。 |
...
* 命名空间 [Aspose.PSD.Xmp.Schemas.XmpBaseSchema](../../aspose.psd.xmp.schemas.xmpbaseschema/)
* 部件 [Aspose.PSD](../../)
