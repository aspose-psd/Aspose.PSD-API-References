---
title: "类 LiFdDataSource"
second_title: "Aspose.PSD for .NET API 参考"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LiFdDataSource 类。定义 PSD 文件中的 liFD 数据源类，该类包含有关嵌入文件的信息。这是 PSD 文件格式操作 API 的一部分，可帮助修改 Adobe Photoshop 文件。"
type: docs
weight: 2970
...
定义 PSD 文件中 liFD 数据源类，包含有关嵌入文件的信息。这是 PSD 文件格式操作 API 的一部分，帮助修改 Adobe® Photoshop® 文件
...
| 名称 | 描述 |
| --- | --- |
| [LiFdDataSource](lifddatasource/#constructor)() | 初始化 `LiFdDataSource` 类的新实例。 |
| [LiFdDataSource](lifddatasource/#constructor_1)(int, Guid, string, string, string) | 初始化 `LiFdDataSource` 类的新实例。 |
