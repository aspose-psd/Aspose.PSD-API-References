...
description: LiFdDataSource 财产. 获取或设置 PSD 文件中嵌入的智能对象数据
type: docs
weight: 20
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/
---
## LiFdDataSource.Data property

获取或设置 PSD 文件中嵌入的智能对象数据。
