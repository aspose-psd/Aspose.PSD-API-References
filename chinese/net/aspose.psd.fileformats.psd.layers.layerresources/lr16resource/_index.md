...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.Lr16Resource 班级. lr32 资源
type: docs
weight: 2770
...
| 姓名 | 描述 |
| --- | --- |
| [Lr16Resource](lr16resource/)() | 默认构造函数。 |
...
| override [PsdVersion](../../aspose.psd.fileformats.psd.layers.layerresources/lr16resource/psdversion/) { get; } | 获取 psd 版本。 |
| override [Signature](../../aspose.psd.fileformats.psd.layers.layerresources/lr16resource/signature/) { get; } | 获取签名. |
...
| 姓名 | 描述 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lr16resource/typetoolkey/) | 类型工具信息键。 |
