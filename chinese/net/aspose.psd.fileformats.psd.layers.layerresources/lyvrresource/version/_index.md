...
description: "LyvrResource 属性。获取或设置图层的 Photoshop 版本"
type: docs
weight: 30
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/
---
{{< psd/tize >}}
## LyvrResource.Version property

获取或设置图层的 Photoshop 版本。
