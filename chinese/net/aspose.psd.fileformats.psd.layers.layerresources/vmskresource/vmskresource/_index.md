...
description: 初始化VmskResourceaspose.psd.fileformats.psd.layers.layerresources/vmskresource类的新实例
type: docs
weight: 10
...
初始化[`VmskResource`](../../vmskresource)类的新实例。
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception) | Vmsk 资源值无效 |
