...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.Lr32Resource 班级. lr32 资源
type: docs
weight: 2780
...
| 姓名 | 描述 |
| --- | --- |
| [Lr32Resource](lr32resource/)(int) | 初始化一个新的实例`Lr32Resource`类. |
...
| override [PsdVersion](../../aspose.psd.fileformats.psd.layers.layerresources/lr32resource/psdversion/) { get; } | 获取 psd 版本。 |
