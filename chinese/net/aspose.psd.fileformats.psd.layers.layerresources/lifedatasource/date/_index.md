...
description: "LiFeDataSource 属性。获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的最后写入日期和时间"
type: docs
weight: 40
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
{{< psd/tize >}}
...
| 异常 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 无法访问 Date 属性，仅在版本 3 或更高的 liFE 数据源中可用 |
