...
description: 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的完整路径
type: docs
weight: 90
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | 您无法访问 FullPath 属性，它仅适用于生命数据源 |
