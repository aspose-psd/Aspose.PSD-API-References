...
description: LiFeDataSource 财产. 获取或设置PSD LnkE资源的LiFE数据源中外部文件的完整路径
type: docs
weight: 90
...
获取或设置PSD LnkE资源的LiFE数据源中外部文件的完整路径。
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 FullPath 属性，它仅适用于 liFE 数据源 |
