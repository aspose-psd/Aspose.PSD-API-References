...
description: LiFeDataSource 财产. 获取或设置 Adobe Photoshop CC 库的图形库元素名称
type: docs
weight: 50
...
获取或设置 Adobe® Photoshop® CC 库的图形库元素名称。
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 ElementName 属性，它仅在 IsLibrary 为 true 时可用于 liFE 数据源 |
