...
description: "LiFeDataSource 属性。获取或设置 Adobe Photoshop CC Libraries 的图形库元素名称。"
type: docs
weight: 50
...
获取或设置图形库元素名称，适用于 Adobe® Photoshop® CC Libraries。
...
| 异常 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 ElementName 属性，仅当 IsLibrary 为 true 时，它在 liFE 数据源中可用。 |
