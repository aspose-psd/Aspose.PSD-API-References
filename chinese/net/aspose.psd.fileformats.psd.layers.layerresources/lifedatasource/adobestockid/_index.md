...
description: LiFeDataSource 财产. 获取或设置图形库 AdobeStockId用于 Adobe Photoshop CC 库
type: docs
weight: 20
...
获取或设置图形库 AdobeStockId，用于 Adobe® Photoshop® CC 库。
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 AdobeStockId 属性，它仅在 IsLibrary 为 true 时可用于 liFE 数据源 |
