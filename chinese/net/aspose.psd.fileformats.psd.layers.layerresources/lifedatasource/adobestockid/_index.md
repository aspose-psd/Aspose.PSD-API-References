...
description: "LiFeDataSource 属性。获取或设置 Adobe Photoshop CC Libraries 的图形库 AdobeStockId"
type: docs
weight: 20
...
获取或设置图形库 AdobeStockId，适用于 Adobe® Photoshop® CC Libraries。
...
| 异常 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 无法访问 AdobeStockId 属性，仅在 IsLibrary 为 true 时的 liFE 数据源中可用 |
