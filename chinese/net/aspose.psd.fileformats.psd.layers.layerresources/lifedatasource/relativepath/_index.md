...
description: "LiFeDataSource 属性。获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的相对路径。"
type: docs
weight: 100
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
{{< psd/tize >}}
...
| 异常 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 RelativePath 属性，它仅在 liFE 数据源中可用。 |
