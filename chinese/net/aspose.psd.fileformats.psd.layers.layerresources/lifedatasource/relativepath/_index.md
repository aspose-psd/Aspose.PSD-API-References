...
description: LiFeDataSource 财产. 获取或设置外部文件在PSD LnkE资源的LiFE数据源中的相对路径
type: docs
weight: 100
...
获取或设置外部文件在PSD LnkE资源的LiFE数据源中的相对路径。
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 RelativePath 属性，它仅适用于 liFE 数据源 |
