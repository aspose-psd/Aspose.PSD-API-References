...
description: LiFeDataSource 财产. 获取或设置PSD LnkE资源的LiFE数据源中外部文件的大小
type: docs
weight: 80
...
获取或设置PSD LnkE资源的LiFE数据源中外部文件的大小。
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 FileSize 属性，它仅适用于 liFE 数据源 |
