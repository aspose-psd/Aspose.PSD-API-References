...
description: 获取或设置 PSD LnkE 资源的 LiFE 数据源中外部文件的大小
type: docs
weight: 80
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | 您无法访问 FileSize 属性，它仅适用于生活数据源 |
