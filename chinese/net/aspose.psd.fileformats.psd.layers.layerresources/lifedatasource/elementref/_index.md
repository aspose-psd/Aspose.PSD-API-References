...
description: "LiFeDataSource 属性。获取或设置 Adobe Photoshop CC Libraries 的图形库元素引用"
type: docs
weight: 60
...
获取或设置图形库元素引用，适用于 Adobe® Photoshop® CC Libraries。
...
| 异常 | 条件 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 无法访问 ElementRef 属性，仅在 IsLibrary 为 true 时的 liFE 数据源中可用 |
