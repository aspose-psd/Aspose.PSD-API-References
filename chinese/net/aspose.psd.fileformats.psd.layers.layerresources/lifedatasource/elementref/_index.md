...
description: LiFeDataSource 财产. 获取或设置图形库元素引用适用于 Adobe Photoshop CC 库
type: docs
weight: 60
...
| 例外 | （健康）状况 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | 您无法访问 ElementRef 属性，它仅在 IsLibrary 为 true 时可用于 liFE 数据源 |
