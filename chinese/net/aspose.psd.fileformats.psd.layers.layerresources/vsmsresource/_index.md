...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VsmsResource 班级. Class VsmsResource. 此资源包含有关矢量图层掩码 的信息
type: docs
weight: 3380
...
Class VsmsResource. 此资源包含有关矢量图层掩码 的信息
...
| 姓名 | 描述 |
| --- | --- |
| [VsmsResource](vsmsresource/#constructor)() | 初始化一个新的实例`VsmsResource`类. |
| [VsmsResource](vsmsresource/#constructor_1)(byte[]) | 初始化一个新的实例`VsmsResource`类. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/key/) { get; } | 获取图层资源键。 |
