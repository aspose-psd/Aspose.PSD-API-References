...
description: 类 VsmsResource. 该资源包含有关矢量图层掩码的信息
type: docs
weight: 3320
...
类 VsmsResource. 该资源包含有关矢量图层掩码的信息
...
| 姓名 | 描述 |
| --- | --- |
| [VsmsResource](vsmsresource#constructor)() | 初始化[`VsmsResource`](../vsmsresource)类. |
| [VsmsResource](vsmsresource#constructor_1)(byte[]) | 初始化[`VsmsResource`](../vsmsresource)类. |
