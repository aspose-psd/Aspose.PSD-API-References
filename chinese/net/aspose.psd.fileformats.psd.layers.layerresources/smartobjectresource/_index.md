...
description: 定义 SmartObjectResource 类该类包含有关 PSD 文件中智能对象层的信息 是 Sold 和 Sole 资源的基类用于支持 Adobe Photoshop 图像中的智能对象层
type: docs
weight: 2960
...
定义 SmartObjectResource 类，该类包含有关 PSD 文件中智能对象层的信息。 是 Sold 和 Sole 资源的基类，用于支持 Adobe® Photoshop® 图像中的智能对象层。
