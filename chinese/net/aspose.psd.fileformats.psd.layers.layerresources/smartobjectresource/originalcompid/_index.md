...
description: SmartObjectResource 财产. 获取当前为子文档选择的 Comp 的原始 ID如果没有选择则为 1 该属性获取 PSD 文件中智能对象图层的原始图层 Comp 选择标识符 智能对象中的图层复合
type: docs
weight: 140
...
获取当前为子文档选择的 Comp 的原始 ID，如果没有选择，则为 -1。 该属性获取 PSD 文件中智能对象图层的原始图层 Comp 选择标识符。 [智能对象中的图层复合](https://helpx.adobe.com/photoshop/using/layer-comps.html)
...
PSD图像中子文档当前选择的comp的原始ID，如果没有选择则为-1。
