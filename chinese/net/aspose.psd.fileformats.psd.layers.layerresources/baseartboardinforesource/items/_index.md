...
description: "BaseArtboardInfoResource 属性。获取或设置 OSTypeStructure 项目"
type: docs
weight: 10
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/
---
{{< psd/tize >}}
## BaseArtboardInfoResource.Items property

获取或设置 [`OSTypeStructure`](../../ostypestructure/) 项目。
