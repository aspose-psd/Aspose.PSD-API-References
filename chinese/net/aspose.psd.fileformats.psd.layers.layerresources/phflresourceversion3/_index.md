...
| 姓名 | 描述 |
| --- | --- |
| [PhflResourceVersion3](phflresourceversion3#constructor)() | 初始化[`PhflResourceVersion3`](../phflresourceversion3)类. |
| [PhflResourceVersion3](phflresourceversion3#constructor_1)(byte[]) | 初始化[`PhflResourceVersion3`](../phflresourceversion3)类. |
...
| override [Length](../../aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/length) { get; } | 以字节为单位获取层资源长度。 |
...
| override [Version](../../aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/version) { get; } | 获取版本。默认值为 2 或 3 |
