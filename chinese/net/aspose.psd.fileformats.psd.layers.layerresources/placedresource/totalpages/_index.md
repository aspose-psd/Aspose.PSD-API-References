...
description: "PlacedResource 属性。获取或设置 PSD 文件中已放置图层的总页数"
type: docs
weight: 150
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/totalpages/
---
{{< psd/tize >}}
## PlacedResource.TotalPages property

获取或设置 PSD 文件中已放置图层的总页数。
