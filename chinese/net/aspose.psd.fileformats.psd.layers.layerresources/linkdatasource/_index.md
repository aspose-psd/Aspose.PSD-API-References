...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LinkDataSource 班级. 定义 LinkDataSource 类其中包含有关链接文件或 PSD 文件中资产的信息
type: docs
weight: 2690
...
定义 LinkDataSource 类，其中包含有关链接文件或 PSD 文件中资产的信息。
