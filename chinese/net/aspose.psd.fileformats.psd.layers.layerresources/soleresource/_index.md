...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource 班级. 定义 SoLeResource 类其中包含有关 PSD 文件中智能对象层的信息 用于支持 Adobe Photoshop 图像中具有外部文件链接的智能对象层
type: docs
weight: 3030
...
定义 SoLeResource 类，其中包含有关 PSD 文件中智能对象层的信息。 用于支持 Adobe® Photoshop® 图像中具有外部文件链接的智能对象层。
...
| 姓名 | 描述 |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | 初始化一个新的实例`SoLeResource`类. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | 初始化一个新的实例`SoLeResource`类. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/key/) { get; } | 获取唯一智能对象层资源键。 |
