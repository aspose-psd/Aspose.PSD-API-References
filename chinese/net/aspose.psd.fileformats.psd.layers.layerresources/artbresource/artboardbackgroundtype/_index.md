...
description: "ArtBResource 属性。获取或设置 ArtboardBackgroundType"
type: docs
weight: 20
url: /zh/net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/artboardbackgroundtype/
---
{{< psd/tize >}}
## ArtBResource.ArtboardBackgroundType property

获取或设置 `ArtboardBackgroundType`
