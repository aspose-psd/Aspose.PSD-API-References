...
description: "IGradientFillSettings 属性。获取或设置特定的渐变定义实例 Solid/Noise"
type: docs
weight: 40
url: /zh/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/gradient/
---
{{< psd/tize >}}
## IGradientFillSettings.Gradient property

获取或设置特定的渐变定义实例（Solid/Noise）。
