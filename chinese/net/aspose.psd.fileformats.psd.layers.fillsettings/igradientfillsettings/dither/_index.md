...
description: "IGradientFillSettings 属性。获取或设置一个值，指示此 IGradientFillSettings 是否使用抖动"
type: docs
weight: 30
url: /zh/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
{{< psd/tize >}}
## IGradientFillSettings.Dither property

获取或设置一个值，指示此 [`IGradientFillSettings`](../) 是否使用抖动。
