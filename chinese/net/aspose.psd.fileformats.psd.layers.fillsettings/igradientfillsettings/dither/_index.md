...
description: 获取或设置一个值该值指示是否IGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings是抖动.
type: docs
weight: 50
...
获取或设置一个值，该值指示是否[`IGradientFillSettings`](../../igradientfillsettings)是抖动.
