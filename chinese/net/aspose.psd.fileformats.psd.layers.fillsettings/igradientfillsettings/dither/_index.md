...
description: 获取或设置一个值该值指示此IGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings是否抖动
type: docs
weight: 50
...
获取或设置一个值，该值指示此[`IGradientFillSettings`](../../igradientfillsettings)是否抖动。
