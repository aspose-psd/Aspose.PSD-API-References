...
description: 获取或设置一个值该值指示此PatternFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/patternfillsettings是否已链接
type: docs
weight: 50
...
获取或设置一个值，该值指示此[`PatternFillSettings`](../../patternfillsettings)是否已链接。
