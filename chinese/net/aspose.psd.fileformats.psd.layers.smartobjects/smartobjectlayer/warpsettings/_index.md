...
description: "SmartObjectLayer 属性。它获取或设置从资源默认值设置或获取的 Warp 参数"
type: docs
weight: 80
url: /zh/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

获取或设置从资源中设置或获取的 Warp 参数（默认）
