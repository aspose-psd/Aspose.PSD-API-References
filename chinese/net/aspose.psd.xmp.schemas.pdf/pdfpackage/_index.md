...
description: Aspose.PSD.Xmp.Schemas.Pdf.PdfPackage 班级. 表示 Adobe Pdf 命名空间
type: docs
weight: 5790
url: /zh/net/aspose.psd.xmp.schemas.pdf/pdfpackage/
---
## PdfPackage class
...
| 姓名 | 描述 |
| --- | --- |
| override [AddValue](../../aspose.psd.xmp.schemas.pdf/pdfpackage/addvalue/)(string, string) | 添加字符串属性。 |
...
| [SetKeywords](../../aspose.psd.xmp.schemas.pdf/pdfpackage/setkeywords/)(string) | 设置关键字。 |
| [SetPdfVersion](../../aspose.psd.xmp.schemas.pdf/pdfpackage/setpdfversion/)(string) | 设置 PDF 版本。 |
| [SetProducer](../../aspose.psd.xmp.schemas.pdf/pdfpackage/setproducer/)(string) | 设置创建 Pdf 的工具的名称。 |
| [SetTrapped](../../aspose.psd.xmp.schemas.pdf/pdfpackage/settrapped/)(bool) | 设置被困. |
...
* 命名空间 [Aspose.PSD.Xmp.Schemas.Pdf](../../aspose.psd.xmp.schemas.pdf/)
* 部件 [Aspose.PSD](../../)
