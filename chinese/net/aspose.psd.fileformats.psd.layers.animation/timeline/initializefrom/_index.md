...
description: TimeLine 方法. 创建的新实例TimeLine 从输入初始化PsdImage .
type: docs
weight: 20
...
创建的新实例[`TimeLine`](../) 从输入初始化[`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/) .
...
的新实例[`TimeLine`](../) 从输入初始化[`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
