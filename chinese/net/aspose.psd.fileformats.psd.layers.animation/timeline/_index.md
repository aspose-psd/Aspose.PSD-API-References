...
description: Aspose.PSD.FileFormats.Psd.Layers.Animation.TimeLine 班级. 时间线选项模型
type: docs
weight: 1880
...
| 姓名 | 描述 |
| --- | --- |
| static [InitializeFrom](../../aspose.psd.fileformats.psd.layers.animation/timeline/initializefrom/)(PsdImage) | 创建的新实例`TimeLine` 从输入初始化[`PsdImage`](../../aspose.psd.fileformats.psd/psdimage/) . |
