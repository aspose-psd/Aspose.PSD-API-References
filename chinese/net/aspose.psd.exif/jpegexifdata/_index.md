...
| [CommonTags](../../aspose.psd.exif/exifdata/commontags) { get; set; } | 获取或设置标签，属于公共部分。这仅适用于 jpeg 图像，使用 tiff 格式 tiffOptions 代替 |
| [ComponentsConfiguration](../../aspose.psd.exif/exifdata/componentsconfiguration) { get; set; } | 获取或设置组件配置。 |
| [CompressedBitsPerPixel](../../aspose.psd.exif/exifdata/compressedbitsperpixel) { get; set; } | 获取或设置每个像素的压缩位。 |
...
| [DateTimeOriginal](../../aspose.psd.exif/exifdata/datetimeoriginal) { get; set; } | 获取或设置日期时间原始。 |
...
| [Gamma](../../aspose.psd.exif/exifdata/gamma) { get; set; } | 获取或设置伽玛。 |
...
| [GPSAreaInformation](../../aspose.psd.exif/exifdata/gpsareainformation) { get; set; } | 获取或设置 GPS 区域信息。 |
| [GPSDateStamp](../../aspose.psd.exif/exifdata/gpsdatestamp) { get; set; } | 获取或设置相对于 UTC（世界标准时间）的 GPS 字符串记录日期和时间信息。 |
| [GPSDestBearing](../../aspose.psd.exif/exifdata/gpsdestbearing) { get; set; } | 获取或设置到目标点的 GPS 方位。 |
| [GPSDestBearingRef](../../aspose.psd.exif/exifdata/gpsdestbearingref) { get; set; } | 获取或设置用于将方位角提供给目标点的 GPS 参考。 |
| [GPSDestDistance](../../aspose.psd.exif/exifdata/gpsdestdistance) { get; set; } | 获取或设置到目标点的 GPS 距离。 |
| [GPSDestDistanceRef](../../aspose.psd.exif/exifdata/gpsdestdistanceref) { get; set; } | 获取或设置用于表示到目的地距离的 GPS 单位。 |
| [GPSDestLatitude](../../aspose.psd.exif/exifdata/gpsdestlatitude) { get; set; } | 获取或设置目标点的 GPS 纬度。 |
| [GPSDestLatitudeRef](../../aspose.psd.exif/exifdata/gpsdestlatituderef) { get; set; } | 获取或设置GPS值，指示目标点的纬度是北纬还是南纬。 |
| [GPSDestLongitude](../../aspose.psd.exif/exifdata/gpsdestlongitude) { get; set; } | 获取或设置目标点的 GPS 经度。 |
| [GPSDestLongitudeRef](../../aspose.psd.exif/exifdata/gpsdestlongituderef) { get; set; } | 获取或设置GPS值，指示目的地点的经度是东经还是西经。 |
| [GPSDifferential](../../aspose.psd.exif/exifdata/gpsdifferential) { get; set; } | 获取或设置一个 GPS 值，该值指示是否将差分校正应用于 GPS 接收器。 |
| [GPSDOP](../../aspose.psd.exif/exifdata/gpsdop) { get; set; } | 获取或设置 GPS DOP（数据精度）。 |
| [GPSImgDirection](../../aspose.psd.exif/exifdata/gpsimgdirection) { get; set; } | 获取或设置捕获图像时的 GPS 方向。 |
| [GPSImgDirectionRef](../../aspose.psd.exif/exifdata/gpsimgdirectionref) { get; set; } | 获取或设置 GPS 参考，用于在捕获图像时提供图像方向。 |
| [GPSLatitude](../../aspose.psd.exif/exifdata/gpslatitude) { get; set; } | 获取或设置 GPS 纬度。 |
| [GPSLatitudeRef](../../aspose.psd.exif/exifdata/gpslatituderef) { get; set; } | 获取或设置GPS纬度是北纬还是南纬。 |
| [GPSLongitude](../../aspose.psd.exif/exifdata/gpslongitude) { get; set; } | 获取或设置 GPS 经度。 |
| [GPSLongitudeRef](../../aspose.psd.exif/exifdata/gpslongituderef) { get; set; } | 获取或设置 GPS 经度为东经或西经。 |
...
| [GPSTags](../../aspose.psd.exif/exifdata/gpstags) { get; set; } | 获取或设置标签，只属于 GPS 部分。 |
| [GPSTimestamp](../../aspose.psd.exif/exifdata/gpstimestamp) { get; set; } | 获取或设置 GPS 时间为 UTC（协调世界时）。 |
| [GPSTrack](../../aspose.psd.exif/exifdata/gpstrack) { get; set; } | 获取或设置 GPS 接收器运动的方向。 |
| [GPSTrackRef](../../aspose.psd.exif/exifdata/gpstrackref) { get; set; } | 获取或设置 GPS 接收器运动方向的参考。 |
...
| [ISOSpeed](../../aspose.psd.exif/exifdata/isospeed) { get; set; } | 获取或设置 ISO 感光度 |
| [ISOSpeedLatitudeYYY](../../aspose.psd.exif/exifdata/isospeedlatitudeyyy) { get; set; } | 获取或设置 ISO 12232 中定义的相机或输入设备的 ISO 感光度纬度 yyy 值。 |
| [ISOSpeedLatitudeZZZ](../../aspose.psd.exif/exifdata/isospeedlatitudezzz) { get; set; } | 获取或设置 ISO 12232 中定义的相机或输入设备的 ISO 感光度纬度 zzz 值。 |
| [LensMake](../../aspose.psd.exif/exifdata/lensmake) { get; set; } | 获取或设置镜头制造商。 |
| [LensModel](../../aspose.psd.exif/exifdata/lensmodel) { get; set; } | 获取或设置镜头模型。 |
...
| [MakerNoteRawData](../../aspose.psd.exif/exifdata/makernoterawdata) { get; set; } | 获取或设置maker note 原始数据。 |
...
| [RecommendedExposureIndex](../../aspose.psd.exif/exifdata/recommendedexposureindex) { get; set; } | 获取或设置推荐的曝光指数。 |
| [ReferenceBlackWhite](../../aspose.psd.exif/jpegexifdata/referenceblackwhite) { get; set; } | 获取或设置参考黑白色。 |
| [RelatedSoundFile](../../aspose.psd.exif/exifdata/relatedsoundfile) { get; set; } | 获取或设置相关的声音文件。 |
...
| [SensingMethod](../../aspose.psd.exif/exifdata/sensingmethod) { get; set; } | 获取或设置感应方式。 |
| [SensitivityType](../../aspose.psd.exif/exifdata/sensitivitytype) { get; set; } | 获取或设置敏感度类型。 |
...
| [SubjectDistance](../../aspose.psd.exif/exifdata/subjectdistance) { get; set; } | 获取或设置被摄体距离。 |
...
| [SubsecTime](../../aspose.psd.exif/exifdata/subsectime) { get; set; } | 获取或设置 DateTime 标记的秒小数部分。 |
| [SubsecTimeDigitized](../../aspose.psd.exif/exifdata/subsectimedigitized) { get; set; } | 获取或设置 DateTimeDigitized 标记的秒小数部分。 |
| [SubsecTimeOriginal](../../aspose.psd.exif/exifdata/subsectimeoriginal) { get; set; } | 获取或设置 DateTimeOriginal 标记的秒小数部分。 |
...
| [YCbCrCoefficients](../../aspose.psd.exif/jpegexifdata/ycbcrcoefficients) { get; set; } | 获取或设置从 RGB 转换为 YCbCr 图像数据的矩阵系数。 |
...
| 姓名 | 描述 |
| --- | --- |
| [RemoveTag](../../aspose.psd.exif/exifdata/removetag)(ExifProperties) | 从容器中删除标签 |
| [RemoveTag](../../aspose.psd.exif/exifdata/removetag)(ushort) | 从容器中移除标签 |
| [SerializeExifData](../../aspose.psd.exif/jpegexifdata/serializeexifdata)() | 序列化 EXIF 数据。写入标签值和内容。影响最大的尺寸标签是缩略图标签内容。 |
