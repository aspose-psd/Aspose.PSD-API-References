...
| [Units](../../aspose.psd.xmp.types.complex.dimensions/dimensions/units) { get; set; } | 获取或设置单位。 |
| [Width](../../aspose.psd.xmp.types.complex.dimensions/dimensions/width) { get; set; } | 获取或设置宽度。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| override [GetXmpRepresentation](../../aspose.psd.xmp.types.complex.dimensions/dimensions/getxmprepresentation)() | 获取 XMP 格式的字符串包含的值。 |
