---
title: "Lfx2Resource Sınıfı"
type: docs
weight: 500
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [Lfx2Resource()](#Lfx2Resource__1) | Lfx2Resource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| descriptor_version | int | r | Tanımlayıcı sürümünü alır. |
...
Lfx2Resource sınıfının yeni bir örneğini başlatır
