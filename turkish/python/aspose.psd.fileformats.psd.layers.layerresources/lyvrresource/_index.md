---
title: "LyvrResource Sınıfı"
type: docs
weight: 670
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [LyvrResource()](#LyvrResource__1) | LyvrResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| version | int | r/w | Katmanın Photoshop sürümünü alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
LyvrResource sınıfının yeni bir örneğini başlatır
