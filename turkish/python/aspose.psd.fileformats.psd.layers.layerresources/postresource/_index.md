...
type: docs
weight: 840
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [PostResource()](#PostResource__1) | PostResource sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
PostResource sınıfının yeni bir örneğini başlatır.
