---
title: "VibAResource Sınıfı"
type: docs
weight: 1090
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [VibAResource()](#VibAResource__1) | [VibAResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vibaresource/) sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| doygunluk | int | r/w | Doygunluk değerini alır veya ayarlar |
| signature | int | r | İmzayı alır. |
| canlılık | int | r/w | Canlılık değerini alır veya ayarlar |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
[VibAResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vibaresource/) sınıfının yeni bir örneğini başlatır.
