...
type: docs
weight: 20
url: /tr/python-net/aspose.psd.shapes/beziershape/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [BezierShape()](#BezierShape__1) | Yeni bir [BezierShape](/psd/python-net/aspose.psd.shapes/beziershape/) sınıfı örneği başlatır. |
| [BezierShape(points)](#BezierShape_points_2) | Yeni bir [BezierShape](/psd/python-net/aspose.psd.shapes/beziershape/) sınıfı örneği başlatır. |
| [BezierShape(points, is_closed)](#BezierShape_points_is_closed_3) | Yeni bir [BezierShape](/psd/python-net/aspose.psd.shapes/beziershape/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [BezierShape](/psd/python-net/aspose.psd.shapes/beziershape/) sınıfı örneği başlatır.
