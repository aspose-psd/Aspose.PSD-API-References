---
title: "TextLayer Sınıfı"
type: docs
weight: 1750
url: /tr/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Yazı tipini alır. |
| alfa_var | bool | r |  |
...
| inner_text | string | r | Katmanın metnini alır |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Metin sınırlama kutusunu alır veya ayarlar. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Metnin rengini alır. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Metin bölümlerini alır. |
| üst | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Metin katmanının yazı tipi kümesini alır. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Görüntüyü yeniden boyutlandırır. Varsayılan [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) kullanılır. |
...
| [update_text(text)](#update_text_text_38) | Metni günceller. |
| [update_text(text, color)](#update_text_text_color_39) | Metni günceller. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Metni günceller. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Metni günceller. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Metni günceller. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Metni günceller. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Metni günceller. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Metni günceller. |
...
| Tür | Açıklama |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | Metin katmanının yazı tipi kümesi. |
...
Görüntüyü yeniden boyutlandırır. Varsayılan [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) kullanılır.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Yeniden boyutlandırma dönüşümünün türü [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | Metin değeri. |
| color | [Color](/psd/python-net/aspose.psd/color) | Renk değeri. |
...
| :- | :- | :- |
| text | string | Metin değeri. |
| font_size | float | Yazı tipinin boyutu. |
...
| :- | :- | :- |
| text | string | Metin değeri. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | Sol üst koordinatı. |
