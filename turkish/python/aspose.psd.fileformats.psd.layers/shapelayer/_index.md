---
title: "ShapeLayer Sınıfı"
type: docs
weight: 1600
url: /tr/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Yeni bir [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) sınıfı örneği başlatır.<br/>            Tüm kaynaklar varsayılan durumlarında oluşturulur. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Shape katmanındaki Şekillerin iç alanı için doldurma ayarlarını alır veya ayarlar. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Bir Shape katmanında bulunan Path'lerin kümesini alır. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Şekillerin Stroke ayarlarını alır veya ayarlar. |
| üst | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Yeni bir [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) sınıfı örneği oluşturur. |
...
| update() | Şekil katman özelliklerinden kaynakları günceller. |
...
Yeni bir [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) sınıfı örneği başlatır.<br/>            Tüm kaynaklar varsayılan durumlarında oluşturulur.
...
Yeni bir [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) sınıfı örneği oluşturur.

**Returns**

| Tür | Açıklama |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Yeni [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) sınıfının örneğini döndürür. |
