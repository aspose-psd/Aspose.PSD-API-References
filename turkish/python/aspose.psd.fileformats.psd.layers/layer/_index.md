...
type: docs
weight: 930
url: /tr/python-net/aspose.psd.fileformats.psd.layers/layer/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [Layer()](#Layer__1) | Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneği başlatır. Tembel başlatma için kurucu. |
| [Layer(bounds, red_bytes, green_bytes, blue_bytes, name)](#Layer_bounds_red_bytes_green_bytes_blue_bytes_name_2) | Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneğini bayt dizilerinden başlatır. |
| [Layer(image, dispose_image)](#Layer_image_dispose_image_3) | Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneği başlatır. |
| [Layer(stream)](#Layer_stream_4) | Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneği başlatır. |
## **Properties**
| **Name** | **Tür** | **Erişim** | **Açıklama** |
| :- | :- | :- | :- |
| BLEND_SIGNATURE [static] | int | r | Karışım modu imzasını temsil eder. |
| LAYER_HEADER_SIZE [static] | int | r | Katman başlığı boyutu. |
...
| blend_clipped_elements | bool | r/w | Kırpılmış öğenin karışımını alır veya ayarlar. |
...
| blend_mode_signature | int | r | Karışım modu imzasını alır. |
| blending_options | [BlendingOptions](/psd/python-net/aspose.psd.fileformats.psd.layers.layereffects/blendingoptions/) | r | Karıştırma seçeneklerini alır. |
| alt | int | r/w | Alt katmanın konumunu alır veya ayarlar. |
...
| channel_information | [ChannelInformation[]](/psd/python-net/aspose.psd.fileformats.psd.layers/channelinformation) | r/w | Kanal bilgilerini alır veya ayarlar. |
| channels_count | ushort | r | Katmanın kanal sayısını alır. |
| clipping | byte | r/w | Katman kırpmasını alır veya ayarlar. 0 = temel, 1 = temel dışı. |
...
| görüntü_adı | string | r/w | Katmanın görüntüleme adını alır veya ayarlar. |
| kapatıldı | bool | r | Bu örneğin atılmış olup olmadığını gösteren bir değeri alır. |
| ek_uzunluk | int | r | Katmanın ek bilgi uzunluğunu bayt olarak alır. |
| file_format | [FileFormat](/psd/python-net/aspose.psd/fileformat) | r | Dosya formatının değerini alır |
| dolgu_opaklığı | int | r/w | Dolgu opaklığını alır veya ayarlar. |
| doldurucu | byte | r/w | Katman doldurucusunu alır veya ayarlar. |
| flags | [LayerFlags](/psd/python-net/aspose.psd.fileformats.psd.layers/layerflags) | r/w | Katman bayraklarını alır veya ayarlar.<br/>            bit 0 = şeffaflık korumalı;<br/>            bit 1 = görünür;<br/>            bit 2 = eski;<br/>            bit 3 = Photoshop 5.0 ve sonrası için 1, bit 4'ün faydalı bilgi içerip içermediğini belirtir;<br/>            bit 4 = belge görünümüne alakasız piksel verisi. |
...
| görünür | bool | r/w | Katmanın görünür olup olmadığını gösteren bir değeri alır veya ayarlar |
| grupta_görünür | bool | r | Bu örneğin grup içinde görünür olup olmadığını gösteren bir değeri alır (Katman grup içinde değilse kök grup anlamına gelir). |
| layer_blending_ranges_data | [LayerBlendingRangesData](/psd/python-net/aspose.psd.fileformats.psd.layers/layerblendingrangesdata) | r/w | Katman karıştırma aralıkları verisini alır veya ayarlar. |
| katman_oluşturma_tarih_saat | datetime | r/w | Katman oluşturma tarih ve saatini alır veya ayarlar. |
...
| layer_mask_data | [LayerMaskData](/psd/python-net/aspose.psd.fileformats.psd.layers/layermaskdata) | r/w | Katman maske verisini alır veya ayarlar. |
| layer_options | [PsdOptions](/psd/python-net/aspose.psd.imageoptions/psdoptions/) | r | Katman seçeneklerini alır. |
| sol | int | r/w | Sol katman konumunu alır veya ayarlar. |
| uzunluk | int | r | Toplam katman uzunluğunu bayt cinsinden alır. |
| name | string | r/w | Katman adını alır veya ayarlar. |
| opaklık | byte | r/w | Katman opaklığını alır veya ayarlar. 0 = şeffaf, 255 = opak. |
...
| resources | [LayerResource[]](/psd/python-net/aspose.psd.fileformats.psd.layers/layerresource) | r/w | Katman kaynaklarını alır veya ayarlar. |
| sağ | int | r/w | Sağ katman konumunu alır veya ayarlar. |
| sheet_color_highlight | [SheetColorHighlightEnum](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/) | r/w | Katmanlar listesindeki dekoratif sayfa renk vurgusunu alır veya ayarlar |
| size | [Size](/psd/python-net/aspose.psd/size) | r | Nesnenin boyutunu alır. |
| üst | int | r/w | Üst katman konumunu alır veya ayarlar. |
...
| **Name** | **Açıklama** |
| :- | :- |
| [add_layer_mask(layer_mask)](#add_layer_mask_layer_mask_1) | Maskeyi mevcut katmana ekler. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_2) | Görüntünün parlaklığını ayarlar. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_3) | Görüntü kontrastı |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_4) | Bir görüntünün gama düzeltmesi. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_5) | Bir görüntünün gama düzeltmesi. |
| [binarize_bradley(brightness_difference)](#binarize_bradley_brightness_difference_6) | Bradley'in adaptif eşikleme algoritması ve integral görüntü eşikleme kullanarak bir görüntünün ikilileştirilmesi. |
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_7) | Bradley'in adaptif eşikleme algoritması ve integral görüntü eşikleme kullanarak bir görüntünün ikilileştirilmesi. |
...
| [can_load(file_path)](#can_load_file_path_9) | Görüntünün belirtilen dosya yolundan yüklenip yüklenemeyeceğini belirler. |
| [can_load(file_path, load_options)](#can_load_file_path_load_options_10) | Görüntünün belirtilen dosya yolundan ve isteğe bağlı olarak belirtilen açma seçenekleri kullanılarak yüklenip yüklenemeyeceğini belirler. |
| [can_load(stream)](#can_load_stream_11) | Görüntünün belirtilen akıştan yüklenip yüklenemeyeceğini belirler. |
| [can_load(stream, load_options)](#can_load_stream_load_options_12) | Görüntünün belirtilen akıştan ve isteğe bağlı olarak belirtilen <paramref name="loadOptions" /> kullanılarak yüklenip yüklenemeyeceğini belirler. |
| [can_save(options)](#can_save_options_13) | Görüntünün, verilen kaydetme seçenekleriyle temsil edilen belirtilen dosya formatına kaydedilip kaydedilemeyeceğini belirler. |
| [create(image_options, width, height)](#create_image_options_width_height_14) | Belirtilen oluşturma seçenekleri kullanılarak yeni bir görüntü oluşturur. |
| crop(left_shift, right_shift, top_shift, bottom_shift) |  |
| [crop(rectangle)](#crop_rectangle_15) | Görüntüyü kırpar. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_16) | Mevcut görüntüde dithering uygular. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_17) | Mevcut görüntüde dithering uygular. |
| [draw_image(location, image)](#draw_image_location_image_18) | Görüntüyü katmana çizer. |
| filter(rectangle, options) |  |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_19) | 32-bit ARGB pikseli olan bir görüntüyü alır. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_20) | Varsayılan 32-bit ARGB piksel dizisini alır. |
| [get_default_options(args)](#get_default_options_args_21) | Varsayılan seçenekleri alır. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_22) | Kısmi piksel yükleyici kullanarak varsayılan piksel dizisini alır. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_23) | Kısmi piksel yükleyici kullanarak varsayılan ham veri dizisini alır. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_24) | Varsayılan ham veri dizisini alır. |
| [get_file_format(file_path)](#get_file_format_file_path_25) | Dosya formatını alır. |
| [get_file_format(stream)](#get_file_format_stream_26) | Dosya formatını alır. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_27) | Geçerli görüntüyü saran dikdörtgeni alır. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_28) | Geçerli görüntüyü saran dikdörtgeni alır. |
| [get_modify_date(use_default)](#get_modify_date_use_default_29) | Kaynak görüntünün en son ne zaman değiştirildiğini gösteren tarih ve saati alır. |
...
| [get_pixel(x, y)](#get_pixel_x_y_31) | Bir görüntü pikseli alır.<br/>            Performans Uyarısı: Tüm görüntü pikselleri üzerinde yineleme yapmak için bu yöntemi kullanmaktan kaçının, çünkü bu önemli performans sorunlarına yol açabilir.<br/>            Daha verimli piksel manipülasyonu için, tüm piksel dizisini aynı anda almak üzere `LoadArgb32Pixels` metodunu kullanın. |
...
| [load(file_path)](#load_file_path_35) | Belirtilen dosyadan yeni bir görüntü yükler. |
| [load(file_path, load_options)](#load_file_path_load_options_36) | Belirtilen dosyadan yeni bir görüntü yükler. |
...
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_39) | 32-bit ARGB piksellerini yükler. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_40) | 64-bit ARGB piksellerini yükler. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_41) | CMYK formatında pikselleri yükler. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_42) | CMYK formatında pikselleri yükler.<br/>            Bu yöntem kullanımdan kaldırılmıştır. Lütfen daha etkili olan [RasterImage.load_cmyk_32_pixels(rectangle)](/psd/python-net/aspose.psd/rasterimage/) metodunu kullanın. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_43) | 32-bit ARGB piksellerini kısmen (bloklar halinde) yükler. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_44) | Pikselleri paketler halinde kısmen yükler. |
| [load_pixels(rectangle)](#load_pixels_rectangle_45) | Pikselleri yükler. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_46) | Ham verileri yükler. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_47) | Ham verileri yükler. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_48) | Katmanı belirtilen katmana birleştirir |
| normalize_angle() |  |
| normalize_angle(resize_proportionally, background_color) |  |
| [read_argb_32_scan_line(scan_line_index)](#read_argb_32_scan_line_scan_line_index_49) | Belirtilen tarama satırı indeksiyle tüm tarama satırını okur. |
| [read_scan_line(scan_line_index)](#read_scan_line_scan_line_index_50) | Belirtilen tarama satırı indeksiyle tüm tarama satırını okur. |
| replace_color(old_color, old_color_diff, new_color) |  |
| replace_color(old_color_argb, old_color_diff, new_color_argb) |  |
| replace_non_transparent_colors(new_color) |  |
| replace_non_transparent_colors(new_color_argb) |  |
| [resize(new_width, new_height)](#resize_new_width_new_height_51) | Görüntüyü yeniden boyutlandırır. Varsayılan olarak [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/) kullanılır. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_52) | Görüntüyü yeniden boyutlandırır. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_53) | Görüntüyü yeniden boyutlandırır. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_54) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_55) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_56) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_57) | Genişliği orantılı olarak yeniden boyutlandırır. Varsayılan olarak [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/) kullanılır. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_58) | Genişliği orantılı olarak yeniden boyutlandırır. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_59) | Genişliği orantılı olarak yeniden boyutlandırır. |
| döndür(açı) |  |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_60) | Görüntüyü merkezin etrafında döndürür. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_61) | Görüntüyü döndürür, çevirir veya döndürüp çevirir. |
| kaydet() | Görüntü verilerini temel akışa kaydeder. |
| [save(file_path)](#save_file_path_62) | Nesnenin verilerini belirtilen dosya konumuna kaydeder. |
| [save(file_path, options)](#save_file_path_options_63) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen dosya konumuna kaydeder. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_64) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen dosya konumuna kaydeder. |
| [save(file_path, over_write)](#save_file_path_over_write_65) | Nesnenin verilerini belirtilen dosya konumuna kaydeder. |
| [save(stream)](#save_stream_66) | Nesnenin verilerini belirtilen akışa kaydeder. |
| [save(stream, options_base)](#save_stream_options_base_67) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen akışa kaydeder. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_68) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen akışa kaydeder. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_69) | 32 bit ARGB piksellerini kaydeder. |
| cmyk_32_pikseli_kaydet(dikdörtgen, piksel) |  |
| cmyk_pikseli_kaydet(dikdörtgen, piksel) |  |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_70) | Pikselleri kaydeder (biçime özgü yöntem). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_71) | Ham veriyi kaydeder. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_72) | Belirtilen konum için bir görüntü 32 bit ARGB pikseli ayarlar. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_73) | Görüntü paletini ayarlar. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_74) | Belirtilen konum için bir görüntü pikseli ayarlar. |
| set_resolution(dpi_x, dpi_y) |  |
| [shallow_copy()](#shallow_copy__75) | Mevcut Katmanın sığ bir kopyasını oluşturur.<br/>            Açıklama için lütfen <see href="https://msdn.microsoft.com/ru-ru/library/system.object.memberwiseclone(v=vs.110).aspx" /> adresine bakın. |
| [to_bitmap()](#to_bitmap__76) |    |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_77) | Tüm tarama satırını belirtilen tarama satırı indeksine yazar. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_78) | Tüm tarama satırını belirtilen tarama satırı indeksine yazar. |
...
Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneği başlatır. Tembel başlatma için kurucu.
...
Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneğini bayt dizilerinden başlatır.

**Parameters:**

| Parametre | Tür | Açıklama |
| :- | :- | :- |
| bounds | [Rectangle](/psd/python-net/aspose.psd/rectangle) | Katman sınırları. |
| red_bytes | byte | Kırmızı baytlar. |
| green_bytes | byte | Yeşil baytlar. |
| blue_bytes | byte | Mavi baytlar. |
...
Yeni bir [Layer](/psd/python-net/aspose.psd.fileformats.psd.layers/layer/) sınıfı örneği başlatır.
...
| dispose_image | bool | eğer <c>true</c> olarak ayarlanırsa [görseli yok et]. |
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| layer_mask | [LayerMaskData](/psd/python-net/aspose.psd.fileformats.psd.layers/layermaskdata) | Katman maskesi. |
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| location | [Point](/psd/python-net/aspose.psd/point) | Konum. |
| image | [RasterImage](/psd/python-net/aspose.psd/rasterimage) | Görsel. |
...
Mevcut Katmanın sığ bir kopyasını oluşturur.<br/>            Açıklama için lütfen <see href="https://msdn.microsoft.com/ru-ru/library/system.object.memberwiseclone(v=vs.110).aspx" /> adresine bakın.

**Returns**

| Tür | Açıklama |
| :- | :- |
| [Layer](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | Mevcut Katmanın sığ bir kopyası. |
