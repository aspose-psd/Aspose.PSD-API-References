---
title: "LayerGroup Sınıf"
type: docs
weight: 950
url: /tr/python-net/aspose.psd.fileformats.psd.layers/layergroup/
---
...
| yükseklik | int | r | Katman grubunun yüksekliğini alır. |
...
| width | int | r | Katman grubunun genişliğini alır. |
