---
title: "ListStructure Sınıfı"
type: docs
weight: 90
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [ListStructure(key_name)](#ListStructure_key_name_1) | Yeni bir [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/) sınıfının örneğini başlatır. |
## **Properties**
| **Name** | **Tür** | **Erişim** | **Açıklama** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Yapı anahtarını tanımlar. |
| items_count | int | r | Öğe sayısını alır. |
...
| types | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | Yapıların bir dizisinin kopyasını alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
Yeni bir [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/) sınıfının örneğini başlatır.
