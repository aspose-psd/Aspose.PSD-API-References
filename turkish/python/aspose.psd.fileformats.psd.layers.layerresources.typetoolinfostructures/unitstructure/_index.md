---
title: "UnitStructure Sınıfı"
type: docs
weight: 180
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [UnitStructure(key_name)](#UnitStructure_key_name_1) | Yeni bir [UnitStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/) sınıfının örneğini başlatır. |
## **Properties**
...
| unit_type | [UnitTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes) | r/w | Birim tipini alır veya ayarlar. |
| değer | double | r/w | Değeri alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
Yeni bir [UnitStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/) sınıfının örneğini başlatır.
