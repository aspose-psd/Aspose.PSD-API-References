---
title: "BooleanStructure Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [BooleanStructure(key_name)](#BooleanStructure_key_name_1) | Yeni bir [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| değer | bool | r/w | Boolean değerini alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
Yeni bir [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/) sınıfının bir örneğini başlatır.
