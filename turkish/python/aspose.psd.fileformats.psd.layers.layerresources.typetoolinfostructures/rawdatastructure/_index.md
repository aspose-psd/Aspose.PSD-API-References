---
title: "RawDataStructure Sınıfı"
type: docs
weight: 140
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [RawDataStructure(key_name)](#RawDataStructure_key_name_1) | Yeni bir [RawDataStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/) sınıfının örneğini başlatır. |
## **Properties**
...
Yeni bir [RawDataStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/) sınıfının örneğini başlatır.
