---
title: "DoubleStructure Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [DoubleStructure(key_name)](#DoubleStructure_key_name_1) | Yeni bir [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) sınıfının örneğini başlatır. |
## **Properties**
...
| değer | double | r/w | Çift değerini alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
Yeni bir [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) sınıfının örneğini başlatır.
