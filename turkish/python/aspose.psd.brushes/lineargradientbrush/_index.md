...
type: docs
weight: 20
url: /tr/python-net/aspose.psd.brushes/lineargradientbrush/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [LinearGradientBrush()](#LinearGradientBrush__1) | Yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının yeni bir örneğini varsayılan parametrelerle başlatır.<br/>            Başlangıç rengi siyahtır, bitiş rengi beyazdır, açı 45 derecedir ve dikdörtgen (0,0) konumunda, (1,1) boyutundadır. |
| [LinearGradientBrush(point1, point2, color1, color2)](#LinearGradientBrush_point1_point2_color1_color2_2) | Belirtilen noktalar ve renklerle yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının örneğini başlatır. |
| [LinearGradientBrush(point1, point2, color1, color2)](#LinearGradientBrush_point1_point2_color1_color2_3) | Belirtilen noktalar ve renklerle yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının örneğini başlatır. |
| [LinearGradientBrush(rect, color1, color2, angle)](#LinearGradientBrush_rect_color1_color2_angle_4) | Bir dikdörtgene, başlangıç ve bitiş renklerine ve bir yön açısına dayalı olarak yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının örneğini başlatır. |
| [LinearGradientBrush(rect, color1, color2, angle)](#LinearGradientBrush_rect_color1_color2_angle_5) | Bir dikdörtgene, başlangıç ve bitiş renklerine ve bir yön açısına dayalı olarak yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının örneğini başlatır. |
| [LinearGradientBrush(rect, color1, color2, angle, is_angle_scalable)](#LinearGradientBrush_rect_color1_color2_angle_is_angle_scalable_6) | Bir dikdörtgene, başlangıç ve bitiş renklerine ve bir yön açısına dayalı olarak yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının örneğini başlatır. |
...
| end_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Bitiş gradyan rengini alır veya ayarlar. |
...
| linear_colors | [Color[]](/psd/python-net/aspose.psd/color) | r/w | Gradyanın başlangıç ve bitiş renklerini alır veya ayarlar. |
...
| start_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Başlangıç gradyan rengini alır veya ayarlar. |
...
| [set_blend_triangular_shape(focus)](#set_blend_triangular_shape_focus_8) | Merkez rengi ve her iki uçta tek bir renge doğru lineer bir düşüşe sahip bir lineer gradyan oluşturur. |
| [set_blend_triangular_shape(focus, scale)](#set_blend_triangular_shape_focus_scale_9) | Merkez rengi ve her iki uçta tek bir renge doğru lineer bir düşüşe sahip bir lineer gradyan oluşturur. |
| [set_sigma_bell_shape(focus)](#set_sigma_bell_shape_focus_10) | Çan şeklinde bir eğriye dayalı bir gradyan düşüşü oluşturur. |
| [set_sigma_bell_shape(focus, scale)](#set_sigma_bell_shape_focus_scale_11) | Çan şeklinde bir eğriye dayalı bir gradyan düşüşü oluşturur. |
...
Yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının yeni bir örneğini varsayılan parametrelerle başlatır.<br/>            Başlangıç rengi siyahtır, bitiş rengi beyazdır, açı 45 derecedir ve dikdörtgen (0,0) konumunda, (1,1) boyutundadır.
...
Belirtilen noktalar ve renklerle yeni bir [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) sınıfının örneğini başlatır.
...
| color1 | [Color](/psd/python-net/aspose.psd/color) | Lineer gradyanın başlangıç rengini temsil eden bir [Color](/psd/python-net/aspose.psd/color/) yapısı. |
| color2 | [Color](/psd/python-net/aspose.psd/color) | Lineer gradyanın bitiş rengini temsil eden bir [Color](/psd/python-net/aspose.psd/color/) yapısı. |
...
| color1 | [Color](/psd/python-net/aspose.psd/color) | Gradyan için başlangıç rengini temsil eden bir [Color](/psd/python-net/aspose.psd/color/) yapısı. |
| color2 | [Color](/psd/python-net/aspose.psd/color) | Bir [Color](/psd/python-net/aspose.psd/color/) yapısı, degrade için son rengi temsil eder. |
...
| color2 | [Color](/psd/python-net/aspose.psd/color) | Bir [Color](/psd/python-net/aspose.psd/color/) yapısı, degrade için son rengi temsil eder. |
| açı | float | Degrade'nin yön çizgisinin, x ekseninden saat yönünde derece cinsinden ölçülen açısı. |
| is_angle_scalable | bool | eğer <c>true</c> olarak ayarlanırsa, açı bu [LinearGradientBrush](/psd/python-net/aspose.psd.brushes/lineargradientbrush/) ile dönüşümler sırasında değiştirilir. |
...
Merkez rengi ve her iki uçta tek bir renge doğru lineer bir düşüşe sahip bir lineer gradyan oluşturur.

**Parameters:**

| Parametre | Tür | Açıklama |
| :- | :- | :- |
| odak | float | 0 ile 1 arasında bir değer, degrade merkezini (degrade'in yalnızca son renkten oluştuğu nokta) belirler. |
...
| :- | :- | :- |
| odak | float | 0 ile 1 arasında bir değer, degrade merkezini (degrade'in yalnızca son renkten oluştuğu nokta) belirler. |
| scale | float | 0 ile 1 arasında bir değer, renklerin başlangıç renginden <paramref name="focus" /> (son renk) kadar ne kadar hızlı azaldığını belirler. |
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| odak | float | 0 ile 1 arasında bir değer, degrade merkezini (başlangıç rengi ve son rengin eşit şekilde karıştığı nokta) belirler. |
...
| :- | :- | :- |
| odak | float | 0 ile 1 arasında bir değer, degrade merkezini (degrade'in yalnızca son renkten oluştuğu nokta) belirler. |
| scale | float | 0 ile 1 arasında bir değer, renklerin <paramref name="focus" /> noktasından ne kadar hızlı azaldığını belirler. |
