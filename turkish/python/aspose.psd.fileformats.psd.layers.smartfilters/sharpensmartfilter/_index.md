...
type: docs
weight: 40
url: /tr/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [SharpenSmartFilter()](#SharpenSmartFilter__1) | [SharpenSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/) sınıfının yeni bir örneğini başlatır. |
| [SharpenSmartFilter(source_descriptor)](#SharpenSmartFilter_source_descriptor_2) | [SharpenSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/) sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
[SharpenSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/sharpensmartfilter/) sınıfının yeni bir örneğini başlatır.
...
| :- | :- | :- |
| source_descriptor | [DescriptorStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure/) | Akıllı filtre bilgileri içeren tanımlayıcı yapı. |
