---
title: "GaussianBlurSmartFilter Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [GaussianBlurSmartFilter()](#GaussianBlurSmartFilter__1) | Yeni bir [GaussianBlurSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/) sınıfı örneği başlatır. |
## **Properties**
...
| yarıçap | double | r/w | Gauss akıllı filtrenin yarıçapını alır veya ayarlar. |
...
Yeni bir [GaussianBlurSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/) sınıfı örneği başlatır.
