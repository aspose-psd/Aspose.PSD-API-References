---
title: "CurvesLayer Sınıfı"
type: docs
weight: 90
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| önbellekte | bool | r |  |
| is_continuous_manager_used | bool | r/w | Bu örneğin continuous manager kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar. |
| is_discrete_manager_used | bool | r/w | Bu örneğin discrete manager kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar. |
...
| [get_curves_manager()](#get_curves_manager__8) | Eğri yöneticisini alır. |
...
| Tür | Açıklama |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) veya [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) bu, IsDiscreteManagerUsed ve IsContinuousManagerUsed özelliğine bağlıdır |
