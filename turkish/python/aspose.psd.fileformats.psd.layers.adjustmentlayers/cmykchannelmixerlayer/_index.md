---
title: "CmykChannelMixerLayer Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Siyah kanalı alır. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Camgöbeği kanalı alır. |
...
| sol | int | r/w |  |
| uzunluk | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Macenta kanalı alır. |
| monochrome | bool | r/w | Bu [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) tek renkli mi olduğunu gösteren bir değeri alır veya ayarlar. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Sarı kanalı alır. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Kanalın indeksini alır. CmykMixerChannel döndürür. |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Katmanı belirtilen katmana birleştirir |
| normalize_angle() |  |
