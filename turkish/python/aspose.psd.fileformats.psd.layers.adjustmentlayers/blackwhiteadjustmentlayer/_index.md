---
title: "BlackWhiteAdjustmentLayer Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Ton Rengi değerini alır veya ayarlar. |
| tint_color_blue | double | r/w | Mavi Ton Rengi çift değerini alır veya ayarlar. |
| tint_color_green | double | r/w | Yeşil Ton Rengi çift değerini alır veya ayarlar. |
| tint_color_red | double | r/w | Kırmızı Ton Rengi çift değerini alır veya ayarlar. |
| üst | int | r/w |  |
