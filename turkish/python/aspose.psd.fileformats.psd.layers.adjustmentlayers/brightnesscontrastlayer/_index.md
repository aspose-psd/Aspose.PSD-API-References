---
title: "BrightnessContrastLayer Sınıfı"
type: docs
weight: 30
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| parlaklık | int | r/w | Parlaklığı alır veya ayarlar. PS aralığında parlaklık -150 ile +150 arasındadır. Ancak bunu görmezden geliyoruz. |
...
| kontrast | int | r/w | Kontrastı alır veya ayarlar. PS aralığında kontrast -50 ile +100 arasındadır. Ancak bunu görmezden geliyoruz. |
