---
title: "ExposureLayer Sınıfı"
type: docs
weight: 100
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| kapatıldı | bool | r |  |
| pozlama | float | r/w | Pozlamayı alır veya ayarlar. PS aralığında Pozlama -20 ile +20 arasındadır. |
| ek_uzunluk | int | r |  |
...
| gama_düzeltme | float | r/w | GammaCorrection'ı alır veya ayarlar. PS aralığında GammaCorrection 9.99 ile +0.01 arasındadır. |
| alfa_var | bool | r |  |
...
| offset | float | r/w | Offset'i alır veya ayarlar. PS aralığında Offset -0.5 ile +0.5 arasındadır. |
| opaklık | byte | r/w |  |
