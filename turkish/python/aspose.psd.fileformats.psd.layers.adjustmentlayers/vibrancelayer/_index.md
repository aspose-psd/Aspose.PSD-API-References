---
title: "VibranceLayer Sınıfı"
type: docs
weight: 220
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
| sağ | int | r/w |  |
| doygunluk | int | r/w | Doygunluğu alır veya ayarlar. |
...
| canlılık | int | r/w | Canlılığı alır veya ayarlar. |
