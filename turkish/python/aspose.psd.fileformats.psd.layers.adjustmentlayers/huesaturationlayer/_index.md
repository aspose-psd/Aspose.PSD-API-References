---
title: "HueSaturationLayer Sınıfı"
type: docs
weight: 120
url: /tr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | byte | r/w |  |
| colorize | bool | r/w | Bu [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) renklenmiş mi olduğunu gösteren bir değeri alır veya ayarlar. |
...
| [get_range(index)](#get_range_index_20) | Aralığı alır. |
...
| Tür | Açıklama |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | Renk Aralığı Hsl |
