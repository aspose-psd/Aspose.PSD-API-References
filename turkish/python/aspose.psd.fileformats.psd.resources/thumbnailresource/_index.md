---
title: "ThumbnailResource Sınıfı"
type: docs
weight: 250
url: /tr/python-net/aspose.psd.fileformats.psd.resources/thumbnailresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [ThumbnailResource()](#ThumbnailResource__1) | ThumbnailResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
ThumbnailResource sınıfının yeni bir örneğini başlatır
