---
title: "BackgroundColorResource Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [BackgroundColorResource()](#BackgroundColorResource__1) | BackgroundColorResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Arka plan rengini alır veya ayarlar. |
...
BackgroundColorResource sınıfının yeni bir örneğini başlatır
