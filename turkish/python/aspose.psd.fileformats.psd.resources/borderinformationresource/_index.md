---
title: "BorderInformationResource Sınıfı"
type: docs
weight: 30
url: /tr/python-net/aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [BorderInformationResource()](#BorderInformationResource__1) | BorderInformationResource sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | Kenarlık birimlerini alır veya ayarlar. |
| width | double | r/w | Kenarlık genişliğini alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
BorderInformationResource sınıfının yeni bir örneğini başlatır.
