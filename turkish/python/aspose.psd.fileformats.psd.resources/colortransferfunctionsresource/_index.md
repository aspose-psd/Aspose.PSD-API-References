---
title: "ColorTransferFunctionsResource Sınıfı"
type: docs
weight: 60
url: /tr/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | Yeni bir ColorTransferFunctionsResource sınıf örneği başlatır. |
## **Properties**
...
| color_transfer_data | byte | r/w | Renk aktarım verisini alır veya ayarlar. |
...
Yeni bir ColorTransferFunctionsResource sınıf örneği başlatır.
