---
title: "QuickMaskInformationResource Sınıfı"
type: docs
weight: 220
url: /tr/python-net/aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource__1) | QuickMaskInformationResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| channel_id | short | r/w | Kanal tanımlayıcısını alır veya ayarlar. |
...
| is_mask_empty | bool | r/w | Bu örneğin maske boş olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
QuickMaskInformationResource sınıfının yeni bir örneğini başlatır
