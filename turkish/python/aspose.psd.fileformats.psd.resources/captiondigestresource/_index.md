---
title: "CaptionDigestResource Sınıfı"
type: docs
weight: 40
url: /tr/python-net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [CaptionDigestResource()](#CaptionDigestResource__1) | CaptionDigestResource sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| özet | byte | r/w | Özet'i alır veya ayarlar. |
...
CaptionDigestResource sınıfının yeni bir örneğini başlatır.
