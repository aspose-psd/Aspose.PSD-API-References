---
title: "DocumentSpecificIdsResource Sınıfı"
type: docs
weight: 70
url: /tr/python-net/aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [DocumentSpecificIdsResource()](#DocumentSpecificIdsResource__1) | DocumentSpecificIdsResource sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
DocumentSpecificIdsResource sınıfının yeni bir örneğini başlatır.
