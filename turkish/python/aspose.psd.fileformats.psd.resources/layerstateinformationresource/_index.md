---
title: "LayerStateInformationResource Sınıfı"
type: docs
weight: 180
url: /tr/python-net/aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [LayerStateInformationResource()](#LayerStateInformationResource__1) | Yeni bir LayerStateInformationResource sınıf örneği başlatır. |
## **Properties**
...
| layer_index | short | r/w | Katmanın indeksini alır veya ayarlar. |
...
Yeni bir LayerStateInformationResource sınıf örneği başlatır.
