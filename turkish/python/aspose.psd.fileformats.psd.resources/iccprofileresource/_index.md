---
title: "IccProfileResource Sınıfı"
type: docs
weight: 130
url: /tr/python-net/aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [IccProfileResource()](#IccProfileResource__1) | IccProfileResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
IccProfileResource sınıfının yeni bir örneğini başlatır
