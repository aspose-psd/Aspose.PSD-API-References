---
title: "TransparencyIndexResource Sınıfı"
type: docs
weight: 260
url: /tr/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | TransparencyIndexResource sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| transparency_index | short | r/w | Şeffaflık renk indeksini alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
TransparencyIndexResource sınıfının yeni bir örneğini başlatır.
