---
title: "LayerSelectionIdsResource Sınıfı"
type: docs
weight: 170
url: /tr/python-net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource__1) | LayerSelectionIdsResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| sayım | short | r/w | Sayımı alır veya ayarlar. |
...
| layer_ids | int | r/w | Katman kimliklerini alır veya ayarlar. |
...
LayerSelectionIdsResource sınıfının yeni bir örneğini başlatır
