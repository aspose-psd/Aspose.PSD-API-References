...
type: docs
weight: 310
url: /tr/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | WatermarkResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| is_watermark | bool | r/w | Bu örneğin filigran olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
WatermarkResource sınıfının yeni bir örneğini başlatır
