---
title: "LayerGroupInformationResource Sınıfı"
type: docs
weight: 150
url: /tr/python-net/aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource__1) | LayerGroupInformationResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| groups | short | r/w | Grupları alır veya ayarlar. |
...
LayerGroupInformationResource sınıfının yeni bir örneğini başlatır
