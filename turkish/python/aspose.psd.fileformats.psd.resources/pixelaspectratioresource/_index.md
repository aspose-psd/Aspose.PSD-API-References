---
title: "PixelAspectRatioResource Sınıfı"
type: docs
weight: 190
url: /tr/python-net/aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource__1) | PixelAspectRatioResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| aspect_ratio | double | r/w | En boy oranını alır veya ayarlar. |
...
PixelAspectRatioResource sınıfının yeni bir örneğini başlatır
