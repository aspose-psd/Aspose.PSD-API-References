---
title: "GlobalAltitudeResource Sınıfı"
type: docs
weight: 90
url: /tr/python-net/aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource__1) | GlobalAltitudeResource sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| rakım | int | r/w | Rakımı alır veya ayarlar. |
...
GlobalAltitudeResource sınıfının yeni bir örneğini başlatır
