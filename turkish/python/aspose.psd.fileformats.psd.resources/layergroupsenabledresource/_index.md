---
title: "LayerGroupsEnabledResource Sınıfı"
type: docs
weight: 160
url: /tr/python-net/aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource__1) | LayerGroupsEnabledResource sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| ds | byte | r/w | i ds'yi alır veya ayarlar. |
...
LayerGroupsEnabledResource sınıfının yeni bir örneğini başlatır.
