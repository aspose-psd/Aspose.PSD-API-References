...
description: "PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içeren SoLdResource sınıfını tanımlar."
type: docs
weight: 15
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
SoLdResource sınıfını tanımlar; bu sınıf bir PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içerir. Adobe® Photoshop® görüntülerinde akıllı nesne katmanlarını desteklemek için kullanılır.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Yeni bir [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) sınıf örneği başlatır. |
| [SoLdResource()](#SoLdResource--) | Yeni bir [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) sınıf örneği başlatır. |
## Alanlar
...
| [TypeToolKey](#TypeToolKey) | Tür aracı bilgi anahtarı: 'SoLd'. |
...
Yeni bir [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) sınıf örneği başlatır. Hazır bir örnek elde etmek için Items özelliğini ayarlamak ya da InitializeItems() metodunu çağırmak gerekir. Bu yapıcı, [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) tarafından ve birim testlerinde kullanılmak üzere tasarlanmıştır. SoLdResource sınıflarını oluşturmak için [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) kullanın.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| uniqueId | java.util.UUID | Akıllı nesne katman verisinin benzersiz tanımlayıcısı [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Yeni bir [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource) sınıf örneği başlatır. Bu varsayılan yapıcı, SoLdResourceLoader tarafından kullanılmak üzere tasarlanmıştır. SoLdResource sınıflarını oluşturmak için [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) kullanın.
