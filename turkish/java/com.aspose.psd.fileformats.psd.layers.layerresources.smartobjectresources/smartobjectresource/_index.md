...
description: "PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içeren SmartObjectResource sınıfını tanımlar."
type: docs
weight: 13
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource/
---
...
SmartObjectResource sınıfını tanımlar; bu sınıf bir PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içerir. Sold ve Sole kaynakları için temel sınıftır ve Adobe\\ufffd Photoshop\\ufffd görüntülerinde akıllı nesne katmanlarını desteklemek için kullanılır.
## Alanlar
