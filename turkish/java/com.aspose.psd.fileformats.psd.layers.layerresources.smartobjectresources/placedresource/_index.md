...
description: "PSD dosyasındaki yerleştirilmiş bir katman veya akıllı nesne katmanı hakkında ortak bilgi içeren PlacedResource sınıfını tanımlar."
type: docs
weight: 12
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Warp öğeleri alınır veya ayarlanır. |
