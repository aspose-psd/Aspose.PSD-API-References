...
description: "Metin hizalama modu."
type: docs
weight: 13
url: /tr/java/com.aspose.psd.fileformats.psd.layers.text.rendering/justificationmode/
---
...
| Alan | Açıklama |
| --- | --- |
| [Center](#Center) | Orta metin. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Left](#Left) | Sola hizalanmış metin. |
| [Right](#Right) | Sağ hizalı metin. |
## Yöntemler
...
Sol hizalı metin. Sol-sağ yönlü modda, Sol konumu Sol’dur. Sağ-sol yönlü modda, Sol konumu Sağ’dır.
...
Sağ hizalı metin. Sol-sağ yönlü modda, Sağ konumu Sağ’dır. Sağ-sol yönlü modda, Sağ konumu Sol’dur.
