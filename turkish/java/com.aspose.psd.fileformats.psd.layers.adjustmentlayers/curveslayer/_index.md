...
description: "Eğriler Ayarlama Katmanı"
type: docs
weight: 17
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | Eğriler yöneticisini alır. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | Bu örneğin sürekli yönetici kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | Bu örneğin ayrık yönetici kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | Bu örneğin sürekli yönetici kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | Bu örneğin ayrık yönetici kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar. |
...
Bu örneğin sürekli yönetici kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar.

Değer:  true  bu örnek sürekli yönetici kullanılıyorsa; aksi takdirde,  false .
...
Bu örneğin ayrık yönetici kullanılıp kullanılmadığını gösteren bir değeri alır veya ayarlar.

Değer:  true  bu örnek ayrık yönetici kullanılıyorsa; aksi takdirde,  false .
...
| piksel | int[] | Piksel. |
| start | [Point](../../com.aspose.psd/point) | Başlangıç. |
| end | [Point](../../com.aspose.psd/point) | Bitiş. |
