...
description: "Renk dengesi ayarlama katmanı sınıfı."
type: docs
weight: 16
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Alır veya ayarlar Shadows YellowBlue Balance. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Mevcut gölgeler, orta tonlar ve vurgular için düzeltmeleri belirtilen int RGB dizisine uygula. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Alır veya ayarlar Shadows YellowBlue Balance. |
...
Alır veya ayarlar Shadows YellowBlue Balance.
...
Mevcut gölgeler, orta tonlar ve vurgular için düzeltmeleri belirtilen int RGB dizisine uygula.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| piksel | int[] | Bu int renk RGB dizisi. |
