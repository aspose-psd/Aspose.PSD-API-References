...
description: "Seçici Renk Ayarlama Katmanı."
type: docs
weight: 28
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Seçici renk ile cmyk düzeltmesini alır. |
| [getContainer()](#getContainer--) | Görüntü konteynerini alır. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Düzeltme yöntemini alır veya ayarlar. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Selective Color katmanını işler. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Seçici renk ile cmyk düzeltmesini ayarlar. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Görüntü konteynerini ayarlar. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Düzeltme yöntemini alır veya ayarlar. |
...
Seçici renk ile cmyk düzeltmesini alır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| selectiveColorsType | int | Seçici renkler. |
...
Düzeltme yöntemini alır veya ayarlar.

Değer: Düzeltme yöntemi.
...
Selective Color katmanını işler.
...
Seçici renk ile cmyk düzeltmesini ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| selectiveColorsType | int | Seçici renklerin türü. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Cmyk Düzeltmesi. |
