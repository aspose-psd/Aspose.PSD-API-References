...
description: "Siyah ve Beyaz ayarlama katmanı sınıfı."
type: docs
weight: 11
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| [getTintColor()](#getTintColor--) | Renk tonu değerini alır veya ayarlar. |
| [getTintColorBlue()](#getTintColorBlue--) | Mavi renk tonu çift değerini alır veya ayarlar. |
| [getTintColorGreen()](#getTintColorGreen--) | Yeşil renk tonu çift değerini alır veya ayarlar. |
| [getTintColorRed()](#getTintColorRed--) | Kırmızı renk tonu çift değerini alır veya ayarlar. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | Piksel işleme yapar. |
...
| [setTintColor(int value)](#setTintColor-int-) | Renk tonu değerini alır veya ayarlar. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | Mavi renk tonu çift değerini alır veya ayarlar. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | Yeşil renk tonu çift değerini alır veya ayarlar. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | Kırmızı renk tonu çift değerini alır veya ayarlar. |
...
Renk tonu değerini alır veya ayarlar.

Değer: Renk tonu değeri.
