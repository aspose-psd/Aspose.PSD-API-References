...
description: "Ters çevirme ayarlama katmanı sınıfı."
type: docs
weight: 21
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
Ters çevirme ayarlama katmanı sınıfı.
## Alanlar
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Invert ayar katmanını işler. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Belirtilen int ARGB dizisine invert düzeltmelerini uygula. |
...
Belirtilen int ARGB dizisine invert düzeltmelerini uygula.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| piksel | int[] | int ARGB dizisi. |
