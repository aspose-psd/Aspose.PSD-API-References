...
description: "Pozlama Ayarlama katmanı."
type: docs
weight: 18
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getGammaCorrection()](#getGammaCorrection--) | GammaCorrection değerini alır veya ayarlar. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | GammaCorrection değerini alır veya ayarlar. |
...
GammaCorrection'ı alır veya ayarlar. PS için GammaCorrection aralığı 9.99 ile +0.01 arasındadır.

Değer: GammaCorrection.
...
Ofseti alır veya ayarlar. PS için Ofset aralığı -0.5 ile +0.5 arasındadır.
