...
description: "CMYK Kanal Mikseri Ayarlama katmanı."
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
CMYK Kanal Mikseri Ayarlama katmanı.
## Alanlar
...
| [getBlackChannel()](#getBlackChannel--) | Siyah kanalı alır. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Kanalın indeksini alır. |
...
| [getCyanChannel()](#getCyanChannel--) | Camgöbeği kanalı alır. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Magenta kanalını alır. |
...
| [getMonochrome()](#getMonochrome--) | Bu [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) tek renkli olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [getYellowChannel()](#getYellowChannel--) | Sarı kanalını alır. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Ayarlama katmanını işler. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Bu [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) tek renkli olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
Magenta kanalını alır.

Değer: Magenta kanalı.
...
Bu [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) tek renkli olup olmadığını gösteren bir değeri alır veya ayarlar.

Değer:  true  tek renkli ise; aksi takdirde,  false .
