...
description: "Gradyan harita katmanı."
type: docs
weight: 19
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
Gradient harita katmanı. GrdmResource'dan gelen verileri kullanarak Gradient harita render'ını işler.
## Alanlar
...
| [getGradientSettings()](#getGradientSettings--) | GrdmResource örneğinden geçirilen Gradient ayarları örneğini alır veya ayarlar. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Gradient harita katmanını işler. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | GrdmResource örneğinden geçirilen Gradient ayarları örneğini alır veya ayarlar. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | İlgili katman kaynağındaki katman verilerini güncelle [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
Gradient harita katmanını işler.
...
İlgili katman kaynağındaki katman verilerini güncelle [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
