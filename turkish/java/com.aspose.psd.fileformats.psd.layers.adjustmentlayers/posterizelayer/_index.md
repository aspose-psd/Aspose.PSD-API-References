...
description: "Posterleştirme katmanı."
type: docs
weight: 25
url: /tr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Posterize katmanı. PostResource verilerini kullanarak Posterize renderlamasını yönetir.
## Alanlar
...
| [getLevels()](#getLevels--) | Posterize katmanının seviyeleri. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Posterize katmanını işler. |
...
| [setLevels(short value)](#setLevels-short-) | Posterize katmanının seviyeleri. |
