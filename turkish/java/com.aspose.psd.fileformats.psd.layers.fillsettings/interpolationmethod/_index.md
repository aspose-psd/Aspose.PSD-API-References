...
description: "Photoshop gradyan enterpolasyon yöntemi için paketlenmiş fourCC değerleri."
type: docs
weight: 18
url: /tr/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Photoshop gradyan enterpolasyon yöntemi için paketlenmiş fourCC değerleri. Tanımlayıcı anahtar: "gradientsInterpolationMethod"
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Klasik (anahtar yoksa varsayılan eski). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Doğrusal (sondaki boşluğa dikkat edin). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Algısal. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Pürüzsüz. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Çizgili. |
## Yöntemler
...
'Gcls' \\u2014 Klasik (anahtar yoksa varsayılan eski).
...
'Lnr ' \\u2014 Doğrusal (sondaki boşluğa dikkat edin).
