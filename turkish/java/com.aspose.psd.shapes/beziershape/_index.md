...
type: docs
weight: 11
url: /tr/java/com.aspose.psd.shapes/beziershape/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [BezierShape()](#BezierShape--) | BezierShape sınıfının yeni bir örneğini başlatır. |
| [BezierShape(PointF[] points)](#BezierShape-com.aspose.psd.PointF---) | BezierShape sınıfının yeni bir örneğini başlatır. |
| [BezierShape(PointF[] points, boolean isClosed)](#BezierShape-com.aspose.psd.PointF---boolean-) | BezierShape sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
BezierShape sınıfının yeni bir örneğini başlatır.
