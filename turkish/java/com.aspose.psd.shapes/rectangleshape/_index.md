...
type: docs
weight: 17
url: /tr/java/com.aspose.psd.shapes/rectangleshape/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | RectangleShape sınıfının yeni bir örneğini başlatır. |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.psd.RectangleF-) | RectangleShape sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
RectangleShape sınıfının yeni bir örneğini başlatır.
