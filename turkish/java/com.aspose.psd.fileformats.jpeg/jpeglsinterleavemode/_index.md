...
description: "Çok bileşenli renk piksel verileri için ara birleştirme modunu tanımlar."
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.jpeg/jpeglsinterleavemode/
---
...
| [Line](#Line) | Ara birleştirme modu satır bazlıdır. |
| [None](#None) | Veri, bileşen bazlı olarak kodlanır ve saklanır: RRRGGGBBB. |
| [Sample](#Sample) | Veri örnek bazlı olarak kodlanır ve saklanır. |
## Yöntemler
...
Ara birleştirme modu satır bazlıdır. Bir sonraki satıra geçmeden önce her bileşenin tam bir satırı kodlanır.
...
Veri, bileşen bazlı olarak kodlanır ve saklanır: RRRGGGBBB.
...
Veri örnek bazlı olarak kodlanır ve saklanır. Renkli görüntüler için bu, RGBRGBRGB gibi bir formattır.
