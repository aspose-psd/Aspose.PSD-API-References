...
description: "Artboard katman sınıfı."
type: docs
weight: 10
url: /tr/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Katmanı katman grubuna ekler. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Katmanı katman grubuna ekler. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Katman grubunu ekler. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Sanat tahtası arka plan rengini alır veya ayarlar. |
...
| [getLayers()](#getLayers--) | Katman grubundaki katmanları alır |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | ArtboardLayer'ın gerçek sınırlarını alır. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Kaynaklardan  LayerSectionResource  öğesini alır. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Bir değeri alır veya ayarlar; bu değer [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) arka plan rengine sahip olup olmadığını gösterir. |
...
| [isOpen()](#isOpen--) | Klasörün açık olup olmadığını alır veya ayarlar; true olarak ayarlanırsa grup başlangıçta açık durumda olur, aksi takdirde küçültülmüş durumda olur. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Sanat tahtası arka plan rengini alır veya ayarlar. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Klasörün açık olup olmadığını alır veya ayarlar; true olarak ayarlanırsa grup başlangıçta açık durumda olur, aksi takdirde küçültülmüş durumda olur. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Katman. |
| indeks | int | Katmanın ekleneceği indeks. Geçersiz değerler katman listesinin sonu anlamına gelir. |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - İki LayerGroup nesnesinden oluşan bir dizi döndürür; ilk [0] başlangıç grup işaretçisi, ikinci [1] ise bitiş grup işaretçisidir.
### cacheData() {#cacheData--}
```
...
Sanat tahtası arka plan rengini alır veya ayarlar.
...
Katman grubundaki katmanları alır
...
ArtboardLayer'ın gerçek sınırlarını alır.
...
Kaynaklardan  LayerSectionResource  öğesini alır.
...
Bir değeri alır veya ayarlar; bu değer [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) arka plan rengine sahip olup olmadığını gösterir.
...
Klasörün açık olup olmadığını alır veya ayarlar; true olarak ayarlanırsa grup başlangıçta açık durumda olur, aksi takdirde küçültülmüş durumda olur.
