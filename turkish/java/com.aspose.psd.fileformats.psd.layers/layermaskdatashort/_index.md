...
description: "LayerMaskDataShort sınıfını tanımlar; bu sınıf, katmanın yalnızca raster veya vektör maskesi olduğu, ancak her ikisi birden olmadığı durumda PSD dosyası katmanındaki maske verileri hakkında bilgi içerir."
type: docs
weight: 23
url: /tr/java/com.aspose.psd.fileformats.psd.layers/layermaskdatashort/
---
...
LayerMaskDataShort sınıfını tanımlar; bu sınıf, katmanın yalnızca raster veya vektör maskesi olduğu ancak her ikisinin birden bulunmadığı zaman PSD dosya katmanındaki maske verileri hakkında bilgi içerir. Aksi takdirde, bir [LayerMaskDataFull](../../com.aspose.psd.fileformats.psd.layers/layermaskdatafull) kullanılır. Katmanda yalnızca raster maskesi varsa ImageData raster maske veri baytlarını içerir. Katmanda yalnızca vektör maskesi varsa ImageData vektör maskesinin rasterleştirilmiş (önbelleğe alınmış) veri baytlarını içerir. LayerMaskData.ImageData ([LayerMaskData.getImageData](../../com.aspose.psd.fileformats.psd.layers/layermaskdata\#getImageData)/[LayerMaskData.setImageData(byte[])](../../com.aspose.psd.fileformats.psd.layers/layermaskdata\#setImageData-byte---)) bayt uzunluğu, Width \* Height değerine eşit olmalıdır LayerMaskData.MaskRectangle ([LayerMaskData.getMaskRectangle](../../com.aspose.psd.fileformats.psd.layers/layermaskdata\#getMaskRectangle)/[LayerMaskData.setMaskRectangle(Rectangle)](../../com.aspose.psd.fileformats.psd.layers/layermaskdata\#setMaskRectangle-Rectangle-)) özellikleri.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LayerMaskDataShort()](#LayerMaskDataShort--) | Yeni bir [LayerMaskDataShort](../../com.aspose.psd.fileformats.psd.layers/layermaskdatashort) sınıfı örneği başlatır. |
## Yöntemler
...
| [getPadding()](#getPadding--) | Katman maskesi doldurmasını alır veya ayarlar. |
...
| [setPadding(short value)](#setPadding-short-) | Katman maskesi doldurmasını alır veya ayarlar. |
...
Yeni bir [LayerMaskDataShort](../../com.aspose.psd.fileformats.psd.layers/layermaskdatashort) sınıfı örneği başlatır.
...
Katman maskesi doldurmasını alır veya ayarlar.

Değer: Katman maskesi doldurması.
