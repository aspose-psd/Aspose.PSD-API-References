...
description: "Katman maskesi bayrakları"
type: docs
weight: 24
url: /tr/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| Alan | Açıklama |
| --- | --- |
| [Disabled](#Disabled) | Katman maskesi devre dışı. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | Karıştırma sırasında katman maskesini ters çevir. |
| [None](#None) | Tanımlı bayrak yok. |
| [RelativeToLayer](#RelativeToLayer) | Pozisyon katmana göre görecelidir. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | Kullanıcı maskesinin aslında diğer verilerin render edilmesinden geldiğini gösterir. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | Kullanıcı ve/veya vektör maskelerinin parametrelerle uygulanmış olduğunu gösterir. |
## Yöntemler
...
Karıştırma sırasında katman maskesini ters çevir.
...
Pozisyon katmana göre görecelidir.
...
Kullanıcı maskesinin aslında diğer verilerin render edilmesinden geldiğini gösterir.
...
Kullanıcı ve/veya vektör maskelerinin parametrelerle uygulanmış olduğunu gösterir.
