...
description: "Grup katman sınıfı"
type: docs
weight: 19
url: /tr/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Katman grubunun yüksekliğini alır. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | LayerGroup içindeki tüm katmanların birleşik sınırlarını alır. |
...
| [getWidth()](#getWidth--) | Katman grubunun genişliğini alır. |
...
LayerGroup içindeki tüm katmanların birleşik sınırlarını alır.
...
Katman grubunun genişliğini alır.
