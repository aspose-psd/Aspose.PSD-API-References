...
description: "Metin katmanı sınıfı"
type: docs
weight: 30
url: /tr/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Yazı tipinin boyutunu düzeltir |
...
| [createInstance_internalized()](#createInstance-internalized--) | Yeni bir [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) sınıfının örneğini oluşturur. |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Yeni bir [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) sınıfının örneğini oluşturur. |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Motor verilerini alır. |
...
| [getFonts()](#getFonts--) | Metin katmanının yazı tipi kümesini alır. |
...
| [getInnerText()](#getInnerText--) | Katmanın metnini alır |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Kaynak işlemcisini alır veya ayarlar. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Dize biçimini alır. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Senkronizasyon kökünü alır. |
| [getText()](#getText--) | Metni alır. |
| [getTextBoundBox()](#getTextBoundBox--) | Metin sınırlama kutusunu alır veya ayarlar. |
| [getTextColor()](#getTextColor--) | Metnin rengini alır. |
| [getTextData()](#getTextData--) | Metin bölümlerini alır. |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Arar ve [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) kaynağını [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) katmanından alır. |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Değerin [was changed] olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Belirtilen fontun [is font available] olup olmadığını belirler. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Fontu ön işler. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Fontu varsayılanla değiştirir. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Katmanın metnini alır |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Kaynak işlemcisini alır veya ayarlar. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Metin sınırlama kutusunu alır veya ayarlar. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Değerin [was changed] olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Kaynaklardaki [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) sınırlarını günceller. |
| [updateText(String text)](#updateText-java.lang.String-) | Metni günceller. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Metni günceller. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Metni günceller. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Metni günceller. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Metni günceller. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Metni günceller. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Metni günceller. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Metni günceller. |
| [wait()](#wait--) |  |
...
Yazı tipinin boyutunu düzeltir

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| newSize | float | Yeni font boyutu |
| yyTransform | double | 'yy' Dönüşüm matrisi parametresi |

**Returns:**
float - Düzeltildi boyut
...
Yeni bir [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) sınıfının örneğini oluşturur.
...
Motor verilerini alır.

Değer: Motor verileri.
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - Metin katmanının ayarlanan fontları.
...
Kaynak işlemcisini alır veya ayarlar.

Değer: Kaynak işleyicisi.
...
Metin sınırlama kutusunu alır veya ayarlar.

Değer: Metin sınırlama kutusu.
...
Arar ve [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) kaynağını [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) katmanından alır.
...
Değerin [was changed] olup olmadığını gösteren bir değeri alır veya ayarlar.

Değer:  true  eğer [was changed]; aksi takdirde,  false .
...
Belirtilen fontun [is font available] olup olmadığını belirler.
...
**Returns:**
boolean - True eğer yazı tipi Mevcut ise
...
Fontu varsayılanla değiştirir.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | Yazı tipi. |
| defaultFontName | java.lang.String | Yazı tipinin varsayılan adı. |
...
| newWidth | int | Yeni genişlik. |
| newHeight | int | Yeni yükseklik. |
| resizeType | int | Yeniden boyutlandırma dönüşümünün türü  ResizeType |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Kaynaklardaki [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) sınırlarını günceller.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Metnin mutlak konumu ve boyutu. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Metnin textBox'a göre konumu ve boyutu. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| metin | java.lang.String | Metin değeri. |
...
| --- | --- | --- |
| metin | java.lang.String | Metin değeri. |
| color | [Color](../../com.aspose.psd/color) | Renk değeri. |
...
| --- | --- | --- |
| metin | java.lang.String | Metin değeri. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Sol üst koordinat. |
...
| metin | java.lang.String | Metin değeri. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Sol üst koordinat. |
| fontSize | float | Yazı tipinin boyutu. |
