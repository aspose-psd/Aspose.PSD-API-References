...
description: "psd katmanı."
type: docs
weight: 16
url: /tr/java/com.aspose.psd.fileformats.psd.layers/layer/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Layer()](#Layer--) | Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneği başlatır. |
| [Layer(RasterImage image)](#Layer-com.aspose.psd.RasterImage-) |  |
| [Layer(RasterImage image, boolean disposeImage)](#Layer-com.aspose.psd.RasterImage-boolean-) | Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneği başlatır. |
| [Layer(InputStream stream)](#Layer-java.io.InputStream-) | Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneği başlatır. |
| [Layer(Rectangle bounds, byte[] redBytes, byte[] greenBytes, byte[] blueBytes, String name)](#Layer-com.aspose.psd.Rectangle-byte---byte---byte---java.lang.String-) | Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneğini bayt dizilerinden başlatır. |
## Alanlar
...
Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneği başlatır. Tembel başlatma için kurucu.
...
Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneği başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| image | [RasterImage](../../com.aspose.psd/rasterimage) | Görüntü. |
| disposeImage | boolean | eğer true olarak ayarlanırsa [dispose image]. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| stream | java.io.InputStream | Görüntü akışı |
...
Yeni bir [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) sınıf örneğini bayt dizilerinden başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Katman sınırları. |
