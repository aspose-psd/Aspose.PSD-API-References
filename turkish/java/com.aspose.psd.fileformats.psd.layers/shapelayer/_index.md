...
description: "Şekil katmanı."
type: docs
weight: 29
url: /tr/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Şekil katmanı. Şekil katmanı ve ilgili kaynaklarla çalışma mantığını kapsüller.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Yeni bir [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) sınıf örneği başlatır. |
## Alanlar
...
| [createInstance()](#createInstance--) | Yeni bir [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) sınıf örneği oluşturur. |
...
| [getFill()](#getFill--) | Şekil katmanındaki Şekillerin iç alanı için doldurma ayarları. |
...
| [getPath()](#getPath--) | Bir Şekil katmanında bulunan Yollar kümesini alır. |
...
| [getStroke()](#getStroke--) | Şekillerin Çizgi (Stroke) ayarlarını alır veya ayarlar. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | [global resources changed] gerçekleştiğinde çağrılır. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | [resources change] gerçekleştiğinde çağrılır. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Şekil katmanındaki Şekillerin iç alanı için doldurma ayarları. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Şekillerin Çizgi (Stroke) ayarlarını alır veya ayarlar. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Şekil katmanı özelliklerinden kaynakları günceller. |
...
Yeni bir [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) sınıf örneği başlatır. Tüm kaynaklar varsayılan durumlarında oluşturulur.
...
Yeni bir [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) sınıf örneği oluşturur.
...
Şekil katmanındaki Şekillerin iç alanı için doldurma ayarları.
...
Bir Şekil katmanında bulunan Yollar kümesini alır.
...
Şekillerin Çizgi (Stroke) ayarlarını alır veya ayarlar.
...
**Returns:**
boolean - Katmanın geçerli olduğunu gösteren Boolean değeri.
...
[global resources changed] gerçekleştiğinde çağrılır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| gönderici | java.lang.Object | Gönderici. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | Olay verilerini içeren EventArgs örneği. |
...
[resources change] gerçekleştiğinde çağrılır.
...
Şekil katmanı özelliklerinden kaynakları günceller.
