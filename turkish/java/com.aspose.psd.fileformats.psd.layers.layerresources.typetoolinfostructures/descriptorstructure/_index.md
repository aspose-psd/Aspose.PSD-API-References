...
description: "Tanımlayıcı yapısı"
type: docs
weight: 13
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [DescriptorStructure(ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#DescriptorStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Yeni bir [DescriptorStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure) sınıf örneği başlatır. |
## Alanlar
...
| [getStructures()](#getStructures--) | Yapıları alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Yapıları alır veya ayarlar. |
...
Yeni bir [DescriptorStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure) sınıf örneği başlatır.
