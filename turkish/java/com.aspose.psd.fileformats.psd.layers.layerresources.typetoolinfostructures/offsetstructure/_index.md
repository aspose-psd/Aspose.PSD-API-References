...
description: "Ofset yapısı."
type: docs
weight: 21
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) sınıfının örneğini başlatır. |
## Alanlar
...
| [getValue()](#getValue--) | Tamsayı değerini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Tamsayı değerini alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure) sınıfının örneğini başlatır.
