...
description: "Double değerler dizisini ve ölçü birimlerini tutan UnitArrayStructure sınıfını tanımlar."
type: docs
weight: 27
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
Double değerler dizisini ve ölçü birimlerini tutan UnitArrayStructure sınıfını tanımlar. PSD dosya kaynaklarında kullanılır, genellikle [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) tarafından.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | Yeni bir [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) sınıfının örneğini başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [StructureKey](#StructureKey) | 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) anahtarını tanımlar. |
## Yöntemler
...
| [getKey()](#getKey--) | Bu birim dizi yapısı anahtarını alır. |
...
| [getUnitType()](#getUnitType--) | [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) değerlerinin ölçü birimi türünü alır veya ayarlar. |
| [getValueCount()](#getValueCount--) | Değer sayısını alır. |
| [getValues()](#getValues--) | Birim dizi yapısı değerlerini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) değerlerinin ölçü birimi türünü alır veya ayarlar. |
| [setValues(double[] value)](#setValues-double---) | Birim dizi yapısı değerlerini alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) sınıfının örneğini başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Anahtarın adı. |
| unitType | int | Birim tipi. |
| değerler | double[] | Değerler. |
...
'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) anahtarını tanımlar.
...
Bu birim dizi yapısı anahtarını alır.
...
[UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) değerlerinin ölçü birimi türünü alır veya ayarlar.

Değer: Ölçü birimi türü.
...
Değer: Birim dizi yapısındaki değer sayısı.
