...
description: "Birim yapısı."
type: docs
weight: 28
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) sınıfının örneğini başlatır. |
## Alanlar
...
| [getUnitType()](#getUnitType--) | Birim tipini alır veya ayarlar. |
...
| [setUnitType(int value)](#setUnitType-int-) | Birim tipini alır veya ayarlar. |
| [setValue(double value)](#setValue-double-) | Değeri alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) sınıfının örneğini başlatır.
...
Birim tipini alır veya ayarlar.
