...
description: "Name yapısı anahtarı 0x6E616D65, ASCII'de name kelimesini temsil eder, katman yolu veya ayar gibi bir öğenin adını temsil eden Unicode veya Pascal tarzı bir dizeyi depolamak için kullanılan basit bir yapıdır."
type: docs
weight: 19
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) sınıfının örneğini başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [StructureKey](#StructureKey) | Name yapısı anahtarı. |
## Yöntemler
...
| [getValue()](#getValue--) | Bir Name yapısının değerini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Name yapısının ilk dize değerini alır veya ayarlar. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Bir Name yapısının değerini alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) sınıfının örneğini başlatır.
...
Bir Name yapısının değerini alır veya ayarlar.
...
Name yapısının ilk dize değerini alır veya ayarlar. Genellikle satır sonu simgesi içerir.
