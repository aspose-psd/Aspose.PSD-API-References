...
description: "Bilinmeyen yapı."
type: docs
weight: 30
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Yapının okunabilir tip adını alır. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
[UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) sınıfının yeni bir örneğini başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Anahtar adı. |
| anahtar | int | Yapı anahtarı. |
...
Yapının okunabilir tip adını alır.
