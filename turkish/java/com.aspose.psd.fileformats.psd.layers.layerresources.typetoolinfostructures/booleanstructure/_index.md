...
description: "Boolean yapısı."
type: docs
weight: 11
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [BooleanStructure(ClassID keyName)](#BooleanStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [BooleanStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/booleanstructure) sınıfının örneğini başlatır. |
## Alanlar
...
| [getValue()](#getValue--) | boolean değerini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(boolean value)](#setValue-boolean-) | boolean değerini alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [BooleanStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/booleanstructure) sınıfının örneğini başlatır.
...
boolean değerini alır veya ayarlar.

Değer: Boolean bir değer.
