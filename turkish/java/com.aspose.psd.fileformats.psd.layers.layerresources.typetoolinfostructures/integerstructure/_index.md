...
description: "Integer yapısı."
type: docs
weight: 17
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [IntegerStructure(ClassID keyName)](#IntegerStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure) sınıf örneği başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [StructureKey](#StructureKey) | Tam sayı yapı anahtarı. |
## Yöntemler
...
| [getValue()](#getValue--) | Tam sayı değerini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Tam sayı değerini alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure) sınıf örneği başlatır.
