...
description: "Sınıf yapısı."
type: docs
weight: 12
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Yeni bir [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) sınıfının örneğini başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Yapı anahtarını tanımlar. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Yapı anahtarını tanımlar. |
| [StructureKeyType](#StructureKeyType) | Yapı anahtarını tanımlar. |
## Yöntemler
...
Yeni bir [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) sınıfının örneğini başlatır.
...
| structureKey | int | Yapı anahtarı. |
