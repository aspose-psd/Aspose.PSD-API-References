...
description: "Double yapısı."
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [DoubleStructure(ClassID keyName)](#DoubleStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) sınıfının örneğini başlatır. |
## Alanlar
...
| [getValue()](#getValue--) | double değerini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(double value)](#setValue-double-) | double değerini alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) sınıfının örneğini başlatır.
