...
description: "Alias yapısı."
type: docs
weight: 10
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) sınıf örneği başlatır. |
## Alanlar
...
| [getDataLength()](#getDataLength--) | Verinin tam uzunluğunu bayt cinsinden alır. |
| [getFullPath()](#getFullPath--) | Tam yolu alır veya ayarlar. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Tam yolu alır veya ayarlar. |
...
Yeni bir [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) sınıf örneği başlatır.
...
Verinin tam uzunluğunu bayt cinsinden alır.

Değer: Bayt cinsinden veri uzunluğu.
