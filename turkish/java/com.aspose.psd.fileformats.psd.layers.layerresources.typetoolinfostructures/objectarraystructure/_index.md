...
description: "ObjectArrayStructure sınıfını tanımlar; genellikle bir dizi tutar."
type: docs
weight: 20
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
ObjectArrayStructure sınıfını tanımlar; genellikle [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) dizisini tutar. PSD dosya kaynaklarında, örneğin PlLd Kaynağı ve SoLd Kaynağı gibi kullanılır.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Yeni bir [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) sınıfının örneğini başlatır. |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Yeni bir [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) sınıfının örneğini başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [StructureKey](#StructureKey) | 'ObAr' yapı anahtarını tanımlar. |
## Yöntemler
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Object array sınıf kimliğini alır veya ayarlar. |
| [getClassName()](#getClassName--) | Object array sınıf adını alır veya ayarlar. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Yapıların listesini alır. |
| [getKey()](#getKey--) | Object array yapı anahtarını alır. |
| [getKeyName()](#getKeyName--) | Anahtar adını alır veya ayarlar. |
| [getLength()](#getLength--) | OSTypeStructure uzunluğunu bayt cinsinden alır. |
...
| [getStructureCount()](#getStructureCount--) | Object array alt yapı sayısını alır. |
| [getStructures()](#getStructures--) | Nesne dizi yapısındaki alt yapıları alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Object array sınıf kimliğini alır veya ayarlar. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Object array sınıf adını alır veya ayarlar. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Nesne dizi yapısındaki alt yapıları alır veya ayarlar. |
...
Yeni bir [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) sınıfının örneğini başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| keyName | java.lang.String | Anahtarın adı. |
| classIdName | java.lang.String | Sınıf tanımlayıcısının adı. |
...
Değer: Nesne dizi sınıf kimliği.
...
Object array sınıf adını alır veya ayarlar.

Değer: Nesne dizi sınıf adı.
...
Object array yapı anahtarını alır.
...
OSTypeStructure uzunluğunu bayt cinsinden alır.
...
Değer: Nesne dizi yapısındaki alt yapı sayısı.
...
Nesne dizi yapısındaki alt yapıları alır veya ayarlar.

Değer: Nesne dizi yapısındaki alt yapılar.
