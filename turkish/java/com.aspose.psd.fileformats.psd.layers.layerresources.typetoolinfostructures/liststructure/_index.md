...
description: "Liste yapısı."
type: docs
weight: 18
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [ListStructure(ClassID keyName)](#ListStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) sınıfının bir örneğini başlatır. |
## Alanlar
...
| [getItemsCount()](#getItemsCount--) | Öğelerin sayısını alır. |
...
| [getTypes()](#getTypes--) | Türleri alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTypes(OSTypeStructure[] value)](#setTypes-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Türleri alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Yeni bir [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) sınıfının bir örneğini başlatır.
