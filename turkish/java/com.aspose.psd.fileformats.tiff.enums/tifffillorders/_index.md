...
type: docs
weight: 17
url: /tr/java/com.aspose.psd.fileformats.tiff.enums/tifffillorders/
---
...
Bir bayt içindeki veri sırası.

FILLORDER etiketi için olası değerler.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Lsb2Msb](#Lsb2Msb) | En az anlamlı -> en çok. |
| [Msb2Lsb](#Msb2Lsb) | En önemlisi -> en azı. |
## Yöntemler
