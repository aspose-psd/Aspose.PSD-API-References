...
type: docs
weight: 10
url: /tr/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
CCITT Group 3/4 faks kodlaması için seçenekler.

GROUP3OPTIONS / TiffTag.T4OPTIONS ve TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS etiketleri için olası değerler.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Encoding1D](#Encoding1D) | 1 boyutlu kodlama. |
| [Encoding2D](#Encoding2D) | 2 boyutlu kodlama. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | Bayt sınırına doldur. |
| [Uncompressed](#Uncompressed) | Veri sıkıştırılmadı. |
## Yöntemler
