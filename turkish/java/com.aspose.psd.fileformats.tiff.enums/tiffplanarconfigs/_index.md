...
type: docs
weight: 21
url: /tr/java/com.aspose.psd.fileformats.tiff.enums/tiffplanarconfigs/
---
...
PLANARCONFIG etiketi için olası değerler.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Contiguous](#Contiguous) | Tek görüntü düzlemi. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Separate](#Separate) | Verinin ayrı düzlemleri. |
## Yöntemler
