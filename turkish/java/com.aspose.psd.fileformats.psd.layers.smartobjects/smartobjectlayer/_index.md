...
description: "SmartObjectLayer sınıfını tanımlar; bu sınıf PSD dosyasında gömülü veya dış dosyada bağlı akıllı nesneyi içerir."
type: docs
weight: 10
url: /tr/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
SmartObjectLayer sınıfını tanımlar; bu sınıf, PSD dosyasına gömülmüş veya harici dosyada bağlı akıllı nesneyi içerir. Smart Objects ile şunları yapabilirsiniz: Yıkıcı olmayan dönüşümler gerçekleştirin. Katmanı ölçeklendirebilir, döndürebilir, eğebilir, bozulabilir, perspektif dönüşümü uygulayabilir veya katmanı orijinal görüntü verisini veya kalitesini kaybetmeden bükebilirsiniz çünkü dönüşümler don\\ufffdt orijinal veriyi etkiler. Illustrator'dan vektör sanat eseri gibi vektör verileriyle çalışın, aksi takdirde rasterleştirilir. Yıkıcı olmayan filtreleme yapın. Smart Objects'e uygulanan filtreleri istediğiniz zaman düzenleyebilirsiniz. Bir Smart Object'i düzenleyin ve tüm bağlı örneklerini otomatik olarak güncelleyin. Smart Object katmanına bağlı ya da bağlı olmayan bir katman maskesi uygulayın that\\ufffds, akıllı nesne katmanına bağlı ya da bağlanmamış olarak. Daha sonra son sürümlerle değiştireceğiniz düşük çözünürlüklü yer tutucu görüntülerle çeşitli tasarımlar deneyin. In Adobe\\ufffd Photoshop\\ufffd, bir görüntünün içeriğini bir PSD belgesine gömebilirsiniz. Daha fazla bilgi burada:   Gömülü bir akıllı nesne içeren bir katman, placed (PlLd) ve SoLd kaynaklarını akıllı nesne özellikleriyle içerir. PlLd kaynağı, PSD sürümleri 10'dan eski olduğunda tek başına olabilir. Bu kaynaklar, gömülü dosya adı ve diğer parametrelerle birlikte global Lnk2Resource içindeki LiFdDataSource'un UniqueId'sini içerir; ayrıca gömülü dosya içeriği orijinal formatta bir bayt dizisi olarak bulunur.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Yeni bir [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) sınıfı örneği başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [BlendSignature](#BlendSignature) | Karışım modu imzasını temsil eder. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Hem placed hem de smart object kaynakları bulundu mesajı |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Mesaj: Yalnızca gömülü bir akıllı nesneyi kopyalayabilirsiniz |
| [LayerHeaderSize](#LayerHeaderSize) | Katman başlığı boyutu. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Yerleştirilmiş veya akıllı nesne kaynağı bulunamadı mesajı |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Yanlış yerleştirilmiş kaynak indeksleri mesajı |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Bu gömülü akıllı nesneyi bağlı bir akıllı nesneye dönüştürür. |
...
| [duplicateLayer()](#duplicateLayer--) | Bu katmanı kopyalayarak yeni bir smart object layer oluşturur. |
| [embedLinked()](#embedLinked--) | Bağlı akıllı nesneyi bu katmana gömer. |
| [equals(Object obj)](#equals-java.lang.Object-) | Belirtilen Nesnenin bu örnekle eşit olup olmadığını belirler. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Gömülü veya bağlı içerikleri bir dosyaya dışa aktarır. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Render warp'ı alır veya ayarlar ya da PS resmini kullanır |
...
| [getContentType()](#getContentType--) | Akıllı nesne katman içeriğinin türünü alır. |
| [getContents()](#getContents--) | Akıllı nesne katmanının içeriğini alır veya ayarlar. |
| [getContentsBounds()](#getContentsBounds--) | Akıllı nesne içeriğinin sınırlarını alır veya ayarlar. |
| [getContentsSource()](#getContentsSource--) | Akıllı nesne içeriğinin kaynağını alır veya ayarlar. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Bükülmek üzere görüntünün son boyutunu alır veya ayarlar. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Orijinal dörtgeni alır veya ayarlar. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Yerleştirilmiş ve akıllı katman kaynak indekslerini ve uygun yerleştirilmiş kaynağı alır. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Yerleştirilmiş katman kaynağını alır. |
...
| [getSmartFilters()](#getSmartFilters--) | Akıllı filtreleri alır. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Dönüştürme dörtgenini alır veya ayarlar. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Bu, bükme ile ilgili işlevleri alır ve yardımcı olur. |
| [getWarpSettings()](#getWarpSettings--) | Bu, kaynaktan ayarlanmış veya alınmış Warp parametrelerini alır veya ayarlar (varsayılan). |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Akıllı nesne katmanının gömülü veya bağlı görüntü içeriğini alır. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Bu katmanı kopyalayarak yeni bir smart object layer oluşturur. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Bu [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) konteyneri ayarlandığında çağır. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Bağlı akıllı nesneyi yeni bir dosyaya yeniden bağlar. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Akıllı nesne katmanına gömülü akıllı nesne içeriğini değiştirir. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Akıllı nesne katmanına gömülü akıllı nesne içeriğini değiştirir. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | İçeriği bir dosyayla değiştirir. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | İçeriği bir dosyayla değiştirir. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | İçeriği bir dosyayla değiştirir. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | İçeriği bir dosyayla değiştirir. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Kanal verilerini yeniden boyutlandırır |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Render warp'ı alır veya ayarlar ya da PS resmini kullanır |
...
| [setContents(byte[] value)](#setContents-byte---) | Akıllı nesne katmanının içeriğini alır veya ayarlar. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Akıllı nesne içeriğinin sınırlarını alır veya ayarlar. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Akıllı nesne içeriğinin kaynağını alır veya ayarlar. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Bükülmek üzere görüntünün son boyutunu alır veya ayarlar. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Orijinal dörtgeni alır veya ayarlar. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Akıllı nesne sağlayıcısını alır. |
| [setTop(int value)](#setTop-int-) | Üst katman konumunu alır veya ayarlar. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Dönüştürme dörtgenini alır veya ayarlar. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Bu, kaynaktan ayarlanmış veya alınmış Warp parametrelerini alır veya ayarlar (varsayılan). |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Veri kaynağı tanımlayıcısını günceller. |
| [updateModifiedContent()](#updateModifiedContent--) | Değiştirilmiş içerikle akıllı nesne katmanı görüntü önbelleğini günceller. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Değiştirilmiş içerikle akıllı nesne katmanı görüntü önbelleğini günceller. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Yerleştirilmiş kaynak değiştiğinde veya dönüşüm gerektiğinde yerleştirilmiş / akıllı kaynakları günceller. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | \"IWarpSupport\" için katman önizlemesini güncellemek amacıyla bir sarmalayıcıdır. |
| [wait()](#wait--) |  |
...
Yeni bir [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) sınıfı örneği başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Öğelerin akışı |
...
Hem placed hem de smart object kaynakları bulundu mesajı
...
Mesaj: Yalnızca gömülü bir akıllı nesneyi kopyalayabilirsiniz
...
Yerleştirilmiş veya akıllı nesne kaynağı bulunamadı mesajı
...
Yanlış yerleştirilmiş kaynak indeksleri mesajı
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| linkedPath | java.lang.String | Bağlı yol. |
...
Bu katmanı kopyalayarak yeni bir akıllı nesne katmanı oluşturur. Gömülü akıllı nesneler için gömülü görüntünün paylaşıldığını unutmayın. Gömülü görüntüyü kopyalamak istiyorsanız [.newSmartObjectViaCopy](../../null/\\#newSmartObjectViaCopy) metodunu kullanın.
...
Bağlı akıllı nesneyi bu katmana gömer.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| filePath | java.lang.String | Dışa aktarma dosya yolu. |
...
Render warp'ı alır veya ayarlar ya da PS resmini kullanır
...
Akıllı nesne katman içeriğinin türünü alır. Gömülü akıllı nesne içeriği, gömülü ham görüntü dosyasıdır:  LiFdDataSource.Data . Bağlantılı akıllı nesne içeriği, mevcutsa bağlantılı görüntü dosyasının ham içeriğidir: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) true olduğunda Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library'den yüklemeyi desteklemiyoruz. Normal bağlantı dosyaları için, önce dosyayı kaynak görüntü yolu DataStreamSupporter.SourceImagePath'e göre aramak amacıyla LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) kullanırız; eğer mevcut değilse LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)) bakarız; yine yoksa bağlantı dosyasını görüntümüzün bulunduğu aynı dizinde ararız: DataStreamSupporter.SourceImagePath .

Değer: Akıllı nesne katman içeriğinin türü.
...
Akıllı nesne katman içeriğini alır veya ayarlar. Gömülü akıllı nesne içeriği, gömülü ham görüntü dosyasıdır:  LiFdDataSource.Data  ve özellikleridir. Bağlantılı akıllı nesne içeriği, mevcutsa bağlantılı görüntü dosyasının ham içeriği ve özellikleridir: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) true olduğunda Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library'den yüklemeyi desteklemiyoruz. Normal bağlantı dosyaları için, önce dosyayı kaynak görüntü yolu DataStreamSupporter.SourceImagePath'e göre aramak amacıyla LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) kullanırız; eğer mevcut değilse LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)) bakarız; yine yoksa bağlantı dosyasını görüntümüzün bulunduğu aynı dizinde ararız: DataStreamSupporter.SourceImagePath .
...
Akıllı nesne içeriğinin sınırlarını alır veya ayarlar.

Değer: Akıllı nesne sınırları.
...
Akıllı nesne içeriğinin kaynağını alır veya ayarlar.

Değer: Akıllı nesne veri kaynağı.
...
Bükülmek üzere görüntünün son boyutunu alır veya ayarlar.
...
Orijinal dörtgeni alır veya ayarlar.

Değer: Orijinal dörtgen.
...
Yerleştirilmiş ve akıllı katman kaynak indekslerini ve uygun yerleştirilmiş kaynağı alır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Kaynaklar. |
| placedResourceIndex | int[] | Yerleştirilen kaynağın indeksi. |
| smartResourceIndex | int[] | Akıllı kaynağın indeksi. |
...
Yerleştirilmiş katman kaynağını alır.
...
Dönüştürme dörtgenini alır veya ayarlar.

Değer: Dönüştürme dörtgeni.
...
Bu, bükme ile ilgili işlevleri alır ve yardımcı olur.
...
Bu, kaynaktan ayarlanmış veya alınmış Warp parametrelerini alır veya ayarlar (varsayılan).
...
Akıllı nesne katmanının gömülü veya bağlı görüntü içeriğini alır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Seçenekler. |
...
Bu katmanı kopyalayarak yeni bir akıllı nesne katmanı oluşturur. Adobe\\ufffd Photoshop\\ufffd'in Kopyala işlevi aracılığıyla Katman -> Akıllı Nesneler -> Yeni Akıllı Nesne'yi yeniden üretir. Yalnızca gömülü akıllı nesneler için etkin olduğunu, çünkü gömülü görüntünün de kopyalandığını unutmayın. Gömülü görüntüyü paylaşmak istiyorsanız [.duplicateLayer](../../null/\#duplicateLayer) yöntemini kullanın.
...
Bu [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) konteyneri ayarlandığında çağır.
...
Bağlı akıllı nesneyi yeni bir dosyaya yeniden bağlar. Sonrasında UpdateModifiedContent yöntemini çağırmaya gerek yok.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Görüntü. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Görüntü. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Çözünürlük ayarları. Null ise görüntü çözünürlüğü kullanılacaktır. |
...
İçeriği bir dosyayla değiştirir. Sonrasında UpdateModifiedContent yöntemini çağırmaya gerek yok.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Bağlı yol. |
| isReplaceOnlyThis | boolean | Bu bayrak, içeriğin bu Akıllı Katmandan mı yoksa bu içerikle tüm Akıllı Katmanlara mı değiştirileceğini gösterir. |
...
Kanal verilerini yeniden boyutlandırır
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Veri kaynağı tanımlayıcısını günceller.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | Veri kaynağı tanımlayıcısı. |
...
Değiştirilmiş içerikle akıllı nesne katmanı görüntü önbelleğini günceller.
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Görüntü. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Çözünürlük. |
| skipBoundsUpdate | boolean | true olarak ayarlanırsa  [sınır güncellemesini atla]. |
...
Yerleştirilmiş kaynak değiştiğinde veya dönüşüm gerektiğinde yerleştirilmiş / akıllı kaynakları günceller.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| toEmbedded | boolean | true olarak ayarlanırsa, gerekirse gömülü bir kaynağa dönüştürür, aksi takdirde bağlı bir kaynağa. |
...
\"IWarpSupport\" için katman önizlemesini güncellemek amacıyla bir sarmalayıcıdır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Yeni önizleme görüntüsünün piksel ve boyutu |
