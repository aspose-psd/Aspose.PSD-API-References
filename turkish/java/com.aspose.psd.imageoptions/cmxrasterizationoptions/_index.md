...
type: docs
weight: 11
url: /tr/java/com.aspose.psd.imageoptions/cmxrasterizationoptions/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [CmxRasterizationOptions()](#CmxRasterizationOptions--) | Yeni bir [CmxRasterizationOptions](../../com.aspose.psd.imageoptions/cmxrasterizationoptions) sınıfının örneğini başlatır. |
## Yöntemler
...
| [copyTo(VectorRasterizationOptions vectorRasterizationOptions)](#copyTo-com.aspose.psd.imageoptions.VectorRasterizationOptions-) | Kopyalar. |
...
| [getCenterDrawing()](#getCenterDrawing--) | Merkez çizim olup olmadığını gösteren değeri alır. |
| [getClass()](#getClass--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Arka plan rengini ayarlar. |
...
| [setCenterDrawing(boolean value)](#setCenterDrawing-boolean-) | Ortalanmış çizim olup olmadığını gösteren bir değeri ayarlar. |
...
| [setDrawColor(Color value)](#setDrawColor-com.aspose.psd.Color-) | Ön plan rengini ayarlar. |
...
| [setPageSize(SizeF value)](#setPageSize-com.aspose.psd.SizeF-) | Sayfa boyutunu ayarlar. |
...
| [setSmoothingMode(int value)](#setSmoothingMode-int-) | Yumuşatma modunu ayarlar. |
...
Yeni bir [CmxRasterizationOptions](../../com.aspose.psd.imageoptions/cmxrasterizationoptions) sınıfının örneğini başlatır.
...
| --- | --- | --- |
| vectorRasterizationOptions | [VectorRasterizationOptions](../../com.aspose.psd.imageoptions/vectorrasterizationoptions) | Vektör rasterleştirme seçenekleri. |
...
Merkez çizim olup olmadığını gösteren değeri alır.

**Returns:**
boolean - ortalanmış çizim olup olmadığını gösteren bir değer.
### getClass() {#getClass--}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | bir arka plan rengi. |
...
Ortalanmış çizim olup olmadığını gösteren bir değeri ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | ortada çizim yapılıp yapılmadığını gösteren bir değer. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | ön plan rengi. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [SizeF](../../com.aspose.psd/sizef) | sayfa boyutu. |
