...
type: docs
weight: 20
url: /tr/java/com.aspose.psd.imageoptions/positioningtypes/
---
...
| Alan | Açıklama |
| --- | --- |
| [DefinedByDocument](#DefinedByDocument) | Belge sayfa ayarlarıyla tanımlanan sayfadaki mutlak konumlandırma. |
| [DefinedByOptions](#DefinedByOptions) | Seçenek sayfa ayarlarıyla tanımlanan sayfadaki mutlak konumlandırma. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | Göreli konumlandırma ve boyut. |
## Yöntemler
...
Belge sayfa ayarlarıyla tanımlanan sayfadaki mutlak konumlandırma.
...
Seçenek sayfa ayarlarıyla tanımlanan sayfadaki mutlak konumlandırma.
...
Göreli konumlandırma ve boyut. Tüm grafik nesnelerinin sınırı tarafından belirlenir.
