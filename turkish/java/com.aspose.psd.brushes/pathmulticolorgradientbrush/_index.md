...
type: docs
weight: 16
url: /tr/java/com.aspose.psd.brushes/pathmulticolorgradientbrush/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [PathMulticolorGradientBrush(PointF[] points)](#PathMulticolorGradientBrush-com.aspose.psd.PointF---) | Belirtilen noktalarla PathMulticolorGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathMulticolorGradientBrush(PointF[] points, int wrapMode)](#PathMulticolorGradientBrush-com.aspose.psd.PointF---int-) | Belirtilen noktalar ve sarma modu ile PathMulticolorGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathMulticolorGradientBrush(Point[] points)](#PathMulticolorGradientBrush-com.aspose.psd.Point---) | Belirtilen noktalarla PathMulticolorGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathMulticolorGradientBrush(Point[] points, int wrapMode)](#PathMulticolorGradientBrush-com.aspose.psd.Point---int-) | Belirtilen noktalar ve sarma modu ile PathMulticolorGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathMulticolorGradientBrush(GraphicsPath path)](#PathMulticolorGradientBrush-com.aspose.psd.GraphicsPath-) | Belirtilen yol ile PathMulticolorGradientBrush sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
| [getInterpolationColors()](#getInterpolationColors--) | Çok renkli doğrusal bir degrade tanımlayan bir com.aspose.psd.ColorBlend alır veya ayarlar. |
...
| [setInterpolationColors(ColorBlend value)](#setInterpolationColors-com.aspose.psd.ColorBlend-) | Çok renkli doğrusal bir degrade tanımlayan bir com.aspose.psd.ColorBlend alır veya ayarlar. |
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | Yolun köşelerini oluşturan noktaları temsil eden Aspose.Imaging.PointF yapılarının bir dizisi. |
| wrapMode | int | Bu PathMulticolorGradientBrush ile çizilen doldurmaların nasıl döşeneceğini belirten bir Aspose.Imaging.WrapMode. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| path | [GraphicsPath](../../com.aspose.psd/graphicspath) | Bu PathMulticolorGradientBrush tarafından doldurulan alanı tanımlayan GraphicsPath. |
...
Çok renkli doğrusal bir degrade tanımlayan bir com.aspose.psd.ColorBlend alır veya ayarlar.

Değer: Çok renkli doğrusal bir degrade tanımlayan bir com.aspose.psd.ColorBlend.
