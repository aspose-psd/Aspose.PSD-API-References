...
description: "png görüntü istisnası."
type: docs
weight: 15
url: /tr/java/com.aspose.psd.coreexceptions.imageformats/pngimageexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [PngImageException(String message)](#PngImageException-java.lang.String-) | PngImageException sınıfının yeni bir örneğini başlatır. |
| [PngImageException(String message, Throwable innerException)](#PngImageException-java.lang.String-java.lang.Throwable-) | PngImageException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
