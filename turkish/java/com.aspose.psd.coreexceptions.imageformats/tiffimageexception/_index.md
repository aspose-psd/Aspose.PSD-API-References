...
description: "Tiff görüntü istisnası"
type: docs
weight: 19
url: /tr/java/com.aspose.psd.coreexceptions.imageformats/tiffimageexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [TiffImageException(String message)](#TiffImageException-java.lang.String-) | TiffImageException sınıfının yeni bir örneğini başlatır. |
| [TiffImageException(String message, Throwable innerException)](#TiffImageException-java.lang.String-java.lang.Throwable-) | TiffImageException sınıfının yeni bir örneğini başlatır. |
| [TiffImageException(String message, int error)](#TiffImageException-java.lang.String-int-) | TiffImageException sınıfının yeni bir örneğini başlatır. |
| [TiffImageException(int error)](#TiffImageException-int-) | TiffImageException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
| [getOptionsError()](#getOptionsError--) | tiff seçenekleri hatasını alır. |
...
TiffImageException sınıfının yeni bir örneğini başlatır.
