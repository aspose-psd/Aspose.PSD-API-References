...
type: docs
weight: 13
url: /tr/java/com.aspose.psd.coreexceptions.imageformats/jpegexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [JpegException(String message)](#JpegException-java.lang.String-) | JpegException sınıfının yeni bir örneğini başlatır. |
| [JpegException(String message, Throwable innerException)](#JpegException-java.lang.String-java.lang.Throwable-) | JpegException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
JpegException sınıfının yeni bir örneğini başlatır.
