...
type: docs
weight: 10
url: /tr/java/com.aspose.psd.coreexceptions.imageformats/bmpimageexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [BmpImageException(String message)](#BmpImageException-java.lang.String-) | BmpImageException sınıfının yeni bir örneğini başlatır. |
| [BmpImageException(String message, Throwable innerException)](#BmpImageException-java.lang.String-java.lang.Throwable-) | BmpImageException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
