...
description: "Bilinmeyen akıllı filtre verilerini tutmak için sınıf."
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/unknownsmartfilter/
---
...
Bilinmeyen akıllı filtre verilerini tutmak için sınıf.
## Yöntemler
