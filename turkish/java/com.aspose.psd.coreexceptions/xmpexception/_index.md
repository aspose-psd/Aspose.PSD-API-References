...
type: docs
weight: 23
url: /tr/java/com.aspose.psd.coreexceptions/xmpexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [XmpException()](#XmpException--) | XmpException sınıfının yeni bir örneğini başlatır. |
| [XmpException(String message)](#XmpException-java.lang.String-) | XmpException sınıfının yeni bir örneğini başlatır. |
| [XmpException(String message, Throwable innerException)](#XmpException-java.lang.String-java.lang.Throwable-) | XmpException sınıfının yeni bir örneğini başlatır. |
## Alanlar
...
XmpException sınıfının yeni bir örneğini başlatır.
