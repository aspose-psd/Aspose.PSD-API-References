...
type: docs
weight: 10
url: /tr/java/com.aspose.psd.coreexceptions/compressorexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [CompressorException(String message)](#CompressorException-java.lang.String-) | CompressorException sınıfının yeni bir örneğini başlatır. |
| [CompressorException(String message, Throwable innerException)](#CompressorException-java.lang.String-java.lang.Throwable-) | CompressorException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
CompressorException sınıfının yeni bir örneğini başlatır.
