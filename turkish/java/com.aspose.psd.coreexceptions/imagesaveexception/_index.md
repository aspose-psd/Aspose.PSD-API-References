...
description: "Görüntü kaydetme istisnası."
type: docs
weight: 16
url: /tr/java/com.aspose.psd.coreexceptions/imagesaveexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [ImageSaveException(String message)](#ImageSaveException-java.lang.String-) | ImageSaveException sınıfının yeni bir örneğini başlatır. |
| [ImageSaveException(String message, Throwable innerException)](#ImageSaveException-java.lang.String-java.lang.Throwable-) | ImageSaveException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
ImageSaveException sınıfının yeni bir örneğini başlatır.
