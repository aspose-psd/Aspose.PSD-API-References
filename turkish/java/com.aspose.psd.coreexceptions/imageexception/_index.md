...
type: docs
weight: 14
url: /tr/java/com.aspose.psd.coreexceptions/imageexception/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [ImageException(String message)](#ImageException-java.lang.String-) | ImageException sınıfının yeni bir örneğini başlatır. |
| [ImageException(String message, Throwable innerException)](#ImageException-java.lang.String-java.lang.Throwable-) | ImageException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
ImageException sınıfının yeni bir örneğini başlatır.
