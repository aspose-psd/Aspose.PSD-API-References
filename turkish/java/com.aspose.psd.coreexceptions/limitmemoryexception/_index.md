...
type: docs
weight: 18
url: /tr/java/com.aspose.psd.coreexceptions/limitmemoryexception/
---
...
Bellek sınır istisnası. Bellek kullanımı azaltılması gerektiğinde oluşur.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LimitMemoryException(String message)](#LimitMemoryException-java.lang.String-) | LimitMemoryException sınıfının yeni bir örneğini başlatır. |
| [LimitMemoryException(String message, Throwable innerException)](#LimitMemoryException-java.lang.String-java.lang.Throwable-) | LimitMemoryException sınıfının yeni bir örneğini başlatır. |
| [LimitMemoryException(String message, long reduceMemoryFactor)](#LimitMemoryException-java.lang.String-long-) | LimitMemoryException sınıfının yeni bir örneğini başlatır. |
| [LimitMemoryException(String message, Throwable innerException, int reduceMemoryFactor)](#LimitMemoryException-java.lang.String-java.lang.Throwable-int-) | LimitMemoryException sınıfının yeni bir örneğini başlatır. |
## Yöntemler
