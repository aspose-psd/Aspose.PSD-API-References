...
description: "Exif görüntü yönelimi."
type: docs
weight: 21
url: /tr/java/com.aspose.psd.exif.enums/exiforientation/
---
...
| Alan | Açıklama |
| --- | --- |
| [BottomLeft](#BottomLeft) | Sol alt. |
| [BottomRight](#BottomRight) | Sağ alt. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LeftBottom](#LeftBottom) | Alt sol. |
| [LeftTop](#LeftTop) | Üst sol. |
| [RightBottom](#RightBottom) | Alt sağ. |
| [RightTop](#RightTop) | Üst sağ. |
| [TopLeft](#TopLeft) | Sol üst. |
| [TopRight](#TopRight) | Sağ üst. |
## Yöntemler
...
Sol alt. 180 derece döndürülmüş ve ardından yatay olarak ters çevrilmiştir.
...
Alt sol. 90 derece saat yönünün tersine döndürülmüş.
...
Üst sol. 90 derece saat yönünün tersine döndürülmüş ve ardından yatay olarak ters çevrilmiştir.
...
Alt sağ. 90 derece saat yönünde döndürülmüş ve ardından yatay olarak ters çevrilmiştir.
...
Sağ üst. Saat yönünde 90 derece döndürülmüş.
...
Sol üst. Varsayılan yönlendirme.
