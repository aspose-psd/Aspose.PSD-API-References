...
description: "PSD formatındaki görüntüde gömülü dosyalar hakkında bilgi içeren sınıfı tanımlar."
type: docs
weight: 15
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
PSD formatı görüntüsündeki gömülü dosyalar hakkında bilgi içeren sınıfı tanımlar. Bağlantı kaynağı, dizinleyici aracılığıyla erişilebilen birkaç LiFdDataSource örneği içerebilir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Yeni bir [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) sınıfı örneği başlatır. |
## Alanlar
...
| [get_Item(int index)](#get-Item-int-) | Belirtilen indeksteki LiFdDataSource'ı alır. |
...
Yeni bir [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) sınıfı örneği başlatır.
...
Belirtilen indeksteki LiFdDataSource'ı alır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Dizin. Değer: LiFdDataSource. |
