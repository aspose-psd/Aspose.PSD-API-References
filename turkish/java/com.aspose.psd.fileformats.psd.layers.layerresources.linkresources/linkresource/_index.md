...
description: "PSD formatındaki görüntüde bağlı veya gömülü dosyalar hakkında bilgi içeren LinkResource sınıfını tanımlar."
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
LinkResource sınıfını tanımlar; bu sınıf PSD formatı görüntüsündeki bağlı veya gömülü dosyalar hakkında bilgi içerir. Bağlantı kaynağı, herhangi bir türetilmiş sınıfta dizinleyiciler aracılığıyla erişilebilen birkaç [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) örneği içerebilir.
## Alanlar
...
| [get_Item(int index)](#get-Item-int-) | Belirtilen dizindeki [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) alır. |
...
Belirtilen dizindeki [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) alır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| index | int | Tam sayı dizin. Değer: [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
