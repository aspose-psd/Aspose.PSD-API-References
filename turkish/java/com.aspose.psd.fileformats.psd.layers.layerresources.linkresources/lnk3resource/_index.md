...
description: "PSD formatındaki 32 bit kanal başına görüntüde gömülü bir dosya hakkında bilgi içeren sınıfı tanımlar."
type: docs
weight: 16
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
Sınıfı tanımlar; bu sınıf PSD formatında 32 bit kanal başına görüntüde gömülü bir dosya hakkında bilgi içerir. Bağlantı kaynağı, dizinleyici ile erişilebilen birkaç [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) örneği içerebilir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | Yeni bir [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) sınıfının örneğini başlatır. |
## Alanlar
...
Yeni bir [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) sınıfının örneğini başlatır.
