...
description: "PSD dosyasındaki bağlı bir dosya veya varlık hakkında bilgi içeren LinkDataSource sınıfını tanımlar."
type: docs
weight: 12
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource/
---
...
PSD dosyasındaki bağlı bir dosya veya varlık hakkında bilgi içeren LinkDataSource sınıfını tanımlar.
## Alanlar
