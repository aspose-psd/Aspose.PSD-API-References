...
description: "VmskResource sınıfı."
type: docs
weight: 27
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [VmskResource(byte[] data)](#VmskResource-byte---) | Yeni bir [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) sınıfının örneğini başlatır. |
| [VmskResource()](#VmskResource--) | Yeni bir [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) sınıfının örneğini başlatır. |
## Alanlar
...
Yeni bir [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) sınıfının örneğini başlatır.
