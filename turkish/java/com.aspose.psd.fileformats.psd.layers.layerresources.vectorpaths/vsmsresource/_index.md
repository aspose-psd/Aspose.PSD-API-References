...
description: "VsmsResource sınıfı."
type: docs
weight: 29
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
Sınıf VsmsResource. Bu kaynak vektör katman maskesi hakkında bilgi içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | Yeni bir örnek başlatır [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) sınıfının. |
| [VsmsResource()](#VsmsResource--) | Yeni bir örnek başlatır [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) sınıfının. |
## Alanlar
...
| [hashCode()](#hashCode--) |  |
| [isChanged_internalized()](#isChanged-internalized--) | Bu örneğin değişip değişmediğini belirler. |
...
| [updateDataToCurrent_internalized()](#updateDataToCurrent-internalized--) | Önbelleğe alınmış orijinal veriyi mevcut duruma güncelle |
| [wait()](#wait--) |  |
...
Yeni bir örnek başlatır [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) sınıfının.
...
Bu örneğin değişip değişmediğini belirler.

**Returns:**
boolean -  true  bu örnek değiştirildiyse; aksi takdirde,  false .
...
Önbelleğe alınmış orijinal veriyi mevcut duruma güncelle
