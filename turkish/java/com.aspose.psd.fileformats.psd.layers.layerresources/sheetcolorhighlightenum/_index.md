...
description: "Sayfa renk ayarının olası renkleri."
type: docs
weight: 73
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Sayfa renk ayarı için olası renkler. PS'deki katmanlar listesindeki katmanın UI süsleme rengi.
## Alanlar
...
| [Gray](#Gray) | Gri renk. |
| [Green](#Green) | Yeşil renk. |
| [NoColor](#NoColor) | Renk belirtilmemiş. |
| [Orange](#Orange) | Turuncu renk. |
| [Red](#Red) | Kırmızı renk. |
| [Violet](#Violet) | Mor renk. |
| [Yellow](#Yellow) | Sarı renk. |
## Yöntemler
