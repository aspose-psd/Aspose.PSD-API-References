...
description: "GdflResource'dan veri dönüşümünü uygulayan yardımcı sınıf."
type: docs
weight: 32
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/gdflresourcehelper/
---
...
GdflResource'dan veri dönüşümünü uygulayan yardımcı sınıf.
## Yapıcılar
