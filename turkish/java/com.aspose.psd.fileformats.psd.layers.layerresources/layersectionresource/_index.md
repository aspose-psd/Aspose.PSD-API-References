...
description: "Katman bölüm kaynağı."
type: docs
weight: 43
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
Katman bölüm kaynağı.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Yeni bir [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) sınıfı örneği başlatır. |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Yeni bir [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) sınıfı örneği başlatır. |
## Alanlar
...
| [getSectionType()](#getSectionType--) | Bölüm tipini alır veya ayarlar. |
| [getSignature()](#getSignature--) | Katman kaynağı imzasını alır. |
| [getSubtype()](#getSubtype--) | Alt tipi alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Bölüm tipini alır veya ayarlar. |
| [setSubtype(int value)](#setSubtype-int-) | Alt tipi alır veya ayarlar. |
...
Yeni bir [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) sınıfı örneği başlatır.
