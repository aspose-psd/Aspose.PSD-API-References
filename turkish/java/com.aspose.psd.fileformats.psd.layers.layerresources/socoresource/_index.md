...
description: "Sınıf SoCoResource."
type: docs
weight: 75
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
Sınıf SoCoResource. Bu kaynak, Renk Doldurma Katmanları hakkında bilgi içerir
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [SoCoResource()](#SoCoResource--) | Yeni bir [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource) sınıfı örneği başlatır. |
## Alanlar
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | RGB rengini alır. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | RGB rengini alır. |
...
Yeni bir [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource) sınıfı örneği başlatır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | RGB Rengi |
