...
description: "Sınıf CustResource."
type: docs
weight: 27
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/custresource/
---
...
Sınıf CustResource. Bu kaynak, kırpılmış öğenin karıştırılmasıyla ilgili bilgileri içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [CustResource()](#CustResource--) | Yeni bir [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) sınıfı örneği başlatır. |
| [CustResource(byte[] data)](#CustResource-byte---) | Yeni bir [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) sınıfı örneği başlatır. |
## Alanlar
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Katmanın oluşturulma tarihini alır veya ayarlar. |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Katmanın oluşturulma tarihini alır veya ayarlar. |
...
Yeni bir [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource) sınıfı örneği başlatır.
...
Katmanın oluşturulma tarihini alır veya ayarlar.

Değer: Katmanın oluşturulma tarihi.
