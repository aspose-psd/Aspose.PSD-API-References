...
description: "lr32 kaynağı."
type: docs
weight: 54
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [Lr32Resource()](#Lr32Resource--) | Yeni bir [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) sınıfı örneği başlatır. |
## Alanlar
...
| [getLayers()](#getLayers--) | Katmanları alır veya ayarlar. |
| [getLength()](#getLength--) | Görüntünün PSD başlık sürümü için kaynak uzunluğunu alır. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | Kaynak uzunluğunu alır. |
...
| [getRawData_internalized()](#getRawData-internalized--) | Kaynağın ham verisini alır veya ayarlar. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Katman kaydını kaydeder. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Katmanları alır veya ayarlar. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | Kaynağın ham verisini alır veya ayarlar. |
...
Yeni bir [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) sınıfı örneği başlatır.
...
Kaynak uzunluğunu alır. PSD sürümüne bağlı olabilir.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| psdHeaderVersion | int | PSD başlık sürümü. |
...
Kaynağın ham verisini alır veya ayarlar.
