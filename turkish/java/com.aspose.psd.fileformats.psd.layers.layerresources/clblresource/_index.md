...
description: "Sınıf ClblResource."
type: docs
weight: 20
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Sınıf ClblResource. Bu kaynak, kırpılmış öğenin karıştırılmasıyla ilgili bilgileri içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ClblResource()](#ClblResource--) | Yeni bir [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) sınıfı örneği başlatır. |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Yeni bir [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) sınıfı örneği başlatır. |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Yeni bir [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) sınıfı örneği başlatır. |
## Alanlar
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Bir değeri alır veya ayarlar; bu değer [blend clipped elements] olup olmadığını gösterir. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | Değerin [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) true ya da false olup olmadığını gösteren bir değeri alır veya ayarlar |
| [hashCode()](#hashCode--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Bir değeri alır veya ayarlar; bu değer [blend clipped elements] olup olmadığını gösterir. |
...
| [setValue(boolean value)](#setValue-boolean-) | Değerin [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) true ya da false olup olmadığını gösteren bir değeri alır veya ayarlar |
...
Yeni bir [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) sınıfı örneği başlatır.
...
| --- | --- | --- |
| blendClippedElements | boolean | eğer true olarak ayarlanırsa  [blend clipped elements]. |
...
Yeni bir [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) sınıfı örneği başlatır. Özel veya bilinmeyen bir değerle
...
Bir değeri alır veya ayarlar; bu değer [blend clipped elements] olup olmadığını gösterir.

Değer:  true  eğer [blend clipped elements]; aksi takdirde,  false .
...
Değerin [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) true ya da false olup olmadığını gösteren bir değeri alır veya ayarlar

Değer: true eğer değer true ise; aksi takdirde false.
