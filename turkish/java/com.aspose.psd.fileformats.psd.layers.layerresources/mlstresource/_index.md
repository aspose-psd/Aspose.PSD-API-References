...
description: "mlst kaynağı."
type: docs
weight: 62
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [MlstResource()](#MlstResource--) | Yeni bir [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) sınıfı örneği başlatır. |
## Alanlar
...
| [getItems()](#getItems--) | Yapıları alır veya ayarlar. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Yapıları alır veya ayarlar. |
...
Yeni bir [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) sınıfı örneği başlatır.
