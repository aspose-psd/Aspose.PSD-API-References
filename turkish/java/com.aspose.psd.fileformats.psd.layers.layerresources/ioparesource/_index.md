...
description: "Sınıf IopaResource."
type: docs
weight: 40
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
IopaResource sınıfı. Bu kaynak, katman stili formundan doldurma opaklığı özelliği hakkında bilgi içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [IopaResource()](#IopaResource--) | Yeni bir [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) sınıfı örneği başlatır. |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Yeni bir [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) sınıfı örneği başlatır. |
## Alanlar
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Dolgu opaklığını alır veya ayarlar. |
...
Yeni bir [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) sınıfı örneği başlatır.
