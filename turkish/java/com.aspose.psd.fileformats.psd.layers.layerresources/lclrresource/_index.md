...
description: "Sınıf LclrResource."
type: docs
weight: 46
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
Sınıf LclrResource. Bu kaynak, PS'deki katmanların listesinde katmanın rengi hakkında bilgi içerir. Sadece
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LclrResource()](#LclrResource--) | Yeni bir [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) sınıfının örneğini başlatır. |
| [LclrResource(short color)](#LclrResource-short-) | Yeni bir [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) sınıfının örneğini başlatır. |
| [LclrResource(byte[] data)](#LclrResource-byte---) | Yeni bir [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Katmanın rengini alır veya ayarlar. |
...
| [setColor(short value)](#setColor-short-) | Katmanın rengini alır veya ayarlar. |
...
Yeni bir [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) sınıfının örneğini başlatır.
