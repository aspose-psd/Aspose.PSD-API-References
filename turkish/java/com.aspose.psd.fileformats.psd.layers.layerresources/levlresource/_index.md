...
description: "Sınıf LevlResource."
type: docs
weight: 48
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/levlresource/
---
...
Sınıf LevlResource. Pozlama Ayar Katmanı Kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LevlResource(byte[] bytes)](#LevlResource-byte---) | Yeni bir [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) sınıfının bir örneğini başlatır. |
| [LevlResource()](#LevlResource--) | Yeni bir [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) sınıfının bir örneğini başlatır. |
## Alanlar
...
| [getChannel(int channelIndex)](#getChannel-int-) | Kanalı alır. |
| [getClass()](#getClass--) |  |
...
Yeni bir [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource) sınıfının bir örneğini başlatır. GrayScale, Duotone, RGB, CMYK, Lab renk modlarında desteklenir 2 bayt - Versiyon (=2) 29 \* 10 bayt - 5 kısa tamsayı içeren seviye kayıtları kümesi 4 bayt - Lvls başlığı (292 indeksinde başlar) 2 bayt - Versiyon (=3) 2 bayt - Toplam seviye kaydı sayısı 10 \* (Toplam Sayı - 29) Lvls kaynağının sıfır sonu da dört için katlanmalıdır
