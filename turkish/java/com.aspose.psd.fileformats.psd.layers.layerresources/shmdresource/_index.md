...
description: "Sınıf ShmdResource."
type: docs
weight: 74
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [ShmdResource()](#ShmdResource--) | Yeni bir [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) sınıfı örneği başlatır. |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | Yeni bir [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) sınıfı örneği başlatır. |
## Alanlar
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | Alt kaynak başlık uzunluğu |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Katmanın oluşturulma zamanını alır veya ayarlar. |
...
| [getSubResources()](#getSubResources--) | Alt kaynaklar |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Katmanın oluşturulma zamanını alır veya ayarlar. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | shmd kaynağının alt kaynaklarını alır. |
...
Yeni bir [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) sınıfı örneği başlatır.
...
Katmanın oluşturulma zamanını alır veya ayarlar. Katman oluşturulma zamanı belirtilmemişse yeni DateTime(0) döndürür.

Değer: Katmanın oluşturulma zamanı.
