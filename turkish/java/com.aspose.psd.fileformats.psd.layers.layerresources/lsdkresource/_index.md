...
description: "lsdk katman kaynağı iç içe katman bölüm kaynağı."
type: docs
weight: 56
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
lsdk katman kaynağı (iç içe katman bölüm kaynağı).
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Yeni bir [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) sınıfının örneğini başlatır. |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Yeni bir [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) sınıfının örneğini başlatır. |
## Alanlar
...
Yeni bir [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) sınıfının örneğini başlatır.
