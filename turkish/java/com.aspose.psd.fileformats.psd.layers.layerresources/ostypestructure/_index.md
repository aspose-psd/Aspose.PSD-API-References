...
description: "OS tip yapısını temsil eder."
type: docs
weight: 64
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [OSTypeStructure(ClassID keyName)](#OSTypeStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Yeni bir [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) sınıfının bir örneğini başlatır. |
## Yöntemler
...
Yeni bir [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) sınıfının bir örneğini başlatır.
