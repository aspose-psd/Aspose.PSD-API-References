...
description: "The Filter Effects kaynağı kanallar, bir kullanıcı maskesi ve bir sheet maskesi içerir."
type: docs
weight: 29
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
Filtre Efektleri kaynağı, kanallar, bir kullanıcı maskesi ve akıllı filtre için bir sayfa maskesi içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Yeni bir [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) sınıfının bir örneğini başlatır. |
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | FEid tip aracı bilgi anahtarı. |
| [FXidTypeToolKey](#FXidTypeToolKey) | FXid tip aracı bilgi anahtarı. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Filtre efekt maskelerini alır. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Filtre efekt maskelerini alır. |
...
Yeni bir [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) sınıfının bir örneğini başlatır.
...
| version | int | Sürüm. |
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Filtre efekt maskeleri. |
