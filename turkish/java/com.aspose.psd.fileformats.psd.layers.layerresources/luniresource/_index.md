...
description: "Katman adı kaynağı"
type: docs
weight: 58
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [LuniResource()](#LuniResource--) | Yeni bir [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) sınıfı örneği başlatır. |
## Alanlar
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Veriyi alır veya ayarlar. |
...
Yeni bir [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) sınıfı örneği başlatır.
