...
description: "Sınıf lnsrResource."
type: docs
weight: 51
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Yeni bir [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) sınıfının örneğini başlatır. |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Yeni bir [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getValue()](#getValue--) | Eğer ilgili enum tanımlanmışsa değeri LnsrResourceType olarak alır. |
| [hashCode()](#hashCode--) |  |
...
Yeni bir [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) sınıfının örneğini başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| lnsrResourceType | int | LNSR'nin türü. |
...
Yeni bir [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) sınıfının örneğini başlatır. Özel veya bilinmeyen bir değerle
...
Eğer ilgili enum tanımlanmışsa değeri LnsrResourceType olarak alır. Aksi takdirde Unknown döndürür

Değer: LnsrResourceType olarak değer
