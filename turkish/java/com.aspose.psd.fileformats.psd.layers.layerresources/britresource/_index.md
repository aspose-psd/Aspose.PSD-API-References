...
description: "Sınıf BritResource."
type: docs
weight: 17
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/britresource/
---
...
BritResource sınıfı. Parlaklık/Kontrast Ayarlama Katmanı kaynağı.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [BritResource()](#BritResource--) | Yeni bir [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource) sınıfı örneği başlatır. |
| [BritResource(short brightness, short contrast, short meanValueForBrightnessAndContrast, boolean labColor)](#BritResource-short-short-short-boolean-) | Yeni bir [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource) sınıfı örneği başlatır. |
| [BritResource(byte[] bytes)](#BritResource-byte---) | Yeni bir [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource) sınıfı örneği başlatır. |
## Alanlar
...
| [getLabColor()](#getLabColor--) | [lab color] olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [setBrightness(short value)](#setBrightness-short-) | Parlaklığı alır veya ayarlar. |
| [setContrast(short value)](#setContrast-short-) | Kontrastı alır veya ayarlar. |
...
| [setLabColor(boolean value)](#setLabColor-boolean-) | [lab color] olup olmadığını gösteren bir değeri alır veya ayarlar. |
| [setMeanValueForBrightnessAndContrast(short value)](#setMeanValueForBrightnessAndContrast-short-) | Parlaklık ve kontrast için ortalama değeri alır veya ayarlar. |
...
Yeni bir [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource) sınıfı örneği başlatır.
...
| meanValueForBrightnessAndContrast | short | Parlaklık ve kontrast için ortalama değer. |
| labColor | boolean | eğer true olarak ayarlanırsa [lab color]. |
...
Yeni bir [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource) sınıfı örneği başlatır. PSD formatı spesifikasyonu aşağıdaki açıklamayı içerir: 2 Parlaklık 2 Kontrast 2 Parlaklık ve kontrast için ortalama değer 1 Yalnızca Lab rengi Modern PSD (CS5 ve üzeri) içinde CgEd'in bulunduğu yerde kullanılmaz. CgEd bilgi özelliklerini depolar.
...
Değer:  true  eğer [lab color]; aksi takdirde,  false .
