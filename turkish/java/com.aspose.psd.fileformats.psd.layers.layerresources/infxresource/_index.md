...
description: "Sınıf InfxResource."
type: docs
weight: 39
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
InfxResource sınıfı. Bu kaynak, kırpılmış öğenin karıştırılmasıyla ilgili bilgileri içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) sınıfının yeni bir örneğini başlatır. |
| [InfxResource()](#InfxResource--) | [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) sınıfının yeni bir örneğini başlatır. |
| [InfxResource(byte[] data)](#InfxResource-byte---) | [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) sınıfının yeni bir örneğini başlatır. |
## Alanlar
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | [blend interior elements] olup olmadığını gösteren bir değeri alır veya ayarlar. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | [blend interior elements] olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
[InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) sınıfının yeni bir örneğini başlatır.
...
Yeni bir [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) sınıfının bir örneğini başlatır. Özel veya bilinmeyen değer ile.
