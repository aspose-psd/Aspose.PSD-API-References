...
description: "Sınıf KnkoResource."
type: docs
weight: 41
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Sınıf KnkoResource. Bu kaynak, kırpılmış öğenin karıştırılmasıyla ilgili bilgileri içerir.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | Yeni bir [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) sınıfının bir örneğini başlatır. |
| [KnkoResource()](#KnkoResource--) | Yeni bir [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) sınıfının bir örneğini başlatır. |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | Yeni bir [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) sınıfının bir örneğini başlatır. |
## Alanlar
...
| [getKnockout()](#getKnockout--) | [blend interior elements] olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | [blend interior elements] olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
Yeni bir [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) sınıfının bir örneğini başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| kırpma | boolean | eğer true olarak ayarlanırsa [blend interior elements]. |
...
Yeni bir [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) sınıfının bir örneğini başlatır. Özel veya bilinmeyen bir değer ile
...
[blend interior elements] olup olmadığını gösteren bir değeri alır veya ayarlar.

Değer: true eğer [blend interior elements]; aksi takdirde false.
