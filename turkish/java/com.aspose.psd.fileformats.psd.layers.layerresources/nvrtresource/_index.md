...
description: "Sınıf NvrtResource."
type: docs
weight: 63
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
NvrtResource sınıfı. Invert Ayar Katmanı kaynağı.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | Yeni bir [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource) sınıf örneği başlatır. |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | Yeni bir [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource) sınıf örneği başlatır. |
## Alanlar
...
Yeni bir [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource) sınıf örneği başlatır.
