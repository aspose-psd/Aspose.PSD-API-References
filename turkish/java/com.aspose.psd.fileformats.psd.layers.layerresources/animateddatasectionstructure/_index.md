...
description: "Animasyonlu veri içeren bölüm."
type: docs
weight: 11
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Alan | Açıklama |
| --- | --- |
| [StructureKey](#StructureKey) | AnDs'nin yapı anahtarını tanımlar. |
## Yöntemler
...
| [getItems()](#getItems--) | Animasyon veri bölümü yapılarını alır veya ayarlar. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ClassID'yi alır veya ayarlar. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Tanımlayıcı sürümünü alır veya ayarlar. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Animasyon veri bölümü yapılarını alır veya ayarlar. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Çerçeve sayısı tek olduğunda mevcut olan bilinmeyen 3 baytı alır veya ayarlar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
AnDs'nin yapı anahtarını tanımlar.
...
'FrIn' liste yapısındaki çerçeve sayısının tek olduğunu kontrol eder.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| öğeler | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Animasyon veri bölümü yapılarını alır veya ayarlar.
...
Çerçeve sayısı tek olduğunda mevcut olan bilinmeyen 3 baytı alır veya ayarlar.
