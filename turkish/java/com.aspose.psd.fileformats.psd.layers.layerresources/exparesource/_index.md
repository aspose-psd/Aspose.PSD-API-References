...
description: "Sınıf ExpaResource."
type: docs
weight: 28
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
Sınıf ExpaResource. Exposure Adjustment Layer kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) sınıfının yeni bir örneğini başlatır. |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) sınıfının yeni bir örneğini başlatır. |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) sınıfının yeni bir örneğini başlatır. |
## Alanlar
...
| [getExposure()](#getExposure--) | Pozlamayı alır veya ayarlar. |
| [getGammaCorrection()](#getGammaCorrection--) | Gammayı alır veya ayarlar. |
...
| [setExposure(float value)](#setExposure-float-) | Pozlamayı alır veya ayarlar. |
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Gammayı alır veya ayarlar. |
...
| [setOffset(float value)](#setOffset-float-) | Ofseti alır veya ayarlar. |
...
[ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) sınıfının yeni bir örneğini başlatır.
