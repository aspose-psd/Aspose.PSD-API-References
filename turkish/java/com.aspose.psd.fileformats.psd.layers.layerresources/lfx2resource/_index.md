...
description: "Lfx2 kaynak etkileri kaynağı"
type: docs
weight: 49
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
Lfx2 kaynağı (efekt kaynağı)
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [Lfx2Resource()](#Lfx2Resource--) | Yeni bir [Lfx2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lfx2resource) sınıf örneği başlatır. |
## Alanlar
...
Yeni bir [Lfx2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lfx2resource) sınıf örneği başlatır.
