...
description: "Sınıf LyidResource."
type: docs
weight: 59
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | Yeni bir [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) sınıfı örneği başlatır. |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | Yeni bir [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) sınıfı örneği başlatır. |
## Alanlar
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | Değeri alır. |
...
Yeni bir [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) sınıfı örneği başlatır.
...
Yeni bir [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) sınıfı örneği başlatır. Özel veya bilinmeyen değer ile.
