...
description: "Katmanın Photoshop sürümünü temsil eden kaynak."
type: docs
weight: 60
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) sınıfının yeni bir örneğini başlatır. |
## Alanlar
...
| [getVersion()](#getVersion--) | Katmanın photoshop sürümünü alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | Katmanın photoshop sürümünü alır veya ayarlar. |
...
[LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) sınıfının yeni bir örneğini başlatır.
...
Katmanın photoshop sürümünü alır veya ayarlar.
