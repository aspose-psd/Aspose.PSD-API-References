...
description: "Temel efekt kaynağı"
type: docs
weight: 12
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Yeni bir [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) sınıf örneği başlatır. |
## Alanlar
...
Yeni bir [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) sınıf örneği başlatır.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| resourceKey | int | Kaynak anahtarı. |
