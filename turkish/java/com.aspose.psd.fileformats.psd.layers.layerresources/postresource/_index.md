...
description: "Sınıf PostResource."
type: docs
weight: 71
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
PostResource sınıfı. Posterize katman ayarları.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PostResource()](#PostResource--) | Yeni bir [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) sınıfının örneğini başlatır. |
## Alanlar
...
Yeni bir [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) sınıfının örneğini başlatır.
