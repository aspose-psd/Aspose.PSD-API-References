...
description: "Bilinmeyen kaynak."
type: docs
weight: 82
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Yeni bir [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) sınıfı örneği başlatır. |
## Alanlar
...
Yeni bir [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) sınıfı örneği başlatır.
