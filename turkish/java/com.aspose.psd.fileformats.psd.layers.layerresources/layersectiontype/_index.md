...
description: "Katman bölüm türü"
type: docs
weight: 45
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectiontype/
---
...
| Alan | Açıklama |
| --- | --- |
| [ClosedFolder](#ClosedFolder) | Kapalı klasör. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Layer](#Layer) | Katman. |
| [OpenFolder](#OpenFolder) | Açık klasör. |
| [SectionDivider](#SectionDivider) | Bölüm ayırıcı. |
## Yöntemler
