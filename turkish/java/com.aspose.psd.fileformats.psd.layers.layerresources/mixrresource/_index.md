...
description: "Sınıf MixrResource."
type: docs
weight: 61
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource/
---
...
MixrResource sınıfı. Kanal Karıştırıcı Ayar Katmanı kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [MixrResource()](#MixrResource--) | Yeni bir [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) sınıf örneğini başlatır. |
| [MixrResource(byte[] data)](#MixrResource-byte---) | Yeni bir [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) sınıf örneğini başlatır. |
## Alanlar
...
| [getChannelInfo(int channelIndex)](#getChannelInfo-int-) | Kanal bilgisi ham verisini alır |
| [getClass()](#getClass--) |  |
...
| [getMonochrome()](#getMonochrome--) | Bu [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) tek renkli olup olmadığını belirten bir değeri alır veya ayarlar. |
...
| [setChannelInfo(int channelIndex, byte[] value)](#setChannelInfo-int-byte---) | Kanal bilgilerini ayarlar. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Bu [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) tek renkli olup olmadığını belirten bir değeri alır veya ayarlar. |
...
Yeni bir [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) sınıfının örneğini başlatır. PSD formatı özelliği aşağıdaki açıklamayı içerir: 2 Versiyon ( = 1) 2 Monokrom 20 RGB veya CMYK renk artı karıştırıcı ayarları için sabit. 4 \* 2 bayt renk ve 2 bayt sabit.
...
Bu [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) tek renkli olup olmadığını belirten bir değeri alır veya ayarlar.
...
Değer: Versiyon. Varsayılan değer 1'dir.
