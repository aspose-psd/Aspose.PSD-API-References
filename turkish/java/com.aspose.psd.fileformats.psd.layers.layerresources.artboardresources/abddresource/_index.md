...
description: "Sanat tahtası bilgi verisi."
type: docs
weight: 10
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource/
---
...
Sanat tahtası bilgi verisi.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [AbddResource()](#AbddResource--) | Yeni bir [AbddResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource) sınıfının örneğini başlatır. |
## Alanlar
...
Yeni bir [AbddResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/abddresource) sınıfının örneğini başlatır.
