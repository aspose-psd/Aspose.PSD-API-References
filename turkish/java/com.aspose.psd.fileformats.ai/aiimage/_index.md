...
description: "Adobe Illustrator AI Görüntüsü"
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [AiImage()](#AiImage--) | Yeni bir [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) sınıfı örneği başlatır. |
## Alanlar
...
| Yöntem | Açıklama |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | AI katman bölümünü ekler. |
| [cacheData()](#cacheData--) | Verileri önbelleğe alır ve temel P:Aspose.PSD.DataStreamSupporter.DataStreamContainer'dan ek veri yüklemesinin yapılmayacağını garanti eder. |
...
| [getActivePageIndex()](#getActivePageIndex--) | Etkin sayfanın dizinini alır veya ayarlar. |
...
| [getDataSection()](#getDataSection--) | Veri bölümünü alır. |
...
| [getFileFormat()](#getFileFormat--) | Dosya biçiminin değerini alır. |
...
| [getFinalizeSection()](#getFinalizeSection--) | Tamamlama bölümünü alır. |
...
| [getPageCount()](#getPageCount--) | Sayfa sayısı. |
...
| [getSetupSection()](#getSetupSection--) | Kurulum bölümünü alır. |
...
| [getVersion()](#getVersion--) | Adobe Illustrator biçiminin sürümünü alır. |
| [getWidth()](#getWidth--) | Görüntü genişliğini alır. |
| [getXmpData()](#getXmpData--) | XMP üst verilerini alır. |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | Etkin sayfanın dizinini alır veya ayarlar. |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | Oluşturulan görüntüyü alır. |
...
Yeni bir [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) sınıfı örneği başlatır.
...
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | AI katman bölümü. |
...
Verileri önbelleğe alır ve temel P:Aspose.PSD.DataStreamSupporter.DataStreamContainer'dan ek veri yüklemesinin yapılmayacağını garanti eder.
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - ApsPage örneği.
...
Değer: Bu özellik yalnızca PDF biçimli AI görüntüsü için geçerlidir. Görüntü PDF biçiminde değilse veya sayfa yoksa, özellik -1 olacaktır. Bu özellik, AI görüntüsünün hangi sayfasının oluşturma için temel olacağını gösterir.
...
Sayfa sayısı. Eski AI biçimli görüntüler için her zaman 0'dır.
...
Adobe Illustrator biçiminin sürümünü alır.
...
Değer:  true  nesnenin verisi önbelleğe alındıysa; aksi takdirde,  false .
...
Oluşturulan görüntüyü alır.

Değer: Oluşturulan görüntü.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| ventureLicense | java.lang.Object | Venture lisans nesnesi. |
