...
type: docs
weight: 11
url: /tr/java/com.aspose.psd.fileformats.psd/compressionmethod/
---
...
| [RLE](#RLE) | RLE sıkıştırmalı görüntü verisi, tüm tarama satırları (satırlar \* kanallar) için bayt sayılarıyla başlar ve her sayı iki baytlık bir değer olarak depolanır. |
| [Raw](#Raw) | Sıkıştırma yok. |
| [ZipWithPrediction](#ZipWithPrediction) | Tahminli ZIP. |
| [ZipWithoutPrediction](#ZipWithoutPrediction) | Tahminsiz ZIP. |
## Yöntemler
...
RLE sıkıştırmalı görüntü verisi, tüm tarama satırları (satırlar \* kanallar) için bayt sayılarıyla başlar ve her sayı iki baytlık bir değer olarak depolanır. RLE sıkıştırılmış veri ardından gelir ve her tarama satırı ayrı ayrı sıkıştırılır. RLE sıkıştırması, Macintosh ROM rutin PackBits ve TIFF standardı tarafından kullanılan aynı sıkıştırma algoritmasıdır.
...
Sıkıştırma yok. Görüntü verisi, RGBA düzlemsel sırasıyla ham baytlar olarak depolanır. Bu, önce tüm R verisinin, ardından tüm G verisinin, sonra tüm B ve son olarak tüm A verisinin yazıldığı anlamına gelir.
