...
description: "Photoshop leading mode satırlar arasındaki mesafe"
type: docs
weight: 12
url: /tr/java/com.aspose.psd.fileformats.psd/leadingmode/
---
...
Photoshop satır aralığı modu (satırlar arasındaki mesafe)
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Auto](#Auto) | Otomatik leading mode |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | Manuel leading mode |
## Yöntemler
