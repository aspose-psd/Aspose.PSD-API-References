...
description: "StreamContainer içinde arama için referans noktalarını temsil eden alanları sağlar."
type: docs
weight: 95
url: /tr/java/com.aspose.psd/seekorigin/
---
...
Arama için StreamContainer içinde referans noktalarını temsil eden alanları sağlar.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [Begin](#Begin) | Bir akışın başlangıcını belirtir. |
| [Current](#Current) | Bir akış içindeki mevcut konumu belirtir. |
| [End](#End) | Bir akışın sonunu belirtir. |
...
Bir akışın başlangıcını belirtir.
...
Bir akış içindeki mevcut konumu belirtir.
