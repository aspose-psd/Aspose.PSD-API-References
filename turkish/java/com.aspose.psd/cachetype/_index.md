...
type: docs
weight: 15
url: /tr/java/com.aspose.psd/cachetype/
---
...
| Alan | Açıklama |
| --- | --- |
| [Auto](#Auto) | Otomatik önbellek türünü belirtir. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Yalnızca bellek içi önbellek. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Yalnızca disk önbelleği. |
...
Otomatik önbellek türünü belirtir. Otomatik önbellek şeması önce bellek içinde, ardından disk üzerinde önbelleklemeyi deneyecektir.
