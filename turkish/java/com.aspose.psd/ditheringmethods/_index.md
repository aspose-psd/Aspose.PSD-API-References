...
description: "Renk dönüşümünü kontrol etmek için kullanılan titreme yöntemleri."
type: docs
weight: 41
url: /tr/java/com.aspose.psd/ditheringmethods/
---
...
Renk dönüşümünü kontrol etmek için kullanılan titreme yöntemleri.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [CustomConverter](#CustomConverter) | Özel dönüştürücü. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | Palet göz ardı edilmez ve akıllı renk dönüşümü uygulanmalıdır. |
| [PaletteIgnore](#PaletteIgnore) | Palet göz ardı edilir. |
## Yöntemler
...
Palet göz ardı edilmez ve akıllı renk dönüşümü uygulanmalıdır.
