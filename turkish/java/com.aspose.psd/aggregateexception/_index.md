...
description: "Birden fazla istisnayı toplar."
type: docs
weight: 10
url: /tr/java/com.aspose.psd/aggregateexception/
---
...
Birden fazla istisnayı toplar.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [AggregateException(Throwable[] innerExceptions)](#AggregateException-java.lang.Throwable---) | Yeni bir [AggregateException](../../com.aspose.psd/aggregateexception) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [AggregateException](../../com.aspose.psd/aggregateexception) sınıfı örneği başlatır.
