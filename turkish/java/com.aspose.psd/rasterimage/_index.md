...
type: docs
weight: 86
url: /tr/java/com.aspose.psd/rasterimage/
---
...
| [crop(Rectangle rectangle)](#crop-com.aspose.psd.Rectangle-) | Belirtilen dikdörtgeni kırpar. |
...
| [resize(int newWidth, int newHeight, ImageResizeSettings settings)](#resize-int-int-com.aspose.psd.ImageResizeSettings-) | Genişletilmiş seçeneklerle görüntüyü yeniden boyutlandırır. |
...
**Returns:**
boolean -  true  bu örnek alfa içeriyorsa; aksi takdirde,  false .
