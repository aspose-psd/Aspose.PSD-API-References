...
description: "Dosya akışı işleme için yardımcı sınıf."
type: docs
weight: 44
url: /tr/java/com.aspose.psd/filestreamcontainer/
---
...
Dosya akışı işleme için yardımcı sınıf.
## Alanlar
...
| [openFileStream_internalized(String fileLocation, boolean disposeDuplicatedStreams)](#openFileStream-internalized-java.lang.String-boolean-) | Mevcut bir dosya akışını açar. |
...
| [setTemporal(boolean value)](#setTemporal-boolean-) | Akışın geçici olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [toString()](#toString--) |  |
| [to_FileStream(FileStreamContainer fileStreamContainer)](#to-FileStream-com.aspose.psd.FileStreamContainer-) | Açık bir dönüşüm gerçekleştirir [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) öğesinden FileInputStream'e. |
...
| [to_Stream(FileStreamContainer fileStreamContainer)](#to-Stream-com.aspose.psd.FileStreamContainer-) | Açık bir dönüşüm gerçekleştirir [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) öğesinden java.io.InputStream'e. |
...
| isTemporal | boolean | true olarak ayarlanırsa dosya akış kapsayıcısı geçicidir. |
...
Değer:  true  akış açıkça oluşturulmuşsa; aksi takdirde  false .
...
Değer:  true  akış geçici ise; aksi takdirde  false .

--------------------

Geçici bir akış, iptal edildiğinde kendisini kaldırır. Akış bellek tabanlıysa bu özellik etkisizdir. Akış, açıkça oluşturulmuşsa geçici veya kalıcı olarak işaretlenebilir; aksi takdirde uygun istisna fırlatılır.
...
| --- | --- | --- |
| fileLocation | java.lang.String | Dosya konumu. |
| disposeDuplicatedStreams | boolean | true olarak ayarlanırsa çoğaltılmış akışları iptal eder. |
...
Açık bir dönüşüm gerçekleştirir [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) öğesinden FileInputStream'e.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| fileStreamContainer | [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) | Dosya akış kapsayıcısı. |

**Returns:**
java.io.FileInputStream - Dönüşümün sonucu.
### to_FileStream_internalized(FileStreamContainer fileStreamContainer) {#to-FileStream-internalized-com.aspose.psd.FileStreamContainer-}
```
...
Açık bir dönüşüm gerçekleştirir [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) öğesinden java.io.InputStream'e.
...
**Returns:**
java.io.InputStream - Dönüşümün sonucu.
