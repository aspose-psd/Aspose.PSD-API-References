...
description: "CMYK cyan magenta yellow black renk uzayındaki bireysel kanalları belirtir."
type: docs
weight: 22
url: /tr/java/com.aspose.psd/colorchannelflag/
---
...
CMYK (cyan, magenta, yellow, black) renk uzayındaki bireysel kanalları belirtir. Bu enum, SetOutputChannel yöntemleri tarafından kullanılır.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [ColorChannelC](#ColorChannelC) | Camgöbeği renk kanalı. |
| [ColorChannelK](#ColorChannelK) | Siyah renk kanalı. |
| [ColorChannelLast](#ColorChannelLast) | Son seçilen kanal kullanılmalıdır. |
| [ColorChannelM](#ColorChannelM) | Macenta renk kanalı. |
| [ColorChannelY](#ColorChannelY) | Sarı renk kanalı. |
...
Son seçilen kanal kullanılmalıdır.
