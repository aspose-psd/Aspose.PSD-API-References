...
type: docs
weight: 102
url: /tr/java/com.aspose.psd/splitstreamcontainer/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [SplitStreamContainer(InputStream stream)](#SplitStreamContainer-java.io.InputStream-) | Yeni bir [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) sınıfı örneği başlatır. |
| [SplitStreamContainer(InputStream stream, boolean disposeStream)](#SplitStreamContainer-java.io.InputStream-boolean-) | Yeni bir [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) sınıfı örneği başlatır. |
| [SplitStreamContainer(StreamContainer stream, boolean disposeStream)](#SplitStreamContainer-com.aspose.psd.StreamContainer-boolean-) | Yeni bir [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) sınıfı örneği başlatır. |
## Alanlar
...
| [hashCode()](#hashCode--) |  |
| [insert(int position, StreamContainer stream, boolean disposeStream)](#insert-int-com.aspose.psd.StreamContainer-boolean-) | Akış kapsayıcısını belirtilen konuma ekler. |
...
| [save(OutputStream dstStream, int bufferSize, long length)](#save-java.io.OutputStream-int-long-) | Akışın verilerini belirtilen akışa kaydeder (kopyalar). |
...
Yeni bir [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) sınıfı örneği başlatır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| stream | [StreamContainer](../../com.aspose.psd/streamcontainer) | Akış konteyneri. |
...
| stream | [StreamContainer](../../com.aspose.psd/streamcontainer) | Eklenecek akış kapsayıcısı. |
| disposeStream | boolean | true olarak ayarlanırsa akışı serbest bırakır. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| dstStream | java.io.OutputStream | Verilerin kaydedileceği akış. |
| bufferSize | int | Tampon boyutu. Varsayılan olarak [StreamContainer.READ\_WRITE\_BYTES\_COUNT](../../com.aspose.psd/streamcontainer\#READ-WRITE-BYTES-COUNT) değeri kullanılır. |
| length | long | Kopyalanacak akış veri uzunluğu. Varsayılan olarak uzunluk,  Length ([StreamContainer.getLength()](../../com.aspose.psd/streamcontainer\#getLength--)/[StreamContainer.setLength(long)](../../com.aspose.psd/streamcontainer\#setLength-long-)) değeri olarak ayarlanır. |
...
| origin | int | Yeni konumu elde etmek için kullanılan referans noktasını gösteren [SeekOrigin](../../com.aspose.psd/seekorigin) tipinde bir değer. |
