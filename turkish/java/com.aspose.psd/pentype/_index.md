...
description: "Bir Pen nesnesinin hatları doldurmak için kullandığı dolgu türünü belirtir."
type: docs
weight: 79
url: /tr/java/com.aspose.psd/pentype/
---
...
Pen nesnesinin çizgileri doldurmak için kullandığı doldurma türünü belirtir.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HatchFill](#HatchFill) | Bir tarama doldurması belirtir. |
| [LinearGradient](#LinearGradient) | Doğrusal degrade doldurması belirtir. |
| [PathGradient](#PathGradient) | Yol degrade doldurması belirtir. |
| [SolidColor](#SolidColor) | Katı doldurmayı belirtir. |
| [TextureFill](#TextureFill) | Bit eşlem doku doldurması belirtir. |
## Yöntemler
...
Bir tarama doldurması belirtir.
...
Doğrusal degrade doldurması belirtir.
...
Yol degrade doldurması belirtir.
...
Bit eşlem doku doldurması belirtir.
