...
description: "İç Gölge Katman etkisi"
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | Yayılımı (sıkıştırma) yüzde olarak alır veya ayarlar. |
...
| [setSpread(int value)](#setSpread-int-) | Yayılımı (sıkıştırma) yüzde olarak alır veya ayarlar. |
