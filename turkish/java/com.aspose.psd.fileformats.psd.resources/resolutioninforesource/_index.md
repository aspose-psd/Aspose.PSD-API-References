...
description: "Çözünürlük bilgisi kaynağı"
type: docs
weight: 33
url: /tr/java/com.aspose.psd.fileformats.psd.resources/resolutioninforesource/
---
...
Çözünürlük bilgisi kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ResolutionInfoResource()](#ResolutionInfoResource--) | Yeni bir [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getHDpi()](#getHDpi--) | Yatay DPI. |
| [getHResDisplayUnit()](#getHResDisplayUnit--) | Yatay çözünürlük için görüntü birimleri. |
| [getHeightDisplayUnit()](#getHeightDisplayUnit--) | Yükseklik görüntü birimini alır veya ayarlar. |
...
| [getVDpi()](#getVDpi--) | Dikey DPI. |
| [getVResDisplayUnit()](#getVResDisplayUnit--) | Dikey çözünürlük için görüntü birimleri. |
| [getWidthDisplayUnit()](#getWidthDisplayUnit--) | Genişlik görüntü birimini alır veya ayarlar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Kaynak bloğunu belirtilen akışa kaydeder. |
| [setHDpi(FixedPointDecimal value)](#setHDpi-com.aspose.psd.fileformats.psd.resources.FixedPointDecimal-) | Yatay DPI. |
| [setHResDisplayUnit(int value)](#setHResDisplayUnit-int-) | Yatay çözünürlük için görüntü birimleri. |
| [setHeightDisplayUnit(int value)](#setHeightDisplayUnit-int-) | Yükseklik görüntü birimini alır veya ayarlar. |
...
| [setVDpi(FixedPointDecimal value)](#setVDpi-com.aspose.psd.fileformats.psd.resources.FixedPointDecimal-) | Dikey DPI. |
| [setVResDisplayUnit(int value)](#setVResDisplayUnit-int-) | Dikey çözünürlük için görüntü birimleri. |
| [setWidthDisplayUnit(int value)](#setWidthDisplayUnit-int-) | Genişlik görüntü birimini alır veya ayarlar. |
| [toString()](#toString--) |  |
...
Yeni bir [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) sınıfının örneğini başlatır.
...
Yatay çözünürlük için görüntü birimleri. Bu yalnızca kullanıcı arayüzünü etkiler; çözünürlük hâlâ PSD dosyasında piksel/inç olarak depolanır.

Değer: Yatay çözünürlük görüntü birimi.
...
Değer: Yükseklik görüntü birimi.
...
Dikey çözünürlük için görüntü birimleri.

Değer: Dikey çözünürlük görüntü birimi.
