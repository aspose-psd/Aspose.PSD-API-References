...
description: "Icc etiketsiz kaynak"
type: docs
weight: 24
url: /tr/java/com.aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [IccUntaggedResource()](#IccUntaggedResource--) | Yeni bir [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getProfile()](#getProfile--) | Profili alır veya ayarlar. |
...
| [setProfile(byte value)](#setProfile-byte-) | Profili alır veya ayarlar. |
...
Yeni bir [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource) sınıfının örneğini başlatır.
