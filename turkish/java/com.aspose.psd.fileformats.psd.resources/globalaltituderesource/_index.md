...
description: "Küresel irtifa kaynağı"
type: docs
weight: 18
url: /tr/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
Küresel irtifa kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | Yeni bir [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getAltitude()](#getAltitude--) | Rakımı alır veya ayarlar. |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | Rakımı alır veya ayarlar. |
...
Yeni bir [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) sınıfının örneğini başlatır.
