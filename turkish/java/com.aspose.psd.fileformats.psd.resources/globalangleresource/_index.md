...
description: "Küresel açı kaynağı"
type: docs
weight: 19
url: /tr/java/com.aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [GlobalAngleResource()](#GlobalAngleResource--) | Yeni bir [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) sınıfı örneği başlatır. |
## Alanlar
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | Genel açıyı alır veya ayarlar. |
...
Yeni bir [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) sınıfı örneği başlatır.
