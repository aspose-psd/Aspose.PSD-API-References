...
description: "XMP üst veri kaynağını temsil eder."
type: docs
weight: 44
url: /tr/java/com.aspose.psd.fileformats.psd.resources/xmpresource/
---
...
XMP üst veri kaynağını temsil eder.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [XmpResource()](#XmpResource--) | Yeni bir [XmpResource](../../com.aspose.psd.fileformats.psd.resources/xmpresource) sınıfının örneğini başlatır. |
## Alanlar
...
Yeni bir [XmpResource](../../com.aspose.psd.fileformats.psd.resources/xmpresource) sınıfının örneğini başlatır.
