...
description: "Hızlı maske bilgi kaynağı"
type: docs
weight: 32
url: /tr/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Hızlı maske bilgi kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Yeni bir [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getChannelId()](#getChannelId--) | Kanal tanımlayıcısını alır veya ayarlar. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Bu örneğin maske boş olup olmadığını gösteren bir değeri alır veya ayarlar. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Kaynak bloğunu belirtilen akışa kaydeder. |
| [setChannelId(short value)](#setChannelId-short-) | Kanal tanımlayıcısını alır veya ayarlar. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Bu örneğin maske boş olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
Yeni bir [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) sınıfının örneğini başlatır.
...
Kanal tanımlayıcısını alır veya ayarlar.

Değer: Kanal tanımlayıcısı.
...
Değer:  true  bu örnek maske boşsa; aksi takdirde,  false .
