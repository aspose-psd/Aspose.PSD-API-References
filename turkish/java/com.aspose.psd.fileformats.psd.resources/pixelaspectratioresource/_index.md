...
description: "Piksel en‑boy oranı kaynağı"
type: docs
weight: 29
url: /tr/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
Piksel en‑boy oranı kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | Yeni bir [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getAspectRatio()](#getAspectRatio--) | En-boy oranını alır veya ayarlar. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | En-boy oranını alır veya ayarlar. |
