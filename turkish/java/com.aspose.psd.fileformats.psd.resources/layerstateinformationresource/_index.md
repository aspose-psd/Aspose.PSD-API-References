...
description: "Katman durumu bilgi kaynağı"
type: docs
weight: 28
url: /tr/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
Katman durumu bilgi kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | Yeni bir [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getLayerIndex()](#getLayerIndex--) | Katmanın indeksini alır veya ayarlar. |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | Katmanın indeksini alır veya ayarlar. |
...
Yeni bir [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) sınıfının örneğini başlatır.
