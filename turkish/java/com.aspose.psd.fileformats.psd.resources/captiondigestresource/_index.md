...
description: "CaptionDigest kaynağı"
type: docs
weight: 13
url: /tr/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Yeni bir [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getDigest()](#getDigest--) | Digest'i alır veya ayarlar. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Digest'i alır veya ayarlar. |
