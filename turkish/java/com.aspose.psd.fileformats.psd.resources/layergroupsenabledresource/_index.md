...
description: "Katman grupları etkin kaynak"
type: docs
weight: 26
url: /tr/java/com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
Katman grupları etkin kaynak
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource--) | Yeni bir [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getIDs()](#getIDs--) | Alır veya ayarlar i ds. |
...
| [setIDs(byte[] value)](#setIDs-byte---) | Alır veya ayarlar i ds. |
...
Yeni bir [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) sınıfının örneğini başlatır.
