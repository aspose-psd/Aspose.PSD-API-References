...
description: "Katman grup bilgi kaynağı"
type: docs
weight: 25
url: /tr/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
Katman grup bilgi kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Yeni bir [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getGroups()](#getGroups--) | Grupları alır veya ayarlar. |
...
| [setGroups(short[] value)](#setGroups-short---) | Grupları alır veya ayarlar. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Katmanlardaki LinkGroupId'yi Groups özelliğinden günceller. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Katmanlardan Groups özelliğindeki değerleri günceller. |
...
Katmanlardaki LinkGroupId'yi Groups özelliğinden günceller.
...
Katmanlardan Groups özelliğindeki değerleri günceller.
