...
description: "Unicode alfa adları kaynağı"
type: docs
weight: 38
url: /tr/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
Unicode alfa adları kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | Yeni bir [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) sınıfının bir örneğini başlatır. |
## Alanlar
...
| [getAlphaNames()](#getAlphaNames--) | Alfa adlarını alır veya ayarlar. |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | Alfa adlarını alır veya ayarlar. |
...
Yeni bir [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) sınıfının bir örneğini başlatır.
