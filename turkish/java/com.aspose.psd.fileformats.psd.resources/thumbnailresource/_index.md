...
description: "Küçük resim kaynağı bloğu."
type: docs
weight: 36
url: /tr/java/com.aspose.psd.fileformats.psd.resources/thumbnailresource/
---
...
Küçük resim kaynağı bloğu.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [ThumbnailResource()](#ThumbnailResource--) | Yeni bir [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource) sınıfı örneği başlatır. |
## Alanlar
...
Yeni bir [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource) sınıfı örneği başlatır.
