...
description: "Yarı tonlama kaynağı"
type: docs
weight: 14
url: /tr/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| Yapıcı | Açıklama |
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | Yeni bir [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getHalftoneData()](#getHalftoneData--) | Yarı ton verisini alır veya ayarlar. |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | Yarı ton verisini alır veya ayarlar. |
...
Yeni bir [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) sınıfının örneğini başlatır.
...
Yarı ton verisini alır veya ayarlar.

Değer: Yarı ton verisi.
