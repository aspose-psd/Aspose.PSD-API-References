...
description: "Belgeye Özel Kimlikler kaynağı"
type: docs
weight: 16
url: /tr/java/com.aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
...
Belgeye Özel Kimlikler kaynağı
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [DocumentSpecificIdsResource()](#DocumentSpecificIdsResource--) | Yeni bir [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) sınıfının örneğini başlatır. |
## Alanlar
...
| [getId()](#getId--) | Tanımlayıcıyı alır veya ayarlar. |
...
| [setId(int value)](#setId-int-) | Tanımlayıcıyı alır veya ayarlar. |
...
Yeni bir [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) sınıfının örneğini başlatır.
