...
description: ITextParagraph mülk. Bunun olup olmadığını gösteren bir değer alır veya ayarlar.ITextParagraphburasagiri.
type: docs
weight: 30
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`ITextParagraph`](../)burasagiri.
...
`doğru` burasagiri ise; aksi takdirde,`YANLIŞ` .
