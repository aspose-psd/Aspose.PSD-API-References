...
description: "ITextParagraph özelliği. Bu ITextParagraph'ın burasagiri olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 30
...
Bu [`ITextParagraph`](../) öğesinin burasagiri olup olmadığını gösteren bir değeri alır veya ayarlar.
...
`true` eğer burasagiri; aksi takdirde `false`.
