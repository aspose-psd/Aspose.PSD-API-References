...
description: "ITextParagraph özelliği. Otomatik tireleme olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 10
...
Bu [automatic hyphenate] olup olmadığını gösteren bir değeri alır veya ayarlar.
...
`true` eğer [otomatik tireleme]; aksi takdirde, `false`.
