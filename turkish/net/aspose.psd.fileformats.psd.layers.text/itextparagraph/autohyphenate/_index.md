...
description: ITextParagraph mülk. otomatik tireleme. olup olmadığını gösteren bir değer alır veya ayarlar.
type: docs
weight: 10
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

[otomatik tireleme]. olup olmadığını gösteren bir değer alır veya ayarlar.
...
`doğru` if [otomatik tireleme]; aksi takdirde,`YANLIŞ` .
