...
description: "ITextParagraph özelliği. Bu ITextParagraph'ın asılı olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 90
...
Bu [`ITextParagraph`](../) asılı olup olmadığını gösteren bir değeri alır veya ayarlar.
...
`true` eğer asılı; aksi takdirde, `false`.
