...
description: ITextParagraph mülk. Bunun olup olmadığını gösteren bir değer alır veya ayarlar.ITextParagraph asılı.
type: docs
weight: 90
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`ITextParagraph`](../) asılı.
...
`doğru` asılıysa; aksi takdirde,`YANLIŞ` .
