...
description: ITextParagraph mülk. her satırın oluşturucu. olup olmadığını gösteren bir değer alır veya ayarlar.
type: docs
weight: 60
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

[her satırın oluşturucu]. olup olmadığını gösteren bir değer alır veya ayarlar.
...
`doğru` if [her satır bestecisi]; aksi takdirde,`YANLIŞ` .
...
* ad alanı [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph/)
* toplantı [Aspose.PSD](../../../)
