...
description: "ITextParagraph özelliği. Her satır oluşturucusunun olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 60
...
Bu [every line composer] olup olmadığını gösteren bir değeri alır veya ayarlar.
...
`true` eğer [every line composer]; aksi takdirde, `false`.
