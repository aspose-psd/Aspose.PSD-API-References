...
description: "ITextStyle özelliği. Otomatik satır aralığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 20
...
Otomatik [automatic leading] gösteren bir değeri alır veya ayarlar.
...
`true` eğer [automatic leading]; aksi takdirde, `false`.
