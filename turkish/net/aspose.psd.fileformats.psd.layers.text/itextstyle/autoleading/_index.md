...
description: ITextStyle mülk. otomatik yönlendirme. olup olmadığını gösteren bir değer alır veya ayarlar.
type: docs
weight: 20
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

[otomatik yönlendirme]. olup olmadığını gösteren bir değer alır veya ayarlar.
...
`doğru` if [otomatik yönlendirme]; aksi takdirde,`YANLIŞ` .
