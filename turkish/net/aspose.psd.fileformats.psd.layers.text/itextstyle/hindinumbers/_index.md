...
description: "ITextStyle özelliği. Hint rakamlarını gösterip göstermediğini belirten bir değeri alır veya ayarlar"
type: docs
weight: 150
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
{{< psd/tize >}}
## ITextStyle.HindiNumbers property

Hindi [hindi numbers] gösteren bir değeri alır veya ayarlar.
...
`true` eğer [hindi numbers]; aksi takdirde, `false`.
