...
description: ITextStyle mülk. Hintçe sayılar. olup olmadığını gösteren bir değer alır veya ayarlar.
type: docs
weight: 150
...
[Hintçe sayılar]. olup olmadığını gösteren bir değer alır veya ayarlar.
...
`doğru` if [hintçe sayılar]; aksi takdirde,`YANLIŞ` .
