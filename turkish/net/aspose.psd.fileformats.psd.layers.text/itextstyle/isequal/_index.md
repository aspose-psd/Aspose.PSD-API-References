...
description: "ITextStyle yöntemi. Belirtilen stilin eşit olup olmadığını belirler"
type: docs
weight: 290
url: /tr/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| style | ITextStyle | Stil. |

### Dönüş Değeri

`true` eğer belirtilen stil eşitse; aksi takdirde `false`.
