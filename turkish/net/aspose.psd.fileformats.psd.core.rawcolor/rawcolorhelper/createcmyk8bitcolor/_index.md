...
description: "RawColorHelper yöntemi. Kanal başına 8 bit CMYK rengi oluşturur."
type: docs
weight: 50
url: /tr/net/aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createcmyk8bitcolor/
---
{{< psd/tize >}}
## RawColorHelper.CreateCmyk8BitColor method

Kanal başına 8 bit CMYK rengi oluşturur.
...
| k | Byte | Ana (siyah) bileşen değeri (0-255). |
...
Renk bileşenleri, camgöbeği (bit 24-31), macenta (bit 16-23), sarı (bit 8-15) ve ana/siyah (bit 0-7) sırasıyla 32-bit bir tam sayıya paketlenir.
