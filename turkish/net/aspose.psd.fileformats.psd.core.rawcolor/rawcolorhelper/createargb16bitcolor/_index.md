...
description: "RawColorHelper yöntemi. Kanal başına 16 bit ARGB renk oluşturur."
type: docs
weight: 20
url: /tr/net/aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createargb16bitcolor/
---
{{< psd/tize >}}
## RawColorHelper.CreateArgb16BitColor method

Kanal başına 16 bit ARGB renk oluşturur.
...
| --- | --- | --- |
| a | UInt16 | Alfa bileşen değeri (0-65535). |
| r | UInt16 | Kırmızı bileşen değeri (0-65535). |
| g | UInt16 | Yeşil bileşen değeri (0-65535). |
| b | UInt16 | Mavi bileşen değeri (0-65535). |

### Dönüş Değeri

ARGB rengini temsil eden yeni bir [`RawColor`](../../rawcolor/) örneği.

## Açıklamalar

Renk bileşenleri, alfa (bit 48-63), kırmızı (bit 32-47), yeşil (bit 16-31) ve mavi (bit 0-15) sırasıyla 64-bit bir tam sayıya paketlenir.
