---
title: "Sınıf RawColorHelper"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Core.RawColor.RawColorHelper sınıfı. Raw Color Helper sınıfı, önceden tanımlı kanal meta verilerini kullanarak RawColor'ı daha hızlı oluşturmayı sağlar"
type: docs
weight: 1660
url: /tr/net/aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/
---
{{< psd/tize >}}
...
| Ad | Açıklama |
| --- | --- |
| [RawColorHelper](rawcolorhelper/)() | Varsayılan yapıcı. |

## Yöntemler

| Ad | Açıklama |
| --- | --- |
| static [CreateArgb16BitColor](../../aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createargb16bitcolor/)(ushort, ushort, ushort, ushort) | Kanal başına 16 bit ARGB renk oluşturur. |
| static [CreateArgb8BitColor](../../aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createargb8bitcolor/#createargb8bitcolor)(Color) | Drawing.Color'dan kanal başına 8 bit ARGB renk oluşturur. |
| static [CreateArgb8BitColor](../../aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createargb8bitcolor/#createargb8bitcolor_1)(byte, byte, byte, byte) | Kanal başına 8 bit ARGB renk oluşturur. |
| static [CreateCmyk16BitBitColor](../../aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createcmyk16bitbitcolor/)(ushort, ushort, ushort, ushort) | Kanal başına 16 bit CMYK rengi oluşturur. |
| static [CreateCmyk8BitColor](../../aspose.psd.fileformats.psd.core.rawcolor/rawcolorhelper/createcmyk8bitcolor/)(byte, byte, byte, byte) | Kanal başına 8 bit CMYK rengi oluşturur. |
