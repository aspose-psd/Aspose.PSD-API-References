---
title: "Sınıf GaussianBlurSmartFilter"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.GaussianBlurSmartFilter sınıfı. GaussianBlur akıllı filtresi"
type: docs
weight: 3860
url: /tr/net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/
---
{{< psd/tize >}}
...
| Ad | Açıklama |
| --- | --- |
| [GaussianBlurSmartFilter](gaussianblursmartfilter/)() | `GaussianBlurSmartFilter` sınıfının yeni bir örneğini başlatır. |
...
| override [FilterId](../../aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/filterid/) { get; } | Akıllı filtre türü tanımlayıcısını alır. |
...
| override [Name](../../aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/name/) { get; } | Akıllı filtre adını alır. |
...
| [Radius](../../aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/radius/) { get; set; } | Gaussian akıllı filtrenin yarıçapını alır veya ayarlar. |
...
| Ad | Açıklama |
| --- | --- |
| const [FilterType](../../aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/filtertype/) | Geçerli akıllı filtrenin tanımlayıcısı. |
