...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.GaussianBlurSmartFilter sınıf. GaussianBlur akıllı filtresi.
type: docs
weight: 3430
...
| İsim | Tanım |
| --- | --- |
| [GaussianBlurSmartFilter](gaussianblursmartfilter/)() | Yeni bir örneğini başlatır.`GaussianBlurSmartFilter` sınıf. |
...
| [Radius](../../aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/radius/) { get; set; } | Gauss akıllı filtresinin yarıçapını alır veya ayarlar. |
