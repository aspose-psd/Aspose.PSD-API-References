---
title: "Sınıf AddNoiseSmartFilter"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.AddNoiseSmartFilter sınıfı. AddNoise akıllı filtresi"
type: docs
weight: 3830
url: /tr/net/aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/
---
{{< psd/tize >}}
...
| Ad | Açıklama |
| --- | --- |
| [AddNoiseSmartFilter](addnoisesmartfilter/)() | `AddNoiseSmartFilter` sınıfının yeni bir örneğini başlatır. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [AmountNoise](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/amountnoise/) { get; set; } | Gürültü değeri miktarını alır veya ayarlar. |
...
| [Distribution](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/distribution/) { get; set; } | Gürültü filtresinin dağılımını alır veya ayarlar. |
| override [FilterId](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/filterid/) { get; } | Akıllı filtre türü tanımlayıcısını alır. |
...
| [IsMonochromatic](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/ismonochromatic/) { get; set; } | Monokromatik değerini alır veya ayarlar. |
| override [Name](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/name/) { get; } | Akıllı filtre adını alır. |
...
| Ad | Açıklama |
| --- | --- |
| const [FilterType](../../aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/filtertype/) | Geçerli akıllı filtrenin tanımlayıcısı. |
