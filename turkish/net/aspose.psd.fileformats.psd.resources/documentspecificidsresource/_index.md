---
title: "Sınıf DocumentSpecificIdsResource"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Resources.DocumentSpecificIdsResource sınıfı. Belgeye Özel Kimlikler kaynağı"
type: docs
weight: 4180
url: /tr/net/aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
{{< psd/tize >}}
## DocumentSpecificIdsResource class

Belgeye Özel Id'ler kaynağı
...
| Ad | Açıklama |
| --- | --- |
| [DocumentSpecificIdsResource](documentspecificidsresource/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/datasize/) { get; } | Kaynak veri boyutunu bayt olarak alır. |
| [Id](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/id/) { get; set; } | Tanımlayıcıyı alır veya ayarlar. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Kaynak için benzersiz tanımlayıcıyı alır veya ayarlar. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/minimalversion/) { get; } | Gerekli minimum PSD sürümünü alır. |
