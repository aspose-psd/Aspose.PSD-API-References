...
description: Aspose.PSD.FileFormats.Psd.Resources.IccProfileResource sınıf. ICC profil kaynağını temsil eder.
type: docs
weight: 3760
...
| İsim | Tanım |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/iccprofileresource/datasize/) { get; } | Kaynak veri boyutunu bayt cinsinden alır. |
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/iccprofileresource/minimalversion/) { get; } | Gereken minimum PSD sürümünü alır. |
