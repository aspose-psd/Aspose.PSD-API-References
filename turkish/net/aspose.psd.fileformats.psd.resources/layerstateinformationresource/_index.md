---
title: "Sınıf LayerStateInformationResource"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Resources.LayerStateInformationResource sınıfı. Katman durumu bilgi kaynağı"
type: docs
weight: 4310
url: /tr/net/aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
{{< psd/tize >}}
## LayerStateInformationResource class

Katman durumu bilgisi kaynağı
...
| Ad | Açıklama |
| --- | --- |
| [LayerStateInformationResource](layerstateinformationresource/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layerstateinformationresource/datasize/) { get; } | Kaynak veri boyutunu bayt olarak alır. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Kaynak için benzersiz tanımlayıcıyı alır veya ayarlar. |
| [LayerIndex](../../aspose.psd.fileformats.psd.resources/layerstateinformationresource/layerindex/) { get; set; } | Katmanın indeksini alır veya ayarlar. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/layerstateinformationresource/minimalversion/) { get; } | Gerekli minimum PSD sürümünü alır. |
