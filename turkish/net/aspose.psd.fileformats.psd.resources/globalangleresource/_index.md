...
description: Aspose.PSD.FileFormats.Psd.Resources.GlobalAngleResource sınıf. Genel açı kaynağı
type: docs
weight: 3720
url: /tr/net/aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| İsim | Tanım |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalangleresource/datasize/) { get; } | Kaynak veri boyutunu bayt cinsinden alır. |
| [GlobalAngle](../../aspose.psd.fileformats.psd.resources/globalangleresource/globalangle/) { get; set; } | Genel açıyı alır veya ayarlar. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Kaynak için benzersiz tanımlayıcıyı alır veya ayarlar. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/globalangleresource/minimalversion/) { get; } | Gereken minimum PSD sürümünü alır. |
