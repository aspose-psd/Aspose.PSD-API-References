...
description: Aspose.PSD.FileFormats.Psd.Resources.ColorTransferFunctionsResource sınıf. Renk aktarım kaynağı
type: docs
weight: 3680
url: /tr/net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| İsim | Tanım |
| --- | --- |
| [ColorTransferData](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/colortransferdata/) { get; set; } | Renk aktarım verilerini alır veya ayarlar. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/datasize/) { get; } | Kaynak veri boyutunu bayt cinsinden alır. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Kaynak için benzersiz tanımlayıcıyı alır veya ayarlar. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/minimalversion/) { get; } | Gereken minimum PSD sürümünü alır. |
