...
description: BlendingOptions yöntem. Kontur efekti ekler.
type: docs
weight: 80
url: /tr/net/aspose.psd.fileformats.psd.layers.layereffects/blendingoptions/addstroke/
---
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| fillType | FillType | Konturu doldurmak için dolgu türü. |

### Geri dönüş değeri

Oluşturuldu[`StrokeEffect`](../../strokeeffect/) nesne.
