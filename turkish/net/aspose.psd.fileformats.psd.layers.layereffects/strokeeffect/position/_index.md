...
description: StrokeEffect mülk. Konturunuzun PSD katman içeriğine hizalamasını kontrol etmek için kontur efektinin konumunu alır veya ayarlar. Değer şu olabilirInside PSD katman içeriğinin içine kontur çizmek için veyaOutside PSD katman içeriğinin etrafına kontur çizmek için veCenter hem içeride hem de dışarıda kontur çizmek için.
type: docs
weight: 70
...
Konturunuzun PSD katman içeriğine hizalamasını kontrol etmek için kontur efektinin konumunu alır veya ayarlar. Değer şu olabilir:Inside PSD katman içeriğinin içine kontur çizmek için, veyaOutside PSD katman içeriğinin etrafına kontur çizmek için, veCenter hem içeride hem de dışarıda kontur çizmek için.
