...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerEffects.StrokeEffect sınıf. PSD katmanı için Adobe Photoshop kontur efekti.
type: docs
weight: 2190
...
PSD katmanı için Adobe® Photoshop® kontur efekti.
...
| [EffectType](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/effecttype/) { get; } | Bir tür effect alır |
| [FillSettings](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/fillsettings/) { get; set; } | Dolgu ayarlarını alır veya ayarlar. |
| [IsVisible](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/isvisible/) { get; set; } | Bu örneğin görünür olup olmadığını belirten bir değer alır veya ayarlar. |
| [Opacity](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/opacity/) { get; set; } | Opaklığı alır veya ayarlar. |
| [Overprint](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/overprint/) { get; set; } | Bunun olup olmadığını gösteren bir değer alır veya ayarlar.`StrokeEffect` konturu mevcut katman içeriğine göre harmanlayacaktır. |
| [Position](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/position/) { get; set; } | Konturunuzun PSD katman içeriğine hizalamasını kontrol etmek için kontur efektinin konumunu alır veya ayarlar. Değer şu olabilir:Inside PSD katman içeriğinin içine kontur çizmek için, veyaOutside PSD katman içeriğinin etrafına kontur çizmek için, veCenter hem içeride hem de dışarıda kontur çizmek için. |
| [Size](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/size/) { get; set; } | Kontur efektinin genişliğini alır veya ayarlar. |

### Örnekler

Aşağıdaki kod örneği, Renk Dolgusu ile Kontur efektinin oluşturulmasını gösterir.

```csharp
[C#]

// Dışa aktarma için Renkli Dolgu ile Kontur efektinin oluşturulmasını gerçekleştirin
