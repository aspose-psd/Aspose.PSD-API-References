---
title: "Arayüz IShapeLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.IShapeLayer arayüzü. Shape katmanının özelliklerini tanımlar."
type: docs
weight: 2260
url: /tr/net/aspose.psd.fileformats.psd.layers/ishapelayer/
---
{{< psd/tize >}}
## IShapeLayer interface

Şekil katmanının özelliklerini açıklar.
...
| Ad | Açıklama |
| --- | --- |
| [Fill](../../aspose.psd.fileformats.psd.layers/ishapelayer/fill/) { get; set; } | Şekillerin iç alanını doldurmak için kullanılan doldurma ayarları. |
| [Path](../../aspose.psd.fileformats.psd.layers/ishapelayer/path/) { get; } | Bir Shape katmanında bulunan Path'lerin kümesi. |
| [Stroke](../../aspose.psd.fileformats.psd.layers/ishapelayer/stroke/) { get; set; } | Şekillerin çizgi ayarları. |

## Örnekler

Aşağıdaki kod, Şekil Çizgisinin render edilmesini gösterir.
...
// Değiştirilen verileri kontrol edin.
