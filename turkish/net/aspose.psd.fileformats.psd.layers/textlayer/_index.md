...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer sınıf. Metin katmanı class
type: docs
weight: 3560
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Layer metninin metnini alır |
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Metin bağlı kutusunu alır veya ayarlar. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Görüntüyü yeniden boyutlandırır. VarsayılanLeftTopToLeftTopkullanılır. |
