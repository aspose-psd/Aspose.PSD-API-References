...
description: "TextLayer özelliği. Kaynak varsayılandan ayarlanan veya alınan Warp parametrelerini alır veya ayarlar"
type: docs
weight: 80
url: /tr/net/aspose.psd.fileformats.psd.layers/textlayer/warpsettings/
---
{{< psd/tize >}}
## TextLayer.WarpSettings property

Kaynak üzerinden ayarlanmış veya alınmış Warp parametrelerini alır veya ayarlar (varsayılan).
