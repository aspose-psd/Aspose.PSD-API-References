---
title: "ArtboardLayer sınıfı"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer sınıfı. Çizim tahtası katman sınıfı"
type: docs
weight: 1990
url: /tr/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Çizim tahtası arka plan rengini alır veya ayarlar. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | `ArtboardLayer`'ın arka plan rengine sahip olup olmadığını belirten değeri alır veya ayarlar. |
