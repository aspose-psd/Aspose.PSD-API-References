...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer sınıf. psd katmanı.
type: docs
weight: 2080
...
| İsim | Tanım |
| --- | --- |
| [Layer](layer/#constructor)() | Yeni bir örneğini başlatır.`Layer` sınıf. Geç başlatma için yapıcı. |
| [Layer](layer/#constructor_3)(Stream) | Yeni bir örneğini başlatır.`Layer` sınıf. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Yeni bir örneğini başlatır.`Layer` sınıf. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Yeni bir örneğini başlatır.`Layer` bayt dizilerinden sınıf. |
...
| İsim | Tanım |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Karışım modu imzasını temsil eder. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | Katman başlığı boyutu. |
