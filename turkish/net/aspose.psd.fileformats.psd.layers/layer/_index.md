...
description: "Aspose.PSD.FileFormats.Psd.Layers.Layer sınıfı. PSD katmanı"
type: docs
weight: 2270
url: /tr/net/aspose.psd.fileformats.psd.layers/layer/
---
{{< psd/tize >}}
## Layer class
...
| Ad | Açıklama |
| --- | --- |
| [Layer](layer/#constructor)() | `Layer` sınıfının yeni bir örneğini başlatır. Tembel başlatma için yapıcı. |
| [Layer](layer/#constructor_3)(Stream) | `Layer` sınıfının yeni bir örneğini başlatır. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | `Layer` sınıfının yeni bir örneğini başlatır. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | `Layer` sınıfının yeni bir örneğini bayt dizilerinden başlatır. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Nesnenin verilerini belirtilen akışa kaydeder. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Nesnenin verilerini belirtilen dosya konumuna kaydeder. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen dosya konumuna kaydeder. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen akışa kaydeder. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya biçiminde belirtilen dosya konumuna kaydeder. |
...
| Ad | Açıklama |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Karıştırma modu imzasını temsil eder. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | Katman başlık boyutu. |
