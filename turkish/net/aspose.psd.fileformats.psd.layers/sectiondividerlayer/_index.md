...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer sınıf. Klasörün katman grubu sınırlarını işaretlemek için bölüm ayırıcı katman.
type: docs
weight: 3410
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Bu örneğin grupta görünüp görünmediğini gösteren bir değer alır (katman grupta değilse, kök grup anlamına gelir). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Şunu alır:[`LayerGroup`](../layergroup/) bununla alakalı`SectionDividerLayer` örnek. |
