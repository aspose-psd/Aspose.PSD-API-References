...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup sınıf. Grup katmanı class
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Karışım modu tuşunu alır veya ayarlar. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Katmanlar grubunun yüksekliğini alır. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Alır veya ayarlar klasörü açılır olarak ayarlanırsa`doğru` grup başlangıçta açık durumda, aksi takdirde küçültülmüş durumda olacaktır. |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | Katmanlar grubunun genişliğini alır. |
