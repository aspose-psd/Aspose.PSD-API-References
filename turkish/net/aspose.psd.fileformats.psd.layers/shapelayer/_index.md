---
title: "Sınıf ShapeLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer sınıfı. Shape katmanı. Shape katmanı ve ilgili kaynaklarla çalışmanın mantığını kapsüller."
type: docs
weight: 3820
url: /tr/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class
...
| Ad | Açıklama |
| --- | --- |
| [ShapeLayer](shapelayer/)() | `ShapeLayer` sınıfının yeni bir örneğini başlatır. Tüm kaynaklar varsayılan durumunda oluşturulur. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Shape katmanındaki Şekillerin iç alanı için Doldurma ayarlarını alır veya ayarlar. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Bir Shape katmanında bulunan Path'lerin kümesini alır. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Şekillerin Çizgi (Stroke) ayarlarını alır veya ayarlar. |
...
| Ad | Açıklama |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | `ShapeLayer` sınıfının yeni bir örneğini oluşturur. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Shape katmanı özelliklerinden kaynakları günceller. |
