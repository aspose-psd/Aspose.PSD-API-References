...
description: "ShapeLayer özelliği. Shape katmanındaki Şekillerin iç alanı için Dolgu ayarlarını alır veya ayarlar."
type: docs
weight: 30
url: /tr/net/aspose.psd.fileformats.psd.layers/shapelayer/fill/
---
{{< psd/tize >}}
## ShapeLayer.Fill property

Shape katmanındaki Şekillerin iç alanı için Doldurma ayarlarını alır veya ayarlar.
...
Aşağıdaki kod, ShapeLayer'ın Fill özelliğini gösterir.
