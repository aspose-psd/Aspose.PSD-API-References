...
description: LinkedLayersManager yöntem. Katmanla ilişkili bağlantı grubu kimliğini alır.
type: docs
weight: 20
url: /tr/net/aspose.psd.fileformats.psd.layers/linkedlayersmanager/getlinkgroupid/
---
## LinkedLayersManager.GetLinkGroupId method

Katmanla ilişkili bağlantı grubu kimliğini alır.
