...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerHashCalculator sınıfı. PSD Katmanları için Karma (Hash) Hesaplayıcı. Farklı PSD dosyalarındaki eşit veya farklı katmanları bulmak için kullanılabilir."
type: docs
weight: 2430
...
| Ad | Açıklama |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator/)(Layer) | Yeni bir `LayerHashCalculator` sınıfı örneği başlatır. |
...
| [GetChannelsHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getchannelshash/)() | Kanallar karmasını alır. |
