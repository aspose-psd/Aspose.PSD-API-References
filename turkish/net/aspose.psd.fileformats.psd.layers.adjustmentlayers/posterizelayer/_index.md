...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer sınıf. Posterleştirme katmanı. PostResource. verilerini kullanarak Posterize oluşturmayı işler
type: docs
weight: 1800
...
Posterleştirme katmanı. PostResource. verilerini kullanarak Posterize oluşturmayı işler
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Posterleştirme katmanının seviyeleri. |
