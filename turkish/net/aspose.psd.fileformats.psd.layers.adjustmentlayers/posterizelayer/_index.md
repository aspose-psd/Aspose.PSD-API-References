---
title: "Sınıf PosterizeLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer sınıfı. Posterize katmanı. Posterize renderlamasını PostResource verilerini kullanarak işler."
type: docs
weight: 1870
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
{{< psd/tize >}}
## PosterizeLayer class

Posterleştirme katmanı. PostResource'tan gelen verileri kullanarak posterleştirme render'ını yönetir.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Posterize katmanının seviyeleri. |
