---
title: "Sınıf ColorBalanceAdjustmentLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ColorBalanceAdjustmentLayer sınıfı. Renk dengesi ayar katmanı sınıfı."
type: docs
weight: 1770
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
{{< psd/tize >}}
## ColorBalanceAdjustmentLayer class

Renk dengesi ayarlama katmanı sınıfı.
...
| [HighlightsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightscyanredbalance/) { get; set; } | Vurguların Camgöbeği Kırmızı Dengesini alır veya ayarlar. |
| [HighlightsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsmagentagreenbalance/) { get; set; } | Vurguların Magenta Yeşil Dengesini alır veya ayarlar. |
| [HighlightsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsyellowbluebalance/) { get; set; } | Vurguların Sarı Mavi Dengesini alır veya ayarlar. |
...
| [MidtonesCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonescyanredbalance/) { get; set; } | Orta tonların Camgöbeği Kırmızı Dengesini alır veya ayarlar. |
| [MidtonesMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesmagentagreenbalance/) { get; set; } | Orta tonların Magenta Yeşil Dengesini alır veya ayarlar. |
| [MidtonesYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesyellowbluebalance/) { get; set; } | Orta tonların Sarı Mavi Dengesini alır veya ayarlar. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/preserveluminosity/) { get; set; } | Bu [`BlncResource`](../../aspose.psd.fileformats.psd.layers.layerresources/blncresource/) ışıklılığı koruyup korumadığını gösteren bir değeri alır veya ayarlar. |
...
| [ShadowsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowscyanredbalance/) { get; set; } | Gölgelerin Camgöbeği Kırmızı Dengesini alır veya ayarlar. |
| [ShadowsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsmagentagreenbalance/) { get; set; } | Gölgelerin Magenta Yeşil Dengesini alır veya ayarlar. |
| [ShadowsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsyellowbluebalance/) { get; set; } | Gölgelerin Sarı Mavi Dengesini alır veya ayarlar. |
...
| override [MergeLayerTo](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/adjustmentlayer/mergelayerto/)(Layer) | Katmanı belirtilen katmana birleştirir |
