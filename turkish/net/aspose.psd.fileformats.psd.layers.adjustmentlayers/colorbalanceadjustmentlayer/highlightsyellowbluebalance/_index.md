...
description: "ColorBalanceAdjustmentLayer özelliği. Highlights Yellow Blue Balance değerini alır veya ayarlar"
type: docs
weight: 30
...
| istisna | koşul |
| --- | --- |
| ArgumentOutOfRangeException | Highlights Yellow Blue Balance -100 ile +100 arasında olmalıdır. |
