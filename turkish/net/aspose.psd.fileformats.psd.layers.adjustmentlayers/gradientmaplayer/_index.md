---
title: "GradientMapLayer sınıfı"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer sınıfı. Gradient harita katmanı. Gradient harita render'ını GrdmResource verisini kullanarak işler"
type: docs
weight: 1810
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
## GradientMapLayer class

Gradyan harita katmanı. GrdmResource'tan gelen verileri kullanarak gradyan harita render'ını yönetir.
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | GrdmResource örneğinden geçirilen Gradient ayarları örneğini alır veya ayarlar. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | İlgili katman kaynağındaki katman verisini güncelle [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/). |
