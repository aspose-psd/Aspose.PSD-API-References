...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes enum. Seçici renk ayar katmanındaki düzeltme yöntemi"
type: docs
weight: 1780
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
## CorrectionMethodTypes enumeration

Seçici renk ayar katmanında düzeltme yöntemi.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Relative | `0` | Renk düzeltmesini göreceli modda uygula. |
| Absolute | `1` | Renk düzeltmesini mutlak modda uygula. |
