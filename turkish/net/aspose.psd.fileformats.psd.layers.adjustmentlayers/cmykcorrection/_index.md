---
title: "Sınıf CmykCorrection"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection sınıfı. Seçici renk ayarlama katmanında renk düzeltmesi"
type: docs
weight: 1750
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
## CmykCorrection class

Seçmeli renk ayarlama katmanında renk düzeltmesi.
...
| Ad | Açıklama |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | Siyah renk düzeltmesini alır veya ayarlar. |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | Camgöbeği renk düzeltmesini alır veya ayarlar. |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | Macenta renk düzeltmesini alır veya ayarlar. |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | Sarı renk düzeltmesini alır veya ayarlar. |
