...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer sınıf. Kanal Karıştırıcı Ayarlama katmanı.
type: docs
weight: 1690
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Bunun olup olmadığını gösteren bir değer alır veya ayarlar.`ChannelMixerLayer` tek renkli. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | tarafından kanalın indeksini alır. RgbMixerChannel veya CmykMixerChannel döndürebilir |
