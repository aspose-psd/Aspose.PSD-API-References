---
title: "Sınıf ChannelMixerLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer sınıfı. Channel Mixer ayar katmanı"
type: docs
weight: 1730
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
{{< psd/tize >}}
## ChannelMixerLayer class

Kanal Karıştırıcı Ayarlama katmanı.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Bu `ChannelMixerLayer`'ın tek renkli olup olmadığını belirten bir değeri alır veya ayarlar. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Kanalın indeksini alır. RgbMixerChannel veya CmykMixerChannel döndürebilir. |
