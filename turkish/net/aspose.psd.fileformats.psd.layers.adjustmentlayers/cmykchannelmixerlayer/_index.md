...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer sınıfı. Cmyk Kanal Karıştırıcı Ayar katmanı"
type: docs
weight: 1740
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
{{< psd/tize >}}
## CmykChannelMixerLayer class

CMYK Kanal Karıştırıcı Ayarlama katmanı.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | Siyah kanalı alır. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Camgöbeği kanalı alır. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | Macenta kanalı alır. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Bu [`ChannelMixerLayer`](../channelmixerlayer/) katmanının monokrom olup olmadığını gösteren bir değeri alır veya ayarlar. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | Sarı kanalı alır. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Kanalın indeksini alır. CmykMixerChannel döndürür. |
