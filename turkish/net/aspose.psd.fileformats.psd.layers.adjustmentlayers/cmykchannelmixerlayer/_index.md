...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer sınıf. Cmyk Kanal Karıştırıcı Ayarlama katmanı.
type: docs
weight: 1700
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Mavi kanalı alır. |
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`ChannelMixerLayer`](../channelmixerlayer/) tek renkli. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | tarafından kanalın indeksini alır. CmykMixerChannel döndürür |
