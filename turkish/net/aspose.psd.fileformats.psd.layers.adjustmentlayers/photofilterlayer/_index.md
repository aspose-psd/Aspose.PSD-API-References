---
title: "Sınıf PhotoFilterLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer sınıfı. PhotoFilter ayarlama katmanı"
type: docs
weight: 1860
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Filtrein RGB rengini alır veya ayarlar. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Filtrein yoğunluğunu alır veya ayarlar. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Parlaklığın korunup korunmadığını gösteren bir değeri alır veya ayarlar [preserve luminosity]. |
