...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorsTypes enum. Seçici renk ayarlama katmanındaki renk türleri"
type: docs
weight: 1910
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes/
---
{{< psd/tize >}}
## SelectiveColorsTypes enumeration

Seçici renk ayar katmanındaki renk türleri.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Reds | `0` | Kırmızı renkler. |
| Yellows | `1` | Sarı renkler. |
| Greens | `2` | Yeşil renkler. |
| Cyans | `3` | Camgöbeği renkler. |
| Blues | `4` | Mavi renkler. |
| Magentas | `5` | Macenta renkler. |
| Whites | `6` | Beyaz renkler. |
| Neutrals | `7` | Nötr renkler. |
| Blacks | `8` | Siyah renkler. |
