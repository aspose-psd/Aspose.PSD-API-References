---
title: "Sınıf ExposureLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer sınıfı. Exposure Ayar katmanı."
type: docs
weight: 1800
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
{{< psd/tize >}}
## ExposureLayer class
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Exposure değerini alır veya ayarlar. PS için Exposure aralığı -20 ile +20 arasındadır. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | GammaCorrection değerini alır veya ayarlar. PS için GammaCorrection aralığı 9.99 ile +0.01 arasındadır. |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Offset değerini alır veya ayarlar. PS için Offset aralığı -0.5 ile +0.5 arasındadır. |
