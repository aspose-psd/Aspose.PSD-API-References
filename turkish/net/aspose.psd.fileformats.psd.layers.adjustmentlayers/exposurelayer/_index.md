...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer sınıf. Pozlama Ayarlama katmanı.
type: docs
weight: 1740
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Pozlamayı alır veya ayarlar. PS için Pozlama aralığı -20 ile +20. arasındadır. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | GammaDüzeltme'yi alır veya ayarlar. PS için Gama Düzeltme aralığı 9,99 ila +0,01 arasındadır. |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Ofseti alır veya ayarlar. PS Ofset aralığı için -0,5 ile +0,5 arasındadır |
