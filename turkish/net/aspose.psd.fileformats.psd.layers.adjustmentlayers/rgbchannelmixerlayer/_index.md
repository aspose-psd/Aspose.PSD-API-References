---
title: "Sınıf RgbChannelMixerLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer sınıfı. Rgb Channel Mixer Ayar katmanı"
type: docs
weight: 1880
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
{{< psd/tize >}}
## RgbChannelMixerLayer class

Rgb Kanal Karıştırıcı Ayar katmanı.
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel/) { get; } | Mavi kanalı alır. |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel/) { get; } | Yeşil kanalı alır. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel/) { get; } | Kırmızı kanalı alır. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | Kanalın indeksini alır. RgbMixerChannel döndürür. |
