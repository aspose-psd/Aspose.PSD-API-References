...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer sınıf. Rgb Kanal Karıştırıcı Ayarlama katmanı.
type: docs
weight: 1810
...
Rgb Kanal Karıştırıcı Ayarlama katmanı.
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | tarafından kanalın indeksini alır. RgbMixerChannel döndürür |
