...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer sınıf. Titreşim ayarlama katmanının gerçekleştirilmesi
type: docs
weight: 1830
...
Titreşim ayarlama katmanının gerçekleştirilmesi
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance/) { get; set; } | Titreşimi alır veya ayarlar. |
