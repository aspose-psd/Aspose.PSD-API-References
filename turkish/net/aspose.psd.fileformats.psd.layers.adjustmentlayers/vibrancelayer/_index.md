---
title: "Sınıf VibranceLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer sınıfı. Vibrance ayar katmanının gerçekleştirilmesi."
type: docs
weight: 1930
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
{{< psd/tize >}}
## VibranceLayer class

Vibrance ayar katmanının gerçekleştirilmesi
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation/) { get; set; } | Doygunluğu alır veya ayarlar. |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance/) { get; set; } | Vibrance'ı alır veya ayarlar. |
