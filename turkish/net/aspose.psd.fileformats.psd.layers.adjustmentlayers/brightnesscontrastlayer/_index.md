...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer sınıf. Parlaklık/kontrast katmanı.
type: docs
weight: 1680
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | Parlaklığı alır veya ayarlar. PS için parlaklık aralığı -150 ile +150 arasındadır. Ama bunu görmezden geliyoruz. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | Kontrastı alır veya ayarlar. PS için kontrast aralığı -50 ile +100 arasındadır. Ama bunu görmezden geliyoruz. |
