---
title: "Sınıf HueSaturationLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer sınıfı. HueSaturation ayar katmanı"
type: docs
weight: 1820
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
{{< psd/tize >}}
## HueSaturationLayer class

Renk Tonu/Doygunluk ayarlama katmanı.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Bu `HueSaturationLayer`'ın renklenip renklendirileceğini belirten bir değeri alır veya ayarlar. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Renk tonunu alır veya ayarlar. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | Açıklığı alır veya ayarlar. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | Doygunluğu alır veya ayarlar. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | Aralığı alır. |
