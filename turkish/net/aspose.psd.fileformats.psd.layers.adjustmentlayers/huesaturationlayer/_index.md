...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer sınıf. Ton Doygunluğu ayarlama katmanı.
type: docs
weight: 1750
...
Ton Doygunluğu ayarlama katmanı.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Bunun olup olmadığını gösteren bir değer alır veya ayarlar.`HueSaturationLayer` colorize. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Tonu alır veya ayarlar. |
