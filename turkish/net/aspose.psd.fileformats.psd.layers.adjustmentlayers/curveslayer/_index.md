...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer sınıf. Eğrileri Ayarlama Katmanı
type: docs
weight: 1730
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Bu örneğin sürekli yönetici tarafından kullanıldığını gösteren bir değer alır veya ayarlar. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Bu örneğin kullanılan ayrı yönetici olup olmadığını gösteren bir değer alır veya ayarlar. |
