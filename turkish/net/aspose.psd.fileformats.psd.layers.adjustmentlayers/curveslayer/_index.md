---
title: "Sınıf CurvesLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer sınıfı. Curves ayar katmanı"
type: docs
weight: 1790
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
{{< psd/tize >}}
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Bu örneğin sürekli yönetici kullanılıp kullanılmadığını belirten bir değeri alır veya ayarlar. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Bu örneğin ayrık yönetici kullanılıp kullanılmadığını belirten bir değeri alır veya ayarlar. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | Eğri yöneticisini alır. |
