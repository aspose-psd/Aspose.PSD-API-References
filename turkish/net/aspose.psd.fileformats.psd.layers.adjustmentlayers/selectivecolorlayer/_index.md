---
title: "Sınıf SelectiveColorLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorLayer sınıf. Seçici Renk Ayar Katmanı"
type: docs
weight: 1900
url: /tr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
{{< psd/tize >}}
## SelectiveColorLayer class

Seçici Renk Ayar Katmanı.
...
| [CorrectionMethod](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/correctionmethod/) { get; set; } | Düzeltme yöntemini alır veya ayarlar. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/version/) { get; } | Sürümü alır. |
...
| [GetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/)(SelectiveColorsTypes) | Seçici renk ile cmyk düzeltmesini alır. |
...
| [SetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/)(SelectiveColorsTypes, CmykCorrection) | Seçici renk ile cmyk düzeltmesini ayarlar. |
...
Aşağıdaki kod, SelectiveColorLayer ayarlama katmanının desteğini gösterir.
...
// Görüntüden Selective Color ayarlama katmanını al, kontrol et ve değiştir.
using (var image = (PsdImage)Image.Load(sourceFileWithSelectiveColorLayer))
{
    foreach (var layer in image.Layers)
    {
        ...
        {
            // Selective Color ayarlama katmanını al.
            ...
            // Katman parametrelerini değiştir.
...
// Selective color ayarlama katmanını görüntüye ekle ve ayarla.
using (var image = (PsdImage)Image.Load(sourceFileWithoutSelectiveColorLayer))
{
    // Selective Color Adjustment katmanını ekle.
