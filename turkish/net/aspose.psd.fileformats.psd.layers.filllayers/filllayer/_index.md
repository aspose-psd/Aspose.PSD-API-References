...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer sınıf. Dolgu katmanı. Farklılık gösteren Renk Dolgusu Degrade Dolgusu veya Desen Dolgusu KatmanıFillSettings
type: docs
weight: 1910
...
Dolgu katmanı. Farklılık gösteren Renk Dolgusu, Degrade Dolgusu veya Desen Dolgusu Katmanı[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Dolgu ayarlarını alır. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Dolgu türünü alır. |
...
| İsim | Tanım |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Yeni bir örneğini oluşturun`FillLayer` fill. türüne göre sınıf |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Saydam olmayan tüm renkleri yeni renkle değiştirir ve düzgün kenarları korumak için orijinal alfa değerini korur. Not: saydam olmayan görüntülerde kullanırsanız, tüm renkler tek bir renkle değiştirilir. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Dolgu Katmanı Piksel Verilerini gerçek değerlere göre günceller[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* ad alanı [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* toplantı [Aspose.PSD](../../)
