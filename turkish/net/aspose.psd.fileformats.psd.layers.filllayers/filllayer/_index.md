---
title: "Sınıf FillLayer"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer sınıfı. Doldurma katmanı. Renk Doldurma, Gradyan Doldurma veya Desen Doldurma Katmanı, FillSettings tarafından farklılık gösterir"
type: docs
weight: 2020
url: /tr/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
{{< psd/tize >}}
## FillLayer class

Doldurma katmanı. Renk Doldurma, Gradyan Doldurma veya Desen Doldurma Katmanı, [`FillSettings`](./fillsettings/) tarafından farklılık gösterir
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | Doldurma ayarlarını alır veya ayarlar. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Doldurmanın türünü alır. |
...
| Ad | Açıklama |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | `FillLayer` sınıfının yeni bir örneğini doldurma türüne göre oluşturur. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Tüm saydam olmayan renkleri yeni renk ile değiştirir ve düzgün kenarları korumak için orijinal alfa değerini korur. Not: Saydamlığı olmayan görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Mevcut [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) temelinde doldurma katmanının piksel verilerini günceller. |
