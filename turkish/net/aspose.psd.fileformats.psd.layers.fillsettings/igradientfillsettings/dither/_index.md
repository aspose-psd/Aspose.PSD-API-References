...
description: IGradientFillSettings mülk. Bunun olup olmadığını gösteren bir değer alır veya ayarlar.IGradientFillSettings titreme.
type: docs
weight: 50
...
Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`IGradientFillSettings`](../) titreme.
