...
description: "IGradientFillSettings özelliği. Bu IGradientFillSettings'in titreme olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 30
url: /tr/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
{{< psd/tize >}}
## IGradientFillSettings.Dither property

Bu [`IGradientFillSettings`](../) titreme olup olmadığını gösteren bir değeri alır veya ayarlar.
