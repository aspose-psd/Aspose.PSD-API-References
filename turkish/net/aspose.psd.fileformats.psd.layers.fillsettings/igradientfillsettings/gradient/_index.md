...
description: "IGradientFillSettings özelliği. Belirli degrade tanım örneğini (Solid/Noise) alır veya ayarlar"
type: docs
weight: 40
url: /tr/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/gradient/
---
{{< psd/tize >}}
## IGradientFillSettings.Gradient property

Belirli degrade tanımı örneğini (Katı/Gürültü) alır veya ayarlar.
