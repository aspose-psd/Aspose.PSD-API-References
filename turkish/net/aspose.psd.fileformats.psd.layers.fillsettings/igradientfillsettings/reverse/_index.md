...
description: "IGradientFillSettings özelliği. Bu IGradientFillSettings'in ters olup olmadığını gösteren bir değeri alır veya ayarlar"
type: docs
weight: 80
url: /tr/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
{{< psd/tize >}}
## IGradientFillSettings.Reverse property

Bu [`IGradientFillSettings`](../) ters olup olmadığını gösteren bir değeri alır veya ayarlar.
