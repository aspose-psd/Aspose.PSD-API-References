...
description: IGradientFillSettings mülk. Bunun olup olmadığını gösteren bir değer alır veya ayarlar.IGradientFillSettings ters.
type: docs
weight: 90
...
Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`IGradientFillSettings`](../) ters.
