---
title: "Sınıf GradientMapSettings"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientMapSettings sınıf. Degrade haritası katmanı için degrade ayarları sınıfı. Hem Katı hem de Gürültü türündeki degradeler için ortak özellikleri içerir."
type: docs
weight: 2080
url: /tr/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/
---
{{< psd/tize >}}
## GradientMapSettings class

Gradyan harita katmanı için gradyan ayarları sınıfı. Hem Katı hem de Gürültü gradyan türleri için ortak özellikleri içerir.
...
| Ad | Açıklama |
| --- | --- |
| [GradientMapSettings](gradientmapsettings/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/dither/) { get; set; } | Bu [`GradientFillSettings`](../gradientfillsettings/) öğesinin titreme yapıp yapmadığını belirten bir değeri alır veya ayarlar. |
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/) { get; set; } | Belirli degrade tanımı örneğini (Katı/Gürültü) alır veya ayarlar. |
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/interpolationmethod/) { get; set; } | Degrade için ara değerleme yöntemini alır veya ayarlar. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/reverse/) { get; set; } | Bu [`GradientFillSettings`](../gradientfillsettings/) öğesinin ters olup olmadığını belirten bir değeri alır veya ayarlar. |
