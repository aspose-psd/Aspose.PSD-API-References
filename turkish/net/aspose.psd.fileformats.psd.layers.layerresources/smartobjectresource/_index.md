...
SmartObjectResource sınıfını tanımlar; bu sınıf PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içerir. Adobe® Photoshop® görüntülerinde akıllı nesne katmanlarını desteklemek için kullanılan Sold ve Sole kaynakları için temel sınıftır.
...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | Alır veya ayarlar PSD görüntüsündeki akıllı nesne katman verisinin `SmartObjectResource` küresel benzersiz tanımlayıcısını. |
