...
description: VsmsResource inşaatçı. Yeni bir örneğini başlatır.VsmsResource sınıf.
type: docs
weight: 10
...
Yeni bir örneğini başlatır.[`VsmsResource`](../) sınıf.
...
* class [VsmsResource](../)
* ad alanı [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../vsmsresource/)
* toplantı [Aspose.PSD](../../../)
