...
description: Lnk3Resource inşaatçı. Yeni bir örneğini başlatır.Lnk3Resource sınıf.
type: docs
weight: 10
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/lnk3resource/lnk3resource/
---
## Lnk3Resource constructor

Yeni bir örneğini başlatır.[`Lnk3Resource`](../) sınıf.
...
* class [Lnk3Resource](../)
* ad alanı [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lnk3resource/)
* toplantı [Aspose.PSD](../../../)
