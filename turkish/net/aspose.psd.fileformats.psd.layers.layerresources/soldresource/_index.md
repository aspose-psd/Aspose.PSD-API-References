...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource sınıf. Bir PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içeren SoLdResource sınıfını tanımlar. Adobe Photoshop görüntülerinde akıllı nesne katmanlarını desteklemek için kullanılır.
type: docs
weight: 3020
...
Bir PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içeren SoLdResource sınıfını tanımlar. Adobe® Photoshop® görüntülerinde akıllı nesne katmanlarını desteklemek için kullanılır.
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/key/) { get; } | SoLd akıllı nesne katmanı kaynak anahtarını alır. |
...
| İsim | Tanım |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | Tip aracı bilgi anahtarı: 'SoLd'. |
