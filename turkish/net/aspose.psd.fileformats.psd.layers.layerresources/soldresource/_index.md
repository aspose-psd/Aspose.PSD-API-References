---
title: "Sınıf SoLdResource"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource sınıfı. SoLdResource sınıfını tanımlar; bu sınıf bir PSD dosyasındaki akıllı nesne katmanı hakkında bilgi içerir. Adobe Photoshop görüntülerindeki akıllı nesne katmanlarını desteklemek için kullanılır."
type: docs
weight: 3370
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
{{< psd/tize >}}
## SoLdResource class
...
| Ad | Açıklama |
| --- | --- |
| [SoLdResource](soldresource/#constructor)() | Yeni bir `SoLdResource` sınıfı örneği başlatır. Bu varsayılan yapıcı, SoLdResourceLoader tarafından kullanılmak üzere tasarlanmıştır. SoLdResource sınıfları oluşturmak için [`SmartResourceCreator`](../smartresourcecreator/) kullanın. |
| [SoLdResource](soldresource/#constructor_1)(Guid, bool, bool) | Yeni bir `SoLdResource` sınıfı örneği başlatır. Hazır bir örnek elde etmek için Items özelliğini ayarlamak veya InitializeItems() metodunu çağırmak gerekir. Bu yapıcı, [`SmartResourceCreator`](../smartresourcecreator/) tarafından ve birim testlerinde kullanılmak üzere tasarlanmıştır. SoLdResource sınıfları oluşturmak için [`SmartResourceCreator`](../smartresourcecreator/) kullanın. |
...
| Ad | Açıklama |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | Tür araç bilgi anahtarı: 'SoLd'. |
