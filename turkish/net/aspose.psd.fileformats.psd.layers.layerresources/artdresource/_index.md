---
title: "Sınıf ArtDResource"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtDResource sınıfı. GlobalLayerResources için Artboard bilgi verisi"
type: docs
weight: 2530
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/artdresource/
---
{{< psd/tize >}}
## ArtDResource class

[`GlobalLayerResources`](../../aspose.psd.fileformats.psd/psdimage/globallayerresources/) için Artboard bilgi verisi.
...
| Ad | Açıklama |
| --- | --- |
| [ArtDResource](artdresource/)() | Varsayılan yapıcı. |
...
| Ad | Açıklama |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artdresource/typetoolkey/) | Tip aracı bilgi anahtarı. |
