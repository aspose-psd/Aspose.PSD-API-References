...
description: Lnk2Resource inşaatçı. Yeni bir örneğini başlatır.Lnk2Resource sınıf.
type: docs
weight: 10
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/lnk2resource/
---
## Lnk2Resource constructor

Yeni bir örneğini başlatır.[`Lnk2Resource`](../) sınıf.
