...
description: GdFlResource mülk. Bunun olup olmadığını gösteren bir değer alır veya ayarlar.GdFlResource titreme.
type: docs
weight: 60
...
Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`GdFlResource`](../) titreme.
