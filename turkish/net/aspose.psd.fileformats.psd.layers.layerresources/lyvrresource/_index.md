---
title: "Sınıf LyvrResource"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource sınıfı. Katmanın Photoshop sürümünü temsil eden kaynak"
type: docs
weight: 3150
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

Katmanın Photoshop sürümünü temsil eden kaynak.
...
| Ad | Açıklama |
| --- | --- |
| [LyvrResource](lyvrresource/)() | Varsayılan yapıcı. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | Katmanın Photoshop sürümünü alır veya ayarlar. |

## Yöntemler

| Ad | Açıklama |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | Kaynağı belirtilen akış konteynerine kaydeder. |
...
| Ad | Açıklama |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | Tip aracı bilgi anahtarı. |
