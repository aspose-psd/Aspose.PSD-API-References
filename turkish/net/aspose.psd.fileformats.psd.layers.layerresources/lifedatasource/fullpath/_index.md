...
description: "LiFeDataSource özelliği. PSD LnkE kaynağının LiFE veri kaynağındaki harici dosyanın tam yolunu alır veya ayarlar"
type: docs
weight: 90
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
{{< psd/tize >}}
...
| istisna | koşul |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FullPath özelliğine erişemezsiniz, yalnızca liFE veri kaynağı için kullanılabilir |
