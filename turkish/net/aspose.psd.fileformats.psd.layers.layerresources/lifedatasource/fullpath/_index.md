...
description: LiFeDataSource mülk. PSD LnkE kaynağının LiFE veri kaynağındaki harici dosyanın tam yolunu alır veya ayarlar.
type: docs
weight: 90
...
| istisna | şart |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FullPath özelliğine erişemezsiniz, yalnızca liFE verileri için kullanılabilir source |
