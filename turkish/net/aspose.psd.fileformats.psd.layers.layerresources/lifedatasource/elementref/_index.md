...
description: "LiFeDataSource özelliği. Adobe Photoshop CC Libraries için grafik kitaplığı öğesi referansını alır veya ayarlar."
type: docs
weight: 60
...
Adobe® Photoshop® CC Libraries için grafik kütüphanesi öğesi referansını alır veya ayarlar.
...
| istisna | koşul |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | ElementRef özelliğine erişemezsiniz, yalnızca IsLibrary true olduğunda liFE veri kaynağı için kullanılabilir. |
