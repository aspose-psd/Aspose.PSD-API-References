...
description: LiFeDataSource mülk. PSD LnkE kaynağının LiFE veri kaynağındaki harici dosyanın göreli yolunu alır veya ayarlar.
type: docs
weight: 100
...
| istisna | şart |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | RelativePath özelliğine erişemezsiniz, yalnızca liFE verileri için kullanılabilir source |
