...
description: LiFeDataSource mülk. Adobe Photoshop CC Libraries için AdobeStockId grafik kitaplığını alır veya ayarlar.
type: docs
weight: 20
...
Adobe® Photoshop® CC Libraries için AdobeStockId grafik kitaplığını alır veya ayarlar.
...
Grafik kitaplığı Adobe Stock Identifier.

### istisnalar

| istisna | şart |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | AdobeStockId özelliğine erişemezsiniz, IsLibrary true olduğunda yalnızca liFE veri kaynağı için kullanılabilir. |
