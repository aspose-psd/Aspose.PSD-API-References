...
description: LiFeDataSource mülk. PSD LnkE kaynağının LiFE veri kaynağındaki harici dosyanın boyutunu alır veya ayarlar.
type: docs
weight: 80
...
| istisna | şart |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FileSize özelliğine erişemezsiniz, yalnızca liFE verileri için kullanılabilir source |
