...
description: "LiFeDataSource özelliği. PSD LnkE kaynağının LiFE veri kaynağındaki harici dosyanın boyutunu alır veya ayarlar."
type: docs
weight: 80
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
{{< psd/tize >}}
...
| istisna | koşul |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FileSize özelliğine erişemezsiniz, yalnızca liFE veri kaynağı için kullanılabilir. |
