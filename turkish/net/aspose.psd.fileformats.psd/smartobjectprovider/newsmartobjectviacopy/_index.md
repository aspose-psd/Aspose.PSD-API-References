...
description: "SmartObjectProvider yöntemi. Kaynak katmanı kopyalayarak yeni bir akıllı nesne katmanı oluşturur"
type: docs
weight: 30
...
| --- | --- | --- |
| sourceLayer | SmartObjectLayer | Kaynak katman. |

### Dönüş Değeri

Klonlanmış [`SmartObjectLayer`](../../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) örneği.

### İstisnalar

| istisna | koşul |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Yalnızca gömülü bir akıllı nesneyi değiştirebilirsiniz. |
