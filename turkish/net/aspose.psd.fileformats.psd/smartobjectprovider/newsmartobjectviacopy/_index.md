...
description: SmartObjectProvider yöntem. Kaynak one. kopyalayarak yeni bir akıllı nesne katmanı oluşturur.
type: docs
weight: 30
url: /tr/net/aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/
---
## SmartObjectProvider.NewSmartObjectViaCopy method

Kaynak one. kopyalayarak yeni bir akıllı nesne katmanı oluşturur.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| sourceLayer | SmartObjectLayer | Kaynak katmanı. |

### Geri dönüş değeri

klonlanmış[`SmartObjectLayer`](../../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) örnek.

### istisnalar

| istisna | şart |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Yalnızca katıştırılmış bir akıllı nesneyi değiştirebilirsiniz. |
