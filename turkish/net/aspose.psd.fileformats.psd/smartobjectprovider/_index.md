...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider sınıf. PSD dosyasının genel bağlantı kaynaklarından ve içeriklerinden veri kaynaklarının alınmasını / ayarlanmasını sağlayan akıllı nesne sağlayıcısını tanımlar.
type: docs
weight: 4000
url: /tr/net/aspose.psd.fileformats.psd/smartobjectprovider/
---
## SmartObjectProvider class

PSD dosyasının genel bağlantı kaynaklarından ve içeriklerinden veri kaynaklarının alınmasını / ayarlanmasını sağlayan akıllı nesne sağlayıcısını tanımlar.
...
| İsim | Tanım |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Katmanları katıştırılmış bir akıllı nesneye dönüştürür. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Katmanları katıştırılmış bir akıllı nesneye dönüştürür. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Tüm bağlantılı akıllı nesneleri görüntüye yerleştirir. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Kaynak one. kopyalayarak yeni bir akıllı nesne katmanı oluşturur. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Görüntüdeki değiştirilmiş tüm akıllı nesnelerin içeriğini günceller. |
