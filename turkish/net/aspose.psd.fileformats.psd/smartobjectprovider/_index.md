---
title: "Sınıf SmartObjectProvider"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.SmartObjectProvider sınıfı. PSD dosyasının küresel bağlantı kaynaklarından veri kaynaklarını alma / ayarlama ve içeriklerini sağlayan akıllı nesne sağlayıcısını tanımlar."
type: docs
weight: 4500
...
PSD dosyasının küresel bağlantı kaynaklarından veri kaynaklarını alma/ayarlama ve içeriklerini sağlayan akıllı nesne sağlayıcısını tanımlar.
...
| Ad | Açıklama |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Katmanları gömülü bir akıllı nesneye dönüştürür. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Katmanları gömülü bir akıllı nesneye dönüştürür. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Tüm bağlı akıllı nesneleri görüntüye gömer. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Kaynak katmanı kopyalayarak yeni bir akıllı nesne katmanı oluşturur. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Görüntüdeki tüm değiştirilmiş akıllı nesnelerin içeriğini günceller. |
