...
description: "VscgResource özelliği. Yapı öğelerinin dizisini alır veya ayarlar. Uyarı Items dizisi değerleri, Items içinde yapıların içinde depolanan dolgu ayarlarının türünü belirleyen KeyForData özelliğiyle eşleşmelidir"
type: docs
weight: 20
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/items/
---
{{< psd/tize >}}
## VscgResource.Items property

Yapı öğelerinin dizisini alır veya ayarlar. **Warning:** `Items` dizi değerleri, `KeyForData` özelliğiyle eşleşmelidir; bu özellik, `Items` içindeki yapıların içinde depolanan dolgu ayarlarının türünü belirler.
...
[`OSTypeStructure`](../../../aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/) öğelerinin dizisi.

## Örnekler

Aşağıdaki kod, VscgResource desteğini gösterir.
