---
title: "Sınıf VscgResource"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.StrokeResources.VscgResource sınıf. Vektör Çizgi İçerik Veri kaynağı"
type: docs
weight: 3430
url: /tr/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
{{< psd/tize >}}
## VscgResource class

Vektör Çizgi İçerik Verisi kaynağı.
...
| Ad | Açıklama |
| --- | --- |
| [VscgResource](vscgresource/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [Items](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/items/) { get; } | Yapı öğelerinin dizisini alır veya ayarlar. **Warning:** `Items` dizi değerleri, `KeyForData` özelliğiyle eşleşmelidir; bu özellik, `Items` içindeki yapıların içinde depolanan dolgu ayarlarının türünü belirler. |
| [Key](../../aspose.psd.fileformats.psd.layers/layerresource/key/) { get; } | Katman kaynağı anahtarını alır. |
| [KeyForData](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/keyfordata/) { get; } | Kaynağa kaydedilen doldurma ayarının türünü tanımlayan tam sayı anahtarını alır: * Color - 0x536f436f - SoCoResource.TypeToolKey * Gradient - 0x4764466c - GdFlResource.TypeToolKey * Pattern - 0x5074466c - PtFlResource.TypeToolKey Uyarı! KeyForData özelliğinin değeri, Items yapılarında depolanan Doldurma ayarının türüyle eşleşmelidir. |
| override [Length](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/length/) { get; } | Katman kaynağı uzunluğunu bayt cinsinden alır. |
...
| Ad | Açıklama |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/save/)(StreamContainer, int) | Kaynağı belirtilen akış konteynerine kaydeder. |
...
| Ad | Açıklama |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/typetoolkey/) | Tip aracı bilgi anahtarı. |
