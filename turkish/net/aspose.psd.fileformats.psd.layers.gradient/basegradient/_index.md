...
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient class. Temel gradient tanım sınıfı. Katı ve Gürültü olmak üzere her iki gradient türü için ortak özellikleri içerir"
type: docs
weight: 2190
url: /tr/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| Ad | Açıklama |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | Bu degrade için modu alır. 'Gradient Type' = 'Solid/Noise' (0/1) olarak belirler. |
