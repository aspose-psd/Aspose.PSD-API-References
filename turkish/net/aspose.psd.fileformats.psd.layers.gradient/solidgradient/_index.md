...
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.SolidGradient class. Gradient doldurma efekti ayarları"
type: docs
weight: 2230
url: /tr/net/aspose.psd.fileformats.psd.layers.gradient/solidgradient/
---
{{< psd/tize >}}
## SolidGradient class

Gradyan dolgu efekt ayarları.
...
| Ad | Açıklama |
| --- | --- |
| [SolidGradient](solidgradient/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [ColorPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/colorpoints/) { get; set; } | Renk noktalarını alır veya ayarlar. |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/gradientmode/) { get; } | Bu degrade için modu alır. 'Gradient Type' = 'Solid/Noise' (0/1) olarak belirler. |
...
| [Interpolation](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/interpolation/) { get; set; } | Interpolasyonu alır ve ayarlar. 'Gradient Type' = 'Solid' olduğunda Pürüzsüzlüğü belirler. Değer aralığı: 0-4096. |
| [TransparencyPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/transparencypoints/) { get; set; } | Şeffaflık noktalarını alır veya ayarlar. |

## Yöntemler

| Ad | Açıklama |
| --- | --- |
| [AddColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addcolorpoint/)() | Renk noktasını ekler. |
| [AddTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addtransparencypoint/)() | Renk noktasını ekler. |
| [RemoveColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removecolorpoint/)(IGradientColorPoint) | Renk noktasını kaldırır. |
| [RemoveTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removetransparencypoint/)(IGradientTransparencyPoint) | Şeffaflık noktasını kaldırır. |
| static [GenerateLfx2ResourceNodes](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/generatelfx2resourcenodes/)() | LFX2 kaynak düğümlerini oluşturur. |
