...
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.NoiseGradient class. Gürültü gradient tanım sınıfı"
type: docs
weight: 2220
url: /tr/net/aspose.psd.fileformats.psd.layers.gradient/noisegradient/
---
{{< psd/tize >}}
## NoiseGradient class

Gürültü gradyan tanım sınıfı.
...
| Ad | Açıklama |
| --- | --- |
| [NoiseGradient](noisegradient/)() | Varsayılan yapıcı. |

## Özellikler

| Ad | Açıklama |
| --- | --- |
| [ColorModel](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/colormodel/) { get; set; } | Renk Modelini alır veya ayarlar - RGB/HSB/LAB (3/4/6). |
| [ExpansionCount](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/expansioncount/) { get; set; } | Genişleme sayısını alır veya ayarlar ( = Photoshop 6.0 için 2). |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/gradientmode/) { get; } | Bu degrade için modu alır. 'Gradient Type' = 'Solid/Noise' (0/1) olarak belirler. |
| [GradientName](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientname/) { get; set; } | Degrade adını alır veya ayarlar. |
| [MaximumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/maximumcolor/) { get; set; } | PixelDataFormat'ın Maximum rengini alır veya ayarlar. |
| [MinimumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/minimumcolor/) { get; set; } | PixelDataFormat'ın Minimum rengini alır veya ayarlar. |
| [RndNumberSeed](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/rndnumberseed/) { get; set; } | Gürültü geçişi için renkler oluşturmakta kullanılan rastgele sayı tohumunu alır veya ayarlar. |
| [Roughness](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/roughness/) { get; set; } | Pürüzlülük faktörünü alır veya ayarlar. |
| [ShowTransparency](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/showtransparency/) { get; set; } | Şeffaflığı gösterme bayrağını alır veya ayarlar. |
| [UseVectorColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/usevectorcolor/) { get; set; } | Vektör rengini kullanma bayrağını alır veya ayarlar. |

## Örnekler

Strok doldurma efektlerinde gürültü ve katı degrade ayarlarını okuma ve değiştirmeyi gösterir.
...
using (PsdImage image = (PsdImage)Image.Load(inputFile, loadOptions))
{
    ...
    // Ortak degrade doldurma ayarları özelliklerini kontrol et
    ...
    // Gürültü degrade özelliklerini kontrol et
