...
description: SmartObjectLayer yöntem. Bağlantılı akıllı nesneyi yeni bir dosyaya yeniden bağlar. Daha sonra UpdateModifiedContent yöntemini çağırmaya gerek yoktur.
type: docs
weight: 130
url: /tr/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/
---
## SmartObjectLayer.RelinkToFile method

Bağlantılı akıllı nesneyi yeni bir dosyaya yeniden bağlar. Daha sonra UpdateModifiedContent yöntemini çağırmaya gerek yoktur.
