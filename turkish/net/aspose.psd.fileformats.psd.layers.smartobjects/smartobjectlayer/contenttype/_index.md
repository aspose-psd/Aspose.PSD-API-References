...
description: SmartObjectLayer mülk. Akıllı nesne katmanı içeriğinin türünü alır. Katıştırılmış akıllı nesne içeriği katıştırılmış ham görüntü dosyasıdırData . Bağlantılı akıllı nesne içeriği varsa bağlantılı görüntü dosyasının ham içeriğidirLiFeDataSource . Adobe Photoshop  Graphics Libraryden yüklemeyi desteklemiyoruz.IsLibraryLink true. Normal bağlantı dosyaları için ilk başta şunu kullanırızRelativePath kaynak görüntü yoluna göre nispeten dosyasını aramak içinSourceImagePath  yoksa bakarızFullPath  değilse bağlantı dosyasını resmimizin bulunduğu dizinde ararızSourceImagePath .
type: docs
weight: 40
