...
description: "SmartObjectLayer yöntemi. Akıllı nesne katmanının gömülü veya bağlantılı görüntü içeriğini alır"
type: docs
weight: 130
url: /tr/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/loadcontents/
---
{{< psd/tize >}}
## SmartObjectLayer.LoadContents method

Akıllı nesne katmanının gömülü veya bağlantılı görüntü içeriğini alır.
...
| --- | --- | --- |
| seçenekler | LoadOptions | Seçenekler. |

### Dönüş Değeri

Yüklenen [`Image`](../../../aspose.psd/image/) akıllı nesne örneği.
