...
description: SmartObjectLayer yöntem. Akıllı nesne katmanının gömülü veya bağlantılı görüntü içeriklerini alır.
type: docs
weight: 110
...
Akıllı nesne katmanının gömülü veya bağlantılı görüntü içeriklerini alır.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| options | LoadOptions | Seçenekler. |

### Geri dönüş değeri

yüklü[`Image`](../../../aspose.psd/image/) akıllı nesne örneği.
