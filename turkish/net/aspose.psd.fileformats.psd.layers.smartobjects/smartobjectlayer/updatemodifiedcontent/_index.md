...
description: "SmartObjectLayer yöntemi. Değiştirilmiş içerikle akıllı nesne katmanı görüntü önbelleğini günceller"
type: docs
weight: 170
url: /tr/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/updatemodifiedcontent/
---
{{< psd/tize >}}
## SmartObjectLayer.UpdateModifiedContent method

Akıllı nesne katmanının görüntü önbelleğini değiştirilmiş içerikle günceller.
