---
title: "Sınıf EllipseShape"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.Shapes.EllipseShape sınıfı. Bir elips şekli temsil eder"
type: docs
weight: 6020
url: /tr/net/aspose.psd.shapes/ellipseshape/
---
{{< psd/tize >}}
## EllipseShape class

Bir elips şekli temsil eder.
...
| Ad | Açıklama |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | `EllipseShape` sınıfının yeni bir örneğini başlatır. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | `EllipseShape` sınıfının yeni bir örneğini başlatır. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | Şekil segmentlerini alır. |
