...
description: Aspose.PSD.Shapes.EllipseShape sınıf. Bir elips şeklini temsil eder.
type: docs
weight: 5490
...
| İsim | Tanım |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | Yeni bir örneğini başlatır.`EllipseShape` sınıf. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | Yeni bir örneğini başlatır.`EllipseShape` sınıf. |
