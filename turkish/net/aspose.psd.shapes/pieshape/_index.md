---
title: "Sınıf PieShape"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.Shapes.PieShape sınıfı. Bir pasta dilimi şekli temsil eder"
type: docs
weight: 6030
...
| Ad | Açıklama |
| --- | --- |
| [PieShape](pieshape/#constructor)() | `PieShape` sınıfının yeni bir örneğini başlatır. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | `PieShape` sınıfının yeni bir örneğini başlatır. |
