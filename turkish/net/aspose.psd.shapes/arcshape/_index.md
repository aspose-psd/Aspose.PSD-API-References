---
title: "Sınıf ArcShape"
second_title: "Aspose.PSD for .NET API Referansı"
description: "Aspose.PSD.Shapes.ArcShape sınıfı. Bir yay şekli temsil eder"
type: docs
weight: 5990
...
| Ad | Açıklama |
| --- | --- |
| [ArcShape](arcshape/#constructor)() | `ArcShape` sınıfının yeni bir örneğini başlatır. |
| [ArcShape](arcshape/#constructor_1)(RectangleF, float, float) | `ArcShape` sınıfının yeni bir örneğini başlatır. |
| [ArcShape](arcshape/#constructor_2)(RectangleF, float, float, bool) | `ArcShape` sınıfının yeni bir örneğini başlatır. |
...
| [EndPoint](../../aspose.psd.shapes/arcshape/endpoint/) { get; } | Şeklin son noktasını alır. |
...
| [IsClosed](../../aspose.psd.shapes/arcshape/isclosed/) { get; set; } | Sıralı şeklin kapalı olup olmadığını gösteren bir değeri alır veya ayarlar. Kapalı sıralı şekil işlenirken başlangıç ve bitiş noktaları bir anlam taşımaz. |
...
| [StartPoint](../../aspose.psd.shapes/arcshape/startpoint/) { get; } | Şeklin başlangıç noktasını alır. |
...
| [Reverse](../../aspose.psd.shapes/arcshape/reverse/)() | Bu şekil için nokta sırasını tersine çevirir. |
