...
description: Aspose.PSD.Shapes.RectangleShape sınıf. Dikdörtgen şekli temsil eder.
type: docs
weight: 5530
...
| İsim | Tanım |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Yeni bir örneğini başlatır.`RectangleShape` sınıf. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Yeni bir örneğini başlatır.`RectangleShape` sınıf. |
