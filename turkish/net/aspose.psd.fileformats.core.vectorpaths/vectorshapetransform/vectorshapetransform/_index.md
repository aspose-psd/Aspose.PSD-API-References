...
description: VectorShapeTransform inşaatçı. Yeni bir örneğini başlatır.VectorShapeTransform sınıf.
type: docs
weight: 10
url: /tr/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/vectorshapetransform/
---
## VectorShapeTransform constructor

Yeni bir örneğini başlatır.[`VectorShapeTransform`](../) sınıf.
...
* ad alanı [Aspose.PSD.FileFormats.Core.VectorPaths](../../vectorshapetransform/)
* toplantı [Aspose.PSD](../../../)
