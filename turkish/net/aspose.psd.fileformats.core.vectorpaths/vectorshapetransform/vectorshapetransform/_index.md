...
description: "VectorShapeTransform yapıcı. VectorShapeTransform sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
...
Yeni bir [`VectorShapeTransform`](../) sınıfının örneğini başlatır.
