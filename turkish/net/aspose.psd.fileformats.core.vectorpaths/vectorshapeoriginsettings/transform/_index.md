...
description: "VectorShapeOriginSettings özelliği. Dönüşüm matrisini alır veya ayarlar"
type: docs
weight: 170
url: /tr/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/transform/
---
{{< psd/tize >}}
...
Bu örnek, PSD görüntüsünde bir Vogk ve vektör yol kaynağıyla katmanların nasıl yeniden boyutlandırılacağını gösterir.
