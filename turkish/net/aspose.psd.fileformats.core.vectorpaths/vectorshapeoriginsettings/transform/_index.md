...
description: VectorShapeOriginSettings mülk. Dönüşüm matrisini alır veya ayarlar.
type: docs
weight: 170
...
Bu örnek, PSD görüntüsünde bir Vogk ve vektör yolu kaynağıyla katmanların nasıl yeniden boyutlandırılacağını gösterir.
