...
description: "VectorShapeOriginSettings yapıcı. VectorShapeOriginSettings sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
url: /tr/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

[`VectorShapeOriginSettings`](../) sınıfının yeni bir örneğini başlatır.
...
| --- | --- | --- |
| isShapeInvalidated | Boolean | Şeklin geçersiz kılındığı değeri. |
| originIndex | Int32 | Şeklin orijin indeksi. |
