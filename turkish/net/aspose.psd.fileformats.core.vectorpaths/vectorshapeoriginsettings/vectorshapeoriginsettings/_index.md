...
description: VectorShapeOriginSettings inşaatçı. Yeni bir örneğini başlatır.VectorShapeOriginSettings sınıf.
type: docs
weight: 10
...
Yeni bir örneğini başlatır.[`VectorShapeOriginSettings`](../) sınıf.
