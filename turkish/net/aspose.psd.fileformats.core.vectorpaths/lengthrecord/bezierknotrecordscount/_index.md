...
description: "LengthRecord özelliği. Bezier düğüm kayıt sayısını alır veya ayarlar"
type: docs
weight: 20
url: /tr/net/aspose.psd.fileformats.core.vectorpaths/lengthrecord/bezierknotrecordscount/
---
{{< psd/tize >}}
## LengthRecord.BezierKnotRecordsCount property

bezier knot kayıt sayısını alır veya ayarlar.
