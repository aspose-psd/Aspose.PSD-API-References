...
description: "BezierKnotRecord yapıcı. BezierKnotRecord sınıfının yeni bir örneğini başlatır"
type: docs
weight: 10
url: /tr/net/aspose.psd.fileformats.core.vectorpaths/bezierknotrecord/bezierknotrecord/
---
{{< psd/tize >}}
## BezierKnotRecord() {#constructor}

[`BezierKnotRecord`](../) sınıfının yeni bir örneğini başlatır.
