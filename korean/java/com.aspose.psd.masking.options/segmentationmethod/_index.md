...
description: "분할 방법 유형"
type: docs
weight: 17
url: /ko/java/com.aspose.psd.masking.options/segmentationmethod/
---
...
| [FuzzyCMeans](#FuzzyCMeans) | 퍼지 C-평균 세그멘테이션 알고리즘. |
| [GraphCut](#GraphCut) | 그래프 컷 세그멘테이션 알고리즘 |
| [KMeans](#KMeans) | K-평균 세그멘테이션 알고리즘. |
| [Manual](#Manual) | 수동 세그멘테이션 알고리즘 |
| [Watershed](#Watershed) | 워터셰드 세그멘테이션 알고리즘. |
## 메서드
