...
description: "벡터 스트로크 콘텐츠 데이터 리소스."
type: docs
weight: 13
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [VscgResource()](#VscgResource--) | 새 인스턴스를 초기화합니다 [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource) 클래스. |
## 필드
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | 클래스 이름을 가져오거나 설정합니다. |
| [getClassName_internalized()](#getClassName-internalized--) | 클래스 식별자를 가져오거나 설정합니다. |
| [getHeader_internalized()](#getHeader-internalized--) | 헤더를 가져오거나 설정합니다. |
| [getItems()](#getItems--) | 구조 항목을 가져오거나 설정합니다. |
| [getKey()](#getKey--) | 레이어 리소스 키를 가져옵니다. |
| [getKeyForData()](#getKeyForData--) | 리소스에 저장되는 채우기 설정 종류를 정의하는 정수 키: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 클래스 이름을 가져오거나 설정합니다. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | 클래스 식별자를 가져오거나 설정합니다. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 구조 항목을 가져오거나 설정합니다. |
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | 리소스에 저장되는 채우기 설정 종류를 정의하는 정수 키를 가져옵니다: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey 경고! 속성 KeyForData의 값은 Items 구조에 저장된 Fill 설정 유형과 일치해야 합니다. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | 읽기 전용 속성 KeyForData를 할당할 수 있게 하는 내부 메서드입니다. |
...
새 인스턴스를 초기화합니다 [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource) 클래스.
...
리소스에 저장되는 채우기 설정 종류를 정의하는 정수 키: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
리소스에 저장되는 채우기 설정 종류를 정의하는 정수 키를 가져옵니다: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey 경고! 속성 KeyForData의 값은 Items 구조에 저장된 Fill 설정 유형과 일치해야 합니다.
...
읽기 전용 속성 KeyForData를 할당할 수 있게 하는 내부 메서드입니다. 리소스 속성을 할당할 때 Vscg 리소스 로더에서만 사용해야 합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | int | KeyForData 속성의 정수 값입니다. |
