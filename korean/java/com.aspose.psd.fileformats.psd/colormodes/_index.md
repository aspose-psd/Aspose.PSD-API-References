...
description: "psd 파일 형식의 색상 모드를 나타냅니다."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.psd/colormodes/
---
...
| [Duotone](#Duotone) | 듀오톤 색상 모드. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | 그레이스케일 모드. |
| [Indexed](#Indexed) | 인덱스 색상 모드. |
| [Lab](#Lab) | Lab 색상 모드. |
| [Multichannel](#Multichannel) | 멀티채널 색상 모드. |
| [Rgb](#Rgb) | RGB 색상 모드. |
## 메서드
