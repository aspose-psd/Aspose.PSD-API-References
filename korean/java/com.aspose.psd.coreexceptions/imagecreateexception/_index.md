...
description: "이미지 생성 예외."
type: docs
weight: 13
url: /ko/java/com.aspose.psd.coreexceptions/imagecreateexception/
---
...
이미지 생성 예외입니다. 이미지 생성 중에 발생합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ImageCreateException(String message)](#ImageCreateException-java.lang.String-) | ImageCreateException 클래스의 새 인스턴스를 초기화합니다. |
| [ImageCreateException(String message, Throwable innerException)](#ImageCreateException-java.lang.String-java.lang.Throwable-) | ImageCreateException 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
