...
description: "이미지 저장 예외."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.coreexceptions/imagesaveexception/
---
...
이미지 저장 예외입니다. 이미지 저장 중에 발생합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ImageSaveException(String message)](#ImageSaveException-java.lang.String-) | ImageSaveException 클래스의 새 인스턴스를 초기화합니다. |
| [ImageSaveException(String message, Throwable innerException)](#ImageSaveException-java.lang.String-java.lang.Throwable-) | ImageSaveException 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
ImageSaveException 클래스의 새 인스턴스를 초기화합니다.
