...
type: docs
weight: 14
url: /ko/java/com.aspose.psd.coreexceptions/imageexception/
---
...
| 생성자 | 설명 |
| --- | --- |
| [ImageException(String message)](#ImageException-java.lang.String-) | ImageException 클래스의 새 인스턴스를 초기화합니다. |
| [ImageException(String message, Throwable innerException)](#ImageException-java.lang.String-java.lang.Throwable-) | ImageException 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
ImageException 클래스의 새 인스턴스를 초기화합니다.
