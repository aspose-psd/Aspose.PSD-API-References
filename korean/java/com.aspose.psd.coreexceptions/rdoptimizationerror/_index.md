...
description: "RD 최적화 오류 예외 클래스"
type: docs
weight: 21
url: /ko/java/com.aspose.psd.coreexceptions/rdoptimizationerror/
---
...
| 생성자 | 설명 |
| --- | --- |
| [RdOptimizationError(String message)](#RdOptimizationError-java.lang.String-) | RdOptimizationError 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
RdOptimizationError 클래스의 새 인스턴스를 초기화합니다.
