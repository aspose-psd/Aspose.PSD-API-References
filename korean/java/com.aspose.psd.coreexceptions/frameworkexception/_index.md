...
description: "이미징 프레임워크 예외."
type: docs
weight: 12
url: /ko/java/com.aspose.psd.coreexceptions/frameworkexception/
---
...
이미징 프레임워크 예외입니다. 이 클래스는 모든 Aspose.Imaging 예외의 핵심 클래스이며, Aspose.Imaging 엔진에서 발생한 예외와 기타 모든 예외 유형을 구분하기 위해 도입되었습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [FrameworkException(String message)](#FrameworkException-java.lang.String-) | FrameworkException 클래스의 새 인스턴스를 초기화합니다. |
| [FrameworkException(String message, Throwable innerException)](#FrameworkException-java.lang.String-java.lang.Throwable-) | FrameworkException 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
FrameworkException 클래스의 새 인스턴스를 초기화합니다.
