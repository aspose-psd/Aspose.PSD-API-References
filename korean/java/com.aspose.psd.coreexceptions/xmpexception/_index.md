...
description: "XMP에 잘못된 구조가 있을 때 발생하는 예외."
type: docs
weight: 23
url: /ko/java/com.aspose.psd.coreexceptions/xmpexception/
---
...
XMP에 잘못된 구조가 있을 때 발생하는 예외.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [XmpException()](#XmpException--) | XmpException 클래스의 새 인스턴스를 초기화합니다. |
| [XmpException(String message)](#XmpException-java.lang.String-) | XmpException 클래스의 새 인스턴스를 초기화합니다. |
| [XmpException(String message, Throwable innerException)](#XmpException-java.lang.String-java.lang.Throwable-) | XmpException 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
XmpException 클래스의 새 인스턴스를 초기화합니다.
