...
description: "인너 섀도우 레이어 효과"
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | 퍼짐(조임)을 백분율로 가져오거나 설정합니다. |
...
| [setSpread(int value)](#setSpread-int-) | 퍼짐(조임)을 백분율로 가져오거나 설정합니다. |
