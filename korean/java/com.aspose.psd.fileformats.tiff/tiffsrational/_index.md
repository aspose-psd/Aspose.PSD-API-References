...
type: docs
weight: 13
url: /ko/java/com.aspose.psd.fileformats.tiff/tiffsrational/
---
...
| 생성자 | 설명 |
| --- | --- |
| [TiffSRational()](#TiffSRational--) | 새로운 TiffSRational 클래스의 인스턴스를 초기화합니다. |
| [TiffSRational(int value)](#TiffSRational-int-) | 새 인스턴스를 초기화합니다 TiffRational 클래스. |
| [TiffSRational(int nominator, int denominator)](#TiffSRational-int-int-) | 새로운 TiffSRational 클래스의 인스턴스를 초기화합니다. |
## 필드
...
새로운 TiffSRational 클래스의 인스턴스를 초기화합니다.
