...
description: "png 로드 옵션."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.imageloadoptions/pngloadoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PngLoadOptions()](#PngLoadOptions--) | 새로운 PngLoadOptions 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getStrictMode()](#getStrictMode--) | 엄격 모드인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [setStrictMode(boolean value)](#setStrictMode-boolean-) | 엄격 모드인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
새로운 PngLoadOptions 클래스 인스턴스를 초기화합니다.
...
엄격 모드인지 여부를 나타내는 값을 가져오거나 설정합니다.

**Returns:**
boolean - 엄격 모드인지 여부를 나타내는 값.
