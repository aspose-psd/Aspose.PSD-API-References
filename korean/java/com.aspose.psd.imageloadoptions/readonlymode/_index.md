...
description: "PSD 이미지를 로드할 때 사용할 수 있는 읽기 전용 모드를 지정합니다."
type: docs
weight: 13
url: /ko/java/com.aspose.psd.imageloadoptions/readonlymode/
---
...
| [MetadataEdit](#MetadataEdit) | 이미지 내용을 읽기 전용으로 유지하면서 이미지 메타데이터 편집을 허용합니다. |
| [None](#None) | 읽기 전용 제한이 적용되지 않습니다. |
## 메서드
...
기본 모드. 이미지가 완전히 읽기 전용이며 수정할 수 없습니다.
...
이미지 내용을 읽기 전용으로 유지하면서 이미지 메타데이터 편집을 허용합니다.
...
읽기 전용 제한이 적용되지 않습니다. 이미지를 완전히 수정할 수 있습니다.
