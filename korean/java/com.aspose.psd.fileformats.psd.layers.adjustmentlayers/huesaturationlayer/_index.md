...
description: "색조/채도 조정 레이어."
type: docs
weight: 20
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| [getColorize()](#getColorize--) | 이 [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer)이 색상화되는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [getRange(int index)](#getRange-int-) | 범위를 가져옵니다. |
...
| [setColorize(boolean value)](#setColorize-boolean-) | 이 [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer)이 색상화되는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
이 [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer)이 색상화되는지 여부를 나타내는 값을 가져오거나 설정합니다.
