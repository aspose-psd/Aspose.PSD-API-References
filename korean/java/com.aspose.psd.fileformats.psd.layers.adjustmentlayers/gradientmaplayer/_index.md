...
description: "그라디언트 맵 레이어."
type: docs
weight: 19
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
그라디언트 맵 레이어. GrdmResource의 데이터를 사용하여 그라디언트 맵 렌더링을 처리합니다.
## 필드
...
| [getGradientSettings()](#getGradientSettings--) | GrdmResource 인스턴스에서 전달된 Gradient 설정 인스턴스를 가져오거나 설정합니다. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 그라디언트 맵 레이어를 처리합니다. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | GrdmResource 인스턴스에서 전달된 Gradient 설정 인스턴스를 가져오거나 설정합니다. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | 관련 레이어 리소스에서 레이어 데이터를 업데이트합니다 [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
GrdmResource 인스턴스에서 전달된 Gradient 설정 인스턴스를 가져오거나 설정합니다.
...
관련 레이어 리소스에서 레이어 데이터를 업데이트합니다 [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
