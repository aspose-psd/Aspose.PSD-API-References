...
description: "CMYK 채널 믹서 조정 레이어."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| [getBlackChannel()](#getBlackChannel--) | 검은 채널을 가져옵니다. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | 채널의 인덱스를 가져옵니다. |
...
| [getCyanChannel()](#getCyanChannel--) | 시안 채널을 가져옵니다. |
...
| [getMagentaChannel()](#getMagentaChannel--) | 마젠타 채널을 가져옵니다. |
...
| [getMonochrome()](#getMonochrome--) | 이 [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer)가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [getYellowChannel()](#getYellowChannel--) | 노란 채널을 가져옵니다. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 조정 레이어를 처리합니다. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | 이 [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer)가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
채널의 인덱스를 가져옵니다. CmykMixerChannel를 반환합니다.
...
이 [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer)가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다.

값:  true  monochrome인 경우; 그렇지 않으면,  false .
