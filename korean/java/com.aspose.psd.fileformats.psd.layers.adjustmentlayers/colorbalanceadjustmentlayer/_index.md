...
description: "색상 균형 조정 레이어 클래스."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | 섀도우 옐로우 블루 밸런스를 가져오거나 설정합니다. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | 지정된 int RGB 배열에 현재 섀도우, 미드톤 및 하이라이트에 대한 보정을 적용합니다. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | 섀도우 옐로우 블루 밸런스를 가져오거나 설정합니다. |
...
지정된 int RGB 배열에 현재 섀도우, 미드톤 및 하이라이트에 대한 보정을 적용합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 픽셀 | int[] | int 색상 RGB 배열. |
