...
description: "반전 조정 레이어 클래스."
type: docs
weight: 21
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | invert adjustment layer를 처리합니다. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | 지정된 int ARGB 배열에 invert 보정을 적용합니다. |
...
invert adjustment layer를 처리합니다.
...
지정된 int ARGB 배열에 invert 보정을 적용합니다.
