---
title: "SelectiveColorLayer"
second_title: "Java용 Aspose.PSD API 참조"
description: "선택 색상 조정 레이어."
type: docs
weight: 28
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | 조정 레이어의 유형을 가져옵니다. |
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | 선택 색상에 의한 CMYK 보정을 가져옵니다. |
| [getContainer()](#getContainer--) | 이미지 컨테이너를 가져옵니다. |
| [getCorrectionMethod()](#getCorrectionMethod--) | 보정 방법을 가져오거나 설정합니다. |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | 프로세서를 가져옵니다. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 선택 색상 레이어를 처리합니다. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | 데이터를 병합합니다. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | 선택 색상에 의한 CMYK 보정을 설정합니다. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | 이미지 컨테이너를 설정합니다. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | 보정 방법을 가져오거나 설정합니다. |
...
### create_internalized(PsdHeader header, LayerResource[] resources) {#create-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.fileformats.psd.layers.LayerResource---}
```
public static SelectiveColorLayer create_internalized(PsdHeader header, LayerResource[] resources)
```
...
**Returns:**
[SelectiveColorLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer)
### create_internalized(System.IO.Stream stream) {#create-internalized-com.aspose.ms.System.IO.Stream-}
```
...
**Returns:**
byte
### getCmykCorrection(int selectiveColorsType) {#getCmykCorrection-int-}
```
public final CmykCorrection getCmykCorrection(int selectiveColorsType)
```
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| selectiveColorsType | int | 선택 색상. |

**Returns:**
[CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) - Cmyk Correction.
...
### getCorrectionMethod() {#getCorrectionMethod--}
```
...
| 픽셀 | int[] | 픽셀 배열. |
| start | [Point](../../com.aspose.psd/point) | 픽셀 왼쪽 상단 위치. |
| end | [Point](../../com.aspose.psd/point) | 픽셀 오른쪽 하단 위치. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - 픽셀 사각형 및 처리된 픽셀.
...
### setCmykCorrection(int selectiveColorsType, CmykCorrection correction) {#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-}
```
public final void setCmykCorrection(int selectiveColorsType, CmykCorrection correction)
```


선택 색상에 의한 CMYK 보정을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| selectiveColorsType | int | 선택 색상의 유형. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | CMYK 보정. |
...
### setCorrectionMethod(int value) {#setCorrectionMethod-int-}
```
public final void setCorrectionMethod(int value)
```
