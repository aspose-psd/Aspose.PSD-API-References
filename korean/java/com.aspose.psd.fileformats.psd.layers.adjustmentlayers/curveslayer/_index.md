...
description: "곡선 조정 레이어"
type: docs
weight: 17
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | 곡선 관리자를 가져옵니다. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | 이 인스턴스가 연속 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | 이 인스턴스가 이산 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | 이 인스턴스가 연속 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | 이 인스턴스가 이산 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
이 인스턴스가 연속 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다.

값: 이 인스턴스가 연속 관리자를 사용하는 경우 true, 그렇지 않으면 false.
...
이 인스턴스가 이산 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다.

값: 이 인스턴스가 이산 관리자를 사용하는 경우 true, 그렇지 않으면 false.
...
| 픽셀 | int[] | 픽셀. |
| start | [Point](../../com.aspose.psd/point) | 시작. |
| end | [Point](../../com.aspose.psd/point) | 끝. |
