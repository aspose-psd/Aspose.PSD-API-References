...
description: "흑백 조정 레이어 클래스."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| [getTintColor()](#getTintColor--) | 틴트 색상 값을 가져오거나 설정합니다. |
| [getTintColorBlue()](#getTintColorBlue--) | 블루 틴트 색상 double 값을 가져오거나 설정합니다. |
| [getTintColorGreen()](#getTintColorGreen--) | 그린 틴트 색상 double 값을 가져오거나 설정합니다. |
| [getTintColorRed()](#getTintColorRed--) | 레드 틴트 색상 double 값을 가져오거나 설정합니다. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | 픽셀을 처리합니다. |
...
| [setTintColor(int value)](#setTintColor-int-) | 틴트 색상 값을 가져오거나 설정합니다. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | 블루 틴트 색상 double 값을 가져오거나 설정합니다. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | 그린 틴트 색상 double 값을 가져오거나 설정합니다. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | 레드 틴트 색상 double 값을 가져오거나 설정합니다. |
