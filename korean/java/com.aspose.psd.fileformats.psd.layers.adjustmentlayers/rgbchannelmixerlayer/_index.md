...
description: "RGB 채널 믹서 조정 레이어."
type: docs
weight: 26
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| [getBlueChannel()](#getBlueChannel--) | 파란 채널을 가져옵니다. |
...
| [getGreenChannel()](#getGreenChannel--) | 녹색 채널을 가져옵니다. |
...
| [getRedChannel()](#getRedChannel--) | 빨간 채널을 가져옵니다. |
...
채널의 인덱스를 가져옵니다. RgbMixerChannel를 반환합니다.
