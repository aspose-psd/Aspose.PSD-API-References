...
description: "Photoshop 그라디언트 보간 방법에 대한 패킹된 fourCC 값."
type: docs
weight: 18
url: /ko/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Photoshop 그라디언트 보간 방법에 대한 패킹된 fourCC 값. 설명자 키: "gradientsInterpolationMethod"
## 필드

| 필드 | 설명 |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 클래식 (키가 없을 때의 레거시 기본값). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 선형 (뒤에 공백이 있음). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 인지적. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 부드러운. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 스트라이프. |
## 메서드
