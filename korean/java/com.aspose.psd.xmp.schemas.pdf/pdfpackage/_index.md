...
description: "Adobe Pdf 네임스페이스를 나타냅니다."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.xmp.schemas.pdf/pdfpackage/
---
...
Adobe Pdf 네임스페이스를 나타냅니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [PdfPackage()](#PdfPackage--) | PdfPackage 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [setKeywords(String keywords)](#setKeywords-java.lang.String-) | 키워드를 설정합니다. |
| [setPdfVersion(String version)](#setPdfVersion-java.lang.String-) | Pdf 버전을 설정합니다. |
| [setProducer(String producer)](#setProducer-java.lang.String-) | Pdf를 만든 도구의 이름을 설정합니다. |
| [setTrapped(boolean isTrapped)](#setTrapped-boolean-) | trapped를 설정합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| version | java.lang.String | 예: 1.0, 1.3 등과 같은 Pdf 버전. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| isTrapped | boolean | true 로 설정하면 문서가 트랩되었습니다. |
