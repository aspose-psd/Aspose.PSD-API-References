...
description: "선택 색상 조정 레이어에서 색상 유형."
type: docs
weight: 12
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/selectivecolorstypes/
---
...
선택 색상 조정 레이어에서 색상 유형.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Blacks](#Blacks) | 검은 색상들. |
| [Blues](#Blues) | 파란 색상들. |
| [Cyans](#Cyans) | 시안 색상들. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Greens](#Greens) | 녹색 색상들. |
| [Magentas](#Magentas) | 마젠타 색상들. |
| [Neutrals](#Neutrals) | 중립 색상들. |
| [Reds](#Reds) | 빨간 색상들. |
| [Whites](#Whites) | 흰색 색상들. |
| [Yellows](#Yellows) | 노란 색상들. |
## 메서드
