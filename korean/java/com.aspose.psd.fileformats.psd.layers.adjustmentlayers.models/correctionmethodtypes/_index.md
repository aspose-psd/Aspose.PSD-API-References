...
description: "선택 색상 조정 레이어에서 보정 방법."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/correctionmethodtypes/
---
...
선택 색상 조정 레이어에서 보정 방법.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Absolute](#Absolute) | 절대 모드에서 색 보정을 적용합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | 상대 모드에서 색 보정을 적용합니다. |
## 메서드
