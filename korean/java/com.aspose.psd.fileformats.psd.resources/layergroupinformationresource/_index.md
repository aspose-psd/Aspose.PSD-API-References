...
description: "레이어 그룹 정보 리소스"
type: docs
weight: 25
url: /ko/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | 새로운 [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getGroups()](#getGroups--) | 그룹을 가져오거나 설정합니다. |
...
| [setGroups(short[] value)](#setGroups-short---) | 그룹을 가져오거나 설정합니다. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Groups 속성에서 레이어의 LinkGroupId를 업데이트합니다. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | 레이어에서 Groups 속성의 값을 업데이트합니다. |
...
Groups 속성에서 레이어의 LinkGroupId를 업데이트합니다.
