...
description: "퀵 마스크 정보 리소스"
type: docs
weight: 32
url: /ko/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | 새 인스턴스를 초기화합니다. [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) 클래스. |
## 필드
...
| [getChannelId()](#getChannelId--) | 채널 식별자를 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | 이 인스턴스가 마스크가 비었는지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | 지정된 스트림에 리소스 블록을 저장합니다. |
| [setChannelId(short value)](#setChannelId-short-) | 채널 식별자를 가져오거나 설정합니다. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | 이 인스턴스가 마스크가 비었는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) 클래스.
...
이 인스턴스가 마스크가 비었는지 여부를 나타내는 값을 가져오거나 설정합니다.

값: 이 인스턴스가 마스크가 비었으면 true, 그렇지 않으면 false.
