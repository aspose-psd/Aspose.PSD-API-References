...
description: "애니메이션 데이터 섹션 플러그인 리소스."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.psd.resources/animateddatasectionresource/
---
...
| [getAnimatedDataSection()](#getAnimatedDataSection--) | 애니메이션 데이터 섹션 구조를 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
| [getDataSize()](#getDataSize--) | 리소스 데이터 크기를 바이트 단위로 가져옵니다. |
| [getID()](#getID--) | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| [getKeyName()](#getKeyName--) | 리소스 키 이름. |
...
| [setAnimatedDataSection_internalized(AnimatedDataSectionStructure value)](#setAnimatedDataSection-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.AnimatedDataSectionStructure-) | 애니메이션 데이터 섹션 구조를 가져오거나 설정합니다. |
| [setID(short value)](#setID-short-) | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| [setKeyName_internalized(String value)](#setKeyName-internalized-java.lang.String-) | 리소스 키 이름. |
...
| [setRoll_internalized(RollStructure value)](#setRoll-internalized-com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure-) | 롤 구조를 가져오거나 설정합니다. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | 리소스 블록 상태를 가져오거나 설정합니다. |
| [setUnknownLeftBytes_internalized(byte[] value)](#setUnknownLeftBytes-internalized-byte---) | 원본 리소스에서 가져온 알 수 없는 바이트. |
| [toString()](#toString--) |  |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure |  |
