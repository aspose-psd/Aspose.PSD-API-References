...
description: "워터마크 리소스"
type: docs
weight: 42
url: /ko/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | 새 인스턴스를 초기화합니다. [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) 클래스. |
## 필드
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | 이 인스턴스가 워터마크인지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | 이 인스턴스가 워터마크인지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
...
새 인스턴스를 초기화합니다. [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) 클래스.
...
이 인스턴스가 워터마크인지 여부를 나타내는 값을 가져오거나 설정합니다.

값: 이 인스턴스가 워터마크이면 true, 그렇지 않으면 false.
