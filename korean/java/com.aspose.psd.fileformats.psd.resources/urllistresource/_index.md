...
description: "URL 목록 리소스"
type: docs
weight: 40
url: /ko/java/com.aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [UrlListResource()](#UrlListResource--) | 새 인스턴스를 초기화합니다. [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource) 클래스. |
## 필드
...
| [getIds()](#getIds--) | ids를 가져오거나 설정합니다. |
| [getLongs()](#getLongs--) | longs를 가져오거나 설정합니다. |
...
| [setLongs(int[] value)](#setLongs-int---) | longs를 가져오거나 설정합니다. |
...
| [setTexts(String[] value)](#setTexts-java.lang.String---) | texts를 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
...
새 인스턴스를 초기화합니다. [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource) 클래스.
