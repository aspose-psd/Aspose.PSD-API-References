...
description: "그리드 및 가이드 리소스를 나타냅니다."
type: docs
weight: 20
url: /ko/java/com.aspose.psd.fileformats.psd.resources/gridandguidesresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [GridAndGuidesResource()](#GridAndGuidesResource--) | 새 인스턴스를 초기화합니다. [GridAndGuidesResource](../../com.aspose.psd.fileformats.psd.resources/gridandguidesresource) 클래스. |
## 필드
...
| [getGridCycleX()](#getGridCycleX--) | 수평 그리드 주기를 가져오거나 설정합니다. |
| [getGridCycleY()](#getGridCycleY--) | 수직 그리드 주기를 가져오거나 설정합니다. |
| [getGuideCount()](#getGuideCount--) | 가이드 리소스 블록 수를 가져옵니다. |
| [getGuides()](#getGuides--) | 가이드를 가져오거나 설정합니다. |
| [getHeaderVersion()](#getHeaderVersion--) | 헤더 버전을 가져오거나 설정합니다. |
...
| [setGridCycleX(int value)](#setGridCycleX-int-) | 수평 그리드 주기를 가져오거나 설정합니다. |
| [setGridCycleY(int value)](#setGridCycleY-int-) | 수직 그리드 주기를 가져오거나 설정합니다. |
| [setGuides(GuideResource[] value)](#setGuides-com.aspose.psd.fileformats.psd.resources.GuideResource---) | 가이드를 가져오거나 설정합니다. |
| [setHeaderVersion(int value)](#setHeaderVersion-int-) | 헤더 버전을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [GridAndGuidesResource](../../com.aspose.psd.fileformats.psd.resources/gridandguidesresource) 클래스.
...
수평 그리드 주기를 가져오거나 설정합니다. 기본값은 576입니다.
...
수직 그리드 주기를 가져오거나 설정합니다. 기본값은 576입니다.
...
헤더 버전을 가져오거나 설정합니다. 이 값은 항상 1이어야 합니다.
