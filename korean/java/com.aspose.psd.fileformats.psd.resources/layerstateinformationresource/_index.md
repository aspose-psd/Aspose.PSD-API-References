...
description: "레이어 상태 정보 리소스"
type: docs
weight: 28
url: /ko/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | 새 인스턴스를 초기화합니다. [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) 클래스. |
## 필드
...
| [getLayerIndex()](#getLayerIndex--) | 레이어의 인덱스를 가져오거나 설정합니다. |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | 레이어의 인덱스를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource) 클래스.
