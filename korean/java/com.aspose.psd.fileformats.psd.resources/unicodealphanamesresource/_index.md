...
description: "Unicode 알파 이름 리소스"
type: docs
weight: 38
url: /ko/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | 새 인스턴스를 초기화합니다 [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) 클래스. |
## 필드
...
| [getAlphaNames()](#getAlphaNames--) | 알파 이름을 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | 알파 이름을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) 클래스.
