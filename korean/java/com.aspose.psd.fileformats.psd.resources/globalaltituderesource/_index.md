...
description: "전역 고도 리소스"
type: docs
weight: 18
url: /ko/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | 새 인스턴스를 초기화합니다. [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) 클래스. |
## 필드
...
| [getAltitude()](#getAltitude--) | 고도를 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | 고도를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource) 클래스.
