...
description: "픽셀 종횡비 리소스"
type: docs
weight: 29
url: /ko/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | 새로운 [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getAspectRatio()](#getAspectRatio--) | 종횡비를 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | 종횡비를 가져오거나 설정합니다. |
