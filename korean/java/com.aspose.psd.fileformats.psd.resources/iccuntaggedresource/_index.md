...
description: "Icc 태그되지 않은 리소스"
type: docs
weight: 24
url: /ko/java/com.aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [IccUntaggedResource()](#IccUntaggedResource--) | 새 인스턴스를 초기화합니다. [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource) 클래스. |
## 필드
...
| [getProfile()](#getProfile--) | 프로필을 가져오거나 설정합니다. |
...
| [setProfile(byte value)](#setProfile-byte-) | 프로필을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource) 클래스.
