...
description: "CaptionDigest 리소스"
type: docs
weight: 13
url: /ko/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | 새로운 [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getDigest()](#getDigest--) | 다이제스트를 가져오거나 설정합니다. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | 다이제스트를 가져오거나 설정합니다. |
