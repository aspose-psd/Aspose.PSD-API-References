...
description: "전역 각도 리소스"
type: docs
weight: 19
url: /ko/java/com.aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [GlobalAngleResource()](#GlobalAngleResource--) | 새 인스턴스를 초기화합니다. [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) 클래스. |
## 필드
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | 전역 각도를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource) 클래스.
