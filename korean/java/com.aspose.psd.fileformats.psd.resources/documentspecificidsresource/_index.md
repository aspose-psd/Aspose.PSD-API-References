...
description: "문서별 ID 리소스"
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [DocumentSpecificIdsResource()](#DocumentSpecificIdsResource--) | 새 인스턴스를 초기화합니다. [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) 클래스. |
## 필드
...
| [setId(int value)](#setId-int-) | 식별자를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [DocumentSpecificIdsResource](../../com.aspose.psd.fileformats.psd.resources/documentspecificidsresource) 클래스.
