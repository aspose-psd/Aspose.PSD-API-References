...
description: "투명도 인덱스 리소스 블록."
type: docs
weight: 37
url: /ko/java/com.aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [TransparencyIndexResource()](#TransparencyIndexResource--) | 새 인스턴스를 초기화합니다. [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) 클래스. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [RequiredVersion_internalized](#RequiredVersion-internalized) | 필요한 PSD 버전. |
...
| [getTransparencyIndex()](#getTransparencyIndex--) | 투명도 색 인덱스를 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTransparencyIndex(short value)](#setTransparencyIndex-short-) | 투명도 색 인덱스를 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
...
새 인스턴스를 초기화합니다. [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) 클래스.
