...
description: "레이어 그룹 활성화 리소스"
type: docs
weight: 26
url: /ko/java/com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LayerGroupsEnabledResource()](#LayerGroupsEnabledResource--) | 새 인스턴스를 초기화합니다. [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) 클래스. |
## 필드
...
| [getIDs()](#getIDs--) | i ds를 가져오거나 설정합니다. |
...
| [setIDs(byte[] value)](#setIDs-byte---) | i ds를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [LayerGroupsEnabledResource](../../com.aspose.psd.fileformats.psd.resources/layergroupsenabledresource) 클래스.
