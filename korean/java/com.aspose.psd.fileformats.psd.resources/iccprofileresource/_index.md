...
description: "ICC 프로파일 리소스를 나타냅니다."
type: docs
weight: 23
url: /ko/java/com.aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [IccProfileResource()](#IccProfileResource--) | 새로운 [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getIccProfile()](#getIccProfile--) | ICC 프로파일을 가져오거나 설정합니다. |
...
| [setIccProfile(byte[] value)](#setIccProfile-byte---) | ICC 프로파일을 가져오거나 설정합니다. |
...
새로운 [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource) 클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | com.aspose.ms.System.IO.MemoryStream |  |
