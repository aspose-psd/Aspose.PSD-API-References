...
description: "그래픽 씬의 위치 지정 및 크기 유형."
type: docs
weight: 20
url: /ko/java/com.aspose.psd.imageoptions/positioningtypes/
---
...
그래픽 씬의 위치 지정 및 크기 유형.
## 필드

| 필드 | 설명 |
| --- | --- |
| [DefinedByDocument](#DefinedByDocument) | 문서 페이지 설정에 의해 정의된 페이지의 절대 위치 지정. |
| [DefinedByOptions](#DefinedByOptions) | 옵션 페이지 설정에 의해 정의된 페이지의 절대 위치 지정. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | 상대 위치 지정 및 크기. |
## 메서드
...
문서 페이지 설정에 의해 정의된 페이지의 절대 위치 지정.
...
옵션 페이지 설정에 의해 정의된 페이지의 절대 위치 지정.
...
상대적인 위치와 크기. 모든 그래픽 객체의 경계에 의해 결정됩니다.
