...
description: "TIFF 옵션 오류 코드."
type: docs
weight: 26
url: /ko/java/com.aspose.psd.imageoptions/tiffoptionserror/
---
...
| 필드 | 설명 |
| --- | --- |
| [Baseline6OptionsMismatch](#Baseline6OptionsMismatch) | 지정된 TIFF 옵션 매개변수가 TIFF Baseline 6.0 표준에 부합하지 않습니다. |
| [ColorMapLengthInvalid](#ColorMapLengthInvalid) | 색상 맵 길이가 올바르지 않습니다. |
| [CompressionSppMismatch](#CompressionSppMismatch) | 압축이 픽셀당 샘플 수와 일치하지 않습니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NoColorMap](#NoColorMap) | 색상 맵이 정의되지 않았습니다. |
| [NoError](#NoError) | 오류 코드가 없습니다. |
| [NotSupportedAlphaStorage](#NotSupportedAlphaStorage) | 알파 저장이 지원되지 않습니다. |
| [PhotometricBitsPerSampleMismatch](#PhotometricBitsPerSampleMismatch) | 포토메트릭 샘플당 비트 수가 올바르지 않습니다 |
| [PhotometricCompressionMismatch](#PhotometricCompressionMismatch) | 압축이 포토메트릭 설정과 일치하지 않습니다. |
| [PhotometricSppMismatch](#PhotometricSppMismatch) | 포토메트릭이 픽셀당 샘플 수와 일치하지 않습니다. |
## 메서드
...
지정된 TIFF 옵션 매개변수가 TIFF Baseline 6.0 표준에 부합하지 않습니다.
