...
description: "BMP 파일 형식 생성 옵션."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.imageoptions/bmpoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [BmpOptions()](#BmpOptions--) | BmpOptions 클래스의 새 인스턴스를 초기화합니다. |
| [BmpOptions(BmpOptions bmpOptions)](#BmpOptions-com.aspose.psd.imageoptions.BmpOptions-) | BmpOptions 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getBitsPerPixel()](#getBitsPerPixel--) | 이미지 비트당 픽셀 수를 가져오거나 설정합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBitsPerPixel(int value)](#setBitsPerPixel-int-) | 이미지 비트당 픽셀 수를 가져오거나 설정합니다. |
| [setBufferSizeHint(int value)](#setBufferSizeHint-int-) | 버퍼 크기 힌트를 가져오거나 설정합니다. 이는 모든 내부 버퍼에 대해 정의된 최대 허용 크기입니다. |
| [setCompression(long value)](#setCompression-long-) | 압축을 가져오거나 설정합니다. |
...
BmpOptions 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| bmpOptions | [BmpOptions](../../com.aspose.psd.imageoptions/bmpoptions) | BMP 옵션입니다. |
