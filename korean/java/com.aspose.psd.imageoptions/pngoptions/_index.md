...
description: "PNG 파일 형식 생성 옵션."
type: docs
weight: 19
url: /ko/java/com.aspose.psd.imageoptions/pngoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PngOptions()](#PngOptions--) | 새로운  PngOptions  클래스 인스턴스를 초기화합니다. |
| [PngOptions(PngOptions pngOptions)](#PngOptions-com.aspose.psd.imageoptions.PngOptions-) | 새로운 JpegOptions 클래스 인스턴스를 초기화합니다. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [DEFAULT_COMPRESSION_LEVEL](#DEFAULT-COMPRESSION-LEVEL) | 기본 압축 수준. |
## 메서드
...
| [getBitDepth()](#getBitDepth--) | 비트 깊이를 가져옵니다. |
...
| [getCompressionLevel()](#getCompressionLevel--) | png 이미지 압축 수준은 0-9 범위이며, 9는 최대 압축, 0은 저장 모드입니다. |
...
| [getFilterType()](#getFilterType--) | png 파일 저장 과정에서 사용되는 필터 유형을 가져오거나 설정합니다. |
...
| [getProgressive()](#getProgressive--) | 이  PngOptions  가 진행형인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBitDepth(byte value)](#setBitDepth-byte-) | 비트 깊이를 설정합니다. |
...
| [setCompressionLevel(int value)](#setCompressionLevel-int-) | png 이미지 압축 수준은 0-9 범위이며, 9는 최대 압축, 0은 저장 모드입니다. |
...
| [setFilterType(int value)](#setFilterType-int-) | png 파일 저장 과정에서 사용되는 필터 유형을 가져오거나 설정합니다. |
...
| [setProgressive(boolean value)](#setProgressive-boolean-) | 이  PngOptions  가 진행형인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [toString()](#toString--) |  |
| [validate_internalized()](#validate-internalized--) | 옵션 검증 루틴. |
| [wait()](#wait--) |  |
...
새로운  PngOptions  클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| pngOptions | [PngOptions](../../com.aspose.psd.imageoptions/pngoptions) | PNG 옵션. |
...
png 이미지 압축 수준은 0-9 범위이며, 9는 최대 압축, 0은 저장 모드입니다.

**Returns:**
int - 0-9 범위의 압축 수준이며, 9는 최대 압축, 0은 저장 모드입니다.
...
png 파일 저장 과정에서 사용되는 필터 유형을 가져오거나 설정합니다.

**Returns:**
int - png 파일 저장 과정에서 사용되는 필터 유형.
...
이  PngOptions  가 진행형인지 여부를 나타내는 값을 가져오거나 설정합니다.

**Returns:**
boolean -  true  진행형이면; 그렇지 않으면,  false .
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | int | 0-9 범위의 압축 수준이며, 9는 최대 압축, 0은 저장 모드입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | int | png 파일 저장 과정에서 사용되는 필터 유형. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | boolean | true  진행형이면; 그렇지 않으면,  false . |
