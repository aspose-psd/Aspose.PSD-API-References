...
description: "CAD 파일에서 누락될 수 있는 섹션을 나타냅니다."
type: docs
weight: 23
url: /ko/java/com.aspose.psd.imageoptions/rendererrorcode/
---
...
CAD 파일에서 누락될 수 있는 섹션을 나타냅니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MissingBlocks](#MissingBlocks) | 블록 정보가 누락되었습니다. |
| [MissingDimensionStyles](#MissingDimensionStyles) | 차원 스타일 정보가 누락되었습니다. |
| [MissingHeader](#MissingHeader) | 헤더가 누락되었습니다. |
| [MissingLayouts](#MissingLayouts) | 레이아웃 정보가 누락되었습니다. |
| [MissingStyles](#MissingStyles) | 스타일 정보가 누락되었습니다. |
## 메서드
