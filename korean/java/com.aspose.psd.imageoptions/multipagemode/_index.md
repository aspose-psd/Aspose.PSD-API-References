...
description: "다중 페이지 모드를 나타냅니다."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.imageoptions/multipagemode/
---
...
| 필드 | 설명 |
| --- | --- |
| [AllPages](#AllPages) | 모든 페이지 사용 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pages](#Pages) | 사용된 페이지 인덱스 |
| [Range](#Range) | 사용된 페이지 범위 |
| [TimeInterval](#TimeInterval) | 시간 구간에 사용된 페이지 |
| [Titles](#Titles) | 사용된 페이지 제목 |
## 메서드
