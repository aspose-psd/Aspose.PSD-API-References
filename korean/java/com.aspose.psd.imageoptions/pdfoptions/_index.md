...
type: docs
weight: 18
url: /ko/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PdfOptions()](#PdfOptions--) | 새 인스턴스를 초기화합니다 [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) 클래스. |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | 핵심 PDF 옵션을 가져옵니다. |
...
| [getPdfCoreOptions()](#getPdfCoreOptions--) | PDF 핵심 옵션 |
| [getPdfDocumentInfo()](#getPdfDocumentInfo--) | 문서 메타데이터를 가져오거나 설정합니다. |
...
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | PDF 핵심 옵션 |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | 문서 메타데이터를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions) 클래스.
