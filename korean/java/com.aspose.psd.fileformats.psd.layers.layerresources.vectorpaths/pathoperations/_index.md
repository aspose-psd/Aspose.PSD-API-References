...
description: "경로 형태를 결합하는 부울 연산에 대한 작업입니다."
type: docs
weight: 15
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| 필드 | 설명 |
| --- | --- |
| [CombineShapes](#CombineShapes) | 모양 결합 (OR operation). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | 겹치는 모양 제외 (XOR operation). |
| [IntersectShapeAreas](#IntersectShapeAreas) | 모양 영역 교차 (AND operation). |
| [SubtractFrontShape](#SubtractFrontShape) | 앞 모양 빼기 (NOT operation). |
## 메서드
...
모양 결합 (OR operation). 이것은 Photoshop의 기본값입니다.
