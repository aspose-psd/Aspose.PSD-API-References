...
description: "클래스 VsmsResource."
type: docs
weight: 29
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
클래스 VsmsResource. 이 리소스는 벡터 레이어 마스크에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) 클래스의 새 인스턴스를 초기화합니다. |
| [VsmsResource()](#VsmsResource--) | [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [hashCode()](#hashCode--) |  |
| [isChanged_internalized()](#isChanged-internalized--) | 이 인스턴스가 변경되었는지 여부를 결정합니다. |
...
| [updateDataToCurrent_internalized()](#updateDataToCurrent-internalized--) | 캐시된 원본 데이터를 현재 상태로 업데이트합니다. |
| [wait()](#wait--) |  |
...
[VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource) 클래스의 새 인스턴스를 초기화합니다.
...
이 인스턴스가 변경되었는지 여부를 결정합니다.

**Returns:**
boolean -  이 인스턴스가 변경되면 true; 그렇지 않으면 false .
