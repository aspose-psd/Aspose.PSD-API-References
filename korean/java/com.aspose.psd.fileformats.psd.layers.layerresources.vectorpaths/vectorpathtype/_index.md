...
description: "PSD 포맷 사양에 따른 벡터 경로 유형"
type: docs
weight: 22
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
PSD 포맷 사양에 따른 벡터 경로 유형
## 필드

| 필드 | 설명 |
| --- | --- |
| [ClipboardRecord](#ClipboardRecord) | 클립보드 레코드 |
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | 닫힌 서브패스 베지어 노드 연결됨 |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | 닫힌 서브패스 베지어 노드 연결 해제됨 |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | 닫힌 서브패스 길이 레코드 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | 초기 채우기 규칙 레코드 |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | 열린 서브패스 베지어 노드 연결됨 |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | 열린 서브패스 베지어 노드 연결 해제됨 |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | 열린 서브패스 길이 레코드 |
| [PathFillRuleRecord](#PathFillRuleRecord) | 경로 채우기 규칙 레코드 |
## 메서드
