...
description: "클래스 VmskResource."
type: docs
weight: 27
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource/
---
...
VmskResource 클래스. 이 리소스는 벡터 레이어 마스크에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VmskResource(byte[] data)](#VmskResource-byte---) | 새 인스턴스를 초기화합니다. [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) 클래스. |
| [VmskResource()](#VmskResource--) | 새 인스턴스를 초기화합니다. [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) 클래스. |
## 필드
...
새 인스턴스를 초기화합니다. [VmskResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vmskresource) 클래스.
