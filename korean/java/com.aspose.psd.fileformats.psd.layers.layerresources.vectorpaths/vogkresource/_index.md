...
description: "그 Vector Origination Data 리소스."
type: docs
weight: 28
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
그 Vector Origination Data 리소스.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [VogkResource()](#VogkResource--) | 새로운 [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) 클래스 인스턴스를 초기화합니다. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | 도형 원점 설정을 저장하기 위한 디스크립터 키. |
...
| [getItems_internalized()](#getItems-internalized--) | 구조 항목을 가져오거나 설정합니다. |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | 도형 원점 설정을 가져오거나 설정합니다. |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | 도형 원점 설정을 가져오거나 설정합니다. |
...
새로운 [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) 클래스 인스턴스를 초기화합니다.
