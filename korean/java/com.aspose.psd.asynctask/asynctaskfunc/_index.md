...
description: "제네릭 타입 결과를 갖는 비동기 작업을 위한 장기 작업 대리자."
type: docs
weight: 12
url: /ko/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
제네릭 타입 결과를 갖는 비동기 작업을 위한 장기 작업 대리자.
## 생성자
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | 제네릭 타입 결과를 갖는 비동기 작업을 위한 장기 작업 대리자. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | 비동기 작업의 상태. |

**Returns:**
java.lang.Object - 긴 작업의 결과.
### notify() {#notify--}
```
