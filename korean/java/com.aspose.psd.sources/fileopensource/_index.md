...
description: "열기를 위한 파일 소스를 나타냅니다."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.sources/fileopensource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [FileOpenSource(String filePath)](#FileOpenSource-java.lang.String-) | FileOpenSource 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getFilePath()](#getFilePath--) | 열 파일 경로를 가져옵니다. |
...
FileOpenSource 클래스의 새 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| filePath | java.lang.String | 열 파일 경로. |
