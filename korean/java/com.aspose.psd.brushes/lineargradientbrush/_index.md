...
description: "Aspose.Imaging.Brush를 선형 그라디언트와 함께 캡슐화합니다."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.brushes/lineargradientbrush/
---
...
Aspose.Imaging.Brush를 선형 그라디언트와 함께 캡슐화합니다. 이 클래스는 상속할 수 없습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [LinearGradientBrush()](#LinearGradientBrush--) | LinearGradientBrush 클래스의 새 인스턴스를 기본 매개변수로 초기화합니다. |
| [LinearGradientBrush(Point point1, Point point2, Color color1, Color color2)](#LinearGradientBrush-com.aspose.psd.Point-com.aspose.psd.Point-com.aspose.psd.Color-com.aspose.psd.Color-) | LinearGradientBrush 클래스의 새 인스턴스를 지정된 포인트와 색상으로 초기화합니다. |
| [LinearGradientBrush(PointF point1, PointF point2, Color color1, Color color2)](#LinearGradientBrush-com.aspose.psd.PointF-com.aspose.psd.PointF-com.aspose.psd.Color-com.aspose.psd.Color-) | LinearGradientBrush 클래스의 새 인스턴스를 지정된 포인트와 색상으로 초기화합니다. |
| [LinearGradientBrush(Rectangle rect, Color color1, Color color2, float angle)](#LinearGradientBrush-com.aspose.psd.Rectangle-com.aspose.psd.Color-com.aspose.psd.Color-float-) | LinearGradientBrush 클래스의 새 인스턴스를 사각형, 시작 및 종료 색상, 그리고 방향 각도를 기반으로 초기화합니다. |
| [LinearGradientBrush(RectangleF rect, Color color1, Color color2, float angle)](#LinearGradientBrush-com.aspose.psd.RectangleF-com.aspose.psd.Color-com.aspose.psd.Color-float-) | LinearGradientBrush 클래스의 새 인스턴스를 사각형, 시작 및 종료 색상, 그리고 방향 각도를 기반으로 초기화합니다. |
| [LinearGradientBrush(Rectangle rect, Color color1, Color color2, float angle, boolean isAngleScalable)](#LinearGradientBrush-com.aspose.psd.Rectangle-com.aspose.psd.Color-com.aspose.psd.Color-float-boolean-) | LinearGradientBrush 클래스의 새 인스턴스를 사각형, 시작 및 종료 색상, 그리고 방향 각도를 기반으로 초기화합니다. |
| [LinearGradientBrush(RectangleF rect, Color color1, Color color2, float angle, boolean isAngleScalable)](#LinearGradientBrush-com.aspose.psd.RectangleF-com.aspose.psd.Color-com.aspose.psd.Color-float-boolean-) | LinearGradientBrush 클래스의 새 인스턴스를 사각형, 시작 및 종료 색상, 그리고 방향 각도를 기반으로 초기화합니다. |
## 메서드
...
| [getAngle()](#getAngle--) | 그라디언트 각도를 가져옵니다. |
| [getBlend()](#getBlend--) | 그라디언트에 대한 사용자 정의 감쇠를 정의하는 위치와 계수를 지정하는 Aspose.Imaging.Blend를 가져옵니다. |
| [getClass()](#getClass--) |  |
| [getDisposed()](#getDisposed--) | 이 인스턴스가 해제되었는지 여부를 나타내는 값을 가져옵니다. |
| [getEndColor()](#getEndColor--) | 종료 그라디언트 색상을 가져옵니다. |
| [getGammaCorrection()](#getGammaCorrection--) | 이 LinearGradientBrushBase 에 대해 감마 보정이 활성화되어 있는지 여부를 나타내는 값을 가져옵니다. |
| [getInterpolationColors()](#getInterpolationColors--) | 다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend 를 가져옵니다. |
| [getLinearColors()](#getLinearColors--) | 그라디언트의 시작 및 종료 색상을 가져옵니다. |
| [getOpacity()](#getOpacity--) | Brush 불투명도를 가져옵니다. |
| [getRectangle()](#getRectangle--) | 그라디언트의 시작 및 끝 포인트를 정의하는 사각형 영역을 가져옵니다. |
| [getStartColor()](#getStartColor--) | 시작 그라디언트 색상을 가져옵니다. |
...
| [hashCode()](#hashCode--) |  |
| [isAngleScalable()](#isAngleScalable--) | 이 LinearGradientBrushBase 로 변환하는 동안 LinearGradientBrushBase.Angle 가 변경되는지 여부를 나타내는 값을 가져옵니다. |
...
| [setAngle(float value)](#setAngle-float-) | 그라디언트 각도를 설정합니다. |
| [setAngleScalable(boolean value)](#setAngleScalable-boolean-) | 이 LinearGradientBrushBase 로 변환하는 동안 LinearGradientBrushBase.Angle 가 변경되는지 여부를 나타내는 값을 설정합니다. |
| [setBlend(Blend value)](#setBlend-com.aspose.psd.Blend-) | 그라디언트에 대한 사용자 정의 감쇠를 정의하는 위치와 계수를 지정하는 Aspose.Imaging.Blend를 설정합니다. |
| [setBlendTriangularShape(float focus)](#setBlendTriangularShape-float-) | 중심 색상과 양쪽 끝에 단일 색상으로 선형 감쇠되는 선형 그라디언트를 생성합니다. |
| [setBlendTriangularShape(float focus, float scale)](#setBlendTriangularShape-float-float-) | 중심 색상과 양쪽 끝에 단일 색상으로 선형 감쇠되는 선형 그라디언트를 생성합니다. |
| [setEndColor(Color value)](#setEndColor-com.aspose.psd.Color-) | 종료 그라디언트 색상을 설정합니다. |
| [setGammaCorrection(boolean value)](#setGammaCorrection-boolean-) | 이 LinearGradientBrushBase 에 대해 감마 보정이 활성화되어 있는지 여부를 나타내는 값을 설정합니다. |
| [setInterpolationColors(ColorBlend value)](#setInterpolationColors-com.aspose.psd.ColorBlend-) | 다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend 를 설정합니다. |
| [setLinearColors(Color[] value)](#setLinearColors-com.aspose.psd.Color---) | 그라디언트의 시작 및 종료 색상을 설정합니다. |
| [setOpacity(float value)](#setOpacity-float-) | 브러시 불투명도를 설정합니다. |
| [setRectangle(RectangleF value)](#setRectangle-com.aspose.psd.RectangleF-) | 그라디언트의 시작점과 끝점을 정의하는 직사각형 영역을 설정합니다. |
| [setSigmaBellShape(float focus)](#setSigmaBellShape-float-) | 벨 모양 곡선을 기반으로 그라디언트 감쇠를 생성합니다. |
| [setSigmaBellShape(float focus, float scale)](#setSigmaBellShape-float-float-) | 벨 모양 곡선을 기반으로 그라디언트 감쇠를 생성합니다. |
| [setStartColor(Color value)](#setStartColor-com.aspose.psd.Color-) | 시작 그라디언트 색상을 설정합니다. |
...
기본 매개변수로  LinearGradientBrush  클래스의 새 인스턴스를 초기화합니다. 시작 색상은 검정색이고, 끝 색상은 흰색이며, 각도는 45도이고, 사각형은 (0,0)에 위치하고 크기는 (1,1)입니다.
...
LinearGradientBrush 클래스의 새 인스턴스를 지정된 포인트와 색상으로 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| point1 | [Point](../../com.aspose.psd/point) | 선형 그라디언트의 시작점을 나타내는 Aspose.Imaging.Point 구조체입니다. |
| point2 | [Point](../../com.aspose.psd/point) | 선형 그라디언트의 끝점을 나타내는 Aspose.Imaging.Point 구조체입니다. |
| color1 | [Color](../../com.aspose.psd/color) | 선형 그라디언트의 시작 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| color2 | [Color](../../com.aspose.psd/color) | 선형 그라디언트의 끝 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| point1 | [PointF](../../com.aspose.psd/pointf) | 선형 그라디언트의 시작점을 나타내는 Aspose.Imaging.PointF 구조체입니다. |
| point2 | [PointF](../../com.aspose.psd/pointf) | 선형 그라디언트의 끝점을 나타내는 Aspose.Imaging.PointF 구조체입니다. |
| color1 | [Color](../../com.aspose.psd/color) | 선형 그라디언트의 시작 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| color2 | [Color](../../com.aspose.psd/color) | 선형 그라디언트의 끝 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
...
LinearGradientBrush 클래스의 새 인스턴스를 사각형, 시작 및 종료 색상, 그리고 방향 각도를 기반으로 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| rect | [Rectangle](../../com.aspose.psd/rectangle) | 선형 그라디언트의 경계를 지정하는 Aspose.Imaging.RectangleF 구조체입니다. |
| color1 | [Color](../../com.aspose.psd/color) | 그라디언트의 시작 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| color2 | [Color](../../com.aspose.psd/color) | 그라디언트의 끝 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| 각도 | float | 그라디언트 방향선의 각도(시계 방향으로 x축에서 측정한 도 단위)입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| rect | [RectangleF](../../com.aspose.psd/rectanglef) | 선형 그라디언트의 경계를 지정하는 Aspose.Imaging.RectangleF 구조체입니다. |
| color1 | [Color](../../com.aspose.psd/color) | 그라디언트의 시작 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| color2 | [Color](../../com.aspose.psd/color) | 그라디언트의 끝 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| 각도 | float | 그라디언트 방향선의 각도(시계 방향으로 x축에서 측정한 도 단위)입니다. |
...
| color2 | [Color](../../com.aspose.psd/color) | 그라디언트의 끝 색상을 나타내는  com.aspose.psd.Color  구조체입니다. |
| 각도 | float | 그라디언트 방향선의 각도(시계 방향으로 x축에서 측정한 도 단위)입니다. |
| isAngleScalable | boolean | true 로 설정하면 이  LinearGradientBrush  로 변환하는 동안 각도가 변경됩니다. |
...
그라디언트에 대한 사용자 정의 감쇠를 정의하는 위치와 계수를 지정하는 Aspose.Imaging.Blend를 가져옵니다.
...
이 LinearGradientBrushBase 에 대해 감마 보정이 활성화되어 있는지 여부를 나타내는 값을 가져옵니다.

**Returns:**
boolean - 이 LinearGradientBrushBase에 대해 감마 보정이 활성화된 경우 `true`이며, 그렇지 않으면 `false`입니다.
...
다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend 를 가져옵니다.
...
그라디언트의 시작 및 종료 색상을 가져옵니다.

**Returns:**
com.aspose.psd.Color[] - 그라디언트의 시작 및 끝 색상을 나타내는 두 개의  Color  구조체 배열입니다.
...
그라디언트의 시작 및 끝 포인트를 정의하는 사각형 영역을 가져옵니다.
...
이 LinearGradientBrushBase 로 변환하는 동안 LinearGradientBrushBase.Angle 가 변경되는지 여부를 나타내는 값을 가져옵니다.

**Returns:**
boolean - 이 LinearGradientBrushBase로 변환할 때 LinearGradientBrushBase.Angle가 변경된 경우 `true`, 그렇지 않으면 `false`.
...
이 LinearGradientBrushBase 로 변환하는 동안 LinearGradientBrushBase.Angle 가 변경되는지 여부를 나타내는 값을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | boolean | 이 LinearGradientBrushBase 로 변환 중에 LinearGradientBrushBase.Angle이 변경되면 true, 그렇지 않으면 false. |
...
그라디언트에 대한 사용자 정의 감쇠를 정의하는 위치와 계수를 지정하는 Aspose.Imaging.Blend를 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Blend](../../com.aspose.psd/blend) | 그라디언트에 대한 사용자 정의 감쇠를 나타내는  Aspose.Imaging.Blend  입니다. |
...
중심 색상과 양쪽 끝에 단일 색상으로 선형 감쇠되는 선형 그라디언트를 생성합니다.
...
| --- | --- | --- |
| 포커스 | float | 0부터 1까지의 값으로 그라디언트의 중심을 지정합니다(그라디언트가 오직 끝 색상만으로 구성되는 지점). |
| 스케일 | float | 0부터 1까지의 값으로 시작 색상에서  focus  (끝 색상)까지 색상이 얼마나 빠르게 감쇠하는지를 지정합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | 끝 그라디언트 색상입니다. |
...
이 LinearGradientBrushBase 에 대해 감마 보정이 활성화되어 있는지 여부를 나타내는 값을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | boolean | 이 LinearGradientBrushBase에 대해 감마 보정이 활성화된 경우 값은 true이며, 그렇지 않으면 false입니다. |
...
다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend 를 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [ColorBlend](../../com.aspose.psd/colorblend) | 다중 색상 선형 그라디언트를 정의하는  com.aspose.psd.ColorBlend  입니다. |
...
그라디언트의 시작 및 종료 색상을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Color\[\]](../../com.aspose.psd/color) | 그라디언트의 시작 및 끝 색상을 나타내는 두 개의  Color  구조체 배열입니다. |
...
그라디언트의 시작점과 끝점을 정의하는 직사각형 영역을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [RectangleF](../../com.aspose.psd/rectanglef) | 그라디언트의 시작점과 끝점을 지정하는  com.aspose.psd.RectangleF  구조체입니다. |
...
| --- | --- | --- |
| 포커스 | float | 0부터 1까지의 값으로 그라디언트의 중심을 지정합니다(그라디언트가 오직 끝 색상만으로 구성되는 지점). |
| 스케일 | float | 0부터 1까지의 값으로 색상이  focus  로부터 얼마나 빠르게 감쇠하는지를 지정합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | 시작 그라디언트 색상입니다. |
