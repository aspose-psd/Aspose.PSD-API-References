...
description: "그라디언트를 사용하여 Aspose.Imaging.Brush 객체를 캡슐화합니다."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.brushes/pathgradientbrush/
---
...
그라디언트를 사용하여 Aspose.Imaging.Brush 객체를 캡슐화합니다. 이 클래스는 상속할 수 없습니다.

중심 색상은 기본적으로 흰색입니다. 사용자는 나중에 언제든지 이 값을 변경할 수 있습니다.

주변 색상 배열은 기본적으로 흰색을 포함하는 단일 요소로 초기화됩니다. 주변 색상은 나중에 변경될 수 있지만, 주변 색상을 설정할 때 최소 하나의 요소는 필요합니다.

초기화에 대한 자세한 내용은  Blend  를 참조하십시오.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [PathGradientBrush(PointF[] points)](#PathGradientBrush-com.aspose.psd.PointF---) | 지정된 점을 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathGradientBrush(PointF[] points, int wrapMode)](#PathGradientBrush-com.aspose.psd.PointF---int-) | 지정된 점 및 랩 모드를 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathGradientBrush(Point[] points)](#PathGradientBrush-com.aspose.psd.Point---) | 지정된 점을 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathGradientBrush(Point[] points, int wrapMode)](#PathGradientBrush-com.aspose.psd.Point---int-) | 지정된 점 및 랩 모드를 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathGradientBrush(GraphicsPath path)](#PathGradientBrush-com.aspose.psd.GraphicsPath-) | 지정된 경로를 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getCenterColor()](#getCenterColor--) | 경로 그라디언트 중심의 색상을 가져옵니다. |
...
| [getSurroundColors()](#getSurroundColors--) | 이 PathGradientBrush가 채우는 경로의 점에 해당하는 색상 배열을 가져옵니다. |
...
| [setBlendTriangularShape(float focus)](#setBlendTriangularShape-float-) | 중심 색상과 하나의 주변 색상으로 선형 감소하는 그라디언트를 생성합니다. |
| [setBlendTriangularShape(float focus, float scale)](#setBlendTriangularShape-float-float-) | 중심 색상과 각 주변 색상으로 선형 감소하는 그라디언트를 생성합니다. |
| [setCenterColor(Color value)](#setCenterColor-com.aspose.psd.Color-) | 경로 그라디언트 중심의 색상을 설정합니다. |
...
| [setSigmaBellShape(float focus)](#setSigmaBellShape-float-) | 경로의 중심에서 경계까지 색상이 변하는 그라디언트 브러시를 생성합니다. |
| [setSigmaBellShape(float focus, float scale)](#setSigmaBellShape-float-float-) | 경로의 중심에서 경계까지 색상이 변하는 그라디언트 브러시를 생성합니다. |
| [setSurroundColors(Color[] value)](#setSurroundColors-com.aspose.psd.Color---) | 이 PathGradientBrush가 채우는 경로의 점에 해당하는 색상 배열을 설정합니다. |
...
지정된 점을 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | 경로의 정점을 구성하는 점들을 나타내는 Aspose.Imaging.PointF 구조체 배열입니다. |
...
지정된 점 및 랩 모드를 사용하여 PathGradientBrush 클래스의 새 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | 경로의 정점을 구성하는 점들을 나타내는 Aspose.Imaging.PointF 구조체 배열입니다. |
| wrapMode | int | 이 PathGradientBrush로 그린 채우기가 타일링되는 방식을 지정하는 Aspose.Imaging.WrapMode. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| points | [Point\[\]](../../com.aspose.psd/point) | 경로의 정점을 구성하는 점들을 나타내는 Aspose.Imaging.Point 구조체 배열입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| path | [GraphicsPath](../../com.aspose.psd/graphicspath) | 이 PathGradientBrush가 채우는 영역을 정의하는 GraphicsPath. |
...
이 PathGradientBrush가 채우는 경로의 점에 해당하는 색상 배열을 가져옵니다.

**Returns:**
com.aspose.psd.Color[] - 이 PathGradientBrush가 채우는 경로의 각 점에 연결된 색상을 나타내는 com.aspose.psd.Color 구조체 배열입니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 포커스 | float | 0에서 1 사이의 값으로, 경로 중심에서 경계까지의 방사선 상에서 중심 색상의 최대 강도가 위치하는 지점을 지정합니다. 값 1(기본값)은 경로 중심에 최대 강도를 배치합니다. |
...
| --- | --- | --- |
| 포커스 | float | 0에서 1 사이의 값으로, 경로 중심에서 경계까지의 방사선 상에서 중심 색상의 최대 강도가 위치하는 지점을 지정합니다. 값 1(기본값)은 경로 중심에 최대 강도를 배치합니다. |
| 스케일 | float | 0에서 1 사이의 값으로, 경계 색상과 혼합되는 중심 색상의 최대 강도를 지정합니다. 값 1은 가능한 가장 높은 중심 색상 강도를 발생시키며, 기본값입니다. |
...
경로 그라디언트 중심의 색상을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | 경로 그라디언트 중심의 색상을 나타내는 com.aspose.psd.Color. |
...
경로의 중심에서 경계까지 색상이 변하는 그라디언트 브러시를 생성합니다. 한 색상에서 다른 색상으로의 전환은 종 모양 곡선을 기반으로 합니다.
...
이 PathGradientBrush가 채우는 경로의 점에 해당하는 색상 배열을 설정합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Color\[\]](../../com.aspose.psd/color) | 이 PathGradientBrush가 채우는 경로의 각 점에 연결된 색상을 나타내는 com.aspose.psd.Color 구조체 배열입니다. |
