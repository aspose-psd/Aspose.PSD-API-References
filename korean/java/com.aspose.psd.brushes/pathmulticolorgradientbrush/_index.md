...
type: docs
weight: 16
url: /ko/java/com.aspose.psd.brushes/pathmulticolorgradientbrush/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PathMulticolorGradientBrush(PointF[] points)](#PathMulticolorGradientBrush-com.aspose.psd.PointF---) | 지정된 점들을 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathMulticolorGradientBrush(PointF[] points, int wrapMode)](#PathMulticolorGradientBrush-com.aspose.psd.PointF---int-) | 지정된 점들과 래핑 모드를 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathMulticolorGradientBrush(Point[] points)](#PathMulticolorGradientBrush-com.aspose.psd.Point---) | 지정된 점들을 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathMulticolorGradientBrush(Point[] points, int wrapMode)](#PathMulticolorGradientBrush-com.aspose.psd.Point---int-) | 지정된 점들과 래핑 모드를 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
| [PathMulticolorGradientBrush(GraphicsPath path)](#PathMulticolorGradientBrush-com.aspose.psd.GraphicsPath-) | 지정된 경로를 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getInterpolationColors()](#getInterpolationColors--) | 다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend를 가져오거나 설정합니다. |
...
| [setInterpolationColors(ColorBlend value)](#setInterpolationColors-com.aspose.psd.ColorBlend-) | 다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend를 가져오거나 설정합니다. |
...
지정된 점들을 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다.
...
지정된 점들과 래핑 모드를 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | 경로의 정점을 구성하는 점들을 나타내는 Aspose.Imaging.PointF 구조체 배열입니다. |
| wrapMode | int | 이 PathMulticolorGradientBrush 로 그린 채우기가 어떻게 타일링되는지를 지정하는 Aspose.Imaging.WrapMode. |
...
지정된 경로를 사용하여 PathMulticolorGradientBrush 클래스의 새 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| path | [GraphicsPath](../../com.aspose.psd/graphicspath) | 이 PathMulticolorGradientBrush 로 채워지는 영역을 정의하는 GraphicsPath. |
...
다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend를 가져오거나 설정합니다.

값: 다중 색상 선형 그라디언트를 정의하는 com.aspose.psd.ColorBlend.
