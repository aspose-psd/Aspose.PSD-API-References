...
description: "exif 파일 소스 열거형."
type: docs
weight: 15
url: /ko/java/com.aspose.psd.exif.enums/exiffilesource/
---
...
| 필드 | 설명 |
| --- | --- |
| [DigitalStillCamera](#DigitalStillCamera) | 디지털 정지 카메라. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FilmScanner](#FilmScanner) | 필름 스캐너. |
| [Others](#Others) | 기타. |
| [ReflexionPrintScanner](#ReflexionPrintScanner) | 반사 인쇄 스캐너. |
## 메서드
