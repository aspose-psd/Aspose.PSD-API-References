...
type: docs
weight: 16
url: /ko/java/com.aspose.psd.exif.enums/exifflash/
---
...
| [Fired](#Fired) | 플래시가 작동했습니다. |
| [FiredReturnLightDetected](#FiredReturnLightDetected) | 플래시가 작동했으며, 반사광이 감지되었습니다. |
| [FiredReturnLightNotDetected](#FiredReturnLightNotDetected) | 플래시가 작동했으며, 반사광이 감지되지 않았습니다. |
| [NoAuto](#NoAuto) | 플래시가 작동하지 않았습니다, 자동 모드. |
| [NoCompulsory](#NoCompulsory) | 플래시가 작동하지 않았습니다, 강제 플래시 모드. |
| [NoDidNotFireReturnLightNotDetected](#NoDidNotFireReturnLightNotDetected) | 플래시가 작동하지 않았으며, 반사광이 감지되지 않았습니다. |
| [NoFlashFunction](#NoFlashFunction) | 플래시 기능이 없습니다. |
| [Noflash](#Noflash) | 플래시가 작동하지 않았습니다. |
| [YesAuto](#YesAuto) | 플래시가 작동했습니다, 자동 모드. |
| [YesAutoReturnLightDetected](#YesAutoReturnLightDetected) | 플래시가 작동했으며, 자동 모드, 반사광이 감지되었습니다. |
| [YesAutoReturnLightNotDetected](#YesAutoReturnLightNotDetected) | 플래시가 작동했으며, 자동 모드, 반사광이 감지되지 않았습니다. |
| [YesCompulsory](#YesCompulsory) | 플래시가 작동했으며, 강제 플래시 모드. |
| [YesCompulsoryReturnLightDetected](#YesCompulsoryReturnLightDetected) | 플래시가 작동했으며, 강제 모드, 반사광이 감지되었습니다. |
| [YesCompulsoryReturnLightNotDetected](#YesCompulsoryReturnLightNotDetected) | 플래시가 작동했으며, 강제 모드, 반사광이 감지되지 않았습니다. |
## 메서드
...
플래시가 작동하지 않았으며, 반사광이 감지되지 않았습니다.
...
플래시가 작동했으며, 자동 모드, 반사광이 감지되지 않았습니다.
...
플래시가 작동했으며, 강제 모드, 반사광이 감지되지 않았습니다.
