...
description: "Exif 이미지 방향."
type: docs
weight: 21
url: /ko/java/com.aspose.psd.exif.enums/exiforientation/
---
...
| 필드 | 설명 |
| --- | --- |
| [BottomLeft](#BottomLeft) | 왼쪽 하단. |
| [BottomRight](#BottomRight) | 오른쪽 하단. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LeftBottom](#LeftBottom) | 왼쪽 하단. |
| [LeftTop](#LeftTop) | 왼쪽 상단. |
| [RightBottom](#RightBottom) | 오른쪽 하단. |
| [RightTop](#RightTop) | 오른쪽 상단. |
| [TopLeft](#TopLeft) | 왼쪽 상단. |
| [TopRight](#TopRight) | 오른쪽 상단. |
## 메서드
...
왼쪽 상단. 90도 반시계 방향 회전한 다음 수평으로 뒤집습니다.
...
오른쪽 하단. 90도 시계 방향 회전한 다음 수평으로 뒤집습니다.
