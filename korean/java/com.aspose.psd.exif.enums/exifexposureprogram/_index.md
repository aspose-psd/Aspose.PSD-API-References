...
description: "exif 노출 프로그램 열거형."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.exif.enums/exifexposureprogram/
---
...
| 필드 | 설명 |
| --- | --- |
| [Actionprogram](#Actionprogram) | 액션 프로그램. |
| [Aperturepriority](#Aperturepriority) | 조리개 우선. |
| [Auto](#Auto) | 자동 노출. |
| [Creativeprogram](#Creativeprogram) | 크리에이티브 프로그램. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Landscapemode](#Landscapemode) | 풍경 모드. |
| [Manual](#Manual) | 수동 프로그램. |
| [Notdefined](#Notdefined) | 정의되지 않음. |
| [Portraitmode](#Portraitmode) | 인물 모드. |
| [Shutterpriority](#Shutterpriority) | 셔터 우선. |
## 메서드
