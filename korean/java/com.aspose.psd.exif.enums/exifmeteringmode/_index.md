...
description: "exif 측광 모드 열거형."
type: docs
weight: 20
url: /ko/java/com.aspose.psd.exif.enums/exifmeteringmode/
---
...
| 필드 | 설명 |
| --- | --- |
| [Average](#Average) | 평균 측광 |
| [Centerweightedaverage](#Centerweightedaverage) | 중심 가중 평균. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MultiSegment](#MultiSegment) | 다중 구간 측광. |
| [MultiSpot](#MultiSpot) | 다중 스팟 측광 |
| [Other](#Other) | 다른 모드에 대해. |
| [Partial](#Partial) | 부분 측광. |
| [Spot](#Spot) | 스팟 측광 |
| [Unknown](#Unknown) | 정의되지 않은 모드 |
## 메서드
