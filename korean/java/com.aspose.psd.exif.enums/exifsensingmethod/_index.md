...
description: "exif 감지 방법 열거형."
type: docs
weight: 24
url: /ko/java/com.aspose.psd.exif.enums/exifsensingmethod/
---
...
| 필드 | 설명 |
| --- | --- |
| [Colorsequentialarea](#Colorsequentialarea) | 컬러 순차 영역. |
| [Colorsequentiallinear](#Colorsequentiallinear) | 컬러 순차 선형 센서. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Notdefined](#Notdefined) | 정의되지 않음. |
| [OneChipColorArea](#OneChipColorArea) | 원칩 컬러 영역. |
| [ThreeChipColorArea](#ThreeChipColorArea) | 삼칩 컬러 영역. |
| [Trilinearsensor](#Trilinearsensor) | 삼선형 센서. |
| [TwoChipColorArea](#TwoChipColorArea) | 이칩 컬러 영역. |
## 메서드
