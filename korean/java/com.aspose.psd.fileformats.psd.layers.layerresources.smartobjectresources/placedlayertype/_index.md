...
description: "배치된 레이어 PlLd 리소스를 위한 PlacedLayerType 열거형을 정의합니다."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedlayertype/
---
...
| [ImageStack](#ImageStack) | 이미지 스택 배치 레이어 유형 |
| [Raster](#Raster) | 래스터 배치 레이어 유형 |
| [Unknown](#Unknown) | 알 수 없는 배치 레이어 유형 |
| [Vector](#Vector) | 벡터 배치 레이어 유형 |
## 메서드
