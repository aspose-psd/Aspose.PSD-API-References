...
description: "PSD 파일에서 배치된 레이어에 대한 정보를 포함하는 PlLdResource 클래스를 정의합니다."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
PlLdResource 클래스를 정의합니다. 이 클래스는 PSD 파일의 배치 레이어에 대한 정보를 포함합니다. Adobe® Photoshop® 이미지에서 스마트 오브젝트 레이어를 지원하는 데 사용됩니다. Adobe® Photoshop® CS3에서 SoLdResource로 교체되었습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [PlLdResource()](#PlLdResource--) | 새로운 [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [TypeValue_internalized](#TypeValue-internalized) | 예상되는 유형 값 |
...
| [getLength()](#getLength--) | PlLd 리소스의 길이를 바이트 단위로 가져옵니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 지정된 스트림 컨테이너에 PlLD 리소스를 저장합니다. |
...
새로운 [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource) 클래스 인스턴스를 초기화합니다. 이 기본 생성자는 PlLdResourceLoader에서 사용하도록 설계되었습니다. PlLdResource 클래스를 생성하려면 [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator)를 사용하십시오.
