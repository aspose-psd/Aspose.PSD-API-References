...
description: "PSD 파일에서 스마트 오브젝트 레이어에 대한 정보를 포함하는 SoLdResource 클래스를 정의합니다."
type: docs
weight: 15
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
SoLdResource 클래스를 정의합니다. 이 클래스는 PSD 파일의 스마트 객체 레이어에 대한 정보를 포함합니다. Adobe® Photoshop® 이미지에서 스마트 객체 레이어를 지원하는 데 사용됩니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | 새로운 [SoLdResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soldresource) 클래스 인스턴스를 초기화합니다. |
| [SoLdResource()](#SoLdResource--) | 새로운 [SoLdResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soldresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [TypeToolKey](#TypeToolKey) | 타입 도구 정보 키: 'SoLd'. |
...
새로운 [SoLdResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soldresource) 클래스 인스턴스를 초기화합니다. 준비된 인스턴스를 얻으려면 Items 속성을 설정하거나 InitializeItems()를 호출해야 합니다. 이 생성자는 [SmartResourceCreator](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/smartresourcecreator)와 단위 테스트에서 사용하도록 설계되었습니다. SoLdResource 클래스를 생성하려면 [SmartResourceCreator](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/smartresourcecreator)를 사용하십시오.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| uniqueId | java.util.UUID | 스마트 객체 레이어 데이터의 고유 식별자 [SoLdResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soldresource). |
...
새로운 [SoLdResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soldresource) 클래스 인스턴스를 초기화합니다. 이 기본 생성자는 SoLdResourceLoader에서 사용하도록 설계되었습니다. SoLdResource 클래스를 생성하려면 [SmartResourceCreator](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/smartresourcecreator)를 사용하십시오.
