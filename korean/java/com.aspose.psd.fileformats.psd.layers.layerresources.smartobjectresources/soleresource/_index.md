...
description: "PSD 파일에서 스마트 오브젝트 레이어에 대한 정보를 포함하는 SoLeResource 클래스를 정의합니다."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource/
---
...
SoLeResource 클래스를 정의합니다. 이 클래스는 PSD 파일의 스마트 객체 레이어에 대한 정보를 포함하며, Adobe\\ufffd Photoshop\\ufffd 이미지에서 외부 파일 링크가 있는 스마트 객체 레이어를 지원하는 데 사용됩니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [SoLeResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLeResource-java.util.UUID-boolean-boolean-) | 새로운 [SoLeResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soleresource) 클래스 인스턴스를 초기화합니다. |
| [SoLeResource()](#SoLeResource--) | 새로운 [SoLeResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soleresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [TypeToolKey](#TypeToolKey) | 타입 도구 정보 키: 'SoLE'. |
...
새로운 [SoLeResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/soleresource) 클래스 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| uniqueId | java.util.UUID | 배치 레이어 데이터의 고유 식별자 [PlLdResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.smartobjectresources/plldresource). |
