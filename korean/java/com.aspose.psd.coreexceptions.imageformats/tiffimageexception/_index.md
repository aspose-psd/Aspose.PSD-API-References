...
description: "Tiff 이미지 예외입니다"
type: docs
weight: 19
url: /ko/java/com.aspose.psd.coreexceptions.imageformats/tiffimageexception/
---
...
| 생성자 | 설명 |
| --- | --- |
| [TiffImageException(String message)](#TiffImageException-java.lang.String-) | TiffImageException 클래스의 새 인스턴스를 초기화합니다. |
| [TiffImageException(String message, Throwable innerException)](#TiffImageException-java.lang.String-java.lang.Throwable-) | TiffImageException 클래스의 새 인스턴스를 초기화합니다. |
| [TiffImageException(String message, int error)](#TiffImageException-java.lang.String-int-) | TiffImageException 클래스의 새 인스턴스를 초기화합니다. |
| [TiffImageException(int error)](#TiffImageException-int-) | TiffImageException 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getOptionsError()](#getOptionsError--) | tiff 옵션 오류를 가져옵니다. |
...
TiffImageException 클래스의 새 인스턴스를 초기화합니다.
