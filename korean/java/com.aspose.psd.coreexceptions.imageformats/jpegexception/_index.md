...
description: "Jpeg 파일에 대한 예외"
type: docs
weight: 13
url: /ko/java/com.aspose.psd.coreexceptions.imageformats/jpegexception/
---
...
| 생성자 | 설명 |
| --- | --- |
| [JpegException(String message)](#JpegException-java.lang.String-) | JpegException 클래스의 새 인스턴스를 초기화합니다. |
| [JpegException(String message, Throwable innerException)](#JpegException-java.lang.String-java.lang.Throwable-) | JpegException 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
JpegException 클래스의 새 인스턴스를 초기화합니다.
