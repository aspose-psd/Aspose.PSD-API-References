...
description: "CCITT Group 3/4 팩스 인코딩 옵션. GROUP3OPTIONS / TiffTag.T4OPTIONS 및 TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS 태그에 대한 가능한 값."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
CCITT Group 3/4 팩스 인코딩 옵션.

GROUP3OPTIONS / TiffTag.T4OPTIONS 및 TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS 태그에 대한 가능한 값.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Encoding1D](#Encoding1D) | 1차원 코딩. |
| [Encoding2D](#Encoding2D) | 2차원 코딩. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | 바이트 경계까지 채웁니다. |
| [Uncompressed](#Uncompressed) | 데이터가 압축되지 않았습니다. |
## 메서드
