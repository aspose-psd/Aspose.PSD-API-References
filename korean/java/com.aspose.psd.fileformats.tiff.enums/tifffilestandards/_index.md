...
description: "TIFF 파일 형식 표준을 지정합니다."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
TIFF 파일 형식 표준을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Baseline](#Baseline) | Baseline TIFF 6.0 파일 표준. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extended](#Extended) | Extended TIFF 6.0 파일 표준. |
## 메서드
...
Baseline TIFF 6.0 파일 표준. 이 표준은 공식적으로 TIFF 6.0, Part 1: Baseline TIFF 로 알려져 있습니다.
...
Extended TIFF 6.0 파일 표준. 이 표준은 공식적으로 Extended TIFF 6.0, Part 2: TIFF Extensions 로 알려져 있습니다.
