...
description: "바이트 내의 데이터 순서. FILLORDER 태그의 가능한 값들."
type: docs
weight: 17
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tifffillorders/
---
...
FILLORDER 태그의 가능한 값들.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Lsb2Msb](#Lsb2Msb) | 최하위 비트 -> 최상위 비트. |
| [Msb2Lsb](#Msb2Lsb) | 최상위 비트 -> 최하위 비트. |
## 메서드
