...
description: "tiff 데이터 유형 열거형."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tiffdatatypes/
---
...
| 필드 | 설명 |
| --- | --- |
| [Ascii](#Ascii) | 8비트 바이트, 마지막 바이트는 null 입니다. |
| [Byte](#Byte) | 8비트 부호 없는 정수. |
| [Double](#Double) | 64비트 IEEE 부동 소수점. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Float](#Float) | 32비트 IEEE 부동 소수점. |
| [Ifd](#Ifd) | Exif 이미지 파일 디렉터리 (IFD) 포인터. |
| [Long](#Long) | 32비트 부호 없는 정수. |
| [Rational](#Rational) | 64비트 부호 없는 분수. |
| [Sbyte](#Sbyte) | 8비트 부호 있는 정수. |
| [Short](#Short) | 16비트 부호 없는 정수. |
| [Slong](#Slong) | 32비트 부호 있는 정수. |
| [Srational](#Srational) | 64비트 부호 있는 분수. |
| [Sshort](#Sshort) | 16비트 부호 있는 정수. |
| [Undefined](#Undefined) | 8비트 비정형 데이터. |
## 메서드
