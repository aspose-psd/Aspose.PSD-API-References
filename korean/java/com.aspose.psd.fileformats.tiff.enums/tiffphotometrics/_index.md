...
description: "광도 보간 열거형"
type: docs
weight: 20
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tiffphotometrics/
---
...
| [Mask](#Mask) | [TIFF rev에 의해 폐기됨 |
| [MinIsBlack](#MinIsBlack) | 최소값은 검정색입니다. |
| [MinIsWhite](#MinIsWhite) | 최소값은 흰색입니다. |
| [Palette](#Palette) | 색상 맵이 인덱싱되었습니다. |
| [Rgb](#Rgb) | RGB 색상 모델. |
| [Separated](#Separated) | 색상 분리. |
...
ICC L\*a\*b\*. TIFF rev 6.0 이후 Adobe TIFF Technote 4에 의해 도입되었습니다.
