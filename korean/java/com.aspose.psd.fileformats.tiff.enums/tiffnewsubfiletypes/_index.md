...
description: "tiff 새 하위 파일 유형 열거형."
type: docs
weight: 18
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tiffnewsubfiletypes/
---
...
| [FileTypeDefault](#FileTypeDefault) | 기본 파일 유형입니다. |
| [FileTypeLast](#FileTypeLast) | 마지막 파일 유형입니다. |
| [FileTypeMask](#FileTypeMask) | 마스크 파일 유형입니다. |
| [FileTypePage](#FileTypePage) | 페이지 파일 형식. |
| [FileTypeReducedImage](#FileTypeReducedImage) | 축소된 이미지 파일 형식. |
## 메서드
