...
description: "샘플 형식 열거형"
type: docs
weight: 24
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tiffsampleformats/
---
...
| 필드 | 설명 |
| --- | --- |
| [ComplexIeeeFp](#ComplexIeeeFp) | 복합 ieee 부동소수점 |
| [ComplexInt](#ComplexInt) | 복합 부호 있는 정수 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IeeeFp](#IeeeFp) | IEEE 부동소수점 데이터 |
| [Int](#Int) | 부호 있는 정수 데이터 |
| [Uint](#Uint) | 부호 없는 정수 데이터 |
| [Void](#Void) | 형식이 지정되지 않은 데이터 |
## 메서드
