...
description: "이미지 방향. ORIENTATION 태그의 가능한 값들."
type: docs
weight: 19
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tifforientations/
---
...
ORIENTATION 태그의 가능한 값.
## 필드

| 필드 | 설명 |
| --- | --- |
| [BottomLeft](#BottomLeft) | 행 0 하단, 열 0 좌측. |
| [BottomRight](#BottomRight) | 행 0 하단, 열 0 우측. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LeftBottom](#LeftBottom) | 행 0 좌측, 열 0 하단. |
| [LeftTop](#LeftTop) | 행 0 좌측, 열 0 상단. |
| [RightBottom](#RightBottom) | 행 0 우측, 열 0 하단. |
| [RightTop](#RightTop) | 행 0 우측, 열 0 상단. |
| [TopLeft](#TopLeft) | 행 0 상단, 열 0 좌측. |
| [TopRight](#TopRight) | 행 0 상단, 열 0 우측. |
## 메서드
