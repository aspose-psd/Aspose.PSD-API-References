...
description: "스토리지 구성. PLANARCONFIG 태그의 가능한 값들."
type: docs
weight: 21
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tiffplanarconfigs/
---
...
PLANARCONFIG 태그에 대한 가능한 값들.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Contiguous](#Contiguous) | 단일 이미지 평면. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Separate](#Separate) | 데이터의 개별 평면. |
## 메서드
