...
description: "tiff 이미지의 바이트 순서"
type: docs
weight: 12
url: /ko/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
| 필드 | 설명 |
| --- | --- |
| [BigEndian](#BigEndian) | 빅 엔디안 바이트 순서 (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | 리틀 엔디안 바이트 순서 (Intel). |
## 메서드
