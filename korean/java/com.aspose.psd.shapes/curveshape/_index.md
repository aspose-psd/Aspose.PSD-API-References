...
description: "곡선 스플라인 형태를 나타냅니다."
type: docs
weight: 12
url: /ko/java/com.aspose.psd.shapes/curveshape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [CurveShape()](#CurveShape--) | CurveShape 클래스의 새 인스턴스를 초기화합니다. |
| [CurveShape(PointF[] points)](#CurveShape-com.aspose.psd.PointF---) | CurveShape 클래스의 새 인스턴스를 초기화합니다. |
| [CurveShape(PointF[] points, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---boolean-) | CurveShape 클래스의 새 인스턴스를 초기화합니다. |
| [CurveShape(PointF[] points, float tension)](#CurveShape-com.aspose.psd.PointF---float-) | CurveShape 클래스의 새 인스턴스를 초기화합니다. |
| [CurveShape(PointF[] points, float tension, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---float-boolean-) | CurveShape 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getTension()](#getTension--) | 곡선 장력을 가져오거나 설정합니다. |
...
| [setTension(float value)](#setTension-float-) | 곡선 장력을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
