...
description: "타원 형태를 나타냅니다."
type: docs
weight: 13
url: /ko/java/com.aspose.psd.shapes/ellipseshape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [EllipseShape()](#EllipseShape--) | EllipseShape 클래스의 새 인스턴스를 초기화합니다. |
| [EllipseShape(RectangleF rectangle)](#EllipseShape-com.aspose.psd.RectangleF-) | EllipseShape 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
EllipseShape 클래스의 새 인스턴스를 초기화합니다.
