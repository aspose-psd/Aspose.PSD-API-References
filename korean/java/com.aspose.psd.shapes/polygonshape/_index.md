...
description: "다각형 형태를 나타냅니다."
type: docs
weight: 15
url: /ko/java/com.aspose.psd.shapes/polygonshape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PolygonShape()](#PolygonShape--) | PolygonShape 클래스의 새 인스턴스를 초기화합니다. |
| [PolygonShape(PointF[] points)](#PolygonShape-com.aspose.psd.PointF---) | PolygonShape 클래스의 새 인스턴스를 초기화합니다. |
| [PolygonShape(PointF[] points, boolean isClosed)](#PolygonShape-com.aspose.psd.PointF---boolean-) | PolygonShape 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
PolygonShape 클래스의 새 인스턴스를 초기화합니다.
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | 점 배열입니다. |
| isClosed | boolean | true 로 설정하면 다각형이 닫힙니다. |
