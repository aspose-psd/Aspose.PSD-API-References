...
description: "직사각형 형태를 나타냅니다."
type: docs
weight: 17
url: /ko/java/com.aspose.psd.shapes/rectangleshape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | RectangleShape 클래스의 새 인스턴스를 초기화합니다. |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.psd.RectangleF-) | RectangleShape 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
RectangleShape 클래스의 새 인스턴스를 초기화합니다.
