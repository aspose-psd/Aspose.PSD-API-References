...
description: "파이 형태를 나타냅니다."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.shapes/pieshape/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PieShape()](#PieShape--) | PieShape 클래스의 새 인스턴스를 초기화합니다. |
| [PieShape(RectangleF rectangle, float startAngle, float sweepAngle)](#PieShape-com.aspose.psd.RectangleF-float-float-) | PieShape 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
