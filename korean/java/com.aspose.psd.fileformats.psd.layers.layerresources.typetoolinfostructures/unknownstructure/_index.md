...
description: "알 수 없는 구조."
type: docs
weight: 30
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [getTypeName_internalized()](#getTypeName-internalized--) | 구조의 읽을 수 있는 유형 이름을 가져옵니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
[UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) 클래스의 새 인스턴스를 초기화합니다.
