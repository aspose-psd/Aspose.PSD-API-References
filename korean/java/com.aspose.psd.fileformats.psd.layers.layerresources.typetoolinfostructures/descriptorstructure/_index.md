...
description: "디스크립터 구조"
type: docs
weight: 13
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [DescriptorStructure(ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#DescriptorStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 새 인스턴스를 초기화합니다 [DescriptorStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure) 클래스. |
## 필드
...
| [getStructures()](#getStructures--) | 구조를 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 구조를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [DescriptorStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure) 클래스.
