...
type: docs
weight: 26
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [StringStructure(ClassID keyName)](#StringStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 새 인스턴스를 초기화합니다 [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure) 클래스. |
## 필드
...
| [setValue(String value)](#setValue-java.lang.String-) | 값을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
새 인스턴스를 초기화합니다 [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure) 클래스.
