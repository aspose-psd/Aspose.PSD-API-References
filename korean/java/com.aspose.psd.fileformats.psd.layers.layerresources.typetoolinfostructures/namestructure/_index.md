...
description: "Name 구조 키 0x6E616D65는 ASCII에서 name을 나타내며, 레이어 경로나 조정과 같은 요소의 이름을 나타내는 Unicode 또는 Pascal 스타일 문자열을 저장하는 간단한 구조입니다."
type: docs
weight: 19
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
Name 구조(key: 0x6E616D65, ASCII에서 "name"을 의미)는 레이어, 경로 또는 조정과 같은 요소의 이름을 나타내는 유니코드 또는 파스칼 스타일 문자열을 저장하는 데 사용되는 간단한 구조입니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) 클래스를 새 인스턴스로 초기화합니다. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [StructureKey](#StructureKey) | Name 구조 키. |
## 메서드
...
| [getValue()](#getValue--) | Name 구조의 값을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Name 구조의 첫 번째 문자열 값을 가져오거나 설정합니다. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Name 구조의 값을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) 클래스를 새 인스턴스로 초기화합니다.
...
Name 구조의 첫 번째 문자열 값을 가져오거나 설정합니다. 일반적으로 줄 끝 기호를 포함합니다.
