...
type: docs
weight: 22
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [PathStructure(ClassID keyName)](#PathStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | [PathStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [getPath()](#getPath--) | 경로를 가져오거나 설정합니다. |
...
| [getPrefix()](#getPrefix--) | 경로 접두사를 가져오거나 설정합니다. |
...
| [setPath(String value)](#setPath-java.lang.String-) | 경로를 가져오거나 설정합니다. |
...
| [setPrefix(String value)](#setPrefix-java.lang.String-) | 경로 접두사를 가져오거나 설정합니다. |
...
[PathStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure) 클래스의 새 인스턴스를 초기화합니다.
