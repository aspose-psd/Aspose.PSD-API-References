...
description: "열거형 참조 구조."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 새 인스턴스를 초기화합니다 [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) 클래스. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | 구조 키를 식별합니다. |
| [StructureKey](#StructureKey) | 열거형 디스크립터 키. |
## 메서드
...
| [getEnumName()](#getEnumName--) | 열거형 이름을 가져오거나 설정합니다. |
...
| [getTypeID()](#getTypeID--) | 유형 ID를 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 열거형 이름을 가져오거나 설정합니다. |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 유형 ID를 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
새 인스턴스를 초기화합니다 [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) 클래스.
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | 유형 ID. |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | 열거형 이름. |
