...
type: docs
weight: 28
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) 클래스를 새 인스턴스로 초기화합니다. |
## 필드
...
| [getUnitType()](#getUnitType--) | 단위 유형을 가져오거나 설정합니다. |
...
| [setUnitType(int value)](#setUnitType-int-) | 단위 유형을 가져오거나 설정합니다. |
| [setValue(double value)](#setValue-double-) | 값을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) 클래스를 새 인스턴스로 초기화합니다.
