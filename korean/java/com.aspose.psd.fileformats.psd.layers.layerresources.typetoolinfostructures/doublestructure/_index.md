...
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [DoubleStructure(ClassID keyName)](#DoubleStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 새 인스턴스를 초기화합니다 [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) 클래스. |
## 필드
...
| [getValue()](#getValue--) | double 값을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(double value)](#setValue-double-) | double 값을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
새 인스턴스를 초기화합니다 [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) 클래스.
