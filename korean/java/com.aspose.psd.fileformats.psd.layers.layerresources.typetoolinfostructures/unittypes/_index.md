...
type: docs
weight: 29
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes/
---
...
| --- | --- |
| [Angle](#Angle) | 각도 단위. |
| [Density](#Density) | 밀도 단위. |
| [Distance](#Distance) | 거리 단위. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Millimeters](#Millimeters) | 밀리미터 단위. |
| [None](#None) | 정의되지 않은 단위. |
| [Percent](#Percent) | 퍼센트 단위. |
| [Pixels](#Pixels) | 픽셀 단위. |
| [Points](#Points) | 포인트 단위. |
## 메서드
