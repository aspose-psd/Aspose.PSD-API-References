...
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 새 인스턴스를 초기화합니다 [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) 클래스. |
## 필드
...
| [getDataLength()](#getDataLength--) | 바이트 단위의 정확한 데이터 길이를 가져옵니다. |
| [getFullPath()](#getFullPath--) | 전체 경로를 가져오거나 설정합니다. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | 전체 경로를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) 클래스.
