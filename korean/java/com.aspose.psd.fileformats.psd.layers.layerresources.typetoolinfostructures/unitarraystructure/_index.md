...
description: "double 값 배열과 해당 측정 단위를 보유하는 UnitArrayStructure 클래스를 정의합니다."
type: docs
weight: 27
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
double 값 배열과 해당 측정 단위를 보유하는 UnitArrayStructure 클래스를 정의합니다. 이 클래스는 PSD 파일 리소스에서 사용되며, 일반적으로 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure)에 의해 사용됩니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 클래스를 새 인스턴스로 초기화합니다. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [StructureKey](#StructureKey) | ‘UnFl’ [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 키를 정의합니다. |
## 메서드
...
| [getKey()](#getKey--) | 이 단위 배열 구조 키를 가져옵니다. |
...
| [getUnitType()](#getUnitType--) | [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 값의 측정 단위 유형을 가져오거나 설정합니다. |
| [getValueCount()](#getValueCount--) | 값 개수를 가져옵니다. |
| [getValues()](#getValues--) | 단위 배열 구조 값을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 값의 측정 단위 유형을 가져오거나 설정합니다. |
| [setValues(double[] value)](#setValues-double---) | 단위 배열 구조 값을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
[UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 클래스를 새 인스턴스로 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | 키의 이름. |
| unitType | int | 단위 유형. |
| 값들 | double[] | 값들. |
...
‘UnFl’ [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 키를 정의합니다.
...
[UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 값의 측정 단위 유형을 가져오거나 설정합니다.
