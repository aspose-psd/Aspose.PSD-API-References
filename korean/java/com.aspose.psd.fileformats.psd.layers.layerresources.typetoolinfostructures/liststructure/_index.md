...
type: docs
weight: 18
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [ListStructure(ClassID keyName)](#ListStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 새 인스턴스를 초기화합니다 [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) 클래스. |
## 필드
...
| [getItemsCount()](#getItemsCount--) | 항목 수를 가져옵니다. |
...
| [getTypes()](#getTypes--) | 형식을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTypes(OSTypeStructure[] value)](#setTypes-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 형식을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
새 인스턴스를 초기화합니다 [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) 클래스.
