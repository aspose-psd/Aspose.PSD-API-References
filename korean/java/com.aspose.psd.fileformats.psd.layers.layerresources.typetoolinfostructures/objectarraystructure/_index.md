...
description: "ObjectArrayStructure 클래스를 정의합니다. 일반적으로 배열을 보유합니다."
type: docs
weight: 20
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
ObjectArrayStructure 클래스를 정의합니다. 일반적으로 [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) 배열을 보유합니다. PSD 파일 리소스, 예를 들어 PlLd Resource 및 SoLd Resource에서 사용됩니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 새 인스턴스를 초기화합니다 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 클래스. |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 새 인스턴스를 초기화합니다 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 클래스. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [StructureKey](#StructureKey) | 'ObAr' 구조 키를 식별합니다. |
## 메서드
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | object array 클래스 ID를 가져오거나 설정합니다. |
| [getClassName()](#getClassName--) | object array 클래스 이름을 가져오거나 설정합니다. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | 구조 목록을 가져옵니다. |
| [getKey()](#getKey--) | object array 구조 키를 가져옵니다. |
| [getKeyName()](#getKeyName--) | 키 이름을 가져오거나 설정합니다. |
| [getLength()](#getLength--) | OSTypeStructure의 길이를 바이트 단위로 가져옵니다. |
...
| [getStructureCount()](#getStructureCount--) | object array 하위 구조 개수를 가져옵니다. |
| [getStructures()](#getStructures--) | object array 구조의 하위 구조를 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | object array 클래스 ID를 가져오거나 설정합니다. |
| [setClassName(String value)](#setClassName-java.lang.String-) | object array 클래스 이름을 가져오거나 설정합니다. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | object array 구조의 하위 구조를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) 클래스.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| keyName | java.lang.String | 키의 이름. |
| classIdName | java.lang.String | 클래스 식별자의 이름. |
| structures | [OSTypeStructure\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | 구조들. |
...
object array 클래스 ID를 가져오거나 설정합니다.

값: object array 클래스 ID.
...
object array 클래스 이름을 가져오거나 설정합니다.
...
OSTypeStructure의 길이를 바이트 단위로 가져옵니다.
...
object array 하위 구조 개수를 가져옵니다.

값: 객체 배열 구조에서 하위 구조 개수.
...
object array 구조의 하위 구조를 가져오거나 설정합니다.
