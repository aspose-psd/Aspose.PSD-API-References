...
description: "데이터 복구 모드."
type: docs
weight: 37
url: /ko/java/com.aspose.psd/datarecoverymode/
---
...
| 필드 | 설명 |
| --- | --- |
| [ConsistentRecover](#ConsistentRecover) | 일관된 복구 모드는 손상이 파일 형식을 깨뜨리지 않는 한 모든 데이터를 복구하려고 시도하며 올바른 후속 처리를 가능하게 합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MaximalRecover](#MaximalRecover) | 최대 복구 모드는 파일 형식에 손상된 구조가 있더라도 모든 데이터를 복구하며, 이후 처리는 예상치 못한 영향을 초래할 수 있습니다. |
| [None](#None) | 데이터 복구가 암시되지 않습니다. |
## 메서드
...
일관된 복구 모드는 손상이 파일 형식을 깨뜨리지 않는 한 모든 데이터를 복구하려고 시도하며 올바른 후속 처리를 가능하게 합니다.
...
최대 복구 모드는 파일 형식에 손상된 구조가 있더라도 모든 데이터를 복구하며, 이후 처리는 예상치 못한 영향을 초래할 수 있습니다.
...
데이터 복구가 암시되지 않습니다. 파일 형식에 손상된 데이터가 있을 경우 적절한 예외가 발생합니다.
