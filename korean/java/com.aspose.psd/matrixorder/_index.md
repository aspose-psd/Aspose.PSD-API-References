...
description: "행렬 변환 작업의 순서를 지정합니다."
type: docs
weight: 70
url: /ko/java/com.aspose.psd/matrixorder/
---
...
| 필드 | 설명 |
| --- | --- |
| [Append](#Append) | 새 작업은 이전 작업 뒤에 적용됩니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Prepend](#Prepend) | 새 작업은 이전 작업보다 먼저 적용됩니다. |
## 메서드
