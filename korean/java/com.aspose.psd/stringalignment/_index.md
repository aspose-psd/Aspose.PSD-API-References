...
description: "텍스트 문자열을 레이아웃 사각형에 상대적으로 정렬하는 방식을 지정합니다."
type: docs
weight: 104
url: /ko/java/com.aspose.psd/stringalignment/
---
...
텍스트 문자열을 레이아웃 사각형에 상대적으로 정렬하는 방식을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Center](#Center) | 텍스트가 레이아웃 사각형의 중앙에 정렬됨을 지정합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Far](#Far) | 텍스트가 레이아웃 사각형의 원점 위치에서 멀리 정렬됨을 지정합니다. |
| [Near](#Near) | 텍스트가 레이아웃에 가깝게 정렬됨을 지정합니다. |
## 메서드
...
텍스트가 레이아웃 사각형의 원점 위치에서 멀리 정렬되도록 지정합니다. 왼쪽에서 오른쪽으로 진행하는 레이아웃에서는 멀리 위치가 오른쪽이며, 오른쪽에서 왼쪽으로 진행하는 레이아웃에서는 멀리 위치가 왼쪽입니다.
...
텍스트가 레이아웃에 가깝게 정렬되도록 지정합니다. 왼쪽에서 오른쪽으로 진행하는 레이아웃에서는 가까운 위치가 왼쪽이며, 오른쪽에서 왼쪽으로 진행하는 레이아웃에서는 가까운 위치가 오른쪽입니다.
