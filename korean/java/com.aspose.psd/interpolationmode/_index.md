...
description: "com.aspose.psd.InterpolationMode 열거형은 이미지가 확대되거나 회전될 때 사용되는 알고리즘을 지정합니다."
type: docs
weight: 63
url: /ko/java/com.aspose.psd/interpolationmode/
---
...
The  com.aspose.psd.InterpolationMode  열거형은 이미지가 확대되거나 회전될 때 사용되는 알고리즘을 지정합니다.
## 필드
...
바이큐빅 보간을 지정합니다. 사전 필터링이 수행되지 않습니다. 이 모드는 이미지 크기를 원본 크기의 25% 이하로 축소할 때 적합하지 않습니다.
...
양선형 보간을 지정합니다. 사전 필터링이 수행되지 않습니다. 이 모드는 이미지 크기를 원본 크기의 50% 이하로 축소할 때 적합하지 않습니다.
