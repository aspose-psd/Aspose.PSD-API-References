...
description: "이 열거형은 사용자의 로케일 또는 언어에 따라 문자열의 숫자를 대체하는 방법을 지정합니다."
type: docs
weight: 105
url: /ko/java/com.aspose.psd/stringdigitsubstitute/
---
...
열거형은 사용자의 로케일 또는 언어에 따라 문자열의 숫자를 대체하는 방법을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [National](#National) | 사용자 로케일의 공식 국가 언어에 해당하는 대체 숫자를 지정합니다. |
| [None](#None) | 대체를 비활성화하도록 지정합니다. |
| [Traditional](#Traditional) | 사용자 로케일의 공식 국가 언어와 다를 수 있는 사용자의 고유 스크립트 또는 언어에 해당하는 대체 숫자를 지정합니다. |
| [User](#User) | 사용자 정의 대체 방식을 지정합니다. |
## 메서드
...
사용자 로케일의 공식 국가 언어에 해당하는 대체 숫자를 지정합니다.
...
사용자 로케일의 공식 국가 언어와 다를 수 있는 사용자의 고유 스크립트 또는 언어에 해당하는 대체 숫자를 지정합니다.
