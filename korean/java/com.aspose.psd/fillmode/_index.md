...
description: "닫힌 경로 내부가 어떻게 채워지는지 지정합니다."
type: docs
weight: 45
url: /ko/java/com.aspose.psd/fillmode/
---
...
닫힌 경로 내부가 어떻게 채워지는지 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Alternate](#Alternate) | 대체 채우기 모드를 지정합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Winding](#Winding) | 와인딩 채우기 모드를 지정합니다. |
## 메서드
