...
description: "출력 파일에 대한 PDF 호환성 수준을 지정합니다."
type: docs
weight: 76
url: /ko/java/com.aspose.psd/pdfcomplianceversion/
---
...
출력 파일에 대한 PDF 호환성 수준을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pdf15](#Pdf15) | 출력 파일은 PDF 1.5 규격을 준수합니다. |
| [PdfA1a](#PdfA1a) | 출력 파일은 PDF/A-1a 규격을 준수합니다. |
| [PdfA1b](#PdfA1b) | 출력 파일은 PDF/A-1b 규격을 준수합니다. |
## 메서드
