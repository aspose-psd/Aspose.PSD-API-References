...
description: "CMYK 시안 마젠타 옐로우 블랙 색 공간의 개별 채널을 지정합니다."
type: docs
weight: 22
url: /ko/java/com.aspose.psd/colorchannelflag/
---
...
CMYK(시안, 마젠타, 옐로우, 블랙) 색 공간의 개별 채널을 지정합니다. 이 열거형은 SetOutputChannel 메서드에서 사용됩니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [ColorChannelC](#ColorChannelC) | 시안 색 채널. |
| [ColorChannelK](#ColorChannelK) | 블랙 색 채널. |
| [ColorChannelLast](#ColorChannelLast) | 마지막으로 선택된 채널을 사용해야 합니다. |
| [ColorChannelM](#ColorChannelM) | 마젠타 색 채널. |
| [ColorChannelY](#ColorChannelY) | 노란색 채널. |
