...
description: "Pen 객체로 그린 점선 스타일을 지정합니다."
type: docs
weight: 36
url: /ko/java/com.aspose.psd/dashstyle/
---
...
Pen 객체로 그린 점선의 스타일을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Custom](#Custom) | 사용자 정의 맞춤 점선 스타일을 지정합니다. |
| [Dash](#Dash) | 대시로 구성된 선을 지정합니다. |
| [DashDot](#DashDot) | 대시-점 반복 패턴으로 구성된 선을 지정합니다. |
| [DashDotDot](#DashDotDot) | 대시-점-점 반복 패턴으로 구성된 선을 지정합니다. |
| [Dot](#Dot) | 점으로 구성된 선을 지정합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Solid](#Solid) | 실선을 지정합니다. |
## 메서드
