...
description: "진행 이벤트 처리기 함수 참조"
type: docs
weight: 84
url: /ko/java/com.aspose.psd/progresseventhandler/
---
...
| [hashCode()](#hashCode--) |  |
| [invoke(ProgressEventHandlerInfo info)](#invoke-com.aspose.psd.progressmanagement.ProgressEventHandlerInfo-) | 진행 이벤트 처리기 함수 참조 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| 콜백 | com.aspose.ms.System.AsyncCallback |  |
| 상태 | java.lang.Object |  |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 결과 | com.aspose.ms.System.IAsyncResult |  |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| info | [ProgressEventHandlerInfo](../../com.aspose.psd.progressmanagement/progresseventhandlerinfo) | 진행 상황 이벤트 처리기 데이터. |
