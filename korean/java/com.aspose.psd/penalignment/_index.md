...
description: "Pen 객체의 정렬을 이론적인 무폭선과의 관계에서 지정합니다."
type: docs
weight: 78
url: /ko/java/com.aspose.psd/penalignment/
---
...
Pen 객체의 정렬을 이론적인 무폭 폭선에 대해 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Center](#Center) | Pen 객체가 이론적인 선 위에 중앙에 배치되도록 지정합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inset](#Inset) | Pen이 이론적인 선 안쪽에 배치되도록 지정합니다. |
| [Left](#Left) | Pen이 이론적인 선 왼쪽에 배치되도록 지정합니다. |
| [Outset](#Outset) | Pen이 이론적인 선 바깥쪽에 배치되도록 지정합니다. |
| [Right](#Right) | Pen이 이론적인 선 오른쪽에 배치되도록 지정합니다. |
## 메서드
...
Pen 객체가 이론적인 선 위에 중앙에 배치되도록 지정합니다.
