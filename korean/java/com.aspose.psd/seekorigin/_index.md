...
description: "StreamContainer에서 탐색을 위한 기준점을 나타내는 필드를 제공합니다."
type: docs
weight: 95
url: /ko/java/com.aspose.psd/seekorigin/
---
...
스트림 컨테이너에서 탐색을 위한 StreamContainer의 기준점을 나타내는 필드를 제공합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Begin](#Begin) | 스트림의 시작을 지정합니다. |
| [Current](#Current) | 스트림 내 현재 위치를 지정합니다. |
| [End](#End) | 스트림의 끝을 지정합니다. |
