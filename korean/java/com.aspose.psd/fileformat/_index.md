...
description: "지원되는 PSD 파일 형식 중 하나."
type: docs
weight: 43
url: /ko/java/com.aspose.psd/fileformat/
---
...
| 필드 | 설명 |
| --- | --- |
| [Ai](#Ai) | Adobe Illustrator 형식 |
| [Bmp](#Bmp) | Bmp (Dib) 파일 형식. |
| [Cdr](#Cdr) | CDR 파일 형식 |
| [Cmx](#Cmx) | CMX 파일 형식 |
| [Custom](#Custom) | 사용자 정의 파일 형식. |
| [Dicom](#Dicom) | dicom 형식 |
| [Djvu](#Djvu) | Djvu 파일 형식 |
| [Dng](#Dng) | DNG 파일 형식 |
| [Emf](#Emf) | Emf/Emf+ 파일 형식 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Eps](#Eps) | Encapsulated PostScript 형식 |
| [Gif](#Gif) | Gif 파일 형식. |
| [Jpeg](#Jpeg) | Jpeg 파일 형식. |
| [Jpeg2000](#Jpeg2000) | Jpeg2000 파일 형식 |
| [Odg](#Odg) | Open document graphic 형식 |
| [Otg](#Otg) | otg 파일 형식 |
| [Png](#Png) | Png 파일 형식. |
| [Psd](#Psd) | Psd 파일 형식. |
| [Svg](#Svg) | SVG 파일 형식 |
| [Tiff](#Tiff) | Tiff 파일 형식. |
| [Undefined](#Undefined) | 정의되지 않은 파일 형식. |
| [Webp](#Webp) | webp 파일 형식 |
| [Wmf](#Wmf) | Wmf 파일 형식 |
## 메서드
