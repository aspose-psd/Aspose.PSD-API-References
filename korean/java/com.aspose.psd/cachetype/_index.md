...
description: "사용할 캐시 유형을 지정합니다."
type: docs
weight: 15
url: /ko/java/com.aspose.psd/cachetype/
---
...
| 필드 | 설명 |
| --- | --- |
| [Auto](#Auto) | 자동 캐시 유형을 지정합니다. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | 메모리 내 캐시만 사용합니다. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | 디스크 캐시만 사용합니다. |
...
자동 캐시 유형을 지정합니다. 자동 캐시 방식은 먼저 메모리 내에 캐시를 시도하고, 그 다음 디스크에 캐시합니다.
