...
type: docs
weight: 40
url: /ko/java/com.aspose.psd/ditheringmethod/
---
...
| [FloydSteinbergDithering](#FloydSteinbergDithering) | 그 Floyd-Steinberg 디더링. |
| [ThresholdDithering](#ThresholdDithering) | 임계값 디더링. |
## 메서드
...
그 Floyd-Steinberg 디더링. 보다 복잡한 디더링 알고리즘으로, 가장 가까운 이웃의 강도 값을 사용합니다.
