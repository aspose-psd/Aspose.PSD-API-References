...
description: "색상 변환을 제어하는 데 사용되는 디더링 방법들."
type: docs
weight: 41
url: /ko/java/com.aspose.psd/ditheringmethods/
---
...
색상 변환을 제어하는 데 사용되는 디더링 방법들.
## 필드

| 필드 | 설명 |
| --- | --- |
| [CustomConverter](#CustomConverter) | 사용자 지정 변환기. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | 팔레트를 무시하지 않으며 적절한 색 변환을 적용해야 합니다. |
| [PaletteIgnore](#PaletteIgnore) | 팔레트를 무시합니다. |
## 메서드
...
팔레트를 무시하지 않으며 적절한 색 변환을 적용해야 합니다.
