...
description: "사용할 이미지 필터"
type: docs
weight: 58
url: /ko/java/com.aspose.psd/imagefiltertype/
---
...
| 필드 | 설명 |
| --- | --- |
| [BigRectangular](#BigRectangular) | 큰 직사각형 필터 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | 필터가 사용되지 않음 |
| [SmallRectangular](#SmallRectangular) | 작은 직사각형 필터 |
## 메서드
