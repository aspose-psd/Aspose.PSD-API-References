...
description: "래스터 그래픽 작업을 지원하는 래스터 이미지를 나타냅니다."
type: docs
weight: 86
url: /ko/java/com.aspose.psd/rasterimage/
---
...
| [crop(Rectangle rectangle)](#crop-com.aspose.psd.Rectangle-) | 지정된 사각형을 자릅니다. |
...
| [resize(int newWidth, int newHeight, ImageResizeSettings settings)](#resize-int-int-com.aspose.psd.ImageResizeSettings-) | 이미지를 확장 옵션으로 크기 조정합니다. |
...
**Returns:**
boolean - 이 인스턴스에 알파가 있으면 true, 그렇지 않으면 false.
