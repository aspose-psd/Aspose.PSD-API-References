...
description: "GraphicsPath 객체에 포함된 도형 서브패스에서 연속적인 선 또는 곡선 세그먼트를 연결하는 방법을 지정합니다."
type: docs
weight: 67
url: /ko/java/com.aspose.psd/linejoin/
---
...
GraphicsPath 객체에 포함된 도형(하위 경로)에서 연속적인 선 또는 곡선 세그먼트를 연결하는 방법을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Bevel](#Bevel) | 베벨 조인을 지정합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Miter](#Miter) | 마이터 조인을 지정합니다. |
| [MiterClipped](#MiterClipped) | 마이터 조인을 지정합니다. |
| [Round](#Round) | 원형 조인을 지정합니다. |
## 메서드
...
베벨 조인을 지정합니다. 이는 대각선 모서리를 생성합니다.
...
마이터 조인을 지정합니다. 마이터 길이가 마이터 제한을 초과하는지 여부에 따라 날카로운 모서리 또는 잘린 모서리를 생성합니다.
...
마이터 조인을 지정합니다. 마이터 길이가 마이터 제한을 초과하는지 여부에 따라 날카로운 모서리 또는 베벨 모서리를 생성합니다.
...
원형 조인을 지정합니다. 이는 선 사이에 부드러운 원형 호를 생성합니다.
