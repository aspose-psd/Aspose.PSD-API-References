...
description: "스트림을 포함하고 스트림 처리 루틴을 제공하는 분할 스트림 컨테이너를 나타냅니다."
type: docs
weight: 102
url: /ko/java/com.aspose.psd/splitstreamcontainer/
---
...
| 생성자 | 설명 |
| --- | --- |
| [SplitStreamContainer(InputStream stream)](#SplitStreamContainer-java.io.InputStream-) | [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) 클래스의 새 인스턴스를 초기화합니다. |
| [SplitStreamContainer(InputStream stream, boolean disposeStream)](#SplitStreamContainer-java.io.InputStream-boolean-) | [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) 클래스의 새 인스턴스를 초기화합니다. |
| [SplitStreamContainer(StreamContainer stream, boolean disposeStream)](#SplitStreamContainer-com.aspose.psd.StreamContainer-boolean-) | [SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [hashCode()](#hashCode--) |  |
| [insert(int position, StreamContainer stream, boolean disposeStream)](#insert-int-com.aspose.psd.StreamContainer-boolean-) | 스트림 컨테이너를 지정된 위치에 삽입합니다. |
...
| [save(OutputStream dstStream, int bufferSize, long length)](#save-java.io.OutputStream-int-long-) | 스트림의 데이터를 지정된 스트림에 저장(복사)합니다. |
...
[SplitStreamContainer](../../com.aspose.psd/splitstreamcontainer) 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| stream | [StreamContainer](../../com.aspose.psd/streamcontainer) | 스트림 컨테이너입니다. |
| disposeStream | boolean | true 로 설정하면 스트림을 해제합니다. |
...
| --- | --- | --- |
| position | int | 삽입할 위치. |
| stream | [StreamContainer](../../com.aspose.psd/streamcontainer) | 삽입할 스트림 컨테이너. |
| disposeStream | boolean | true 로 설정하면 스트림을 해제합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| dstStream | java.io.OutputStream | 데이터를 저장할 스트림. |
| bufferSize | int | 버퍼 크기입니다. 기본값으로 [StreamContainer.READ\_WRITE\_BYTES\_COUNT](../../com.aspose.psd/streamcontainer\#READ-WRITE-BYTES-COUNT) 값을 사용합니다. |
| length | long | 복사할 스트림 데이터 길이입니다. 기본적으로 길이는  Length ([StreamContainer.getLength()](../../com.aspose.psd/streamcontainer\#getLength--)/[StreamContainer.setLength(long)](../../com.aspose.psd/streamcontainer\#setLength-long-)) 값으로 설정됩니다. |
...
| origin | int | 새 위치를 얻기 위해 사용되는 기준점을 나타내는 [SeekOrigin](../../com.aspose.psd/seekorigin) 타입의 값입니다. |
