...
description: "점선의 각 대시 양쪽 끝에 사용할 그래픽 형태의 유형을 지정합니다."
type: docs
weight: 35
url: /ko/java/com.aspose.psd/dashcap/
---
...
점선의 각 대시 양쪽 끝에 사용할 그래픽 형태의 유형을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Flat](#Flat) | 각 대시의 양쪽 끝을 정사각형으로 만드는 사각 캡을 지정합니다. |
| [Round](#Round) | 각 대시의 양쪽 끝을 둥글게 만드는 원형 캡을 지정합니다. |
| [Triangle](#Triangle) | 각 대시의 양쪽 끝을 뾰족하게 만드는 삼각형 캡을 지정합니다. |
## 메서드
...
각 대시의 양쪽 끝을 정사각형으로 만드는 사각 캡을 지정합니다.
...
각 대시의 양쪽 끝을 둥글게 만드는 원형 캡을 지정합니다.
...
각 대시의 양쪽 끝을 뾰족하게 만드는 삼각형 캡을 지정합니다.
