...
description: "텍스처 또는 그라디언트가 채워지는 영역보다 작을 때 어떻게 타일링되는지 지정합니다."
type: docs
weight: 113
url: /ko/java/com.aspose.psd/wrapmode/
---
...
텍스처 또는 그라디언트가 채워지는 영역보다 작을 때 어떻게 타일링되는지 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Clamp](#Clamp) | 텍스처 또는 그라디언트가 타일링되지 않습니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Tile](#Tile) | 그라디언트 또는 텍스처를 타일링합니다. |
| [TileFlipX](#TileFlipX) | 텍스처 또는 그라디언트를 수평으로 뒤집은 다음 타일링합니다. |
| [TileFlipXY](#TileFlipXY) | 텍스처 또는 그라디언트를 수평 및 수직으로 뒤집은 다음 타일링합니다. |
| [TileFlipY](#TileFlipY) | 텍스처 또는 그라디언트를 수직으로 뒤집은 다음 타일링합니다. |
## 메서드
...
텍스처 또는 그라디언트를 수평으로 뒤집은 다음 타일링합니다.
...
텍스처 또는 그라디언트를 수평 및 수직으로 뒤집은 다음 타일링합니다.
...
텍스처 또는 그라디언트를 수직으로 뒤집은 다음 타일링합니다.
