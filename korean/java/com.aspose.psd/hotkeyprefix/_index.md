...
description: "텍스트와 관련된 단축키 접두사의 표시 유형을 지정합니다."
type: docs
weight: 53
url: /ko/java/com.aspose.psd/hotkeyprefix/
---
...
텍스트와 관련된 단축키 접두사의 표시 유형을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Hide](#Hide) | 핫키 접두사를 표시하지 않습니다. |
| [None](#None) | 핫키 접두사 없음. |
| [Show](#Show) | 핫키 접두사를 표시합니다. |
## 메서드
