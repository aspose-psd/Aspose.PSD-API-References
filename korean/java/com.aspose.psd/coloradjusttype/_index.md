...
description: "어떤 객체가 색상 조정 정보를 사용하는지 지정합니다."
type: docs
weight: 20
url: /ko/java/com.aspose.psd/coloradjusttype/
---
...
어떤 객체가 색상 조정 정보를 사용하는지 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Any](#Any) | 지정된 유형 수. |
| [Bitmap](#Bitmap) | Bitmap 객체에 대한 색상 조정 정보. |
| [Brush](#Brush) | Brush 객체에 대한 색상 조정 정보. |
| [Count](#Count) | 지정된 유형 수. |
| [Default](#Default) | 자체 색상 조정 정보가 없는 모든 GDI+ 객체에서 사용하는 색상 조정 정보. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pen](#Pen) | Pen 객체에 대한 색상 조정 정보. |
| [Text](#Text) | 텍스트에 대한 색상 조정 정보. |
## 메서드
...
자체 색상 조정 정보가 없는 모든 GDI+ 객체에서 사용하는 색상 조정 정보.
