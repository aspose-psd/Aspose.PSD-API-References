...
description: "회전 테스트 모드입니다."
type: docs
weight: 10
url: /ko/java/com.aspose.psd/rastercachedimage.rotatetestmode/
---
...
| 필드 | 설명 |
| --- | --- |
| [ByteArrayMode](#ByteArrayMode) | 바이트 배열 모드 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [RegularMode](#RegularMode) | 일반 모드 |
| [StreamMode](#StreamMode) | 스트림 모드 |
## 메서드
