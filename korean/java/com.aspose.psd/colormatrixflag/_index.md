...
description: "ImageAttributes의 색상 및 그레이스케일 조정 설정에 의해 영향을 받는 이미지 및 색상의 유형을 지정합니다."
type: docs
weight: 26
url: /ko/java/com.aspose.psd/colormatrixflag/
---
...
ImageAttributes의 색상 및 그레이스케일 조정 설정에 영향을 받는 이미지 및 색상 유형을 지정합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [AltGrays](#AltGrays) | 회색 음영만 조정됩니다. |
| [Default](#Default) | 회색 음영을 포함한 모든 색상 값이 동일한 색상 조정 매트릭스에 의해 조정됩니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [SkipGrays](#SkipGrays) | 모든 색상이 조정되지만 회색 음영은 조정되지 않습니다. |
## 메서드
...
회색 음영을 포함한 모든 색상 값이 동일한 색상 조정 매트릭스에 의해 조정됩니다.
...
모든 색상이 조정되지만 회색 음영은 조정되지 않습니다. 회색 음영은 빨강, 초록, 파랑 구성 요소의 값이 동일한 모든 색상입니다.
