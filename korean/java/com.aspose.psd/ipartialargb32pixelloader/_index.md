...
description: "32비트 ARGB 픽셀이 부분적으로 로드되는 것을 준수합니다."
type: docs
weight: 130
url: /ko/java/com.aspose.psd/ipartialargb32pixelloader/
---
```
public interface IPartialArgb32PixelLoader
```

32비트 ARGB 픽셀이 부분적으로 로드되는 것을 준수합니다.
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [process(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#process-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | 로드된 픽셀을 처리합니다. |
