...
description: "레이아웃 형태에 완전히 맞지 않는 문자열에서 문자를 잘라내는 방법을 지정합니다."
type: docs
weight: 108
url: /ko/java/com.aspose.psd/stringtrimming/
---
...
| 필드 | 설명 |
| --- | --- |
| [Character](#Character) | 텍스트가 가장 가까운 문자까지 잘리도록 지정합니다. |
| [EllipsisCharacter](#EllipsisCharacter) | 텍스트가 가장 가까운 문자까지 잘리도록 지정하고, 잘린 줄의 끝에 생략 부호가 삽입됩니다. |
| [EllipsisPath](#EllipsisPath) | 잘린 줄의 가운데 부분이 제거되고 생략 부호로 대체됩니다. |
| [EllipsisWord](#EllipsisWord) | 텍스트가 가장 가까운 단어까지 잘리도록 지정하고, 잘린 줄의 끝에 생략 부호가 삽입됩니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | 잘림이 없도록 지정합니다. |
| [Word](#Word) | 텍스트가 가장 가까운 단어까지 잘리도록 지정합니다. |
## 메서드
...
텍스트가 가장 가까운 문자까지 잘리도록 지정하고, 잘린 줄의 끝에 생략 부호가 삽입됩니다.
...
잘린 줄의 가운데 부분이 제거되고 생략 부호로 대체됩니다. 알고리즘은 가능한 한 줄의 마지막 슬래시 구분 구간을 최대한 유지합니다.
...
텍스트가 가장 가까운 단어까지 잘리도록 지정하고, 잘린 줄의 끝에 생략 부호가 삽입됩니다.
