...
description: "XMP 패키지에 대한 기본 추상화를 나타냅니다."
type: docs
weight: 18
url: /ko/java/com.aspose.psd.xmp/xmppackage/
---
...
XMP 패키지에 대한 기본 추상화를 나타냅니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [XmpPackage(String prefix, String namespaceUri)](#XmpPackage-java.lang.String-java.lang.String-) | XmpPackage 클래스의 새 인스턴스를 초기화합니다. |
## 메서드
...
| [addValue(String key, String value)](#addValue-java.lang.String-java.lang.String-) | 값을 추가합니다. |
...
XmpPackage 클래스의 새 인스턴스를 초기화합니다.
