...
description: "XmpArray에서 배열 유형을 나타냅니다."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.xmp/xmparraytype/
---
...
XmpArray에서 배열 유형을 나타냅니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [ALTERNATIVE](#ALTERNATIVE) | 대체 배열. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ORDERED](#ORDERED) | 정렬된 배열. |
| [UNORDERED](#UNORDERED) | 정렬되지 않은 배열. |
## 메서드
