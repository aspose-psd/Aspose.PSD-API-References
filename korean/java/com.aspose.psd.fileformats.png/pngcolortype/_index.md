...
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.png/pngcolortype/
---
...
| [Grayscale](#Grayscale) | 각 픽셀이 그레이스케일 샘플인 색상 유형을 나타냅니다. |
| [GrayscaleWithAlpha](#GrayscaleWithAlpha) | 각 픽셀이 그레이스케일 샘플에 알파 샘플이 뒤따르는 색상 유형을 나타냅니다. |
| [IndexedColor](#IndexedColor) | 각 픽셀이 팔레트 인덱스인 색상 유형을 나타냅니다; PLTE 청크가 나타나야 합니다. |
| [Truecolor](#Truecolor) | 각 픽셀이 R,G,B 삼중값인 색상 유형을 나타냅니다. |
| [TruecolorWithAlpha](#TruecolorWithAlpha) | 각 픽셀이 R,G,B 삼중값에 알파 샘플이 뒤따르는 색상 유형을 나타냅니다. |
## 메서드
...
각 픽셀이 그레이스케일 샘플에 알파 샘플이 뒤따르는 색상 유형을 나타냅니다.
...
각 픽셀이 팔레트 인덱스인 색상 유형을 나타냅니다; PLTE 청크가 나타나야 합니다.
...
각 픽셀이 R,G,B 삼중값에 알파 샘플이 뒤따르는 색상 유형을 나타냅니다.
