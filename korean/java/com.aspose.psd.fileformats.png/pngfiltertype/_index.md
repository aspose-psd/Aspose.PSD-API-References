...
description: "png 필터 유형."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.fileformats.png/pngfiltertype/
---
...
| 필드 | 설명 |
| --- | --- |
| [Adaptive](#Adaptive) | 적응형 필터링은 저장 과정에서 각 데이터 행에 가장 적합한 필터를 선택함을 의미합니다. |
| [Avg](#Avg) | 평균 필터는 이미지 데이터에 평균 필터를 적용함을 의미합니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | 널 필터는 이미지 데이터 행에 필터링을 적용하지 않음을 의미합니다. |
| [Paeth](#Paeth) | Paeth 예측 필터. |
| [Sub](#Sub) | Sub 필터는 이미지 데이터에 차감 필터링을 적용함을 의미합니다. |
| [Up](#Up) | Up 필터는 행별 차감 필터를 적용함을 의미합니다. |
## 메서드
...
적응형 필터링은 저장 과정에서 각 데이터 행에 가장 적합한 필터를 선택함을 의미합니다. 최고의 압축, 가장 느린 실행 시간.
...
평균 필터는 이미지 데이터에 평균 필터를 적용함을 의미합니다.
...
널 필터는 이미지 데이터 행에 필터링을 적용하지 않음을 의미합니다.
...
Sub 필터는 이미지 데이터에 차감 필터링을 적용함을 의미합니다.
