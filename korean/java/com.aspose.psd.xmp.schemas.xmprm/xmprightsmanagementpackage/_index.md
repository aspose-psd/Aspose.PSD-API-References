...
type: docs
weight: 10
url: /ko/java/com.aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/
---
...
| 생성자 | 설명 |
| --- | --- |
| [XmpRightsManagementPackage()](#XmpRightsManagementPackage--) | 새로운 XmpRightsManagementPackage 클래스 인스턴스를 초기화합니다. |
## 메서드
...
| [setCertificate(String certificate)](#setCertificate-java.lang.String-) | 인증서를 설정합니다. |
| [setMarkedAsRightManagement(boolean value)](#setMarkedAsRightManagement-boolean-) | 권리 관리 콘텐츠로 표시합니다 |
| [setOwners(String[] owners)](#setOwners-java.lang.String---) | 소유자를 설정합니다. |
| [setUsageTerms(LangAlt usageTerms)](#setUsageTerms-com.aspose.psd.xmp.LangAlt-) | 사용 조건을 설정합니다. |
| [setValue(String key, IXmlValue value)](#setValue-java.lang.String-com.aspose.psd.xmp.IXmlValue-) | 값을 설정합니다. |
| [setWebStatement(String webStatementUrl)](#setWebStatement-java.lang.String-) | 웹 진술을 설정합니다. |
...
새로운 XmpRightsManagementPackage 클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | boolean | true 로 설정된 경우, 이는 권리 관리 리소스임을 의미합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| usageTerms | [LangAlt](../../com.aspose.psd.xmp/langalt) | 사용 약관입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| webStatementUrl | java.lang.String | 웹 진술 URL입니다. |
