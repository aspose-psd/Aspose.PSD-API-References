...
description: "알 수 없는 스마트 필터 데이터를 보관하는 클래스입니다."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/unknownsmartfilter/
---
...
알 수 없는 스마트 필터 데이터를 보관하는 클래스입니다.
## 메서드
