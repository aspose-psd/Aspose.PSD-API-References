...
description: "jpeg 파일용 EXIF 데이터 컨테이너."
type: docs
weight: 12
url: /ko/java/com.aspose.psd.exif/jpegexifdata/
---
...
| 생성자 | 설명 |
| --- | --- |
| [JpegExifData()](#JpegExifData--) | JpegExifData 클래스의 새 인스턴스를 초기화합니다. |
| [JpegExifData(TiffDataType[] exifdata)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | JpegExifData 클래스의 새 인스턴스를 배열의 데이터로 초기화합니다. |
| [JpegExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | JpegExifData 클래스의 새 인스턴스를 배열의 데이터로 초기화합니다. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [MaxExifSegmentSize](#MaxExifSegmentSize) | 허용되는 최대 EXIF 세그먼트 크기(바이트)입니다. |
## 메서드
...
| [getBitsPerSample()](#getBitsPerSample--) | 샘플당 비트를 가져오거나 설정합니다. |
...
| [getCompression()](#getCompression--) | 압축을 가져오거나 설정합니다. |
| [getContrast()](#getContrast--) | 대비를 가져오거나 설정합니다. |
| [getCopyright()](#getCopyright--) | 저작권을 가져오거나 설정합니다. |
| [getCustomRendered()](#getCustomRendered--) | 사용자 정의 렌더링을 가져오거나 설정합니다. |
| [getDateTime()](#getDateTime--) | 날짜 및 시간을 가져오거나 설정합니다. |
...
| [getModel()](#getModel--) | 모델을 가져오거나 설정합니다. |
...
| [getPhotometricInterpretation()](#getPhotometricInterpretation--) | 광도 해석을 가져오거나 설정합니다. |
...
| [getPrimaryChromaticities()](#getPrimaryChromaticities--) | 이미지의 세 기본 색상의 색도(chromaticity)를 가져오거나 설정합니다. |
...
| [getReferenceBlackWhite()](#getReferenceBlackWhite--) | 참조 흑백을 가져오거나 설정합니다. |
| [getRelatedSoundFile()](#getRelatedSoundFile--) | 관련 사운드 파일을 가져오거나 설정합니다. |
| [getResolutionUnit()](#getResolutionUnit--) | 해상도 단위를 가져오거나 설정합니다. |
| [getSamplesPerPixel()](#getSamplesPerPixel--) | 픽셀당 샘플 수를 가져오거나 설정합니다. |
...
| [getSoftware()](#getSoftware--) | 소프트웨어를 가져오거나 설정합니다. |
...
| [getThumbnail()](#getThumbnail--) | 썸네일 이미지를 가져오거나 설정합니다. |
| [getTransferFunction()](#getTransferFunction--) | 전송 함수를 가져오거나 설정합니다. |
...
| [getYCbCrCoefficients()](#getYCbCrCoefficients--) | RGB에서 YCbCr 이미지 데이터로 변환하기 위한 매트릭스 계수를 가져오거나 설정합니다. |
| [getYCbCrPositioning()](#getYCbCrPositioning--) | 채도 성분이 휘도 성분에 대한 위치를 가져오거나 설정합니다. |
| [getYCbCrSubSampling()](#getYCbCrSubSampling--) | 채도 성분이 휘도 성분에 대한 샘플링 비율을 가져오거나 설정합니다. |
...
| [serializeExifData()](#serializeExifData--) | EXIF 데이터를 직렬화합니다. |
...
| [setBitsPerSample(int[] value)](#setBitsPerSample-int---) | 샘플당 비트를 가져오거나 설정합니다. |
...
| [setCompression(int value)](#setCompression-int-) | 압축을 가져오거나 설정합니다. |
| [setContrast(int value)](#setContrast-int-) | 대비를 가져오거나 설정합니다. |
| [setCopyright(String value)](#setCopyright-java.lang.String-) | 저작권을 가져오거나 설정합니다. |
| [setCustomRendered(int value)](#setCustomRendered-int-) | 사용자 정의 렌더링을 가져오거나 설정합니다. |
| [setDateTime(String value)](#setDateTime-java.lang.String-) | 날짜 및 시간을 가져오거나 설정합니다. |
...
| [setModel(String value)](#setModel-java.lang.String-) | 모델을 가져오거나 설정합니다. |
...
| [setPhotometricInterpretation(int value)](#setPhotometricInterpretation-int-) | 광도 해석을 가져오거나 설정합니다. |
...
| [setPrimaryChromaticities(TiffRational[] value)](#setPrimaryChromaticities-com.aspose.psd.fileformats.tiff.TiffRational---) | 이미지의 세 기본 색상의 색도(chromaticity)를 가져오거나 설정합니다. |
...
| [setReferenceBlackWhite(TiffRational[] value)](#setReferenceBlackWhite-com.aspose.psd.fileformats.tiff.TiffRational---) | 참조 흑백을 가져오거나 설정합니다. |
...
| [setSamplesPerPixel(int value)](#setSamplesPerPixel-int-) | 픽셀당 샘플 수를 가져오거나 설정합니다. |
...
| [setSoftware(String value)](#setSoftware-java.lang.String-) | 소프트웨어를 가져오거나 설정합니다. |
...
| [setThumbnail(RasterImage value)](#setThumbnail-com.aspose.psd.RasterImage-) | 썸네일 이미지를 가져오거나 설정합니다. |
| [setTransferFunction(int[] value)](#setTransferFunction-int---) | 전송 함수를 가져오거나 설정합니다. |
...
| [setYCbCrCoefficients(TiffRational[] value)](#setYCbCrCoefficients-com.aspose.psd.fileformats.tiff.TiffRational---) | RGB에서 YCbCr 이미지 데이터로 변환하기 위한 매트릭스 계수를 가져오거나 설정합니다. |
| [setYCbCrPositioning(int value)](#setYCbCrPositioning-int-) | 채도 성분이 휘도 성분에 대한 위치를 가져오거나 설정합니다. |
| [setYCbCrSubSampling(int[] value)](#setYCbCrSubSampling-int---) | 채도 성분이 휘도 성분에 대한 샘플링 비율을 가져오거나 설정합니다. |
...
JpegExifData 클래스의 새 인스턴스를 초기화합니다.
...
JpegExifData 클래스의 새 인스턴스를 배열의 데이터로 초기화합니다.
...
이미지의 세 기본 색상의 색도(chromaticity)를 가져오거나 설정합니다.
...
RGB에서 YCbCr 이미지 데이터로 변환하기 위한 매트릭스 계수를 가져오거나 설정합니다.

값: RGB에서 YCbCr 이미지 데이터로 변환하기 위한 행렬 계수.
...
채도 성분이 휘도 성분에 대한 위치를 가져오거나 설정합니다.

값: 색차 성분이 휘도 성분에 대한 위치.
...
채도 성분이 휘도 성분에 대한 샘플링 비율을 가져오거나 설정합니다.

값: 색차 성분이 휘도 성분에 대한 샘플링 비율.
...
EXIF 데이터를 직렬화합니다. 태그 값과 내용을 기록합니다. 가장 큰 영향을 미치는 크기 태그는 썸네일 태그 내용입니다.

**Returns:**
byte[] - 직렬화된 EXIF 데이터.

전체 세그먼트 크기는 올바른 JPEG 이미지를 생성하기 위해 MaxExifSegmentSize 바이트 이하이어야 합니다. 힌트: 썸네일 크기를 줄이거나 압축 방식을 변경하여 EXIF 섹션 크기가 너무 큰 경우 해결해 보세요.
