...
description: "다중 구성 요소 색상 픽셀 데이터에 대한 인터리브 모드를 정의합니다."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.jpeg/jpeglsinterleavemode/
---
...
다중 구성 요소(컬러) 픽셀 데이터에 대한 인터리브 모드를 정의합니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Line](#Line) | 인터리브 모드는 라인 단위입니다. |
| [None](#None) | 데이터는 구성 요소별로 인코딩되어 저장됩니다: RRRGGGBBB. |
| [Sample](#Sample) | 데이터는 샘플 단위로 인코딩되어 저장됩니다. |
## 메서드
...
인터리브 모드는 라인 단위입니다. 다음 라인으로 이동하기 전에 각 구성 요소의 전체 라인이 인코딩됩니다.
...
데이터는 구성 요소별로 인코딩되어 저장됩니다: RRRGGGBBB.
...
데이터는 샘플 단위로 인코딩되어 저장됩니다. 컬러 이미지의 경우 이 형식은 RGBRGBRGB와 같습니다.
