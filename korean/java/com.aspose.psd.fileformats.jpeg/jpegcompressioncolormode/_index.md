...
description: "jpeg 이미지의 색상 모드."
type: docs
weight: 12
url: /ko/java/com.aspose.psd.fileformats.jpeg/jpegcompressioncolormode/
---
...
| 필드 | 설명 |
| --- | --- |
| [Cmyk](#Cmyk) | 4-컴포넌트 CMYK 이미지. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Grayscale](#Grayscale) | 그레이스케일 이미지. |
| [Rgb](#Rgb) | RGB 컬러 모드. |
| [YCbCr](#YCbCr) | YCbCr 이미지, JPEG 이미지에 대한 표준 옵션. |
| [Ycck](#Ycck) | YCCK 컬러 JPEG 이미지. |
## 메서드
...
YCCK 컬러 JPEG 이미지. 저장을 위해 ICC 프로파일이 필요합니다.
