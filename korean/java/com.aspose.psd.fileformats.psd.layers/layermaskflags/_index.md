...
description: "레이어 마스크 플래그"
type: docs
weight: 24
url: /ko/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| 필드 | 설명 |
| --- | --- |
| [Disabled](#Disabled) | 레이어 마스크가 비활성화되었습니다. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | 블렌딩 시 레이어 마스크를 반전시킵니다. |
| [None](#None) | 정의된 플래그가 없습니다. |
| [RelativeToLayer](#RelativeToLayer) | 위치는 레이어를 기준으로 합니다. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | 사용자 마스크가 실제로 다른 데이터를 렌더링한 결과임을 나타냅니다. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | 사용자 및/또는 벡터 마스크에 매개변수가 적용되었음을 나타냅니다. |
## 메서드
...
사용자 마스크가 실제로 다른 데이터를 렌더링한 결과임을 나타냅니다.
...
사용자 및/또는 벡터 마스크에 매개변수가 적용되었음을 나타냅니다.
