...
description: "텍스트 레이어 클래스"
type: docs
weight: 30
url: /ko/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | 글꼴 크기를 수정합니다 |
...
| [createInstance_internalized()](#createInstance-internalized--) | 새로운 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 클래스 인스턴스를 생성합니다. |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | 새로운 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 클래스 인스턴스를 생성합니다. |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | 엔진 데이터를 가져옵니다. |
...
| [getFont()](#getFont--) | 글꼴을 가져옵니다. |
| [getFonts()](#getFonts--) | 텍스트 레이어의 글꼴 집합을 가져옵니다. |
...
| [getInnerText()](#getInnerText--) | 레이어의 텍스트를 가져옵니다 |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | 리소스 프로세서를 가져오거나 설정합니다. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | 문자열 형식을 가져옵니다. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | 동기화 루트를 가져옵니다. |
| [getText()](#getText--) | 텍스트를 가져옵니다. |
| [getTextBoundBox()](#getTextBoundBox--) | 텍스트 경계 상자를 가져오거나 설정합니다. |
| [getTextColor()](#getTextColor--) | 텍스트의 색상을 가져옵니다. |
| [getTextData()](#getTextData--) | 텍스트 부분을 가져옵니다 |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | 검색하고 [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) 리소스를 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer)에서 가져옵니다. |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | 값을 가져오거나 설정합니다. [was changed] 여부를 나타냅니다. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | 지정된 글꼴에 대해 [is font available] [the specified font] 여부를 판단합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | 이  Image 의 컨테이너가 설정될 때 호출됩니다. |
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | 글꼴을 전처리합니다. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | 글꼴을 기본값으로 교체합니다. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | 레이어의 텍스트를 가져옵니다 |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | 리소스 프로세서를 가져오거나 설정합니다. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | 텍스트 경계 상자를 가져오거나 설정합니다. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | 값을 가져오거나 설정합니다. [was changed] 여부를 나타냅니다. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | 리소스에서 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer)의 경계를 업데이트합니다. |
| [updateText(String text)](#updateText-java.lang.String-) | 텍스트를 업데이트합니다. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | 텍스트를 업데이트합니다. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | 텍스트를 업데이트합니다. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | 텍스트를 업데이트합니다. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | 텍스트를 업데이트합니다. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | 텍스트를 업데이트합니다. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | 텍스트를 업데이트합니다. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | 텍스트를 업데이트합니다. |
| [wait()](#wait--) |  |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| newSize | float | 새 글꼴 크기 |
| yyTransform | double | 'yy' 변환 행렬 매개변수 |
...
새로운 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) 클래스 인스턴스를 생성합니다.
...
텍스트 레이어의 글꼴 집합을 가져옵니다.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - 텍스트 레이어에 설정된 글꼴들.
...
검색하고 [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) 리소스를 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer)에서 가져옵니다.
...
값을 가져오거나 설정합니다. [was changed] 여부를 나타냅니다.

값:  true  이면 [was changed]; 그렇지 않으면  false .
...
지정된 글꼴에 대해 [is font available] [the specified font] 여부를 판단합니다.
...
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | 폰트. |
| defaultFontName | java.lang.String | 폰트의 기본 이름. |
...
| newWidth | int | 그 새로운 너비. |
| newHeight | int | 그 새로운 높이. |
| 크기 조정 유형 | int | ResizeType 리사이즈 변환 유형 |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 값 | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
리소스에서 [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer)의 경계를 업데이트합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | 텍스트의 절대 위치와 크기. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | 텍스트가 textBox에 상대적인 위치와 크기. |
...
| --- | --- | --- |
| text | java.lang.String | 텍스트 값. |
| color | [Color](../../com.aspose.psd/color) | 색상 값. |
...
| --- | --- | --- |
| text | java.lang.String | 텍스트 값. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | 왼쪽 상단 좌표. |
