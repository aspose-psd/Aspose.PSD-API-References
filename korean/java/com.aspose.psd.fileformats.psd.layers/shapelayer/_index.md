...
type: docs
weight: 29
url: /ko/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Shape 레이어. Shape 레이어와 관련 리소스 작업 로직을 캡슐화합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | 새로운 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [createInstance()](#createInstance--) | 새로운 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 클래스 인스턴스를 생성합니다. |
...
| [getFill()](#getFill--) | Shape 레이어 내 Shape의 내부 영역에 대한 채우기 설정입니다. |
...
| [getPath()](#getPath--) | Shape 레이어에 존재하는 Path 집합을 가져옵니다. |
...
| [getStroke()](#getStroke--) | Shape의 Stroke 설정을 가져오거나 설정합니다. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | [global resources changed]가 발생했을 때 호출됩니다. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | [resources change]가 발생했을 때 호출됩니다. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Shape 레이어 내 Shape의 내부 영역에 대한 채우기 설정입니다. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Shape의 Stroke 설정을 가져오거나 설정합니다. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Shape 레이어 속성에서 리소스를 업데이트합니다. |
...
새로운 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 클래스 인스턴스를 초기화합니다. 모든 리소스는 기본 상태로 생성됩니다.
...
새로운 [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) 클래스 인스턴스를 생성합니다.
...
Shape 레이어 내 Shape의 내부 영역에 대한 채우기 설정입니다.
...
**Returns:**
boolean - 레이어가 유효함을 나타내는 부울 값입니다.
...
[global resources changed]가 발생했을 때 호출됩니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 보내는 사람 | java.lang.Object | 보내는 사람. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | 이벤트 데이터를 포함하는 EventArgs 인스턴스. |
...
[resources change]가 발생했을 때 호출됩니다.
