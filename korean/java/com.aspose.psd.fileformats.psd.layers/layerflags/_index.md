...
type: docs
weight: 18
url: /ko/java/com.aspose.psd.fileformats.psd.layers/layerflags/
---
...
| [HasUsefulInformation](#HasUsefulInformation) | Photoshop 5.0 이상에서는 1이며, 비트 4에 유용한 정보가 있는지 알려줍니다. |
| [Obsolete](#Obsolete) | 폐기된 플래그 |
| [PixelDataIrrelevantToAppearenceInDocument](#PixelDataIrrelevantToAppearenceInDocument) | 문서에 표시되는 것과 무관한 픽셀 데이터 |
| [TransparencyProtected](#TransparencyProtected) | 투명도 보호 |
| [Undocumented](#Undocumented) | 문서화되지 않은 플래그 |
| [Visible](#Visible) | 보이는 플래그 |
## 메서드
...
Photoshop 5.0 이상에서는 1이며, 비트 4에 유용한 정보가 있는지 알려줍니다.
