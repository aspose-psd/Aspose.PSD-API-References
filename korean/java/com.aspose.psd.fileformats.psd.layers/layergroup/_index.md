...
description: "그룹 레이어 클래스"
type: docs
weight: 19
url: /ko/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | 레이어 그룹의 높이를 가져옵니다. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | LayerGroup에 있는 모든 레이어의 합집합 경계를 가져옵니다. |
...
| [getWidth()](#getWidth--) | 레이어 그룹의 너비를 가져옵니다. |
...
LayerGroup에 있는 모든 레이어의 합집합 경계를 가져옵니다.
