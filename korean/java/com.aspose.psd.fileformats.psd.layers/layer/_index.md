...
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.psd.layers/layer/
---
...
| 생성자 | 설명 |
| --- | --- |
| [Layer()](#Layer--) | 새로운 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 인스턴스를 초기화합니다. |
| [Layer(RasterImage image)](#Layer-com.aspose.psd.RasterImage-) |  |
| [Layer(RasterImage image, boolean disposeImage)](#Layer-com.aspose.psd.RasterImage-boolean-) | 새로운 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 인스턴스를 초기화합니다. |
| [Layer(InputStream stream)](#Layer-java.io.InputStream-) | 새로운 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 인스턴스를 초기화합니다. |
| [Layer(Rectangle bounds, byte[] redBytes, byte[] greenBytes, byte[] blueBytes, String name)](#Layer-com.aspose.psd.Rectangle-byte---byte---byte---java.lang.String-) | 바이트 배열에서 새로운 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 인스턴스를 초기화합니다. |
## 필드
...
[Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 새로운 인스턴스를 초기화합니다. 지연 초기화를 위한 생성자.
...
새로운 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| image | [RasterImage](../../com.aspose.psd/rasterimage) | 이미지입니다. |
| disposeImage | boolean | true 로 설정된 경우 [dispose image]를 수행합니다. |
...
바이트 배열에서 새로운 [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) 클래스의 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | 레이어 경계. |
