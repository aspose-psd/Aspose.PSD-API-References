...
description: "텍스트 정렬 모드."
type: docs
weight: 13
url: /ko/java/com.aspose.psd.fileformats.psd.layers.text.rendering/justificationmode/
---
...
| 필드 | 설명 |
| --- | --- |
| [Center](#Center) | 가운데 텍스트. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Left](#Left) | 왼쪽 정렬 텍스트. |
| [Right](#Right) | 오른쪽 정렬 텍스트. |
## 메서드
...
왼쪽 정렬 텍스트. 왼쪽에서 오른쪽 모드에서는 Left 위치가 Left이며, 오른쪽에서 왼쪽 모드에서는 Left 위치가 Right입니다.
...
오른쪽 정렬 텍스트. 왼쪽에서 오른쪽 모드에서는 Right 위치가 Right이며, 오른쪽에서 왼쪽 모드에서는 Right 위치가 Left입니다.
