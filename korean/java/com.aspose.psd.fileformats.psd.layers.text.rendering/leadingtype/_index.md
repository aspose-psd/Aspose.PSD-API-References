...
description: "Photoshop 리딩 타입은 줄 사이의 거리 유형입니다."
type: docs
weight: 14
url: /ko/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
Photoshop 리딩 유형(줄 사이 거리 유형).
## 필드

| 필드 | 설명 |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | 아래쪽-아래쪽 리딩. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | 위쪽-위쪽 리딩. |
## 메서드
