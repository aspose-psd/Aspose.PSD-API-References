...
description: "Photoshop 자동 커닝 모드에서 기호 사이의 거리."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.psd.layers.text.rendering/autokerning/
---
...
Photoshop 자동 커닝 모드(기호 사이 거리).
## 필드

| 필드 | 설명 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | 수동 커닝 값. |
| [Metric](#Metric) | Metrics kerning은 대부분의 글꼴에 포함된 커닝 페어를 사용합니다 (디자이너가 제공함). |
| [Optical](#Optical) | Optical kerning은 인접한 문자들의 형태를 기반으로 간격을 조정합니다. |
## 메서드
...
Metrics kerning은 대부분의 글꼴에 포함된 커닝 페어를 사용합니다 (디자이너가 제공함).
...
Optical kerning은 인접한 문자들의 형태를 기반으로 간격을 조정합니다.
