...
description: "클래스 LyidResource."
type: docs
weight: 59
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | 새 인스턴스를 초기화합니다 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 클래스. |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | 새 인스턴스를 초기화합니다 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 클래스. |
## 필드
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | 값을 가져옵니다. |
...
새 인스턴스를 초기화합니다 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 클래스.
...
새 인스턴스를 초기화합니다 [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) 클래스. 사용자 지정 또는 알 수 없는 값과 함께
