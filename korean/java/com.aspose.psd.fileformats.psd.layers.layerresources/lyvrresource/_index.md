...
description: "레이어의 포토샵 버전을 나타내는 리소스."
type: docs
weight: 60
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
레이어의 포토샵 버전을 나타내는 리소스.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | 새 인스턴스를 초기화합니다 [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) 클래스. |
## 필드
...
| [getVersion()](#getVersion--) | Layer의 포토샵 버전을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | Layer의 포토샵 버전을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource) 클래스.
