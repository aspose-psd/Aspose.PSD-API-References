...
description: "FxrpResource 클래스."
type: docs
weight: 32
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
FxrpResource 클래스. 레이어의 기준점
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 클래스의 새 인스턴스를 초기화합니다. |
| [FxrpResource()](#FxrpResource--) | [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 클래스의 새 인스턴스를 초기화합니다. |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [getX()](#getX--) | 기준점의 x 값을 가져오거나 설정합니다 |
| [getY()](#getY--) | 기준점의 y 값을 가져오거나 설정합니다 |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 지정된 스트림 컨테이너에 저장합니다. |
...
| [setX(double value)](#setX-double-) | 기준점의 x 값을 가져오거나 설정합니다 |
| [setY(double value)](#setY-double-) | 기준점의 y 값을 가져오거나 설정합니다 |
...
[FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 클래스의 새 인스턴스를 초기화합니다.
...
[FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) 클래스의 새 인스턴스를 초기화합니다. 사용자 지정 또는 알 수 없는 값과 함께
