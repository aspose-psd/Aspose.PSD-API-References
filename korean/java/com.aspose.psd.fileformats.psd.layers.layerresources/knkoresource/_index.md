...
description: "클래스 KnkoResource."
type: docs
weight: 41
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Class KnkoResource. 이 리소스는 클리핑된 요소의 블렌딩에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | 새로운 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 클래스 인스턴스를 초기화합니다. |
| [KnkoResource()](#KnkoResource--) | 새로운 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 클래스 인스턴스를 초기화합니다. |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | 새로운 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getKnockout()](#getKnockout--) | [blend interior elements]인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | [blend interior elements]인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
새로운 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 클래스 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 노크아웃 | boolean | true로 설정된 경우  [blend interior elements]입니다. |
...
새로운 [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) 클래스 인스턴스를 초기화합니다. 사용자 지정 또는 알 수 없는 값과 함께
