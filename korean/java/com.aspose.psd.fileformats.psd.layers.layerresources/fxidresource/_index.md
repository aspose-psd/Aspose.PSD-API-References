...
description: "Filter Effects 리소스에는 스마트 필터용 채널, 사용자 마스크 및 시트 마스크가 포함됩니다."
type: docs
weight: 29
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
필터 효과 리소스에는 채널, 사용자 마스크 및 스마트 필터용 시트 마스크가 포함되어 있습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드

| 필드 | 설명 |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | type tool info 키 FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | type tool info 키 FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | 필터 효과 마스크를 가져옵니다. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | 필터 효과 마스크를 가져옵니다. |
...
[FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) 클래스의 새 인스턴스를 초기화합니다.
...
| 키 | int | 리소스 키. |
| version | int | 버전. |
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | 필터 효과 마스크. |
