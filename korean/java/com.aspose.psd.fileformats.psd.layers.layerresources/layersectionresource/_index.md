...
description: "레이어 섹션 리소스."
type: docs
weight: 43
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) 클래스의 새 인스턴스를 초기화합니다. |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [getSectionType()](#getSectionType--) | 섹션 유형을 가져오거나 설정합니다. |
| [getSignature()](#getSignature--) | 레이어 리소스 서명을 가져옵니다. |
| [getSubtype()](#getSubtype--) | 하위 유형을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | 섹션 유형을 가져오거나 설정합니다. |
| [setSubtype(int value)](#setSubtype-int-) | 하위 유형을 가져오거나 설정합니다. |
...
[LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource) 클래스의 새 인스턴스를 초기화합니다.
