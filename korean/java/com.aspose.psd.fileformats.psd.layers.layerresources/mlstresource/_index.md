...
description: "mlst 리소스."
type: docs
weight: 62
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
mlst 리소스입니다. 이 클래스는 기타 여러 기능 중 레이어가 타임라인에 위치하는 정보 등을 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [MlstResource()](#MlstResource--) | 새로운 [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [getItems()](#getItems--) | 구조를 가져오거나 설정합니다. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 구조를 가져오거나 설정합니다. |
...
새로운 [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource) 클래스 인스턴스를 초기화합니다.
