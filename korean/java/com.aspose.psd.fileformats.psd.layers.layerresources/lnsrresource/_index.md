...
description: "클래스 lnsrResource."
type: docs
weight: 51
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | 새 인스턴스를 초기화합니다 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 클래스. |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | 새 인스턴스를 초기화합니다 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 클래스. |
## 필드
...
| [getValue()](#getValue--) | 해당 열거형이 설명된 경우 LnsrResourceType으로 값을 가져옵니다. |
| [hashCode()](#hashCode--) |  |
...
새 인스턴스를 초기화합니다 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 클래스.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| lnsrResourceType | int | LNSR의 유형. |
...
새 인스턴스를 초기화합니다 [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) 클래스. 사용자 지정 또는 알 수 없는 값과 함께
...
해당 열거형이 설명된 경우 LnsrResourceType으로 값을 가져옵니다. 그렇지 않으면 Unknown을 반환합니다.

값: LnsrResourceType 형식의 값.
