...
description: "알 수 없는 리소스."
type: docs
weight: 82
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | 새로운 [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
새로운 [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) 클래스 인스턴스를 초기화합니다.
