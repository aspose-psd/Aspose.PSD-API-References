...
description: "가능한 Lnsr 리소스 유형 발견"
type: docs
weight: 52
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresourcetype/
---
...
| 필드 | 설명 |
| --- | --- |
| [Bgnd](#Bgnd) | 배경 레이어용 Bgnd |
| [Cont](#Cont) | 채우기 레이어용 cont 예시 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Layr](#Layr) | 일반 이미지 레이어용 layr |
| [Rend](#Rend) | 텍스트용 rend |
| [Unknown](#Unknown) | Unknown은 열거형을 설명하지 않은 상황을 위해 사용됩니다. |
## 메서드
...
Unknown은 열거형을 설명하지 않은 상황을 위해 사용됩니다.
