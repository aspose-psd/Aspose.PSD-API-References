...
description: "lsdk 레이어 리소스 중첩 레이어 섹션 리소스."
type: docs
weight: 56
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) 클래스의 새 인스턴스를 초기화합니다. |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
[LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) 클래스의 새 인스턴스를 초기화합니다.
