...
description: "클래스 InfxResource."
type: docs
weight: 39
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
InfxResource 클래스. 이 리소스는 클리핑된 요소의 블렌딩에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 클래스의 새 인스턴스를 초기화합니다. |
| [InfxResource()](#InfxResource--) | [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 클래스의 새 인스턴스를 초기화합니다. |
| [InfxResource(byte[] data)](#InfxResource-byte---) | [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | [blend interior elements]인지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | 값 [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource)가 true인지 false인지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [hashCode()](#hashCode--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | [blend interior elements]인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [setValue(boolean value)](#setValue-boolean-) | 값 [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource)가 true인지 false인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
[InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 클래스의 새 인스턴스를 초기화합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| blendInteriorElements | boolean | true로 설정된 경우  [blend interior elements]입니다. |
...
[InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) 클래스의 새 인스턴스를 초기화합니다. 사용자 지정 또는 알 수 없는 값과 함께
...
[blend interior elements]인지 여부를 나타내는 값을 가져오거나 설정합니다.

값:  true  [blend interior elements]인 경우; 그렇지 않으면 false.
...
값 [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource)가 true인지 false인지 여부를 나타내는 값을 가져오거나 설정합니다.

값:  true  값이 true인 경우; 그렇지 않으면 false.
