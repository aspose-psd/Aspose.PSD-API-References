...
description: "MixrResource 클래스."
type: docs
weight: 61
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource/
---
...
클래스 MixrResource. Channel Mixer Adjustment Layer의 리소스.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [MixrResource()](#MixrResource--) | 새 인스턴스를 초기화합니다 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 클래스. |
| [MixrResource(byte[] data)](#MixrResource-byte---) | 새 인스턴스를 초기화합니다 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 클래스. |
## 필드
...
| [getChannelInfo(int channelIndex)](#getChannelInfo-int-) | 채널 정보 원시 데이터를 가져옵니다. |
| [getClass()](#getClass--) |  |
...
| [getMonochrome()](#getMonochrome--) | 이 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [setChannelInfo(int channelIndex, byte[] value)](#setChannelInfo-int-byte---) | 채널 정보를 설정합니다. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | 이 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 클래스. PSD 형식 사양에는 다음 설명이 포함됩니다: 2 버전 (= 1) 2 단색 20 RGB 또는 CMYK 색상과 믹서 설정을 위한 상수. 4 \* 2 바이트 색상과 2 바이트 상수.
...
이 [MixrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mixrresource) 가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다.
