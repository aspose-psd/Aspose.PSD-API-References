...
description: "ShmdResource 클래스."
type: docs
weight: 74
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [ShmdResource()](#ShmdResource--) | [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) 클래스의 새 인스턴스를 초기화합니다. |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | 하위 리소스 헤더 길이 |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | 레이어 생성 시간을 가져오거나 설정합니다. |
...
| [getSubResources()](#getSubResources--) | 하위 리소스 |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | 레이어 생성 시간을 가져오거나 설정합니다. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | shmd 리소스의 하위 리소스를 가져옵니다. |
...
[ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) 클래스의 새 인스턴스를 초기화합니다.
...
레이어 생성 시간을 가져오거나 설정합니다. 레이어 생성 시간이 지정되지 않은 경우 new DateTime(0)을 반환합니다.
