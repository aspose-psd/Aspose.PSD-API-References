...
description: "OS 유형 구조를 나타냅니다."
type: docs
weight: 64
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
...
| 생성자 | 설명 |
| --- | --- |
| [OSTypeStructure(ClassID keyName)](#OSTypeStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | 새로운 [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) 클래스 인스턴스를 초기화합니다. |
## 메서드
...
새로운 [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) 클래스 인스턴스를 초기화합니다.
