...
description: "PostResource 클래스."
type: docs
weight: 71
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
PostResource 클래스. 포스터라이즈 레이어 설정.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [PostResource()](#PostResource--) | [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
[PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource) 클래스의 새 인스턴스를 초기화합니다.
