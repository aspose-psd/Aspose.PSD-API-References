...
description: "클래스 IopaResource."
type: docs
weight: 40
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
클래스 IopaResource. 이 리소스는 레이어 스타일 폼의 fill opacity 속성에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [IopaResource()](#IopaResource--) | 새로운 [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) 클래스 인스턴스를 초기화합니다. |
| [IopaResource(byte[] data)](#IopaResource-byte---) | 새로운 [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | 채우기 불투명도를 가져오거나 설정합니다. |
...
새로운 [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource) 클래스 인스턴스를 초기화합니다.
