...
description: "ClblResource 클래스."
type: docs
weight: 20
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
클래스 ClblResource. 이 리소스는 클립된 요소의 블렌딩에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ClblResource()](#ClblResource--) | 새 인스턴스를 초기화합니다. [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 클래스. |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | 새 인스턴스를 초기화합니다. [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 클래스. |
| [ClblResource(byte[] data)](#ClblResource-byte---) | 새 인스턴스를 초기화합니다. [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 클래스. |
## 필드
...
| [getBlendClippedElements()](#getBlendClippedElements--) | 블렌드된 클립된 요소인지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | 블렌드된 클립된 요소인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 클래스.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| blendClippedElements | boolean | true 로 설정된 경우 [blend clipped elements]. |
...
새 인스턴스를 초기화합니다. [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource) 클래스. 사용자 지정 또는 알 수 없는 값과 함께
...
블렌드된 클립된 요소인지 여부를 나타내는 값을 가져오거나 설정합니다.

값: true, [blend clipped elements]인 경우; 그렇지 않으면 false.
