...
description: "레이어 잠금 옵션"
type: docs
weight: 42
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/layerlocktype/
---
...
| [LockAll](#LockAll) | 레이어의 모든 속성을 잠급니다. |
| [LockImagePixels](#LockImagePixels) | 레이어를 부분적으로 잠급니다 - 페인팅 도구를 사용한 레이어의 픽셀 수정을 방지합니다. |
| [LockPosition](#LockPosition) | 레이어를 부분적으로 잠그기 - 레이어\\u2019s 픽셀 이동을 방지합니다. |
| [LockTransparentPixels](#LockTransparentPixels) | 레이어를 부분적으로 잠그기 - 레이어의 불투명한 부분으로 편집을 제한합니다. |
| [None](#None) | 레이어 잠금 없음 |
## 메서드
...
레이어를 부분적으로 잠급니다 - 페인팅 도구를 사용한 레이어의 픽셀 수정을 방지합니다.
...
레이어를 부분적으로 잠그기 - 레이어\\u2019s 픽셀 이동을 방지합니다.
...
레이어를 부분적으로 잠그기 - 레이어의 불투명한 부분으로 편집을 제한합니다. 이 옵션은 이전 포토샵 버전의 Preserve Transparency 옵션과 동일합니다.
