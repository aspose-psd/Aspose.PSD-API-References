...
description: "클래스 LclrResource."
type: docs
weight: 46
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
LclrResource 클래스. 이 리소스는 PS 레이어 목록에 있는 레이어 색상에 대한 정보를 포함합니다. 이것만
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [LclrResource()](#LclrResource--) | 새 인스턴스를 초기화합니다. [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 클래스. |
| [LclrResource(short color)](#LclrResource-short-) | 새 인스턴스를 초기화합니다. [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 클래스. |
| [LclrResource(byte[] data)](#LclrResource-byte---) | 새 인스턴스를 초기화합니다. [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 클래스. |
## 필드
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | 레이어의 색상을 가져오거나 설정합니다. |
...
| [setColor(short value)](#setColor-short-) | 레이어의 색상을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다. [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource) 클래스.
