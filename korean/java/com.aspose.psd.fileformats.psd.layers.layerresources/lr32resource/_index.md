...
description: "lr32 리소스."
type: docs
weight: 54
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [Lr32Resource()](#Lr32Resource--) | [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) 클래스의 새 인스턴스를 초기화합니다. |
## 필드
...
| [getLayers()](#getLayers--) | 레이어를 가져오거나 설정합니다. |
| [getLength()](#getLength--) | 이미지의 PSD 헤더 버전에 대한 리소스 길이를 가져옵니다. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | 리소스 길이를 가져옵니다. |
...
| [getRawData_internalized()](#getRawData-internalized--) | 리소스의 원시 데이터를 가져오거나 설정합니다. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | 레이어 레코드를 저장합니다. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | 레이어를 가져오거나 설정합니다. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | 리소스의 원시 데이터를 가져오거나 설정합니다. |
...
[Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) 클래스의 새 인스턴스를 초기화합니다.
...
리소스 길이를 가져옵니다. PSD 버전에 따라 달라질 수 있습니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| psdHeaderVersion | int | PSD 헤더 버전. |
