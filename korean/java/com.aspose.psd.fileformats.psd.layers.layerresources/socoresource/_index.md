...
description: "SoCoResource 클래스."
type: docs
weight: 75
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
Class SoCoResource. 이 리소스는 색상 채우기 레이어에 대한 정보를 포함합니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [SoCoResource()](#SoCoResource--) | 새 인스턴스를 초기화합니다 [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource) 클래스의. |
## 필드
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | RGB 색상을 가져옵니다. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | RGB 색상을 가져옵니다. |
...
새 인스턴스를 초기화합니다 [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource) 클래스의.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | RGB 색상 |
