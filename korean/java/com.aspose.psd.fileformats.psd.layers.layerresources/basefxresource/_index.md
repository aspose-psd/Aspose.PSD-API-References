...
description: "기본 효과 리소스"
type: docs
weight: 12
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | 새 인스턴스를 초기화합니다 [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) 클래스. |
## 필드
...
새 인스턴스를 초기화합니다 [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) 클래스.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| resourceKey | int | 리소스 키. |
