...
description: "ExpaResource 클래스."
type: docs
weight: 28
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
ExpaResource 클래스. 노출 조정 레이어의 리소스.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | 새 인스턴스를 초기화합니다 [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) 클래스. |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | 새 인스턴스를 초기화합니다 [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) 클래스. |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | 새 인스턴스를 초기화합니다 [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) 클래스. |
## 필드
...
| [getExposure()](#getExposure--) | 노출을 가져오거나 설정합니다. |
| [getGammaCorrection()](#getGammaCorrection--) | 감마 값을 가져오거나 설정합니다. |
...
| [setExposure(float value)](#setExposure-float-) | 노출을 가져오거나 설정합니다. |
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | 감마 값을 가져오거나 설정합니다. |
...
| [setOffset(float value)](#setOffset-float-) | 오프셋을 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) 클래스.
