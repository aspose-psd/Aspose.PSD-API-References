...
description: "GdflResource의 데이터 변환을 구현하는 도우미 클래스."
type: docs
weight: 32
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/gdflresourcehelper/
---
...
GdflResource의 데이터 변환을 구현하는 도우미 클래스.
## 생성자
