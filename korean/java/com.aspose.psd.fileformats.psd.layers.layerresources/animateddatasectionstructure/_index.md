...
description: "애니메이션 데이터가 포함된 섹션."
type: docs
weight: 11
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| 필드 | 설명 |
| --- | --- |
| [StructureKey](#StructureKey) | AnDs의 구조 키를 식별합니다. |
## 메서드
...
| [framesNumberIsOdd_internalized(System.Collections.Generic.IGenericEnumerable<OSTypeStructure> items)](#framesNumberIsOdd-internalized-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure--) | 'FrIn' 리스트 구조에서 프레임 수가 홀수인지 확인합니다. |
...
| [getItems()](#getItems--) | 애니메이션 데이터 섹션 구조를 가져오거나 설정합니다. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ClassID를 가져오거나 설정합니다. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | 디스크립터 버전을 가져오거나 설정합니다. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | 애니메이션 데이터 섹션 구조를 가져오거나 설정합니다. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | 프레임 수가 홀수일 때 존재하는 알 수 없는 바이트 3을 가져오거나 설정합니다. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
'FrIn' 리스트 구조에서 프레임 수가 홀수인지 확인합니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 항목 | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
프레임 수가 홀수일 때 존재하는 알 수 없는 바이트 3을 가져오거나 설정합니다.
