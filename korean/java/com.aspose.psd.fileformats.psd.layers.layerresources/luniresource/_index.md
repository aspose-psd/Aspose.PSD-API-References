...
description: "레이어 이름 리소스"
type: docs
weight: 58
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| 생성자 | 설명 |
| --- | --- |
| [LuniResource()](#LuniResource--) | 새로운 [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) 클래스의 인스턴스를 초기화합니다. |
## 필드
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | 데이터를 가져오거나 설정합니다. |
...
새로운 [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource) 클래스의 인스턴스를 초기화합니다.
