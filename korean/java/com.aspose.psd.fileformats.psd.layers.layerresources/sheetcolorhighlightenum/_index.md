...
description: "시트 색상 설정의 가능한 색상."
type: docs
weight: 73
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
시트 색상 설정의 가능한 색상입니다. PS의 레이어 목록에서 레이어의 UI 장식 색상입니다.
## 필드
...
| [Gray](#Gray) | 회색. |
| [Green](#Green) | 녹색. |
| [NoColor](#NoColor) | 색상이 지정되지 않았습니다. |
| [Orange](#Orange) | 주황색. |
| [Red](#Red) | 빨간색. |
| [Violet](#Violet) | 보라색. |
| [Yellow](#Yellow) | 노란색. |
