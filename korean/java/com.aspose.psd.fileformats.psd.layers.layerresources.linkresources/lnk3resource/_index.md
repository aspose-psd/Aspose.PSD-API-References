...
description: "PSD 형식 32비트 채널 이미지에서 임베디드 파일에 대한 정보를 포함하는 클래스를 정의합니다."
type: docs
weight: 16
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
PSD 형식 32비트 채널 이미지에서 임베디드 파일에 대한 정보를 포함하는 클래스를 정의합니다. 링크 리소스는 인덱서를 통해 접근할 수 있는 여러 [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) 인스턴스를 포함할 수 있습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | 새로운 [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) 클래스의 인스턴스를 초기화합니다. |
## 필드
...
새로운 [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) 클래스의 인스턴스를 초기화합니다.
