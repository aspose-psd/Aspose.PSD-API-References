...
description: "PSD 링크 리소스의 데이터 소스에 대한 LinkDataSourceType 열거형을 정의합니다."
type: docs
weight: 13
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasourcetype/
---
...
| [None](#None) | 빈 링크 리소스. |
| [liFA](#liFA) | 연결된 파일 별칭 데이터 |
| [liFD](#liFD) | 포함된 연결 파일 데이터 |
| [liFE](#liFE) | 외부 연결 파일 데이터 |
## 메서드
