...
description: "PSD 파일에서 임베디드 파일에 대한 정보를 포함하는 liFD 데이터 소스 클래스를 정의합니다."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
PSD 파일에서 임베디드 파일에 대한 정보를 포함하는 liFD 데이터 소스 클래스를 정의합니다. 이는 Adobe® Photoshop® 파일을 수정하는 데 도움이 되는 PSD 파일 형식 조작 API의 일부입니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | 새로운 [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) 클래스의 인스턴스를 초기화합니다. |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | 새로운 [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) 클래스의 인스턴스를 초기화합니다. |
## 필드
...
| [getData()](#getData--) | PSD 파일에서 임베디드 스마트 오브젝트 데이터를 가져오거나 설정합니다. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | 임베디드 데이터의 길이를 가져옵니다. |
...
| [setData(byte[] value)](#setData-byte---) | PSD 파일에서 임베디드 스마트 오브젝트 데이터를 가져오거나 설정합니다. |
...
새로운 [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) 클래스의 인스턴스를 초기화합니다.
...
PSD 파일에서 임베디드 스마트 오브젝트 데이터를 가져오거나 설정합니다.
