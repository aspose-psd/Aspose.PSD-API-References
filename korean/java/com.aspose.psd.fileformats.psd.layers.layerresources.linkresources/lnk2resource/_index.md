...
description: "PSD 형식 이미지에서 임베디드 파일에 대한 정보를 포함하는 클래스를 정의합니다."
type: docs
weight: 15
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
PSD 형식 이미지에서 포함된 파일에 대한 정보를 포함하는 클래스를 정의합니다. 이 링크 리소스는 여러 LiFdDataSource 인스턴스를 포함할 수 있으며, 인덱서를 통해 접근할 수 있습니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | 새로운 [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스에서 LiFdDataSource를 가져옵니다. |
...
새로운 [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) 클래스 인스턴스를 초기화합니다.
...
지정된 인덱스에서 LiFdDataSource를 가져옵니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 인덱스 | int | 인덱스. 값: LiFdDataSource. |
