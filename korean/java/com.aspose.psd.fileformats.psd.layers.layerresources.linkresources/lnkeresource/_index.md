...
description: "PSD 형식 이미지에서 외부 링크된 파일 또는 자산에 대한 정보를 포함하는 LnkeResource 클래스를 정의합니다."
type: docs
weight: 17
url: /ko/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
PSD 형식 이미지에서 외부 링크 파일 또는 자산에 대한 정보를 포함하는 LnkeResource 클래스를 정의합니다. 이 링크 리소스는 여러 [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) 인스턴스를 포함할 수 있으며, 인덱서를 통해 접근할 수 있습니다. 이는 Adobe® Photoshop® 파일을 프로그래밍 방식으로 수정하는 데 도움이 되는 PSD 파일 형식 조작 API의 일부입니다.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | 새로운 [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) 클래스 인스턴스를 초기화합니다. |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | 새로운 [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) 클래스 인스턴스를 초기화합니다. |
## 필드
...
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스에 있는 [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)를 가져옵니다. |
...
새로운 [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) 클래스 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | 데이터 소스들. |
...
지정된 인덱스에 있는 [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)를 가져옵니다.

**Parameters:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| index | int | 인덱스. 값: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). |
