...
description: "PhotoshopPackage에서 색상 모드를 나타냅니다."
type: docs
weight: 10
url: /ko/java/com.aspose.psd.xmp.schemas.photoshop/colormode/
---
...
PhotoshopPackage의 색상 모드를 나타냅니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [Bitmap](#Bitmap) | 비트맵 색상 모드. |
| [Cmyk](#Cmyk) | CMYK 색상 모드. |
| [Duotone](#Duotone) | 듀오톤 색상. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GrayScale](#GrayScale) | 그레이스케일 색상 모드. |
| [IndexedColor](#IndexedColor) | 인덱스 색상. |
| [LabColor](#LabColor) | LAB 색상. |
| [MultiChannel](#MultiChannel) | 멀티채널 색상. |
| [Rgb](#Rgb) | RGB 색상. |
## 메서드
