...
description: "SmartObjectLayer 메서드. 연결된 스마트 오브젝트를 이 레이어에 임베드합니다."
type: docs
weight: 110
url: /ko/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/embedlinked/
---
{{< psd/tize >}}
## SmartObjectLayer.EmbedLinked method

연결된 스마트 객체를 이 레이어에 포함합니다.
