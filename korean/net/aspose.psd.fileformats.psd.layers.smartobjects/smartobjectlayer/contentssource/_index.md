...
description: "SmartObjectLayer 속성. 스마트 오브젝트 콘텐츠 소스를 가져오거나 설정합니다"
type: docs
weight: 40
url: /ko/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentssource/
---
{{< psd/tize >}}
## SmartObjectLayer.ContentsSource property

스마트 오브젝트 콘텐츠의 소스를 가져오거나 설정합니다.
