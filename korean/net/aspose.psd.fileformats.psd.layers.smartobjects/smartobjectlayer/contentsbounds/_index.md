...
description: "SmartObjectLayer 속성. 스마트 오브젝트 내용 경계값을 가져오거나 설정합니다."
type: docs
weight: 30
url: /ko/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentsbounds/
---
{{< psd/tize >}}
## SmartObjectLayer.ContentsBounds property

스마트 오브젝트 콘텐츠의 경계를 가져오거나 설정합니다.
