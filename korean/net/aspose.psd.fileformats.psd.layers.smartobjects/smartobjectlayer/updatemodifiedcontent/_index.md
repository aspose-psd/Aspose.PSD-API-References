...
description: "SmartObjectLayer 메서드. 수정된 콘텐츠로 스마트 객체 레이어 이미지 캐시를 업데이트합니다."
type: docs
weight: 170
url: /ko/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/updatemodifiedcontent/
---
{{< psd/tize >}}
