...
description: "SmartObjectLayer 메서드. 연결된 스마트 오브젝트를 새 파일에 다시 연결합니다. 이후에 UpdateModifiedContent 메서드를 호출할 필요가 없습니다."
type: docs
weight: 150
...
링크된 스마트 오브젝트를 새 파일에 다시 연결합니다. 이후에 UpdateModifiedContent 메서드를 호출할 필요가 없습니다.
