...
description: "SmartObjectLayer 속성. 리소스 기본값에서 설정되거나 가져온 Warp 매개변수를 가져오거나 설정합니다."
type: docs
weight: 80
url: /ko/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

리소스에서 설정되었거나 가져온 워프 매개변수를 가져오거나 설정합니다 (기본값).
