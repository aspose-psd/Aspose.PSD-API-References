...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType 열거형. 스마트 개체 콘텐츠 type 에 대한 SmartObjectType 열거를 정의합니다.
type: docs
weight: 3500
url: /ko/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
## SmartObjectType enumeration

스마트 개체 콘텐츠 type 에 대한 SmartObjectType 열거를 정의합니다.
...
| --- | --- | --- |
| Embedded | `0` | 포함된 콘텐츠 |
| AvailableLinked | `1` | available 인 링크된 파일 |
| UnavailableLinked | `2` | 사용할 수 없는 링크된 파일 |
| LibraryLink | `3` | Adobe® Photoshop® ÑÑ 라이브러리 link |
