---
title: "열거형 SmartObjectType"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType 열거형. 스마트 오브젝트 콘텐츠 유형에 대한 SmartObjectType 열거형을 정의합니다"
type: docs
weight: 3920
...
SmartObjectType 열거형을 정의하여 스마트 오브젝트 콘텐츠 유형을 지정합니다
...
| --- | --- | --- |
| Embedded | `0` | 내장된 콘텐츠 |
| AvailableLinked | `1` | 사용 가능한 링크된 파일 |
| UnavailableLinked | `2` | 사용할 수 없는 링크된 파일 |
| LibraryLink | `3` | Adobe® Photoshop® ÑÑ 라이브러리 링크 |
