---
title: "클래스 EllipseShape"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.Shapes.EllipseShape 클래스. 타원 모양을 나타냅니다"
type: docs
weight: 5990
...
| 이름 | 설명 |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | `EllipseShape` 클래스의 새 인스턴스를 초기화합니다. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | `EllipseShape` 클래스의 새 인스턴스를 초기화합니다. |
