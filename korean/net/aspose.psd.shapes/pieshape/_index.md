...
description: "Aspose.PSD.Shapes.PieShape 클래스. 파이 모양을 나타냅니다"
type: docs
weight: 6000
...
| 이름 | 설명 |
| --- | --- |
| [PieShape](pieshape/#constructor)() | `PieShape` 클래스의 새 인스턴스를 초기화합니다. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | `PieShape` 클래스의 새 인스턴스를 초기화합니다. |
