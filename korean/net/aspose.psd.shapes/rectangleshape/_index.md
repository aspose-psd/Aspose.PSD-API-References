...
description: Aspose.PSD.Shapes.RectangleShape 수업. 직사각형 모양을 나타냅니다.
type: docs
weight: 5530
...
| 이름 | 설명 |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | 의 새 인스턴스를 초기화합니다.`RectangleShape` 클래스. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | 의 새 인스턴스를 초기화합니다.`RectangleShape` 클래스. |
