...
description: Aspose.PSD.Shapes.ArcShape 수업. 호 모양을 나타냅니다.
type: docs
weight: 5460
...
| 이름 | 설명 |
| --- | --- |
| [ArcShape](arcshape/#constructor)() | 의 새 인스턴스를 초기화합니다.`ArcShape` 클래스. |
| [ArcShape](arcshape/#constructor_1)(RectangleF, float, float) | 의 새 인스턴스를 초기화합니다.`ArcShape` 클래스. |
| [ArcShape](arcshape/#constructor_2)(RectangleF, float, float, bool) | 의 새 인스턴스를 초기화합니다.`ArcShape` 클래스. |
...
| [IsClosed](../../aspose.psd.shapes/arcshape/isclosed/) { get; set; } | 정렬된 모양이 닫혀 있는지 여부를 나타내는 값을 가져오거나 설정합니다. 닫힌 순서 모양을 처리할 때 시작점과 끝점은 의미가 없습니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds)(Matrix) | 개체의 범위를 가져옵니다. |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds_1)(Matrix, Pen) | 개체의 범위를 가져옵니다. |
| [Reverse](../../aspose.psd.shapes/arcshape/reverse/)() | 이 모양의 포인트 순서를 반대로 합니다. |
