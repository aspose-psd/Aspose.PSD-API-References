...
description: PsdColorPalette 방법. 팔레트를 복사합니다.
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.psd/psdcolorpalette/copypalette/
---
...
| useCompactPalette | Boolean | 컴팩트 팔레트 여부를 나타냅니다. |

### 반환 값

새로 생성 및 복사된 팔레트 또는 null 팔레트가 통과된 경우 null입니다.
