...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider 수업. PSD 파일 및 해당 콘텐츠의 글로벌 링크 리소스에서 데이터 소스 가져오기/설정을 제공하는 스마트 개체 공급자를 정의합니다.
type: docs
weight: 4000
...
PSD 파일 및 해당 콘텐츠의 글로벌 링크 리소스에서 데이터 소스 가져오기/설정을 제공하는 스마트 개체 공급자를 정의합니다.
...
| 이름 | 설명 |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | 레이어를 포함된 스마트 개체로 변환합니다. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | 레이어를 포함된 스마트 개체로 변환합니다. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | 이미지에 연결된 모든 스마트 개체를 포함합니다. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | 원본 레이어를 복사하여 새로운 스마트 개체 레이어를 생성합니다. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | 이미지에서 수정된 모든 스마트 개체의 내용을 업데이트합니다. |
