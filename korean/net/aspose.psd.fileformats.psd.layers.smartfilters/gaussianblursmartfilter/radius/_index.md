...
description: GaussianBlurSmartFilter 재산. 가우스 스마트 필터의 반지름을 가져오거나 설정합니다.
type: docs
weight: 40
url: /ko/net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/radius/
---
## GaussianBlurSmartFilter.Radius property

가우스 스마트 필터의 반지름을 가져오거나 설정합니다.
