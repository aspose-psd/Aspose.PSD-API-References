...
description: "IGradientFillSettings 속성. 이 IGradientFillSettings가 역방향인지 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 80
url: /ko/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
{{< psd/tize >}}
## IGradientFillSettings.Reverse property

이 [`IGradientFillSettings`](../)가 역방향인지 여부를 나타내는 값을 가져오거나 설정합니다.
