---
title: "인터페이스 IPatternFillSettings"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.FillSettings.IPatternFillSettings 인터페이스. 패턴 채우기 설정을 위한 인터페이스"
type: docs
weight: 2150
...
| 이름 | 설명 |
| --- | --- |
| [Angle](../../aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings/angle/) { get; set; } | 각도를 가져오거나 설정합니다. |
...
| [Linked](../../aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings/linked/) { get; set; } | 이 `IPatternFillSettings`가 연결되어 있는지를 나타내는 값을 가져오거나 설정합니다. |
| [PatternData](../../aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings/patterndata/) { get; set; } | 패턴 데이터를 가져옵니다. |
...
| [PatternName](../../aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings/patternname/) { get; set; } | 패턴 이름을 가져오거나 설정합니다. |
...
| [Scale](../../aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings/scale/) { get; set; } | 스케일을 가져오거나 설정합니다. |
