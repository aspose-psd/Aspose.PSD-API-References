...
description: "Aspose.PSD.ImageOptions.Jpeg2000Options class. Jpeg2000 파일 형식 옵션입니다"
type: docs
weight: 5320
...
| 이름 | 설명 |
| --- | --- |
| [Jpeg2000Options](jpeg2000options/#constructor)() | 새 `Jpeg2000Options` 클래스 인스턴스를 초기화합니다. |
| [Jpeg2000Options](jpeg2000options/#constructor_1)(Jpeg2000Options) | 새 `Jpeg2000Options` 클래스 인스턴스를 초기화합니다. |
...
| [Codec](../../aspose.psd.imageoptions/jpeg2000options/codec/) { get; set; } | JPEG2000 코덱을 가져오거나 설정합니다 |
| [Comments](../../aspose.psd.imageoptions/jpeg2000options/comments/) { get; set; } | Jpeg 주석 마커를 가져오거나 설정합니다. |
| [CompressionRatios](../../aspose.psd.imageoptions/jpeg2000options/compressionratios/) { get; set; } | 압축 비율 배열을 가져오거나 설정합니다. 연속 레이어마다 다른 압축 비율을 사용합니다. 각 품질 수준에 지정된 비율은 원하는 압축 계수이며, 비율을 감소시켜야 합니다. |
...
| [Irreversible](../../aspose.psd.imageoptions/jpeg2000options/irreversible/) { get; set; } | 비가역 DWT 9-7을 사용할지(true) 아니면 무손실 DWT 5-3 압축을 사용할지(기본값)를 나타내는 값을 가져오거나 설정합니다. |
