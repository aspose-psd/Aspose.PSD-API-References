---
title: "클래스 CmxRasterizationOptions"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.ImageOptions.CmxRasterizationOptions 클래스. CMX 내보내기 옵션"
type: docs
weight: 5290
url: /ko/net/aspose.psd.imageoptions/cmxrasterizationoptions/
---
{{< psd/tize >}}
...
| 이름 | 설명 |
| --- | --- |
| [CmxRasterizationOptions](cmxrasterizationoptions/)() | 기본 생성자입니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [BackgroundColor](../../aspose.psd.imageoptions/vectorrasterizationoptions/backgroundcolor/) { get; set; } | 배경 색상을 가져오거나 설정합니다. |
...
| [CenterDrawing](../../aspose.psd.imageoptions/vectorrasterizationoptions/centerdrawing/) { get; set; } | 중심 그리기 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [DrawColor](../../aspose.psd.imageoptions/vectorrasterizationoptions/drawcolor/) { get; set; } | 전경 색상을 가져오거나 설정합니다. |
...
| [Positioning](../../aspose.psd.imageoptions/cmxrasterizationoptions/positioning/) { get; set; } | 위를 가져오거나 설정합니다. |
...
| [CopyTo](../../aspose.psd.imageoptions/vectorrasterizationoptions/copyto/)(VectorRasterizationOptions) | 복사합니다. |
