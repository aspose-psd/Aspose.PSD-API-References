...
description: InitialFillRuleRecord 건설자. 의 새 인스턴스를 초기화합니다.InitialFillRuleRecord 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.core.vectorpaths/initialfillrulerecord/initialfillrulerecord/
---
## InitialFillRuleRecord() {#constructor}

의 새 인스턴스를 초기화합니다.[`InitialFillRuleRecord`](../) 클래스.
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| isFillStartsWithAllPixels | Boolean | is 채우기는 모든 픽셀로 시작합니다. |
