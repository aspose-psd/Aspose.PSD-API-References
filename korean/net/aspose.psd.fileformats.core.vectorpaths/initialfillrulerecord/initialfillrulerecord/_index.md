...
description: "InitialFillRuleRecord 생성자. InitialFillRuleRecord 클래스의 새 인스턴스를 초기화합니다"
type: docs
weight: 10
...
[`InitialFillRuleRecord`](../) 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| isFillStartsWithAllPixels | Boolean | 그 fill는 모든 픽셀로 시작합니다. |
