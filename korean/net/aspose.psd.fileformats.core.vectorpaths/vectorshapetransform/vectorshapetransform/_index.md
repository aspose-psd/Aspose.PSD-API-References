...
description: VectorShapeTransform 건설자. 의 새 인스턴스를 초기화합니다.VectorShapeTransform 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/vectorshapetransform/
---
## VectorShapeTransform constructor

의 새 인스턴스를 초기화합니다.[`VectorShapeTransform`](../) 클래스.
