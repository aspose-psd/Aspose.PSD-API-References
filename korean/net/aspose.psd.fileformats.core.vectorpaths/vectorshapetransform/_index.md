...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform 수업. 벡터 형상 변환 행렬 정의 class
type: docs
weight: 1460
...
| 이름 | 설명 |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | 의 새 인스턴스를 초기화합니다.`VectorShapeTransform` 클래스. |
