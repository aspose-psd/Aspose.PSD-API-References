...
description: "IVectorPathData 속성. 이 인스턴스가 연결되지 않았는지 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 30
url: /ko/net/aspose.psd.fileformats.core.vectorpaths/ivectorpathdata/isnotlinked/
---
{{< psd/tize >}}
