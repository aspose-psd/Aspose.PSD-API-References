...
description: "BezierKnotRecord constructor. BezierKnotRecord 클래스의 새 인스턴스를 초기화합니다"
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.core.vectorpaths/bezierknotrecord/bezierknotrecord/
---
{{< psd/tize >}}
## BezierKnotRecord() {#constructor}

새 인스턴스를 초기화합니다 [`BezierKnotRecord`](../) 클래스의.
