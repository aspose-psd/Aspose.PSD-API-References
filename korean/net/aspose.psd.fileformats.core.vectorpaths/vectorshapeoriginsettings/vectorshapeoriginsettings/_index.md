...
description: VectorShapeOriginSettings 건설자. 의 새 인스턴스를 초기화합니다.VectorShapeOriginSettings 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
## VectorShapeOriginSettings constructor

의 새 인스턴스를 초기화합니다.[`VectorShapeOriginSettings`](../) 클래스.
