...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer 수업. 포토필터 조정 레이어.
type: docs
weight: 1790
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | 필터의 RGB 색상을 가져오거나 설정합니다. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | filter 의 밀도를 가져오거나 설정합니다. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | [광도 유지]. 여부를 나타내는 값을 가져오거나 설정합니다. |
