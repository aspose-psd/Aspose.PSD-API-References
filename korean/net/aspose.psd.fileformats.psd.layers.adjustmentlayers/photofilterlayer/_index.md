---
title: "클래스 PhotoFilterLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer 클래스. PhotoFilter 조정 레이어"
type: docs
weight: 1860
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | 필터의 밀도를 가져오거나 설정합니다. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | 광도 보존 여부를 나타내는 값을 가져오거나 설정합니다. |
