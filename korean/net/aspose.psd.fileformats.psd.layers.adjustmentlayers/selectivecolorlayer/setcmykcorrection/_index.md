...
description: "SelectiveColorLayer 메서드. 선택 색상에 따라 CMYK 보정을 설정합니다"
type: docs
weight: 40
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/
---
{{< psd/tize >}}
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | 선택 색상의 유형. |
| 보정 | CmykCorrection | CMYK 보정. |
