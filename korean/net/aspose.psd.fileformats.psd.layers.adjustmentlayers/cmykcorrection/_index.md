---
title: "클래스 CmykCorrection"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection 클래스. 선택 색상 조정 레이어에서 색상 보정"
type: docs
weight: 1750
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
## CmykCorrection class

선택 색상 조정 레이어에서 색상 보정.
...
| 이름 | 설명 |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | 기본 생성자입니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | 검정 색 보정을 가져오거나 설정합니다. |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | 시안 색 보정을 가져오거나 설정합니다. |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | 마젠타 색 보정을 가져오거나 설정합니다. |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | 노란색 보정을 가져오거나 설정합니다. |
