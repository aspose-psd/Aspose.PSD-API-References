---
title: "클래스 BrightnessContrastLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer 클래스. 밝기/대비 레이어"
type: docs
weight: 1720
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | 밝기를 가져오거나 설정합니다. PS에서 밝기 범위는 -150에서 +150까지입니다. 하지만 우리는 이를 무시합니다. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | 대비를 가져오거나 설정합니다. PS에서 대비 범위는 -50에서 +100까지입니다. 하지만 우리는 이를 무시합니다. |
