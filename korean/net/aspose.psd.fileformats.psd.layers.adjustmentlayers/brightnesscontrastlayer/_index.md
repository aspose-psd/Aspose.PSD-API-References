...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer 수업. 밝기/대비 레이어.
type: docs
weight: 1680
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | 밝기를 가져오거나 설정합니다. PS의 경우 밝기 범위는 -150에서 +150입니다. 그러나 우리는 이것을 무시합니다. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | 대비를 가져오거나 설정합니다. PS의 경우 대비 범위는 -50에서 +100입니다. 그러나 우리는 이것을 무시합니다. |
