...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer 수업. 레이어를 포스터화합니다. PostResource. 의 데이터를 사용하여 포스터라이즈 렌더링을 처리합니다.
type: docs
weight: 1800
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
## PosterizeLayer class

레이어를 포스터화합니다. PostResource. 의 데이터를 사용하여 포스터라이즈 렌더링을 처리합니다.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | 포스터라이즈 레이어 레벨. |
