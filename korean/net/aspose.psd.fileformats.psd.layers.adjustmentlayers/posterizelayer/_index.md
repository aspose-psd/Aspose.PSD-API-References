---
title: "클래스 PosterizeLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer 클래스. Posterize 레이어. PostResource의 데이터를 사용하여 Posterize 렌더링을 처리합니다."
type: docs
weight: 1870
...
포스터화 레이어. PostResource의 데이터를 사용하여 포스터화 렌더링을 처리합니다.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Posterize 레이어의 레벨. |
