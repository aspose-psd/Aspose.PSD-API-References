...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer 수업. 채널 믹서 조정 레이어.
type: docs
weight: 1690
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | 이 여부를 나타내는 값을 가져오거나 설정합니다.`ChannelMixerLayer` 단색입니다. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | 채널 인덱스를 가져옵니다. RgbMixerChannel 또는 CmykMixerChannel 를 반환할 수 있습니다. |
