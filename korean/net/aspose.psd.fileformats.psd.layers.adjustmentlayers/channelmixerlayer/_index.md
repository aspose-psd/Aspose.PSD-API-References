---
title: "클래스 ChannelMixerLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer 클래스. 채널 믹서 조정 레이어"
type: docs
weight: 1730
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | 이 `ChannelMixerLayer`가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | 채널의 인덱스를 가져옵니다. RgbMixerChannel 또는 CmykMixerChannel을 반환할 수 있습니다. |
