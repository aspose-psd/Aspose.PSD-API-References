---
title: "클래스 HueSaturationLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer 클래스. HueSaturation 조정 레이어"
type: docs
weight: 1820
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | 이 `HueSaturationLayer`가 색상화되는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | 명도를 가져오거나 설정합니다. |
