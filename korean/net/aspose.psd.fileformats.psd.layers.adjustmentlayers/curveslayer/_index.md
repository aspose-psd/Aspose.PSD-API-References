---
title: "클래스 CurvesLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer 클래스. 커브 조정 레이어"
type: docs
weight: 1790
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | 이 인스턴스가 연속 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | 이 인스턴스가 이산 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | 커브 관리자를 가져옵니다. |
