...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer 수업. 곡선 조정 Layer
type: docs
weight: 1730
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | 이 인스턴스가 연속 관리자 사용 여부를 나타내는 값을 가져오거나 설정합니다. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | 이 인스턴스가 사용된 개별 관리자인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | 곡선 관리자를 가져옵니다. |
