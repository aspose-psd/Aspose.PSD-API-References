...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer 수업. 바이브런스 조정 구현 layer
type: docs
weight: 1830
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
## VibranceLayer class
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation/) { get; set; } | 채도를 가져오거나 설정합니다. |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance/) { get; set; } | 진동을 가져오거나 설정합니다. |
