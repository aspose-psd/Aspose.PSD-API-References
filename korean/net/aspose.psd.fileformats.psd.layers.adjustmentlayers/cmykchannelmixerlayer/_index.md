---
title: "클래스 CmykChannelMixerLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer 클래스. Cmyk 채널 믹서 조정 레이어"
type: docs
weight: 1740
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | 검은색 채널을 가져옵니다. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | 시안 채널을 가져옵니다. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | 마젠타 채널을 가져옵니다. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | 이 [`ChannelMixerLayer`](../channelmixerlayer/)가 단색인지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | 채널의 인덱스를 가져옵니다. CmykMixerChannel를 반환합니다. |
