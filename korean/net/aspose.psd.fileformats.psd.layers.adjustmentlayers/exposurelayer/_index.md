...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer 수업. 노출 조정 레이어.
type: docs
weight: 1740
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | 노출을 가져오거나 설정합니다. PS의 경우 노출 범위는 -20에서 +20입니다. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | GammaCorrection을 가져오거나 설정합니다. GammaCorrection의 PS 범위는 9.99에서 +0.01 까지입니다. |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | 오프셋을 가져오거나 설정합니다. 오프셋의 PS 범위는 -0.5 ~ +0.5 입니다. |
