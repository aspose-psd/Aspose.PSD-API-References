---
title: "클래스 GradientMapLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer 클래스. 그라디언트 맵 레이어. GrdmResource의 데이터를 사용하여 그라디언트 맵 렌더링을 처리합니다."
type: docs
weight: 1810
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | GrdmResource 인스턴스로부터 전달된 Gradient 설정 인스턴스를 가져오거나 설정합니다. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | 관련 레이어 리소스 [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/)의 레이어 데이터를 업데이트합니다. |
