---
title: "클래스 BlackWhiteAdjustmentLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BlackWhiteAdjustmentLayer 클래스. 흑백 조정 레이어 클래스"
type: docs
weight: 1710
url: /ko/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
{{< psd/tize >}}
...
| [BlackAndWhitePresetFileName](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blackandwhitepresetfilename/) { get; set; } | 흑백 프리셋 파일 이름을 가져오거나 설정합니다. |
...
| [Blues](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blues/) { get; set; } | blues 값을 가져오거나 설정합니다. |
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind/) { get; set; } | 흑백 프리셋 종류 값을 가져오거나 설정합니다. |
...
| [Cyans](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans/) { get; set; } | cyans 값을 가져오거나 설정합니다. |
...
| [Greens](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens/) { get; set; } | greens 값을 가져오거나 설정합니다. |
...
| [Magentas](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/magentas/) { get; set; } | magentas 값을 가져오거나 설정합니다. |
...
| [Reds](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/reds/) { get; set; } | reds 값을 가져오거나 설정합니다. |
...
| [TintColor](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolor/) { get; set; } | Tint Color 값을 가져오거나 설정합니다. |
| [TintColorBlue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/) { get; set; } | Blue Tint Color double 값을 가져오거나 설정합니다. |
| [TintColorGreen](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorgreen/) { get; set; } | Green Tint Color double 값을 가져오거나 설정합니다. |
| [TintColorRed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorred/) { get; set; } | Red Tint Color의 double 값을 가져오거나 설정합니다. |
...
| [UseTint](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/usetint/) { get; set; } | [tint color]가 사용되는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [Yellows](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/) { get; set; } | yellows 값을 가져오거나 설정합니다. |
