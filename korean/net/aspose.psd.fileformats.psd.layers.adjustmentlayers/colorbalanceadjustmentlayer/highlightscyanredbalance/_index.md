...
description: ColorBalanceAdjustmentLayer 재산. 하이라이트 청록색 균형을 가져오거나 설정합니다.
type: docs
weight: 10
...
| 예외 | 상태 |
| --- | --- |
| ArgumentOutOfRangeException | 하이라이트 청록색 균형은 -100에서 +100 사이여야 합니다. |
