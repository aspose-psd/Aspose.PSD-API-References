...
description: "ColorBalanceAdjustmentLayer 속성. Midtones Yellow Blue Balance를 가져오거나 설정합니다."
type: docs
weight: 60
...
Midtones Yellow Blue Balance를 가져오거나 설정합니다.
...
| 예외 | 조건 |
| --- | --- |
| ArgumentOutOfRangeException | Midtones Yellow Blue Balance는 -100에서 +100 사이여야 합니다. |
