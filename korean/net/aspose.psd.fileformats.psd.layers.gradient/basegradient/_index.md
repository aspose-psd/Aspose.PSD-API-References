---
title: "클래스 BaseGradient"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient 클래스. 기본 그라디언트 정의 클래스. 솔리드와 노이즈 두 종류의 그라디언트에 공통적인 속성을 포함합니다."
type: docs
weight: 2190
url: /ko/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| 이름 | 설명 |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | 이 그라디언트의 모드를 가져옵니다. 'Gradient Type' = 'Solid/Noise' (0/1) 를 결정합니다. |
