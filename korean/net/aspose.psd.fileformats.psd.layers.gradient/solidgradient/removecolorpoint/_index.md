...
description: "SolidGradient 메서드. 색상 포인트를 제거합니다"
type: docs
weight: 80
url: /ko/net/aspose.psd.fileformats.psd.layers.gradient/solidgradient/removecolorpoint/
---
{{< psd/tize >}}
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| 포인트 | IGradientColorPoint | 포인트입니다. |
