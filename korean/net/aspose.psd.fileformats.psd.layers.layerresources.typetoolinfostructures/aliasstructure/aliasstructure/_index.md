...
description: AliasStructure 건설자. 의 새 인스턴스를 초기화합니다.AliasStructure 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/aliasstructure/
---
## AliasStructure constructor

의 새 인스턴스를 초기화합니다.[`AliasStructure`](../) 클래스.
