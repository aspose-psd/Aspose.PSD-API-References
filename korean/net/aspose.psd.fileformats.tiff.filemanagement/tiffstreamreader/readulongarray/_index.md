...
description: TiffStreamReader 방법. 스트림에서 부호 없는 정수 값의 배열을 읽습니다.
type: docs
weight: 200
url: /ko/net/aspose.psd.fileformats.tiff.filemanagement/tiffstreamreader/readulongarray/
---
## TiffStreamReader.ReadULongArray method

스트림에서 부호 없는 정수 값의 배열을 읽습니다.
