...
description: PsdImageException 건설자. 의 새 인스턴스를 초기화합니다.PsdImageException 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.coreexceptions.imageformats/psdimageexception/psdimageexception/
---
## PsdImageException(string) {#constructor}

의 새 인스턴스를 초기화합니다.[`PsdImageException`](../) 클래스.
...
* 네임스페이스 [Aspose.PSD.CoreExceptions.ImageFormats](../../psdimageexception/)
* 집회 [Aspose.PSD](../../../)
