...
description: "AiLayerSection 속성. 이 레이어가 잠겨 있는지 여부를 나타내는 값을 가져오거나 설정합니다. 항목에 대한 변경을 방지합니다"
type: docs
weight: 80
url: /ko/net/aspose.psd.fileformats.ai/ailayersection/islocked/
---
{{< psd/tize >}}
...
`true` 이 레이어가 잠겨 있는 경우; 그렇지 않으면 `false`.
