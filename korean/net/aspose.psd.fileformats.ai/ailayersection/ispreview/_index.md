...
description: AiLayerSection 재산. 이 레이어가 미리보기인지 여부를 나타내는 값을 가져오거나 설정합니다. 레이어에 포함된 아트웍을 윤곽선 대신 컬러로 표시합니다.
type: docs
weight: 70
url: /ko/net/aspose.psd.fileformats.ai/ailayersection/ispreview/
---
## AiLayerSection.IsPreview property

이 레이어가 미리보기인지 여부를 나타내는 값을 가져오거나 설정합니다. 레이어에 포함된 아트웍을 윤곽선 대신 컬러로 표시합니다.
