...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer 수업. 채우기 레이어. 색상 채우기 그라데이션 채우기 또는 패턴 채우기 레이어는 다음과 같이 다릅니다.FillSettings
type: docs
weight: 1910
url: /ko/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

채우기 레이어. 색상 채우기, 그라데이션 채우기 또는 패턴 채우기 레이어는 다음과 같이 다릅니다.[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | 채우기 설정을 가져옵니다. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | 채우기 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | 새 인스턴스를 빌드합니다.`FillLayer` 채우기 유형별 클래스. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | 모든 불투명 색상을 새 색상으로 교체하고 원래 알파 값을 유지하여 부드러운 가장자리를 저장합니다. 참고: 투명하지 않은 이미지에 사용하면 모든 색상이 단일 색상으로 교체됩니다. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | 실제에 따라 채우기 레이어 픽셀 데이터를 업데이트합니다.[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* 네임스페이스 [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* 집회 [Aspose.PSD](../../)
