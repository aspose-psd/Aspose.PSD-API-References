...
description: "Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer 클래스. Fill 레이어. FillSettings에 따라 색상 채우기, 그라디언트 채우기 또는 패턴 채우기 레이어"
type: docs
weight: 2020
...
Fill 레이어. 색상 채우기, 그라디언트 채우기 또는 패턴 채우기 레이어로, [`FillSettings`](./fillsettings/)에 따라 다릅니다.
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | 채우기 설정을 가져오거나 설정합니다. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | 채우기의 유형을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | `FillLayer` 클래스의 새 인스턴스를 채우기 유형으로 빌드합니다. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | 투명하지 않은 모든 색상을 새 색상으로 교체하고 원래 알파 값을 유지하여 부드러운 가장자리를 보존합니다. 참고: 투명도가 없는 이미지에 사용하면 모든 색상이 하나의 색상으로 교체됩니다. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | 현재 [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/)를 기반으로 채우기 레이어의 픽셀 데이터를 업데이트합니다. |
