...
description: Aspose.PSD.FileFormats.Psd.Resources.ThumbnailResource 수업. 썸네일 리소스 블록.
type: docs
weight: 3910
...
| [Height](../../aspose.psd.fileformats.psd.resources/thumbnailresource/height/) { get; set; } | 축소판의 높이를 픽셀 단위로 가져오거나 설정합니다. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| [JpegOptions](../../aspose.psd.fileformats.psd.resources/thumbnailresource/jpegoptions/) { get; set; } | JPEG 옵션을 가져오거나 설정합니다. 썸네일 리소스가 JPEG 파일 형식으로만 저장되는 경우에 적합합니다. 이 옵션은 RAW 형식이 정의된 경우에는 적용되지 않습니다. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/thumbnailresource/minimalversion/) { get; } | 최소한의 필수 psd 버전을 가져옵니다. |
...
| [PlanesCount](../../aspose.psd.fileformats.psd.resources/thumbnailresource/planescount/) { get; set; } | 평면 수를 가져오거나 설정합니다. |
...
| [SizeAfterCompression](../../aspose.psd.fileformats.psd.resources/thumbnailresource/sizeaftercompression/) { get; } | 압축 후 크기를 가져오거나 설정합니다. 일관성 검사에 사용됩니다. |
...
| [TotalSize](../../aspose.psd.fileformats.psd.resources/thumbnailresource/totalsize/) { get; } | 총 데이터 크기를 가져옵니다. |
...
| override [ValidateValues](../../aspose.psd.fileformats.psd.resources/thumbnailresource/validatevalues/)() | 리소스 값의 유효성을 검사합니다. |
