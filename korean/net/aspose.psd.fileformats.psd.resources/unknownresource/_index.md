...
description: Aspose.PSD.FileFormats.Psd.Resources.UnknownResource 수업. 알 수 없는 리소스입니다. 리소스 블록이 인식되지 않으면 이 리소스 블록이 생성됩니다.
type: docs
weight: 3940
...
알 수 없는 리소스입니다. 리소스 블록이 인식되지 않으면 이 리소스 블록이 생성됩니다.
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/unknownresource/minimalversion/) { get; } | 최소한의 필수 psd 버전을 가져옵니다. |
