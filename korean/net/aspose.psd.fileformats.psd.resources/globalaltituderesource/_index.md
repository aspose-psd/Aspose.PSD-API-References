---
title: "클래스 GlobalAltitudeResource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Resources.GlobalAltitudeResource 클래스. 전역 고도 리소스"
type: docs
weight: 4180
url: /ko/net/aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
{{< psd/tize >}}
...
| 이름 | 설명 |
| --- | --- |
| [GlobalAltitudeResource](globalaltituderesource/)() | 기본 생성자입니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Altitude](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/altitude/) { get; set; } | 고도를 가져오거나 설정합니다. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/datasize/) { get; } | 리소스 데이터 크기를 바이트 단위로 가져옵니다. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/globalaltituderesource/minimalversion/) { get; } | 필요한 최소 PSD 버전을 가져옵니다. |
