...
description: Aspose.PSD.FileFormats.Psd.Resources.XmpResource 수업. XMP 메타데이터 리소스를 나타냅니다.
type: docs
weight: 3990
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/xmpresource/minimalversion/) { get; } | 최소한의 필수 psd 버전을 가져옵니다. |
...
| [XmpData](../../aspose.psd.fileformats.psd.resources/xmpresource/xmpdata/) { get; set; } | XMP 데이터 가져오기 또는 설정 container |
