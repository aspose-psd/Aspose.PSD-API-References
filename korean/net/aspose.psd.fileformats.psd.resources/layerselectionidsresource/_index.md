...
description: Aspose.PSD.FileFormats.Psd.Resources.LayerSelectionIdsResource 수업. 레이어 선택 ID resource
type: docs
weight: 3800
...
| 이름 | 설명 |
| --- | --- |
| [Count](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/count/) { get; set; } | 개수를 가져오거나 설정합니다. |
