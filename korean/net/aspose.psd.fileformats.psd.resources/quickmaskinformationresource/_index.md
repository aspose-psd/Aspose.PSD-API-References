...
description: Aspose.PSD.FileFormats.Psd.Resources.QuickMaskInformationResource 수업. 빠른 마스크 정보 resource
type: docs
weight: 3850
...
| [IsMaskEmpty](../../aspose.psd.fileformats.psd.resources/quickmaskinformationresource/ismaskempty/) { get; set; } | 이 인스턴스가 비어 있는지 여부를 나타내는 값을 가져오거나 설정합니다. |
