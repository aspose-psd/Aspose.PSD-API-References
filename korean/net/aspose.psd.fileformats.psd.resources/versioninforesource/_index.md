...
description: Aspose.PSD.FileFormats.Psd.Resources.VersionInfoResource 수업. 버전 정보 resource
type: docs
weight: 3960
...
| [HasRealMergedData](../../aspose.psd.fileformats.psd.resources/versioninforesource/hasrealmergeddata/) { get; set; } | 이 인스턴스에 실제로 병합된 데이터가 있는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [ReaderName](../../aspose.psd.fileformats.psd.resources/versioninforesource/readername/) { get; set; } | 판독기의 이름을 가져오거나 설정합니다. |
...
| [WriterName](../../aspose.psd.fileformats.psd.resources/versioninforesource/writername/) { get; set; } | 작성자의 이름을 가져오거나 설정합니다. |
