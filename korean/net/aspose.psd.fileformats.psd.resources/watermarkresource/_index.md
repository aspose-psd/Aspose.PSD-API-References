---
title: "클래스 WatermarkResource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Resources.WatermarkResource 클래스. 워터마크 리소스"
type: docs
weight: 4440
url: /ko/net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
{{< psd/tize >}}
...
| 이름 | 설명 |
| --- | --- |
| [WatermarkResource](watermarkresource/)() | 기본 생성자입니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/watermarkresource/datasize/) { get; } | 리소스 데이터 크기를 바이트 단위로 가져옵니다. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| [IsWatermark](../../aspose.psd.fileformats.psd.resources/watermarkresource/iswatermark/) { get; set; } | 이 인스턴스가 워터마크인지 여부를 나타내는 값을 가져오거나 설정합니다. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/watermarkresource/minimalversion/) { get; } | 필요한 최소 PSD 버전을 가져옵니다. |
