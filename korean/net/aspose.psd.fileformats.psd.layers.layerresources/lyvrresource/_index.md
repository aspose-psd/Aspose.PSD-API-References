---
title: "클래스 LyvrResource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource 클래스. 레이어의 포토샵 버전을 나타내는 리소스"
type: docs
weight: 3150
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

레이어의 Photoshop 버전을 나타내는 리소스.
...
| 이름 | 설명 |
| --- | --- |
| [LyvrResource](lyvrresource/)() | 기본 생성자입니다. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | 레이어의 포토샵 버전을 가져오거나 설정합니다. |

## 메서드

| 이름 | 설명 |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | 리소스를 지정된 스트림 컨테이너에 저장합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | 타입 툴 정보 키. |
