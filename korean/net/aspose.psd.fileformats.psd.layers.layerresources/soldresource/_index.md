---
title: "클래스 SoLdResource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource 클래스. SoLdResource 클래스를 정의하며, PSD 파일의 스마트 오브젝트 레이어에 대한 정보를 포함합니다. Adobe Photoshop 이미지에서 스마트 오브젝트 레이어를 지원하는 데 사용됩니다."
type: docs
weight: 3370
...
SoLdResource 클래스를 정의하며 PSD 파일의 스마트 객체 레이어에 대한 정보를 포함합니다. Adobe� Photoshop� 이미지에서 스마트 객체 레이어를 지원하는 데 사용됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [SoLdResource](soldresource/#constructor)() | 새 `SoLdResource` 클래스의 인스턴스를 초기화합니다. 이 기본 생성자는 SoLdResourceLoader에서 사용하도록 설계되었습니다. SoLdResource 클래스를 생성하려면 [`SmartResourceCreator`](../smartresourcecreator/)를 사용하십시오. |
| [SoLdResource](soldresource/#constructor_1)(Guid, bool, bool) | 새 `SoLdResource` 클래스의 인스턴스를 초기화합니다. 준비된 인스턴스를 얻으려면 Items 속성을 설정하거나 InitializeItems()를 호출해야 합니다. 이 생성자는 [`SmartResourceCreator`](../smartresourcecreator/)에서 사용하고 단위 테스트에서도 사용하도록 설계되었습니다. SoLdResource 클래스를 생성하려면 [`SmartResourceCreator`](../smartresourcecreator/)를 사용하십시오. |
...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | PSD 이미지에서 스마트 오브젝트 레이어 데이터 [`SmartObjectResource`](../smartobjectresource/)의 전역 고유 식별자를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | 타입 도구 정보 키: 'SoLd'. |
