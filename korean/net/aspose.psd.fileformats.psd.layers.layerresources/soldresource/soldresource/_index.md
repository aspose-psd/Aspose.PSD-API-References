...
description: "SoLdResource 생성자. SoLdResource 클래스의 새 인스턴스를 초기화합니다. 준비된 인스턴스를 얻으려면 Items 속성을 설정하거나 InitializeItems를 호출해야 합니다. 이 생성자는 SmartResourceCreator와 단위 테스트에서 사용하도록 설계되었습니다. SoLdResource 클래스를 만들 때 SmartResourceCreator를 사용하십시오."
type: docs
weight: 10
...
[`SoLdResource`](../) 클래스의 새 인스턴스를 초기화합니다. 준비된 인스턴스를 얻으려면 Items 속성을 설정하거나 InitializeItems()를 호출해야 합니다. 이 생성자는 [`SmartResourceCreator`](../../smartresourcecreator/)와 단위 테스트에서 사용하도록 설계되었습니다. SoLdResource 클래스를 만들 때 [`SmartResourceCreator`](../../smartresourcecreator/)를 사용하십시오.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| uniqueId | Guid | 스마트 객체 레이어 데이터 [`SoLdResource`](../)의 고유 식별자입니다. |
| isCustom | Boolean | `true` 로 설정된 경우 [사용자 정의]입니다. |
| hasCompInfo | Boolean | 설정이 `true`이면 [컴포넌트 정보가 있음]. |
...
[`SoLdResource`](../) 클래스의 새 인스턴스를 초기화합니다. 이 기본 생성자는 SoLdResourceLoader에서 사용하도록 설계되었습니다. SoLdResource 클래스를 만들 때 [`SmartResourceCreator`](../../smartresourcecreator/)를 사용하십시오.
