...
description: "BaseLayerSectionResource 속성. 블렌드 모드 키를 가져오거나 설정합니다"
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/baselayersectionresource/blendmodekey/
---
{{< psd/tize >}}
...
| 예외 | 조건 |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | BlendModeKey는 길이가 4자여야 합니다. |
