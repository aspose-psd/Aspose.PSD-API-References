...
description: LinkResource 재산. 가져오기LinkDataSource 링크 데이터 소스 고유 식별자인 지정된 인덱스에서..
type: docs
weight: 30
...
가져오기[`LinkDataSource`](../../linkdatasource/) 링크 데이터 소스 고유 식별자인 지정된 인덱스에서..
...
[`LinkDataSource`](../../linkdatasource/) 인스턴스.
