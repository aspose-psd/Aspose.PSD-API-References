...
description: LiFeDataSource 재산. Adobe Photoshop CC 라이브러리에 대한 그래픽 라이브러리 요소 참조를 가져오거나 설정합니다.
type: docs
weight: 60
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
## LiFeDataSource.ElementRef property

Adobe® Photoshop® CC 라이브러리에 대한 그래픽 라이브러리 요소 참조를 가져오거나 설정합니다.
...
| 예외 | 상태 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | ElementRef 속성에 액세스할 수 없습니다. IsLibrary가 true 인 경우 liFE 데이터 소스에만 사용할 수 있습니다. |
