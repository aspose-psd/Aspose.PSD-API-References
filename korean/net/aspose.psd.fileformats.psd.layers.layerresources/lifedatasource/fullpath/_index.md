...
description: "LiFeDataSource 속성. 외부 파일의 전체 경로를 LiFE 데이터 소스의 PSD LnkE 리소스에서 가져오거나 설정합니다."
type: docs
weight: 90
...
| 예외 | 조건 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FullPath 속성에 접근할 수 없습니다. 이 속성은 liFE 데이터 소스에서만 사용할 수 있습니다. |
