...
description: LiFeDataSource 재산. PSD LnkE 리소스의 LiFE 데이터 소스에 있는 외부 파일의 전체 경로를 가져오거나 설정합니다.
type: docs
weight: 90
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
...
| 예외 | 상태 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FullPath 속성에 액세스할 수 없습니다. liFE 데이터 source 에만 사용할 수 있습니다. |
