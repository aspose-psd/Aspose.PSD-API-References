...
description: "LiFeDataSource 속성. PSD LnkE 리소스의 LiFE 데이터 소스에서 외부 파일의 크기를 가져오거나 설정합니다"
type: docs
weight: 80
...
| 예외 | 조건 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | FileSize 속성에 접근할 수 없습니다. liFE 데이터 소스에서만 사용할 수 있습니다 |
