...
description: LiFeDataSource 재산. Adobe Photoshop CC 라이브러리용 그래픽 라이브러리 AdobeStockId를 가져오거나 설정합니다.
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

Adobe® Photoshop® CC 라이브러리용 그래픽 라이브러리 AdobeStockId를 가져오거나 설정합니다.
...
그래픽 라이브러리 Adobe Stock Identifier.

### 예외

| 예외 | 상태 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | AdobeStockId 속성에 액세스할 수 없습니다. IsLibrary가 true 인 경우 liFE 데이터 소스에만 사용할 수 있습니다. |
