...
description: "LiFeDataSource 속성. Adobe Photoshop CC 라이브러리를 위한 그래픽 라이브러리 AdobeStockId를 가져오거나 설정합니다"
type: docs
weight: 20
...
그래픽 라이브러리 Adobe Stock 식별자.

### 예외

| 예외 | 조건 |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | AdobeStockId 속성에 접근할 수 없습니다. IsLibrary가 true일 때만 liFE 데이터 소스에서 사용할 수 있습니다 |
