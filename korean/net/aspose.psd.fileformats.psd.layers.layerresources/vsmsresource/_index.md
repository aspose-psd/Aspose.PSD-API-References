---
title: "클래스 VsmsResource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VsmsResource 클래스. VsmsResource 클래스. 이 리소스는 벡터 레이어 마스크에 대한 정보를 포함합니다."
type: docs
weight: 3780
...
VsmsResource 클래스. 이 리소스는 벡터 레이어 마스크에 대한 정보를 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [VsmsResource](vsmsresource/#constructor)() | `VsmsResource` 클래스의 새 인스턴스를 초기화합니다. |
| [VsmsResource](vsmsresource/#constructor_1)(byte[]) | `VsmsResource` 클래스의 새 인스턴스를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/typetoolkey/) | 타입 툴 정보 키. |
