...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VsmsResource 수업. 클래스 VsmsResource. 이 리소스에는 벡터 레이어 mask 에 대한 정보가 포함되어 있습니다.
type: docs
weight: 3380
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/
---
## VsmsResource class
...
| 이름 | 설명 |
| --- | --- |
| [VsmsResource](vsmsresource/#constructor)() | 의 새 인스턴스를 초기화합니다.`VsmsResource` 클래스. |
| [VsmsResource](vsmsresource/#constructor_1)(byte[]) | 의 새 인스턴스를 초기화합니다.`VsmsResource` 클래스. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/key/) { get; } | 레이어 리소스 키를 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/typetoolkey/) | 유형 도구 정보 키입니다. |
