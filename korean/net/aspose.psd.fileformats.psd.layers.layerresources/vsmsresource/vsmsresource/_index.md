...
description: VsmsResource 건설자. 의 새 인스턴스를 초기화합니다.VsmsResource 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/vsmsresource/
---
## VsmsResource(byte[]) {#constructor_1}

의 새 인스턴스를 초기화합니다.[`VsmsResource`](../) 클래스.
...
| 예외 | 상태 |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | 잘못된 Vsms 리소스 값 |

### 또한보십시오

* class [VsmsResource](../)
* 네임스페이스 [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../vsmsresource/)
* 집회 [Aspose.PSD](../../../)
