...
description: "ArtBResource 속성. ArtboardBackgroundType을 가져오거나 설정합니다"
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/artboardbackgroundtype/
---
{{< psd/tize >}}
## ArtBResource.ArtboardBackgroundType property

`ArtboardBackgroundType`을 가져오거나 설정합니다
