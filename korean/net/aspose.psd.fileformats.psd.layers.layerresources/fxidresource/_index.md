---
title: "클래스 FXidResource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.FXidResource 클래스. 필터 효과 리소스는 스마트 필터를 위한 채널, 사용자 마스크 및 시트 마스크를 포함합니다."
type: docs
weight: 2720
...
필터 효과 리소스에는 채널, 사용자 마스크 및 스마트 필터용 시트 마스크가 포함됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [FXidResource](fxidresource/)(int, int, FilterEffectMaskData[]) | `FXidResource` 클래스의 새 인스턴스를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [FEidTypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/fxidresource/feidtypetoolkey/) | 타입 도구 정보 키 FEid. |
| const [FXidTypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/fxidresource/fxidtypetoolkey/) | 타입 도구 정보 키 FXid. |
