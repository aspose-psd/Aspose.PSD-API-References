...
description: "PlacedResource 속성. 배치 레이어의 총 페이지 수를 가져오거나 설정합니다. PSD 파일에서"
type: docs
weight: 150
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/totalpages/
---
{{< psd/tize >}}
## PlacedResource.TotalPages property

PSD 파일에서 배치된 레이어의 전체 페이지 수를 가져오거나 설정합니다.
