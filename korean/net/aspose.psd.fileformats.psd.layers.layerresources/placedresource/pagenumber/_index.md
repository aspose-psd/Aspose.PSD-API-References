...
description: "PlacedResource 속성. 배치된 레이어의 페이지 번호를 가져오거나 설정합니다. PSD 파일에서"
type: docs
weight: 90
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/pagenumber/
---
{{< psd/tize >}}
## PlacedResource.PageNumber property

PSD 파일에서 배치된 레이어의 페이지 번호를 가져오거나 설정합니다.
