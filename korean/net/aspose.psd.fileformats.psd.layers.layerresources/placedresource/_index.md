...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlacedResource 수업. PSD 파일에서 배치된 레이어 또는 스마트 개체 레이어에 대한 공통 정보를 포함하는 PlacedResource 클래스를 정의합니다. Adobe Photoshop 이미지에서 스마트 개체 레이어를 지원하는 데 사용됩니다.
type: docs
weight: 2940
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/
---
## PlacedResource class

PSD 파일에서 배치된 레이어 또는 스마트 개체 레이어에 대한 공통 정보를 포함하는 PlacedResource 클래스를 정의합니다. Adobe® Photoshop® 이미지에서 스마트 개체 레이어를 지원하는 데 사용됩니다.
...
| abstract [PsdVersion](../../aspose.psd.fileformats.psd.layers/layerresource/psdversion/) { get; } | 레이어 리소스에 필요한 최소 psd 버전을 가져옵니다. 0은 제한이 없음을 나타냅니다. |
...
| override [Signature](../../aspose.psd.fileformats.psd.layers.layerresources/placedresource/signature/) { get; } | 배치된 리소스 서명을 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| abstract [Save](../../aspose.psd.fileformats.psd.layers/layerresource/save/)(StreamContainer, int) | 리소스를 지정된 스트림 컨테이너에 저장합니다. |
