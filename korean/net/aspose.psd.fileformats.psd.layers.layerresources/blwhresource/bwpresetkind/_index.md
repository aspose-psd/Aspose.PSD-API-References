...
description: "BlwhResource 속성. 흑백 프리셋 종류 값을 가져오거나 설정합니다."
type: docs
weight: 40
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/blwhresource/bwpresetkind/
---
{{< psd/tize >}}
## BlwhResource.BwPresetKind property

흑백 프리셋 종류 값을 가져오거나 설정합니다.
