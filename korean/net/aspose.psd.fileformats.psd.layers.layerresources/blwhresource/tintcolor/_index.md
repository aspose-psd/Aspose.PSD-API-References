...
description: "BlwhResource property. Tint Color ARGB 값을 가져오거나 설정합니다"
type: docs
weight: 100
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/blwhresource/tintcolor/
---
{{< psd/tize >}}
## BlwhResource.TintColor property

Tint Color ARGB 값을 가져오거나 설정합니다.
