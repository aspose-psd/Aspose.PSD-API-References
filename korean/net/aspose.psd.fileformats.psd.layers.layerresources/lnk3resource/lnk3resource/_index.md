...
description: Lnk3Resource 건설자. 의 새 인스턴스를 초기화합니다.Lnk3Resource 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lnk3resource/lnk3resource/
---
## Lnk3Resource constructor

의 새 인스턴스를 초기화합니다.[`Lnk3Resource`](../) 클래스.
