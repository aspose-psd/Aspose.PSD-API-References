---
title: "클래스 LinkDataSource"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LinkDataSource 클래스. PSD 파일에 연결된 파일이나 자산에 대한 정보를 포함하는 LinkDataSource 클래스를 정의합니다."
type: docs
weight: 2990
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/
---
{{< psd/tize >}}
## LinkDataSource class

PSD 파일에서 링크된 파일 또는 자산에 대한 정보를 포함하는 LinkDataSource 클래스를 정의합니다.
