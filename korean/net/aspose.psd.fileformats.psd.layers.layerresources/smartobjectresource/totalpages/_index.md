...
description: SmartObjectResource 재산. PSD 파일에서 스마트 개체 레이어 데이터의 총 페이지 수를 가져오거나 설정합니다.
type: docs
weight: 220
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/totalpages/
---
## SmartObjectResource.TotalPages property

PSD 파일에서 스마트 개체 레이어 데이터의 총 페이지 수를 가져오거나 설정합니다.
