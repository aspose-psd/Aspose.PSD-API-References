...
description: "SmartObjectResource 속성. PSD 파일의 스마트 오브젝트 레이어 데이터 총 페이지 수를 가져오거나 설정합니다."
type: docs
weight: 200
...
PSD 파일의 스마트 오브젝트 레이어 데이터 전체 페이지 수를 가져오거나 설정합니다.
