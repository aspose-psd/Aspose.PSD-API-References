...
description: Lnk2Resource 재산. 가져오기LiFdDataSource 지정된 index. 에서
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
## Lnk2Resource indexer

가져오기[`LiFdDataSource`](../../lifddatasource/) 지정된 index. 에서
...
[`LiFdDataSource`](../../lifddatasource/) 인스턴스.
...
* class [Lnk2Resource](../)
* 네임스페이스 [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lnk2resource/)
* 집회 [Aspose.PSD](../../../)
