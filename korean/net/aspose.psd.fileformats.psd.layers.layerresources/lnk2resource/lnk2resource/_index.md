...
description: Lnk2Resource 건설자. 의 새 인스턴스를 초기화합니다.Lnk2Resource 클래스.
type: docs
weight: 10
url: /ko/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/lnk2resource/
---
## Lnk2Resource constructor

의 새 인스턴스를 초기화합니다.[`Lnk2Resource`](../) 클래스.
