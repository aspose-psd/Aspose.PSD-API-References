...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VmskResource 클래스. VmskResource 클래스. 이 리소스는 벡터 레이어 마스크에 대한 정보를 포함합니다."
type: docs
weight: 3760
...
| 이름 | 설명 |
| --- | --- |
| [VmskResource](vmskresource/#constructor)() | `VmskResource` 클래스의 새 인스턴스를 초기화합니다. |
| [VmskResource](vmskresource/#constructor_1)(byte[]) | `VmskResource` 클래스의 새 인스턴스를 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/vmskresource/typetoolkey/) | 타입 툴 정보 키. |
