...
description: "TiffSRational 메서드. 제공된 값을 분수로 근사합니다"
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.tiff/tiffsrational/approximatefraction/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| 값 | Double | 값. |
| epsilon | Double | 오류가 허용됩니다. |

### 반환 값

오차가 *epsilon*보다 작은 유리수.
