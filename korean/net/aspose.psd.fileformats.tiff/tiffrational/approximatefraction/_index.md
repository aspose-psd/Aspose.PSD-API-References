...
description: TiffRational 방법. 제공된 값을 분수로 근사화합니다.
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.tiff/tiffrational/approximatefraction/
---
...
| --- | --- | --- |
| value | Double | 가치. |
| epsilon | Double | 오류가 허용되었습니다. |

### 반환 값

오차가 다음보다 작은 유리수*epsilon*.
...
오차가 다음보다 작은 유리수[`Epsilon`](../epsilon/) .
