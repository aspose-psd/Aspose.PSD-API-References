...
description: "IRasterImageRawDataLoader 속성. 현재 원시 데이터 설정을 가져옵니다. 이 설정을 사용할 때 데이터가 변환 없이 로드된다는 점에 유의하십시오"
type: docs
weight: 20
url: /ko/net/aspose.psd/irasterimagerawdataloader/rawdatasettings/
---
{{< psd/tize >}}
