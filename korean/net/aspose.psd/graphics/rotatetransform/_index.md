...
description: "Graphics 메서드. 지정된 양만큼 로컬 기하 변환을 회전시킵니다. 이 메서드는 회전을 변환 앞에 추가합니다."
type: docs
weight: 450
url: /ko/net/aspose.psd/graphics/rotatetransform/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| 각도 | 단일 | 회전 각도입니다. |
| order | MatrixOrder | A [`MatrixOrder`](../../matrixorder/)은 회전 행렬을 추가하거나 앞에 붙일지를 지정합니다. |
