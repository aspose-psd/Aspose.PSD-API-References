...
description: CmykColorHelper 방법. 사용자 정의 ICC 프로파일을 사용하여 RGB를 CMYK로 변환합니다.
type: docs
weight: 120
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| pixels | Int32[] | RGB 색상은 32비트 정수 값으로 표시됩니다. |
| startIndex | Int32 | RGB 색상의 시작 인덱스입니다. |
| length | Int32 | 변환할 RGB 픽셀 수입니다. |
| rgbIccStream | Stream | RGB 프로파일 스트림. |
| cmykIccStream | Stream | CMYK 프로필 스트림입니다. |

### 반환 값

바이트 배열로 표시되는 CMYK 색상입니다.
