...
description: "ITextStyle 메서드. 지정된 스타일이 같은지 여부를 판단합니다"
type: docs
weight: 290
url: /ko/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
{{< psd/tize >}}
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| style | ITextStyle | 스타일입니다. |

### 반환 값

`true`이면 지정된 스타일이 같으며, 그렇지 않으면 `false`.
