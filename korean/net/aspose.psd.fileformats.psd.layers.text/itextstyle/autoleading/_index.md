...
description: "ITextStyle 속성. 자동 행간 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 20
url: /ko/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
{{< psd/tize >}}
## ITextStyle.AutoLeading property

[자동 리딩] 여부를 나타내는 값을 가져오거나 설정합니다.
...
`true`이면 [automatic leading]; 그렇지 않으면 `false`.
