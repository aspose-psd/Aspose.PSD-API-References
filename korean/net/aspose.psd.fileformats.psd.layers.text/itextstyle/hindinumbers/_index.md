...
description: "ITextStyle 속성. 힌디어 숫자 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 150
url: /ko/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
{{< psd/tize >}}
## ITextStyle.HindiNumbers property

값을 가져오거나 설정하여 [hindi numbers] 여부를 나타냅니다.
...
`true`이면 [hindi numbers]; 그렇지 않으면 `false`.
