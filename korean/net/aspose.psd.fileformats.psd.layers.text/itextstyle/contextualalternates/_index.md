...
description: ITextStyle 재산. 문자를 함께 연결하는 데 사용되는 문맥 대체.
type: docs
weight: 40
url: /ko/net/aspose.psd.fileformats.psd.layers.text/itextstyle/contextualalternates/
---
## ITextStyle.ContextualAlternates property

문자를 함께 연결하는 데 사용되는 문맥 대체.
