...
description: ITextParagraph 방법. 지정된 단락이 같은지 여부를 결정합니다.
type: docs
weight: 230
url: /ko/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/isequal/
---
...
| 모수 | 유형 | 설명 |
| --- | --- | --- |
| paragraph | ITextParagraph | 단락. |

### 반환 값

`진실` 지정된 단락이 동일한 경우; 그렇지 않으면,`거짓` .
