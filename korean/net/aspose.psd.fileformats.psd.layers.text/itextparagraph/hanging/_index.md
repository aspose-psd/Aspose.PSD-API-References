...
description: "ITextParagraph 속성. 이 ITextParagraph가 걸려 있는지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 90
...
이 [`ITextParagraph`](../)가 걸려 있는지 여부를 나타내는 값을 가져오거나 설정합니다.
