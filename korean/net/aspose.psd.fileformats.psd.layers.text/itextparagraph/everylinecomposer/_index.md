...
description: "ITextParagraph 속성. 모든 줄 작곡기 여부를 나타내는 값을 가져오거나 설정합니다"
type: docs
weight: 60
...
값을 가져오거나 설정합니다. 이는 [every line composer] 여부를 나타냅니다.
...
`true`이면 [every line composer]; 그렇지 않으면 `false`.
