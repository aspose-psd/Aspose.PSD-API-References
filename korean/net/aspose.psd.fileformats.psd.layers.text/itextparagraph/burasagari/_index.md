...
description: "ITextParagraph 속성. 이 ITextParagraph가 버라사기리인지 여부를 나타내는 값을 가져오거나 설정합니다."
type: docs
weight: 30
...
이 [`ITextParagraph`](../)가 버라사기리인지 여부를 나타내는 값을 가져오거나 설정합니다.
