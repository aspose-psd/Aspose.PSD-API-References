...
description: "Aspose.PSD.FileFormats.Psd.Layers.Layer 클래스. PSD 레이어"
type: docs
weight: 2270
...
| 이름 | 설명 |
| --- | --- |
| [Layer](layer/#constructor)() | `Layer` 클래스의 새 인스턴스를 초기화합니다. 지연 초기화를 위한 생성자. |
| [Layer](layer/#constructor_3)(Stream) | `Layer` 클래스의 새 인스턴스를 초기화합니다. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | `Layer` 클래스의 새 인스턴스를 초기화합니다. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | 바이트 배열에서 `Layer` 클래스의 새 인스턴스를 초기화합니다. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | 객체 데이터를 지정된 스트림에 저장합니다. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | 객체 데이터를 지정된 파일 위치에 저장합니다. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | 객체 데이터를 저장 옵션에 따라 지정된 파일 형식으로 지정된 파일 위치에 저장합니다. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | 이미지 데이터를 저장 옵션에 따라 지정된 파일 형식으로 지정된 스트림에 저장합니다. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | 객체 데이터를 저장 옵션에 따라 지정된 파일 형식으로 지정된 파일 위치에 저장합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | 블렌드 모드 서명을 나타냅니다. |
