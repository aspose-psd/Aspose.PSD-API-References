...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer 수업. psd 레이어.
type: docs
weight: 2080
url: /ko/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| 이름 | 설명 |
| --- | --- |
| [Layer](layer/#constructor)() | 의 새 인스턴스를 초기화합니다.`Layer` 수업. 지연 초기화를 위한 생성자. |
| [Layer](layer/#constructor_3)(Stream) | 의 새 인스턴스를 초기화합니다.`Layer` 클래스. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | 의 새 인스턴스를 초기화합니다.`Layer` 클래스. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | 의 새 인스턴스를 초기화합니다.`Layer` 바이트 배열의 클래스. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | 개체의 데이터를 지정된 스트림에 저장합니다. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | 개체의 데이터를 지정된 파일 위치에 저장합니다. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | 저장 옵션에 따라 객체의 데이터를 지정된 파일 위치에 지정된 파일 형식으로 저장합니다. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | 이미지의 데이터를 저장 옵션에 따라 지정된 파일 형식으로 지정된 스트림에 저장합니다. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | 저장 옵션에 따라 객체의 데이터를 지정된 파일 위치에 지정된 파일 형식으로 저장합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | 혼합 모드 서명을 나타냅니다. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | 레이어 헤더 크기. |
