...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer 수업. 텍스트 레이어 class
type: docs
weight: 3560
url: /ko/net/aspose.psd.fileformats.psd.layers/textlayer/
---
## TextLayer class
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | 글꼴을 가져옵니다. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | layer 의 텍스트를 가져옵니다. |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | 텍스트를 가져옵니다. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | 텍스트 바인딩 상자를 가져오거나 설정합니다. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | 텍스트의 색상을 가져옵니다. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | 텍스트 부분을 가져옵니다. |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | 최상위 레이어 위치를 가져오거나 설정합니다. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | 변환 매트릭스 를 가져오거나 설정합니다. |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | 텍스트 레이어의 글꼴 세트를 가져옵니다. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | 이미지 크기를 조정합니다. 기본값LeftTopToLeftTop사용중입니다. |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | 텍스트를 업데이트합니다. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | 텍스트를 업데이트합니다. |
