...
description: "Aspose.PSD.FileFormats.Psd.Layers.TextLayer 클래스. 텍스트 레이어 클래스"
type: docs
weight: 3980
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | 폰트를 가져옵니다. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | 레이어의 텍스트를 가져옵니다 |
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | 텍스트 경계 상자를 가져오거나 설정합니다. |
...
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | 변환 행렬을 가져오거나 설정합니다. |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | 리소스에서 설정되었거나 가져온 워프 매개변수를 가져오거나 설정합니다 (기본값). |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | 텍스트 레이어의 폰트 집합을 가져옵니다. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | 이미지를 크기 조정합니다. 기본 LeftTopToLeftTop이 사용됩니다. |
