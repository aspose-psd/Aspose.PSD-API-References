---
title: "인터페이스 IShapeLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.IShapeLayer 인터페이스. Shape 레이어의 속성을 설명합니다."
type: docs
weight: 2260
url: /ko/net/aspose.psd.fileformats.psd.layers/ishapelayer/
---
{{< psd/tize >}}
...
| 이름 | 설명 |
| --- | --- |
| [Fill](../../aspose.psd.fileformats.psd.layers/ishapelayer/fill/) { get; set; } | 도형의 내부 영역을 채우는 데 사용되는 채우기 설정. |
| [Path](../../aspose.psd.fileformats.psd.layers/ishapelayer/path/) { get; } | Shape 레이어에 존재하는 Path 집합. |
| [Stroke](../../aspose.psd.fileformats.psd.layers/ishapelayer/stroke/) { get; set; } | 도형의 스트로크 설정. |

## 예제

다음 코드는 도형 스트로크 렌더링 지원을 보여줍니다.
