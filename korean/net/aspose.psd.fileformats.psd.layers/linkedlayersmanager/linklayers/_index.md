...
description: "LinkedLayersManager 메서드. 입력 레이어를 연결하고 LingGroupId를 반환합니다."
type: docs
weight: 30
url: /ko/net/aspose.psd.fileformats.psd.layers/linkedlayersmanager/linklayers/
---
{{< psd/tize >}}
...
| 예외 | 조건 |
| --- | --- |
| ArgumentNullException | 레이어가 null입니다. |
| ArgumentException | 레이어 수는 1보다 커야 합니다. |
| ArgumentException | 각 레이어의 컨테이너는 현재 PsdImage와 동일해야 합니다. |
