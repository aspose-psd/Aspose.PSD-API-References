---
title: "클래스 ArtboardLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer 클래스. 아트보드 레이어 클래스."
type: docs
weight: 1990
url: /ko/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | 아트보드 배경 색상을 가져오거나 설정합니다. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | 블렌드 모드 키를 가져오거나 설정합니다. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | `ArtboardLayer`에 배경 색상이 있는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | 폴더가 열려 있는지 여부를 가져오거나 설정합니다. `true` 로 설정하면 시작 시 그룹이 열려 있는 상태가 되고, 그렇지 않으면 최소화된 상태가 됩니다. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | 레이어 그룹의 레이어를 가져옵니다 |
...
| 이름 | 설명 |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | 레이어를 레이어 그룹에 추가합니다. |
