...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup 수업. 그룹 레이어 class
type: docs
weight: 2220
url: /ko/net/aspose.psd.fileformats.psd.layers/layergroup/
---
## LayerGroup class
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | 혼합 모드 키를 가져오거나 설정합니다. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | 레이어 그룹의 높이를 가져옵니다. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | 가져오거나 설정하면 폴더가 열림 로 설정된 경우`진실` 시작 시 그룹이 열린 상태가 되고 그렇지 않으면 최소화된 상태가 됩니다. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | 레이어 그룹 의 레이어를 가져옵니다. |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | 레이어 그룹의 너비를 가져옵니다. |
...
| 이름 | 설명 |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | 레이어 그룹에 레이어를 추가합니다. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | 레이어 그룹을 추가합니다. |
