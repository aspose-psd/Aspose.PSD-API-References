...
description: LayerResourcesRegistry 방법. 로드LayerResource 지정된 항목에 적합한 첫 번째 발견 오프너 사용stream .
type: docs
weight: 40
...
로드[`LayerResource`](../../layerresource/) 지정된 항목에 적합한 첫 번째 발견 오프너 사용*stream* .
...
로드된[`LayerResource`](../../layerresource/) 또는 오프너가 없으면 null입니다.

### 비고

첫 번째 오프너는 실제로 마지막으로 등록된 것입니다.
