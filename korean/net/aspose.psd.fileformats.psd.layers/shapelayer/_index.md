---
title: "클래스 ShapeLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer 클래스. Shape 레이어. Shape 레이어 및 관련 리소스 작업 로직을 캡슐화합니다."
type: docs
weight: 3820
url: /ko/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

쉐이프 레이어. 쉐이프 레이어와 관련 리소스 작업 로직을 캡슐화합니다.
...
| 이름 | 설명 |
| --- | --- |
| [ShapeLayer](shapelayer/)() | 새 `ShapeLayer` 클래스의 인스턴스를 초기화합니다. 모든 리소스가 기본 상태로 생성됩니다. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Shape 레이어의 도형 내부 영역에 대한 채우기 설정을 가져오거나 설정합니다. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Shape 레이어에 존재하는 Path 집합을 가져옵니다. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | 도형의 스트로크 설정을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | `ShapeLayer` 클래스의 새 인스턴스를 생성합니다. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Shape 레이어 속성에서 리소스를 업데이트합니다. |
