...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer 수업. 폴더의 경계를 표시하는 섹션 구분선 레이어레이어 그룹.
type: docs
weight: 3410
url: /ko/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
## SectionDividerLayer class

폴더의 경계를 표시하는 섹션 구분선 레이어(레이어 그룹).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | 이 인스턴스가 그룹에 있는지 여부를 나타내는 값을 가져옵니다(레이어가 그룹에 없으면 루트 그룹을 의미합니다). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | 가져오기[`LayerGroup`](../layergroup/) 이것과 관련된 것`SectionDividerLayer` 인스턴스. |
