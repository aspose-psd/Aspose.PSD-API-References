---
title: "클래스 SectionDividerLayer"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer 클래스. 폴더 레이어 그룹의 경계를 표시하는 섹션 구분 레이어"
type: docs
weight: 3810
...
폴더(레이어 그룹)의 경계를 표시하기 위한 섹션 구분자 레이어입니다.
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | 이 인스턴스가 그룹 내에서 표시되는지 여부를 나타내는 값을 가져옵니다(레이어가 그룹에 없으면 루트 그룹을 의미합니다). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | `SectionDividerLayer` 인스턴스와 관련된 [`LayerGroup`](../layergroup/)을 가져옵니다. |
