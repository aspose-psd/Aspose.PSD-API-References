---
title: "클래스 LinearGradientBrushBase"
second_title: "Aspose.PSD for .NET API 레퍼런스"
description: "Aspose.PSD.Brushes.LinearGradientBrushBase 클래스. 그라디언트 기능과 적절한 속성을 가진 브러시를 나타냅니다."
type: docs
weight: 150
url: /ko/net/aspose.psd.brushes/lineargradientbrushbase/
---
{{< psd/tize >}}
## LinearGradientBrushBase class

그라디언트 기능과 적절한 속성을 가진 [`Brush`](../../aspose.psd/brush/)를 나타냅니다.
...
| [GammaCorrection](../../aspose.psd.brushes/lineargradientbrushbase/gammacorrection/) { get; set; } | `LinearGradientBrushBase`에 대해 감마 보정이 활성화되어 있는지 여부를 나타내는 값을 가져오거나 설정합니다. |
| [IsAngleScalable](../../aspose.psd.brushes/lineargradientbrushbase/isanglescalable/) { get; set; } | 이 `LinearGradientBrushBase`와 함께 변환 중에 [`Angle`](./angle/)이 변경되는지 여부를 나타내는 값을 가져오거나 설정합니다. |
