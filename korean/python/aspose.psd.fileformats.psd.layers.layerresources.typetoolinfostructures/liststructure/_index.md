---
title: "ListStructure 클래스"
type: docs
weight: 90
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [ListStructure(key_name)](#ListStructure_key_name_1) | 새 인스턴스를 초기화합니다 [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | 구조 키를 식별합니다. |
| items_count | int | r | items count를 가져옵니다. |
| 키 | int | r | 구조 키를 가져옵니다. |
...
| types | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | 구조체 배열의 복사본을 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
새 인스턴스를 초기화합니다 [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/) 클래스.
