---
title: "BooleanStructure 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [BooleanStructure(key_name)](#BooleanStructure_key_name_1) | 새 인스턴스를 초기화합니다 [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| 값 | bool | r/w | boolean 값에 대한 가져오기 및 설정. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
새 인스턴스를 초기화합니다 [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/) 클래스.
