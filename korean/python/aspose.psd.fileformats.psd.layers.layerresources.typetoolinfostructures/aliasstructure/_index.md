---
title: "AliasStructure 클래스"
type: docs
weight: 10
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | 새 인스턴스를 초기화합니다 [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | 구조 키를 식별합니다. |
| data_length | int | r | 바이트 단위의 정확한 데이터 길이를 가져옵니다. |
| full_path | 문자열 | r/w | 전체 경로를 가져오거나 설정합니다. |
| 키 | int | r | 구조 키를 가져옵니다. |
...
새 인스턴스를 초기화합니다 [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) 클래스.
