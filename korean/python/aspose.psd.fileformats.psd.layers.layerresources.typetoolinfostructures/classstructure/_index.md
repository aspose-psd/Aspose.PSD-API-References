---
title: "ClassStructure 클래스"
type: docs
weight: 30
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [ClassStructure(key_name, class_id, structure_key)](#ClassStructure_key_name_class_id_structure_key_1) | 새로운 [ClassStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| STRUCTURE_KEY_CLSS [static] | int | r | 구조 키를 식별합니다. |
| STRUCTURE_KEY_GLBC [static] | int | r | 구조 키를 식별합니다. |
| STRUCTURE_KEY_TYPE [static] | int | r | 구조 키를 식별합니다. |
...
새로운 [ClassStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/) 클래스 인스턴스를 초기화합니다.
