---
title: "DoubleStructure 클래스"
type: docs
weight: 50
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [DoubleStructure(key_name)](#DoubleStructure_key_name_1) | 새 인스턴스를 초기화합니다 [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| 값 | double | r/w | double 값에 대한 가져오기 및 설정. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
새 인스턴스를 초기화합니다 [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) 클래스.
