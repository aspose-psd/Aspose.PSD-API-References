---
title: "IntegerStructure 클래스"
type: docs
weight: 80
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | 새로운 [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | 정수 구조 키입니다. |
| 키 | int | r | 키를 가져옵니다. |
...
새로운 [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/) 클래스 인스턴스를 초기화합니다.
