---
title: "EnumeratedReferenceStructure 클래스"
type: docs
weight: 70
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
| **Name** | **설명** |
| :- | :- |
| [EnumeratedReferenceStructure(key_name, class_id, type_id, enum_name)](#EnumeratedReferenceStructure_key_name_class_id_type_id_enum_name_1) | 새 인스턴스를 초기화합니다 [EnumeratedReferenceStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| ENUMERATED_STRUCTURE_KEY [static] | int | r | 구조 키를 식별합니다. |
| STRUCTURE_KEY [static] | int | r | 열거형 디스크립터 키. |
...
| enum_name | [ClassID](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/classid) | r/w | enum 이름을 가져오거나 설정합니다. |
| 키 | int | r | 키를 가져옵니다. |
...
| type_id | [ClassID](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/classid) | r/w | type ID를 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
새 인스턴스를 초기화합니다 [EnumeratedReferenceStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/) 클래스.
...
| enum_name | [ClassID](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/classid) | enum 이름. |
