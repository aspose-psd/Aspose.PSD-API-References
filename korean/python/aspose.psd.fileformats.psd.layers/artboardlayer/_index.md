---
title: "ArtboardLayer 클래스"
type: docs
weight: 90
url: /ko/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | 아트보드 배경 색상을 가져오거나 설정합니다. |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | 배경 색상이 있는지 여부를 나타내는 값을 가져오거나 설정합니다 [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/). |
...
| is_cached | bool | r |  |
| is_open | bool | r/w | 폴더가 열려 있는지 여부를 가져오거나 설정합니다<br/>            <c>true</c> 로 설정하면 시작 시 그룹이 열린 상태가 되고, 그렇지 않으면 최소화된 상태가 됩니다. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | 레이어 그룹의 레이어를 가져옵니다. |
...
| **Name** | **설명** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | 레이어를 레이어 그룹에 추가합니다. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | 레이어 그룹을 추가합니다. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | 32비트 ARGB 픽셀을 부분적으로(블록 단위로) 로드합니다. |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | 원시 데이터를 로드합니다. |
