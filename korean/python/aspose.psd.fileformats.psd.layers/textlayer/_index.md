...
type: docs
weight: 1750
url: /ko/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | 글꼴을 가져옵니다. |
| has_alpha | bool | r |  |
...
| inner_text | 문자열 | r | 레이어의 텍스트를 가져옵니다 |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | 텍스트 경계 상자를 가져오거나 설정합니다. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | 텍스트의 색상을 가져옵니다. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | 텍스트 부분을 가져옵니다. |
| top | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | 텍스트 레이어의 글꼴 집합을 가져옵니다. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | 이미지 크기를 조정합니다. 기본값 [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/)이 사용됩니다. |
...
| [update_text(text)](#update_text_text_38) | 텍스트를 업데이트합니다. |
| [update_text(text, color)](#update_text_text_color_39) | 텍스트를 업데이트합니다. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | 텍스트를 업데이트합니다. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | 텍스트를 업데이트합니다. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | 텍스트를 업데이트합니다. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | 텍스트를 업데이트합니다. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | 텍스트를 업데이트합니다. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | 텍스트를 업데이트합니다. |
...
| 유형 | 설명 |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | 텍스트 레이어의 글꼴 집합. |
...
이미지 크기를 조정합니다. 기본값 [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/)이 사용됩니다.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | 크기 조정 변환 유형 [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | 문자열 | 텍스트 값. |
| color | [Color](/psd/python-net/aspose.psd/color) | 색상 값. |
...
| :- | :- | :- |
| text | 문자열 | 텍스트 값. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | 왼쪽 위 좌표. |
