---
title: "ShapeLayer 클래스"
type: docs
weight: 1600
url: /ko/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **설명** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 클래스의 새 인스턴스를 초기화합니다.<br/>            모든 리소스가 기본 상태로 생성됩니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Shape 레이어에서 도형의 내부 영역에 대한 채우기 설정을 가져오거나 설정합니다. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Shape 레이어에 존재하는 경로 집합을 가져옵니다. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | 도형의 스트로크 설정을 가져오거나 설정합니다. |
| top | int | r/w |  |
...
| [create_instance()](#create_instance__7) | [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 클래스의 새 인스턴스를 생성합니다. |
...
| update() | Shape 레이어 속성에서 리소스를 업데이트합니다. |
...
[ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 클래스의 새 인스턴스를 초기화합니다.<br/>            모든 리소스가 기본 상태로 생성됩니다.
...
[ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 클래스의 새 인스턴스를 생성합니다.

**Returns**

| 유형 | 설명 |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | 새로운 [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) 클래스 인스턴스를 반환합니다. |
