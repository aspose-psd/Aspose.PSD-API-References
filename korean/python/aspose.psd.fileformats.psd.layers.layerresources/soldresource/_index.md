---
title: "SoLdResource 클래스"
type: docs
weight: 930
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [SoLdResource()](#SoLdResource__1) | 새로운 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 클래스의 인스턴스를 초기화합니다.<br/>            이 기본 생성자는 [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/)에서 사용하도록 설계되었습니다.<br/>            [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)를 사용하여 SoLdResource 클래스를 생성합니다. |
| [SoLdResource(unique_id, is_custom, has_comp_info)](#SoLdResource_unique_id_is_custom_has_comp_info_2) | 새로운 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 클래스의 인스턴스를 초기화합니다.<br/>            준비된 인스턴스를 얻으려면 Items 속성을 설정하거나 InitializeItems()를 호출해야 합니다.<br/>            이 생성자는 [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)에서 사용하도록 설계되었습니다.<br/>            그리고 단위 테스트에서도 사용됩니다.<br/>            SoLdResource 클래스를 생성하려면 [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)를 사용하십시오. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| PSB_RESOURCE_SIGNATURE [static] | int | r | PSB 전용 리소스 서명입니다. |
| RESOURCE_SIGNATURE [static] | int | r | 공통 리소스 서명입니다. |
| TYPE_TOOL_KEY [static] | int | r | 형식 도구 정보 키: 'SoLd'. |
...
새로운 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) 클래스의 인스턴스를 초기화합니다.<br/>            이 기본 생성자는 [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/)에서 사용하도록 설계되었습니다.<br/>            [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)를 사용하여 SoLdResource 클래스를 생성합니다.
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| unique_id | Guid | 스마트 오브젝트 레이어 데이터 [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/)의 고유 식별자입니다. |
