---
title: "VogkResource 클래스"
type: docs
weight: 1110
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/vogkresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [VogkResource()](#VogkResource__1) | 새로운 [VogkResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vogkresource/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| shape_origin_settings | [VectorShapeOriginSettings[]](/psd/python-net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/) | r/w | 모양 원점 설정을 가져오거나 설정합니다. |
...
새로운 [VogkResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vogkresource/) 클래스 인스턴스를 초기화합니다.
