---
title: "Lfx2Resource 클래스"
type: docs
weight: 500
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
| **Name** | **설명** |
| :- | :- |
| [Lfx2Resource()](#Lfx2Resource__1) | Lfx2Resource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| descriptor_version | int | r | 디스크립터 버전을 가져옵니다. |
...
Lfx2Resource 클래스의 새 인스턴스를 초기화합니다.
