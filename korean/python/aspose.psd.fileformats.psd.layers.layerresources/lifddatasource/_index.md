...
type: docs
weight: 510
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/
---
...
| **Name** | **설명** |
| :- | :- |
| [LiFdDataSource()](#LiFdDataSource__1) | [LiFdDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) 클래스의 새 인스턴스를 초기화합니다. |
| [LiFdDataSource(version, unique_id, original_file_name, file_type, file_creator)](#LiFdDataSource_version_unique_id_original_file_name_file_type_file_creator_2) | [LiFdDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| 데이터 | byte | r/w | PSD 파일에 포함된 스마트 객체 데이터를 가져오거나 설정합니다. |
...
[LiFdDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) 클래스의 새 인스턴스를 초기화합니다.
