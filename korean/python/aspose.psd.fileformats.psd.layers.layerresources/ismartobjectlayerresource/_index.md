---
title: "ISmartObjectLayerResource 클래스"
type: docs
weight: 400
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/ismartobjectlayerresource/
---
...
| unique_id | Guid | r/w | PSD 이미지에서 배치된 레이어 또는 스마트 객체의 전역 고유 식별자를 가져오거나 설정합니다. |
