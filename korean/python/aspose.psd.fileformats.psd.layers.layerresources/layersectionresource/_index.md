---
title: "LayerSectionResource 클래스"
type: docs
weight: 460
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [LayerSectionResource()](#LayerSectionResource__1) | 새 인스턴스를 초기화합니다 [LayerSectionResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| section_type | [LayerSectionType](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectiontype) | r/w | 섹션 유형을 가져오거나 설정합니다. |
| signature | int | r | 서명을 가져옵니다. |
| subtype | [LayerSectionSubtype](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionsubtype) | r/w | 하위 유형을 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
새 인스턴스를 초기화합니다 [LayerSectionResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/) 클래스.
