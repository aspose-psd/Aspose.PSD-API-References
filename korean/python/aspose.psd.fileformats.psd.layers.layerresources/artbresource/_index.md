---
title: "ArtBResource 클래스"
type: docs
weight: 50
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [ArtBResource()](#ArtBResource__1) | ArtBResource 클래스의 새 인스턴스를 초기화합니다 |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| artboard_background_type | int | r/w | 다음의 [ArtBResource.artboard_background_type](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/)을 가져오거나 설정합니다 |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | 다음의 [ArtBResource.color](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/)을 가져오거나 설정합니다 |
...
ArtBResource 클래스의 새 인스턴스를 초기화합니다
