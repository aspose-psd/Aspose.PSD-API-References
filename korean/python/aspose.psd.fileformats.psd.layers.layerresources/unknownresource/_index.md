...
type: docs
weight: 1050
url: /ko/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [UnknownResource(signature, key)](#UnknownResource_signature_key_1) | [UnknownResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/) 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| signature | int | r | 레이어 리소스 서명을 가져옵니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
[UnknownResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/unknownresource/) 클래스의 새 인스턴스를 초기화합니다.
