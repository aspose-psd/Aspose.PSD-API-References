...
type: docs
weight: 10
url: /ko/python-net/aspose.psd.exif/exifdata/
---
...
| **Name** | **설명** |
| :- | :- |
| [ExifData()](#ExifData__1) | 새로운 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 클래스 인스턴스를 초기화합니다. |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | 배열의 데이터를 사용하여 새로운 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 클래스 인스턴스를 초기화합니다. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | 배열의 데이터를 사용하여 새로운 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
새로운 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 클래스 인스턴스를 초기화합니다.
...
배열의 데이터를 사용하여 새로운 [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) 클래스 인스턴스를 초기화합니다.
