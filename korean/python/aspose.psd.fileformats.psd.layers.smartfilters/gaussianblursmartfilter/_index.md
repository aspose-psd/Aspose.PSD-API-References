...
type: docs
weight: 20
url: /ko/python-net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/
---
...
| **Name** | **설명** |
| :- | :- |
| [GaussianBlurSmartFilter()](#GaussianBlurSmartFilter__1) | [GaussianBlurSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/) 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| 반경 | double | r/w | 가우시안 스마트 필터의 반경을 가져오거나 설정합니다. |
...
[GaussianBlurSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/gaussianblursmartfilter/) 클래스의 새 인스턴스를 초기화합니다.
