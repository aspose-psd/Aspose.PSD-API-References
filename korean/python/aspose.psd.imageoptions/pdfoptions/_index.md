---
title: "PdfOptions 클래스"
type: docs
weight: 80
url: /ko/python-net/aspose.psd.imageoptions/pdfoptions/
---
...
| **Name** | **설명** |
| :- | :- |
| [PdfOptions()](#PdfOptions__1) | PdfOptions 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| pdf_core_options | [PdfCoreOptions](/psd/python-net/aspose.psd.fileformats.pdf/pdfcoreoptions/) | r/w | PDF 핵심 옵션 |
| pdf_document_info | [PdfDocumentInfo](/psd/python-net/aspose.psd.fileformats.pdf/pdfdocumentinfo/) | r/w | 문서 메타데이터를 가져오거나 설정합니다. |
...
PdfOptions 클래스의 새 인스턴스를 초기화합니다.
