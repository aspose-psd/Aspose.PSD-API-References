---
title: "BmpOptions 클래스"
type: docs
weight: 10
url: /ko/python-net/aspose.psd.imageoptions/bmpoptions/
---
...
| **Name** | **설명** |
| :- | :- |
| [BmpOptions()](#BmpOptions__1) | [BmpOptions](/psd/python-net/aspose.psd.imageoptions/bmpoptions/) 클래스의 새 인스턴스를 초기화합니다. |
| [BmpOptions(bmp_options)](#BmpOptions_bmp_options_2) | [BmpOptions](/psd/python-net/aspose.psd.imageoptions/bmpoptions/) 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
| bits_per_pixel | int | r/w | 이미지 비트당 픽셀 수를 가져오거나 설정합니다. |
| buffer_size_hint | int | r/w | 버퍼 크기 힌트를 가져오거나 설정합니다. 이 힌트는 모든 내부 버퍼에 허용되는 최대 크기로 정의됩니다. |
| compression | [BitmapCompression](/psd/python-net/aspose.psd.fileformats.bmp/bitmapcompression/) | r/w | 압축을 가져오거나 설정합니다. |
...
[BmpOptions](/psd/python-net/aspose.psd.imageoptions/bmpoptions/) 클래스의 새 인스턴스를 초기화합니다.
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| bmp_options | [BmpOptions](/psd/python-net/aspose.psd.imageoptions/bmpoptions) | BMP 옵션. |
