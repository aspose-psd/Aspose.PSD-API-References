---
title: "TransparencyIndexResource 클래스"
type: docs
weight: 260
url: /ko/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | TransparencyIndexResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| transparency_index | short | r/w | 투명 색 인덱스를 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
TransparencyIndexResource 클래스의 새 인스턴스를 초기화합니다.
