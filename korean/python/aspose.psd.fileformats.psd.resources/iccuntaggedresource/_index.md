---
title: "IccUntaggedResource 클래스"
type: docs
weight: 140
url: /ko/python-net/aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [IccUntaggedResource()](#IccUntaggedResource__1) | IccUntaggedResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| profile | byte | r/w | profile을 가져오거나 설정합니다. |
...
IccUntaggedResource 클래스의 새 인스턴스를 초기화합니다.
