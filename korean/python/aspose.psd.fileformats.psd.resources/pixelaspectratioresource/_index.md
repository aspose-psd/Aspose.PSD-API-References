---
title: "PixelAspectRatioResource 클래스"
type: docs
weight: 190
url: /ko/python-net/aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource__1) | PixelAspectRatioResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| aspect_ratio | double | r/w | 가로 세로 비율을 가져오거나 설정합니다. |
...
PixelAspectRatioResource 클래스의 새 인스턴스를 초기화합니다.
