...
type: docs
weight: 290
url: /ko/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | UrlListResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| count | int | r/w | 카운트를 가져오거나 설정합니다. |
| data_size | int | r | 리소스 데이터 크기를 바이트 단위로 가져옵니다. |
| id | short | r/w | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| ids | int | r/w | ids를 가져오거나 설정합니다. |
| longs | int | r/w | longs를 가져오거나 설정합니다. |
...
| texts | 문자열 | r/w | texts를 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
UrlListResource 클래스의 새 인스턴스를 초기화합니다.
