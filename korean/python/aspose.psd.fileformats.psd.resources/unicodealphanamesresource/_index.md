---
title: "UnicodeAlphaNamesResource 클래스"
type: docs
weight: 270
url: /ko/python-net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource__1) | UnicodeAlphaNamesResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| alpha_names | 문자열 | r/w | 알파 이름을 가져오거나 설정합니다. |
...
UnicodeAlphaNamesResource 클래스의 새 인스턴스를 초기화합니다.
