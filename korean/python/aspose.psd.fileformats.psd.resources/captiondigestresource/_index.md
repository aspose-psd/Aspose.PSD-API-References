---
title: "CaptionDigestResource 클래스"
type: docs
weight: 40
url: /ko/python-net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [CaptionDigestResource()](#CaptionDigestResource__1) | CaptionDigestResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| 다이제스트 | byte | r/w | 다이제스트를 가져오거나 설정합니다. |
...
CaptionDigestResource 클래스의 새 인스턴스를 초기화합니다.
