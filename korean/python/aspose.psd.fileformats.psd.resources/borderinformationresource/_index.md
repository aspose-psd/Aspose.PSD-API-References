---
title: "BorderInformationResource 클래스"
type: docs
weight: 30
url: /ko/python-net/aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [BorderInformationResource()](#BorderInformationResource__1) | BorderInformationResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | 테두리 단위를 가져오거나 설정합니다. |
| width | double | r/w | 테두리 너비를 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
BorderInformationResource 클래스의 새 인스턴스를 초기화합니다.
