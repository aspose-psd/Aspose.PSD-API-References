---
title: "QuickMaskInformationResource 클래스"
type: docs
weight: 220
url: /ko/python-net/aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource__1) | QuickMaskInformationResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| channel_id | short | r/w | 채널 식별자를 가져오거나 설정합니다. |
| data_size | int | r | 리소스 데이터 크기를 바이트 단위로 가져옵니다. |
| id | short | r/w | 리소스의 고유 식별자를 가져오거나 설정합니다. |
| is_mask_empty | bool | r/w | 이 인스턴스가 마스크가 비어 있는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
QuickMaskInformationResource 클래스의 새 인스턴스를 초기화합니다.
