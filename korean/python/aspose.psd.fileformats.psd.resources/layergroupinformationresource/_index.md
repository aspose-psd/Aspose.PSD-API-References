---
title: "LayerGroupInformationResource 클래스"
type: docs
weight: 150
url: /ko/python-net/aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource__1) | LayerGroupInformationResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| groups | short | r/w | groups를 가져오거나 설정합니다. |
...
LayerGroupInformationResource 클래스의 새 인스턴스를 초기화합니다.
