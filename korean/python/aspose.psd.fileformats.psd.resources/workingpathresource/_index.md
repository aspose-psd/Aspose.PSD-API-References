---
title: "WorkingPathResource 클래스"
type: docs
weight: 320
url: /ko/python-net/aspose.psd.fileformats.psd.resources/workingpathresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [WorkingPathResource(data_bytes)](#WorkingPathResource_data_bytes_1) | 새 인스턴스를 초기화합니다 [WorkingPathResource](/psd/python-net/aspose.psd.fileformats.psd.resources/workingpathresource/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
새 인스턴스를 초기화합니다 [WorkingPathResource](/psd/python-net/aspose.psd.fileformats.psd.resources/workingpathresource/) 클래스.

**Parameters:**

| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| data_bytes | byte | 벡터 경로의 데이터입니다. |
