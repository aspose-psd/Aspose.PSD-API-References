...
type: docs
weight: 50
url: /ko/python-net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource__1) | ColorHalftoneInformationResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| halftone_data | byte | r/w | halftone 데이터를 가져오거나 설정합니다. |
...
ColorHalftoneInformationResource 클래스의 새 인스턴스를 초기화합니다.
