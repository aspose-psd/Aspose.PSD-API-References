---
title: "BackgroundColorResource 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [BackgroundColorResource()](#BackgroundColorResource__1) | BackgroundColorResource 클래스의 새 인스턴스를 초기화합니다 |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | 배경 색상을 가져오거나 설정합니다. |
...
BackgroundColorResource 클래스의 새 인스턴스를 초기화합니다
