---
title: "GlobalAltitudeResource 클래스"
type: docs
weight: 90
url: /ko/python-net/aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| **Name** | **설명** |
| :- | :- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource__1) | GlobalAltitudeResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| altitude | int | r/w | altitude를 가져오거나 설정합니다. |
...
GlobalAltitudeResource 클래스의 새 인스턴스를 초기화합니다.
