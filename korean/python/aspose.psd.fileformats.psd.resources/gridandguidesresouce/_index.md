---
title: "GridAndGuidesResouce 클래스"
type: docs
weight: 110
url: /ko/python-net/aspose.psd.fileformats.psd.resources/gridandguidesresouce/
---
...
| **Name** | **설명** |
| :- | :- |
| [GridAndGuidesResouce()](#GridAndGuidesResouce__1) | GridAndGuidesResouce 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| grid_cycle_x | int | r/w | 수평 그리드 주기를 가져오거나 설정합니다. 기본값은 576입니다. |
| grid_cycle_y | int | r/w | 수직 그리드 주기를 가져오거나 설정합니다. 기본값은 576입니다. |
| guide_count | int | r | 가이드 리소스 블록 수를 가져옵니다. |
| guides | [GuideResource[]](/psd/python-net/aspose.psd.fileformats.psd.resources/guideresource) | r/w | 가이드를 가져오거나 설정합니다. |
| header_version | int | r/w | 헤더 버전을 가져오거나 설정합니다. 이 값은 항상 1이어야 합니다. |
...
GridAndGuidesResouce 클래스의 새 인스턴스를 초기화합니다.
