---
title: "LayerStateInformationResource 클래스"
type: docs
weight: 180
url: /ko/python-net/aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [LayerStateInformationResource()](#LayerStateInformationResource__1) | 새 인스턴스를 초기화합니다 LayerStateInformationResource 클래스 |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| layer_index | short | r/w | 레이어의 인덱스를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 LayerStateInformationResource 클래스
