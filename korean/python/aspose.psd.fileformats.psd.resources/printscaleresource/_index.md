---
title: "PrintScaleResource 클래스."
type: docs
weight: 210
url: /ko/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | PrintScaleResource 클래스의 새 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| scale | float | r/w | scale을 가져오거나 설정합니다. |
| signature | int | r | 리소스 서명을 가져옵니다. 항상 '8BIM'이어야 합니다. |
| 크기 | int | r | 데이터를 포함한 리소스 블록 크기를 바이트 단위로 가져옵니다. |
| style | short | r/w | style을 가져오거나 설정합니다. |
| x_location | float | r/w | x location을 가져오거나 설정합니다. |
| y_location | float | r/w | y 위치를 가져오거나 설정합니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
PrintScaleResource 클래스의 새 인스턴스를 초기화합니다.
