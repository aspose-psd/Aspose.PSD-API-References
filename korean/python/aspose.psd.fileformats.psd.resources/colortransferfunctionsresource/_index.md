---
title: "ColorTransferFunctionsResource 클래스"
type: docs
weight: 60
url: /ko/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **설명** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | 새 인스턴스를 초기화합니다 ColorTransferFunctionsResource 클래스 |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
| color_transfer_data | byte | r/w | 색상 전송 데이터를 가져오거나 설정합니다. |
...
새 인스턴스를 초기화합니다 ColorTransferFunctionsResource 클래스
