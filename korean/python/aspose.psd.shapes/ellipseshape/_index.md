---
title: "EllipseShape 클래스"
type: docs
weight: 40
url: /ko/python-net/aspose.psd.shapes/ellipseshape/
---
...
| **Name** | **설명** |
| :- | :- |
| [EllipseShape()](#EllipseShape__1) | 새 인스턴스를 초기화합니다 [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) 클래스. |
| [EllipseShape(rectangle)](#EllipseShape_rectangle_2) | 새 인스턴스를 초기화합니다 [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
새 인스턴스를 초기화합니다 [EllipseShape](/psd/python-net/aspose.psd.shapes/ellipseshape/) 클래스.
