---
title: "RectangleShape 클래스"
type: docs
weight: 80
url: /ko/python-net/aspose.psd.shapes/rectangleshape/
---
...
| **Name** | **설명** |
| :- | :- |
| [RectangleShape()](#RectangleShape__1) | 새로운 [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/) 클래스 인스턴스를 초기화합니다. |
| [RectangleShape(rectangle)](#RectangleShape_rectangle_2) | 새로운 [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/) 클래스 인스턴스를 초기화합니다. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
새로운 [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/) 클래스 인스턴스를 초기화합니다.
