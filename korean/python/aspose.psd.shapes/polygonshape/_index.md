---
title: "PolygonShape 클래스"
type: docs
weight: 60
url: /ko/python-net/aspose.psd.shapes/polygonshape/
---
...
| **Name** | **설명** |
| :- | :- |
| [PolygonShape()](#PolygonShape__1) | 새 인스턴스를 초기화합니다. [PolygonShape](/psd/python-net/aspose.psd.shapes/polygonshape/) 클래스. |
| [PolygonShape(points)](#PolygonShape_points_2) | 새 인스턴스를 초기화합니다. [PolygonShape](/psd/python-net/aspose.psd.shapes/polygonshape/) 클래스. |
| [PolygonShape(points, is_closed)](#PolygonShape_points_is_closed_3) | 새 인스턴스를 초기화합니다. [PolygonShape](/psd/python-net/aspose.psd.shapes/polygonshape/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
새 인스턴스를 초기화합니다. [PolygonShape](/psd/python-net/aspose.psd.shapes/polygonshape/) 클래스.
...
| :- | :- | :- |
| points | [PointF[]](/psd/python-net/aspose.psd/pointf) | 포인트 배열. |
| is_closed | bool | 만약 <c>true</c> 로 설정하면 다각형이 닫힙니다. |
