...
type: docs
weight: 50
url: /ko/python-net/aspose.psd.shapes/pieshape/
---
...
| **Name** | **설명** |
| :- | :- |
| [PieShape()](#PieShape__1) | 새 인스턴스를 초기화합니다 [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/) 클래스. |
| [PieShape(rectangle, start_angle, sweep_angle)](#PieShape_rectangle_start_angle_sweep_angle_2) | 새 인스턴스를 초기화합니다 [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/) 클래스. |
## **Properties**
| **Name** | **Type** | **Access** | **설명** |
| :- | :- | :- | :- |
...
새 인스턴스를 초기화합니다 [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/) 클래스.
