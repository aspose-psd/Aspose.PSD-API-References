---
title: "LevelsLayer 클래스"
type: docs
weight: 140
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| left | int | r/w |  |
| 길이 | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | 마스터 채널을 가져옵니다. |
...
| [get_channel(index)](#get_channel_index_8) | 채널을 가져옵니다. |
...
| 유형 | 설명 |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) 인덱스로 |
