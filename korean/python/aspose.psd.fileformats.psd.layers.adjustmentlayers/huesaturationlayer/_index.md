---
title: "HueSaturationLayer 클래스"
type: docs
weight: 120
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | byte | r/w |  |
| colorize | bool | r/w | 이 [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/)가 색상화되는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [get_range(index)](#get_range_index_20) | 범위를 가져옵니다. |
