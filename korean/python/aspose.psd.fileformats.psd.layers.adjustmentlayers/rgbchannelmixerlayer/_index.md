---
title: "RgbChannelMixerLayer 클래스"
type: docs
weight: 180
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 파란 채널을 가져옵니다. |
| 하단 | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 녹색 채널을 가져옵니다. |
| has_alpha | bool | r |  |
...
| raw_line_size | int | r |  |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | 빨간색 채널을 가져옵니다. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | 채널의 인덱스를 가져옵니다. RgbMixerChannel을 반환합니다. |
...
채널의 인덱스를 가져옵니다. RgbMixerChannel을 반환합니다.
