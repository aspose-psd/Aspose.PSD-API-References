---
title: "PhotoFilterLayer 클래스"
type: docs
weight: 160
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| clipping | byte | r/w |  |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | 필터의 RGB 색상을 가져오거나 설정합니다. |
...
| density | int | r/w | 필터의 밀도를 가져오거나 설정합니다. |
