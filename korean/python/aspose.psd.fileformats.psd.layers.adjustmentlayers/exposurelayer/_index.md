---
title: "ExposureLayer 클래스"
type: docs
weight: 100
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| disposed | bool | r |  |
| 노출 | float | r/w | 노출을 가져오거나 설정합니다. PS에서 노출 범위는 -20에서 +20까지입니다. |
| extra_length | int | r |  |
...
| 감마_보정 | float | r/w | 감마 보정을 가져오거나 설정합니다. PS에서 감마 보정 범위는 9.99에서 +0.01까지입니다. |
| has_alpha | bool | r |  |
...
| offset | float | r/w | 오프셋을 가져오거나 설정합니다. PS에서 오프셋 범위는 -0.5에서 +0.5까지입니다. |
| opacity | byte | r/w |  |
