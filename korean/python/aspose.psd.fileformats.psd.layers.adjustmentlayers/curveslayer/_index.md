---
title: "CurvesLayer 클래스"
type: docs
weight: 90
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | r/w | 이 인스턴스가 연속 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
| is_discrete_manager_used | bool | r/w | 이 인스턴스가 이산 관리자를 사용하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [get_curves_manager()](#get_curves_manager__8) | 곡선 관리자를 가져옵니다. |
...
| 유형 | 설명 |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) 또는 [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) 은 IsDiscreteManagerUsed 및 IsContinuousManagerUsed 속성에 따라 달라집니다. |
