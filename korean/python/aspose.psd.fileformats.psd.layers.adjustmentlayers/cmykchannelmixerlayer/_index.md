---
title: "CmykChannelMixerLayer 클래스"
type: docs
weight: 50
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 검은색 채널을 가져옵니다. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 시안 채널을 가져옵니다. |
...
| left | int | r/w |  |
| 길이 | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 마젠타 채널을 가져옵니다. |
| monochrome | bool | r/w | 값을 가져오거나 설정하여 이 [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/)가 단색인지 여부를 나타냅니다. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | 노란색 채널을 가져옵니다. |
## **Methods**
| **Name** | **설명** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | 채널의 인덱스를 가져옵니다. CmykMixerChannel를 반환합니다. |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | 지정된 레이어에 레이어를 병합합니다. |
| normalize_angle() |  |
