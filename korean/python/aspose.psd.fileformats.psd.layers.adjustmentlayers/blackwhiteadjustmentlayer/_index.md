---
title: "BlackWhiteAdjustmentLayer 클래스"
type: docs
weight: 20
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Tint Color 값을 가져오거나 설정합니다. |
| tint_color_blue | double | r/w | Blue Tint Color double 값을 가져오거나 설정합니다. |
| tint_color_green | double | r/w | Green Tint Color double 값을 가져오거나 설정합니다. |
| tint_color_red | double | r/w | Red Tint Color double 값을 가져오거나 설정합니다. |
| top | int | r/w |  |
