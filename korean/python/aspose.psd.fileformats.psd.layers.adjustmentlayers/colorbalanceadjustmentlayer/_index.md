---
title: "ColorBalanceAdjustmentLayer 클래스"
type: docs
weight: 80
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| highlights_cyan_red_balance | short | r/w | Highlights Cyan Red Balance를 가져오거나 설정합니다. |
| highlights_magenta_green_balance | short | r/w | Highlights Magenta Green Balance를 가져오거나 설정합니다. |
| highlights_yellow_blue_balance | short | r/w | Highlights Yellow Blue Balance를 가져오거나 설정합니다. |
...
| left | int | r/w |  |
| 길이 | int | r |  |
| midtones_cyan_red_balance | short | r/w | Midtones Cyan Red Balance를 가져오거나 설정합니다. |
| midtones_magenta_green_balance | short | r/w | Midtones Magenta Green Balance를 가져오거나 설정합니다. |
| midtones_yellow_blue_balance | short | r/w | Midtones Yellow Blue Balance를 가져오거나 설정합니다. |
...
| preserve_luminosity | bool | r/w | 이 [BlncResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/blncresource/)가 광도를 보존하는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| right | int | r/w |  |
| shadows_cyan_red_balance | short | r/w | Shadows Cyan Red Balance를 가져오거나 설정합니다. |
| shadows_magenta_green_balance | short | r/w | Shadows Magenta Green Balance를 가져오거나 설정합니다. |
| shadows_yellow_blue_balance | short | r/w | Shadows YellowBlue Balance를 가져오거나 설정합니다. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | 32비트 ARGB 픽셀을 부분적으로(블록 단위로) 로드합니다. |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | 원시 데이터를 로드합니다. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | 지정된 레이어에 레이어를 병합합니다. |
| normalize_angle() |  |
