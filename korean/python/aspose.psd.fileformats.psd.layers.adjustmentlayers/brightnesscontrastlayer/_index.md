---
title: "BrightnessContrastLayer 클래스"
type: docs
weight: 30
url: /ko/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| 밝기 | int | r/w | 밝기를 가져오거나 설정합니다. PS에서 밝기 범위는 -150에서 +150까지이지만, 우리는 이를 무시합니다. |
...
| 대비 | int | r/w | 대비를 가져오거나 설정합니다. PS에서 대비 범위는 -50에서 +100까지이지만, 우리는 이를 무시합니다. |
