...
description: "Define la clase PlacedResource que contiene información común sobre una capa colocada o una capa de objeto inteligente en el archivo PSD."
type: docs
weight: 12
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
Define la clase PlacedResource que contiene información común sobre una capa colocada o una capa de objeto inteligente en el archivo PSD. Se utiliza para soportar capas de objeto inteligente en las imágenes Adobe\\ufffd Photoshop\\ufffd.
## Campos
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Obtiene o establece los elementos de deformación. |
