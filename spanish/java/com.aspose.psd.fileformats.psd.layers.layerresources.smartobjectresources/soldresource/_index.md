...
description: "Define la clase SoLdResource que contiene información sobre una capa de objeto inteligente en un archivo PSD."
type: docs
weight: 15
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
Define la clase SoLdResource que contiene información sobre una capa de objeto inteligente en un archivo PSD. Se utiliza para admitir capas de objeto inteligente en las imágenes Adobe® Photoshop®.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Inicializa una nueva instancia de la clase [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | Inicializa una nueva instancia de la clase [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## Campos
...
| [TypeToolKey](#TypeToolKey) | La clave de información de la herramienta de tipo: 'SoLd'. |
...
Inicializa una nueva instancia de la clase [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Es necesario establecer la propiedad Items o llamar a InitializeItems() para obtener una instancia lista. Este constructor está diseñado para ser usado por [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) y en pruebas unitarias. Use [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) para crear clases SoLdResource.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| uniqueId | java.util.UUID | El identificador único de los datos de la capa de objeto inteligente [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Inicializa una nueva instancia de la clase [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Este constructor predeterminado está diseñado para ser usado por SoLdResourceLoader. Use [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) para crear clases SoLdResource.
...
La clave de información de la herramienta de tipo: 'SoLd'.
