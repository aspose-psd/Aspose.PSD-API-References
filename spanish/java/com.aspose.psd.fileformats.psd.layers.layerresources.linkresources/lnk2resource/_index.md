...
description: "Define la clase que contiene información sobre archivos incrustados en la imagen de formato PSD."
type: docs
weight: 15
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
Define la clase que contiene información sobre archivos incrustados en la imagen de formato PSD. El recurso de enlace puede contener varias instancias de  LiFdDataSource  que pueden ser accedidas mediante el indexador.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Inicializa una nueva instancia de la clase [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource). |
## Campos
...
| [get_Item(int index)](#get-Item-int-) | Obtiene el  LiFdDataSource  en el índice especificado. |
...
Inicializa una nueva instancia de la clase [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource).
...
Obtiene el  LiFdDataSource  en el índice especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| índice | int | El índice. Valor: El  LiFdDataSource . |
