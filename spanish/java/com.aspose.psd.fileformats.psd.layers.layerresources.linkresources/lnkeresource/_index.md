...
description: "Define la clase LnkeResource que contiene información sobre archivos enlazados externos o recursos en la imagen de formato PSD."
type: docs
weight: 17
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Define la clase LnkeResource que contiene información sobre archivos o recursos externos vinculados en la imagen de formato PSD. El recurso de enlace puede contener varias instancias de [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) que pueden ser accedidas mediante indexador. Esta es una parte de la API de Manipulación del Formato de Archivo PSD que ayuda a modificar archivos de Adobe® Photoshop® programáticamente
## Constructores

| Constructor | Descripción |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Inicializa una nueva instancia de la clase [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource). |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Inicializa una nueva instancia de la clase [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource). |
## Campos
...
| [get_Item(int index)](#get-Item-int-) | Obtiene el [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) en el índice especificado. |
...
Inicializa una nueva instancia de la clase [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource).
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Las fuentes de datos. |
...
Obtiene el [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) en el índice especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | El índice. Valor: El [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource). |
