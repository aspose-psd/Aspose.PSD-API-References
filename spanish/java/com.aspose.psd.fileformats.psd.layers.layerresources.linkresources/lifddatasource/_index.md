...
description: "Define la clase de origen de datos liFD en el archivo PSD que contiene información sobre un archivo incrustado."
type: docs
weight: 10
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
Define la clase de origen de datos liFD en el archivo PSD que contiene información sobre un archivo incrustado. Forma parte de la API de Manipulación de Formato de Archivo PSD que ayuda a modificar archivos Adobe® Photoshop®.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | Inicializa una nueva instancia de la clase [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Inicializa una nueva instancia de la clase [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
## Campos
...
| [getData()](#getData--) | Obtiene o establece los datos del objeto inteligente incrustado en el archivo PSD. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | Obtiene la longitud de los datos incrustados. |
...
| [setData(byte[] value)](#setData-byte---) | Obtiene o establece los datos del objeto inteligente incrustado en el archivo PSD. |
...
Inicializa una nueva instancia de la clase [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource).
...
Obtiene o establece los datos del objeto inteligente incrustado en el archivo PSD.

Valor: Los datos del objeto inteligente incrustado.
...
Obtiene la longitud de los datos incrustados.

Valor: La longitud de los datos incrustados.
