...
description: "Define la clase SmartObjectLayer que contiene un objeto inteligente incrustado en el archivo PSD o vinculado en el archivo externo."
type: docs
weight: 10
url: /es/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Define la clase SmartObjectLayer que contiene un objeto inteligente incrustado en el archivo PSD o un objeto inteligente vinculado en un archivo externo. Con Smart Objects, puedes: Realizar transformaciones no destructivas. Puedes escalar, rotar, sesgar, distorsionar, aplicar transformaciones de perspectiva o deformar una capa sin perder los datos de imagen originales o la calidad porque las transformaciones don\\ufffdt afectan los datos originales. Trabajar con datos vectoriales, como arte vectorial de Illustrator, que de otro modo se rasterizarían. Realizar filtrado no destructivo. Puedes editar los filtros aplicados a Smart Objects en cualquier momento. Editar un Smart Object y actualizar automáticamente todas sus instancias vinculadas. Aplicar una máscara de capa que\\ufffds sea vinculada o desvinculada a la capa Smart Object. Probar varios diseños con imágenes de marcador de posición de baja resolución que luego reemplazas con versiones finales. En Adobe\\ufffd Photoshop\\ufffd, puedes incrustar el contenido de una imagen en un documento PSD. Más información aquí:   Una capa con un objeto inteligente incrustado contiene recursos placed (PlLd) y SoLd con propiedades de objeto inteligente. El recurso PlLd puede estar solo para versiones de PSD older then 10. Estos recursos contienen UniqueId del LiFdDataSource en el recurso global Lnk2Resource con el nombre de archivo incrustado y otros parámetros, incluyendo el contenido del archivo incrustado en el formato original como una matriz de bytes.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Inicializa una nueva instancia de la clase [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) . |
## Campos

| Campo | Descripción |
| --- | --- |
| [BlendSignature](#BlendSignature) | Representa la firma del modo de fusión. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | El mensaje de recursos tanto placed como smart object encontrados |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | El mensaje Solo puedes copiar un objeto inteligente incrustado |
| [LayerHeaderSize](#LayerHeaderSize) | El tamaño del encabezado de la capa. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | No hay mensaje de recurso colocado o de objeto inteligente encontrado |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | El mensaje de índices de recurso colocado incorrectos |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Convierte este objeto inteligente incrustado en un objeto inteligente vinculado. |
...
| [duplicateLayer()](#duplicateLayer--) | Crea una nueva capa de objeto inteligente copiando esta. |
| [embedLinked()](#embedLinked--) | Incrusta el objeto inteligente vinculado en esta capa. |
| [equals(Object obj)](#equals-java.lang.Object-) | Determina si el Object especificado es igual a esta instancia. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Exporta los contenidos incrustados o vinculados a un archivo. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Obtiene o establece la deformación de renderizado o usa la imagen PS |
...
| [getContentType()](#getContentType--) | Obtiene el tipo del contenido de la capa de objeto inteligente. |
| [getContents()](#getContents--) | Obtiene o establece los contenidos de la capa de objeto inteligente. |
| [getContentsBounds()](#getContentsBounds--) | Obtiene o establece los límites del contenido del objeto inteligente. |
| [getContentsSource()](#getContentsSource--) | Obtiene o establece la fuente del contenido del objeto inteligente. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Obtiene o establece el último tamaño de la imagen a deformar. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Obtiene o establece el cuadrilátero original. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Obtiene los índices de recursos de capa colocada y inteligente y el recurso colocado adecuado. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Obtiene el recurso de capa colocada. |
...
| [getSmartFilters()](#getSmartFilters--) | Obtiene los filtros inteligentes. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Obtiene o establece el cuadrilátero de transformación. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Obtiene funciones que ayudan con la deformación |
| [getWarpSettings()](#getWarpSettings--) | Obtiene o establece los parámetros de deformación que se establecieron o obtuvieron del recurso (por defecto) |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Obtiene los contenidos de imagen incrustados o vinculados de la capa de objeto inteligente. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Crea una nueva capa de objeto inteligente copiando esta. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Invocar cuando se estableció el contenedor de este [Layer](../../com.aspose.psd.fileformats.psd.layers/layer). |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Vuelve a vincular el objeto inteligente vinculado a un archivo nuevo. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Reemplaza los contenidos del objeto inteligente incrustados en la capa de objeto inteligente. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Reemplaza los contenidos del objeto inteligente incrustados en la capa de objeto inteligente. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Reemplaza los contenidos con un archivo. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Reemplaza los contenidos con un archivo. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Reemplaza los contenidos con un archivo. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Reemplaza los contenidos con un archivo. |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Obtiene o establece la deformación de renderizado o usa la imagen PS |
...
| [setContents(byte[] value)](#setContents-byte---) | Obtiene o establece los contenidos de la capa de objeto inteligente. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Obtiene o establece los límites del contenido del objeto inteligente. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Obtiene o establece la fuente del contenido del objeto inteligente. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Obtiene o establece el último tamaño de la imagen a deformar. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Obtiene o establece el cuadrilátero original. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Obtiene el proveedor de objetos inteligentes. |
| [setTop(int value)](#setTop-int-) | Obtiene o establece la posición superior de la capa. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Obtiene o establece el cuadrilátero de transformación. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Obtiene o establece los parámetros de deformación que se establecieron o obtuvieron del recurso (por defecto) |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Actualiza el identificador de la fuente de datos. |
| [updateModifiedContent()](#updateModifiedContent--) | Actualiza la caché de imágenes de la capa de objeto inteligente con el contenido modificado. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Actualiza la caché de imágenes de la capa de objeto inteligente con contenido modificado. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Actualiza los recursos colocados / inteligentes cuando placedResource cambia o cuando se necesita conversión. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Es un contenedor para "IWarpSupport" para actualizar la vista previa de la capa. |
| [wait()](#wait--) |  |
...
Inicializa una nueva instancia de la clase [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) .

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | El flujo de elementos |
...
El mensaje de recursos tanto placed como smart object encontrados
...
El mensaje Solo puedes copiar un objeto inteligente incrustado
...
No hay mensaje de recurso colocado o de objeto inteligente encontrado
...
El mensaje de índices de recurso colocado incorrectos
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| linkedPath | java.lang.String | La ruta enlazada. |
...
Crea una nueva capa de objeto inteligente copiando esta. Observe que para los objetos inteligentes incrustados la imagen incrustada se comparte. Si desea copiar la imagen incrustada, use el método [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy).
...
Exporta los contenidos incrustados o vinculados a un archivo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| filePath | java.lang.String | La ruta del archivo de exportación. |
...
Obtiene o establece la deformación de renderizado o usa la imagen PS
...
Obtiene el tipo de contenido de la capa de objeto inteligente. El contenido del objeto inteligente incrustado es el archivo de imagen sin procesar incrustado:  LiFdDataSource.Data . El contenido del objeto inteligente enlazado es el contenido sin procesar del archivo de imagen enlazado si está disponible: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). No admitimos la carga desde la Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library cuando  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) es verdadero. Para archivos de enlace regulares, primero usamos  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) para buscar el archivo de forma relativa a la ruta de la imagen fuente  DataStreamSupporter.SourceImagePath , si no está disponible buscamos en  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), y si aún no lo encontramos buscamos el archivo de enlace en el mismo directorio donde está nuestra imagen:  DataStreamSupporter.SourceImagePath .

Valor: El tipo de contenido de la capa de objeto inteligente.
...
Obtiene o establece el contenido de la capa de objeto inteligente. El contenido del objeto inteligente incrustado es el archivo de imagen sin procesar incrustado:  LiFdDataSource.Data  y sus propiedades. El contenido del objeto inteligente enlazado es el contenido sin procesar del archivo de imagen enlazado si está disponible y sus propiedades: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). No admitimos la carga desde la Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library cuando  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) es verdadero. Para archivos de enlace regulares, primero usamos  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) para buscar el archivo de forma relativa a la ruta de la imagen fuente  DataStreamSupporter.SourceImagePath , si no está disponible buscamos en  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), y si aún no lo encontramos buscamos el archivo de enlace en el mismo directorio donde está nuestra imagen:  DataStreamSupporter.SourceImagePath .
...
Obtiene o establece los límites del contenido del objeto inteligente.

Valor: Los límites del objeto inteligente.
...
Obtiene o establece la fuente del contenido del objeto inteligente.

Valor: La fuente de datos del objeto inteligente.
...
Obtiene o establece el último tamaño de la imagen a deformar.
...
Obtiene o establece el cuadrilátero original.

Valor: El cuadrilátero original.
...
Obtiene los índices de recursos de capa colocada y inteligente y el recurso colocado adecuado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Los recursos. |
| placedResourceIndex | int[] | Índice del recurso colocado |
| smartResourceIndex | int[] | Índice del recurso inteligente. |
...
Obtiene el recurso de capa colocada.
...
Obtiene los filtros inteligentes.
...
Obtiene o establece el cuadrilátero de transformación.

Valor: El cuadrilátero de transformación.
...
Obtiene funciones que ayudan con la deformación
...
Obtiene o establece los parámetros de deformación que se establecieron o obtuvieron del recurso (por defecto)
...
Obtiene los contenidos de imagen incrustados o vinculados de la capa de objeto inteligente.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Las opciones. |
...
Crea una nueva capa de objeto inteligente copiando esta. Reproduce Capa -> Objetos inteligentes -> Nuevo objeto inteligente mediante la funcionalidad de Copiar de Adobe\\ufffd Photoshop\\ufffd. Observe que está habilitado solo para objetos inteligentes incrustados porque la imagen incrustada también se copia. Si desea compartir la imagen incrustada, use el método [.duplicateLayer](../../null/\\#duplicateLayer).
...
Invocar cuando se estableció el contenedor de este [Layer](../../com.aspose.psd.fileformats.psd.layers/layer).
...
Vuelve a enlazar el objeto inteligente vinculado a un nuevo archivo. No es necesario llamar al método UpdateModifiedContent después.
...
Reemplaza los contenidos del objeto inteligente incrustados en la capa de objeto inteligente.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | La imagen. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | La imagen. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Los ajustes de resolución. Si es nulo, se usará la resolución de la imagen. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Actualiza el identificador de la fuente de datos.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | El identificador de la fuente de datos. |
...
Actualiza la caché de imágenes de la capa de objeto inteligente con el contenido modificado.
...
Actualiza la caché de imágenes de la capa de objeto inteligente con contenido modificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | La imagen. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | La resolución. |
| skipBoundsUpdate | boolean | si se establece en  true  [omitir actualización de límites]. |
...
Actualiza los recursos colocados / inteligentes cuando placedResource cambia o cuando se necesita conversión.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| toEmbedded | boolean | si se establece en  true  convertir a un recurso incrustado si es necesario, de lo contrario a uno vinculado. |
...
Es un contenedor para "IWarpSupport" para actualizar la vista previa de la capa.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Píxeles y tamaño de la nueva imagen de vista previa |
