...
type: docs
weight: 10
url: /es/java/com.aspose.psd.imageloadoptions/jpeg2000loadoptions/
---
...
| --- | --- |
| [Jpeg2000LoadOptions()](#Jpeg2000LoadOptions--) | Inicializa una nueva instancia de la clase Jpeg2000LoadOptions. |
## Campos
...
| [getDefaultMaximumDecodingTime_internalized()](#getDefaultMaximumDecodingTime-internalized--) | Obtiene el tiempo máximo de decodificación predeterminado. |
| [getIgnoreAfterLoad_internalized()](#getIgnoreAfterLoad-internalized--) | Obtiene un valor que indica si [ignore after load]. |
| [getMaximumDecodingTime()](#getMaximumDecodingTime--) | Obtiene el tiempo máximo de decodificación en segundos (esta opción puede usarse en máquinas muy lentas o con poca memoria para evitar que el proceso se bloquee con imágenes muy grandes - resolución superior a 5500x6500 píxeles). |
| [getMaximumDecodingTimeForTile()](#getMaximumDecodingTimeForTile--) | Obtiene el tiempo máximo de decodificación para el mosaico. |
...
| [setDefaultMaximumDecodingTime_internalized(int value)](#setDefaultMaximumDecodingTime-internalized-int-) | Establece el tiempo máximo de decodificación predeterminado. |
...
| [setMaximumDecodingTime(int value)](#setMaximumDecodingTime-int-) | Establece el tiempo máximo de decodificación en segundos (esta opción puede usarse en máquinas muy lentas o con poca memoria para evitar que el proceso se bloquee con imágenes muy grandes - resolución superior a 5500x6500 píxeles). |
| [setMaximumDecodingTimeForTile(int value)](#setMaximumDecodingTimeForTile-int-) | Establece el tiempo máximo de decodificación para el mosaico. |
...
Inicializa una nueva instancia de la clase Jpeg2000LoadOptions.
...
Obtiene el tiempo máximo de decodificación predeterminado.

**Returns:**
int - El tiempo máximo de decodificación predeterminado.
...
Obtiene el tiempo máximo de decodificación en segundos (esta opción puede usarse en máquinas muy lentas o con poca memoria para evitar que el proceso se bloquee con imágenes muy grandes - resolución superior a 5500x6500 píxeles).

**Returns:**
int - El tiempo máximo de decodificación.
...
Obtiene el tiempo máximo de decodificación para el mosaico.

Valor: El tiempo máximo de decodificación para el mosaico.

**Returns:**
int - el tiempo máximo de decodificación para el mosaico.
...
Establece el tiempo máximo de decodificación predeterminado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | El tiempo máximo de decodificación predeterminado. |
...
Establece el tiempo máximo de decodificación en segundos (esta opción puede usarse en máquinas muy lentas o con poca memoria para evitar que el proceso se bloquee con imágenes muy grandes - resolución superior a 5500x6500 píxeles).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | El tiempo máximo de decodificación. |
...
Establece el tiempo máximo de decodificación para el mosaico.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | el tiempo máximo de decodificación para mosaico. |
