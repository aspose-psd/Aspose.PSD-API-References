...
description: "Recurso de nombre de capa"
type: docs
weight: 58
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
Recurso de nombre de capa
## Constructores

| Constructor | Descripción |
| --- | --- |
| [LuniResource()](#LuniResource--) | Inicializa una nueva instancia de la clase [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource). |
## Campos
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Obtiene o establece los datos. |
...
Inicializa una nueva instancia de la clase [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource).
