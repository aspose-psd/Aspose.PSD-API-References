...
description: "Clase ExpaResource."
type: docs
weight: 28
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
Clase ExpaResource. Recurso de la capa de ajuste de exposición
## Constructores

| Constructor | Descripción |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | Inicializa una nueva instancia de la clase [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | Inicializa una nueva instancia de la clase [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | Inicializa una nueva instancia de la clase [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
## Campos
...
| [getGammaCorrection()](#getGammaCorrection--) | Obtiene o establece la gamma. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Obtiene o establece la gamma. |
...
Inicializa una nueva instancia de la clase [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource).
