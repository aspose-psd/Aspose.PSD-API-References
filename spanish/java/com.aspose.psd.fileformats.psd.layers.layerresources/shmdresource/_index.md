...
description: "Clase ShmdResource."
type: docs
weight: 74
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
| --- | --- |
| [ShmdResource()](#ShmdResource--) | Inicializa una nueva instancia de la clase [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | Inicializa una nueva instancia de la clase [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
## Campos
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | La longitud del encabezado del subrecurso |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Obtiene o establece la hora de creación de la capa. |
...
| [getSubResources()](#getSubResources--) | Los subrecursos |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Obtiene o establece la hora de creación de la capa. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | Obtiene los subrecursos del recurso shmd. |
...
Inicializa una nueva instancia de la clase [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource).
...
La longitud del encabezado del subrecurso
...
Valor: La hora de creación de la capa.
