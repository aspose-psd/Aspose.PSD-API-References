...
description: "Clase ClblResource."
type: docs
weight: 20
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Clase ClblResource. Este recurso contiene información sobre la fusión de elementos recortados.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [ClblResource()](#ClblResource--) | Inicializa una nueva instancia de la clase [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Inicializa una nueva instancia de la clase [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Inicializa una nueva instancia de la clase [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Campos
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Obtiene o establece un valor que indica si [blend clipped elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Obtiene o establece un valor que indica si [blend clipped elements]. |
...
Inicializa una nueva instancia de la clase [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
| --- | --- | --- |
| blendClippedElements | boolean | si se establece a  true  [blend clipped elements]. |
...
Inicializa una nueva instancia de la clase [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). Con valor personalizado o desconocido
...
Obtiene o establece un valor que indica si [blend clipped elements].

Valor:  true  si [blend clipped elements]; de lo contrario,  false .
