...
description: "El recurso Filter Effects contiene canales, una máscara de usuario y una máscara de hoja para el filtro inteligente."
type: docs
weight: 29
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
El recurso Filter Effects contiene canales, una máscara de usuario y una máscara de hoja para el filtro inteligente.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Inicializa una nueva instancia de la clase [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource). |
## Campos

| Campo | Descripción |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | La clave de información de la herramienta de tipo FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | La clave de información de la herramienta de tipo FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Obtiene las máscaras de efecto de filtro. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Obtiene las máscaras de efecto de filtro. |
...
Inicializa una nueva instancia de la clase [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource).
...
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Las máscaras de efecto de filtro. |
...
La clave de información de la herramienta de tipo FEid.
...
Obtiene las máscaras de efecto de filtro.
