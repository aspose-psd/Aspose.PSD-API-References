...
type: docs
weight: 51
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Inicializa una nueva instancia de la clase [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) . |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Inicializa una nueva instancia de la clase [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) . |
## Campos
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Obtiene los datos sin procesar. |
...
| [getValue()](#getValue--) | Obtiene el valor como LnsrResourceType si el enum correspondiente está descrito. |
| [hashCode()](#hashCode--) |  |
...
Inicializa una nueva instancia de la clase [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) .

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| lnsrResourceType | int | Tipo del LNSR. |
...
Inicializa una nueva instancia de la clase [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) . Con valor personalizado o desconocido
...
Obtiene el valor como LnsrResourceType si el enum correspondiente está descrito. De lo contrario, devuelve Unknown

Valor: El valor como LnsrResourceType
