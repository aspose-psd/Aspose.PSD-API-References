...
description: "Clase PattResource."
type: docs
weight: 66
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
Clase PattResource. Recurso con datos de patrón
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PattResource()](#PattResource--) | Inicializa una nueva instancia de la clase [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Inicializa una nueva instancia de la clase [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
## Campos
...
| [TypeToolKey](#TypeToolKey) | La clave de información de herramienta tipo 'Patt' para 8 bits. |
| [TypeToolKey2](#TypeToolKey2) | La clave de información de herramienta tipo 'Pat2' para 16 bits. |
| [TypeToolKey3](#TypeToolKey3) | La clave de información de herramienta tipo 'Pat3' para 32 bits. |
| [ventureLicense_internalized](#ventureLicense-internalized) | La licencia venture. |
## Métodos

| Método | Descripción |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Actualiza el recurso Patt con datos predeterminados. |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | Crea el recurso predeterminado no vacío. |
...
| [getPatterns()](#getPatterns--) | Obtiene o establece los datos de patrones; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Obtiene o establece los datos de patrones; |
| [toString()](#toString--) | Devuelve una String que representa esta instancia. |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | Busca el elemento de datos de patrón y lo actualiza con uno nuevo; de lo contrario, agrega uno nuevo al final del arreglo. |
| [wait()](#wait--) |  |
...
Inicializa una nueva instancia de la clase [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource).
...
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | Los datos de patrones. |
...
La clave de información de herramienta tipo 'Patt' para 8 bits.
...
La clave de información de herramienta tipo 'Pat2' para 16 bits.
...
La clave de información de herramienta tipo 'Pat3' para 32 bits.
...
Actualiza el recurso Patt con datos predeterminados.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | El recurso. |
...
Crea el recurso predeterminado no vacío.
...
Obtiene o establece los datos de patrones;
...
Busca el elemento de datos de patrón y lo actualiza con uno nuevo; de lo contrario, agrega uno nuevo al final del arreglo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | El objeto de configuración de patrones para actualizar el elemento de patrón. |
