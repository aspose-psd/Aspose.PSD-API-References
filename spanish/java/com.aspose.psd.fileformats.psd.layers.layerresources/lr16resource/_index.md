...
type: docs
weight: 53
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource/
---
...
| --- | --- |
| [Lr16Resource()](#Lr16Resource--) | Inicializa una nueva instancia de la clase [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource). |
## Campos
...
| [getLayers()](#getLayers--) | Obtiene o establece las capas. |
| [getLength()](#getLength--) | Obtiene la longitud del recurso para la versión de encabezado PSD de la imagen. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | Obtiene la longitud del recurso. |
...
| [getRawData_internalized()](#getRawData-internalized--) | Obtiene o establece los datos sin procesar del recurso. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Guarda el registro de capa. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Obtiene o establece las capas. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | Obtiene o establece los datos sin procesar del recurso. |
...
Inicializa una nueva instancia de la clase [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource).
...
Obtiene la longitud del recurso para la versión de encabezado PSD de la imagen.
...
Obtiene la longitud del recurso. Puede depender de la versión psd.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| psdHeaderVersion | int | La versión del encabezado PSD. |

**Returns:**
int - La longitud del recurso.
...
Obtiene o establece los datos sin procesar del recurso.
