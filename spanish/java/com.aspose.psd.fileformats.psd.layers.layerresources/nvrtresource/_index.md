...
description: "Clase NvrtResource."
type: docs
weight: 63
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
Clase NvrtResource. Recurso de la capa de ajuste Invertir.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | Inicializa una nueva instancia de la clase [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | Inicializa una nueva instancia de la clase [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
## Campos

| Campo | Descripción |
| --- | --- |
| [DataLength_internalized](#DataLength-internalized) | Longitud de datos esperada. |
...
Inicializa una nueva instancia de la clase [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource).
