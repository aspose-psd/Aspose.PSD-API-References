...
description: "Colores posibles de la configuración de color de hoja."
type: docs
weight: 73
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Colores posibles de la configuración de color de hoja. Es un color decorativo de la UI de la capa en la lista de capas en PS
## Campos

| Campo | Descripción |
| --- | --- |
| [Blue](#Blue) | El color azul. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gray](#Gray) | El color gris. |
| [Green](#Green) | El color verde. |
| [NoColor](#NoColor) | El color no está especificado. |
| [Orange](#Orange) | El color naranja. |
| [Red](#Red) | El color rojo. |
| [Violet](#Violet) | El color violeta. |
| [Yellow](#Yellow) | El color amarillo. |
## Métodos
