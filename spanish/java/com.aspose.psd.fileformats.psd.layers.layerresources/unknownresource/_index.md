...
type: docs
weight: 82
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Inicializa una nueva instancia de la clase [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource). |
## Campos
...
Inicializa una nueva instancia de la clase [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource).
