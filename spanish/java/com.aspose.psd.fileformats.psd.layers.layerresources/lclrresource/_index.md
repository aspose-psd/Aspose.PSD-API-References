...
description: "Clase LclrResource."
type: docs
weight: 46
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
Clase LclrResource. Este recurso contiene información sobre el color de la capa en la lista de capas de PS. Sólo
## Constructores

| Constructor | Descripción |
| --- | --- |
| [LclrResource()](#LclrResource--) | Inicializa una nueva instancia de la clase [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(short color)](#LclrResource-short-) | Inicializa una nueva instancia de la clase [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(byte[] data)](#LclrResource-byte---) | Inicializa una nueva instancia de la clase [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
## Campos
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Obtiene o establece el color de la capa. |
...
| [setColor(short value)](#setColor-short-) | Obtiene o establece el color de la capa. |
...
Inicializa una nueva instancia de la clase [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource).
