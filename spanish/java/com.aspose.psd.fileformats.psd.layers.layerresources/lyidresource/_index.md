...
type: docs
weight: 59
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | Inicializa una nueva instancia de la clase [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | Inicializa una nueva instancia de la clase [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
## Campos
...
| [getValue()](#getValue--) | Obtiene el valor. |
| [hashCode()](#hashCode--) |  |
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | Obtiene el valor. |
...
Inicializa una nueva instancia de la clase [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource).
...
Inicializa una nueva instancia de la clase [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). Con valor personalizado o desconocido.
