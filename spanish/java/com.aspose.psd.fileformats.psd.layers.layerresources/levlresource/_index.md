...
description: "Clase LevlResource."
type: docs
weight: 48
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/levlresource/
---
...
Clase LevlResource. Recurso de la capa de ajuste de exposición.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [LevlResource(byte[] bytes)](#LevlResource-byte---) | Inicializa una nueva instancia de la clase [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource). |
| [LevlResource()](#LevlResource--) | Inicializa una nueva instancia de la clase [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource). |
## Campos
...
| [getChannel(int channelIndex)](#getChannel-int-) | Obtiene el canal. |
| [getClass()](#getClass--) |  |
...
Inicializa una nueva instancia de la clase [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource). Compatible con los modos de color GrayScale, Duotone, RGB, CMYK, Lab. 2 bytes - Versión (=2) 29 \* 10 bytes - Conjuntos de registros de nivel con 5 enteros cortos 4 bytes - Cabecera Lvls (comienza en el índice 292) 2 bytes - Versión (=3) 2 bytes - Recuento total de registros de nivel 10 \* (Recuento total - 29) El terminador cero del recurso Lvls debe plegarse también para cuatro.
...
Inicializa una nueva instancia de la clase [LevlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/levlresource).
