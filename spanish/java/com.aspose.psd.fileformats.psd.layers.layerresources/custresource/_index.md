...
description: "Clase CustResource."
type: docs
weight: 27
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/custresource/
---
...
Clase CustResource. Este recurso contiene información sobre la fusión de elementos recortados.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [CustResource()](#CustResource--) | Inicializa una nueva instancia de la clase [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource). |
| [CustResource(byte[] data)](#CustResource-byte---) | Inicializa una nueva instancia de la clase [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource). |
## Campos
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Obtiene o establece la fecha de creación de la capa. |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Obtiene o establece la fecha de creación de la capa. |
...
Inicializa una nueva instancia de la clase [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource).
...
Valor: La fecha de creación de la capa.
