...
description: "Clase FxrpResource."
type: docs
weight: 32
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
Clase FxrpResource. El punto de referencia de la capa
## Constructores

| Constructor | Descripción |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Inicializa una nueva instancia de la clase [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Inicializa una nueva instancia de la clase [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Inicializa una nueva instancia de la clase [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Campos
...
| [getX()](#getX--) | Obtiene o establece la x del punto de referencia |
| [getY()](#getY--) | Obtiene o establece la y del punto de referencia |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Guarda en el contenedor de flujo especificado. |
...
| [setX(double value)](#setX-double-) | Obtiene o establece la x del punto de referencia |
| [setY(double value)](#setY-double-) | Obtiene o establece la y del punto de referencia |
...
Inicializa una nueva instancia de la clase [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).
...
Inicializa una nueva instancia de la clase [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Con valor personalizado o desconocido
...
Valor: La x del punto de referencia
...
Valor: La y del punto de referencia
