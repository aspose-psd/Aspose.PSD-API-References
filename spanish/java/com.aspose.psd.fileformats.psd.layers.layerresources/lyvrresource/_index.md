...
description: "El recurso que representa la versión de Photoshop de la capa."
type: docs
weight: 60
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
| --- | --- |
| [LyvrResource()](#LyvrResource--) | Inicializa una nueva instancia de la clase [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource). |
## Campos
...
| [getVersion()](#getVersion--) | Obtiene o establece la versión de Photoshop de la capa. |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | Obtiene o establece la versión de Photoshop de la capa. |
...
Inicializa una nueva instancia de la clase [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource).
