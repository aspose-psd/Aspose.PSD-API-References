...
description: "Clase IopaResource."
type: docs
weight: 40
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
Clase IopaResource. Este recurso contiene información sobre la propiedad de opacidad de relleno del formulario de estilo de capa
## Constructores

| Constructor | Descripción |
| --- | --- |
| [IopaResource()](#IopaResource--) | Inicializa una nueva instancia de la clase [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Inicializa una nueva instancia de la clase [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
## Campos
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Obtiene o establece la opacidad del relleno. |
...
Inicializa una nueva instancia de la clase [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).
