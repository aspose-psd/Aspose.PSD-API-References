...
type: docs
weight: 11
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Campo | Descripción |
| --- | --- |
| [StructureKey](#StructureKey) | Identifica la clave de estructura de AnDs. |
## Métodos
...
| [getItems()](#getItems--) | Obtiene o establece las estructuras de sección de datos animados. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtiene o establece el ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Obtiene o establece la versión del descriptor. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Obtiene o establece las estructuras de sección de datos animados. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Obtiene o establece los bytes desconocidos 3 que existen cuando el número de fotogramas es impar. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Comprueba que el recuento de fotogramas en la estructura de lista 'FrIn' sea impar.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| elementos | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Obtiene o establece las estructuras de sección de datos animados.
...
Obtiene o establece el ClassID.
...
Obtiene o establece los bytes desconocidos 3 que existen cuando el número de fotogramas es impar.
