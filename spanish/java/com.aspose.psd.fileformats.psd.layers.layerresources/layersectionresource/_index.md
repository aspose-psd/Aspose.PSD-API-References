...
description: "El recurso de sección de capa."
type: docs
weight: 43
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Inicializa una nueva instancia de la clase [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Inicializa una nueva instancia de la clase [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Campos
...
Inicializa una nueva instancia de la clase [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
