...
description: "Clase InfxResource."
type: docs
weight: 39
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Clase InfxResource. Este recurso contiene información sobre la fusión de elementos recortados.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Inicializa una nueva instancia de la clase [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource()](#InfxResource--) | Inicializa una nueva instancia de la clase [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Inicializa una nueva instancia de la clase [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
## Campos
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Obtiene o establece un valor que indica si [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Obtiene o establece un valor que indica si [blend interior elements]. |
...
Inicializa una nueva instancia de la clase [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| blendInteriorElements | boolean | si se establece en  true  [blend interior elements]. |
...
Inicializa una nueva instancia de la clase [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). Con valor personalizado o desconocido.
