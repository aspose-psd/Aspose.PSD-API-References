...
description: "La imagen AI de Adobe Illustrator"
type: docs
weight: 14
url: /es/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
| --- | --- |
| [AiImage()](#AiImage--) | Inicializa una nueva instancia de la clase [AiImage](../../com.aspose.psd.fileformats.ai/aiimage). |
## Campos
...
| Método | Descripción |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | Agrega la sección de capa AI. |
| [cacheData()](#cacheData--) | Almacena en caché los datos y asegura que no se realizará carga adicional de datos desde el contenedor subyacente P:Aspose.PSD.DataStreamSupporter.DataStreamContainer. |
...
| [getActivePageIndex()](#getActivePageIndex--) | Obtiene o establece el índice de la página activa. |
...
| [getDataSection()](#getDataSection--) | Obtiene la sección de datos. |
...
| [getFinalizeSection()](#getFinalizeSection--) | Obtiene la sección de finalización. |
...
| [getHeader()](#getHeader--) | Obtiene el encabezado. |
...
| [getLayers()](#getLayers--) | Obtiene las secciones de capas. |
...
| [getPageCount()](#getPageCount--) | El número de páginas. |
...
| [getSetupSection()](#getSetupSection--) | Obtiene la sección de configuración. |
...
| [getVersion()](#getVersion--) | Obtiene la versión del formato Adobe Illustrator. |
| [getWidth()](#getWidth--) | Obtiene el ancho de la imagen. |
| [getXmpData()](#getXmpData--) | Obtiene los metadatos XMP. |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | Obtiene o establece el índice de la página activa. |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | Obtiene la imagen renderizada. |
...
Inicializa una nueva instancia de la clase [AiImage](../../com.aspose.psd.fileformats.ai/aiimage).
...
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | La sección de capa AI. |
...
Almacena en caché los datos y asegura que no se realizará carga adicional de datos desde el contenedor subyacente P:Aspose.PSD.DataStreamSupporter.DataStreamContainer.
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - instancia de ApsPage.
...
Valor: Esta propiedad solo es válida para imágenes AI en formato PDF. Si la imagen no está en formato PDF o no hay páginas, la propiedad será -1. Esta propiedad indica qué página de la imagen AI será la base para el renderizado.
...
Valor: La sección de finalización.
...
Obtiene las secciones de capas.

Valor: Las secciones de capas.
...
El número de páginas. Para el formato AI antiguo, las imágenes siempre son iguales a 0.

Valor: El número de páginas.
...
Valor: La sección de configuración.
...
Obtiene la imagen renderizada.

Valor: La imagen renderizada.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ventureLicense | java.lang.Object | Objeto de licencia Venture. |
