...
description: "Valores fourCC empaquetados para el método de interpolación de degradado de Photoshop."
type: docs
weight: 18
url: /es/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
| Campo | Descripción |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Clásico (valor predeterminado heredado cuando la clave está ausente). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Lineal (nota el espacio al final). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Perceptual. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Suave. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Rayas. |
## Métodos
...
'Gcls' \\u2014 Clásico (valor predeterminado heredado cuando la clave está ausente).
...
'Lnr ' \\u2014 Lineal (nota el espacio al final).
