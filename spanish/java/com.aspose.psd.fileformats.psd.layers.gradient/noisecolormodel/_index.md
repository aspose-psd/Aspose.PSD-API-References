...
description: "Modelo de color cuando el tipo de gradiente es Ruido podemos asignar el modelo de color a RGB/SHB/LAB 3/4/6"
type: docs
weight: 12
url: /es/java/com.aspose.psd.fileformats.psd.layers.gradient/noisecolormodel/
---
...
Modelo de color Cuando 'Gradient type' = 'Noise', podemos asignar 'Color Model' a RGB/SHB/LAB (3/4/6)
## Campos

| Campo | Descripción |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HSB](#HSB) | Modelo de color HSB. |
| [LAB](#LAB) | Modelo de color LAB. |
