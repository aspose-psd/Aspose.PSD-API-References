...
description: "Capa de ajuste de color selectivo."
type: docs
weight: 28
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
Capa de ajuste de color selectivo.
## Campos
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | Obtiene el tipo de la capa de ajuste. |
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Obtiene la corrección cmyk por color selectivo. |
| [getContainer()](#getContainer--) | Obtiene el  Image  contenedor. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Obtiene o establece el método de corrección. |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | Obtiene el procesador. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Procesa la capa de Color selectivo. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Fusiona los datos. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Establece la corrección cmyk por color selectivo. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Establece el contenedor Image. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Obtiene o establece el método de corrección. |
...
Obtiene el tipo de la capa de ajuste.

Valor: El tipo de la capa de ajuste.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| selectiveColorsType | int | Colores selectivos. |
...
Obtiene o establece el método de corrección.

Valor: El método de corrección.
...
Procesa la capa de Color selectivo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | El rectángulo de píxeles. |
| píxeles | int[] | El array de píxeles. |
| start | [Point](../../com.aspose.psd/point) | La ubicación superior izquierda de los píxeles. |
| end | [Point](../../com.aspose.psd/point) | La ubicación inferior derecha de los píxeles. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - El rectángulo de píxeles y los píxeles procesados.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| selectiveColorsType | int | Tipo de los colores selectivos. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Corrección Cmyk. |
