...
description: "Capa de posterizado."
type: docs
weight: 25
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Capa Posterize. Maneja el renderizado de Posterize usando datos de PostResource.
## Campos
...
| [getLevels()](#getLevels--) | Niveles de la capa Posterize. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Procesa la capa Posterize. |
...
| [setLevels(short value)](#setLevels-short-) | Niveles de la capa Posterize. |
