...
description: "Capa de ajuste de curvas"
type: docs
weight: 17
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | Obtiene el administrador de curvas. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | Obtiene o establece un valor que indica si se utiliza el administrador continuo en esta instancia. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | Obtiene o establece un valor que indica si se utiliza el administrador discreto en esta instancia. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | Obtiene o establece un valor que indica si se utiliza el administrador continuo en esta instancia. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | Obtiene o establece un valor que indica si se utiliza el administrador discreto en esta instancia. |
...
Obtiene o establece un valor que indica si se utiliza el administrador continuo en esta instancia.

Valor:  true  si se utiliza el administrador continuo en esta instancia; de lo contrario,  false .
...
Obtiene o establece un valor que indica si se utiliza el administrador discreto en esta instancia.

Valor:  true  si se utiliza el administrador discreto en esta instancia; de lo contrario,  false .
...
| start | [Point](../../com.aspose.psd/point) | El inicio. |
| end | [Point](../../com.aspose.psd/point) | El fin. |
