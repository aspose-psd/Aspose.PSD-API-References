...
description: "Capa de ajuste de exposición."
type: docs
weight: 18
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | Obtiene o establece la exposición. |
...
| [getGammaCorrection()](#getGammaCorrection--) | Obtiene o establece la corrección gamma. |
...
| [setExposure(float value)](#setExposure-float-) | Obtiene o establece la exposición. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Obtiene o establece la corrección gamma. |
...
| [setOffset(float value)](#setOffset-float-) | Obtiene o establece el desplazamiento. |
...
Obtiene o establece la Exposure. Para PS el rango de Exposure es de -20 a +20.
...
Obtiene o establece la GammaCorrection. Para PS el rango de GammaCorrection es de 9.99 a +0.01

Valor: La GammaCorrection.
...
Obtiene o establece la Offset. Para PS el rango de Offset es de -0.5 a +0.5.
