...
type: docs
weight: 16
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Obtiene o establece el Balance YellowBlue de los Shadows. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Aplica las correcciones para las sombras, tonos medios y destacados actuales al arreglo int RGB especificado. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Obtiene o establece el Balance YellowBlue de los Shadows. |
...
Obtiene o establece el Balance YellowBlue de los Shadows.
...
Aplica las correcciones para las sombras, tonos medios y destacados actuales al arreglo int RGB especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| píxeles | int[] | El arreglo int RGB de color. |
