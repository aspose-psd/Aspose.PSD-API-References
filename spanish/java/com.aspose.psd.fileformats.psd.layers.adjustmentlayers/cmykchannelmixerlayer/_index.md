...
description: "Capa de ajuste de mezclador de canales CMYK."
type: docs
weight: 14
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
Capa de ajuste de mezclador de canales CMYK.
## Campos
...
| [getBlackChannel()](#getBlackChannel--) | Obtiene el canal negro. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Obtiene el índice del canal por. |
...
| [getCyanChannel()](#getCyanChannel--) | Obtiene el canal cian. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Obtiene el canal magenta. |
...
| [getMonochrome()](#getMonochrome--) | Obtiene o establece un valor que indica si este [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) es monocromo. |
...
| [getYellowChannel()](#getYellowChannel--) | Obtiene el canal amarillo. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Procesa la capa de ajuste. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Obtiene o establece un valor que indica si este [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) es monocromo. |
...
Obtiene o establece un valor que indica si este [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) es monocromo.
