...
type: docs
weight: 11
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| [getTintColor()](#getTintColor--) | Obtiene o establece el valor del Color de Tinte. |
| [getTintColorBlue()](#getTintColorBlue--) | Obtiene o establece el valor doble del Color de Tinte Azul. |
| [getTintColorGreen()](#getTintColorGreen--) | Obtiene o establece el valor doble del Color de Tinte Verde. |
| [getTintColorRed()](#getTintColorRed--) | Obtiene o establece el valor doble del Color de Tinte Rojo. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | Procesa los píxeles. |
...
| [setTintColor(int value)](#setTintColor-int-) | Obtiene o establece el valor del Color de Tinte. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | Obtiene o establece el valor doble del Color de Tinte Azul. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | Obtiene o establece el valor doble del Color de Tinte Verde. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | Obtiene o establece el valor doble del Color de Tinte Rojo. |
...
Obtiene o establece el valor del Color de Tinte.

Valor: El valor del Color de Tinte.
