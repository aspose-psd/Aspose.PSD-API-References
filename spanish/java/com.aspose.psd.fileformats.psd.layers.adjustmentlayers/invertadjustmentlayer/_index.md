...
description: "La clase de capa de ajuste de inversión."
type: docs
weight: 21
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Procesa la capa de ajuste invert. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Aplica las correcciones de inversión al array int ARGB especificado. |
...
Procesa la capa de ajuste invert.
...
Aplica las correcciones de inversión al array int ARGB especificado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| píxeles | int[] | El array int ARGB. |
