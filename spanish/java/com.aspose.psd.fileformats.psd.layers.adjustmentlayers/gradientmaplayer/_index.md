...
description: "Capa de mapa de degradado."
type: docs
weight: 19
url: /es/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
Capa de mapa de degradado. Maneja el renderizado del mapa de degradado usando datos de GrdmResource.
## Campos
...
| [getGradientSettings()](#getGradientSettings--) | Obtiene o establece la instancia de configuración de Gradient pasada desde la instancia de GrdmResource. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Procesa la capa de mapa de degradado. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | Obtiene o establece la instancia de configuración de Gradient pasada desde la instancia de GrdmResource. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Actualiza los datos de la capa en el recurso de capa relacionado [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
Obtiene o establece la instancia de configuración de Gradient pasada desde la instancia de GrdmResource.
...
Procesa la capa de mapa de degradado.
...
Actualiza los datos de la capa en el recurso de capa relacionado [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
