...
description: "enumeración de espacio de color EXIF."
type: docs
weight: 10
url: /es/java/com.aspose.psd.exif.enums/exifcolorspace/
---
...
enumeración de espacio de color EXIF.
## Campos

| Campo | Descripción |
| --- | --- |
| [AdobeRgb](#AdobeRgb) | Espacio de color Adobe rgb. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [SRgb](#SRgb) | Espacio de color SRGB. |
| [Uncalibrated](#Uncalibrated) | Espacio de color no calibrado. |
## Métodos
