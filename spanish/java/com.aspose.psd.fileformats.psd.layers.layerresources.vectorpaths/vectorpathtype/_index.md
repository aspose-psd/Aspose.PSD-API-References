...
description: "Tipo de ruta vectorial según la especificación del formato PSD"
type: docs
weight: 22
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
| Campo | Descripción |
| --- | --- |
| [ClipboardRecord](#ClipboardRecord) | El registro del portapapeles |
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | El nudo Bézier de subruta cerrada enlazado |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | El nudo Bézier de subruta cerrada desenlazado |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | El registro de longitud de subruta cerrada |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | El registro de regla de relleno inicial |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | El nudo Bézier de subruta abierta enlazado |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | El nudo Bézier de subruta abierta desenlazado |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | El registro de longitud de subruta abierta |
| [PathFillRuleRecord](#PathFillRuleRecord) | El registro de regla de relleno de ruta |
## Métodos
...
El nudo Bézier de subruta cerrada enlazado
...
El nudo Bézier de subruta cerrada desenlazado
...
El registro de longitud de subruta cerrada
...
El registro de regla de relleno inicial
...
El nudo Bézier de subruta abierta enlazado
...
El nudo Bézier de subruta abierta desenlazado
...
El registro de longitud de subruta abierta
...
El registro de regla de relleno de ruta
