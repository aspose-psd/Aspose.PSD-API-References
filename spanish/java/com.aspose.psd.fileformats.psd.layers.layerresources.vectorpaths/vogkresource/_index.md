...
description: "El recurso Vector Origination Data."
type: docs
weight: 28
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| --- | --- |
| [VogkResource()](#VogkResource--) | Inicializa una nueva instancia de la clase [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource). |
## Campos

| Campo | Descripción |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | La clave del descriptor para guardar la configuración del origen de la forma. |
...
| [getItems_internalized()](#getItems-internalized--) | Obtiene o establece los elementos de la estructura. |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | Obtiene o establece la configuración del origen de la forma. |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | Obtiene o establece la configuración del origen de la forma. |
...
Inicializa una nueva instancia de la clase [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource).
...
La clave del descriptor para guardar la configuración del origen de la forma.
