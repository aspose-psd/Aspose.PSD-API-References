...
type: docs
weight: 15
url: /es/java/com.aspose.psd/cachetype/
---
...
| Campo | Descripción |
| --- | --- |
| [Auto](#Auto) | Especifica el tipo de caché automático. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Solo la caché en memoria. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Solo la caché en disco. |
...
Especifica el tipo de caché automático. El esquema de caché automática intentará almacenar en memoria primero y luego en disco.
