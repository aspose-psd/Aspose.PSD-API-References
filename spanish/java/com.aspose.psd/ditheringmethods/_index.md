...
type: docs
weight: 41
url: /es/java/com.aspose.psd/ditheringmethods/
---
...
| Campo | Descripción |
| --- | --- |
| [CustomConverter](#CustomConverter) | El convertidor personalizado. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | La paleta no se ignora y debe aplicarse una conversión de color adecuada. |
| [PaletteIgnore](#PaletteIgnore) | La paleta se ignora |
## Métodos
...
La paleta no se ignora y debe aplicarse una conversión de color adecuada.
