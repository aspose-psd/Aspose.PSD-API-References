...
type: docs
weight: 86
url: /es/java/com.aspose.psd/rasterimage/
---
...
Representa una imagen raster que admite operaciones de gráficos raster.
## Campos
...
| [crop(Rectangle rectangle)](#crop-com.aspose.psd.Rectangle-) | Recorta el rectángulo especificado. |
...
| [resize(int newWidth, int newHeight, ImageResizeSettings settings)](#resize-int-int-com.aspose.psd.ImageResizeSettings-) | Redimensiona la imagen con opciones extendidas. |
