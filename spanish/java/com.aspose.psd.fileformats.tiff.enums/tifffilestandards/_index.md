...
description: "Especifica los estándares del formato de archivo TIFF."
type: docs
weight: 16
url: /es/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
| Campo | Descripción |
| --- | --- |
| [Baseline](#Baseline) | El estándar de archivo TIFF 6.0 básico. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extended](#Extended) | El estándar de archivo TIFF 6.0 extendido. |
## Métodos
...
El estándar de archivo TIFF 6.0 básico. Este estándar se conoce formalmente como TIFF 6.0, Parte 1: TIFF básico.
...
El estándar de archivo TIFF 6.0 extendido. Este estándar se conoce formalmente como TIFF 6.0 extendido, Parte 2: Extensiones TIFF.
