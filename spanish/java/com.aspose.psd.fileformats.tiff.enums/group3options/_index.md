...
description: "Opciones para la codificación de fax CCITT Grupo 3/4. Valores posibles para las etiquetas GROUP3OPTIONS / TiffTag.T4OPTIONS y TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS."
type: docs
weight: 10
url: /es/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
Opciones para la codificación de fax CCITT Grupo 3/4.

Valores posibles para las etiquetas GROUP3OPTIONS / TiffTag.T4OPTIONS y TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS.
## Campos

| Campo | Descripción |
| --- | --- |
| [Encoding1D](#Encoding1D) | Codificación unidimensional. |
| [Encoding2D](#Encoding2D) | Codificación bidimensional. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | Rellenar hasta el límite de byte. |
| [Uncompressed](#Uncompressed) | Datos no comprimidos. |
## Métodos
...
Codificación unidimensional. (predeterminado)
