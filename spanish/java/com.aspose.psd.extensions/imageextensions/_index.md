...
description: "Contiene métodos de extensión para conversiones basadas en java.awt.Image y ."
type: docs
weight: 19
url: /es/java/com.aspose.psd.extensions/imageextensions/
---
...
Contiene métodos de extensión para conversiones basadas en java.awt.Image y [Image](../../com.aspose.psd/image).
## Métodos
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toGdiImage(Image image)](#toGdiImage-com.aspose.psd.Image-) | Convierte el [Image](../../com.aspose.psd/image) al java.awt.Image. |
...
Convierte el [Image](../../com.aspose.psd/image) al java.awt.Image.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
|  | image | [Image](../../com.aspose.psd/image) | El [Image](../../com.aspose.psd/image) a convertir. |

--------------------

Advertencia, la imagen GDI puede obtener límites inferiores a los que tiene la  imagen . Para obtener todas las partes de la imagen use el método de extensión más seguro ToGdiImageFull. |
