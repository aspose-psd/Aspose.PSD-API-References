...
description: "La estructura alias."
type: docs
weight: 10
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Inicializa una nueva instancia de la clase [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure). |
## Campos
...
| [getDataLength()](#getDataLength--) | Obtiene la longitud exacta de los datos en bytes. |
| [getFullPath()](#getFullPath--) | Obtiene o establece la ruta completa. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Obtiene o establece la ruta completa. |
...
Inicializa una nueva instancia de la clase [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure).
...
Valor: La longitud de los datos en bytes.
