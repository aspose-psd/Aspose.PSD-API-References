...
description: "La estructura entera."
type: docs
weight: 17
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| --- | --- |
| [IntegerStructure(ClassID keyName)](#IntegerStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Inicializa una nueva instancia de la clase [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure). |
## Campos

| Campo | Descripción |
| --- | --- |
| [StructureKey](#StructureKey) | La clave de la estructura entera. |
## Métodos
...
| [getValue()](#getValue--) | Obtiene o establece un valor entero. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Obtiene o establece un valor entero. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inicializa una nueva instancia de la clase [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure).
...
La clave de la estructura entera.
