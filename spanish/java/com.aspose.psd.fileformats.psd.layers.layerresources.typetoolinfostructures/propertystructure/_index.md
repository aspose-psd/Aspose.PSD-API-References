...
description: "La estructura de propiedad."
type: docs
weight: 23
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure/
---
...
| --- | --- |
| [PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID)](#PropertyStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Inicializa una nueva instancia de la clase [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure). |
## Campos

| Campo | Descripción |
| --- | --- |
| [StructureKey](#StructureKey) | Identifica la clave de la estructura. |
## Métodos
...
| [getKey()](#getKey--) | Obtiene la clave de la estructura. |
| [getKeyID()](#getKeyID--) | Obtiene o establece el ID de la clave. |
...
| [setKeyID(ClassID value)](#setKeyID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtiene o establece el ID de la clave. |
...
### PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID) {#PropertyStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-}
```
public PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID)
```


Inicializa una nueva instancia de la clase [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure).
...
| keyID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | El ID de la clave. |
...
### getKeyID() {#getKeyID--}
```
public final ClassID getKeyID()
```


Obtiene o establece el ID de la clave.

Valor: El ID de la clave.
...
### setKeyID(ClassID value) {#setKeyID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-}
```
public final void setKeyID(ClassID value)
```
