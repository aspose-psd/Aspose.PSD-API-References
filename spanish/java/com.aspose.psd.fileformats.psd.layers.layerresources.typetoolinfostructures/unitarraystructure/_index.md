...
description: "Define la clase UnitArrayStructure que contiene una matriz de valores double y su unidad de medida."
type: docs
weight: 27
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
Define la clase UnitArrayStructure que contiene una matriz de valores double y su unidad de medida. Se utiliza en los recursos de archivos PSD, generalmente mediante [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).
## Constructores

| Constructor | Descripción |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | Inicializa una nueva instancia de la clase [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## Campos

| Campo | Descripción |
| --- | --- |
| [StructureKey](#StructureKey) | Define la clave 'UnFl' de [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## Métodos
...
| [getKey()](#getKey--) | Obtiene esta clave de la estructura de matriz de unidades. |
...
| [getUnitType()](#getUnitType--) | Obtiene o establece el tipo de unidad de medida de los valores de [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [getValueCount()](#getValueCount--) | Obtiene el recuento de valores. |
| [getValues()](#getValues--) | Obtiene o establece los valores de la estructura de matriz de unidades. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | Obtiene o establece el tipo de unidad de medida de los valores de [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [setValues(double[] value)](#setValues-double---) | Obtiene o establece los valores de la estructura de matriz de unidades. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inicializa una nueva instancia de la clase [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Nombre de la clave. |
| unitType | int | Tipo de la unidad. |
| valores | double[] | Los valores. |
...
Define la clave 'UnFl' de [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).
...
Obtiene esta clave de la estructura de matriz de unidades.
...
Obtiene o establece el tipo de unidad de medida de los valores de [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

Valor: El tipo de unidad de medida.
...
Obtiene el recuento de valores.

Valor: El recuento de valores en la estructura de matriz de unidades.
