...
description: "La estructura de clase."
type: docs
weight: 12
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Inicializa una nueva instancia de la clase [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure). |
## Campos

| Campo | Descripción |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Identifica la clave de la estructura. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Identifica la clave de la estructura. |
| [StructureKeyType](#StructureKeyType) | Identifica la clave de la estructura. |
## Métodos
...
Inicializa una nueva instancia de la clase [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure).
...
| structureKey | int | La clave de la estructura. |
