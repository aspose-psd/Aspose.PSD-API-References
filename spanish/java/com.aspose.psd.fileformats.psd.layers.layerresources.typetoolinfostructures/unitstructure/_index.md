...
description: "La estructura de unidad."
type: docs
weight: 28
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
La estructura de unidad.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Inicializa una nueva instancia de la clase [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure). |
## Campos
...
| [getUnitType()](#getUnitType--) | Obtiene o establece el tipo de unidad. |
...
| [setUnitType(int value)](#setUnitType-int-) | Obtiene o establece el tipo de unidad. |
| [setValue(double value)](#setValue-double-) | Obtiene o establece el valor. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inicializa una nueva instancia de la clase [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure).
