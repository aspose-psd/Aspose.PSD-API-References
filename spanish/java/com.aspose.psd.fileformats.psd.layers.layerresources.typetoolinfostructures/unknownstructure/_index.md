...
description: "La estructura desconocida."
type: docs
weight: 30
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Inicializa una nueva instancia de la clase [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure). |
## Métodos
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Obtiene el nombre legible del tipo de la estructura. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Inicializa una nueva instancia de la clase [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | El nombre de la clave. |
| key | int | La clave de la estructura. |
...
Obtiene el nombre legible del tipo de la estructura.
