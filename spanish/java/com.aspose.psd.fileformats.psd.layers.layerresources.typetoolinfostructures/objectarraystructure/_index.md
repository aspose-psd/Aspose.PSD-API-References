...
description: "Define la clase ObjectArrayStructure que normalmente contiene una matriz."
type: docs
weight: 20
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Define la clase ObjectArrayStructure que normalmente contiene una matriz [UnitArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure). Se utiliza en los recursos de archivos PSD, como los recursos PlLd y SoLd.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Inicializa una nueva instancia de la clase [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) . |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Inicializa una nueva instancia de la clase [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) . |
## Campos

| Campo | Descripción |
| --- | --- |
| [StructureKey](#StructureKey) | Identifica la clave de estructura 'ObAr'. |
## Métodos
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Obtiene o establece el ID de la clase de matriz de objetos. |
| [getClassName()](#getClassName--) | Obtiene o establece el nombre de la clase de matriz de objetos. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Obtiene la lista de estructuras. |
| [getKey()](#getKey--) | Obtiene la clave de la estructura de la matriz de objetos. |
| [getKeyName()](#getKeyName--) | Obtiene o establece el nombre de la clave. |
| [getLength()](#getLength--) | Obtiene la longitud de OSTypeStructure en bytes. |
...
| [getStructureCount()](#getStructureCount--) | Obtiene el recuento de subestructuras de la matriz de objetos. |
| [getStructures()](#getStructures--) | Obtiene o establece las subestructuras en la estructura de la matriz de objetos. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtiene o establece el ID de la clase de matriz de objetos. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Obtiene o establece el nombre de la clase de matriz de objetos. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Obtiene o establece las subestructuras en la estructura de la matriz de objetos. |
...
Inicializa una nueva instancia de la clase [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) .

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| keyName | java.lang.String | Nombre de la clave. |
| classIdName | java.lang.String | Nombre del identificador de clase. |
...
Obtiene o establece el ID de la clase de matriz de objetos.

Valor: El ID de la clase de matriz de objetos.
...
Obtiene o establece el nombre de la clase de matriz de objetos.

Valor: El nombre de la clase de matriz de objetos.
...
Obtiene la lista de estructuras.
...
Obtiene la clave de la estructura de la matriz de objetos.
...
Obtiene la longitud de OSTypeStructure en bytes.
...
Valor: El recuento de subestructuras en la estructura de la matriz de objetos.
...
Obtiene o establece las subestructuras en la estructura de la matriz de objetos.

Valor: Las subestructuras en la estructura de la matriz de objetos.
