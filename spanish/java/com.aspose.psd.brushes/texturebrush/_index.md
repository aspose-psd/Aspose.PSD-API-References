...
type: docs
weight: 18
url: /es/java/com.aspose.psd.brushes/texturebrush/
---
...
Cada propiedad de la  Aspose.Imaging.Brushes.TextureBrush  clase es un objeto  Aspose.Imaging.Brush  que utiliza una imagen para rellenar el interior de una forma. Esta clase no puede heredarse.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [TextureBrush(Image image)](#TextureBrush-com.aspose.psd.Image-) | Inicializa una nueva instancia de la  Aspose.Imaging.Brushes.TextureBrush  clase que utiliza la imagen especificada. |
| [TextureBrush(Image image, int wrapMode)](#TextureBrush-com.aspose.psd.Image-int-) | Inicializa una nueva instancia de la  Aspose.Imaging.Brushes.TextureBrush  clase que utiliza la imagen especificada y el modo de ajuste. |
| [TextureBrush(Image image, int wrapMode, RectangleF destinationRectangle)](#TextureBrush-com.aspose.psd.Image-int-com.aspose.psd.RectangleF-) | Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada, el modo de ajuste y el rectángulo delimitador. |
| [TextureBrush(Image image, int wrapMode, Rectangle destinationRectangle)](#TextureBrush-com.aspose.psd.Image-int-com.aspose.psd.Rectangle-) | Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada, el modo de ajuste y el rectángulo delimitador. |
| [TextureBrush(Image image, RectangleF destinationRectangle)](#TextureBrush-com.aspose.psd.Image-com.aspose.psd.RectangleF-) | Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada y el rectángulo delimitador. |
| [TextureBrush(Image image, RectangleF destinationRectangle, ImageAttributes imageAttributes)](#TextureBrush-com.aspose.psd.Image-com.aspose.psd.RectangleF-com.aspose.psd.ImageAttributes-) | Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada, el rectángulo delimitador y los atributos de imagen. |
| [TextureBrush(Image image, Rectangle destinationRectangle)](#TextureBrush-com.aspose.psd.Image-com.aspose.psd.Rectangle-) | Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada y el rectángulo delimitador. |
| [TextureBrush(Image image, Rectangle destinationRectangle, ImageAttributes imageAttributes)](#TextureBrush-com.aspose.psd.Image-com.aspose.psd.Rectangle-com.aspose.psd.ImageAttributes-) | Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada, el rectángulo delimitador y los atributos de imagen. |
## Métodos
...
| [getImage()](#getImage--) | Obtiene el objeto com.aspose.psd.Image asociado con este objeto com.aspose.psd.brushes.TextureBrush. |
| [getImageAttributes()](#getImageAttributes--) | Obtiene los ImageAttributes asociados con este TextureBrush. |
...
Inicializa una nueva instancia de la  Aspose.Imaging.Brushes.TextureBrush  clase que utiliza la imagen especificada.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | El objeto Aspose.Imaging.Image con el que este Aspose.Imaging.Brushes.TextureBrush rellena los interiores. |
...
Inicializa una nueva instancia de la  Aspose.Imaging.Brushes.TextureBrush  clase que utiliza la imagen especificada y el modo de ajuste.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | El objeto Aspose.Imaging.Image con el que este Aspose.Imaging.Brushes.TextureBrush rellena los interiores. |
| wrapMode | int | Una enumeración Aspose.Imaging.WrapMode que especifica cómo se mosaica este Aspose.Imaging.Brushes.TextureBrush. |
...
Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada, el modo de ajuste y el rectángulo delimitador.
...
| image | [Image](../../com.aspose.psd/image) | El objeto Aspose.Imaging.Image con el que este Aspose.Imaging.Brushes.TextureBrush rellena los interiores. |
| wrapMode | int | Una enumeración Aspose.Imaging.WrapMode que especifica cómo se mosaica este Aspose.Imaging.Brushes.TextureBrush. |
| destinationRectangle | [RectangleF](../../com.aspose.psd/rectanglef) | Una estructura Aspose.Imaging.RectangleF que representa el rectángulo delimitador para este Aspose.Imaging.Brushes.TextureBrush. |
...
| image | [Image](../../com.aspose.psd/image) | El objeto Aspose.Imaging.Image con el que este Aspose.Imaging.Brushes.TextureBrush rellena los interiores. |
| wrapMode | int | Una enumeración Aspose.Imaging.WrapMode que especifica cómo se mosaica este Aspose.Imaging.Brushes.TextureBrush. |
| destinationRectangle | [Rectangle](../../com.aspose.psd/rectangle) | Una estructura Aspose.Imaging.Rectangle que representa el rectángulo delimitador para este Aspose.Imaging.Brushes.TextureBrush. |
...
Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada y el rectángulo delimitador.
...
Inicializa una nueva instancia de la clase Aspose.Imaging.Brushes.TextureBrush que usa la imagen especificada, el rectángulo delimitador y los atributos de imagen.
...
| image | [Image](../../com.aspose.psd/image) | El objeto Aspose.Imaging.Image con el que este Aspose.Imaging.Brushes.TextureBrush rellena los interiores. |
| destinationRectangle | [RectangleF](../../com.aspose.psd/rectanglef) | Una estructura Aspose.Imaging.RectangleF que representa el rectángulo delimitador para este Aspose.Imaging.Brushes.TextureBrush. |
| imageAttributes | [ImageAttributes](../../com.aspose.psd/imageattributes) | Un objeto com.aspose.psd.ImageAttributes que contiene información adicional sobre la imagen utilizada por este Aspose.Imaging.Brushes.TextureBrush. |
...
Obtiene el objeto com.aspose.psd.Image asociado con este objeto com.aspose.psd.brushes.TextureBrush.

Valor: Un objeto com.aspose.psd.Image que representa la imagen con la que este com.aspose.psd.brushes.TextureBrush rellena formas.
...
Obtiene los ImageAttributes asociados con este TextureBrush.

Valor: Los ImageAttributes.
