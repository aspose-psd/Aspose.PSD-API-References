...
description: "La unidad de resolución de resolution info"
type: docs
weight: 11
url: /es/java/com.aspose.psd.fileformats.psd.resources.resolutionenums/resolutionunit/
---
...
La unidad de resolución de resolution info
## Campos

| Campo | Descripción |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PxPerCm](#PxPerCm) | Los píxeles por cm |
| [PxPerInch](#PxPerInch) | Los píxeles por pulgada |
## Métodos
...
### PxPerCm {#PxPerCm}
```
public static final int PxPerCm
```
...
### PxPerInch {#PxPerInch}
```
public static final int PxPerInch
```


Los píxeles por pulgada
