...
description: "Representa el espacio de nombres Adobe Pdf."
type: docs
weight: 10
url: /es/java/com.aspose.psd.xmp.schemas.pdf/pdfpackage/
---
...
Representa el espacio de nombres Adobe Pdf.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PdfPackage()](#PdfPackage--) | Inicializa una nueva instancia de la  PdfPackage  clase. |
## Métodos
...
| [setKeywords(String keywords)](#setKeywords-java.lang.String-) | Establece las palabras clave. |
| [setPdfVersion(String version)](#setPdfVersion-java.lang.String-) | Establece la versión del Pdf. |
| [setProducer(String producer)](#setProducer-java.lang.String-) | Establece el nombre de la herramienta que creó el Pdf. |
| [setTrapped(boolean isTrapped)](#setTrapped-boolean-) | Establece el atrapado. |
...
Inicializa una nueva instancia de la  PdfPackage  clase.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| palabras clave | java.lang.String | Las palabras clave. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| version | java.lang.String | Versión del Pdf, por ejemplo: 1.0, 1.3 etc. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| productor | java.lang.String | El nombre del productor. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| isTrapped | boolean | si se establece a  true  el documento ha sido atrapado. |
