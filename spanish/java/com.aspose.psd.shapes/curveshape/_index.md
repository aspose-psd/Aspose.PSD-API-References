...
type: docs
weight: 12
url: /es/java/com.aspose.psd.shapes/curveshape/
---
...
| --- | --- |
| [CurveShape()](#CurveShape--) | Inicializa una nueva instancia de la  CurveShape  clase. |
| [CurveShape(PointF[] points)](#CurveShape-com.aspose.psd.PointF---) | Inicializa una nueva instancia de la  CurveShape  clase. |
| [CurveShape(PointF[] points, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---boolean-) | Inicializa una nueva instancia de la  CurveShape  clase. |
| [CurveShape(PointF[] points, float tension)](#CurveShape-com.aspose.psd.PointF---float-) | Inicializa una nueva instancia de la  CurveShape  clase. |
| [CurveShape(PointF[] points, float tension, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---float-boolean-) | Inicializa una nueva instancia de la  CurveShape  clase. |
## Métodos
...
Inicializa una nueva instancia de la  CurveShape  clase.
...
Inicializa una nueva instancia de la  CurveShape  clase. Se usa la tensión predeterminada de 0.5.
