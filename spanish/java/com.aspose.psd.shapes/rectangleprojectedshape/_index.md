...
type: docs
weight: 16
url: /es/java/com.aspose.psd.shapes/rectangleprojectedshape/
---
...
Representa una forma que se proyecta sobre un rectángulo girado a una orientación particular. Especificada por cuatro puntos que pueden rotarse en el espacio manteniendo la misma longitud de los bordes y 90 grados entre los bordes adyacentes.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [RectangleProjectedShape()](#RectangleProjectedShape--) | Inicializa una nueva instancia de la clase  RectangleProjectedShape . |
| [RectangleProjectedShape(RectangleF rectangle)](#RectangleProjectedShape-com.aspose.psd.RectangleF-) | Inicializa una nueva instancia de la clase  RectangleProjectedShape . |
## Métodos
...
| --- | --- | --- |
| rectangle | [RectangleF](../../com.aspose.psd/rectanglef) | El rectángulo del cual inicializar. |
