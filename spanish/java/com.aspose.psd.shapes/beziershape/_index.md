...
description: "Representa una spline Bézier."
type: docs
weight: 11
url: /es/java/com.aspose.psd.shapes/beziershape/
---
...
| [BezierShape(PointF[] points)](#BezierShape-com.aspose.psd.PointF---) | Inicializa una nueva instancia de la clase BezierShape. |
| [BezierShape(PointF[] points, boolean isClosed)](#BezierShape-com.aspose.psd.PointF---boolean-) | Inicializa una nueva instancia de la clase BezierShape. |
## Métodos
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | La matriz de puntos. |
| isClosed | boolean | Si se establece en true, la spline bezier está cerrada. |
