...
type: docs
weight: 12
url: /es/java/com.aspose.psd.exif/jpegexifdata/
---
...
| [JpegExifData(TiffDataType[] exifdata)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | Inicializa una nueva instancia de la clase JpegExifData con datos de la matriz. |
| [JpegExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | Inicializa una nueva instancia de la clase JpegExifData con datos de la matriz. |
## Campos

| Campo | Descripción |
| --- | --- |
| [MaxExifSegmentSize](#MaxExifSegmentSize) | El tamaño máximo del segmento EXIF en bytes permitido. |
## Métodos
...
| [getThumbnail()](#getThumbnail--) | Obtiene o establece la imagen miniatura. |
...
| [setPrimaryChromaticities(TiffRational[] value)](#setPrimaryChromaticities-com.aspose.psd.fileformats.tiff.TiffRational---) | Obtiene o establece la cromaticidad de los tres colores primarios de la imagen. |
...
| [setReferenceBlackWhite(TiffRational[] value)](#setReferenceBlackWhite-com.aspose.psd.fileformats.tiff.TiffRational---) | Obtiene o establece la referencia de negro y blanco. |
...
| [setThumbnail(RasterImage value)](#setThumbnail-com.aspose.psd.RasterImage-) | Obtiene o establece la imagen miniatura. |
...
| [setYCbCrCoefficients(TiffRational[] value)](#setYCbCrCoefficients-com.aspose.psd.fileformats.tiff.TiffRational---) | Obtiene o establece los coeficientes de la matriz para la transformación de datos de imagen de RGB a YCbCr. |
...
Inicializa una nueva instancia de la clase JpegExifData con datos de la matriz.
...
Valor: El negro y blanco de referencia.
...
Obtiene o establece la imagen miniatura.
...
Valor: Los coeficientes de matriz para la transformación de datos de imagen de RGB a YCbCr.
...
El tamaño total del segmento debe ser menor o igual a MaxExifSegmentSize bytes para producir una imagen jpeg correcta. Sugerencia: intente reducir el tamaño del thumbnail o cambiar su compresión en caso de que tenga una sección EXIF demasiado grande.
