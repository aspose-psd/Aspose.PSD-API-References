...
description: "Capa de relleno."
type: docs
weight: 10
url: /es/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
Capa de relleno. Color Fill, Gradient Fill o Pattern Fill Layer que difiere por FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#setFillSettings-IFillSettings-))
## Campos
...
| [createInstance(int fillType)](#createInstance-int-) | Construye una nueva instancia de la clase [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) por tipo de relleno. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Obtiene el procesador de renderizado para [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Obtiene o establece la opacidad del relleno. |
| [getFillSettings()](#getFillSettings--) | Obtiene la configuración del relleno. |
| [getFillType()](#getFillType--) | Obtiene el tipo de relleno. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Obtiene la configuración del relleno. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Actualiza los datos de píxeles de la capa de relleno según la configuración real de [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Construye una nueva instancia de la clase [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) por tipo de relleno.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fillType | int | El tipo de capa de relleno. |
...
Obtiene el procesador de renderizado para [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | La imagen a la que renderizar. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Los límites a procesar. |

**Returns:**
com.aspose.internal.IPartialProcessor - Devuelve el procesador de renderizado para [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Obtiene la configuración del relleno.
...
Actualiza los datos de píxeles de la capa de relleno según la configuración real de [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
