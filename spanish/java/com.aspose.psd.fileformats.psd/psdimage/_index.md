...
description: "Define la clase PsdImage que proporciona la capacidad de cargar, editar y guardar archivos PSD, así como actualizar propiedades, añadir marcas de agua, realizar operaciones gráficas o convertir un formato de archivo a otro."
type: docs
weight: 14
url: /es/java/com.aspose.psd.fileformats.psd/psdimage/
---
...
Define la clase PsdImage que proporciona la capacidad de cargar, editar, guardar archivos PSD, así como actualizar propiedades, añadir marcas de agua, realizar operaciones gráficas o convertir un formato de archivo a otro. Aspose.PSD admite la importación como capa y la exportación a los siguientes formatos: Png, Jpeg, Jpeg2000, Gif, Bmp, Tiff, Psd, Psb junto con la exportación a Pdf con texto seleccionable.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PsdImage(String path)](#PsdImage-java.lang.String-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de la ruta especificada de una imagen raster (no una imagen psd en la ruta). |
| [PsdImage(String path, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-java.lang.String-short-short-short-int-short-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de la ruta especificada de una imagen raster (no una imagen psd en la ruta) con parámetros del constructor. |
| [PsdImage(InputStream stream)](#PsdImage-java.io.InputStream-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de la ruta especificada de una imagen raster (no una imagen psd en el flujo). |
| [PsdImage(InputStream stream, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-java.io.InputStream-short-short-short-int-short-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de la ruta especificada de una imagen raster (no una imagen psd en el flujo) con parámetros del constructor. |
| [PsdImage(RasterImage rasterImage)](#PsdImage-com.aspose.psd.RasterImage-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de una imagen raster existente (no una imagen psd) con modo de color RGB, 4 canales, 8 bits por canal y sin compresión. |
| [PsdImage(RasterImage rasterImage, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-com.aspose.psd.RasterImage-short-short-short-int-short-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de una imagen raster existente (no una imagen psd) con parámetros del constructor. |
| [PsdImage(int width, int height)](#PsdImage-int-int-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) con el ancho y alto especificados. |
| [PsdImage(int width, int height, IColorPalette colorPalette, short colorMode, short channelBitDepth, short channels, int psdVersion, short compression)](#PsdImage-int-int-com.aspose.psd.IColorPalette-short-short-short-int-short-) | Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) con el ancho, alto, paleta, modo de color, número de canales y longitud de bits de los canales, y con los parámetros del modo de compresión especificados. |
## Campos

| Campo | Descripción |
| --- | --- |
| [DefaultStubEncodingName_internalized](#DefaultStubEncodingName-internalized) | El nombre de codificación predeterminado |
| [DefaultVersion](#DefaultVersion) | La versión predeterminada de PSD. |
...
| [SyncLayersRoot_internalized](#SyncLayersRoot-internalized) | El objeto que puede usarse para sincronizar el acceso a las capas. |
| [horizontalResolution](#horizontalResolution) |  |
## Métodos

| Método | Descripción |
| --- | --- |
| [addBlackWhiteAdjustmentLayer()](#addBlackWhiteAdjustmentLayer--) | Añade la capa de ajuste en blanco y negro. |
| [addBrightnessContrastAdjustmentLayer(int brightness, int contrast)](#addBrightnessContrastAdjustmentLayer-int-int-) | Añade la capa de ajuste de brillo/contraste. |
| [addChannelMixerAdjustmentLayer()](#addChannelMixerAdjustmentLayer--) | Añade la capa de ajuste de mezclador de canales con parámetros predeterminados |
| [addColorBalanceAdjustmentLayer()](#addColorBalanceAdjustmentLayer--) | Añade la capa de ajuste de balance de color. |
| [addCurvesAdjustmentLayer()](#addCurvesAdjustmentLayer--) | Agrega la capa de ajuste Curves. |
...
| [addExposureAdjustmentLayer(float exposure, float offset, float gammaCorrection)](#addExposureAdjustmentLayer-float-float-float-) | Agrega la capa de ajuste de exposición. |
| [addGradientMapAdjustmentLayer()](#addGradientMapAdjustmentLayer--) | Agrega la capa de ajuste GradientMap. |
| [addHueSaturationAdjustmentLayer()](#addHueSaturationAdjustmentLayer--) | Agrega la capa de ajuste de tono/saturación. |
| [addInvertAdjustmentLayer()](#addInvertAdjustmentLayer--) | Agrega una capa de ajuste de inversión. |
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Agrega la capa. |
| [addLayerGroup(String groupName, int index, boolean startBehaviour)](#addLayerGroup-java.lang.String-int-boolean-) | Añade el grupo de capas. |
| [addLayer_internalized(Layer layer, int index)](#addLayer-internalized-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Agrega la capa en el índice. |
| [addLevelsAdjustmentLayer()](#addLevelsAdjustmentLayer--) | Agrega la capa de ajuste Levels. |
| [addPhotoFilterLayer(Color color)](#addPhotoFilterLayer-com.aspose.psd.Color-) | Agrega la capa de filtro fotográfico. |
| [addPosterizeAdjustmentLayer()](#addPosterizeAdjustmentLayer--) | Agrega la capa de ajuste Posterize. |
| [addRegularLayer()](#addRegularLayer--) | Agrega una nueva capa regular. |
| [addSelectiveColorAdjustmentLayer()](#addSelectiveColorAdjustmentLayer--) | Agrega la capa de ajuste de color selectivo. |
| [addShapeLayer()](#addShapeLayer--) | Agrega una capa de forma vacía. |
| [addTextLayer(String text, Rectangle rect)](#addTextLayer-java.lang.String-com.aspose.psd.Rectangle-) | Agrega una nueva capa de texto. |
| [addThresholdAdjustmentLayer()](#addThresholdAdjustmentLayer--) | Agrega la capa de ajuste Threshold. |
| [addVibranceAdjustmentLayer()](#addVibranceAdjustmentLayer--) | Agrega la capa de ajuste Vibrance. |
...
| [convert(PsdOptions newOptions)](#convert-com.aspose.psd.imageoptions.PsdOptions-) | Convierte este formato de imagen al especificado en las opciones. |
...
| [flattenImage()](#flattenImage--) | Aplana todas las capas. |
| [getActiveLayer()](#getActiveLayer--) | Obtiene o establece la capa activa. |
...
| [getBackgroundContents_internalized()](#getBackgroundContents-internalized--) | Obtiene o establece el color de fondo. |
| [getBitsPerChannel()](#getBitsPerChannel--) | Obtiene los bits por canal. |
...
| [getChannelsCount()](#getChannelsCount--) | Obtiene el recuento de canales PSD. |
| [getClass()](#getClass--) |  |
| [getCmykColorProfile()](#getCmykColorProfile--) | Obtiene o establece el perfil de color CMYK para imágenes PSD CMYK. |
| [getColorMode()](#getColorMode--) | Obtiene o establece el modo de color. |
| [getCompression()](#getCompression--) | Obtiene el método de compresión. |
| [getContainer()](#getContainer--) | Obtiene el  Image  contenedor. |
| [getCurrentOptions_internalized()](#getCurrentOptions-internalized--) | Obtiene las opciones actuales de la imagen. |
...
| [getDefaultReplacementFont_internalized()](#getDefaultReplacementFont-internalized--) | Obtiene o establece la fuente de reemplazo predeterminada. |
...
| [getGlobalAngle()](#getGlobalAngle--) | Obtiene o establece el ángulo global. |
| [getGlobalLayerMaskInfo()](#getGlobalLayerMaskInfo--) | Obtiene la información de la máscara de capa global. |
| [getGlobalLayerResources()](#getGlobalLayerResources--) | Obtiene o establece los recursos de capa global. |
| [getGrayColorProfile()](#getGrayColorProfile--) | Obtiene o establece el perfil de color GRAY (monocromo) para imágenes PSD en escala de grises. |
| [getHeight()](#getHeight--) | Obtiene la altura de la imagen. |
| [getHorizontalResolution()](#getHorizontalResolution--) | Obtiene o establece la resolución horizontal, en píxeles por pulgada, de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage). |
| [getImageLayers_internalized()](#getImageLayers-internalized--) | Obtiene o establece las capas PSD. |
| [getImageOpacity()](#getImageOpacity--) | Obtiene la opacidad de esta imagen. |
| [getImageResources()](#getImageResources--) | Obtiene o establece los recursos de imagen PSD. |
...
| [getLayerAndMask_internalized()](#getLayerAndMask-internalized--) | Obtiene la capa y la máscara. |
| [getLayers()](#getLayers--) | Obtiene o establece las capas PSD. |
| [getLinkedLayersManager()](#getLinkedLayersManager--) | Obtiene el administrador de capas vinculadas. |
...
| [getPsdHeader_internalized()](#getPsdHeader-internalized--) | Obtiene o establece el encabezado PSD. |
...
| [getRgbColorProfile()](#getRgbColorProfile--) | Obtiene o establece el perfil de color RGB para imágenes PSD CMYK. |
...
| [getSmartObjectProvider()](#getSmartObjectProvider--) | Obtiene el proveedor de objetos inteligentes. |
...
| [getTimeline()](#getTimeline--) | Obtiene la Línea de tiempo ([.getTimeline](../../null/\#getTimeline)/[.setTimeline(Timeline)](../../null/\#setTimeline-Timeline-)) de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage). |
...
| [getUpdatedResourceBlocks_internalized(ResourceBlock[] resources, ResourceBlock resource, boolean removeDuplicates)](#getUpdatedResourceBlocks-internalized-com.aspose.psd.fileformats.psd.ResourceBlock---com.aspose.psd.fileformats.psd.ResourceBlock-boolean-) | Obtiene recursos actualizados con un bloque de recursos completamente nuevo. |
...
| [getVerticalResolution()](#getVerticalResolution--) | Obtiene o establece la resolución vertical, en píxeles por pulgada, de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage). |
...
| [hasAlpha()](#hasAlpha--) | Obtiene o establece la resolución vertical, en píxeles por pulgada, de este RasterImage. |
...
| [hasTransparencyData()](#hasTransparencyData--) | Obtiene o establece un valor que indica si el primer canal alfa contiene los datos de transparencia para el resultado combinado al especificar datos de capas. |
...
| [insertLayerAfter_internalized(Layer layer, Layer layerToInsert)](#insertLayerAfter-internalized-com.aspose.psd.fileformats.psd.layers.Layer-com.aspose.psd.fileformats.psd.layers.Layer-) | Inserta la capa después de la capa especificada con todas las preparaciones. |
| [isCached()](#isCached--) | Obtiene un valor que indica si los datos de la imagen están almacenados en caché actualmente. |
| [isFlatten()](#isFlatten--) | Obtiene un valor que indica si la imagen PSD está aplanada. |
...
| [mergeLayers(Layer bottomLayer, Layer topLayer)](#mergeLayers-com.aspose.psd.fileformats.psd.layers.Layer-com.aspose.psd.fileformats.psd.layers.Layer-) | Fusiona las capas. |
...
| [removeGlobalTextEngineResource_internalized()](#removeGlobalTextEngineResource-internalized--) | Elimina el recurso global del motor de texto - El método se usa para algunos archivos PSD con capas de texto, que no pueden abrirse en Adobe Photoshop después del procesamiento (principalmente relacionado con capas de texto de fuentes ausentes). |
...
| [saveSpecificLayers_internalized(System.IO.Stream stream, ImageOptionsBase optionsBase, Rectangle boundsRectangle, Layer[] layersToExport)](#saveSpecificLayers-internalized-com.aspose.ms.System.IO.Stream-com.aspose.psd.ImageOptionsBase-com.aspose.psd.Rectangle-com.aspose.psd.fileformats.psd.layers.Layer---) | Guarda los datos de la imagen en el flujo especificado usando las opciones de guardado y los límites especificados. |
...
| [setActiveLayer(Layer value)](#setActiveLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Obtiene o establece la capa activa. |
...
| [setBackgroundContents_internalized(RawColor value)](#setBackgroundContents-internalized-com.aspose.psd.fileformats.psd.rawcolor.RawColor-) | Obtiene o establece el color de fondo. |
...
| [setCmykColorProfile(StreamSource value)](#setCmykColorProfile-com.aspose.psd.sources.StreamSource-) | Obtiene o establece el perfil de color CMYK para imágenes PSD CMYK. |
| [setColorMode(short value)](#setColorMode-short-) | Obtiene o establece el modo de color. |
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | El ángulo global. |
| [setGlobalLayerResources(LayerResource[] value)](#setGlobalLayerResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | Obtiene o establece los recursos de capa global. |
| [setGrayColorProfile(StreamSource value)](#setGrayColorProfile-com.aspose.psd.sources.StreamSource-) | El perfil de color GRAY (monocromo) para imágenes PSD en escala de grises. |
| [setHorizontalResolution(double value)](#setHorizontalResolution-double-) | Obtiene o establece la resolución horizontal, en píxeles por pulgada, de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage). |
...
| [setImageResources(ResourceBlock[] value)](#setImageResources-com.aspose.psd.fileformats.psd.ResourceBlock---) | Obtiene o establece los recursos de imagen PSD. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Obtiene o establece las capas PSD. |
...
| [setResolution(double dpiX, double dpiY)](#setResolution-double-double-) | Establece la resolución para este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage). |
| [setRgbColorProfile(StreamSource value)](#setRgbColorProfile-com.aspose.psd.sources.StreamSource-) | Obtiene o establece el perfil de color RGB para imágenes PSD CMYK. |
| [setRotateMode_internalized(int value)](#setRotateMode-internalized-int-) | Obtiene o establece el modo de rotación. |
| [setTransparencyData(boolean value)](#setTransparencyData-boolean-) | Obtiene o establece un valor que indica si el primer canal alfa contiene los datos de transparencia para el resultado combinado al especificar datos de capas. |
...
| [setVentureLicense_internalized(Object ventureLicense)](#setVentureLicense-internalized-java.lang.Object-) | Establece la licencia venture. |
| [setVersion(int value)](#setVersion-int-) | Obtiene o establece la versión. |
| [setVerticalResolution(double value)](#setVerticalResolution-double-) | Obtiene o establece la resolución vertical, en píxeles por pulgada, de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage). |
...
Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de la ruta especificada de una imagen raster (no una imagen psd en la ruta) con parámetros del constructor.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ruta | java.lang.String | La ruta desde la cual cargar los datos de píxeles y paleta y con la que inicializar. |
| colorMode | short | El modo de color. |
| channelBitDepth | short | La profundidad de bits del PSD por canal. |
| canales | short | El recuento de canales del PSD. |
| psdVersion | int | La versión PSD. |
| compresión | short | La compresión a usar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | java.io.InputStream | El flujo desde el cual cargar los datos de píxeles y paleta y con el que inicializar. |
...
Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de la ruta especificada de una imagen raster (no una imagen psd en el flujo) con parámetros del constructor.
...
Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de una imagen raster existente (no una imagen psd) con modo de color RGB, 4 canales, 8 bits por canal y sin compresión.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| rasterImage | [RasterImage](../../com.aspose.psd/rasterimage) | La imagen desde la cual cargar los datos de píxeles y paleta y con la que inicializar. |
...
Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) a partir de una imagen raster existente (no una imagen psd) con parámetros del constructor.
...
Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) con el ancho y alto especificados. Se utiliza para inicializar una imagen psd vacía.
...
Inicializa una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage) con el ancho, alto, paletter, modo de color, recuento de canales y longitud de bits de los canales especificados, así como los parámetros del modo de compresión especificados. Se utiliza para inicializar una imagen psd vacía.
...
El nombre de codificación predeterminado
...
El objeto que puede usarse para sincronizar el acceso a las capas.
...
Añade la capa de ajuste en blanco y negro.
...
Agrega la capa de ajuste Curves.
...
| gammaCorrection | float | La corrección gamma. |
...
Agrega la capa de ajuste GradientMap.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| groupName | java.lang.String | Nombre del grupo. |
| índice | int | El índice de la capa después de la cual insertar. |
| startBehaviour | boolean | si se establece a  true  [comportamiento de inicio] entonces el grupo estará en estado abierto al iniciar, de lo contrario en estado minimizado. |
...
Agrega la capa de ajuste Levels.
...
Agrega la capa de filtro fotográfico.
...
Agrega la capa de ajuste Posterize.
...
Agrega la capa de ajuste de color selectivo.
...
Agregar capa de forma vacía. Sin rutas. Deben agregarse a la capa de forma antes de guardar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| texto | java.lang.String | El texto de la capa. |
| rect | [Rectangle](../../com.aspose.psd/rectangle) | El rectángulo de la capa. |
...
Agrega la capa de ajuste Threshold.
...
Agrega la capa de ajuste Vibrance.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| newOptions | [PsdOptions](../../com.aspose.psd.imageoptions/psdoptions) | Las nuevas opciones. |
...
Crea una nueva instancia de la clase [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage).

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| psdHeader | com.aspose.internal.fileformats.psd.sections.PsdHeader | El encabezado PSD. |
| colorData | com.aspose.internal.fileformats.psd.sections.ColorData | Los datos de color. |
| imageResources | com.aspose.internal.fileformats.psd.sections.ImageResources | Los recursos de imagen. |
| layerAndMaskInfo | com.aspose.internal.fileformats.psd.sections.LayerAndMaskInfo | La información de capa y máscara. |
| imageData | com.aspose.internal.fileformats.psd.sections.ImageData | Los datos de imagen. |
| colorPalette | [IColorPalette](../../com.aspose.psd/icolorpalette) | La paleta de colores. |
| version | int | La versión PSD. |
| loadOptions | [LoadOptions](../../com.aspose.psd/loadoptions) | Las opciones de carga. |
| noLayerLoad | boolean | Sin carga de capa |
...
Obtiene o establece la capa activa.
...
Obtiene los bits por canal.

Valor: Los bits por canal.
...
Obtiene el recuento de canales PSD.

Valor: El recuento de canales PSD.
...
Obtiene las opciones actuales de la imagen.
...
Obtiene o establece la fuente de reemplazo predeterminada. Si la fuente de reemplazo está establecida, se usará para el renderizado. Necesitamos este método para soporte interno.

**Returns:**
java.lang.String - El nombre de la fuente de reemplazo
...
Obtiene o establece los recursos de capa global.

Valor: Los recursos de capa globales.
...
Obtiene o establece el perfil de color GRAY (monocromo) para imágenes PSD en escala de grises.

Valor: El perfil de color GRAY (monocromo).
...
Obtiene o establece la resolución horizontal, en píxeles por pulgada, de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage).
...
Obtiene o establece las capas PSD.

Valor: Las capas PSD.

--------------------

Nota: si no hay capas, la otra información relacionada dentro de la sección de información de capas y máscaras no se conservará (máscaras de capa, recursos, etc.).
...
Obtiene o establece los recursos de imagen PSD.

Valor: Los recursos de imagen PSD.
...
Obtiene la capa y la máscara.

Valor: La capa y la máscara.
...
Obtiene el administrador de capas vinculadas.
...
Obtiene o establece el encabezado PSD.

Valor: El encabezado PSD.
...
Valor: El formato de datos sin procesar.
...
Valor: El proveedor de objeto inteligente.
...
Obtiene la Línea de tiempo ([.getTimeline](../../null/\#getTimeline)/[.setTimeline(Timeline)](../../null/\#setTimeline-Timeline-)) de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage).
...
Obtiene recursos actualizados con un bloque de recursos completamente nuevo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| resources | [ResourceBlock\[\]](../../com.aspose.psd.fileformats.psd/resourceblock) | Los recursos. |
| resource | [ResourceBlock](../../com.aspose.psd.fileformats.psd/resourceblock) | El recurso a añadir a los recursos existentes. |
| removeDuplicates | boolean | si se establece en  true  elimina recursos con IDs idénticos. |

**Returns:**
com.aspose.psd.fileformats.psd.ResourceBlock[] - Devuelve una matriz con bloques de recursos actualizados.
...
Obtiene o establece la resolución vertical, en píxeles por pulgada, de este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage).
...
Valor:  true  si esta instancia tiene la imagen modificada; de lo contrario,  false .
...
Valor:  true  si el primer canal alfa contiene los datos de transparencia para el resultado fusionado al especificar datos de capas; de lo contrario,  false .
...
Inserta la capa después de la capa especificada con todas las preparaciones.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | La capa. |
| layerToInsert | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | La capa a insertar. |
...
Valor:  true  si esta instancia está aplanada; de lo contrario,  false .
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| bottomLayer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | La capa inferior. |
| topLayer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | La capa superior. |
...
Elimina el recurso global del motor de texto - el método se usa para algunos archivos PSD con capas de texto que no pueden abrirse en Adobe Photoshop después del procesamiento (principalmente relacionado con capas de texto con fuentes ausentes). Después de usar esta opción, el usuario debe hacer lo siguiente en el archivo abierto en Photoshop: Menú \"Text\" -> \"Process absent fonts\". Después de esa operación todo el texto volverá a aparecer. Tenga en cuenta que esta operación puede causar algunos cambios finales en el diseño.
...
Guarda los datos de la imagen en el flujo especificado usando las opciones de guardado y los límites especificados. Opcionalmente exporta solo las capas especificadas para la vista previa de renderizado.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | El flujo al que se guardarán los datos de la imagen. |
| optionsBase | [ImageOptionsBase](../../com.aspose.psd/imageoptionsbase) | Las opciones de guardado a usar. |
| boundsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | El rectángulo de límites de la imagen de destino. Establézcalo en  Rectangle.Empty  para usar los límites de origen. |
| layersToExport | [Layer\[\]](../../com.aspose.psd.fileformats.psd.layers/layer) | Las capas específicas a exportar. Un valor  null  indica el comportamiento predeterminado con todas las capas. |
...
El perfil de color GRAY (monocromo) para imágenes PSD en escala de grises.
...
Establece la resolución para este [PsdImage](../../com.aspose.psd.fileformats.psd/psdimage).
...
Establece la licencia venture.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| ventureLicense | java.lang.Object | La licencia venture. |
