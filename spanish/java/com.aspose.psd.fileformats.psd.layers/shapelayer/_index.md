...
description: "Capa de forma."
type: docs
weight: 29
url: /es/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Capa de forma. Encapsula la lógica de trabajo con la capa de forma y los recursos relacionados.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Inicializa una nueva instancia de la clase [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Campos
...
| [createInstance()](#createInstance--) | Crea una nueva instancia de la clase [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Configuración de relleno para el área interna de las formas en la capa de forma. |
...
| [getPath()](#getPath--) | Obtiene el conjunto de rutas que están presentes en una capa de forma. |
...
| [getStroke()](#getStroke--) | Obtiene o establece la configuración de trazo de las formas. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Se llama cuando [global resources changed]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Se llama cuando [resources change]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Configuración de relleno para el área interna de las formas en la capa de forma. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Obtiene o establece la configuración de trazo de las formas. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Actualiza los recursos a partir de las propiedades de la capa Shape. |
...
Inicializa una nueva instancia de la clase [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). Todos los recursos se crean en su estado predeterminado.
...
Crea una nueva instancia de la clase [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
Configuración de relleno para el área interna de las formas en la capa de forma.
...
Obtiene el conjunto de rutas que están presentes en una capa de forma.
...
Obtiene o establece la configuración de trazo de las formas.
...
**Returns:**
boolean - Valor booleano que indica que la capa es válida.
...
Se llama cuando [global resources changed].

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| remitente | java.lang.Object | El remitente. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | La instancia de EventArgs que contiene los datos del evento. |
...
Se llama cuando [resources change].
