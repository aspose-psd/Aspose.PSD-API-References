...
description: "La clase de capa de texto"
type: docs
weight: 30
url: /es/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Corrige el tamaño de la fuente |
...
| [createInstance_internalized()](#createInstance-internalized--) | Crea la nueva instancia de la clase [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Crea la nueva instancia de la clase [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Obtiene los datos del motor. |
...
| [getFont()](#getFont--) | Obtiene la fuente. |
| [getFonts()](#getFonts--) | Obtiene el conjunto de fuentes de la capa de texto. |
...
| [getInnerText()](#getInnerText--) | Obtiene el texto de la capa |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Obtiene o establece el procesador de recursos. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Obtiene el formato de cadena. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Obtiene la raíz de sincronización. |
| [getText()](#getText--) | Obtiene el texto. |
| [getTextBoundBox()](#getTextBoundBox--) | Obtiene o establece el cuadro delimitador del texto. |
| [getTextColor()](#getTextColor--) | Obtiene el color del texto. |
| [getTextData()](#getTextData--) | Obtiene las porciones del texto. |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Busca y obtiene el recurso [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) del [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Obtiene o establece un valor que indica si [was changed]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Determina si [is font available] [the specified font]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Preprocesa la fuente. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Reemplaza la fuente por la predeterminada. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Obtiene el texto de la capa |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Obtiene o establece el procesador de recursos. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Obtiene o establece el cuadro delimitador del texto. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Obtiene o establece un valor que indica si [was changed]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Actualiza los límites del [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) en los recursos. |
| [updateText(String text)](#updateText-java.lang.String-) | Actualiza el texto. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Actualiza el texto. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Actualiza el texto. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Actualiza el texto. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Actualiza el texto. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Actualiza el texto. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Actualiza el texto. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Actualiza el texto. |
| [wait()](#wait--) |  |
...
Corrige el tamaño de la fuente

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| newSize | float | Nuevo tamaño de fuente |
| yyTransform | double | 'yy' Parámetro de matriz de transformación |

**Returns:**
float - Tamaño corregido
...
Crea la nueva instancia de la clase [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Obtiene los datos del motor.

Valor: Los datos del motor.
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - El conjunto de fuentes de la capa de texto.
...
Obtiene o establece el procesador de recursos.

Valor: El procesador de recursos.
...
Obtiene el formato de cadena.

Valor: El formato de cadena.
...
Valor: El cuadro delimitador del texto.
...
Busca y obtiene el recurso [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) del [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Obtiene o establece un valor que indica si [was changed].

Valor:  true  si [was changed]; otherwise,  false .
...
Determina si [is font available] [the specified font].
...
**Returns:**
boolean - Verdadero si la fuente está disponible
...
Reemplaza la fuente por la predeterminada.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | La fuente. |
| defaultFontName | java.lang.String | Nombre predeterminado de la fuente. |
...
| newWidth | int | El nuevo ancho. |
| newHeight | int | El nuevo alto. |
| resizeType | int | El tipo de transformación de redimensionado  ResizeType |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Actualiza los límites del [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) en los recursos.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | La posición absoluta y el tamaño del texto. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | La posición y el tamaño del texto relativo al cuadro de texto. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| texto | java.lang.String | El valor del texto. |
...
| --- | --- | --- |
| texto | java.lang.String | El valor del texto. |
| color | [Color](../../com.aspose.psd/color) | El valor del color. |
...
| --- | --- | --- |
| texto | java.lang.String | El valor del texto. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | La coordenada superior izquierda. |
...
| texto | java.lang.String | El valor del texto. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | La coordenada superior izquierda. |
| fontSize | float | Tamaño de la fuente. |
