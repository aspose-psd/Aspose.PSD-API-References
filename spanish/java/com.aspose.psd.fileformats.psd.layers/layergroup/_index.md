...
description: "Clase de capa de grupo"
type: docs
weight: 19
url: /es/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Obtiene la altura del grupo de capas. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Obtiene los límites de unión de todas las capas en LayerGroup. |
...
| [getWidth()](#getWidth--) | Obtiene el ancho del grupo de capas. |
...
Obtiene la altura del grupo de capas.
...
Obtiene los límites de unión de todas las capas en LayerGroup.
