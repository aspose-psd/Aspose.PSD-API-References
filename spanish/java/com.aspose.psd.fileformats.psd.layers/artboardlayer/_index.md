...
description: "La clase de capa de mesa de trabajo."
type: docs
weight: 10
url: /es/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
La clase de capa de mesa de trabajo.
## Campos
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Añade la capa al grupo de capas. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Añade la capa al grupo de capas. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Añade el grupo de capas. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Obtiene o establece el color de fondo del artboard. |
...
| [getLayers()](#getLayers--) | Obtiene las capas en el grupo de capas |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Obtiene los límites reales del ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Obtiene el  LayerSectionResource  de los recursos. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Obtiene o establece un valor que indica si [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) tiene el color de fondo. |
...
| [isOpen()](#isOpen--) | Obtiene o establece si la carpeta está abierta; si se establece a true, el grupo estará en estado abierto al iniciar, de lo contrario en estado minimizado. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Obtiene o establece el color de fondo del artboard. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Obtiene o establece si la carpeta está abierta; si se establece a true, el grupo estará en estado abierto al iniciar, de lo contrario en estado minimizado. |
...
Añade la capa al grupo de capas.
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | La capa. |
| índice | int | El índice en el que se insertará la capa. Los valores inválidos significan el final de la lista de capas. |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Devuelve una matriz de dos objetos LayerGroup, donde el primero [0] es el marcador de inicio de grupo y el segundo [1] es el marcador de fin de grupo.
### cacheData() {#cacheData--}
```
...
Obtiene los límites reales del ArtboardLayer.
...
Obtiene el  LayerSectionResource  de los recursos.
...
Obtiene o establece un valor que indica si [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) tiene el color de fondo.
...
Obtiene o establece si la carpeta está abierta; si se establece a true, el grupo estará en estado abierto al iniciar, de lo contrario en estado minimizado.
