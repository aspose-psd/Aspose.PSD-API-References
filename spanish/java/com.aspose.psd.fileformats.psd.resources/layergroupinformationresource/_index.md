...
description: "Recurso de información de grupo de capas"
type: docs
weight: 25
url: /es/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Inicializa una nueva instancia de la clase [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Campos
...
| [getGroups()](#getGroups--) | Obtiene o establece los grupos. |
...
| [setGroups(short[] value)](#setGroups-short---) | Obtiene o establece los grupos. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Actualiza LinkGroupId en las capas a partir de la propiedad Groups. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Actualiza los valores de la propiedad Groups a partir de las capas. |
...
Actualiza LinkGroupId en las capas a partir de la propiedad Groups.
...
Actualiza los valores de la propiedad Groups a partir de las capas.
