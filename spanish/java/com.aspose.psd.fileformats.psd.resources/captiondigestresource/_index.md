...
description: "Recurso CaptionDigest"
type: docs
weight: 13
url: /es/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Inicializa una nueva instancia de la clase [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Campos
...
| [getDigest()](#getDigest--) | Obtiene o establece el resumen. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Obtiene o establece el resumen. |
