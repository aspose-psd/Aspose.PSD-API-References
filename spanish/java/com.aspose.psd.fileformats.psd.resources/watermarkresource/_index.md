...
type: docs
weight: 42
url: /es/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | Inicializa una nueva instancia de la clase [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource). |
## Campos
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | Obtiene o establece un valor que indica si esta instancia es una marca de agua. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | Obtiene o establece un valor que indica si esta instancia es una marca de agua. |
| [toString()](#toString--) |  |
...
Inicializa una nueva instancia de la clase [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource).
...
Obtiene o establece un valor que indica si esta instancia es una marca de agua.

Valor:  true  si esta instancia es una marca de agua; de lo contrario,  false .
