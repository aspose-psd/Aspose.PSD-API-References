...
description: "El recurso con información de bordes de la configuración de impresión de imágenes."
type: docs
weight: 11
url: /es/java/com.aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
El recurso con información de bordes de la configuración de impresión de imágenes.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [BackgroundColorResource()](#BackgroundColorResource--) | Inicializa una nueva instancia de la clase [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource). |
## Campos
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Obtiene o establece el color de fondo. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Obtiene o establece el color de fondo. |
| [setColorSpace(int value)](#setColorSpace-int-) | Obtiene o establece un espacio de color. |
...
Inicializa una nueva instancia de la clase [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource).
...
Obtiene o establece un espacio de color.

Valor: El espacio de color de fondo.
