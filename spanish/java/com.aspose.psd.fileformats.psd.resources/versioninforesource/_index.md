...
description: "Recurso de información de versión"
type: docs
weight: 41
url: /es/java/com.aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
| --- | --- |
| [VersionInfoResource()](#VersionInfoResource--) | Inicializa una nueva instancia de la clase [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource). |
## Campos
...
| [getFileVersion()](#getFileVersion--) | Obtiene o establece la versión del archivo. |
...
| [getReaderName()](#getReaderName--) | Obtiene o establece el nombre del lector. |
...
| [getWriterName()](#getWriterName--) | Obtiene o establece el nombre del escritor. |
| [hasRealMergedData()](#hasRealMergedData--) | Obtiene o establece un valor que indica si esta instancia tiene datos fusionados reales. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Guarda el bloque de recurso en el flujo especificado. |
| [setFileVersion(long value)](#setFileVersion-long-) | Obtiene o establece la versión del archivo. |
...
| [setReaderName(String value)](#setReaderName-java.lang.String-) | Obtiene o establece el nombre del lector. |
| [setRealMergedData(boolean value)](#setRealMergedData-boolean-) | Obtiene o establece un valor que indica si esta instancia tiene datos fusionados reales. |
...
| [setVersion(long value)](#setVersion-long-) | Obtiene o establece la versión. |
| [setWriterName(String value)](#setWriterName-java.lang.String-) | Obtiene o establece el nombre del escritor. |
| [toString()](#toString--) |  |
...
Inicializa una nueva instancia de la clase [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource).
...
Valor:  true  si esta instancia tiene datos combinados reales; de lo contrario,  false .
