...
description: "Recurso de indicadores de impresión"
type: docs
weight: 30
url: /es/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
Recurso de indicadores de impresión
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Inicializa una nueva instancia de la clase [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource). |
## Campos
...
| [getBleedScale()](#getBleedScale--) | Obtiene o establece la escala de sangrado. |
| [getBleedWidth()](#getBleedWidth--) | Obtiene o establece el ancho del sangrado. |
| [getCenterCropMark()](#getCenterCropMark--) | Obtiene o establece la marca de recorte central. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Obtiene o establece la escala de sangrado. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Obtiene o establece el ancho del sangrado. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Obtiene o establece la marca de recorte central. |
...
Inicializa una nueva instancia de la clase [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource).
...
Obtiene o establece el ancho del sangrado.

Valor: El ancho del sangrado.
...
Obtiene o establece la marca de recorte central.

Valor: La marca de recorte central.
