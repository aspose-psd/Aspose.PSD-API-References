...
description: "Recurso de información de máscara rápida"
type: docs
weight: 32
url: /es/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Recurso de información de máscara rápida
## Constructores

| Constructor | Descripción |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Inicializa una nueva instancia de la clase [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource). |
## Campos
...
| [getChannelId()](#getChannelId--) | Obtiene o establece el identificador del canal. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Obtiene o establece un valor que indica si esta instancia está vacía de máscara. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Guarda el bloque de recurso en el flujo especificado. |
| [setChannelId(short value)](#setChannelId-short-) | Obtiene o establece el identificador del canal. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Obtiene o establece un valor que indica si esta instancia está vacía de máscara. |
...
Inicializa una nueva instancia de la clase [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource).
...
Obtiene o establece el identificador del canal.

Valor: El identificador del canal.
...
Obtiene o establece un valor que indica si esta instancia está vacía de máscara.

Valor:  true  si esta instancia está vacía de máscara; de lo contrario,  false .
