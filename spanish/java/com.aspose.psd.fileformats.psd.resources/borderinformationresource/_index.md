...
type: docs
weight: 12
url: /es/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | Inicializa una nueva instancia de la clase [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource). |
## Campos
...
| [getUnit()](#getUnit--) | Obtiene o establece las unidades del borde. |
| [getWidth()](#getWidth--) | Obtiene o establece el ancho del borde. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | Obtiene o establece las unidades del borde. |
| [setWidth(double value)](#setWidth-double-) | Obtiene o establece el ancho del borde. |
| [toString()](#toString--) |  |
...
Inicializa una nueva instancia de la clase [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource).
