...
description: "Recurso de relación de aspecto de píxel"
type: docs
weight: 29
url: /es/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
Recurso de relación de aspecto de píxel
## Constructores

| Constructor | Descripción |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | Inicializa una nueva instancia de la clase [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Campos
...
| [getAspectRatio()](#getAspectRatio--) | Obtiene o establece la relación de aspecto. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | Obtiene o establece la relación de aspecto. |
...
Obtiene o establece la relación de aspecto.

Valor: La relación de aspecto.
