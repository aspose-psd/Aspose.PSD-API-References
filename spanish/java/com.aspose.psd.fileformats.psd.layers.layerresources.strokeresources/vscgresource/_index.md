...
description: "Recurso de datos de contenido de trazo vectorial."
type: docs
weight: 13
url: /es/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
| --- | --- |
| [VscgResource()](#VscgResource--) | Inicializa una nueva instancia de la clase [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource). |
## Campos
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Obtiene o establece el nombre de la clase. |
| [getClassName_internalized()](#getClassName-internalized--) | Obtiene o establece el identificador de la clase. |
| [getHeader_internalized()](#getHeader-internalized--) | Obtiene o establece el encabezado. |
| [getItems()](#getItems--) | Obtiene o establece los elementos de la estructura. |
| [getKey()](#getKey--) | Obtiene la clave del recurso de capa. |
| [getKeyForData()](#getKeyForData--) | Clave entera que define qué tipo de configuración de relleno se almacena en el recurso: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtiene o establece el nombre de la clase. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Obtiene o establece el identificador de la clase. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Obtiene o establece los elementos de la estructura. |
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Obtiene la clave entera que define qué tipo de configuración de relleno se almacena en el recurso: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey ¡Advertencia! El valor de la propiedad KeyForData debe coincidir con el tipo de configuración de relleno almacenado en las estructuras Items. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Método interno que permite asignar la propiedad de solo lectura KeyForData. |
...
Inicializa una nueva instancia de la clase [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource).
...
Obtiene o establece los elementos de la estructura.

Valor: Los elementos de la estructura.
...
Clave entera que define qué tipo de configuración de relleno se almacena en el recurso: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Obtiene la clave entera que define qué tipo de configuración de relleno se almacena en el recurso: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey ¡Advertencia! El valor de la propiedad KeyForData debe coincidir con el tipo de configuración de relleno almacenado en las estructuras Items.
...
Método interno que permite asignar la propiedad de solo lectura KeyForData. Debe usarse solo en el cargador de recursos Vscg al asignar propiedades del recurso.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | Valor entero para la propiedad KeyForData. |
