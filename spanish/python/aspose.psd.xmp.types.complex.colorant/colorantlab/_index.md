---
title: "Clase ColorantLab"
type: docs
weight: 30
url: /es/python-net/aspose.psd.xmp.types.complex.colorant/colorantlab/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ColorantLab()](#ColorantLab__1) | Inicializa una nueva instancia de la clase [ColorantLab](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colorantlab/). |
| [ColorantLab(a, b, l)](#ColorantLab_a_b_l_2) | Inicializa una nueva instancia de la clase [ColorantLab](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colorantlab/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| MAX_A [static] | int | r | El valor máximo del componente A |
| MAX_B [static] | int | r | El valor máximo del componente A |
| MAX_L [static] | float | r | El valor máximo del componente A |
| MIN_A [static] | int | r | El valor mínimo del componente A |
| MIN_B [static] | int | r | El valor mínimo del componente B |
| MIN_L [static] | float | r | El valor mínimo del componente L |
| a | int | r/w | Obtiene o establece el componente A. |
| b | int | r/w | Obtiene o establece el componente B. |
...
| l | float | r/w | Obtiene o establece el componente L. |
...
Inicializa una nueva instancia de la clase [ColorantLab](/psd/python-net/aspose.psd.xmp.types.complex.colorant/colorantlab/).
