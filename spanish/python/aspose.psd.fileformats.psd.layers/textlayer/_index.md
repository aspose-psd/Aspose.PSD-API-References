...
type: docs
weight: 1750
url: /es/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Obtiene la fuente. |
| has_alpha | bool | r |  |
...
| inner_text | string | r | Obtiene el texto de la capa |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Obtiene o establece el cuadro delimitador del texto. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Obtiene el color del texto. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Obtiene las porciones de texto. |
| top | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Obtiene el conjunto de fuentes de la capa de texto. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Redimensiona la imagen. Se usa el valor predeterminado [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/). |
...
| [update_text(text)](#update_text_text_38) | Actualiza el texto. |
| [update_text(text, color)](#update_text_text_color_39) | Actualiza el texto. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Actualiza el texto. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Actualiza el texto. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Actualiza el texto. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Actualiza el texto. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Actualiza el texto. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Actualiza el texto. |
...
| Tipo | Descripción |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | El conjunto de fuentes de la capa de texto. |
...
Redimensiona la imagen. Se usa el valor predeterminado [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/).
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | El tipo de transformación de redimensionamiento [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | El valor del texto. |
| color | [Color](/psd/python-net/aspose.psd/color) | El valor del color. |
...
| :- | :- | :- |
| text | string | El valor del texto. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | La coordenada superior izquierda. |
