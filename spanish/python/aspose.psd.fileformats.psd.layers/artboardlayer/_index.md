---
title: "Clase ArtboardLayer"
type: docs
weight: 90
url: /es/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Obtiene o establece el color de fondo del tablero. |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | Obtiene o establece un valor que indica si [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) tiene el color de fondo. |
| has_transparent_color | bool | r/w |  |
| altura | int | r | <inheritdoc /> |
...
| is_cached | bool | r |  |
| is_open | bool | r/w | Obtiene o establece si la carpeta está abierta<br/>            si se establece en <c>true</c> entonces el grupo estará en estado abierto al iniciar, de lo contrario en estado minimizado. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Obtiene las capas del grupo de capas |
...
| **Name** | **Descripción** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Añade la capa al grupo de capas. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Añade el grupo de capas. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Carga píxeles ARGB de 32 bits parcialmente (por bloques). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Carga datos sin procesar. |
