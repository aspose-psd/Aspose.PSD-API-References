---
title: "Clase ShapeLayer"
type: docs
weight: 1600
url: /es/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Inicializa una nueva instancia de la clase [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Todos los recursos se crean en su estado predeterminado. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Obtiene o establece la configuración de relleno para el área interna de Shapes en la capa Shape. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Obtiene el conjunto de Paths que están presentes en una capa Shape. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Obtiene o establece la configuración de trazo de Shapes. |
| top | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Crea una nueva instancia de la clase [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Actualiza recursos de las propiedades de la capa Shape. |
...
Inicializa una nueva instancia de la clase [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Todos los recursos se crean en su estado predeterminado.
...
Crea una nueva instancia de la clase [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Tipo | Descripción |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Devuelve una nueva instancia de la clase [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
