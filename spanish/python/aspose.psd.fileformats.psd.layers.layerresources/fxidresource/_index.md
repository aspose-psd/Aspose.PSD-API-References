...
type: docs
weight: 290
url: /es/python-net/aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [FXidResource(key, version, filter_effect_masks)](#FXidResource_key_version_filter_effect_masks_1) | Inicializa una nueva instancia de la clase [FXidResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/fxidresource/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| F_EID_TYPE_TOOL_KEY [static] | int | r | La clave de información de la herramienta de tipo FEid. |
| F_XID_TYPE_TOOL_KEY [static] | int | r | La clave de información de la herramienta de tipo FXid. |
...
| filter_effect_masks | [FilterEffectMaskData[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | r | Obtiene las máscaras de efecto de filtro. |
...
Inicializa una nueva instancia de la clase [FXidResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/fxidresource/).
...
| filter_effect_masks | [FilterEffectMaskData[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Las máscaras de efecto de filtro. |
