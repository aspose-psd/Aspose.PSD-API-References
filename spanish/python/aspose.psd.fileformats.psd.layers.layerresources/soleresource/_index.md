...
type: docs
weight: 940
url: /es/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [SoLeResource()](#SoLeResource__1) | Inicializa una nueva instancia de la clase [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
| [SoLeResource(unique_id, is_custom, has_comp_info)](#SoLeResource_unique_id_is_custom_has_comp_info_2) | Inicializa una nueva instancia de la clase [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | La clave de información de la herramienta de tipo: 'SoLE'. |
...
Inicializa una nueva instancia de la clase [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/).
...
| :- | :- | :- |
| unique_id | Guid | El identificador único de los datos de capa colocada [PlLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/). |
