...
type: docs
weight: 40
url: /es/python-net/aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifica la clave de estructura de AnDs. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | Obtiene o establece las estructuras de sección de datos animados. |
