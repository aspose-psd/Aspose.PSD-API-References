...
type: docs
weight: 150
url: /es/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ReferenceStructure(key_name)](#ReferenceStructure_key_name_1) | Inicializa una nueva instancia de la [ReferenceStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/) clase. |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifica la clave de la estructura. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | Obtiene o establece una copia de una matriz de estructuras. |
...
Inicializa una nueva instancia de la [ReferenceStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/) clase.
