...
type: docs
weight: 10
url: /es/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Inicializa una nueva instancia de la clase [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifica la clave de la estructura. |
| data_length | int | r | Obtiene la longitud exacta de los datos en bytes. |
| full_path | string | r/w | Obtiene o establece la ruta completa. |
...
Inicializa una nueva instancia de la clase [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/).
