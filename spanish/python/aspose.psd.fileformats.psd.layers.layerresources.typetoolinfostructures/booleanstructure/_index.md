...
type: docs
weight: 20
url: /es/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [BooleanStructure(key_name)](#BooleanStructure_key_name_1) | Inicializa una nueva instancia de la clase [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/). |
## **Properties**
...
| value | bool | r/w | Obtiene o establece un valor booleano. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
Inicializa una nueva instancia de la clase [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/).
