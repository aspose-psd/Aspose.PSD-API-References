---
title: "Clase FillLayer"
type: docs
weight: 10
url: /es/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Obtiene o establece la configuración de relleno. |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | Obtiene el tipo de relleno. |
| filler | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | Crea una nueva instancia de la clase [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) según el tipo de relleno. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | Reemplaza todos los colores no transparentes con un nuevo color y preserva el valor alfa original para mantener bordes suaves.<br/>            Nota: si lo usas en imágenes sin transparencia, todos los colores se reemplazarán por uno solo. |
...
| update() | Actualiza los datos de píxeles de la capa de relleno basándose en el [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) actual. |
...
Crea una nueva instancia de la clase [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) según el tipo de relleno.

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | El tipo de capa de relleno. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | Devuelve una nueva instancia de la clase [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) según el tipo de relleno. |
