---
title: "Clase LayerSelectionIdsResource"
type: docs
weight: 170
url: /es/python-net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource__1) | Inicializa una nueva instancia de la clase LayerSelectionIdsResource |
## **Properties**
...
| count | short | r/w | Obtiene o establece el count. |
...
| layer_ids | int | r/w | Obtiene o establece los layer ids. |
...
Inicializa una nueva instancia de la clase LayerSelectionIdsResource
