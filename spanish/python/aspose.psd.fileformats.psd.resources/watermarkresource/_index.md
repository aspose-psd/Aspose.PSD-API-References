...
type: docs
weight: 310
url: /es/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | Inicializa una nueva instancia de la clase WatermarkResource |
## **Properties**
...
| is_watermark | bool | r/w | Obtiene o establece un valor que indica si esta instancia es una marca de agua. |
...
Inicializa una nueva instancia de la clase WatermarkResource
