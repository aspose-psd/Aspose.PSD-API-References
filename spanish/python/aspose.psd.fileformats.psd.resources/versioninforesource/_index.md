...
type: docs
weight: 300
url: /es/python-net/aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [VersionInfoResource()](#VersionInfoResource__1) | Inicializa una nueva instancia de la clase VersionInfoResource |
## **Properties**
...
| file_version | uint | r/w | Obtiene o establece la versión del archivo. |
| has_real_merged_data | bool | r/w | Obtiene o establece un valor que indica si esta instancia tiene datos fusionados reales. |
...
| reader_name | string | r/w | Obtiene o establece el nombre del lector. |
...
| version | uint | r/w | Obtiene o establece la versión. |
| writer_name | string | r/w | Obtiene o establece el nombre del escritor. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
Inicializa una nueva instancia de la clase VersionInfoResource
