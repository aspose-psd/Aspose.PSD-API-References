...
type: docs
weight: 200
url: /es/python-net/aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [PrintFlagsResource()](#PrintFlagsResource__1) | Inicializa una nueva instancia de la clase PrintFlagsResource |
## **Properties**
...
| bleed_scale | short | r/w | Obtiene o establece la escala de sangrado. |
| bleed_width | int | r/w | Obtiene o establece el ancho del sangrado. |
| center_crop_mark | byte | r/w | Obtiene o establece la marca de recorte central. |
...
Inicializa una nueva instancia de la clase PrintFlagsResource
