...
type: docs
weight: 230
url: /es/python-net/aspose.psd.fileformats.psd.resources/resolutioninforesource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ResolutionInfoResource()](#ResolutionInfoResource__1) | Inicializa una nueva instancia de la clase ResolutionInfoResource |
## **Properties**
...
| h_res_display_unit | [ResolutionUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/resolutionunit/) | r/w | Unidades de visualización para la resolución horizontal.  Esto solo afecta a la<br/>            interfaz de usuario; la resolución todavía se almacena en el archivo PSD<br/>            como píxeles/pulgada. |
| height_display_unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | Obtiene o establece la unidad de visualización de la altura. |
...
| v_dpi | [FixedPointDecimal](/psd/python-net/aspose.psd.fileformats.psd.resources/fixedpointdecimal) | r/w | DPI vertical. |
| v_res_display_unit | [ResolutionUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/resolutionunit/) | r/w | Unidades de visualización para la resolución vertical. |
| width_display_unit | [PhysicalUnit](/psd/python-net/aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/) | r/w | Obtiene o establece la unidad de visualización del ancho. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
Inicializa una nueva instancia de la clase ResolutionInfoResource
