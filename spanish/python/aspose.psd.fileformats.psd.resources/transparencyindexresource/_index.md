...
type: docs
weight: 260
url: /es/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | Inicializa una nueva instancia de la clase TransparencyIndexResource |
## **Properties**
...
| transparency_index | short | r/w | Obtiene o establece el índice de color de transparencia. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
Inicializa una nueva instancia de la clase TransparencyIndexResource
