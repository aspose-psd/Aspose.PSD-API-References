...
type: docs
weight: 20
url: /es/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Obtiene o establece el valor de Tint Color. |
| tint_color_blue | double | r/w | Obtiene o establece el valor doble de Blue Tint Color. |
| tint_color_green | double | r/w | Obtiene o establece el valor doble de Green Tint Color. |
| tint_color_red | double | r/w | Obtiene o establece el valor doble de Red Tint Color. |
| top | int | r/w |  |
