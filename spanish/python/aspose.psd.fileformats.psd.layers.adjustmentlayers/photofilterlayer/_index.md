...
type: docs
weight: 160
url: /es/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| recorte | byte | r/w |  |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Obtiene o establece el color RGB del filtro. |
...
| density | int | r/w | Obtiene o establece la densidad del filtro |
