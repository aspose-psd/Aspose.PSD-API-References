---
title: "CurvesLayer Clase"
type: docs
weight: 90
url: /es/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | r/w | Obtiene o establece un valor que indica si esta instancia usa un administrador continuo. |
| is_discrete_manager_used | bool | r/w | Obtiene o establece un valor que indica si esta instancia usa un administrador discreto. |
...
| [get_curves_manager()](#get_curves_manager__8) | Obtiene el administrador de curvas. |
