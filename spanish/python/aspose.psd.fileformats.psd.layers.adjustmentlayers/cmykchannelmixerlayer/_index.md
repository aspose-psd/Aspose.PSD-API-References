---
title: "CmykChannelMixerLayer Clase"
type: docs
weight: 50
url: /es/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtiene el canal negro. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtiene el canal cian. |
...
| left | int | r/w |  |
| longitud | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtiene el canal magenta. |
| monochrome | bool | r/w | Obtiene o establece un valor que indica si este [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) es monocromo. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtiene el canal amarillo. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Obtiene el índice del canal por. Devuelve CmykMixerChannel |
