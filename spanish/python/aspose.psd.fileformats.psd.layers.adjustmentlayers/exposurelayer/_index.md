---
title: "Clase ExposureLayer"
type: docs
weight: 100
url: /es/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| disposed | bool | r |  |
| exposición | float | r/w | Obtiene o establece la Exposición. Para PS, el rango de Exposición es de -20 a +20. |
| extra_length | int | r |  |
...
| gamma_correction | float | r/w | Obtiene o establece la GammaCorrection. Para PS, el rango de GammaCorrection es de 9.99 a +0.01 |
| has_alpha | bool | r |  |
...
| offset | float | r/w | Obtiene o establece el Offset. Para PS, el rango de Offset es de -0.5 a +0.5 |
| opacity | byte | r/w |  |
