...
type: docs
weight: 30
url: /es/python-net/aspose.psd.fileformats.psd.layers.layereffects/dropshadoweffect/
---
...
| knocks_out | bool | r/w | Obtiene o establece un valor que indica si [knocks out]. |
...
| propagación | int | r/w | Obtiene o establece la intensidad como un porcentaje. |
