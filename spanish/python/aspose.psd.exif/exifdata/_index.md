...
type: docs
weight: 10
url: /es/python-net/aspose.psd.exif/exifdata/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ExifData()](#ExifData__1) | Inicializa una nueva instancia de la clase [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) . |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | Inicializa una nueva instancia de la clase [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) con datos de una matriz. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | Inicializa una nueva instancia de la clase [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) con datos de una matriz. |
## **Properties**
...
Inicializa una nueva instancia de la clase [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) .
...
Inicializa una nueva instancia de la clase [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) con datos de una matriz.
