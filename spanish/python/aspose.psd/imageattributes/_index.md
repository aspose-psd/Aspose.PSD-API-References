...
type: docs
weight: 2180
url: /es/python-net/aspose.psd/imageattributes/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ImageAttributes()](#ImageAttributes__1) | Inicializa una nueva instancia de la clase ImageAttributes |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
| clear_brush_remap_table() | Borra la tabla de remapeo de color del pincel de este objeto [ImageAttributes](/psd/python-net/aspose.psd/imageattributes/). |
...
| clear_remap_table() | Borra la tabla de remapeo de color para la categoría predeterminada. |
| [clear_remap_table(type)](#clear_remap_table_type_7) | Borra la tabla de remapeo de color para una categoría especificada. |
...
| [set_brush_remap_table(map)](#set_brush_remap_table_map_9) | Establece la tabla de remapeo de color para la categoría de pincel. |
...
| [set_remap_table(map)](#set_remap_table_map_25) | Establece la tabla de remapeo de color para la categoría predeterminada. |
| [set_remap_table(map, type)](#set_remap_table_map_type_26) | Establece la tabla de remapeo de color para una categoría especificada. |
...
| [set_wrap_mode(mode, color)](#set_wrap_mode_mode_color_30) | Establece el modo de envoltura y el color usados para decidir cómo mosaicar una textura a lo largo de una forma, o en los límites de la forma. Una textura se mosaica a lo largo de una forma para rellenarla cuando la textura es más pequeña que la forma que está rellenando. |
| [set_wrap_mode(mode, color, clamp)](#set_wrap_mode_mode_color_clamp_31) | Establece el modo de envoltura y el color usados para decidir cómo mosaicar una textura a lo largo de una forma, o en los límites de la forma. Una textura se mosaica a lo largo de una forma para rellenarla cuando la textura es más pequeña que la forma que está rellenando. |
...
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se elimina la clave de color. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se elimina la matriz de ajuste de color. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se desactiva la corrección gamma. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se elimina la configuración NoOp. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se borra la configuración del canal de salida. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se borra la configuración del perfil del canal de salida. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se borra la tabla de remapeo. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se borra el umbral. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | Una matriz de objetos [ColorMap](/psd/python-net/aspose.psd/colormap/). |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| color_low | [Color](/psd/python-net/aspose.psd/color) | El valor bajo de la clave de color. |
| color_high | [Color](/psd/python-net/aspose.psd/color) | El valor alto de la clave de color. |
...
| color_low | [Color](/psd/python-net/aspose.psd/color) | El valor bajo de la clave de color. |
| color_high | [Color](/psd/python-net/aspose.psd/color) | El valor alto de la clave de color. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece la clave de color. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de color. |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de escala de grises. |
...
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de color. |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de escala de grises. |
| flags | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un elemento de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) que especifica el tipo de imagen y color que se verá afectado por las matrices de ajuste de color y ajuste de escala de grises. |
...
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de color. |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de escala de grises. |
| mode | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un elemento de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) que especifica el tipo de imagen y color que se verá afectado por las matrices de ajuste de color y ajuste de escala de grises. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establecen las matrices de ajuste de color y ajuste de escala de grises. |
...
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de color. |
| flags | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un elemento de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) que especifica el tipo de imagen y color que se verá afectado por la matriz de ajuste de color. |
...
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matriz de ajuste de color. |
| mode | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un elemento de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) que especifica el tipo de imagen y color que se verá afectado por la matriz de ajuste de color. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece la matriz de ajuste de color. |
...
| :- | :- | :- |
| gamma | float | El valor de corrección gamma. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de la enumeración [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece el valor gamma. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se desactiva la corrección de color. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| flags | [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag) | Un elemento de [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag/) que especifica el canal de salida. |
...
| :- | :- | :- |
| flags | [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag) | Un elemento de [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag/) que especifica el canal de salida. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece el canal de salida. |
...
| :- | :- | :- |
| color_profile_filename | string | El nombre de ruta de un archivo de perfil de color. Si el archivo de perfil de color está en el directorio %SystemRoot%\System32\Spool\Drivers\Color, este parámetro puede ser el nombre del archivo. De lo contrario, este parámetro debe ser el nombre de ruta totalmente calificado. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece el archivo de perfil de color del canal de salida. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | Una matriz de pares de colores del tipo [ColorMap](/psd/python-net/aspose.psd/colormap/). Cada par de colores contiene un color existente (el primer valor) y el color al que se mapeará (el segundo valor). |
...
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | Una matriz de pares de colores del tipo [ColorMap](/psd/python-net/aspose.psd/colormap/). Cada par de colores contiene un color existente (el primer valor) y el color al que se mapeará (el segundo valor). |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece la tabla de remapeo de color. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| threshold | float | Un valor de umbral de 0.0 a 1.0 que se usa como punto de interrupción para ordenar colores que se asignarán a un valor máximo o mínimo. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un elemento de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) que especifica la categoría para la cual se establece el umbral de color. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | Un elemento de [WrapMode](/psd/python-net/aspose.psd/wrapmode/) que especifica cómo se utilizan copias repetidas de una imagen para mosaicar un área. |
...
Establece el modo de envoltura y el color usados para decidir cómo mosaicar una textura a lo largo de una forma, o en los límites de la forma. Una textura se mosaica a lo largo de una forma para rellenarla cuando la textura es más pequeña que la forma que está rellenando.
...
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | Un elemento de [WrapMode](/psd/python-net/aspose.psd/wrapmode/) que especifica cómo se utilizan copias repetidas de una imagen para mosaicar un área. |
| color | [Color](/psd/python-net/aspose.psd/color) | Un objeto [ImageAttributes](/psd/python-net/aspose.psd/imageattributes/) que especifica el color de los píxeles fuera de una imagen renderizada. Este color es visible si el parámetro mode se establece en [WrapMode.CLAMP](/psd/python-net/aspose.psd/wrapmode/) y el rectángulo fuente pasado a DrawImage es mayor que la propia imagen. |
...
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | Un elemento de [WrapMode](/psd/python-net/aspose.psd/wrapmode/) que especifica cómo se utilizan copias repetidas de una imagen para mosaicar un área. |
| color | [Color](/psd/python-net/aspose.psd/color) | Un objeto de color que especifica el color de los píxeles fuera de una imagen renderizada. Este color es visible si el parámetro mode se establece en [WrapMode.CLAMP](/psd/python-net/aspose.psd/wrapmode/) y el rectángulo fuente pasado a DrawImage es mayor que la propia imagen. |
| sujetar | bool | Este parámetro no tiene efecto. Establécelo en false. |
