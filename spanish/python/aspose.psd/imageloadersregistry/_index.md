...
type: docs
weight: 2260
url: /es/python-net/aspose.psd/imageloadersregistry/
---
...
| :- | :- | :- | :- |
| registered_descriptors [static] | [IImageLoaderDescriptor[]](/psd/python-net/aspose.psd/iimageloaderdescriptor) | r | Obtiene los descriptores registrados. |
| registered_formats [static] | [FileFormat](/psd/python-net/aspose.psd/fileformat) | r | Obtiene los formatos de carga de imagen registrados. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
| [create_first_supported_loader(stream, load_options)](#create_first_supported_loader_stream_load_options_1) | Crea el primer cargador encontrado que sea adecuado para el <paramref name="stream" /> especificado y, opcionalmente, el <paramref name="loadOptions" />. |
| [get_first_supported_descriptor(stream, load_options)](#get_first_supported_descriptor_stream_load_options_2) | Obtiene el primer descriptor compatible encontrado que sea adecuado para el <paramref name="stream" /> especificado y, opcionalmente, el <paramref name="loadOptions" />. |
...
Crea el primer cargador encontrado que sea adecuado para el <paramref name="stream" /> especificado y, opcionalmente, el <paramref name="loadOptions" />.
...
| Tipo | Descripción |
| :- | :- |
| [IImageLoader](/psd/python-net/aspose.psd/iimageloader) | El cargador que admite el <paramref name="stream" /> y <paramref name="loadOptions" /> especificados, o null si no se encuentra ningún cargador de este tipo. |
...
Obtiene el primer descriptor compatible encontrado que sea adecuado para el <paramref name="stream" /> especificado y, opcionalmente, el <paramref name="loadOptions" />.
...
| Tipo | Descripción |
| :- | :- |
| [IImageLoaderDescriptor](/psd/python-net/aspose.psd/iimageloaderdescriptor) | El descriptor del cargador que admite el <paramref name="stream" /> y <paramref name="loadOptions" /> especificados, o null si no se encuentra ningún descriptor de este tipo. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| file_format | [FileFormat](/psd/python-net/aspose.psd/fileformat) | El formato de archivo del descriptor compatible. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [IImageLoaderDescriptor](/psd/python-net/aspose.psd/iimageloaderdescriptor) | El primer descriptor de cargador encontrado, o null si no se encuentra dicho descriptor. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| image_loader_descriptor | [IImageLoaderDescriptor](/psd/python-net/aspose.psd/iimageloaderdescriptor) | El descriptor del cargador de imagen. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| loader_descriptor | [IImageLoaderDescriptor](/psd/python-net/aspose.psd/iimageloaderdescriptor) | El descriptor del cargador a registrar. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| loader_descriptor | [IImageLoaderDescriptor](/psd/python-net/aspose.psd/iimageloaderdescriptor) | El descriptor del cargador a desregistrar. |
