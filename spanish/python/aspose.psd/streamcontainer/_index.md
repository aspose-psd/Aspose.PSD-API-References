...
type: docs
weight: 4230
url: /es/python-net/aspose.psd/streamcontainer/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [StreamContainer(stream)](#StreamContainer_stream_1) | Inicializa una nueva instancia de la clase [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [StreamContainer(stream, dispose_stream)](#StreamContainer_stream_dispose_stream_2) | Inicializa una nueva instancia de la clase [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
## **Properties**
...
| [save(destination_stream)](#save_destination_stream_4) | Guarda (copia) los datos de la secuencia al flujo especificado. Utiliza el tamaño de búfer predeterminado [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) y el valor de la secuencia [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_5) | Guarda (copia) todos los datos de la secuencia al flujo especificado. Utiliza el valor de la secuencia [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size, length)](#save_destination_stream_buffer_size_length_6) | Guarda (copia) los datos de la secuencia al flujo especificado. |
| [save(file_path)](#save_file_path_7) | Guarda (copia) los datos de la secuencia al flujo especificado. Utiliza el tamaño de búfer predeterminado [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) y el valor de la secuencia [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_8) | Guarda (copia) los datos del flujo al flujo especificado. Utiliza el valor del flujo [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size, length)](#save_file_path_buffer_size_length_9) | Guarda (copia) los datos de la secuencia al flujo especificado. |
| [seek(offset, origin)](#seek_offset_origin_10) | Establece la posición dentro del flujo actual. |
...
| [to_bytes()](#to_bytes__11) | Convierte los datos del flujo a una matriz de enteros. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_12) | Convierte los datos del flujo a una matriz de enteros. |
| [write(buffer, offset, count)](#write_buffer_offset_count_13) | Escribe una secuencia de bytes en el flujo actual y avanza la posición actual dentro de este flujo en la cantidad de bytes escritos. |
| [write(bytes)](#write_bytes_14) | Escribe todos los bytes especificados en el flujo. |
| [write_byte(value)](#write_byte_value_15) | Escribe un byte en la posición actual del flujo y avanza la posición dentro del flujo en un byte. |
| [write_to(stream_container)](#write_to_stream_container_16) | Copia los datos contenidos a otro [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [write_to(stream_container, length)](#write_to_stream_container_length_17) | Copia los datos contenidos a otro [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
...
Inicializa una nueva instancia de la clase [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/).
