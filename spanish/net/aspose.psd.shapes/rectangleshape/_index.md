...
description: "Clase Aspose.PSD.Shapes.RectangleShape. Representa una forma rectangular"
type: docs
weight: 6030
url: /es/net/aspose.psd.shapes/rectangleshape/
---
{{< psd/tize >}}
...
| Nombre | Descripción |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Inicializa una nueva instancia de la clase `RectangleShape`. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Inicializa una nueva instancia de la clase `RectangleShape`. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Obtiene los segmentos de la forma. |
