...
description: Aspose.PSD.Shapes.RectangleShape clase. Representa una forma rectangular.
type: docs
weight: 5530
...
| Nombre | Descripción |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Inicializa una nueva instancia del`RectangleShape` clase. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Inicializa una nueva instancia del`RectangleShape` clase. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Obtiene los segmentos de forma. |
