...
description: "Clase Aspose.PSD.Shapes.EllipseShape. Representa una forma elíptica"
type: docs
weight: 5990
url: /es/net/aspose.psd.shapes/ellipseshape/
---
{{< psd/tize >}}
## EllipseShape class
...
| Nombre | Descripción |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | Inicializa una nueva instancia de la clase `EllipseShape`. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | Inicializa una nueva instancia de la clase `EllipseShape`. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | Obtiene los segmentos de la forma. |
