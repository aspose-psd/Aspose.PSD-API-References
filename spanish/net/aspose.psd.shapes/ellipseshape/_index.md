...
description: Aspose.PSD.Shapes.EllipseShape clase. Representa una forma de elipse.
type: docs
weight: 5490
...
| Nombre | Descripción |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | Inicializa una nueva instancia del`EllipseShape` clase. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | Inicializa una nueva instancia del`EllipseShape` clase. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | Obtiene los segmentos de forma. |
