...
description: "Clase Aspose.PSD.Shapes.CurveShape. Representa una forma de spline curvada"
type: docs
weight: 5980
...
| Nombre | Descripción |
| --- | --- |
| [CurveShape](curveshape/#constructor)() | Inicializa una nueva instancia de la clase `CurveShape`. |
| [CurveShape](curveshape/#constructor_1)(PointF[]) | Inicializa una nueva instancia de la clase `CurveShape`. Se usa la tensión predeterminada de 0.5. |
| [CurveShape](curveshape/#constructor_2)(PointF[], bool) | Inicializa una nueva instancia de la clase `CurveShape`. Se usa la tensión predeterminada de 0.5. |
| [CurveShape](curveshape/#constructor_3)(PointF[], float) | Inicializa una nueva instancia de la clase `CurveShape`. |
| [CurveShape](curveshape/#constructor_4)(PointF[], float, bool) | Inicializa una nueva instancia de la clase `CurveShape`. |
...
| override [Segments](../../aspose.psd.shapes/curveshape/segments/) { get; } | Obtiene los segmentos de la forma. |
