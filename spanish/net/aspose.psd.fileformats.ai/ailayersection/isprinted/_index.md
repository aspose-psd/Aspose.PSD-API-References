...
description: Obtiene o establece un valor que indica si esta capa está impresa. Hace que la ilustración contenida en la capa sea imprimible si es verdadero.
type: docs
weight: 80
