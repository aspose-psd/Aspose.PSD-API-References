...
description: Obtiene o establece el número de color. 1 es el valor de color personalizado de las propiedades Rojo Verde Azul. Especifica la configuración de color de la capa.
type: docs
weight: 20
