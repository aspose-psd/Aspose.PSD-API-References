...
description: Obtiene o establece un valor que indica si esta capa es una vista previa. Muestra la ilustración contenida en la capa en color en lugar de como contornos.
type: docs
weight: 70
