...
description: "Constructor VectorShapeOriginSettings. Inicializa una nueva instancia de la clase VectorShapeOriginSettings"
type: docs
weight: 10
url: /es/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

Inicializa una nueva instancia de la clase [`VectorShapeOriginSettings`](../).
...
| --- | --- | --- |
| isShapeInvalidated | Boolean | El valor de forma invalidada. |
| originIndex | Int32 | El índice de origen de la forma. |
