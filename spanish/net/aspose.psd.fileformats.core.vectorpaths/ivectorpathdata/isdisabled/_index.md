...
description: "Propiedad IVectorPathData. Obtiene o establece un valor que indica si esta instancia está deshabilitada"
type: docs
weight: 10
...
`true` si esta instancia está deshabilitada; de lo contrario, `false`.
