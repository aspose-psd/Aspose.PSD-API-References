...
description: Define la matriz de transformación de forma vectorial class
type: docs
weight: 1460
...
| Nombre | Descripción |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform)() | Inicializa una nueva instancia del[`VectorShapeTransform`](../vectorshapetransform) clase. |
