...
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer. Capa Posterize. Maneja el renderizado de Posterize usando datos de PostResource."
type: docs
weight: 1870
url: /es/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
{{< psd/tize >}}
## PosterizeLayer class

Capa de posterizado. Maneja el renderizado de posterizado usando datos de PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Niveles de la capa Posterize. |
