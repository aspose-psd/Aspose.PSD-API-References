---
title: "Clase CmykCorrection"
second_title: "Referencia de API de Aspose.PSD para .NET"
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection. Corrección de colores en la capa de ajuste de color selectivo"
type: docs
weight: 1750
url: /es/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
## CmykCorrection class

Corrección de colores en la capa de ajuste de color selectivo.
...
| Nombre | Descripción |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | El constructor predeterminado. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | Obtiene o establece la corrección de color negro. |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | Obtiene o establece la corrección de color cian. |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | Obtiene o establece la corrección de color magenta. |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | Obtiene o establece la corrección de color amarillo. |

## Ejemplos

El siguiente código demuestra el soporte de la capa de ajuste SelectiveColorLayer.
...
// Obtenga, verifique y cambie la capa de ajuste Selective Color de la imagen.
using (var image = (PsdImage)Image.Load(sourceFileWithSelectiveColorLayer))
{
    foreach (var layer in image.Layers)
    {
        ...
        {
            // Obtener la capa de ajuste Selective Color.
            ...
            // Cambiar los parámetros de las capas.
...
// Agregar y establecer la capa de ajuste Selective color en la imagen.
using (var image = (PsdImage)Image.Load(sourceFileWithoutSelectiveColorLayer))
{
    // Agregar capa de ajuste Selective Color.
