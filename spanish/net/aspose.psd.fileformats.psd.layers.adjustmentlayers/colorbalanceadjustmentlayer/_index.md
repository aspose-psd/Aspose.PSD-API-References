---
title: "Clase ColorBalanceAdjustmentLayer"
second_title: "Referencia de API de Aspose.PSD para .NET"
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ColorBalanceAdjustmentLayer. La clase de capa de ajuste de balance de color."
type: docs
weight: 1770
...
| [HighlightsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightscyanredbalance/) { get; set; } | Obtiene o establece el balance Cyan Rojo de Highlights. |
| [HighlightsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsmagentagreenbalance/) { get; set; } | Obtiene o establece el balance Magenta Verde de Highlights. |
| [HighlightsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsyellowbluebalance/) { get; set; } | Obtiene o establece el balance Amarillo Azul de Highlights. |
...
| [MidtonesCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonescyanredbalance/) { get; set; } | Obtiene o establece el balance Cyan Rojo de Midtones. |
| [MidtonesMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesmagentagreenbalance/) { get; set; } | Obtiene o establece el balance Magenta Verde de Midtones. |
| [MidtonesYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesyellowbluebalance/) { get; set; } | Obtiene o establece el balance Amarillo Azul de Midtones. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/preserveluminosity/) { get; set; } | Obtiene o establece un valor que indica si este [`BlncResource`](../../aspose.psd.fileformats.psd.layers.layerresources/blncresource/) preserva la luminosidad. |
...
| [ShadowsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowscyanredbalance/) { get; set; } | Obtiene o establece el balance Cyan Rojo de Shadows. |
| [ShadowsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsmagentagreenbalance/) { get; set; } | Obtiene o establece el balance Magenta Verde de Shadows. |
| [ShadowsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsyellowbluebalance/) { get; set; } | Obtiene o establece el balance YellowBlue de Shadows. |
