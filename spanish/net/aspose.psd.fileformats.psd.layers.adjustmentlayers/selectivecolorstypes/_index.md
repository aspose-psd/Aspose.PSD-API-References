---
title: "Enumeración SelectiveColorsTypes"
second_title: "Referencia de API de Aspose.PSD para .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorsTypes enum. Tipos de color en la capa de ajuste de color selectivo"
type: docs
weight: 1910
url: /es/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes/
---
{{< psd/tize >}}
## SelectiveColorsTypes enumeration

Tipos de color en la capa de ajuste de color selectivo.
...
| --- | --- | --- |
| Reds | `0` | Los colores rojos. |
| Yellows | `1` | Los colores amarillos. |
| Greens | `2` | Los colores verdes. |
| Cyans | `3` | Los colores cian. |
| Blues | `4` | Los colores azules. |
| Magentas | `5` | Los colores magenta. |
| Whites | `6` | Los colores blancos. |
| Neutrals | `7` | Los colores neutros. |
| Blacks | `8` | Los colores negros. |
