...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer clase. Capa de ajuste de PhotoFilter.
type: docs
weight: 1790
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Obtiene o establece la densidad de filter |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Obtiene o establece un valor que indica si [preservar la luminosidad]. |
