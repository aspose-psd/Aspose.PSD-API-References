...
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer. La clase de capa de mesa de trabajo."
type: docs
weight: 1990
url: /es/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Obtiene o establece el color de fondo del artboard. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Obtiene o establece la clave del modo de fusión. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | Obtiene o establece un valor que indica si `ArtboardLayer` tiene el color de fondo. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Obtiene o establece si la carpeta está abierta; si se establece en `true`, el grupo estará en estado abierto al iniciar, de lo contrario en estado minimizado. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Obtiene las capas del grupo de capas. |
...
| Nombre | Descripción |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Agrega la capa al grupo de capas. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Agrega el grupo de capas. |
