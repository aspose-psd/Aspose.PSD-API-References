...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer clase. La clase de capa de texto
type: docs
weight: 3560
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Obtiene o establece el cuadro de límite de texto. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Obtiene el color del texto. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Obtiene las porciones de texto. |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Obtiene o establece la posición de la capa superior. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Obtiene o establece la transformación matrix |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Cambia el tamaño de la imagen. El valor por defectoLeftTopToLeftTopse usa. |
