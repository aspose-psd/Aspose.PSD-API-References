---
title: "Clase TextLayer"
second_title: "Referencia de API de Aspose.PSD para .NET"
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.TextLayer. La clase de capa de texto"
type: docs
weight: 3980
url: /es/net/aspose.psd.fileformats.psd.layers/textlayer/
---
{{< psd/tize >}}
## TextLayer class

Clase de capa de texto
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | Obtiene la fuente. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Obtiene el texto de la capa |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | Obtiene el texto. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Obtiene o establece el cuadro delimitador del texto. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Obtiene el color del texto. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Obtiene las porciones del texto. |
| virtual [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Obtiene o establece la posición de la capa superior. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Obtiene o establece la matriz de transformación |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | Obtiene o establece los parámetros Warp que se establecieron o obtuvieron del recurso (por defecto). |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Obtiene el conjunto de fuentes de la capa de texto. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Redimensiona la imagen. Se utiliza el valor predeterminado LeftTopToLeftTop. |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | Actualiza el texto. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | Actualiza el texto. |
