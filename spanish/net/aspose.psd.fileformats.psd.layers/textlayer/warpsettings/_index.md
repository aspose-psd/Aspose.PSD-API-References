...
description: "Propiedad TextLayer. Obtiene o establece los parámetros Warp que se configuraron o obtuvieron del recurso predeterminado"
type: docs
weight: 80
url: /es/net/aspose.psd.fileformats.psd.layers/textlayer/warpsettings/
---
{{< psd/tize >}}
## TextLayer.WarpSettings property

Obtiene o establece los parámetros Warp que se establecieron o obtuvieron del recurso (por defecto).
