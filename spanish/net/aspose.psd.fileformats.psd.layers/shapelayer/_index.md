...
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer. Capa Shape. Encapsula la lógica de trabajo con la capa Shape y los recursos relacionados"
type: docs
weight: 3820
url: /es/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

Capa de forma. Encapsula la lógica de trabajo con la capa Shape y los recursos relacionados.
...
| Nombre | Descripción |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Inicializa una nueva instancia de la clase `ShapeLayer`. Todos los recursos se crean en su estado predeterminado. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Obtiene o establece la configuración de relleno para el área interna de las Shapes en la capa Shape. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Obtiene el conjunto de Paths que están presentes en una capa Shape. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Obtiene o establece la configuración de trazo de las Shapes. |
...
| Nombre | Descripción |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Crea una nueva instancia de la clase `ShapeLayer`. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Actualiza los recursos a partir de las propiedades de la capa Shape. |
