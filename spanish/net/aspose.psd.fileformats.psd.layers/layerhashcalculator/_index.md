...
description: Calculadora hash para capas PSD. Se puede usar para encontrar capas iguales o diferentes en diferentes archivos PSD
type: docs
weight: 2210
...
| Nombre | Descripción |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator)(Layer) | Inicializa una nueva instancia del[`LayerHashCalculator`](../layerhashcalculator) clase. |
