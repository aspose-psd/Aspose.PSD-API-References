...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer clase. La capa divisoria de sección para marcar los límites de la carpeta grupo de capas.
type: docs
weight: 3410
url: /es/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
## SectionDividerLayer class

La capa divisoria de sección para marcar los límites de la carpeta (grupo de capas).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Obtiene un valor que indica si esta instancia está visible en el grupo (si la capa no está en el grupo, significa grupo raíz). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Obtiene el[`LayerGroup`](../layergroup/) eso esta relacionado con esto`SectionDividerLayer` instancia. |
