...
description: SectionDividerLayer propiedad. Obtiene un valor que indica si esta instancia está visible en el grupo si la capa no está en el grupo significa grupo raíz.
type: docs
weight: 10
