...
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.Layer. La capa psd"
type: docs
weight: 2270
url: /es/net/aspose.psd.fileformats.psd.layers/layer/
---
{{< psd/tize >}}
## Layer class
...
| Nombre | Descripción |
| --- | --- |
| [Layer](layer/#constructor)() | Inicializa una nueva instancia de la clase `Layer`. Constructor para inicialización perezosa. |
| [Layer](layer/#constructor_3)(Stream) | Inicializa una nueva instancia de la clase `Layer`. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Inicializa una nueva instancia de la clase `Layer`. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Inicializa una nueva instancia de la clase `Layer` a partir de matrices de bytes. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Guarda los datos del objeto en el flujo especificado. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Guarda los datos del objeto en la ubicación de archivo especificada. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Guarda los datos del objeto en la ubicación de archivo especificada en el formato de archivo especificado según las opciones de guardado. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Guarda los datos de la imagen en el flujo especificado en el formato de archivo especificado según las opciones de guardado. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Guarda los datos del objeto en la ubicación de archivo especificada en el formato de archivo especificado según las opciones de guardado. |
...
| Nombre | Descripción |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Representa la firma del modo de fusión. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | El tamaño del encabezado de la capa. |
