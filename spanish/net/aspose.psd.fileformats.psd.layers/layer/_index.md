...
| Nombre | Descripción |
| --- | --- |
| [Layer](layer#constructor)() | Inicializa una nueva instancia del[`Layer`](../layer) clase. Constructor para inicialización diferida. |
| [Layer](layer#constructor_3)(Stream) | Inicializa una nueva instancia del[`Layer`](../layer) clase. |
| [Layer](layer#constructor_1)(RasterImage, bool) | Inicializa una nueva instancia del[`Layer`](../layer) clase. |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Inicializa una nueva instancia del[`Layer`](../layer) clase de matrices de bytes. |
