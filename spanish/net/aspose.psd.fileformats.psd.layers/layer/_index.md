...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer clase. La capa psd.
type: docs
weight: 2080
...
| Nombre | Descripción |
| --- | --- |
| [Layer](layer/#constructor)() | Inicializa una nueva instancia del`Layer` clase. Constructor para inicialización diferida. |
| [Layer](layer/#constructor_3)(Stream) | Inicializa una nueva instancia del`Layer` clase. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Inicializa una nueva instancia del`Layer` clase. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Inicializa una nueva instancia del`Layer` clase de matrices de bytes. |
...
| Nombre | Descripción |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Representa la firma del modo combinado. |
