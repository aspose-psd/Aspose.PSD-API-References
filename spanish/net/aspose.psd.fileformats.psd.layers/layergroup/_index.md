...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup clase. Clase de capa de grupo
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Obtiene o establece la clave del modo de combinación. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Obtiene o establece la carpeta abierta si se establece en`verdadero` que el grupo estará en estado abierto al inicio, de lo contrario en estado minimizado. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Obtiene las capas en el grupo de capas |
