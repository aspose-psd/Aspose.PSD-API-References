...
description: Obtiene o establece la carpeta abierta si se establece enverdadero que el grupo estará en estado abierto al inicio de lo contrario en estado minimizado.
type: docs
weight: 30
