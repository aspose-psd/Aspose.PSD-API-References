...
description: ITextStyle propiedad. Obtiene o establece un valor que indica si números hindi.
type: docs
weight: 150
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Obtiene o establece un valor que indica si [números hindi].
...
`verdadero` si [números hindi]; de lo contrario,`FALSO` .
