...
description: ITextStyle propiedad. Obtiene o establece un valor que indica si interlineado automático.
type: docs
weight: 20
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Obtiene o establece un valor que indica si [interlineado automático].
...
`verdadero` si [líder automático]; de lo contrario,`FALSO` .
