...
description: "ITextStyle propiedad. Obtiene o establece un valor que indica si el interlineado automático"
type: docs
weight: 20
...
`true` si [interlineado automático]; de lo contrario, `false`.
