...
description: ITextStyle método. Determina si el estilo especificado es igual.
type: docs
weight: 290
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
...
| --- | --- | --- |
| style | ITextStyle | El estilo. |

### Valor_devuelto

`verdadero` si el estilo especificado es igual; de lo contrario,`FALSO` .
