...
description: ITextParagraph propiedad. Obtiene o establece un valor que indica si esteITextParagraphes burasagiri.
type: docs
weight: 30
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Obtiene o establece un valor que indica si este[`ITextParagraph`](../)es burasagiri.
...
`verdadero` si burasagiri; de lo contrario,`FALSO` .
