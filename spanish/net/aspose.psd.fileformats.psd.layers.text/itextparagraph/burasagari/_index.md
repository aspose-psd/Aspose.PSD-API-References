...
description: Obtiene o establece un valor que indica si esteITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph es burasagiri.
type: docs
weight: 30
...
Obtiene o establece un valor que indica si este[`ITextParagraph`](../../itextparagraph) es burasagiri.
