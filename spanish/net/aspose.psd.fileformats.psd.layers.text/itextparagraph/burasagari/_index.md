...
description: "Propiedad ITextParagraph. Obtiene o establece un valor que indica si este ITextParagraph es burasagiri"
type: docs
weight: 30
...
`true` si es burasagiri; de lo contrario, `false`.
