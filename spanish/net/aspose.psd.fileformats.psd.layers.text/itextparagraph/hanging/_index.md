...
description: "Propiedad ITextParagraph. Obtiene o establece un valor que indica si este ITextParagraph está colgante"
type: docs
weight: 90
...
Obtiene o establece un valor que indica si este [`ITextParagraph`](../) está colgante.
...
`true` si está colgando; de lo contrario, `false`.
