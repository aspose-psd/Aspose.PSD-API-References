...
description: Obtiene o establece un valor que indica si esteITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph esta colgando.
type: docs
weight: 90
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Obtiene o establece un valor que indica si este[`ITextParagraph`](../../itextparagraph) esta colgando.
...
`verdadero` si está colgado; de lo contrario,`falso` .
...
* espacio de nombres [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph)
* asamblea [Aspose.PSD](../../../)
