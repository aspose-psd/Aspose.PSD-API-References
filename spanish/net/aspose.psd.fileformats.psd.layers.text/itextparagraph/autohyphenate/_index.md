...
description: ITextParagraph propiedad. Obtiene o establece un valor que indica si guión automático.
type: docs
weight: 10
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Obtiene o establece un valor que indica si [guión automático].
...
`verdadero` si [guión automático]; de lo contrario,`FALSO` .
