...
description: "Propiedad ITextParagraph. Obtiene o establece un valor que indica si la separación automática por guiones está habilitada"
type: docs
weight: 10
...
`true` si [automatic hyphenate]; de lo contrario, `false`.
