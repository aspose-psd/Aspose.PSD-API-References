...
description: ITextParagraph propiedad. Obtiene o establece un valor que indica si every line composer.
type: docs
weight: 60
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
...
`verdadero` si [compositor de cada línea]; de lo contrario,`FALSO` .
