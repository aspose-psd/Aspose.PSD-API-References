...
description: "Propiedad ITextParagraph. Obtiene o establece un valor que indica si el compositor de cada línea"
type: docs
weight: 60
...
`true` si [every line composer]; de lo contrario, `false`.
