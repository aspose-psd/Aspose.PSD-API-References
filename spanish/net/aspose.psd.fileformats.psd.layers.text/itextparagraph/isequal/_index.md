...
description: ITextParagraph método. Determina si el párrafo especificado es igual.
type: docs
weight: 230
url: /es/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/isequal/
---
...
| --- | --- | --- |
| paragraph | ITextParagraph | El párrafo. |

### Valor_devuelto

`verdadero` si el párrafo especificado es igual; de lo contrario,`FALSO` .
