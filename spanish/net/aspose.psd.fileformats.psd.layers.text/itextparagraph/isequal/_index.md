...
description: "Método ITextParagraph. Determina si el párrafo especificado es igual"
type: docs
weight: 230
...
| --- | --- | --- |
| párrafo | ITextParagraph | El párrafo. |

### Valor devuelto

`true` si el párrafo especificado es igual; de lo contrario, `false`.
