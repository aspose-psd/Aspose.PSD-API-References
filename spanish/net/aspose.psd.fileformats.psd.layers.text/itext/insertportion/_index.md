...
description: "Método IText. Inserta el ITextPortion en la posición especificada"
type: docs
weight: 50
...
Inserta el [`ITextPortion`](../../itextportion/) en la posición especificada
...
| --- | --- | --- |
| porción | ITextPortion | La porción. |
