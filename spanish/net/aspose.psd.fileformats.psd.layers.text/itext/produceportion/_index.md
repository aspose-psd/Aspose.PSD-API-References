...
description: Produce la nueva porción con los parámetros predeterminados
type: docs
weight: 50
url: /es/net/aspose.psd.fileformats.psd.layers.text/itext/produceportion/
---
## IText.ProducePortion method

Produce la nueva porción con los parámetros predeterminados
...
Referencia a recién creado[`ITextPortion`](../../itextportion).
