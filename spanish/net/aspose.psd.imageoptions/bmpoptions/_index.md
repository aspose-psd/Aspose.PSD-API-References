...
description: "Clase Aspose.PSD.ImageOptions.BmpOptions. Opciones de creación del formato de archivo bmp"
type: docs
weight: 5280
...
| Nombre | Descripción |
| --- | --- |
| [BmpOptions](bmpoptions/#constructor)() | Inicializa una nueva instancia de la clase `BmpOptions`. |
| [BmpOptions](bmpoptions/#constructor_1)(BmpOptions) | Inicializa una nueva instancia de la clase `BmpOptions`. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [BitsPerPixel](../../aspose.psd.imageoptions/bmpoptions/bitsperpixel/) { get; set; } | Obtiene o establece la cantidad de bits por píxel de la imagen. |
