...
description: IGradientFillSettings propiedad. Obtiene o establece un valor que indica si esteIGradientFillSettings es tramado.
type: docs
weight: 50
...
Obtiene o establece un valor que indica si este[`IGradientFillSettings`](../) es tramado.
