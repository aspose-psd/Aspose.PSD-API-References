...
description: Obtiene o establece un valor que indica si esteIGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings es tramado.
type: docs
weight: 50
...
Obtiene o establece un valor que indica si este[`IGradientFillSettings`](../../igradientfillsettings) es tramado.
