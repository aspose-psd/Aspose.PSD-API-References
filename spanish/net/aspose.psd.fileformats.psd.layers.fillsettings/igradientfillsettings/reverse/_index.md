...
description: "Propiedad IGradientFillSettings. Obtiene o establece un valor que indica si este IGradientFillSettings está invertido"
type: docs
weight: 80
url: /es/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
{{< psd/tize >}}
## IGradientFillSettings.Reverse property

Obtiene o establece un valor que indica si este [`IGradientFillSettings`](../) está invertido.
...
`true` si está invertido; de lo contrario, `false`.
