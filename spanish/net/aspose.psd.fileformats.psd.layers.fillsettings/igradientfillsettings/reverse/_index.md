...
description: Obtiene o establece un valor que indica si esteIGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings es inversa.
type: docs
weight: 90
...
Obtiene o establece un valor que indica si este[`IGradientFillSettings`](../../igradientfillsettings) es inversa.
