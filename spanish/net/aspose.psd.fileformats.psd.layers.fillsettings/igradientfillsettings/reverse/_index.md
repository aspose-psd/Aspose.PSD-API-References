...
description: IGradientFillSettings propiedad. Obtiene o establece un valor que indica si esteIGradientFillSettings es inversa.
type: docs
weight: 90
...
Obtiene o establece un valor que indica si este[`IGradientFillSettings`](../) es inversa.
