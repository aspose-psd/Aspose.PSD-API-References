---
title: "Clase GradientMapSettings"
second_title: "Referencia de API de Aspose.PSD para .NET"
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientMapSettings. Clase de configuración de degradado para la capa de mapa de degradado. Contiene propiedades comunes para ambos tipos de degradado Solid y Noise."
type: docs
weight: 2080
url: /es/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/
---
{{< psd/tize >}}
## GradientMapSettings class

Clase de configuración de degradado para la capa de mapa de degradado. Contiene propiedades comunes para ambos tipos de degradado (Solid y Noise).
...
| Nombre | Descripción |
| --- | --- |
| [GradientMapSettings](gradientmapsettings/)() | El constructor predeterminado. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/dither/) { get; set; } | Obtiene o establece un valor que indica si este [`GradientFillSettings`](../gradientfillsettings/) está con dithering. |
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/) { get; set; } | Obtiene o establece una instancia de definición de degradado específica (Solid/Noise). |
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/interpolationmethod/) { get; set; } | Obtiene o establece el método de interpolación para el degradado. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/reverse/) { get; set; } | Obtiene o establece un valor que indica si este [`GradientFillSettings`](../gradientfillsettings/) está invertido. |
