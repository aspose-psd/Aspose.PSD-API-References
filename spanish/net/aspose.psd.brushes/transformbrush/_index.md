...
description: Aspose.PSD.Brushes.TransformBrush clase. ABrush con capacidades de transformación.
type: docs
weight: 220
...
| [Transform](../../aspose.psd.brushes/transformbrush/transform/) { get; set; } | Obtiene o establece una copia[`Matrix`](../../aspose.psd/matrix/) que define una transformación geométrica local para este`TransformBrush` . |
| [WrapMode](../../aspose.psd.brushes/transformbrush/wrapmode/) { get; set; } | Obtiene o establece un[`WrapMode`](../../aspose.psd/wrapmode/) enumeración que indica el modo de ajuste para este`TransformBrush` . |
