...
description: Aspose.PSD.Brushes.PathGradientBrush clase. Encapsula unBrush objeto con un degradado. Esta clase no se puede heredar.
type: docs
weight: 170
...
| Nombre | Descripción |
| --- | --- |
| [PathGradientBrush](pathgradientbrush/#constructor)(GraphicsPath) | Inicializa una nueva instancia del`PathGradientBrush` clase con la ruta especificada. |
| [PathGradientBrush](pathgradientbrush/#constructor_1)(PointF[]) | Inicializa una nueva instancia del`PathGradientBrush` clase con los puntos especificados. |
| [PathGradientBrush](pathgradientbrush/#constructor_3)(Point[]) | Inicializa una nueva instancia del`PathGradientBrush` clase con los puntos especificados. |
| [PathGradientBrush](pathgradientbrush/#constructor_2)(PointF[], WrapMode) | Inicializa una nueva instancia del`PathGradientBrush` clase con los puntos especificados y modo de ajuste. |
| [PathGradientBrush](pathgradientbrush/#constructor_4)(Point[], WrapMode) | Inicializa una nueva instancia del`PathGradientBrush` clase con los puntos especificados y modo de ajuste. |
...
| [SurroundColors](../../aspose.psd.brushes/pathgradientbrush/surroundcolors/) { get; set; } | Obtiene o establece una matriz de colores que corresponden a los puntos de la ruta que`PathGradientBrush` llena. |
