...
description: Representa unBrush../aspose.psd/brush con capacidades de degradado y propiedades apropiadas.
type: docs
weight: 150
...
| [IsAngleScalable](../../aspose.psd.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | Obtiene o establece un valor que indica si[`Angle`](./angle) se cambia durante las transformaciones con este[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
