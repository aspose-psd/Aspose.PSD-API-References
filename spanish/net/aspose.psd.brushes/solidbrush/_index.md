...
description: Aspose.PSD.Brushes.SolidBrush clase. El pincel sólido está diseñado para dibujar continuamente con un color específico. Esta clase no se puede heredar.
type: docs
weight: 200
...
| Nombre | Descripción |
| --- | --- |
| [SolidBrush](solidbrush/#constructor)() | Inicializa una nueva instancia del`SolidBrush` clase. |
| [SolidBrush](solidbrush/#constructor_1)(Color) | Inicializa una nueva instancia del`SolidBrush` clase. |
