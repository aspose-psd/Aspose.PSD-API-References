...
description: "Método TimeLine. Crea una nueva instancia de TimeLine inicializada a partir de la PsdImage de entrada"
type: docs
weight: 20
...
Crea una nueva instancia de [`TimeLine`](../), inicializada a partir de la [`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
...
La nueva instancia de [`TimeLine`](../), inicializada a partir de la [`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
