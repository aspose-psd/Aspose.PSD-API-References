...
description: Inicializa una nueva instancia delPsdImageaspose.psd.fileformats.psd/psdimage clase de la ruta especificada de la imagen ráster no la imagen psd en la ruta. Se utiliza para inicializar la imagen psd con los parámetros predeterminados  Modo de color  rgb 4 canales 8 bits por canal Compresión  Raw.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase de la ruta especificada de la imagen ráster (no la imagen psd en la ruta). Se utiliza para inicializar la imagen psd con los parámetros predeterminados - Modo de color - rgb, 4 canales, 8 bits por canal, Compresión - Raw.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase de la ruta especificada de la imagen ráster (no la imagen psd en la ruta) con parámetros de constructor.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase de la ruta especificada de la imagen ráster (no la imagen psd en la transmisión). Se utiliza para inicializar la imagen psd con los parámetros predeterminados - Modo de color - rgb, 4 canales, 8 bits por canal, Compresión - Raw.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase de la ruta especificada de la imagen ráster (no la imagen psd en la transmisión) con parámetros de constructor.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage)clase de imagen ráster existente (no imagen psd) con modo de color RGB con 4 canales de 8 bits/canal y sin compresión.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase de imagen ráster existente (no imagen psd) con parámetros de constructor.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase con ancho y alto especificados. Se utiliza para inicializar la imagen psd vacía.
...
Inicializa una nueva instancia del[`PsdImage`](../../psdimage) clase con ancho, alto, paleta, modo de color, número de canales y longitud de bits de canales especificados y parámetros de modo de compresión especificados. Se utiliza para inicializar la imagen psd vacía.
