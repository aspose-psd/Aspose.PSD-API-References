...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider clase. Define el proveedor de objetos inteligentes que proporciona fuentes de datos de obtención/configuración de recursos de enlace global del archivo PSD y su contenido.
type: docs
weight: 4000
url: /es/net/aspose.psd.fileformats.psd/smartobjectprovider/
---
## SmartObjectProvider class

Define el proveedor de objetos inteligentes que proporciona fuentes de datos de obtención/configuración de recursos de enlace global del archivo PSD y su contenido.
...
| Nombre | Descripción |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Convierte capas en un objeto inteligente incrustado. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Convierte capas en un objeto inteligente incrustado. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Incrusta todos los objetos inteligentes vinculados en la imagen. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Crea una nueva capa de objeto inteligente copiando la fuente. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Actualiza el contenido de todos los objetos inteligentes modificados en la imagen. |
