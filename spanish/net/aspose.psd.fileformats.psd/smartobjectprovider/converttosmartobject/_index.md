...
description: Convierte capas en un objeto inteligente incrustado.
type: docs
weight: 10
...
| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | No hay capas para convertir. |
