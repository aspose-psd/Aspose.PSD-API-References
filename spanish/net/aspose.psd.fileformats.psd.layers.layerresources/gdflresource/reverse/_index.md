...
description: GdFlResource propiedad. Obtiene o establece un valor que indica si esteGdFlResource es inversa.
type: docs
weight: 140
...
Obtiene o establece un valor que indica si este[`GdFlResource`](../) es inversa.
