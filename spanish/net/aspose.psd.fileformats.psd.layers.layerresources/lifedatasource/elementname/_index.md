...
description: LiFeDataSource propiedad. Obtiene o establece el nombre del elemento de la biblioteca de gráficos para las bibliotecas de Adobe Photoshop CC.
type: docs
weight: 50
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

Obtiene o establece el nombre del elemento de la biblioteca de gráficos, para las bibliotecas de Adobe® Photoshop® CC.
...
El nombre del elemento de la biblioteca de gráficos.

### Excepciones

| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad ElementName, solo está disponible para la fuente de datos liFE cuando IsLibrary es true |
