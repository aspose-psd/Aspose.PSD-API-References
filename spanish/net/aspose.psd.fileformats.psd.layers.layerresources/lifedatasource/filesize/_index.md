...
description: LiFeDataSource propiedad. Obtiene o establece el tamaño del archivo externo en la fuente de datos LiFE del recurso PSD LnkE.
type: docs
weight: 80
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
...
| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad FileSize, solo está disponible para la fuente de datos liFE |
