...
description: "Propiedad LiFeDataSource. Obtiene o establece la fecha y hora de la última escritura del archivo externo en la fuente de datos LiFE del recurso PSD LnkE"
type: docs
weight: 40
...
La fecha y hora de la última escritura del archivo externo.

### Excepciones

| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad Date, solo está disponible para la fuente de datos liFE con versión 3 o superior |
