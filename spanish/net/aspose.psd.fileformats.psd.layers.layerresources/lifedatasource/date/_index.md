...
description: LiFeDataSource propiedad. Obtiene o establece la última fecha y hora de escritura del archivo externo en la fuente de datos LiFE del recurso PSD LnkE.
type: docs
weight: 40
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
## LiFeDataSource.Date property

Obtiene o establece la última fecha y hora de escritura del archivo externo en la fuente de datos LiFE del recurso PSD LnkE.
...
La última fecha y hora de escritura del archivo externo.

### Excepciones

| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad Fecha, solo está disponible para la fuente de datos liFE con la versión 3 o superior |
