...
description: "Propiedad LiFeDataSource. Obtiene o establece el AdobeStockId de la biblioteca gráfica para Adobe Photoshop CC Libraries"
type: docs
weight: 20
...
Obtiene o establece la biblioteca gráfica AdobeStockId, para las Bibliotecas Adobe® Photoshop® CC.
...
El identificador Adobe Stock de la biblioteca gráfica.

### Excepciones

| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad AdobeStockId, solo está disponible para la fuente de datos liFE cuando IsLibrary es verdadero |
