...
description: LiFeDataSource propiedad. Obtiene o establece la biblioteca de gráficos AdobeStockId para las bibliotecas de Adobe Photoshop CC.
type: docs
weight: 20
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

Obtiene o establece la biblioteca de gráficos AdobeStockId, para las bibliotecas de Adobe® Photoshop® CC.
...
La biblioteca de gráficos Adobe Stock Identifier.

### Excepciones

| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad AdobeStockId, solo está disponible para la fuente de datos liFE cuando IsLibrary es true |
