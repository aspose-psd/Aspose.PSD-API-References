...
description: LiFeDataSource propiedad. Obtiene o establece la ruta completa del archivo externo en la fuente de datos LiFE del recurso PSD LnkE.
type: docs
weight: 90
...
| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad FullPath, solo está disponible para fuente de datos liFE |
