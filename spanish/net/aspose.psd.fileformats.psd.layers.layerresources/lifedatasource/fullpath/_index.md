...
description: "Propiedad LiFeDataSource. Obtiene o establece la ruta completa del archivo externo en la fuente de datos LiFE del recurso PSD LnkE"
type: docs
weight: 90
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
{{< psd/tize >}}
...
| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | No puede acceder a la propiedad FullPath, solo está disponible para la fuente de datos liFE |
