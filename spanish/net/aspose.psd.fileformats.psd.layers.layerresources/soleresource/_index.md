---
title: "Clase SoLeResource"
second_title: "Referencia de API de Aspose.PSD para .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource class. Define la clase SoLeResource que contiene información sobre una capa de objeto inteligente en un archivo PSD. Se utiliza para admitir capas de objetos inteligentes con enlaces a archivos externos en las imágenes de Adobe Photoshop."
type: docs
weight: 3380
...
Define la clase SoLeResource que contiene información sobre una capa de objeto inteligente en un archivo PSD. Se usa para soportar capas de objetos inteligentes con enlaces a archivos externos en las imágenes de Adobe� Photoshop�.
...
| Nombre | Descripción |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Inicializa una nueva instancia de la clase `SoLeResource`. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Inicializa una nueva instancia de la clase `SoLeResource`. |
...
| Nombre | Descripción |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | La clave de información de la herramienta de tipo: 'SoLE'. |
