...
description: Class VsmsResource. Este recurso contiene información sobre la máscara de capa vectorial
type: docs
weight: 3320
...
| Nombre | Descripción |
| --- | --- |
| [VsmsResource](vsmsresource#constructor)() | Inicializa una nueva instancia del[`VsmsResource`](../vsmsresource) clase. |
| [VsmsResource](vsmsresource#constructor_1)(byte[]) | Inicializa una nueva instancia del[`VsmsResource`](../vsmsresource) clase. |
