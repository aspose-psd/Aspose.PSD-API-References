...
description: Inicializa una nueva instancia delVsmsResourceaspose.psd.fileformats.psd.layers.layerresources/vsmsresource clase.
type: docs
weight: 10
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/vsmsresource/
---
## VsmsResource(byte[]) {#constructor_1}

Inicializa una nueva instancia del[`VsmsResource`](../../vsmsresource) clase.
...
| excepción | condición |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception) | Valor de recurso de Vsms no válido |
