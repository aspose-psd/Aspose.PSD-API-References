...
description: "Constructor VsmsResource. Inicializa una nueva instancia de la clase VsmsResource"
type: docs
weight: 10
...
Inicializa una nueva instancia de la clase [`VsmsResource`](../).
...
| excepción | condición |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Valor de recurso Vsms no válido |
