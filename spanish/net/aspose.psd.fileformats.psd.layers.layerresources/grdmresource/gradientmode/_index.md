...
description: "Propiedad GrdmResource. Modo para este degradado Determina el tipo de degradado  Sólido/Ruido 0/1"
type: docs
weight: 60
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/grdmresource/gradientmode/
---
{{< psd/tize >}}
## GrdmResource.GradientMode property

Modo para este degradado determina 'Gradient Type' = 'Solid/Noise' (0/1).
