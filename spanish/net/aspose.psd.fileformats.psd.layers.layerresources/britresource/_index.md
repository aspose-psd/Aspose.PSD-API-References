...
description: Clase BritResource. Recurso de ajuste de brillo/contraste Layer
type: docs
weight: 2320
...
| Nombre | Descripción |
| --- | --- |
| [BritResource](britresource#constructor)() | Inicializa una nueva instancia del[`BritResource`](../britresource) clase. |
| [BritResource](britresource#constructor_1)(byte[]) | Inicializa una nueva instancia del[`BritResource`](../britresource)class. La especificación de formato PSD contiene la siguiente descripción: 2 Brillo 2 Contraste 2 Valor medio de brillo y contraste 1 Lab color only No se usa en PSD moderno (CS5 y superior) donde está CgEd. CgEd almacena información properties |
| [BritResource](britresource#constructor_2)(short, short, short, bool) | Inicializa una nueva instancia del[`BritResource`](../britresource) clase. |
