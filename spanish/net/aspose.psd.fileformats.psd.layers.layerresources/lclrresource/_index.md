...
description: Class LclrResource. Este recurso contiene información sobre el color de la capa en la lista de capas es PS. Es solo
type: docs
weight: 2600
...
| Nombre | Descripción |
| --- | --- |
| [LclrResource](lclrresource#constructor)() | Inicializa una nueva instancia del[`LclrResource`](../lclrresource) clase. |
| [LclrResource](lclrresource#constructor_2)(byte[]) | Inicializa una nueva instancia del[`LclrResource`](../lclrresource) clase. |
| [LclrResource](lclrresource#constructor_1)(SheetColorHighlightEnum) | Inicializa una nueva instancia del[`LclrResource`](../lclrresource) clase. |
