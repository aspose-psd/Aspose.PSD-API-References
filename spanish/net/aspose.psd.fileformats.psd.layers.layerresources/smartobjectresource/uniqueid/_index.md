...
description: Obtiene o establece el identificador único global de los datos de la capa de objeto inteligenteSmartObjectResourceaspose.psd.fileformats.psd.layers.layerresources/smartobjectresource en la imagen PSD.
type: docs
weight: 240
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

Obtiene o establece el identificador único global de los datos de la capa de objeto inteligente[`SmartObjectResource`](../../smartobjectresource) en la imagen PSD.
...
El identificador único global de los datos de la capa de objeto inteligente[`SmartObjectResource`](../../smartobjectresource) .
