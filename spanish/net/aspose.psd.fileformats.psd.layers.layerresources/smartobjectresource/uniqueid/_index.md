...
description: "Propiedad SmartObjectResource. Obtiene o establece el identificador único global de los datos de la capa de objeto inteligente SmartObjectResource en la imagen PSD"
type: docs
weight: 220
...
Obtiene o establece el identificador único global de los datos de la capa de objeto inteligente [`SmartObjectResource`](../) en la imagen PSD.
...
El identificador único global de los datos de la capa de objeto inteligente [`SmartObjectResource`](../).
