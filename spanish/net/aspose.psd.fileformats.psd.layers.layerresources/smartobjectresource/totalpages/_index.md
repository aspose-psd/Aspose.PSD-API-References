...
description: SmartObjectResource propiedad. Obtiene o establece el número total de páginas de los datos de la capa de objeto inteligente en el archivo PSD.
type: docs
weight: 220
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/totalpages/
---
## SmartObjectResource.TotalPages property

Obtiene o establece el número total de páginas de los datos de la capa de objeto inteligente en el archivo PSD.
...
El número total de páginas de los datos de la capa de objeto inteligente.
