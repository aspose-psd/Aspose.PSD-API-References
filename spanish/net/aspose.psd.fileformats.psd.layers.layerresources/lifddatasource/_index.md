...
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LiFdDataSource. Define la clase de origen de datos liFD en el archivo PSD que contiene información sobre un archivo incrustado. Forma parte de la API de Manipulación del Formato de Archivo PSD que ayuda a modificar archivos de Adobe Photoshop."
type: docs
weight: 2970
...
Define la clase de origen de datos liFD en PSD File que contiene información sobre un archivo incrustado. Esto es parte de la API de manipulación del formato de archivo PSD que ayuda a modificar archivos Adobe® Photoshop®.
...
| Nombre | Descripción |
| --- | --- |
| [LiFdDataSource](lifddatasource/#constructor)() | Inicializa una nueva instancia de la clase `LiFdDataSource`. |
| [LiFdDataSource](lifddatasource/#constructor_1)(int, Guid, string, string, string) | Inicializa una nueva instancia de la clase `LiFdDataSource`. |
