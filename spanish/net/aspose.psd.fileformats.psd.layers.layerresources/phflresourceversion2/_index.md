...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PhflResourceVersion2 clase. Clase PhflResource. Recurso de capa de ajuste de exposición 2 Versión   3  o   2  12 4 bytes cada uno para el color XYZ solo en la versión 3 10 2 bytes de espacio de color seguido de 4  2 bytes de componente de color solo en la versión 2 4 Densidad 1 Conservar Luminosidad
type: docs
weight: 2900
...
| Nombre | Descripción |
| --- | --- |
| [PhflResourceVersion2](phflresourceversion2/#constructor)() | Inicializa una nueva instancia del`PhflResourceVersion2` clase. |
| [PhflResourceVersion2](phflresourceversion2/#constructor_1)(byte[]) | Inicializa una nueva instancia del`PhflResourceVersion2` clase. |
