...
description: recurso Lfx2 recurso de efectos
type: docs
weight: 2630
...
| Nombre | Descripción |
| --- | --- |
| [BlendMode](../../aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/blendmode) { get; } | Obtiene el modo de mezcla. |
| [Data](../../aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/data) { get; set; } | Obtiene o establece los datos. |
...
| [EffectColor](../../aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/effectcolor) { get; } | Obtiene el color del efecto. |
...
| [Opacity](../../aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/opacity) { get; } | Obtiene la opacidad. |
...
| Nombre | Descripción |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/typetoolkey) | La clave de información de la herramienta de tipo. |
