...
description: Define la clase PlLdResource que contiene información sobre una capa colocada en el archivo PSD. Se utiliza para admitir capas de objetos inteligentes en las imágenes de Adobe Photoshop. Fue reemplazada por SoLdResource en Adobe Photoshop CS3
type: docs
weight: 2900
url: /es/net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/
---
## PlLdResource class
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/key) { get; } | Obtiene la clave de recurso PlLd. |
...
| override [Length](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/length) { get; } | Obtiene la longitud del recurso PlLd en bytes. |
...
| override [PsdVersion](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/psdversion) { get; } | Obtiene la versión psd mínima necesaria para el recurso PlLd. 0 indica que no hay restricciones. |
...
| override [Signature](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/signature) { get; } | Obtiene la firma del recurso PlLd. |
...
| Nombre | Descripción |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/save)(StreamContainer, int) | Guarda el recurso PlLD en el contenedor de flujo especificado. |
...
| Nombre | Descripción |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/plldresource/typetoolkey) | La clave de información de la herramienta de tipo. |
