...
description: "Clase Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlLdResource. Define la clase PlLdResource que contiene información sobre una capa colocada en el archivo PSD. Se utiliza para admitir capas de objetos inteligentes en las imágenes de Adobe Photoshop. Fue reemplazada por SoLdResource en Adobe Photoshop CS3"
type: docs
weight: 3270
...
Define la clase PlLdResource que contiene información sobre una capa colocada en el archivo PSD. Se utiliza para admitir capas de objetos inteligentes en las imágenes Adobe® Photoshop®. Fue reemplazada por SoLdResource en Adobe® Photoshop® CS3.
