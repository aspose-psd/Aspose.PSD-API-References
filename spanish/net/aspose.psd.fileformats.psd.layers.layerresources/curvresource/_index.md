...
| Nombre | Descripción |
| --- | --- |
| [CurvResource](curvresource/#constructor)(byte[]) | Inicializa una nueva instancia del`CurvResource` clase. |
| [CurvResource](curvresource/#constructor_1)(int) | Inicializa una nueva instancia del`CurvResource` clase. |
