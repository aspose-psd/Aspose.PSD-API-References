...
description: Clase NvrtResource. Recurso de Invertir Capa de Ajuste.
type: docs
weight: 2820
...
| Nombre | Descripción |
| --- | --- |
| [NvrtResource](nvrtresource#constructor)() | Inicializa una nueva instancia del[`NvrtResource`](../nvrtresource) clase. |
| [NvrtResource](nvrtresource#constructor_1)(byte[]) | Inicializa una nueva instancia del[`NvrtResource`](../nvrtresource) clase. |
