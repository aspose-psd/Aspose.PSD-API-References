...
description: Class VmskResource. Este recurso contiene información sobre la máscara de capa vectorial
type: docs
weight: 3300
...
| Nombre | Descripción |
| --- | --- |
| [VmskResource](vmskresource#constructor)() | Inicializa una nueva instancia del[`VmskResource`](../vmskresource) clase. |
| [VmskResource](vmskresource#constructor_1)(byte[]) | Inicializa una nueva instancia del[`VmskResource`](../vmskresource) clase. |
