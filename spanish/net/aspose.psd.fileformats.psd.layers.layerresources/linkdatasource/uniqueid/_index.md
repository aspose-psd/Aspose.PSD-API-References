...
description: Obtiene el identificador único global de la fuente de datos en el recurso de enlace PSD.
type: docs
weight: 130
...
| excepción | condición |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | No puede acceder a la propiedad UniqueId. |
