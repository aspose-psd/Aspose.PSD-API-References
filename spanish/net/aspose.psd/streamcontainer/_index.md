...
| virtual [WriteTo](../../aspose.psd/streamcontainer/writeto#writeto)(StreamContainer) | Copia los datos contenidos a otro[`StreamContainer`](../streamcontainer) . |
| virtual [WriteTo](../../aspose.psd/streamcontainer/writeto#writeto_1)(StreamContainer, long) | Copia los datos contenidos a otro[`StreamContainer`](../streamcontainer) . |
| [explicit operator](../../aspose.psd/streamcontainer/op_explicit) | Realiza una conversión explícita de[`StreamContainer`](../streamcontainer) aStream . |
