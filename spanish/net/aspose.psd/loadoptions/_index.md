...
type: docs
weight: 5010
url: /es/net/aspose.psd/loadoptions/
---
## LoadOptions class
...
| [DataBackgroundColor](../../aspose.psd/loadoptions/databackgroundcolor) { get; set; } | Obtiene o establece el[`Image`](../image) antecedentes[`Color`](../color) . |
