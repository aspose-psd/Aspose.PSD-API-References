...
description: Aspose.PSD.SplitStreamContainer clase. Representa el contenedor de flujo dividido que contiene el flujo y proporciona rutinas de procesamiento de flujo.
type: docs
weight: 5630
...
| Nombre | Descripción |
| --- | --- |
| [SplitStreamContainer](splitstreamcontainer/#constructor_1)(Stream) | Inicializa una nueva instancia del`SplitStreamContainer` clase. |
| [SplitStreamContainer](splitstreamcontainer/#constructor_2)(Stream, bool) | Inicializa una nueva instancia del`SplitStreamContainer` clase. |
| [SplitStreamContainer](splitstreamcontainer/#constructor)(StreamContainer, bool) | Inicializa una nueva instancia del`SplitStreamContainer` clase. |
