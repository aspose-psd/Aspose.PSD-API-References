...
description: FillLayer método. Reemplaza todos los colores no transparentes con un nuevo color y conserva el valor alfa original para guardar bordes suaves. Nota si lo usa en imágenes sin transparencia todos los colores se reemplazarán con uno solo.
type: docs
weight: 40
