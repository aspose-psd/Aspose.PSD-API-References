...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer clase. Capa de relleno. Relleno de color Relleno de degradado o Capa de relleno de patrón que se diferencia porFillSettings
type: docs
weight: 1910
url: /es/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

Capa de relleno. Relleno de color, Relleno de degradado o Capa de relleno de patrón que se diferencia por[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Obtiene la configuración de relleno. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Obtiene el tipo de relleno. |
...
| Nombre | Descripción |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Cree una nueva instancia del`FillLayer` clase por tipo de relleno. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Reemplaza todos los colores no transparentes con un nuevo color y conserva el valor alfa original para guardar bordes suaves. Nota: si lo usa en imágenes sin transparencia, todos los colores se reemplazarán con uno solo. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Actualiza los datos de píxeles de la capa de relleno de acuerdo con[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* espacio de nombres [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* asamblea [Aspose.PSD](../../)
