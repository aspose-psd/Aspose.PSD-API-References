...
description: Capa de relleno. Relleno de color Relleno de degradado o Capa de relleno de patrón que se diferencia porFillSettings./filllayer/fillsettings
type: docs
weight: 1890
...
| Nombre | Descripción |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | Cree una nueva instancia del[`FillLayer`](../filllayer) clase por tipo de relleno. |
