...
description: Aspose.PSD.FileFormats.Psd.Resources.LayerSelectionIdsResource clase. ID de selección de capa resource
type: docs
weight: 3800
url: /es/net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
## LayerSelectionIdsResource class

ID de selección de capa resource
...
| Nombre | Descripción |
| --- | --- |
| [LayerSelectionIdsResource](layerselectionidsresource/)() | Constructor predeterminado |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Count](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/count/) { get; set; } | Obtiene o establece el conteo. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/datasize/) { get; } | Obtiene el tamaño de los datos del recurso en bytes. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Obtiene o establece el identificador único del recurso. |
| [LayerIds](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/layerids/) { get; set; } | Obtiene o establece los ids de capa. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/minimalversion/) { get; } | Obtiene la versión PSD mínima requerida. |
