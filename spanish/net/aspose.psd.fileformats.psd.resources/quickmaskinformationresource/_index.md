...
description: Información de máscara rápida recurso
type: docs
weight: 3790
...
Información de máscara rápida recurso
...
| Nombre | Descripción |
| --- | --- |
| [QuickMaskInformationResource](quickmaskinformationresource)() | Constructor predeterminado |
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/quickmaskinformationresource/minimalversion) { get; } | Obtiene la versión PSD mínima requerida. |
