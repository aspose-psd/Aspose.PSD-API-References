...
description: Obtiene o establece un valor que indica si esteStrokeEffectaspose.psd.fileformats.psd.layers.layereffects/strokeeffect combinará el trazo con el contenido de la capa actual.
type: docs
weight: 60
...
Obtiene o establece un valor que indica si este[`StrokeEffect`](../../strokeeffect) combinará el trazo con el contenido de la capa actual.
