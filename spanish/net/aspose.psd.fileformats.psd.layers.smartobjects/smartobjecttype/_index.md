...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType enumeración. Define la enumeración SmartObjectType para el tipo de contenido de objeto inteligente
type: docs
weight: 3500
url: /es/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
## SmartObjectType enumeration

Define la enumeración SmartObjectType para el tipo de contenido de objeto inteligente
...
| --- | --- | --- |
| Embedded | `0` | El contenido incrustado |
| AvailableLinked | `1` | El archivo vinculado que está disponible |
| UnavailableLinked | `2` | El archivo vinculado que no está disponible |
| LibraryLink | `3` | La biblioteca de Adobe® Photoshop® ÑÑ link |
