...
description: SmartObjectLayer método. Vuelve a vincular el objeto inteligente vinculado a un nuevo archivo. No es necesario llamar al método UpdateModifiedContent después.
type: docs
weight: 130
url: /es/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/
---
## SmartObjectLayer.RelinkToFile method

Vuelve a vincular el objeto inteligente vinculado a un nuevo archivo. No es necesario llamar al método UpdateModifiedContent después.
