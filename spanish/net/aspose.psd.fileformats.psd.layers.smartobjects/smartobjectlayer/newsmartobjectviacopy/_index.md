...
description: Crea una nueva capa de objeto inteligente copiando esta. Reproduce la funcionalidad Capa gt Objetos inteligentes gt Nuevo objeto inteligente a través de la copia de Adobe Photoshop. Tenga en cuenta que está habilitado solo para objetos inteligentes incrustados porque la imagen incrustada también se copia. Si desea compartir la imagen incrustada useDuplicateLayeraspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/duplicatelayer método.
type: docs
weight: 120
...
el clonado[`SmartObjectLayer`](../../smartobjectlayer) instancia.
