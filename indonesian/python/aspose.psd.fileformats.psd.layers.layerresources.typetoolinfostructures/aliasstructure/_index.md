...
type: docs
weight: 10
url: /id/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Menginisialisasi instance baru dari kelas [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Deskripsi** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Mengidentifikasi kunci struktur. |
| data_length | int | r | Mendapatkan panjang data yang tepat dalam byte. |
| full_path | string | r/w | Mendapatkan atau mengatur jalur lengkap. |
...
Menginisialisasi instance baru dari kelas [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/).
