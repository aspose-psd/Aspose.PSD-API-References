---
title: "Kelas ListStructure"
type: docs
weight: 90
url: /id/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [ListStructure(key_name)](#ListStructure_key_name_1) | Menginisialisasi sebuah instance baru dari kelas [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Deskripsi** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Mengidentifikasi kunci struktur. |
| items_count | int | r | Mendapatkan jumlah item. |
...
| types | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | Mendapatkan atau mengatur salinan array struktur. |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
...
Menginisialisasi sebuah instance baru dari kelas [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/).
