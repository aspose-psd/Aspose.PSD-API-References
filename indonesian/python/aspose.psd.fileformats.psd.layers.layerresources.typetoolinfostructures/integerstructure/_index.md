---
title: "Kelas IntegerStructure"
type: docs
weight: 80
url: /id/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | Menginisialisasi sebuah instance baru dari kelas [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Deskripsi** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Kunci struktur integer. |
...
Menginisialisasi sebuah instance baru dari kelas [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/).
