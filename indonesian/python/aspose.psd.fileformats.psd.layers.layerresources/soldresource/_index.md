...
type: docs
weight: 930
url: /id/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [SoLdResource()](#SoLdResource__1) | Menginisialisasi sebuah instance baru dari kelas [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) .<br/>            Konstruktor default ini dirancang untuk digunakan oleh [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/).<br/>            Gunakan [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) untuk membuat kelas SoLdResource. |
| [SoLdResource(unique_id, is_custom, has_comp_info)](#SoLdResource_unique_id_is_custom_has_comp_info_2) | Menginisialisasi sebuah instance baru dari kelas [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) .<br/>            Perlu mengatur properti Items atau memanggil InitializeItems() untuk mendapatkan instance yang siap.<br/>            Konstruktor ini dirancang untuk digunakan oleh [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)<br/>            dan dalam pengujian unit.<br/>            Gunakan [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) untuk membuat kelas SoLdResource. |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | Kunci info alat tipe: 'SoLd'. |
...
Menginisialisasi sebuah instance baru dari kelas [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) .<br/>            Konstruktor default ini dirancang untuk digunakan oleh [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/).<br/>            Gunakan [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) untuk membuat kelas SoLdResource.
...
| :- | :- | :- |
| unique_id | Guid | Pengidentifikasi unik data lapisan objek pintar [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/). |
