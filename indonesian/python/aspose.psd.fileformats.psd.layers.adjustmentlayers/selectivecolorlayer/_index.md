...
type: docs
weight: 200
url: /id/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | Mendapatkan atau mengatur metode koreksi. |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | Mendapatkan koreksi cmyk berdasarkan warna selektif. |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | Mengatur koreksi cmyk berdasarkan warna selektif. |
...
Mendapatkan koreksi cmyk berdasarkan warna selektif.

**Parameters:**

| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Warna selektif. |

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Cmyk Koreksi. |
...
Mengatur koreksi cmyk berdasarkan warna selektif.

**Parameters:**

| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Tipe warna selektif. |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Cmyk Koreksi. |
