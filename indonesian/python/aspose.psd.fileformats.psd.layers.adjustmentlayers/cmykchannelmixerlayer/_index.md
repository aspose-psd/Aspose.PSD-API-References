...
type: docs
weight: 50
url: /id/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Mendapatkan channel hitam. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Mendapatkan channel cyan. |
...
| kiri | int | r/w |  |
| panjang | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Mendapatkan channel magenta. |
| monochrome | bool | r/w | Mendapatkan atau mengatur nilai yang menunjukkan apakah [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) ini monokrom. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Mendapatkan channel kuning. |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Mendapatkan indeks channel. Mengembalikan CmykMixerChannel |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Menggabungkan lapisan ke lapisan yang ditentukan |
| normalize_angle() |  |
...
Mendapatkan indeks channel. Mengembalikan CmykMixerChannel
