...
type: docs
weight: 90
url: /id/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_continuous_manager_used | bool | r/w | Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini menggunakan continuous manager. |
| is_discrete_manager_used | bool | r/w | Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini menggunakan discrete manager. |
...
| [get_curves_manager()](#get_curves_manager__8) | Mendapatkan curves manager. |
...
Mendapatkan curves manager.

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) atau [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) yang tergantung pada properti IsDiscreteManagerUsed dan IsContinuousManagerUsed |
