...
type: docs
weight: 4220
url: /id/python-net/aspose.psd/splitstreamcontainer/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [SplitStreamContainer(stream)](#SplitStreamContainer_stream_1) | Menginisialisasi instance baru dari kelas [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/). |
| [SplitStreamContainer(stream, dispose_stream)](#SplitStreamContainer_stream_dispose_stream_2) | Menginisialisasi instance baru dari kelas [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/). |
| [SplitStreamContainer(stream, dispose_stream)](#SplitStreamContainer_stream_dispose_stream_3) | Menginisialisasi instance baru dari kelas [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/). |
## **Properties**
...
| [insert(position, stream, dispose_stream)](#insert_position_stream_dispose_stream_1) | Menyisipkan kontainer aliran ke posisi yang ditentukan. |
| [read(buffer, offset, count)](#read_buffer_offset_count_2) | Membaca urutan byte dari aliran saat ini dan memajukan posisi dalam aliran sebesar jumlah byte yang dibaca. |
| [read(bytes)](#read_bytes_3) | Membaca byte untuk mengisi buffer byte yang ditentukan. |
| [read_byte()](#read_byte__4) | Membaca satu byte dari aliran dan memajukan posisi dalam aliran satu byte, atau mengembalikan -1 jika berada di akhir aliran. |
| [save(destination_stream)](#save_destination_stream_5) | Menyimpan (menyalin) data aliran ke aliran yang ditentukan. Menggunakan ukuran buffer default [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) dan nilai [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) aliran. |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_6) | Menyimpan (menyalin) semua data aliran ke aliran yang ditentukan. Menggunakan nilai [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) aliran. |
| [save(destination_stream, buffer_size, length)](#save_destination_stream_buffer_size_length_7) | Menyimpan (menyalin) data aliran ke aliran yang ditentukan. |
| [save(file_path)](#save_file_path_8) | Menyimpan (menyalin) data aliran ke aliran yang ditentukan. Menggunakan ukuran buffer default [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) dan nilai [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) aliran. |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_9) | Menyimpan (menyalin) data aliran ke aliran yang ditentukan. Menggunakan nilai aliran [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size, length)](#save_file_path_buffer_size_length_10) | Menyimpan (menyalin) data aliran ke aliran yang ditentukan. |
| [seek(offset, origin)](#seek_offset_origin_11) | Menetapkan posisi dalam aliran saat ini. |
...
| [to_bytes()](#to_bytes__12) | Mengonversi data aliran menjadi array int. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_13) | Mengonversi data aliran menjadi array int. |
| [write(buffer, offset, count)](#write_buffer_offset_count_14) | Menulis urutan byte ke aliran saat ini dan memajukan posisi saat ini dalam aliran ini sebesar jumlah byte yang ditulis. |
| [write(bytes)](#write_bytes_15) | Menulis semua byte yang ditentukan ke aliran. |
| [write_byte(value)](#write_byte_value_16) | Menulis satu byte ke posisi saat ini dalam aliran dan memajukan posisi dalam aliran sebesar satu byte. |
| [write_to(stream_container)](#write_to_stream_container_17) | Mengopi data yang terkandung ke [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) lain. |
| [write_to(stream_container, length)](#write_to_stream_container_length_18) | Mengopi data yang terkandung ke [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) lain. |
...
Menginisialisasi instance baru dari kelas [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/).
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| stream | [StreamContainer](/psd/python-net/aspose.psd/streamcontainer) | Aliran data. |
| dispose_stream | bool | Jika diatur ke <c>true</c> aliran akan dibuang ketika kontainer dibuang. |
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| posisi | int | Posisi untuk menyisipkan. |
| stream | [StreamContainer](/psd/python-net/aspose.psd/streamcontainer) | Kontainer aliran untuk disisipkan. |
| dispose_stream | bool | Jika diatur ke <c>true</c> membuang aliran. |
...
| :- | :- | :- |
| destination_stream | _io.BufferedRandom | Aliran untuk menyimpan data. |
| buffer_size | int | Ukuran buffer. Secara default nilai ReadWriteBytesCount digunakan. |
| length | long | Panjang data aliran yang akan disalin. Secara default panjang diatur ke nilai [SplitStreamContainer.length](/psd/python-net/aspose.psd/splitstreamcontainer/). |
