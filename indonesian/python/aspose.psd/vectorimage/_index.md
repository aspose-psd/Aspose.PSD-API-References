...
type: docs
weight: 4700
url: /id/python-net/aspose.psd/vectorimage/
---
...
| height_f | float | r | Mendapatkan tinggi objek, dalam inci. |
...
| size_f | [SizeF](/psd/python-net/aspose.psd/sizef) | r | Mendapatkan ukuran objek, dalam inci. |
| use_palette | bool | r | Mendapatkan nilai yang menunjukkan apakah palet gambar digunakan. |
| width | int | r | Mendapatkan lebar gambar. |
| width_f | float | r | Mendapatkan lebar objek, dalam inci. |
## **Methods**
| **Name** | **Deskripsi** |
| :- | :- |
