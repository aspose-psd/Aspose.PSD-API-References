...
type: docs
weight: 90
url: /id/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Mendapatkan atau mengatur warna latar belakang artboard. |
...
| has_background_color | bool | r/w | Mendapatkan atau mengatur nilai yang menunjukkan apakah [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) memiliki warna latar belakang. |
| memiliki_warna_transparan | bool | r/w |  |
| tinggi | int | r | <inheritdoc /> |
...
| is_open | bool | r/w | Mendapatkan atau mengatur apakah folder terbuka<br/>            jika disetel ke <c>true</c> maka grup akan berada dalam keadaan terbuka saat memulai, jika tidak dalam keadaan diminimalkan. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Mendapatkan lapisan dalam grup lapisan |
| kiri | int | r/w | <inheritdoc /> |
| panjang | int | r |  |
...
| **Name** | **Deskripsi** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Menambahkan lapisan ke grup lapisan. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Menambahkan grup lapisan. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Memuat piksel ARGB 32-bit secara parsial (per blok). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Memuat data mentah. |
