...
type: docs
weight: 1600
url: /id/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Menginisialisasi instance baru dari kelas [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Semua sumber daya dibuat dalam keadaan default. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Mendapatkan atau mengatur pengaturan Isi untuk area internal Shapes dalam lapisan Shape. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Mendapatkan kumpulan Path yang ada dalam lapisan Shape. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Mendapatkan atau mengatur pengaturan Stroke dari Shapes. |
| atas | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Membuat instance baru dari kelas [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Memperbarui sumber daya dari properti lapisan Shape. |
...
Menginisialisasi instance baru dari kelas [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Semua sumber daya dibuat dalam keadaan default.
...
Membuat instance baru dari kelas [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Tipe | Deskripsi |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Mengembalikan instance baru dari kelas [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
