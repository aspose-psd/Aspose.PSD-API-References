---
title: "TextLayer Kelas"
type: docs
weight: 1750
url: /id/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Mendapatkan font. |
...
| inner_text | string | r | Mendapatkan teks lapisan |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Mendapatkan atau mengatur kotak pembatas teks. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Mendapatkan warna teks. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Mendapatkan bagian teks. |
| atas | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Mendapatkan kumpulan font lapisan teks. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Mengubah ukuran gambar. Default [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) digunakan. |
...
| [update_text(text)](#update_text_text_38) | Memperbarui teks. |
| [update_text(text, color)](#update_text_text_color_39) | Memperbarui teks. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Memperbarui teks. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Memperbarui teks. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Memperbarui teks. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Memperbarui teks. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Memperbarui teks. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Memperbarui teks. |
...
| Tipe | Deskripsi |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | Kumpulan font lapisan teks. |
...
Mengubah ukuran gambar. Default [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) digunakan.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Jenis transformasi ubah ukuran [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | Nilai teks. |
| color | [Color](/psd/python-net/aspose.psd/color) | Nilai warna. |
...
| :- | :- | :- |
| text | string | Nilai teks. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | Koordinat kiri atas. |
