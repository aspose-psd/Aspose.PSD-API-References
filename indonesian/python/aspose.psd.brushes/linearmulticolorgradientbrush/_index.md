...
type: docs
weight: 40
url: /id/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [LinearMulticolorGradientBrush()](#LinearMulticolorGradientBrush__1) | Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) dengan parameter default.<br/>            Warna awal adalah hitam, warna akhir adalah putih, sudutnya 45 derajat dan persegi panjang berada di (0,0) dengan ukuran (1,1). |
| [LinearMulticolorGradientBrush(point1, point2)](#LinearMulticolorGradientBrush_point1_point2_2) | Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) dengan titik-titik yang ditentukan. |
| [LinearMulticolorGradientBrush(point1, point2)](#LinearMulticolorGradientBrush_point1_point2_3) | Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) dengan titik-titik yang ditentukan. |
| [LinearMulticolorGradientBrush(rect, angle)](#LinearMulticolorGradientBrush_rect_angle_4) | Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) berdasarkan persegi panjang dan sudut orientasi. |
| [LinearMulticolorGradientBrush(rect, angle)](#LinearMulticolorGradientBrush_rect_angle_5) | Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) berdasarkan persegi panjang dan sudut orientasi. |
| [LinearMulticolorGradientBrush(rect, angle, is_angle_scalable)](#LinearMulticolorGradientBrush_rect_angle_is_angle_scalable_6) | Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) berdasarkan persegi panjang dan sudut orientasi. |
...
Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) dengan parameter default.<br/>            Warna awal adalah hitam, warna akhir adalah putih, sudutnya 45 derajat dan persegi panjang berada di (0,0) dengan ukuran (1,1).
...
Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) dengan titik-titik yang ditentukan.
...
Menginisialisasi sebuah instance baru dari kelas [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) berdasarkan persegi panjang dan sudut orientasi.
...
| rect | [Rectangle](/psd/python-net/aspose.psd/rectangle) | Sebuah struktur [RectangleF](/psd/python-net/aspose.psd/rectanglef/) yang menentukan batas gradien linier. |
| sudut | float | Sudut, diukur dalam derajat searah jarum jam dari sumbu x, dari garis orientasi gradien. |
| is_angle_scalable | bool | jika disetel ke <c>true</c> sudut akan berubah selama transformasi dengan [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) ini. |
