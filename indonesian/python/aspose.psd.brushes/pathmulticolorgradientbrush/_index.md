...
type: docs
weight: 70
url: /id/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/
---
...
| **Name** | **Deskripsi** |
| :- | :- |
| [PathMulticolorGradientBrush(path)](#PathMulticolorGradientBrush_path_1) | Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan jalur yang ditentukan. |
| [PathMulticolorGradientBrush(points)](#PathMulticolorGradientBrush_points_2) | Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan titik-titik yang ditentukan. |
| [PathMulticolorGradientBrush(points)](#PathMulticolorGradientBrush_points_3) | Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan titik-titik yang ditentukan. |
| [PathMulticolorGradientBrush(points, wrap_mode)](#PathMulticolorGradientBrush_points_wrap_mode_4) | Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan titik-titik yang ditentukan dan mode pembungkus. |
| [PathMulticolorGradientBrush(points, wrap_mode)](#PathMulticolorGradientBrush_points_wrap_mode_5) | Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan titik-titik yang ditentukan dan mode pembungkus. |
## **Properties**
...
Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan jalur yang ditentukan.

**Parameters:**

| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| path | [GraphicsPath](/psd/python-net/aspose.psd/graphicspath) | [GraphicsPath](/psd/python-net/aspose.psd/graphicspath/) yang mendefinisikan area yang diisi oleh [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/). |
...
Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan titik-titik yang ditentukan.
...
Menginisialisasi sebuah instance baru dari kelas [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) dengan titik-titik yang ditentukan dan mode pembungkus.
...
| :- | :- | :- |
| points | [PointF[]](/psd/python-net/aspose.psd/pointf) | Array struktur [PointF](/psd/python-net/aspose.psd/pointf/) yang mewakili titik-titik yang membentuk simpul-simpul jalur. |
| wrap_mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | [WrapMode](/psd/python-net/aspose.psd/wrapmode/) yang menentukan bagaimana isian yang digambar dengan [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) ditata ubin. |
