...
description: "Konstruktor InitialFillRuleRecord. Menginisialisasi instance baru dari kelas InitialFillRuleRecord"
type: docs
weight: 10
...
Menginisialisasi instance baru dari kelas [`InitialFillRuleRecord`](../).
...
| --- | --- | --- |
| isFillStartsWithAllPixels | Boolean | Is fill dimulai dengan semua piksel. |
