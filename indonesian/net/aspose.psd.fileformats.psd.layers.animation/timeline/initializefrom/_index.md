...
description: "Metode TimeLine. Membuat instance baru dari TimeLine yang diinisialisasi dari PsdImage input"
type: docs
weight: 20
url: /id/net/aspose.psd.fileformats.psd.layers.animation/timeline/initializefrom/
---
{{< psd/tize >}}
## TimeLine.InitializeFrom method

Membuat instance baru dari [`TimeLine`](../), yang diinisialisasi dari [`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
...
Instance baru dari [`TimeLine`](../), yang diinisialisasi dari [`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
