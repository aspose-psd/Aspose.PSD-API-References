...
description: TimeLine metode. Membuat instance baru dariTimeLine  diinisialisasi dari inputPsdImage .
type: docs
weight: 20
...
Membuat instance baru dari[`TimeLine`](../) , diinisialisasi dari input[`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/) .
...
Contoh baru dari[`TimeLine`](../) , diinisialisasi dari input[`PsdImage`](../../../aspose.psd.fileformats.psd/psdimage/).
