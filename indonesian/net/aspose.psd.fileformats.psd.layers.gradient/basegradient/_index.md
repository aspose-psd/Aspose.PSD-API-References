...
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient class. Kelas definisi gradien dasar. Ini berisi properti umum untuk kedua tipe gradien Solid dan Noise"
type: docs
weight: 2190
url: /id/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| Nama | Deskripsi |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | Mendapatkan mode untuk gradien ini. Menentukan 'Gradient Type' = 'Solid/Noise' (0/1). |
