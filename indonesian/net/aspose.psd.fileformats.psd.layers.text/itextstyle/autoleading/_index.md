...
description: ITextStyle Properti. Mendapat atau menetapkan nilai yang menunjukkan apakah memimpin otomatis.
type: docs
weight: 20
url: /id/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Mendapat atau menetapkan nilai yang menunjukkan apakah [memimpin otomatis].
...
`BENAR` if [memimpin otomatis]; jika tidak,`PALSU` .
