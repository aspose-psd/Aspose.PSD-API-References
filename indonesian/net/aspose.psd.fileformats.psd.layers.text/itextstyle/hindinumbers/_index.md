...
description: ITextStyle Properti. Mendapat atau menetapkan nilai yang menunjukkan apakah angka hindi.
type: docs
weight: 150
url: /id/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Mendapat atau menetapkan nilai yang menunjukkan apakah [angka hindi].
...
`BENAR` if [nomor hindi]; jika tidak,`PALSU` .
