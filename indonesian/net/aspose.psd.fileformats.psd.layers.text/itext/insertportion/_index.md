...
description: "IText metode. Menyisipkan ITextPortion ke posisi yang ditentukan"
type: docs
weight: 50
url: /id/net/aspose.psd.fileformats.psd.layers.text/itext/insertportion/
---
{{< psd/tize >}}
## IText.InsertPortion method

Menyisipkan [`ITextPortion`](../../itextportion/) ke posisi yang ditentukan
...
| --- | --- | --- |
| bagian | ITextPortion | Bagian tersebut. |
| index | Int32 | Indeks. |
