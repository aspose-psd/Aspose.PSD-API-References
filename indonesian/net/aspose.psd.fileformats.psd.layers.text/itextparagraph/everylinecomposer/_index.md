...
description: ITextParagraph Properti. Mendapat atau menetapkan nilai yang menunjukkan apakah setiap baris komposer.
type: docs
weight: 60
url: /id/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Mendapat atau menetapkan nilai yang menunjukkan apakah [setiap baris komposer].
...
`BENAR` if [setiap komposer baris]; jika tidak,`PALSU` .
