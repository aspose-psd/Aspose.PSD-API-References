...
description: "ITextParagraph properti. Mendapatkan atau mengatur nilai yang menunjukkan apakah setiap penyusun baris"
type: docs
weight: 60
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah [every line composer].
...
`true` jika [every line composer]; selain itu, `false`.
