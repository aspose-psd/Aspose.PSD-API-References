...
description: "Properti ITextParagraph. Mendapatkan atau mengatur nilai yang menunjukkan apakah hyphenasi otomatis"
type: docs
weight: 10
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah [automatic hyphenate].
...
`true` jika [automatic hyphenate]; selainnya, `false`.
