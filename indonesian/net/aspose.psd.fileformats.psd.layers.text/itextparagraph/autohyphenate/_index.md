...
description: ITextParagraph Properti. Mendapat atau menetapkan nilai yang menunjukkan apakah tanda hubung otomatis.
type: docs
weight: 10
url: /id/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Mendapat atau menetapkan nilai yang menunjukkan apakah [tanda hubung otomatis].
...
`BENAR` if [tanda hubung otomatis]; jika tidak,`PALSU` .
