---
title: ITextParagraph.Hanging
second_title: Aspose.PSD untuk Referensi .NET API
description: ITextParagraph Properti. Mendapat atau menetapkan nilai yang menunjukkan apakah iniITextParagraph sedang menggantung.
type: docs
weight: 90
url: /id/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Mendapat atau menetapkan nilai yang menunjukkan apakah ini[`ITextParagraph`](../) sedang menggantung.
...
`BENAR` jika digantung; jika tidak,`PALSU` .
