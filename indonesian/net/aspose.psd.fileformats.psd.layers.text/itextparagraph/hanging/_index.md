...
description: "Properti ITextParagraph. Mendapatkan atau mengatur nilai yang menunjukkan apakah ITextParagraph ini menggantung"
type: docs
weight: 90
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah [`ITextParagraph`](../) ini menggantung.
...
`true` jika menggantung; sebaliknya, `false`.
