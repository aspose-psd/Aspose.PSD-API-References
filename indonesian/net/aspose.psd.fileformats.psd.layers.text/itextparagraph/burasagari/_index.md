...
description: "Properti ITextParagraph. Mendapatkan atau mengatur nilai yang menunjukkan apakah ITextParagraph ini adalah burasagiri"
type: docs
weight: 30
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah [`ITextParagraph`](../) ini adalah burasagiri.
...
`true` jika burasagiri; sebaliknya, `false`.
