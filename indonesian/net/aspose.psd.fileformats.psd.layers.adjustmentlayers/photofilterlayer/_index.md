...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer kelas. Lapisan penyesuaian PhotoFilter.
type: docs
weight: 1790
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Mendapat atau menyetel warna RGB filter. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Mendapat atau menyetel kepadatan filter |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah [mempertahankan luminositas]. |
