...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer kelas. Lapisan Penyesuaian Mixer Saluran.
type: docs
weight: 1690
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah ini`ChannelMixerLayer` adalah monokrom. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Mendapat indeks saluran. Dapat mengembalikan RgbMixerChannel atau CmykMixerChannel |
