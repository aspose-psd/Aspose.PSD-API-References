...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes enum. Metode koreksi dalam lapisan penyesuaian warna selektif"
type: docs
weight: 1780
url: /id/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| Relative | `0` | Terapkan koreksi warna dalam mode relatif. |
| Absolute | `1` | Terapkan koreksi warna dalam mode absolut. |
