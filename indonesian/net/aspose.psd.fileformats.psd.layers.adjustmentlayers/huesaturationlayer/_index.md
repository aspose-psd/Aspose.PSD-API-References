---
title: "Kelas HueSaturationLayer"
second_title: "Aspose.PSD untuk Referensi API .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer kelas. Lapisan penyesuaian HueSaturation"
type: docs
weight: 1820
url: /id/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
{{< psd/tize >}}
## HueSaturationLayer class

Lapisan penyesuaian HueSaturation.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Mendapatkan atau mengatur nilai yang menunjukkan apakah `HueSaturationLayer` ini diwarnai. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Mendapatkan atau mengatur hue. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | Mendapatkan atau mengatur lightness. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | Mendapatkan atau mengatur saturasi. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | Mendapatkan rentang. |
