...
description: "Konstruktor VmskResource. Menginisialisasi sebuah instance baru dari kelas VmskResource"
type: docs
weight: 10
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/vmskresource/
---
{{< psd/tize >}}
## VmskResource(byte[]) {#constructor_1}

Menginisialisasi sebuah instance baru dari kelas [`VmskResource`](../).
...
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Nilai Vmsk Resource tidak valid |
