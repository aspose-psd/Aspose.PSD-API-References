...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LiFdDataSource kelas. Menentukan kelas sumber data liFD di File PSD yang berisi informasi tentang file tersemat. Ini adalah bagian dari API Manipulasi Format File PSD yang membantu memodifikasi file Adobe Photoshop
type: docs
weight: 2670
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/
---
## LiFdDataSource class

Menentukan kelas sumber data liFD di File PSD yang berisi informasi tentang file tersemat. Ini adalah bagian dari API Manipulasi Format File PSD yang membantu memodifikasi file Adobe® Photoshop®
...
| Nama | Keterangan |
| --- | --- |
| [LiFdDataSource](lifddatasource/#constructor)() | Menginisialisasi instance baru dari`LiFdDataSource` kelas. |
| [LiFdDataSource](lifddatasource/#constructor_1)(int, Guid, string, string, string) | Menginisialisasi instance baru dari`LiFdDataSource` kelas. |
...
| [Data](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) { get; set; } | Mendapat atau menyetel data objek pintar tersemat dalam file PSD. |
