...
description: LiFeDataSource Properti. Mendapat atau menyetel jalur relatif file eksternal di sumber data LiFE sumber daya PSD LnkE.
type: docs
weight: 100
...
Mendapat atau menyetel jalur relatif file eksternal di sumber data LiFE sumber daya PSD LnkE.
...
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Anda tidak dapat mengakses properti RelativePath, ini hanya tersedia untuk sumber data seumur hidup |
