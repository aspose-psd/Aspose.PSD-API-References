...
description: LiFeDataSource Properti. Mendapat atau menyetel perpustakaan grafis AdobeStockId untuk Perpustakaan Adobe Photoshop CC.
type: docs
weight: 20
...
Mendapat atau menyetel perpustakaan grafis AdobeStockId, untuk Perpustakaan Adobe® Photoshop® CC.
...
Perpustakaan grafik Adobe Stock Identifier.

### Pengecualian

| pengecualian | kondisi |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Anda tidak dapat mengakses properti AdobeStockId, ini hanya tersedia untuk sumber data seumur hidup jika IsLibrary true |
