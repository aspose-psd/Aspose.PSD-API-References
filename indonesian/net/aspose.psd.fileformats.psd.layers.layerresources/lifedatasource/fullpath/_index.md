...
description: LiFeDataSource Properti. Mendapat atau menyetel jalur lengkap file eksternal di sumber data LiFE sumber daya PSD LnkE.
type: docs
weight: 90
...
Mendapat atau menyetel jalur lengkap file eksternal di sumber data LiFE sumber daya PSD LnkE.
...
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Anda tidak dapat mengakses properti FullPath, ini hanya tersedia untuk sumber data seumur hidup |
