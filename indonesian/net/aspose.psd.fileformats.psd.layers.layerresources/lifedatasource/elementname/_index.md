...
description: LiFeDataSource Properti. Mendapatkan atau menyetel nama elemen pustaka grafis untuk Adobe Photoshop CC Libraries.
type: docs
weight: 50
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

Mendapatkan atau menyetel nama elemen pustaka grafis, untuk Adobe® Photoshop® CC Libraries.
...
Nama elemen pustaka grafis.

### Pengecualian

| pengecualian | kondisi |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Anda tidak dapat mengakses properti ElementName, ini hanya tersedia untuk sumber data live ketika IsLibrary true |
