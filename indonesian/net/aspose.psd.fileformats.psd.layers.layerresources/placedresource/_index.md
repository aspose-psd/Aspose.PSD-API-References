...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlacedResource kelas. Menentukan kelas PlacedResource yang berisi informasi umum tentang lapisan yang ditempatkan atau lapisan objek pintar di file PSD. Digunakan untuk mendukung lapisan objek pintar di gambar Adobe Photoshop.
type: docs
weight: 2940
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/
---
## PlacedResource class

Menentukan kelas PlacedResource yang berisi informasi umum tentang lapisan yang ditempatkan atau lapisan objek pintar di file PSD. Digunakan untuk mendukung lapisan objek pintar di gambar Adobe® Photoshop®.
...
| override [Signature](../../aspose.psd.fileformats.psd.layers.layerresources/placedresource/signature/) { get; } | Mendapat tanda tangan sumber daya Ditempatkan. |
...
| Nama | Keterangan |
| --- | --- |
| abstract [Save](../../aspose.psd.fileformats.psd.layers/layerresource/save/)(StreamContainer, int) | Menyimpan sumber daya ke wadah aliran yang ditentukan. |
