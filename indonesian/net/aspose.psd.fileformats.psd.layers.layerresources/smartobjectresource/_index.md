---
title: "Kelas SmartObjectResource"
second_title: "Aspose.PSD untuk Referensi API .NET"
description: "Kelas Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SmartObjectResource. Mendefinisikan kelas SmartObjectResource yang berisi informasi tentang lapisan objek pintar dalam file PSD. Ini adalah kelas dasar untuk sumber daya Sold dan Sole yang digunakan untuk mendukung lapisan objek pintar dalam gambar Adobe Photoshop."
type: docs
weight: 3340
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/
---
{{< psd/tize >}}
## SmartObjectResource class

Mendefinisikan kelas SmartObjectResource yang berisi informasi tentang lapisan objek pintar dalam file PSD. Merupakan kelas dasar untuk sumber daya Sold dan Sole yang digunakan untuk mendukung lapisan objek pintar dalam gambar Adobe® Photoshop®.
...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | Mendapatkan atau mengatur pengidentifikasi unik global data lapisan objek pintar `SmartObjectResource` dalam gambar PSD. |
