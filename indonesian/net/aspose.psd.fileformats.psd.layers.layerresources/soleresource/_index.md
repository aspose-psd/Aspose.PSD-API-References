...
description: "Kelas Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource. Mendefinisikan kelas SoLeResource yang berisi informasi tentang lapisan objek pintar dalam file PSD. Ini digunakan untuk mendukung lapisan objek pintar dengan tautan file eksternal dalam gambar Adobe Photoshop"
type: docs
weight: 3380
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
{{< psd/tize >}}
## SoLeResource class

Mendefinisikan kelas SoLeResource yang berisi informasi tentang lapisan objek pintar dalam file PSD. Digunakan untuk mendukung lapisan objek pintar dengan tautan file eksternal dalam gambar Adobe® Photoshop®.
...
| Nama | Deskripsi |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Menginisialisasi instance baru dari kelas `SoLeResource`. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Menginisialisasi instance baru dari kelas `SoLeResource`. |
...
| Nama | Deskripsi |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | Kunci info alat tipe: 'SoLE'. |
