...
description: "VsmsResource constructor. Menginisialisasi instance baru dari kelas VsmsResource"
type: docs
weight: 10
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/vsmsresource/
---
{{< psd/tize >}}
## VsmsResource(byte[]) {#constructor_1}

Menginisialisasi instance baru dari kelas [`VsmsResource`](../).
...
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Nilai Sumber Daya Vsms Tidak Valid |
