---
title: "Kelas GradientMapSettings"
second_title: "Aspose.PSD untuk Referensi API .NET"
description: "Kelas Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientMapSettings. Kelas pengaturan gradien untuk lapisan peta gradien. Ini berisi properti umum untuk kedua tipe gradien Solid dan Noise."
type: docs
weight: 2080
url: /id/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/
---
{{< psd/tize >}}
## GradientMapSettings class

Kelas pengaturan gradien untuk lapisan peta gradien. Ini berisi properti umum untuk kedua tipe gradien (Solid dan Noise).
...
| Nama | Deskripsi |
| --- | --- |
| [GradientMapSettings](gradientmapsettings/)() | Konstruktor default. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/dither/) { get; set; } | Mendapatkan atau mengatur nilai yang menunjukkan apakah [`GradientFillSettings`](../gradientfillsettings/) ini menggunakan dither. |
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/) { get; set; } | Mendapatkan atau mengatur instance definisi gradien spesifik (Solid/Noise). |
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/interpolationmethod/) { get; set; } | Mendapatkan atau mengatur metode interpolasi untuk gradien. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/reverse/) { get; set; } | Mendapatkan atau mengatur nilai yang menunjukkan apakah [`GradientFillSettings`](../gradientfillsettings/) ini dibalik. |
