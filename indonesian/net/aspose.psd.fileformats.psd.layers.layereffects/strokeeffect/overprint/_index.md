...
description: "StrokeEffect properti. Mendapatkan atau mengatur nilai yang menunjukkan apakah StrokeEffect ini akan menggabungkan stroke dengan konten lapisan saat ini"
type: docs
weight: 60
url: /id/net/aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/overprint/
---
{{< psd/tize >}}
## StrokeEffect.Overprint property

Mendapatkan atau mengatur nilai yang menunjukkan apakah [`StrokeEffect`](../) ini akan menggabungkan stroke dengan konten lapisan saat ini.
...
`true` jika harus menggabungkan stroke dengan konten lapisan saat ini; jika tidak, `false`.
