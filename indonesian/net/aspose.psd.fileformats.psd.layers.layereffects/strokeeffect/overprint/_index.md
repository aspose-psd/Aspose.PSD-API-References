...
description: StrokeEffect Properti. Mendapat atau menetapkan nilai yang menunjukkan apakah iniStrokeEffect akan memadukan goresan dengan konten lapisan saat ini.
type: docs
weight: 60
...
Mendapat atau menetapkan nilai yang menunjukkan apakah ini[`StrokeEffect`](../) akan memadukan goresan dengan konten lapisan saat ini.
...
`BENAR` jika harus memadukan goresan dengan konten lapisan saat ini; jika tidak,`PALSU` .
