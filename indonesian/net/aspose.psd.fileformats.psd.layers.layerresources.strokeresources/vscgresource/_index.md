...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.StrokeResources.VscgResource class. Sumber daya Data Konten Goresan Vektor"
type: docs
weight: 3430
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
{{< psd/tize >}}
## VscgResource class

Sumber daya Data Konten Goresan Vektor.
...
| Nama | Deskripsi |
| --- | --- |
| [VscgResource](vscgresource/)() | Konstruktor default. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [Items](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/items/) { get; } | Mendapatkan atau mengatur array item struktur. **Warning:** Nilai array `Items` harus cocok dengan properti `KeyForData`, yang menentukan tipe pengaturan isi yang disimpan dalam struktur di dalam `Items`. |
| [Key](../../aspose.psd.fileformats.psd.layers/layerresource/key/) { get; } | Mendapatkan kunci sumber daya lapisan. |
| [KeyForData](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/keyfordata/) { get; } | Mendapatkan kunci integer yang menentukan jenis pengaturan isi yang disimpan dalam sumber daya: * Color - 0x536f436f - SoCoResource.TypeToolKey * Gradient - 0x4764466c - GdFlResource.TypeToolKey * Pattern - 0x5074466c - PtFlResource.TypeToolKey Peringatan! Nilai properti KeyForData harus sesuai dengan tipe pengaturan Isi yang disimpan dalam struktur Items. |
| override [Length](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/length/) { get; } | Mendapatkan panjang sumber daya lapisan dalam byte. |
...
| Nama | Deskripsi |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/save/)(StreamContainer, int) | Menyimpan sumber daya ke kontainer aliran yang ditentukan. |
...
| Nama | Deskripsi |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/typetoolkey/) | Kunci info alat tipe. |
