...
description: "Properti VscgResource. Mendapatkan atau mengatur array item struktur. Peringatan Nilai array Items harus cocok dengan properti KeyForData yang menentukan jenis pengaturan isian yang disimpan dalam struktur di dalam Items"
type: docs
weight: 20
url: /id/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/items/
---
{{< psd/tize >}}
## VscgResource.Items property

Mendapatkan atau mengatur array item struktur. **Warning:** Nilai array `Items` harus cocok dengan properti `KeyForData`, yang menentukan tipe pengaturan isi yang disimpan dalam struktur di dalam `Items`.
...
Array dari item [`OSTypeStructure`](../../../aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/).

## Contoh

Kode berikut menunjukkan dukungan untuk VscgResource.
