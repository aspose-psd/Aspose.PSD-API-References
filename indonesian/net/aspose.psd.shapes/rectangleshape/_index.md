...
description: "Kelas Aspose.PSD.Shapes.RectangleShape. Mewakili bentuk persegi panjang"
type: docs
weight: 6030
url: /id/net/aspose.psd.shapes/rectangleshape/
---
{{< psd/tize >}}
## RectangleShape class

Mewakili bentuk persegi panjang.
...
| Nama | Deskripsi |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Menginisialisasi instance baru dari kelas `RectangleShape`. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Menginisialisasi instance baru dari kelas `RectangleShape`. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Mendapatkan segmen bentuk. |
