...
description: Aspose.PSD.Shapes.ArcShape kelas. Merupakan bentuk busur.
type: docs
weight: 5460
...
| Nama | Keterangan |
| --- | --- |
| [ArcShape](arcshape/#constructor)() | Menginisialisasi instance baru dari`ArcShape` kelas. |
| [ArcShape](arcshape/#constructor_1)(RectangleF, float, float) | Menginisialisasi instance baru dari`ArcShape` kelas. |
| [ArcShape](arcshape/#constructor_2)(RectangleF, float, float, bool) | Menginisialisasi instance baru dari`ArcShape` kelas. |
...
| [EndPoint](../../aspose.psd.shapes/arcshape/endpoint/) { get; } | Mendapatkan titik bentuk akhir. |
...
| [IsClosed](../../aspose.psd.shapes/arcshape/isclosed/) { get; set; } | Mendapat atau menetapkan nilai yang menunjukkan apakah bentuk yang dipesan ditutup. Saat memproses bentuk pesanan tertutup, titik awal dan akhir tidak memiliki arti. |
...
| [StartPoint](../../aspose.psd.shapes/arcshape/startpoint/) { get; } | Mendapatkan titik bentuk awal. |
...
| Nama | Keterangan |
| --- | --- |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds)(Matrix) | Mendapat batas objek. |
| override [GetBounds](../../aspose.psd.shapes/arcshape/getbounds/#getbounds_1)(Matrix, Pen) | Mendapat batas objek. |
| [Reverse](../../aspose.psd.shapes/arcshape/reverse/)() | Membalik urutan poin untuk bentuk ini. |
