---
title: "Kelas LayerGroup"
second_title: "Aspose.PSD untuk Referensi API .NET"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerGroup class. Kelas lapisan grup"
type: docs
weight: 2420
url: /id/net/aspose.psd.fileformats.psd.layers/layergroup/
---
{{< psd/tize >}}
## LayerGroup class
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Mendapatkan atau mengatur kunci mode pencampuran. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Mendapatkan tinggi grup lapisan. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Mendapatkan atau mengatur apakah folder terbuka; jika diset ke `true` maka grup akan berada dalam keadaan terbuka saat memulai, jika tidak dalam keadaan diminimalkan. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Mendapatkan lapisan dalam grup lapisan |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | Mendapatkan lebar grup lapisan. |
...
| Nama | Deskripsi |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Menambahkan lapisan ke grup lapisan. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Menambahkan grup lapisan. |
