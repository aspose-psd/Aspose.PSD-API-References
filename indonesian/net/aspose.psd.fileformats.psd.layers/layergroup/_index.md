...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup kelas. Kelas lapisan grup
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Mendapat atau menyetel kunci mode campuran. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Mendapat ketinggian grup layer. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Mendapat atau menyetel adalah folder yang dibuka jika disetel ke`BENAR` daripada grup akan dalam keadaan terbuka saat start up, jika tidak dalam keadaan diminimalkan. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Mendapat lapisan dalam grup lapisan |
...
| Nama | Keterangan |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Menambahkan layer ke grup layer. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Menambahkan grup layer. |
