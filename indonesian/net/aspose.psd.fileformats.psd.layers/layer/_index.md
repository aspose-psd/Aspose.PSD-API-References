...
description: "Kelas Aspose.PSD.FileFormats.Psd.Layers.Layer. Lapisan PSD"
type: docs
weight: 2270
url: /id/net/aspose.psd.fileformats.psd.layers/layer/
---
{{< psd/tize >}}
## Layer class
...
| Nama | Deskripsi |
| --- | --- |
| [Layer](layer/#constructor)() | Menginisialisasi sebuah instance baru dari kelas `Layer`. Konstruktor untuk inisialisasi malas. |
| [Layer](layer/#constructor_3)(Stream) | Menginisialisasi sebuah instance baru dari kelas `Layer`. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Menginisialisasi sebuah instance baru dari kelas `Layer`. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Menginisialisasi sebuah instance baru dari kelas `Layer` dari array byte. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Menyimpan data objek ke aliran yang ditentukan. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Menyimpan data objek ke lokasi file yang ditentukan. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Menyimpan data objek ke lokasi file yang ditentukan dalam format file yang ditentukan sesuai opsi penyimpanan. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Menyimpan data gambar ke aliran yang ditentukan dalam format file yang ditentukan sesuai opsi penyimpanan. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Menyimpan data objek ke lokasi file yang ditentukan dalam format file yang ditentukan sesuai opsi penyimpanan. |
...
| Nama | Deskripsi |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Mewakili tanda tangan mode pencampuran. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | Ukuran header lapisan. |
