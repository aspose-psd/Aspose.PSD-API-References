...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer kelas. Kelas lapisan teks
type: docs
weight: 3560
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Mendapat teks dari layer |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | Mendapat teks. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Mendapat atau menyetel kotak terikat teks. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Mendapat warna teks. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Mendapat bagian teks. |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Mendapat atau mengatur posisi layer atas. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Mendapat atau menyetel matriks transformasi |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Mendapat kumpulan font dari lapisan teks. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Mengubah ukuran gambar. DefaultLeftTopToLeftTopdigunakan. |
