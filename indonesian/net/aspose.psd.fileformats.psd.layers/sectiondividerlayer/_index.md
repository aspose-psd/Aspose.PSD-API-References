---
title: "Kelas SectionDividerLayer"
second_title: "Aspose.PSD untuk Referensi API .NET"
description: "Kelas Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer. Lapisan pembagi bagian untuk menandai batas grup lapisan folder"
type: docs
weight: 3810
url: /id/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
{{< psd/tize >}}
## SectionDividerLayer class

Lapisan pembagi bagian untuk menandai batas folder (grup lapisan).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Mendapatkan nilai yang menunjukkan apakah instance ini terlihat dalam grup (Jika lapisan tidak berada dalam grup berarti grup akar). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Mendapatkan [`LayerGroup`](../layergroup/) yang terkait dengan instance `SectionDividerLayer` ini. |
