...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer kelas. Layer pembagi bagian untuk menandai batas folder grup layer.
type: docs
weight: 3410
...
Layer pembagi bagian untuk menandai batas folder (grup layer).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Mendapat nilai yang menunjukkan apakah instance ini terlihat dalam grup (Jika lapisan tidak ada dalam grup, berarti grup root). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Mendapatkan[`LayerGroup`](../layergroup/) yang berhubungan dengan ini`SectionDividerLayer` contoh. |
