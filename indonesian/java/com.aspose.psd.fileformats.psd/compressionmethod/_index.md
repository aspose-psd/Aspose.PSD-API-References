...
description: "Mendefinisikan metode kompresi yang digunakan untuk data gambar."
type: docs
weight: 11
url: /id/java/com.aspose.psd.fileformats.psd/compressionmethod/
---
...
| [RLE](#RLE) | Data gambar yang dikompresi RLE dimulai dengan hitungan byte untuk semua baris pemindaian (baris \* kanal), dengan setiap hitungan disimpan sebagai nilai dua byte. |
| [Raw](#Raw) | Tanpa kompresi. |
| [ZipWithPrediction](#ZipWithPrediction) | ZIP dengan prediksi. |
| [ZipWithoutPrediction](#ZipWithoutPrediction) | ZIP tanpa prediksi. |
## Metode
...
Data gambar yang dikompresi RLE dimulai dengan hitungan byte untuk semua baris pemindaian (baris \* kanal), dengan setiap hitungan disimpan sebagai nilai dua byte. Data terkompresi RLE berikutnya, dengan setiap baris pemindaian dikompresi secara terpisah. Kompresi RLE adalah algoritma kompresi yang sama yang digunakan oleh rutin ROM Macintosh PackBits dan standar TIFF.
...
Tidak ada kompresi. Data gambar disimpan sebagai byte mentah dalam urutan planar RGBA. Itu berarti bahwa pertama semua data R ditulis, kemudian semua data G, kemudian semua data B, dan akhirnya semua data A ditulis.
