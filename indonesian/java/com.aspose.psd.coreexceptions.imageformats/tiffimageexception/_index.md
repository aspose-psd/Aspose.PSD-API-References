...
description: "Pengecualian gambar Tiff"
type: docs
weight: 19
url: /id/java/com.aspose.psd.coreexceptions.imageformats/tiffimageexception/
---
...
Pengecualian gambar Tiff
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [TiffImageException(String message)](#TiffImageException-java.lang.String-) | Menginisialisasi sebuah instance baru dari kelas  TiffImageException . |
| [TiffImageException(String message, Throwable innerException)](#TiffImageException-java.lang.String-java.lang.Throwable-) | Menginisialisasi sebuah instance baru dari kelas  TiffImageException . |
| [TiffImageException(String message, int error)](#TiffImageException-java.lang.String-int-) | Menginisialisasi sebuah instance baru dari kelas  TiffImageException . |
| [TiffImageException(int error)](#TiffImageException-int-) | Menginisialisasi sebuah instance baru dari kelas  TiffImageException . |
## Metode
...
| [getOptionsError()](#getOptionsError--) | Mendapatkan kesalahan opsi tiff. |
...
| --- | --- | --- |
| pesan | java.lang.String | Pesan. |
| kesalahan | int | Kesalahan tersebut. |
