...
description: "Urutan byte untuk gambar tiff."
type: docs
weight: 12
url: /id/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
| Bidang | Deskripsi |
| --- | --- |
| [BigEndian](#BigEndian) | Urutan byte big endian (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | Urutan byte little endian (Intel). |
## Metode
...
Urutan byte big endian (Motorola).
...
Urutan byte little endian (Intel).
