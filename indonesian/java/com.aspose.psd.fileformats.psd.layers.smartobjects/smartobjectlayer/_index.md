...
description: "Mendefinisikan kelas SmartObjectLayer yang berisi objek pintar yang disematkan dalam file PSD atau objek pintar yang ditautkan dalam file eksternal."
type: docs
weight: 10
url: /id/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Mendefinisikan kelas SmartObjectLayer yang berisi objek pintar yang disematkan dalam file PSD atau objek pintar yang ditautkan dalam file eksternal. Dengan Smart Objects, Anda dapat: Melakukan transformasi nondestruktif. Anda dapat memperbesar, memutar, memiringkan, mendistorsi, melakukan transformasi perspektif, atau melengkungkan sebuah lapisan tanpa kehilangan data gambar asli atau kualitas karena transformasi don\\ufffdt memengaruhi data asli. Bekerja dengan data vektor, seperti karya seni vektor dari Illustrator, yang sebaliknya akan dirasterkan. Melakukan penyaringan nondestruktif. Anda dapat mengedit filter yang diterapkan pada Smart Objects kapan saja. Mengedit satu Smart Object dan secara otomatis memperbarui semua instansinya yang ditautkan. Menerapkan masker lapisan yang \\ufffds baik ditautkan maupun tidak ditautkan ke lapisan Smart Object. Mencoba berbagai desain dengan gambar placeholder resolusi rendah yang kemudian Anda ganti dengan versi final. Di Adobe\\ufffd Photoshop\\ufffd, Anda dapat menyematkan konten gambar ke dalam dokumen PSD. Informasi lebih lanjut ada di sini:   Sebuah lapisan dengan smart object yang disematkan berisi sumber daya placed (PlLd) dan SoLd dengan properti smart object. Sumber daya PlLd dapat berdiri sendiri untuk versi PSD yang lebih lama dari 10. Sumber daya ini berisi UniqueId dari LiFdDataSource dalam Lnk2Resource global dengan nama file yang disematkan dan parameter lainnya, termasuk konten file yang disematkan dalam format asli sebagai array byte.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Menginisialisasi instance baru dari kelas [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [BlendSignature](#BlendSignature) | Mewakili tanda tangan mode campuran. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Pesan sumber daya placed dan smart object yang ditemukan |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Pesan: Anda hanya dapat menyalin smart object yang disematkan |
| [LayerHeaderSize](#LayerHeaderSize) | Ukuran header lapisan. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Tidak ada pesan sumber daya yang ditempatkan atau objek pintar yang ditemukan |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Pesan indeks sumber daya yang ditempatkan salah |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Mengonversi objek pintar tertanam ini menjadi objek pintar tertaut. |
...
| [duplicateLayer()](#duplicateLayer--) | Membuat lapisan objek pintar baru dengan menyalin yang ini. |
| [embedLinked()](#embedLinked--) | Menyematkan objek pintar tertaut dalam lapisan ini. |
| [equals(Object obj)](#equals-java.lang.Object-) | Menentukan apakah Object yang ditentukan, sama dengan instance ini. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Mengekspor konten yang tertanam atau tertaut ke sebuah file. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Ini mendapatkan atau mengatur render warp atau menggunakan gambar PS |
...
| [getContentType()](#getContentType--) | Mendapatkan tipe konten lapisan objek pintar. |
| [getContents()](#getContents--) | Mendapatkan atau mengatur konten lapisan objek pintar. |
| [getContentsBounds()](#getContentsBounds--) | Mendapatkan atau mengatur batas konten objek pintar. |
| [getContentsSource()](#getContentsSource--) | Mendapatkan atau mengatur sumber konten objek pintar. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Ini mendapatkan atau mengatur ukuran terakhir gambar untuk warp. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Mendapatkan atau mengatur kuadrilateral asli. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Mendapatkan indeks sumber daya lapisan yang ditempatkan dan pintar serta sumber daya yang ditempatkan dengan benar. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Mendapatkan sumber daya lapisan yang ditempatkan |
...
| [getSmartFilters()](#getSmartFilters--) | Mendapatkan filter pintar. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Mendapatkan atau mengatur kuadrilateral transformasi. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Ini mendapatkan fungsi yang membantu dengan warp |
| [getWarpSettings()](#getWarpSettings--) | Ini mendapatkan atau mengatur parameter Warp yang telah diatur atau diambil dari sumber daya (default). |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Mendapatkan konten gambar yang tertanam atau tertaut dari lapisan objek pintar. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Membuat lapisan objek pintar baru dengan menyalin yang ini. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Panggil ketika kontainer dari [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) ini telah diatur. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Menautkan kembali objek pintar yang tertaut ke file baru. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Mengganti konten objek pintar yang tertanam dalam lapisan objek pintar. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Mengganti konten objek pintar yang tertanam dalam lapisan objek pintar. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Mengganti konten dengan sebuah file. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Mengganti konten dengan sebuah file. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Mengganti konten dengan sebuah file. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Mengganti konten dengan sebuah file. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Mengubah ukuran data saluran |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Ini mendapatkan atau mengatur render warp atau menggunakan gambar PS |
...
| [setContents(byte[] value)](#setContents-byte---) | Mendapatkan atau mengatur konten lapisan objek pintar. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Mendapatkan atau mengatur batas konten objek pintar. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Mendapatkan atau mengatur sumber konten objek pintar. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Ini mendapatkan atau mengatur ukuran terakhir gambar untuk warp. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Mendapatkan atau mengatur kuadrilateral asli. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Mendapatkan penyedia objek pintar. |
| [setTop(int value)](#setTop-int-) | Mendapatkan atau mengatur posisi lapisan atas. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Mendapatkan atau mengatur kuadrilateral transformasi. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Ini mendapatkan atau mengatur parameter Warp yang telah diatur atau diambil dari sumber daya (default). |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Memperbarui pengidentifikasi sumber data. |
| [updateModifiedContent()](#updateModifiedContent--) | Memperbarui cache gambar lapisan objek pintar dengan konten yang dimodifikasi. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Memperbarui cache gambar lapisan objek pintar dengan konten yang dimodifikasi. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Memperbarui sumber daya yang ditempatkan / pintar ketika placedResource diubah atau ketika konversi diperlukan. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Ini adalah pembungkus untuk "IWarpSupport" guna memperbarui pratinjau lapisan |
| [wait()](#wait--) |  |
...
Menginisialisasi instance baru dari kelas [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Aliran item |
...
Pesan sumber daya placed dan smart object yang ditemukan
...
Pesan: Anda hanya dapat menyalin smart object yang disematkan
...
Tidak ada pesan sumber daya yang ditempatkan atau objek pintar yang ditemukan
...
Pesan indeks sumber daya yang ditempatkan salah
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| linkedPath | java.lang.String | Jalur tertaut. |
...
Membuat lapisan objek pintar baru dengan menyalin yang ini. Perhatikan bahwa untuk objek pintar yang disematkan, gambar yang disematkan dibagikan. Jika Anda ingin menyalin gambar yang disematkan, gunakan metode [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy).
...
Menyematkan objek pintar tertaut dalam lapisan ini.
...
Mengekspor konten yang tertanam atau tertaut ke sebuah file.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| filePath | java.lang.String | Jalur berkas ekspor. |
...
Ini mendapatkan atau mengatur render warp atau menggunakan gambar PS
...
Mendapatkan jenis konten lapisan objek pintar. Konten objek pintar yang disematkan adalah berkas gambar mentah yang disematkan:  LiFdDataSource.Data . Konten objek pintar yang ditautkan adalah konten mentah dari berkas gambar yang ditautkan jika tersedia: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Kami tidak mendukung pemuatan dari Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library ketika LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) bernilai true. Untuk berkas tautan biasa, pertama-tama kami menggunakan LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) untuk mencari berkas relatif terhadap jalur gambar sumber DataStreamSupporter.SourceImagePath, jika tidak tersedia kami mencari di LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), jika masih tidak ditemukan kami mencari berkas tautan di direktori yang sama dengan gambar kami: DataStreamSupporter.SourceImagePath.

Nilai: Jenis konten lapisan objek pintar.
...
Mengambil atau mengatur konten lapisan objek pintar. Konten objek pintar yang disematkan adalah berkas gambar mentah yang disematkan:  LiFdDataSource.Data  dan propertinya. Konten objek pintar yang ditautkan adalah konten mentah dari berkas gambar yang ditautkan jika tersedia dan propertinya: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Kami tidak mendukung pemuatan dari Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library ketika LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) bernilai true. Untuk berkas tautan biasa, pertama-tama kami menggunakan LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) untuk mencari berkas relatif terhadap jalur gambar sumber DataStreamSupporter.SourceImagePath, jika tidak tersedia kami mencari di LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), jika masih tidak ditemukan kami mencari berkas tautan di direktori yang sama dengan gambar kami: DataStreamSupporter.SourceImagePath.
...
Mendapatkan atau mengatur batas konten objek pintar.

Nilai: Batas objek pintar.
...
Mendapatkan atau mengatur sumber konten objek pintar.

Nilai: Sumber data objek pintar.
...
Ini mendapatkan atau mengatur ukuran terakhir gambar untuk warp.
...
Mendapatkan atau mengatur kuadrilateral asli.

Nilai: Kuadrilateral asli.
...
Mendapatkan indeks sumber daya lapisan yang ditempatkan dan pintar serta sumber daya yang ditempatkan dengan benar.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Sumber daya. |
| placedResourceIndex | int[] | Indeks sumber daya yang ditempatkan. |
| smartResourceIndex | int[] | Indeks sumber daya pintar. |
...
Mendapatkan sumber daya lapisan yang ditempatkan
...
Mendapatkan atau mengatur kuadrilateral transformasi.

Nilai: Transformasi kuadrilateral.
...
Ini mendapatkan fungsi yang membantu dengan warp
...
Ini mendapatkan atau mengatur parameter Warp yang telah diatur atau diambil dari sumber daya (default).
...
Mendapatkan konten gambar yang tertanam atau tertaut dari lapisan objek pintar.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Opsi. |
...
Buat lapisan objek pintar baru dengan menyalin yang ini. Reproduksi Layer -> Smart Objects -> New Smart Object melalui fungsi Copy pada Adobe\\ufffd Photoshop\\ufffd. Perhatikan bahwa ini hanya diaktifkan untuk objek pintar yang tersemat karena gambar tersemat juga disalin. Jika Anda ingin berbagi gambar tersemat, gunakan metode [.duplicateLayer](../../null/\\#duplicateLayer).
...
Panggil ketika kontainer dari [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) ini telah diatur.
...
Menyambungkan kembali objek pintar yang tertaut ke file baru. Tidak perlu memanggil metode UpdateModifiedContent setelahnya.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Gambar. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Gambar. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Pengaturan resolusi. Jika null, resolusi gambar yang akan digunakan. |
...
| --- | --- | --- |
| linkedPath | java.lang.String | Jalur tertaut. |
| isReplaceOnlyThis | boolean | Bendera menunjukkan penggantian konten dari Smart Layer ini atau ke semua Smart Layer dengan konten ini |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| nilai | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Memperbarui pengidentifikasi sumber data.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | Pengidentifikasi sumber data. |
...
Memperbarui cache gambar lapisan objek pintar dengan konten yang dimodifikasi.
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Gambar. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Resolusi. |
| skipBoundsUpdate | boolean | jika diatur ke true [skip bounds update]. |
...
Memperbarui sumber daya yang ditempatkan / pintar ketika placedResource diubah atau ketika konversi diperlukan.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| toEmbedded | boolean | jika diatur ke true mengonversi menjadi sumber daya tersemat jika diperlukan, jika tidak menjadi yang tertaut. |
...
Ini adalah pembungkus untuk "IWarpSupport" guna memperbarui pratinjau lapisan

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Piksel dan ukuran gambar pratinjau baru |
