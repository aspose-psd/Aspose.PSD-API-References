...
description: "Mendefinisikan kelas LnkeResource yang berisi informasi tentang file tautan eksternal atau aset dalam gambar format PSD."
type: docs
weight: 17
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Mendefinisikan kelas LnkeResource yang berisi informasi tentang file atau aset eksternal yang ditautkan dalam gambar format PSD. Sumber daya tautan dapat berisi beberapa instance [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource) yang dapat diakses melalui indeks. Ini adalah bagian dari API Manipulasi Format File PSD yang membantu memodifikasi file Adobe® Photoshop® secara programatis
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Menginisialisasi instance baru dari kelas [LnkeResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lnkeresource). |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Menginisialisasi instance baru dari kelas [LnkeResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lnkeresource). |
## Bidang
...
| [get_Item(int index)](#get-Item-int-) | Mendapatkan [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource) pada indeks yang ditentukan. |
...
Menginisialisasi instance baru dari kelas [LnkeResource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lnkeresource).
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Sumber data. |
...
Mendapatkan [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource) pada indeks yang ditentukan.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| index | int | Indeks. Nilai: [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource). |
