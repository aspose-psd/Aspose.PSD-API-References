...
description: "Mendefinisikan kelas LinkResource yang berisi informasi tentang file yang ditautkan atau disematkan dalam gambar format PSD."
type: docs
weight: 14
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
Mendefinisikan kelas LinkResource yang berisi informasi tentang file yang ditautkan atau disematkan dalam gambar format PSD. Sumber daya tautan dapat berisi beberapa instance [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) yang dapat diakses melalui indeks di kelas turunan mana pun.
## Bidang
...
| [get_Item(int index)](#get-Item-int-) | Mendapatkan [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) pada indeks yang ditentukan. |
...
Mendapatkan [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) pada indeks yang ditentukan.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| index | int | Indeks integer. Nilai: [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
