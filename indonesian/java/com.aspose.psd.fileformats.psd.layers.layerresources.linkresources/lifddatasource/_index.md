...
description: "Mendefinisikan kelas sumber data liFD dalam File PSD yang berisi informasi tentang file yang disematkan."
type: docs
weight: 10
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
Mendefinisikan kelas sumber data liFD dalam File PSD yang berisi informasi tentang file yang disematkan. Ini merupakan bagian dari API Manipulasi Format File PSD yang membantu memodifikasi file Adobe® Photoshop®.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | Menginisialisasi instance baru dari kelas [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) . |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Menginisialisasi instance baru dari kelas [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) . |
## Bidang
...
| [getData()](#getData--) | Mendapatkan atau mengatur data objek pintar yang disematkan dalam file PSD. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | Mendapatkan panjang data yang disematkan. |
...
| [setData(byte[] value)](#setData-byte---) | Mendapatkan atau mengatur data objek pintar yang disematkan dalam file PSD. |
...
Menginisialisasi instance baru dari kelas [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) .
...
Mendapatkan atau mengatur data objek pintar yang disematkan dalam file PSD.

Nilai: Data objek pintar yang disematkan.
...
Mendapatkan panjang data yang disematkan.

Nilai: Panjang data yang disematkan.
