...
type: docs
weight: 10
url: /id/java/com.aspose.psd.fileformats.psd.layers.layereffects/blendingoptions/
---
...
| Metode | Deskripsi |
| --- | --- |
| [addColorOverlay()](#addColorOverlay--) | Menambahkan lapisan warna. |
| [addDropShadow()](#addDropShadow--) | Menambahkan efek bayangan jatuh. |
| [addGradientOverlay()](#addGradientOverlay--) | Menambahkan lapisan Gradien. |
| [addInnerShadow()](#addInnerShadow--) | Menambahkan efek bayangan dalam. |
| [addOuterGlow()](#addOuterGlow--) | Menambahkan efek cahaya luar. |
| [addPatternOverlay()](#addPatternOverlay--) | Menambahkan lapisan Pola. |
| [addStroke(int fillType)](#addStroke-int-) | Menambahkan efek stroke. |
| [calculateBoundsWithEffects_internalized(Rectangle layerBounds, int globalAngle)](#calculateBoundsWithEffects-internalized-com.aspose.psd.Rectangle-int-) | Menghitung batas lapisan termasuk efek visual. |
...
| [getAreEffectsEnabled()](#getAreEffectsEnabled--) | Mendapatkan atau mengatur visibilitas semua efek lapisan. |
| [getClass()](#getClass--) |  |
| [getEffects()](#getEffects--) | Mendapatkan efek. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAreEffectsEnabled(boolean value)](#setAreEffectsEnabled-boolean-) | Mendapatkan atau mengatur visibilitas semua efek lapisan. |
| [setEffects(ILayerEffect[] value)](#setEffects-com.aspose.psd.fileformats.psd.layers.layereffects.ILayerEffect---) | Mendapatkan efek. |
| [setNewPatternToFillSettings_internalized(PatternFillSettings patternSettings)](#setNewPatternToFillSettings-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.PatternFillSettings-) | Membuat data pola baru dan menempatkannya ke dalam instance [PatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/patternfillsettings). |
| [toString()](#toString--) |  |
| [updateEffectsSources_internalized(LayerStyleFX layerStyle, PattResource pattResource)](#updateEffectsSources-internalized-com.aspose.internal.fileformats.psd.layers.layereffects.LayerStyleFX-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Memperbarui efek jika lebih baru. |
| [wait()](#wait--) |  |
...
Menambahkan efek stroke.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fillType | int | Tipe isian untuk mengisi goresan. |
...
Menghitung batas lapisan termasuk efek visual.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| layerBounds | [Rectangle](../../com.aspose.psd/rectangle) | Batas asli lapisan. |
| globalAngle | int | Sudut cahaya global yang digunakan untuk efek tertentu. |
...
Membuat data pola baru dan menempatkannya ke dalam instance [PatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/patternfillsettings).

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| patternSettings | [PatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/patternfillsettings) | Pengaturan isian pola. |
...
Memperbarui efek jika lebih baru.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| layerStyle | com.aspose.internal.fileformats.psd.layers.layereffects.LayerStyleFX | Gaya lapisan dengan efek. |
| pattResource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | Sumber daya patt. |
