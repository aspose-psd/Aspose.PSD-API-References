...
description: "Sumber daya Info Versi"
type: docs
weight: 41
url: /id/java/com.aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
Sumber daya Info Versi
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [VersionInfoResource()](#VersionInfoResource--) | Menginisialisasi instance baru dari kelas [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource). |
## Bidang
...
| [getFileVersion()](#getFileVersion--) | Mendapatkan atau mengatur versi file. |
...
| [getReaderName()](#getReaderName--) | Mendapatkan atau mengatur nama pembaca. |
...
| [getWriterName()](#getWriterName--) | Mendapatkan atau mengatur nama penulis. |
| [hasRealMergedData()](#hasRealMergedData--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini memiliki data gabungan nyata. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Menyimpan blok sumber daya ke aliran yang ditentukan. |
| [setFileVersion(long value)](#setFileVersion-long-) | Mendapatkan atau mengatur versi file. |
...
| [setReaderName(String value)](#setReaderName-java.lang.String-) | Mendapatkan atau mengatur nama pembaca. |
| [setRealMergedData(boolean value)](#setRealMergedData-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini memiliki data gabungan nyata. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Mendapatkan atau mengatur status blok sumber daya. |
| [setVersion(long value)](#setVersion-long-) | Mendapatkan atau mengatur versi. |
| [setWriterName(String value)](#setWriterName-java.lang.String-) | Mendapatkan atau mengatur nama penulis. |
| [toString()](#toString--) |  |
...
Menginisialisasi instance baru dari kelas [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource).
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini memiliki data gabungan nyata.

Nilai:  true  jika instance ini memiliki data gabungan nyata; jika tidak,  false .
