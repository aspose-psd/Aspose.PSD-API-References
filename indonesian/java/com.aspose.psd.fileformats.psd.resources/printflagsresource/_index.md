...
description: "Sumber daya bendera cetak"
type: docs
weight: 30
url: /id/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
Sumber daya bendera cetak
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Menginisialisasi sebuah instance baru dari kelas [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource). |
## Bidang
...
| [getBleedScale()](#getBleedScale--) | Mendapatkan atau mengatur skala bleed. |
| [getBleedWidth()](#getBleedWidth--) | Mendapatkan atau mengatur lebar bleed. |
| [getCenterCropMark()](#getCenterCropMark--) | Mendapatkan atau mengatur tanda pemotongan tengah. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Mendapatkan atau mengatur skala bleed. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Mendapatkan atau mengatur lebar bleed. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Mendapatkan atau mengatur tanda pemotongan tengah. |
...
Menginisialisasi sebuah instance baru dari kelas [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource).
...
Mendapatkan atau mengatur lebar bleed.
...
Mendapatkan atau mengatur tanda pemotongan tengah.

Nilai: Tanda pemotongan tengah.
