...
description: "Sumber daya tanda air"
type: docs
weight: 42
url: /id/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
Sumber daya tanda air
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | Menginisialisasi sebuah instance baru dari kelas [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource). |
## Bidang
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini adalah watermark. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini adalah watermark. |
| [toString()](#toString--) |  |
...
Menginisialisasi sebuah instance baru dari kelas [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource).
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah instance ini adalah watermark.

Nilai:  true  jika instance ini adalah watermark; jika tidak,  false .
