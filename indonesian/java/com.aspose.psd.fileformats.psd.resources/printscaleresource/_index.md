...
description: "Sumber daya Skala Cetak"
type: docs
weight: 31
url: /id/java/com.aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
Sumber daya Skala Cetak
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [PrintScaleResource()](#PrintScaleResource--) | Menginisialisasi sebuah instance baru dari kelas [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource). |
## Bidang
...
| [getXLocation()](#getXLocation--) | Mendapatkan atau mengatur lokasi x. |
| [getYLocation()](#getYLocation--) | Mendapatkan atau mengatur lokasi y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setScale(float value)](#setScale-float-) | Mendapatkan atau mengatur skala. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Mendapatkan atau mengatur status blok sumber daya. |
| [setStyle(short value)](#setStyle-short-) | Mendapatkan atau mengatur gaya. |
| [setXLocation(float value)](#setXLocation-float-) | Mendapatkan atau mengatur lokasi x. |
| [setYLocation(float value)](#setYLocation-float-) | Mendapatkan atau mengatur lokasi y. |
| [toString()](#toString--) |  |
...
Menginisialisasi sebuah instance baru dari kelas [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource).
