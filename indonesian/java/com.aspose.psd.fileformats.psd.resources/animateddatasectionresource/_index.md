...
description: "Sumber daya Plug-In Seksi Data Animasi."
type: docs
weight: 10
url: /id/java/com.aspose.psd.fileformats.psd.resources/animateddatasectionresource/
---
...
Sumber daya Plug-In Seksi Data Animasi.
## Bidang
...
| [getAnimatedDataSection()](#getAnimatedDataSection--) | Mendapatkan atau mengatur struktur bagian data animasi. |
| [getClass()](#getClass--) |  |
...
| [getKeyName()](#getKeyName--) | Nama kunci sumber daya. |
...
| [setAnimatedDataSection_internalized(AnimatedDataSectionStructure value)](#setAnimatedDataSection-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.AnimatedDataSectionStructure-) | Mendapatkan atau mengatur struktur bagian data animasi. |
| [setID(short value)](#setID-short-) | Mendapatkan atau mengatur pengidentifikasi unik untuk sumber daya. |
| [setKeyName_internalized(String value)](#setKeyName-internalized-java.lang.String-) | Nama kunci sumber daya. |
...
| [setRoll_internalized(RollStructure value)](#setRoll-internalized-com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure-) | Mendapatkan atau mengatur struktur roll. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Mendapatkan atau mengatur status blok sumber daya. |
| [setUnknownLeftBytes_internalized(byte[] value)](#setUnknownLeftBytes-internalized-byte---) | Byte tidak diketahui dari sumber daya asli. |
| [toString()](#toString--) |  |
...
Mendapatkan atau mengatur struktur roll.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| nilai | com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure |  |
...
Byte tidak diketahui dari sumber daya asli.
