...
description: "Sumber daya informasi grup lapisan"
type: docs
weight: 25
url: /id/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
Sumber daya informasi grup lapisan
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Menginisialisasi instance baru dari kelas [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Bidang
...
| [getGroups()](#getGroups--) | Mendapatkan atau mengatur grup. |
...
| [setGroups(short[] value)](#setGroups-short---) | Mendapatkan atau mengatur grup. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Memperbarui LinkGroupId pada lapisan dari properti Groups. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Memperbarui nilai pada properti Groups dari lapisan. |
...
Memperbarui LinkGroupId pada lapisan dari properti Groups.
...
Memperbarui nilai pada properti Groups dari lapisan.
