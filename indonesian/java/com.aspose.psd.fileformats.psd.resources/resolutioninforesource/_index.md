...
description: "Sumber daya info resolusi"
type: docs
weight: 33
url: /id/java/com.aspose.psd.fileformats.psd.resources/resolutioninforesource/
---
...
Sumber daya info resolusi
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [ResolutionInfoResource()](#ResolutionInfoResource--) | Menginisialisasi instance baru dari kelas [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Bidang
...
| [getHResDisplayUnit()](#getHResDisplayUnit--) | Unit tampilan untuk resolusi horizontal. |
| [getHeightDisplayUnit()](#getHeightDisplayUnit--) | Mendapatkan atau mengatur unit tampilan tinggi. |
...
| [getVDpi()](#getVDpi--) | DPI Vertikal. |
| [getVResDisplayUnit()](#getVResDisplayUnit--) | Unit tampilan untuk resolusi vertikal. |
| [getWidthDisplayUnit()](#getWidthDisplayUnit--) | Mendapatkan atau mengatur unit tampilan lebar. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setHResDisplayUnit(int value)](#setHResDisplayUnit-int-) | Unit tampilan untuk resolusi horizontal. |
| [setHeightDisplayUnit(int value)](#setHeightDisplayUnit-int-) | Mendapatkan atau mengatur unit tampilan tinggi. |
...
| [setVDpi(FixedPointDecimal value)](#setVDpi-com.aspose.psd.fileformats.psd.resources.FixedPointDecimal-) | DPI Vertikal. |
| [setVResDisplayUnit(int value)](#setVResDisplayUnit-int-) | Unit tampilan untuk resolusi vertikal. |
| [setWidthDisplayUnit(int value)](#setWidthDisplayUnit-int-) | Mendapatkan atau mengatur unit tampilan lebar. |
| [toString()](#toString--) |  |
...
Menginisialisasi instance baru dari kelas [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource).
...
Unit tampilan untuk resolusi horizontal. Ini hanya memengaruhi antarmuka pengguna; resolusi tetap disimpan dalam file PSD sebagai piksel/inci.

Nilai: Unit tampilan resolusi horizontal.
...
Mendapatkan atau mengatur unit tampilan tinggi.

Nilai: Unit tampilan tinggi.
...
Nilai: satuan tampilan resolusi vertikal.
