...
description: "Lapisan Penyesuaian Warna Selektif."
type: docs
weight: 28
url: /id/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Mendapatkan koreksi cmyk dengan warna selektif. |
| [getContainer()](#getContainer--) | Mendapatkan kontainer  Image  . |
| [getCorrectionMethod()](#getCorrectionMethod--) | Mendapatkan atau mengatur metode koreksi. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Memproses lapisan Warna Selektif. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Mengatur koreksi cmyk dengan warna selektif. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Menetapkan  Image  kontainer. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Mendapatkan atau mengatur metode koreksi. |
...
Mendapatkan koreksi cmyk dengan warna selektif.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| selectiveColorsType | int | Warna selektif. |
...
Mendapatkan atau mengatur metode koreksi.

Nilai: Metode koreksi.
...
Memproses lapisan Warna Selektif.
...
Mengatur koreksi cmyk dengan warna selektif.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| selectiveColorsType | int | Tipe warna selektif. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Koreksi Cmyk. |
