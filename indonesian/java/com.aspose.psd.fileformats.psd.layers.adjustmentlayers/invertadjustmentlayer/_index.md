...
description: "Kelas lapisan penyesuaian invert."
type: docs
weight: 21
url: /id/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
Kelas lapisan penyesuaian invert.
## Bidang
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Memproses invert adjustment layer. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Terapkan koreksi invert ke array int ARGB yang ditentukan. |
...
Memproses invert adjustment layer.
...
Terapkan koreksi invert ke array int ARGB yang ditentukan.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| piksel | int[] | Array int ARGB. |
