...
description: "Kelas ExpaResource."
type: docs
weight: 28
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
Kelas ExpaResource. Sumber dari Exposure Adjustment Layer
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | Menginisialisasi instance baru dari kelas [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | Menginisialisasi instance baru dari kelas [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | Menginisialisasi instance baru dari kelas [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
## Bidang
...
| [getExposure()](#getExposure--) | Mendapatkan atau mengatur exposure. |
| [getGammaCorrection()](#getGammaCorrection--) | Mendapatkan atau mengatur gamma. |
...
| [setExposure(float value)](#setExposure-float-) | Mendapatkan atau mengatur exposure. |
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Mendapatkan atau mengatur gamma. |
...
| [setOffset(float value)](#setOffset-float-) | Mendapatkan atau mengatur offset. |
...
Menginisialisasi instance baru dari kelas [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource).
...
Mendapatkan atau mengatur exposure.
...
Mendapatkan versi. Default adalah 1
