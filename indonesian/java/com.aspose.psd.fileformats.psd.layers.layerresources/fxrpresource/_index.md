...
description: "Kelas FxrpResource."
type: docs
weight: 32
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Menginisialisasi sebuah instance baru dari kelas [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Menginisialisasi sebuah instance baru dari kelas [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Menginisialisasi sebuah instance baru dari kelas [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Bidang
...
| [getX()](#getX--) | Mendapatkan atau mengatur x dari titik referensi |
| [getY()](#getY--) | Mendapatkan atau mengatur y dari titik referensi |
| [hashCode()](#hashCode--) |  |
...
| [setX(double value)](#setX-double-) | Mendapatkan atau mengatur x dari titik referensi |
| [setY(double value)](#setY-double-) | Mendapatkan atau mengatur y dari titik referensi |
...
Menginisialisasi sebuah instance baru dari kelas [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).
...
Menginisialisasi sebuah instance baru dari kelas [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Dengan nilai khusus atau tidak diketahui
