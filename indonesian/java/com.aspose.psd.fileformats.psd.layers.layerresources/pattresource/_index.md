...
description: "Kelas PattResource."
type: docs
weight: 66
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
| --- | --- |
| [PattResource()](#PattResource--) | Menginisialisasi sebuah instance baru dari kelas [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Menginisialisasi sebuah instance baru dari kelas [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
## Bidang
...
| [TypeToolKey](#TypeToolKey) | Kunci info alat tipe 'Patt' untuk 8-bit. |
| [TypeToolKey2](#TypeToolKey2) | Kunci info alat tipe 'Pat2' untuk 16-bit. |
| [TypeToolKey3](#TypeToolKey3) | Kunci info alat tipe 'Pat3' untuk 32-bit. |
| [ventureLicense_internalized](#ventureLicense-internalized) | Lisensi usaha. |
## Metode

| Metode | Deskripsi |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Memperbarui sumber daya Patt dengan data default. |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | Membuat sumber daya default yang tidak kosong. |
...
| [getPatterns()](#getPatterns--) | Mendapatkan atau mengatur data pola; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Mendapatkan atau mengatur data pola; |
| [toString()](#toString--) | Mengembalikan String yang mewakili instance ini. |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | Mencari item data pola dan memperbaruinya dengan yang baru, jika tidak, menambahkan yang baru ke akhir array. |
| [wait()](#wait--) |  |
...
Menginisialisasi sebuah instance baru dari kelas [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource).
...
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | Data pola. |
...
Kunci info alat tipe 'Patt' untuk 8-bit.
...
Kunci info alat tipe 'Pat2' untuk 16-bit.
...
Memperbarui sumber daya Patt dengan data default.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | Sumber daya. |
...
Membuat sumber daya default yang tidak kosong.
...
Mencari item data pola dan memperbaruinya dengan yang baru, jika tidak, menambahkan yang baru ke akhir array.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | Objek pengaturan pola untuk memperbarui item pola. |
