...
description: "Sumber daya lapisan lsdk sumber daya bagian lapisan bersarang."
type: docs
weight: 56
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Menginisialisasi instance baru dari kelas [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Menginisialisasi instance baru dari kelas [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
## Bidang
...
Menginisialisasi instance baru dari kelas [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource).
