...
description: "Sumber daya bagian lapisan."
type: docs
weight: 43
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Menginisialisasi sebuah instance baru dari kelas [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Menginisialisasi sebuah instance baru dari kelas [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Bidang
...
| [getSectionType()](#getSectionType--) | Mendapatkan atau mengatur tipe bagian. |
| [getSignature()](#getSignature--) | Mendapatkan tanda tangan sumber daya lapisan. |
| [getSubtype()](#getSubtype--) | Mendapatkan atau mengatur subtipe. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Mendapatkan atau mengatur tipe bagian. |
| [setSubtype(int value)](#setSubtype-int-) | Mendapatkan atau mengatur subtipe. |
...
Menginisialisasi sebuah instance baru dari kelas [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
Mendapatkan atau mengatur tipe bagian.
