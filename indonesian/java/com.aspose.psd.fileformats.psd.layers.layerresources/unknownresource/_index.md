...
description: "Sumber daya yang tidak diketahui."
type: docs
weight: 82
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
Sumber daya yang tidak diketahui.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Menginisialisasi instance baru dari kelas [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource). |
## Bidang
...
Menginisialisasi instance baru dari kelas [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource).
