...
description: "Kelas PhflResource."
type: docs
weight: 69
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/
---
...
Kelas PhflResource. Sumber dari Exposure Adjustment Layer 2 Versi ( = 3 ) atau ( = 2 ) 12 4 byte masing-masing untuk warna XYZ (Hanya di Versi 3) 10 2 byte ruang warna diikuti oleh 4 \* 2 byte komponen warna (Hanya di Versi 2) 4 Kepadatan 1 Pertahankan Luminositas
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [PhflResourceVersion2()](#PhflResourceVersion2--) | Menginisialisasi instance baru dari kelas [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2). |
| [PhflResourceVersion2(byte[] data)](#PhflResourceVersion2-byte---) | Menginisialisasi instance baru dari kelas [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2). |
## Bidang
...
| [getComponentA()](#getComponentA--) | Mendapatkan atau mengatur komponen A dari warna |
| [getComponentB()](#getComponentB--) | Mendapatkan atau mengatur komponen B |
| [getComponentL()](#getComponentL--) | Mendapatkan atau mengatur komponen L dari warna |
| [getData()](#getData--) | Mendapatkan atau mengatur data. |
| [getDensity()](#getDensity--) | Mendapatkan atau mengatur kepadatan. |
...
| [getPreserveLuminosity()](#getPreserveLuminosity--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [preserve luminosity]. |
| [getPsdVersion()](#getPsdVersion--) | Mendapatkan versi PSD minimal yang diperlukan untuk sumber daya lapisan. |
| [getRgbColor()](#getRgbColor--) | Mendapatkan warna. |
...
| [setColorSpace(short value)](#setColorSpace-short-) | Mendapatkan ruang warna. |
| [setComponentA(short value)](#setComponentA-short-) | Mendapatkan atau mengatur komponen A dari warna |
| [setComponentB(short value)](#setComponentB-short-) | Mendapatkan atau mengatur komponen B |
| [setComponentL(short value)](#setComponentL-short-) | Mendapatkan atau mengatur komponen L dari warna |
| [setDensity(int value)](#setDensity-int-) | Mendapatkan atau mengatur kepadatan. |
...
| [setPreserveLuminosity(boolean value)](#setPreserveLuminosity-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [preserve luminosity]. |
| [setRgbColor(Color color)](#setRgbColor-com.aspose.psd.Color-) | Mengatur warna RGB. |
...
Menginisialisasi instance baru dari kelas [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2).
...
Mendapatkan atau mengatur komponen A dari warna
...
Nilai:  true  jika [preserve luminosity]; sebaliknya,  false .
