...
description: "Sumber daya Filter Effects berisi saluran, masker pengguna, dan masker lembar untuk filter pintar."
type: docs
weight: 29
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
Sumber daya Efek Filter berisi saluran, masker pengguna, dan masker lembar untuk filter pintar.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Menginisialisasi instance baru dari kelas [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource). |
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | Kunci info alat tipe FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | Kunci info alat tipe FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Mendapatkan masker efek filter. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Mendapatkan masker efek filter. |
...
Menginisialisasi instance baru dari kelas [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource).
...
| version | int | Versi. |
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Masker efek filter. |
