...
description: "Kelas BritResource."
type: docs
weight: 17
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/britresource/
---
...
| --- | --- |
| [BritResource()](#BritResource--) | Menginisialisasi sebuah instance baru dari kelas [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). |
| [BritResource(short brightness, short contrast, short meanValueForBrightnessAndContrast, boolean labColor)](#BritResource-short-short-short-boolean-) | Menginisialisasi sebuah instance baru dari kelas [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). |
| [BritResource(byte[] bytes)](#BritResource-byte---) | Menginisialisasi sebuah instance baru dari kelas [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). |
## Bidang
...
| [getLabColor()](#getLabColor--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [lab color]. |
...
| [setBrightness(short value)](#setBrightness-short-) | Mendapatkan atau mengatur brightness. |
| [setContrast(short value)](#setContrast-short-) | Mendapatkan atau mengatur kontras. |
...
| [setLabColor(boolean value)](#setLabColor-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [lab color]. |
| [setMeanValueForBrightnessAndContrast(short value)](#setMeanValueForBrightnessAndContrast-short-) | Mendapatkan atau mengatur nilai rata-rata untuk kecerahan dan kontras. |
...
Menginisialisasi sebuah instance baru dari kelas [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource).
...
| meanValueForBrightnessAndContrast | short | Nilai rata-rata untuk kecerahan dan kontras. |
| labColor | boolean | jika diatur ke  true  [lab color]. |
...
Menginisialisasi sebuah instance baru dari kelas [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). Spesifikasi format PSD berisi deskripsi berikut: 2 Kecerahan 2 Kontras 2 Nilai rata-rata untuk kecerahan dan kontras 1 Hanya warna Lab. Tidak digunakan dalam PSD modern (CS5 ke atas) dimana CgEd digunakan. CgEd menyimpan properti info.
...
Nilai:  true  jika [lab color]; selainnya,  false .
