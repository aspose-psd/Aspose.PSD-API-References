...
description: "Kelas ClblResource."
type: docs
weight: 20
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Kelas ClblResource. Sumber daya ini berisi informasi tentang pencampuran elemen terklip.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [ClblResource()](#ClblResource--) | Menginisialisasi sebuah instance baru dari kelas [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Menginisialisasi sebuah instance baru dari kelas [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Menginisialisasi sebuah instance baru dari kelas [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Bidang
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [blend clipped elements]. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah nilai [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) adalah true atau false |
| [hashCode()](#hashCode--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [blend clipped elements]. |
...
| [setValue(boolean value)](#setValue-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah nilai [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) adalah true atau false |
...
Menginisialisasi sebuah instance baru dari kelas [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
Menginisialisasi instance baru dari kelas [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). Dengan nilai khusus atau tidak diketahui
...
Nilai:  true  jika [blend clipped elements]; selainnya,  false .
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah nilai [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) adalah true atau false

Nilai: true jika nilai adalah true; jika tidak, false.
