...
description: "Kelas LyidResource."
type: docs
weight: 59
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | Menginisialisasi sebuah instance baru dari kelas [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | Menginisialisasi sebuah instance baru dari kelas [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
## Bidang
...
| [getValue()](#getValue--) | Mendapatkan nilai. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Menyimpan ke kontainer aliran yang ditentukan. |
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | Mendapatkan nilai. |
...
Menginisialisasi sebuah instance baru dari kelas [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource).
...
Menginisialisasi sebuah instance baru dari kelas [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). Dengan nilai khusus atau tidak diketahui.
