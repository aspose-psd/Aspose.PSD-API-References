...
description: "Bagian dengan data animasi."
type: docs
weight: 11
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Bidang | Deskripsi |
| --- | --- |
| [StructureKey](#StructureKey) | Mengidentifikasi kunci struktur dari AnDs. |
## Metode
...
| [getItems()](#getItems--) | Mendapatkan atau mengatur struktur bagian data animasi. |
| [getKey()](#getKey--) | Mendapatkan kunci struktur. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Mendapatkan atau mengatur ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Mendapatkan atau mengatur versi deskriptor. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Mendapatkan atau mengatur struktur bagian data animasi. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Mendapatkan atau mengatur byte tidak dikenal 3 yang ada ketika jumlah frame ganjil. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Mengidentifikasi kunci struktur dari AnDs.
...
Memeriksa bahwa jumlah frame dalam struktur daftar 'FrIn' adalah ganjil.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| item | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Mendapatkan atau mengatur ClassID.
...
Mendapatkan atau mengatur byte tidak dikenal 3 yang ada ketika jumlah frame ganjil.
