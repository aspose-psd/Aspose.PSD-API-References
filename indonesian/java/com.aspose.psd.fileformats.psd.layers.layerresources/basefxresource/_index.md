...
description: "Sumber daya efek dasar"
type: docs
weight: 12
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
Sumber daya efek dasar
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Menginisialisasi instance baru dari kelas [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource). |
## Bidang
...
Menginisialisasi instance baru dari kelas [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource).

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| resourceKey | int | Kunci sumber daya. |
