...
description: "Kelas lnsrResource."
type: docs
weight: 51
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Menginisialisasi instance baru dari kelas [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Menginisialisasi instance baru dari kelas [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Bidang
...
| [getValue()](#getValue--) | Mendapatkan nilai sebagai LnsrResourceType jika enum yang sesuai dijelaskan. |
| [hashCode()](#hashCode--) |  |
...
Menginisialisasi instance baru dari kelas [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| lnsrResourceType | int | Tipe dari LNSR. |
...
Menginisialisasi instance baru dari kelas [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). Dengan nilai khusus atau tidak diketahui
...
Nilai: Nilai sebagai LnsrResourceType
