...
description: "Enum com.aspose.psd.InterpolationMode menentukan algoritma yang digunakan saat gambar diperbesar atau diputar."
type: docs
weight: 63
url: /id/java/com.aspose.psd/interpolationmode/
---
...
Enumerasi  com.aspose.psd.InterpolationMode  menentukan algoritma yang digunakan ketika gambar diubah skala atau diputar.
## Bidang
...
| [HighQualityBicubic](#HighQualityBicubic) | Menentukan interpolasi berkualitas tinggi, bikubik. |
| [HighQualityBilinear](#HighQualityBilinear) | Menentukan interpolasi bilinear berkualitas tinggi. |
| [Invalid](#Invalid) | Mode interpolasi tidak valid. |
| [Low](#Low) | Menentukan interpolasi berkualitas rendah. |
...
Menentukan interpolasi bikubik. Tidak ada pra‑penyaringan yang dilakukan. Mode ini tidak cocok untuk memperkecil gambar di bawah 25 persen dari ukuran aslinya.
...
Menentukan interpolasi bilinear. Tidak ada pra‑penyaringan yang dilakukan. Mode ini tidak cocok untuk memperkecil gambar di bawah 50 persen dari ukuran aslinya.
...
Menentukan interpolasi bikubik berkualitas tinggi. Pra‑penyaringan dilakukan untuk memastikan pengecilan berkualitas tinggi. Mode ini menghasilkan gambar tertransformasi dengan kualitas tertinggi.
...
Menentukan interpolasi bilinear berkualitas tinggi. Pra‑penyaringan dilakukan untuk memastikan pengecilan berkualitas tinggi.
...
Menentukan interpolasi berkualitas rendah.
