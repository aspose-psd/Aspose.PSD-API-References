...
description: "Operasi untuk bentuk jalur yang menggabungkan operasi Boolean."
type: docs
weight: 15
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| Bidang | Deskripsi |
| --- | --- |
| [CombineShapes](#CombineShapes) | Gabungkan Bentuk (operasi OR). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | Kecualikan Bentuk yang Tumpang Tindih (operasi XOR). |
| [IntersectShapeAreas](#IntersectShapeAreas) | Interseksi Area Bentuk (operasi AND). |
| [SubtractFrontShape](#SubtractFrontShape) | Kurangi Bentuk Depan (operasi NOT). |
## Metode
...
Gabungkan Bentuk (operasi OR). Ini adalah nilai default di Photoshop.
...
Kecualikan Bentuk yang Tumpang Tindih (operasi XOR).
...
Interseksi Area Bentuk (operasi AND).
...
Kurangi Bentuk Depan (operasi NOT).
