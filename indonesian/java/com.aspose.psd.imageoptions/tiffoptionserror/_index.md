...
description: "Kode kesalahan opsi tiff."
type: docs
weight: 26
url: /id/java/com.aspose.psd.imageoptions/tiffoptionserror/
---
...
Kode kesalahan opsi tiff.
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [Baseline6OptionsMismatch](#Baseline6OptionsMismatch) | Parameter opsi TIFF yang ditentukan tidak sesuai dengan standar TIFF Baseline 6.0 |
| [ColorMapLengthInvalid](#ColorMapLengthInvalid) | Panjang peta warna tidak valid. |
| [CompressionSppMismatch](#CompressionSppMismatch) | Kompressi tidak cocok dengan jumlah sampel per piksel. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NoColorMap](#NoColorMap) | Peta warna tidak didefinisikan. |
| [NoError](#NoError) | Tidak ada kode kesalahan. |
| [NotSupportedAlphaStorage](#NotSupportedAlphaStorage) | Penyimpanan alfa tidak didukung. |
| [PhotometricBitsPerSampleMismatch](#PhotometricBitsPerSampleMismatch) | Bit fotometrik per sampel tidak valid |
| [PhotometricCompressionMismatch](#PhotometricCompressionMismatch) | Kompressi tidak cocok dengan pengaturan fotometrik. |
| [PhotometricSppMismatch](#PhotometricSppMismatch) | Fotometrik tidak cocok dengan jumlah sampel per piksel. |
## Metode
...
Parameter opsi TIFF yang ditentukan tidak sesuai dengan standar TIFF Baseline 6.0
...
Panjang peta warna tidak valid.
...
Kompressi tidak cocok dengan jumlah sampel per piksel.
...
Peta warna tidak didefinisikan.
...
Penyimpanan alfa tidak didukung.
...
Bit fotometrik per sampel tidak valid
...
Kompressi tidak cocok dengan pengaturan fotometrik.
...
Fotometrik tidak cocok dengan jumlah sampel per piksel.
