...
description: "Mendefinisikan kelas SoLdResource yang berisi informasi tentang lapisan objek pintar dalam file PSD."
type: docs
weight: 15
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Menginisialisasi instance baru dari kelas [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | Menginisialisasi instance baru dari kelas [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [AntiAliasPolicyKey_internalized](#AntiAliasPolicyKey-internalized) | Kunci kebijakan anti alias |
| [BottomKey_internalized](#BottomKey-internalized) | Kunci bawah |
| [BoundsKey_internalized](#BoundsKey-internalized) | Kunci batas |
| [CompIdKey_internalized](#CompIdKey-internalized) | Nama kunci dari CompID |
| [CompInfoKey_internalized](#CompInfoKey-internalized) | Nama kunci informasi comp |
| [CompKey_internalized](#CompKey-internalized) | Kunci comp |
| [CompNoneValue_internalized](#CompNoneValue-internalized) | Nilai comp yang berarti 'none' |
| [CropKey_internalized](#CropKey-internalized) | Kunci pemotongan |
...
| [DenominatorKey_internalized](#DenominatorKey-internalized) | Kunci penyebut |
| [DurationKey_internalized](#DurationKey-internalized) | Kunci durasi |
...
| [FrameCountKey_internalized](#FrameCountKey-internalized) | Kunci jumlah frame |
| [FrameStepKey_internalized](#FrameStepKey-internalized) | Kunci langkah frame |
| [HeightKey_internalized](#HeightKey-internalized) | Kunci tinggi |
| [HorizontalIdName_internalized](#HorizontalIdName-internalized) | Nama pengidentifikasi horizontal |
| [IdentKey_internalized](#IdentKey-internalized) | Kunci pengidentifikasi unik |
| [ItemsPropertyCannotBeNull_internalized](#ItemsPropertyCannotBeNull-internalized) | Properti items tidak boleh null |
| [LeftKey_internalized](#LeftKey-internalized) | Kunci kiri |
| [MeshPointsKeyName_internalized](#MeshPointsKeyName-internalized) | Nama kunci titik mesh |
| [NonAffineTransformKey_internalized](#NonAffineTransformKey-internalized) | Kunci transformasi non afine |
| [NullClassId_internalized](#NullClassId-internalized) | Pengidentifikasi kelas null |
| [NumeratorKey_internalized](#NumeratorKey-internalized) | Kunci pembilang |
| [OptionalKeys_internalized](#OptionalKeys-internalized) | Koleksi kunci opsional |
| [OrientationIdName_internalized](#OrientationIdName-internalized) | Nama pengidentifikasi orientasi |
| [OriginalCompIdKey_internalized](#OriginalCompIdKey-internalized) | Nama kunci dari CompID asli |
| [PageNumberKey_internalized](#PageNumberKey-internalized) | Kunci nomor halaman |
| [PlacedIdKey_internalized](#PlacedIdKey-internalized) | Kunci pengidentifikasi yang ditempatkan |
...
| [ResolutionKey_internalized](#ResolutionKey-internalized) | Kunci resolusi |
| [ResourceSignature](#ResourceSignature) | Tanda tangan sumber daya umum. |
| [RightKey_internalized](#RightKey-internalized) | Kunci kanan |
| [SizeKey_internalized](#SizeKey-internalized) | Kunci ukuran |
...
| [SmartVersionValue_internalized](#SmartVersionValue-internalized) | Nilai versi sumber daya objek pintar yang diharapkan. |
| [TopKey_internalized](#TopKey-internalized) | Kunci atas |
| [TotalPagesKey_internalized](#TotalPagesKey-internalized) | Kunci total halaman |
| [TransformKey_internalized](#TransformKey-internalized) | Kunci transformasi |
| [TransformValueCount_internalized](#TransformValueCount-internalized) | Jumlah nilai transformasi |
| [TypeKey_internalized](#TypeKey-internalized) | Kunci tipe |
| [TypeToolKey](#TypeToolKey) | Kunci info alat tipe: 'SoLd'. |
| [TypeValue_internalized](#TypeValue-internalized) | Nilai tipe yang diharapkan. |
...
| [WidthKey_internalized](#WidthKey-internalized) | Kunci lebar |
| [YouCannotAccessCropPropertyMessage_internalized](#YouCannotAccessCropPropertyMessage-internalized) | Anda tidak dapat mengakses properti Crop |
| [YouCannotSetCompIdPropertyMessage_internalized](#YouCannotSetCompIdPropertyMessage-internalized) | Anda tidak dapat mengatur properti CompId |
| [YouCannotSetCompPropertyMessage_internalized](#YouCannotSetCompPropertyMessage-internalized) | Anda tidak dapat mengatur properti Comp |
| [YouCannotSetOriginalCompIdPropertyMessage_internalized](#YouCannotSetOriginalCompIdPropertyMessage-internalized) | Anda tidak dapat mengatur properti OriginalCompId |
...
| [convertListStructureToDoubleArray_internalized(ListStructure list)](#convertListStructureToDoubleArray-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures.ListStructure-) | Mengonversi struktur daftar menjadi array double. |
...
| [getAntiAliasPolicy()](#getAntiAliasPolicy--) | Mendapatkan atau mengatur kebijakan anti alias dari data lapisan objek pintar dalam gambar PSD. |
...
| [getClass()](#getClass--) |  |
| [getComp()](#getComp--) | Mendapatkan atau mengatur nilai comp dari data lapisan objek pintar dalam file PSD. |
...
| [getCrop()](#getCrop--) | Mendapatkan atau mengatur crop dari data lapisan objek pintar dalam gambar PSD. |
...
| [getDurationDenominator()](#getDurationDenominator--) | Mendapatkan atau mengatur penyebut durasi. |
| [getDurationNumerator()](#getDurationNumerator--) | Mendapatkan atau mengatur pembilang durasi. |
| [getFrameCount()](#getFrameCount--) | Mendapatkan atau mengatur jumlah frame dari data lapisan objek pintar dalam file PSD. |
| [getFrameStepDenominator()](#getFrameStepDenominator--) | Mendapatkan atau mengatur penyebut langkah frame. |
| [getFrameStepNumerator()](#getFrameStepNumerator--) | Mendapatkan atau mengatur pembilang langkah frame. |
| [getHeader_internalized()](#getHeader-internalized--) | Mendapatkan atau mengatur header. |
| [getHeight()](#getHeight--) | Mendapatkan atau mengatur tinggi. |
...
| [getItems()](#getItems--) | Mendapatkan atau mengatur item deskriptor dari data lapisan objek pintar dalam file PSD. |
...
| [getLength()](#getLength--) | Mendapatkan panjang sumber daya smart object dalam byte. |
| [getNonAffineTransformMatrix()](#getNonAffineTransformMatrix--) | Mendapatkan atau mengatur matriks transformasi non-afine dari data lapisan smart object dalam file PSD. |
...
| [getPageNumber()](#getPageNumber--) | Mendapatkan atau mengatur nomor halaman dari data lapisan smart object dalam file PSD. |
...
| [getPlacedId()](#getPlacedId--) | Mendapatkan atau mengatur pengidentifikasi unik dari data lapisan smart object ini dalam gambar PSD. |
| [getPlacedId_internalized()](#getPlacedId-internalized--) |  |
| [getPlacedLayerType()](#getPlacedLayerType--) | Mendapatkan atau mengatur tipe dari data lapisan smart object dalam file PSD. |
...
| [getResolution()](#getResolution--) | Mendapatkan atau mengatur resolusi dari data lapisan smart object dalam file PSD. |
| [getResolutionUnit()](#getResolutionUnit--) | Mendapatkan atau mengatur satuan ukuran resolusi dari data lapisan smart object dalam file PSD. |
...
| [getTotalPages()](#getTotalPages--) | Mendapatkan atau mengatur total jumlah halaman dari data lapisan smart object dalam file PSD. |
| [getTransformMatrix()](#getTransformMatrix--) | Mendapatkan atau mengatur matriks transformasi dari data lapisan smart object dalam file PSD. |
| [getUOrder()](#getUOrder--) | Mendapatkan atau mengatur nilai urutan U dari lapisan yang ditempatkan dalam file PSD. |
| [getUniqueId()](#getUniqueId--) | Mendapatkan atau mengatur pengidentifikasi unik global dari data lapisan smart object [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) dalam gambar PSD. |
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Item warp. |
| [getWarpVersion_internalized()](#getWarpVersion-internalized--) | Mendapatkan atau mengatur versi warp. |
| [getWidth()](#getWidth--) | Mendapatkan atau mengatur lebar. |
...
| [initializeBounds_internalized(Rectangle bounds)](#initializeBounds-internalized-com.aspose.psd.Rectangle-) | Menginisialisasi batas dan matriks. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Menyimpan sumber daya smart object ke kontainer aliran yang ditentukan. |
...
| [setAntiAliasPolicy(int value)](#setAntiAliasPolicy-int-) | Mendapatkan atau mengatur kebijakan anti alias dari data lapisan objek pintar dalam gambar PSD. |
...
| [setComp(int value)](#setComp-int-) | Mendapatkan atau mengatur nilai comp dari data lapisan objek pintar dalam file PSD. |
...
| [setCrop(int value)](#setCrop-int-) | Mendapatkan atau mengatur crop dari data lapisan objek pintar dalam gambar PSD. |
...
| [setDurationDenominator(int value)](#setDurationDenominator-int-) | Mendapatkan atau mengatur penyebut durasi. |
| [setDurationNumerator(int value)](#setDurationNumerator-int-) | Mendapatkan atau mengatur pembilang durasi. |
| [setFrameCount(int value)](#setFrameCount-int-) | Mendapatkan atau mengatur jumlah frame dari data lapisan objek pintar dalam file PSD. |
| [setFrameStepDenominator(int value)](#setFrameStepDenominator-int-) | Mendapatkan atau mengatur penyebut langkah frame. |
| [setFrameStepNumerator(int value)](#setFrameStepNumerator-int-) | Mendapatkan atau mengatur pembilang langkah frame. |
...
| [setHeight(double value)](#setHeight-double-) | Mendapatkan atau mengatur tinggi. |
...
| [setItems(OSTypeStructure[] value)](#setItems-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Mendapatkan atau mengatur item deskriptor dari data lapisan objek pintar dalam file PSD. |
| [setLeft(double value)](#setLeft-double-) | Mendapatkan atau mengatur lokasi kiri lapisan yang ditempatkan dalam file PSD. |
| [setNonAffineTransformMatrix(double[] value)](#setNonAffineTransformMatrix-double---) | Mendapatkan atau mengatur matriks transformasi non-afine dari data lapisan smart object dalam file PSD. |
| [setOriginalCompId_internalized(int value)](#setOriginalCompId-internalized-int-) | Mendapatkan ID asli dari Comp yang saat ini dipilih untuk dokumen anak, yang akan menjadi -1 jika tidak ada yang dipilih. |
| [setPageNumber(int value)](#setPageNumber-int-) | Mendapatkan atau mengatur nomor halaman dari data lapisan smart object dalam file PSD. |
...
| [setPlacedId(UUID value)](#setPlacedId-java.util.UUID-) | Mendapatkan atau mengatur pengidentifikasi unik dari data lapisan smart object ini dalam gambar PSD. |
| [setPlacedId_internalized(System.Guid value)](#setPlacedId-internalized-com.aspose.ms.System.Guid-) |  |
| [setPlacedLayerType(int value)](#setPlacedLayerType-int-) | Mendapatkan atau mengatur tipe dari data lapisan smart object dalam file PSD. |
| [setResolution(double value)](#setResolution-double-) | Mendapatkan atau mengatur resolusi dari data lapisan smart object dalam file PSD. |
| [setResolutionUnit(int value)](#setResolutionUnit-int-) | Mendapatkan atau mengatur satuan ukuran resolusi dari data lapisan smart object dalam file PSD. |
...
| [setTotalPages(int value)](#setTotalPages-int-) | Mendapatkan atau mengatur total jumlah halaman dari data lapisan smart object dalam file PSD. |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | Mendapatkan atau mengatur matriks transformasi dari data lapisan smart object dalam file PSD. |
| [setUOrder(int value)](#setUOrder-int-) | Mendapatkan atau mengatur nilai urutan U dari lapisan yang ditempatkan dalam file PSD. |
| [setUniqueId(UUID value)](#setUniqueId-java.util.UUID-) | Mendapatkan atau mengatur pengidentifikasi unik global dari data lapisan smart object [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) dalam gambar PSD. |
...
| [setWidth(double value)](#setWidth-double-) | Mendapatkan atau mengatur lebar. |
...
Menginisialisasi instance baru dari kelas [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Diperlukan untuk mengatur properti Items atau memanggil InitializeItems() guna mendapatkan instance yang siap. Konstruktor ini dirancang untuk digunakan oleh [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) dan dalam pengujian unit. Gunakan [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) untuk membuat kelas SoLdResource.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| uniqueId | java.util.UUID | Pengidentifikasi unik dari data lapisan objek pintar [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Menginisialisasi instance baru dari kelas [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Konstruktor default ini dirancang untuk digunakan oleh SoLdResourceLoader. Gunakan [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) untuk membuat kelas SoLdResource.
...
Properti items tidak boleh null
...
Kunci pengidentifikasi yang ditempatkan
...
Nilai versi sumber daya objek pintar yang diharapkan.
...
Anda tidak dapat mengakses properti Crop
...
Anda tidak dapat mengatur properti CompId
...
Anda tidak dapat mengatur properti Comp
...
Anda tidak dapat mengatur properti OriginalCompId
...
Mengonversi struktur daftar menjadi array double.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| list | [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) | Instansi  ListStructure  . |

**Returns:**
double[] - Array  double[]  yang dibuat.
### create_internalized(System.Guid uniqueId, boolean isCustom, boolean hasCompInfo) {#create-internalized-com.aspose.ms.System.Guid-boolean-boolean-}
```
...
Nilai: Kebijakan anti alias dari data lapisan smart object.
...
Mendapatkan atau mengatur nilai comp dari data lapisan smart object dalam file PSD.  Layer comps in Smart Objects

Nilai: Nilai comp, adalah -1 jika tidak ada.
...
Mendapatkan atau mengatur crop dari data lapisan objek pintar dalam gambar PSD.

Nilai: Nilai crop dari informasi lapisan yang ditempatkan.
...
Mendapatkan atau mengatur jumlah frame dari data lapisan objek pintar dalam file PSD.

Nilai: Jumlah frame dari informasi lapisan yang ditempatkan.
...
Mendapatkan atau mengatur pembilang langkah frame.

Nilai: Pembilang langkah bingkai.
...
Mendapatkan atau mengatur item deskriptor dari data lapisan objek pintar dalam file PSD.

Nilai: Item deskriptor dari informasi lapisan yang ditempatkan.
...
Mendapatkan panjang sumber daya smart object dalam byte.
...
Mendapatkan atau mengatur matriks transformasi non-afine dari data lapisan smart object dalam file PSD.

Nilai: Matriks transformasi non-afin dari lapisan objek pintar.
...
Mendapatkan ID asli dari Comp yang saat ini dipilih untuk dokumen anak, yang akan bernilai -1 jika tidak ada yang dipilih. Properti ini mendapatkan pengidentifikasi pilihan Comp lapisan asli untuk lapisan objek pintar dalam file PSD.  Layer comps dalam Smart Objects

Nilai: ID asli dari comp yang saat ini dipilih untuk dokumen anak dalam gambar PSD, yang akan bernilai -1 jika tidak ada yang dipilih.
...
Mendapatkan atau mengatur nomor halaman dari data lapisan smart object dalam file PSD.

Nilai: Nomor halaman data lapisan objek pintar.
...
Mendapatkan atau mengatur pengidentifikasi unik dari data lapisan smart object ini dalam gambar PSD.

Nilai: Pengidentifikasi unik dari sumber daya lapisan objek pintar ini.
...
Mendapatkan atau mengatur tipe dari data lapisan smart object dalam file PSD.

Nilai: Tipe data lapisan objek pintar.
...
Mendapatkan atau mengatur resolusi dari data lapisan smart object dalam file PSD.

Nilai: Resolusi lapisan objek pintar.
...
Mendapatkan atau mengatur satuan ukuran resolusi dari data lapisan smart object dalam file PSD.

Nilai: Satuan ukuran resolusi lapisan objek pintar.
...
Mendapatkan atau mengatur total jumlah halaman dari data lapisan smart object dalam file PSD.

Nilai: Jumlah total halaman data lapisan objek pintar.
...
Mendapatkan atau mengatur matriks transformasi dari data lapisan smart object dalam file PSD.

Nilai: Matriks transformasi data lapisan objek pintar.
...
Mendapatkan atau mengatur pengidentifikasi unik global dari data lapisan smart object [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) dalam gambar PSD.

Nilai: Pengidentifikasi unik global dari data lapisan objek pintar [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource).
...
Menginisialisasi batas dan matriks.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Batasnya. |
...
Menyimpan sumber daya smart object ke kontainer aliran yang ditentukan.
