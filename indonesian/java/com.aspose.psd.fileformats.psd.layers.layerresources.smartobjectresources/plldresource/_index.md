...
description: "Mendefinisikan kelas PlLdResource yang berisi informasi tentang lapisan yang ditempatkan dalam file PSD."
type: docs
weight: 10
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
| --- | --- |
| [PlLdResource()](#PlLdResource--) | Menginisialisasi instance baru dari kelas [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
## Bidang
...
| [getLength()](#getLength--) | Mendapatkan panjang sumber daya PlLd dalam byte. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Menyimpan sumber daya PlLD ke kontainer aliran yang ditentukan. |
...
Menginisialisasi instance baru dari kelas [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). Konstruktor default ini dirancang untuk digunakan oleh PlLdResourceLoader. Gunakan [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) untuk membuat kelas PlLdResource.
...
Mendapatkan panjang sumber daya PlLd dalam byte.
