...
description: "Sumber Data Konten Goresan Vektor."
type: docs
weight: 13
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
Sumber Data Konten Goresan Vektor.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [VscgResource()](#VscgResource--) | Menginisialisasi sebuah instance baru dari kelas [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource). |
## Bidang
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Mendapatkan atau mengatur nama kelas. |
| [getClassName_internalized()](#getClassName-internalized--) | Mendapatkan atau mengatur pengidentifikasi kelas. |
| [getHeader_internalized()](#getHeader-internalized--) | Mendapatkan atau mengatur header. |
| [getItems()](#getItems--) | Mendapatkan atau mengatur item struktur. |
| [getKey()](#getKey--) | Mendapatkan kunci sumber daya lapisan. |
| [getKeyForData()](#getKeyForData--) | Kunci integer yang menentukan jenis pengaturan isi yang disimpan dalam sumber daya: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Mendapatkan atau mengatur nama kelas. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Mendapatkan atau mengatur pengidentifikasi kelas. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Mendapatkan atau mengatur item struktur. |
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Mendapatkan kunci integer yang menentukan jenis pengaturan isi yang disimpan dalam sumber daya: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Peringatan! Nilai properti KeyForData harus sesuai dengan tipe pengaturan Isi yang disimpan dalam struktur Items. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Metode internal yang memungkinkan penetapan properti read‑only KeyForData. |
...
Menginisialisasi sebuah instance baru dari kelas [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource).
...
Mendapatkan atau mengatur pengidentifikasi kelas.
...
Mendapatkan atau mengatur item struktur.
...
Kunci integer yang menentukan jenis pengaturan isi yang disimpan dalam sumber daya: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Mendapatkan kunci integer yang menentukan jenis pengaturan isi yang disimpan dalam sumber daya: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Peringatan! Nilai properti KeyForData harus sesuai dengan tipe pengaturan Isi yang disimpan dalam struktur Items.
...
Metode internal yang memungkinkan penetapan properti read‑only KeyForData. Harus digunakan hanya dalam pemuat sumber daya Vscg saat menetapkan properti sumber daya.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| nilai | int | Nilai integer untuk properti KeyForData. |
