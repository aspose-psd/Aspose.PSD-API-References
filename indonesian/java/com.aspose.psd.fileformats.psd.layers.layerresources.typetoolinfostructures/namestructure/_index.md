...
description: "Kunci struktur Name 0x6E616D65 yang menuliskan 'name' dalam ASCII adalah struktur sederhana yang digunakan untuk menyimpan string Unicode atau gaya Pascal yang mewakili nama elemen seperti jalur lapisan atau penyesuaian."
type: docs
weight: 19
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Menginisialisasi instance baru dari kelas [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure). |
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [StructureKey](#StructureKey) | Kunci struktur Name. |
## Metode
...
| [getValue()](#getValue--) | Mendapatkan atau mengatur nilai struktur Name. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Mendapatkan atau mengatur nilai string pertama dari struktur Name. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Mendapatkan atau mengatur nilai struktur Name. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Menginisialisasi instance baru dari kelas [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure).
...
Mendapatkan atau mengatur nilai struktur Name.
...
Mendapatkan atau mengatur nilai string pertama dari struktur Name. Biasanya berisi simbol akhir baris.
