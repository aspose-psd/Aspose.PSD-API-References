...
type: docs
weight: 12
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Menginisialisasi instance baru dari kelas [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure). |
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Mengidentifikasi kunci struktur. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Mengidentifikasi kunci struktur. |
| [StructureKeyType](#StructureKeyType) | Mengidentifikasi kunci struktur. |
## Metode
...
Menginisialisasi instance baru dari kelas [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure).
...
| structureKey | int | Kunci struktur. |
