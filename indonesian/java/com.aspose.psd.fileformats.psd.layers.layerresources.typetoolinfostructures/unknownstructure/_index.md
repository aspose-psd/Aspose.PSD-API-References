...
description: "Struktur tidak dikenal."
type: docs
weight: 30
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Menginisialisasi sebuah instance baru dari kelas [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure). |
## Metode
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Mendapatkan nama tipe yang dapat dibaca dari struktur. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Menginisialisasi sebuah instance baru dari kelas [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure).

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Nama kunci. |
| key | int | Kunci struktur. |
...
Mendapatkan nama tipe yang dapat dibaca dari struktur.
