...
description: "Mendefinisikan kelas ObjectArrayStructure yang biasanya berisi array."
type: docs
weight: 20
url: /id/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Mendefinisikan kelas ObjectArrayStructure yang biasanya berisi array [UnitArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) array. Ini digunakan dalam sumber daya file PSD, seperti PlLd Resource dan SoLd Resource.
## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Menginisialisasi sebuah instance baru dari kelas [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class. |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Menginisialisasi sebuah instance baru dari kelas [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class. |
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [StructureKey](#StructureKey) | Mengidentifikasi kunci struktur 'ObAr'. |
## Metode
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Mendapatkan atau mengatur ID kelas array objek. |
| [getClassName()](#getClassName--) | Mendapatkan atau mengatur nama kelas array objek. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Mendapatkan daftar struktur. |
| [getKey()](#getKey--) | Mendapatkan kunci struktur array objek. |
| [getKeyName()](#getKeyName--) | Mendapatkan atau mengatur nama kunci. |
| [getLength()](#getLength--) | Mendapatkan panjang OSTypeStructure dalam byte. |
...
| [getStructureCount()](#getStructureCount--) | Mendapatkan jumlah substruktur array objek. |
| [getStructures()](#getStructures--) | Mendapatkan atau mengatur substruktur dalam struktur array objek. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Mendapatkan atau mengatur ID kelas array objek. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Mendapatkan atau mengatur nama kelas array objek. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Mendapatkan atau mengatur substruktur dalam struktur array objek. |
...
Menginisialisasi sebuah instance baru dari kelas [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) class.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| keyName | java.lang.String | Nama kunci. |
| classIdName | java.lang.String | Nama pengidentifikasi kelas. |
...
Mendapatkan kunci struktur array objek.
...
Mendapatkan panjang OSTypeStructure dalam byte.
...
Nilai: Jumlah substruktur dalam struktur array objek.
...
Mendapatkan atau mengatur substruktur dalam struktur array objek.

Nilai: Substruktur dalam struktur array objek.
