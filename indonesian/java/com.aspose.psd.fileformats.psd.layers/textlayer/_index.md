...
description: "Kelas lapisan teks"
type: docs
weight: 30
url: /id/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Memperbaiki ukuran font |
...
| [createInstance_internalized()](#createInstance-internalized--) | Membuat instance baru dari kelas [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Membuat instance baru dari kelas [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Mendapatkan data mesin. |
...
| [getFont()](#getFont--) | Mendapatkan font. |
| [getFonts()](#getFonts--) | Mendapatkan kumpulan font dari lapisan teks. |
...
| [getInnerText()](#getInnerText--) | Mendapatkan teks lapisan |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Mendapatkan atau mengatur pemroses sumber daya. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Mendapatkan format string. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Mendapatkan akar sinkronisasi. |
| [getText()](#getText--) | Mendapatkan teks. |
| [getTextBoundBox()](#getTextBoundBox--) | Mendapatkan atau mengatur kotak batas teks. |
| [getTextColor()](#getTextColor--) | Mendapatkan warna teks. |
| [getTextData()](#getTextData--) | Mendapatkan bagian-bagian teks. |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Mencari dan mendapatkan sumber daya [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) dari [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [was changed]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Menentukan apakah [is font available] [font yang ditentukan]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Melakukan pra-pemrosesan font. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Mengganti font dengan default. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Mendapatkan teks lapisan |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Mendapatkan atau mengatur pemroses sumber daya. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Mendapatkan atau mengatur kotak batas teks. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [was changed]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Memperbarui batas [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) dalam sumber daya. |
| [updateText(String text)](#updateText-java.lang.String-) | Memperbarui teks. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Memperbarui teks. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Memperbarui teks. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Memperbarui teks. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Memperbarui teks. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Memperbarui teks. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Memperbarui teks. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Memperbarui teks. |
| [wait()](#wait--) |  |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| newSize | float | Ukuran font baru |
| yyTransform | double | 'yy' parameter matriks Transform |

**Returns:**
float - Ukuran yang dikoreksi
...
Membuat instance baru dari kelas [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Mendapatkan kumpulan font dari lapisan teks.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - Set font lapisan teks.
...
Mendapatkan atau mengatur pemroses sumber daya.

Nilai: Processor sumber daya.
...
Mendapatkan bagian-bagian teks.
...
Mencari dan mendapatkan sumber daya [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) dari [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah [was changed].

Nilai:  true  jika [was changed]; sebaliknya,  false .
...
Menentukan apakah [is font available] [font yang ditentukan].
...
**Returns:**
boolean - True jika font tersedia
...
Mengganti font dengan default.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | Font. |
| defaultFontName | java.lang.String | Nama default font. |
...
| newWidth | int | Lebar baru. |
| newHeight | int | Tinggi baru. |
| resizeType | int | Jenis transformasi ubah ukuran  ResizeType |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| nilai | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Memperbarui batas [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) dalam sumber daya.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Posisi dan ukuran absolut teks. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Posisi dan ukuran teks relatif terhadap textBox. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| teks | java.lang.String | Nilai teks. |
...
| --- | --- | --- |
| teks | java.lang.String | Nilai teks. |
| color | [Color](../../com.aspose.psd/color) | Nilai warna. |
...
| --- | --- | --- |
| teks | java.lang.String | Nilai teks. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Koordinat kiri atas. |
