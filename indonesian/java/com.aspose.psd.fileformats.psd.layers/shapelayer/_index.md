...
description: "Lapisan bentuk."
type: docs
weight: 29
url: /id/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Menginisialisasi sebuah instance baru dari kelas [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Bidang
...
| [createInstance()](#createInstance--) | Membuat sebuah instance baru dari kelas [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Pengaturan isi untuk area internal Bentuk dalam lapisan Bentuk. |
...
| [getPath()](#getPath--) | Mendapatkan kumpulan Path yang ada di lapisan Bentuk. |
...
| [getStroke()](#getStroke--) | Mendapatkan atau mengatur pengaturan Stroke Bentuk. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Dipanggil ketika [global resources changed] berubah. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Dipanggil ketika [resources change] berubah. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Pengaturan isi untuk area internal Bentuk dalam lapisan Bentuk. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Mendapatkan atau mengatur pengaturan Stroke Bentuk. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Memperbarui sumber daya dari properti lapisan Shape. |
...
Menginisialisasi instance baru dari kelas [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). Semua sumber daya dibuat dalam keadaan default.
...
Membuat sebuah instance baru dari kelas [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
Pengaturan isi untuk area internal Bentuk dalam lapisan Bentuk.
...
Mendapatkan kumpulan Path yang ada di lapisan Bentuk.
...
Mendapatkan atau mengatur pengaturan Stroke Bentuk.
...
**Returns:**
boolean - Nilai Boolean yang menunjukkan bahwa lapisan valid.
...
Dipanggil ketika [global resources changed] berubah.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| pengirim | java.lang.Object | Pengirim. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | Instansi EventArgs yang berisi data acara. |
...
Dipanggil ketika [resources change] berubah.
