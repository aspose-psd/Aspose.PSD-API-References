...
description: "Mewakili registri sumber daya lapisan."
type: docs
weight: 26
url: /id/java/com.aspose.psd.fileformats.psd.layers/layerresourcesregistry/
---
...
Mewakili registri sumber daya lapisan.
## Konstruktor
...
| [getClass()](#getClass--) |  |
| [getFirstSupportedDescriptor(InputStream stream, int psdVersion)](#getFirstSupportedDescriptor-java.io.InputStream-int-) | Mendapatkan deskriptor pembuka pertama yang didukung. |
...
| [hashCode()](#hashCode--) |  |
| [loadResourceByFirstSupportedDescriptor(InputStream stream, int psdVersion)](#loadResourceByFirstSupportedDescriptor-java.io.InputStream-int-) | Memuat [LayerResource](../../com.aspose.psd.fileformats.psd.layers/layerresource) menggunakan pembuka pertama yang ditemukan yang cocok untuk aliran yang ditentukan. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [registerDefaultPsdOptions_internalized()](#registerDefaultPsdOptions-internalized--) | Mendaftarkan opsi PSD default. |
| [registerOpener(ILayerResourceLoader openerDescriptor)](#registerOpener-com.aspose.psd.fileformats.psd.layers.ILayerResourceLoader-) | Mendaftarkan pembuka. |
| [registerPsdLoadOptions_internalized(PsdLoadOptions load)](#registerPsdLoadOptions-internalized-com.aspose.psd.imageloadoptions.PsdLoadOptions-) | Mendaftarkan opsi pemuatan PSD. |
| [toString()](#toString--) |  |
| [unregisterOpener(ILayerResourceLoader openerDescriptor)](#unregisterOpener-com.aspose.psd.fileformats.psd.layers.ILayerResourceLoader-) | Membatalkan pendaftaran pembuka. |
| [wait()](#wait--) |  |
...
Memuat [LayerResource](../../com.aspose.psd.fileformats.psd.layers/layerresource) menggunakan pembuka pertama yang ditemukan yang cocok untuk aliran yang ditentukan.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| openerDescriptor | [ILayerResourceLoader](../../com.aspose.psd.fileformats.psd.layers/ilayerresourceloader) | Deskriptor pembuka untuk didaftarkan. |
...
Mendaftarkan opsi pemuatan PSD.

**Parameters:**
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| load | [PsdLoadOptions](../../com.aspose.psd.imageloadoptions/psdloadoptions) | Pemuatannya. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| openerDescriptor | [ILayerResourceLoader](../../com.aspose.psd.fileformats.psd.layers/ilayerresourceloader) | Deskriptor pembuka untuk dibatalkan pendaftarannya. |
