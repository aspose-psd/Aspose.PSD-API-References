...
description: "Flag masker lapisan"
type: docs
weight: 24
url: /id/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| Bidang | Deskripsi |
| --- | --- |
| [Disabled](#Disabled) | Mask lapisan dinonaktifkan. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | Balikkan mask lapisan saat pencampuran. |
| [None](#None) | Tidak ada flag yang didefinisikan. |
| [RelativeToLayer](#RelativeToLayer) | Posisi relatif terhadap lapisan. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | Menunjukkan bahwa mask pengguna sebenarnya berasal dari rendering data lain. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | Menunjukkan bahwa mask pengguna dan/atau vektor memiliki parameter yang diterapkan padanya. |
## Metode
...
Balikkan mask lapisan saat pencampuran.
...
Tidak ada flag yang didefinisikan.
...
Posisi relatif terhadap lapisan.
...
Menunjukkan bahwa mask pengguna sebenarnya berasal dari rendering data lain.
...
Menunjukkan bahwa mask pengguna dan/atau vektor memiliki parameter yang diterapkan padanya.
