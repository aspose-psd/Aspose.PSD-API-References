...
description: "Kelas lapisan artboard."
type: docs
weight: 10
url: /id/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Menambahkan lapisan ke grup lapisan. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Menambahkan lapisan ke grup lapisan. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Menambahkan grup lapisan. |
...
| [buildGroupLayerMarkers_internalized(String groupName, PsdHeader psdHeader, IColorPalette colorPalette, int layerNestingLevel)](#buildGroupLayerMarkers-internalized-java.lang.String-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-int-) | Membangun penanda grup awal dan akhir. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Mendapatkan atau mengatur warna latar belakang artboard. |
...
| [getLayers()](#getLayers--) | Mendapatkan lapisan dalam grup lapisan |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Mendapatkan batas sebenarnya dari ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Mendapatkan LayerSectionResource dari sumber daya. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Mendapatkan atau mengatur nilai yang menunjukkan apakah [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) memiliki warna latar belakang. |
...
| [isOpen()](#isOpen--) | Mendapatkan atau mengatur apakah folder terbuka; jika diset ke true maka grup akan berada dalam keadaan terbuka saat start up, jika tidak dalam keadaan diminimalkan. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Mendapatkan atau mengatur warna latar belakang artboard. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Mendapatkan atau mengatur apakah folder terbuka; jika diset ke true maka grup akan berada dalam keadaan terbuka saat start up, jika tidak dalam keadaan diminimalkan. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Lapisan. |
| indeks | int | Indeks di mana lapisan akan disisipkan. Nilai yang tidak valid berarti akhir daftar lapisan. |
...
Membangun penanda grup awal dan akhir.
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Mengembalikan array berisi dua objek LayerGroup, di mana yang pertama [0] adalah penanda grup awal dan yang kedua [1] adalah penanda grup akhir.
### cacheData() {#cacheData--}
```
...
Mendapatkan atau mengatur warna latar belakang artboard.
...
Mendapatkan batas sebenarnya dari ArtboardLayer.
...
Mendapatkan LayerSectionResource dari sumber daya.
...
Mendapatkan atau mengatur nilai yang menunjukkan apakah [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) memiliki warna latar belakang.
...
Mendapatkan atau mengatur apakah folder terbuka; jika diset ke true maka grup akan berada dalam keadaan terbuka saat start up, jika tidak dalam keadaan diminimalkan.
