...
description: "Nilai fourCC terpaket untuk metode interpolasi gradien Photoshop."
type: docs
weight: 18
url: /id/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Nilai fourCC yang dipaketkan untuk metode interpolasi gradien Photoshop. Kunci deskriptor: "gradientsInterpolationMethod"
## Bidang

| Bidang | Deskripsi |
| --- | --- |
| [Classic](#Classic) | 'Gcls' — Klasik (default warisan ketika kunci tidak ada). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' — Linear (catatan spasi di akhir). |
| [Perceptual](#Perceptual) | 'Perc' — Perseptual. |
| [Smooth](#Smooth) | 'Smoo' — Halus. |
| [Stripes](#Stripes) | 'GIMs' — Garis. |
## Metode
...
'Gcls' — Klasik (default warisan ketika kunci tidak ada).
...
'Lnr ' — Linear (catatan spasi di akhir).
