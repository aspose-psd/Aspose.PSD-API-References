...
description: "Mewakili Brush dengan fungsionalitas gradien jalur dasar."
type: docs
weight: 15
url: /id/java/com.aspose.psd.brushes/pathgradientbrushbase/
---
...
Mewakili sebuah Brush dengan fungsi gradien jalur dasar.

Perhatikan bahwa saat membuat kelas PathGradientBrushBase, kelas tersebut harus diinisialisasi dengan setidaknya 2 titik. Jalur internal yang dibuat akan selalu menjadi bentuk tertutup, titik terakhir menghubungkan ke titik pertama. Bentuk itu diisi dengan PathGradientBrushBase ini. Implementasi GDI+ melempar OutOfMemoryError ketika diberikan array kosong atau kumpulan titik dengan koordinat yang sama. PathGradientBrushBase melempar pengecualian ketika array titik berisi kurang dari 2 titik, ArgumentException dilempar alih-alih OutOfMemoryError ketika array titik tidak dapat diterima. Titik pusat dihitung sebagai pusat massa untuk titik-titik yang diberikan secara default. Pengguna dapat mengubah titik ini kemudian. Skala fokus adalah titik kosong (0.0, 0.0) secara default.
## Metode
