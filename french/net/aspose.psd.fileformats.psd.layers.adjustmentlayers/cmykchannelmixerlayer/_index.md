---
title: "Classe CmykChannelMixerLayer"
second_title: "Aspose.PSD pour .NET Référence de l'API"
description: "classe Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer. Calque d'ajustement du mélangeur de canaux CMJN"
type: docs
weight: 1740
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
{{< psd/tize >}}
## CmykChannelMixerLayer class

Calque d'ajustement du mélangeur de canaux CMYK.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | Obtient le canal noir. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Obtient le canal cyan. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | Obtient le canal magenta. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Obtient ou définit une valeur indiquant si ce [`ChannelMixerLayer`](../channelmixerlayer/) est monochrome. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | Obtient le canal jaune. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Obtient l'index du canal par. Retourne CmykMixerChannel |
