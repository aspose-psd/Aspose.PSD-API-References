...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer classe. Couche de réglage du mélangeur de canaux CMJN.
type: docs
weight: 1700
...
Couche de réglage du mélangeur de canaux CMJN.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Obtient ou définit une valeur indiquant si cette[`ChannelMixerLayer`](../channelmixerlayer/) est monochrome. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Obtient l'index du canal par. Renvoie CmykMixerChannel |
