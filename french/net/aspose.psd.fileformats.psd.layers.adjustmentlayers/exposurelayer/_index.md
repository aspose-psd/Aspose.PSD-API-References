...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer classe. Couche de réglage de lexposition.
type: docs
weight: 1740
...
Couche de réglage de l'exposition.
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Obtient ou définit l'exposition. Pour la gamme PS d'exposition est de -20 à +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Obtient ou définit la GammaCorrection. Pour la gamme PS de GammaCorrection est de 9,99 à +0,01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Obtient ou définit le décalage. Pour PS, la plage de décalage est de -0,5 à +0,5 |
