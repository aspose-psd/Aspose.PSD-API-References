...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer classe. Calque d'ajustement d'exposition"
type: docs
weight: 1800
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
{{< psd/tize >}}
## ExposureLayer class

Calque d'ajustement de l'exposition.
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Obtient ou définit l'exposition. Pour PS, la plage d'exposition va de -20 à +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Obtient ou définit la correction gamma. Pour PS, la plage de correction gamma va de 9,99 à +0,01. |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Obtient ou définit le décalage. Pour PS, la plage de décalage va de -0,5 à +0,5. |
