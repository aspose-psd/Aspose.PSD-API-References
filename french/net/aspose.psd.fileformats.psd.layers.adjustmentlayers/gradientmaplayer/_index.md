...
description: "classe Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer. Calque de carte de dégradé. Gère le rendu de la carte de dégradé en utilisant les données de GrdmResource"
type: docs
weight: 1810
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | Obtient ou définit l'instance des paramètres de dégradé transmise depuis l'instance GrdmResource. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | Met à jour les données du calque dans la ressource de calque associée [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/). |
