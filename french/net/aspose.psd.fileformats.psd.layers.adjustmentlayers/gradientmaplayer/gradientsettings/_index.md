...
description: "Propriété GradientMapLayer. Obtient ou définit l'instance des paramètres de dégradé transmise depuis l'instance GrdmResource"
type: docs
weight: 10
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/
---
{{< psd/tize >}}
## GradientMapLayer.GradientSettings property

Obtient ou définit l'instance des paramètres de dégradé transmise depuis l'instance GrdmResource.
