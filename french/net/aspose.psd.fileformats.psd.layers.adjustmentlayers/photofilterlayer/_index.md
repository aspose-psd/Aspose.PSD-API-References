---
title: "Classe PhotoFilterLayer"
second_title: "Aspose.PSD pour .NET Référence de l'API"
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer. Calque d'ajustement PhotoFilter"
type: docs
weight: 1860
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
{{< psd/tize >}}
## PhotoFilterLayer class

Calque d'ajustement Filtre photo.
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Obtient ou définit la couleur RGB du filtre. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Obtient ou définit la densité du filtre. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Obtient ou définit une valeur indiquant si [preserve luminosity]. |
