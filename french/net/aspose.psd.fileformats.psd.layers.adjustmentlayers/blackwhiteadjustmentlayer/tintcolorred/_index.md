...
description: "BlackWhiteAdjustmentLayer property. Obtient ou définit la valeur double de Red Tint Color"
type: docs
weight: 110
...
Obtient ou définit la valeur double de la couleur de teinte rouge.
...
La valeur double de Red Tint Color.
