---
title: "Énumération CorrectionMethodTypes"
second_title: "Aspose.PSD pour .NET Référence de l'API"
description: "Énumération Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes. Méthode de correction dans le calque de réglage de couleur sélective"
type: docs
weight: 1780
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
## CorrectionMethodTypes enumeration

Méthode de correction dans le calque d'ajustement de couleur sélective.
...
| --- | --- | --- |
| Relative | `0` | Appliquer la correction des couleurs en mode relatif. |
| Absolute | `1` | Appliquer la correction des couleurs en mode absolu. |
