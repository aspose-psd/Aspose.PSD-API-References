...
description: "Propriété ColorBalanceAdjustmentLayer. Obtient ou définit l'équilibre Jaune Bleu des hautes lumières."
type: docs
weight: 30
...
Obtient ou définit le Highlights Yellow Blue Balance.
...
L'équilibre Jaune Bleu des hautes lumières.

### Exceptions

| exception | condition |
| --- | --- |
| ArgumentOutOfRangeException | L'équilibre Jaune Bleu des hautes lumières doit être compris entre -100 et +100. |
