...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer classe. Réalisation du calque d'ajustement de la vibrance"
type: docs
weight: 1930
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
{{< psd/tize >}}
## VibranceLayer class

Réalisation du calque d'ajustement de la vibrance
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation/) { get; set; } | Obtient ou définit la saturation. |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance/) { get; set; } | Obtient ou définit la vibrance. |
