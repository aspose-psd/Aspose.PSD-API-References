...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer classe. Couche de réglage des courbes
type: docs
weight: 1730
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Obtient ou définit une valeur indiquant si cette instance est utilisée en continu par le gestionnaire. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Obtient ou définit une valeur indiquant si cette instance est un gestionnaire discret utilisé. |
