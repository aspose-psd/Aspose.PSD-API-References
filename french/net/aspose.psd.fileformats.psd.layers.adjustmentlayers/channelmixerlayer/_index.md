...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer classe. Couche de réglage du mélangeur de canaux.
type: docs
weight: 1690
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
## ChannelMixerLayer class

Couche de réglage du mélangeur de canaux.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Obtient ou définit une valeur indiquant si cette`ChannelMixerLayer` est monochrome. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Obtient l'index du canal par. Peut renvoyer RgbMixerChannel ou CmykMixerChannel |
