...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer. Calque de réglage du mélangeur de canaux"
type: docs
weight: 1730
...
Calque d'ajustement du mélangeur de canaux.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Obtient ou définit une valeur indiquant si ce `ChannelMixerLayer` est monochrome. |
