...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer classe. Calque Posterize. Gère le rendu Posterize en utilisant les données de PostResource"
type: docs
weight: 1870
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
{{< psd/tize >}}
## PosterizeLayer class

Calque de postérisation. Gère le rendu de la postérisation en utilisant les données de PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Niveaux du calque Posterize. |
