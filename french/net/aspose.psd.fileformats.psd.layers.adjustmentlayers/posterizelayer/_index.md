...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer classe. Postériser le calque. Gère le rendu postérisé à laide des données de PostResource.
type: docs
weight: 1800
...
Postériser le calque. Gère le rendu postérisé à l'aide des données de PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Niveaux du calque de postérisation. |
