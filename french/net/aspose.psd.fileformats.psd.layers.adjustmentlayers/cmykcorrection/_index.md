...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykCorrection. Correction des couleurs dans le calque d'ajustement de couleur sélective"
type: docs
weight: 1750
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/
---
{{< psd/tize >}}
## CmykCorrection class

Correction des couleurs dans le calque d'ajustement de couleur sélective.
...
| Nom | Description |
| --- | --- |
| [CmykCorrection](cmykcorrection/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [Black](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/black/) { get; set; } | Obtient ou définit la correction de couleur noire. |
| [Cyan](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/cyan/) { get; set; } | Obtient ou définit la correction de couleur cyan. |
| [Magenta](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/magenta/) { get; set; } | Obtient ou définit la correction de couleur magenta. |
| [Yellow](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection/yellow/) { get; set; } | Obtient ou définit la correction de couleur jaune. |
