...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer classe. Calque de luminosité/contraste"
type: docs
weight: 1720
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | Obtient ou définit la luminosité. Pour PS, la plage de luminosité va de -150 à +150. Mais nous l'ignorons. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | Obtient ou définit le contraste. Pour PS, la plage de contraste va de -50 à +100. Mais nous l'ignorons. |
