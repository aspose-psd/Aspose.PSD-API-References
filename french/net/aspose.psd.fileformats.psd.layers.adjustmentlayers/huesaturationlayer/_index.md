...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer classe. Couche de réglage HueSaturation.
type: docs
weight: 1750
...
Couche de réglage HueSaturation.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Obtient ou définit une valeur indiquant si cette`HueSaturationLayer` est colorisé. |
