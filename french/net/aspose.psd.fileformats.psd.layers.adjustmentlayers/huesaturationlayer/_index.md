...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer. Calque de réglage HueSaturation"
type: docs
weight: 1820
url: /fr/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
{{< psd/tize >}}
## HueSaturationLayer class

Calque d'ajustement Teinte/Saturation.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Obtient ou définit une valeur indiquant si ce `HueSaturationLayer` est colorisé. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Obtient ou définit la teinte. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | Obtient ou définit la luminosité. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | Obtient ou définit la saturation. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | Obtient la plage. |
