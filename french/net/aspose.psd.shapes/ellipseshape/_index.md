...
description: "Classe Aspose.PSD.Shapes.EllipseShape. Représente une forme d'ellipse"
type: docs
weight: 5990
...
| Nom | Description |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | Initialise une nouvelle instance de la classe `EllipseShape`. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | Initialise une nouvelle instance de la classe `EllipseShape`. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | Obtient les segments de la forme. |
