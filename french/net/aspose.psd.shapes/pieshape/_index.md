...
description: "Classe Aspose.PSD.Shapes.PieShape. Représente une forme de secteur"
type: docs
weight: 6000
url: /fr/net/aspose.psd.shapes/pieshape/
---
{{< psd/tize >}}
## PieShape class
...
| Nom | Description |
| --- | --- |
| [PieShape](pieshape/#constructor)() | Initialise une nouvelle instance de la classe `PieShape`. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | Initialise une nouvelle instance de la classe `PieShape`. |
...
| override [Segments](../../aspose.psd.shapes/pieshape/segments/) { get; } | Obtient les segments de la forme. |
