...
description: Aspose.PSD.FileFormats.Psd.Resources.CaptionDigestResource classe. Ressource CaptionDigest
type: docs
weight: 3660
url: /fr/net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
## CaptionDigestResource class

Ressource CaptionDigest
...
| Nom | La description |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/captiondigestresource/datasize/) { get; } | Obtient la taille des données de ressource en octets. |
| [Digest](../../aspose.psd.fileformats.psd.resources/captiondigestresource/digest/) { get; set; } | Obtient ou définit le résumé. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Obtient ou définit l'identifiant unique de la ressource. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/captiondigestresource/minimalversion/) { get; } | Obtient la version PSD minimale requise. |
