...
description: Aspose.PSD.FileFormats.Psd.Resources.ColorTransferFunctionsResource classe. Ressource de transfert de couleur
type: docs
weight: 3680
url: /fr/net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| Nom | La description |
| --- | --- |
| [ColorTransferFunctionsResource](colortransferfunctionsresource/)() | Default_Constructor |

## Propriétés

| Nom | La description |
| --- | --- |
| [ColorTransferData](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/colortransferdata/) { get; set; } | Obtient ou définit les données de transfert de couleur. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/datasize/) { get; } | Obtient la taille des données de ressource en octets. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Obtient ou définit l'identifiant unique de la ressource. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/minimalversion/) { get; } | Obtient la version PSD minimale requise. |
