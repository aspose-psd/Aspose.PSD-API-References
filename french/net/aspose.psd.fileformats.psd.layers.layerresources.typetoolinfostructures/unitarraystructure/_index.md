...
description: Définit la classe UnitArrayStructure qui contientDouble tableau de valeurs et leur unité de mesure. Il est utilisé dans les ressources du fichier PSD généralement parObjectArrayStructure./objectarraystructure .
type: docs
weight: 3210
...
| Nom | La description |
| --- | --- |
| [UnitArrayStructure](unitarraystructure)(ClassID, UnitTypes, double[]) | Initialise une nouvelle instance du[`UnitArrayStructure`](../unitarraystructure) classe. |
...
| [UnitType](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/unittype) { get; set; } | Obtient ou définit le type d'unité de mesure du[`UnitArrayStructure`](../unitarraystructure) valeurs. |
...
| Nom | La description |
| --- | --- |
| const [StructureKey](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/structurekey) | Définit le 'UnFl'[`UnitArrayStructure`](../unitarraystructure) clé. |
