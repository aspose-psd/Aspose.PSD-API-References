...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.LayerResources.Lnk3Resource. Définit la classe qui contient des informations sur un fichier intégré dans le format PSD image 32 bits par canal. La ressource de lien peut contenir plusieurs instances LiFdDataSource qui peuvent être accessibles via l'indexeur"
type: docs
weight: 3040
...
Définit la classe qui contient des informations sur un fichier intégré dans le format PSD image 32 bits par canal. La ressource de lien peut contenir plusieurs instances [`LiFdDataSource`](../lifddatasource/) qui peuvent être accessibles via l'indexeur.
...
| Nom | Description |
| --- | --- |
| [Lnk3Resource](lnk3resource/)() | Initialise une nouvelle instance de la classe `Lnk3Resource`. |
...
| Nom | Description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lnk3resource/typetoolkey/) | La clé d'information de l'outil de type. |
