...
description: Obtient ou définit une valeur indiquant si la couleur de teinte est utilisée.
type: docs
weight: 130
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/blwhresource/usetint/
---
...
`vrai` si utilisé [couleur de teinte] ; Par ailleurs,`faux` .
