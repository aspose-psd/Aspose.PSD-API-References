...
description: Définit la classe qui contient des informations sur les fichiers intégrés dans limage au format PSD. La ressource de lien peut contenir plusieursLiFdDataSource./lifddatasource instances accessibles par lindexeur.
type: docs
weight: 2700
...
Définit la classe qui contient des informations sur les fichiers intégrés dans l'image au format PSD. La ressource de lien peut contenir plusieurs[`LiFdDataSource`](../lifddatasource) instances accessibles par l'indexeur.
...
| Nom | La description |
| --- | --- |
| [Lnk2Resource](lnk2resource)() | Initialise une nouvelle instance du[`Lnk2Resource`](../lnk2resource) classe. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/key) { get; } | Obtient la clé de ressource de couche. |
...
| Nom | La description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/typetoolkey) | La clé d'informations sur l'outil de type. |
