...
description: Obtient leLiFdDataSourceaspose.psd.fileformats.psd.layers.layerresources/lifddatasource à lindex spécifié.
type: docs
weight: 20
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
## Lnk2Resource indexer

Obtient le[`LiFdDataSource`](../../lifddatasource) à l'index spécifié.
...
Le[`LiFdDataSource`](../../lifddatasource) instance.

### Valeur de la propriété

Le[`LiFdDataSource`](../../lifddatasource) .
