...
description: Représente la structure du type de système dexploitation.
type: docs
weight: 2830
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
## OSTypeStructure class

Représente la structure du type de système d'exploitation.
...
| Nom | La description |
| --- | --- |
| [OSTypeStructure](ostypestructure)(ClassID) | Initialise une nouvelle instance du[`OSTypeStructure`](../ostypestructure) classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| abstract [Key](../../aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/key) { get; } | Obtient la clé de structure. |
...
| abstract [Length](../../aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/length) { get; } | Obtient le[`OSTypeStructure`](../ostypestructure) longueur en octets. |
