...
description: Classe MixrResource. Ressource de Channel Mixer Adjustment Layer
type: docs
weight: 2800
...
| Nom | La description |
| --- | --- |
| [MixrResource](mixrresource#constructor)() | Initialise une nouvelle instance du[`MixrResource`](../mixrresource) class. La spécification du format PSD contient la description suivante : 2 Version ( = 1) 2 Monochrome 20 Couleur RVB ou CMJN plus constante pour les paramètres du mélangeur. 4 * 2 octets de couleur avec 2 octets de constant. |
| [MixrResource](mixrresource#constructor_1)(byte[]) | Initialise une nouvelle instance du[`MixrResource`](../mixrresource) class. La spécification du format PSD contient la description suivante : 2 Version ( = 1) 2 Monochrome 20 Couleur RVB ou CMJN plus constante pour les paramètres du mélangeur. 4 * 2 octets de couleur avec 2 octets de constant. |
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.layerresources/mixrresource/monochrome) { get; set; } | Obtient ou définit une valeur indiquant si cette[`MixrResource`](../mixrresource) est monochrome. |
