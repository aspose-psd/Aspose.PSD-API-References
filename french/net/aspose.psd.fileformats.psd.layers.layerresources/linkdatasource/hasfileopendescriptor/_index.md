...
description: Obtient ou définit une valeur indiquant si cette source de données de lien a le descripteur de fichier ouvert  CompId et OriginalCompId.
type: docs
weight: 70
...
`vrai` si cette instance a un descripteur d'ouverture de fichier ; Par ailleurs,`faux` .
