...
| Nom | La description |
| --- | --- |
| [CurvResource](curvresource/#constructor)(byte[]) | Initialise une nouvelle instance du`CurvResource` classe. |
| [CurvResource](curvresource/#constructor_1)(int) | Initialise une nouvelle instance du`CurvResource` classe. |
