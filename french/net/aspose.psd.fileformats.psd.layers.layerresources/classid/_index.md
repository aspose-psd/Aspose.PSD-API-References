...
description: Lobjet ID de classe PSD.
type: docs
weight: 2340
...
| Nom | La description |
| --- | --- |
| [ClassID](classid#constructor)(byte[]) | Initialise une nouvelle instance du[`ClassID`](../classid) classe. |
| [ClassID](classid#constructor_2)(int) | Initialise une nouvelle instance du[`ClassID`](../classid) classe. |
| [ClassID](classid#constructor_3)(string) | Initialise une nouvelle instance du[`ClassID`](../classid) classe. |
| [ClassID](classid#constructor_5)(uint) | Initialise une nouvelle instance du[`ClassID`](../classid) classe. |
| [ClassID](classid#constructor_1)(byte[], bool) | Initialise une nouvelle instance du[`ClassID`](../classid) classe. |
| [ClassID](classid#constructor_4)(string, bool) | Initialise une nouvelle instance du[`ClassID`](../classid) classe. |
