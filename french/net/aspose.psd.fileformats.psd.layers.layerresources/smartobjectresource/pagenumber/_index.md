...
description: "SmartObjectResource propriété. Obtient ou définit le numéro de page des données du calque d'objet intelligent dans le fichier PSD"
type: docs
weight: 150
...
Obtient ou définit le numéro de page des données du calque d'objet dynamique dans le fichier PSD.
...
Le numéro de page des données du calque d'objet intelligent.
