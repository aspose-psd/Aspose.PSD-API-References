...
description: SmartObjectResource propriété. Obtient ou définit le numéro de page des données de la couche dobjet intelligent dans le fichier PSD.
type: docs
weight: 150
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/pagenumber/
---
## SmartObjectResource.PageNumber property

Obtient ou définit le numéro de page des données de la couche d'objet intelligent dans le fichier PSD.
...
Le numéro de page des données de la couche d'objets intelligents.
