...
description: Obtient ou définit lidentifiant unique global des données de la couche dobjets intelligentsSmartObjectResourceaspose.psd.fileformats.psd.layers.layerresources/smartobjectresource dans limage PSD.
type: docs
weight: 240
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

Obtient ou définit l'identifiant unique global des données de la couche d'objets intelligents[`SmartObjectResource`](../../smartobjectresource) dans l'image PSD.
...
L'identifiant unique global des données de la couche d'objets intelligents[`SmartObjectResource`](../../smartobjectresource) .
