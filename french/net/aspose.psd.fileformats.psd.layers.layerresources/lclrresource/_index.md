...
description: Classe LclrResource. Cette ressource contient des informations sur la couleur du calque dans la liste des calques est PS. Cest seulement
type: docs
weight: 2600
...
| Nom | La description |
| --- | --- |
| [LclrResource](lclrresource#constructor)() | Initialise une nouvelle instance du[`LclrResource`](../lclrresource) classe. |
| [LclrResource](lclrresource#constructor_2)(byte[]) | Initialise une nouvelle instance du[`LclrResource`](../lclrresource) classe. |
| [LclrResource](lclrresource#constructor_1)(SheetColorHighlightEnum) | Initialise une nouvelle instance du[`LclrResource`](../lclrresource) classe. |
