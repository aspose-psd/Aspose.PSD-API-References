...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtDResource. Les données d'information du plan de travail pour GlobalLayerResources"
type: docs
weight: 2530
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/artdresource/
---
{{< psd/tize >}}
## ArtDResource class

Les données d'information du plan de travail pour [`GlobalLayerResources`](../../aspose.psd.fileformats.psd/psdimage/globallayerresources/).
...
| Nom | Description |
| --- | --- |
| [ArtDResource](artdresource/)() | Le constructeur par défaut. |
...
| Nom | Description |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artdresource/typetoolkey/) | La clé d'information de l'outil de type. |
