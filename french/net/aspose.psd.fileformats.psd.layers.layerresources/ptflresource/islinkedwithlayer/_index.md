...
description: "Propriété PtFlResource. Obtient ou définit une valeur indiquant si cette instance est liée au calque"
type: docs
weight: 40
...
`true` si cette instance est liée au calque ; sinon, `false`.
