...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PtFlResource classe. Classe PtFlResource. Contient des données de calque de remplissage de motif.
type: docs
weight: 2960
...
| Nom | La description |
| --- | --- |
| [PtFlResource](ptflresource/)(string, string) | Initialise une nouvelle instance du`PtFlResource` classe. |
