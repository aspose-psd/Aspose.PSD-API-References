...
description: Initialise une nouvelle instance duSoLdResourceaspose.psd.fileformats.psd.layers.layerresources/soldresource class. Il est nécessaire de définir la propriété Items ou dappeler InitializeItems pour obtenir une instance prête. Ce constructeur est conçu pour être utilisé parSmartResourceCreatoraspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator et dans les tests unitaires. UtilisationSmartResourceCreatoraspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator pour créer des classes SoLdResource.
type: docs
weight: 10
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/soldresource/
---
## SoLdResource(Guid, bool, bool) {#constructor_1}

Initialise une nouvelle instance du[`SoLdResource`](../../soldresource) class. Il est nécessaire de définir la propriété Items ou d'appeler InitializeItems() pour obtenir une instance prête. Ce constructeur est conçu pour être utilisé par[`SmartResourceCreator`](../../smartresourcecreator) et dans les tests unitaires. Utilisation[`SmartResourceCreator`](../../smartresourcecreator) pour créer des classes SoLdResource.
...
| --- | --- | --- |
| uniqueId | Guid | L'identifiant unique des données de la couche d'objets intelligents[`SoLdResource`](../../soldresource). |
...
Initialise une nouvelle instance du[`SoLdResource`](../../soldresource) class. Ce constructeur par défaut est conçu pour être utilisé parSoLdResourceLoader . Utilisation[`SmartResourceCreator`](../../smartresourcecreator) pour créer des classes SoLdResource.
