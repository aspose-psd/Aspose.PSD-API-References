...
description: "GdFlResource propriété. Obtient ou définit une valeur indiquant si ce GdFlResource est en tramage"
type: docs
weight: 70
...
Obtient ou définit une valeur indiquant si ce [`GdFlResource`](../) est en tramage.
