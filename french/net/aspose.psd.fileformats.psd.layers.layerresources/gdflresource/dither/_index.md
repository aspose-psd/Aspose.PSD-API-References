...
description: GdFlResource propriété. Obtient ou définit une valeur indiquant si cetteGdFlResource est le tramage.
type: docs
weight: 60
...
Obtient ou définit une valeur indiquant si cette[`GdFlResource`](../) est le tramage.
