...
description: GdFlResource propriété. Obtient ou définit une valeur indiquant si cetteGdFlResource est inversé.
type: docs
weight: 140
...
Obtient ou définit une valeur indiquant si cette[`GdFlResource`](../) est inversé.
