...
description: "Propriété GdFlResource. Obtient ou définit une valeur indiquant si ce GdFlResource est inversé"
type: docs
weight: 170
...
Obtient ou définit une valeur indiquant si ce [`GdFlResource`](../) est inversé.
