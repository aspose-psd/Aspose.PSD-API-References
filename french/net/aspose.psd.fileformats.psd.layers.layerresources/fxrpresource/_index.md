...
description: Classe FxrpResource. Le point de référence de la couche
type: docs
weight: 2470
...
| Nom | La description |
| --- | --- |
| [FxrpResource](fxrpresource#constructor)() | Initialise une nouvelle instance du[`FxrpResource`](../fxrpresource) classe. |
| [FxrpResource](fxrpresource#constructor_1)(byte[]) | Initialise une nouvelle instance du[`FxrpResource`](../fxrpresource) class. Avec valeur personnalisée ou inconnue |
| [FxrpResource](fxrpresource#constructor_2)(double, double) | Initialise une nouvelle instance du[`FxrpResource`](../fxrpresource) classe. |
