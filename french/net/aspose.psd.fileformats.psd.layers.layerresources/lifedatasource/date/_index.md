...
description: LiFeDataSource propriété. Obtient ou définit la date et lheure de la dernière écriture du fichier externe dans la source de données LiFE de la ressource PSD LnkE.
type: docs
weight: 40
