...
description: LiFeDataSource propriété. Obtient ou définit le nom du fichier externe ou intégré dans la ressource de lien PSD .
type: docs
weight: 70
...
Le nom du fichier externe ou intégré.
