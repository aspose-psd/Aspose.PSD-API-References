...
description: "Propriété LiFeDataSource. Obtient ou définit la référence d'élément de la bibliothèque graphique pour les bibliothèques Adobe Photoshop CC"
type: docs
weight: 60
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
{{< psd/tize >}}
## LiFeDataSource.ElementRef property

Obtient ou définit la référence de l'élément de la bibliothèque graphique, pour les Adobe® Photoshop® CC Libraries.
...
La référence d'élément de la bibliothèque graphique.

### Exceptions

| exception | condition |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Vous ne pouvez pas accéder à la propriété ElementRef, elle n'est disponible que pour la source de données liFE lorsque IsLibrary est vrai |
