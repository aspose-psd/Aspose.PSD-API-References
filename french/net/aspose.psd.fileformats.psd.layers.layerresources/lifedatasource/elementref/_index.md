...
description: LiFeDataSource propriété. Obtient ou définit la référence de lélément de la bibliothèque graphique pour les bibliothèques Adobe Photoshop CC.
type: docs
weight: 60
...
La référence de l'élément de la bibliothèque graphique.

### Exceptions

| exception | condition |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Vous ne pouvez pas accéder à la propriété ElementRef, elle n'est disponible que pour la source de données liFE lorsque IsLibrary est true |
