...
description: Définit la classe LnkeDataSource qui contient des informations sur le fichier lié externe. Ceci fait partie de lAPI de manipulation du format de fichier PSD qui aide à modifier les fichiers Adobe Photoshop
type: docs
weight: 2660
...
| Nom | La description |
| --- | --- |
| [LiFeDataSource](lifedatasource#constructor)() | Initialise une nouvelle instance du[`LiFeDataSource`](../lifedatasource) classe. |
| [LiFeDataSource](lifedatasource#constructor_1)(int, Guid, string, string, string) | Initialise une nouvelle instance du[`LiFeDataSource`](../lifedatasource) classe. |
