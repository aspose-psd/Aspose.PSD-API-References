...
description: LiFeDataSource propriété. Obtient ou définit le nom de lélément de la bibliothèque graphique pour les bibliothèques Adobe Photoshop CC.
type: docs
weight: 50
...
| exception | condition |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Vous ne pouvez pas accéder à la propriété ElementName, elle n'est disponible que pour la source de données liFE lorsque IsLibrary est true |
