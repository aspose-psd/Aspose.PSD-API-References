...
description: "Propriété LiFeDataSource. Obtient ou définit le nom de l'élément de la bibliothèque graphique pour les bibliothèques Adobe Photoshop CC."
type: docs
weight: 50
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
{{< psd/tize >}}
## LiFeDataSource.ElementName property

Obtient ou définit le nom de l'élément de la bibliothèque graphique, pour les Adobe® Photoshop® CC Libraries.
...
Le nom de l'élément de la bibliothèque graphique.

### Exceptions

| exception | condition |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Vous ne pouvez pas accéder à la propriété ElementName, elle n'est disponible que pour la source de données liFE lorsque IsLibrary est vrai. |
