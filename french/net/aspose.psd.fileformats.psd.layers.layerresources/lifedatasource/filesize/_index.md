...
description: LiFeDataSource propriété. Obtient ou définit la taille du fichier externe dans la source de données LiFE de la ressource PSD LnkE.
type: docs
weight: 80
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
...
| exception | condition |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Vous ne pouvez pas accéder à la propriété FileSize, elle n'est disponible que pour la source de données liFE |
