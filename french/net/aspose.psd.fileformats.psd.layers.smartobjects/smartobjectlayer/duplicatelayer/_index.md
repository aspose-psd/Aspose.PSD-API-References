...
description: Crée un nouveau calque dobjet intelligent en copiant celuici. Notez que pour les objets intelligents intégrés limage intégrée est partagée. Si vous souhaitez copier limage intégrée utilisezNewSmartObjectViaCopyaspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/newsmartobjectviacopy méthode.
type: docs
weight: 80
...
Le cloné[`SmartObjectLayer`](../../smartobjectlayer) instance.
