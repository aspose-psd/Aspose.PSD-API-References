...
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectLayer class. Définit la classe SmartObjectLayer qui contient un objet intelligent intégré dans le fichier PSD ou un objet intelligent lié dans le fichier externe. Avec les objets intelligents, vous pouvez effectuer des transformations non destructives. Vous pouvez mettre à l'échelle, faire pivoter, incliner, déformer, transformer la perspective ou déformer une couche sans perdre les données ou la qualité de l'image originale, car les transformations n'affectent pas les données d'origine. Travaillez avec des données vectorielles telles que des illustrations vectorielles provenant d'Illustrator qui seraient autrement rasterisées. Effectuez un filtrage non destructif. Vous pouvez modifier les filtres appliqués aux objets intelligents à tout moment. Modifiez un objet intelligent et mettez automatiquement à jour toutes ses instances liées. Appliquez un masque de calque qui est soit lié, soit détaché du calque d'objet intelligent. Essayez diverses conceptions avec des images de substitution à basse résolution que vous remplacerez plus tard par les versions finales. Dans Adobe Photoshop, vous pouvez intégrer le contenu d'une image dans un document PSD. Plus d'informations ici https//helpx.adobe.com/photoshop/using/createsmartobjects.html Un calque avec un objet intelligent intégré contient des ressources PlLd et SoLd placées avec les propriétés de l'objet intelligent. La ressource PlLd peut être seule pour les versions PSD antérieures à 10. Ces ressources contiennent l'UniqueId du LiFdDataSource dans le Lnk2Resource global avec le nom de fichier intégré et d'autres paramètres, y compris le contenu du fichier intégré au format original sous forme de tableau d'octets."
type: docs
weight: 3910
url: /fr/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
{{< psd/tize >}}
## SmartObjectLayer class

Définit la classe SmartObjectLayer qui contient un objet intelligent intégré dans le fichier PSD ou lié dans le fichier externe. Avec les objets intelligents, vous pouvez : Effectuer des transformations non destructives. Vous pouvez mettre à l'échelle, faire pivoter, incliner, déformer, appliquer une transformation de perspective ou déformer une couche sans perdre les données ou la qualité de l'image originale, car les transformations n'affectent pas les données d'origine. Travailler avec des données vectorielles, telles que des illustrations vectorielles d'Illustrator, qui seraient autrement rasterisées. Effectuer un filtrage non destructif. Vous pouvez modifier les filtres appliqués aux objets intelligents à tout moment. Modifier un objet intelligent et mettre à jour automatiquement toutes ses instances liées. Appliquer un masque de calque qui est soit lié, soit non lié au calque d'objet intelligent. Essayer diverses conceptions avec des images de substitution à basse résolution que vous remplacerez plus tard par les versions finales. Dans Adobe Photoshop, vous pouvez intégrer le contenu d'une image dans un document PSD. Plus d'informations ici : [https://helpx.adobe.com/photoshop/using/create-smart-objects.html](https://helpx.adobe.com/photoshop/using/create-smart-objects.html) Un calque contenant un objet intelligent intégré contient des ressources placées (PlLd) et SoLd avec les propriétés de l'objet intelligent. La ressource PlLd peut être seule pour les versions PSD antérieures à 10. Ces ressources contiennent l'UniqueId du LiFdDataSource dans la ressource globale Lnk2Resource avec le nom de fichier intégré et d'autres paramètres, y compris le contenu du fichier intégré au format original sous forme de tableau d'octets.
...
| Nom | Description |
| --- | --- |
| [SmartObjectLayer](smartobjectlayer/)(Stream) | Initialise une nouvelle instance de la classe `SmartObjectLayer`. |
...
| [Contents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contents/) { get; set; } | Obtient ou définit le contenu du calque d'objet dynamique. Le contenu d'objet dynamique intégré est le fichier d'image brute intégré : [`Data`](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) et ses propriétés. Le contenu d'objet dynamique lié est le contenu brut du fichier d'image lié s'il est disponible ainsi que ses propriétés : [`LiFeDataSource`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/). Nous ne prenons pas en charge le chargement depuis la bibliothèque graphique Adobe® Photoshop® lorsque [`IsLibraryLink`](../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) est vrai. Pour les fichiers liés classiques, nous utilisons d'abord [`RelativePath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/) pour rechercher le fichier relativement au chemin de l'image source SourceImagePath ; s'il n'est pas disponible, nous consultons [`FullPath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/), sinon nous recherchons le fichier lié dans le même répertoire que notre image : SourceImagePath. |
| [ContentsBounds](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentsbounds/) { get; set; } | Obtient ou définit les limites du contenu de l'objet dynamique. |
| [ContentsSource](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentssource/) { get; set; } | Obtient ou définit la source du contenu de l'objet dynamique. |
| [ContentType](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contenttype/) { get; } | Obtient le type du contenu du calque d'objet dynamique. Le contenu d'objet dynamique intégré est le fichier d'image brute intégré : [`Data`](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/). Le contenu d'objet dynamique lié est le contenu brut du fichier d'image lié s'il est disponible : [`LiFeDataSource`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/). Nous ne prenons pas en charge le chargement depuis la bibliothèque graphique Adobe® Photoshop® lorsque [`IsLibraryLink`](../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) est vrai. Pour les fichiers liés classiques, nous utilisons d'abord [`RelativePath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/) pour rechercher le fichier relativement au chemin de l'image source SourceImagePath ; s'il n'est pas disponible, nous consultons [`FullPath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/), sinon nous recherchons le fichier lié dans le même répertoire que notre image : SourceImagePath. |
...
| [SmartFilters](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/smartfilters/) { get; } | Obtient les filtres intelligents. |
| [SmartObjectProvider](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/smartobjectprovider/) { get; } | Obtient le fournisseur d'objets intelligents. |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/) { get; set; } | Obtient ou définit les paramètres de déformation qui ont été définis ou obtenus à partir de la ressource (par défaut) |
...
| [ConvertToLinked](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/converttolinked/)(string) | Convertit cet objet intelligent intégré en un objet intelligent lié. |
...
| [DuplicateLayer](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/duplicatelayer/)() | Crée un nouveau calque d'objet intelligent en copiant celui-ci. Notez que pour les objets intelligents intégrés, l'image intégrée est partagée. Si vous souhaitez copier l'image intégrée, utilisez la méthode [`NewSmartObjectViaCopy`](./newsmartobjectviacopy/). |
| [EmbedLinked](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/embedlinked/)() | Intègre l'objet intelligent lié dans ce calque. |
| [ExportContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/exportcontents/)(string) | Exporte le contenu intégré ou lié vers un fichier. |
...
| [LoadContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/loadcontents/)(LoadOptions) | Obtient le contenu image incorporé ou lié du calque d'objet intelligent. |
...
| virtual [MergeLayerTo](../../aspose.psd.fileformats.psd.layers/layer/mergelayerto/)(Layer) | Fusionne le calque avec le calque spécifié |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/newsmartobjectviacopy/)() | Crée un nouveau calque d'objet intelligent en copiant celui-ci. Reproduit la fonctionnalité `Layer -&gt; Smart Objects -&gt; New Smart Object via Copy` d'Adobe Photoshop. Notez qu'elle n'est activée que pour les objets intelligents incorporés car l'image incorporée est également copiée. Si vous souhaitez partager l'image incorporée, utilisez la méthode [`DuplicateLayer`](./duplicatelayer/). |
...
| [RelinkToFile](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/)(string) | Rélie de nouveau l'objet intelligent lié à un nouveau fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite. |
...
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents)(Image) | Remplace le contenu de l'objet intelligent incorporé dans le calque d'objet intelligent. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_2)(string) | Remplace le contenu par un fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_1)(Image, ResolutionSetting) | Remplace le contenu de l'objet intelligent incorporé dans le calque d'objet intelligent. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_5)(string, bool) | Remplace le contenu par un fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_3)(string, ResolutionSetting) | Remplace le contenu par un fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_4)(string, ResolutionSetting, bool) | Remplace le contenu par un fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite. |
...
| [UpdateModifiedContent](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/updatemodifiedcontent/)() | Met à jour le cache d'image du calque d'objet dynamique avec le contenu modifié. |
