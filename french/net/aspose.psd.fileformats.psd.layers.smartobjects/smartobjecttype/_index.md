...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType énumération. Définit lénumération SmartObjectType pour le type de contenu dobjet intelligent
type: docs
weight: 3500
url: /fr/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
...
| --- | --- | --- |
| Embedded | `0` | Le contenu intégré |
| AvailableLinked | `1` | Le fichier lié disponible |
| UnavailableLinked | `2` | Le fichier lié qui n'est pas disponible |
| LibraryLink | `3` | Le lien vers la bibliothèque Adobe® Photoshop® ÑÑ |
