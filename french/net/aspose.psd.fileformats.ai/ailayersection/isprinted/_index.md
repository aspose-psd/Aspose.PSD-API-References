...
description: Obtient ou définit une valeur indiquant si ce calque est imprimé. Rend lillustration contenue dans le calque imprimable si vrai.
type: docs
weight: 80
...
`vrai` si ce calque est imprimé ; Par ailleurs,`faux` .
