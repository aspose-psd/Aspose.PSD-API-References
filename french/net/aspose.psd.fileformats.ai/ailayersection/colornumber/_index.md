...
description: Obtient ou définit le numéro de couleur. 1 est la valeur de couleur personnalisée des propriétés Rouge Vert Bleu. Spécifie le paramètre de couleur du calque.
type: docs
weight: 20
