...
description: Obtient ou définit une valeur indiquant si ce calque est un aperçu. Affiche lillustration contenue dans le calque en couleur plutôt quen contours.
type: docs
weight: 70
...
`vrai` si ce calque est un aperçu ; Par ailleurs,`faux` .
