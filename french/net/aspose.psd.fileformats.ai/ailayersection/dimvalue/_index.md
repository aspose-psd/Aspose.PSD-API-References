...
description: Obtient ou définit la valeur dim sous forme de pourcentage. Réduit lintensité des images liées et des images bitmap contenues dans le calque au pourcentage spécifié.
type: docs
weight: 30
