...
description: Obtient ou définit une valeur indiquant si ce calque est affiché. Affiche toutes les illustrations contenues dans le calque sur la planche graphique si vrai.
type: docs
weight: 90
...
`vrai` si cette couche est affichée ; Par ailleurs,`faux` .
