...
description: "Propriété VscgResource. Obtient ou définit le tableau d'éléments de structure. Avertissement : les valeurs du tableau Items doivent correspondre à la propriété KeyForData qui détermine le type de paramètres de remplissage stockés dans les structures au sein de Items"
type: docs
weight: 20
url: /fr/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/items/
---
{{< psd/tize >}}
## VscgResource.Items property

Obtient ou définit le tableau des éléments de structure. **Warning:** Les valeurs du tableau `Items` doivent correspondre à la propriété `KeyForData`, qui détermine le type de paramètres de remplissage stockés dans les structures du tableau `Items`.
...
Le tableau d'éléments [`OSTypeStructure`](../../../aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/).
