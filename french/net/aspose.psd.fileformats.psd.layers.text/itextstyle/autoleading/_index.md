...
description: ITextStyle propriété. Obtient ou définit une valeur indiquant si interlignage automatique.
type: docs
weight: 20
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Obtient ou définit une valeur indiquant si [interlignage automatique].
...
`vrai` si [interligne automatique] ; sinon,`FAUX` .
