...
description: ITextStyle propriété. Obtient ou définit une valeur indiquant si nombres hindis.
type: docs
weight: 150
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Obtient ou définit une valeur indiquant si [nombres hindis].
...
`vrai` si [chiffres hindis] ; sinon,`FAUX` .
