...
description: ITextParagraph propriété. Obtient ou définit une valeur indiquant si cetteITextParagraph est suspendu.
type: docs
weight: 90
...
Obtient ou définit une valeur indiquant si cette[`ITextParagraph`](../) est suspendu.
