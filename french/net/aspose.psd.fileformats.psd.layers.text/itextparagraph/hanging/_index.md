...
description: Obtient ou définit une valeur indiquant si cetteITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph est suspendu.
type: docs
weight: 90
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Obtient ou définit une valeur indiquant si cette[`ITextParagraph`](../../itextparagraph) est suspendu.
...
`vrai` si suspendu; Par ailleurs,`faux` .
