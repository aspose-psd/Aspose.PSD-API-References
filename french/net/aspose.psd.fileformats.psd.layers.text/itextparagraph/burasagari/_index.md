...
description: "Propriété ITextParagraph. Obtient ou définit une valeur indiquant si cet ITextParagraph est burasagiri"
type: docs
weight: 30
...
Obtient ou définit une valeur indiquant si ce [`ITextParagraph`](../) est burasagiri.
...
`true` si burasagiri ; sinon, `false`.
