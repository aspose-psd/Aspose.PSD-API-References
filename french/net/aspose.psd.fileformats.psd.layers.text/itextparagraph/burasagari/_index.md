...
description: ITextParagraph propriété. Obtient ou définit une valeur indiquant si cetteITextParagraphest burasagiri.
type: docs
weight: 30
...
Obtient ou définit une valeur indiquant si cette[`ITextParagraph`](../)est burasagiri.
