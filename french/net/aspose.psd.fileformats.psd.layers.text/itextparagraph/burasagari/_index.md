...
description: Obtient ou définit une valeur indiquant si cetteITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph est burasagiri.
type: docs
weight: 30
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Obtient ou définit une valeur indiquant si cette[`ITextParagraph`](../../itextparagraph) est burasagiri.
...
`vrai` si burasagiri; Par ailleurs,`faux` .
...
* espace de noms [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph)
