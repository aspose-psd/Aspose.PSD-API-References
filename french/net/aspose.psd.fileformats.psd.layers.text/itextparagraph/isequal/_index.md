...
description: ITextParagraph méthode. Détermine si le paragraphe spécifié est égal.
type: docs
weight: 230
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/isequal/
---
...
| --- | --- | --- |
| paragraph | ITextParagraph | Le paragraphe. |

### Return_Value

`vrai` si le paragraphe spécifié est égal ; sinon,`FAUX` .
