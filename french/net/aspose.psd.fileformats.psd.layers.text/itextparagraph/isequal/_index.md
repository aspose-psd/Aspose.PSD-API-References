...
description: "Méthode ITextParagraph. Détermine si le paragraphe spécifié est égal"
type: docs
weight: 230
...
| --- | --- | --- |
| paragraphe | ITextParagraph | Le paragraphe. |

### Valeur de retour

`true` si le paragraphe spécifié est égal ; sinon, `false`.
