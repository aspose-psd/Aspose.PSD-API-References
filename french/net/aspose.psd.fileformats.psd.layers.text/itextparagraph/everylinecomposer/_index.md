...
description: ITextParagraph propriété. Obtient ou définit une valeur indiquant si every line composer.
type: docs
weight: 60
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
...
`vrai` if [chaque compositeur de lignes] ; sinon,`FAUX` .
