...
description: ITextParagraph propriété. Obtient ou définit une valeur indiquant si trait dunion automatique.
type: docs
weight: 10
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Obtient ou définit une valeur indiquant si [trait d'union automatique].
...
`vrai` si [trait d'union automatique] ; sinon,`FAUX` .
