...
description: "Propriété ITextParagraph. Obtient ou définit une valeur indiquant si la césure automatique est activée"
type: docs
weight: 10
...
`true` si [automatic hyphenate] ; sinon, `false`.
