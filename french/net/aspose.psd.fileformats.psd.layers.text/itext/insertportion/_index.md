...
description: Insère leITextPortionaspose.psd.fileformats.psd.layers.text/itextportion à la position spécifiée
type: docs
weight: 40
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itext/insertportion/
---
## IText.InsertPortion method

Insère le[`ITextPortion`](../../itextportion) à la position spécifiée
...
| --- | --- | --- |
| portion | ITextPortion | La portion. |
| index | Int32 | L'index. |
