...
description: "IText méthode. Produit la nouvelle portion avec les paramètres par défaut"
type: docs
weight: 60
url: /fr/net/aspose.psd.fileformats.psd.layers.text/itext/produceportion/
---
{{< psd/tize >}}
...
Référence à l'`ITextPortion` nouvellement créé [`ITextPortion`](../../itextportion/).
