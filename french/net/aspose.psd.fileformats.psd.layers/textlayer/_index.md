...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer classe. La classe de calque de texte
type: docs
weight: 3560
...
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Obtient ou définit la zone liée au texte. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Obtient la couleur du texte. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Récupère les portions de texte. |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Obtient le jeu de polices du calque de texte. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Redimensionne l'image. Le défautLeftTopToLeftTopest utilisé. |
