...
description: Obtient ou définit les données de masque utilisateur raster dun calque dans le fichier PSD. Il y a un masque vectoriel classé dans la propriété MaskData.
type: docs
weight: 80
