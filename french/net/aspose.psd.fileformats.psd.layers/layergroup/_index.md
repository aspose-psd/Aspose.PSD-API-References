...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup classe. Classe de couche de groupe
type: docs
weight: 2220
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Obtient ou définit le dossier ouvert si défini sur`vrai` que le groupe sera à l'état ouvert au démarrage, sinon à l'état réduit. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Récupère les calques du groupe de calques |
