...
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer class. La classe de calque d'artboard."
type: docs
weight: 1990
url: /fr/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class

Classe de calque de plan de travail.
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Obtient ou définit la couleur d'arrière-plan de l'artboard. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Obtient ou définit la clé du mode de fusion. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | Obtient ou définit une valeur indiquant si `ArtboardLayer` possède la couleur d'arrière-plan. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Obtient ou définit si le dossier est ouvert ; si la valeur est `true`, le groupe sera en état ouvert au démarrage, sinon il sera minimisé. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Obtient les calques du groupe de calques |
...
| Nom | Description |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Ajoute le calque au groupe de calques. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Ajoute le groupe de calques. |
