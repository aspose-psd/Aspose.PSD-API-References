...
description: LayerHashCalculator méthode. Obtient le hachage de mélange.
type: docs
weight: 20
url: /fr/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/getblendinghash/
---
## LayerHashCalculator.GetBlendingHash method

Obtient le hachage de mélange.
...
Hachage unique pour les options de fusion des calques
