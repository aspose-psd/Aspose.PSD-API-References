...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerHashCalculator classe. Calculatrice de hachage pour les couches PSD. Il peut être utilisé pour trouver des couches égales ou différentes dans différents fichiers PSD
type: docs
weight: 2230
url: /fr/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/
---
## LayerHashCalculator class

Calculatrice de hachage pour les couches PSD. Il peut être utilisé pour trouver des couches égales ou différentes dans différents fichiers PSD
...
| Nom | La description |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator/)(Layer) | Initialise une nouvelle instance du`LayerHashCalculator` classe. |

## Méthodes

| Nom | La description |
| --- | --- |
| [GetBlendingHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getblendinghash/)() | Obtient le hachage de mélange. |
| [GetChannelsHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getchannelshash/)() | Obtient le hachage des canaux. |
| [GetContentHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getcontenthash/)() | Obtient le hachage du contenu. |
