...
description: Calculatrice de hachage pour les couches PSD. Il peut être utilisé pour trouver des couches égales ou différentes dans différents fichiers PSD
type: docs
weight: 2210
...
| Nom | La description |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator)(Layer) | Initialise une nouvelle instance du[`LayerHashCalculator`](../layerhashcalculator) classe. |
