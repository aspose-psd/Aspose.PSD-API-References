...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerHashCalculator class. Calculateur de hachage pour les calques PSD. Il peut être utilisé pour trouver des calques égaux ou différents dans différents fichiers PSD."
type: docs
weight: 2430
...
Calculateur de hachage pour les calques PSD. Il peut être utilisé pour trouver des calques identiques ou différents dans différents fichiers PSD.
...
| Nom | Description |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator/)(Layer) | Initialise une nouvelle instance de la classe `LayerHashCalculator`. |

## Méthodes

| Nom | Description |
| --- | --- |
| [GetBlendingHash](../../aspose.psd.fileformats.psd.layers/layerhashcalculator/getblendinghash/)() | Obtient le hachage de fusion. |
