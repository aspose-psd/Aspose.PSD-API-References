...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer. Le calque diviseur de section qui marque les limites du groupe de calques de dossier"
type: docs
weight: 3810
url: /fr/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
{{< psd/tize >}}
## SectionDividerLayer class

Le calque de séparateur de section pour marquer les limites du dossier (groupe de calques).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Obtient une valeur indiquant si cette instance est visible dans le groupe (si le calque n'est pas dans un groupe, cela signifie le groupe racine). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Obtient le [`LayerGroup`](../layergroup/) lié à cette instance de `SectionDividerLayer`. |
