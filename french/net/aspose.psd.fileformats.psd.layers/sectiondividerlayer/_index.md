...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer classe. Le calque de séparation de section pour marquer les limites du dossier groupe de calques.
type: docs
weight: 3410
...
Le calque de séparation de section pour marquer les limites du dossier (groupe de calques).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Obtient une valeur indiquant si cette instance est visible dans le groupe (si la couche n'est pas dans le groupe, cela signifie le groupe racine). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Obtient le[`LayerGroup`](../layergroup/) c'est lié à ça`SectionDividerLayer` instance. |
