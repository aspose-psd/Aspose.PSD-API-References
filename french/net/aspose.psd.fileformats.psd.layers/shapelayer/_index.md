...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer. Calque Shape. Encapsule la logique de travail avec le calque Shape et les ressources associées"
type: docs
weight: 3820
url: /fr/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

Calque de forme. Encapsule la logique de travail avec le calque de forme et les ressources associées.
...
| Nom | Description |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Initialise une nouvelle instance de la classe `ShapeLayer`. Toutes les ressources sont créées dans leur état par défaut. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Obtient ou définit les paramètres de remplissage pour la zone interne des formes dans le calque Shape. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Obtient l'ensemble des chemins présents dans un calque Shape. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Obtient ou définit les paramètres de contour des formes. |
...
| Nom | Description |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Crée une nouvelle instance de la classe `ShapeLayer`. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Met à jour les ressources à partir des propriétés du calque Shape. |
