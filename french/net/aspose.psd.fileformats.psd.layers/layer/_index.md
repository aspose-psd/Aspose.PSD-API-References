...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer classe. La couche psd.
type: docs
weight: 2080
url: /fr/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| Nom | La description |
| --- | --- |
| [Layer](layer/#constructor)() | Initialise une nouvelle instance du`Layer` classe. Constructeur pour l'initialisation paresseuse. |
| [Layer](layer/#constructor_3)(Stream) | Initialise une nouvelle instance du`Layer` classe. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Initialise une nouvelle instance du`Layer` classe. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Initialise une nouvelle instance du`Layer` classe à partir de tableaux d'octets. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Enregistre les données de l'objet dans le flux spécifié. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Enregistre les données de l'objet à l'emplacement de fichier spécifié. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier spécifié en fonction des options d'enregistrement. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier spécifié en fonction des options d'enregistrement. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier spécifié en fonction des options d'enregistrement. |
...
| Nom | La description |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Représente la signature du mode de fusion. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | La taille de l'en-tête du calque. |
