...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.Layer. Le calque psd"
type: docs
weight: 2270
...
| Nom | Description |
| --- | --- |
| [Layer](layer/#constructor)() | Initialise une nouvelle instance de la classe `Layer`. Constructeur pour l'initialisation paresseuse. |
| [Layer](layer/#constructor_3)(Stream) | Initialise une nouvelle instance de la classe `Layer`. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Initialise une nouvelle instance de la classe `Layer`. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Initialise une nouvelle instance de la classe `Layer` à partir de tableaux d'octets. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Enregistre les données de l'objet à l'emplacement de fichier spécifié au format de fichier indiqué selon les options d'enregistrement. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Enregistre les données de l'image dans le flux spécifié au format de fichier indiqué selon les options d'enregistrement. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Enregistre les données de l'objet à l'emplacement de fichier spécifié au format de fichier indiqué selon les options d'enregistrement. |
