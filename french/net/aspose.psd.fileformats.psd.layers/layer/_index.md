...
| Nom | La description |
| --- | --- |
| [Layer](layer#constructor)() | Initialise une nouvelle instance du[`Layer`](../layer) classer. Constructeur pour l'initialisation paresseuse. |
| [Layer](layer#constructor_3)(Stream) | Initialise une nouvelle instance du[`Layer`](../layer) classe. |
| [Layer](layer#constructor_1)(RasterImage, bool) | Initialise une nouvelle instance du[`Layer`](../layer) classe. |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Initialise une nouvelle instance du[`Layer`](../layer) classe à partir de tableaux d'octets. |
