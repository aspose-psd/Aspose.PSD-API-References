...
description: "Propriété StrokeEffect. Obtient ou définit une valeur indiquant si ce StrokeEffect fusionnera le trait avec le contenu du calque actuel"
type: docs
weight: 60
...
Obtient ou définit une valeur indiquant si ce [`StrokeEffect`](../) fusionnera le trait avec le contenu du calque actuel.
...
`true` si le trait doit être fusionné avec le contenu du calque actuel ; sinon, `false`.
