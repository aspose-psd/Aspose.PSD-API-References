...
description: Obtient ou définit une valeur indiquant si cetteStrokeEffectaspose.psd.fileformats.psd.layers.layereffects/strokeeffect mélangera le trait avec le contenu du calque actuel.
type: docs
weight: 60
...
Obtient ou définit une valeur indiquant si cette[`StrokeEffect`](../../strokeeffect) mélangera le trait avec le contenu du calque actuel.
...
`vrai`s'il doit mélanger le trait avec le contenu du calque actuel ; Par ailleurs,`faux` .
