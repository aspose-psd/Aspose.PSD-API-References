...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerEffects.StrokePosition énumération. Le paramètre de position contrôle lalignement de votre trait sur le calque auquel il est appliqué dans leStrokeEffect .
type: docs
weight: 2200
...
Le paramètre de position contrôle l'alignement de votre trait sur le calque auquel il est appliqué dans le[`StrokeEffect`](../strokeeffect/) .
...
| --- | --- | --- |
| Inside | `0` | Le trait sera créé à partir du bord de la forme et se développera vers l'intérieur, jusqu'au centre de l'objet. |
| Center | `1` | Le trait sera créé à partir du bord de la forme et se développera à la fois vers l'intérieur et vers l'extérieur. |
| Outside | `2` | Le trait sera créé à partir du bord de la forme et se développera vers l'extérieur, loin de l'objet. |
