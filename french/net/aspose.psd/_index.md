...
description: Lespace de noms est le noyau des espaces de noms imbriqués et les objets les plus élémentaires utilisés pour le traitement Aspose.PSD.
type: docs
weight: 10
url: /fr/net/aspose.psd/
---
L'espace de noms est le noyau des espaces de noms imbriqués et les objets les plus élémentaires utilisés pour le traitement Aspose.PSD.
...
| [CmykColorHelper](./cmykcolorhelper/) | Méthodes d'assistance pour travailler avec la couleur CMJN présentée sous la forme d'une valeur entière 32 bits signée. Fournit l'API similaire à[`CmykColor`](../aspose.psd/cmykcolor/)struct. C'est plus léger car la couleur CMJN est présentée comme Int32 plutôt que comme une structure avec des champs internes. Veuillez préférer utiliser les méthodes statiques de cette classe lorsque cela est possible au lieu de l'obsolète [`CmykColor`](../aspose.psd/cmykcolor/) structure. |
...
| [ColorMap](./colormap/) | Définit une carte pour convertir les couleurs. Plusieurs méthodes de la[`ImageAttributes`](../aspose.psd/imageattributes/) classe ajuste les couleurs de l'image à l'aide d'une table de remappage des couleurs, qui est un tableau de[`ColorMap`](../aspose.psd/colormap/) structures. Non héréditaire. |
| [ColorMatrix](./colormatrix/) | Définit une matrice 5 x 5 qui contient les coordonnées de l'espace RGBA. Plusieurs méthodes de la[`ImageAttributes`](../aspose.psd/imageattributes/) ajuste les couleurs de l'image à l'aide d'une matrice de couleurs. Cette classe ne peut pas être héritée. |
...
| [FontSettings](./fontsettings/) | Paramètres généraux des polices de rendu des formats vectoriels PSD. |
...
| [ImageAttributes](./imageattributes/) | Un[`ImageAttributes`](../aspose.psd/imageattributes/) L'objet contient des informations sur la manière dont les couleurs des bitmaps et des métafichiers sont manipulées lors du rendu. Un[`ImageAttributes`](../aspose.psd/imageattributes/) L'objet conserve plusieurs paramètres d'ajustement des couleurs, notamment les matrices d'ajustement des couleurs, les matrices d'ajustement des niveaux de gris, les valeurs de correction gamma, les tables de cartes de couleurs et les valeurs de seuil de couleur. Pendant le rendu, les couleurs peuvent être corrigées, assombries, éclaircies et supprimées. Pour appliquer de telles manipulations, initialisez un[`ImageAttributes`](../aspose.psd/imageattributes/)objet et passez le chemin de celui-ci[`ImageAttributes`](../aspose.psd/imageattributes/) objet (ainsi que le chemin d'un[`Image`](../aspose.psd/image/) ) à la méthode DrawImage. |
...
| [PixelsData](./pixelsdata/) | La classe pour stocker les données des pixels de l'image et ses limites. |
...
| --- | --- |
| [CmykColor](./cmykcolor/) | La couleur CMJN du pixel. |
| [Color](./color/) | La couleur du pixel. |
| [Point](./point/) | Représente une paire ordonnée de coordonnées x et y entières qui définissent un point dans un plan bidimensionnel. |
...
| [Rectangle](./rectangle/) | Stocke un ensemble de quatre nombres entiers qui représentent l'emplacement et la taille d'un rectangle. |
| [RectangleF](./rectanglef/) | Stocke un ensemble de quatre nombres à virgule flottante qui représentent l'emplacement et la taille d'un rectangle. |
...
| [IImageExporter](./iimageexporter/) | L'exportateur d'images. Peut exporter des données du format Aspose.PSD interne vers un format de données spécifié. |
...
| [IPsdColorPalette](./ipsdcolorpalette/) | La palette de couleurs passées |
...
| [ColorMatrixFlag](./colormatrixflag/) | Spécifie les types d'images et de couleurs qui seront affectés par les paramètres de réglage des couleurs et des niveaux de gris d'un[`ImageAttributes`](../aspose.psd/imageattributes/) . |
...
| [DashStyle](./dashstyle/) | Spécifie le style des lignes pointillées dessinées avec un[`Pen`](../aspose.psd/pen/) objet. |
...
| [HatchStyle](./hatchstyle/) | Spécifie les différents modèles disponibles pour[`HatchBrush`](../aspose.psd.brushes/hatchbrush/) objets. |
...
| [InterpolationMode](./interpolationmode/) | Le[`InterpolationMode`](../aspose.psd/interpolationmode/) l'énumération spécifie l'algorithme utilisé lorsque les images sont mises à l'échelle ou pivotées. |
| [KnownColor](./knowncolor/) | Spécifie les couleurs système connues. |
| [LineCap](./linecap/) | Spécifie les styles de capuchon disponibles avec lesquels un[`Pen`](../aspose.psd/pen/) l'objet peut terminer une ligne. |
| [LineJoin](./linejoin/) | Spécifie comment joindre des segments de ligne ou de courbe consécutifs dans une figure (sous-chemin) contenue dans un[`GraphicsPath`](../aspose.psd/graphicspath/) objet. |
...
| [PenAlignment](./penalignment/) | Spécifie l'alignement d'un[`Pen`](../aspose.psd/pen/) objet par rapport à la ligne théorique de largeur nulle. |
| [PenType](./pentype/) | Spécifie le type de remplissage a[`Pen`](../aspose.psd/pen/) objet utilise pour remplir les lignes. |
...
| [SeekOrigin](./seekorigin/) | Fournit les champs qui représentent les points de référence dans[`StreamContainer`](../aspose.psd/streamcontainer/) pour chercher. |
