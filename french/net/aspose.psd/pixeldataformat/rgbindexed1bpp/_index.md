...
description: Obtient lePixelDataFormataspose.psd/pixeldataformat défini pour indexé 1 bit par couleur. Le stockage de données de pixels indexés est destiné à permettre le stockage et la récupération de données partout où la palette de couleurs est utilisée. À utiliser avec prudence car peut nécessiter une conversion dune palette à une autre ou de RVBA à un modèle de couleurs indexées .
type: docs
weight: 110
url: /fr/net/aspose.psd/pixeldataformat/rgbindexed1bpp/
---
