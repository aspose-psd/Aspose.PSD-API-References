...
description: Obtient lePixelDataFormataspose.psd/pixeldataformat défini pour 8 bits indexés par couleur. Le stockage de données de pixels indexés est destiné à permettre le stockage et la récupération de données partout où la palette de couleurs est utilisée. À utiliser avec prudence car peut nécessiter une conversion dune palette à une autre ou de RVBA à un modèle de couleurs indexées .
type: docs
weight: 140
url: /fr/net/aspose.psd/pixeldataformat/rgbindexed8bpp/
---
