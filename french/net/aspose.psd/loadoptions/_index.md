...
description: Aspose.PSD.LoadOptions classe. Représente les options de chargement.
type: docs
weight: 5080
...
| [DataBackgroundColor](../../aspose.psd/loadoptions/databackgroundcolor/) { get; set; } | Obtient ou définit le[`Image`](../image/) arrière-plan[`Color`](../color/) . |
