...
description: Aspose.PSD.DataStreamSupporter classe. Le conteneur de flux de données.
type: docs
weight: 740
...
| virtual [Save](../../aspose.psd/datastreamsupporter/save/#save)() | Enregistre les données de l'objet dans la`DataStreamSupporter` . |
