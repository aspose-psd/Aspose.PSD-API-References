...
description: Aspose.PSD.Image classe. Limage est la classe de base pour tous les types dimages.
type: docs
weight: 4590
...
| [Container](../../aspose.psd/image/container/) { get; } | Obtient le`Image` conteneur. |
