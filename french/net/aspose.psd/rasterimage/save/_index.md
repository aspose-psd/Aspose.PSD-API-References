...
description: RasterImage méthode. Enregistre les données de limage dans le flux spécifié dans le format de fichier spécifié en fonction des options denregistrement.
type: docs
weight: 490
