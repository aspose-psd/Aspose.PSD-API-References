...
description: GraphicsPath méthode. Applique une transformation warp définie par un rectangle et un parallélogramme à cetteGraphicsPath .
type: docs
weight: 180
...
Applique une transformation warp, définie par un rectangle et un parallélogramme, à cette[`GraphicsPath`](../) .
