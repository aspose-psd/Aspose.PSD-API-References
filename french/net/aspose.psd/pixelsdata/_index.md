...
description: La classe pour stocker les données des pixels de limage et ses limites.
type: docs
weight: 5180
...
| Nom | La description |
| --- | --- |
| [PixelsData](pixelsdata#constructor)() | Initialise une nouvelle instance du[`PixelsData`](../pixelsdata) classe. |
| [PixelsData](pixelsdata#constructor_1)(int[], Rectangle) | Initialise une nouvelle instance du[`PixelsData`](../pixelsdata) classe. |
