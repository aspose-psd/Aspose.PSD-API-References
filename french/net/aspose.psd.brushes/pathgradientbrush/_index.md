...
description: Encapsule unBrush../aspose.psd/brush objet avec un dégradé. Cette classe ne peut pas être héritée.
type: docs
weight: 170
...
| [SurroundColors](../../aspose.psd.brushes/pathgradientbrush/surroundcolors) { get; set; } | Obtient ou définit un tableau de couleurs qui correspondent aux points du chemin[`PathGradientBrush`](../pathgradientbrush) remplit. |
