...
description: Représente unBrush../aspose.psd/brush avec des capacités de dégradé et des propriétés appropriées.
type: docs
weight: 150
...
| [IsAngleScalable](../../aspose.psd.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | Obtient ou définit une valeur indiquant si[`Angle`](./angle) est changé lors des transformations avec ceci[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
