...
description: "Aspose.PSD.ImageOptions.Jpeg2000Options classe. Les options du format de fichier Jpeg2000"
type: docs
weight: 5320
...
Les options du format de fichier Jpeg2000.
...
| Nom | Description |
| --- | --- |
| [Jpeg2000Options](jpeg2000options/#constructor)() | Initialise une nouvelle instance de la classe `Jpeg2000Options`. |
| [Jpeg2000Options](jpeg2000options/#constructor_1)(Jpeg2000Options) | Initialise une nouvelle instance de la classe `Jpeg2000Options`. |
...
| [CompressionRatios](../../aspose.psd.imageoptions/jpeg2000options/compressionratios/) { get; set; } | Obtient ou définit le tableau des rapports de compression. Différents rapports de compression pour les couches successives. Le taux spécifié pour chaque niveau de qualité est le facteur de compression souhaité. Des rapports décroissants sont requis. |
...
| [Irreversible](../../aspose.psd.imageoptions/jpeg2000options/irreversible/) { get; set; } | Obtient ou définit une valeur indiquant s'il faut utiliser la DWT irréversible 9-7 (true) ou la compression DWT sans perte 5-3 (par défaut). |
