...
| [IsValid](../../aspose.psd.imageoptions/tiffoptions/isvalid) { get; } | Obtient une valeur indiquant si le[`TiffOptions`](../tiffoptions) ont été correctement configurés. Utilisez la méthode Validate as pour trouver la raison de l'échec. |
