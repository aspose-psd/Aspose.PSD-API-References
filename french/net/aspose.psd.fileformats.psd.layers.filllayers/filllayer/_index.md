...
description: Remplir le calque. Color Fill Gradient Fill ou Pattern Fill Layer qui diffère parFillSettings./filllayer/fillsettings
type: docs
weight: 1890
...
| Nom | La description |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | Créez une nouvelle instance de[`FillLayer`](../filllayer) classer par type de remplissage. |
