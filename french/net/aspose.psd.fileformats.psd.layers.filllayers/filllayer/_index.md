...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer classe. Remplir le calque. Color Fill Gradient Fill ou Pattern Fill Layer qui diffère parFillSettings
type: docs
weight: 1910
url: /fr/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

Remplir le calque. Color Fill, Gradient Fill ou Pattern Fill Layer qui diffère par[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Obtient les paramètres de remplissage. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Obtient le type de remplissage. |
...
| Nom | La description |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Créez une nouvelle instance de`FillLayer` classer par type de remplissage. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Remplace toutes les couleurs non transparentes par une nouvelle couleur et conserve la valeur alpha d'origine pour économiser des bords lisses. Remarque : si vous l'utilisez sur des images sans transparence, toutes les couleurs seront remplacées par une seule. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Met à jour les données de pixels de calque de remplissage en fonction de[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* espace de noms [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
