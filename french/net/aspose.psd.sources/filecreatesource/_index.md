...
description: Aspose.PSD.Sources.FileCreateSource classe. Représente une source de fichier pour la création.
type: docs
weight: 5590
...
| Nom | La description |
| --- | --- |
| [FileCreateSource](filecreatesource/#constructor)(string) | Initialise une nouvelle instance du`FileCreateSource` classe. |
| [FileCreateSource](filecreatesource/#constructor_1)(string, bool) | Initialise une nouvelle instance du`FileCreateSource` classe. |
