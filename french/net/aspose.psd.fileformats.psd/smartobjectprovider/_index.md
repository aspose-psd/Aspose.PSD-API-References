...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider classe. Définit le fournisseur dobjets intelligents qui permet dobtenir/de définir des sources de données à partir de ressources de liens globales du fichier PSD et de leur contenu.
type: docs
weight: 4000
url: /fr/net/aspose.psd.fileformats.psd/smartobjectprovider/
---
## SmartObjectProvider class

Définit le fournisseur d'objets intelligents qui permet d'obtenir/de définir des sources de données à partir de ressources de liens globales du fichier PSD et de leur contenu.
...
| Nom | La description |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Convertit les calques en un objet intelligent intégré. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Convertit les calques en un objet intelligent intégré. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Incorpore tous les objets intelligents liés dans l'image. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Crée un nouveau calque d'objet intelligent en copiant le calque source. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Met à jour le contenu de tous les objets intelligents modifiés dans l'image. |
