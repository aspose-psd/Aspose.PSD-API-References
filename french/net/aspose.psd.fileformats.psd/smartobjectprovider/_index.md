...
description: Définit le fournisseur dobjets intelligents qui permet dobtenir/de définir des sources de données à partir de ressources de liens globales du fichier PSD et de leur contenu.
type: docs
weight: 3940
