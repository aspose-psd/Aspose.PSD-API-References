...
description: "Aspose.PSD.FileFormats.Psd.SmartObjectProvider classe. Définit le fournisseur d'objet intelligent qui permet d'obtenir / de définir les sources de données à partir des ressources de lien globales du fichier PSD et de leur contenu."
type: docs
weight: 4470
...
Définit le fournisseur d'objet dynamique qui permet d'obtenir / de définir les sources de données à partir des ressources de lien globales du fichier PSD et de leur contenu.
...
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Intègre tous les objets intelligents liés dans l'image. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Crée un nouveau calque d'objet intelligent en copiant celui source. |
