...
description: Obtient ou définit le profil de couleur RVB pour les images PSD CMJN. Doit être en paire avec CmykColorProfile pour une conversion de couleur correcte.
type: docs
weight: 230
