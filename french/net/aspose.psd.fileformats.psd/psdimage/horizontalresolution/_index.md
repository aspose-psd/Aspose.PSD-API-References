...
description: Obtient ou définit la résolution horizontale en pixels par pouce de cePsdImageaspose.psd.fileformats.psd/psdimage .
type: docs
weight: 170
...
Obtient ou définit la résolution horizontale, en pixels par pouce, de ce[`PsdImage`](../../psdimage) .
