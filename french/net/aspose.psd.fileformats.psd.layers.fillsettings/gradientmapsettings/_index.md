...
description: "Classe Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientMapSettings. Classe de paramètres de dégradé pour le calque de carte de dégradé. Elle contient des propriétés communes aux deux types de dégradé, Solid et Noise."
type: docs
weight: 2080
url: /fr/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/
---
{{< psd/tize >}}
## GradientMapSettings class

Classe de paramètres de dégradé pour le calque de carte de dégradé. Elle contient des propriétés communes aux deux types de dégradé (Solide et Bruit).
...
| Nom | Description |
| --- | --- |
| [GradientMapSettings](gradientmapsettings/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/dither/) { get; set; } | Obtient ou définit une valeur indiquant si ce [`GradientFillSettings`](../gradientfillsettings/) est en tramage. |
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/) { get; set; } | Obtient ou définit une instance de définition de dégradé spécifique (Solid/Noise). |
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/interpolationmethod/) { get; set; } | Obtient ou définit la méthode d'interpolation du dégradé. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/reverse/) { get; set; } | Obtient ou définit une valeur indiquant si ce [`GradientFillSettings`](../gradientfillsettings/) est inversé. |
