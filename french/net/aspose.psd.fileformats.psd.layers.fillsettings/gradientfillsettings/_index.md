...
description: "Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientFillSettings class. Classe de définition de gradient de base. Elle contient des propriétés communes pour les deux types de gradient Solide et Bruit"
type: docs
weight: 2070
...
| Nom | Description |
| --- | --- |
| [GradientFillSettings](gradientfillsettings/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [AlignWithLayer](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/alignwithlayer/) { get; set; } | Obtient ou définit une valeur indiquant si [align with layer]. |
| [Angle](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/angle/) { get; set; } | Obtient ou définit l'angle. |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/dither/) { get; set; } | Obtient ou définit une valeur indiquant si ce `GradientFillSettings` est dither. |
...
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/gradient/) { get; set; } | Obtient ou définit une instance de définition de dégradé spécifique (Solid/Noise). |
| [GradientType](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/gradienttype/) { get; set; } | Obtient ou définit le type du dégradé. |
...
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/interpolationmethod/) { get; set; } | Obtient ou définit la méthode d'interpolation du dégradé. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/reverse/) { get; set; } | Obtient ou définit une valeur indiquant si ce `GradientFillSettings` est inversé. |
| [Scale](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientfillsettings/scale/) { get; set; } | Obtient ou définit l'échelle de gradient **normalisée** (en pourcentage) |
...
Le code suivant montre la prise en charge du calque d'effet de contour avec le type de remplissage - Gradient.
...
using (var im = (PsdImage)Image.Load(exportPath, loadOptions))
{
    ...
    // Vérifier les points transparents
