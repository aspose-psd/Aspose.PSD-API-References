...
description: Obtient ou définit une valeur indiquant si cettePatternFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/patternfillsettings est lié.
type: docs
weight: 50
...
Obtient ou définit une valeur indiquant si cette[`PatternFillSettings`](../../patternfillsettings) est lié.
