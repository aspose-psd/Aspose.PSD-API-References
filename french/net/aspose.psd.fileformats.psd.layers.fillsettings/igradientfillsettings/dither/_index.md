...
description: IGradientFillSettings propriété. Obtient ou définit une valeur indiquant si cetteIGradientFillSettings est le tramage.
type: docs
weight: 50
...
Obtient ou définit une valeur indiquant si cette[`IGradientFillSettings`](../) est le tramage.
