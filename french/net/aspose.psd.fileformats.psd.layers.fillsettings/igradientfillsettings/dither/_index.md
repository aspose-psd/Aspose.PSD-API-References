...
description: "Propriété IGradientFillSettings. Obtient ou définit une valeur indiquant si cet IGradientFillSettings utilise le tramage"
type: docs
weight: 30
url: /fr/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
{{< psd/tize >}}
## IGradientFillSettings.Dither property

Obtient ou définit une valeur indiquant si ce [`IGradientFillSettings`](../) utilise le tramage.
