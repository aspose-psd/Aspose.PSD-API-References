...
description: Obtient ou définit une valeur indiquant si cetteIGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings est le tramage.
type: docs
weight: 50
...
Obtient ou définit une valeur indiquant si cette[`IGradientFillSettings`](../../igradientfillsettings) est le tramage.
