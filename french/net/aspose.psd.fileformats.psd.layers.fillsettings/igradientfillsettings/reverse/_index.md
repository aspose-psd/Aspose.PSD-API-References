...
description: Obtient ou définit une valeur indiquant si cetteIGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings est inversé.
type: docs
weight: 90
...
Obtient ou définit une valeur indiquant si cette[`IGradientFillSettings`](../../igradientfillsettings) est inversé.
