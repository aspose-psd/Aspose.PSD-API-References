...
description: IGradientFillSettings propriété. Obtient ou définit une valeur indiquant si cetteIGradientFillSettings est inversé.
type: docs
weight: 90
url: /fr/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
## IGradientFillSettings.Reverse property

Obtient ou définit une valeur indiquant si cette[`IGradientFillSettings`](../) est inversé.
