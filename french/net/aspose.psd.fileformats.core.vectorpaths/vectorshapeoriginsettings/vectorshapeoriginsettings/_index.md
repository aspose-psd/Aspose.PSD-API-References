...
description: "Constructeur VectorShapeOriginSettings. Initialise une nouvelle instance de la classe VectorShapeOriginSettings"
type: docs
weight: 10
url: /fr/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

Initialise une nouvelle instance de la classe [`VectorShapeOriginSettings`](../).
...
| --- | --- | --- |
| isShapeInvalidated | Booléen | La valeur de forme invalidée. |
| originIndex | Int32 | L'index d'origine de la forme. |
