...
description: "Propriété VectorShapeOriginSettings. Obtient ou définit la matrice de transformation"
type: docs
weight: 170
...
// Cet exemple montre comment redimensionner les calques avec une ressource Vogt et un chemin vectoriel dans l'image PSD
float scaleX = 0.45f;
float scaleY = 1.60f;
