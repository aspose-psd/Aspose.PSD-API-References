---
title: "Classe VectorShapeTransform"
second_title: "Aspose.PSD pour .NET Référence de l'API"
description: "Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform class. Définit la classe de matrice de transformation de forme vectorielle"
type: docs
weight: 1470
...
| Nom | Description |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | Initialise une nouvelle instance de la classe `VectorShapeTransform`. |
...
Cet exemple montre comment obtenir et définir les nouvelles propriétés Transform et OriginBoxCorners de ShapeOriginSettings dans la ressource Vogt du FillLayer du fichier PSD.
