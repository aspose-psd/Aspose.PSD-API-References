...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform classe. Définit la classe de matrice de transformation de forme vectorielle
type: docs
weight: 1460
url: /fr/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/
---
## VectorShapeTransform class

Définit la classe de matrice de transformation de forme vectorielle
...
| Nom | La description |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | Initialise une nouvelle instance du`VectorShapeTransform` classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Tx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/tx/) { get; set; } | Obtient ou définit la valeur TX. |
| [Ty](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/ty/) { get; set; } | Obtient ou définit la valeur TY. |
| [Xx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx/) { get; set; } | Obtient ou définit la valeur XX. |
| [Xy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy/) { get; set; } | Obtient ou définit la valeur XY. |
| [Yx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yx/) { get; set; } | Obtient ou définit la valeur YX. |
| [Yy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yy/) { get; set; } | Obtient ou définit la valeur YY. |
...
Cet exemple montre comment obtenir et définir les nouvelles propriétés Transform et OriginBoxCorners de ShapeOriginSettings dans la ressource Vogk de FillLayer dans le fichier PSD.

```csharp
[C#]

// Cet exemple montre comment obtenir et définir les nouvelles propriétés Transform et OriginBoxCorners
// de ShapeOriginSettings dans la ressource Vogk de FillLayer dans le fichier PSD
...
using (PsdImage image = (PsdImage)Image.Load(sourceFileName))
{
    ...
    // Assertion de nouvelles propriétés
    ...
    // Enregistrez cette image PSD avec les propriétés modifiées.
    image.Save(outputPath, new PsdOptions(image));
}

// Charge l'image PSD enregistrée avec les propriétés modifiées.
using (PsdImage image = (PsdImage)Image.Load(outputPath))
{
    ...
    // Confirme que les propriétés sont enregistrées et chargées correctement 
    var setting = resource.ShapeOriginSettings[0];
    AssertAreEqual(true, setting.IsOriginIndexPresent);
    AssertAreEqual(false, setting.IsShapeInvalidatedPresent);
    AssertAreEqual(true, setting.IsOriginResolutionPresent);
