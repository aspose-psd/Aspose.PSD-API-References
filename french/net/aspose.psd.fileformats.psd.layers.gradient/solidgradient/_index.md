...
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.SolidGradient class. Paramètres d'effet de remplissage du dégradé"
type: docs
weight: 2230
url: /fr/net/aspose.psd.fileformats.psd.layers.gradient/solidgradient/
---
{{< psd/tize >}}
## SolidGradient class

Paramètres de l'effet de remplissage du dégradé.
...
| Nom | Description |
| --- | --- |
| [SolidGradient](solidgradient/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [ColorPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/colorpoints/) { get; set; } | Obtient ou définit les points de couleur. |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/gradientmode/) { get; } | Obtient le mode pour ce dégradé. Détermine 'Gradient Type' = 'Solid/Noise' (0/1). |
...
| [Interpolation](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/interpolation/) { get; set; } | Obtient ou définit l'interpolation. Détermine la douceur lorsque le 'Type de dégradé' = 'Solide'. Plage de valeurs : 0-4096. |
| [TransparencyPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/transparencypoints/) { get; set; } | Obtient ou définit les points de transparence. |

## Méthodes

| Nom | Description |
| --- | --- |
| [AddColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addcolorpoint/)() | Ajoute le point de couleur. |
| [AddTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addtransparencypoint/)() | Ajoute le point de couleur. |
| [RemoveColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removecolorpoint/)(IGradientColorPoint) | Supprime le point de couleur. |
| [RemoveTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removetransparencypoint/)(IGradientTransparencyPoint) | Supprime le point de transparence. |
| static [GenerateLfx2ResourceNodes](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/generatelfx2resourcenodes/)() | Génère les nœuds de ressources LFX2. |
