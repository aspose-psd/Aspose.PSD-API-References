...
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.NoiseGradient class. Classe de définition du dégradé bruit"
type: docs
weight: 2220
url: /fr/net/aspose.psd.fileformats.psd.layers.gradient/noisegradient/
---
{{< psd/tize >}}
## NoiseGradient class
...
| Nom | Description |
| --- | --- |
| [NoiseGradient](noisegradient/)() | Le constructeur par défaut. |

## Propriétés

| Nom | Description |
| --- | --- |
| [ColorModel](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/colormodel/) { get; set; } | Obtient ou définit le modèle de couleur - RGB/HSB/LAB (3/4/6). |
| [ExpansionCount](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/expansioncount/) { get; set; } | Obtient ou définit le nombre d'expansion ( = 2 pour Photoshop 6.0). |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/gradientmode/) { get; } | Obtient le mode pour ce dégradé. Détermine 'Gradient Type' = 'Solid/Noise' (0/1). |
...
| [MaximumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/maximumcolor/) { get; set; } | Obtient ou définit la couleur maximale de PixelDataFormat. |
| [MinimumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/minimumcolor/) { get; set; } | Obtient ou définit la couleur minimale de PixelDataFormat. |
| [RndNumberSeed](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/rndnumberseed/) { get; set; } | Obtient ou définit la graine du nombre aléatoire utilisée pour générer les couleurs du dégradé de bruit. |
| [Roughness](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/roughness/) { get; set; } | Obtient ou définit le facteur de rugosité. |
| [ShowTransparency](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/showtransparency/) { get; set; } | Obtient ou définit le drapeau d'affichage de la transparence. |
| [UseVectorColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/usevectorcolor/) { get; set; } | Obtient ou définit le drapeau d'utilisation de la couleur vectorielle. |
