...
description: "Définit la classe SmartObjectLayer qui contient un objet intelligent intégré dans le fichier PSD ou un objet intelligent lié dans le fichier externe."
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Définit la classe SmartObjectLayer qui contient un objet intelligent intégré dans le fichier PSD ou un objet intelligent lié dans le fichier externe. Avec les objets intelligents, vous pouvez : Effectuer des transformations non destructives. Vous pouvez mettre à l'échelle, faire pivoter, incliner, déformer, appliquer une transformation de perspective ou déformer une couche sans perdre les données ou la qualité de l'image originale car les transformations don\\ufffdt affectent les données originales. Travailler avec des données vectorielles, telles que des illustrations vectorielles d'Illustrator, qui seraient autrement rasterisées. Effectuer un filtrage non destructif. Vous pouvez modifier les filtres appliqués aux objets intelligents à tout moment. Modifier un objet intelligent et mettre à jour automatiquement toutes ses instances liées. Appliquer un masque de calque qui\\ufffds soit lié, soit non lié à la couche d'objet intelligent. Essayer diverses conceptions avec des images de substitution à basse résolution que vous remplacerez plus tard par les versions finales. Dans Adobe\\ufffd Photoshop\\ufffd, vous pouvez intégrer le contenu d'une image dans un document PSD. Plus d'informations ici :   Une couche avec un objet intelligent intégré contient des ressources placées (PlLd) et SoLd avec les propriétés de l'objet intelligent. La ressource PlLd peut être seule pour les versions PSD antérieures à 10. Ces ressources contiennent l'UniqueId du LiFdDataSource dans le Lnk2Resource global avec le nom de fichier intégré et d'autres paramètres, y compris le contenu du fichier intégré au format original sous forme de tableau d'octets.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Initialise une nouvelle instance de la classe [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Champs

| Champ | Description |
| --- | --- |
| [BlendSignature](#BlendSignature) | Représente la signature du mode de fusion. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Le message indiquant que les ressources placées et les objets intelligents ont été trouvés |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Le message Vous ne pouvez copier qu'un objet intelligent intégré |
| [LayerHeaderSize](#LayerHeaderSize) | La taille de l'en-tête du calque. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Le message Aucun objet placé ou ressource d'objet intelligent trouvé |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Le message Indices de ressource placée incorrects |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Convertit cet objet intelligent intégré en un objet intelligent lié. |
...
| [duplicateLayer()](#duplicateLayer--) | Crée une nouvelle couche d'objet intelligent en copiant celle-ci. |
| [embedLinked()](#embedLinked--) | Intègre l'objet intelligent lié dans ce calque. |
| [equals(Object obj)](#equals-java.lang.Object-) | Détermine si l'Objet spécifié est égal à cette instance. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Exporte le contenu intégré ou lié vers un fichier. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Obtient ou définit le rendu de la déformation ou utilise l'image PS |
...
| [getContentType()](#getContentType--) | Obtient le type du contenu de la couche d'objet intelligent. |
| [getContents()](#getContents--) | Obtient ou définit le contenu du calque d'objet intelligent. |
| [getContentsBounds()](#getContentsBounds--) | Obtient ou définit les limites du contenu de l'objet intelligent. |
| [getContentsSource()](#getContentsSource--) | Obtient ou définit la source du contenu de l'objet intelligent. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Il obtient ou définit la dernière taille de l'image à déformer |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Obtient ou définit le quadrilatère original. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Obtient les indices des ressources du calque placé et intelligent ainsi que la ressource placée appropriée. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Obtient la ressource du calque placé |
...
| [getSmartFilters()](#getSmartFilters--) | Obtient les filtres intelligents. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Obtient ou définit le quadrilatère de transformation. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Il obtient des fonctions qui aident avec la déformation. |
| [getWarpSettings()](#getWarpSettings--) | Il obtient ou définit les paramètres de Warp qui ont été définis ou obtenus à partir de la ressource (par défaut) |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Obtient le contenu image intégré ou lié du calque d'objet intelligent. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Crée une nouvelle couche d'objet intelligent en copiant celle-ci. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Invoqué lorsque le conteneur de ce [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) a été défini. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Relie à nouveau l'objet intelligent lié à un nouveau fichier. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Remplace le contenu de l'objet intelligent intégré dans le calque d'objet intelligent. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Remplace le contenu de l'objet intelligent intégré dans le calque d'objet intelligent. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Remplace le contenu par un fichier. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Remplace le contenu par un fichier. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Remplace le contenu par un fichier. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Remplace le contenu par un fichier. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Redimensionne les données des canaux |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Obtient ou définit le rendu de la déformation ou utilise l'image PS |
...
| [setContents(byte[] value)](#setContents-byte---) | Obtient ou définit le contenu du calque d'objet intelligent. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Obtient ou définit les limites du contenu de l'objet intelligent. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Obtient ou définit la source du contenu de l'objet intelligent. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Il obtient ou définit la dernière taille de l'image à déformer |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Obtient ou définit le quadrilatère original. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Obtient le fournisseur d'objets intelligents. |
| [setTop(int value)](#setTop-int-) | Obtient ou définit la position de la couche supérieure. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Obtient ou définit le quadrilatère de transformation. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Il obtient ou définit les paramètres de Warp qui ont été définis ou obtenus à partir de la ressource (par défaut) |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Met à jour l'identifiant de la source de données. |
| [updateModifiedContent()](#updateModifiedContent--) | Met à jour le cache d'image du calque d'objet intelligent avec le contenu modifié. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Met à jour le cache d'image du calque d'objet intelligent avec le contenu modifié. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Met à jour les ressources placées / intelligentes lorsque placedResource est modifiée ou lorsqu'une conversion est nécessaire. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | C'est un wrapper pour "IWarpSupport" afin de mettre à jour l'aperçu du calque |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Le flux d'éléments |
...
Le message indiquant que les ressources placées et les objets intelligents ont été trouvés
...
Le message Vous ne pouvez copier qu'un objet intelligent intégré
...
Le message Aucun objet placé ou ressource d'objet intelligent trouvé
...
Le message Indices de ressource placée incorrects
...
| Paramètre | Type | Description |
| --- | --- | --- |
| linkedPath | java.lang.String | Le chemin lié. |
...
Crée un nouveau calque d'objet intelligent en copiant celui-ci. Notez que pour les objets intelligents intégrés, l'image intégrée est partagée. Si vous souhaitez copier l'image intégrée, utilisez la méthode [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy).
...
Intègre l'objet intelligent lié dans ce calque.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| filePath | java.lang.String | Le chemin du fichier d'export. |
...
Obtient ou définit le rendu de la déformation ou utilise l'image PS
...
Obtient le type du contenu du calque d'objet dynamique. Le contenu intégré de l'objet dynamique est le fichier image brut intégré :  LiFdDataSource.Data . Le contenu lié de l'objet dynamique est le contenu brut du fichier image lié s'il est disponible : [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Nous ne prenons pas en charge le chargement depuis la bibliothèque graphique Adobe\ufffd Photoshop\ufffd \ufffd\ufffd lorsque LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) est vrai. Pour les fichiers liés ordinaires, nous utilisons d'abord LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) pour rechercher le fichier relativement au chemin de l'image source DataStreamSupporter.SourceImagePath ; s'il n'est pas disponible nous consultons LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), sinon nous recherchons le fichier lié dans le même répertoire que notre image : DataStreamSupporter.SourceImagePath.

Valeur : le type du contenu du calque d'objet dynamique.
...
Obtient ou définit le contenu du calque d'objet dynamique. Le contenu intégré de l'objet dynamique est le fichier image brut intégré :  LiFdDataSource.Data  et ses propriétés. Le contenu lié de l'objet dynamique est le contenu brut du fichier image lié s'il est disponible et ses propriétés : [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Nous ne prenons pas en charge le chargement depuis la bibliothèque graphique Adobe\ufffd Photoshop\ufffd \ufffd\ufffd lorsque LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) est vrai. Pour les fichiers liés ordinaires, nous utilisons d'abord LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) pour rechercher le fichier relativement au chemin de l'image source DataStreamSupporter.SourceImagePath ; s'il n'est pas disponible nous consultons LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), sinon nous recherchons le fichier lié dans le même répertoire que notre image : DataStreamSupporter.SourceImagePath.
...
Obtient ou définit les limites du contenu de l'objet intelligent.

Valeur : les limites de l'objet dynamique.
...
Valeur : la source de données de l'objet dynamique.
...
Il obtient ou définit la dernière taille de l'image à déformer
...
Obtient ou définit le quadrilatère original.

Valeur : le quadrilatère original.
...
Obtient les indices des ressources du calque placé et intelligent ainsi que la ressource placée appropriée.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Les ressources. |
| placedResourceIndex | int[] | Indice de la ressource placée. |
| smartResourceIndex | int[] | Indice de la ressource dynamique. |
...
Obtient la ressource du calque placé
...
Obtient les filtres intelligents.
...
Obtient ou définit le quadrilatère de transformation.

Valeur : le quadrilatère de transformation.
...
Il obtient des fonctions qui aident avec la déformation.
...
Il obtient ou définit les paramètres de Warp qui ont été définis ou obtenus à partir de la ressource (par défaut)
...
| Paramètre | Type | Description |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Les options. |
...
Crée un nouveau calque d'objet dynamique en copiant celui-ci. Reproduit Calque -> Objets dynamiques -> Nouvel objet dynamique via la fonction Copier d'Adobe\ufffd Photoshop\ufffd. Notez qu'elle n'est activée que pour les objets dynamiques incorporés car l'image incorporée est également copiée. Si vous souhaitez partager l'image incorporée, utilisez la méthode [.duplicateLayer](../../null/\#duplicateLayer).
...
Invoqué lorsque le conteneur de ce [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) a été défini.
...
Relie à nouveau l'objet dynamique lié à un nouveau fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | L'image. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | L'image. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Les paramètres de résolution. Si null, la résolution de l'image sera utilisée. |
...
Remplace le contenu par un fichier. Il n'est pas nécessaire d'appeler la méthode UpdateModifiedContent par la suite.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Le chemin lié. |
| isReplaceOnlyThis | booléen | Le drapeau indique de remplacer le contenu de ce calque dynamique ou de tous les calques dynamiques avec ce contenu. |
...
Redimensionne les données des canaux
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Met à jour l'identifiant de la source de données.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | L'identifiant de la source de données. |
...
Met à jour le cache d'image du calque d'objet intelligent avec le contenu modifié.
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | L'image. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | La résolution. |
| skipBoundsUpdate | booléen | si défini sur  true  [skip bounds update]. |
...
Met à jour les ressources placées / intelligentes lorsque placedResource est modifiée ou lorsqu'une conversion est nécessaire.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| toEmbedded | booléen | si défini sur  true  convertit en ressource incorporée si nécessaire, sinon en ressource liée. |
...
C'est un wrapper pour "IWarpSupport" afin de mettre à jour l'aperçu du calque

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Pixels et taille de la nouvelle image d'aperçu |
