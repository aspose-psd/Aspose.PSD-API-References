...
type: docs
weight: 91
url: /fr/java/com.aspose.psd/resizetype/
---
...
| [CubicBSpline](#CubicBSpline) | La méthode d'interpolation cubique CubicBSpline |
...
Rééchantillonner en utilisant l'interpolation bilinéaire. Le préfiltrage d'image est autorisé pour supprimer le bruit avant le rééchantillonnage, si nécessaire.
...
La méthode d'interpolation cubique CubicBSpline
