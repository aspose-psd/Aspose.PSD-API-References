...
type: docs
weight: 12
url: /fr/java/com.aspose.psd.shapes/curveshape/
---
...
| [CurveShape(PointF[] points)](#CurveShape-com.aspose.psd.PointF---) | Initialise une nouvelle instance de la classe CurveShape. |
| [CurveShape(PointF[] points, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---boolean-) | Initialise une nouvelle instance de la classe CurveShape. |
| [CurveShape(PointF[] points, float tension)](#CurveShape-com.aspose.psd.PointF---float-) | Initialise une nouvelle instance de la classe CurveShape. |
| [CurveShape(PointF[] points, float tension, boolean isClosed)](#CurveShape-com.aspose.psd.PointF---float-boolean-) | Initialise une nouvelle instance de la classe CurveShape. |
## Méthodes
...
| points | [PointF\[\]](../../com.aspose.psd/pointf) | Le tableau de points. |
| tension | float | La tension de la courbe. |
| isClosed | booléen | si elle est définie sur true, la courbe est fermée. |
