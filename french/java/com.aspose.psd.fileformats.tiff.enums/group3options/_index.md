...
description: "Options pour le codage fax CCITT Group 3/4. Valeurs possibles pour les balises GROUP3OPTIONS / TiffTag.T4OPTIONS et TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS."
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
Options pour le codage fax CCITT Group 3/4.

Valeurs possibles pour les balises GROUP3OPTIONS / TiffTag.T4OPTIONS et TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS.
## Champs

| Champ | Description |
| --- | --- |
| [Encoding1D](#Encoding1D) | Codage unidimensionnel. |
| [Encoding2D](#Encoding2D) | Codage bidimensionnel. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | Remplir jusqu'à la limite d'octet. |
| [Uncompressed](#Uncompressed) | Données non compressées. |
## Méthodes
...
Codage unidimensionnel. (par défaut)
...
Remplir jusqu'à la limite d'octet.
