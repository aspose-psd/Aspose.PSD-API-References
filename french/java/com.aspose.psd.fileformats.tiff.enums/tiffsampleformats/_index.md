...
description: "Énumération de format d'échantillon"
type: docs
weight: 24
url: /fr/java/com.aspose.psd.fileformats.tiff.enums/tiffsampleformats/
---
...
Énumération de format d'échantillon
## Champs

| Champ | Description |
| --- | --- |
| [ComplexIeeeFp](#ComplexIeeeFp) | Complexe ieee flottant |
| [ComplexInt](#ComplexInt) | Entier signé complexe |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IeeeFp](#IeeeFp) | Données à virgule flottante IEEE |
| [Int](#Int) | Données entières signées |
| [Uint](#Uint) | Données entières non signées |
| [Void](#Void) | Données non typées |
## Méthodes
...
Données à virgule flottante IEEE
