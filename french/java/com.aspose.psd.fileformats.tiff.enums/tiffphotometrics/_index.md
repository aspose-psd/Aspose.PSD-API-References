...
description: "Énumération d'interpolation photométrique"
type: docs
weight: 20
url: /fr/java/com.aspose.psd.fileformats.tiff.enums/tiffphotometrics/
---
...
| [Mask](#Mask) | [obsolète depuis TIFF rev. |
| [MinIsBlack](#MinIsBlack) | La valeur minimale est noire. |
| [MinIsWhite](#MinIsWhite) | La valeur minimale est blanche. |
| [Palette](#Palette) | Carte des couleurs indexée. |
| [Rgb](#Rgb) | Modèle de couleur RGB. |
| [Separated](#Separated) | Séparations de couleur. |
| [Ycbcr](#Ycbcr) | Le CCIR 601. |
## Méthodes
...
ICC L\*a\*b\*. Introduit après la révision TIFF 6.0 par le Technote TIFF d'Adobe 4.
...
La valeur minimale est blanche.
