...
description: "Calque de forme."
type: docs
weight: 29
url: /fr/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Shape layer. Encapsule la logique de travail avec le Shape layer et les ressources associées.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Initialise une nouvelle instance de la classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Champs
...
| [createInstance()](#createInstance--) | Crée une nouvelle instance de la classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Paramètres de remplissage pour la zone interne des formes dans le Shape layer. |
...
| [getPath()](#getPath--) | Obtient l'ensemble des chemins présents dans un Shape layer. |
...
| [getStroke()](#getStroke--) | Obtient ou définit les paramètres de contour des formes. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Appelé lorsque [global resources changed]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Appelé lorsque [resources change]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Paramètres de remplissage pour la zone interne des formes dans le Shape layer. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Obtient ou définit les paramètres de contour des formes. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Met à jour les ressources à partir des propriétés du Shape layer. |
...
Initialise une nouvelle instance de la classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). Toutes les ressources sont créées dans leur état par défaut.
...
Crée une nouvelle instance de la classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
Paramètres de remplissage pour la zone interne des formes dans le Shape layer.
...
Obtient l'ensemble des chemins présents dans un Shape layer.
...
Obtient ou définit les paramètres de contour des formes.
...
**Returns:**
boolean - Valeur booléenne indiquant que le calque est valide.
...
Appelé lorsque [global resources changed].

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| expéditeur | java.lang.Object | L'expéditeur. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | L'instance EventArgs contenant les données de l'événement. |
...
Appelé lorsque [resources change].
...
Met à jour les ressources à partir des propriétés du Shape layer.
