...
description: "La classe de calque de planche à dessin."
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
La classe de calque de planche à dessin.
## Champs
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Ajoute le calque au groupe de calques. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Ajoute le calque au groupe de calques. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Ajoute le groupe de calques. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Obtient ou définit la couleur d'arrière-plan de l'artboard. |
...
| [getLayers()](#getLayers--) | Obtient les calques du groupe de calques |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Obtient les limites réelles de ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Obtient le  LayerSectionResource  à partir des ressources. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Obtient ou définit une valeur indiquant si [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) possède la couleur d'arrière-plan. |
...
| [isOpen()](#isOpen--) | Obtient ou définit si le dossier est ouvert ; si la valeur est  true , le groupe sera en état ouvert au démarrage, sinon il sera réduit. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Obtient ou définit la couleur d'arrière-plan de l'artboard. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Obtient ou définit si le dossier est ouvert ; si la valeur est  true , le groupe sera en état ouvert au démarrage, sinon il sera réduit. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Le calque. |
| index | int | L'index auquel le calque sera inséré. Les valeurs invalides signifient la fin de la liste des calques. |
...
Construit les marqueurs de début et de fin de groupe.
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Retourne un tableau de deux objets LayerGroup, où le premier [0] est le marqueur de début de groupe et le second [1] est le marqueur de fin de groupe.
### cacheData() {#cacheData--}
```
...
Obtient les limites réelles de ArtboardLayer.
...
Obtient le  LayerSectionResource  à partir des ressources.
...
Obtient ou définit une valeur indiquant si [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) possède la couleur d'arrière-plan.
...
Obtient ou définit si le dossier est ouvert ; si la valeur est  true , le groupe sera en état ouvert au démarrage, sinon il sera réduit.
