...
description: "Les indicateurs du masque de calque"
type: docs
weight: 24
url: /fr/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| Champ | Description |
| --- | --- |
| [Disabled](#Disabled) | Le masque de calque est désactivé. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | Inverser le masque de calque lors du mélange. |
| [None](#None) | Aucun drapeau défini. |
| [RelativeToLayer](#RelativeToLayer) | La position est relative au calque. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | Indique que le masque utilisateur provient réellement du rendu d'autres données. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | Indique que les masques utilisateur et/ou vectoriel ont des paramètres appliqués. |
## Méthodes
...
Le masque de calque est désactivé.
...
Inverser le masque de calque lors du mélange.
...
La position est relative au calque.
...
Indique que le masque utilisateur provient réellement du rendu d'autres données.
...
Indique que les masques utilisateur et/ou vectoriel ont des paramètres appliqués.
