...
description: "La classe du calque de texte"
type: docs
weight: 30
url: /fr/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Corrige la taille de la police |
...
| [createInstance_internalized()](#createInstance-internalized--) | Crée une nouvelle instance de la classe [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Crée une nouvelle instance de la classe [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Obtient les données du moteur. |
...
| [getFont()](#getFont--) | Obtient la police. |
| [getFonts()](#getFonts--) | Obtient l'ensemble des polices du calque de texte. |
...
| [getInnerText()](#getInnerText--) | Obtient le texte du calque |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Obtient ou définit le processeur de ressources. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Obtient le format de chaîne. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Obtient la racine de synchronisation. |
| [getText()](#getText--) | Obtient le texte. |
| [getTextBoundBox()](#getTextBoundBox--) | Obtient ou définit la boîte englobante du texte. |
| [getTextColor()](#getTextColor--) | Obtient la couleur du texte. |
| [getTextData()](#getTextData--) | Obtient les portions du texte. |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Recherche et obtient la ressource [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) depuis le [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Obtient ou définit une valeur indiquant si [was changed] a été modifié. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Détermine si [is font available] [the specified font]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Prétraite la police. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Remplace la police par défaut. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Obtient le texte du calque |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Obtient ou définit le processeur de ressources. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Obtient ou définit la boîte englobante du texte. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Obtient ou définit une valeur indiquant si [was changed] a été modifié. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Met à jour les limites du [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) dans les ressources. |
| [updateText(String text)](#updateText-java.lang.String-) | Met à jour le texte. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Met à jour le texte. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Met à jour le texte. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Met à jour le texte. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Met à jour le texte. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Met à jour le texte. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Met à jour le texte. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Met à jour le texte. |
| [wait()](#wait--) |  |
...
Corrige la taille de la police

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| newSize | float | Nouvelle taille de police |
| yyTransform | double | Paramètre de matrice de transformation 'yy' |

**Returns:**
float - taille corrigée
...
Crée une nouvelle instance de la classe [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Obtient les données du moteur.

Valeur : les données du moteur.
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - Les polices définies du calque de texte.
...
Obtient ou définit le processeur de ressources.

Valeur : le processeur de ressources.
...
Obtient le format de chaîne.

Valeur : le format de chaîne.
...
Obtient ou définit la boîte englobante du texte.

Valeur : la boîte englobante du texte.
...
Recherche et obtient la ressource [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) depuis le [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Obtient ou définit une valeur indiquant si [was changed] a été modifié.

Valeur :  true  si [was changed] ; sinon,  false .
...
Détermine si [is font available] [the specified font].
...
**Returns:**
booléen - True si la police est disponible
...
Remplace la police par défaut.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | La police. |
| defaultFontName | java.lang.String | Nom par défaut de la police. |
...
| newWidth | int | La nouvelle largeur. |
| newHeight | int | La nouvelle hauteur. |
| resizeType | int | Le type de transformation de redimensionnement  ResizeType |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Met à jour les limites du [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) dans les ressources.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | La position absolue et la taille du texte. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | La position et la taille du texte par rapport à la textBox. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| text | java.lang.String | La valeur du texte. |
...
| --- | --- | --- |
| text | java.lang.String | La valeur du texte. |
| color | [Color](../../com.aspose.psd/color) | La valeur de la couleur. |
...
| --- | --- | --- |
| text | java.lang.String | La valeur du texte. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | La coordonnée supérieure gauche. |
...
| text | java.lang.String | La valeur du texte. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | La coordonnée supérieure gauche. |
| fontSize | float | Taille de la police. |
