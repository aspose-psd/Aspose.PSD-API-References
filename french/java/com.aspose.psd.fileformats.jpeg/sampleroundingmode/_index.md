...
type: docs
weight: 16
url: /fr/java/com.aspose.psd.fileformats.jpeg/sampleroundingmode/
---
...
| [Extrapolate](#Extrapolate) | Extrapole une valeur de 8 bits pour l'adapter à n bits, où 1 < n < 8. |
| [Truncate](#Truncate) | Tronque une valeur de 8 bits pour l'adapter à n bits, où 1 < n < 8. |
## Méthodes
...
Extrapole une valeur de 8 bits pour l'adapter à n bits, où 1 < n < 8. Le nombre de toutes les valeurs possibles de 8 bits est 1 << 8 = 256, de 0 à 255. Le nombre de toutes les valeurs possibles de n bits est 1 << n, de 0 à (1 << n) - 1. La valeur de n bits la plus raisonnable Vn correspondant à une valeur de 8 bits V8 est égale à Vn = V8 >> (8 - n).
...
Tronque une valeur de 8 bits pour l'adapter à n bits, où 1 < n < 8. Le nombre de toutes les valeurs possibles de n bits est 1 << n, de 0 à (1 << n) - 1. La valeur de n bits la plus raisonnable Vn correspondant à une valeur de 8 bits V8 est égale à Vn = V8 & ((1 << n) - 1).
