...
description: "Ressource de données de contenu de contour vectoriel."
type: docs
weight: 13
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
Ressource de données de contenu de contour vectoriel.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [VscgResource()](#VscgResource--) | Initialise une nouvelle instance de la classe [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource). |
## Champs
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Obtient ou définit le nom de la classe. |
| [getClassName_internalized()](#getClassName-internalized--) | Obtient ou définit l'identifiant de la classe. |
| [getHeader_internalized()](#getHeader-internalized--) | Obtient ou définit l'en-tête. |
| [getItems()](#getItems--) | Obtient ou définit les éléments de structure. |
| [getKey()](#getKey--) | Obtient la clé de la ressource de calque. |
| [getKeyForData()](#getKeyForData--) | Clé entière qui définit le type de paramètres de remplissage stockés dans la ressource : \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtient ou définit le nom de la classe. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Obtient ou définit l'identifiant de la classe. |
...
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Obtient la clé entière qui définit le type de paramètres de remplissage stockés dans la ressource : \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Attention ! La valeur de la propriété KeyForData doit correspondre au type de paramètres de remplissage stockés dans les structures Items. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Méthode interne qui permet d'assigner la propriété en lecture seule KeyForData. |
...
Initialise une nouvelle instance de la classe [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource).
...
Obtient ou définit l'identifiant de la classe.
...
Clé entière qui définit le type de paramètres de remplissage stockés dans la ressource : \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Méthode interne qui permet d'assigner la propriété en lecture seule KeyForData. Ne doit être utilisée que dans le chargeur de ressources Vscg lors de l'affectation des propriétés de la ressource.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | int | Valeur entière pour la propriété KeyForData. |
