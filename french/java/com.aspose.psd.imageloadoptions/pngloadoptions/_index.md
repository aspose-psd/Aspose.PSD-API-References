...
type: docs
weight: 11
url: /fr/java/com.aspose.psd.imageloadoptions/pngloadoptions/
---
...
**Returns:**
booléen - une valeur indiquant si [strict mode].
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | booléen | une valeur indiquant si [strict mode]. |
