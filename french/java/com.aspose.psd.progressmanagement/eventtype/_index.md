...
description: "Cette énumération décrit les types d'événements de progression possibles qui peuvent survenir lors des opérations de traitement d'image."
type: docs
weight: 11
url: /fr/java/com.aspose.psd.progressmanagement/eventtype/
---
...
Cette énumération décrit les types d'événements de progression possibles qui peuvent survenir lors des opérations de traitement d'image.
## Champs
...
| [StageChange](#StageChange) | La prochaine étape de l'opération a commencé |
## Méthodes
...
La prochaine étape de l'opération a commencé
