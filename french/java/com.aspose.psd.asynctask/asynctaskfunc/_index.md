...
type: docs
weight: 12
url: /fr/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | Le délégué d'opération longue pour la tâche asynchrone avec un résultat de type générique. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | État de la tâche asynchrone. |
