...
type: docs
weight: 18
url: /fr/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| --- | --- |
| [PdfOptions()](#PdfOptions--) | Initialise une nouvelle instance de la classe [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions). |
## Méthodes
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | Obtient les options PDF de base. |
...
| [getPdfCoreOptions()](#getPdfCoreOptions--) | Les options PDF de base |
...
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | Les options PDF de base |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | Obtient ou définit les métadonnées du document. |
...
Initialise une nouvelle instance de la classe [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions).
...
Obtient les options PDF de base.
