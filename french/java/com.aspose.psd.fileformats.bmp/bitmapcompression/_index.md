...
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.bmp/bitmapcompression/
---
...
| [Rle4](#Rle4) | Compression RLE 4 bits/pixel. |
| [Rle8](#Rle8) | Compression RLE 8 bits/pixel. |
## Méthodes
...
Champs de bits RGBA. Ne peut être utilisé qu'avec des images bitmap de 16 et 32 bits/pixel.
...
Champs de bits RGB. Ne peut être utilisé qu'avec des images bitmap de 16 et 32 bits/pixel.
...
Compression RLE 4 bits/pixel. Ne peut être utilisé qu'avec des images bitmap de 4 bits/pixel.
...
Compression RLE 8 bits/pixel. Ne peut être utilisé qu'avec des images bitmap de 8 bits/pixel.
