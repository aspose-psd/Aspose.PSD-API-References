...
type: docs
weight: 11
url: /fr/java/com.aspose.psd.fileformats.psd/compressionmethod/
---
...
| [RLE](#RLE) | Les données d'image compressées en RLE commencent par les comptes d'octets pour toutes les lignes de numérisation (lignes \* canaux), chaque compte étant stocké sous forme d'une valeur de deux octets. |
...
Les données d'image compressées en RLE commencent par les comptes d'octets pour toutes les lignes de numérisation (lignes \* canaux), chaque compte étant stocké sous forme d'une valeur de deux octets. Les données compressées en RLE suivent, chaque ligne de numérisation étant compressée séparément. La compression RLE est le même algorithme de compression utilisé par la routine PackBits du ROM Macintosh et la norme TIFF.
