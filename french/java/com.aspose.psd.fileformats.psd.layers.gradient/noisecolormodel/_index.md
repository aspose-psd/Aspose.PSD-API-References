...
description: "Modèle de couleur lorsqu'un type de dégradé Noise, nous pouvons assigner le modèle de couleur à RGB/SHB/LAB 3/4/6"
type: docs
weight: 12
url: /fr/java/com.aspose.psd.fileformats.psd.layers.gradient/noisecolormodel/
---
...
Modèle de couleur Lorsque 'Gradient type' = 'Noise', nous pouvons assigner 'Color Model' à RGB/SHB/LAB (3/4/6)
## Champs

| Champ | Description |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HSB](#HSB) | Modèle de couleur HSB. |
| [LAB](#LAB) | Modèle de couleur LAB. |
