...
description: "Définit la classe PlLdResource qui contient des informations sur un calque placé dans le fichier PSD."
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
Définit la classe PlLdResource qui contient des informations sur un calque placé dans le fichier PSD. Elle est utilisée pour prendre en charge les calques d'objet dynamique dans les images Adobe® Photoshop®. Elle a été remplacée par SoLdResource dans Adobe® Photoshop® CS3.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PlLdResource()](#PlLdResource--) | Initialise une nouvelle instance de la classe [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
## Champs
...
| [getLength()](#getLength--) | Obtient la longueur de la ressource PlLd en octets. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Enregistre la ressource PlLD dans le conteneur de flux spécifié. |
...
Initialise une nouvelle instance de la classe [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). Ce constructeur par défaut est conçu pour être utilisé par PlLdResourceLoader. Utilisez [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) pour créer des classes PlLdResource.
...
Enregistre la ressource PlLD dans le conteneur de flux spécifié.
