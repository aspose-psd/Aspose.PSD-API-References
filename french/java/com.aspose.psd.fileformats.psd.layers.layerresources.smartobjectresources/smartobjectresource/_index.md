...
description: "Définit la classe SmartObjectResource qui contient des informations sur un calque d'objet dynamique dans un fichier PSD."
type: docs
weight: 13
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource/
---
...
Définit la classe SmartObjectResource qui contient des informations sur un calque d'objet dynamique dans un fichier PSD. C’est la classe de base pour les ressources Sold et Sole qui est utilisée pour prendre en charge les calques d'objet dynamique dans les images Adobe Photoshop.
## Champs
