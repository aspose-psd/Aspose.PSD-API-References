...
description: "Définit la classe SoLdResource qui contient des informations sur un calque d'objet dynamique dans un fichier PSD."
type: docs
weight: 15
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
Définit la classe SoLdResource qui contient des informations sur un calque d'objet intelligent dans un fichier PSD. Elle est utilisée pour prendre en charge les calques d'objet intelligent dans les images Adobe® Photoshop®.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Initialise une nouvelle instance de la classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | Initialise une nouvelle instance de la classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## Champs

| Champ | Description |
| --- | --- |
| [AntiAliasPolicyKey_internalized](#AntiAliasPolicyKey-internalized) | La clé de politique d'anticrénelage |
| [BottomKey_internalized](#BottomKey-internalized) | La clé du bas |
| [BoundsKey_internalized](#BoundsKey-internalized) | La clé des limites |
| [CompIdKey_internalized](#CompIdKey-internalized) | Le nom de clé du CompID |
| [CompInfoKey_internalized](#CompInfoKey-internalized) | Le nom de clé des informations de comp |
| [CompKey_internalized](#CompKey-internalized) | La clé de comp |
| [CompNoneValue_internalized](#CompNoneValue-internalized) | La valeur de comp qui signifie 'none' |
| [CropKey_internalized](#CropKey-internalized) | La clé de recadrage |
...
| [DenominatorKey_internalized](#DenominatorKey-internalized) | La clé du dénominateur |
| [DurationKey_internalized](#DurationKey-internalized) | La clé de durée |
...
| [FrameCountKey_internalized](#FrameCountKey-internalized) | La clé du nombre de cadres |
| [FrameStepKey_internalized](#FrameStepKey-internalized) | La clé du pas de cadre |
| [HeightKey_internalized](#HeightKey-internalized) | La clé de hauteur |
| [HorizontalIdName_internalized](#HorizontalIdName-internalized) | Le nom de l'identifiant horizontal |
| [IdentKey_internalized](#IdentKey-internalized) | La clé d'identifiant unique |
| [ItemsPropertyCannotBeNull_internalized](#ItemsPropertyCannotBeNull-internalized) | La propriété items ne peut pas être nulle |
| [LeftKey_internalized](#LeftKey-internalized) | La clé de gauche |
| [MeshPointsKeyName_internalized](#MeshPointsKeyName-internalized) | Le nom de la clé des points de maillage |
| [NonAffineTransformKey_internalized](#NonAffineTransformKey-internalized) | La clé de transformation non affine |
| [NullClassId_internalized](#NullClassId-internalized) | L'identifiant de classe null |
| [NumeratorKey_internalized](#NumeratorKey-internalized) | La clé du numérateur |
| [OptionalKeys_internalized](#OptionalKeys-internalized) | La collection de clés optionnelles |
| [OrientationIdName_internalized](#OrientationIdName-internalized) | Le nom de l'identifiant d'orientation |
| [OriginalCompIdKey_internalized](#OriginalCompIdKey-internalized) | Le nom de clé du CompID original |
| [PageNumberKey_internalized](#PageNumberKey-internalized) | La clé du numéro de page |
| [PlacedIdKey_internalized](#PlacedIdKey-internalized) | La clé de l'identifiant placé |
...
| [ResolutionKey_internalized](#ResolutionKey-internalized) | La clé de résolution |
| [ResourceSignature](#ResourceSignature) | La signature de ressource commune. |
| [RightKey_internalized](#RightKey-internalized) | La clé de droite |
| [SizeKey_internalized](#SizeKey-internalized) | La clé de taille |
...
| [SmartVersionValue_internalized](#SmartVersionValue-internalized) | La valeur attendue de la version de la ressource d'objet intelligent. |
| [TopKey_internalized](#TopKey-internalized) | La clé du haut |
| [TotalPagesKey_internalized](#TotalPagesKey-internalized) | La clé du nombre total de pages |
| [TransformKey_internalized](#TransformKey-internalized) | La clé de transformation |
| [TransformValueCount_internalized](#TransformValueCount-internalized) | Le nombre de valeurs de transformation |
| [TypeKey_internalized](#TypeKey-internalized) | La clé de type |
| [TypeToolKey](#TypeToolKey) | La clé d'information de l'outil type : 'SoLd'. |
| [TypeValue_internalized](#TypeValue-internalized) | La valeur de type attendue. |
...
| [WidthKey_internalized](#WidthKey-internalized) | La clé de largeur |
| [YouCannotAccessCropPropertyMessage_internalized](#YouCannotAccessCropPropertyMessage-internalized) | Vous ne pouvez pas accéder à la propriété Crop |
| [YouCannotSetCompIdPropertyMessage_internalized](#YouCannotSetCompIdPropertyMessage-internalized) | Vous ne pouvez pas définir la propriété CompId |
| [YouCannotSetCompPropertyMessage_internalized](#YouCannotSetCompPropertyMessage-internalized) | Vous ne pouvez pas définir la propriété Comp |
| [YouCannotSetOriginalCompIdPropertyMessage_internalized](#YouCannotSetOriginalCompIdPropertyMessage-internalized) | Vous ne pouvez pas définir la propriété OriginalCompId |
...
| [convertListStructureToDoubleArray_internalized(ListStructure list)](#convertListStructureToDoubleArray-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures.ListStructure-) | Convertit la structure de liste en tableau de doubles. |
...
| [getAntiAliasPolicy()](#getAntiAliasPolicy--) | Obtient ou définit la politique d'anticrénelage des données de calque d'objet intelligent dans l'image PSD. |
...
| [getClass()](#getClass--) |  |
| [getComp()](#getComp--) | Obtient ou définit la valeur comp des données de calque d'objet intelligent dans le fichier PSD. |
...
| [getCrop()](#getCrop--) | Obtient ou définit le recadrage des données de calque d'objet intelligent dans l'image PSD. |
...
| [getDurationDenominator()](#getDurationDenominator--) | Obtient ou définit le dénominateur de la durée. |
| [getDurationNumerator()](#getDurationNumerator--) | Obtient ou définit le numérateur de la durée. |
| [getFrameCount()](#getFrameCount--) | Obtient ou définit le nombre d'images des données de calque d'objet intelligent dans le fichier PSD. |
| [getFrameStepDenominator()](#getFrameStepDenominator--) | Obtient ou définit le dénominateur du pas d'image. |
| [getFrameStepNumerator()](#getFrameStepNumerator--) | Obtient ou définit le numérateur du pas d'image. |
...
| [getItems()](#getItems--) | Obtient ou définit les éléments de descripteur des données de calque d'objet intelligent dans le fichier PSD. |
...
| [getLength()](#getLength--) | Obtient la longueur de la ressource d'objet intelligent en octets. |
| [getNonAffineTransformMatrix()](#getNonAffineTransformMatrix--) | Obtient ou définit la matrice de transformation non affine des données de calque d'objet intelligent dans le fichier PSD. |
...
| [getPageNumber()](#getPageNumber--) | Obtient ou définit le numéro de page des données de calque d'objet intelligent dans le fichier PSD. |
...
| [getPlacedId()](#getPlacedId--) | Obtient ou définit l'identifiant unique de ces données de calque d'objet intelligent dans l'image PSD. |
| [getPlacedId_internalized()](#getPlacedId-internalized--) |  |
| [getPlacedLayerType()](#getPlacedLayerType--) | Obtient ou définit le type des données de calque d'objet intelligent dans le fichier PSD. |
...
| [getResolution()](#getResolution--) | Obtient ou définit la résolution des données de calque d'objet intelligent dans le fichier PSD. |
| [getResolutionUnit()](#getResolutionUnit--) | Obtient ou définit l'unité de mesure de la résolution des données de calque d'objet intelligent dans le fichier PSD. |
...
| [getTotalPages()](#getTotalPages--) | Obtient ou définit le nombre total de pages des données de calque d'objet intelligent dans le fichier PSD. |
| [getTransformMatrix()](#getTransformMatrix--) | Obtient ou définit la matrice de transformation des données de calque d'objet intelligent dans le fichier PSD. |
| [getUOrder()](#getUOrder--) | Obtient ou définit la valeur d'ordre U du calque placé dans le fichier PSD. |
| [getUniqueId()](#getUniqueId--) | Obtient ou définit l'identifiant unique global des données de calque d'objet intelligent [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) dans l'image PSD. |
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Les éléments de déformation. |
...
| [initializeBounds_internalized(Rectangle bounds)](#initializeBounds-internalized-com.aspose.psd.Rectangle-) | Initialise les limites et les matrices. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Enregistre la ressource d'objet intelligent dans le conteneur de flux spécifié. |
...
| [setAntiAliasPolicy(int value)](#setAntiAliasPolicy-int-) | Obtient ou définit la politique d'anticrénelage des données de calque d'objet intelligent dans l'image PSD. |
...
| [setComp(int value)](#setComp-int-) | Obtient ou définit la valeur comp des données de calque d'objet intelligent dans le fichier PSD. |
...
| [setCrop(int value)](#setCrop-int-) | Obtient ou définit le recadrage des données de calque d'objet intelligent dans l'image PSD. |
...
| [setDurationDenominator(int value)](#setDurationDenominator-int-) | Obtient ou définit le dénominateur de la durée. |
| [setDurationNumerator(int value)](#setDurationNumerator-int-) | Obtient ou définit le numérateur de la durée. |
| [setFrameCount(int value)](#setFrameCount-int-) | Obtient ou définit le nombre d'images des données de calque d'objet intelligent dans le fichier PSD. |
| [setFrameStepDenominator(int value)](#setFrameStepDenominator-int-) | Obtient ou définit le dénominateur du pas d'image. |
| [setFrameStepNumerator(int value)](#setFrameStepNumerator-int-) | Obtient ou définit le numérateur du pas d'image. |
...
| [setHeight(double value)](#setHeight-double-) | Obtient ou définit la hauteur. |
...
| [setItems(OSTypeStructure[] value)](#setItems-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Obtient ou définit les éléments de descripteur des données de calque d'objet intelligent dans le fichier PSD. |
| [setLeft(double value)](#setLeft-double-) | Obtient ou définit la position gauche du calque placé dans le fichier PSD. |
| [setNonAffineTransformMatrix(double[] value)](#setNonAffineTransformMatrix-double---) | Obtient ou définit la matrice de transformation non affine des données de calque d'objet intelligent dans le fichier PSD. |
| [setOriginalCompId_internalized(int value)](#setOriginalCompId-internalized-int-) | Obtient l'ID original du Comp actuellement sélectionné pour le document enfant, qui sera -1 si aucun n'est sélectionné. |
| [setPageNumber(int value)](#setPageNumber-int-) | Obtient ou définit le numéro de page des données de calque d'objet intelligent dans le fichier PSD. |
...
| [setPlacedId(UUID value)](#setPlacedId-java.util.UUID-) | Obtient ou définit l'identifiant unique de ces données de calque d'objet intelligent dans l'image PSD. |
| [setPlacedId_internalized(System.Guid value)](#setPlacedId-internalized-com.aspose.ms.System.Guid-) |  |
| [setPlacedLayerType(int value)](#setPlacedLayerType-int-) | Obtient ou définit le type des données de calque d'objet intelligent dans le fichier PSD. |
| [setResolution(double value)](#setResolution-double-) | Obtient ou définit la résolution des données de calque d'objet intelligent dans le fichier PSD. |
| [setResolutionUnit(int value)](#setResolutionUnit-int-) | Obtient ou définit l'unité de mesure de la résolution des données de calque d'objet intelligent dans le fichier PSD. |
...
| [setTotalPages(int value)](#setTotalPages-int-) | Obtient ou définit le nombre total de pages des données de calque d'objet intelligent dans le fichier PSD. |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | Obtient ou définit la matrice de transformation des données de calque d'objet intelligent dans le fichier PSD. |
| [setUOrder(int value)](#setUOrder-int-) | Obtient ou définit la valeur d'ordre U du calque placé dans le fichier PSD. |
| [setUniqueId(UUID value)](#setUniqueId-java.util.UUID-) | Obtient ou définit l'identifiant unique global des données de calque d'objet intelligent [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) dans l'image PSD. |
...
| [setWidth(double value)](#setWidth-double-) | Obtient ou définit la largeur. |
...
Initialise une nouvelle instance de la classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Il est nécessaire de définir la propriété Items ou d'appeler InitializeItems() pour obtenir une instance prête. Ce constructeur est conçu pour être utilisé par [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) et dans les tests unitaires. Utilisez [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) pour créer des classes SoLdResource.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| uniqueId | java.util.UUID | L'identifiant unique des données du calque d'objet intelligent [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Initialise une nouvelle instance de la classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Ce constructeur par défaut est conçu pour être utilisé par SoLdResourceLoader. Utilisez [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) pour créer des classes SoLdResource.
...
La clé de politique d'anticrénelage
...
Le nom de clé des informations de comp
...
La valeur de comp qui signifie 'none'
...
La propriété items ne peut pas être nulle
...
La clé de transformation non affine
...
La collection de clés optionnelles
...
Le nom de clé du CompID original
...
La valeur attendue de la version de la ressource d'objet intelligent.
...
La clé du nombre total de pages
...
La clé d'information de l'outil type : 'SoLd'.
...
Vous ne pouvez pas accéder à la propriété Crop
...
Vous ne pouvez pas définir la propriété CompId
...
Vous ne pouvez pas définir la propriété Comp
...
Vous ne pouvez pas définir la propriété OriginalCompId
...
Convertit la structure de liste en tableau de doubles.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| list | [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) | L'instance  ListStructure  . |

**Returns:**
double[] - Le tableau  double[]  créé.
### create_internalized(System.Guid uniqueId, boolean isCustom, boolean hasCompInfo) {#create-internalized-com.aspose.ms.System.Guid-boolean-boolean-}
```
...
Obtient ou définit la politique d'anticrénelage des données de calque d'objet intelligent dans l'image PSD.

Valeur: La politique d'anticrénelage des données de calque d'objet intelligent.
...
Obtient ou définit la valeur de composition des données de calque d'objet intelligent dans le fichier PSD.  Calques de composition dans les objets intelligents

Valeur: La valeur de composition, est -1 si aucune.
...
Obtient ou définit l'ID de la composition actuellement sélectionnée pour le document enfant, qui sera -1 si aucune n'est sélectionnée. Les compositions sont des mises en page qu'un concepteur peut créer. En utilisant les calques de composition, vous pouvez créer, gérer et visualiser plusieurs versions d'une mise en page dans un seul fichier Adobe\\ufffd Photoshop\\ufffd. Un calque de composition est un instantané d'un état du panneau Calques. Les calques de composition enregistrent trois types d'options de calque mais cette propriété obtient l'identifiant de sélection du calque de composition pour le calque d'objet intelligent dans le fichier PSD.  Calques de composition dans les objets intelligents

Valeur: L'ID de la composition actuellement sélectionnée pour le document enfant dans l'image PSD, qui sera -1 si aucune n'est sélectionnée.
...
Obtient ou définit le recadrage des données de calque d'objet intelligent dans l'image PSD.

Valeur: La valeur de recadrage des informations du calque placé.
...
Obtient ou définit le dénominateur de la durée.

Valeur: Le dénominateur de la durée.
...
Valeur: Le numérateur de la durée.
...
Obtient ou définit le nombre d'images des données de calque d'objet intelligent dans le fichier PSD.

Valeur: Le nombre d'images des informations du calque placé.
...
Obtient ou définit le dénominateur du pas d'image.

Valeur: Le dénominateur du pas d'image.
...
Obtient ou définit le numérateur du pas d'image.

Valeur: Le numérateur du pas d'image.
...
Obtient ou définit les éléments de descripteur des données de calque d'objet intelligent dans le fichier PSD.

Valeur: Les éléments de descripteur des informations du calque placé.
...
Obtient ou définit la matrice de transformation non affine des données de calque d'objet intelligent dans le fichier PSD.

Valeur: La matrice de transformation non affine du calque d'objet intelligent.
...
Obtient l'ID original de la composition actuellement sélectionnée pour le document enfant, qui sera -1 si aucune n'est sélectionnée. Cette propriété obtient l'identifiant de sélection original du calque de composition pour le calque d'objet intelligent dans le fichier PSD.  Calques de composition dans les objets intelligents

Valeur : l'ID original du comp actuellement sélectionné pour le document enfant dans l'image PSD, qui sera -1 si aucun n'est sélectionné.
...
Obtient ou définit le numéro de page des données de calque d'objet intelligent dans le fichier PSD.

Valeur : le numéro de page des données du calque d'objet intelligent.
...
Obtient ou définit l'identifiant unique de ces données de calque d'objet intelligent dans l'image PSD.

Valeur : l'identifiant unique de cette ressource de calque d'objet intelligent.
...
Obtient ou définit le type des données de calque d'objet intelligent dans le fichier PSD.

Valeur : le type des données du calque d'objet intelligent.
...
Obtient ou définit la résolution des données de calque d'objet intelligent dans le fichier PSD.

Valeur : la résolution du calque d'objet intelligent.
...
Obtient ou définit l'unité de mesure de la résolution des données de calque d'objet intelligent dans le fichier PSD.

Valeur : l'unité de mesure de la résolution du calque d'objet intelligent.
...
Obtient ou définit le nombre total de pages des données de calque d'objet intelligent dans le fichier PSD.

Valeur : le nombre total de pages des données du calque d'objet intelligent.
...
Obtient ou définit la matrice de transformation des données de calque d'objet intelligent dans le fichier PSD.

Valeur : la matrice de transformation des données du calque d'objet intelligent.
...
Obtient ou définit l'identifiant unique global des données de calque d'objet intelligent [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource) dans l'image PSD.

Valeur : l'identifiant unique global des données du calque d'objet intelligent [SmartObjectResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource).
...
Initialise les limites et les matrices.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Les limites. |
