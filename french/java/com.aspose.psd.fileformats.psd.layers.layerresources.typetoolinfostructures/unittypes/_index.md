...
description: "Les types d'unité."
type: docs
weight: 29
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes/
---
...
| Champ | Description |
| --- | --- |
| [Angle](#Angle) | Unité d'angle. |
| [Density](#Density) | Unité de densité. |
| [Distance](#Distance) | Unité de distance. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Millimeters](#Millimeters) | Unité de millimètres. |
| [None](#None) | Unité non définie. |
| [Percent](#Percent) | Unité de pourcentage. |
| [Pixels](#Pixels) | Unité de pixels. |
| [Points](#Points) | Unité de points. |
## Méthodes
