...
type: docs
weight: 21
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialise une nouvelle instance de la classe [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure). |
## Champs
...
| [getValue()](#getValue--) | Obtient ou définit la valeur entière. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Obtient ou définit la valeur entière. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure).
