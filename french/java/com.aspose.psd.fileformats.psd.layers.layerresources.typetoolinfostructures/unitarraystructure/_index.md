...
description: "Définit la classe UnitArrayStructure qui contient un tableau de valeurs double et leur unité de mesure."
type: docs
weight: 27
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
Définit la classe UnitArrayStructure qui contient un tableau de valeurs double et leur unité de mesure. Elle est utilisée dans les ressources de fichiers PSD, généralement par [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | Initialise une nouvelle instance de la classe [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## Champs

| Champ | Description |
| --- | --- |
| [StructureKey](#StructureKey) | Définit la clé 'UnFl' de la [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## Méthodes
...
| [getKey()](#getKey--) | Obtient la clé de cette structure de tableau d'unités. |
...
| [getUnitType()](#getUnitType--) | Obtient ou définit le type d'unité de mesure des valeurs de la [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [getValueCount()](#getValueCount--) | Obtient le nombre de valeurs. |
| [getValues()](#getValues--) | Obtient ou définit les valeurs de la structure de tableau d'unités. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | Obtient ou définit le type d'unité de mesure des valeurs de la [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [setValues(double[] value)](#setValues-double---) | Obtient ou définit les valeurs de la structure de tableau d'unités. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Nom de la clé. |
| unitType | int | Type de l'unité. |
...
Définit la clé 'UnFl' de la [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).
...
Obtient la clé de cette structure de tableau d'unités.
...
Obtient ou définit le type d'unité de mesure des valeurs de la [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

Valeur: le type d'unité de mesure.
...
Valeur: le nombre de valeurs dans la structure de tableau d'unités.
