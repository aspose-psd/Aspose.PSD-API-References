...
description: "Définit la classe ObjectArrayStructure qui contient généralement un tableau."
type: docs
weight: 20
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Définit la classe ObjectArrayStructure qui contient généralement le tableau [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) . Elle est utilisée dans les ressources de fichiers PSD, telles que la ressource PlLd et la ressource SoLd.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initialise une nouvelle instance de la classe [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initialise une nouvelle instance de la classe [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
## Champs

| Champ | Description |
| --- | --- |
| [StructureKey](#StructureKey) | Identifie la clé de structure 'ObAr'. |
## Méthodes
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Obtient ou définit l'ID de classe du tableau d'objets. |
| [getClassName()](#getClassName--) | Obtient ou définit le nom de classe du tableau d'objets. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Obtient la liste des structures. |
| [getKey()](#getKey--) | Obtient la clé de structure du tableau d'objets. |
| [getKeyName()](#getKeyName--) | Obtient ou définit le nom de la clé. |
| [getLength()](#getLength--) | Obtient la longueur de l'OSTypeStructure en octets. |
...
| [getStructureCount()](#getStructureCount--) | Obtient le nombre de sous-structures du tableau d'objets. |
| [getStructures()](#getStructures--) | Obtient ou définit les sous-structures dans la structure de tableau d'objets. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtient ou définit l'ID de classe du tableau d'objets. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Obtient ou définit le nom de classe du tableau d'objets. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Obtient ou définit les sous-structures dans la structure de tableau d'objets. |
...
Initialise une nouvelle instance de la classe [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| keyName | java.lang.String | Nom de la clé. |
| classIdName | java.lang.String | Nom de l'identifiant de classe. |
...
Obtient ou définit l'ID de classe du tableau d'objets.

Valeur : l'ID de classe du tableau d'objets.
...
Obtient ou définit le nom de classe du tableau d'objets.

Valeur : le nom de classe du tableau d'objets.
...
Obtient la liste des structures.
...
Obtient la longueur de l'OSTypeStructure en octets.
...
Obtient le nombre de sous-structures du tableau d'objets.

Valeur : le nombre de sous-structures dans la structure de tableau d'objets.
...
Obtient ou définit les sous-structures dans la structure de tableau d'objets.

Valeur : les sous-structures dans la structure de tableau d'objets.
