...
description: "La structure entière."
type: docs
weight: 17
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| --- | --- |
| [IntegerStructure(ClassID keyName)](#IntegerStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialise une nouvelle instance de la classe [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure). |
## Champs

| Champ | Description |
| --- | --- |
| [StructureKey](#StructureKey) | La clé de la structure entière. |
## Méthodes
...
| [getValue()](#getValue--) | Obtient ou définit une valeur entière. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Obtient ou définit une valeur entière. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [IntegerStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure).
