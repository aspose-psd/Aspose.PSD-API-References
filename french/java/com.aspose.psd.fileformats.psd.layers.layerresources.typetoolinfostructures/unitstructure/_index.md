...
description: "La structure d'unité."
type: docs
weight: 28
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
La structure d'unité.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialise une nouvelle instance de la classe [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure). |
## Champs
...
| [getUnitType()](#getUnitType--) | Obtient ou définit le type d'unité. |
...
| [setUnitType(int value)](#setUnitType-int-) | Obtient ou définit le type d'unité. |
| [setValue(double value)](#setValue-double-) | Obtient ou définit la valeur. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure).
