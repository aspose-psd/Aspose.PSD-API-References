...
description: "La structure alias."
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialise une nouvelle instance de la classe [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure). |
## Champs
...
| [getDataLength()](#getDataLength--) | Obtient la longueur exacte des données en octets. |
| [getFullPath()](#getFullPath--) | Obtient ou définit le chemin complet. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Obtient ou définit le chemin complet. |
...
Initialise une nouvelle instance de la classe [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure).
...
Valeur : la longueur des données en octets.
...
Obtient ou définit le chemin complet.

Valeur: le chemin complet.
