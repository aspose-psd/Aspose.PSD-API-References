...
type: docs
weight: 30
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Initialise une nouvelle instance de la classe [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure). |
## Méthodes
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Obtient le nom de type lisible de la structure. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Initialise une nouvelle instance de la classe [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Le nom de la clé. |
| clé | int | La clé de la structure. |
...
Obtient le nom de type lisible de la structure.
