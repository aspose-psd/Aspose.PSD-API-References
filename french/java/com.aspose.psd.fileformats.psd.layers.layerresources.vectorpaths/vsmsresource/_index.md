...
description: "Classe VsmsResource."
type: docs
weight: 29
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
Classe VsmsResource. Cette ressource contient des informations sur le masque de calque vectoriel.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | Initialise une nouvelle instance de la classe [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
| [VsmsResource()](#VsmsResource--) | Initialise une nouvelle instance de la classe [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
## Champs
...
| [hashCode()](#hashCode--) |  |
| [isChanged_internalized()](#isChanged-internalized--) | Détermine si cette instance a été modifiée. |
...
| [updateDataToCurrent_internalized()](#updateDataToCurrent-internalized--) | Met à jour les données originales en cache vers l'état actuel |
| [wait()](#wait--) |  |
...
Initialise une nouvelle instance de la classe [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource).
...
Détermine si cette instance a été modifiée.

**Returns:**
boolean -  true  si cette instance est modifiée ; sinon,  false .
...
Met à jour les données originales en cache vers l'état actuel
