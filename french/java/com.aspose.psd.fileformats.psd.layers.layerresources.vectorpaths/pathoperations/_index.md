...
type: docs
weight: 15
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| Champ | Description |
| --- | --- |
| [CombineShapes](#CombineShapes) | Combiner les formes (opération OU). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | Exclure les formes qui se chevauchent (opération OU exclusif). |
| [IntersectShapeAreas](#IntersectShapeAreas) | Intersecter les zones de forme (opération ET). |
| [SubtractFrontShape](#SubtractFrontShape) | Soustraire la forme avant (opération NON). |
## Méthodes
...
Combiner les formes (opération OU). C’est la valeur par défaut dans Photoshop.
...
Exclure les formes qui se chevauchent (opération OU exclusif).
...
Intersecter les zones de forme (opération ET).
...
Soustraire la forme avant (opération NON).
