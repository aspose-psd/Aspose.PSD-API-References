...
description: "Calque de remplissage."
type: docs
weight: 10
url: /fr/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| [createInstance(int fillType)](#createInstance-int-) | Construit une nouvelle instance de la classe [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) par type de remplissage. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Obtient le processeur de rendu pour [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Obtient ou définit l'opacité du remplissage. |
| [getFillSettings()](#getFillSettings--) | Obtient les paramètres de remplissage. |
| [getFillType()](#getFillType--) | Obtient le type du remplissage. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Obtient les paramètres de remplissage. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Met à jour les données des pixels du calque de remplissage selon les [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Construit une nouvelle instance de la classe [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) par type de remplissage.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| fillType | int | Le type de couche de remplissage. |
...
Obtient le processeur de rendu pour [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | L'image à rendre. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Les limites à traiter. |

**Returns:**
com.aspose.internal.IPartialProcessor - Retourne le processeur de rendu pour [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Obtient le type du remplissage.

Valeur : le type de remplissage.
...
Met à jour les données des pixels du calque de remplissage selon les [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
