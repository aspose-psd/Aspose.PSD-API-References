...
description: "Effet de calque d'ombre interne"
type: docs
weight: 14
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | Obtient ou définit la diffusion (étranglement) en pourcentage. |
...
| [setSpread(int value)](#setSpread-int-) | Obtient ou définit la diffusion (étranglement) en pourcentage. |
