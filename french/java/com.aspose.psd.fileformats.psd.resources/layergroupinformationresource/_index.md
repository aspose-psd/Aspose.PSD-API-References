...
description: "Ressource d'information du groupe de calques"
type: docs
weight: 25
url: /fr/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
Ressource d'information du groupe de calques
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Initialise une nouvelle instance de la classe [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Champs
...
| [getGroups()](#getGroups--) | Obtient ou définit les groupes. |
...
| [setGroups(short[] value)](#setGroups-short---) | Obtient ou définit les groupes. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Met à jour LinkGroupId dans les calques à partir de la propriété Groups. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Met à jour les valeurs de la propriété Groups à partir des calques. |
...
Met à jour LinkGroupId dans les calques à partir de la propriété Groups.
...
Met à jour les valeurs de la propriété Groups à partir des calques.
