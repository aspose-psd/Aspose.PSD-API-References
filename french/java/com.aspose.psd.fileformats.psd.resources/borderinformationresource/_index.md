...
type: docs
weight: 12
url: /fr/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | Initialise une nouvelle instance de la classe [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource). |
## Champs
...
| [getUnit()](#getUnit--) | Obtient ou définit les unités de bordure. |
| [getWidth()](#getWidth--) | Obtient ou définit la largeur de la bordure. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | Obtient ou définit les unités de bordure. |
| [setWidth(double value)](#setWidth-double-) | Obtient ou définit la largeur de la bordure. |
| [toString()](#toString--) |  |
...
Initialise une nouvelle instance de la classe [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource).
