...
description: "Ressource de tramage"
type: docs
weight: 14
url: /fr/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
Ressource de tramage
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | Initialise une nouvelle instance de la classe [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource). |
## Champs
...
| [getHalftoneData()](#getHalftoneData--) | Obtient ou définit les données de demi-teinte. |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | Obtient ou définit les données de demi-teinte. |
...
Initialise une nouvelle instance de la classe [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource).
...
Obtient ou définit les données de demi-teinte.

Valeur : les données de demi-teinte.
