...
description: "Ressource CaptionDigest"
type: docs
weight: 13
url: /fr/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Initialise une nouvelle instance de la classe [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Champs
...
| [getDigest()](#getDigest--) | Obtient ou définit le condensat. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Obtient ou définit le condensat. |
...
Obtient ou définit le condensat.
