...
description: "Ressource des indicateurs d'impression"
type: docs
weight: 30
url: /fr/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
Ressource des indicateurs d'impression
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Initialise une nouvelle instance de la classe [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource). |
## Champs
...
| [getBleedScale()](#getBleedScale--) | Obtient ou définit l'échelle de débordement. |
| [getBleedWidth()](#getBleedWidth--) | Obtient ou définit la largeur du débordement. |
| [getCenterCropMark()](#getCenterCropMark--) | Obtient ou définit la marque de recadrage centrale. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Obtient ou définit l'échelle de débordement. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Obtient ou définit la largeur du débordement. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Obtient ou définit la marque de recadrage centrale. |
...
Initialise une nouvelle instance de la classe [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource).
...
Valeur : l'échelle de débordement.
...
Valeur : la largeur du débordement.
...
Obtient ou définit la marque de recadrage centrale.

Valeur : la marque de recadrage centrale.
