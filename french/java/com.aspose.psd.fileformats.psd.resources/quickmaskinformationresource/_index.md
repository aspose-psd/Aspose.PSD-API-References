...
description: "Ressource d'information du masque rapide"
type: docs
weight: 32
url: /fr/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Ressource d'information du masque rapide
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Initialise une nouvelle instance de la classe [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource). |
## Champs
...
| [getChannelId()](#getChannelId--) | Obtient ou définit l'identifiant du canal. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Obtient ou définit une valeur indiquant si cette instance est un masque vide. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Enregistre le bloc de ressource dans le flux spécifié. |
| [setChannelId(short value)](#setChannelId-short-) | Obtient ou définit l'identifiant du canal. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Obtient ou définit une valeur indiquant si cette instance est un masque vide. |
...
Initialise une nouvelle instance de la classe [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource).
...
Obtient ou définit une valeur indiquant si cette instance est un masque vide.

Valeur:  true  si cette instance est un masque vide; sinon,  false .
