...
description: "La ressource contenant les informations de bordure des paramètres d'impression d'image."
type: docs
weight: 11
url: /fr/java/com.aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| --- | --- |
| [BackgroundColorResource()](#BackgroundColorResource--) | Initialise une nouvelle instance de la classe [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource). |
## Champs
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Obtient ou définit la couleur d'arrière-plan. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Obtient ou définit la couleur d'arrière-plan. |
| [setColorSpace(int value)](#setColorSpace-int-) | Obtient ou définit un espace couleur. |
...
Initialise une nouvelle instance de la classe [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource).
...
Obtient ou définit un espace couleur.

Valeur : l'espace couleur d'arrière-plan.
