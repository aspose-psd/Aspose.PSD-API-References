...
description: "Ressource de filigrane"
type: docs
weight: 42
url: /fr/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | Initialise une nouvelle instance de la classe [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource). |
## Champs
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | Obtient ou définit une valeur indiquant si cette instance est un filigrane. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | Obtient ou définit une valeur indiquant si cette instance est un filigrane. |
| [toString()](#toString--) |  |
...
Initialise une nouvelle instance de la classe [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource).
...
Valeur :  true  si cette instance est un filigrane ; sinon,  false .
