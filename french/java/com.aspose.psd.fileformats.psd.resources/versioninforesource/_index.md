...
description: "Ressource d'information de version"
type: docs
weight: 41
url: /fr/java/com.aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
| --- | --- |
| [VersionInfoResource()](#VersionInfoResource--) | Initialise une nouvelle instance de la classe [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource). |
## Champs
...
| [getFileVersion()](#getFileVersion--) | Obtient ou définit la version du fichier. |
...
| [getReaderName()](#getReaderName--) | Obtient ou définit le nom du lecteur. |
...
| [getWriterName()](#getWriterName--) | Obtient ou définit le nom du rédacteur. |
| [hasRealMergedData()](#hasRealMergedData--) | Obtient ou définit une valeur indiquant si cette instance possède des données fusionnées réelles. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Enregistre le bloc de ressource dans le flux spécifié. |
| [setFileVersion(long value)](#setFileVersion-long-) | Obtient ou définit la version du fichier. |
...
| [setReaderName(String value)](#setReaderName-java.lang.String-) | Obtient ou définit le nom du lecteur. |
| [setRealMergedData(boolean value)](#setRealMergedData-boolean-) | Obtient ou définit une valeur indiquant si cette instance possède des données fusionnées réelles. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Obtient ou définit l'état du bloc de ressource. |
| [setVersion(long value)](#setVersion-long-) | Obtient ou définit la version. |
| [setWriterName(String value)](#setWriterName-java.lang.String-) | Obtient ou définit le nom du rédacteur. |
| [toString()](#toString--) |  |
...
Initialise une nouvelle instance de la classe [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource).
...
Obtient ou définit une valeur indiquant si cette instance possède des données fusionnées réelles.

Valeur :  true  si cette instance possède des données fusionnées réelles ; sinon,  false .
