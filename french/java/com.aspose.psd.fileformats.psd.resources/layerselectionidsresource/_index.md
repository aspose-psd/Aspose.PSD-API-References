...
description: "Ressource des identifiants de sélection de calques"
type: docs
weight: 27
url: /fr/java/com.aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
Ressource des identifiants de sélection de calques
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource--) | Initialise une nouvelle instance de la classe [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource). |
## Champs
...
| [getLayerIds()](#getLayerIds--) | Obtient ou définit les identifiants de calque. |
...
| [setCount(short value)](#setCount-short-) | Obtient ou définit le nombre. |
...
| [setLayerIds(int[] value)](#setLayerIds-int---) | Obtient ou définit les identifiants de calque. |
...
Initialise une nouvelle instance de la classe [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource).
...
Valeur : Les identifiants de calque.
