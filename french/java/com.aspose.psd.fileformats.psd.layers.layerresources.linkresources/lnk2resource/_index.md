...
description: "Définit la classe qui contient des informations sur les fichiers intégrés dans l'image au format PSD."
type: docs
weight: 15
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
Définit la classe qui contient des informations sur les fichiers incorporés dans l'image au format PSD. La ressource de lien peut contenir plusieurs instances de  LiFdDataSource  qui peuvent être accessibles via l'indexeur.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Initialise une nouvelle instance de la classe [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) class. |
## Champs
...
| [get_Item(int index)](#get-Item-int-) | Obtient le LiFdDataSource à l'index spécifié. |
...
Initialise une nouvelle instance de la classe [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) class.
...
Obtient le LiFdDataSource à l'index spécifié.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index. Valeur : Le  LiFdDataSource . |
