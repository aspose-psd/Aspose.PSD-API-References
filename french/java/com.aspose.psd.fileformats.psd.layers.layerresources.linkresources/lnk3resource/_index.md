...
description: "Définit la classe qui contient des informations sur un fichier intégré dans l'image au format PSD 32 bits par canal."
type: docs
weight: 16
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
Définit la classe qui contient des informations sur un fichier intégré dans le format PSD image 32 bits par canal. La ressource de lien peut contenir plusieurs instances de [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) qui peuvent être accessibles via l'indexeur.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | Initialise une nouvelle instance de la classe [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource). |
## Champs
...
Initialise une nouvelle instance de la classe [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource).
