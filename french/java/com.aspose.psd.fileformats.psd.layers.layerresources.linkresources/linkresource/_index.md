...
description: "Définit la classe LinkResource qui contient des informations sur les fichiers liés ou intégrés dans l'image au format PSD."
type: docs
weight: 14
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
Définit la classe LinkResource qui contient des informations sur les fichiers liés ou incorporés dans l'image au format PSD. La ressource de lien peut contenir plusieurs instances de [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) qui peuvent être accessibles via des indexeurs dans toute classe dérivée.
## Champs
...
| [get_Item(int index)](#get-Item-int-) | Obtient le [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) à l'index spécifié. |
...
Obtient le [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) à l'index spécifié.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index entier. Valeur : Le [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
