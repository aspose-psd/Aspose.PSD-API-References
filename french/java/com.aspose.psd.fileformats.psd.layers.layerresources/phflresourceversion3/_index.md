...
type: docs
weight: 70
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/
---
...
| --- | --- |
| [PhflResourceVersion3()](#PhflResourceVersion3--) | Initialise une nouvelle instance de la classe [PhflResourceVersion3](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3). |
| [PhflResourceVersion3(byte[] data)](#PhflResourceVersion3-byte---) | Initialise une nouvelle instance de la classe [PhflResourceVersion3](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3). |
## Champs
...
| [getColorX()](#getColorX--) | Obtient ou définit la couleur X. |
| [getColorY()](#getColorY--) | Obtient ou définit la couleur Y. |
| [getColorZ()](#getColorZ--) | Obtient ou définit la couleur Z. |
...
| [setColorX(float value)](#setColorX-float-) | Obtient ou définit la couleur X. |
| [setColorY(float value)](#setColorY-float-) | Obtient ou définit la couleur Y. |
| [setColorZ(float value)](#setColorZ-float-) | Obtient ou définit la couleur Z. |
...
Initialise une nouvelle instance de la classe [PhflResourceVersion3](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3).
...
Obtient ou définit la couleur Y.
...
Obtient ou définit la couleur Z.
