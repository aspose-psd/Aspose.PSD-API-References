...
description: "La ressource de couche lsdk imbriquée de la section de couche."
type: docs
weight: 56
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Initialise une nouvelle instance de la classe [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Initialise une nouvelle instance de la classe [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
## Champs
...
Initialise une nouvelle instance de la classe [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource).
