...
description: "Ressource de nom de calque"
type: docs
weight: 58
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
Ressource de nom de calque
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [LuniResource()](#LuniResource--) | Initialise une nouvelle instance de la classe [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource). |
## Champs
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Obtient ou définit les données. |
...
Initialise une nouvelle instance de la classe [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource).
