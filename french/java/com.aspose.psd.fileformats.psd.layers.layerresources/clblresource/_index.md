...
description: "Classe ClblResource."
type: docs
weight: 20
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Classe ClblResource. Cette ressource contient des informations sur le mélange d'éléments découpés.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ClblResource()](#ClblResource--) | Initialise une nouvelle instance de la classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Initialise une nouvelle instance de la classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Initialise une nouvelle instance de la classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Champs
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Obtient ou définit une valeur indiquant si [blend clipped elements]. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | Obtient ou définit une valeur indiquant si la valeur [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) est vraie ou fausse |
| [hashCode()](#hashCode--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Obtient ou définit une valeur indiquant si [blend clipped elements]. |
...
| [setValue(boolean value)](#setValue-boolean-) | Obtient ou définit une valeur indiquant si la valeur [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) est vraie ou fausse |
...
Initialise une nouvelle instance de la classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
Initialise une nouvelle instance de la classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). Avec une valeur personnalisée ou inconnue
...
Obtient ou définit une valeur indiquant si [blend clipped elements].

Valeur :  true  si [blend clipped elements] ; sinon,  false .
...
Obtient ou définit une valeur indiquant si la valeur [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) est vraie ou fausse

Valeur :  true  si la valeur est vraie ; sinon,  false .
