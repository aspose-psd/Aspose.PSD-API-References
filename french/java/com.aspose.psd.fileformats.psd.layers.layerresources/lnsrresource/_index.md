...
type: docs
weight: 51
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Initialise une nouvelle instance de la classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Initialise une nouvelle instance de la classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Champs
...
| [getValue()](#getValue--) | Obtient la valeur en tant que LnsrResourceType si l'énumération correspondante est décrite. |
| [hashCode()](#hashCode--) |  |
...
Initialise une nouvelle instance de la classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| lnsrResourceType | int | Type du LNSR. |
...
Initialise une nouvelle instance de la classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). Avec une valeur personnalisée ou inconnue.
...
Obtient la valeur en tant que LnsrResourceType si l'énumération correspondante est décrite. Sinon, renvoie Unknown.

Valeur: la valeur en tant que LnsrResourceType.
