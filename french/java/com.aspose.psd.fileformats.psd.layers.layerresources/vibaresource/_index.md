...
description: "Ressource VibA."
type: docs
weight: 83
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| --- | --- |
| [VibAResource()](#VibAResource--) | Initialise une nouvelle instance de la classe [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource). |
## Champs
...
| [getSaturation()](#getSaturation--) | Obtient ou définit la valeur de saturation |
| [getSignature()](#getSignature--) | Obtient la signature de la ressource de calque. |
| [getVibrance()](#getVibrance--) | Obtient ou définit la valeur de vibrance |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | Obtient ou définit la valeur de saturation |
| [setVibrance(int value)](#setVibrance-int-) | Obtient ou définit la valeur de vibrance |
...
Initialise une nouvelle instance de la classe [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource).
...
Obtient ou définit la valeur de saturation
