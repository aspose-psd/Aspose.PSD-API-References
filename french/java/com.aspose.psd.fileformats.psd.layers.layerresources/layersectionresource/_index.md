...
description: "La ressource de section de calque."
type: docs
weight: 43
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
La ressource de section de calque.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Initialise une nouvelle instance de la classe [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Initialise une nouvelle instance de la classe [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Champs
...
| [getSectionType()](#getSectionType--) | Obtient ou définit le type de section. |
| [getSignature()](#getSignature--) | Obtient la signature de la ressource de calque. |
| [getSubtype()](#getSubtype--) | Obtient ou définit le sous-type. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Obtient ou définit le type de section. |
| [setSubtype(int value)](#setSubtype-int-) | Obtient ou définit le sous-type. |
...
Initialise une nouvelle instance de la classe [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
| --- | --- | --- |
| sectionType | int | Le type de section. |
| subType | int | Le sous-type. |
