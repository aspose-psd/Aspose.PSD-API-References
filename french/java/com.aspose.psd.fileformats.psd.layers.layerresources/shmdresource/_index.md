...
type: docs
weight: 74
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
Classe ShmdResource. Paramètres de métadonnées
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ShmdResource()](#ShmdResource--) | Initialise une nouvelle instance de la classe [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | Initialise une nouvelle instance de la classe [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
## Champs
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | Longueur de l'en-tête de la sous-ressource |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Obtient ou définit l'heure de création du calque. |
...
| [getSubResources()](#getSubResources--) | Les sous-ressources |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Obtient ou définit l'heure de création du calque. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | Obtient les sous-ressources de la ressource shmd. |
...
Initialise une nouvelle instance de la classe [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource).
...
Longueur de l'en-tête de la sous-ressource
...
Obtient ou définit l'heure de création du calque. Si l'heure de création du calque n'est pas spécifiée, renvoie new DateTime(0).

Valeur : L'heure de création du calque.
