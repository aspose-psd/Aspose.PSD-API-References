...
description: "Classe InfxResource."
type: docs
weight: 39
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Classe InfxResource. Cette ressource contient des informations sur le mélange de l'élément découpé.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Initialise une nouvelle instance de la classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource()](#InfxResource--) | Initialise une nouvelle instance de la classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Initialise une nouvelle instance de la classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
## Champs
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Obtient ou définit une valeur indiquant si [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Obtient ou définit une valeur indiquant si [blend interior elements]. |
...
Initialise une nouvelle instance de la classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource).
...
Initialise une nouvelle instance de la classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). Avec une valeur personnalisée ou inconnue
...
Valeur :  true  si [blend interior elements] ; sinon,  false .
