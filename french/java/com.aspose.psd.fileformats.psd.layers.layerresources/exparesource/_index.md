...
type: docs
weight: 28
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
Classe ExpaResource. Ressource du calque d'ajustement d'exposition
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | Initialise une nouvelle instance de la classe [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | Initialise une nouvelle instance de la classe [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | Initialise une nouvelle instance de la classe [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource). |
## Champs
...
| [getExposure()](#getExposure--) | Obtient ou définit l'exposition. |
| [getGammaCorrection()](#getGammaCorrection--) | Obtient ou définit le gamma. |
...
| [setExposure(float value)](#setExposure-float-) | Obtient ou définit l'exposition. |
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Obtient ou définit le gamma. |
...
| [setOffset(float value)](#setOffset-float-) | Obtient ou définit le décalage. |
...
Initialise une nouvelle instance de la classe [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource).
