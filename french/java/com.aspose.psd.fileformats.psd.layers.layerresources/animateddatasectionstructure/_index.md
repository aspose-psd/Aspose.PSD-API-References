...
type: docs
weight: 11
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Champ | Description |
| --- | --- |
| [StructureKey](#StructureKey) | Identifie la clé de structure de AnDs. |
## Méthodes
...
| [getItems()](#getItems--) | Obtient ou définit les structures de section de données animées. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Obtient ou définit le ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Obtient ou définit la version du descripteur. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Obtient ou définit les structures de section de données animées. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Obtient ou définit les octets inconnus 3 qui existent lorsque le nombre d'images est impair. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Vérifie que le nombre d'images dans la structure de liste 'FrIn' est impair.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| éléments | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Obtient ou définit les octets inconnus 3 qui existent lorsque le nombre d'images est impair.
