...
type: docs
weight: 32
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Initialise une nouvelle instance de la classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Initialise une nouvelle instance de la classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Initialise une nouvelle instance de la classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Champs
...
| [getX()](#getX--) | Obtient ou définit le x du point de référence |
| [getY()](#getY--) | Obtient ou définit le y du point de référence |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Enregistre dans le conteneur de flux spécifié. |
...
| [setX(double value)](#setX-double-) | Obtient ou définit le x du point de référence |
| [setY(double value)](#setY-double-) | Obtient ou définit le y du point de référence |
...
Initialise une nouvelle instance de la classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).
...
Initialise une nouvelle instance de la classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Avec une valeur personnalisée ou inconnue
...
Valeur: le x du point de référence
...
Valeur: le y du point de référence
