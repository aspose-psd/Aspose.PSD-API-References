...
description: "Paramètres protégés du calque"
type: docs
weight: 57
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
Paramètres protégés du calque
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | Initialise une nouvelle instance de la classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | Initialise une nouvelle instance de la classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource()](#LspfResource--) | Initialise une nouvelle instance de la classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
## Champs
...
| [TypeToolKey](#TypeToolKey) | La clé d'information d'outil de type 1819504742 |
...
| [getLockType()](#getLockType--) | Obtient ou définit le type du verrou. |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | Obtient ou définit une valeur indiquant si cette instance est protégée de manière composite. |
| [isPositionProtected()](#isPositionProtected--) | Obtient ou définit une valeur indiquant si cette instance est protégée de position. |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | Obtient ou définit une valeur indiquant si cette instance est protégée de transparence. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | Obtient ou définit une valeur indiquant si cette instance est protégée de manière composite. |
...
| [setLockType(int value)](#setLockType-int-) | Obtient ou définit le type du verrou. |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | Obtient ou définit une valeur indiquant si cette instance est protégée de position. |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | Obtient ou définit une valeur indiquant si cette instance est protégée de transparence. |
...
Initialise une nouvelle instance de la classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). Avec une valeur personnalisée ou inconnue
...
Initialise une nouvelle instance de la classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| isTransparencyProtected | booléen | si défini sur  true  [est protégé de transparence]. |
| isCompositeProtected | booléen | si défini sur  true  [est protégé de façon composite]. |
| isPositionProtected | booléen | si défini sur  true  [est protégé de position]. |
...
La clé d'information d'outil de type 1819504742
...
Obtient ou définit le type du verrou.

Valeur : le type du verrou.
...
Obtient ou définit une valeur indiquant si cette instance est protégée de manière composite.

Valeur :  true  si cette instance est protégée de façon composite ; sinon,  false .
...
Obtient ou définit une valeur indiquant si cette instance est protégée de position.

Valeur :  true  si cette instance est protégée de position ; sinon,  false .
...
Obtient ou définit une valeur indiquant si cette instance est protégée de transparence.

Valeur:  true  si cette instance est protégée contre la transparence ; sinon,  false .
