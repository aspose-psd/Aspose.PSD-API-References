...
type: docs
weight: 41
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Classe KnkoResource. Cette ressource contient des informations sur le mélange de l'élément découpé.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | Initialise une nouvelle instance de la classe [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource()](#KnkoResource--) | Initialise une nouvelle instance de la classe [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | Initialise une nouvelle instance de la classe [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
## Champs
...
| [getKnockout()](#getKnockout--) | Obtient ou définit une valeur indiquant si [blend interior elements]. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | Obtient ou définit une valeur indiquant si [blend interior elements]. |
...
Initialise une nouvelle instance de la classe [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| knockout | booléen | si défini sur  true  [blend interior elements]. |
...
Initialise une nouvelle instance de la classe [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). Avec une valeur personnalisée ou inconnue
