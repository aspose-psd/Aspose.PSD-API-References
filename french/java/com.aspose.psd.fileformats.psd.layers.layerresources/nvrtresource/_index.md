...
type: docs
weight: 63
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
Classe NvrtResource. Ressource du calque de réglage Inverser.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | Initialise une nouvelle instance de la classe [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | Initialise une nouvelle instance de la classe [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
## Champs

| Champ | Description |
| --- | --- |
| [DataLength_internalized](#DataLength-internalized) | Longueur de données attendue. |
...
Initialise une nouvelle instance de la classe [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource).
