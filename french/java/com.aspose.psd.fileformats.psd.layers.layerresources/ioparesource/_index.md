...
type: docs
weight: 40
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
Classe IopaResource. Cette ressource contient des informations sur la propriété d'opacité de remplissage du formulaire de style de calque
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [IopaResource()](#IopaResource--) | Initialise une nouvelle instance de la classe [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Initialise une nouvelle instance de la classe [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
## Champs
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Obtient ou définit l'opacité du remplissage. |
...
Initialise une nouvelle instance de la classe [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).
...
Valeur : l'opacité de remplissage.
