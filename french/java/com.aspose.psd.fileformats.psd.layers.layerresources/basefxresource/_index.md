...
description: "Ressource d'effets de base"
type: docs
weight: 12
url: /fr/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
Ressource d'effets de base
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Initialise une nouvelle instance de la classe [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource). |
## Champs
...
Initialise une nouvelle instance de la classe [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource).

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| resourceKey | int | La clé de la ressource. |
