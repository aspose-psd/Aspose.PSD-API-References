...
description: "Valeurs fourCC empaquetées pour la méthode d'interpolation de dégradé Photoshop."
type: docs
weight: 18
url: /fr/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
| Champ | Description |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Classique (valeur par défaut héritée lorsqu'aucune clé n'est présente). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Linéaire (notez l'espace final). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Perceptuel. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Lisse. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Rayures. |
## Méthodes
...
'Gcls' \\u2014 Classique (valeur par défaut héritée lorsqu'aucune clé n'est présente).
...
'Lnr ' \\u2014 Linéaire (notez l'espace final).
