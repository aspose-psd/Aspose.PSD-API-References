...
description: "Calque Posterize."
type: docs
weight: 25
url: /fr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Couche de postérisation. Gère le rendu de Postérisation en utilisant les données de PostResource.
## Champs
...
| [getLevels()](#getLevels--) | Niveaux du calque Posterize. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Traite le calque Posterize. |
...
| [setLevels(short value)](#setLevels-short-) | Niveaux du calque Posterize. |
