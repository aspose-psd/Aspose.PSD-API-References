...
description: "La classe du calque d'ajustement Black and White."
type: docs
weight: 11
url: /fr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
La classe du calque d'ajustement Black and White.
## Champs
...
| [getTintColor()](#getTintColor--) | Obtient ou définit la valeur de Tint Color. |
| [getTintColorBlue()](#getTintColorBlue--) | Obtient ou définit la valeur double de Blue Tint Color. |
| [getTintColorGreen()](#getTintColorGreen--) | Obtient ou définit la valeur double de Green Tint Color. |
| [getTintColorRed()](#getTintColorRed--) | Obtient ou définit la valeur double de Red Tint Color. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | Traite les pixels. |
...
| [setTintColor(int value)](#setTintColor-int-) | Obtient ou définit la valeur de Tint Color. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | Obtient ou définit la valeur double de Blue Tint Color. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | Obtient ou définit la valeur double de Green Tint Color. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | Obtient ou définit la valeur double de Red Tint Color. |
...
Obtient ou définit la valeur de Tint Color.

Valeur : la valeur de Tint Color.
