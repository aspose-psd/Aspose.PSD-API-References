...
description: "Calque d'ajustement Selective Color."
type: docs
weight: 28
url: /fr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
Calque d'ajustement Selective Color.
## Champs
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Obtient la correction cmyk par couleur sélective. |
| [getContainer()](#getContainer--) | Obtient le conteneur Image. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Obtient ou définit la méthode de correction. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Traite la couche Selective Color. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Définit la correction cmyk par couleur sélective. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Définit le conteneur Image. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Obtient ou définit la méthode de correction. |
...
Obtient la correction cmyk par couleur sélective.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| selectiveColorsType | int | Couleurs sélectives. |
...
Obtient ou définit la méthode de correction.

Valeur : la méthode de correction.
...
Traite la couche Selective Color.
...
Définit la correction cmyk par couleur sélective.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| selectiveColorsType | int | Type des couleurs sélectives. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Correction Cmyk. |
