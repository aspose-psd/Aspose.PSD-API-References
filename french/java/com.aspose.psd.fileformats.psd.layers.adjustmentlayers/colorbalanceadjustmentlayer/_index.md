...
description: "La classe du calque d'ajustement color balance."
type: docs
weight: 16
url: /fr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
La classe du calque d'ajustement color balance.
## Champs
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Obtient ou définit l'équilibre YellowBlue des ombres. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Applique les corrections pour les ombres, tons moyens et hautes lumières actuels au tableau int RGB spécifié. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Obtient ou définit l'équilibre YellowBlue des ombres. |
...
Obtient ou définit l'équilibre YellowBlue des ombres.
...
Applique les corrections pour les ombres, tons moyens et hautes lumières actuels au tableau int RGB spécifié.

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| pixels | int[] | Le tableau int RGB de couleur. |
