...
description: "Calque d'ajustement Exposure."
type: docs
weight: 18
url: /fr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getGammaCorrection()](#getGammaCorrection--) | Obtient ou définit la correction gamma. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Obtient ou définit la correction gamma. |
...
Obtient ou définit l'exposition. Pour PS, la plage d'exposition va de -20 à +20.
...
Obtient ou définit la correction gamma. Pour PS, la plage de correction gamma va de 9.99 à +0.01

Valeur: la correction gamma.
...
Obtient ou définit le décalage. Pour PS, la plage de décalage va de -0.5 à +0.5
