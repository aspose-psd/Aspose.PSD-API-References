...
description: "Calque Gradient map."
type: docs
weight: 19
url: /fr/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
Calque de carte de dégradé. Gère le rendu de la carte de dégradé en utilisant les données de GrdmResource.
## Champs
...
| [getGradientSettings()](#getGradientSettings--) | Obtient ou définit l'instance des paramètres Gradient transmise depuis l'instance GrdmResource. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Traite le calque de carte de dégradé. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | Obtient ou définit l'instance des paramètres Gradient transmise depuis l'instance GrdmResource. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Met à jour les données du calque dans la ressource de calque associée [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
Obtient ou définit l'instance des paramètres Gradient transmise depuis l'instance GrdmResource.
...
Traite le calque de carte de dégradé.
...
Met à jour les données du calque dans la ressource de calque associée [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
