---
title: "CmykChannelMixerLayer Classe"
type: docs
weight: 50
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtient le canal noir. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtient le canal cyan. |
...
| gauche | int | r/w |  |
| longueur | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtient le canal magenta. |
| monochrome | bool | r/w | Obtient ou définit une valeur indiquant si ce [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) est monochrome. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Obtient le canal jaune. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Obtient l'indice du canal par. Retourne CmykMixerChannel |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Fusionne le calque vers le calque spécifié |
| normalize_angle() |  |
...
Obtient l'indice du canal par. Retourne CmykMixerChannel
