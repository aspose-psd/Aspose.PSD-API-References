...
type: docs
weight: 20
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Obtient ou définit la valeur de la couleur de teinte. |
| tint_color_blue | double | r/w | Obtient ou définit la valeur double de la couleur de teinte bleue. |
| tint_color_green | double | r/w | Obtient ou définit la valeur double de la couleur de teinte verte. |
| tint_color_red | double | r/w | Obtient ou définit la valeur double de la couleur de teinte rouge. |
| haut | int | r/w |  |
