...
type: docs
weight: 140
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| gauche | int | r/w |  |
| longueur | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | Obtient le canal maître. |
...
| [get_channel(index)](#get_channel_index_8) | Obtient le canal. |
...
| Type | Description |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) par indice |
