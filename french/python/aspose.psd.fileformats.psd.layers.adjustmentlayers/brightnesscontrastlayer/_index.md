---
title: "Classe BrightnessContrastLayer"
type: docs
weight: 30
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| luminosité | int | r/w | Obtient ou définit la luminosité. Pour la plage PS de la luminosité, elle va de -150 à +150. Mais nous l'ignorons. |
...
| contraste | int | r/w | Obtient ou définit le contraste. Pour la plage PS du contraste, elle va de -50 à +100. Mais nous l'ignorons. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | Charge partiellement les pixels ARGB 32 bits (par blocs). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | Charge les données brutes. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | Fusionne le calque vers le calque spécifié |
| normalize_angle() |  |
