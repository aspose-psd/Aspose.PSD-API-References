...
type: docs
weight: 160
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| clipping | byte | r/w |  |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Obtient ou définit la couleur RVB du filtre. |
...
| density | int | r/w | Obtient ou définit la densité du filtre |
