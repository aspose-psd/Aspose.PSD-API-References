---
title: "SelectiveColorLayer Classe"
type: docs
weight: 200
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | Obtient ou définit la méthode de correction. |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | Obtient la correction cmyk par couleur sélective. |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | Définit la correction cmyk par couleur sélective. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Couleurs sélectives. |

**Returns**

| Type | Description |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Correction Cmyk. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Type des couleurs sélectives. |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Correction Cmyk. |
