---
title: "Classe ExposureLayer"
type: docs
weight: 100
url: /fr/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| libéré | bool | r |  |
| exposition | float | r/w | Obtient ou définit l'Exposure. Pour la plage PS de l'Exposure, elle va de -20 à +20. |
...
| gamma_correction | float | r/w | Obtient ou définit le GammaCorrection. Pour la plage PS du GammaCorrection, elle va de 9.99 à +0.01 |
| a_alpha | bool | r |  |
...
| offset | float | r/w | Obtient ou définit le Offset. Pour la plage PS du Offset, elle va de -0.5 à +0.5 |
| opacity | byte | r/w |  |
