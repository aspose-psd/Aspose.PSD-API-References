...
type: docs
weight: 1600
url: /fr/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Initialise une nouvelle instance de la classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Toutes les ressources sont créées dans leur état par défaut. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Obtient ou définit les paramètres de remplissage pour la zone interne des formes dans le calque de forme. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Obtient l'ensemble des chemins présents dans un calque de forme. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Obtient ou définit les paramètres de contour des formes. |
| haut | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Crée une nouvelle instance de la classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Met à jour les ressources à partir des propriétés du calque Shape. |
...
Initialise une nouvelle instance de la classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Toutes les ressources sont créées dans leur état par défaut.
...
Crée une nouvelle instance de la classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Type | Description |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Renvoie la nouvelle instance de la classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
