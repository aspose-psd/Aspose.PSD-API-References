...
type: docs
weight: 90
url: /fr/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Obtient ou définit la couleur d'arrière-plan du plan de travail. |
...
| a_alpha | bool | r |  |
| has_background_color | bool | r/w | Obtient ou définit une valeur indiquant si [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) a la couleur d'arrière-plan. |
| a_couleur_transparente | bool | r/w |  |
| hauteur | int | r | <inheritdoc /> |
...
| est_en_cache | bool | r |  |
| is_open | bool | r/w | Obtient ou définit si le dossier est ouvert<br/>            si défini sur <c>true</c> alors le groupe sera en état ouvert au démarrage, sinon en état réduit. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Obtient les calques du groupe de calques |
| gauche | int | r/w | <inheritdoc /> |
| longueur | int | r |  |
...
| **Name** | **Description** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Ajoute le calque au groupe de calques. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Ajoute le groupe de calques. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Charge partiellement les pixels ARGB 32 bits (par blocs). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Charge les données brutes. |
