---
title: "Classe TextLayer"
type: docs
weight: 1750
url: /fr/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Obtient la police. |
| a_alpha | bool | r |  |
...
| inner_text | chaîne | r | Obtient le texte de la couche |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Obtient ou définit la boîte englobante du texte. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Obtient la couleur du texte. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Obtient les portions de texte. |
| haut | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Obtient l'ensemble des polices du calque de texte. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Redimensionne l'image. Le [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) par défaut est utilisé. |
...
| [update_text(text)](#update_text_text_38) | Met à jour le texte. |
| [update_text(text, color)](#update_text_text_color_39) | Met à jour le texte. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Met à jour le texte. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Met à jour le texte. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Met à jour le texte. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Met à jour le texte. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Met à jour le texte. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Met à jour le texte. |
...
| Type | Description |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | L'ensemble des polices du calque de texte. |
...
Redimensionne l'image. Le [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) par défaut est utilisé.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Le type de transformation de redimensionnement [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| text | chaîne | La valeur du texte. |
...
| :- | :- | :- |
| text | chaîne | La valeur du texte. |
| color | [Color](/psd/python-net/aspose.psd/color) | La valeur de la couleur. |
...
| :- | :- | :- |
| text | chaîne | La valeur du texte. |
| font_size | float | Taille de la police. |
...
| :- | :- | :- |
| text | chaîne | La valeur du texte. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | La coordonnée en haut à gauche. |
