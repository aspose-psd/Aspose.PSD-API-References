...
type: docs
weight: 940
url: /fr/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [SoLeResource()](#SoLeResource__1) | Initialise une nouvelle instance de la classe [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
| [SoLeResource(unique_id, is_custom, has_comp_info)](#SoLeResource_unique_id_is_custom_has_comp_info_2) | Initialise une nouvelle instance de la classe [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | La clé d'information de l'outil de type : 'SoLE'. |
...
Initialise une nouvelle instance de la classe [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/).
...
| :- | :- | :- |
| unique_id | Guid | L'identifiant unique des données du calque placé [PlLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/). |
