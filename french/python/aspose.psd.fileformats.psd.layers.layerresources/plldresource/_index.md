...
type: docs
weight: 820
url: /fr/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/
---
...
| longueur | int | r | Obtient la longueur de la ressource PlLd en octets. |
...
| **Name** | **Description** |
| :- | :- |
| [save(stream_container, psd_version)](#save_stream_container_psd_version_1) | Enregistre la ressource PlLD dans le conteneur de flux spécifié. |
