...
type: docs
weight: 690
url: /fr/python-net/aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [MlstResource()](#MlstResource__1) | Initialise une nouvelle instance de la classe MlstResource |
## **Properties**
...
| descriptor_version | int | r | Obtient ou définit la version du descripteur. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | Obtient ou définit les structures. |
...
Initialise une nouvelle instance de la classe MlstResource
