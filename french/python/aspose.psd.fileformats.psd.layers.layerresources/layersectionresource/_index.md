...
type: docs
weight: 460
url: /fr/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [LayerSectionResource()](#LayerSectionResource__1) | Initialise une nouvelle instance de la classe [LayerSectionResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/). |
## **Properties**
...
| section_type | [LayerSectionType](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectiontype) | r/w | Obtient ou définit le type de section. |
| signature | int | r | Obtient la signature. |
| subtype | [LayerSectionSubtype](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionsubtype) | r/w | Obtient ou définit le sous-type. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Initialise une nouvelle instance de la classe [LayerSectionResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/).
