...
type: docs
weight: 50
url: /fr/python-net/aspose.psd.shapes/pieshape/
---
...
| **Name** | **Description** |
| :- | :- |
| [PieShape()](#PieShape__1) | Initialise une nouvelle instance de la classe [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/). |
| [PieShape(rectangle, start_angle, sweep_angle)](#PieShape_rectangle_start_angle_sweep_angle_2) | Initialise une nouvelle instance de la classe [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/). |
## **Properties**
...
Initialise une nouvelle instance de la classe [PieShape](/psd/python-net/aspose.psd.shapes/pieshape/).
