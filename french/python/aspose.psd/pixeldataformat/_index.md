...
type: docs
weight: 3450
url: /fr/python-net/aspose.psd/pixeldataformat/
---
...
| légende | chaîne | r | Obtient la légende du format de données pixel. |
| channel_bits | int | r | Obtient le nombre de bits pour chaque canal. |
| channels_count | int | r | Obtient le nombre de canaux. |
| cmyk [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 32 bits par pixel avec 8 bits pour chacun du cyan, magenta, jaune et noir. |
| cmyka [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le acmyk. |
| grayscale [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 8 bits par pixel avec 8 bits représentant l'intensité en niveaux de gris dans l'intervalle 0-255. |
| grayscale_alpha [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 16 bits par pixel avec 8 bits représentant l'intensité en niveaux de gris dans l'intervalle 0-255 et un composant alpha supplémentaire de 8 bits. |
| pixel_format | [PixelFormat](/psd/python-net/aspose.psd/pixelformat) | r | Obtient le format de pixel. |
| rgb_16_bpp_555 [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 16 bits par pixel avec 5 bits pour chacun du rouge, vert et bleu, l'alpha n'est pas défini. |
| rgb_16_bpp_565 [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 16 bits par pixel avec 5 bits pour le rouge, 6 bits pour le vert et 5 bits pour le bleu, l'alpha n'est pas défini. |
| rgb_24_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 24 bits par pixel avec 8 bits pour chacun de l'alpha, du rouge, du vert et du bleu, l'alpha n'est pas défini. |
| rgb_24_bpp_png [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 24 bits par pixel avec 8 bits pour chacun de l'alpha, du rouge, du vert et du bleu, l'alpha n'est pas défini. |
| rgb_32_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 32 bits par pixel avec 8 bits pour chacun de l'alpha, du rouge, du vert et du bleu. |
| rgb_indexed_1_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 1 bit indexé par couleur.<br/>            Le stockage de données pixel indexées est destiné à permettre le stockage et la récupération des données partout où la palette de couleurs est utilisée.<br/>            Utilisez-le avec prudence, car il peut nécessiter une conversion d'une palette à une autre ou du modèle RGBA au modèle de couleur indexée. |
| rgb_indexed_2_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour un index de 2 bits par couleur.<br/>            Le stockage de données de pixels indexés est destiné à permettre le stockage et la récupération des données partout où la palette de couleurs est utilisée.<br/>            Utilisez-le avec prudence, car cela peut nécessiter une conversion d’une palette à une autre ou du RGBA vers un modèle de couleur indexé. |
| rgb_indexed_4_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour un index de 4 bits par couleur.<br/>            Le stockage de données de pixels indexés est destiné à permettre le stockage et la récupération des données partout où la palette de couleurs est utilisée.<br/>            Utilisez-le avec prudence, car cela peut nécessiter une conversion d’une palette à une autre ou du RGBA vers un modèle de couleur indexé. |
| rgb_indexed_8_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour un index de 8 bits par couleur.<br/>            Le stockage de données de pixels indexés est destiné à permettre le stockage et la récupération des données partout où la palette de couleurs est utilisée.<br/>            Utilisez-le avec prudence, car cela peut nécessiter une conversion d’une palette à une autre ou du RGBA vers un modèle de couleur indexé. |
| rgba_32_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 32 bits par pixel avec 8 bits pour chacun de l'alpha, du rouge, du vert et du bleu. |
| rgba_64_bpp [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 64 bits par pixel avec 16 bits pour chacun des canaux alpha, rouge, vert et bleu. |
| y_cb_cr [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 24 bits par pixel avec 8 bits pour chacun des composants chromatiques luma, différence bleue et différence rouge. |
| ycck [static] | [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | r | Obtient le [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat/) défini pour 32 bits par pixel avec 8 bits pour chacun des composants chromatiques luma, différence bleue, différence rouge et noir. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_grayscale_alpha(bits_per_sample)](#get_grayscale_alpha_bits_per_sample_8) | Obtient la couleur Niveaux de gris Alpha avec un nombre spécifié de bits par échantillon. |
| [get_grayscale_alpha(bits_per_sample, alpha_channel_bits)](#get_grayscale_alpha_bits_per_sample_alpha_channel_bits_9) | Obtient la couleur Niveaux de gris Alpha avec un nombre spécifié de bits par échantillon. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur BGRA. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur CIE Lab. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur CMYK. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur en niveaux de gris. |
...
Obtient la couleur Niveaux de gris Alpha avec un nombre spécifié de bits par échantillon.
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur GrayscaleAlpha. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur RVB. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur RGBA. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur YCbCr. |
...
| Type | Description |
| :- | :- |
| [PixelDataFormat](/psd/python-net/aspose.psd/pixeldataformat) | La couleur YCCK. |
