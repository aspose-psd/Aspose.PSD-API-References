...
type: docs
weight: 2180
url: /fr/python-net/aspose.psd/imageattributes/
---
...
| **Name** | **Description** |
| :- | :- |
| [ImageAttributes()](#ImageAttributes__1) | Initialise une nouvelle instance de la classe ImageAttributes |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| clear_brush_remap_table() | Efface la table de remappage des couleurs du pinceau de cet objet [ImageAttributes](/psd/python-net/aspose.psd/imageattributes/). |
...
| clear_output_channel_color_profile() | Efface le paramètre du profil couleur du canal de sortie pour la catégorie par défaut. |
| [clear_output_channel_color_profile(type)](#clear_output_channel_color_profile_type_6) | Efface le paramètre du profil couleur du canal de sortie pour une catégorie spécifiée. |
...
| [set_output_channel(flags)](#set_output_channel_flags_21) | Définit le canal de sortie CMYK (cyan-magenta-jaune-noir) pour la catégorie par défaut. |
| [set_output_channel(flags, type)](#set_output_channel_flags_type_22) | Définit le canal de sortie CMYK (cyan-magenta-jaune-noir) pour une catégorie spécifiée. |
...
| [set_wrap_mode(mode)](#set_wrap_mode_mode_29) | Définit le mode d'enveloppement utilisé pour déterminer comment répéter une texture sur une forme, ou aux limites de la forme. Une texture est répétée sur une forme pour la remplir lorsque la texture est plus petite que la forme qu'elle remplit. |
| [set_wrap_mode(mode, color)](#set_wrap_mode_mode_color_30) | Définit le mode d'enveloppement et la couleur utilisés pour déterminer comment répéter une texture sur une forme, ou aux limites de la forme. Une texture est répétée sur une forme pour la remplir lorsque la texture est plus petite que la forme qu'elle remplit. |
| [set_wrap_mode(mode, color, clamp)](#set_wrap_mode_mode_color_clamp_31) | Définit le mode d'enveloppement et la couleur utilisés pour déterminer comment répéter une texture sur une forme, ou aux limites de la forme. Une texture est répétée sur une forme pour la remplir lorsque la texture est plus petite que la forme qu'elle remplit. |
...
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la clé de couleur est effacée. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la matrice d'ajustement des couleurs est effacée. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la correction gamma est désactivée. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le paramètre NoOp est effacé. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le paramètre du canal de sortie est réinitialisé. |
...
Efface le paramètre du profil couleur du canal de sortie pour une catégorie spécifiée.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le paramètre du profil du canal de sortie est réinitialisé. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la table de remappage est réinitialisée. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le seuil est réinitialisé. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | Un tableau d'objets [ColorMap](/psd/python-net/aspose.psd/colormap/). |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| color_low | [Color](/psd/python-net/aspose.psd/color) | La valeur basse de la clé de couleur. |
| color_high | [Color](/psd/python-net/aspose.psd/color) | La valeur haute de la clé de couleur. |
...
| color_low | [Color](/psd/python-net/aspose.psd/color) | La valeur basse de la clé de couleur. |
| color_high | [Color](/psd/python-net/aspose.psd/color) | La valeur haute de la clé de couleur. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la clé de couleur est définie. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement des couleurs. |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement du niveau de gris. |
...
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement des couleurs. |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement du niveau de gris. |
| flags | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un élément de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) qui spécifie le type d'image et de couleur qui sera affecté par les matrices d'ajustement des couleurs et d'ajustement du niveau de gris. |
...
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement des couleurs. |
| gray_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement du niveau de gris. |
| mode | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un élément de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) qui spécifie le type d'image et de couleur qui sera affecté par les matrices d'ajustement des couleurs et d'ajustement du niveau de gris. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle les matrices d'ajustement des couleurs et d'ajustement du niveau de gris sont définies. |
...
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement des couleurs. |
| flags | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un élément de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) qui spécifie le type d'image et de couleur qui sera affecté par la matrice d'ajustement des couleurs. |
...
| :- | :- | :- |
| new_color_matrix | [ColorMatrix](/psd/python-net/aspose.psd/colormatrix) | La matrice d'ajustement des couleurs. |
| mode | [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag) | Un élément de [ColorMatrixFlag](/psd/python-net/aspose.psd/colormatrixflag/) qui spécifie le type d'image et de couleur qui sera affecté par la matrice d'ajustement des couleurs. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la matrice d'ajustement des couleurs est définie. |
...
| :- | :- | :- |
| gamma | float | La valeur de correction gamma. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de l'énumération [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la valeur gamma est définie. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la correction des couleurs est désactivée. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| flags | [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag) | Un élément de [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag/) qui spécifie le canal de sortie. |
...
| :- | :- | :- |
| flags | [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag) | Un élément de [ColorChannelFlag](/psd/python-net/aspose.psd/colorchannelflag/) qui spécifie le canal de sortie. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le canal de sortie est défini. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| color_profile_filename | chaîne | Le chemin d'accès d'un fichier de profil couleur. Si le fichier de profil couleur se trouve dans le répertoire %SystemRoot%\System32\Spool\Drivers\Color, ce paramètre peut être le nom du fichier. Sinon, ce paramètre doit être le chemin d'accès complet. |
...
| :- | :- | :- |
| color_profile_filename | chaîne | Le chemin d'accès d'un fichier de profil couleur. Si le fichier de profil couleur se trouve dans le répertoire %SystemRoot%\System32\Spool\Drivers\Color, ce paramètre peut être le nom du fichier. Sinon, ce paramètre doit être le chemin d'accès complet. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le fichier de profil couleur du canal de sortie est défini. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | Un tableau de paires de couleurs du type [ColorMap](/psd/python-net/aspose.psd/colormap/). Chaque paire de couleurs contient une couleur existante (la première valeur) et la couleur vers laquelle elle sera mappée (la deuxième valeur). |
...
| :- | :- | :- |
| map | [ColorMap[]](/psd/python-net/aspose.psd/colormap) | Un tableau de paires de couleurs du type [ColorMap](/psd/python-net/aspose.psd/colormap/). Chaque paire de couleurs contient une couleur existante (la première valeur) et la couleur vers laquelle elle sera mappée (la deuxième valeur). |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle la table de remappage des couleurs est définie. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| threshold | float | Une valeur de seuil de 0,0 à 1,0 utilisée comme point de rupture pour trier les couleurs qui seront associées à une valeur maximale ou minimale. |
| type | [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype) | Un élément de [ColorAdjustType](/psd/python-net/aspose.psd/coloradjusttype/) qui spécifie la catégorie pour laquelle le seuil de couleur est défini. |
...
Définit le mode d'enveloppement utilisé pour déterminer comment répéter une texture sur une forme, ou aux limites de la forme. Une texture est répétée sur une forme pour la remplir lorsque la texture est plus petite que la forme qu'elle remplit.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | Un élément de [WrapMode](/psd/python-net/aspose.psd/wrapmode/) qui indique comment les copies répétées d'une image sont utilisées pour couvrir une zone. |
...
Définit le mode d'enveloppement et la couleur utilisés pour déterminer comment répéter une texture sur une forme, ou aux limites de la forme. Une texture est répétée sur une forme pour la remplir lorsque la texture est plus petite que la forme qu'elle remplit.
...
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | Un élément de [WrapMode](/psd/python-net/aspose.psd/wrapmode/) qui indique comment les copies répétées d'une image sont utilisées pour couvrir une zone. |
| color | [Color](/psd/python-net/aspose.psd/color) | Un objet [ImageAttributes](/psd/python-net/aspose.psd/imageattributes/) qui spécifie la couleur des pixels en dehors d'une image rendue. Cette couleur est visible si le paramètre mode est défini sur [WrapMode.CLAMP](/psd/python-net/aspose.psd/wrapmode/) et que le rectangle source passé à DrawImage est plus grand que l'image elle‑même. |
...
| :- | :- | :- |
| mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | Un élément de [WrapMode](/psd/python-net/aspose.psd/wrapmode/) qui indique comment les copies répétées d'une image sont utilisées pour couvrir une zone. |
| color | [Color](/psd/python-net/aspose.psd/color) | Un objet couleur qui spécifie la couleur des pixels en dehors d'une image rendue. Cette couleur est visible si le paramètre mode est défini sur [WrapMode.CLAMP](/psd/python-net/aspose.psd/wrapmode/) et que le rectangle source passé à DrawImage est plus grand que l'image elle‑même. |
| serrer | bool | Ce paramètre n'a aucun effet. Réglez‑le sur false. |
