---
title: "Classe LayerSelectionIdsResource"
type: docs
weight: 170
url: /fr/python-net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource__1) | Initialise une nouvelle instance de la classe LayerSelectionIdsResource |
## **Properties**
...
| count | short | r/w | Obtient ou définit le nombre. |
...
| layer_ids | int | r/w | Obtient ou définit les identifiants de couche. |
...
Initialise une nouvelle instance de la classe LayerSelectionIdsResource
