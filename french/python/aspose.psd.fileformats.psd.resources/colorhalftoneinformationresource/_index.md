---
title: "Classe ColorHalftoneInformationResource"
type: docs
weight: 50
url: /fr/python-net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource__1) | Initialise une nouvelle instance de la classe ColorHalftoneInformationResource |
## **Properties**
...
| halftone_data | byte | r/w | Obtient ou définit les données de demi-teinte. |
...
Initialise une nouvelle instance de la classe ColorHalftoneInformationResource
