...
type: docs
weight: 290
url: /fr/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | Initialise une nouvelle instance de la classe UrlListResource |
## **Properties**
...
| count | int | r/w | Obtient ou définit le nombre. |
...
| ids | int | r/w | Obtient ou définit les ids. |
| longs | int | r/w | Obtient ou définit les longs. |
...
| texts | chaîne | r/w | Obtient ou définit les textes. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Initialise une nouvelle instance de la classe UrlListResource
