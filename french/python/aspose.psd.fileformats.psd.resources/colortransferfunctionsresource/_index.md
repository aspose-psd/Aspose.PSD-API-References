---
title: "Classe ColorTransferFunctionsResource"
type: docs
weight: 60
url: /fr/python-net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource__1) | Initialise une nouvelle instance de la classe ColorTransferFunctionsResource |
## **Properties**
...
| color_transfer_data | byte | r/w | Obtient ou définit les données de transfert de couleur. |
...
Initialise une nouvelle instance de la classe ColorTransferFunctionsResource
