---
title: "Classe PrintScaleResource"
type: docs
weight: 210
url: /fr/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | Initialise une nouvelle instance de la classe PrintScaleResource |
## **Properties**
...
| scale | float | r/w | Obtient ou définit l'échelle. |
...
| style | short | r/w | Obtient ou définit le style. |
| x_location | float | r/w | Obtient ou définit la position x. |
| y_location | float | r/w | Obtient ou définit la position y. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Initialise une nouvelle instance de la classe PrintScaleResource
