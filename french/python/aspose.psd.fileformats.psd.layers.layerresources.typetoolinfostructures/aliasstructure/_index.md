---
title: "Classe AliasStructure"
type: docs
weight: 10
url: /fr/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Description** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Initialise une nouvelle instance de la classe [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [statique] | int | r | Identifie la clé de structure. |
| data_length | int | r | Obtient la longueur exacte des données en octets. |
| full_path | chaîne | r/w | Obtient ou définit le chemin complet. |
...
Initialise une nouvelle instance de la classe [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/).
