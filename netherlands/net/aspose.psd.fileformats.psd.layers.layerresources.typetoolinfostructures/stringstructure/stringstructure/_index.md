...
description: StringStructure constructeur. Initialiseert een nieuw exemplaar van hetStringStructure klasse.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/stringstructure/
---
## StringStructure(ClassID) {#constructor}

Initialiseert een nieuw exemplaar van het[`StringStructure`](../) klasse.
...
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources.TypeToolInfoStructures](../../stringstructure/)
* montage [Aspose.PSD](../../../)
...
Initialiseert een nieuw exemplaar van het[`StringStructure`](../)klasse met waarde.
