...
description: ObjectArrayStructure constructeur. Initialiseert een nieuw exemplaar van hetObjectArrayStructure klasse.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/objectarraystructure/
---
## ObjectArrayStructure(string, string, OSTypeStructure[]) {#constructor_1}

Initialiseert een nieuw exemplaar van het[`ObjectArrayStructure`](../) klasse.
...
| --- | --- | --- |
| keyName | String | Naam van de sleutel. |
| classIdName | String | Naam van de klasse-ID. |
| structures | OSTypeStructure[] | De structuren. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| key | Int32 | De integer-sleutel. |
| keyName | ClassID | De sleutelnaam. |
| classID | ClassID | De klasse-ID. |
| className | String | Naam van de klas. |
| structures | OSTypeStructure[] | De structuren. |
