...
description: PsdImage methode. Converteert deze afbeeldingsindeling naar de indeling die is opgegeven in opties.
type: docs
weight: 500
url: /nl/net/aspose.psd.fileformats.psd/psdimage/convert/
---
## PsdImage.Convert method

Converteert deze afbeeldingsindeling naar de indeling die is opgegeven in opties.
...
| --- | --- | --- |
| newOptions | PsdOptions | De nieuwe opties. |

### Voorbeelden

Deze voorbeelden demonstreren de conversie van het PSD-beeldformaat naar andere kleurmodi/bitdiepte.
...
// Slaat op naar PSD, laadt vervolgens het opgeslagen bestand en slaat op naar PNG.
