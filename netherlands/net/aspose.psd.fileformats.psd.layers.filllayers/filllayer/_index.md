...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer klas. Laag vullen. Kleuropvulling verloopopvulling of patroonopvullaag die verschilt perFillSettings
type: docs
weight: 1910
url: /nl/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

Laag vullen. Kleuropvulling, verloopopvulling of patroonopvullaag die verschilt per[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Haalt de vulinstellingen op. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Haalt het type vulling op. |
...
| Naam | Beschrijving |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Bouw een nieuw exemplaar van het`FillLayer` klasse op type vulling. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Vervangt alle niet-transparante kleuren door nieuwe kleuren en behoudt de oorspronkelijke alfawaarde om vloeiende randen te besparen. Opmerking: als u het gebruikt op afbeeldingen zonder transparantie, worden alle kleuren vervangen door een enkele kleur. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Updates Fill Layer Pixels Gegevens volgens actueel[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* montage [Aspose.PSD](../../)
