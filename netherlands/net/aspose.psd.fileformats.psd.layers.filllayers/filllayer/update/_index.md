...
description: FillLayer methode. Updates Fill Layer Pixels Gegevens volgens actueelIFillSettings .
type: docs
weight: 50
url: /nl/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/
---
## FillLayer.Update method

Updates Fill Layer Pixels Gegevens volgens actueel[`IFillSettings`](../../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) .
...
| --- | --- |
| ArgumentOutOfRangeException | Onbekend type FillType |

### Voorbeelden

De volgende code demonstreert de ondersteuning van opvullagen: Kleurvulling.

```csharp
[C#]

// Ondersteuning van opvullagen toevoegen: kleurvulling
