...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer klas. Cmyk Channel Mixeraanpassingslaag.
type: docs
weight: 1700
url: /nl/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
## CmykChannelMixerLayer class

Cmyk Channel Mixer-aanpassingslaag.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | Krijgt het zwarte kanaal. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Haalt het cyaankanaal op. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | Haalt het magenta kanaal op. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Haalt of stelt een waarde in die aangeeft of dit[`ChannelMixerLayer`](../channelmixerlayer/) is monochroom. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | Krijgt het gele kanaal. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Haalt de index van het kanaal op. Retourneert CmykMixerChannel |
