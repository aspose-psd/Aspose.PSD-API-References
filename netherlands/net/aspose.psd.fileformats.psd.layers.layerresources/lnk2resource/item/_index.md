...
description: Lnk2Resource eigendom. Krijgt deLiFdDataSource op de opgegeven index.
type: docs
weight: 20
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
## Lnk2Resource indexer

Krijgt de[`LiFdDataSource`](../../lifddatasource/) op de opgegeven index.
...
De[`LiFdDataSource`](../../lifddatasource/) instantie.

### Eigendoms-waarde

De[`LiFdDataSource`](../../lifddatasource/) .
...
* class [Lnk2Resource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lnk2resource/)
* montage [Aspose.PSD](../../../)
