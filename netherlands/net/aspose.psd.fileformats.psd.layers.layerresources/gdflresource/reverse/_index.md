...
description: GdFlResource eigendom. Haalt of stelt een waarde in die aangeeft of ditGdFlResource is omgekeerd.
type: docs
weight: 140
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/gdflresource/reverse/
---
## GdFlResource.Reverse property

Haalt of stelt een waarde in die aangeeft of dit[`GdFlResource`](../) is omgekeerd.
...
`WAAR` indien omgekeerd; anders,`vals` .
...
* class [GdFlResource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../gdflresource/)
* montage [Aspose.PSD](../../../)
