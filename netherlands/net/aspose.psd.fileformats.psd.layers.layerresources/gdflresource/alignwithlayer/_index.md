...
description: GdFlResource eigendom. Haalt of stelt een waarde in die aangeeft of uitlijnen met laag.
type: docs
weight: 20
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/gdflresource/alignwithlayer/
---
## GdFlResource.AlignWithLayer property

Haalt of stelt een waarde in die aangeeft of [uitlijnen met laag].
...
`WAAR` als [uitlijnen met laag]; anders,`vals` .
