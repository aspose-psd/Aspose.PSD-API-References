...
description: GdFlResource eigendom. Haalt of stelt een waarde in die aangeeft of ditGdFlResource is dither.
type: docs
weight: 60
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/gdflresource/dither/
---
## GdFlResource.Dither property

Haalt of stelt een waarde in die aangeeft of dit[`GdFlResource`](../) is dither.
