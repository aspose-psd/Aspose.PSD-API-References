...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SmartResourceCreator klas. Definieert de SmartResourceCreatorklasse die PlLd SoLd en SoLeresources kan maken. Wordt gebruikt om slimme objectlagen in de Adobe Photoshopafbeeldingen te ondersteunen.
type: docs
weight: 3000
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/
---
## SmartResourceCreator class

Definieert de SmartResourceCreator-klasse die PlLd-, SoLd- en SoLe-resources kan maken. Wordt gebruikt om slimme objectlagen in de Adobe® Photoshop®-afbeeldingen te ondersteunen.
...
| Naam | Beschrijving |
| --- | --- |
| [SmartResourceCreator](smartresourcecreator/#constructor)() | Initialiseert een nieuw exemplaar van het`SmartResourceCreator` klasse. |
| [SmartResourceCreator](smartresourcecreator/#constructor_1)(PlacedResource) | Initialiseert een nieuw exemplaar van het`SmartResourceCreator` class met het opgegeven sjabloon. |
| [SmartResourceCreator](smartresourcecreator/#constructor_2)(bool, bool) | Initialiseert een nieuw exemplaar van het`SmartResourceCreator` klasse. |

## methoden

| Naam | Beschrijving |
| --- | --- |
| [GeneratePlacedResource](../../aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/generateplacedresource/)() | Genereert de geplaatste resource. |
| [GenerateSmartEmbeddedResource](../../aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/generatesmartembeddedresource/)() | Genereert de ingebedde slimme objectbron. |
| [GenerateSmartExternalResource](../../aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/generatesmartexternalresource/)() | Genereert de externe slimme objectbron. |
