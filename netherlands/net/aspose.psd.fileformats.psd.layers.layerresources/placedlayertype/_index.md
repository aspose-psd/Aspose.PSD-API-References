...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlacedLayerType opsomming. Definieert de PlacedLayerTypeopsomming voor de geplaatste laag PlLdresource.
type: docs
weight: 2930
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/placedlayertype/
---
## PlacedLayerType enumeration

Definieert de PlacedLayerType-opsomming voor de geplaatste laag PlLd-resource.
...
| --- | --- | --- |
| Unknown | `0` | De onbekende geplaatste laag type |
| Vector | `1` | De vector geplaatste laag type |
| Raster | `2` | De raster geplaatste laag type |
| ImageStack | `3` | De afbeeldingsstapel geplaatste laag type |

### Voorbeelden

De volgende code demonstreert de ondersteuning van de PlLdResource-resource.
