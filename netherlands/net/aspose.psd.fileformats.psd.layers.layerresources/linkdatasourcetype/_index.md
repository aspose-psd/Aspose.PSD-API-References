...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LinkDataSourceType opsomming. Definieert de LinkDataSourceTypeopsomming voor de gegevensbronnen in de PSDlinkresource.
type: docs
weight: 2700
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasourcetype/
---
## LinkDataSourceType enumeration

Definieert de LinkDataSourceType-opsomming voor de gegevensbronnen in de PSD-linkresource.
...
| --- | --- | --- |
| None | `0` | De lege linkbron. |
| liFD | `1` | Het ingesloten gekoppelde bestand data |
| liFE | `2` | Het extern gekoppelde bestand data |
| liFA | `3` | De gekoppelde bestandsalias data |
