...
description: VmskResource constructeur. Initialiseert een nieuw exemplaar van hetVmskResource klasse.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/vmskresource/
---
## VmskResource(byte[]) {#constructor_1}

Initialiseert een nieuw exemplaar van het[`VmskResource`](../) klasse.
...
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Ongeldige Vmsk-resourcewaarde |

### Zie ook

* class [VmskResource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../vmskresource/)
* montage [Aspose.PSD](../../../)
