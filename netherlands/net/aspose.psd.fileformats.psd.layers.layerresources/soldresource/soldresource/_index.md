...
description: SoLdResource constructeur. Initialiseert een nieuw exemplaar van hetSoLdResource class. Het is noodzakelijk om de eigenschap Items in te stellen of InitializeItems aan te roepen om een kantenklare instantie te krijgen. Deze constructor is ontworpen voor gebruik doorSmartResourceCreator en in eenheidstests. GebruikSmartResourceCreator voor het maken van SoLdResourceklassen.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/soldresource/
---
...
| --- | --- | --- |
| uniqueId | Guid | De unieke identificatie van de gegevens van de slimme objectlaag[`SoLdResource`](../). |
| isCustom | Boolean | indien ingesteld op`WAAR` [wordt aangepast]. |
| hasCompInfo | Boolean | indien ingesteld op`WAAR` [heeft comp-informatie]. |
...
* class [SoLdResource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../soldresource/)
* montage [Aspose.PSD](../../../)
...
Initialiseert een nieuw exemplaar van het[`SoLdResource`](../) class. Deze standaardconstructor is ontworpen voor gebruik doorSoLdResourceLoader . Gebruik[`SmartResourceCreator`](../../smartresourcecreator/) voor het maken van SoLdResource-klassen.
