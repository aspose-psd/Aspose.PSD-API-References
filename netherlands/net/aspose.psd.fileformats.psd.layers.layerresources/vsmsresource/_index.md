...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.VsmsResource klas. Klasse VsmsResource. Deze bron bevat informatie over vectorlaagmasker
type: docs
weight: 3380
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/
---
## VsmsResource class
...
| Naam | Beschrijving |
| --- | --- |
| [VsmsResource](vsmsresource/#constructor)() | Initialiseert een nieuw exemplaar van het`VsmsResource` klasse. |
| [VsmsResource](vsmsresource/#constructor_1)(byte[]) | Initialiseert een nieuw exemplaar van het`VsmsResource` klasse. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/key/) { get; } | Haalt de laagbronsleutel op. |
...
| Naam | Beschrijving |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/typetoolkey/) | De infotoets voor het typen van gereedschap. |
