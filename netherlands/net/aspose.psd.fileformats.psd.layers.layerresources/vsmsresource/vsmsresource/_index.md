...
description: VsmsResource constructeur. Initialiseert een nieuw exemplaar van hetVsmsResource klasse.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/vsmsresource/vsmsresource/
---
## VsmsResource(byte[]) {#constructor_1}

Initialiseert een nieuw exemplaar van het[`VsmsResource`](../) klasse.
...
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Ongeldige Vsms-resourcewaarde |

### Zie ook

* class [VsmsResource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../vsmsresource/)
* montage [Aspose.PSD](../../../)
