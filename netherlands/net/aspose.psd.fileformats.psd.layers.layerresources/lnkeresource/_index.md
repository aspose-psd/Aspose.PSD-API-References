...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LnkeResource klas. Definieert de klasse LnkeResource die informatie bevat over externe gekoppelde bestanden of middelen in de afbeelding in PSDindeling. De koppelingsbron kan meerdereLiFeDataSource instanties die toegankelijk zijn voor indexer. Dit is een onderdeel van de PSD File Format Manipulation API die helpt bij het programmatisch wijzigen van Adobe Photoshopbestanden
type: docs
weight: 2740
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lnkeresource/
---
## LnkeResource class

Definieert de klasse LnkeResource die informatie bevat over externe gekoppelde bestanden of middelen in de afbeelding in PSD-indeling. De koppelingsbron kan meerdere[`LiFeDataSource`](../lifedatasource/) instanties die toegankelijk zijn voor indexer. Dit is een onderdeel van de PSD File Format Manipulation API die helpt bij het programmatisch wijzigen van Adobe® Photoshop®-bestanden
...
| Naam | Beschrijving |
| --- | --- |
| [LnkeResource](lnkeresource/#constructor)() | Initialiseert een nieuw exemplaar van het`LnkeResource` klasse. |
| [LnkeResource](lnkeresource/#constructor_1)(LinkDataSource[]) | Initialiseert een nieuw exemplaar van het`LnkeResource` klasse. |
...
| [Item](../../aspose.psd.fileformats.psd.layers.layerresources/lnkeresource/item/) { get; } | Krijgt de[`LiFeDataSource`](../lifedatasource/) op de opgegeven index. (2 indexers) |
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/lnkeresource/key/) { get; } | Haalt de Adobe® Photoshop® globale broncode op. |
...
| Naam | Beschrijving |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lnkeresource/typetoolkey/) | De infotoets voor het typen van gereedschap. |
