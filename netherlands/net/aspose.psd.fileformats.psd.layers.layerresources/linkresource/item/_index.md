...
description: LinkResource eigendom. Krijgt deLinkDataSource bij de gespecificeerde index die de unieke identifier van de linkgegevensbron is..
type: docs
weight: 30
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/linkresource/item/
---
## LinkResource indexer

Krijgt de[`LinkDataSource`](../../linkdatasource/) bij de gespecificeerde index die de unieke identifier van de linkgegevensbron is..
...
| --- | --- |
| index | De index als unieke identifier van de linkgegevensbron. |

### Winstwaarde

De[`LinkDataSource`](../../linkdatasource/) instantie.

### Eigendoms-waarde

De[`LinkDataSource`](../../linkdatasource/) .
...
* class [LinkResource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../linkresource/)
* montage [Aspose.PSD](../../../)
