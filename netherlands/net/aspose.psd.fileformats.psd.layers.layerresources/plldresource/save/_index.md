...
description: PlLdResource methode. Slaat de PlLDresource op in de opgegeven streamcontainer.
type: docs
weight: 50
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/save/
---
...
| --- | --- | --- |
| streamContainer | StreamContainer | De streamcontainer waarin moet worden opgeslagen. |
...
* class [PlLdResource](../)
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../plldresource/)
* montage [Aspose.PSD](../../../)
