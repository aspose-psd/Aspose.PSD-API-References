...
description: PlacedResource eigendom. Haalt de globale unieke identificatie van de geplaatste laag in de PSDafbeelding op of stelt deze in.
type: docs
weight: 180
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/uniqueid/
---
## PlacedResource.UniqueId property

Haalt de globale unieke identificatie van de geplaatste laag in de PSD-afbeelding op of stelt deze in.
...
De unieke identificatie van de geplaatste laag.
...
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../placedresource/)
* montage [Aspose.PSD](../../../)
