...
description: SmartObjectResource eigendom. Haalt de globale unieke identificatie van de slimme objectlaaggegevens op of stelt deze inSmartObjectResource in de PSDafbeelding.
type: docs
weight: 240
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

Haalt de globale unieke identificatie van de slimme objectlaaggegevens op of stelt deze in[`SmartObjectResource`](../) in de PSD-afbeelding.
...
De globale unieke identificatie van de gegevens van de slimme objectlaag[`SmartObjectResource`](../) .
