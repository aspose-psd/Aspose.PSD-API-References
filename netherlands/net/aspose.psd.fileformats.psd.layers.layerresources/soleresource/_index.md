...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource klas. Definieert de SoLeResourceklasse die informatie bevat over een slimme objectlaag in een PSDbestand. Wordt gebruikt om slimme objectlagen te ondersteunen met externe bestandskoppelingen in de Adobe Photoshopafbeeldingen.
type: docs
weight: 3030
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
## SoLeResource class
...
| Naam | Beschrijving |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Initialiseert een nieuw exemplaar van het`SoLeResource` klasse. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Initialiseert een nieuw exemplaar van het`SoLeResource` klasse. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/key/) { get; } | Haalt de resourcesleutel van de enige slimme objectlaag op. |
...
| Naam | Beschrijving |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | De infosleutel van het type gereedschap: 'SoLE'. |
