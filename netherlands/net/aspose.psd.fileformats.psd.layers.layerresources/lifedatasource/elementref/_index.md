...
description: LiFeDataSource eigendom. Haalt of stelt de grafische bibliotheekelementreferentie in voor Adobe Photoshop CC Libraries.
type: docs
weight: 60
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
## LiFeDataSource.ElementRef property

Haalt of stelt de grafische bibliotheekelementreferentie in, voor Adobe® Photoshop® CC Libraries.
...
De elementreferentie van de grafische bibliotheek.

### Uitzonderingen

| uitzondering | voorwaarde |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de eigenschap ElementRef, deze is alleen beschikbaar voor de liFE-gegevensbron wanneer IsLibrary true is |
