...
description: LiFeDataSource eigendom. Hiermee wordt de grootte van het externe bestand in de LiFEgegevensbron van de PSD LnkEresource opgehaald of ingesteld.
type: docs
weight: 80
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
## LiFeDataSource.FileSize property

Hiermee wordt de grootte van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource opgehaald of ingesteld.
...
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de eigenschap FileSize, deze is alleen beschikbaar voor liFE-gegevensbron |
