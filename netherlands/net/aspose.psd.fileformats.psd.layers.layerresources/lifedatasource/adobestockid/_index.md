...
description: LiFeDataSource eigendom. Haalt de grafische bibliotheek AdobeStockId op of stelt deze in voor Adobe Photoshop CC Libraries.
type: docs
weight: 20
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

Haalt de grafische bibliotheek AdobeStockId op of stelt deze in voor Adobe® Photoshop® CC Libraries.
...
De grafische bibliotheek Adobe Stock Identifier.

### Uitzonderingen

| uitzondering | voorwaarde |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de AdobeStockId-eigenschap, deze is alleen beschikbaar voor de liFE-gegevensbron wanneer IsLibrary true is |
