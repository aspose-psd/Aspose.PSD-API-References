...
description: LiFeDataSource eigendom. Krijgt de status van de Adobe Stocklicentie indien beschikbaar voor Adobe Photoshop CCbibliotheken.
type: docs
weight: 30
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestocklicensestate/
---
## LiFeDataSource.AdobeStockLicenseState property

Krijgt de status van de Adobe Stock-licentie, indien beschikbaar, voor Adobe® Photoshop® CC-bibliotheken.
...
De status van de Adobe Stock-licentie of een lege tekenreeks als deze niet beschikbaar is.
