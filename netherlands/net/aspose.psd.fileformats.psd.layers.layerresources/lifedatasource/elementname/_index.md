...
description: LiFeDataSource eigendom. Haalt de elementnaam van de grafische bibliotheek op of stelt deze in voor Adobe Photoshop CC Libraries.
type: docs
weight: 50
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

Haalt de elementnaam van de grafische bibliotheek op of stelt deze in voor Adobe® Photoshop® CC Libraries.
...
De naam van het grafische bibliotheekelement.

### Uitzonderingen

| uitzondering | voorwaarde |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de eigenschap ElementName, deze is alleen beschikbaar voor de liFE-gegevensbron wanneer IsLibrary true is |
...
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lifedatasource/)
* montage [Aspose.PSD](../../../)
