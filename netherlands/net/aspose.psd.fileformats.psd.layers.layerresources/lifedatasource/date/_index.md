...
description: LiFeDataSource eigendom. Haalt of stelt de laatste schrijfdatum en tijd in van het externe bestand in de LiFEgegevensbron van de PSD LnkEresource.
type: docs
weight: 40
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
## LiFeDataSource.Date property

Haalt of stelt de laatste schrijfdatum en -tijd in van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource.
...
De laatste schrijfdatum en -tijd van het externe bestand.

### Uitzonderingen

| uitzondering | voorwaarde |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de eigenschap Date, deze is alleen beschikbaar voor de liFE-gegevensbron met versie 3 of hoger |
