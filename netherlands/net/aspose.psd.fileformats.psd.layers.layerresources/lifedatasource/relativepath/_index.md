...
description: LiFeDataSource eigendom. Haalt of stelt het relatieve pad in van het externe bestand in de LiFEgegevensbron van de PSD LnkEresource.
type: docs
weight: 100
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
## LiFeDataSource.RelativePath property

Haalt of stelt het relatieve pad in van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource.
...
Het relatieve bestandspad.

### Uitzonderingen

| uitzondering | voorwaarde |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de eigenschap RelativePath, deze is alleen beschikbaar voor liFE-gegevensbron |
