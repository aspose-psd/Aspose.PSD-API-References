...
description: LiFeDataSource eigendom. Haalt of stelt het volledige pad in van het externe bestand in de LiFEgegevensbron van de PSD LnkEresource.
type: docs
weight: 90
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
## LiFeDataSource.FullPath property

Haalt of stelt het volledige pad in van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource.
...
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | U hebt geen toegang tot de FullPath-eigenschap, deze is alleen beschikbaar voor liFE-gegevensbron |
