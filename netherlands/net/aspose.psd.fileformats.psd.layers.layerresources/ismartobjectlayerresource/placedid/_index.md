...
description: ISmartObjectLayerResource eigendom. Haalt of stelt de unieke identificatie van deze slimme objectlaaggegevens in de PSDafbeelding in.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.layerresources/ismartobjectlayerresource/placedid/
---
## ISmartObjectLayerResource.PlacedId property

Haalt of stelt de unieke identificatie van deze slimme objectlaaggegevens in de PSD-afbeelding in.
...
De unieke identificatie van deze slimme objectlaagresource.
...
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../ismartobjectlayerresource/)
* montage [Aspose.PSD](../../../)
