...
description: BlendingOptions methode. Voegt het lijneffect toe.
type: docs
weight: 80
url: /nl/net/aspose.psd.fileformats.psd.layers.layereffects/blendingoptions/addstroke/
---
...
| --- | --- | --- |
| fillType | FillType | Het type vulling om de lijn te vullen. |

### Winstwaarde

Gemaakt[`StrokeEffect`](../../strokeeffect/) object.
