...
description: Aspose.PSD.FileFormats.Psd.Resources.ColorHalftoneInformationResource klas. Hulpbron voor halftonen
type: docs
weight: 3670
url: /nl/net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
## ColorHalftoneInformationResource class

Hulpbron voor halftonen
...
| Naam | Beschrijving |
| --- | --- |
| [ColorHalftoneInformationResource](colorhalftoneinformationresource/)() | De standaard constructeur. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/datasize/) { get; } | Haalt de gegevensgrootte van de bron op in bytes. |
| [HalftoneData](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/halftonedata/) { get; set; } | Haalt de halftoongegevens op of stelt deze in. |
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/minimalversion/) { get; } | Krijgt de minimaal vereiste PSD-versie. |
