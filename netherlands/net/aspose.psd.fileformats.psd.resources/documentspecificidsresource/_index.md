...
description: Aspose.PSD.FileFormats.Psd.Resources.DocumentSpecificIdsResource klas. Documentspecifieke IDs resource
type: docs
weight: 3690
url: /nl/net/aspose.psd.fileformats.psd.resources/documentspecificidsresource/
---
## DocumentSpecificIdsResource class

Documentspecifieke ID's resource
...
| Naam | Beschrijving |
| --- | --- |
| [DocumentSpecificIdsResource](documentspecificidsresource/)() | De standaard constructeur. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/datasize/) { get; } | Haalt de gegevensgrootte van de bron op in bytes. |
| [Id](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/id/) { get; set; } | Haalt de identifier op of stelt deze in. |
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/documentspecificidsresource/minimalversion/) { get; } | Krijgt de minimaal vereiste PSD-versie. |
