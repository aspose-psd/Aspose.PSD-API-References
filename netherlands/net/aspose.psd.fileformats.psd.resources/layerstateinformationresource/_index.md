...
description: Aspose.PSD.FileFormats.Psd.Resources.LayerStateInformationResource klas. Informatiebron laagstatus
type: docs
weight: 3810
url: /nl/net/aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
## LayerStateInformationResource class

Informatiebron laagstatus
...
| Naam | Beschrijving |
| --- | --- |
| [LayerStateInformationResource](layerstateinformationresource/)() | De standaard constructeur. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layerstateinformationresource/datasize/) { get; } | Haalt de gegevensgrootte van de bron op in bytes. |
...
| [LayerIndex](../../aspose.psd.fileformats.psd.resources/layerstateinformationresource/layerindex/) { get; set; } | Haalt de index van de laag op of stelt deze in. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/layerstateinformationresource/minimalversion/) { get; } | Krijgt de minimaal vereiste PSD-versie. |
