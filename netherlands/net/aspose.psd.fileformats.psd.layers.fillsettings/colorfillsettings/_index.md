...
description: Aspose.PSD.FileFormats.Psd.Layers.FillSettings.ColorFillSettings klas. Effectinstellingen kleurvulling
type: docs
weight: 1930
url: /nl/net/aspose.psd.fileformats.psd.layers.fillsettings/colorfillsettings/
---
## ColorFillSettings class

Effectinstellingen kleurvulling
...
| Naam | Beschrijving |
| --- | --- |
| [Color](../../aspose.psd.fileformats.psd.layers.fillsettings/colorfillsettings/color/) { get; set; } | Krijgt of stelt de kleur in. |
| override [FillType](../../aspose.psd.fileformats.psd.layers.fillsettings/colorfillsettings/filltype/) { get; } | Het vultype |

### Voorbeelden

De volgende code demonstreert ondersteuning van de lijneffectlaag met vultype - Kleur.
