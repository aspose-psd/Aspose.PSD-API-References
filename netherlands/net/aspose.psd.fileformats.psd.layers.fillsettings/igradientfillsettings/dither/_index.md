...
description: IGradientFillSettings eigendom. Haalt of stelt een waarde in die aangeeft of ditIGradientFillSettings is dither.
type: docs
weight: 50
url: /nl/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
## IGradientFillSettings.Dither property

Haalt of stelt een waarde in die aangeeft of dit[`IGradientFillSettings`](../) is dither.
