...
description: PatternFillSettings eigendom. Haalt of stelt een waarde in die aangeeft of koppeling met laag.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.fillsettings/patternfillsettings/alignwithlayer/
---
## PatternFillSettings.AlignWithLayer property

Haalt of stelt een waarde in die aangeeft of [koppeling met laag].
...
`WAAR` als [koppeling met laag]; anders,`vals` .
