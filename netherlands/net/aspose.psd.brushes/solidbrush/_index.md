...
description: Aspose.PSD.Brushes.SolidBrush klas. Stevig penseel is bedoeld om continu met een specifieke kleur te tekenen. Deze klasse kan niet worden geërfd.
type: docs
weight: 200
url: /nl/net/aspose.psd.brushes/solidbrush/
---
## SolidBrush class

Stevig penseel is bedoeld om continu met een specifieke kleur te tekenen. Deze klasse kan niet worden geërfd.
...
| Naam | Beschrijving |
| --- | --- |
| [SolidBrush](solidbrush/#constructor)() | Initialiseert een nieuw exemplaar van het`SolidBrush` klasse. |
| [SolidBrush](solidbrush/#constructor_1)(Color) | Initialiseert een nieuw exemplaar van het`SolidBrush` klasse. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Color](../../aspose.psd.brushes/solidbrush/color/) { get; set; } | Haalt of stelt de penseelkleur in. |
