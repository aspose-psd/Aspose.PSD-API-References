...
description: ITextParagraph eigendom. Haalt of stelt een waarde in die aangeeft of ditITextParagraphis burasagiri.
type: docs
weight: 30
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Haalt of stelt een waarde in die aangeeft of dit[`ITextParagraph`](../)is burasagiri.
...
`WAAR` als burasagiri; anders,`vals` .
