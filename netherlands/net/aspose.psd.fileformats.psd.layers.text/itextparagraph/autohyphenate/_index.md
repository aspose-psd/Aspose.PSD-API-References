...
description: ITextParagraph eigendom. Haalt of stelt een waarde in die aangeeft of automatische woordafbreking.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Haalt of stelt een waarde in die aangeeft of [automatische woordafbreking].
...
`WAAR` if [automatische woordafbreking]; anders,`vals` .
...
* naamruimte [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph/)
* montage [Aspose.PSD](../../../)
