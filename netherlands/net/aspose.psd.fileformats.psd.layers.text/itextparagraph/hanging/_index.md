...
description: ITextParagraph eigendom. Haalt of stelt een waarde in die aangeeft of ditITextParagraph hangt.
type: docs
weight: 90
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Haalt of stelt een waarde in die aangeeft of dit[`ITextParagraph`](../) hangt.
...
`WAAR` indien hangend; anders,`vals` .
