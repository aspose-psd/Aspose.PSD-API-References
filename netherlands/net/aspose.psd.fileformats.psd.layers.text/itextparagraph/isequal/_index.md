...
description: ITextParagraph methode. Bepaalt of de opgegeven alinea gelijk is.
type: docs
weight: 230
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/isequal/
---
...
| --- | --- | --- |
| paragraph | ITextParagraph | De paragraaf. |

### Winstwaarde

`WAAR` als de gespecificeerde alinea gelijk is; anders,`vals` .
