...
description: ITextParagraph eigendom. Haalt of stelt een waarde in die aangeeft of elke regelsamensteller.
type: docs
weight: 60
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Haalt of stelt een waarde in die aangeeft of [elke regelsamensteller].
...
`WAAR` if [elke regelcomponist]; anders,`vals` .
