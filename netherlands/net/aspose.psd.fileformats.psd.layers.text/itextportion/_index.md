...
description: Aspose.PSD.FileFormats.Psd.Layers.Text.ITextPortion koppel. Interface om tekstgedeelten te manipuleren
type: docs
weight: 3530
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextportion/
---
## ITextPortion interface

Interface om tekstgedeelten te manipuleren
...
| Naam | Beschrijving |
| --- | --- |
| [Paragraph](../../aspose.psd.fileformats.psd.layers.text/itextportion/paragraph/) { get; } | Stelt de stijl in. |
| [Style](../../aspose.psd.fileformats.psd.layers.text/itextportion/style/) { get; } | Krijgt de stijl. |
| [Text](../../aspose.psd.fileformats.psd.layers.text/itextportion/text/) { get; set; } | Haalt of stelt de tekst in. |
