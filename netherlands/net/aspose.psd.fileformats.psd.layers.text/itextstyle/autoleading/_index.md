...
description: ITextStyle eigendom. Haalt of stelt een waarde in die aangeeft of automatisch leidend.
type: docs
weight: 20
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Haalt of stelt een waarde in die aangeeft of [automatisch leidend].
...
`WAAR` als [automatisch leidend]; anders,`vals` .
