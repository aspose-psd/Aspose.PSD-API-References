...
description: ITextStyle eigendom. Haalt of stelt een waarde in die aangeeft of hindi numbers.
type: docs
weight: 150
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Haalt of stelt een waarde in die aangeeft of [hindi numbers].
...
`WAAR` als [hindi getallen]; anders,`vals` .
