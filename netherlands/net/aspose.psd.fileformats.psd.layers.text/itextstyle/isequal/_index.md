...
description: ITextStyle methode. Bepaalt of de opgegeven stijl gelijk is.
type: docs
weight: 290
url: /nl/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
...
| --- | --- | --- |
| style | ITextStyle | De stijl. |

### Winstwaarde

`WAAR` als de opgegeven stijl gelijk is; anders,`vals` .
