...
description: Aspose.PSD.Shapes.EllipseShape klas. Vertegenwoordigt een ellipsvorm.
type: docs
weight: 5490
url: /nl/net/aspose.psd.shapes/ellipseshape/
---
## EllipseShape class

Vertegenwoordigt een ellipsvorm.
...
| Naam | Beschrijving |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | Initialiseert een nieuw exemplaar van het`EllipseShape` klasse. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | Initialiseert een nieuw exemplaar van het`EllipseShape` klasse. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | Krijgt de vormsegmenten. |
