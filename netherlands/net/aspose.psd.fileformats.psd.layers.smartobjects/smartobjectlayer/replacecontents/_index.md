...
description: SmartObjectLayer methode. Vervangt de slimme objectinhoud die is ingesloten in de slimme objectlaag.
type: docs
weight: 140
url: /nl/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/
---
## ReplaceContents(Image) {#replacecontents}

Vervangt de slimme objectinhoud die is ingesloten in de slimme objectlaag.
...
| --- | --- | --- |
| image | Image | De afbeelding. |
| resolution | ResolutionSetting | De resolutie-instellingen. Indien null wordt de afbeeldingsresolutie gebruikt. |

### Uitzonderingen

| uitzondering | voorwaarde |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Kan alleen ingebed slim object vervangen. |

### Voorbeelden

Dit voorbeeld laat zien dat de methode ReplaceContents correct werkt wanneer het nieuwe inhoudsbestand een andere resolutie heeft.
...
string filePath = baseFolder + fileName; // originele PSD-afbeelding
string newContentPath = baseFolder + "image.jpg"; // het nieuwe inhoudsbestand voor het slimme object
string outputFilePath = outputFolder + "ChangedPsd";
string pngOutputPath = outputFilePath + ".png"; // het PNG-uitvoerbestand
string psdOutputPath = outputFilePath + ".psd"; // het output PSD-bestand
...
Vervangt de inhoud door een bestand. Het is niet nodig om de methode UpdateModifiedContent achteraf aan te roepen.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| linkedPath | String | Het gekoppelde pad. |
| resolution | ResolutionSetting | De resolutie-instellingen. Indien null wordt de afbeeldingsresolutie gebruikt. |
