...
description: AiLayerSection eigendom. Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of deze laag gedimd is. Vermindert de intensiteit van gekoppelde afbeeldingen en bitmapafbeeldingen in de laag.
type: docs
weight: 50
url: /nl/net/aspose.psd.fileformats.ai/ailayersection/isimagesdimmed/
---
## AiLayerSection.IsImagesDimmed property

Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of deze laag gedimd is. Vermindert de intensiteit van gekoppelde afbeeldingen en bitmapafbeeldingen in de laag.
...
`WAAR` als deze laag gedimd is; anders,`vals` .

### Voorbeelden

Het volgende voorbeeld demonstreert de ondersteuning van lagen in bestanden in AI-indeling.
...
* naamruimte [Aspose.PSD.FileFormats.Ai](../../ailayersection/)
* montage [Aspose.PSD](../../../)
