...
description: AiLayerSection eigendom. Haalt of stelt een waarde in die aangeeft of deze laag vergrendeld is. Voorkomt wijzigingen aan het item.
type: docs
weight: 60
url: /nl/net/aspose.psd.fileformats.ai/ailayersection/islocked/
---
## AiLayerSection.IsLocked property

Haalt of stelt een waarde in die aangeeft of deze laag vergrendeld is. Voorkomt wijzigingen aan het item.
...
`WAAR` als deze laag is vergrendeld; anders,`vals` .
