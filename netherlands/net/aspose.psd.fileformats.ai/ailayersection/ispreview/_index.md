...
description: AiLayerSection eigendom. Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of deze laag een voorbeeld is. Geeft de illustratie in de laag weer in kleur in plaats van als contouren.
type: docs
weight: 70
url: /nl/net/aspose.psd.fileformats.ai/ailayersection/ispreview/
---
## AiLayerSection.IsPreview property

Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of deze laag een voorbeeld is. Geeft de illustratie in de laag weer in kleur in plaats van als contouren.
...
`WAAR` als deze laag een voorbeeld is; anders,`vals` .
