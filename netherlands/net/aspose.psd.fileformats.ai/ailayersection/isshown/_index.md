...
description: AiLayerSection eigendom. Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of deze laag wordt weergegeven. Geeft alle illustraties in de laag op het tekengebied weer indien waar.
type: docs
weight: 90
url: /nl/net/aspose.psd.fileformats.ai/ailayersection/isshown/
---
## AiLayerSection.IsShown property

Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of deze laag wordt weergegeven. Geeft alle illustraties in de laag op het tekengebied weer, indien waar.
...
`WAAR` als deze laag wordt getoond; anders,`vals` .
