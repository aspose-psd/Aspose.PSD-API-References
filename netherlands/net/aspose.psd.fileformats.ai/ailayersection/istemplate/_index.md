...
description: AiLayerSection eigendom. Haalt of stelt een waarde in die aangeeft of deze laag een sjabloonlaag is.
type: docs
weight: 100
url: /nl/net/aspose.psd.fileformats.ai/ailayersection/istemplate/
---
## AiLayerSection.IsTemplate property

Haalt of stelt een waarde in die aangeeft of deze laag een sjabloonlaag is.
...
`WAAR` als deze laag een sjabloon is; anders,`vals` .
