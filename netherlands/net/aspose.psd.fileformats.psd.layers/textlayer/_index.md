...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer klas. De tekstlaag class
type: docs
weight: 3560
url: /nl/net/aspose.psd.fileformats.psd.layers/textlayer/
---
## TextLayer class
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | Haalt het lettertype op. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Krijgt de tekst van de laag |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | Krijgt de tekst. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Haalt of stelt het tekstgebonden vak in. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Krijgt de kleur van de tekst. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Haalt de tekstgedeelten op. |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Haalt of stelt de positie van de bovenste laag in. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Haalt of stelt de transformatiematrix in |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Haalt de fontset van de tekstlaag op. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Wijzigt de grootte van de afbeelding. De standaardLeftTopToLeftTopwordt gebruikt. |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | Werkt de tekst bij. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | Werkt de tekst bij. |
