...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup klas. Groepslaag klasse
type: docs
weight: 2220
url: /nl/net/aspose.psd.fileformats.psd.layers/layergroup/
---
## LayerGroup class
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Haalt of stelt de overvloeimodussleutel in. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Krijgt de hoogte van de lagengroep. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Krijgt of stelt de map geopend indien ingesteld op`WAAR` dan is de groep bij het opstarten in de open status, anders in de geminimaliseerde status. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Haalt de lagen op in lagengroep |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | Haalt de breedte van de lagengroep op. |
...
| Naam | Beschrijving |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Voegt de laag toe aan de lagengroep. |
