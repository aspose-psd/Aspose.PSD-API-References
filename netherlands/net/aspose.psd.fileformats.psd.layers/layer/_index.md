...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer klas. De psdlaag.
type: docs
weight: 2080
url: /nl/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| Naam | Beschrijving |
| --- | --- |
| [Layer](layer/#constructor)() | Initialiseert een nieuw exemplaar van het`Layer` klas. Constructor voor luie initialisatie. |
| [Layer](layer/#constructor_3)(Stream) | Initialiseert een nieuw exemplaar van het`Layer` klasse. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Initialiseert een nieuw exemplaar van het`Layer` klasse. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Initialiseert een nieuw exemplaar van het`Layer` klasse uit byte-arrays. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Slaat de gegevens van het object op in de opgegeven stream. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Slaat de objectgegevens op naar de opgegeven bestandslocatie. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Slaat de objectgegevens op naar de opgegeven bestandslocatie in de opgegeven bestandsindeling volgens de opslagopties. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Slaat de afbeeldingsgegevens op in de opgegeven stream in de opgegeven bestandsindeling volgens de opslagopties. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Slaat de objectgegevens op naar de opgegeven bestandslocatie in de opgegeven bestandsindeling volgens de opslagopties. |
...
| Naam | Beschrijving |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Vertegenwoordigt de handtekening van de overvloeimodus. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | De grootte van de laagkoptekst. |
