...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeRadiiRectangle klas. Definieert vectorvorm radii rechthoek class
type: docs
weight: 1450
url: /nl/net/aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/
---
## VectorShapeRadiiRectangle class

Definieert vectorvorm radii rechthoek class
...
| Naam | Beschrijving |
| --- | --- |
| [VectorShapeRadiiRectangle](vectorshaperadiirectangle/)() | De standaard constructeur. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [BottomLeft](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/bottomleft/) { get; set; } | Krijgt of zet de bodem. |
| [BottomRight](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/bottomright/) { get; set; } | Krijgt of stelt rechtsonder in. |
| [QuadVersion](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/quadversion/) { get; set; } | Haalt of stelt de quad-versie van de eenheidswaarde in. |
| [TopLeft](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/topleft/) { get; set; } | Krijgt of stelt de linkerbovenhoek in. |
| [TopRight](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/topright/) { get; set; } | Krijgt of stelt de rechterbovenhoek in. |
