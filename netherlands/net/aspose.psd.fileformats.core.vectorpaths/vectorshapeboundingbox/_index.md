...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeBoundingBox klas. Definieert de klasse van het begrenzingskader van de vectorvorm.
type: docs
weight: 1430
url: /nl/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/
---
## VectorShapeBoundingBox class

Definieert de klasse van het begrenzingskader van de vectorvorm.
...
| Naam | Beschrijving |
| --- | --- |
| [VectorShapeBoundingBox](vectorshapeboundingbox/)() | De standaard constructeur. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Bottom](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/bottom/) { get; set; } | Krijgt of zet de bodem. |
| [Bounds](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/bounds/) { get; set; } | Haalt of stelt de grenzen van het begrenzingsvak van de vorm in. |
| [Left](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/left/) { get; set; } | Krijgt of stelt links in. |
| [QuadVersion](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/quadversion/) { get; set; } | Haalt of stelt de quad-versie van de eenheidswaarde in. |
| [Right](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/right/) { get; set; } | Krijgt of stelt het recht in. |
| [Top](../../aspose.psd.fileformats.core.vectorpaths/vectorshapeboundingbox/top/) { get; set; } | Krijgt of zet de top. |

### Voorbeelden

Dit voorbeeld laat zien dat het laden en opslaan van de PSD-afbeelding met vormlagen en vectorpaden correct werkt.
