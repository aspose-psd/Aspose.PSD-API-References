...
description: InitialFillRuleRecord constructeur. Initialiseert een nieuw exemplaar van hetInitialFillRuleRecord klasse.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.core.vectorpaths/initialfillrulerecord/initialfillrulerecord/
---
## InitialFillRuleRecord() {#constructor}

Initialiseert een nieuw exemplaar van het[`InitialFillRuleRecord`](../) klasse.
...
* naamruimte [Aspose.PSD.FileFormats.Core.VectorPaths](../../initialfillrulerecord/)
* montage [Aspose.PSD](../../../)
...
| --- | --- | --- |
| isFillStartsWithAllPixels | Boolean | De vulling begint met alle pixels. |
