...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform klas. Definieert vectorvormtransformatiematrix class
type: docs
weight: 1460
url: /nl/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/
---
## VectorShapeTransform class

Definieert vectorvormtransformatiematrix class
...
| Naam | Beschrijving |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | Initialiseert een nieuw exemplaar van het`VectorShapeTransform` klasse. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Tx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/tx/) { get; set; } | Haalt de TX-waarde op of stelt deze in. |
| [Ty](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/ty/) { get; set; } | Haalt de TY-waarde op of stelt deze in. |
| [Xx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx/) { get; set; } | Haalt de XX-waarde op of stelt deze in. |
| [Xy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy/) { get; set; } | Haalt de XY-waarde op of stelt deze in. |
| [Yx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yx/) { get; set; } | Haalt de YX-waarde op of stelt deze in. |
| [Yy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yy/) { get; set; } | Haalt de YY-waarde op of stelt deze in. |
...
Dit voorbeeld laat zien hoe u nieuwe Transform- en OriginBoxCorners-eigenschappen van ShapeOriginSettings kunt ophalen en instellen in de Vogk-resource van FillLayer in het PSD-bestand.

```csharp
[C#]

// Dit voorbeeld laat zien hoe u nieuwe Transform- en OriginBoxCorners-eigenschappen ophaalt en instelt
// van ShapeOriginSettings in de Vogk-bron van FillLayer in het PSD-bestand
...
using (PsdImage image = (PsdImage)Image.Load(sourceFileName))
{
    ...
    // Bewaar deze PSD-afbeelding met gewijzigde eigenschappen.
...
using (PsdImage image = (PsdImage)Image.Load(outputPath))
{
    ...
    // Bevestig dat eigenschappen correct zijn opgeslagen en geladen 
    var setting = resource.ShapeOriginSettings[0];
    AssertAreEqual(true, setting.IsOriginIndexPresent);
    AssertAreEqual(false, setting.IsShapeInvalidatedPresent);
    AssertAreEqual(true, setting.IsOriginResolutionPresent);
