...
description: IVectorPathData eigendom. Haalt of stelt een waarde in die aangeeft of deze instantie niet is gekoppeld.
type: docs
weight: 30
url: /nl/net/aspose.psd.fileformats.core.vectorpaths/ivectorpathdata/isnotlinked/
---
...
`WAAR` als deze instantie niet is gekoppeld; anders,`vals` .
