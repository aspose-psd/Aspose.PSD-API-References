...
description: IVectorPathData eigendom. Haalt of stelt een waarde in die aangeeft of deze instantie is uitgeschakeld.
type: docs
weight: 10
url: /nl/net/aspose.psd.fileformats.core.vectorpaths/ivectorpathdata/isdisabled/
---
...
`WAAR` als deze instantie is uitgeschakeld; anders,`vals` .
