...
description: "De bewerkingen voor de padvormen die Booleaanse bewerkingen combineren."
type: docs
weight: 15
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| Veld | Beschrijving |
| --- | --- |
| [CombineShapes](#CombineShapes) | Combineer vormen (OR-bewerking). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | Sluit overlappende vormen uit (XOR-bewerking). |
| [IntersectShapeAreas](#IntersectShapeAreas) | Snij vormgebieden (AND-bewerking). |
| [SubtractFrontShape](#SubtractFrontShape) | Trek voorste vorm af (NOT-bewerking). |
## Methoden
...
Combineer vormen (OR-bewerking). Dit is de standaardwaarde in Photoshop.
...
Sluit overlappende vormen uit (XOR-bewerking).
...
Snij vormgebieden (AND-bewerking).
...
Trek voorste vorm af (NOT-bewerking).
