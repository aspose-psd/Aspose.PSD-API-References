...
description: "De lange bewerkingsdelegate voor de asynchrone taak met generiek type resultaat."
type: docs
weight: 12
url: /nl/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
De lange bewerkingsdelegate voor de asynchrone taak met generiek type resultaat.
## Constructors
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | De lange bewerkingsdelegate voor de asynchrone taak met generiek type resultaat. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| resultaat | com.aspose.ms.System.IAsyncResult |  |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | Status van de asynchrone taak. |

**Returns:**
java.lang.Object - Resultaat van de lange bewerking.
### notify() {#notify--}
```
