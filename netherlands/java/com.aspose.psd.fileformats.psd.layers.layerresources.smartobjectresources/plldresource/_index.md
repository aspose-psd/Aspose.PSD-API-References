...
description: "Definieert de PlLdResource-klasse die informatie bevat over een geplaatste laag in het PSD‑bestand."
type: docs
weight: 10
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
Definieert de PlLdResource‑klasse die informatie bevat over een geplaatste laag in het PSD‑bestand. Het wordt gebruikt om slimme objectlagen in de Adobe® Photoshop®‑afbeeldingen te ondersteunen. Het werd vervangen door SoLdResource in de Adobe® Photoshop® CS3.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PlLdResource()](#PlLdResource--) | Initialiseert een nieuw exemplaar van de [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource) klasse. |
## Velden
...
| [TypeValue_internalized](#TypeValue-internalized) | De verwachte type‑waarde |
...
| [getLength()](#getLength--) | Haalt de lengte van de PlLd‑resource op in bytes. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Slaat de PlLD‑resource op in de opgegeven streamcontainer. |
...
Initialiseert een nieuw exemplaar van de [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource) klasse. Deze standaardconstructor is ontworpen voor gebruik door PlLdResourceLoader. Gebruik [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) om PlLdResource‑klassen te maken.
...
Haalt de lengte van de PlLd‑resource op in bytes.
...
Slaat de PlLD‑resource op in de opgegeven streamcontainer.
