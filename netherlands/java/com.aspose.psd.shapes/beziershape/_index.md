...
description: "Stelt een Bézier-spline voor."
type: docs
weight: 11
url: /nl/java/com.aspose.psd.shapes/beziershape/
---
...
Stelt een Bézier-spline voor.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [BezierShape()](#BezierShape--) | Initialiseert een nieuw exemplaar van de  BezierShape  klasse. |
| [BezierShape(PointF[] points)](#BezierShape-com.aspose.psd.PointF---) | Initialiseert een nieuw exemplaar van de  BezierShape  klasse. |
| [BezierShape(PointF[] points, boolean isClosed)](#BezierShape-com.aspose.psd.PointF---boolean-) | Initialiseert een nieuw exemplaar van de  BezierShape  klasse. |
## Methoden
...
Initialiseert een nieuw exemplaar van de  BezierShape  klasse.
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | De puntenarray. |
| isClosed | boolean | Indien ingesteld op  true  is de bezier spline gesloten. |
