...
description: "Stelt een taartvorm voor."
type: docs
weight: 14
url: /nl/java/com.aspose.psd.shapes/pieshape/
---
...
Stelt een taartvorm voor.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PieShape()](#PieShape--) | Initialiseert een nieuw exemplaar van de  PieShape  klasse. |
| [PieShape(RectangleF rectangle, float startAngle, float sweepAngle)](#PieShape-com.aspose.psd.RectangleF-float-float-) | Initialiseert een nieuw exemplaar van de  PieShape  klasse. |
## Methoden
...
Initialiseert een nieuw exemplaar van de  PieShape  klasse.
