...
description: "Klasse PattResource."
type: docs
weight: 66
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
Klasse PattResource. Resource met patroongegevens
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PattResource()](#PattResource--) | Initialiseert een nieuw exemplaar van de [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) klasse. |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Initialiseert een nieuw exemplaar van de [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) klasse. |
## Velden
...
| [TypeToolKey](#TypeToolKey) | De 'Patt' type gereedschapsinfo-sleutel voor 8-bits. |
| [TypeToolKey2](#TypeToolKey2) | De 'Pat2' type gereedschapsinfo-sleutel voor 16-bits. |
| [TypeToolKey3](#TypeToolKey3) | De 'Pat3' type gereedschapsinfo-sleutel voor 32-bits. |
| [ventureLicense_internalized](#ventureLicense-internalized) | De venture-licentie. |
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Werk de Patt-resource bij met standaardgegevens. |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | Maakt de standaard niet-lege resource. |
...
| [getPatterns()](#getPatterns--) | Haalt op of stelt de patroongegevens in; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Haalt op of stelt de patroongegevens in; |
| [toString()](#toString--) | Retourneert een String die deze instantie vertegenwoordigt. |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | Zoekt het patroongegevensitem en werkt het bij met nieuw, anders wordt nieuw toegevoegd aan het einde van de array. |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) klasse.
...
| --- | --- | --- |
| sleutel | int | De resource-type sleutel. |
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | De patroongegevens. |
...
De 'Patt' type gereedschapsinfo-sleutel voor 8-bits.
...
De 'Pat2' type gereedschapsinfo-sleutel voor 16-bits.
...
De 'Pat3' type gereedschapsinfo-sleutel voor 32-bits.
...
Werk de Patt-resource bij met standaardgegevens.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | De resource. |
...
Maakt de standaard niet-lege resource.
...
Haalt op of stelt de patroongegevens in;
...
Zoekt het patroongegevensitem en werkt het bij met nieuw, anders wordt nieuw toegevoegd aan het einde van de array.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | Het patrooninstellingenobject om het patroonitem bij te werken. |
