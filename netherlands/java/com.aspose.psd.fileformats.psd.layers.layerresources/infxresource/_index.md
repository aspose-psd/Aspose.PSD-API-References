...
description: "Klasse InfxResource."
type: docs
weight: 39
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Klasse InfxResource. Deze bron bevat informatie over het mengen van een bijgesneden element.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Initialiseert een nieuw exemplaar van de [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) klasse. |
| [InfxResource()](#InfxResource--) | Initialiseert een nieuw exemplaar van de [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) klasse. |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Initialiseert een nieuw exemplaar van de [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) klasse. |
## Velden
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Haalt op of stelt een waarde in die aangeeft of [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | Haalt op of stelt een waarde in die aangeeft of de waarde [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) waar of onwaar is. |
| [hashCode()](#hashCode--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Haalt op of stelt een waarde in die aangeeft of [blend interior elements]. |
...
| [setValue(boolean value)](#setValue-boolean-) | Haalt op of stelt een waarde in die aangeeft of de waarde [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) waar of onwaar is. |
...
Initialiseert een nieuw exemplaar van de [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| blendInteriorElements | boolean | indien ingesteld op  true  [blend interior elements]. |
...
Initialiseert een nieuw exemplaar van de [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) klasse. Met een aangepaste of onbekende waarde.
...
Haalt op of stelt een waarde in die aangeeft of [blend interior elements].

Waarde:  true  als [blend interior elements]; anders,  false .
...
Haalt op of stelt een waarde in die aangeeft of de waarde [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) waar of onwaar is.

Waarde:  true  als de waarde waar is; anders,  false .
