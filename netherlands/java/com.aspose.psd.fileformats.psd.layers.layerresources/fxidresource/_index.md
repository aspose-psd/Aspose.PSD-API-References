...
description: "De Filter Effects resource bevat kanalen, een gebruikersmasker en een sheetmasker voor de slimme filter."
type: docs
weight: 29
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
De Filter Effects-resource bevat kanalen, een gebruikersmasker en een sheetmasker voor het slimme filter.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Initialiseert een nieuw exemplaar van de [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) klasse. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | De type tool-informatiesleutel FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | De type tool-informatiesleutel FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Haalt de filter effect masks op. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Haalt de filter effect masks op. |
...
Initialiseert een nieuw exemplaar van de [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) klasse.
...
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | De filter effect masks. |
...
De type tool-informatiesleutel FEid.
...
De type tool-informatiesleutel FXid.
...
Haalt de filter effect masks op.
