---
title: "Klasse KnkoResource. Deze resource bevat informatie over het mengen van een geknipte element."
second_title: "Aspose.PSD voor Java API-referentie"
description: "Klasse KnkoResource."
type: docs
weight: 41
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Klasse KnkoResource. Deze bron bevat informatie over het mengen van bijgesneden element.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | Initialiseert een nieuw exemplaar van de [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) klasse. |
| [KnkoResource()](#KnkoResource--) | Initialiseert een nieuw exemplaar van de [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) klasse. |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | Initialiseert een nieuw exemplaar van de [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) klasse. |
## Velden
...
| [getKnockout()](#getKnockout--) | Haalt op of stelt een waarde in die aangeeft of [blend interior elements]. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | Haalt op of stelt een waarde in die aangeeft of [blend interior elements]. |
...
Initialiseert een nieuw exemplaar van de [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| knockout | boolean | indien ingesteld op  true  [blend interior elements]. |
...
Initialiseert een nieuw exemplaar van de [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource) klasse. Met een aangepaste of onbekende waarde
