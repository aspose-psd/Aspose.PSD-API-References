...
type: docs
weight: 40
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
Klasse IopaResource. Deze resource bevat informatie over de eigenschap fill opacity van het laagstijl‑formulier.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [IopaResource()](#IopaResource--) | Initialiseert een nieuw exemplaar van de [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource)‑klasse. |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Initialiseert een nieuw exemplaar van de [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource)‑klasse. |
## Velden
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Haalt de vulopaciteit op of stelt deze in. |
...
Initialiseert een nieuw exemplaar van de [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource)‑klasse.
...
| --- | --- | --- |
| gegevens | byte[] | De ruwe bytegegevens. |
