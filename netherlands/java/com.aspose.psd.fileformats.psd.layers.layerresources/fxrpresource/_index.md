...
description: "Klasse FxrpResource."
type: docs
weight: 32
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
Klasse FxrpResource. Het referentiepunt van de laag
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Initialiseert een nieuw exemplaar van de klasse [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) |
| [FxrpResource()](#FxrpResource--) | Initialiseert een nieuw exemplaar van de klasse [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Initialiseert een nieuw exemplaar van de klasse [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource) |
## Velden
...
| [getX()](#getX--) | Haalt of stelt de x van het referentiepunt in |
| [getY()](#getY--) | Haalt of stelt de y van het referentiepunt in |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Slaat op in de opgegeven streamcontainer. |
...
| [setX(double value)](#setX-double-) | Haalt of stelt de x van het referentiepunt in |
| [setY(double value)](#setY-double-) | Haalt of stelt de y van het referentiepunt in |
...
Initialiseert een nieuw exemplaar van de klasse [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource)
...
Initialiseert een nieuw exemplaar van de klasse [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Met een aangepaste of onbekende waarde
...
Haalt of stelt de x van het referentiepunt in

Waarde: De x van het referentiepunt.
...
Haalt of stelt de y van het referentiepunt in

Waarde: De y van referentiepunt
