...
description: "De sectie met geanimeerde gegevens."
type: docs
weight: 11
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Veld | Beschrijving |
| --- | --- |
| [StructureKey](#StructureKey) | Identificeert de structuur‑sleutel van AnDs. |
## Methoden
...
| [getItems()](#getItems--) | Haalt of stelt de geanimeerde gegevenssectiestructuren in. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Haalt of stelt de ClassID in. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Haalt of stelt de descriptorversie in. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Haalt of stelt de geanimeerde gegevenssectiestructuren in. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Haalt of stelt de onbekende bytes 3 in die bestaan wanneer het aantal frames oneven is. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Identificeert de structuur‑sleutel van AnDs.
...
Controleert of het aantal frames in de 'FrIn' lijststructuur oneven is.
...
Haalt of stelt de geanimeerde gegevenssectiestructuren in.
...
Haalt of stelt de onbekende bytes 3 in die bestaan wanneer het aantal frames oneven is.
