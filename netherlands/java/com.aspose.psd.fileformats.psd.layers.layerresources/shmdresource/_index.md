...
description: "Klasse ShmdResource."
type: docs
weight: 74
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
Klasse ShmdResource. Metagegevensinstellingen
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [ShmdResource()](#ShmdResource--) | Initialiseert een nieuw exemplaar van de [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) klasse. |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | Initialiseert een nieuw exemplaar van de [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) klasse. |
## Velden
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | De subresource headerlengte |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Haalt op of stelt de aanmaaktijd van de laag in. |
...
| [getSubResources()](#getSubResources--) | De subresources |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Haalt op of stelt de aanmaaktijd van de laag in. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | Haalt de subresources van shmd resource op. |
...
Initialiseert een nieuw exemplaar van de [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource) klasse.
...
Haalt op of stelt de aanmaaktijd van de laag in. Als de aanmaaktijd van de laag niet gespecificeerd is, retourneert het nieuwe DateTime(0).

Waarde: De aanmaaktijd van de laag.
...
Haalt de subresources van shmd resource op.
