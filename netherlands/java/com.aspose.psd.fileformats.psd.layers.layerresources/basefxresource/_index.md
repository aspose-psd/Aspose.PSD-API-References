...
description: "Basis effectresource"
type: docs
weight: 12
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
Basis effectresource
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Initialiseert een nieuw exemplaar van de [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) klasse. |
## Velden
...
Initialiseert een nieuw exemplaar van de [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| resourceKey | int | De resource‑sleutel. |
