...
description: "De onbekende resource."
type: docs
weight: 82
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
De onbekende resource.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Initialiseert een nieuw exemplaar van de [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) klasse. |
## Velden
...
Initialiseert een nieuw exemplaar van de [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource) klasse.
