...
description: "Laag beschermde instellingen"
type: docs
weight: 57
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
Laag beschermde instellingen
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | Initialiseert een nieuw exemplaar van de [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) klasse. |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | Initialiseert een nieuw exemplaar van de [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) klasse. |
| [LspfResource()](#LspfResource--) | Initialiseert een nieuw exemplaar van de [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) klasse. |
## Velden
...
| [TypeToolKey](#TypeToolKey) | De type tool info-sleutel 1819504742 |
...
| [getLockType()](#getLockType--) | Haalt op of stelt het type van de vergrendeling in. |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | Haalt op of stelt een waarde in die aangeeft of dit exemplaar composiet beschermd is. |
| [isPositionProtected()](#isPositionProtected--) | Haalt op of stelt een waarde in die aangeeft of dit exemplaar positie beschermd is. |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | Haalt op of stelt een waarde in die aangeeft of dit exemplaar transparantie beschermd is. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | Haalt op of stelt een waarde in die aangeeft of dit exemplaar composiet beschermd is. |
...
| [setLockType(int value)](#setLockType-int-) | Haalt op of stelt het type van de vergrendeling in. |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | Haalt op of stelt een waarde in die aangeeft of dit exemplaar positie beschermd is. |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | Haalt op of stelt een waarde in die aangeeft of dit exemplaar transparantie beschermd is. |
...
Initialiseert een nieuw exemplaar van de [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) klasse. Met een aangepaste of onbekende waarde.
...
Initialiseert een nieuw exemplaar van de [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| isTransparencyProtected | boolean | indien ingesteld op  true  [is transparency protected]. |
| isCompositeProtected | boolean | indien ingesteld op  true  [is composite protected]. |
| isPositionProtected | boolean | als ingesteld op  true  [is position protected]. |
...
De type tool info-sleutel 1819504742
...
Haalt op of stelt het type van de vergrendeling in.

Waarde: Het type van het slot.
...
Haalt op of stelt een waarde in die aangeeft of dit exemplaar composiet beschermd is.

Waarde:  true  als deze instantie composiet beschermd is; anders,  false .
...
Haalt op of stelt een waarde in die aangeeft of dit exemplaar positie beschermd is.

Waarde:  true  als deze instantie positie beschermd is; anders,  false .
...
Haalt op of stelt een waarde in die aangeeft of dit exemplaar transparantie beschermd is.

Waarde:  true  als deze instantie transparantie beschermd is; anders,  false .
