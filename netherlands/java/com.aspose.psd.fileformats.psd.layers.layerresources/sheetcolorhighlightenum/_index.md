...
description: "Mogelijke kleuren van de bladkleurinstelling."
type: docs
weight: 73
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Mogelijke kleuren van de Sheet‑kleurinstelling. Het is een UI‑decoratieve kleur van de laag in de lagenlijst in PS
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Blue](#Blue) | De blauwe kleur. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gray](#Gray) | De grijze kleur. |
| [Green](#Green) | De groene kleur. |
| [NoColor](#NoColor) | Kleur is niet gespecificeerd. |
| [Orange](#Orange) | De oranje kleur. |
| [Red](#Red) | De rode kleur. |
| [Violet](#Violet) | De paarse kleur. |
| [Yellow](#Yellow) | De gele kleur. |
## Methoden
