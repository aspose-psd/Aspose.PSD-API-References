...
description: "De lsdk layer resource geneste layer sectie resource."
type: docs
weight: 56
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
De lsdk laag resource (geneste laagsectie resource).
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Initialiseert een nieuw exemplaar van de [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) klasse. |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Initialiseert een nieuw exemplaar van de [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) klasse. |
## Velden
...
| [getSectionType()](#getSectionType--) | Haalt op of stelt het sectietype in. |
| [getSignature()](#getSignature--) | Haalt de laagresourcehandtekening op. |
| [getSubtype()](#getSubtype--) | Haalt op of stelt het subtype in. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Haalt op of stelt het sectietype in. |
| [setSubtype(int value)](#setSubtype-int-) | Haalt op of stelt het subtype in. |
...
Initialiseert een nieuw exemplaar van de [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource) klasse.
...
| --- | --- | --- |
| sectionType | int | Het sectietype. |
| subType | int | Het subtype. |
