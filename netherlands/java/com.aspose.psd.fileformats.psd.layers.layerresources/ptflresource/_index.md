...
type: docs
weight: 72
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/ptflresource/
---
...
Klasse PtFlResource. Bevat patroonvullingslaaggegevens.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PtFlResource()](#PtFlResource--) | Initialiseert een nieuw exemplaar van de [PtFlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ptflresource) klasse. |
| [PtFlResource(String patternName, String patternId)](#PtFlResource-java.lang.String-java.lang.String-) | Initialiseert een nieuw exemplaar van de [PtFlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ptflresource) klasse. |
## Velden
...
| [hashCode()](#hashCode--) |  |
| [isLinkedWithLayer()](#isLinkedWithLayer--) | Haalt of stelt een waarde in die aangeeft of dit exemplaar is gekoppeld aan een laag. |
...
| [setLinkedWithLayer(boolean value)](#setLinkedWithLayer-boolean-) | Haalt of stelt een waarde in die aangeeft of dit exemplaar is gekoppeld aan een laag. |
| [setOffset(Point value)](#setOffset-com.aspose.psd.Point-) | Haalt de offset op of stelt deze in. |
...
Initialiseert een nieuw exemplaar van de [PtFlResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ptflresource) klasse.
...
| patternId | java.lang.String | De patroonidentificatie. |
...
Haalt of stelt een waarde in die aangeeft of dit exemplaar is gekoppeld aan een laag.

Waarde:  true  als dit exemplaar is gekoppeld aan een laag; anders,  false .
