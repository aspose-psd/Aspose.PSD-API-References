---
title: "Klasse CurvResource. Resource van Curves Adjustment Layer 1 byte - 0 als curves worden gebruikt, 1 als pixels op de kaart worden gebruikt; als 0 dan: 2 bytes - short. Standaard is 1 4 bytes - int. Alleen het laatste byte wordt per bit gebruikt. Eerste bit is voor 1 kanaal, het vierde bit voor 4 kanalen, bijvoorbeeld 2 bytes - short puntenaantal 4 bytes \\* aantal punten - punten van de curve 2 short: eerste positie, tweede hoogte 4 bytes - woord \\\"Crv \\\" 2 bytes - short standaard is 4 voor Curves 4 bytes - int. Standaard is 1 4 bytes - puntenaantal 4 bytes \\* puntenaantal - punten van de curve 2 short: eerste positie, tweede hoogte 0-4 bytes - Leidend om voor vier te vouwen; als 1 dan: 2 bytes - short. Standaard is 1 4 bytes - int. Alleen het laatste byte wordt gebruikt. Eén kanaal is in één bit. Eerste bit is voor 1 kanaal, het vierde bit voor 4 kanalen, bijvoorbeeld 256 \\* aantal gewijzigde kanalen - geordende waarden van kanaal in bereik 0 - 255 4 bytes - woord \\\"Crv \\\" 2 bytes - short. Standaard is 3 voor pixels op de kaart 4 bytes - int Kanaal aantal (2 + 256) bytes - short 2 voor kanaalindex, 256 is geordende waarden van kanaal in bereik 0 - 255"
second_title: "Aspose.PSD voor Java API-referentie"
description: "Klasse CurvResource."
type: docs
weight: 23
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/curvresource/
---
...
Initialiseert een nieuw exemplaar van de [CurvResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/curvresource) klasse.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [CurvResource(int maxChannelCount)](#CurvResource-int-) | Haalt de actieve manager op. |
| [CurvResource(byte[] bytes)](#CurvResource-byte---) | Haalt de actieve manager op. |
## Velden
...
| [getActiveManager()](#getActiveManager--) | Haalt de kanaalgegevens op. |
| [getChannelData(int channelIndex)](#getChannelData-int-) | Haalt de curve manager op. |
| [getClass()](#getClass--) |  |
| [getCurveManager()](#getCurveManager--) | Haalt op of stelt een waarde in die aangeeft of deze instantie discrete gegevens opslaat. |
...
| [hashCode()](#hashCode--) |  |
| [isDataStoredDiscretely()](#isDataStoredDiscretely--) | byte[] - Kanaalgegevens |
...
| [setDataStoredDiscretely(boolean value)](#setDataStoredDiscretely-boolean-) | byte[] - Kanaalgegevens |
...
**Returns:**
Waarde:  true  als deze instantie discrete gegevens opslaat; anders,  false .
### getClass() {#getClass--}
```
...
Haalt op of stelt een waarde in die aangeeft of deze instantie discrete gegevens opslaat.
