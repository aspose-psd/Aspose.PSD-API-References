...
description: "Klasse LyidResource."
type: docs
weight: 59
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | Initialiseert een nieuw exemplaar van de [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) klasse. |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | Initialiseert een nieuw exemplaar van de [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) klasse. |
## Velden
...
| [getValue()](#getValue--) | Haalt de waarde op. |
| [hashCode()](#hashCode--) |  |
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | Haalt de waarde op. |
...
Initialiseert een nieuw exemplaar van de [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| id | int | De identificatie van de laag. |
...
Initialiseert een nieuw exemplaar van de [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource) klasse. Met een aangepaste of onbekende waarde.
