...
description: "Klasse lnsrResource."
type: docs
weight: 51
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Initialiseert een nieuw exemplaar van de [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) klasse. |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Initialiseert een nieuw exemplaar van de [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) klasse. |
## Velden
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Haalt de ruwe gegevens op. |
...
| [getValue()](#getValue--) | Haalt de waarde op als LnsrResourceType als de overeenkomstige enum wordt beschreven. |
| [hashCode()](#hashCode--) |  |
...
Initialiseert een nieuw exemplaar van de [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| lnsrResourceType | int | Type van de LNSR. |
...
Initialiseert een nieuw exemplaar van de [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource) klasse. Met een aangepaste of onbekende waarde.
...
Haalt de waarde op als LnsrResourceType als de overeenkomstige enum wordt beschreven. Anders retourneert Unknown.

Waarde: De waarde als LnsrResourceType
