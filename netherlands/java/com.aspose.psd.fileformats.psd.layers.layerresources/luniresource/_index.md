...
description: "Laag naam resource"
type: docs
weight: 58
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| --- | --- |
| [LuniResource()](#LuniResource--) | Initialiseert een nieuw exemplaar van de [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource)‑klasse. |
## Velden
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Haalt op of stelt de gegevens in. |
...
Initialiseert een nieuw exemplaar van de [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource)‑klasse.
