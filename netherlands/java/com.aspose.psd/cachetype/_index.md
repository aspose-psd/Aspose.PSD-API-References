...
description: "Specificeert het te gebruiken cachetype."
type: docs
weight: 15
url: /nl/java/com.aspose.psd/cachetype/
---
...
Specificeert het te gebruiken cachetype.
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Auto](#Auto) | Specificeert het automatische cachetype. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Alleen de in-memory cache. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Alleen de schijfcache. |
...
Specificeert het automatische cachetype. Het automatische cacheschema probeert eerst in-memory te cachen en daarna op schijf.
