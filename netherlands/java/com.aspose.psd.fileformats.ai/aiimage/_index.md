...
description: "De Adobe Illustrator AI-afbeelding"
type: docs
weight: 14
url: /nl/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
De Adobe Illustrator (AI) afbeelding
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [AiImage()](#AiImage--) | Initialiseert een nieuw exemplaar van de [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) klasse. |
## Velden
...
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | Voegt de AI-laagsectie toe. |
| [cacheData()](#cacheData--) | Cachet de gegevens en zorgt ervoor dat er geen extra gegevens worden geladen vanuit de onderliggende  P:Aspose.PSD.DataStreamSupporter.DataStreamContainer . |
...
| [getActivePageIndex()](#getActivePageIndex--) | Haalt of stelt de index van de actieve pagina in. |
...
| [getDataSection()](#getDataSection--) | Haalt de gegevenssectie op. |
...
| [getFinalizeSection()](#getFinalizeSection--) | Haalt de finalisatie‑sectie op. |
...
| [getPageCount()](#getPageCount--) | Het aantal pagina's. |
...
| [getSetupSection()](#getSetupSection--) | Haalt de setup‑sectie op. |
...
| [getVersion()](#getVersion--) | Haalt de versie van het Adobe Illustrator‑formaat op. |
| [getWidth()](#getWidth--) | Haalt de breedte van de afbeelding op. |
| [getXmpData()](#getXmpData--) | Haalt de XMP‑metadata op. |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | Haalt of stelt de index van de actieve pagina in. |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | Haalt de gerenderde afbeelding op. |
...
Initialiseert een nieuw exemplaar van de [AiImage](../../com.aspose.psd.fileformats.ai/aiimage) klasse.
...
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | De AI-laagsectie. |
...
Cachet de gegevens en zorgt ervoor dat er geen extra gegevens worden geladen vanuit de onderliggende  P:Aspose.PSD.DataStreamSupporter.DataStreamContainer .
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - ApsPage‑instantie.
...
Haalt of stelt de index van de actieve pagina in.

Waarde: Deze eigenschap is alleen van toepassing op AI-afbeeldingen in PDF-formaat. Als de afbeelding niet in PDF-formaat is of er geen pagina's zijn, zal de eigenschap -1 zijn. Deze eigenschap geeft aan welke pagina van de AI-afbeelding de basis zal vormen voor weergave.
...
Haalt de gegevenssectie op.

Waarde: De gegevenssectie.
...
Haalt de finalisatie‑sectie op.

Waarde: De finalisatie‑sectie.
...
Haalt de laagsecties op.

Waarde: De laagsecties.
...
Haalt de setup‑sectie op.

Waarde: De installatiesectie.
...
Haalt de versie van het Adobe Illustrator‑formaat op.
...
Waarde:  true  als de gegevens van het object in de cache staan; anders,  false .
...
Haalt de gerenderde afbeelding op.

Waarde: De gerenderde afbeelding.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| ventureLicense | java.lang.Object | Venture-licentieobject. |
