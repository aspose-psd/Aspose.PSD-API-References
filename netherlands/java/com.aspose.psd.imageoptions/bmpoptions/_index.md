...
description: "De BMP‑bestandsformaat‑creatieopties."
type: docs
weight: 10
url: /nl/java/com.aspose.psd.imageoptions/bmpoptions/
---
...
De BMP‑bestandsformaat‑creatieopties.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [BmpOptions()](#BmpOptions--) | Initialiseert een nieuw exemplaar van de BmpOptions-klasse. |
| [BmpOptions(BmpOptions bmpOptions)](#BmpOptions-com.aspose.psd.imageoptions.BmpOptions-) | Initialiseert een nieuw exemplaar van de BmpOptions-klasse. |
## Methoden
...
| [getBitsPerPixel()](#getBitsPerPixel--) | Haalt het aantal bits per pixel van de afbeelding op of stelt dit in. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBitsPerPixel(int value)](#setBitsPerPixel-int-) | Haalt het aantal bits per pixel van de afbeelding op of stelt dit in. |
...
| [setCompression(long value)](#setCompression-long-) | Haalt op of stelt de compressie in. |
...
Initialiseert een nieuw exemplaar van de BmpOptions-klasse.
...
| --- | --- | --- |
| bmpOptions | [BmpOptions](../../com.aspose.psd.imageoptions/bmpoptions) | De BMP-opties. |
...
Haalt het aantal bits per pixel van de afbeelding op of stelt dit in.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| waarde | int | Het aantal bits per pixel van de afbeelding. |
