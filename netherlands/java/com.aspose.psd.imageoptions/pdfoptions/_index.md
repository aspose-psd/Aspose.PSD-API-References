...
description: "De PDF‑opties."
type: docs
weight: 18
url: /nl/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| --- | --- |
| [PdfOptions()](#PdfOptions--) | Initialiseert een nieuw exemplaar van de klasse [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions). |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | Haalt de kern‑PDF‑opties op. |
...
| [getPageSize()](#getPageSize--) | Haalt de grootte van de pagina op. |
| [getPalette()](#getPalette--) | Haalt of stelt het kleurenpalet in. |
| [getPdfCoreOptions()](#getPdfCoreOptions--) | De PDF‑kernopties |
| [getPdfDocumentInfo()](#getPdfDocumentInfo--) | Haalt op of stelt metadata voor het document in. |
...
| [setPageSize(SizeF value)](#setPageSize-com.aspose.psd.SizeF-) | Stelt de grootte van de pagina in. |
| [setPalette(IColorPalette value)](#setPalette-com.aspose.psd.IColorPalette-) | Haalt of stelt het kleurenpalet in. |
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | De PDF‑kernopties |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | Haalt op of stelt metadata voor het document in. |
...
Initialiseert een nieuw exemplaar van de klasse [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions).
...
Waarde: De grootte van de pagina.
...
Haalt op of stelt metadata voor het document in.
...
Stelt de grootte van de pagina in.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| value | [SizeF](../../com.aspose.psd/sizef) | de grootte van de pagina. |
