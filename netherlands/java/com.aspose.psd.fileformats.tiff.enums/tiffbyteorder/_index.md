...
description: "De bytevolgorde voor de tiff-afbeelding"
type: docs
weight: 12
url: /nl/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
De bytevolgorde voor de tiff-afbeelding
## Velden

| Veld | Beschrijving |
| --- | --- |
| [BigEndian](#BigEndian) | De big-endian bytevolgorde (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | De little-endian bytevolgorde (Intel). |
## Methoden
...
De big-endian bytevolgorde (Motorola).
...
De little-endian bytevolgorde (Intel).
