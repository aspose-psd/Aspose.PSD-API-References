...
description: "Definieert de SmartObjectLayer-klasse die een ingebedde smart object in het PSD‑bestand of een gekoppeld smart object in het externe bestand bevat."
type: docs
weight: 10
url: /nl/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Definieert de SmartObjectLayer‑klasse die embedded smart objects in het PSD‑bestand of gekoppelde smart objects in een extern bestand bevat. Met Smart Objects kun je: Niet‑destructieve transformaties uitvoeren. Je kunt een laag schalen, roteren, scheefzetten, vervormen, perspectieftransformatie toepassen of vervormen zonder de originele beeldgegevens of kwaliteit te verliezen, omdat de transformaties don\\ufffdt de originele gegevens niet beïnvloeden. Werken met vectorgegevens, zoals vectorillustraties van Illustrator, die anders gerasterd zouden worden. Niet‑destructieve filtering uitvoeren. Je kunt filters die op Smart Objects zijn toegepast op elk moment bewerken. Bewerk één Smart Object en werk automatisch alle gekoppelde instanties bij. Pas een laagmasker toe dat\\ufffds ofwel gekoppeld of ontkoppeld is van de Smart Object‑laag. Probeer verschillende ontwerpen met low‑resolution placeholder‑afbeeldingen die je later vervangt door definitieve versies. In Adobe\\ufffd Photoshop\\ufffd kun je de inhoud van een afbeelding in een PSD‑document insluiten. Meer informatie is hier:   Een laag met een embedded smart object bevat placed (PlLd) en SoLd resources met smart object‑eigenschappen. De PlLd‑resource kan alleen staan voor PSD‑versies ouder dan 10. Deze resources bevatten UniqueId van de LiFdDataSource in de globale Lnk2Resource met de embedded bestandsnaam en andere parameters, inclusief de embedded bestandsinhoud in het oorspronkelijke formaat als een byte‑array.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Initialiseert een nieuwe instantie van de [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) klasse. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [BlendSignature](#BlendSignature) | Geeft de blend-modus handtekening weer. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Het bericht dat zowel placed- als smart object resources gevonden zijn. |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Het bericht U kunt alleen een embedded smart object kopiëren |
| [LayerHeaderSize](#LayerHeaderSize) | De grootte van de laagheader. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Er is geen geplaatst of smartobject resource gevonden bericht |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Het verkeerde geplaatste resource-indexbericht |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Converteert dit ingebedde smartobject naar een gekoppeld smartobject. |
...
| [duplicateLayer()](#duplicateLayer--) | Maakt een nieuwe smartobjectlaag door deze te kopiëren. |
| [embedLinked()](#embedLinked--) | Integreert het gekoppelde smartobject in deze laag. |
| [equals(Object obj)](#equals-java.lang.Object-) | Bepaalt of het opgegeven Object gelijk is aan deze instantie. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Exporteert de ingebedde of gekoppelde inhoud naar een bestand. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Het haalt op of stelt render warp in of gebruikt PS-afbeelding |
...
| [getContentType()](#getContentType--) | Haalt het type op van de inhoud van de smart object‑laag. |
| [getContents()](#getContents--) | Haalt op of stelt de inhoud van de smartobjectlaag in. |
| [getContentsBounds()](#getContentsBounds--) | Haalt op of stelt de grenzen van de smartobjectinhoud in. |
| [getContentsSource()](#getContentsSource--) | Haalt op of stelt de bron van de smartobjectinhoud in. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Het haalt op of stelt de laatste grootte van de afbeelding in om te vervormen |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Haalt op of stelt de oorspronkelijke vierhoek in. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Haalt de indices van de geplaatste en smartlaag resources op en de juiste geplaatste resource. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Haalt de geplaatste laagresource op |
...
| [getSmartFilters()](#getSmartFilters--) | Haalt de smartfilters op. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Haalt op of stelt de transformatie‑vierhoek in. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Het haalt functies op die helpen bij warp |
| [getWarpSettings()](#getWarpSettings--) | Het haalt op of stelt warp-parameters in die waren ingesteld of opgehaald uit de resource (standaard) |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Haalt de ingebedde of gekoppelde afbeeldingsinhoud van de smartobjectlaag op. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Maakt een nieuwe smartobjectlaag door deze te kopiëren. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Aanroepen wanneer de container van deze [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) is ingesteld. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Linkt het gekoppelde smartobject opnieuw naar een nieuw bestand. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Vervangt de smartobjectinhoud die is ingebed in de smartobjectlaag. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Vervangt de smartobjectinhoud die is ingebed in de smartobjectlaag. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Vervangt de inhoud door een bestand. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Vervangt de inhoud door een bestand. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Vervangt de inhoud door een bestand. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Vervangt de inhoud door een bestand. |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Het haalt op of stelt render warp in of gebruikt PS-afbeelding |
...
| [setContents(byte[] value)](#setContents-byte---) | Haalt op of stelt de inhoud van de smartobjectlaag in. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Haalt op of stelt de grenzen van de smartobjectinhoud in. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Haalt op of stelt de bron van de smartobjectinhoud in. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Het haalt op of stelt de laatste grootte van de afbeelding in om te vervormen |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Haalt op of stelt de oorspronkelijke vierhoek in. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Haalt de smart object-provider op. |
| [setTop(int value)](#setTop-int-) | Haalt de positie van de bovenste laag op of stelt deze in. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Haalt op of stelt de transformatie‑vierhoek in. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Het haalt op of stelt warp-parameters in die waren ingesteld of opgehaald uit de resource (standaard) |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Werk de gegevensbron‑identificatie bij. |
| [updateModifiedContent()](#updateModifiedContent--) | Werk de afbeeldingscache van de smartobjectlaag bij met de gewijzigde inhoud. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Werk de afbeeldingscache van de smartobjectlaag bij met gewijzigde inhoud. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Werk de geplaatste / smart resources bij wanneer de placedResource wordt gewijzigd of wanneer conversie nodig is. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Het is een wrapper voor "IWarpSupport" om de laagpreview bij te werken. |
| [wait()](#wait--) |  |
...
Initialiseert een nieuwe instantie van de [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | De stroom van items |
...
Het bericht dat zowel placed- als smart object resources gevonden zijn.
...
Het bericht U kunt alleen een embedded smart object kopiëren
...
Er is geen geplaatst of smartobject resource gevonden bericht
...
Het verkeerde geplaatste resource-indexbericht
...
Converteert dit ingebedde smartobject naar een gekoppeld smartobject.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| linkedPath | java.lang.String | Het gekoppelde pad. |
...
Maakt een nieuwe slimme objectlaag door deze te kopiëren. Merk op dat voor ingesloten slimme objecten de ingesloten afbeelding wordt gedeeld. Als u de ingesloten afbeelding wilt kopiëren, gebruik dan de [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy) methode.
...
Integreert het gekoppelde smartobject in deze laag.
...
Exporteert de ingebedde of gekoppelde inhoud naar een bestand.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| filePath | java.lang.String | Het exportbestandspad. |
...
Het haalt op of stelt render warp in of gebruikt PS-afbeelding
...
Haalt het type op van de inhoud van de slimme objectlaag. De ingesloten slimme objectinhoud is het ingesloten ruwe afbeeldingsbestand:  LiFdDataSource.Data . De gekoppelde slimme objectinhoud is de ruwe inhoud van het gekoppelde afbeeldingsbestand als deze beschikbaar is: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). We ondersteunen het laden vanuit de Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library niet wanneer  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) waar is. Voor gewone koppelingsbestanden gebruiken we eerst  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) om het bestand te zoeken ten opzichte van het bronafbeeldingspad  DataStreamSupporter.SourceImagePath, als dit niet beschikbaar is kijken we naar  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), en zo niet zoeken we het koppelingsbestand in dezelfde map als onze afbeelding:  DataStreamSupporter.SourceImagePath .

Waarde: Het type van de inhoud van de slimme objectlaag.
...
Haalt de inhoud van de slimme objectlaag op of stelt deze in. De ingesloten slimme objectinhoud is het ingesloten ruwe afbeeldingsbestand:  LiFdDataSource.Data  en de bijbehorende eigenschappen. De gekoppelde slimme objectinhoud is de ruwe inhoud van het gekoppelde afbeeldingsbestand als deze beschikbaar is en de bijbehorende eigenschappen: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). We ondersteunen het laden vanuit de Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library niet wanneer  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) waar is. Voor gewone koppelingsbestanden gebruiken we eerst  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) om het bestand te zoeken ten opzichte van het bronafbeeldingspad  DataStreamSupporter.SourceImagePath, als dit niet beschikbaar is kijken we naar  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), en zo niet zoeken we het koppelingsbestand in dezelfde map als onze afbeelding:  DataStreamSupporter.SourceImagePath .
...
Haalt op of stelt de grenzen van de smartobjectinhoud in.

Waarde: De grenzen van het slimme object.
...
Haalt op of stelt de bron van de smartobjectinhoud in.

Waarde: De gegevensbron van het slimme object.
...
Het haalt op of stelt de laatste grootte van de afbeelding in om te vervormen
...
Haalt op of stelt de oorspronkelijke vierhoek in.

Waarde: Het oorspronkelijke vierhoek.
...
Haalt de indices van de geplaatste en smartlaag resources op en de juiste geplaatste resource.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | De resources. |
| placedResourceIndex | int[] | Index van de geplaatste bron. |
| smartResourceIndex | int[] | Index van de slimme resource. |
...
Haalt de geplaatste laagresource op
...
Haalt op of stelt de transformatie‑vierhoek in.

Waarde: De transformatie‑vierhoek.
...
Het haalt functies op die helpen bij warp
...
Het haalt op of stelt warp-parameters in die waren ingesteld of opgehaald uit de resource (standaard)
...
Haalt de ingebedde of gekoppelde afbeeldingsinhoud van de smartobjectlaag op.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | De opties. |
...
Maakt een nieuwe smart object‑laag door deze te kopiëren. Reproduceert Laag -> Smart Objects -> Nieuw Smart Object via de Kopie‑functionaliteit van Adobe\\ufffd Photoshop\\ufffd. Merk op dat dit alleen is ingeschakeld voor ingebedde smart objects omdat de ingebedde afbeelding ook wordt gekopieerd. Als je de ingebedde afbeelding wilt delen, gebruik dan de [.duplicateLayer](../../null/\\#duplicateLayer)‑methode.
...
Aanroepen wanneer de container van deze [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) is ingesteld.
...
Linkt het gekoppelde smart object opnieuw naar een nieuw bestand. Het is niet nodig om daarna de UpdateModifiedContent‑methode aan te roepen.
...
Vervangt de smartobjectinhoud die is ingebed in de smartobjectlaag.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | De afbeelding. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | De afbeelding. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | De resolutie‑instellingen. Indien null wordt de beeldresolutie gebruikt. |
...
Vervangt de inhoud door een bestand. Het is niet nodig om daarna de UpdateModifiedContent‑methode aan te roepen.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Het gekoppelde pad. |
| isReplaceOnlyThis | boolean | De vlag geeft aan of de inhoud van deze Smart Layer moet worden vervangen of voor alle Smart Layers met deze inhoud. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| waarde | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Werk de gegevensbron‑identificatie bij.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | De gegevensbron‑identificatie. |
...
Werk de afbeeldingscache van de smartobjectlaag bij met de gewijzigde inhoud.
...
Werk de afbeeldingscache van de smartobjectlaag bij met gewijzigde inhoud.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | De afbeelding. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | De resolutie. |
| skipBoundsUpdate | boolean | indien ingesteld op  true  [skip bounds update]. |
...
Werk de geplaatste / smart resources bij wanneer de placedResource wordt gewijzigd of wanneer conversie nodig is.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| toEmbedded | boolean | indien ingesteld op  true  converteer naar een ingebedde resource indien nodig, anders naar een gekoppelde. |
...
Het is een wrapper voor "IWarpSupport" om de laagpreview bij te werken.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Pixels en grootte van de nieuwe voorbeeldafbeelding. |
