...
description: "Stelt een penseel met basis padgradiëntfunctionaliteit voor."
type: docs
weight: 15
url: /nl/java/com.aspose.psd.brushes/pathgradientbrushbase/
---
...
Stelt een  Brush  voor met basispadverloopfunctionaliteit.

Let op dat bij het maken van de  PathGradientBrushBase  klasse deze minimaal met 2 punten moet worden geïnitialiseerd. Het interne pad dat wordt aangemaakt is altijd een gesloten figuur; het laatste punt verbindt met het eerste punt. Die vorm wordt gevuld met deze  PathGradientBrushBase . De GDI+ implementatie gooit een  OutOfMemoryError  wanneer lege arrays of een puntenreeks met dezelfde coördinaten worden doorgegeven. De  PathGradientBrushBase  gooit een uitzondering wanneer de puntenreeks minder dan 2 punten bevat; de  ArgumentException  wordt gegooid in plaats van een  OutOfMemoryError  wanneer de puntenreeks onaanvaardbaar is. Het middelpunt wordt standaard berekend als het massacentrum van de meegegeven punten. Een gebruiker kan dit punt later wijzigen. De focus-schaal is standaard een leeg punt (0.0, 0.0).
## Methoden
