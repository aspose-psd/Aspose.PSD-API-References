...
type: docs
weight: 14
url: /nl/java/com.aspose.psd.brushes/pathgradientbrush/
---
...
De middenkleur is standaard wit. Een gebruiker kan deze waarde later op elk moment wijzigen.

De omringende kleurenarray wordt standaard geïnitialiseerd met één element dat de witte kleur bevat. De omringende kleuren kunnen later worden gewijzigd, maar er is ten minste één element vereist bij het instellen van de omringende kleuren.

Zie de Blend voor meer details over de initialisatie.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PathGradientBrush(PointF[] points)](#PathGradientBrush-com.aspose.psd.PointF---) | Initialiseert een nieuw exemplaar van de **PathGradientBrush**-klasse met de opgegeven punten. |
| [PathGradientBrush(PointF[] points, int wrapMode)](#PathGradientBrush-com.aspose.psd.PointF---int-) | Initialiseert een nieuw exemplaar van de **PathGradientBrush**-klasse met de opgegeven punten en wrap-modus. |
| [PathGradientBrush(Point[] points)](#PathGradientBrush-com.aspose.psd.Point---) | Initialiseert een nieuw exemplaar van de **PathGradientBrush**-klasse met de opgegeven punten. |
| [PathGradientBrush(Point[] points, int wrapMode)](#PathGradientBrush-com.aspose.psd.Point---int-) | Initialiseert een nieuw exemplaar van de **PathGradientBrush**-klasse met de opgegeven punten en wrap-modus. |
| [PathGradientBrush(GraphicsPath path)](#PathGradientBrush-com.aspose.psd.GraphicsPath-) | Initialiseert een nieuw exemplaar van de  PathGradientBrush  klasse met het opgegeven pad. |
## Methoden
...
| [getCenterColor()](#getCenterColor--) | Haalt de kleur op het midden van de padgradiënt op. |
...
| [getSurroundColors()](#getSurroundColors--) | Haalt een array van kleuren op die overeenkomen met de punten in het pad dat deze  PathGradientBrush  vult. |
...
| [setBlendTriangularShape(float focus)](#setBlendTriangularShape-float-) | Maakt een gradiënt met een middelkleur en een lineaire afname naar één omringende kleur. |
| [setBlendTriangularShape(float focus, float scale)](#setBlendTriangularShape-float-float-) | Maakt een gradiënt met een middelkleur en een lineaire afname naar elke omringende kleur. |
| [setCenterColor(Color value)](#setCenterColor-com.aspose.psd.Color-) | Stelt de kleur in op het midden van de padgradiënt. |
...
| [setSigmaBellShape(float focus)](#setSigmaBellShape-float-) | Maakt een gradiënt penseel dat de kleur verandert, beginnend bij het midden van het pad naar de rand van het pad. |
| [setSigmaBellShape(float focus, float scale)](#setSigmaBellShape-float-float-) | Maakt een gradiënt penseel dat de kleur verandert, beginnend bij het midden van het pad naar de rand van het pad. |
| [setSurroundColors(Color[] value)](#setSurroundColors-com.aspose.psd.Color---) | Stelt een array van kleuren in die overeenkomen met de punten in het pad dat deze  PathGradientBrush  vult. |
...
Initialiseert een nieuw exemplaar van de **PathGradientBrush**-klasse met de opgegeven punten en wrap-modus.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | Een array van  Aspose.Imaging.PointF  structuren die de punten vertegenwoordigen die de hoekpunten van het pad vormen. |
| wrapMode | int | Een  Aspose.Imaging.WrapMode  die specificeert hoe vullingen getekend met deze  PathGradientBrush  worden getegeld. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| path | [GraphicsPath](../../com.aspose.psd/graphicspath) | Het  GraphicsPath  dat het gebied definieert dat wordt gevuld door deze  PathGradientBrush . |
...
Haalt de kleur op het midden van de padgradiënt op.
...
Haalt een array van kleuren op die overeenkomen met de punten in het pad dat deze  PathGradientBrush  vult.

**Returns:**
com.aspose.psd.Color[] - Een array van  com.aspose.psd.Color  structuren die de kleuren vertegenwoordigen die aan elk punt in het pad dat deze  PathGradientBrush  vult, zijn gekoppeld.
...
Maakt een gradiënt met een middelkleur en een lineaire afname naar één omringende kleur.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| focus | float | Een waarde van 0 tot 1 die aangeeft waar, langs elke radiaal van het midden van het pad tot de rand van het pad, de middelkleur de hoogste intensiteit heeft. Een waarde van 1 (de standaard) plaatst de hoogste intensiteit in het midden van het pad. |
...
Maakt een gradiënt met een middelkleur en een lineaire afname naar elke omringende kleur.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| focus | float | Een waarde van 0 tot 1 die aangeeft waar, langs elke radiaal van het midden van het pad tot de rand van het pad, de middelkleur de hoogste intensiteit heeft. Een waarde van 1 (de standaard) plaatst de hoogste intensiteit in het midden van het pad. |
| scale | float | Een waarde van 0 tot 1 die de maximale intensiteit van de middelkleur specificeert die wordt gemengd met de randkleur. Een waarde van 1 veroorzaakt de hoogst mogelijke intensiteit van de middelkleur, en dit is de standaardwaarde. |
...
Stelt de kleur in op het midden van de padgradiënt.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | Een  com.aspose.psd.Color  die de kleur op het midden van de padgradiënt vertegenwoordigt. |
...
Maakt een gradiënt penseel dat de kleur verandert, beginnend bij het midden van het pad naar de rand van het pad. De overgang van de ene kleur naar de andere is gebaseerd op een klokvormige curve.
...
Stelt een array van kleuren in die overeenkomen met de punten in het pad dat deze  PathGradientBrush  vult.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| value | [Color\[\]](../../com.aspose.psd/color) | Een array van  com.aspose.psd.Color  structuren die de kleuren vertegenwoordigen die aan elk punt in het pad dat deze  PathGradientBrush  vult, zijn gekoppeld. |
