...
description: "Definieert de LnkeDataSource-klasse die informatie bevat over een extern gekoppeld bestand."
type: docs
weight: 11
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource/
---
...
Definieert de LnkeDataSource-klasse die informatie bevat over een extern gekoppeld bestand. Dit maakt deel uit van de PSD File Format Manipulation API die helpt bij het wijzigen van Adobe® Photoshop®-bestanden.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [LiFeDataSource()](#LiFeDataSource--) | Initialiseert een nieuw exemplaar van de [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) klasse. |
| [LiFeDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFeDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Initialiseert een nieuw exemplaar van de [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) klasse. |
## Velden
...
| [getAdobeStockId()](#getAdobeStockId--) | Haalt de AdobeStockId van de grafische bibliotheek op of stelt deze in, voor Adobe® Photoshop® CC Libraries. |
| [getAdobeStockLicenseState()](#getAdobeStockLicenseState--) | Haalt de status van de Adobe Stock-licentie op indien beschikbaar, voor Adobe® Photoshop® CC libraries. |
...
| [getDate()](#getDate--) | Haalt op of stelt de datum en tijd van de laatste schrijfactie van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource in. |
| [getDate_internalized()](#getDate-internalized--) |  |
| [getElementName()](#getElementName--) | Haalt op of stelt de naam van het grafische bibliotheek‑element in, voor Adobe® Photoshop® CC Libraries. |
| [getElementRef()](#getElementRef--) | Haalt op of stelt de referentie van het grafische bibliotheek‑element in, voor Adobe® Photoshop® CC Libraries. |
| [getFileCreator()](#getFileCreator--) | Haalt op of stelt de maker van het bestand in de PSD‑formaat LnkE / Lnk2-resource in. |
| [getFileName()](#getFileName--) | Haalt op of stelt de naam van het externe of ingebedde bestand in de PSD‑linkresource in. |
| [getFileSize()](#getFileSize--) | Haalt op of stelt de grootte van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in. |
...
| [getFullPath()](#getFullPath--) | Haalt op of stelt het volledige pad van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in. |
...
| [getRelativePath()](#getRelativePath--) | Haalt op of stelt het relatieve pad van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in. |
...
| [setAdobeStockId(String value)](#setAdobeStockId-java.lang.String-) | Haalt de AdobeStockId van de grafische bibliotheek op of stelt deze in, voor Adobe® Photoshop® CC Libraries. |
...
| [setDate(Date value)](#setDate-java.util.Date-) | Haalt op of stelt de datum en tijd van de laatste schrijfactie van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource in. |
| [setDate_internalized(System.DateTime value)](#setDate-internalized-com.aspose.ms.System.DateTime-) |  |
| [setElementName(String value)](#setElementName-java.lang.String-) | Haalt op of stelt de naam van het grafische bibliotheek‑element in, voor Adobe® Photoshop® CC Libraries. |
| [setElementRef(String value)](#setElementRef-java.lang.String-) | Haalt op of stelt de referentie van het grafische bibliotheek‑element in, voor Adobe® Photoshop® CC Libraries. |
...
| [setFileName(String value)](#setFileName-java.lang.String-) | Haalt op of stelt de naam van het externe of ingebedde bestand in de PSD‑linkresource in. |
...
| [setFileSize(long value)](#setFileSize-long-) | Haalt op of stelt de grootte van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Haalt op of stelt het volledige pad van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in. |
...
| [setRelativePath(String value)](#setRelativePath-java.lang.String-) | Haalt op of stelt het relatieve pad van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in. |
...
Initialiseert een nieuw exemplaar van de [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) klasse.
...
| uniqueId | java.util.UUID | De unieke identificatie. |
| originalFileName | java.lang.String | Naam van het originele bestand. |
| fileType | java.lang.String | Type van het bestand. |
| fileCreator | java.lang.String | De maker van het bestand. |
...
Haalt de AdobeStockId van de grafische bibliotheek op of stelt deze in, voor Adobe® Photoshop® CC Libraries.
...
Haalt de status van de Adobe Stock-licentie op indien beschikbaar, voor Adobe® Photoshop® CC libraries.

Waarde: De status van de Adobe Stock-licentie of een lege tekenreeks als deze niet beschikbaar is.
...
Haalt op of stelt de datum en tijd van de laatste schrijfactie van het externe bestand in de LiFE-gegevensbron van de PSD LnkE-resource in.
...
Haalt op of stelt de naam van het grafische bibliotheek‑element in, voor Adobe® Photoshop® CC Libraries.
...
Haalt op of stelt de referentie van het grafische bibliotheek‑element in, voor Adobe® Photoshop® CC Libraries.
...
Haalt op of stelt de naam van het externe of ingebedde bestand in de PSD‑linkresource in.

Waarde: De naam van het externe of ingebedde bestand.
...
Haalt op of stelt de grootte van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in.
...
Haalt op of stelt het volledige pad van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in.
...
Haalt op of stelt het relatieve pad van het externe bestand in de LiFE‑gegevensbron van de PSD LnkE-resource in.
