...
description: "Definieert de klasse die informatie bevat over een ingebed bestand in de PSD-formaatafbeelding met 32 bits per kanaal."
type: docs
weight: 16
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
Definieert de klasse die informatie bevat over een ingesloten bestand in het PSD‑formaat 32‑bit per kanaal‑afbeelding. De link‑resource kan meerdere [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) instanties bevatten die via een indexer toegankelijk zijn.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | Initialiseert een nieuw exemplaar van de [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) klasse. |
## Velden
...
Initialiseert een nieuw exemplaar van de [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource) klasse.
