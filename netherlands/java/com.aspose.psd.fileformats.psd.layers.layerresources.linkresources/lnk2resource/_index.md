...
description: "Definieert de klasse die informatie bevat over ingebedde bestanden in de PSD-formaatafbeelding."
type: docs
weight: 15
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
Definieert de klasse die informatie bevat over ingesloten bestanden in de PSD‑formaatafbeelding. De linkresource kan meerdere  LiFdDataSource  instanties bevatten die via de indexer toegankelijk zijn.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Initialiseert een nieuw exemplaar van de [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) klasse. |
## Velden
...
| [get_Item(int index)](#get-Item-int-) | Haalt de  LiFdDataSource  op op de opgegeven index. |
...
Initialiseert een nieuw exemplaar van de [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) klasse.
...
Haalt de  LiFdDataSource  op op de opgegeven index.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | De index. Waarde: De  LiFdDataSource . |
