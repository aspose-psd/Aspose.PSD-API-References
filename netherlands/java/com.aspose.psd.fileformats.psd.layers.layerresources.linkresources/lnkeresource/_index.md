...
description: "Definieert de LnkeResource-klasse die informatie bevat over externe gekoppelde bestanden of assets in de PSD-formaatafbeelding."
type: docs
weight: 17
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Definieert de LnkeResource klasse die informatie bevat over externe gekoppelde bestanden of assets in de PSD‑formaatafbeelding. De linkresource kan meerdere [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) instanties bevatten die via de indexer toegankelijk zijn. Dit is een onderdeel van de PSD File Format Manipulation API die helpt bij het programmeren van Adobe® Photoshop® bestanden.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Initialiseert een nieuw exemplaar van de [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) klasse. |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Initialiseert een nieuw exemplaar van de [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) klasse. |
## Velden
...
| [get_Item(int index)](#get-Item-int-) | Haalt de [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) op op de opgegeven index. |
...
Initialiseert een nieuw exemplaar van de [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) klasse.
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | De gegevensbronnen. |
...
Haalt de [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) op op de opgegeven index.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | De index. Waarde: De [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). |
