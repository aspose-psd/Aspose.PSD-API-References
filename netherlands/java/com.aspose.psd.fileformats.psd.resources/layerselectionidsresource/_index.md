...
description: "Resource voor laagselectie‑ids"
type: docs
weight: 27
url: /nl/java/com.aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
Resource voor laagselectie‑ids
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource--) | Initialiseert een nieuw exemplaar van de [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource) klasse. |
## Velden
...
| [getLayerIds()](#getLayerIds--) | Haalt de laag‑ID's op of stelt deze in. |
...
| [setCount(short value)](#setCount-short-) | Haalt het aantal op of stelt dit in. |
...
| [setLayerIds(int[] value)](#setLayerIds-int---) | Haalt de laag‑ID's op of stelt deze in. |
...
Initialiseert een nieuw exemplaar van de [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource) klasse.
...
Haalt de laag‑ID's op of stelt deze in.
