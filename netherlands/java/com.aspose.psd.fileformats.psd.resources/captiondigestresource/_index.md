...
description: "CaptionDigest‑resource"
type: docs
weight: 13
url: /nl/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Initialiseert een nieuw exemplaar van de klasse [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Velden
...
| [getDigest()](#getDigest--) | Haalt op of stelt de digest in. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Haalt op of stelt de digest in. |
...
Haalt op of stelt de digest in.
