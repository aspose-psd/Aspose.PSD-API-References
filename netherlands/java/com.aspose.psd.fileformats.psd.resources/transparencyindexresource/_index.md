...
description: "Het transparantie‑indexresource‑blok."
type: docs
weight: 37
url: /nl/java/com.aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
Het transparantie‑indexresource‑blok.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [TransparencyIndexResource()](#TransparencyIndexResource--) | Initialiseert een nieuw exemplaar van de [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) klasse. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [RequiredVersion_internalized](#RequiredVersion-internalized) | De vereiste psd-versie. |
...
| [getTransparencyIndex()](#getTransparencyIndex--) | Haalt de transparantie-kleurindex op of stelt deze in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTransparencyIndex(short value)](#setTransparencyIndex-short-) | Haalt de transparantie-kleurindex op of stelt deze in. |
| [toString()](#toString--) |  |
...
Initialiseert een nieuw exemplaar van de [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource) klasse.
...
Haalt de transparantie-kleurindex op of stelt deze in.

Waarde: De transparantie-kleurindex.
