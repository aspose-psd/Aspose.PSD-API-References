...
description: "Resource voor laaggroepinformatie"
type: docs
weight: 25
url: /nl/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
Resource voor laaggroepinformatie
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Initialiseert een nieuw exemplaar van de klasse [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Velden
...
| [getGroups()](#getGroups--) | Haalt op of stelt de groepen in. |
...
| [setGroups(short[] value)](#setGroups-short---) | Haalt op of stelt de groepen in. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Werk LinkGroupId bij in lagen vanuit de Groups-eigenschap. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Werk waarden bij in de Groups-eigenschap vanuit de lagen. |
...
Haalt op of stelt de groepen in.
...
Werk LinkGroupId bij in lagen vanuit de Groups-eigenschap.
...
Werk waarden bij in de Groups-eigenschap vanuit de lagen.
