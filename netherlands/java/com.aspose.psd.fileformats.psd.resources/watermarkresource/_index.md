...
description: "Watermerk‑resource"
type: docs
weight: 42
url: /nl/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | Initialiseert een nieuw exemplaar van de [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) klasse. |
## Velden
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | Haalt een waarde op die aangeeft of dit exemplaar een watermerk is of stelt deze in. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | Haalt een waarde op die aangeeft of dit exemplaar een watermerk is of stelt deze in. |
| [toString()](#toString--) |  |
...
Initialiseert een nieuw exemplaar van de [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource) klasse.
...
Haalt een waarde op die aangeeft of dit exemplaar een watermerk is of stelt deze in.

Waarde:  true  als dit exemplaar een watermerk is; anders,  false .
