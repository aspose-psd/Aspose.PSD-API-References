...
description: "Resource voor afdrukvlaggen"
type: docs
weight: 30
url: /nl/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
Resource voor afdrukvlaggen
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Initialiseert een nieuw exemplaar van de [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) klasse. |
## Velden
...
| [getBleedScale()](#getBleedScale--) | Haalt de afloop-schaal op of stelt deze in. |
| [getBleedWidth()](#getBleedWidth--) | Haalt de breedte van de afloop op of stelt deze in. |
| [getCenterCropMark()](#getCenterCropMark--) | Geeft of stelt de centre bijsnijdmarkering in. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Haalt de afloop-schaal op of stelt deze in. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Haalt de breedte van de afloop op of stelt deze in. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Geeft of stelt de centre bijsnijdmarkering in. |
...
Initialiseert een nieuw exemplaar van de [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource) klasse.
...
Haalt de afloop-schaal op of stelt deze in.

Waarde: De bleed-schaal.
...
Haalt de breedte van de afloop op of stelt deze in.

Waarde: De breedte van de bleed.
...
Geeft of stelt de centre bijsnijdmarkering in.

Waarde: De centre bijsnijdmarkering.
