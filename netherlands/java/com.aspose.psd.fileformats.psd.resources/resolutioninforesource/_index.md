...
description: "De resolutie‑infobron"
type: docs
weight: 33
url: /nl/java/com.aspose.psd.fileformats.psd.resources/resolutioninforesource/
---
...
De resolutie‑infobron
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [ResolutionInfoResource()](#ResolutionInfoResource--) | Initialiseert een nieuw exemplaar van de klasse [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Velden
...
| [getHDpi()](#getHDpi--) | Horizontale DPI. |
| [getHResDisplayUnit()](#getHResDisplayUnit--) | Weergave-eenheden voor horizontale resolutie. |
| [getHeightDisplayUnit()](#getHeightDisplayUnit--) | Haalt op of stelt de hoogte-weergave-eenheid in. |
...
| [getVDpi()](#getVDpi--) | Verticale DPI. |
| [getVResDisplayUnit()](#getVResDisplayUnit--) | Weergave-eenheden voor verticale resolutie. |
| [getWidthDisplayUnit()](#getWidthDisplayUnit--) | Haalt op of stelt de breedte-weergave-eenheid in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Slaat het resource‑blok op naar de opgegeven stream. |
| [setHDpi(FixedPointDecimal value)](#setHDpi-com.aspose.psd.fileformats.psd.resources.FixedPointDecimal-) | Horizontale DPI. |
| [setHResDisplayUnit(int value)](#setHResDisplayUnit-int-) | Weergave-eenheden voor horizontale resolutie. |
| [setHeightDisplayUnit(int value)](#setHeightDisplayUnit-int-) | Haalt op of stelt de hoogte-weergave-eenheid in. |
...
| [setVDpi(FixedPointDecimal value)](#setVDpi-com.aspose.psd.fileformats.psd.resources.FixedPointDecimal-) | Verticale DPI. |
| [setVResDisplayUnit(int value)](#setVResDisplayUnit-int-) | Weergave-eenheden voor verticale resolutie. |
| [setWidthDisplayUnit(int value)](#setWidthDisplayUnit-int-) | Haalt op of stelt de breedte-weergave-eenheid in. |
| [toString()](#toString--) |  |
...
Weergave-eenheden voor horizontale resolutie. Dit beïnvloedt alleen de gebruikersinterface; de resolutie wordt nog steeds opgeslagen in het PSD‑bestand als pixels/inch.

Waarde: De weergave-eenheid voor horizontale resolutie.
...
Haalt op of stelt de hoogte-weergave-eenheid in.

Waarde: De hoogte-weergave-eenheid.
...
Weergave-eenheden voor verticale resolutie.

Waarde: de verticale resolutie weergave-eenheid.
...
Haalt op of stelt de breedte-weergave-eenheid in.

Waarde: de breedte weergave-eenheid.
