...
description: "Gecomprimeerde fourCC-waarden voor Photoshop gradientinterpolatiemethode."
type: docs
weight: 18
url: /nl/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Gecomprimeerde fourCC-waarden voor Photoshop gradient-interpolatiemethode. Descriptor-sleutel: "gradientsInterpolationMethod"
## Velden

| Veld | Beschrijving |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Klassiek (legacy standaard wanneer sleutel afwezig is). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Lineair (let op spatie aan het einde). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Perceptueel. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Glad. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Strepen. |
## Methoden
...
'Gcls' \\u2014 Klassiek (legacy standaard wanneer sleutel afwezig is).
...
'Lnr ' \\u2014 Lineair (let op spatie aan het einde).
