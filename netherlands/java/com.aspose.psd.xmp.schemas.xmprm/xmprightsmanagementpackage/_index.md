...
description: "Stelt de XMP Rights Management-namespace voor."
type: docs
weight: 10
url: /nl/java/com.aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/
---
...
Stelt de XMP Rights Management-namespace voor.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [XmpRightsManagementPackage()](#XmpRightsManagementPackage--) | Initialiseert een nieuw exemplaar van de  XmpRightsManagementPackage  klasse. |
## Methoden
...
| [setCertificate(String certificate)](#setCertificate-java.lang.String-) | Stelt het certificaat in. |
| [setMarkedAsRightManagement(boolean value)](#setMarkedAsRightManagement-boolean-) | Markeert als rechtenbeheerinhoud |
| [setOwners(String[] owners)](#setOwners-java.lang.String---) | Stelt eigenaren in. |
| [setUsageTerms(LangAlt usageTerms)](#setUsageTerms-com.aspose.psd.xmp.LangAlt-) | Stelt de gebruiksvoorwaarden in. |
| [setValue(String key, IXmlValue value)](#setValue-java.lang.String-com.aspose.psd.xmp.IXmlValue-) | Stelt de waarde in. |
| [setWebStatement(String webStatementUrl)](#setWebStatement-java.lang.String-) | Stelt de webverklaring in. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| certificaat | java.lang.String | Het certificaat. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| waarde | boolean | indien ingesteld op  true  dat dit een rechtenbeheerde bron is. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| eigenaren | java.lang.String[] | De eigenaren. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| usageTerms | [LangAlt](../../com.aspose.psd.xmp/langalt) | De gebruiksvoorwaarden. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| webStatementUrl | java.lang.String | De URL van de webverklaring. |
