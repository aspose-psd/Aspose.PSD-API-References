...
description: "Selectieve kleur-aanpassingslaag."
type: docs
weight: 28
url: /nl/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Haalt de CMYK-correctie op via selectieve kleur. |
| [getContainer()](#getContainer--) | Haalt de Image-container op. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Haalt op of stelt de correctiemethode in. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Verwerkt de Selective Color-laag. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Stelt de CMYK-correctie in via selectieve kleur. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Stelt de  Image  container in. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Haalt op of stelt de correctiemethode in. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| selectiveColorsType | int | Selectieve kleuren. |
...
**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - Het pixelrechthoek en de verwerkte pixels.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| selectiveColorsType | int | Type van de selectieve kleuren. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | CMYK-correctie. |
