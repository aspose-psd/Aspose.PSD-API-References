...
description: "CMYK-kanaalmixer-aanpassingslaag."
type: docs
weight: 14
url: /nl/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
CMYK-kanaalmixer-aanpassingslaag.
## Velden
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | Haalt het type van de aanpassingslaag op. |
...
| [getBlackChannel()](#getBlackChannel--) | Haalt het zwarte kanaal op. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Haalt de index van het kanaal op via. |
...
| [getCyanChannel()](#getCyanChannel--) | Haalt het cyaan kanaal op. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Haalt het magenta kanaal op. |
...
| [getMonochrome()](#getMonochrome--) | Haalt een waarde op of stelt een waarde in die aangeeft of deze [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) monochroom is. |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | Haalt de processor op. |
...
| [getYellowChannel()](#getYellowChannel--) | Haalt het gele kanaal op. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Verwerkt de aanpassingslaag. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Voegt de gegevens samen. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Haalt een waarde op of stelt een waarde in die aangeeft of deze [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) monochroom is. |
...
### create_internalized(PsdHeader header, LayerResource[] resources) {#create-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.fileformats.psd.layers.LayerResource---}
```
public static CmykChannelMixerLayer create_internalized(PsdHeader header, LayerResource[] resources)
```
...
**Returns:**
[CmykChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer)
### create_internalized(System.IO.Stream stream) {#create-internalized-com.aspose.ms.System.IO.Stream-}
```
...
Haalt het type van de aanpassingslaag op.

Waarde: Het type van de aanpassingslaag.
...
**Returns:**
int
### getBlackChannel() {#getBlackChannel--}
```
public final CmykMixerChannel getBlackChannel()
```


Haalt het zwarte kanaal op.

Waarde: Het zwarte kanaal.

**Returns:**
[CmykMixerChannel](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel)
...
Haalt de index van het kanaal op. Retourneert CmykMixerChannel
...
**Returns:**
[MixerChannel](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/mixerchannel) - [CmykMixerChannel](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel)
...
### getCyanChannel() {#getCyanChannel--}
```
public final CmykMixerChannel getCyanChannel()
```


Haalt het cyaan kanaal op.

Waarde: Het cyaan kanaal.
...
**Returns:**
long
### getMagentaChannel() {#getMagentaChannel--}
```
public final CmykMixerChannel getMagentaChannel()
```


Haalt het magenta kanaal op.

Waarde: Het magenta kanaal.
...
Haalt een waarde op of stelt een waarde in die aangeeft of deze [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) monochroom is.
...
### getYellowChannel() {#getYellowChannel--}
```
public final CmykMixerChannel getYellowChannel()
```


Haalt het gele kanaal op.

Waarde: Het gele kanaal.
...
Verwerkt de aanpassingslaag.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | De pixels rechthoek. |
| pixels | int[] | De pixels. |
| start | [Point](../../com.aspose.psd/point) | De pixels linkerboven locatie. |
| end | [Point](../../com.aspose.psd/point) | De pixels rechteronder locatie. |
