...
type: docs
weight: 10
url: /nl/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
Vullag. Kleurvulling, Verloopvulling of Patroonvulling die verschilt door FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#setFillSettings-IFillSettings-))
## Velden
...
| [createInstance(int fillType)](#createInstance-int-) | Bouw een nieuw exemplaar van de [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) klasse op basis van het vultype. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Haalt de renderprocessor op voor [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Haalt de vulopaciteit op of stelt deze in. |
| [getFillSettings()](#getFillSettings--) | Haalt de vulinstellingen op. |
| [getFillType()](#getFillType--) | Haalt het type van de vulling op. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Haalt de vulinstellingen op. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Werkt Fill Layer Pixels Data bij volgens de werkelijke [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Bouw een nieuw exemplaar van de [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) klasse op basis van het vultype.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| fillType | int | Het type vullag. |
...
Haalt de renderprocessor op voor [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | De afbeelding om naar te renderen. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | De grenzen om te verwerken. |

**Returns:**
com.aspose.internal.IPartialProcessor - Retourneer de renderprocessor voor [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Haalt het type van de vulling op.

Waarde: het type van de vulling.
...
Werkt Fill Layer Pixels Data bij volgens de werkelijke [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
