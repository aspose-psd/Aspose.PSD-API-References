...
description: "Definieert de ObjectArrayStructure klasse die meestal een array bevat."
type: docs
weight: 20
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Definieert de ObjectArrayStructure klasse die meestal een [UnitArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure) array bevat. Het wordt gebruikt in de PSD-bestandsresources, zoals de PlLd Resource en de SoLd Resource.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initialiseert een nieuw exemplaar van de [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) klasse. |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initialiseert een nieuw exemplaar van de [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) klasse. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [StructureKey](#StructureKey) | Identificeert de 'ObAr' structuursleutel. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Haalt op of stelt de object array class ID in. |
| [getClassName()](#getClassName--) | Haalt op of stelt de object array class name in. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Haalt de lijst met structuren op. |
| [getKey()](#getKey--) | Haalt de object array structure key op. |
...
| [getStructureCount()](#getStructureCount--) | Haalt het object array substructure count op. |
| [getStructures()](#getStructures--) | Haalt op of stelt de substructures in de object array structure in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Haalt op of stelt de object array class ID in. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Haalt op of stelt de object array class name in. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Haalt op of stelt de substructures in de object array structure in. |
...
Initialiseert een nieuw exemplaar van de [ObjectArrayStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure) klasse.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| keyName | java.lang.String | Naam van de sleutel. |
| classIdName | java.lang.String | Naam van de class identifier. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| sleutel | int | De integer sleutel. |
...
Identificeert de 'ObAr' structuursleutel.
...
Haalt op of stelt de object array class ID in.

Waarde: De object array class ID.
...
Haalt op of stelt de object array class name in.

Waarde: De object array class name.
...
Haalt de lijst met structuren op.
...
Haalt de object array structure key op.
...
Haalt het object array substructure count op.

Waarde: Het substructure count in de object array structure.
...
Haalt op of stelt de substructures in de object array structure in.

Waarde: De substructures in de object array structure.
