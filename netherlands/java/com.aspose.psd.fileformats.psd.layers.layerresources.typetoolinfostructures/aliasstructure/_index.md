...
description: "De alias‑structuur."
type: docs
weight: 10
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) klasse. |
## Velden
...
| [getDataLength()](#getDataLength--) | Haalt de exacte gegevenslengte in bytes op. |
| [getFullPath()](#getFullPath--) | Haalt op of stelt het volledige pad in. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Haalt op of stelt het volledige pad in. |
...
Initialiseert een nieuw exemplaar van de [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure) klasse.
...
Haalt de exacte gegevenslengte in bytes op.

Waarde: De gegevenslengte in bytes.
...
Haalt op of stelt het volledige pad in.

Waarde: Het volledige pad.
