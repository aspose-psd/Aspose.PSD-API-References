...
description: "De Name-structuursleutel 0x6E616D65, die 'name' in ASCII weergeeft, is een eenvoudige structuur die wordt gebruikt om een Unicode- of Pascal-stijl tekenreeks op te slaan die de naam van een element zoals een laagpad of aanpassing vertegenwoordigt."
type: docs
weight: 19
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
De Name‑structuur (sleutel: 0x6E616D65, wat "name" in ASCII betekent) is een eenvoudige structuur die wordt gebruikt om een Unicode‑ of Pascal‑stijl tekenreeks op te slaan die de naam van een element vertegenwoordigt, zoals een laag, pad of aanpassing.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) klasse. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [StructureKey](#StructureKey) | De Name-structuursleutel. |
## Methoden
...
| [getValue()](#getValue--) | Haalt de waarde van een Name-structuur op of stelt deze in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Haalt de eerste tekenreekswaarde van de Name-structuur op of stelt deze in. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Haalt de waarde van een Name-structuur op of stelt deze in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) klasse.
...
Haalt de waarde van een Name-structuur op of stelt deze in.
...
Haalt de eerste tekenreekswaarde van de Name-structuur op of stelt deze in. Deze bevat meestal een regeleinde-symbool.
