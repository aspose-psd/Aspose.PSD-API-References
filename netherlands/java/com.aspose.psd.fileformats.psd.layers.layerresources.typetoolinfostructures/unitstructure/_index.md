...
description: "De eenheidsstructuur."
type: docs
weight: 28
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) klasse. |
## Velden
...
| [getUnitType()](#getUnitType--) | Haalt het eenheidstype op of stelt dit in. |
...
| [setUnitType(int value)](#setUnitType-int-) | Haalt het eenheidstype op of stelt dit in. |
| [setValue(double value)](#setValue-double-) | Haalt de waarde op of stelt deze in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure) klasse.
...
Haalt het eenheidstype op of stelt dit in.

Waarde: het eenheidstype.
