...
description: "De offsetstructuur."
type: docs
weight: 21
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [OffsetStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/offsetstructure) klasse. |
## Velden
...
| [getValue()](#getValue--) | Haalt de integerwaarde op of stelt deze in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Haalt de integerwaarde op of stelt deze in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [OffsetStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/offsetstructure) klasse.
...
Haalt de integerwaarde op of stelt deze in.

Waarde: De integerwaarde.
