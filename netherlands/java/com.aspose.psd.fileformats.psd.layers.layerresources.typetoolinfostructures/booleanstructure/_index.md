...
description: "De boolean‑structuur."
type: docs
weight: 11
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| --- | --- |
| [BooleanStructure(ClassID keyName)](#BooleanStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [BooleanStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/booleanstructure) klasse. |
## Velden
...
| [getValue()](#getValue--) | Haalt een booleanwaarde op of stelt deze in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(boolean value)](#setValue-boolean-) | Haalt een booleanwaarde op of stelt deze in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [BooleanStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/booleanstructure) klasse.
...
Haalt een booleanwaarde op of stelt deze in.

Waarde: Een booleanwaarde.
