...
description: "Geënumereerde referentiestructuur."
type: docs
weight: 16
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
Geënumereerde referentiestructuur.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) klasse. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | Identificeert de structuur‑sleutel. |
| [StructureKey](#StructureKey) | De genummerde descriptor sleutel. |
## Methoden
...
| [getEnumName()](#getEnumName--) | Haalt op of stelt de enumnaam in. |
...
| [getKey()](#getKey--) | Haalt de sleutel op. |
...
| [getTypeID()](#getTypeID--) | Haalt op of stelt de type-ID in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Haalt op of stelt de enumnaam in. |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Haalt op of stelt de type-ID in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) klasse.
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | De type-ID. |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | De enumnaam. |
...
De genummerde descriptor sleutel.
...
Haalt op of stelt de enumnaam in.
...
Haalt op of stelt de type-ID in.
