...
description: "De double‑structuur."
type: docs
weight: 14
url: /nl/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| --- | --- |
| [DoubleStructure(ClassID keyName)](#DoubleStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialiseert een nieuw exemplaar van de [DoubleStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/doublestructure) klasse. |
## Velden
...
| [getValue()](#getValue--) | Haalt de doublewaarde op of stelt deze in. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(double value)](#setValue-double-) | Haalt de doublewaarde op of stelt deze in. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialiseert een nieuw exemplaar van de [DoubleStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/doublestructure) klasse.
...
Haalt de doublewaarde op of stelt deze in.
