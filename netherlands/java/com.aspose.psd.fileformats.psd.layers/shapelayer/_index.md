...
description: "Vormlaag."
type: docs
weight: 29
url: /nl/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Shape-laag. Omvat de logica voor het werken met Shape-laag en gerelateerde bronnen.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Initialiseert een nieuw exemplaar van de [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) klasse. |
## Velden
...
| [createInstance()](#createInstance--) | Creëert een nieuw exemplaar van de [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) klasse. |
...
| [getFill()](#getFill--) | Vulinstellingen voor het interne gebied van Shapes in de Shape-laag. |
...
| [getPath()](#getPath--) | Haalt de set van paden op die aanwezig zijn in een Shape-laag. |
...
| [getStroke()](#getStroke--) | Haalt op of stelt de Stroke-instellingen van Shapes in. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Aangeroepen wanneer [global resources changed]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Aangeroepen wanneer [resources change]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Vulinstellingen voor het interne gebied van Shapes in de Shape-laag. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Haalt op of stelt de Stroke-instellingen van Shapes in. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Werk resources bij vanuit Shape-laageigenschappen. |
...
Initialiseert een nieuw exemplaar van de [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) klasse. Alle resources worden aangemaakt in hun standaardstatus.
...
Creëert een nieuw exemplaar van de [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) klasse.
...
Vulinstellingen voor het interne gebied van Shapes in de Shape-laag.
...
Haalt de set van paden op die aanwezig zijn in een Shape-laag.
...
Haalt op of stelt de Stroke-instellingen van Shapes in.
...
**Returns:**
boolean - Booleaanse waarde die aangeeft dat de laag geldig is.
...
Aangeroepen wanneer [global resources changed].

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| zender | java.lang.Object | De zender. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | De EventArgs‑instantie die de gebeurtenisgegevens bevat. |
...
Aangeroepen wanneer [resources change].
...
Werk resources bij vanuit Shape-laageigenschappen.
