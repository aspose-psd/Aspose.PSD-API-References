...
description: "De tekstlaag‑klasse"
type: docs
weight: 30
url: /nl/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Corrigeert de grootte van het lettertype |
...
| [createInstance_internalized()](#createInstance-internalized--) | Maakt een nieuw exemplaar van de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) klasse. |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Maakt een nieuw exemplaar van de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) klasse. |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Haalt de engine-gegevens op. |
...
| [getFont()](#getFont--) | Haalt het lettertype op. |
| [getFonts()](#getFonts--) | Haalt de set lettertypen van de tekstlaag op. |
...
| [getInnerText()](#getInnerText--) | Haalt de tekst van de laag op |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Haalt op of stelt de resource-processor in. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Haalt het tekenreeksformaat op. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Haalt de synchronisatiewortel op. |
| [getText()](#getText--) | Haalt de tekst op. |
| [getTextBoundBox()](#getTextBoundBox--) | Haalt op of stelt het tekstbegrenzingsvak in. |
| [getTextColor()](#getTextColor--) | Haalt de kleur van de tekst op. |
| [getTextData()](#getTextData--) | Haalt de tekstgedeelten op. |
| [getTop()](#getTop--) | Haalt de positie van de bovenste laag op of stelt deze in. |
| [getTransformMatrix()](#getTransformMatrix--) | Haalt op of stelt de transformatiesmatrix in |
| [getTransparentColor()](#getTransparentColor--) | Haalt de transparante kleur van de afbeelding op. |
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Zoekt en haalt de [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) resource op uit de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Haalt op of stelt een waarde in die aangeeft of [was gewijzigd]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Bepaalt of [lettertype beschikbaar is] [het opgegeven lettertype]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Verwerkt het lettertype vooraf. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Vervangt het lettertype door de standaard. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Haalt de tekst van de laag op |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Haalt op of stelt de resource-processor in. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Haalt op of stelt het tekstbegrenzingsvak in. |
| [setTop(int value)](#setTop-int-) | Haalt de positie van de bovenste laag op of stelt deze in. |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | Haalt op of stelt de transformatiesmatrix in |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Haalt op of stelt een waarde in die aangeeft of [was gewijzigd]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Werkt de grenzen van de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) bij in de resources. |
| [updateText(String text)](#updateText-java.lang.String-) | Werkt de tekst bij. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Werkt de tekst bij. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Werkt de tekst bij. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Werkt de tekst bij. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Werkt de tekst bij. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Werkt de tekst bij. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Werkt de tekst bij. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Werkt de tekst bij. |
| [wait()](#wait--) |  |
...
Corrigeert de grootte van het lettertype

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| newSize | float | Nieuwe lettergrootte |
| yyTransform | double | 'yy' Transformatiematrixparameter |

**Returns:**
float - gecorrigeerde grootte
...
Maakt een nieuw exemplaar van de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) klasse.
...
Haalt de engine-gegevens op.

Value: de engine-gegevens.
...
Haalt de set lettertypen van de tekstlaag op.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - de set lettertypen van de tekstlaag.
...
Haalt op of stelt de resource-processor in.

Value: de resource-processor.
...
Haalt het tekenreeksformaat op.

Value: het tekenreeksformaat.
...
Haalt op of stelt het tekstbegrenzingsvak in.

Value: het tekstbegrenzingsvak.
...
Haalt de kleur van de tekst op.
...
Haalt op of stelt de transformatiesmatrix in

Value: de transformatiematrix
...
Zoekt en haalt de [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) resource op uit de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Haalt op of stelt een waarde in die aangeeft of [was gewijzigd].

Value:  true  als [was changed]; anders,  false .
...
Bepaalt of [lettertype beschikbaar is] [het opgegeven lettertype].
...
**Returns:**
boolean - Waar als lettertype beschikbaar is
...
Verwerkt het lettertype vooraf.
...
Vervangt het lettertype door de standaard.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | Het lettertype. |
| defaultFontName | java.lang.String | Standaardnaam van het lettertype. |
...
| newWidth | int | De nieuwe breedte. |
| newHeight | int | De nieuwe hoogte. |
| resizeType | int | Het type van de schaalaanpassingstransformatie  ResizeType |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| waarde | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Werkt de grenzen van de [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) bij in de resources.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | De absolute positie en grootte van de tekst. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | De positie en grootte van de tekst ten opzichte van de tekstvak. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| tekst | java.lang.String | De tekstwaarde. |
...
| --- | --- | --- |
| tekst | java.lang.String | De tekstwaarde. |
| color | [Color](../../com.aspose.psd/color) | De kleurwaarde. |
...
| --- | --- | --- |
| tekst | java.lang.String | De tekstwaarde. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | De linkerboven coördinaat. |
...
| tekst | java.lang.String | De tekstwaarde. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | De linkerboven coördinaat. |
| fontSize | float | Grootte van het lettertype. |
