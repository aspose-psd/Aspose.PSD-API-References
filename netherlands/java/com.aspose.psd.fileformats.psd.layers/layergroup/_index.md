...
description: "Groeplaagklasse"
type: docs
weight: 19
url: /nl/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Geeft de hoogte van de laaggroep. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Geeft de unie‑grenzen van alle lagen in LayerGroup. |
...
| [getWidth()](#getWidth--) | Geeft de breedte van de laaggroep. |
...
Geeft de hoogte van de laaggroep.
...
Geeft de unie‑grenzen van alle lagen in LayerGroup.
...
Geeft de breedte van de laaggroep.
