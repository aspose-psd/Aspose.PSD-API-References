...
description: "De artboard-laagklasse."
type: docs
weight: 10
url: /nl/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Voegt de laag toe aan de laaggroep. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Voegt de laag toe aan de laaggroep. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Voegt de laaggroep toe. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Haalt of stelt de achtergrondkleur van het artboard in. |
...
| [getLayers()](#getLayers--) | Geeft de lagen in de laaggroep. |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Haalt de werkelijke grenzen van de ArtboardLayer op. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Haalt de  LayerSectionResource  op uit de bronnen. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Haalt of stelt een waarde in die aangeeft of [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) de achtergrondkleur heeft. |
...
| [isOpen()](#isOpen--) | Geeft of stelt in of de map geopend is; als deze op true wordt gezet, wordt de groep bij het opstarten geopend, anders geminimaliseerd. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Haalt of stelt de achtergrondkleur van het artboard in. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Geeft of stelt in of de map geopend is; als deze op true wordt gezet, wordt de groep bij het opstarten geopend, anders geminimaliseerd. |
...
Voegt de laag toe aan de laaggroep.
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | De laag. |
| index | int | De index waarop de laag wordt ingevoegd. Ongeldige waarden betekenen het einde van de lagenlijst. |
...
Bouw de begin‑ en eind‑groeppemarkeringen.
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Retourneert een array van twee LayerGroup-objecten, waarbij de eerste [0] de begin-groepmarkering is en de tweede [1] de eind-groepmarkering.
### cacheData() {#cacheData--}
```
...
Haalt of stelt de achtergrondkleur van het artboard in.
...
Geeft de lagen in de laaggroep.
...
Haalt de werkelijke grenzen van de ArtboardLayer op.
...
Haalt de  LayerSectionResource  op uit de bronnen.
...
Haalt of stelt een waarde in die aangeeft of [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) de achtergrondkleur heeft.
...
Geeft of stelt in of de map geopend is; als deze op true wordt gezet, wordt de groep bij het opstarten geopend, anders geminimaliseerd.
