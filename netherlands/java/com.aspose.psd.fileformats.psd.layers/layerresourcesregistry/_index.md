...
description: "Representeert het register van laagresources."
type: docs
weight: 26
url: /nl/java/com.aspose.psd.fileformats.psd.layers/layerresourcesregistry/
---
...
Representeert het register van laagresources.
## Constructors
...
| [getClass()](#getClass--) |  |
| [getFirstSupportedDescriptor(InputStream stream, int psdVersion)](#getFirstSupportedDescriptor-java.io.InputStream-int-) | Haalt de eerste ondersteunde opener‑descriptor op. |
...
| [hashCode()](#hashCode--) |  |
| [loadResourceByFirstSupportedDescriptor(InputStream stream, int psdVersion)](#loadResourceByFirstSupportedDescriptor-java.io.InputStream-int-) | Laadt [LayerResource](../../com.aspose.psd.fileformats.psd.layers/layerresource) met de eerst gevonden opener die geschikt is voor de opgegeven stream. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [registerDefaultPsdOptions_internalized()](#registerDefaultPsdOptions-internalized--) | Registreert de standaard PSD‑opties. |
| [registerOpener(ILayerResourceLoader openerDescriptor)](#registerOpener-com.aspose.psd.fileformats.psd.layers.ILayerResourceLoader-) | Registreert de opener. |
| [registerPsdLoadOptions_internalized(PsdLoadOptions load)](#registerPsdLoadOptions-internalized-com.aspose.psd.imageloadoptions.PsdLoadOptions-) | Registreert de PSD‑laadopties. |
| [toString()](#toString--) |  |
| [unregisterOpener(ILayerResourceLoader openerDescriptor)](#unregisterOpener-com.aspose.psd.fileformats.psd.layers.ILayerResourceLoader-) | Deregistreert de opener. |
| [wait()](#wait--) |  |
...
Laadt [LayerResource](../../com.aspose.psd.fileformats.psd.layers/layerresource) met de eerst gevonden opener die geschikt is voor de opgegeven stream.
...
Registreert de standaard PSD‑opties.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| openerDescriptor | [ILayerResourceLoader](../../com.aspose.psd.fileformats.psd.layers/ilayerresourceloader) | De opener descriptor om te registreren. |
...
Registreert de PSD‑laadopties.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| load | [PsdLoadOptions](../../com.aspose.psd.imageloadoptions/psdloadoptions) | De load. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| openerDescriptor | [ILayerResourceLoader](../../com.aspose.psd.fileformats.psd.layers/ilayerresourceloader) | De opener descriptor om te deregistreren. |
