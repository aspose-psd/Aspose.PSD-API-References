...
description: "EXIF-gegevenscontainer voor jpeg-bestanden."
type: docs
weight: 12
url: /nl/java/com.aspose.psd.exif/jpegexifdata/
---
...
EXIF-gegevenscontainer voor jpeg-bestanden.
## Constructors

| Constructor | Beschrijving |
| --- | --- |
| [JpegExifData()](#JpegExifData--) | Initialiseert een nieuw exemplaar van de  JpegExifData  klasse. |
| [JpegExifData(TiffDataType[] exifdata)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | Initialiseert een nieuw exemplaar van de  JpegExifData  klasse met gegevens uit een array. |
| [JpegExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#JpegExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | Initialiseert een nieuw exemplaar van de  JpegExifData  klasse met gegevens uit een array. |
## Velden

| Veld | Beschrijving |
| --- | --- |
| [MaxExifSegmentSize](#MaxExifSegmentSize) | De maximale EXIF-segmentgrootte in bytes toegestaan. |
## Methoden
...
| [getBitsPerSample()](#getBitsPerSample--) | Haalt op of stelt de bits per monster in. |
...
| [getCompression()](#getCompression--) | Haalt op of stelt de compressie in. |
| [getContrast()](#getContrast--) | Haalt het contrast op of stelt dit in. |
| [getCopyright()](#getCopyright--) | Haalt op of stelt de copyright in. |
| [getCustomRendered()](#getCustomRendered--) | Haalt de aangepaste rendering op of stelt deze in. |
| [getDateTime()](#getDateTime--) | Haalt op of stelt de datumtijd in. |
...
| [getModel()](#getModel--) | Haalt op of stelt het model in. |
...
| [getPhotometricInterpretation()](#getPhotometricInterpretation--) | Haalt op of stelt de fotometrische interpretatie in. |
...
| [getPrimaryChromaticities()](#getPrimaryChromaticities--) | Haalt op of stelt de chromaticiteit van de drie primaire kleuren van de afbeelding in. |
...
| [getReferenceBlackWhite()](#getReferenceBlackWhite--) | Haalt op of stelt de referentie zwart wit in. |
...
| [getSamplesPerPixel()](#getSamplesPerPixel--) | Haalt op of stelt de samples per pixel in. |
...
| [getSoftware()](#getSoftware--) | Haalt op of stelt de software in. |
...
| [getThumbnail()](#getThumbnail--) | Haalt op of stelt de miniatuurafbeelding in. |
| [getTransferFunction()](#getTransferFunction--) | Haalt op of stelt de overdrachtsfunctie in. |
...
| [getYCbCrCoefficients()](#getYCbCrCoefficients--) | Haalt op of stelt de matrixcoëfficiënten voor transformatie van RGB naar YCbCr-beeldgegevens in. |
| [getYCbCrPositioning()](#getYCbCrPositioning--) | Haalt op of stelt de positie van chrominantiecomponenten ten opzichte van de luminantiecomponent in. |
| [getYCbCrSubSampling()](#getYCbCrSubSampling--) | Haalt op of stelt de bemonsteringsratio van chrominantiecomponenten ten opzichte van de luminantiecomponent in. |
...
| [serializeExifData()](#serializeExifData--) | Serialiseert de EXIF-gegevens. |
...
| [setBitsPerSample(int[] value)](#setBitsPerSample-int---) | Haalt op of stelt de bits per monster in. |
...
| [setCompression(int value)](#setCompression-int-) | Haalt op of stelt de compressie in. |
| [setContrast(int value)](#setContrast-int-) | Haalt het contrast op of stelt dit in. |
| [setCopyright(String value)](#setCopyright-java.lang.String-) | Haalt op of stelt de copyright in. |
| [setCustomRendered(int value)](#setCustomRendered-int-) | Haalt de aangepaste rendering op of stelt deze in. |
| [setDateTime(String value)](#setDateTime-java.lang.String-) | Haalt op of stelt de datumtijd in. |
...
| [setModel(String value)](#setModel-java.lang.String-) | Haalt op of stelt het model in. |
...
| [setPhotometricInterpretation(int value)](#setPhotometricInterpretation-int-) | Haalt op of stelt de fotometrische interpretatie in. |
...
| [setPrimaryChromaticities(TiffRational[] value)](#setPrimaryChromaticities-com.aspose.psd.fileformats.tiff.TiffRational---) | Haalt op of stelt de chromaticiteit van de drie primaire kleuren van de afbeelding in. |
...
| [setReferenceBlackWhite(TiffRational[] value)](#setReferenceBlackWhite-com.aspose.psd.fileformats.tiff.TiffRational---) | Haalt op of stelt de referentie zwart wit in. |
...
| [setSamplesPerPixel(int value)](#setSamplesPerPixel-int-) | Haalt op of stelt de samples per pixel in. |
...
| [setSoftware(String value)](#setSoftware-java.lang.String-) | Haalt op of stelt de software in. |
...
| [setThumbnail(RasterImage value)](#setThumbnail-com.aspose.psd.RasterImage-) | Haalt op of stelt de miniatuurafbeelding in. |
| [setTransferFunction(int[] value)](#setTransferFunction-int---) | Haalt op of stelt de overdrachtsfunctie in. |
...
| [setYCbCrCoefficients(TiffRational[] value)](#setYCbCrCoefficients-com.aspose.psd.fileformats.tiff.TiffRational---) | Haalt op of stelt de matrixcoëfficiënten voor transformatie van RGB naar YCbCr-beeldgegevens in. |
| [setYCbCrPositioning(int value)](#setYCbCrPositioning-int-) | Haalt op of stelt de positie van chrominantiecomponenten ten opzichte van de luminantiecomponent in. |
| [setYCbCrSubSampling(int[] value)](#setYCbCrSubSampling-int---) | Haalt op of stelt de bemonsteringsratio van chrominantiecomponenten ten opzichte van de luminantiecomponent in. |
...
Initialiseert een nieuw exemplaar van de  JpegExifData  klasse.
...
Initialiseert een nieuw exemplaar van de  JpegExifData  klasse met gegevens uit een array.
...
De maximale EXIF-segmentgrootte in bytes toegestaan.
...
Haalt op of stelt de bits per monster in.

Waarde: Het aantal bits per monster.
...
Haalt op of stelt de compressie in.
...
Haalt op of stelt de copyright in.

Waarde: Het auteursrecht.
...
Haalt op of stelt de datumtijd in.

Waarde: De datum en tijd.
...
Waarde: De afbeeldingsbeschrijving.
...
Waarde: De lengte van de afbeelding.
...
Waarde: De breedte van de afbeelding.
...
Haalt op of stelt het model in.
...
Haalt op of stelt de fotometrische interpretatie in.

Waarde: De fotometrische interpretatie.
...
Waarde: De planaire configuratie.
...
Haalt op of stelt de chromaticiteit van de drie primaire kleuren van de afbeelding in.

Waarde: De chromaticiteit van de drie primaire kleuren van de afbeelding.
...
Haalt op of stelt de referentie zwart wit in.

Waarde: De referentie zwart-wit.
...
Haalt op of stelt de samples per pixel in.

Waarde: Het aantal monsters per pixel.
...
Haalt op of stelt de software in.
...
Haalt op of stelt de miniatuurafbeelding in.
...
Haalt op of stelt de overdrachtsfunctie in.

Waarde: De overdrachtsfunctie.
...
Haalt op of stelt de matrixcoëfficiënten voor transformatie van RGB naar YCbCr-beeldgegevens in.

Waarde: De matrixcoëfficiënten voor de transformatie van RGB naar YCbCr-beeldgegevens.
...
Haalt op of stelt de positie van chrominantiecomponenten ten opzichte van de luminantiecomponent in.

Waarde: De positie van chrominantiecomponenten ten opzichte van de luminantiecomponent.
...
Haalt op of stelt de bemonsteringsratio van chrominantiecomponenten ten opzichte van de luminantiecomponent in.

Waarde: De bemonsteringsratio van chrominantiecomponenten ten opzichte van de luminantiecomponent.
...
Serialiseert de EXIF-gegevens. Schrijft de tagwaarden en inhoud. De meest invloedrijke grootte-tag is de inhoud van de Thumbnail-tag.

**Returns:**
byte[] - De geserialiseerde EXIF-gegevens.

De totale segmentgrootte moet kleiner dan of gelijk aan MaxExifSegmentSize bytes zijn om een correcte jpeg-afbeelding te produceren. Tip: probeer de thumbnail-grootte te verkleinen of de compressie ervan te wijzigen als de EXIF-sectiegrootte te groot is.
