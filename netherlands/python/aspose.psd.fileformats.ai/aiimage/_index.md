...
type: docs
weight: 40
url: /nl/python-net/aspose.psd.fileformats.ai/aiimage/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [AiImage()](#AiImage__1) | Initialiseert een nieuw exemplaar van de AiImage klasse |
## **Properties**
| **Name** | **Type** | **Access** | **Beschrijving** |
| :- | :- | :- | :- |
| active_page_index | int | r/w | Haalt de index van de actieve pagina op of stelt deze in. |
...
| data_section | [AiDataSection](/psd/python-net/aspose.psd.fileformats.ai/aidatasection) | r | Haalt de gegevenssectie op. |
...
| file_format | [FileFormat](/psd/python-net/aspose.psd/fileformat) | r | Haalt een waarde voor bestandsformaat op. |
| finalize_section | [AiFinalizeSection](/psd/python-net/aspose.psd.fileformats.ai/aifinalizesection) | r | Haalt de finalisatie‑sectie op. |
| has_background_color | bool | r/w | Haalt of stelt een waarde in die aangeeft of de afbeelding een achtergrondkleur heeft. |
| header | [AiHeader](/psd/python-net/aspose.psd.fileformats.ai/aiheader) | r | Haalt de header op. |
...
| layers | [AiLayerSection[]](/psd/python-net/aspose.psd.fileformats.ai/ailayersection) | r | Haalt de laagsecties op. |
| page_count | int | r | Het aantal pagina's.<br/>            Voor afbeeldingen in het oude AI‑formaat is dit altijd gelijk aan 0. |
...
| setup_section | [AiSetupSection](/psd/python-net/aspose.psd.fileformats.ai/aisetupsection) | r | Haalt de setup‑sectie op. |
...
| version | [AiFormatVersion](/psd/python-net/aspose.psd.fileformats.ai/aiformatversion) | r | Haalt de versie van het Adobe Illustrator‑formaat op. |
| width | int | r | Haalt de breedte van de afbeelding op. |
| xmp_data | [XmpPacketWrapper](/psd/python-net/aspose.psd.xmp/xmppacketwrapper/) | r | Haalt de XMP-metadata op of stelt deze in. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Voegt de AI‑laagsectie toe. |
...
| [can_load(file_path)](#can_load_file_path_2) | Bepaalt of de afbeelding kan worden geladen vanaf het opgegeven bestandspad. |
| [can_load(file_path, load_options)](#can_load_file_path_load_options_3) | Bepaalt of de afbeelding kan worden geladen vanaf het opgegeven bestandspad en eventueel met de opgegeven openopties. |
| [can_load(stream)](#can_load_stream_4) | Bepaalt of de afbeelding kan worden geladen vanaf de opgegeven stream. |
| [can_load(stream, load_options)](#can_load_stream_load_options_5) | Bepaalt of de afbeelding kan worden geladen vanaf de opgegeven stream en eventueel met de opgegeven <paramref name="loadOptions" />. |
| [can_save(options)](#can_save_options_6) | Bepaalt of de afbeelding kan worden opgeslagen in het opgegeven bestandsformaat dat wordt weergegeven door de meegegeven opslagopties. |
| [create(image_options, width, height)](#create_image_options_width_height_7) | Maakt een nieuwe afbeelding aan met de opgegeven creatieopties. |
| [get_default_options(args)](#get_default_options_args_8) | Haalt de standaardopties op. |
| [get_file_format(file_path)](#get_file_format_file_path_9) | Haalt het bestandsformaat op. |
| [get_file_format(stream)](#get_file_format_stream_10) | Haalt het bestandsformaat op. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_11) | Haalt het rechthoek op dat past bij de huidige afbeelding. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_12) | Haalt het rechthoek op dat past bij de huidige afbeelding. |
| [get_original_options()](#get_original_options__13) | Haalt de opties op op basis van de oorspronkelijke bestandsinstellingen.<br/>            Dit kan nuttig zijn om de bitsdiepte en andere parameters van de oorspronkelijke afbeelding ongewijzigd te houden.<br/>            Bijvoorbeeld, als we een zwart-witte PNG-afbeelding met 1 bit per pixel laden en deze vervolgens opslaan met de<br/>            [DataStreamSupporter.save(file_path)](/psd/python-net/aspose.psd/datastreamsupporter/) methode, wordt een PNG-uitvoerafbeelding met 8 bits per pixel gegenereerd.<br/>            Om dit te voorkomen en een PNG-afbeelding met 1 bit per pixel op te slaan, gebruik deze methode om de bijbehorende opslagopties op te halen en ze<br/>            door te geven aan de [Image.save(file_path, options)](/psd/python-net/aspose.psd/image/) methode als tweede parameter. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_14) | Haalt een proportionele hoogte op. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_15) | Haalt een proportionele breedte op. |
| [load(file_path)](#load_file_path_16) | Laadt een nieuwe afbeelding vanuit het opgegeven bestand. |
| [load(file_path, load_options)](#load_file_path_load_options_17) | Laadt een nieuwe afbeelding vanuit het opgegeven bestand. |
| [load(stream)](#load_stream_18) | Laadt een nieuwe afbeelding vanuit de opgegeven stream. |
| [load(stream, load_options)](#load_stream_load_options_19) | Laadt een nieuwe afbeelding vanuit de opgegeven stream. |
| [resize(new_width, new_height)](#resize_new_width_new_height_20) | Wijzigt de grootte van de afbeelding. De standaard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/) wordt gebruikt. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_21) | Wijzigt de grootte van de afbeelding. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_22) | Wijzigt de grootte van de afbeelding. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_23) | Wijzigt de hoogte proportioneel. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_24) | Wijzigt de hoogte proportioneel. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_25) | Wijzigt de hoogte proportioneel. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_26) | Wijzigt de breedte proportioneel. De standaard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/) wordt gebruikt. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_27) | Wijzigt de breedte proportioneel. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_28) | Wijzigt de breedte proportioneel. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_29) | Roteert, spiegelt of roteert en spiegelt de afbeelding. |
| save() | Slaat de afbeeldingsgegevens op in de onderliggende stream. |
| [save(file_path)](#save_file_path_30) | Slaat de gegevens van het object op op de opgegeven bestandslocatie. |
| [save(file_path, options)](#save_file_path_options_31) | Slaat de gegevens van het object op op de opgegeven bestandslocatie in het opgegeven bestandsformaat volgens de opslagopties. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_32) | Slaat de gegevens van het object op op de opgegeven bestandslocatie in het opgegeven bestandsformaat volgens de opslagopties. |
| [save(file_path, over_write)](#save_file_path_over_write_33) | Slaat de gegevens van het object op op de opgegeven bestandslocatie. |
| [save(stream)](#save_stream_34) | Slaat de gegevens van het object op in de opgegeven stream. |
| [save(stream, options_base)](#save_stream_options_base_35) | Slaat de gegevens van de afbeelding op in de opgegeven stream in het opgegeven bestandsformaat volgens de opslagopties. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_36) | Slaat de gegevens van de afbeelding op in de opgegeven stream in het opgegeven bestandsformaat volgens de opslagopties. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_37) | Stelt het palet van de afbeelding in. |
...
Initialiseert een nieuw exemplaar van de AiImage klasse
...
Voegt de AI‑laagsectie toe.

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| layer | [AiLayerSection](/psd/python-net/aspose.psd.fileformats.ai/ailayersection) | De AI‑laagsectie. |
