...
type: docs
weight: 20
url: /nl/python-net/aspose.psd.exif/jpegexifdata/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [JpegExifData()](#JpegExifData__1) | Initialiseert een nieuw exemplaar van de [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) klasse. |
| [JpegExifData(common_tags, exif_tags, gps_tags)](#JpegExifData_common_tags_exif_tags_gps_tags_2) | Initialiseert een nieuw exemplaar van de [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) klasse met gegevens uit een array. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_3) | Initialiseert een nieuw exemplaar van de [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) klasse met gegevens uit een array. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschrijving** |
| :- | :- | :- | :- |
| MAX_EXIF_SEGMENT_SIZE [static] | int | r | De maximale EXIF-segmentgrootte in bytes die is toegestaan. |
...
| compression | ushort | r/w | Haalt de compressie op of stelt deze in. |
...
| date_time | string | r/w | Haalt op of stelt de datum en tijd in. |
...
| make | string | r/w | Haalt op of stelt de fabrikant van de opnameapparatuur in. |
...
| model | string | r/w | Haalt of stelt het model in. |
| oecf | byte | r/w | Krijgt of stelt de Opto-Electrische Conversiefunctie (OECF) gespecificeerd in ISO 14524 in. |
| orientation | [ExifOrientation](/psd/python-net/aspose.psd.exif.enums/exiforientation/) | r/w | Haalt of stelt de oriëntatie in. |
| photographic_sensitivity | uint | r/w | Krijgt of stelt de fotografische gevoeligheid in. |
| photometric_interpretation | ushort | r/w | Haalt of stelt de fotometrische interpretatie in. |
...
| planar_configuration | ushort | r/w | Haalt of stelt de planaire configuratie in. |
| primary_chromaticities | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Haalt of stelt de chromaticiteit van de drie primaire kleuren van de afbeelding in. |
...
| reference_black_white | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Haalt of stelt de referentie zwart-wit in. |
| related_sound_file | string | r/w | Haalt of stelt het gerelateerde geluidsbestand in. |
| resolution_unit | [ExifUnit](/psd/python-net/aspose.psd.exif.enums/exifunit/) | r/w | Haalt of stelt de resolutie‑eenheid in. |
| samples_per_pixel | ushort | r/w | Haalt of stelt de monsters per pixel in. |
...
| software | string | r/w | Haalt of stelt de software in. |
...
| thumbnail | [RasterImage](/psd/python-net/aspose.psd/rasterimage) | r/w | Haalt of stelt de miniatuurafbeelding in. |
| transfer_function | ushort | r/w | Haalt of stelt de overdrachtsfunctie in. |
...
| x_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Haalt op of stelt de x-resolutie in. |
| y_cb_cr_coefficients | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Haalt of stelt de matrixcoëfficiënten voor de transformatie van RGB naar YCbCr-beeldgegevens in. |
| y_cb_cr_positioning | [ExifYCbCrPositioning](/psd/python-net/aspose.psd.exif.enums/exifycbcrpositioning/) | r/w | Haalt of stelt de positie van chrominantiecomponenten ten opzichte van de luminantiecomponent in. |
| y_cb_cr_sub_sampling | ushort | r/w | Haalt of stelt de bemonsteringsratio van chrominantiecomponenten ten opzichte van de luminantiecomponent in. |
| y_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Haalt op of stelt de y-resolutie in. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
| [serialize_exif_data()](#serialize_exif_data__3) | Serialiseert de EXIF-gegevens. Schrijft de tagwaarden en -inhoud. De meest invloedrijke grootte-tag is de inhoud van de miniatuur-tag. |
...
Initialiseert een nieuw exemplaar van de [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) klasse.
...
Initialiseert een nieuw exemplaar van de [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) klasse met gegevens uit een array.
...
Serialiseert de EXIF-gegevens. Schrijft de tagwaarden en -inhoud. De meest invloedrijke grootte-tag is de inhoud van de miniatuur-tag.
