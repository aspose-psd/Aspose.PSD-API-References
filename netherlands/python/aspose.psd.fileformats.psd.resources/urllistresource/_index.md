...
type: docs
weight: 290
url: /nl/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | Initialiseert een nieuw exemplaar van de UrlListResource-klasse |
## **Properties**
...
| count | int | r/w | Haalt de count op of stelt deze in. |
...
| ids | int | r/w | Haalt of stelt de ids in. |
| longs | int | r/w | Haalt of stelt de longs in. |
...
| texts | string | r/w | Haalt of stelt de texts in. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
Initialiseert een nieuw exemplaar van de UrlListResource-klasse
