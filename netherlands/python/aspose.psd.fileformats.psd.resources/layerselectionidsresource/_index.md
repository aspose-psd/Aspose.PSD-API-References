...
type: docs
weight: 170
url: /nl/python-net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource__1) | Initialiseert een nieuw exemplaar van de LayerSelectionIdsResource klasse |
## **Properties**
...
| count | short | r/w | Haalt de count op of stelt deze in. |
...
| layer_ids | int | r/w | Haalt de layer ids op of stelt deze in. |
...
Initialiseert een nieuw exemplaar van de LayerSelectionIdsResource klasse
