...
type: docs
weight: 50
url: /nl/python-net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource__1) | Initialiseert een nieuw exemplaar van de ColorHalftoneInformationResource-klasse |
## **Properties**
...
| halftone_data | byte | r/w | Haalt of stelt de halftone-gegevens in. |
...
Initialiseert een nieuw exemplaar van de ColorHalftoneInformationResource-klasse
