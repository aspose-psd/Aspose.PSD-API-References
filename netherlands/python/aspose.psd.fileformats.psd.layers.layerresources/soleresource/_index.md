...
type: docs
weight: 940
url: /nl/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [SoLeResource()](#SoLeResource__1) | Initialiseert een nieuw exemplaar van de [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/) klasse. |
| [SoLeResource(unique_id, is_custom, has_comp_info)](#SoLeResource_unique_id_is_custom_has_comp_info_2) | Initialiseert een nieuw exemplaar van de [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/) klasse. |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | De type tool info-sleutel: 'SoLE'. |
...
Initialiseert een nieuw exemplaar van de [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/) klasse.
...
| :- | :- | :- |
| unique_id | Guid | De unieke identifier van de geplaatste laaggegevens [PlLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/). |
