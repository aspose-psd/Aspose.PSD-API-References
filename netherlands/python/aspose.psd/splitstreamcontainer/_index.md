...
type: docs
weight: 4220
url: /nl/python-net/aspose.psd/splitstreamcontainer/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [SplitStreamContainer(stream)](#SplitStreamContainer_stream_1) | Initialiseert een nieuw exemplaar van de [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/) klasse. |
| [SplitStreamContainer(stream, dispose_stream)](#SplitStreamContainer_stream_dispose_stream_2) | Initialiseert een nieuw exemplaar van de [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/) klasse. |
| [SplitStreamContainer(stream, dispose_stream)](#SplitStreamContainer_stream_dispose_stream_3) | Initialiseert een nieuw exemplaar van de [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/) klasse. |
## **Properties**
...
| [insert(position, stream, dispose_stream)](#insert_position_stream_dispose_stream_1) | Voegt de streamcontainer in op de opgegeven positie. |
| [read(buffer, offset, count)](#read_buffer_offset_count_2) | Leest een reeks bytes van de huidige stream en verschuift de positie binnen de stream met het aantal gelezen bytes. |
| [read(bytes)](#read_bytes_3) | Leest bytes om de opgegeven bytebuffer te vullen. |
| [read_byte()](#read_byte__4) | Leest een byte van de stream en verschuift de positie binnen de stream met één byte, of retourneert -1 als het einde van de stream is bereikt. |
| [save(destination_stream)](#save_destination_stream_5) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. Gebruikt de standaardbuffergrootte [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) en de waarde van stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_6) | Slaat (kopieert) alle gegevens van de stream op naar de opgegeven stream. Gebruikt de waarde van stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size, length)](#save_destination_stream_buffer_size_length_7) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. |
| [save(file_path)](#save_file_path_8) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. Gebruikt de standaardbuffergrootte [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) en de waarde van stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_9) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. Gebruikt de stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) waarde. |
| [save(file_path, buffer_size, length)](#save_file_path_buffer_size_length_10) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. |
| [seek(offset, origin)](#seek_offset_origin_11) | Stelt de positie binnen de huidige stream in. |
...
| [to_bytes()](#to_bytes__12) | Converteert de streamgegevens naar een int‑array. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_13) | Converteert de streamgegevens naar een int‑array. |
| [write(buffer, offset, count)](#write_buffer_offset_count_14) | Schrijft een reeks bytes naar de huidige stream en verplaatst de huidige positie binnen deze stream met het aantal geschreven bytes. |
| [write(bytes)](#write_bytes_15) | Schrijft alle opgegeven bytes naar de stream. |
| [write_byte(value)](#write_byte_value_16) | Schrijft een byte naar de huidige positie in de stream en verplaatst de positie binnen de stream met één byte. |
| [write_to(stream_container)](#write_to_stream_container_17) | Kopieert de ingesloten gegevens naar een andere [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [write_to(stream_container, length)](#write_to_stream_container_length_18) | Kopieert de ingesloten gegevens naar een andere [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
...
Initialiseert een nieuw exemplaar van de [SplitStreamContainer](/psd/python-net/aspose.psd/splitstreamcontainer/) klasse.
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| stream | [StreamContainer](/psd/python-net/aspose.psd/streamcontainer) | De gegevensstroom. |
| dispose_stream | bool | indien ingesteld op <c>true</c> wordt de stream verwijderd wanneer de container wordt verwijderd. |
...
| stream | [StreamContainer](/psd/python-net/aspose.psd/streamcontainer) | De streamcontainer om in te voegen. |
| dispose_stream | bool | indien ingesteld op <c>true</c> verwijdert de stream. |
...
| :- | :- | :- |
| destination_stream | _io.BufferedRandom | De stream waarin de gegevens moeten worden opgeslagen. |
| buffer_size | int | De buffer‑grootte. Standaard wordt de waarde ReadWriteBytesCount gebruikt. |
| length | long | De lengte van de streamgegevens om te kopiëren. Standaard is de lengte ingesteld op de waarde van [SplitStreamContainer.length](/psd/python-net/aspose.psd/splitstreamcontainer/). |
