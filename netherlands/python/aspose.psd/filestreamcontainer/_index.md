...
type: docs
weight: 1270
url: /nl/python-net/aspose.psd/filestreamcontainer/
---
...
| file_path | string | r | Haalt het bestandspad op. |
| is_created | bool | r | Haalt een waarde op die aangeeft of de stream expliciet is aangemaakt. |
| is_stream_disposed_on_close | bool | r | Haalt een waarde op die aangeeft of deze stream bij sluiten wordt vrijgegeven. |
| is_temporal | bool | r/w | Haalt een waarde op of stelt deze in die aangeeft of de stream tijdelijk is. |
...
| **Name** | **Beschrijving** |
| :- | :- |
| [create_file_stream(file_location, is_temporal)](#create_file_stream_file_location_is_temporal_1) | Maakt een nieuwe bestandsstroom aan. |
...
| [open_file_stream(file_location)](#open_file_stream_file_location_2) | Opent een bestaande bestandsstroom. Als de bestandsstroom niet bestaat, wordt de juiste uitzondering gegooid. |
| [read(buffer, offset, count)](#read_buffer_offset_count_3) | Leest een reeks bytes van de huidige stream en verschuift de positie binnen de stream met het aantal gelezen bytes. |
| [read(bytes)](#read_bytes_4) | Leest bytes om de opgegeven bytebuffer te vullen. |
| [read_byte()](#read_byte__5) | Leest een byte van de stream en verschuift de positie binnen de stream met één byte, of retourneert -1 als het einde van de stream is bereikt. |
| [save(destination_stream)](#save_destination_stream_6) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. Gebruikt de standaardbuffergrootte [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) en de waarde van stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_7) | Slaat (kopieert) alle gegevens van de stream op naar de opgegeven stream. Gebruikt de waarde van stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size, length)](#save_destination_stream_buffer_size_length_8) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. |
| [save(file_path)](#save_file_path_9) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. Gebruikt de standaardbuffergrootte [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) en de waarde van stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_10) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. Gebruikt de stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/) waarde. |
| [save(file_path, buffer_size, length)](#save_file_path_buffer_size_length_11) | Slaat (kopieert) de gegevens van de stream op naar de opgegeven stream. |
| [seek(offset, origin)](#seek_offset_origin_12) | Stelt de positie binnen de huidige stream in. |
...
| [to_bytes()](#to_bytes__13) | Converteert de streamgegevens naar een int‑array. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_14) | Converteert de streamgegevens naar een int‑array. |
| [write(buffer, offset, count)](#write_buffer_offset_count_15) | Schrijft een reeks bytes naar de huidige stream en verplaatst de huidige positie binnen deze stream met het aantal geschreven bytes. |
| [write(bytes)](#write_bytes_16) | Schrijft alle opgegeven bytes naar de stream. |
| [write_byte(value)](#write_byte_value_17) | Schrijft een byte naar de huidige positie in de stream en verplaatst de positie binnen de stream met één byte. |
| [write_to(stream_container)](#write_to_stream_container_18) | Kopieert de ingesloten gegevens naar een andere [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [write_to(stream_container, length)](#write_to_stream_container_length_19) | Kopieert de ingesloten gegevens naar een andere [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
...
| :- | :- | :- |
| file_location | string | De bestandslocatie. |
| is_temporal | bool | Als ingesteld op <c>true</c> is de bestandsstroomcontainer tijdelijk. |

**Returns**

| Type | Beschrijving |
| :- | :- |
| [FileStreamContainer](/psd/python-net/aspose.psd/filestreamcontainer) | De bestandsstroomcontainer. |
