...
type: docs
weight: 50
url: /nl/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [DoubleStructure(key_name)](#DoubleStructure_key_name_1) | Initialiseert een nieuw exemplaar van de [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) klasse. |
## **Properties**
...
| value | double | r/w | Haalt de double-waarde op of stelt deze in. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
Initialiseert een nieuw exemplaar van de [DoubleStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/) klasse.
