---
title: "AliasStructure klasse"
type: docs
weight: 10
url: /nl/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Initialiseert een nieuw exemplaar van de [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschrijving** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identificeert de structure key. |
| data_length | int | r | Haalt de exacte gegevenslengte in bytes op. |
| full_path | string | r/w | Haalt op of stelt het volledige pad in. |
...
Initialiseert een nieuw exemplaar van de [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) klasse.
