...
type: docs
weight: 90
url: /nl/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [ListStructure(key_name)](#ListStructure_key_name_1) | Initialiseert een nieuw exemplaar van de [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/) klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschrijving** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identificeert de structure key. |
| items_count | int | r | Haalt het aantal items op. |
...
| types | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | Haalt een kopie van een array van structuren op of stelt deze in. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
Initialiseert een nieuw exemplaar van de [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/) klasse.
