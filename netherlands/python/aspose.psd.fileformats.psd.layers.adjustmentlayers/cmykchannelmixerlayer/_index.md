---
title: "CmykChannelMixerLayer Klasse"
type: docs
weight: 50
url: /nl/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Haalt het zwarte kanaal op. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Haalt het cyaankanaal op. |
...
| left | int | r/w |  |
| lengte | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Haalt het magentakanaal op. |
| monochrome | bool | r/w | Haalt een waarde op of stelt deze in die aangeeft of deze [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) monochroom is. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Haalt het gele kanaal op. |
## **Methods**
| **Name** | **Beschrijving** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Haalt de index van het kanaal op. Retourneert CmykMixerChannel |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Voegt de laag samen met de opgegeven laag |
| normalize_angle() |  |
