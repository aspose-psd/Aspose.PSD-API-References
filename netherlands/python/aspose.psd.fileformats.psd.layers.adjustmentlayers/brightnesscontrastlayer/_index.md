...
type: docs
weight: 30
url: /nl/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| helderheid | int | r/w | Haalt of stelt de helderheid in. Voor PS is het bereik van helderheid van -150 tot +150. Maar we negeren dit. |
...
| contrast | int | r/w | Haalt of stelt het contrast in. Voor PS is het bereik van contrast van -50 tot +100. Maar we negeren dit. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | Laadt 32-bit ARGB-pixels gedeeltelijk (per blokken). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | Laadt ruwe gegevens. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | Voegt de laag samen met de opgegeven laag |
| normalize_angle() |  |
