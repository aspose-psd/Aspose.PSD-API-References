...
type: docs
weight: 100
url: /nl/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| disposed | bool | r |  |
| belichting | float | r/w | Haalt of stelt de belichting in. Voor PS is het bereik van belichting van -20 tot +20. |
| extra_length | int | r |  |
...
| gamma_correctie | float | r/w | Haalt of stelt de GammaCorrection in. Voor PS is het bereik van GammaCorrection van 9.99 tot +0.01 |
| has_alpha | bool | r |  |
...
| offset | float | r/w | Haalt of stelt de Offset in. Voor PS is het bereik van Offset van -0.5 tot +0.5 |
| opacity | byte | r/w |  |
