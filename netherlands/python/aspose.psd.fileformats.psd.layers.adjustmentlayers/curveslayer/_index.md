...
type: docs
weight: 90
url: /nl/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | r/w | Haalt een waarde op of stelt deze in die aangeeft of deze instantie een continue manager gebruikt. |
| is_discrete_manager_used | bool | r/w | Haalt een waarde op of stelt deze in die aangeeft of deze instantie een discrete manager gebruikt. |
...
| [get_curves_manager()](#get_curves_manager__8) | Haalt de curves manager op. |
