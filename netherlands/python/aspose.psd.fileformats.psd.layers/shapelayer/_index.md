---
title: "ShapeLayer Klasse"
type: docs
weight: 1600
url: /nl/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Beschrijving** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Initialiseert een nieuw exemplaar van de [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) klasse.<br/>            Alle bronnen worden aangemaakt in hun standaardstatus. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Haalt op of stelt vulinstellingen in voor het interne gebied van vormen in de Shape-laag. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Haalt de set van paden op die aanwezig is in een Shape-laag. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Haalt op of stelt strookinstellingen van vormen in. |
| boven | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Maakt een nieuw exemplaar van de [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) klasse. |
...
| update() | Werkt bronnen bij vanuit Shape-laag eigenschappen. |
...
Initialiseert een nieuw exemplaar van de [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) klasse.<br/>            Alle bronnen worden aangemaakt in hun standaardstatus.
...
Maakt een nieuw exemplaar van de [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) klasse.

**Returns**

| Type | Beschrijving |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Retourneert de nieuwe instantie van de [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) klasse. |
