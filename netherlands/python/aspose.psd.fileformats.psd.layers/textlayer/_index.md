---
title: "TextLayer Klasse"
type: docs
weight: 1750
url: /nl/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Haalt het lettertype op. |
| has_alpha | bool | r |  |
...
| inner_text | string | r | Haalt de tekst van de laag op |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Haalt de begrenzingsbox van de tekst op of stelt deze in. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Haalt de kleur van de tekst op. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Haalt de tekstgedeelten op. |
| boven | int | r/w |  |
| transform_matrix | double | r/w | Haalt de transformatie-matrix op of stelt deze in |
...
| [get_fonts()](#get_fonts__15) | Haalt de set lettertypen van de tekstlaag op. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_30) | Laadt 32-bit ARGB-pixels gedeeltelijk (per blokken). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_31) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_32) | Laadt ruwe gegevens. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Wijzigt de grootte van de afbeelding. De standaard [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) wordt gebruikt. |
...
| [update_text(text)](#update_text_text_38) | Werk de tekst bij. |
| [update_text(text, color)](#update_text_text_color_39) | Werk de tekst bij. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Werk de tekst bij. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Werk de tekst bij. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Werk de tekst bij. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Werk de tekst bij. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Werk de tekst bij. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Werk de tekst bij. |
...
| Type | Beschrijving |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | De set lettertypen van de tekstlaag. |
...
Wijzigt de grootte van de afbeelding. De standaard [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) wordt gebruikt.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Het type van de grootteaanpassingstransformatie [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | De tekstwaarde. |
| color | [Color](/psd/python-net/aspose.psd/color) | De kleurwaarde. |
...
| :- | :- | :- |
| text | string | De tekstwaarde. |
| font_size | float | Grootte van het lettertype. |
...
| :- | :- | :- |
| text | string | De tekstwaarde. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | De linkerbovencoördinaat. |
