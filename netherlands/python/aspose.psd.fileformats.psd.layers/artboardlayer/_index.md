---
title: "ArtboardLayer Klasse"
type: docs
weight: 90
url: /nl/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Geeft of stelt de artboard‑achtergrondkleur in. |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | Haalt een waarde op of stelt een waarde in die aangeeft of [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) de achtergrondkleur heeft. |
| has_transparent_color | bool | r/w |  |
| hoogte | int | r | <inheritdoc /> |
...
| is_cached | bool | r |  |
| is_open | bool | r/w | Geeft of stelt in of de map geopend is<br/>            als ingesteld op <c>true</c> dan zal de groep bij opstarten in de geopende toestand zijn, anders in de geminimaliseerde toestand. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Geeft de lagen in de laaggroep. |
| left | int | r/w | <inheritdoc /> |
| lengte | int | r |  |
...
| **Name** | **Beschrijving** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Voegt de laag toe aan de laaggroep. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Voegt de laaggroep toe. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Laadt 32-bit ARGB-pixels gedeeltelijk (per blokken). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Laadt ruwe gegevens. |
