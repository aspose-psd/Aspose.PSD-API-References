...
type: docs
weight: 10
url: /nl/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Haalt de vulinstellingen op of stelt ze in. |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | Haalt het type van de vulling op. |
| filler | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | Bouw een nieuw exemplaar van de [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) klasse op basis van het vultype. |
...
| update() | Werk de pixelgegevens van de vullaag bij op basis van de huidige [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
...
Bouw een nieuw exemplaar van de [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) klasse op basis van het vultype.

**Parameters:**

| Parameter | Type | Beschrijving |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | Het type vullaag. |

**Returns**

| Type | Beschrijving |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | Retourneert een nieuw exemplaar van de [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) klasse op basis van het vultype. |
