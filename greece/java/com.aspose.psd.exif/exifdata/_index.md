...
description: "Δοχείο δεδομένων EXIF."
type: docs
weight: 10
url: /el/java/com.aspose.psd.exif/exifdata/
---
...
Δοχείο δεδομένων EXIF.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ExifData()](#ExifData--) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ExifData . |
| [ExifData(TiffDataType[] exifdata)](#ExifData-com.aspose.psd.fileformats.tiff.TiffDataType---) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ExifData  με δεδομένα από πίνακα. |
| [ExifData(TiffDataType[] commonTags, TiffDataType[] exifTags, TiffDataType[] gpsTags)](#ExifData-com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---com.aspose.psd.fileformats.tiff.TiffDataType---) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ExifData  με δεδομένα από πίνακα. |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης  ExifData .
...
Αρχικοποιεί μια νέα παρουσία της κλάσης  ExifData  με δεδομένα από πίνακα.
