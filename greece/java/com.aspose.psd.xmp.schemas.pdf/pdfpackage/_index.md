...
description: "Αντιπροσωπεύει το χώρο ονομάτων Adobe Pdf."
type: docs
weight: 10
url: /el/java/com.aspose.psd.xmp.schemas.pdf/pdfpackage/
---
...
Αντιπροσωπεύει το χώρο ονομάτων Adobe Pdf.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PdfPackage()](#PdfPackage--) | Αρχικοποιεί μια νέα παρουσία της κλάσης PdfPackage. |
## Μέθοδοι
...
| [setKeywords(String keywords)](#setKeywords-java.lang.String-) | Ορίζει τις λέξεις-κλειδιά. |
| [setPdfVersion(String version)](#setPdfVersion-java.lang.String-) | Ορίζει την έκδοση Pdf. |
| [setProducer(String producer)](#setProducer-java.lang.String-) | Ορίζει το όνομα του εργαλείου που δημιούργησε το Pdf. |
| [setTrapped(boolean isTrapped)](#setTrapped-boolean-) | Ορίζει το trapped. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| keywords | java.lang.String | Οι λέξεις-κλειδιά. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| version | java.lang.String | Έκδοση Pdf, για παράδειγμα: 1.0, 1.3 κ.λπ. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| producer | java.lang.String | Το όνομα του παραγωγού. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| isTrapped | boolean | αν οριστεί σε  true  το έγγραφο έχει παγιδευτεί. |
