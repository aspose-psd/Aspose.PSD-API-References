...
description: "Καθορίζει μεμονωμένα κανάλια στον χρωματικό χώρο CMYK cyan magenta yellow black."
type: docs
weight: 22
url: /el/java/com.aspose.psd/colorchannelflag/
---
...
Καθορίζει μεμονωμένα κανάλια στον χρωματικό χώρο CMYK (cyan, magenta, yellow, black). Αυτή η απαρίθμηση χρησιμοποιείται από τις μεθόδους SetOutputChannel.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ColorChannelC](#ColorChannelC) | Το κανάλι χρώματος cyan. |
| [ColorChannelK](#ColorChannelK) | Το κανάλι χρώματος black. |
| [ColorChannelLast](#ColorChannelLast) | Το τελευταίο επιλεγμένο κανάλι πρέπει να χρησιμοποιηθεί. |
| [ColorChannelM](#ColorChannelM) | Το κανάλι χρώματος magenta. |
| [ColorChannelY](#ColorChannelY) | Το κανάλι χρώματος yellow. |
...
Το τελευταίο επιλεγμένο κανάλι πρέπει να χρησιμοποιηθεί.
