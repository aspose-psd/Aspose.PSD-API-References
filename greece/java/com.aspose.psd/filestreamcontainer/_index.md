...
description: "Βοηθός για την επεξεργασία ροής αρχείου"
type: docs
weight: 44
url: /el/java/com.aspose.psd/filestreamcontainer/
---
...
Βοηθός για την επεξεργασία ροής αρχείου
## Πεδία
...
| [createFileStream(String fileLocation, boolean isTemporal)](#createFileStream-java.lang.String-boolean-) | Δημιουργεί μια νέα ροή αρχείου. |
...
| [getFilePath()](#getFilePath--) | Λαμβάνει τη διαδρομή του αρχείου. |
...
| [hashCode()](#hashCode--) |  |
| [isCreated()](#isCreated--) | Λαμβάνει μια τιμή που υποδεικνύει εάν η ροή δημιουργήθηκε ρητά. |
...
| [isTemporal()](#isTemporal--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η ροή είναι προσωρινή. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [openFileStream(String fileLocation)](#openFileStream-java.lang.String-) | Ανοίγει μια υπάρχουσα ροή αρχείου. |
| [openFileStream_internalized(String fileLocation, boolean disposeDuplicatedStreams)](#openFileStream-internalized-java.lang.String-boolean-) | Ανοίγει μια υπάρχουσα ροή αρχείου. |
...
| [save(OutputStream destinationStream, int bufferSize, long length)](#save-java.io.OutputStream-int-long-) | Αποθηκεύει (αντιγράφει) τα δεδομένα της ροής στο καθορισμένο stream. |
...
| [setTemporal(boolean value)](#setTemporal-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η ροή είναι προσωρινή. |
...
| [toString()](#toString--) |  |
| [to_FileStream(FileStreamContainer fileStreamContainer)](#to-FileStream-com.aspose.psd.FileStreamContainer-) | Εκτελεί μια ρητή μετατροπή από [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) σε FileInputStream. |
...
| [to_Stream(FileStreamContainer fileStreamContainer)](#to-Stream-com.aspose.psd.FileStreamContainer-) | Εκτελεί μια ρητή μετατροπή από [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) σε java.io.InputStream. |
...
| --- | --- | --- |
| fileLocation | java.lang.String | Η θέση του αρχείου. |
| isTemporal | boolean | Εάν οριστεί σε  true  το δοχείο ροής αρχείου είναι προσωρινό. |
...
Λαμβάνει τη διαδρομή του αρχείου.

Τιμή: Η διαδρομή του αρχείου.
...
Τιμή:  true  εάν η ροή δημιουργήθηκε ρητά· διαφορετικά,  false .
...
Τιμή:  true  εάν η ροή είναι προσωρινή· διαφορετικά,  false .

--------------------

Μια προσωρινή ροή θα αφαιρεθεί μόλις διαγραφεί. Εάν η ροή βασίζεται στη μνήμη, αυτή η ιδιότητα δεν έχει καμία επίδραση. Η ροή μπορεί να επισημανθεί ως προσωρινή ή μόνιμη σε περίπτωση που δημιουργήθηκε ρητά, διαφορετικά θα εξαπολυθεί η κατάλληλη εξαίρεση.
...
Ανοίγει μια υπάρχουσα ροή αρχείου. Εάν η ροή αρχείου δεν υπάρχει, θα εξαπολυθεί η κατάλληλη εξαίρεση.
...
| --- | --- | --- |
| fileLocation | java.lang.String | Η θέση του αρχείου. |
| disposeDuplicatedStreams | boolean | Εάν οριστεί σε  true  διαγράφει τις διπλότυπες ροές. |
...
| origin | int | Μια τιμή τύπου  System.IO.SeekOrigin  που υποδεικνύει το σημείο αναφοράς που χρησιμοποιείται για την απόκτηση της νέας θέσης. |
...
Εκτελεί μια ρητή μετατροπή από [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) σε FileInputStream.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| fileStreamContainer | [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) | Το δοχείο ροής αρχείου. |

**Returns:**
java.io.FileInputStream - Το αποτέλεσμα της μετατροπής.
### to_FileStream_internalized(FileStreamContainer fileStreamContainer) {#to-FileStream-internalized-com.aspose.psd.FileStreamContainer-}
```
...
Εκτελεί μια ρητή μετατροπή από [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) σε java.io.InputStream.
...
**Returns:**
java.io.InputStream - Το αποτέλεσμα της μετατροπής.
