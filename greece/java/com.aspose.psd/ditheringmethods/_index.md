...
description: "Οι μέθοδοι dithering που χρησιμοποιούνται για τον έλεγχο της μετατροπής χρωμάτων"
type: docs
weight: 41
url: /el/java/com.aspose.psd/ditheringmethods/
---
...
Οι μέθοδοι dithering που χρησιμοποιούνται για τον έλεγχο της μετατροπής χρωμάτων
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [CustomConverter](#CustomConverter) | Ο προσαρμοσμένος μετατροπέας. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [PaletteConversion](#PaletteConversion) | Η παλέτα δεν αγνοείται και πρέπει να εφαρμοστεί σοφή μετατροπή χρώματος. |
| [PaletteIgnore](#PaletteIgnore) | Η παλέτα αγνοείται |
## Μέθοδοι
...
Η παλέτα δεν αγνοείται και πρέπει να εφαρμοστεί σοφή μετατροπή χρώματος.
