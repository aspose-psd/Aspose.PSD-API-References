...
description: "Καθορίζει τη σειρά για τις λειτουργίες μετασχηματισμού μήτρας."
type: docs
weight: 70
url: /el/java/com.aspose.psd/matrixorder/
---
...
Καθορίζει τη σειρά για τις λειτουργίες μετασχηματισμού μήτρας.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Append](#Append) | Η νέα λειτουργία εφαρμόζεται μετά την παλιά λειτουργία. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Prepend](#Prepend) | Η νέα λειτουργία εφαρμόζεται πριν την παλιά λειτουργία. |
## Μέθοδοι
...
Η νέα λειτουργία εφαρμόζεται μετά την παλιά λειτουργία.
...
Η νέα λειτουργία εφαρμόζεται πριν την παλιά λειτουργία.
