...
description: "Καθορίζει τον τύπο της εφαρμοζόμενης παραμόρφωσης."
type: docs
weight: 112
url: /el/java/com.aspose.psd/warpmode/
---
...
Καθορίζει τον τύπο της εφαρμοζόμενης παραμόρφωσης.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Bilinear](#Bilinear) | Καθορίζει μια διγραμμική παραμόρφωση. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Perspective](#Perspective) | Καθορίζει μια προοπτική παραμόρφωση. |
## Μέθοδοι
...
Καθορίζει μια διγραμμική παραμόρφωση.
...
Καθορίζει μια προοπτική παραμόρφωση.
