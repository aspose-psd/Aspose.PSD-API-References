...
description: "Μέθοδος σύγκρισης χρωμάτων για προσαρμογή στον πλησιέστερο γείτονα"
type: docs
weight: 23
url: /el/java/com.aspose.psd/colorcomparemethod/
---
...
Μέθοδος σύγκρισης χρωμάτων για προσαρμογή στον πλησιέστερο γείτονα
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Euclidian](#Euclidian) | Η ευκλείδεια μέθοδος |
## Μέθοδοι
