...
description: "Καθορίζει πώς γεμίζει το εσωτερικό ενός κλειστού μονοπατιού"
type: docs
weight: 45
url: /el/java/com.aspose.psd/fillmode/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [Alternate](#Alternate) | Καθορίζει τη εναλλακτική λειτουργία γεμίσματος. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Winding](#Winding) | Καθορίζει τη λειτουργία γεμίσματος περιδίνησης. |
## Μέθοδοι
...
Καθορίζει τη εναλλακτική λειτουργία γεμίσματος.
...
Καθορίζει τη λειτουργία γεμίσματος περιδίνησης.
