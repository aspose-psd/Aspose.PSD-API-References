...
description: "Αναφορά συνάρτησης διαχειριστή συμβάντος προόδου"
type: docs
weight: 84
url: /el/java/com.aspose.psd/progresseventhandler/
---
...
Αναφορά συνάρτησης διαχειριστή συμβάντος προόδου
## Κατασκευαστές
...
| [hashCode()](#hashCode--) |  |
| [invoke(ProgressEventHandlerInfo info)](#invoke-com.aspose.psd.progressmanagement.ProgressEventHandlerInfo-) | Αναφορά συνάρτησης διαχειριστή συμβάντος προόδου |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| info | [ProgressEventHandlerInfo](../../com.aspose.psd.progressmanagement/progresseventhandlerinfo) | Τα δεδομένα του χειριστή συμβάντος προόδου. |
