...
description: "Μέθοδος dithering"
type: docs
weight: 40
url: /el/java/com.aspose.psd/ditheringmethod/
---
...
| [FloydSteinbergDithering](#FloydSteinbergDithering) | Η διαβάθμιση Floyd-Steinberg. |
| [ThresholdDithering](#ThresholdDithering) | Διαβάθμιση κατωφλίου. |
## Μέθοδοι
...
Η διασπορά Floyd‑Steinberg. Ένας πιο σύνθετος αλγόριθμος διασποράς, χρησιμοποιεί τιμές έντασης των κοντινότερων γειτόνων.
...
Διασπορά κατωφλίου. Ο πιο απλός και γρήγορος αλγόριθμος διασποράς.
