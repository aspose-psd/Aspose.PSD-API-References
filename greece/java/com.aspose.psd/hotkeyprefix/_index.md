...
description: "Καθορίζει τον τύπο εμφάνισης των προθεμάτων πλήκτρων συντόμευσης που σχετίζονται με το κείμενο"
type: docs
weight: 53
url: /el/java/com.aspose.psd/hotkeyprefix/
---
...
Καθορίζει τον τύπο εμφάνισης των προθεμάτων πλήκτρων συντόμευσης που σχετίζονται με το κείμενο
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Hide](#Hide) | Να μην εμφανίζεται το πρόθεμα συντόμευσης. |
| [None](#None) | Χωρίς πρόθεμα συντόμευσης. |
| [Show](#Show) | Να εμφανίζεται το πρόθεμα συντόμευσης. |
## Μέθοδοι
...
Να μην εμφανίζεται το πρόθεμα συντόμευσης.
...
Να εμφανίζεται το πρόθεμα συντόμευσης.
