...
description: "Παρέχει τα πεδία που αντιπροσωπεύουν σημεία αναφοράς στο StreamContainer για την αναζήτηση."
type: docs
weight: 95
url: /el/java/com.aspose.psd/seekorigin/
---
...
Παρέχει τα πεδία που αντιπροσωπεύουν σημεία αναφοράς στο  StreamContainer  για αναζήτηση.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Begin](#Begin) | Καθορίζει την αρχή ενός stream. |
| [Current](#Current) | Καθορίζει την τρέχουσα θέση μέσα σε ένα stream. |
| [End](#End) | Καθορίζει το τέλος ενός stream. |
...
Καθορίζει την αρχή ενός stream.
...
Καθορίζει την τρέχουσα θέση μέσα σε ένα stream.
...
Καθορίζει το τέλος ενός stream.
