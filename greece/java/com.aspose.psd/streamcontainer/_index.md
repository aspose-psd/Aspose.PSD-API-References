...
description: "Αντιπροσωπεύει το δοχείο ροής που περιέχει τη ροή και παρέχει ρουτίνες επεξεργασίας ροής."
type: docs
weight: 103
url: /el/java/com.aspose.psd/streamcontainer/
---
...
Αντιπροσωπεύει το δοχείο ροής που περιέχει τη ροή και παρέχει ρουτίνες επεξεργασίας ροής.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [StreamContainer(InputStream stream)](#StreamContainer-java.io.InputStream-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης  StreamContainer . |
| [StreamContainer(System.IO.Stream stream)](#StreamContainer-com.aspose.ms.System.IO.Stream-) |  |
| [StreamContainer(InputStream stream, boolean disposeStream)](#StreamContainer-java.io.InputStream-boolean-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης  StreamContainer . |
