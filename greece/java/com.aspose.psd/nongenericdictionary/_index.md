...
description: "Αντιπροσωπεύει ένα μη γενικό λεξικό."
type: docs
weight: 72
url: /el/java/com.aspose.psd/nongenericdictionary/
---
...
Αντιπροσωπεύει ένα μη γενικό λεξικό.
## Κατασκευαστές
...
| [getKeys()](#getKeys--) |  |
| [getKeysTyped()](#getKeysTyped--) | Λαμβάνει τη συλλογή κλειδιών με ισχυρό τύπο. |
| [getSyncRoot()](#getSyncRoot--) |  |
| [getValues()](#getValues--) |  |
| [getValuesTyped()](#getValuesTyped--) | Λαμβάνει τη συλλογή τιμών με ισχυρό τύπο. |
...
Λαμβάνει τη συλλογή κλειδιών με ισχυρό τύπο.

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<K> - Η συλλογή κλειδιών με ισχυρό τύπο.
### getSyncRoot() {#getSyncRoot--}
```
...
Λαμβάνει τη συλλογή τιμών με ισχυρό τύπο.

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<V> - Η συλλογή τιμών με ισχυρό τύπο.
### get_Item(TKey arg0) {#get-Item-TKey-}
```
