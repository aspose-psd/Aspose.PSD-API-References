...
description: "Καθορίζει τον τύπο κρυφής μνήμης που θα χρησιμοποιηθεί."
type: docs
weight: 15
url: /el/java/com.aspose.psd/cachetype/
---
...
Καθορίζει τον τύπο κρυφής μνήμης που θα χρησιμοποιηθεί.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Auto](#Auto) | Καθορίζει τον τύπο αυτόματης προσωρινής μνήμης. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Μόνο η προσωρινή μνήμη στη μνήμη. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Μόνο η προσωρινή μνήμη στο δίσκο. |
...
Καθορίζει τον τύπο αυτόματης προσωρινής μνήμης. Το σχήμα αυτόματης προσωρινής μνήμης θα προσπαθήσει να αποθηκεύσει πρώτα στη μνήμη και στη συνέχεια στο δίσκο.
...
Μόνο η προσωρινή μνήμη στη μνήμη.
...
Μόνο η προσωρινή μνήμη στο δίσκο.
