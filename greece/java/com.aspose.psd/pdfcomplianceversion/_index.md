...
description: "Καθορίζει το επίπεδο συμμόρφωσης PDF για το αρχείο εξόδου."
type: docs
weight: 76
url: /el/java/com.aspose.psd/pdfcomplianceversion/
---
...
| [Pdf15](#Pdf15) | Το αρχείο εξόδου θα είναι συμβατό με PDF 1.5. |
| [PdfA1a](#PdfA1a) | Το αρχείο εξόδου θα είναι συμβατό με PDF/A-1a. |
| [PdfA1b](#PdfA1b) | Το αρχείο εξόδου θα είναι συμβατό με PDF/A-1b. |
## Μέθοδοι
...
Το αρχείο εξόδου θα είναι συμβατό με PDF 1.5.
...
Το αρχείο εξόδου θα είναι συμβατό με PDF/A-1a.
...
Το αρχείο εξόδου θα είναι συμβατό με PDF/A-1b.
