...
type: docs
weight: 85
url: /el/java/com.aspose.psd/rastercachedimage/
---
...
Αντιπροσωπεύει μια raster εικόνα που υποστηρίζει λειτουργίες raster γραφικών. Αυτή η εικόνα αποθηκεύει στην κρυφή μνήμη τα δεδομένα των εικονοστοιχείων όταν απαιτείται.
## Πεδία
