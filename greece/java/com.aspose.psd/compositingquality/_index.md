...
type: docs
weight: 32
url: /el/java/com.aspose.psd/compositingquality/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [AssumeLinear](#AssumeLinear) | Υποθέστε γραμμικές τιμές. |
| [Default](#Default) | Προεπιλεγμένη ποιότητα. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GammaCorrected](#GammaCorrected) | Χρησιμοποιείται διόρθωση γάμμα. |
| [HighQuality](#HighQuality) | Υψηλή ποιότητα, χαμηλή ταχύτητα σύνθεσης. |
| [HighSpeed](#HighSpeed) | Υψηλή ταχύτητα, χαμηλή ποιότητα. |
| [Invalid](#Invalid) | Μη έγκυρη ποιότητα. |
## Μέθοδοι
...
Χρησιμοποιείται διόρθωση γάμμα.
...
Υψηλή ποιότητα, χαμηλή ταχύτητα σύνθεσης.
...
Υψηλή ταχύτητα, χαμηλή ποιότητα.
