...
description: "Αναπαριστά τη βασική αφαίρεση για το πακέτο XMP."
type: docs
weight: 18
url: /el/java/com.aspose.psd.xmp/xmppackage/
---
...
Αναπαριστά τη βασική αφαίρεση για το πακέτο XMP.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [XmpPackage(String prefix, String namespaceUri)](#XmpPackage-java.lang.String-java.lang.String-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης XmpPackage. |
## Μέθοδοι
...
| [addValue(String key, String value)](#addValue-java.lang.String-java.lang.String-) | Προσθέτει την τιμή. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης XmpPackage.
...
| τιμή | java.lang.String | Η τιμή προς προσθήκη. |
