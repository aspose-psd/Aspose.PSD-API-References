...
description: "Αναπαριστά τον τύπο πίνακα στο XmpArray."
type: docs
weight: 14
url: /el/java/com.aspose.psd.xmp/xmparraytype/
---
...
Αναπαριστά τον τύπο πίνακα στο XmpArray.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ALTERNATIVE](#ALTERNATIVE) | Ο εναλλακτικός πίνακας. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ORDERED](#ORDERED) | Ο διατεταγμένος πίνακας. |
| [UNORDERED](#UNORDERED) | Ο αδιάτακτος πίνακας. |
## Μέθοδοι
