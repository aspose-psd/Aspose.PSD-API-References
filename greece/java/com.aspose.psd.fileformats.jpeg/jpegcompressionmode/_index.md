...
description: "Λειτουργία συμπίεσης για εικόνες jpeg."
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.jpeg/jpegcompressionmode/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [Baseline](#Baseline) | Η βασική συμπίεση. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [JpegLs](#JpegLs) | Η συμπίεση JPEG-LS. |
| [Lossless](#Lossless) | Η μη απωλεστική συμπίεση. |
| [Progressive](#Progressive) | Η προοδευτική συμπίεση. |
## Μέθοδοι
