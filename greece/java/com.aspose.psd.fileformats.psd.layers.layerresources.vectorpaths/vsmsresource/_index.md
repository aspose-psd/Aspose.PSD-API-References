...
description: "Κλάση VsmsResource."
type: docs
weight: 29
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
Κλάση VsmsResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με τη μάσκα διανυσματικού στρώματος.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
| [VsmsResource()](#VsmsResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource).
