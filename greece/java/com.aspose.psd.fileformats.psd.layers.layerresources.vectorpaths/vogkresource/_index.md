...
description: "Ο πόρος Vector Origination Data."
type: docs
weight: 28
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| --- | --- |
| [VogkResource()](#VogkResource--) | Αρχικοποιεί ένα νέο παράδειγμα της [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) κλάσης. |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | Το κλειδί περιγραφέα για την αποθήκευση των ρυθμίσεων προέλευσης σχήματος. |
...
| [getItems_internalized()](#getItems-internalized--) | Λαμβάνει ή ορίζει τα στοιχεία της δομής. |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | Λαμβάνει ή ορίζει τις ρυθμίσεις προέλευσης σχήματος. |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | Λαμβάνει ή ορίζει τις ρυθμίσεις προέλευσης σχήματος. |
...
Αρχικοποιεί ένα νέο παράδειγμα της [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource) κλάσης.
...
Το κλειδί περιγραφέα για την αποθήκευση των ρυθμίσεων προέλευσης σχήματος.
