...
description: "Κλάση VectorPathDataResource."
type: docs
weight: 19
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathdataresource/
---
...
Κλάση VectorPathDataResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με τη μάσκα του διανυσματικού στρώματος.
## Πεδία
