...
description: "Οι λειτουργίες για τα σχήματα διαδρομής που συνδυάζουν λογικές λειτουργίες."
type: docs
weight: 15
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [CombineShapes](#CombineShapes) | Συνδυάστε Σχήματα (λειτουργία OR). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | Εξαίρεση Αλληλοεπικαλυπτόμενων Σχημάτων (λειτουργία XOR). |
| [IntersectShapeAreas](#IntersectShapeAreas) | Διατομή Περιοχών Σχημάτων (λειτουργία AND). |
| [SubtractFrontShape](#SubtractFrontShape) | Αφαίρεση Μπροστινού Σχήματος (λειτουργία NOT). |
## Μέθοδοι
...
Συνδυάστε Σχήματα (λειτουργία OR). Αυτή είναι η προεπιλεγμένη τιμή στο Photoshop.
...
Εξαίρεση Αλληλοεπικαλυπτόμενων Σχημάτων (λειτουργία XOR).
...
Διατομή Περιοχών Σχημάτων (λειτουργία AND).
...
Αφαίρεση Μπροστινού Σχήματος (λειτουργία NOT).
