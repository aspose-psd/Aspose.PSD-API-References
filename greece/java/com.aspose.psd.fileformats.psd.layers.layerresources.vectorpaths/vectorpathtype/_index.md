...
description: "Vector Path Type σύμφωνα με την προδιαγραφή μορφής PSD"
type: docs
weight: 22
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
Vector Path Type σύμφωνα με την προδιαγραφή μορφής PSD
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ClipboardRecord](#ClipboardRecord) | Η εγγραφή πρόχειρου |
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | Η κλειστή υποδιαδρομή κόμβος Bezier συνδεδεμένος |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | Η κλειστή υποδιαδρομή κόμβος Bezier αποσυνδεδεμένος |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | Η εγγραφή μήκους κλειστής υποδιαδρομής |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | Η εγγραφή αρχικού κανόνα γεμίσματος |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | Η ανοιχτή υποδιαδρομή κόμβος Bezier συνδεδεμένος |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | Η ανοιχτή υποδιαδρομή κόμβος Bezier αποσυνδεδεμένος |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | Η εγγραφή μήκους ανοιχτής υποδιαδρομής |
| [PathFillRuleRecord](#PathFillRuleRecord) | Η εγγραφή κανόνα γεμίσματος διαδρομής |
## Μέθοδοι
...
Η κλειστή υποδιαδρομή κόμβος Bezier συνδεδεμένος
...
Η κλειστή υποδιαδρομή κόμβος Bezier αποσυνδεδεμένος
...
Η εγγραφή μήκους κλειστής υποδιαδρομής
...
Η εγγραφή αρχικού κανόνα γεμίσματος
...
Η ανοιχτή υποδιαδρομή κόμβος Bezier συνδεδεμένος
...
Η ανοιχτή υποδιαδρομή κόμβος Bezier αποσυνδεδεμένος
...
Η εγγραφή μήκους ανοιχτής υποδιαδρομής
...
Η εγγραφή κανόνα γεμίσματος διαδρομής
