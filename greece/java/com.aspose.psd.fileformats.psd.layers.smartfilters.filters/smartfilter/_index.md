...
description: "Η κλάση για την επεξεργασία της βασικής λογικής των έξυπνων φίλτρων."
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter/
---
...
| --- | --- |
| [SmartFilter()](#SmartFilter--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [SmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/smartfilter).
