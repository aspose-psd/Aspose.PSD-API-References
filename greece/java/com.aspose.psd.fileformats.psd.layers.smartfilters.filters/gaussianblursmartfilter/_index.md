...
description: "Το έξυπνο φίλτρο GaussianBlur."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter/
---
...
| --- | --- |
| [GaussianBlurSmartFilter()](#GaussianBlurSmartFilter--) | Αρχικοποιεί μια νέα παρουσία της [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter) class. |
## Πεδία
...
| [getRadius()](#getRadius--) | Λαμβάνει ή ορίζει την ακτίνα του gaussian smart filter. |
...
| [setRadius(double value)](#setRadius-double-) | Λαμβάνει ή ορίζει την ακτίνα του gaussian smart filter. |
...
Αρχικοποιεί μια νέα παρουσία της [GaussianBlurSmartFilter](../../com.aspose.psd.fileformats.psd.layers.smartfilters.filters/gaussianblursmartfilter) class.
...
Λαμβάνει ή ορίζει την ακτίνα του gaussian smart filter.
