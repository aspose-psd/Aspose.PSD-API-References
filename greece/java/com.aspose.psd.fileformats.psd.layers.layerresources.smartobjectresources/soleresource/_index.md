...
description: "Ορίζει την κλάση SoLeResource που περιέχει πληροφορίες σχετικά με ένα στρώμα έξυπνου αντικειμένου σε αρχείο PSD."
type: docs
weight: 16
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource/
---
...
Ορίζει την κλάση SoLeResource που περιέχει πληροφορίες για ένα στρώμα έξυπνου αντικειμένου σε αρχείο PSD. Χρησιμοποιείται για την υποστήριξη στρωμάτων έξυπνου αντικειμένου με εξωτερικούς συνδέσμους αρχείων στις εικόνες Adobe\ufffd Photoshop\ufffd.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [SoLeResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLeResource-java.util.UUID-boolean-boolean-) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource). |
| [SoLeResource()](#SoLeResource--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource). |
## Πεδία
...
| [TypeToolKey](#TypeToolKey) | Το κλειδί πληροφοριών του εργαλείου τύπου: 'SoLE'. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| uniqueId | java.util.UUID | Το μοναδικό αναγνωριστικό των δεδομένων του τοποθετημένου στρώματος [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
