...
description: "Ορίζει την κλάση PlLdResource που περιέχει πληροφορίες σχετικά με ένα τοποθετημένο στρώμα στο αρχείο PSD."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource/
---
...
Ορίζει την κλάση PlLdResource που περιέχει πληροφορίες για ένα τοποθετημένο στρώμα στο αρχείο PSD. Χρησιμοποιείται για την υποστήριξη στρωμάτων έξυπνου αντικειμένου στις εικόνες Adobe® Photoshop®. Αντικαταστάθηκε από την SoLdResource στο Adobe® Photoshop® CS3.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PlLdResource()](#PlLdResource--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
## Πεδία
...
| [getLength()](#getLength--) | Λαμβάνει το μήκος του πόρου PlLd σε bytes. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Αποθηκεύει τον πόρο PlLD στο καθορισμένο κοντέινερ ροής. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). Αυτός ο προεπιλεγμένος κατασκευαστής έχει σχεδιαστεί για χρήση από το PlLdResourceLoader. Χρησιμοποιήστε το [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) για τη δημιουργία κλάσεων PlLdResource.
...
Λαμβάνει το μήκος του πόρου PlLd σε bytes.
