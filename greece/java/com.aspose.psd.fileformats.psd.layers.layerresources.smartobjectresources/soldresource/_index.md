...
description: "Ορίζει την κλάση SoLdResource που περιέχει πληροφορίες σχετικά με ένα στρώμα έξυπνου αντικειμένου σε αρχείο PSD."
type: docs
weight: 15
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
Ορίζει την κλάση SoLdResource που περιέχει πληροφορίες σχετικά με ένα έξυπνο αντικείμενο στρώματος σε αρχείο PSD. Χρησιμοποιείται για την υποστήριξη εξυπνων αντικειμένων στρωμάτων στις εικόνες Adobe® Photoshop®.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## Πεδία
...
| [TypeToolKey](#TypeToolKey) | Το κλειδί πληροφοριών εργαλείου τύπου: 'SoLd'. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Είναι απαραίτητο να οριστεί η ιδιότητα Items ή να κληθεί η μέθοδος InitializeItems() για να ληφθεί ένα έτοιμο παράδειγμα. Αυτός ο κατασκευαστής έχει σχεδιαστεί για χρήση από το [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) και σε μονάδες δοκιμών. Χρησιμοποιήστε το [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) για τη δημιουργία κλάσεων SoLdResource.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| uniqueId | java.util.UUID | Το μοναδικό αναγνωριστικό των δεδομένων του έξυπνου αντικειμένου στρώματος [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| isCustom | boolean | αν οριστεί σε  true  [είναι προσαρμοσμένο]. |
| hasCompInfo | boolean | αν οριστεί σε  true  [έχει πληροφορίες συνιστώσας]. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Αυτός ο προεπιλεγμένος κατασκευαστής έχει σχεδιαστεί για χρήση από το SoLdResourceLoader. Χρησιμοποιήστε το [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) για τη δημιουργία κλάσεων SoLdResource.
...
Το κλειδί πληροφοριών εργαλείου τύπου: 'SoLd'.
