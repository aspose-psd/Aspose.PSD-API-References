...
description: "Τύποι περιστροφής παραμόρφωσης"
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.warp.structs/warprotates/
---
...
Τύποι περιστροφής παραμόρφωσης
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Horizontal](#Horizontal) | Οριζόντια κατεύθυνση παραμόρφωσης |
| [Vertical](#Vertical) | Κατακόρυφη κατεύθυνση παραμόρφωσης |
## Μέθοδοι
...
Οριζόντια κατεύθυνση παραμόρφωσης
...
Κατακόρυφη κατεύθυνση παραμόρφωσης
