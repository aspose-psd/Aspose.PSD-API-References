...
description: "Αντιπροσωπεύει το χώρο ονομάτων XMP Rights Management."
type: docs
weight: 10
url: /el/java/com.aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/
---
...
Αντιπροσωπεύει το χώρο ονομάτων XMP Rights Management.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [XmpRightsManagementPackage()](#XmpRightsManagementPackage--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης XmpRightsManagementPackage. |
## Μέθοδοι
...
| [setCertificate(String certificate)](#setCertificate-java.lang.String-) | Ορίζει το πιστοποιητικό. |
| [setMarkedAsRightManagement(boolean value)](#setMarkedAsRightManagement-boolean-) | Σημειώνει ως περιεχόμενο διαχείρισης δικαιωμάτων |
| [setOwners(String[] owners)](#setOwners-java.lang.String---) | Ορίζει ιδιοκτήτες. |
| [setUsageTerms(LangAlt usageTerms)](#setUsageTerms-com.aspose.psd.xmp.LangAlt-) | Ορίζει τους όρους χρήσης. |
| [setValue(String key, IXmlValue value)](#setValue-java.lang.String-com.aspose.psd.xmp.IXmlValue-) | Ορίζει την τιμή. |
| [setWebStatement(String webStatementUrl)](#setWebStatement-java.lang.String-) | Ορίζει τη διαδικτυακή δήλωση. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης XmpRightsManagementPackage.
...
Ορίζει το πιστοποιητικό.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| πιστοποιητικό | java.lang.String | Το πιστοποιητικό. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | boolean | αν οριστεί σε  true  ότι αυτό είναι ένα πόρο με διαχείριση δικαιωμάτων. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| ιδιοκτήτες | java.lang.String[] | Οι ιδιοκτήτες. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| usageTerms | [LangAlt](../../com.aspose.psd.xmp/langalt) | Οι όροι χρήσης. |
...
Ορίζει τη διαδικτυακή δήλωση.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| webStatementUrl | java.lang.String | Το URL της διαδικτυακής δήλωσης. |
