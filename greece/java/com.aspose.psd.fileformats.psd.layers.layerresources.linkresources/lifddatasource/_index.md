...
description: "Ορίζει την κλάση πηγής δεδομένων liFD στο αρχείο PSD που περιέχει πληροφορίες για ένα ενσωματωμένο αρχείο."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
Ορίζει την κλάση πηγής δεδομένων liFD στο αρχείο PSD που περιέχει πληροφορίες για ένα ενσωματωμένο αρχείο. Αυτό αποτελεί μέρος του API Διαχείρισης Μορφής Αρχείου PSD που βοηθά στην τροποποίηση των αρχείων Adobe® Photoshop®.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.lifddatasource). |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.lifddatasource). |
## Πεδία
...
| [getData()](#getData--) | Λαμβάνει ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου στο αρχείο PSD. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | Λαμβάνει το μήκος των ενσωματωμένων δεδομένων. |
...
| [setData(byte[] value)](#setData-byte---) | Λαμβάνει ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου στο αρχείο PSD. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.lifddatasource).
...
Λαμβάνει ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου στο αρχείο PSD.

Τιμή: Τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου.
...
Λαμβάνει το μήκος των ενσωματωμένων δεδομένων.

Τιμή: Το μήκος των ενσωματωμένων δεδομένων.
