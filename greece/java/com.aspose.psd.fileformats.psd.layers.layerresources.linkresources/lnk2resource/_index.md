...
description: "Ορίζει την κλάση που περιέχει πληροφορίες για ενσωματωμένα αρχεία στην εικόνα μορφής PSD."
type: docs
weight: 15
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
Ορίζει την κλάση που περιέχει πληροφορίες σχετικά με ενσωματωμένα αρχεία στην εικόνα μορφής PSD. Ο πόρος συνδέσμου μπορεί να περιέχει αρκετές  LiFdDataSource  εμφανίσεις που μπορούν να προσπελαστούν μέσω του δεικτή.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) class. |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) class.
