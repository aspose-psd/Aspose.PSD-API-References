...
description: "Ορίζει την κλάση LnkeResource που περιέχει πληροφορίες για εξωτερικά συνδεδεμένα αρχεία ή περιουσιακά στοιχεία στην εικόνα μορφής PSD."
type: docs
weight: 17
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Ορίζει την κλάση LnkeResource που περιέχει πληροφορίες σχετικά με εξωτερικά συνδεδεμένα αρχεία ή πόρους στην εικόνα μορφής PSD. Ο πόρος συνδέσμου μπορεί να περιέχει αρκετές [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) εμφανίσεις που μπορούν να προσπελαστούν μέσω δεικτή. Αυτό είναι μέρος του API Διαχείρισης Μορφής Αρχείου PSD που βοηθά στην προγραμματιστική τροποποίηση αρχείων Adobe® Photoshop®.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) class. |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) class. |
## Πεδία
...
| [get_Item(int index)](#get-Item-int-) | Λαμβάνει το [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) στον καθορισμένο δείκτη. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) class.
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Οι πηγές δεδομένων. |
...
Λαμβάνει το [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) στον καθορισμένο δείκτη.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Ο δείκτης. Τιμή: Η [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). |
