...
description: "Ορίζει την κλάση LinkResource που περιέχει πληροφορίες για συνδεδεμένα ή ενσωματωμένα αρχεία στην εικόνα μορφής PSD."
type: docs
weight: 14
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
Ορίζει την κλάση LinkResource που περιέχει πληροφορίες σχετικά με συνδεδεμένα ή ενσωματωμένα αρχεία στην εικόνα μορφής PSD. Ο πόρος συνδέσμου μπορεί να περιέχει αρκετές [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) εμφανίσεις που μπορούν να προσπελαστούν μέσω δεικτών σε οποιαδήποτε παράγωγη κλάση.
## Πεδία
...
| [get_Item(int index)](#get-Item-int-) | Λαμβάνει το [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) στον καθορισμένο δείκτη. |
...
Λαμβάνει το [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) στον καθορισμένο δείκτη.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Ο ακέραιος δείκτης. Τιμή: Η [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
