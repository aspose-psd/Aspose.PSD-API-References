...
description: "Η δομή class."
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Αρχικοποιεί μια νέα παρουσία της [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) class. |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Αναγνωρίζει το κλειδί της δομής. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Αναγνωρίζει το κλειδί της δομής. |
| [StructureKeyType](#StructureKeyType) | Αναγνωρίζει το κλειδί της δομής. |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure) class.
...
| structureKey | int | Το κλειδί της δομής. |
