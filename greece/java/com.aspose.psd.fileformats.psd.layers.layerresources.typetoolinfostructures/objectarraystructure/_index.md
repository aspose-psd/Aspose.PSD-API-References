...
description: "Ορίζει την κλάση ObjectArrayStructure που συνήθως περιέχει έναν πίνακα."
type: docs
weight: 20
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Ορίζει την κλάση ObjectArrayStructure που συνήθως περιέχει τον πίνακα [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) . Χρησιμοποιείται στους πόρους αρχείων PSD, όπως οι πόροι PlLd και SoLd.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) . |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) . |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [StructureKey](#StructureKey) | Αναγνωρίζει το κλειδί δομής 'ObAr'. |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Αποκτά ή ορίζει το class ID του πίνακα αντικειμένων. |
| [getClassName()](#getClassName--) | Αποκτά ή ορίζει το class name του πίνακα αντικειμένων. |
...
| [getKey()](#getKey--) | Αποκτά το κλειδί δομής του πίνακα αντικειμένων. |
...
| [getStructureCount()](#getStructureCount--) | Αποκτά τον αριθμό υποδομών του πίνακα αντικειμένων. |
| [getStructures()](#getStructures--) | Αποκτά ή ορίζει τις υποδομές στη δομή του πίνακα αντικειμένων. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αποκτά ή ορίζει το class ID του πίνακα αντικειμένων. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Αποκτά ή ορίζει το class name του πίνακα αντικειμένων. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Αποκτά ή ορίζει τις υποδομές στη δομή του πίνακα αντικειμένων. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) .

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| keyName | java.lang.String | Όνομα του κλειδιού. |
| classIdName | java.lang.String | Όνομα του αναγνωριστικού κλάσης. |
...
Αναγνωρίζει το κλειδί δομής 'ObAr'.
...
Αποκτά ή ορίζει το class ID του πίνακα αντικειμένων.

Τιμή: Το class ID του πίνακα αντικειμένων.
...
Αποκτά ή ορίζει το class name του πίνακα αντικειμένων.

Τιμή: Το class name του πίνακα αντικειμένων.
...
Αποκτά το κλειδί δομής του πίνακα αντικειμένων.
...
Αποκτά τον αριθμό υποδομών του πίνακα αντικειμένων.

Τιμή: Ο αριθμός υποδομών στη δομή του πίνακα αντικειμένων.
...
Αποκτά ή ορίζει τις υποδομές στη δομή του πίνακα αντικειμένων.

Τιμή: Οι υποδομές στη δομή του πίνακα αντικειμένων.
