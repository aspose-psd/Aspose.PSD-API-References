...
description: "Η δομή string."
type: docs
weight: 26
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/
---
...
| --- | --- |
| [StringStructure(ClassID keyName)](#StringStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure).
