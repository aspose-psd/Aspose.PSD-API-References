...
description: "Η δομή list."
type: docs
weight: 18
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| --- | --- |
| [ListStructure(ClassID keyName)](#ListStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) . |
## Πεδία
...
| [getItemsCount()](#getItemsCount--) | Λαμβάνει τον αριθμό των στοιχείων. |
...
| [getTypes()](#getTypes--) | Λαμβάνει ή ορίζει τους τύπους. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTypes(OSTypeStructure[] value)](#setTypes-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Λαμβάνει ή ορίζει τους τύπους. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) .
