...
description: "Η δομή boolean."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| --- | --- |
| [BooleanStructure(ClassID keyName)](#BooleanStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BooleanStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure) . |
## Πεδία
...
| [getValue()](#getValue--) | Λαμβάνει ή ορίζει μια λογική τιμή. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(boolean value)](#setValue-boolean-) | Λαμβάνει ή ορίζει μια λογική τιμή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BooleanStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure) .
...
Λαμβάνει ή ορίζει μια λογική τιμή.

Τιμή: Μια λογική τιμή.
