...
description: "Η δομή raw data."
type: docs
weight: 24
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/rawdatastructure/
---
...
| --- | --- |
| [RawDataStructure(ClassID keyName)](#RawDataStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [RawDataStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/rawdatastructure) . |
## Πεδία
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [RawDataStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/rawdatastructure) .
