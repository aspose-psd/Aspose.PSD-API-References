...
description: "Η δομή reference."
type: docs
weight: 25
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/
---
...
| --- | --- |
| [ReferenceStructure(ClassID keyName)](#ReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure). |
## Πεδία
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [ReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure).
