...
description: "Η δομή alias."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure). |
## Πεδία
...
| [getDataLength()](#getDataLength--) | Αποκτά το ακριβές μήκος δεδομένων σε bytes. |
| [getFullPath()](#getFullPath--) | Αποκτά ή ορίζει την πλήρη διαδρομή. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Αποκτά ή ορίζει την πλήρη διαδρομή. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure).
...
Αποκτά το ακριβές μήκος δεδομένων σε bytes.

Τιμή: Το μήκος δεδομένων σε bytes.
...
Αποκτά ή ορίζει την πλήρη διαδρομή.

Τιμή: Η πλήρης διαδρομή.
