...
description: "Η δομή double."
type: docs
weight: 14
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| --- | --- |
| [DoubleStructure(ClassID keyName)](#DoubleStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) . |
## Πεδία
...
| [getValue()](#getValue--) | Λαμβάνει ή ορίζει τη διπλή τιμή. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(double value)](#setValue-double-) | Λαμβάνει ή ορίζει τη διπλή τιμή. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) .
