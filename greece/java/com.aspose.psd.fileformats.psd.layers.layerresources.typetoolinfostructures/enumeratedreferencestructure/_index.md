...
description: "Δομή enumerated reference."
type: docs
weight: 16
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
Δομή enumerated reference.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) . |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | Αναγνωρίζει το κλειδί της δομής. |
| [StructureKey](#StructureKey) | Το κλειδί του απαριθμημένου περιγραφέα. |
## Μέθοδοι
...
| [getEnumName()](#getEnumName--) | Λαμβάνει ή ορίζει το όνομα της απαρίθμησης. |
...
| [getKey()](#getKey--) | Λαμβάνει το κλειδί. |
...
| [getTypeID()](#getTypeID--) | Λαμβάνει ή ορίζει το αναγνωριστικό τύπου. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Λαμβάνει ή ορίζει το όνομα της απαρίθμησης. |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Λαμβάνει ή ορίζει το αναγνωριστικό τύπου. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats/psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) .
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Το αναγνωριστικό τύπου. |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Το όνομα της απαρίθμησης. |
...
Το κλειδί του απαριθμημένου περιγραφέα.
