...
description: "Η δομή property."
type: docs
weight: 23
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure/
---
...
| --- | --- |
| [PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID)](#PropertyStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure). |
## Πεδία
...
| [getKeyID()](#getKeyID--) | Λαμβάνει ή ορίζει το αναγνωριστικό κλειδιού. |
...
| [setKeyID(ClassID value)](#setKeyID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Λαμβάνει ή ορίζει το αναγνωριστικό κλειδιού. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure).
...
| keyID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Το αναγνωριστικό του κλειδιού. |
