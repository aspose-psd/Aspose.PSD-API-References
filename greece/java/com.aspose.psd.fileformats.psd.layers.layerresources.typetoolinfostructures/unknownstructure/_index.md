...
description: "Η άγνωστη δομή."
type: docs
weight: 30
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) . |
## Μέθοδοι
...
| [getTypeName_internalized()](#getTypeName-internalized--) | Λαμβάνει το αναγνώσιμο όνομα τύπου της δομής. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure) .

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Το όνομα κλειδιού. |
| κλειδί | int | Το κλειδί της δομής. |
...
Λαμβάνει το αναγνώσιμο όνομα τύπου της δομής.
