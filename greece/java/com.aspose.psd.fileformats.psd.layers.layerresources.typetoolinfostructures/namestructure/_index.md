...
description: "Το κλειδί δομής Name 0x6E616D65 που γράφει name σε ASCII είναι μια απλή δομή που χρησιμοποιείται για την αποθήκευση μιας συμβολοσειράς Unicode ή τύπου Pascal που αντιπροσωπεύει το όνομα ενός στοιχείου όπως διαδρομή στρώσης ή προσαρμογή."
type: docs
weight: 19
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
Η δομή Name (κλειδί: 0x6E616D65, που γράφει "name" σε ASCII) είναι μια απλή δομή που χρησιμοποιείται για την αποθήκευση μιας συμβολοσειράς Unicode ή τύπου Pascal που αντιπροσωπεύει το όνομα ενός στοιχείου, όπως ένα στρώμα, μια διαδρομή ή μια προσαρμογή.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί μια νέα παρουσία της [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) class. |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [StructureKey](#StructureKey) | Το κλειδί δομής Name. |
## Μέθοδοι
...
| [getValue()](#getValue--) | Λαμβάνει ή ορίζει την τιμή μιας δομής Name. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Λαμβάνει ή ορίζει την πρώτη τιμή συμβολοσειράς της δομής Name. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Λαμβάνει ή ορίζει την τιμή μιας δομής Name. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Αρχικοποιεί μια νέα παρουσία της [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure) class.
...
Λαμβάνει ή ορίζει την πρώτη τιμή συμβολοσειράς της δομής Name. Συνήθως περιέχει το σύμβολο τέλους γραμμής.
