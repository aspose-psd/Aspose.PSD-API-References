...
description: "Αναπαριστά τη λειτουργία χρώματος στο PhotoshopPackage."
type: docs
weight: 10
url: /el/java/com.aspose.psd.xmp.schemas.photoshop/colormode/
---
...
Αντιπροσωπεύει τη λειτουργία χρώματος στο PhotoshopPackage.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Bitmap](#Bitmap) | Λειτουργία χρώματος bitmap. |
| [Cmyk](#Cmyk) | Λειτουργία χρώματος CMYK. |
| [Duotone](#Duotone) | Διχρωματικό χρώμα. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GrayScale](#GrayScale) | Λειτουργία χρώματος σε κλίμακα του γκρι. |
| [IndexedColor](#IndexedColor) | Το χρώμα με ευρετήριο. |
| [LabColor](#LabColor) | Χρώμα LAB. |
| [MultiChannel](#MultiChannel) | Πολυκαναλικό χρώμα. |
| [Rgb](#Rgb) | Χρώμα RGB. |
## Μέθοδοι
...
Λειτουργία χρώματος σε κλίμακα του γκρι.
