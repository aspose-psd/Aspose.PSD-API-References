...
description: "Τύποι τοποθέτησης και μεγέθους για σκηνή γραφικών."
type: docs
weight: 20
url: /el/java/com.aspose.psd.imageoptions/positioningtypes/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [DefinedByDocument](#DefinedByDocument) | Η απόλυτη τοποθέτηση στη σελίδα που ορίζεται από τις ρυθμίσεις σελίδας του εγγράφου. |
| [DefinedByOptions](#DefinedByOptions) | Η απόλυτη τοποθέτηση στη σελίδα που ορίζεται από τις ρυθμίσεις σελίδας επιλογών. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Relative](#Relative) | Η σχετική τοποθέτηση και μέγεθος. |
## Μέθοδοι
...
Η απόλυτη τοποθέτηση στη σελίδα που ορίζεται από τις ρυθμίσεις σελίδας του εγγράφου.
...
Η απόλυτη τοποθέτηση στη σελίδα που ορίζεται από τις ρυθμίσεις σελίδας επιλογών.
...
Η σχετική τοποθέτηση και μέγεθος. Καθορίζεται από το όριο όλων των αντικειμένων γραφικών.
