...
description: "Αντιπροσωπεύει τη λειτουργία πολλαπλών σελίδων"
type: docs
weight: 16
url: /el/java/com.aspose.psd.imageoptions/multipagemode/
---
...
Αντιπροσωπεύει τη λειτουργία πολλαπλών σελίδων
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [AllPages](#AllPages) | Χρησιμοποιήθηκαν όλες οι σελίδες |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Pages](#Pages) | Χρησιμοποιήθηκαν δείκτες σελίδας |
| [Range](#Range) | Χρησιμοποιήθηκε εύρος σελίδων |
| [TimeInterval](#TimeInterval) | Χρησιμοποιήθηκαν σελίδες στο χρονικό διάστημα |
| [Titles](#Titles) | Χρησιμοποιήθηκαν τίτλοι σελίδας |
## Μέθοδοι
...
Χρησιμοποιήθηκαν όλες οι σελίδες
...
Χρησιμοποιήθηκαν δείκτες σελίδας
...
Χρησιμοποιήθηκαν σελίδες στο χρονικό διάστημα
...
Χρησιμοποιήθηκαν τίτλοι σελίδας
