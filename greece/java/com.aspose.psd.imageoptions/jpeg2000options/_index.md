...
description: "Οι επιλογές μορφής αρχείου Jpeg2000."
type: docs
weight: 14
url: /el/java/com.aspose.psd.imageoptions/jpeg2000options/
---
...
| --- | --- |
| [Jpeg2000Options()](#Jpeg2000Options--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης  Jpeg2000Options  . |
| [Jpeg2000Options(Jpeg2000Options jpeg2000Options)](#Jpeg2000Options-com.aspose.psd.imageoptions.Jpeg2000Options-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης  Jpeg2000Options  . |
## Μέθοδοι
...
| [getClass()](#getClass--) |  |
| [getCodec()](#getCodec--) | Λαμβάνει ή ορίζει τον κωδικοποιητή JPEG2000 |
| [getComments()](#getComments--) | Λαμβάνει ή ορίζει τα σημεία σχολίων Jpeg. |
| [getCompressionRatios()](#getCompressionRatios--) | Λαμβάνει ή ορίζει τον Πίνακα του λόγου συμπίεσης. |
...
| [getIrreversible()](#getIrreversible--) | Λαμβάνει μια τιμή που υποδεικνύει εάν χρησιμοποιείται η μη αναστρέψιμη DWT 9-7 (true) ή η απώλεια-μη-συμπίεση DWT 5-3 (προεπιλογή). |
...
| [setCodec(int value)](#setCodec-int-) | Λαμβάνει ή ορίζει τον κωδικοποιητή JPEG2000 |
| [setComments(String[] value)](#setComments-java.lang.String---) | Λαμβάνει ή ορίζει τα σημεία σχολίων Jpeg. |
| [setCompressionRatios(int[] value)](#setCompressionRatios-int---) | Λαμβάνει ή ορίζει τον Πίνακα του λόγου συμπίεσης. |
...
| [setIrreversible(boolean value)](#setIrreversible-boolean-) | Ορίζει μια τιμή που υποδεικνύει εάν χρησιμοποιείται η μη αναστρέψιμη DWT 9-7 (true) ή η απώλεια-μη-συμπίεση DWT 5-3 (προεπιλογή). |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης  Jpeg2000Options  .
...
| --- | --- | --- |
| jpeg2000Options | [Jpeg2000Options](../../com.aspose.psd.imageoptions/jpeg2000options) | Οι επιλογές μορφής αρχείου Jpeg2000 από τις οποίες θα αντιγραφούν οι ρυθμίσεις. |
...
Λαμβάνει ή ορίζει τον κωδικοποιητή JPEG2000

**Returns:**
int - Ο κωδικοποιητής JPEG2000
...
Λαμβάνει ή ορίζει τα σημεία σχολίων Jpeg.

**Returns:**
java.lang.String[] - Τα σημεία σχολίων Jpeg.
...
Λαμβάνει ή ορίζει τον Πίνακα του λόγου συμπίεσης. Διαφορετικοί λόγοι συμπίεσης για διαδοχικά στρώματα. Ο ρυθμός που καθορίζεται για κάθε επίπεδο ποιότητας είναι ο επιθυμητός παράγοντας συμπίεσης. Απαιτούνται μειωμένοι λόγοι.

**Returns:**
int[] - Οι λόγοι συμπίεσης.
...
Λαμβάνει μια τιμή που υποδεικνύει εάν χρησιμοποιείται η μη αναστρέψιμη DWT 9-7 (true) ή η απώλεια-μη-συμπίεση DWT 5-3 (προεπιλογή).

**Returns:**
boolean - μια τιμή που υποδεικνύει εάν χρησιμοποιείται η μη αναστρέψιμη DWT 9-7 (true) ή η απώλεια-μη-συμπίεση DWT 5-3
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | Ο κωδικοποιητής JPEG2000 |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | java.lang.String[] | Τα σημεία σχολίων Jpeg. |
...
Ορίζει μια τιμή που υποδεικνύει εάν χρησιμοποιείται η μη αναστρέψιμη DWT 9-7 (true) ή η απώλεια-μη-συμπίεση DWT 5-3 (προεπιλογή).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | boolean | μια τιμή που υποδεικνύει εάν χρησιμοποιείται η μη αναστρέψιμη DWT 9-7 (true) ή η απώλεια-μη-συμπίεση DWT 5-3 |
