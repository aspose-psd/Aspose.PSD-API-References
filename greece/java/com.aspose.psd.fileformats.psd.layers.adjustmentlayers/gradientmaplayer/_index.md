...
description: "Στρώση χάρτη διαβάθμισης."
type: docs
weight: 19
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
Επίπεδο χάρτη διαβάθμισης. Διαχειρίζεται την απόδοση του χάρτη διαβάθμισης χρησιμοποιώντας δεδομένα από το GrdmResource.
## Πεδία
...
| [getGradientSettings()](#getGradientSettings--) | Λαμβάνει ή ορίζει την παρουσία ρυθμίσεων Gradient που περνιέται από την παρουσία GrdmResource. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Επεξεργάζεται το επίπεδο χάρτη διαβάθμισης. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | Λαμβάνει ή ορίζει την παρουσία ρυθμίσεων Gradient που περνιέται από την παρουσία GrdmResource. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Ενημερώνει τα δεδομένα του επιπέδου στον σχετικό πόρο επιπέδου [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
Επεξεργάζεται το επίπεδο χάρτη διαβάθμισης.
...
Ενημερώνει τα δεδομένα του επιπέδου στον σχετικό πόρο επιπέδου [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
