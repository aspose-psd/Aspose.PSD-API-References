...
description: "Η κλάση στρώσης προσαρμογής ισορροπίας χρώματος."
type: docs
weight: 16
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
Η κλάση στρώσης προσαρμογής ισορροπίας χρώματος.
## Πεδία
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Λαμβάνει ή ορίζει το Shadows YellowBlue Balance. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Εφαρμόστε τις διορθώσεις για τις τρέχουσες σκιές, μεσαίες αποχρώσεις και φωτεινά σημεία στον καθορισμένο int RGB πίνακα. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Λαμβάνει ή ορίζει το Shadows YellowBlue Balance. |
...
Εφαρμόστε τις διορθώσεις για τις τρέχουσες σκιές, μεσαίες αποχρώσεις και φωτεινά σημεία στον καθορισμένο int RGB πίνακα.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pixels | int[] | Ο int color RGB πίνακας. |
