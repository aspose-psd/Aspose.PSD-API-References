...
description: "Στρώση προσαρμογής HueSaturation."
type: docs
weight: 20
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
Στρώση προσαρμογής HueSaturation.
## Πεδία
...
| [getColorize()](#getColorize--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) είναι χρωματισμένο. |
...
| [getHue()](#getHue--) | Λαμβάνει ή ορίζει το hue. |
...
| [getLightness()](#getLightness--) | Λαμβάνει ή ορίζει τη φωτεινότητα. |
...
| [getRange(int index)](#getRange-int-) | Λαμβάνει το εύρος. |
...
| [setColorize(boolean value)](#setColorize-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) είναι χρωματισμένο. |
...
| [setHue(short value)](#setHue-short-) | Λαμβάνει ή ορίζει το hue. |
...
| [setLightness(short value)](#setLightness-short-) | Λαμβάνει ή ορίζει τη φωτεινότητα. |
...
| [setSaturation(short value)](#setSaturation-short-) | Λαμβάνει ή ορίζει τον κορεσμό. |
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) είναι χρωματισμένο.
