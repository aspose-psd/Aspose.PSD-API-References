...
description: "Στρώση προσαρμογής Cmyk Channel Mixer."
type: docs
weight: 14
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
Στρώση προσαρμογής Cmyk Channel Mixer.
## Πεδία
...
| [getBlackChannel()](#getBlackChannel--) | Λαμβάνει το μαύρο κανάλι. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Λαμβάνει το δείκτη του καναλιού κατά. |
...
| [getCyanChannel()](#getCyanChannel--) | Λαμβάνει το κυανό κανάλι. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Λαμβάνει το ματζέντα κανάλι. |
...
| [getMonochrome()](#getMonochrome--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) είναι μονόχρωμο. |
...
| [getYellowChannel()](#getYellowChannel--) | Λαμβάνει το κίτρινο κανάλι. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) είναι μονόχρωμο. |
...
Λαμβάνει το μαύρο κανάλι.

Τιμή: Το μαύρο κανάλι.
...
Λαμβάνει το κυανό κανάλι.

Τιμή: Το κυανό κανάλι.
...
Λαμβάνει το ματζέντα κανάλι.

Τιμή: Το ματζέντα κανάλι.
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) είναι μονόχρωμο.
