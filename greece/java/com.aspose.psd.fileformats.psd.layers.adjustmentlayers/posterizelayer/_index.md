...
description: "Στρώση Posterize."
type: docs
weight: 25
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
Posterize layer. Διαχειρίζεται την απόδοση του Posterize χρησιμοποιώντας δεδομένα από το PostResource.
## Πεδία
...
| [getLevels()](#getLevels--) | Επίπεδα του Posterize layer. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Επεξεργάζεται το Posterize layer. |
...
| [setLevels(short value)](#setLevels-short-) | Επίπεδα του Posterize layer. |
...
Επεξεργάζεται το Posterize layer.
