...
description: "Στρώση προσαρμογής Channel Mixer."
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
...
Στρώση προσαρμογής Channel Mixer.
## Πεδία
...
Λαμβάνει το δείκτη του καναλιού κατά. Μπορεί να επιστρέψει RgbMixerChannel ή CmykMixerChannel
