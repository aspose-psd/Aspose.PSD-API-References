...
description: "Στρώση προσαρμογής Επιλεκτικού Χρώματος."
type: docs
weight: 28
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
Στρώση προσαρμογής Επιλεκτικού Χρώματος.
## Πεδία
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Αποκτά τη διόρθωση cmyk με επιλεκτικό χρώμα. |
| [getContainer()](#getContainer--) | Λαμβάνει το περιέκτη Image. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Αποκτά ή ορίζει τη μέθοδο διόρθωσης. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Επεξεργάζεται το επίπεδο Επιλεκτικού Χρώματος. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Ορίζει τη διόρθωση cmyk με επιλεκτικό χρώμα. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Ορίζει το Image container. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Αποκτά ή ορίζει τη μέθοδο διόρθωσης. |
...
Αποκτά τη διόρθωση cmyk με επιλεκτικό χρώμα.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| selectiveColorsType | int | Επιλεκτικά χρώματα. |
...
Αποκτά ή ορίζει τη μέθοδο διόρθωσης.

Τιμή: Η μέθοδος διόρθωσης.
...
Επεξεργάζεται το επίπεδο Επιλεκτικού Χρώματος.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | Το ορθογώνιο των pixel. |
| pixels | int[] | Ο πίνακας των pixel. |
| start | [Point](../../com.aspose.psd/point) | Η αριστερή άνω θέση των pixel. |
| end | [Point](../../com.aspose.psd/point) | Η δεξιά κάτω θέση των pixel. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - Το ορθογώνιο των pixel και τα επεξεργασμένα pixel.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| selectiveColorsType | int | Τύπος των επιλεκτικών χρωμάτων. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Διόρθωση Cmyk. |
