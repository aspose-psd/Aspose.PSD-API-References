...
description: "Στρώση προσαρμογής."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/adjustmentlayer/
---
...
Προσαρμογικό επίπεδο. Για παράδειγμα Φωτεινότητα/αντίθεση
## Πεδία
...
**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - Πίνακας εικονοστοιχείων και τα όριά του
