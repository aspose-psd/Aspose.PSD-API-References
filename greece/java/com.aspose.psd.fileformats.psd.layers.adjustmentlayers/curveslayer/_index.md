...
description: "Στρώση προσαρμογής Καμπύλες"
type: docs
weight: 17
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | Λαμβάνει το διαχειριστή καμπυλών. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιείται ως continuous manager. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιείται ως discrete manager. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιείται ως continuous manager. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιείται ως discrete manager. |
...
Λαμβάνει το διαχειριστή καμπυλών.
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιείται ως continuous manager.

Τιμή: true αν αυτή η παρουσία χρησιμοποιείται ως continuous manager; διαφορετικά, false.
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιείται ως discrete manager.

Τιμή: true αν αυτή η παρουσία χρησιμοποιείται ως discrete manager; διαφορετικά, false.
...
| pixels | int[] | Τα pixel. |
| start | [Point](../../com.aspose.psd/point) | Η έναρξη. |
| end | [Point](../../com.aspose.psd/point) | Το τέλος. |
