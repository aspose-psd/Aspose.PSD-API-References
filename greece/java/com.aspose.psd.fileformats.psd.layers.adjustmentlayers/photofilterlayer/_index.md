...
description: "Στρώση προσαρμογής PhotoFilter."
type: docs
weight: 24
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
Στρώση προσαρμογής PhotoFilter.
## Πεδία
...
| [getColor()](#getColor--) | Αποκτά ή ορίζει το χρώμα RGB του φίλτρου. |
...
| [getDensity()](#getDensity--) | Αποκτά ή ορίζει την πυκνότητα του φίλτρου |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Αποκτά ή ορίζει το χρώμα RGB του φίλτρου. |
...
| [setDensity(int value)](#setDensity-int-) | Αποκτά ή ορίζει την πυκνότητα του φίλτρου |
