...
description: "Η κλάση στρώσης προσαρμογής αντιστροφής."
type: docs
weight: 21
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
Η κλάση στρώσης προσαρμογής αντιστροφής.
## Πεδία
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Επεξεργάζεται το invert adjustment layer. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Εφαρμόζει τις αντιστροφικές διορθώσεις στον καθορισμένο int ARGB πίνακα. |
...
Επεξεργάζεται το invert adjustment layer.
...
Εφαρμόζει τις αντιστροφικές διορθώσεις στον καθορισμένο int ARGB πίνακα.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pixels | int[] | Ο int ARGB πίνακας. |
