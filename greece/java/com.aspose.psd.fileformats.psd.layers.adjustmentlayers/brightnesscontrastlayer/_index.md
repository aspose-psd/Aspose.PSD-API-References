...
description: "Στρώση φωτεινότητας/αντίθεσης."
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
Λαμβάνει ή ορίζει το brightness. Για το PS το εύρος του brightness είναι από -150 έως +150. Αλλά το αγνοούμε.
...
Λαμβάνει ή ορίζει το contrast. Για το PS το εύρος του contrast είναι από -50 έως +100. Αλλά το αγνοούμε.
