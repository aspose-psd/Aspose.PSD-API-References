...
description: "Υλοποίηση της στρώσης προσαρμογής Vibrance"
type: docs
weight: 30
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
Υλοποίηση της στρώσης προσαρμογής Vibrance
## Πεδία
...
| [getVibrance()](#getVibrance--) | Λαμβάνει ή ορίζει τη ζωντάνια. |
...
| [setVibrance(int value)](#setVibrance-int-) | Λαμβάνει ή ορίζει τη ζωντάνια. |
...
**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - προσαρμογικό στρώμα
