...
description: "Στρώση προσαρμογής Rgb Channel Mixer."
type: docs
weight: 26
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
Στρώση προσαρμογής Rgb Channel Mixer.
## Πεδία
...
| [getBlueChannel()](#getBlueChannel--) | Λαμβάνει το μπλε κανάλι. |
...
| [getGreenChannel()](#getGreenChannel--) | Λαμβάνει το πράσινο κανάλι. |
...
| [getRedChannel()](#getRedChannel--) | Λαμβάνει το κόκκινο κανάλι. |
...
Λαμβάνει το δείκτη του καναλιού κατά. Επιστρέφει RgbMixerChannel
...
Λαμβάνει το πράσινο κανάλι.

Τιμή: Το πράσινο κανάλι.
...
Λαμβάνει το κόκκινο κανάλι.

Τιμή: Το κόκκινο κανάλι.
