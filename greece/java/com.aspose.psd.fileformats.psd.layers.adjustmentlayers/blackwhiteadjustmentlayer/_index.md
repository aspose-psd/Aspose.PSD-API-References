...
description: "Η κλάση στρώσης προσαρμογής Black and White."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
Η κλάση στρώσης προσαρμογής Black and White.
## Πεδία
...
| [getTintColor()](#getTintColor--) | Λαμβάνει ή ορίζει την τιμή του Tint Color. |
| [getTintColorBlue()](#getTintColorBlue--) | Λαμβάνει ή ορίζει την διπλή τιμή του Blue Tint Color. |
| [getTintColorGreen()](#getTintColorGreen--) | Λαμβάνει ή ορίζει την διπλή τιμή του Green Tint Color. |
| [getTintColorRed()](#getTintColorRed--) | Λαμβάνει ή ορίζει την διπλή τιμή του Red Tint Color. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | Επεξεργάζεται τα pixel. |
...
| [setTintColor(int value)](#setTintColor-int-) | Λαμβάνει ή ορίζει την τιμή του Tint Color. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | Λαμβάνει ή ορίζει την διπλή τιμή του Blue Tint Color. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | Λαμβάνει ή ορίζει την διπλή τιμή του Green Tint Color. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | Λαμβάνει ή ορίζει την διπλή τιμή του Red Tint Color. |
...
Λαμβάνει ή ορίζει την τιμή του Tint Color.

Τιμή: Η τιμή του Tint Color.
