...
description: "Στρώση προσαρμογής Επιπέδων"
type: docs
weight: 22
url: /el/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| [getChannel(int index)](#getChannel-int-) | Λαμβάνει το κανάλι. |
...
| [getMasterChannel()](#getMasterChannel--) | Λαμβάνει το κύριο κανάλι. |
