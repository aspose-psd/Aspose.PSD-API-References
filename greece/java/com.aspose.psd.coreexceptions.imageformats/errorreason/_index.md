...
description: "Αντιπροσωπεύει τους λόγους του σφάλματος."
type: docs
weight: 10
url: /el/java/com.aspose.psd.coreexceptions.imageformats/jpegloadexception.errorreason/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [BasicError](#BasicError) | Ο βασικός τύπος σφάλματος. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NotEnoughData](#NotEnoughData) | Δεν υπάρχουν αρκετά δεδομένα στη ροή. |
## Μέθοδοι
...
Δεν υπάρχουν αρκετά δεδομένα στη ροή.
