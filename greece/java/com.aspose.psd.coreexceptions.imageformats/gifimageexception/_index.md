...
description: "Η εξαίρεση εικόνας Gif."
type: docs
weight: 11
url: /el/java/com.aspose.psd.coreexceptions.imageformats/gifimageexception/
---
...
| --- | --- |
| [GifImageException(String message)](#GifImageException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  GifImageException  . |
| [GifImageException(String message, Throwable innerException)](#GifImageException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  GifImageException  . |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης  GifImageException  .
