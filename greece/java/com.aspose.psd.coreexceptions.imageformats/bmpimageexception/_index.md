...
description: "Η εξαίρεση εικόνας bmp."
type: docs
weight: 10
url: /el/java/com.aspose.psd.coreexceptions.imageformats/bmpimageexception/
---
...
Η εξαίρεση εικόνας bmp.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [BmpImageException(String message)](#BmpImageException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  BmpImageException  . |
| [BmpImageException(String message, Throwable innerException)](#BmpImageException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  BmpImageException  . |
## Μέθοδοι
