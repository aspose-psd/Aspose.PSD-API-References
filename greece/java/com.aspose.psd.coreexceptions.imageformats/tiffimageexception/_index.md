...
description: "Η εξαίρεση εικόνας Tiff"
type: docs
weight: 19
url: /el/java/com.aspose.psd.coreexceptions.imageformats/tiffimageexception/
---
...
Η εξαίρεση εικόνας Tiff
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [TiffImageException(String message)](#TiffImageException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης TiffImageException. |
| [TiffImageException(String message, Throwable innerException)](#TiffImageException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης TiffImageException. |
| [TiffImageException(String message, int error)](#TiffImageException-java.lang.String-int-) | Αρχικοποιεί μια νέα παρουσία της κλάσης TiffImageException. |
| [TiffImageException(int error)](#TiffImageException-int-) | Αρχικοποιεί μια νέα παρουσία της κλάσης TiffImageException. |
## Μέθοδοι
...
| [getOptionsError()](#getOptionsError--) | Λαμβάνει το σφάλμα επιλογών tiff. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης TiffImageException.
