...
description: "Η εξαίρεση εικόνας png."
type: docs
weight: 15
url: /el/java/com.aspose.psd.coreexceptions.imageformats/pngimageexception/
---
...
Η εξαίρεση εικόνας png.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PngImageException(String message)](#PngImageException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  PngImageException  . |
| [PngImageException(String message, Throwable innerException)](#PngImageException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  PngImageException  . |
## Μέθοδοι
