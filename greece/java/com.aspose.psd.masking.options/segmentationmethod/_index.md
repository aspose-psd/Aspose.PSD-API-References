...
description: "Τύποι μεθόδων τμηματοποίησης"
type: docs
weight: 17
url: /el/java/com.aspose.psd.masking.options/segmentationmethod/
---
...
Τύποι μεθόδων τμηματοποίησης
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FuzzyCMeans](#FuzzyCMeans) | Ο αλγόριθμος τμηματοποίησης Fuzzy C-means. |
| [GraphCut](#GraphCut) | Ο αλγόριθμος τμηματοποίησης Graph Cut |
| [KMeans](#KMeans) | Ο αλγόριθμος τμηματοποίησης K-means. |
| [Manual](#Manual) | Ο αλγόριθμος τμηματοποίησης manual |
| [Watershed](#Watershed) | Ο αλγόριθμος τμηματοποίησης Watershed. |
## Μέθοδοι
...
Ο αλγόριθμος τμηματοποίησης Fuzzy C-means.
...
Ο αλγόριθμος τμηματοποίησης Graph Cut
...
Ο αλγόριθμος τμηματοποίησης K-means.
...
Ο αλγόριθμος τμηματοποίησης manual
...
Ο αλγόριθμος τμηματοποίησης Watershed.
