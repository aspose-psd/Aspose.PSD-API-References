...
description: "Αναπαριστά τις κοινές επιλογές μάσκας εικόνας."
type: docs
weight: 16
url: /el/java/com.aspose.psd.masking.options/maskingoptions/
---
...
Αναπαριστά τις κοινές επιλογές μάσκας εικόνας.
## Κατασκευαστές
