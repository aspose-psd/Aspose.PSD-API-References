...
description: "Αντιπροσωπεύει ένα Brush με δυνατότητες gradient και κατάλληλες ιδιότητες."
type: docs
weight: 12
url: /el/java/com.aspose.psd.brushes/lineargradientbrushbase/
---
...
Αντιπροσωπεύει ένα Brush με δυνατότητες διαβάθμισης και κατάλληλες ιδιότητες.
## Μέθοδοι
