...
description: "Η εξαίρεση εικόνας."
type: docs
weight: 14
url: /el/java/com.aspose.psd.coreexceptions/imageexception/
---
...
| --- | --- |
| [ImageException(String message)](#ImageException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ImageException  . |
| [ImageException(String message, Throwable innerException)](#ImageException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ImageException  . |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης  ImageException  .
