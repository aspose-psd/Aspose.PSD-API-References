...
description: "Η εξαίρεση αποθήκευσης εικόνας."
type: docs
weight: 16
url: /el/java/com.aspose.psd.coreexceptions/imagesaveexception/
---
...
| --- | --- |
| [ImageSaveException(String message)](#ImageSaveException-java.lang.String-) | Αρχικοποιεί ένα νέο στιγμιότυπο της  ImageSaveException  κλάσης. |
| [ImageSaveException(String message, Throwable innerException)](#ImageSaveException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί ένα νέο στιγμιότυπο της  ImageSaveException  κλάσης. |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο στιγμιότυπο της  ImageSaveException  κλάσης.
