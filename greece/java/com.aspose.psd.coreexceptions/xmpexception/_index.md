...
description: "Η εξαίρεση που ρίχνεται όταν το XMP έχει μη έγκυρη δομή."
type: docs
weight: 23
url: /el/java/com.aspose.psd.coreexceptions/xmpexception/
---
...
| --- | --- |
| [XmpException()](#XmpException--) | Αρχικοποιεί μια νέα παρουσία της κλάσης  XmpException  . |
| [XmpException(String message)](#XmpException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  XmpException  . |
| [XmpException(String message, Throwable innerException)](#XmpException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  XmpException  . |
## Πεδία
