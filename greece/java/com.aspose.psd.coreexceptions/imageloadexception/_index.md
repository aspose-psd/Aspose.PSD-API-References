...
description: "Η εξαίρεση φόρτωσης εικόνας."
type: docs
weight: 15
url: /el/java/com.aspose.psd.coreexceptions/imageloadexception/
---
...
| --- | --- |
| [ImageLoadException(String message)](#ImageLoadException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ImageLoadException  . |
| [ImageLoadException(String message, Throwable innerException)](#ImageLoadException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  ImageLoadException  . |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης  ImageLoadException  .
