...
description: "Συμβαίνει όταν μια λειτουργία διακόπτεται."
type: docs
weight: 20
url: /el/java/com.aspose.psd.coreexceptions/operationinterruptedexception/
---
...
| --- | --- |
| [OperationInterruptedException(String message)](#OperationInterruptedException-java.lang.String-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  OperationInterruptedException  . |
| [OperationInterruptedException(String message, Throwable innerException)](#OperationInterruptedException-java.lang.String-java.lang.Throwable-) | Αρχικοποιεί μια νέα παρουσία της κλάσης  OperationInterruptedException  . |
## Μέθοδοι
