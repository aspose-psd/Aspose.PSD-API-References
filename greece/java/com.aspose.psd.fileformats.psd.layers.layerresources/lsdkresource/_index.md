...
description: "Ο πόρος στρώσης lsdk, ενσωματωμένος πόρος ενότητας στρώσης."
type: docs
weight: 56
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
Ο lsdk πόρος στρώσης (ενσωματωμένος πόρος τμήματος στρώσης).
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource).
