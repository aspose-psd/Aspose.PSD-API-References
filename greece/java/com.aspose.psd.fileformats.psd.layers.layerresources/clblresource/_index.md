...
description: "Κλάση ClblResource."
type: docs
weight: 20
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Κλάση ClblResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με την ανάμειξη του αποκομμένου στοιχείου.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ClblResource()](#ClblResource--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Πεδία
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [αναμείξτε αποκομμένα στοιχεία]. |
| [getClass()](#getClass--) |  |
...
| [getValue()](#getValue--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η τιμή [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) είναι αληθής ή ψευδής |
| [hashCode()](#hashCode--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [αναμείξτε αποκομμένα στοιχεία]. |
...
| [setValue(boolean value)](#setValue-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η τιμή [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) είναι αληθής ή ψευδής |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
| --- | --- | --- |
| blendClippedElements | boolean | αν οριστεί σε  true  [αναμείξτε αποκομμένα στοιχεία]. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). Με προσαρμοσμένη ή άγνωστη τιμή
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [αναμείξτε αποκομμένα στοιχεία].

Τιμή:  true  εάν [blend clipped elements]; διαφορετικά,  false .
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η τιμή [BooleanResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/booleanresource) είναι αληθής ή ψευδής

Τιμή:  true  εάν η τιμή είναι αληθής· διαφορετικά,  false .
