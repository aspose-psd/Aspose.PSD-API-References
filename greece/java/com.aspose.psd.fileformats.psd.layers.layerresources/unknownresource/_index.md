...
description: "Ο άγνωστος πόρος."
type: docs
weight: 82
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource). |
## Πεδία
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource).
