...
description: "Ο πόρος mlst."
type: docs
weight: 62
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
Ο πόρος mlst. Αυτή η κλάση, μεταξύ άλλων, περιέχει πληροφορίες σχετικά με τη θέση του στρώματος στη χρονογραμμή.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [MlstResource()](#MlstResource--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource). |
## Πεδία
...
| [getItems()](#getItems--) | Λαμβάνει ή ορίζει τις δομές. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Λαμβάνει ή ορίζει τις δομές. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource).
