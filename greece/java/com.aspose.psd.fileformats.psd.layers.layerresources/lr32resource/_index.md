...
description: "Ο lr32 πόρος."
type: docs
weight: 54
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource/
---
...
| --- | --- |
| [Lr32Resource()](#Lr32Resource--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource). |
## Πεδία
...
| [getLayers()](#getLayers--) | Λαμβάνει ή ορίζει τα στρώματα. |
| [getLength()](#getLength--) | Λαμβάνει το μήκος του πόρου για την έκδοση κεφαλίδας PSD της εικόνας. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | Λαμβάνει το μήκος του πόρου. |
...
| [getRawData_internalized()](#getRawData-internalized--) | Λαμβάνει ή ορίζει τα ακατέργαστα δεδομένα του πόρου. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Αποθηκεύει την εγγραφή του στρώματος. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Λαμβάνει ή ορίζει τα στρώματα. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | Λαμβάνει ή ορίζει τα ακατέργαστα δεδομένα του πόρου. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource).
...
Λαμβάνει το μήκος του πόρου για την έκδοση κεφαλίδας PSD της εικόνας.
...
Λαμβάνει το μήκος του πόρου. Μπορεί να εξαρτάται από την έκδοση του PSD.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| psdHeaderVersion | int | Η έκδοση κεφαλίδας PSD. |

**Returns:**
int - Το μήκος του πόρου.
...
Λαμβάνει ή ορίζει τα ακατέργαστα δεδομένα του πόρου.
...
Αποθηκεύει την εγγραφή του στρώματος.
