...
type: docs
weight: 68
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresource/
---
...
| [getRgbColor()](#getRgbColor--) | Λαμβάνει το χρώμα του RGB. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| color | [Color](../../com.aspose.psd/color) | Το χρώμα RGB. |
