...
description: "Κλάση IopaResource."
type: docs
weight: 40
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
Κλάση IopaResource. Αυτός ο πόρος περιέχει πληροφορίες για την ιδιότητα διαφάνειας γεμίσματος από τη φόρμα στυλ στρώσης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [IopaResource()](#IopaResource--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
## Πεδία
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Λαμβάνει ή ορίζει τη διαφάνεια γεμίσματος. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).
...
| --- | --- | --- |
| δεδομένα | byte[] | Τα ακατέργαστα δεδομένα byte. |
