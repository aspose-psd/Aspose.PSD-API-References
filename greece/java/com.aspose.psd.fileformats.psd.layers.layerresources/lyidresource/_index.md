...
description: "Κλάση LyidResource."
type: docs
weight: 59
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
## Πεδία
...
| [getValue()](#getValue--) | Λαμβάνει την τιμή. |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Αποθηκεύει στο καθορισμένο δοχείο ροής. |
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | Λαμβάνει την τιμή. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource).
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). Με προσαρμοσμένη ή άγνωστη τιμή
