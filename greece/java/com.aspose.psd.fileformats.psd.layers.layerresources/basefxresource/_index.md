...
description: "Βασικός πόρος εφέ"
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource). |
## Πεδία
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| resourceKey | int | Το κλειδί του πόρου. |
