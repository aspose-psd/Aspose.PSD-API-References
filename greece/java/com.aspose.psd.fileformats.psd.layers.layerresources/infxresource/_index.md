...
description: "Κλάση InfxResource."
type: docs
weight: 39
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Κλάση InfxResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με την ανάμειξη του περικομμένου στοιχείου.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource()](#InfxResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
## Πεδία
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [blend interior elements]. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| blendInteriorElements | boolean | εάν οριστεί σε  true  [blend interior elements]. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). Με προσαρμοσμένη ή άγνωστη τιμή
