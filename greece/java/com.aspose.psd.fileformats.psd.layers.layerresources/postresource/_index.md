...
description: "Κλάση PostResource."
type: docs
weight: 71
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
Κλάση PostResource. Ρυθμίσεις αποστρόφωσης στρώσης.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PostResource()](#PostResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource).
