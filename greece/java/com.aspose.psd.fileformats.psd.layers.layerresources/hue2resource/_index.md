...
description: "Κλάση Hue2Resource."
type: docs
weight: 36
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource/
---
...
Κλάση Hue2Resource. Πόρος του επιπέδου προσαρμογής έκθεσης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Hue2Resource()](#Hue2Resource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Hue2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource). |
| [Hue2Resource(byte[] data)](#Hue2Resource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [Hue2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getColorize()](#getColorize--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [Hue2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource) είναι χρωματισμένο. |
...
| [getRanges()](#getRanges--) | Λαμβάνει τα εύρη του επιπέδου προσαρμογής απόχρωσης/κορεσμού. |
| [getSaturation()](#getSaturation--) | Λαμβάνει ή ορίζει τον κύριο κορεσμό. |
...
| [setColorize(boolean value)](#setColorize-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [Hue2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource) είναι χρωματισμένο. |
...
| [setHue(short value)](#setHue-short-) | Λαμβάνει ή ορίζει την κύρια απόχρωση. |
| [setLightness(short value)](#setLightness-short-) | Λαμβάνει ή ορίζει τη κύρια φωτεινότητα. |
| [setRanges(ColorRangeHsl[] value)](#setRanges-com.aspose.psd.fileformats.psd.layers.layerresources.ColorRangeHsl---) | Λαμβάνει τα εύρη του επιπέδου προσαρμογής απόχρωσης/κορεσμού. |
| [setSaturation(short value)](#setSaturation-short-) | Λαμβάνει ή ορίζει τον κύριο κορεσμό. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [Hue2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource).
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [Hue2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/hue2resource) είναι χρωματισμένο.

Τιμή: true αν colorize; διαφορετικά, false.
...
Λαμβάνει ή ορίζει τη κύρια φωτεινότητα.

Τιμή: Η κύρια φωτεινότητα.
...
Λαμβάνει τα εύρη του επιπέδου προσαρμογής απόχρωσης/κορεσμού. Τα εύρη στο PS μπορούν να αλλάξουν ονόματα εάν το εύρος αλλάξει, επομένως πρέπει να δουλεύουμε με βάση το δείκτη.
...
Λαμβάνει ή ορίζει τον κύριο κορεσμό.

Τιμή: Ο κύριος κορεσμός.
