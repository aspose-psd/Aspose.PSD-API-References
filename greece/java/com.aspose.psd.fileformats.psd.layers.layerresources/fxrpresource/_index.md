...
description: "Κλάση FxrpResource."
type: docs
weight: 32
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
Κλάση **FxrpResource**. Το σημείο αναφοράς του στρώματος
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Πεδία
...
| [getX()](#getX--) | Λαμβάνει ή ορίζει το x του σημείου αναφοράς |
| [getY()](#getY--) | Λαμβάνει ή ορίζει το y του σημείου αναφοράς |
| [hashCode()](#hashCode--) |  |
...
| [setX(double value)](#setX-double-) | Λαμβάνει ή ορίζει το x του σημείου αναφοράς |
| [setY(double value)](#setY-double-) | Λαμβάνει ή ορίζει το y του σημείου αναφοράς |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Με προσαρμοσμένη ή άγνωστη τιμή
...
Τιμή: Το x του σημείου αναφοράς
...
Τιμή: Το y του σημείου αναφοράς
