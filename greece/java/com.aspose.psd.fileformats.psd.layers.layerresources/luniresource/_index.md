...
description: "Πόρος ονόματος στρώσης"
type: docs
weight: 58
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
Πόρος ονόματος στρώσης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LuniResource()](#LuniResource--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource). |
## Πεδία
...
| [getName()](#getName--) | Λαμβάνει ή ορίζει το όνομα. |
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Λαμβάνει ή ορίζει τα δεδομένα. |
...
| [setName(String value)](#setName-java.lang.String-) | Λαμβάνει ή ορίζει το όνομα. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource).
