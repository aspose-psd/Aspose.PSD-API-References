...
description: "Ο πόρος τμήματος στρώσης."
type: docs
weight: 43
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
Ο πόρος τμήματος στρώσης.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Πεδία
...
| [getSectionType()](#getSectionType--) | Λαμβάνει ή ορίζει τον τύπο ενότητας. |
| [getSignature()](#getSignature--) | Λαμβάνει την υπογραφή του πόρου της στρώσης. |
| [getSubtype()](#getSubtype--) | Λαμβάνει ή ορίζει τον υποτύπο. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Λαμβάνει ή ορίζει τον τύπο ενότητας. |
| [setSubtype(int value)](#setSubtype-int-) | Λαμβάνει ή ορίζει τον υποτύπο. |
...
Αρχικοποιεί ένα νέο παράδειγμα της κλάσης [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
| --- | --- | --- |
| sectionType | int | Ο τύπος ενότητας. |
| subType | int | Ο υποτύπος. |
