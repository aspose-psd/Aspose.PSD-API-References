...
description: "Πόρος Imfx Πόρος πολλαπλών εφέ"
type: docs
weight: 38
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource/
---
...
Imfx πόρος (πολλαπλών εφέ πόρος)
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ImfxResource()](#ImfxResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ImfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ImfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/imfxresource).
