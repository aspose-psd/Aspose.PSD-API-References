...
description: "Κλάση NvrtResource."
type: docs
weight: 63
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
Κλάση NvrtResource. Πόρος του Invert Adjustment Layer.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [DataLength_internalized](#DataLength-internalized) | Αναμενόμενο μήκος δεδομένων. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource).
