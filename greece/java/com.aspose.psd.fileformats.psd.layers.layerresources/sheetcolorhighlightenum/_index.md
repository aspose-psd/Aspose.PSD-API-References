...
description: "Πιθανά χρώματα της ρύθμισης χρώματος Φύλλου."
type: docs
weight: 73
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Πιθανά χρώματα της ρύθμισης χρώματος φύλλου. Είναι διακοσμητικό χρώμα UI της στρώσης στη λίστα στρώσεων στο PS
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Blue](#Blue) | Το μπλε χρώμα. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gray](#Gray) | Το γκρι χρώμα. |
| [Green](#Green) | Το πράσινο χρώμα. |
| [NoColor](#NoColor) | Το χρώμα δεν έχει καθοριστεί. |
| [Orange](#Orange) | Το πορτοκαλί χρώμα. |
| [Red](#Red) | Το κόκκινο χρώμα. |
| [Violet](#Violet) | Το βιολετί χρώμα. |
| [Yellow](#Yellow) | Το κίτρινο χρώμα. |
## Μέθοδοι
