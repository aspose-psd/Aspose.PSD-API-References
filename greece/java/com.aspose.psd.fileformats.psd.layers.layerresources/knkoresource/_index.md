...
description: "Κλάση KnkoResource."
type: docs
weight: 41
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
Class KnkoResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με τη συγχώνευση του κομμένου στοιχείου.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource()](#KnkoResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
## Πεδία
...
| [getKnockout()](#getKnockout--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [blend interior elements]. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [blend interior elements]. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| knockout | boolean | εάν οριστεί σε  true  [blend interior elements]. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). Με προσαρμοσμένη ή άγνωστη τιμή
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [blend interior elements].

Τιμή:  true  εάν [blend interior elements]; διαφορετικά,  false .
