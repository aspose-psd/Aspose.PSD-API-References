...
description: "Πόρος ομάδας επιδράσεων στρώματος Ifxs"
type: docs
weight: 37
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource/
---
...
Ifxs πόρος (ομάδα εφέ στρώσης πόρος)
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [IfxsResource()](#IfxsResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [IfxsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource). |
## Πεδία
...
| [fillDefaultStructs_internalized(BaseFxResource fxResource, boolean isMultiStructure)](#fillDefaultStructs-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.BaseFxResource-boolean-) | Γέμισμα δομής με προεπιλεγμένες δομές |
| [findResourceForTest_internalized(int type)](#findResourceForTest-internalized-int-) | Βρίσκει την οντότητα του εφέ. |
| [generateDefaultResource_internalized()](#generateDefaultResource-internalized--) | Δημιουργεί τον προεπιλεγμένο πόρο. |
| [getClass()](#getClass--) |  |
| [getDefaultListStructure_internalized(int multiType, int type, boolean isMultiStructure)](#getDefaultListStructure-internalized-int-int-boolean-) | Δημιουργεί τη νέα παρουσία του [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) βασισμένη σε LayerMultiEffectsTypes με προεπιλεγμένες δομές εφέ. |
| [getDescriptorVersion()](#getDescriptorVersion--) | Λαμβάνει την έκδοση του περιγραφέα. |
...
| [getLayerStyle_internalized()](#getLayerStyle-internalized--) | Λαμβάνει ή ορίζει το στυλ του στρώματος. |
...
| [setLayerStyle_internalized(LayerStyleFX value)](#setLayerStyle-internalized-com.aspose.internal.fileformats.psd.layers.layereffects.LayerStyleFX-) | Λαμβάνει ή ορίζει το στυλ του στρώματος. |
| [toString()](#toString--) | Επιστρέφει ένα String που αντιπροσωπεύει αυτό το αντικείμενο. |
| [update_internalized()](#update-internalized--) | Ενημερώνει αυτήν την παρουσία. |
| [wait()](#wait--) |  |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [IfxsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource).
...
Γέμισμα δομής με προεπιλεγμένες δομές

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| fxResource | [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource) | Οποιοσδήποτε πόρος εφέ |
| isMultiStructure | boolean | Σημαία χρήσης κλάσης multi-structure |
...
**Returns:**
com.aspose.internal.fileformats.psd.layers.layereffects.effectentities.IEffectEntity - Επιστρέφει την οντότητα του εφέ.
...
Δημιουργεί τον προεπιλεγμένο πόρο.
...
Δημιουργεί τη νέα παρουσία του [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) βασισμένη σε LayerMultiEffectsTypes με προεπιλεγμένες δομές εφέ. Εάν το isMultiStructure είναι true, η δομή θα είναι Multi αλλιώς Simple

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| multiType | int | Ο multi type του εφέ. |
| τύπος | int | Ο τύπος του εφέ. |
| isMultiStructure | boolean | Σημαία χρήσης κλάσης multi-structure |
...
Λαμβάνει ή ορίζει το στυλ του στρώματος.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | com.aspose.internal.fileformats.psd.layers.layereffects.LayerStyleFX |  |
...
Ενημερώνει αυτό το παράδειγμα. TODO: Αφαιρέστε αυτή τη μέθοδο. Η ενημέρωση θα πρέπει να είναι αυτόματη.
