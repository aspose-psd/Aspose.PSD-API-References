...
description: "Κλάση CmlsResource."
type: docs
weight: 21
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/
---
...
| --- | --- |
| [CmlsResource(byte[] data)](#CmlsResource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource).
