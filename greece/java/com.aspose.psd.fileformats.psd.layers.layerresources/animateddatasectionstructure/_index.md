...
description: "Η ενότητα με κινούμενα δεδομένα."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [StructureKey](#StructureKey) | Αναγνωρίζει το κλειδί δομής του AnDs. |
## Μέθοδοι
...
| [getItems()](#getItems--) | Λαμβάνει ή ορίζει τις δομές τμήματος κινούμενων δεδομένων. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Λαμβάνει ή ορίζει το ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Λαμβάνει ή ορίζει την έκδοση του περιγραφέα. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Λαμβάνει ή ορίζει τις δομές τμήματος κινούμενων δεδομένων. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Λαμβάνει ή ορίζει τα άγνωστα bytes 3 που υπάρχουν όταν ο αριθμός πλαισίων είναι περιττός. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Ελέγχει ότι ο αριθμός πλαισίων στη δομή λίστας 'FrIn' είναι περιττός.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| στοιχεία | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Λαμβάνει ή ορίζει τις δομές τμήματος κινούμενων δεδομένων.
...
Λαμβάνει ή ορίζει τα άγνωστα bytes 3 που υπάρχουν όταν ο αριθμός πλαισίων είναι περιττός.
