...
description: "Κλάση SoCoResource."
type: docs
weight: 75
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
Κλάση SoCoResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με τα Color Fill Layers.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [SoCoResource()](#SoCoResource--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Λαμβάνει το χρώμα RGB. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Λαμβάνει το χρώμα RGB. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource).
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | Το χρώμα RGB |
