...
description: "Πόρος εφέ πόρου Lfx2"
type: docs
weight: 49
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
Lfx2 πόρος (εφέ πόρος)
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Lfx2Resource()](#Lfx2Resource--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Lfx2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lfx2resource). |
## Πεδία
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [Lfx2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lfx2resource).
