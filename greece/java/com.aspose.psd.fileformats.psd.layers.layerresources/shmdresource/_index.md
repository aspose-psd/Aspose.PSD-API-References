...
description: "Κλάση ShmdResource."
type: docs
weight: 74
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
| --- | --- |
| [ShmdResource()](#ShmdResource--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
## Πεδία
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | Το μήκος κεφαλίδας του υπο-πόρου |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Λαμβάνει ή ορίζει την ώρα δημιουργίας του στρώματος. |
...
| [getSubResources()](#getSubResources--) | Οι υπο-πόροι |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Λαμβάνει ή ορίζει την ώρα δημιουργίας του στρώματος. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | Λαμβάνει τους υπο-πόρους του πόρου shmd. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource).
...
Το μήκος κεφαλίδας του υπο-πόρου
...
Λαμβάνει ή ορίζει την ώρα δημιουργίας του στρώματος. Εάν η ώρα δημιουργίας του στρώματος δεν έχει καθοριστεί, τότε επιστρέφει νέο DateTime(0).

Τιμή: Η ώρα δημιουργίας του στρώματος.
...
Λαμβάνει τους υπο-πόρους του πόρου shmd.
