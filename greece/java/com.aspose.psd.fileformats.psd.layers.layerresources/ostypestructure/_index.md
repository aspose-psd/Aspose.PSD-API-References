...
description: "Αναπαριστά τη δομή τύπου OS."
type: docs
weight: 64
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure/
---
...
Αναπαριστά τη δομή τύπου OS.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [OSTypeStructure(ClassID keyName)](#OSTypeStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure). |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [OSTypeStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure).
