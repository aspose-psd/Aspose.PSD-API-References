...
description: "Ο πόρος Filter Effects περιέχει κανάλια, μια μάσκα χρήστη και μια μάσκα φύλλου για το έξυπνο φίλτρο."
type: docs
weight: 29
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource). |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | Το κλειδί πληροφοριών εργαλείου τύπου FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | Το κλειδί πληροφοριών εργαλείου τύπου FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Λαμβάνει τις μάσκες εφέ φίλτρου. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Λαμβάνει τις μάσκες εφέ φίλτρου. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource).
...
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Οι μάσκες εφέ φίλτρου. |
...
Το κλειδί πληροφοριών εργαλείου τύπου FXid.
