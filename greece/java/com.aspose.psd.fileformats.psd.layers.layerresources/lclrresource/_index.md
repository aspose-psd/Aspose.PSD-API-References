...
description: "Κλάση LclrResource."
type: docs
weight: 46
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
Κλάση LclrResource. Αυτός ο πόρος περιέχει πληροφορίες σχετικά με το χρώμα της στρώσης στη λίστα στρώσεων του PS. Είναι μόνο
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LclrResource()](#LclrResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(short color)](#LclrResource-short-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(byte[] data)](#LclrResource-byte---) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Λαμβάνει ή ορίζει το χρώμα της στρώσης. |
...
| [setColor(short value)](#setColor-short-) | Λαμβάνει ή ορίζει το χρώμα της στρώσης. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource).

### LclrResource(short color) {#LclrResource-short-}
```
...
| --- | --- | --- |
| color | short | Το χρώμα. |

### LclrResource(byte[] data) {#LclrResource-byte---}
```
...
Λαμβάνει ή ορίζει το χρώμα της στρώσης.
...
### setColor(short value) {#setColor-short-}
```
