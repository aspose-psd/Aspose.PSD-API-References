...
description: "Ο τύπος τμήματος στρώσης"
type: docs
weight: 45
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectiontype/
---
...
Ο τύπος τμήματος στρώσης
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ClosedFolder](#ClosedFolder) | Ο κλειστός φάκελος. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Layer](#Layer) | Το στρώμα. |
| [OpenFolder](#OpenFolder) | Ο ανοιχτός φάκελος. |
| [SectionDivider](#SectionDivider) | Ο διαχωριστής ενότητας. |
## Μέθοδοι
