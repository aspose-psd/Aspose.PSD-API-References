...
description: "Πόρος VibA."
type: docs
weight: 83
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| --- | --- |
| [VibAResource()](#VibAResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource). |
## Πεδία
...
| [getSaturation()](#getSaturation--) | Λαμβάνει ή ορίζει την τιμή κορεσμού |
| [getSignature()](#getSignature--) | Λαμβάνει την υπογραφή του πόρου της στρώσης. |
| [getVibrance()](#getVibrance--) | Λαμβάνει ή ορίζει την τιμή ζωντάνιας |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | Λαμβάνει ή ορίζει την τιμή κορεσμού |
| [setVibrance(int value)](#setVibrance-int-) | Λαμβάνει ή ορίζει την τιμή ζωντάνιας |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource).
