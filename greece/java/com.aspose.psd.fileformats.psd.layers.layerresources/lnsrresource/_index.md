...
description: "Κλάση lnsrResource."
type: docs
weight: 51
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Αποκτά τα ακατέργαστα δεδομένα. |
...
| [getValue()](#getValue--) | Λαμβάνει την τιμή ως LnsrResourceType εάν η αντίστοιχη enum περιγράφεται. |
| [hashCode()](#hashCode--) |  |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| lnsrResourceType | int | Τύπος του LNSR. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). Με προσαρμοσμένη ή άγνωστη τιμή
...
Αποκτά τα ακατέργαστα δεδομένα.
...
Λαμβάνει την τιμή ως LnsrResourceType εάν η αντίστοιχη enum περιγράφεται. Διαφορετικά επιστρέφει Unknown

Τιμή: Η τιμή ως LnsrResourceType
