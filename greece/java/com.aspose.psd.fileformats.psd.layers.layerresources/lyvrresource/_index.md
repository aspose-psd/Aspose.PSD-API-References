...
description: "Ο πόρος που αντιπροσωπεύει την έκδοση Photoshop της στρώσης."
type: docs
weight: 60
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
Ο πόρος που αντιπροσωπεύει την έκδοση Photoshop της στρώσης.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource). |
## Πεδία
...
| [getVersion()](#getVersion--) | Λαμβάνει ή ορίζει την έκδοση Photoshop του Layer. |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | Λαμβάνει ή ορίζει την έκδοση Photoshop του Layer. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource).
...
Λαμβάνει ή ορίζει την έκδοση Photoshop του Layer.
