...
description: "Ο αντιπρόσωπος μακράς λειτουργίας για την ασύγχρονη εργασία με γενικό τύπο αποτελέσματος."
type: docs
weight: 12
url: /el/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
Ο αντιπρόσωπος μακράς λειτουργίας για την ασύγχρονη εργασία με γενικό τύπο αποτελέσματος.
## Κατασκευαστές
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [beginInvoke(IAsyncTaskState taskState, System.AsyncCallback callback, Object state)](#beginInvoke-com.aspose.psd.asynctask.IAsyncTaskState-com.aspose.ms.System.AsyncCallback-java.lang.Object-) |  |
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | Ο αντιπρόσωπος μακράς λειτουργίας για την ασύγχρονη εργασία με γενικό τύπο αποτελέσματος. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) |  |
| κλήση επιστροφής | com.aspose.ms.System.AsyncCallback |  |
| κατάσταση | java.lang.Object |  |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| αποτέλεσμα | com.aspose.ms.System.IAsyncResult |  |
...
**Returns:**
int
### invoke(IAsyncTaskState taskState) {#invoke-com.aspose.psd.asynctask.IAsyncTaskState-}
```
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | Κατάσταση της ασύγχρονης εργασίας. |

**Returns:**
java.lang.Object - Το αποτέλεσμα της λειτουργίας long.
### notify() {#notify--}
```
