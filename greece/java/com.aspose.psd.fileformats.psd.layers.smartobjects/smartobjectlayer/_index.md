...
description: "Ορίζει το SmartObjectLayer class που περιέχει ενσωματωμένο στο αρχείο PSD ή συνδεδεμένο smart object στο εξωτερικό αρχείο."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Ορίζει την κλάση SmartObjectLayer που περιέχει ενσωματωμένο στο αρχείο PSD ή συνδεδεμένο έξυπνο αντικείμενο στο εξωτερικό αρχείο. Με τα Smart Objects, μπορείτε: Να εκτελείτε μη καταστροφικές μετασχηματίσεις. Μπορείτε να κλιμακώσετε, να περιστρέψετε, να παραμορφώσετε, να διαστρεβλώσετε, να εφαρμόσετε προοπτική ή να παραμορφώσετε ένα επίπεδο χωρίς να χάσετε τα αρχικά δεδομένα ή την ποιότητα της εικόνας, επειδή οι μετασχηματισμοί don\\ufffdt επηρεάζουν τα αρχικά δεδομένα. Να εργάζεστε με διανυσματικά δεδομένα, όπως διανυσματικά σχέδια από το Illustrator, που διαφορετικά θα rasterized. Να εκτελείτε μη καταστροφικό φιλτράρισμα. Μπορείτε να επεξεργάζεστε φίλτρα που εφαρμόζονται στα Smart Objects ανά πάσα στιγμή. Επεξεργαστείτε ένα Smart Object και ενημερώστε αυτόματα όλες τις συνδεδεμένες παρουσίες του. Εφαρμόστε μια μάσκα επιπέδου που\\ufffds είτε συνδεδεμένη είτε μη συνδεδεμένη με το επίπεδο Smart Object. Δοκιμάστε διάφορα σχέδια με εικόνες placeholder χαμηλής ανάλυσης που θα αντικαταστήσετε αργότερα με τις τελικές εκδόσεις. Στο Adobe\\ufffd Photoshop\\ufffd, μπορείτε να ενσωματώσετε τα περιεχόμενα μιας εικόνας σε ένα έγγραφο PSD. Περισσότερες πληροφορίες εδώ:   Ένα επίπεδο με ενσωματωμένο smart object περιέχει πόρους placed (PlLd) και SoLd με ιδιότητες smart object. Ο πόρος PlLd μπορεί να είναι μόνος για εκδόσεις PSD παλαιότερες από το 10. Αυτοί οι πόροι περιέχουν UniqueId του LiFdDataSource στο global Lnk2Resource με το ενσωματωμένο όνομα αρχείου και άλλες παραμέτρους, συμπεριλαμβανομένων των ενσωματωμένων περιεχομένων αρχείου στην αρχική μορφή ως byte array.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Αρχικοποιεί μια νέα παρουσία της κλάσης [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [BlendSignature](#BlendSignature) | Αναπαριστά την υπογραφή λειτουργίας ανάμειξης. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Το μήνυμα που βρέθηκε για τους πόρους placed και smart object |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Το μήνυμα Μπορείτε μόνο να αντιγράψετε ένα ενσωματωμένο smart object |
| [LayerHeaderSize](#LayerHeaderSize) | Το μέγεθος κεφαλίδας του στρώματος. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Δεν υπάρχει μήνυμα για πόρο τοποθετημένου ή έξυπνου αντικειμένου |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Το μήνυμα λανθασμένων δεικτών τοποθετημένου πόρου |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Μετατρέπει αυτό το ενσωματωμένο έξυπνο αντικείμενο σε συνδεδεμένο έξυπνο αντικείμενο. |
...
| [duplicateLayer()](#duplicateLayer--) | Δημιουργεί ένα νέο επίπεδο έξυπνου αντικειμένου αντιγράφοντας αυτό. |
| [embedLinked()](#embedLinked--) | Ενσωματώνει το συνδεδεμένο έξυπνο αντικείμενο σε αυτό το επίπεδο. |
| [equals(Object obj)](#equals-java.lang.Object-) | Καθορίζει εάν το καθορισμένο Object είναι ίσο με αυτήν την παρουσία. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Εξάγει τα ενσωματωμένα ή συνδεδεμένα περιεχόμενα σε ένα αρχείο. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Ανακτά ή ορίζει την απόδοση παραμόρφωσης ή τη χρήση εικόνας PS. |
...
| [getContentType()](#getContentType--) | Αποκτά τον τύπο του περιεχομένου του στρώματος smart object. |
| [getContents()](#getContents--) | Ανακτά ή ορίζει τα περιεχόμενα του επιπέδου έξυπνου αντικειμένου. |
| [getContentsBounds()](#getContentsBounds--) | Ανακτά ή ορίζει τα όρια του περιεχομένου του έξυπνου αντικειμένου. |
| [getContentsSource()](#getContentsSource--) | Ανακτά ή ορίζει την πηγή του περιεχομένου του έξυπνου αντικειμένου. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Ανακτά ή ορίζει το τελευταίο μέγεθος της εικόνας για παραμόρφωση. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Ανακτά ή ορίζει το αρχικό τετράπλευρο. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Ανακτά τους δείκτες του τοποθετημένου και έξυπνου πόρου επιπέδου και τον κατάλληλο τοποθετημένο πόρο. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Ανακτά τον τοποθετημένο πόρο επιπέδου. |
...
| [getSmartFilters()](#getSmartFilters--) | Ανακτά τα έξυπνα φίλτρα. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Ανακτά ή ορίζει το τετράπλευρο μετασχηματισμού. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Ανακτά συναρτήσεις που βοηθούν με την παραμόρφωση. |
| [getWarpSettings()](#getWarpSettings--) | Ανακτά ή ορίζει τις παραμέτρους παραμόρφωσης που ορίστηκαν ή ανακτήθηκαν από τον πόρο (προεπιλογή). |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Ανακτά τα ενσωματωμένα ή συνδεδεμένα περιεχόμενα εικόνας του επιπέδου έξυπνου αντικειμένου. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Δημιουργεί ένα νέο επίπεδο έξυπνου αντικειμένου αντιγράφοντας αυτό. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Καλείται όταν ο περιέκτης αυτού του [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) έχει οριστεί. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Επανασυνδέει το συνδεδεμένο έξυπνο αντικείμενο σε ένα νέο αρχείο. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Αντικαθιστά τα περιεχόμενα του έξυπνου αντικειμένου που είναι ενσωματωμένα στο επίπεδο έξυπνου αντικειμένου. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Αντικαθιστά τα περιεχόμενα του έξυπνου αντικειμένου που είναι ενσωματωμένα στο επίπεδο έξυπνου αντικειμένου. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Αντικαθιστά τα περιεχόμενα με ένα αρχείο. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Αντικαθιστά τα περιεχόμενα με ένα αρχείο. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Αντικαθιστά τα περιεχόμενα με ένα αρχείο. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Αντικαθιστά τα περιεχόμενα με ένα αρχείο. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Αλλάζει το μέγεθος των δεδομένων καναλιών |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Ανακτά ή ορίζει την απόδοση παραμόρφωσης ή τη χρήση εικόνας PS. |
...
| [setContents(byte[] value)](#setContents-byte---) | Ανακτά ή ορίζει τα περιεχόμενα του επιπέδου έξυπνου αντικειμένου. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Ανακτά ή ορίζει τα όρια του περιεχομένου του έξυπνου αντικειμένου. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Ανακτά ή ορίζει την πηγή του περιεχομένου του έξυπνου αντικειμένου. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Ανακτά ή ορίζει το τελευταίο μέγεθος της εικόνας για παραμόρφωση. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Ανακτά ή ορίζει το αρχικό τετράπλευρο. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Λαμβάνει τον πάροχο έξυπνου αντικειμένου. |
| [setTop(int value)](#setTop-int-) | Λαμβάνει ή ορίζει τη θέση του ανώτερου επιπέδου. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Ανακτά ή ορίζει το τετράπλευρο μετασχηματισμού. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Ανακτά ή ορίζει τις παραμέτρους παραμόρφωσης που ορίστηκαν ή ανακτήθηκαν από τον πόρο (προεπιλογή). |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Ενημερώνει το αναγνωριστικό της πηγής δεδομένων. |
| [updateModifiedContent()](#updateModifiedContent--) | Ενημερώνει την κρυφή μνήμη εικόνας του επιπέδου έξυπνου αντικειμένου με το τροποποιημένο περιεχόμενο. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Ενημερώνει την κρυφή μνήμη εικόνας του επιπέδου έξυπνου αντικειμένου με τροποποιημένο περιεχόμενο. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Ενημερώνει τους τοποθετημένους / έξυπνους πόρους όταν το placedResource αλλάζει ή όταν απαιτείται μετατροπή. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Είναι περιτύλιγμα για το "IWarpSupport" για την ενημέρωση της προεπισκόπησης του επιπέδου |
| [wait()](#wait--) |  |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Η ροή των στοιχείων |
...
Το μήνυμα που βρέθηκε για τους πόρους placed και smart object
...
Το μήνυμα Μπορείτε μόνο να αντιγράψετε ένα ενσωματωμένο smart object
...
Δεν υπάρχει μήνυμα για πόρο τοποθετημένου ή έξυπνου αντικειμένου
...
Το μήνυμα λανθασμένων δεικτών τοποθετημένου πόρου
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| linkedPath | java.lang.String | Η συνδεδεμένη διαδρομή. |
...
Δημιουργεί ένα νέο επίπεδο έξυπνου αντικειμένου αντιγράφοντας αυτό. Σημειώστε ότι για ενσωματωμένα έξυπνα αντικείμενα η ενσωματωμένη εικόνα είναι κοινόχρηστη. Εάν θέλετε να αντιγράψετε την ενσωματωμένη εικόνα, χρησιμοποιήστε τη μέθοδο [.newSmartObjectViaCopy](../../null/\\#newSmartObjectViaCopy).
...
Ενσωματώνει το συνδεδεμένο έξυπνο αντικείμενο σε αυτό το επίπεδο.
...
Εξάγει τα ενσωματωμένα ή συνδεδεμένα περιεχόμενα σε ένα αρχείο.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| filePath | java.lang.String | Η διαδρομή αρχείου εξαγωγής. |
...
Ανακτά ή ορίζει την απόδοση παραμόρφωσης ή τη χρήση εικόνας PS.
...
Λαμβάνει τον τύπο του περιεχομένου του επιπέδου έξυπνου αντικειμένου. Τα ενσωματωμένα περιεχόμενα έξυπνου αντικειμένου είναι το ενσωματωμένο ακατέργαστο αρχείο εικόνας:  LiFdDataSource.Data . Τα συνδεδεμένα περιεχόμενα έξυπνου αντικειμένου είναι το ακατέργαστο περιεχόμενο του συνδεδεμένου αρχείου εικόνας εάν είναι διαθέσιμο: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Δεν υποστηρίζουμε τη φόρτωση από τη βιβλιοθήκη γραφικών Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd όταν το LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)) είναι αληθές. Για κανονικά αρχεία συνδέσμου, αρχικά, χρησιμοποιούμε το LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)) για να αναζητήσουμε το αρχείο σχετικά με τη διαδρομή εικόνας προέλευσης DataStreamSupporter.SourceImagePath, εάν δεν είναι διαθέσιμο κοιτάζουμε στο LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)), αν όχι, τότε αναζητούμε το αρχείο συνδέσμου στον ίδιο φάκελο όπου βρίσκεται η εικόνα μας: DataStreamSupporter.SourceImagePath .

Τιμή: Ο τύπος του περιεχομένου του επιπέδου έξυπνου αντικειμένου.
...
Λαμβάνει ή ορίζει τα περιεχόμενα του επιπέδου έξυπνου αντικειμένου. Τα ενσωματωμένα περιεχόμενα έξυπνου αντικειμένου είναι το ενσωματωμένο ακατέργαστο αρχείο εικόνας:  LiFdDataSource.Data  και οι ιδιότητές του. Τα συνδεδεμένα περιεχόμενα έξυπνου αντικειμένου είναι το ακατέργαστο περιεχόμενο του συνδεδεμένου αρχείου εικόνας εάν είναι διαθέσιμο και οι ιδιότητές του: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Δεν υποστηρίζουμε τη φόρτωση από τη βιβλιοθήκη γραφικών Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd όταν το LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\\#setLibraryLink-boolean-)) είναι αληθές. Για κανονικά αρχεία συνδέσμου, αρχικά, χρησιμοποιούμε το LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setRelativePath-String-)) για να αναζητήσουμε το αρχείο σχετικά με τη διαδρομή εικόνας προέλευσης DataStreamSupporter.SourceImagePath, εάν δεν είναι διαθέσιμο κοιτάζουμε στο LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\\#setFullPath-String-)), αν όχι, τότε αναζητούμε το αρχείο συνδέσμου στον ίδιο φάκελο όπου βρίσκεται η εικόνα μας: DataStreamSupporter.SourceImagePath .
...
Ανακτά ή ορίζει τα όρια του περιεχομένου του έξυπνου αντικειμένου.

Τιμή: Τα όρια του έξυπνου αντικειμένου.
...
Ανακτά ή ορίζει την πηγή του περιεχομένου του έξυπνου αντικειμένου.

Τιμή: Η πηγή δεδομένων του έξυπνου αντικειμένου.
...
Ανακτά ή ορίζει το τελευταίο μέγεθος της εικόνας για παραμόρφωση.
...
Ανακτά ή ορίζει το αρχικό τετράπλευρο.

Τιμή: Το αρχικό τετράπλευρο.
...
Ανακτά τους δείκτες του τοποθετημένου και έξυπνου πόρου επιπέδου και τον κατάλληλο τοποθετημένο πόρο.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Οι πόροι. |
| placedResourceIndex | int[] | Δείκτης του τοποθετημένου πόρου. |
| smartResourceIndex | int[] | Δείκτης του έξυπνου πόρου. |
...
Ανακτά τον τοποθετημένο πόρο επιπέδου.
...
Ανακτά ή ορίζει το τετράπλευρο μετασχηματισμού.

Τιμή: Το τετράπλευρο μετασχηματισμού.
...
Ανακτά συναρτήσεις που βοηθούν με την παραμόρφωση.
...
Ανακτά ή ορίζει τις παραμέτρους παραμόρφωσης που ορίστηκαν ή ανακτήθηκαν από τον πόρο (προεπιλογή).
...
Ανακτά τα ενσωματωμένα ή συνδεδεμένα περιεχόμενα εικόνας του επιπέδου έξυπνου αντικειμένου.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Οι επιλογές. |
...
Δημιουργεί ένα νέο επίπεδο έξυπνου αντικειμένου αντιγράφοντας αυτό. Αναπαράγει Layer -> Smart Objects -> New Smart Object μέσω της λειτουργίας Copy του Adobe\ufffd Photoshop\ufffd. Σημειώστε ότι είναι ενεργοποιημένο μόνο για ενσωματωμένα έξυπνα αντικείμενα επειδή η ενσωματωμένη εικόνα επίσης αντιγράφεται. Εάν θέλετε να μοιραστείτε την ενσωματωμένη εικόνα, χρησιμοποιήστε τη μέθοδο [.duplicateLayer](../../null/\#duplicateLayer).
...
Καλείται όταν ο περιέκτης αυτού του [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) έχει οριστεί.
...
Επανασυνδέει το συνδεδεμένο έξυπνο αντικείμενο σε νέο αρχείο. Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά.
...
Αντικαθιστά τα περιεχόμενα του έξυπνου αντικειμένου που είναι ενσωματωμένα στο επίπεδο έξυπνου αντικειμένου.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Η εικόνα. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Η εικόνα. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Οι ρυθμίσεις ανάλυσης. Εάν είναι null, θα χρησιμοποιηθεί η ανάλυση της εικόνας. |
...
Αντικαθιστά το περιεχόμενο με ένα αρχείο. Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Η συνδεδεμένη διαδρομή. |
| isReplaceOnlyThis | boolean | Η σημαία δείχνει την αντικατάσταση του περιεχομένου από αυτό το Smart Layer ή σε όλα τα Smart Layers με αυτό το περιεχόμενο. |
...
Αλλάζει το μέγεθος των δεδομένων καναλιών
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Ενημερώνει το αναγνωριστικό της πηγής δεδομένων.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | Το αναγνωριστικό της πηγής δεδομένων. |
...
Ενημερώνει την κρυφή μνήμη εικόνας του επιπέδου έξυπνου αντικειμένου με το τροποποιημένο περιεχόμενο.
...
Ενημερώνει την κρυφή μνήμη εικόνας του επιπέδου έξυπνου αντικειμένου με τροποποιημένο περιεχόμενο.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Η εικόνα. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Η ανάλυση. |
| skipBoundsUpdate | boolean | αν οριστεί σε  true  [παράλειψη ενημέρωσης ορίων]. |
...
Ενημερώνει τους τοποθετημένους / έξυπνους πόρους όταν το placedResource αλλάζει ή όταν απαιτείται μετατροπή.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| toEmbedded | boolean | αν οριστεί σε  true  μετατρέπει σε ενσωματωμένο πόρο εάν χρειάζεται, διαφορετικά σε συνδεδεμένο. |
...
Είναι περιτύλιγμα για το "IWarpSupport" για την ενημέρωση της προεπισκόπησης του επιπέδου

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Εικονοστοιχεία και μέγεθος νέας εικόνας προεπισκόπησης |
