...
description: "Συμπιεσμένες τιμές fourCC για τη μέθοδο παρεμβολής διαβάθμισης του Photoshop."
type: docs
weight: 18
url: /el/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Συμπιεσμένες τιμές fourCC για τη μέθοδο παρεμβολής gradient του Photoshop. Κλειδί περιγραφέα: "gradientsInterpolationMethod"
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Κλασικό (προεπιλογή κληρονομίας όταν το κλειδί λείπει). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Γραμμικό (σημειώστε το κενό στο τέλος). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Αντιληπτικό. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Ομαλό. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Ρίγες. |
## Μέθοδοι
...
'Gcls' \\u2014 Κλασικό (προεπιλογή κληρονομίας όταν το κλειδί λείπει).
...
'Lnr ' \\u2014 Γραμμικό (σημειώστε το κενό στο τέλος).
