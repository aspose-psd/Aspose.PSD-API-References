...
description: "Ο τύπος γεμίσματος"
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd.layers.fillsettings/filltype/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [Color](#Color) | Ο τύπος γεμίσματος χρώματος |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gradient](#Gradient) | Ο τύπος γεμίσματος κλίσης |
| [Pattern](#Pattern) | Ο τύπος γεμίσματος μοτίβου |
## Μέθοδοι
