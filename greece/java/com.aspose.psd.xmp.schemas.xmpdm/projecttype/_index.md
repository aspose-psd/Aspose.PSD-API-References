...
description: "Αναπαριστά τον τύπο έργου στο XmpDynamicMediaPackage."
type: docs
weight: 12
url: /el/java/com.aspose.psd.xmp.schemas.xmpdm/projecttype/
---
...
Αντιπροσωπεύει τον τύπο έργου στο XmpDynamicMediaPackage.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Audio](#Audio) | Ο τύπος έργου ήχου |
| [Custom](#Custom) | Ο προσαρμοσμένος τύπος έργου |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Movie](#Movie) | Ο τύπος έργου ταινίας |
| [Still](#Still) | Ο τύπος έργου στατικού |
## Μέθοδοι
