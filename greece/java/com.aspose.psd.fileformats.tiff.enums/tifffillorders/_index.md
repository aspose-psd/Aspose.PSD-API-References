...
description: "Διάταξη δεδομένων μέσα σε ένα byte. Πιθανές τιμές για την ετικέτα FILLORDER."
type: docs
weight: 17
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tifffillorders/
---
...
Σειρά δεδομένων μέσα σε ένα byte.

Πιθανές τιμές για την ετικέτα FILLORDER.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Lsb2Msb](#Lsb2Msb) | Λιγότερο σημαντικό -> περισσότερο. |
| [Msb2Lsb](#Msb2Lsb) | Περισσότερο σημαντικό -> λιγότερο. |
## Μέθοδοι
...
Λιγότερο σημαντικό -> περισσότερο.
...
Περισσότερο σημαντικό -> λιγότερο.
