...
description: "Η σειρά των bytes για την εικόνα tiff."
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
Η σειρά των bytes για την εικόνα tiff.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [BigEndian](#BigEndian) | Η σειρά byte big endian (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | Η σειρά byte little endian (Intel). |
## Μέθοδοι
...
Η σειρά byte big endian (Motorola).
...
Η σειρά byte little endian (Intel).
