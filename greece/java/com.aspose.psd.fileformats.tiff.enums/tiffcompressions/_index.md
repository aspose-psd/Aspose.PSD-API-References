...
description: "Περιέχει τύπους συμπίεσης."
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffcompressions/
---
...
Περιέχει τύπους συμπίεσης.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [AdobeDeflate](#AdobeDeflate) | Συμπίεση Deflate, όπως αναγνωρίζεται από την Adobe. |
| [CcittFax3](#CcittFax3) | Κωδικοποίηση φαξ CCITT Group 3. |
| [CcittFax4](#CcittFax4) | Κωδικοποίηση φαξ CCITT Group 4. |
| [CcittRle](#CcittRle) | Τροποποιημένο Huffman RLE της CCITT. |
| [CcittRleW](#CcittRleW) | CCITT RLE. |
| [Dcs](#Dcs) | Κωδικοποίηση Kodak DCS. |
| [Deflate](#Deflate) | Συμπίεση Deflate. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [It8Bl](#It8Bl) | Δυαδική γραφική τέχνη IT8. |
| [It8Ctpad](#It8Ctpad) | IT8 CT με padding. |
| [It8Lw](#It8Lw) | IT8 Linework RLE. |
| [It8Mp](#It8Mp) | Μονόχρωμη εικόνα IT8. |
| [Jbig](#Jbig) | ISO Jpeg μεγάλο. |
| [Jp2000](#Jp2000) | Leadtools JPEG2000. |
| [Jpeg](#Jpeg) | Συμπίεση JPEG DCT. |
| [Lzw](#Lzw) | Lempel-Ziv & Welch. |
| [Next](#Next) | NeXT 2-bit RLE. |
| [None](#None) | Λειτουργία απορριμμάτων. |
| [Ojpeg](#Ojpeg) | Αρχικό JPEG / Παλαιού‑στυλ JPEG (6.0). |
| [Packbits](#Packbits) | Macintosh RLE. |
| [PixarFilm](#PixarFilm) | Pixar συμπιεσμένο 10bit LZW. |
| [PixarLog](#PixarLog) | Pixar συμπιεσμένο 11bit ZIP. |
...
Συμπίεση Deflate, όπως αναγνωρίζεται από την Adobe.
...
Κωδικοποίηση φαξ CCITT Group 3.
...
Κωδικοποίηση φαξ CCITT Group 4.
...
Τροποποιημένο Huffman RLE της CCITT.
...
Κωδικοποίηση Kodak DCS. Κρατημένο για Oceana Matrix.
...
IT8 Δυαδική γραφική τέχνη. Κρατημένο για ANSI IT8 TIFF/IT.
...
IT8 CT με συμπλήρωση. Κρατημένο για ANSI IT8 TIFF/IT.
...
IT8 Γραμμική εργασία RLE. Κρατημένο για ANSI IT8 TIFF/IT.
...
IT8 Μονόχρωμη εικόνα. Κρατημένο για ANSI IT8 TIFF/IT.
...
Συμπίεση JPEG DCT. Εισήχθη μετά την έκδοση TIFF rev 6.0.
...
Αρχικό JPEG / Παλαιού‑στυλ JPEG (6.0).
...
Pixar συμπιεσμένο 10bit LZW. Κρατημένο για Pixar.
...
Pixar συμπιεσμένο 11bit ZIP. Κρατημένο για Pixar.
