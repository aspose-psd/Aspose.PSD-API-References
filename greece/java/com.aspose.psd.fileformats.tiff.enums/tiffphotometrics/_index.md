...
description: "Enum παρεμβολής φωτομετρίας"
type: docs
weight: 20
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffphotometrics/
---
...
| [Mask](#Mask) | [παρωχημένο από TIFF rev. |
| [MinIsBlack](#MinIsBlack) | Η ελάχιστη τιμή είναι μαύρο. |
| [MinIsWhite](#MinIsWhite) | Η ελάχιστη τιμή είναι λευκό. |
| [Palette](#Palette) | Χρωματικός χάρτης ευρετηριασμένος. |
| [Rgb](#Rgb) | Μοντέλο χρώματος RGB. |
| [Separated](#Separated) | Διαχωρισμοί χρώματος. |
| [Ycbcr](#Ycbcr) | Το CCIR 601. |
## Μέθοδοι
...
ICC L\*a\*b\*. Εισήχθη μετά την έκδοση TIFF rev 6.0 από το Adobe TIFF Technote 4.
...
Χρωματικός χάρτης ευρετηριασμένος.
