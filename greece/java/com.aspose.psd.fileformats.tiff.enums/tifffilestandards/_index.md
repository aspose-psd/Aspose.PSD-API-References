...
description: "Καθορίζει τα πρότυπα μορφής αρχείου TIFF."
type: docs
weight: 16
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [Baseline](#Baseline) | Το βασικό πρότυπο αρχείου TIFF 6.0. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extended](#Extended) | Το επεκταμένο πρότυπο αρχείου TIFF 6.0. |
## Μέθοδοι
...
Το βασικό πρότυπο αρχείου TIFF 6.0. Αυτό το πρότυπο είναι επίσημα γνωστό ως TIFF 6.0, Μέρος 1: Baseline TIFF.
...
Το επεκταμένο πρότυπο αρχείου TIFF 6.0. Αυτό το πρότυπο είναι επίσημα γνωστό ως Extended TIFF 6.0, Μέρος 2: TIFF Extensions.
