...
description: "Enum μονάδας ανάλυσης Tiff"
type: docs
weight: 23
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffresolutionunits/
---
...
Enum μονάδας ανάλυσης Tiff
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Centimeter](#Centimeter) | Μετρικό σύστημα. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inch](#Inch) | Αγγλικό σύστημα. |
| [None](#None) | Δεν υπάρχουν ουσιαστικές μονάδες. |
## Μέθοδοι
...
Δεν υπάρχουν ουσιαστικές μονάδες.
