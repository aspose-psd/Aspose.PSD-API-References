...
description: "Σχήμα πρόβλεψης για LZW"
type: docs
weight: 22
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffpredictor/
---
...
Σχήμα πρόβλεψης για LZW
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Horizontal](#Horizontal) | Οριζόντια διαφοροποίηση. |
| [None](#None) | Δεν χρησιμοποιείται σχήμα πρόβλεψης. |
## Μέθοδοι
...
Δεν χρησιμοποιείται σχήμα πρόβλεψης.
