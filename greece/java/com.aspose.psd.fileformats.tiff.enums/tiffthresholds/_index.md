...
description: "Καθορισμός κατωφλίου που χρησιμοποιείται στα δεδομένα."
type: docs
weight: 26
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffthresholds/
---
...
| [ErrorDiffuse](#ErrorDiffuse) | Συνήθως Floyd-Steinberg. |
| [HalfTone](#HalfTone) | Σάρωση με θόρυβο. |
| [NoDithering](#NoDithering) | Δεν εκτελείται θόρυβος. |
## Μέθοδοι
