...
description: "Οργάνωση αποθήκευσης. Πιθανές τιμές για την ετικέτα PLANARCONFIG."
type: docs
weight: 21
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffplanarconfigs/
---
...
Πιθανές τιμές για την ετικέτα PLANARCONFIG.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Contiguous](#Contiguous) | Μονοεπίπεδο εικόνας. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Separate](#Separate) | Ξεχωριστά επίπεδα δεδομένων. |
## Μέθοδοι
