...
description: "Enum μορφής δείγματος"
type: docs
weight: 24
url: /el/java/com.aspose.psd.fileformats.tiff.enums/tiffsampleformats/
---
...
Enum μορφής δείγματος
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [ComplexIeeeFp](#ComplexIeeeFp) | Σύνθετος ieee floating |
| [ComplexInt](#ComplexInt) | Σύνθετος υπογεγραμμένος ακέραιος |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [IeeeFp](#IeeeFp) | Δεδομένα πλωτής υποδιαστολής IEEE |
| [Int](#Int) | Δεδομένα υπογεγραμμένου ακέραιου |
| [Uint](#Uint) | Δεδομένα μη υπογεγραμμένου ακέραιου |
| [Void](#Void) | Δεδομένα χωρίς τύπο |
## Μέθοδοι
...
Σύνθετος υπογεγραμμένος ακέραιος
...
Δεδομένα πλωτής υποδιαστολής IEEE
...
Δεδομένα υπογεγραμμένου ακέραιου
...
Δεδομένα μη υπογεγραμμένου ακέραιου
