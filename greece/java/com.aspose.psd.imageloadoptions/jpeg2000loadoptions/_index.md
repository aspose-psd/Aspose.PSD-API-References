...
description: "Επιλογές φόρτωσης JPEG2000"
type: docs
weight: 10
url: /el/java/com.aspose.psd.imageloadoptions/jpeg2000loadoptions/
---
...
Επιλογές φόρτωσης JPEG2000
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [Jpeg2000LoadOptions()](#Jpeg2000LoadOptions--) | Αρχικοποιεί μια νέα παρουσία της κλάσης  Jpeg2000LoadOptions  . |
## Πεδία
...
| [getDefaultMaximumDecodingTime_internalized()](#getDefaultMaximumDecodingTime-internalized--) | Λαμβάνει το προεπιλεγμένο μέγιστο χρόνο αποκωδικοποίησης. |
| [getIgnoreAfterLoad_internalized()](#getIgnoreAfterLoad-internalized--) | Λαμβάνει μια τιμή που υποδεικνύει εάν [ignore after load]. |
| [getMaximumDecodingTime()](#getMaximumDecodingTime--) | Λαμβάνει το μέγιστο χρόνο αποκωδικοποίησης σε δευτερόλεπτα (αυτή η επιλογή μπορεί να χρησιμοποιηθεί σε πολύ αργούς ή μηχανές με περιορισμένη μνήμη για να αποτρέψει το κλείδωμα της διαδικασίας σε πολύ μεγάλες εικόνες - ανάλυση μεγαλύτερη από 5500x6500 pixels). |
| [getMaximumDecodingTimeForTile()](#getMaximumDecodingTimeForTile--) | Λαμβάνει το μέγιστο χρόνο αποκωδικοποίησης για το πλακίδιο. |
...
| [setDefaultMaximumDecodingTime_internalized(int value)](#setDefaultMaximumDecodingTime-internalized-int-) | Ορίζει το προεπιλεγμένο μέγιστο χρόνο αποκωδικοποίησης. |
...
| [setMaximumDecodingTime(int value)](#setMaximumDecodingTime-int-) | Ορίζει το μέγιστο χρόνο αποκωδικοποίησης σε δευτερόλεπτα (αυτή η επιλογή μπορεί να χρησιμοποιηθεί σε πολύ αργές μηχανές με περιορισμένη μνήμη για να αποτρέψει το κλείσιμο της διαδικασίας σε πολύ μεγάλες εικόνες - ανάλυση μεγαλύτερη από 5500x6500 pixels). |
| [setMaximumDecodingTimeForTile(int value)](#setMaximumDecodingTimeForTile-int-) | Ορίζει το μέγιστο χρόνο αποκωδικοποίησης για το πλακίδιο. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης  Jpeg2000LoadOptions  .
...
Λαμβάνει το προεπιλεγμένο μέγιστο χρόνο αποκωδικοποίησης.

**Returns:**
int - Ο προεπιλεγμένος μέγιστος χρόνος αποκωδικοποίησης.
...
Λαμβάνει το μέγιστο χρόνο αποκωδικοποίησης σε δευτερόλεπτα (αυτή η επιλογή μπορεί να χρησιμοποιηθεί σε πολύ αργούς ή μηχανές με περιορισμένη μνήμη για να αποτρέψει το κλείδωμα της διαδικασίας σε πολύ μεγάλες εικόνες - ανάλυση μεγαλύτερη από 5500x6500 pixels).

**Returns:**
int - Ο μέγιστος χρόνος αποκωδικοποίησης.
...
Λαμβάνει το μέγιστο χρόνο αποκωδικοποίησης για το πλακίδιο.

Τιμή: Ο μέγιστος χρόνος αποκωδικοποίησης για το πλακίδιο.

**Returns:**
int - ο μέγιστος χρόνος αποκωδικοποίησης για το πλακίδιο.
...
Ορίζει το προεπιλεγμένο μέγιστο χρόνο αποκωδικοποίησης.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | Ο προεπιλεγμένος μέγιστος χρόνος αποκωδικοποίησης. |
...
Ορίζει το μέγιστο χρόνο αποκωδικοποίησης σε δευτερόλεπτα (αυτή η επιλογή μπορεί να χρησιμοποιηθεί σε πολύ αργές μηχανές με περιορισμένη μνήμη για να αποτρέψει το κλείσιμο της διαδικασίας σε πολύ μεγάλες εικόνες - ανάλυση μεγαλύτερη από 5500x6500 pixels).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | Ο μέγιστος χρόνος αποκωδικοποίησης. |
...
Ορίζει το μέγιστο χρόνο αποκωδικοποίησης για το πλακίδιο.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | ο μέγιστος χρόνος αποκωδικοποίησης για πλακίδιο. |
