...
description: "Αναπαριστά ένα ορθογώνιο σχήμα."
type: docs
weight: 17
url: /el/java/com.aspose.psd.shapes/rectangleshape/
---
...
| --- | --- |
| [RectangleShape()](#RectangleShape--) | Αρχικοποιεί μια νέα παρουσία της  RectangleShape  κλάσης. |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.psd.RectangleF-) | Αρχικοποιεί μια νέα παρουσία της  RectangleShape  κλάσης. |
## Μέθοδοι
...
Αρχικοποιεί μια νέα παρουσία της  RectangleShape  κλάσης.
