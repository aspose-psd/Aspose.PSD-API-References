...
description: "Αναπαριστά ένα σχήμα πολυγώνου."
type: docs
weight: 15
url: /el/java/com.aspose.psd.shapes/polygonshape/
---
...
| --- | --- |
| [PolygonShape()](#PolygonShape--) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης  PolygonShape . |
| [PolygonShape(PointF[] points)](#PolygonShape-com.aspose.psd.PointF---) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης  PolygonShape . |
| [PolygonShape(PointF[] points, boolean isClosed)](#PolygonShape-com.aspose.psd.PointF---boolean-) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης  PolygonShape . |
## Μέθοδοι
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης  PolygonShape .
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | Ο πίνακας σημείων. |
| isClosed | boolean | Εάν οριστεί σε  true  το πολύγωνο είναι κλειστό. |
