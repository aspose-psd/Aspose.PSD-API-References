...
description: "Ο πόρος δεδομένων πληροφοριών του Πίνακα Σχεδίασης."
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.artboardresources/baseartboardinforesource/
---
...
Ο πόρος δεδομένων πληροφοριών του Πίνακα Σχεδίασης.
## Πεδία
