...
description: "exif λειτουργία μέτρησης απαριθμήσεις."
type: docs
weight: 20
url: /el/java/com.aspose.psd.exif.enums/exifmeteringmode/
---
...
exif λειτουργία μέτρησης απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Average](#Average) | Μέτρηση μέσου όρου |
| [Centerweightedaverage](#Centerweightedaverage) | Κεντρική βαρυμένη μέση. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MultiSegment](#MultiSegment) | Πολλαπλή τμηματική μέτρηση. |
| [MultiSpot](#MultiSpot) | Πολλαπλή σημειακή μέτρηση |
| [Other](#Other) | Για άλλες λειτουργίες. |
| [Partial](#Partial) | Μερική μέτρηση. |
| [Spot](#Spot) | Σημειακή μέτρηση |
| [Unknown](#Unknown) | Μη καθορισμένη λειτουργία |
## Μέθοδοι
