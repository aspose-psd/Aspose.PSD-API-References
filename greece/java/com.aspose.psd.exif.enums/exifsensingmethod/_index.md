...
description: "exif μέθοδος ανίχνευσης απαριθμήσεις."
type: docs
weight: 24
url: /el/java/com.aspose.psd.exif.enums/exifsensingmethod/
---
...
exif μέθοδος ανίχνευσης απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Colorsequentialarea](#Colorsequentialarea) | Περιοχή χρωματικής ακολουθίας. |
| [Colorsequentiallinear](#Colorsequentiallinear) | Γραμμικός αισθητήρας χρωματικής ακολουθίας. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Notdefined](#Notdefined) | Δεν ορίζεται. |
| [OneChipColorArea](#OneChipColorArea) | Περιοχή χρώματος με ένα chip. |
| [ThreeChipColorArea](#ThreeChipColorArea) | Περιοχή χρώματος με τρία chip. |
| [Trilinearsensor](#Trilinearsensor) | Τριγραμμικός αισθητήρας. |
| [TwoChipColorArea](#TwoChipColorArea) | Περιοχή χρώματος με δύο chip. |
## Μέθοδοι
...
Γραμμικός αισθητήρας χρωματικής ακολουθίας.
