...
description: "enums προσαρμοσμένων αποδομένων exif."
type: docs
weight: 12
url: /el/java/com.aspose.psd.exif.enums/exifcustomrendered/
---
...
enums προσαρμοσμένων αποδομένων exif.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [CustomProcess](#CustomProcess) | Προσαρμοσμένη διαδικασία απόδοσης. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NormalProcess](#NormalProcess) | Κανονική διαδικασία απόδοσης. |
## Μέθοδοι
...
Προσαρμοσμένη διαδικασία απόδοσης.
