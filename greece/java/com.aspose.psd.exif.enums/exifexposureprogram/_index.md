...
description: "exif πρόγραμμα έκθεσης απαριθμήσεις."
type: docs
weight: 14
url: /el/java/com.aspose.psd.exif.enums/exifexposureprogram/
---
...
exif πρόγραμμα έκθεσης απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Actionprogram](#Actionprogram) | Πρόγραμμα δράσης. |
| [Aperturepriority](#Aperturepriority) | Προτεραιότητα διαφράγματος. |
| [Auto](#Auto) | Αυτόματη έκθεση. |
| [Creativeprogram](#Creativeprogram) | Δημιουργικό πρόγραμμα. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Landscapemode](#Landscapemode) | Λειτουργία τοπίου. |
| [Manual](#Manual) | Χειροκίνητο πρόγραμμα. |
| [Notdefined](#Notdefined) | Δεν ορίζεται. |
| [Portraitmode](#Portraitmode) | Λειτουργία πορτραίτου. |
| [Shutterpriority](#Shutterpriority) | Προτεραιότητα κλείστρου. |
## Μέθοδοι
