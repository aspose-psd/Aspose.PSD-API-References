...
description: "exif εύρος απόστασης θέματος απαριθμήσεις."
type: docs
weight: 25
url: /el/java/com.aspose.psd.exif.enums/exifsubjectdistancerange/
---
...
exif εύρος απόστασης θέματος απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [CloseView](#CloseView) | Κοντινή προβολή. |
| [DistantView](#DistantView) | Απομακρυσμένη προβολή. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Macro](#Macro) | Μακροεύρος |
| [Unknown](#Unknown) | Άγνωστο εύρος απόστασης θέματος |
## Μέθοδοι
...
Άγνωστο εύρος απόστασης θέματος
