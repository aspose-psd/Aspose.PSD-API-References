...
description: "exif έλεγχος κέρδους απαριθμήσεις."
type: docs
weight: 18
url: /el/java/com.aspose.psd.exif.enums/exifgaincontrol/
---
...
exif έλεγχος κέρδους απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HighGainDown](#HighGainDown) | Μείωση υψηλού κέρδους. |
| [HighGainUp](#HighGainUp) | Αύξηση υψηλού κέρδους. |
| [LowGainDown](#LowGainDown) | Μείωση χαμηλού κέρδους. |
| [LowGainUp](#LowGainUp) | Αύξηση χαμηλού κέρδους. |
| [None](#None) | Χωρίς έλεγχο κέρδους. |
## Μέθοδοι
