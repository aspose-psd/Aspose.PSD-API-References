...
description: "exif τοποθέτηση y cb cr απαριθμήσεις."
type: docs
weight: 28
url: /el/java/com.aspose.psd.exif.enums/exifycbcrpositioning/
---
...
exif τοποθέτηση y cb cr απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Centered](#Centered) | Κεντραρισμένο YCbCr |
| [CoSited](#CoSited) | Συν-τοποθετημένη θέση |
