...
description: "exif gps αναφορά υψομέτρου απαριθμήσεις."
type: docs
weight: 17
url: /el/java/com.aspose.psd.exif.enums/exifgpsaltituderef/
---
...
exif gps αναφορά υψομέτρου απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [AboveSeaLevel](#AboveSeaLevel) | Πάνω από την επιφάνεια της θάλασσας. |
| [BelowSeaLevel](#BelowSeaLevel) | Κάτω από την επιφάνεια της θάλασσας. |
