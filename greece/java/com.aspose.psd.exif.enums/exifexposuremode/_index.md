...
description: "exif λειτουργία έκθεσης απαριθμήσεις."
type: docs
weight: 13
url: /el/java/com.aspose.psd.exif.enums/exifexposuremode/
---
...
exif λειτουργία έκθεσης απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Auto](#Auto) | Αυτόματη έκθεση. |
| [AutoBracket](#AutoBracket) | Αυτόματη παρενθέση. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | Χειροκίνητη έκθεση. |
## Μέθοδοι
