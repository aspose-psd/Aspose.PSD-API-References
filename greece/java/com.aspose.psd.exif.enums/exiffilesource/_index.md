...
description: "exif προέλευση αρχείου απαριθμήσεις."
type: docs
weight: 15
url: /el/java/com.aspose.psd.exif.enums/exiffilesource/
---
...
exif προέλευση αρχείου απαριθμήσεις.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [DigitalStillCamera](#DigitalStillCamera) | Ψηφιακή στατική κάμερα. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FilmScanner](#FilmScanner) | Σαρωτής φιλμ. |
| [Others](#Others) | Οι άλλοι. |
| [ReflexionPrintScanner](#ReflexionPrintScanner) | Σαρωτής εκτυπώσεων ανάκλασης. |
## Μέθοδοι
