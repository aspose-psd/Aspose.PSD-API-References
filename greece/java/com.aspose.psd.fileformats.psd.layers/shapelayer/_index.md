...
description: "Επίπεδο σχήματος."
type: docs
weight: 29
url: /el/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
com.aspose.internal.fileformats.psd.layers.IShapeLayer
```
public class ShapeLayer extends Layer implements IShapeLayer
```

Στρώμα σχήματος. Συνοψίζει τη λογική εργασίας με το στρώμα σχήματος και τους σχετικούς πόρους.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Πεδία
...
| [createInstance()](#createInstance--) | Δημιουργεί μια νέα παρουσία της κλάσης [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Ρυθμίσεις γεμίσματος για την εσωτερική περιοχή των Σχημάτων στο στρώμα σχήματος. |
...
| [getPath()](#getPath--) | Λαμβάνει το σύνολο των Διαδρομών που υπάρχουν σε ένα στρώμα σχήματος. |
...
| [getStroke()](#getStroke--) | Λαμβάνει ή ορίζει τις ρυθμίσεις Πινέλου των Σχημάτων. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Καλείται όταν [global resources changed]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Καλείται όταν [resources change]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Ρυθμίσεις γεμίσματος για την εσωτερική περιοχή των Σχημάτων στο στρώμα σχήματος. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Λαμβάνει ή ορίζει τις ρυθμίσεις Πινέλου των Σχημάτων. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Ενημερώνει τους πόρους από τις ιδιότητες του επιπέδου Shape. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) class. Όλοι οι πόροι δημιουργούνται στην προεπιλεγμένη τους κατάσταση.
...
Δημιουργεί μια νέα παρουσία της κλάσης [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).

**Returns:**
[ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) - Returns the new instance of the [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) class.
...
### create_internalized(PsdHeader header, IColorPalette palette) {#create-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-}
```
public static ShapeLayer create_internalized(PsdHeader header, IColorPalette palette)
```
...
**Returns:**
[ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer)
### create_internalized(System.IO.Stream stream) {#create-internalized-com.aspose.ms.System.IO.Stream-}
```
...
Ρυθμίσεις γεμίσματος για την εσωτερική περιοχή των Σχημάτων στο στρώμα σχήματος.
...
Λαμβάνει το σύνολο των Διαδρομών που υπάρχουν σε ένα στρώμα σχήματος.

**Returns:**
[IPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/ipath)
...
Λαμβάνει ή ορίζει τις ρυθμίσεις Πινέλου των Σχημάτων.

**Returns:**
[IStrokeSettings](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings)
...
**Returns:**
boolean - Boolean τιμή που υποδεικνύει ότι το επίπεδο είναι έγκυρο.
...
Καλείται όταν [global resources changed].

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sender | java.lang.Object | Ο sender. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | Το αντικείμενο EventArgs που περιέχει τα δεδομένα του γεγονότος. |
...
Καλείται όταν [resources change].
...
### setStroke(IStrokeSettings value) {#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-}
```
public final void setStroke(IStrokeSettings value)
```
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [IStrokeSettings](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings) |  |
...
Ενημερώνει τους πόρους από τις ιδιότητες του επιπέδου Shape.
