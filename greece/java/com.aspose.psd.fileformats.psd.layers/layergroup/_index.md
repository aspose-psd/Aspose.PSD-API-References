...
description: "Κλάση ομάδας επιπέδου"
type: docs
weight: 19
url: /el/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Λαμβάνει το ύψος της ομάδας στρωμάτων. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Λαμβάνει τα ενωμένα όρια όλων των στρωμάτων στην LayerGroup. |
...
| [getWidth()](#getWidth--) | Λαμβάνει το πλάτος της ομάδας στρωμάτων. |
...
Λαμβάνει το ύψος της ομάδας στρωμάτων.
...
Λαμβάνει τα ενωμένα όρια όλων των στρωμάτων στην LayerGroup.
...
Λαμβάνει το πλάτος της ομάδας στρωμάτων.
