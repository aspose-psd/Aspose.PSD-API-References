...
description: "Το στρώμα διαχωριστή ενότητας για να σημειώσει τα όρια της ομάδας στρωμάτων φακέλου."
type: docs
weight: 28
url: /el/java/com.aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
...
Το επίπεδο διαχωριστή ενότητας για να σημειώσει τα όρια του φακέλου (ομάδας επιπέδων).
## Πεδία
...
| [getRelatedLayerGroup()](#getRelatedLayerGroup--) | Αποκτά το [LayerGroup](../../com.aspose.psd.fileformats.psd.layers/layergroup) που σχετίζεται με αυτήν την παρουσία [SectionDividerLayer](../../com.aspose.psd.fileformats.psd.layers/sectiondividerlayer). |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LayerGroup](../../com.aspose.psd.fileformats.psd.layers/layergroup) με προεπιλεγμένους πόρους.
...
| layerNestedLevel | int | Επίπεδο ένθεσης του στρώματος. |
...
Αποκτά το [LayerGroup](../../com.aspose.psd.fileformats.psd.layers/layergroup) που σχετίζεται με αυτήν την παρουσία [SectionDividerLayer](../../com.aspose.psd.fileformats.psd.layers/sectiondividerlayer).
