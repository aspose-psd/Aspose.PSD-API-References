...
description: "Η κλάση επιπέδου κειμένου"
type: docs
weight: 30
url: /el/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Διορθώνει το μέγεθος της γραμματοσειράς. |
...
| [createInstance_internalized()](#createInstance-internalized--) | Δημιουργεί τη νέα παρουσία της κλάσης [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Δημιουργεί τη νέα παρουσία της κλάσης [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Ανακτά τα δεδομένα της μηχανής. |
...
| [getFont()](#getFont--) | Ανακτά τη γραμματοσειρά. |
| [getFonts()](#getFonts--) | Ανακτά το σύνολο γραμματοσειρών του στρώματος κειμένου. |
...
| [getInnerText()](#getInnerText--) | Ανακτά το κείμενο του στρώματος |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Ανακτά ή ορίζει τον επεξεργαστή πόρων. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Ανακτά τη μορφή συμβολοσειράς. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Λαμβάνει τη ρίζα συγχρονισμού. |
| [getText()](#getText--) | Λαμβάνει το κείμενο. |
| [getTextBoundBox()](#getTextBoundBox--) | Ανακτά ή ορίζει το πλαίσιο οριοθέτησης κειμένου. |
| [getTextColor()](#getTextColor--) | Ανακτά το χρώμα του κειμένου. |
| [getTextData()](#getTextData--) | Ανακτά τα τμήματα του κειμένου. |
| [getTop()](#getTop--) | Λαμβάνει ή ορίζει τη θέση του ανώτερου επιπέδου. |
| [getTransformMatrix()](#getTransformMatrix--) | Ανακτά ή ορίζει τον πίνακα μετασχηματισμού |
| [getTransparentColor()](#getTransparentColor--) | Λαμβάνει το διαφανές χρώμα της εικόνας. |
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Αναζητά και ανακτά τον πόρο [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) από το [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Ανακτά ή ορίζει μια τιμή που υποδεικνύει εάν [was changed]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Καθορίζει εάν [is font available] [the specified font]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Προεπεξεργάζεται τη γραμματοσειρά. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Αντικαθιστά τη γραμματοσειρά με την προεπιλογή. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Ανακτά το κείμενο του στρώματος |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Ανακτά ή ορίζει τον επεξεργαστή πόρων. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Ανακτά ή ορίζει το πλαίσιο οριοθέτησης κειμένου. |
| [setTop(int value)](#setTop-int-) | Λαμβάνει ή ορίζει τη θέση του ανώτερου επιπέδου. |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | Ανακτά ή ορίζει τον πίνακα μετασχηματισμού |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Ανακτά ή ορίζει μια τιμή που υποδεικνύει εάν [was changed]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Ενημερώνει τα όρια του [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) στους πόρους. |
| [updateText(String text)](#updateText-java.lang.String-) | Ενημερώνει το κείμενο. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Ενημερώνει το κείμενο. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Ενημερώνει το κείμενο. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Ενημερώνει το κείμενο. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Ενημερώνει το κείμενο. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Ενημερώνει το κείμενο. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Ενημερώνει το κείμενο. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Ενημερώνει το κείμενο. |
| [wait()](#wait--) |  |
...
Διορθώνει το μέγεθος της γραμματοσειράς.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| newSize | float | Νέο μέγεθος γραμματοσειράς |
| yyTransform | double | 'yy' Παράμετρος πίνακα μετασχηματισμού |

**Returns:**
float - Διορθωμένο μέγεθος
...
Δημιουργεί τη νέα παρουσία της κλάσης [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Ανακτά τα δεδομένα της μηχανής.

Τιμή: Τα δεδομένα μηχανής.
...
Ανακτά το σύνολο γραμματοσειρών του στρώματος κειμένου.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - Το σύνολο γραμματοσειρών του στρώματος κειμένου.
...
Ανακτά το κείμενο του στρώματος
...
Ανακτά ή ορίζει τον επεξεργαστή πόρων.

Τιμή: Ο επεξεργαστής πόρων.
...
Ανακτά τη μορφή συμβολοσειράς.

Τιμή: Η μορφή συμβολοσειράς.
...
Ανακτά ή ορίζει το πλαίσιο οριοθέτησης κειμένου.

Τιμή: Το πλαίσιο οριοθέτησης του κειμένου.
...
Ανακτά τα τμήματα του κειμένου.
...
Ανακτά ή ορίζει τον πίνακα μετασχηματισμού

Τιμή: Ο πίνακας μετασχηματισμού
...
Αναζητά και ανακτά τον πόρο [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) από το [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Ανακτά ή ορίζει μια τιμή που υποδεικνύει εάν [was changed].

Τιμή:  true  εάν [was changed]; διαφορετικά,  false .
...
Καθορίζει εάν [is font available] [the specified font].
...
**Returns:**
boolean - Αληθές εάν η γραμματοσειρά είναι διαθέσιμη
...
Προεπεξεργάζεται τη γραμματοσειρά.
...
Αντικαθιστά τη γραμματοσειρά με την προεπιλογή.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | Η γραμματοσειρά. |
| defaultFontName | java.lang.String | Προεπιλεγμένο όνομα της γραμματοσειράς. |
...
| newWidth | int | Το νέο πλάτος. |
| newHeight | int | Το νέο ύψος. |
| resizeType | int | Ο τύπος της μετασχηματισμού αλλαγής μεγέθους  ResizeType |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Ενημερώνει τα όρια του [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) στους πόρους.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Η απόλυτη θέση και το μέγεθος του κειμένου. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Η θέση και το μέγεθος του κειμένου σε σχέση με το πλαίσιο κειμένου. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| κείμενο | java.lang.String | Η τιμή του κειμένου. |
...
| --- | --- | --- |
| κείμενο | java.lang.String | Η τιμή του κειμένου. |
| color | [Color](../../com.aspose.psd/color) | Η τιμή του χρώματος. |
...
| --- | --- | --- |
| κείμενο | java.lang.String | Η τιμή του κειμένου. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Η αριστερή άνω συντεταγμένη. |
...
| κείμενο | java.lang.String | Η τιμή του κειμένου. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Η αριστερή άνω συντεταγμένη. |
| fontSize | float | Μέγεθος της γραμματοσειράς. |
