...
description: "Η κλάση επιπέδου artboard."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Προσθέτει το στρώμα στην ομάδα στρωμάτων. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Προσθέτει το στρώμα στην ομάδα στρωμάτων. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Προσθέτει την ομάδα στρωμάτων. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Λαμβάνει ή ορίζει το χρώμα φόντου του artboard. |
...
| [getLayers()](#getLayers--) | Λαμβάνει τα στρώματα στην ομάδα στρωμάτων |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Λαμβάνει τα πραγματικά όρια του ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Λαμβάνει το LayerSectionResource από τους πόρους. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) έχει το χρώμα φόντου. |
...
| [isOpen()](#isOpen--) | Λαμβάνει ή ορίζει αν ο φάκελος είναι ανοιχτός· εάν οριστεί σε true, η ομάδα θα είναι σε ανοιχτή κατάσταση κατά την εκκίνηση, διαφορετικά σε ελαχιστοποιημένη κατάσταση. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Λαμβάνει ή ορίζει το χρώμα φόντου του artboard. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Λαμβάνει ή ορίζει αν ο φάκελος είναι ανοιχτός· εάν οριστεί σε true, η ομάδα θα είναι σε ανοιχτή κατάσταση κατά την εκκίνηση, διαφορετικά σε ελαχιστοποιημένη κατάσταση. |
...
Προσθέτει το στρώμα στην ομάδα στρωμάτων.
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Το στρώμα. |
| δείκτης | int | Ο δείκτης στο οποίο θα εισαχθεί το επίπεδο. Οι μη έγκυρες τιμές σημαίνουν το τέλος της λίστας των επιπέδων. |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Επιστρέφει έναν πίνακα δύο αντικειμένων LayerGroup, όπου το πρώτο [0] είναι ο δείκτης έναρξης της ομάδας και το δεύτερο [1] είναι ο δείκτης λήξης της ομάδας.
### cacheData() {#cacheData--}
```
...
Λαμβάνει τα στρώματα στην ομάδα στρωμάτων
...
Λαμβάνει τα πραγματικά όρια του ArtboardLayer.
...
Λαμβάνει το LayerSectionResource από τους πόρους.
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) έχει το χρώμα φόντου.
