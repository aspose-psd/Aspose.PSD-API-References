...
description: "Αυτή είναι η γραμμή βάσης της γραμματοσειράς."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.text.rendering/fontbaseline/
---

**Inheritance:**
java.lang.Object, com.aspose.ms.System.ValueType, com.aspose.ms.System.Enum
```
public final class FontBaseline extends System.Enum
```

Αυτή είναι η γραμμή βάσης της γραμματοσειράς.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | Καμία τιμή γραμμής βάσης |
| [Subscript](#Subscript) | Γραμμή βάσης δείκτη. |
| [Superscript](#Superscript) | Γραμμή βάσης ανώτερης γραφής. |
## Μέθοδοι
