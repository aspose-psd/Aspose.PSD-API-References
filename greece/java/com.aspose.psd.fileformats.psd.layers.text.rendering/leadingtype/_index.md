...
description: "Ο τύπος leading του Photoshop, τύπος απόστασης μεταξύ γραμμών."
type: docs
weight: 14
url: /el/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | Το leading από το κάτω προς το κάτω. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | Το leading από το πάνω προς το πάνω. |
## Μέθοδοι
...
Το leading από το κάτω προς το κάτω.
...
Το leading από το πάνω προς το πάνω.
