...
description: "Απαρίθμηση για τη λειτουργία προσανατολισμού κειμένου."
type: docs
weight: 15
url: /el/java/com.aspose.psd.fileformats.psd.layers.text.rendering/textorientation/
---
...
| [Horizontal](#Horizontal) | Ο οριζόντιος προσανατολισμός του κειμένου. |
| [Vertical](#Vertical) | Ο κάθετος προσανατολισμός του κειμένου. |
## Μέθοδοι
...
Ο οριζόντιος προσανατολισμός του κειμένου.
...
Ο κάθετος προσανατολισμός του κειμένου.
