...
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd.layers.text.rendering/fontcaps/
---
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [AllCaps](#AllCaps) | Τα όλα κεφαλαία. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | Καμία τιμή κεφαλαίων γραμματοσειράς. |
| [SmallCaps](#SmallCaps) | Τα μικρά κεφαλαία. |
## Μέθοδοι
...
Καμία τιμή κεφαλαίων γραμματοσειράς.
