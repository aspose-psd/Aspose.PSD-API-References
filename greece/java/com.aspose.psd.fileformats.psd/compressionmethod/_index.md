...
description: "Ορίζει τη μέθοδο συμπίεσης που χρησιμοποιείται για δεδομένα εικόνας."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd/compressionmethod/
---
...
| [RLE](#RLE) | Τα δεδομένα εικόνας που έχουν συμπιεστεί με RLE ξεκινούν με τους μετρητές byte για όλες τις γραμμές σάρωσης (rows \* channels), με κάθε μετρητή αποθηκευμένο ως τιμή δύο byte. |
| [Raw](#Raw) | Χωρίς συμπίεση. |
| [ZipWithPrediction](#ZipWithPrediction) | ZIP με πρόβλεψη. |
| [ZipWithoutPrediction](#ZipWithoutPrediction) | ZIP χωρίς πρόβλεψη. |
## Μέθοδοι
...
Χωρίς συμπίεση. Τα δεδομένα εικόνας αποθηκεύονται ως ακατέργαστα byte σε επίπεδη σειρά RGBA. Αυτό σημαίνει ότι πρώτα γράφονται όλα τα δεδομένα R, μετά όλα τα G, μετά όλα τα B και τέλος όλα τα δεδομένα A.
