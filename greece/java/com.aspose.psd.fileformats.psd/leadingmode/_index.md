...
description: "Photoshop leading mode απόσταση μεταξύ γραμμών"
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd/leadingmode/
---
...
Λειτουργία διάστιχου Photoshop (απόσταση μεταξύ γραμμών)
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Auto](#Auto) | Αυτόματη leading mode |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Manual](#Manual) | Χειροκίνητη leading mode |
## Μέθοδοι
