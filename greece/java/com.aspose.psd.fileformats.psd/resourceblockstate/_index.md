...
description: "Αναπαριστά την κατάσταση του μπλοκ πόρου."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd/resourceblock.resourceblockstate/
---

**Inheritance:**
java.lang.Object, com.aspose.ms.System.ValueType, com.aspose.ms.System.Enum
```
public static final class ResourceBlock.ResourceBlockState extends System.Enum
```

Αναπαριστά την κατάσταση του μπλοκ πόρου.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Cached](#Cached) | Καταχωρημένη κατάσταση. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Normal](#Normal) | Τυπική κατάσταση. |
## Μέθοδοι
