...
description: "Απαρίθμηση τύπου διαβάθμισης."
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.layers.gradient/gradientkind/
---
...
Απαρίθμηση τύπου διαβάθμισης.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Noise](#Noise) | Τύπος Gradient Θορύβου |
| [Solid](#Solid) | Τύπος Solid Gradient |
## Μέθοδοι
