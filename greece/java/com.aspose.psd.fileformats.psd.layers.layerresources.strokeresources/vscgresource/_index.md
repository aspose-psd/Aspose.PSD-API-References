...
description: "Πόρος δεδομένων περιεχομένου διανυσματικού περιγράμματος."
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
| --- | --- |
| [VscgResource()](#VscgResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Λαμβάνει ή ορίζει το όνομα της κλάσης. |
| [getClassName_internalized()](#getClassName-internalized--) | Λαμβάνει ή ορίζει το αναγνωριστικό της κλάσης. |
| [getHeader_internalized()](#getHeader-internalized--) | Λαμβάνει ή ορίζει την κεφαλίδα. |
| [getItems()](#getItems--) | Λαμβάνει ή ορίζει τα στοιχεία της δομής. |
| [getKey()](#getKey--) | Λαμβάνει το κλειδί πόρου της στρώσης. |
| [getKeyForData()](#getKeyForData--) | Ακέραιος κλειδί που ορίζει τι είδους ρυθμίσεις fill αποθηκεύονται στον πόρο: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Λαμβάνει ή ορίζει το όνομα της κλάσης. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Λαμβάνει ή ορίζει το αναγνωριστικό της κλάσης. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Λαμβάνει ή ορίζει τα στοιχεία της δομής. |
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Λαμβάνει ακέραιο κλειδί που ορίζει τι είδους ρυθμίσεις fill αποθηκεύονται στον πόρο: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Προειδοποίηση! Η τιμή της ιδιότητας KeyForData πρέπει να ταιριάζει με τον τύπο των ρυθμίσεων Fill που αποθηκεύονται στις δομές Items. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Εσωτερική μέθοδος που επιτρέπει την ανάθεση της ιδιότητας μόνο για ανάγνωση KeyForData. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource).
...
Λαμβάνει ή ορίζει τα στοιχεία της δομής.

Τιμή: Τα στοιχεία της δομής.
...
Ακέραιος κλειδί που ορίζει τι είδους ρυθμίσεις fill αποθηκεύονται στον πόρο: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Λαμβάνει ακέραιο κλειδί που ορίζει τι είδους ρυθμίσεις fill αποθηκεύονται στον πόρο: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Προειδοποίηση! Η τιμή της ιδιότητας KeyForData πρέπει να ταιριάζει με τον τύπο των ρυθμίσεων Fill που αποθηκεύονται στις δομές Items.
...
Εσωτερική μέθοδος που επιτρέπει την ανάθεση της ιδιότητας μόνο για ανάγνωση KeyForData. Θα πρέπει να χρησιμοποιείται μόνο στον φορτωτή πόρων Vscg όταν ανατίθενται ιδιότητες πόρου.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | int | Ακέραια τιμή για την ιδιότητα KeyForData. |
