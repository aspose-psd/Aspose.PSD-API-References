...
description: "Η απαρίθμηση φυσικής μονάδας του resoultionInfo"
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/
---
...
Η απαρίθμηση φυσικής μονάδας του resoultionInfo
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [Centimeters](#Centimeters) | Τα εκατοστά |
| [Columns](#Columns) | Οι στήλες |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inches](#Inches) | Οι ίντσες |
| [Picas](#Picas) | Η μονάδα picas |
| [Points](#Points) | Τα σημεία |
## Μέθοδοι
