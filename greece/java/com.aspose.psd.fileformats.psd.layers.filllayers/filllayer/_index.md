...
description: "Στρώμα γεμίσματος."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| [createInstance(int fillType)](#createInstance-int-) | Δημιουργήστε ένα νέο αντικείμενο της κλάσης [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) με βάση τον τύπο γεμίσματος. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Λαμβάνει τον επεξεργαστή απόδοσης για [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Λαμβάνει ή ορίζει τη διαφάνεια γεμίσματος. |
| [getFillSettings()](#getFillSettings--) | Λαμβάνει τις ρυθμίσεις γεμίσματος. |
| [getFillType()](#getFillType--) | Λαμβάνει τον τύπο του γεμίσματος. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Λαμβάνει τις ρυθμίσεις γεμίσματος. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Ενημερώνει τα δεδομένα pixel του Fill Layer σύμφωνα με τις πραγματικές [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Δημιουργήστε ένα νέο αντικείμενο της κλάσης [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) με βάση τον τύπο γεμίσματος.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| fillType | int | Ο τύπος της στρώσης γεμίσματος. |
...
Λαμβάνει τον επεξεργαστή απόδοσης για [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | Η εικόνα για απόδοση. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | Τα όρια για επεξεργασία. |

**Returns:**
com.aspose.internal.IPartialProcessor - Επιστρέφει τον επεξεργαστή απόδοσης για [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Λαμβάνει τις ρυθμίσεις γεμίσματος.
...
Ενημερώνει τα δεδομένα pixel του Fill Layer σύμφωνα με τις πραγματικές [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
