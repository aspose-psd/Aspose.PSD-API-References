...
description: "Το Adobe Illustrator AI Image"
type: docs
weight: 14
url: /el/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
Η εικόνα Adobe Illustrator (AI)
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [AiImage()](#AiImage--) | Αρχικοποιεί ένα νέο αντίτυπο της κλάσης [AiImage](../../com.aspose.psd.fileformats.ai/aiimage). |
## Πεδία
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | Προσθέτει το τμήμα στρώματος AI. |
| [cacheData()](#cacheData--) | Αποθηκεύει προσωρινά τα δεδομένα και εξασφαλίζει ότι δεν θα γίνει επιπλέον φόρτωση δεδομένων από το υποκείμενο P:Aspose.PSD.DataStreamSupporter.DataStreamContainer. |
...
| [getActivePageIndex()](#getActivePageIndex--) | Λαμβάνει ή ορίζει το δείκτη της ενεργής σελίδας. |
...
| [getDataSection()](#getDataSection--) | Λαμβάνει την ενότητα δεδομένων. |
...
| [getFinalizeSection()](#getFinalizeSection--) | Λαμβάνει την ενότητα ολοκλήρωσης. |
...
| [getHeader()](#getHeader--) | Λαμβάνει την κεφαλίδα. |
...
| [getLayers()](#getLayers--) | Λαμβάνει τις ενότητες στρώματος. |
...
| [getPageCount()](#getPageCount--) | Ο αριθμός των σελίδων. |
...
| [getSetupSection()](#getSetupSection--) | Λαμβάνει την ενότητα ρυθμίσεων. |
...
| [getVersion()](#getVersion--) | Λαμβάνει την έκδοση της μορφής Adobe Illustrator. |
| [getWidth()](#getWidth--) | Λαμβάνει το πλάτος της εικόνας. |
| [getXmpData()](#getXmpData--) | Λαμβάνει τα μεταδεδομένα XMP. |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | Λαμβάνει ή ορίζει το δείκτη της ενεργής σελίδας. |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | Λαμβάνει την αποδιδόμενη εικόνα. |
...
Αρχικοποιεί ένα νέο αντίτυπο της κλάσης [AiImage](../../com.aspose.psd.fileformats.ai/aiimage).
...
Προσθέτει το τμήμα στρώματος AI.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | Η ενότητα στρώματος AI. |
...
Αποθηκεύει προσωρινά τα δεδομένα και εξασφαλίζει ότι δεν θα γίνει επιπλέον φόρτωση δεδομένων από το υποκείμενο P:Aspose.PSD.DataStreamSupporter.DataStreamContainer.
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - Αντίτυπο ApsPage.
...
Τιμή: Αυτή η ιδιότητα ισχύει μόνο για εικόνα AI σε μορφή PDF. Εάν η εικόνα δεν είναι σε μορφή PDF ή δεν υπάρχουν σελίδες, η ιδιότητα θα είναι -1. Αυτή η ιδιότητα δείχνει ποια σελίδα της εικόνας AI θα είναι η βάση για την απόδοση.
...
Ο αριθμός των σελίδων. Για τις παλιές εικόνες μορφής AI πάντα ισούται με 0.

Τιμή: Ο αριθμός των σελίδων.
...
Λαμβάνει την ενότητα ρυθμίσεων.

Τιμή: Η ενότητα ρύθμισης.
...
Τιμή:  true  εάν τα δεδομένα του αντικειμένου είναι στην κρυφή μνήμη· διαφορετικά,  false .
...
Λαμβάνει την αποδιδόμενη εικόνα.

Τιμή: Η αποδιδόμενη εικόνα.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| ventureLicense | java.lang.Object | Αντικείμενο άδειας Venture. |
