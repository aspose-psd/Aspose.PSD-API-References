...
description: "Πόρος ονομάτων Unicode alpha"
type: docs
weight: 38
url: /el/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | Αρχικοποιεί ένα νέο αντίγραφο της [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) κλάσης. |
## Πεδία
...
| [getAlphaNames()](#getAlphaNames--) | Λαμβάνει ή ορίζει τα ονόματα άλφα. |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | Λαμβάνει ή ορίζει τα ονόματα άλφα. |
...
Αρχικοποιεί ένα νέο αντίγραφο της [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource) κλάσης.
...
Λαμβάνει ή ορίζει τα ονόματα άλφα.

Τιμή: Τα ονόματα άλφα.
