...
description: "Πόρος πληροφοριών ομάδας στρώσεων"
type: docs
weight: 25
url: /el/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
Πόρος πληροφοριών ομάδας στρώσεων
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Πεδία
...
| [getGroups()](#getGroups--) | Λαμβάνει ή ορίζει τις ομάδες. |
...
| [setGroups(short[] value)](#setGroups-short---) | Λαμβάνει ή ορίζει τις ομάδες. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Ενημερώνει το LinkGroupId σε στρώματα από την ιδιότητα Groups. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Ενημερώνει τις τιμές στην ιδιότητα Groups από τα στρώματα. |
...
Ενημερώνει το LinkGroupId σε στρώματα από την ιδιότητα Groups.
...
Ενημερώνει τις τιμές στην ιδιότητα Groups από τα στρώματα.
