...
description: "Πόρος σημαιών εκτύπωσης"
type: docs
weight: 30
url: /el/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
Πόρος σημαιών εκτύπωσης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource). |
## Πεδία
...
| [getBleedScale()](#getBleedScale--) | Λαμβάνει ή ορίζει την κλίμακα αποκοπής. |
| [getBleedWidth()](#getBleedWidth--) | Λαμβάνει ή ορίζει το πλάτος της αποκοπής. |
| [getCenterCropMark()](#getCenterCropMark--) | Λαμβάνει ή ορίζει το σημάδι περικοπής κέντρου. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Λαμβάνει ή ορίζει την κλίμακα αποκοπής. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Λαμβάνει ή ορίζει το πλάτος της αποκοπής. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Λαμβάνει ή ορίζει το σημάδι περικοπής κέντρου. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource).
...
Λαμβάνει ή ορίζει την κλίμακα αποκοπής.

Τιμή: Η κλίμακα υπερέκτασης.
...
Λαμβάνει ή ορίζει το πλάτος της αποκοπής.

Τιμή: Το πλάτος της υπερέκτασης.
...
Λαμβάνει ή ορίζει το σημάδι περικοπής κέντρου.

Τιμή: Το σημάδι περικοπής κέντρου.
