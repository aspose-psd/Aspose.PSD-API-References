...
description: "Πόρος πληροφοριών γρήγορης μάσκας"
type: docs
weight: 32
url: /el/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Πόρος πληροφοριών γρήγορης μάσκας
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource). |
## Πεδία
...
| [getChannelId()](#getChannelId--) | Αποκτά ή ορίζει το αναγνωριστικό καναλιού. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι κενή μάσκα. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Αποθηκεύει το μπλοκ πόρου στο καθορισμένο stream. |
| [setChannelId(short value)](#setChannelId-short-) | Αποκτά ή ορίζει το αναγνωριστικό καναλιού. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι κενή μάσκα. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource).
...
Αποκτά ή ορίζει το αναγνωριστικό καναλιού.

Τιμή: Το αναγνωριστικό καναλιού.
...
Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι κενή μάσκα.

Τιμή:  true  εάν αυτή η παρουσία είναι κενή μάσκα· διαφορετικά,  false .
