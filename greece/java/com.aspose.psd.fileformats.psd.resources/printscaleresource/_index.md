...
description: "Πόρος κλίμακας εκτύπωσης"
type: docs
weight: 31
url: /el/java/com.aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
Πόρος κλίμακας εκτύπωσης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PrintScaleResource()](#PrintScaleResource--) | Αρχικοποιεί ένα νέο αντίγραφο της [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource) κλάσης. |
## Πεδία
...
| [getStyle()](#getStyle--) | Λαμβάνει ή ορίζει το στυλ. |
| [getXLocation()](#getXLocation--) | Λαμβάνει ή ορίζει τη θέση x. |
| [getYLocation()](#getYLocation--) | Λαμβάνει ή ορίζει τη θέση y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setScale(float value)](#setScale-float-) | Λαμβάνει ή ορίζει την κλίμακα. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Λαμβάνει ή ορίζει την κατάσταση του μπλοκ πόρου. |
| [setStyle(short value)](#setStyle-short-) | Λαμβάνει ή ορίζει το στυλ. |
| [setXLocation(float value)](#setXLocation-float-) | Λαμβάνει ή ορίζει τη θέση x. |
| [setYLocation(float value)](#setYLocation-float-) | Λαμβάνει ή ορίζει τη θέση y. |
| [toString()](#toString--) |  |
...
Αρχικοποιεί ένα νέο αντίγραφο της [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource) κλάσης.
