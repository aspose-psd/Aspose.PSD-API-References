...
description: "Το μπλοκ πόρου μικρογραφίας."
type: docs
weight: 36
url: /el/java/com.aspose.psd.fileformats.psd.resources/thumbnailresource/
---
...
| --- | --- |
| [ThumbnailResource()](#ThumbnailResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource). |
## Πεδία
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ThumbnailResource](../../com.aspose.psd.fileformats.psd.resources/thumbnailresource).
