...
description: "Αντιπροσωπεύει τον πόρο προφίλ ICC."
type: docs
weight: 23
url: /el/java/com.aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| --- | --- |
| [IccProfileResource()](#IccProfileResource--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource). |
## Πεδία
...
| [getIccProfile()](#getIccProfile--) | Λαμβάνει ή ορίζει το προφίλ ICC. |
...
| [setIccProfile(byte[] value)](#setIccProfile-byte---) | Λαμβάνει ή ορίζει το προφίλ ICC. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource).
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | com.aspose.ms.System.IO.MemoryStream |  |
