...
description: "Πόρος πληροφοριών κατάστασης στρώσης"
type: docs
weight: 28
url: /el/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
Πόρος πληροφοριών κατάστασης στρώσης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource). |
## Πεδία
...
| [getLayerIndex()](#getLayerIndex--) | Λαμβάνει ή ορίζει τον δείκτη της στρώσης. |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | Λαμβάνει ή ορίζει τον δείκτη της στρώσης. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource).
...
Λαμβάνει ή ορίζει τον δείκτη της στρώσης.

Τιμή: Ο δείκτης της στρώσης.
