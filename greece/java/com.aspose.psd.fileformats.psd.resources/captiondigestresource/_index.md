...
description: "Πόρος CaptionDigest"
type: docs
weight: 13
url: /el/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Πεδία
...
| [getDigest()](#getDigest--) | Λαμβάνει ή ορίζει τη σύνοψη. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Λαμβάνει ή ορίζει τη σύνοψη. |
