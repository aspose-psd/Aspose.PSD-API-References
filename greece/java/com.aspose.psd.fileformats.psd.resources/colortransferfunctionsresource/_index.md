...
description: "Πόρος μεταφοράς χρώματος"
type: docs
weight: 15
url: /el/java/com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
Πόρος μεταφοράς χρώματος
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getColorTransferData()](#getColorTransferData--) | Λαμβάνει ή ορίζει τα δεδομένα μεταφοράς χρώματος. |
...
| [setColorTransferData(byte[] value)](#setColorTransferData-byte---) | Λαμβάνει ή ορίζει τα δεδομένα μεταφοράς χρώματος. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource).
...
Τιμή: Τα δεδομένα μεταφοράς χρώματος.
