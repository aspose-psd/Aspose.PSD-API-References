...
description: "Ο πόρος του πρόσθετου Animated Data Section."
type: docs
weight: 10
url: /el/java/com.aspose.psd.fileformats.psd.resources/animateddatasectionresource/
---
...
Ο πόρος του πρόσθετου Animated Data Section.
## Πεδία
...
| [getAnimatedDataSection()](#getAnimatedDataSection--) | Λαμβάνει ή ορίζει τη δομή της ενότητας δεδομένων κίνησης. |
| [getClass()](#getClass--) |  |
...
| [getKeyName()](#getKeyName--) | Το όνομα κλειδιού του πόρου. |
...
| [setAnimatedDataSection_internalized(AnimatedDataSectionStructure value)](#setAnimatedDataSection-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.AnimatedDataSectionStructure-) | Λαμβάνει ή ορίζει τη δομή της ενότητας δεδομένων κίνησης. |
| [setID(short value)](#setID-short-) | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό για τον πόρο. |
| [setKeyName_internalized(String value)](#setKeyName-internalized-java.lang.String-) | Το όνομα κλειδιού του πόρου. |
...
| [setRoll_internalized(RollStructure value)](#setRoll-internalized-com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure-) | Λαμβάνει ή ορίζει τη δομή roll. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Λαμβάνει ή ορίζει την κατάσταση του μπλοκ πόρου. |
| [setUnknownLeftBytes_internalized(byte[] value)](#setUnknownLeftBytes-internalized-byte---) | Τα άγνωστα bytes από το αρχικό πόρο. |
| [toString()](#toString--) |  |
...
Λαμβάνει ή ορίζει τη δομή της ενότητας δεδομένων κίνησης.
...
Λαμβάνει ή ορίζει τη δομή roll.

**Parameters:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| τιμή | com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure |  |
...
Τα άγνωστα bytes από το αρχικό πόρο.
