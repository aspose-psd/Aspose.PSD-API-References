...
description: "Ο πόρος με πληροφορίες περιγράμματος των ρυθμίσεων εκτύπωσης εικόνας."
type: docs
weight: 12
url: /el/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource). |
## Πεδία
...
| [getUnit()](#getUnit--) | Λαμβάνει ή ορίζει τις μονάδες του περιγράμματος. |
| [getWidth()](#getWidth--) | Λαμβάνει ή ορίζει το πλάτος του περιγράμματος. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | Λαμβάνει ή ορίζει τις μονάδες του περιγράμματος. |
| [setWidth(double value)](#setWidth-double-) | Λαμβάνει ή ορίζει το πλάτος του περιγράμματος. |
| [toString()](#toString--) |  |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource).
...
Λαμβάνει ή ορίζει τις μονάδες του περιγράμματος.
...
Λαμβάνει ή ορίζει το πλάτος του περιγράμματος.
