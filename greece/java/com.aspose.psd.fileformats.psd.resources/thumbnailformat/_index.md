...
description: "Καθορίζει τη μορφή δεδομένων μικρογραφίας."
type: docs
weight: 35
url: /el/java/com.aspose.psd.fileformats.psd.resources/thumbnailformat/
---
...
| [KJpegRgb](#KJpegRgb) | Συμπιεσμένη μορφή Jpeg. |
| [KRawRgb](#KRawRgb) | Ακατέργαστη μορφή RGB. |
## Μέθοδοι
