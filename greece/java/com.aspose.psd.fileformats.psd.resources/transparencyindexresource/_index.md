...
description: "Το μπλοκ πόρου δείκτη διαφάνειας."
type: docs
weight: 37
url: /el/java/com.aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
Το μπλοκ πόρου δείκτη διαφάνειας.
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [TransparencyIndexResource()](#TransparencyIndexResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource). |
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [RequiredVersion_internalized](#RequiredVersion-internalized) | Η απαιτούμενη έκδοση psd. |
...
| [getTransparencyIndex()](#getTransparencyIndex--) | Αποκτά ή ορίζει το δείκτη χρώματος διαφάνειας. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTransparencyIndex(short value)](#setTransparencyIndex-short-) | Αποκτά ή ορίζει το δείκτη χρώματος διαφάνειας. |
| [toString()](#toString--) |  |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [TransparencyIndexResource](../../com.aspose.psd.fileformats.psd.resources/transparencyindexresource).
...
Αποκτά ή ορίζει το δείκτη χρώματος διαφάνειας.

Τιμή: Ο δείκτης χρώματος διαφάνειας.
