...
description: "Πόρος αναγνωριστικών επιλογής στρώσεων"
type: docs
weight: 27
url: /el/java/com.aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| --- | --- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getCount()](#getCount--) | Λαμβάνει ή ορίζει το πλήθος. |
...
| [getLayerIds()](#getLayerIds--) | Λαμβάνει ή ορίζει τα αναγνωριστικά της στρώσης. |
...
| [setCount(short value)](#setCount-short-) | Λαμβάνει ή ορίζει το πλήθος. |
...
| [setLayerIds(int[] value)](#setLayerIds-int---) | Λαμβάνει ή ορίζει τα αναγνωριστικά της στρώσης. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LayerSelectionIdsResource](../../com.aspose.psd.fileformats.psd.resources/layerselectionidsresource).
...
Λαμβάνει ή ορίζει τα αναγνωριστικά της στρώσης.

Τιμή: Τα αναγνωριστικά της στρώσης.
