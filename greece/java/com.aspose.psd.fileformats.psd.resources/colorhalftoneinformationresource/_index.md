...
description: "Πόρος ημιτονοποίησης"
type: docs
weight: 14
url: /el/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
Πόρος ημιτονοποίησης
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource). |
## Πεδία
...
| [getHalftoneData()](#getHalftoneData--) | Λαμβάνει ή ορίζει τα δεδομένα ημιτονοειδούς. |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | Λαμβάνει ή ορίζει τα δεδομένα ημιτονοειδούς. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource).
...
Λαμβάνει ή ορίζει τα δεδομένα ημιτονοειδούς.

Τιμή: Τα δεδομένα ημιτονοειδούς.
