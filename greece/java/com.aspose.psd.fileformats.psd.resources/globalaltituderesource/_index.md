...
description: "Πόρος παγκόσμιου υψομέτρου"
type: docs
weight: 18
url: /el/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
Πόρος παγκόσμιου υψομέτρου
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource). |
## Πεδία
...
| [getAltitude()](#getAltitude--) | Λαμβάνει ή ορίζει το υψόμετρο. |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | Λαμβάνει ή ορίζει το υψόμετρο. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource).
