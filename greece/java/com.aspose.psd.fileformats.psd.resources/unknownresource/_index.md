...
type: docs
weight: 39
url: /el/java/com.aspose.psd.fileformats.psd.resources/unknownresource/
---
...
Ο άγνωστος πόρος. Όταν ένα μπλοκ πόρων δεν αναγνωρίζεται, τότε δημιουργείται αυτό το μπλοκ πόρων.
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Λαμβάνει τα δεδομένα του πόρου. |
...
Λαμβάνει τα δεδομένα του πόρου.

Τιμή: Τα δεδομένα του πόρου.
