...
type: docs
weight: 11
url: /el/java/com.aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| --- | --- |
| [BackgroundColorResource()](#BackgroundColorResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource). |
## Πεδία
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Λαμβάνει ή ορίζει το χρώμα φόντου. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Λαμβάνει ή ορίζει το χρώμα φόντου. |
| [setColorSpace(int value)](#setColorSpace-int-) | Λαμβάνει ή ορίζει έναν χώρο χρωμάτων. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource).
...
Λαμβάνει ή ορίζει έναν χώρο χρωμάτων.

Τιμή: Ο χώρος χρωμάτων φόντου.
