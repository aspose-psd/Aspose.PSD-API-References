...
description: "Πόρος Icc χωρίς ετικέτα"
type: docs
weight: 24
url: /el/java/com.aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| --- | --- |
| [IccUntaggedResource()](#IccUntaggedResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource). |
## Πεδία
...
| [getProfile()](#getProfile--) | Λαμβάνει ή ορίζει το προφίλ. |
...
| [setProfile(byte value)](#setProfile-byte-) | Λαμβάνει ή ορίζει το προφίλ. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource).
