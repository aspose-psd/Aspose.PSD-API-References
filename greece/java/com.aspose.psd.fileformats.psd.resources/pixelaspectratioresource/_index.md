...
description: "Πόρος αναλογίας διαστάσεων pixel"
type: docs
weight: 29
url: /el/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
Πόρος αναλογίας διαστάσεων pixel
## Κατασκευαστές

| Κατασκευαστής | Περιγραφή |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Πεδία
...
| [getAspectRatio()](#getAspectRatio--) | Λαμβάνει ή ορίζει την αναλογία διαστάσεων. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | Λαμβάνει ή ορίζει την αναλογία διαστάσεων. |
...
Λαμβάνει ή ορίζει την αναλογία διαστάσεων.

Τιμή: Η αναλογία διαστάσεων.
