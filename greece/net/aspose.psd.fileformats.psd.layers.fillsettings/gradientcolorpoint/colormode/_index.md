...
description: "Ιδιότητα GradientColorPoint. Λειτουργία για το χρώμα που ακολουθεί"
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientcolorpoint/colormode/
---
{{< psd/tize >}}
## GradientColorPoint.ColorMode property

Λειτουργία για το χρώμα που ακολουθεί
