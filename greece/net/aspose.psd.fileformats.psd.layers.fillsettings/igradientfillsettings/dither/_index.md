...
description: IGradientFillSettings ιδιοκτησία. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτόIGradientFillSettings είναι διχασμός.
type: docs
weight: 50
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό[`IGradientFillSettings`](../) είναι διχασμός.
