...
description: "Ιδιότητα IGradientFillSettings. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το IGradientFillSettings είναι dither"
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
{{< psd/tize >}}
## IGradientFillSettings.Dither property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [`IGradientFillSettings`](../) είναι dither.
