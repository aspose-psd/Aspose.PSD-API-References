...
description: "IGradientFillSettings ιδιότητα. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ευθυγραμμίζεται με το επίπεδο"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/alignwithlayer/
---
{{< psd/tize >}}
