...
description: "Ιδιότητα IGradientFillSettings. Λαμβάνει ή ορίζει συγκεκριμένο παράδειγμα ορισμού διαβάθμισης Solid/Noise"
type: docs
weight: 40
url: /el/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/gradient/
---
{{< psd/tize >}}
