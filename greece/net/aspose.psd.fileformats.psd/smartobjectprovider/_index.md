...
description: "Aspose.PSD.FileFormats.Psd.SmartObjectProvider κλάση. Ορίζει τον πάροχο έξυπνων αντικειμένων που παρέχει λήψη/ρύθμιση πηγών δεδομένων από παγκόσμιους συνδετικούς πόρους του αρχείου PSD και τα περιεχόμενά τους."
type: docs
weight: 4470
...
Ορίζει τον πάροχο έξυπνου αντικειμένου που παρέχει λήψη / ορισμό πηγών δεδομένων από παγκόσμιους συνδετικούς πόρους του αρχείου PSD και τα περιεχόμενά τους.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Μετατρέπει τα επίπεδα σε ενσωματωμένο έξυπνο αντικείμενο. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Μετατρέπει τα επίπεδα σε ενσωματωμένο έξυπνο αντικείμενο. |
...
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Δημιουργεί ένα νέο επίπεδο έξυπνου αντικειμένου αντιγράφοντας το πηγαίο. |
