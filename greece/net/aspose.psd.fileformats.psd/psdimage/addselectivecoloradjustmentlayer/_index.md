...
description: "Μέθοδος PsdImage. Προσθέτει τη στρώση ρύθμισης επιλεκτικού χρώματος"
type: docs
weight: 450
url: /el/net/aspose.psd.fileformats.psd/psdimage/addselectivecoloradjustmentlayer/
---
{{< psd/tize >}}
## PsdImage.AddSelectiveColorAdjustmentLayer method

Προσθέτει το επίπεδο προσαρμογής επιλεκτικού χρώματος.
...
Το δημιουργημένο επίπεδο προσαρμογής επιλεκτικού χρώματος.
