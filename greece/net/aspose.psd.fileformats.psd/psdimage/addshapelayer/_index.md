...
description: "PsdImage μέθοδος. Προσθέτει κενό στρώμα Shape. Χωρίς διαδρομές. Πρέπει να προστεθούν στο στρώμα shape πριν από την αποθήκευση"
type: docs
weight: 460
url: /el/net/aspose.psd.fileformats.psd/psdimage/addshapelayer/
---
{{< psd/tize >}}
## PsdImage.AddShapeLayer method

Προσθέτει κενό επίπεδο Shape. Χωρίς διαδρομές. Θα πρέπει να προστεθούν στο shape layer πριν από την αποθήκευση.
...
Παράδειγμα ShapeLayer.

## Παραδείγματα

Ο παρακάτω κώδικας δείχνει πώς να προσθέσετε το ShapeLayer.
