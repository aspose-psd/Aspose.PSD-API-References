---
title: "Κλάση NoiseGradient"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.NoiseGradient class. Κλάση ορισμού θορυβώδους διαβάθμισης"
type: docs
weight: 2220
url: /el/net/aspose.psd.fileformats.psd.layers.gradient/noisegradient/
---
{{< psd/tize >}}
## NoiseGradient class
...
| Όνομα | Περιγραφή |
| --- | --- |
| [NoiseGradient](noisegradient/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Όνομα | Περιγραφή |
| --- | --- |
| [ColorModel](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/colormodel/) { get; set; } | Λαμβάνει ή ορίζει το Μοντέλο Χρώματος - RGB/HSB/LAB (3/4/6). |
| [ExpansionCount](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/expansioncount/) { get; set; } | Λαμβάνει ή ορίζει τον αριθμό επέκτασης ( = 2 για Photoshop 6.0). |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/gradientmode/) { get; } | Λαμβάνει ή ορίζει το όνομα της διαβάθμισης. |
| [GradientName](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientname/) { get; set; } | Λαμβάνει ή ορίζει τον τύπο της διαβάθμισης. |
| [MaximumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/maximumcolor/) { get; set; } | Λαμβάνει ή ορίζει το Μέγιστο χρώμα του PixelDataFormat. |
| [MinimumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/minimumcolor/) { get; set; } | Λαμβάνει ή ορίζει το Ελάχιστο χρώμα του PixelDataFormat. |
| [RndNumberSeed](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/rndnumberseed/) { get; set; } | Λαμβάνει ή ορίζει τον σπόρο τυχαίου αριθμού που χρησιμοποιείται για τη δημιουργία χρωμάτων για το gradient Θορύβου. |
| [Roughness](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/roughness/) { get; set; } | Λαμβάνει ή ορίζει τον συντελεστή τραχύτητας. |
| [ShowTransparency](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/showtransparency/) { get; set; } | Λαμβάνει ή ορίζει τη σημαία για την εμφάνιση διαφάνειας. |
| [UseVectorColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/usevectorcolor/) { get; set; } | Λαμβάνει ή ορίζει τη σημαία για τη χρήση διανυσματικού χρώματος. |
