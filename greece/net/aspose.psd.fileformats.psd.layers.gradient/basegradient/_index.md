---
title: "Κλάση BaseGradient"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient class. Κλάση ορισμού βασικής διαβάθμισης. Περιέχει κοινές ιδιότητες για και τους δύο τύπους διαβάθμισης, Στερεή και Θορυβώδη"
type: docs
weight: 2190
url: /el/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| Όνομα | Περιγραφή |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | Λαμβάνει ή ορίζει το όνομα της διαβάθμισης. |
