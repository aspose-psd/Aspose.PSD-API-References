---
title: "Κλάση SolidGradient"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.SolidGradient class. Ρυθμίσεις εφέ γεμίσματος διαβάθμισης"
type: docs
weight: 2230
url: /el/net/aspose.psd.fileformats.psd.layers.gradient/solidgradient/
---
{{< psd/tize >}}
## SolidGradient class
...
| Όνομα | Περιγραφή |
| --- | --- |
| [SolidGradient](solidgradient/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Όνομα | Περιγραφή |
| --- | --- |
| [ColorPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/colorpoints/) { get; set; } | Λαμβάνει ή ορίζει τα σημεία χρώματος. |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/gradientmode/) { get; } | Λαμβάνει ή ορίζει το όνομα της διαβάθμισης. |
...
| [Interpolation](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/interpolation/) { get; set; } | Λαμβάνει ή ορίζει την Παρεμβολή. Καθορίζει την Ομαλότητα, όταν 'Gradient Type' = 'Solid'. Εύρος τιμών: 0-4096. |
| [TransparencyPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/transparencypoints/) { get; set; } | Λαμβάνει ή ορίζει τα σημεία διαφάνειας. |

## Μέθοδοι

| Όνομα | Περιγραφή |
| --- | --- |
| [AddColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addcolorpoint/)() | Προσθέτει το σημείο χρώματος. |
| [AddTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addtransparencypoint/)() | Προσθέτει το σημείο χρώματος. |
| [RemoveColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removecolorpoint/)(IGradientColorPoint) | Αφαιρεί το σημείο χρώματος. |
| [RemoveTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removetransparencypoint/)(IGradientTransparencyPoint) | Αφαιρεί το σημείο διαφάνειας. |
| static [GenerateLfx2ResourceNodes](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/generatelfx2resourcenodes/)() | Δημιουργεί τους κόμβους πόρων LFX2. |
