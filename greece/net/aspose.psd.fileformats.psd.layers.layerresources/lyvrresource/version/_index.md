...
description: "Ιδιότητα LyvrResource. Λαμβάνει ή ορίζει την έκδοση Photoshop του Layer"
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/
---
{{< psd/tize >}}
## LyvrResource.Version property

Λαμβάνει ή ορίζει την έκδοση Photoshop του Στρώματος.
