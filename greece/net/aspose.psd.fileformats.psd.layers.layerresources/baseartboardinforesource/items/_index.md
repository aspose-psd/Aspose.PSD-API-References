...
description: "Ιδιότητα BaseArtboardInfoResource. Λαμβάνει ή ορίζει τα στοιχεία OSTypeStructure"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/
---
{{< psd/tize >}}
## BaseArtboardInfoResource.Items property

Λαμβάνει ή ορίζει τα στοιχεία [`OSTypeStructure`](../../ostypestructure/).
