...
description: VsmsResource κατασκευαστής. Αρχικοποιεί μια νέα παρουσία τουVsmsResource τάξη.
type: docs
weight: 10
...
Αρχικοποιεί μια νέα παρουσία του[`VsmsResource`](../) τάξη.
...
| εξαίρεση | κατάσταση |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | Μη έγκυρη τιμή πόρου Vsms |
