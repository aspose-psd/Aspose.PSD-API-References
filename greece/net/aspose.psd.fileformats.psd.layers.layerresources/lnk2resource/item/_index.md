...
description: Lnk2Resource ιδιοκτησία. Λαμβάνει τοLiFdDataSource στον καθορισμένο δείκτη.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
## Lnk2Resource indexer

Λαμβάνει το[`LiFdDataSource`](../../lifddatasource/) στον καθορισμένο δείκτη.
...
Το[`LiFdDataSource`](../../lifddatasource/) παράδειγμα.

### Αξία περιουσίας

Το[`LiFdDataSource`](../../lifddatasource/) .
...
* class [Lnk2Resource](../)
* χώρος ονομάτων [Aspose.PSD.FileFormats.Psd.Layers.LayerResources](../../lnk2resource/)
