...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource τάξη. Καθορίζει την κλάση SoLeResource που περιέχει πληροφορίες σχετικά με ένα επίπεδο έξυπνου αντικειμένου σε ένα αρχείο PSD. Is χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων με εξωτερικούς συνδέσμους αρχείων στις εικόνες του Adobe Photoshop.
type: docs
weight: 3030
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
## SoLeResource class

Καθορίζει την κλάση SoLeResource που περιέχει πληροφορίες σχετικά με ένα επίπεδο έξυπνου αντικειμένου σε ένα αρχείο PSD. Is χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων με εξωτερικούς συνδέσμους αρχείων στις εικόνες του Adobe® Photoshop®.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`SoLeResource` τάξη. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Αρχικοποιεί μια νέα παρουσία του`SoLeResource` τάξη. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/key/) { get; } | Λαμβάνει το κλειδί πόρων επιπέδου Sole smart object. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | Το κλειδί πληροφοριών εργαλείου τύπου: 'SoLE'. |
