---
title: "Κλάση SoLeResource"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource κλάση. Ορίζει την κλάση SoLeResource που περιέχει πληροφορίες σχετικά με ένα στρώμα έξυπνου αντικειμένου σε αρχείο PSD. Χρησιμοποιείται για την υποστήριξη στρωμάτων έξυπνων αντικειμένων με εξωτερικούς συνδέσμους αρχείων στις εικόνες Adobe Photoshop."
type: docs
weight: 3380
...
Ορίζει την κλάση SoLeResource που περιέχει πληροφορίες σχετικά με ένα επίπεδο έξυπνου αντικειμένου σε αρχείο PSD. Χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων με εξωτερικούς συνδέσμους αρχείων στις εικόνες Adobe� Photoshop�.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `SoLeResource`. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Αρχικοποιεί μια νέα παρουσία της κλάσης `SoLeResource`. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | Το κλειδί πληροφοριών του εργαλείου τύπου: 'SoLE'. |
