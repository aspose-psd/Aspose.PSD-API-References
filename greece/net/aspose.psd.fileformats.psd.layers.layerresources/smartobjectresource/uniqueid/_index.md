...
description: SmartObjectResource ιδιοκτησία. Λαμβάνει ή ορίζει το καθολικό μοναδικό αναγνωριστικό των δεδομένων του επιπέδου έξυπνου αντικειμένουSmartObjectResource στην εικόνα PSD.
type: docs
weight: 240
...
Λαμβάνει ή ορίζει το καθολικό μοναδικό αναγνωριστικό των δεδομένων του επιπέδου έξυπνου αντικειμένου[`SmartObjectResource`](../) στην εικόνα PSD.
