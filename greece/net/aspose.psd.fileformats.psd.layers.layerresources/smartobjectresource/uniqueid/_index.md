...
description: "Ιδιότητα SmartObjectResource. Λαμβάνει ή ορίζει το παγκόσμιο μοναδικό αναγνωριστικό των δεδομένων του επιπέδου έξυπνου αντικειμένου SmartObjectResource στην εικόνα PSD"
type: docs
weight: 220
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
{{< psd/tize >}}
## SmartObjectResource.UniqueId property

Λαμβάνει ή ορίζει το παγκόσμιο μοναδικό αναγνωριστικό των δεδομένων του επιπέδου έξυπνου αντικειμένου [`SmartObjectResource`](../) στην εικόνα PSD.
...
Το παγκόσμιο μοναδικό αναγνωριστικό των δεδομένων του επιπέδου έξυπνου αντικειμένου [`SmartObjectResource`](../).
