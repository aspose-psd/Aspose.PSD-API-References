...
description: SmartObjectResource ιδιοκτησία. Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό αυτού του επιπέδου δεδομένων έξυπνου αντικειμένου στην εικόνα PSD.
type: docs
weight: 160
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/placedid/
---
