...
description: "Ιδιότητα SmartObjectResource. Λαμβάνει ή ορίζει τον συνολικό αριθμό σελίδων των δεδομένων του επιπέδου έξυπνου αντικειμένου στο αρχείο PSD"
type: docs
weight: 200
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/totalpages/
---
{{< psd/tize >}}
## SmartObjectResource.TotalPages property

Λαμβάνει ή ορίζει τον συνολικό αριθμό σελίδων των δεδομένων στρώσης έξυπνου αντικειμένου στο αρχείο PSD.
...
Ο συνολικός αριθμός σελίδων των δεδομένων του επιπέδου έξυπνου αντικειμένου.
