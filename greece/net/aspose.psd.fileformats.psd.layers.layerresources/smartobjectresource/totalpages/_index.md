...
description: SmartObjectResource ιδιοκτησία. Λαμβάνει ή ορίζει τον συνολικό αριθμό σελίδων των δεδομένων επιπέδου έξυπνου αντικειμένου στο αρχείο PSD.
type: docs
weight: 220
...
Λαμβάνει ή ορίζει τον συνολικό αριθμό σελίδων των δεδομένων επιπέδου έξυπνου αντικειμένου στο αρχείο PSD.
...
Ο συνολικός αριθμός σελίδων των δεδομένων επιπέδου έξυπνου αντικειμένου.
