...
description: "SmartObjectResource ιδιότητα. Λαμβάνει ή ορίζει τον αριθμό σελίδας των δεδομένων στρώματος έξυπνου αντικειμένου στο αρχείο PSD"
type: docs
weight: 150
...
Λαμβάνει ή ορίζει τον αριθμό σελίδας των δεδομένων στρώσης έξυπνου αντικειμένου στο αρχείο PSD.
...
Ο αριθμός σελίδας των δεδομένων στρώματος έξυπνου αντικειμένου.
