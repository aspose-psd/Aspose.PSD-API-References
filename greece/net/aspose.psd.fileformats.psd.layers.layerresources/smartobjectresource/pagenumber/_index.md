...
description: SmartObjectResource ιδιοκτησία. Λαμβάνει ή ορίζει τον αριθμό σελίδας των δεδομένων επιπέδου έξυπνου αντικειμένου στο αρχείο PSD.
type: docs
weight: 150
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/pagenumber/
---
## SmartObjectResource.PageNumber property

Λαμβάνει ή ορίζει τον αριθμό σελίδας των δεδομένων επιπέδου έξυπνου αντικειμένου στο αρχείο PSD.
...
Ο αριθμός σελίδας των δεδομένων επιπέδου έξυπνου αντικειμένου.
