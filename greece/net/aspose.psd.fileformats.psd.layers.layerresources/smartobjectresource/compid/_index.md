...
Το αναγνωριστικό του τρέχοντος επιλεγμένου comp για το θυγατρικό έγγραφο στην εικόνα PSD, το οποίο θα είναι -1 εάν δεν επιλεγεί κανένα.
