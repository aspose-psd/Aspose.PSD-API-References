...
description: PlacedResource ιδιοκτησία. Λαμβάνει ή ορίζει το καθολικό μοναδικό αναγνωριστικό του τοποθετημένου επιπέδου στην εικόνα PSD.
type: docs
weight: 180
...
Λαμβάνει ή ορίζει το καθολικό μοναδικό αναγνωριστικό του τοποθετημένου επιπέδου στην εικόνα PSD.
...
Το μοναδικό αναγνωριστικό του τοποθετημένου επιπέδου.
