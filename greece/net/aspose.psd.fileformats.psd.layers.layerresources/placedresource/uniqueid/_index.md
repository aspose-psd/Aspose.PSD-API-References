...
description: "Ιδιότητα PlacedResource. Λαμβάνει ή ορίζει το παγκόσμιο μοναδικό αναγνωριστικό του τοποθετημένου στρώματος στην εικόνα PSD"
type: docs
weight: 170
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/uniqueid/
---
{{< psd/tize >}}
## PlacedResource.UniqueId property

Ανακτά ή ορίζει το παγκόσμιο μοναδικό αναγνωριστικό του τοποθετημένου στρώματος στην εικόνα PSD.
...
Το μοναδικό αναγνωριστικό του τοποθετημένου στρώματος.
