...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlacedResource τάξη. Καθορίζει την κλάση PlacedResource που περιέχει κοινές πληροφορίες σχετικά με ένα τοποθετημένο επίπεδο ή ένα επίπεδο έξυπνου αντικειμένου στο αρχείο PSD. Is χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων στις εικόνες του Adobe Photoshop.
type: docs
weight: 2940
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/
---
## PlacedResource class

Καθορίζει την κλάση PlacedResource που περιέχει κοινές πληροφορίες σχετικά με ένα τοποθετημένο επίπεδο ή ένα επίπεδο έξυπνου αντικειμένου στο αρχείο PSD. Is χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων στις εικόνες του Adobe® Photoshop®.
...
| abstract [PsdVersion](../../aspose.psd.fileformats.psd.layers/layerresource/psdversion/) { get; } | Λαμβάνει την ελάχιστη έκδοση psd που απαιτείται για τον πόρο του επιπέδου. Το 0 δεν υποδηλώνει περιορισμούς. |
...
| override [Signature](../../aspose.psd.fileformats.psd.layers.layerresources/placedresource/signature/) { get; } | Λαμβάνει την υπογραφή του πόρου Placed. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| abstract [Save](../../aspose.psd.fileformats.psd.layers/layerresource/save/)(StreamContainer, int) | Αποθηκεύει τον πόρο στο καθορισμένο κοντέινερ ροής. |
