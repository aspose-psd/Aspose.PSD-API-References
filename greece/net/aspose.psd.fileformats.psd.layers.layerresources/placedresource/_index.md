...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlacedResource κλάση. Ορίζει την κλάση PlacedResource που περιέχει κοινές πληροφορίες για ένα τοποθετημένο στρώμα ή ένα στρώμα έξυπνου αντικειμένου στο αρχείο PSD. Χρησιμοποιείται για την υποστήριξη στρωμάτων έξυπνων αντικειμένων στις εικόνες Adobe Photoshop."
type: docs
weight: 3290
...
Ορίζει την κλάση PlacedResource που περιέχει κοινές πληροφορίες σχετικά με μια τοποθετημένη στρώση ή μια στρώση έξυπνου αντικειμένου στο αρχείο PSD. Χρησιμοποιείται για την υποστήριξη στρώσεων έξυπνου αντικειμένου σε εικόνες Adobe® Photoshop®.
