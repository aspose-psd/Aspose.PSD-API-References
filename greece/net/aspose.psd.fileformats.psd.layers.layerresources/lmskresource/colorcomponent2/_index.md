...
description: "Ιδιότητα LmskResource. Λαμβάνει το στοιχείο χρώματος 2"
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent2/
---
{{< psd/tize >}}
## LmskResource.ColorComponent2 property

Λαμβάνει το συστατικό χρώματος 2.
