...
description: "LmskResource ιδιότητα. Λαμβάνει το στοιχείο χρώματος 4"
type: docs
weight: 50
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent4/
---
{{< psd/tize >}}
## LmskResource.ColorComponent4 property

Λαμβάνει το συστατικό χρώματος 4.
