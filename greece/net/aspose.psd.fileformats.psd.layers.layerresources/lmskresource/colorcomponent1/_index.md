...
description: "LmskResource ιδιότητα. Λαμβάνει το στοιχείο χρώματος 1"
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lmskresource/colorcomponent1/
---
{{< psd/tize >}}
## LmskResource.ColorComponent1 property

Λαμβάνει το συστατικό χρώματος 1.
