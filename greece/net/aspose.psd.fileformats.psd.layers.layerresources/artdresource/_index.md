...
description: "Κλάση Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtDResource. Τα δεδομένα πληροφοριών του Artboard για GlobalLayerResources"
type: docs
weight: 2530
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/artdresource/
---
{{< psd/tize >}}
## ArtDResource class

Τα δεδομένα πληροφοριών του Artboard για [`GlobalLayerResources`](../../aspose.psd.fileformats.psd/psdimage/globallayerresources/).
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ArtDResource](artdresource/)() | Ο προεπιλεγμένος κατασκευαστής. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artdresource/typetoolkey/) | Το κλειδί πληροφοριών του εργαλείου τύπου. |
