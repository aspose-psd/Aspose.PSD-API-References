...
description: "LiFeDataSource ιδιότητα. Λαμβάνει ή ορίζει το μέγεθος του εξωτερικού αρχείου στην πηγή δεδομένων LiFE του πόρου PSD LnkE."
type: docs
weight: 80
...
| εξαίρεση | συνθήκη |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να προσπελάσετε την ιδιότητα FileSize, είναι διαθέσιμη μόνο για την πηγή δεδομένων liFE. |
