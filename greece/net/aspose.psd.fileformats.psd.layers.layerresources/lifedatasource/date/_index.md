...
description: "LiFeDataSource ιδιότητα. Λαμβάνει ή ορίζει την ημερομηνία και ώρα τελευταίας εγγραφής του εξωτερικού αρχείου στην πηγή δεδομένων LiFE του πόρου PSD LnkE."
type: docs
weight: 40
...
| εξαίρεση | συνθήκη |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να προσπελάσετε την ιδιότητα Date, είναι διαθέσιμη μόνο για την πηγή δεδομένων liFE με έκδοση 3 ή μεγαλύτερη. |
