...
description: "LiFeDataSource ιδιότητα. Λαμβάνει ή ορίζει την πλήρη διαδρομή του εξωτερικού αρχείου στην πηγή δεδομένων LiFE του πόρου PSD LnkE."
type: docs
weight: 90
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
{{< psd/tize >}}
...
Η πλήρης διαδρομή του αρχείου.

### Εξαιρέσεις

| εξαίρεση | συνθήκη |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να προσπελάσετε την ιδιότητα FullPath, είναι διαθέσιμη μόνο για την πηγή δεδομένων liFE. |
