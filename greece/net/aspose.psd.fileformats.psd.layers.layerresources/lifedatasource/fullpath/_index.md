...
description: LiFeDataSource ιδιοκτησία. Λαμβάνει ή ορίζει την πλήρη διαδρομή του εξωτερικού αρχείου στην πηγή δεδομένων LiFE του πόρου PSD LnkE.
type: docs
weight: 90
...
| εξαίρεση | κατάσταση |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να αποκτήσετε πρόσβαση στην ιδιότητα FullPath, είναι διαθέσιμη μόνο για το liFE data source |
