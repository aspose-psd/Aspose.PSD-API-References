...
description: "LiFeDataSource ιδιότητα. Λαμβάνει ή ορίζει την αναφορά στοιχείου της βιβλιοθήκης γραφικών για τις βιβλιοθήκες Adobe Photoshop CC."
type: docs
weight: 60
...
Λαμβάνει ή ορίζει την αναφορά του στοιχείου της βιβλιοθήκης γραφικών, για Adobe® Photoshop® CC Libraries.
...
Η αναφορά στοιχείου της βιβλιοθήκης γραφικών.

### Εξαιρέσεις

| εξαίρεση | συνθήκη |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να προσπελάσετε την ιδιότητα ElementRef, είναι διαθέσιμη μόνο για την πηγή δεδομένων liFE όταν το IsLibrary είναι true. |
