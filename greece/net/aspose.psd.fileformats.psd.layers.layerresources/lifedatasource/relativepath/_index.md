...
description: "Ιδιότητα LiFeDataSource. Λαμβάνει ή ορίζει τη σχετική διαδρομή του εξωτερικού αρχείου στην πηγή δεδομένων LiFE του πόρου PSD LnkE."
type: docs
weight: 100
...
Η σχετική διαδρομή του αρχείου.

### Εξαιρέσεις

| εξαίρεση | συνθήκη |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να προσπελάσετε την ιδιότητα RelativePath· είναι διαθέσιμη μόνο για την πηγή δεδομένων liFE. |
