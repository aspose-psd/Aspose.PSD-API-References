...
description: LiFeDataSource ιδιοκτησία. Λαμβάνει ή ορίζει τη σχετική διαδρομή του εξωτερικού αρχείου στην πηγή δεδομένων LiFE του πόρου PSD LnkE.
type: docs
weight: 100
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
...
Η σχετική διαδρομή αρχείου.

### Εξαιρέσεις

| εξαίρεση | κατάσταση |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Δεν μπορείτε να αποκτήσετε πρόσβαση στην ιδιότητα RelativePath, είναι διαθέσιμη μόνο για το liFE data source |
