...
description: GdFlResource ιδιοκτησία. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ευθυγράμμιση με το επίπεδο.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/gdflresource/alignwithlayer/
---
