...
description: "Ιδιότητα LiFdDataSource. Επιστρέφει ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου σε αρχείο PSD"
type: docs
weight: 20
...
Ανακτά ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου σε αρχείο PSD.
...
Τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου.
