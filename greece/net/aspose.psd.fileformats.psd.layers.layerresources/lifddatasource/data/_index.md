...
description: LiFdDataSource ιδιοκτησία. Λαμβάνει ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου σε αρχείο PSD.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/
---
## LiFdDataSource.Data property

Λαμβάνει ή ορίζει τα ενσωματωμένα δεδομένα έξυπνου αντικειμένου σε αρχείο PSD.
...
Τα δεδομένα του ενσωματωμένου έξυπνου αντικειμένου.
