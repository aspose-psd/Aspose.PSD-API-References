...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource κλάση. Ορίζει την κλάση SoLdResource που περιέχει πληροφορίες σχετικά με ένα επίπεδο έξυπνου αντικειμένου σε αρχείο PSD. Χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων στις εικόνες Adobe Photoshop."
type: docs
weight: 3370
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
{{< psd/tize >}}
## SoLdResource class

Ορίζει την κλάση SoLdResource που περιέχει πληροφορίες σχετικά με ένα επίπεδο έξυπνου αντικειμένου σε αρχείο PSD. Χρησιμοποιείται για την υποστήριξη επιπέδων έξυπνων αντικειμένων στις εικόνες Adobe� Photoshop�.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [SoLdResource](soldresource/#constructor)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `SoLdResource`. Αυτός ο προεπιλεγμένος κατασκευαστής έχει σχεδιαστεί για χρήση από το SoLdResourceLoader. Χρησιμοποιήστε [`SmartResourceCreator`](../smartresourcecreator/) για τη δημιουργία κλάσεων SoLdResource. |
| [SoLdResource](soldresource/#constructor_1)(Guid, bool, bool) | Αρχικοποιεί μια νέα παρουσία της κλάσης `SoLdResource`. Είναι απαραίτητο να οριστεί η ιδιότητα Items ή να κληθεί η μέθοδος InitializeItems() για να ληφθεί μια έτοιμη παρουσία. Αυτός ο κατασκευαστής έχει σχεδιαστεί για χρήση από το [`SmartResourceCreator`](../smartresourcecreator/) και σε μονάδες δοκιμής. Χρησιμοποιήστε το [`SmartResourceCreator`](../smartresourcecreator/) για τη δημιουργία κλάσεων SoLdResource. |
...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | Ανακτά ή ορίζει το παγκόσμιο μοναδικό αναγνωριστικό των δεδομένων επιπέδου έξυπνου αντικειμένου [`SmartObjectResource`](../smartobjectresource/) στην εικόνα PSD. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | Το κλειδί πληροφοριών του εργαλείου τύπου: 'SoLd'. |
