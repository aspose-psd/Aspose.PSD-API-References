...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer τάξη. Επίπεδο προσαρμογής PhotoFilter.
type: docs
weight: 1790
...
Επίπεδο προσαρμογής PhotoFilter.
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Λαμβάνει ή ορίζει το χρώμα RGB του φίλτρου. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Λαμβάνει ή ορίζει την πυκνότητα του filter |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [διατήρηση φωτεινότητας]. |
