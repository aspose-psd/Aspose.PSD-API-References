...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer τάξη. Στρώση αφίσας. Χειρίζεται την απόδοση Posterize χρησιμοποιώντας δεδομένα από το PostResource.
type: docs
weight: 1800
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
## PosterizeLayer class

Στρώση αφίσας. Χειρίζεται την απόδοση Posterize χρησιμοποιώντας δεδομένα από το PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Επίπεδα επιπέδου Posterize. |
