---
title: "Κλάση PosterizeLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer class. Posterize layer. Διαχειρίζεται την απόδοση του Posterize χρησιμοποιώντας δεδομένα από το PostResource"
type: docs
weight: 1870
...
Στρώμα Posterize. Διαχειρίζεται την απόδοση του Posterize χρησιμοποιώντας δεδομένα από το PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Επίπεδα του Posterize layer. |
