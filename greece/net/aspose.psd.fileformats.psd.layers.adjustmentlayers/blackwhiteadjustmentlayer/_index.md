---
title: "Κλάση BlackWhiteAdjustmentLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BlackWhiteAdjustmentLayer κλάση. Η κλάση επιπέδου προσαρμογής Μαύρο-Άσπρο"
type: docs
weight: 1710
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
{{< psd/tize >}}
## BlackWhiteAdjustmentLayer class

Η κλάση στρώματος ρύθμισης Black and White.
...
| [BlackAndWhitePresetFileName](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blackandwhitepresetfilename/) { get; set; } | Λαμβάνει ή ορίζει το όνομα αρχείου προεπιλογής μαύρο-άσπρου. |
...
| [Blues](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blues/) { get; set; } | Λαμβάνει ή ορίζει την τιμή των μπλε. |
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind/) { get; set; } | Λαμβάνει ή ορίζει την τιμή του τύπου προεπιλογής μαύρο-άσπρου. |
...
| [Cyans](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans/) { get; set; } | Λαμβάνει ή ορίζει την τιμή των κυανών. |
...
| [Greens](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens/) { get; set; } | Λαμβάνει ή ορίζει την τιμή των πράσινων. |
...
| [Magentas](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/magentas/) { get; set; } | Λαμβάνει ή ορίζει την τιμή των ματζέντα. |
...
| [Reds](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/reds/) { get; set; } | Λαμβάνει ή ορίζει την τιμή των κόκκινων. |
...
| [TintColor](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolor/) { get; set; } | Λαμβάνει ή ορίζει την τιμή του Tint Color. |
| [TintColorBlue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/) { get; set; } | Λαμβάνει ή ορίζει τη διπλή τιμή του Blue Tint Color. |
| [TintColorGreen](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorgreen/) { get; set; } | Λαμβάνει ή ορίζει τη διπλή τιμή του Green Tint Color. |
| [TintColorRed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorred/) { get; set; } | Λαμβάνει ή ορίζει τη διπλή τιμή του Red Tint Color. |
...
| [UseTint](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/usetint/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [tint color] χρησιμοποιείται. |
...
| [Yellows](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/) { get; set; } | Λαμβάνει ή ορίζει την τιμή των κίτρινων. |
