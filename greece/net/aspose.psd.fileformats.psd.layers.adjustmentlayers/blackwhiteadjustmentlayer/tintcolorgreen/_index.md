...
description: BlackWhiteAdjustmentLayer ιδιοκτησία. Λαμβάνει ή ορίζει τη διπλή τιμή Green Tint Color.
type: docs
weight: 100
...
Λαμβάνει ή ορίζει τη διπλή τιμή Green Tint Color.
...
Η διπλή τιμή του πράσινου χρώματος.
