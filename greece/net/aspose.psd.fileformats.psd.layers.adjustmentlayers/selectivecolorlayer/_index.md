---
title: "Κλάση SelectiveColorLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorLayer κλάση. Επίπεδο Προσαρμογής Επιλεκτικού Χρώματος"
type: docs
weight: 1900
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
{{< psd/tize >}}
...
| [CorrectionMethod](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/correctionmethod/) { get; set; } | Λαμβάνει ή ορίζει τη μέθοδο διόρθωσης. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/version/) { get; } | Λαμβάνει την έκδοση. |
...
| [GetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/)(SelectiveColorsTypes) | Λαμβάνει τη διόρθωση cmyk με επιλεκτικό χρώμα. |
...
| [SetCmykCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/)(SelectiveColorsTypes, CmykCorrection) | Ορίζει τη διόρθωση cmyk με επιλεκτικό χρώμα. |
