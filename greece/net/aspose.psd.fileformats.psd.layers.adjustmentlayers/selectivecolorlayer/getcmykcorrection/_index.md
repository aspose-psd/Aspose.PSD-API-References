...
description: "SelectiveColorLayer μέθοδος. Λαμβάνει τη διόρθωση cmyk με επιλεκτικό χρώμα"
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | Επιλεκτικά χρώματα. |
