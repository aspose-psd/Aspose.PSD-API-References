...
description: "SelectiveColorLayer ιδιότητα. Λαμβάνει ή ορίζει τη μέθοδο διόρθωσης"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/correctionmethod/
---
{{< psd/tize >}}
## SelectiveColorLayer.CorrectionMethod property

Λαμβάνει ή ορίζει τη μέθοδο διόρθωσης.
