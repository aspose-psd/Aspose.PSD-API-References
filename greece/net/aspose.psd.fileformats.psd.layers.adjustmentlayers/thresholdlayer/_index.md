---
title: "Κλάση ThresholdLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ThresholdLayer κλάση. Επίπεδο Προσαρμογής Κατωφλίου"
type: docs
weight: 1920
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/thresholdlayer/
---
{{< psd/tize >}}
...
| [Level](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/thresholdlayer/level/) { get; set; } | Λαμβάνει και ορίζει το επίπεδο κατωφλίου. |
