---
title: "Απαρίθμηση CorrectionMethodTypes"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes απαρίθμηση. Μέθοδος διόρθωσης σε στρώμα προσαρμογής επιλεκτικού χρώματος"
type: docs
weight: 1780
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
## CorrectionMethodTypes enumeration

Μέθοδος διόρθωσης στη στρώση προσαρμογής επιλεκτικού χρώματος.
...
| --- | --- | --- |
| Relative | `0` | Εφαρμόστε διόρθωση χρώματος σε σχετική λειτουργία. |
| Absolute | `1` | Εφαρμόστε διόρθωση χρώματος σε απόλυτη λειτουργία. |
