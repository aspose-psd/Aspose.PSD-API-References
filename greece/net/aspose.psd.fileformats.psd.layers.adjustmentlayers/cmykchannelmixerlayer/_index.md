---
title: "Κλάση CmykChannelMixerLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer κλάση. Στρώση προσαρμογής μίξης καναλιών Cmyk"
type: docs
weight: 1740
...
Στρώμα Cmyk Channel Mixer Adjustment.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | Λαμβάνει το μαύρο κανάλι. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Λαμβάνει το κυανό κανάλι. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | Λαμβάνει το ματζέντα κανάλι. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Αποκτά ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [`ChannelMixerLayer`](../channelmixerlayer/) είναι μονόχρωμο. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | Λαμβάνει το κίτρινο κανάλι. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Λαμβάνει το δείκτη του καναλιού κατά. Επιστρέφει CmykMixerChannel |
