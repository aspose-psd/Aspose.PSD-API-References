...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.InvertAdjustmentLayer τάξη. Η κλάση στρώματος προσαρμογής αναστροφής.
type: docs
weight: 1760
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
## InvertAdjustmentLayer class

Η κλάση στρώματος προσαρμογής αναστροφής.
