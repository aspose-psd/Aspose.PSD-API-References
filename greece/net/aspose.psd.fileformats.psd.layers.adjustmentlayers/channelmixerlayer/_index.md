...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer τάξη. Επίπεδο προσαρμογής μείκτη καναλιών.
type: docs
weight: 1690
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
## ChannelMixerLayer class

Επίπεδο προσαρμογής μείκτη καναλιών.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό`ChannelMixerLayer` είναι μονόχρωμη. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Λαμβάνει το ευρετήριο του καναλιού κατά. Μπορεί να επιστρέψει RgbMixerChannel ή CmykMixerChannel |
