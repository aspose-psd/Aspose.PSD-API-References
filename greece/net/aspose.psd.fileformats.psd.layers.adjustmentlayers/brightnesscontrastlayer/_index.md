...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer τάξη. Στρώμα φωτεινότητας/αντίθεσης.
type: docs
weight: 1680
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
## BrightnessContrastLayer class

Στρώμα φωτεινότητας/αντίθεσης.
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | Λαμβάνει ή ρυθμίζει τη φωτεινότητα. Για PS το εύρος φωτεινότητας είναι από -150 έως +150. Αλλά το αγνοούμε αυτό. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | Λαμβάνει ή ρυθμίζει την αντίθεση. Για PS το εύρος αντίθεσης είναι από -50 έως +100. Αλλά το αγνοούμε αυτό. |
