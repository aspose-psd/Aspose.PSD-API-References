...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer τάξη. Επίπεδο ρύθμισης HueSaturation.
type: docs
weight: 1750
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
## HueSaturationLayer class

Επίπεδο ρύθμισης HueSaturation.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό`HueSaturationLayer` είναι colorize. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Λαμβάνει ή ορίζει την απόχρωση. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | Παίρνει ή ρυθμίζει την ελαφρότητα. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | Λαμβάνει ή ρυθμίζει τον κορεσμό. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | Λαμβάνει το εύρος. |
