...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer τάξη. Πραγματοποίηση του επιπέδου προσαρμογής Vibrance
type: docs
weight: 1830
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
## VibranceLayer class

Πραγματοποίηση του επιπέδου προσαρμογής Vibrance
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation/) { get; set; } | Λαμβάνει ή ρυθμίζει τον κορεσμό. |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance/) { get; set; } | Λαμβάνει ή ρυθμίζει τη δόνηση. |
