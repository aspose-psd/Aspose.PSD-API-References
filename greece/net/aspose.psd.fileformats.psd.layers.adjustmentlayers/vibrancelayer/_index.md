---
title: "Κλάση VibranceLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.VibranceLayer κλάση. Υλοποίηση της στρώσης ρύθμισης Vibrance"
type: docs
weight: 1930
...
Υλοποίηση στρώσης προσαρμογής Vibrance
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/saturation/) { get; set; } | Αποκτά ή ορίζει τον κορεσμό. |
...
| [Vibrance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/vibrance/) { get; set; } | Αποκτά ή ορίζει τη ζωντάνια. |
