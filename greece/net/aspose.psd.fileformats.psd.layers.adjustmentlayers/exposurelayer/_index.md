---
title: "Κλάση ExposureLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer κλάση. Στρώση ρύθμισης Exposure"
type: docs
weight: 1800
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Αποκτά ή ορίζει το Exposure. Για το PS το εύρος του Exposure είναι από -20 έως +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Αποκτά ή ορίζει το GammaCorrection. Για το PS το εύρος του GammaCorrection είναι από 9.99 έως +0.01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Αποκτά ή ορίζει το Offset. Για το PS το εύρος του Offset είναι από -0.5 έως +0.5 |
