...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ExposureLayer τάξη. Επίπεδο προσαρμογής έκθεσης.
type: docs
weight: 1740
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
## ExposureLayer class

Επίπεδο προσαρμογής έκθεσης.
...
| [Exposure](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/exposure/) { get; set; } | Λαμβάνει ή ορίζει την έκθεση. Για PS το εύρος έκθεσης είναι από -20 έως +20. |
...
| [GammaCorrection](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/gammacorrection/) { get; set; } | Λαμβάνει ή ορίζει το GammaCorrection. Για PS το εύρος GammaCorrection είναι από 9,99 έως +0,01 |
...
| [Offset](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/offset/) { get; set; } | Λαμβάνει ή ορίζει το Offset. Για PS το εύρος Offset είναι από -0,5 έως +0,5 |
