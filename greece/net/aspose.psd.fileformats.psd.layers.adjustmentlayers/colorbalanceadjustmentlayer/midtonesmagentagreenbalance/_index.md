...
description: "Ιδιότητα ColorBalanceAdjustmentLayer. Λαμβάνει ή ορίζει το Midtones Magenta Green Balance"
type: docs
weight: 50
...
| εξαίρεση | συνθήκη |
| --- | --- |
| ArgumentOutOfRangeException | Το Midtones Magenta Green Balance πρέπει να είναι στο εύρος από -100 έως +100. |
