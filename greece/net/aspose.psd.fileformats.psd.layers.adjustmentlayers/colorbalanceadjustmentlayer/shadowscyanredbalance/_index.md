...
description: ColorBalanceAdjustmentLayer ιδιοκτησία. Λαμβάνει ή ρυθμίζει το Shadows Cyan Red Balance.
type: docs
weight: 80
...
| εξαίρεση | κατάσταση |
| --- | --- |
| ArgumentOutOfRangeException | Shadows Cyan Red Balance πρέπει να κυμαίνεται από -100 έως +100. |
