...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer κλάση. Ρυθμιστική στρώση Rgb Channel Mixer"
type: docs
weight: 1880
...
Rgb Channel Mixer Στρώση προσαρμογής.
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel/) { get; } | Αποκτά το μπλε κανάλι. |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel/) { get; } | Αποκτά το πράσινο κανάλι. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel/) { get; } | Αποκτά το κόκκινο κανάλι. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | Αποκτά τον δείκτη του καναλιού. Επιστρέφει RgbMixerChannel |
