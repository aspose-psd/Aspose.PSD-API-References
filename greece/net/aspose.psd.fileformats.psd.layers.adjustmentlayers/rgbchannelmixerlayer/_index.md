...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer τάξη. Επίπεδο προσαρμογής μείκτη καναλιών Rgb.
type: docs
weight: 1810
url: /el/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
## RgbChannelMixerLayer class

Επίπεδο προσαρμογής μείκτη καναλιών Rgb.
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel/) { get; } | Παίρνει το μπλε κανάλι. |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel/) { get; } | Παίρνει το πράσινο κανάλι. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel/) { get; } | Παίρνει το κόκκινο κανάλι. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | Λαμβάνει το ευρετήριο του καναλιού κατά. Επιστρέφει RgbMixerChannel |
