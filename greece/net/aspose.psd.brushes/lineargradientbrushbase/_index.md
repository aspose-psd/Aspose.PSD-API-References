...
description: Aspose.PSD.Brushes.LinearGradientBrushBase τάξη. Αντιπροσωπεύει αBrush με δυνατότητες κλίσης και κατάλληλες ιδιότητες.
type: docs
weight: 150
...
Αντιπροσωπεύει α[`Brush`](../../aspose.psd/brush/) με δυνατότητες κλίσης και κατάλληλες ιδιότητες.
...
| [GammaCorrection](../../aspose.psd.brushes/lineargradientbrushbase/gammacorrection/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η διόρθωση γάμμα είναι ενεργοποιημένη για αυτό`LinearGradientBrushBase` . |
| [IsAngleScalable](../../aspose.psd.brushes/lineargradientbrushbase/isanglescalable/) { get; set; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν[`Angle`](./angle/) αλλάζει κατά τη διάρκεια των μετασχηματισμών με αυτό`LinearGradientBrushBase` . |
