---
title: "Κλάση PathMulticolorGradientBrush"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Κλάση Aspose.PSD.Brushes.PathMulticolorGradientBrush. Περιβάλλει ένα αντικείμενο Brush με μια διαβάθμιση. Αυτή η κλάση δεν μπορεί να κληρονομηθεί."
type: docs
weight: 190
url: /el/net/aspose.psd.brushes/pathmulticolorgradientbrush/
---
{{< psd/tize >}}
...
| Όνομα | Περιγραφή |
| --- | --- |
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor)(GraphicsPath) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `PathMulticolorGradientBrush` με το καθορισμένο μονοπάτι. |
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor_1)(PointF[]) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `PathMulticolorGradientBrush` με τα καθορισμένα σημεία. |
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor_3)(Point[]) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `PathMulticolorGradientBrush` με τα καθορισμένα σημεία. |
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor_2)(PointF[], WrapMode) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `PathMulticolorGradientBrush` με τα καθορισμένα σημεία και τη λειτουργία περιτύλιξης. |
| [PathMulticolorGradientBrush](pathmulticolorgradientbrush/#constructor_4)(Point[], WrapMode) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης `PathMulticolorGradientBrush` με τα καθορισμένα σημεία και τη λειτουργία περιτύλιξης. |
...
| [InterpolationColors](../../aspose.psd.brushes/pathmulticolorgradientbrush/interpolationcolors/) { get; set; } | Λαμβάνει ή ορίζει ένα [`ColorBlend`](../../aspose.psd/colorblend/) που ορίζει ένα πολυχρωματικό γραμμικό gradient. |
