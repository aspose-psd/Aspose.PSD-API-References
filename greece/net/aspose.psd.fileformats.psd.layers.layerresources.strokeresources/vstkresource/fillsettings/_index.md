...
description: "VstkResource ιδιότητα. Λαμβάνει ή ορίζει τις Fill settings του Stroke"
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vstkresource/fillsettings/
---
{{< psd/tize >}}
## VstkResource.FillSettings property

Λαμβάνει ή ορίζει τις ρυθμίσεις γεμίσματος του Stroke.
