...
description: BezierKnotRecord κατασκευαστής. Αρχικοποιεί μια νέα παρουσία τουBezierKnotRecord τάξη.
type: docs
weight: 10
...
Αρχικοποιεί μια νέα παρουσία του[`BezierKnotRecord`](../) τάξη.
