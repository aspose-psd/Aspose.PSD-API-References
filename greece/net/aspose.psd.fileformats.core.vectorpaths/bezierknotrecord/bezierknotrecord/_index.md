...
description: "Κατασκευαστής BezierKnotRecord. Αρχικοποιεί μια νέα παρουσία της κλάσης BezierKnotRecord"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.core.vectorpaths/bezierknotrecord/bezierknotrecord/
---
{{< psd/tize >}}
## BezierKnotRecord() {#constructor}

Αρχικοποιεί μια νέα παρουσία της κλάσης [`BezierKnotRecord`](../).
