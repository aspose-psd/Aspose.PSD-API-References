...
description: VectorShapeOriginSettings ιδιοκτησία. Λαμβάνει ή ορίζει τον πίνακα μετασχηματισμού.
type: docs
weight: 170
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/transform/
---
...
Αυτό το παράδειγμα δείχνει πώς να αλλάξετε το μέγεθος των επιπέδων με έναν πόρο Vogk και διανυσματική διαδρομή στην εικόνα PSD.
