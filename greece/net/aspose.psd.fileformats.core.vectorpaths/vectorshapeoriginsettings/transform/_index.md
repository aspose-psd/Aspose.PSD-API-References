...
description: "Ιδιότητα VectorShapeOriginSettings. Λαμβάνει ή ορίζει τον πίνακα μετασχηματισμού"
type: docs
weight: 170
...
Αυτό το παράδειγμα δείχνει πώς να αλλάξετε το μέγεθος των επιπέδων με έναν πόρο Vogk και διανυσματικό μονοπάτι στην εικόνα PSD.
