...
description: VectorShapeOriginSettings κατασκευαστής. Αρχικοποιεί μια νέα παρουσία τουVectorShapeOriginSettings τάξη.
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
## VectorShapeOriginSettings constructor

Αρχικοποιεί μια νέα παρουσία του[`VectorShapeOriginSettings`](../) τάξη.
