...
description: "VectorShapeOriginSettings ιδιότητα. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το σχήμα είναι ακυρωμένο"
type: docs
weight: 80
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν το σχήμα είναι ακυρωμένο.
