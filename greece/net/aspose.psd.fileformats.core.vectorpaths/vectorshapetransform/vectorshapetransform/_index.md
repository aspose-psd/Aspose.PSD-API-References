...
description: "Κατασκευαστής VectorShapeTransform. Δημιουργεί ένα νέο αντικείμενο της κλάσης VectorShapeTransform"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/vectorshapetransform/
---
{{< psd/tize >}}
## VectorShapeTransform constructor

Δημιουργεί ένα νέο αντικείμενο της κλάσης [`VectorShapeTransform`](../).
