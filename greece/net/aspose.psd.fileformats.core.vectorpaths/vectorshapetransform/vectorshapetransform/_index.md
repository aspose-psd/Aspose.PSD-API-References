...
description: VectorShapeTransform κατασκευαστής. Αρχικοποιεί μια νέα παρουσία τουVectorShapeTransform τάξη.
type: docs
weight: 10
...
Αρχικοποιεί μια νέα παρουσία του[`VectorShapeTransform`](../) τάξη.
