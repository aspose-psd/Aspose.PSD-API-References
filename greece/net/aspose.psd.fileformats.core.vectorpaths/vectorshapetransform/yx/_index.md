...
description: VectorShapeTransform ιδιοκτησία. Λαμβάνει ή ορίζει την τιμή YX.
type: docs
weight: 60
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yx/
---
## VectorShapeTransform.Yx property

Λαμβάνει ή ορίζει την τιμή YX.
