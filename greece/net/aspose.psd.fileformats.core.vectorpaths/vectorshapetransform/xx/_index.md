...
description: VectorShapeTransform ιδιοκτησία. Λαμβάνει ή ορίζει την τιμή XX.
type: docs
weight: 40
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx/
---
## VectorShapeTransform.Xx property

Λαμβάνει ή ορίζει την τιμή XX.
