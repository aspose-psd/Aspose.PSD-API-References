...
| [Xx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx/) { get; set; } | Λαμβάνει ή ορίζει την τιμή XX. |
| [Xy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy/) { get; set; } | Λαμβάνει ή ορίζει την τιμή XY. |
