...
description: VectorShapeTransform ιδιοκτησία. Λαμβάνει ή ορίζει την τιμή TX.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/tx/
---
## VectorShapeTransform.Tx property

Λαμβάνει ή ορίζει την τιμή TX.
