...
description: VectorShapeTransform ιδιοκτησία. Λαμβάνει ή ορίζει την τιμή XY.
type: docs
weight: 50
url: /el/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy/
---
## VectorShapeTransform.Xy property

Λαμβάνει ή ορίζει την τιμή XY.
