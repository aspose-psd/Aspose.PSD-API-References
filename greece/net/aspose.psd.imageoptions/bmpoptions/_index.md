...
description: "Η κλάση Aspose.PSD.ImageOptions.BmpOptions. Οι επιλογές δημιουργίας μορφής αρχείου bmp."
type: docs
weight: 5280
...
| Όνομα | Περιγραφή |
| --- | --- |
| [BmpOptions](bmpoptions/#constructor)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `BmpOptions`. |
| [BmpOptions](bmpoptions/#constructor_1)(BmpOptions) | Αρχικοποιεί μια νέα παρουσία της κλάσης `BmpOptions`. |

## Ιδιότητες

| Όνομα | Περιγραφή |
| --- | --- |
| [BitsPerPixel](../../aspose.psd.imageoptions/bmpoptions/bitsperpixel/) { get; set; } | Λαμβάνει ή ορίζει τον αριθμό bit ανά pixel της εικόνας. |
...
| [Compression](../../aspose.psd.imageoptions/bmpoptions/compression/) { get; set; } | Λαμβάνει ή ορίζει τη συμπίεση. |
