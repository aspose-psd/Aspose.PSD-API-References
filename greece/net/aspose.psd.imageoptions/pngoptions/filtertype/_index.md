...
description: "Ιδιότητα PngOptions. Λαμβάνει ή ορίζει τον τύπο φίλτρου που χρησιμοποιείται κατά τη διαδικασία αποθήκευσης αρχείου png"
type: docs
weight: 50
url: /el/net/aspose.psd.imageoptions/pngoptions/filtertype/
---
{{< psd/tize >}}
