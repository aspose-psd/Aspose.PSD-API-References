...
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType enum. Ορίζει την απαρίθμηση SmartObjectType για τον τύπο περιεχομένου του έξυπνου αντικειμένου."
type: docs
weight: 3920
...
Ορίζει την απαρίθμηση SmartObjectType για τον τύπο περιεχομένου smart object
...
| LibraryLink | `3` | Ο σύνδεσμος της βιβλιοθήκης Adobe® Photoshop® ÑÑ |
