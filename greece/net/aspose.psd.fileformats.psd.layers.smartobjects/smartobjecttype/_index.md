...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType αρίθμηση. Καθορίζει την απαρίθμηση SmartObjectType για περιεχόμενο έξυπνου αντικειμένου type
type: docs
weight: 3500
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
## SmartObjectType enumeration

Καθορίζει την απαρίθμηση SmartObjectType για περιεχόμενο έξυπνου αντικειμένου type
...
| --- | --- | --- |
| Embedded | `0` | Το ενσωματωμένο περιεχόμενο |
| AvailableLinked | `1` | Το συνδεδεμένο αρχείο που είναι διαθέσιμο |
| UnavailableLinked | `2` | Το συνδεδεμένο αρχείο που δεν είναι διαθέσιμο |
| LibraryLink | `3` | Σύνδεσμος βιβλιοθήκης Adobe® Photoshop® ÑÑ |
...
* χώρος ονομάτων [Aspose.PSD.FileFormats.Psd.Layers.SmartObjects](../../aspose.psd.fileformats.psd.layers.smartobjects/)
