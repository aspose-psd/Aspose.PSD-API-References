...
description: SmartObjectLayer μέθοδος. Εξάγει το ενσωματωμένο ή συνδεδεμένο περιεχόμενο σε ένα αρχείο.
type: docs
weight: 100
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/exportcontents/
---
## SmartObjectLayer.ExportContents method

Εξάγει το ενσωματωμένο ή συνδεδεμένο περιεχόμενο σε ένα αρχείο.
...
| --- | --- | --- |
| filePath | String | Η διαδρομή του αρχείου εξαγωγής. |
