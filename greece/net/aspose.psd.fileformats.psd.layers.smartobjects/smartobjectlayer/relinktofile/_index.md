...
description: "Μέθοδος SmartObjectLayer. Επανασυνδέει το συνδεδεμένο έξυπνο αντικείμενο σε νέο αρχείο. Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά."
type: docs
weight: 150
...
Επανασυνδέει το συνδεδεμένο smart object σε νέο αρχείο. Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά.
