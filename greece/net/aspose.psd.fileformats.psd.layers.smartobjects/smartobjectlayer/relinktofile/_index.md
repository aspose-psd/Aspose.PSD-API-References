...
description: SmartObjectLayer μέθοδος. Συνδέει ξανά το συνδεδεμένο έξυπνο αντικείμενο σε ένα νέο αρχείο. Δεν χρειάζεται να καλέσετε στη συνέχεια τη μέθοδο UpdateModifiedContent.
type: docs
weight: 130
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/
---
## SmartObjectLayer.RelinkToFile method

Συνδέει ξανά το συνδεδεμένο έξυπνο αντικείμενο σε ένα νέο αρχείο. Δεν χρειάζεται να καλέσετε στη συνέχεια τη μέθοδο UpdateModifiedContent.
