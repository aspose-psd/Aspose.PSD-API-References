...
description: "Ιδιότητα SmartObjectLayer. Λαμβάνει ή ορίζει την πηγή περιεχομένου έξυπνου αντικειμένου"
type: docs
weight: 40
...
Λαμβάνει ή ορίζει την πηγή του περιεχομένου του smart object.
...
Η πηγή δεδομένων του έξυπνου αντικειμένου.
