...
description: SmartObjectLayer ιδιοκτησία. Λαμβάνει ή ορίζει την πηγή του περιεχομένου του έξυπνου αντικειμένου.
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentssource/
---
## SmartObjectLayer.ContentsSource property

Λαμβάνει ή ορίζει την πηγή του περιεχομένου του έξυπνου αντικειμένου.
...
Η πηγή δεδομένων έξυπνου αντικειμένου.
