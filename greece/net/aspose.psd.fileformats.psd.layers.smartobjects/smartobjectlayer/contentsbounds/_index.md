...
description: "Ιδιότητα SmartObjectLayer. Λαμβάνει ή ορίζει τα όρια του περιεχομένου του έξυπνου αντικειμένου"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει τα όρια του περιεχομένου του smart object.
...
Τα όρια του έξυπνου αντικειμένου.
