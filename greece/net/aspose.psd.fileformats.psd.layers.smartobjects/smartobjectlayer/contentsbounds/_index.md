...
description: SmartObjectLayer ιδιοκτησία. Λαμβάνει ή ορίζει τα όρια του περιεχομένου του έξυπνου αντικειμένου.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentsbounds/
---
## SmartObjectLayer.ContentsBounds property

Λαμβάνει ή ορίζει τα όρια του περιεχομένου του έξυπνου αντικειμένου.
...
Το έξυπνο αντικείμενο περιορίζει.
