...
description: "Ιδιότητα SmartObjectLayer. Λαμβάνει ή ορίζει τις παραμέτρους Warp που ορίστηκαν ή λήφθηκαν από το προεπιλεγμένο πόρο."
type: docs
weight: 80
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

Ανακτά ή ορίζει τις παραμέτρους Warp που είχαν οριστεί ή ληφθεί από τον πόρο (προεπιλογή)
