...
description: SmartObjectLayer μέθοδος. Ενσωματώνει το συνδεδεμένο έξυπνο αντικείμενο σε αυτό το επίπεδο.
type: docs
weight: 90
url: /el/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/embedlinked/
---
