...
description: "Aspose.PSD.FileFormats.Psd.Resources.Enums.ColorSpace enum. Τύποι χρωματικού χώρου"
type: docs
weight: 4160
url: /el/net/aspose.psd.fileformats.psd.resources.enums/colorspace/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| RGB | `0` | Ο χρωματικός χώρος RGB. |
| HSB | `1` | Ο χρωματικός χώρος HSB. |
| CMYK | `2` | Ο χρωματικός χώρος CMYK. |
| Lab | `7` | Ο χρωματικός χώρος Lab. |
| GrayScale | `8` | Ο χρωματικός χώρος GrayScale. |
