...
description: LayerStateEffects μέθοδος. Προσθέτει το εφέ εξωτερικής λάμψης.
type: docs
weight: 70
...
Το νέο παράδειγμα του[`OuterGlowEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/outergloweffect/) τάξη.
