...
description: LayerStateEffects μέθοδος. Προσθέτει το εφέ επικάλυψης χρώματος.
type: docs
weight: 30
...
Το νέο παράδειγμα του[`ColorOverlayEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/coloroverlayeffect/) τάξη.
