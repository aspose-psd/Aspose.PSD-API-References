...
description: LayerState ιδιοκτησία. Λαμβάνει ή ρυθμίζει τη λειτουργία blen.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.animation/layerstate/blendmode/
---
## LayerState.BlendMode property

Λαμβάνει ή ρυθμίζει τη λειτουργία blen.
