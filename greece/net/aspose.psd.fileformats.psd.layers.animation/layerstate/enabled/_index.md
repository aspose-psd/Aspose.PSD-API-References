...
description: LayerState ιδιοκτησία. Λαμβάνει ή ορίζει την κατάσταση ενεργοποίησης.
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.animation/layerstate/enabled/
---
## LayerState.Enabled property

Λαμβάνει ή ορίζει την κατάσταση ενεργοποίησης.
