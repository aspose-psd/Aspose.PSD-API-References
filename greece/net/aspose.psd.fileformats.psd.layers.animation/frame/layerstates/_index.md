...
description: Frame ιδιοκτησία. Λαμβάνει ot ορίζει τις καταστάσεις στρώματος του πλαισίου.
type: docs
weight: 50
url: /el/net/aspose.psd.fileformats.psd.layers.animation/frame/layerstates/
---
## Frame.LayerStates property

Λαμβάνει ot ορίζει τις καταστάσεις στρώματος του πλαισίου.
...
* class [Frame](../)
* χώρος ονομάτων [Aspose.PSD.FileFormats.Psd.Layers.Animation](../../frame/)
