...
description: Aspose.PSD.FileFormats.Psd.Resources.ColorTransferFunctionsResource τάξη. Πηγή μεταφοράς χρώματος
type: docs
weight: 3680
url: /el/net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
## ColorTransferFunctionsResource class

Πηγή μεταφοράς χρώματος
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ColorTransferFunctionsResource](colortransferfunctionsresource/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [ColorTransferData](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/colortransferdata/) { get; set; } | Λαμβάνει ή ορίζει τα δεδομένα μεταφοράς χρώματος. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/datasize/) { get; } | Λαμβάνει το μέγεθος δεδομένων πόρων σε byte. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό για τον πόρο. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/minimalversion/) { get; } | Αποκτά την ελάχιστη απαιτούμενη έκδοση PSD. |
