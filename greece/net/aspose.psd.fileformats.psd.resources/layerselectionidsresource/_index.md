---
title: "Κλάση LayerSelectionIdsResource"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Resources.LayerSelectionIdsResource class. Πόρος αναγνωριστικών επιλογής στρώματος"
type: docs
weight: 4270
url: /el/net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
{{< psd/tize >}}
## LayerSelectionIdsResource class

Πόρος αναγνωριστικών επιλογής στρώσεων
...
| Όνομα | Περιγραφή |
| --- | --- |
| [LayerSelectionIdsResource](layerselectionidsresource/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Όνομα | Περιγραφή |
| --- | --- |
| [Count](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/count/) { get; set; } | Λαμβάνει ή ορίζει τον αριθμό. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/datasize/) { get; } | Λαμβάνει το μέγεθος δεδομένων του πόρου σε byte. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό για τον πόρο. |
| [LayerIds](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/layerids/) { get; set; } | Λαμβάνει ή ορίζει τα αναγνωριστικά στρώσης. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/minimalversion/) { get; } | Λαμβάνει την ελάχιστη απαιτούμενη έκδοση PSD. |
