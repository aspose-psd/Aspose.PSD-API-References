...
description: Aspose.PSD.FileFormats.Psd.Resources.CaptionDigestResource τάξη. CaptionDigest resource
type: docs
weight: 3660
url: /el/net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CaptionDigestResource](captiondigestresource/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/captiondigestresource/datasize/) { get; } | Λαμβάνει το μέγεθος δεδομένων πόρων σε byte. |
| [Digest](../../aspose.psd.fileformats.psd.resources/captiondigestresource/digest/) { get; set; } | Λαμβάνει ή ρυθμίζει τη σύνοψη. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό για τον πόρο. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/captiondigestresource/minimalversion/) { get; } | Αποκτά την ελάχιστη απαιτούμενη έκδοση PSD. |
