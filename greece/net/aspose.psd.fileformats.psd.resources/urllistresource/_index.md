...
description: Aspose.PSD.FileFormats.Psd.Resources.UrlListResource τάξη. Πηγός λίστας διευθύνσεων URL
type: docs
weight: 3950
url: /el/net/aspose.psd.fileformats.psd.resources/urllistresource/
---
## UrlListResource class

Πηγός λίστας διευθύνσεων URL
...
| Ονομα | Περιγραφή |
| --- | --- |
| [UrlListResource](urllistresource/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Count](../../aspose.psd.fileformats.psd.resources/urllistresource/count/) { get; set; } | Λαμβάνει ή ορίζει το πλήθος. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/urllistresource/datasize/) { get; } | Λαμβάνει το μέγεθος δεδομένων πόρων σε byte. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό για τον πόρο. |
| [Ids](../../aspose.psd.fileformats.psd.resources/urllistresource/ids/) { get; set; } | Λαμβάνει ή ορίζει τα αναγνωριστικά. |
| [Longs](../../aspose.psd.fileformats.psd.resources/urllistresource/longs/) { get; set; } | Παίρνει ή ρυθμίζει τα long. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/urllistresource/minimalversion/) { get; } | Αποκτά την ελάχιστη απαιτούμενη έκδοση PSD. |
...
| [Texts](../../aspose.psd.fileformats.psd.resources/urllistresource/texts/) { get; set; } | Λαμβάνει ή ορίζει τα κείμενα. |
