...
description: "Aspose.PSD.FileFormats.Psd.Resources.GlobalAngleResource class. Πόρος παγκόσμιας γωνίας"
type: docs
weight: 4190
url: /el/net/aspose.psd.fileformats.psd.resources/globalangleresource/
---
{{< psd/tize >}}
...
| Όνομα | Περιγραφή |
| --- | --- |
| [GlobalAngleResource](globalangleresource/)() | Ο προεπιλεγμένος κατασκευαστής. |

## Ιδιότητες

| Όνομα | Περιγραφή |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalangleresource/datasize/) { get; } | Λαμβάνει το μέγεθος δεδομένων του πόρου σε byte. |
| [GlobalAngle](../../aspose.psd.fileformats.psd.resources/globalangleresource/globalangle/) { get; set; } | Λαμβάνει ή ορίζει τη παγκόσμια γωνία. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Λαμβάνει ή ορίζει το μοναδικό αναγνωριστικό για τον πόρο. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/globalangleresource/minimalversion/) { get; } | Λαμβάνει την ελάχιστη απαιτούμενη έκδοση PSD. |
