...
description: Aspose.PSD.Shapes.RectangleShape τάξη. Αντιπροσωπεύει ένα ορθογώνιο σχήμα.
type: docs
weight: 5530
...
| Ονομα | Περιγραφή |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`RectangleShape` τάξη. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Αρχικοποιεί μια νέα παρουσία του`RectangleShape` τάξη. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Παίρνει τα τμήματα σχήματος. |
