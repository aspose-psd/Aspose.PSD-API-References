...
description: Aspose.PSD.Shapes.EllipseShape τάξη. Αντιπροσωπεύει ένα σχήμα έλλειψης.
type: docs
weight: 5490
...
Αντιπροσωπεύει ένα σχήμα έλλειψης.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`EllipseShape` τάξη. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | Αρχικοποιεί μια νέα παρουσία του`EllipseShape` τάξη. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | Παίρνει τα τμήματα σχήματος. |
