...
description: "Κλάση Aspose.PSD.Shapes.PieShape. Αντιπροσωπεύει ένα σχήμα πίτας"
type: docs
weight: 6000
...
| Όνομα | Περιγραφή |
| --- | --- |
| [PieShape](pieshape/#constructor)() | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `PieShape`. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης `PieShape`. |
...
| override [Segments](../../aspose.psd.shapes/pieshape/segments/) { get; } | Λαμβάνει τα τμήματα του σχήματος. |
