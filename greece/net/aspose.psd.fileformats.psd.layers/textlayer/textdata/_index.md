...
description: TextLayer ιδιοκτησία. Λαμβάνει τα τμήματα του κειμένου.
type: docs
weight: 60
url: /el/net/aspose.psd.fileformats.psd.layers/textlayer/textdata/
---
## TextLayer.TextData property

Λαμβάνει τα τμήματα του κειμένου.
