...
description: LayerHashCalculator κατασκευαστής. Αρχικοποιεί μια νέα παρουσία τουLayerHashCalculator τάξη.
type: docs
weight: 10
...
Αρχικοποιεί μια νέα παρουσία του[`LayerHashCalculator`](../) τάξη.
