...
description: "LayerHashCalculator constructor. Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης LayerHashCalculator"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/layerhashcalculator/
---
{{< psd/tize >}}
## LayerHashCalculator constructor

Αρχικοποιεί μια νέα παρουσία της κλάσης [`LayerHashCalculator`](../).
