...
description: "Μέθοδος LayerHashCalculator. Λαμβάνει το hash του περιεχομένου"
type: docs
weight: 40
...
Το hash των σημαντικών παραμέτρων των στρωμάτων. Αυτό το hash διαφέρει για όλους τους τύπους στρωμάτων
