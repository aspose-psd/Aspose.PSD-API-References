...
description: LayerHashCalculator μέθοδος. Λαμβάνει τον κατακερματισμό περιεχομένου.
type: docs
weight: 40
url: /el/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/getcontenthash/
---
## LayerHashCalculator.GetContentHash method

Λαμβάνει τον κατακερματισμό περιεχομένου.
...
Ο κατακερματισμός των σημαντικών παραμέτρων των επιπέδων. Αυτός ο κατακερματισμός είναι διαφορετικός για όλους τους τύπους επιπέδων
