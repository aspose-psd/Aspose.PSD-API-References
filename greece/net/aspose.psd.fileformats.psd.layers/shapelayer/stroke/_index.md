...
description: "Ιδιότητα ShapeLayer. Λαμβάνει ή ορίζει τις ρυθμίσεις Stroke των Shapes."
type: docs
weight: 50
url: /el/net/aspose.psd.fileformats.psd.layers/shapelayer/stroke/
---
{{< psd/tize >}}
## ShapeLayer.Stroke property

Λαμβάνει ή ορίζει τις ρυθμίσεις περιγράμματος των Σχημάτων.
