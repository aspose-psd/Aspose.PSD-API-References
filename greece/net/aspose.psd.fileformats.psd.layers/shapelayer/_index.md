...
description: "Κλάση Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer. Στρώμα Shape. Συγκρατεί τη λογική εργασίας με το στρώμα Shape και τους σχετικούς πόρους"
type: docs
weight: 3820
url: /el/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

Στρώση σχήματος. Συμπυκνώνει τη λογική εργασίας με τη στρώση σχήματος και τους σχετικούς πόρους.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `ShapeLayer`. Όλοι οι πόροι δημιουργούνται στην προεπιλεγμένη τους κατάσταση. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Λαμβάνει ή ορίζει τις ρυθμίσεις γεμίσματος για την εσωτερική περιοχή των Σχημάτων στο στρώμα Shape. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Λαμβάνει το σύνολο των Διαδρομών που εμφανίζονται σε ένα στρώμα Shape. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Λαμβάνει ή ορίζει τις ρυθμίσεις περιγράμματος των Σχημάτων. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Δημιουργεί μια νέα παρουσία της κλάσης `ShapeLayer`. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Ενημερώνει τους πόρους από τις ιδιότητες του στρώματος Shape. |
