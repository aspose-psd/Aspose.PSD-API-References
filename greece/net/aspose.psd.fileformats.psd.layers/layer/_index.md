...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer τάξη. Το επίπεδο psd.
type: docs
weight: 2080
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Layer](layer/#constructor)() | Αρχικοποιεί μια νέα παρουσία του`Layer` τάξη. Κατασκευαστής για lazy προετοιμασία. |
| [Layer](layer/#constructor_3)(Stream) | Αρχικοποιεί μια νέα παρουσία του`Layer` τάξη. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Αρχικοποιεί μια νέα παρουσία του`Layer` τάξη. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Αρχικοποιεί μια νέα παρουσία του`Layer` κλάση από πίνακες byte. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Αποθηκεύει τα δεδομένα του αντικειμένου στην καθορισμένη ροή. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Αποθηκεύει τα δεδομένα της εικόνας στην καθορισμένη ροή στην καθορισμένη μορφή αρχείου σύμφωνα με τις επιλογές αποθήκευσης. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Αντιπροσωπεύει την υπογραφή blend mode. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | Το μέγεθος της κεφαλίδας του επιπέδου. |
