...
description: "Aspose.PSD.FileFormats.Psd.Layers.Layer κλάση. Η στρώση psd"
type: docs
weight: 2270
url: /el/net/aspose.psd.fileformats.psd.layers/layer/
---
{{< psd/tize >}}
## Layer class
...
| Όνομα | Περιγραφή |
| --- | --- |
| [Layer](layer/#constructor)() | Αρχικοποιεί μια νέα παρουσία της κλάσης `Layer`. Κατασκευαστής για αργή αρχικοποίηση. |
| [Layer](layer/#constructor_3)(Stream) | Αρχικοποιεί μια νέα παρουσία της κλάσης `Layer`. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Αρχικοποιεί μια νέα παρουσία της κλάσης `Layer`. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Αρχικοποιεί μια νέα παρουσία της κλάσης `Layer` από πίνακες byte. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Αποθηκεύει τα δεδομένα του αντικειμένου στο καθορισμένο ρεύμα. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Αποθηκεύει τα δεδομένα του αντικειμένου στην καθορισμένη θέση αρχείου. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Αποθηκεύει τα δεδομένα του αντικειμένου στην καθορισμένη θέση αρχείου στην καθορισμένη μορφή αρχείου σύμφωνα με τις επιλογές αποθήκευσης. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Αποθηκεύει τα δεδομένα της εικόνας στο καθορισμένο ρεύμα στην καθορισμένη μορφή αρχείου σύμφωνα με τις επιλογές αποθήκευσης. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Αποθηκεύει τα δεδομένα του αντικειμένου στην καθορισμένη θέση αρχείου στην καθορισμένη μορφή αρχείου σύμφωνα με τις επιλογές αποθήκευσης. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Αναπαριστά την υπογραφή της λειτουργίας ανάμειξης. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | Το μέγεθος της κεφαλίδας της στρώσης. |
