---
title: "Διεπαφή IShapeLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Διεπαφή Aspose.PSD.FileFormats.Psd.Layers.IShapeLayer. Περιγράφει τις ιδιότητες του στρώματος Shape"
type: docs
weight: 2260
url: /el/net/aspose.psd.fileformats.psd.layers/ishapelayer/
---
{{< psd/tize >}}
## IShapeLayer interface

Περιγράφει τις ιδιότητες της στρώσης σχήματος.
...
| Όνομα | Περιγραφή |
| --- | --- |
| [Fill](../../aspose.psd.fileformats.psd.layers/ishapelayer/fill/) { get; set; } | Ρυθμίσεις γεμίσματος που χρησιμοποιούνται για το γέμισμα της εσωτερικής περιοχής των Σχημάτων. |
| [Path](../../aspose.psd.fileformats.psd.layers/ishapelayer/path/) { get; } | Το σύνολο των Διαδρομών που εμφανίζονται σε ένα στρώμα Shape. |
| [Stroke](../../aspose.psd.fileformats.psd.layers/ishapelayer/stroke/) { get; set; } | Ρυθμίσεις περιγράμματος σχημάτων. |
