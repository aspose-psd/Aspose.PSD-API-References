...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer τάξη. Το επίπεδο διαιρέτη τομής για την επισήμανση των ορίων του φακέλου ομάδα επιπέδων.
type: docs
weight: 3410
...
Το επίπεδο διαιρέτη τομής για την επισήμανση των ορίων του φακέλου (ομάδα επιπέδων).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι ορατή σε ομάδα (Εάν το στρώμα δεν είναι στην ομάδα, σημαίνει ομάδα ρίζας). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Λαμβάνει το[`LayerGroup`](../layergroup/) αυτό έχει σχέση με αυτό`SectionDividerLayer` παράδειγμα. |
