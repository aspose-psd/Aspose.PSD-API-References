---
title: "Κλάση SectionDividerLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer κλάση. Η στρώση διαχωριστή ενότητας για τον καθορισμό των ορίων της ομάδας στρώσεων φακέλου"
type: docs
weight: 3810
url: /el/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
{{< psd/tize >}}
## SectionDividerLayer class

Η στρώση διαχωριστή ενότητας για τον καθορισμό των ορίων του φακέλου (ομάδας στρώσεων).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι ορατή στην ομάδα (Εάν το στρώμα δεν βρίσκεται σε ομάδα, σημαίνει ότι είναι η ριζική ομάδα). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Λαμβάνει το [`LayerGroup`](../layergroup/) που σχετίζεται με αυτήν την παρουσία `SectionDividerLayer`. |
