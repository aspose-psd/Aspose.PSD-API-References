...
description: LinkedLayersManager μέθοδος. Λαμβάνει το αναγνωριστικό ομάδας συνδέσμων που σχετίζεται με το επίπεδο.
type: docs
weight: 20
...
Λαμβάνει το αναγνωριστικό ομάδας συνδέσμων που σχετίζεται με το επίπεδο.
