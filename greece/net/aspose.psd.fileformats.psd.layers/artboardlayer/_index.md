---
title: "Κλάση ArtboardLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer κλάση. Η κλάση artboard layer"
type: docs
weight: 1990
url: /el/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class

Η κλάση στρώματος artboard.
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Λαμβάνει ή ορίζει το χρώμα φόντου του artboard. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Λαμβάνει ή ορίζει το κλειδί της λειτουργίας ανάμειξης. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει αν το `ArtboardLayer` έχει το χρώμα φόντου. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Λαμβάνει ή ορίζει αν ο φάκελος είναι ανοιχτός· εάν οριστεί σε `true`, η ομάδα θα είναι σε ανοιχτή κατάσταση κατά την εκκίνηση, διαφορετικά σε ελαχιστοποιημένη κατάσταση. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Λαμβάνει τα επίπεδα στην ομάδα επιπέδων |
...
| Όνομα | Περιγραφή |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Προσθέτει το επίπεδο στην ομάδα επιπέδων. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Προσθέτει την ομάδα επιπέδων. |
