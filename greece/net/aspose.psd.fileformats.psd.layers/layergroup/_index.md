...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup τάξη. Κατηγορία επιπέδου ομάδας
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Λαμβάνει ή ρυθμίζει το πλήκτρο λειτουργίας ανάμειξης. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Παίρνει ύψος της ομάδας στρώσεων. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Λαμβάνει ή θέτει ο φάκελος open εάν έχει οριστεί σε`αληθής` από την ομάδα θα είναι σε ανοιχτή κατάσταση κατά την εκκίνηση, διαφορετικά σε ελαχιστοποιημένη κατάσταση. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Παίρνει τα επίπεδα στην ομάδα επιπέδων |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | Λαμβάνει το πλάτος της ομάδας στρώσεων. |
