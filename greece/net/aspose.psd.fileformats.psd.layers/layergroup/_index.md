---
title: "Κλάση LayerGroup"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerGroup κλάση. Κλάση ομάδας επιπέδων"
type: docs
weight: 2420
url: /el/net/aspose.psd.fileformats.psd.layers/layergroup/
---
{{< psd/tize >}}
## LayerGroup class

Κλάση ομάδας στρώσης
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Λαμβάνει το ύψος της ομάδας επιπέδων. |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | Λαμβάνει το πλάτος της ομάδας επιπέδων. |
