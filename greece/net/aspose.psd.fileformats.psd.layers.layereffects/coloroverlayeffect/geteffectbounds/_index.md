...
description: "ColorOverlayEffect μέθοδος. Υπολογίζει και λαμβάνει τα όρια των εικονοστοιχείων του εφέ βάσει των ορίων των εικονοστοιχείων της εισαγόμενης στρώσης"
type: docs
weight: 60
url: /el/net/aspose.psd.fileformats.psd.layers.layereffects/coloroverlayeffect/geteffectbounds/
---
{{< psd/tize >}}
