...
description: "Ιδιότητα StrokeEffect. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το StrokeEffect θα αναμείξει το stroke με το τρέχον περιεχόμενο της στρώσης"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [`StrokeEffect`](../) θα αναμείξει το stroke με το τρέχον περιεχόμενο της στρώσης.
...
`true` εάν πρέπει να αναμείξει το stroke με το τρέχον περιεχόμενο της στρώσης· διαφορετικά, `false`.
