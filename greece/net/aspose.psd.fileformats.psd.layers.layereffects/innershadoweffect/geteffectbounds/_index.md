...
description: "InnerShadowEffect μέθοδος. Υπολογίζει και λαμβάνει τα όρια των εικονοστοιχείων εφέ με βάση τα όρια των εικονοστοιχείων της εισαγόμενης στρώσης"
type: docs
weight: 120
url: /el/net/aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/geteffectbounds/
---
{{< psd/tize >}}
