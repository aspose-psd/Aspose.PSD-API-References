...
description: "Ιδιότητα WarpSettings. Λαμβάνει ή ορίζει το στυλ της παραμόρφωσης"
type: docs
weight: 70
url: /el/net/aspose.psd.fileformats.psd.layers.warp/warpsettings/style/
---
{{< psd/tize >}}
## WarpSettings.Style property

Λαμβάνει ή ορίζει το στυλ της παραμόρφωσης
