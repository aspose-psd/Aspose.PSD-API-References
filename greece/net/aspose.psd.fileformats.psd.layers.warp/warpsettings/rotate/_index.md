...
description: "WarpSettings ιδιότητα. Λαμβάνει ή ορίζει την τιμή περιστροφής"
type: docs
weight: 60
url: /el/net/aspose.psd.fileformats.psd.layers.warp/warpsettings/rotate/
---
{{< psd/tize >}}
## WarpSettings.Rotate property

Λαμβάνει ή ορίζει την τιμή περιστροφής
