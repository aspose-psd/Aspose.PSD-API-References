---
title: "Απαρίθμηση WarpRotates"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Aspose.PSD.FileFormats.Psd.Layers.Warp.WarpRotates enum. Τύποι περιστροφής παραμόρφωσης"
type: docs
weight: 4000
url: /el/net/aspose.psd.fileformats.psd.layers.warp/warprotates/
---
{{< psd/tize >}}
...
| --- | --- | --- |
| Horizontal | `0` | Οριζόντια κατεύθυνση παραμόρφωσης |
| Vertical | `1` | Κάθετη κατεύθυνση παραμόρφωσης |
