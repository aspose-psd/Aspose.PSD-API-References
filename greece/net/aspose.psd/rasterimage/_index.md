...
description: Aspose.PSD.RasterImage τάξη. Αντιπροσωπεύει μια εικόνα ράστερ που υποστηρίζει λειτουργίες γραφικών ράστερ.
type: docs
weight: 5320
...
Αντιπροσωπεύει μια εικόνα ράστερ που υποστηρίζει λειτουργίες γραφικών ράστερ.
...
| virtual [HorizontalResolution](../../aspose.psd/rasterimage/horizontalresolution/) { get; set; } | Λαμβάνει ή ορίζει την οριζόντια ανάλυση, σε pixel ανά ίντσα, αυτής`RasterImage` . |
...
| virtual [VerticalResolution](../../aspose.psd/rasterimage/verticalresolution/) { get; set; } | Λαμβάνει ή ορίζει την κατακόρυφη ανάλυση, σε pixel ανά ίντσα, αυτής`RasterImage` . |
...
| Ονομα | Περιγραφή |
| --- | --- |
| virtual [AdjustBrightness](../../aspose.psd/rasterimage/adjustbrightness/)(int) | Προσαρμογή φωτεινότητας για την εικόνα. |
| virtual [AdjustContrast](../../aspose.psd/rasterimage/adjustcontrast/)(float) | Αντίθεση εικόνας |
| virtual [AdjustGamma](../../aspose.psd/rasterimage/adjustgamma/#adjustgamma)(float) | Διόρθωση γάμμα εικόνας. |
| virtual [AdjustGamma](../../aspose.psd/rasterimage/adjustgamma/#adjustgamma_1)(float, float, float) | Διόρθωση γάμμα εικόνας. |
| virtual [BinarizeBradley](../../aspose.psd/rasterimage/binarizebradley/#binarizebradley)(double) | Δυαδοποίηση μιας εικόνας χρησιμοποιώντας τον προσαρμοστικό αλγόριθμο κατωφλίου του Bradley χρησιμοποιώντας το ενσωματωμένο thresholding |
| virtual [BinarizeBradley](../../aspose.psd/rasterimage/binarizebradley/#binarizebradley_1)(double, int) | Δυαδοποίηση μιας εικόνας χρησιμοποιώντας τον προσαρμοστικό αλγόριθμο κατωφλίου του Bradley χρησιμοποιώντας το ενσωματωμένο thresholding |
| virtual [BinarizeFixed](../../aspose.psd/rasterimage/binarizefixed/)(byte) | Δυαδοποίηση εικόνας με προκαθορισμένο όριο |
| virtual [BinarizeOtsu](../../aspose.psd/rasterimage/binarizeotsu/)() | Δυαδοποίηση εικόνας με thresholding Otsu |
...
| virtual [Crop](../../aspose.psd/rasterimage/crop/#crop)(Rectangle) | Περικόπτει το καθορισμένο ορθογώνιο. |
...
| [Dither](../../aspose.psd/rasterimage/dither/#dither)(DitheringMethod, int) | Εκτελεί παραμόρφωση στην τρέχουσα εικόνα. |
| abstract [Dither](../../aspose.psd/rasterimage/dither/#dither_1)(DitheringMethod, int, IColorPalette) | Εκτελεί παραμόρφωση στην τρέχουσα εικόνα. |
...
| [GetDefaultRawData](../../aspose.psd/rasterimage/getdefaultrawdata/#getdefaultrawdata)(Rectangle, RawDataSettings) | Λαμβάνει τον προεπιλεγμένο πίνακα πρωτογενών δεδομένων. |
| [GetDefaultRawData](../../aspose.psd/rasterimage/getdefaultrawdata/#getdefaultrawdata_1)(Rectangle, IPartialRawDataLoader, RawDataSettings) | Λαμβάνει τον προεπιλεγμένο πίνακα ακατέργαστων δεδομένων χρησιμοποιώντας μερικό φορτωτή εικονοστοιχείων. |
...
| virtual [Grayscale](../../aspose.psd/rasterimage/grayscale/)() | Μεταμόρφωση μιας εικόνας στην αναπαράστασή της σε κλίμακα του γκρι |
...
| [NormalizeAngle](../../aspose.psd/rasterimage/normalizeangle/#normalizeangle)() | Κανονικοποιεί τη γωνία. Αυτή η μέθοδος εφαρμόζεται σε σαρωμένα έγγραφα κειμένου για να απαλλαγούμε από τη λοξή σάρωση. Αυτή η μέθοδος χρησιμοποιεί[`GetSkewAngle`](./getskewangle/) και[`Rotate`](./rotate/) μέθοδοι. |
| virtual [NormalizeAngle](../../aspose.psd/rasterimage/normalizeangle/#normalizeangle_1)(bool, Color) | Κανονικοποιεί τη γωνία. Αυτή η μέθοδος εφαρμόζεται σε σαρωμένα έγγραφα κειμένου για να απαλλαγούμε από τη λοξή σάρωση. Αυτή η μέθοδος χρησιμοποιεί[`GetSkewAngle`](./getskewangle/) και[`Rotate`](./rotate/) μέθοδοι. |
...
| [ReplaceColor](../../aspose.psd/rasterimage/replacecolor/#replacecolor)(Color, byte, Color) | Αντικαθιστά το ένα χρώμα στο άλλο με την επιτρεπόμενη διαφορά και διατηρεί την αρχική τιμή άλφα για εξοικονόμηση ομαλών άκρων. |
| virtual [ReplaceColor](../../aspose.psd/rasterimage/replacecolor/#replacecolor_1)(int, byte, int) | Αντικαθιστά το ένα χρώμα στο άλλο με την επιτρεπόμενη διαφορά και διατηρεί την αρχική τιμή άλφα για εξοικονόμηση ομαλών άκρων. |
| [ReplaceNonTransparentColors](../../aspose.psd/rasterimage/replacenontransparentcolors/#replacenontransparentcolors)(Color) | Αντικαθιστά όλα τα αδιαφανή χρώματα με νέο χρώμα και διατηρεί την αρχική τιμή άλφα για εξοικονόμηση ομαλών άκρων. Σημείωση: εάν το χρησιμοποιείτε σε εικόνες χωρίς διαφάνεια, όλα τα χρώματα θα αντικατασταθούν με ένα. |
...
| override [Resize](../../aspose.psd/rasterimage/resize/#resize_1)(int, int, ImageResizeSettings) | Αλλάζει το μέγεθος της εικόνας με εκτεταμένες επιλογές. |
...
| virtual [Rotate](../../aspose.psd/rasterimage/rotate/#rotate)(float) | Περιστροφή εικόνας γύρω από το κέντρο. |
| virtual [Rotate](../../aspose.psd/rasterimage/rotate/#rotate_1)(float, bool, Color) | Περιστροφή εικόνας γύρω από το κέντρο. |
...
| override [Save](../../aspose.psd/rasterimage/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Αποθηκεύει τα δεδομένα της εικόνας στην καθορισμένη ροή στην καθορισμένη μορφή αρχείου σύμφωνα με τις επιλογές αποθήκευσης. |
...
| virtual [SetResolution](../../aspose.psd/rasterimage/setresolution/)(double, double) | Ορίζει την ανάλυση για αυτό`RasterImage` . |
