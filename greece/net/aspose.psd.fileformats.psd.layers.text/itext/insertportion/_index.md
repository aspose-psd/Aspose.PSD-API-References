...
description: IText μέθοδος. Εισάγει τοITextPortion στην καθορισμένη θέση
type: docs
weight: 50
url: /el/net/aspose.psd.fileformats.psd.layers.text/itext/insertportion/
---
## IText.InsertPortion method

Εισάγει το[`ITextPortion`](../../itextportion/) στην καθορισμένη θέση
