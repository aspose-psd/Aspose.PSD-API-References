...
description: "IText μέθοδος. Δημιουργεί το νέο τμήμα με προεπιλεγμένες παραμέτρους"
type: docs
weight: 60
url: /el/net/aspose.psd.fileformats.psd.layers.text/itext/produceportion/
---
{{< psd/tize >}}
## IText.ProducePortion method

Παράγει το νέο τμήμα με προεπιλεγμένες παραμέτρους
...
Αναφορά στο πρόσφατα δημιουργημένο [`ITextPortion`](../../itextportion/).
