...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει την εσοχή έναρξης.
type: docs
weight: 190
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/startindent/
---
## ITextParagraph.StartIndent property

Λαμβάνει ή ορίζει την εσοχή έναρξης.
