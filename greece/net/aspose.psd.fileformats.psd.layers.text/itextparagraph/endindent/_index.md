...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει την εσοχή τέλους.
type: docs
weight: 50
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/endindent/
---
## ITextParagraph.EndIndent property

Λαμβάνει ή ορίζει την εσοχή τέλους.
