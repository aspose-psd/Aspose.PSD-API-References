...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει την απόσταση των λέξεων.
type: docs
weight: 200
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/wordspacing/
---
## ITextParagraph.WordSpacing property

Λαμβάνει ή ορίζει την απόσταση των λέξεων.
