...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει το μέγεθος της λέξης με παύλα.
type: docs
weight: 100
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hyphenatedwordsize/
---
## ITextParagraph.HyphenatedWordSize property

Λαμβάνει ή ορίζει το μέγεθος της λέξης με παύλα.
