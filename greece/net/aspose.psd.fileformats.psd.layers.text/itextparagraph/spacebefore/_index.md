...
description: ITextParagraph ιδιοκτησία. Παίρνει ή ρυθμίζει το διάστημα πριν.
type: docs
weight: 180
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/spacebefore/
---
## ITextParagraph.SpaceBefore property

Παίρνει ή ρυθμίζει το διάστημα πριν.
