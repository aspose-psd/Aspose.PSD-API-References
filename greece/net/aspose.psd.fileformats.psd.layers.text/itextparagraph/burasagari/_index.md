...
description: "ITextParagraph ιδιότητα. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το ITextParagraph είναι burasagiri"
type: docs
weight: 30
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [`ITextParagraph`](../) είναι burasagiri.
...
`true` εάν είναι burasagiri· διαφορετικά, `false`.
