...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτόITextParagraphείναι μπουρασαγίρι.
type: docs
weight: 30
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό[`ITextParagraph`](../)είναι μπουρασαγίρι.
...
`αληθής` αν μπουρασαγιρι? σε διαφορετική περίπτωση,`ψευδής` .
