...
description: ITextParagraph μέθοδος. Εφαρμόζει την καθορισμένη παράγραφο.
type: docs
weight: 220
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/apply/
---
## ITextParagraph.Apply method

Εφαρμόζει την καθορισμένη παράγραφο.
