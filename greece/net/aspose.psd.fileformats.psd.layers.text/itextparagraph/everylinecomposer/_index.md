...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν κάθε συνθέτης γραμμής.
type: docs
weight: 60
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [κάθε συνθέτης γραμμής].
...
`αληθής` αν [κάθε συνθέτης γραμμής]? σε διαφορετική περίπτωση,`ψευδής` .
