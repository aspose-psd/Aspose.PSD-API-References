...
description: "ITextParagraph ιδιότητα. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν κάθε συνθέτης γραμμής"
type: docs
weight: 60
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [every line composer].
...
`true` εάν [every line composer]; διαφορετικά, `false`.
