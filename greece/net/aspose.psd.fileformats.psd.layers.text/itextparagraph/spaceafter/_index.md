...
description: ITextParagraph ιδιοκτησία. Παίρνει ή ρυθμίζει το διάστημα μετά.
type: docs
weight: 170
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/spaceafter/
---
## ITextParagraph.SpaceAfter property

Παίρνει ή ρυθμίζει το διάστημα μετά.
