...
description: ITextParagraph ιδιοκτησία. Παίρνει ή ορίζει τις διαδοχικές παύλες.
type: docs
weight: 40
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/consecutivehyphens/
---
## ITextParagraph.ConsecutiveHyphens property

Παίρνει ή ορίζει τις διαδοχικές παύλες.
