...
description: ITextParagraph ιδιοκτησία. Παίρνει ή ορίζει την προενωτική.
type: docs
weight: 160
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/prehyphen/
---
## ITextParagraph.PreHyphen property

Παίρνει ή ορίζει την προενωτική.
