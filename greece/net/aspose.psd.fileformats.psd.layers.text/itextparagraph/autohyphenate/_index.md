...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτόματος παύλα.
type: docs
weight: 10
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [αυτόματος παύλα].
...
`αληθής` εάν [αυτόματο παύλα]; σε διαφορετική περίπτωση,`ψευδής` .
