...
description: "Ιδιότητα ITextParagraph. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν ο αυτόματος συλλαβισμός είναι ενεργός"
type: docs
weight: 10
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
{{< psd/tize >}}
## ITextParagraph.AutoHyphenate property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [automatic hyphenate].
...
`true` if [αυτόματος συλλαβισμός]; otherwise, `false`.
