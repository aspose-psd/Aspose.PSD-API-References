...
description: "Ιδιότητα ITextParagraph. Λαμβάνει ή ορίζει το διάστημα χαρακτήρων"
type: docs
weight: 80
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/glyphspacing/
---
{{< psd/tize >}}
## ITextParagraph.GlyphSpacing property

Λαμβάνει ή ορίζει το διάστημα των γλύφων.
