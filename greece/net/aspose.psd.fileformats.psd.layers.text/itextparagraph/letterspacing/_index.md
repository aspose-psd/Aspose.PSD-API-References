...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει την απόσταση των γραμμάτων.
type: docs
weight: 140
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/letterspacing/
---
## ITextParagraph.LetterSpacing property

Λαμβάνει ή ορίζει την απόσταση των γραμμάτων.
