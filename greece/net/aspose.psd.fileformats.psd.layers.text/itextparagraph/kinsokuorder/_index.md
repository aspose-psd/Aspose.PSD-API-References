...
description: ITextParagraph ιδιοκτησία. Λαμβάνει ή ορίζει τη σειρά kinsoku.
type: docs
weight: 120
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/kinsokuorder/
---
## ITextParagraph.KinsokuOrder property

Λαμβάνει ή ορίζει τη σειρά kinsoku.
