...
description: ITextParagraph ιδιοκτησία. Παίρνει ή ορίζει την παύλα ανάρτησης.
type: docs
weight: 150
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/posthyphen/
---
## ITextParagraph.PostHyphen property

Παίρνει ή ορίζει την παύλα ανάρτησης.
