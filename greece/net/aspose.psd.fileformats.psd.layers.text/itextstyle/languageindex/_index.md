...
description: ITextStyle ιδιοκτησία. Λαμβάνει το ευρετήριο γλώσσας.
type: docs
weight: 190
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/languageindex/
---
## ITextStyle.LanguageIndex property

Λαμβάνει το ευρετήριο γλώσσας.
