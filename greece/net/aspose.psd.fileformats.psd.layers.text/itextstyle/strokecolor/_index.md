...
description: ITextStyle ιδιοκτησία. Λαμβάνει ή ρυθμίζει το χρώμα της διαδρομής.
type: docs
weight: 240
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/strokecolor/
---
## ITextStyle.StrokeColor property

Λαμβάνει ή ρυθμίζει το χρώμα της διαδρομής.
