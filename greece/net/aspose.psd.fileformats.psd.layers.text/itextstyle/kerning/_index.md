...
description: ITextStyle ιδιοκτησία. Λαμβάνει ή ορίζει τον πυρήνα.
type: docs
weight: 180
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/kerning/
---
## ITextStyle.Kerning property

Λαμβάνει ή ορίζει τον πυρήνα.
...
Η διασταύρωση μεταξύ δύο χαρακτήρων.
