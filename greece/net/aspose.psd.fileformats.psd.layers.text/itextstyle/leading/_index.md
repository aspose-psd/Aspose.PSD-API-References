...
description: ITextStyle ιδιοκτησία. Παίρνει ή θέτει το προβάδισμα.
type: docs
weight: 200
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/leading/
---
## ITextStyle.Leading property

Παίρνει ή θέτει το προβάδισμα.
