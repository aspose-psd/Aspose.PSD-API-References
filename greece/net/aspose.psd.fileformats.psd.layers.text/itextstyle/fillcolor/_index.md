...
description: ITextStyle ιδιοκτησία. Παίρνει ή ορίζει το χρώμα του γεμίσματος.
type: docs
weight: 80
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/fillcolor/
---
## ITextStyle.FillColor property

Παίρνει ή ορίζει το χρώμα του γεμίσματος.
