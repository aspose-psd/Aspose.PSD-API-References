...
description: ITextStyle ιδιοκτησία. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτόματη προαγωγή.
type: docs
weight: 20
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [αυτόματη προαγωγή].
...
`αληθής` εάν [αυτόματο οδηγό]? σε διαφορετική περίπτωση,`ψευδής` .
