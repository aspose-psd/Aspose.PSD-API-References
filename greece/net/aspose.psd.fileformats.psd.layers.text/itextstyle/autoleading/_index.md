...
description: "Ιδιότητα ITextStyle. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν η αυτόματη απόσταση γραμμής"
type: docs
weight: 20
...
Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [automatic leading].
...
`true` εάν [automatic leading]; διαφορετικά, `false`.
