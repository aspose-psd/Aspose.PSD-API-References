...
description: "Ιδιότητα ITextStyle. Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν οι hindi αριθμοί"
type: docs
weight: 150
url: /el/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
{{< psd/tize >}}
## ITextStyle.HindiNumbers property

Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [hindi numbers].
...
`true` εάν [hindi numbers]; διαφορετικά, `false`.
