---
title: "Κλάση FillLayer"
second_title: "Aspose.PSD για .NET API Αναφορά"
description: "Κλάση Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer. Στρώση γεμίσματος. Color Fill, Gradient Fill ή Pattern Fill Layer που διαφέρει ανάλογα με το FillSettings."
type: docs
weight: 2020
...
Στρώση γεμίσματος. Color Fill, Gradient Fill ή Pattern Fill Layer που διαφέρει ανάλογα με το [`FillSettings`](./fillsettings/).
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | Λαμβάνει ή ορίζει τις ρυθμίσεις γεμίσματος. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Λαμβάνει τον τύπο του γεμίσματος. |
...
| Όνομα | Περιγραφή |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Δημιουργεί ένα νέο στιγμιότυπο της κλάσης `FillLayer` ανά τύπο γεμίσματος. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Ενημερώνει τα δεδομένα εικονοστοιχείων της στρώσης γεμίσματος βάσει των τρεχουσών [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
