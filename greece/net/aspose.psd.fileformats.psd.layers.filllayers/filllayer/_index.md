...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer τάξη. Στρώμα πλήρωσης. Color Fill Gradient Fill ή Pattern Fill Layer που διαφέρει κατάFillSettings
type: docs
weight: 1910
url: /el/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

Στρώμα πλήρωσης. Color Fill, Gradient Fill ή Pattern Fill Layer που διαφέρει κατά[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Λαμβάνει τις ρυθμίσεις πλήρωσης. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Παίρνει τον τύπο του γεμίσματος. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Δημιουργήστε μια νέα παρουσία του`FillLayer` κατηγορία ανά τύπο γεμίσματος. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Ενημερώνει τα δεδομένα εικονοστοιχείων γεμίσματος επιπέδου σύμφωνα με τα πραγματικά[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* χώρος ονομάτων [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
