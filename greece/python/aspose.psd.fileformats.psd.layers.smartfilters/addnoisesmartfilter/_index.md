...
type: docs
weight: 10
url: /el/python-net/aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [AddNoiseSmartFilter()](#AddNoiseSmartFilter__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [AddNoiseSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/). |
## **Properties**
| **Name** | **Type** | **Access** | **Περιγραφή** |
| :- | :- | :- | :- |
| FILTER_TYPE [static] | int | r | Το αναγνωριστικό του τρέχοντος έξυπνου φίλτρου. |
| amount_noise | double | r/w | Λαμβάνει ή ορίζει την ποσότητα του θορύβου. |
...
| distribution | [NoiseDistribution](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/noisedistribution) | r/w | Λαμβάνει ή ορίζει την κατανομή του φίλτρου θορύβου. |
...
| is_monochromatic | bool | r/w | Αποκτά ή ορίζει την τιμή του μονοχρωματικού. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [AddNoiseSmartFilter](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/addnoisesmartfilter/).
