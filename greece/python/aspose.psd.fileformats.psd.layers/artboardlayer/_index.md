---
title: "ArtboardLayer Κλάση"
type: docs
weight: 90
url: /el/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Λαμβάνει ή ορίζει το χρώμα φόντου του artboard. |
...
| έχει_άλφα | bool | r |  |
| has_background_color | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) έχει το χρώμα φόντου. |
| έχει_διαφανές_χρώμα | bool | r/w |  |
| height | int | r | <inheritdoc /> |
...
| is_open | bool | r/w | Λαμβάνει ή ορίζει αν ο φάκελος είναι ανοιχτός<br/>            αν οριστεί σε <c>true</c> τότε η ομάδα θα είναι σε ανοιχτή κατάσταση κατά την εκκίνηση, διαφορετικά σε ελαχιστοποιημένη κατάσταση. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Λαμβάνει τα στρώματα στην ομάδα στρωμάτων |
| αριστερά | int | r/w | <inheritdoc /> |
| μήκος | int | r |  |
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Προσθέτει το στρώμα στην ομάδα στρωμάτων. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Προσθέτει την ομάδα στρωμάτων. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Φορτώνει μερικά pixel 32-bit ARGB (ανά μπλοκ). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Φορτώνει ακατέργαστα δεδομένα. |
