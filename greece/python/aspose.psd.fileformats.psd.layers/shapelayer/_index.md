---
title: "Κλάση ShapeLayer"
type: docs
weight: 1600
url: /el/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---

**Summary:** Shape layer. Encapsulates the logic of work with Shape layer and related resources.

**Module:** [aspose.psd.fileformats.psd.layers](/psd/python-net/aspose.psd.fileformats.psd.layers/)

**Full Name:** aspose.psd.fileformats.psd.layers.ShapeLayer
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Όλοι οι πόροι δημιουργούνται στην προεπιλεγμένη τους κατάσταση. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Λαμβάνει ή ορίζει τις ρυθμίσεις γεμίσματος για την εσωτερική περιοχή των Σχημάτων στο στρώμα Shape. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Λαμβάνει το σύνολο των Διαδρομών που υπάρχουν σε ένα στρώμα Shape. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Λαμβάνει ή ορίζει τις ρυθμίσεις περιγράμματος των Σχημάτων. |
| επάνω | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Δημιουργεί ένα νέο αντικείμενο της κλάσης [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Ενημερώνει τους πόρους από τις ιδιότητες του στρώματος Shape. |
| write_argb_32_scan_line(scan_line_index, argb_32_pixels) |  |
| write_scan_line(scan_line_index, pixels) |  |


### Constructor: ShapeLayer() {#ShapeLayer__1}
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Όλοι οι πόροι δημιουργούνται στην προεπιλεγμένη τους κατάσταση.
...
### Method: create_instance()  [static] {#create_instance__7}
...
Δημιουργεί ένα νέο αντικείμενο της κλάσης [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Επιστρέφει τη νέα παρουσία της κλάσης [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
