---
title: "TextLayer Κλάση"
type: docs
weight: 1750
url: /el/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Ανακτά τη γραμματοσειρά. |
| έχει_άλφα | bool | r |  |
...
| inner_text | string | r | Ανακτά το κείμενο του στρώματος |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Ανακτά ή ορίζει το πλαίσιο οριοθέτησης του κειμένου. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Ανακτά το χρώμα του κειμένου. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Λαμβάνει τα τμήματα κειμένου. |
| επάνω | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Λαμβάνει το σύνολο γραμματοσειρών του στρώματος κειμένου. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_30) | Φορτώνει μερικά pixel 32-bit ARGB (ανά μπλοκ). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_31) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_32) | Φορτώνει ακατέργαστα δεδομένα. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Αλλάζει το μέγεθος της εικόνας. Η προεπιλεγμένη τιμή [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) χρησιμοποιείται. |
...
| [update_text(text)](#update_text_text_38) | Ενημερώνει το κείμενο. |
| [update_text(text, color)](#update_text_text_color_39) | Ενημερώνει το κείμενο. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Ενημερώνει το κείμενο. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Ενημερώνει το κείμενο. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Ενημερώνει το κείμενο. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Ενημερώνει το κείμενο. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Ενημερώνει το κείμενο. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Ενημερώνει το κείμενο. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | Το σύνολο γραμματοσειρών του στρώματος κειμένου. |
...
Αλλάζει το μέγεθος της εικόνας. Η προεπιλεγμένη τιμή [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) χρησιμοποιείται.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Ο τύπος της μετασχηματισμού αλλαγής μεγέθους [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | Η τιμή κειμένου. |
| color | [Color](/psd/python-net/aspose.psd/color) | Η τιμή χρώματος. |
...
| :- | :- | :- |
| text | string | Η τιμή κειμένου. |
| font_size | float | Μέγεθος γραμματοσειράς. |
...
| :- | :- | :- |
| text | string | Η τιμή κειμένου. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | Η αριστερή άνω συντεταγμένη. |
