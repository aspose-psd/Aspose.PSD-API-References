---
title: "SectionDividerLayer Κλάση"
type: docs
weight: 1580
url: /el/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
...
| [get_related_layer_group()](#get_related_layer_group__20) | Αποκτά το [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/) που σχετίζεται με αυτήν την παρουσίαση του [SectionDividerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/). |
...
Αποκτά το [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/) που σχετίζεται με αυτήν την παρουσίαση του [SectionDividerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/).

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup) | Το [LayerGroup](/psd/python-net/aspose.psd.fileformats.psd.layers/layergroup/) παράδειγμα. |
