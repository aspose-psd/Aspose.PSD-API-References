---
title: "Κλάση WatermarkResource"
type: docs
weight: 310
url: /el/python-net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [WatermarkResource()](#WatermarkResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης WatermarkResource |
## **Properties**
...
| is_watermark | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει αν αυτό το αντικείμενο είναι υδατογράφημα. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης WatermarkResource
