---
title: "IccUntaggedResource Κλάση"
type: docs
weight: 140
url: /el/python-net/aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [IccUntaggedResource()](#IccUntaggedResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης IccUntaggedResource |
## **Properties**
...
| profile | byte | r/w | Λαμβάνει ή ορίζει το profile. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης IccUntaggedResource
