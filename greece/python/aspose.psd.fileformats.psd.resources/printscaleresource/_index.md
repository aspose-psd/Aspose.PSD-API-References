---
title: "PrintScaleResource Κλάση"
type: docs
weight: 210
url: /el/python-net/aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [PrintScaleResource()](#PrintScaleResource__1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης PrintScaleResource |
## **Properties**
...
| scale | float | r/w | Λαμβάνει ή ορίζει την κλίμακα. |
...
| style | short | r/w | Λαμβάνει ή ορίζει το στυλ. |
| x_location | float | r/w | Λαμβάνει ή ορίζει τη θέση x. |
| y_location | float | r/w | Λαμβάνει ή ορίζει τη θέση y. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης PrintScaleResource
