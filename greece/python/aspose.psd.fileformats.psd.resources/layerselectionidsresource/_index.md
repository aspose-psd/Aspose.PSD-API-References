---
title: "LayerSelectionIdsResource Κλάση"
type: docs
weight: 170
url: /el/python-net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [LayerSelectionIdsResource()](#LayerSelectionIdsResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LayerSelectionIdsResource |
## **Properties**
...
| count | short | r/w | Λαμβάνει ή ορίζει το count. |
...
| layer_ids | int | r/w | Λαμβάνει ή ορίζει τα layer_ids. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LayerSelectionIdsResource
