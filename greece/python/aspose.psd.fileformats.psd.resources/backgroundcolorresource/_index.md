...
type: docs
weight: 20
url: /el/python-net/aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [BackgroundColorResource()](#BackgroundColorResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης BackgroundColorResource |
## **Properties**
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Λαμβάνει ή ορίζει το χρώμα φόντου. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης BackgroundColorResource
