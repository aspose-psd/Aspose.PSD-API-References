---
title: "QuickMaskInformationResource Κλάση"
type: docs
weight: 220
url: /el/python-net/aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης QuickMaskInformationResource |
## **Properties**
...
| channel_id | short | r/w | Λαμβάνει ή ορίζει το αναγνωριστικό του καναλιού. |
...
| is_mask_empty | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία έχει κενή μάσκα. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης QuickMaskInformationResource
