---
title: "Κλάση PixelAspectRatioResource"
type: docs
weight: 190
url: /el/python-net/aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης PixelAspectRatioResource |
## **Properties**
...
| aspect_ratio | double | r/w | Λαμβάνει ή ορίζει την αναλογία διαστάσεων. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης PixelAspectRatioResource
