---
title: "GlobalAltitudeResource Κλάση"
type: docs
weight: 90
url: /el/python-net/aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης GlobalAltitudeResource |
## **Properties**
...
| altitude | int | r/w | Λαμβάνει ή ορίζει το altitude. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης GlobalAltitudeResource
