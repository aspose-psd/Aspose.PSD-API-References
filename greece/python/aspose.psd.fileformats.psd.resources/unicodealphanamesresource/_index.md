...
type: docs
weight: 270
url: /el/python-net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης UnicodeAlphaNamesResource |
## **Properties**
...
| alpha_names | string | r/w | Λαμβάνει ή ορίζει τα ονόματα άλφα. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης UnicodeAlphaNamesResource
