---
title: "ColorHalftoneInformationResource Κλάση"
type: docs
weight: 50
url: /el/python-net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης ColorHalftoneInformationResource |
## **Properties**
...
| halftone_data | byte | r/w | Λαμβάνει ή ορίζει τα δεδομένα ημιτόνου. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης ColorHalftoneInformationResource
