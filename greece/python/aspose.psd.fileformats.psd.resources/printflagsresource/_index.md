---
title: "PrintFlagsResource Κλάση"
type: docs
weight: 200
url: /el/python-net/aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [PrintFlagsResource()](#PrintFlagsResource__1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης PrintFlagsResource |
## **Properties**
...
| bleed_scale | short | r/w | Λαμβάνει ή ορίζει την κλίμακα υπερέκτασης. |
| bleed_width | int | r/w | Λαμβάνει ή ορίζει το πλάτος της υπερέκτασης. |
| center_crop_mark | byte | r/w | Λαμβάνει ή ορίζει το κεντρικό σημάδι περικοπής. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης PrintFlagsResource
