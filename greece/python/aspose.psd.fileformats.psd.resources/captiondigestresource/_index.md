---
title: "CaptionDigestResource Κλάση"
type: docs
weight: 40
url: /el/python-net/aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [CaptionDigestResource()](#CaptionDigestResource__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης CaptionDigestResource |
## **Properties**
...
| digest | byte | r/w | Λαμβάνει ή ορίζει το digest. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης CaptionDigestResource
