---
title: "LayerGroupInformationResource Κλάση"
type: docs
weight: 150
url: /el/python-net/aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης LayerGroupInformationResource |
## **Properties**
...
| groups | short | r/w | Λαμβάνει ή ορίζει τις ομάδες. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης LayerGroupInformationResource
