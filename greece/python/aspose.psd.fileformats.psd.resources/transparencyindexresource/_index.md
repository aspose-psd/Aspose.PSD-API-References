---
title: "TransparencyIndexResource Κλάση"
type: docs
weight: 260
url: /el/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης TransparencyIndexResource |
## **Properties**
...
| transparency_index | short | r/w | Λαμβάνει ή ορίζει το δείκτη χρώματος διαφάνειας. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης TransparencyIndexResource
