---
title: "LayerStateInformationResource Κλάση"
type: docs
weight: 180
url: /el/python-net/aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [LayerStateInformationResource()](#LayerStateInformationResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LayerStateInformationResource |
## **Properties**
...
| layer_index | short | r/w | Αποκτά ή ορίζει τον δείκτη του επιπέδου. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης LayerStateInformationResource
