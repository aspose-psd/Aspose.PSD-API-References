---
title: "FillLayer Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Λαμβάνει ή ορίζει τις ρυθμίσεις γεμίσματος. |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | Λαμβάνει τον τύπο του γεμίσματος. |
| γέμιση | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | Δημιουργεί μια νέα παρουσία της [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) κλάσης με βάση τον τύπο γεμίσματος. |
...
| update() | Ενημερώνει τα δεδομένα εικονοστοιχείων της στρώσης γεμίσματος βάσει των τρεχουσών [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
...
Δημιουργεί μια νέα παρουσία της [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) κλάσης με βάση τον τύπο γεμίσματος.

**Parameters:**

| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | Ο τύπος της στρώσης γεμίσματος. |

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | Επιστρέφει μια νέα παρουσία της [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) κλάσης με βάση τον τύπο γεμίσματος. |
