...
type: docs
weight: 10
url: /el/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [SmartObjectLayer(stream)](#SmartObjectLayer_stream_1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/). |
## **Properties**
...
| content_type | [SmartObjectType](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype) | r | Λαμβάνει τον τύπο του περιεχομένου του επιπέδου smart object.<br/>            Το ενσωματωμένο περιεχόμενο smart object είναι το ενσωματωμένο ακατέργαστο αρχείο εικόνας: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/).<br/>            Το συνδεδεμένο περιεχόμενο smart object είναι το ακατέργαστο περιεχόμενο του συνδεδεμένου αρχείου εικόνας εάν είναι διαθέσιμο: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/).<br/>            Δεν υποστηρίζουμε τη φόρτωση από τη βιβλιοθήκη γραφικών Adobe Photoshop όταν [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) είναι αληθές.<br/>            Για κανονικά αρχεία συνδέσμου, αρχικά χρησιμοποιούμε [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) για να αναζητήσουμε το αρχείο σχετικά με τη διαδρομή της πηγαίας εικόνας [None](/psd/python-net/aspose.psd/datastreamsupporter/),<br/>            εάν δεν είναι διαθέσιμο, κοιτάζουμε στο [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/),<br/>            αν όχι, τότε αναζητούμε το αρχείο συνδέσμου στον ίδιο φάκελο όπου βρίσκεται η εικόνα μας: [None](/psd/python-net/aspose.psd/datastreamsupporter/). |
| contents | byte | r/w | Λαμβάνει ή ορίζει το περιεχόμενο του επιπέδου smart object.<br/>            Το ενσωματωμένο περιεχόμενο smart object είναι το ενσωματωμένο ακατέργαστο αρχείο εικόνας: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/) και οι ιδιότητές του.<br/>            Το συνδεδεμένο περιεχόμενο smart object είναι το ακατέργαστο περιεχόμενο του συνδεδεμένου αρχείου εικόνας εάν είναι διαθέσιμο και οι ιδιότητές του: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/).<br/>            Δεν υποστηρίζουμε τη φόρτωση από τη βιβλιοθήκη γραφικών Adobe Photoshop όταν [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) είναι αληθές.<br/>            Για κανονικά αρχεία συνδέσμου, αρχικά χρησιμοποιούμε [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) για να αναζητήσουμε το αρχείο σχετικά με τη διαδρομή της πηγαίας εικόνας [None](/psd/python-net/aspose.psd/datastreamsupporter/),<br/>            εάν δεν είναι διαθέσιμο, κοιτάζουμε στο [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/),<br/>            αν όχι, τότε αναζητούμε το αρχείο συνδέσμου στον ίδιο φάκελο όπου βρίσκεται η εικόνα μας: [None](/psd/python-net/aspose.psd/datastreamsupporter/). |
| contents_bounds | [Rectangle](/psd/python-net/aspose.psd/rectangle) | r/w | Λαμβάνει ή ορίζει τα όρια του περιεχομένου του smart object. |
| contents_source | [LinkDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) | r/w | Λαμβάνει ή ορίζει την πηγή του περιεχομένου του smart object. |
...
| smart_filters | [SmartFilters](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/smartfilters/) | r | Λαμβάνει τα έξυπνα φίλτρα. |
...
| warp_settings | [WarpSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.warp/warpsettings/) | r/w | Λαμβάνει ή ορίζει τις παραμέτρους Warp που είχαν οριστεί ή ληφθεί από τον πόρο (προεπιλογή) |
...
| [convert_to_linked(linked_path)](#convert_to_linked_linked_path_6) | Μετατρέπει αυτό το ενσωματωμένο έξυπνο αντικείμενο σε συνδεδεμένο έξυπνο αντικείμενο. |
...
| [duplicate_layer()](#duplicate_layer__8) | Δημιουργεί μια νέα στρώση έξυπνου αντικειμένου αντιγράφοντας αυτήν.<br/>            Σημειώστε ότι για ενσωματωμένα έξυπνα αντικείμενα η ενσωματωμένη εικόνα είναι κοινόχρηστη.<br/>            Εάν θέλετε να αντιγράψετε την ενσωματωμένη εικόνα, χρησιμοποιήστε τη μέθοδο [SmartObjectLayer.new_smart_object_via_copy()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/) method. |
| embed_linked() | Ενσωματώνει το συνδεδεμένο έξυπνο αντικείμενο σε αυτό το επίπεδο. |
| [export_contents(file_path)](#export_contents_file_path_9) | Εξάγει τα ενσωματωμένα ή συνδεδεμένα περιεχόμενα σε ένα αρχείο. |
...
| [load_contents(options)](#load_contents_options_32) | Ανακτά τα ενσωματωμένα ή συνδεδεμένα περιεχόμενα εικόνας του επιπέδου έξυπνου αντικειμένου. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_33) | Φορτώνει μερικά pixel 32-bit ARGB (ανά μπλοκ). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_34) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_35) | Φορτώνει ακατέργαστα δεδομένα. |
| merge_layer_to(layer_to_merge_into) |  |
| [new_smart_object_via_copy()](#new_smart_object_via_copy__36) | Δημιουργεί ένα νέο επίπεδο έξυπνου αντικειμένου αντιγράφοντας αυτό το επίπεδο.<br/>            Αναπαράγει τη λειτουργία `Layer -> Smart Objects -> New Smart Object via Copy` του Adobe� Photoshop�.<br/>            Σημειώστε ότι είναι ενεργοποιημένη μόνο για ενσωματωμένα έξυπνα αντικείμενα επειδή η ενσωματωμένη εικόνα επίσης αντιγράφεται.<br/>            Εάν θέλετε να μοιραστείτε την ενσωματωμένη εικόνα, χρησιμοποιήστε τη μέθοδο [SmartObjectLayer.duplicate_layer()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/). |
| normalize_angle() |  |
...
| [relink_to_file(linked_path)](#relink_to_file_linked_path_39) | Επανασυνδέει το συνδεδεμένο έξυπνο αντικείμενο σε ένα νέο αρχείο.<br/>            Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά. |
| replace_color(old_color, old_color_diff, new_color) |  |
| replace_color(old_color_argb, old_color_diff, new_color_argb) |  |
| [replace_contents(image)](#replace_contents_image_40) | Αντικαθιστά τα περιεχόμενα του έξυπνου αντικειμένου που είναι ενσωματωμένα στο επίπεδο έξυπνου αντικειμένου. |
| [replace_contents(image, resolution)](#replace_contents_image_resolution_41) | Αντικαθιστά τα περιεχόμενα του έξυπνου αντικειμένου που είναι ενσωματωμένα στο επίπεδο έξυπνου αντικειμένου. |
| [replace_contents(linked_path)](#replace_contents_linked_path_42) | Αντικαθιστά τα περιεχόμενα με ένα αρχείο.<br/>            Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά. |
| [replace_contents(linked_path, resolution)](#replace_contents_linked_path_resolution_43) | Αντικαθιστά τα περιεχόμενα με ένα αρχείο.<br/>            Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά. |
...
| update_modified_content() | Ενημερώνει την κρυφή μνήμη εικόνας του smart object layer με το τροποποιημένο περιεχόμενο. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/).

**Parameters:**

| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| ροή | _io.BufferedRandom | Η ροή των στοιχείων |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| linked_path | string | Η συνδεδεμένη διαδρομή. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| file_path | string | Η διαδρομή εξαγωγής αρχείου. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| options | [LoadOptions](/psd/python-net/aspose.psd/loadoptions) | Οι επιλογές. |

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [Image](/psd/python-net/aspose.psd/image) | Η φορτωμένη [Image](/psd/python-net/aspose.psd/image/) smart object αντίγραφο. |
...
Επανασυνδέει το συνδεδεμένο έξυπνο αντικείμενο σε ένα νέο αρχείο.<br/>            Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά.
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | Η εικόνα. |
...
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | Η εικόνα. |
| resolution | [ResolutionSetting](/psd/python-net/aspose.psd/resolutionsetting) | Οι ρυθμίσεις ανάλυσης. Εάν είναι null, θα χρησιμοποιηθεί η ανάλυση της εικόνας. |
...
Αντικαθιστά τα περιεχόμενα με ένα αρχείο.<br/>            Δεν χρειάζεται να κληθεί η μέθοδος UpdateModifiedContent μετά.
