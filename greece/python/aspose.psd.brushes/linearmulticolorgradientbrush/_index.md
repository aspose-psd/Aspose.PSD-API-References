...
type: docs
weight: 40
url: /el/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [LinearMulticolorGradientBrush()](#LinearMulticolorGradientBrush__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) με προεπιλεγμένες παραμέτρους.<br/>            Το αρχικό χρώμα είναι μαύρο, το τελικό χρώμα είναι λευκό, η γωνία είναι 45 μοίρες και το ορθογώνιο βρίσκεται στο (0,0) με μέγεθος (1,1). |
| [LinearMulticolorGradientBrush(point1, point2)](#LinearMulticolorGradientBrush_point1_point2_2) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) με τα καθορισμένα σημεία. |
| [LinearMulticolorGradientBrush(point1, point2)](#LinearMulticolorGradientBrush_point1_point2_3) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) με τα καθορισμένα σημεία. |
| [LinearMulticolorGradientBrush(rect, angle)](#LinearMulticolorGradientBrush_rect_angle_4) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) βασισμένη σε ένα ορθογώνιο και μια γωνία προσανατολισμού. |
| [LinearMulticolorGradientBrush(rect, angle)](#LinearMulticolorGradientBrush_rect_angle_5) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) βασισμένη σε ένα ορθογώνιο και μια γωνία προσανατολισμού. |
| [LinearMulticolorGradientBrush(rect, angle, is_angle_scalable)](#LinearMulticolorGradientBrush_rect_angle_is_angle_scalable_6) | Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) βασισμένη σε ένα ορθογώνιο και μια γωνία προσανατολισμού. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) με προεπιλεγμένες παραμέτρους.<br/>            Το αρχικό χρώμα είναι μαύρο, το τελικό χρώμα είναι λευκό, η γωνία είναι 45 μοίρες και το ορθογώνιο βρίσκεται στο (0,0) με μέγεθος (1,1).
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) με τα καθορισμένα σημεία.
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/) βασισμένη σε ένα ορθογώνιο και μια γωνία προσανατολισμού.
...
| rect | [Rectangle](/psd/python-net/aspose.psd/rectangle) | Μια δομή [RectangleF](/psd/python-net/aspose.psd/rectanglef/) που καθορίζει τα όρια του γραμμικού διαβάθμισης. |
| γωνία | float | Η γωνία, μετρημένη σε μοίρες δεξιόστροφα από τον άξονα x, της γραμμής προσανατολισμού του διαβάθμισης. |
| is_angle_scalable | bool | αν οριστεί σε <c>true</c> η γωνία αλλάζει κατά τις μετασχηματίσεις με αυτό το [LinearMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/linearmulticolorgradientbrush/). |
