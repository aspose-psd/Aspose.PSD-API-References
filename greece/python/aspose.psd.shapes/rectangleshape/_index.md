...
type: docs
weight: 80
url: /el/python-net/aspose.psd.shapes/rectangleshape/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [RectangleShape()](#RectangleShape__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/). |
| [RectangleShape(rectangle)](#RectangleShape_rectangle_2) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/). |
## **Properties**
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [RectangleShape](/psd/python-net/aspose.psd.shapes/rectangleshape/).
