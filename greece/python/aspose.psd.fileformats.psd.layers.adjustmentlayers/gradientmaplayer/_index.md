---
title: "GradientMapLayer Κλάση"
type: docs
weight: 110
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
| gradient_settings | [BaseGradientFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/basegradientfillsettings/) | r/w | Παράδειγμα αντικειμένου ρυθμίσεων gradient που μεταβιβάστηκε από το αντικείμενο GrdmResource. |
| έχει_άλφα | bool | r |  |
