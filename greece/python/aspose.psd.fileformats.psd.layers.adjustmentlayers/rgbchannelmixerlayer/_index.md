---
title: "Κλάση RgbChannelMixerLayer"
type: docs
weight: 180
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---

**Summary:** Rgb Channel Mixer Adjustment layer.
...
**Full Name:** aspose.psd.fileformats.psd.layers.adjustmentlayers.RgbChannelMixerLayer
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Λαμβάνει το μπλε κανάλι. |
| bottom | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Λαμβάνει το πράσινο κανάλι. |
| έχει_άλφα | bool | r |  |
...
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Λαμβάνει το κόκκινο κανάλι. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Λαμβάνει τον δείκτη του καναλιού κατά. Επιστρέφει RgbMixerChannel |
...
Λαμβάνει τον δείκτη του καναλιού κατά. Επιστρέφει RgbMixerChannel
...
| Τύπος | Περιγραφή |
| :- | :- |
| [MixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/mixerchannel) | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel/) |
