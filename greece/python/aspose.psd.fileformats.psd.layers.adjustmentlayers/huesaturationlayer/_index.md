---
title: "HueSaturationLayer Κλάση"
type: docs
weight: 120
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | byte | r/w |  |
| colorize | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτό το [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) είναι χρωματισμένο. |
...
| [get_range(index)](#get_range_index_20) | Λαμβάνει το εύρος. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | Εύρος Χρώματος Hsl |
