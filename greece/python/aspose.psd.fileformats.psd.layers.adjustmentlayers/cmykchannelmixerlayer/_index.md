---
title: "CmykChannelMixerLayer Κλάση"
type: docs
weight: 50
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Λαμβάνει το μαύρο κανάλι. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Λαμβάνει το κυανό κανάλι. |
...
| αριστερά | int | r/w |  |
| μήκος | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Λαμβάνει το ματζέντα κανάλι. |
| monochrome | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει αν αυτή η [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) είναι μονόχρωμη. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Λαμβάνει το κίτρινο κανάλι. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Λαμβάνει τον δείκτη του καναλιού με. Επιστρέφει CmykMixerChannel |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Συγχωνεύει το στρώμα με το καθορισμένο στρώμα |
| normalize_angle() |  |
...
Λαμβάνει τον δείκτη του καναλιού με. Επιστρέφει CmykMixerChannel
