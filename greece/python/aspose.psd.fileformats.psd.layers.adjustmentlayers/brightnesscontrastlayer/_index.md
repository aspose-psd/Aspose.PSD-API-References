---
title: "BrightnessContrastLayer Κλάση"
type: docs
weight: 30
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| φωτεινότητα | int | r/w | Λαμβάνει ή ορίζει τη φωτεινότητα. Για το PS το εύρος της φωτεινότητας είναι από -150 έως +150. Αλλά το αγνοούμε. |
...
| αντίθεση | int | r/w | Λαμβάνει ή ορίζει την αντίθεση. Για το PS το εύρος της αντίθεσης είναι από -50 έως +100. Αλλά το αγνοούμε. |
