---
title: "SelectiveColorLayer Κλάση"
type: docs
weight: 200
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | Λαμβάνει ή ορίζει τη μέθοδο διόρθωσης. |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | Λαμβάνει τη διόρθωση cmyk με επιλεκτικό χρώμα. |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | Ορίζει τη διόρθωση cmyk με επιλεκτικό χρώμα. |
...
Λαμβάνει τη διόρθωση cmyk με επιλεκτικό χρώμα.

**Parameters:**

| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Επιλεκτικά χρώματα. |

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Διόρθωση Cmyk. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Τύπος των επιλεκτικών χρωμάτων. |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | Διόρθωση Cmyk. |
