---
title: "LevelsLayer Κλάση"
type: docs
weight: 140
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| αριστερά | int | r/w |  |
| μήκος | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | Λαμβάνει το κύριο κανάλι. |
...
| [get_channel(index)](#get_channel_index_8) | Λαμβάνει το κανάλι. |
...
| Τύπος | Περιγραφή |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) με δείκτη |
