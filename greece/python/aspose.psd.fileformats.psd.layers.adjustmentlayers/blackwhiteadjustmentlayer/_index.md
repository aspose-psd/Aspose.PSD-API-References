---
title: "BlackWhiteAdjustmentLayer Κλάση"
type: docs
weight: 20
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Λαμβάνει ή ορίζει την τιμή του Tint Color. |
| tint_color_blue | double | r/w | Λαμβάνει ή ορίζει την τιμή double του Blue Tint Color. |
| tint_color_green | double | r/w | Λαμβάνει ή ορίζει την τιμή double του Green Tint Color. |
| tint_color_red | double | r/w | Λαμβάνει ή ορίζει την τιμή double του Red Tint Color. |
| επάνω | int | r/w |  |
