---
title: "ExposureLayer Κλάση"
type: docs
weight: 100
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| απορρίφθηκε | bool | r |  |
| έκθεση | float | r/w | Λαμβάνει ή ορίζει την Έκθεση. Για το PS το εύρος της Έκθεσης είναι από -20 έως +20. |
...
| gamma_correction | float | r/w | Λαμβάνει ή ορίζει τη GammaCorrection. Για το PS το εύρος της GammaCorrection είναι από 9.99 έως +0.01. |
| έχει_άλφα | bool | r |  |
...
| offset | float | r/w | Λαμβάνει ή ορίζει το Offset. Για το PS το εύρος του Offset είναι από -0.5 έως +0.5. |
| opacity | byte | r/w |  |
