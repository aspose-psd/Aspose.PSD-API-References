...
type: docs
weight: 160
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| clipping | byte | r/w |  |
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | Λαμβάνει ή ορίζει το χρώμα RGB του φίλτρου. |
...
| density | int | r/w | Λαμβάνει ή ορίζει την πυκνότητα του φίλτρου |
