---
title: "VibranceLayer Κλάση"
type: docs
weight: 220
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
| δεξιά | int | r/w |  |
| κορεσμός | int | r/w | Λαμβάνει ή ορίζει τον κορεσμό. |
...
| ζωντάνια | int | r/w | Λαμβάνει ή ορίζει τη ζωντάνια. |
