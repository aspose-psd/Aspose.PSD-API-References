---
title: "ChannelMixerLayer Κλάση"
type: docs
weight: 40
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---

**Summary:** Channel Mixer Adjustment layer.
...
**Full Name:** aspose.psd.fileformats.psd.layers.adjustmentlayers.ChannelMixerLayer
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Λαμβάνει τον δείκτη του καναλιού κατά. Μπορεί να επιστρέψει RgbMixerChannel ή CmykMixerChannel |
...
Λαμβάνει τον δείκτη του καναλιού κατά. Μπορεί να επιστρέψει RgbMixerChannel ή CmykMixerChannel
...
| Τύπος | Περιγραφή |
| :- | :- |
| [MixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/mixerchannel) | [MixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/mixerchannel/) |
