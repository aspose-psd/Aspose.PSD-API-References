---
title: "CurvesLayer Κλάση"
type: docs
weight: 90
url: /el/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_continuous_manager_used | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιεί συνεχή διαχειριστή. |
| is_discrete_manager_used | bool | r/w | Λαμβάνει ή ορίζει μια τιμή που υποδεικνύει εάν αυτή η παρουσία χρησιμοποιεί διακριτό διαχειριστή. |
...
| [get_curves_manager()](#get_curves_manager__8) | Λαμβάνει τον διαχειριστή καμπυλών. |
...
Λαμβάνει τον διαχειριστή καμπυλών.

**Returns**

| Τύπος | Περιγραφή |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) ή [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) που εξαρτάται από τις ιδιότητες IsDiscreteManagerUsed και IsContinuousManagerUsed |
