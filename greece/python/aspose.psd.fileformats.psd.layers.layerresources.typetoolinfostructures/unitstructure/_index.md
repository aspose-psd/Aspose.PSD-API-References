---
title: "UnitStructure Κλάση"
type: docs
weight: 180
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [UnitStructure(key_name)](#UnitStructure_key_name_1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [UnitStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/). |
## **Properties**
...
| unit_type | [UnitTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes) | r/w | Λαμβάνει ή ορίζει τον τύπο μονάδας. |
| value | double | r/w | Λαμβάνει ή ορίζει την τιμή. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [UnitStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/).
