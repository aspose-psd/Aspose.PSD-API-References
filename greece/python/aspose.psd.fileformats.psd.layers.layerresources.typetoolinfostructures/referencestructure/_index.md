---
title: "ReferenceStructure Κλάση"
type: docs
weight: 150
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [ReferenceStructure(key_name)](#ReferenceStructure_key_name_1) | Αρχικοποιεί ένα νέο στιγμιότυπο της [ReferenceStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/) κλάσης. |
## **Properties**
| **Name** | **Type** | **Access** | **Περιγραφή** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Αναγνωρίζει το κλειδί δομής. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | Λαμβάνει ή ορίζει ένα αντίγραφο ενός πίνακα δομών. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της [ReferenceStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/referencestructure/) κλάσης.
