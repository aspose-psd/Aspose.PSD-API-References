---
title: "BooleanStructure Κλάση"
type: docs
weight: 20
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [BooleanStructure(key_name)](#BooleanStructure_key_name_1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/). |
## **Properties**
...
| value | bool | r/w | Λαμβάνει ή ορίζει μια τιμή boolean. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/).
