---
title: "PathStructure Κλάση"
type: docs
weight: 120
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [PathStructure(key_name)](#PathStructure_key_name_1) | Αρχικοποιεί ένα νέο στιγμιότυπο της [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/) κλάσης. |
## **Properties**
...
| διαδρομή | string | r/w | Λαμβάνει ή ορίζει τη διαδρομή. |
| πρόθεμα | string | r/w | Λαμβάνει ή ορίζει το πρόθεμα της διαδρομής. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/) κλάσης.
