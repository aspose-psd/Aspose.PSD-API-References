---
title: "ListStructure Κλάση"
type: docs
weight: 90
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [ListStructure(key_name)](#ListStructure_key_name_1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Περιγραφή** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Αναγνωρίζει το κλειδί δομής. |
| items_count | int | r | Λαμβάνει τον αριθμό των στοιχείων. |
...
| types | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r/w | Λαμβάνει ή ορίζει ένα αντίγραφο ενός πίνακα δομών. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [ListStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/).
