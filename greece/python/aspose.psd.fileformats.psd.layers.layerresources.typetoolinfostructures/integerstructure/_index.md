---
title: "IntegerStructure Κλάση"
type: docs
weight: 80
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Περιγραφή** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Το κλειδί της δομής ακεραίου. |
...
| value | int | r/w | Λαμβάνει ή ορίζει μια ακέραια τιμή. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/).
