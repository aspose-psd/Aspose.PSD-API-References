---
title: "AliasStructure Κλάση"
type: docs
weight: 10
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Περιγραφή** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Αναγνωρίζει το κλειδί δομής. |
| data_length | int | r | Λαμβάνει το ακριβές μήκος δεδομένων σε bytes. |
| full_path | string | r/w | Λαμβάνει ή ορίζει τη πλήρη διαδρομή. |
...
Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/).
