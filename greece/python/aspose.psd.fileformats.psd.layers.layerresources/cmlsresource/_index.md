---
title: "Κλάση CmlsResource"
type: docs
weight: 170
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [CmlsResource(data)](#CmlsResource_data_1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [CmlsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/). |
## **Properties**
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [CmlsResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/).
