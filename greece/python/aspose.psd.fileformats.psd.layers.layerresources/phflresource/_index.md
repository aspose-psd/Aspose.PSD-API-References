---
title: "PhflResource Κλάση"
type: docs
weight: 790
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [get_rgb_color()](#get_rgb_color__1) | Λαμβάνει το χρώμα του RGB. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| color | [Color](/psd/python-net/aspose.psd/color) | Το χρώμα RGB. |
