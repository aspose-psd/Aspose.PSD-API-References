---
title: "PhflResourceVersion3 Κλάση"
type: docs
weight: 810
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [PhflResourceVersion3()](#PhflResourceVersion3__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [PhflResourceVersion3](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/). |
| [PhflResourceVersion3(data)](#PhflResourceVersion3_data_2) | Αρχικοποιεί μια νέα παρουσία της κλάσης [PhflResourceVersion3](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/). |
## **Properties**
...
| color_x | float | r/w | Λαμβάνει ή ορίζει το χρώμα X. |
| color_y | float | r/w | Λαμβάνει ή ορίζει το χρώμα Y. |
| color_z | float | r/w | Λαμβάνει ή ορίζει το χρώμα Z. |
...
| version | short | r | Λαμβάνει την έκδοση. Η προεπιλογή είναι 2 ή 3 |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [PhflResourceVersion3](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion3/).
