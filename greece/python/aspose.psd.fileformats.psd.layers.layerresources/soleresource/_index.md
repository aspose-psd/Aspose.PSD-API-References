...
type: docs
weight: 940
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [SoLeResource()](#SoLeResource__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
| [SoLeResource(unique_id, is_custom, has_comp_info)](#SoLeResource_unique_id_is_custom_has_comp_info_2) | Αρχικοποιεί μια νέα παρουσία της κλάσης [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/). |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | Το κλειδί πληροφοριών του εργαλείου τύπου: 'SoLE'. |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/).
...
| :- | :- | :- |
| unique_id | Guid | Το μοναδικό αναγνωριστικό των δεδομένων του τοποθετημένου στρώματος [PlLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/). |
