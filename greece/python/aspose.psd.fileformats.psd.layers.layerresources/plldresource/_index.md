---
title: "Κλάση PlLdResource"
type: docs
weight: 820
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/
---
...
| μήκος | int | r | Λαμβάνει το μήκος του πόρου PlLd σε bytes. |
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [save(stream_container, psd_version)](#save_stream_container_psd_version_1) | Αποθηκεύει τον πόρο PlLD στο καθορισμένο κοντέινερ ροής. |
