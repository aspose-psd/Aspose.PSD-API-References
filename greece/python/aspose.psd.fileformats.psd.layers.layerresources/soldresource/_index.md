---
title: "Κλάση SoLdResource"
type: docs
weight: 930
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [SoLdResource()](#SoLdResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) class.<br/>            Αυτός ο προεπιλεγμένος κατασκευαστής σχεδιάστηκε για χρήση από [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/).<br/>            Χρησιμοποιήστε [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) για τη δημιουργία κλάσεων SoLdResource. |
| [SoLdResource(unique_id, is_custom, has_comp_info)](#SoLdResource_unique_id_is_custom_has_comp_info_2) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) class.<br/>            Απαιτείται να οριστεί η ιδιότητα Items ή να κληθεί η μέθοδος InitializeItems() για να ληφθεί ένα έτοιμο αντικείμενο.<br/>            Αυτός ο κατασκευαστής σχεδιάστηκε για χρήση από [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)<br/>            και σε μονάδες δοκιμών.<br/>            Χρησιμοποιήστε [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) για τη δημιουργία κλάσεων SoLdResource. |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | Το κλειδί πληροφοριών τύπου εργαλείου: 'SoLd'. |
...
| version | int | r | Επιστρέφει την έκδοση του τοποθετημένου στρώματος στο αρχείο PSD, συνήθως 3-5. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) class.<br/>            Αυτός ο προεπιλεγμένος κατασκευαστής σχεδιάστηκε για χρήση από [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/).<br/>            Χρησιμοποιήστε [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) για τη δημιουργία κλάσεων SoLdResource.
...
| :- | :- | :- |
| unique_id | Guid | Το μοναδικό αναγνωριστικό των δεδομένων στρώματος έξυπνου αντικειμένου [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/). |
| is_custom | bool | αν οριστεί σε <c>true</c> [is custom]. |
| has_comp_info | bool | αν οριστεί σε <c>true</c> [has comp information]. |
