...
type: docs
weight: 500
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/lfx2resource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [Lfx2Resource()](#Lfx2Resource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Lfx2Resource. |
## **Properties**
...
| descriptor_version | int | r | Λαμβάνει την έκδοση του περιγραφέα. |
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης Lfx2Resource.
