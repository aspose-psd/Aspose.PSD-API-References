---
title: "LyvrResource Κλάση"
type: docs
weight: 670
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [LyvrResource()](#LyvrResource__1) | Αρχικοποιεί μια νέα παρουσία της κλάσης LyvrResource |
## **Properties**
...
| version | int | r/w | Λαμβάνει ή ορίζει την έκδοση Photoshop του Layer. |
## **Methods**
| **Name** | **Περιγραφή** |
| :- | :- |
...
Αρχικοποιεί μια νέα παρουσία της κλάσης LyvrResource
