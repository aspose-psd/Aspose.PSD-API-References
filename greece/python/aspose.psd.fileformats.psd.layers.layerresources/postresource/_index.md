...
type: docs
weight: 840
url: /el/python-net/aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
| **Name** | **Περιγραφή** |
| :- | :- |
| [PostResource()](#PostResource__1) | Αρχικοποιεί ένα νέο αντικείμενο της κλάσης PostResource |
## **Properties**
...
Αρχικοποιεί ένα νέο αντικείμενο της κλάσης PostResource
