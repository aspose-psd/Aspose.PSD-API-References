...
type: docs
weight: 1750
url: /it/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Ottiene il carattere. |
| ha_alpha | bool | r |  |
...
| inner_text | string | r | Ottiene il testo del livello |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Ottiene o imposta il riquadro di delimitazione del testo. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Ottiene il colore del testo. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Ottiene le parti del testo. |
| superiore | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Ottiene il set di caratteri del livello di testo. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Ridimensiona l'immagine. Viene utilizzato il valore predefinito [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/). |
...
| [update_text(text)](#update_text_text_38) | Aggiorna il testo. |
| [update_text(text, color)](#update_text_text_color_39) | Aggiorna il testo. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Aggiorna il testo. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Aggiorna il testo. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Aggiorna il testo. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Aggiorna il testo. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Aggiorna il testo. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Aggiorna il testo. |
...
| Tipo | Descrizione |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | Il set di caratteri del livello di testo. |
...
Ridimensiona l'immagine. Viene utilizzato il valore predefinito [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/).
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Il tipo di trasformazione di ridimensionamento [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | Il valore del testo. |
| color | [Color](/psd/python-net/aspose.psd/color) | Il valore del colore. |
...
| :- | :- | :- |
| text | string | Il valore del testo. |
| font_size | float | Dimensione del carattere. |
...
| :- | :- | :- |
| text | string | Il valore del testo. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | La coordinata in alto a sinistra. |
