---
title: "ArtboardLayer Classe"
type: docs
weight: 90
url: /it/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | Ottiene o imposta il colore di sfondo dell'artboard. |
...
| ha_alpha | bool | r |  |
| has_background_color | bool | r/w | Ottiene o imposta un valore che indica se [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) ha il colore di sfondo. |
| ha_colore_trasparente | bool | r/w |  |
| altezza | int | r | <inheritdoc /> |
...
| è_in_cache | bool | r |  |
| is_open | bool | r/w | Ottiene o imposta se la cartella è aperta<br/>            se impostato su <c>true</c> il gruppo sarà nello stato aperto all'avvio, altrimenti nello stato ridotto. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | Ottiene i livelli nel gruppo di livelli |
| sinistra | int | r/w | <inheritdoc /> |
| lunghezza | int | r |  |
...
| **Name** | **Description** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Aggiunge il livello al gruppo di livelli. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | Aggiunge il gruppo di livelli. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | Carica parzialmente pixel ARGB a 32 bit (a blocchi). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | Carica dati grezzi. |
