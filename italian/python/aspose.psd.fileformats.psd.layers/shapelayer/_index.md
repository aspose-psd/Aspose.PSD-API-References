...
type: docs
weight: 1600
url: /it/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Description** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Inizializza una nuova istanza della classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Tutte le risorse sono create nello stato predefinito. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Ottiene o imposta le impostazioni di riempimento per l'area interna delle forme nel livello Shape. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Ottiene l'insieme di Path presenti in un livello Shape. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Ottiene o imposta le impostazioni di contorno delle forme. |
| superiore | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Crea una nuova istanza della classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Aggiorna le risorse dalle proprietà del livello Shape. |
...
Inizializza una nuova istanza della classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            Tutte le risorse sono create nello stato predefinito.
...
Crea una nuova istanza della classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Restituisce la nuova istanza della classe [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) |
