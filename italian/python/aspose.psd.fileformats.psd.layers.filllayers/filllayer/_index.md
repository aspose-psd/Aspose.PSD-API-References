...
type: docs
weight: 10
url: /it/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
| fill_settings | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Ottiene o imposta le impostazioni di riempimento. |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | r | Restituisce il tipo di riempimento. |
| riempitore | byte | r/w |  |
...
| [create_instance(fill_type)](#create_instance_fill_type_7) | Crea una nuova istanza della classe [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) in base al tipo di riempimento. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_35) | Sostituisce tutti i colori non trasparenti con un nuovo colore e preserva il valore alfa originale per mantenere bordi lisci.<br/>            Nota: se lo utilizzi su immagini senza trasparenza, tutti i colori verranno sostituiti con un unico colore. |
...
| update() | Aggiorna i dati dei pixel del livello di riempimento in base alle attuali [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
...
Crea una nuova istanza della classe [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) in base al tipo di riempimento.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| fill_type | [FillType](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/filltype/) | Il tipo di livello di riempimento. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer) | Restituisce una nuova istanza della classe [FillLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/) in base al tipo di riempimento. |
