...
type: docs
weight: 110
url: /it/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
| gradient_settings | [BaseGradientFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/basegradientfillsettings/) | r/w | Istanza delle impostazioni del gradiente passata dall'istanza di GrdmResource. |
| ha_alpha | bool | r |  |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | Carica parzialmente pixel ARGB a 32 bit (a blocchi). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | Carica dati grezzi. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | Unisce il livello al livello specificato |
| normalize_angle() |  |
