...
type: docs
weight: 50
url: /it/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Ottiene il canale nero. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Ottiene il canale ciano. |
...
| sinistra | int | r/w |  |
| lunghezza | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Ottiene il canale magenta. |
| monochrome | bool | r/w | Ottiene o imposta un valore che indica se questo [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) è monocromatico. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Ottiene il canale giallo. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Ottiene l'indice del canale. Restituisce CmykMixerChannel |
...
Ottiene l'indice del canale. Restituisce CmykMixerChannel
