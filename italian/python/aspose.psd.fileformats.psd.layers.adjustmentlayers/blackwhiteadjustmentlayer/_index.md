...
type: docs
weight: 20
url: /it/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Ottiene o imposta il valore del colore di tinta. |
| tint_color_blue | double | r/w | Ottiene o imposta il valore double del colore di tinta blu. |
| tint_color_green | double | r/w | Ottiene o imposta il valore double del colore di tinta verde. |
| tint_color_red | double | r/w | Ottiene o imposta il valore double del colore di tinta rosso. |
| superiore | int | r/w |  |
