...
type: docs
weight: 100
url: /it/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| eliminato | bool | r |  |
| esposizione | float | r/w | Ottiene o imposta l'Esposizione. Per PS l'intervallo di Esposizione è da -20 a +20. |
...
| gamma_correction | float | r/w | Ottiene o imposta la GammaCorrection. Per PS l'intervallo di GammaCorrection è da 9,99 a +0,01 |
| ha_alpha | bool | r |  |
...
| offset | float | r/w | Ottiene o imposta l'Offset. Per PS l'intervallo di Offset è da -0,5 a +0,5 |
| opacity | byte | r/w |  |
