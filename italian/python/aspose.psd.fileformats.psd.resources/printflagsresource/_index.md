...
type: docs
weight: 200
url: /it/python-net/aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [PrintFlagsResource()](#PrintFlagsResource__1) | Inizializza una nuova istanza della classe PrintFlagsResource |
## **Properties**
...
| bleed_scale | short | r/w | Ottiene o imposta la scala di sbordamento. |
| bleed_width | int | r/w | Ottiene o imposta la larghezza dello sbordamento. |
| center_crop_mark | byte | r/w | Ottiene o imposta il segno di ritaglio centrale. |
...
Inizializza una nuova istanza della classe PrintFlagsResource
