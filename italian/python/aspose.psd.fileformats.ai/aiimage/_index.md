...
type: docs
weight: 40
url: /it/python-net/aspose.psd.fileformats.ai/aiimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [AiImage()](#AiImage__1) | Inizializza una nuova istanza della classe AiImage |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| active_page_index | int | r/w | Ottiene o imposta l'indice della pagina attiva. |
...
| data_section | [AiDataSection](/psd/python-net/aspose.psd.fileformats.ai/aidatasection) | r | Ottiene la sezione dati. |
...
| finalize_section | [AiFinalizeSection](/psd/python-net/aspose.psd.fileformats.ai/aifinalizesection) | r | Ottiene la sezione di finalizzazione. |
| ha_colore_di_sfondo | bool | r/w | Ottiene o imposta un valore che indica se l'immagine ha un colore di sfondo. |
| header | [AiHeader](/psd/python-net/aspose.psd.fileformats.ai/aiheader) | r | Ottiene l'intestazione. |
...
| layers | [AiLayerSection[]](/psd/python-net/aspose.psd.fileformats.ai/ailayersection) | r | Ottiene le sezioni dei livelli. |
| page_count | int | r | Il numero di pagine.<br/>            Per le immagini del vecchio formato AI è sempre pari a 0. |
...
| setup_section | [AiSetupSection](/psd/python-net/aspose.psd.fileformats.ai/aisetupsection) | r | Ottiene la sezione di configurazione. |
...
| version | [AiFormatVersion](/psd/python-net/aspose.psd.fileformats.ai/aiformatversion) | r | Ottiene la versione del formato Adobe Illustrator. |
| width | int | r | Ottiene la larghezza dell'immagine. |
| xmp_data | [XmpPacketWrapper](/psd/python-net/aspose.psd.xmp/xmppacketwrapper/) | r | Ottiene o imposta i metadati XMP. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | Aggiunge la sezione livello AI. |
...
| [can_load(file_path, load_options)](#can_load_file_path_load_options_3) | Determina se l'immagine può essere caricata dal percorso file specificato e, facoltativamente, usando le opzioni di apertura specificate. |
| [can_load(stream)](#can_load_stream_4) | Determina se l'immagine può essere caricata dallo stream specificato. |
| [can_load(stream, load_options)](#can_load_stream_load_options_5) | Determina se l'immagine può essere caricata dallo stream specificato e, facoltativamente, usando il <paramref name=\"loadOptions\" /> specificato. |
| [can_save(options)](#can_save_options_6) | Determina se l'immagine può essere salvata nel formato file specificato rappresentato dalle opzioni di salvataggio fornite. |
| [create(image_options, width, height)](#create_image_options_width_height_7) | Crea una nuova immagine usando le opzioni di creazione specificate. |
| [get_default_options(args)](#get_default_options_args_8) | Ottiene le opzioni predefinite. |
| [get_file_format(file_path)](#get_file_format_file_path_9) | Ottiene il formato file. |
| [get_file_format(stream)](#get_file_format_stream_10) | Ottiene il formato file. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_11) | Restituisce il rettangolo che si adatta all'immagine corrente. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_12) | Restituisce il rettangolo che si adatta all'immagine corrente. |
| [get_original_options()](#get_original_options__13) | Restituisce le opzioni basate sulle impostazioni del file originale.<br/>            Questo può essere utile per mantenere inalterata la profondità di colore e altri parametri dell'immagine originale.<br/>            Ad esempio, se carichiamo un'immagine PNG in bianco‑nero con 1 bit per pixel e poi la salviamo usando il<br/>            [DataStreamSupporter.save(file_path)](/psd/python-net/aspose.psd/datastreamsupporter/) metodo, verrà prodotta un'immagine PNG di output con 8 bit per pixel.<br/>            Per evitarlo e salvare l'immagine PNG con 1 bit per pixel, utilizza questo metodo per ottenere le opzioni di salvataggio corrispondenti e passale<br/>            al [Image.save(file_path, options)](/psd/python-net/aspose.psd/image/) metodo come secondo parametro. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_14) | Restituisce un'altezza proporzionale. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_15) | Restituisce una larghezza proporzionale. |
| [load(file_path)](#load_file_path_16) | Carica una nuova immagine dal file specificato. |
| [load(file_path, load_options)](#load_file_path_load_options_17) | Carica una nuova immagine dal file specificato. |
| [load(stream)](#load_stream_18) | Carica una nuova immagine dallo stream specificato. |
| [load(stream, load_options)](#load_stream_load_options_19) | Carica una nuova immagine dallo stream specificato. |
| [resize(new_width, new_height)](#resize_new_width_new_height_20) | Ridimensiona l'immagine. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_21) | Ridimensiona l'immagine. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_22) | Ridimensiona l'immagine. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_23) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_24) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_25) | Ridimensiona l'altezza proporzionalmente. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_26) | Ridimensiona la larghezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/psd/python-net/aspose.psd/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_27) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_28) | Ridimensiona la larghezza proporzionalmente. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_29) | Ruota, capovolge o ruota e capovolge l'immagine. |
| save() | Salva i dati dell'immagine nello stream sottostante. |
| [save(file_path)](#save_file_path_30) | Salva i dati dell'oggetto nella posizione file specificata. |
| [save(file_path, options)](#save_file_path_options_31) | Salva i dati dell'oggetto nella posizione file specificata nel formato file specificato secondo le opzioni di salvataggio. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_32) | Salva i dati dell'oggetto nella posizione file specificata nel formato file specificato secondo le opzioni di salvataggio. |
| [save(file_path, over_write)](#save_file_path_over_write_33) | Salva i dati dell'oggetto nella posizione file specificata. |
| [save(stream)](#save_stream_34) | Salva i dati dell'oggetto nello stream specificato. |
| [save(stream, options_base)](#save_stream_options_base_35) | Salva i dati dell'immagine nello stream specificato nel formato file specificato secondo le opzioni di salvataggio. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_36) | Salva i dati dell'immagine nello stream specificato nel formato file specificato secondo le opzioni di salvataggio. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_37) | Imposta la tavolozza dell'immagine. |
...
Inizializza una nuova istanza della classe AiImage
...
Aggiunge la sezione livello AI.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| layer | [AiLayerSection](/psd/python-net/aspose.psd.fileformats.ai/ailayersection) | La sezione livello AI. |
