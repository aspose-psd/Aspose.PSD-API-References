...
type: docs
weight: 10
url: /it/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Description** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Inizializza una nuova istanza della classe [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifica la chiave della struttura. |
| data_length | int | r | Ottiene la lunghezza esatta dei dati in byte. |
| full_path | string | r/w | Ottiene o imposta il percorso completo. |
...
Inizializza una nuova istanza della classe [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/).
