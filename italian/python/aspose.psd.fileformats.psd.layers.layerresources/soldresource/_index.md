---
title: "SoLdResource Classe"
type: docs
weight: 930
url: /it/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [SoLdResource()](#SoLdResource__1) | Inizializza una nuova istanza della classe [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/).<br/>            Questo costruttore predefinito è progettato per essere utilizzato da [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/).<br/>            Usa [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) per creare classi SoLdResource. |
| [SoLdResource(unique_id, is_custom, has_comp_info)](#SoLdResource_unique_id_is_custom_has_comp_info_2) | Inizializza una nuova istanza della classe [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/).<br/>            È necessario impostare la proprietà Items o chiamare InitializeItems() per ottenere un'istanza pronta.<br/>            Questo costruttore è progettato per essere utilizzato da [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/)<br/>            e nei test unitari.<br/>            Usa [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) per creare classi SoLdResource. |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | La chiave delle informazioni dello strumento tipo: 'SoLd'. |
...
Inizializza una nuova istanza della classe [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/).<br/>            Questo costruttore predefinito è progettato per essere utilizzato da [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/).<br/>            Usa [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) per creare classi SoLdResource.
...
| :- | :- | :- |
| unique_id | Guid | L'identificatore univoco dei dati del livello oggetto intelligente [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/). |
