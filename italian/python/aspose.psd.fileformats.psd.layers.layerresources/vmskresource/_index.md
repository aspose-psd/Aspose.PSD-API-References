...
type: docs
weight: 1100
url: /it/python-net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [VmskResource()](#VmskResource__1) | Inizializza una nuova istanza della classe [VmskResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/). |
| [VmskResource(data)](#VmskResource_data_2) | Inizializza una nuova istanza della classe [VmskResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/). |
## **Properties**
...
Inizializza una nuova istanza della classe [VmskResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/).
