...
type: docs
weight: 420
url: /it/python-net/aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [InfxResource()](#InfxResource__1) | Inizializza una nuova istanza della classe [InfxResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/infxresource/). |
| [InfxResource(blend_interior_elements)](#InfxResource_blend_interior_elements_2) | Inizializza una nuova istanza della classe [InfxResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/infxresource/). |
| [InfxResource(data)](#InfxResource_data_3) | Inizializza una nuova istanza della classe [InfxResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/infxresource/).<br/>            Con valore personalizzato o sconosciuto |
## **Properties**
...
| blend_interior_elements | bool | r/w | Ottiene o imposta un valore che indica se [blend interior elements]. |
...
Inizializza una nuova istanza della classe [InfxResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/infxresource/).
...
| :- | :- | :- |
| blend_interior_elements | bool | se impostato a <c>true</c> [blend interior elements]. |
...
Inizializza una nuova istanza della classe [InfxResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/infxresource/).<br/>            Con valore personalizzato o sconosciuto
