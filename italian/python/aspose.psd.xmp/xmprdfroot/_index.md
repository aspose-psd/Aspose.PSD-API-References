...
type: docs
weight: 460
url: /it/python-net/aspose.psd.xmp/xmprdfroot/
---
...
| **Name** | **Description** |
| :- | :- |
| [XmpRdfRoot()](#XmpRdfRoot__1) | Inizializza una nuova istanza della classe XmpRdfRoot |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [get_namespace_uri(prefix)](#get_namespace_uri_prefix_3) | Ottiene l'URI dello spazio dei nomi tramite un prefisso specifico. Il prefisso può iniziare senza xmlns. |
| [get_xml_value()](#get_xml_value__4) | Converte il valore xmp nella rappresentazione xml. |
| [register_namespace_uri(prefix, namespace_uri)](#register_namespace_uri_prefix_namespace_uri_5) | Aggiunge l'URI dello spazio dei nomi tramite un prefisso. Il prefisso può iniziare senza xmlns. |
...
Ottiene l'URI dello spazio dei nomi tramite un prefisso specifico. Il prefisso può iniziare senza xmlns.
...
| Tipo | Descrizione |
| :- | :- |
| string | Restituisce l'URI dello schema del pacchetto. |
...
Aggiunge l'URI dello spazio dei nomi tramite un prefisso. Il prefisso può iniziare senza xmlns.
