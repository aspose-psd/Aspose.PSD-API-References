...
type: docs
weight: 2230
url: /it/python-net/aspose.psd/imageexportersregistry/
---
...
| :- | :- | :- | :- |
| registered_exporter_descriptors [static] | [IImageExporterDescriptor[]](/psd/python-net/aspose.psd/iimageexporterdescriptor) | r | Ottiene i descrittori degli esportatori registrati. |
| registered_formats [static] | [FileFormat](/psd/python-net/aspose.psd/fileformat) | r | Ottiene i formati di esportazione registrati. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| options | [ImageOptionsBase](/psd/python-net/aspose.psd/imageoptionsbase) | Le opzioni di salvataggio da utilizzare per l'esportazione. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [IImageExporter](/psd/python-net/aspose.psd/iimageexporter) | L'esportatore che supporta l'immagine e le opzioni di salvataggio specificate o null se non viene trovato alcun esportatore corrispondente. |
...
| Tipo | Descrizione |
| :- | :- |
| [IImageExporterDescriptor](/psd/python-net/aspose.psd/iimageexporterdescriptor) | Il descrittore dell'esportatore che supporta l'immagine e le opzioni di salvataggio specificate o null se non viene trovato alcun descrittore corrispondente. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| image_exporter_descriptor | [IImageExporterDescriptor](/psd/python-net/aspose.psd/iimageexporterdescriptor) | Il descrittore dell'esportatore di immagini. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| exporter_descriptor | [IImageExporterDescriptor](/psd/python-net/aspose.psd/iimageexporterdescriptor) | Il descrittore dell'esportatore da registrare. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| exporter_descriptor | [IImageExporterDescriptor](/psd/python-net/aspose.psd/iimageexporterdescriptor) | Il descrittore dell'esportatore da annullare la registrazione. |
