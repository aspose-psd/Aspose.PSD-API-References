...
type: docs
weight: 4230
url: /it/python-net/aspose.psd/streamcontainer/
---
...
| **Name** | **Description** |
| :- | :- |
| [StreamContainer(stream)](#StreamContainer_stream_1) | Inizializza una nuova istanza della classe [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [StreamContainer(stream, dispose_stream)](#StreamContainer_stream_dispose_stream_2) | Inizializza una nuova istanza della classe [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
## **Properties**
...
| [save(destination_stream)](#save_destination_stream_4) | Salva (copia) i dati dello stream nello stream specificato. Utilizza la dimensione predefinita del buffer [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) e il valore dello stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_5) | Salva (copia) tutti i dati dello stream nello stream specificato. Utilizza il valore dello stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(destination_stream, buffer_size, length)](#save_destination_stream_buffer_size_length_6) | Salva (copia) i dati dello stream nello stream specificato. |
| [save(file_path)](#save_file_path_7) | Salva (copia) i dati dello stream nello stream specificato. Utilizza la dimensione predefinita del buffer [StreamContainer.READ_WRITE_BYTES_COUNT](/psd/python-net/aspose.psd/streamcontainer/) e il valore dello stream [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_8) | Salva (copia) i dati del flusso nello stream specificato. Utilizza il valore del flusso [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
| [save(file_path, buffer_size, length)](#save_file_path_buffer_size_length_9) | Salva (copia) i dati dello stream nello stream specificato. |
| [seek(offset, origin)](#seek_offset_origin_10) | Imposta la posizione all'interno del flusso corrente. |
...
| [to_bytes()](#to_bytes__11) | Converte i dati del flusso in un array di interi. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_12) | Converte i dati del flusso in un array di interi. |
| [write(buffer, offset, count)](#write_buffer_offset_count_13) | Scrive una sequenza di byte nel flusso corrente e avanza la posizione corrente all'interno di questo flusso del numero di byte scritti. |
| [write(bytes)](#write_bytes_14) | Scrive tutti i byte specificati nello stream. |
| [write_byte(value)](#write_byte_value_15) | Scrive un byte nella posizione corrente del flusso e avanza la posizione all'interno del flusso di un byte. |
| [write_to(stream_container)](#write_to_stream_container_16) | Copia i dati contenuti in un altro [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [write_to(stream_container, length)](#write_to_stream_container_length_17) | Copia i dati contenuti in un altro [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
...
Inizializza una nuova istanza della classe [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/).
