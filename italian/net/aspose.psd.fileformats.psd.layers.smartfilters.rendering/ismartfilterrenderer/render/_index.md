...
description: ISmartFilterRenderer metodo. Renderizza il filtro intelligente corrente sui dati dei pixel.
type: docs
weight: 10
url: /it/net/aspose.psd.fileformats.psd.layers.smartfilters.rendering/ismartfilterrenderer/render/
---
## ISmartFilterRenderer.Render method

Renderizza il filtro intelligente corrente sui dati dei pixel.
...
| --- | --- | --- |
| pixelsData | PixelsData | I dati dei pixel. |

### Valore di ritorno

Restituisce i dati dei pixel elaborati.
...
* spazio dei nomi [Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.Rendering](../../ismartfilterrenderer/)
