...
description: AiLayerSection proprietà. Ottiene o imposta un valore che indica se questo livello è un livello modello.
type: docs
weight: 100
url: /it/net/aspose.psd.fileformats.ai/ailayersection/istemplate/
---
...
`VERO` se questo livello è un modello; Altrimenti,`falso` .
