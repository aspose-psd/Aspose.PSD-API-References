...
description: Ottiene o imposta un valore che indica se questo livello è in anteprima. Visualizza il disegno contenuto nel livello a colori anziché come contorni.
type: docs
weight: 70
...
Ottiene o imposta un valore che indica se questo livello è in anteprima. Visualizza il disegno contenuto nel livello a colori anziché come contorni.
...
`VERO` se questo livello è in anteprima; altrimenti,`falso` .
