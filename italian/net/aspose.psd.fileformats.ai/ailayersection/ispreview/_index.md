...
description: AiLayerSection proprietà. Ottiene o imposta un valore che indica se questo livello è unanteprima. Visualizza la grafica contenuta nel livello a colori anziché come contorni.
type: docs
weight: 70
url: /it/net/aspose.psd.fileformats.ai/ailayersection/ispreview/
---
## AiLayerSection.IsPreview property

Ottiene o imposta un valore che indica se questo livello è un'anteprima. Visualizza la grafica contenuta nel livello a colori anziché come contorni.
...
`VERO` se questo livello è l'anteprima; Altrimenti,`falso` .
