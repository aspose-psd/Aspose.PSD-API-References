...
description: AiLayerSection proprietà. Ottiene o imposta un valore che indica se questo livello è mostrato. Visualizza tutti gli elementi grafici contenuti nel livello sulla tavola da disegno se vero.
type: docs
weight: 90
url: /it/net/aspose.psd.fileformats.ai/ailayersection/isshown/
---
## AiLayerSection.IsShown property

Ottiene o imposta un valore che indica se questo livello è mostrato. Visualizza tutti gli elementi grafici contenuti nel livello sulla tavola da disegno se vero.
...
`VERO` se questo livello è mostrato; Altrimenti,`falso` .
