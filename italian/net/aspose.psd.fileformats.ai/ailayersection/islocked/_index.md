...
description: AiLayerSection proprietà. Ottiene o imposta un valore che indica se questo livello è bloccato. Impedisce le modifiche allelemento.
type: docs
weight: 60
url: /it/net/aspose.psd.fileformats.ai/ailayersection/islocked/
---
## AiLayerSection.IsLocked property

Ottiene o imposta un valore che indica se questo livello è bloccato. Impedisce le modifiche all'elemento.
...
`VERO` se questo livello è bloccato; Altrimenti,`falso` .
