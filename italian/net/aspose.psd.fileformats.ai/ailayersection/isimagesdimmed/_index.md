...
description: AiLayerSection proprietà. Ottiene o imposta un valore che indica se questo livello è oscurato. Riduce lintensità delle immagini collegate e delle immagini bitmap contenute nel livello.
type: docs
weight: 50
url: /it/net/aspose.psd.fileformats.ai/ailayersection/isimagesdimmed/
---
## AiLayerSection.IsImagesDimmed property

Ottiene o imposta un valore che indica se questo livello è oscurato. Riduce l'intensità delle immagini collegate e delle immagini bitmap contenute nel livello.
...
`VERO` se questo livello è oscurato; Altrimenti,`falso` .

### Esempi

L'esempio seguente mostra il supporto dei layer nei file in formato AI.
