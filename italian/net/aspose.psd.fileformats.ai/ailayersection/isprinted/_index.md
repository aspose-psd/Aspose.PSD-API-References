...
description: Ottiene o imposta un valore che indica se questo livello è stampato. Rende stampabile la grafica contenuta nel livello se true.
type: docs
weight: 80
...
Ottiene o imposta un valore che indica se questo livello è stampato. Rende stampabile la grafica contenuta nel livello se true.
...
`VERO` se questo livello è stampato; altrimenti,`falso` .
