...
description: AiLayerSection proprietà. Ottiene o imposta un valore che indica se questo livello è stampato. Rende stampabile limmagine contenuta nel livello se true.
type: docs
weight: 80
url: /it/net/aspose.psd.fileformats.ai/ailayersection/isprinted/
---
## AiLayerSection.IsPrinted property

Ottiene o imposta un valore che indica se questo livello è stampato. Rende stampabile l'immagine contenuta nel livello se true.
...
`VERO` se questo strato è stampato; Altrimenti,`falso` .
