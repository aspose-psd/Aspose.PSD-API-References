...
description: Aspose.PSD.FileFormats.Psd.Resources.WatermarkResource classe. Risorsa filigrana
type: docs
weight: 3970
url: /it/net/aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| Nome | Descrizione |
| --- | --- |
| [WatermarkResource](watermarkresource/)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/watermarkresource/datasize/) { get; } | Ottiene la dimensione dei dati della risorsa in byte. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Ottiene o imposta l'identificatore univoco per la risorsa. |
| [IsWatermark](../../aspose.psd.fileformats.psd.resources/watermarkresource/iswatermark/) { get; set; } | Ottiene o imposta un valore che indica se questa istanza è filigrana. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/watermarkresource/minimalversion/) { get; } | Ottiene la versione PSD minima richiesta. |
