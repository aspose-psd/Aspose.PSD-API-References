...
description: Risorsa mezzitoni
type: docs
weight: 3610
url: /it/net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| Nome | Descrizione |
| --- | --- |
| [ColorHalftoneInformationResource](colorhalftoneinformationresource)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/datasize) { get; } | Ottiene la dimensione dei dati della risorsa in byte. |
| [HalftoneData](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/halftonedata) { get; set; } | Ottiene o imposta i dati dei mezzitoni. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id) { get; set; } | Ottiene o imposta l'identificatore univoco per la risorsa. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/minimalversion) { get; } | Ottiene la versione PSD minima richiesta. |
