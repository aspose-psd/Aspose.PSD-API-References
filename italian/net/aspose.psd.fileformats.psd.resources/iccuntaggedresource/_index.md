...
description: Risorsa senza tag Icc
type: docs
weight: 3710
url: /it/net/aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
## IccUntaggedResource class

Risorsa senza tag Icc
...
| Nome | Descrizione |
| --- | --- |
| [IccUntaggedResource](iccuntaggedresource)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/iccuntaggedresource/datasize) { get; } | Ottiene la dimensione dei dati della risorsa in byte. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id) { get; set; } | Ottiene o imposta l'identificatore univoco per la risorsa. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/iccuntaggedresource/minimalversion) { get; } | Ottiene la versione PSD minima richiesta. |
...
| [Profile](../../aspose.psd.fileformats.psd.resources/iccuntaggedresource/profile) { get; set; } | Ottiene o imposta il profilo. |
