...
description: Aspose.PSD.FileFormats.Psd.Resources.IccProfileResource classe. Rappresenta la risorsa del profilo ICC.
type: docs
weight: 3760
url: /it/net/aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| Nome | Descrizione |
| --- | --- |
| [IccProfileResource](iccprofileresource/)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/iccprofileresource/datasize/) { get; } | Ottiene la dimensione dei dati della risorsa in byte. |
| [IccProfile](../../aspose.psd.fileformats.psd.resources/iccprofileresource/iccprofile/) { get; set; } | Ottiene o imposta il profilo ICC. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Ottiene o imposta l'identificatore univoco per la risorsa. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/iccprofileresource/minimalversion/) { get; } | Ottiene la versione PSD minima richiesta. |
