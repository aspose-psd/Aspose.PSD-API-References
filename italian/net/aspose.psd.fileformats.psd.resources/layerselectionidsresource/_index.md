...
description: ID selezione livello risorsa
type: docs
weight: 3740
url: /it/net/aspose.psd.fileformats.psd.resources/layerselectionidsresource/
---
## LayerSelectionIdsResource class

ID selezione livello risorsa
...
| Nome | Descrizione |
| --- | --- |
| [LayerSelectionIdsResource](layerselectionidsresource)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Count](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/count) { get; set; } | Ottiene o imposta il conteggio. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/datasize) { get; } | Ottiene la dimensione dei dati della risorsa in byte. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id) { get; set; } | Ottiene o imposta l'identificatore univoco per la risorsa. |
| [LayerIds](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/layerids) { get; set; } | Ottiene o imposta gli ID del livello. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/layerselectionidsresource/minimalversion) { get; } | Ottiene la versione PSD minima richiesta. |
