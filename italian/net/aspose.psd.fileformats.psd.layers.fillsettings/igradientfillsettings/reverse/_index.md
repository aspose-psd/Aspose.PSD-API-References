...
description: Ottiene o imposta un valore che indica se questoIGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings è il contrario.
type: docs
weight: 90
...
Ottiene o imposta un valore che indica se questo[`IGradientFillSettings`](../../igradientfillsettings) è il contrario.
