...
description: IGradientFillSettings proprietà. Ottiene o imposta un valore che indica se thisIGradientFillSettings è dither.
type: docs
weight: 50
url: /it/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
## IGradientFillSettings.Dither property

Ottiene o imposta un valore che indica se this[`IGradientFillSettings`](../) è dither.
