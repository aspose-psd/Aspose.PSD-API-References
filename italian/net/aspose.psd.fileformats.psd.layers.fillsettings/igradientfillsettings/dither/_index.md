...
description: Ottiene o imposta un valore che indica se questoIGradientFillSettingsaspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings è dithering.
type: docs
weight: 50
...
Ottiene o imposta un valore che indica se questo[`IGradientFillSettings`](../../igradientfillsettings) è dithering.
