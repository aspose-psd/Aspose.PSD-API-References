...
description: Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeRadiiRectangle classe. Definisce la classe del rettangolo dei raggi della forma vettoriale
type: docs
weight: 1450
...
Definisce la classe del rettangolo dei raggi della forma vettoriale
...
| Nome | Descrizione |
| --- | --- |
| [BottomLeft](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/bottomleft/) { get; set; } | Ottiene o imposta il fondo. |
| [BottomRight](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/bottomright/) { get; set; } | Ottiene o imposta in basso a destra. |
| [QuadVersion](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/quadversion/) { get; set; } | Ottiene o imposta il valore unitario versione quad. |
| [TopLeft](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/topleft/) { get; set; } | Ottiene o imposta la parte superiore sinistra. |
| [TopRight](../../aspose.psd.fileformats.core.vectorpaths/vectorshaperadiirectangle/topright/) { get; set; } | Ottiene o imposta in alto a destra. |
