...
description: Definisce la matrice di trasformazione della forma vettoriale class
type: docs
weight: 1460
url: /it/net/aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/
---
## VectorShapeTransform class

Definisce la matrice di trasformazione della forma vettoriale class
...
| Nome | Descrizione |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform)() | Inizializza una nuova istanza di[`VectorShapeTransform`](../vectorshapetransform) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Tx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/tx) { get; set; } | Ottiene o imposta il valore TX. |
| [Ty](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/ty) { get; set; } | Ottiene o imposta il valore TY. |
| [Xx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx) { get; set; } | Ottiene o imposta il valore XX. |
| [Xy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy) { get; set; } | Ottiene o imposta il valore XY. |
| [Yx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yx) { get; set; } | Ottiene o imposta il valore YX. |
| [Yy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yy) { get; set; } | Ottiene o imposta il valore YY. |
...
Questo esempio mostra come ottenere e impostare nuove proprietà Transform e OriginBoxCorners di ShapeOriginSettings nella risorsa Vogk di FillLayer nel file PSD.

```csharp
[C#]

// Questo esempio mostra come ottenere e impostare nuove proprietà Transform e OriginBoxCorners
// di ShapeOriginSettings nella risorsa Vogk di FillLayer nel file PSD
...
using (PsdImage image = (PsdImage)Image.Load(sourceFileName))
{
    ...
    // Salva questa immagine PSD con proprietà modificate.
    image.Save(outputPath, new PsdOptions(image));
}

// Carica l'immagine PSD salvata con le proprietà modificate.
using (PsdImage image = (PsdImage)Image.Load(outputPath))
{
    ...
    // Afferma che le proprietà sono state salvate e caricate correttamente 
    var setting = resource.ShapeOriginSettings[0];
    AssertAreEqual(true, setting.IsOriginIndexPresent);
    AssertAreEqual(false, setting.IsShapeInvalidatedPresent);
    AssertAreEqual(true, setting.IsOriginResolutionPresent);
