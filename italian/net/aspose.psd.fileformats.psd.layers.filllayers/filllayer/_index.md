...
description: Livello di riempimento. Livello di riempimento colore riempimento sfumato o riempimento motivo che differisce perFillSettings./filllayer/fillsettings
type: docs
weight: 1890
...
Livello di riempimento. Livello di riempimento colore, riempimento sfumato o riempimento motivo che differisce per[`FillSettings`](./fillsettings)
...
| Nome | Descrizione |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | Crea una nuova istanza di[`FillLayer`](../filllayer) classe per tipo di riempimento. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update)() | Aggiorna i dati dei pixel del livello di riempimento in base a quelli effettivi[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) . |
