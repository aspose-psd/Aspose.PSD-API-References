...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer classe. Riempi il livello. Livello di riempimento colore riempimento sfumato o riempimento motivo che differisce perFillSettings
type: docs
weight: 1910
url: /it/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
## FillLayer class

Riempi il livello. Livello di riempimento colore, riempimento sfumato o riempimento motivo che differisce per[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | Ottiene le impostazioni di riempimento. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Ottiene il tipo di riempimento. |
...
| Nome | Descrizione |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Crea una nuova istanza di`FillLayer` classe per tipo di riempimento. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Sostituisce tutti i colori non trasparenti con un nuovo colore e conserva il valore alfa originale per salvare i bordi smussati. Nota: se lo usi su immagini senza trasparenza, tutti i colori verranno sostituiti con uno solo. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Aggiorna i dati dei pixel del livello di riempimento in base ai dati effettivi[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* spazio dei nomi [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
