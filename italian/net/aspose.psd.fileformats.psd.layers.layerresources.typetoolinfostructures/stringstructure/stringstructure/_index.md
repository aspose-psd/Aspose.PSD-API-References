...
description: StringStructure costruttore. Inizializza una nuova istanza diStringStructure classe.
type: docs
weight: 10
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/stringstructure/
---
## StringStructure(ClassID) {#constructor}

Inizializza una nuova istanza di[`StringStructure`](../) classe.
...
Inizializza una nuova istanza di[`StringStructure`](../)classe con valore.
