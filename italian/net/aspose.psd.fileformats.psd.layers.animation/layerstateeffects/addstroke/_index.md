...
description: LayerStateEffects metodo. Aggiunge leffetto tratto.
type: docs
weight: 90
url: /it/net/aspose.psd.fileformats.psd.layers.animation/layerstateeffects/addstroke/
---
...
| --- | --- | --- |
| fillType | FillType | Il tipo riempimento tratto. |

### Valore di ritorno

La nuova istanza di[`StrokeEffect`](../../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/) classe.
