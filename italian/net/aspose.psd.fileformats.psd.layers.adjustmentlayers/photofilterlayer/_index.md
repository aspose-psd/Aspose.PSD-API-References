...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer classe. Livello di regolazione del filtro fotografico.
type: docs
weight: 1790
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | Ottiene o imposta il colore RGB del filtro. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | Ottiene o imposta la densità del filtro |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | Ottiene o imposta un valore che indica se [preserve luminosity]. |
