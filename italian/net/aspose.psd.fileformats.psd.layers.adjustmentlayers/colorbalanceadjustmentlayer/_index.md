...
description: La classe del livello di regolazione del bilanciamento del colore.
type: docs
weight: 1720
...
| [HighlightsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightscyanredbalance) { get; set; } | Ottiene o imposta il bilanciamento del rosso ciano luci. |
| [HighlightsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsmagentagreenbalance) { get; set; } | Ottiene o imposta il saldo verde magenta in evidenza. |
| [HighlightsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsyellowbluebalance) { get; set; } | Ottiene o imposta il saldo giallo blu Highlights. |
...
| [MidtonesYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesyellowbluebalance) { get; set; } | Ottiene o imposta il bilanciamento dei mezzitoni giallo blu. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/preserveluminosity) { get; set; } | Ottiene o imposta un valore che indica se questo[`BlncResource`](../../aspose.psd.fileformats.psd.layers.layerresources/blncresource) preserva la luminosità. |
...
| [ShadowsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowscyanredbalance) { get; set; } | Ottiene o imposta il bilanciamento del rosso ciano delle ombre. |
| [ShadowsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsmagentagreenbalance) { get; set; } | Ottiene o imposta il bilanciamento del verde magenta delle ombre. |
| [ShadowsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsyellowbluebalance) { get; set; } | Ottiene o imposta il bilanciamento ombre gialloblu. |
