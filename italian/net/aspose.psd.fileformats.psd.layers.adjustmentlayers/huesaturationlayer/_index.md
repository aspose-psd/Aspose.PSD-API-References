...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer classe. Livello di regolazione Tonalità e saturazione.
type: docs
weight: 1750
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
## HueSaturationLayer class

Livello di regolazione Tonalità e saturazione.
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | Ottiene o imposta un valore che indica se this`HueSaturationLayer` è colorize. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | Ottiene o imposta la tonalità. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | Ottiene o imposta la luminosità. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | Ottiene o imposta la saturazione. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | Ottiene l'intervallo. |
