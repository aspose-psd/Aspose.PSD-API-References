...
description: Livello di regolazione del mixer dei canali Cmyk.
type: docs
weight: 1700
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
## CmykChannelMixerLayer class

Livello di regolazione del mixer dei canali Cmyk.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel) { get; } | Ottiene il canale nero. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel) { get; } | Ottiene il canale ciano. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel) { get; } | Ottiene il canale magenta. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome) { get; set; } | Ottiene o imposta un valore che indica se questo[`ChannelMixerLayer`](../channelmixerlayer) è monocromatico. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel) { get; } | Ottiene il canale giallo. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex)(int) | Ottiene l'indice del canale tramite. Restituisce CmykMixerChannel |
