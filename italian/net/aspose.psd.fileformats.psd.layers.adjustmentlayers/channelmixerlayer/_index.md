...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer classe. Livello di regolazione del mixer dei canali.
type: docs
weight: 1690
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
## ChannelMixerLayer class

Livello di regolazione del mixer dei canali.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Ottiene o imposta un valore che indica se this`ChannelMixerLayer` è monocromatico. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Ottiene l'indice del canale by. Può restituire RgbMixerChannel o CmykMixerChannel |
