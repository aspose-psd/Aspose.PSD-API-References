...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer classe. Livello di regolazione delle curve
type: docs
weight: 1730
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Ottiene o imposta un valore che indica se questa istanza è un gestore continuo utilizzato. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Ottiene o imposta un valore che indica se questa istanza è utilizzata da un gestore discreto. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | Ottiene il gestore delle curve. |
