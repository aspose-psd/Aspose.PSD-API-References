...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer classe. Posterizza il livello. Gestisce il rendering Posterize utilizzando i dati di PostResource.
type: docs
weight: 1800
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
## PosterizeLayer class

Posterizza il livello. Gestisce il rendering Posterize utilizzando i dati di PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | Livelli del livello Posterizza. |
