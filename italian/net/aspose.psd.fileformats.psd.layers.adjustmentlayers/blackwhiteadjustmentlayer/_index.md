...
description: La classe del livello di regolazione Bianco e nero.
type: docs
weight: 1670
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
## BlackWhiteAdjustmentLayer class

La classe del livello di regolazione Bianco e nero.
...
| [BlackAndWhitePresetFileName](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blackandwhitepresetfilename) { get; set; } | Ottiene o imposta il nome del file predefinito in bianco e nero. |
...
| [Blues](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blues) { get; set; } | Ottiene o imposta il valore blues. |
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind) { get; set; } | Ottiene o imposta il valore del tipo predefinito in bianco e nero. |
...
| [Cyans](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans) { get; set; } | Ottiene o imposta il valore ciano. |
...
| [Greens](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens) { get; set; } | Ottiene o imposta il valore dei verdi. |
...
| [Magentas](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/magentas) { get; set; } | Ottiene o imposta il valore magenta. |
...
| [Reds](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/reds) { get; set; } | Ottiene o imposta il valore dei rossi. |
...
| [TintColor](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolor) { get; set; } | Ottiene o imposta il valore Colore tinta. |
| [TintColorBlue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue) { get; set; } | Ottiene o imposta il valore double del colore della tinta blu. |
| [TintColorGreen](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorgreen) { get; set; } | Ottiene o imposta il valore double del colore della tinta verde. |
| [TintColorRed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorred) { get; set; } | Ottiene o imposta il valore double del colore della tinta rossa. |
...
| [UseTint](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/usetint) { get; set; } | Ottiene o imposta un valore che indica se viene utilizzato [colore tinta]. |
...
| [Yellows](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows) { get; set; } | Ottiene o imposta il valore dei gialli. |
