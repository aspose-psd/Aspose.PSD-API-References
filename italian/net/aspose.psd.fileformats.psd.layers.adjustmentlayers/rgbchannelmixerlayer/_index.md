...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer classe. Livello di regolazione del mixer del canale Rgb.
type: docs
weight: 1810
url: /it/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
## RgbChannelMixerLayer class

Livello di regolazione del mixer del canale Rgb.
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel/) { get; } | Ottiene il canale blu. |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel/) { get; } | Ottiene il canale verde. |
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Ottiene o imposta un valore che indica se this[`ChannelMixerLayer`](../channelmixerlayer/) è monocromatico. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel/) { get; } | Ottiene il canale rosso. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | Ottiene l'indice del canale by. Restituisce RgbMixerChannel |
