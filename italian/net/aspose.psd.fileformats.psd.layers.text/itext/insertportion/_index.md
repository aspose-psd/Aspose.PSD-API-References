...
description: Inserisce ilITextPortionaspose.psd.fileformats.psd.layers.text/itextportion alla posizione specificata
type: docs
weight: 40
url: /it/net/aspose.psd.fileformats.psd.layers.text/itext/insertportion/
---
## IText.InsertPortion method

Inserisce il[`ITextPortion`](../../itextportion) alla posizione specificata
...
| --- | --- | --- |
| portion | ITextPortion | La porzione. |
