...
description: Ottiene o imposta un valore che indica se sillabazione automatica.
type: docs
weight: 10
...
Ottiene o imposta un valore che indica se [sillabazione automatica].
...
`VERO` se [trattino automatico]; altrimenti,`falso` .
