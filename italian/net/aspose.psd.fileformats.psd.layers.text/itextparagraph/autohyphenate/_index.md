...
description: ITextParagraph proprietà. Ottiene o imposta un valore che indica se trattino automatico.
type: docs
weight: 10
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Ottiene o imposta un valore che indica se [trattino automatico].
...
`VERO` if [sillabato automatico]; Altrimenti,`falso` .
