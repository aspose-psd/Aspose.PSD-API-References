...
description: ITextParagraph metodo. Determina se il paragrafo specificato è uguale.
type: docs
weight: 230
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/isequal/
---
## ITextParagraph.IsEqual method

Determina se il paragrafo specificato è uguale.
...
| --- | --- | --- |
| paragraph | ITextParagraph | Il paragrafo. |

### Valore di ritorno

`VERO` se il paragrafo specificato è uguale; Altrimenti,`falso` .
