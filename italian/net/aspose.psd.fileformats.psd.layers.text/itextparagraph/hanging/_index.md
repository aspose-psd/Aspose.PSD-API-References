...
description: ITextParagraph proprietà. Ottiene o imposta un valore che indica se thisITextParagraph è sospeso.
type: docs
weight: 90
...
Ottiene o imposta un valore che indica se this[`ITextParagraph`](../) è sospeso.
