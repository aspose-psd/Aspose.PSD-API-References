...
description: Ottiene o imposta un valore che indica se questoITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph è sospeso.
type: docs
weight: 90
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Ottiene o imposta un valore che indica se questo[`ITextParagraph`](../../itextparagraph) è sospeso.
...
`VERO` se appeso; altrimenti,`falso` .
