...
description: Ottiene o imposta un valore che indica se questoITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph è burasagiri.
type: docs
weight: 30
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Ottiene o imposta un valore che indica se questo[`ITextParagraph`](../../itextparagraph) è burasagiri.
...
`VERO` se burasagiri; altrimenti,`falso` .
...
* spazio dei nomi [Aspose.PSD.FileFormats.Psd.Layers.Text](../../itextparagraph)
