...
description: Ottiene o imposta un valore che indica se ogni line composer.
type: docs
weight: 60
...
Ottiene o imposta un valore che indica se [ogni line composer].
...
`VERO` se [compositore di ogni riga]; altrimenti,`falso` .
