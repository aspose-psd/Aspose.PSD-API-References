...
description: ITextParagraph proprietà. Ottiene o imposta un valore che indica se compositore di ogni riga.
type: docs
weight: 60
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Ottiene o imposta un valore che indica se [compositore di ogni riga].
...
`VERO` if [compositore di ogni riga]; Altrimenti,`falso` .
