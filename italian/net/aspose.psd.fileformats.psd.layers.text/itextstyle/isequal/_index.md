...
description: ITextStyle metodo. Determina se lo stile specificato è uguale.
type: docs
weight: 290
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
...
| --- | --- | --- |
| style | ITextStyle | Lo stile. |

### Valore di ritorno

`VERO` se lo stile specificato è uguale; Altrimenti,`falso` .
