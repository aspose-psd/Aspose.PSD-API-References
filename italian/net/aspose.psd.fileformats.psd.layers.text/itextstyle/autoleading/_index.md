...
description: ITextStyle proprietà. Ottiene o imposta un valore che indica se interlinea automatica.
type: docs
weight: 20
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Ottiene o imposta un valore che indica se [interlinea automatica].
...
`VERO` if [guida automatica]; Altrimenti,`falso` .
