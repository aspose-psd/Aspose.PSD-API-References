...
description: ITextStyle proprietà. Ottiene o imposta un valore che indica se numeri hindi.
type: docs
weight: 150
url: /it/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Ottiene o imposta un valore che indica se [numeri hindi].
...
`VERO` se [numeri hindi]; Altrimenti,`falso` .
