...
description: Aspose.PSD.Shapes.PieShape classe. Rappresenta una forma a torta.
type: docs
weight: 5500
url: /it/net/aspose.psd.shapes/pieshape/
---
## PieShape class
...
| Nome | Descrizione |
| --- | --- |
| [PieShape](pieshape/#constructor)() | Inizializza una nuova istanza di`PieShape` classe. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | Inizializza una nuova istanza di`PieShape` classe. |
...
| override [Segments](../../aspose.psd.shapes/pieshape/segments/) { get; } | Ottiene i segmenti della forma. |
