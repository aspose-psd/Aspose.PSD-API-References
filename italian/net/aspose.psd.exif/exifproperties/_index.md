...
| SpatialFrequencyResponse | `41484` | Questo tag registra la tabella della frequenza spaziale della fotocamera o del dispositivo di input e i valori SFR nella direzione della larghezza dell'immagine, dell'altezza dell'immagine e della direzione della diagonale, come specificato in ISO 12233. |
