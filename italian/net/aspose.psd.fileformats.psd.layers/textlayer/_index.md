...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer classe. La classe del livello di testo
type: docs
weight: 3560
url: /it/net/aspose.psd.fileformats.psd.layers/textlayer/
---
## TextLayer class
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | Ottiene il carattere. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Ottiene il testo del layer |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | Ottiene il testo. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Ottiene o imposta la casella associata al testo. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Ottiene il colore del testo. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Ottiene le porzioni di testo. |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Ottiene o imposta la posizione del livello superiore. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Ottiene o imposta la matrice di trasformazione |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Ottiene il set di caratteri del livello di testo. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. Il predefinitoLeftTopToLeftTopviene utilizzato. |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | Aggiorna il testo. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | Aggiorna il testo. |
