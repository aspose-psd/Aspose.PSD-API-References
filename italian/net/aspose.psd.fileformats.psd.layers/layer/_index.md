...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer classe. Il livello psd.
type: docs
weight: 2080
url: /it/net/aspose.psd.fileformats.psd.layers/layer/
---
## Layer class
...
| Nome | Descrizione |
| --- | --- |
| [Layer](layer/#constructor)() | Inizializza una nuova istanza di`Layer` classe. Costruttore per inizializzazione pigra. |
| [Layer](layer/#constructor_3)(Stream) | Inizializza una nuova istanza di`Layer` classe. |
| [Layer](layer/#constructor_1)(RasterImage, bool) | Inizializza una nuova istanza di`Layer` classe. |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Inizializza una nuova istanza di`Layer` classe da array di byte. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | Salva i dati dell'oggetto nel flusso specificato. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | Salva i dati dell'oggetto nella posizione file specificata. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | Salva i dati dell'oggetto nella posizione file specificata nel formato file specificato in base alle opzioni di salvataggio. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | Salva i dati dell'immagine nel flusso specificato nel formato di file specificato in base alle opzioni di salvataggio. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | Salva i dati dell'oggetto nella posizione file specificata nel formato file specificato in base alle opzioni di salvataggio. |
...
| Nome | Descrizione |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | Rappresenta la firma della modalità di fusione. |
| const [LayerHeaderSize](../../aspose.psd.fileformats.psd.layers/layer/layerheadersize/) | La dimensione dell'intestazione del livello. |
