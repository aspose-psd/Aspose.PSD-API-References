...
description: SectionDividerLayer proprietà. Ottiene un valore che indica se questa istanza è visibile nel gruppo se il layer non è nel gruppo significa gruppo radice.
type: docs
weight: 10
...
Ottiene un valore che indica se questa istanza è visibile nel gruppo (se il layer non è nel gruppo significa gruppo radice).
