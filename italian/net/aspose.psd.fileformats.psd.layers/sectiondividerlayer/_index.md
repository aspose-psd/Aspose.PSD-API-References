...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer classe. Il layer divisore di sezione per contrassegnare i limiti della cartella gruppo di layer.
type: docs
weight: 3410
...
Il layer divisore di sezione per contrassegnare i limiti della cartella (gruppo di layer).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Ottiene un valore che indica se questa istanza è visibile nel gruppo (se il layer non è nel gruppo significa gruppo radice). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Ottiene il[`LayerGroup`](../layergroup/) è legato a questo`SectionDividerLayer` istanza. |
