...
description: Il livello divisore di sezione per contrassegnare i limiti della cartella gruppo di livelli.
type: docs
weight: 3350
url: /it/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
## SectionDividerLayer class

Il livello divisore di sezione per contrassegnare i limiti della cartella (gruppo di livelli).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup) { get; } | Ottiene un valore che indica se questa istanza è visibile nel gruppo (se il livello non è nel gruppo significa gruppo radice). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup)() | Ottiene il[`LayerGroup`](../layergroup) questo è correlato a questo[`SectionDividerLayer`](../sectiondividerlayer) istanza. |
