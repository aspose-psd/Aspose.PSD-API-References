...
description: LiFeDataSource proprietà. Ottiene lo stato della licenza stock Adobe se disponibile per le librerie Adobe Photoshop CC.
type: docs
weight: 30
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestocklicensestate/
---
## LiFeDataSource.AdobeStockLicenseState property

Ottiene lo stato della licenza stock Adobe, se disponibile, per le librerie Adobe® Photoshop® CC.
...
Lo stato della licenza Adobe Stock o una stringa vuota se non è disponibile.
