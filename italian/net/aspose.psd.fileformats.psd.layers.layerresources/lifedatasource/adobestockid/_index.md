...
description: LiFeDataSource proprietà. Ottiene o imposta la libreria grafica AdobeStockId per Adobe Photoshop CC Libraries.
type: docs
weight: 20
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

Ottiene o imposta la libreria grafica AdobeStockId, per Adobe® Photoshop® CC Libraries.
...
La libreria grafica Adobe Stock Identifier.

### Eccezioni

| eccezione | condizione |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Non puoi accedere alla proprietà AdobeStockId, è disponibile solo per l'origine dati liFE quando IsLibrary è true |
