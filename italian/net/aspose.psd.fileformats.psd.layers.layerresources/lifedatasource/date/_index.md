...
description: Ottiene o imposta la data e lora dellultima scrittura del file esterno nellorigine dati LiFE della risorsa PSD LnkE.
type: docs
weight: 40
...
L'ultima data e ora di scrittura del file esterno.

### Eccezioni

| eccezione | condizione |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | Non è possibile accedere alla proprietà Date, è disponibile solo per l'origine dati liFE con versione 3 o successiva |
