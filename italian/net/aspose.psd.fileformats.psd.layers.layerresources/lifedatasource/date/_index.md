...
description: LiFeDataSource proprietà. Ottiene o imposta la data e lora dellultima scrittura del file esterno nellorigine dati LiFE della risorsa PSD LnkE.
type: docs
weight: 40
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
## LiFeDataSource.Date property

Ottiene o imposta la data e l'ora dell'ultima scrittura del file esterno nell'origine dati LiFE della risorsa PSD LnkE.
...
La data e l'ora dell'ultima scrittura del file esterno.

### Eccezioni

| eccezione | condizione |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Non puoi accedere alla proprietà Date, è disponibile solo per l'origine dati liFE con versione 3 o successiva |
