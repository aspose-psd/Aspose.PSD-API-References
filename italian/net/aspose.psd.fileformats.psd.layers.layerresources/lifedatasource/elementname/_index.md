...
description: Ottiene o imposta il nome dellelemento della libreria grafica per Adobe Photoshop CC Libraries.
type: docs
weight: 50
...
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | Non è possibile accedere alla proprietà ElementName, è disponibile solo per l'origine dati liFE quando IsLibrary è true |
