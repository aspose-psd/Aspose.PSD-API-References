...
description: LiFeDataSource proprietà. Ottiene o imposta il nome dellelemento della libreria grafica per Adobe Photoshop CC Libraries.
type: docs
weight: 50
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

Ottiene o imposta il nome dell'elemento della libreria grafica, per Adobe® Photoshop® CC Libraries.
...
Il nome dell'elemento della libreria grafica.

### Eccezioni

| eccezione | condizione |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Non puoi accedere alla proprietà ElementName, è disponibile solo per l'origine dati liFE quando IsLibrary è true |
