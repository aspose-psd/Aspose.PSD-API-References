...
description: LiFeDataSource proprietà. Ottiene o imposta il riferimento allelemento della libreria grafica per Adobe Photoshop CC Libraries.
type: docs
weight: 60
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
## LiFeDataSource.ElementRef property

Ottiene o imposta il riferimento all'elemento della libreria grafica, per Adobe® Photoshop® CC Libraries.
...
Il riferimento all'elemento della libreria grafica.

### Eccezioni

| eccezione | condizione |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Non puoi accedere alla proprietà ElementRef, è disponibile solo per l'origine dati liFE quando IsLibrary è true |
