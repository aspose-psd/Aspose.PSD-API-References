...
description: Definisce lenumerazione PlacedLayerType per la risorsa PlLd del livello posizionato.
type: docs
weight: 2910
...
| Vector | `1` | Il vettore posizionato tipo di livello |
| Raster | `2` | Il tipo di livello posizionato raster |
| ImageStack | `3` | Il tipo di livello posizionato nella pila di immagini |
