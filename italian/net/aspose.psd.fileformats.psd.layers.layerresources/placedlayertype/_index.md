...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.PlacedLayerType enum. Definisce lenumerazione PlacedLayerType per la risorsa PlLd del livello posizionato.
type: docs
weight: 2930
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/placedlayertype/
---
## PlacedLayerType enumeration

Definisce l'enumerazione PlacedLayerType per la risorsa PlLd del livello posizionato.
...
| --- | --- | --- |
| Unknown | `0` | Il tipo di livello posizionato sconosciuto |
| Vector | `1` | Il tipo di livello vettoriale posizionato |
| Raster | `2` | Il tipo di livello posizionato raster |
| ImageStack | `3` | La pila di immagini ha posizionato il tipo di livello |
