...
description: PtFlResource proprietà. Ottiene o imposta un valore che indica se questa istanza è collegata al layer.
type: docs
weight: 30
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/ptflresource/islinkedwithlayer/
---
## PtFlResource.IsLinkedWithLayer property

Ottiene o imposta un valore che indica se questa istanza è collegata al layer.
...
`VERO` se questa istanza è collegata al livello; Altrimenti,`falso` .
