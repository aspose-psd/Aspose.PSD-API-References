...
description: Classe VmskResource. Questa risorsa contiene informazioni sulla maschera di livello vettoriale
type: docs
weight: 3300
...
| Nome | Descrizione |
| --- | --- |
| [VmskResource](vmskresource#constructor)() | Inizializza una nuova istanza di[`VmskResource`](../vmskresource) classe. |
| [VmskResource](vmskresource#constructor_1)(byte[]) | Inizializza una nuova istanza di[`VmskResource`](../vmskresource) classe. |
...
| Nome | Descrizione |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/vmskresource/typetoolkey) | Il tipo di chiave info strumento. |

### Esempi

Nell'esempio seguente viene illustrato il supporto del caricamento delle risorse VmskResource. Come funziona la modifica dei percorsi.
