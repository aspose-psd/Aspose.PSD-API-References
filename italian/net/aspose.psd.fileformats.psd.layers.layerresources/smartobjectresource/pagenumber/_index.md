...
description: SmartObjectResource proprietà. Ottiene o imposta il numero di pagina dei dati del livello oggetto avanzato nel file PSD.
type: docs
weight: 150
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/pagenumber/
---
## SmartObjectResource.PageNumber property

Ottiene o imposta il numero di pagina dei dati del livello oggetto avanzato nel file PSD.
...
Il numero di pagina dei dati del livello oggetto avanzato.
