...
description: SmartObjectResource proprietà. Ottiene o imposta il numero totale di pagine dei dati del livello oggetto avanzato nel file PSD.
type: docs
weight: 220
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/totalpages/
---
## SmartObjectResource.TotalPages property

Ottiene o imposta il numero totale di pagine dei dati del livello oggetto avanzato nel file PSD.
...
Il numero totale di pagine dei dati del livello oggetto avanzato.
