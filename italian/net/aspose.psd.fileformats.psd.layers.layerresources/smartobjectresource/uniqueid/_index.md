...
description: Ottiene o imposta lidentificatore univoco globale dei dati del livello delloggetto intelligenteSmartObjectResourceaspose.psd.fileformats.psd.layers.layerresources/smartobjectresource nellimmagine PSD.
type: docs
weight: 240
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

Ottiene o imposta l'identificatore univoco globale dei dati del livello dell'oggetto intelligente[`SmartObjectResource`](../../smartobjectresource) nell'immagine PSD.
...
L'identificatore univoco globale dei dati del livello dell'oggetto intelligente[`SmartObjectResource`](../../smartobjectresource) .
