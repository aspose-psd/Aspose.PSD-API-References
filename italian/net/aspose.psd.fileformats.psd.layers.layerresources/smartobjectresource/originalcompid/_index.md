...
description: SmartObjectResource proprietà. Ottiene lID originale del Comp attualmente selezionato per il documento secondario che sarà 1 se non ne viene selezionato nessuno. Questa proprietà ottiene lidentificatore di selezione Comp del livello originale per il livello oggetto avanzato nel file PSD. Composizioni di livelli in Oggetti avanzati
type: docs
weight: 140
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/originalcompid/
---
## SmartObjectResource.OriginalCompId property

Ottiene l'ID originale del Comp attualmente selezionato per il documento secondario, che sarà -1 se non ne viene selezionato nessuno. Questa proprietà ottiene l'identificatore di selezione Comp del livello originale per il livello oggetto avanzato nel file PSD. [Composizioni di livelli in Oggetti avanzati](https://helpx.adobe.com/photoshop/using/layer-comps.html)
...
L'ID originale della composizione attualmente selezionata per il documento figlio nell'immagine PSD, che sarà -1 se non ne viene selezionato nessuno.
