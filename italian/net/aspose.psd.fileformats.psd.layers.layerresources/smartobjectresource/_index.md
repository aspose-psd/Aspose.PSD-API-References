...
description: Definisce la classe SmartObjectResource che contiene informazioni su un livello di oggetti intelligenti in un file PSD. Is è la classe base per le risorse Sold e Sole utilizzata per supportare i livelli di oggetti intelligenti nelle immagini di Adobe Photoshop.
type: docs
weight: 2960
...
Definisce la classe SmartObjectResource che contiene informazioni su un livello di oggetti intelligenti in un file PSD. Is è la classe base per le risorse Sold e Sole utilizzata per supportare i livelli di oggetti intelligenti nelle immagini di Adobe® Photoshop®.
