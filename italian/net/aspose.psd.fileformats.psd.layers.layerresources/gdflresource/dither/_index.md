...
description: GdFlResource proprietà. Ottiene o imposta un valore che indica se thisGdFlResource è dither.
type: docs
weight: 60
...
Ottiene o imposta un valore che indica se this[`GdFlResource`](../) è dither.
...
`VERO` se retino; Altrimenti,`falso` .
