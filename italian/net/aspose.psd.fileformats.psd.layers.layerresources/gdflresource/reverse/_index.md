...
description: GdFlResource proprietà. Ottiene o imposta un valore che indica se thisGdFlResource è inverso.
type: docs
weight: 140
...
Ottiene o imposta un valore che indica se this[`GdFlResource`](../) è inverso.
