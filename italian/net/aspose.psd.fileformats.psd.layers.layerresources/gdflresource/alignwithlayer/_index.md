...
description: GdFlResource proprietà. Ottiene o imposta un valore che indica se allinea al livello.
type: docs
weight: 20
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/gdflresource/alignwithlayer/
---
## GdFlResource.AlignWithLayer property

Ottiene o imposta un valore che indica se [allinea al livello].
...
`VERO` if [allineare con il livello]; Altrimenti,`falso` .
