...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LinkDataSourceType enum. Definisce lenumerazione LinkDataSourceType per le origini dati nella risorsa collegamento PSD.
type: docs
weight: 2700
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasourcetype/
---
## LinkDataSourceType enumeration

Definisce l'enumerazione LinkDataSourceType per le origini dati nella risorsa collegamento PSD.
...
| --- | --- | --- |
| None | `0` | La risorsa collegamento vuoto. |
| liFD | `1` | Il file collegato incorporato data |
| liFE | `2` | Il file collegato esterno data |
| liFA | `3` | L'alias del file collegato data |
