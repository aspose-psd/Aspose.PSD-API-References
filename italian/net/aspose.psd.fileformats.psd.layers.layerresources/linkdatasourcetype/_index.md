...
description: Definisce lenumerazione LinkDataSourceType per le origini dati nella risorsa di collegamento PSD.
type: docs
weight: 2680
...
| --- | --- | --- |
| None | `0` | La risorsa di collegamento vuota. |
| liFD | `1` | I dati del file collegato incorporato |
| liFE | `2` | I dati del file collegato esterno |
| liFA | `3` | Il file collegato alias data |
