...
description: Definisce la classe SoLeResource che contiene informazioni su un livello di oggetti intelligenti in un file PSD. Viene utilizzato per supportare livelli di oggetti intelligenti con collegamenti a file esterni nelle immagini di Adobe Photoshop.
type: docs
weight: 3000
url: /it/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
## SoLeResource class

Definisce la classe SoLeResource che contiene informazioni su un livello di oggetti intelligenti in un file PSD. Viene utilizzato per supportare livelli di oggetti intelligenti con collegamenti a file esterni nelle immagini di Adobe® Photoshop®.
...
| Nome | Descrizione |
| --- | --- |
| [SoLeResource](soleresource#constructor)() | Inizializza una nuova istanza di[`SoLeResource`](../soleresource) classe. |
| [SoLeResource](soleresource#constructor_1)(Guid, bool, bool) | Inizializza una nuova istanza di[`SoLeResource`](../soleresource) classe. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/key) { get; } | Ottiene la chiave della risorsa del livello di oggetti intelligenti Sole. |
...
| Nome | Descrizione |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey) | Il tipo di chiave info strumento: 'SoLE'. |
