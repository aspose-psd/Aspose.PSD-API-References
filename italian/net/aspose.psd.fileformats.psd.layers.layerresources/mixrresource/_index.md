...
description: Classe MixrResource. Risorsa del livello di regolazione del mixer dei canali
type: docs
weight: 2800
...
| Nome | Descrizione |
| --- | --- |
| [MixrResource](mixrresource#constructor)() | Inizializza una nuova istanza di[`MixrResource`](../mixrresource) class. La specifica del formato PSD contiene la seguente descrizione: 2 Version ( = 1) 2 Monochrome 20 colori RGB o CMYK più una costante per le impostazioni del mixer. 4 * 2 byte di colore con 2 byte di costante. |
| [MixrResource](mixrresource#constructor_1)(byte[]) | Inizializza una nuova istanza di[`MixrResource`](../mixrresource) class. La specifica del formato PSD contiene la seguente descrizione: 2 Version ( = 1) 2 Monochrome 20 colori RGB o CMYK più una costante per le impostazioni del mixer. 4 * 2 byte di colore con 2 byte di costante. |
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.layerresources/mixrresource/monochrome) { get; set; } | Ottiene o imposta un valore che indica se questo[`MixrResource`](../mixrresource) è monocromatico. |
...
| Nome | Descrizione |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/mixrresource/typetoolkey) | Il tipo di chiave info strumento. |
