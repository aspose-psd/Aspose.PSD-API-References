...
description: Il blocco di risorse.
type: docs
weight: 3550
...
| Nome | Descrizione |
| --- | --- |
| enum [ResourceBlockState](resourceblock.resourceblockstate) | Rappresenta lo stato del blocco della risorsa. |
