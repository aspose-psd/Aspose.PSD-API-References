...
| --- | --- | --- |
| Left | `0` | Il testo allineato a sinistra. |
| Right | `1` | Il testo allineato a destra. |
| Center | `2` | Il testo centrale. |

### Esempi

Il codice seguente mostra il supporto dell'enumerazione MotivazioneMode per impostare l'allineamento del testo per porzioni di testo.
