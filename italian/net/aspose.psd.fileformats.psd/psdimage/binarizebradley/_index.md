...
description: PsdImage metodo. Binarizzazione di unimmagine utilizzando lalgoritmo di soglia adattiva di Bradley utilizzando la soglia integrale dellimmagine
type: docs
weight: 470
url: /it/net/aspose.psd.fileformats.psd/psdimage/binarizebradley/
---
## BinarizeBradley(double, int) {#binarizebradley_1}

Binarizzazione di un'immagine utilizzando l'algoritmo di soglia adattiva di Bradley utilizzando la soglia integrale dell'immagine
