...
description: Crea un nuovo livello di oggetti intelligenti copiando quello di origine.
type: docs
weight: 30
...
| --- | --- | --- |
| sourceLayer | SmartObjectLayer | Il livello sorgente. |
...
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception) | È possibile sostituire solo un oggetto intelligente incorporato. |
