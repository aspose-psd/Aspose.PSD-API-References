...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider classe. Definisce il fornitore di oggetti intelligenti che consente di ottenere/impostare origini dati dalle risorse di collegamento globale del file PSD e dai relativi contenuti.
type: docs
weight: 4000
url: /it/net/aspose.psd.fileformats.psd/smartobjectprovider/
---
## SmartObjectProvider class

Definisce il fornitore di oggetti intelligenti che consente di ottenere/impostare origini dati dalle risorse di collegamento globale del file PSD e dai relativi contenuti.
...
| Nome | Descrizione |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Converte i livelli in un oggetto intelligente incorporato. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Converte i livelli in un oggetto intelligente incorporato. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Incorpora tutti gli oggetti intelligenti collegati nell'immagine. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Crea un nuovo livello di oggetti intelligenti copiando quello di origine. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Aggiorna il contenuto di tutti gli oggetti intelligenti modificati nell'immagine. |
