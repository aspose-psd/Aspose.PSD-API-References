...
description: Ottiene o imposta un valore che indica se questoStrokeEffectaspose.psd.fileformats.psd.layers.layereffects/strokeeffect mescolerà il tratto al contenuto del livello corrente.
type: docs
weight: 60
...
Ottiene o imposta un valore che indica se questo[`StrokeEffect`](../../strokeeffect) mescolerà il tratto al contenuto del livello corrente.
