...
description: Ottiene o imposta la posizione delleffetto tratto per controllare lallineamento del tratto al contenuto del livello PSD. Il valore può essereInside per disegnare un tratto allinterno del contenuto del livello PSD oOutside per disegnare un tratto intorno al contenuto del livello PSD eCenter per disegnare il tratto sia allinterno che allesterno.
type: docs
weight: 70
