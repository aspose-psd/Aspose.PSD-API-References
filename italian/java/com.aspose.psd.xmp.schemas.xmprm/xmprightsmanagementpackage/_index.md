...
type: docs
weight: 10
url: /it/java/com.aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/
---
...
| --- | --- |
| [XmpRightsManagementPackage()](#XmpRightsManagementPackage--) | Inizializza una nuova istanza della  XmpRightsManagementPackage  classe. |
## Metodi
...
| [setCertificate(String certificate)](#setCertificate-java.lang.String-) | Imposta il certificato. |
| [setMarkedAsRightManagement(boolean value)](#setMarkedAsRightManagement-boolean-) | Segna come contenuto a gestione dei diritti |
| [setOwners(String[] owners)](#setOwners-java.lang.String---) | Imposta i proprietari. |
| [setUsageTerms(LangAlt usageTerms)](#setUsageTerms-com.aspose.psd.xmp.LangAlt-) | Imposta i termini di utilizzo. |
| [setValue(String key, IXmlValue value)](#setValue-java.lang.String-com.aspose.psd.xmp.IXmlValue-) | Imposta il valore. |
| [setWebStatement(String webStatementUrl)](#setWebStatement-java.lang.String-) | Imposta la dichiarazione web. |
...
Inizializza una nuova istanza della  XmpRightsManagementPackage  classe.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| certificato | java.lang.String | Il certificato. |
...
Segna come contenuto a gestione dei diritti

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | se impostato su  true  questo è una risorsa a gestione dei diritti. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| proprietari | java.lang.String[] | I proprietari. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| usageTerms | [LangAlt](../../com.aspose.psd.xmp/langalt) | I termini di utilizzo. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| webStatementUrl | java.lang.String | L'URL della dichiarazione web. |
