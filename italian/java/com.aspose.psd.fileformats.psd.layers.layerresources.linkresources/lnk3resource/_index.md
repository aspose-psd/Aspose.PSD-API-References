...
description: "Definisce la classe che contiene informazioni su un file incorporato nell'immagine PSD a 32 bit per canale."
type: docs
weight: 16
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource/
---
...
Definisce la classe che contiene informazioni su un file incorporato nel formato PSD immagine a 32 bit per canale. La risorsa di collegamento può contenere diverse istanze di [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource) che possono essere accessibili tramite indicizzatore.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [Lnk3Resource()](#Lnk3Resource--) | Inizializza una nuova istanza della classe [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource). |
## Campi
...
Inizializza una nuova istanza della classe [Lnk3Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk3resource).
