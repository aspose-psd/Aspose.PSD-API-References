...
description: "Definisce la classe che contiene informazioni su file incorporati nell'immagine in formato PSD."
type: docs
weight: 15
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
Definisce la classe che contiene informazioni sui file incorporati nell'immagine in formato PSD. La risorsa di collegamento può contenere diverse istanze di  LiFdDataSource  che possono essere accessibili tramite l'indicizzatore.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | Inizializza una nuova istanza della classe [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) class. |
## Campi
...
| [get_Item(int index)](#get-Item-int-) | Ottiene il  LiFdDataSource  all'indice specificato. |
...
Inizializza una nuova istanza della classe [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) class.
...
### create_internalized(LinkDataSource[] dataSources) {#create-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---}
```
public static Lnk2Resource create_internalized(LinkDataSource[] dataSources)
```
...
**Returns:**
[Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource)
### equals(Object arg0) {#equals-java.lang.Object-}
```
...
Ottiene il  LiFdDataSource  all'indice specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| indice | int | L'indice. Valore: Il LiFdDataSource. |
