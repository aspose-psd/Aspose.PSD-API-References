...
description: "Definisce la classe LnkeResource che contiene informazioni su file collegati esterni o risorse nell'immagine in formato PSD."
type: docs
weight: 17
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Definisce la classe LnkeResource che contiene informazioni sui file o risorse esterne collegate nell'immagine in formato PSD. La risorsa di collegamento può contenere diverse istanze di [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) che possono essere accessibili tramite indicizzatore. Questa è una parte dell'API di Manipolazione del Formato File PSD che aiuta a modificare i file Adobe® Photoshop® programmaticamente
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Inizializza una nuova istanza della classe [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) class. |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Inizializza una nuova istanza della classe [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) class. |
## Campi
...
| [get_Item(int index)](#get-Item-int-) | Ottiene il [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource) all'indice specificato. |
...
Inizializza una nuova istanza della classe [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) class.
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Le fonti dei dati. |
...
Ottiene il [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource) all'indice specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | L'indice. Valore: Il [LiFeDataSource](../../com.aspose.psd.fileformats/psd.layers.layerresources.linkresources/lifedatasource). |
