...
description: "Definisce la classe SmartObjectLayer che contiene l'oggetto smart incorporato nel file PSD o collegato nel file esterno."
type: docs
weight: 10
url: /it/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Definisce la classe SmartObjectLayer che contiene oggetti intelligenti incorporati nel file PSD o oggetti intelligenti collegati in un file esterno. Con Smart Objects, è possibile: Eseguire trasformazioni non distruttive. È possibile scalare, ruotare, inclinare, distorcere, trasformare in prospettiva o deformare un livello senza perdere i dati o la qualità dell'immagine originale perché le trasformazioni don\\ufffdt influenzano i dati originali. Lavorare con dati vettoriali, come grafica vettoriale da Illustrator, che altrimenti verrebbero rasterizzati. Eseguire filtraggio non distruttivo. È possibile modificare i filtri applicati agli Smart Objects in qualsiasi momento. Modificare un Smart Object e aggiornare automaticamente tutte le sue istanze collegate. Applicare una maschera di livello che\\ufffds è collegata o scollegata dal livello Smart Object. Provare vari design con immagini segnaposto a bassa risoluzione che successivamente si sostituiranno con le versioni finali. In Adobe\\ufffd Photoshop\\ufffd, è possibile incorporare il contenuto di un'immagine in un documento PSD. Maggiori informazioni qui:   Un livello con un smart object incorporato contiene risorse placed (PlLd) e SoLd con proprietà dello smart object. La risorsa PlLd può essere presente da sola per versioni PSD precedenti alla 10. Queste risorse contengono UniqueId del LiFdDataSource nella risorsa globale Lnk2Resource con il nome file incorporato e altri parametri, inclusi i contenuti del file incorporato nel formato originale come array di byte.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Inizializza una nuova istanza della classe [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [BlendSignature](#BlendSignature) | Rappresenta la firma della modalità di fusione. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Il messaggio delle risorse sia placed che smart object trovate |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Il messaggio Puoi copiare solo un smart object incorporato |
| [LayerHeaderSize](#LayerHeaderSize) | La dimensione dell'intestazione del livello. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Non è stato trovato alcun messaggio di risorsa posizionata o smart object. |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Il messaggio di indici di risorsa posizionata errati. |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Converte questo smart object incorporato in uno smart object collegato. |
...
| [duplicateLayer()](#duplicateLayer--) | Crea un nuovo livello smart object copiando questo. |
| [embedLinked()](#embedLinked--) | Incorpora lo smart object collegato in questo livello. |
| [equals(Object obj)](#equals-java.lang.Object-) | Determina se l'Object specificato è uguale a questa istanza. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Esporta i contenuti incorporati o collegati in un file. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Ottiene o imposta la deformazione di rendering o utilizza l'immagine PS |
...
| [getContentType()](#getContentType--) | Ottiene il tipo del contenuto del livello dell'oggetto smart. |
| [getContents()](#getContents--) | Ottiene o imposta i contenuti del livello smart object. |
| [getContentsBounds()](#getContentsBounds--) | Ottiene o imposta i limiti del contenuto dello smart object. |
| [getContentsSource()](#getContentsSource--) | Ottiene o imposta la sorgente del contenuto dello smart object. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Ottiene o imposta l'ultima dimensione dell'immagine da deformare. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Ottiene o imposta il quadrilatero originale. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Ottiene gli indici delle risorse del livello posizionato e smart e la risorsa posizionata corretta. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Ottiene la risorsa del livello posizionato. |
...
| [getSmartFilters()](#getSmartFilters--) | Ottiene i filtri smart. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Ottiene o imposta il quadrilatero di trasformazione. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Ottiene le funzioni che aiutano con la deformazione |
| [getWarpSettings()](#getWarpSettings--) | Ottiene o imposta i parametri di deformazione che sono stati impostati o ottenuti dalla risorsa (predefinito) |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Ottiene i contenuti immagine incorporati o collegati del livello smart object. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Crea un nuovo livello smart object copiando questo. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Invoca quando il contenitore di questo [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) è stato impostato. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Ricollega lo smart object collegato a un nuovo file. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Sostituisce i contenuti dello smart object incorporati nel livello smart object. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Sostituisce i contenuti dello smart object incorporati nel livello smart object. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Sostituisce i contenuti con un file. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Sostituisce i contenuti con un file. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Sostituisce i contenuti con un file. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Sostituisce i contenuti con un file. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Ridimensiona i dati dei canali |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Ottiene o imposta la deformazione di rendering o utilizza l'immagine PS |
...
| [setContents(byte[] value)](#setContents-byte---) | Ottiene o imposta i contenuti del livello smart object. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Ottiene o imposta i limiti del contenuto dello smart object. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Ottiene o imposta la sorgente del contenuto dello smart object. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Ottiene o imposta l'ultima dimensione dell'immagine da deformare. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Ottiene o imposta il quadrilatero originale. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Ottiene il provider dell'oggetto intelligente. |
| [setTop(int value)](#setTop-int-) | Ottiene o imposta la posizione superiore del livello. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Ottiene o imposta il quadrilatero di trasformazione. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Ottiene o imposta i parametri di deformazione che sono stati impostati o ottenuti dalla risorsa (predefinito) |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Aggiorna l'identificatore della fonte dati. |
| [updateModifiedContent()](#updateModifiedContent--) | Aggiorna la cache immagine del livello smart object con il contenuto modificato. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Aggiorna la cache immagine del livello smart object con contenuto modificato. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Aggiorna le risorse posizionate / smart quando placedResource viene modificata o quando è necessaria la conversione. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | È un wrapper per "IWarpSupport" per aggiornare l'anteprima del livello. |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza della classe [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Il flusso di elementi |
...
Il messaggio delle risorse sia placed che smart object trovate
...
Il messaggio Puoi copiare solo un smart object incorporato
...
Non è stato trovato alcun messaggio di risorsa posizionata o smart object.
...
Il messaggio di indici di risorsa posizionata errati.
...
Converte questo smart object incorporato in uno smart object collegato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| linkedPath | java.lang.String | Il percorso collegato. |
...
Crea un nuovo livello di oggetto intelligente copiando questo. Nota che per gli oggetti intelligenti incorporati l'immagine incorporata è condivisa. Se vuoi copiare l'immagine incorporata usa il metodo [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy).
...
Incorpora lo smart object collegato in questo livello.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| filePath | java.lang.String | Il percorso del file di esportazione. |
...
Ottiene o imposta la deformazione di rendering o utilizza l'immagine PS
...
Ottiene il tipo del contenuto del livello di oggetto intelligente. Il contenuto dell'oggetto intelligente incorporato è il file immagine grezzo incorporato: LiFdDataSource.Data. Il contenuto dell'oggetto intelligente collegato è il contenuto grezzo del file immagine collegato, se disponibile: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Non supportiamo il caricamento dalla Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library quando LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) è true. Per i file di collegamento regolari, inizialmente usiamo LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) per cercare il file in modo relativo al percorso dell'immagine sorgente DataStreamSupporter.SourceImagePath, se non è disponibile controlliamo LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), se ancora non lo troviamo cerchiamo il file di collegamento nella stessa directory dell'immagine: DataStreamSupporter.SourceImagePath.

Valore: Il tipo del contenuto del livello di oggetto intelligente.
...
Ottiene o imposta i contenuti del livello di oggetto intelligente. Il contenuto dell'oggetto intelligente incorporato è il file immagine grezzo incorporato: LiFdDataSource.Data e le sue proprietà. Il contenuto dell'oggetto intelligente collegato è il contenuto grezzo del file immagine collegato, se disponibile, e le sue proprietà: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Non supportiamo il caricamento dalla Adobe\\ufffd Photoshop\\ufffd \\ufffd\\ufffd Graphics Library quando LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) è true. Per i file di collegamento regolari, inizialmente usiamo LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)) per cercare il file in modo relativo al percorso dell'immagine sorgente DataStreamSupporter.SourceImagePath, se non è disponibile controlliamo LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)), se ancora non lo troviamo cerchiamo il file di collegamento nella stessa directory dell'immagine: DataStreamSupporter.SourceImagePath.
...
Ottiene o imposta i limiti del contenuto dello smart object.

Valore: I limiti dell'oggetto intelligente.
...
Ottiene o imposta la sorgente del contenuto dello smart object.

Valore: La fonte dati dell'oggetto intelligente.
...
Ottiene o imposta l'ultima dimensione dell'immagine da deformare.
...
Ottiene o imposta il quadrilatero originale.

Valore: Il quadrilatero originale.
...
Ottiene gli indici delle risorse del livello posizionato e smart e la risorsa posizionata corretta.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Le risorse. |
| placedResourceIndex | int[] | Indice della risorsa posizionata. |
| smartResourceIndex | int[] | Indice della risorsa intelligente. |
...
Ottiene la risorsa del livello posizionato.
...
Ottiene o imposta il quadrilatero di trasformazione.

Valore: il quadrilatero di trasformazione.
...
Ottiene le funzioni che aiutano con la deformazione
...
Ottiene o imposta i parametri di deformazione che sono stati impostati o ottenuti dalla risorsa (predefinito)
...
Ottiene i contenuti immagine incorporati o collegati del livello smart object.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Le opzioni. |
...
Crea un nuovo livello oggetto intelligente copiando questo. Riproduce Layer -> Smart Objects -> New Smart Object tramite la funzionalità Copia di Adobe� Photoshop�. Nota che è abilitato solo per gli oggetti intelligenti incorporati perché anche l'immagine incorporata viene copiata. Se desideri condividere l'immagine incorporata, usa il metodo [.duplicateLayer](../../null/\#duplicateLayer).
...
Invoca quando il contenitore di questo [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) è stato impostato.
...
Ricollega l'oggetto intelligente collegato a un nuovo file. Non è necessario chiamare il metodo UpdateModifiedContent successivamente.
...
Sostituisce i contenuti dello smart object incorporati nel livello smart object.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | L'immagine. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | L'immagine. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Le impostazioni di risoluzione. Se null, verrà utilizzata la risoluzione dell'immagine. |
...
Sostituisce il contenuto con un file. Non è necessario chiamare il metodo UpdateModifiedContent successivamente.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Il percorso collegato. |
| isReplaceOnlyThis | boolean | Il flag indica se sostituire il contenuto da questo Smart Layer o da tutti gli Smart Layer con questo contenuto. |
...
Ridimensiona i dati dei canali
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Aggiorna l'identificatore della fonte dati.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | L'identificatore della fonte dati. |
...
Aggiorna la cache immagine del livello smart object con il contenuto modificato.
...
Aggiorna la cache immagine del livello smart object con contenuto modificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | L'immagine. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | La risoluzione. |
| skipBoundsUpdate | boolean | se impostato su true [ignora aggiornamento dei limiti]. |
...
Aggiorna le risorse posizionate / smart quando placedResource viene modificata o quando è necessaria la conversione.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| toEmbedded | boolean | se impostato su true converte in una risorsa incorporata se necessario, altrimenti in una collegata. |
...
È un wrapper per "IWarpSupport" per aggiornare l'anteprima del livello.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Pixel e dimensioni della nuova immagine di anteprima |
