...
description: "Valori fourCC compressi per il metodo di interpolazione del gradiente di Photoshop."
type: docs
weight: 18
url: /it/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
Valori fourCC impacchettati per il metodo di interpolazione del gradiente Photoshop. Chiave del descrittore: "gradientsInterpolationMethod"
## Campi

| Campo | Descrizione |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 Classico (predefinito legacy quando la chiave è assente). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 Lineare (nota lo spazio finale). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 Percepito. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 Liscio. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 Strisce. |
## Metodi
...
'Gcls' \\u2014 Classico (predefinito legacy quando la chiave è assente).
...
'Lnr ' \\u2014 Lineare (nota lo spazio finale).
