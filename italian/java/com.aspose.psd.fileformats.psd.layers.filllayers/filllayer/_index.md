...
description: "Livello di riempimento."
type: docs
weight: 10
url: /it/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
Livello di riempimento. Riempimento colore, Riempimento gradiente o Livello di riempimento pattern che differisce per FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#setFillSettings-IFillSettings-))
## Campi
...
| [createInstance(int fillType)](#createInstance-int-) | Crea una nuova istanza della classe [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) in base al tipo di riempimento. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | Restituisce il processore di rendering per [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
| [getFillOpacity()](#getFillOpacity--) | Ottiene o imposta l'opacità del riempimento. |
| [getFillSettings()](#getFillSettings--) | Restituisce le impostazioni del riempimento. |
...
| [setFillSettings(IFillSettings value)](#setFillSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Restituisce le impostazioni del riempimento. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Aggiorna i dati dei pixel del livello di riempimento in base alle impostazioni effettive di [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings). |
...
Crea una nuova istanza della classe [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) in base al tipo di riempimento.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fillType | int | Il tipo di livello di riempimento. |
...
Restituisce il processore di rendering per [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | L'immagine su cui eseguire il rendering. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | I limiti da elaborare. |

**Returns:**
com.aspose.internal.IPartialProcessor - Restituisce il processore di rendering per [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
Restituisce le impostazioni del riempimento.
...
Restituisce il tipo di riempimento.

Valore: Il tipo del riempimento.
...
Aggiorna i dati dei pixel del livello di riempimento in base alle impostazioni effettive di [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings).
