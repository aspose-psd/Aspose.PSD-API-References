...
type: docs
weight: 12
url: /it/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | Inizializza una nuova istanza della classe [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource). |
## Campi
...
| [getUnit()](#getUnit--) | Ottiene o imposta le unità del bordo. |
| [getWidth()](#getWidth--) | Ottiene o imposta la larghezza del bordo. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | Ottiene o imposta le unità del bordo. |
| [setWidth(double value)](#setWidth-double-) | Ottiene o imposta la larghezza del bordo. |
| [toString()](#toString--) |  |
...
Inizializza una nuova istanza della classe [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource).
