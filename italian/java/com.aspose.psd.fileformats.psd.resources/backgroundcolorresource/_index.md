...
description: "La risorsa con le informazioni del bordo delle impostazioni di stampa dell'immagine."
type: docs
weight: 11
url: /it/java/com.aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
La risorsa con le informazioni del bordo delle impostazioni di stampa dell'immagine.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [BackgroundColorResource()](#BackgroundColorResource--) | Inizializza una nuova istanza della classe [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource). |
## Campi
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | Ottiene o imposta il colore di sfondo. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | Ottiene o imposta il colore di sfondo. |
| [setColorSpace(int value)](#setColorSpace-int-) | Ottiene o imposta uno spazio colore. |
...
Inizializza una nuova istanza della classe [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource).
...
Ottiene o imposta uno spazio colore.

Valore: Lo spazio colore di sfondo.
