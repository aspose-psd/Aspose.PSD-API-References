...
description: "Risorsa dei flag di stampa"
type: docs
weight: 30
url: /it/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
Risorsa dei flag di stampa
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | Inizializza una nuova istanza della classe [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource). |
## Campi
...
| [getBleedScale()](#getBleedScale--) | Ottiene o imposta la scala di sbordamento. |
| [getBleedWidth()](#getBleedWidth--) | Ottiene o imposta la larghezza dello sbordamento. |
| [getCenterCropMark()](#getCenterCropMark--) | Ottiene o imposta il marcatore di ritaglio centrale. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | Ottiene o imposta la scala di sbordamento. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | Ottiene o imposta la larghezza dello sbordamento. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | Ottiene o imposta il marcatore di ritaglio centrale. |
...
Inizializza una nuova istanza della classe [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource).
...
Ottiene o imposta la scala di sbordamento.

Valore: La scala di sbordamento.
...
Ottiene o imposta la larghezza dello sbordamento.

Valore: La larghezza dello sbordamento.
...
Ottiene o imposta il marcatore di ritaglio centrale.

Valore: Il marcatore di ritaglio centrale.
