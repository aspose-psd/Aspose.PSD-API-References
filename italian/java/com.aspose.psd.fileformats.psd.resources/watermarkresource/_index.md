...
description: "Risorsa filigrana"
type: docs
weight: 42
url: /it/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | Inizializza una nuova istanza della classe [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource). |
## Campi
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | Ottiene o imposta un valore che indica se questa istanza è una filigrana. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | Ottiene o imposta un valore che indica se questa istanza è una filigrana. |
| [toString()](#toString--) |  |
...
Inizializza una nuova istanza della classe [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource).
...
Ottiene o imposta un valore che indica se questa istanza è una filigrana.

Valore:  true  se questa istanza è una filigrana; altrimenti,  false .
