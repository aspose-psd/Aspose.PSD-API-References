...
description: "Risorsa delle informazioni della maschera veloce"
type: docs
weight: 32
url: /it/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Risorsa delle informazioni della maschera veloce
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Inizializza una nuova istanza della classe [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource). |
## Campi
...
| [getChannelId()](#getChannelId--) | Ottiene o imposta l'identificatore del canale. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Ottiene o imposta un valore che indica se questa istanza è una maschera vuota. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Salva il blocco risorsa nello stream specificato. |
| [setChannelId(short value)](#setChannelId-short-) | Ottiene o imposta l'identificatore del canale. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Ottiene o imposta un valore che indica se questa istanza è una maschera vuota. |
...
Inizializza una nuova istanza della classe [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource).
...
Valore: l'identificatore del canale.
...
Ottiene o imposta un valore che indica se questa istanza è una maschera vuota.

Valore:  true  se questa istanza è una maschera vuota; altrimenti,  false .
