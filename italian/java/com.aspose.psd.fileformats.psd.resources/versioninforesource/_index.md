...
description: "Risorsa delle informazioni di versione"
type: docs
weight: 41
url: /it/java/com.aspose.psd.fileformats.psd.resources/versioninforesource/
---
...
Risorsa delle informazioni di versione
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [VersionInfoResource()](#VersionInfoResource--) | Inizializza una nuova istanza della classe [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource). |
## Campi
...
| [getFileVersion()](#getFileVersion--) | Ottiene o imposta la versione del file. |
...
| [getReaderName()](#getReaderName--) | Ottiene o imposta il nome del lettore. |
...
| [getWriterName()](#getWriterName--) | Ottiene o imposta il nome dello scrittore. |
| [hasRealMergedData()](#hasRealMergedData--) | Ottiene o imposta un valore che indica se questa istanza contiene dati uniti reali. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Salva il blocco risorsa nello stream specificato. |
| [setFileVersion(long value)](#setFileVersion-long-) | Ottiene o imposta la versione del file. |
...
| [setReaderName(String value)](#setReaderName-java.lang.String-) | Ottiene o imposta il nome del lettore. |
| [setRealMergedData(boolean value)](#setRealMergedData-boolean-) | Ottiene o imposta un valore che indica se questa istanza contiene dati uniti reali. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Ottiene o imposta lo stato del blocco risorsa. |
| [setVersion(long value)](#setVersion-long-) | Ottiene o imposta la versione. |
| [setWriterName(String value)](#setWriterName-java.lang.String-) | Ottiene o imposta il nome dello scrittore. |
| [toString()](#toString--) |  |
...
Inizializza una nuova istanza della classe [VersionInfoResource](../../com.aspose.psd.fileformats.psd.resources/versioninforesource).
...
Ottiene o imposta il nome dello scrittore.

Valore: Il nome dell'autore.
...
Ottiene o imposta un valore che indica se questa istanza contiene dati uniti reali.

Valore:  true  se questa istanza contiene dati uniti reali; altrimenti,  false .
