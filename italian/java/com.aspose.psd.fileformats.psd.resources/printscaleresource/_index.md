...
description: "Risorsa della scala di stampa"
type: docs
weight: 31
url: /it/java/com.aspose.psd.fileformats.psd.resources/printscaleresource/
---
...
Risorsa della scala di stampa
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PrintScaleResource()](#PrintScaleResource--) | Inizializza una nuova istanza della classe [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource). |
## Campi
...
| [getXLocation()](#getXLocation--) | Ottiene o imposta la posizione x. |
| [getYLocation()](#getYLocation--) | Ottiene o imposta la posizione y. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setScale(float value)](#setScale-float-) | Ottiene o imposta la scala. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | Ottiene o imposta lo stato del blocco risorsa. |
| [setStyle(short value)](#setStyle-short-) | Ottiene o imposta lo stile. |
| [setXLocation(float value)](#setXLocation-float-) | Ottiene o imposta la posizione x. |
| [setYLocation(float value)](#setYLocation-float-) | Ottiene o imposta la posizione y. |
| [toString()](#toString--) |  |
...
Inizializza una nuova istanza della classe [PrintScaleResource](../../com.aspose.psd.fileformats.psd.resources/printscaleresource).
