...
description: "Risorsa dell'elenco URL"
type: docs
weight: 40
url: /it/java/com.aspose.psd.fileformats.psd.resources/urllistresource/
---
...
Risorsa dell'elenco URL
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [UrlListResource()](#UrlListResource--) | Inizializza una nuova istanza della classe [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource). |
## Campi
...
| [getIds()](#getIds--) | Ottiene o imposta gli ID. |
| [getLongs()](#getLongs--) | Ottiene o imposta i valori long. |
...
| [getTexts()](#getTexts--) | Ottiene o imposta i testi. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setIds(int[] value)](#setIds-int---) | Ottiene o imposta gli ID. |
...
| [setLongs(int[] value)](#setLongs-int---) | Ottiene o imposta i valori long. |
...
| [setTexts(String[] value)](#setTexts-java.lang.String---) | Ottiene o imposta i testi. |
| [toString()](#toString--) |  |
...
Inizializza una nuova istanza della classe [UrlListResource](../../com.aspose.psd.fileformats.psd.resources/urllistresource).
...
Ottiene o imposta i valori long.

Valore: I valori long.
