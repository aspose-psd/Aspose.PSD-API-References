...
description: "Risorsa dei dati del contenuto del tratto vettoriale."
type: docs
weight: 13
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
Risorsa dei dati del contenuto del tratto vettoriale.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [VscgResource()](#VscgResource--) | Inizializza una nuova istanza della classe [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource). |
## Campi
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Ottiene o imposta il nome della classe. |
| [getClassName_internalized()](#getClassName-internalized--) | Ottiene o imposta l'identificatore della classe. |
| [getHeader_internalized()](#getHeader-internalized--) | Ottiene o imposta l'intestazione. |
| [getItems()](#getItems--) | Ottiene o imposta gli elementi della struttura. |
| [getKey()](#getKey--) | Ottiene la chiave della risorsa del livello. |
| [getKeyForData()](#getKeyForData--) | Chiave intera che definisce quale tipo di impostazioni di riempimento è memorizzato nella risorsa: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Ottiene o imposta il nome della classe. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Ottiene o imposta l'identificatore della classe. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Ottiene o imposta gli elementi della struttura. |
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Ottiene la chiave intera che definisce quale tipo di impostazioni di riempimento è memorizzato nella risorsa: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Attenzione! Il valore della proprietà KeyForData dovrebbe corrispondere al tipo di impostazioni di riempimento memorizzate nelle strutture Items. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Metodo interno che consente di assegnare la proprietà di sola lettura KeyForData. |
...
Inizializza una nuova istanza della classe [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource).
...
Ottiene o imposta l'identificatore della classe.
...
Ottiene o imposta gli elementi della struttura.

Valore: Gli elementi della struttura.
...
Chiave intera che definisce quale tipo di impostazioni di riempimento è memorizzato nella risorsa: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Metodo interno che consente di assegnare la proprietà di sola lettura KeyForData. Dovrebbe essere usato solo nel caricatore di risorse Vscg quando si assegnano le proprietà della risorsa.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | int | Valore intero per la proprietà KeyForData. |
