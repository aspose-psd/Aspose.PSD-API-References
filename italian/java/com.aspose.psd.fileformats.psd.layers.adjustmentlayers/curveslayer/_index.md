...
description: "Livello di regolazione Curve"
type: docs
weight: 17
url: /it/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | Ottiene il gestore delle curve. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | Ottiene o imposta un valore che indica se questa istanza utilizza il gestore continuo. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | Ottiene o imposta un valore che indica se questa istanza utilizza il gestore discreto. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | Ottiene o imposta un valore che indica se questa istanza utilizza il gestore continuo. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | Ottiene o imposta un valore che indica se questa istanza utilizza il gestore discreto. |
...
Ottiene o imposta un valore che indica se questa istanza utilizza il gestore continuo.

Valore:  true  se questa istanza utilizza il gestore continuo; altrimenti,  false .
...
Ottiene o imposta un valore che indica se questa istanza utilizza il gestore discreto.

Valore:  true  se questa istanza utilizza il gestore discreto; altrimenti,  false .
...
| pixel | int[] | I pixel. |
| start | [Point](../../com.aspose.psd/point) | L'inizio. |
| end | [Point](../../com.aspose.psd/point) | La fine. |
