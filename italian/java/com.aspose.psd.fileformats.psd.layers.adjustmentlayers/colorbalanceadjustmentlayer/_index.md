...
description: "La classe del livello di regolazione Bilanciamento colore."
type: docs
weight: 16
url: /it/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
La classe del livello di regolazione Bilanciamento colore.
## Campi
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Ottiene o imposta il bilanciamento YellowBlue delle ombre. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Applica le correzioni per le ombre, i mezzitoni e le luci attuali all'array int RGB specificato. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Ottiene o imposta il bilanciamento YellowBlue delle ombre. |
...
Ottiene o imposta il bilanciamento YellowBlue delle ombre.
...
Applica le correzioni per le ombre, i mezzitoni e le luci attuali all'array int RGB specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| pixel | int[] | L'array int RGB del colore. |
