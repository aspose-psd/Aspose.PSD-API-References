...
description: "Livello di regolazione Esposizione."
type: docs
weight: 18
url: /it/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
Livello di regolazione Esposizione.
## Campi
...
| [getGammaCorrection()](#getGammaCorrection--) | Ottiene o imposta la correzione gamma. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Ottiene o imposta la correzione gamma. |
...
Ottiene o imposta l'Exposure. Per PS l'intervallo di Exposure è da -20 a +20.
...
Ottiene o imposta la GammaCorrection. Per PS l'intervallo di GammaCorrection è da 9,99 a +0,01.

Valore: La GammaCorrection.
...
Ottiene o imposta l'Offset. Per PS l'intervallo di Offset è da -0,5 a +0,5.
