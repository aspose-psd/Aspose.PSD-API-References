...
description: "Livello di regolazione Mixer di canale RGB."
type: docs
weight: 26
url: /it/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
Livello di regolazione Mixer di canale RGB.
## Campi
...
| [getBlueChannel()](#getBlueChannel--) | Ottiene il canale blu. |
...
| [getGreenChannel()](#getGreenChannel--) | Ottiene il canale verde. |
...
| [getRedChannel()](#getRedChannel--) | Ottiene il canale rosso. |
...
Ottiene l'indice del canale per. Restituisce RgbMixerChannel
