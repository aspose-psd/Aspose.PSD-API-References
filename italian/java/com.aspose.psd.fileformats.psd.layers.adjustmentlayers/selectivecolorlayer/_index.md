...
description: "Livello di regolazione Colore selettivo."
type: docs
weight: 28
url: /it/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Ottiene la correzione cmyk per colore selettivo. |
| [getContainer()](#getContainer--) | Restituisce il contenitore Image. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Ottiene o imposta il metodo di correzione. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Elabora lo strato di colore selettivo. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Imposta la correzione cmyk per colore selettivo. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Imposta il contenitore Image. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Ottiene o imposta il metodo di correzione. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| selectiveColorsType | int | Colori selettivi. |
...
Valore: Il metodo di correzione.
...
Elabora lo strato di colore selettivo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| selectiveColorsType | int | Tipo dei colori selettivi. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | Correzione Cmyk. |
