...
description: "La classe del livello di regolazione Inverti."
type: docs
weight: 21
url: /it/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
La classe del livello di regolazione Inverti.
## Campi
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Elabora il livello di regolazione invert. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Applica le correzioni invert al array int ARGB specificato. |
...
Elabora il livello di regolazione invert.
...
Applica le correzioni invert al array int ARGB specificato.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| pixel | int[] | L'array int ARGB. |
