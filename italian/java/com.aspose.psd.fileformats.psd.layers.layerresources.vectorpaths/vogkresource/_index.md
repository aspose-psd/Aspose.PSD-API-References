...
description: "La risorsa dei dati di origine vettoriale."
type: docs
weight: 28
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource/
---
...
| --- | --- |
| [VogkResource()](#VogkResource--) | Inizializza una nuova istanza della classe [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [DescriptorListKey_internalized](#DescriptorListKey-internalized) | La chiave del descrittore per salvare le impostazioni di origine della forma. |
...
| [getItems_internalized()](#getItems-internalized--) | Ottiene o imposta gli elementi della struttura. |
...
| [getShapeOriginSettings()](#getShapeOriginSettings--) | Ottiene o imposta le impostazioni di origine della forma. |
...
| [setShapeOriginSettings(VectorShapeOriginSettings[] value)](#setShapeOriginSettings-com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths.VectorShapeOriginSettings---) | Ottiene o imposta le impostazioni di origine della forma. |
...
Inizializza una nuova istanza della classe [VogkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vogkresource).
...
La chiave del descrittore per salvare le impostazioni di origine della forma.
...
Ottiene o imposta le impostazioni di origine della forma.
