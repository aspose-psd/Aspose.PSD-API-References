...
type: docs
weight: 22
url: /it/java/com.aspose.psd.coreexceptions/streamreadexception/
---
...
L'eccezione di lettura del flusso. Si verifica quando la lettura del flusso fallisce a causa di una richiesta di offset e conteggio dei byte errati.
## Costruttori
...
| [getActualReadCount()](#getActualReadCount--) | Restituisce il conteggio effettivo dei byte letti. |
| [getCause()](#getCause--) |  |
| [getClass()](#getClass--) |  |
| [getExpectedReadCount()](#getExpectedReadCount--) | Restituisce il conteggio previsto dei byte letti. |
...
Restituisce il conteggio effettivo dei byte letti.

**Returns:**
int - Il conteggio effettivo dei byte letti.
### getCause() {#getCause--}
```
...
Restituisce il conteggio previsto dei byte letti.

**Returns:**
int - Il conteggio previsto dei byte letti.
### getInnerException() {#getInnerException--}
```
