...
type: docs
weight: 107
url: /it/java/com.aspose.psd/stringformatflags/
---
...
| [LineLimit](#LineLimit) | Solo linee intere vengono disposte nel rettangolo di formattazione. |
| [MeasureTrailingSpaces](#MeasureTrailingSpaces) | Include lo spazio finale alla fine di ogni riga. |
| [NoClip](#NoClip) | Le parti sporgenti dei glifi e il testo non avvolto che si estende al di fuori del rettangolo di formattazione possono essere visualizzati. |
...
Solo le linee intere vengono disposte nel rettangolo di formattazione. Per impostazione predefinita, il layout continua fino alla fine del testo, o fino a quando non sono più visibili altre linee a causa del ritaglio, a seconda di quale evento si verifichi per primo. Si noti che le impostazioni predefinite consentono all'ultima riga di essere parzialmente oscurata da un rettangolo di formattazione che non è un multiplo intero dell'altezza della riga. Per garantire che vengano visualizzate solo righe intere, specificare questo valore e fare attenzione a fornire un rettangolo di formattazione alto almeno quanto l'altezza di una riga.
...
Include lo spazio finale alla fine di ogni riga. Per impostazione predefinita, il rettangolo di confine restituito dal metodo MeasureString esclude lo spazio alla fine di ogni riga. Impostare questa opzione per includere quello spazio nella misurazione.
...
Le parti sporgenti dei glifi e il testo non avvolto che si estende al di fuori del rettangolo di formattazione possono essere visualizzati. Per impostazione predefinita, tutto il testo e le parti dei glifi che si estendono al di fuori del rettangolo di formattazione vengono ritagliati.
...
L'andare a capo del testo tra le righe durante la formattazione all'interno di un rettangolo è disabilitato. Questa opzione è implicita quando viene passato un punto anziché un rettangolo, o quando il rettangolo specificato ha una lunghezza di riga pari a zero.
