...
type: docs
weight: 15
url: /it/java/com.aspose.psd/cachetype/
---
...
| Campo | Descrizione |
| --- | --- |
| [Auto](#Auto) | Specifica il tipo di cache automatico. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Solo la cache in memoria. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Solo la cache su disco. |
...
Specifica il tipo di cache automatico. Lo schema di cache automatico proverà a memorizzare prima in memoria e poi su disco.
