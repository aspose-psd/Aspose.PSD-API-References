...
type: docs
weight: 51
url: /it/java/com.aspose.psd/graphicsunit/
---
...
| [Document](#Document) | Specifica l'unità del documento (1/300 di pollice) come unità di misura. |
...
| [Point](#Point) | Specifica il punto della stampante (1/72 di pollice) come unità di misura. |
| [World](#World) | Specifica l'unità del sistema di coordinate del mondo come unità di misura. |
## Metodi
...
Specifica l'unità del documento (1/300 di pollice) come unità di misura.
...
Specifica il punto della stampante (1/72 di pollice) come unità di misura.
...
Specifica l'unità del sistema di coordinate del mondo come unità di misura.
