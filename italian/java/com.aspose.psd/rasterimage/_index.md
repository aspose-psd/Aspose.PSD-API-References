...
type: docs
weight: 86
url: /it/java/com.aspose.psd/rasterimage/
---
...
| [crop(Rectangle rectangle)](#crop-com.aspose.psd.Rectangle-) | Ritaglia il rettangolo specificato. |
...
| [resize(int newWidth, int newHeight, ImageResizeSettings settings)](#resize-int-int-com.aspose.psd.ImageResizeSettings-) | Ridimensiona l'immagine con opzioni estese. |
