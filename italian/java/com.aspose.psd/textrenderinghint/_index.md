...
type: docs
weight: 109
url: /it/java/com.aspose.psd/textrenderinghint/
---
...
| Campo | Descrizione |
| --- | --- |
| [AntiAlias](#AntiAlias) | Ogni carattere è disegnato usando la sua bitmap di glifo antialiasata senza hinting. |
...
Ogni carattere è disegnato usando il suo bitmap di glifo antialiasato senza hinting. Qualità migliore grazie all'antialiasing. Le differenze di larghezza dei tratti possono essere evidenti perché l'hinting è disattivato.
...
Ogni carattere è disegnato usando il suo bitmap di glifo ClearType con hinting. L'impostazione di massima qualità. Utilizzato per sfruttare le funzionalità dei font ClearType.
...
Ogni carattere è disegnato usando il suo bitmap di glifo. L'hinting non è utilizzato.
...
Ogni carattere è disegnato usando il suo bitmap di glifo. L'hinting è usato per migliorare l'aspetto dei caratteri su tratti e curvature.
...
Ogni carattere è disegnato usando il suo bitmap di glifo, con il suggerimento di rendering predefinito del sistema. Il testo sarà disegnato usando le impostazioni di smussatura dei font selezionate dall'utente per il sistema.
