...
type: docs
weight: 37
url: /it/java/com.aspose.psd/datarecoverymode/
---
...
| Campo | Descrizione |
| --- | --- |
| [ConsistentRecover](#ConsistentRecover) | La modalità di recupero coerente tenta di recuperare tutti i dati finché la corruzione non rompe il formato del file e consente un corretto ulteriore elaborazione. |
...
| [None](#None) | Non è previsto alcun recupero dei dati. |
## Metodi
...
La modalità di recupero coerente tenta di recuperare tutti i dati finché la corruzione non rompe il formato del file e consente un corretto ulteriore elaborazione.
...
Non è previsto alcun recupero dei dati. Ogni volta che il formato del file contiene dati corrotti viene sollevata l'eccezione appropriata.
