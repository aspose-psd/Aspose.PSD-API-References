...
description: "L'enumerazione com.aspose.psd.InterpolationMode specifica l'algoritmo che viene utilizzato quando le immagini vengono scalate o ruotate."
type: docs
weight: 63
url: /it/java/com.aspose.psd/interpolationmode/
---
...
L'enumerazione  com.aspose.psd.InterpolationMode  specifica l'algoritmo utilizzato quando le immagini vengono scalate o ruotate.
## Campi
...
| [HighQualityBicubic](#HighQualityBicubic) | Specifica l'interpolazione ad alta qualità, bicubica. |
| [HighQualityBilinear](#HighQualityBilinear) | Specifica l'interpolazione ad alta qualità, bilineare. |
...
Specifica l'interpolazione ad alta qualità, bicubica. Viene eseguito il prefiltraggio per garantire una riduzione ad alta qualità. Questa modalità produce le immagini trasformate della massima qualità.
...
Specifica l'interpolazione ad alta qualità, bilineare. Viene eseguito il prefiltraggio per garantire una riduzione ad alta qualità.
