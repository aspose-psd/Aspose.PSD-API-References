...
description: "Il nuovo enum del tipo di sottofile tiff."
type: docs
weight: 18
url: /it/java/com.aspose.psd.fileformats.tiff.enums/tiffnewsubfiletypes/
---
...
Il nuovo enum del tipo di sottofile tiff.
## Campi

| Campo | Descrizione |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FileTypeDefault](#FileTypeDefault) | Il tipo di file predefinito. |
| [FileTypeLast](#FileTypeLast) | L'ultimo tipo di file. |
| [FileTypeMask](#FileTypeMask) | Il tipo di file maschera. |
| [FileTypePage](#FileTypePage) | Il tipo di file pagina. |
| [FileTypeReducedImage](#FileTypeReducedImage) | Il tipo di file immagine ridotta. |
## Metodi
...
Il tipo di file immagine ridotta.
