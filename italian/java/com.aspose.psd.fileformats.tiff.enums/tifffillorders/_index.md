...
description: "Ordine dei dati all'interno di un byte. Valori possibili per il tag FILLORDER."
type: docs
weight: 17
url: /it/java/com.aspose.psd.fileformats.tiff.enums/tifffillorders/
---
...
Ordine dei dati all'interno di un byte.

Valori possibili per il tag FILLORDER.
## Campi

| Campo | Descrizione |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Lsb2Msb](#Lsb2Msb) | Meno significativo -> più significativo. |
| [Msb2Lsb](#Msb2Lsb) | Più significativo -> meno significativo. |
## Metodi
