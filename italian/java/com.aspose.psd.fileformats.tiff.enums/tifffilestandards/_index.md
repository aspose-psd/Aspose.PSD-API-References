...
description: "Specifica gli standard del formato di file TIFF."
type: docs
weight: 16
url: /it/java/com.aspose.psd.fileformats.tiff.enums/tifffilestandards/
---
...
Specifica gli standard del formato di file TIFF.
## Campi

| Campo | Descrizione |
| --- | --- |
| [Baseline](#Baseline) | Lo standard di file TIFF 6.0 di base. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Extended](#Extended) | Lo standard di file TIFF 6.0 esteso. |
## Metodi
...
Lo standard di file TIFF 6.0 di base. Questo standard è formalmente noto come TIFF 6.0, Parte 1: TIFF di base.
...
Lo standard di file TIFF 6.0 esteso. Questo standard è formalmente noto come TIFF 6.0 esteso, Parte 2: Estensioni TIFF.
