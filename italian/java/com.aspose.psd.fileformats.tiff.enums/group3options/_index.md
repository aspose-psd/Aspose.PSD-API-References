...
description: "Opzioni per la codifica fax CCITT Group 3/4. Valori possibili per i tag GROUP3OPTIONS / TiffTag.T4OPTIONS e TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS."
type: docs
weight: 10
url: /it/java/com.aspose.psd.fileformats.tiff.enums/group3options/
---
...
Opzioni per la codifica fax CCITT Group 3/4.

Valori possibili per i tag GROUP3OPTIONS / TiffTag.T4OPTIONS e TiffTag.GROUP4OPTIONS / TiffTag.T6OPTIONS.
## Campi

| Campo | Descrizione |
| --- | --- |
| [Encoding1D](#Encoding1D) | Codifica unidimensionale. |
| [Encoding2D](#Encoding2D) | Codifica bidimensionale. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FillBits](#FillBits) | Riempire fino al confine di byte. |
| [Uncompressed](#Uncompressed) | Dati non compressi. |
## Metodi
...
Codifica unidimensionale. (predefinita)
...
Riempire fino al confine di byte.
