...
type: docs
weight: 53
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource/
---
...
| --- | --- |
| [Lr16Resource()](#Lr16Resource--) | Inizializza una nuova istanza della classe [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource). |
## Campi
...
| [getLayers()](#getLayers--) | Ottiene o imposta i layer. |
| [getLength()](#getLength--) | Ottiene la lunghezza della risorsa per la versione dell'intestazione PSD dell'immagine. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | Ottiene la lunghezza della risorsa. |
...
| [getRawData_internalized()](#getRawData-internalized--) | Ottiene o imposta i dati grezzi della risorsa. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Salva il record del layer. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Ottiene o imposta i layer. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | Ottiene o imposta i dati grezzi della risorsa. |
...
Inizializza una nuova istanza della classe [Lr16Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr16resource).
...
Restituisce la lunghezza della risorsa. Può dipendere dalla versione PSD.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| psdHeaderVersion | int | La versione dell'intestazione PSD. |

**Returns:**
int - La lunghezza della risorsa.
...
Ottiene o imposta i dati grezzi della risorsa.
