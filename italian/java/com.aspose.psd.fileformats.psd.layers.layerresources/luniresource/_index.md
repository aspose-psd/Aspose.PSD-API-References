...
description: "Risorsa del nome del livello"
type: docs
weight: 58
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
Risorsa del nome del livello
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [LuniResource()](#LuniResource--) | Inizializza una nuova istanza della classe [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource). |
## Campi
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | Ottiene o imposta i dati. |
...
Inizializza una nuova istanza della classe [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource).
