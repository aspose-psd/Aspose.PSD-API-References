...
description: "Impostazioni protette del livello"
type: docs
weight: 57
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource/
---
...
Impostazioni protette del livello
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [LspfResource(byte[] data)](#LspfResource-byte---) | Inizializza una nuova istanza della classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource(boolean isTransparencyProtected, boolean isCompositeProtected, boolean isPositionProtected)](#LspfResource-boolean-boolean-boolean-) | Inizializza una nuova istanza della classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
| [LspfResource()](#LspfResource--) | Inizializza una nuova istanza della classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). |
## Campi
...
| [TypeToolKey](#TypeToolKey) | La chiave di informazioni dello strumento di tipo 1819504742 |
...
| [getLockType()](#getLockType--) | Ottiene o imposta il tipo di blocco. |
...
| [hashCode()](#hashCode--) |  |
| [isCompositeProtected()](#isCompositeProtected--) | Ottiene o imposta un valore che indica se questa istanza è protetta da composizione. |
| [isPositionProtected()](#isPositionProtected--) | Ottiene o imposta un valore che indica se questa istanza è protetta dalla posizione. |
...
| [isTransparencyProtected()](#isTransparencyProtected--) | Ottiene o imposta un valore che indica se questa istanza è protetta dalla trasparenza. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setCompositeProtected(boolean value)](#setCompositeProtected-boolean-) | Ottiene o imposta un valore che indica se questa istanza è protetta da composizione. |
...
| [setLockType(int value)](#setLockType-int-) | Ottiene o imposta il tipo di blocco. |
| [setPositionProtected(boolean value)](#setPositionProtected-boolean-) | Ottiene o imposta un valore che indica se questa istanza è protetta dalla posizione. |
| [setTransparencyProtected(boolean value)](#setTransparencyProtected-boolean-) | Ottiene o imposta un valore che indica se questa istanza è protetta dalla trasparenza. |
...
Inizializza una nuova istanza della classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource). Con valore personalizzato o sconosciuto.
...
Inizializza una nuova istanza della classe [LspfResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lspfresource).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| isTransparencyProtected | boolean | se impostato su  true  [è protetta dalla trasparenza]. |
| isCompositeProtected | boolean | se impostato su  true  [è protetta dalla composizione]. |
| isPositionProtected | boolean | se impostato su  true  [è protetto dalla posizione]. |
...
La chiave di informazioni dello strumento di tipo 1819504742
...
Ottiene o imposta un valore che indica se questa istanza è protetta da composizione.

Valore:  true  se questa istanza è protetta da composizione; altrimenti,  false .
...
Valore:  true  se questa istanza è protetta dalla posizione; altrimenti,  false .
...
Valore:  true  se questa istanza è protetta dalla trasparenza; altrimenti,  false .
