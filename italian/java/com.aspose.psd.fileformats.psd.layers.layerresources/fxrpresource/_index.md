...
description: "Classe FxrpResource."
type: docs
weight: 32
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
Classe FxrpResource. Il punto di riferimento del livello
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | Inizializza una nuova istanza della classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | Inizializza una nuova istanza della classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | Inizializza una nuova istanza della classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## Campi
...
| [getX()](#getX--) | Ottiene o imposta l'x del punto di riferimento |
| [getY()](#getY--) | Ottiene o imposta l'y del punto di riferimento |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Salva nel contenitore di stream specificato. |
...
| [setX(double value)](#setX-double-) | Ottiene o imposta l'x del punto di riferimento |
| [setY(double value)](#setY-double-) | Ottiene o imposta l'y del punto di riferimento |
...
Inizializza una nuova istanza della classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).
...
Inizializza una nuova istanza della classe [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). Con valore personalizzato o sconosciuto
...
Ottiene o imposta l'x del punto di riferimento

Valore: L'x del punto di riferimento
...
Ottiene o imposta l'y del punto di riferimento

Valore: l'asse y del punto di riferimento
