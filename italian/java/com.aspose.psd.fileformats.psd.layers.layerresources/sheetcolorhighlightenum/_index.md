...
description: "Colori possibili dell'impostazione del colore del foglio."
type: docs
weight: 73
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
Possibili colori dell'impostazione del colore del foglio. È un colore decorativo dell'interfaccia utente del livello nell'elenco dei livelli in PS
## Campi

| Campo | Descrizione |
| --- | --- |
| [Blue](#Blue) | Il colore blu. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gray](#Gray) | Il colore grigio. |
| [Green](#Green) | Il colore verde. |
| [NoColor](#NoColor) | Il colore non è specificato. |
| [Orange](#Orange) | Il colore arancione. |
| [Red](#Red) | Il colore rosso. |
| [Violet](#Violet) | Il colore violetto. |
| [Yellow](#Yellow) | Il colore giallo. |
## Metodi
