...
description: "La sezione con dati animati."
type: docs
weight: 11
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
La sezione con dati animati.
## Campi

| Campo | Descrizione |
| --- | --- |
| [StructureKey](#StructureKey) | Identifica la chiave di struttura di AnDs. |
## Metodi
...
| [getItems()](#getItems--) | Ottiene o imposta le strutture della sezione dati animata. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Ottiene o imposta il ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Ottiene o imposta la versione del descrittore. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Ottiene o imposta le strutture della sezione dati animata. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Ottiene o imposta i byte sconosciuti 3 che esistono quando il numero di fotogrammi è dispari. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Verifica che il conteggio dei fotogrammi nella struttura della lista 'FrIn' sia dispari.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| elementi | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
Ottiene o imposta le strutture della sezione dati animata.
...
Ottiene o imposta i byte sconosciuti 3 che esistono quando il numero di fotogrammi è dispari.
