...
description: "Classe IopaResource."
type: docs
weight: 40
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
Classe IopaResource. Questa risorsa contiene informazioni sulla proprietà di opacità di riempimento dal modulo stile livello
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [IopaResource()](#IopaResource--) | Inizializza una nuova istanza della classe [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).  |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Inizializza una nuova istanza della classe [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).  |
## Campi
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Ottiene o imposta l'opacità del riempimento. |
...
Inizializza una nuova istanza della classe [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). 
...
| --- | --- | --- |
| dati | byte[] | I dati grezzi dei byte. |
...
Valore: L'opacità di riempimento.
