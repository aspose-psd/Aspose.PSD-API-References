...
type: docs
weight: 39
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Classe InfxResource. Questa risorsa contiene informazioni sul blending dell'elemento ritagliato.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Inizializza una nuova istanza della classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource()](#InfxResource--) | Inizializza una nuova istanza della classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Inizializza una nuova istanza della classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
## Campi
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Ottiene o imposta un valore che indica se [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Ottiene o imposta un valore che indica se [blend interior elements]. |
...
Inizializza una nuova istanza della classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| blendInteriorElements | boolean | se impostato su  true  [blend interior elements]. |
...
Inizializza una nuova istanza della classe [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). Con valore personalizzato o sconosciuto.
