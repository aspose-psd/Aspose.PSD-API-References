...
type: docs
weight: 43
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Inizializza una nuova istanza della classe [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Inizializza una nuova istanza della classe [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Campi
...
| [getSectionType()](#getSectionType--) | Ottiene o imposta il tipo di sezione. |
| [getSignature()](#getSignature--) | Ottiene la firma della risorsa del livello. |
| [getSubtype()](#getSubtype--) | Ottiene o imposta il sottotipo. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Ottiene o imposta il tipo di sezione. |
| [setSubtype(int value)](#setSubtype-int-) | Ottiene o imposta il sottotipo. |
...
Inizializza una nuova istanza della classe [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
| --- | --- | --- |
| sectionType | int | Il tipo di sezione. |
| subType | int | Il sottotipo. |
