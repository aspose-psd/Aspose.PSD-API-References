...
type: docs
weight: 51
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Inizializza una nuova istanza della classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Inizializza una nuova istanza della classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Campi
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Ottiene i dati grezzi. |
...
| [getValue()](#getValue--) | Ottiene il valore come LnsrResourceType se l'enumerazione corrispondente è descritta. |
| [hashCode()](#hashCode--) |  |
...
Inizializza una nuova istanza della classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| lnsrResourceType | int | Tipo di LNSR. |
...
Inizializza una nuova istanza della classe [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). Con valore personalizzato o sconosciuto.
...
Ottiene il valore come LnsrResourceType se l'enumerazione corrispondente è descritta. Altrimenti restituisce Unknown.

Valore: Il valore come LnsrResourceType
