...
description: "Classe ShmdResource."
type: docs
weight: 74
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
| --- | --- |
| [ShmdResource()](#ShmdResource--) | Inizializza una nuova istanza della classe [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | Inizializza una nuova istanza della classe [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
## Campi
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | La lunghezza dell'intestazione della sotto-risorsa |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Ottiene o imposta l'ora di creazione del livello. |
...
| [getSubResources()](#getSubResources--) | Le sotto-risorse |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Ottiene o imposta l'ora di creazione del livello. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | Ottiene le sotto-risorse della risorsa shmd. |
...
Inizializza una nuova istanza della classe [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource).
...
La lunghezza dell'intestazione della sotto-risorsa
...
Ottiene o imposta l'ora di creazione del livello. Se l'ora di creazione del livello non è specificata, restituisce un nuovo DateTime(0)

Valore: L'ora di creazione del livello.
...
Ottiene le sotto-risorse della risorsa shmd.
