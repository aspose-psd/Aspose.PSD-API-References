...
type: docs
weight: 27
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/custresource/
---
...
Classe CustResource. Questa risorsa contiene informazioni sul blending dell'elemento ritagliato.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [CustResource()](#CustResource--) | Inizializza una nuova istanza della classe [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource). |
| [CustResource(byte[] data)](#CustResource-byte---) | Inizializza una nuova istanza della classe [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource). |
## Campi
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | Ottiene o imposta la data di creazione del livello. |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | Ottiene o imposta la data di creazione del livello. |
...
Inizializza una nuova istanza della classe [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource).
...
Valore: La data di creazione del livello.
