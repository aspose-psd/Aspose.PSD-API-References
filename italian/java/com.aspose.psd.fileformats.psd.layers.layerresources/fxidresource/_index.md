...
description: "La risorsa Filter Effects contiene canali, una maschera utente e una maschera foglio per il filtro intelligente."
type: docs
weight: 29
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
La risorsa Filter Effects contiene canali, una maschera utente e una maschera foglio per il filtro intelligente.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Inizializza una nuova istanza della classe [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | La chiave di informazioni dello strumento tipo FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | La chiave di informazioni dello strumento tipo FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Ottiene le maschere dell'effetto filtro. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Ottiene le maschere dell'effetto filtro. |
...
Inizializza una nuova istanza della classe [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource).
...
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Le maschere dell'effetto filtro. |
...
La chiave di informazioni dello strumento tipo FEid.
...
La chiave di informazioni dello strumento tipo FXid.
