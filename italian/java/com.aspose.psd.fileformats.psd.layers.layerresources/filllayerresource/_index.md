...
description: "Classe base per le risorse del livello di riempimento"
type: docs
weight: 30
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/filllayerresource/
---
...
Classe base per le risorse del livello di riempimento
## Campi
