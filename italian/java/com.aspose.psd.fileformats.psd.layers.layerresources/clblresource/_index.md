...
type: docs
weight: 20
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/clblresource/
---
...
Classe ClblResource. Questa risorsa contiene informazioni sul blending dell'elemento ritagliato.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ClblResource()](#ClblResource--) | Inizializza una nuova istanza della classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(boolean blendClippedElements)](#ClblResource-boolean-) | Inizializza una nuova istanza della classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
| [ClblResource(byte[] data)](#ClblResource-byte---) | Inizializza una nuova istanza della classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). |
## Campi
...
| [getBlendClippedElements()](#getBlendClippedElements--) | Ottiene o imposta un valore che indica se [mescolare elementi ritagliati]. |
| [getClass()](#getClass--) |  |
...
| [setBlendClippedElements(boolean value)](#setBlendClippedElements-boolean-) | Ottiene o imposta un valore che indica se [mescolare elementi ritagliati]. |
...
Inizializza una nuova istanza della classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource).
...
| --- | --- | --- |
| blendClippedElements | boolean | se impostato su  true  [mescolare elementi ritagliati]. |
...
Inizializza una nuova istanza della classe [ClblResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/clblresource). Con valore personalizzato o sconosciuto
...
Ottiene o imposta un valore che indica se [mescolare elementi ritagliati].

Valore:  true  se [blend clipped elements]; altrimenti,  false .
