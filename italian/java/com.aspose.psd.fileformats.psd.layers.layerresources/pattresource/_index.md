...
type: docs
weight: 66
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
Classe PattResource. Risorsa con dati del pattern
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [PattResource()](#PattResource--) | Inizializza una nuova istanza della classe [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Inizializza una nuova istanza della classe [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource). |
## Campi
...
| [TypeToolKey](#TypeToolKey) | La chiave di informazioni dello strumento di tipo 'Patt' per 8 bit. |
| [TypeToolKey2](#TypeToolKey2) | La chiave di informazioni dello strumento di tipo 'Pat2' per 16 bit. |
| [TypeToolKey3](#TypeToolKey3) | La chiave di informazioni dello strumento di tipo 'Pat3' per 32 bit. |
| [ventureLicense_internalized](#ventureLicense-internalized) | La licenza venture. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Aggiorna la risorsa Patt con i dati predefiniti. |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | Crea la risorsa predefinita non vuota. |
...
| [getPatterns()](#getPatterns--) | Ottiene o imposta i dati dei pattern; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Ottiene o imposta i dati dei pattern; |
| [toString()](#toString--) | Restituisce una String che rappresenta questa istanza. |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | Cerca l'elemento dei dati del pattern e lo aggiorna con il nuovo, altrimenti aggiunge il nuovo alla fine dell'array. |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza della classe [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource).
...
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | I dati dei pattern. |
...
La chiave di informazioni dello strumento di tipo 'Patt' per 8 bit.
...
La chiave di informazioni dello strumento di tipo 'Pat2' per 16 bit.
...
La chiave di informazioni dello strumento di tipo 'Pat3' per 32 bit.
...
Aggiorna la risorsa Patt con i dati predefiniti.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | La risorsa. |
...
Crea la risorsa predefinita non vuota.
...
Ottiene o imposta i dati dei pattern;
...
Cerca l'elemento dei dati del pattern e lo aggiorna con il nuovo, altrimenti aggiunge il nuovo alla fine dell'array.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | L'oggetto delle impostazioni dei pattern per aggiornare l'elemento del pattern. |
