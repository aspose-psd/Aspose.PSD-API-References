...
description: "La risorsa di livello lsdk della sezione di livello nidificata."
type: docs
weight: 56
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource/
---
...
La risorsa del livello lsdk (risorsa della sezione di livello nidificata).
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [LsdkResource()](#LsdkResource--) | Inizializza una nuova istanza della classe [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
| [LsdkResource(int sectionType, int subType)](#LsdkResource-int-int-) | Inizializza una nuova istanza della classe [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource). |
## Campi
...
Inizializza una nuova istanza della classe [LsdkResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lsdkresource).
