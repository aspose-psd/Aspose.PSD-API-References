...
description: "La risorsa mlst."
type: docs
weight: 62
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
La risorsa mlst. Questa classe, tra le altre cose, contiene informazioni sulla posizione del livello nella timeline.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [MlstResource()](#MlstResource--) | Inizializza una nuova istanza della classe [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource). |
## Campi
...
| [getItems()](#getItems--) | Ottiene o imposta le strutture. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Ottiene o imposta le strutture. |
...
Inizializza una nuova istanza della classe [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource).
