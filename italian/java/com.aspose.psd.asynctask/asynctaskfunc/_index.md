...
type: docs
weight: 12
url: /it/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | Il delegato di operazione lunga per il task asincrono con risultato di tipo generico. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | Stato dell'attività asincrona. |

**Returns:**
java.lang.Object - Risultato dell'operazione long.
### notify() {#notify--}
```
