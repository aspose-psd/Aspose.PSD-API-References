...
description: "Definisce un brush rettangolare con uno stile hatch, un colore di primo piano e un colore di sfondo."
type: docs
weight: 10
url: /it/java/com.aspose.psd.brushes/hatchbrush/
---
...
Definisce un brush rettangolare con uno stile hatch, un colore di primo piano e un colore di sfondo. Questa classe non può essere ereditata.
## Costruttori
...
| [getBackgroundColor()](#getBackgroundColor--) | Ottiene il colore degli spazi tra le linee hatch. |
| [getClass()](#getClass--) |  |
| [getDisposed()](#getDisposed--) | Restituisce un valore che indica se questa istanza è stata eliminata. |
| [getForegroundColor()](#getForegroundColor--) | Ottiene il colore delle linee hatch. |
| [getHatchStyle()](#getHatchStyle--) | Ottiene lo stile hatch di questo brush. |
| [getOpacity()](#getOpacity--) | Restituisce l'opacità del pennello. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Imposta il colore degli spazi tra le linee hatch. |
| [setForegroundColor(Color value)](#setForegroundColor-com.aspose.psd.Color-) | Imposta il colore delle linee hatch. |
| [setHatchStyle(int value)](#setHatchStyle-int-) | Imposta lo stile di tratteggio di questo pennello. |
...
Ottiene il colore degli spazi tra le linee hatch.
...
Ottiene il colore delle linee hatch.
...
Ottiene lo stile hatch di questo brush.
...
Imposta il colore degli spazi tra le linee hatch.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | Il colore degli spazi tra le linee di tratteggio. |
...
Imposta il colore delle linee hatch.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | Il colore delle linee di tratteggio. |
...
Imposta lo stile di tratteggio di questo pennello.
