...
description: "La classe del livello di testo"
type: docs
weight: 30
url: /it/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
La classe del livello di testo
## Campi
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Corregge la dimensione del carattere |
...
| [createInstance_internalized()](#createInstance-internalized--) | Crea una nuova istanza della classe [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Crea una nuova istanza della classe [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Ottiene i dati del motore. |
...
| [getFont()](#getFont--) | Ottiene il carattere. |
| [getFonts()](#getFonts--) | Ottiene l'insieme dei caratteri del livello di testo. |
...
| [getInnerText()](#getInnerText--) | Ottiene il testo del livello |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Ottiene o imposta il processore delle risorse. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Ottiene il formato della stringa. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Ottiene la radice di sincronizzazione. |
| [getText()](#getText--) | Ottiene il testo. |
| [getTextBoundBox()](#getTextBoundBox--) | Ottiene o imposta il riquadro di delimitazione del testo. |
| [getTextColor()](#getTextColor--) | Ottiene il colore del testo. |
| [getTextData()](#getTextData--) | Ottiene le porzioni del testo. |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Cerca e ottiene la risorsa [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) dal [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Ottiene o imposta un valore che indica se [was changed]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Determina se [is font available] [the specified font]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Preelabora il carattere. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Sostituisce il carattere con quello predefinito. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Ottiene il testo del livello |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Ottiene o imposta il processore delle risorse. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Ottiene o imposta il riquadro di delimitazione del testo. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Ottiene o imposta un valore che indica se [was changed]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Aggiorna i limiti del [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) nelle risorse. |
| [updateText(String text)](#updateText-java.lang.String-) | Aggiorna il testo. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Aggiorna il testo. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Aggiorna il testo. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Aggiorna il testo. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Aggiorna il testo. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Aggiorna il testo. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Aggiorna il testo. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Aggiorna il testo. |
| [wait()](#wait--) |  |
...
Corregge la dimensione del carattere

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| newSize | float | Nuova dimensione del carattere |
| yyTransform | double | 'yy' parametro della matrice di trasformazione |

**Returns:**
float - Dimensione corretta
...
Crea una nuova istanza della classe [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Ottiene i dati del motore.

Valore: I dati del motore.
...
Ottiene l'insieme dei caratteri del livello di testo.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - Il set di caratteri del livello di testo.
...
Ottiene o imposta il processore delle risorse.

Valore: Il processore di risorse.
...
Ottiene il formato della stringa.

Valore: Il formato della stringa.
...
Ottiene o imposta il riquadro di delimitazione del testo.

Valore: La casella di delimitazione del testo.
...
Cerca e ottiene la risorsa [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) dal [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Ottiene o imposta un valore che indica se [was changed].

Valore:  true  se [was changed]; altrimenti,  false .
...
Determina se [is font available] [the specified font].
...
**Returns:**
boolean - True se il font è disponibile
...
Sostituisce il carattere con quello predefinito.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | Il font. |
| defaultFontName | java.lang.String | Nome predefinito del font. |
...
| newWidth | int | La nuova larghezza. |
| newHeight | int | La nuova altezza. |
| resizeType | int | Il tipo di trasformazione di ridimensionamento  ResizeType |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Aggiorna i limiti del [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) nelle risorse.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | La posizione assoluta e la dimensione del testo. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | La posizione e la dimensione del testo relative al textBox. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| testo | java.lang.String | Il valore del testo. |
...
| --- | --- | --- |
| testo | java.lang.String | Il valore del testo. |
| color | [Color](../../com.aspose.psd/color) | Il valore del colore. |
...
| --- | --- | --- |
| testo | java.lang.String | Il valore del testo. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | La coordinata in alto a sinistra. |
...
| testo | java.lang.String | Il valore del testo. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | La coordinata in alto a sinistra. |
| fontSize | float | Dimensione del carattere. |
