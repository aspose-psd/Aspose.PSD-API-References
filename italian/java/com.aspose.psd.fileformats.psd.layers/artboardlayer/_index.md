...
description: "La classe del livello artboard."
type: docs
weight: 10
url: /it/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
La classe del livello artboard.
## Campi
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Aggiunge il livello al gruppo di livelli. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Aggiunge il livello al gruppo di livelli. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Aggiunge il gruppo di livelli. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Ottiene o imposta il colore di sfondo dell'artboard. |
...
| [getLayers()](#getLayers--) | Ottiene i livelli nel gruppo di livelli |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Ottiene i limiti reali di ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Ottiene il LayerSectionResource dalle risorse. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Ottiene o imposta un valore che indica se [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) ha il colore di sfondo. |
...
| [isOpen()](#isOpen--) | Ottiene o imposta se la cartella è aperta; se impostata su true, il gruppo sarà nello stato aperto all'avvio, altrimenti nello stato ridotto. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Ottiene o imposta il colore di sfondo dell'artboard. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Ottiene o imposta se la cartella è aperta; se impostata su true, il gruppo sarà nello stato aperto all'avvio, altrimenti nello stato ridotto. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Il livello. |
| indice | int | L'indice al quale il livello verrà inserito. I valori non validi indicano la fine dell'elenco dei livelli. |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Restituisce un array di due oggetti LayerGroup, dove il primo [0] è il marcatore di inizio gruppo e il secondo [1] è il marcatore di fine gruppo.
### cacheData() {#cacheData--}
```
...
Ottiene o imposta il colore di sfondo dell'artboard.
...
Ottiene i limiti reali di ArtboardLayer.
...
Ottiene il LayerSectionResource dalle risorse.
...
Ottiene o imposta un valore che indica se [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) ha il colore di sfondo.
...
Ottiene o imposta se la cartella è aperta; se impostata su true, il gruppo sarà nello stato aperto all'avvio, altrimenti nello stato ridotto.
