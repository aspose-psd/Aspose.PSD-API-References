...
description: "Classe del livello di gruppo"
type: docs
weight: 19
url: /it/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | Ottiene l'altezza del gruppo di livelli. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Ottiene i limiti di unione di tutti i livelli in LayerGroup. |
...
| [getWidth()](#getWidth--) | Ottiene la larghezza del gruppo di livelli. |
...
Ottiene i limiti di unione di tutti i livelli in LayerGroup.
