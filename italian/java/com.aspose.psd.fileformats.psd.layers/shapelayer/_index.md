...
description: "Livello forma."
type: docs
weight: 29
url: /it/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Livello di forma. Incapsula la logica di lavoro con il livello di forma e le risorse correlate.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Inizializza una nuova istanza della classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## Campi
...
| [createInstance()](#createInstance--) | Crea una nuova istanza della classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | Impostazioni di riempimento per l'area interna delle forme nel livello di forma. |
...
| [getPath()](#getPath--) | Ottiene l'insieme di percorsi presenti in un livello di forma. |
...
| [getStroke()](#getStroke--) | Ottiene o imposta le impostazioni di contorno delle forme. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Chiamato quando [global resources changed]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Chiamato quando [resources change]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Impostazioni di riempimento per l'area interna delle forme nel livello di forma. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Ottiene o imposta le impostazioni di contorno delle forme. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Aggiorna le risorse dalle proprietà del livello Shape. |
...
Inizializza una nuova istanza della classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). Tutte le risorse sono create nello stato predefinito.
...
Crea una nuova istanza della classe [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
Impostazioni di riempimento per l'area interna delle forme nel livello di forma.
...
Ottiene l'insieme di percorsi presenti in un livello di forma.
...
Ottiene o imposta le impostazioni di contorno delle forme.
...
**Returns:**
boolean - Valore booleano che indica se il livello è valido.
...
Chiamato quando [global resources changed].

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| mittente | java.lang.Object | Il mittente. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | L'istanza EventArgs contenente i dati dell'evento. |
...
Chiamato quando [resources change].
...
Aggiorna le risorse dalle proprietà del livello Shape.
