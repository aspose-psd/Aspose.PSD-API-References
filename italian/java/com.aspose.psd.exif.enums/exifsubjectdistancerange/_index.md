...
description: "enum degli intervalli di distanza soggetto exif."
type: docs
weight: 25
url: /it/java/com.aspose.psd.exif.enums/exifsubjectdistancerange/
---
...
enum degli intervalli di distanza soggetto exif.
## Campi

| Campo | Descrizione |
| --- | --- |
| [CloseView](#CloseView) | Vista ravvicinata. |
| [DistantView](#DistantView) | Vista distante. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Macro](#Macro) | Gamma macro |
| [Unknown](#Unknown) | Intervallo di distanza del soggetto sconosciuto |
## Metodi
...
Intervallo di distanza del soggetto sconosciuto
