...
description: "La struttura unità."
type: docs
weight: 28
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Inizializza una nuova istanza della classe [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure). |
## Campi
...
| [getUnitType()](#getUnitType--) | Ottiene o imposta il tipo di unità. |
...
| [setUnitType(int value)](#setUnitType-int-) | Ottiene o imposta il tipo di unità. |
| [setValue(double value)](#setValue-double-) | Ottiene o imposta il valore. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza della classe [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure).
