...
description: "La struttura classe."
type: docs
weight: 12
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | Inizializza una nuova istanza della classe [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | Identifica la chiave della struttura. |
| [StructureKeyGlbc](#StructureKeyGlbc) | Identifica la chiave della struttura. |
| [StructureKeyType](#StructureKeyType) | Identifica la chiave della struttura. |
## Metodi
...
Inizializza una nuova istanza della classe [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure).
...
| structureKey | int | La chiave della struttura. |
