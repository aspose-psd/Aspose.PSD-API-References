...
description: "Definisce la classe ObjectArrayStructure che solitamente contiene un array."
type: docs
weight: 20
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Definisce la classe ObjectArrayStructure che solitamente contiene l'array [UnitArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/unitarraystructure). Viene utilizzata nelle risorse del file PSD, come le risorse PlLd e SoLd.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Inizializza una nuova istanza della classe [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Inizializza una nuova istanza della classe [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [StructureKey](#StructureKey) | Identifica la chiave di struttura 'ObAr'. |
## Metodi
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Ottiene o imposta l'ID della classe dell'array di oggetti. |
| [getClassName()](#getClassName--) | Ottiene o imposta il nome della classe dell'array di oggetti. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | Ottiene l'elenco delle strutture. |
| [getKey()](#getKey--) | Ottiene la chiave della struttura dell'array di oggetti. |
| [getKeyName()](#getKeyName--) | Ottiene o imposta il nome della chiave. |
| [getLength()](#getLength--) | Ottiene la lunghezza in byte della OSTypeStructure. |
...
| [getStructureCount()](#getStructureCount--) | Ottiene il conteggio delle sotto-strutture dell'array di oggetti. |
| [getStructures()](#getStructures--) | Ottiene o imposta le sotto-strutture nella struttura dell'array di oggetti. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Ottiene o imposta l'ID della classe dell'array di oggetti. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Ottiene o imposta il nome della classe dell'array di oggetti. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Ottiene o imposta le sotto-strutture nella struttura dell'array di oggetti. |
...
Inizializza una nuova istanza della classe [ObjectArrayStructure](../../com.aspose.psd/fileformats/psd.layers.layerresources.typetoolinfostructures/objectarraystructure).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| keyName | java.lang.String | Nome della chiave. |
| classIdName | java.lang.String | Nome dell'identificatore di classe. |
...
Identifica la chiave di struttura 'ObAr'.
...
Ottiene o imposta l'ID della classe dell'array di oggetti.

Valore: L'ID della classe dell'array di oggetti.
...
Valore: Il nome della classe dell'array di oggetti.
...
Ottiene l'elenco delle strutture.
...
Ottiene la lunghezza in byte della OSTypeStructure.
...
Ottiene il conteggio delle sotto-strutture dell'array di oggetti.

Valore: Il conteggio delle sotto-strutture nella struttura dell'array di oggetti.
...
Ottiene o imposta le sotto-strutture nella struttura dell'array di oggetti.

Valore: Le sotto-strutture nella struttura dell'array di oggetti.
