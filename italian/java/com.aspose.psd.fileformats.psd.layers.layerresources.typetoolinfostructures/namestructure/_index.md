...
description: "La chiave della struttura Name 0x6E616D65, che rappresenta la parola 'name' in ASCII, è una struttura semplice usata per memorizzare una stringa Unicode o in stile Pascal che rappresenta il nome di un elemento come un percorso di livello o una regolazione."
type: docs
weight: 19
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
La struttura Name (chiave: 0x6E616D65, che corrisponde a "name" in ASCII) è una struttura semplice utilizzata per memorizzare una stringa Unicode o in stile Pascal che rappresenta il nome di un elemento, come un livello, un percorso o una regolazione.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Inizializza una nuova istanza della classe [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [StructureKey](#StructureKey) | La chiave della struttura Name. |
## Metodi
...
| [getValue()](#getValue--) | Ottiene o imposta il valore di una struttura Name. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | Ottiene o imposta il primo valore stringa della struttura Name. |
...
| [setValue(String value)](#setValue-java.lang.String-) | Ottiene o imposta il valore di una struttura Name. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza della classe [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure).
...
Ottiene o imposta il primo valore stringa della struttura Name. Di solito contiene il simbolo di fine riga.
