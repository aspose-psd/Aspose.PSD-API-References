...
description: "Definisce la classe UnitArrayStructure che contiene un array di valori double e la loro unità di misura."
type: docs
weight: 27
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
Definisce la classe UnitArrayStructure che contiene un array di valori double e la loro unità di misura. Viene utilizzata nelle risorse dei file PSD, solitamente da [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | Inizializza una nuova istanza della classe [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## Campi

| Campo | Descrizione |
| --- | --- |
| [StructureKey](#StructureKey) | Definisce la chiave 'UnFl' di [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## Metodi
...
| [getKey()](#getKey--) | Ottiene questa chiave della struttura dell'array di unità. |
...
| [getUnitType()](#getUnitType--) | Ottiene o imposta il tipo di unità di misura dei valori di [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [getValueCount()](#getValueCount--) | Ottiene il conteggio dei valori. |
| [getValues()](#getValues--) | Ottiene o imposta i valori della struttura dell'array di unità. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | Ottiene o imposta il tipo di unità di misura dei valori di [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [setValues(double[] value)](#setValues-double---) | Ottiene o imposta i valori della struttura dell'array di unità. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Inizializza una nuova istanza della classe [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Nome della chiave. |
| unitType | int | Tipo dell'unità. |
...
Definisce la chiave 'UnFl' di [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).
...
Ottiene o imposta il tipo di unità di misura dei valori di [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

Valore: Il tipo di unità di misura.
...
Ottiene il conteggio dei valori.

Valore: Il conteggio dei valori nella struttura dell'array di unità.
...
Ottiene o imposta i valori della struttura dell'array di unità.
