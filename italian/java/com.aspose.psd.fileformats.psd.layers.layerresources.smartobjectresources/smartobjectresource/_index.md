...
description: "Definisce la classe SmartObjectResource che contiene informazioni su un livello oggetto intelligente in un file PSD."
type: docs
weight: 13
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartobjectresource/
---
...
Definisce la classe SmartObjectResource che contiene informazioni su un livello di smart object in un file PSD. È la classe base per le risorse Sold e Sole che è usata per supportare i livelli di smart object nelle immagini Adobe\\ufffd Photoshop\\ufffd.
## Campi
