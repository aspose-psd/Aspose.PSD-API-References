...
description: "Definisce la classe PlacedResource che contiene informazioni comuni su un livello posizionato o su un livello oggetto intelligente nel file PSD."
type: docs
weight: 12
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
Definisce la classe PlacedResource che contiene informazioni comuni su un livello posizionato o su un livello di oggetto intelligente nel file PSD. È utilizzata per supportare i livelli di oggetti intelligenti nelle immagini Adobe\\ufffd Photoshop\\ufffd.
## Campi
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | Ottiene o imposta gli elementi del warp. |
