...
description: "Definisce la classe SoLdResource che contiene informazioni su un livello oggetto intelligente in un file PSD."
type: docs
weight: 15
url: /it/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
Definisce la classe SoLdResource che contiene informazioni su un livello oggetto intelligente in un file PSD. È utilizzata per supportare i livelli oggetto intelligente nelle immagini Adobe® Photoshop®.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | Inizializza una nuova istanza della classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | Inizializza una nuova istanza della classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## Campi
...
| [TypeToolKey](#TypeToolKey) | La chiave di informazioni dello strumento tipo: 'SoLd'. |
...
Inizializza una nuova istanza della classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). È necessario impostare la proprietà Items o chiamare InitializeItems() per ottenere un'istanza pronta. Questo costruttore è progettato per essere utilizzato da [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) e nei test unitari. Utilizzare [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) per creare classi SoLdResource.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| uniqueId | java.util.UUID | L'identificatore unico dei dati del livello oggetto intelligente [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
Inizializza una nuova istanza della classe [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). Questo costruttore predefinito è progettato per essere utilizzato da SoLdResourceLoader. Utilizzare [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) per creare classi SoLdResource.
...
La chiave di informazioni dello strumento tipo: 'SoLd'.
