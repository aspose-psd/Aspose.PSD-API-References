...
description: Aspose.PSD.Shapes.RectangleShape klas. Stellt eine rechteckige Form dar.
type: docs
weight: 5530
...
| Name | Beschreibung |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | Initialisiert eine neue Instanz von`RectangleShape` Klasse. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | Initialisiert eine neue Instanz von`RectangleShape` Klasse. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | Ruft die Formsegmente ab. |
