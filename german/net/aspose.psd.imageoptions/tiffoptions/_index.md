...
| Name | Beschreibung |
| --- | --- |
| [TiffOptions](tiffoptions/#constructor_2)(TiffDataType[]) | Initialisiert eine neue Instanz von`TiffOptions` Klasse. |
| [TiffOptions](tiffoptions/#constructor)(TiffExpectedFormat) | Initialisiert eine neue Instanz von`TiffOptions` Klasse. Standardmäßig wird die Little-Endian-Konvention verwendet. |
| [TiffOptions](tiffoptions/#constructor_3)(TiffOptions) | Initialisiert eine neue Instanz von`TiffOptions` Klasse. |
| [TiffOptions](tiffoptions/#constructor_1)(TiffExpectedFormat, TiffByteOrder) | Initialisiert eine neue Instanz von`TiffOptions` Klasse. |
...
| [IsValid](../../aspose.psd.imageoptions/tiffoptions/isvalid/) { get; } | Ruft einen Wert ab, der angibt, ob die`TiffOptions` richtig konfiguriert wurden. Verwenden Sie die Validate-Methode, um die Fehlerursache zu finden. |
