...
description: "Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientMapSettings Klasse. Gradient‑Einstellungs‑Klasse für die Gradient‑Map‑Ebene. Sie enthält gemeinsame Eigenschaften für beide Gradienttypen Solid und Noise."
type: docs
weight: 2080
url: /de/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/
---
{{< psd/tize >}}
## GradientMapSettings class

Klasse für Gradient‑Einstellungen für die Gradient‑Map‑Ebene. Sie enthält gemeinsame Eigenschaften für beide Arten von Gradient (Solid und Noise).
...
| Name | Beschreibung |
| --- | --- |
| [GradientMapSettings](gradientmapsettings/)() | Der Standardkonstruktor. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/dither/) { get; set; } | Liest oder setzt einen Wert, der angibt, ob dieses [`GradientFillSettings`](../gradientfillsettings/) dithernd ist. |
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/) { get; set; } | Liest oder setzt eine spezifische Gradient‑Definitions‑Instanz (Solid/Noise). |
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/interpolationmethod/) { get; set; } | Liest oder setzt die Interpolationsmethode für den Gradient. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/reverse/) { get; set; } | Liest oder setzt einen Wert, der angibt, ob dieses [`GradientFillSettings`](../gradientfillsettings/) umgekehrt ist. |
