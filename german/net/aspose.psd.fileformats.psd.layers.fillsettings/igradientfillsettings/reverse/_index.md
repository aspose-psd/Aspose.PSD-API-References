...
description: IGradientFillSettings eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istIGradientFillSettings ist umgekehrt.
type: docs
weight: 90
url: /de/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/reverse/
---
## IGradientFillSettings.Reverse property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`IGradientFillSettings`](../) ist umgekehrt.
