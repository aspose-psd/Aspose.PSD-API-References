...
description: IGradientFillSettings eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istIGradientFillSettings ist Zittern.
type: docs
weight: 50
url: /de/net/aspose.psd.fileformats.psd.layers.fillsettings/igradientfillsettings/dither/
---
## IGradientFillSettings.Dither property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`IGradientFillSettings`](../) ist Zittern.
