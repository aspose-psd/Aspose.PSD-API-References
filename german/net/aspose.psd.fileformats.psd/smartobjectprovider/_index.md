---
title: "Klasse SmartObjectProvider"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Klasse Aspose.PSD.FileFormats.Psd.SmartObjectProvider. Definiert den Smart-Object-Provider, der das Abrufen/Setzen von Datenquellen aus globalen Link-Ressourcen der PSD-Datei und deren Inhalte ermöglicht."
type: docs
weight: 4470
url: /de/net/aspose.psd.fileformats.psd/smartobjectprovider/
---
{{< psd/tize >}}
## SmartObjectProvider class

Definiert den Smart-Object-Anbieter, der das Abrufen/Setzen von Datenquellen aus globalen Link-Ressourcen der PSD-Datei und deren Inhalt ermöglicht.
...
| Name | Beschreibung |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Konvertiert Ebenen in ein eingebettetes Smart-Object. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Konvertiert Ebenen in ein eingebettetes Smart-Object. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Bettet alle verknüpften Smart-Objects im Bild ein. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Erstellt eine neue Smart-Object-Ebene, indem die Quell-Ebene kopiert wird. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Aktualisiert den Inhalt aller modifizierten Smart Objects im Bild. |
