...
description: Aspose.PSD.FileFormats.Psd.SmartObjectProvider klas. Definiert den intelligenten Objektanbieter der das Abrufen/Festlegen von Datenquellen aus globalen Linkressourcen der PSDDatei und deren Inhalt bereitstellt.
type: docs
weight: 4000
...
Definiert den intelligenten Objektanbieter, der das Abrufen/Festlegen von Datenquellen aus globalen Linkressourcen der PSD-Datei und deren Inhalt bereitstellt.
...
| Name | Beschreibung |
| --- | --- |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject_1)(params int[]) | Konvertiert Ebenen in ein eingebettetes Smart-Objekt. |
| [ConvertToSmartObject](../../aspose.psd.fileformats.psd/smartobjectprovider/converttosmartobject/#converttosmartobject)(Layer[]) | Konvertiert Ebenen in ein eingebettetes Smart-Objekt. |
| [EmbedAllLinked](../../aspose.psd.fileformats.psd/smartobjectprovider/embedalllinked/)() | Bettet alle verknüpften Smart-Objekte in das Bild ein. |
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd/smartobjectprovider/newsmartobjectviacopy/)(SmartObjectLayer) | Erstellt eine neue intelligente Objektebene durch Kopieren der Quellebene. |
| [UpdateAllModifiedContent](../../aspose.psd.fileformats.psd/smartobjectprovider/updateallmodifiedcontent/)() | Aktualisiert den Inhalt aller geänderten Smart-Objekte im Bild. |
