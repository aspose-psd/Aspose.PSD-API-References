---
title: "Klasse NoiseGradient"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.NoiseGradient Klasse. Klasse zur Definition von Rausch‑Gradienten"
type: docs
weight: 2220
url: /de/net/aspose.psd.fileformats.psd.layers.gradient/noisegradient/
---
{{< psd/tize >}}
## NoiseGradient class

Klasse zur Definition von Rauschverläufen.
...
| Name | Beschreibung |
| --- | --- |
| [NoiseGradient](noisegradient/)() | Der Standardkonstruktor. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [ColorModel](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/colormodel/) { get; set; } | Liest oder setzt das Farbmodell – RGB/HSB/LAB (3/4/6). |
| [ExpansionCount](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/expansioncount/) { get; set; } | Liest oder setzt die Expansionsanzahl ( = 2 für Photoshop 6.0). |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/gradientmode/) { get; } | Liest den Modus für diesen Verlauf. Bestimmt 'Gradient Type' = 'Solid/Noise' (0/1). |
| [GradientName](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientname/) { get; set; } | Liest oder setzt den Namen des Verlaufs. |
| [MaximumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/maximumcolor/) { get; set; } | Liest oder setzt die maximale Farbe von PixelDataFormat. |
| [MinimumColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/minimumcolor/) { get; set; } | Liest oder setzt die minimale Farbe von PixelDataFormat. |
| [RndNumberSeed](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/rndnumberseed/) { get; set; } | Liest oder setzt den Zufallszahl-Seed, der zur Erzeugung von Farben für den Rauschverlauf verwendet wird. |
| [Roughness](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/roughness/) { get; set; } | Liest oder setzt den Rauheitsfaktor. |
| [ShowTransparency](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/showtransparency/) { get; set; } | Liest oder setzt das Flag zum Anzeigen von Transparenz. |
| [UseVectorColor](../../aspose.psd.fileformats.psd.layers.gradient/noisegradient/usevectorcolor/) { get; set; } | Liest oder setzt das Flag zur Verwendung von Vektorfarbe. |

## Beispiele

Demonstriert das Lesen und Ändern von Noise‑ und Solid‑Gradient‑Einstellungen in Strich‑Fülleffekten.
...
using (PsdImage image = (PsdImage)Image.Load(inputFile, loadOptions))
{
    ...
    // Gemeinsame Eigenschaften der Gradient‑Fülleinstellungen prüfen
    ...
    // Überprüfen Sie die Eigenschaften des Rauschgradienten
