---
title: "Klasse SolidGradient"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.SolidGradient Klasse. Einstellungen für den Farbverlauf-Füllungseffekt"
type: docs
weight: 2230
url: /de/net/aspose.psd.fileformats.psd.layers.gradient/solidgradient/
---
{{< psd/tize >}}
## SolidGradient class

Einstellungen für den Farbverlaufsfüllungseffekt.
...
| Name | Beschreibung |
| --- | --- |
| [SolidGradient](solidgradient/)() | Der Standardkonstruktor. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [ColorPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/colorpoints/) { get; set; } | Liest oder setzt die Farbpunkte. |
| override [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/gradientmode/) { get; } | Liest den Modus für diesen Verlauf. Bestimmt 'Gradient Type' = 'Solid/Noise' (0/1). |
...
| [Interpolation](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/interpolation/) { get; set; } | Liest und setzt Interpolation. Bestimmt die Glätte, wenn 'Gradient Type' = 'Solid'. Wertebereich: 0-4096. |
| [TransparencyPoints](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/transparencypoints/) { get; set; } | Liest oder setzt die Transparenzpunkte. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| [AddColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addcolorpoint/)() | Fügt den Farbpunkt hinzu. |
| [AddTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/addtransparencypoint/)() | Fügt den Farbpunkt hinzu. |
| [RemoveColorPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removecolorpoint/)(IGradientColorPoint) | Entfernt den Farbpunkt. |
| [RemoveTransparencyPoint](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/removetransparencypoint/)(IGradientTransparencyPoint) | Entfernt den Transparenzpunkt. |
| static [GenerateLfx2ResourceNodes](../../aspose.psd.fileformats.psd.layers.gradient/solidgradient/generatelfx2resourcenodes/)() | Erzeugt die LFX2-Ressourcenknoten. |
