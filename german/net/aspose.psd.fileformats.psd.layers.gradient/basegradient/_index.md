---
title: "Klasse BaseGradient"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient Klasse. Basisklasse zur Definition von Gradienten. Sie enthält gemeinsame Eigenschaften für beide Gradiententypen, Solid und Noise"
type: docs
weight: 2190
url: /de/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| Name | Beschreibung |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | Liest den Modus für diesen Verlauf. Bestimmt 'Gradient Type' = 'Solid/Noise' (0/1). |
