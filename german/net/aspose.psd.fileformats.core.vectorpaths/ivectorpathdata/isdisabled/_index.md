...
description: IVectorPathData eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob diese Instanz deaktiviert ist.
type: docs
weight: 10
...
`WAHR` wenn diese Instanz deaktiviert ist; ansonsten,`FALSCH` .
