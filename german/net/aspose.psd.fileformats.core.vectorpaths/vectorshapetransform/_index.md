---
title: "Klasse VectorShapeTransform"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Core.VectorPaths.VectorShapeTransform Klasse. Definiert die Klasse für die Transformationsmatrix von Vektorformen."
type: docs
weight: 1470
...
Definiert die Transformationsmatrix‑Klasse für Vektorformen
...
| Name | Beschreibung |
| --- | --- |
| [VectorShapeTransform](vectorshapetransform/)() | Initialisiert eine neue Instanz der `VectorShapeTransform` Klasse. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Tx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/tx/) { get; set; } | Liest oder setzt den TX-Wert. |
| [Ty](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/ty/) { get; set; } | Liest oder setzt den TY-Wert. |
| [Xx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xx/) { get; set; } | Liest oder setzt den XX-Wert. |
| [Xy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/xy/) { get; set; } | Liest oder setzt den XY-Wert. |
| [Yx](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yx/) { get; set; } | Liest oder setzt den YX-Wert. |
| [Yy](../../aspose.psd.fileformats.core.vectorpaths/vectorshapetransform/yy/) { get; set; } | Liest oder setzt den YY-Wert. |
