...
description: Ruft einen Wert ab der angibt ob diese Instanz die Transformationseigenschaft hat.
type: docs
weight: 100
...
`Stimmt` wenn diese Instanz die transform-Eigenschaft hat; Andernfalls,`FALSCH` .
