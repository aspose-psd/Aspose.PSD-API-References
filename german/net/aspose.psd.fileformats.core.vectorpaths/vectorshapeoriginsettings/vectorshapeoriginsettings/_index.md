...
description: "VectorShapeOriginSettings Konstruktor. Initialisiert eine neue Instanz der VectorShapeOriginSettings‑Klasse"
type: docs
weight: 10
url: /de/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

Initialisiert eine neue Instanz der [`VectorShapeOriginSettings`](../)-Klasse.
...
| --- | --- | --- |
| isShapeInvalidated | Boolean | Der Wert, ob die Form ungültig ist. |
| originIndex | Int32 | Der Ursprung‑Index der Form. |
