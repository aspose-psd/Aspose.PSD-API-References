...
description: Ruft einen Wert ab der angibt ob diese Instanz die Eigenschaft Ecken des Ursprungsfelds hat.
type: docs
weight: 20
...
`Stimmt` wenn diese Instanz die Eigenschaft Ecken des Ursprungsfelds hat; Andernfalls,`FALSCH` .
