...
description: Erstellen Sie eine neue Instanz derFillLayeraspose.psd.fileformats.psd.layers.filllayers/filllayer Klasse nach Art der Füllung.
type: docs
weight: 10
...
Erstellen Sie eine neue Instanz der[`FillLayer`](../../filllayer) Klasse nach Art der Füllung.
...
Gibt eine neue Instanz von zurück[`FillLayer`](../../filllayer) Klasse nach Art der Füllung.
