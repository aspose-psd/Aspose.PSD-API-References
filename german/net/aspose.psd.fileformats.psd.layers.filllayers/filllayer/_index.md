...
description: Ebene füllen. Farbfüllung Verlaufsfüllung oder Musterfüllungsebene die sich durch unterscheidetFillSettings./filllayer/fillsettings
type: docs
weight: 1890
...
| Name | Beschreibung |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance)(FillType) | Erstellen Sie eine neue Instanz der[`FillLayer`](../filllayer) Klasse nach Art der Füllung. |
