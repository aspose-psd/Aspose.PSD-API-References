---
title: "Klasse FillLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer class. Füllschicht. Farbfüllung, Farbverlauf oder Musterfüllschicht, die sich durch FillSettings unterscheidet"
type: docs
weight: 2020
...
Füllschicht. Farbfüllung, Farbverlauf oder Musterfüllschicht, die sich durch [`FillSettings`](./fillsettings/) unterscheidet
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | Liest oder setzt die Füll-Einstellungen. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | Gibt den Typ der Füllung zurück. |
...
| Name | Beschreibung |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | Erstelle eine neue Instanz der `FillLayer`-Klasse anhand des Fülltyps. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | Ersetzt alle nicht‑transparenten Farben durch eine neue Farbe und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. Hinweis: Wenn Sie dies bei Bildern ohne Transparenz verwenden, werden alle Farben durch eine einzige ersetzt. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | Aktualisiert die Pixeldaten der Füllschicht basierend auf den aktuellen [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
