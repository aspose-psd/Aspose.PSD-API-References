...
description: Die PlugInRessource für animierte Datenabschnitte.
type: docs
weight: 3570
...
| override [DataSize](../../aspose.psd.fileformats.psd.resources/animateddatasectionresource/datasize) { get; } | Ruft die Ressourcendatengröße in Bytes ab. |
