...
description: PixelSeitenverhältnis resource
type: docs
weight: 3760
url: /de/net/aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
## PixelAspectRatioResource class

Pixel-Seitenverhältnis resource
...
| Name | Beschreibung |
| --- | --- |
| [PixelAspectRatioResource](pixelaspectratioresource)() | Default_Constructor |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [AspectRatio](../../aspose.psd.fileformats.psd.resources/pixelaspectratioresource/aspectratio) { get; set; } | Ruft das Seitenverhältnis ab oder legt es fest. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/pixelaspectratioresource/datasize) { get; } | Ruft die Ressourcendatengröße in Bytes ab. |
...
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/pixelaspectratioresource/minimalversion) { get; } | Ruft die minimal erforderliche PSD-Version ab. |
...
| [Version](../../aspose.psd.fileformats.psd.resources/pixelaspectratioresource/version) { get; set; } | Ruft die Version ab oder legt sie fest. |
