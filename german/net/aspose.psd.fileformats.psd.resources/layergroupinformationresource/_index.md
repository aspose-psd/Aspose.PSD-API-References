...
description: Aspose.PSD.FileFormats.Psd.Resources.LayerGroupInformationResource klas. Schichtgruppeninformationen resource
type: docs
weight: 3780
...
Schichtgruppeninformationen resource
...
| Name | Beschreibung |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/layergroupinformationresource/datasize/) { get; } | Ruft die Ressourcendatengröße in Byte ab. |
| [Groups](../../aspose.psd.fileformats.psd.resources/layergroupinformationresource/groups/) { get; set; } | Ruft die Gruppen ab oder legt sie fest. |
