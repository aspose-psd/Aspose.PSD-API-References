---
title: "Klasse UnicodeAlphaNamesResource"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Resources.UnicodeAlphaNamesResource Klasse. Unicode‑Alpha‑Namens‑Ressource"
type: docs
weight: 4400
url: /de/net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
{{< psd/tize >}}
## UnicodeAlphaNamesResource class

Unicode Alpha-Namen-Ressource
...
| Name | Beschreibung |
| --- | --- |
| [UnicodeAlphaNamesResource](unicodealphanamesresource/)() | Der Standardkonstruktor. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [AlphaNames](../../aspose.psd.fileformats.psd.resources/unicodealphanamesresource/alphanames/) { get; set; } | Liest oder setzt die Alpha-Namen. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/unicodealphanamesresource/datasize/) { get; } | Ruft die Größe der Ressourcendaten in Bytes ab. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Ruft die eindeutige Kennung der Ressource ab oder legt sie fest. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/unicodealphanamesresource/minimalversion/) { get; } | Ruft die minimal erforderliche PSD-Version ab. |
