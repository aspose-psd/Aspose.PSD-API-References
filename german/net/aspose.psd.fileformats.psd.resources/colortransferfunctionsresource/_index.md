---
title: "Klasse ColorTransferFunctionsResource"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Resources.ColorTransferFunctionsResource Klasse. Farbübertragungs-Ressource"
type: docs
weight: 4140
url: /de/net/aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
{{< psd/tize >}}
## ColorTransferFunctionsResource class

Color transfer Ressource
...
| Name | Beschreibung |
| --- | --- |
| [ColorTransferFunctionsResource](colortransferfunctionsresource/)() | Der Standardkonstruktor. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [ColorTransferData](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/colortransferdata/) { get; set; } | Liest oder legt die Farbübertragungsdaten fest. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/datasize/) { get; } | Ruft die Größe der Ressourcendaten in Bytes ab. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Ruft die eindeutige Kennung der Ressource ab oder legt sie fest. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/minimalversion/) { get; } | Ruft die minimal erforderliche PSD-Version ab. |
