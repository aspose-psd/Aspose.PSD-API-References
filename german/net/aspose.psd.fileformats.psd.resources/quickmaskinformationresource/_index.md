...
description: Schnellmaskeninformationsressource
type: docs
weight: 3790
url: /de/net/aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
## QuickMaskInformationResource class

Schnellmaskeninformationsressource
...
| Name | Beschreibung |
| --- | --- |
| [ChannelId](../../aspose.psd.fileformats.psd.resources/quickmaskinformationresource/channelid) { get; set; } | Ruft die Kanalkennung ab oder legt sie fest. |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/quickmaskinformationresource/datasize) { get; } | Ruft die Ressourcendatengröße in Bytes ab. |
...
| [IsMaskEmpty](../../aspose.psd.fileformats.psd.resources/quickmaskinformationresource/ismaskempty) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob diese Instanz maskenleer ist. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/quickmaskinformationresource/minimalversion) { get; } | Ruft die minimal erforderliche PSD-Version ab. |
