---
title: "Klasse ColorHalftoneInformationResource"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Resources.ColorHalftoneInformationResource Klasse. Halftoning-Ressource."
type: docs
weight: 4130
url: /de/net/aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
{{< psd/tize >}}
## ColorHalftoneInformationResource class

Halftoning Ressource
...
| Name | Beschreibung |
| --- | --- |
| [ColorHalftoneInformationResource](colorhalftoneinformationresource/)() | Der Standardkonstruktor. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/datasize/) { get; } | Ruft die Größe der Ressourcendaten in Bytes ab. |
| [HalftoneData](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/halftonedata/) { get; set; } | Liest oder setzt die Halftone-Daten. |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | Ruft die eindeutige Kennung der Ressource ab oder legt sie fest. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/minimalversion/) { get; } | Ruft die minimal erforderliche PSD-Version ab. |
