...
description: Der Adobe PhotoshopStricheffekt für die PSDEbene.
type: docs
weight: 2170
...
| [Overprint](../../aspose.psd.fileformats.psd.layers.layereffects/strokeeffect/overprint) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`StrokeEffect`](../strokeeffect) wird Striche mit aktuellen Ebeneninhalten mischen. |
