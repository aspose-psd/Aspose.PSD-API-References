...
description: "StrokeEffect-Eigenschaft. Ruft einen Wert ab oder legt ihn fest, der angibt, ob dieser StrokeEffect den Strich mit den aktuellen Ebeneninhalten mischt"
type: docs
weight: 60
...
Ruft einen Wert ab oder legt ihn fest, der angibt, ob dieses [`StrokeEffect`](../) den Strich mit den aktuellen Ebeneninhalten mischt.
...
`true`, wenn der Strich mit den aktuellen Ebeneninhalten gemischt werden muss; andernfalls `false`.
