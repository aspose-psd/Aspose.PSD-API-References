...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istStrokeEffectaspose.psd.fileformats.psd.layers.layereffects/strokeeffect wird Striche mit aktuellen Ebeneninhalten mischen.
type: docs
weight: 60
...
Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`StrokeEffect`](../../strokeeffect) wird Striche mit aktuellen Ebeneninhalten mischen.
...
`Stimmt`wenn Striche mit aktuellen Ebeneninhalten gemischt werden müssen; Andernfalls,`FALSCH` .
