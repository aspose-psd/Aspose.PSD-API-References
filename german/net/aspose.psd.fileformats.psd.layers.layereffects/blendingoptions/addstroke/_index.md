...
description: "BlendingOptions-Methode. Fügt den Kontur-Effekt hinzu."
type: docs
weight: 90
...
| --- | --- | --- |
| fillType | FillType | Der Typ der Füllung, um die Kontur zu füllen. |

### Rückgabewert

Erstellt das Objekt [`StrokeEffect`](../../strokeeffect/).
