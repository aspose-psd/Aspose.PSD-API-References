...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob diese Ebene gesperrt ist. Verhindert Änderungen am Element.
type: docs
weight: 60
...
`Stimmt` wenn diese Ebene gesperrt ist; Andernfalls,`FALSCH` .
