...
description: "AiLayerSection Eigenschaft. Gibt einen Wert zurück oder legt ihn fest, der angibt, ob diese Ebene eine Vorlagenebene ist"
type: docs
weight: 120
...
`true`, wenn diese Ebene eine Vorlage ist; andernfalls `false`.
