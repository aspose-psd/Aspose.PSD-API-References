...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob diese Ebene eine Vorlagenebene ist.
type: docs
weight: 100
...
`Stimmt` wenn diese Ebene eine Vorlage ist; Andernfalls,`FALSCH` .
