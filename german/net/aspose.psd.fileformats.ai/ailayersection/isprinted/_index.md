...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob diese Ebene gedruckt wird. Macht das in der Ebene enthaltene Bildmaterial druckbar wenn wahr.
type: docs
weight: 80
...
`Stimmt` wenn diese Schicht gedruckt wird; Andernfalls,`FALSCH` .
