...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob diese Ebene angezeigt wird. Zeigt alle in der Ebene enthaltenen Grafiken auf der Zeichenfläche an falls wahr.
type: docs
weight: 90
...
`Stimmt` wenn dieser Layer angezeigt wird; Andernfalls,`FALSCH` .
