...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup klas. Gruppenebenenklasse
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Ruft den Mischmodusschlüssel ab oder legt ihn fest. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | Ruft die Höhe der Ebenengruppe ab. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Ruft ab oder legt fest, ob der Ordner geöffnet ist , wenn auf eingestellt`WAHR` Diese Gruppe befindet sich beim Start im geöffneten Zustand, ansonsten im minimierten Zustand. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Ruft die Ebenen in der Ebenengruppe ab |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | Ruft die Breite der Ebenengruppe ab. |
