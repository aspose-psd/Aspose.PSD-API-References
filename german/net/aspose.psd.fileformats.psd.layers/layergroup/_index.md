...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen) { get; set; } | Ruft ab oder legt fest, ob der Ordner geöffnet ist , wenn auf eingestellt`Stimmt` Diese Gruppe befindet sich beim Start im geöffneten Zustand, ansonsten im minimierten Zustand. |
