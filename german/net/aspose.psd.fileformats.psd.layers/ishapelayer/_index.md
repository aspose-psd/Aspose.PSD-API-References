---
title: "Schnittstelle IShapeLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.IShapeLayer Schnittstelle. Beschreibt die Eigenschaften des Shape-Layers."
type: docs
weight: 2260
url: /de/net/aspose.psd.fileformats.psd.layers/ishapelayer/
---
{{< psd/tize >}}
## IShapeLayer interface

Beschreibt die Eigenschaften der Formebene.
...
| Name | Beschreibung |
| --- | --- |
| [Fill](../../aspose.psd.fileformats.psd.layers/ishapelayer/fill/) { get; set; } | Fülleinstellungen, die zum Füllen des inneren Bereichs von Shapes verwendet werden. |
| [Path](../../aspose.psd.fileformats.psd.layers/ishapelayer/path/) { get; } | Die Menge der Pfade, die in einem Shape-Layer vorhanden sind. |
| [Stroke](../../aspose.psd.fileformats.psd.layers/ishapelayer/stroke/) { get; set; } | Strich‑Einstellungen von Formen. |
