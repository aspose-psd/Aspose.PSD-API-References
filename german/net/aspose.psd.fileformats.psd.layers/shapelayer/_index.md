---
title: "Klasse ShapeLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer Klasse. Shape layer. Kapselt die Logik der Arbeit mit dem Shape layer und zugehörigen Ressourcen."
type: docs
weight: 3820
url: /de/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

Formebene. Kapselt die Logik der Arbeit mit Formebenen und zugehörigen Ressourcen.
...
| Name | Beschreibung |
| --- | --- |
| [ShapeLayer](shapelayer/)() | Initialisiert eine neue Instanz der `ShapeLayer`-Klasse. Alle Ressourcen werden im Standardzustand erstellt. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | Ruft die Fülleinstellungen für den internen Bereich von Shapes im Shape layer ab oder legt sie fest. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | Ruft die Menge der Pfade ab, die in einem Shape layer vorhanden sind. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | Ruft die Strich-Einstellungen von Shapes ab oder legt sie fest. |
...
| Name | Beschreibung |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | Erstellt eine neue Instanz der `ShapeLayer`-Klasse. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | Aktualisiert Ressourcen aus den Eigenschaften der Shape-Ebene. |
