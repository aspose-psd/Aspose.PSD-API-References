...
description: Ruft die abLayerGroupaspose.psd.fileformats.psd.layers/layergroup das hängt damit zusammenSectionDividerLayeraspose.psd.fileformats.psd.layers/sectiondividerlayer Instanz.
type: docs
weight: 20
...
Ruft die ab[`LayerGroup`](../../layergroup) das hängt damit zusammen[`SectionDividerLayer`](../../sectiondividerlayer) Instanz.
...
Das[`LayerGroup`](../../layergroup) Beispiel.
