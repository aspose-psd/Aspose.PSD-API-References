---
title: "Klasse SectionDividerLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer class. Die Abschnittstrennschicht, um die Grenzen der Ordner‑Ebenengruppe zu markieren"
type: docs
weight: 3810
url: /de/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
{{< psd/tize >}}
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | Liefert einen Wert, der angibt, ob diese Instanz in einer Gruppe sichtbar ist (Wenn die Ebene nicht in einer Gruppe ist, bedeutet das die Stammgruppe). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | Ruft das [`LayerGroup`](../layergroup/) ab, das zu dieser `SectionDividerLayer`‑Instanz gehört. |
