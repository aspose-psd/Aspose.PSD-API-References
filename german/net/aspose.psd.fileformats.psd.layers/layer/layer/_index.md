...
description: Initialisiert eine neue Instanz vonLayeraspose.psd.fileformats.psd.layers/layer Klasse. Konstruktor für verzögerte Initialisierung.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von[`Layer`](../../layer) Klasse. Konstruktor für verzögerte Initialisierung.
...
| disposeImage | Boolean | wenn eingestellt`Stimmt` [Bild entsorgen]. |
...
Initialisiert eine neue Instanz von[`Layer`](../../layer) Klasse aus Byte-Arrays.
