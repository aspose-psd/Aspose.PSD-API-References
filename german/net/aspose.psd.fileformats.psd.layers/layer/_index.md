...
| Name | Beschreibung |
| --- | --- |
| [Layer](layer#constructor)() | Initialisiert eine neue Instanz von[`Layer`](../layer) Klasse. Konstruktor für verzögerte Initialisierung. |
| [Layer](layer#constructor_3)(Stream) | Initialisiert eine neue Instanz von[`Layer`](../layer) Klasse. |
| [Layer](layer#constructor_1)(RasterImage, bool) | Initialisiert eine neue Instanz von[`Layer`](../layer) Klasse. |
| [Layer](layer#constructor_2)(Rectangle, byte[], byte[], byte[], string) | Initialisiert eine neue Instanz von[`Layer`](../layer) Klasse aus Byte-Arrays. |
