---
title: "Klasse TextLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.TextLayer Klasse. Die Textebenenklasse"
type: docs
weight: 3980
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | Liest die Schriftart. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | Liest den Text der Ebene |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | Liest den Text. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | Liest oder setzt die Textbegrenzungsbox. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | Liest die Farbe des Textes. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | Liest die Textabschnitte. |
| virtual [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | Liest oder setzt die obere Ebenenposition. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | Liest oder setzt die Transformationsmatrix |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | Liest oder setzt Warp-Parameter, die aus der Ressource festgelegt oder abgerufen wurden (Standard). |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | Ermittelt das Schriftarten-Set der Textebene. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | Skaliert das Bild. Der Standard LeftTopToLeftTop wird verwendet. |
