...
description: HashRechner für PSDLayer. Es kann verwendet werden um gleiche oder unterschiedliche Ebenen in verschiedenen PSDDateien zu finden
type: docs
weight: 2210
...
| Name | Beschreibung |
| --- | --- |
| [LayerHashCalculator](layerhashcalculator)(Layer) | Initialisiert eine neue Instanz von[`LayerHashCalculator`](../layerhashcalculator) Klasse. |
