...
description: "Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer Klasse. Die Artboard‑Layer‑Klasse"
type: docs
weight: 1990
url: /de/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | Liest oder setzt die Artboard‑Hintergrundfarbe. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | Liest oder setzt den Schlüssel des Mischmodus. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | Liest oder setzt einen Wert, der angibt, ob `ArtboardLayer` die Hintergrundfarbe hat. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Liest oder setzt, ob der Ordner geöffnet ist; wenn er auf `true` gesetzt wird, ist die Gruppe beim Start geöffnet, andernfalls im minimierten Zustand. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | Liest die Ebenen in der Ebenengruppe |
...
| Name | Beschreibung |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | Fügt die Ebene der Ebenengruppe hinzu. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | Fügt die Ebenengruppe hinzu. |
