...
description: Aspose.PSD.SplitStreamContainer klas. Repräsentiert SplitStreamContainer der den Stream enthält und StreamVerarbeitungsroutinen bereitstellt.
type: docs
weight: 5630
...
| Name | Beschreibung |
| --- | --- |
| [SplitStreamContainer](splitstreamcontainer/#constructor_1)(Stream) | Initialisiert eine neue Instanz von`SplitStreamContainer` Klasse. |
| [SplitStreamContainer](splitstreamcontainer/#constructor_2)(Stream, bool) | Initialisiert eine neue Instanz von`SplitStreamContainer` Klasse. |
| [SplitStreamContainer](splitstreamcontainer/#constructor)(StreamContainer, bool) | Initialisiert eine neue Instanz von`SplitStreamContainer` Klasse. |
