...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| buffer | Byte[] | Ein Array von Bytes. Wenn diese Methode zurückkehrt, enthält der Puffer das angegebene Bytearray mit den Werten dazwischen*offset* und (*offset* +*count* - 1) durch die aus der aktuellen Quelle gelesenen Bytes ersetzt. |
