...
description: Aspose.PSD.StreamContainer klas. Stellt den StreamContainer dar der den Stream enthält und StreamVerarbeitungsroutinen bereitstellt.
type: docs
weight: 5640
...
| Name | Beschreibung |
| --- | --- |
| [StreamContainer](streamcontainer/#constructor)(Stream) | Initialisiert eine neue Instanz von`StreamContainer` Klasse. |
| [StreamContainer](streamcontainer/#constructor_1)(Stream, bool) | Initialisiert eine neue Instanz von`StreamContainer` Klasse. |
...
| [explicit operator](../../aspose.psd/streamcontainer/op_explicit/) | Führt eine explizite Konvertierung von aus`StreamContainer` ZuStream . |
