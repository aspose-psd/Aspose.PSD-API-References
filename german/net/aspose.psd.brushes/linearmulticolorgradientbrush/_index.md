...
description: Aspose.PSD.Brushes.LinearMulticolorGradientBrush klas. steht für aBrush mit linearem Farbverlauf der durch mehrere Farben und geeignete Positionen definiert ist. Diese Klasse kann nicht vererbt werden.
type: docs
weight: 160
...
steht für a[`Brush`](../../aspose.psd/brush/) mit linearem Farbverlauf, der durch mehrere Farben und geeignete Positionen definiert ist. Diese Klasse kann nicht vererbt werden.
...
| Name | Beschreibung |
| --- | --- |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor)() | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse mit Standardparametern. Die Startfarbe ist Schwarz, die Endfarbe Weiß, der Winkel beträgt 45 Grad und das Rechteck befindet sich in (0,0) mit der Größe (1,1). |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_1)(Point, Point) | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse mit den angegebenen Punkten. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_2)(PointF, PointF) | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse mit den angegebenen Punkten. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_3)(Rectangle, float) | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse basierend auf einem Rechteck und einem Orientierungswinkel. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_5)(RectangleF, float) | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse basierend auf einem Rechteck und einem Orientierungswinkel. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_4)(Rectangle, float, bool) | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse basierend auf einem Rechteck und einem Orientierungswinkel. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_6)(RectangleF, float, bool) | Initialisiert eine neue Instanz von`LinearMulticolorGradientBrush` Klasse basierend auf einem Rechteck und einem Orientierungswinkel. |
...
| [InterpolationColors](../../aspose.psd.brushes/linearmulticolorgradientbrush/interpolationcolors/) { get; set; } | Holt oder setzt a[`ColorBlend`](../../aspose.psd/colorblend/) das einen mehrfarbigen linearen Farbverlauf definiert. |
