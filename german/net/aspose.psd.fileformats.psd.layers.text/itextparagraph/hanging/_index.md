...
description: ITextParagraph eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istITextParagraph hängt.
type: docs
weight: 90
...
Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`ITextParagraph`](../) hängt.
...
`WAHR` wenn hängend; ansonsten,`FALSCH` .
