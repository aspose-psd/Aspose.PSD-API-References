...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph hängt.
type: docs
weight: 90
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`ITextParagraph`](../../itextparagraph) hängt.
...
`Stimmt` wenn hängend; Andernfalls,`FALSCH` .
