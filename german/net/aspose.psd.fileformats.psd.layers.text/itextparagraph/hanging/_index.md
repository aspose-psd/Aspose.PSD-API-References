...
description: "ITextParagraph-Eigenschaft. Ruft einen Wert ab oder legt ihn fest, der angibt, ob dieses ITextParagraph hängend ist"
type: docs
weight: 90
...
Ruft einen Wert ab oder legt ihn fest, der angibt, ob dieses [`ITextParagraph`](../) hängend ist.
...
`true` wenn hängend; andernfalls `false`.
