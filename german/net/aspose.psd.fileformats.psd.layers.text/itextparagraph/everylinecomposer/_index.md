...
description: ITextParagraph eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob jeder Zeilenkomponist.
type: docs
weight: 60
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob [jeder Zeilenkomponist].
...
`WAHR` if [jeder Zeilenkomponist]; ansonsten,`FALSCH` .
