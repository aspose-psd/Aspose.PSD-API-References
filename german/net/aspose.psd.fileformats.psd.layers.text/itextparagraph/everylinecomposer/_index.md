...
description: "ITextParagraph property. Liest oder setzt einen Wert, der angibt, ob jeder Zeilen-Composer"
type: docs
weight: 60
...
Ruft den Wert ab oder legt ihn fest, der angibt, ob [every line composer].
...
`true` wenn [every line composer]; sonst `false`.
