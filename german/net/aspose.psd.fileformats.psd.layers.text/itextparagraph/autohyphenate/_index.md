...
description: "ITextParagraph-Eigenschaft. Liest oder schreibt einen Wert, der angibt, ob automatische Silbentrennung aktiviert ist"
type: docs
weight: 10
...
Ruft den Wert ab oder legt ihn fest, der angibt, ob [automatic hyphenate].
...
`true` wenn [automatische Silbentrennung]; andernfalls `false`.
