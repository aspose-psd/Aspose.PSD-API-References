...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob automatische Silbentrennung.
type: docs
weight: 10
...
`Stimmt` if [automatische Silbentrennung]; Andernfalls,`FALSCH` .
