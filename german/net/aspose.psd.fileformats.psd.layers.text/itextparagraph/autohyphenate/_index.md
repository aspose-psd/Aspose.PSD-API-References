...
description: ITextParagraph eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob automatische Silbentrennung.
type: docs
weight: 10
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob [automatische Silbentrennung].
...
`WAHR` if [automatische Silbentrennung]; ansonsten,`FALSCH` .
