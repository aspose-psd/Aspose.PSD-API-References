...
description: "ITextParagraph-Eigenschaft. Ruft einen Wert ab oder legt ihn fest, der angibt, ob dieses ITextParagraph burasagiri ist"
type: docs
weight: 30
...
Ruft einen Wert ab oder legt ihn fest, der angibt, ob dieses [`ITextParagraph`](../) burasagiri ist.
...
`true` wenn burasagiri; andernfalls `false`.
