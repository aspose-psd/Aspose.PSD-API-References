...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istITextParagraphaspose.psd.fileformats.psd.layers.text/itextparagraph ist burasagiri.
type: docs
weight: 30
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/burasagari/
---
## ITextParagraph.Burasagari property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`ITextParagraph`](../../itextparagraph) ist burasagiri.
...
`Stimmt` wenn burasagiri; Andernfalls,`FALSCH` .
