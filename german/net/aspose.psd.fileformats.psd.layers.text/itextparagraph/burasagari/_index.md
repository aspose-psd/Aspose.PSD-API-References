...
description: ITextParagraph eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istITextParagraphist burasagiri.
type: docs
weight: 30
...
Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`ITextParagraph`](../)ist burasagiri.
...
`WAHR` wenn burasagiri; ansonsten,`FALSCH` .
