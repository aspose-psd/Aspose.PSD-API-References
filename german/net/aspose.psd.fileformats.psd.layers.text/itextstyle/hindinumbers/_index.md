...
description: ITextStyle eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob HindiZahlen.
type: docs
weight: 150
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
## ITextStyle.HindiNumbers property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob [Hindi-Zahlen].
...
`WAHR` if [Hindi-Zahlen]; ansonsten,`FALSCH` .
