...
description: ITextStyle eigendom. Ruft einen Wert ab oder legt einen Wert fest der angibt ob automatischer Zeilenabstand.
type: docs
weight: 20
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob [automatischer Zeilenabstand].
...
`WAHR` if [automatische Führung]; ansonsten,`FALSCH` .
