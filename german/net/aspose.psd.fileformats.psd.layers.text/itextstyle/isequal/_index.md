...
description: ITextStyle methode. Bestimmt ob der angegebene Stil gleich ist.
type: docs
weight: 290
url: /de/net/aspose.psd.fileformats.psd.layers.text/itextstyle/isequal/
---
...
| --- | --- | --- |
| style | ITextStyle | Der Style. |

### Rückgabewert

`WAHR` wenn der angegebene Stil gleich ist; ansonsten,`FALSCH` .
