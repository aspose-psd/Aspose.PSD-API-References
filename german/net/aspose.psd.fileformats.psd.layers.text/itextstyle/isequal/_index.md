...
description: "ITextStyle method. Bestimmt, ob der angegebene Stil gleich ist"
type: docs
weight: 290
...
| --- | --- | --- |
| Stil | ITextStyle | Der Stil. |

### Rückgabewert

`true` wenn der angegebene Stil gleich ist; andernfalls `false`.
