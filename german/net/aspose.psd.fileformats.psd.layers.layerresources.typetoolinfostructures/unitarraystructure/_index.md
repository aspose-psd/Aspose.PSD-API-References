...
description: Definiert die UnitArrayStructureKlasse die enthältDouble WerteArray und ihre Maßeinheit. Es wird in den PSDDateiressourcen verwendet normalerweise vonObjectArrayStructure./objectarraystructure .
type: docs
weight: 3210
...
| Name | Beschreibung |
| --- | --- |
| [UnitArrayStructure](unitarraystructure)(ClassID, UnitTypes, double[]) | Initialisiert eine neue Instanz von[`UnitArrayStructure`](../unitarraystructure) Klasse. |
...
| [UnitType](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/unittype) { get; set; } | Ruft den Typ der Maßeinheit ab oder legt ihn fest[`UnitArrayStructure`](../unitarraystructure) Werte. |
...
| Name | Beschreibung |
| --- | --- |
| const [StructureKey](../../aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/structurekey) | Definiert das 'UnFl'[`UnitArrayStructure`](../unitarraystructure) Schlüssel. |
