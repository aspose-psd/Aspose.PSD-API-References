...
description: Definiert die ObjectArrayStructureKlasse die normalerweise verwendet wirdUnitArrayStructure./unitarraystructure array. Es wird in den PSDDateiressourcen verwendet z. B. PlLd Resource und SoLd Resource.
type: docs
weight: 3140
...
| Name | Beschreibung |
| --- | --- |
| [ObjectArrayStructure](objectarraystructure#constructor_1)(string, string, OSTypeStructure[]) | Initialisiert eine neue Instanz von[`ObjectArrayStructure`](../objectarraystructure) Klasse. |
| [ObjectArrayStructure](objectarraystructure#constructor)(int, ClassID, ClassID, string, OSTypeStructure[]) | Initialisiert eine neue Instanz von[`ObjectArrayStructure`](../objectarraystructure) Klasse. |
