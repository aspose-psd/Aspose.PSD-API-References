...
description: LiFeDataSource eigendom. Ruft die Größe der externen Datei in der LiFEDatenquelle der PSDLnkERessource ab oder legt sie fest.
type: docs
weight: 80
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
## LiFeDataSource.FileSize property

Ruft die Größe der externen Datei in der LiFE-Datenquelle der PSD-LnkE-Ressource ab oder legt sie fest.
...
| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die FileSize-Eigenschaft zugreifen, sie ist nur für die LIFE-Datenquelle verfügbar |
