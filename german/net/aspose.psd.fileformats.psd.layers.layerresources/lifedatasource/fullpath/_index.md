...
description: LiFeDataSource eigendom. Ruft den vollständigen Pfad der externen Datei in der LiFEDatenquelle der PSDLnkERessource ab oder legt ihn fest.
type: docs
weight: 90
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/
---
## LiFeDataSource.FullPath property

Ruft den vollständigen Pfad der externen Datei in der LiFE-Datenquelle der PSD-LnkE-Ressource ab oder legt ihn fest.
...
| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die FullPath-Eigenschaft zugreifen, sie ist nur für die LIFE-Datenquelle verfügbar |
