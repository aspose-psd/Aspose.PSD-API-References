...
description: "LiFeDataSource Eigenschaft. Gibt den vollständigen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource zurück oder legt ihn fest."
type: docs
weight: 90
...
| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die FullPath-Eigenschaft zugreifen, sie ist nur für LiFE-Datenquellen verfügbar. |
