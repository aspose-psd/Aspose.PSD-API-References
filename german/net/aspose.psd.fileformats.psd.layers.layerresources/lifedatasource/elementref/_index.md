...
description: LiFeDataSource eigendom. Ruft die Elementreferenz der Grafikbibliothek für Adobe Photoshop CCBibliotheken ab oder legt sie fest.
type: docs
weight: 60
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
## LiFeDataSource.ElementRef property

Ruft die Elementreferenz der Grafikbibliothek für Adobe® Photoshop® CC-Bibliotheken ab oder legt sie fest.
...
Die Elementreferenz der Grafikbibliothek.

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die Eigenschaft ElementRef zugreifen, sie ist nur für die LiFE-Datenquelle verfügbar, wenn IsLibrary wahr ist |
