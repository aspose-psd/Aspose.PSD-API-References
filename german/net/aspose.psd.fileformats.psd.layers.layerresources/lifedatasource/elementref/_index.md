...
description: "LiFeDataSource-Eigenschaft. Gibt die Grafikbibliothek-Elementreferenz für Adobe Photoshop CC Libraries zurück oder legt sie fest."
type: docs
weight: 60
...
Die Grafikbibliothek-Elementreferenz.

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die ElementRef-Eigenschaft zugreifen, sie ist nur für die liFE-Datenquelle verfügbar, wenn IsLibrary true ist. |
