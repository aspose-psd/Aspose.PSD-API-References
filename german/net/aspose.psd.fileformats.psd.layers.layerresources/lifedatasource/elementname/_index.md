...
description: "LiFeDataSource Eigenschaft. Gibt den Elementnamen der Grafikbibliothek für Adobe Photoshop CC Libraries zurück oder legt ihn fest."
type: docs
weight: 50
...
Der Elementname der Grafikbibliothek.

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die ElementName-Eigenschaft zugreifen, sie ist nur für LiFE-Datenquellen verfügbar, wenn IsLibrary true ist. |
