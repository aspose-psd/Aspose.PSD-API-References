...
description: LiFeDataSource eigendom. Ruft den Elementnamen der Grafikbibliothek für Adobe Photoshop CCBibliotheken ab oder legt ihn fest.
type: docs
weight: 50
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

Ruft den Elementnamen der Grafikbibliothek für Adobe® Photoshop® CC-Bibliotheken ab oder legt ihn fest.
...
Der Name des Grafikbibliothekselements.

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die Eigenschaft ElementName zugreifen, sie ist nur für die LiFE-Datenquelle verfügbar, wenn IsLibrary wahr ist |
