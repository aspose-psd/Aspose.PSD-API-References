...
description: "LiFeDataSource Eigenschaft. Gibt den relativen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource zurück oder legt ihn fest."
type: docs
weight: 100
...
| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die RelativePath-Eigenschaft zugreifen, sie ist nur für LiFE-Datenquellen verfügbar. |
