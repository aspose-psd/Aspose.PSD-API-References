...
description: LiFeDataSource eigendom. Ruft den relativen Pfad der externen Datei in der LiFEDatenquelle der PSDLnkERessource ab oder legt ihn fest.
type: docs
weight: 100
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
## LiFeDataSource.RelativePath property

Ruft den relativen Pfad der externen Datei in der LiFE-Datenquelle der PSD-LnkE-Ressource ab oder legt ihn fest.
...
Der relative Dateipfad.

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | Sie können nicht auf die RelativePath-Eigenschaft zugreifen, sie ist nur für die LIFE-Datenquelle verfügbar |
