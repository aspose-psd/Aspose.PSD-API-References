...
description: Initialisiert eine neue Instanz vonVmskResourceaspose.psd.fileformats.psd.layers.layerresources/vmskresource Klasse.
type: docs
weight: 10
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/vmskresource/
---
## VmskResource(byte[]) {#constructor_1}

Initialisiert eine neue Instanz von[`VmskResource`](../../vmskresource) Klasse.
...
| Ausnahme | Bedingung |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception) | Ungültiger Vmsk-Ressourcenwert |
