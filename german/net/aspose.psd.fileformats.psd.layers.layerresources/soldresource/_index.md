---
title: "Klasse SoLdResource"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource Klasse. Definiert die SoLdResource‑Klasse, die Informationen über eine Smart‑Object‑Ebene in einer PSD‑Datei enthält. Wird verwendet, um Smart‑Object‑Ebenen in Adobe‑Photoshop‑Bildern zu unterstützen."
type: docs
weight: 3370
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
{{< psd/tize >}}
## SoLdResource class

Definiert die Klasse **SoLdResource**, die Informationen über eine Smart‑Object‑Ebene in einer PSD‑Datei enthält. Sie wird verwendet, um Smart‑Object‑Ebenen in den Adobe‑Photoshop‑Bildern zu unterstützen.
...
| Name | Beschreibung |
| --- | --- |
| [SoLdResource](soldresource/#constructor)() | Initialisiert eine neue Instanz der `SoLdResource`‑Klasse. Dieser Standardkonstruktor ist für die Verwendung durch SoLdResourceLoader vorgesehen. Verwenden Sie [`SmartResourceCreator`](../smartresourcecreator/) zum Erstellen von SoLdResource‑Klassen. |
| [SoLdResource](soldresource/#constructor_1)(Guid, bool, bool) | Initialisiert eine neue Instanz der `SoLdResource`‑Klasse. Es ist notwendig, die Items‑Eigenschaft zu setzen oder InitializeItems() aufzurufen, um eine fertige Instanz zu erhalten. Dieser Konstruktor ist für die Verwendung durch [`SmartResourceCreator`](../smartresourcecreator/) und in Unit‑Tests vorgesehen. Verwenden Sie [`SmartResourceCreator`](../smartresourcecreator/) zum Erstellen von SoLdResource‑Klassen. |
...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | Liest oder setzt die global eindeutige Kennung der Smart‑Object‑Ebenen‑Daten [`SmartObjectResource`](../smartobjectresource/) im PSD‑Bild. |
...
| Name | Beschreibung |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | Der Typwerkzeug‑Info‑Schlüssel: 'SoLd'. |
