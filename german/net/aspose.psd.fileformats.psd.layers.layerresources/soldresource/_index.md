...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource klas. Definiert die SoLdResourceKlasse die Informationen zu einer SmartObjektEbene in einer PSDDatei enthält. Wird verwendet um SmartObjektEbenen in den Adobe PhotoshopBildern zu unterstützen.
type: docs
weight: 3020
...
Definiert die SoLdResource-Klasse, die Informationen zu einer Smart-Objekt-Ebene in einer PSD-Datei enthält. Wird verwendet, um Smart-Objekt-Ebenen in den Adobe® Photoshop®-Bildern zu unterstützen.
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/key/) { get; } | Ruft den Ressourcenschlüssel der SoLd-Smart-Objekt-Schicht ab. |
...
| override [UniqueId](../../aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/) { get; set; } | Ruft die globale eindeutige Kennung der Smart-Objekt-Layer-Daten ab oder legt sie fest[`SmartObjectResource`](../smartobjectresource/) im PSD-Bild. |
...
| Name | Beschreibung |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soldresource/typetoolkey/) | Der Typ-Tool-Infoschlüssel: 'SoLd'. |
