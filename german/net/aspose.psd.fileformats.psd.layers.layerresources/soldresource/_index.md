...
description: Definiert die SoLdResourceKlasse die Informationen zu einer SmartObjektEbene in einer PSDDatei enthält. Wird verwendet um SmartObjektEbenen in den Adobe PhotoshopBildern zu unterstützen.
type: docs
weight: 2990
...
| Name | Beschreibung |
| --- | --- |
| [SoLdResource](soldresource#constructor)() | Initialisiert eine neue Instanz von[`SoLdResource`](../soldresource) class. Dieser Standardkonstruktor ist für die Verwendung von by konzipiertSoLdResourceLoader . verwenden[`SmartResourceCreator`](../smartresourcecreator) zum Erstellen von SoLdResource-Klassen. |
