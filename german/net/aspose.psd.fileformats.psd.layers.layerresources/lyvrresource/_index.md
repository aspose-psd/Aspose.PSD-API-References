...
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource Klasse. Die Ressource, die die Photoshop-Version einer Ebene darstellt."
type: docs
weight: 3150
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

Die Ressource, die die Photoshop-Version einer Ebene darstellt.
...
| Name | Beschreibung |
| --- | --- |
| [LyvrResource](lyvrresource/)() | Der Standardkonstruktor. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | Liest oder setzt die Photoshop-Version der Ebene. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | Speichert die Ressource in den angegebenen Stream-Container. |
...
| Name | Beschreibung |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | Der Typwerkzeug-Info-Schlüssel. |
