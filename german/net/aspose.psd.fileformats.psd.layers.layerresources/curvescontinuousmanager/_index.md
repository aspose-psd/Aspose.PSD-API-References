...
description: Manager für die Kurvenanpassungsebene die Kurven manipuliert
type: docs
weight: 2390
...
| Name | Beschreibung |
| --- | --- |
| [CurvesContinuousManager](curvescontinuousmanager)(int) | Initialisiert eine neue Instanz von[`CurvesContinuousManager`](../curvescontinuousmanager) Klasse. |
