...
description: Definiert die liFDDatenquellenklasse in der PSDDatei die Informationen über eine eingebettete Datei enthält. Dies ist Teil der PSDDateiformatManipulationsAPI die hilft Adobe PhotoshopDateien zu ändern
type: docs
weight: 2650
...
| Name | Beschreibung |
| --- | --- |
| [LiFdDataSource](lifddatasource#constructor)() | Initialisiert eine neue Instanz von[`LiFdDataSource`](../lifddatasource) Klasse. |
| [LiFdDataSource](lifddatasource#constructor_1)(int, Guid, string, string, string) | Initialisiert eine neue Instanz von[`LiFdDataSource`](../lifddatasource) Klasse. |
