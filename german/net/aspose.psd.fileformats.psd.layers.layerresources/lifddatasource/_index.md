...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LiFdDataSource klas. Definiert die liFDDatenquellenklasse in der PSDDatei die Informationen über eine eingebettete Datei enthält. Dies ist Teil der PSDDateiformatManipulationsAPI die hilft Adobe PhotoshopDateien zu ändern
type: docs
weight: 2670
...
Definiert die liFD-Datenquellenklasse in der PSD-Datei, die Informationen über eine eingebettete Datei enthält. Dies ist Teil der PSD-Dateiformat-Manipulations-API, die hilft, Adobe® Photoshop®-Dateien zu ändern
...
| Name | Beschreibung |
| --- | --- |
| [LiFdDataSource](lifddatasource/#constructor)() | Initialisiert eine neue Instanz von`LiFdDataSource` Klasse. |
| [LiFdDataSource](lifddatasource/#constructor_1)(int, Guid, string, string, string) | Initialisiert eine neue Instanz von`LiFdDataSource` Klasse. |
...
| [Data](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) { get; set; } | Ruft die eingebetteten Smart-Objektdaten in der PSD-Datei ab oder legt sie fest. |
