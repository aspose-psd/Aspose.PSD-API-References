...
description: Definiert die SoLeResourceKlasse die Informationen über eine SmartObjektEbene in einer PSDDatei enthält. Wird verwendet um SmartObjektEbenen mit externen Dateiverknüpfungen in den Adobe PhotoshopBildern zu unterstützen.
type: docs
weight: 3000
...
| Name | Beschreibung |
| --- | --- |
| [SoLeResource](soleresource#constructor)() | Initialisiert eine neue Instanz von[`SoLeResource`](../soleresource) Klasse. |
| [SoLeResource](soleresource#constructor_1)(Guid, bool, bool) | Initialisiert eine neue Instanz von[`SoLeResource`](../soleresource) Klasse. |
