...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource klas. Definiert die SoLeResourceKlasse die Informationen über eine SmartObjektEbene in einer PSDDatei enthält. Wird verwendet um SmartObjektEbenen mit externen Dateiverknüpfungen in den Adobe PhotoshopBildern zu unterstützen.
type: docs
weight: 3030
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
## SoLeResource class

Definiert die SoLeResource-Klasse, die Informationen über eine Smart-Objekt-Ebene in einer PSD-Datei enthält. Wird verwendet, um Smart-Objekt-Ebenen mit externen Dateiverknüpfungen in den Adobe® Photoshop®-Bildern zu unterstützen.
...
| Name | Beschreibung |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | Initialisiert eine neue Instanz von`SoLeResource` Klasse. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | Initialisiert eine neue Instanz von`SoLeResource` Klasse. |
...
| override [Key](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/key/) { get; } | Ruft den Sole-Smart-Object-Layer-Ressourcenschlüssel ab. |
...
| Name | Beschreibung |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | Der Typ-Tool-Infoschlüssel: 'SoLE'. |
