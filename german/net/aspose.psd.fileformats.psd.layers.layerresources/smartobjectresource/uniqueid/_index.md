...
description: SmartObjectResource eigendom. Ruft die globale eindeutige Kennung der SmartObjektLayerDaten ab oder legt sie festSmartObjectResource im PSDBild.
type: docs
weight: 240
...
Ruft die globale eindeutige Kennung der Smart-Objekt-Layer-Daten ab oder legt sie fest[`SmartObjectResource`](../) im PSD-Bild.
...
Der globale eindeutige Bezeichner der Smart-Objekt-Layer-Daten[`SmartObjectResource`](../) .
