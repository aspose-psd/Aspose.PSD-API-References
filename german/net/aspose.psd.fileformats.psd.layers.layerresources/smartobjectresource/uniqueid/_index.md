...
description: Ruft die globale eindeutige Kennung der SmartObjektLayerDaten ab oder legt sie festSmartObjectResourceaspose.psd.fileformats.psd.layers.layerresources/smartobjectresource im PSDBild.
type: docs
weight: 240
url: /de/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

Ruft die globale eindeutige Kennung der Smart-Objekt-Layer-Daten ab oder legt sie fest[`SmartObjectResource`](../../smartobjectresource) im PSD-Bild.
...
Der globale eindeutige Bezeichner der Smart-Objekt-Layer-Daten[`SmartObjectResource`](../../smartobjectresource) .
