...
description: Ruft einen Wert ab oder legt einen Wert fest der angibt ob dies der Fall istGdFlResourceaspose.psd.fileformats.psd.layers.layerresources/gdflresource ist Zittern.
type: docs
weight: 60
...
Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`GdFlResource`](../../gdflresource) ist Zittern.
