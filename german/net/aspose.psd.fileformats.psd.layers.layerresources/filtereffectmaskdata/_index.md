...
description: Die Datenklasse der Filtermaske.
type: docs
weight: 2460
...
| Name | Beschreibung |
| --- | --- |
| [FilterEffectMaskData](filtereffectmaskdata)(string, Rectangle, int, int, ChannelInformation[], ChannelInformation, Rectangle, ChannelInformation) | Initialisiert eine neue Instanz von[`FilterEffectMaskData`](../filtereffectmaskdata) Klasse. |
