...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer Klasse. Gradientkarten-Ebene. Verarbeitet die Darstellung der Gradientkarte mithilfe von Daten aus GrdmResource."
type: docs
weight: 1810
url: /de/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
## GradientMapLayer class

Gradient‑Karten‑Ebene. Verarbeitet das Rendern von Gradient‑Karten mithilfe von Daten aus GrdmResource.
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | Liest oder setzt die Gradient-Einstellungsinstanz, die von einer GrdmResource-Instanz übergeben wird. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | Aktualisieren Sie Ebenendaten in der zugehörigen Ebenenressource [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/). |
