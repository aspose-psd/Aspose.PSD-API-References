...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer klas. Channel Mixer Einstellungsebene.
type: docs
weight: 1690
url: /de/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
## ChannelMixerLayer class

Channel Mixer Einstellungsebene.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist`ChannelMixerLayer` ist einfarbig. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | Ruft den Index des Kanals ab. Kann RgbMixerChannel oder CmykMixerChannel zurückgeben |
