...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer klas. Kurven Anpassungsebene
type: docs
weight: 1730
url: /de/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
## CurvesLayer class

Kurven Anpassungsebene
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob diese Instanz als kontinuierlicher Manager verwendet wird. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob diese Instanz als diskreter Manager verwendet wird. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | Ruft den Kurvenmanager ab. |
