...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BlackWhiteAdjustmentLayer klas. Die Klasse der SchwarzweißAnpassungsebene.
type: docs
weight: 1670
url: /de/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
## BlackWhiteAdjustmentLayer class

Die Klasse der Schwarzweiß-Anpassungsebene.
...
| [BlackAndWhitePresetFileName](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blackandwhitepresetfilename/) { get; set; } | Ruft den Dateinamen der Schwarzweiß-Voreinstellung ab oder legt ihn fest. |
...
| [Blues](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blues/) { get; set; } | Ruft den Blues-Wert ab oder setzt ihn. |
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind/) { get; set; } | Ruft den voreingestellten Schwarzweiß-Artwert ab oder legt ihn fest. |
...
| [Cyans](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans/) { get; set; } | Ruft den Cyanwert ab oder legt ihn fest. |
...
| [Greens](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens/) { get; set; } | Ruft den Grünwert ab oder setzt ihn. |
...
| [Magentas](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/magentas/) { get; set; } | Ruft den Magenta-Wert ab oder legt ihn fest. |
...
| [Reds](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/reds/) { get; set; } | Ruft den Rotwert ab oder legt ihn fest. |
...
| [TintColor](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolor/) { get; set; } | Ruft den Farbtonwert ab oder legt ihn fest. |
| [TintColorBlue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/) { get; set; } | Ruft den Double-Wert der Blautonfarbe ab oder legt ihn fest. |
| [TintColorGreen](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorgreen/) { get; set; } | Ruft den Double-Wert der Grüntonfarbe ab oder legt ihn fest. |
| [TintColorRed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorred/) { get; set; } | Ruft den Double-Wert der Rottonfarbe ab oder legt ihn fest. |
...
| [UseTint](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/usetint/) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob [Tönungsfarbe] verwendet wird. |
...
| [Yellows](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/) { get; set; } | Ruft den Gelbwert ab oder legt ihn fest. |
