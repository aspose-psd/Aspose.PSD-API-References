---
title: "Klasse CmykChannelMixerLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer Klasse. Cmyk-Kanalmixer-Anpassungsebene"
type: docs
weight: 1740
...
CMYK‑Kanal‑Mischer‑Anpassungsebene.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | Liest den Schwarz-Kanal. |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | Liest den Cyan-Kanal. |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | Liest den Magenta-Kanal. |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | Liest oder setzt einen Wert, der angibt, ob dieses [`ChannelMixerLayer`](../channelmixerlayer/) monochrom ist. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | Liest den Gelb-Kanal. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | Liest den Index des Kanals. Gibt CmykMixerChannel zurück. |
