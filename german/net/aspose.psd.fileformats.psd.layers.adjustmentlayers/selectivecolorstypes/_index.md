...
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorsTypes Enum. Farbtypen in der selektiven Farbkorrekturebene"
type: docs
weight: 1910
url: /de/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes/
---
{{< psd/tize >}}
## SelectiveColorsTypes enumeration

Farbtypen in der selektiven Farb-Anpassungsebene.
...
| --- | --- | --- |
| Reds | `0` | Die roten Farben. |
| Yellows | `1` | Die gelben Farben. |
| Greens | `2` | Die grünen Farben. |
| Cyans | `3` | Die cyanfarbenen Farben. |
| Blues | `4` | Die blauen Farben. |
| Magentas | `5` | Die magentafarbenen Farben. |
| Whites | `6` | Die weißen Farben. |
| Neutrals | `7` | Die neutralen Farben. |
| Blacks | `8` | Die schwarzen Farben. |
