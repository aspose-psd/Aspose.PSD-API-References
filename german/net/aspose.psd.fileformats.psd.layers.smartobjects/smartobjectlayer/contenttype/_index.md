...
description: "SmartObjectLayer‑Eigenschaft. Gibt den Typ des Inhalts der Smart‑Object‑Ebene zurück. Der Inhalt des eingebetteten Smart‑Objects ist die eingebettete Rohbilddatei Data. Der Inhalt des verknüpften Smart‑Objects ist der Rohinhalt der verknüpften Bilddatei, falls verfügbar LiFeDataSource. Das Laden aus der Adobe‑Photoshop‑Graphics‑Library wird nicht unterstützt, wenn IsLibraryLink wahr ist. Für reguläre Link‑Dateien verwenden wir zunächst RelativePath, um die Datei relativ zum Quellbildpfad SourceImagePath zu suchen; ist sie nicht verfügbar, prüfen wir FullPath; ist auch das nicht vorhanden, suchen wir die Link‑Datei im selben Verzeichnis wie unser Bild: SourceImagePath."
type: docs
weight: 50
...
Ermittelt den Typ des Inhalts der Smart‑Object‑Ebene. Der Inhalt des eingebetteten Smart‑Objects ist die eingebettete Rohbilddatei: [`Data`](../../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/). Der Inhalt des verknüpften Smart‑Objects ist der Rohinhalt der verknüpften Bilddatei, falls verfügbar: [`LiFeDataSource`](../../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/). Das Laden aus der Adobe‑Photoshop‑Graphics‑Library wird nicht unterstützt, wenn [`IsLibraryLink`](../../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) wahr ist. Für reguläre Link‑Dateien verwenden wir zunächst [`RelativePath`](../../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/), um die Datei relativ zum Quellbildpfad SourceImagePath zu suchen; ist sie nicht verfügbar, prüfen wir [`FullPath`](../../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/); ist auch das nicht vorhanden, suchen wir die Link‑Datei im selben Verzeichnis wie unser Bild: SourceImagePath.
...
Der Typ des Inhalts der Smart‑Object‑Ebene.
