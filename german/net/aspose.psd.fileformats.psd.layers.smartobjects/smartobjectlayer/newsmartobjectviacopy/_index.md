...
description: Erstellt eine neue SmartObjektEbene durch Kopieren dieser Ebene. Reproduziert die Funktionalität Ebene gt SmartObjekte gt Neues SmartObjekt über Kopieren von Adobe Photoshop. Beachten Sie dass dies aufgrund des eingebetteten Bildes nur für eingebettete SmartObjekte aktiviert ist wird ebenfalls kopiert. Wenn Sie das eingebettete Bild teilen möchten verwenden Sie esDuplicateLayeraspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/duplicatelayer Methode.
type: docs
weight: 120
...
Der geklonte[`SmartObjectLayer`](../../smartobjectlayer) Beispiel.
