---
title: "Klasse SmartObjectLayer"
second_title: "Aspose.PSD für .NET API-Referenz"
description: "Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectLayer class. Definiert die Klasse SmartObjectLayer, die ein im PSD‑Datei eingebettetes oder in einer externen Datei verknüpftes Smart‑Object enthält. Mit Smart Objects können Sie destruktionsfreie Transformationen durchführen. Sie können eine Ebene skalieren, drehen, kippen, verzerren, perspektivisch transformieren oder verformen, ohne die ursprünglichen Bilddaten oder die Qualität zu verlieren, da die Transformationen die Originaldaten nicht beeinflussen. Arbeiten Sie mit Vektordaten wie Vektor‑Grafiken aus Illustrator, die sonst gerastert würden. Führen Sie destruktionsfreie Filterungen durch. Sie können Filter, die auf Smart Objects angewendet wurden, jederzeit bearbeiten. Bearbeiten Sie ein Smart Object und aktualisieren Sie automatisch alle verknüpften Instanzen. Wenden Sie eine Ebenenmaske an, die entweder mit dem Smart‑Object‑Layer verknüpft oder davon getrennt ist. Probieren Sie verschiedene Designs mit niedrigauflösenden Platzhalter‑Bildern, die Sie später durch Endversionen ersetzen. In Adobe Photoshop können Sie den Inhalt eines Bildes in ein PSD‑Dokument einbetten. Weitere Informationen finden Sie hier https//helpx.adobe.com/photoshop/using/createsmartobjects.html Ein Layer mit einem eingebetteten Smart Object enthält platzierte PlLd‑ und SoLd‑Ressourcen mit Smart‑Object‑Eigenschaften. Die PlLd‑Ressource kann allein für PSD‑Versionen älter als 10 sein. Diese Ressourcen enthalten die UniqueId der LiFdDataSource im globalen Lnk2Resource mit dem eingebetteten Dateinamen und weiteren Parametern, einschließlich des eingebetteten Dateiinhalts im Originalformat als Byte‑Array."
type: docs
weight: 3910
...
| Name | Beschreibung |
| --- | --- |
| [SmartObjectLayer](smartobjectlayer/)(Stream) | Initialisiert eine neue Instanz der Klasse `SmartObjectLayer`. |
...
| [Contents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contents/) { get; set; } | Liest oder setzt den Inhalt der Smart‑Object‑Ebene. Der eingebettete Smart‑Object‑Inhalt ist die eingebettete Rohbilddatei: [`Data`](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/) und deren Eigenschaften. Der verknüpfte Smart‑Object‑Inhalt ist der Rohinhalt der verknüpften Bilddatei, falls verfügbar, und dessen Eigenschaften: [`LiFeDataSource`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/). Wir unterstützen das Laden aus der Adobe® Photoshop®® Graphics Library nicht, wenn [`IsLibraryLink`](../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) true ist. Für reguläre Verknüpfungsdateien verwenden wir zunächst [`RelativePath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/) um die Datei relativ zum Quellbildpfad SourceImagePath zu suchen; ist sie nicht verfügbar, prüfen wir [`FullPath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/), andernfalls suchen wir die Verknüpfungsdatei im selben Verzeichnis wie unser Bild: SourceImagePath. |
| [ContentsBounds](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentsbounds/) { get; set; } | Liest oder setzt die Grenzen des Smart‑Object‑Inhalts. |
| [ContentsSource](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentssource/) { get; set; } | Liest oder setzt die Quelle des Smart‑Object‑Inhalts. |
| [ContentType](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contenttype/) { get; } | Liest den Typ des Smart‑Object‑Ebeneninhalts. Der eingebettete Smart‑Object‑Inhalt ist die eingebettete Rohbilddatei: [`Data`](../../aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/data/). Der verknüpfte Smart‑Object‑Inhalt ist der Rohinhalt der verknüpften Bilddatei, falls verfügbar: [`LiFeDataSource`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/). Wir unterstützen das Laden aus der Adobe® Photoshop®® Graphics Library nicht, wenn [`IsLibraryLink`](../../aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/islibrarylink/) true ist. Für reguläre Verknüpfungsdateien verwenden wir zunächst [`RelativePath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/) um die Datei relativ zum Quellbildpfad SourceImagePath zu suchen; ist sie nicht verfügbar, prüfen wir [`FullPath`](../../aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/fullpath/), andernfalls suchen wir die Verknüpfungsdatei im selben Verzeichnis wie unser Bild: SourceImagePath. |
...
| [SmartFilters](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/smartfilters/) { get; } | Liest die intelligenten Filter. |
| [SmartObjectProvider](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/smartobjectprovider/) { get; } | Liest den Anbieter für intelligente Objekte. |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/) { get; set; } | Liest oder setzt Warp-Parameter, die aus der Ressource festgelegt oder abgerufen wurden (Standard). |
...
| [DuplicateLayer](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/duplicatelayer/)() | Erstellt eine neue Smart‑Objekt‑Ebene, indem diese kopiert wird. Beachten Sie, dass bei eingebetteten Smart‑Objekten das eingebettete Bild gemeinsam genutzt wird. Wenn Sie das eingebettete Bild kopieren möchten, verwenden Sie die Methode [`NewSmartObjectViaCopy`](./newsmartobjectviacopy/). |
...
| [ExportContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/exportcontents/)(string) | Exportiert die eingebetteten oder verknüpften Inhalte in eine Datei. |
...
| [LoadContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/loadcontents/)(LoadOptions) | Ermittelt die eingebetteten oder verknüpften Bildinhalte der Smart‑Object‑Ebene. |
...
| [NewSmartObjectViaCopy](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/newsmartobjectviacopy/)() | Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. Reproduziert die Funktion `Layer -&gt; Smart Objects -&gt; New Smart Object via Copy` von Adobe Photoshop. Beachten Sie, dass dies nur für eingebettete Smart‑Objects aktiviert ist, da das eingebettete Bild ebenfalls kopiert wird. Wenn Sie das eingebettete Bild teilen möchten, verwenden Sie die [`DuplicateLayer`](./duplicatelayer/)‑Methode. |
...
| [RelinkToFile](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/)(string) | Verknüpft das verknüpfte Smart‑Object mit einer neuen Datei neu. Es ist nicht erforderlich, danach die Methode UpdateModifiedContent aufzurufen. |
...
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents)(Image) | Ersetzt die in der Smart‑Object‑Ebene eingebetteten Smart‑Object‑Inhalte. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_2)(string) | Ersetzt den Inhalt durch eine Datei. Es ist nicht erforderlich, danach die Methode UpdateModifiedContent aufzurufen. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_1)(Image, ResolutionSetting) | Ersetzt die in der Smart‑Object‑Ebene eingebetteten Smart‑Object‑Inhalte. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_5)(string, bool) | Ersetzt den Inhalt durch eine Datei. Es ist nicht erforderlich, danach die Methode UpdateModifiedContent aufzurufen. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_3)(string, ResolutionSetting) | Ersetzt den Inhalt durch eine Datei. Es ist nicht erforderlich, danach die Methode UpdateModifiedContent aufzurufen. |
| [ReplaceContents](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/replacecontents/#replacecontents_4)(string, ResolutionSetting, bool) | Ersetzt den Inhalt durch eine Datei. Es ist nicht erforderlich, danach die Methode UpdateModifiedContent aufzurufen. |
...
| [UpdateModifiedContent](../../aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/updatemodifiedcontent/)() | Aktualisiert den Bild-Cache der Smart‑Object‑Ebene mit dem geänderten Inhalt. |
