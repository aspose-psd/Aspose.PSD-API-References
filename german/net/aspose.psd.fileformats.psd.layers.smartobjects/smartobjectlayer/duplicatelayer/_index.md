...
description: Erstellt eine neue SmartObjektEbene durch Kopieren dieser. Beachten Sie dass für eingebettete SmartObjekte das eingebettete Bild geteilt wird. Wenn Sie das eingebettete Bild kopieren möchten verwenden SieNewSmartObjectViaCopyaspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/newsmartobjectviacopy Methode.
type: docs
weight: 80
...
Der geklonte[`SmartObjectLayer`](../../smartobjectlayer) Instanz.
