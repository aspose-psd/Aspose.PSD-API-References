...
description: "SmartObjectLayer‑Methode. Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. Beachten Sie, dass bei eingebetteten Smart‑Objects das eingebettete Bild gemeinsam genutzt wird. Wenn Sie das eingebettete Bild kopieren möchten, verwenden Sie die NewSmartObjectViaCopy‑Methode."
type: docs
weight: 100
...
Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. Beachten Sie, dass bei eingebetteten Smart‑Objects das eingebettete Bild gemeinsam genutzt wird. Wenn Sie das eingebettete Bild kopieren möchten, verwenden Sie die [`NewSmartObjectViaCopy`](../newsmartobjectviacopy/)‑Methode.
