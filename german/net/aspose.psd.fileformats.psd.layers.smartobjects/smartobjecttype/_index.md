...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType opsomming. Definiert die SmartObjectTypeEnumeration für SmartObjektInhaltstyp
type: docs
weight: 3500
url: /de/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
## SmartObjectType enumeration

Definiert die SmartObjectType-Enumeration für Smart-Objekt-Inhaltstyp
...
| --- | --- | --- |
| Embedded | `0` | Der eingebettete Inhalt |
| AvailableLinked | `1` | Die verknüpfte Datei, die verfügbar ist |
| UnavailableLinked | `2` | Die verknüpfte Datei, die nicht verfügbar ist |
| LibraryLink | `3` | Die Adobe® Photoshop® ÑÑ-Bibliothek link |
