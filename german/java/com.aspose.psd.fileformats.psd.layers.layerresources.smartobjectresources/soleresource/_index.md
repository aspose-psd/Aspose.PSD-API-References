...
description: "Definiert die SoLeResource-Klasse, die Informationen über eine Smart-Object-Ebene in einer PSD-Datei enthält."
type: docs
weight: 16
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource/
---
...
Definiert die SoLeResource-Klasse, die Informationen über eine Smart-Object-Ebene in einer PSD-Datei enthält. Sie wird verwendet, um Smart-Object-Ebenen mit externen Dateiverknüpfungen in den Adobe\ufffd Photoshop\ufffd-Bildern zu unterstützen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [SoLeResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLeResource-java.util.UUID-boolean-boolean-) | Initialisiert eine neue Instanz der Klasse [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource). |
| [SoLeResource()](#SoLeResource--) | Initialisiert eine neue Instanz der Klasse [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource). |
## Felder
...
| [TypeToolKey](#TypeToolKey) | Der Typwerkzeug-Info-Schlüssel: 'SoLE'. |
...
Initialisiert eine neue Instanz der Klasse [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource).

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| uniqueId | java.util.UUID | Der eindeutige Bezeichner der platzierten Ebenendaten [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
...
Der Typwerkzeug-Info-Schlüssel: 'SoLE'.
