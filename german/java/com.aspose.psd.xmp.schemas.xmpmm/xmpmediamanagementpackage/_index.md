...
description: "Stellt den XMP Media Management-Namespace dar."
type: docs
weight: 10
url: /de/java/com.aspose.psd.xmp.schemas.xmpmm/xmpmediamanagementpackage/
---
...
Stellt den XMP Media Management-Namespace dar.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [XmpMediaManagementPackage()](#XmpMediaManagementPackage--) | Initialisiert eine neue Instanz der  XmpMediaManagementPackage  Klasse. |
## Methoden
...
| [setDerivedFrom(ResourceRef resourceRef)](#setDerivedFrom-com.aspose.psd.xmp.types.complex.resourceref.ResourceRef-) | Setzt das abgeleitet von. |
| [setDocumentId(String guid)](#setDocumentId-java.lang.String-) | Setzt den Dokumenten‑Identifier. |
| [setDocumentId(UUID guid)](#setDocumentId-java.util.UUID-) | Setzt den Dokumenten‑Identifier. |
| [setDocumentId_internalized(System.Guid guid)](#setDocumentId-internalized-com.aspose.ms.System.Guid-) |  |
| [setInstanceId(String guid)](#setInstanceId-java.lang.String-) | Setzt die Instanz‑ID. |
| [setInstanceId(UUID guid)](#setInstanceId-java.util.UUID-) | Setzt die Instanz‑ID. |
| [setInstanceId_internalized(System.Guid guid)](#setInstanceId-internalized-com.aspose.ms.System.Guid-) |  |
| [setOriginalDocumentId(String guid)](#setOriginalDocumentId-java.lang.String-) | Legt die ursprüngliche Dokument-ID fest. |
| [setOriginalDocumentId(UUID guid)](#setOriginalDocumentId-java.util.UUID-) | Legt die ursprüngliche Dokument-ID fest. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| resourceRef | [ResourceRef](../../com.aspose.psd.xmp.types.complex.resourceref/resourceref) | Die Ressourcenreferenz. |
...
Setzt den Dokumenten‑Identifier.
...
Legt die ursprüngliche Dokument-ID fest.
