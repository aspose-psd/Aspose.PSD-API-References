...
description: "Definiert die UnitArrayStructure‑Klasse, die ein Array von Double‑Werten und deren Maßeinheit enthält."
type: docs
weight: 27
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
Definiert die UnitArrayStructure‑Klasse, die ein Array von Double‑Werten und deren Maßeinheit enthält. Sie wird in den PSD‑Dateiresourcen verwendet, normalerweise von [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | Initialisiert eine neue Instanz der [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Klasse. |
## Felder

| Feld | Beschreibung |
| --- | --- |
| [StructureKey](#StructureKey) | Definiert den 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Schlüssel. |
## Methoden
...
| [getKey()](#getKey--) | Liest diesen UnitArrayStructure-Schlüssel. |
...
| [getUnitType()](#getUnitType--) | Liest oder setzt den Maßeinheitstyp der [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Werte. |
| [getValueCount()](#getValueCount--) | Liest die Werteanzahl. |
| [getValues()](#getValues--) | Liest oder setzt die UnitArrayStructure-Werte. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | Liest oder setzt den Maßeinheitstyp der [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Werte. |
| [setValues(double[] value)](#setValues-double---) | Liest oder setzt die UnitArrayStructure-Werte. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialisiert eine neue Instanz der [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Klasse.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Name des Schlüssels. |
| unitType | int | Typ der Einheit. |
| Werte | double[] | Die Werte. |
...
Definiert den 'UnFl' [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Schlüssel.
...
Liest diesen UnitArrayStructure-Schlüssel.
...
Liest oder setzt den Maßeinheitstyp der [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure) Werte.

Wert: Der Maßeinheitstyp.
...
Liest die Werteanzahl.

Wert: Die Werteanzahl in der UnitArrayStructure.
...
Liest oder setzt die UnitArrayStructure-Werte.
