...
description: "Enumerierte Referenzstruktur."
type: docs
weight: 16
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
Enumerierte Referenzstruktur.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialisiert eine neue Instanz der [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) Klasse. |
## Felder

| Feld | Beschreibung |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | Identifiziert den Struktur-Schlüssel. |
| [StructureKey](#StructureKey) | Der enumerierte Deskriptorschlüssel. |
## Methoden
...
| [getEnumName()](#getEnumName--) | Liest oder setzt den Enum-Namen. |
...
| [getKey()](#getKey--) | Ruft den Schlüssel ab. |
...
| [getTypeID()](#getTypeID--) | Liest oder setzt die Typ-ID. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Liest oder setzt den Enum-Namen. |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Liest oder setzt die Typ-ID. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialisiert eine neue Instanz der [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) Klasse.
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Die Typ-ID. |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | Der Enum-Name. |
...
Liest oder setzt den Enum-Namen.
