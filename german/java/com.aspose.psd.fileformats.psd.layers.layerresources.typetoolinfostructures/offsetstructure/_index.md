...
description: "Die Offset-Struktur."
type: docs
weight: 21
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure/
---
...
| --- | --- |
| [OffsetStructure(ClassID keyName, ClassID classID)](#OffsetStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialisiert eine neue Instanz der Klasse [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure). |
## Felder
...
| [getValue()](#getValue--) | Liest oder setzt den Ganzzahlwert. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(int value)](#setValue-int-) | Liest oder setzt den Ganzzahlwert. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Initialisiert eine neue Instanz der Klasse [OffsetStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/offsetstructure).
...
Liest oder setzt den Ganzzahlwert.

Wert: Der Ganzzahlwert.
