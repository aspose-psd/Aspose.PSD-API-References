...
description: "Die Alias‑Struktur."
type: docs
weight: 10
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Initialisiert eine neue Instanz der Klasse [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure). |
## Felder
...
| [getDataLength()](#getDataLength--) | Liest die genaue Datenlänge in Bytes. |
| [getFullPath()](#getFullPath--) | Liest oder setzt den vollständigen Pfad. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Liest oder setzt den vollständigen Pfad. |
...
Initialisiert eine neue Instanz der Klasse [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure).
...
Liest die genaue Datenlänge in Bytes.

Wert: Die Datenlänge in Bytes.
...
Liest oder setzt den vollständigen Pfad.

Wert: Der vollständige Pfad.
