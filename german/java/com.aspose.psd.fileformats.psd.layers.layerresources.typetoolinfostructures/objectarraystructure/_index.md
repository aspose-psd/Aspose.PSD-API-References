...
description: "Definiert die Klasse ObjectArrayStructure, die normalerweise ein Array enthält."
type: docs
weight: 20
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
Definiert die Klasse ObjectArrayStructure, die normalerweise ein [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure)-Array enthält. Sie wird in den PSD-Dateiressourcen verwendet, wie z. B. PlLd Resource und SoLd Resource.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initialisiert eine neue Instanz der Klasse [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Initialisiert eine neue Instanz der Klasse [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure). |
## Felder

| Feld | Beschreibung |
| --- | --- |
| [StructureKey](#StructureKey) | Identifiziert den Struktur-Schlüssel 'ObAr'. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | Liest oder setzt die Klassen-ID des Objektarrays. |
| [getClassName()](#getClassName--) | Liest oder setzt den Klassennamen des Objektarrays. |
...
| [getKey()](#getKey--) | Liest den Struktur-Schlüssel des Objektarrays. |
| [getKeyName()](#getKeyName--) | Liest oder setzt den Schlüsselnamen. |
| [getLength()](#getLength--) | Liest die  OSTypeStructure  Länge in Bytes. |
...
| [getStructureCount()](#getStructureCount--) | Liest die Anzahl der Untersubstrukturen des Objektarrays. |
| [getStructures()](#getStructures--) | Liest oder legt die Teilstrukturen in der Objektarray-Struktur fest. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Liest oder setzt die Klassen-ID des Objektarrays. |
| [setClassName(String value)](#setClassName-java.lang.String-) | Liest oder setzt den Klassennamen des Objektarrays. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Liest oder legt die Teilstrukturen in der Objektarray-Struktur fest. |
...
Initialisiert eine neue Instanz der Klasse [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| keyName | java.lang.String | Name des Schlüssels. |
| classIdName | java.lang.String | Name des Klassenbezeichners. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Schlüssel | int | Der Ganzzahlenschlüssel. |
...
Identifiziert den Struktur-Schlüssel 'ObAr'.
...
Liest oder setzt die Klassen-ID des Objektarrays.

Wert: Die Objektarray-Klassen-ID.
...
Liest oder setzt den Klassennamen des Objektarrays.

Wert: Der Objektarray-Klassenname.
...
Liest den Struktur-Schlüssel des Objektarrays.
...
Liest die  OSTypeStructure  Länge in Bytes.
...
Liest die Anzahl der Untersubstrukturen des Objektarrays.

Wert: Die Anzahl der Teilstrukturen in der Objektarray-Struktur.
...
Liest oder legt die Teilstrukturen in der Objektarray-Struktur fest.

Wert: Die Teilstrukturen in der Objektarray-Struktur.
