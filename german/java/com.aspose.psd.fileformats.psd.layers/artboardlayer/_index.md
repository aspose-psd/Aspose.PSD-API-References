...
description: "Die Artboard-Ebenenklasse."
type: docs
weight: 10
url: /de/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | Fügt die Ebene zur Ebenengruppe hinzu. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | Fügt die Ebene zur Ebenengruppe hinzu. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | Fügt die Ebenengruppe hinzu. |
...
| [buildGroupLayerMarkers_internalized(String groupName, PsdHeader psdHeader, IColorPalette colorPalette, int layerNestingLevel)](#buildGroupLayerMarkers-internalized-java.lang.String-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-int-) | Erstellt die Anfangs- und Endgruppenmarker. |
...
| [getBackgroundColor()](#getBackgroundColor--) | Liest oder setzt die Hintergrundfarbe des Artboards. |
...
| [getLayers()](#getLayers--) | Ermittelt die Ebenen in der Ebenengruppe |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | Ermittelt die tatsächlichen Grenzen von ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | Ermittelt die  LayerSectionResource  aus den Ressourcen. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | Liest oder setzt einen Wert, der angibt, ob [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) die Hintergrundfarbe hat. |
...
| [isOpen()](#isOpen--) | Liest oder setzt, ob der Ordner geöffnet ist; wenn auf true gesetzt, wird die Gruppe beim Start im offenen Zustand sein, andernfalls im minimierten Zustand. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | Liest oder setzt die Hintergrundfarbe des Artboards. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | Liest oder setzt, ob der Ordner geöffnet ist; wenn auf true gesetzt, wird die Gruppe beim Start im offenen Zustand sein, andernfalls im minimierten Zustand. |
...
Fügt die Ebene zur Ebenengruppe hinzu.
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | Die Ebene. |
| Index | int | Der Index, an dem die Ebene eingefügt wird. Ungültige Werte bedeuten das Ende der Ebenenliste. |
...
**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - Gibt ein Array von zwei LayerGroup-Objekten zurück, wobei das erste [0] der Anfangsgruppenmarker und das zweite [1] der Endgruppenmarker ist.
### cacheData() {#cacheData--}
```
...
Liest oder setzt die Hintergrundfarbe des Artboards.
...
Ermittelt die Ebenen in der Ebenengruppe
...
Ermittelt die tatsächlichen Grenzen von ArtboardLayer.
...
Ermittelt die  LayerSectionResource  aus den Ressourcen.
...
Liest oder setzt einen Wert, der angibt, ob [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) die Hintergrundfarbe hat.
...
Liest oder setzt, ob der Ordner geöffnet ist; wenn auf true gesetzt, wird die Gruppe beim Start im offenen Zustand sein, andernfalls im minimierten Zustand.
