...
description: "Die Textebenen‑Klasse"
type: docs
weight: 30
url: /de/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | Korrigiert die Größe der Schrift. |
...
| [createInstance_internalized()](#createInstance-internalized--) | Erstellt eine neue Instanz der Klasse [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | Erstellt eine neue Instanz der Klasse [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | Liest die Engine-Daten. |
...
| [getFont()](#getFont--) | Liest die Schrift. |
| [getFonts()](#getFonts--) | Liest den Schriftartensatz der Textebene. |
...
| [getInnerText()](#getInnerText--) | Liest den Text der Ebene. |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | Liest oder setzt den Ressourcenprozessor. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | Liest das Zeichenkettenformat. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | Liest die Synchronisationswurzel. |
| [getText()](#getText--) | Liefert den Text. |
| [getTextBoundBox()](#getTextBoundBox--) | Liest oder setzt die Textbegrenzungsbox. |
| [getTextColor()](#getTextColor--) | Liest die Farbe des Textes. |
| [getTextData()](#getTextData--) | Liest die Textabschnitte. |
...
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | Sucht und holt die [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) Ressource aus dem [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | Liest oder setzt einen Wert, der angibt, ob [was changed]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | Bestimmt, ob [is font available] [the specified font]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | Verarbeitet die Schriftart vor. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | Ersetzt die Schriftart durch die Standardschrift. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | Liest den Text der Ebene. |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | Liest oder setzt den Ressourcenprozessor. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | Liest oder setzt die Textbegrenzungsbox. |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | Liest oder setzt einen Wert, der angibt, ob [was changed]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | Aktualisiert die Grenzen des [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) in den Ressourcen. |
| [updateText(String text)](#updateText-java.lang.String-) | Aktualisiert den Text. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | Aktualisiert den Text. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | Aktualisiert den Text. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | Aktualisiert den Text. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | Aktualisiert den Text. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | Aktualisiert den Text. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | Aktualisiert den Text. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | Aktualisiert den Text. |
| [wait()](#wait--) |  |
...
Korrigiert die Größe der Schrift.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| newSize | float | Neue Schriftgröße |
| yyTransform | double | 'yy' Transformationsmatrix-Parameter |

**Returns:**
float - Korrigierte Größe
...
Erstellt eine neue Instanz der Klasse [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Liest die Engine-Daten.

Wert: Die Engine-Daten.
...
Liest den Schriftartensatz der Textebene.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - Die Schriftarten des Textlayers.
...
Liest oder setzt den Ressourcenprozessor.

Wert: Der Ressourcenprozessor.
...
Liest das Zeichenkettenformat.

Wert: Das Zeichenkettenformat.
...
Sucht und holt die [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) Ressource aus dem [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
Liest oder setzt einen Wert, der angibt, ob [was changed].

Wert:  true  wenn [was changed]; andernfalls,  false .
...
Bestimmt, ob [is font available] [the specified font].
...
**Returns:**
boolean - Wahr, wenn Schriftart verfügbar ist
...
Verarbeitet die Schriftart vor.
...
Ersetzt die Schriftart durch die Standardschrift.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | Die Schriftart. |
| defaultFontName | java.lang.String | Standardname der Schriftart. |
...
| newWidth | int | Die neue Breite. |
| newHeight | int | Die neue Höhe. |
| resizeType | int | Der Typ der Skalierungstransformation  ResizeType |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
Aktualisiert die Grenzen des [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) in den Ressourcen.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Die absolute Position und Größe des Textes. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | Die Position und Größe des Textes relativ zur TextBox. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| text | java.lang.String | Der Textwert. |
...
| --- | --- | --- |
| text | java.lang.String | Der Textwert. |
| color | [Color](../../com.aspose.psd/color) | Der Farbwert. |
...
| --- | --- | --- |
| text | java.lang.String | Der Textwert. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Die linke obere Koordinate. |
...
| text | java.lang.String | Der Textwert. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | Die linke obere Koordinate. |
| fontSize | float | Größe der Schriftart. |
