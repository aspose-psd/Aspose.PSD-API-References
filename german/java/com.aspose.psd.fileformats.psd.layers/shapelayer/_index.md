...
description: "Formebene."
type: docs
weight: 29
url: /de/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
Shape layer. Kapselt die Logik der Arbeit mit Shape layer und zugehörigen Ressourcen.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | Initialisiert eine neue Instanz der [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) Klasse. |
## Felder
...
| [createInstance()](#createInstance--) | Erstellt eine neue Instanz der [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) Klasse. |
...
| [getFill()](#getFill--) | Fülleinstellungen für den internen Bereich von Shapes in der Shape layer. |
...
| [getPath()](#getPath--) | Gibt die Menge von Pfaden zurück, die in einer Shape layer vorhanden sind. |
...
| [getStroke()](#getStroke--) | Liest oder setzt Strich‑Einstellungen von Shapes. |
...
| [onGlobalResourcesChanged_internalized(Object sender, GlobalResourceChangedEventArgs eventArgs)](#onGlobalResourcesChanged-internalized-java.lang.Object-com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs-) | Aufgerufen, wenn [globale Ressourcen geändert]. |
| [onResourcesChange_internalized()](#onResourcesChange-internalized--) | Aufgerufen, wenn [Ressourcenänderung]. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | Fülleinstellungen für den internen Bereich von Shapes in der Shape layer. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | Liest oder setzt Strich‑Einstellungen von Shapes. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Aktualisiert Ressourcen basierend auf den Eigenschaften der Shape layer. |
...
Initialisiert eine neue Instanz der [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) Klasse. Alle Ressourcen werden im Standardzustand erstellt.
...
Erstellt eine neue Instanz der [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer) Klasse.
...
Fülleinstellungen für den internen Bereich von Shapes in der Shape layer.
...
Gibt die Menge von Pfaden zurück, die in einer Shape layer vorhanden sind.
...
Liest oder setzt Strich‑Einstellungen von Shapes.
...
**Returns:**
boolean - Boolescher Wert, der angibt, dass die Ebene gültig ist.
...
Aufgerufen, wenn [globale Ressourcen geändert].

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Absender | java.lang.Object | Der Absender. |
| eventArgs | com.aspose.internal.fileformats.psd.sections.GlobalResourceChangedEventArgs | Die EventArgs‑Instanz, die die Ereignisdaten enthält. |
...
Aufgerufen, wenn [Ressourcenänderung].
...
Aktualisiert Ressourcen basierend auf den Eigenschaften der Shape layer.
