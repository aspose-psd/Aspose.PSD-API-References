...
description: "Die Ebenenmasken‑Flags"
type: docs
weight: 24
url: /de/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| Feld | Beschreibung |
| --- | --- |
| [Disabled](#Disabled) | Layer-Maske ist deaktiviert. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | Layer-Maske beim Mischen invertieren. |
| [None](#None) | Keine Flags definiert. |
| [RelativeToLayer](#RelativeToLayer) | Position ist relativ zum Layer. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | Gibt an, dass die Benutzer-Maske tatsächlich aus der Darstellung anderer Daten stammt. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | Gibt an, dass auf die Benutzer- und/oder Vektor-Masken Parameter angewendet wurden. |
## Methoden
...
Layer-Maske beim Mischen invertieren.
...
Position ist relativ zum Layer.
...
Gibt an, dass die Benutzer-Maske tatsächlich aus der Darstellung anderer Daten stammt.
...
Gibt an, dass auf die Benutzer- und/oder Vektor-Masken Parameter angewendet wurden.
