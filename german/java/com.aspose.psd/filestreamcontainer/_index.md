...
description: "Hilfsprogramm für die Verarbeitung von Dateistreams."
type: docs
weight: 44
url: /de/java/com.aspose.psd/filestreamcontainer/
---
...
Hilfsprogramm für die Verarbeitung von Dateistreams.
## Felder
...
| [openFileStream_internalized(String fileLocation, boolean disposeDuplicatedStreams)](#openFileStream-internalized-java.lang.String-boolean-) | Öffnet einen vorhandenen Dateistream. |
...
| [setTemporal(boolean value)](#setTemporal-boolean-) | Liest oder setzt einen Wert, der angibt, ob der Stream temporär ist. |
...
| [toString()](#toString--) |  |
| [to_FileStream(FileStreamContainer fileStreamContainer)](#to-FileStream-com.aspose.psd.FileStreamContainer-) | Führt eine explizite Konvertierung von [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) zu FileInputStream durch. |
...
| [to_Stream(FileStreamContainer fileStreamContainer)](#to-Stream-com.aspose.psd.FileStreamContainer-) | Führt eine explizite Konvertierung von [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) zu java.io.InputStream durch. |
...
Wert:  true  wenn der Stream explizit erstellt wurde; andernfalls  false .
...
Wert:  true  wenn der Stream temporär ist; andernfalls  false .

--------------------

Ein temporärer Stream wird sich selbst beim Entsorgen entfernen. Wenn der Stream speicherbasiert ist, hat diese Eigenschaft keine Auswirkung. Der Stream kann als temporär oder persistent markiert werden, falls er explizit erstellt wurde; andernfalls wird die entsprechende Ausnahme ausgelöst.
...
| --- | --- | --- |
| fileLocation | java.lang.String | Der Dateistandort. |
| disposeDuplicatedStreams | boolean | wenn auf  true  gesetzt, werden die duplizierten Streams entsorgt. |
...
Führt eine explizite Konvertierung von [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) zu FileInputStream durch.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fileStreamContainer | [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) | Der Dateistream-Container. |

**Returns:**
java.io.FileInputStream - Das Ergebnis der Konvertierung.
### to_FileStream_internalized(FileStreamContainer fileStreamContainer) {#to-FileStream-internalized-com.aspose.psd.FileStreamContainer-}
```
...
Führt eine explizite Konvertierung von [FileStreamContainer](../../com.aspose.psd/filestreamcontainer) zu java.io.InputStream durch.
...
**Returns:**
java.io.InputStream - Das Ergebnis der Konvertierung.
