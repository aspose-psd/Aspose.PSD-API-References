...
type: docs
weight: 15
url: /de/java/com.aspose.psd/cachetype/
---
...
| Feld | Beschreibung |
| --- | --- |
| [Auto](#Auto) | Gibt den automatischen Cache-Typ an. |
| [CacheInMemoryOnly](#CacheInMemoryOnly) | Nur der In-Memory-Cache. |
| [CacheOnDiskOnly](#CacheOnDiskOnly) | Nur der Festplatten-Cache. |
...
Gibt den automatischen Cache-Typ an. Das automatische Cache-Schema versucht zuerst, im Speicher zu cachen, dann auf der Festplatte.
