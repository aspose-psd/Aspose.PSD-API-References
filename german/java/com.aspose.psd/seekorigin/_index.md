...
description: "Stellt die Felder bereit, die Referenzpunkte in StreamContainer für das Suchen darstellen."
type: docs
weight: 95
url: /de/java/com.aspose.psd/seekorigin/
---
...
Stellt die Felder bereit, die Referenzpunkte im StreamContainer für das Suchen darstellen.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [Begin](#Begin) | Gibt den Beginn eines Streams an. |
| [Current](#Current) | Gibt die aktuelle Position innerhalb eines Streams an. |
| [End](#End) | Gibt das Ende eines Streams an. |
...
Gibt den Beginn eines Streams an.
