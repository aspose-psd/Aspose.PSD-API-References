...
description: "Gibt den Qualitätsgrad an, der beim Compositing verwendet wird."
type: docs
weight: 32
url: /de/java/com.aspose.psd/compositingquality/
---
...
Gibt den Qualitätsgrad an, der beim Compositing verwendet wird.
## Felder

| Feld | Beschreibung |
| --- | --- |
| [AssumeLinear](#AssumeLinear) | Lineare Werte annehmen. |
| [Default](#Default) | Standardqualität. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GammaCorrected](#GammaCorrected) | Gamma‑Korrektur wird verwendet. |
| [HighQuality](#HighQuality) | Hohe Qualität, niedrige Geschwindigkeit beim Kompositing. |
| [HighSpeed](#HighSpeed) | Hohe Geschwindigkeit, niedrige Qualität. |
...
Hohe Qualität, niedrige Geschwindigkeit beim Kompositing.
