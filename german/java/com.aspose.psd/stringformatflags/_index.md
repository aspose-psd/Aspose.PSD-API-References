...
type: docs
weight: 107
url: /de/java/com.aspose.psd/stringformatflags/
---
...
| [DisplayFormatControl](#DisplayFormatControl) | Steuerzeichen wie das Links-nach-rechts-Zeichen werden in der Ausgabe mit einem repräsentativen Glyphen angezeigt. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FitBlackBox](#FitBlackBox) | Teile von Zeichen dürfen über das Layout‑Rechteck der Zeichenkette hinausragen. |
...
| [NoClip](#NoClip) | Überstehende Teile von Glyphen und nicht umgebrochener Text, die außerhalb des Formatierungsrechtecks reichen, dürfen angezeigt werden. |
...
Steuerzeichen wie das Links-nach-rechts-Zeichen werden in der Ausgabe mit einem repräsentativen Glyphen angezeigt.
...
Teile von Zeichen dürfen über das Layout‑Rechteck der Zeichenkette hinausragen. Standardmäßig werden Zeichen neu positioniert, um ein Überstehen zu vermeiden.
...
Überstehende Teile von Glyphen und nicht umgebrochener Text, die außerhalb des Formatierungsrechtecks reichen, dürfen angezeigt werden. Standardmäßig werden alle Texte und Glyphen‑Teile, die außerhalb des Formatierungsrechtecks liegen, abgeschnitten.
