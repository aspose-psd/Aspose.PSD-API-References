...
description: "Gibt den Fülltyp an, den ein Pen‑Objekt zum Füllen von Linien verwendet."
type: docs
weight: 79
url: /de/java/com.aspose.psd/pentype/
---
...
| [HatchFill](#HatchFill) | Gibt eine Schraffurfüllung an. |
| [LinearGradient](#LinearGradient) | Gibt eine lineare Farbverlauf‑Füllung an. |
| [PathGradient](#PathGradient) | Gibt eine Pfad‑Farbverlauf‑Füllung an. |
| [SolidColor](#SolidColor) | Gibt eine einfarbige Füllung an. |
| [TextureFill](#TextureFill) | Gibt eine Bitmap‑Textur‑Füllung an. |
## Methoden
...
Gibt eine lineare Farbverlauf‑Füllung an.
...
Gibt eine Pfad‑Farbverlauf‑Füllung an.
...
Gibt eine einfarbige Füllung an.
...
Gibt eine Bitmap‑Textur‑Füllung an.
