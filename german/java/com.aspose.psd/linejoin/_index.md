...
description: "Gibt an, wie aufeinanderfolgende Linien- oder Kurvensegmente in einem Figurenunterpfad, der in einem GraphicsPath‑Objekt enthalten ist, verbunden werden."
type: docs
weight: 67
url: /de/java/com.aspose.psd/linejoin/
---
...
| [Miter](#Miter) | Gibt eine Gehrungsverbindung an. |
| [MiterClipped](#MiterClipped) | Gibt eine Gehrungsverbindung an. |
...
Gibt eine Gehrungsverbindung an. Dies erzeugt eine spitze Ecke oder eine abgeschnittene Ecke, abhängig davon, ob die Länge des Gehrungs‑Limits das Gehrungs‑Limit überschreitet.
...
Gibt eine Gehrungsverbindung an. Dies erzeugt eine spitze Ecke oder eine abgeschrägte Ecke, abhängig davon, ob die Länge des Gehrungs‑Limits das Gehrungs‑Limit überschreitet.
