...
description: "Definiert die LnkeDataSource-Klasse, die Informationen über eine extern verlinkte Datei enthält."
type: docs
weight: 11
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource/
---
...
Definiert die Klasse LnkeDataSource, die Informationen über externe verknüpfte Dateien enthält. Dies ist Teil der PSD File Format Manipulation API, die beim Ändern von Adobe® Photoshop®-Dateien hilft.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [LiFeDataSource()](#LiFeDataSource--) | Initialisiert eine neue Instanz der [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)-Klasse. |
| [LiFeDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFeDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | Initialisiert eine neue Instanz der [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)-Klasse. |
## Felder
...
| [getAdobeStockId()](#getAdobeStockId--) | Liest oder setzt die Grafikbibliothek AdobeStockId für Adobe® Photoshop® CC Libraries. |
| [getAdobeStockLicenseState()](#getAdobeStockLicenseState--) | Liest den Status der Adobe Stock-Lizenz, falls verfügbar, für Adobe® Photoshop® CC Libraries. |
...
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | Liest die Länge zusätzlicher Daten. |
| [getDataLength_internalized()](#getDataLength-internalized--) | Liest die Länge der Link-Quellendaten. |
| [getDate()](#getDate--) | Liest oder setzt das Datum und die Uhrzeit der letzten Schreibvorgangs der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
| [getDate_internalized()](#getDate-internalized--) |  |
| [getElementName()](#getElementName--) | Liest oder setzt den Namen des Grafikbibliothekselements für Adobe® Photoshop® CC Libraries. |
| [getElementRef()](#getElementRef--) | Liest oder setzt die Referenz des Grafikbibliothekselements für Adobe® Photoshop® CC Libraries. |
| [getFileCreator()](#getFileCreator--) | Liest oder setzt den Dateiersteller in der PSD-Format LnkE / Lnk2-Ressource. |
| [getFileName()](#getFileName--) | Liest oder setzt den Namen der externen oder eingebetteten Datei in der PSD-Link-Ressource. |
| [getFileSize()](#getFileSize--) | Liest oder setzt die Größe der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
...
| [getFullPath()](#getFullPath--) | Liest oder setzt den vollständigen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
...
| [getRelativePath()](#getRelativePath--) | Liest oder setzt den relativen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
...
| [setAdobeStockId(String value)](#setAdobeStockId-java.lang.String-) | Liest oder setzt die Grafikbibliothek AdobeStockId für Adobe® Photoshop® CC Libraries. |
...
| [setDate(Date value)](#setDate-java.util.Date-) | Liest oder setzt das Datum und die Uhrzeit der letzten Schreibvorgangs der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
| [setDate_internalized(System.DateTime value)](#setDate-internalized-com.aspose.ms.System.DateTime-) |  |
| [setElementName(String value)](#setElementName-java.lang.String-) | Liest oder setzt den Namen des Grafikbibliothekselements für Adobe® Photoshop® CC Libraries. |
| [setElementRef(String value)](#setElementRef-java.lang.String-) | Liest oder setzt die Referenz des Grafikbibliothekselements für Adobe® Photoshop® CC Libraries. |
...
| [setFileName(String value)](#setFileName-java.lang.String-) | Liest oder setzt den Namen der externen oder eingebetteten Datei in der PSD-Link-Ressource. |
...
| [setFileSize(long value)](#setFileSize-long-) | Liest oder setzt die Größe der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | Liest oder setzt den vollständigen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
...
| [setRelativePath(String value)](#setRelativePath-java.lang.String-) | Liest oder setzt den relativen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource. |
...
Initialisiert eine neue Instanz der [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)-Klasse.
...
Liest den Status der Adobe Stock-Lizenz, falls verfügbar, für Adobe® Photoshop® CC Libraries.

Wert: Der Zustand der Adobe Stock-Lizenz oder eine leere Zeichenkette, wenn sie nicht verfügbar ist.
...
Liest die Länge zusätzlicher Daten.

Wert: Die Länge der Daten.
...
Liest oder setzt das Datum und die Uhrzeit der letzten Schreibvorgangs der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource.
...
Liest oder setzt den Namen des Grafikbibliothekselements für Adobe® Photoshop® CC Libraries.
...
Liest oder setzt die Referenz des Grafikbibliothekselements für Adobe® Photoshop® CC Libraries.
...
Liest oder setzt den Namen der externen oder eingebetteten Datei in der PSD-Link-Ressource.

Wert: Der Name der externen oder eingebetteten Datei.
...
Liest oder setzt die Größe der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource.
...
Liest oder setzt den vollständigen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource.
...
Liest oder setzt den relativen Pfad der externen Datei in der LiFE-Datenquelle der PSD LnkE-Ressource.
