...
description: "Definiert die LinkResource-Klasse, die Informationen über verlinkte oder eingebettete Dateien im PSD-Formatbild enthält."
type: docs
weight: 14
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
Definiert die Klasse LinkResource, die Informationen über verknüpfte oder eingebettete Dateien im PSD-Format-Bild enthält. Die Link-Ressource kann mehrere [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource)-Instanzen enthalten, auf die über Indexer in jeder abgeleiteten Klasse zugegriffen werden kann.
## Felder
...
| [get_Item(int index)](#get-Item-int-) | Ruft die [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) am angegebenen Index ab. |
...
Ruft die [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) am angegebenen Index ab.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| index | int | Der ganzzahlige Index. Wert: Die [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
