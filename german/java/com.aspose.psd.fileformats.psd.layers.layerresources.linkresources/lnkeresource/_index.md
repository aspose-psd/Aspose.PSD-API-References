...
description: "Definiert die LnkeResource-Klasse, die Informationen über externe verlinkte Dateien oder Assets im PSD-Formatbild enthält."
type: docs
weight: 17
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
Definiert die Klasse LnkeResource, die Informationen über externe verknüpfte Dateien oder Assets im PSD-Format-Bild enthält. Die Link-Ressource kann mehrere [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource)-Instanzen enthalten, auf die über den Indexer zugegriffen werden kann. Dies ist ein Teil der PSD File Format Manipulation API, die dabei hilft, Adobe® Photoshop®‑Dateien programmgesteuert zu ändern.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | Initialisiert eine neue Instanz der Klasse [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource). |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | Initialisiert eine neue Instanz der Klasse [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource). |
## Felder
...
| [get_Item(int index)](#get-Item-int-) | Ruft die [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) am angegebenen Index ab. |
...
Initialisiert eine neue Instanz der Klasse [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource).
...
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | Die Datenquellen. |
...
Ruft die [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) am angegebenen Index ab.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| index | int | Der Index. Wert: Die [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). |
