...
type: docs
weight: 16
url: /de/java/com.aspose.psd.shapes/rectangleprojectedshape/
---
...
Stellt eine Form dar, die über ein Rechteck projiziert wird, das in eine bestimmte Orientierung gedreht ist. Sie wird durch vier Punkte definiert, die im Raum rotiert werden können, wobei die gleiche Kantenlänge und 90 Grad zwischen benachbarten Kanten beibehalten werden.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [RectangleProjectedShape()](#RectangleProjectedShape--) | Initialisiert eine neue Instanz der  RectangleProjectedShape  Klasse. |
| [RectangleProjectedShape(RectangleF rectangle)](#RectangleProjectedShape-com.aspose.psd.RectangleF-) | Initialisiert eine neue Instanz der  RectangleProjectedShape  Klasse. |
## Methoden
...
Initialisiert eine neue Instanz der  RectangleProjectedShape  Klasse.
...
| --- | --- | --- |
| rectangle | [RectangleF](../../com.aspose.psd/rectanglef) | Das Rechteck, von dem initialisiert wird. |
