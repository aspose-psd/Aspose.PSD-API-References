...
description: "Stellt einen Bézier-Spline dar."
type: docs
weight: 11
url: /de/java/com.aspose.psd.shapes/beziershape/
---
...
Stellt einen Bézier-Spline dar.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [BezierShape()](#BezierShape--) | Initialisiert eine neue Instanz der  BezierShape  Klasse. |
| [BezierShape(PointF[] points)](#BezierShape-com.aspose.psd.PointF---) | Initialisiert eine neue Instanz der  BezierShape  Klasse. |
| [BezierShape(PointF[] points, boolean isClosed)](#BezierShape-com.aspose.psd.PointF---boolean-) | Initialisiert eine neue Instanz der  BezierShape  Klasse. |
## Methoden
...
| --- | --- | --- |
| points | [PointF\[\]](../../com.aspose.psd/pointf) | Das Punkte-Array. |
| isClosed | boolean | Wenn auf  true  gesetzt, ist die Bezier‑Kurve geschlossen. |
