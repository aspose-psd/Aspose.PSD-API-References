...
description: "Die Klasse für die Schwarz‑und‑Weiß‑Einstellungsebene."
type: docs
weight: 11
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
Die Klasse für die Schwarz‑und‑Weiß‑Einstellungsebene.
## Felder
...
| [getTintColor()](#getTintColor--) | Liest oder setzt den Tint Color‑Wert. |
| [getTintColorBlue()](#getTintColorBlue--) | Liest oder setzt den Blue Tint Color‑Doppelwert. |
| [getTintColorGreen()](#getTintColorGreen--) | Liest oder setzt den Green Tint Color‑Doppelwert. |
| [getTintColorRed()](#getTintColorRed--) | Liest oder setzt den Red Tint Color‑Doppelwert. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | Verarbeitet die Pixel. |
...
| [setTintColor(int value)](#setTintColor-int-) | Liest oder setzt den Tint Color‑Wert. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | Liest oder setzt den Blue Tint Color‑Doppelwert. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | Liest oder setzt den Green Tint Color‑Doppelwert. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | Liest oder setzt den Red Tint Color‑Doppelwert. |
...
Liest oder setzt den Tint Color‑Wert.

Wert: Der Tint Color‑Wert.
