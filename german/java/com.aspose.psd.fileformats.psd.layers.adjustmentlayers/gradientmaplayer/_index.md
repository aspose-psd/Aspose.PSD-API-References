...
description: "Verlaufs‑Karten‑Ebene."
type: docs
weight: 19
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
...
Gradient-Map-Ebene. Verarbeitet das Rendern der Gradient-Map mithilfe von Daten aus GrdmResource.
## Felder
...
| [getGradientSettings()](#getGradientSettings--) | Ruft die Gradient-Einstellungen-Instanz ab oder legt sie fest, die von einer GrdmResource-Instanz übergeben wird. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Verarbeitet die Gradient-Map-Ebene. |
...
| [setGradientSettings(GradientMapSettings value)](#setGradientSettings-com.aspose.psd.fileformats.psd.layers.fillsettings.GradientMapSettings-) | Ruft die Gradient-Einstellungen-Instanz ab oder legt sie fest, die von einer GrdmResource-Instanz übergeben wird. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | Aktualisiert Ebenendaten in der zugehörigen Ebenenressource [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource). |
...
Ruft die Gradient-Einstellungen-Instanz ab oder legt sie fest, die von einer GrdmResource-Instanz übergeben wird.
...
Verarbeitet die Gradient-Map-Ebene.
...
Aktualisiert Ebenendaten in der zugehörigen Ebenenressource [GrdmResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/grdmresource).
