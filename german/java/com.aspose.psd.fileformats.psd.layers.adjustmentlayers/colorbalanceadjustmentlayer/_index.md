...
description: "Die Klasse für die Farb‑Ausgleich‑Einstellungsebene."
type: docs
weight: 16
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
Die Klasse für die Farb‑Ausgleich‑Einstellungsebene.
## Felder
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | Liest oder setzt das Schatten GelbBlau Gleichgewicht. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | Wendet die Korrekturen für die aktuellen Schatten, Mitteltöne und Highlights auf das angegebene int RGB-Array an. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | Liest oder setzt das Schatten GelbBlau Gleichgewicht. |
...
Liest oder setzt das Schatten GelbBlau Gleichgewicht.
...
Wendet die Korrekturen für die aktuellen Schatten, Mitteltöne und Highlights auf das angegebene int RGB-Array an.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Pixel | int[] | Das int Farb‑RGB‑Array. |
