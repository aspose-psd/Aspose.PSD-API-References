...
description: "RGB‑Kanal‑Mischer‑Einstellungsebene."
type: docs
weight: 26
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
RGB‑Kanal‑Mischer‑Einstellungsebene.
## Felder
...
| [getBlueChannel()](#getBlueChannel--) | Liefert den blauen Kanal. |
...
| [getGreenChannel()](#getGreenChannel--) | Liefert den grünen Kanal. |
...
| [getRedChannel()](#getRedChannel--) | Liefert den roten Kanal. |
...
Liefert den blauen Kanal.

Wert: Der blaue Kanal.
...
Liefert den Index des Kanals nach. Gibt RgbMixerChannel zurück.
...
Liefert den grünen Kanal.

Wert: Der grüne Kanal.
