...
description: "CMYK‑Kanal‑Mischer‑Einstellungsebene."
type: docs
weight: 14
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
CMYK‑Kanal‑Mischer‑Einstellungsebene.
## Felder
...
| [getBlackChannel()](#getBlackChannel--) | Ruft den Schwarzkanal ab. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | Liefert den Index des Kanals nach. |
...
| [getCyanChannel()](#getCyanChannel--) | Ruft den Cyan-Kanal ab. |
...
| [getMagentaChannel()](#getMagentaChannel--) | Ruft den Magenta-Kanal ab. |
...
| [getMonochrome()](#getMonochrome--) | Liest oder setzt einen Wert, der angibt, ob diese [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) monochrom ist. |
...
| [getYellowChannel()](#getYellowChannel--) | Ruft den Gelb-Kanal ab. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | Liest oder setzt einen Wert, der angibt, ob diese [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) monochrom ist. |
...
Ruft den Schwarzkanal ab.

Wert: Der Schwarz-Kanal.
...
Liest oder setzt einen Wert, der angibt, ob diese [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) monochrom ist.

Wert:  true  wenn monochrom; andernfalls  false .
