...
description: "Die Klasse für die Invertierungs‑Einstellungsebene."
type: docs
weight: 21
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
Die Klasse für die Invertierungs‑Einstellungsebene.
## Felder
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Verarbeitet die InvertAdjustmentLayer. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | Wendet die Invertierungskorrekturen auf das angegebene int ARGB-Array an. |
...
Verarbeitet die InvertAdjustmentLayer.
...
Wendet die Invertierungskorrekturen auf das angegebene int ARGB-Array an.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Pixel | int[] | Das int ARGB-Array. |
