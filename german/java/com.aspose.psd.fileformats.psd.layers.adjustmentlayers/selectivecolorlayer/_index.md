...
description: "Selektive‑Farbe‑Einstellungsebene."
type: docs
weight: 28
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
Selektive‑Farbe‑Einstellungsebene.
## Felder
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | Liefert die CMYK-Korrektur nach selektiver Farbe. |
| [getContainer()](#getContainer--) | Liest den Image‑Container. |
| [getCorrectionMethod()](#getCorrectionMethod--) | Liefert oder setzt die Korrekturmethode. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | Verarbeitet die Selective Color Ebene. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | Setzt die CMYK-Korrektur nach selektiver Farbe. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | Setzt den Image‑Container. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | Liefert oder setzt die Korrekturmethode. |
...
Liefert die CMYK-Korrektur nach selektiver Farbe.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| selectiveColorsType | int | Selektive Farben. |
...
Liefert oder setzt die Korrekturmethode.

Wert: Die Korrekturmethode.
...
Verarbeitet die Selective Color Ebene.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | Das Pixelrechteck. |
| Pixel | int[] | Das Array von Pixeln. |
| start | [Point](../../com.aspose.psd/point) | Die linke obere Position der Pixel. |
| end | [Point](../../com.aspose.psd/point) | Die rechte untere Position der Pixel. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - Das Pixelrechteck und die verarbeiteten Pixel.
...
Setzt die CMYK-Korrektur nach selektiver Farbe.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| selectiveColorsType | int | Typ der selektiven Farben. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | CMYK-Korrektur. |
