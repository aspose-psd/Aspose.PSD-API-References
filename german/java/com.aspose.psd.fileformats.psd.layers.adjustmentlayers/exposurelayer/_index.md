...
description: "Belichtungs‑Einstellungsebene."
type: docs
weight: 18
url: /de/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getGammaCorrection()](#getGammaCorrection--) | Liest oder setzt die GammaKorrektur. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Liest oder setzt die GammaKorrektur. |
...
Liest oder setzt die Belichtung. Für PS liegt der Bereich der Belichtung von -20 bis +20.
...
Liest oder setzt die GammaKorrektur. Für PS liegt der Bereich der GammaKorrektur von 9,99 bis +0,01.

Wert: Die GammaKorrektur.
