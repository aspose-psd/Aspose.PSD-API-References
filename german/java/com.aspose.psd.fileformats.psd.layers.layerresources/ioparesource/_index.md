...
description: "Klasse IopaResource."
type: docs
weight: 40
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
Klasse IopaResource. Diese Ressource enthält Informationen über die Füllungs-Opazitäts-Eigenschaft aus dem Ebenenstil-Formular.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [IopaResource()](#IopaResource--) | Initialisiert eine neue Instanz der Klasse [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
| [IopaResource(byte[] data)](#IopaResource-byte---) | Initialisiert eine neue Instanz der Klasse [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
## Felder
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | Ermittelt oder legt die Füll-Opazität fest. |
...
Initialisiert eine neue Instanz der Klasse [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).
...
| --- | --- | --- |
| Daten | byte[] | Die rohen Byte-Daten. |
