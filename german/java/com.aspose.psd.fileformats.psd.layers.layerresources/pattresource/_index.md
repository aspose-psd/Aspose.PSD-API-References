...
type: docs
weight: 66
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/pattresource/
---
...
Klasse PattResource. Ressource mit Musterdaten.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PattResource()](#PattResource--) | Initialisiert eine neue Instanz der [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) Klasse. |
| [PattResource(int key, PattResourceData[] patterns)](#PattResource-int-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Initialisiert eine neue Instanz der [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) Klasse. |
## Felder
...
| [TypeToolKey](#TypeToolKey) | Der 'Patt'-Typ-Tool-Info-Schlüssel für 8‑Bit. |
| [TypeToolKey2](#TypeToolKey2) | Der 'Pat2'-Typ-Tool-Info-Schlüssel für 16‑Bit. |
| [TypeToolKey3](#TypeToolKey3) | Der 'Pat3'-Typ-Tool-Info-Schlüssel für 32‑Bit. |
| [ventureLicense_internalized](#ventureLicense-internalized) | Die Venture-Lizenz. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [addNewPattResourceData_internalized(PattResource resource)](#addNewPattResourceData-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.PattResource-) | Aktualisiert die Patt‑Ressource mit Standarddaten. |
...
| [createDefaultNotEmptyResource_internalized(int bitDepth)](#createDefaultNotEmptyResource-internalized-int-) | Erstellt die Standard‑nicht‑leere Ressource. |
...
| [getPatterns()](#getPatterns--) | Liest oder setzt die Musterdaten; |
...
| [setPatterns(PattResourceData[] value)](#setPatterns-com.aspose.psd.fileformats.psd.layers.layerresources.PattResourceData---) | Liest oder setzt die Musterdaten; |
| [toString()](#toString--) | Gibt einen String zurück, der diese Instanz darstellt. |
| [updateOrAddPattern_internalized(IPatternFillSettings patternSettings)](#updateOrAddPattern-internalized-com.aspose.psd.fileformats.psd.layers.fillsettings.IPatternFillSettings-) | Durchsucht das Musterdaten‑Element und aktualisiert es mit einem neuen, andernfalls wird ein neues am Ende des Arrays hinzugefügt. |
| [wait()](#wait--) |  |
...
Initialisiert eine neue Instanz der [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) Klasse.
...
| patterns | [PattResourceData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresourcedata) | Die Musterdaten. |
...
Der 'Patt'-Typ-Tool-Info-Schlüssel für 8‑Bit.
...
Der 'Pat2'-Typ-Tool-Info-Schlüssel für 16‑Bit.
...
Der 'Pat3'-Typ-Tool-Info-Schlüssel für 32‑Bit.
...
Aktualisiert die Patt‑Ressource mit Standarddaten.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| resource | [PattResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/pattresource) | Die Ressource. |
...
Erstellt die Standard‑nicht‑leere Ressource.
...
Durchsucht das Musterdaten‑Element und aktualisiert es mit einem neuen, andernfalls wird ein neues am Ende des Arrays hinzugefügt.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| patternSettings | [IPatternFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ipatternfillsettings) | Das Mustereinstellungs‑Objekt zum Aktualisieren des Musterelements. |
