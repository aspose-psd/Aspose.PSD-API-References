...
description: "Die Layer-Abschnittsressource."
type: docs
weight: 43
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
Die Layer-Abschnittsressource.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | Initialisiert eine neue Instanz der Klasse [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | Initialisiert eine neue Instanz der Klasse [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## Felder
...
| [getSectionType()](#getSectionType--) | Liest oder setzt den Abschnittstyp. |
| [getSignature()](#getSignature--) | Ermittelt die Signatur der Schichtressource. |
| [getSubtype()](#getSubtype--) | Liest oder setzt den Subtyp. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | Liest oder setzt den Abschnittstyp. |
| [setSubtype(int value)](#setSubtype-int-) | Liest oder setzt den Subtyp. |
...
Initialisiert eine neue Instanz der Klasse [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
| --- | --- | --- |
| sectionType | int | Der Abschnittstyp. |
| subType | int | Der Subtyp. |
