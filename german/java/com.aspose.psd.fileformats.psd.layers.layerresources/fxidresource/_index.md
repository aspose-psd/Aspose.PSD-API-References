...
description: "Die Filter Effects-Ressource enthält Kanäle, eine Benutzer-Maske und eine Blatt-Maske für den Smart-Filter."
type: docs
weight: 29
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource/
---
...
Die Filtereffekte‑Ressource enthält Kanäle, eine Benutzer‑Maske und eine Blatt‑Maske für den Smart‑Filter.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [FXidResource(int key, int version, FilterEffectMaskData[] filterEffectMasks)](#FXidResource-int-int-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Initialisiert eine neue Instanz der [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) Klasse. |
## Felder

| Feld | Beschreibung |
| --- | --- |
| [FEidTypeToolKey](#FEidTypeToolKey) | Der Typwerkzeug-Info-Schlüssel FEid. |
| [FXidTypeToolKey](#FXidTypeToolKey) | Der Typwerkzeug-Info-Schlüssel FXid. |
...
| [getClass()](#getClass--) |  |
| [getFilterEffectMasks()](#getFilterEffectMasks--) | Liest die Filtereffekt-Masken. |
...
| [setFilterEffectMasks_internalized(FilterEffectMaskData[] value)](#setFilterEffectMasks-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.FilterEffectMaskData---) | Liest die Filtereffekt-Masken. |
...
Initialisiert eine neue Instanz der [FXidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxidresource) Klasse.
...
| filterEffectMasks | [FilterEffectMaskData\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/filtereffectmaskdata) | Die Filtereffekt-Masken. |
...
Der Typwerkzeug-Info-Schlüssel FXid.
