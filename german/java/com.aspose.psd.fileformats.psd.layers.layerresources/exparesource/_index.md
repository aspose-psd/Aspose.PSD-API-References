...
type: docs
weight: 28
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
Klasse ExpaResource. Ressource des Belichtungsanpassungs-Layers
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [ExpaResource()](#ExpaResource--) | Initialisiert eine neue Instanz der [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) Klasse. |
| [ExpaResource(float exposure, float offset, float gamma)](#ExpaResource-float-float-float-) | Initialisiert eine neue Instanz der [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) Klasse. |
| [ExpaResource(byte[] bytes)](#ExpaResource-byte---) | Initialisiert eine neue Instanz der [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) Klasse. |
## Felder
...
| [getExposure()](#getExposure--) | Liest oder setzt die Belichtung. |
| [getGammaCorrection()](#getGammaCorrection--) | Liest oder setzt das Gamma. |
...
| [setExposure(float value)](#setExposure-float-) | Liest oder setzt die Belichtung. |
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | Liest oder setzt das Gamma. |
...
| [setOffset(float value)](#setOffset-float-) | Liest oder setzt den Versatz. |
...
Initialisiert eine neue Instanz der [ExpaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/exparesource) Klasse.
...
Ermittelt die Version. Standard ist 1
