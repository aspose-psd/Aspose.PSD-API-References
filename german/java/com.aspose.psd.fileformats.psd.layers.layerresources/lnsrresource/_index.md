...
type: docs
weight: 51
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | Initialisiert eine neue Instanz der Klasse [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | Initialisiert eine neue Instanz der Klasse [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## Felder
...
| [getClass()](#getClass--) |  |
| [getData()](#getData--) | Liest die Rohdaten. |
...
| [getValue()](#getValue--) | Gibt den Wert als LnsrResourceType zurück, wenn das entsprechende Enum beschrieben ist. |
| [hashCode()](#hashCode--) |  |
...
Initialisiert eine neue Instanz der Klasse [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| lnsrResourceType | int | Typ des LNSR. |
...
Initialisiert eine neue Instanz der Klasse [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). Mit benutzerdefiniertem oder unbekanntem Wert
...
Gibt den Wert als LnsrResourceType zurück, wenn das entsprechende Enum beschrieben ist. Andernfalls wird Unknown zurückgegeben

Wert: Der Wert als LnsrResourceType
