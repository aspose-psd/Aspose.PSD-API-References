...
type: docs
weight: 69
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2/
---
...
Klasse PhflResource. Ressource des Belichtungsanpassungs-Layers 2 Version ( = 3 ) oder ( = 2 ) 12 4 Bytes jeweils für XYZ-Farbe(Nur in Version 3) 10 2 Bytes Farbraum gefolgt von 4 \* 2 Bytes Farbbestandteil(Nur in Version 2) 4 Dichte 1 Luminosität beibehalten
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [PhflResourceVersion2()](#PhflResourceVersion2--) | Initialisiert eine neue Instanz der [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) Klasse. |
| [PhflResourceVersion2(byte[] data)](#PhflResourceVersion2-byte---) | Initialisiert eine neue Instanz der [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) Klasse. |
## Felder
...
| [getComponentA()](#getComponentA--) | Liest oder setzt die A-Komponente der Farbe |
| [getComponentB()](#getComponentB--) | Liest oder setzt die B-Komponente |
| [getComponentL()](#getComponentL--) | Liest oder setzt die L-Komponente der Farbe |
| [getData()](#getData--) | Liest oder setzt die Daten. |
| [getDensity()](#getDensity--) | Liest oder setzt die Dichte. |
...
| [getPreserveLuminosity()](#getPreserveLuminosity--) | Liest oder setzt einen Wert, der angibt, ob [preserve luminosity]. |
| [getPsdVersion()](#getPsdVersion--) | Ermittelt die minimale PSD-Version, die für die Schichtressource erforderlich ist. |
| [getRgbColor()](#getRgbColor--) | Liest die Farbe. |
...
| [setColorSpace(short value)](#setColorSpace-short-) | Liest den Farbraum. |
| [setComponentA(short value)](#setComponentA-short-) | Liest oder setzt die A-Komponente der Farbe |
| [setComponentB(short value)](#setComponentB-short-) | Liest oder setzt die B-Komponente |
| [setComponentL(short value)](#setComponentL-short-) | Liest oder setzt die L-Komponente der Farbe |
| [setDensity(int value)](#setDensity-int-) | Liest oder setzt die Dichte. |
...
| [setPreserveLuminosity(boolean value)](#setPreserveLuminosity-boolean-) | Liest oder setzt einen Wert, der angibt, ob [preserve luminosity]. |
| [setRgbColor(Color color)](#setRgbColor-com.aspose.psd.Color-) | Setzt die RGB-Farbe. |
...
Initialisiert eine neue Instanz der [PhflResourceVersion2](../../com.aspose.psd.fileformats.psd.layers.layerresources/phflresourceversion2) Klasse.
...
Liest oder setzt die A-Komponente der Farbe
...
Liest oder setzt die L-Komponente der Farbe
...
Liest oder setzt einen Wert, der angibt, ob [preserve luminosity].

Wert:  true  wenn [preserve luminosity]; andernfalls  false .
