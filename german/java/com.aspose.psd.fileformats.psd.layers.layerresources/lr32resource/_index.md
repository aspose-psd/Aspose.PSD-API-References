...
description: "Die lr32-Ressource."
type: docs
weight: 54
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource/
---
...
| --- | --- |
| [Lr32Resource()](#Lr32Resource--) | Initialisiert eine neue Instanz der [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) Klasse. |
## Felder
...
| [getLayers()](#getLayers--) | Liest oder setzt die Ebenen. |
| [getLength()](#getLength--) | Liest die Ressourcengröße für die PSD-Header-Version des Bildes. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | Liest die Ressourcengröße. |
...
| [getRawData_internalized()](#getRawData-internalized--) | Liest oder setzt die Rohdaten der Ressource. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | Speichert den Ebenendatensatz. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | Liest oder setzt die Ebenen. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | Liest oder setzt die Rohdaten der Ressource. |
...
Initialisiert eine neue Instanz der [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource) Klasse.
...
Liest die Ressourcengröße für die PSD-Header-Version des Bildes.
...
Liest die Ressourcengröße. Sie kann von der psd-Version abhängen.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| psdHeaderVersion | int | Die PSD-Header-Version. |

**Returns:**
int - Die Ressourcengröße.
...
Liest oder setzt die Rohdaten der Ressource.
