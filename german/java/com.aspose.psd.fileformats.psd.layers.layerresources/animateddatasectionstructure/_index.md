...
description: "Der Abschnitt mit animierten Daten."
type: docs
weight: 11
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| Feld | Beschreibung |
| --- | --- |
| [StructureKey](#StructureKey) | Identifiziert den Struktur‑Schlüssel von AnDs. |
## Methoden
...
| [getItems()](#getItems--) | Liest oder setzt die animierten Datenabschnitts‑Strukturen. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Liest oder setzt die ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | Liest oder setzt die Deskriptorsversion. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | Liest oder setzt die animierten Datenabschnitts‑Strukturen. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | Liest oder setzt die unbekannten Bytes 3, die existieren, wenn die Anzahl der Bilder ungerade ist. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Identifiziert den Struktur‑Schlüssel von AnDs.
...
Prüft, ob die Bildanzahl in der 'FrIn'-Listenstruktur ungerade ist.
...
Liest oder setzt die animierten Datenabschnitts‑Strukturen.
...
Liest oder setzt die unbekannten Bytes 3, die existieren, wenn die Anzahl der Bilder ungerade ist.
