...
type: docs
weight: 39
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
Klasse InfxResource. Diese Ressource enthält Informationen über das Blending des beschnittenen Elements.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | Initialisiert eine neue Instanz der [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) Klasse. |
| [InfxResource()](#InfxResource--) | Initialisiert eine neue Instanz der [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) Klasse. |
| [InfxResource(byte[] data)](#InfxResource-byte---) | Initialisiert eine neue Instanz der [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) Klasse. |
## Felder
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | Liest oder setzt einen Wert, der angibt, ob [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | Liest oder setzt einen Wert, der angibt, ob [blend interior elements]. |
...
Initialisiert eine neue Instanz der [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) Klasse.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| blendInteriorElements | boolean | wenn auf  true  [blend interior elements] gesetzt ist. |
...
Initialisiert eine neue Instanz der [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) Klasse. Mit benutzerdefiniertem oder unbekanntem Wert
