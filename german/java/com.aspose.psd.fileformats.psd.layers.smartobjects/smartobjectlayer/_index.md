...
description: "Definiert die SmartObjectLayer‑Klasse, die ein im PSD‑Datei eingebettetes oder in einer externen Datei verknüpftes Smart‑Object enthält."
type: docs
weight: 10
url: /de/java/com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
Definiert die Klasse SmartObjectLayer, die eingebettete Smart Objects in der PSD‑Datei oder verknüpfte Smart Objects in einer externen Datei enthält. Mit Smart Objects können Sie: Nicht‑destruktive Transformationen durchführen. Sie können eine Ebene skalieren, drehen, kippen, verzerren, perspektivisch transformieren oder verziehen, ohne die ursprünglichen Bilddaten oder die Qualität zu verlieren, weil die Transformationen don\\ufffdt die Originaldaten beeinflussen. Mit Vektordaten arbeiten, wie z. B. Vektorgrafiken aus Illustrator, die sonst gerastert würden. Nicht‑destruktive Filterung durchführen. Sie können Filter, die auf Smart Objects angewendet wurden, jederzeit bearbeiten. Ein Smart Object bearbeiten und automatisch alle verknüpften Instanzen aktualisieren. Eine Ebenenmaske anwenden, die that\\ufffds entweder verknüpft oder nicht verknüpft mit der Smart Object‑Ebene ist. Verschiedene Designs mit niedrig aufgelösten Platzhalter‑Bildern ausprobieren, die Sie später durch endgültige Versionen ersetzen. In Adobe\\ufffd Photoshop\\ufffd können Sie den Inhalt eines Bildes in ein PSD‑Dokument einbetten. Weitere Informationen finden Sie hier:   Eine Ebene mit einem eingebetteten Smart Object enthält placed (PlLd)‑ und SoLd‑Ressourcen mit Smart‑Object‑Eigenschaften. Die PlLd‑Ressource kann allein für PSD‑Versionen älter als 10 sein. Diese Ressourcen enthalten die UniqueId der LiFdDataSource im globalen Lnk2Resource mit dem eingebetteten Dateinamen und anderen Parametern, einschließlich des eingebetteten Dateiinhalts im Originalformat als Byte‑Array.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [SmartObjectLayer(System.IO.Stream stream)](#SmartObjectLayer-com.aspose.ms.System.IO.Stream-) | Initialisiert eine neue Instanz der Klasse [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer). |
## Felder

| Feld | Beschreibung |
| --- | --- |
| [BlendSignature](#BlendSignature) | Stellt die Signatur des Mischmodus dar. |
| [BothPlacedAndSmartObjectResourcesFoundMessage_internalized](#BothPlacedAndSmartObjectResourcesFoundMessage-internalized) | Die Meldung, dass sowohl platzierte als auch Smart‑Object‑Ressourcen gefunden wurden. |
| [CanOnlyCopyEmbeddedSmartObjectMessage_internalized](#CanOnlyCopyEmbeddedSmartObjectMessage-internalized) | Die Meldung Sie können nur ein eingebettetes Smart Object kopieren. |
| [LayerHeaderSize](#LayerHeaderSize) | Die Größe des Ebenen-Headers. |
| [NoPlacedOrSmartObjectResourceFoundMessage_internalized](#NoPlacedOrSmartObjectResourceFoundMessage-internalized) | Keine Meldung gefunden für platzierte oder Smart‑Object‑Ressource. |
...
| [WrongPlacedResourceIndicesMessage_internalized](#WrongPlacedResourceIndicesMessage-internalized) | Die Meldung für falsche platzierte Ressourcenindizes. |
...
| [convertToLinked(String linkedPath)](#convertToLinked-java.lang.String-) | Konvertiert dieses eingebettete Smart Object in ein verknüpftes Smart Object. |
...
| [duplicateLayer()](#duplicateLayer--) | Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. |
| [embedLinked()](#embedLinked--) | Bettet das verknüpfte Smart Object in diese Ebene ein. |
| [equals(Object obj)](#equals-java.lang.Object-) | Bestimmt, ob das angegebene Objekt diesem Exemplar gleich ist. |
| [exportContents(String filePath)](#exportContents-java.lang.String-) | Exportiert die eingebetteten oder verknüpften Inhalte in eine Datei. |
...
| [getAllowWarpRepaint_internalized()](#getAllowWarpRepaint-internalized--) | Liest oder setzt das Render-Warp oder verwendet das PS-Bild. |
...
| [getContentType()](#getContentType--) | Ermittelt den Typ des Inhalts der Smart‑Object‑Ebene. |
| [getContents()](#getContents--) | Liest oder setzt den Inhalt der Smart‑Object‑Ebene. |
| [getContentsBounds()](#getContentsBounds--) | Liest oder setzt die Begrenzungen des Smart‑Object‑Inhalts. |
| [getContentsSource()](#getContentsSource--) | Liest oder setzt die Quelle des Smart‑Object‑Inhalts. |
...
| [getImageSizeBeforeChange_internalized()](#getImageSizeBeforeChange-internalized--) | Liest oder setzt die letzte Größe des zu verzerrenden Bildes. |
...
| [getOriginalQuadrilateral_internalized()](#getOriginalQuadrilateral-internalized--) | Liest oder setzt das ursprüngliche Viereck. |
...
| [getPlacedLayerResource_internalized(LayerResource[] resources, int[] placedResourceIndex, int[] smartResourceIndex)](#getPlacedLayerResource-internalized-com.aspose.psd.fileformats.psd.layers.LayerResource---int---int---) | Liest die Indizes der platzierten und Smart‑Layer‑Ressourcen sowie die korrekte platzierte Ressource. |
| [getPlacedResource_internalized()](#getPlacedResource-internalized--) | Liest die platzierte Ebenen‑Ressource. |
...
| [getSmartFilters()](#getSmartFilters--) | Liest die Smart‑Filter. |
...
| [getTransformedQuadrilateral_internalized()](#getTransformedQuadrilateral-internalized--) | Liest oder setzt das Transformations‑Viereck. |
...
| [getWarpProvider_internalized()](#getWarpProvider-internalized--) | Es erhält Funktionen, die beim Verformen helfen. |
| [getWarpSettings()](#getWarpSettings--) | Es liest oder setzt Warp-Parameter, die aus der Ressource gesetzt oder gelesen wurden (Standard). |
...
| [loadContents(LoadOptions options)](#loadContents-com.aspose.psd.LoadOptions-) | Liest die eingebetteten oder verknüpften Bildinhalte der Smart‑Object‑Ebene. |
...
| [newSmartObjectViaCopy()](#newSmartObjectViaCopy--) | Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [onContainerSet_internalized()](#onContainerSet-internalized--) | Aufruf, wenn der Container dieses [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) gesetzt wurde. |
...
| [relinkToFile(String linkedPath)](#relinkToFile-java.lang.String-) | Verknüpft das verknüpfte Smart Object erneut mit einer neuen Datei. |
...
| [replaceContents(Image image)](#replaceContents-com.aspose.psd.Image-) | Ersetzt die in der Smart‑Object‑Ebene eingebetteten Smart‑Object‑Inhalte. |
| [replaceContents(Image image, ResolutionSetting resolution)](#replaceContents-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-) | Ersetzt die in der Smart‑Object‑Ebene eingebetteten Smart‑Object‑Inhalte. |
| [replaceContents(String linkedPath)](#replaceContents-java.lang.String-) | Ersetzt die Inhalte durch eine Datei. |
| [replaceContents(String linkedPath, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-boolean-) | Ersetzt die Inhalte durch eine Datei. |
| [replaceContents(String linkedPath, ResolutionSetting resolution)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-) | Ersetzt die Inhalte durch eine Datei. |
| [replaceContents(String linkedPath, ResolutionSetting resolution, boolean isReplaceOnlyThis)](#replaceContents-java.lang.String-com.aspose.psd.ResolutionSetting-boolean-) | Ersetzt die Inhalte durch eine Datei. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | Ändert die Größe der Kanaldaten |
...
| [setAllowWarpRepaint_internalized(boolean value)](#setAllowWarpRepaint-internalized-boolean-) | Liest oder setzt das Render-Warp oder verwendet das PS-Bild. |
...
| [setContents(byte[] value)](#setContents-byte---) | Liest oder setzt den Inhalt der Smart‑Object‑Ebene. |
| [setContentsBounds(Rectangle value)](#setContentsBounds-com.aspose.psd.Rectangle-) | Liest oder setzt die Begrenzungen des Smart‑Object‑Inhalts. |
| [setContentsSource(LinkDataSource value)](#setContentsSource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource-) | Liest oder setzt die Quelle des Smart‑Object‑Inhalts. |
...
| [setImageSizeBeforeChange_internalized(Size value)](#setImageSizeBeforeChange-internalized-com.aspose.psd.Size-) | Liest oder setzt die letzte Größe des zu verzerrenden Bildes. |
...
| [setOriginalQuadrilateral_internalized(Quadrilateral value)](#setOriginalQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Liest oder setzt das ursprüngliche Viereck. |
...
| [setSmartObjectProvider_internalized(SmartObjectProvider value)](#setSmartObjectProvider-internalized-com.aspose.psd.fileformats.psd.SmartObjectProvider-) | Liest den Smart‑Object‑Provider. |
| [setTop(int value)](#setTop-int-) | Liest oder setzt die Position der obersten Ebene. |
| [setTransformedQuadrilateral_internalized(Quadrilateral value)](#setTransformedQuadrilateral-internalized-com.aspose.internal.fileformats.psd.projective.Quadrilateral-) | Liest oder setzt das Transformations‑Viereck. |
...
| [setWarpSettings(WarpSettings value)](#setWarpSettings-com.aspose.psd.fileformats.psd.layers.warp.structs.WarpSettings-) | Es liest oder setzt Warp-Parameter, die aus der Ressource gesetzt oder gelesen wurden (Standard). |
...
| [updateDataSourceId_internalized(System.Guid sourceId)](#updateDataSourceId-internalized-com.aspose.ms.System.Guid-) | Aktualisiert den Datenquellen‑Bezeichner. |
| [updateModifiedContent()](#updateModifiedContent--) | Aktualisiert den Bild-Cache der Smart‑Object‑Ebene mit dem modifizierten Inhalt. |
| [updateModifiedContentWithImage_internalized(Image image, ResolutionSetting resolution, boolean skipBoundsUpdate)](#updateModifiedContentWithImage-internalized-com.aspose.psd.Image-com.aspose.psd.ResolutionSetting-boolean-) | Aktualisiert den Bild-Cache der Smart‑Object‑Ebene mit modifiziertem Inhalt. |
| [updatePlacedResources_internalized(boolean toEmbedded)](#updatePlacedResources-internalized-boolean-) | Aktualisiert die platzierten / Smart‑Ressourcen, wenn die placedResource geändert wird oder eine Konvertierung erforderlich ist. |
| [updatePreview_internalized(PixelsData targetWarpedPixels)](#updatePreview-internalized-com.aspose.psd.pixelsdatamodels.PixelsData-) | Es ist ein Wrapper für "IWarpSupport", um die Ebenenvorschau zu aktualisieren. |
| [wait()](#wait--) |  |
...
Initialisiert eine neue Instanz der Klasse [SmartObjectLayer](../../com.aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer).

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| stream | com.aspose.ms.System.IO.Stream | Der Stream von Elementen |
...
Die Meldung, dass sowohl platzierte als auch Smart‑Object‑Ressourcen gefunden wurden.
...
Die Meldung Sie können nur ein eingebettetes Smart Object kopieren.
...
Keine Meldung gefunden für platzierte oder Smart‑Object‑Ressource.
...
Die Meldung für falsche platzierte Ressourcenindizes.
...
Konvertiert dieses eingebettete Smart Object in ein verknüpftes Smart Object.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| linkedPath | java.lang.String | Der verknüpfte Pfad. |
...
Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. Beachten Sie, dass bei eingebetteten Smart‑Objects das eingebettete Bild gemeinsam genutzt wird. Wenn Sie das eingebettete Bild kopieren möchten, verwenden Sie die Methode [.newSmartObjectViaCopy](../../null/\#newSmartObjectViaCopy).
...
Bettet das verknüpfte Smart Object in diese Ebene ein.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| filePath | java.lang.String | Der Exportdateipfad. |
...
Liest oder setzt das Render-Warp oder verwendet das PS-Bild.
...
Holt den Typ des Inhalts der Smart‑Object‑Ebenen. Der Inhalt eingebetteter Smart‑Objects ist die eingebettete Rohbilddatei: LiFdDataSource.Data. Der Inhalt verknüpfter Smart‑Objects ist der Rohinhalt der verknüpften Bilddatei, falls verfügbar: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Wir unterstützen das Laden aus der Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library nicht, wenn  LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) true ist. Für reguläre Verknüpfungsdateien verwenden wir zunächst  LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)), um die Datei relativ zum Quellbildpfad  DataStreamSupporter.SourceImagePath zu suchen. Ist sie nicht verfügbar, prüfen wir  LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)); falls das ebenfalls nicht existiert, suchen wir die Verknüpfungsdatei im selben Verzeichnis wie unser Bild:  DataStreamSupporter.SourceImagePath.

Wert: Der Typ des Inhalts der Smart‑Object‑Ebene.
...
Liest oder setzt den Inhalt der Smart‑Object‑Ebene. Der eingebettete Smart‑Object‑Inhalt ist die eingebettete Rohbilddatei: LiFdDataSource.Data und deren Eigenschaften. Der verknüpfte Smart‑Object‑Inhalt ist der Rohinhalt der verknüpften Bilddatei, falls verfügbar, und dessen Eigenschaften: [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). Wir unterstützen das Laden aus der Adobe\ufffd Photoshop\ufffd \ufffd\ufffd Graphics Library nicht, wenn LinkDataSource.IsLibraryLink ([LinkDataSource.isLibraryLink()](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#isLibraryLink--)/[LinkDataSource.setLibraryLink(boolean)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource\#setLibraryLink-boolean-)) true ist. Für reguläre Verknüpfungsdateien verwenden wir zunächst LiFeDataSource.RelativePath ([LiFeDataSource.getRelativePath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getRelativePath)/[LiFeDataSource.setRelativePath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setRelativePath-String-)), um die Datei relativ zum Quellbildpfad DataStreamSupporter.SourceImagePath zu suchen. Ist sie nicht verfügbar, prüfen wir LiFeDataSource.FullPath ([LiFeDataSource.getFullPath](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#getFullPath)/[LiFeDataSource.setFullPath(String)](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource\#setFullPath-String-)). Wenn auch das nicht existiert, suchen wir die Verknüpfungsdatei im selben Verzeichnis wie unser Bild: DataStreamSupporter.SourceImagePath.
...
Liest oder setzt die Begrenzungen des Smart‑Object‑Inhalts.

Wert: Die Grenzen des Smart‑Objects.
...
Liest oder setzt die Quelle des Smart‑Object‑Inhalts.

Wert: Die Datenquelle des Smart‑Objects.
...
Liest oder setzt die letzte Größe des zu verzerrenden Bildes.
...
Liest oder setzt das ursprüngliche Viereck.

Wert: Das ursprüngliche Viereck.
...
Liest die Indizes der platzierten und Smart‑Layer‑Ressourcen sowie die korrekte platzierte Ressource.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| resources | [LayerResource\[\]](../../com.aspose.psd.fileformats.psd.layers/layerresource) | Die Ressourcen. |
| placedResourceIndex | int[] | Index der platzierten Ressource. |
| smartResourceIndex | int[] | Index der Smart‑Ressource. |
...
Liest die platzierte Ebenen‑Ressource.
...
Liest oder setzt das Transformations‑Viereck.

Wert: Das Transformations‑Viereck.
...
Es erhält Funktionen, die beim Verformen helfen.
...
Es liest oder setzt Warp-Parameter, die aus der Ressource gesetzt oder gelesen wurden (Standard).
...
Liest die eingebetteten oder verknüpften Bildinhalte der Smart‑Object‑Ebene.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| options | [LoadOptions](../../com.aspose.psd/loadoptions) | Die Optionen. |
...
Erstellt eine neue Smart‑Object‑Ebene, indem diese kopiert wird. Reproduziert Layer → Smart Objects → New Smart Object über die Kopierfunktion von Adobe\ufffd Photoshop\ufffd. Beachten Sie, dass dies nur für eingebettete Smart‑Objects aktiviert ist, da das eingebettete Bild ebenfalls kopiert wird. Wenn Sie das eingebettete Bild teilen möchten, verwenden Sie die Methode [.duplicateLayer](../../null/\#duplicateLayer).
...
Aufruf, wenn der Container dieses [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) gesetzt wurde.
...
Verknüpft das verknüpfte Smart‑Object erneut mit einer neuen Datei. Es ist nicht nötig, anschließend die Methode UpdateModifiedContent aufzurufen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Das Bild. |
...
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Das Bild. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Die Auflösungseinstellungen. Wenn null, wird die Bildauflösung verwendet. |
...
Ersetzt den Inhalt durch eine Datei. Es ist nicht nötig, anschließend die Methode UpdateModifiedContent aufzurufen.
...
| --- | --- | --- |
| linkedPath | java.lang.String | Der verknüpfte Pfad. |
| isReplaceOnlyThis | boolean | Das Flag gibt an, ob der Inhalt dieser Smart‑Ebene oder aller Smart‑Ebenen mit diesem Inhalt ersetzt wird. |
...
Ändert die Größe der Kanaldaten
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | com.aspose.internal.fileformats.psd.projective.Quadrilateral |  |
...
Aktualisiert den Datenquellen‑Bezeichner.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sourceId | com.aspose.ms.System.Guid | Der Datenquellen‑Bezeichner. |
...
Aktualisiert den Bild-Cache der Smart‑Object‑Ebene mit dem modifizierten Inhalt.
...
Aktualisiert den Bild-Cache der Smart‑Object‑Ebene mit modifiziertem Inhalt.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| image | [Image](../../com.aspose.psd/image) | Das Bild. |
| resolution | [ResolutionSetting](../../com.aspose.psd/resolutionsetting) | Die Auflösung. |
| skipBoundsUpdate | boolean | wenn auf true gesetzt [Grenz‑Update überspringen]. |
...
Aktualisiert die platzierten / Smart‑Ressourcen, wenn die placedResource geändert wird oder eine Konvertierung erforderlich ist.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| toEmbedded | boolean | wenn auf true gesetzt, in eine eingebettete Ressource konvertieren, falls nötig, andernfalls in eine verknüpfte. |
...
Es ist ein Wrapper für "IWarpSupport", um die Ebenenvorschau zu aktualisieren.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| targetWarpedPixels | [PixelsData](../../com.aspose.psd.pixelsdatamodels/pixelsdata) | Pixel und Größe des neuen Vorschaubildes |
