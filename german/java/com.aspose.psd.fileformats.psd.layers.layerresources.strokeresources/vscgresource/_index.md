...
description: "Vektor-Strich-Inhaltsdatenressource."
type: docs
weight: 13
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
...
Vektor-Strich-Inhaltsdatenressource.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [VscgResource()](#VscgResource--) | Initialisiert eine neue Instanz der [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource) Klasse. |
## Felder
...
| [getClass()](#getClass--) |  |
| [getClassId_internalized()](#getClassId-internalized--) | Liest oder setzt den Klassennamen. |
| [getClassName_internalized()](#getClassName-internalized--) | Liest oder setzt die Klassenkennung. |
| [getHeader_internalized()](#getHeader-internalized--) | Ermittelt oder legt den Header fest. |
| [getItems()](#getItems--) | Liest oder setzt die Strukturelemente. |
| [getKey()](#getKey--) | Ermittelt den Schichtressourcen-Schlüssel. |
| [getKeyForData()](#getKeyForData--) | Ganzzahliger Schlüssel, der definiert, welche Art von Fülleinstellungen in der Ressource gespeichert ist: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey |
...
| [setClassId_internalized(ClassID value)](#setClassId-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | Liest oder setzt den Klassennamen. |
| [setClassName_internalized(String value)](#setClassName-internalized-java.lang.String-) | Liest oder setzt die Klassenkennung. |
...
| [setKeyForData_Rename_Namesake_internalized(int value)](#setKeyForData-Rename-Namesake-internalized-int-) | Liest den ganzzahligen Schlüssel, der definiert, welche Art von Fülleinstellungen in der Ressource gespeichert ist: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Warnung! Der Wert der Eigenschaft KeyForData sollte dem Typ der in Items-Strukturen gespeicherten Fülleinstellungen entsprechen. |
| [setKeyForData_internalized(int value)](#setKeyForData-internalized-int-) | Interne Methode, die das Zuweisen der schreibgeschützten Eigenschaft KeyForData ermöglicht. |
...
Initialisiert eine neue Instanz der [VscgResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource) Klasse.
...
Liest oder setzt die Klassenkennung.
...
Ganzzahliger Schlüssel, der definiert, welche Art von Fülleinstellungen in der Ressource gespeichert ist: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey
...
Liest den ganzzahligen Schlüssel, der definiert, welche Art von Fülleinstellungen in der Ressource gespeichert ist: \* Color - 0x536f436f - SoCoResource.TypeToolKey \* Gradient - 0x4764466c - GdFlResource.TypeToolKey \* Pattern - 0x5074466c - PtFlResource.TypeToolKey Warnung! Der Wert der Eigenschaft KeyForData sollte dem Typ der in Items-Strukturen gespeicherten Fülleinstellungen entsprechen.
...
Interne Methode, die das Zuweisen der schreibgeschützten Eigenschaft KeyForData ermöglicht. Sollte nur im Vscg-Ressourcenlader verwendet werden, wenn Ressourceneigenschaften zugewiesen werden.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int | Ganzzahliger Wert für die Eigenschaft KeyForData. |
