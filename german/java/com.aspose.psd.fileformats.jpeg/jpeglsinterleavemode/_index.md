...
type: docs
weight: 14
url: /de/java/com.aspose.psd.fileformats.jpeg/jpeglsinterleavemode/
---
...
Definiert den Interleave-Modus für mehrkomponentige (Farb-)Pixeldaten.
## Felder
...
Der Interleavemodus ist zeilenweise. Eine vollständige Zeile jeder Komponente wird kodiert, bevor zur nächsten Zeile gewechselt wird.
...
Die Daten werden pro Sample kodiert und gespeichert. Bei Farbbildern ist dies das Format wie RGBRGBRGB.
