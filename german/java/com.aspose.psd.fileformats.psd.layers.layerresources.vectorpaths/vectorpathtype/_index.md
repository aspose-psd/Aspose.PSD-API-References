...
description: "Vektor‑Pfad‑Typ gemäß PSD‑Formatspezifikation"
type: docs
weight: 22
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
Vektor‑Pfad‑Typ gemäß PSD‑Formatspezifikation
## Felder

| Feld | Beschreibung |
| --- | --- |
| [ClipboardRecord](#ClipboardRecord) | Der Clipboard-Datensatz |
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | Der geschlossene Subpath-Bezier-Knoten verknüpft |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | Der geschlossene Subpath-Bezier-Knoten nicht verknüpft |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | Der geschlossene Subpath-Längen-Datensatz |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | Der anfängliche Füllregel-Datensatz |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | Der offene Subpath-Bezier-Knoten verknüpft |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | Der offene Subpath-Bezier-Knoten nicht verknüpft |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | Der offene Subpath-Längen-Datensatz |
| [PathFillRuleRecord](#PathFillRuleRecord) | Der Pfad-Füllregel-Datensatz |
## Methoden
...
Der geschlossene Subpath-Bezier-Knoten verknüpft
...
Der geschlossene Subpath-Bezier-Knoten nicht verknüpft
...
Der geschlossene Subpath-Längen-Datensatz
...
Der anfängliche Füllregel-Datensatz
...
Der offene Subpath-Bezier-Knoten verknüpft
...
Der offene Subpath-Bezier-Knoten nicht verknüpft
...
Der offene Subpath-Längen-Datensatz
