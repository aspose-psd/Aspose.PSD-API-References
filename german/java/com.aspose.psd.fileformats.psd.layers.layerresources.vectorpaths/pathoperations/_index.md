...
description: "Die Operationen für die Pfadformen, die Boolesche Operationen kombinieren."
type: docs
weight: 15
url: /de/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/pathoperations/
---
...
| Feld | Beschreibung |
| --- | --- |
| [CombineShapes](#CombineShapes) | Formen kombinieren (OR-Operation). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [ExcludeOverlappingShapes](#ExcludeOverlappingShapes) | Überlappende Formen ausschließen (XOR-Operation). |
| [IntersectShapeAreas](#IntersectShapeAreas) | Formflächen schneiden (AND-Operation). |
| [SubtractFrontShape](#SubtractFrontShape) | Vordere Form subtrahieren (NOT-Operation). |
## Methoden
...
Formflächen schneiden (AND-Operation).
