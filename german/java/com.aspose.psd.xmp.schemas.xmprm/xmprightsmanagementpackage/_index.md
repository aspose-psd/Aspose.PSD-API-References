...
description: "Stellt den XMP-Rechtemanagement-Namespace dar."
type: docs
weight: 10
url: /de/java/com.aspose.psd.xmp.schemas.xmprm/xmprightsmanagementpackage/
---
...
Stellt den XMP-Rechtemanagement-Namespace dar.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [XmpRightsManagementPackage()](#XmpRightsManagementPackage--) | Initialisiert eine neue Instanz der Klasse XmpRightsManagementPackage. |
## Methoden
...
| [setCertificate(String certificate)](#setCertificate-java.lang.String-) | Legt das Zertifikat fest. |
| [setMarkedAsRightManagement(boolean value)](#setMarkedAsRightManagement-boolean-) | Markiert als Rechte-Management-Inhalt |
| [setOwners(String[] owners)](#setOwners-java.lang.String---) | Legt die Eigentümer fest. |
| [setUsageTerms(LangAlt usageTerms)](#setUsageTerms-com.aspose.psd.xmp.LangAlt-) | Legt die Nutzungsbedingungen fest. |
| [setValue(String key, IXmlValue value)](#setValue-java.lang.String-com.aspose.psd.xmp.IXmlValue-) | Setzt den Wert. |
| [setWebStatement(String webStatementUrl)](#setWebStatement-java.lang.String-) | Legt die Web-Erklärung fest. |
...
Initialisiert eine neue Instanz der Klasse XmpRightsManagementPackage.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Zertifikat | java.lang.String | Das Zertifikat. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | wenn auf  true  gesetzt, dass dies eine rights‑managed Ressource ist. |
...
Legt die Eigentümer fest.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Eigentümer | java.lang.String[] | Die Eigentümer. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| usageTerms | [LangAlt](../../com.aspose.psd.xmp/langalt) | Die Nutzungsbedingungen. |
...
Legt die Web-Erklärung fest.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| webStatementUrl | java.lang.String | Die Web‑Statement‑URL. |
