...
type: docs
weight: 18
url: /de/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| --- | --- |
| [PdfOptions()](#PdfOptions--) | Initialisiert eine neue Instanz der [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions)-Klasse. |
## Methoden
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | Gibt die Kern-PDF-Optionen zurück. |
...
| [getPageSize()](#getPageSize--) | Gibt die Größe der Seite zurück. |
| [getPalette()](#getPalette--) | Ruft die Farbpalette ab oder legt sie fest. |
| [getPdfCoreOptions()](#getPdfCoreOptions--) | Die PDF-Kernoptionen |
| [getPdfDocumentInfo()](#getPdfDocumentInfo--) | Liest oder setzt Metadaten für das Dokument. |
...
| [setPageSize(SizeF value)](#setPageSize-com.aspose.psd.SizeF-) | Setzt die Größe der Seite. |
| [setPalette(IColorPalette value)](#setPalette-com.aspose.psd.IColorPalette-) | Ruft die Farbpalette ab oder legt sie fest. |
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | Die PDF-Kernoptionen |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | Liest oder setzt Metadaten für das Dokument. |
...
Initialisiert eine neue Instanz der [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions)-Klasse.
...
Gibt die Kern-PDF-Optionen zurück.
...
Gibt die Größe der Seite zurück.
...
Liest oder setzt Metadaten für das Dokument.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | [SizeF](../../com.aspose.psd/sizef) | die Größe der Seite. |
