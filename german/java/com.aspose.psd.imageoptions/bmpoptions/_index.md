...
description: "Die BMP‑Dateiformat‑Erstellungsoptionen."
type: docs
weight: 10
url: /de/java/com.aspose.psd.imageoptions/bmpoptions/
---
...
| [BmpOptions(BmpOptions bmpOptions)](#BmpOptions-com.aspose.psd.imageoptions.BmpOptions-) | Initialisiert eine neue Instanz der  BmpOptions  Klasse. |
## Methoden
...
| [getBitsPerPixel()](#getBitsPerPixel--) | Liest oder setzt die Anzahl der Bildbits pro Pixel. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setBitsPerPixel(int value)](#setBitsPerPixel-int-) | Liest oder setzt die Anzahl der Bildbits pro Pixel. |
...
| [setCompression(long value)](#setCompression-long-) | Liest oder setzt die Kompression. |
...
| --- | --- | --- |
| bmpOptions | [BmpOptions](../../com.aspose.psd.imageoptions/bmpoptions) | Die BMP-Optionen. |
...
Liest oder setzt die Anzahl der Bildbits pro Pixel.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int | Die Anzahl der Bildbits pro Pixel. |
