...
description: "Deconvolution-Filteroptionen     Bewegungsunschärfe entfernen"
type: docs
weight: 18
url: /de/java/com.aspose.psd.imagefilters.filteroptions/motionwienerfilteroptions/
---
...
Deconvolution-Filteroptionen Deblur Bewegung
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [MotionWienerFilterOptions(int length, double smooth, double angle)](#MotionWienerFilterOptions-int-double-double-) | Initialisiert eine neue Instanz der Klasse MotionWienerFilterOptions. |
## Methoden
...
| [getLength()](#getLength--) | Liest oder setzt die Länge. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAngle(double value)](#setAngle-double-) | Liest oder setzt den Winkel in Grad. |
...
| [setLength(int value)](#setLength-int-) | Liest oder setzt die Länge. |
...
Initialisiert eine neue Instanz der Klasse MotionWienerFilterOptions.
...
| Winkel | double | Der Winkel in Grad. |
