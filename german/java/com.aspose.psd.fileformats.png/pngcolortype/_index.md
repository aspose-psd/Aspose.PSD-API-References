...
type: docs
weight: 10
url: /de/java/com.aspose.psd.fileformats.png/pngcolortype/
---
...
| [Grayscale](#Grayscale) | Stellt den Farbtyp dar, bei dem jedes Pixel ein Graustufen-Sample ist. |
| [GrayscaleWithAlpha](#GrayscaleWithAlpha) | Stellt den Farbtyp dar, bei dem jedes Pixel ein Graustufen-Sample gefolgt von einem Alpha-Sample ist. |
| [IndexedColor](#IndexedColor) | Stellt den Farbtyp dar, bei dem jedes Pixel ein Palettenindex ist; ein PLTE-Chunk muss vorkommen. |
| [Truecolor](#Truecolor) | Stellt den Farbtyp dar, bei dem jedes Pixel ein R,G,B‑Tripel ist. |
| [TruecolorWithAlpha](#TruecolorWithAlpha) | Stellt den Farbtyp dar, bei dem jedes Pixel ein R,G,B‑Tripel gefolgt von einem Alpha-Sample ist. |
## Methoden
...
Stellt den Farbtyp dar, bei dem jedes Pixel ein Graustufen-Sample ist.
...
Stellt den Farbtyp dar, bei dem jedes Pixel ein Graustufen-Sample gefolgt von einem Alpha-Sample ist.
...
Stellt den Farbtyp dar, bei dem jedes Pixel ein Palettenindex ist; ein PLTE-Chunk muss vorkommen.
...
Stellt den Farbtyp dar, bei dem jedes Pixel ein R,G,B‑Tripel gefolgt von einem Alpha-Sample ist.
