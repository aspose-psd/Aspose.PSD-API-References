...
type: docs
weight: 12
url: /de/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | Initialisiert eine neue Instanz der Klasse [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource). |
## Felder
...
| [getUnit()](#getUnit--) | Liest oder setzt die Rand-Einheiten. |
| [getWidth()](#getWidth--) | Liest oder setzt die Randbreite. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | Liest oder setzt die Rand-Einheiten. |
| [setWidth(double value)](#setWidth-double-) | Liest oder setzt die Randbreite. |
| [toString()](#toString--) |  |
...
Initialisiert eine neue Instanz der Klasse [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource).
