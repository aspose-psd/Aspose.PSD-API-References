...
description: "Quick-Masken-Informationsressource"
type: docs
weight: 32
url: /de/java/com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource/
---
...
Quick-Masken-Informationsressource
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [QuickMaskInformationResource()](#QuickMaskInformationResource--) | Initialisiert eine neue Instanz der [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) Klasse. |
## Felder
...
| [getChannelId()](#getChannelId--) | Liest oder setzt die Kanalkennung. |
| [getClass()](#getClass--) |  |
...
| [hashCode()](#hashCode--) |  |
| [isMaskEmpty()](#isMaskEmpty--) | Liest oder setzt einen Wert, der angibt, ob diese Instanz maskenleer ist. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer stream)](#save-com.aspose.psd.StreamContainer-) | Speichert den Ressourcenblock in den angegebenen Stream. |
| [setChannelId(short value)](#setChannelId-short-) | Liest oder setzt die Kanalkennung. |
...
| [setMaskEmpty(boolean value)](#setMaskEmpty-boolean-) | Liest oder setzt einen Wert, der angibt, ob diese Instanz maskenleer ist. |
...
Initialisiert eine neue Instanz der [QuickMaskInformationResource](../../com.aspose.psd.fileformats.psd.resources/quickmaskinformationresource) Klasse.
...
Liest oder setzt die Kanalkennung.

Wert: Die Kanalkennung.
...
Liest oder setzt einen Wert, der angibt, ob diese Instanz maskenleer ist.

Wert:  true  wenn diese Instanz maskenleer ist; andernfalls,  false .
