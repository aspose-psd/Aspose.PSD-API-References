...
description: "Layer-Gruppen-Informationsressource"
type: docs
weight: 25
url: /de/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
Layer-Gruppen-Informationsressource
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | Initialisiert eine neue Instanz der Klasse [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Felder
...
| [getGroups()](#getGroups--) | Liest oder setzt die Gruppen. |
...
| [setGroups(short[] value)](#setGroups-short---) | Liest oder setzt die Gruppen. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | Aktualisiert LinkGroupId in den Ebenen anhand der Eigenschaft Groups. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | Aktualisiert die Werte der Eigenschaft Groups aus den Ebenen. |
...
Aktualisiert LinkGroupId in den Ebenen anhand der Eigenschaft Groups.
...
Aktualisiert die Werte der Eigenschaft Groups aus den Ebenen.
