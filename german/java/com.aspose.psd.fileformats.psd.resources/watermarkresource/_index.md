...
description: "Wasserzeichen-Ressource"
type: docs
weight: 42
url: /de/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | Initialisiert eine neue Instanz der Klasse [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource). |
## Felder
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | Liest oder setzt einen Wert, der angibt, ob diese Instanz ein Wasserzeichen ist. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | Liest oder setzt einen Wert, der angibt, ob diese Instanz ein Wasserzeichen ist. |
| [toString()](#toString--) |  |
...
Initialisiert eine neue Instanz der Klasse [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource).
...
Liest oder setzt einen Wert, der angibt, ob diese Instanz ein Wasserzeichen ist.

Wert:  true  wenn diese Instanz ein Wasserzeichen ist; andernfalls,  false .
