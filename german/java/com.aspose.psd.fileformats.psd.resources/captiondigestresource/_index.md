...
description: "CaptionDigest‑Ressource"
type: docs
weight: 13
url: /de/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | Initialisiert eine neue Instanz der Klasse [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## Felder
...
| [getDigest()](#getDigest--) | Liest oder setzt den Digest. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | Liest oder setzt den Digest. |
