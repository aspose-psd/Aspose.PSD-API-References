...
type: docs
weight: 10
url: /de/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [AliasStructure(key_name)](#AliasStructure_key_name_1) | Initialisiert eine neue Instanz der [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifiziert den Struktur‑Schlüssel. |
| data_length | int | r | Gibt die genaue Datenlänge in Bytes zurück. |
| full_path | string | r/w | Liest oder setzt den vollständigen Pfad. |
...
Initialisiert eine neue Instanz der [AliasStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/) Klasse.
