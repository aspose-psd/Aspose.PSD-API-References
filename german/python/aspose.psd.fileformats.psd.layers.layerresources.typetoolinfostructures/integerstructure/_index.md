...
type: docs
weight: 80
url: /de/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [IntegerStructure(key_name)](#IntegerStructure_key_name_1) | Initialisiert eine neue Instanz der Klasse [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/). |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Der Schlüssel der Integer-Struktur. |
...
| Wert | int | r/w | Liest oder setzt einen Ganzzahlwert. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
Initialisiert eine neue Instanz der Klasse [IntegerStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/integerstructure/).
