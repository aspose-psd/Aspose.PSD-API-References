...
type: docs
weight: 820
url: /de/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/
---
...
| Länge | int | r | Ermittelt die Länge der PlLd-Ressource in Bytes. |
...
| **Name** | **Beschreibung** |
| :- | :- |
| [save(stream_container, psd_version)](#save_stream_container_psd_version_1) | Speichert die PlLD-Ressource im angegebenen Stream-Container. |
