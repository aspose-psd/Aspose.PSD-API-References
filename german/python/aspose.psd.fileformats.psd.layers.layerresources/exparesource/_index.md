...
type: docs
weight: 280
url: /de/python-net/aspose.psd.fileformats.psd.layers.layerresources/exparesource/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [ExpaResource()](#ExpaResource__1) | Initialisiert eine neue Instanz der [ExpaResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/exparesource/) Klasse. |
| [ExpaResource(bytes)](#ExpaResource_bytes_2) | Initialisiert eine neue Instanz der [ExpaResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/exparesource/) Klasse. |
| [ExpaResource(exposure, offset, gamma)](#ExpaResource_exposure_offset_gamma_3) | Initialisiert eine neue Instanz der [ExpaResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/exparesource/) Klasse. |
## **Properties**
...
| Belichtung | float | r/w | Liest oder setzt die Belichtung. |
| gamma_correction | float | r/w | Liest oder setzt das Gamma. |
| Schlüssel | int | r | Liest den Schicht-Ressourcen-Schlüssel. |
| Länge | int | r | Liest die Länge der Schicht-Ressource in Bytes. |
| offset | float | r/w | Liest oder setzt den Versatz. |
...
| version | short | r | Liest die Version. Standard ist 1 |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
Initialisiert eine neue Instanz der [ExpaResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/exparesource/) Klasse.
