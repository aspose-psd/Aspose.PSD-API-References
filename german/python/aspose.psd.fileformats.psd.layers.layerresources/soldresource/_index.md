...
type: docs
weight: 930
url: /de/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [SoLdResource()](#SoLdResource__1) | Initialisiert eine neue Instanz der [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) Klasse.<br/>            Dieser Standardkonstruktor ist für die Verwendung durch [SoLdResourceLoader](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresourcesloaders/soldresourceloader/) vorgesehen.<br/>            Verwenden Sie [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) zum Erstellen von SoLdResource-Klassen. |
| [SoLdResource(unique_id, is_custom, has_comp_info)](#SoLdResource_unique_id_is_custom_has_comp_info_2) | Initialisiert eine neue Instanz der [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/) Klasse.<br/>            Es ist notwendig, die Eigenschaft Items zu setzen oder InitializeItems() aufzurufen, um eine fertige Instanz zu erhalten.<br/>            Dieser Konstruktor ist für die Verwendung durch [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) vorgesehen<br/>            und in Unit-Tests.<br/>            Verwenden Sie [SmartResourceCreator](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/smartresourcecreator/) zum Erstellen von SoLdResource-Klassen. |
## **Properties**
...
| TYPE_TOOL_KEY [static] | int | r | Der Typwerkzeug-Info-Schlüssel: 'SoLd'. |
...
| :- | :- | :- |
| unique_id | Guid | Der eindeutige Bezeichner der Smart-Object-Ebenendaten [SoLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soldresource/). |
