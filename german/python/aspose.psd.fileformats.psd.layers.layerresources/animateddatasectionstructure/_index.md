...
type: docs
weight: 40
url: /de/python-net/aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | Identifiziert den Struktur‑Schlüssel von AnDs. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | Liest oder setzt die animierten Datenabschnittsstrukturen. |
