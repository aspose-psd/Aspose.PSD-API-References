...
type: docs
weight: 200
url: /de/python-net/aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [PrintFlagsResource()](#PrintFlagsResource__1) | Initialisiert eine neue Instanz der PrintFlagsResource Klasse |
## **Properties**
...
| bleed_scale | short | r/w | Ruft das Blutungsmaß ab oder legt es fest. |
| bleed_width | int | r/w | Ruft die Breite der Blutung ab oder legt sie fest. |
| center_crop_mark | byte | r/w | Ruft die Zentrierte Zuschnitt-Markierung ab oder legt sie fest. |
...
Initialisiert eine neue Instanz der PrintFlagsResource Klasse
