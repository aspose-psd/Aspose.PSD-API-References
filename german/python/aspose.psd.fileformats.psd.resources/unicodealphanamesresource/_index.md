---
title: "UnicodeAlphaNamesResource Klasse"
type: docs
weight: 270
url: /de/python-net/aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource__1) | Initialisiert eine neue Instanz der UnicodeAlphaNamesResource Klasse |
## **Properties**
...
| alpha_names | string | r/w | Ruft die Alpha-Namen ab oder legt sie fest. |
...
Initialisiert eine neue Instanz der UnicodeAlphaNamesResource Klasse
