...
type: docs
weight: 260
url: /de/python-net/aspose.psd.fileformats.psd.resources/transparencyindexresource/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [TransparencyIndexResource()](#TransparencyIndexResource__1) | Initialisiert eine neue Instanz der TransparencyIndexResource Klasse |
## **Properties**
...
| transparency_index | short | r/w | Liest oder setzt den Transparenzfarbindex. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
Initialisiert eine neue Instanz der TransparencyIndexResource Klasse
