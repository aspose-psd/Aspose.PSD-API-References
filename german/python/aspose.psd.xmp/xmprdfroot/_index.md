...
type: docs
weight: 460
url: /de/python-net/aspose.psd.xmp/xmprdfroot/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [XmpRdfRoot()](#XmpRdfRoot__1) | Initialisiert eine neue Instanz der XmpRdfRoot-Klasse |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
| [get_namespace_uri(prefix)](#get_namespace_uri_prefix_3) | Liefert den Namespace-URI anhand eines bestimmten Präfixes. Das Präfix kann ohne xmlns beginnen. |
...
Liefert den Namespace-URI anhand eines bestimmten Präfixes. Das Präfix kann ohne xmlns beginnen.
