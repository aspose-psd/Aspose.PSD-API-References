...
type: docs
weight: 20
url: /de/python-net/aspose.psd.exif/jpegexifdata/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [JpegExifData()](#JpegExifData__1) | Initialisiert eine neue Instanz der [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) Klasse. |
| [JpegExifData(common_tags, exif_tags, gps_tags)](#JpegExifData_common_tags_exif_tags_gps_tags_2) | Initialisiert eine neue Instanz der [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) Klasse mit Daten aus einem Array. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_3) | Initialisiert eine neue Instanz der [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) Klasse mit Daten aus einem Array. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| MAX_EXIF_SEGMENT_SIZE [statisch] | int | r | Die maximal zulässige EXIF-Segmentgröße in Bytes. |
...
| compression | ushort | r/w | Liest oder setzt die Kompression. |
...
| make | string | r/w | Liest oder setzt den Hersteller der Aufnahmeeinrichtung. |
...
| orientation | [ExifOrientation](/psd/python-net/aspose.psd.exif.enums/exiforientation/) | r/w | Liest oder setzt die Orientierung. |
| photographic_sensitivity | uint | r/w | Liest oder setzt die fotografische Empfindlichkeit. |
| photometric_interpretation | ushort | r/w | Liest oder setzt die photometrische Interpretation. |
...
| planar_configuration | ushort | r/w | Liest oder setzt die planare Konfiguration. |
| primary_chromaticities | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Liest oder setzt die Chromatik der drei Primärfarben des Bildes. |
...
| reference_black_white | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Liest oder setzt das Referenz-Schwarz-Weiß. |
| related_sound_file | string | r/w | Liest oder setzt die zugehörige Audiodatei. |
| resolution_unit | [ExifUnit](/psd/python-net/aspose.psd.exif.enums/exifunit/) | r/w | Liest oder setzt die Auflösungseinheit. |
| samples_per_pixel | ushort | r/w | Liest oder setzt die Proben pro Pixel. |
...
| thumbnail | [RasterImage](/psd/python-net/aspose.psd/rasterimage) | r/w | Liest oder setzt das Vorschaubild. |
| transfer_function | ushort | r/w | Liest oder setzt die Transferfunktion. |
...
| x_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Liest oder setzt die x-Auflösung. |
| y_cb_cr_coefficients | [TiffRational[]](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Liest oder setzt die Matrixkoeffizienten für die Transformation von RGB zu YCbCr Bilddaten. |
| y_cb_cr_positioning | [ExifYCbCrPositioning](/psd/python-net/aspose.psd.exif.enums/exifycbcrpositioning/) | r/w | Liest oder setzt die Position der Chrominanzkomponenten in Bezug auf die Luminanzkomponente. |
| y_cb_cr_sub_sampling | ushort | r/w | Liest oder setzt das Abtastverhältnis der Chrominanzkomponenten in Bezug auf die Luminanzkomponente. |
| y_resolution | [TiffRational](/psd/python-net/aspose.psd.fileformats.tiff/tiffrational/) | r/w | Liest oder setzt die y-Auflösung. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
| [serialize_exif_data()](#serialize_exif_data__3) | Serialisiert die EXIF-Daten. Schreibt die Tag-Werte und Inhalte. Das am meisten die Größe beeinflussende Tag ist der Inhalt des Thumbnail-Tags. |
...
Initialisiert eine neue Instanz der [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) Klasse.
...
Initialisiert eine neue Instanz der [JpegExifData](/psd/python-net/aspose.psd.exif/jpegexifdata/) Klasse mit Daten aus einem Array.
...
Serialisiert die EXIF-Daten. Schreibt die Tag-Werte und Inhalte. Das am meisten die Größe beeinflussende Tag ist der Inhalt des Thumbnail-Tags.
