...
type: docs
weight: 1600
url: /de/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | Initialisiert eine neue Instanz der [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) Klasse.<br/>            Alle Ressourcen werden im Standardzustand erstellt. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | Liest oder setzt Füll-Einstellungen für den inneren Bereich von Formen in der Shape‑Ebene. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | Liest die Menge der Pfade, die in einer Shape‑Ebene vorhanden sind. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | Liest oder setzt die Strich‑Einstellungen von Formen. |
| oben | int | r/w |  |
...
| [create_instance()](#create_instance__7) | Erstellt eine neue Instanz der Klasse [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | Aktualisiert Ressourcen aus den Eigenschaften der Shape‑Ebene. |
...
Initialisiert eine neue Instanz der [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) Klasse.<br/>            Alle Ressourcen werden im Standardzustand erstellt.
...
Erstellt eine neue Instanz der Klasse [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | Gibt die neue Instanz der Klasse [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/) zurück. |
