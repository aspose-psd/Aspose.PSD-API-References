...
type: docs
weight: 1750
url: /de/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | Liest die Schriftart. |
| has_alpha | bool | r |  |
...
| inner_text | string | r | Liest den Text der Ebene |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | Liest oder setzt die Textbegrenzungsbox. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | Liest die Farbe des Textes. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | Liest die Textabschnitte. |
| oben | int | r/w |  |
...
| [get_fonts()](#get_fonts__15) | Liest die Schriftartensammlung der Textebene. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | Skaliert das Bild. Der Standard [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) wird verwendet. |
...
| [update_text(text)](#update_text_text_38) | Aktualisiert den Text. |
| [update_text(text, color)](#update_text_text_color_39) | Aktualisiert den Text. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | Aktualisiert den Text. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | Aktualisiert den Text. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | Aktualisiert den Text. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | Aktualisiert den Text. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | Aktualisiert den Text. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | Aktualisiert den Text. |
...
Liest die Schriftartensammlung der Textebene.

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | Die Schriftartensammlung der Textebene. |
...
Skaliert das Bild. Der Standard [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) wird verwendet.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | Der Typ der Skalierungstransformation [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | Der Textwert. |
| color | [Color](/psd/python-net/aspose.psd/color) | Der Farbwert. |
...
| :- | :- | :- |
| text | string | Der Textwert. |
| font_size | float | Größe der Schrift. |
...
| :- | :- | :- |
| text | string | Der Textwert. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | Die linke obere Koordinate. |
