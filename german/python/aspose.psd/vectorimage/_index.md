...
type: docs
weight: 4700
url: /de/python-net/aspose.psd/vectorimage/
---
...
| height_f | float | r | Liest die Objekt‑Höhe in Zoll. |
...
| size_f | [SizeF](/psd/python-net/aspose.psd/sizef) | r | Liest die Objektgröße in Zoll. |
| use_palette | bool | r | Liest einen Wert, der angibt, ob die Bildpalette verwendet wird. |
| width | int | r | Liest die Bildbreite. |
| width_f | float | r | Liest die Objekt‑Breite in Zoll. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
