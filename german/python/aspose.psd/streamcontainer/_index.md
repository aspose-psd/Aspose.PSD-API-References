...
type: docs
weight: 4230
url: /de/python-net/aspose.psd/streamcontainer/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [StreamContainer(stream)](#StreamContainer_stream_1) | Initialisiert eine neue Instanz der [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) Klasse. |
| [StreamContainer(stream, dispose_stream)](#StreamContainer_stream_dispose_stream_2) | Initialisiert eine neue Instanz der [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) Klasse. |
## **Properties**
...
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_5) | Speichert (kopiert) alle Daten des Streams in den angegebenen Stream. Verwendet den Wert des Streams [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
...
| [save(file_path, buffer_size)](#save_file_path_buffer_size_8) | Speichert (kopiert) die Daten des Streams in den angegebenen Stream. Verwendet den Wert des Streams [StreamContainer.length](/psd/python-net/aspose.psd/streamcontainer/). |
...
| [seek(offset, origin)](#seek_offset_origin_10) | Setzt die Position im aktuellen Stream. |
...
| [to_bytes()](#to_bytes__11) | Konvertiert die Stream-Daten in ein int-Array. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_12) | Konvertiert die Stream-Daten in ein int-Array. |
| [write(buffer, offset, count)](#write_buffer_offset_count_13) | Schreibt eine Sequenz von Bytes in den aktuellen Stream und verschiebt die aktuelle Position in diesem Stream um die geschriebene Anzahl von Bytes. |
| [write(bytes)](#write_bytes_14) | Schreibt alle angegebenen Bytes in den Stream. |
| [write_byte(value)](#write_byte_value_15) | Schreibt ein Byte an die aktuelle Position im Stream und verschiebt die Position im Stream um ein Byte. |
| [write_to(stream_container)](#write_to_stream_container_16) | Kopiert die enthaltenen Daten in einen anderen [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
| [write_to(stream_container, length)](#write_to_stream_container_length_17) | Kopiert die enthaltenen Daten in einen anderen [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/). |
...
Initialisiert eine neue Instanz der [StreamContainer](/psd/python-net/aspose.psd/streamcontainer/) Klasse.
