---
title: "SelectiveColorLayer Klasse"
type: docs
weight: 200
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| correction_method | [CorrectionMethodTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes) | r/w | Liest oder setzt die Korrekturmethode. |
...
| [get_cmyk_correction(selective_colors_type)](#get_cmyk_correction_selective_colors_type_8) | Liest die CMYK-Korrektur nach selektiver Farbe. |
...
| [set_cmyk_correction(selective_colors_type, correction)](#set_cmyk_correction_selective_colors_type_correction_36) | Setzt die CMYK-Korrektur nach selektiver Farbe. |
...
Liest die CMYK-Korrektur nach selektiver Farbe.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Selektive Farben. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | CMYK-Korrektur. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| selective_colors_type | [SelectiveColorsTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes) | Typ der selektiven Farben. |
| correction | [CmykCorrection](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykcorrection) | CMYK-Korrektur. |
