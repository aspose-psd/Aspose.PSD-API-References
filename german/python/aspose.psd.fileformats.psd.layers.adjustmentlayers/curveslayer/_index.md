---
title: "CurvesLayer Klasse"
type: docs
weight: 90
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | r/w | Liest oder setzt einen Wert, der angibt, ob bei dieser Instanz ein kontinuierlicher Manager verwendet wird. |
| is_discrete_manager_used | bool | r/w | Liest oder setzt einen Wert, der angibt, ob bei dieser Instanz ein diskreter Manager verwendet wird. |
...
| [get_curves_manager()](#get_curves_manager__8) | Liest den Kurven-Manager. |
...
| Typ | Beschreibung |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) oder [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) die von den Eigenschaften IsDiscreteManagerUsed und IsContinuousManagerUsed abhängt |
