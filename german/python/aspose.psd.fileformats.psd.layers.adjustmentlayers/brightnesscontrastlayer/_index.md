---
title: "BrightnessContrastLayer Klasse"
type: docs
weight: 30
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
...
| Helligkeit | int | r/w | Liest oder setzt die Helligkeit. Für PS liegt der Bereich der Helligkeit zwischen -150 und +150. Wir ignorieren dies jedoch. |
...
| Kontrast | int | r/w | Liest oder setzt den Kontrast. Für PS liegt der Bereich des Kontrasts zwischen -50 und +100. Wir ignorieren dies jedoch. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_29) | Lädt 32‑Bit‑ARGB‑Pixel teilweise (nach Blöcken). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_30) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_31) | Lädt Rohdaten. |
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_32) | Führt die Ebene mit der angegebenen Ebene zusammen |
| normalize_angle() |  |
