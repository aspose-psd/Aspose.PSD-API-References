---
title: "BlackWhiteAdjustmentLayer Klasse"
type: docs
weight: 20
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | Liest oder setzt den Wert von Tint Color. |
| tint_color_blue | double | r/w | Liest oder setzt den Double-Wert von Blue Tint Color. |
| tint_color_green | double | r/w | Liest oder setzt den Double-Wert von Green Tint Color. |
| tint_color_red | double | r/w | Liest oder setzt den Double-Wert von Red Tint Color. |
| oben | int | r/w |  |
