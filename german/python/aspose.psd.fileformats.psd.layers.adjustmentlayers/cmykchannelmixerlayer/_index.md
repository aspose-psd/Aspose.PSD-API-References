...
type: docs
weight: 50
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Liest den schwarzen Kanal. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Liest den Cyan-Kanal. |
...
| left | int | r/w |  |
| Länge | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Liest den Magenta-Kanal. |
| monochrome | bool | r/w | Liest oder setzt einen Wert, der angibt, ob dieser [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) monochrom ist. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | Liest den gelben Kanal. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Ermittelt den Index des Kanals. Gibt CmykMixerChannel zurück |
...
| [merge_layer_to(layer_to_merge_into)](#merge_layer_to_layer_to_merge_into_33) | Führt die Ebene mit der angegebenen Ebene zusammen |
| normalize_angle() |  |
...
Ermittelt den Index des Kanals. Gibt CmykMixerChannel zurück
