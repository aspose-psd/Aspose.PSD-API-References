...
type: docs
weight: 180
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Gibt den blauen Kanal zurück. |
| bottom | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Gibt den grünen Kanal zurück. |
| has_alpha | bool | r |  |
...
| raw_line_size | int | r |  |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | Gibt den roten Kanal zurück. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | Liest den Index des Kanals nach. Gibt RgbMixerChannel zurück. |
...
Liest den Index des Kanals nach. Gibt RgbMixerChannel zurück.
