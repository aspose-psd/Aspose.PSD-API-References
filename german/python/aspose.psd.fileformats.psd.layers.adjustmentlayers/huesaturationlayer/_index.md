...
type: docs
weight: 120
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| clipping | byte | r/w |  |
| colorize | bool | r/w | Liest oder legt einen Wert fest, der angibt, ob diese [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) eingefärbt ist. |
...
| [get_range(index)](#get_range_index_20) | Liest den Bereich. |
...
| Typ | Beschreibung |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | Farbbereich HSL |
