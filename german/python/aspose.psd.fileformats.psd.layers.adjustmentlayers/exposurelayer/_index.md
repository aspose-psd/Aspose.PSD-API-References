---
title: "ExposureLayer Klasse"
type: docs
weight: 100
url: /de/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| disposed | bool | r |  |
| Belichtung | float | r/w | Liest oder setzt die Belichtung. Für PS liegt der Bereich der Belichtung zwischen -20 und +20. |
| extra_length | int | r |  |
...
| gamma_correction | float | r/w | Liest oder setzt die GammaCorrection. Für PS liegt der Bereich der GammaCorrection zwischen 9,99 und +0,01. |
| has_alpha | bool | r |  |
...
| offset | float | r/w | Liest oder setzt den Offset. Für PS liegt der Bereich des Offset zwischen -0,5 und +0,5. |
| Deckkraft | byte | r/w |  |
