---
title: "فئة VogkResource"
type: docs
weight: 1110
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources/vogkresource/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [VogkResource()](#VogkResource__1) | ينشئ نسخة جديدة من الفئة [VogkResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vogkresource/) class. |
## **Properties**
...
| shape_origin_settings | [VectorShapeOriginSettings[]](/psd/python-net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/) | r/w | يحصل أو يعيّن إعدادات أصل الشكل. |
...
ينشئ نسخة جديدة من الفئة [VogkResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/vogkresource/) class.
