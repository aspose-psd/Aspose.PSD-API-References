---
title: "AnimatedDataSectionStructure فئة"
type: docs
weight: 40
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| :- | :- | :- | :- |
| STRUCTURE_KEY [static] | int | r | يحدد مفتاح البنية لـ AnDs. |
| items | [OSTypeStructure[]](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | r | يحصل أو يضبط هياكل قسم البيانات المتحركة. |
