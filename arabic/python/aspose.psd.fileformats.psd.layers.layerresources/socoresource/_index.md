---
title: "SoCoResource فئة"
type: docs
weight: 920
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [SoCoResource()](#SoCoResource__1) | يُنشئ مثيلاً جديدًا للفئة [SoCoResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/). |
## **Properties**
...
| color | [Color](/psd/python-net/aspose.psd/color) | r/w | يحصل على لون RGB. |
...
يُنشئ مثيلاً جديدًا للفئة [SoCoResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/socoresource/).
