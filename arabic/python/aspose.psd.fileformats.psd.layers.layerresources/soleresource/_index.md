---
title: "فئة SoLeResource"
type: docs
weight: 940
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [SoLeResource()](#SoLeResource__1) | يُنشئ مثيلاً جديدًا للفئة [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/) فئة. |
| [SoLeResource(unique_id, is_custom, has_comp_info)](#SoLeResource_unique_id_is_custom_has_comp_info_2) | يُنشئ مثيلاً جديدًا للفئة [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/) فئة. |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| PSB_RESOURCE_SIGNATURE [static] | int | r | توقيع المورد الخاص بـ PSB. |
| RESOURCE_SIGNATURE [static] | int | r | توقيع المورد المشترك. |
| TYPE_TOOL_KEY [static] | int | r | مفتاح معلومات أداة النوع: 'SoLE'. |
...
يُنشئ مثيلاً جديدًا للفئة [SoLeResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/) فئة.
...
| معامل | النوع | الوصف |
| :- | :- | :- |
| unique_id | Guid | المعرّف الفريد لبيانات الطبقة الموضوعة [PlLdResource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/plldresource/). |
