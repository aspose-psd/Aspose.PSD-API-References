---
title: "فئة UnitStructure"
type: docs
weight: 180
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [UnitStructure(key_name)](#UnitStructure_key_name_1) | ينشئ مثلاً جديداً من الفئة [UnitStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/). |
## **Properties**
...
| unit_type | [UnitTypes](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unittypes) | r/w | يحصل أو يعيّن نوع الوحدة. |
| قيمة | double | r/w | يحصل أو يعيّن القيمة. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
ينشئ مثلاً جديداً من الفئة [UnitStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/).
