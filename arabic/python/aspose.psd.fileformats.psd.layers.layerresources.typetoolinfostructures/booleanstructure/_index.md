---
title: "BooleanStructure فئة"
type: docs
weight: 20
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [BooleanStructure(key_name)](#BooleanStructure_key_name_1) | ينشئ مثيلاً جديداً من الفئة [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/). |
## **Properties**
...
| قيمة | bool | r/w | يحصل أو يضبط قيمة منطقية. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
ينشئ مثيلاً جديداً من الفئة [BooleanStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/).
