---
title: "فئة PathStructure"
type: docs
weight: 120
url: /ar/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [PathStructure(key_name)](#PathStructure_key_name_1) | يُنشئ مثلاً جديداً من الفئة [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/) . |
## **Properties**
...
| المسار | string | r/w | يحصل أو يعيّن المسار. |
| بادئة | string | r/w | يحصل أو يعيّن بادئة المسار. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
يُنشئ مثلاً جديداً من الفئة [PathStructure](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/) .
