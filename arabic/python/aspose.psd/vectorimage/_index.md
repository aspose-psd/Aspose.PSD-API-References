...
type: docs
weight: 4700
url: /ar/python-net/aspose.psd/vectorimage/
---
...
| height_f | float | r | الحصول على ارتفاع الكائن، بالبوصة. |
...
| size_f | [SizeF](/psd/python-net/aspose.psd/sizef) | r | الحصول على حجم الكائن، بالبوصة. |
| use_palette | bool | r | يحصل على قيمة تشير إلى ما إذا كانت لوحة ألوان الصورة مستخدمة. |
| width | int | r | يحصل على عرض الصورة. |
| width_f | float | r | الحصول على عرض الكائن، بالبوصة. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
