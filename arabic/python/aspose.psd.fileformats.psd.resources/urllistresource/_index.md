---
title: "فئة UrlListResource"
type: docs
weight: 290
url: /ar/python-net/aspose.psd.fileformats.psd.resources/urllistresource/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [UrlListResource()](#UrlListResource__1) | ينشئ مثيلًا جديدًا من الفئة UrlListResource |
## **Properties**
...
| count | int | r/w | يحصل أو يضبط count. |
| data_size | int | r | يحصل على حجم بيانات المورد بالبايت. |
| id | short | r/w | يحصل أو يعيّن المعرف الفريد للمورد. |
| ids | int | r/w | يحصل أو يعيّن المعرفات. |
| longs | int | r/w | يحصل أو يعيّن القيم الطويلة. |
...
| texts | string | r/w | يحصل أو يعيّن النصوص. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
ينشئ مثيلًا جديدًا من الفئة UrlListResource
