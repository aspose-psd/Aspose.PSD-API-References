...
type: docs
weight: 1750
url: /ar/python-net/aspose.psd.fileformats.psd.layers/textlayer/
---
...
| font | [Font](/psd/python-net/aspose.psd.xmp.types.complex.font/font) | r | يحصل على الخط. |
| has_alpha | bool | r |  |
...
| inner_text | string | r | يحصل على نص الطبقة |
...
| text_bound_box | [RectangleF](/psd/python-net/aspose.psd/rectanglef) | r/w | يحصل أو يعيّن صندوق حدود النص. |
| text_color | [Color](/psd/python-net/aspose.psd/color) | r | يحصل على لون النص. |
| text_data | [IText](/psd/python-net/aspose.psd.fileformats.psd.layers.text/itext/) | r | يحصل على أجزاء النصوص. |
| أعلى | int | r/w |  |
| transform_matrix | double | r/w | يحصل أو يعيّن مصفوفة التحويل |
...
| [get_fonts()](#get_fonts__15) | يحصل على مجموعة الخطوط لطبقة النص. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_35) | يغيّر حجم الصورة. يتم استخدام [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) الافتراضي. |
...
| [update_text(text)](#update_text_text_38) | يحدّث النص. |
| [update_text(text, color)](#update_text_text_color_39) | يحدّث النص. |
| [update_text(text, font_size)](#update_text_text_font_size_40) | يحدّث النص. |
| [update_text(text, font_size, color)](#update_text_text_font_size_color_41) | يحدّث النص. |
| [update_text(text, left_top_coordinate)](#update_text_text_left_top_coordinate_42) | يحدّث النص. |
| [update_text(text, left_top_coordinate, color)](#update_text_text_left_top_coordinate_color_43) | يحدّث النص. |
| [update_text(text, left_top_coordinate, font_size)](#update_text_text_left_top_coordinate_font_size_44) | يحدّث النص. |
| [update_text(text, left_top_coordinate, font_size, color)](#update_text_text_left_top_coordinate_font_size_color_45) | يحدّث النص. |
...
| النوع | الوصف |
| :- | :- |
| [TextFontInfo[]](/psd/python-net/aspose.psd.fileformats.psd.layers.text/textfontinfo/) | مجموعة الخطوط لطبقة النص. |
...
يغيّر حجم الصورة. يتم استخدام [ResizeType.LEFT_TOP_TO_LEFT_TOP](/psd/python-net/aspose.psd/resizetype/) الافتراضي.
...
| resize_type | [ResizeType](/psd/python-net/aspose.psd/resizetype) | نوع تحويل الحجم [ResizeType](/psd/python-net/aspose.psd/resizetype/) |
...
| :- | :- | :- |
| text | string | قيمة النص. |
| color | [Color](/psd/python-net/aspose.psd/color) | قيمة اللون. |
...
| :- | :- | :- |
| text | string | قيمة النص. |
| left_top_coordinate | [Point](/psd/python-net/aspose.psd/point) | الإحداثي العلوي الأيسر. |
