---
title: "فئة ArtboardLayer"
type: docs
weight: 90
url: /ar/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| background_color | [Color](/psd/python-net/aspose.psd/color) | r/w | يحصل أو يضبط لون خلفية لوحة الرسم. |
| بتات_لكل_بكسل | int | r |  |
...
| has_alpha | bool | r |  |
| has_background_color | bool | r/w | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [ArtboardLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/artboardlayer/) لديه لون الخلفية. |
| has_transparent_color | bool | r/w |  |
| الارتفاع | int | r | <inheritdoc /> |
...
| is_cached | bool | r |  |
| is_open | bool | r/w | يحصل أو يضبط ما إذا كان المجلد مفتوحًا<br/>            إذا تم تعيينه إلى <c>true</c> فإن المجموعة ستكون في حالة مفتوحة عند بدء التشغيل، وإلا ستكون في حالة مصغرة. |
...
| layers | [Layer[]](/psd/python-net/aspose.psd.xmp.schemas.photoshop/layer) | r | يحصل على الطبقات في مجموعة الطبقة |
...
| **Name** | **الوصف** |
| :- | :- |
| [add_layer(layer)](#add_layer_layer_1) | يضيف الطبقة إلى مجموعة الطبقة. |
| [add_layer_group(group_name, index)](#add_layer_group_group_name_index_2) | يضيف مجموعة الطبقة. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_31) | يحمّل بكسلات ARGB 32‑بت جزئياً (حسب الكتل). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_32) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_33) | يحمّل البيانات الخام. |
