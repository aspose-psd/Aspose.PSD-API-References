---
title: "فئة ShapeLayer"
type: docs
weight: 1600
url: /ar/python-net/aspose.psd.fileformats.psd.layers/shapelayer/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [ShapeLayer()](#ShapeLayer__1) | ينشئ مثيلًا جديدًا للفئة [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            جميع الموارد تُنشأ بالحالة الافتراضية. |
## **Properties**
...
| fill | [IFillSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) | r/w | يحصل أو يضبط إعدادات التعبئة للمنطقة الداخلية للأشكال في طبقة Shape. |
...
| path | [IPath](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/ipath/) | r | يحصل على مجموعة المسارات الموجودة في طبقة Shape. |
...
| stroke | [IStrokeSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/istrokesettings/) | r/w | يحصل أو يضبط إعدادات الحد للأشكال. |
| أعلى | int | r/w |  |
...
| [create_instance()](#create_instance__7) | ينشئ مثيلًا جديدًا للفئة [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
...
| update() | يقوم بتحديث الموارد من خصائص طبقة الشكل. |
...
ينشئ مثيلًا جديدًا للفئة [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).<br/>            جميع الموارد تُنشأ بالحالة الافتراضية.
...
ينشئ مثيلًا جديدًا للفئة [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/).

**Returns**

| النوع | الوصف |
| :- | :- |
| [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer) | يعيد النسخة الجديدة من الفئة [ShapeLayer](/psd/python-net/aspose.psd.fileformats.psd.layers/shapelayer/). |
