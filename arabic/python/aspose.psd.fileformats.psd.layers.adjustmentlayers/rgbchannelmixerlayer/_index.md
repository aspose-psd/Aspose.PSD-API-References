---
title: "فئة RgbChannelMixerLayer"
type: docs
weight: 180
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| blue_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | يحصل على القناة الزرقاء. |
| أسفل | int | r/w |  |
...
| green_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | يحصل على القناة الخضراء. |
| has_alpha | bool | r |  |
...
| raw_line_size | int | r |  |
| red_channel | [RgbMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbmixerchannel) | r | يحصل على القناة الحمراء. |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | يحصل على فهرس القناة بواسطة. يرجع RgbMixerChannel |
...
يحصل على فهرس القناة بواسطة. يرجع RgbMixerChannel
