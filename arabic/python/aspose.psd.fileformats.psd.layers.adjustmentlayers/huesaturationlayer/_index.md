---
title: "HueSaturationLayer فئة"
type: docs
weight: 120
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| قص | byte | r/w |  |
| colorize | bool | r/w | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا [HueSaturationLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/) مُلوّن. |
...
| [get_range(index)](#get_range_index_20) | يحصل على النطاق. |
...
| النوع | الوصف |
| :- | :- |
| [ColorRangeHsl](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/colorrangehsl/) | نطاق اللون Hsl |
