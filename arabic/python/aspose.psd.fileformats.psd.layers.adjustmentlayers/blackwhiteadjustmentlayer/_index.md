---
title: "فئة BlackWhiteAdjustmentLayer"
type: docs
weight: 20
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| tint_color | int | r/w | يحصل أو يعيّن قيمة لون الصبغة. |
| tint_color_blue | double | r/w | يحصل أو يعيّن قيمة مزدوجة للون الصبغة الأزرق. |
| tint_color_green | double | r/w | يحصل أو يعيّن قيمة مزدوجة للون الصبغة الأخضر. |
| tint_color_red | double | r/w | يحصل أو يعيّن قيمة مزدوجة للون الصبغة الأحمر. |
| أعلى | int | r/w |  |
