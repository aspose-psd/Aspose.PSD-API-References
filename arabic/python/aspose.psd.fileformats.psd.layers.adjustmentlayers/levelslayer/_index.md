---
title: "فئة LevelsLayer"
type: docs
weight: 140
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| left | int | r/w |  |
| الطول | int | r |  |
| master_channel | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | r | يحصل على القناة الرئيسية. |
...
| [get_channel(index)](#get_channel_index_8) | يحصل على القناة. |
...
| النوع | الوصف |
| :- | :- |
| [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) | [LevelChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/levelchannel/) حسب الفهرس |
