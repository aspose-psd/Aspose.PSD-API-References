---
title: "فئة CurvesLayer"
type: docs
weight: 90
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| is_cached | bool | r |  |
| is_continuous_manager_used | bool | r/w | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا الكائن يستخدم مديرًا مستمرًا. |
| is_discrete_manager_used | bool | r/w | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا الكائن يستخدم مديرًا متقطعًا. |
...
| [get_curves_manager()](#get_curves_manager__8) | يحصل على مدير المنحنيات. |
...
| النوع | الوصف |
| :- | :- |
| [CurvesManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesmanager/) | [CurvesDiscreteManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvesdiscretemanager/) أو [CurvesContinuousManager](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/curvescontinuousmanager/) التي تعتمد على خاصية IsDiscreteManagerUsed و IsContinuousManagerUsed |
