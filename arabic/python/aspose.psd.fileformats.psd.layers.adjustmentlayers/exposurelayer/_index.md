---
title: "فئة ExposureLayer"
type: docs
weight: 100
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| disposed | bool | r |  |
| التعريض | float | r/w | يحصل أو يضبط التعريض. النطاق في PS للتعريض هو من -20 إلى +20. |
| extra_length | int | r |  |
...
| تصحيح_الجاما | float | r/w | يحصل أو يضبط تصحيح الجاما. النطاق في PS لتصحيح الجاما هو من 9.99 إلى +0.01 |
| has_alpha | bool | r |  |
...
| offset | float | r/w | يحصل أو يضبط الإزاحة. النطاق في PS للإزاحة هو من -0.5 إلى +0.5 |
| opacity | byte | r/w |  |
