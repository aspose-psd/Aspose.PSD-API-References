---
title: "فئة CmykChannelMixerLayer"
type: docs
weight: 50
url: /ar/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| بتات_لكل_بكسل | int | r |  |
| black_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | يحصل على القناة السوداء. |
...
| cyan_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | يحصل على القناة السماوية. |
...
| left | int | r/w |  |
| الطول | int | r |  |
| magenta_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | يحصل على القناة الأرجوانية. |
| monochrome | bool | r/w | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [ChannelMixerLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/) أحادي اللون. |
...
| yellow_channel | [CmykMixerChannel](/psd/python-net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykmixerchannel) | r | يحصل على القناة الصفراء. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
| [get_channel_by_index(index)](#get_channel_by_index_index_8) | يحصل على فهرس القناة بواسطة. تُرجع CmykMixerChannel |
...
يحصل على فهرس القناة بواسطة. تُرجع CmykMixerChannel
