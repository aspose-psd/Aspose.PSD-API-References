...
type: docs
weight: 10
url: /ar/python-net/aspose.psd.exif/exifdata/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [ExifData()](#ExifData__1) | ينشئ مثيلًا جديدًا من الفئة [ExifData](/psd/python-net/aspose.psd.exif/exifdata/). |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | ينشئ مثيلًا جديدًا من الفئة [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) باستخدام بيانات من مصفوفة. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | ينشئ مثيلًا جديدًا من الفئة [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) باستخدام بيانات من مصفوفة. |
## **Properties**
...
ينشئ مثيلًا جديدًا من الفئة [ExifData](/psd/python-net/aspose.psd.exif/exifdata/).
...
ينشئ مثيلًا جديدًا من الفئة [ExifData](/psd/python-net/aspose.psd.exif/exifdata/) باستخدام بيانات من مصفوفة.
