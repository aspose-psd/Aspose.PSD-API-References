...
type: docs
weight: 10
url: /ar/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [SmartObjectLayer(stream)](#SmartObjectLayer_stream_1) | ينشئ مثيلاً جديداً من الفئة [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/). |
## **Properties**
...
| content_type | [SmartObjectType](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype) | r | يحصل على نوع محتوى طبقة الكائن الذكي.<br/>            المحتوى المدمج للكائن الذكي هو ملف الصورة الخام المدمج: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifddatasource/).<br/>            المحتوى المرتبط للكائن الذكي هو المحتوى الخام لملف الصورة المرتبطة إذا كان متاحًا: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/).<br/>            لا ندعم التحميل من مكتبة الرسومات Adobe� Photoshop� �� عندما يكون [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) صحيحًا.<br/>            بالنسبة لملفات الروابط العادية، في البداية نستخدم [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) للبحث عن الملف نسبياً<br/>            إلى مسار صورة المصدر [None](/psd/python-net/aspose.psd/datastreamsupporter/),<br/>            إذا لم يكن متاحًا ننظر إلى [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/),<br/>            إذا لا يزال غير موجود نبحث عن ملف الرابط في نفس الدليل الذي توجد فيه صورتنا: [None](/psd/python-net/aspose.psd/datastreamsupporter/). |
| contents | byte | r/w | يحصل أو يضبط محتويات طبقة الكائن الذكي.<br/>            المحتوى المدمج للكائن الذكي هو ملف الصورة الخام المدمج: [LiFdDataSource.data](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifdddatasource/) وخصائصه.<br/>            المحتوى المرتبط للكائن الذكي هو المحتوى الخام لملف الصورة المرتبطة إذا كان متاحًا وخصائصه: [LiFeDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/).<br/>            لا ندعم التحميل من مكتبة الرسومات Adobe� Photoshop� �� عندما يكون [LinkDataSource.is_library_link](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) صحيحًا.<br/>            بالنسبة لملفات الروابط العادية، في البداية نستخدم [LiFeDataSource.relative_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/) للبحث عن الملف نسبياً<br/>            إلى مسار صورة المصدر [None](/psd/python-net/aspose.psd/datastreamsupporter/),<br/>            إذا لم يكن متاحًا ننظر إلى [LiFeDataSource.full_path](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/),<br/>            إذا لا يزال غير موجود نبحث عن ملف الرابط في نفس الدليل الذي توجد فيه صورتنا: [None](/psd/python-net/aspose.psd/datastreamsupporter/). |
| contents_bounds | [Rectangle](/psd/python-net/aspose.psd/rectangle) | r/w | يحصل أو يضبط حدود محتوى الكائن الذكي. |
| contents_source | [LinkDataSource](/psd/python-net/aspose.psd.fileformats.psd.layers.layerresources/linkdatasource/) | r/w | يحصل أو يضبط مصدر محتوى الكائن الذكي. |
...
| smart_filters | [SmartFilters](/psd/python-net/aspose.psd.fileformats.psd.layers.smartfilters/smartfilters/) | r | يحصل على الفلاتر الذكية. |
...
| warp_settings | [WarpSettings](/psd/python-net/aspose.psd.fileformats.psd.layers.warp/warpsettings/) | r/w | يقوم بالحصول على أو تعيين معلمات التشويه التي تم تعيينها أو الحصول عليها من المورد (افتراضي) |
...
| [convert_to_linked(linked_path)](#convert_to_linked_linked_path_6) | يحول هذا الكائن الذكي المضمن إلى كائن ذكي مرتبط. |
...
| [duplicate_layer()](#duplicate_layer__8) | إنشاء طبقة كائن ذكي جديدة عن طريق نسخ هذه الطبقة.<br/>            لاحظ أنه بالنسبة للكائنات الذكية المضمنة يتم مشاركة الصورة المضمنة.<br/>            إذا كنت تريد نسخ الصورة المضمنة استخدم طريقة [SmartObjectLayer.new_smart_object_via_copy()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/). |
| embed_linked() | يدمج الكائن الذكي المرتبط في هذه الطبقة. |
| [export_contents(file_path)](#export_contents_file_path_9) | يصدّر المحتويات المدمجة أو المرتبطة إلى ملف. |
...
| [load_contents(options)](#load_contents_options_32) | يحصل على محتويات الصورة المدمجة أو المرتبطة لطبقة الكائن الذكي. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_33) | يحمّل بكسلات ARGB 32‑بت جزئياً (حسب الكتل). |
| load_partial_pixels(desired_rectangle, pixel_loader) |  |
| [load_pixels(rectangle)](#load_pixels_rectangle_34) |    |
| load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) |  |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_35) | يحمّل البيانات الخام. |
| merge_layer_to(layer_to_merge_into) |  |
| [new_smart_object_via_copy()](#new_smart_object_via_copy__36) | ينشئ طبقة كائن ذكي جديدة عن طريق نسخ هذه الطبقة.<br/>            يعيد إنتاج وظيفة `Layer -&gt; Smart Objects -&gt; New Smart Object via Copy` في Adobe Photoshop.<br/>            لاحظ أنه مُفعَّل فقط للكائنات الذكية المدمجة لأن الصورة المدمجة تُنسخ أيضاً.<br/>            إذا كنت تريد مشاركة الصورة المدمجة استخدم طريقة [SmartObjectLayer.duplicate_layer()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/). |
| normalize_angle() |  |
...
| [relink_to_file(linked_path)](#relink_to_file_linked_path_39) | يعيد ربط الكائن الذكي المرتبط بملف جديد.<br/>            لا حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك. |
| replace_color(old_color, old_color_diff, new_color) |  |
| replace_color(old_color_argb, old_color_diff, new_color_argb) |  |
| [replace_contents(image)](#replace_contents_image_40) | يستبدل محتويات الكائن الذكي المدمجة في طبقة الكائن الذكي. |
| [replace_contents(image, resolution)](#replace_contents_image_resolution_41) | يستبدل محتويات الكائن الذكي المدمجة في طبقة الكائن الذكي. |
| [replace_contents(linked_path)](#replace_contents_linked_path_42) | يستبدل المحتويات بملف.<br/>            لا حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك. |
| [replace_contents(linked_path, resolution)](#replace_contents_linked_path_resolution_43) | يستبدل المحتويات بملف.<br/>            لا حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك. |
...
| update_modified_content() | يقوم بتحديث ذاكرة التخزين المؤقت لطبقة الكائن الذكي للصور بالمحتوى المعدل. |
...
ينشئ مثيلاً جديداً من الفئة [SmartObjectLayer](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/).

**Parameters:**

| معامل | النوع | الوصف |
| :- | :- | :- |
| تدفق | _io.BufferedRandom | تدفق العناصر |
...
| معامل | النوع | الوصف |
| :- | :- | :- |
| linked_path | string | المسار المرتبط. |
...
إنشاء طبقة كائن ذكي جديدة عن طريق نسخ هذه الطبقة.<br/>            لاحظ أنه بالنسبة للكائنات الذكية المضمنة يتم مشاركة الصورة المضمنة.<br/>            إذا كنت تريد نسخ الصورة المضمنة استخدم طريقة [SmartObjectLayer.new_smart_object_via_copy()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/).
...
| معامل | النوع | الوصف |
| :- | :- | :- |
| file_path | string | مسار ملف التصدير. |
...
يحصل على محتويات الصورة المدمجة أو المرتبطة لطبقة الكائن الذكي.

**Parameters:**

| معامل | النوع | الوصف |
| :- | :- | :- |
| options | [LoadOptions](/psd/python-net/aspose.psd/loadoptions) | الخيارات. |

**Returns**

| النوع | الوصف |
| :- | :- |
| [Image](/psd/python-net/aspose.psd/image) | مثيل الكائن الذكي [Image](/psd/python-net/aspose.psd/image/) المحمّل. |
...
ينشئ طبقة كائن ذكي جديدة عن طريق نسخ هذه الطبقة.<br/>            يعيد إنتاج وظيفة `Layer -&gt; Smart Objects -&gt; New Smart Object via Copy` في Adobe Photoshop.<br/>            لاحظ أنه مُفعَّل فقط للكائنات الذكية المدمجة لأن الصورة المدمجة تُنسخ أيضاً.<br/>            إذا كنت تريد مشاركة الصورة المدمجة استخدم طريقة [SmartObjectLayer.duplicate_layer()](/psd/python-net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/).
...
يعيد ربط الكائن الذكي المرتبط بملف جديد.<br/>            لا حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك.
...
| معامل | النوع | الوصف |
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | الصورة. |
...
| :- | :- | :- |
| image | [Image](/psd/python-net/aspose.psd/image) | الصورة. |
| resolution | [ResolutionSetting](/psd/python-net/aspose.psd/resolutionsetting) | إعدادات الدقة. إذا كانت القيمة null فسيتم استخدام دقة الصورة. |
...
يستبدل المحتويات بملف.<br/>            لا حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك.
