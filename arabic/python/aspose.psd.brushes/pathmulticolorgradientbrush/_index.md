---
title: "فئة PathMulticolorGradientBrush"
type: docs
weight: 70
url: /ar/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [PathMulticolorGradientBrush(path)](#PathMulticolorGradientBrush_path_1) | يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع المسار المحدد. |
| [PathMulticolorGradientBrush(points)](#PathMulticolorGradientBrush_points_2) | يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع النقاط المحددة. |
| [PathMulticolorGradientBrush(points)](#PathMulticolorGradientBrush_points_3) | يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع النقاط المحددة. |
| [PathMulticolorGradientBrush(points, wrap_mode)](#PathMulticolorGradientBrush_points_wrap_mode_4) | يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع النقاط المحددة ووضع الالتفاف. |
| [PathMulticolorGradientBrush(points, wrap_mode)](#PathMulticolorGradientBrush_points_wrap_mode_5) | يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع النقاط المحددة ووضع الالتفاف. |
## **Properties**
...
يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع المسار المحدد.

**Parameters:**

| معامل | النوع | الوصف |
| :- | :- | :- |
| path | [GraphicsPath](/psd/python-net/aspose.psd/graphicspath) | الـ [GraphicsPath](/psd/python-net/aspose.psd/graphicspath/) الذي يحدد المنطقة المملوءة بواسطة هذا [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/). |
...
يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع النقاط المحددة.
...
يُنشئ مثلاً جديدًا من الفئة [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/) مع النقاط المحددة ووضع الالتفاف.
...
| :- | :- | :- |
| points | [PointF[]](/psd/python-net/aspose.psd/pointf) | مصفوفة من هياكل [PointF](/psd/python-net/aspose.psd/pointf/) التي تمثل النقاط التي تشكّل رؤوس المسار. |
| wrap_mode | [WrapMode](/psd/python-net/aspose.psd/wrapmode) | وضع [WrapMode](/psd/python-net/aspose.psd/wrapmode/) الذي يحدد كيفية تجانب التعبئات المرسومة بهذا [PathMulticolorGradientBrush](/psd/python-net/aspose.psd.brushes/pathmulticolorgradientbrush/). |
