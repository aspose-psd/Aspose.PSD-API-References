...
description: "استثناء حفظ الصورة."
type: docs
weight: 16
url: /ar/java/com.aspose.psd.coreexceptions/imagesaveexception/
---
...
| المنشئ | الوصف |
| --- | --- |
| [ImageSaveException(String message)](#ImageSaveException-java.lang.String-) | يُنشئ مثيلاً جديداً من الفئة ImageSaveException. |
| [ImageSaveException(String message, Throwable innerException)](#ImageSaveException-java.lang.String-java.lang.Throwable-) | يُنشئ مثيلاً جديداً من الفئة ImageSaveException. |
## الطرق
...
يُنشئ مثيلاً جديداً من الفئة ImageSaveException.
