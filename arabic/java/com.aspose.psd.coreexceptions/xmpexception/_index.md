...
description: "الاستثناء الذي يُرمى عندما يكون لدى XMP بنية غير صالحة."
type: docs
weight: 23
url: /ar/java/com.aspose.psd.coreexceptions/xmpexception/
---
...
الاستثناء الذي يُرمى عندما يكون لدى XMP بنية غير صالحة.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [XmpException()](#XmpException--) | يقوم بإنشاء نسخة جديدة من الفئة  XmpException . |
| [XmpException(String message)](#XmpException-java.lang.String-) | يقوم بإنشاء نسخة جديدة من الفئة  XmpException . |
| [XmpException(String message, Throwable innerException)](#XmpException-java.lang.String-java.lang.Throwable-) | يقوم بإنشاء نسخة جديدة من الفئة  XmpException . |
## الحقول
...
يقوم بإنشاء نسخة جديدة من الفئة  XmpException .
