...
description: "يمثل شكل متعدد الأضلاع."
type: docs
weight: 15
url: /ar/java/com.aspose.psd.shapes/polygonshape/
---
...
| المنشئ | الوصف |
| --- | --- |
| [PolygonShape()](#PolygonShape--) | يقوم بتهيئة نسخة جديدة من الفئة  PolygonShape  . |
| [PolygonShape(PointF[] points)](#PolygonShape-com.aspose.psd.PointF---) | يقوم بتهيئة نسخة جديدة من الفئة  PolygonShape  . |
| [PolygonShape(PointF[] points, boolean isClosed)](#PolygonShape-com.aspose.psd.PointF---boolean-) | يقوم بتهيئة نسخة جديدة من الفئة  PolygonShape  . |
## الطرق
...
يقوم بتهيئة نسخة جديدة من الفئة  PolygonShape  .
