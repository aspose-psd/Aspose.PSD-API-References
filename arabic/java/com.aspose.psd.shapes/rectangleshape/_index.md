...
description: "يمثل شكلًا مستطيلًا."
type: docs
weight: 17
url: /ar/java/com.aspose.psd.shapes/rectangleshape/
---
...
| المنشئ | الوصف |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | يقوم بتهيئة نسخة جديدة من الفئة  RectangleShape . |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.psd.RectangleF-) | يقوم بتهيئة نسخة جديدة من الفئة  RectangleShape . |
## الطرق
...
يقوم بتهيئة نسخة جديدة من الفئة  RectangleShape .
