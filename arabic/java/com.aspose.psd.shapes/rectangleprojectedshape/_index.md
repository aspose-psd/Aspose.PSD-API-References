...
type: docs
weight: 16
url: /ar/java/com.aspose.psd.shapes/rectangleprojectedshape/
---
...
يمثل شكلًا يتم إسقاطه على مستطيل موجه إلى اتجاه معين. يتم تحديده بأربع نقاط يمكن تدويرها في الفضاء مع الحفاظ على طول الحواف نفسه و 90 درجة بين الحواف المتجاورة.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [RectangleProjectedShape()](#RectangleProjectedShape--) | ينشئ نسخة جديدة من الفئة  RectangleProjectedShape  . |
| [RectangleProjectedShape(RectangleF rectangle)](#RectangleProjectedShape-com.aspose.psd.RectangleF-) | ينشئ نسخة جديدة من الفئة  RectangleProjectedShape  . |
## الطرق
...
ينشئ نسخة جديدة من الفئة  RectangleProjectedShape  .
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| rectangle | [RectangleF](../../com.aspose.psd/rectanglef) | المستطيل الذي سيتم التهيئة منه. |
