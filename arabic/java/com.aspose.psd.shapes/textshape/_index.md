...
type: docs
weight: 18
url: /ar/java/com.aspose.psd.shapes/textshape/
---
...
| المنشئ | الوصف |
| --- | --- |
| [TextShape()](#TextShape--) | يقوم بتهيئة نسخة جديدة من الفئة  TextShape  . |
| [TextShape(String text, RectangleF rectangle, Font font, StringFormat stringFormat)](#TextShape-java.lang.String-com.aspose.psd.RectangleF-com.aspose.psd.Font-com.aspose.psd.StringFormat-) | يقوم بتهيئة نسخة جديدة من الفئة  TextShape  . |
## الطرق
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setFont(Font value)](#setFont-com.aspose.psd.Font-) | يحصل أو يعيّن الخط المستخدم لرسم النص. |
| [setText(String value)](#setText-java.lang.String-) | يحصل أو يعيّن النص المرسوم. |
| [setTextFormat(StringFormat value)](#setTextFormat-com.aspose.psd.StringFormat-) | يحصل أو يعيّن تنسيق النص. |
| [toString()](#toString--) |  |
...
يقوم بتهيئة نسخة جديدة من الفئة  TextShape  .
...
| rectangle | [RectangleF](../../com.aspose.psd/rectanglef) | مستطيل النص. |
| font | [Font](../../com.aspose.psd/font) | الخط المستخدم. |
