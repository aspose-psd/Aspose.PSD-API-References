...
description: "هيكل السلسلة."
type: docs
weight: 26
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [StringStructure(ClassID keyName)](#StringStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثلاً جديداً من الفئة [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure). |
## الحقول
...
| [setValue(String value)](#setValue-java.lang.String-) | يحصل أو يعيّن القيمة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ مثلاً جديداً من الفئة [StringStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/stringstructure).
