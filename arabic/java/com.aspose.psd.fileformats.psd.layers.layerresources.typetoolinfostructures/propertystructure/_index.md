...
description: "هيكل الخاصية."
type: docs
weight: 23
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [PropertyStructure(ClassID keyName, ClassID classID, ClassID keyID)](#PropertyStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | يُنشئ مثيلاً جديدًا للفئة [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure). |
## الحقول

| حقل | الوصف |
| --- | --- |
| [StructureKey](#StructureKey) | يحدد مفتاح البنية. |
## الطرق
...
| [getKey()](#getKey--) | يحصل على مفتاح البنية. |
| [getKeyID()](#getKeyID--) | يحصل أو يعيّن معرف المفتاح. |
...
| [setKeyID(ClassID value)](#setKeyID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | يحصل أو يعيّن معرف المفتاح. |
...
يُنشئ مثيلاً جديدًا للفئة [PropertyStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/propertystructure).
...
| keyID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | معرف المفتاح. |
