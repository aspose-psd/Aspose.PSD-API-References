...
description: "هيكل الاسم المستعار."
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [AliasStructure(ClassID keyName)](#AliasStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثلاً جديداً من الفئة [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure). |
## الحقول
...
| [getDataLength()](#getDataLength--) | يسترجع الطول الدقيق للبيانات بالبايت. |
| [getFullPath()](#getFullPath--) | يسترجع أو يعيّن المسار الكامل. |
...
| [setFullPath(String value)](#setFullPath-java.lang.String-) | يسترجع أو يعيّن المسار الكامل. |
...
ينشئ مثلاً جديداً من الفئة [AliasStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/aliasstructure).
...
يسترجع الطول الدقيق للبيانات بالبايت.

القيمة: طول البيانات بالبايت.
...
يسترجع أو يعيّن المسار الكامل.

القيمة: المسار الكامل.
