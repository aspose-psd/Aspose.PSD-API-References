...
description: "هيكل الفئة."
type: docs
weight: 12
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [ClassStructure(ClassID keyName, ClassID classID, int structureKey)](#ClassStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | إنشاء نسخة جديدة من الفئة [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure). |
## الحقول

| حقل | الوصف |
| --- | --- |
| [StructureKeyClss](#StructureKeyClss) | يحدد مفتاح البنية. |
| [StructureKeyGlbc](#StructureKeyGlbc) | يحدد مفتاح البنية. |
| [StructureKeyType](#StructureKeyType) | يحدد مفتاح البنية. |
## الطرق
...
إنشاء نسخة جديدة من الفئة [ClassStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/classstructure).
