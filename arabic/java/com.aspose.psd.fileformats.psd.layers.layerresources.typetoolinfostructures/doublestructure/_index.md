...
description: "هيكل العدد المزدوج."
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [DoubleStructure(ClassID keyName)](#DoubleStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثلاً جديداً من الفئة [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure) |
## الحقول
...
| [getValue()](#getValue--) | يحصل أو يعيّن القيمة العشرية. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(double value)](#setValue-double-) | يحصل أو يعيّن القيمة العشرية. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ مثلاً جديداً من الفئة [DoubleStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/doublestructure)
