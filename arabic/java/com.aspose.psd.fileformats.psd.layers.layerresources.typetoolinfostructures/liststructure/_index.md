...
description: "هيكل القائمة."
type: docs
weight: 18
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [ListStructure(ClassID keyName)](#ListStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثلاً جديدًا من الفئة [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) فئة. |
## الحقول
...
| [getItemsCount()](#getItemsCount--) | يحصل على عدد العناصر. |
...
| [getTypes()](#getTypes--) | يحصل أو يعيّن الأنواع. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setTypes(OSTypeStructure[] value)](#setTypes-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | يحصل أو يعيّن الأنواع. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ مثلاً جديدًا من الفئة [ListStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/liststructure) فئة.
