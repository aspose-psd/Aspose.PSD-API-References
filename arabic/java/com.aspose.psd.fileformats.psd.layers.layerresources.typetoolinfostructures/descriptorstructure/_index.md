...
description: "هيكل الوصف"
type: docs
weight: 13
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [DescriptorStructure(ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#DescriptorStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | ينشئ مثلاً جديداً من الفئة [DescriptorStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure). |
## الحقول
...
| [getStructures()](#getStructures--) | يسترجع أو يعيّن البنى. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | يسترجع أو يعيّن البنى. |
...
ينشئ مثلاً جديداً من الفئة [DescriptorStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/descriptorstructure).
