...
description: "هيكل الوحدة."
type: docs
weight: 28
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [UnitStructure(ClassID keyName)](#UnitStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | إنشاء نسخة جديدة من الفئة [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure). |
## الحقول
...
| [getUnitType()](#getUnitType--) | يحصل أو يعيّن نوع الوحدة. |
...
| [setUnitType(int value)](#setUnitType-int-) | يحصل أو يعيّن نوع الوحدة. |
| [setValue(double value)](#setValue-double-) | يحصل أو يعيّن القيمة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
إنشاء نسخة جديدة من الفئة [UnitStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitstructure).
