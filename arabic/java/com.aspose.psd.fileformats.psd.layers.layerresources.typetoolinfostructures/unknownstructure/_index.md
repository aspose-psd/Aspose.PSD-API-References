...
description: "الهيكل غير المعروف."
type: docs
weight: 30
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [UnknownStructure(ClassID keyName, int key)](#UnknownStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-) | ينشئ مثيلاً جديداً من الفئة [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure). |
## الطرق
...
| [getTypeName_internalized()](#getTypeName-internalized--) | يحصل على اسم النوع القابل للقراءة للبنية. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
ينشئ مثيلاً جديداً من الفئة [UnknownStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unknownstructure).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | اسم المفتاح. |
| المفتاح | int | مفتاح الهيكل. |
...
يحصل على اسم النوع القابل للقراءة للبنية.
