...
description: "هيكل القيم المنطقية."
type: docs
weight: 11
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [BooleanStructure(ClassID keyName)](#BooleanStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثلاً جديداً من الفئة [BooleanStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure) |
## الحقول
...
| [getValue()](#getValue--) | يحصل أو يعيّن قيمة منطقية. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setValue(boolean value)](#setValue-boolean-) | يحصل أو يعيّن قيمة منطقية. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ مثلاً جديداً من الفئة [BooleanStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/booleanstructure)
