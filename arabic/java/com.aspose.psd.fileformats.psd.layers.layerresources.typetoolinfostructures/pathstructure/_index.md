...
description: "هيكل المسار."
type: docs
weight: 22
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure/
---
...
| المنشئ | الوصف |
| --- | --- |
| [PathStructure(ClassID keyName)](#PathStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثيلاً جديداً من الفئة [PathStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure). |
## الحقول
...
| [getPath()](#getPath--) | يحصل أو يضبط المسار. |
...
| [getPrefix()](#getPrefix--) | يحصل أو يضبط بادئة المسار. |
...
| [setPath(String value)](#setPath-java.lang.String-) | يحصل أو يضبط المسار. |
...
| [setPrefix(String value)](#setPrefix-java.lang.String-) | يحصل أو يضبط بادئة المسار. |
...
ينشئ مثيلاً جديداً من الفئة [PathStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/pathstructure).
