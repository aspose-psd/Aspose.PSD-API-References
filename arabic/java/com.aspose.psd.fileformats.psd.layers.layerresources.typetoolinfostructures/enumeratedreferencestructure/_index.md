...
description: "هيكل المرجع المُعدَّد."
type: docs
weight: 16
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure/
---
...
هيكل المرجع المُعدَّد.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [EnumeratedReferenceStructure(ClassID keyName, ClassID classID, ClassID typeID, ClassID enumName)](#EnumeratedReferenceStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | ينشئ مثلاً جديدًا من الفئة [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) فئة. |
## الحقول

| حقل | الوصف |
| --- | --- |
| [EnumeratedStructureKey](#EnumeratedStructureKey) | يحدد مفتاح البنية. |
| [StructureKey](#StructureKey) | مفتاح الوصف المُعدد. |
## الطرق
...
| [getEnumName()](#getEnumName--) | يحصل أو يعيّن اسم التعداد. |
...
| [getTypeID()](#getTypeID--) | يحصل أو يعيّن معرف النوع. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setEnumName(ClassID value)](#setEnumName-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | يحصل أو يعيّن اسم التعداد. |
...
| [setTypeID(ClassID value)](#setTypeID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | يحصل أو يعيّن معرف النوع. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
ينشئ مثلاً جديدًا من الفئة [EnumeratedReferenceStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/enumeratedreferencestructure) فئة.
...
| typeID | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | معرف النوع. |
| enumName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | اسم التعداد. |
