...
description: "يعرّف فئة ObjectArrayStructure التي عادةً ما تحتوي على مصفوفة."
type: docs
weight: 20
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure/
---
...
يعرّف فئة ObjectArrayStructure التي عادةً ما تحتوي على مصفوفة [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). تُستخدم في موارد ملف PSD، مثل مورد PlLd ومورد SoLd.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [ObjectArrayStructure(String keyName, String classIdName, OSTypeStructure[] structures)](#ObjectArrayStructure-java.lang.String-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | ينشئ مثلاً جديداً من الفئة [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) |
| [ObjectArrayStructure(int key, ClassID keyName, ClassID classID, String className, OSTypeStructure[] structures)](#ObjectArrayStructure-int-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-java.lang.String-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | ينشئ مثلاً جديداً من الفئة [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure) |
## الحقول

| حقل | الوصف |
| --- | --- |
| [StructureKey](#StructureKey) | يحدد مفتاح بنية 'ObAr'. |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getClassID()](#getClassID--) | يحصل أو يعيّن معرف فئة مصفوفة الكائن. |
| [getClassName()](#getClassName--) | يحصل أو يعيّن اسم فئة مصفوفة الكائن. |
...
| [getItemsList_internalized()](#getItemsList-internalized--) | يحصل على قائمة البنى. |
| [getKey()](#getKey--) | يحصل على مفتاح بنية مصفوفة الكائن. |
| [getKeyName()](#getKeyName--) | يحصل أو يعيّن اسم المفتاح. |
| [getLength()](#getLength--) | يحصل على طول OSTypeStructure بالبايت. |
...
| [getStructureCount()](#getStructureCount--) | يحصل على عدد البنى الفرعية لمصفوفة الكائن. |
| [getStructures()](#getStructures--) | يسترجع أو يعيّن البنى الفرعية في بنية مصفوفة الكائن. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setClassID(ClassID value)](#setClassID-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | يحصل أو يعيّن معرف فئة مصفوفة الكائن. |
| [setClassName(String value)](#setClassName-java.lang.String-) | يحصل أو يعيّن اسم فئة مصفوفة الكائن. |
...
| [setStructures(OSTypeStructure[] value)](#setStructures-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | يسترجع أو يعيّن البنى الفرعية في بنية مصفوفة الكائن. |
...
ينشئ مثلاً جديداً من الفئة [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure)

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| keyName | java.lang.String | اسم المفتاح. |
| classIdName | java.lang.String | اسم معرف الفئة. |
| structures | [OSTypeStructure\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources/ostypestructure) | البنى. |
...
يحصل على مفتاح بنية مصفوفة الكائن.
...
يحصل على طول OSTypeStructure بالبايت.
...
القيمة: عدد البنى الفرعية في بنية مصفوفة الكائن.
...
يسترجع أو يعيّن البنى الفرعية في بنية مصفوفة الكائن.

القيمة: البنى الفرعية في بنية مصفوفة الكائن.
