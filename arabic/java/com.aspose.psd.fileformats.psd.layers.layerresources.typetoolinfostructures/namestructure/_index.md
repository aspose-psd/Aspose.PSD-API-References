...
description: "مفتاح بنية Name 0x6E616D65 الذي يكتب name في ASCII هو بنية بسيطة تُستخدم لتخزين سلسلة Unicode أو بنية على نمط Pascal تمثل اسم عنصر مثل مسار طبقة أو تعديل."
type: docs
weight: 19
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure/
---
...
هيكل Name (المفتاح: 0x6E616D65، والذي يُكتب "name" في ASCII) هو هيكل بسيط يُستخدم لتخزين سلسلة Unicode أو بنمط باسكال تمثل اسم عنصر، مثل طبقة أو مسار أو تعديل.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [NameStructure(ClassID keyName)](#NameStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | إنشاء نسخة جديدة من الفئة [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure). |
## الحقول

| حقل | الوصف |
| --- | --- |
| [StructureKey](#StructureKey) | مفتاح بنية Name. |
## الطرق
...
| [getValue()](#getValue--) | يحصل أو يعيّن قيمة بنية Name. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setFirstNameValue_internalized(String value)](#setFirstNameValue-internalized-java.lang.String-) | يحصل أو يعيّن القيمة النصية الأولى لبنية Name. |
...
| [setValue(String value)](#setValue-java.lang.String-) | يحصل أو يعيّن قيمة بنية Name. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
إنشاء نسخة جديدة من الفئة [NameStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/namestructure).
...
يحصل أو يعيّن القيمة النصية الأولى لبنية Name. عادةً ما يحتوي على رمز نهاية السطر.
