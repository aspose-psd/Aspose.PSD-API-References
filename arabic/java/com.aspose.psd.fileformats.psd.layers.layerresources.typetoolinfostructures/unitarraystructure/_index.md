...
description: "يعرّف فئة UnitArrayStructure التي تحتفظ بمصفوفة قيم مزدوجة ووحدة قياسها."
type: docs
weight: 27
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure/
---
...
يعرّف فئة UnitArrayStructure التي تحتفظ بمصفوفة قيم مزدوجة ووحدة قياسها. تُستخدم في موارد ملفات PSD، عادةً بواسطة [ObjectArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/objectarraystructure).
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [UnitArrayStructure(ClassID keyName, int unitType, double[] values)](#UnitArrayStructure-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-int-double---) | إنشاء نسخة جديدة من الفئة [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## الحقول

| حقل | الوصف |
| --- | --- |
| [StructureKey](#StructureKey) | يحدد مفتاح 'UnFl' لـ [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
## الطرق
...
| [getKey()](#getKey--) | يحصل على مفتاح بنية مصفوفة الوحدات هذا. |
...
| [getUnitType()](#getUnitType--) | يحصل أو يضبط نوع وحدة القياس لقيم [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [getValueCount()](#getValueCount--) | يحصل على عدد القيم. |
| [getValues()](#getValues--) | يحصل أو يضبط قيم بنية مصفوفة الوحدة. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnitType(int value)](#setUnitType-int-) | يحصل أو يضبط نوع وحدة القياس لقيم [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure). |
| [setValues(double[] value)](#setValues-double---) | يحصل أو يضبط قيم بنية مصفوفة الوحدة. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
إنشاء نسخة جديدة من الفئة [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| keyName | [ClassID](../../com.aspose.psd.fileformats.psd.layers.layerresources/classid) | اسم المفتاح. |
| unitType | int | نوع الوحدة. |
| القيم | double[] | القيم. |
...
يحدد مفتاح 'UnFl' لـ [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).
...
يحصل على مفتاح بنية مصفوفة الوحدات هذا.
...
يحصل أو يضبط نوع وحدة القياس لقيم [UnitArrayStructure](../../com.aspose.psd.fileformats.psd.layers.layerresources.typetoolinfostructures/unitarraystructure).

القيمة: نوع وحدة القياس.
...
القيمة: عدد القيم في بنية مصفوفة الوحدة.
...
يحصل أو يضبط قيم بنية مصفوفة الوحدة.
