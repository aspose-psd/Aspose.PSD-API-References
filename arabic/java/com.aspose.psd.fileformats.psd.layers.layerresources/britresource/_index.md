...
description: "الفئة BritResource."
type: docs
weight: 17
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/britresource/
---
...
الفئة BritResource. مورد طبقة تعديل السطوع/التباين
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [BritResource()](#BritResource--) | ينشئ مثيلاً جديداً من الفئة [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). |
| [BritResource(short brightness, short contrast, short meanValueForBrightnessAndContrast, boolean labColor)](#BritResource-short-short-short-boolean-) | ينشئ مثيلاً جديداً من الفئة [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). |
| [BritResource(byte[] bytes)](#BritResource-byte---) | ينشئ مثيلاً جديداً من الفئة [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). |
## الحقول
...
| [getLabColor()](#getLabColor--) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [lab color]. |
...
| [setBrightness(short value)](#setBrightness-short-) | يحصل أو يضبط السطوع. |
| [setContrast(short value)](#setContrast-short-) | يحصل أو يعيّن التباين. |
...
| [setLabColor(boolean value)](#setLabColor-boolean-) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [lab color]. |
| [setMeanValueForBrightnessAndContrast(short value)](#setMeanValueForBrightnessAndContrast-short-) | يحصل أو يعيّن القيمة المتوسطة للسطوع والتباين. |
...
ينشئ مثيلاً جديداً من الفئة [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource).
...
| meanValueForBrightnessAndContrast | short | القيمة المتوسطة للسطوع والتباين. |
...
ينشئ مثيلاً جديداً من الفئة [BritResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/britresource). يحتوي مواصفات تنسيق PSD على الوصف التالي: 2 سطوع 2 تباين 2 القيمة المتوسطة للسطوع والتباين 1 لون Lab فقط. لا يُستخدم في PSD الحديثة (CS5 وما فوق) حيث CgEd هو. CgEd يخزن خصائص المعلومات.
...
القيمة:  true  إذا كان [lab color]؛ وإلا،  false .
