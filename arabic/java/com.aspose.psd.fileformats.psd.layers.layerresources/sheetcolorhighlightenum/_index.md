...
description: "الألوان المحتملة لإعداد لون الورقة."
type: docs
weight: 73
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/sheetcolorhighlightenum/
---
...
الألوان الممكنة لإعداد لون الورقة. إنه لون ديكوري في واجهة المستخدم للطبقة في قائمة الطبقات في PS
## الحقول

| حقل | الوصف |
| --- | --- |
| [Blue](#Blue) | اللون الأزرق. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Gray](#Gray) | اللون الرمادي. |
| [Green](#Green) | اللون الأخضر. |
| [NoColor](#NoColor) | لم يتم تحديد اللون. |
| [Orange](#Orange) | اللون البرتقالي. |
| [Red](#Red) | اللون الأحمر. |
| [Violet](#Violet) | اللون البنفسجي. |
| [Yellow](#Yellow) | اللون الأصفر. |
## الطرق
