...
description: "الفئة IopaResource."
type: docs
weight: 40
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource/
---
...
الفئة IopaResource. يحتوي هذا المورد على معلومات حول خاصية شفافية التعبئة من نموذج نمط الطبقة
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [IopaResource()](#IopaResource--) | يُهيئ مثيلًا جديدًا من الفئة [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
| [IopaResource(byte[] data)](#IopaResource-byte---) | يُهيئ مثيلًا جديدًا من الفئة [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource). |
## الحقول
...
| [setFillOpacity(byte value)](#setFillOpacity-byte-) | يحصل أو يضبط شفافية التعبئة. |
...
يُهيئ مثيلًا جديدًا من الفئة [IopaResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ioparesource).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| بيانات | byte[] | بيانات البايت الخام. |
