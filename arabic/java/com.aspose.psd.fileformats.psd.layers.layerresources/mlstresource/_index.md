...
description: "المورد mlst."
type: docs
weight: 62
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [MlstResource()](#MlstResource--) | يُنشئ مثيلة جديدة من الفئة [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource). |
## الحقول
...
| [getItems()](#getItems--) | يسترجع أو يعيّن البنى. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | يسترجع أو يعيّن البنى. |
...
يُنشئ مثيلة جديدة من الفئة [MlstResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/mlstresource).
