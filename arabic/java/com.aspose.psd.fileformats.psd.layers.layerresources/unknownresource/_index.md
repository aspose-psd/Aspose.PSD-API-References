...
type: docs
weight: 82
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [UnknownResource(int signature, int key)](#UnknownResource-int-int-) | يُنشئ مثيلة جديدة من الفئة [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource). |
## الحقول
...
يُنشئ مثيلة جديدة من الفئة [UnknownResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/unknownresource).
