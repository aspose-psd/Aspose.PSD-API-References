...
description: "القسم الذي يحتوي على بيانات متحركة."
type: docs
weight: 11
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/animateddatasectionstructure/
---
...
| حقل | الوصف |
| --- | --- |
| [StructureKey](#StructureKey) | يحدد مفتاح البنية لـ AnDs. |
## الطرق
...
| [getItems()](#getItems--) | يحصل أو يعيّن هياكل قسم البيانات المتحركة. |
...
| [setClassID_internalized(ClassID value)](#setClassID-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.ClassID-) | يحصل أو يعيّن معرف الفئة ClassID. |
...
| [setDescriptorVersion_internalized(int value)](#setDescriptorVersion-internalized-int-) | يحصل أو يعيّن إصدار الوصف. |
...
| [setItems_internalized(OSTypeStructure[] value)](#setItems-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure---) | يحصل أو يعيّن هياكل قسم البيانات المتحركة. |
...
| [setUnknownBytesForOdd3_internalized(byte[] value)](#setUnknownBytesForOdd3-internalized-byte---) | يحصل أو يعيّن البايتات غير المعروفة 3 التي توجد عندما يكون عدد الإطارات فرديًا. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
يتحقق من أن عدد الإطارات في بنية القائمة 'FrIn' هو عدد فردي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| العناصر | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.psd.fileformats.psd.layers.layerresources.OSTypeStructure> |  |
...
يحصل أو يعيّن هياكل قسم البيانات المتحركة.
...
يحصل أو يعيّن معرف الفئة ClassID.
...
يحصل أو يعيّن البايتات غير المعروفة 3 التي توجد عندما يكون عدد الإطارات فرديًا.
