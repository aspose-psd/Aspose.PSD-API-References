...
description: "مورد مجموعة طبقة التأثيرات Ifxs"
type: docs
weight: 37
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [IfxsResource()](#IfxsResource--) | ينشئ مثلاً جديدًا من الفئة [IfxsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource). |
## الحقول
...
ينشئ مثلاً جديدًا من الفئة [IfxsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/ifxsresource).
