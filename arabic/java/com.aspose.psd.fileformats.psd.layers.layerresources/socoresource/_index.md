...
description: "الفئة SoCoResource."
type: docs
weight: 75
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/socoresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [SoCoResource()](#SoCoResource--) | يُنشئ مثيلة جديدة من الفئة [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource). |
## الحقول
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | يحصل على لون RGB. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | يحصل على لون RGB. |
...
يُنشئ مثيلة جديدة من الفئة [SoCoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/socoresource).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [Color](../../com.aspose.psd/color) | لون RGB |
