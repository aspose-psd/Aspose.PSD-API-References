...
description: "الفئة الأساسية لموارد طبقة التعبئة"
type: docs
weight: 30
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/filllayerresource/
---
...
الفئة الأساسية لموارد طبقة التعبئة
## الحقول
