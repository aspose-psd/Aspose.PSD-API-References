...
description: "مورد lr32."
type: docs
weight: 54
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [Lr32Resource()](#Lr32Resource--) | يُنشئ مثلاً جديدًا من الفئة [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource). |
## الحقول
...
| [getLayers()](#getLayers--) | يسترجع أو يعيّن الطبقات. |
| [getLength()](#getLength--) | يسترجع طول المورد لإصدار رأس PSD للصورة. |
| [getLength(int psdHeaderVersion)](#getLength-int-) | يسترجع طول المورد. |
...
| [getRawData_internalized()](#getRawData-internalized--) | يسترجع أو يعيّن البيانات الخام للمورد. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | يحفظ سجل الطبقة. |
...
| [setLayers(Layer[] value)](#setLayers-com.aspose.psd.fileformats.psd.layers.Layer---) | يسترجع أو يعيّن الطبقات. |
| [setRawData_internalized(byte[] value)](#setRawData-internalized-byte---) | يسترجع أو يعيّن البيانات الخام للمورد. |
...
يُنشئ مثلاً جديدًا من الفئة [Lr32Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lr32resource).
...
يسترجع طول المورد لإصدار رأس PSD للصورة.
...
يسترجع طول المورد. قد يعتمد على إصدار PSD.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| psdHeaderVersion | int | إصدار رأس PSD. |
...
يسترجع أو يعيّن البيانات الخام للمورد.
