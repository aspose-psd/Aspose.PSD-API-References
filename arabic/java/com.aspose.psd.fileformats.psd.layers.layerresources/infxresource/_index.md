...
description: "الفئة InfxResource."
type: docs
weight: 39
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/infxresource/
---
...
الفئة InfxResource. يحتوي هذا المورد على معلومات حول دمج العنصر المقصوص.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [InfxResource(boolean blendInteriorElements)](#InfxResource-boolean-) | يُهيئ نسخة جديدة من الفئة [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource()](#InfxResource--) | يُهيئ نسخة جديدة من الفئة [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
| [InfxResource(byte[] data)](#InfxResource-byte---) | يُهيئ نسخة جديدة من الفئة [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource). |
## الحقول
...
| [getBlendInteriorElements()](#getBlendInteriorElements--) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [blend interior elements]. |
| [getClass()](#getClass--) |  |
...
| [setBlendInteriorElements(boolean value)](#setBlendInteriorElements-boolean-) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [blend interior elements]. |
...
يُهيئ نسخة جديدة من الفئة [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| blendInteriorElements | boolean | إذا تم تعيينه إلى  true  [دمج العناصر الداخلية]. |
...
ينشئ مثيلاً جديدًا للفئة [InfxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/infxresource) . مع قيمة مخصصة أو غير معروفة
...
القيمة:  true  إذا كان [دمج العناصر الداخلية]; وإلا,  false .
