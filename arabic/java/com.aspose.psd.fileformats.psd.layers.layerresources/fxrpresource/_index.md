...
description: "الفئة FxrpResource."
type: docs
weight: 32
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource/
---
...
الفئة FxrpResource. نقطة المرجع للطبقة
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [FxrpResource(double x, double y)](#FxrpResource-double-double-) | ينشئ مثلاً جديداً من الفئة [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource()](#FxrpResource--) | ينشئ مثلاً جديداً من الفئة [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
| [FxrpResource(byte[] data)](#FxrpResource-byte---) | ينشئ مثلاً جديداً من الفئة [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). |
## الحقول
...
| [getX()](#getX--) | يحصل أو يعيّن x لنقطة المرجع |
| [getY()](#getY--) | يحصل أو يعيّن y لنقطة المرجع |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [save(StreamContainer streamContainer, int psdVersion)](#save-com.aspose.psd.StreamContainer-int-) | يحفظ إلى حاوية الدفق المحددة. |
...
| [setX(double value)](#setX-double-) | يحصل أو يعيّن x لنقطة المرجع |
| [setY(double value)](#setY-double-) | يحصل أو يعيّن y لنقطة المرجع |
...
ينشئ مثلاً جديداً من الفئة [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| س | double | الإحداثي x لنقطة المرجع |
| ص | double | الإحداثي y لنقطة المرجع |
...
ينشئ مثلاً جديداً من الفئة [FxrpResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/fxrpresource). مع قيمة مخصصة أو غير معروفة
...
يحصل أو يعيّن x لنقطة المرجع

القيمة: x لنقطة المرجع
...
يحصل أو يعيّن y لنقطة المرجع

القيمة: y لنقطة المرجع
