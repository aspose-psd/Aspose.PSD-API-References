...
description: "المورد VibA."
type: docs
weight: 83
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [VibAResource()](#VibAResource--) | ينشئ مثيلاً جديدًا للفئة [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource) . |
## الحقول
...
| [getSaturation()](#getSaturation--) | يحصل أو يعيّن قيمة التشبع |
| [getSignature()](#getSignature--) | يحصل على توقيع مورد الطبقة. |
| [getVibrance()](#getVibrance--) | يحصل أو يعيّن قيمة الإشراق |
| [hashCode()](#hashCode--) |  |
...
| [setSaturation(int value)](#setSaturation-int-) | يحصل أو يعيّن قيمة التشبع |
| [setVibrance(int value)](#setVibrance-int-) | يحصل أو يعيّن قيمة الإشراق |
...
ينشئ مثيلاً جديدًا للفئة [VibAResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/vibaresource) .
