...
description: "الفئة LyidResource."
type: docs
weight: 59
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LyidResource(int id)](#LyidResource-int-) | يُنشئ مثلاً جديدًا من الفئة [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
| [LyidResource(byte[] bytes)](#LyidResource-byte---) | يُنشئ مثلاً جديدًا من الفئة [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). |
## الحقول
...
| [getValue()](#getValue--) | يحصل على القيمة. |
| [hashCode()](#hashCode--) |  |
...
| [setValue_internalized(int value)](#setValue-internalized-int-) | يحصل على القيمة. |
...
يُنشئ مثلاً جديدًا من الفئة [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| معرّف | int | معرّف الطبقة. |
...
يُنشئ مثلاً جديدًا من الفئة [LyidResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyidresource). مع قيمة مخصصة أو غير معروفة.
