...
description: "الفئة KnkoResource."
type: docs
weight: 41
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource/
---
...
الفئة KnkoResource. يحتوي هذا المورد على معلومات حول دمج العنصر المقصوص.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [KnkoResource(boolean knockout)](#KnkoResource-boolean-) | ينشئ مثيلاً جديداً للفئة [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource()](#KnkoResource--) | ينشئ مثيلاً جديداً للفئة [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
| [KnkoResource(byte[] data)](#KnkoResource-byte---) | ينشئ مثيلاً جديداً للفئة [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). |
## الحقول
...
| [getKnockout()](#getKnockout--) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [blend interior elements]. |
...
| [setKnockout(boolean value)](#setKnockout-boolean-) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان [blend interior elements]. |
...
ينشئ مثيلاً جديداً للفئة [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| قَطْع | boolean | إذا تم تعيينه إلى  true  [دمج العناصر الداخلية]. |
...
ينشئ مثيلاً جديداً للفئة [KnkoResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/knkoresource). بقيمة مخصصة أو غير معروفة
