...
description: "مورد اسم الطبقة"
type: docs
weight: 58
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/luniresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LuniResource()](#LuniResource--) | ينشئ مثيلاً جديداً من الفئة [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource). |
## الحقول
...
| [setData_internalized(byte[] value)](#setData-internalized-byte---) | يحصل أو يضبط البيانات. |
...
ينشئ مثيلاً جديداً من الفئة [LuniResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/luniresource).
