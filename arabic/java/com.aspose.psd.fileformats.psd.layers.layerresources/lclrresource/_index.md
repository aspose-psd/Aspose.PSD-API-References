...
description: "الفئة LclrResource."
type: docs
weight: 46
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource/
---
...
الفئة LclrResource. هذا المورد يحتوي على معلومات حول لون الطبقة في قائمة الطبقات في PS. هو فقط
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [LclrResource()](#LclrResource--) | ينشئ مثيلًا جديدًا من الفئة [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(short color)](#LclrResource-short-) | ينشئ مثيلًا جديدًا من الفئة [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
| [LclrResource(byte[] data)](#LclrResource-byte---) | ينشئ مثيلًا جديدًا من الفئة [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource). |
## الحقول
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | يحصل أو يضبط لون الطبقة. |
...
| [setColor(short value)](#setColor-short-) | يحصل أو يضبط لون الطبقة. |
...
ينشئ مثيلًا جديدًا من الفئة [LclrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lclrresource).
