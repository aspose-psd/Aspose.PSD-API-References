...
description: "الفئة lnsrResource."
type: docs
weight: 51
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LnsrResource(int lnsrResourceType)](#LnsrResource-int-) | ينشئ مثيلاً جديداً من الفئة [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
| [LnsrResource(byte[] bytes)](#LnsrResource-byte---) | ينشئ مثيلاً جديداً من الفئة [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). |
## الحقول
...
| [getValue()](#getValue--) | يحصل على القيمة كـ LnsrResourceType إذا تم وصف التعداد المقابل. |
| [hashCode()](#hashCode--) |  |
...
ينشئ مثيلاً جديداً من الفئة [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| lnsrResourceType | int | نوع الـ LNSR. |
...
ينشئ مثيلاً جديداً من الفئة [LnsrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresource). بقيمة مخصصة أو غير معروفة
...
القيمة: القيمة كـ LnsrResourceType
