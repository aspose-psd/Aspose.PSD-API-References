...
description: "الفئة CustResource."
type: docs
weight: 27
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/custresource/
---
...
الفئة CustResource. يحتوي هذا المورد على معلومات حول دمج العنصر المقصوص.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [CustResource()](#CustResource--) | ينشئ مثيلًا جديدًا من الفئة [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource). |
| [CustResource(byte[] data)](#CustResource-byte---) | ينشئ مثيلًا جديدًا من الفئة [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource). |
## الحقول
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | يحصل أو يعيّن تاريخ إنشاء الطبقة. |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | يحصل أو يعيّن تاريخ إنشاء الطبقة. |
...
ينشئ مثيلًا جديدًا من الفئة [CustResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/custresource).
