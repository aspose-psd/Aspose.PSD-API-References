...
description: "مورد قسم الطبقة."
type: docs
weight: 43
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LayerSectionResource()](#LayerSectionResource--) | ينشئ مثلاً جديداً من الفئة [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
| [LayerSectionResource(int sectionType, int subType)](#LayerSectionResource-int-int-) | ينشئ مثلاً جديداً من الفئة [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource). |
## الحقول
...
| [getSectionType()](#getSectionType--) | يحصل أو يعيّن نوع القسم. |
| [getSignature()](#getSignature--) | يحصل على توقيع مورد الطبقة. |
| [getSubtype()](#getSubtype--) | يحصل أو يعيّن النوع الفرعي. |
| [hashCode()](#hashCode--) |  |
...
| [setSectionType(int value)](#setSectionType-int-) | يحصل أو يعيّن نوع القسم. |
| [setSubtype(int value)](#setSubtype-int-) | يحصل أو يعيّن النوع الفرعي. |
...
ينشئ مثلاً جديداً من الفئة [LayerSectionResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/layersectionresource).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| sectionType | int | نوع القسم. |
| subType | int | النوع الفرعي. |
