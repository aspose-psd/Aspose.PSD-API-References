...
description: "الفئة CmlsResource."
type: docs
weight: 21
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [CmlsResource(byte[] data)](#CmlsResource-byte---) | ينشئ مثيلاً جديدًا من الفئة [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource). |
## الحقول
...
ينشئ مثيلاً جديدًا من الفئة [CmlsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/cmlsresource).
