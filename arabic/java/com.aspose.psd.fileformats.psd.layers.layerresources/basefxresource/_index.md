...
description: "مورد التأثيرات الأساسي"
type: docs
weight: 12
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [BaseFxResource(int resourceKey)](#BaseFxResource-int-) | ينشئ مثلاً جديداً من الفئة [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource). |
## الحقول
...
ينشئ مثلاً جديداً من الفئة [BaseFxResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/basefxresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| resourceKey | int | مفتاح المورد. |
