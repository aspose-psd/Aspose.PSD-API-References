...
description: "الفئة ShmdResource."
type: docs
weight: 74
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource/
---
...
الفئة ShmdResource. إعدادات البيانات الوصفية
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [ShmdResource()](#ShmdResource--) | ينشئ مثيلًا جديدًا من الفئة [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
| [ShmdResource(byte[] data)](#ShmdResource-byte---) | ينشئ مثيلًا جديدًا من الفئة [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource). |
## الحقول
...
| [SubResourceHeaderLength](#SubResourceHeaderLength) | طول رأس المورد الفرعي |
...
| [getLayerCreatedDateTime()](#getLayerCreatedDateTime--) | يحصل أو يعيّن وقت إنشاء الطبقة. |
...
| [getSubResources()](#getSubResources--) | الموارد الفرعية |
| [hashCode()](#hashCode--) |  |
...
| [setLayerCreatedDateTime(Date value)](#setLayerCreatedDateTime-java.util.Date-) | يحصل أو يعيّن وقت إنشاء الطبقة. |
...
| [setSubResources(LayerResource[] value)](#setSubResources-com.aspose.psd.fileformats.psd.layers.LayerResource---) | يحصل على الموارد الفرعية لمورد shmd. |
...
ينشئ مثيلًا جديدًا من الفئة [ShmdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/shmdresource).
...
يحصل أو يعيّن وقت إنشاء الطبقة. إذا لم يتم تحديد وقت إنشاء الطبقة فسيُعيد new DateTime(0).

القيمة: وقت إنشاء الطبقة.
