...
description: "المورد الذي يمثل نسخة فوتوشوب من الطبقة."
type: docs
weight: 60
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
...
المورد الذي يمثل نسخة فوتوشوب من الطبقة.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [LyvrResource()](#LyvrResource--) | ينشئ مثيلًا جديدًا من الفئة [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource). |
## الحقول
...
| [getVersion()](#getVersion--) | يحصل أو يعيّن إصدار photoshop للطبقة. |
| [hashCode()](#hashCode--) |  |
...
| [setVersion(int value)](#setVersion-int-) | يحصل أو يعيّن إصدار photoshop للطبقة. |
...
ينشئ مثيلًا جديدًا من الفئة [LyvrResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/lyvrresource).
...
يحصل أو يعيّن إصدار photoshop للطبقة.
