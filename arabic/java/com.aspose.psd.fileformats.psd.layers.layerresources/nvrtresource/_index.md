...
description: "الفئة NvrtResource."
type: docs
weight: 63
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource/
---
...
الفئة NvrtResource. مورد طبقة تعديل الانعكاس.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [NvrtResource()](#NvrtResource--) | يقوم بتهيئة نسخة جديدة من الفئة [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
| [NvrtResource(byte[] data)](#NvrtResource-byte---) | يقوم بتهيئة نسخة جديدة من الفئة [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource). |
## الحقول
...
يقوم بتهيئة نسخة جديدة من الفئة [NvrtResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/nvrtresource).
