...
description: "أنواع موارد Lnsr المحتملة المكتشفة"
type: docs
weight: 52
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/lnsrresourcetype/
---
...
| حقل | الوصف |
| --- | --- |
| [Bgnd](#Bgnd) | خلفية Bgnd للطبقة الخلفية |
| [Cont](#Cont) | ال cont للطبقة المملوءة على سبيل المثال |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Layr](#Layr) | ال layr للطبقة الصورة العادية |
| [Rend](#Rend) | ال rend للنص |
| [Unknown](#Unknown) | المجهول مخصص للحالة عندما لم نصف التعداد |
## الطرق
...
ال cont للطبقة المملوءة على سبيل المثال
...
المجهول مخصص للحالة عندما لم نصف التعداد
