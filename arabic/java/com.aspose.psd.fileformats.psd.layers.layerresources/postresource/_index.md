...
description: "الفئة PostResource."
type: docs
weight: 71
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/postresource/
---
...
الفئة PostResource. إعدادات تمويه الطبقة.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [PostResource()](#PostResource--) | ينشئ مثيلاً جديدًا للفئة [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource). |
## الحقول
...
ينشئ مثيلاً جديدًا للفئة [PostResource](../../com.aspose.psd.fileformats.psd.layers.layerresources/postresource).
