...
description: "الفئة الأساسية لموارد طبقة الضبط"
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources/adjustmentlayerresource/
---
...
الفئة الأساسية لموارد طبقة الضبط
## الحقول
