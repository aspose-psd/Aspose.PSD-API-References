...
description: "يوفر الحقول التي تمثل نقاط المرجع في StreamContainer للبحث."
type: docs
weight: 95
url: /ar/java/com.aspose.psd/seekorigin/
---
...
يوفر الحقول التي تمثل نقاط المرجع في StreamContainer للبحث.
## الحقول

| حقل | الوصف |
| --- | --- |
| [Begin](#Begin) | يحدد بداية التدفق. |
| [Current](#Current) | يحدد الموقع الحالي داخل التدفق. |
...
يحدد الموقع الحالي داخل التدفق.
