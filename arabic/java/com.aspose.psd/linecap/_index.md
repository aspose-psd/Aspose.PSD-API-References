...
type: docs
weight: 66
url: /ar/java/com.aspose.psd/linecap/
---
...
يحدد أنماط القمة المتاحة التي يمكن لكائن  Pen  إنهاء الخط بها.
## الحقول

| حقل | الوصف |
| --- | --- |
| [AnchorMask](#AnchorMask) | يحدد قمة خط مخصصة. |
| [ArrowAnchor](#ArrowAnchor) | يحدد قمة ربط على شكل سهم. |
| [Custom](#Custom) | يحدد قناعًا يُستخدم للتحقق مما إذا كانت قمة الخط قمة ربط. |
| [DiamondAnchor](#DiamondAnchor) | يحدد قمة ربط ماسية. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Flat](#Flat) | يحدد قمة خط مسطحة. |
| [NoAnchor](#NoAnchor) | يحدد عدم وجود ربط. |
| [Round](#Round) | يحدد قمة خط دائرية. |
| [RoundAnchor](#RoundAnchor) | يحدد قمة ربط دائرية. |
| [Square](#Square) | يحدد قمة خط مربعة. |
| [SquareAnchor](#SquareAnchor) | يحدد قمة ربط خط مربعة. |
...
يحدد قناعًا يُستخدم للتحقق مما إذا كانت قمة الخط قمة ربط.
