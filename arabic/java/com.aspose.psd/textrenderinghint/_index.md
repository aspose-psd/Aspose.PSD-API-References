...
type: docs
weight: 109
url: /ar/java/com.aspose.psd/textrenderinghint/
---
...
| حقل | الوصف |
| --- | --- |
| [AntiAlias](#AntiAlias) | يتم رسم كل حرف باستخدام صورة البكسل للرمز المضاد للتنعيم دون توجيه. |
| [AntiAliasGridFit](#AntiAliasGridFit) | يتم رسم كل حرف باستخدام صورة البكسل للرمز المضاد للتنعيم مع توجيه. |
| [ClearTypeGridFit](#ClearTypeGridFit) | يتم رسم كل حرف باستخدام صورة البكسل للرمز ClearType مع توجيه. |
...
يتم رسم كل حرف باستخدام صورة البكسل للرمز المضاد للتنعيم دون توجيه. جودة أفضل بفضل التنعيم. قد تكون اختلافات عرض الساق ملحوظة لأن التوجيه مُعطل.
...
يتم رسم كل حرف باستخدام صورة البكسل للرمز المضاد للتنعيم مع توجيه. جودة أعلى بكثير بفضل التنعيم، لكن بتكلفة أداء أعلى.
...
يتم رسم كل حرف باستخدام صورة البت ClearType الخاصة به مع التلميح. أعلى إعداد جودة. يُستخدم للاستفادة من ميزات خط ClearType.
...
يتم رسم كل حرف باستخدام صورة البت الخاصة به. لا يُستخدم التلميح.
...
يتم رسم كل حرف باستخدام صورة البت الخاصة به. يُستخدم التلميح لتحسين مظهر الحرف على الساقين والانحناءات.
...
يتم رسم كل حرف باستخدام صورة البت الخاصة به، مع تلميح العرض الافتراضي للنظام. سيتم رسم النص باستخدام أي إعدادات تنعيم الخط التي اختارها المستخدم للنظام.
