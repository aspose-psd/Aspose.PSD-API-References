...
description: "يحدد أنواع الصور والألوان التي سيتأثر بها إعدادات تعديل اللون وتدرج الرمادي لكائن ImageAttributes."
type: docs
weight: 26
url: /ar/java/com.aspose.psd/colormatrixflag/
---
...
يحدد أنواع الصور والألوان التي سيتأثر بها إعدادات تعديل اللون وتدرج الرمادي لكائن ImageAttributes.
## الحقول

| حقل | الوصف |
| --- | --- |
| [AltGrays](#AltGrays) | يتم تعديل الظلال الرمادية فقط. |
...
يتم تعديل جميع الألوان، لكن درجات الرمادي لا يتم تعديلها. درجة الرمادي هي أي لون له نفس القيمة لمكونات الأحمر والأخضر والأزرق.
