...
description: "تحدد تعداد com.aspose.psd.InterpolationMode الخوارزمية المستخدمة عند تحجيم أو تدوير الصور."
type: docs
weight: 63
url: /ar/java/com.aspose.psd/interpolationmode/
---
...
تحدد تعداد  com.aspose.psd.InterpolationMode  الخوارزمية المستخدمة عند تحجيم أو تدوير الصور.
## الحقول
...
| [HighQualityBicubic](#HighQualityBicubic) | يحدد استيفاء ثنائي المكعب عالي الجودة. |
| [HighQualityBilinear](#HighQualityBilinear) | يحدد استيفاء ثنائي الخطية عالي الجودة. |
| [Invalid](#Invalid) | وضع استيفاء غير صالح. |
...
يحدد استيفاء ثنائي المكعب. لا يتم إجراء ترشيح مسبق. هذا الوضع غير مناسب لتصغير صورة إلى أقل من 25٪ من حجمها الأصلي.
...
يحدد استيفاء ثنائي الخطية. لا يتم إجراء ترشيح مسبق. هذا الوضع غير مناسب لتصغير صورة إلى أقل من 50٪ من حجمها الأصلي.
...
يحدد استيفاء ثنائي المكعب عالي الجودة. يتم إجراء ترشيح مسبق لضمان تصغير عالي الجودة. هذا الوضع ينتج أعلى جودة للصور المحوّلة.
...
يحدد استيفاء ثنائي الخطية عالي الجودة. يتم إجراء ترشيح مسبق لضمان تصغير عالي الجودة.
