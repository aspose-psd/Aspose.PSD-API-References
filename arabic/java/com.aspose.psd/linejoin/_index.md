...
description: "يحدد كيفية ربط مقاطع الخط أو المنحنى المتتالية في مسار فرعي للشكل الموجود داخل كائن GraphicsPath."
type: docs
weight: 67
url: /ar/java/com.aspose.psd/linejoin/
---
...
يحدد كيفية ربط مقاطع الخط أو المنحنى المتتالية في شكل (مسار فرعي) موجود داخل كائن  GraphicsPath .
## الحقول
...
| [Miter](#Miter) | يحدد وصلة مِترية. |
| [MiterClipped](#MiterClipped) | يحدد وصلة مِترية. |
...
يحدد وصلة مائلة. ينتج ذلك زاوية قطرية.
...
يحدد وصلة مِترية. ينتج ذلك زاوية حادة أو زاوية مقصوصة، اعتمادًا على ما إذا كان طول المِتر يتجاوز حد المِتر.
...
يحدد وصلة مِترية. ينتج ذلك زاوية حادة أو زاوية مائلة، اعتمادًا على ما إذا كان طول المِتر يتجاوز حد المِتر.
...
يحدد وصلة دائرية. ينتج ذلك قوسًا دائريًا ناعمًا بين الخطوط.
