...
type: docs
weight: 37
url: /ar/java/com.aspose.psd/datarecoverymode/
---
...
| [MaximalRecover](#MaximalRecover) | وضع الاستعادة الأقصى يستعيد جميع البيانات حتى إذا كان تنسيق الملف يحتوي على بنية تالفة وقد تؤدي المعالجة اللاحقة إلى تأثيرات غير مقصودة. |
...
وضع الاستعادة الأقصى يستعيد جميع البيانات حتى إذا كان تنسيق الملف يحتوي على بنية تالفة وقد تؤدي المعالجة اللاحقة إلى تأثيرات غير مقصودة.
