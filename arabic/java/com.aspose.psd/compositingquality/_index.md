...
description: "يحدد مستوى الجودة للاستخدام أثناء التركيب."
type: docs
weight: 32
url: /ar/java/com.aspose.psd/compositingquality/
---
...
يحدد مستوى الجودة للاستخدام أثناء التركيب.
## الحقول

| حقل | الوصف |
| --- | --- |
| [AssumeLinear](#AssumeLinear) | افترض قيمًا خطية. |
| [Default](#Default) | الجودة الافتراضية. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [GammaCorrected](#GammaCorrected) | يتم استخدام تصحيح جاما. |
| [HighQuality](#HighQuality) | تجميع عالي الجودة، منخفض السرعة. |
...
تجميع عالي الجودة، منخفض السرعة.
