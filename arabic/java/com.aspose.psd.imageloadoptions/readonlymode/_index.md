...
description: "يحدد أوضاع القراءة فقط المتاحة عند تحميل صورة PSD."
type: docs
weight: 13
url: /ar/java/com.aspose.psd.imageloadoptions/readonlymode/
---
...
| حقل | الوصف |
| --- | --- |
| [Default](#Default) | الوضع الافتراضي. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MetadataEdit](#MetadataEdit) | يسمح بتحرير بيانات تعريف الصورة مع الحفاظ على محتوى الصورة للقراءة فقط. |
| [None](#None) | لم يتم تطبيق أي قيود للقراءة فقط. |
## الطرق
...
الوضع الافتراضي. الصورة للقراءة فقط بالكامل ولا يمكن تعديلها.
...
يسمح بتحرير بيانات تعريف الصورة مع الحفاظ على محتوى الصورة للقراءة فقط.
...
لم يتم تطبيق أي قيود للقراءة فقط. يمكن تعديل الصورة بالكامل.
