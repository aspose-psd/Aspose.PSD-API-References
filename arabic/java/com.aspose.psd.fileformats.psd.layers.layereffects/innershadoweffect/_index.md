...
description: "تأثير طبقة الظل الداخلي"
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layereffects/innershadoweffect/
---
...
| [getSpread()](#getSpread--) | يحصل أو يضبط الانتشار (الاختناق) كنسبة مئوية. |
...
| [setSpread(int value)](#setSpread-int-) | يحصل أو يضبط الانتشار (الاختناق) كنسبة مئوية. |
