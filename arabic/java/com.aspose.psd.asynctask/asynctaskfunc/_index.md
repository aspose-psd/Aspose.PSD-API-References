...
description: "المندوب للعملية الطويلة للمهمة غير المتزامنة مع نتيجة من نوع عام."
type: docs
weight: 12
url: /ar/java/com.aspose.psd.asynctask/asynctaskfunc/
---
...
المندوب للعملية الطويلة للمهمة غير المتزامنة مع نتيجة من نوع عام.
## المنشئات
...
| [hashCode()](#hashCode--) |  |
| [invoke(IAsyncTaskState taskState)](#invoke-com.aspose.psd.asynctask.IAsyncTaskState-) | المندوب للعملية الطويلة للمهمة غير المتزامنة مع نتيجة من نوع عام. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| taskState | [IAsyncTaskState](../../com.aspose.psd.asynctask/iasynctaskstate) | حالة المهمة غير المتزامنة. |
