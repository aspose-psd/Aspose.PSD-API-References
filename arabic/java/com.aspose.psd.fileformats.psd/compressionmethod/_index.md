...
type: docs
weight: 11
url: /ar/java/com.aspose.psd.fileformats.psd/compressionmethod/
---
...
| [RLE](#RLE) | يتم ضغط بيانات الصورة باستخدام RLE بحيث يبدأ بعدد البايتات لجميع خطوط المسح (الصفوف \* القنوات)، مع تخزين كل عدد كقيمة من بايتين. |
| [Raw](#Raw) | بدون ضغط. |
| [ZipWithPrediction](#ZipWithPrediction) | ZIP مع التنبؤ. |
| [ZipWithoutPrediction](#ZipWithoutPrediction) | ZIP بدون تنبؤ. |
## الطرق
...
يتم ضغط بيانات الصورة باستخدام RLE بحيث يبدأ بعدد البايتات لجميع خطوط المسح (الصفوف \* القنوات)، مع تخزين كل عدد كقيمة من بايتين. يتبع ذلك بيانات مضغوطة بـ RLE، حيث يتم ضغط كل خط مسح بشكل منفصل. ضغط RLE هو نفس خوارزمية الضغط المستخدمة في روتين Macintosh ROM PackBits ومعيار TIFF.
...
بدون ضغط. يتم تخزين بيانات الصورة كبايتات خام بترتيب RGBA الطبقي. هذا يعني أنه يتم كتابة جميع بيانات R أولاً، ثم جميع بيانات G، ثم جميع بيانات B وأخيرًا جميع بيانات A.
