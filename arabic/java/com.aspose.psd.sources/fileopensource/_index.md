...
type: docs
weight: 11
url: /ar/java/com.aspose.psd.sources/fileopensource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [FileOpenSource(String filePath)](#FileOpenSource-java.lang.String-) | يُنشئ مثيلاً جديدًا لفئة  FileOpenSource . |
## الطرق
...
يُنشئ مثيلاً جديدًا لفئة  FileOpenSource .
...
القيمة:  true  إذا كان الملف سيكون مؤقتًا؛ وإلا،  false .
