...
type: docs
weight: 18
url: /ar/java/com.aspose.psd.imageoptions/pdfoptions/
---
...
| المنشئ | الوصف |
| --- | --- |
| [PdfOptions()](#PdfOptions--) | ينشئ مثيلاً جديدًا من الفئة [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions). |
## الطرق
...
| [getClass()](#getClass--) |  |
| [getCorePdfOptions_internalized()](#getCorePdfOptions-internalized--) | يحصل على خيارات PDF الأساسية. |
...
| [getPdfCoreOptions()](#getPdfCoreOptions--) | خيارات PDF الأساسية |
...
| [setPdfCoreOptions(PdfCoreOptions value)](#setPdfCoreOptions-com.aspose.psd.fileformats.pdf.PdfCoreOptions-) | خيارات PDF الأساسية |
| [setPdfDocumentInfo(PdfDocumentInfo value)](#setPdfDocumentInfo-com.aspose.psd.fileformats.pdf.PdfDocumentInfo-) | يحصل أو يضبط البيانات الوصفية للمستند. |
...
ينشئ مثيلاً جديدًا من الفئة [PdfOptions](../../com.aspose.psd.imageoptions/pdfoptions).
