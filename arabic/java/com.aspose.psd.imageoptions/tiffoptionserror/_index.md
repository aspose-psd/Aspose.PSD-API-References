...
type: docs
weight: 26
url: /ar/java/com.aspose.psd.imageoptions/tiffoptionserror/
---
...
| حقل | الوصف |
| --- | --- |
| [Baseline6OptionsMismatch](#Baseline6OptionsMismatch) | المعلمات المحددة لخيارات TIFF لا تتوافق مع معيار TIFF Baseline 6.0 |
...
| [PhotometricCompressionMismatch](#PhotometricCompressionMismatch) | ضغط البيانات لا يتطابق مع الإعدادات الفوتومترية. |
| [PhotometricSppMismatch](#PhotometricSppMismatch) | الإعداد الفوتومتري لا يتطابق مع عدد العينات لكل بكسل. |
## الطرق
...
المعلمات المحددة لخيارات TIFF لا تتوافق مع معيار TIFF Baseline 6.0
...
ضغط البيانات لا يتطابق مع الإعدادات الفوتومترية.
...
الإعداد الفوتومتري لا يتطابق مع عدد العينات لكل بكسل.
