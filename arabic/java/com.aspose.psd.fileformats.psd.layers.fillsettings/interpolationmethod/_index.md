...
description: "قيم fourCC المعبأة لطريقة استيفاء التدرج في Photoshop."
type: docs
weight: 18
url: /ar/java/com.aspose.psd.fileformats.psd.layers.fillsettings/interpolationmethod/
---
...
قيم fourCC المعبأة لطريقة استيفاء تدرج الفوتوشوب. مفتاح الوصف: \"gradientsInterpolationMethod\"
## الحقول

| حقل | الوصف |
| --- | --- |
| [Classic](#Classic) | 'Gcls' \\u2014 كلاسيكي (الإعداد الافتراضي القديم عندما يكون المفتاح غائبًا). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Linear](#Linear) | 'Lnr ' \\u2014 خطي (لاحظ وجود مساحة زائدة). |
| [Perceptual](#Perceptual) | 'Perc' \\u2014 إدراكي. |
| [Smooth](#Smooth) | 'Smoo' \\u2014 ناعم. |
| [Stripes](#Stripes) | 'GIMs' \\u2014 خطوط. |
## الطرق
...
'Gcls' \\u2014 كلاسيكي (الإعداد الافتراضي القديم عندما يكون المفتاح غائبًا).
