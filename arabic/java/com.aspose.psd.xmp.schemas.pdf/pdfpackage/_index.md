...
type: docs
weight: 10
url: /ar/java/com.aspose.psd.xmp.schemas.pdf/pdfpackage/
---
...
| المنشئ | الوصف |
| --- | --- |
| [PdfPackage()](#PdfPackage--) | يُنشئ مثيلًا جديدًا من الفئة PdfPackage. |
## الطرق
...
| [setTrapped(boolean isTrapped)](#setTrapped-boolean-) | يضبط قيمة trapped. |
...
يُنشئ مثيلًا جديدًا من الفئة PdfPackage.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| version | java.lang.String | إصدار Pdf، على سبيل المثال: 1.0، 1.3 إلخ. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| isTrapped | boolean | إذا تم تعيينه إلى true فإن المستند تم تعقبه. |
