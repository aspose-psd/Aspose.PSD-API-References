...
description: "تعداد وحدة القياس الفيزيائية لـ resoultionInfo"
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.resources.resolutionenums/physicalunit/
---
...
تعداد وحدة القياس الفيزيائية لـ resoultionInfo
## الحقول

| حقل | الوصف |
| --- | --- |
| [Centimeters](#Centimeters) | السنتيمترات |
| [Columns](#Columns) | الأعمدة |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Inches](#Inches) | البوصات |
| [Picas](#Picas) | وحدة البيكاس |
