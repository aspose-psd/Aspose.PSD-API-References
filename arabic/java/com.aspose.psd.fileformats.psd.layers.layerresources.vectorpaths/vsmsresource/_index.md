...
description: "الفئة VsmsResource."
type: docs
weight: 29
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource/
---
...
الفئة VsmsResource. هذا المورد يحتوي على معلومات حول قناع طبقة المتجه.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [VsmsResource(byte[] data)](#VsmsResource-byte---) | ينشئ مثلاً جديداً من الفئة [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
| [VsmsResource()](#VsmsResource--) | ينشئ مثلاً جديداً من الفئة [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource). |
## الحقول
...
ينشئ مثلاً جديداً من الفئة [VsmsResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vsmsresource).
