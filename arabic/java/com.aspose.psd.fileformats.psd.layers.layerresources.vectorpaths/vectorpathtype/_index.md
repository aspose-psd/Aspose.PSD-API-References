...
description: "نوع المسار المتجه وفقًا لمواصفات تنسيق PSD"
type: docs
weight: 22
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.vectorpaths/vectorpathtype/
---
...
| [ClosedSubpathBezierKnotLinked](#ClosedSubpathBezierKnotLinked) | العقدة المرتبطة للbezier المغلق |
| [ClosedSubpathBezierKnotUnlinked](#ClosedSubpathBezierKnotUnlinked) | العقدة غير المرتبطة للbezier المغلق |
| [ClosedSubpathLengthRecord](#ClosedSubpathLengthRecord) | سجل طول المنحنى المغلق |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InitialFillRuleRecord](#InitialFillRuleRecord) | سجل قاعدة التعبئة الأولية |
| [OpenSubpathBezierKnotLinked](#OpenSubpathBezierKnotLinked) | العقدة المرتبطة للbezier المفتوح |
| [OpenSubpathBezierKnotUnlinked](#OpenSubpathBezierKnotUnlinked) | العقدة غير المرتبطة للbezier المفتوح |
| [OpenSubpathLengthRecord](#OpenSubpathLengthRecord) | سجل طول المنحنى المفتوح |
...
العقدة المرتبطة للbezier المغلق
...
العقدة غير المرتبطة للbezier المغلق
...
العقدة المرتبطة للbezier المفتوح
...
العقدة غير المرتبطة للbezier المفتوح
