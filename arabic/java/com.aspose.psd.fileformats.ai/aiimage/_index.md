...
description: "صورة Adobe Illustrator AI"
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.ai/aiimage/
---
...
| المنشئ | الوصف |
| --- | --- |
| [AiImage()](#AiImage--) | ينشئ مثلاً جديداً من الفئة [AiImage](../../com.aspose.psd.fileformats.ai/aiimage). |
## الحقول
...
| طريقة | الوصف |
| --- | --- |
| [addLayer(AiLayerSection layer)](#addLayer-com.aspose.psd.fileformats.ai.AiLayerSection-) | يضيف قسم طبقة AI. |
| [cacheData()](#cacheData--) | يقوم بتخزين البيانات مؤقتًا ويضمن عدم تحميل بيانات إضافية من الكائن الأساسي P:Aspose.PSD.DataStreamSupporter.DataStreamContainer. |
...
| [getActivePageIndex()](#getActivePageIndex--) | يحصل أو يعيّن فهرس الصفحة النشطة. |
...
| [getDataSection()](#getDataSection--) | يحصل على قسم البيانات. |
...
| [getFinalizeSection()](#getFinalizeSection--) | يحصل على قسم الإنهاء. |
...
| [getPageCount()](#getPageCount--) | عدد الصفحات. |
...
| [getSetupSection()](#getSetupSection--) | يحصل على قسم الإعداد. |
...
| [getVersion()](#getVersion--) | يحصل على نسخة تنسيق Adobe Illustrator. |
| [getWidth()](#getWidth--) | يحصل على عرض الصورة. |
| [getXmpData()](#getXmpData--) | يحصل على بيانات التعريف XMP. |
...
| [setActivePageIndex(int value)](#setActivePageIndex-int-) | يحصل أو يعيّن فهرس الصفحة النشطة. |
...
| [setRenderedImage_internalized(RasterImage value)](#setRenderedImage-internalized-com.aspose.psd.RasterImage-) | يحصل على الصورة المرسومة. |
...
ينشئ مثلاً جديداً من الفئة [AiImage](../../com.aspose.psd.fileformats.ai/aiimage).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| layer | [AiLayerSection](../../com.aspose.psd.fileformats.ai/ailayersection) | قسم طبقة AI. |
...
يقوم بتخزين البيانات مؤقتًا ويضمن عدم تحميل بيانات إضافية من الكائن الأساسي P:Aspose.PSD.DataStreamSupporter.DataStreamContainer.
...
**Returns:**
com.aspose.foundation.rendering.ApsPage - نسخة ApsPage.
...
القيمة: هذه الخاصية صالحة فقط لتنسيق PDF لصورة AI. إذا لم تكن الصورة بتنسيق PDF أو لا توجد صفحات، ستكون قيمة الخاصية -1. تُظهر هذه الخاصية أي صفحة من صورة AI ستكون الأساس للعرض.
...
عدد الصفحات. بالنسبة لصور تنسيق AI القديمة تكون دائمًا مساوية للصفر.
...
يحصل على نسخة تنسيق Adobe Illustrator.
...
يحصل على الصورة المرسومة.

القيمة: الصورة المُعالجة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| ventureLicense | java.lang.Object | كائن ترخيص Venture. |
