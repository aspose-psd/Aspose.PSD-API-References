...
description: "يمثل مساحة اسم إدارة وسائط XMP."
type: docs
weight: 10
url: /ar/java/com.aspose.psd.xmp.schemas.xmpmm/xmpmediamanagementpackage/
---
...
| المنشئ | الوصف |
| --- | --- |
| [XmpMediaManagementPackage()](#XmpMediaManagementPackage--) | تهيئ نسخة جديدة من الفئة  XmpMediaManagementPackage . |
## الطرق
...
| [setDerivedFrom(ResourceRef resourceRef)](#setDerivedFrom-com.aspose.psd.xmp.types.complex.resourceref.ResourceRef-) | يضبط المستمد من. |
...
تهيئ نسخة جديدة من الفئة  XmpMediaManagementPackage .
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| resourceRef | [ResourceRef](../../com.aspose.psd.xmp.types.complex.resourceref/resourceref) | مرجع المورد. |
