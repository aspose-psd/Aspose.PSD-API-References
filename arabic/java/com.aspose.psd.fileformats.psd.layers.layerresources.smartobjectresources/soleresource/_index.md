...
description: "يعرّف فئة SoLeResource التي تحتوي على معلومات حول طبقة كائن ذكي في ملف PSD."
type: docs
weight: 16
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource/
---
...
يعرّف فئة SoLeResource التي تحتوي على معلومات حول طبقة كائن ذكي في ملف PSD. يُستخدم لدعم طبقات الكائن الذكي مع روابط ملفات خارجية في صور Adobe\\ufffd Photoshop\\ufffd.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [SoLeResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLeResource-java.util.UUID-boolean-boolean-) | يُنشئ مثيلاً جديدًا للفئة [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource). |
| [SoLeResource()](#SoLeResource--) | يُنشئ مثيلاً جديدًا للفئة [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource). |
## الحقول
...
| [TypeToolKey](#TypeToolKey) | مفتاح معلومات أداة النوع: 'SoLE'. |
...
يُنشئ مثيلاً جديدًا للفئة [SoLeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soleresource).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| uniqueId | java.util.UUID | المعرّف الفريد لبيانات الطبقة الموضوعة [PlLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/plldresource). |
