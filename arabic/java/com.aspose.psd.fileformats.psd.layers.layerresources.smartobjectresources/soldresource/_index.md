...
description: "يعرّف فئة SoLdResource التي تحتوي على معلومات حول طبقة كائن ذكي في ملف PSD."
type: docs
weight: 15
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource/
---
...
يعرّف فئة SoLdResource التي تحتوي على معلومات حول طبقة الكائن الذكي في ملف PSD. تُستخدم لدعم طبقات الكائن الذكي في صور Adobe® Photoshop®.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [SoLdResource(UUID uniqueId, boolean isCustom, boolean hasCompInfo)](#SoLdResource-java.util.UUID-boolean-boolean-) | ينشئ مثيلًا جديدًا للفئة [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
| [SoLdResource()](#SoLdResource--) | ينشئ مثيلًا جديدًا للفئة [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
## الحقول
...
| [TypeToolKey](#TypeToolKey) | مفتاح معلومات أداة النوع: 'SoLd'. |
...
ينشئ مثيلًا جديدًا للفئة [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). من الضروري تعيين خاصية Items أو استدعاء InitializeItems() للحصول على مثيل جاهز. تم تصميم هذا المُنشئ للاستخدام بواسطة [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) وفي اختبارات الوحدة. استخدم [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) لإنشاء فئات SoLdResource.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| uniqueId | java.util.UUID | المعرف الفريد لبيانات طبقة الكائن الذكي [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). |
...
ينشئ مثيلًا جديدًا للفئة [SoLdResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/soldresource). تم تصميم هذا المُنشئ الافتراضي للاستخدام بواسطة SoLdResourceLoader. استخدم [SmartResourceCreator](../../com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/smartresourcecreator) لإنشاء فئات SoLdResource.
