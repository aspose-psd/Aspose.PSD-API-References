...
description: "يعرّف فئة PlacedResource التي تحتوي على معلومات عامة حول طبقة موضوعة أو طبقة كائن ذكي في ملف PSD."
type: docs
weight: 12
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.smartobjectresources/placedresource/
---
...
يحدد فئة PlacedResource التي تحتوي على معلومات مشتركة حول طبقة موضوعة أو طبقة كائن ذكي في ملف PSD. يُستخدم لدعم طبقات الكائنات الذكية في صور Adobe\ufffd Photoshop\ufffd.
## الحقول
...
| [getWarpItems_internalized()](#getWarpItems-internalized--) | يحصل أو يضبط عناصر الالتواء. |
