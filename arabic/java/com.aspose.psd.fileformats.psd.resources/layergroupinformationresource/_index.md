...
description: "مورد معلومات مجموعة الطبقة"
type: docs
weight: 25
url: /ar/java/com.aspose.psd.fileformats.psd.resources/layergroupinformationresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LayerGroupInformationResource()](#LayerGroupInformationResource--) | ينشئ مثيلًا جديدًا للفئة [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## الحقول
...
| [getGroups()](#getGroups--) | يحصل أو يضبط المجموعات. |
...
| [setGroups(short[] value)](#setGroups-short---) | يحصل أو يضبط المجموعات. |
...
| [toString()](#toString--) |  |
| [updateLayerGroupIds_internalized()](#updateLayerGroupIds-internalized--) | يقوم بتحديث LinkGroupId في الطبقات من خاصية Groups. |
| [updateResourceGroupIds_internalized()](#updateResourceGroupIds-internalized--) | يقوم بتحديث القيم في خاصية Groups من الطبقات. |
...
يقوم بتحديث LinkGroupId في الطبقات من خاصية Groups.
...
يقوم بتحديث القيم في خاصية Groups من الطبقات.
