...
description: "مورد نقل اللون"
type: docs
weight: 15
url: /ar/java/com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [ColorTransferFunctionsResource()](#ColorTransferFunctionsResource--) | يُنشئ مثلاً جديدًا من الفئة [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource). |
## الحقول
...
| [getClass()](#getClass--) |  |
| [getColorTransferData()](#getColorTransferData--) | احصل أو اضبط بيانات نقل اللون. |
...
| [setColorTransferData(byte[] value)](#setColorTransferData-byte---) | احصل أو اضبط بيانات نقل اللون. |
...
يُنشئ مثلاً جديدًا من الفئة [ColorTransferFunctionsResource](../../com.aspose.psd.fileformats.psd.resources/colortransferfunctionsresource).
...
احصل أو اضبط بيانات نقل اللون.

القيمة: بيانات نقل اللون.
