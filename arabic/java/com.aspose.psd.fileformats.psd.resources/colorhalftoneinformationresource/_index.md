...
description: "مورد نصف التظليل"
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [ColorHalftoneInformationResource()](#ColorHalftoneInformationResource--) | تهيئة نسخة جديدة من الفئة [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) . |
## الحقول
...
| [getHalftoneData()](#getHalftoneData--) | الحصول أو تعيين بيانات النصف نغمة. |
...
| [setHalftoneData(byte[] value)](#setHalftoneData-byte---) | الحصول أو تعيين بيانات النصف نغمة. |
...
تهيئة نسخة جديدة من الفئة [ColorHalftoneInformationResource](../../com.aspose.psd.fileformats.psd.resources/colorhalftoneinformationresource) .
...
الحصول أو تعيين بيانات النصف نغمة.

القيمة: بيانات النصف نغمة.
