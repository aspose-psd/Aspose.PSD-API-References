...
description: "مورد CaptionDigest"
type: docs
weight: 13
url: /ar/java/com.aspose.psd.fileformats.psd.resources/captiondigestresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [CaptionDigestResource()](#CaptionDigestResource--) | ينشئ مثيلًا جديدًا للفئة [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## الحقول
...
| [getDigest()](#getDigest--) | يحصل أو يضبط الخلاصة. |
...
| [setDigest(byte[] value)](#setDigest-byte---) | يحصل أو يضبط الخلاصة. |
