...
description: "مورد الزاوية العالمية"
type: docs
weight: 19
url: /ar/java/com.aspose.psd.fileformats.psd.resources/globalangleresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [GlobalAngleResource()](#GlobalAngleResource--) | ينشئ مثلاً جديداً من الفئة [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource). |
## الحقول
...
| [setGlobalAngle(int value)](#setGlobalAngle-int-) | يحصل أو يعيّن الزاوية العامة. |
...
ينشئ مثلاً جديداً من الفئة [GlobalAngleResource](../../com.aspose.psd.fileformats.psd.resources/globalangleresource).
