...
description: "مورد ملحق قسم البيانات المتحركة."
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.resources/animateddatasectionresource/
---
...
مورد ملحق قسم البيانات المتحركة.
## الحقول
...
| [getAnimatedDataSection()](#getAnimatedDataSection--) | يحصل أو يعيّن بنية قسم البيانات المتحركة. |
| [getClass()](#getClass--) |  |
| [getDataSize()](#getDataSize--) | يحصل على حجم بيانات المورد بالبايت. |
| [getID()](#getID--) | يحصل أو يعيّن المعرف الفريد للمورد. |
| [getKeyName()](#getKeyName--) | اسم مفتاح المورد. |
...
| [setAnimatedDataSection_internalized(AnimatedDataSectionStructure value)](#setAnimatedDataSection-internalized-com.aspose.psd.fileformats.psd.layers.layerresources.AnimatedDataSectionStructure-) | يحصل أو يعيّن بنية قسم البيانات المتحركة. |
| [setID(short value)](#setID-short-) | يحصل أو يعيّن المعرف الفريد للمورد. |
| [setKeyName_internalized(String value)](#setKeyName-internalized-java.lang.String-) | اسم مفتاح المورد. |
...
| [setRoll_internalized(RollStructure value)](#setRoll-internalized-com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure-) | يحصل أو يعيّن بنية اللف. |
| [setSignature_internalized(int signature)](#setSignature-internalized-int-) |  |
| [setState_internalized(int value)](#setState-internalized-int-) | يحصل على أو يعيّن حالة كتلة المورد. |
| [setUnknownLeftBytes_internalized(byte[] value)](#setUnknownLeftBytes-internalized-byte---) | البايتات غير المعروفة من المورد الأصلي. |
| [toString()](#toString--) |  |
...
يحصل أو يعيّن بنية قسم البيانات المتحركة.
...
يحصل أو يعيّن بنية اللف.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | com.aspose.internal.fileformats.psd.layers.layerresources.RollStructure |  |
...
البايتات غير المعروفة من المورد الأصلي.
