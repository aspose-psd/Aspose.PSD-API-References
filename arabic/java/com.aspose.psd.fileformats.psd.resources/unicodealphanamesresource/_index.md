...
description: "مورد أسماء ألفا Unicode"
type: docs
weight: 38
url: /ar/java/com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource/
---
...
مورد أسماء ألفا Unicode
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [UnicodeAlphaNamesResource()](#UnicodeAlphaNamesResource--) | يُنشئ مثيلاً جديدًا من الفئة [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource). |
## الحقول
...
| [getAlphaNames()](#getAlphaNames--) | يحصل أو يضبط أسماء ألفا. |
| [getClass()](#getClass--) |  |
...
| [setAlphaNames(String value)](#setAlphaNames-java.lang.String-) | يحصل أو يضبط أسماء ألفا. |
...
يُنشئ مثيلاً جديدًا من الفئة [UnicodeAlphaNamesResource](../../com.aspose.psd.fileformats.psd.resources/unicodealphanamesresource).
