...
description: "المورد الذي يحتوي على معلومات الحدود لإعدادات طباعة الصورة."
type: docs
weight: 12
url: /ar/java/com.aspose.psd.fileformats.psd.resources/borderinformationresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [BorderInformationResource()](#BorderInformationResource--) | ينشئ مثيلاً جديداً من الفئة [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource). |
## الحقول
...
| [getUnit()](#getUnit--) | يحصل أو يعيّن وحدات الحدود. |
| [getWidth()](#getWidth--) | يحصل أو يعيّن عرض الحدود. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setUnit(int value)](#setUnit-int-) | يحصل أو يعيّن وحدات الحدود. |
| [setWidth(double value)](#setWidth-double-) | يحصل أو يعيّن عرض الحدود. |
| [toString()](#toString--) |  |
...
ينشئ مثيلاً جديداً من الفئة [BorderInformationResource](../../com.aspose.psd.fileformats.psd.resources/borderinformationresource).
