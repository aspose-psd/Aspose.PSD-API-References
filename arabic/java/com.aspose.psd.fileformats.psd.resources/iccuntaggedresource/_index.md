...
description: "مورد Icc غير موسوم"
type: docs
weight: 24
url: /ar/java/com.aspose.psd.fileformats.psd.resources/iccuntaggedresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [IccUntaggedResource()](#IccUntaggedResource--) | ينشئ مثيلًا جديدًا من الفئة [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource). |
## الحقول
...
| [getProfile()](#getProfile--) | يحصل أو يضبط الملف. |
...
| [setProfile(byte value)](#setProfile-byte-) | يحصل أو يضبط الملف. |
...
ينشئ مثيلًا جديدًا من الفئة [IccUntaggedResource](../../com.aspose.psd.fileformats.psd.resources/iccuntaggedresource).
