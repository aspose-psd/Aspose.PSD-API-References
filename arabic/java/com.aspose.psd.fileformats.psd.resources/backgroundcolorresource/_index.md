...
type: docs
weight: 11
url: /ar/java/com.aspose.psd.fileformats.psd.resources/backgroundcolorresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [BackgroundColorResource()](#BackgroundColorResource--) | ينشئ مثلاً جديداً من الفئة [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource). |
## الحقول
...
| [getClass()](#getClass--) |  |
| [getColor()](#getColor--) | يحصل أو يعيّن لون الخلفية. |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | يحصل أو يعيّن لون الخلفية. |
| [setColorSpace(int value)](#setColorSpace-int-) | يحصل أو يعيّن مساحة ألوان. |
...
ينشئ مثلاً جديداً من الفئة [BackgroundColorResource](../../com.aspose.psd.fileformats.psd.resources/backgroundcolorresource).
...
يحصل أو يعيّن مساحة ألوان.

القيمة: مساحة ألوان الخلفية.
