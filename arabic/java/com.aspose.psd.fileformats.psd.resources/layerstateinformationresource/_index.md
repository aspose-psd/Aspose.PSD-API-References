...
description: "مورد معلومات حالة الطبقة"
type: docs
weight: 28
url: /ar/java/com.aspose.psd.fileformats.psd.resources/layerstateinformationresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LayerStateInformationResource()](#LayerStateInformationResource--) | يُنشئ مثلاً جديدًا من الفئة [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource). |
## الحقول
...
| [getLayerIndex()](#getLayerIndex--) | احصل أو اضبط فهرس الطبقة. |
...
| [setLayerIndex(short value)](#setLayerIndex-short-) | احصل أو اضبط فهرس الطبقة. |
...
يُنشئ مثلاً جديدًا من الفئة [LayerStateInformationResource](../../com.aspose.psd.fileformats.psd.resources/layerstateinformationresource).
