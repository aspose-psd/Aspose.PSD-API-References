...
description: "مورد نسبة أبعاد البكسل"
type: docs
weight: 29
url: /ar/java/com.aspose.psd.fileformats.psd.resources/pixelaspectratioresource/
---
...
مورد نسبة أبعاد البكسل
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [PixelAspectRatioResource()](#PixelAspectRatioResource--) | ينشئ مثيلًا جديدًا للفئة [ResolutionInfoResource](../../com.aspose.psd.fileformats.psd.resources/resolutioninforesource). |
## الحقول
...
| [getAspectRatio()](#getAspectRatio--) | يحصل أو يعيّن نسبة العرض إلى الارتفاع. |
| [getClass()](#getClass--) |  |
...
| [setAspectRatio(double value)](#setAspectRatio-double-) | يحصل أو يعيّن نسبة العرض إلى الارتفاع. |
...
يحصل أو يعيّن نسبة العرض إلى الارتفاع.

القيمة: نسبة العرض إلى الارتفاع.
