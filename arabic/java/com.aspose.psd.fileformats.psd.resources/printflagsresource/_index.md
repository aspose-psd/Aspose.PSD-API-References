...
description: "مورد علامات الطباعة"
type: docs
weight: 30
url: /ar/java/com.aspose.psd.fileformats.psd.resources/printflagsresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [PrintFlagsResource()](#PrintFlagsResource--) | ينشئ مثيلاً جديدًا للفئة [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource). |
## الحقول
...
| [getBleedScale()](#getBleedScale--) | يحصل أو يضبط مقياس النزف. |
| [getBleedWidth()](#getBleedWidth--) | يحصل أو يضبط عرض النزف. |
| [getCenterCropMark()](#getCenterCropMark--) | يحصل أو يضبط علامة القص المركزية. |
| [getClass()](#getClass--) |  |
...
| [setBleedScale(short value)](#setBleedScale-short-) | يحصل أو يضبط مقياس النزف. |
| [setBleedWidth(int value)](#setBleedWidth-int-) | يحصل أو يضبط عرض النزف. |
| [setCenterCropMark(byte value)](#setCenterCropMark-byte-) | يحصل أو يضبط علامة القص المركزية. |
...
ينشئ مثيلاً جديدًا للفئة [PrintFlagsResource](../../com.aspose.psd.fileformats.psd.resources/printflagsresource).
