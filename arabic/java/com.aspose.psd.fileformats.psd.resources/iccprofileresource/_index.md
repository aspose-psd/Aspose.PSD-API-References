...
description: "يمثل مورد ملف تعريف ICC."
type: docs
weight: 23
url: /ar/java/com.aspose.psd.fileformats.psd.resources/iccprofileresource/
---
...
| المنشئ | الوصف |
| --- | --- |
| [IccProfileResource()](#IccProfileResource--) | ينشئ مثيلاً جديدًا للفئة [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource). |
## الحقول
...
| [getIccProfile()](#getIccProfile--) | يحصل أو يضبط ملف تعريف ICC. |
...
| [setIccProfile(byte[] value)](#setIccProfile-byte---) | يحصل أو يضبط ملف تعريف ICC. |
...
ينشئ مثيلاً جديدًا للفئة [IccProfileResource](../../com.aspose.psd.fileformats.psd.resources/iccprofileresource).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | com.aspose.ms.System.IO.MemoryStream |  |
