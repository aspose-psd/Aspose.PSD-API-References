...
description: "مورد العلامة المائية"
type: docs
weight: 42
url: /ar/java/com.aspose.psd.fileformats.psd.resources/watermarkresource/
---
...
مورد العلامة المائية
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [WatermarkResource()](#WatermarkResource--) | ينشئ مثلاً جديداً من الفئة [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource). |
## الحقول
...
| [hashCode()](#hashCode--) |  |
| [isWatermark()](#isWatermark--) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا المثيل علامة مائية. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setWatermark(boolean value)](#setWatermark-boolean-) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا المثيل علامة مائية. |
| [toString()](#toString--) |  |
...
ينشئ مثلاً جديداً من الفئة [WatermarkResource](../../com.aspose.psd.fileformats.psd.resources/watermarkresource).
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا المثيل علامة مائية.

القيمة:  true  إذا كان هذا المثيل علامة مائية؛ وإلا،  false .
