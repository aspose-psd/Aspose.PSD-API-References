...
description: "مورد الارتفاع العالمي"
type: docs
weight: 18
url: /ar/java/com.aspose.psd.fileformats.psd.resources/globalaltituderesource/
---
...
مورد الارتفاع العالمي
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [GlobalAltitudeResource()](#GlobalAltitudeResource--) | ينشئ مثيلًا جديدًا من الفئة [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource). |
## الحقول
...
| [getAltitude()](#getAltitude--) | يحصل أو يضبط الارتفاع. |
| [getClass()](#getClass--) |  |
...
| [setAltitude(int value)](#setAltitude-int-) | يحصل أو يضبط الارتفاع. |
...
ينشئ مثيلًا جديدًا من الفئة [GlobalAltitudeResource](../../com.aspose.psd.fileformats.psd.resources/globalaltituderesource).
