...
type: docs
weight: 12
url: /ar/java/com.aspose.psd.fileformats.tiff.enums/tiffbyteorder/
---
...
| حقل | الوصف |
| --- | --- |
| [BigEndian](#BigEndian) | ترتيب البايتات big endian (Motorola). |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [LittleEndian](#LittleEndian) | ترتيب البايتات little endian (Intel). |
## الطرق
...
ترتيب البايتات big endian (Motorola).
...
ترتيب البايتات little endian (Intel).
