...
description: "الحدّية المستخدمة على البيانات."
type: docs
weight: 26
url: /ar/java/com.aspose.psd.fileformats.tiff.enums/tiffthresholds/
---
...
الحدّية المستخدمة على البيانات.
## الحقول
...
| [NoDithering](#NoDithering) | لم يتم تنفيذ أي تدرج. |
## الطرق
