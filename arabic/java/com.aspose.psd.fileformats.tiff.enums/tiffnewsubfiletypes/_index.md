...
description: "تعداد نوع الملف الفرعي الجديد لتنسيق tiff."
type: docs
weight: 18
url: /ar/java/com.aspose.psd.fileformats.tiff.enums/tiffnewsubfiletypes/
---
...
تعداد نوع الملف الفرعي الجديد لتنسيق tiff.
## الحقول
...
| [FileTypeReducedImage](#FileTypeReducedImage) | نوع ملف الصورة المصغرة. |
## الطرق
