...
description: "علامات قناع الطبقة"
type: docs
weight: 24
url: /ar/java/com.aspose.psd.fileformats.psd.layers/layermaskflags/
---
...
| حقل | الوصف |
| --- | --- |
| [Disabled](#Disabled) | قناع الطبقة معطل. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [InvertedWhenBlending](#InvertedWhenBlending) | عكس قناع الطبقة عند الدمج. |
| [None](#None) | لم يتم تعريف أي أعلام. |
| [RelativeToLayer](#RelativeToLayer) | الموقع نسبي للطبقة. |
| [UserMaskFromRenderingOtherData](#UserMaskFromRenderingOtherData) | يشير إلى أن قناع المستخدم جاء فعلياً من تجسيد بيانات أخرى. |
| [UserOrVectorMasksHaveParameters](#UserOrVectorMasksHaveParameters) | يشير إلى أن أقنعة المستخدم و/أو المتجهات لديها معلمات مطبقة عليها. |
## الطرق
...
يشير إلى أن قناع المستخدم جاء فعلياً من تجسيد بيانات أخرى.
...
يشير إلى أن أقنعة المستخدم و/أو المتجهات لديها معلمات مطبقة عليها.
