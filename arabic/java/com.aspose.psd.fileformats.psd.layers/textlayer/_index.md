...
description: "فئة طبقة النص"
type: docs
weight: 30
url: /ar/java/com.aspose.psd.fileformats.psd.layers/textlayer/
---
...
| [correctFontSize_internalized(float newSize, double yyTransform)](#correctFontSize-internalized-float-double-) | يصحّح حجم الخط |
...
| [createInstance_internalized()](#createInstance-internalized--) | ينشئ نسخة جديدة من الفئة [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
| [createInstance_internalized(PsdHeader header, IColorPalette palette)](#createInstance-internalized-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-) | ينشئ نسخة جديدة من الفئة [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getEngineData_internalized()](#getEngineData-internalized--) | يحصل على بيانات المحرك. |
...
| [getFonts()](#getFonts--) | يحصل على مجموعة الخطوط للطبقة النصية. |
...
| [getInnerText()](#getInnerText--) | يحصل على نص الطبقة |
...
| [getResourceProcessor_internalized()](#getResourceProcessor-internalized--) | يحصل أو يعيّن معالج الموارد. |
...
| [getStringFormat_internalized()](#getStringFormat-internalized--) | يحصل على تنسيق السلسلة. |
| [getSyncRoot_internalized()](#getSyncRoot-internalized--) | يحصل على جذر المزامنة. |
| [getText()](#getText--) | يحصل على النص. |
| [getTextBoundBox()](#getTextBoundBox--) | يحصل أو يعيّن صندوق حدود النص. |
| [getTextColor()](#getTextColor--) | يحصل على لون النص. |
| [getTextData()](#getTextData--) | يحصل على أجزاء النصوص. |
| [getTop()](#getTop--) | يحصل أو يعيّن موضع الطبقة العليا. |
| [getTransformMatrix()](#getTransformMatrix--) | يحصل أو يضبط مصفوفة التحويل |
| [getTransparentColor()](#getTransparentColor--) | يحصل على لون شفافية الصورة. |
| [getTyShResourceIfExists_internalized()](#getTyShResourceIfExists-internalized--) | ابحث واحصل على مورد [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) من [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer). |
...
| [getWasChanged_internalized()](#getWasChanged-internalized--) | يحصل أو يضبط قيمة تشير إلى ما إذا كان [was changed]. |
...
| [isFontAvailable_internalized(Font font, GetPrivateFontCache getPrivateFontCache)](#isFontAvailable-internalized-com.aspose.psd.Font-com.aspose.internal.GetPrivateFontCache-) | يحدد ما إذا كان [is font available] [the specified font]. |
...
| [preprocessFont_internalized(Font font, float newSize, double yyTransform)](#preprocessFont-internalized-com.aspose.psd.Font-float-double-) | يعالج الخط مسبقًا. |
...
| [replaceFontWithDefault_internalized(Font font, String defaultFontName)](#replaceFontWithDefault-internalized-com.aspose.psd.Font-java.lang.String-) | يستبدل الخط بالخط الافتراضي. |
...
| [setInnerText(String value)](#setInnerText-java.lang.String-) | يحصل على نص الطبقة |
...
| [setResourceProcessor_internalized(TypeToolResourceProcessor value)](#setResourceProcessor-internalized-com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor-) | يحصل أو يعيّن معالج الموارد. |
...
| [setTextBoundBox(RectangleF value)](#setTextBoundBox-com.aspose.psd.RectangleF-) | يحصل أو يعيّن صندوق حدود النص. |
| [setTop(int value)](#setTop-int-) | يحصل أو يعيّن موضع الطبقة العليا. |
| [setTransformMatrix(double[] value)](#setTransformMatrix-double---) | يحصل أو يضبط مصفوفة التحويل |
...
| [setWasChanged_internalized(boolean value)](#setWasChanged-internalized-boolean-) | يحصل أو يضبط قيمة تشير إلى ما إذا كان [was changed]. |
...
| [updateBounds_internalized(RectangleF absoluteTextBounds, RectangleF inBoxTextBounds)](#updateBounds-internalized-com.aspose.psd.RectangleF-com.aspose.psd.RectangleF-) | يقوم بتحديث حدود [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) في الموارد. |
| [updateText(String text)](#updateText-java.lang.String-) | يقوم بتحديث النص. |
| [updateText(String text, Color color)](#updateText-java.lang.String-com.aspose.psd.Color-) | يقوم بتحديث النص. |
| [updateText(String text, Point leftTopCoordinate)](#updateText-java.lang.String-com.aspose.psd.Point-) | يقوم بتحديث النص. |
| [updateText(String text, Point leftTopCoordinate, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-com.aspose.psd.Color-) | يقوم بتحديث النص. |
| [updateText(String text, Point leftTopCoordinate, float fontSize)](#updateText-java.lang.String-com.aspose.psd.Point-float-) | يقوم بتحديث النص. |
| [updateText(String text, Point leftTopCoordinate, float fontSize, Color color)](#updateText-java.lang.String-com.aspose.psd.Point-float-com.aspose.psd.Color-) | يقوم بتحديث النص. |
| [updateText(String text, float fontSize)](#updateText-java.lang.String-float-) | يقوم بتحديث النص. |
| [updateText(String text, float fontSize, Color color)](#updateText-java.lang.String-float-com.aspose.psd.Color-) | يقوم بتحديث النص. |
| [wait()](#wait--) |  |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| newSize | float | حجم الخط الجديد |
| yyTransform | double | 'yy' معلمة مصفوفة التحويل |
...
ينشئ نسخة جديدة من الفئة [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
يحصل على بيانات المحرك.

القيمة: بيانات المحرك.
...
يحصل على مجموعة الخطوط للطبقة النصية.

**Returns:**
com.aspose.psd.fileformats.psd.layers.text.TextFontInfo[] - مجموعة الخطوط لطبقة النص.
...
يحصل على تنسيق السلسلة.

القيمة: تنسيق السلسلة.
...
يحصل أو يعيّن صندوق حدود النص.

القيمة: صندوق حدود النص.
...
ابحث واحصل على مورد [TypeToolInfo6Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources/typetoolinfo6resource) من [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer).
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان [was changed].

القيمة:  true  إذا تم التغيير؛ وإلا،  false .
...
يحدد ما إذا كان [is font available] [the specified font].
...
**Returns:**
boolean - صحيح إذا كان الخط متاح
...
يستبدل الخط بالخط الافتراضي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| font | [Font](../../com.aspose.psd/font) | الخط. |
| defaultFontName | java.lang.String | الاسم الافتراضي للخط. |
...
| newWidth | int | العرض الجديد. |
| newHeight | int | الارتفاع الجديد. |
| resizeType | int | نوع تحويل التحجيم  ResizeType |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | com.aspose.internal.fileformats.psd.layers.TypeToolResourceProcessor |  |
...
يقوم بتحديث حدود [TextLayer](../../com.aspose.psd.fileformats.psd.layers/textlayer) في الموارد.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| absoluteTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | الموضع المطلق وحجم النص. |
| inBoxTextBounds | [RectangleF](../../com.aspose.psd/rectanglef) | الموضع وحجم النص بالنسبة إلى textBox. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| text | java.lang.String | قيمة النص. |
...
| --- | --- | --- |
| text | java.lang.String | قيمة النص. |
| color | [Color](../../com.aspose.psd/color) | قيمة اللون. |
...
| --- | --- | --- |
| text | java.lang.String | قيمة النص. |
| leftTopCoordinate | [Point](../../com.aspose.psd/point) | الإحداثي العلوي الأيسر. |
