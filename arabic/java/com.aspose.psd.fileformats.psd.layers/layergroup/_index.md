...
description: "فئة طبقة المجموعة"
type: docs
weight: 19
url: /ar/java/com.aspose.psd.fileformats.psd.layers/layergroup/
---
...
| [getHeight()](#getHeight--) | يحصل على ارتفاع مجموعة الطبقات. |
...
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | يحصل على حدود الاتحاد لجميع الطبقات في LayerGroup. |
...
| [getWidth()](#getWidth--) | يحصل على عرض مجموعة الطبقات. |
...
يحصل على ارتفاع مجموعة الطبقات.
...
يحصل على حدود الاتحاد لجميع الطبقات في LayerGroup.
