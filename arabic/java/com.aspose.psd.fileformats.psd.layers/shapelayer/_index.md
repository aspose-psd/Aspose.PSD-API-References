...
description: "طبقة الشكل."
type: docs
weight: 29
url: /ar/java/com.aspose.psd.fileformats.psd.layers/shapelayer/
---
...
طبقة الشكل. تغلف منطق العمل مع طبقة الشكل والموارد المرتبطة بها.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [ShapeLayer()](#ShapeLayer--) | يُنشئ مثلاً جديداً من الفئة [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
## الحقول
...
| [createInstance()](#createInstance--) | ينشئ مثلاً جديداً من الفئة [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). |
...
| [getFill()](#getFill--) | إعدادات التعبئة للمنطقة الداخلية للأشكال في طبقة الشكل. |
...
| [getPath()](#getPath--) | يحصل على مجموعة المسارات الموجودة في طبقة الشكل. |
...
| [getStroke()](#getStroke--) | يحصل أو يعيّن إعدادات الخط للأشكال. |
...
| [setFill(IFillSettings value)](#setFill-com.aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings-) | إعدادات التعبئة للمنطقة الداخلية للأشكال في طبقة الشكل. |
...
| [setStroke(IStrokeSettings value)](#setStroke-com.aspose.psd.fileformats.psd.layers.layerresources.strokeresources.IStrokeSettings-) | يحصل أو يعيّن إعدادات الخط للأشكال. |
...
| [toString()](#toString--) |  |
| [update()](#update--) | يحدّث الموارد من خصائص طبقة الشكل. |
...
يُنشئ مثلاً جديداً من الفئة [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer). جميع الموارد تُنشأ بحالتها الافتراضية.
...
ينشئ مثلاً جديداً من الفئة [ShapeLayer](../../com.aspose.psd.fileformats.psd.layers/shapelayer).
...
إعدادات التعبئة للمنطقة الداخلية للأشكال في طبقة الشكل.
...
يحصل أو يعيّن إعدادات الخط للأشكال.
...
**Returns:**
boolean - قيمة منطقية تشير إلى أن الطبقة صالحة.
...
يحدّث الموارد من خصائص طبقة الشكل.
