...
description: "فئة طبقة لوحة الرسم."
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.layers/artboardlayer/
---
...
| [addLayer(Layer layer)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-) | يضيف الطبقة إلى مجموعة الطبقات. |
| [addLayer(Layer layer, int index)](#addLayer-com.aspose.psd.fileformats.psd.layers.Layer-int-) | يضيف الطبقة إلى مجموعة الطبقات. |
| [addLayerGroup(String groupName, int index)](#addLayerGroup-java.lang.String-int-) | يضيف مجموعة الطبقات. |
...
| [buildGroupLayerMarkers_internalized(String groupName, PsdHeader psdHeader, IColorPalette colorPalette, int layerNestingLevel)](#buildGroupLayerMarkers-internalized-java.lang.String-com.aspose.internal.fileformats.psd.sections.PsdHeader-com.aspose.psd.IColorPalette-int-) | يبني علامات بداية ونهاية المجموعة. |
...
| [getBackgroundColor()](#getBackgroundColor--) | يحصل أو يضبط لون خلفية لوحة الرسم. |
...
| [getLayers()](#getLayers--) | يحصل على الطبقات في مجموعة الطبقات |
| [getLayersBounds_internalized()](#getLayersBounds-internalized--) | يحصل على الحدود الحقيقية لـ ArtboardLayer. |
| [getLeft()](#getLeft--) |    |
...
| [getSectionResource_internalized()](#getSectionResource-internalized--) | يحصل على  LayerSectionResource  من الموارد. |
...
| [hasBackgroundColor()](#hasBackgroundColor--) | يحصل أو يضبط قيمة تشير إلى ما إذا كان [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) يحتوي على لون الخلفية. |
...
| [isOpen()](#isOpen--) | يحصل أو يضبط ما إذا كان المجلد مفتوحًا؛ إذا تم تعيينه إلى  true  فإن المجموعة ستكون في حالة مفتوحة عند بدء التشغيل، وإلا ستكون في حالة مصغرة. |
...
| [setBackgroundColor(Color value)](#setBackgroundColor-com.aspose.psd.Color-) | يحصل أو يضبط لون خلفية لوحة الرسم. |
...
| [setOpen(boolean value)](#setOpen-boolean-) | يحصل أو يضبط ما إذا كان المجلد مفتوحًا؛ إذا تم تعيينه إلى  true  فإن المجموعة ستكون في حالة مفتوحة عند بدء التشغيل، وإلا ستكون في حالة مصغرة. |
...
| --- | --- | --- |
| layer | [Layer](../../com.aspose.psd.fileformats.psd.layers/layer) | الطبقة. |
| الفهرس | int | الفهرس الذي سيتم إدراج الطبقة عنده. القيم غير الصالحة تعني نهاية قائمة الطبقات. |
...
يبني علامات بداية ونهاية المجموعة.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| groupName | java.lang.String | اسم المجموعة. |
| psdHeader | com.aspose.internal.fileformats.psd.sections.PsdHeader | رأس الـ psd. |
| colorPalette | [IColorPalette](../../com.aspose.psd/icolorpalette) | لوحة الألوان. |
| layerNestingLevel | int |  |

**Returns:**
com.aspose.psd.fileformats.psd.layers.Layer[] - يُرجع مصفوفة من كائنين LayerGroup، حيث أن الأول [0] هو علامة بداية المجموعة والثاني [1] هو علامة نهاية المجموعة.
### cacheData() {#cacheData--}
```
...
يحصل أو يضبط لون خلفية لوحة الرسم.
...
يحصل على الطبقات في مجموعة الطبقات
...
يحصل على الحدود الحقيقية لـ ArtboardLayer.
...
يحصل على  LayerSectionResource  من الموارد.
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان [ArtboardLayer](../../com.aspose.psd.fileformats.psd.layers/artboardlayer) يحتوي على لون الخلفية.
...
يحصل أو يضبط ما إذا كان المجلد مفتوحًا؛ إذا تم تعيينه إلى  true  فإن المجموعة ستكون في حالة مفتوحة عند بدء التشغيل، وإلا ستكون في حالة مصغرة.
