...
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
...
طبقة تعبئة. تعبئة لونية، تعبئة تدرجية أو تعبئة بنمط تختلف حسب  FillSettings ([getFillSettings](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#getFillSettings)/[setFillSettings(IFillSettings)](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer\#setFillSettings-IFillSettings-))
## الحقول
...
| [createInstance(int fillType)](#createInstance-int-) | بناء نسخة جديدة من الفئة [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) حسب نوع التعبئة. |
...
| [getFillImageProcessor_internalized(IPixelsSaver imageToProcess, Rectangle bounds)](#getFillImageProcessor-internalized-com.aspose.internal.IPixelsSaver-com.aspose.psd.Rectangle-) | يحصل على معالج العرض لـ [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer). |
...
| [toString()](#toString--) |  |
| [update()](#update--) | يقوم بتحديث بيانات بكسلات طبقة التعبئة وفقًا لإعدادات [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) الفعلية. |
...
بناء نسخة جديدة من الفئة [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer) حسب نوع التعبئة.
...
يحصل على معالج العرض لـ [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| imageToProcess | com.aspose.internal.IPixelsSaver | الصورة للعرض عليها. |
| bounds | [Rectangle](../../com.aspose.psd/rectangle) | الحدود للمعالجة. |

**Returns:**
com.aspose.internal.IPartialProcessor - إرجاع معالج العرض لـ [FillLayer](../../com.aspose.psd.fileformats.psd.layers.filllayers/filllayer).
...
يقوم بتحديث بيانات بكسلات طبقة التعبئة وفقًا لإعدادات [IFillSettings](../../com.aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings) الفعلية.
