...
type: docs
weight: 13
url: /ar/java/com.aspose.psd.brushes/linearmulticolorgradientbrush/
---
...
| المنشئ | الوصف |
| --- | --- |
| [LinearMulticolorGradientBrush()](#LinearMulticolorGradientBrush--) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  بالمعلمات الافتراضية. |
| [LinearMulticolorGradientBrush(Point point1, Point point2)](#LinearMulticolorGradientBrush-com.aspose.psd.Point-com.aspose.psd.Point-) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  بالنقاط المحددة. |
| [LinearMulticolorGradientBrush(PointF point1, PointF point2)](#LinearMulticolorGradientBrush-com.aspose.psd.PointF-com.aspose.psd.PointF-) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  بالنقاط المحددة. |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.psd.Rectangle-float-) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  استناداً إلى مستطيل وزاوية توجيه. |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.psd.RectangleF-float-) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  استناداً إلى مستطيل وزاوية توجيه. |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.psd.Rectangle-float-boolean-) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  استناداً إلى مستطيل وزاوية توجيه. |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.psd.RectangleF-float-boolean-) | ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  استناداً إلى مستطيل وزاوية توجيه. |
## الطرق
...
ينشئ نسخة جديدة من فئة LinearMulticolorGradientBrush بالمعلمات الافتراضية. اللون الابتدائي هو الأسود، واللون النهائي هو الأبيض، والزاوية 45 درجة، والمستطيل يقع في (0,0) بحجم (1,1).
...
ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  بالنقاط المحددة.
...
ينشئ مثيلاً جديداً من الفئة  LinearMulticolorGradientBrush  استناداً إلى مستطيل وزاوية توجيه.
...
| rect | [Rectangle](../../com.aspose.psd/rectangle) | هيكل  Aspose.Imaging.RectangleF  يحدد حدود التدرج الخطي. |
| زاوية | float | الزاوية، مقاسة بالدرجات في اتجاه عقارب الساعة من محور x، لخط توجيه التدرج. |
| isAngleScalable | boolean | إذا تم تعيينه إلى  true  يتم تغيير الزاوية أثناء التحويلات باستخدام  LinearMulticolorGradientBrush . |
