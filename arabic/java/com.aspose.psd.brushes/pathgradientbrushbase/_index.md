...
type: docs
weight: 15
url: /ar/java/com.aspose.psd.brushes/pathgradientbrushbase/
---
...
يمثل Brush مع وظيفة تدرج مسار أساسي.

لاحظ أنه عند إنشاء فئة PathGradientBrushBase يجب تهيئتها بحد أدنى نقطتين. المسار الداخلي الذي يتم إنشاؤه سيكون دائمًا شكلًا مغلقًا، حيث تربط النقطة الأخيرة النقطة الأولى. يتم ملء هذا الشكل بـ PathGradientBrushBase. تُصدر تنفيذية GDI+ استثناء OutOfMemoryError عند تمرير مصفوفات فارغة أو مجموعة نقاط ذات إحداثيات متطابقة. تُصدر فئة PathGradientBrushBase استثناءً عندما تحتوي مصفوفة النقاط على أقل من نقطتين، حيث يتم إلقاء ArgumentException بدلاً من OutOfMemoryError عندما تكون مصفوفة النقاط غير مقبولة. يتم حساب نقطة المركز كمتوسط كتلة للنقاط الممررة بشكل افتراضي. يمكن للمستخدم تغيير هذه النقطة لاحقًا. مقياس التركيز هو نقطة فارغة (0.0, 0.0) بشكل افتراضي.
## الطرق
