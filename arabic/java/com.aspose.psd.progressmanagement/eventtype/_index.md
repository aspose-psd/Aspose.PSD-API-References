...
description: "هذا التعداد يصف أنواع أحداث التقدم المحتملة التي يمكن أن تحدث أثناء عمليات معالجة الصورة."
type: docs
weight: 11
url: /ar/java/com.aspose.psd.progressmanagement/eventtype/
---
...
هذا التعداد يصف أنواع أحداث التقدم المحتملة التي يمكن أن تحدث أثناء عمليات معالجة الصورة.
## الحقول
