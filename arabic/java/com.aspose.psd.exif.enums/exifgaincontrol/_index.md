...
description: "قوائم تعيين التحكم في الكسب لـ exif."
type: docs
weight: 18
url: /ar/java/com.aspose.psd.exif.enums/exifgaincontrol/
---
...
قوائم تعيين التحكم في الكسب لـ exif.
## الحقول

| حقل | الوصف |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HighGainDown](#HighGainDown) | ارتفاع الكسب إلى الأسفل. |
| [HighGainUp](#HighGainUp) | ارتفاع الكسب إلى الأعلى. |
| [LowGainDown](#LowGainDown) | انخفاض الكسب إلى الأسفل. |
| [LowGainUp](#LowGainUp) | انخفاض الكسب إلى الأعلى. |
