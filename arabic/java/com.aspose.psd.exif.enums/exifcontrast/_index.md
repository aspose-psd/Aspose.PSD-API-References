...
description: "enums exif العادي الناعم الصلب."
type: docs
weight: 11
url: /ar/java/com.aspose.psd.exif.enums/exifcontrast/
---
...
enums exif العادي الناعم الصلب.
## الحقول

| حقل | الوصف |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [High](#High) | تباين عالي. |
| [Low](#Low) | تباين منخفض. |
| [Normal](#Normal) | تباين عادي. |
## الطرق
