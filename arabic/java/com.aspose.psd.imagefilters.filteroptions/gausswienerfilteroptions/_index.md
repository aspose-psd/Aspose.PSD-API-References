...
description: "خيارات مرشح غاوس وينر لإزالة الضبابية غاوس"
type: docs
weight: 15
url: /ar/java/com.aspose.psd.imagefilters.filteroptions/gausswienerfilteroptions/
---
...
خيارات مرشح غاوس وينر لإزالة الضبابية غاوس
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [GaussWienerFilterOptions(int radius, double smooth)](#GaussWienerFilterOptions-int-double-) | ينشئ مثيلاً جديداً من الفئة GaussWienerFilterOptions. |
| [GaussWienerFilterOptions()](#GaussWienerFilterOptions--) | ينشئ مثيلاً جديداً من الفئة GaussWienerFilterOptions. |
## الطرق
...
| [getRadius()](#getRadius--) | يحصل أو يضبط نصف القطر. |
...
| [setRadius(int value)](#setRadius-int-) | يحصل أو يضبط نصف القطر. |
...
ينشئ مثيلاً جديداً من الفئة GaussWienerFilterOptions.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| نصف القطر | int | نصف القطر. |
...
ينشئ مثيلاً جديداً من الفئة GaussWienerFilterOptions. بإعدادات افتراضية.
