...
description: "تحقيق طبقة تعديل Vibrance"
type: docs
weight: 30
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/vibrancelayer/
---
...
| [getVibrance()](#getVibrance--) | يحصل أو يعيّن الحيوية. |
...
| [setVibrance(int value)](#setVibrance-int-) | يحصل أو يعيّن الحيوية. |
...
**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - طبقة تعديل
