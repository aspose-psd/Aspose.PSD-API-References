...
description: "فئة طبقة تعديل الانعكاس."
type: docs
weight: 21
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | يعالج طبقة تعديل الانعكاس. |
| [processInvert_internalized(int[] pixels)](#processInvert-internalized-int---) | طبق تصحيحات الانعكاس على مصفوفة ARGB الصحيحة المحددة. |
...
طبق تصحيحات الانعكاس على مصفوفة ARGB الصحيحة المحددة.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| بكسلات | int[] | مصفوفة ARGB الصحيحة. |
