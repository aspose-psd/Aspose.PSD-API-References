...
description: "طبقة بوستريزي."
type: docs
weight: 25
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
...
طبقة Posterize. تتعامل مع عرض Posterize باستخدام البيانات من PostResource.
## الحقول
...
| [getLevels()](#getLevels--) | مستويات طبقة Posterize. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | يعالج طبقة Posterize. |
...
| [setLevels(short value)](#setLevels-short-) | مستويات طبقة Posterize. |
