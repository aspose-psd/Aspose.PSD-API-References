...
description: "طبقة تعديل مرشح الصورة."
type: docs
weight: 24
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
...
| [getColor()](#getColor--) | يحصل أو يعيّن اللون RGB للمرشح. |
...
| [getDensity()](#getDensity--) | يحصل أو يعيّن كثافة المرشح |
...
| [setColor(Color value)](#setColor-com.aspose.psd.Color-) | يحصل أو يعيّن اللون RGB للمرشح. |
...
| [setDensity(int value)](#setDensity-int-) | يحصل أو يعيّن كثافة المرشح |
...
يحصل أو يعيّن اللون RGB للمرشح.
