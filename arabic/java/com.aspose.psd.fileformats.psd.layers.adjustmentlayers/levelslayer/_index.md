...
description: "طبقة تعديل المستويات"
type: docs
weight: 22
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/levelslayer/
---
...
| [getChannel(int index)](#getChannel-int-) | يحصل على القناة. |
...
| [getMasterChannel()](#getMasterChannel--) | يحصل على القناة الرئيسية. |
