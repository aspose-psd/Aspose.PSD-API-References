...
description: "طبقة تعديل خالط القنوات RGB."
type: docs
weight: 26
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
...
| [getBlueChannel()](#getBlueChannel--) | يحصل على القناة الزرقاء. |
...
| [getGreenChannel()](#getGreenChannel--) | يحصل على القناة الخضراء. |
...
| [getRedChannel()](#getRedChannel--) | يحصل على القناة الحمراء. |
...
يحصل على فهرس القناة بواسطة. يُعيد RgbMixerChannel
...
يحصل على القناة الخضراء.

القيمة: القناة الخضراء.
