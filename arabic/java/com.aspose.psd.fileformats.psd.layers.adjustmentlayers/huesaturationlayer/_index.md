...
description: "طبقة تعديل HueSaturation."
type: docs
weight: 20
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
...
| [getColorize()](#getColorize--) | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) ملونًا. |
...
| [getHue()](#getHue--) | يحصل أو يضبط الصبغة. |
...
| [getLightness()](#getLightness--) | يحصل أو يضبط الإضاءة. |
...
| [getRange(int index)](#getRange-int-) | يحصل على النطاق. |
...
| [setColorize(boolean value)](#setColorize-boolean-) | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) ملونًا. |
...
| [setHue(short value)](#setHue-short-) | يحصل أو يضبط الصبغة. |
...
| [setLightness(short value)](#setLightness-short-) | يحصل أو يضبط الإضاءة. |
...
| [setSaturation(short value)](#setSaturation-short-) | يحصل أو يضبط التشبع. |
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [HueSaturationLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer) ملونًا.
