...
description: "فئة طبقة تعديل الأسود والأبيض."
type: docs
weight: 11
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
...
| [getTintColor()](#getTintColor--) | يحصل أو يعيّن قيمة لون الصبغ. |
| [getTintColorBlue()](#getTintColorBlue--) | يحصل أو يعيّن القيمة المزدوجة للون الصبغ الأزرق. |
| [getTintColorGreen()](#getTintColorGreen--) | يحصل أو يعيّن القيمة المزدوجة للون الصبغ الأخضر. |
| [getTintColorRed()](#getTintColorRed--) | يحصل أو يعيّن القيمة المزدوجة للون الصبغ الأحمر. |
...
| [processPixels_internalized(int[] pixels)](#processPixels-internalized-int---) | يعالج البكسلات. |
...
| [setTintColor(int value)](#setTintColor-int-) | يحصل أو يعيّن قيمة لون الصبغ. |
| [setTintColorBlue(double value)](#setTintColorBlue-double-) | يحصل أو يعيّن القيمة المزدوجة للون الصبغ الأزرق. |
| [setTintColorGreen(double value)](#setTintColorGreen-double-) | يحصل أو يعيّن القيمة المزدوجة للون الصبغ الأخضر. |
| [setTintColorRed(double value)](#setTintColorRed-double-) | يحصل أو يعيّن القيمة المزدوجة للون الصبغ الأحمر. |
...
يحصل أو يعيّن قيمة لون الصبغ.

القيمة: قيمة لون الصبغ.
