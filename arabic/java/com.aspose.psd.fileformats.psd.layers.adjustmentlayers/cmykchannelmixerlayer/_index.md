...
description: "طبقة تعديل خالط القنوات CMYK."
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
...
| [getBlackChannel()](#getBlackChannel--) | يحصل على القناة السوداء. |
...
| [getChannelByIndex(int index)](#getChannelByIndex-int-) | يحصل على فهرس القناة بواسطة. |
...
| [getCyanChannel()](#getCyanChannel--) | يحصل على القناة السماوية. |
...
| [getMagentaChannel()](#getMagentaChannel--) | يحصل على قناة الماجنتا. |
...
| [getMonochrome()](#getMonochrome--) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) أحادي اللون. |
...
| [getYellowChannel()](#getYellowChannel--) | يحصل على قناة الأصفر. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | يعالج طبقة التعديل. |
...
| [setMonochrome(boolean value)](#setMonochrome-boolean-) | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) أحادي اللون. |
...
يحصل على فهرس القناة بواسطة. يُعيد CmykMixerChannel
...
يحصل على قناة الماجنتا.

القيمة: قناة الماجنتا.
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا [ChannelMixerLayer](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer) أحادي اللون.

القيمة:  true  إذا كان أحادي اللون؛ وإلا،  false .
