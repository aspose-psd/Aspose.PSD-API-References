...
description: "طبقة تعديل اللون الانتقائي."
type: docs
weight: 28
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/
---
...
| [getAdjustmentLayerType_internalized()](#getAdjustmentLayerType-internalized--) | يحصل على نوع طبقة التعديل. |
...
| [getCmykCorrection(int selectiveColorsType)](#getCmykCorrection-int-) | يحصل على تصحيح cmyk عن طريق اللون الانتقائي. |
| [getContainer()](#getContainer--) | يحصل على حاوية الصورة. |
| [getCorrectionMethod()](#getCorrectionMethod--) | يحصل أو يضبط طريقة التصحيح. |
...
| [getProcessor_internalized()](#getProcessor-internalized--) | يحصل على المعالج. |
...
| [processAdjustmentLayer_internalized(Rectangle pixelsRectangle, int[] pixels, Point start, Point end)](#processAdjustmentLayer-internalized-com.aspose.psd.Rectangle-int---com.aspose.psd.Point-com.aspose.psd.Point-) | يعالج طبقة اللون الانتقائي. |
...
| [resizeChannelsData_internalized(Rectangle rect)](#resizeChannelsData-internalized-com.aspose.psd.Rectangle-) | يدمج البيانات. |
...
| [setCmykCorrection(int selectiveColorsType, CmykCorrection correction)](#setCmykCorrection-int-com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models.CmykCorrection-) | يضبط تصحيح cmyk عن طريق اللون الانتقائي. |
| [setContainer_internalized(Image container)](#setContainer-internalized-com.aspose.psd.Image-) | يضبط حاوية الصورة. |
| [setCorrectionMethod(int value)](#setCorrectionMethod-int-) | يحصل أو يضبط طريقة التصحيح. |
...
يحصل على نوع طبقة التعديل.

القيمة: نوع طبقة التعديل.
...
يحصل على تصحيح cmyk عن طريق اللون الانتقائي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| selectiveColorsType | int | الألوان الانتقائية. |
...
يحصل أو يضبط طريقة التصحيح.

القيمة: طريقة التصحيح.
...
يعالج طبقة اللون الانتقائي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| pixelsRectangle | [Rectangle](../../com.aspose.psd/rectangle) | مستطيل البكسلات. |
| بكسلات | int[] | مصفوفة البكسلات. |
| start | [Point](../../com.aspose.psd/point) | موقع البكسلات العلوي الأيسر. |
| end | [Point](../../com.aspose.psd/point) | موقع البكسلات السفلي الأيمن. |

**Returns:**
com.aspose.internal.fileformats.psd.common.Tuple<int[],com.aspose.psd.Rectangle> - مستطيل البكسلات والبكسلات المعالجة.
...
يضبط تصحيح cmyk عن طريق اللون الانتقائي.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| selectiveColorsType | int | نوع الألوان الانتقائية. |
| correction | [CmykCorrection](../../com.aspose.psd.fileformats.psd.layers.adjustmentlayers.models/cmykcorrection) | تصحيح Cmyk. |
