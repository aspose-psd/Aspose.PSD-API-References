...
description: "فئة طبقة تعديل توازن اللون."
type: docs
weight: 16
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/
---
...
| [getShadowsYellowBlueBalance()](#getShadowsYellowBlueBalance--) | يحصل أو يضبط توازن الظلال YellowBlue. |
...
| [processColorBalance_internalized(int[] pixels)](#processColorBalance-internalized-int---) | طبق التصحيحات للظلال الحالية والوسطيات والإضاءات على مصفوفة int RGB المحددة. |
...
| [setShadowsYellowBlueBalance(short value)](#setShadowsYellowBlueBalance-short-) | يحصل أو يضبط توازن الظلال YellowBlue. |
...
يحصل أو يضبط توازن الظلال YellowBlue.
...
طبق التصحيحات للظلال الحالية والوسطيات والإضاءات على مصفوفة int RGB المحددة.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| بكسلات | int[] | مصفوفة int اللون RGB. |
