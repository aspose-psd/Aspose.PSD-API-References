...
description: "طبقة تعديل التعرض."
type: docs
weight: 18
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/exposurelayer/
---
...
| [getExposure()](#getExposure--) | يحصل أو يعيّن الـ Exposure. |
...
| [getGammaCorrection()](#getGammaCorrection--) | يحصل أو يعيّن الـ GammaCorrection. |
...
| [getOffset()](#getOffset--) | يحصل أو يعيّن الـ Offset. |
...
| [setExposure(float value)](#setExposure-float-) | يحصل أو يعيّن الـ Exposure. |
...
| [setGammaCorrection(float value)](#setGammaCorrection-float-) | يحصل أو يعيّن الـ GammaCorrection. |
...
| [setOffset(float value)](#setOffset-float-) | يحصل أو يعيّن الـ Offset. |
...
يحصل أو يعيّن الـ Exposure. النطاق في PS للـ Exposure هو من -20 إلى +20.
...
يحصل أو يعيّن الـ GammaCorrection. النطاق في PS للـ GammaCorrection هو من 9.99 إلى +0.01

القيمة: الـ GammaCorrection.
...
يحصل أو يعيّن الـ Offset. النطاق في PS للـ Offset هو من -0.5 إلى +0.5
