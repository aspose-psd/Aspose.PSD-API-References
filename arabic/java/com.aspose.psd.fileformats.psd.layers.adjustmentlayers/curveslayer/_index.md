...
description: "طبقة تعديل المنحنيات"
type: docs
weight: 17
url: /ar/java/com.aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
...
| [getCurvesManager()](#getCurvesManager--) | يحصل على مدير المنحنيات. |
...
| [isContinuousManagerUsed()](#isContinuousManagerUsed--) | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا مستمرًا. |
| [isDiscreteManagerUsed()](#isDiscreteManagerUsed--) | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا متقطعًا. |
...
| [setContinuousManagerUsed(boolean value)](#setContinuousManagerUsed-boolean-) | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا مستمرًا. |
...
| [setDiscreteManagerUsed(boolean value)](#setDiscreteManagerUsed-boolean-) | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا متقطعًا. |
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا مستمرًا.

القيمة:  true  إذا كان هذا المثال يستخدم مديرًا مستمرًا؛ وإلا،  false .
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا متقطعًا.

القيمة:  true  إذا كان هذا المثال يستخدم مديرًا متقطعًا؛ وإلا،  false .
...
| بكسلات | int[] | البكسلات. |
| start | [Point](../../com.aspose.psd/point) | البداية. |
| end | [Point](../../com.aspose.psd/point) | النهاية. |
