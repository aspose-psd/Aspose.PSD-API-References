...
type: docs
weight: 19
url: /ar/java/com.aspose.psd.coreexceptions.imageformats/tiffimageexception/
---
...
| المنشئ | الوصف |
| --- | --- |
| [TiffImageException(String message)](#TiffImageException-java.lang.String-) | يقوم بإنشاء نسخة جديدة من الفئة  TiffImageException  . |
| [TiffImageException(String message, Throwable innerException)](#TiffImageException-java.lang.String-java.lang.Throwable-) | يقوم بإنشاء نسخة جديدة من الفئة  TiffImageException  . |
| [TiffImageException(String message, int error)](#TiffImageException-java.lang.String-int-) | يقوم بإنشاء نسخة جديدة من الفئة  TiffImageException  . |
| [TiffImageException(int error)](#TiffImageException-int-) | يقوم بإنشاء نسخة جديدة من الفئة  TiffImageException  . |
## الطرق
...
يقوم بإنشاء نسخة جديدة من الفئة  TiffImageException  .
