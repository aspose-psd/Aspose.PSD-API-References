...
description: "استثناء مورد صورة psd."
type: docs
weight: 18
url: /ar/java/com.aspose.psd.coreexceptions.imageformats/psdimageresourceexception/
---
...
استثناء مورد صورة psd.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [PsdImageResourceException(String message, ResourceBlock resource)](#PsdImageResourceException-java.lang.String-com.aspose.psd.fileformats.psd.ResourceBlock-) | ينشئ مثيلاً جديدًا من الفئة [PsdImageResourceException](../../com.aspose.psd.coreexceptions.imageformats/psdimageresourceexception) . |
| [PsdImageResourceException(String message, ResourceBlock resource, RuntimeException innerException)](#PsdImageResourceException-java.lang.String-com.aspose.psd.fileformats.psd.ResourceBlock-java.lang.RuntimeException-) | ينشئ مثيلاً جديدًا من الفئة [PsdImageResourceException](../../com.aspose.psd.coreexceptions.imageformats/psdimageresourceexception) . |
## الطرق
...
| [getResource()](#getResource--) | يحصل على مورد الـ psd الذي تسبب في هذا الاستثناء. |
...
ينشئ مثيلاً جديدًا من الفئة [PsdImageResourceException](../../com.aspose.psd.coreexceptions.imageformats/psdimageresourceexception) .

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| message | java.lang.String | رسالة الاستثناء. |
| resource | [ResourceBlock](../../com.aspose.psd.fileformats.psd/resourceblock) | المورد. |
...
| message | java.lang.String | رسالة الاستثناء. |
| resource | [ResourceBlock](../../com.aspose.psd.fileformats.psd/resourceblock) | المورد. |
| innerException | java.lang.RuntimeException | الاستثناء الداخلي. |
...
يحصل على مورد الـ psd الذي تسبب في هذا الاستثناء.
