...
description: "يعرف فئة مصدر البيانات liFD في ملف PSD التي تحتوي على معلومات حول ملف مضمّن."
type: docs
weight: 10
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource/
---
...
يعرّف فئة مصدر بيانات liFD في ملف PSD التي تحتوي على معلومات حول ملف مدمج. هذه جزء من واجهة برمجة تطبيقات تعديل تنسيق ملفات PSD التي تساعد على تعديل ملفات Adobe® Photoshop®.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [LiFdDataSource()](#LiFdDataSource--) | ينشئ مثيلًا جديدًا من الفئة [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
| [LiFdDataSource(int version, UUID uniqueId, String originalFileName, String fileType, String fileCreator)](#LiFdDataSource-int-java.util.UUID-java.lang.String-java.lang.String-java.lang.String-) | ينشئ مثيلًا جديدًا من الفئة [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource). |
## الحقول
...
| [getData()](#getData--) | يحصل أو يعيّن بيانات الكائن الذكي المدمج في ملف PSD. |
| [getDataLength_Property_internalized()](#getDataLength-Property-internalized--) | يحصل على طول البيانات المدمجة. |
...
| [setData(byte[] value)](#setData-byte---) | يحصل أو يعيّن بيانات الكائن الذكي المدمج في ملف PSD. |
...
ينشئ مثيلًا جديدًا من الفئة [LiFdDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifddatasource).
...
يحصل أو يعيّن بيانات الكائن الذكي المدمج في ملف PSD.

القيمة: بيانات الكائن الذكي المدمج.
...
يحصل على طول البيانات المدمجة.

القيمة: طول البيانات المدمجة.
