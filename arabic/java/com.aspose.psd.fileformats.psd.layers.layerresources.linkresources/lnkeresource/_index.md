...
description: "يعرف فئة LnkeResource التي تحتوي على معلومات حول الملفات المرتبطة خارجيًا أو الأصول في صورة بتنسيق PSD."
type: docs
weight: 17
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource/
---
...
يعرّف فئة LnkeResource التي تحتوي على معلومات حول الملفات أو الأصول المرتبطة الخارجية في صورة بصيغة PSD. قد يحتوي مصدر الارتباط على عدة مثيلات من [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) يمكن الوصول إليها عبر الفهرس. هذا جزء من واجهة برمجة تطبيقات معالجة صيغة ملفات PSD التي تساعد على تعديل ملفات Adobe® Photoshop® برمجيًا
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [LnkeResource()](#LnkeResource--) | ينشئ مثيلًا جديدًا من فئة [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) . |
| [LnkeResource(LinkDataSource[] dataSources)](#LnkeResource-com.aspose.psd.fileformats.psd.layers.layerresources.linkresources.LinkDataSource---) | ينشئ مثيلًا جديدًا من فئة [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) . |
## الحقول
...
| [get_Item(int index)](#get-Item-int-) | يحصل على [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) عند الفهرس المحدد. |
...
ينشئ مثيلًا جديدًا من فئة [LnkeResource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnkeresource) .
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| dataSources | [LinkDataSource\[\]](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) | مصادر البيانات. |
...
يحصل على [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource) عند الفهرس المحدد.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| index | int | المؤشر. القيمة: الـ [LiFeDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lifedatasource). |
