...
description: "يعرف فئة LinkResource التي تحتوي على معلومات حول الملفات المرتبطة أو المضمنة في صورة بتنسيق PSD."
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkresource/
---
...
يعرّف فئة LinkResource التي تحتوي على معلومات حول الملفات المرتبطة أو المدمجة في صورة بصيغة PSD. قد يحتوي مصدر الارتباط على عدة مثيلات من [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) يمكن الوصول إليها عبر الفهارس في أي فئة مشتقة.
## الحقول
...
| [get_Item(int index)](#get-Item-int-) | يحصل على [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) عند الفهرس المحدد. |
...
يحصل على [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource) عند الفهرس المحدد.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| index | int | الفهرس الصحيح. القيمة: الـ [LinkDataSource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/linkdatasource). |
