...
description: "يعرف الفئة التي تحتوي على معلومات حول الملفات المضمنة في صورة بتنسيق PSD."
type: docs
weight: 15
url: /ar/java/com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource/
---
...
يعرّف الفئة التي تحتوي على معلومات حول الملفات المدمجة في صورة بصيغة PSD. قد يحتوي مصدر الارتباط على عدة مثيلات من LiFdDataSource يمكن الوصول إليها عبر الفهرس.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [Lnk2Resource()](#Lnk2Resource--) | ينشئ مثيلًا جديدًا من فئة [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) . |
## الحقول
...
ينشئ مثيلًا جديدًا من فئة [Lnk2Resource](../../com.aspose.psd.fileformats.psd.layers.layerresources.linkresources/lnk2resource) .
