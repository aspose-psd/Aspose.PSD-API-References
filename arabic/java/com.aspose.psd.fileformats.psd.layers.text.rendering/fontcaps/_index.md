...
description: "هذا هو خط أساس الخط."
type: docs
weight: 12
url: /ar/java/com.aspose.psd.fileformats.psd.layers.text.rendering/fontcaps/
---
...
| حقل | الوصف |
| --- | --- |
| [AllCaps](#AllCaps) | كل الأحرف الكبيرة. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | لا قيمة لأحرف الخط الكبيرة. |
| [SmallCaps](#SmallCaps) | الأحرف الصغيرة. |
## الطرق
