...
description: "نوع الفواصل في Photoshop هو المسافة بين السطور."
type: docs
weight: 14
url: /ar/java/com.aspose.psd.fileformats.psd.layers.text.rendering/leadingtype/
---
...
نوع التباعد في فوتوشوب (نوع المسافة بين السطور).
## الحقول

| حقل | الوصف |
| --- | --- |
| [BottomToBottom](#BottomToBottom) | الفاصل من أسفل إلى أسفل. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [TopToTop](#TopToTop) | الفاصل من أعلى إلى أعلى. |
## الطرق
