...
description: "الفئة Aspose.PSD.Shapes.EllipseShape. تمثل شكل بيضاوي"
type: docs
weight: 5990
...
| الاسم | الوصف |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | يقوم بتهيئة نسخة جديدة من الفئة `EllipseShape`. |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | يقوم بتهيئة نسخة جديدة من الفئة `EllipseShape`. |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | يحصل على مقاطع الشكل. |
