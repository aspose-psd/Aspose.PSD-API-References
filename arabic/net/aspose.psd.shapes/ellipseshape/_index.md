...
description: Aspose.PSD.Shapes.EllipseShape فصل. يمثل شكل القطع الناقص.
type: docs
weight: 5490
url: /ar/net/aspose.psd.shapes/ellipseshape/
---
## EllipseShape class
...
| اسم | وصف |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | يقوم بتهيئة مثيل جديد لملف`EllipseShape` فئة . |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | يقوم بتهيئة مثيل جديد لملف`EllipseShape` فئة . |
...
| override [Segments](../../aspose.psd.shapes/ellipseshape/segments/) { get; } | الحصول على شرائح الشكل . |
