...
description: "الفئة Aspose.PSD.Shapes.RectangleShape. تمثل شكل مستطيل"
type: docs
weight: 6030
...
| الاسم | الوصف |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | يقوم بتهيئة نسخة جديدة من الفئة `RectangleShape`. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | يقوم بتهيئة نسخة جديدة من الفئة `RectangleShape`. |
...
| override [Segments](../../aspose.psd.shapes/rectangleshape/segments/) { get; } | يحصل على مقاطع الشكل. |
