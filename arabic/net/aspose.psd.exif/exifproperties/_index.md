...
description: Aspose.PSD.Exif.ExifProperties تعداد. قائمة علامات Exif
type: docs
weight: 1000
...
| XResolution | `282` | عدد البكسل لكل وحدة دقة في اتجاه ImageWidth. عندما تكون دقة الصورة غير معروفة ، يتم تعيين 72 [نقطة في البوصة]. |
...
| TransferFunction | `301` | وظيفة نقل للصورة ، موصوفة بأسلوب جدولي. عادةً لا تكون هذه العلامة ضرورية ، حيث يتم تحديد مساحة اللون في علامة ColorSpace الخاصة بمعلومات مساحة اللون. |
