---
title: "الفئة GradientMapLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.GradientMapLayer class. طبقة خريطة التدرج. تتعامل مع عرض خريطة التدرج باستخدام البيانات من GrdmResource."
type: docs
weight: 1810
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/
---
{{< psd/tize >}}
...
| [GradientSettings](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/) { get; set; } | يحصل أو يضبط نسخة إعدادات التدرج الممررة من نسخة GrdmResource. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/update/)() | تحديث بيانات الطبقة في مورد الطبقة المرتبط [`GrdmResource`](../../aspose.psd.fileformats.psd.layers.layerresources/grdmresource/). |
