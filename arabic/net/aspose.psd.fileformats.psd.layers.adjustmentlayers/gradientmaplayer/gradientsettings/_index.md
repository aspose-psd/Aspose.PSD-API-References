...
description: "خاصية GradientMapLayer. تحصل أو تعين كائن إعدادات التدرج الممرَّر من كائن GrdmResource"
type: docs
weight: 10
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/gradientmaplayer/gradientsettings/
---
{{< psd/tize >}}
## GradientMapLayer.GradientSettings property

يحصل أو يضبط نسخة إعدادات التدرج الممررة من نسخة GrdmResource.
