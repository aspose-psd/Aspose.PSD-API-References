...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer فصل. طبقة السطوع / التباين.
type: docs
weight: 1680
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | الحصول على أو ضبط السطوع. تتراوح درجة سطوع PS من -150 إلى +150. لكننا نتجاهل هذا. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | الحصول على التباين أو تحديده. يتراوح نطاق التباين لـ PS من -50 إلى +100. لكننا نتجاهل هذا. |
