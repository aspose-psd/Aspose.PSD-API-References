---
title: "الفئة BrightnessContrastLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BrightnessContrastLayer الفئة. طبقة السطوع/التباين"
type: docs
weight: 1720
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/
---
{{< psd/tize >}}
...
| [Brightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/brightness/) { get; set; } | الحصول أو تعيين السطوع. النطاق في PS للسطوع هو من -150 إلى +150. لكننا نتجاهل ذلك. |
...
| [Contrast](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/brightnesscontrastlayer/contrast/) { get; set; } | الحصول أو تعيين التباين. النطاق في PS للتباين هو من -50 إلى +100. لكننا نتجاهل ذلك. |
