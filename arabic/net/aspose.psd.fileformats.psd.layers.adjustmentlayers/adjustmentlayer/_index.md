...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.AdjustmentLayer فصل. طبقة الضبط. على سبيل المثال السطوع / التباين
type: docs
weight: 1660
...
طبقة الضبط. على سبيل المثال السطوع / التباين
