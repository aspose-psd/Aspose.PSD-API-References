...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer فصل. طبقة ضبط مرشح الصورة .
type: docs
weight: 1790
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | الحصول على أو تحديد لون RGB للمرشح. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | الحصول على كثافة المرشح أو تعيينها |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى [الحفاظ على اللمعان] . |
