---
title: "الفئة PhotoFilterLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PhotoFilterLayer. طبقة تعديل PhotoFilter."
type: docs
weight: 1860
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/
---
{{< psd/tize >}}
## PhotoFilterLayer class

طبقة ضبط مرشح الصورة.
...
| [Color](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/color/) { get; set; } | الحصول أو تعيين لون RGB للمرشح. |
...
| [Density](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/density/) { get; set; } | الحصول أو تعيين كثافة المرشح. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/photofilterlayer/preserveluminosity/) { get; set; } | الحصول أو تعيين قيمة تشير إلى ما إذا كان [preserve luminosity]. |
