---
title: "تعداد SelectiveColorsTypes"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.SelectiveColorsTypes enum. أنواع الألوان في طبقة تعديل اللون الانتقائي"
type: docs
weight: 1910
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorstypes/
---
{{< psd/tize >}}
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Reds | `0` | الألوان الحمراء. |
| Yellows | `1` | الألوان الصفراء. |
| Greens | `2` | الألوان الخضراء. |
| Cyans | `3` | الألوان السيان. |
| Blues | `4` | الألوان الزرقاء. |
| Magentas | `5` | الألوان الأرجوانية. |
| Whites | `6` | الألوان البيضاء. |
| Neutrals | `7` | الألوان المحايدة. |
| Blacks | `8` | الألوان السوداء. |
