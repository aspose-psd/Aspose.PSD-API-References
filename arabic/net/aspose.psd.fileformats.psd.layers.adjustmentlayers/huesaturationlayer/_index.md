...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer فصل. طبقة ضبط HueSaturation .
type: docs
weight: 1750
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/
---
## HueSaturationLayer class

طبقة ضبط HueSaturation .
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا`HueSaturationLayer` هو colorize . |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | الحصول على الصبغة أو تعيينها . |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | الحصول على الإضاءة أو ضبطها . |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | الحصول على أو تعيين التشبع. |
...
| [GetRange](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/getrange/)(int) | يحصل على النطاق . |
