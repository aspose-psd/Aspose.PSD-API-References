---
title: "الفئة HueSaturationLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.HueSaturationLayer. طبقة تعديل تشبع اللون"
type: docs
weight: 1820
...
| [Colorize](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/colorize/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كانت هذه `HueSaturationLayer` ملونة. |
...
| [Hue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/hue/) { get; set; } | يحصل أو يعيّن درجة اللون. |
...
| [Lightness](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/lightness/) { get; set; } | يحصل أو يعيّن الإضاءة. |
...
| [Saturation](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/huesaturationlayer/saturation/) { get; set; } | الحصول أو تعيين التشبع. |
