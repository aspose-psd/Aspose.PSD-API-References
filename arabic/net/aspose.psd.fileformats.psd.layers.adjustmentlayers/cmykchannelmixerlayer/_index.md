...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CmykChannelMixerLayer فصل. طبقة تعديل Cmyk Channel Mixer.
type: docs
weight: 1700
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/
---
## CmykChannelMixerLayer class

طبقة تعديل Cmyk Channel Mixer.
...
| [BlackChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/blackchannel/) { get; } | يحصل على القناة السوداء . |
...
| [CyanChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/cyanchannel/) { get; } | يحصل على القناة السماوية . |
...
| [MagentaChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/magentachannel/) { get; } | يحصل على القناة الأرجواني . |
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا[`ChannelMixerLayer`](../channelmixerlayer/) أحادي اللون. |
...
| [YellowChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/yellowchannel/) { get; } | يحصل على القناة الصفراء . |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/cmykchannelmixerlayer/getchannelbyindex/)(int) | يحصل على فهرس القناة بواسطة. إرجاع CmykMixerChannel |
