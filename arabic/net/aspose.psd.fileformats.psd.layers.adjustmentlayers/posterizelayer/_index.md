...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer فصل. طبقة تتالي. يعالج عرض الملصق باستخدام البيانات من PostResource .
type: docs
weight: 1800
...
طبقة تتالي. يعالج عرض الملصق باستخدام البيانات من PostResource .
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | مستويات الطبقة المتتالية . |
