...
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.PosterizeLayer. طبقة Posterize. تتعامل مع عرض Posterize باستخدام البيانات من PostResource"
type: docs
weight: 1870
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/
---
{{< psd/tize >}}
## PosterizeLayer class

طبقة بوستريزي. تتعامل مع عرض بوستريزي باستخدام البيانات من PostResource.
...
| [Levels](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/posterizelayer/levels/) { get; set; } | مستويات طبقة Posterize. |
