...
description: "SelectiveColorLayer الطريقة. يحصل على تصحيح cmyk عن طريق اللون الانتقائي"
type: docs
weight: 30
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/getcmykcorrection/
---
{{< psd/tize >}}
## SelectiveColorLayer.GetCmykCorrection method

يحصل على تصحيح cmyk بواسطة اللون الانتقائي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | الألوان الانتقائية. |
