...
description: "SelectiveColorLayer الطريقة. يضبط تصحيح cmyk عن طريق اللون الانتقائي"
type: docs
weight: 40
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/selectivecolorlayer/setcmykcorrection/
---
{{< psd/tize >}}
## SelectiveColorLayer.SetCmykCorrection method

يضبط تصحيح cmyk بواسطة اللون الانتقائي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| selectiveColorsType | SelectiveColorsTypes | نوع الألوان الانتقائية. |
| تصحيح | CmykCorrection | تصحيح Cmyk. |
