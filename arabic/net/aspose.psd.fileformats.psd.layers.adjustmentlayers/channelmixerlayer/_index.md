---
title: "الفئة ChannelMixerLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer. طبقة تعديل خالط القنوات."
type: docs
weight: 1730
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/
---
{{< psd/tize >}}
## ChannelMixerLayer class

طبقة ضبط خالط القنوات.
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كانت هذه `ChannelMixerLayer` أحادية اللون. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | يحصل على فهرس القناة. يمكن أن يرجع RgbMixerChannel أو CmykMixerChannel. |
