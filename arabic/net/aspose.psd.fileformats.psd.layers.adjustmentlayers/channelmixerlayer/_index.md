...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ChannelMixerLayer فصل. طبقة ضبط مازج القنوات.
type: docs
weight: 1690
...
| [Monochrome](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/monochrome/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا`ChannelMixerLayer` أحادي اللون. |
...
| abstract [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/channelmixerlayer/getchannelbyindex/)(int) | يحصل على فهرس القناة بواسطة. يمكن إرجاع RgbMixerChannel أو CmykMixerChannel |
