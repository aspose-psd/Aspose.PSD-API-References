---
title: "التعداد CorrectionMethodTypes"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "التعداد Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CorrectionMethodTypes. طريقة التصحيح في طبقة تعديل اللون الانتقائي."
type: docs
weight: 1780
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/correctionmethodtypes/
---
{{< psd/tize >}}
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Relative | `0` | تطبيق تصحيح اللون في الوضع النسبي. |
| Absolute | `1` | تطبيق تصحيح اللون في الوضع المطلق. |
