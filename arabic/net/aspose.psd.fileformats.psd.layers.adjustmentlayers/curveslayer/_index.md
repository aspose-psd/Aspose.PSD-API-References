...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer فصل. طبقة ضبط المنحنيات
type: docs
weight: 1730
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا المثيل مديرًا مستمرًا مستخدمًا. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا المثيل هو مدير منفصل مستخدم. |
