---
title: "الفئة CurvesLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.CurvesLayer. طبقة تعديل المنحنيات."
type: docs
weight: 1790
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/
---
{{< psd/tize >}}
## CurvesLayer class
...
| [IsContinuousManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/iscontinuousmanagerused/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا مستمرًا. |
| [IsDiscreteManagerUsed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/isdiscretemanagerused/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كان هذا المثال يستخدم مديرًا منفصلًا. |
...
| [GetCurvesManager](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/curveslayer/getcurvesmanager/)() | يحصل على مدير المنحنيات. |
