---
title: "الفئة ColorBalanceAdjustmentLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.ColorBalanceAdjustmentLayer. فئة طبقة تعديل توازن اللون."
type: docs
weight: 1770
...
| [HighlightsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightscyanredbalance/) { get; set; } | يحصل أو يضبط توازن الإضاءات للسيان الأحمر. |
| [HighlightsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsmagentagreenbalance/) { get; set; } | يحصل أو يضبط توازن الإضاءات للماجنتا الأخضر. |
| [HighlightsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/highlightsyellowbluebalance/) { get; set; } | يحصل أو يضبط توازن الإضاءات للأصفر الأزرق. |
...
| [MidtonesCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonescyanredbalance/) { get; set; } | يحصل أو يضبط توازن النغمات المتوسطة للسيان الأحمر. |
| [MidtonesMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesmagentagreenbalance/) { get; set; } | يحصل أو يضبط توازن النغمات المتوسطة للماجنتا الأخضر. |
| [MidtonesYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/midtonesyellowbluebalance/) { get; set; } | يحصل أو يضبط توازن النغمات المتوسطة للأصفر الأزرق. |
...
| [PreserveLuminosity](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/preserveluminosity/) { get; set; } | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [`BlncResource`](../../aspose.psd.fileformats.psd.layers.layerresources/blncresource/) يحافظ على الإضاءة. |
...
| [ShadowsCyanRedBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowscyanredbalance/) { get; set; } | يحصل أو يضبط توازن الظلال للسيان الأحمر. |
| [ShadowsMagentaGreenBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsmagentagreenbalance/) { get; set; } | يحصل أو يضبط توازن الظلال للماجنتا الأخضر. |
| [ShadowsYellowBlueBalance](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/colorbalanceadjustmentlayer/shadowsyellowbluebalance/) { get; set; } | يحصل أو يضبط توازن الظلال للأصفر الأزرق. |
