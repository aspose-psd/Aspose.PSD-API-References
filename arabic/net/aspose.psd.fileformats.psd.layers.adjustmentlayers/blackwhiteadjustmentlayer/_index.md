...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.BlackWhiteAdjustmentLayer فصل. فئة طبقة الضبط بالأبيض والأسود .
type: docs
weight: 1670
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/
---
## BlackWhiteAdjustmentLayer class

فئة طبقة الضبط بالأبيض والأسود .
...
| [BlackAndWhitePresetFileName](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blackandwhitepresetfilename/) { get; set; } | الحصول على أو تعيين اسم ملف الإعداد المسبق بالأبيض والأسود. |
...
| [Blues](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/blues/) { get; set; } | الحصول على أو تحديد قيمة البلوز. |
...
| [BwPresetKind](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/bwpresetkind/) { get; set; } | الحصول على أو تعيين قيمة نوع الإعداد المسبق بالأبيض والأسود. |
...
| [Cyans](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/cyans/) { get; set; } | الحصول على أو تعيين قيمة cyans . |
...
| [Greens](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/greens/) { get; set; } | الحصول على أو تعيين قيمة الخضر . |
...
| [Magentas](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/magentas/) { get; set; } | الحصول على أو تحديد قيمة اللون الأرجواني. |
...
| [Reds](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/reds/) { get; set; } | الحصول على قيمة اللون الأحمر أو تعيينها. |
...
| [TintColor](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolor/) { get; set; } | الحصول على أو تعيين قيمة اللون الخفيف. |
| [TintColorBlue](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorblue/) { get; set; } | الحصول على القيمة المزدوجة لـ Blue Tint Color أو تعيينها. |
| [TintColorGreen](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorgreen/) { get; set; } | الحصول على القيمة المزدوجة لـ Green Tint Color أو تعيينها. |
| [TintColorRed](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/tintcolorred/) { get; set; } | الحصول على القيمة المزدوجة للون الأحمر الخفيف أو تعيينها. |
...
| [UseTint](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/usetint/) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان [لون الصبغة] مستخدمًا . |
...
| [Yellows](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/blackwhiteadjustmentlayer/yellows/) { get; set; } | الحصول على أو تحديد قيمة اللون الأصفر. |
