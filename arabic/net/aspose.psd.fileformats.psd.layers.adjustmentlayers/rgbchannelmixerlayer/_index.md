---
title: "الفئة RgbChannelMixerLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.RgbChannelMixerLayer الفئة. طبقة تعديل خلط القنوات Rgb"
type: docs
weight: 1880
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/
---
{{< psd/tize >}}
## RgbChannelMixerLayer class

طبقة تعديل خلط قناة Rgb.
...
| [BlueChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/bluechannel/) { get; } | الحصول على قناة الأزرق. |
...
| [GreenChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/greenchannel/) { get; } | الحصول على قناة الأخضر. |
...
| [RedChannel](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/redchannel/) { get; } | الحصول على قناة الأحمر. |
...
| override [GetChannelByIndex](../../aspose.psd.fileformats.psd.layers.adjustmentlayers/rgbchannelmixerlayer/getchannelbyindex/)(int) | الحصول على فهرس القناة بواسطة. يُرجع RgbMixerChannel |
