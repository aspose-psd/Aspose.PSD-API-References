...
description: Aspose.PSD.FileFormats.Psd.Layers.AdjustmentLayers.InvertAdjustmentLayer فصل. فئة طبقة الضبط العكسي .
type: docs
weight: 1760
url: /ar/net/aspose.psd.fileformats.psd.layers.adjustmentlayers/invertadjustmentlayer/
---
## InvertAdjustmentLayer class

فئة طبقة الضبط العكسي .
