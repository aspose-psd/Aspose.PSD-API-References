...
description: ISmartFilterRenderer طريقة. يعرض عامل التصفية الذكي الحالي على بيانات البكسل.
type: docs
weight: 10
...
يعرض عامل التصفية الذكي الحالي على بيانات البكسل.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| pixelsData | PixelsData | بيانات البكسل. |

### قيمة الإرجاع

إرجاع بيانات البكسل التي تمت معالجتها.
...
* مساحة الاسم [Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.Rendering](../../ismartfilterrenderer/)
* المجسم [Aspose.PSD](../../../)
