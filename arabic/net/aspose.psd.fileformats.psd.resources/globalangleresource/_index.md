...
description: Aspose.PSD.FileFormats.Psd.Resources.GlobalAngleResource فصل. مورد الزاوية العالمية
type: docs
weight: 3720
url: /ar/net/aspose.psd.fileformats.psd.resources/globalangleresource/
---
## GlobalAngleResource class

مورد الزاوية العالمية
...
| اسم | وصف |
| --- | --- |
| override [DataSize](../../aspose.psd.fileformats.psd.resources/globalangleresource/datasize/) { get; } | الحصول على حجم بيانات المورد بالبايت. |
| [GlobalAngle](../../aspose.psd.fileformats.psd.resources/globalangleresource/globalangle/) { get; set; } | الحصول على الزاوية العامة أو تحديدها . |
| [ID](../../aspose.psd.fileformats.psd/resourceblock/id/) { get; set; } | الحصول على أو تحديد المعرف الفريد للمورد. |
| override [MinimalVersion](../../aspose.psd.fileformats.psd.resources/globalangleresource/minimalversion/) { get; } | يحصل على الحد الأدنى من إصدار PSD المطلوب. |
