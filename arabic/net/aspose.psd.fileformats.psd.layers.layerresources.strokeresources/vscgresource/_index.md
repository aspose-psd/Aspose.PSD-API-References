---
title: "الفئة VscgResource"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.LayerResources.StrokeResources.VscgResource. مورد بيانات محتوى الخط المتجه"
type: docs
weight: 3430
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/
---
{{< psd/tize >}}
## VscgResource class
...
| الاسم | الوصف |
| --- | --- |
| [VscgResource](vscgresource/)() | الباني الافتراضي. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [Items](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/items/) { get; } | يحصل أو يضبط مصفوفة عناصر البنية. **Warning:** يجب أن تتطابق قيم مصفوفة `Items` مع خاصية `KeyForData`، التي تحدد نوع إعدادات التعبئة المخزنة في البنى داخل `Items`. |
| [Key](../../aspose.psd.fileformats.psd.layers/layerresource/key/) { get; } | يحصل على مفتاح مورد الطبقة. |
| [KeyForData](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/keyfordata/) { get; } | يحصل على المفتاح الصحيح الذي يحدد نوع إعدادات التعبئة المخزنة في المورد: * Color - 0x536f436f - SoCoResource.TypeToolKey * Gradient - 0x4764466c - GdFlResource.TypeToolKey * Pattern - 0x5074466c - PtFlResource.TypeToolKey تحذير! يجب أن تتطابق قيمة الخاصية KeyForData مع نوع إعدادات التعبئة المخزنة في هياكل Items. |
| override [Length](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/length/) { get; } | يحصل على طول مورد الطبقة بالبايت. |
...
| الاسم | الوصف |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/save/)(StreamContainer, int) | يحفظ المورد في حاوية الدفق المحددة. |
...
| الاسم | الوصف |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vscgresource/typetoolkey/) | مفتاح معلومات أداة النوع. |
