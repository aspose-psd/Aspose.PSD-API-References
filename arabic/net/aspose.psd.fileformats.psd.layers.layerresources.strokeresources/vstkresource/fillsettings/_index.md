...
description: "خاصية VstkResource. تحصل أو تعيين إعدادات التعبئة للحد"
type: docs
weight: 30
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources.strokeresources/vstkresource/fillsettings/
---
{{< psd/tize >}}
## VstkResource.FillSettings property

يحصل أو يضبط إعدادات التعبئة للخط.
