---
title: "الفئة FXidResource"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.LayerResources.FXidResource. مورد تأثيرات الفلتر يحتوي على قنوات وقناع مستخدم وقناع ورقة للفلتر الذكي"
type: docs
weight: 2720
...
مورد تأثيرات الفلتر يحتوي على القنوات، قناع المستخدم، وقناع الورقة للفلتر الذكي.
...
| الاسم | الوصف |
| --- | --- |
| [FXidResource](fxidresource/)(int, int, FilterEffectMaskData[]) | يُنشئ مثيلًا جديدًا من الفئة `FXidResource`. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [FilterEffectMasks](../../aspose.psd.fileformats.psd.layers.layerresources/fxidresource/filtereffectmasks/) { get; } | يحصل على أقنعة تأثير الفلتر. |
| [Key](../../aspose.psd.fileformats.psd.layers/layerresource/key/) { get; } | يحصل على مفتاح مورد الطبقة. |
| override [Length](../../aspose.psd.fileformats.psd.layers.layerresources/fxidresource/length/) { get; } | يحصل على طول مورد الطبقة بالبايت. |
...
| الاسم | الوصف |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/fxidresource/save/)(StreamContainer, int) | يحفظ المورد في حاوية الدفق المحددة. |
