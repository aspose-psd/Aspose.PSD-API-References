---
title: "الفئة SoLeResource"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLeResource الفئة. يحدد فئة SoLeResource التي تحتوي على معلومات حول طبقة كائن ذكي في ملف PSD. تُستخدم لدعم طبقات الكائنات الذكية مع روابط ملفات خارجية في صور Adobe Photoshop."
type: docs
weight: 3380
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/soleresource/
---
{{< psd/tize >}}
## SoLeResource class

يعرّف فئة SoLeResource التي تحتوي على معلومات حول طبقة كائن ذكي في ملف PSD. يُستخدم لدعم طبقات الكائنات الذكية مع روابط ملفات خارجية في صور Adobe® Photoshop®.
...
| الاسم | الوصف |
| --- | --- |
| [SoLeResource](soleresource/#constructor)() | يُهيئ مثيلاً جديداً من الفئة `SoLeResource`. |
| [SoLeResource](soleresource/#constructor_1)(Guid, bool, bool) | يُهيئ مثيلاً جديداً من الفئة `SoLeResource`. |
...
| الاسم | الوصف |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/soleresource/typetoolkey/) | مفتاح معلومات أداة النوع: 'SoLE'. |
