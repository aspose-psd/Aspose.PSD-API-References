...
description: "خاصية SmartObjectResource. يحصل أو يضبط العدد الإجمالي للصفحات لبيانات طبقة الكائن الذكي في ملف PSD"
type: docs
weight: 200
...
العدد الإجمالي للصفحات لبيانات طبقة الكائن الذكي.
