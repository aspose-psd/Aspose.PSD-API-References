...
description: SmartObjectResource ملكية. الحصول على أو تعيين المعرف الفريد العام لبيانات طبقة الكائن الذكيSmartObjectResource في صورة PSD.
type: docs
weight: 240
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/uniqueid/
---
## SmartObjectResource.UniqueId property

الحصول على أو تعيين المعرف الفريد العام لبيانات طبقة الكائن الذكي[`SmartObjectResource`](../) في صورة PSD.
...
المعرف الفريد العام لبيانات طبقة الكائن الذكي[`SmartObjectResource`](../) .
