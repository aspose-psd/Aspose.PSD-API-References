...
معرف الـ comp المحدد حاليًا للمستند الفرعي في صورة PSD، والذي سيكون -1 إذا لم يتم اختيار أيٍّ.
