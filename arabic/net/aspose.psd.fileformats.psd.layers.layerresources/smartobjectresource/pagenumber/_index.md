...
description: SmartObjectResource ملكية. الحصول على أو تعيين رقم صفحة بيانات طبقة الكائن الذكي في ملف PSD.
type: docs
weight: 150
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/pagenumber/
---
## SmartObjectResource.PageNumber property

الحصول على أو تعيين رقم صفحة بيانات طبقة الكائن الذكي في ملف PSD.
...
رقم صفحة بيانات طبقة الكائن الذكي.
