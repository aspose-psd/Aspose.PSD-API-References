...
description: "SmartObjectResource property. يحصل أو يعيّن المعرف الفريد لبيانات طبقة الكائن الذكي هذه في صورة PSD"
type: docs
weight: 160
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/smartobjectresource/placedid/
---
{{< psd/tize >}}
...
المعرف الفريد لهذا مورد طبقة الكائن الذكي.
