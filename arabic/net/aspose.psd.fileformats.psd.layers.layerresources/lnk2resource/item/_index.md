...
description: Lnk2Resource ملكية. يحصل على ملفLiFdDataSource في الفهرس المحدد.
type: docs
weight: 20
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lnk2resource/item/
---
## Lnk2Resource indexer

يحصل على ملف[`LiFdDataSource`](../../lifddatasource/) في الفهرس المحدد.
...
ملف[`LiFdDataSource`](../../lifddatasource/) المثال.

### Property_Value

ملف[`LiFdDataSource`](../../lifddatasource/) .
