---
title: "الفئة ArtBResource"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.LayerResources.ArtBResource. بيانات معلومات لوحة الرسم للموارد"
type: docs
weight: 2520
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/artbresource/
---
{{< psd/tize >}}
## ArtBResource class

بيانات معلومات لوحة الرسم لـ [`Resources`](../../aspose.psd.fileformats.psd.layers/layer/resources/).
...
| الاسم | الوصف |
| --- | --- |
| [ArtBResource](artbresource/)() | الباني الافتراضي. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [ArtboardBackgroundType](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/artboardbackgroundtype/) { get; set; } | يحصل أو يعيّن الـ [`ArtboardBackgroundType`](./artboardbackgroundtype/) |
| [Color](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/color/) { get; set; } | يحصل أو يعيّن الـ [`Color`](./color/) |
...
| الاسم | الوصف |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/artbresource/typetoolkey/) | مفتاح معلومات أداة النوع. |
