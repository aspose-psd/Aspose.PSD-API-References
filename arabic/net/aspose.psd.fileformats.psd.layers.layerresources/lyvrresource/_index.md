---
title: "الفئة LyvrResource"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.LayerResources.LyvrResource. المورد الذي يمثل نسخة الفوتوشوب من الطبقة"
type: docs
weight: 3150
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/
---
{{< psd/tize >}}
## LyvrResource class

المورد الذي يمثل نسخة Photoshop للطبقة.
...
| الاسم | الوصف |
| --- | --- |
| [LyvrResource](lyvrresource/)() | الباني الافتراضي. |
...
| [Version](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/version/) { get; set; } | يحصل أو يضبط نسخة الفوتوشوب للطبقة. |

## الطرق

| الاسم | الوصف |
| --- | --- |
| override [Save](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/save/)(StreamContainer, int) | يحفظ المورد في حاوية الدفق المحددة. |
...
| الاسم | الوصف |
| --- | --- |
| const [TypeToolKey](../../aspose.psd.fileformats.psd.layers.layerresources/lyvrresource/typetoolkey/) | مفتاح معلومات أداة النوع. |
