...
description: PlacedResource ملكية. الحصول على أو تحديد رقم الصفحة للطبقة الموضوعة في ملف PSD.
type: docs
weight: 90
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/placedresource/pagenumber/
---
## PlacedResource.PageNumber property

الحصول على أو تحديد رقم الصفحة للطبقة الموضوعة في ملف PSD.
