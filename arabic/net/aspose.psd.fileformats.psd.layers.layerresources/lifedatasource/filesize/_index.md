...
description: LiFeDataSource ملكية. الحصول على أو تعيين حجم الملف الخارجي في مصدر بيانات LiFE لمورد PSD LnkE.
type: docs
weight: 80
...
الحصول على أو تعيين حجم الملف الخارجي في مصدر بيانات LiFE لمورد PSD LnkE.
...
| استثناء | حالة |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية حجم الملف ، فهي متاحة فقط لمصدر بيانات liFE |
