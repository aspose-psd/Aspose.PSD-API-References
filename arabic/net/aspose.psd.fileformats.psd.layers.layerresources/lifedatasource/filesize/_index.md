...
description: "LiFeDataSource property. تحصل أو تعين حجم الملف الخارجي في مصدر البيانات LiFE لمورد PSD LnkE"
type: docs
weight: 80
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/filesize/
---
{{< psd/tize >}}
## LiFeDataSource.FileSize property

يحصل أو يعيّن حجم الملف الخارجي في مصدر البيانات LiFE الخاص بموارد PSD LnkE.
...
| استثناء | شرط |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية FileSize، فهي متاحة فقط لمصدر البيانات liFE |
