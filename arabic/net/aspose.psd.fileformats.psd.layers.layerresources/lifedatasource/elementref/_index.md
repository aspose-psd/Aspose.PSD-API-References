...
description: "LiFeDataSource property. تحصل أو تعين مرجع عنصر مكتبة الرسوميات لـ Adobe Photoshop CC Libraries"
type: docs
weight: 60
...
يحصل أو يعيّن مرجع عنصر مكتبة الرسومات، لأدوب® Photoshop® CC Libraries.
...
مرجع عنصر مكتبة الرسوميات.

### استثناءات

| استثناء | شرط |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية ElementRef، فهي متاحة فقط لمصدر البيانات liFE عندما تكون IsLibrary صحيحة |
