...
description: LiFeDataSource ملكية. الحصول على مرجع عنصر مكتبة الرسومات أو تعيينه  لمكتبات Adobe Photoshop CC .
type: docs
weight: 60
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementref/
---
## LiFeDataSource.ElementRef property

الحصول على مرجع عنصر مكتبة الرسومات أو تعيينه ، لمكتبات Adobe® Photoshop® CC .
...
مرجع عنصر مكتبة الرسومات .

### استثناءات

| استثناء | حالة |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية ElementRef ، فهي متاحة فقط لمصدر بيانات liFE عندما تكون IsLibrary هي true |
