...
description: "LiFeDataSource property. تحصل أو تعين تاريخ ووقت الكتابة الأخير للملف الخارجي في مصدر البيانات LiFE لمورد PSD LnkE"
type: docs
weight: 40
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/date/
---
{{< psd/tize >}}
## LiFeDataSource.Date property

يحصل أو يعيّن تاريخ ووقت الكتابة الأخير للملف الخارجي في مصدر البيانات LiFE الخاص بموارد PSD LnkE.
...
تاريخ ووقت الكتابة الأخير للملف الخارجي.

### استثناءات

| استثناء | شرط |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية Date، فهي متاحة فقط لمصدر البيانات liFE بالإصدار 3 أو أعلى |
