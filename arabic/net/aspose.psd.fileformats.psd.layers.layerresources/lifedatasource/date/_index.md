...
description: LiFeDataSource ملكية. الحصول على أو تعيين آخر تاريخ كتابة ووقت للملف الخارجي في مصدر بيانات LiFE لمورد PSD LnkE.
type: docs
weight: 40
...
الحصول على أو تعيين آخر تاريخ كتابة ووقت للملف الخارجي في مصدر بيانات LiFE لمورد PSD LnkE.
...
تاريخ ووقت آخر كتابة للملف الخارجي.

### استثناءات

| استثناء | حالة |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية التاريخ ، فهي متاحة فقط لمصدر بيانات liFE بالإصدار 3 أو أكبر |
