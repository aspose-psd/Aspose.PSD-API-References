...
description: "خاصية LiFeDataSource. تحصل أو تعين اسم عنصر مكتبة الرسومات لـ Adobe Photoshop CC Libraries"
type: docs
weight: 50
...
يحصل أو يعيّن اسم عنصر مكتبة الرسومات، لأدوب® Photoshop® CC Libraries.
...
| استثناء | شرط |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية ElementName، فهي متاحة فقط لمصدر البيانات liFE عندما تكون IsLibrary صحيحة |
