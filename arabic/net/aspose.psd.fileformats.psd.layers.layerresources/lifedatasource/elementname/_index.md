...
description: LiFeDataSource ملكية. الحصول على أو تعيين اسم عنصر مكتبة الرسومات لمكتبات Adobe Photoshop CC .
type: docs
weight: 50
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/elementname/
---
## LiFeDataSource.ElementName property

الحصول على أو تعيين اسم عنصر مكتبة الرسومات لمكتبات Adobe® Photoshop® CC .
...
اسم عنصر مكتبة الرسومات.

### استثناءات

| استثناء | حالة |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية ElementName ، فهي متاحة فقط لمصدر بيانات liFE عندما تكون IsLibrary هي true |
