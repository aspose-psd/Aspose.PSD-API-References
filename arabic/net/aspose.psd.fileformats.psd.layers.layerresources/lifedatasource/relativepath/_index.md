...
description: "خاصية LiFeDataSource. تحصل أو تعين المسار النسبي للملف الخارجي في مصدر البيانات LiFE لمورد PSD LnkE"
type: docs
weight: 100
...
يحصل أو يعيّن المسار النسبي للملف الخارجي في مصدر البيانات LiFE الخاص بموارد PSD LnkE.
...
| استثناء | شرط |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية RelativePath، فهي متاحة فقط لمصدر البيانات liFE |
