...
description: LiFeDataSource ملكية. الحصول على أو تعيين المسار النسبي للملف الخارجي في مصدر بيانات LiFE لمورد PSD LnkE.
type: docs
weight: 100
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/relativepath/
---
## LiFeDataSource.RelativePath property

الحصول على أو تعيين المسار النسبي للملف الخارجي في مصدر بيانات LiFE لمورد PSD LnkE.
...
| استثناء | حالة |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية RelativePath ، فهي متاحة فقط لمصدر بيانات liFE |
