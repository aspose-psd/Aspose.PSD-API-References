...
description: "LiFeDataSource property. تحصل أو تعين معرف AdobeStockId لمكتبة الرسوميات لـ Adobe Photoshop CC Libraries"
type: docs
weight: 20
...
معرف Adobe Stock لمكتبة الرسوميات.

### استثناءات

| استثناء | شرط |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية AdobeStockId، فهي متاحة فقط لمصدر البيانات liFE عندما تكون IsLibrary صحيحة |
