...
description: LiFeDataSource ملكية. الحصول على مكتبة الرسومات أو تعيينها AdobeStockId  لمكتبات Adobe Photoshop CC .
type: docs
weight: 20
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/lifedatasource/adobestockid/
---
## LiFeDataSource.AdobeStockId property

الحصول على مكتبة الرسومات أو تعيينها AdobeStockId ، لمكتبات Adobe® Photoshop® CC .
...
مكتبة الرسومات Adobe Stock Identifier .

### استثناءات

| استثناء | حالة |
| --- | --- |
| [PsdImageException](../../../aspose.psd.coreexceptions.imageformats/psdimageexception/) | لا يمكنك الوصول إلى خاصية AdobeStockId ، فهي متاحة فقط لمصدر بيانات liFE عندما تكون IsLibrary صحيحة |
