...
description: "خاصية BaseArtboardInfoResource. يحصل على أو يضبط عناصر OSTypeStructure"
type: docs
weight: 10
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/baseartboardinforesource/items/
---
{{< psd/tize >}}
## BaseArtboardInfoResource.Items property

يحصل على أو يضبط عناصر [`OSTypeStructure`](../../ostypestructure/).
