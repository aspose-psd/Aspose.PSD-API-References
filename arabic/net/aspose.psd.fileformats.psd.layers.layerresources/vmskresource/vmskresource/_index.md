...
description: "منشئ VmskResource. يهيئ مثيلاً جديداً من الفئة VmskResource"
type: docs
weight: 10
...
يهيئ مثيلاً جديداً من الفئة [`VmskResource`](../).
...
| استثناء | شرط |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | قيمة Vmsk Resource غير صالحة |
