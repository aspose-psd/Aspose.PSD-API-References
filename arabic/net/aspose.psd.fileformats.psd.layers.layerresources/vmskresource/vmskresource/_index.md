...
description: VmskResource البناء. يقوم بتهيئة مثيل جديد لملفVmskResource فئة .
type: docs
weight: 10
url: /ar/net/aspose.psd.fileformats.psd.layers.layerresources/vmskresource/vmskresource/
---
## VmskResource(byte[]) {#constructor_1}

يقوم بتهيئة مثيل جديد لملف[`VmskResource`](../) فئة .
...
| استثناء | حالة |
| --- | --- |
| [PsdImageArgumentException](../../../aspose.psd.coreexceptions.imageformats/psdimageargumentexception/) | قيمة مورد Vmsk غير صالحة |
