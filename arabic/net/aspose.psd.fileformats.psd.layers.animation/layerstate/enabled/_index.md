...
description: LayerState ملكية. الحصول على أو تعيين حالة التمكين.
type: docs
weight: 30
url: /ar/net/aspose.psd.fileformats.psd.layers.animation/layerstate/enabled/
---
## LayerState.Enabled property

الحصول على أو تعيين حالة التمكين.
