---
title: "تعداد WarpRotates"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "تعداد Aspose.PSD.FileFormats.Psd.Layers.Warp.WarpRotates. أنواع دوران الالتواء"
type: docs
weight: 4000
url: /ar/net/aspose.psd.fileformats.psd.layers.warp/warprotates/
---
{{< psd/tize >}}
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Horizontal | `0` | اتجاه الالتواء الأفقي |
| Vertical | `1` | اتجاه الالتواء العمودي |
