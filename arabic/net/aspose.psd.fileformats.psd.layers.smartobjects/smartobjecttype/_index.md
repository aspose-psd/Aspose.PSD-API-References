---
title: "تعداد SmartObjectType"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "تعداد Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType. يعرّف تعداد SmartObjectType لنوع محتوى الكائن الذكي"
type: docs
weight: 3920
url: /ar/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjecttype/
---
{{< psd/tize >}}
## SmartObjectType enumeration

يعرّف تعداد SmartObjectType لنوع محتوى الكائن الذكي
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Embedded | `0` | المحتوى المضمّن |
| AvailableLinked | `1` | الملف المرتبط المتوفر |
| UnavailableLinked | `2` | الملف المرتبط غير متوفر |
| LibraryLink | `3` | رابط مكتبة Adobe® Photoshop® ÑÑ |
