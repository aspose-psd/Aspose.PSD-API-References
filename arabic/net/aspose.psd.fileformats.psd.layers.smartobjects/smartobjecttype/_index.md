...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartObjects.SmartObjectType تعداد. يحدد تعداد SmartObjectType للكائن الذكي type
type: docs
weight: 3500
...
يحدد تعداد SmartObjectType للكائن الذكي type
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Embedded | `0` | المحتوى المضمن |
| AvailableLinked | `1` | الملف المرتبط المتاح |
| UnavailableLinked | `2` | الملف المرتبط غير متوفر |
| LibraryLink | `3` | Adobe® Photoshop® رابط مكتبة |
