...
description: SmartObjectLayer ملكية. الحصول على أو تعيين مصدر محتوى الكائن الذكي.
type: docs
weight: 30
url: /ar/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/contentssource/
---
## SmartObjectLayer.ContentsSource property

الحصول على أو تعيين مصدر محتوى الكائن الذكي.
