...
description: "خاصية SmartObjectLayer. تحصل أو تعين معلمات Warp التي تم تعيينها أو الحصول عليها من الإعداد الافتراضي للموارد"
type: docs
weight: 80
url: /ar/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/warpsettings/
---
{{< psd/tize >}}
## SmartObjectLayer.WarpSettings property

يحصل أو يضبط معلمات التشويه التي تم ضبطها أو الحصول عليها من المورد (الافتراضي)
