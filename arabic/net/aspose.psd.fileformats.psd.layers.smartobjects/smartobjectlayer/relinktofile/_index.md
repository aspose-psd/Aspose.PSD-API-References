...
description: SmartObjectLayer طريقة. إعادة ربط الكائن الذكي المرتبط بملف جديد. ليست هناك حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك.
type: docs
weight: 130
url: /ar/net/aspose.psd.fileformats.psd.layers.smartobjects/smartobjectlayer/relinktofile/
---
## SmartObjectLayer.RelinkToFile method

إعادة ربط الكائن الذكي المرتبط بملف جديد. ليست هناك حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك.
