...
description: "طريقة SmartObjectLayer. تعيد ربط الكائن الذكي المرتبط بملف جديد. لا حاجة لاستدعاء طريقة UpdateModifiedContent بعد ذلك"
type: docs
weight: 150
...
يعيد ربط الكائن الذكي المرتبط بملف جديد. لا حاجة لاستدعاء طريقة UpdateModifiedContent لاحقاً.
