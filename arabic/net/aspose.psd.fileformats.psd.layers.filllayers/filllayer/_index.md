...
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer. طبقة تعبئة. تعبئة لونية أو تعبئة تدرجية أو تعبئة بنمط تختلف حسب FillSettings"
type: docs
weight: 2020
url: /ar/net/aspose.psd.fileformats.psd.layers.filllayers/filllayer/
---
{{< psd/tize >}}
## FillLayer class

طبقة تعبئة. تعبئة لونية أو تعبئة تدرجية أو تعبئة بنمط تختلف حسب [`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; set; } | يحصل أو يضبط إعدادات التعبئة. |
| [FillType](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/filltype/) { get; } | يحصل على نوع التعبئة. |
...
| الاسم | الوصف |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | أنشئ مثيلاً جديداً للفئة `FillLayer` حسب نوع التعبئة. |
...
| override [ReplaceNonTransparentColors](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية للحفاظ على حواف ناعمة. ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | يقوم بتحديث بيانات البكسل لطبقة التعبئة بناءً على الـ [`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/). |
