...
description: Aspose.PSD.FileFormats.Psd.Layers.FillLayers.FillLayer فصل. طبقة التعبئة. لون تعبئة  تعبئة متدرجة أو طبقة تعبئة نمط تختلف حسبFillSettings
type: docs
weight: 1910
...
طبقة التعبئة. لون تعبئة ، تعبئة متدرجة أو طبقة تعبئة نمط تختلف حسب[`FillSettings`](./fillsettings/)
...
| [FillSettings](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/fillsettings/) { get; } | يحصل على إعدادات التعبئة . |
...
| اسم | وصف |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/createinstance/)(FillType) | إنشاء مثيل جديد لملف`FillLayer` فئة حسب نوع التعبئة. |
...
| [Update](../../aspose.psd.fileformats.psd.layers.filllayers/filllayer/update/)() | التحديثات قم بتعبئة بيانات طبقة البكسل وفقًا للواقع[`IFillSettings`](../../aspose.psd.fileformats.psd.layers.fillsettings/ifillsettings/) . |
...
* مساحة الاسم [Aspose.PSD.FileFormats.Psd.Layers.FillLayers](../../aspose.psd.fileformats.psd.layers.filllayers/)
* المجسم [Aspose.PSD](../../)
