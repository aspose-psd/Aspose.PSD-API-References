...
description: ITextParagraph ملكية. الحصول على تباعد الصورة الرمزية أو تعيينه.
type: docs
weight: 80
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/glyphspacing/
---
## ITextParagraph.GlyphSpacing property

الحصول على تباعد الصورة الرمزية أو تعيينه.
