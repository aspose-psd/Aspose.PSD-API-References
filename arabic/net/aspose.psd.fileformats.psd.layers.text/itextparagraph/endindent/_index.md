...
description: ITextParagraph ملكية. الحصول على المسافة البادئة للنهاية أو تعيينها .
type: docs
weight: 50
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/endindent/
---
## ITextParagraph.EndIndent property

الحصول على المسافة البادئة للنهاية أو تعيينها .
