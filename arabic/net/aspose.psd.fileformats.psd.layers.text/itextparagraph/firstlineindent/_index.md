...
description: ITextParagraph ملكية. الحصول على المسافة البادئة للسطر الأول أو تعيينها .
type: docs
weight: 70
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/firstlineindent/
---
## ITextParagraph.FirstLineIndent property

الحصول على المسافة البادئة للسطر الأول أو تعيينها .
