...
description: ITextParagraph ملكية. الحصول على أو تعيين قيمة تشير إلى ما إذا كانت واصلة تلقائية .
type: docs
weight: 10
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autohyphenate/
---
## ITextParagraph.AutoHyphenate property

الحصول على أو تعيين قيمة تشير إلى ما إذا كانت [واصلة تلقائية] .
...
`حقيقي` إذا [واصلة تلقائية] ؛ خلاف ذلك،`خطأ شنيع` .
