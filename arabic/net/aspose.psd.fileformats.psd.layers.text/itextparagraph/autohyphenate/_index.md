...
description: "خاصية ITextParagraph. يحصل أو يضبط قيمة تشير إلى ما إذا كان التجزئة التلقائية مفعلة"
type: docs
weight: 10
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان [automatic hyphenate].
...
`true` إذا كان [automatic hyphenate]; وإلا `false`.
