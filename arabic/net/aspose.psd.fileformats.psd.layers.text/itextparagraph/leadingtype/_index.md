...
description: ITextParagraph ملكية. الحصول على أو تحديد نوع المسافة البادئة .
type: docs
weight: 130
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/leadingtype/
---
## ITextParagraph.LeadingType property

الحصول على أو تحديد نوع المسافة البادئة .
