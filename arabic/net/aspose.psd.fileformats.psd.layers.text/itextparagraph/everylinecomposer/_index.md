...
description: ITextParagraph ملكية. الحصول على أو تعيين قيمة تشير إلى ما إذا كان كل سطر مؤلف .
type: docs
weight: 60
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/everylinecomposer/
---
## ITextParagraph.EveryLineComposer property

الحصول على أو تعيين قيمة تشير إلى ما إذا كان [كل سطر مؤلف] .
...
`حقيقي` إذا [كل مؤلف سطر] ؛ خلاف ذلك،`خطأ شنيع` .
