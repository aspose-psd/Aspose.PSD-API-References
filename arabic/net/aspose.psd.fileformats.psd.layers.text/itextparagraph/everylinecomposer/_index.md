...
description: "خاصية ITextParagraph. يحصل أو يضبط قيمة تشير إلى ما إذا كان مؤلف كل سطر"
type: docs
weight: 60
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان [every line composer].
...
`true` إذا كان [every line composer]؛ وإلا، `false`.
