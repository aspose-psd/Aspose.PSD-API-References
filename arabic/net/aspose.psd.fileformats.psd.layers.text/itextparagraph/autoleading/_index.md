...
description: ITextParagraph ملكية. الحصول على المسافة البادئة التلقائية أو تعيينها.
type: docs
weight: 20
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/autoleading/
---
## ITextParagraph.AutoLeading property

الحصول على المسافة البادئة التلقائية أو تعيينها.
