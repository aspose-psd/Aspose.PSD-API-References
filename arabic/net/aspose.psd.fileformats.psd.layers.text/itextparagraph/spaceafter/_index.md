...
description: ITextParagraph ملكية. الحصول على المسافة أو تحديدها بعد .
type: docs
weight: 170
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/spaceafter/
---
## ITextParagraph.SpaceAfter property

الحصول على المسافة أو تحديدها بعد .
