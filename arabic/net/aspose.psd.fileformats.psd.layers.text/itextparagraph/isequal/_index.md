...
description: "طريقة ITextParagraph. تحدد ما إذا كانت الفقرة المحددة مساوية"
type: docs
weight: 230
...
يحدد ما إذا كانت الفقرة المحددة متساوية.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| فقرة | ITextParagraph | الفقرة. |

### قيمة الإرجاع

`true` إذا كانت الفقرة المحددة مساوية؛ وإلا `false`.
