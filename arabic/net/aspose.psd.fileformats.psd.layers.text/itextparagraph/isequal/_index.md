...
description: ITextParagraph طريقة. لتحديد ما إذا كانت الفقرة المحددة متساوية.
type: docs
weight: 230
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/isequal/
---
## ITextParagraph.IsEqual method

لتحديد ما إذا كانت الفقرة المحددة متساوية.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| paragraph | ITextParagraph | الفقرة. |

### قيمة الإرجاع

`حقيقي` إذا كانت الفقرة المحددة متساوية ؛ خلاف ذلك،`خطأ شنيع` .
