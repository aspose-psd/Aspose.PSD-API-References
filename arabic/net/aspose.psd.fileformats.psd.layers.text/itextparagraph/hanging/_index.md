...
description: "خاصية ITextParagraph. يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا ITextParagraph معلقًا"
type: docs
weight: 90
...
يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [`ITextParagraph`](../) معلقًا.
...
`true` إذا كان معلقًا؛ وإلا `false`.
