...
description: ITextParagraph ملكية. الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذاITextParagraph معلق .
type: docs
weight: 90
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hanging/
---
## ITextParagraph.Hanging property

الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا[`ITextParagraph`](../) معلق .
...
`حقيقي` إذا كانت معلقة خلاف ذلك،`خطأ شنيع` .
