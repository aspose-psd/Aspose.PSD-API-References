...
description: "خاصية ITextParagraph. تحصل أو تعين قيمة تشير إلى ما إذا كان هذا ITextParagraph هو burasagiri."
type: docs
weight: 30
...
تحصل أو تعين قيمة تشير إلى ما إذا كان هذا [`ITextParagraph`](../) هو burasagiri.
...
`true` إذا كان burasagiri؛ وإلا `false`.
