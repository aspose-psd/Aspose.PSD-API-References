...
description: ITextParagraph ملكية. الحصول على المسافة البادئة للبداية أو تعيينها .
type: docs
weight: 190
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/startindent/
---
## ITextParagraph.StartIndent property

الحصول على المسافة البادئة للبداية أو تعيينها .
