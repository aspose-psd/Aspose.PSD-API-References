...
description: ITextParagraph ملكية. الحصول على الواصلة المسبقة أو تعيينها .
type: docs
weight: 160
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/prehyphen/
---
## ITextParagraph.PreHyphen property

الحصول على الواصلة المسبقة أو تعيينها .
