...
description: ITextParagraph ملكية. الحصول على حجم الكلمة الموصولة أو تعيينها.
type: docs
weight: 100
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextparagraph/hyphenatedwordsize/
---
## ITextParagraph.HyphenatedWordSize property

الحصول على حجم الكلمة الموصولة أو تعيينها.
