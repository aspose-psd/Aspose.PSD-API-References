...
description: "طريقة IText. تُنتج الجزء الجديد باستخدام المعلمات الافتراضية"
type: docs
weight: 60
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itext/produceportion/
---
{{< psd/tize >}}
## IText.ProducePortion method

ينتج الجزء الجديد مع المعلمات الافتراضية
...
إشارة إلى الـ [`ITextPortion`](../../itextportion/) الذي تم إنشاؤه حديثًا.
