...
description: ITextStyle ملكية. الحصول على أو تعيين قيمة تشير إلى الأرقام الهندية .
type: docs
weight: 150
...
الحصول على أو تعيين قيمة تشير إلى [الأرقام الهندية] .
...
`حقيقي` إذا [أرقام هندية] ؛ خلاف ذلك،`خطأ شنيع` .
