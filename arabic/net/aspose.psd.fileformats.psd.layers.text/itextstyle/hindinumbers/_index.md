...
description: "خاصية ITextStyle. يحصل أو يضبط قيمة تشير إلى ما إذا كانت الأرقام الهندية"
type: docs
weight: 150
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextstyle/hindinumbers/
---
{{< psd/tize >}}
## ITextStyle.HindiNumbers property

يحصل أو يعيّن قيمة تشير إلى ما إذا كان [الأرقام الهندية].
...
`true` إذا كان [hindi numbers]; وإلا `false`.
