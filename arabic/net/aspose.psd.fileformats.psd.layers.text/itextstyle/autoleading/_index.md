...
description: "خاصية ITextStyle. يحصل أو يضبط قيمة تشير إلى ما إذا كان التباعد التلقائي"
type: docs
weight: 20
...
يحصل أو يعيّن قيمة تشير إلى ما إذا كان [التباعد التلقائي].
...
`true` إذا كان [automatic leading]; وإلا `false`.
