...
description: ITextStyle ملكية. الحصول على أو تعيين قيمة تشير إلى ما إذا كان المسافة البادئة تلقائيًا .
type: docs
weight: 20
url: /ar/net/aspose.psd.fileformats.psd.layers.text/itextstyle/autoleading/
---
## ITextStyle.AutoLeading property

الحصول على أو تعيين قيمة تشير إلى ما إذا كان [المسافة البادئة تلقائيًا] .
...
`حقيقي` إذا [بادئة تلقائية] ؛ خلاف ذلك،`خطأ شنيع` .
