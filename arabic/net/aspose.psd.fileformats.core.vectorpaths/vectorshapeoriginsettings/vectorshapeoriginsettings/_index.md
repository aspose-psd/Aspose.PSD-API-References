...
description: VectorShapeOriginSettings البناء. يقوم بتهيئة مثيل جديد لملفVectorShapeOriginSettings فئة .
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لملف[`VectorShapeOriginSettings`](../) فئة .
