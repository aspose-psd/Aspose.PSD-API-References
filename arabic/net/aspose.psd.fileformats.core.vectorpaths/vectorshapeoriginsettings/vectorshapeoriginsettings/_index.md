...
description: "منشئ VectorShapeOriginSettings. يهيئ نسخة جديدة من فئة VectorShapeOriginSettings"
type: docs
weight: 10
url: /ar/net/aspose.psd.fileformats.core.vectorpaths/vectorshapeoriginsettings/vectorshapeoriginsettings/
---
{{< psd/tize >}}
## VectorShapeOriginSettings(bool, int) {#constructor_1}

يهيئ نسخة جديدة من الفئة [`VectorShapeOriginSettings`](../).
...
| originIndex | Int32 | فهرس أصل الشكل. |
