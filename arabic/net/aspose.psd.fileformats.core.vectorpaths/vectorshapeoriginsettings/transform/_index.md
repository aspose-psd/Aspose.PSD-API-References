...
description: "خاصية VectorShapeOriginSettings. يحصل أو يضبط مصفوفة التحويل"
type: docs
weight: 170
...
يوضح هذا المثال كيفية تغيير حجم الطبقات باستخدام مورد Vogt ومسار متجه في صورة PSD.
