...
description: Aspose.PSD.FileFormats.Psd.Layers.SmartFilters.NoiseDistribution تعداد. توزيع مرشح الضوضاء .
type: docs
weight: 3440
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Uniform | `0` | التوزيع الموحد للضوضاء . |
| Gaussian | `1` | توزيع الضوضاء الغوسية . |
