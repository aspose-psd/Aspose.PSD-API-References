...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerEffects.StrokePosition تعداد. يتحكم إعداد الموضع في محاذاة الحد الخاص بك مع الطبقة التي يتم تطبيقها عليها في ملفStrokeEffect .
type: docs
weight: 2200
...
يتحكم إعداد الموضع في محاذاة الحد الخاص بك مع الطبقة التي يتم تطبيقها عليها في ملف[`StrokeEffect`](../strokeeffect/) .
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Inside | `0` | سيتم إنشاء الحد من حافة الشكل وتنمو للداخل ، إلى مركز الكائن . |
| Center | `1` | سيتم إنشاء الحد من حافة الشكل وتنمو داخليًا وخارجيًا . |
| Outside | `2` | سيتم إنشاء الحد من حافة الشكل وسينمو للخارج بعيدًا عن الكائن . |
