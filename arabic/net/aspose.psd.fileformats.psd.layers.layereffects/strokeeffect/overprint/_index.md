...
description: "خاصية StrokeEffect. يحصل على أو يضبط قيمة تشير إلى ما إذا كان هذا StrokeEffect سيخلط الخط مع محتويات الطبقة الحالية"
type: docs
weight: 60
...
يحصل على أو يضبط قيمة تشير إلى ما إذا كان هذا [`StrokeEffect`](../) سيخلط الخط مع محتويات الطبقة الحالية.
...
`true` إذا كان يجب أن يخلط الخط مع محتويات الطبقة الحالية؛ وإلا `false`.
