...
description: "خاصية GradientMapSettings. يحصل أو يضبط تعريفًا محددًا لتدرج من النوع صلب/ضوضائي"
type: docs
weight: 30
url: /ar/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/
---
{{< psd/tize >}}
## GradientMapSettings.Gradient property

يحصل أو يضبط مثيل تعريف التدرج المحدد (Solid/Noise).
