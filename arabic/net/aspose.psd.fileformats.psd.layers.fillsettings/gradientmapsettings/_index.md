---
title: "الفئة GradientMapSettings"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientMapSettings. فئة إعدادات التدرج لطبقة خريطة التدرج. تحتوي على الخصائص المشتركة لكلا نوعي التدرج الصلب والضوضائي."
type: docs
weight: 2080
url: /ar/net/aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/
---
{{< psd/tize >}}
## GradientMapSettings class

فئة إعدادات التدرج لطبقة خريطة التدرج. تحتوي على خصائص مشتركة لكلا نوعي التدرج (الصلب والضوضائي).
...
| الاسم | الوصف |
| --- | --- |
| [GradientMapSettings](gradientmapsettings/)() | الباني الافتراضي. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [Dither](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/dither/) { get; set; } | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [`GradientFillSettings`](../gradientfillsettings/) مُنقّطاً. |
| [Gradient](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/gradient/) { get; set; } | يحصل أو يضبط مثيل تعريف التدرج المحدد (Solid/Noise). |
| [InterpolationMethod](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/interpolationmethod/) { get; set; } | يحصل أو يضبط طريقة الاستيفاء للتدرج. |
| [Reverse](../../aspose.psd.fileformats.psd.layers.fillsettings/gradientmapsettings/reverse/) { get; set; } | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [`GradientFillSettings`](../gradientfillsettings/) معكوساً. |
