...
description: Aspose.PSD.FileFormats.Psd.Layers.TextLayer فصل. طبقة النص class
type: docs
weight: 3560
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | يحصل على الخط . |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | يحصل على نص layer |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | يحصل على النص. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | الحصول على أو تحديد المربع المرتبط بالنص. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | يحصل على لون النص. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | يحصل على أجزاء النصوص . |
| [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | الحصول على أو تحديد موضع الطبقة العليا. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | الحصول على مصفوفة التحويل أو تعيينها |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | يحصل على مجموعة الخطوط لطبقة النص. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | يغير حجم الصورة. الافتراضيLeftTopToLeftTopيستخدم . |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | يقوم بتحديث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | يقوم بتحديث النص. |
