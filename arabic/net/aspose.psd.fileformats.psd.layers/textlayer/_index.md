---
title: "الفئة TextLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.TextLayer. فئة طبقة النص"
type: docs
weight: 3980
url: /ar/net/aspose.psd.fileformats.psd.layers/textlayer/
---
{{< psd/tize >}}
## TextLayer class
...
| [Font](../../aspose.psd.fileformats.psd.layers/textlayer/font/) { get; } | يسترجع الخط. |
...
| [InnerText](../../aspose.psd.fileformats.psd.layers/textlayer/innertext/) { get; } | يسترجع نص الطبقة |
...
| [Text](../../aspose.psd.fileformats.psd.layers/textlayer/text/) { get; } | يسترجع النص. |
| [TextBoundBox](../../aspose.psd.fileformats.psd.layers/textlayer/textboundbox/) { get; set; } | يسترجع أو يعيّن صندوق حدود النص. |
| [TextColor](../../aspose.psd.fileformats.psd.layers/textlayer/textcolor/) { get; } | يسترجع لون النص. |
| [TextData](../../aspose.psd.fileformats.psd.layers/textlayer/textdata/) { get; } | يسترجع أجزاء النصوص. |
| virtual [Top](../../aspose.psd.fileformats.psd.layers/layer/top/) { get; set; } | يحصل أو يضبط موضع الطبقة العليا. |
| [TransformMatrix](../../aspose.psd.fileformats.psd.layers/textlayer/transformmatrix/) { get; set; } | يسترجع أو يعيّن مصفوفة التحويل |
...
| [WarpSettings](../../aspose.psd.fileformats.psd.layers/textlayer/warpsettings/) { get; set; } | يحصل أو يضبط معلمات التشويه التي تم ضبطها أو الحصول عليها من المورد (الافتراضي) |
...
| [GetFonts](../../aspose.psd.fileformats.psd.layers/textlayer/getfonts/)() | يسترجع مجموعة الخطوط لطبقة النص. |
...
| override [Resize](../../aspose.psd.fileformats.psd.layers/textlayer/resize/#resize_2)(int, int, ResizeType) | يغيّر حجم الصورة. يتم استخدام الافتراضي LeftTopToLeftTop. |
...
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext)(string) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_1)(string, Color) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_6)(string, float) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_2)(string, Point) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_7)(string, float, Color) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_3)(string, Point, Color) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_4)(string, Point, float) | يحدّث النص. |
| [UpdateText](../../aspose.psd.fileformats.psd.layers/textlayer/updatetext/#updatetext_5)(string, Point, float, Color) | يحدّث النص. |
