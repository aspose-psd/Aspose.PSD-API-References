...
description: "فئة Aspose.PSD.FileFormats.Psd.Layers.ArtboardLayer. فئة طبقة لوحة الرسم."
type: docs
weight: 1990
url: /ar/net/aspose.psd.fileformats.psd.layers/artboardlayer/
---
{{< psd/tize >}}
## ArtboardLayer class
...
| override [BackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/backgroundcolor/) { get; set; } | يحصل أو يعيّن لون خلفية لوحة الرسم. |
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | يحصل أو يعيّن مفتاح وضع الدمج. |
...
| override [HasBackgroundColor](../../aspose.psd.fileformats.psd.layers/artboardlayer/hasbackgroundcolor/) { get; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كانت `ArtboardLayer` لديها لون الخلفية. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | يحصل أو يعيّن ما إذا كان المجلد مفتوحًا؛ إذا تم تعيينه إلى `true` فإن المجموعة ستكون في حالة مفتوحة عند بدء التشغيل، وإلا ستكون في حالة مصغرة. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | يحصل على الطبقات في مجموعة الطبقة. |
...
| الاسم | الوصف |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | يضيف الطبقة إلى مجموعة الطبقة. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | يضيف مجموعة الطبقة. |
