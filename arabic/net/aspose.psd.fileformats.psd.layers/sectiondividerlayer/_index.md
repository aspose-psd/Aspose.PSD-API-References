...
description: Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer فصل. طبقة مقسم القسم لتمييز حدود المجلد مجموعة الطبقات .
type: docs
weight: 3410
...
طبقة مقسم القسم لتمييز حدود المجلد (مجموعة الطبقات) .
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل مرئيًا في المجموعة (إذا لم تكن الطبقة في مجموعة فهذا يعني مجموعة الجذر). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | يحصل على ملف[`LayerGroup`](../layergroup/) هذا متعلق بهذا`SectionDividerLayer` المثال. |
