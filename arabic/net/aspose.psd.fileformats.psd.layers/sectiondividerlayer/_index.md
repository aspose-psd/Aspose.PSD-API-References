---
title: "الفئة SectionDividerLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.SectionDividerLayer. طبقة مقسّم القسم لتحديد حدود مجموعة طبقة المجلد."
type: docs
weight: 3810
url: /ar/net/aspose.psd.fileformats.psd.layers/sectiondividerlayer/
---
{{< psd/tize >}}
## SectionDividerLayer class

طبقة فاصل القسم لتحديد حدود المجلد (مجموعة الطبقات).
...
| override [IsVisibleInGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/isvisibleingroup/) { get; } | يحصل على قيمة تشير إلى ما إذا كانت هذه الحالة مرئية في المجموعة (إذا لم تكن الطبقة في مجموعة فهذا يعني مجموعة الجذر). |
...
| [GetRelatedLayerGroup](../../aspose.psd.fileformats.psd.layers/sectiondividerlayer/getrelatedlayergroup/)() | يحصل على [`LayerGroup`](../layergroup/) المرتبط بهذه النسخة من `SectionDividerLayer`. |
