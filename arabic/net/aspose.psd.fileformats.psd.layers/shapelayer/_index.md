---
title: "الفئة ShapeLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الفئة Aspose.PSD.FileFormats.Psd.Layers.ShapeLayer. طبقة الشكل. تُغلف منطق العمل مع طبقة الشكل والموارد المرتبطة."
type: docs
weight: 3820
url: /ar/net/aspose.psd.fileformats.psd.layers/shapelayer/
---
{{< psd/tize >}}
## ShapeLayer class

طبقة الشكل. تغلف منطق العمل مع طبقة الشكل والموارد المرتبطة.
...
| الاسم | الوصف |
| --- | --- |
| [ShapeLayer](shapelayer/)() | يُنشئ مثيلاً جديدًا للفئة `ShapeLayer`. جميع الموارد تُنشأ بالحالة الافتراضية. |
...
| [Fill](../../aspose.psd.fileformats.psd.layers/shapelayer/fill/) { get; set; } | يحصل أو يعيّن إعدادات التعبئة للمنطقة الداخلية للأشكال في طبقة الشكل. |
...
| [Path](../../aspose.psd.fileformats.psd.layers/shapelayer/path/) { get; } | يحصل على مجموعة المسارات الموجودة في طبقة الشكل. |
...
| [Stroke](../../aspose.psd.fileformats.psd.layers/shapelayer/stroke/) { get; set; } | يحصل أو يعيّن إعدادات الحد للأشكال. |
...
| الاسم | الوصف |
| --- | --- |
| static [CreateInstance](../../aspose.psd.fileformats.psd.layers/shapelayer/createinstance/)() | ينشئ مثيلاً جديدًا للفئة `ShapeLayer`. |
...
| [Update](../../aspose.psd.fileformats.psd.layers/shapelayer/update/)() | يُحدّث الموارد من خصائص طبقة الشكل. |
