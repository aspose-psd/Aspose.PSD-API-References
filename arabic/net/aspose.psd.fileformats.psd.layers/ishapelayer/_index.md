---
title: "الواجهة IShapeLayer"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "الواجهة Aspose.PSD.FileFormats.Psd.Layers.IShapeLayer. تصف خصائص طبقة الشكل."
type: docs
weight: 2260
url: /ar/net/aspose.psd.fileformats.psd.layers/ishapelayer/
---
{{< psd/tize >}}
## IShapeLayer interface

يصف خصائص طبقة الشكل.
...
| الاسم | الوصف |
| --- | --- |
| [Fill](../../aspose.psd.fileformats.psd.layers/ishapelayer/fill/) { get; set; } | إعدادات التعبئة المستخدمة لملء المنطقة الداخلية للأشكال. |
| [Path](../../aspose.psd.fileformats.psd.layers/ishapelayer/path/) { get; } | مجموعة المسارات الموجودة في طبقة الشكل. |
| [Stroke](../../aspose.psd.fileformats.psd.layers/ishapelayer/stroke/) { get; set; } | إعدادات الخط للأشكال. |
