...
description: Aspose.PSD.FileFormats.Psd.Layers.Layer فصل. طبقة psd .
type: docs
weight: 2080
...
| اسم | وصف |
| --- | --- |
| [Layer](layer/#constructor)() | يقوم بتهيئة مثيل جديد لملف`Layer` فصل. مُنشئ للتهيئة البطيئة . |
| [Layer](layer/#constructor_3)(Stream) | يقوم بتهيئة مثيل جديد لملف`Layer` فئة . |
| [Layer](layer/#constructor_1)(RasterImage, bool) | يقوم بتهيئة مثيل جديد لملف`Layer` فئة . |
| [Layer](layer/#constructor_2)(Rectangle, byte[], byte[], byte[], string) | يقوم بتهيئة مثيل جديد لملف`Layer` فئة من مصفوفات البايت. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_1)(Stream) | يحفظ بيانات الكائن في الدفق المحدد. |
...
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_7)(string, bool) | يحفظ بيانات الكائن في موقع الملف المحدد. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_5)(string, ImageOptionsBase) | يحفظ بيانات الكائن في موقع الملف المحدد بتنسيق الملف المحدد وفقًا لخيارات الحفظ. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_3)(Stream, ImageOptionsBase, Rectangle) | يحفظ بيانات الصورة إلى التدفق المحدد بتنسيق الملف المحدد وفقًا لخيارات الحفظ. |
| override [Save](../../aspose.psd.fileformats.psd.layers/layer/save/#save_6)(string, ImageOptionsBase, Rectangle) | يحفظ بيانات الكائن في موقع الملف المحدد بتنسيق الملف المحدد وفقًا لخيارات الحفظ. |
...
| اسم | وصف |
| --- | --- |
| const [BlendSignature](../../aspose.psd.fileformats.psd.layers/layer/blendsignature/) | يمثل توقيع وضع المزج. |
