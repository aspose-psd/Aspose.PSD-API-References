...
description: Aspose.PSD.FileFormats.Psd.Layers.LayerGroup فصل. فئة طبقة المجموعة
type: docs
weight: 2220
...
| override [BlendModeKey](../../aspose.psd.fileformats.psd.layers/layergroup/blendmodekey/) { get; set; } | الحصول على أو تعيين مفتاح وضع المزج. |
...
| override [Height](../../aspose.psd.fileformats.psd.layers/layergroup/height/) { get; } | الحصول على ارتفاع مجموعة الطبقات. |
...
| [IsOpen](../../aspose.psd.fileformats.psd.layers/layergroup/isopen/) { get; set; } | Gets أو المجموعات هو المجلد المفتوح إذا تم تعيينه على`حقيقي` من المجموعة ستكون في حالة مفتوحة عند بدء التشغيل ، وإلا في حالة مصغرة. |
...
| [Layers](../../aspose.psd.fileformats.psd.layers/layergroup/layers/) { get; } | الحصول على الطبقات في مجموعة الطبقة |
...
| override [Width](../../aspose.psd.fileformats.psd.layers/layergroup/width/) { get; } | الحصول على عرض مجموعة الطبقات . |
...
| اسم | وصف |
| --- | --- |
| [AddLayer](../../aspose.psd.fileformats.psd.layers/layergroup/addlayer/)(Layer) | يضيف الطبقة إلى مجموعة الطبقات. |
| [AddLayerGroup](../../aspose.psd.fileformats.psd.layers/layergroup/addlayergroup/)(string, int) | يضيف مجموعة الطبقات . |
