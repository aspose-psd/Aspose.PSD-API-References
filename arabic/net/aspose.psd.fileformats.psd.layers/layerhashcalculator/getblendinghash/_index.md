...
description: LayerHashCalculator طريقة. يحصل على تجزئة المزج .
type: docs
weight: 20
url: /ar/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/getblendinghash/
---
## LayerHashCalculator.GetBlendingHash method

يحصل على تجزئة المزج .
...
تجزئة فريدة لخيارات مزج الطبقة
