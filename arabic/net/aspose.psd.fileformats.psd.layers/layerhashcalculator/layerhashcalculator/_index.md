...
description: LayerHashCalculator البناء. يقوم بتهيئة مثيل جديد لملفLayerHashCalculator فئة .
type: docs
weight: 10
url: /ar/net/aspose.psd.fileformats.psd.layers/layerhashcalculator/layerhashcalculator/
---
## LayerHashCalculator constructor

يقوم بتهيئة مثيل جديد لملف[`LayerHashCalculator`](../) فئة .
