---
title: "فئة BaseGradient"
second_title: "Aspose.PSD لـ .NET مرجع API"
description: "فئة Aspose.PSD.FileFormats.Psd.Layers.Gradient.BaseGradient. فئة تعريف التدرج الأساسي. تحتوي على خصائص مشتركة لكلا نوعي التدرج الصلب والضوضائي"
type: docs
weight: 2190
url: /ar/net/aspose.psd.fileformats.psd.layers.gradient/basegradient/
---
{{< psd/tize >}}
## BaseGradient class
...
| الاسم | الوصف |
| --- | --- |
| abstract [GradientMode](../../aspose.psd.fileformats.psd.layers.gradient/basegradient/gradientmode/) { get; } | يحصل على الوضع لهذا التدرج. يحدد 'نوع التدرج' = 'صلب/ضوضاء' (0/1). |
